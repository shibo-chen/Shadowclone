; ModuleID = 'perf_wc.c.rand.4P3.bc'
...
entry:
  ...
  %canary = alloca i32
  store i32 365538892, i32* %canary
...
entry:
  ...
  %charct.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1775137775, i32* %canary
  %i = alloca i32, align 4
  %wordct_array.addr = alloca i64*, align 8
  %wd.addr = alloca i8*, align 8
  %wordct.addr = alloca i64, align 8
...
entry:
  %canary = alloca i32
  store i32 318911807, i32* %canary
  %wordct_array.addr = alloca i64*, align 8
  %i = alloca i32, align 4
  %charct.addr = alloca i64, align 8
  %wordct.addr = alloca i64, align 8
...
entry:
  ...
  %wordct.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1741816310, i32* %canary
  %linect.addr = alloca i64, align 8
  %i = alloca i32, align 4
  %wd.addr = alloca i8*, align 8
  %charct.addr = alloca i64, align 8
