...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$998792327, -20(%rbp)   # imm = 0x3B885C87
	movq	%rdi, -16(%rbp)
	movq	%rsi, -40(%rbp)
	movq	%rdx, -48(%rbp)
	movq	%rcx, -32(%rbp)
...
.LBB4_12:                               # %sw.epilog
	...
	jmp	.LBB4_5
.LBB4_13:                               # %while.end
	cmpl	$998792327, -20(%rbp)   # imm = 0x3B885C87
	jne	.LBB4_15
.LBB4_14:
	addq	$64, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$107141751, -20(%rbp)   # imm = 0x662DA77
	movq	%rdi, -16(%rbp)
	movq	%rsi, -32(%rbp)
	movq	%rdx, -40(%rbp)
	movq	%rcx, -48(%rbp)
...
.LBB5_12:                               # %sw.epilog
	...
	jmp	.LBB5_5
.LBB5_13:                               # %while.end
	cmpl	$107141751, -20(%rbp)   # imm = 0x662DA77
	jne	.LBB5_15
.LBB5_14:
	addq	$64, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$1335172807, -20(%rbp)  # imm = 0x4F951EC7
	movq	%rdi, -16(%rbp)
	movq	%rsi, -32(%rbp)
	movq	%rdx, -56(%rbp)
	movq	%rcx, -40(%rbp)
...
.LBB6_12:                               # %sw.epilog
	...
	jmp	.LBB6_5
.LBB6_13:                               # %while.end
	cmpl	$1335172807, -20(%rbp)  # imm = 0x4F951EC7
	jne	.LBB6_15
.LBB6_14:
	addq	$64, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$1418644877, -20(%rbp)  # imm = 0x548ECD8D
	movq	%rdi, -16(%rbp)
	movq	%rsi, -32(%rbp)
	movq	%rdx, -40(%rbp)
	movq	%rcx, -56(%rbp)
...
.LBB7_12:                               # %sw.epilog
	...
	jmp	.LBB7_5
.LBB7_13:                               # %while.end
	cmpl	$1418644877, -20(%rbp)  # imm = 0x548ECD8D
	jne	.LBB7_15
.LBB7_14:
	addq	$64, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$1130941533, -20(%rbp)  # imm = 0x4368CC5D
	movq	%rdi, -16(%rbp)
	movq	%rsi, -56(%rbp)
	movq	%rdx, -40(%rbp)
	movq	%rcx, -48(%rbp)
...
.LBB8_12:                               # %sw.epilog
	...
	jmp	.LBB8_5
.LBB8_13:                               # %while.end
	cmpl	$1130941533, -20(%rbp)  # imm = 0x4368CC5D
	jne	.LBB8_15
.LBB8_14:
	addq	$64, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$1100206949, -20(%rbp)  # imm = 0x4193D365
	movq	%rdi, -16(%rbp)
	movq	%rsi, -32(%rbp)
	movq	%rdx, -56(%rbp)
	movq	%rcx, -40(%rbp)
...
.LBB9_12:                               # %sw.epilog
	...
	jmp	.LBB9_5
.LBB9_13:                               # %while.end
	cmpl	$1100206949, -20(%rbp)  # imm = 0x4193D365
	jne	.LBB9_15
.LBB9_14:
	addq	$64, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$2093731257, -20(%rbp)  # imm = 0x7CCBCDB9
	movq	%rdi, -16(%rbp)
	movq	%rsi, -48(%rbp)
	movq	%rdx, -40(%rbp)
	movq	%rcx, -32(%rbp)
...
.LBB10_12:                              # %sw.epilog
	...
	jmp	.LBB10_5
.LBB10_13:                              # %while.end
	cmpl	$2093731257, -20(%rbp)  # imm = 0x7CCBCDB9
	jne	.LBB10_15
.LBB10_14:
	addq	$64, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$1556807889, -20(%rbp)  # imm = 0x5CCB00D1
	movq	%rdi, -16(%rbp)
	movq	%rsi, -48(%rbp)
	movq	%rdx, -32(%rbp)
	movq	%rcx, -40(%rbp)
...
.LBB11_12:                              # %sw.epilog
	...
	jmp	.LBB11_5
.LBB11_13:                              # %while.end
	cmpl	$1556807889, -20(%rbp)  # imm = 0x5CCB00D1
	jne	.LBB11_15
.LBB11_14:
	addq	$64, %rsp
	popq	%rbp
