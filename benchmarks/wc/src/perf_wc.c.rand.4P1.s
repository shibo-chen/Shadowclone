...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$1142686431, -20(%rbp)  # imm = 0x441C02DF
	movq	%rdi, -16(%rbp)
	movq	%rsi, -48(%rbp)
	movq	%rdx, -32(%rbp)
	movq	%rcx, -56(%rbp)
...
.LBB4_12:                               # %sw.epilog
	...
	jmp	.LBB4_5
.LBB4_13:                               # %while.end
	cmpl	$1142686431, -20(%rbp)  # imm = 0x441C02DF
	jne	.LBB4_15
.LBB4_14:
	addq	$64, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$893024448, -20(%rbp)   # imm = 0x353A78C0
	movq	%rdi, -16(%rbp)
	movq	%rsi, -56(%rbp)
	movq	%rdx, -40(%rbp)
	movq	%rcx, -48(%rbp)
...
.LBB5_12:                               # %sw.epilog
	...
	jmp	.LBB5_5
.LBB5_13:                               # %while.end
	cmpl	$893024448, -20(%rbp)   # imm = 0x353A78C0
	jne	.LBB5_15
.LBB5_14:
	addq	$64, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$1727327429, -20(%rbp)  # imm = 0x66F4ECC5
	movq	%rdi, -16(%rbp)
	movq	%rsi, -48(%rbp)
	movq	%rdx, -32(%rbp)
	movq	%rcx, -56(%rbp)
...
.LBB6_12:                               # %sw.epilog
	...
	jmp	.LBB6_5
.LBB6_13:                               # %while.end
	cmpl	$1727327429, -20(%rbp)  # imm = 0x66F4ECC5
	jne	.LBB6_15
.LBB6_14:
	addq	$64, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$1017758428, -20(%rbp)  # imm = 0x3CA9C2DC
	movq	%rdi, -16(%rbp)
	movq	%rsi, -56(%rbp)
	movq	%rdx, -32(%rbp)
	movq	%rcx, -40(%rbp)
...
.LBB7_12:                               # %sw.epilog
	...
	jmp	.LBB7_5
.LBB7_13:                               # %while.end
	cmpl	$1017758428, -20(%rbp)  # imm = 0x3CA9C2DC
	jne	.LBB7_15
.LBB7_14:
	addq	$64, %rsp
	popq	%rbp
