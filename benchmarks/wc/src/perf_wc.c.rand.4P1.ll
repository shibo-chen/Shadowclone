; ModuleID = 'perf_wc.c.rand.4P1.bc'
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_wcp.3, label %func_wcp.4
}
...
entry:
  ...
  %canary = alloca i32
  store i32 1142686431, i32* %canary
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 893024448, i32* %canary
  %wordct_array.addr = alloca i64*, align 8
  store i8* %wd, i8** %wd.addr, align 8
  store i64 %charct, i64* %charct.addr, align 8
  store i64 %wordct, i64* %wordct.addr, align 8
...
entry:
  ...
  %wordct_array.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 1727327429, i32* %canary
  %i = alloca i32, align 4
  %wd.addr = alloca i8*, align 8
  %wordct.addr = alloca i64, align 8
  store i8* %wd, i8** %wd.addr, align 8
...
entry:
  ...
  %wd.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1017758428, i32* %canary
  %i = alloca i32, align 4
  %linect.addr = alloca i64, align 8
  %wordct.addr = alloca i64, align 8
  store i8* %wd, i8** %wd.addr, align 8
