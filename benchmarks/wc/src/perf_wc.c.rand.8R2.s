...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$184911604, -20(%rbp)   # imm = 0xB0586F4
	movq	%rdi, -16(%rbp)
	movq	%rsi, -32(%rbp)
	movq	%rdx, -56(%rbp)
	movq	%rcx, -40(%rbp)
...
.LBB4_12:                               # %sw.epilog
	...
	jmp	.LBB4_5
.LBB4_13:                               # %while.end
	cmpl	$184911604, -20(%rbp)   # imm = 0xB0586F4
	jne	.LBB4_15
.LBB4_14:
	addq	$64, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$1065448935, -20(%rbp)  # imm = 0x3F8175E7
	movq	%rdi, -16(%rbp)
	movq	%rsi, -56(%rbp)
	movq	%rdx, -40(%rbp)
	movq	%rcx, -48(%rbp)
...
.LBB5_12:                               # %sw.epilog
	...
	jmp	.LBB5_5
.LBB5_13:                               # %while.end
	cmpl	$1065448935, -20(%rbp)  # imm = 0x3F8175E7
	jne	.LBB5_15
.LBB5_14:
	addq	$64, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$1181625550, -20(%rbp)  # imm = 0x466E2CCE
	movq	%rdi, -16(%rbp)
	movq	%rsi, -48(%rbp)
	movq	%rdx, -40(%rbp)
	movq	%rcx, -56(%rbp)
...
.LBB6_12:                               # %sw.epilog
	...
	jmp	.LBB6_5
.LBB6_13:                               # %while.end
	cmpl	$1181625550, -20(%rbp)  # imm = 0x466E2CCE
	jne	.LBB6_15
.LBB6_14:
	addq	$64, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$919022271, -20(%rbp)   # imm = 0x36C72ABF
	movq	%rdi, -16(%rbp)
	movq	%rsi, -40(%rbp)
	movq	%rdx, -48(%rbp)
	movq	%rcx, -56(%rbp)
...
.LBB7_12:                               # %sw.epilog
	...
	jmp	.LBB7_5
.LBB7_13:                               # %while.end
	cmpl	$919022271, -20(%rbp)   # imm = 0x36C72ABF
	jne	.LBB7_15
.LBB7_14:
	addq	$64, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$1407609142, -20(%rbp)  # imm = 0x53E66936
	movq	%rdi, -16(%rbp)
	movq	%rsi, -32(%rbp)
	movq	%rdx, -56(%rbp)
	movq	%rcx, -48(%rbp)
...
.LBB8_12:                               # %sw.epilog
	...
	jmp	.LBB8_5
.LBB8_13:                               # %while.end
	cmpl	$1407609142, -20(%rbp)  # imm = 0x53E66936
	jne	.LBB8_15
.LBB8_14:
	addq	$64, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$339237044, -20(%rbp)   # imm = 0x143858B4
	movq	%rdi, -16(%rbp)
	movq	%rsi, -32(%rbp)
	movq	%rdx, -40(%rbp)
	movq	%rcx, -48(%rbp)
...
.LBB9_12:                               # %sw.epilog
	...
	jmp	.LBB9_5
.LBB9_13:                               # %while.end
	cmpl	$339237044, -20(%rbp)   # imm = 0x143858B4
	jne	.LBB9_15
.LBB9_14:
	addq	$64, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$264491840, -20(%rbp)   # imm = 0xFC3D340
	movq	%rdi, -16(%rbp)
	movq	%rsi, -40(%rbp)
	movq	%rdx, -32(%rbp)
	movq	%rcx, -56(%rbp)
...
.LBB10_12:                              # %sw.epilog
	...
	jmp	.LBB10_5
.LBB10_13:                              # %while.end
	cmpl	$264491840, -20(%rbp)   # imm = 0xFC3D340
	jne	.LBB10_15
.LBB10_14:
	addq	$64, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$916960834, -20(%rbp)   # imm = 0x36A7B642
	movq	%rdi, -16(%rbp)
	movq	%rsi, -48(%rbp)
	movq	%rdx, -40(%rbp)
	movq	%rcx, -32(%rbp)
...
.LBB11_12:                              # %sw.epilog
	...
	jmp	.LBB11_5
.LBB11_13:                              # %while.end
	cmpl	$916960834, -20(%rbp)   # imm = 0x36A7B642
	jne	.LBB11_15
.LBB11_14:
	addq	$64, %rsp
	popq	%rbp
