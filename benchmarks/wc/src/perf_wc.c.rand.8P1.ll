; ModuleID = 'perf_wc.c.rand.8P1.bc'
...
ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_wcp.7, label %func_wcp.8
}
...
entry:
  ...
  %canary = alloca i32
  store i32 998792327, i32* %canary
...
entry:
  ...
  %wordct_array.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 107141751, i32* %canary
  %linect.addr = alloca i64, align 8
  %i = alloca i32, align 4
  %wordct.addr = alloca i64, align 8
  %charct.addr = alloca i64, align 8
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1335172807, i32* %canary
  %wordct_array.addr = alloca i64*, align 8
  %wd.addr = alloca i8*, align 8
  %linect.addr = alloca i64, align 8
  %charct.addr = alloca i64, align 8
...
entry:
  ...
  %wordct_array.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 1418644877, i32* %canary
  %wordct.addr = alloca i64, align 8
  %charct.addr = alloca i64, align 8
  %i = alloca i32, align 4
  store i8* %wd, i8** %wd.addr, align 8
...
entry:
  ...
  %wordct.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1130941533, i32* %canary
  %wd.addr = alloca i8*, align 8
  %wordct_array.addr = alloca i64*, align 8
  store i8* %wd, i8** %wd.addr, align 8
  store i64 %charct, i64* %charct.addr, align 8
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1100206949, i32* %canary
  %charct.addr = alloca i64, align 8
  store i8* %wd, i8** %wd.addr, align 8
  store i64 %charct, i64* %charct.addr, align 8
  store i64 %wordct, i64* %wordct.addr, align 8
...
entry:
  %wordct_array.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 2093731257, i32* %canary
  %wd.addr = alloca i8*, align 8
  %charct.addr = alloca i64, align 8
  %wordct.addr = alloca i64, align 8
  %linect.addr = alloca i64, align 8
...
entry:
  %wordct_array.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 1556807889, i32* %canary
  %charct.addr = alloca i64, align 8
  %linect.addr = alloca i64, align 8
  %wd.addr = alloca i8*, align 8
  %i = alloca i32, align 4
