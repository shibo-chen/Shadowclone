...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$619327967, -20(%rbp)   # imm = 0x24EA31DF
	movq	%rdi, -16(%rbp)
	movq	%rsi, -32(%rbp)
	movq	%rdx, -56(%rbp)
	movq	%rcx, -48(%rbp)
...
.LBB4_12:                               # %sw.epilog
	...
	jmp	.LBB4_5
.LBB4_13:                               # %while.end
	cmpl	$619327967, -20(%rbp)   # imm = 0x24EA31DF
	jne	.LBB4_15
.LBB4_14:
	addq	$64, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$466224735, -20(%rbp)   # imm = 0x1BCA065F
	movq	%rdi, -16(%rbp)
	movq	%rsi, -40(%rbp)
	movq	%rdx, -48(%rbp)
	movq	%rcx, -56(%rbp)
...
.LBB5_12:                               # %sw.epilog
	...
	jmp	.LBB5_5
.LBB5_13:                               # %while.end
	cmpl	$466224735, -20(%rbp)   # imm = 0x1BCA065F
	jne	.LBB5_15
.LBB5_14:
	addq	$64, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$1017719357, -20(%rbp)  # imm = 0x3CA92A3D
	movq	%rdi, -16(%rbp)
	movq	%rsi, -32(%rbp)
	movq	%rdx, -40(%rbp)
	movq	%rcx, -56(%rbp)
...
.LBB6_12:                               # %sw.epilog
	...
	jmp	.LBB6_5
.LBB6_13:                               # %while.end
	cmpl	$1017719357, -20(%rbp)  # imm = 0x3CA92A3D
	jne	.LBB6_15
.LBB6_14:
	addq	$64, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$256172939, -20(%rbp)   # imm = 0xF44E38B
	movq	%rdi, -16(%rbp)
	movq	%rsi, -56(%rbp)
	movq	%rdx, -40(%rbp)
	movq	%rcx, -32(%rbp)
...
.LBB7_12:                               # %sw.epilog
	...
	jmp	.LBB7_5
.LBB7_13:                               # %while.end
	cmpl	$256172939, -20(%rbp)   # imm = 0xF44E38B
	jne	.LBB7_15
.LBB7_14:
	addq	$64, %rsp
	popq	%rbp
