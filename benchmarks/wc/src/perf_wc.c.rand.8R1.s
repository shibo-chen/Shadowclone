...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$1962321976, -20(%rbp)  # imm = 0x74F6A838
	movq	%rdi, -16(%rbp)
	movq	%rsi, -48(%rbp)
	movq	%rdx, -56(%rbp)
	movq	%rcx, -40(%rbp)
...
.LBB4_12:                               # %sw.epilog
	...
	jmp	.LBB4_5
.LBB4_13:                               # %while.end
	cmpl	$1962321976, -20(%rbp)  # imm = 0x74F6A838
	jne	.LBB4_15
.LBB4_14:
	addq	$64, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$1520367253, -20(%rbp)  # imm = 0x5A9EF695
	movq	%rdi, -16(%rbp)
	movq	%rsi, -48(%rbp)
	movq	%rdx, -32(%rbp)
	movq	%rcx, -40(%rbp)
...
.LBB5_12:                               # %sw.epilog
	...
	jmp	.LBB5_5
.LBB5_13:                               # %while.end
	cmpl	$1520367253, -20(%rbp)  # imm = 0x5A9EF695
	jne	.LBB5_15
.LBB5_14:
	addq	$64, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$499591325, -20(%rbp)   # imm = 0x1DC7289D
	movq	%rdi, -16(%rbp)
	movq	%rsi, -56(%rbp)
	movq	%rdx, -40(%rbp)
	movq	%rcx, -48(%rbp)
...
.LBB6_12:                               # %sw.epilog
	...
	jmp	.LBB6_5
.LBB6_13:                               # %while.end
	cmpl	$499591325, -20(%rbp)   # imm = 0x1DC7289D
	jne	.LBB6_15
.LBB6_14:
	addq	$64, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$331068485, -20(%rbp)   # imm = 0x13BBB445
	movq	%rdi, -16(%rbp)
	movq	%rsi, -56(%rbp)
	movq	%rdx, -32(%rbp)
	movq	%rcx, -48(%rbp)
...
.LBB7_12:                               # %sw.epilog
	...
	jmp	.LBB7_5
.LBB7_13:                               # %while.end
	cmpl	$331068485, -20(%rbp)   # imm = 0x13BBB445
	jne	.LBB7_15
.LBB7_14:
	addq	$64, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$1242243231, -20(%rbp)  # imm = 0x4A0B209F
	movq	%rdi, -16(%rbp)
	movq	%rsi, -32(%rbp)
	movq	%rdx, -56(%rbp)
	movq	%rcx, -40(%rbp)
...
.LBB8_12:                               # %sw.epilog
	...
	jmp	.LBB8_5
.LBB8_13:                               # %while.end
	cmpl	$1242243231, -20(%rbp)  # imm = 0x4A0B209F
	jne	.LBB8_15
.LBB8_14:
	addq	$64, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$1488805391, -20(%rbp)  # imm = 0x58BD5E0F
	movq	%rdi, -16(%rbp)
	movq	%rsi, -32(%rbp)
	movq	%rdx, -48(%rbp)
	movq	%rcx, -40(%rbp)
...
.LBB9_12:                               # %sw.epilog
	...
	jmp	.LBB9_5
.LBB9_13:                               # %while.end
	cmpl	$1488805391, -20(%rbp)  # imm = 0x58BD5E0F
	jne	.LBB9_15
.LBB9_14:
	addq	$64, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$318406320, -20(%rbp)   # imm = 0x12FA7EB0
	movq	%rdi, -16(%rbp)
	movq	%rsi, -32(%rbp)
	movq	%rdx, -48(%rbp)
	movq	%rcx, -40(%rbp)
...
.LBB10_12:                              # %sw.epilog
	...
	jmp	.LBB10_5
.LBB10_13:                              # %while.end
	cmpl	$318406320, -20(%rbp)   # imm = 0x12FA7EB0
	jne	.LBB10_15
.LBB10_14:
	addq	$64, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$866006505, -20(%rbp)   # imm = 0x339E35E9
	movq	%rdi, -16(%rbp)
	movq	%rsi, -40(%rbp)
	movq	%rdx, -32(%rbp)
	movq	%rcx, -48(%rbp)
...
.LBB11_12:                              # %sw.epilog
	...
	jmp	.LBB11_5
.LBB11_13:                              # %while.end
	cmpl	$866006505, -20(%rbp)   # imm = 0x339E35E9
	jne	.LBB11_15
.LBB11_14:
	addq	$64, %rsp
	popq	%rbp
