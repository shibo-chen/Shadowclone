; ModuleID = 'perf_wc.c.rand.4R3.bc'
...
entry:
  ...
  %canary = alloca i32
  store i32 619327967, i32* %canary
  %i = alloca i32, align 4
...
entry:
  ...
  %wd.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 466224735, i32* %canary
  %charct.addr = alloca i64, align 8
  %wordct_array.addr = alloca i64*, align 8
  %i = alloca i32, align 4
  store i8* %wd, i8** %wd.addr, align 8
...
entry:
  %linect.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1017719357, i32* %canary
  %wd.addr = alloca i8*, align 8
  %wordct_array.addr = alloca i64*, align 8
  %wordct.addr = alloca i64, align 8
  %charct.addr = alloca i64, align 8
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 256172939, i32* %canary
  %wordct.addr = alloca i64, align 8
  %linect.addr = alloca i64, align 8
  %wd.addr = alloca i8*, align 8
  store i8* %wd, i8** %wd.addr, align 8
