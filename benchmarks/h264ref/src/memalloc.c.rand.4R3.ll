; ModuleID = 'memalloc.c.rand.4R3.bc'
...
func_init_top_bot_planes.51:                      ; preds = %ctrl0
  %3 = call i32 @init_top_bot_planes.51(i16** %imgFrame, i32 %rows, i32 %columns, i16*** %imgTopField, i16*** %imgBotField)
  ret i32 %3

func_init_top_bot_planes.79:                      ; preds = %ctrl1
  %4 = call i32 @init_top_bot_planes.79(i16** %imgFrame, i32 %rows, i32 %columns, i16*** %imgTopField, i16*** %imgBotField)
  ret i32 %4

func_init_top_bot_planes.81:                      ; preds = %ctrl1
  %5 = call i32 @init_top_bot_planes.81(i16** %imgFrame, i32 %rows, i32 %columns, i16*** %imgTopField, i16*** %imgBotField)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_init_top_bot_planes.51, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_init_top_bot_planes.79, label %func_init_top_bot_planes.81
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_free_top_bot_planes.8, label %func_free_top_bot_planes.27

func_free_top_bot_planes.8:                       ; preds = %rand_bb
  call void @free_top_bot_planes.8(i16** %imgTopField, i16** %imgBotField)
  ret void
...
func_get_mem2Dpel.32:                             ; preds = %ctrl0
  %3 = call i32 @get_mem2Dpel.32(i16*** %array2D, i32 %rows, i32 %columns)
  ret i32 %3
...
func_get_mem2Dpel.71:                             ; preds = %ctrl1
  %5 = call i32 @get_mem2Dpel.71(i16*** %array2D, i32 %rows, i32 %columns)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_get_mem2Dpel.32, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_get_mem2Dpel.45, label %func_get_mem2Dpel.71
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_get_mem3Dpel.53, label %ctrl0

func_get_mem3Dpel.53:                             ; preds = %rand_bb
  %2 = call i32 @get_mem3Dpel.53(i16**** %array3D, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %2

func_get_mem3Dpel.62:                             ; preds = %ctrl0
  %3 = call i32 @get_mem3Dpel.62(i16**** %array3D, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %3
...
func_get_mem3Dpel.68:                             ; preds = %ctrl1
  %5 = call i32 @get_mem3Dpel.68(i16**** %array3D, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_get_mem3Dpel.62, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_get_mem3Dpel.64, label %func_get_mem3Dpel.68
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_free_mem3Dpel.2, label %ctrl0

func_free_mem3Dpel.2:                             ; preds = %rand_bb
  call void @free_mem3Dpel.2(i16*** %array3D, i32 %frames)
  ret void

func_free_mem3Dpel.12:                            ; preds = %ctrl0
  call void @free_mem3Dpel.12(i16*** %array3D, i32 %frames)
  ret void

func_free_mem3Dpel.13:                            ; preds = %ctrl1
  call void @free_mem3Dpel.13(i16*** %array3D, i32 %frames)
  ret void

func_free_mem3Dpel.34:                            ; preds = %ctrl1
  call void @free_mem3Dpel.34(i16*** %array3D, i32 %frames)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_free_mem3Dpel.12, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_free_mem3Dpel.13, label %func_free_mem3Dpel.34
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_get_mem2D.6, label %ctrl0

func_get_mem2D.6:                                 ; preds = %rand_bb
  %2 = call i32 @get_mem2D.6(i8*** %array2D, i32 %rows, i32 %columns)
  ret i32 %2

func_get_mem2D.38:                                ; preds = %ctrl0
  %3 = call i32 @get_mem2D.38(i8*** %array2D, i32 %rows, i32 %columns)
  ret i32 %3

func_get_mem2D.56:                                ; preds = %ctrl1
  %4 = call i32 @get_mem2D.56(i8*** %array2D, i32 %rows, i32 %columns)
  ret i32 %4

func_get_mem2D.67:                                ; preds = %ctrl1
  %5 = call i32 @get_mem2D.67(i8*** %array2D, i32 %rows, i32 %columns)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_get_mem2D.38, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_get_mem2D.56, label %func_get_mem2D.67
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_get_mem2Dint.36, label %ctrl0

func_get_mem2Dint.36:                             ; preds = %rand_bb
  %2 = call i32 @get_mem2Dint.36(i32*** %array2D, i32 %rows, i32 %columns)
  ret i32 %2
...
func_get_mem2Dint.78:                             ; preds = %ctrl1
  %4 = call i32 @get_mem2Dint.78(i32*** %array2D, i32 %rows, i32 %columns)
  ret i32 %4

func_get_mem2Dint.80:                             ; preds = %ctrl1
  %5 = call i32 @get_mem2Dint.80(i32*** %array2D, i32 %rows, i32 %columns)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_get_mem2Dint.65, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_get_mem2Dint.78, label %func_get_mem2Dint.80
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_get_mem2Dint64.25, label %ctrl0

func_get_mem2Dint64.25:                           ; preds = %rand_bb
  %2 = call i32 @get_mem2Dint64.25(i64*** %array2D, i32 %rows, i32 %columns)
  ret i32 %2

func_get_mem2Dint64.41:                           ; preds = %ctrl0
  %3 = call i32 @get_mem2Dint64.41(i64*** %array2D, i32 %rows, i32 %columns)
  ret i32 %3
...
func_get_mem2Dint64.57:                           ; preds = %ctrl1
  %5 = call i32 @get_mem2Dint64.57(i64*** %array2D, i32 %rows, i32 %columns)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_get_mem2Dint64.41, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_get_mem2Dint64.44, label %func_get_mem2Dint64.57
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_get_mem3D.7, label %ctrl0

func_get_mem3D.7:                                 ; preds = %rand_bb
  %2 = call i32 @get_mem3D.7(i8**** %array3D, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %2

func_get_mem3D.21:                                ; preds = %ctrl0
  %3 = call i32 @get_mem3D.21(i8**** %array3D, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %3

func_get_mem3D.24:                                ; preds = %ctrl1
  %4 = call i32 @get_mem3D.24(i8**** %array3D, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %4

func_get_mem3D.31:                                ; preds = %ctrl1
  %5 = call i32 @get_mem3D.31(i8**** %array3D, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_get_mem3D.21, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_get_mem3D.24, label %func_get_mem3D.31
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_get_mem3Dint.39, label %ctrl0

func_get_mem3Dint.39:                             ; preds = %rand_bb
  %2 = call i32 @get_mem3Dint.39(i32**** %array3D, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %2

func_get_mem3Dint.52:                             ; preds = %ctrl0
  %3 = call i32 @get_mem3Dint.52(i32**** %array3D, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %3

func_get_mem3Dint.69:                             ; preds = %ctrl1
  %4 = call i32 @get_mem3Dint.69(i32**** %array3D, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %4

func_get_mem3Dint.77:                             ; preds = %ctrl1
  %5 = call i32 @get_mem3Dint.77(i32**** %array3D, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_get_mem3Dint.52, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_get_mem3Dint.69, label %func_get_mem3Dint.77
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_get_mem3Dint64.11, label %ctrl0

func_get_mem3Dint64.11:                           ; preds = %rand_bb
  %2 = call i32 @get_mem3Dint64.11(i64**** %array3D, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %2

func_get_mem3Dint64.15:                           ; preds = %ctrl0
  %3 = call i32 @get_mem3Dint64.15(i64**** %array3D, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %3

func_get_mem3Dint64.35:                           ; preds = %ctrl1
  %4 = call i32 @get_mem3Dint64.35(i64**** %array3D, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %4

func_get_mem3Dint64.37:                           ; preds = %ctrl1
  %5 = call i32 @get_mem3Dint64.37(i64**** %array3D, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_get_mem3Dint64.15, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_get_mem3Dint64.35, label %func_get_mem3Dint64.37
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_get_mem4Dint.22, label %ctrl0

func_get_mem4Dint.22:                             ; preds = %rand_bb
  %2 = call i32 @get_mem4Dint.22(i32***** %array4D, i32 %idx, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %2

func_get_mem4Dint.23:                             ; preds = %ctrl0
  %3 = call i32 @get_mem4Dint.23(i32***** %array4D, i32 %idx, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %3

func_get_mem4Dint.28:                             ; preds = %ctrl1
  %4 = call i32 @get_mem4Dint.28(i32***** %array4D, i32 %idx, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %4

func_get_mem4Dint.29:                             ; preds = %ctrl1
  %5 = call i32 @get_mem4Dint.29(i32***** %array4D, i32 %idx, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_get_mem4Dint.23, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_get_mem4Dint.28, label %func_get_mem4Dint.29
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_free_mem3D.14, label %ctrl0

func_free_mem3D.14:                               ; preds = %rand_bb
  call void @free_mem3D.14(i8*** %array3D, i32 %frames)
  ret void

func_free_mem3D.26:                               ; preds = %ctrl0
  call void @free_mem3D.26(i8*** %array3D, i32 %frames)
  ret void

func_free_mem3D.42:                               ; preds = %ctrl1
  call void @free_mem3D.42(i8*** %array3D, i32 %frames)
  ret void

func_free_mem3D.54:                               ; preds = %ctrl1
  call void @free_mem3D.54(i8*** %array3D, i32 %frames)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_free_mem3D.26, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_free_mem3D.42, label %func_free_mem3D.54
}
...
func_free_mem3Dint.17:                            ; preds = %ctrl0
  call void @free_mem3Dint.17(i32*** %array3D, i32 %frames)
  ret void

func_free_mem3Dint.30:                            ; preds = %ctrl1
  call void @free_mem3Dint.30(i32*** %array3D, i32 %frames)
  ret void

func_free_mem3Dint.48:                            ; preds = %ctrl1
  call void @free_mem3Dint.48(i32*** %array3D, i32 %frames)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_free_mem3Dint.17, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_free_mem3Dint.30, label %func_free_mem3Dint.48
}
...
func_free_mem3Dint64.46:                          ; preds = %ctrl0
  call void @free_mem3Dint64.46(i64*** %array3D, i32 %frames)
  ret void

func_free_mem3Dint64.50:                          ; preds = %ctrl1
  call void @free_mem3Dint64.50(i64*** %array3D, i32 %frames)
  ret void

func_free_mem3Dint64.74:                          ; preds = %ctrl1
  call void @free_mem3Dint64.74(i64*** %array3D, i32 %frames)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_free_mem3Dint64.46, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_free_mem3Dint64.50, label %func_free_mem3Dint64.74
}
...
func_free_mem4Dint.55:                            ; preds = %ctrl0
  call void @free_mem4Dint.55(i32**** %array4D, i32 %idx, i32 %frames)
  ret void

func_free_mem4Dint.58:                            ; preds = %ctrl1
  call void @free_mem4Dint.58(i32**** %array4D, i32 %idx, i32 %frames)
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_free_mem4Dint.55, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_free_mem4Dint.58, label %func_free_mem4Dint.59
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_get_mem2Dshort.3, label %ctrl0

func_get_mem2Dshort.3:                            ; preds = %rand_bb
  %2 = call i32 @get_mem2Dshort.3(i16*** %array2D, i32 %rows, i32 %columns)
  ret i32 %2

func_get_mem2Dshort.16:                           ; preds = %ctrl0
  %3 = call i32 @get_mem2Dshort.16(i16*** %array2D, i32 %rows, i32 %columns)
  ret i32 %3

func_get_mem2Dshort.33:                           ; preds = %ctrl1
  %4 = call i32 @get_mem2Dshort.33(i16*** %array2D, i32 %rows, i32 %columns)
  ret i32 %4

func_get_mem2Dshort.47:                           ; preds = %ctrl1
  %5 = call i32 @get_mem2Dshort.47(i16*** %array2D, i32 %rows, i32 %columns)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_get_mem2Dshort.16, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_get_mem2Dshort.33, label %func_get_mem2Dshort.47
}
...
func_get_mem3Dshort.43:                           ; preds = %ctrl0
  %3 = call i32 @get_mem3Dshort.43(i16**** %array3D, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %3

func_get_mem3Dshort.66:                           ; preds = %ctrl1
  %4 = call i32 @get_mem3Dshort.66(i16**** %array3D, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %4

func_get_mem3Dshort.75:                           ; preds = %ctrl1
  %5 = call i32 @get_mem3Dshort.75(i16**** %array3D, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_get_mem3Dshort.43, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_get_mem3Dshort.66, label %func_get_mem3Dshort.75
}
...
func_get_mem4Dshort.61:                           ; preds = %ctrl0
  %3 = call i32 @get_mem4Dshort.61(i16***** %array4D, i32 %idx, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %3

func_get_mem4Dshort.70:                           ; preds = %ctrl1
  %4 = call i32 @get_mem4Dshort.70(i16***** %array4D, i32 %idx, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %4

func_get_mem4Dshort.76:                           ; preds = %ctrl1
  %5 = call i32 @get_mem4Dshort.76(i16***** %array4D, i32 %idx, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_get_mem4Dshort.61, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_get_mem4Dshort.70, label %func_get_mem4Dshort.76
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_free_mem3Dshort.10, label %ctrl0

func_free_mem3Dshort.10:                          ; preds = %rand_bb
  call void @free_mem3Dshort.10(i16*** %array3D, i32 %frames)
  ret void

func_free_mem3Dshort.49:                          ; preds = %ctrl0
  call void @free_mem3Dshort.49(i16*** %array3D, i32 %frames)
  ret void

func_free_mem3Dshort.60:                          ; preds = %ctrl1
  call void @free_mem3Dshort.60(i16*** %array3D, i32 %frames)
  ret void

func_free_mem3Dshort.63:                          ; preds = %ctrl1
  call void @free_mem3Dshort.63(i16*** %array3D, i32 %frames)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_free_mem3Dshort.49, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_free_mem3Dshort.60, label %func_free_mem3Dshort.63
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_free_mem4Dshort.40, label %ctrl0

func_free_mem4Dshort.40:                          ; preds = %rand_bb
  call void @free_mem4Dshort.40(i16**** %array4D, i32 %idx, i32 %frames)
  ret void

func_free_mem4Dshort.72:                          ; preds = %ctrl0
  call void @free_mem4Dshort.72(i16**** %array4D, i32 %idx, i32 %frames)
  ret void

func_free_mem4Dshort.73:                          ; preds = %ctrl1
  call void @free_mem4Dshort.73(i16**** %array4D, i32 %idx, i32 %frames)
  ret void

func_free_mem4Dshort.82:                          ; preds = %ctrl1
  call void @free_mem4Dshort.82(i16**** %array4D, i32 %idx, i32 %frames)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_free_mem4Dshort.72, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_free_mem4Dshort.73, label %func_free_mem4Dshort.82
}
...
entry:
  ...
  %canary = alloca i32
  store i32 885939498, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_mem3Dpel.2(i16*** %array3D, i32 %frames) #0 {
entry:
  %array3D.addr = alloca i16***, align 8
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1997221484, i32* %canary
  %frames.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem2Dshort.3(i16*** %array2D, i32 %rows, i32 %columns) #0 {
entry:
  %canary = alloca i32
  store i32 1971554307, i32* %canary
  %array2D.addr = alloca i16***, align 8
...
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 621768738, i32* %canary
  %rows.addr = alloca i32, align 4
  %columns.addr = alloca i32, align 4
  %array2D.addr = alloca i16***, align 8
  store i16*** %array2D, i16**** %array2D.addr, align 8
...
entry:
  ...
  %canary = alloca i32
  store i32 343858016, i32* %canary
  %columns.addr = alloca i32, align 4
  store i16**** %array3D, i16***** %array3D.addr, align 8
  store i32 %frames, i32* %frames.addr, align 4
  store i32 %rows, i32* %rows.addr, align 4
...
entry:
  %columns.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 706159595, i32* %canary
  %rows.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %array2D.addr = alloca i8***, align 8
  store i8*** %array2D, i8**** %array2D.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem3D.7(i8**** %array3D, i32 %frames, i32 %rows, i32 %columns) #0 {
entry:
  %array3D.addr = alloca i8****, align 8
  %rows.addr = alloca i32, align 4
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 532833245, i32* %canary
  %columns.addr = alloca i32, align 4
  %frames.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_top_bot_planes.8(i16** %imgTopField, i16** %imgBotField) #0 {
entry:
  %imgTopField.addr = alloca i16**, align 8
  %canary = alloca i32
  store i32 569392668, i32* %canary
...
entry:
  %imgTopField.addr = alloca i16***, align 8
  %canary = alloca i32
  store i32 2051174383, i32* %canary
  %columns.addr = alloca i32, align 4
  %imgBotField.addr = alloca i16***, align 8
  %rows.addr = alloca i32, align 4
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_mem3Dshort.10(i16*** %array3D, i32 %frames) #0 {
entry:
  %i = alloca i32, align 4
  %array3D.addr = alloca i16***, align 8
  %canary = alloca i32
  store i32 130249839, i32* %canary
  %frames.addr = alloca i32, align 4
  store i16*** %array3D, i16**** %array3D.addr, align 8
  store i32 %frames, i32* %frames.addr, align 4
  %0 = load i16***, i16**** %array3D.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem3Dint64.11(i64**** %array3D, i32 %frames, i32 %rows, i32 %columns) #0 {
entry:
  %array3D.addr = alloca i64****, align 8
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1286970380, i32* %canary
  %rows.addr = alloca i32, align 4
  %frames.addr = alloca i32, align 4
  %columns.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_mem3Dpel.12(i16*** %array3D, i32 %frames) #0 {
entry:
  %canary = alloca i32
  store i32 1103175622, i32* %canary
  %array3D.addr = alloca i16***, align 8
  %frames.addr = alloca i32, align 4
  %i = alloca i32, align 4
  store i16*** %array3D, i16**** %array3D.addr, align 8
...
entry:
  ...
  %frames.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 989046440, i32* %canary
  %array3D.addr = alloca i16***, align 8
  store i16*** %array3D, i16**** %array3D.addr, align 8
  store i32 %frames, i32* %frames.addr, align 4
  %0 = load i16***, i16**** %array3D.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_mem3D.14(i8*** %array3D, i32 %frames) #0 {
entry:
  %canary = alloca i32
  store i32 755730069, i32* %canary
  %frames.addr = alloca i32, align 4
  %array3D.addr = alloca i8***, align 8
  %i = alloca i32, align 4
  store i8*** %array3D, i8**** %array3D.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem3Dint64.15(i64**** %array3D, i32 %frames, i32 %rows, i32 %columns) #0 {
entry:
  %rows.addr = alloca i32, align 4
  %array3D.addr = alloca i64****, align 8
  %columns.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1570995660, i32* %canary
  %j = alloca i32, align 4
  %frames.addr = alloca i32, align 4
  store i64**** %array3D, i64***** %array3D.addr, align 8
  store i32 %frames, i32* %frames.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem2Dshort.16(i16*** %array2D, i32 %rows, i32 %columns) #0 {
entry:
  %canary = alloca i32
  store i32 307444455, i32* %canary
  %array2D.addr = alloca i16***, align 8
  %columns.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %rows.addr = alloca i32, align 4
...
entry:
  ...
  %array3D.addr = alloca i32***, align 8
  %canary = alloca i32
  store i32 2070657566, i32* %canary
  %i = alloca i32, align 4
  store i32*** %array3D, i32**** %array3D.addr, align 8
  store i32 %frames, i32* %frames.addr, align 4
  %0 = load i32***, i32**** %array3D.addr, align 8
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 233846116, i32* %canary
  %frames.addr = alloca i32, align 4
  store i64*** %array3D, i64**** %array3D.addr, align 8
  store i32 %frames, i32* %frames.addr, align 4
...
entry:
  ...
  %frames.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 144626667, i32* %canary
  %columns.addr = alloca i32, align 4
  %rows.addr = alloca i32, align 4
  %j = alloca i32, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 2092216075, i32* %canary
  %idx.addr = alloca i32, align 4
  %frames.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem3D.21(i8**** %array3D, i32 %frames, i32 %rows, i32 %columns) #0 {
entry:
  %canary = alloca i32
  store i32 557532089, i32* %canary
  %array3D.addr = alloca i8****, align 8
  %columns.addr = alloca i32, align 4
  %j = alloca i32, align 4
  %frames.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem4Dint.22(i32***** %array4D, i32 %idx, i32 %frames, i32 %rows, i32 %columns) #0 {
entry:
  %idx.addr = alloca i32, align 4
  %rows.addr = alloca i32, align 4
  %frames.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1473647517, i32* %canary
  %array4D.addr = alloca i32*****, align 8
  %columns.addr = alloca i32, align 4
  %j = alloca i32, align 4
  store i32***** %array4D, i32****** %array4D.addr, align 8
...
entry:
  ...
  %columns.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 570496366, i32* %canary
  %array4D.addr = alloca i32*****, align 8
  store i32***** %array4D, i32****** %array4D.addr, align 8
  store i32 %idx, i32* %idx.addr, align 4
  store i32 %frames, i32* %frames.addr, align 4
...
entry:
  ...
  %rows.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1187786389, i32* %canary
  %frames.addr = alloca i32, align 4
  %columns.addr = alloca i32, align 4
  store i8**** %array3D, i8***** %array3D.addr, align 8
  store i32 %frames, i32* %frames.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem2Dint64.25(i64*** %array2D, i32 %rows, i32 %columns) #0 {
entry:
  %canary = alloca i32
  store i32 387910618, i32* %canary
  %i = alloca i32, align 4
  %rows.addr = alloca i32, align 4
  %columns.addr = alloca i32, align 4
  %array2D.addr = alloca i64***, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_mem3D.26(i8*** %array3D, i32 %frames) #0 {
entry:
  %canary = alloca i32
  store i32 1637146244, i32* %canary
  %array3D.addr = alloca i8***, align 8
  %i = alloca i32, align 4
  %frames.addr = alloca i32, align 4
  store i8*** %array3D, i8**** %array3D.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1552484907, i32* %canary
  %imgBotField.addr = alloca i16**, align 8
  %imgTopField.addr = alloca i16**, align 8
  store i16** %imgTopField, i16*** %imgTopField.addr, align 8
  store i16** %imgBotField, i16*** %imgBotField.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem4Dint.29(i32***** %array4D, i32 %idx, i32 %frames, i32 %rows, i32 %columns) #0 {
entry:
  %columns.addr = alloca i32, align 4
  %j = alloca i32, align 4
  %rows.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 570376370, i32* %canary
  %idx.addr = alloca i32, align 4
  %array4D.addr = alloca i32*****, align 8
  %frames.addr = alloca i32, align 4
  store i32***** %array4D, i32****** %array4D.addr, align 8
...
entry:
  %frames.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1157074644, i32* %canary
  %i = alloca i32, align 4
  %array3D.addr = alloca i32***, align 8
  store i32*** %array3D, i32**** %array3D.addr, align 8
  store i32 %frames, i32* %frames.addr, align 4
...
entry:
  ...
  %frames.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1027540910, i32* %canary
  %columns.addr = alloca i32, align 4
  %rows.addr = alloca i32, align 4
  store i8**** %array3D, i8***** %array3D.addr, align 8
  store i32 %frames, i32* %frames.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem2Dpel.32(i16*** %array2D, i32 %rows, i32 %columns) #0 {
entry:
  %array2D.addr = alloca i16***, align 8
  %i = alloca i32, align 4
  %columns.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1691992323, i32* %canary
  %rows.addr = alloca i32, align 4
  store i16*** %array2D, i16**** %array2D.addr, align 8
  store i32 %rows, i32* %rows.addr, align 4
  store i32 %columns, i32* %columns.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem2Dshort.33(i16*** %array2D, i32 %rows, i32 %columns) #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 525107086, i32* %canary
  %array2D.addr = alloca i16***, align 8
  %columns.addr = alloca i32, align 4
  %rows.addr = alloca i32, align 4
  store i16*** %array2D, i16**** %array2D.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 206790150, i32* %canary
  %frames.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %array3D.addr = alloca i16***, align 8
  store i16*** %array3D, i16**** %array3D.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem3Dint64.35(i64**** %array3D, i32 %frames, i32 %rows, i32 %columns) #0 {
entry:
  %columns.addr = alloca i32, align 4
  %j = alloca i32, align 4
  %array3D.addr = alloca i64****, align 8
  %rows.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 382655265, i32* %canary
  %frames.addr = alloca i32, align 4
  store i64**** %array3D, i64***** %array3D.addr, align 8
  store i32 %frames, i32* %frames.addr, align 4
  store i32 %rows, i32* %rows.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem2Dint.36(i32*** %array2D, i32 %rows, i32 %columns) #0 {
entry:
  %columns.addr = alloca i32, align 4
  %rows.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 339186888, i32* %canary
  %i = alloca i32, align 4
  %array2D.addr = alloca i32***, align 8
  store i32*** %array2D, i32**** %array2D.addr, align 8
  store i32 %rows, i32* %rows.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem3Dint64.37(i64**** %array3D, i32 %frames, i32 %rows, i32 %columns) #0 {
entry:
  %array3D.addr = alloca i64****, align 8
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 911264337, i32* %canary
  %frames.addr = alloca i32, align 4
  %columns.addr = alloca i32, align 4
  %rows.addr = alloca i32, align 4
  store i64**** %array3D, i64***** %array3D.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem2D.38(i8*** %array2D, i32 %rows, i32 %columns) #0 {
entry:
  %i = alloca i32, align 4
  %rows.addr = alloca i32, align 4
  %array2D.addr = alloca i8***, align 8
  %canary = alloca i32
  store i32 1212148108, i32* %canary
  %columns.addr = alloca i32, align 4
  store i8*** %array2D, i8**** %array2D.addr, align 8
  store i32 %rows, i32* %rows.addr, align 4
  store i32 %columns, i32* %columns.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem3Dint.39(i32**** %array3D, i32 %frames, i32 %rows, i32 %columns) #0 {
entry:
  %j = alloca i32, align 4
  %array3D.addr = alloca i32****, align 8
  %canary = alloca i32
  store i32 1693214003, i32* %canary
  %frames.addr = alloca i32, align 4
  %rows.addr = alloca i32, align 4
  %columns.addr = alloca i32, align 4
  store i32**** %array3D, i32***** %array3D.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_mem4Dshort.40(i16**** %array4D, i32 %idx, i32 %frames) #0 {
entry:
  %canary = alloca i32
  store i32 855150435, i32* %canary
  %array4D.addr = alloca i16****, align 8
  %j = alloca i32, align 4
  %frames.addr = alloca i32, align 4
  %idx.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem2Dint64.41(i64*** %array2D, i32 %rows, i32 %columns) #0 {
entry:
  %array2D.addr = alloca i64***, align 8
  %columns.addr = alloca i32, align 4
  %rows.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 116784246, i32* %canary
  %i = alloca i32, align 4
  store i64*** %array2D, i64**** %array2D.addr, align 8
  store i32 %rows, i32* %rows.addr, align 4
  store i32 %columns, i32* %columns.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 1612508269, i32* %canary
  %i = alloca i32, align 4
  %array3D.addr = alloca i8***, align 8
  %frames.addr = alloca i32, align 4
  store i8*** %array3D, i8**** %array3D.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem3Dshort.43(i16**** %array3D, i32 %frames, i32 %rows, i32 %columns) #0 {
entry:
  %columns.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 627681682, i32* %canary
  %j = alloca i32, align 4
  %rows.addr = alloca i32, align 4
  %frames.addr = alloca i32, align 4
  %array3D.addr = alloca i16****, align 8
...
entry:
  ...
  %rows.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1961473589, i32* %canary
  %i = alloca i32, align 4
  %columns.addr = alloca i32, align 4
  store i64*** %array2D, i64**** %array2D.addr, align 8
  store i32 %rows, i32* %rows.addr, align 4
...
entry:
  ...
  %columns.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1600663443, i32* %canary
  %i = alloca i32, align 4
  store i16*** %array2D, i16**** %array2D.addr, align 8
  store i32 %rows, i32* %rows.addr, align 4
  store i32 %columns, i32* %columns.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_mem3Dint64.46(i64*** %array3D, i32 %frames) #0 {
entry:
  %frames.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1671929378, i32* %canary
  %i = alloca i32, align 4
  %array3D.addr = alloca i64***, align 8
  store i64*** %array3D, i64**** %array3D.addr, align 8
  store i32 %frames, i32* %frames.addr, align 4
...
entry:
  ...
  %rows.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2135855649, i32* %canary
  %array2D.addr = alloca i16***, align 8
  %i = alloca i32, align 4
  store i16*** %array2D, i16**** %array2D.addr, align 8
  store i32 %rows, i32* %rows.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_mem3Dint.48(i32*** %array3D, i32 %frames) #0 {
entry:
  %array3D.addr = alloca i32***, align 8
  %canary = alloca i32
  store i32 386485106, i32* %canary
  %i = alloca i32, align 4
  %frames.addr = alloca i32, align 4
  store i32*** %array3D, i32**** %array3D.addr, align 8
  store i32 %frames, i32* %frames.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_mem3Dshort.49(i16*** %array3D, i32 %frames) #0 {
entry:
  %canary = alloca i32
  store i32 31829066, i32* %canary
  %i = alloca i32, align 4
  %frames.addr = alloca i32, align 4
  %array3D.addr = alloca i16***, align 8
  store i16*** %array3D, i16**** %array3D.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_mem3Dint64.50(i64*** %array3D, i32 %frames) #0 {
entry:
  %array3D.addr = alloca i64***, align 8
  %frames.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1773217745, i32* %canary
  %i = alloca i32, align 4
  store i64*** %array3D, i64**** %array3D.addr, align 8
  store i32 %frames, i32* %frames.addr, align 4
  %0 = load i64***, i64**** %array3D.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @init_top_bot_planes.51(i16** %imgFrame, i32 %rows, i32 %columns, i16*** %imgTopField, i16*** %imgBotField) #0 {
entry:
  %i = alloca i32, align 4
  %rows.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 847786003, i32* %canary
  %imgTopField.addr = alloca i16***, align 8
  %imgFrame.addr = alloca i16**, align 8
  %imgBotField.addr = alloca i16***, align 8
  %columns.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem3Dint.52(i32**** %array3D, i32 %frames, i32 %rows, i32 %columns) #0 {
entry:
  %canary = alloca i32
  store i32 221476791, i32* %canary
  %columns.addr = alloca i32, align 4
  %rows.addr = alloca i32, align 4
  %array3D.addr = alloca i32****, align 8
  %frames.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem3Dpel.53(i16**** %array3D, i32 %frames, i32 %rows, i32 %columns) #0 {
entry:
  %canary = alloca i32
  store i32 1729053655, i32* %canary
  %j = alloca i32, align 4
  %frames.addr = alloca i32, align 4
  %rows.addr = alloca i32, align 4
  %columns.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_mem3D.54(i8*** %array3D, i32 %frames) #0 {
entry:
  %canary = alloca i32
  store i32 2076276413, i32* %canary
  %array3D.addr = alloca i8***, align 8
  %frames.addr = alloca i32, align 4
  %i = alloca i32, align 4
  store i8*** %array3D, i8**** %array3D.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_mem4Dint.55(i32**** %array4D, i32 %idx, i32 %frames) #0 {
entry:
  %canary = alloca i32
  store i32 1082389337, i32* %canary
  %frames.addr = alloca i32, align 4
  %idx.addr = alloca i32, align 4
  %array4D.addr = alloca i32****, align 8
  %j = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem2D.56(i8*** %array2D, i32 %rows, i32 %columns) #0 {
entry:
  %array2D.addr = alloca i8***, align 8
  %canary = alloca i32
  store i32 1101921085, i32* %canary
  %i = alloca i32, align 4
  %columns.addr = alloca i32, align 4
  %rows.addr = alloca i32, align 4
  store i8*** %array2D, i8**** %array2D.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem2Dint64.57(i64*** %array2D, i32 %rows, i32 %columns) #0 {
entry:
  %canary = alloca i32
  store i32 1521639306, i32* %canary
  %array2D.addr = alloca i64***, align 8
  %i = alloca i32, align 4
  %columns.addr = alloca i32, align 4
  %rows.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_mem4Dint.58(i32**** %array4D, i32 %idx, i32 %frames) #0 {
entry:
  %canary = alloca i32
  store i32 1833423085, i32* %canary
  %frames.addr = alloca i32, align 4
  %j = alloca i32, align 4
  %idx.addr = alloca i32, align 4
  %array4D.addr = alloca i32****, align 8
...
entry:
  %canary = alloca i32
  store i32 1327239522, i32* %canary
  %j = alloca i32, align 4
  %frames.addr = alloca i32, align 4
  %idx.addr = alloca i32, align 4
  %array4D.addr = alloca i32****, align 8
...
entry:
  %canary = alloca i32
  store i32 1867465883, i32* %canary
  %frames.addr = alloca i32, align 4
  %array3D.addr = alloca i16***, align 8
  %i = alloca i32, align 4
  store i16*** %array3D, i16**** %array3D.addr, align 8
...
entry:
  ...
  %columns.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1488680684, i32* %canary
  %rows.addr = alloca i32, align 4
  %frames.addr = alloca i32, align 4
  %idx.addr = alloca i32, align 4
  store i16***** %array4D, i16****** %array4D.addr, align 8
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1433543373, i32* %canary
  %columns.addr = alloca i32, align 4
  store i16**** %array3D, i16***** %array3D.addr, align 8
  store i32 %frames, i32* %frames.addr, align 4
  store i32 %rows, i32* %rows.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_mem3Dshort.63(i16*** %array3D, i32 %frames) #0 {
entry:
  %array3D.addr = alloca i16***, align 8
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 2019030985, i32* %canary
  %frames.addr = alloca i32, align 4
  store i16*** %array3D, i16**** %array3D.addr, align 8
  store i32 %frames, i32* %frames.addr, align 4
  %0 = load i16***, i16**** %array3D.addr, align 8
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1864195631, i32* %canary
  %array3D.addr = alloca i16****, align 8
  store i16**** %array3D, i16***** %array3D.addr, align 8
  store i32 %frames, i32* %frames.addr, align 4
  store i32 %rows, i32* %rows.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 770358097, i32* %canary
  %array2D.addr = alloca i32***, align 8
  %rows.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %columns.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem2D.67(i8*** %array2D, i32 %rows, i32 %columns) #0 {
entry:
  %columns.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 215036735, i32* %canary
  %array2D.addr = alloca i8***, align 8
  %rows.addr = alloca i32, align 4
  store i8*** %array2D, i8**** %array2D.addr, align 8
  store i32 %rows, i32* %rows.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem3Dpel.68(i16**** %array3D, i32 %frames, i32 %rows, i32 %columns) #0 {
entry:
  %canary = alloca i32
  store i32 2007517093, i32* %canary
  %columns.addr = alloca i32, align 4
  %rows.addr = alloca i32, align 4
  %array3D.addr = alloca i16****, align 8
  %j = alloca i32, align 4
...
entry:
  ...
  %rows.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 478901971, i32* %canary
  %frames.addr = alloca i32, align 4
  %j = alloca i32, align 4
  %array3D.addr = alloca i32****, align 8
  store i32**** %array3D, i32***** %array3D.addr, align 8
...
entry:
  ...
  %idx.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1948041923, i32* %canary
  %rows.addr = alloca i32, align 4
  store i16***** %array4D, i16****** %array4D.addr, align 8
  store i32 %idx, i32* %idx.addr, align 4
  store i32 %frames, i32* %frames.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem2Dpel.71(i16*** %array2D, i32 %rows, i32 %columns) #0 {
entry:
  %array2D.addr = alloca i16***, align 8
  %canary = alloca i32
  store i32 311688699, i32* %canary
  %i = alloca i32, align 4
  %rows.addr = alloca i32, align 4
  %columns.addr = alloca i32, align 4
  store i16*** %array2D, i16**** %array2D.addr, align 8
...
entry:
  ...
  %idx.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1713013377, i32* %canary
  %j = alloca i32, align 4
  store i16**** %array4D, i16***** %array4D.addr, align 8
  store i32 %idx, i32* %idx.addr, align 4
  store i32 %frames, i32* %frames.addr, align 4
...
entry:
  %array4D.addr = alloca i16****, align 8
  %canary = alloca i32
  store i32 1621029172, i32* %canary
  %frames.addr = alloca i32, align 4
  %j = alloca i32, align 4
  %idx.addr = alloca i32, align 4
  store i16**** %array4D, i16***** %array4D.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_mem3Dint64.74(i64*** %array3D, i32 %frames) #0 {
entry:
  %frames.addr = alloca i32, align 4
  %array3D.addr = alloca i64***, align 8
  %canary = alloca i32
  store i32 608426361, i32* %canary
  %i = alloca i32, align 4
  store i64*** %array3D, i64**** %array3D.addr, align 8
  store i32 %frames, i32* %frames.addr, align 4
  %0 = load i64***, i64**** %array3D.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem3Dshort.75(i16**** %array3D, i32 %frames, i32 %rows, i32 %columns) #0 {
entry:
  %columns.addr = alloca i32, align 4
  %j = alloca i32, align 4
  %frames.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1937134212, i32* %canary
  %rows.addr = alloca i32, align 4
  %array3D.addr = alloca i16****, align 8
  store i16**** %array3D, i16***** %array3D.addr, align 8
  store i32 %frames, i32* %frames.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem4Dshort.76(i16***** %array4D, i32 %idx, i32 %frames, i32 %rows, i32 %columns) #0 {
entry:
  %j = alloca i32, align 4
  %rows.addr = alloca i32, align 4
  %idx.addr = alloca i32, align 4
  ...
  %frames.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 791077322, i32* %canary
  %array4D.addr = alloca i16*****, align 8
  store i16***** %array4D, i16****** %array4D.addr, align 8
  store i32 %idx, i32* %idx.addr, align 4
  store i32 %frames, i32* %frames.addr, align 4
...
entry:
  ...
  %columns.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1197376302, i32* %canary
  %frames.addr = alloca i32, align 4
  %rows.addr = alloca i32, align 4
  %j = alloca i32, align 4
  store i32**** %array3D, i32***** %array3D.addr, align 8
...
entry:
  ...
  %array2D.addr = alloca i32***, align 8
  %canary = alloca i32
  store i32 1663733833, i32* %canary
  %columns.addr = alloca i32, align 4
  store i32*** %array2D, i32**** %array2D.addr, align 8
  store i32 %rows, i32* %rows.addr, align 4
  store i32 %columns, i32* %columns.addr, align 4
...
entry:
  %imgBotField.addr = alloca i16***, align 8
  %canary = alloca i32
  store i32 1108739676, i32* %canary
  %rows.addr = alloca i32, align 4
  %imgFrame.addr = alloca i16**, align 8
  %imgTopField.addr = alloca i16***, align 8
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem2Dint.80(i32*** %array2D, i32 %rows, i32 %columns) #0 {
entry:
  %canary = alloca i32
  store i32 1980804571, i32* %canary
  %rows.addr = alloca i32, align 4
  %array2D.addr = alloca i32***, align 8
  %i = alloca i32, align 4
  %columns.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @init_top_bot_planes.81(i16** %imgFrame, i32 %rows, i32 %columns, i16*** %imgTopField, i16*** %imgBotField) #0 {
entry:
  %imgFrame.addr = alloca i16**, align 8
  %imgBotField.addr = alloca i16***, align 8
  %canary = alloca i32
  store i32 1780896715, i32* %canary
  %imgTopField.addr = alloca i16***, align 8
  %i = alloca i32, align 4
  %rows.addr = alloca i32, align 4
  %columns.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_mem4Dshort.82(i16**** %array4D, i32 %idx, i32 %frames) #0 {
entry:
  %canary = alloca i32
  store i32 1349156782, i32* %canary
  %j = alloca i32, align 4
  %idx.addr = alloca i32, align 4
  %array4D.addr = alloca i16****, align 8
  %frames.addr = alloca i32, align 4
