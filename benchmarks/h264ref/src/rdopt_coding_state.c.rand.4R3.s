...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$96, %rsp
	movl	$51084387, -44(%rbp)    # imm = 0x30B7C63
	movq	%rdi, -16(%rbp)
	movq	img, %rax
	movq	14160(%rax), %rax
	movq	32(%rax), %rax
...
.LBB4_19:                               # %if.end41
	...
	movq	%rax, 504(%rcx)
.LBB4_20:                               # %return
	cmpl	$51084387, -44(%rbp)    # imm = 0x30B7C63
	jne	.LBB4_22
.LBB4_21:
	addq	$96, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$96, %rsp
	movl	$1839752610, -44(%rbp)  # imm = 0x6DA865A2
	movq	%rdi, -16(%rbp)
	movq	img, %rax
	movq	14160(%rax), %rax
	movq	32(%rax), %rax
...
.LBB5_19:                               # %if.end41
	...
	movq	%rax, 344(%rcx)
.LBB5_20:                               # %return
	cmpl	$1839752610, -44(%rbp)  # imm = 0x6DA865A2
	jne	.LBB5_22
.LBB5_21:
	addq	$96, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$96, %rsp
	movl	$1282372172, -44(%rbp)  # imm = 0x4C6F724C
	movq	%rdi, -16(%rbp)
	movq	img, %rax
	movq	14160(%rax), %rax
	movq	32(%rax), %rax
...
.LBB6_19:                               # %if.end41
	...
	movq	%rax, 504(%rcx)
.LBB6_20:                               # %return
	cmpl	$1282372172, -44(%rbp)  # imm = 0x4C6F724C
	jne	.LBB6_22
.LBB6_21:
	addq	$96, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$96, %rsp
	movl	$172505151, -44(%rbp)   # imm = 0xA48383F
	movq	%rdi, -16(%rbp)
	movq	img, %rax
	movq	14160(%rax), %rax
	movq	32(%rax), %rax
...
.LBB7_19:                               # %if.end41
	...
	movq	%rax, 344(%rcx)
.LBB7_20:                               # %return
	cmpl	$172505151, -44(%rbp)   # imm = 0xA48383F
	jne	.LBB7_22
.LBB7_21:
	addq	$96, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$96, %rsp
	movl	$1224403729, -44(%rbp)  # imm = 0x48FAEB11
	movq	%rdi, -16(%rbp)
	movq	img, %rax
	movq	14160(%rax), %rax
	movq	32(%rax), %rax
...
.LBB8_19:                               # %if.end41
	...
	movq	%rax, 344(%rcx)
.LBB8_20:                               # %return
	cmpl	$1224403729, -44(%rbp)  # imm = 0x48FAEB11
	jne	.LBB8_22
.LBB8_21:
	addq	$96, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$96, %rsp
	movl	$58986396, -44(%rbp)    # imm = 0x3840F9C
	movq	%rdi, -16(%rbp)
	movq	img, %rax
	movq	14160(%rax), %rax
	movq	32(%rax), %rax
...
.LBB9_19:                               # %if.end41
	...
	movq	%rax, 344(%rcx)
.LBB9_20:                               # %return
	cmpl	$58986396, -44(%rbp)    # imm = 0x3840F9C
	jne	.LBB9_22
.LBB9_21:
	addq	$96, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$96, %rsp
	movl	$1009930046, -44(%rbp)  # imm = 0x3C324F3E
	movq	%rdi, -16(%rbp)
	movq	img, %rax
	movq	14160(%rax), %rax
	movq	32(%rax), %rax
...
.LBB10_19:                              # %if.end41
	...
	movq	%rax, 504(%rcx)
.LBB10_20:                              # %return
	cmpl	$1009930046, -44(%rbp)  # imm = 0x3C324F3E
	jne	.LBB10_22
.LBB10_21:
	addq	$96, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$96, %rsp
	movl	$1462443300, -44(%rbp)  # imm = 0x572B1D24
	movq	%rdi, -16(%rbp)
	movq	img, %rax
	movq	14160(%rax), %rax
	movq	32(%rax), %rax
...
.LBB11_19:                              # %if.end41
	...
	movq	%rax, 504(%rcx)
.LBB11_20:                              # %return
	cmpl	$1462443300, -44(%rbp)  # imm = 0x572B1D24
	jne	.LBB11_22
.LBB11_21:
	addq	$96, %rsp
	popq	%rbp
