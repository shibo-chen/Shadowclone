; ModuleID = 'intrarefresh.c.rand.4R1.bc'
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_RandomIntra.4, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_RandomIntra.5, label %func_RandomIntra.7
}
...
entry:
  ...
  %canary = alloca i32
  store i32 1876859350, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1378989017, i32* %canary
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %0 = load i32, i32* @NumberIntraPerPicture, align 4
  %1 = load i32, i32* @WalkAround, align 4
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 283354688, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1500183770, i32* %canary
  %mb.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  %i = alloca i32, align 4
  store i32 %mb, i32* %mb.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 1605484019, i32* %canary
  %retval = alloca i32, align 4
  %mb.addr = alloca i32, align 4
  %i = alloca i32, align 4
  store i32 %mb, i32* %mb.addr, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 494543614, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 105654707, i32* %canary
  %i = alloca i32, align 4
  %retval = alloca i32, align 4
  %mb.addr = alloca i32, align 4
  store i32 %mb, i32* %mb.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 371516859, i32* %canary
  %ysize.addr = alloca i32, align 4
  %xsize.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %pos = alloca i32, align 4
...
entry:
  ...
  %refresh.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2110025451, i32* %canary
  %ysize.addr = alloca i32, align 4
  store i32 %xsize, i32* %xsize.addr, align 4
  store i32 %ysize, i32* %ysize.addr, align 4
  store i32 %refresh, i32* %refresh.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 495954923, i32* %canary
  %ysize.addr = alloca i32, align 4
  %xsize.addr = alloca i32, align 4
  %refresh.addr = alloca i32, align 4
  %i = alloca i32, align 4
