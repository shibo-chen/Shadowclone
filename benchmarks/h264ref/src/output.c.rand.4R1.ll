...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_testEndian.1, label %func_testEndian.3
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_img2buf.15, label %func_img2buf.21
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_write_picture.4, label %ctrl0

func_write_picture.4:                             ; preds = %rand_bb
  call void @write_picture.4(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure)
  ret void
...
func_write_picture.22:                            ; preds = %ctrl1
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_write_picture.22, label %func_write_picture.23
}
...
func_write_out_picture.13:                        ; preds = %ctrl0
  call void @write_out_picture.13(%struct.storable_picture* %p, i32 %p_out)
  ret void

func_write_out_picture.14:                        ; preds = %ctrl1
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_write_out_picture.13, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_write_out_picture.14, label %func_write_out_picture.18
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_clear_picture.11, label %func_clear_picture.12
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_write_unpaired_field.10, label %ctrl0

func_write_unpaired_field.10:                     ; preds = %rand_bb
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_write_stored_frame.6, label %func_write_stored_frame.9
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_direct_output.7, label %func_direct_output.16
...
entry:
  %canary = alloca i32
  store i32 2077421694, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 463647667, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1776699068, i32* %canary
  %p = alloca i8*, align 8
  %s = alloca i16, align 2
  %0 = bitcast i16* %s to i8*
  store i8* %0, i8** %p, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_picture.4(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure) #0 {
entry:
  %p.addr = alloca %struct.storable_picture*, align 8
  %real_structure.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1772423754, i32* %canary
  %p_out.addr = alloca i32, align 4
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1202853728, i32* %canary
  %tmp16 = alloca i16, align 2
  %theight = alloca i32, align 4
  %symbol_size_in_bytes.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1202853728
  br i1 %109, label %110, label %func_exit
...
entry:
  %canary = alloca i32
  store i32 1826341900, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 921046355, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  %p_out.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 1906528937, i32* %canary
...
return:                                           ; preds = %if.end139, %if.then
  ...
  %193 = icmp eq i32 %192, 1906528937
...
entry:
  %canary = alloca i32
  store i32 190506631, i32* %canary
  %p_out.addr = alloca i32, align 4
  %fs.addr = alloca %struct.frame_store*, align 8
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  %fs.addr = alloca %struct.frame_store*, align 8
  %canary = alloca i32
  store i32 1046723937, i32* %canary
  %p_out.addr = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1143246972, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  %i = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 0, i32* %i, align 4
...
entry:
  ...
  %crop_left = alloca i32, align 4
  %canary = alloca i32
  store i32 741529338, i32* %canary
  %buf = alloca i8*, align 8
  %p.addr = alloca %struct.storable_picture*, align 8
  %p_out.addr = alloca i32, align 4
  %rgb_output = alloca i32, align 4
...
entry:
  ...
  %symbol_size_in_bytes = alloca i32, align 4
  %canary = alloca i32
  store i32 940705265, i32* %canary
  %crop_left = alloca i32, align 4
  %buf = alloca i8*, align 8
  %SubWidthC = alloca [4 x i32], align 16
  %p_out.addr = alloca i32, align 4
...
entry:
  ...
  %size = alloca i32, align 4
  %canary = alloca i32
  store i32 1015781930, i32* %canary
  %size_x.addr = alloca i32, align 4
  %crop_right.addr = alloca i32, align 4
  %size_y.addr = alloca i32, align 4
  %tmp32 = alloca i64, align 8
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1015781930
  br i1 %109, label %110, label %func_exit
...
entry:
  %canary = alloca i32
  store i32 284986496, i32* %canary
  %p_out.addr = alloca i32, align 4
  %p.addr = alloca %struct.storable_picture*, align 8
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  %real_structure.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 773103376, i32* %canary
  %p_out.addr = alloca i32, align 4
  %p.addr = alloca %struct.storable_picture*, align 8
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  ...
  %buf = alloca i8*, align 8
  %canary = alloca i32
  store i32 1722802694, i32* %canary
  %crop_left = alloca i32, align 4
  %crop_bottom = alloca i32, align 4
  %p_out.addr = alloca i32, align 4
  %SubHeightC = alloca [4 x i32], align 16
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1722802694
  br i1 %193, label %194, label %func_exit
...
entry:
  %fs.addr = alloca %struct.frame_store*, align 8
  %canary = alloca i32
  store i32 1688228156, i32* %canary
  %p = alloca %struct.storable_picture*, align 8
  %p_out.addr = alloca i32, align 4
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  %p = alloca %struct.storable_picture*, align 8
  %canary = alloca i32
  store i32 1152738237, i32* %canary
  %p_out.addr = alloca i32, align 4
  %fs.addr = alloca %struct.frame_store*, align 8
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  ...
  %size_y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1305907907, i32* %canary
  %theight = alloca i32, align 4
  %twidth = alloca i32, align 4
  %ui16 = alloca i16, align 2
  %tmp32 = alloca i64, align 8
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1305907907
  br i1 %109, label %110, label %func_exit
...
entry:
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 142290897, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  %real_structure.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  ...
  %real_structure.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 978317907, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  store i32 %real_structure, i32* %real_structure.addr, align 4
...
entry:
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 904248563, i32* %canary
  %p = alloca %struct.storable_picture*, align 8
  %fs.addr = alloca %struct.frame_store*, align 8
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
