...
# %bb.0:                                # %entry
	...
	.cfi_offset %rbx, -24
	movl	16(%rbp), %eax
	movl	$1978270400, -32(%rbp)  # imm = 0x75EA02C0
	movq	%rdi, -48(%rbp)
	movq	%rsi, -16(%rbp)
	movl	%edx, -24(%rbp)
	movl	%ecx, -36(%rbp)
	...
	movl	%eax, 4(%rcx)
	movl	-20(%rbp), %ebx
	cmpl	$1978270400, -32(%rbp)  # imm = 0x75EA02C0
	jne	.LBB1_2
.LBB1_1:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_offset %rbx, -24
	movl	16(%rbp), %eax
	movl	$987745743, -40(%rbp)   # imm = 0x3ADFCDCF
	movq	%rdi, -48(%rbp)
	movq	%rsi, -16(%rbp)
	movl	%edx, -20(%rbp)
	movl	%ecx, -32(%rbp)
	...
	movl	%eax, 4(%rcx)
	movl	-24(%rbp), %ebx
	cmpl	$987745743, -40(%rbp)   # imm = 0x3ADFCDCF
	jne	.LBB2_2
.LBB2_1:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_offset %rbx, -24
	movl	16(%rbp), %eax
	movl	$631096000, -28(%rbp)   # imm = 0x259DC2C0
	movq	%rdi, -48(%rbp)
	movq	%rsi, -16(%rbp)
	movl	%edx, -24(%rbp)
	movl	%ecx, -40(%rbp)
	...
	movl	%eax, 4(%rcx)
	movl	-20(%rbp), %ebx
	cmpl	$631096000, -28(%rbp)   # imm = 0x259DC2C0
	jne	.LBB3_2
.LBB3_1:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_offset %rbx, -24
	movl	16(%rbp), %eax
	movl	$121006356, -40(%rbp)   # imm = 0x7366914
	movq	%rdi, -48(%rbp)
	movq	%rsi, -16(%rbp)
	movl	%edx, -24(%rbp)
	movl	%ecx, -36(%rbp)
	...
	movl	%eax, 4(%rcx)
	movl	-20(%rbp), %ebx
	cmpl	$121006356, -40(%rbp)   # imm = 0x7366914
	jne	.LBB5_2
.LBB5_1:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_offset %rbx, -24
	movl	16(%rbp), %eax
	movl	$1317444702, -28(%rbp)  # imm = 0x4E869C5E
	movq	%rdi, -48(%rbp)
	movq	%rsi, -16(%rbp)
	movl	%edx, -20(%rbp)
	movl	%ecx, -32(%rbp)
	...
	movl	%eax, 4(%rcx)
	movl	-24(%rbp), %ebx
	cmpl	$1317444702, -28(%rbp)  # imm = 0x4E869C5E
	jne	.LBB6_2
.LBB6_1:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_offset %rbx, -24
	movl	16(%rbp), %eax
	movl	$1600166460, -28(%rbp)  # imm = 0x5F609A3C
	movq	%rdi, -48(%rbp)
	movq	%rsi, -16(%rbp)
	movl	%edx, -24(%rbp)
	movl	%ecx, -40(%rbp)
	...
	movl	%eax, 4(%rcx)
	movl	-20(%rbp), %ebx
	cmpl	$1600166460, -28(%rbp)  # imm = 0x5F609A3C
	jne	.LBB7_2
.LBB7_1:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_offset %rbx, -24
	movl	16(%rbp), %eax
	movl	$585442619, -36(%rbp)   # imm = 0x22E5253B
	movq	%rdi, -48(%rbp)
	movq	%rsi, -16(%rbp)
	movl	%edx, -20(%rbp)
	movl	%ecx, -28(%rbp)
	...
	movl	%eax, 4(%rcx)
	movl	-24(%rbp), %ebx
	cmpl	$585442619, -36(%rbp)   # imm = 0x22E5253B
	jne	.LBB8_2
.LBB8_1:
	movl	%ebx, %eax
	addq	$40, %rsp
