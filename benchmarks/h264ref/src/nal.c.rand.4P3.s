...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$1006009237, -40(%rbp)  # imm = 0x3BF67B95
	movq	%rdi, -32(%rbp)
	movl	%esi, -24(%rbp)
	movl	%edx, -36(%rbp)
	movl	%ecx, -44(%rbp)
...
.LBB4_17:                               # %while.end
	movl	-12(%rbp), %ebx
	cmpl	$1006009237, -40(%rbp)  # imm = 0x3BF67B95
	jne	.LBB4_19
.LBB4_18:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$1656283992, -44(%rbp)  # imm = 0x62B8E358
	movq	%rdi, -32(%rbp)
	movl	%esi, -24(%rbp)
	movl	%edx, -36(%rbp)
	movl	%ecx, -40(%rbp)
...
.LBB5_17:                               # %while.end
	movl	-12(%rbp), %ebx
	cmpl	$1656283992, -44(%rbp)  # imm = 0x62B8E358
	jne	.LBB5_19
.LBB5_18:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$119433195, -44(%rbp)   # imm = 0x71E67EB
	movq	%rdi, -32(%rbp)
	movl	%esi, -24(%rbp)
	movl	%edx, -36(%rbp)
	movl	%ecx, -40(%rbp)
...
.LBB6_17:                               # %while.end
	movl	-12(%rbp), %ebx
	cmpl	$119433195, -44(%rbp)   # imm = 0x71E67EB
	jne	.LBB6_19
.LBB6_18:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$673744390, -44(%rbp)   # imm = 0x28288606
	movq	%rdi, -32(%rbp)
	movl	%esi, -24(%rbp)
	movl	%edx, -36(%rbp)
	movl	%ecx, -40(%rbp)
...
.LBB7_17:                               # %while.end
	movl	-12(%rbp), %ebx
	cmpl	$673744390, -44(%rbp)   # imm = 0x28288606
	jne	.LBB7_19
.LBB7_18:
	movl	%ebx, %eax
	addq	$40, %rsp
