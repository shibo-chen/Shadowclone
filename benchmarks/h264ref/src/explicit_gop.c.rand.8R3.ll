; ModuleID = 'explicit_gop.c.rand.8R3.bc'
...
func_create_pyramid.2:                            ; preds = %ctrl0
  call void @create_pyramid.2()
  ret void

func_create_pyramid.3:                            ; preds = %ctrl1
  call void @create_pyramid.3()
  ret void

func_create_pyramid.11:                           ; preds = %ctrl2
  call void @create_pyramid.11()
  ret void

func_create_pyramid.13:                           ; preds = %ctrl3
  call void @create_pyramid.13()
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_create_pyramid.2, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_create_pyramid.3, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_create_pyramid.11, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_create_pyramid.13, label %ctrl4
...
func_gop_pyramid.12:                              ; preds = %ctrl0
...
func_gop_pyramid.18:                              ; preds = %ctrl3
  call void @gop_pyramid.18(i32 %level, i32 %frm_no, i32 %frames, %struct.GOP_DATA* %pyramid_structure)
  ret void

func_gop_pyramid.21:                              ; preds = %ctrl4
  call void @gop_pyramid.21(i32 %level, i32 %frm_no, i32 %frames, %struct.GOP_DATA* %pyramid_structure)
  ret void

func_gop_pyramid.22:                              ; preds = %ctrl5
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_gop_pyramid.12, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_gop_pyramid.14, label %ctrl2
...
ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_gop_pyramid.18, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_gop_pyramid.21, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_gop_pyramid.22, label %func_gop_pyramid.23
}
...
func_interpret_gop_structure.7:                   ; preds = %ctrl0
  call void @interpret_gop_structure.7()
  ret void

func_interpret_gop_structure.17:                  ; preds = %ctrl1
  call void @interpret_gop_structure.17()
  ret void

func_interpret_gop_structure.20:                  ; preds = %ctrl2
  call void @interpret_gop_structure.20()
  ret void

func_interpret_gop_structure.26:                  ; preds = %ctrl3
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_interpret_gop_structure.7, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_interpret_gop_structure.17, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_interpret_gop_structure.20, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_interpret_gop_structure.26, label %ctrl4
...
ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_interpret_gop_structure.30, label %func_interpret_gop_structure.31
}
...
func_poc_based_ref_management.8:                  ; preds = %ctrl0
...
func_poc_based_ref_management.10:                 ; preds = %ctrl2
  call void @poc_based_ref_management.10(i32 %current_pic_num)
  ret void
...
func_poc_based_ref_management.25:                 ; preds = %ctrl5
  call void @poc_based_ref_management.25(i32 %current_pic_num)
  ret void

func_poc_based_ref_management.27:                 ; preds = %ctrl5
  call void @poc_based_ref_management.27(i32 %current_pic_num)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_poc_based_ref_management.8, label %ctrl1
...
ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_poc_based_ref_management.10, label %ctrl3
...
ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_poc_based_ref_management.25, label %func_poc_based_ref_management.27
}
...
entry:
  ...
  %canary = alloca i32
  store i32 1176492781, i32* %canary
...
if.end200:                                        ; preds = %for.end199, %for.end
  ...
  %162 = icmp eq i32 %161, 1176492781
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @create_pyramid.2() #0 {
entry:
  %j = alloca i32, align 4
  %i = alloca i32, align 4
  %levelrefs = alloca i32, align 4
  ...
  %curGOPLevelfrm = alloca i32*, align 8
  %canary = alloca i32
  store i32 278512819, i32* %canary
  %curGOPLeveldist = alloca i32*, align 8
  %prvlevelrefs = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %successive_Bframe = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 34
...
entry:
  ...
  %curGOPLevelfrm = alloca i32*, align 8
  %canary = alloca i32
  store i32 1536047027, i32* %canary
  %i = alloca i32, align 4
  %GOPlevels = alloca i32, align 4
  %levelrefs = alloca i32, align 4
  %i28 = alloca i32, align 4
...
if.end200:                                        ; preds = %for.end199, %for.end
  %161 = load i32, i32* %canary
  %162 = icmp eq i32 %161, 1536047027
  br i1 %162, label %163, label %func_exit
...
entry:
  ...
  %canary = alloca i32
  store i32 740427595, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 369926948, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1241335155, i32* %canary
...
entry:
  ...
  %order_read = alloca i32, align 4
  %canary = alloca i32
  store i32 2070974871, i32* %canary
  %qp = alloca i32, align 4
  %k = alloca i32, align 4
  %qp_read = alloca i32, align 4
  %stored_read = alloca i32, align 4
...
entry:
  ...
  %current_pic_num.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 639402947, i32* %canary
  %min_poc = alloca i32, align 4
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
  %tmp_drpm2 = alloca %struct.DecRefPicMarking_s*, align 8
  %pic_num = alloca i32, align 4
...
entry:
  ...
  %pic_num = alloca i32, align 4
  %canary = alloca i32
  store i32 1224773742, i32* %canary
  %current_pic_num.addr = alloca i32, align 4
  %tmp_drpm2 = alloca %struct.DecRefPicMarking_s*, align 8
  %min_poc = alloca i32, align 4
  store i32 %current_pic_num, i32* %current_pic_num.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @poc_based_ref_management.10(i32 %current_pic_num) #0 {
entry:
  %tmp_drpm2 = alloca %struct.DecRefPicMarking_s*, align 8
  %canary = alloca i32
  store i32 1990421795, i32* %canary
  %i = alloca i32, align 4
  %pic_num = alloca i32, align 4
  %current_pic_num.addr = alloca i32, align 4
  %min_poc = alloca i32, align 4
...
entry:
  ...
  %curGOPLeveldist = alloca i32*, align 8
  %canary = alloca i32
  store i32 151097057, i32* %canary
  %tempnum = alloca i32, align 4
  %Bframes = alloca i32, align 4
  %curGOPLevelfrm = alloca i32*, align 8
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
entry:
  ...
  %level.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1318226000, i32* %canary
  %frames.addr = alloca i32, align 4
  %pyramid_structure.addr = alloca %struct.GOP_DATA*, align 8
  store i32 %level, i32* %level.addr, align 4
  store i32 %frm_no, i32* %frm_no.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @create_pyramid.13() #0 {
entry:
  %i = alloca i32, align 4
  %i28 = alloca i32, align 4
  %j = alloca i32, align 4
  %Bframes = alloca i32, align 4
  %canary = alloca i32
  store i32 983167375, i32* %canary
  %centerB = alloca i32, align 4
  %curGOPLeveldist = alloca i32*, align 8
  %curGOPLevelfrm = alloca i32*, align 8
  %tempnum = alloca i32, align 4
...
entry:
  ...
  %frm_no.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1857008333, i32* %canary
  %frames.addr = alloca i32, align 4
  store i32 %level, i32* %level.addr, align 4
  store i32 %frm_no, i32* %frm_no.addr, align 4
  store i32 %frames, i32* %frames.addr, align 4
...
entry:
  ...
  %frm_no.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1522644296, i32* %canary
  %frames.addr = alloca i32, align 4
  %pyramid_structure.addr = alloca %struct.GOP_DATA*, align 8
  store i32 %level, i32* %level.addr, align 4
  store i32 %frm_no, i32* %frm_no.addr, align 4
...
entry:
  %current_pic_num.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1396849422, i32* %canary
  %pic_num = alloca i32, align 4
  %min_poc = alloca i32, align 4
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
  %tmp_drpm2 = alloca %struct.DecRefPicMarking_s*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @interpret_gop_structure.17() #0 {
entry:
  %order_read = alloca i32, align 4
  %i = alloca i32, align 4
  %nLength = alloca i32, align 4
  ...
  %stored_read = alloca i32, align 4
  %canary = alloca i32
  store i32 1309513897, i32* %canary
  %k = alloca i32, align 4
  %qp = alloca i32, align 4
  %slice_read = alloca i32, align 4
  %coded_frame = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @gop_pyramid.18(i32 %level, i32 %frm_no, i32 %frames, %struct.GOP_DATA* %pyramid_structure) #0 {
entry:
  %canary = alloca i32
  store i32 2116577941, i32* %canary
  %frames.addr = alloca i32, align 4
  %pyramid_structure.addr = alloca %struct.GOP_DATA*, align 8
  %level.addr = alloca i32, align 4
  %frm_no.addr = alloca i32, align 4
...
entry:
  ...
  %min_poc = alloca i32, align 4
  %canary = alloca i32
  store i32 1044317526, i32* %canary
  %i = alloca i32, align 4
  %pic_num = alloca i32, align 4
  store i32 %current_pic_num, i32* %current_pic_num.addr, align 4
  store i32 0, i32* %pic_num, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @interpret_gop_structure.20() #0 {
entry:
  %canary = alloca i32
  store i32 1118184650, i32* %canary
  %i = alloca i32, align 4
  %slice_read = alloca i32, align 4
  %stored_read = alloca i32, align 4
  %qp = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @gop_pyramid.21(i32 %level, i32 %frm_no, i32 %frames, %struct.GOP_DATA* %pyramid_structure) #0 {
entry:
  %level.addr = alloca i32, align 4
  %frm_no.addr = alloca i32, align 4
  %pyramid_structure.addr = alloca %struct.GOP_DATA*, align 8
  %canary = alloca i32
  store i32 1373582365, i32* %canary
  %frames.addr = alloca i32, align 4
  store i32 %level, i32* %level.addr, align 4
  store i32 %frm_no, i32* %frm_no.addr, align 4
  store i32 %frames, i32* %frames.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 293375022, i32* %canary
  %frames.addr = alloca i32, align 4
  %level.addr = alloca i32, align 4
  %pyramid_structure.addr = alloca %struct.GOP_DATA*, align 8
  %frm_no.addr = alloca i32, align 4
...
entry:
  %level.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 934868058, i32* %canary
  %pyramid_structure.addr = alloca %struct.GOP_DATA*, align 8
  %frm_no.addr = alloca i32, align 4
  %frames.addr = alloca i32, align 4
  store i32 %level, i32* %level.addr, align 4
...
entry:
  ...
  %GOPlevels = alloca i32, align 4
  %canary = alloca i32
  store i32 1120804838, i32* %canary
  %i28 = alloca i32, align 4
  %Bframes = alloca i32, align 4
  %j = alloca i32, align 4
  %centerB = alloca i32, align 4
...
if.end200:                                        ; preds = %for.end199, %for.end
  %161 = load i32, i32* %canary
  %162 = icmp eq i32 %161, 1120804838
  br i1 %162, label %163, label %func_exit
...
entry:
  ...
  %pic_num = alloca i32, align 4
  %canary = alloca i32
  store i32 1790454038, i32* %canary
  %min_poc = alloca i32, align 4
  %tmp_drpm2 = alloca %struct.DecRefPicMarking_s*, align 8
  %current_pic_num.addr = alloca i32, align 4
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
...
entry:
  ...
  %slice_read = alloca i32, align 4
  %canary = alloca i32
  store i32 922630611, i32* %canary
  %k = alloca i32, align 4
  %i = alloca i32, align 4
  %qp = alloca i32, align 4
  %nLength = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @poc_based_ref_management.27(i32 %current_pic_num) #0 {
entry:
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
  %i = alloca i32, align 4
  %pic_num = alloca i32, align 4
  %canary = alloca i32
  store i32 545425689, i32* %canary
  %current_pic_num.addr = alloca i32, align 4
  %tmp_drpm2 = alloca %struct.DecRefPicMarking_s*, align 8
  %min_poc = alloca i32, align 4
  store i32 %current_pic_num, i32* %current_pic_num.addr, align 4
...
entry:
  ...
  %prvlevelrefs = alloca i32, align 4
  %canary = alloca i32
  store i32 1260341947, i32* %canary
  %levelrefs = alloca i32, align 4
  %j = alloca i32, align 4
  %tempnum = alloca i32, align 4
  %curGOPLevelfrm = alloca i32*, align 8
...
if.end200:                                        ; preds = %for.end199, %for.end
  %161 = load i32, i32* %canary
  %162 = icmp eq i32 %161, 1260341947
  br i1 %162, label %163, label %func_exit
...
entry:
  ...
  %display_no = alloca i32, align 4
  %canary = alloca i32
  store i32 317010936, i32* %canary
  %stored_read = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %ExplicitPyramidFormat = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 56
  %arraydecay = getelementptr inbounds [1024 x i8], [1024 x i8]* %ExplicitPyramidFormat, i64 0, i64 0
...
entry:
  ...
  %order_read = alloca i32, align 4
  %canary = alloca i32
  store i32 1484560327, i32* %canary
  %nLength = alloca i32, align 4
  %slice_read = alloca i32, align 4
  %display_no = alloca i32, align 4
  %qp_read = alloca i32, align 4
...
entry:
  ...
  %nLength = alloca i32, align 4
  %canary = alloca i32
  store i32 305390080, i32* %canary
  %stored_read = alloca i32, align 4
  %qp_read = alloca i32, align 4
  %display_no = alloca i32, align 4
  %coded_frame = alloca i32, align 4
...
entry:
  %prvlevelrefs = alloca i32, align 4
  %canary = alloca i32
  store i32 1570437986, i32* %canary
  %curlevel = alloca i32, align 4
  %levelrefs = alloca i32, align 4
  %curGOPLeveldist = alloca i32*, align 8
  %centerB = alloca i32, align 4
...
if.end200:                                        ; preds = %for.end199, %for.end
  %161 = load i32, i32* %canary
  %162 = icmp eq i32 %161, 1570437986
  br i1 %162, label %163, label %func_exit
