; ModuleID = 'q_offsets.c.rand.4P2.bc'
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_CheckOffsetParameterName.3, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_CheckOffsetParameterName.9, label %func_CheckOffsetParameterName.14
}
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_ParseQOffsetMatrix.15, label %func_ParseQOffsetMatrix.16
}
...
func_CalculateOffsetParam.10:                     ; preds = %ctrl0
...
func_CalculateOffsetParam.13:                     ; preds = %ctrl1
  call void @CalculateOffsetParam.13()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_CalculateOffsetParam.10, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_CalculateOffsetParam.11, label %func_CalculateOffsetParam.13
}
...
func_CalculateOffset8Param.6:                     ; preds = %ctrl0
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_CalculateOffset8Param.6, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_CalculateOffset8Param.7, label %func_CalculateOffset8Param.8
}
...
entry:
  ...
  %canary = alloca i32
  store i32 1176386628, i32* %canary
...
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 106560567, i32* %canary
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 891385601, i32* %canary
  %i = alloca i32, align 4
  %s.addr = alloca i8*, align 8
  store i8* %s, i8** %s.addr, align 8
  store i32* %type, i32** %type.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1789450847, i32* %canary
  %j = alloca i32, align 4
...
if.end225:                                        ; preds = %for.end224, %for.end102
  ...
  %133 = icmp eq i32 %132, 1789450847
...
entry:
  ...
  %canary = alloca i32
  store i32 852643518, i32* %canary
  %j = alloca i32, align 4
...
entry:
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 577169337, i32* %canary
  %temp = alloca i32, align 4
  %k = alloca i32, align 4
  %i = alloca i32, align 4
  %q_bits = alloca i32, align 4
...
entry:
  ...
  %temp = alloca i32, align 4
  %canary = alloca i32
  store i32 1312964545, i32* %canary
  %i = alloca i32, align 4
  %k = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %OffsetMatrixPresentFlag = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 147
...
entry:
  ...
  %s.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 459532586, i32* %canary
  %i = alloca i32, align 4
  store i8* %s, i8** %s.addr, align 8
  store i32* %type, i32** %type.addr, align 8
  store i32 0, i32* %i, align 4
...
entry:
  ...
  %temp = alloca i32, align 4
  %canary = alloca i32
  store i32 633686680, i32* %canary
  %i = alloca i32, align 4
  %k = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %OffsetMatrixPresentFlag = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 147
...
entry:
  %canary = alloca i32
  store i32 1041775343, i32* %canary
  %k = alloca i32, align 4
  %temp = alloca i32, align 4
  %j = alloca i32, align 4
  %qp_per = alloca i32, align 4
...
if.end225:                                        ; preds = %for.end224, %for.end102
  %132 = load i32, i32* %canary
  %133 = icmp eq i32 %132, 1041775343
  br i1 %133, label %134, label %func_exit
...
entry:
  ...
  %buf.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1209556459, i32* %canary
  %InItem = alloca i32, align 4
  %i = alloca i32, align 4
  %InString = alloca i32, align 4
  %p = alloca i8*, align 8
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1101048970, i32* %canary
  %qp_per = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %OffsetMatrixPresentFlag = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 147
  %1 = load i32, i32* %OffsetMatrixPresentFlag, align 8
...
if.end225:                                        ; preds = %for.end224, %for.end102
  %132 = load i32, i32* %canary
  %133 = icmp eq i32 %132, 1101048970
  br i1 %133, label %134, label %func_exit
...
entry:
  %s.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1942544729, i32* %canary
  %i = alloca i32, align 4
  %type.addr = alloca i32*, align 8
  %retval = alloca i32, align 4
  store i8* %s, i8** %s.addr, align 8
...
entry:
  ...
  %buf.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1853417124, i32* %canary
  %type = alloca i32, align 4
  %cnt = alloca i32, align 4
  %j = alloca i32, align 4
  %bufsize.addr = alloca i32, align 4
...
entry:
  ...
  %InItem = alloca i32, align 4
  %canary = alloca i32
  store i32 447695191, i32* %canary
  %InString = alloca i32, align 4
  %bufend = alloca i8*, align 8
  %type = alloca i32, align 4
  %item = alloca i32, align 4
