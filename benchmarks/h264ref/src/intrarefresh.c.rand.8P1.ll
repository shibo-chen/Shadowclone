; ModuleID = 'intrarefresh.c.rand.8P1.bc'
...
func_RandomIntraInit.4:                           ; preds = %ctrl1
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_RandomIntraInit.4, label %ctrl2
...
func_RandomIntra.10:                              ; preds = %ctrl2
  %5 = call i32 @RandomIntra.10(i32 %mb)
  ret i32 %5
...
func_RandomIntra.13:                              ; preds = %ctrl3
  %7 = call i32 @RandomIntra.13(i32 %mb)
  ret i32 %7
...
ctrl2:                                            ; preds = %ctrl1
  %10 = icmp eq i32 %0, 3
  br i1 %10, label %func_RandomIntra.10, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %11 = icmp eq i32 %0, 4
  br i1 %11, label %func_RandomIntra.11, label %func_RandomIntra.13
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_RandomIntraNewPicture.2, label %func_RandomIntraNewPicture.12

func_RandomIntraNewPicture.2:                     ; preds = %rand_bb
  call void @RandomIntraNewPicture.2()
  ret void

func_RandomIntraNewPicture.12:                    ; preds = %rand_bb
  call void @RandomIntraNewPicture.12()
  ret void
}
...
entry:
  ...
  %canary = alloca i32
  store i32 798247476, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 898403637, i32* %canary
  %i = alloca i32, align 4
...
entry:
  ...
  %refresh.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 428630132, i32* %canary
  %xsize.addr = alloca i32, align 4
  %i = alloca i32, align 4
  store i32 %xsize, i32* %xsize.addr, align 4
  store i32 %ysize, i32* %ysize.addr, align 4
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 793573461, i32* %canary
  %xsize.addr = alloca i32, align 4
  %pos = alloca i32, align 4
  store i32 %xsize, i32* %xsize.addr, align 4
  store i32 %ysize, i32* %ysize.addr, align 4
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 299209319, i32* %canary
...
entry:
  %mb.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 495419834, i32* %canary
  %retval = alloca i32, align 4
  %i = alloca i32, align 4
  store i32 %mb, i32* %mb.addr, align 4
  store i32 0, i32* %i, align 4
...
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1006516106, i32* %canary
  %retval = alloca i32, align 4
  %mb.addr = alloca i32, align 4
  store i32 %mb, i32* %mb.addr, align 4
  store i32 0, i32* %i, align 4
...
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 268686150, i32* %canary
  %ysize.addr = alloca i32, align 4
  %xsize.addr = alloca i32, align 4
  %refresh.addr = alloca i32, align 4
  %pos = alloca i32, align 4
...
entry:
  ...
  %xsize.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 153262769, i32* %canary
  %refresh.addr = alloca i32, align 4
  %ysize.addr = alloca i32, align 4
  store i32 %xsize, i32* %xsize.addr, align 4
  store i32 %ysize, i32* %ysize.addr, align 4
...
entry:
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 226086281, i32* %canary
  %mb.addr = alloca i32, align 4
  %i = alloca i32, align 4
  store i32 %mb, i32* %mb.addr, align 4
  store i32 0, i32* %i, align 4
...
entry:
  %canary = alloca i32
  store i32 1849120544, i32* %canary
  %mb.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %retval = alloca i32, align 4
  store i32 %mb, i32* %mb.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @RandomIntraNewPicture.12() #0 {
entry:
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 525503721, i32* %canary
  %i = alloca i32, align 4
  %0 = load i32, i32* @NumberIntraPerPicture, align 4
  %1 = load i32, i32* @WalkAround, align 4
  %add = add nsw i32 %1, %0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @RandomIntra.13(i32 %mb) #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 284801518, i32* %canary
  %mb.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  store i32 %mb, i32* %mb.addr, align 4
  store i32 0, i32* %i, align 4
...
entry:
  %canary = alloca i32
  store i32 750329137, i32* %canary
  %i = alloca i32, align 4
  %pos = alloca i32, align 4
  %refresh.addr = alloca i32, align 4
  %xsize.addr = alloca i32, align 4
...
entry:
  ...
  %refresh.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 167691618, i32* %canary
  %pos = alloca i32, align 4
  store i32 %xsize, i32* %xsize.addr, align 4
  store i32 %ysize, i32* %ysize.addr, align 4
  store i32 %refresh, i32* %refresh.addr, align 4
...
entry:
  ...
  %refresh.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1964429456, i32* %canary
  %xsize.addr = alloca i32, align 4
  %pos = alloca i32, align 4
  store i32 %xsize, i32* %xsize.addr, align 4
  store i32 %ysize, i32* %ysize.addr, align 4
