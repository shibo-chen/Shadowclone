...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$115313058, -20(%rbp)   # imm = 0x6DF89A2
	vmovsd	%xmm0, -32(%rbp)
	vmovsd	%xmm1, -64(%rbp)
	movl	%edi, -24(%rbp)
	movl	%esi, -16(%rbp)
...
.LBB2_5:                                # %return
	movl	-12(%rbp), %ebx
	cmpl	$115313058, -20(%rbp)   # imm = 0x6DF89A2
	jne	.LBB2_7
.LBB2_6:
	movl	%ebx, %eax
	addq	$56, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$72, %rsp
	.cfi_offset %rbx, -24
	movl	$1979066875, -40(%rbp)  # imm = 0x75F629FB
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movl	%edx, -12(%rbp)
	movq	img, %rax
...
.LBB3_5:                                # %if.end
	...
	movl	%eax, %ebx
	cmpl	$1979066875, -40(%rbp)  # imm = 0x75F629FB
	jne	.LBB3_7
.LBB3_6:
	movl	%ebx, %eax
	addq	$72, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$2041579540, -20(%rbp)  # imm = 0x79B00814
	vmovsd	%xmm0, -40(%rbp)
	vmovsd	%xmm1, -56(%rbp)
	movl	%edi, -16(%rbp)
	movl	%esi, -24(%rbp)
...
.LBB4_5:                                # %return
	movl	-12(%rbp), %ebx
	cmpl	$2041579540, -20(%rbp)  # imm = 0x79B00814
	jne	.LBB4_7
.LBB4_6:
	movl	%ebx, %eax
	addq	$56, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$1035134845, -20(%rbp)  # imm = 0x3DB2E77D
	vmovsd	%xmm0, -56(%rbp)
	vmovsd	%xmm1, -64(%rbp)
	movl	%edi, -24(%rbp)
	movl	%esi, -16(%rbp)
...
.LBB5_5:                                # %return
	movl	-12(%rbp), %ebx
	cmpl	$1035134845, -20(%rbp)  # imm = 0x3DB2E77D
	jne	.LBB5_7
.LBB5_6:
	movl	%ebx, %eax
	addq	$56, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$72, %rsp
	.cfi_offset %rbx, -24
	movl	$1163721566, -48(%rbp)  # imm = 0x455CFB5E
	movq	%rdi, -24(%rbp)
	movq	%rsi, -32(%rbp)
	movl	%edx, -12(%rbp)
	movq	img, %rax
...
.LBB6_5:                                # %if.end
	...
	callq	rd_pic_decision
	movl	%eax, %ebx
	cmpl	$1163721566, -48(%rbp)  # imm = 0x455CFB5E
	jne	.LBB6_7
.LBB6_6:
	movl	%ebx, %eax
	addq	$72, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$361676934, -20(%rbp)   # imm = 0x158EC086
	vmovsd	%xmm0, -48(%rbp)
	vmovsd	%xmm1, -40(%rbp)
	movl	%edi, -16(%rbp)
	movl	%esi, -24(%rbp)
...
.LBB7_5:                                # %return
	movl	-12(%rbp), %ebx
	cmpl	$361676934, -20(%rbp)   # imm = 0x158EC086
	jne	.LBB7_7
.LBB7_6:
	movl	%ebx, %eax
	addq	$56, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$72, %rsp
	.cfi_offset %rbx, -24
	movl	$159366309, -48(%rbp)   # imm = 0x97FBCA5
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movl	%edx, -12(%rbp)
	movq	img, %rax
...
.LBB8_5:                                # %if.end
	...
	callq	rd_pic_decision
	movl	%eax, %ebx
	cmpl	$159366309, -48(%rbp)   # imm = 0x97FBCA5
	jne	.LBB8_7
.LBB8_6:
	movl	%ebx, %eax
	addq	$72, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$72, %rsp
	.cfi_offset %rbx, -24
	movl	$250631768, -40(%rbp)   # imm = 0xEF05658
	movq	%rdi, -24(%rbp)
	movq	%rsi, -32(%rbp)
	movl	%edx, -12(%rbp)
	movq	img, %rax
...
.LBB9_5:                                # %if.end
	...
	callq	rd_pic_decision
	movl	%eax, %ebx
	cmpl	$250631768, -40(%rbp)   # imm = 0xEF05658
	jne	.LBB9_7
.LBB9_6:
	movl	%ebx, %eax
	addq	$72, %rsp
