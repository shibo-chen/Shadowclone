...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_WriteRTPNALU.2, label %func_WriteRTPNALU.8

func_WriteRTPNALU.2:                              ; preds = %rand_bb
  %2 = call i32 @WriteRTPNALU.2(%struct.NALU_t* %n)
  ret i32 %2

func_WriteRTPNALU.8:                              ; preds = %rand_bb
  %3 = call i32 @WriteRTPNALU.8(%struct.NALU_t* %n)
  ret i32 %3
}
...
entry:
  ...
  %canary = alloca i32
  store i32 978587112, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1102738769, i32* %canary
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 962497384, i32* %canary
  %f.addr = alloca %struct._IO_FILE*, align 8
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
  store i32 -1, i32* %intime, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 121625229, i32* %canary
...
entry:
  %tr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1885315277, i32* %canary
  %delta = alloca i32, align 4
  store i32 %tr, i32* %tr.addr, align 4
  %0 = load i32, i32* @RTPUpdateTimestamp.oldtr, align 4
  %cmp = icmp eq i32 %0, -1
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 211683974, i32* %canary
  %f.addr = alloca %struct._IO_FILE*, align 8
  %intime = alloca i32, align 4
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @WriteRTPNALU.8(%struct.NALU_t* %n) #0 {
entry:
  %canary = alloca i32
  store i32 1706433703, i32* %canary
  %n.addr = alloca %struct.NALU_t*, align 8
  %p = alloca %struct.RTPpacket_t*, align 8
  store %struct.NALU_t* %n, %struct.NALU_t** %n.addr, align 8
  %0 = load %struct.NALU_t*, %struct.NALU_t** %n.addr, align 8
...
entry:
  ...
  %f.addr = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 1652124101, i32* %canary
  %p.addr = alloca %struct.RTPpacket_t*, align 8
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
  store i32 -1, i32* %intime, align 4
...
entry:
  %canary = alloca i32
  store i32 886802086, i32* %canary
  %intime = alloca i32, align 4
  %retval = alloca i32, align 4
  %f.addr = alloca %struct._IO_FILE*, align 8
  %p.addr = alloca %struct.RTPpacket_t*, align 8
...
entry:
  ...
  %p.addr = alloca %struct.RTPpacket_t*, align 8
  %canary = alloca i32
  store i32 981886345, i32* %canary
  %intime = alloca i32, align 4
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
  store i32 -1, i32* %intime, align 4
...
entry:
  %intime = alloca i32, align 4
  %canary = alloca i32
  store i32 691351048, i32* %canary
  %retval = alloca i32, align 4
  %p.addr = alloca %struct.RTPpacket_t*, align 8
  %f.addr = alloca %struct._IO_FILE*, align 8
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
...
entry:
  ...
  %f.addr = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 260022309, i32* %canary
  %p.addr = alloca %struct.RTPpacket_t*, align 8
  %retval = alloca i32, align 4
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
...
entry:
  ...
  %intime = alloca i32, align 4
  %canary = alloca i32
  store i32 1702457581, i32* %canary
  %retval = alloca i32, align 4
  %p.addr = alloca %struct.RTPpacket_t*, align 8
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
...
entry:
  ...
  %f.addr = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 1132994252, i32* %canary
  %retval = alloca i32, align 4
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
  store i32 -1, i32* %intime, align 4
...
entry:
  ...
  %p.addr = alloca %struct.RTPpacket_t*, align 8
  %canary = alloca i32
  store i32 1522339583, i32* %canary
  %retval = alloca i32, align 4
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
  store i32 -1, i32* %intime, align 4
...
entry:
  ...
  %p.addr = alloca %struct.RTPpacket_t*, align 8
  %canary = alloca i32
  store i32 920833084, i32* %canary
  %intime = alloca i32, align 4
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
  store i32 -1, i32* %intime, align 4
...
entry:
  %canary = alloca i32
  store i32 1338855987, i32* %canary
  %f.addr = alloca %struct._IO_FILE*, align 8
  %p.addr = alloca %struct.RTPpacket_t*, align 8
  %intime = alloca i32, align 4
  %retval = alloca i32, align 4
...
entry:
  %p.addr = alloca %struct.RTPpacket_t*, align 8
  %canary = alloca i32
  store i32 1079296238, i32* %canary
  %intime = alloca i32, align 4
  %retval = alloca i32, align 4
  %f.addr = alloca %struct._IO_FILE*, align 8
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
...
entry:
  %p.addr = alloca %struct.RTPpacket_t*, align 8
  %canary = alloca i32
  store i32 1425109847, i32* %canary
  %f.addr = alloca %struct._IO_FILE*, align 8
  %retval = alloca i32, align 4
  %intime = alloca i32, align 4
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
