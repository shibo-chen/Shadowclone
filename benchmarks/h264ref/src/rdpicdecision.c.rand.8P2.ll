; ModuleID = 'rdpicdecision.c.rand.8P2.bc'
...
func_rd_pic_decision.3:                           ; preds = %ctrl0
  %3 = call i32 @rd_pic_decision.3(double %snrY_version1, double %snrY_version2, i32 %bits_version1, i32 %bits_version2, double %lambda_picture)
  ret i32 %3
...
func_rd_pic_decision.10:                          ; preds = %ctrl4
  %7 = call i32 @rd_pic_decision.10(double %snrY_version1, double %snrY_version2, i32 %bits_version1, i32 %bits_version2, double %lambda_picture)
  ret i32 %7
...
func_rd_pic_decision.12:                          ; preds = %ctrl5
...
ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_rd_pic_decision.3, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_rd_pic_decision.5, label %ctrl2
...
ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_rd_pic_decision.10, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_rd_pic_decision.11, label %func_rd_pic_decision.12
}
...
func_picture_coding_decision.6:                   ; preds = %ctrl1
  %4 = call i32 @picture_coding_decision.6(%struct.Picture* %picture1, %struct.Picture* %picture2, i32 %qp)
  ret i32 %4
...
func_picture_coding_decision.13:                  ; preds = %ctrl3
  %6 = call i32 @picture_coding_decision.13(%struct.Picture* %picture1, %struct.Picture* %picture2, i32 %qp)
  ret i32 %6

func_picture_coding_decision.14:                  ; preds = %ctrl4
  %7 = call i32 @picture_coding_decision.14(%struct.Picture* %picture1, %struct.Picture* %picture2, i32 %qp)
  ret i32 %7
...
ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_picture_coding_decision.4, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_picture_coding_decision.6, label %ctrl2
...
ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_picture_coding_decision.13, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_picture_coding_decision.14, label %ctrl5
...
entry:
  ...
  %canary = alloca i32
  store i32 1946543805, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 954206926, i32* %canary
...
entry:
  ...
  %cost_version2 = alloca double, align 8
  %canary = alloca i32
  store i32 574174793, i32* %canary
  %lambda_picture.addr = alloca double, align 8
  %retval = alloca i32, align 4
  %cost_version1 = alloca double, align 8
  %snrY_version2.addr = alloca double, align 8
...
entry:
  ...
  %qp.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 290724518, i32* %canary
  %lambda_picture = alloca double, align 8
  store %struct.Picture* %picture1, %struct.Picture** %picture1.addr, align 8
  store %struct.Picture* %picture2, %struct.Picture** %picture2.addr, align 8
  store i32 %qp, i32* %qp.addr, align 4
...
entry:
  %cost_version2 = alloca double, align 8
  %canary = alloca i32
  store i32 519640362, i32* %canary
  %lambda_picture.addr = alloca double, align 8
  %snrY_version1.addr = alloca double, align 8
  %snrY_version2.addr = alloca double, align 8
  %retval = alloca i32, align 4
...
entry:
  ...
  %bit_picture1 = alloca i32, align 4
  %canary = alloca i32
  store i32 634091719, i32* %canary
  %spframe = alloca i32, align 4
  %snr_picture2 = alloca double, align 8
  %snr_picture1 = alloca double, align 8
  %picture1.addr = alloca %struct.Picture*, align 8
...
entry:
  ...
  %snrY_version1.addr = alloca double, align 8
  %canary = alloca i32
  store i32 1980139380, i32* %canary
  %bits_version1.addr = alloca i32, align 4
  %lambda_picture.addr = alloca double, align 8
  %snrY_version2.addr = alloca double, align 8
  %cost_version1 = alloca double, align 8
...
entry:
  %cost_version2 = alloca double, align 8
  %canary = alloca i32
  store i32 684531123, i32* %canary
  %cost_version1 = alloca double, align 8
  %bits_version1.addr = alloca i32, align 4
  %snrY_version1.addr = alloca double, align 8
  %snrY_version2.addr = alloca double, align 8
...
entry:
  ...
  %snr_picture1 = alloca double, align 8
  %canary = alloca i32
  store i32 420840895, i32* %canary
  %lambda_picture = alloca double, align 8
  store %struct.Picture* %picture1, %struct.Picture** %picture1.addr, align 8
  store %struct.Picture* %picture2, %struct.Picture** %picture2.addr, align 8
  store i32 %qp, i32* %qp.addr, align 4
...
entry:
  ...
  %snrY_version2.addr = alloca double, align 8
  %canary = alloca i32
  store i32 1014652507, i32* %canary
  %snrY_version1.addr = alloca double, align 8
  %cost_version1 = alloca double, align 8
  store double %snrY_version1, double* %snrY_version1.addr, align 8
  store double %snrY_version2, double* %snrY_version2.addr, align 8
...
entry:
  ...
  %cost_version2 = alloca double, align 8
  %canary = alloca i32
  store i32 821417731, i32* %canary
  %retval = alloca i32, align 4
  %lambda_picture.addr = alloca double, align 8
  store double %snrY_version1, double* %snrY_version1.addr, align 8
  store double %snrY_version2, double* %snrY_version2.addr, align 8
...
entry:
  ...
  %cost_version1 = alloca double, align 8
  %canary = alloca i32
  store i32 694440113, i32* %canary
  %bits_version1.addr = alloca i32, align 4
  store double %snrY_version1, double* %snrY_version1.addr, align 8
  store double %snrY_version2, double* %snrY_version2.addr, align 8
  store i32 %bits_version1, i32* %bits_version1.addr, align 4
...
entry:
  ...
  %qp.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 807042850, i32* %canary
  %snr_picture2 = alloca double, align 8
  %lambda_picture = alloca double, align 8
  store %struct.Picture* %picture1, %struct.Picture** %picture1.addr, align 8
  store %struct.Picture* %picture2, %struct.Picture** %picture2.addr, align 8
...
entry:
  ...
  %picture1.addr = alloca %struct.Picture*, align 8
  %canary = alloca i32
  store i32 1366299140, i32* %canary
  %snr_picture1 = alloca double, align 8
  %qp.addr = alloca i32, align 4
  %snr_picture2 = alloca double, align 8
  store %struct.Picture* %picture1, %struct.Picture** %picture1.addr, align 8
...
entry:
  ...
  %bframe = alloca i32, align 4
  %canary = alloca i32
  store i32 299822428, i32* %canary
  %lambda_picture = alloca double, align 8
  %snr_picture1 = alloca double, align 8
  store %struct.Picture* %picture1, %struct.Picture** %picture1.addr, align 8
  store %struct.Picture* %picture2, %struct.Picture** %picture2.addr, align 8
...
entry:
  ...
  %bit_picture1 = alloca i32, align 4
  %canary = alloca i32
  store i32 375577153, i32* %canary
  %picture1.addr = alloca %struct.Picture*, align 8
  %picture2.addr = alloca %struct.Picture*, align 8
  store %struct.Picture* %picture1, %struct.Picture** %picture1.addr, align 8
  store %struct.Picture* %picture2, %struct.Picture** %picture2.addr, align 8
