...
ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_WriteRTPPacket.6, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_WriteRTPPacket.7, label %ctrl3
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_WriteRTPNALU.5, label %func_WriteRTPNALU.8

func_WriteRTPNALU.5:                              ; preds = %rand_bb
  %2 = call i32 @WriteRTPNALU.5(%struct.NALU_t* %n)
  ret i32 %2
...
entry:
  %canary = alloca i32
  store i32 962954698, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 776770903, i32* %canary
...
entry:
  ...
  %p.addr = alloca %struct.RTPpacket_t*, align 8
  %canary = alloca i32
  store i32 721876731, i32* %canary
  %intime = alloca i32, align 4
  %f.addr = alloca %struct._IO_FILE*, align 8
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 2041926349, i32* %canary
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 673655619, i32* %canary
  %f.addr = alloca %struct._IO_FILE*, align 8
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
  store i32 -1, i32* %intime, align 4
...
entry:
  %p.addr = alloca %struct.RTPpacket_t*, align 8
  %canary = alloca i32
  store i32 2049771285, i32* %canary
  %intime = alloca i32, align 4
  %f.addr = alloca %struct._IO_FILE*, align 8
  %retval = alloca i32, align 4
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
...
entry:
  %n.addr = alloca %struct.NALU_t*, align 8
  %canary = alloca i32
  store i32 2123823067, i32* %canary
  %p = alloca %struct.RTPpacket_t*, align 8
  store %struct.NALU_t* %n, %struct.NALU_t** %n.addr, align 8
  %0 = load %struct.NALU_t*, %struct.NALU_t** %n.addr, align 8
  %forbidden_bit = getelementptr inbounds %struct.NALU_t, %struct.NALU_t* %0, i32 0, i32 5
...
entry:
  ...
  %f.addr = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 1475849863, i32* %canary
  %retval = alloca i32, align 4
  %intime = alloca i32, align 4
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1135467811, i32* %canary
  %f.addr = alloca %struct._IO_FILE*, align 8
  %p.addr = alloca %struct.RTPpacket_t*, align 8
  %intime = alloca i32, align 4
  %retval = alloca i32, align 4
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1398591292, i32* %canary
  %f.addr = alloca %struct._IO_FILE*, align 8
  %p.addr = alloca %struct.RTPpacket_t*, align 8
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1253330816, i32* %canary
  %intime = alloca i32, align 4
  %retval = alloca i32, align 4
  %p.addr = alloca %struct.RTPpacket_t*, align 8
  %f.addr = alloca %struct._IO_FILE*, align 8
