...
func_PutPel_14.20:                                ; preds = %ctrl0
  call void @PutPel_14.20(i16** %Pic, i32 %y, i32 %x, i16 %val)
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_PutPel_14.20, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_PutPel_14.25, label %func_PutPel_14.31
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_PutPel_11.6, label %ctrl0

func_PutPel_11.6:                                 ; preds = %rand_bb
  call void @PutPel_11.6(i16* %Pic, i32 %y, i32 %x, i16 %val, i32 %width)
  ret void

func_PutPel_11.29:                                ; preds = %ctrl0
...
func_PutPel_11.32:                                ; preds = %ctrl1
  call void @PutPel_11.32(i16* %Pic, i32 %y, i32 %x, i16 %val, i32 %width)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_PutPel_11.29, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_PutPel_11.30, label %func_PutPel_11.32
}
...
func_FastLine16Y_11.19:                           ; preds = %ctrl0
  %3 = call i16* @FastLine16Y_11.19(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %3
...
func_FastLine16Y_11.24:                           ; preds = %ctrl1
  %5 = call i16* @FastLine16Y_11.24(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_FastLine16Y_11.19, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_FastLine16Y_11.22, label %func_FastLine16Y_11.24
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_UMVLine16Y_11.3, label %ctrl0

func_UMVLine16Y_11.3:                             ; preds = %rand_bb
  %2 = call i16* @UMVLine16Y_11.3(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %2
...
func_UMVLine16Y_11.28:                            ; preds = %ctrl1
  %5 = call i16* @UMVLine16Y_11.28(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %5
...
ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_UMVLine16Y_11.18, label %func_UMVLine16Y_11.28
}
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_FastLineX.7, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_FastLineX.14, label %func_FastLineX.21
}
...
func_UMVLineX.12:                                 ; preds = %ctrl1
  %4 = call i16* @UMVLineX.12(i32 %size, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %4

func_UMVLineX.13:                                 ; preds = %ctrl1
  %5 = call i16* @UMVLineX.13(i32 %size, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_UMVLineX.9, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_UMVLineX.12, label %func_UMVLineX.13
}
...
func_UMVPelY_14.26:                               ; preds = %ctrl1
  %5 = call i16 @UMVPelY_14.26(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16 %5
...
ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_UMVPelY_14.16, label %func_UMVPelY_14.26
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FastPelY_14.15, label %ctrl0

func_FastPelY_14.15:                              ; preds = %rand_bb
  %2 = call i16 @FastPelY_14.15(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16 %2
...
func_FastPelY_14.27:                              ; preds = %ctrl1
  %5 = call i16 @FastPelY_14.27(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_FastPelY_14.17, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_FastPelY_14.23, label %func_FastPelY_14.27
}
...
entry:
  %canary = alloca i32
  store i32 548933103, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1164605228, i32* %canary
  %Pic.addr = alloca i16*, align 8
  %y.addr = alloca i32, align 4
  %height.addr = alloca i32, align 4
  %width.addr = alloca i32, align 4
...
entry:
  %height.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1652745110, i32* %canary
  %x.addr = alloca i32, align 4
...
entry:
  ...
  %maxx = alloca i32, align 4
  %canary = alloca i32
  store i32 1620406151, i32* %canary
  %i = alloca i32, align 4
  %retval = alloca i16*, align 8
  %Pic.addr = alloca i16*, align 8
  %y.addr = alloca i32, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 771461933, i32* %canary
  %x.addr = alloca i32, align 4
  %Pic.addr = alloca i16*, align 8
  store i16* %Pic, i16** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
...
entry:
  ...
  %height.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 332076026, i32* %canary
  %Pic.addr = alloca i16*, align 8
  %y.addr = alloca i32, align 4
  %dummy.addr = alloca i32, align 4
  %width.addr = alloca i32, align 4
...
entry:
  %y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1169109046, i32* %canary
  %Pic.addr = alloca i16**, align 8
  %x.addr = alloca i32, align 4
  %val.addr = alloca i16, align 2
  store i16** %Pic, i16*** %Pic.addr, align 8
...
entry:
  ...
  %Pic.addr = alloca i16*, align 8
  %canary = alloca i32
  store i32 377113295, i32* %canary
  %height.addr = alloca i32, align 4
  %x.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %retval = alloca i16*, align 8
...
entry:
  ...
  %height4 = alloca i32, align 4
  %canary = alloca i32
  store i32 1953718094, i32* %canary
  %x.addr = alloca i32, align 4
  %retval = alloca i16, align 2
  %width.addr = alloca i32, align 4
  store i16** %Pic, i16*** %Pic.addr, align 8
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1966119785, i32* %canary
  %width.addr = alloca i32, align 4
  %height.addr = alloca i32, align 4
  store i16* %Pic, i16** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
...
entry:
  ...
  %maxx = alloca i32, align 4
  %canary = alloca i32
  store i32 656706620, i32* %canary
  %y.addr = alloca i32, align 4
  %width.addr = alloca i32, align 4
  %x.addr = alloca i32, align 4
  %Pic.addr = alloca i16*, align 8
...
entry:
  ...
  %y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1103269629, i32* %canary
  %Pic.addr = alloca i16*, align 8
  store i32 %size, i32* %size.addr, align 4
  store i16* %Pic, i16** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 924321681, i32* %canary
  %y.addr = alloca i32, align 4
  %width.addr = alloca i32, align 4
  %x.addr = alloca i32, align 4
  %height.addr = alloca i32, align 4
...
entry:
  ...
  %y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2125625981, i32* %canary
  %retval = alloca i16, align 2
  %width.addr = alloca i32, align 4
  %height4 = alloca i32, align 4
  store i16** %Pic, i16*** %Pic.addr, align 8
...
entry:
  ...
  %Pic.addr = alloca i16*, align 8
  %canary = alloca i32
  store i32 414749573, i32* %canary
  %x.addr = alloca i32, align 4
  store i16* %Pic, i16** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
  store i32 %x, i32* %x.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 402031952, i32* %canary
  %Pic.addr = alloca i16*, align 8
  %y.addr = alloca i32, align 4
  %x.addr = alloca i32, align 4
  %width.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @PutPel_14.20(i16** %Pic, i32 %y, i32 %x, i16 zeroext %val) #0 {
entry:
  %x.addr = alloca i32, align 4
  %Pic.addr = alloca i16**, align 8
  %val.addr = alloca i16, align 2
  %canary = alloca i32
  store i32 1832309080, i32* %canary
  %y.addr = alloca i32, align 4
  store i16** %Pic, i16*** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
  store i32 %x, i32* %x.addr, align 4
...
entry:
  %height.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1789894482, i32* %canary
  %Pic.addr = alloca i16*, align 8
  %x.addr = alloca i32, align 4
  %dummy.addr = alloca i32, align 4
  %width.addr = alloca i32, align 4
...
entry:
  ...
  %height.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 594167168, i32* %canary
  %y.addr = alloca i32, align 4
  store i16* %Pic, i16** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
  store i32 %x, i32* %x.addr, align 4
...
entry:
  ...
  %Pic.addr = alloca i16**, align 8
  %canary = alloca i32
  store i32 1622810176, i32* %canary
  %x.addr = alloca i32, align 4
  store i16** %Pic, i16*** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
  store i32 %x, i32* %x.addr, align 4
...
entry:
  ...
  %height.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1729154493, i32* %canary
  %Pic.addr = alloca i16*, align 8
  %width.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
  store i16* %Pic, i16** %Pic.addr, align 8
...
entry:
  %y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1425331405, i32* %canary
  %val.addr = alloca i16, align 2
  %x.addr = alloca i32, align 4
  %Pic.addr = alloca i16**, align 8
  store i16** %Pic, i16*** %Pic.addr, align 8
...
entry:
  ...
  %width.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 615237658, i32* %canary
  %Pic.addr = alloca i16**, align 8
  %height.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
  %retval = alloca i16, align 2
...
entry:
  ...
  %y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1132859930, i32* %canary
  %height.addr = alloca i32, align 4
  store i16** %Pic, i16*** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
  store i32 %x, i32* %x.addr, align 4
...
entry:
  %y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 662028017, i32* %canary
  %i = alloca i32, align 4
  %Pic.addr = alloca i16*, align 8
  %height.addr = alloca i32, align 4
  %retval = alloca i16*, align 8
...
entry:
  %canary = alloca i32
  store i32 1382028518, i32* %canary
  %y.addr = alloca i32, align 4
  %val.addr = alloca i16, align 2
  %x.addr = alloca i32, align 4
  %width.addr = alloca i32, align 4
...
entry:
  %x.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1047653505, i32* %canary
  %Pic.addr = alloca i16*, align 8
  %y.addr = alloca i32, align 4
  %width.addr = alloca i32, align 4
  %val.addr = alloca i16, align 2
...
entry:
  %canary = alloca i32
  store i32 1914821918, i32* %canary
  %val.addr = alloca i16, align 2
  %x.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
  %Pic.addr = alloca i16**, align 8
...
entry:
  ...
  %x.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1616287791, i32* %canary
  %Pic.addr = alloca i16*, align 8
  store i16* %Pic, i16** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
  store i32 %x, i32* %x.addr, align 4
