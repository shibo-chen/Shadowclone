; ModuleID = 'q_offsets.c.rand.8P2.bc'
...
func_CheckOffsetParameterName.12:                 ; preds = %ctrl0
  %3 = call i32 @CheckOffsetParameterName.12(i8* %s, i32* %type)
  ret i32 %3

func_CheckOffsetParameterName.20:                 ; preds = %ctrl1
  %4 = call i32 @CheckOffsetParameterName.20(i8* %s, i32* %type)
  ret i32 %4

func_CheckOffsetParameterName.23:                 ; preds = %ctrl2
  %5 = call i32 @CheckOffsetParameterName.23(i8* %s, i32* %type)
  ret i32 %5

func_CheckOffsetParameterName.26:                 ; preds = %ctrl3
  %6 = call i32 @CheckOffsetParameterName.26(i8* %s, i32* %type)
  ret i32 %6
...
ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_CheckOffsetParameterName.12, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_CheckOffsetParameterName.20, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_CheckOffsetParameterName.23, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_CheckOffsetParameterName.26, label %ctrl4
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_ParseQOffsetMatrix.1, label %ctrl0

func_ParseQOffsetMatrix.1:                        ; preds = %rand_bb
  call void @ParseQOffsetMatrix.1(i8* %buf, i32 %bufsize)
  ret void

func_ParseQOffsetMatrix.3:                        ; preds = %ctrl0
  call void @ParseQOffsetMatrix.3(i8* %buf, i32 %bufsize)
  ret void

func_ParseQOffsetMatrix.4:                        ; preds = %ctrl1
  call void @ParseQOffsetMatrix.4(i8* %buf, i32 %bufsize)
  ret void

func_ParseQOffsetMatrix.5:                        ; preds = %ctrl2
  call void @ParseQOffsetMatrix.5(i8* %buf, i32 %bufsize)
  ret void

func_ParseQOffsetMatrix.6:                        ; preds = %ctrl3
  call void @ParseQOffsetMatrix.6(i8* %buf, i32 %bufsize)
  ret void

func_ParseQOffsetMatrix.7:                        ; preds = %ctrl4
  call void @ParseQOffsetMatrix.7(i8* %buf, i32 %bufsize)
  ret void

func_ParseQOffsetMatrix.9:                        ; preds = %ctrl5
  call void @ParseQOffsetMatrix.9(i8* %buf, i32 %bufsize)
  ret void

func_ParseQOffsetMatrix.10:                       ; preds = %ctrl5
  call void @ParseQOffsetMatrix.10(i8* %buf, i32 %bufsize)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_ParseQOffsetMatrix.3, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_ParseQOffsetMatrix.4, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_ParseQOffsetMatrix.5, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_ParseQOffsetMatrix.6, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_ParseQOffsetMatrix.7, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_ParseQOffsetMatrix.9, label %func_ParseQOffsetMatrix.10
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_CalculateOffsetParam.13, label %ctrl0

func_CalculateOffsetParam.13:                     ; preds = %rand_bb
  call void @CalculateOffsetParam.13()
  ret void

func_CalculateOffsetParam.14:                     ; preds = %ctrl0
  call void @CalculateOffsetParam.14()
  ret void

func_CalculateOffsetParam.19:                     ; preds = %ctrl1
  call void @CalculateOffsetParam.19()
  ret void

func_CalculateOffsetParam.21:                     ; preds = %ctrl2
  call void @CalculateOffsetParam.21()
  ret void

func_CalculateOffsetParam.22:                     ; preds = %ctrl3
  call void @CalculateOffsetParam.22()
  ret void

func_CalculateOffsetParam.25:                     ; preds = %ctrl4
...
func_CalculateOffsetParam.29:                     ; preds = %ctrl5
  call void @CalculateOffsetParam.29()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_CalculateOffsetParam.14, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_CalculateOffsetParam.19, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_CalculateOffsetParam.21, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_CalculateOffsetParam.22, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_CalculateOffsetParam.25, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_CalculateOffsetParam.28, label %func_CalculateOffsetParam.29
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_CalculateOffset8Param.8, label %ctrl0

func_CalculateOffset8Param.8:                     ; preds = %rand_bb
  call void @CalculateOffset8Param.8()
  ret void

func_CalculateOffset8Param.11:                    ; preds = %ctrl0
  call void @CalculateOffset8Param.11()
  ret void

func_CalculateOffset8Param.15:                    ; preds = %ctrl1
  call void @CalculateOffset8Param.15()
  ret void

func_CalculateOffset8Param.16:                    ; preds = %ctrl2
  call void @CalculateOffset8Param.16()
  ret void

func_CalculateOffset8Param.17:                    ; preds = %ctrl3
  call void @CalculateOffset8Param.17()
  ret void
...
func_CalculateOffset8Param.27:                    ; preds = %ctrl5
  call void @CalculateOffset8Param.27()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_CalculateOffset8Param.11, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_CalculateOffset8Param.15, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_CalculateOffset8Param.16, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_CalculateOffset8Param.17, label %ctrl4
...
ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_CalculateOffset8Param.24, label %func_CalculateOffset8Param.27
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @ParseQOffsetMatrix.1(i8* %buf, i32 %bufsize) #0 {
entry:
  %MapIdx = alloca i32, align 4
  %canary = alloca i32
  store i32 1693568844, i32* %canary
  %p = alloca i8*, align 8
...
entry:
  ...
  %canary = alloca i32
  store i32 1880660257, i32* %canary
  %i = alloca i32, align 4
...
entry:
  %p = alloca i8*, align 8
  %canary = alloca i32
  store i32 232586796, i32* %canary
  %range = alloca i32, align 4
  %cnt = alloca i32, align 4
  %i = alloca i32, align 4
  %j = alloca i32, align 4
...
entry:
  ...
  %InItem = alloca i32, align 4
  %canary = alloca i32
  store i32 1473138786, i32* %canary
  %MapIdx = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %bufsize, i32* %bufsize.addr, align 4
  store i32 0, i32* %item, align 4
...
entry:
  ...
  %bufsize.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 956747486, i32* %canary
  %IntContent = alloca i32, align 4
  %i = alloca i32, align 4
  %p = alloca i8*, align 8
  %bufend = alloca i8*, align 8
...
entry:
  ...
  %item = alloca i32, align 4
  %canary = alloca i32
  store i32 1485556336, i32* %canary
  %range = alloca i32, align 4
  %InItem = alloca i32, align 4
  %j = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
...
entry:
  ...
  %p = alloca i8*, align 8
  %canary = alloca i32
  store i32 1290952562, i32* %canary
  %OffsetList = alloca i16*, align 8
  %InItem = alloca i32, align 4
  %cnt = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
...
entry:
  ...
  %canary = alloca i32
  store i32 1006303639, i32* %canary
...
entry:
  ...
  %bufsize.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1648589529, i32* %canary
  %type = alloca i32, align 4
  %IntContent = alloca i32, align 4
  %cnt = alloca i32, align 4
  %MapIdx = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1999122173, i32* %canary
  %j = alloca i32, align 4
  %i = alloca i32, align 4
  %k = alloca i32, align 4
  %q_bits = alloca i32, align 4
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 2092109349, i32* %canary
  %s.addr = alloca i8*, align 8
  %i = alloca i32, align 4
  store i8* %s, i8** %s.addr, align 8
  store i32* %type, i32** %type.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1315239529, i32* %canary
...
if.end225:                                        ; preds = %for.end224, %for.end102
  ...
  %133 = icmp eq i32 %132, 1315239529
...
entry:
  %canary = alloca i32
  store i32 430423959, i32* %canary
  %i = alloca i32, align 4
  %k = alloca i32, align 4
  %qp_per = alloca i32, align 4
  %j = alloca i32, align 4
...
entry:
  ...
  %temp = alloca i32, align 4
  %canary = alloca i32
  store i32 864629604, i32* %canary
  %q_bits = alloca i32, align 4
  %j = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %OffsetMatrixPresentFlag = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 147
...
entry:
  ...
  %q_bits = alloca i32, align 4
  %canary = alloca i32
  store i32 2006110868, i32* %canary
  %temp = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %OffsetMatrixPresentFlag = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 147
  %1 = load i32, i32* %OffsetMatrixPresentFlag, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @CalculateOffset8Param.17() #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 346893605, i32* %canary
  %q_bits = alloca i32, align 4
  %j = alloca i32, align 4
  %temp = alloca i32, align 4
  %k = alloca i32, align 4
...
entry:
  %q_bits = alloca i32, align 4
  %canary = alloca i32
  store i32 888339957, i32* %canary
  %temp = alloca i32, align 4
  %k = alloca i32, align 4
  %i = alloca i32, align 4
  %j = alloca i32, align 4
...
entry:
  ...
  %temp = alloca i32, align 4
  %canary = alloca i32
  store i32 717995532, i32* %canary
  %j = alloca i32, align 4
  %k = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %OffsetMatrixPresentFlag = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 147
...
entry:
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1811785833, i32* %canary
  %s.addr = alloca i8*, align 8
  %type.addr = alloca i32*, align 8
  %i = alloca i32, align 4
  store i8* %s, i8** %s.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1801847858, i32* %canary
  %j = alloca i32, align 4
  %qp_per = alloca i32, align 4
  %temp = alloca i32, align 4
  %k = alloca i32, align 4
...
if.end225:                                        ; preds = %for.end224, %for.end102
  %132 = load i32, i32* %canary
  %133 = icmp eq i32 %132, 1801847858
  br i1 %133, label %134, label %func_exit
...
entry:
  ...
  %qp_per = alloca i32, align 4
  %canary = alloca i32
  store i32 914617822, i32* %canary
  %i = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %OffsetMatrixPresentFlag = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 147
  %1 = load i32, i32* %OffsetMatrixPresentFlag, align 8
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 622422826, i32* %canary
  %s.addr = alloca i8*, align 8
  store i8* %s, i8** %s.addr, align 8
  store i32* %type, i32** %type.addr, align 8
  store i32 0, i32* %i, align 4
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1104073086, i32* %canary
  %temp = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %OffsetMatrixPresentFlag = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 147
  %1 = load i32, i32* %OffsetMatrixPresentFlag, align 8
...
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 417201299, i32* %canary
  %qp_per = alloca i32, align 4
  %j = alloca i32, align 4
  %k = alloca i32, align 4
  %temp = alloca i32, align 4
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1865626199, i32* %canary
  %type.addr = alloca i32*, align 8
  %i = alloca i32, align 4
  store i8* %s, i8** %s.addr, align 8
  store i32* %type, i32** %type.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @CalculateOffset8Param.27() #0 {
entry:
  %canary = alloca i32
  store i32 1152161803, i32* %canary
  %k = alloca i32, align 4
  %q_bits = alloca i32, align 4
  %temp = alloca i32, align 4
  %i = alloca i32, align 4
...
entry:
  %temp = alloca i32, align 4
  %canary = alloca i32
  store i32 740296717, i32* %canary
  %i = alloca i32, align 4
  %qp_per = alloca i32, align 4
  %j = alloca i32, align 4
  %k = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 258503796, i32* %canary
  %j = alloca i32, align 4
  %temp = alloca i32, align 4
  %qp_per = alloca i32, align 4
  %k = alloca i32, align 4
...
entry:
  ...
  %type.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 1732006899, i32* %canary
  %s.addr = alloca i8*, align 8
  %i = alloca i32, align 4
  store i8* %s, i8** %s.addr, align 8
  store i32* %type, i32** %type.addr, align 8
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 599532865, i32* %canary
  %retval = alloca i32, align 4
  store i8* %s, i8** %s.addr, align 8
  store i32* %type, i32** %type.addr, align 8
  store i32 0, i32* %i, align 4
...
entry:
  %s.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1744439278, i32* %canary
  %type.addr = alloca i32*, align 8
  %i = alloca i32, align 4
  %retval = alloca i32, align 4
  store i8* %s, i8** %s.addr, align 8
