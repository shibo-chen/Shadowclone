; ModuleID = 'decoder.c.rand.4R3.bc'
...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_decode_one_b8block.10, label %ctrl0

func_decode_one_b8block.10:                       ; preds = %rand_bb
  call void @decode_one_b8block.10(i32 %decoder, i32 %mbmode, i32 %b8block, i32 %b8mode, i32 %b8ref)
  ret void

func_decode_one_b8block.27:                       ; preds = %ctrl0
  call void @decode_one_b8block.27(i32 %decoder, i32 %mbmode, i32 %b8block, i32 %b8mode, i32 %b8ref)
  ret void

func_decode_one_b8block.31:                       ; preds = %ctrl1
  call void @decode_one_b8block.31(i32 %decoder, i32 %mbmode, i32 %b8block, i32 %b8mode, i32 %b8ref)
  ret void

func_decode_one_b8block.32:                       ; preds = %ctrl1
  call void @decode_one_b8block.32(i32 %decoder, i32 %mbmode, i32 %b8block, i32 %b8mode, i32 %b8ref)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_decode_one_b8block.27, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_decode_one_b8block.31, label %func_decode_one_b8block.32
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_Get_Reference_Block.2, label %ctrl0

func_Get_Reference_Block.2:                       ; preds = %rand_bb
  call void @Get_Reference_Block.2(i16** %imY, i32 %block_y, i32 %block_x, i32 %mvhor, i32 %mvver, i16** %out)
  ret void

func_Get_Reference_Block.7:                       ; preds = %ctrl0
  call void @Get_Reference_Block.7(i16** %imY, i32 %block_y, i32 %block_x, i32 %mvhor, i32 %mvver, i16** %out)
  ret void

func_Get_Reference_Block.15:                      ; preds = %ctrl1
  call void @Get_Reference_Block.15(i16** %imY, i32 %block_y, i32 %block_x, i32 %mvhor, i32 %mvver, i16** %out)
  ret void

func_Get_Reference_Block.19:                      ; preds = %ctrl1
  call void @Get_Reference_Block.19(i16** %imY, i32 %block_y, i32 %block_x, i32 %mvhor, i32 %mvver, i16** %out)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_Get_Reference_Block.7, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_Get_Reference_Block.15, label %func_Get_Reference_Block.19
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_decode_one_mb.25, label %func_decode_one_mb.26

func_decode_one_mb.25:                            ; preds = %rand_bb
  call void @decode_one_mb.25(i32 %decoder, %struct.macroblock* %currMB)
  ret void

func_decode_one_mb.26:                            ; preds = %rand_bb
  call void @decode_one_mb.26(i32 %decoder, %struct.macroblock* %currMB)
  ret void
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_Get_Reference_Pixel.8, label %ctrl0

func_Get_Reference_Pixel.8:                       ; preds = %rand_bb
  %2 = call i8 @Get_Reference_Pixel.8(i16** %imY, i32 %y_pos, i32 %x_pos)
  ret i8 %2

func_Get_Reference_Pixel.28:                      ; preds = %ctrl0
  %3 = call i8 @Get_Reference_Pixel.28(i16** %imY, i32 %y_pos, i32 %x_pos)
  ret i8 %3

func_Get_Reference_Pixel.33:                      ; preds = %ctrl1
  %4 = call i8 @Get_Reference_Pixel.33(i16** %imY, i32 %y_pos, i32 %x_pos)
  ret i8 %4

func_Get_Reference_Pixel.34:                      ; preds = %ctrl1
  %5 = call i8 @Get_Reference_Pixel.34(i16** %imY, i32 %y_pos, i32 %x_pos)
  ret i8 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_Get_Reference_Pixel.28, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_Get_Reference_Pixel.33, label %func_Get_Reference_Pixel.34
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_Build_Status_Map.1, label %ctrl0

func_Build_Status_Map.1:                          ; preds = %rand_bb
  call void @Build_Status_Map.1(i8** %s_map)
  ret void

func_Build_Status_Map.3:                          ; preds = %ctrl0
  call void @Build_Status_Map.3(i8** %s_map)
  ret void

func_Build_Status_Map.16:                         ; preds = %ctrl1
  call void @Build_Status_Map.16(i8** %s_map)
  ret void

func_Build_Status_Map.21:                         ; preds = %ctrl1
  call void @Build_Status_Map.21(i8** %s_map)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_Build_Status_Map.3, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_Build_Status_Map.16, label %func_Build_Status_Map.21
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_Error_Concealment.4, label %ctrl0

func_Error_Concealment.4:                         ; preds = %rand_bb
  call void @Error_Concealment.4(i16** %inY, i8** %s_map, i16*** %refY)
  ret void

func_Error_Concealment.5:                         ; preds = %ctrl0
  call void @Error_Concealment.5(i16** %inY, i8** %s_map, i16*** %refY)
  ret void

func_Error_Concealment.6:                         ; preds = %ctrl1
  call void @Error_Concealment.6(i16** %inY, i8** %s_map, i16*** %refY)
  ret void

func_Error_Concealment.14:                        ; preds = %ctrl1
  call void @Error_Concealment.14(i16** %inY, i8** %s_map, i16*** %refY)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_Error_Concealment.5, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_Error_Concealment.6, label %func_Error_Concealment.14
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_DecOneForthPix.9, label %ctrl0

func_DecOneForthPix.9:                            ; preds = %rand_bb
  call void @DecOneForthPix.9(i16** %dY, i16*** %dref)
  ret void

func_DecOneForthPix.12:                           ; preds = %ctrl0
  call void @DecOneForthPix.12(i16** %dY, i16*** %dref)
  ret void

func_DecOneForthPix.29:                           ; preds = %ctrl1
  call void @DecOneForthPix.29(i16** %dY, i16*** %dref)
  ret void

func_DecOneForthPix.30:                           ; preds = %ctrl1
  call void @DecOneForthPix.30(i16** %dY, i16*** %dref)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_DecOneForthPix.12, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_DecOneForthPix.29, label %func_DecOneForthPix.30
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_compute_residue_b8block.13, label %ctrl0

func_compute_residue_b8block.13:                  ; preds = %rand_bb
  call void @compute_residue_b8block.13(i32 %b8block, i32 %i16mode)
  ret void

func_compute_residue_b8block.17:                  ; preds = %ctrl0
  call void @compute_residue_b8block.17(i32 %b8block, i32 %i16mode)
  ret void

func_compute_residue_b8block.23:                  ; preds = %ctrl1
  call void @compute_residue_b8block.23(i32 %b8block, i32 %i16mode)
  ret void

func_compute_residue_b8block.24:                  ; preds = %ctrl1
  call void @compute_residue_b8block.24(i32 %b8block, i32 %i16mode)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_compute_residue_b8block.17, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_compute_residue_b8block.23, label %func_compute_residue_b8block.24
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_Conceal_Error.11, label %ctrl0

func_Conceal_Error.11:                            ; preds = %rand_bb
  call void @Conceal_Error.11(i16** %inY, i32 %mb_y, i32 %mb_x, i16*** %refY, i8** %s_map)
  ret void

func_Conceal_Error.18:                            ; preds = %ctrl0
  call void @Conceal_Error.18(i16** %inY, i32 %mb_y, i32 %mb_x, i16*** %refY, i8** %s_map)
  ret void

func_Conceal_Error.20:                            ; preds = %ctrl1
  call void @Conceal_Error.20(i16** %inY, i32 %mb_y, i32 %mb_x, i16*** %refY, i8** %s_map)
  ret void

func_Conceal_Error.22:                            ; preds = %ctrl1
  call void @Conceal_Error.22(i16** %inY, i32 %mb_y, i32 %mb_x, i16*** %refY, i8** %s_map)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_Conceal_Error.18, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_Conceal_Error.20, label %func_Conceal_Error.22
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Build_Status_Map.1(i8** %s_map) #0 {
entry:
  %mb = alloca i32, align 4
  %canary = alloca i32
  store i32 724253941, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Get_Reference_Block.2(i16** %imY, i32 %block_y, i32 %block_x, i32 %mvhor, i32 %mvver, i16** %out) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 2131314801, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Build_Status_Map.3(i8** %s_map) #0 {
entry:
  %s_map.addr = alloca i8**, align 8
  %canary = alloca i32
  store i32 1415294232, i32* %canary
  %ii = alloca i32, align 4
  %slice = alloca i32, align 4
  %mb = alloca i32, align 4
  %j = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Error_Concealment.4(i16** %inY, i8** %s_map, i16*** %refY) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 165471811, i32* %canary
  %s_map.addr = alloca i8**, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Error_Concealment.5(i16** %inY, i8** %s_map, i16*** %refY) #0 {
entry:
  %s_map.addr = alloca i8**, align 8
  %mb_h = alloca i32, align 4
  %refY.addr = alloca i16***, align 8
  %canary = alloca i32
  store i32 39158091, i32* %canary
  %mb_y = alloca i32, align 4
  %mb_x = alloca i32, align 4
  %mb_w = alloca i32, align 4
  %inY.addr = alloca i16**, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Error_Concealment.6(i16** %inY, i8** %s_map, i16*** %refY) #0 {
entry:
  %canary = alloca i32
  store i32 1960398365, i32* %canary
  %mb_y = alloca i32, align 4
  %refY.addr = alloca i16***, align 8
  %s_map.addr = alloca i8**, align 8
  %inY.addr = alloca i16**, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Get_Reference_Block.7(i16** %imY, i32 %block_y, i32 %block_x, i32 %mvhor, i32 %mvver, i16** %out) #0 {
entry:
  %i = alloca i32, align 4
  %block_x.addr = alloca i32, align 4
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1470967496, i32* %canary
  %mvhor.addr = alloca i32, align 4
  %mvver.addr = alloca i32, align 4
  %block_y.addr = alloca i32, align 4
  %y = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local zeroext i8 @Get_Reference_Pixel.8(i16** %imY, i32 %y_pos, i32 %x_pos) #0 {
entry:
  %result2 = alloca i32, align 4
  %maxold_y = alloca i32, align 4
  %x_pos.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 554018279, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @DecOneForthPix.9(i16** %dY, i16*** %dref) #0 {
entry:
  %ref = alloca i32, align 4
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 488394312, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @decode_one_b8block.10(i32 %decoder, i32 %mbmode, i32 %b8block, i32 %b8mode, i32 %b8ref) #0 {
entry:
...
entry:
  ...
  %canary = alloca i32
  store i32 1579980761, i32* %canary
...
sw.epilog:                                        ; preds = %if.end545, %if.end487, %if.end321, %if.end, %land.end54
  ...
  %326 = icmp eq i32 %325, 1579980761
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @DecOneForthPix.12(i16** %dY, i16*** %dref) #0 {
entry:
  %canary = alloca i32
  store i32 1739535336, i32* %canary
  %j = alloca i32, align 4
  %ref = alloca i32, align 4
  %dref.addr = alloca i16***, align 8
  %dY.addr = alloca i16**, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @compute_residue_b8block.13(i32 %b8block, i32 %i16mode) #0 {
entry:
  %j1 = alloca i32, align 4
  %canary = alloca i32
  store i32 1750438981, i32* %canary
  %j0 = alloca i32, align 4
  %i1 = alloca i32, align 4
  %j = alloca i32, align 4
  %i16mode.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Error_Concealment.14(i16** %inY, i8** %s_map, i16*** %refY) #0 {
entry:
  %s_map.addr = alloca i8**, align 8
  %mb_w = alloca i32, align 4
  %mb_y = alloca i32, align 4
  %canary = alloca i32
  store i32 1468526761, i32* %canary
  %inY.addr = alloca i16**, align 8
  %refY.addr = alloca i16***, align 8
  %mb_x = alloca i32, align 4
  %mb_h = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Get_Reference_Block.15(i16** %imY, i32 %block_y, i32 %block_x, i32 %mvhor, i32 %mvver, i16** %out) #0 {
entry:
  %mvhor.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1658949088, i32* %canary
  %y = alloca i32, align 4
  %block_x.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %imY.addr = alloca i16**, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Build_Status_Map.16(i8** %s_map) #0 {
entry:
  %j = alloca i32, align 4
  %ii = alloca i32, align 4
  %mb = alloca i32, align 4
  ...
  %slice = alloca i32, align 4
  %canary = alloca i32
  store i32 916717373, i32* %canary
  %packet_lost = alloca i32, align 4
  store i8** %s_map, i8*** %s_map.addr, align 8
  store i32 -1, i32* %slice, align 4
  store i32 0, i32* %mb, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @compute_residue_b8block.17(i32 %b8block, i32 %i16mode) #0 {
entry:
  %canary = alloca i32
  store i32 1198546106, i32* %canary
  %i = alloca i32, align 4
  %j0 = alloca i32, align 4
  %i1 = alloca i32, align 4
  %j = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Conceal_Error.18(i16** %inY, i32 %mb_y, i32 %mb_x, i16*** %refY, i8** %s_map) #0 {
entry:
  %copy = alloca i32, align 4
  %refY.addr = alloca i16***, align 8
  %pos_y = alloca i32, align 4
  ...
  %tmp_mv = alloca i16***, align 8
  %canary = alloca i32
  store i32 382241208, i32* %canary
  %inter = alloca i32, align 4
  %resY = alloca [16 x [16 x i32]], align 16
  %mb_y.addr = alloca i32, align 4
  store i16** %inY, i16*** %inY.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Get_Reference_Block.19(i16** %imY, i32 %block_y, i32 %block_x, i32 %mvhor, i32 %mvver, i16** %out) #0 {
entry:
  %mvver.addr = alloca i32, align 4
  %j = alloca i32, align 4
  %out.addr = alloca i16**, align 8
  ...
  %block_y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1115510086, i32* %canary
  %y = alloca i32, align 4
  %mvhor.addr = alloca i32, align 4
  %x = alloca i32, align 4
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Conceal_Error.20(i16** %inY, i32 %mb_y, i32 %mb_x, i16*** %refY, i8** %s_map) #0 {
entry:
  %block_y = alloca i32, align 4
  %i = alloca i32, align 4
  %inY.addr = alloca i16**, align 8
  ...
  %block_x = alloca i32, align 4
  %canary = alloca i32
  store i32 2135129737, i32* %canary
  %j = alloca i32, align 4
  %mb_x.addr = alloca i32, align 4
  %resY = alloca [16 x [16 x i32]], align 16
  %s_map.addr = alloca i8**, align 8
...
sw.epilog:                                        ; preds = %if.end545, %if.end487, %if.end321, %if.end, %land.end54
  %325 = load i32, i32* %canary
  %326 = icmp eq i32 %325, 2135129737
  br i1 %326, label %327, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Build_Status_Map.21(i8** %s_map) #0 {
entry:
  %ii = alloca i32, align 4
  %j = alloca i32, align 4
  %mb = alloca i32, align 4
  %canary = alloca i32
  store i32 354474026, i32* %canary
  %packet_lost = alloca i32, align 4
  %s_map.addr = alloca i8**, align 8
  %i = alloca i32, align 4
  %jj = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Conceal_Error.22(i16** %inY, i32 %mb_y, i32 %mb_x, i16*** %refY, i8** %s_map) #0 {
entry:
  %inY.addr = alloca i16**, align 8
  %mb_x.addr = alloca i32, align 4
  %mb_y.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @compute_residue_b8block.23(i32 %b8block, i32 %i16mode) #0 {
entry:
  %i16mode.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %j1 = alloca i32, align 4
  %canary = alloca i32
  store i32 264163557, i32* %canary
  %i1 = alloca i32, align 4
  %j0 = alloca i32, align 4
  %b8block.addr = alloca i32, align 4
  %i0 = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @compute_residue_b8block.24(i32 %b8block, i32 %i16mode) #0 {
entry:
  %i = alloca i32, align 4
  %j1 = alloca i32, align 4
  %b8block.addr = alloca i32, align 4
  ...
  %i1 = alloca i32, align 4
  %canary = alloca i32
  store i32 303625759, i32* %canary
  %j0 = alloca i32, align 4
  %i0 = alloca i32, align 4
  store i32 %b8block, i32* %b8block.addr, align 4
  store i32 %i16mode, i32* %i16mode.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @decode_one_mb.25(i32 %decoder, %struct.macroblock* %currMB) #0 {
entry:
  %decoder.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1251969702, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @decode_one_mb.26(i32 %decoder, %struct.macroblock* %currMB) #0 {
entry:
  %currMB.addr = alloca %struct.macroblock*, align 8
  %canary = alloca i32
  store i32 2021928026, i32* %canary
  %decoder.addr = alloca i32, align 4
  store i32 %decoder, i32* %decoder.addr, align 4
  store %struct.macroblock* %currMB, %struct.macroblock** %currMB.addr, align 8
  %0 = load i32, i32* %canary
  %1 = icmp eq i32 %0, 2021928026
  br i1 %1, label %2, label %func_exit
...
entry:
  ...
  %ref_inx = alloca i32, align 4
  %canary = alloca i32
  store i32 1303664831, i32* %canary
  %by = alloca i32, align 4
  %j1 = alloca i32, align 4
  %block_x = alloca i32, align 4
  %mbmode.addr = alloca i32, align 4
...
if.end315:                                        ; preds = %if.end314, %for.end28
  %241 = load i32, i32* %canary
  %242 = icmp eq i32 %241, 1303664831
  br i1 %242, label %243, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local zeroext i8 @Get_Reference_Pixel.28(i16** %imY, i32 %y_pos, i32 %x_pos) #0 {
entry:
  %pres_y = alloca i32, align 4
  %tmp_res = alloca [6 x i32], align 16
  %pres_x = alloca i32, align 4
  ...
  %result1 = alloca i32, align 4
  %canary = alloca i32
  store i32 1846961954, i32* %canary
  %result2 = alloca i32, align 4
  %maxold_y = alloca i32, align 4
  %imY.addr = alloca i16**, align 8
  %dy = alloca i32, align 4
...
if.end926:                                        ; preds = %if.end925, %cond.end31
  ...
  %conv927 = trunc i32 %436 to i8
  %437 = load i32, i32* %canary
  %438 = icmp eq i32 %437, 1846961954
  br i1 %438, label %439, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @DecOneForthPix.29(i16** %dY, i16*** %dref) #0 {
entry:
  %canary = alloca i32
  store i32 784427997, i32* %canary
  %ref = alloca i32, align 4
  %dref.addr = alloca i16***, align 8
  %dY.addr = alloca i16**, align 8
  %j = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @DecOneForthPix.30(i16** %dY, i16*** %dref) #0 {
entry:
  %canary = alloca i32
  store i32 247220885, i32* %canary
  %dY.addr = alloca i16**, align 8
  %ref = alloca i32, align 4
  %j = alloca i32, align 4
  %dref.addr = alloca i16***, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @decode_one_b8block.31(i32 %decoder, i32 %mbmode, i32 %b8block, i32 %b8mode, i32 %b8ref) #0 {
entry:
  %j = alloca i32, align 4
  %mv = alloca [2 x [4 x [4 x i32]]], align 16
  %canary = alloca i32
  store i32 863823520, i32* %canary
  %i0 = alloca i32, align 4
  %j0 = alloca i32, align 4
  %resY_tmp = alloca [16 x [16 x i32]], align 16
  %block_x = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @decode_one_b8block.32(i32 %decoder, i32 %mbmode, i32 %b8block, i32 %b8mode, i32 %b8ref) #0 {
entry:
  %j = alloca i32, align 4
  %by0 = alloca i32, align 4
  %mbmode.addr = alloca i32, align 4
  %ref_inx = alloca i32, align 4
  %canary = alloca i32
  store i32 104716787, i32* %canary
  %mv = alloca [2 x [4 x [4 x i32]]], align 16
  %i = alloca i32, align 4
  %j0 = alloca i32, align 4
  %bx0 = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local zeroext i8 @Get_Reference_Pixel.33(i16** %imY, i32 %y_pos, i32 %x_pos) #0 {
entry:
  %maxold_y = alloca i32, align 4
  %x = alloca i32, align 4
  %maxold_x = alloca i32, align 4
  ...
  %x_pos.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1693498800, i32* %canary
  %pres_x = alloca i32, align 4
  %tmp_res = alloca [6 x i32], align 16
  %y_pos.addr = alloca i32, align 4
  %dx = alloca i32, align 4
...
if.end926:                                        ; preds = %if.end925, %cond.end31
  ...
  %conv927 = trunc i32 %436 to i8
  %437 = load i32, i32* %canary
  %438 = icmp eq i32 %437, 1693498800
  br i1 %438, label %439, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local zeroext i8 @Get_Reference_Pixel.34(i16** %imY, i32 %y_pos, i32 %x_pos) #0 {
entry:
  %result1 = alloca i32, align 4
  %result2 = alloca i32, align 4
  %imY.addr = alloca i16**, align 8
  ...
  %x = alloca i32, align 4
  %canary = alloca i32
  store i32 1928901084, i32* %canary
  %dx = alloca i32, align 4
  %pres_y = alloca i32, align 4
  %result = alloca i32, align 4
  %dy = alloca i32, align 4
...
if.end926:                                        ; preds = %if.end925, %cond.end31
  ...
  %conv927 = trunc i32 %436 to i8
  %437 = load i32, i32* %canary
  %438 = icmp eq i32 %437, 1928901084
  br i1 %438, label %439, label %func_exit
