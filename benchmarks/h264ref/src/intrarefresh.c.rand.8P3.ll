; ModuleID = 'intrarefresh.c.rand.8P3.bc'
...
ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_RandomIntraInit.6, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_RandomIntraInit.7, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_RandomIntraInit.8, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_RandomIntraInit.10, label %func_RandomIntraInit.13
}
...
func_RandomIntra.11:                              ; preds = %ctrl1
  %4 = call i32 @RandomIntra.11(i32 %mb)
  ret i32 %4

func_RandomIntra.12:                              ; preds = %ctrl2
  %5 = call i32 @RandomIntra.12(i32 %mb)
  ret i32 %5
...
ctrl1:                                            ; preds = %ctrl0
  %9 = icmp eq i32 %0, 2
  br i1 %9, label %func_RandomIntra.11, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %10 = icmp eq i32 %0, 3
  br i1 %10, label %func_RandomIntra.12, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %11 = icmp eq i32 %0, 4
  br i1 %11, label %func_RandomIntra.15, label %func_RandomIntra.16
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_RandomIntraNewPicture.9, label %func_RandomIntraNewPicture.14

func_RandomIntraNewPicture.9:                     ; preds = %rand_bb
  call void @RandomIntraNewPicture.9()
  ret void

func_RandomIntraNewPicture.14:                    ; preds = %rand_bb
  call void @RandomIntraNewPicture.14()
  ret void
}
...
entry:
  ...
  %canary = alloca i32
  store i32 1992451598, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 2055435944, i32* %canary
...
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1352861573, i32* %canary
  %ysize.addr = alloca i32, align 4
  %refresh.addr = alloca i32, align 4
  %pos = alloca i32, align 4
  %xsize.addr = alloca i32, align 4
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1018208135, i32* %canary
  %ysize.addr = alloca i32, align 4
  store i32 %xsize, i32* %xsize.addr, align 4
  store i32 %ysize, i32* %ysize.addr, align 4
  store i32 %refresh, i32* %refresh.addr, align 4
...
entry:
  %mb.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 965319733, i32* %canary
  %i = alloca i32, align 4
  %retval = alloca i32, align 4
  store i32 %mb, i32* %mb.addr, align 4
  store i32 0, i32* %i, align 4
...
entry:
  %xsize.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1082657959, i32* %canary
  %ysize.addr = alloca i32, align 4
  %refresh.addr = alloca i32, align 4
  %pos = alloca i32, align 4
  %i = alloca i32, align 4
...
entry:
  ...
  %xsize.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 878376582, i32* %canary
  %refresh.addr = alloca i32, align 4
  %ysize.addr = alloca i32, align 4
  store i32 %xsize, i32* %xsize.addr, align 4
  store i32 %ysize, i32* %ysize.addr, align 4
...
entry:
  ...
  %ysize.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1390908435, i32* %canary
  %i = alloca i32, align 4
  store i32 %xsize, i32* %xsize.addr, align 4
  store i32 %ysize, i32* %ysize.addr, align 4
  store i32 %refresh, i32* %refresh.addr, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 487880849, i32* %canary
  %i = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 432869528, i32* %canary
  %pos = alloca i32, align 4
  %ysize.addr = alloca i32, align 4
  %refresh.addr = alloca i32, align 4
  %xsize.addr = alloca i32, align 4
...
entry:
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 373271414, i32* %canary
  %i = alloca i32, align 4
  %mb.addr = alloca i32, align 4
  store i32 %mb, i32* %mb.addr, align 4
  store i32 0, i32* %i, align 4
...
entry:
  %canary = alloca i32
  store i32 345334677, i32* %canary
  %retval = alloca i32, align 4
  %mb.addr = alloca i32, align 4
  %i = alloca i32, align 4
  store i32 %mb, i32* %mb.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 274344828, i32* %canary
  %i = alloca i32, align 4
  %pos = alloca i32, align 4
  %ysize.addr = alloca i32, align 4
  %refresh.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @RandomIntraNewPicture.14() #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 686723707, i32* %canary
  %j = alloca i32, align 4
  %0 = load i32, i32* @NumberIntraPerPicture, align 4
  %1 = load i32, i32* @WalkAround, align 4
  %add = add nsw i32 %1, %0
...
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1854161860, i32* %canary
  %mb.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  store i32 %mb, i32* %mb.addr, align 4
  store i32 0, i32* %i, align 4
