...
.LBB6_2:                                # %func_poc_based_ref_management.5
	...
	.cfi_def_cfa %rsp, 8
	retq
.LBB6_3:                                # %func_poc_based_ref_management.7
	.cfi_def_cfa %rbp, 16
	movl	%ebx, %edi
	...
	.cfi_def_cfa %rsp, 8
	retq
.LBB6_4:                                # %func_poc_based_ref_management.13
	.cfi_def_cfa %rbp, 16
	movl	%ebx, %edi
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$48, %rsp
	movl	$1407754994, -40(%rbp)  # imm = 0x53E8A2F2
	movl	%edi, -36(%rbp)
	movl	$0, -12(%rbp)
...
.LBB7_16:                               # %if.end27
	...
	movq	%rax, 72512(%rcx)
.LBB7_17:                               # %return
	cmpl	$1407754994, -40(%rbp)  # imm = 0x53E8A2F2
	jne	.LBB7_19
.LBB7_18:
	addq	$48, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$1526895763, -60(%rbp)  # imm = 0x5B029493
	movq	input, %rax
	movl	1236(%rax), %eax
	cltd
	movl	$2, %ecx
...
.LBB8_37:                               # %for.end199
	jmp	.LBB8_38
.LBB8_38:                               # %if.end200
	cmpl	$1526895763, -60(%rbp)  # imm = 0x5B029493
	jne	.LBB8_40
.LBB8_39:
	addq	$64, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1381324853, -28(%rbp)  # imm = 0x52555835
	movl	%edi, -20(%rbp)
	movl	%esi, -4(%rbp)
	movl	%edx, -24(%rbp)
	movq	%rcx, -16(%rbp)
...
.LBB9_9:                                # %if.end32
	...
	callq	gop_pyramid
.LBB9_10:                               # %if.end42
	cmpl	$1381324853, -28(%rbp)  # imm = 0x52555835
	jne	.LBB9_12
.LBB9_11:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$681483981, -60(%rbp)   # imm = 0x289E9ECD
	movq	input, %rax
	movl	1236(%rax), %eax
	cltd
	movl	$2, %ecx
...
.LBB10_37:                              # %for.end199
	jmp	.LBB10_38
.LBB10_38:                              # %if.end200
	cmpl	$681483981, -60(%rbp)   # imm = 0x289E9ECD
	jne	.LBB10_40
.LBB10_39:
	addq	$64, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$48, %rsp
	movl	$935103614, -36(%rbp)   # imm = 0x37BC8C7E
	movl	%edi, -40(%rbp)
	movl	$0, -12(%rbp)
	movl	$2147483647, -8(%rbp)   # imm = 0x7FFFFFFF
	movq	img, %rax
...
.LBB11_16:                              # %if.end27
	...
	movq	%rax, 72512(%rcx)
.LBB11_17:                              # %return
	cmpl	$935103614, -36(%rbp)   # imm = 0x37BC8C7E
	jne	.LBB11_19
.LBB11_18:
	addq	$48, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$1450554353, -60(%rbp)  # imm = 0x5675B3F1
	movq	input, %rax
	movl	1236(%rax), %eax
	cltd
	movl	$2, %ecx
...
.LBB12_37:                              # %for.end199
	jmp	.LBB12_38
.LBB12_38:                              # %if.end200
	cmpl	$1450554353, -60(%rbp)  # imm = 0x5675B3F1
	jne	.LBB12_40
.LBB12_39:
	addq	$64, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$48, %rsp
	movl	$131533512, -40(%rbp)   # imm = 0x7D70AC8
	movl	%edi, -36(%rbp)
	movl	$0, -8(%rbp)
...
.LBB13_16:                              # %if.end27
	...
	movq	%rax, 72512(%rcx)
.LBB13_17:                              # %return
	cmpl	$131533512, -40(%rbp)   # imm = 0x7D70AC8
	jne	.LBB13_19
.LBB13_18:
	addq	$48, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1657874630, -28(%rbp)  # imm = 0x62D128C6
	movl	%edi, -20(%rbp)
	movl	%esi, -4(%rbp)
	movl	%edx, -24(%rbp)
	movq	%rcx, -16(%rbp)
...
.LBB14_9:                               # %if.end32
	...
	callq	gop_pyramid
.LBB14_10:                              # %if.end42
	cmpl	$1657874630, -28(%rbp)  # imm = 0x62D128C6
	jne	.LBB14_12
.LBB14_11:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$48, %rsp
	movl	$1494148032, -44(%rbp)  # imm = 0x590EE3C0
	movq	input, %rdi
...
.LBB15_65:                              # %if.end171
	...
	movq	input, %rcx
	movl	%eax, 1236(%rcx)
	cmpl	$1494148032, -44(%rbp)  # imm = 0x590EE3C0
	jne	.LBB15_67
.LBB15_66:
	addq	$48, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$114312606, -28(%rbp)   # imm = 0x6D0459E
	movl	%edi, -24(%rbp)
	movl	%esi, -4(%rbp)
	movl	%edx, -20(%rbp)
	movq	%rcx, -16(%rbp)
...
.LBB16_9:                               # %if.end32
	...
	callq	gop_pyramid
.LBB16_10:                              # %if.end42
	cmpl	$114312606, -28(%rbp)   # imm = 0x6D0459E
	jne	.LBB16_12
.LBB16_11:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1624003031, -28(%rbp)  # imm = 0x60CC51D7
	movl	%edi, -20(%rbp)
	movl	%esi, -4(%rbp)
	movl	%edx, -24(%rbp)
	movq	%rcx, -16(%rbp)
...
.LBB17_9:                               # %if.end32
	...
	callq	gop_pyramid
.LBB17_10:                              # %if.end42
	cmpl	$1624003031, -28(%rbp)  # imm = 0x60CC51D7
	jne	.LBB17_12
.LBB17_11:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$48, %rsp
	movl	$588255657, -44(%rbp)   # imm = 0x231011A9
	movq	input, %rdi
	addq	$1324, %rdi             # imm = 0x52C
	callq	strlen
	movl	%eax, -32(%rbp)
...
.LBB18_65:                              # %if.end171
	...
	movq	input, %rcx
	movl	%eax, 1236(%rcx)
	cmpl	$588255657, -44(%rbp)   # imm = 0x231011A9
	jne	.LBB18_67
.LBB18_66:
	addq	$48, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$48, %rsp
	movl	$1693916558, -40(%rbp)  # imm = 0x64F71D8E
	movl	%edi, -36(%rbp)
	movl	$0, -8(%rbp)
	movl	$2147483647, -12(%rbp)  # imm = 0x7FFFFFFF
	movq	img, %rax
...
.LBB19_16:                              # %if.end27
	...
	movq	%rax, 72512(%rcx)
.LBB19_17:                              # %return
	cmpl	$1693916558, -40(%rbp)  # imm = 0x64F71D8E
	jne	.LBB19_19
.LBB19_18:
	addq	$48, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$2062748785, -60(%rbp)  # imm = 0x7AF30C71
	movq	input, %rax
	movl	1236(%rax), %eax
	cltd
	movl	$2, %ecx
...
.LBB20_37:                              # %for.end199
	jmp	.LBB20_38
.LBB20_38:                              # %if.end200
	cmpl	$2062748785, -60(%rbp)  # imm = 0x7AF30C71
	jne	.LBB20_40
.LBB20_39:
	addq	$64, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$48, %rsp
	movl	$1615771424, -44(%rbp)  # imm = 0x604EB720
	movq	input, %rdi
	addq	$1324, %rdi             # imm = 0x52C
	callq	strlen
	movl	%eax, -36(%rbp)
...
.LBB21_65:                              # %if.end171
	...
	movq	input, %rcx
	movl	%eax, 1236(%rcx)
	cmpl	$1615771424, -44(%rbp)  # imm = 0x604EB720
	jne	.LBB21_67
.LBB21_66:
	addq	$48, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$48, %rsp
	movl	$1473254094, -44(%rbp)  # imm = 0x57D012CE
	movq	input, %rdi
	addq	$1324, %rdi             # imm = 0x52C
	callq	strlen
	movl	%eax, -36(%rbp)
...
.LBB22_65:                              # %if.end171
	...
	movq	input, %rcx
	movl	%eax, 1236(%rcx)
	cmpl	$1473254094, -44(%rbp)  # imm = 0x57D012CE
	jne	.LBB22_67
.LBB22_66:
	addq	$48, %rsp
	popq	%rbp
