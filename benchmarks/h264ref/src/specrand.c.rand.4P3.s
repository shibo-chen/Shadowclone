...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$133347598, -16(%rbp)   # imm = 0x7F2B90E
	movslq	seedi, %rax
	cqto
...
.LBB2_3:                                # %if.end
	...
	cmpl	$133347598, -16(%rbp)   # imm = 0x7F2B90E
	jne	.LBB2_5
.LBB2_4:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1555494401, -16(%rbp)  # imm = 0x5CB6F601
	movslq	seedi, %rax
	cqto
	movl	$127773, %ecx           # imm = 0x1F31D
	idivq	%rcx
...
.LBB3_3:                                # %if.end
	...
	vcvtsi2sdl	seedi, %xmm0, %xmm1
	vdivsd	%xmm0, %xmm1, %xmm0
	cmpl	$1555494401, -16(%rbp)  # imm = 0x5CB6F601
	jne	.LBB3_5
.LBB3_4:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1288012586, -16(%rbp)  # imm = 0x4CC5832A
	movslq	seedi, %rax
	cqto
	movl	$127773, %ecx           # imm = 0x1F31D
	idivq	%rcx
...
.LBB4_3:                                # %if.end
	...
	vcvtsi2sdl	seedi, %xmm0, %xmm1
	vdivsd	%xmm0, %xmm1, %xmm0
	cmpl	$1288012586, -16(%rbp)  # imm = 0x4CC5832A
	jne	.LBB4_5
.LBB4_4:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$710980286, -12(%rbp)   # imm = 0x2A60B2BE
	movslq	seedi, %rax
	cqto
	movl	$127773, %ecx           # imm = 0x1F31D
	idivq	%rcx
...
.LBB5_3:                                # %if.end
	...
	vcvtsi2sdl	seedi, %xmm0, %xmm1
	vdivsd	%xmm0, %xmm1, %xmm0
	cmpl	$710980286, -12(%rbp)   # imm = 0x2A60B2BE
	jne	.LBB5_5
.LBB5_4:
	addq	$32, %rsp
	popq	%rbp
