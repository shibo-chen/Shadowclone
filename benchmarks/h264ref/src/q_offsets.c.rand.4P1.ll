; ModuleID = 'q_offsets.c.rand.4P1.bc'
...
func_CheckOffsetParameterName.4:                  ; preds = %ctrl1
  %4 = call i32 @CheckOffsetParameterName.4(i8* %s, i32* %type)
  ret i32 %4

func_CheckOffsetParameterName.9:                  ; preds = %ctrl1
  %5 = call i32 @CheckOffsetParameterName.9(i8* %s, i32* %type)
  ret i32 %5
...
ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_CheckOffsetParameterName.4, label %func_CheckOffsetParameterName.9
}
...
func_ParseQOffsetMatrix.10:                       ; preds = %ctrl0
  call void @ParseQOffsetMatrix.10(i8* %buf, i32 %bufsize)
  ret void

func_ParseQOffsetMatrix.12:                       ; preds = %ctrl1
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_ParseQOffsetMatrix.10, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_ParseQOffsetMatrix.12, label %func_ParseQOffsetMatrix.13
}
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_CalculateOffsetParam.8, label %func_CalculateOffsetParam.11
}
...
func_CalculateOffset8Param.14:                    ; preds = %ctrl0
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_CalculateOffset8Param.14, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_CalculateOffset8Param.15, label %func_CalculateOffset8Param.16
}
...
entry:
  %canary = alloca i32
  store i32 159637455, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1942923145, i32* %canary
...
if.end225:                                        ; preds = %for.end224, %for.end102
  ...
  %133 = icmp eq i32 %132, 1942923145
...
entry:
  %type.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 1810568115, i32* %canary
  %retval = alloca i32, align 4
  %s.addr = alloca i8*, align 8
  %i = alloca i32, align 4
  store i8* %s, i8** %s.addr, align 8
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1864822885, i32* %canary
  %type.addr = alloca i32*, align 8
  store i8* %s, i8** %s.addr, align 8
  store i32* %type, i32** %type.addr, align 8
  store i32 0, i32* %i, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 1866608247, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1199085349, i32* %canary
  %k = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %OffsetMatrixPresentFlag = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 147
  %1 = load i32, i32* %OffsetMatrixPresentFlag, align 8
...
entry:
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 404599329, i32* %canary
  %qp_per = alloca i32, align 4
  %k = alloca i32, align 4
  %temp = alloca i32, align 4
  %i = alloca i32, align 4
...
entry:
  ...
  %temp = alloca i32, align 4
  %canary = alloca i32
  store i32 2057632265, i32* %canary
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %OffsetMatrixPresentFlag = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 147
...
if.end225:                                        ; preds = %for.end224, %for.end102
  %132 = load i32, i32* %canary
  %133 = icmp eq i32 %132, 2057632265
  br i1 %133, label %134, label %func_exit
...
entry:
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1173968742, i32* %canary
  %s.addr = alloca i8*, align 8
  %i = alloca i32, align 4
  %type.addr = alloca i32*, align 8
  store i8* %s, i8** %s.addr, align 8
...
entry:
  ...
  %MapIdx = alloca i32, align 4
  %canary = alloca i32
  store i32 700040460, i32* %canary
  %p = alloca i8*, align 8
  %IntContent = alloca i32, align 4
  %bufend = alloca i8*, align 8
  store i8* %buf, i8** %buf.addr, align 8
...
entry:
  ...
  %p = alloca i8*, align 8
  %canary = alloca i32
  store i32 529290190, i32* %canary
  %j = alloca i32, align 4
  %items = alloca [1000 x i8*], align 16
  %IntContent = alloca i32, align 4
  %InItem = alloca i32, align 4
...
entry:
  ...
  %type = alloca i32, align 4
  %canary = alloca i32
  store i32 1607225584, i32* %canary
  %InString = alloca i32, align 4
  %i = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  store i8* %buf, i8** %buf.addr, align 8
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1918490548, i32* %canary
  %q_bits = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %OffsetMatrixPresentFlag = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 147
  %1 = load i32, i32* %OffsetMatrixPresentFlag, align 8
...
entry:
  ...
  %temp = alloca i32, align 4
  %canary = alloca i32
  store i32 389159008, i32* %canary
  %k = alloca i32, align 4
  %q_bits = alloca i32, align 4
  %i = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
entry:
  ...
  %k = alloca i32, align 4
  %canary = alloca i32
  store i32 509088944, i32* %canary
  %q_bits = alloca i32, align 4
  %j = alloca i32, align 4
  %i = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
