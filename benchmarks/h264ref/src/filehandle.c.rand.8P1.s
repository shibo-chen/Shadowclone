...
# %bb.1:                                # %func_start_sequence.2
	...
	.cfi_def_cfa %rsp, 8
	retq
.LBB2_2:                                # %func_start_sequence.7
	.cfi_def_cfa %rbp, 16
	callq	start_sequence.7
	popq	%rbp
	.cfi_def_cfa %rsp, 8
	retq
.LBB2_3:                                # %func_start_sequence.11
	.cfi_def_cfa %rbp, 16
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1614594243, -20(%rbp)  # imm = 0x603CC0C3
	movq	%rdi, -16(%rbp)
	movl	%esi, -4(%rbp)
	movq	stderr, %rdi
	movq	-16(%rbp), %rdx
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$165828678, -36(%rbp)   # imm = 0x9E25846
	movl	$0, -12(%rbp)
	movq	input(%rip), %rax
	movl	60(%rax), %eax
	xorl	%ecx, %ecx
...
.LBB5_10:                               # %return
	movl	-20(%rbp), %ebx
	cmpl	$165828678, -36(%rbp)   # imm = 0x9E25846
	jne	.LBB5_12
.LBB5_11:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$498069285, -20(%rbp)   # imm = 0x1DAFEF25
	movq	%rdi, -16(%rbp)
	movl	%esi, -4(%rbp)
	movq	stderr, %rdi
	movq	-16(%rbp), %rdx
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$33481636, -32(%rbp)    # imm = 0x1FEE3A4
	movl	%edi, -12(%rbp)
	movl	%esi, -28(%rbp)
	movq	$0, -24(%rbp)
	movl	-28(%rbp), %edi
	...
	callq	FreeNALU
	movl	-12(%rbp), %ebx
	cmpl	$33481636, -32(%rbp)    # imm = 0x1FEE3A4
	jne	.LBB7_2
.LBB7_1:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$1447738589, -28(%rbp)  # imm = 0x564ABCDD
	movl	%edi, -12(%rbp)
	movl	%esi, -32(%rbp)
	movq	$0, -24(%rbp)
	movl	-32(%rbp), %edi
	...
	callq	FreeNALU
	movl	-12(%rbp), %ebx
	cmpl	$1447738589, -28(%rbp)  # imm = 0x564ABCDD
	jne	.LBB8_2
.LBB8_1:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$1729311191, -28(%rbp)  # imm = 0x671331D7
	movl	%edi, -12(%rbp)
	movl	%esi, -32(%rbp)
	movq	$0, -24(%rbp)
	movl	-32(%rbp), %edi
	...
	callq	FreeNALU
	movl	-12(%rbp), %ebx
	cmpl	$1729311191, -28(%rbp)  # imm = 0x671331D7
	jne	.LBB9_2
.LBB9_1:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$856242956, -40(%rbp)   # imm = 0x33093B0C
	movl	$0, -12(%rbp)
	movq	input(%rip), %rax
	movl	60(%rax), %eax
	xorl	%ecx, %ecx
...
.LBB10_10:                              # %return
	movl	-20(%rbp), %ebx
	cmpl	$856242956, -40(%rbp)   # imm = 0x33093B0C
	jne	.LBB10_12
.LBB10_11:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$1513735001, -28(%rbp)  # imm = 0x5A39C359
	movl	%edi, -12(%rbp)
	movl	%esi, -32(%rbp)
	movq	$0, -24(%rbp)
	movl	-32(%rbp), %edi
	...
	callq	FreeNALU
	movl	-12(%rbp), %ebx
	cmpl	$1513735001, -28(%rbp)  # imm = 0x5A39C359
	jne	.LBB11_2
.LBB11_1:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$348226253, -32(%rbp)   # imm = 0x14C182CD
	movl	%edi, -12(%rbp)
	movl	%esi, -28(%rbp)
	movq	$0, -24(%rbp)
	movl	-28(%rbp), %edi
	...
	callq	FreeNALU
	movl	-12(%rbp), %ebx
	cmpl	$348226253, -32(%rbp)   # imm = 0x14C182CD
	jne	.LBB12_2
.LBB12_1:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$2125198295, -32(%rbp)  # imm = 0x7EABF3D7
	movl	%edi, -12(%rbp)
	movl	%esi, -28(%rbp)
	movq	$0, -24(%rbp)
	movl	-28(%rbp), %edi
	...
	callq	FreeNALU
	movl	-12(%rbp), %ebx
	cmpl	$2125198295, -32(%rbp)  # imm = 0x7EABF3D7
	jne	.LBB13_2
.LBB13_1:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$587502996, -36(%rbp)   # imm = 0x23049594
	movl	$0, -12(%rbp)
	movq	input(%rip), %rax
	movl	60(%rax), %eax
	xorl	%ecx, %ecx
...
.LBB14_10:                              # %return
	movl	-20(%rbp), %ebx
	cmpl	$587502996, -36(%rbp)   # imm = 0x23049594
	jne	.LBB14_12
.LBB14_11:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$918140827, -40(%rbp)   # imm = 0x36B9B79B
	movl	$0, -12(%rbp)
	movq	input(%rip), %rax
	movl	60(%rax), %eax
	xorl	%ecx, %ecx
...
.LBB15_10:                              # %return
	movl	-20(%rbp), %ebx
	cmpl	$918140827, -40(%rbp)   # imm = 0x36B9B79B
	jne	.LBB15_12
.LBB15_11:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$408519388, -40(%rbp)   # imm = 0x185982DC
	movl	$0, -12(%rbp)
	movq	input(%rip), %rax
	movl	60(%rax), %eax
	xorl	%ecx, %ecx
...
.LBB16_10:                              # %return
	movl	-20(%rbp), %ebx
	cmpl	$408519388, -40(%rbp)   # imm = 0x185982DC
	jne	.LBB16_12
.LBB16_11:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$749235316, -36(%rbp)   # imm = 0x2CA86C74
	movl	$0, -12(%rbp)
	movq	input(%rip), %rax
	movl	60(%rax), %eax
	xorl	%ecx, %ecx
...
.LBB17_10:                              # %return
	movl	-20(%rbp), %ebx
	cmpl	$749235316, -36(%rbp)   # imm = 0x2CA86C74
	jne	.LBB17_12
.LBB17_11:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$331601953, -36(%rbp)   # imm = 0x13C3D821
	movl	$0, -12(%rbp)
	movq	input(%rip), %rax
	movl	60(%rax), %eax
	xorl	%ecx, %ecx
...
.LBB18_10:                              # %return
	movl	-20(%rbp), %ebx
	cmpl	$331601953, -36(%rbp)   # imm = 0x13C3D821
	jne	.LBB18_12
.LBB18_11:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$215327526, -40(%rbp)   # imm = 0xCD5A326
	movl	$0, -12(%rbp)
	movq	input(%rip), %rax
	movl	60(%rax), %eax
	xorl	%ecx, %ecx
...
.LBB19_10:                              # %return
	movl	-20(%rbp), %ebx
	cmpl	$215327526, -40(%rbp)   # imm = 0xCD5A326
	jne	.LBB19_12
.LBB19_11:
	movl	%ebx, %eax
	addq	$40, %rsp
