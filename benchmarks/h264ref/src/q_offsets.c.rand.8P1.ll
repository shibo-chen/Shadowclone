; ModuleID = 'q_offsets.c.rand.8P1.bc'
...
func_CheckOffsetParameterName.7:                  ; preds = %ctrl0
  %3 = call i32 @CheckOffsetParameterName.7(i8* %s, i32* %type)
  ret i32 %3

func_CheckOffsetParameterName.14:                 ; preds = %ctrl1
  %4 = call i32 @CheckOffsetParameterName.14(i8* %s, i32* %type)
  ret i32 %4
...
func_CheckOffsetParameterName.23:                 ; preds = %ctrl3
  %6 = call i32 @CheckOffsetParameterName.23(i8* %s, i32* %type)
  ret i32 %6

func_CheckOffsetParameterName.25:                 ; preds = %ctrl4
  %7 = call i32 @CheckOffsetParameterName.25(i8* %s, i32* %type)
  ret i32 %7

func_CheckOffsetParameterName.29:                 ; preds = %ctrl5
  %8 = call i32 @CheckOffsetParameterName.29(i8* %s, i32* %type)
  ret i32 %8

func_CheckOffsetParameterName.30:                 ; preds = %ctrl5
  %9 = call i32 @CheckOffsetParameterName.30(i8* %s, i32* %type)
  ret i32 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_CheckOffsetParameterName.7, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_CheckOffsetParameterName.14, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_CheckOffsetParameterName.19, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_CheckOffsetParameterName.23, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_CheckOffsetParameterName.25, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_CheckOffsetParameterName.29, label %func_CheckOffsetParameterName.30
}
...
func_ParseQOffsetMatrix.10:                       ; preds = %ctrl1
...
func_ParseQOffsetMatrix.15:                       ; preds = %ctrl3
  call void @ParseQOffsetMatrix.15(i8* %buf, i32 %bufsize)
  ret void

func_ParseQOffsetMatrix.20:                       ; preds = %ctrl4
...
func_ParseQOffsetMatrix.27:                       ; preds = %ctrl5
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_ParseQOffsetMatrix.10, label %ctrl2
...
ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_ParseQOffsetMatrix.15, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_ParseQOffsetMatrix.20, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_ParseQOffsetMatrix.22, label %func_ParseQOffsetMatrix.27
}
...
func_CalculateOffsetParam.6:                      ; preds = %ctrl1
...
func_CalculateOffsetParam.21:                     ; preds = %ctrl5
  call void @CalculateOffsetParam.21()
  ret void
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_CalculateOffsetParam.6, label %ctrl2
...
ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_CalculateOffsetParam.17, label %func_CalculateOffsetParam.21
}
...
func_CalculateOffset8Param.24:                    ; preds = %ctrl2
  call void @CalculateOffset8Param.24()
  ret void

func_CalculateOffset8Param.26:                    ; preds = %ctrl3
  call void @CalculateOffset8Param.26()
  ret void

func_CalculateOffset8Param.28:                    ; preds = %ctrl4
  call void @CalculateOffset8Param.28()
  ret void

func_CalculateOffset8Param.31:                    ; preds = %ctrl5
  call void @CalculateOffset8Param.31()
  ret void

func_CalculateOffset8Param.32:                    ; preds = %ctrl5
...
ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_CalculateOffset8Param.24, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_CalculateOffset8Param.26, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_CalculateOffset8Param.28, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_CalculateOffset8Param.31, label %func_CalculateOffset8Param.32
}
...
entry:
  %canary = alloca i32
  store i32 462339363, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1525445711, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 696358914, i32* %canary
...
entry:
  %k = alloca i32, align 4
  %canary = alloca i32
  store i32 1829331701, i32* %canary
...
if.end225:                                        ; preds = %for.end224, %for.end102
  ...
  %133 = icmp eq i32 %132, 1829331701
...
entry:
  ...
  %k = alloca i32, align 4
  %canary = alloca i32
  store i32 1268146380, i32* %canary
  %qp_per = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %OffsetMatrixPresentFlag = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 147
  %1 = load i32, i32* %OffsetMatrixPresentFlag, align 8
...
if.end225:                                        ; preds = %for.end224, %for.end102
  %132 = load i32, i32* %canary
  %133 = icmp eq i32 %132, 1268146380
  br i1 %133, label %134, label %func_exit
...
entry:
  %k = alloca i32, align 4
  %canary = alloca i32
  store i32 761952013, i32* %canary
  %temp = alloca i32, align 4
  %qp_per = alloca i32, align 4
  %j = alloca i32, align 4
  %i = alloca i32, align 4
...
entry:
  ...
  %type.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 763807365, i32* %canary
  %retval = alloca i32, align 4
  %s.addr = alloca i8*, align 8
  store i8* %s, i8** %s.addr, align 8
  store i32* %type, i32** %type.addr, align 8
...
entry:
  ...
  %InString = alloca i32, align 4
  %canary = alloca i32
  store i32 1171524959, i32* %canary
  %IntContent = alloca i32, align 4
  %bufsize.addr = alloca i32, align 4
  %j = alloca i32, align 4
  %type = alloca i32, align 4
...
entry:
  %k = alloca i32, align 4
  %canary = alloca i32
  store i32 443597130, i32* %canary
  %temp = alloca i32, align 4
  %i = alloca i32, align 4
  %qp_per = alloca i32, align 4
  %j = alloca i32, align 4
...
entry:
  ...
  %bufsize.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1221506025, i32* %canary
  %InItem = alloca i32, align 4
  %p = alloca i8*, align 8
  %buf.addr = alloca i8*, align 8
  %bufend = alloca i8*, align 8
...
entry:
  ...
  %temp = alloca i32, align 4
  %canary = alloca i32
  store i32 237866238, i32* %canary
  %i = alloca i32, align 4
  %k = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %OffsetMatrixPresentFlag = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 147
...
entry:
  %temp = alloca i32, align 4
  %canary = alloca i32
  store i32 1847058593, i32* %canary
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %qp_per = alloca i32, align 4
  %k = alloca i32, align 4
...
if.end225:                                        ; preds = %for.end224, %for.end102
  %132 = load i32, i32* %canary
  %133 = icmp eq i32 %132, 1847058593
  br i1 %133, label %134, label %func_exit
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 858950060, i32* %canary
  %type.addr = alloca i32*, align 8
  store i8* %s, i8** %s.addr, align 8
  store i32* %type, i32** %type.addr, align 8
  store i32 0, i32* %i, align 4
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1446585940, i32* %canary
  %MapIdx = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %bufsize, i32* %bufsize.addr, align 4
  store i32 0, i32* %item, align 4
...
entry:
  ...
  %temp = alloca i32, align 4
  %canary = alloca i32
  store i32 1378598024, i32* %canary
  %k = alloca i32, align 4
  %i = alloca i32, align 4
  %q_bits = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
entry:
  ...
  %k = alloca i32, align 4
  %canary = alloca i32
  store i32 575719227, i32* %canary
  %j = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %OffsetMatrixPresentFlag = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 147
  %1 = load i32, i32* %OffsetMatrixPresentFlag, align 8
...
entry:
  ...
  %q_bits = alloca i32, align 4
  %canary = alloca i32
  store i32 1632266018, i32* %canary
  %i = alloca i32, align 4
  %k = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %OffsetMatrixPresentFlag = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 147
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1449183230, i32* %canary
  %s.addr = alloca i8*, align 8
  %type.addr = alloca i32*, align 8
  store i8* %s, i8** %s.addr, align 8
  store i32* %type, i32** %type.addr, align 8
...
entry:
  ...
  %IntContent = alloca i32, align 4
  %canary = alloca i32
  store i32 1026131380, i32* %canary
  %range = alloca i32, align 4
  %bufsize.addr = alloca i32, align 4
  %p = alloca i8*, align 8
  %InString = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @CalculateOffsetParam.21() #0 {
entry:
  %temp = alloca i32, align 4
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 103776399, i32* %canary
  %qp_per = alloca i32, align 4
  %k = alloca i32, align 4
  %i = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
entry:
  ...
  %items = alloca [1000 x i8*], align 16
  %canary = alloca i32
  store i32 547266970, i32* %canary
  %cnt = alloca i32, align 4
  %type = alloca i32, align 4
  %range = alloca i32, align 4
  %OffsetList = alloca i16*, align 8
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1140785826, i32* %canary
  %type.addr = alloca i32*, align 8
  %s.addr = alloca i8*, align 8
  store i8* %s, i8** %s.addr, align 8
  store i32* %type, i32** %type.addr, align 8
...
entry:
  ...
  %k = alloca i32, align 4
  %canary = alloca i32
  store i32 1776792767, i32* %canary
  %j = alloca i32, align 4
  %q_bits = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %OffsetMatrixPresentFlag = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 147
...
entry:
  ...
  %type.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 820463806, i32* %canary
  %retval = alloca i32, align 4
  %i = alloca i32, align 4
  store i8* %s, i8** %s.addr, align 8
  store i32* %type, i32** %type.addr, align 8
...
entry:
  ...
  %MapIdx = alloca i32, align 4
  %canary = alloca i32
  store i32 1037499585, i32* %canary
  %OffsetList = alloca i16*, align 8
  %i = alloca i32, align 4
  %items = alloca [1000 x i8*], align 16
  %bufsize.addr = alloca i32, align 4
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1940444989, i32* %canary
  %type.addr = alloca i32*, align 8
  store i8* %s, i8** %s.addr, align 8
  store i32* %type, i32** %type.addr, align 8
  store i32 0, i32* %i, align 4
...
entry:
  ...
  %s.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 2140515262, i32* %canary
  %i = alloca i32, align 4
  store i8* %s, i8** %s.addr, align 8
  store i32* %type, i32** %type.addr, align 8
  store i32 0, i32* %i, align 4
...
entry:
  %q_bits = alloca i32, align 4
  %canary = alloca i32
  store i32 498293975, i32* %canary
  %k = alloca i32, align 4
  %temp = alloca i32, align 4
  %j = alloca i32, align 4
  %i = alloca i32, align 4
...
entry:
  ...
  %temp = alloca i32, align 4
  %canary = alloca i32
  store i32 535819527, i32* %canary
  %j = alloca i32, align 4
  %k = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %OffsetMatrixPresentFlag = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 147
