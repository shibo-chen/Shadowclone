; ModuleID = 'specrand.c.rand.16R3.bc'
...
entry:
  ...
  %canary = alloca i32
  store i32 1753783628, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1827150623, i32* %canary
  %test = alloca i32, align 4
  %hi = alloca i32, align 4
  %lo = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
...
entry:
  ...
  %lo = alloca i32, align 4
  %canary = alloca i32
  store i32 541274872, i32* %canary
  %test = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
  %conv = sext i32 %0 to i64
  %div = sdiv i64 %conv, 127773
...
entry:
  %canary = alloca i32
  store i32 1646944123, i32* %canary
  %hi = alloca i32, align 4
  %test = alloca i32, align 4
  %lo = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
...
entry:
  ...
  %test = alloca i32, align 4
  %canary = alloca i32
  store i32 800358942, i32* %canary
  %hi = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
  %conv = sext i32 %0 to i64
  %div = sdiv i64 %conv, 127773
...
entry:
  %canary = alloca i32
  store i32 1255509079, i32* %canary
  %test = alloca i32, align 4
  %lo = alloca i32, align 4
  %hi = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
