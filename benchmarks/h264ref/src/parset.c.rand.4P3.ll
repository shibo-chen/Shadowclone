...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_GenerateParameterSets.8, label %func_GenerateParameterSets.26

func_GenerateParameterSets.8:                     ; preds = %rand_bb
  call void @GenerateParameterSets.8()
  ret void

func_GenerateParameterSets.26:                    ; preds = %rand_bb
  call void @GenerateParameterSets.26()
  ret void
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_GenerateSequenceParameterSet.7, label %ctrl0

func_GenerateSequenceParameterSet.7:              ; preds = %rand_bb
  call void @GenerateSequenceParameterSet.7(%struct.seq_parameter_set_rbsp_t* %sps, i32 %SPS_id)
  ret void

func_GenerateSequenceParameterSet.12:             ; preds = %ctrl0
  call void @GenerateSequenceParameterSet.12(%struct.seq_parameter_set_rbsp_t* %sps, i32 %SPS_id)
  ret void

func_GenerateSequenceParameterSet.13:             ; preds = %ctrl1
  call void @GenerateSequenceParameterSet.13(%struct.seq_parameter_set_rbsp_t* %sps, i32 %SPS_id)
  ret void

func_GenerateSequenceParameterSet.20:             ; preds = %ctrl1
  call void @GenerateSequenceParameterSet.20(%struct.seq_parameter_set_rbsp_t* %sps, i32 %SPS_id)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_GenerateSequenceParameterSet.12, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_GenerateSequenceParameterSet.13, label %func_GenerateSequenceParameterSet.20
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_GeneratePictureParameterSet.9, label %ctrl0

func_GeneratePictureParameterSet.9:               ; preds = %rand_bb
  call void @GeneratePictureParameterSet.9(%struct.pic_parameter_set_rbsp_t* %pps, %struct.seq_parameter_set_rbsp_t* %sps, i32 %PPS_id, i32 %WeightedPrediction, i32 %WeightedBiprediction, i32 %cb_qp_index_offset, i32 %cr_qp_index_offset)
  ret void

func_GeneratePictureParameterSet.16:              ; preds = %ctrl0
  call void @GeneratePictureParameterSet.16(%struct.pic_parameter_set_rbsp_t* %pps, %struct.seq_parameter_set_rbsp_t* %sps, i32 %PPS_id, i32 %WeightedPrediction, i32 %WeightedBiprediction, i32 %cb_qp_index_offset, i32 %cr_qp_index_offset)
  ret void

func_GeneratePictureParameterSet.22:              ; preds = %ctrl1
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_GeneratePictureParameterSet.16, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_GeneratePictureParameterSet.22, label %func_GeneratePictureParameterSet.23
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_GenerateSeq_parameter_set_NALU.1, label %ctrl0

func_GenerateSeq_parameter_set_NALU.1:            ; preds = %rand_bb
  %2 = call %struct.NALU_t* @GenerateSeq_parameter_set_NALU.1()
  ret %struct.NALU_t* %2

func_GenerateSeq_parameter_set_NALU.5:            ; preds = %ctrl0
  %3 = call %struct.NALU_t* @GenerateSeq_parameter_set_NALU.5()
  ret %struct.NALU_t* %3

func_GenerateSeq_parameter_set_NALU.24:           ; preds = %ctrl1
  %4 = call %struct.NALU_t* @GenerateSeq_parameter_set_NALU.24()
  ret %struct.NALU_t* %4

func_GenerateSeq_parameter_set_NALU.25:           ; preds = %ctrl1
  %5 = call %struct.NALU_t* @GenerateSeq_parameter_set_NALU.25()
  ret %struct.NALU_t* %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_GenerateSeq_parameter_set_NALU.5, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_GenerateSeq_parameter_set_NALU.24, label %func_GenerateSeq_parameter_set_NALU.25
}
...
func_GenerateSeq_parameter_set_rbsp.10:           ; preds = %ctrl0
  %3 = call i32 @GenerateSeq_parameter_set_rbsp.10(%struct.seq_parameter_set_rbsp_t* %sps, i8* %rbsp)
  ret i32 %3

func_GenerateSeq_parameter_set_rbsp.11:           ; preds = %ctrl1
  %4 = call i32 @GenerateSeq_parameter_set_rbsp.11(%struct.seq_parameter_set_rbsp_t* %sps, i8* %rbsp)
  ret i32 %4

func_GenerateSeq_parameter_set_rbsp.15:           ; preds = %ctrl1
  %5 = call i32 @GenerateSeq_parameter_set_rbsp.15(%struct.seq_parameter_set_rbsp_t* %sps, i8* %rbsp)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_GenerateSeq_parameter_set_rbsp.10, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_GenerateSeq_parameter_set_rbsp.11, label %func_GenerateSeq_parameter_set_rbsp.15
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_GeneratePic_parameter_set_NALU.2, label %ctrl0

func_GeneratePic_parameter_set_NALU.2:            ; preds = %rand_bb
  %2 = call %struct.NALU_t* @GeneratePic_parameter_set_NALU.2(i32 %PPS_id)
  ret %struct.NALU_t* %2

func_GeneratePic_parameter_set_NALU.3:            ; preds = %ctrl0
  %3 = call %struct.NALU_t* @GeneratePic_parameter_set_NALU.3(i32 %PPS_id)
  ret %struct.NALU_t* %3

func_GeneratePic_parameter_set_NALU.4:            ; preds = %ctrl1
  %4 = call %struct.NALU_t* @GeneratePic_parameter_set_NALU.4(i32 %PPS_id)
  ret %struct.NALU_t* %4

func_GeneratePic_parameter_set_NALU.14:           ; preds = %ctrl1
  %5 = call %struct.NALU_t* @GeneratePic_parameter_set_NALU.14(i32 %PPS_id)
  ret %struct.NALU_t* %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_GeneratePic_parameter_set_NALU.3, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_GeneratePic_parameter_set_NALU.4, label %func_GeneratePic_parameter_set_NALU.14
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_GeneratePic_parameter_set_rbsp.18, label %ctrl0

func_GeneratePic_parameter_set_rbsp.18:           ; preds = %rand_bb
  %2 = call i32 @GeneratePic_parameter_set_rbsp.18(%struct.pic_parameter_set_rbsp_t* %pps, i8* %rbsp)
  ret i32 %2

func_GeneratePic_parameter_set_rbsp.21:           ; preds = %ctrl0
  %3 = call i32 @GeneratePic_parameter_set_rbsp.21(%struct.pic_parameter_set_rbsp_t* %pps, i8* %rbsp)
  ret i32 %3

func_GeneratePic_parameter_set_rbsp.29:           ; preds = %ctrl1
  %4 = call i32 @GeneratePic_parameter_set_rbsp.29(%struct.pic_parameter_set_rbsp_t* %pps, i8* %rbsp)
  ret i32 %4

func_GeneratePic_parameter_set_rbsp.31:           ; preds = %ctrl1
  %5 = call i32 @GeneratePic_parameter_set_rbsp.31(%struct.pic_parameter_set_rbsp_t* %pps, i8* %rbsp)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_GeneratePic_parameter_set_rbsp.21, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_GeneratePic_parameter_set_rbsp.29, label %func_GeneratePic_parameter_set_rbsp.31
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_Scaling_List.17, label %ctrl0

func_Scaling_List.17:                             ; preds = %rand_bb
  %2 = call i32 @Scaling_List.17(i16* %scalingListinput, i16* %scalingList, i32 %sizeOfScalingList, i16* %UseDefaultScalingMatrix, %struct.datapartition* %partition)
  ret i32 %2

func_Scaling_List.27:                             ; preds = %ctrl0
  %3 = call i32 @Scaling_List.27(i16* %scalingListinput, i16* %scalingList, i32 %sizeOfScalingList, i16* %UseDefaultScalingMatrix, %struct.datapartition* %partition)
  ret i32 %3

func_Scaling_List.30:                             ; preds = %ctrl1
  %4 = call i32 @Scaling_List.30(i16* %scalingListinput, i16* %scalingList, i32 %sizeOfScalingList, i16* %UseDefaultScalingMatrix, %struct.datapartition* %partition)
  ret i32 %4

func_Scaling_List.32:                             ; preds = %ctrl1
  %5 = call i32 @Scaling_List.32(i16* %scalingListinput, i16* %scalingList, i32 %sizeOfScalingList, i16* %UseDefaultScalingMatrix, %struct.datapartition* %partition)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_Scaling_List.27, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_Scaling_List.30, label %func_Scaling_List.32
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_GenerateVUISequenceParameters.19, label %func_GenerateVUISequenceParameters.28

func_GenerateVUISequenceParameters.19:            ; preds = %rand_bb
  %2 = call i32 @GenerateVUISequenceParameters.19(%struct.datapartition* %partition)
  ret i32 %2

func_GenerateVUISequenceParameters.28:            ; preds = %rand_bb
  %3 = call i32 @GenerateVUISequenceParameters.28(%struct.datapartition* %partition)
  ret i32 %3
}
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct.NALU_t* @GenerateSeq_parameter_set_NALU.1() #0 {
entry:
  %rbsp = alloca [64000 x i8], align 16
  %NALUlen = alloca i32, align 4
  %RBSPlen = alloca i32, align 4
  %canary = alloca i32
  store i32 587010800, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct.NALU_t* @GeneratePic_parameter_set_NALU.2(i32 %PPS_id) #0 {
entry:
  %RBSPlen = alloca i32, align 4
  %n = alloca %struct.NALU_t*, align 8
  %canary = alloca i32
  store i32 151146546, i32* %canary
  %rbsp = alloca [64000 x i8], align 16
  %NALUlen = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 745848624, i32* %canary
  %NALUlen = alloca i32, align 4
  %PPS_id.addr = alloca i32, align 4
  %n = alloca %struct.NALU_t*, align 8
  %rbsp = alloca [64000 x i8], align 16
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct.NALU_t* @GeneratePic_parameter_set_NALU.4(i32 %PPS_id) #0 {
entry:
  %NALUlen = alloca i32, align 4
  %rbsp = alloca [64000 x i8], align 16
  %canary = alloca i32
  store i32 1725604475, i32* %canary
  %RBSPlen = alloca i32, align 4
  %PPS_id.addr = alloca i32, align 4
  %n = alloca %struct.NALU_t*, align 8
  store i32 %PPS_id, i32* %PPS_id.addr, align 4
...
entry:
  ...
  %RBSPlen = alloca i32, align 4
  %canary = alloca i32
  store i32 364307292, i32* %canary
  %n = alloca %struct.NALU_t*, align 8
  %rbsp = alloca [64000 x i8], align 16
  %call = call %struct.NALU_t* (i32, ...) bitcast (%struct.NALU_t* (...)* @AllocNALU to %struct.NALU_t* (i32, ...)*)(i32 64000)
  store %struct.NALU_t* %call, %struct.NALU_t** %n, align 8
...
entry:
  %canary = alloca i32
  store i32 705373896, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1411157539, i32* %canary
  %sps.addr = alloca %struct.seq_parameter_set_rbsp_t*, align 8
...
if.end137:                                        ; preds = %if.else135, %if.end134
  ...
  %163 = icmp eq i32 %162, 1411157539
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @GenerateParameterSets.8() #0 {
entry:
  %canary = alloca i32
  store i32 1237088438, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @GeneratePictureParameterSet.9(%struct.pic_parameter_set_rbsp_t* %pps, %struct.seq_parameter_set_rbsp_t* %sps, i32 %PPS_id, i32 %WeightedPrediction, i32 %WeightedBiprediction, i32 %cb_qp_index_offset, i32 %cr_qp_index_offset) #0 {
entry:
  %PPS_id.addr = alloca i32, align 4
  %sps.addr = alloca %struct.seq_parameter_set_rbsp_t*, align 8
  %WeightedBiprediction.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1932421066, i32* %canary
  %i = alloca i32, align 4
...
if.end139:                                        ; preds = %if.else135, %if.then132
  ...
  %152 = icmp eq i32 %151, 1932421066
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @GenerateSeq_parameter_set_rbsp.10(%struct.seq_parameter_set_rbsp_t* %sps, i8* %rbsp) #0 {
entry:
  %canary = alloca i32
  store i32 181896481, i32* %canary
  %LenInBytes = alloca i32, align 4
  %i = alloca i32, align 4
  %rbsp.addr = alloca i8*, align 8
  %len = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @GenerateSeq_parameter_set_rbsp.11(%struct.seq_parameter_set_rbsp_t* %sps, i8* %rbsp) #0 {
entry:
  %len = alloca i32, align 4
  %rbsp.addr = alloca i8*, align 8
  %partition = alloca %struct.datapartition*, align 8
  ...
  %sps.addr = alloca %struct.seq_parameter_set_rbsp_t*, align 8
  %canary = alloca i32
  store i32 2024029011, i32* %canary
  %i = alloca i32, align 4
  store %struct.seq_parameter_set_rbsp_t* %sps, %struct.seq_parameter_set_rbsp_t** %sps.addr, align 8
  store i8* %rbsp, i8** %rbsp.addr, align 8
  store i32 0, i32* %len, align 4
...
if.end158:                                        ; preds = %if.then155, %if.end150
  ...
  %206 = load i32, i32* %LenInBytes, align 4
  %207 = load i32, i32* %canary
  %208 = icmp eq i32 %207, 2024029011
  br i1 %208, label %209, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @GenerateSequenceParameterSet.12(%struct.seq_parameter_set_rbsp_t* %sps, i32 %SPS_id) #0 {
entry:
  %PicHeightInMapUnits = alloca i32, align 4
  %FrameHeightInMbs = alloca i32, align 4
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1117646826, i32* %canary
  %PicWidthInMbs = alloca i32, align 4
  %width = alloca i32, align 4
  %SubWidthC = alloca [4 x i32], align 16
  %height = alloca i32, align 4
...
if.end137:                                        ; preds = %if.else135, %if.end134
  %162 = load i32, i32* %canary
  %163 = icmp eq i32 %162, 1117646826
  br i1 %163, label %164, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @GenerateSequenceParameterSet.13(%struct.seq_parameter_set_rbsp_t* %sps, i32 %SPS_id) #0 {
entry:
  %canary = alloca i32
  store i32 1411290920, i32* %canary
  %SubHeightC = alloca [4 x i32], align 16
  %width = alloca i32, align 4
  %PicWidthInMbs = alloca i32, align 4
  %height = alloca i32, align 4
...
if.end137:                                        ; preds = %if.else135, %if.end134
  %162 = load i32, i32* %canary
  %163 = icmp eq i32 %162, 1411290920
  br i1 %163, label %164, label %func_exit
...
entry:
  %RBSPlen = alloca i32, align 4
  %canary = alloca i32
  store i32 801300328, i32* %canary
  %PPS_id.addr = alloca i32, align 4
  %NALUlen = alloca i32, align 4
  %n = alloca %struct.NALU_t*, align 8
  %rbsp = alloca [64000 x i8], align 16
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @GenerateSeq_parameter_set_rbsp.15(%struct.seq_parameter_set_rbsp_t* %sps, i8* %rbsp) #0 {
entry:
  %partition = alloca %struct.datapartition*, align 8
  %i = alloca i32, align 4
  %len = alloca i32, align 4
  ...
  %LenInBytes = alloca i32, align 4
  %canary = alloca i32
  store i32 1116606941, i32* %canary
  %rbsp.addr = alloca i8*, align 8
  store %struct.seq_parameter_set_rbsp_t* %sps, %struct.seq_parameter_set_rbsp_t** %sps.addr, align 8
  store i8* %rbsp, i8** %rbsp.addr, align 8
  store i32 0, i32* %len, align 4
...
if.end158:                                        ; preds = %if.then155, %if.end150
  ...
  %206 = load i32, i32* %LenInBytes, align 4
  %207 = load i32, i32* %canary
  %208 = icmp eq i32 %207, 1116606941
  br i1 %208, label %209, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @GeneratePictureParameterSet.16(%struct.pic_parameter_set_rbsp_t* %pps, %struct.seq_parameter_set_rbsp_t* %sps, i32 %PPS_id, i32 %WeightedPrediction, i32 %WeightedBiprediction, i32 %cb_qp_index_offset, i32 %cr_qp_index_offset) #0 {
entry:
  %PPS_id.addr = alloca i32, align 4
  %cb_qp_index_offset.addr = alloca i32, align 4
  %WeightedPrediction.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1791637146, i32* %canary
  %i = alloca i32, align 4
  %sps.addr = alloca %struct.seq_parameter_set_rbsp_t*, align 8
  %WeightedBiprediction.addr = alloca i32, align 4
  %frext_profile = alloca i32, align 4
...
if.end139:                                        ; preds = %if.else135, %if.then132
  ...
  store i32 0, i32* %redundant_pic_cnt_present_flag, align 4
  %151 = load i32, i32* %canary
  %152 = icmp eq i32 %151, 1791637146
  br i1 %152, label %153, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @Scaling_List.17(i16* %scalingListinput, i16* %scalingList, i32 %sizeOfScalingList, i16* %UseDefaultScalingMatrix, %struct.datapartition* %partition) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 1812117106, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @GeneratePic_parameter_set_rbsp.18(%struct.pic_parameter_set_rbsp_t* %pps, i8* %rbsp) #0 {
entry:
  %profile_idc = alloca i32, align 4
  %canary = alloca i32
  store i32 1031036663, i32* %canary
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %LenInBytes = alloca i32, align 4
...
if.end201:                                        ; preds = %if.end198, %lor.lhs.false143
  ...
  %202 = icmp eq i32 %201, 1031036663
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @GenerateVUISequenceParameters.19(%struct.datapartition* %partition) #0 {
entry:
  %canary = alloca i32
  store i32 1067931534, i32* %canary
  %partition.addr = alloca %struct.datapartition*, align 8
  %len = alloca i32, align 4
  store %struct.datapartition* %partition, %struct.datapartition** %partition.addr, align 8
  store i32 0, i32* %len, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @GenerateSequenceParameterSet.20(%struct.seq_parameter_set_rbsp_t* %sps, i32 %SPS_id) #0 {
entry:
  %PicWidthInMbs = alloca i32, align 4
  %FrameHeightInMbs = alloca i32, align 4
  %sps.addr = alloca %struct.seq_parameter_set_rbsp_t*, align 8
  ...
  %SPS_id.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1168783142, i32* %canary
  %frext_profile = alloca i32, align 4
  %height = alloca i32, align 4
  %width = alloca i32, align 4
  %PicHeightInMapUnits = alloca i32, align 4
...
if.end137:                                        ; preds = %if.else135, %if.end134
  %162 = load i32, i32* %canary
  %163 = icmp eq i32 %162, 1168783142
  br i1 %163, label %164, label %func_exit
...
entry:
  ...
  %NumberBitsPerSliceGroupId = alloca i32, align 4
  %canary = alloca i32
  store i32 668796383, i32* %canary
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %partition = alloca %struct.datapartition*, align 8
  %i = alloca i32, align 4
  %len = alloca i32, align 4
...
entry:
  %frext_profile = alloca i32, align 4
  %canary = alloca i32
  store i32 1899220285, i32* %canary
  %cr_qp_index_offset.addr = alloca i32, align 4
  %cb_qp_index_offset.addr = alloca i32, align 4
  %WeightedBiprediction.addr = alloca i32, align 4
  %WeightedPrediction.addr = alloca i32, align 4
...
if.end139:                                        ; preds = %if.else135, %if.then132
  ...
  store i32 0, i32* %redundant_pic_cnt_present_flag, align 4
  %151 = load i32, i32* %canary
  %152 = icmp eq i32 %151, 1899220285
  br i1 %152, label %153, label %func_exit
...
entry:
  ...
  %cb_qp_index_offset.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1067488926, i32* %canary
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
  store %struct.seq_parameter_set_rbsp_t* %sps, %struct.seq_parameter_set_rbsp_t** %sps.addr, align 8
  store i32 %PPS_id, i32* %PPS_id.addr, align 4
...
if.end139:                                        ; preds = %if.else135, %if.then132
  ...
  store i32 0, i32* %redundant_pic_cnt_present_flag, align 4
  %151 = load i32, i32* %canary
  %152 = icmp eq i32 %151, 1067488926
  br i1 %152, label %153, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct.NALU_t* @GenerateSeq_parameter_set_NALU.24() #0 {
entry:
  %RBSPlen = alloca i32, align 4
  %rbsp = alloca [64000 x i8], align 16
  %NALUlen = alloca i32, align 4
  %canary = alloca i32
  store i32 1386889637, i32* %canary
  %n = alloca %struct.NALU_t*, align 8
  %call = call %struct.NALU_t* (i32, ...) bitcast (%struct.NALU_t* (...)* @AllocNALU to %struct.NALU_t* (i32, ...)*)(i32 64000)
  store %struct.NALU_t* %call, %struct.NALU_t** %n, align 8
  store i32 0, i32* %RBSPlen, align 4
...
entry:
  ...
  %n = alloca %struct.NALU_t*, align 8
  %canary = alloca i32
  store i32 636334152, i32* %canary
  %RBSPlen = alloca i32, align 4
  %rbsp = alloca [64000 x i8], align 16
  %call = call %struct.NALU_t* (i32, ...) bitcast (%struct.NALU_t* (...)* @AllocNALU to %struct.NALU_t* (i32, ...)*)(i32 64000)
  store %struct.NALU_t* %call, %struct.NALU_t** %n, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @GenerateParameterSets.26() #0 {
entry:
  %canary = alloca i32
  store i32 1396889465, i32* %canary
  %pps = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %sps = alloca %struct.seq_parameter_set_rbsp_t*, align 8
  store %struct.seq_parameter_set_rbsp_t* null, %struct.seq_parameter_set_rbsp_t** %sps, align 8
  store %struct.pic_parameter_set_rbsp_t* null, %struct.pic_parameter_set_rbsp_t** %pps, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @Scaling_List.27(i16* %scalingListinput, i16* %scalingList, i32 %sizeOfScalingList, i16* %UseDefaultScalingMatrix, %struct.datapartition* %partition) #0 {
entry:
  %partition.addr = alloca %struct.datapartition*, align 8
  %scanj = alloca i32, align 4
  %j = alloca i32, align 4
  ...
  %UseDefaultScalingMatrix.addr = alloca i16*, align 8
  %canary = alloca i32
  store i32 1738411703, i32* %canary
  %sizeOfScalingList.addr = alloca i32, align 4
  store i16* %scalingListinput, i16** %scalingListinput.addr, align 8
  store i16* %scalingList, i16** %scalingList.addr, align 8
  store i32 %sizeOfScalingList, i32* %sizeOfScalingList.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @GenerateVUISequenceParameters.28(%struct.datapartition* %partition) #0 {
entry:
  %len = alloca i32, align 4
  %canary = alloca i32
  store i32 1306701187, i32* %canary
  %partition.addr = alloca %struct.datapartition*, align 8
  store %struct.datapartition* %partition, %struct.datapartition** %partition.addr, align 8
  store i32 0, i32* %len, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
entry:
  ...
  %LenInBytes = alloca i32, align 4
  %canary = alloca i32
  store i32 547633663, i32* %canary
  %len = alloca i32, align 4
  %rbsp.addr = alloca i8*, align 8
  %profile_idc = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @Scaling_List.32(i16* %scalingListinput, i16* %scalingList, i32 %sizeOfScalingList, i16* %UseDefaultScalingMatrix, %struct.datapartition* %partition) #0 {
entry:
  %nextScale = alloca i32, align 4
  %UseDefaultScalingMatrix.addr = alloca i16*, align 8
  %partition.addr = alloca %struct.datapartition*, align 8
  ...
  %lastScale = alloca i32, align 4
  %canary = alloca i32
  store i32 1257186208, i32* %canary
  %scalingListinput.addr = alloca i16*, align 8
  %j = alloca i32, align 4
  %scalingList.addr = alloca i16*, align 8
  %len = alloca i32, align 4
