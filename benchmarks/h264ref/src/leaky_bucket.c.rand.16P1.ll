; ModuleID = 'leaky_bucket.c.rand.16P1.bc'
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_get_LeakyBucketRate.9, label %ctrl0

func_get_LeakyBucketRate.9:                       ; preds = %rand_bb
  %2 = call i32 @get_LeakyBucketRate.9(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret i32 %2

func_get_LeakyBucketRate.19:                      ; preds = %ctrl0
  %3 = call i32 @get_LeakyBucketRate.19(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret i32 %3
...
func_get_LeakyBucketRate.38:                      ; preds = %ctrl3
  %6 = call i32 @get_LeakyBucketRate.38(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret i32 %6
...
func_get_LeakyBucketRate.40:                      ; preds = %ctrl5
  %8 = call i32 @get_LeakyBucketRate.40(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret i32 %8

func_get_LeakyBucketRate.42:                      ; preds = %ctrl6
  %9 = call i32 @get_LeakyBucketRate.42(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret i32 %9

func_get_LeakyBucketRate.51:                      ; preds = %ctrl7
  %10 = call i32 @get_LeakyBucketRate.51(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret i32 %10

func_get_LeakyBucketRate.53:                      ; preds = %ctrl8
  %11 = call i32 @get_LeakyBucketRate.53(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret i32 %11
...
func_get_LeakyBucketRate.56:                      ; preds = %ctrl10
  %13 = call i32 @get_LeakyBucketRate.56(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret i32 %13
...
func_get_LeakyBucketRate.65:                      ; preds = %ctrl13
  %16 = call i32 @get_LeakyBucketRate.65(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret i32 %16

func_get_LeakyBucketRate.66:                      ; preds = %ctrl13
  %17 = call i32 @get_LeakyBucketRate.66(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret i32 %17

ctrl0:                                            ; preds = %rand_bb
  %18 = icmp eq i32 %0, 1
  br i1 %18, label %func_get_LeakyBucketRate.19, label %ctrl1
...
ctrl3:                                            ; preds = %ctrl2
  %21 = icmp eq i32 %0, 4
  br i1 %21, label %func_get_LeakyBucketRate.38, label %ctrl4
...
ctrl5:                                            ; preds = %ctrl4
  %23 = icmp eq i32 %0, 6
  br i1 %23, label %func_get_LeakyBucketRate.40, label %ctrl6

ctrl6:                                            ; preds = %ctrl5
  %24 = icmp eq i32 %0, 7
  br i1 %24, label %func_get_LeakyBucketRate.42, label %ctrl7

ctrl7:                                            ; preds = %ctrl6
  %25 = icmp eq i32 %0, 8
  br i1 %25, label %func_get_LeakyBucketRate.51, label %ctrl8

ctrl8:                                            ; preds = %ctrl7
  %26 = icmp eq i32 %0, 9
  br i1 %26, label %func_get_LeakyBucketRate.53, label %ctrl9
...
ctrl10:                                           ; preds = %ctrl9
  %28 = icmp eq i32 %0, 11
  br i1 %28, label %func_get_LeakyBucketRate.56, label %ctrl11
...
ctrl13:                                           ; preds = %ctrl12
  %31 = icmp eq i32 %0, 14
  br i1 %31, label %func_get_LeakyBucketRate.65, label %func_get_LeakyBucketRate.66
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_PutBigDoubleWord.22, label %func_PutBigDoubleWord.26

func_PutBigDoubleWord.22:                         ; preds = %rand_bb
  call void @PutBigDoubleWord.22(i64 %dw, %struct._IO_FILE* %fp)
  ret void

func_PutBigDoubleWord.26:                         ; preds = %rand_bb
  call void @PutBigDoubleWord.26(i64 %dw, %struct._IO_FILE* %fp)
  ret void
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_write_buffer.7, label %ctrl0

func_write_buffer.7:                              ; preds = %rand_bb
  call void @write_buffer.7(i64 %NumberLeakyBuckets, i64* %Rmin, i64* %Bmin, i64* %Fmin)
  ret void

func_write_buffer.8:                              ; preds = %ctrl0
  call void @write_buffer.8(i64 %NumberLeakyBuckets, i64* %Rmin, i64* %Bmin, i64* %Fmin)
  ret void

func_write_buffer.10:                             ; preds = %ctrl1
  call void @write_buffer.10(i64 %NumberLeakyBuckets, i64* %Rmin, i64* %Bmin, i64* %Fmin)
  ret void

func_write_buffer.11:                             ; preds = %ctrl2
  call void @write_buffer.11(i64 %NumberLeakyBuckets, i64* %Rmin, i64* %Bmin, i64* %Fmin)
  ret void

func_write_buffer.12:                             ; preds = %ctrl3
  call void @write_buffer.12(i64 %NumberLeakyBuckets, i64* %Rmin, i64* %Bmin, i64* %Fmin)
  ret void

func_write_buffer.14:                             ; preds = %ctrl4
  call void @write_buffer.14(i64 %NumberLeakyBuckets, i64* %Rmin, i64* %Bmin, i64* %Fmin)
  ret void

func_write_buffer.17:                             ; preds = %ctrl5
  call void @write_buffer.17(i64 %NumberLeakyBuckets, i64* %Rmin, i64* %Bmin, i64* %Fmin)
  ret void

func_write_buffer.29:                             ; preds = %ctrl6
  call void @write_buffer.29(i64 %NumberLeakyBuckets, i64* %Rmin, i64* %Bmin, i64* %Fmin)
  ret void

func_write_buffer.33:                             ; preds = %ctrl7
  call void @write_buffer.33(i64 %NumberLeakyBuckets, i64* %Rmin, i64* %Bmin, i64* %Fmin)
  ret void

func_write_buffer.35:                             ; preds = %ctrl8
  call void @write_buffer.35(i64 %NumberLeakyBuckets, i64* %Rmin, i64* %Bmin, i64* %Fmin)
  ret void

func_write_buffer.43:                             ; preds = %ctrl9
  call void @write_buffer.43(i64 %NumberLeakyBuckets, i64* %Rmin, i64* %Bmin, i64* %Fmin)
  ret void

func_write_buffer.49:                             ; preds = %ctrl10
  call void @write_buffer.49(i64 %NumberLeakyBuckets, i64* %Rmin, i64* %Bmin, i64* %Fmin)
  ret void

func_write_buffer.50:                             ; preds = %ctrl11
  call void @write_buffer.50(i64 %NumberLeakyBuckets, i64* %Rmin, i64* %Bmin, i64* %Fmin)
  ret void

func_write_buffer.57:                             ; preds = %ctrl12
  call void @write_buffer.57(i64 %NumberLeakyBuckets, i64* %Rmin, i64* %Bmin, i64* %Fmin)
  ret void

func_write_buffer.63:                             ; preds = %ctrl13
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_write_buffer.8, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_write_buffer.10, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_write_buffer.11, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_write_buffer.12, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_write_buffer.14, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_write_buffer.17, label %ctrl6

ctrl6:                                            ; preds = %ctrl5
  %8 = icmp eq i32 %0, 7
  br i1 %8, label %func_write_buffer.29, label %ctrl7

ctrl7:                                            ; preds = %ctrl6
  %9 = icmp eq i32 %0, 8
  br i1 %9, label %func_write_buffer.33, label %ctrl8

ctrl8:                                            ; preds = %ctrl7
  %10 = icmp eq i32 %0, 9
  br i1 %10, label %func_write_buffer.35, label %ctrl9

ctrl9:                                            ; preds = %ctrl8
  %11 = icmp eq i32 %0, 10
  br i1 %11, label %func_write_buffer.43, label %ctrl10

ctrl10:                                           ; preds = %ctrl9
  %12 = icmp eq i32 %0, 11
  br i1 %12, label %func_write_buffer.49, label %ctrl11

ctrl11:                                           ; preds = %ctrl10
  %13 = icmp eq i32 %0, 12
  br i1 %13, label %func_write_buffer.50, label %ctrl12

ctrl12:                                           ; preds = %ctrl11
  %14 = icmp eq i32 %0, 13
  br i1 %14, label %func_write_buffer.57, label %ctrl13

ctrl13:                                           ; preds = %ctrl12
  %15 = icmp eq i32 %0, 14
  br i1 %15, label %func_write_buffer.63, label %func_write_buffer.64
}
...
ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_Sort.16, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_Sort.21, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_Sort.23, label %ctrl5
...
ctrl6:                                            ; preds = %ctrl5
  %8 = icmp eq i32 %0, 7
  br i1 %8, label %func_Sort.30, label %ctrl7

ctrl7:                                            ; preds = %ctrl6
  %9 = icmp eq i32 %0, 8
  br i1 %9, label %func_Sort.31, label %ctrl8

ctrl8:                                            ; preds = %ctrl7
  %10 = icmp eq i32 %0, 9
  br i1 %10, label %func_Sort.32, label %ctrl9
...
ctrl10:                                           ; preds = %ctrl9
  %12 = icmp eq i32 %0, 11
  br i1 %12, label %func_Sort.36, label %ctrl11

ctrl11:                                           ; preds = %ctrl10
  %13 = icmp eq i32 %0, 12
  br i1 %13, label %func_Sort.37, label %ctrl12

ctrl12:                                           ; preds = %ctrl11
  %14 = icmp eq i32 %0, 13
  br i1 %14, label %func_Sort.41, label %ctrl13

ctrl13:                                           ; preds = %ctrl12
  %15 = icmp eq i32 %0, 14
  br i1 %15, label %func_Sort.45, label %func_Sort.46
}
...
func_calc_buffer.4:                               ; preds = %ctrl1
  call void @calc_buffer.4()
  ret void

func_calc_buffer.5:                               ; preds = %ctrl2
  call void @calc_buffer.5()
  ret void

func_calc_buffer.15:                              ; preds = %ctrl3
...
func_calc_buffer.20:                              ; preds = %ctrl5
  call void @calc_buffer.20()
  ret void

func_calc_buffer.24:                              ; preds = %ctrl6
...
func_calc_buffer.47:                              ; preds = %ctrl8
...
func_calc_buffer.52:                              ; preds = %ctrl10
  call void @calc_buffer.52()
  ret void

func_calc_buffer.55:                              ; preds = %ctrl11
  call void @calc_buffer.55()
  ret void

func_calc_buffer.58:                              ; preds = %ctrl12
  call void @calc_buffer.58()
  ret void
...
func_calc_buffer.61:                              ; preds = %ctrl13
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_calc_buffer.4, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_calc_buffer.5, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_calc_buffer.15, label %ctrl4
...
ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_calc_buffer.20, label %ctrl6

ctrl6:                                            ; preds = %ctrl5
  %8 = icmp eq i32 %0, 7
  br i1 %8, label %func_calc_buffer.24, label %ctrl7
...
ctrl8:                                            ; preds = %ctrl7
  %10 = icmp eq i32 %0, 9
  br i1 %10, label %func_calc_buffer.47, label %ctrl9
...
ctrl10:                                           ; preds = %ctrl9
  %12 = icmp eq i32 %0, 11
  br i1 %12, label %func_calc_buffer.52, label %ctrl11

ctrl11:                                           ; preds = %ctrl10
  %13 = icmp eq i32 %0, 12
  br i1 %13, label %func_calc_buffer.55, label %ctrl12

ctrl12:                                           ; preds = %ctrl11
  %14 = icmp eq i32 %0, 13
  br i1 %14, label %func_calc_buffer.58, label %ctrl13

ctrl13:                                           ; preds = %ctrl12
  %15 = icmp eq i32 %0, 14
  br i1 %15, label %func_calc_buffer.59, label %func_calc_buffer.61
}
...
entry:
  ...
  %canary = alloca i32
  store i32 357292116, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 167738342, i32* %canary
...
entry:
  ...
  %TotalRate = alloca i64, align 8
  %canary = alloca i32
  store i32 1736408690, i32* %canary
  %maxBuffer = alloca i64, align 8
  %buffer_frame = alloca i64*, align 8
  %Bmin = alloca i64*, align 8
  %iChannelRate = alloca i64, align 8
...
for.end136:                                       ; preds = %for.cond57
  ...
  call void @free(i8* %148) #3
  %149 = load i32, i32* %canary
  %150 = icmp eq i32 %149, 1736408690
  br i1 %150, label %151, label %func_exit
...
entry:
  ...
  %actualBuffer = alloca i64, align 8
  %canary = alloca i32
  store i32 2102300951, i32* %canary
  %iFrame = alloca i64, align 8
  %AvgRate = alloca i64, align 8
  %InitFullness = alloca i64, align 8
  %NumberLeakyBuckets = alloca i64, align 8
...
for.end136:                                       ; preds = %for.cond57
  ...
  call void @free(i8* %148) #3
  %149 = load i32, i32* %canary
  %150 = icmp eq i32 %149, 2102300951
  br i1 %150, label %151, label %func_exit
...
entry:
  %temp = alloca i64, align 8
  %canary = alloca i32
  store i32 623675540, i32* %canary
  %Rmin.addr = alloca i64*, align 8
  %j = alloca i64, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %i = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_buffer.7(i64 %NumberLeakyBuckets, i64* %Rmin, i64* %Bmin, i64* %Fmin) #0 {
entry:
  %iBucket = alloca i64, align 8
  %canary = alloca i32
  store i32 1734940099, i32* %canary
  %NumberLeakyBuckets.addr = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_buffer.8(i64 %NumberLeakyBuckets, i64* %Rmin, i64* %Bmin, i64* %Fmin) #0 {
entry:
  %Bmin.addr = alloca i64*, align 8
  %outf = alloca %struct._IO_FILE*, align 8
  %iBucket = alloca i64, align 8
  ...
  %Rmin.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 929386754, i32* %canary
  %NumberLeakyBuckets.addr = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
  store i64* %Bmin, i64** %Bmin.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_LeakyBucketRate.9(i64 %NumberLeakyBuckets, i64* %Rmin) #0 {
entry:
  %f = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 1466753446, i32* %canary
  %i = alloca i64, align 8
  %Rmin.addr = alloca i64*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_buffer.10(i64 %NumberLeakyBuckets, i64* %Rmin, i64* %Bmin, i64* %Fmin) #0 {
entry:
  %Rmin.addr = alloca i64*, align 8
  %Bmin.addr = alloca i64*, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %Fmin.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 216681414, i32* %canary
  %outf = alloca %struct._IO_FILE*, align 8
  %iBucket = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
...
entry:
  ...
  %Bmin.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 606609164, i32* %canary
  %iBucket = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
  store i64* %Bmin, i64** %Bmin.addr, align 8
...
entry:
  ...
  %Rmin.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 111999951, i32* %canary
  %outf = alloca %struct._IO_FILE*, align 8
  %iBucket = alloca i64, align 8
  %Fmin.addr = alloca i64*, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
...
entry:
  %canary = alloca i32
  store i32 808899810, i32* %canary
  %Rmin.addr = alloca i64*, align 8
  %i = alloca i64, align 8
  %temp = alloca i64, align 8
  %j = alloca i64, align 8
...
entry:
  ...
  %outf = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 2002499621, i32* %canary
  %iBucket = alloca i64, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %Rmin.addr = alloca i64*, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
...
entry:
  ...
  %maxBuffer = alloca i64, align 8
  %canary = alloca i32
  store i32 359120694, i32* %canary
  %Fmin = alloca i64*, align 8
  %Bmin = alloca i64*, align 8
  %minB = alloca i64, align 8
  %iBucket = alloca i64, align 8
...
entry:
  %canary = alloca i32
  store i32 1701625898, i32* %canary
  %Rmin.addr = alloca i64*, align 8
  %j = alloca i64, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %temp = alloca i64, align 8
...
entry:
  ...
  %Bmin.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 351042526, i32* %canary
  %iBucket = alloca i64, align 8
  %Fmin.addr = alloca i64*, align 8
  %outf = alloca %struct._IO_FILE*, align 8
  %Rmin.addr = alloca i64*, align 8
...
entry:
  ...
  %FrameIndex = alloca i64, align 8
  %canary = alloca i32
  store i32 932739731, i32* %canary
  %iChannelRate = alloca i64, align 8
  %AvgRate = alloca i64, align 8
  %buffer_frame = alloca i64*, align 8
  %Rmin = alloca i64*, align 8
...
entry:
  ...
  %buf = alloca i64, align 8
  %canary = alloca i32
  store i32 1918769121, i32* %canary
  %retval = alloca i32, align 4
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
entry:
  ...
  %buffer_frame = alloca i64*, align 8
  %canary = alloca i32
  store i32 2005910953, i32* %canary
  %Bmin = alloca i64*, align 8
  %InitFullness = alloca i64, align 8
  %AvgRate = alloca i64, align 8
  %maxBuffer = alloca i64, align 8
...
for.end136:                                       ; preds = %for.cond57
  ...
  call void @free(i8* %148) #3
  %149 = load i32, i32* %canary
  %150 = icmp eq i32 %149, 2005910953
  br i1 %150, label %151, label %func_exit
...
entry:
  %canary = alloca i32
  store i32 711217527, i32* %canary
  %j = alloca i64, align 8
  %i = alloca i64, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %Rmin.addr = alloca i64*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @PutBigDoubleWord.22(i64 %dw, %struct._IO_FILE* %fp) #0 {
entry:
  %canary = alloca i32
  store i32 195636354, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1058473804, i32* %canary
  %i = alloca i64, align 8
  %temp = alloca i64, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %Rmin.addr = alloca i64*, align 8
...
entry:
  %minB = alloca i64, align 8
  %canary = alloca i32
  store i32 2046224260, i32* %canary
  %TotalRate = alloca i64, align 8
  %NumberLeakyBuckets = alloca i64, align 8
  %Bmin = alloca i64*, align 8
  %iFrame = alloca i64, align 8
...
for.end136:                                       ; preds = %for.cond57
  ...
  call void @free(i8* %148) #3
  %149 = load i32, i32* %canary
  %150 = icmp eq i32 %149, 2046224260
  br i1 %150, label %151, label %func_exit
...
entry:
  ...
  %Rmin.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 422745957, i32* %canary
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %i = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @PutBigDoubleWord.26(i64 %dw, %struct._IO_FILE* %fp) #0 {
entry:
  %canary = alloca i32
  store i32 1032808684, i32* %canary
  %dw.addr = alloca i64, align 8
  %fp.addr = alloca %struct._IO_FILE*, align 8
  store i64 %dw, i64* %dw.addr, align 8
  store %struct._IO_FILE* %fp, %struct._IO_FILE** %fp.addr, align 8
...
entry:
  %Rmin.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 133326763, i32* %canary
  %buf = alloca i64, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %i = alloca i64, align 8
  %f = alloca %struct._IO_FILE*, align 8
...
entry:
  ...
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 472295972, i32* %canary
  %i = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
  store i64 0, i64* %i, align 8
...
entry:
  %Bmin.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 501837684, i32* %canary
  %Fmin.addr = alloca i64*, align 8
  %outf = alloca %struct._IO_FILE*, align 8
  %iBucket = alloca i64, align 8
  %Rmin.addr = alloca i64*, align 8
...
entry:
  ...
  %j = alloca i64, align 8
  %canary = alloca i32
  store i32 439078680, i32* %canary
  %Rmin.addr = alloca i64*, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
  store i64 0, i64* %i, align 8
...
entry:
  %i = alloca i64, align 8
  %canary = alloca i32
  store i32 578297912, i32* %canary
  %temp = alloca i64, align 8
  %Rmin.addr = alloca i64*, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %j = alloca i64, align 8
...
entry:
  %Rmin.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 2026975031, i32* %canary
  %j = alloca i64, align 8
  %temp = alloca i64, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %i = alloca i64, align 8
...
entry:
  %iBucket = alloca i64, align 8
  %canary = alloca i32
  store i32 2145636526, i32* %canary
  %Rmin.addr = alloca i64*, align 8
  %Fmin.addr = alloca i64*, align 8
  %outf = alloca %struct._IO_FILE*, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
...
entry:
  ...
  %Bmin.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 1701298384, i32* %canary
  %Fmin.addr = alloca i64*, align 8
  %iBucket = alloca i64, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
...
entry:
  %j = alloca i64, align 8
  %canary = alloca i32
  store i32 605951408, i32* %canary
  %temp = alloca i64, align 8
  %Rmin.addr = alloca i64*, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %i = alloca i64, align 8
...
entry:
  ...
  %buf = alloca i64, align 8
  %canary = alloca i32
  store i32 752278212, i32* %canary
  %f = alloca %struct._IO_FILE*, align 8
  %retval = alloca i32, align 4
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
...
entry:
  ...
  %buf = alloca i64, align 8
  %canary = alloca i32
  store i32 1659101258, i32* %canary
  %retval = alloca i32, align 4
  %NumberLeakyBuckets.addr = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1100737040, i32* %canary
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %i = alloca i64, align 8
  %temp = alloca i64, align 8
  %Rmin.addr = alloca i64*, align 8
...
entry:
  %i = alloca i64, align 8
  %canary = alloca i32
  store i32 1183119457, i32* %canary
  %f = alloca %struct._IO_FILE*, align 8
  %retval = alloca i32, align 4
  %Rmin.addr = alloca i64*, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_buffer.43(i64 %NumberLeakyBuckets, i64* %Rmin, i64* %Bmin, i64* %Fmin) #0 {
entry:
  %canary = alloca i32
  store i32 726374704, i32* %canary
  %Bmin.addr = alloca i64*, align 8
  %outf = alloca %struct._IO_FILE*, align 8
  %Rmin.addr = alloca i64*, align 8
  %Fmin.addr = alloca i64*, align 8
...
entry:
  ...
  %TotalRate = alloca i64, align 8
  %canary = alloca i32
  store i32 990414424, i32* %canary
  %Rmin = alloca i64*, align 8
  %iBucket = alloca i64, align 8
  %Fmin = alloca i64*, align 8
  %InitFullness = alloca i64, align 8
...
entry:
  %canary = alloca i32
  store i32 1475355523, i32* %canary
  %Rmin.addr = alloca i64*, align 8
  %j = alloca i64, align 8
  %i = alloca i64, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Sort.46(i64 %NumberLeakyBuckets, i64* %Rmin) #0 {
entry:
  %temp = alloca i64, align 8
  %Rmin.addr = alloca i64*, align 8
  %j = alloca i64, align 8
  %i = alloca i64, align 8
  %canary = alloca i32
  store i32 1220381059, i32* %canary
  %NumberLeakyBuckets.addr = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
  store i64 0, i64* %i, align 8
...
entry:
  ...
  %actualBuffer = alloca i64, align 8
  %canary = alloca i32
  store i32 965947400, i32* %canary
  %TotalRate = alloca i64, align 8
  %minB = alloca i64, align 8
  %FrameIndex = alloca i64, align 8
  %Fmin = alloca i64*, align 8
...
entry:
  ...
  %minB = alloca i64, align 8
  %canary = alloca i32
  store i32 235374142, i32* %canary
  %FrameIndex = alloca i64, align 8
  %TotalRate = alloca i64, align 8
  %AvgRate = alloca i64, align 8
  %InitFullness = alloca i64, align 8
...
entry:
  ...
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1536535550, i32* %canary
  %Rmin.addr = alloca i64*, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
  store i64* %Bmin, i64** %Bmin.addr, align 8
...
entry:
  ...
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 869037024, i32* %canary
  %Bmin.addr = alloca i64*, align 8
  %Rmin.addr = alloca i64*, align 8
  %iBucket = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
...
entry:
  ...
  %Rmin = alloca i64*, align 8
  %canary = alloca i32
  store i32 195194857, i32* %canary
  %iBucket = alloca i64, align 8
  %AvgRate = alloca i64, align 8
  %iChannelRate = alloca i64, align 8
  %InitFullness = alloca i64, align 8
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 553259972, i32* %canary
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %i = alloca i64, align 8
  %Rmin.addr = alloca i64*, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
...
entry:
  ...
  %f = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 245321010, i32* %canary
  %retval = alloca i32, align 4
  %Rmin.addr = alloca i64*, align 8
  %i = alloca i64, align 8
  %buf = alloca i64, align 8
...
entry:
  ...
  %iChannelRate = alloca i64, align 8
  %canary = alloca i32
  store i32 1462984750, i32* %canary
  %maxBuffer = alloca i64, align 8
  %TotalRate = alloca i64, align 8
  %Fmin = alloca i64*, align 8
  %Rmin = alloca i64*, align 8
...
for.end136:                                       ; preds = %for.cond57
  ...
  call void @free(i8* %148) #3
  %149 = load i32, i32* %canary
  %150 = icmp eq i32 %149, 1462984750
  br i1 %150, label %151, label %func_exit
...
entry:
  ...
  %i = alloca i64, align 8
  %canary = alloca i32
  store i32 1460443790, i32* %canary
  %retval = alloca i32, align 4
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
entry:
  ...
  %iBucket = alloca i64, align 8
  %canary = alloca i32
  store i32 1092320869, i32* %canary
  %Rmin.addr = alloca i64*, align 8
  %Fmin.addr = alloca i64*, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %Bmin.addr = alloca i64*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @calc_buffer.58() #0 {
entry:
  %TotalRate = alloca i64, align 8
  %Rmin = alloca i64*, align 8
  %Bmin = alloca i64*, align 8
  ...
  %buffer_frame = alloca i64*, align 8
  %canary = alloca i32
  store i32 642035011, i32* %canary
  %AvgRate = alloca i64, align 8
  %minB = alloca i64, align 8
  %maxBuffer = alloca i64, align 8
  %iBucket = alloca i64, align 8
...
entry:
  ...
  %AvgRate = alloca i64, align 8
  %canary = alloca i32
  store i32 1882159621, i32* %canary
  %iChannelRate = alloca i64, align 8
  %minB = alloca i64, align 8
  %Bmin = alloca i64*, align 8
  %InitFullness = alloca i64, align 8
...
for.end136:                                       ; preds = %for.cond57
  ...
  call void @free(i8* %148) #3
  %149 = load i32, i32* %canary
  %150 = icmp eq i32 %149, 1882159621
  br i1 %150, label %151, label %func_exit
...
entry:
  ...
  %Rmin.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 1168541198, i32* %canary
  %f = alloca %struct._IO_FILE*, align 8
  %i = alloca i64, align 8
  %retval = alloca i32, align 4
  %buf = alloca i64, align 8
...
entry:
  ...
  %iChannelRate = alloca i64, align 8
  %canary = alloca i32
  store i32 602442797, i32* %canary
  %Bmin = alloca i64*, align 8
  %buffer_frame = alloca i64*, align 8
  %iBucket = alloca i64, align 8
  %NumberLeakyBuckets = alloca i64, align 8
...
entry:
  ...
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 154223015, i32* %canary
  %buf = alloca i64, align 8
  %Rmin.addr = alloca i64*, align 8
  %retval = alloca i32, align 4
  %i = alloca i64, align 8
...
entry:
  %outf = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 231837970, i32* %canary
  %Bmin.addr = alloca i64*, align 8
  %Fmin.addr = alloca i64*, align 8
  %Rmin.addr = alloca i64*, align 8
  %iBucket = alloca i64, align 8
...
entry:
  ...
  %Fmin.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 524306804, i32* %canary
  %outf = alloca %struct._IO_FILE*, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
  store i64* %Bmin, i64** %Bmin.addr, align 8
...
entry:
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1190375594, i32* %canary
  %i = alloca i64, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %buf = alloca i64, align 8
  %f = alloca %struct._IO_FILE*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_LeakyBucketRate.66(i64 %NumberLeakyBuckets, i64* %Rmin) #0 {
entry:
  %Rmin.addr = alloca i64*, align 8
  %buf = alloca i64, align 8
  %i = alloca i64, align 8
  %f = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 2137203878, i32* %canary
  %retval = alloca i32, align 4
  %NumberLeakyBuckets.addr = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
