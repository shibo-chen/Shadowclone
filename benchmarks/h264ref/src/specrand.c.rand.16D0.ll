; ModuleID = 'specrand.c.rand.16D0.bc'
...
entry:
  ...
  %canary = alloca i32
  store i32 1329304936, i32* %canary
...
entry:
  ...
  %lo = alloca i32, align 4
  %canary = alloca i32
  store i32 1841516489, i32* %canary
  %test = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
  %conv = sext i32 %0 to i64
  %div = sdiv i64 %conv, 127773
...
entry:
  %canary = alloca i32
  store i32 935266152, i32* %canary
  %hi = alloca i32, align 4
  %test = alloca i32, align 4
  %lo = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
...
entry:
  %lo = alloca i32, align 4
  %canary = alloca i32
  store i32 822886489, i32* %canary
  %hi = alloca i32, align 4
  %test = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
  %conv = sext i32 %0 to i64
...
entry:
  %test = alloca i32, align 4
  %canary = alloca i32
  store i32 1997051846, i32* %canary
  %hi = alloca i32, align 4
  %lo = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
  %conv = sext i32 %0 to i64
...
entry:
  %canary = alloca i32
  store i32 1025761596, i32* %canary
  %lo = alloca i32, align 4
  %test = alloca i32, align 4
  %hi = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
