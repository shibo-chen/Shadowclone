; ModuleID = 'filehandle.c.rand.4R2.bc'
...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_error.5, label %func_error.7
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_write_PPS.6, label %ctrl1
...
ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_start_sequence.4, label %func_start_sequence.8
}
...
entry:
  ...
  %canary = alloca i32
  store i32 1369891856, i32* %canary
  %retval = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 455137215, i32* %canary
...
entry:
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 471792147, i32* %canary
  %i = alloca i32, align 4
  %nalu = alloca %struct.NALU_t*, align 8
  %total_pps = alloca i32, align 4
  %len = alloca i32, align 4
...
entry:
  ...
  %len = alloca i32, align 4
  %canary = alloca i32
  store i32 330117778, i32* %canary
  %i = alloca i32, align 4
  %total_pps = alloca i32, align 4
  store i32 0, i32* %len, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
entry:
  %canary = alloca i32
  store i32 769965224, i32* %canary
...
entry:
  %nalu = alloca %struct.NALU_t*, align 8
  %canary = alloca i32
  store i32 568830092, i32* %canary
  %len.addr = alloca i32, align 4
  %PPS_id.addr = alloca i32, align 4
  store i32 %len, i32* %len.addr, align 4
  store i32 %PPS_id, i32* %PPS_id.addr, align 4
...
entry:
  %text.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 351882955, i32* %canary
  %code.addr = alloca i32, align 4
  store i8* %text, i8** %text.addr, align 8
  store i32 %code, i32* %code.addr, align 4
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 2046561090, i32* %canary
  %nalu = alloca %struct.NALU_t*, align 8
  %total_pps = alloca i32, align 4
  %len = alloca i32, align 4
  store i32 0, i32* %len, align 4
...
entry:
  %PPS_id.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1424971595, i32* %canary
  %len.addr = alloca i32, align 4
  %nalu = alloca %struct.NALU_t*, align 8
  store i32 %len, i32* %len.addr, align 4
  store i32 %PPS_id, i32* %PPS_id.addr, align 4
