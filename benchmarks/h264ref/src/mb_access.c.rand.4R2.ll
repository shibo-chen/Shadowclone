; ModuleID = 'mb_access.c.rand.4R2.bc'
...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_mb_is_available.7, label %ctrl0

func_mb_is_available.7:                           ; preds = %rand_bb
  %2 = call i32 @mb_is_available.7(i32 %mbAddr, i32 %currMbAddr)
  ret i32 %2

func_mb_is_available.18:                          ; preds = %ctrl0
  %3 = call i32 @mb_is_available.18(i32 %mbAddr, i32 %currMbAddr)
  ret i32 %3
...
func_mb_is_available.31:                          ; preds = %ctrl1
  %5 = call i32 @mb_is_available.31(i32 %mbAddr, i32 %currMbAddr)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_mb_is_available.18, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_mb_is_available.29, label %func_mb_is_available.31
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_CheckAvailabilityOfNeighbors.5, label %func_CheckAvailabilityOfNeighbors.8

func_CheckAvailabilityOfNeighbors.5:              ; preds = %rand_bb
  call void @CheckAvailabilityOfNeighbors.5()
  ret void

func_CheckAvailabilityOfNeighbors.8:              ; preds = %rand_bb
  call void @CheckAvailabilityOfNeighbors.8()
  ret void
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_get_mb_block_pos.9, label %ctrl0

func_get_mb_block_pos.9:                          ; preds = %rand_bb
  call void @get_mb_block_pos.9(i32 %mb_addr, i32* %x, i32* %y)
  ret void

func_get_mb_block_pos.13:                         ; preds = %ctrl0
  call void @get_mb_block_pos.13(i32 %mb_addr, i32* %x, i32* %y)
  ret void

func_get_mb_block_pos.15:                         ; preds = %ctrl1
  call void @get_mb_block_pos.15(i32 %mb_addr, i32* %x, i32* %y)
  ret void

func_get_mb_block_pos.27:                         ; preds = %ctrl1
  call void @get_mb_block_pos.27(i32 %mb_addr, i32* %x, i32* %y)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_get_mb_block_pos.13, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_get_mb_block_pos.15, label %func_get_mb_block_pos.27
}
...
func_get_mb_pos.26:                               ; preds = %ctrl0
  call void @get_mb_pos.26(i32 %mb_addr, i32* %x, i32* %y)
  ret void

func_get_mb_pos.32:                               ; preds = %ctrl1
  call void @get_mb_pos.32(i32 %mb_addr, i32* %x, i32* %y)
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_get_mb_pos.26, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_get_mb_pos.32, label %func_get_mb_pos.34
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_getNonAffNeighbour.2, label %ctrl0

func_getNonAffNeighbour.2:                        ; preds = %rand_bb
  call void @getNonAffNeighbour.2(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

func_getNonAffNeighbour.17:                       ; preds = %ctrl0
...
func_getNonAffNeighbour.28:                       ; preds = %ctrl1
  call void @getNonAffNeighbour.28(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_getNonAffNeighbour.17, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_getNonAffNeighbour.20, label %func_getNonAffNeighbour.28
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_getAffNeighbour.3, label %ctrl0

func_getAffNeighbour.3:                           ; preds = %rand_bb
  call void @getAffNeighbour.3(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

func_getAffNeighbour.25:                          ; preds = %ctrl0
  call void @getAffNeighbour.25(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

func_getAffNeighbour.30:                          ; preds = %ctrl1
  call void @getAffNeighbour.30(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

func_getAffNeighbour.33:                          ; preds = %ctrl1
  call void @getAffNeighbour.33(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_getAffNeighbour.25, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_getAffNeighbour.30, label %func_getAffNeighbour.33
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_getNeighbour.10, label %ctrl0

func_getNeighbour.10:                             ; preds = %rand_bb
  call void @getNeighbour.10(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

func_getNeighbour.14:                             ; preds = %ctrl0
  call void @getNeighbour.14(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void
...
func_getNeighbour.22:                             ; preds = %ctrl1
  call void @getNeighbour.22(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_getNeighbour.14, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_getNeighbour.21, label %func_getNeighbour.22
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_getLuma4x4Neighbour.1, label %ctrl0

func_getLuma4x4Neighbour.1:                       ; preds = %rand_bb
  call void @getLuma4x4Neighbour.1(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix)
  ret void
...
func_getLuma4x4Neighbour.19:                      ; preds = %ctrl1
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_getLuma4x4Neighbour.6, label %func_getLuma4x4Neighbour.19
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_getChroma4x4Neighbour.11, label %ctrl0

func_getChroma4x4Neighbour.11:                    ; preds = %rand_bb
  call void @getChroma4x4Neighbour.11(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix)
  ret void
...
func_getChroma4x4Neighbour.23:                    ; preds = %ctrl1
  call void @getChroma4x4Neighbour.23(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix)
  ret void

func_getChroma4x4Neighbour.24:                    ; preds = %ctrl1
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_getChroma4x4Neighbour.23, label %func_getChroma4x4Neighbour.24
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getLuma4x4Neighbour.1(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 1467392205, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getNonAffNeighbour.2(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix) #0 {
entry:
  ...
  %curr_mb_nr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 213963283, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getAffNeighbour.3(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix) #0 {
entry:
  %maxW = alloca i32, align 4
  %currMb = alloca %struct.macroblock*, align 8
  %curr_mb_nr.addr = alloca i32, align 4
  ...
  %pix.addr = alloca %struct.pix_pos*, align 8
  %canary = alloca i32
  store i32 1113993747, i32* %canary
  %yN.addr = alloca i32, align 4
  %maxH = alloca i32, align 4
  %xN.addr = alloca i32, align 4
...
if.end376:                                        ; preds = %if.end375, %lor.lhs.false, %if.then8, %if.then1
  ...
  %310 = icmp eq i32 %309, 1113993747
...
entry:
  %canary = alloca i32
  store i32 428418444, i32* %canary
  %block_y.addr = alloca i32, align 4
  %x = alloca i32, align 4
  %rel_x.addr = alloca i32, align 4
  %y = alloca i32, align 4
...
entry:
  %currMB = alloca %struct.macroblock*, align 8
  %canary = alloca i32
  store i32 1713459802, i32* %canary
...
if.end104:                                        ; preds = %if.then98, %if.end95
  ...
  %108 = icmp eq i32 %107, 1713459802
...
entry:
  ...
  %curr_mb_nr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2106711289, i32* %canary
  %pix.addr = alloca %struct.pix_pos*, align 8
  %y = alloca i32, align 4
  %block_x.addr = alloca i32, align 4
  %rel_y.addr = alloca i32, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 909987005, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @CheckAvailabilityOfNeighbors.8() #0 {
entry:
  %canary = alloca i32
  store i32 1081162472, i32* %canary
  %mb_nr = alloca i32, align 4
  %currMB = alloca %struct.macroblock*, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %current_mb_nr = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 3
...
if.end104:                                        ; preds = %if.then98, %if.end95
  %107 = load i32, i32* %canary
  %108 = icmp eq i32 %107, 1081162472
  br i1 %108, label %109, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @get_mb_block_pos.9(i32 %mb_addr, i32* %x, i32* %y) #0 {
entry:
  %canary = alloca i32
  store i32 1254945348, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getNeighbour.10(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix) #0 {
entry:
  %curr_mb_nr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 475419563, i32* %canary
  %luma.addr = alloca i32, align 4
  %xN.addr = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
  %yN.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getChroma4x4Neighbour.11(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix) #0 {
entry:
  %canary = alloca i32
  store i32 2059188980, i32* %canary
  %rel_x.addr = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
  %rel_y.addr = alloca i32, align 4
  %x = alloca i32, align 4
...
entry:
  ...
  %y = alloca i32, align 4
  %canary = alloca i32
  store i32 400091483, i32* %canary
  %block_y.addr = alloca i32, align 4
  %curr_mb_nr.addr = alloca i32, align 4
  %block_x.addr = alloca i32, align 4
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @get_mb_block_pos.13(i32 %mb_addr, i32* %x, i32* %y) #0 {
entry:
  %x.addr = alloca i32*, align 8
  %mb_addr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2025790830, i32* %canary
  %y.addr = alloca i32*, align 8
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
  store i32* %x, i32** %x.addr, align 8
  store i32* %y, i32** %y.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getNeighbour.14(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix) #0 {
entry:
  %pix.addr = alloca %struct.pix_pos*, align 8
  %curr_mb_nr.addr = alloca i32, align 4
  %xN.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 890634797, i32* %canary
  %luma.addr = alloca i32, align 4
  %yN.addr = alloca i32, align 4
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
  store i32 %xN, i32* %xN.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @get_mb_block_pos.15(i32 %mb_addr, i32* %x, i32* %y) #0 {
entry:
  %y.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 1367744742, i32* %canary
  %x.addr = alloca i32*, align 8
  %mb_addr.addr = alloca i32, align 4
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
  store i32* %x, i32** %x.addr, align 8
...
entry:
  ...
  %x.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 452718297, i32* %canary
  %mb_addr.addr = alloca i32, align 4
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
  store i32* %x, i32** %x.addr, align 8
  store i32* %y, i32** %y.addr, align 8
...
entry:
  ...
  %currMbAddr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2101466098, i32* %canary
  %mbAddr.addr = alloca i32, align 4
  store i32 %mbAddr, i32* %mbAddr.addr, align 4
  store i32 %currMbAddr, i32* %currMbAddr.addr, align 4
  %0 = load i32, i32* %mbAddr.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 1984719049, i32* %canary
  %x = alloca i32, align 4
  %block_x.addr = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
  %rel_x.addr = alloca i32, align 4
...
entry:
  ...
  %luma.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 101135893, i32* %canary
  %yN.addr = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
  %maxW = alloca i32, align 4
  %currMb = alloca %struct.macroblock*, align 8
...
entry:
  ...
  %luma.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1991008440, i32* %canary
  %curr_mb_nr.addr = alloca i32, align 4
  %yN.addr = alloca i32, align 4
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
  store i32 %xN, i32* %xN.addr, align 4
...
entry:
  ...
  %yN.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2039536133, i32* %canary
  %xN.addr = alloca i32, align 4
  %curr_mb_nr.addr = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getChroma4x4Neighbour.23(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix) #0 {
entry:
  %rel_x.addr = alloca i32, align 4
  %block_y.addr = alloca i32, align 4
  %curr_mb_nr.addr = alloca i32, align 4
  ...
  %y = alloca i32, align 4
  %canary = alloca i32
  store i32 1219535512, i32* %canary
  %pix.addr = alloca %struct.pix_pos*, align 8
  %block_x.addr = alloca i32, align 4
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
  store i32 %block_x, i32* %block_x.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 1589195016, i32* %canary
  %pix.addr = alloca %struct.pix_pos*, align 8
  %block_x.addr = alloca i32, align 4
  %x = alloca i32, align 4
  %block_y.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getAffNeighbour.25(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix) #0 {
entry:
  %curr_mb_nr.addr = alloca i32, align 4
  %yM = alloca i32, align 4
  %maxW = alloca i32, align 4
  ...
  %xN.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 383191748, i32* %canary
  %pix.addr = alloca %struct.pix_pos*, align 8
  %yN.addr = alloca i32, align 4
  %currMb = alloca %struct.macroblock*, align 8
  %luma.addr = alloca i32, align 4
...
entry:
  ...
  %y.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 222102332, i32* %canary
  %mb_addr.addr = alloca i32, align 4
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
  store i32* %x, i32** %x.addr, align 8
  store i32* %y, i32** %y.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getNonAffNeighbour.28(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix) #0 {
entry:
  %currMb = alloca %struct.macroblock*, align 8
  %yN.addr = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
  ...
  %xN.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 731857730, i32* %canary
  %maxH = alloca i32, align 4
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
  store i32 %xN, i32* %xN.addr, align 4
  store i32 %yN, i32* %yN.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 1922667483, i32* %canary
  %currMbAddr.addr = alloca i32, align 4
  %mbAddr.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  store i32 %mbAddr, i32* %mbAddr.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getAffNeighbour.30(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix) #0 {
entry:
  %yN.addr = alloca i32, align 4
  %maxW = alloca i32, align 4
  %luma.addr = alloca i32, align 4
  ...
  %pix.addr = alloca %struct.pix_pos*, align 8
  %canary = alloca i32
  store i32 862660782, i32* %canary
  %curr_mb_nr.addr = alloca i32, align 4
  %currMb = alloca %struct.macroblock*, align 8
  %yM = alloca i32, align 4
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @get_mb_pos.32(i32 %mb_addr, i32* %x, i32* %y) #0 {
entry:
  %canary = alloca i32
  store i32 768098555, i32* %canary
  %mb_addr.addr = alloca i32, align 4
  %x.addr = alloca i32*, align 8
  %y.addr = alloca i32*, align 8
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
...
entry:
  ...
  %currMb = alloca %struct.macroblock*, align 8
  %canary = alloca i32
  store i32 1040056237, i32* %canary
  %xN.addr = alloca i32, align 4
  %maxW = alloca i32, align 4
  %luma.addr = alloca i32, align 4
  %yM = alloca i32, align 4
...
if.end376:                                        ; preds = %if.end375, %lor.lhs.false, %if.then8, %if.then1
  %309 = load i32, i32* %canary
  %310 = icmp eq i32 %309, 1040056237
  br i1 %310, label %311, label %func_exit
...
entry:
  ...
  %mb_addr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 193926627, i32* %canary
  %x.addr = alloca i32*, align 8
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
  store i32* %x, i32** %x.addr, align 8
  store i32* %y, i32** %y.addr, align 8
