...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_testEndian.2, label %func_testEndian.8

func_testEndian.2:                                ; preds = %rand_bb
  %2 = call i32 @testEndian.2()
  ret i32 %2

func_testEndian.8:                                ; preds = %rand_bb
  %3 = call i32 @testEndian.8()
  ret i32 %3
}
...
func_img2buf.6:                                   ; preds = %ctrl0
  call void @img2buf.6(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom)
  ret void

func_img2buf.9:                                   ; preds = %ctrl1
  call void @img2buf.9(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom)
  ret void

func_img2buf.28:                                  ; preds = %ctrl2
  call void @img2buf.28(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom)
  ret void

func_img2buf.30:                                  ; preds = %ctrl3
...
func_img2buf.33:                                  ; preds = %ctrl5
  call void @img2buf.33(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom)
  ret void

func_img2buf.34:                                  ; preds = %ctrl6
...
func_img2buf.36:                                  ; preds = %ctrl8
  call void @img2buf.36(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom)
  ret void

func_img2buf.40:                                  ; preds = %ctrl9
...
func_img2buf.41:                                  ; preds = %ctrl10
  call void @img2buf.41(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom)
  ret void

func_img2buf.42:                                  ; preds = %ctrl11
  call void @img2buf.42(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom)
  ret void

func_img2buf.44:                                  ; preds = %ctrl12
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_img2buf.6, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_img2buf.9, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_img2buf.28, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_img2buf.30, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_img2buf.31, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_img2buf.33, label %ctrl6

ctrl6:                                            ; preds = %ctrl5
  %8 = icmp eq i32 %0, 7
  br i1 %8, label %func_img2buf.34, label %ctrl7

ctrl7:                                            ; preds = %ctrl6
  %9 = icmp eq i32 %0, 8
  br i1 %9, label %func_img2buf.35, label %ctrl8

ctrl8:                                            ; preds = %ctrl7
  %10 = icmp eq i32 %0, 9
  br i1 %10, label %func_img2buf.36, label %ctrl9

ctrl9:                                            ; preds = %ctrl8
  %11 = icmp eq i32 %0, 10
  br i1 %11, label %func_img2buf.40, label %ctrl10

ctrl10:                                           ; preds = %ctrl9
  %12 = icmp eq i32 %0, 11
  br i1 %12, label %func_img2buf.41, label %ctrl11

ctrl11:                                           ; preds = %ctrl10
  %13 = icmp eq i32 %0, 12
  br i1 %13, label %func_img2buf.42, label %ctrl12

ctrl12:                                           ; preds = %ctrl11
  %14 = icmp eq i32 %0, 13
  br i1 %14, label %func_img2buf.44, label %ctrl13

ctrl13:                                           ; preds = %ctrl12
  %15 = icmp eq i32 %0, 14
  br i1 %15, label %func_img2buf.48, label %func_img2buf.52
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_write_picture.11, label %ctrl0

func_write_picture.11:                            ; preds = %rand_bb
  call void @write_picture.11(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure)
  ret void

func_write_picture.12:                            ; preds = %ctrl0
  call void @write_picture.12(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure)
  ret void

func_write_picture.16:                            ; preds = %ctrl1
  call void @write_picture.16(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure)
  ret void

func_write_picture.20:                            ; preds = %ctrl2
  call void @write_picture.20(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure)
  ret void

func_write_picture.23:                            ; preds = %ctrl3
  call void @write_picture.23(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure)
  ret void

func_write_picture.24:                            ; preds = %ctrl3
  call void @write_picture.24(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_write_picture.12, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_write_picture.16, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_write_picture.20, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_write_picture.23, label %func_write_picture.24
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_write_out_picture.10, label %ctrl0

func_write_out_picture.10:                        ; preds = %rand_bb
  call void @write_out_picture.10(%struct.storable_picture* %p, i32 %p_out)
  ret void

func_write_out_picture.17:                        ; preds = %ctrl0
  call void @write_out_picture.17(%struct.storable_picture* %p, i32 %p_out)
  ret void

func_write_out_picture.19:                        ; preds = %ctrl1
  call void @write_out_picture.19(%struct.storable_picture* %p, i32 %p_out)
  ret void

func_write_out_picture.26:                        ; preds = %ctrl2
  call void @write_out_picture.26(%struct.storable_picture* %p, i32 %p_out)
  ret void

func_write_out_picture.29:                        ; preds = %ctrl3
  call void @write_out_picture.29(%struct.storable_picture* %p, i32 %p_out)
  ret void

func_write_out_picture.32:                        ; preds = %ctrl4
  call void @write_out_picture.32(%struct.storable_picture* %p, i32 %p_out)
  ret void

func_write_out_picture.37:                        ; preds = %ctrl5
  call void @write_out_picture.37(%struct.storable_picture* %p, i32 %p_out)
  ret void

func_write_out_picture.38:                        ; preds = %ctrl6
  call void @write_out_picture.38(%struct.storable_picture* %p, i32 %p_out)
  ret void

func_write_out_picture.39:                        ; preds = %ctrl7
  call void @write_out_picture.39(%struct.storable_picture* %p, i32 %p_out)
  ret void

func_write_out_picture.43:                        ; preds = %ctrl8
  call void @write_out_picture.43(%struct.storable_picture* %p, i32 %p_out)
  ret void

func_write_out_picture.45:                        ; preds = %ctrl9
  call void @write_out_picture.45(%struct.storable_picture* %p, i32 %p_out)
  ret void

func_write_out_picture.46:                        ; preds = %ctrl10
  call void @write_out_picture.46(%struct.storable_picture* %p, i32 %p_out)
  ret void

func_write_out_picture.47:                        ; preds = %ctrl11
  call void @write_out_picture.47(%struct.storable_picture* %p, i32 %p_out)
  ret void

func_write_out_picture.49:                        ; preds = %ctrl12
  call void @write_out_picture.49(%struct.storable_picture* %p, i32 %p_out)
  ret void

func_write_out_picture.50:                        ; preds = %ctrl13
  call void @write_out_picture.50(%struct.storable_picture* %p, i32 %p_out)
  ret void

func_write_out_picture.51:                        ; preds = %ctrl13
  call void @write_out_picture.51(%struct.storable_picture* %p, i32 %p_out)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_write_out_picture.17, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_write_out_picture.19, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_write_out_picture.26, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_write_out_picture.29, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_write_out_picture.32, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_write_out_picture.37, label %ctrl6

ctrl6:                                            ; preds = %ctrl5
  %8 = icmp eq i32 %0, 7
  br i1 %8, label %func_write_out_picture.38, label %ctrl7

ctrl7:                                            ; preds = %ctrl6
  %9 = icmp eq i32 %0, 8
  br i1 %9, label %func_write_out_picture.39, label %ctrl8

ctrl8:                                            ; preds = %ctrl7
  %10 = icmp eq i32 %0, 9
  br i1 %10, label %func_write_out_picture.43, label %ctrl9

ctrl9:                                            ; preds = %ctrl8
  %11 = icmp eq i32 %0, 10
  br i1 %11, label %func_write_out_picture.45, label %ctrl10

ctrl10:                                           ; preds = %ctrl9
  %12 = icmp eq i32 %0, 11
  br i1 %12, label %func_write_out_picture.46, label %ctrl11

ctrl11:                                           ; preds = %ctrl10
  %13 = icmp eq i32 %0, 12
  br i1 %13, label %func_write_out_picture.47, label %ctrl12

ctrl12:                                           ; preds = %ctrl11
  %14 = icmp eq i32 %0, 13
  br i1 %14, label %func_write_out_picture.49, label %ctrl13

ctrl13:                                           ; preds = %ctrl12
  %15 = icmp eq i32 %0, 14
  br i1 %15, label %func_write_out_picture.50, label %func_write_out_picture.51
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_clear_picture.3, label %func_clear_picture.5

func_clear_picture.3:                             ; preds = %rand_bb
  call void @clear_picture.3(%struct.storable_picture* %p)
  ret void

func_clear_picture.5:                             ; preds = %rand_bb
  call void @clear_picture.5(%struct.storable_picture* %p)
  ret void
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_write_unpaired_field.1, label %ctrl0

func_write_unpaired_field.1:                      ; preds = %rand_bb
  call void @write_unpaired_field.1(%struct.frame_store* %fs, i32 %p_out)
  ret void

func_write_unpaired_field.13:                     ; preds = %ctrl0
  call void @write_unpaired_field.13(%struct.frame_store* %fs, i32 %p_out)
  ret void

func_write_unpaired_field.18:                     ; preds = %ctrl1
  call void @write_unpaired_field.18(%struct.frame_store* %fs, i32 %p_out)
  ret void

func_write_unpaired_field.21:                     ; preds = %ctrl2
  call void @write_unpaired_field.21(%struct.frame_store* %fs, i32 %p_out)
  ret void

func_write_unpaired_field.25:                     ; preds = %ctrl3
  call void @write_unpaired_field.25(%struct.frame_store* %fs, i32 %p_out)
  ret void

func_write_unpaired_field.27:                     ; preds = %ctrl3
  call void @write_unpaired_field.27(%struct.frame_store* %fs, i32 %p_out)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_write_unpaired_field.13, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_write_unpaired_field.18, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_write_unpaired_field.21, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_write_unpaired_field.25, label %func_write_unpaired_field.27
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_write_stored_frame.14, label %func_write_stored_frame.15

func_write_stored_frame.14:                       ; preds = %rand_bb
  call void @write_stored_frame.14(%struct.frame_store* %fs, i32 %p_out)
  ret void

func_write_stored_frame.15:                       ; preds = %rand_bb
  call void @write_stored_frame.15(%struct.frame_store* %fs, i32 %p_out)
  ret void
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_direct_output.7, label %func_direct_output.22

func_direct_output.7:                             ; preds = %rand_bb
  call void @direct_output.7(%struct.storable_picture* %p, i32 %p_out)
  ret void

func_direct_output.22:                            ; preds = %rand_bb
  call void @direct_output.22(%struct.storable_picture* %p, i32 %p_out)
  ret void
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_unpaired_field.1(%struct.frame_store* %fs, i32 %p_out) #0 {
entry:
  %p = alloca %struct.storable_picture*, align 8
  %fs.addr = alloca %struct.frame_store*, align 8
  %canary = alloca i32
  store i32 1203465159, i32* %canary
  %p_out.addr = alloca i32, align 4
...
entry:
  %p = alloca i8*, align 8
  %canary = alloca i32
  store i32 979178588, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @clear_picture.3(%struct.storable_picture* %p) #0 {
entry:
  %canary = alloca i32
  store i32 2097058508, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1470389735, i32* %canary
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  ...
  %109 = icmp eq i32 %108, 1470389735
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @clear_picture.5(%struct.storable_picture* %p) #0 {
entry:
  %canary = alloca i32
  store i32 1628181465, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  %i = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 0, i32* %i, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @img2buf.6(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom) #0 {
entry:
  %crop_top.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1363346981, i32* %canary
  %twidth = alloca i32, align 4
  %crop_bottom.addr = alloca i32, align 4
  %crop_right.addr = alloca i32, align 4
  %tmp32 = alloca i64, align 8
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1363346981
  br i1 %109, label %110, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @direct_output.7(%struct.storable_picture* %p, i32 %p_out) #0 {
entry:
  %canary = alloca i32
  store i32 949473944, i32* %canary
  %p_out.addr = alloca i32, align 4
  %p.addr = alloca %struct.storable_picture*, align 8
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @testEndian.8() #0 {
entry:
  %canary = alloca i32
  store i32 1818445904, i32* %canary
  %s = alloca i16, align 2
  %p = alloca i8*, align 8
  %0 = bitcast i16* %s to i8*
  store i8* %0, i8** %p, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @img2buf.9(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom) #0 {
entry:
  %crop_left.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %crop_top.addr = alloca i32, align 4
  ...
  %size_y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1049260322, i32* %canary
  %j = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %ui16 = alloca i16, align 2
  %crop_right.addr = alloca i32, align 4
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1049260322
  br i1 %109, label %110, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_out_picture.10(%struct.storable_picture* %p, i32 %p_out) #0 {
entry:
  %SubWidthC = alloca [4 x i32], align 16
  %crop_right = alloca i32, align 4
  %p.addr = alloca %struct.storable_picture*, align 8
  %canary = alloca i32
  store i32 1494001673, i32* %canary
...
return:                                           ; preds = %if.end139, %if.then
  ...
  %193 = icmp eq i32 %192, 1494001673
...
entry:
  ...
  %canary = alloca i32
  store i32 715971587, i32* %canary
  %p_out.addr = alloca i32, align 4
  %p.addr = alloca %struct.storable_picture*, align 8
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  ...
  %real_structure.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1783170585, i32* %canary
  %p_out.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  store i32 %real_structure, i32* %real_structure.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_unpaired_field.13(%struct.frame_store* %fs, i32 %p_out) #0 {
entry:
  %fs.addr = alloca %struct.frame_store*, align 8
  %canary = alloca i32
  store i32 32097952, i32* %canary
  %p = alloca %struct.storable_picture*, align 8
  %p_out.addr = alloca i32, align 4
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_stored_frame.14(%struct.frame_store* %fs, i32 %p_out) #0 {
entry:
  %fs.addr = alloca %struct.frame_store*, align 8
  %canary = alloca i32
  store i32 537204357, i32* %canary
  %p_out.addr = alloca i32, align 4
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_stored_frame.15(%struct.frame_store* %fs, i32 %p_out) #0 {
entry:
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 347423432, i32* %canary
  %fs.addr = alloca %struct.frame_store*, align 8
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  %0 = load i32, i32* %p_out.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_picture.16(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure) #0 {
entry:
  %p.addr = alloca %struct.storable_picture*, align 8
  %canary = alloca i32
  store i32 1886296013, i32* %canary
  %p_out.addr = alloca i32, align 4
  %real_structure.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  ...
  %symbol_size_in_bytes = alloca i32, align 4
  %canary = alloca i32
  store i32 835127709, i32* %canary
  %crop_left = alloca i32, align 4
  %p_out.addr = alloca i32, align 4
  %crop_right = alloca i32, align 4
  %SubWidthC = alloca [4 x i32], align 16
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_unpaired_field.18(%struct.frame_store* %fs, i32 %p_out) #0 {
entry:
  %canary = alloca i32
  store i32 1829361871, i32* %canary
  %fs.addr = alloca %struct.frame_store*, align 8
  %p_out.addr = alloca i32, align 4
  %p = alloca %struct.storable_picture*, align 8
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_out_picture.19(%struct.storable_picture* %p, i32 %p_out) #0 {
entry:
  %crop_top = alloca i32, align 4
  %symbol_size_in_bytes = alloca i32, align 4
  %p_out.addr = alloca i32, align 4
  ...
  %p.addr = alloca %struct.storable_picture*, align 8
  %canary = alloca i32
  store i32 1770899910, i32* %canary
  %buf = alloca i8*, align 8
  %rgb_output = alloca i32, align 4
  %SubHeightC = alloca [4 x i32], align 16
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1770899910
  br i1 %193, label %194, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_picture.20(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure) #0 {
entry:
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 487264338, i32* %canary
  %real_structure.addr = alloca i32, align 4
  %p.addr = alloca %struct.storable_picture*, align 8
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1008386672, i32* %canary
  %fs.addr = alloca %struct.frame_store*, align 8
  %p = alloca %struct.storable_picture*, align 8
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @direct_output.22(%struct.storable_picture* %p, i32 %p_out) #0 {
entry:
  %p.addr = alloca %struct.storable_picture*, align 8
  %canary = alloca i32
  store i32 1908647313, i32* %canary
  %p_out.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  %0 = load %struct.storable_picture*, %struct.storable_picture** %p.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_picture.23(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure) #0 {
entry:
  %real_structure.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1971311777, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  %p_out.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_picture.24(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure) #0 {
entry:
  %p_out.addr = alloca i32, align 4
  %p.addr = alloca %struct.storable_picture*, align 8
  %canary = alloca i32
  store i32 584491950, i32* %canary
  %real_structure.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  store i32 %real_structure, i32* %real_structure.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_unpaired_field.25(%struct.frame_store* %fs, i32 %p_out) #0 {
entry:
  %p = alloca %struct.storable_picture*, align 8
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 563657276, i32* %canary
  %fs.addr = alloca %struct.frame_store*, align 8
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  %0 = load %struct.frame_store*, %struct.frame_store** %fs.addr, align 8
...
entry:
  ...
  %SubHeightC = alloca [4 x i32], align 16
  %canary = alloca i32
  store i32 1035244574, i32* %canary
  %crop_right = alloca i32, align 4
  %p_out.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1035244574
  br i1 %193, label %194, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_unpaired_field.27(%struct.frame_store* %fs, i32 %p_out) #0 {
entry:
  %canary = alloca i32
  store i32 1672380663, i32* %canary
  %p_out.addr = alloca i32, align 4
  %p = alloca %struct.storable_picture*, align 8
  %fs.addr = alloca %struct.frame_store*, align 8
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @img2buf.28(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom) #0 {
entry:
  %crop_right.addr = alloca i32, align 4
  %theight = alloca i32, align 4
  %crop_bottom.addr = alloca i32, align 4
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 173550131, i32* %canary
  %tmp16 = alloca i16, align 2
  %buf.addr = alloca i8*, align 8
  %ui8 = alloca i8, align 1
  %ui16 = alloca i16, align 2
...
entry:
  ...
  %p.addr = alloca %struct.storable_picture*, align 8
  %canary = alloca i32
  store i32 2144943739, i32* %canary
  %p_out.addr = alloca i32, align 4
  %crop_left = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 2144943739
  br i1 %193, label %194, label %func_exit
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 310695263, i32* %canary
  %buf.addr = alloca i8*, align 8
  %imgX.addr = alloca i16**, align 8
  store i16** %imgX, i16*** %imgX.addr, align 8
  store i8* %buf, i8** %buf.addr, align 8
...
entry:
  ...
  %crop_left.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 408021705, i32* %canary
  %tmp32 = alloca i64, align 8
  %crop_bottom.addr = alloca i32, align 4
  %size = alloca i32, align 4
  %crop_top.addr = alloca i32, align 4
...
entry:
  ...
  %p.addr = alloca %struct.storable_picture*, align 8
  %canary = alloca i32
  store i32 1078138639, i32* %canary
  %SubWidthC = alloca [4 x i32], align 16
  %crop_top = alloca i32, align 4
  %crop_left = alloca i32, align 4
  %crop_bottom = alloca i32, align 4
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1078138639
  br i1 %193, label %194, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @img2buf.33(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom) #0 {
entry:
  %ui32 = alloca i64, align 8
  %symbol_size_in_bytes.addr = alloca i32, align 4
  %theight = alloca i32, align 4
...
entry:
  ...
  %crop_bottom.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 831528040, i32* %canary
  %size = alloca i32, align 4
  %i = alloca i32, align 4
  %size_x.addr = alloca i32, align 4
  %crop_left.addr = alloca i32, align 4
...
entry:
  ...
  %ui8 = alloca i8, align 1
  %canary = alloca i32
  store i32 1678903320, i32* %canary
  %tmp32 = alloca i64, align 8
  store i16** %imgX, i16*** %imgX.addr, align 8
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size_x, i32* %size_x.addr, align 4
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1678903320
  br i1 %109, label %110, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @img2buf.36(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom) #0 {
entry:
  %j = alloca i32, align 4
  %i = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  ...
  %crop_left.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1663476073, i32* %canary
  %crop_bottom.addr = alloca i32, align 4
  %crop_top.addr = alloca i32, align 4
  %ui32 = alloca i64, align 8
  %symbol_size_in_bytes.addr = alloca i32, align 4
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1663476073
  br i1 %109, label %110, label %func_exit
...
entry:
  ...
  %rgb_output = alloca i32, align 4
  %canary = alloca i32
  store i32 542819272, i32* %canary
  %crop_right = alloca i32, align 4
  %buf = alloca i8*, align 8
  %p.addr = alloca %struct.storable_picture*, align 8
  %crop_top = alloca i32, align 4
...
entry:
  ...
  %SubWidthC = alloca [4 x i32], align 16
  %canary = alloca i32
  store i32 814727341, i32* %canary
  %rgb_output = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  %0 = bitcast [4 x i32]* %SubWidthC to i8*
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_out_picture.39(%struct.storable_picture* %p, i32 %p_out) #0 {
entry:
  %p.addr = alloca %struct.storable_picture*, align 8
  %symbol_size_in_bytes = alloca i32, align 4
  %canary = alloca i32
  store i32 1048014596, i32* %canary
  %rgb_output = alloca i32, align 4
  %crop_top = alloca i32, align 4
  %SubWidthC = alloca [4 x i32], align 16
  %buf = alloca i8*, align 8
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1048014596
  br i1 %193, label %194, label %func_exit
...
entry:
  ...
  %crop_right.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 304331231, i32* %canary
  %j = alloca i32, align 4
  %crop_left.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  store i16** %imgX, i16*** %imgX.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @img2buf.41(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom) #0 {
entry:
  %i = alloca i32, align 4
  %crop_left.addr = alloca i32, align 4
  %symbol_size_in_bytes.addr = alloca i32, align 4
  ...
  %ui32 = alloca i64, align 8
  %canary = alloca i32
  store i32 1148838663, i32* %canary
  %ui16 = alloca i16, align 2
  %crop_right.addr = alloca i32, align 4
  %tmp32 = alloca i64, align 8
  %size = alloca i32, align 4
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1148838663
  br i1 %109, label %110, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @img2buf.42(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom) #0 {
entry:
  %j = alloca i32, align 4
  %twidth = alloca i32, align 4
  %size_x.addr = alloca i32, align 4
  ...
  %theight = alloca i32, align 4
  %canary = alloca i32
  store i32 1588305415, i32* %canary
  %crop_top.addr = alloca i32, align 4
  %ui16 = alloca i16, align 2
  %crop_left.addr = alloca i32, align 4
  store i16** %imgX, i16*** %imgX.addr, align 8
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1588305415
  br i1 %109, label %110, label %func_exit
...
entry:
  ...
  %crop_bottom = alloca i32, align 4
  %canary = alloca i32
  store i32 1200056863, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  %crop_top = alloca i32, align 4
  %p_out.addr = alloca i32, align 4
  %symbol_size_in_bytes = alloca i32, align 4
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1200056863
  br i1 %193, label %194, label %func_exit
...
entry:
  ...
  %crop_bottom.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1332562690, i32* %canary
  %ui16 = alloca i16, align 2
  %buf.addr = alloca i8*, align 8
  %imgX.addr = alloca i16**, align 8
  %j = alloca i32, align 4
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1332562690
  br i1 %109, label %110, label %func_exit
...
entry:
  ...
  %rgb_output = alloca i32, align 4
  %canary = alloca i32
  store i32 554103260, i32* %canary
  %SubWidthC = alloca [4 x i32], align 16
  %buf = alloca i8*, align 8
  %p.addr = alloca %struct.storable_picture*, align 8
  %p_out.addr = alloca i32, align 4
...
entry:
  ...
  %crop_top = alloca i32, align 4
  %canary = alloca i32
  store i32 786107080, i32* %canary
  %crop_bottom = alloca i32, align 4
  %SubHeightC = alloca [4 x i32], align 16
  %rgb_output = alloca i32, align 4
  %p.addr = alloca %struct.storable_picture*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_out_picture.47(%struct.storable_picture* %p, i32 %p_out) #0 {
entry:
  %crop_bottom = alloca i32, align 4
  %crop_right = alloca i32, align 4
  %crop_left = alloca i32, align 4
  ...
  %buf = alloca i8*, align 8
  %canary = alloca i32
  store i32 731437911, i32* %canary
  %p_out.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  %0 = bitcast [4 x i32]* %SubWidthC to i8*
...
entry:
  ...
  %ui16 = alloca i16, align 2
  %canary = alloca i32
  store i32 242240560, i32* %canary
  %i = alloca i32, align 4
  %size_x.addr = alloca i32, align 4
  %size_y.addr = alloca i32, align 4
  %theight = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_out_picture.49(%struct.storable_picture* %p, i32 %p_out) #0 {
entry:
  %canary = alloca i32
  store i32 712420541, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  %symbol_size_in_bytes = alloca i32, align 4
  %crop_top = alloca i32, align 4
  %p_out.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_out_picture.50(%struct.storable_picture* %p, i32 %p_out) #0 {
entry:
  %p_out.addr = alloca i32, align 4
  %crop_left = alloca i32, align 4
  %crop_right = alloca i32, align 4
  %canary = alloca i32
  store i32 1250749264, i32* %canary
  %buf = alloca i8*, align 8
  %symbol_size_in_bytes = alloca i32, align 4
  %crop_top = alloca i32, align 4
  %crop_bottom = alloca i32, align 4
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1250749264
  br i1 %193, label %194, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_out_picture.51(%struct.storable_picture* %p, i32 %p_out) #0 {
entry:
  %SubWidthC = alloca [4 x i32], align 16
  %p.addr = alloca %struct.storable_picture*, align 8
  %p_out.addr = alloca i32, align 4
  ...
  %crop_right = alloca i32, align 4
  %canary = alloca i32
  store i32 951438633, i32* %canary
  %symbol_size_in_bytes = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  %0 = bitcast [4 x i32]* %SubWidthC to i8*
...
entry:
  ...
  %size = alloca i32, align 4
  %canary = alloca i32
  store i32 1472677370, i32* %canary
  %crop_left.addr = alloca i32, align 4
  %size_x.addr = alloca i32, align 4
  %tmp16 = alloca i16, align 2
  %symbol_size_in_bytes.addr = alloca i32, align 4
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1472677370
  br i1 %109, label %110, label %func_exit
