; ModuleID = 'biariencode.c.rand.4P3.bc'
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_arienco_start_encoding.9, label %ctrl0

func_arienco_start_encoding.9:                    ; preds = %rand_bb
  call void @arienco_start_encoding.9(%struct.EncodingEnvironment* %eep, i8* %code_buffer, i32* %code_len, i32 %slice_type)
  ret void

func_arienco_start_encoding.11:                   ; preds = %ctrl0
...
func_arienco_start_encoding.19:                   ; preds = %ctrl1
  call void @arienco_start_encoding.19(%struct.EncodingEnvironment* %eep, i8* %code_buffer, i32* %code_len, i32 %slice_type)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_arienco_start_encoding.11, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_arienco_start_encoding.12, label %func_arienco_start_encoding.19
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_biari_encode_symbol.5, label %ctrl0

func_biari_encode_symbol.5:                       ; preds = %rand_bb
  call void @biari_encode_symbol.5(%struct.EncodingEnvironment* %eep, i16 %symbol, %struct.BiContextType* %bi_ct)
  ret void

func_biari_encode_symbol.6:                       ; preds = %ctrl0
  call void @biari_encode_symbol.6(%struct.EncodingEnvironment* %eep, i16 %symbol, %struct.BiContextType* %bi_ct)
  ret void

func_biari_encode_symbol.8:                       ; preds = %ctrl1
  call void @biari_encode_symbol.8(%struct.EncodingEnvironment* %eep, i16 %symbol, %struct.BiContextType* %bi_ct)
  ret void

func_biari_encode_symbol.17:                      ; preds = %ctrl1
  call void @biari_encode_symbol.17(%struct.EncodingEnvironment* %eep, i16 %symbol, %struct.BiContextType* %bi_ct)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_biari_encode_symbol.6, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_biari_encode_symbol.8, label %func_biari_encode_symbol.17
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_biari_encode_symbol_eq_prob.7, label %ctrl0

func_biari_encode_symbol_eq_prob.7:               ; preds = %rand_bb
  call void @biari_encode_symbol_eq_prob.7(%struct.EncodingEnvironment* %eep, i16 %symbol)
  ret void

func_biari_encode_symbol_eq_prob.14:              ; preds = %ctrl0
...
func_biari_encode_symbol_eq_prob.20:              ; preds = %ctrl1
  call void @biari_encode_symbol_eq_prob.20(%struct.EncodingEnvironment* %eep, i16 %symbol)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_biari_encode_symbol_eq_prob.14, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_biari_encode_symbol_eq_prob.18, label %func_biari_encode_symbol_eq_prob.20
}
...
func_biari_encode_symbol_final.4:                 ; preds = %ctrl0
  call void @biari_encode_symbol_final.4(%struct.EncodingEnvironment* %eep, i16 %symbol)
  ret void

func_biari_encode_symbol_final.10:                ; preds = %ctrl1
  call void @biari_encode_symbol_final.10(%struct.EncodingEnvironment* %eep, i16 %symbol)
  ret void

func_biari_encode_symbol_final.13:                ; preds = %ctrl1
  call void @biari_encode_symbol_final.13(%struct.EncodingEnvironment* %eep, i16 %symbol)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_biari_encode_symbol_final.4, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_biari_encode_symbol_final.10, label %func_biari_encode_symbol_final.13
}
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_biari_init_context.15, label %func_biari_init_context.16
}
...
entry:
  %canary = alloca i32
  store i32 1471260411, i32* %canary
...
while.end125:                                     ; preds = %while.cond
  ...
  %111 = icmp eq i32 %110, 1471260411
...
entry:
  ...
  %canary = alloca i32
  store i32 233758145, i32* %canary
...
entry:
  %ini.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 562877949, i32* %canary
  %pstate = alloca i32, align 4
  %ctx.addr = alloca %struct.BiContextType*, align 8
  store %struct.BiContextType* %ctx, %struct.BiContextType** %ctx.addr, align 8
  store i32* %ini, i32** %ini.addr, align 8
...
entry:
  ...
  %symbol.addr = alloca i16, align 2
  %canary = alloca i32
  store i32 741435730, i32* %canary
  %range = alloca i32, align 4
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
...
entry:
  ...
  %canary = alloca i32
  store i32 1286559389, i32* %canary
  %range = alloca i32, align 4
  %symbol.addr = alloca i16, align 2
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
...
while.end162:                                     ; preds = %while.cond
  ...
  %137 = icmp eq i32 %136, 1286559389
...
entry:
  %bi_ct.addr = alloca %struct.BiContextType*, align 8
  %canary = alloca i32
  store i32 207724700, i32* %canary
  %symbol.addr = alloca i16, align 2
  %low = alloca i32, align 4
  %rLPS = alloca i32, align 4
  %range = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 636431679, i32* %canary
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %symbol.addr = alloca i16, align 2
  %low = alloca i32, align 4
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_encode_symbol.8(%struct.EncodingEnvironment* %eep, i16 signext %symbol, %struct.BiContextType* %bi_ct) #0 {
entry:
  %range = alloca i32, align 4
  %symbol.addr = alloca i16, align 2
  %canary = alloca i32
  store i32 562827767, i32* %canary
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %rLPS = alloca i32, align 4
  %bi_ct.addr = alloca %struct.BiContextType*, align 8
  %low = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1811669026, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_encode_symbol_final.10(%struct.EncodingEnvironment* %eep, i16 signext %symbol) #0 {
entry:
  %range = alloca i32, align 4
  %low = alloca i32, align 4
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 1978044066, i32* %canary
  %symbol.addr = alloca i16, align 2
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
  %0 = load %struct.EncodingEnvironment*, %struct.EncodingEnvironment** %eep.addr, align 8
...
while.end125:                                     ; preds = %while.cond
  ...
  store i32 %inc129, i32* %C128, align 8
  %110 = load i32, i32* %canary
  %111 = icmp eq i32 %110, 1978044066
  br i1 %111, label %112, label %func_exit
...
entry:
  ...
  %code_len.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 1343767896, i32* %canary
  %slice_type.addr = alloca i32, align 4
  %code_buffer.addr = alloca i8*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i8* %code_buffer, i8** %code_buffer.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1169800449, i32* %canary
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %slice_type.addr = alloca i32, align 4
  %code_buffer.addr = alloca i8*, align 8
  %code_len.addr = alloca i32*, align 8
...
entry:
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 1895788555, i32* %canary
  %symbol.addr = alloca i16, align 2
  %range = alloca i32, align 4
  %low = alloca i32, align 4
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
...
while.end125:                                     ; preds = %while.cond
  ...
  store i32 %inc129, i32* %C128, align 8
  %110 = load i32, i32* %canary
  %111 = icmp eq i32 %110, 1895788555
  br i1 %111, label %112, label %func_exit
...
entry:
  %low = alloca i32, align 4
  %canary = alloca i32
  store i32 949520064, i32* %canary
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %symbol.addr = alloca i16, align 2
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
...
entry:
  %canary = alloca i32
  store i32 1250806483, i32* %canary
  %pstate = alloca i32, align 4
  %ctx.addr = alloca %struct.BiContextType*, align 8
  %ini.addr = alloca i32*, align 8
  store %struct.BiContextType* %ctx, %struct.BiContextType** %ctx.addr, align 8
...
entry:
  %ini.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 564168261, i32* %canary
  %ctx.addr = alloca %struct.BiContextType*, align 8
  %pstate = alloca i32, align 4
  store %struct.BiContextType* %ctx, %struct.BiContextType** %ctx.addr, align 8
  store i32* %ini, i32** %ini.addr, align 8
...
entry:
  %rLPS = alloca i32, align 4
  %canary = alloca i32
  store i32 1762283531, i32* %canary
  %range = alloca i32, align 4
  %low = alloca i32, align 4
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %symbol.addr = alloca i16, align 2
...
while.end162:                                     ; preds = %while.cond
  ...
  store i32 %inc166, i32* %C165, align 8
  %136 = load i32, i32* %canary
  %137 = icmp eq i32 %136, 1762283531
  br i1 %137, label %138, label %func_exit
...
entry:
  %low = alloca i32, align 4
  %canary = alloca i32
  store i32 397254440, i32* %canary
  %symbol.addr = alloca i16, align 2
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
...
entry:
  ...
  %code_buffer.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 102700543, i32* %canary
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i8* %code_buffer, i8** %code_buffer.addr, align 8
  store i32* %code_len, i32** %code_len.addr, align 8
...
entry:
  %symbol.addr = alloca i16, align 2
  %canary = alloca i32
  store i32 1011242573, i32* %canary
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %low = alloca i32, align 4
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
...
if.end124:                                        ; preds = %if.end123, %while.end51
  ...
  store i32 %inc127, i32* %C126, align 8
  %104 = load i32, i32* %canary
  %105 = icmp eq i32 %104, 1011242573
  br i1 %105, label %106, label %func_exit
