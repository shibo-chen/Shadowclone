; ModuleID = 'memalloc.c.rand.4P2.bc'
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_init_top_bot_planes.3, label %ctrl0

func_init_top_bot_planes.3:                       ; preds = %rand_bb
  %2 = call i32 @init_top_bot_planes.3(i16** %imgFrame, i32 %rows, i32 %columns, i16*** %imgTopField, i16*** %imgBotField)
  ret i32 %2

func_init_top_bot_planes.6:                       ; preds = %ctrl0
  %3 = call i32 @init_top_bot_planes.6(i16** %imgFrame, i32 %rows, i32 %columns, i16*** %imgTopField, i16*** %imgBotField)
  ret i32 %3

func_init_top_bot_planes.8:                       ; preds = %ctrl1
  %4 = call i32 @init_top_bot_planes.8(i16** %imgFrame, i32 %rows, i32 %columns, i16*** %imgTopField, i16*** %imgBotField)
  ret i32 %4

func_init_top_bot_planes.11:                      ; preds = %ctrl1
  %5 = call i32 @init_top_bot_planes.11(i16** %imgFrame, i32 %rows, i32 %columns, i16*** %imgTopField, i16*** %imgBotField)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_init_top_bot_planes.6, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_init_top_bot_planes.8, label %func_init_top_bot_planes.11
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_free_top_bot_planes.21, label %func_free_top_bot_planes.51

func_free_top_bot_planes.21:                      ; preds = %rand_bb
  call void @free_top_bot_planes.21(i16** %imgTopField, i16** %imgBotField)
  ret void

func_free_top_bot_planes.51:                      ; preds = %rand_bb
  call void @free_top_bot_planes.51(i16** %imgTopField, i16** %imgBotField)
  ret void
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_get_mem2Dpel.60, label %ctrl0

func_get_mem2Dpel.60:                             ; preds = %rand_bb
  %2 = call i32 @get_mem2Dpel.60(i16*** %array2D, i32 %rows, i32 %columns)
  ret i32 %2

func_get_mem2Dpel.76:                             ; preds = %ctrl0
  %3 = call i32 @get_mem2Dpel.76(i16*** %array2D, i32 %rows, i32 %columns)
  ret i32 %3

func_get_mem2Dpel.78:                             ; preds = %ctrl1
  %4 = call i32 @get_mem2Dpel.78(i16*** %array2D, i32 %rows, i32 %columns)
  ret i32 %4

func_get_mem2Dpel.79:                             ; preds = %ctrl1
  %5 = call i32 @get_mem2Dpel.79(i16*** %array2D, i32 %rows, i32 %columns)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_get_mem2Dpel.76, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_get_mem2Dpel.78, label %func_get_mem2Dpel.79
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_get_mem3Dpel.14, label %ctrl0

func_get_mem3Dpel.14:                             ; preds = %rand_bb
  %2 = call i32 @get_mem3Dpel.14(i16**** %array3D, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %2

func_get_mem3Dpel.17:                             ; preds = %ctrl0
  %3 = call i32 @get_mem3Dpel.17(i16**** %array3D, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %3

func_get_mem3Dpel.38:                             ; preds = %ctrl1
  %4 = call i32 @get_mem3Dpel.38(i16**** %array3D, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %4

func_get_mem3Dpel.56:                             ; preds = %ctrl1
  %5 = call i32 @get_mem3Dpel.56(i16**** %array3D, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_get_mem3Dpel.17, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_get_mem3Dpel.38, label %func_get_mem3Dpel.56
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_free_mem3Dpel.30, label %ctrl0

func_free_mem3Dpel.30:                            ; preds = %rand_bb
  call void @free_mem3Dpel.30(i16*** %array3D, i32 %frames)
  ret void

func_free_mem3Dpel.37:                            ; preds = %ctrl0
  call void @free_mem3Dpel.37(i16*** %array3D, i32 %frames)
  ret void

func_free_mem3Dpel.64:                            ; preds = %ctrl1
  call void @free_mem3Dpel.64(i16*** %array3D, i32 %frames)
  ret void

func_free_mem3Dpel.68:                            ; preds = %ctrl1
  call void @free_mem3Dpel.68(i16*** %array3D, i32 %frames)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_free_mem3Dpel.37, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_free_mem3Dpel.64, label %func_free_mem3Dpel.68
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_get_mem2D.5, label %ctrl0

func_get_mem2D.5:                                 ; preds = %rand_bb
  %2 = call i32 @get_mem2D.5(i8*** %array2D, i32 %rows, i32 %columns)
  ret i32 %2

func_get_mem2D.16:                                ; preds = %ctrl0
  %3 = call i32 @get_mem2D.16(i8*** %array2D, i32 %rows, i32 %columns)
  ret i32 %3

func_get_mem2D.26:                                ; preds = %ctrl1
  %4 = call i32 @get_mem2D.26(i8*** %array2D, i32 %rows, i32 %columns)
  ret i32 %4

func_get_mem2D.53:                                ; preds = %ctrl1
  %5 = call i32 @get_mem2D.53(i8*** %array2D, i32 %rows, i32 %columns)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_get_mem2D.16, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_get_mem2D.26, label %func_get_mem2D.53
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_get_mem2Dint.13, label %ctrl0

func_get_mem2Dint.13:                             ; preds = %rand_bb
  %2 = call i32 @get_mem2Dint.13(i32*** %array2D, i32 %rows, i32 %columns)
  ret i32 %2

func_get_mem2Dint.31:                             ; preds = %ctrl0
  %3 = call i32 @get_mem2Dint.31(i32*** %array2D, i32 %rows, i32 %columns)
  ret i32 %3

func_get_mem2Dint.54:                             ; preds = %ctrl1
  %4 = call i32 @get_mem2Dint.54(i32*** %array2D, i32 %rows, i32 %columns)
  ret i32 %4

func_get_mem2Dint.75:                             ; preds = %ctrl1
  %5 = call i32 @get_mem2Dint.75(i32*** %array2D, i32 %rows, i32 %columns)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_get_mem2Dint.31, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_get_mem2Dint.54, label %func_get_mem2Dint.75
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_get_mem2Dint64.22, label %ctrl0

func_get_mem2Dint64.22:                           ; preds = %rand_bb
  %2 = call i32 @get_mem2Dint64.22(i64*** %array2D, i32 %rows, i32 %columns)
  ret i32 %2

func_get_mem2Dint64.46:                           ; preds = %ctrl0
  %3 = call i32 @get_mem2Dint64.46(i64*** %array2D, i32 %rows, i32 %columns)
  ret i32 %3

func_get_mem2Dint64.50:                           ; preds = %ctrl1
  %4 = call i32 @get_mem2Dint64.50(i64*** %array2D, i32 %rows, i32 %columns)
  ret i32 %4

func_get_mem2Dint64.74:                           ; preds = %ctrl1
  %5 = call i32 @get_mem2Dint64.74(i64*** %array2D, i32 %rows, i32 %columns)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_get_mem2Dint64.46, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_get_mem2Dint64.50, label %func_get_mem2Dint64.74
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_get_mem3D.10, label %ctrl0

func_get_mem3D.10:                                ; preds = %rand_bb
  %2 = call i32 @get_mem3D.10(i8**** %array3D, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %2

func_get_mem3D.12:                                ; preds = %ctrl0
  %3 = call i32 @get_mem3D.12(i8**** %array3D, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %3

func_get_mem3D.27:                                ; preds = %ctrl1
  %4 = call i32 @get_mem3D.27(i8**** %array3D, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %4

func_get_mem3D.34:                                ; preds = %ctrl1
  %5 = call i32 @get_mem3D.34(i8**** %array3D, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_get_mem3D.12, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_get_mem3D.27, label %func_get_mem3D.34
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_get_mem3Dint.29, label %ctrl0

func_get_mem3Dint.29:                             ; preds = %rand_bb
  %2 = call i32 @get_mem3Dint.29(i32**** %array3D, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %2

func_get_mem3Dint.40:                             ; preds = %ctrl0
  %3 = call i32 @get_mem3Dint.40(i32**** %array3D, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %3

func_get_mem3Dint.42:                             ; preds = %ctrl1
  %4 = call i32 @get_mem3Dint.42(i32**** %array3D, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %4

func_get_mem3Dint.58:                             ; preds = %ctrl1
  %5 = call i32 @get_mem3Dint.58(i32**** %array3D, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_get_mem3Dint.40, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_get_mem3Dint.42, label %func_get_mem3Dint.58
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_get_mem3Dint64.32, label %ctrl0

func_get_mem3Dint64.32:                           ; preds = %rand_bb
  %2 = call i32 @get_mem3Dint64.32(i64**** %array3D, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %2

func_get_mem3Dint64.36:                           ; preds = %ctrl0
  %3 = call i32 @get_mem3Dint64.36(i64**** %array3D, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %3

func_get_mem3Dint64.47:                           ; preds = %ctrl1
  %4 = call i32 @get_mem3Dint64.47(i64**** %array3D, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %4

func_get_mem3Dint64.63:                           ; preds = %ctrl1
  %5 = call i32 @get_mem3Dint64.63(i64**** %array3D, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_get_mem3Dint64.36, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_get_mem3Dint64.47, label %func_get_mem3Dint64.63
}
...
func_get_mem4Dint.18:                             ; preds = %ctrl0
  %3 = call i32 @get_mem4Dint.18(i32***** %array4D, i32 %idx, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %3

func_get_mem4Dint.41:                             ; preds = %ctrl1
  %4 = call i32 @get_mem4Dint.41(i32***** %array4D, i32 %idx, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %4

func_get_mem4Dint.48:                             ; preds = %ctrl1
  %5 = call i32 @get_mem4Dint.48(i32***** %array4D, i32 %idx, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_get_mem4Dint.18, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_get_mem4Dint.41, label %func_get_mem4Dint.48
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_free_mem3D.33, label %ctrl0

func_free_mem3D.33:                               ; preds = %rand_bb
  call void @free_mem3D.33(i8*** %array3D, i32 %frames)
  ret void

func_free_mem3D.39:                               ; preds = %ctrl0
  call void @free_mem3D.39(i8*** %array3D, i32 %frames)
  ret void

func_free_mem3D.43:                               ; preds = %ctrl1
  call void @free_mem3D.43(i8*** %array3D, i32 %frames)
  ret void

func_free_mem3D.44:                               ; preds = %ctrl1
  call void @free_mem3D.44(i8*** %array3D, i32 %frames)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_free_mem3D.39, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_free_mem3D.43, label %func_free_mem3D.44
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_free_mem3Dint.61, label %ctrl0

func_free_mem3Dint.61:                            ; preds = %rand_bb
  call void @free_mem3Dint.61(i32*** %array3D, i32 %frames)
  ret void

func_free_mem3Dint.72:                            ; preds = %ctrl0
  call void @free_mem3Dint.72(i32*** %array3D, i32 %frames)
  ret void

func_free_mem3Dint.81:                            ; preds = %ctrl1
  call void @free_mem3Dint.81(i32*** %array3D, i32 %frames)
  ret void

func_free_mem3Dint.82:                            ; preds = %ctrl1
  call void @free_mem3Dint.82(i32*** %array3D, i32 %frames)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_free_mem3Dint.72, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_free_mem3Dint.81, label %func_free_mem3Dint.82
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_free_mem3Dint64.20, label %ctrl0

func_free_mem3Dint64.20:                          ; preds = %rand_bb
  call void @free_mem3Dint64.20(i64*** %array3D, i32 %frames)
  ret void

func_free_mem3Dint64.24:                          ; preds = %ctrl0
  call void @free_mem3Dint64.24(i64*** %array3D, i32 %frames)
  ret void

func_free_mem3Dint64.52:                          ; preds = %ctrl1
  call void @free_mem3Dint64.52(i64*** %array3D, i32 %frames)
  ret void

func_free_mem3Dint64.55:                          ; preds = %ctrl1
  call void @free_mem3Dint64.55(i64*** %array3D, i32 %frames)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_free_mem3Dint64.24, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_free_mem3Dint64.52, label %func_free_mem3Dint64.55
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_free_mem4Dint.4, label %ctrl0

func_free_mem4Dint.4:                             ; preds = %rand_bb
  call void @free_mem4Dint.4(i32**** %array4D, i32 %idx, i32 %frames)
  ret void
...
func_free_mem4Dint.57:                            ; preds = %ctrl1
  call void @free_mem4Dint.57(i32**** %array4D, i32 %idx, i32 %frames)
  ret void

func_free_mem4Dint.70:                            ; preds = %ctrl1
  call void @free_mem4Dint.70(i32**** %array4D, i32 %idx, i32 %frames)
  ret void
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_free_mem4Dint.57, label %func_free_mem4Dint.70
}
...
func_get_mem2Dshort.28:                           ; preds = %ctrl0
  %3 = call i32 @get_mem2Dshort.28(i16*** %array2D, i32 %rows, i32 %columns)
  ret i32 %3

func_get_mem2Dshort.65:                           ; preds = %ctrl1
  %4 = call i32 @get_mem2Dshort.65(i16*** %array2D, i32 %rows, i32 %columns)
  ret i32 %4

func_get_mem2Dshort.73:                           ; preds = %ctrl1
  %5 = call i32 @get_mem2Dshort.73(i16*** %array2D, i32 %rows, i32 %columns)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_get_mem2Dshort.28, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_get_mem2Dshort.65, label %func_get_mem2Dshort.73
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_get_mem3Dshort.49, label %ctrl0

func_get_mem3Dshort.49:                           ; preds = %rand_bb
  %2 = call i32 @get_mem3Dshort.49(i16**** %array3D, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %2

func_get_mem3Dshort.59:                           ; preds = %ctrl0
  %3 = call i32 @get_mem3Dshort.59(i16**** %array3D, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %3

func_get_mem3Dshort.67:                           ; preds = %ctrl1
  %4 = call i32 @get_mem3Dshort.67(i16**** %array3D, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %4
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_get_mem3Dshort.59, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_get_mem3Dshort.67, label %func_get_mem3Dshort.69
}
...
func_get_mem4Dshort.15:                           ; preds = %ctrl0
  %3 = call i32 @get_mem4Dshort.15(i16***** %array4D, i32 %idx, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %3

func_get_mem4Dshort.45:                           ; preds = %ctrl1
  %4 = call i32 @get_mem4Dshort.45(i16***** %array4D, i32 %idx, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %4

func_get_mem4Dshort.62:                           ; preds = %ctrl1
  %5 = call i32 @get_mem4Dshort.62(i16***** %array4D, i32 %idx, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_get_mem4Dshort.15, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_get_mem4Dshort.45, label %func_get_mem4Dshort.62
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_free_mem3Dshort.7, label %ctrl0

func_free_mem3Dshort.7:                           ; preds = %rand_bb
  call void @free_mem3Dshort.7(i16*** %array3D, i32 %frames)
  ret void

func_free_mem3Dshort.9:                           ; preds = %ctrl0
  call void @free_mem3Dshort.9(i16*** %array3D, i32 %frames)
  ret void

func_free_mem3Dshort.23:                          ; preds = %ctrl1
  call void @free_mem3Dshort.23(i16*** %array3D, i32 %frames)
  ret void

func_free_mem3Dshort.25:                          ; preds = %ctrl1
  call void @free_mem3Dshort.25(i16*** %array3D, i32 %frames)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_free_mem3Dshort.9, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_free_mem3Dshort.23, label %func_free_mem3Dshort.25
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_free_mem4Dshort.66, label %ctrl0

func_free_mem4Dshort.66:                          ; preds = %rand_bb
  call void @free_mem4Dshort.66(i16**** %array4D, i32 %idx, i32 %frames)
  ret void

func_free_mem4Dshort.71:                          ; preds = %ctrl0
  call void @free_mem4Dshort.71(i16**** %array4D, i32 %idx, i32 %frames)
  ret void
...
func_free_mem4Dshort.80:                          ; preds = %ctrl1
  call void @free_mem4Dshort.80(i16**** %array4D, i32 %idx, i32 %frames)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_free_mem4Dshort.71, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_free_mem4Dshort.77, label %func_free_mem4Dshort.80
}
...
entry:
  ...
  %canary = alloca i32
  store i32 1280291231, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 789027209, i32* %canary
  %j = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @init_top_bot_planes.3(i16** %imgFrame, i32 %rows, i32 %columns, i16*** %imgTopField, i16*** %imgBotField) #0 {
entry:
  ...
  %rows.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 267982202, i32* %canary
  %columns.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_mem4Dint.4(i32**** %array4D, i32 %idx, i32 %frames) #0 {
entry:
  %frames.addr = alloca i32, align 4
  %array4D.addr = alloca i32****, align 8
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 812062935, i32* %canary
  %idx.addr = alloca i32, align 4
  store i32**** %array4D, i32***** %array4D.addr, align 8
  store i32 %idx, i32* %idx.addr, align 4
  store i32 %frames, i32* %frames.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem2D.5(i8*** %array2D, i32 %rows, i32 %columns) #0 {
entry:
  %rows.addr = alloca i32, align 4
  %columns.addr = alloca i32, align 4
  %array2D.addr = alloca i8***, align 8
  %canary = alloca i32
  store i32 859055725, i32* %canary
  %i = alloca i32, align 4
  store i8*** %array2D, i8**** %array2D.addr, align 8
  store i32 %rows, i32* %rows.addr, align 4
  store i32 %columns, i32* %columns.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @init_top_bot_planes.6(i16** %imgFrame, i32 %rows, i32 %columns, i16*** %imgTopField, i16*** %imgBotField) #0 {
entry:
  %imgTopField.addr = alloca i16***, align 8
  %columns.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1517761853, i32* %canary
  %imgFrame.addr = alloca i16**, align 8
  %imgBotField.addr = alloca i16***, align 8
  %rows.addr = alloca i32, align 4
  store i16** %imgFrame, i16*** %imgFrame.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_mem3Dshort.7(i16*** %array3D, i32 %frames) #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 666180495, i32* %canary
...
entry:
  ...
  %imgFrame.addr = alloca i16**, align 8
  %canary = alloca i32
  store i32 847243363, i32* %canary
  %rows.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %imgBotField.addr = alloca i16***, align 8
  %imgTopField.addr = alloca i16***, align 8
...
entry:
  %array3D.addr = alloca i16***, align 8
  %canary = alloca i32
  store i32 2008193541, i32* %canary
  %i = alloca i32, align 4
  %frames.addr = alloca i32, align 4
  store i16*** %array3D, i16**** %array3D.addr, align 8
  store i32 %frames, i32* %frames.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem3D.10(i8**** %array3D, i32 %frames, i32 %rows, i32 %columns) #0 {
entry:
  %frames.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 548985079, i32* %canary
  %rows.addr = alloca i32, align 4
  %columns.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @init_top_bot_planes.11(i16** %imgFrame, i32 %rows, i32 %columns, i16*** %imgTopField, i16*** %imgBotField) #0 {
entry:
  %imgFrame.addr = alloca i16**, align 8
  %canary = alloca i32
  store i32 1051349760, i32* %canary
  %imgBotField.addr = alloca i16***, align 8
  %columns.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %rows.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem3D.12(i8**** %array3D, i32 %frames, i32 %rows, i32 %columns) #0 {
entry:
  %frames.addr = alloca i32, align 4
  %j = alloca i32, align 4
  %columns.addr = alloca i32, align 4
  %rows.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 116856800, i32* %canary
  %array3D.addr = alloca i8****, align 8
  store i8**** %array3D, i8***** %array3D.addr, align 8
  store i32 %frames, i32* %frames.addr, align 4
  store i32 %rows, i32* %rows.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem2Dint.13(i32*** %array2D, i32 %rows, i32 %columns) #0 {
entry:
  %rows.addr = alloca i32, align 4
  %array2D.addr = alloca i32***, align 8
  %columns.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1762791943, i32* %canary
  %i = alloca i32, align 4
  store i32*** %array2D, i32**** %array2D.addr, align 8
  store i32 %rows, i32* %rows.addr, align 4
  store i32 %columns, i32* %columns.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem3Dpel.14(i16**** %array3D, i32 %frames, i32 %rows, i32 %columns) #0 {
entry:
  %canary = alloca i32
  store i32 516528744, i32* %canary
  %j = alloca i32, align 4
  %rows.addr = alloca i32, align 4
  %frames.addr = alloca i32, align 4
  %array3D.addr = alloca i16****, align 8
...
entry:
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1585597062, i32* %canary
  %idx.addr = alloca i32, align 4
  %rows.addr = alloca i32, align 4
  %frames.addr = alloca i32, align 4
  %array4D.addr = alloca i16*****, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem2D.16(i8*** %array2D, i32 %rows, i32 %columns) #0 {
entry:
  %columns.addr = alloca i32, align 4
  %array2D.addr = alloca i8***, align 8
  %canary = alloca i32
  store i32 421156278, i32* %canary
  %rows.addr = alloca i32, align 4
  %i = alloca i32, align 4
  store i8*** %array2D, i8**** %array2D.addr, align 8
  store i32 %rows, i32* %rows.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem3Dpel.17(i16**** %array3D, i32 %frames, i32 %rows, i32 %columns) #0 {
entry:
  %array3D.addr = alloca i16****, align 8
  %columns.addr = alloca i32, align 4
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 28903897, i32* %canary
  %rows.addr = alloca i32, align 4
  %frames.addr = alloca i32, align 4
  store i16**** %array3D, i16***** %array3D.addr, align 8
  store i32 %frames, i32* %frames.addr, align 4
...
entry:
  ...
  %frames.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 172383864, i32* %canary
  %columns.addr = alloca i32, align 4
  %rows.addr = alloca i32, align 4
  %j = alloca i32, align 4
  %idx.addr = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 109276217, i32* %canary
  %columns.addr = alloca i32, align 4
  %rows.addr = alloca i32, align 4
  %array2D.addr = alloca i16***, align 8
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_mem3Dint64.20(i64*** %array3D, i32 %frames) #0 {
entry:
  %array3D.addr = alloca i64***, align 8
  %frames.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 41303807, i32* %canary
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_top_bot_planes.21(i16** %imgTopField, i16** %imgBotField) #0 {
entry:
  %canary = alloca i32
  store i32 1491949819, i32* %canary
  %imgBotField.addr = alloca i16**, align 8
  %imgTopField.addr = alloca i16**, align 8
  store i16** %imgTopField, i16*** %imgTopField.addr, align 8
  store i16** %imgBotField, i16*** %imgBotField.addr, align 8
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 179325232, i32* %canary
  %rows.addr = alloca i32, align 4
  store i64*** %array2D, i64**** %array2D.addr, align 8
  store i32 %rows, i32* %rows.addr, align 4
  store i32 %columns, i32* %columns.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_mem3Dshort.23(i16*** %array3D, i32 %frames) #0 {
entry:
  %array3D.addr = alloca i16***, align 8
  %frames.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1872932559, i32* %canary
  %i = alloca i32, align 4
  store i16*** %array3D, i16**** %array3D.addr, align 8
  store i32 %frames, i32* %frames.addr, align 4
  %0 = load i16***, i16**** %array3D.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_mem3Dint64.24(i64*** %array3D, i32 %frames) #0 {
entry:
  %canary = alloca i32
  store i32 1661163316, i32* %canary
  %frames.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %array3D.addr = alloca i64***, align 8
  store i64*** %array3D, i64**** %array3D.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_mem3Dshort.25(i16*** %array3D, i32 %frames) #0 {
entry:
  %frames.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 560578804, i32* %canary
  %array3D.addr = alloca i16***, align 8
  store i16*** %array3D, i16**** %array3D.addr, align 8
  store i32 %frames, i32* %frames.addr, align 4
  %0 = load i16***, i16**** %array3D.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem2D.26(i8*** %array2D, i32 %rows, i32 %columns) #0 {
entry:
  %columns.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2128114052, i32* %canary
  %rows.addr = alloca i32, align 4
  %array2D.addr = alloca i8***, align 8
  %i = alloca i32, align 4
  store i8*** %array2D, i8**** %array2D.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem3D.27(i8**** %array3D, i32 %frames, i32 %rows, i32 %columns) #0 {
entry:
  %columns.addr = alloca i32, align 4
  %j = alloca i32, align 4
  %frames.addr = alloca i32, align 4
  %array3D.addr = alloca i8****, align 8
  %canary = alloca i32
  store i32 1946314035, i32* %canary
  %rows.addr = alloca i32, align 4
  store i8**** %array3D, i8***** %array3D.addr, align 8
  store i32 %frames, i32* %frames.addr, align 4
  store i32 %rows, i32* %rows.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 1442262388, i32* %canary
  %columns.addr = alloca i32, align 4
  %array2D.addr = alloca i16***, align 8
  %rows.addr = alloca i32, align 4
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem3Dint.29(i32**** %array3D, i32 %frames, i32 %rows, i32 %columns) #0 {
entry:
  %array3D.addr = alloca i32****, align 8
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1667993600, i32* %canary
  %columns.addr = alloca i32, align 4
  %frames.addr = alloca i32, align 4
  %rows.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_mem3Dpel.30(i16*** %array3D, i32 %frames) #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1671558770, i32* %canary
  %frames.addr = alloca i32, align 4
  %array3D.addr = alloca i16***, align 8
  store i16*** %array3D, i16**** %array3D.addr, align 8
  store i32 %frames, i32* %frames.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 788866644, i32* %canary
  %array2D.addr = alloca i32***, align 8
  %rows.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %columns.addr = alloca i32, align 4
...
entry:
  ...
  %rows.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1765020788, i32* %canary
  %j = alloca i32, align 4
  store i64**** %array3D, i64***** %array3D.addr, align 8
  store i32 %frames, i32* %frames.addr, align 4
  store i32 %rows, i32* %rows.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_mem3D.33(i8*** %array3D, i32 %frames) #0 {
entry:
  %canary = alloca i32
  store i32 1186709679, i32* %canary
  %frames.addr = alloca i32, align 4
  %array3D.addr = alloca i8***, align 8
  %i = alloca i32, align 4
  store i8*** %array3D, i8**** %array3D.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem3D.34(i8**** %array3D, i32 %frames, i32 %rows, i32 %columns) #0 {
entry:
  %array3D.addr = alloca i8****, align 8
  %rows.addr = alloca i32, align 4
  %columns.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1308136448, i32* %canary
  %frames.addr = alloca i32, align 4
  %j = alloca i32, align 4
  store i8**** %array3D, i8***** %array3D.addr, align 8
  store i32 %frames, i32* %frames.addr, align 4
...
entry:
  ...
  %array4D.addr = alloca i32****, align 8
  %canary = alloca i32
  store i32 1154991047, i32* %canary
  %frames.addr = alloca i32, align 4
  %idx.addr = alloca i32, align 4
  store i32**** %array4D, i32***** %array4D.addr, align 8
  store i32 %idx, i32* %idx.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 1371260579, i32* %canary
  %columns.addr = alloca i32, align 4
  %frames.addr = alloca i32, align 4
  %array3D.addr = alloca i64****, align 8
  %rows.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_mem3Dpel.37(i16*** %array3D, i32 %frames) #0 {
entry:
  %canary = alloca i32
  store i32 498256777, i32* %canary
  %array3D.addr = alloca i16***, align 8
  %frames.addr = alloca i32, align 4
  %i = alloca i32, align 4
  store i16*** %array3D, i16**** %array3D.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem3Dpel.38(i16**** %array3D, i32 %frames, i32 %rows, i32 %columns) #0 {
entry:
  %rows.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1150613190, i32* %canary
  %j = alloca i32, align 4
  %columns.addr = alloca i32, align 4
  %array3D.addr = alloca i16****, align 8
  %frames.addr = alloca i32, align 4
...
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 715267737, i32* %canary
  %frames.addr = alloca i32, align 4
  %array3D.addr = alloca i8***, align 8
  store i8*** %array3D, i8**** %array3D.addr, align 8
  store i32 %frames, i32* %frames.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem3Dint.40(i32**** %array3D, i32 %frames, i32 %rows, i32 %columns) #0 {
entry:
  %columns.addr = alloca i32, align 4
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1363068102, i32* %canary
  %rows.addr = alloca i32, align 4
  %frames.addr = alloca i32, align 4
  %array3D.addr = alloca i32****, align 8
  store i32**** %array3D, i32***** %array3D.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem4Dint.41(i32***** %array4D, i32 %idx, i32 %frames, i32 %rows, i32 %columns) #0 {
entry:
  %canary = alloca i32
  store i32 484601088, i32* %canary
  %j = alloca i32, align 4
  %rows.addr = alloca i32, align 4
  %array4D.addr = alloca i32*****, align 8
  %columns.addr = alloca i32, align 4
...
entry:
  ...
  %array3D.addr = alloca i32****, align 8
  %canary = alloca i32
  store i32 1518750827, i32* %canary
  %rows.addr = alloca i32, align 4
  %columns.addr = alloca i32, align 4
  %frames.addr = alloca i32, align 4
  store i32**** %array3D, i32***** %array3D.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_mem3D.43(i8*** %array3D, i32 %frames) #0 {
entry:
  %canary = alloca i32
  store i32 329031562, i32* %canary
  %frames.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %array3D.addr = alloca i8***, align 8
  store i8*** %array3D, i8**** %array3D.addr, align 8
...
entry:
  ...
  %array3D.addr = alloca i8***, align 8
  %canary = alloca i32
  store i32 2000752824, i32* %canary
  %frames.addr = alloca i32, align 4
  store i8*** %array3D, i8**** %array3D.addr, align 8
  store i32 %frames, i32* %frames.addr, align 4
  %0 = load i8***, i8**** %array3D.addr, align 8
...
entry:
  ...
  %rows.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 674990259, i32* %canary
  %frames.addr = alloca i32, align 4
  store i16***** %array4D, i16****** %array4D.addr, align 8
  store i32 %idx, i32* %idx.addr, align 4
  store i32 %frames, i32* %frames.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem2Dint64.46(i64*** %array2D, i32 %rows, i32 %columns) #0 {
entry:
  %rows.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 822660530, i32* %canary
  %columns.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %array2D.addr = alloca i64***, align 8
  store i64*** %array2D, i64**** %array2D.addr, align 8
...
entry:
  ...
  %rows.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1431883705, i32* %canary
  %frames.addr = alloca i32, align 4
  store i64**** %array3D, i64***** %array3D.addr, align 8
  store i32 %frames, i32* %frames.addr, align 4
  store i32 %rows, i32* %rows.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem4Dint.48(i32***** %array4D, i32 %idx, i32 %frames, i32 %rows, i32 %columns) #0 {
entry:
  %canary = alloca i32
  store i32 876578152, i32* %canary
  %j = alloca i32, align 4
  %frames.addr = alloca i32, align 4
  %idx.addr = alloca i32, align 4
  %array4D.addr = alloca i32*****, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem3Dshort.49(i16**** %array3D, i32 %frames, i32 %rows, i32 %columns) #0 {
entry:
  %rows.addr = alloca i32, align 4
  %columns.addr = alloca i32, align 4
  %array3D.addr = alloca i16****, align 8
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1524559067, i32* %canary
  %frames.addr = alloca i32, align 4
  store i16**** %array3D, i16***** %array3D.addr, align 8
  store i32 %frames, i32* %frames.addr, align 4
  store i32 %rows, i32* %rows.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem2Dint64.50(i64*** %array2D, i32 %rows, i32 %columns) #0 {
entry:
  %i = alloca i32, align 4
  %columns.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 715565170, i32* %canary
  %array2D.addr = alloca i64***, align 8
  %rows.addr = alloca i32, align 4
  store i64*** %array2D, i64**** %array2D.addr, align 8
  store i32 %rows, i32* %rows.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_top_bot_planes.51(i16** %imgTopField, i16** %imgBotField) #0 {
entry:
  %imgTopField.addr = alloca i16**, align 8
  %canary = alloca i32
  store i32 2106079637, i32* %canary
  %imgBotField.addr = alloca i16**, align 8
  store i16** %imgTopField, i16*** %imgTopField.addr, align 8
  store i16** %imgBotField, i16*** %imgBotField.addr, align 8
  %0 = load i16**, i16*** %imgTopField.addr, align 8
...
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 762849057, i32* %canary
  %array3D.addr = alloca i64***, align 8
  %frames.addr = alloca i32, align 4
  store i64*** %array3D, i64**** %array3D.addr, align 8
  store i32 %frames, i32* %frames.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem2D.53(i8*** %array2D, i32 %rows, i32 %columns) #0 {
entry:
  %rows.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1760122388, i32* %canary
  %array2D.addr = alloca i8***, align 8
  %i = alloca i32, align 4
  %columns.addr = alloca i32, align 4
  store i8*** %array2D, i8**** %array2D.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1810675860, i32* %canary
  %i = alloca i32, align 4
  %columns.addr = alloca i32, align 4
  %array2D.addr = alloca i32***, align 8
  %rows.addr = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1115938047, i32* %canary
  %frames.addr = alloca i32, align 4
  %array3D.addr = alloca i64***, align 8
  %i = alloca i32, align 4
  store i64*** %array3D, i64**** %array3D.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem3Dpel.56(i16**** %array3D, i32 %frames, i32 %rows, i32 %columns) #0 {
entry:
  %array3D.addr = alloca i16****, align 8
  %rows.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 130487660, i32* %canary
  %frames.addr = alloca i32, align 4
  %j = alloca i32, align 4
  %columns.addr = alloca i32, align 4
  store i16**** %array3D, i16***** %array3D.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_mem4Dint.57(i32**** %array4D, i32 %idx, i32 %frames) #0 {
entry:
  %array4D.addr = alloca i32****, align 8
  %idx.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1460471508, i32* %canary
  %frames.addr = alloca i32, align 4
  %j = alloca i32, align 4
  store i32**** %array4D, i32***** %array4D.addr, align 8
  store i32 %idx, i32* %idx.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem3Dint.58(i32**** %array3D, i32 %frames, i32 %rows, i32 %columns) #0 {
entry:
  %canary = alloca i32
  store i32 797805344, i32* %canary
  %columns.addr = alloca i32, align 4
  %array3D.addr = alloca i32****, align 8
  %frames.addr = alloca i32, align 4
  %j = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem3Dshort.59(i16**** %array3D, i32 %frames, i32 %rows, i32 %columns) #0 {
entry:
  %rows.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 239513693, i32* %canary
  %columns.addr = alloca i32, align 4
  %frames.addr = alloca i32, align 4
  %array3D.addr = alloca i16****, align 8
  %j = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem2Dpel.60(i16*** %array2D, i32 %rows, i32 %columns) #0 {
entry:
  %columns.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 457099600, i32* %canary
  %i = alloca i32, align 4
  %array2D.addr = alloca i16***, align 8
  %rows.addr = alloca i32, align 4
  store i16*** %array2D, i16**** %array2D.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_mem3Dint.61(i32*** %array3D, i32 %frames) #0 {
entry:
  %canary = alloca i32
  store i32 431448042, i32* %canary
  %array3D.addr = alloca i32***, align 8
  %i = alloca i32, align 4
  %frames.addr = alloca i32, align 4
  store i32*** %array3D, i32**** %array3D.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem4Dshort.62(i16***** %array4D, i32 %idx, i32 %frames, i32 %rows, i32 %columns) #0 {
entry:
  %frames.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1942757638, i32* %canary
  %array4D.addr = alloca i16*****, align 8
  %rows.addr = alloca i32, align 4
  %j = alloca i32, align 4
  %idx.addr = alloca i32, align 4
...
entry:
  ...
  %rows.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1355025773, i32* %canary
  %j = alloca i32, align 4
  %frames.addr = alloca i32, align 4
  store i64**** %array3D, i64***** %array3D.addr, align 8
  store i32 %frames, i32* %frames.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_mem3Dpel.64(i16*** %array3D, i32 %frames) #0 {
entry:
  %frames.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1943936815, i32* %canary
  %i = alloca i32, align 4
  %array3D.addr = alloca i16***, align 8
  store i16*** %array3D, i16**** %array3D.addr, align 8
  store i32 %frames, i32* %frames.addr, align 4
...
entry:
  ...
  %columns.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 999345593, i32* %canary
  %i = alloca i32, align 4
  %array2D.addr = alloca i16***, align 8
  store i16*** %array2D, i16**** %array2D.addr, align 8
  store i32 %rows, i32* %rows.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_mem4Dshort.66(i16**** %array4D, i32 %idx, i32 %frames) #0 {
entry:
  %frames.addr = alloca i32, align 4
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 2078313512, i32* %canary
  %array4D.addr = alloca i16****, align 8
  %idx.addr = alloca i32, align 4
  store i16**** %array4D, i16***** %array4D.addr, align 8
  store i32 %idx, i32* %idx.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem3Dshort.67(i16**** %array3D, i32 %frames, i32 %rows, i32 %columns) #0 {
entry:
  %frames.addr = alloca i32, align 4
  %j = alloca i32, align 4
  %rows.addr = alloca i32, align 4
  %columns.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1979044055, i32* %canary
  %array3D.addr = alloca i16****, align 8
  store i16**** %array3D, i16***** %array3D.addr, align 8
  store i32 %frames, i32* %frames.addr, align 4
  store i32 %rows, i32* %rows.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_mem3Dpel.68(i16*** %array3D, i32 %frames) #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1518572295, i32* %canary
  %array3D.addr = alloca i16***, align 8
  %frames.addr = alloca i32, align 4
  store i16*** %array3D, i16**** %array3D.addr, align 8
  store i32 %frames, i32* %frames.addr, align 4
...
entry:
  ...
  %frames.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 978265052, i32* %canary
  %rows.addr = alloca i32, align 4
  store i16**** %array3D, i16***** %array3D.addr, align 8
  store i32 %frames, i32* %frames.addr, align 4
  store i32 %rows, i32* %rows.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_mem4Dint.70(i32**** %array4D, i32 %idx, i32 %frames) #0 {
entry:
  %frames.addr = alloca i32, align 4
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1284089076, i32* %canary
  %idx.addr = alloca i32, align 4
  %array4D.addr = alloca i32****, align 8
  store i32**** %array4D, i32***** %array4D.addr, align 8
  store i32 %idx, i32* %idx.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_mem4Dshort.71(i16**** %array4D, i32 %idx, i32 %frames) #0 {
entry:
  %j = alloca i32, align 4
  %array4D.addr = alloca i16****, align 8
  %idx.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 740767043, i32* %canary
  %frames.addr = alloca i32, align 4
  store i16**** %array4D, i16***** %array4D.addr, align 8
  store i32 %idx, i32* %idx.addr, align 4
  store i32 %frames, i32* %frames.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_mem3Dint.72(i32*** %array3D, i32 %frames) #0 {
entry:
  %array3D.addr = alloca i32***, align 8
  %canary = alloca i32
  store i32 335574357, i32* %canary
  %frames.addr = alloca i32, align 4
  %i = alloca i32, align 4
  store i32*** %array3D, i32**** %array3D.addr, align 8
  store i32 %frames, i32* %frames.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem2Dshort.73(i16*** %array2D, i32 %rows, i32 %columns) #0 {
entry:
  %array2D.addr = alloca i16***, align 8
  %columns.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 296901732, i32* %canary
  %rows.addr = alloca i32, align 4
  store i16*** %array2D, i16**** %array2D.addr, align 8
  store i32 %rows, i32* %rows.addr, align 4
  store i32 %columns, i32* %columns.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem2Dint64.74(i64*** %array2D, i32 %rows, i32 %columns) #0 {
entry:
  %columns.addr = alloca i32, align 4
  %array2D.addr = alloca i64***, align 8
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1782609459, i32* %canary
  %rows.addr = alloca i32, align 4
  store i64*** %array2D, i64**** %array2D.addr, align 8
  store i32 %rows, i32* %rows.addr, align 4
  store i32 %columns, i32* %columns.addr, align 4
...
entry:
  ...
  %array2D.addr = alloca i32***, align 8
  %canary = alloca i32
  store i32 634411146, i32* %canary
  %rows.addr = alloca i32, align 4
  %i = alloca i32, align 4
  store i32*** %array2D, i32**** %array2D.addr, align 8
  store i32 %rows, i32* %rows.addr, align 4
...
entry:
  %array2D.addr = alloca i16***, align 8
  %canary = alloca i32
  store i32 2072999094, i32* %canary
  %columns.addr = alloca i32, align 4
  %rows.addr = alloca i32, align 4
  %i = alloca i32, align 4
  store i16*** %array2D, i16**** %array2D.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 948045566, i32* %canary
  %array4D.addr = alloca i16****, align 8
  %frames.addr = alloca i32, align 4
  %j = alloca i32, align 4
  %idx.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem2Dpel.78(i16*** %array2D, i32 %rows, i32 %columns) #0 {
entry:
  %array2D.addr = alloca i16***, align 8
  %rows.addr = alloca i32, align 4
  %columns.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1845378996, i32* %canary
  %i = alloca i32, align 4
  store i16*** %array2D, i16**** %array2D.addr, align 8
  store i32 %rows, i32* %rows.addr, align 4
  store i32 %columns, i32* %columns.addr, align 4
...
entry:
  ...
  %array2D.addr = alloca i16***, align 8
  %canary = alloca i32
  store i32 2004448121, i32* %canary
  %columns.addr = alloca i32, align 4
  %i = alloca i32, align 4
  store i16*** %array2D, i16**** %array2D.addr, align 8
  store i32 %rows, i32* %rows.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_mem4Dshort.80(i16**** %array4D, i32 %idx, i32 %frames) #0 {
entry:
  %idx.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 967324749, i32* %canary
  %array4D.addr = alloca i16****, align 8
  %frames.addr = alloca i32, align 4
  %j = alloca i32, align 4
  store i16**** %array4D, i16***** %array4D.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_mem3Dint.81(i32*** %array3D, i32 %frames) #0 {
entry:
  %canary = alloca i32
  store i32 1736266713, i32* %canary
  %i = alloca i32, align 4
  %frames.addr = alloca i32, align 4
  %array3D.addr = alloca i32***, align 8
  store i32*** %array3D, i32**** %array3D.addr, align 8
...
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1789939308, i32* %canary
  %array3D.addr = alloca i32***, align 8
  %frames.addr = alloca i32, align 4
  store i32*** %array3D, i32**** %array3D.addr, align 8
  store i32 %frames, i32* %frames.addr, align 4
