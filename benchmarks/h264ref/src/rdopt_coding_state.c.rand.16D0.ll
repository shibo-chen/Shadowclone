; ModuleID = 'rdopt_coding_state.c.rand.16D0.bc'
...
func_store_coding_state.9:                        ; preds = %ctrl2
  call void @store_coding_state.9(%struct.CSobj* %cs)
  ret void
...
func_store_coding_state.17:                       ; preds = %ctrl6
  call void @store_coding_state.17(%struct.CSobj* %cs)
  ret void

func_store_coding_state.18:                       ; preds = %ctrl7
  call void @store_coding_state.18(%struct.CSobj* %cs)
  ret void
...
func_store_coding_state.25:                       ; preds = %ctrl9
  call void @store_coding_state.25(%struct.CSobj* %cs)
  ret void

func_store_coding_state.28:                       ; preds = %ctrl10
  call void @store_coding_state.28(%struct.CSobj* %cs)
  ret void

func_store_coding_state.29:                       ; preds = %ctrl11
  call void @store_coding_state.29(%struct.CSobj* %cs)
  ret void
...
ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_store_coding_state.9, label %ctrl3
...
ctrl6:                                            ; preds = %ctrl5
  %8 = icmp eq i32 %0, 7
  br i1 %8, label %func_store_coding_state.17, label %ctrl7

ctrl7:                                            ; preds = %ctrl6
  %9 = icmp eq i32 %0, 8
  br i1 %9, label %func_store_coding_state.18, label %ctrl8
...
ctrl9:                                            ; preds = %ctrl8
  %11 = icmp eq i32 %0, 10
  br i1 %11, label %func_store_coding_state.25, label %ctrl10

ctrl10:                                           ; preds = %ctrl9
  %12 = icmp eq i32 %0, 11
  br i1 %12, label %func_store_coding_state.28, label %ctrl11

ctrl11:                                           ; preds = %ctrl10
  %13 = icmp eq i32 %0, 12
  br i1 %13, label %func_store_coding_state.29, label %ctrl12
...
func_reset_coding_state.6:                        ; preds = %ctrl1
  call void @reset_coding_state.6(%struct.CSobj* %cs)
  ret void

func_reset_coding_state.7:                        ; preds = %ctrl2
...
func_reset_coding_state.10:                       ; preds = %ctrl4
...
func_reset_coding_state.15:                       ; preds = %ctrl6
  call void @reset_coding_state.15(%struct.CSobj* %cs)
  ret void

func_reset_coding_state.16:                       ; preds = %ctrl7
...
func_reset_coding_state.22:                       ; preds = %ctrl10
  call void @reset_coding_state.22(%struct.CSobj* %cs)
  ret void

func_reset_coding_state.23:                       ; preds = %ctrl11
  call void @reset_coding_state.23(%struct.CSobj* %cs)
  ret void

func_reset_coding_state.24:                       ; preds = %ctrl12
  call void @reset_coding_state.24(%struct.CSobj* %cs)
  ret void

func_reset_coding_state.26:                       ; preds = %ctrl13
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_reset_coding_state.6, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_reset_coding_state.7, label %ctrl3
...
ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_reset_coding_state.10, label %ctrl5
...
ctrl6:                                            ; preds = %ctrl5
  %8 = icmp eq i32 %0, 7
  br i1 %8, label %func_reset_coding_state.15, label %ctrl7

ctrl7:                                            ; preds = %ctrl6
  %9 = icmp eq i32 %0, 8
  br i1 %9, label %func_reset_coding_state.16, label %ctrl8
...
ctrl10:                                           ; preds = %ctrl9
  %12 = icmp eq i32 %0, 11
  br i1 %12, label %func_reset_coding_state.22, label %ctrl11

ctrl11:                                           ; preds = %ctrl10
  %13 = icmp eq i32 %0, 12
  br i1 %13, label %func_reset_coding_state.23, label %ctrl12

ctrl12:                                           ; preds = %ctrl11
  %14 = icmp eq i32 %0, 13
  br i1 %14, label %func_reset_coding_state.24, label %ctrl13

ctrl13:                                           ; preds = %ctrl12
  %15 = icmp eq i32 %0, 14
  br i1 %15, label %func_reset_coding_state.26, label %func_reset_coding_state.27
}
...
entry:
  ...
  %canary = alloca i32
  store i32 903450044, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 2057907778, i32* %canary
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %cs.addr = alloca %struct.CSobj*, align 8
  %bs_src = alloca %struct.Bitstream*, align 8
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
...
entry:
  ...
  %bs_src = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 389137167, i32* %canary
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %bs_dest = alloca %struct.Bitstream*, align 8
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
...
entry:
  %canary = alloca i32
  store i32 234657321, i32* %canary
  %i = alloca i32, align 4
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %currMB = alloca %struct.macroblock*, align 8
  %bs_dest = alloca %struct.Bitstream*, align 8
...
entry:
  ...
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %canary = alloca i32
  store i32 291773432, i32* %canary
  %bs_src = alloca %struct.Bitstream*, align 8
  %bs_dest = alloca %struct.Bitstream*, align 8
  %cs.addr = alloca %struct.CSobj*, align 8
  store %struct.CSobj* %cs, %struct.CSobj** %cs.addr, align 8
...
entry:
  ...
  %currMB = alloca %struct.macroblock*, align 8
  %canary = alloca i32
  store i32 277231526, i32* %canary
  %bs_dest = alloca %struct.Bitstream*, align 8
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %bs_src = alloca %struct.Bitstream*, align 8
...
entry:
  ...
  %currMB = alloca %struct.macroblock*, align 8
  %canary = alloca i32
  store i32 1884144127, i32* %canary
  %bs_dest = alloca %struct.Bitstream*, align 8
  %i = alloca i32, align 4
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
...
entry:
  ...
  %bs_src = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 526892793, i32* %canary
  %bs_dest = alloca %struct.Bitstream*, align 8
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %cs.addr = alloca %struct.CSobj*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @store_coding_state.9(%struct.CSobj* %cs) #0 {
entry:
  %bs_src = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 1463049702, i32* %canary
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %bs_dest = alloca %struct.Bitstream*, align 8
  %i = alloca i32, align 4
  %currMB = alloca %struct.macroblock*, align 8
...
entry:
  ...
  %currMB = alloca %struct.macroblock*, align 8
  %canary = alloca i32
  store i32 612325477, i32* %canary
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %cs.addr = alloca %struct.CSobj*, align 8
  store %struct.CSobj* %cs, %struct.CSobj** %cs.addr, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
entry:
  ...
  %bs_src = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 838842842, i32* %canary
  %i = alloca i32, align 4
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
...
entry:
  ...
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 1886117179, i32* %canary
  %bs_dest = alloca %struct.Bitstream*, align 8
  %i = alloca i32, align 4
  %bs_src = alloca %struct.Bitstream*, align 8
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
...
entry:
  ...
  %currMB = alloca %struct.macroblock*, align 8
  %canary = alloca i32
  store i32 1317929989, i32* %canary
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
...
entry:
  ...
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %canary = alloca i32
  store i32 1233144160, i32* %canary
  %currMB = alloca %struct.macroblock*, align 8
  %bs_dest = alloca %struct.Bitstream*, align 8
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %cs.addr = alloca %struct.CSobj*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @reset_coding_state.15(%struct.CSobj* %cs) #0 {
entry:
  %canary = alloca i32
  store i32 583949353, i32* %canary
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %i = alloca i32, align 4
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
...
entry:
  ...
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 1401545596, i32* %canary
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %i = alloca i32, align 4
  store %struct.CSobj* %cs, %struct.CSobj** %cs.addr, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @store_coding_state.18(%struct.CSobj* %cs) #0 {
entry:
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 2111345116, i32* %canary
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %bs_dest = alloca %struct.Bitstream*, align 8
  %currMB = alloca %struct.macroblock*, align 8
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
...
entry:
  ...
  %currMB = alloca %struct.macroblock*, align 8
  %canary = alloca i32
  store i32 945100754, i32* %canary
  %i = alloca i32, align 4
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %cs.addr = alloca %struct.CSobj*, align 8
  %bs_dest = alloca %struct.Bitstream*, align 8
...
entry:
  %canary = alloca i32
  store i32 432118697, i32* %canary
  %bs_dest = alloca %struct.Bitstream*, align 8
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %i = alloca i32, align 4
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
...
entry:
  ...
  %bs_src = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 2133646657, i32* %canary
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  store %struct.CSobj* %cs, %struct.CSobj** %cs.addr, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %currentSlice = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 50
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @reset_coding_state.22(%struct.CSobj* %cs) #0 {
entry:
  %canary = alloca i32
  store i32 1405770620, i32* %canary
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %bs_dest = alloca %struct.Bitstream*, align 8
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @reset_coding_state.23(%struct.CSobj* %cs) #0 {
entry:
  %bs_dest = alloca %struct.Bitstream*, align 8
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %cs.addr = alloca %struct.CSobj*, align 8
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %canary = alloca i32
  store i32 526561182, i32* %canary
  %bs_src = alloca %struct.Bitstream*, align 8
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %i = alloca i32, align 4
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
...
entry:
  ...
  %bs_src = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 980663054, i32* %canary
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %cs.addr = alloca %struct.CSobj*, align 8
  %i = alloca i32, align 4
  %currMB = alloca %struct.macroblock*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @store_coding_state.25(%struct.CSobj* %cs) #0 {
entry:
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %canary = alloca i32
  store i32 550158552, i32* %canary
  %bs_src = alloca %struct.Bitstream*, align 8
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %cs.addr = alloca %struct.CSobj*, align 8
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
...
entry:
  ...
  %cs.addr = alloca %struct.CSobj*, align 8
  %canary = alloca i32
  store i32 382187403, i32* %canary
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %i = alloca i32, align 4
  %currMB = alloca %struct.macroblock*, align 8
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
...
entry:
  ...
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %canary = alloca i32
  store i32 982320255, i32* %canary
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %bs_dest = alloca %struct.Bitstream*, align 8
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %cs.addr = alloca %struct.CSobj*, align 8
...
entry:
  ...
  %cs.addr = alloca %struct.CSobj*, align 8
  %canary = alloca i32
  store i32 1216633276, i32* %canary
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %bs_dest = alloca %struct.Bitstream*, align 8
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @store_coding_state.29(%struct.CSobj* %cs) #0 {
entry:
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 2030008076, i32* %canary
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %currMB = alloca %struct.macroblock*, align 8
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
...
entry:
  ...
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %canary = alloca i32
  store i32 681572813, i32* %canary
  %bs_dest = alloca %struct.Bitstream*, align 8
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  store %struct.CSobj* %cs, %struct.CSobj** %cs.addr, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
entry:
  ...
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 1586344399, i32* %canary
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %bs_dest = alloca %struct.Bitstream*, align 8
  store %struct.CSobj* %cs, %struct.CSobj** %cs.addr, align 8
...
entry:
  ...
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %canary = alloca i32
  store i32 667320724, i32* %canary
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %cs.addr = alloca %struct.CSobj*, align 8
  %i = alloca i32, align 4
