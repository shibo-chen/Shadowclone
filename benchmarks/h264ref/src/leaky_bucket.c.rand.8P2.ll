; ModuleID = 'leaky_bucket.c.rand.8P2.bc'
...
func_get_LeakyBucketRate.17:                      ; preds = %ctrl0
  %3 = call i32 @get_LeakyBucketRate.17(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret i32 %3
...
func_get_LeakyBucketRate.29:                      ; preds = %ctrl2
  %5 = call i32 @get_LeakyBucketRate.29(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret i32 %5

func_get_LeakyBucketRate.30:                      ; preds = %ctrl3
  %6 = call i32 @get_LeakyBucketRate.30(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret i32 %6

func_get_LeakyBucketRate.31:                      ; preds = %ctrl4
  %7 = call i32 @get_LeakyBucketRate.31(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret i32 %7

func_get_LeakyBucketRate.32:                      ; preds = %ctrl5
  %8 = call i32 @get_LeakyBucketRate.32(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret i32 %8

func_get_LeakyBucketRate.33:                      ; preds = %ctrl5
  %9 = call i32 @get_LeakyBucketRate.33(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret i32 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_get_LeakyBucketRate.17, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_get_LeakyBucketRate.20, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_get_LeakyBucketRate.29, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_get_LeakyBucketRate.30, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_get_LeakyBucketRate.31, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_get_LeakyBucketRate.32, label %func_get_LeakyBucketRate.33
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_PutBigDoubleWord.4, label %func_PutBigDoubleWord.5

func_PutBigDoubleWord.4:                          ; preds = %rand_bb
  call void @PutBigDoubleWord.4(i64 %dw, %struct._IO_FILE* %fp)
  ret void

func_PutBigDoubleWord.5:                          ; preds = %rand_bb
  call void @PutBigDoubleWord.5(i64 %dw, %struct._IO_FILE* %fp)
  ret void
}
...
func_write_buffer.14:                             ; preds = %ctrl0
...
func_write_buffer.24:                             ; preds = %ctrl3
  call void @write_buffer.24(i64 %NumberLeakyBuckets, i64* %Rmin, i64* %Bmin, i64* %Fmin)
  ret void

func_write_buffer.27:                             ; preds = %ctrl4
  call void @write_buffer.27(i64 %NumberLeakyBuckets, i64* %Rmin, i64* %Bmin, i64* %Fmin)
  ret void

func_write_buffer.28:                             ; preds = %ctrl5
  call void @write_buffer.28(i64 %NumberLeakyBuckets, i64* %Rmin, i64* %Bmin, i64* %Fmin)
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_write_buffer.14, label %ctrl1
...
ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_write_buffer.24, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_write_buffer.27, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_write_buffer.28, label %func_write_buffer.34
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_Sort.7, label %ctrl0

func_Sort.7:                                      ; preds = %rand_bb
  call void @Sort.7(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret void

func_Sort.9:                                      ; preds = %ctrl0
  call void @Sort.9(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret void
...
ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_Sort.13, label %ctrl3
...
ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_Sort.22, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_Sort.25, label %func_Sort.26
}
...
func_calc_buffer.8:                               ; preds = %ctrl1
...
func_calc_buffer.12:                              ; preds = %ctrl3
  call void @calc_buffer.12()
  ret void

func_calc_buffer.15:                              ; preds = %ctrl4
  call void @calc_buffer.15()
  ret void

func_calc_buffer.18:                              ; preds = %ctrl5
  call void @calc_buffer.18()
  ret void

func_calc_buffer.23:                              ; preds = %ctrl5
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_calc_buffer.8, label %ctrl2
...
ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_calc_buffer.12, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_calc_buffer.15, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_calc_buffer.18, label %func_calc_buffer.23
}
...
entry:
  ...
  %canary = alloca i32
  store i32 441979905, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1469041544, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1549316071, i32* %canary
  %iBucket = alloca i64, align 8
...
for.end136:                                       ; preds = %for.cond57
  ...
  %150 = icmp eq i32 %149, 1549316071
...
entry:
  %canary = alloca i32
  store i32 899951128, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @PutBigDoubleWord.5(i64 %dw, %struct._IO_FILE* %fp) #0 {
entry:
  %canary = alloca i32
  store i32 1858921409, i32* %canary
  %dw.addr = alloca i64, align 8
  %fp.addr = alloca %struct._IO_FILE*, align 8
  store i64 %dw, i64* %dw.addr, align 8
  store %struct._IO_FILE* %fp, %struct._IO_FILE** %fp.addr, align 8
...
entry:
  ...
  %buffer_frame = alloca i64*, align 8
  %canary = alloca i32
  store i32 588763140, i32* %canary
  %maxBuffer = alloca i64, align 8
  %iBucket = alloca i64, align 8
  store i64 0, i64* %FrameIndex, align 8
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Sort.7(i64 %NumberLeakyBuckets, i64* %Rmin) #0 {
entry:
  %temp = alloca i64, align 8
  %Rmin.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 645243128, i32* %canary
  %i = alloca i64, align 8
...
entry:
  ...
  %TotalRate = alloca i64, align 8
  %canary = alloca i32
  store i32 282593371, i32* %canary
  %Bmin = alloca i64*, align 8
  store i64 0, i64* %FrameIndex, align 8
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8
  %call = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %0, i8* getelementptr inbounds ([81 x i8], [81 x i8]* @.str.8, i64 0, i64 0))
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Sort.9(i64 %NumberLeakyBuckets, i64* %Rmin) #0 {
entry:
  %canary = alloca i32
  store i32 1102588715, i32* %canary
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %i = alloca i64, align 8
  %temp = alloca i64, align 8
  %j = alloca i64, align 8
...
entry:
  ...
  %maxBuffer = alloca i64, align 8
  %canary = alloca i32
  store i32 2016321488, i32* %canary
  %Fmin = alloca i64*, align 8
  %FrameIndex = alloca i64, align 8
  %Bmin = alloca i64*, align 8
  store i64 0, i64* %FrameIndex, align 8
...
for.end136:                                       ; preds = %for.cond57
  ...
  call void @free(i8* %148) #3
  %149 = load i32, i32* %canary
  %150 = icmp eq i32 %149, 2016321488
  br i1 %150, label %151, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @calc_buffer.12() #0 {
entry:
  %Bmin = alloca i64*, align 8
  %FrameIndex = alloca i64, align 8
  %AvgRate = alloca i64, align 8
  ...
  %minB = alloca i64, align 8
  %canary = alloca i32
  store i32 859079376, i32* %canary
  %TotalRate = alloca i64, align 8
  %Rmin = alloca i64*, align 8
  %iBucket = alloca i64, align 8
  %actualBuffer = alloca i64, align 8
...
entry:
  ...
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1428455868, i32* %canary
  %temp = alloca i64, align 8
  %j = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
...
entry:
  ...
  %Bmin.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 1293241348, i32* %canary
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %Rmin.addr = alloca i64*, align 8
  %outf = alloca %struct._IO_FILE*, align 8
  %Fmin.addr = alloca i64*, align 8
...
entry:
  ...
  %Fmin = alloca i64*, align 8
  %canary = alloca i32
  store i32 1005228903, i32* %canary
  %maxBuffer = alloca i64, align 8
  %actualBuffer = alloca i64, align 8
  %Rmin = alloca i64*, align 8
  %AvgRate = alloca i64, align 8
...
for.end136:                                       ; preds = %for.cond57
  ...
  call void @free(i8* %148) #3
  %149 = load i32, i32* %canary
  %150 = icmp eq i32 %149, 1005228903
  br i1 %150, label %151, label %func_exit
...
entry:
  %canary = alloca i32
  store i32 1521087396, i32* %canary
  %iBucket = alloca i64, align 8
  %outf = alloca %struct._IO_FILE*, align 8
  %Rmin.addr = alloca i64*, align 8
  %Bmin.addr = alloca i64*, align 8
...
entry:
  %canary = alloca i32
  store i32 855385146, i32* %canary
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %buf = alloca i64, align 8
  %Rmin.addr = alloca i64*, align 8
  %i = alloca i64, align 8
...
entry:
  ...
  %buffer_frame = alloca i64*, align 8
  %canary = alloca i32
  store i32 1491623819, i32* %canary
  %Fmin = alloca i64*, align 8
  %AvgRate = alloca i64, align 8
  %TotalRate = alloca i64, align 8
  %Rmin = alloca i64*, align 8
...
for.end136:                                       ; preds = %for.cond57
  ...
  call void @free(i8* %148) #3
  %149 = load i32, i32* %canary
  %150 = icmp eq i32 %149, 1491623819
  br i1 %150, label %151, label %func_exit
...
entry:
  ...
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 491017962, i32* %canary
  %outf = alloca %struct._IO_FILE*, align 8
  %iBucket = alloca i64, align 8
  %Bmin.addr = alloca i64*, align 8
  %Rmin.addr = alloca i64*, align 8
...
entry:
  %canary = alloca i32
  store i32 833496807, i32* %canary
  %f = alloca %struct._IO_FILE*, align 8
  %buf = alloca i64, align 8
  %retval = alloca i32, align 4
  %i = alloca i64, align 8
...
entry:
  ...
  %Rmin.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 1174736412, i32* %canary
  %NumberLeakyBuckets.addr = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
  store i64 0, i64* %i, align 8
...
entry:
  %canary = alloca i32
  store i32 902282827, i32* %canary
  %Rmin.addr = alloca i64*, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %temp = alloca i64, align 8
  %i = alloca i64, align 8
...
entry:
  ...
  %Fmin = alloca i64*, align 8
  %canary = alloca i32
  store i32 1368524357, i32* %canary
  %Rmin = alloca i64*, align 8
  %InitFullness = alloca i64, align 8
  %FrameIndex = alloca i64, align 8
  %buffer_frame = alloca i64*, align 8
...
for.end136:                                       ; preds = %for.cond57
  ...
  call void @free(i8* %148) #3
  %149 = load i32, i32* %canary
  %150 = icmp eq i32 %149, 1368524357
  br i1 %150, label %151, label %func_exit
...
entry:
  ...
  %Fmin.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 1550950448, i32* %canary
  %outf = alloca %struct._IO_FILE*, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
  store i64* %Bmin, i64** %Bmin.addr, align 8
...
entry:
  ...
  %j = alloca i64, align 8
  %canary = alloca i32
  store i32 1745530264, i32* %canary
  %i = alloca i64, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %Rmin.addr = alloca i64*, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1302593311, i32* %canary
  %temp = alloca i64, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %j = alloca i64, align 8
  %Rmin.addr = alloca i64*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_buffer.27(i64 %NumberLeakyBuckets, i64* %Rmin, i64* %Bmin, i64* %Fmin) #0 {
entry:
  %iBucket = alloca i64, align 8
  %outf = alloca %struct._IO_FILE*, align 8
  %Fmin.addr = alloca i64*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_buffer.28(i64 %NumberLeakyBuckets, i64* %Rmin, i64* %Bmin, i64* %Fmin) #0 {
entry:
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %Bmin.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 342946619, i32* %canary
  %Rmin.addr = alloca i64*, align 8
  %outf = alloca %struct._IO_FILE*, align 8
  %Fmin.addr = alloca i64*, align 8
  %iBucket = alloca i64, align 8
...
entry:
  ...
  %f = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 499655277, i32* %canary
  %retval = alloca i32, align 4
  %buf = alloca i64, align 8
  %Rmin.addr = alloca i64*, align 8
  %i = alloca i64, align 8
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1009149065, i32* %canary
  %buf = alloca i64, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %f = alloca %struct._IO_FILE*, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 925761085, i32* %canary
  %f = alloca %struct._IO_FILE*, align 8
  %Rmin.addr = alloca i64*, align 8
  %i = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
...
entry:
  ...
  %f = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 115272157, i32* %canary
  %Rmin.addr = alloca i64*, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
