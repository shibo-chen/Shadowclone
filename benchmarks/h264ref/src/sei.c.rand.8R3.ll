...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_write_sei_message.6, label %ctrl0

func_write_sei_message.6:                         ; preds = %rand_bb
  call void @write_sei_message.6(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type)
  ret void

func_write_sei_message.29:                        ; preds = %ctrl0
  call void @write_sei_message.29(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type)
  ret void

func_write_sei_message.40:                        ; preds = %ctrl1
  call void @write_sei_message.40(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type)
  ret void

func_write_sei_message.62:                        ; preds = %ctrl2
  call void @write_sei_message.62(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type)
  ret void

func_write_sei_message.82:                        ; preds = %ctrl3
  call void @write_sei_message.82(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type)
  ret void

func_write_sei_message.89:                        ; preds = %ctrl4
  call void @write_sei_message.89(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type)
  ret void

func_write_sei_message.95:                        ; preds = %ctrl5
  call void @write_sei_message.95(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type)
  ret void

func_write_sei_message.96:                        ; preds = %ctrl5
  call void @write_sei_message.96(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_write_sei_message.29, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_write_sei_message.40, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_write_sei_message.62, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_write_sei_message.82, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_write_sei_message.89, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_write_sei_message.95, label %func_write_sei_message.96
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_finalize_sei_message.2, label %func_finalize_sei_message.5

func_finalize_sei_message.2:                      ; preds = %rand_bb
  call void @finalize_sei_message.2(i32 %id)
  ret void

func_finalize_sei_message.5:                      ; preds = %rand_bb
  call void @finalize_sei_message.5(i32 %id)
  ret void
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_AppendTmpbits2Buf.1, label %ctrl0

func_AppendTmpbits2Buf.1:                         ; preds = %rand_bb
  call void @AppendTmpbits2Buf.1(%struct.Bitstream* %dest, %struct.Bitstream* %source)
  ret void

func_AppendTmpbits2Buf.3:                         ; preds = %ctrl0
  call void @AppendTmpbits2Buf.3(%struct.Bitstream* %dest, %struct.Bitstream* %source)
  ret void

func_AppendTmpbits2Buf.23:                        ; preds = %ctrl1
  call void @AppendTmpbits2Buf.23(%struct.Bitstream* %dest, %struct.Bitstream* %source)
  ret void

func_AppendTmpbits2Buf.27:                        ; preds = %ctrl2
  call void @AppendTmpbits2Buf.27(%struct.Bitstream* %dest, %struct.Bitstream* %source)
  ret void

func_AppendTmpbits2Buf.38:                        ; preds = %ctrl3
  call void @AppendTmpbits2Buf.38(%struct.Bitstream* %dest, %struct.Bitstream* %source)
  ret void

func_AppendTmpbits2Buf.39:                        ; preds = %ctrl4
  call void @AppendTmpbits2Buf.39(%struct.Bitstream* %dest, %struct.Bitstream* %source)
  ret void

func_AppendTmpbits2Buf.46:                        ; preds = %ctrl5
  call void @AppendTmpbits2Buf.46(%struct.Bitstream* %dest, %struct.Bitstream* %source)
  ret void

func_AppendTmpbits2Buf.67:                        ; preds = %ctrl5
  call void @AppendTmpbits2Buf.67(%struct.Bitstream* %dest, %struct.Bitstream* %source)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_AppendTmpbits2Buf.3, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_AppendTmpbits2Buf.23, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_AppendTmpbits2Buf.27, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_AppendTmpbits2Buf.38, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_AppendTmpbits2Buf.39, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_AppendTmpbits2Buf.46, label %func_AppendTmpbits2Buf.67
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_ComposeSparePictureMessage.37, label %ctrl0

func_ComposeSparePictureMessage.37:               ; preds = %rand_bb
  call void @ComposeSparePictureMessage.37(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream)
  ret void

func_ComposeSparePictureMessage.48:               ; preds = %ctrl0
  call void @ComposeSparePictureMessage.48(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream)
  ret void

func_ComposeSparePictureMessage.58:               ; preds = %ctrl1
  call void @ComposeSparePictureMessage.58(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream)
  ret void

func_ComposeSparePictureMessage.63:               ; preds = %ctrl2
  call void @ComposeSparePictureMessage.63(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream)
  ret void

func_ComposeSparePictureMessage.69:               ; preds = %ctrl3
  call void @ComposeSparePictureMessage.69(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream)
  ret void

func_ComposeSparePictureMessage.71:               ; preds = %ctrl4
  call void @ComposeSparePictureMessage.71(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream)
  ret void

func_ComposeSparePictureMessage.76:               ; preds = %ctrl5
  call void @ComposeSparePictureMessage.76(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream)
  ret void

func_ComposeSparePictureMessage.80:               ; preds = %ctrl5
  call void @ComposeSparePictureMessage.80(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_ComposeSparePictureMessage.48, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_ComposeSparePictureMessage.58, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_ComposeSparePictureMessage.63, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_ComposeSparePictureMessage.69, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_ComposeSparePictureMessage.71, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_ComposeSparePictureMessage.76, label %func_ComposeSparePictureMessage.80
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_CompressSpareMBMap.11, label %ctrl0

func_CompressSpareMBMap.11:                       ; preds = %rand_bb
  %2 = call i32 @CompressSpareMBMap.11(i8** %map_sp, %struct.Bitstream* %bitstream)
  ret i32 %2

func_CompressSpareMBMap.31:                       ; preds = %ctrl0
  %3 = call i32 @CompressSpareMBMap.31(i8** %map_sp, %struct.Bitstream* %bitstream)
  ret i32 %3

func_CompressSpareMBMap.33:                       ; preds = %ctrl1
  %4 = call i32 @CompressSpareMBMap.33(i8** %map_sp, %struct.Bitstream* %bitstream)
  ret i32 %4

func_CompressSpareMBMap.34:                       ; preds = %ctrl2
  %5 = call i32 @CompressSpareMBMap.34(i8** %map_sp, %struct.Bitstream* %bitstream)
  ret i32 %5

func_CompressSpareMBMap.41:                       ; preds = %ctrl3
  %6 = call i32 @CompressSpareMBMap.41(i8** %map_sp, %struct.Bitstream* %bitstream)
  ret i32 %6

func_CompressSpareMBMap.43:                       ; preds = %ctrl4
  %7 = call i32 @CompressSpareMBMap.43(i8** %map_sp, %struct.Bitstream* %bitstream)
  ret i32 %7

func_CompressSpareMBMap.54:                       ; preds = %ctrl5
  %8 = call i32 @CompressSpareMBMap.54(i8** %map_sp, %struct.Bitstream* %bitstream)
  ret i32 %8

func_CompressSpareMBMap.83:                       ; preds = %ctrl5
  %9 = call i32 @CompressSpareMBMap.83(i8** %map_sp, %struct.Bitstream* %bitstream)
  ret i32 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_CompressSpareMBMap.31, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_CompressSpareMBMap.33, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_CompressSpareMBMap.34, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_CompressSpareMBMap.41, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_CompressSpareMBMap.43, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_CompressSpareMBMap.54, label %func_CompressSpareMBMap.83
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FinalizeSpareMBMap.14, label %ctrl0

func_FinalizeSpareMBMap.14:                       ; preds = %rand_bb
  call void @FinalizeSpareMBMap.14()
  ret void

func_FinalizeSpareMBMap.19:                       ; preds = %ctrl0
  call void @FinalizeSpareMBMap.19()
  ret void

func_FinalizeSpareMBMap.24:                       ; preds = %ctrl1
  call void @FinalizeSpareMBMap.24()
  ret void

func_FinalizeSpareMBMap.45:                       ; preds = %ctrl2
  call void @FinalizeSpareMBMap.45()
  ret void

func_FinalizeSpareMBMap.81:                       ; preds = %ctrl3
  call void @FinalizeSpareMBMap.81()
  ret void

func_FinalizeSpareMBMap.91:                       ; preds = %ctrl4
  call void @FinalizeSpareMBMap.91()
  ret void

func_FinalizeSpareMBMap.93:                       ; preds = %ctrl5
  call void @FinalizeSpareMBMap.93()
  ret void

func_FinalizeSpareMBMap.94:                       ; preds = %ctrl5
  call void @FinalizeSpareMBMap.94()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_FinalizeSpareMBMap.19, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_FinalizeSpareMBMap.24, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_FinalizeSpareMBMap.45, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_FinalizeSpareMBMap.81, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_FinalizeSpareMBMap.91, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_FinalizeSpareMBMap.93, label %func_FinalizeSpareMBMap.94
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FinalizeSubseqInfo.21, label %ctrl0

func_FinalizeSubseqInfo.21:                       ; preds = %rand_bb
  call void @FinalizeSubseqInfo.21(i32 %currLayer)
  ret void

func_FinalizeSubseqInfo.32:                       ; preds = %ctrl0
  call void @FinalizeSubseqInfo.32(i32 %currLayer)
  ret void
...
func_FinalizeSubseqInfo.52:                       ; preds = %ctrl2
  call void @FinalizeSubseqInfo.52(i32 %currLayer)
  ret void

func_FinalizeSubseqInfo.65:                       ; preds = %ctrl3
  call void @FinalizeSubseqInfo.65(i32 %currLayer)
  ret void

func_FinalizeSubseqInfo.66:                       ; preds = %ctrl3
  call void @FinalizeSubseqInfo.66(i32 %currLayer)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_FinalizeSubseqInfo.32, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_FinalizeSubseqInfo.44, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_FinalizeSubseqInfo.52, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_FinalizeSubseqInfo.65, label %func_FinalizeSubseqInfo.66
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FinalizeSubseqLayerInfo.8, label %func_FinalizeSubseqLayerInfo.20

func_FinalizeSubseqLayerInfo.8:                   ; preds = %rand_bb
  call void @FinalizeSubseqLayerInfo.8()
  ret void

func_FinalizeSubseqLayerInfo.20:                  ; preds = %rand_bb
  call void @FinalizeSubseqLayerInfo.20()
  ret void
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FinalizeSubseqChar.9, label %ctrl0

func_FinalizeSubseqChar.9:                        ; preds = %rand_bb
  call void @FinalizeSubseqChar.9()
  ret void

func_FinalizeSubseqChar.16:                       ; preds = %ctrl0
  call void @FinalizeSubseqChar.16()
  ret void

func_FinalizeSubseqChar.18:                       ; preds = %ctrl1
  call void @FinalizeSubseqChar.18()
  ret void

func_FinalizeSubseqChar.55:                       ; preds = %ctrl2
  call void @FinalizeSubseqChar.55()
  ret void

func_FinalizeSubseqChar.70:                       ; preds = %ctrl3
  call void @FinalizeSubseqChar.70()
  ret void

func_FinalizeSubseqChar.72:                       ; preds = %ctrl3
  call void @FinalizeSubseqChar.72()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_FinalizeSubseqChar.16, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_FinalizeSubseqChar.18, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_FinalizeSubseqChar.55, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_FinalizeSubseqChar.70, label %func_FinalizeSubseqChar.72
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FinalizeSceneInformation.17, label %func_FinalizeSceneInformation.49

func_FinalizeSceneInformation.17:                 ; preds = %rand_bb
  call void @FinalizeSceneInformation.17()
  ret void

func_FinalizeSceneInformation.49:                 ; preds = %rand_bb
  call void @FinalizeSceneInformation.49()
  ret void
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_UpdateSceneInformation.28, label %ctrl0

func_UpdateSceneInformation.28:                   ; preds = %rand_bb
  call void @UpdateSceneInformation.28(i32 %HasSceneInformation, i32 %sceneID, i32 %sceneTransType, i32 %secondSceneID)
  ret void

func_UpdateSceneInformation.50:                   ; preds = %ctrl0
  call void @UpdateSceneInformation.50(i32 %HasSceneInformation, i32 %sceneID, i32 %sceneTransType, i32 %secondSceneID)
  ret void

func_UpdateSceneInformation.59:                   ; preds = %ctrl1
  call void @UpdateSceneInformation.59(i32 %HasSceneInformation, i32 %sceneID, i32 %sceneTransType, i32 %secondSceneID)
  ret void

func_UpdateSceneInformation.61:                   ; preds = %ctrl2
  call void @UpdateSceneInformation.61(i32 %HasSceneInformation, i32 %sceneID, i32 %sceneTransType, i32 %secondSceneID)
  ret void

func_UpdateSceneInformation.68:                   ; preds = %ctrl3
  call void @UpdateSceneInformation.68(i32 %HasSceneInformation, i32 %sceneID, i32 %sceneTransType, i32 %secondSceneID)
  ret void

func_UpdateSceneInformation.73:                   ; preds = %ctrl4
  call void @UpdateSceneInformation.73(i32 %HasSceneInformation, i32 %sceneID, i32 %sceneTransType, i32 %secondSceneID)
  ret void

func_UpdateSceneInformation.78:                   ; preds = %ctrl5
  call void @UpdateSceneInformation.78(i32 %HasSceneInformation, i32 %sceneID, i32 %sceneTransType, i32 %secondSceneID)
  ret void

func_UpdateSceneInformation.92:                   ; preds = %ctrl5
  call void @UpdateSceneInformation.92(i32 %HasSceneInformation, i32 %sceneID, i32 %sceneTransType, i32 %secondSceneID)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_UpdateSceneInformation.50, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_UpdateSceneInformation.59, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_UpdateSceneInformation.61, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_UpdateSceneInformation.68, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_UpdateSceneInformation.73, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_UpdateSceneInformation.78, label %func_UpdateSceneInformation.92
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FinalizePanScanRectInfo.36, label %func_FinalizePanScanRectInfo.57

func_FinalizePanScanRectInfo.36:                  ; preds = %rand_bb
  call void @FinalizePanScanRectInfo.36()
  ret void

func_FinalizePanScanRectInfo.57:                  ; preds = %rand_bb
  call void @FinalizePanScanRectInfo.57()
  ret void
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_UpdateUser_data_unregistered.30, label %ctrl0

func_UpdateUser_data_unregistered.30:             ; preds = %rand_bb
  call void @UpdateUser_data_unregistered.30()
  ret void

func_UpdateUser_data_unregistered.35:             ; preds = %ctrl0
  call void @UpdateUser_data_unregistered.35()
  ret void

func_UpdateUser_data_unregistered.47:             ; preds = %ctrl1
  call void @UpdateUser_data_unregistered.47()
  ret void

func_UpdateUser_data_unregistered.64:             ; preds = %ctrl2
  call void @UpdateUser_data_unregistered.64()
  ret void

func_UpdateUser_data_unregistered.74:             ; preds = %ctrl3
  call void @UpdateUser_data_unregistered.74()
  ret void

func_UpdateUser_data_unregistered.87:             ; preds = %ctrl3
  call void @UpdateUser_data_unregistered.87()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_UpdateUser_data_unregistered.35, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_UpdateUser_data_unregistered.47, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_UpdateUser_data_unregistered.64, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_UpdateUser_data_unregistered.74, label %func_UpdateUser_data_unregistered.87
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FinalizeUser_data_unregistered.15, label %ctrl0

func_FinalizeUser_data_unregistered.15:           ; preds = %rand_bb
  call void @FinalizeUser_data_unregistered.15()
  ret void

func_FinalizeUser_data_unregistered.56:           ; preds = %ctrl0
  call void @FinalizeUser_data_unregistered.56()
  ret void

func_FinalizeUser_data_unregistered.60:           ; preds = %ctrl1
  call void @FinalizeUser_data_unregistered.60()
  ret void

func_FinalizeUser_data_unregistered.77:           ; preds = %ctrl2
  call void @FinalizeUser_data_unregistered.77()
  ret void

func_FinalizeUser_data_unregistered.84:           ; preds = %ctrl3
  call void @FinalizeUser_data_unregistered.84()
  ret void

func_FinalizeUser_data_unregistered.90:           ; preds = %ctrl3
  call void @FinalizeUser_data_unregistered.90()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_FinalizeUser_data_unregistered.56, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_FinalizeUser_data_unregistered.60, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_FinalizeUser_data_unregistered.77, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_FinalizeUser_data_unregistered.84, label %func_FinalizeUser_data_unregistered.90
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_UpdateUser_data_registered_itu_t_t35.7, label %ctrl0

func_UpdateUser_data_registered_itu_t_t35.7:      ; preds = %rand_bb
  call void @UpdateUser_data_registered_itu_t_t35.7()
  ret void

func_UpdateUser_data_registered_itu_t_t35.25:     ; preds = %ctrl0
  call void @UpdateUser_data_registered_itu_t_t35.25()
  ret void
...
func_UpdateUser_data_registered_itu_t_t35.75:     ; preds = %ctrl2
  call void @UpdateUser_data_registered_itu_t_t35.75()
  ret void

func_UpdateUser_data_registered_itu_t_t35.79:     ; preds = %ctrl3
  call void @UpdateUser_data_registered_itu_t_t35.79()
  ret void

func_UpdateUser_data_registered_itu_t_t35.85:     ; preds = %ctrl4
  call void @UpdateUser_data_registered_itu_t_t35.85()
  ret void

func_UpdateUser_data_registered_itu_t_t35.86:     ; preds = %ctrl5
  call void @UpdateUser_data_registered_itu_t_t35.86()
  ret void

func_UpdateUser_data_registered_itu_t_t35.88:     ; preds = %ctrl5
  call void @UpdateUser_data_registered_itu_t_t35.88()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_UpdateUser_data_registered_itu_t_t35.25, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_UpdateUser_data_registered_itu_t_t35.51, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_UpdateUser_data_registered_itu_t_t35.75, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_UpdateUser_data_registered_itu_t_t35.79, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_UpdateUser_data_registered_itu_t_t35.85, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_UpdateUser_data_registered_itu_t_t35.86, label %func_UpdateUser_data_registered_itu_t_t35.88
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FinalizeUser_data_registered_itu_t_t35.4, label %ctrl0

func_FinalizeUser_data_registered_itu_t_t35.4:    ; preds = %rand_bb
  call void @FinalizeUser_data_registered_itu_t_t35.4()
  ret void

func_FinalizeUser_data_registered_itu_t_t35.13:   ; preds = %ctrl0
  call void @FinalizeUser_data_registered_itu_t_t35.13()
  ret void

func_FinalizeUser_data_registered_itu_t_t35.22:   ; preds = %ctrl1
  call void @FinalizeUser_data_registered_itu_t_t35.22()
  ret void

func_FinalizeUser_data_registered_itu_t_t35.26:   ; preds = %ctrl2
  call void @FinalizeUser_data_registered_itu_t_t35.26()
  ret void

func_FinalizeUser_data_registered_itu_t_t35.42:   ; preds = %ctrl3
  call void @FinalizeUser_data_registered_itu_t_t35.42()
  ret void

func_FinalizeUser_data_registered_itu_t_t35.53:   ; preds = %ctrl3
  call void @FinalizeUser_data_registered_itu_t_t35.53()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_FinalizeUser_data_registered_itu_t_t35.13, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_FinalizeUser_data_registered_itu_t_t35.22, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_FinalizeUser_data_registered_itu_t_t35.26, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_FinalizeUser_data_registered_itu_t_t35.42, label %func_FinalizeUser_data_registered_itu_t_t35.53
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FinalizeRandomAccess.10, label %func_FinalizeRandomAccess.12

func_FinalizeRandomAccess.10:                     ; preds = %rand_bb
  call void @FinalizeRandomAccess.10()
  ret void

func_FinalizeRandomAccess.12:                     ; preds = %rand_bb
  call void @FinalizeRandomAccess.12()
  ret void
}
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @AppendTmpbits2Buf.1(%struct.Bitstream* %dest, %struct.Bitstream* %source) #0 {
entry:
  %i = alloca i32, align 4
  %source.addr = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 164703587, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @finalize_sei_message.2(i32 %id) #0 {
entry:
  %canary = alloca i32
  store i32 915194452, i32* %canary
  %id.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @AppendTmpbits2Buf.3(%struct.Bitstream* %dest, %struct.Bitstream* %source) #0 {
entry:
  %canary = alloca i32
  store i32 1136253312, i32* %canary
  %dest.addr = alloca %struct.Bitstream*, align 8
  %mask = alloca i8, align 1
  %source.addr = alloca %struct.Bitstream*, align 8
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeUser_data_registered_itu_t_t35.4() #0 {
entry:
  %sym = alloca %struct.syntaxelement, align 8
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1897461082, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @finalize_sei_message.5(i32 %id) #0 {
entry:
  %offset = alloca i32, align 4
  %canary = alloca i32
  store i32 1850458906, i32* %canary
  %id.addr = alloca i32, align 4
  store i32 %id, i32* %id.addr, align 4
  %0 = load i32, i32* %id.addr, align 4
  %idxprom = sext i32 %0 to i64
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_sei_message.6(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type) #0 {
entry:
  %canary = alloca i32
  store i32 2030795990, i32* %canary
  %offset = alloca i32, align 4
  %id.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateUser_data_registered_itu_t_t35.7() #0 {
entry:
  %temp_data = alloca i32, align 4
  %canary = alloca i32
  store i32 57057969, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSubseqLayerInfo.8() #0 {
entry:
  %canary = alloca i32
  store i32 635856872, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSubseqChar.9() #0 {
entry:
  %dest = alloca %struct.Bitstream*, align 8
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 685725292, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.subseq_char_information_struct, %struct.subseq_char_information_struct* @seiSubseqChar, i32 0, i32 10), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
  %type = getelementptr inbounds %struct.syntaxelement, %struct.syntaxelement* %sym, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeRandomAccess.10() #0 {
entry:
  %sym = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 813298506, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.randomaccess_information_struct, %struct.randomaccess_information_struct* @seiRandomAccess, i32 0, i32 3), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
  %type = getelementptr inbounds %struct.syntaxelement, %struct.syntaxelement* %sym, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @CompressSpareMBMap.11(i8** %map_sp, %struct.Bitstream* %bitstream) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 2134647827, i32* %canary
...
if.end190:                                        ; preds = %for.end189, %if.end141
  ...
  %123 = icmp eq i32 %122, 2134647827
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeRandomAccess.12() #0 {
entry:
  %canary = alloca i32
  store i32 97898763, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  %sym = alloca %struct.syntaxelement, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.randomaccess_information_struct, %struct.randomaccess_information_struct* @seiRandomAccess, i32 0, i32 3), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeUser_data_registered_itu_t_t35.13() #0 {
entry:
  %i = alloca i32, align 4
  %dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 1302725227, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_registered_itu_t_t35_information_struct, %struct.user_data_registered_itu_t_t35_information_struct* @seiUser_data_registered_itu_t_t35, i32 0, i32 4), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
  %type = getelementptr inbounds %struct.syntaxelement, %struct.syntaxelement* %sym, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSpareMBMap.14() #0 {
entry:
  %sym = alloca %struct.syntaxelement, align 8
  %CurrFrameNum = alloca i32, align 4
  %dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 826356817, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeUser_data_unregistered.15() #0 {
entry:
  %dest = alloca %struct.Bitstream*, align 8
  %sym = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 1470675568, i32* %canary
  %i = alloca i32, align 4
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_unregistered_information_struct, %struct.user_data_unregistered_information_struct* @seiUser_data_unregistered, i32 0, i32 2), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
  %type = getelementptr inbounds %struct.syntaxelement, %struct.syntaxelement* %sym, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSubseqChar.16() #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 111870988, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %dest = alloca %struct.Bitstream*, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.subseq_char_information_struct, %struct.subseq_char_information_struct* @seiSubseqChar, i32 0, i32 10), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSceneInformation.17() #0 {
entry:
  %canary = alloca i32
  store i32 932158441, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %dest = alloca %struct.Bitstream*, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.scene_information_struct, %struct.scene_information_struct* @seiSceneInformation, i32 0, i32 3), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSubseqChar.18() #0 {
entry:
  %sym = alloca %struct.syntaxelement, align 8
  %dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 471328126, i32* %canary
  %i = alloca i32, align 4
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.subseq_char_information_struct, %struct.subseq_char_information_struct* @seiSubseqChar, i32 0, i32 10), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
  %type = getelementptr inbounds %struct.syntaxelement, %struct.syntaxelement* %sym, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSpareMBMap.19() #0 {
entry:
  %canary = alloca i32
  store i32 1096628108, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  %CurrFrameNum = alloca i32, align 4
  %source = alloca %struct.Bitstream*, align 8
  %delta_frame_num = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSubseqLayerInfo.20() #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 871002668, i32* %canary
  %pos = alloca i32, align 4
  store i32 0, i32* %pos, align 4
  store i32 0, i32* getelementptr inbounds (%struct.subseq_layer_information_struct, %struct.subseq_layer_information_struct* @seiSubseqLayerInfo, i32 0, i32 4), align 4
  store i32 0, i32* %i, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSubseqInfo.21(i32 %currLayer) #0 {
entry:
  %canary = alloca i32
  store i32 1681576476, i32* %canary
  %currLayer.addr = alloca i32, align 4
  %dest = alloca %struct.Bitstream*, align 8
  %sym = alloca %struct.syntaxelement, align 8
  store i32 %currLayer, i32* %currLayer.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeUser_data_registered_itu_t_t35.22() #0 {
entry:
  %sym = alloca %struct.syntaxelement, align 8
  %dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 511966955, i32* %canary
  %i = alloca i32, align 4
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_registered_itu_t_t35_information_struct, %struct.user_data_registered_itu_t_t35_information_struct* @seiUser_data_registered_itu_t_t35, i32 0, i32 4), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
  %type = getelementptr inbounds %struct.syntaxelement, %struct.syntaxelement* %sym, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @AppendTmpbits2Buf.23(%struct.Bitstream* %dest, %struct.Bitstream* %source) #0 {
entry:
  %dest.addr = alloca %struct.Bitstream*, align 8
  %i = alloca i32, align 4
  %mask = alloca i8, align 1
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 534722046, i32* %canary
  %source.addr = alloca %struct.Bitstream*, align 8
  %bits_in_last_byte = alloca i32, align 4
  store %struct.Bitstream* %dest, %struct.Bitstream** %dest.addr, align 8
  store %struct.Bitstream* %source, %struct.Bitstream** %source.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSpareMBMap.24() #0 {
entry:
  %dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 2144545374, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %delta_frame_num = alloca i32, align 4
  %CurrFrameNum = alloca i32, align 4
  %source = alloca %struct.Bitstream*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateUser_data_registered_itu_t_t35.25() #0 {
entry:
  %country_code = alloca i32, align 4
  %temp_data = alloca i32, align 4
  %total_byte = alloca i32, align 4
  %canary = alloca i32
  store i32 418109063, i32* %canary
  %i = alloca i32, align 4
  store i32 82, i32* %country_code, align 4
  %0 = load i32, i32* %country_code, align 4
  %cmp = icmp slt i32 %0, 255
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeUser_data_registered_itu_t_t35.26() #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1623594428, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %dest = alloca %struct.Bitstream*, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_registered_itu_t_t35_information_struct, %struct.user_data_registered_itu_t_t35_information_struct* @seiUser_data_registered_itu_t_t35, i32 0, i32 4), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @AppendTmpbits2Buf.27(%struct.Bitstream* %dest, %struct.Bitstream* %source) #0 {
entry:
  %bits_in_last_byte = alloca i32, align 4
  %dest.addr = alloca %struct.Bitstream*, align 8
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1900647474, i32* %canary
  %source.addr = alloca %struct.Bitstream*, align 8
  %mask = alloca i8, align 1
  %j = alloca i32, align 4
  store %struct.Bitstream* %dest, %struct.Bitstream** %dest.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateSceneInformation.28(i32 %HasSceneInformation, i32 %sceneID, i32 %sceneTransType, i32 %secondSceneID) #0 {
entry:
  %sceneID.addr = alloca i32, align 4
  %HasSceneInformation.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 151915026, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_sei_message.29(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type) #0 {
entry:
  %payload_size.addr = alloca i32, align 4
  %payload_type.addr = alloca i32, align 4
  %size = alloca i32, align 4
  ...
  %id.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 156606925, i32* %canary
  %payload.addr = alloca i8*, align 8
  %type = alloca i32, align 4
  store i32 %id, i32* %id.addr, align 4
  store i8* %payload, i8** %payload.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateUser_data_unregistered.30() #0 {
entry:
  %temp_data = alloca i32, align 4
  %canary = alloca i32
  store i32 1708516992, i32* %canary
  %total_byte = alloca i32, align 4
  %i = alloca i32, align 4
  store i32 7, i32* %total_byte, align 4
  store i32 0, i32* %i, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @CompressSpareMBMap.31(i8** %map_sp, %struct.Bitstream* %bitstream) #0 {
entry:
  %directy = alloca i32, align 4
  %bitc = alloca i32, align 4
  %sym = alloca %struct.syntaxelement, align 8
  ...
  %k = alloca i32, align 4
  %canary = alloca i32
  store i32 1780141693, i32* %canary
  %x = alloca i32, align 4
  %map_sp.addr = alloca i8**, align 8
  %noc = alloca i32, align 4
  %y = alloca i32, align 4
...
if.end190:                                        ; preds = %for.end189, %if.end141
  %121 = load i32, i32* %ret, align 4
  %122 = load i32, i32* %canary
  %123 = icmp eq i32 %122, 1780141693
  br i1 %123, label %124, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSubseqInfo.32(i32 %currLayer) #0 {
entry:
  %canary = alloca i32
  store i32 2123583169, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %currLayer.addr = alloca i32, align 4
  %dest = alloca %struct.Bitstream*, align 8
  store i32 %currLayer, i32* %currLayer.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @CompressSpareMBMap.33(i8** %map_sp, %struct.Bitstream* %bitstream) #0 {
entry:
  %sym = alloca %struct.syntaxelement, align 8
  %directx = alloca i32, align 4
  %y = alloca i32, align 4
  ...
  %bit0 = alloca i32, align 4
  %canary = alloca i32
  store i32 1140599561, i32* %canary
  %directy = alloca i32, align 4
  %size_compressed = alloca i32, align 4
  %right = alloca i32, align 4
  %bit1 = alloca i32, align 4
...
if.end190:                                        ; preds = %for.end189, %if.end141
  %121 = load i32, i32* %ret, align 4
  %122 = load i32, i32* %canary
  %123 = icmp eq i32 %122, 1140599561
  br i1 %123, label %124, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @CompressSpareMBMap.34(i8** %map_sp, %struct.Bitstream* %bitstream) #0 {
entry:
  %size_uncompressed = alloca i32, align 4
  %top = alloca i32, align 4
  %bit1 = alloca i32, align 4
  %canary = alloca i32
  store i32 2115876276, i32* %canary
  %bit0 = alloca i32, align 4
  %k = alloca i32, align 4
  %y = alloca i32, align 4
  %directy = alloca i32, align 4
...
if.end190:                                        ; preds = %for.end189, %if.end141
  %121 = load i32, i32* %ret, align 4
  %122 = load i32, i32* %canary
  %123 = icmp eq i32 %122, 2115876276
  br i1 %123, label %124, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateUser_data_unregistered.35() #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1144608005, i32* %canary
  %total_byte = alloca i32, align 4
  %temp_data = alloca i32, align 4
  store i32 7, i32* %total_byte, align 4
  store i32 0, i32* %i, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizePanScanRectInfo.36() #0 {
entry:
  %canary = alloca i32
  store i32 967262384, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %dest = alloca %struct.Bitstream*, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.panscanrect_information_struct, %struct.panscanrect_information_struct* @seiPanScanRectInfo, i32 0, i32 5), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @ComposeSparePictureMessage.37(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream) #0 {
entry:
  %bitstream = alloca %struct.Bitstream*, align 8
  %delta_spare_frame_num.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 979158125, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @AppendTmpbits2Buf.38(%struct.Bitstream* %dest, %struct.Bitstream* %source) #0 {
entry:
  %dest.addr = alloca %struct.Bitstream*, align 8
  %mask = alloca i8, align 1
  %canary = alloca i32
  store i32 1533950330, i32* %canary
  %source.addr = alloca %struct.Bitstream*, align 8
  %bits_in_last_byte = alloca i32, align 4
  %j = alloca i32, align 4
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @AppendTmpbits2Buf.39(%struct.Bitstream* %dest, %struct.Bitstream* %source) #0 {
entry:
  %source.addr = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 668888681, i32* %canary
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %dest.addr = alloca %struct.Bitstream*, align 8
  %mask = alloca i8, align 1
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_sei_message.40(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type) #0 {
entry:
  %type = alloca i32, align 4
  %canary = alloca i32
  store i32 400173036, i32* %canary
  %size = alloca i32, align 4
  %offset = alloca i32, align 4
  %payload.addr = alloca i8*, align 8
  %payload_size.addr = alloca i32, align 4
...
entry:
  ...
  %bottom = alloca i32, align 4
  %canary = alloca i32
  store i32 356149616, i32* %canary
  %directy = alloca i32, align 4
  %j = alloca i32, align 4
  %size_uncompressed = alloca i32, align 4
  %left = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeUser_data_registered_itu_t_t35.42() #0 {
entry:
  %dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 1079620742, i32* %canary
  %i = alloca i32, align 4
  %sym = alloca %struct.syntaxelement, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_registered_itu_t_t35_information_struct, %struct.user_data_registered_itu_t_t35_information_struct* @seiUser_data_registered_itu_t_t35, i32 0, i32 4), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @CompressSpareMBMap.43(i8** %map_sp, %struct.Bitstream* %bitstream) #0 {
entry:
  %size_uncompressed = alloca i32, align 4
  %sym = alloca %struct.syntaxelement, align 8
  %y = alloca i32, align 4
  ...
  %left = alloca i32, align 4
  %canary = alloca i32
  store i32 2039784167, i32* %canary
  %right = alloca i32, align 4
  %bitc = alloca i32, align 4
  %top = alloca i32, align 4
  %directy = alloca i32, align 4
...
if.end190:                                        ; preds = %for.end189, %if.end141
  %121 = load i32, i32* %ret, align 4
  %122 = load i32, i32* %canary
  %123 = icmp eq i32 %122, 2039784167
  br i1 %123, label %124, label %func_exit
...
entry:
  ...
  %dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 1797859125, i32* %canary
  %currLayer.addr = alloca i32, align 4
  store i32 %currLayer, i32* %currLayer.addr, align 4
  %0 = load i32, i32* %currLayer.addr, align 4
  %idxprom = sext i32 %0 to i64
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSpareMBMap.45() #0 {
entry:
  %canary = alloca i32
  store i32 1569975836, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  %sym = alloca %struct.syntaxelement, align 8
  %delta_frame_num = alloca i32, align 4
  %source = alloca %struct.Bitstream*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @AppendTmpbits2Buf.46(%struct.Bitstream* %dest, %struct.Bitstream* %source) #0 {
entry:
  %bits_in_last_byte = alloca i32, align 4
  %j = alloca i32, align 4
  %dest.addr = alloca %struct.Bitstream*, align 8
  %mask = alloca i8, align 1
  %canary = alloca i32
  store i32 737275736, i32* %canary
  %source.addr = alloca %struct.Bitstream*, align 8
  %i = alloca i32, align 4
  store %struct.Bitstream* %dest, %struct.Bitstream** %dest.addr, align 8
  store %struct.Bitstream* %source, %struct.Bitstream** %source.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateUser_data_unregistered.47() #0 {
entry:
  %canary = alloca i32
  store i32 559953670, i32* %canary
  %temp_data = alloca i32, align 4
  %i = alloca i32, align 4
  %total_byte = alloca i32, align 4
  store i32 7, i32* %total_byte, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @ComposeSparePictureMessage.48(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream) #0 {
entry:
  %canary = alloca i32
  store i32 1813779675, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %delta_spare_frame_num.addr = alloca i32, align 4
  %bitstream = alloca %struct.Bitstream*, align 8
  %tmpBitstream.addr = alloca %struct.Bitstream*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSceneInformation.49() #0 {
entry:
  %dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 1069532849, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.scene_information_struct, %struct.scene_information_struct* @seiSceneInformation, i32 0, i32 3), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
  %type = getelementptr inbounds %struct.syntaxelement, %struct.syntaxelement* %sym, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateSceneInformation.50(i32 %HasSceneInformation, i32 %sceneID, i32 %sceneTransType, i32 %secondSceneID) #0 {
entry:
  %sceneTransType.addr = alloca i32, align 4
  %HasSceneInformation.addr = alloca i32, align 4
  %secondSceneID.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1795633371, i32* %canary
  %sceneID.addr = alloca i32, align 4
  store i32 %HasSceneInformation, i32* %HasSceneInformation.addr, align 4
  store i32 %sceneID, i32* %sceneID.addr, align 4
  store i32 %sceneTransType, i32* %sceneTransType.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 2017430670, i32* %canary
  %total_byte = alloca i32, align 4
  %temp_data = alloca i32, align 4
  %i = alloca i32, align 4
  %country_code = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSubseqInfo.52(i32 %currLayer) #0 {
entry:
  %currLayer.addr = alloca i32, align 4
  %sym = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 621796121, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  store i32 %currLayer, i32* %currLayer.addr, align 4
  %0 = load i32, i32* %currLayer.addr, align 4
  %idxprom = sext i32 %0 to i64
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeUser_data_registered_itu_t_t35.53() #0 {
entry:
  %dest = alloca %struct.Bitstream*, align 8
  %sym = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 329994070, i32* %canary
  %i = alloca i32, align 4
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_registered_itu_t_t35_information_struct, %struct.user_data_registered_itu_t_t35_information_struct* @seiUser_data_registered_itu_t_t35, i32 0, i32 4), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
  %type = getelementptr inbounds %struct.syntaxelement, %struct.syntaxelement* %sym, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @CompressSpareMBMap.54(i8** %map_sp, %struct.Bitstream* %bitstream) #0 {
entry:
  %top = alloca i32, align 4
  %bitstream.addr = alloca %struct.Bitstream*, align 8
  %map_sp.addr = alloca i8**, align 8
  ...
  %size_uncompressed = alloca i32, align 4
  %canary = alloca i32
  store i32 255015113, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %k = alloca i32, align 4
  %directy = alloca i32, align 4
  %bit0 = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSubseqChar.55() #0 {
entry:
  %dest = alloca %struct.Bitstream*, align 8
  %sym = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 1914072349, i32* %canary
  %i = alloca i32, align 4
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.subseq_char_information_struct, %struct.subseq_char_information_struct* @seiSubseqChar, i32 0, i32 10), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
  %type = getelementptr inbounds %struct.syntaxelement, %struct.syntaxelement* %sym, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeUser_data_unregistered.56() #0 {
entry:
  %canary = alloca i32
  store i32 608877508, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %i = alloca i32, align 4
  %dest = alloca %struct.Bitstream*, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_unregistered_information_struct, %struct.user_data_unregistered_information_struct* @seiUser_data_unregistered, i32 0, i32 2), align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizePanScanRectInfo.57() #0 {
entry:
  %dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 689274475, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.panscanrect_information_struct, %struct.panscanrect_information_struct* @seiPanScanRectInfo, i32 0, i32 5), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
  %type = getelementptr inbounds %struct.syntaxelement, %struct.syntaxelement* %sym, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @ComposeSparePictureMessage.58(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream) #0 {
entry:
  %tmpBitstream.addr = alloca %struct.Bitstream*, align 8
  %sym = alloca %struct.syntaxelement, align 8
  %bitstream = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 2076311173, i32* %canary
  %ref_area_indicator.addr = alloca i32, align 4
  %delta_spare_frame_num.addr = alloca i32, align 4
  store i32 %delta_spare_frame_num, i32* %delta_spare_frame_num.addr, align 4
  store i32 %ref_area_indicator, i32* %ref_area_indicator.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateSceneInformation.59(i32 %HasSceneInformation, i32 %sceneID, i32 %sceneTransType, i32 %secondSceneID) #0 {
entry:
  %canary = alloca i32
  store i32 2057204767, i32* %canary
  %sceneTransType.addr = alloca i32, align 4
  %secondSceneID.addr = alloca i32, align 4
  %HasSceneInformation.addr = alloca i32, align 4
  %sceneID.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeUser_data_unregistered.60() #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1730487035, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %dest = alloca %struct.Bitstream*, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_unregistered_information_struct, %struct.user_data_unregistered_information_struct* @seiUser_data_unregistered, i32 0, i32 2), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateSceneInformation.61(i32 %HasSceneInformation, i32 %sceneID, i32 %sceneTransType, i32 %secondSceneID) #0 {
entry:
  %sceneID.addr = alloca i32, align 4
  %sceneTransType.addr = alloca i32, align 4
  %secondSceneID.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1967560743, i32* %canary
  %HasSceneInformation.addr = alloca i32, align 4
  store i32 %HasSceneInformation, i32* %HasSceneInformation.addr, align 4
  store i32 %sceneID, i32* %sceneID.addr, align 4
  store i32 %sceneTransType, i32* %sceneTransType.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_sei_message.62(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type) #0 {
entry:
  %offset = alloca i32, align 4
  %size = alloca i32, align 4
  %id.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1158335444, i32* %canary
  %payload.addr = alloca i8*, align 8
  %payload_size.addr = alloca i32, align 4
  %type = alloca i32, align 4
  %payload_type.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @ComposeSparePictureMessage.63(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream) #0 {
entry:
  %bitstream = alloca %struct.Bitstream*, align 8
  %ref_area_indicator.addr = alloca i32, align 4
  %sym = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 133990918, i32* %canary
  %delta_spare_frame_num.addr = alloca i32, align 4
  %tmpBitstream.addr = alloca %struct.Bitstream*, align 8
  store i32 %delta_spare_frame_num, i32* %delta_spare_frame_num.addr, align 4
  store i32 %ref_area_indicator, i32* %ref_area_indicator.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateUser_data_unregistered.64() #0 {
entry:
  %total_byte = alloca i32, align 4
  %temp_data = alloca i32, align 4
  %canary = alloca i32
  store i32 1313963146, i32* %canary
  %i = alloca i32, align 4
  store i32 7, i32* %total_byte, align 4
  store i32 0, i32* %i, align 4
  br label %for.cond
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSubseqInfo.65(i32 %currLayer) #0 {
entry:
  %canary = alloca i32
  store i32 2069567647, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  %sym = alloca %struct.syntaxelement, align 8
  %currLayer.addr = alloca i32, align 4
  store i32 %currLayer, i32* %currLayer.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSubseqInfo.66(i32 %currLayer) #0 {
entry:
  %dest = alloca %struct.Bitstream*, align 8
  %currLayer.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 855856251, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  store i32 %currLayer, i32* %currLayer.addr, align 4
  %0 = load i32, i32* %currLayer.addr, align 4
  %idxprom = sext i32 %0 to i64
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @AppendTmpbits2Buf.67(%struct.Bitstream* %dest, %struct.Bitstream* %source) #0 {
entry:
  %bits_in_last_byte = alloca i32, align 4
  %source.addr = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 1978028314, i32* %canary
  %i = alloca i32, align 4
  %mask = alloca i8, align 1
  %j = alloca i32, align 4
  %dest.addr = alloca %struct.Bitstream*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateSceneInformation.68(i32 %HasSceneInformation, i32 %sceneID, i32 %sceneTransType, i32 %secondSceneID) #0 {
entry:
  %HasSceneInformation.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1157220777, i32* %canary
  %sceneID.addr = alloca i32, align 4
  %sceneTransType.addr = alloca i32, align 4
  %secondSceneID.addr = alloca i32, align 4
  store i32 %HasSceneInformation, i32* %HasSceneInformation.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @ComposeSparePictureMessage.69(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream) #0 {
entry:
  %ref_area_indicator.addr = alloca i32, align 4
  %tmpBitstream.addr = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 754835549, i32* %canary
  %delta_spare_frame_num.addr = alloca i32, align 4
  %sym = alloca %struct.syntaxelement, align 8
  %bitstream = alloca %struct.Bitstream*, align 8
  store i32 %delta_spare_frame_num, i32* %delta_spare_frame_num.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSubseqChar.70() #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1670821652, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  %sym = alloca %struct.syntaxelement, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.subseq_char_information_struct, %struct.subseq_char_information_struct* @seiSubseqChar, i32 0, i32 10), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @ComposeSparePictureMessage.71(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream) #0 {
entry:
  %canary = alloca i32
  store i32 1671541787, i32* %canary
  %bitstream = alloca %struct.Bitstream*, align 8
  %sym = alloca %struct.syntaxelement, align 8
  %tmpBitstream.addr = alloca %struct.Bitstream*, align 8
  %delta_spare_frame_num.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSubseqChar.72() #0 {
entry:
  %sym = alloca %struct.syntaxelement, align 8
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 856825684, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.subseq_char_information_struct, %struct.subseq_char_information_struct* @seiSubseqChar, i32 0, i32 10), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
  %type = getelementptr inbounds %struct.syntaxelement, %struct.syntaxelement* %sym, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateSceneInformation.73(i32 %HasSceneInformation, i32 %sceneID, i32 %sceneTransType, i32 %secondSceneID) #0 {
entry:
  %secondSceneID.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1539315208, i32* %canary
  %sceneID.addr = alloca i32, align 4
  %HasSceneInformation.addr = alloca i32, align 4
  %sceneTransType.addr = alloca i32, align 4
  store i32 %HasSceneInformation, i32* %HasSceneInformation.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateUser_data_unregistered.74() #0 {
entry:
  %canary = alloca i32
  store i32 2141537313, i32* %canary
  %i = alloca i32, align 4
  %temp_data = alloca i32, align 4
  %total_byte = alloca i32, align 4
  store i32 7, i32* %total_byte, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateUser_data_registered_itu_t_t35.75() #0 {
entry:
  %canary = alloca i32
  store i32 375890781, i32* %canary
  %total_byte = alloca i32, align 4
  %i = alloca i32, align 4
  %country_code = alloca i32, align 4
  %temp_data = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @ComposeSparePictureMessage.76(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream) #0 {
entry:
  %tmpBitstream.addr = alloca %struct.Bitstream*, align 8
  %ref_area_indicator.addr = alloca i32, align 4
  %delta_spare_frame_num.addr = alloca i32, align 4
  %bitstream = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 2056752008, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  store i32 %delta_spare_frame_num, i32* %delta_spare_frame_num.addr, align 4
  store i32 %ref_area_indicator, i32* %ref_area_indicator.addr, align 4
  store %struct.Bitstream* %tmpBitstream, %struct.Bitstream** %tmpBitstream.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeUser_data_unregistered.77() #0 {
entry:
  %sym = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 595192479, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  %i = alloca i32, align 4
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_unregistered_information_struct, %struct.user_data_unregistered_information_struct* @seiUser_data_unregistered, i32 0, i32 2), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateSceneInformation.78(i32 %HasSceneInformation, i32 %sceneID, i32 %sceneTransType, i32 %secondSceneID) #0 {
entry:
  %canary = alloca i32
  store i32 1687670244, i32* %canary
  %secondSceneID.addr = alloca i32, align 4
  %sceneTransType.addr = alloca i32, align 4
  %HasSceneInformation.addr = alloca i32, align 4
  %sceneID.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateUser_data_registered_itu_t_t35.79() #0 {
entry:
  %country_code = alloca i32, align 4
  %total_byte = alloca i32, align 4
  %canary = alloca i32
  store i32 97770931, i32* %canary
  %temp_data = alloca i32, align 4
  %i = alloca i32, align 4
  store i32 82, i32* %country_code, align 4
  %0 = load i32, i32* %country_code, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @ComposeSparePictureMessage.80(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream) #0 {
entry:
  %delta_spare_frame_num.addr = alloca i32, align 4
  %bitstream = alloca %struct.Bitstream*, align 8
  %ref_area_indicator.addr = alloca i32, align 4
  %sym = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 1927664311, i32* %canary
  %tmpBitstream.addr = alloca %struct.Bitstream*, align 8
  store i32 %delta_spare_frame_num, i32* %delta_spare_frame_num.addr, align 4
  store i32 %ref_area_indicator, i32* %ref_area_indicator.addr, align 4
  store %struct.Bitstream* %tmpBitstream, %struct.Bitstream** %tmpBitstream.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSpareMBMap.81() #0 {
entry:
  %CurrFrameNum = alloca i32, align 4
  %source = alloca %struct.Bitstream*, align 8
  %dest = alloca %struct.Bitstream*, align 8
  %sym = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 513518906, i32* %canary
  %delta_frame_num = alloca i32, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %number = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 0
  %1 = load i32, i32* %number, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_sei_message.82(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type) #0 {
entry:
  %payload_size.addr = alloca i32, align 4
  %id.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 564641935, i32* %canary
  %payload_type.addr = alloca i32, align 4
  %type = alloca i32, align 4
  %offset = alloca i32, align 4
  %size = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @CompressSpareMBMap.83(i8** %map_sp, %struct.Bitstream* %bitstream) #0 {
entry:
  %x = alloca i32, align 4
  %left = alloca i32, align 4
  %size_compressed = alloca i32, align 4
  %directy = alloca i32, align 4
  %canary = alloca i32
  store i32 163802063, i32* %canary
  %ret = alloca i32, align 4
  %y = alloca i32, align 4
  %k = alloca i32, align 4
  %map_sp.addr = alloca i8**, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeUser_data_unregistered.84() #0 {
entry:
  %i = alloca i32, align 4
  %dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 489909592, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_unregistered_information_struct, %struct.user_data_unregistered_information_struct* @seiUser_data_unregistered, i32 0, i32 2), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
  %type = getelementptr inbounds %struct.syntaxelement, %struct.syntaxelement* %sym, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateUser_data_registered_itu_t_t35.85() #0 {
entry:
  %temp_data = alloca i32, align 4
  %i = alloca i32, align 4
  %total_byte = alloca i32, align 4
  %canary = alloca i32
  store i32 565089051, i32* %canary
  %country_code = alloca i32, align 4
  store i32 82, i32* %country_code, align 4
  %0 = load i32, i32* %country_code, align 4
  %cmp = icmp slt i32 %0, 255
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateUser_data_registered_itu_t_t35.86() #0 {
entry:
  %total_byte = alloca i32, align 4
  %canary = alloca i32
  store i32 29500386, i32* %canary
  %temp_data = alloca i32, align 4
  %country_code = alloca i32, align 4
  %i = alloca i32, align 4
  store i32 82, i32* %country_code, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateUser_data_unregistered.87() #0 {
entry:
  %canary = alloca i32
  store i32 1603446243, i32* %canary
  %total_byte = alloca i32, align 4
  %i = alloca i32, align 4
  %temp_data = alloca i32, align 4
  store i32 7, i32* %total_byte, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateUser_data_registered_itu_t_t35.88() #0 {
entry:
  %canary = alloca i32
  store i32 410080159, i32* %canary
  %temp_data = alloca i32, align 4
  %country_code = alloca i32, align 4
  %total_byte = alloca i32, align 4
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_sei_message.89(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type) #0 {
entry:
  %size = alloca i32, align 4
  %id.addr = alloca i32, align 4
  %payload.addr = alloca i8*, align 8
  ...
  %payload_type.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 964077498, i32* %canary
  %offset = alloca i32, align 4
  %type = alloca i32, align 4
  store i32 %id, i32* %id.addr, align 4
  store i8* %payload, i8** %payload.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeUser_data_unregistered.90() #0 {
entry:
  %canary = alloca i32
  store i32 510833289, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  %i = alloca i32, align 4
  %sym = alloca %struct.syntaxelement, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_unregistered_information_struct, %struct.user_data_unregistered_information_struct* @seiUser_data_unregistered, i32 0, i32 2), align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSpareMBMap.91() #0 {
entry:
  %canary = alloca i32
  store i32 616194291, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  %sym = alloca %struct.syntaxelement, align 8
  %source = alloca %struct.Bitstream*, align 8
  %CurrFrameNum = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateSceneInformation.92(i32 %HasSceneInformation, i32 %sceneID, i32 %sceneTransType, i32 %secondSceneID) #0 {
entry:
  %sceneTransType.addr = alloca i32, align 4
  %sceneID.addr = alloca i32, align 4
  %HasSceneInformation.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 190417350, i32* %canary
  %secondSceneID.addr = alloca i32, align 4
  store i32 %HasSceneInformation, i32* %HasSceneInformation.addr, align 4
  store i32 %sceneID, i32* %sceneID.addr, align 4
  store i32 %sceneTransType, i32* %sceneTransType.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSpareMBMap.93() #0 {
entry:
  %canary = alloca i32
  store i32 1665339447, i32* %canary
  %delta_frame_num = alloca i32, align 4
  %source = alloca %struct.Bitstream*, align 8
  %dest = alloca %struct.Bitstream*, align 8
  %CurrFrameNum = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSpareMBMap.94() #0 {
entry:
  %CurrFrameNum = alloca i32, align 4
  %source = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 114162015, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %delta_frame_num = alloca i32, align 4
  %dest = alloca %struct.Bitstream*, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_sei_message.95(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type) #0 {
entry:
  %type = alloca i32, align 4
  %payload.addr = alloca i8*, align 8
  %payload_type.addr = alloca i32, align 4
  ...
  %payload_size.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 144392100, i32* %canary
  %offset = alloca i32, align 4
  store i32 %id, i32* %id.addr, align 4
  store i8* %payload, i8** %payload.addr, align 8
  store i32 %payload_size, i32* %payload_size.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_sei_message.96(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type) #0 {
entry:
  %size = alloca i32, align 4
  %offset = alloca i32, align 4
  %canary = alloca i32
  store i32 1985219743, i32* %canary
  %id.addr = alloca i32, align 4
  %payload_size.addr = alloca i32, align 4
  %payload.addr = alloca i8*, align 8
  %payload_type.addr = alloca i32, align 4
