; ModuleID = 'loopFilter.c.rand.4R2.bc'
...
func_DeblockFrame.15:                             ; preds = %ctrl1
  call void @DeblockFrame.15(%struct.ImageParameters* %img, i16** %imgY, i16*** %imgUV)
  ret void
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_DeblockFrame.15, label %func_DeblockFrame.16
}
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_DeblockMb.10, label %func_DeblockMb.13
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_GetStrength.5, label %ctrl0

func_GetStrength.5:                               ; preds = %rand_bb
  call void @GetStrength.5(i8* %Strength, %struct.ImageParameters* %img, i32 %MbQAddr, i32 %dir, i32 %edge, i32 %mvlimit)
  ret void

func_GetStrength.8:                               ; preds = %ctrl0
  call void @GetStrength.8(i8* %Strength, %struct.ImageParameters* %img, i32 %MbQAddr, i32 %dir, i32 %edge, i32 %mvlimit)
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_GetStrength.8, label %ctrl1
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_EdgeLoop.4, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_EdgeLoop.7, label %func_EdgeLoop.12
}
...
entry:
  ...
  %canary = alloca i32
  store i32 802308891, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1101293683, i32* %canary
...
return:                                           ; preds = %for.end152, %if.then25
  ...
  %161 = icmp eq i32 %160, 1101293683
...
entry:
  ...
  %imgY.addr = alloca i16**, align 8
  %canary = alloca i32
  store i32 672993179, i32* %canary
  %i = alloca i32, align 4
  %img.addr = alloca %struct.ImageParameters*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store i16** %imgY, i16*** %imgY.addr, align 8
...
entry:
  ...
  %QP = alloca i32, align 4
  %canary = alloca i32
  store i32 583050231, i32* %canary
  %ClipTab = alloca i8*, align 8
  %Alpha = alloca i32, align 4
  %R2 = alloca i32, align 4
  %L3 = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @GetStrength.5(i8* %Strength, %struct.ImageParameters* %img, i32 %MbQAddr, i32 %dir, i32 %edge, i32 %mvlimit) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 636713229, i32* %canary
  %Strength.addr = alloca i8*, align 8
  %yP = alloca i32, align 4
  %pixP = alloca %struct.pix_pos, align 4
  %xP = alloca i32, align 4
...
entry:
  ...
  %filterLeftMbEdgeFlag = alloca i32, align 4
  %canary = alloca i32
  store i32 891748312, i32* %canary
  %mb_x = alloca i32, align 4
  %EdgeCondition = alloca i32, align 4
  %img.addr = alloca %struct.ImageParameters*, align 8
  %StrengthSum = alloca i32, align 4
...
entry:
  ...
  %L3 = alloca i32, align 4
  %canary = alloca i32
  store i32 1151638745, i32* %canary
  %SrcPtrQ = alloca i16*, align 8
  %L1 = alloca i32, align 4
  %c0 = alloca i32, align 4
  %uv.addr = alloca i32, align 4
...
for.end:                                          ; preds = %for.cond
  %347 = load i32, i32* %canary
  %348 = icmp eq i32 %347, 1151638745
  br i1 %348, label %349, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @GetStrength.8(i8* %Strength, %struct.ImageParameters* %img, i32 %MbQAddr, i32 %dir, i32 %edge, i32 %mvlimit) #0 {
entry:
  %Strength.addr = alloca i8*, align 8
  %MbQAddr.addr = alloca i32, align 4
  %MbP = alloca %struct.macroblock*, align 8
  ...
  %list1_mv = alloca i16***, align 8
  %canary = alloca i32
  store i32 1117333708, i32* %canary
  %ref_p1 = alloca i64, align 8
  %blk_y2 = alloca i32, align 4
  %img.addr = alloca %struct.ImageParameters*, align 8
  %list0_refIdxArr = alloca i16**, align 8
...
for.end:                                          ; preds = %for.cond
  %393 = load i32, i32* %canary
  %394 = icmp eq i32 %393, 1117333708
  br i1 %394, label %395, label %func_exit
...
entry:
  ...
  %imgUV.addr = alloca i16***, align 8
  %canary = alloca i32
  store i32 1356440084, i32* %canary
  %i = alloca i32, align 4
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store i16** %imgY, i16*** %imgY.addr, align 8
  store i16*** %imgUV, i16**** %imgUV.addr, align 8
...
entry:
  ...
  %mvlimit = alloca i32, align 4
  %canary = alloca i32
  store i32 1799023418, i32* %canary
  %filterLeftMbEdgeFlag = alloca i32, align 4
  %StrengthSum = alloca i32, align 4
  %filterNon8x8LumaEdgesFlag = alloca [4 x i32], align 16
  %imgY.addr = alloca i16**, align 8
...
return:                                           ; preds = %for.end152, %if.then25
  %160 = load i32, i32* %canary
  %161 = icmp eq i32 %160, 1799023418
  br i1 %161, label %162, label %func_exit
...
entry:
  %canary = alloca i32
  store i32 959079246, i32* %canary
  %mb_x = alloca i32, align 4
  %blk_y = alloca i32, align 4
  %ref_q0 = alloca i64, align 8
  %list1_mv = alloca i16***, align 8
...
entry:
  ...
  %R2 = alloca i32, align 4
  %canary = alloca i32
  store i32 485169900, i32* %canary
  %SrcPtrQ = alloca i16*, align 8
  %dir.addr = alloca i32, align 4
  %RL0 = alloca i32, align 4
  %ap = alloca i32, align 4
...
entry:
  ...
  %edge_cr = alloca i32, align 4
  %canary = alloca i32
  store i32 426982382, i32* %canary
  %MbQAddr.addr = alloca i32, align 4
  %filterLeftMbEdgeFlag = alloca i32, align 4
  %imgUV.addr = alloca i16***, align 8
  %mvlimit = alloca i32, align 4
...
entry:
  ...
  %ref_q0 = alloca i64, align 8
  %canary = alloca i32
  store i32 945430718, i32* %canary
  %ref_p1 = alloca i64, align 8
  %MbQ = alloca %struct.macroblock*, align 8
  %list0_refPicIdArr = alloca i64**, align 8
  %list1_mv = alloca i16***, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @DeblockFrame.15(%struct.ImageParameters* %img, i16** %imgY, i16*** %imgUV) #0 {
entry:
  %imgY.addr = alloca i16**, align 8
  %canary = alloca i32
  store i32 822381411, i32* %canary
  %imgUV.addr = alloca i16***, align 8
  %i = alloca i32, align 4
  %img.addr = alloca %struct.ImageParameters*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 842430893, i32* %canary
  %i = alloca i32, align 4
  %imgUV.addr = alloca i16***, align 8
  %imgY.addr = alloca i16**, align 8
  %img.addr = alloca %struct.ImageParameters*, align 8
