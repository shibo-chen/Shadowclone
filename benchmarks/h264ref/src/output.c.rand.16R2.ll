; ModuleID = 'output.c.rand.16R2.bc'
...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_testEndian.6, label %func_testEndian.11

func_testEndian.6:                                ; preds = %rand_bb
  %2 = call i32 @testEndian.6()
  ret i32 %2

func_testEndian.11:                               ; preds = %rand_bb
  %3 = call i32 @testEndian.11()
  ret i32 %3
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_img2buf.9, label %ctrl0

func_img2buf.9:                                   ; preds = %rand_bb
...
func_img2buf.25:                                  ; preds = %ctrl2
  call void @img2buf.25(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom)
  ret void

func_img2buf.29:                                  ; preds = %ctrl3
  call void @img2buf.29(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom)
  ret void
...
func_img2buf.32:                                  ; preds = %ctrl5
  call void @img2buf.32(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom)
  ret void

func_img2buf.40:                                  ; preds = %ctrl6
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_img2buf.14, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_img2buf.25, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_img2buf.29, label %ctrl4
...
ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_img2buf.32, label %ctrl6

ctrl6:                                            ; preds = %ctrl5
  %8 = icmp eq i32 %0, 7
  br i1 %8, label %func_img2buf.40, label %ctrl7
...
ctrl8:                                            ; preds = %ctrl7
  %10 = icmp eq i32 %0, 9
  br i1 %10, label %func_img2buf.45, label %ctrl9

ctrl9:                                            ; preds = %ctrl8
  %11 = icmp eq i32 %0, 10
  br i1 %11, label %func_img2buf.46, label %ctrl10
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_write_picture.1, label %ctrl0

func_write_picture.1:                             ; preds = %rand_bb
  call void @write_picture.1(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure)
  ret void

func_write_picture.7:                             ; preds = %ctrl0
  call void @write_picture.7(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure)
  ret void

func_write_picture.24:                            ; preds = %ctrl1
  call void @write_picture.24(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure)
  ret void

func_write_picture.27:                            ; preds = %ctrl2
  call void @write_picture.27(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure)
  ret void

func_write_picture.31:                            ; preds = %ctrl3
  call void @write_picture.31(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure)
  ret void

func_write_picture.33:                            ; preds = %ctrl3
  call void @write_picture.33(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_write_picture.7, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_write_picture.24, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_write_picture.27, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_write_picture.31, label %func_write_picture.33
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_write_out_picture.5, label %ctrl0

func_write_out_picture.5:                         ; preds = %rand_bb
  call void @write_out_picture.5(%struct.storable_picture* %p, i32 %p_out)
  ret void
...
func_write_out_picture.21:                        ; preds = %ctrl1
  call void @write_out_picture.21(%struct.storable_picture* %p, i32 %p_out)
  ret void

func_write_out_picture.22:                        ; preds = %ctrl2
  call void @write_out_picture.22(%struct.storable_picture* %p, i32 %p_out)
  ret void

func_write_out_picture.26:                        ; preds = %ctrl3
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_write_out_picture.21, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_write_out_picture.22, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_write_out_picture.26, label %ctrl4
...
ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_write_out_picture.34, label %ctrl6

ctrl6:                                            ; preds = %ctrl5
  %8 = icmp eq i32 %0, 7
  br i1 %8, label %func_write_out_picture.35, label %ctrl7

ctrl7:                                            ; preds = %ctrl6
  %9 = icmp eq i32 %0, 8
  br i1 %9, label %func_write_out_picture.36, label %ctrl8

ctrl8:                                            ; preds = %ctrl7
  %10 = icmp eq i32 %0, 9
  br i1 %10, label %func_write_out_picture.37, label %ctrl9
...
ctrl10:                                           ; preds = %ctrl9
  %12 = icmp eq i32 %0, 11
  br i1 %12, label %func_write_out_picture.39, label %ctrl11

ctrl11:                                           ; preds = %ctrl10
  %13 = icmp eq i32 %0, 12
  br i1 %13, label %func_write_out_picture.41, label %ctrl12

ctrl12:                                           ; preds = %ctrl11
  %14 = icmp eq i32 %0, 13
  br i1 %14, label %func_write_out_picture.42, label %ctrl13

ctrl13:                                           ; preds = %ctrl12
  %15 = icmp eq i32 %0, 14
  br i1 %15, label %func_write_out_picture.44, label %func_write_out_picture.47
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_clear_picture.12, label %func_clear_picture.23

func_clear_picture.12:                            ; preds = %rand_bb
  call void @clear_picture.12(%struct.storable_picture* %p)
  ret void

func_clear_picture.23:                            ; preds = %rand_bb
  call void @clear_picture.23(%struct.storable_picture* %p)
  ret void
}
...
func_write_unpaired_field.15:                     ; preds = %ctrl0
  call void @write_unpaired_field.15(%struct.frame_store* %fs, i32 %p_out)
  ret void

func_write_unpaired_field.17:                     ; preds = %ctrl1
  call void @write_unpaired_field.17(%struct.frame_store* %fs, i32 %p_out)
  ret void

func_write_unpaired_field.18:                     ; preds = %ctrl2
...
func_write_unpaired_field.20:                     ; preds = %ctrl3
  call void @write_unpaired_field.20(%struct.frame_store* %fs, i32 %p_out)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_write_unpaired_field.15, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_write_unpaired_field.17, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_write_unpaired_field.18, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_write_unpaired_field.19, label %func_write_unpaired_field.20
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_write_stored_frame.3, label %func_write_stored_frame.10
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_direct_output.4, label %func_direct_output.16

func_direct_output.4:                             ; preds = %rand_bb
  call void @direct_output.4(%struct.storable_picture* %p, i32 %p_out)
  ret void

func_direct_output.16:                            ; preds = %rand_bb
  call void @direct_output.16(%struct.storable_picture* %p, i32 %p_out)
  ret void
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_picture.1(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure) #0 {
entry:
  %canary = alloca i32
  store i32 875267679, i32* %canary
...
entry:
  %fs.addr = alloca %struct.frame_store*, align 8
  %canary = alloca i32
  store i32 1422451369, i32* %canary
  %p_out.addr = alloca i32, align 4
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 867019930, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  %0 = load %struct.storable_picture*, %struct.storable_picture** %p.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_out_picture.5(%struct.storable_picture* %p, i32 %p_out) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 1519485357, i32* %canary
...
return:                                           ; preds = %if.end139, %if.then
  ...
  %193 = icmp eq i32 %192, 1519485357
...
entry:
  %p = alloca i8*, align 8
  %canary = alloca i32
  store i32 1969502736, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_picture.7(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure) #0 {
entry:
  %p.addr = alloca %struct.storable_picture*, align 8
  %canary = alloca i32
  store i32 80907502, i32* %canary
  %real_structure.addr = alloca i32, align 4
  %p_out.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  ...
  %buf = alloca i8*, align 8
  %canary = alloca i32
  store i32 1031664655, i32* %canary
  %rgb_output = alloca i32, align 4
  %crop_top = alloca i32, align 4
  %SubWidthC = alloca [4 x i32], align 16
  %SubHeightC = alloca [4 x i32], align 16
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1031664655
  br i1 %193, label %194, label %func_exit
...
entry:
  ...
  %canary = alloca i32
  store i32 2080125366, i32* %canary
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  ...
  %109 = icmp eq i32 %108, 2080125366
...
entry:
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 421530663, i32* %canary
  %fs.addr = alloca %struct.frame_store*, align 8
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  %0 = load i32, i32* %p_out.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @testEndian.11() #0 {
entry:
  %s = alloca i16, align 2
  %canary = alloca i32
  store i32 1197490153, i32* %canary
  %p = alloca i8*, align 8
  %0 = bitcast i16* %s to i8*
  store i8* %0, i8** %p, align 8
  store i16 1, i16* %s, align 2
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @clear_picture.12(%struct.storable_picture* %p) #0 {
entry:
  %p.addr = alloca %struct.storable_picture*, align 8
  %canary = alloca i32
  store i32 1759217051, i32* %canary
  %i = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
...
entry:
  ...
  %tmp16 = alloca i16, align 2
  %canary = alloca i32
  store i32 2059940358, i32* %canary
  %ui8 = alloca i8, align 1
  %tmp32 = alloca i64, align 8
  %ui16 = alloca i16, align 2
  %ui32 = alloca i64, align 8
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 2059940358
  br i1 %109, label %110, label %func_exit
...
entry:
  ...
  %ui32 = alloca i64, align 8
  %canary = alloca i32
  store i32 1561210299, i32* %canary
  %size = alloca i32, align 4
  %j = alloca i32, align 4
  %tmp16 = alloca i16, align 2
  %twidth = alloca i32, align 4
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1561210299
  br i1 %109, label %110, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_unpaired_field.15(%struct.frame_store* %fs, i32 %p_out) #0 {
entry:
  %canary = alloca i32
  store i32 214256689, i32* %canary
  %fs.addr = alloca %struct.frame_store*, align 8
  %p = alloca %struct.storable_picture*, align 8
  %p_out.addr = alloca i32, align 4
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @direct_output.16(%struct.storable_picture* %p, i32 %p_out) #0 {
entry:
  %canary = alloca i32
  store i32 876650406, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  %p_out.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_unpaired_field.17(%struct.frame_store* %fs, i32 %p_out) #0 {
entry:
  %p_out.addr = alloca i32, align 4
  %fs.addr = alloca %struct.frame_store*, align 8
  %canary = alloca i32
  store i32 1947592955, i32* %canary
  %p = alloca %struct.storable_picture*, align 8
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  %0 = load %struct.frame_store*, %struct.frame_store** %fs.addr, align 8
...
entry:
  ...
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 621388316, i32* %canary
  %fs.addr = alloca %struct.frame_store*, align 8
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  %0 = load %struct.frame_store*, %struct.frame_store** %fs.addr, align 8
...
entry:
  ...
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2090946334, i32* %canary
  %p = alloca %struct.storable_picture*, align 8
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  %0 = load %struct.frame_store*, %struct.frame_store** %fs.addr, align 8
...
entry:
  %p = alloca %struct.storable_picture*, align 8
  %canary = alloca i32
  store i32 1173469399, i32* %canary
  %fs.addr = alloca %struct.frame_store*, align 8
  %p_out.addr = alloca i32, align 4
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  ...
  %symbol_size_in_bytes = alloca i32, align 4
  %canary = alloca i32
  store i32 673964695, i32* %canary
  %crop_top = alloca i32, align 4
  %SubHeightC = alloca [4 x i32], align 16
  %crop_left = alloca i32, align 4
  %p.addr = alloca %struct.storable_picture*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_out_picture.22(%struct.storable_picture* %p, i32 %p_out) #0 {
entry:
  %crop_top = alloca i32, align 4
  %buf = alloca i8*, align 8
  %crop_right = alloca i32, align 4
  ...
  %SubHeightC = alloca [4 x i32], align 16
  %canary = alloca i32
  store i32 1256275079, i32* %canary
  %rgb_output = alloca i32, align 4
  %crop_left = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1256275079
  br i1 %193, label %194, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @clear_picture.23(%struct.storable_picture* %p) #0 {
entry:
  %canary = alloca i32
  store i32 1121237042, i32* %canary
  %i = alloca i32, align 4
  %p.addr = alloca %struct.storable_picture*, align 8
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 0, i32* %i, align 4
...
entry:
  ...
  %p.addr = alloca %struct.storable_picture*, align 8
  %canary = alloca i32
  store i32 249517365, i32* %canary
  %real_structure.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  store i32 %real_structure, i32* %real_structure.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @img2buf.25(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom) #0 {
entry:
  %size = alloca i32, align 4
  %crop_left.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  ...
  %size_x.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1371824577, i32* %canary
  %crop_right.addr = alloca i32, align 4
  %imgX.addr = alloca i16**, align 8
  %i = alloca i32, align 4
  %symbol_size_in_bytes.addr = alloca i32, align 4
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1371824577
  br i1 %109, label %110, label %func_exit
...
entry:
  ...
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1727288168, i32* %canary
  %rgb_output = alloca i32, align 4
  %buf = alloca i8*, align 8
  %SubHeightC = alloca [4 x i32], align 16
  %crop_top = alloca i32, align 4
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1727288168
  br i1 %193, label %194, label %func_exit
...
entry:
  %real_structure.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 252126391, i32* %canary
  %p_out.addr = alloca i32, align 4
  %p.addr = alloca %struct.storable_picture*, align 8
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  ...
  %SubHeightC = alloca [4 x i32], align 16
  %canary = alloca i32
  store i32 440873378, i32* %canary
  %symbol_size_in_bytes = alloca i32, align 4
  %crop_bottom = alloca i32, align 4
  %p.addr = alloca %struct.storable_picture*, align 8
  %crop_top = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @img2buf.29(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom) #0 {
entry:
  %theight = alloca i32, align 4
  %crop_bottom.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1886226910, i32* %canary
  %size = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %symbol_size_in_bytes.addr = alloca i32, align 4
  %size_y.addr = alloca i32, align 4
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1886226910
  br i1 %109, label %110, label %func_exit
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 2049825902, i32* %canary
  %twidth = alloca i32, align 4
  %size_y.addr = alloca i32, align 4
  %tmp16 = alloca i16, align 2
  %ui32 = alloca i64, align 8
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 2049825902
  br i1 %109, label %110, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_picture.31(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure) #0 {
entry:
  %p.addr = alloca %struct.storable_picture*, align 8
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 226132244, i32* %canary
  %real_structure.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  store i32 %real_structure, i32* %real_structure.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @img2buf.32(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom) #0 {
entry:
  %crop_top.addr = alloca i32, align 4
  %crop_bottom.addr = alloca i32, align 4
  %size_y.addr = alloca i32, align 4
  ...
  %tmp16 = alloca i16, align 2
  %canary = alloca i32
  store i32 901685264, i32* %canary
  %ui8 = alloca i8, align 1
  %tmp32 = alloca i64, align 8
  %theight = alloca i32, align 4
  %crop_left.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_picture.33(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure) #0 {
entry:
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 218407790, i32* %canary
  %real_structure.addr = alloca i32, align 4
  %p.addr = alloca %struct.storable_picture*, align 8
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  ...
  %SubWidthC = alloca [4 x i32], align 16
  %canary = alloca i32
  store i32 972726081, i32* %canary
  %symbol_size_in_bytes = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  %0 = bitcast [4 x i32]* %SubWidthC to i8*
...
entry:
  ...
  %crop_right = alloca i32, align 4
  %canary = alloca i32
  store i32 1018063179, i32* %canary
  %buf = alloca i8*, align 8
  %SubWidthC = alloca [4 x i32], align 16
  %SubHeightC = alloca [4 x i32], align 16
  %p_out.addr = alloca i32, align 4
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1018063179
  br i1 %193, label %194, label %func_exit
...
entry:
  ...
  %buf = alloca i8*, align 8
  %canary = alloca i32
  store i32 1446403154, i32* %canary
  %crop_top = alloca i32, align 4
  %SubHeightC = alloca [4 x i32], align 16
  %crop_left = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1446403154
  br i1 %193, label %194, label %func_exit
...
entry:
  %canary = alloca i32
  store i32 433301647, i32* %canary
  %p_out.addr = alloca i32, align 4
  %p.addr = alloca %struct.storable_picture*, align 8
  %SubWidthC = alloca [4 x i32], align 16
  %crop_top = alloca i32, align 4
...
entry:
  ...
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 946403414, i32* %canary
  %crop_left = alloca i32, align 4
  %crop_right = alloca i32, align 4
  %crop_top = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
...
entry:
  %crop_right = alloca i32, align 4
  %canary = alloca i32
  store i32 1735290590, i32* %canary
  %crop_bottom = alloca i32, align 4
  %symbol_size_in_bytes = alloca i32, align 4
  %SubHeightC = alloca [4 x i32], align 16
  %p.addr = alloca %struct.storable_picture*, align 8
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1735290590
  br i1 %193, label %194, label %func_exit
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1780686821, i32* %canary
  %twidth = alloca i32, align 4
  %size = alloca i32, align 4
  %ui16 = alloca i16, align 2
  %tmp16 = alloca i16, align 2
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1780686821
  br i1 %109, label %110, label %func_exit
...
entry:
  ...
  %crop_left = alloca i32, align 4
  %canary = alloca i32
  store i32 1216866083, i32* %canary
  %p_out.addr = alloca i32, align 4
  %SubHeightC = alloca [4 x i32], align 16
  %rgb_output = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1216866083
  br i1 %193, label %194, label %func_exit
...
entry:
  ...
  %crop_left = alloca i32, align 4
  %canary = alloca i32
  store i32 1155081493, i32* %canary
  %crop_top = alloca i32, align 4
  %crop_right = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1155081493
  br i1 %193, label %194, label %func_exit
...
entry:
  ...
  %tmp16 = alloca i16, align 2
  %canary = alloca i32
  store i32 1935328695, i32* %canary
  %crop_top.addr = alloca i32, align 4
  %size_x.addr = alloca i32, align 4
  %ui8 = alloca i8, align 1
  %j = alloca i32, align 4
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1935328695
  br i1 %109, label %110, label %func_exit
...
entry:
  ...
  %SubWidthC = alloca [4 x i32], align 16
  %canary = alloca i32
  store i32 1072614344, i32* %canary
  %SubHeightC = alloca [4 x i32], align 16
  %crop_right = alloca i32, align 4
  %crop_bottom = alloca i32, align 4
  %symbol_size_in_bytes = alloca i32, align 4
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1072614344
  br i1 %193, label %194, label %func_exit
...
entry:
  ...
  %tmp16 = alloca i16, align 2
  %canary = alloca i32
  store i32 2138618417, i32* %canary
  %i = alloca i32, align 4
  %size_y.addr = alloca i32, align 4
  %j = alloca i32, align 4
  %crop_top.addr = alloca i32, align 4
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 2138618417
  br i1 %109, label %110, label %func_exit
...
entry:
  %canary = alloca i32
  store i32 572231875, i32* %canary
  %twidth = alloca i32, align 4
  %ui16 = alloca i16, align 2
  %crop_right.addr = alloca i32, align 4
  %theight = alloca i32, align 4
...
entry:
  ...
  %SubHeightC = alloca [4 x i32], align 16
  %canary = alloca i32
  store i32 1113089849, i32* %canary
  %buf = alloca i8*, align 8
  %SubWidthC = alloca [4 x i32], align 16
  %crop_top = alloca i32, align 4
  %rgb_output = alloca i32, align 4
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1113089849
  br i1 %193, label %194, label %func_exit
...
entry:
  %canary = alloca i32
  store i32 165720923, i32* %canary
  %ui32 = alloca i64, align 8
  %theight = alloca i32, align 4
  %twidth = alloca i32, align 4
  %crop_left.addr = alloca i32, align 4
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1380110366, i32* %canary
  %crop_right.addr = alloca i32, align 4
  %crop_left.addr = alloca i32, align 4
  %tmp16 = alloca i16, align 2
  %size_x.addr = alloca i32, align 4
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1380110366
  br i1 %109, label %110, label %func_exit
...
entry:
  ...
  %size_y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 120196776, i32* %canary
  %ui8 = alloca i8, align 1
  %crop_left.addr = alloca i32, align 4
  %crop_bottom.addr = alloca i32, align 4
  %crop_top.addr = alloca i32, align 4
...
entry:
  %ui16 = alloca i16, align 2
  %canary = alloca i32
  store i32 1379317506, i32* %canary
  %crop_bottom.addr = alloca i32, align 4
  %crop_right.addr = alloca i32, align 4
  %size = alloca i32, align 4
  %size_x.addr = alloca i32, align 4
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1379317506
  br i1 %109, label %110, label %func_exit
...
entry:
  ...
  %crop_bottom.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1992008815, i32* %canary
  %theight = alloca i32, align 4
  %ui32 = alloca i64, align 8
  %tmp32 = alloca i64, align 8
  %tmp16 = alloca i16, align 2
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1992008815
  br i1 %109, label %110, label %func_exit
