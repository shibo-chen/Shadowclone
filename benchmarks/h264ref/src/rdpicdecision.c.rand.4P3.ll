; ModuleID = 'rdpicdecision.c.rand.4P3.bc'
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_rd_pic_decision.3, label %ctrl1
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_picture_coding_decision.4, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_picture_coding_decision.5, label %func_picture_coding_decision.6
}
...
entry:
  ...
  %canary = alloca i32
  store i32 156633803, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1215703315, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1812683216, i32* %canary
  %lambda_picture.addr = alloca double, align 8
  %cost_version2 = alloca double, align 8
  %bits_version1.addr = alloca i32, align 4
  %retval = alloca i32, align 4
...
entry:
  ...
  %qp.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 368515065, i32* %canary
  %bit_picture2 = alloca i32, align 4
  %picture1.addr = alloca %struct.Picture*, align 8
  %lambda_picture = alloca double, align 8
  %snr_picture1 = alloca double, align 8
...
entry:
  ...
  %qp.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1360567528, i32* %canary
  %lambda_picture = alloca double, align 8
  %bit_picture1 = alloca i32, align 4
  %bframe = alloca i32, align 4
  %snr_picture2 = alloca double, align 8
...
entry:
  ...
  %qp.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2083200191, i32* %canary
  %picture1.addr = alloca %struct.Picture*, align 8
  %bit_picture1 = alloca i32, align 4
  %spframe = alloca i32, align 4
  %bframe = alloca i32, align 4
...
entry:
  ...
  %bits_version1.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 775926945, i32* %canary
  %bits_version2.addr = alloca i32, align 4
  %lambda_picture.addr = alloca double, align 8
  %snrY_version2.addr = alloca double, align 8
  store double %snrY_version1, double* %snrY_version1.addr, align 8
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1273836812, i32* %canary
  %bits_version1.addr = alloca i32, align 4
  %lambda_picture.addr = alloca double, align 8
  %snrY_version1.addr = alloca double, align 8
  %cost_version1 = alloca double, align 8
