...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_write_sei_message.1, label %ctrl0

func_write_sei_message.1:                         ; preds = %rand_bb
  call void @write_sei_message.1(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type)
  ret void

func_write_sei_message.2:                         ; preds = %ctrl0
  call void @write_sei_message.2(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type)
  ret void
...
func_write_sei_message.32:                        ; preds = %ctrl2
  call void @write_sei_message.32(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type)
  ret void

func_write_sei_message.34:                        ; preds = %ctrl3
  call void @write_sei_message.34(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type)
  ret void

func_write_sei_message.39:                        ; preds = %ctrl4
  call void @write_sei_message.39(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type)
  ret void

func_write_sei_message.44:                        ; preds = %ctrl5
  call void @write_sei_message.44(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type)
  ret void

func_write_sei_message.46:                        ; preds = %ctrl5
  call void @write_sei_message.46(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_write_sei_message.2, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_write_sei_message.17, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_write_sei_message.32, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_write_sei_message.34, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_write_sei_message.39, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_write_sei_message.44, label %func_write_sei_message.46
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_finalize_sei_message.11, label %func_finalize_sei_message.12

func_finalize_sei_message.11:                     ; preds = %rand_bb
  call void @finalize_sei_message.11(i32 %id)
  ret void

func_finalize_sei_message.12:                     ; preds = %rand_bb
  call void @finalize_sei_message.12(i32 %id)
  ret void
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_AppendTmpbits2Buf.15, label %ctrl0

func_AppendTmpbits2Buf.15:                        ; preds = %rand_bb
  call void @AppendTmpbits2Buf.15(%struct.Bitstream* %dest, %struct.Bitstream* %source)
  ret void

func_AppendTmpbits2Buf.49:                        ; preds = %ctrl0
  call void @AppendTmpbits2Buf.49(%struct.Bitstream* %dest, %struct.Bitstream* %source)
  ret void

func_AppendTmpbits2Buf.64:                        ; preds = %ctrl1
  call void @AppendTmpbits2Buf.64(%struct.Bitstream* %dest, %struct.Bitstream* %source)
  ret void

func_AppendTmpbits2Buf.65:                        ; preds = %ctrl2
  call void @AppendTmpbits2Buf.65(%struct.Bitstream* %dest, %struct.Bitstream* %source)
  ret void

func_AppendTmpbits2Buf.84:                        ; preds = %ctrl3
  call void @AppendTmpbits2Buf.84(%struct.Bitstream* %dest, %struct.Bitstream* %source)
  ret void

func_AppendTmpbits2Buf.91:                        ; preds = %ctrl4
  call void @AppendTmpbits2Buf.91(%struct.Bitstream* %dest, %struct.Bitstream* %source)
  ret void

func_AppendTmpbits2Buf.92:                        ; preds = %ctrl5
  call void @AppendTmpbits2Buf.92(%struct.Bitstream* %dest, %struct.Bitstream* %source)
  ret void

func_AppendTmpbits2Buf.94:                        ; preds = %ctrl5
  call void @AppendTmpbits2Buf.94(%struct.Bitstream* %dest, %struct.Bitstream* %source)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_AppendTmpbits2Buf.49, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_AppendTmpbits2Buf.64, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_AppendTmpbits2Buf.65, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_AppendTmpbits2Buf.84, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_AppendTmpbits2Buf.91, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_AppendTmpbits2Buf.92, label %func_AppendTmpbits2Buf.94
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_ComposeSparePictureMessage.7, label %ctrl0

func_ComposeSparePictureMessage.7:                ; preds = %rand_bb
  call void @ComposeSparePictureMessage.7(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream)
  ret void

func_ComposeSparePictureMessage.13:               ; preds = %ctrl0
  call void @ComposeSparePictureMessage.13(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream)
  ret void

func_ComposeSparePictureMessage.18:               ; preds = %ctrl1
  call void @ComposeSparePictureMessage.18(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream)
  ret void

func_ComposeSparePictureMessage.19:               ; preds = %ctrl2
  call void @ComposeSparePictureMessage.19(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream)
  ret void

func_ComposeSparePictureMessage.41:               ; preds = %ctrl3
  call void @ComposeSparePictureMessage.41(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream)
  ret void

func_ComposeSparePictureMessage.42:               ; preds = %ctrl4
  call void @ComposeSparePictureMessage.42(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream)
  ret void

func_ComposeSparePictureMessage.61:               ; preds = %ctrl5
  call void @ComposeSparePictureMessage.61(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream)
  ret void

func_ComposeSparePictureMessage.67:               ; preds = %ctrl5
  call void @ComposeSparePictureMessage.67(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_ComposeSparePictureMessage.13, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_ComposeSparePictureMessage.18, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_ComposeSparePictureMessage.19, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_ComposeSparePictureMessage.41, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_ComposeSparePictureMessage.42, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_ComposeSparePictureMessage.61, label %func_ComposeSparePictureMessage.67
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_CompressSpareMBMap.47, label %ctrl0

func_CompressSpareMBMap.47:                       ; preds = %rand_bb
  %2 = call i32 @CompressSpareMBMap.47(i8** %map_sp, %struct.Bitstream* %bitstream)
  ret i32 %2

func_CompressSpareMBMap.81:                       ; preds = %ctrl0
  %3 = call i32 @CompressSpareMBMap.81(i8** %map_sp, %struct.Bitstream* %bitstream)
  ret i32 %3

func_CompressSpareMBMap.88:                       ; preds = %ctrl1
  %4 = call i32 @CompressSpareMBMap.88(i8** %map_sp, %struct.Bitstream* %bitstream)
  ret i32 %4

func_CompressSpareMBMap.89:                       ; preds = %ctrl2
  %5 = call i32 @CompressSpareMBMap.89(i8** %map_sp, %struct.Bitstream* %bitstream)
  ret i32 %5

func_CompressSpareMBMap.90:                       ; preds = %ctrl3
  %6 = call i32 @CompressSpareMBMap.90(i8** %map_sp, %struct.Bitstream* %bitstream)
  ret i32 %6

func_CompressSpareMBMap.93:                       ; preds = %ctrl4
  %7 = call i32 @CompressSpareMBMap.93(i8** %map_sp, %struct.Bitstream* %bitstream)
  ret i32 %7

func_CompressSpareMBMap.95:                       ; preds = %ctrl5
  %8 = call i32 @CompressSpareMBMap.95(i8** %map_sp, %struct.Bitstream* %bitstream)
  ret i32 %8

func_CompressSpareMBMap.96:                       ; preds = %ctrl5
  %9 = call i32 @CompressSpareMBMap.96(i8** %map_sp, %struct.Bitstream* %bitstream)
  ret i32 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_CompressSpareMBMap.81, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_CompressSpareMBMap.88, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_CompressSpareMBMap.89, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_CompressSpareMBMap.90, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_CompressSpareMBMap.93, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_CompressSpareMBMap.95, label %func_CompressSpareMBMap.96
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FinalizeSpareMBMap.8, label %ctrl0

func_FinalizeSpareMBMap.8:                        ; preds = %rand_bb
  call void @FinalizeSpareMBMap.8()
  ret void

func_FinalizeSpareMBMap.40:                       ; preds = %ctrl0
  call void @FinalizeSpareMBMap.40()
  ret void

func_FinalizeSpareMBMap.52:                       ; preds = %ctrl1
  call void @FinalizeSpareMBMap.52()
  ret void

func_FinalizeSpareMBMap.55:                       ; preds = %ctrl2
  call void @FinalizeSpareMBMap.55()
  ret void

func_FinalizeSpareMBMap.70:                       ; preds = %ctrl3
  call void @FinalizeSpareMBMap.70()
  ret void

func_FinalizeSpareMBMap.77:                       ; preds = %ctrl4
  call void @FinalizeSpareMBMap.77()
  ret void

func_FinalizeSpareMBMap.82:                       ; preds = %ctrl5
  call void @FinalizeSpareMBMap.82()
  ret void

func_FinalizeSpareMBMap.87:                       ; preds = %ctrl5
  call void @FinalizeSpareMBMap.87()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_FinalizeSpareMBMap.40, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_FinalizeSpareMBMap.52, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_FinalizeSpareMBMap.55, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_FinalizeSpareMBMap.70, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_FinalizeSpareMBMap.77, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_FinalizeSpareMBMap.82, label %func_FinalizeSpareMBMap.87
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FinalizeSubseqInfo.3, label %ctrl0

func_FinalizeSubseqInfo.3:                        ; preds = %rand_bb
  call void @FinalizeSubseqInfo.3(i32 %currLayer)
  ret void

func_FinalizeSubseqInfo.24:                       ; preds = %ctrl0
  call void @FinalizeSubseqInfo.24(i32 %currLayer)
  ret void

func_FinalizeSubseqInfo.33:                       ; preds = %ctrl1
  call void @FinalizeSubseqInfo.33(i32 %currLayer)
  ret void

func_FinalizeSubseqInfo.43:                       ; preds = %ctrl2
  call void @FinalizeSubseqInfo.43(i32 %currLayer)
  ret void

func_FinalizeSubseqInfo.59:                       ; preds = %ctrl3
  call void @FinalizeSubseqInfo.59(i32 %currLayer)
  ret void

func_FinalizeSubseqInfo.60:                       ; preds = %ctrl3
  call void @FinalizeSubseqInfo.60(i32 %currLayer)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_FinalizeSubseqInfo.24, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_FinalizeSubseqInfo.33, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_FinalizeSubseqInfo.43, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_FinalizeSubseqInfo.59, label %func_FinalizeSubseqInfo.60
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FinalizeSubseqLayerInfo.50, label %func_FinalizeSubseqLayerInfo.51

func_FinalizeSubseqLayerInfo.50:                  ; preds = %rand_bb
  call void @FinalizeSubseqLayerInfo.50()
  ret void

func_FinalizeSubseqLayerInfo.51:                  ; preds = %rand_bb
  call void @FinalizeSubseqLayerInfo.51()
  ret void
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FinalizeSubseqChar.23, label %ctrl0

func_FinalizeSubseqChar.23:                       ; preds = %rand_bb
  call void @FinalizeSubseqChar.23()
  ret void
...
func_FinalizeSubseqChar.56:                       ; preds = %ctrl2
  call void @FinalizeSubseqChar.56()
  ret void

func_FinalizeSubseqChar.66:                       ; preds = %ctrl3
  call void @FinalizeSubseqChar.66()
  ret void

func_FinalizeSubseqChar.69:                       ; preds = %ctrl3
  call void @FinalizeSubseqChar.69()
  ret void
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_FinalizeSubseqChar.35, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_FinalizeSubseqChar.56, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_FinalizeSubseqChar.66, label %func_FinalizeSubseqChar.69
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FinalizeSceneInformation.4, label %func_FinalizeSceneInformation.5

func_FinalizeSceneInformation.4:                  ; preds = %rand_bb
  call void @FinalizeSceneInformation.4()
  ret void

func_FinalizeSceneInformation.5:                  ; preds = %rand_bb
  call void @FinalizeSceneInformation.5()
  ret void
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_UpdateSceneInformation.6, label %ctrl0

func_UpdateSceneInformation.6:                    ; preds = %rand_bb
  call void @UpdateSceneInformation.6(i32 %HasSceneInformation, i32 %sceneID, i32 %sceneTransType, i32 %secondSceneID)
  ret void

func_UpdateSceneInformation.9:                    ; preds = %ctrl0
  call void @UpdateSceneInformation.9(i32 %HasSceneInformation, i32 %sceneID, i32 %sceneTransType, i32 %secondSceneID)
  ret void

func_UpdateSceneInformation.26:                   ; preds = %ctrl1
  call void @UpdateSceneInformation.26(i32 %HasSceneInformation, i32 %sceneID, i32 %sceneTransType, i32 %secondSceneID)
  ret void

func_UpdateSceneInformation.36:                   ; preds = %ctrl2
  call void @UpdateSceneInformation.36(i32 %HasSceneInformation, i32 %sceneID, i32 %sceneTransType, i32 %secondSceneID)
  ret void

func_UpdateSceneInformation.53:                   ; preds = %ctrl3
  call void @UpdateSceneInformation.53(i32 %HasSceneInformation, i32 %sceneID, i32 %sceneTransType, i32 %secondSceneID)
  ret void

func_UpdateSceneInformation.68:                   ; preds = %ctrl4
  call void @UpdateSceneInformation.68(i32 %HasSceneInformation, i32 %sceneID, i32 %sceneTransType, i32 %secondSceneID)
  ret void

func_UpdateSceneInformation.72:                   ; preds = %ctrl5
  call void @UpdateSceneInformation.72(i32 %HasSceneInformation, i32 %sceneID, i32 %sceneTransType, i32 %secondSceneID)
  ret void

func_UpdateSceneInformation.80:                   ; preds = %ctrl5
  call void @UpdateSceneInformation.80(i32 %HasSceneInformation, i32 %sceneID, i32 %sceneTransType, i32 %secondSceneID)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_UpdateSceneInformation.9, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_UpdateSceneInformation.26, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_UpdateSceneInformation.36, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_UpdateSceneInformation.53, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_UpdateSceneInformation.68, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_UpdateSceneInformation.72, label %func_UpdateSceneInformation.80
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FinalizePanScanRectInfo.20, label %func_FinalizePanScanRectInfo.22

func_FinalizePanScanRectInfo.20:                  ; preds = %rand_bb
  call void @FinalizePanScanRectInfo.20()
  ret void

func_FinalizePanScanRectInfo.22:                  ; preds = %rand_bb
  call void @FinalizePanScanRectInfo.22()
  ret void
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_UpdateUser_data_unregistered.38, label %ctrl0

func_UpdateUser_data_unregistered.38:             ; preds = %rand_bb
  call void @UpdateUser_data_unregistered.38()
  ret void

func_UpdateUser_data_unregistered.71:             ; preds = %ctrl0
  call void @UpdateUser_data_unregistered.71()
  ret void

func_UpdateUser_data_unregistered.74:             ; preds = %ctrl1
  call void @UpdateUser_data_unregistered.74()
  ret void

func_UpdateUser_data_unregistered.83:             ; preds = %ctrl2
  call void @UpdateUser_data_unregistered.83()
  ret void

func_UpdateUser_data_unregistered.85:             ; preds = %ctrl3
  call void @UpdateUser_data_unregistered.85()
  ret void

func_UpdateUser_data_unregistered.86:             ; preds = %ctrl3
  call void @UpdateUser_data_unregistered.86()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_UpdateUser_data_unregistered.71, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_UpdateUser_data_unregistered.74, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_UpdateUser_data_unregistered.83, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_UpdateUser_data_unregistered.85, label %func_UpdateUser_data_unregistered.86
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FinalizeUser_data_unregistered.21, label %ctrl0

func_FinalizeUser_data_unregistered.21:           ; preds = %rand_bb
  call void @FinalizeUser_data_unregistered.21()
  ret void

func_FinalizeUser_data_unregistered.37:           ; preds = %ctrl0
  call void @FinalizeUser_data_unregistered.37()
  ret void

func_FinalizeUser_data_unregistered.58:           ; preds = %ctrl1
  call void @FinalizeUser_data_unregistered.58()
  ret void

func_FinalizeUser_data_unregistered.63:           ; preds = %ctrl2
  call void @FinalizeUser_data_unregistered.63()
  ret void

func_FinalizeUser_data_unregistered.75:           ; preds = %ctrl3
  call void @FinalizeUser_data_unregistered.75()
  ret void

func_FinalizeUser_data_unregistered.76:           ; preds = %ctrl3
  call void @FinalizeUser_data_unregistered.76()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_FinalizeUser_data_unregistered.37, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_FinalizeUser_data_unregistered.58, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_FinalizeUser_data_unregistered.63, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_FinalizeUser_data_unregistered.75, label %func_FinalizeUser_data_unregistered.76
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_UpdateUser_data_registered_itu_t_t35.14, label %ctrl0

func_UpdateUser_data_registered_itu_t_t35.14:     ; preds = %rand_bb
  call void @UpdateUser_data_registered_itu_t_t35.14()
  ret void

func_UpdateUser_data_registered_itu_t_t35.27:     ; preds = %ctrl0
  call void @UpdateUser_data_registered_itu_t_t35.27()
  ret void

func_UpdateUser_data_registered_itu_t_t35.29:     ; preds = %ctrl1
  call void @UpdateUser_data_registered_itu_t_t35.29()
  ret void

func_UpdateUser_data_registered_itu_t_t35.31:     ; preds = %ctrl2
  call void @UpdateUser_data_registered_itu_t_t35.31()
  ret void

func_UpdateUser_data_registered_itu_t_t35.54:     ; preds = %ctrl3
  call void @UpdateUser_data_registered_itu_t_t35.54()
  ret void

func_UpdateUser_data_registered_itu_t_t35.57:     ; preds = %ctrl4
  call void @UpdateUser_data_registered_itu_t_t35.57()
  ret void

func_UpdateUser_data_registered_itu_t_t35.73:     ; preds = %ctrl5
  call void @UpdateUser_data_registered_itu_t_t35.73()
  ret void

func_UpdateUser_data_registered_itu_t_t35.79:     ; preds = %ctrl5
  call void @UpdateUser_data_registered_itu_t_t35.79()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_UpdateUser_data_registered_itu_t_t35.27, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_UpdateUser_data_registered_itu_t_t35.29, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_UpdateUser_data_registered_itu_t_t35.31, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_UpdateUser_data_registered_itu_t_t35.54, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_UpdateUser_data_registered_itu_t_t35.57, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_UpdateUser_data_registered_itu_t_t35.73, label %func_UpdateUser_data_registered_itu_t_t35.79
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FinalizeUser_data_registered_itu_t_t35.25, label %ctrl0

func_FinalizeUser_data_registered_itu_t_t35.25:   ; preds = %rand_bb
  call void @FinalizeUser_data_registered_itu_t_t35.25()
  ret void

func_FinalizeUser_data_registered_itu_t_t35.30:   ; preds = %ctrl0
  call void @FinalizeUser_data_registered_itu_t_t35.30()
  ret void

func_FinalizeUser_data_registered_itu_t_t35.45:   ; preds = %ctrl1
  call void @FinalizeUser_data_registered_itu_t_t35.45()
  ret void

func_FinalizeUser_data_registered_itu_t_t35.48:   ; preds = %ctrl2
  call void @FinalizeUser_data_registered_itu_t_t35.48()
  ret void

func_FinalizeUser_data_registered_itu_t_t35.62:   ; preds = %ctrl3
  call void @FinalizeUser_data_registered_itu_t_t35.62()
  ret void

func_FinalizeUser_data_registered_itu_t_t35.78:   ; preds = %ctrl3
  call void @FinalizeUser_data_registered_itu_t_t35.78()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_FinalizeUser_data_registered_itu_t_t35.30, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_FinalizeUser_data_registered_itu_t_t35.45, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_FinalizeUser_data_registered_itu_t_t35.48, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_FinalizeUser_data_registered_itu_t_t35.62, label %func_FinalizeUser_data_registered_itu_t_t35.78
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FinalizeRandomAccess.10, label %func_FinalizeRandomAccess.16

func_FinalizeRandomAccess.10:                     ; preds = %rand_bb
  call void @FinalizeRandomAccess.10()
  ret void

func_FinalizeRandomAccess.16:                     ; preds = %rand_bb
  call void @FinalizeRandomAccess.16()
  ret void
}
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_sei_message.1(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type) #0 {
entry:
  %offset = alloca i32, align 4
  %canary = alloca i32
  store i32 939751218, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_sei_message.2(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type) #0 {
entry:
  %canary = alloca i32
  store i32 1471645698, i32* %canary
  %payload.addr = alloca i8*, align 8
  %offset = alloca i32, align 4
  %size = alloca i32, align 4
  %payload_size.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSubseqInfo.3(i32 %currLayer) #0 {
entry:
  %currLayer.addr = alloca i32, align 4
  %sym = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 1114666993, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSceneInformation.4() #0 {
entry:
  %dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 941206223, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.scene_information_struct, %struct.scene_information_struct* @seiSceneInformation, i32 0, i32 3), align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSceneInformation.5() #0 {
entry:
  %canary = alloca i32
  store i32 231384136, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %dest = alloca %struct.Bitstream*, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.scene_information_struct, %struct.scene_information_struct* @seiSceneInformation, i32 0, i32 3), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateSceneInformation.6(i32 %HasSceneInformation, i32 %sceneID, i32 %sceneTransType, i32 %secondSceneID) #0 {
entry:
  %sceneID.addr = alloca i32, align 4
  %secondSceneID.addr = alloca i32, align 4
  %sceneTransType.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1172009202, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @ComposeSparePictureMessage.7(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream) #0 {
entry:
  %delta_spare_frame_num.addr = alloca i32, align 4
  %sym = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 201909108, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSpareMBMap.8() #0 {
entry:
  %source = alloca %struct.Bitstream*, align 8
  %sym = alloca %struct.syntaxelement, align 8
  %CurrFrameNum = alloca i32, align 4
  %canary = alloca i32
  store i32 117045149, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateSceneInformation.9(i32 %HasSceneInformation, i32 %sceneID, i32 %sceneTransType, i32 %secondSceneID) #0 {
entry:
  %sceneTransType.addr = alloca i32, align 4
  %secondSceneID.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1819591822, i32* %canary
  %HasSceneInformation.addr = alloca i32, align 4
  %sceneID.addr = alloca i32, align 4
  store i32 %HasSceneInformation, i32* %HasSceneInformation.addr, align 4
  store i32 %sceneID, i32* %sceneID.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 1437628940, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %dest = alloca %struct.Bitstream*, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.randomaccess_information_struct, %struct.randomaccess_information_struct* @seiRandomAccess, i32 0, i32 3), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @finalize_sei_message.11(i32 %id) #0 {
entry:
  %canary = alloca i32
  store i32 1705889685, i32* %canary
  %id.addr = alloca i32, align 4
  %offset = alloca i32, align 4
  store i32 %id, i32* %id.addr, align 4
  %0 = load i32, i32* %id.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @finalize_sei_message.12(i32 %id) #0 {
entry:
  %offset = alloca i32, align 4
  %canary = alloca i32
  store i32 2111063788, i32* %canary
  %id.addr = alloca i32, align 4
  store i32 %id, i32* %id.addr, align 4
  %0 = load i32, i32* %id.addr, align 4
  %idxprom = sext i32 %0 to i64
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @ComposeSparePictureMessage.13(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream) #0 {
entry:
  %tmpBitstream.addr = alloca %struct.Bitstream*, align 8
  %delta_spare_frame_num.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1943851428, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %bitstream = alloca %struct.Bitstream*, align 8
  %ref_area_indicator.addr = alloca i32, align 4
  store i32 %delta_spare_frame_num, i32* %delta_spare_frame_num.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateUser_data_registered_itu_t_t35.14() #0 {
entry:
  %i = alloca i32, align 4
  %total_byte = alloca i32, align 4
  %temp_data = alloca i32, align 4
  %canary = alloca i32
  store i32 455619716, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @AppendTmpbits2Buf.15(%struct.Bitstream* %dest, %struct.Bitstream* %source) #0 {
entry:
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %source.addr = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 793901567, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeRandomAccess.16() #0 {
entry:
  %dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 791105563, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.randomaccess_information_struct, %struct.randomaccess_information_struct* @seiRandomAccess, i32 0, i32 3), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
  %type = getelementptr inbounds %struct.syntaxelement, %struct.syntaxelement* %sym, i32 0, i32 0
...
entry:
  %payload.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 255533285, i32* %canary
  %payload_size.addr = alloca i32, align 4
  %type = alloca i32, align 4
  %payload_type.addr = alloca i32, align 4
  %id.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @ComposeSparePictureMessage.18(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream) #0 {
entry:
  %delta_spare_frame_num.addr = alloca i32, align 4
  %tmpBitstream.addr = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 1891447182, i32* %canary
  %ref_area_indicator.addr = alloca i32, align 4
  %sym = alloca %struct.syntaxelement, align 8
  %bitstream = alloca %struct.Bitstream*, align 8
  store i32 %delta_spare_frame_num, i32* %delta_spare_frame_num.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @ComposeSparePictureMessage.19(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream) #0 {
entry:
  %ref_area_indicator.addr = alloca i32, align 4
  %bitstream = alloca %struct.Bitstream*, align 8
  %delta_spare_frame_num.addr = alloca i32, align 4
  %sym = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 1948295254, i32* %canary
  %tmpBitstream.addr = alloca %struct.Bitstream*, align 8
  store i32 %delta_spare_frame_num, i32* %delta_spare_frame_num.addr, align 4
  store i32 %ref_area_indicator, i32* %ref_area_indicator.addr, align 4
  store %struct.Bitstream* %tmpBitstream, %struct.Bitstream** %tmpBitstream.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizePanScanRectInfo.20() #0 {
entry:
  %sym = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 1274310941, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.panscanrect_information_struct, %struct.panscanrect_information_struct* @seiPanScanRectInfo, i32 0, i32 5), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
  %type = getelementptr inbounds %struct.syntaxelement, %struct.syntaxelement* %sym, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeUser_data_unregistered.21() #0 {
entry:
  %sym = alloca %struct.syntaxelement, align 8
  %dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 1988128281, i32* %canary
  %i = alloca i32, align 4
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_unregistered_information_struct, %struct.user_data_unregistered_information_struct* @seiUser_data_unregistered, i32 0, i32 2), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
  %type = getelementptr inbounds %struct.syntaxelement, %struct.syntaxelement* %sym, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizePanScanRectInfo.22() #0 {
entry:
  %canary = alloca i32
  store i32 1216227539, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  %sym = alloca %struct.syntaxelement, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.panscanrect_information_struct, %struct.panscanrect_information_struct* @seiPanScanRectInfo, i32 0, i32 5), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSubseqChar.23() #0 {
entry:
  %sym = alloca %struct.syntaxelement, align 8
  %dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 1085168998, i32* %canary
  %i = alloca i32, align 4
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.subseq_char_information_struct, %struct.subseq_char_information_struct* @seiSubseqChar, i32 0, i32 10), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
  %type = getelementptr inbounds %struct.syntaxelement, %struct.syntaxelement* %sym, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSubseqInfo.24(i32 %currLayer) #0 {
entry:
  %dest = alloca %struct.Bitstream*, align 8
  %sym = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 890827723, i32* %canary
  %currLayer.addr = alloca i32, align 4
  store i32 %currLayer, i32* %currLayer.addr, align 4
  %0 = load i32, i32* %currLayer.addr, align 4
  %idxprom = sext i32 %0 to i64
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeUser_data_registered_itu_t_t35.25() #0 {
entry:
  %dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 975358427, i32* %canary
  %i = alloca i32, align 4
  %sym = alloca %struct.syntaxelement, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_registered_itu_t_t35_information_struct, %struct.user_data_registered_itu_t_t35_information_struct* @seiUser_data_registered_itu_t_t35, i32 0, i32 4), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateSceneInformation.26(i32 %HasSceneInformation, i32 %sceneID, i32 %sceneTransType, i32 %secondSceneID) #0 {
entry:
  %sceneTransType.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1898314692, i32* %canary
  %secondSceneID.addr = alloca i32, align 4
  %sceneID.addr = alloca i32, align 4
  %HasSceneInformation.addr = alloca i32, align 4
  store i32 %HasSceneInformation, i32* %HasSceneInformation.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateUser_data_registered_itu_t_t35.27() #0 {
entry:
  %canary = alloca i32
  store i32 1508399051, i32* %canary
  %country_code = alloca i32, align 4
  %i = alloca i32, align 4
  %total_byte = alloca i32, align 4
  %temp_data = alloca i32, align 4
...
entry:
  %sym = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 324172314, i32* %canary
  %i = alloca i32, align 4
  %dest = alloca %struct.Bitstream*, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.subseq_char_information_struct, %struct.subseq_char_information_struct* @seiSubseqChar, i32 0, i32 10), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateUser_data_registered_itu_t_t35.29() #0 {
entry:
  %canary = alloca i32
  store i32 4761799, i32* %canary
  %i = alloca i32, align 4
  %country_code = alloca i32, align 4
  %total_byte = alloca i32, align 4
  %temp_data = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeUser_data_registered_itu_t_t35.30() #0 {
entry:
  %sym = alloca %struct.syntaxelement, align 8
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1159831632, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_registered_itu_t_t35_information_struct, %struct.user_data_registered_itu_t_t35_information_struct* @seiUser_data_registered_itu_t_t35, i32 0, i32 4), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
  %type = getelementptr inbounds %struct.syntaxelement, %struct.syntaxelement* %sym, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateUser_data_registered_itu_t_t35.31() #0 {
entry:
  %canary = alloca i32
  store i32 1082983468, i32* %canary
  %total_byte = alloca i32, align 4
  %i = alloca i32, align 4
  %temp_data = alloca i32, align 4
  %country_code = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_sei_message.32(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type) #0 {
entry:
  %size = alloca i32, align 4
  %canary = alloca i32
  store i32 201922957, i32* %canary
  %type = alloca i32, align 4
  %payload_type.addr = alloca i32, align 4
  %id.addr = alloca i32, align 4
  %payload_size.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSubseqInfo.33(i32 %currLayer) #0 {
entry:
  %sym = alloca %struct.syntaxelement, align 8
  %dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 2127936645, i32* %canary
  %currLayer.addr = alloca i32, align 4
  store i32 %currLayer, i32* %currLayer.addr, align 4
  %0 = load i32, i32* %currLayer.addr, align 4
  %idxprom = sext i32 %0 to i64
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_sei_message.34(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type) #0 {
entry:
  %id.addr = alloca i32, align 4
  %type = alloca i32, align 4
  %payload_size.addr = alloca i32, align 4
  ...
  %offset = alloca i32, align 4
  %canary = alloca i32
  store i32 1147725518, i32* %canary
  %payload.addr = alloca i8*, align 8
  %payload_type.addr = alloca i32, align 4
  store i32 %id, i32* %id.addr, align 4
  store i8* %payload, i8** %payload.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 668701411, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  %sym = alloca %struct.syntaxelement, align 8
  %i = alloca i32, align 4
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.subseq_char_information_struct, %struct.subseq_char_information_struct* @seiSubseqChar, i32 0, i32 10), align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateSceneInformation.36(i32 %HasSceneInformation, i32 %sceneID, i32 %sceneTransType, i32 %secondSceneID) #0 {
entry:
  %sceneTransType.addr = alloca i32, align 4
  %HasSceneInformation.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1628624762, i32* %canary
  %secondSceneID.addr = alloca i32, align 4
  %sceneID.addr = alloca i32, align 4
  store i32 %HasSceneInformation, i32* %HasSceneInformation.addr, align 4
  store i32 %sceneID, i32* %sceneID.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeUser_data_unregistered.37() #0 {
entry:
  %dest = alloca %struct.Bitstream*, align 8
  %sym = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 126626125, i32* %canary
  %i = alloca i32, align 4
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_unregistered_information_struct, %struct.user_data_unregistered_information_struct* @seiUser_data_unregistered, i32 0, i32 2), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
  %type = getelementptr inbounds %struct.syntaxelement, %struct.syntaxelement* %sym, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateUser_data_unregistered.38() #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 521243525, i32* %canary
  %total_byte = alloca i32, align 4
  %temp_data = alloca i32, align 4
  store i32 7, i32* %total_byte, align 4
  store i32 0, i32* %i, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_sei_message.39(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type) #0 {
entry:
  %payload.addr = alloca i8*, align 8
  %size = alloca i32, align 4
  %payload_type.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1502077376, i32* %canary
  %id.addr = alloca i32, align 4
  %offset = alloca i32, align 4
  %payload_size.addr = alloca i32, align 4
  %type = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSpareMBMap.40() #0 {
entry:
  %CurrFrameNum = alloca i32, align 4
  %delta_frame_num = alloca i32, align 4
  %sym = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 1650729258, i32* %canary
  %source = alloca %struct.Bitstream*, align 8
  %dest = alloca %struct.Bitstream*, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %number = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @ComposeSparePictureMessage.41(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream) #0 {
entry:
  %tmpBitstream.addr = alloca %struct.Bitstream*, align 8
  %delta_spare_frame_num.addr = alloca i32, align 4
  %ref_area_indicator.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1062855067, i32* %canary
  %bitstream = alloca %struct.Bitstream*, align 8
  %sym = alloca %struct.syntaxelement, align 8
  store i32 %delta_spare_frame_num, i32* %delta_spare_frame_num.addr, align 4
  store i32 %ref_area_indicator, i32* %ref_area_indicator.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @ComposeSparePictureMessage.42(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream) #0 {
entry:
  %ref_area_indicator.addr = alloca i32, align 4
  %delta_spare_frame_num.addr = alloca i32, align 4
  %tmpBitstream.addr = alloca %struct.Bitstream*, align 8
  %sym = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 844517229, i32* %canary
  %bitstream = alloca %struct.Bitstream*, align 8
  store i32 %delta_spare_frame_num, i32* %delta_spare_frame_num.addr, align 4
  store i32 %ref_area_indicator, i32* %ref_area_indicator.addr, align 4
  store %struct.Bitstream* %tmpBitstream, %struct.Bitstream** %tmpBitstream.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSubseqInfo.43(i32 %currLayer) #0 {
entry:
  %dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 1815645486, i32* %canary
  %currLayer.addr = alloca i32, align 4
  %sym = alloca %struct.syntaxelement, align 8
  store i32 %currLayer, i32* %currLayer.addr, align 4
  %0 = load i32, i32* %currLayer.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_sei_message.44(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type) #0 {
entry:
  %type = alloca i32, align 4
  %payload.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 230058805, i32* %canary
  %id.addr = alloca i32, align 4
  %payload_size.addr = alloca i32, align 4
  %size = alloca i32, align 4
  %payload_type.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeUser_data_registered_itu_t_t35.45() #0 {
entry:
  %canary = alloca i32
  store i32 1375972333, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  %sym = alloca %struct.syntaxelement, align 8
  %i = alloca i32, align 4
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_registered_itu_t_t35_information_struct, %struct.user_data_registered_itu_t_t35_information_struct* @seiUser_data_registered_itu_t_t35, i32 0, i32 4), align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_sei_message.46(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type) #0 {
entry:
  %payload_size.addr = alloca i32, align 4
  %size = alloca i32, align 4
  %payload_type.addr = alloca i32, align 4
  ...
  %payload.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 2091305855, i32* %canary
  %offset = alloca i32, align 4
  store i32 %id, i32* %id.addr, align 4
  store i8* %payload, i8** %payload.addr, align 8
  store i32 %payload_size, i32* %payload_size.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @CompressSpareMBMap.47(i8** %map_sp, %struct.Bitstream* %bitstream) #0 {
entry:
  %ret = alloca i32, align 4
  %bitstream.addr = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 724645274, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeUser_data_registered_itu_t_t35.48() #0 {
entry:
  %sym = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 1934798027, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  %i = alloca i32, align 4
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_registered_itu_t_t35_information_struct, %struct.user_data_registered_itu_t_t35_information_struct* @seiUser_data_registered_itu_t_t35, i32 0, i32 4), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @AppendTmpbits2Buf.49(%struct.Bitstream* %dest, %struct.Bitstream* %source) #0 {
entry:
  %i = alloca i32, align 4
  %dest.addr = alloca %struct.Bitstream*, align 8
  %bits_in_last_byte = alloca i32, align 4
  %mask = alloca i8, align 1
  %canary = alloca i32
  store i32 1073625910, i32* %canary
  %source.addr = alloca %struct.Bitstream*, align 8
  %j = alloca i32, align 4
  store %struct.Bitstream* %dest, %struct.Bitstream** %dest.addr, align 8
  store %struct.Bitstream* %source, %struct.Bitstream** %source.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSubseqLayerInfo.50() #0 {
entry:
  %pos = alloca i32, align 4
  %canary = alloca i32
  store i32 1679568370, i32* %canary
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSubseqLayerInfo.51() #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 225640615, i32* %canary
  %pos = alloca i32, align 4
  store i32 0, i32* %pos, align 4
  store i32 0, i32* getelementptr inbounds (%struct.subseq_layer_information_struct, %struct.subseq_layer_information_struct* @seiSubseqLayerInfo, i32 0, i32 4), align 4
  store i32 0, i32* %i, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSpareMBMap.52() #0 {
entry:
  %canary = alloca i32
  store i32 1105346221, i32* %canary
  %CurrFrameNum = alloca i32, align 4
  %sym = alloca %struct.syntaxelement, align 8
  %dest = alloca %struct.Bitstream*, align 8
  %source = alloca %struct.Bitstream*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateSceneInformation.53(i32 %HasSceneInformation, i32 %sceneID, i32 %sceneTransType, i32 %secondSceneID) #0 {
entry:
  %HasSceneInformation.addr = alloca i32, align 4
  %sceneTransType.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1815091634, i32* %canary
  %sceneID.addr = alloca i32, align 4
  %secondSceneID.addr = alloca i32, align 4
  store i32 %HasSceneInformation, i32* %HasSceneInformation.addr, align 4
  store i32 %sceneID, i32* %sceneID.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateUser_data_registered_itu_t_t35.54() #0 {
entry:
  %country_code = alloca i32, align 4
  %canary = alloca i32
  store i32 1405061589, i32* %canary
  %i = alloca i32, align 4
  %temp_data = alloca i32, align 4
  %total_byte = alloca i32, align 4
  store i32 82, i32* %country_code, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSpareMBMap.55() #0 {
entry:
  %CurrFrameNum = alloca i32, align 4
  %sym = alloca %struct.syntaxelement, align 8
  %delta_frame_num = alloca i32, align 4
  %source = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 522953537, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %number = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 0
  %1 = load i32, i32* %number, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSubseqChar.56() #0 {
entry:
  %dest = alloca %struct.Bitstream*, align 8
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 2079344713, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.subseq_char_information_struct, %struct.subseq_char_information_struct* @seiSubseqChar, i32 0, i32 10), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
  %type = getelementptr inbounds %struct.syntaxelement, %struct.syntaxelement* %sym, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateUser_data_registered_itu_t_t35.57() #0 {
entry:
  %canary = alloca i32
  store i32 1648515195, i32* %canary
  %i = alloca i32, align 4
  %temp_data = alloca i32, align 4
  %country_code = alloca i32, align 4
  %total_byte = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeUser_data_unregistered.58() #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 759561380, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  %sym = alloca %struct.syntaxelement, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_unregistered_information_struct, %struct.user_data_unregistered_information_struct* @seiUser_data_unregistered, i32 0, i32 2), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSubseqInfo.59(i32 %currLayer) #0 {
entry:
  %sym = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 1864263731, i32* %canary
  %currLayer.addr = alloca i32, align 4
  %dest = alloca %struct.Bitstream*, align 8
  store i32 %currLayer, i32* %currLayer.addr, align 4
  %0 = load i32, i32* %currLayer.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSubseqInfo.60(i32 %currLayer) #0 {
entry:
  %currLayer.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1798087102, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  %sym = alloca %struct.syntaxelement, align 8
  store i32 %currLayer, i32* %currLayer.addr, align 4
  %0 = load i32, i32* %currLayer.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @ComposeSparePictureMessage.61(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream) #0 {
entry:
  %sym = alloca %struct.syntaxelement, align 8
  %bitstream = alloca %struct.Bitstream*, align 8
  %delta_spare_frame_num.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 461141726, i32* %canary
  %tmpBitstream.addr = alloca %struct.Bitstream*, align 8
  %ref_area_indicator.addr = alloca i32, align 4
  store i32 %delta_spare_frame_num, i32* %delta_spare_frame_num.addr, align 4
  store i32 %ref_area_indicator, i32* %ref_area_indicator.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeUser_data_registered_itu_t_t35.62() #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1767330807, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %dest = alloca %struct.Bitstream*, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_registered_itu_t_t35_information_struct, %struct.user_data_registered_itu_t_t35_information_struct* @seiUser_data_registered_itu_t_t35, i32 0, i32 4), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeUser_data_unregistered.63() #0 {
entry:
  %i = alloca i32, align 4
  %sym = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 487060597, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_unregistered_information_struct, %struct.user_data_unregistered_information_struct* @seiUser_data_unregistered, i32 0, i32 2), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
  %type = getelementptr inbounds %struct.syntaxelement, %struct.syntaxelement* %sym, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @AppendTmpbits2Buf.64(%struct.Bitstream* %dest, %struct.Bitstream* %source) #0 {
entry:
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %bits_in_last_byte = alloca i32, align 4
  %canary = alloca i32
  store i32 30675377, i32* %canary
  %source.addr = alloca %struct.Bitstream*, align 8
  %dest.addr = alloca %struct.Bitstream*, align 8
  %mask = alloca i8, align 1
  store %struct.Bitstream* %dest, %struct.Bitstream** %dest.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @AppendTmpbits2Buf.65(%struct.Bitstream* %dest, %struct.Bitstream* %source) #0 {
entry:
  %canary = alloca i32
  store i32 1046308452, i32* %canary
  %dest.addr = alloca %struct.Bitstream*, align 8
  %i = alloca i32, align 4
  %bits_in_last_byte = alloca i32, align 4
  %source.addr = alloca %struct.Bitstream*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSubseqChar.66() #0 {
entry:
  %canary = alloca i32
  store i32 144921651, i32* %canary
  %i = alloca i32, align 4
  %dest = alloca %struct.Bitstream*, align 8
  %sym = alloca %struct.syntaxelement, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.subseq_char_information_struct, %struct.subseq_char_information_struct* @seiSubseqChar, i32 0, i32 10), align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @ComposeSparePictureMessage.67(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream) #0 {
entry:
  %tmpBitstream.addr = alloca %struct.Bitstream*, align 8
  %sym = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 2129880819, i32* %canary
  %ref_area_indicator.addr = alloca i32, align 4
  %delta_spare_frame_num.addr = alloca i32, align 4
  %bitstream = alloca %struct.Bitstream*, align 8
  store i32 %delta_spare_frame_num, i32* %delta_spare_frame_num.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 346500313, i32* %canary
  %secondSceneID.addr = alloca i32, align 4
  %HasSceneInformation.addr = alloca i32, align 4
  %sceneTransType.addr = alloca i32, align 4
  %sceneID.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSubseqChar.69() #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 159672559, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %dest = alloca %struct.Bitstream*, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.subseq_char_information_struct, %struct.subseq_char_information_struct* @seiSubseqChar, i32 0, i32 10), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSpareMBMap.70() #0 {
entry:
  %dest = alloca %struct.Bitstream*, align 8
  %source = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 1734609202, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %CurrFrameNum = alloca i32, align 4
  %delta_frame_num = alloca i32, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateUser_data_unregistered.71() #0 {
entry:
  %i = alloca i32, align 4
  %temp_data = alloca i32, align 4
  %canary = alloca i32
  store i32 825728819, i32* %canary
  %total_byte = alloca i32, align 4
  store i32 7, i32* %total_byte, align 4
  store i32 0, i32* %i, align 4
  br label %for.cond
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateSceneInformation.72(i32 %HasSceneInformation, i32 %sceneID, i32 %sceneTransType, i32 %secondSceneID) #0 {
entry:
  %sceneTransType.addr = alloca i32, align 4
  %HasSceneInformation.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1080989077, i32* %canary
  %sceneID.addr = alloca i32, align 4
  %secondSceneID.addr = alloca i32, align 4
  store i32 %HasSceneInformation, i32* %HasSceneInformation.addr, align 4
  store i32 %sceneID, i32* %sceneID.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateUser_data_registered_itu_t_t35.73() #0 {
entry:
  %total_byte = alloca i32, align 4
  %temp_data = alloca i32, align 4
  %canary = alloca i32
  store i32 127980632, i32* %canary
  %i = alloca i32, align 4
  %country_code = alloca i32, align 4
  store i32 82, i32* %country_code, align 4
  %0 = load i32, i32* %country_code, align 4
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 745509803, i32* %canary
  %temp_data = alloca i32, align 4
  store i32 7, i32* %total_byte, align 4
  store i32 0, i32* %i, align 4
  br label %for.cond
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeUser_data_unregistered.75() #0 {
entry:
  %canary = alloca i32
  store i32 1942013722, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  %i = alloca i32, align 4
  %sym = alloca %struct.syntaxelement, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_unregistered_information_struct, %struct.user_data_unregistered_information_struct* @seiUser_data_unregistered, i32 0, i32 2), align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeUser_data_unregistered.76() #0 {
entry:
  %sym = alloca %struct.syntaxelement, align 8
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1543447235, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_unregistered_information_struct, %struct.user_data_unregistered_information_struct* @seiUser_data_unregistered, i32 0, i32 2), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
  %type = getelementptr inbounds %struct.syntaxelement, %struct.syntaxelement* %sym, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSpareMBMap.77() #0 {
entry:
  %canary = alloca i32
  store i32 2083188943, i32* %canary
  %source = alloca %struct.Bitstream*, align 8
  %delta_frame_num = alloca i32, align 4
  %sym = alloca %struct.syntaxelement, align 8
  %dest = alloca %struct.Bitstream*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeUser_data_registered_itu_t_t35.78() #0 {
entry:
  %i = alloca i32, align 4
  %dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 1384559657, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_registered_itu_t_t35_information_struct, %struct.user_data_registered_itu_t_t35_information_struct* @seiUser_data_registered_itu_t_t35, i32 0, i32 4), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
  %type = getelementptr inbounds %struct.syntaxelement, %struct.syntaxelement* %sym, i32 0, i32 0
...
entry:
  ...
  %total_byte = alloca i32, align 4
  %canary = alloca i32
  store i32 959484039, i32* %canary
  %country_code = alloca i32, align 4
  store i32 82, i32* %country_code, align 4
  %0 = load i32, i32* %country_code, align 4
  %cmp = icmp slt i32 %0, 255
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateSceneInformation.80(i32 %HasSceneInformation, i32 %sceneID, i32 %sceneTransType, i32 %secondSceneID) #0 {
entry:
  %sceneTransType.addr = alloca i32, align 4
  %sceneID.addr = alloca i32, align 4
  %secondSceneID.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 620842731, i32* %canary
  %HasSceneInformation.addr = alloca i32, align 4
  store i32 %HasSceneInformation, i32* %HasSceneInformation.addr, align 4
  store i32 %sceneID, i32* %sceneID.addr, align 4
  store i32 %sceneTransType, i32* %sceneTransType.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @CompressSpareMBMap.81(i8** %map_sp, %struct.Bitstream* %bitstream) #0 {
entry:
  %directy = alloca i32, align 4
  %right = alloca i32, align 4
  %left = alloca i32, align 4
  ...
  %k = alloca i32, align 4
  %canary = alloca i32
  store i32 848434023, i32* %canary
  %noc = alloca i32, align 4
  %bitstream.addr = alloca %struct.Bitstream*, align 8
  %bit0 = alloca i32, align 4
  %x = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSpareMBMap.82() #0 {
entry:
  %CurrFrameNum = alloca i32, align 4
  %dest = alloca %struct.Bitstream*, align 8
  %sym = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 1920465547, i32* %canary
  %source = alloca %struct.Bitstream*, align 8
  %delta_frame_num = alloca i32, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %number = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateUser_data_unregistered.83() #0 {
entry:
  %temp_data = alloca i32, align 4
  %canary = alloca i32
  store i32 1468007096, i32* %canary
  %i = alloca i32, align 4
  %total_byte = alloca i32, align 4
  store i32 7, i32* %total_byte, align 4
  store i32 0, i32* %i, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @AppendTmpbits2Buf.84(%struct.Bitstream* %dest, %struct.Bitstream* %source) #0 {
entry:
  %source.addr = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 425974403, i32* %canary
  %bits_in_last_byte = alloca i32, align 4
  %j = alloca i32, align 4
  %mask = alloca i8, align 1
  %dest.addr = alloca %struct.Bitstream*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateUser_data_unregistered.85() #0 {
entry:
  %temp_data = alloca i32, align 4
  %canary = alloca i32
  store i32 217537012, i32* %canary
  %total_byte = alloca i32, align 4
  %i = alloca i32, align 4
  store i32 7, i32* %total_byte, align 4
  store i32 0, i32* %i, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateUser_data_unregistered.86() #0 {
entry:
  %canary = alloca i32
  store i32 947540572, i32* %canary
  %total_byte = alloca i32, align 4
  %temp_data = alloca i32, align 4
  %i = alloca i32, align 4
  store i32 7, i32* %total_byte, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSpareMBMap.87() #0 {
entry:
  %canary = alloca i32
  store i32 1472795166, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %source = alloca %struct.Bitstream*, align 8
  %dest = alloca %struct.Bitstream*, align 8
  %CurrFrameNum = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @CompressSpareMBMap.88(i8** %map_sp, %struct.Bitstream* %bitstream) #0 {
entry:
  %directy = alloca i32, align 4
  %left = alloca i32, align 4
  %noc = alloca i32, align 4
  ...
  %y = alloca i32, align 4
  %canary = alloca i32
  store i32 773475229, i32* %canary
  %bit0 = alloca i32, align 4
  %bit1 = alloca i32, align 4
  %k = alloca i32, align 4
  %bottom = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @CompressSpareMBMap.89(i8** %map_sp, %struct.Bitstream* %bitstream) #0 {
entry:
  %y = alloca i32, align 4
  %size_compressed = alloca i32, align 4
  %j = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @CompressSpareMBMap.90(i8** %map_sp, %struct.Bitstream* %bitstream) #0 {
entry:
  %x = alloca i32, align 4
  %noc = alloca i32, align 4
  %canary = alloca i32
  store i32 1012565090, i32* %canary
  %ret = alloca i32, align 4
  %bitc = alloca i32, align 4
  %bit0 = alloca i32, align 4
  %size_uncompressed = alloca i32, align 4
...
if.end190:                                        ; preds = %for.end189, %if.end141
  %121 = load i32, i32* %ret, align 4
  %122 = load i32, i32* %canary
  %123 = icmp eq i32 %122, 1012565090
  br i1 %123, label %124, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @AppendTmpbits2Buf.91(%struct.Bitstream* %dest, %struct.Bitstream* %source) #0 {
entry:
  %bits_in_last_byte = alloca i32, align 4
  %canary = alloca i32
  store i32 744699599, i32* %canary
  %mask = alloca i8, align 1
  %source.addr = alloca %struct.Bitstream*, align 8
  %dest.addr = alloca %struct.Bitstream*, align 8
  %j = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @AppendTmpbits2Buf.92(%struct.Bitstream* %dest, %struct.Bitstream* %source) #0 {
entry:
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %mask = alloca i8, align 1
  %canary = alloca i32
  store i32 1324006105, i32* %canary
  %dest.addr = alloca %struct.Bitstream*, align 8
  %bits_in_last_byte = alloca i32, align 4
  %source.addr = alloca %struct.Bitstream*, align 8
  store %struct.Bitstream* %dest, %struct.Bitstream** %dest.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @CompressSpareMBMap.93(i8** %map_sp, %struct.Bitstream* %bitstream) #0 {
entry:
  %right = alloca i32, align 4
  %noc = alloca i32, align 4
  %directx = alloca i32, align 4
  ...
  %map_sp.addr = alloca i8**, align 8
  %canary = alloca i32
  store i32 2009116698, i32* %canary
  %size_uncompressed = alloca i32, align 4
  %left = alloca i32, align 4
  %sym = alloca %struct.syntaxelement, align 8
  %bit1 = alloca i32, align 4
...
if.end190:                                        ; preds = %for.end189, %if.end141
  %121 = load i32, i32* %ret, align 4
  %122 = load i32, i32* %canary
  %123 = icmp eq i32 %122, 2009116698
  br i1 %123, label %124, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @AppendTmpbits2Buf.94(%struct.Bitstream* %dest, %struct.Bitstream* %source) #0 {
entry:
  %canary = alloca i32
  store i32 1249003379, i32* %canary
  %bits_in_last_byte = alloca i32, align 4
  %dest.addr = alloca %struct.Bitstream*, align 8
  %mask = alloca i8, align 1
  %source.addr = alloca %struct.Bitstream*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @CompressSpareMBMap.95(i8** %map_sp, %struct.Bitstream* %bitstream) #0 {
entry:
  %j = alloca i32, align 4
  %bottom = alloca i32, align 4
  %sym = alloca %struct.syntaxelement, align 8
  ...
  %directx = alloca i32, align 4
  %canary = alloca i32
  store i32 354359281, i32* %canary
  %k = alloca i32, align 4
  %x = alloca i32, align 4
  %bit0 = alloca i32, align 4
  %bit1 = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @CompressSpareMBMap.96(i8** %map_sp, %struct.Bitstream* %bitstream) #0 {
entry:
  %directy = alloca i32, align 4
  %size_uncompressed = alloca i32, align 4
  %bottom = alloca i32, align 4
