; ModuleID = 'specrand.c.rand.4R1.bc'
...
entry:
  %canary = alloca i32
  store i32 1301356924, i32* %canary
...
entry:
  ...
  %lo = alloca i32, align 4
  %canary = alloca i32
  store i32 2012533519, i32* %canary
  %test = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
  %conv = sext i32 %0 to i64
  %div = sdiv i64 %conv, 127773
...
entry:
  %test = alloca i32, align 4
  %canary = alloca i32
  store i32 2057868741, i32* %canary
  %hi = alloca i32, align 4
  %lo = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
  %conv = sext i32 %0 to i64
...
entry:
  %test = alloca i32, align 4
  %canary = alloca i32
  store i32 1188657984, i32* %canary
  %lo = alloca i32, align 4
  %hi = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
  %conv = sext i32 %0 to i64
