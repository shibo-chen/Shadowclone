; ModuleID = 'intrarefresh.c.rand.4P1.bc'
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_RandomIntraInit.8, label %func_RandomIntraInit.9
}
...
ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_RandomIntra.6, label %func_RandomIntra.10
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_RandomIntraNewPicture.4, label %func_RandomIntraNewPicture.5
...
entry:
  %canary = alloca i32
  store i32 1441479185, i32* %canary
...
entry:
  %mb.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 606731207, i32* %canary
  %i = alloca i32, align 4
  %retval = alloca i32, align 4
  store i32 %mb, i32* %mb.addr, align 4
  store i32 0, i32* %i, align 4
...
entry:
  %canary = alloca i32
  store i32 1976034224, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1238124390, i32* %canary
  %i = alloca i32, align 4
...
entry:
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 664332178, i32* %canary
  %i = alloca i32, align 4
  %0 = load i32, i32* @NumberIntraPerPicture, align 4
  %1 = load i32, i32* @WalkAround, align 4
  %add = add nsw i32 %1, %0
...
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 2071258984, i32* %canary
  %retval = alloca i32, align 4
  %mb.addr = alloca i32, align 4
  store i32 %mb, i32* %mb.addr, align 4
  store i32 0, i32* %i, align 4
...
entry:
  ...
  %pos = alloca i32, align 4
  %canary = alloca i32
  store i32 415453695, i32* %canary
  %ysize.addr = alloca i32, align 4
  store i32 %xsize, i32* %xsize.addr, align 4
  store i32 %ysize, i32* %ysize.addr, align 4
  store i32 %refresh, i32* %refresh.addr, align 4
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1287944541, i32* %canary
  %refresh.addr = alloca i32, align 4
  %xsize.addr = alloca i32, align 4
  %ysize.addr = alloca i32, align 4
  store i32 %xsize, i32* %xsize.addr, align 4
...
entry:
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 749072368, i32* %canary
  %i = alloca i32, align 4
  %mb.addr = alloca i32, align 4
  store i32 %mb, i32* %mb.addr, align 4
  store i32 0, i32* %i, align 4
