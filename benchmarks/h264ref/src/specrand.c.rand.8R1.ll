; ModuleID = 'specrand.c.rand.8R1.bc'
...
entry:
  %canary = alloca i32
  store i32 228624052, i32* %canary
...
entry:
  ...
  %lo = alloca i32, align 4
  %canary = alloca i32
  store i32 594872010, i32* %canary
  %hi = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
  %conv = sext i32 %0 to i64
  %div = sdiv i64 %conv, 127773
...
entry:
  %lo = alloca i32, align 4
  %canary = alloca i32
  store i32 860937408, i32* %canary
  %hi = alloca i32, align 4
  %test = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
  %conv = sext i32 %0 to i64
...
entry:
  %canary = alloca i32
  store i32 643020533, i32* %canary
  %hi = alloca i32, align 4
  %lo = alloca i32, align 4
  %test = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
...
entry:
  ...
  %test = alloca i32, align 4
  %canary = alloca i32
  store i32 1219642326, i32* %canary
  %hi = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
  %conv = sext i32 %0 to i64
  %div = sdiv i64 %conv, 127773
