; ModuleID = 'output.c.rand.16P1.bc'
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_testEndian.2, label %func_testEndian.5

func_testEndian.2:                                ; preds = %rand_bb
  %2 = call i32 @testEndian.2()
  ret i32 %2

func_testEndian.5:                                ; preds = %rand_bb
  %3 = call i32 @testEndian.5()
  ret i32 %3
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_img2buf.1, label %ctrl0

func_img2buf.1:                                   ; preds = %rand_bb
  call void @img2buf.1(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom)
  ret void

func_img2buf.13:                                  ; preds = %ctrl0
  call void @img2buf.13(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom)
  ret void

func_img2buf.16:                                  ; preds = %ctrl1
  call void @img2buf.16(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom)
  ret void

func_img2buf.20:                                  ; preds = %ctrl2
  call void @img2buf.20(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom)
  ret void

func_img2buf.24:                                  ; preds = %ctrl3
  call void @img2buf.24(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom)
  ret void

func_img2buf.30:                                  ; preds = %ctrl4
...
func_img2buf.35:                                  ; preds = %ctrl5
  call void @img2buf.35(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom)
  ret void
...
func_img2buf.43:                                  ; preds = %ctrl7
  call void @img2buf.43(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom)
  ret void

func_img2buf.44:                                  ; preds = %ctrl8
  call void @img2buf.44(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom)
  ret void

func_img2buf.45:                                  ; preds = %ctrl9
  call void @img2buf.45(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom)
  ret void

func_img2buf.47:                                  ; preds = %ctrl10
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_img2buf.13, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_img2buf.16, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_img2buf.20, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_img2buf.24, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_img2buf.30, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_img2buf.35, label %ctrl6
...
ctrl7:                                            ; preds = %ctrl6
  %9 = icmp eq i32 %0, 8
  br i1 %9, label %func_img2buf.43, label %ctrl8

ctrl8:                                            ; preds = %ctrl7
  %10 = icmp eq i32 %0, 9
  br i1 %10, label %func_img2buf.44, label %ctrl9

ctrl9:                                            ; preds = %ctrl8
  %11 = icmp eq i32 %0, 10
  br i1 %11, label %func_img2buf.45, label %ctrl10

ctrl10:                                           ; preds = %ctrl9
  %12 = icmp eq i32 %0, 11
  br i1 %12, label %func_img2buf.47, label %ctrl11
...
func_write_picture.15:                            ; preds = %ctrl0
  call void @write_picture.15(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure)
  ret void

func_write_picture.18:                            ; preds = %ctrl1
  call void @write_picture.18(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure)
  ret void

func_write_picture.22:                            ; preds = %ctrl2
  call void @write_picture.22(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure)
  ret void

func_write_picture.38:                            ; preds = %ctrl3
  call void @write_picture.38(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure)
  ret void

func_write_picture.42:                            ; preds = %ctrl3
  call void @write_picture.42(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_write_picture.15, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_write_picture.18, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_write_picture.22, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_write_picture.38, label %func_write_picture.42
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_write_out_picture.4, label %ctrl0

func_write_out_picture.4:                         ; preds = %rand_bb
  call void @write_out_picture.4(%struct.storable_picture* %p, i32 %p_out)
  ret void

func_write_out_picture.7:                         ; preds = %ctrl0
  call void @write_out_picture.7(%struct.storable_picture* %p, i32 %p_out)
  ret void

func_write_out_picture.11:                        ; preds = %ctrl1
  call void @write_out_picture.11(%struct.storable_picture* %p, i32 %p_out)
  ret void

func_write_out_picture.17:                        ; preds = %ctrl2
  call void @write_out_picture.17(%struct.storable_picture* %p, i32 %p_out)
  ret void

func_write_out_picture.21:                        ; preds = %ctrl3
  call void @write_out_picture.21(%struct.storable_picture* %p, i32 %p_out)
  ret void

func_write_out_picture.23:                        ; preds = %ctrl4
  call void @write_out_picture.23(%struct.storable_picture* %p, i32 %p_out)
  ret void

func_write_out_picture.26:                        ; preds = %ctrl5
  call void @write_out_picture.26(%struct.storable_picture* %p, i32 %p_out)
  ret void

func_write_out_picture.27:                        ; preds = %ctrl6
  call void @write_out_picture.27(%struct.storable_picture* %p, i32 %p_out)
  ret void

func_write_out_picture.28:                        ; preds = %ctrl7
  call void @write_out_picture.28(%struct.storable_picture* %p, i32 %p_out)
  ret void

func_write_out_picture.29:                        ; preds = %ctrl8
  call void @write_out_picture.29(%struct.storable_picture* %p, i32 %p_out)
  ret void

func_write_out_picture.31:                        ; preds = %ctrl9
  call void @write_out_picture.31(%struct.storable_picture* %p, i32 %p_out)
  ret void

func_write_out_picture.36:                        ; preds = %ctrl10
  call void @write_out_picture.36(%struct.storable_picture* %p, i32 %p_out)
  ret void

func_write_out_picture.37:                        ; preds = %ctrl11
  call void @write_out_picture.37(%struct.storable_picture* %p, i32 %p_out)
  ret void

func_write_out_picture.40:                        ; preds = %ctrl12
  call void @write_out_picture.40(%struct.storable_picture* %p, i32 %p_out)
  ret void

func_write_out_picture.46:                        ; preds = %ctrl13
  call void @write_out_picture.46(%struct.storable_picture* %p, i32 %p_out)
  ret void

func_write_out_picture.48:                        ; preds = %ctrl13
  call void @write_out_picture.48(%struct.storable_picture* %p, i32 %p_out)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_write_out_picture.7, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_write_out_picture.11, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_write_out_picture.17, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_write_out_picture.21, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_write_out_picture.23, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_write_out_picture.26, label %ctrl6

ctrl6:                                            ; preds = %ctrl5
  %8 = icmp eq i32 %0, 7
  br i1 %8, label %func_write_out_picture.27, label %ctrl7

ctrl7:                                            ; preds = %ctrl6
  %9 = icmp eq i32 %0, 8
  br i1 %9, label %func_write_out_picture.28, label %ctrl8

ctrl8:                                            ; preds = %ctrl7
  %10 = icmp eq i32 %0, 9
  br i1 %10, label %func_write_out_picture.29, label %ctrl9

ctrl9:                                            ; preds = %ctrl8
  %11 = icmp eq i32 %0, 10
  br i1 %11, label %func_write_out_picture.31, label %ctrl10

ctrl10:                                           ; preds = %ctrl9
  %12 = icmp eq i32 %0, 11
  br i1 %12, label %func_write_out_picture.36, label %ctrl11

ctrl11:                                           ; preds = %ctrl10
  %13 = icmp eq i32 %0, 12
  br i1 %13, label %func_write_out_picture.37, label %ctrl12

ctrl12:                                           ; preds = %ctrl11
  %14 = icmp eq i32 %0, 13
  br i1 %14, label %func_write_out_picture.40, label %ctrl13

ctrl13:                                           ; preds = %ctrl12
  %15 = icmp eq i32 %0, 14
  br i1 %15, label %func_write_out_picture.46, label %func_write_out_picture.48
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_clear_picture.6, label %func_clear_picture.8

func_clear_picture.6:                             ; preds = %rand_bb
  call void @clear_picture.6(%struct.storable_picture* %p)
  ret void

func_clear_picture.8:                             ; preds = %rand_bb
  call void @clear_picture.8(%struct.storable_picture* %p)
  ret void
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_write_unpaired_field.12, label %ctrl0

func_write_unpaired_field.12:                     ; preds = %rand_bb
  call void @write_unpaired_field.12(%struct.frame_store* %fs, i32 %p_out)
  ret void

func_write_unpaired_field.14:                     ; preds = %ctrl0
  call void @write_unpaired_field.14(%struct.frame_store* %fs, i32 %p_out)
  ret void

func_write_unpaired_field.32:                     ; preds = %ctrl1
  call void @write_unpaired_field.32(%struct.frame_store* %fs, i32 %p_out)
  ret void

func_write_unpaired_field.33:                     ; preds = %ctrl2
  call void @write_unpaired_field.33(%struct.frame_store* %fs, i32 %p_out)
  ret void

func_write_unpaired_field.34:                     ; preds = %ctrl3
  call void @write_unpaired_field.34(%struct.frame_store* %fs, i32 %p_out)
  ret void

func_write_unpaired_field.41:                     ; preds = %ctrl3
  call void @write_unpaired_field.41(%struct.frame_store* %fs, i32 %p_out)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_write_unpaired_field.14, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_write_unpaired_field.32, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_write_unpaired_field.33, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_write_unpaired_field.34, label %func_write_unpaired_field.41
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_write_stored_frame.3, label %func_write_stored_frame.9

func_write_stored_frame.3:                        ; preds = %rand_bb
  call void @write_stored_frame.3(%struct.frame_store* %fs, i32 %p_out)
  ret void

func_write_stored_frame.9:                        ; preds = %rand_bb
  call void @write_stored_frame.9(%struct.frame_store* %fs, i32 %p_out)
  ret void
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_direct_output.19, label %func_direct_output.25

func_direct_output.19:                            ; preds = %rand_bb
  call void @direct_output.19(%struct.storable_picture* %p, i32 %p_out)
  ret void

func_direct_output.25:                            ; preds = %rand_bb
  call void @direct_output.25(%struct.storable_picture* %p, i32 %p_out)
  ret void
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @img2buf.1(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 1971256343, i32* %canary
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  ...
  %109 = icmp eq i32 %108, 1971256343
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @testEndian.2() #0 {
entry:
  %p = alloca i8*, align 8
  %canary = alloca i32
  store i32 1119273083, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_stored_frame.3(%struct.frame_store* %fs, i32 %p_out) #0 {
entry:
  %canary = alloca i32
  store i32 243214909, i32* %canary
  %p_out.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_out_picture.4(%struct.storable_picture* %p, i32 %p_out) #0 {
entry:
  %symbol_size_in_bytes = alloca i32, align 4
  %crop_top = alloca i32, align 4
  %canary = alloca i32
  store i32 708181615, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @testEndian.5() #0 {
entry:
  %canary = alloca i32
  store i32 1922422980, i32* %canary
  %s = alloca i16, align 2
  %p = alloca i8*, align 8
  %0 = bitcast i16* %s to i8*
  store i8* %0, i8** %p, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @clear_picture.6(%struct.storable_picture* %p) #0 {
entry:
  %canary = alloca i32
  store i32 1327828077, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  %i = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_out_picture.7(%struct.storable_picture* %p, i32 %p_out) #0 {
entry:
  %SubWidthC = alloca [4 x i32], align 16
  %crop_top = alloca i32, align 4
  %p_out.addr = alloca i32, align 4
  ...
  %crop_bottom = alloca i32, align 4
  %canary = alloca i32
  store i32 265766095, i32* %canary
  %crop_right = alloca i32, align 4
  %buf = alloca i8*, align 8
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @clear_picture.8(%struct.storable_picture* %p) #0 {
entry:
  %canary = alloca i32
  store i32 1878199830, i32* %canary
  %i = alloca i32, align 4
  %p.addr = alloca %struct.storable_picture*, align 8
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 0, i32* %i, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_stored_frame.9(%struct.frame_store* %fs, i32 %p_out) #0 {
entry:
  %canary = alloca i32
  store i32 1197976345, i32* %canary
  %fs.addr = alloca %struct.frame_store*, align 8
  %p_out.addr = alloca i32, align 4
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 1837411720, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  %p_out.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_out_picture.11(%struct.storable_picture* %p, i32 %p_out) #0 {
entry:
  %rgb_output = alloca i32, align 4
  %p.addr = alloca %struct.storable_picture*, align 8
  %SubWidthC = alloca [4 x i32], align 16
  ...
  %buf = alloca i8*, align 8
  %canary = alloca i32
  store i32 1200902966, i32* %canary
  %crop_right = alloca i32, align 4
  %symbol_size_in_bytes = alloca i32, align 4
  %crop_left = alloca i32, align 4
  %p_out.addr = alloca i32, align 4
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1200902966
  br i1 %193, label %194, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_unpaired_field.12(%struct.frame_store* %fs, i32 %p_out) #0 {
entry:
  %canary = alloca i32
  store i32 102981727, i32* %canary
  %fs.addr = alloca %struct.frame_store*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @img2buf.13(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom) #0 {
entry:
  %size = alloca i32, align 4
  %j = alloca i32, align 4
  %i = alloca i32, align 4
  ...
  %theight = alloca i32, align 4
  %canary = alloca i32
  store i32 714285356, i32* %canary
  %crop_left.addr = alloca i32, align 4
  %twidth = alloca i32, align 4
  %tmp32 = alloca i64, align 8
  %size_y.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_unpaired_field.14(%struct.frame_store* %fs, i32 %p_out) #0 {
entry:
  %fs.addr = alloca %struct.frame_store*, align 8
  %canary = alloca i32
  store i32 329798877, i32* %canary
  %p_out.addr = alloca i32, align 4
  %p = alloca %struct.storable_picture*, align 8
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_picture.15(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure) #0 {
entry:
  %p_out.addr = alloca i32, align 4
  %p.addr = alloca %struct.storable_picture*, align 8
  %canary = alloca i32
  store i32 2100834077, i32* %canary
  %real_structure.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  store i32 %real_structure, i32* %real_structure.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @img2buf.16(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom) #0 {
entry:
  %size_y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1627517133, i32* %canary
  %size_x.addr = alloca i32, align 4
  %j = alloca i32, align 4
  %symbol_size_in_bytes.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1627517133
  br i1 %109, label %110, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_out_picture.17(%struct.storable_picture* %p, i32 %p_out) #0 {
entry:
  %SubWidthC = alloca [4 x i32], align 16
  %SubHeightC = alloca [4 x i32], align 16
  %buf = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_picture.18(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure) #0 {
entry:
  %p.addr = alloca %struct.storable_picture*, align 8
  %real_structure.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 580984546, i32* %canary
  %p_out.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  store i32 %real_structure, i32* %real_structure.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @direct_output.19(%struct.storable_picture* %p, i32 %p_out) #0 {
entry:
  %p.addr = alloca %struct.storable_picture*, align 8
  %canary = alloca i32
  store i32 538352227, i32* %canary
  %p_out.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  %0 = load %struct.storable_picture*, %struct.storable_picture** %p.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @img2buf.20(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom) #0 {
entry:
  %ui16 = alloca i16, align 2
  %tmp32 = alloca i64, align 8
  %twidth = alloca i32, align 4
  ...
  %buf.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 184032566, i32* %canary
  %crop_right.addr = alloca i32, align 4
  %ui32 = alloca i64, align 8
  %j = alloca i32, align 4
  store i16** %imgX, i16*** %imgX.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_out_picture.21(%struct.storable_picture* %p, i32 %p_out) #0 {
entry:
  %SubWidthC = alloca [4 x i32], align 16
  %crop_bottom = alloca i32, align 4
  %canary = alloca i32
  store i32 300785359, i32* %canary
  %symbol_size_in_bytes = alloca i32, align 4
  %p_out.addr = alloca i32, align 4
  %crop_top = alloca i32, align 4
  %crop_left = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_picture.22(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure) #0 {
entry:
  %canary = alloca i32
  store i32 929337001, i32* %canary
  %p_out.addr = alloca i32, align 4
  %real_structure.addr = alloca i32, align 4
  %p.addr = alloca %struct.storable_picture*, align 8
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
...
entry:
  ...
  %crop_right = alloca i32, align 4
  %canary = alloca i32
  store i32 1494176622, i32* %canary
  %buf = alloca i8*, align 8
  %symbol_size_in_bytes = alloca i32, align 4
  %crop_top = alloca i32, align 4
  %SubHeightC = alloca [4 x i32], align 16
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1494176622
  br i1 %193, label %194, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @img2buf.24(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom) #0 {
entry:
  %i = alloca i32, align 4
  %crop_top.addr = alloca i32, align 4
  %ui16 = alloca i16, align 2
  ...
  %crop_left.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 889281087, i32* %canary
  %size_x.addr = alloca i32, align 4
  %crop_right.addr = alloca i32, align 4
  %crop_bottom.addr = alloca i32, align 4
  %ui32 = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @direct_output.25(%struct.storable_picture* %p, i32 %p_out) #0 {
entry:
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 887860449, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  %0 = load %struct.storable_picture*, %struct.storable_picture** %p.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_out_picture.26(%struct.storable_picture* %p, i32 %p_out) #0 {
entry:
  %crop_right = alloca i32, align 4
  %SubWidthC = alloca [4 x i32], align 16
  %symbol_size_in_bytes = alloca i32, align 4
  %crop_left = alloca i32, align 4
  %canary = alloca i32
  store i32 1414140487, i32* %canary
  %buf = alloca i8*, align 8
  %p_out.addr = alloca i32, align 4
  %rgb_output = alloca i32, align 4
  %p.addr = alloca %struct.storable_picture*, align 8
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1414140487
  br i1 %193, label %194, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_out_picture.27(%struct.storable_picture* %p, i32 %p_out) #0 {
entry:
  %p_out.addr = alloca i32, align 4
  %p.addr = alloca %struct.storable_picture*, align 8
  %canary = alloca i32
  store i32 39235330, i32* %canary
  %crop_right = alloca i32, align 4
  %rgb_output = alloca i32, align 4
  %symbol_size_in_bytes = alloca i32, align 4
  %crop_top = alloca i32, align 4
...
entry:
  ...
  %symbol_size_in_bytes = alloca i32, align 4
  %canary = alloca i32
  store i32 1793531676, i32* %canary
  %SubWidthC = alloca [4 x i32], align 16
  %SubHeightC = alloca [4 x i32], align 16
  %p_out.addr = alloca i32, align 4
  %rgb_output = alloca i32, align 4
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1793531676
  br i1 %193, label %194, label %func_exit
...
entry:
  ...
  %crop_right = alloca i32, align 4
  %canary = alloca i32
  store i32 1758948979, i32* %canary
  %rgb_output = alloca i32, align 4
  %buf = alloca i8*, align 8
  %crop_bottom = alloca i32, align 4
  %symbol_size_in_bytes = alloca i32, align 4
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1758948979
  br i1 %193, label %194, label %func_exit
...
entry:
  ...
  %size_x.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 855907299, i32* %canary
  %symbol_size_in_bytes.addr = alloca i32, align 4
  %crop_bottom.addr = alloca i32, align 4
  %size = alloca i32, align 4
  %tmp16 = alloca i16, align 2
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_out_picture.31(%struct.storable_picture* %p, i32 %p_out) #0 {
entry:
  %buf = alloca i8*, align 8
  %p.addr = alloca %struct.storable_picture*, align 8
  %crop_top = alloca i32, align 4
  ...
  %crop_bottom = alloca i32, align 4
  %canary = alloca i32
  store i32 1359439617, i32* %canary
  %symbol_size_in_bytes = alloca i32, align 4
  %SubWidthC = alloca [4 x i32], align 16
  %p_out.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1359439617
  br i1 %193, label %194, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_unpaired_field.32(%struct.frame_store* %fs, i32 %p_out) #0 {
entry:
  %p = alloca %struct.storable_picture*, align 8
  %canary = alloca i32
  store i32 716435747, i32* %canary
  %fs.addr = alloca %struct.frame_store*, align 8
  %p_out.addr = alloca i32, align 4
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_unpaired_field.33(%struct.frame_store* %fs, i32 %p_out) #0 {
entry:
  %canary = alloca i32
  store i32 1180854733, i32* %canary
  %p = alloca %struct.storable_picture*, align 8
  %p_out.addr = alloca i32, align 4
  %fs.addr = alloca %struct.frame_store*, align 8
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_unpaired_field.34(%struct.frame_store* %fs, i32 %p_out) #0 {
entry:
  %canary = alloca i32
  store i32 1749037017, i32* %canary
  %p_out.addr = alloca i32, align 4
  %p = alloca %struct.storable_picture*, align 8
  %fs.addr = alloca %struct.frame_store*, align 8
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @img2buf.35(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom) #0 {
entry:
  %size = alloca i32, align 4
  %tmp32 = alloca i64, align 8
  %ui8 = alloca i8, align 1
  ...
  %crop_right.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1974396627, i32* %canary
  %size_x.addr = alloca i32, align 4
  %j = alloca i32, align 4
  %crop_bottom.addr = alloca i32, align 4
  %twidth = alloca i32, align 4
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1974396627
  br i1 %109, label %110, label %func_exit
...
entry:
  ...
  %crop_left = alloca i32, align 4
  %canary = alloca i32
  store i32 828408658, i32* %canary
  %crop_right = alloca i32, align 4
  %crop_top = alloca i32, align 4
  %p.addr = alloca %struct.storable_picture*, align 8
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_out_picture.37(%struct.storable_picture* %p, i32 %p_out) #0 {
entry:
  %p_out.addr = alloca i32, align 4
  %symbol_size_in_bytes = alloca i32, align 4
  %crop_left = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_picture.38(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure) #0 {
entry:
  %real_structure.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 537386122, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  %p_out.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  ...
  %tmp32 = alloca i64, align 8
  %canary = alloca i32
  store i32 631521297, i32* %canary
  %imgX.addr = alloca i16**, align 8
  %crop_left.addr = alloca i32, align 4
  %ui16 = alloca i16, align 2
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_out_picture.40(%struct.storable_picture* %p, i32 %p_out) #0 {
entry:
  %buf = alloca i8*, align 8
  %rgb_output = alloca i32, align 4
  %SubWidthC = alloca [4 x i32], align 16
  ...
  %crop_bottom = alloca i32, align 4
  %canary = alloca i32
  store i32 881512767, i32* %canary
  %crop_left = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  %0 = bitcast [4 x i32]* %SubWidthC to i8*
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_unpaired_field.41(%struct.frame_store* %fs, i32 %p_out) #0 {
entry:
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 312695078, i32* %canary
  %fs.addr = alloca %struct.frame_store*, align 8
  %p = alloca %struct.storable_picture*, align 8
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_picture.42(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure) #0 {
entry:
  %real_structure.addr = alloca i32, align 4
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1924954238, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  store i32 %real_structure, i32* %real_structure.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @img2buf.43(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom) #0 {
entry:
  %ui8 = alloca i8, align 1
  %imgX.addr = alloca i16**, align 8
  %tmp16 = alloca i16, align 2
  ...
  %symbol_size_in_bytes.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1571951035, i32* %canary
  %crop_top.addr = alloca i32, align 4
  %size_y.addr = alloca i32, align 4
  %crop_left.addr = alloca i32, align 4
  %size = alloca i32, align 4
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1571951035
  br i1 %109, label %110, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @img2buf.44(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom) #0 {
entry:
  %size_x.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %theight = alloca i32, align 4
  ...
  %size = alloca i32, align 4
  %canary = alloca i32
  store i32 193692066, i32* %canary
  %crop_bottom.addr = alloca i32, align 4
  %tmp32 = alloca i64, align 8
  %twidth = alloca i32, align 4
  store i16** %imgX, i16*** %imgX.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @img2buf.45(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom) #0 {
entry:
  %ui8 = alloca i8, align 1
  %j = alloca i32, align 4
  %size_y.addr = alloca i32, align 4
  ...
  %size_x.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 456760684, i32* %canary
  %ui32 = alloca i64, align 8
  %size = alloca i32, align 4
  %crop_left.addr = alloca i32, align 4
  store i16** %imgX, i16*** %imgX.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_out_picture.46(%struct.storable_picture* %p, i32 %p_out) #0 {
entry:
  %SubHeightC = alloca [4 x i32], align 16
  %crop_bottom = alloca i32, align 4
  %p.addr = alloca %struct.storable_picture*, align 8
  ...
  %buf = alloca i8*, align 8
  %canary = alloca i32
  store i32 669509890, i32* %canary
  %SubWidthC = alloca [4 x i32], align 16
  %p_out.addr = alloca i32, align 4
  %crop_left = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 940164155, i32* %canary
  %i = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %tmp32 = alloca i64, align 8
  %ui32 = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_out_picture.48(%struct.storable_picture* %p, i32 %p_out) #0 {
entry:
  %crop_left = alloca i32, align 4
  %buf = alloca i8*, align 8
  %SubWidthC = alloca [4 x i32], align 16
  %canary = alloca i32
  store i32 1996800295, i32* %canary
  %crop_bottom = alloca i32, align 4
  %p_out.addr = alloca i32, align 4
  %SubHeightC = alloca [4 x i32], align 16
  %p.addr = alloca %struct.storable_picture*, align 8
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1996800295
  br i1 %193, label %194, label %func_exit
...
entry:
  ...
  %crop_bottom.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1326111421, i32* %canary
  %crop_right.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %crop_left.addr = alloca i32, align 4
  %ui32 = alloca i64, align 8
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1326111421
  br i1 %109, label %110, label %func_exit
...
entry:
  ...
  %size = alloca i32, align 4
  %canary = alloca i32
  store i32 1038779685, i32* %canary
  %tmp32 = alloca i64, align 8
  %ui32 = alloca i64, align 8
  %i = alloca i32, align 4
  %crop_right.addr = alloca i32, align 4
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1038779685
  br i1 %109, label %110, label %func_exit
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1858466186, i32* %canary
  %size_y.addr = alloca i32, align 4
  %tmp32 = alloca i64, align 8
  %twidth = alloca i32, align 4
  %crop_bottom.addr = alloca i32, align 4
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1858466186
  br i1 %109, label %110, label %func_exit
...
entry:
  ...
  %twidth = alloca i32, align 4
  %canary = alloca i32
  store i32 2134551367, i32* %canary
  %tmp32 = alloca i64, align 8
  %tmp16 = alloca i16, align 2
  %size_y.addr = alloca i32, align 4
  %theight = alloca i32, align 4
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 2134551367
  br i1 %109, label %110, label %func_exit
