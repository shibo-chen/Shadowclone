...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$520450669, -28(%rbp)   # imm = 0x1F05726D
	movq	%rdi, -24(%rbp)
	movq	-24(%rbp), %rax
	movl	20(%rax), %eax
	shll	$7, %eax
...
.LBB6_10:                               # %if.end32
	...
	movl	4(%rax), %ebx
	shll	$3, %ebx
	cmpl	$520450669, -28(%rbp)   # imm = 0x1F05726D
	jne	.LBB6_12
.LBB6_11:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$16, %rsp
	movl	$1381492175, -12(%rbp)  # imm = 0x5257E5CF
	movl	%edi, -8(%rbp)
...
.LBB7_5:                                # %return
	cmpl	$1381492175, -12(%rbp)  # imm = 0x5257E5CF
	jne	.LBB7_7
.LBB7_6:
	addq	$16, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$1379431370, -28(%rbp)  # imm = 0x523873CA
	movq	%rdi, -24(%rbp)
	movq	-24(%rbp), %rax
	movl	20(%rax), %eax
	shll	$7, %eax
...
.LBB8_10:                               # %if.end32
	...
	movl	4(%rax), %ebx
	shll	$3, %ebx
	cmpl	$1379431370, -28(%rbp)  # imm = 0x523873CA
	jne	.LBB8_12
.LBB8_11:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$4118030, -36(%rbp)     # imm = 0x3ED60E
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movl	$-1, -40(%rbp)
	movq	-32(%rbp), %rdi
...
.LBB9_7:                                # %return
	movl	-12(%rbp), %ebx
	cmpl	$4118030, -36(%rbp)     # imm = 0x3ED60E
	jne	.LBB9_9
.LBB9_8:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$16, %rsp
	movl	$1154779232, -12(%rbp)  # imm = 0x44D48860
	movl	%edi, -8(%rbp)
	cmpl	$-1, RTPUpdateTimestamp.oldtr
	jne	.LBB10_2
# %bb.1:                                # %if.then
...
.LBB10_4:                               # %if.end3
	...
	movl	%eax, RTPUpdateTimestamp.oldtr
.LBB10_5:                               # %return
	cmpl	$1154779232, -12(%rbp)  # imm = 0x44D48860
	jne	.LBB10_7
.LBB10_6:
	addq	$16, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$74251780, -36(%rbp)    # imm = 0x46CFE04
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movl	$-1, -40(%rbp)
	movq	-32(%rbp), %rdi
...
.LBB11_7:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$74251780, -36(%rbp)    # imm = 0x46CFE04
	jne	.LBB11_9
.LBB11_8:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$424102156, -36(%rbp)   # imm = 0x1947490C
	movq	%rdi, -24(%rbp)
	movq	%rsi, -32(%rbp)
	movl	$-1, -40(%rbp)
	movq	-24(%rbp), %rdi
...
.LBB12_7:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$424102156, -36(%rbp)   # imm = 0x1947490C
	jne	.LBB12_9
.LBB12_8:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$511872991, -36(%rbp)   # imm = 0x1E828FDF
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movl	$-1, -40(%rbp)
	movq	-32(%rbp), %rdi
...
.LBB13_7:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$511872991, -36(%rbp)   # imm = 0x1E828FDF
	jne	.LBB13_9
.LBB13_8:
	movl	%ebx, %eax
	addq	$40, %rsp
