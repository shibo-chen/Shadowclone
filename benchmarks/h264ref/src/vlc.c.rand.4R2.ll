...
func_ue_v.76:                                     ; preds = %ctrl0
  %3 = call i32 @ue_v.76(i8* %tracestring, i32 %value, %struct.datapartition* %part)
  ret i32 %3

func_ue_v.91:                                     ; preds = %ctrl1
  %4 = call i32 @ue_v.91(i8* %tracestring, i32 %value, %struct.datapartition* %part)
  ret i32 %4

func_ue_v.92:                                     ; preds = %ctrl1
  %5 = call i32 @ue_v.92(i8* %tracestring, i32 %value, %struct.datapartition* %part)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_ue_v.76, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_ue_v.91, label %func_ue_v.92
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_ue_linfo.33, label %ctrl0

func_ue_linfo.33:                                 ; preds = %rand_bb
  call void @ue_linfo.33(i32 %ue, i32 %dummy, i32* %len, i32* %info)
  ret void

func_ue_linfo.46:                                 ; preds = %ctrl0
  call void @ue_linfo.46(i32 %ue, i32 %dummy, i32* %len, i32* %info)
  ret void

func_ue_linfo.56:                                 ; preds = %ctrl1
  call void @ue_linfo.56(i32 %ue, i32 %dummy, i32* %len, i32* %info)
  ret void

func_ue_linfo.58:                                 ; preds = %ctrl1
  call void @ue_linfo.58(i32 %ue, i32 %dummy, i32* %len, i32* %info)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_ue_linfo.46, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_ue_linfo.56, label %func_ue_linfo.58
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_writeSyntaxElement_UVLC.7, label %func_writeSyntaxElement_UVLC.20
...
func_writeSyntaxElement_UVLC.20:                  ; preds = %rand_bb
  %3 = call i32 @writeSyntaxElement_UVLC.20(%struct.syntaxelement* %se, %struct.datapartition* %this_dataPart)
  ret i32 %3
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_se_v.3, label %ctrl0

func_se_v.3:                                      ; preds = %rand_bb
  %2 = call i32 @se_v.3(i8* %tracestring, i32 %value, %struct.datapartition* %part)
  ret i32 %2
...
func_se_v.39:                                     ; preds = %ctrl1
  %4 = call i32 @se_v.39(i8* %tracestring, i32 %value, %struct.datapartition* %part)
  ret i32 %4

func_se_v.65:                                     ; preds = %ctrl1
  %5 = call i32 @se_v.65(i8* %tracestring, i32 %value, %struct.datapartition* %part)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_se_v.25, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_se_v.39, label %func_se_v.65
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_se_linfo.14, label %ctrl0

func_se_linfo.14:                                 ; preds = %rand_bb
  call void @se_linfo.14(i32 %se, i32 %dummy, i32* %len, i32* %info)
  ret void

func_se_linfo.21:                                 ; preds = %ctrl0
  call void @se_linfo.21(i32 %se, i32 %dummy, i32* %len, i32* %info)
  ret void

func_se_linfo.26:                                 ; preds = %ctrl1
  call void @se_linfo.26(i32 %se, i32 %dummy, i32* %len, i32* %info)
  ret void

func_se_linfo.44:                                 ; preds = %ctrl1
  call void @se_linfo.44(i32 %se, i32 %dummy, i32* %len, i32* %info)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_se_linfo.21, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_se_linfo.26, label %func_se_linfo.44
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_u_1.48, label %ctrl0

func_u_1.48:                                      ; preds = %rand_bb
  %2 = call i32 @u_1.48(i8* %tracestring, i32 %value, %struct.datapartition* %part)
  ret i32 %2

func_u_1.81:                                      ; preds = %ctrl0
  %3 = call i32 @u_1.81(i8* %tracestring, i32 %value, %struct.datapartition* %part)
  ret i32 %3

func_u_1.84:                                      ; preds = %ctrl1
  %4 = call i32 @u_1.84(i8* %tracestring, i32 %value, %struct.datapartition* %part)
  ret i32 %4

func_u_1.88:                                      ; preds = %ctrl1
  %5 = call i32 @u_1.88(i8* %tracestring, i32 %value, %struct.datapartition* %part)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_u_1.81, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_u_1.84, label %func_u_1.88
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_writeSyntaxElement_fixed.71, label %func_writeSyntaxElement_fixed.75

func_writeSyntaxElement_fixed.71:                 ; preds = %rand_bb
  %2 = call i32 @writeSyntaxElement_fixed.71(%struct.syntaxelement* %se, %struct.datapartition* %this_dataPart)
  ret i32 %2

func_writeSyntaxElement_fixed.75:                 ; preds = %rand_bb
  %3 = call i32 @writeSyntaxElement_fixed.75(%struct.syntaxelement* %se, %struct.datapartition* %this_dataPart)
  ret i32 %3
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_u_v.74, label %ctrl0

func_u_v.74:                                      ; preds = %rand_bb
  %2 = call i32 @u_v.74(i32 %n, i8* %tracestring, i32 %value, %struct.datapartition* %part)
  ret i32 %2

func_u_v.78:                                      ; preds = %ctrl0
  %3 = call i32 @u_v.78(i32 %n, i8* %tracestring, i32 %value, %struct.datapartition* %part)
  ret i32 %3

func_u_v.82:                                      ; preds = %ctrl1
  %4 = call i32 @u_v.82(i32 %n, i8* %tracestring, i32 %value, %struct.datapartition* %part)
  ret i32 %4

func_u_v.86:                                      ; preds = %ctrl1
  %5 = call i32 @u_v.86(i32 %n, i8* %tracestring, i32 %value, %struct.datapartition* %part)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_u_v.78, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_u_v.82, label %func_u_v.86
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_cbp_linfo_intra.40, label %ctrl0

func_cbp_linfo_intra.40:                          ; preds = %rand_bb
  call void @cbp_linfo_intra.40(i32 %cbp, i32 %dummy, i32* %len, i32* %info)
  ret void

func_cbp_linfo_intra.51:                          ; preds = %ctrl0
  call void @cbp_linfo_intra.51(i32 %cbp, i32 %dummy, i32* %len, i32* %info)
  ret void

func_cbp_linfo_intra.62:                          ; preds = %ctrl1
  call void @cbp_linfo_intra.62(i32 %cbp, i32 %dummy, i32* %len, i32* %info)
  ret void

func_cbp_linfo_intra.66:                          ; preds = %ctrl1
  call void @cbp_linfo_intra.66(i32 %cbp, i32 %dummy, i32* %len, i32* %info)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_cbp_linfo_intra.51, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_cbp_linfo_intra.62, label %func_cbp_linfo_intra.66
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_cbp_linfo_inter.6, label %ctrl0

func_cbp_linfo_inter.6:                           ; preds = %rand_bb
  call void @cbp_linfo_inter.6(i32 %cbp, i32 %dummy, i32* %len, i32* %info)
  ret void
...
func_cbp_linfo_inter.85:                          ; preds = %ctrl1
  call void @cbp_linfo_inter.85(i32 %cbp, i32 %dummy, i32* %len, i32* %info)
  ret void
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_cbp_linfo_inter.38, label %func_cbp_linfo_inter.85
}
...
func_levrun_linfo_c2x2.42:                        ; preds = %ctrl0
  call void @levrun_linfo_c2x2.42(i32 %level, i32 %run, i32* %len, i32* %info)
  ret void

func_levrun_linfo_c2x2.77:                        ; preds = %ctrl1
  call void @levrun_linfo_c2x2.77(i32 %level, i32 %run, i32* %len, i32* %info)
  ret void

func_levrun_linfo_c2x2.79:                        ; preds = %ctrl1
  call void @levrun_linfo_c2x2.79(i32 %level, i32 %run, i32* %len, i32* %info)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_levrun_linfo_c2x2.42, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_levrun_linfo_c2x2.77, label %func_levrun_linfo_c2x2.79
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_levrun_linfo_inter.49, label %ctrl0

func_levrun_linfo_inter.49:                       ; preds = %rand_bb
  call void @levrun_linfo_inter.49(i32 %level, i32 %run, i32* %len, i32* %info)
  ret void

func_levrun_linfo_inter.60:                       ; preds = %ctrl0
...
func_levrun_linfo_inter.89:                       ; preds = %ctrl1
  call void @levrun_linfo_inter.89(i32 %level, i32 %run, i32* %len, i32* %info)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_levrun_linfo_inter.60, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_levrun_linfo_inter.67, label %func_levrun_linfo_inter.89
}
...
func_levrun_linfo_intra.19:                       ; preds = %ctrl0
  call void @levrun_linfo_intra.19(i32 %level, i32 %run, i32* %len, i32* %info)
  ret void

func_levrun_linfo_intra.34:                       ; preds = %ctrl1
  call void @levrun_linfo_intra.34(i32 %level, i32 %run, i32* %len, i32* %info)
  ret void

func_levrun_linfo_intra.68:                       ; preds = %ctrl1
  call void @levrun_linfo_intra.68(i32 %level, i32 %run, i32* %len, i32* %info)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_levrun_linfo_intra.19, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_levrun_linfo_intra.34, label %func_levrun_linfo_intra.68
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_symbol2uvlc.13, label %func_symbol2uvlc.32
...
func_symbol2uvlc.32:                              ; preds = %rand_bb
  %3 = call i32 @symbol2uvlc.32(%struct.syntaxelement* %sym)
  ret i32 %3
}
...
func_writeUVLC2buffer.37:                         ; preds = %ctrl0
  call void @writeUVLC2buffer.37(%struct.syntaxelement* %se, %struct.Bitstream* %currStream)
  ret void

func_writeUVLC2buffer.43:                         ; preds = %ctrl1
  call void @writeUVLC2buffer.43(%struct.syntaxelement* %se, %struct.Bitstream* %currStream)
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_writeUVLC2buffer.37, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_writeUVLC2buffer.43, label %func_writeUVLC2buffer.59
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_writeSyntaxElement_Intra4x4PredictionMode.2, label %func_writeSyntaxElement_Intra4x4PredictionMode.27

func_writeSyntaxElement_Intra4x4PredictionMode.2: ; preds = %rand_bb
  %2 = call i32 @writeSyntaxElement_Intra4x4PredictionMode.2(%struct.syntaxelement* %se, %struct.datapartition* %this_dataPart)
  ret i32 %2
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_writeSyntaxElement2Buf_UVLC.53, label %func_writeSyntaxElement2Buf_UVLC.83

func_writeSyntaxElement2Buf_UVLC.53:              ; preds = %rand_bb
  %2 = call i32 @writeSyntaxElement2Buf_UVLC.53(%struct.syntaxelement* %se, %struct.Bitstream* %this_streamBuffer)
  ret i32 %2

func_writeSyntaxElement2Buf_UVLC.83:              ; preds = %rand_bb
  %3 = call i32 @writeSyntaxElement2Buf_UVLC.83(%struct.syntaxelement* %se, %struct.Bitstream* %this_streamBuffer)
  ret i32 %3
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_writeSyntaxElement2Buf_Fixed.15, label %func_writeSyntaxElement2Buf_Fixed.45

func_writeSyntaxElement2Buf_Fixed.15:             ; preds = %rand_bb
  %2 = call i32 @writeSyntaxElement2Buf_Fixed.15(%struct.syntaxelement* %se, %struct.Bitstream* %this_streamBuffer)
  ret i32 %2
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_symbol2vlc.16, label %func_symbol2vlc.23

func_symbol2vlc.16:                               ; preds = %rand_bb
  %2 = call i32 @symbol2vlc.16(%struct.syntaxelement* %sym)
  ret i32 %2

func_symbol2vlc.23:                               ; preds = %rand_bb
  %3 = call i32 @symbol2vlc.23(%struct.syntaxelement* %sym)
  ret i32 %3
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_writeSyntaxElement_VLC.28, label %func_writeSyntaxElement_VLC.64

func_writeSyntaxElement_VLC.28:                   ; preds = %rand_bb
  %2 = call i32 @writeSyntaxElement_VLC.28(%struct.syntaxelement* %se, %struct.datapartition* %this_dataPart)
  ret i32 %2
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_writeSyntaxElement_NumCoeffTrailingOnes.10, label %ctrl0

func_writeSyntaxElement_NumCoeffTrailingOnes.10:  ; preds = %rand_bb
  %2 = call i32 @writeSyntaxElement_NumCoeffTrailingOnes.10(%struct.syntaxelement* %se, %struct.datapartition* %this_dataPart)
  ret i32 %2

func_writeSyntaxElement_NumCoeffTrailingOnes.61:  ; preds = %ctrl0
  %3 = call i32 @writeSyntaxElement_NumCoeffTrailingOnes.61(%struct.syntaxelement* %se, %struct.datapartition* %this_dataPart)
  ret i32 %3

func_writeSyntaxElement_NumCoeffTrailingOnes.70:  ; preds = %ctrl1
  %4 = call i32 @writeSyntaxElement_NumCoeffTrailingOnes.70(%struct.syntaxelement* %se, %struct.datapartition* %this_dataPart)
  ret i32 %4

func_writeSyntaxElement_NumCoeffTrailingOnes.87:  ; preds = %ctrl1
  %5 = call i32 @writeSyntaxElement_NumCoeffTrailingOnes.87(%struct.syntaxelement* %se, %struct.datapartition* %this_dataPart)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_writeSyntaxElement_NumCoeffTrailingOnes.61, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_writeSyntaxElement_NumCoeffTrailingOnes.70, label %func_writeSyntaxElement_NumCoeffTrailingOnes.87
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_writeSyntaxElement_NumCoeffTrailingOnesChromaDC.8, label %ctrl0

func_writeSyntaxElement_NumCoeffTrailingOnesChromaDC.8: ; preds = %rand_bb
  %2 = call i32 @writeSyntaxElement_NumCoeffTrailingOnesChromaDC.8(%struct.syntaxelement* %se, %struct.datapartition* %this_dataPart)
  ret i32 %2

func_writeSyntaxElement_NumCoeffTrailingOnesChromaDC.41: ; preds = %ctrl0
  %3 = call i32 @writeSyntaxElement_NumCoeffTrailingOnesChromaDC.41(%struct.syntaxelement* %se, %struct.datapartition* %this_dataPart)
  ret i32 %3

func_writeSyntaxElement_NumCoeffTrailingOnesChromaDC.50: ; preds = %ctrl1
  %4 = call i32 @writeSyntaxElement_NumCoeffTrailingOnesChromaDC.50(%struct.syntaxelement* %se, %struct.datapartition* %this_dataPart)
  ret i32 %4

func_writeSyntaxElement_NumCoeffTrailingOnesChromaDC.72: ; preds = %ctrl1
  %5 = call i32 @writeSyntaxElement_NumCoeffTrailingOnesChromaDC.72(%struct.syntaxelement* %se, %struct.datapartition* %this_dataPart)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_writeSyntaxElement_NumCoeffTrailingOnesChromaDC.41, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_writeSyntaxElement_NumCoeffTrailingOnesChromaDC.50, label %func_writeSyntaxElement_NumCoeffTrailingOnesChromaDC.72
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_writeSyntaxElement_TotalZeros.12, label %ctrl0

func_writeSyntaxElement_TotalZeros.12:            ; preds = %rand_bb
  %2 = call i32 @writeSyntaxElement_TotalZeros.12(%struct.syntaxelement* %se, %struct.datapartition* %this_dataPart)
  ret i32 %2

func_writeSyntaxElement_TotalZeros.47:            ; preds = %ctrl0
  %3 = call i32 @writeSyntaxElement_TotalZeros.47(%struct.syntaxelement* %se, %struct.datapartition* %this_dataPart)
  ret i32 %3

func_writeSyntaxElement_TotalZeros.52:            ; preds = %ctrl1
  %4 = call i32 @writeSyntaxElement_TotalZeros.52(%struct.syntaxelement* %se, %struct.datapartition* %this_dataPart)
  ret i32 %4

func_writeSyntaxElement_TotalZeros.55:            ; preds = %ctrl1
  %5 = call i32 @writeSyntaxElement_TotalZeros.55(%struct.syntaxelement* %se, %struct.datapartition* %this_dataPart)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_writeSyntaxElement_TotalZeros.47, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_writeSyntaxElement_TotalZeros.52, label %func_writeSyntaxElement_TotalZeros.55
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_writeSyntaxElement_TotalZerosChromaDC.30, label %ctrl0

func_writeSyntaxElement_TotalZerosChromaDC.30:    ; preds = %rand_bb
  %2 = call i32 @writeSyntaxElement_TotalZerosChromaDC.30(%struct.syntaxelement* %se, %struct.datapartition* %this_dataPart)
  ret i32 %2

func_writeSyntaxElement_TotalZerosChromaDC.54:    ; preds = %ctrl0
  %3 = call i32 @writeSyntaxElement_TotalZerosChromaDC.54(%struct.syntaxelement* %se, %struct.datapartition* %this_dataPart)
  ret i32 %3

func_writeSyntaxElement_TotalZerosChromaDC.69:    ; preds = %ctrl1
  %4 = call i32 @writeSyntaxElement_TotalZerosChromaDC.69(%struct.syntaxelement* %se, %struct.datapartition* %this_dataPart)
  ret i32 %4
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_writeSyntaxElement_TotalZerosChromaDC.54, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_writeSyntaxElement_TotalZerosChromaDC.69, label %func_writeSyntaxElement_TotalZerosChromaDC.90
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_writeSyntaxElement_Run.18, label %ctrl0

func_writeSyntaxElement_Run.18:                   ; preds = %rand_bb
  %2 = call i32 @writeSyntaxElement_Run.18(%struct.syntaxelement* %se, %struct.datapartition* %this_dataPart)
  ret i32 %2
...
func_writeSyntaxElement_Run.63:                   ; preds = %ctrl1
  %4 = call i32 @writeSyntaxElement_Run.63(%struct.syntaxelement* %se, %struct.datapartition* %this_dataPart)
  ret i32 %4
...
ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_writeSyntaxElement_Run.63, label %func_writeSyntaxElement_Run.80
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_writeSyntaxElement_Level_VLC1.4, label %ctrl0

func_writeSyntaxElement_Level_VLC1.4:             ; preds = %rand_bb
  %2 = call i32 @writeSyntaxElement_Level_VLC1.4(%struct.syntaxelement* %se, %struct.datapartition* %this_dataPart)
  ret i32 %2

func_writeSyntaxElement_Level_VLC1.5:             ; preds = %ctrl0
  %3 = call i32 @writeSyntaxElement_Level_VLC1.5(%struct.syntaxelement* %se, %struct.datapartition* %this_dataPart)
  ret i32 %3

func_writeSyntaxElement_Level_VLC1.29:            ; preds = %ctrl1
  %4 = call i32 @writeSyntaxElement_Level_VLC1.29(%struct.syntaxelement* %se, %struct.datapartition* %this_dataPart)
  ret i32 %4

func_writeSyntaxElement_Level_VLC1.31:            ; preds = %ctrl1
  %5 = call i32 @writeSyntaxElement_Level_VLC1.31(%struct.syntaxelement* %se, %struct.datapartition* %this_dataPart)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_writeSyntaxElement_Level_VLC1.5, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_writeSyntaxElement_Level_VLC1.29, label %func_writeSyntaxElement_Level_VLC1.31
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_writeSyntaxElement_Level_VLCN.1, label %ctrl0

func_writeSyntaxElement_Level_VLCN.1:             ; preds = %rand_bb
  %2 = call i32 @writeSyntaxElement_Level_VLCN.1(%struct.syntaxelement* %se, i32 %vlc, %struct.datapartition* %this_dataPart)
  ret i32 %2

func_writeSyntaxElement_Level_VLCN.35:            ; preds = %ctrl0
  %3 = call i32 @writeSyntaxElement_Level_VLCN.35(%struct.syntaxelement* %se, i32 %vlc, %struct.datapartition* %this_dataPart)
  ret i32 %3

func_writeSyntaxElement_Level_VLCN.57:            ; preds = %ctrl1
  %4 = call i32 @writeSyntaxElement_Level_VLCN.57(%struct.syntaxelement* %se, i32 %vlc, %struct.datapartition* %this_dataPart)
  ret i32 %4

func_writeSyntaxElement_Level_VLCN.73:            ; preds = %ctrl1
  %5 = call i32 @writeSyntaxElement_Level_VLCN.73(%struct.syntaxelement* %se, i32 %vlc, %struct.datapartition* %this_dataPart)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_writeSyntaxElement_Level_VLCN.35, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_writeSyntaxElement_Level_VLCN.57, label %func_writeSyntaxElement_Level_VLCN.73
}
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @writeSyntaxElement_Level_VLCN.1(%struct.syntaxelement* %se, i32 %vlc, %struct.datapartition* %this_dataPart) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 1720843037, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @writeSyntaxElement_Intra4x4PredictionMode.2(%struct.syntaxelement* %se, %struct.datapartition* %this_dataPart) #0 {
entry:
  %this_dataPart.addr = alloca %struct.datapartition*, align 8
  %canary = alloca i32
  store i32 2121694622, i32* %canary
  %se.addr = alloca %struct.syntaxelement*, align 8
  store %struct.syntaxelement* %se, %struct.syntaxelement** %se.addr, align 8
  store %struct.datapartition* %this_dataPart, %struct.datapartition** %this_dataPart.addr, align 8
  %0 = load %struct.syntaxelement*, %struct.syntaxelement** %se.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @se_v.3(i8* %tracestring, i32 %value, %struct.datapartition* %part) #0 {
entry:
  %symbol = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 516813759, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @writeSyntaxElement_Level_VLC1.4(%struct.syntaxelement* %se, %struct.datapartition* %this_dataPart) #0 {
entry:
  %levabs = alloca i32, align 4
  %canary = alloca i32
  store i32 1228716884, i32* %canary
  %level = alloca i32, align 4
  %this_dataPart.addr = alloca %struct.datapartition*, align 8
  %se.addr = alloca %struct.syntaxelement*, align 8
  %sign = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @writeSyntaxElement_Level_VLC1.5(%struct.syntaxelement* %se, %struct.datapartition* %this_dataPart) #0 {
entry:
  %this_dataPart.addr = alloca %struct.datapartition*, align 8
  %se.addr = alloca %struct.syntaxelement*, align 8
  %canary = alloca i32
  store i32 324487837, i32* %canary
  %levabs = alloca i32, align 4
  %sign = alloca i32, align 4
  %level = alloca i32, align 4
  store %struct.syntaxelement* %se, %struct.syntaxelement** %se.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @cbp_linfo_inter.6(i32 %cbp, i32 %dummy, i32* %len, i32* %info) #0 {
entry:
  %len.addr = alloca i32*, align 8
  %dummy.addr = alloca i32, align 4
  %info.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 1737915328, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1352613975, i32* %canary
  %this_dataPart.addr = alloca %struct.datapartition*, align 8
  %se.addr = alloca %struct.syntaxelement*, align 8
  store %struct.syntaxelement* %se, %struct.syntaxelement** %se.addr, align 8
  store %struct.datapartition* %this_dataPart, %struct.datapartition** %this_dataPart.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @writeSyntaxElement_NumCoeffTrailingOnesChromaDC.8(%struct.syntaxelement* %se, %struct.datapartition* %this_dataPart) #0 {
entry:
  %canary = alloca i32
  store i32 1042716060, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1871330938, i32* %canary
  %se.addr = alloca %struct.syntaxelement*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @writeSyntaxElement_NumCoeffTrailingOnes.10(%struct.syntaxelement* %se, %struct.datapartition* %this_dataPart) #0 {
entry:
  %se.addr = alloca %struct.syntaxelement*, align 8
  %canary = alloca i32
  store i32 807248758, i32* %canary
  %this_dataPart.addr = alloca %struct.datapartition*, align 8
...
entry:
  ...
  %canary = alloca i32
  store i32 706182875, i32* %canary
  %sign = alloca i32, align 4
  %info.addr = alloca i32*, align 8
...
entry:
  %canary = alloca i32
  store i32 665222274, i32* %canary
  %se.addr = alloca %struct.syntaxelement*, align 8
  %vlcnum = alloca i32, align 4
  %this_dataPart.addr = alloca %struct.datapartition*, align 8
  store %struct.syntaxelement* %se, %struct.syntaxelement** %se.addr, align 8
...
entry:
  ...
  %canary = alloca i32
  store i32 522464742, i32* %canary
...
entry:
  ...
  %nn = alloca i32, align 4
  %canary = alloca i32
  store i32 429732693, i32* %canary
  %sign = alloca i32, align 4
  %n = alloca i32, align 4
  %i = alloca i32, align 4
  %info.addr = alloca i32*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @writeSyntaxElement2Buf_Fixed.15(%struct.syntaxelement* %se, %struct.Bitstream* %this_streamBuffer) #0 {
entry:
  %canary = alloca i32
  store i32 397407142, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1070150257, i32* %canary
  %sym.addr = alloca %struct.syntaxelement*, align 8
  store %struct.syntaxelement* %sym, %struct.syntaxelement** %sym.addr, align 8
  %0 = load %struct.syntaxelement*, %struct.syntaxelement** %sym.addr, align 8
  %len = getelementptr inbounds %struct.syntaxelement, %struct.syntaxelement* %0, i32 0, i32 3
...
entry:
  %cbp.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 892189746, i32* %canary
  %dummy.addr = alloca i32, align 4
  %info.addr = alloca i32*, align 8
  %len.addr = alloca i32*, align 8
  store i32 %cbp, i32* %cbp.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @writeSyntaxElement_Run.18(%struct.syntaxelement* %se, %struct.datapartition* %this_dataPart) #0 {
entry:
  %se.addr = alloca %struct.syntaxelement*, align 8
  %canary = alloca i32
  store i32 1271114986, i32* %canary
  %this_dataPart.addr = alloca %struct.datapartition*, align 8
  %vlcnum = alloca i32, align 4
  store %struct.syntaxelement* %se, %struct.syntaxelement** %se.addr, align 8
  store %struct.datapartition* %this_dataPart, %struct.datapartition** %this_dataPart.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @levrun_linfo_intra.19(i32 %level, i32 %run, i32* %len, i32* %info) #0 {
entry:
  %NTAB = alloca [9 x [5 x i8]], align 16
  %nn = alloca i32, align 4
  %info.addr = alloca i32*, align 8
  %len.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 392563304, i32* %canary
  %i = alloca i32, align 4
  %n = alloca i32, align 4
  %levabs = alloca i32, align 4
  %run.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @writeSyntaxElement_UVLC.20(%struct.syntaxelement* %se, %struct.datapartition* %this_dataPart) #0 {
entry:
  %canary = alloca i32
  store i32 1049087102, i32* %canary
  %se.addr = alloca %struct.syntaxelement*, align 8
  %this_dataPart.addr = alloca %struct.datapartition*, align 8
  store %struct.syntaxelement* %se, %struct.syntaxelement** %se.addr, align 8
  store %struct.datapartition* %this_dataPart, %struct.datapartition** %this_dataPart.addr, align 8
...
entry:
  ...
  %n = alloca i32, align 4
  %canary = alloca i32
  store i32 512956908, i32* %canary
  %se.addr = alloca i32, align 4
  %info.addr = alloca i32*, align 8
  %len.addr = alloca i32*, align 8
  store i32 %se, i32* %se.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 761852330, i32* %canary
  %vlcnum = alloca i32, align 4
  %se.addr = alloca %struct.syntaxelement*, align 8
  %this_dataPart.addr = alloca %struct.datapartition*, align 8
  store %struct.syntaxelement* %se, %struct.syntaxelement** %se.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @symbol2vlc.23(%struct.syntaxelement* %sym) #0 {
entry:
  %canary = alloca i32
  store i32 1653945513, i32* %canary
  %sym.addr = alloca %struct.syntaxelement*, align 8
  %info_len = alloca i32, align 4
  store %struct.syntaxelement* %sym, %struct.syntaxelement** %sym.addr, align 8
  %0 = load %struct.syntaxelement*, %struct.syntaxelement** %sym.addr, align 8
...
entry:
  ...
  %info.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 1370912291, i32* %canary
  %i = alloca i32, align 4
  %levabs = alloca i32, align 4
...
entry:
  ...
  %symbol = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 1837941294, i32* %canary
  %part.addr = alloca %struct.datapartition*, align 8
  %tracestring.addr = alloca i8*, align 8
  %sym = alloca %struct.syntaxelement*, align 8
  store i8* %tracestring, i8** %tracestring.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @se_linfo.26(i32 %se, i32 %dummy, i32* %len, i32* %info) #0 {
entry:
  %n = alloca i32, align 4
  %canary = alloca i32
  store i32 908598794, i32* %canary
  %se.addr = alloca i32, align 4
  %info.addr = alloca i32*, align 8
  %len.addr = alloca i32*, align 8
  %i = alloca i32, align 4
...
entry:
  %se.addr = alloca %struct.syntaxelement*, align 8
  %canary = alloca i32
  store i32 915588591, i32* %canary
  %this_dataPart.addr = alloca %struct.datapartition*, align 8
  store %struct.syntaxelement* %se, %struct.syntaxelement** %se.addr, align 8
  store %struct.datapartition* %this_dataPart, %struct.datapartition** %this_dataPart.addr, align 8
  %0 = load %struct.syntaxelement*, %struct.syntaxelement** %se.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @writeSyntaxElement_VLC.28(%struct.syntaxelement* %se, %struct.datapartition* %this_dataPart) #0 {
entry:
  %se.addr = alloca %struct.syntaxelement*, align 8
  %canary = alloca i32
  store i32 884865783, i32* %canary
  %this_dataPart.addr = alloca %struct.datapartition*, align 8
  store %struct.syntaxelement* %se, %struct.syntaxelement** %se.addr, align 8
  store %struct.datapartition* %this_dataPart, %struct.datapartition** %this_dataPart.addr, align 8
  %0 = load %struct.syntaxelement*, %struct.syntaxelement** %se.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @writeSyntaxElement_Level_VLC1.29(%struct.syntaxelement* %se, %struct.datapartition* %this_dataPart) #0 {
entry:
  %sign = alloca i32, align 4
  %level = alloca i32, align 4
  %se.addr = alloca %struct.syntaxelement*, align 8
  %canary = alloca i32
  store i32 825320497, i32* %canary
  %levabs = alloca i32, align 4
  %this_dataPart.addr = alloca %struct.datapartition*, align 8
  store %struct.syntaxelement* %se, %struct.syntaxelement** %se.addr, align 8
  store %struct.datapartition* %this_dataPart, %struct.datapartition** %this_dataPart.addr, align 8
...
entry:
  %this_dataPart.addr = alloca %struct.datapartition*, align 8
  %canary = alloca i32
  store i32 858156958, i32* %canary
  %vlcnum = alloca i32, align 4
  %yuv = alloca i32, align 4
  %se.addr = alloca %struct.syntaxelement*, align 8
  store %struct.syntaxelement* %se, %struct.syntaxelement** %se.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @writeSyntaxElement_Level_VLC1.31(%struct.syntaxelement* %se, %struct.datapartition* %this_dataPart) #0 {
entry:
  %sign = alloca i32, align 4
  %se.addr = alloca %struct.syntaxelement*, align 8
  %levabs = alloca i32, align 4
  %canary = alloca i32
  store i32 1980309257, i32* %canary
  %level = alloca i32, align 4
  %this_dataPart.addr = alloca %struct.datapartition*, align 8
  store %struct.syntaxelement* %se, %struct.syntaxelement** %se.addr, align 8
  store %struct.datapartition* %this_dataPart, %struct.datapartition** %this_dataPart.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @ue_linfo.33(i32 %ue, i32 %dummy, i32* %len, i32* %info) #0 {
entry:
  %len.addr = alloca i32*, align 8
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 491844794, i32* %canary
  %dummy.addr = alloca i32, align 4
...
entry:
  %run.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 767929721, i32* %canary
  %sign = alloca i32, align 4
  %n = alloca i32, align 4
  %NTAB = alloca [9 x [5 x i8]], align 16
  %level.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @writeSyntaxElement_Level_VLCN.35(%struct.syntaxelement* %se, i32 %vlc, %struct.datapartition* %this_dataPart) #0 {
entry:
  %levabs = alloca i32, align 4
  %this_dataPart.addr = alloca %struct.datapartition*, align 8
  %sign = alloca i32, align 4
  ...
  %vlc.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1916618815, i32* %canary
  %se.addr = alloca %struct.syntaxelement*, align 8
  %numPrefix = alloca i32, align 4
  %shift = alloca i32, align 4
  %escape = alloca i32, align 4
...
entry:
  ...
  %tracestring.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 549896287, i32* %canary
  %sym = alloca %struct.syntaxelement*, align 8
  store i8* %tracestring, i8** %tracestring.addr, align 8
  store i32 %value, i32* %value.addr, align 4
  store %struct.datapartition* %part, %struct.datapartition** %part.addr, align 8
...
entry:
  %mask = alloca i32, align 4
  %canary = alloca i32
  store i32 1146180442, i32* %canary
  %currStream.addr = alloca %struct.Bitstream*, align 8
  %i = alloca i32, align 4
  %se.addr = alloca %struct.syntaxelement*, align 8
  store %struct.syntaxelement* %se, %struct.syntaxelement** %se.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 143953782, i32* %canary
  %len.addr = alloca i32*, align 8
  %dummy.addr = alloca i32, align 4
  %cbp.addr = alloca i32, align 4
  %info.addr = alloca i32*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @se_v.39(i8* %tracestring, i32 %value, %struct.datapartition* %part) #0 {
entry:
  %part.addr = alloca %struct.datapartition*, align 8
  %symbol = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 122955409, i32* %canary
  %tracestring.addr = alloca i8*, align 8
  %value.addr = alloca i32, align 4
  %sym = alloca %struct.syntaxelement*, align 8
  store i8* %tracestring, i8** %tracestring.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @cbp_linfo_intra.40(i32 %cbp, i32 %dummy, i32* %len, i32* %info) #0 {
entry:
  %dummy.addr = alloca i32, align 4
  %cbp.addr = alloca i32, align 4
  %info.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 528056229, i32* %canary
  %len.addr = alloca i32*, align 8
  store i32 %cbp, i32* %cbp.addr, align 4
  store i32 %dummy, i32* %dummy.addr, align 4
  store i32* %len, i32** %len.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 911963667, i32* %canary
  %yuv = alloca i32, align 4
  %this_dataPart.addr = alloca %struct.datapartition*, align 8
  %se.addr = alloca %struct.syntaxelement*, align 8
  store %struct.syntaxelement* %se, %struct.syntaxelement** %se.addr, align 8
...
entry:
  ...
  %sign = alloca i32, align 4
  %canary = alloca i32
  store i32 815401415, i32* %canary
  %nn = alloca i32, align 4
  %LEVRUN = alloca [4 x i32], align 16
  store i32 %level, i32* %level.addr, align 4
  store i32 %run, i32* %run.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @writeUVLC2buffer.43(%struct.syntaxelement* %se, %struct.Bitstream* %currStream) #0 {
entry:
  %canary = alloca i32
  store i32 1812794581, i32* %canary
  %mask = alloca i32, align 4
  %i = alloca i32, align 4
  %se.addr = alloca %struct.syntaxelement*, align 8
  %currStream.addr = alloca %struct.Bitstream*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @se_linfo.44(i32 %se, i32 %dummy, i32* %len, i32* %info) #0 {
entry:
  %se.addr = alloca i32, align 4
  %dummy.addr = alloca i32, align 4
  %sign = alloca i32, align 4
  %canary = alloca i32
  store i32 1880227446, i32* %canary
  %i = alloca i32, align 4
  %n = alloca i32, align 4
  %info.addr = alloca i32*, align 8
  %len.addr = alloca i32*, align 8
...
entry:
  %canary = alloca i32
  store i32 1140304479, i32* %canary
  %se.addr = alloca %struct.syntaxelement*, align 8
  %this_streamBuffer.addr = alloca %struct.Bitstream*, align 8
  store %struct.syntaxelement* %se, %struct.syntaxelement** %se.addr, align 8
  store %struct.Bitstream* %this_streamBuffer, %struct.Bitstream** %this_streamBuffer.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1596601546, i32* %canary
  %dummy.addr = alloca i32, align 4
  %info.addr = alloca i32*, align 8
  %nn = alloca i32, align 4
  %ue.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @writeSyntaxElement_TotalZeros.47(%struct.syntaxelement* %se, %struct.datapartition* %this_dataPart) #0 {
entry:
  %se.addr = alloca %struct.syntaxelement*, align 8
  %canary = alloca i32
  store i32 1515791526, i32* %canary
  %this_dataPart.addr = alloca %struct.datapartition*, align 8
  %vlcnum = alloca i32, align 4
  store %struct.syntaxelement* %se, %struct.syntaxelement** %se.addr, align 8
  store %struct.datapartition* %this_dataPart, %struct.datapartition** %this_dataPart.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @u_1.48(i8* %tracestring, i32 %value, %struct.datapartition* %part) #0 {
entry:
  %tracestring.addr = alloca i8*, align 8
  %value.addr = alloca i32, align 4
  %sym = alloca %struct.syntaxelement*, align 8
  %canary = alloca i32
  store i32 1341968827, i32* %canary
  %part.addr = alloca %struct.datapartition*, align 8
  %symbol = alloca %struct.syntaxelement, align 8
  store i8* %tracestring, i8** %tracestring.addr, align 8
  store i32 %value, i32* %value.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @levrun_linfo_inter.49(i32 %level, i32 %run, i32* %len, i32* %info) #0 {
entry:
  %sign = alloca i32, align 4
  %canary = alloca i32
  store i32 1349416609, i32* %canary
  %levabs = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @writeSyntaxElement_NumCoeffTrailingOnesChromaDC.50(%struct.syntaxelement* %se, %struct.datapartition* %this_dataPart) #0 {
entry:
  %this_dataPart.addr = alloca %struct.datapartition*, align 8
  %canary = alloca i32
  store i32 1058568647, i32* %canary
  %yuv = alloca i32, align 4
  %se.addr = alloca %struct.syntaxelement*, align 8
  store %struct.syntaxelement* %se, %struct.syntaxelement** %se.addr, align 8
  store %struct.datapartition* %this_dataPart, %struct.datapartition** %this_dataPart.addr, align 8
...
entry:
  %len.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 1113357150, i32* %canary
  %dummy.addr = alloca i32, align 4
  %cbp.addr = alloca i32, align 4
  %info.addr = alloca i32*, align 8
  store i32 %cbp, i32* %cbp.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @writeSyntaxElement_TotalZeros.52(%struct.syntaxelement* %se, %struct.datapartition* %this_dataPart) #0 {
entry:
  %canary = alloca i32
  store i32 1389402726, i32* %canary
  %this_dataPart.addr = alloca %struct.datapartition*, align 8
  %vlcnum = alloca i32, align 4
  %se.addr = alloca %struct.syntaxelement*, align 8
  store %struct.syntaxelement* %se, %struct.syntaxelement** %se.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 726581089, i32* %canary
  %this_streamBuffer.addr = alloca %struct.Bitstream*, align 8
  %se.addr = alloca %struct.syntaxelement*, align 8
  store %struct.syntaxelement* %se, %struct.syntaxelement** %se.addr, align 8
  store %struct.Bitstream* %this_streamBuffer, %struct.Bitstream** %this_streamBuffer.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @writeSyntaxElement_TotalZerosChromaDC.54(%struct.syntaxelement* %se, %struct.datapartition* %this_dataPart) #0 {
entry:
  %canary = alloca i32
  store i32 2099729713, i32* %canary
  %this_dataPart.addr = alloca %struct.datapartition*, align 8
  %yuv = alloca i32, align 4
  %se.addr = alloca %struct.syntaxelement*, align 8
  %vlcnum = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @writeSyntaxElement_TotalZeros.55(%struct.syntaxelement* %se, %struct.datapartition* %this_dataPart) #0 {
entry:
  %canary = alloca i32
  store i32 2004696285, i32* %canary
  %this_dataPart.addr = alloca %struct.datapartition*, align 8
  %se.addr = alloca %struct.syntaxelement*, align 8
  %vlcnum = alloca i32, align 4
  store %struct.syntaxelement* %se, %struct.syntaxelement** %se.addr, align 8
...
entry:
  ...
  %nn = alloca i32, align 4
  %canary = alloca i32
  store i32 1702847179, i32* %canary
  %dummy.addr = alloca i32, align 4
  %len.addr = alloca i32*, align 8
  %ue.addr = alloca i32, align 4
  %i = alloca i32, align 4
...
entry:
  ...
  %se.addr = alloca %struct.syntaxelement*, align 8
  %canary = alloca i32
  store i32 792760521, i32* %canary
  %vlc.addr = alloca i32, align 4
  %escape = alloca i32, align 4
  %sufmask = alloca i32, align 4
  %this_dataPart.addr = alloca %struct.datapartition*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @ue_linfo.58(i32 %ue, i32 %dummy, i32* %len, i32* %info) #0 {
entry:
  %ue.addr = alloca i32, align 4
  %nn = alloca i32, align 4
  %canary = alloca i32
  store i32 1673113129, i32* %canary
  %i = alloca i32, align 4
  %dummy.addr = alloca i32, align 4
  %info.addr = alloca i32*, align 8
  %len.addr = alloca i32*, align 8
...
entry:
  %canary = alloca i32
  store i32 1062877556, i32* %canary
  %mask = alloca i32, align 4
  %i = alloca i32, align 4
  %currStream.addr = alloca %struct.Bitstream*, align 8
  %se.addr = alloca %struct.syntaxelement*, align 8
...
entry:
  ...
  %n = alloca i32, align 4
  %canary = alloca i32
  store i32 2048964871, i32* %canary
  %levabs = alloca i32, align 4
  %level.addr = alloca i32, align 4
  %len.addr = alloca i32*, align 8
  %NTAB = alloca [4 x [10 x i8]], align 16
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @writeSyntaxElement_NumCoeffTrailingOnes.61(%struct.syntaxelement* %se, %struct.datapartition* %this_dataPart) #0 {
entry:
  %se.addr = alloca %struct.syntaxelement*, align 8
  %vlcnum = alloca i32, align 4
  %canary = alloca i32
  store i32 1529890637, i32* %canary
  %this_dataPart.addr = alloca %struct.datapartition*, align 8
  store %struct.syntaxelement* %se, %struct.syntaxelement** %se.addr, align 8
  store %struct.datapartition* %this_dataPart, %struct.datapartition** %this_dataPart.addr, align 8
  %0 = load %struct.syntaxelement*, %struct.syntaxelement** %se.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @cbp_linfo_intra.62(i32 %cbp, i32 %dummy, i32* %len, i32* %info) #0 {
entry:
  %dummy.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1628215047, i32* %canary
  %info.addr = alloca i32*, align 8
  %len.addr = alloca i32*, align 8
  %cbp.addr = alloca i32, align 4
  store i32 %cbp, i32* %cbp.addr, align 4
...
entry:
  ...
  %vlcnum = alloca i32, align 4
  %canary = alloca i32
  store i32 1848743511, i32* %canary
  %se.addr = alloca %struct.syntaxelement*, align 8
  store %struct.syntaxelement* %se, %struct.syntaxelement** %se.addr, align 8
  store %struct.datapartition* %this_dataPart, %struct.datapartition** %this_dataPart.addr, align 8
  %0 = load %struct.syntaxelement*, %struct.syntaxelement** %se.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 924626744, i32* %canary
  %this_dataPart.addr = alloca %struct.datapartition*, align 8
  %se.addr = alloca %struct.syntaxelement*, align 8
  store %struct.syntaxelement* %se, %struct.syntaxelement** %se.addr, align 8
  store %struct.datapartition* %this_dataPart, %struct.datapartition** %this_dataPart.addr, align 8
...
entry:
  ...
  %sym = alloca %struct.syntaxelement*, align 8
  %canary = alloca i32
  store i32 2095561995, i32* %canary
  %part.addr = alloca %struct.datapartition*, align 8
  store i8* %tracestring, i8** %tracestring.addr, align 8
  store i32 %value, i32* %value.addr, align 4
  store %struct.datapartition* %part, %struct.datapartition** %part.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @cbp_linfo_intra.66(i32 %cbp, i32 %dummy, i32* %len, i32* %info) #0 {
entry:
  %canary = alloca i32
  store i32 1515934842, i32* %canary
  %info.addr = alloca i32*, align 8
  %dummy.addr = alloca i32, align 4
  %cbp.addr = alloca i32, align 4
  %len.addr = alloca i32*, align 8
...
entry:
  ...
  %sign = alloca i32, align 4
  %canary = alloca i32
  store i32 682185217, i32* %canary
  %level.addr = alloca i32, align 4
  %NTAB = alloca [4 x [10 x i8]], align 16
  %info.addr = alloca i32*, align 8
  %nn = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @levrun_linfo_intra.68(i32 %level, i32 %run, i32* %len, i32* %info) #0 {
entry:
  %nn = alloca i32, align 4
  %canary = alloca i32
  store i32 774389689, i32* %canary
  %level.addr = alloca i32, align 4
  %info.addr = alloca i32*, align 8
  %i = alloca i32, align 4
  %LEVRUN = alloca [8 x i8], align 1
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @writeSyntaxElement_TotalZerosChromaDC.69(%struct.syntaxelement* %se, %struct.datapartition* %this_dataPart) #0 {
entry:
  %yuv = alloca i32, align 4
  %this_dataPart.addr = alloca %struct.datapartition*, align 8
  %se.addr = alloca %struct.syntaxelement*, align 8
  %canary = alloca i32
  store i32 439684283, i32* %canary
  %vlcnum = alloca i32, align 4
  store %struct.syntaxelement* %se, %struct.syntaxelement** %se.addr, align 8
  store %struct.datapartition* %this_dataPart, %struct.datapartition** %this_dataPart.addr, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @writeSyntaxElement_NumCoeffTrailingOnes.70(%struct.syntaxelement* %se, %struct.datapartition* %this_dataPart) #0 {
entry:
  %canary = alloca i32
  store i32 1568341150, i32* %canary
  %vlcnum = alloca i32, align 4
  %this_dataPart.addr = alloca %struct.datapartition*, align 8
  %se.addr = alloca %struct.syntaxelement*, align 8
  store %struct.syntaxelement* %se, %struct.syntaxelement** %se.addr, align 8
...
entry:
  %se.addr = alloca %struct.syntaxelement*, align 8
  %canary = alloca i32
  store i32 613205984, i32* %canary
  %this_dataPart.addr = alloca %struct.datapartition*, align 8
  store %struct.syntaxelement* %se, %struct.syntaxelement** %se.addr, align 8
  store %struct.datapartition* %this_dataPart, %struct.datapartition** %this_dataPart.addr, align 8
  %0 = load %struct.syntaxelement*, %struct.syntaxelement** %se.addr, align 8
...
entry:
  ...
  %this_dataPart.addr = alloca %struct.datapartition*, align 8
  %canary = alloca i32
  store i32 1837047879, i32* %canary
  %yuv = alloca i32, align 4
  store %struct.syntaxelement* %se, %struct.syntaxelement** %se.addr, align 8
  store %struct.datapartition* %this_dataPart, %struct.datapartition** %this_dataPart.addr, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @writeSyntaxElement_Level_VLCN.73(%struct.syntaxelement* %se, i32 %vlc, %struct.datapartition* %this_dataPart) #0 {
entry:
  %sign = alloca i32, align 4
  %this_dataPart.addr = alloca %struct.datapartition*, align 8
  %iCodeword = alloca i32, align 4
  ...
  %escape = alloca i32, align 4
  %canary = alloca i32
  store i32 1325323725, i32* %canary
  %se.addr = alloca %struct.syntaxelement*, align 8
  %numPrefix = alloca i32, align 4
  %levabs = alloca i32, align 4
  %iLength = alloca i32, align 4
...
entry:
  ...
  %tracestring.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 2055964892, i32* %canary
  %value.addr = alloca i32, align 4
  %symbol = alloca %struct.syntaxelement, align 8
  %sym = alloca %struct.syntaxelement*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @writeSyntaxElement_fixed.75(%struct.syntaxelement* %se, %struct.datapartition* %this_dataPart) #0 {
entry:
  %canary = alloca i32
  store i32 357834359, i32* %canary
  %this_dataPart.addr = alloca %struct.datapartition*, align 8
  %se.addr = alloca %struct.syntaxelement*, align 8
  store %struct.syntaxelement* %se, %struct.syntaxelement** %se.addr, align 8
  store %struct.datapartition* %this_dataPart, %struct.datapartition** %this_dataPart.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @ue_v.76(i8* %tracestring, i32 %value, %struct.datapartition* %part) #0 {
entry:
  %sym = alloca %struct.syntaxelement*, align 8
  %value.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1082098423, i32* %canary
  %part.addr = alloca %struct.datapartition*, align 8
  %symbol = alloca %struct.syntaxelement, align 8
  %tracestring.addr = alloca i8*, align 8
  store i8* %tracestring, i8** %tracestring.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @levrun_linfo_c2x2.77(i32 %level, i32 %run, i32* %len, i32* %info) #0 {
entry:
  %sign = alloca i32, align 4
  %len.addr = alloca i32*, align 8
  %nn = alloca i32, align 4
  ...
  %NTAB = alloca [2 x [2 x i32]], align 16
  %canary = alloca i32
  store i32 1332230004, i32* %canary
  %levabs = alloca i32, align 4
  store i32 %level, i32* %level.addr, align 4
  store i32 %run, i32* %run.addr, align 4
  store i32* %len, i32** %len.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @u_v.78(i32 %n, i8* %tracestring, i32 %value, %struct.datapartition* %part) #0 {
entry:
  %symbol = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 914286387, i32* %canary
  %value.addr = alloca i32, align 4
  %sym = alloca %struct.syntaxelement*, align 8
  %n.addr = alloca i32, align 4
  %tracestring.addr = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @levrun_linfo_c2x2.79(i32 %level, i32 %run, i32* %len, i32* %info) #0 {
entry:
  %canary = alloca i32
  store i32 1288883369, i32* %canary
  %len.addr = alloca i32*, align 8
  %i = alloca i32, align 4
  %levabs = alloca i32, align 4
  %run.addr = alloca i32, align 4
...
entry:
  ...
  %this_dataPart.addr = alloca %struct.datapartition*, align 8
  %canary = alloca i32
  store i32 558169051, i32* %canary
  %se.addr = alloca %struct.syntaxelement*, align 8
  store %struct.syntaxelement* %se, %struct.syntaxelement** %se.addr, align 8
  store %struct.datapartition* %this_dataPart, %struct.datapartition** %this_dataPart.addr, align 8
  %0 = load %struct.syntaxelement*, %struct.syntaxelement** %se.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @u_v.82(i32 %n, i8* %tracestring, i32 %value, %struct.datapartition* %part) #0 {
entry:
  %sym = alloca %struct.syntaxelement*, align 8
  %tracestring.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1872509286, i32* %canary
  %value.addr = alloca i32, align 4
  %symbol = alloca %struct.syntaxelement, align 8
  %n.addr = alloca i32, align 4
  %part.addr = alloca %struct.datapartition*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @writeSyntaxElement2Buf_UVLC.83(%struct.syntaxelement* %se, %struct.Bitstream* %this_streamBuffer) #0 {
entry:
  %canary = alloca i32
  store i32 842931347, i32* %canary
  %se.addr = alloca %struct.syntaxelement*, align 8
  %this_streamBuffer.addr = alloca %struct.Bitstream*, align 8
  store %struct.syntaxelement* %se, %struct.syntaxelement** %se.addr, align 8
  store %struct.Bitstream* %this_streamBuffer, %struct.Bitstream** %this_streamBuffer.addr, align 8
...
entry:
  %sym = alloca %struct.syntaxelement*, align 8
  %canary = alloca i32
  store i32 1364633231, i32* %canary
  %value.addr = alloca i32, align 4
  %symbol = alloca %struct.syntaxelement, align 8
  %part.addr = alloca %struct.datapartition*, align 8
  %tracestring.addr = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @cbp_linfo_inter.85(i32 %cbp, i32 %dummy, i32* %len, i32* %info) #0 {
entry:
  %info.addr = alloca i32*, align 8
  %len.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 371569777, i32* %canary
  %dummy.addr = alloca i32, align 4
  %cbp.addr = alloca i32, align 4
  store i32 %cbp, i32* %cbp.addr, align 4
  store i32 %dummy, i32* %dummy.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @u_v.86(i32 %n, i8* %tracestring, i32 %value, %struct.datapartition* %part) #0 {
entry:
  %canary = alloca i32
  store i32 748323257, i32* %canary
  %value.addr = alloca i32, align 4
  %part.addr = alloca %struct.datapartition*, align 8
  %tracestring.addr = alloca i8*, align 8
  %n.addr = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1941867110, i32* %canary
  %vlcnum = alloca i32, align 4
  %se.addr = alloca %struct.syntaxelement*, align 8
  %this_dataPart.addr = alloca %struct.datapartition*, align 8
  store %struct.syntaxelement* %se, %struct.syntaxelement** %se.addr, align 8
...
entry:
  ...
  %symbol = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 2070237649, i32* %canary
  %part.addr = alloca %struct.datapartition*, align 8
  store i8* %tracestring, i8** %tracestring.addr, align 8
  store i32 %value, i32* %value.addr, align 4
  store %struct.datapartition* %part, %struct.datapartition** %part.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @levrun_linfo_inter.89(i32 %level, i32 %run, i32* %len, i32* %info) #0 {
entry:
  %run.addr = alloca i32, align 4
  %levabs = alloca i32, align 4
  %canary = alloca i32
  store i32 738020403, i32* %canary
  %sign = alloca i32, align 4
  %info.addr = alloca i32*, align 8
  %nn = alloca i32, align 4
  %LEVRUN = alloca [16 x i8], align 16
...
entry:
  ...
  %this_dataPart.addr = alloca %struct.datapartition*, align 8
  %canary = alloca i32
  store i32 1641974327, i32* %canary
  %vlcnum = alloca i32, align 4
  %se.addr = alloca %struct.syntaxelement*, align 8
  store %struct.syntaxelement* %se, %struct.syntaxelement** %se.addr, align 8
  store %struct.datapartition* %this_dataPart, %struct.datapartition** %this_dataPart.addr, align 8
...
entry:
  ...
  %value.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 171469139, i32* %canary
  %sym = alloca %struct.syntaxelement*, align 8
  %part.addr = alloca %struct.datapartition*, align 8
  store i8* %tracestring, i8** %tracestring.addr, align 8
  store i32 %value, i32* %value.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @ue_v.92(i8* %tracestring, i32 %value, %struct.datapartition* %part) #0 {
entry:
  %value.addr = alloca i32, align 4
  %tracestring.addr = alloca i8*, align 8
  %sym = alloca %struct.syntaxelement*, align 8
  %canary = alloca i32
  store i32 662797598, i32* %canary
  %part.addr = alloca %struct.datapartition*, align 8
  %symbol = alloca %struct.syntaxelement, align 8
  store i8* %tracestring, i8** %tracestring.addr, align 8
  store i32 %value, i32* %value.addr, align 4
