...
# %bb.0:                                # %rand_bb
	...
	cmpl	$0, %eax
	jne	.LBB2_5
# %bb.1:                                # %func_store_coding_state.4
	movq	%rbx, %rdi
...
.LBB3_2:                                # %func_reset_coding_state.2
	...
	.cfi_def_cfa %rsp, 8
	retq
.LBB3_3:                                # %func_reset_coding_state.3
	.cfi_def_cfa %rbp, 16
	movq	%rbx, %rdi
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$96, %rsp
	movl	$722877692, -44(%rbp)   # imm = 0x2B163CFC
	movq	%rdi, -16(%rbp)
	movq	img, %rax
	movq	14160(%rax), %rax
	movq	32(%rax), %rax
...
.LBB4_19:                               # %if.end41
	...
	movq	%rax, 504(%rcx)
.LBB4_20:                               # %return
	cmpl	$722877692, -44(%rbp)   # imm = 0x2B163CFC
	jne	.LBB4_22
.LBB4_21:
	addq	$96, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$96, %rsp
	movl	$1119178877, -44(%rbp)  # imm = 0x42B5507D
	movq	%rdi, -16(%rbp)
	movq	img, %rax
	movq	14160(%rax), %rax
	movq	32(%rax), %rax
...
.LBB5_19:                               # %if.end41
	...
	movq	%rax, 504(%rcx)
.LBB5_20:                               # %return
	cmpl	$1119178877, -44(%rbp)  # imm = 0x42B5507D
	jne	.LBB5_22
.LBB5_21:
	addq	$96, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$96, %rsp
	movl	$1569589168, -44(%rbp)  # imm = 0x5D8E07B0
	movq	%rdi, -16(%rbp)
	movq	img, %rax
	movq	14160(%rax), %rax
	movq	32(%rax), %rax
...
.LBB6_19:                               # %if.end41
	...
	movq	%rax, 504(%rcx)
.LBB6_20:                               # %return
	cmpl	$1569589168, -44(%rbp)  # imm = 0x5D8E07B0
	jne	.LBB6_22
.LBB6_21:
	addq	$96, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$96, %rsp
	movl	$564878431, -44(%rbp)   # imm = 0x21AB5C5F
	movq	%rdi, -16(%rbp)
	movq	img, %rax
	movq	14160(%rax), %rax
	movq	32(%rax), %rax
...
.LBB7_19:                               # %if.end41
	...
	movq	%rax, 344(%rcx)
.LBB7_20:                               # %return
	cmpl	$564878431, -44(%rbp)   # imm = 0x21AB5C5F
	jne	.LBB7_22
.LBB7_21:
	addq	$96, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$96, %rsp
	movl	$466925335, -44(%rbp)   # imm = 0x1BD4B717
	movq	%rdi, -16(%rbp)
	movq	img, %rax
	movq	14160(%rax), %rax
	movq	32(%rax), %rax
...
.LBB8_19:                               # %if.end41
	...
	movq	%rax, 504(%rcx)
.LBB8_20:                               # %return
	cmpl	$466925335, -44(%rbp)   # imm = 0x1BD4B717
	jne	.LBB8_22
.LBB8_21:
	addq	$96, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$96, %rsp
	movl	$1298587518, -44(%rbp)  # imm = 0x4D66DF7E
	movq	%rdi, -16(%rbp)
	movq	img, %rax
	movq	14160(%rax), %rax
	movq	32(%rax), %rax
...
.LBB9_19:                               # %if.end41
	...
	movq	%rax, 344(%rcx)
.LBB9_20:                               # %return
	cmpl	$1298587518, -44(%rbp)  # imm = 0x4D66DF7E
	jne	.LBB9_22
.LBB9_21:
	addq	$96, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$96, %rsp
	movl	$1878516114, -44(%rbp)  # imm = 0x6FF7E192
	movq	%rdi, -16(%rbp)
	movq	img, %rax
	movq	14160(%rax), %rax
	movq	32(%rax), %rax
...
.LBB10_19:                              # %if.end41
	...
	movq	%rax, 344(%rcx)
.LBB10_20:                              # %return
	cmpl	$1878516114, -44(%rbp)  # imm = 0x6FF7E192
	jne	.LBB10_22
.LBB10_21:
	addq	$96, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$96, %rsp
	movl	$47586371, -44(%rbp)    # imm = 0x2D61C43
	movq	%rdi, -16(%rbp)
	movq	img, %rax
	movq	14160(%rax), %rax
	movq	32(%rax), %rax
...
.LBB11_19:                              # %if.end41
	...
	movq	%rax, 344(%rcx)
.LBB11_20:                              # %return
	cmpl	$47586371, -44(%rbp)    # imm = 0x2D61C43
	jne	.LBB11_22
.LBB11_21:
	addq	$96, %rsp
	popq	%rbp
