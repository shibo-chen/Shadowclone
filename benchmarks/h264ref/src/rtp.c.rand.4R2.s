...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$1612158483, -28(%rbp)  # imm = 0x60179613
	movq	%rdi, -24(%rbp)
	movq	-24(%rbp), %rax
	movl	20(%rax), %eax
	shll	$7, %eax
...
.LBB6_10:                               # %if.end32
	...
	movl	4(%rax), %ebx
	shll	$3, %ebx
	cmpl	$1612158483, -28(%rbp)  # imm = 0x60179613
	jne	.LBB6_12
.LBB6_11:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$995772550, -40(%rbp)   # imm = 0x3B5A4886
	movq	%rdi, -24(%rbp)
	movq	%rsi, -32(%rbp)
	movl	$-1, -36(%rbp)
	movq	-24(%rbp), %rdi
...
.LBB7_7:                                # %return
	movl	-12(%rbp), %ebx
	cmpl	$995772550, -40(%rbp)   # imm = 0x3B5A4886
	jne	.LBB7_9
.LBB7_8:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$1346487685, -40(%rbp)  # imm = 0x5041C585
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movl	$-1, -36(%rbp)
	movq	-32(%rbp), %rdi
...
.LBB8_7:                                # %return
	movl	-12(%rbp), %ebx
	cmpl	$1346487685, -40(%rbp)  # imm = 0x5041C585
	jne	.LBB8_9
.LBB8_8:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$1169863441, -28(%rbp)  # imm = 0x45BAB311
	movq	%rdi, -24(%rbp)
	movq	-24(%rbp), %rax
	movl	20(%rax), %eax
	shll	$7, %eax
...
.LBB9_10:                               # %if.end32
	...
	movl	4(%rax), %ebx
	shll	$3, %ebx
	cmpl	$1169863441, -28(%rbp)  # imm = 0x45BAB311
	jne	.LBB9_12
.LBB9_11:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$16, %rsp
	movl	$738582327, -12(%rbp)   # imm = 0x2C05DF37
	movl	%edi, -8(%rbp)
...
.LBB10_5:                               # %return
	cmpl	$738582327, -12(%rbp)   # imm = 0x2C05DF37
	jne	.LBB10_7
.LBB10_6:
	addq	$16, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$16, %rsp
	movl	$1452592742, -12(%rbp)  # imm = 0x5694CE66
	movl	%edi, -8(%rbp)
	cmpl	$-1, RTPUpdateTimestamp.oldtr
	jne	.LBB11_2
# %bb.1:                                # %if.then
...
.LBB11_4:                               # %if.end3
	...
	movl	%eax, RTPUpdateTimestamp.oldtr
.LBB11_5:                               # %return
	cmpl	$1452592742, -12(%rbp)  # imm = 0x5694CE66
	jne	.LBB11_7
.LBB11_6:
	addq	$16, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$1913557206, -36(%rbp)  # imm = 0x720E90D6
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movl	$-1, -40(%rbp)
	movq	-32(%rbp), %rdi
...
.LBB12_7:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$1913557206, -36(%rbp)  # imm = 0x720E90D6
	jne	.LBB12_9
.LBB12_8:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$9688998, -40(%rbp)     # imm = 0x93D7A6
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movl	$-1, -36(%rbp)
	movq	-32(%rbp), %rdi
...
.LBB13_7:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$9688998, -40(%rbp)     # imm = 0x93D7A6
	jne	.LBB13_9
.LBB13_8:
	movl	%ebx, %eax
	addq	$40, %rsp
