...
entry:
  ...
  %canary = alloca i32
  store i32 1219566523, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 981127841, i32* %canary
  %begin_bytepos.addr = alloca i32, align 4
  %count = alloca i32, align 4
  %min_num_bytes.addr = alloca i32, align 4
  %streamBuffer.addr = alloca i8*, align 8
...
entry:
  %streamBuffer.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1237576607, i32* %canary
  %end_bytepos.addr = alloca i32, align 4
  %count = alloca i32, align 4
  %min_num_bytes.addr = alloca i32, align 4
  %i = alloca i32, align 4
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1836784246, i32* %canary
  %count = alloca i32, align 4
  %i = alloca i32, align 4
  %min_num_bytes.addr = alloca i32, align 4
  %streamBuffer.addr = alloca i8*, align 8
...
entry:
  ...
  %count = alloca i32, align 4
  %canary = alloca i32
  store i32 2072109872, i32* %canary
  %min_num_bytes.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %end_bytepos.addr = alloca i32, align 4
  %j = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1082452061, i32* %canary
  %begin_bytepos.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %min_num_bytes.addr = alloca i32, align 4
  %streamBuffer.addr = alloca i8*, align 8
...
entry:
  %min_num_bytes.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1977288233, i32* %canary
  %begin_bytepos.addr = alloca i32, align 4
  %count = alloca i32, align 4
  %streamBuffer.addr = alloca i8*, align 8
  %i = alloca i32, align 4
