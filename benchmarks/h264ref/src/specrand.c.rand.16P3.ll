; ModuleID = 'specrand.c.rand.16P3.bc'
...
entry:
  ...
  %canary = alloca i32
  store i32 1722986134, i32* %canary
...
entry:
  ...
  %hi = alloca i32, align 4
  %canary = alloca i32
  store i32 872910781, i32* %canary
  %lo = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
  %conv = sext i32 %0 to i64
  %div = sdiv i64 %conv, 127773
...
entry:
  ...
  %test = alloca i32, align 4
  %canary = alloca i32
  store i32 966059749, i32* %canary
  %lo = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
  %conv = sext i32 %0 to i64
  %div = sdiv i64 %conv, 127773
...
entry:
  %lo = alloca i32, align 4
  %canary = alloca i32
  store i32 1850419529, i32* %canary
  %test = alloca i32, align 4
  %hi = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
  %conv = sext i32 %0 to i64
...
entry:
  %canary = alloca i32
  store i32 1293499393, i32* %canary
  %lo = alloca i32, align 4
  %hi = alloca i32, align 4
  %test = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
...
entry:
  %test = alloca i32, align 4
  %canary = alloca i32
  store i32 806088794, i32* %canary
  %lo = alloca i32, align 4
  %hi = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
  %conv = sext i32 %0 to i64
