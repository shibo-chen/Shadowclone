; ModuleID = 'filehandle.c.rand.16R3.bc'
...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_error.6, label %func_error.7

func_error.6:                                     ; preds = %rand_bb
  call void @error.6(i8* %text, i32 %code)
  ret void

func_error.7:                                     ; preds = %rand_bb
  call void @error.7(i8* %text, i32 %code)
  ret void
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_write_PPS.1, label %ctrl0

func_write_PPS.1:                                 ; preds = %rand_bb
  %2 = call i32 @write_PPS.1(i32 %len, i32 %PPS_id)
  ret i32 %2

func_write_PPS.3:                                 ; preds = %ctrl0
  %3 = call i32 @write_PPS.3(i32 %len, i32 %PPS_id)
  ret i32 %3

func_write_PPS.5:                                 ; preds = %ctrl1
  %4 = call i32 @write_PPS.5(i32 %len, i32 %PPS_id)
  ret i32 %4

func_write_PPS.8:                                 ; preds = %ctrl2
  %5 = call i32 @write_PPS.8(i32 %len, i32 %PPS_id)
  ret i32 %5

func_write_PPS.11:                                ; preds = %ctrl3
  %6 = call i32 @write_PPS.11(i32 %len, i32 %PPS_id)
  ret i32 %6

func_write_PPS.12:                                ; preds = %ctrl3
  %7 = call i32 @write_PPS.12(i32 %len, i32 %PPS_id)
  ret i32 %7

ctrl0:                                            ; preds = %rand_bb
  %8 = icmp eq i32 %0, 1
  br i1 %8, label %func_write_PPS.3, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %9 = icmp eq i32 %0, 2
  br i1 %9, label %func_write_PPS.5, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %10 = icmp eq i32 %0, 3
  br i1 %10, label %func_write_PPS.8, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %11 = icmp eq i32 %0, 4
  br i1 %11, label %func_write_PPS.11, label %func_write_PPS.12
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_start_sequence.2, label %ctrl0

func_start_sequence.2:                            ; preds = %rand_bb
  %2 = call i32 @start_sequence.2()
  ret i32 %2
...
func_start_sequence.9:                            ; preds = %ctrl1
  %4 = call i32 @start_sequence.9()
  ret i32 %4

func_start_sequence.10:                           ; preds = %ctrl2
  %5 = call i32 @start_sequence.10()
  ret i32 %5

func_start_sequence.13:                           ; preds = %ctrl3
  %6 = call i32 @start_sequence.13()
  ret i32 %6

func_start_sequence.14:                           ; preds = %ctrl4
  %7 = call i32 @start_sequence.14()
  ret i32 %7
...
ctrl1:                                            ; preds = %ctrl0
  %19 = icmp eq i32 %0, 2
  br i1 %19, label %func_start_sequence.9, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %20 = icmp eq i32 %0, 3
  br i1 %20, label %func_start_sequence.10, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %21 = icmp eq i32 %0, 4
  br i1 %21, label %func_start_sequence.13, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %22 = icmp eq i32 %0, 5
  br i1 %22, label %func_start_sequence.14, label %ctrl5
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @write_PPS.1(i32 %len, i32 %PPS_id) #0 {
entry:
  %canary = alloca i32
  store i32 622888, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @start_sequence.2() #0 {
entry:
  %len = alloca i32, align 4
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1846543778, i32* %canary
  %nalu = alloca %struct.NALU_t*, align 8
...
entry:
  %len.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 170478017, i32* %canary
  %nalu = alloca %struct.NALU_t*, align 8
  %PPS_id.addr = alloca i32, align 4
  store i32 %len, i32* %len.addr, align 4
  store i32 %PPS_id, i32* %PPS_id.addr, align 4
...
entry:
  ...
  %total_pps = alloca i32, align 4
  %canary = alloca i32
  store i32 142345189, i32* %canary
  %retval = alloca i32, align 4
  %nalu = alloca %struct.NALU_t*, align 8
  %i = alloca i32, align 4
  store i32 0, i32* %len, align 4
...
entry:
  %PPS_id.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2062871890, i32* %canary
  %len.addr = alloca i32, align 4
  %nalu = alloca %struct.NALU_t*, align 8
  store i32 %len, i32* %len.addr, align 4
  store i32 %PPS_id, i32* %PPS_id.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @error.6(i8* %text, i32 %code) #0 {
entry:
  %canary = alloca i32
  store i32 364877737, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @error.7(i8* %text, i32 %code) #0 {
entry:
  %text.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 2131977702, i32* %canary
  %code.addr = alloca i32, align 4
  store i8* %text, i8** %text.addr, align 8
  store i32 %code, i32* %code.addr, align 4
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
...
entry:
  ...
  %PPS_id.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1309273254, i32* %canary
  %len.addr = alloca i32, align 4
  store i32 %len, i32* %len.addr, align 4
  store i32 %PPS_id, i32* %PPS_id.addr, align 4
  store %struct.NALU_t* null, %struct.NALU_t** %nalu, align 8
...
entry:
  ...
  %total_pps = alloca i32, align 4
  %canary = alloca i32
  store i32 1723254603, i32* %canary
  %retval = alloca i32, align 4
  %len = alloca i32, align 4
  %nalu = alloca %struct.NALU_t*, align 8
  store i32 0, i32* %len, align 4
...
entry:
  ...
  %nalu = alloca %struct.NALU_t*, align 8
  %canary = alloca i32
  store i32 349487521, i32* %canary
  %i = alloca i32, align 4
  %len = alloca i32, align 4
  %total_pps = alloca i32, align 4
  store i32 0, i32* %len, align 4
...
entry:
  ...
  %nalu = alloca %struct.NALU_t*, align 8
  %canary = alloca i32
  store i32 1136335356, i32* %canary
  %len.addr = alloca i32, align 4
  store i32 %len, i32* %len.addr, align 4
  store i32 %PPS_id, i32* %PPS_id.addr, align 4
  store %struct.NALU_t* null, %struct.NALU_t** %nalu, align 8
...
entry:
  %canary = alloca i32
  store i32 1474658815, i32* %canary
  %nalu = alloca %struct.NALU_t*, align 8
  %len.addr = alloca i32, align 4
  %PPS_id.addr = alloca i32, align 4
  store i32 %len, i32* %len.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @start_sequence.13() #0 {
entry:
  %nalu = alloca %struct.NALU_t*, align 8
  %canary = alloca i32
  store i32 1738267058, i32* %canary
  %i = alloca i32, align 4
  %len = alloca i32, align 4
  %retval = alloca i32, align 4
  %total_pps = alloca i32, align 4
...
entry:
  ...
  %total_pps = alloca i32, align 4
  %canary = alloca i32
  store i32 558252816, i32* %canary
  %i = alloca i32, align 4
  %nalu = alloca %struct.NALU_t*, align 8
  %len = alloca i32, align 4
  store i32 0, i32* %len, align 4
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 825496436, i32* %canary
  %retval = alloca i32, align 4
  %len = alloca i32, align 4
  %nalu = alloca %struct.NALU_t*, align 8
  store i32 0, i32* %len, align 4
...
entry:
  %nalu = alloca %struct.NALU_t*, align 8
  %canary = alloca i32
  store i32 967919786, i32* %canary
  %retval = alloca i32, align 4
  %len = alloca i32, align 4
  %i = alloca i32, align 4
  %total_pps = alloca i32, align 4
...
entry:
  ...
  %nalu = alloca %struct.NALU_t*, align 8
  %canary = alloca i32
  store i32 1445254835, i32* %canary
  %retval = alloca i32, align 4
  store i32 0, i32* %len, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %GenerateMultiplePPS = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 15
...
entry:
  ...
  %nalu = alloca %struct.NALU_t*, align 8
  %canary = alloca i32
  store i32 727605935, i32* %canary
  %i = alloca i32, align 4
  %retval = alloca i32, align 4
  %len = alloca i32, align 4
  store i32 0, i32* %len, align 4
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1646333283, i32* %canary
  %nalu = alloca %struct.NALU_t*, align 8
  %retval = alloca i32, align 4
  store i32 0, i32* %len, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
entry:
  ...
  %nalu = alloca %struct.NALU_t*, align 8
  %canary = alloca i32
  store i32 1804025031, i32* %canary
  %len = alloca i32, align 4
  %total_pps = alloca i32, align 4
  store i32 0, i32* %len, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1440177334, i32* %canary
  %retval = alloca i32, align 4
  %total_pps = alloca i32, align 4
  store i32 0, i32* %len, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 636648774, i32* %canary
  %total_pps = alloca i32, align 4
  store i32 0, i32* %len, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %GenerateMultiplePPS = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 15
...
entry:
  %total_pps = alloca i32, align 4
  %canary = alloca i32
  store i32 1887893906, i32* %canary
  %nalu = alloca %struct.NALU_t*, align 8
  %retval = alloca i32, align 4
  %len = alloca i32, align 4
  %i = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1458970886, i32* %canary
  %nalu = alloca %struct.NALU_t*, align 8
  %retval = alloca i32, align 4
  %total_pps = alloca i32, align 4
  %len = alloca i32, align 4
