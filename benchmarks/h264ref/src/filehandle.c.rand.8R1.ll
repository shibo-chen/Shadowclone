; ModuleID = 'filehandle.c.rand.8R1.bc'
...
ctrl2:                                            ; preds = %ctrl1
  %10 = icmp eq i32 %0, 3
  br i1 %10, label %func_write_PPS.10, label %ctrl3
...
func_start_sequence.6:                            ; preds = %ctrl0
  %3 = call i32 @start_sequence.6()
  ret i32 %3
...
ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_start_sequence.6, label %ctrl1
...
entry:
  ...
  %canary = alloca i32
  store i32 1408183620, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 763458643, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1803374560, i32* %canary
  %code.addr = alloca i32, align 4
  %text.addr = alloca i8*, align 8
  store i8* %text, i8** %text.addr, align 8
  store i32 %code, i32* %code.addr, align 4
...
entry:
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1981811619, i32* %canary
...
entry:
  %PPS_id.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1370324358, i32* %canary
  %len.addr = alloca i32, align 4
  %nalu = alloca %struct.NALU_t*, align 8
  store i32 %len, i32* %len.addr, align 4
  store i32 %PPS_id, i32* %PPS_id.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 339098344, i32* %canary
  %total_pps = alloca i32, align 4
  %len = alloca i32, align 4
  %nalu = alloca %struct.NALU_t*, align 8
  %i = alloca i32, align 4
...
entry:
  ...
  %nalu = alloca %struct.NALU_t*, align 8
  %canary = alloca i32
  store i32 560968361, i32* %canary
  %PPS_id.addr = alloca i32, align 4
  store i32 %len, i32* %len.addr, align 4
  store i32 %PPS_id, i32* %PPS_id.addr, align 4
  store %struct.NALU_t* null, %struct.NALU_t** %nalu, align 8
...
entry:
  ...
  %total_pps = alloca i32, align 4
  %canary = alloca i32
  store i32 317864987, i32* %canary
  %len = alloca i32, align 4
  store i32 0, i32* %len, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %GenerateMultiplePPS = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 15
...
entry:
  ...
  %nalu = alloca %struct.NALU_t*, align 8
  %canary = alloca i32
  store i32 1356975897, i32* %canary
  %len = alloca i32, align 4
  %retval = alloca i32, align 4
  %i = alloca i32, align 4
  store i32 0, i32* %len, align 4
...
entry:
  %canary = alloca i32
  store i32 227131387, i32* %canary
  %nalu = alloca %struct.NALU_t*, align 8
  %len.addr = alloca i32, align 4
  %PPS_id.addr = alloca i32, align 4
  store i32 %len, i32* %len.addr, align 4
...
entry:
  %nalu = alloca %struct.NALU_t*, align 8
  %canary = alloca i32
  store i32 1171022023, i32* %canary
  %PPS_id.addr = alloca i32, align 4
  %len.addr = alloca i32, align 4
  store i32 %len, i32* %len.addr, align 4
  store i32 %PPS_id, i32* %PPS_id.addr, align 4
...
entry:
  ...
  %nalu = alloca %struct.NALU_t*, align 8
  %canary = alloca i32
  store i32 2142560139, i32* %canary
  %len.addr = alloca i32, align 4
  store i32 %len, i32* %len.addr, align 4
  store i32 %PPS_id, i32* %PPS_id.addr, align 4
  store %struct.NALU_t* null, %struct.NALU_t** %nalu, align 8
...
entry:
  %len = alloca i32, align 4
  %canary = alloca i32
  store i32 938324673, i32* %canary
  %nalu = alloca %struct.NALU_t*, align 8
  %retval = alloca i32, align 4
  %total_pps = alloca i32, align 4
  %i = alloca i32, align 4
...
entry:
  ...
  %total_pps = alloca i32, align 4
  %canary = alloca i32
  store i32 1631299142, i32* %canary
  %i = alloca i32, align 4
  store i32 0, i32* %len, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %GenerateMultiplePPS = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 15
...
entry:
  %total_pps = alloca i32, align 4
  %canary = alloca i32
  store i32 1322998292, i32* %canary
  %nalu = alloca %struct.NALU_t*, align 8
  %i = alloca i32, align 4
  %len = alloca i32, align 4
  %retval = alloca i32, align 4
...
entry:
  %len = alloca i32, align 4
  %canary = alloca i32
  store i32 2121833297, i32* %canary
  %nalu = alloca %struct.NALU_t*, align 8
  %retval = alloca i32, align 4
  %i = alloca i32, align 4
  %total_pps = alloca i32, align 4
