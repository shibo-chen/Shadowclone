...
func_FmoInit.12:                                  ; preds = %ctrl0
  %3 = call i32 @FmoInit.12(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps, %struct.seq_parameter_set_rbsp_t* %sps)
  ret i32 %3

func_FmoInit.20:                                  ; preds = %ctrl1
  %4 = call i32 @FmoInit.20(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps, %struct.seq_parameter_set_rbsp_t* %sps)
  ret i32 %4

func_FmoInit.33:                                  ; preds = %ctrl2
  %5 = call i32 @FmoInit.33(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps, %struct.seq_parameter_set_rbsp_t* %sps)
  ret i32 %5

func_FmoInit.42:                                  ; preds = %ctrl3
  %6 = call i32 @FmoInit.42(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps, %struct.seq_parameter_set_rbsp_t* %sps)
  ret i32 %6

func_FmoInit.53:                                  ; preds = %ctrl4
  %7 = call i32 @FmoInit.53(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps, %struct.seq_parameter_set_rbsp_t* %sps)
  ret i32 %7

func_FmoInit.55:                                  ; preds = %ctrl5
  %8 = call i32 @FmoInit.55(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps, %struct.seq_parameter_set_rbsp_t* %sps)
  ret i32 %8

func_FmoInit.78:                                  ; preds = %ctrl5
  %9 = call i32 @FmoInit.78(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps, %struct.seq_parameter_set_rbsp_t* %sps)
  ret i32 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_FmoInit.12, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_FmoInit.20, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_FmoInit.33, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_FmoInit.42, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_FmoInit.53, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_FmoInit.55, label %func_FmoInit.78
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FmoGenerateMapUnitToSliceGroupMap.1, label %ctrl0

func_FmoGenerateMapUnitToSliceGroupMap.1:         ; preds = %rand_bb
  %2 = call i32 @FmoGenerateMapUnitToSliceGroupMap.1(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret i32 %2

func_FmoGenerateMapUnitToSliceGroupMap.3:         ; preds = %ctrl0
  %3 = call i32 @FmoGenerateMapUnitToSliceGroupMap.3(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret i32 %3

func_FmoGenerateMapUnitToSliceGroupMap.39:        ; preds = %ctrl1
  %4 = call i32 @FmoGenerateMapUnitToSliceGroupMap.39(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret i32 %4

func_FmoGenerateMapUnitToSliceGroupMap.52:        ; preds = %ctrl2
  %5 = call i32 @FmoGenerateMapUnitToSliceGroupMap.52(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret i32 %5

func_FmoGenerateMapUnitToSliceGroupMap.71:        ; preds = %ctrl3
  %6 = call i32 @FmoGenerateMapUnitToSliceGroupMap.71(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret i32 %6

func_FmoGenerateMapUnitToSliceGroupMap.72:        ; preds = %ctrl3
  %7 = call i32 @FmoGenerateMapUnitToSliceGroupMap.72(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret i32 %7

ctrl0:                                            ; preds = %rand_bb
  %8 = icmp eq i32 %0, 1
  br i1 %8, label %func_FmoGenerateMapUnitToSliceGroupMap.3, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %9 = icmp eq i32 %0, 2
  br i1 %9, label %func_FmoGenerateMapUnitToSliceGroupMap.39, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %10 = icmp eq i32 %0, 3
  br i1 %10, label %func_FmoGenerateMapUnitToSliceGroupMap.52, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %11 = icmp eq i32 %0, 4
  br i1 %11, label %func_FmoGenerateMapUnitToSliceGroupMap.71, label %func_FmoGenerateMapUnitToSliceGroupMap.72
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FmoGenerateMBAmap.23, label %ctrl0

func_FmoGenerateMBAmap.23:                        ; preds = %rand_bb
  %2 = call i32 @FmoGenerateMBAmap.23(%struct.ImageParameters* %img, %struct.seq_parameter_set_rbsp_t* %sps)
  ret i32 %2
...
func_FmoGenerateMBAmap.43:                        ; preds = %ctrl1
  %4 = call i32 @FmoGenerateMBAmap.43(%struct.ImageParameters* %img, %struct.seq_parameter_set_rbsp_t* %sps)
  ret i32 %4

func_FmoGenerateMBAmap.47:                        ; preds = %ctrl2
  %5 = call i32 @FmoGenerateMBAmap.47(%struct.ImageParameters* %img, %struct.seq_parameter_set_rbsp_t* %sps)
  ret i32 %5

func_FmoGenerateMBAmap.61:                        ; preds = %ctrl3
  %6 = call i32 @FmoGenerateMBAmap.61(%struct.ImageParameters* %img, %struct.seq_parameter_set_rbsp_t* %sps)
  ret i32 %6

func_FmoGenerateMBAmap.75:                        ; preds = %ctrl3
  %7 = call i32 @FmoGenerateMBAmap.75(%struct.ImageParameters* %img, %struct.seq_parameter_set_rbsp_t* %sps)
  ret i32 %7

ctrl0:                                            ; preds = %rand_bb
  %8 = icmp eq i32 %0, 1
  br i1 %8, label %func_FmoGenerateMBAmap.40, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %9 = icmp eq i32 %0, 2
  br i1 %9, label %func_FmoGenerateMBAmap.43, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %10 = icmp eq i32 %0, 3
  br i1 %10, label %func_FmoGenerateMBAmap.47, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %11 = icmp eq i32 %0, 4
  br i1 %11, label %func_FmoGenerateMBAmap.61, label %func_FmoGenerateMBAmap.75
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FmoGetFirstMBOfSliceGroup.18, label %ctrl0

func_FmoGetFirstMBOfSliceGroup.18:                ; preds = %rand_bb
  %2 = call i32 @FmoGetFirstMBOfSliceGroup.18(i32 %SliceGroupID)
  ret i32 %2

func_FmoGetFirstMBOfSliceGroup.30:                ; preds = %ctrl0
  %3 = call i32 @FmoGetFirstMBOfSliceGroup.30(i32 %SliceGroupID)
  ret i32 %3

func_FmoGetFirstMBOfSliceGroup.62:                ; preds = %ctrl1
  %4 = call i32 @FmoGetFirstMBOfSliceGroup.62(i32 %SliceGroupID)
  ret i32 %4

func_FmoGetFirstMBOfSliceGroup.80:                ; preds = %ctrl2
  %5 = call i32 @FmoGetFirstMBOfSliceGroup.80(i32 %SliceGroupID)
  ret i32 %5

func_FmoGetFirstMBOfSliceGroup.88:                ; preds = %ctrl3
  %6 = call i32 @FmoGetFirstMBOfSliceGroup.88(i32 %SliceGroupID)
  ret i32 %6

func_FmoGetFirstMBOfSliceGroup.94:                ; preds = %ctrl3
  %7 = call i32 @FmoGetFirstMBOfSliceGroup.94(i32 %SliceGroupID)
  ret i32 %7

ctrl0:                                            ; preds = %rand_bb
  %8 = icmp eq i32 %0, 1
  br i1 %8, label %func_FmoGetFirstMBOfSliceGroup.30, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %9 = icmp eq i32 %0, 2
  br i1 %9, label %func_FmoGetFirstMBOfSliceGroup.62, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %10 = icmp eq i32 %0, 3
  br i1 %10, label %func_FmoGetFirstMBOfSliceGroup.80, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %11 = icmp eq i32 %0, 4
  br i1 %11, label %func_FmoGetFirstMBOfSliceGroup.88, label %func_FmoGetFirstMBOfSliceGroup.94
}
...
func_FmoGetNextMBNr.22:                           ; preds = %ctrl0
  %3 = call i32 @FmoGetNextMBNr.22(i32 %CurrentMbNr)
  ret i32 %3

func_FmoGetNextMBNr.65:                           ; preds = %ctrl1
  %4 = call i32 @FmoGetNextMBNr.65(i32 %CurrentMbNr)
  ret i32 %4

func_FmoGetNextMBNr.74:                           ; preds = %ctrl2
  %5 = call i32 @FmoGetNextMBNr.74(i32 %CurrentMbNr)
  ret i32 %5

func_FmoGetNextMBNr.84:                           ; preds = %ctrl3
  %6 = call i32 @FmoGetNextMBNr.84(i32 %CurrentMbNr)
  ret i32 %6

func_FmoGetNextMBNr.90:                           ; preds = %ctrl3
  %7 = call i32 @FmoGetNextMBNr.90(i32 %CurrentMbNr)
  ret i32 %7

ctrl0:                                            ; preds = %rand_bb
  %8 = icmp eq i32 %0, 1
  br i1 %8, label %func_FmoGetNextMBNr.22, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %9 = icmp eq i32 %0, 2
  br i1 %9, label %func_FmoGetNextMBNr.65, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %10 = icmp eq i32 %0, 3
  br i1 %10, label %func_FmoGetNextMBNr.74, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %11 = icmp eq i32 %0, 4
  br i1 %11, label %func_FmoGetNextMBNr.84, label %func_FmoGetNextMBNr.90
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FmoGetPreviousMBNr.5, label %ctrl0

func_FmoGetPreviousMBNr.5:                        ; preds = %rand_bb
  %2 = call i32 @FmoGetPreviousMBNr.5(i32 %CurrentMbNr)
  ret i32 %2

func_FmoGetPreviousMBNr.17:                       ; preds = %ctrl0
  %3 = call i32 @FmoGetPreviousMBNr.17(i32 %CurrentMbNr)
  ret i32 %3
...
func_FmoGetPreviousMBNr.36:                       ; preds = %ctrl2
  %5 = call i32 @FmoGetPreviousMBNr.36(i32 %CurrentMbNr)
  ret i32 %5

func_FmoGetPreviousMBNr.38:                       ; preds = %ctrl3
  %6 = call i32 @FmoGetPreviousMBNr.38(i32 %CurrentMbNr)
  ret i32 %6

func_FmoGetPreviousMBNr.67:                       ; preds = %ctrl3
  %7 = call i32 @FmoGetPreviousMBNr.67(i32 %CurrentMbNr)
  ret i32 %7

ctrl0:                                            ; preds = %rand_bb
  %8 = icmp eq i32 %0, 1
  br i1 %8, label %func_FmoGetPreviousMBNr.17, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %9 = icmp eq i32 %0, 2
  br i1 %9, label %func_FmoGetPreviousMBNr.21, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %10 = icmp eq i32 %0, 3
  br i1 %10, label %func_FmoGetPreviousMBNr.36, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %11 = icmp eq i32 %0, 4
  br i1 %11, label %func_FmoGetPreviousMBNr.38, label %func_FmoGetPreviousMBNr.67
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FmoGetLastCodedMBOfSliceGroup.14, label %ctrl0

func_FmoGetLastCodedMBOfSliceGroup.14:            ; preds = %rand_bb
  %2 = call i32 @FmoGetLastCodedMBOfSliceGroup.14(i32 %SliceGroupID)
  ret i32 %2
...
func_FmoGetLastCodedMBOfSliceGroup.35:            ; preds = %ctrl1
  %4 = call i32 @FmoGetLastCodedMBOfSliceGroup.35(i32 %SliceGroupID)
  ret i32 %4

func_FmoGetLastCodedMBOfSliceGroup.45:            ; preds = %ctrl2
  %5 = call i32 @FmoGetLastCodedMBOfSliceGroup.45(i32 %SliceGroupID)
  ret i32 %5

func_FmoGetLastCodedMBOfSliceGroup.82:            ; preds = %ctrl3
  %6 = call i32 @FmoGetLastCodedMBOfSliceGroup.82(i32 %SliceGroupID)
  ret i32 %6

func_FmoGetLastCodedMBOfSliceGroup.92:            ; preds = %ctrl3
  %7 = call i32 @FmoGetLastCodedMBOfSliceGroup.92(i32 %SliceGroupID)
  ret i32 %7

ctrl0:                                            ; preds = %rand_bb
  %8 = icmp eq i32 %0, 1
  br i1 %8, label %func_FmoGetLastCodedMBOfSliceGroup.15, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %9 = icmp eq i32 %0, 2
  br i1 %9, label %func_FmoGetLastCodedMBOfSliceGroup.35, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %10 = icmp eq i32 %0, 3
  br i1 %10, label %func_FmoGetLastCodedMBOfSliceGroup.45, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %11 = icmp eq i32 %0, 4
  br i1 %11, label %func_FmoGetLastCodedMBOfSliceGroup.82, label %func_FmoGetLastCodedMBOfSliceGroup.92
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FmoSetLastMacroblockInSlice.9, label %func_FmoSetLastMacroblockInSlice.44

func_FmoSetLastMacroblockInSlice.9:               ; preds = %rand_bb
  call void @FmoSetLastMacroblockInSlice.9(i32 %mb)
  ret void

func_FmoSetLastMacroblockInSlice.44:              ; preds = %rand_bb
  call void @FmoSetLastMacroblockInSlice.44(i32 %mb)
  ret void
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FmoSliceGroupCompletelyCoded.59, label %func_FmoSliceGroupCompletelyCoded.69

func_FmoSliceGroupCompletelyCoded.59:             ; preds = %rand_bb
  %2 = call i32 @FmoSliceGroupCompletelyCoded.59(i32 %SliceGroupID)
  ret i32 %2
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FmoGenerateType0MapUnitMap.31, label %ctrl0

func_FmoGenerateType0MapUnitMap.31:               ; preds = %rand_bb
  call void @FmoGenerateType0MapUnitMap.31(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType0MapUnitMap.41:               ; preds = %ctrl0
...
func_FmoGenerateType0MapUnitMap.58:               ; preds = %ctrl2
  call void @FmoGenerateType0MapUnitMap.58(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType0MapUnitMap.68:               ; preds = %ctrl3
  call void @FmoGenerateType0MapUnitMap.68(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType0MapUnitMap.83:               ; preds = %ctrl4
  call void @FmoGenerateType0MapUnitMap.83(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType0MapUnitMap.86:               ; preds = %ctrl5
  call void @FmoGenerateType0MapUnitMap.86(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType0MapUnitMap.93:               ; preds = %ctrl5
  call void @FmoGenerateType0MapUnitMap.93(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_FmoGenerateType0MapUnitMap.41, label %ctrl1
...
ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_FmoGenerateType0MapUnitMap.58, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_FmoGenerateType0MapUnitMap.68, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_FmoGenerateType0MapUnitMap.83, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_FmoGenerateType0MapUnitMap.86, label %func_FmoGenerateType0MapUnitMap.93
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FmoGenerateType1MapUnitMap.16, label %ctrl0

func_FmoGenerateType1MapUnitMap.16:               ; preds = %rand_bb
  call void @FmoGenerateType1MapUnitMap.16(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void
...
func_FmoGenerateType1MapUnitMap.77:               ; preds = %ctrl3
  call void @FmoGenerateType1MapUnitMap.77(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_FmoGenerateType1MapUnitMap.29, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_FmoGenerateType1MapUnitMap.34, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_FmoGenerateType1MapUnitMap.64, label %func_FmoGenerateType1MapUnitMap.77
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FmoGenerateType2MapUnitMap.4, label %ctrl0

func_FmoGenerateType2MapUnitMap.4:                ; preds = %rand_bb
  call void @FmoGenerateType2MapUnitMap.4(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType2MapUnitMap.27:               ; preds = %ctrl0
  call void @FmoGenerateType2MapUnitMap.27(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType2MapUnitMap.32:               ; preds = %ctrl1
  call void @FmoGenerateType2MapUnitMap.32(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType2MapUnitMap.37:               ; preds = %ctrl2
...
func_FmoGenerateType2MapUnitMap.70:               ; preds = %ctrl4
  call void @FmoGenerateType2MapUnitMap.70(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType2MapUnitMap.81:               ; preds = %ctrl5
  call void @FmoGenerateType2MapUnitMap.81(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType2MapUnitMap.91:               ; preds = %ctrl5
  call void @FmoGenerateType2MapUnitMap.91(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_FmoGenerateType2MapUnitMap.27, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_FmoGenerateType2MapUnitMap.32, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_FmoGenerateType2MapUnitMap.37, label %ctrl3
...
ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_FmoGenerateType2MapUnitMap.70, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_FmoGenerateType2MapUnitMap.81, label %func_FmoGenerateType2MapUnitMap.91
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FmoGenerateType3MapUnitMap.2, label %ctrl0

func_FmoGenerateType3MapUnitMap.2:                ; preds = %rand_bb
  call void @FmoGenerateType3MapUnitMap.2(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void
...
func_FmoGenerateType3MapUnitMap.28:               ; preds = %ctrl2
  call void @FmoGenerateType3MapUnitMap.28(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType3MapUnitMap.48:               ; preds = %ctrl3
  call void @FmoGenerateType3MapUnitMap.48(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType3MapUnitMap.49:               ; preds = %ctrl4
  call void @FmoGenerateType3MapUnitMap.49(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType3MapUnitMap.50:               ; preds = %ctrl5
  call void @FmoGenerateType3MapUnitMap.50(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType3MapUnitMap.51:               ; preds = %ctrl5
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_FmoGenerateType3MapUnitMap.25, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_FmoGenerateType3MapUnitMap.28, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_FmoGenerateType3MapUnitMap.48, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_FmoGenerateType3MapUnitMap.49, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_FmoGenerateType3MapUnitMap.50, label %func_FmoGenerateType3MapUnitMap.51
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FmoGenerateType4MapUnitMap.73, label %ctrl0

func_FmoGenerateType4MapUnitMap.73:               ; preds = %rand_bb
  call void @FmoGenerateType4MapUnitMap.73(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType4MapUnitMap.76:               ; preds = %ctrl0
  call void @FmoGenerateType4MapUnitMap.76(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType4MapUnitMap.79:               ; preds = %ctrl1
  call void @FmoGenerateType4MapUnitMap.79(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType4MapUnitMap.85:               ; preds = %ctrl2
  call void @FmoGenerateType4MapUnitMap.85(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType4MapUnitMap.97:               ; preds = %ctrl3
  call void @FmoGenerateType4MapUnitMap.97(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType4MapUnitMap.98:               ; preds = %ctrl4
  call void @FmoGenerateType4MapUnitMap.98(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void
...
func_FmoGenerateType4MapUnitMap.100:              ; preds = %ctrl5
  call void @FmoGenerateType4MapUnitMap.100(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_FmoGenerateType4MapUnitMap.76, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_FmoGenerateType4MapUnitMap.79, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_FmoGenerateType4MapUnitMap.85, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_FmoGenerateType4MapUnitMap.97, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_FmoGenerateType4MapUnitMap.98, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_FmoGenerateType4MapUnitMap.99, label %func_FmoGenerateType4MapUnitMap.100
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FmoGenerateType5MapUnitMap.7, label %ctrl0

func_FmoGenerateType5MapUnitMap.7:                ; preds = %rand_bb
  call void @FmoGenerateType5MapUnitMap.7(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType5MapUnitMap.13:               ; preds = %ctrl0
  call void @FmoGenerateType5MapUnitMap.13(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType5MapUnitMap.54:               ; preds = %ctrl1
  call void @FmoGenerateType5MapUnitMap.54(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType5MapUnitMap.56:               ; preds = %ctrl2
  call void @FmoGenerateType5MapUnitMap.56(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType5MapUnitMap.87:               ; preds = %ctrl3
  call void @FmoGenerateType5MapUnitMap.87(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType5MapUnitMap.89:               ; preds = %ctrl4
  call void @FmoGenerateType5MapUnitMap.89(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType5MapUnitMap.95:               ; preds = %ctrl5
  call void @FmoGenerateType5MapUnitMap.95(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType5MapUnitMap.96:               ; preds = %ctrl5
  call void @FmoGenerateType5MapUnitMap.96(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_FmoGenerateType5MapUnitMap.13, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_FmoGenerateType5MapUnitMap.54, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_FmoGenerateType5MapUnitMap.56, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_FmoGenerateType5MapUnitMap.87, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_FmoGenerateType5MapUnitMap.89, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_FmoGenerateType5MapUnitMap.95, label %func_FmoGenerateType5MapUnitMap.96
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FmoGenerateType6MapUnitMap.11, label %ctrl0

func_FmoGenerateType6MapUnitMap.11:               ; preds = %rand_bb
  call void @FmoGenerateType6MapUnitMap.11(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType6MapUnitMap.24:               ; preds = %ctrl0
  call void @FmoGenerateType6MapUnitMap.24(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType6MapUnitMap.26:               ; preds = %ctrl1
  call void @FmoGenerateType6MapUnitMap.26(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType6MapUnitMap.60:               ; preds = %ctrl2
  call void @FmoGenerateType6MapUnitMap.60(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType6MapUnitMap.63:               ; preds = %ctrl3
  call void @FmoGenerateType6MapUnitMap.63(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType6MapUnitMap.66:               ; preds = %ctrl3
  call void @FmoGenerateType6MapUnitMap.66(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_FmoGenerateType6MapUnitMap.24, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_FmoGenerateType6MapUnitMap.26, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_FmoGenerateType6MapUnitMap.60, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_FmoGenerateType6MapUnitMap.63, label %func_FmoGenerateType6MapUnitMap.66
}

; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @FmoGenerateMapUnitToSliceGroupMap.1(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %canary = alloca i32
  store i32 1773111026, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType3MapUnitMap.2(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 2111197819, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @FmoGenerateMapUnitToSliceGroupMap.3(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %canary = alloca i32
  store i32 1435733396, i32* %canary
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %retval = alloca i32, align 4
  %img.addr = alloca %struct.ImageParameters*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType2MapUnitMap.4(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %img.addr = alloca %struct.ImageParameters*, align 8
  %i = alloca i32, align 4
  ...
  %x = alloca i32, align 4
  %canary = alloca i32
  store i32 730668602, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @FmoGetPreviousMBNr.5(i32 %CurrentMbNr) #0 {
entry:
  %canary = alloca i32
  store i32 385193388, i32* %canary
...
entry:
  ...
  %k = alloca i32, align 4
  %canary = alloca i32
  store i32 1539306114, i32* %canary
  %img.addr = alloca %struct.ImageParameters*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
...
entry:
  ...
  %canary = alloca i32
  store i32 1130962325, i32* %canary
  %k = alloca i32, align 4
  %img.addr = alloca %struct.ImageParameters*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 839058109, i32* %canary
  %topBound = alloca i32, align 4
  %mapUnitsInSliceGroup0 = alloca i32, align 4
  %rightBound = alloca i32, align 4
  %yDir = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FmoSetLastMacroblockInSlice.9(i32 %mb) #0 {
entry:
  %canary = alloca i32
  store i32 1987602232, i32* %canary
  %mb.addr = alloca i32, align 4
...
entry:
  %CurrentMbNr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 883437032, i32* %canary
  %SliceGroupID = alloca i32, align 4
  %retval = alloca i32, align 4
  store i32 %CurrentMbNr, i32* %CurrentMbNr.addr, align 4
  %0 = load i32, i32* %CurrentMbNr.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType6MapUnitMap.11(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %canary = alloca i32
  store i32 393914883, i32* %canary
  %img.addr = alloca %struct.ImageParameters*, align 8
  %i = alloca i32, align 4
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @FmoInit.12(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps, %struct.seq_parameter_set_rbsp_t* %sps) #0 {
entry:
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %img.addr = alloca %struct.ImageParameters*, align 8
  %canary = alloca i32
  store i32 1363133740, i32* %canary
  %sps.addr = alloca %struct.seq_parameter_set_rbsp_t*, align 8
  %k = alloca i32, align 4
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType5MapUnitMap.13(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %k = alloca i32, align 4
  %img.addr = alloca %struct.ImageParameters*, align 8
  %mapUnitsInSliceGroup0 = alloca i32, align 4
  ...
  %sizeOfUpperLeftGroup = alloca i32, align 4
  %canary = alloca i32
  store i32 2050397770, i32* %canary
  %j = alloca i32, align 4
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @FmoGetLastCodedMBOfSliceGroup.14(i32 %SliceGroupID) #0 {
entry:
  %i = alloca i32, align 4
  %SliceGroupID.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1923367135, i32* %canary
...
entry:
  %LastMB = alloca i32, align 4
  %canary = alloca i32
  store i32 1358767023, i32* %canary
  %SliceGroupID.addr = alloca i32, align 4
  %i = alloca i32, align 4
  store i32 %SliceGroupID, i32* %SliceGroupID.addr, align 4
  store i32 -1, i32* %LastMB, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType1MapUnitMap.16(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %canary = alloca i32
  store i32 32860866, i32* %canary
  %img.addr = alloca %struct.ImageParameters*, align 8
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %i = alloca i32, align 4
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @FmoGetPreviousMBNr.17(i32 %CurrentMbNr) #0 {
entry:
  %CurrentMbNr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1861785278, i32* %canary
  %SliceGroupID = alloca i32, align 4
  %retval = alloca i32, align 4
  store i32 %CurrentMbNr, i32* %CurrentMbNr.addr, align 4
  %0 = load i32, i32* %CurrentMbNr.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @FmoGetFirstMBOfSliceGroup.18(i32 %SliceGroupID) #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1485789942, i32* %canary
  %retval = alloca i32, align 4
  %SliceGroupID.addr = alloca i32, align 4
  store i32 %SliceGroupID, i32* %SliceGroupID.addr, align 4
  store i32 0, i32* %i, align 4
...
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1660947185, i32* %canary
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %img.addr = alloca %struct.ImageParameters*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @FmoInit.20(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps, %struct.seq_parameter_set_rbsp_t* %sps) #0 {
entry:
  %img.addr = alloca %struct.ImageParameters*, align 8
  %k = alloca i32, align 4
  %canary = alloca i32
  store i32 90949708, i32* %canary
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %sps.addr = alloca %struct.seq_parameter_set_rbsp_t*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1384251491, i32* %canary
  %retval = alloca i32, align 4
  %CurrentMbNr.addr = alloca i32, align 4
  %SliceGroupID = alloca i32, align 4
  store i32 %CurrentMbNr, i32* %CurrentMbNr.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @FmoGetNextMBNr.22(i32 %CurrentMbNr) #0 {
entry:
  %SliceGroupID = alloca i32, align 4
  %CurrentMbNr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1702423965, i32* %canary
  %retval = alloca i32, align 4
  store i32 %CurrentMbNr, i32* %CurrentMbNr.addr, align 4
  %0 = load i32, i32* %CurrentMbNr.addr, align 4
  %call = call i32 @FmoMB2SliceGroup(i32 %0)
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @FmoGenerateMBAmap.23(%struct.ImageParameters* %img, %struct.seq_parameter_set_rbsp_t* %sps) #0 {
entry:
  %i = alloca i32, align 4
  %sps.addr = alloca %struct.seq_parameter_set_rbsp_t*, align 8
  %canary = alloca i32
  store i32 275548238, i32* %canary
  %img.addr = alloca %struct.ImageParameters*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.seq_parameter_set_rbsp_t* %sps, %struct.seq_parameter_set_rbsp_t** %sps.addr, align 8
  %0 = load i8*, i8** @MBAmap, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType6MapUnitMap.24(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 109353018, i32* %canary
  %img.addr = alloca %struct.ImageParameters*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
  store i32 0, i32* %i, align 4
...
entry:
  ...
  %leftBound = alloca i32, align 4
  %canary = alloca i32
  store i32 934421322, i32* %canary
  %bottomBound = alloca i32, align 4
  %k = alloca i32, align 4
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType6MapUnitMap.26(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1095711414, i32* %canary
  %img.addr = alloca %struct.ImageParameters*, align 8
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType2MapUnitMap.27(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %xBottomRight = alloca i32, align 4
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %i = alloca i32, align 4
  ...
  %yTopLeft = alloca i32, align 4
  %canary = alloca i32
  store i32 1585248021, i32* %canary
  %img.addr = alloca %struct.ImageParameters*, align 8
  %xTopLeft = alloca i32, align 4
  %y = alloca i32, align 4
  %yBottomRight = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType3MapUnitMap.28(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %leftBound = alloca i32, align 4
  %xDir = alloca i32, align 4
  %mapUnitVacant = alloca i32, align 4
  ...
  %topBound = alloca i32, align 4
  %canary = alloca i32
  store i32 2134927964, i32* %canary
  %y = alloca i32, align 4
  %yDir = alloca i32, align 4
  %mapUnitsInSliceGroup0 = alloca i32, align 4
  %x = alloca i32, align 4
...
entry:
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %canary = alloca i32
  store i32 1539094202, i32* %canary
  %img.addr = alloca %struct.ImageParameters*, align 8
  %i = alloca i32, align 4
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
...
entry:
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 382050628, i32* %canary
  %SliceGroupID.addr = alloca i32, align 4
  %i = alloca i32, align 4
  store i32 %SliceGroupID, i32* %SliceGroupID.addr, align 4
  store i32 0, i32* %i, align 4
...
entry:
  %img.addr = alloca %struct.ImageParameters*, align 8
  %canary = alloca i32
  store i32 931800699, i32* %canary
  %iGroup = alloca i32, align 4
  %j = alloca i32, align 4
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType2MapUnitMap.32(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %yBottomRight = alloca i32, align 4
  %y = alloca i32, align 4
  %yTopLeft = alloca i32, align 4
  ...
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %canary = alloca i32
  store i32 1602907032, i32* %canary
  %i = alloca i32, align 4
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
  store i32 0, i32* %i, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @FmoInit.33(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps, %struct.seq_parameter_set_rbsp_t* %sps) #0 {
entry:
  %k = alloca i32, align 4
  %img.addr = alloca %struct.ImageParameters*, align 8
  %canary = alloca i32
  store i32 1766730982, i32* %canary
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %sps.addr = alloca %struct.seq_parameter_set_rbsp_t*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
...
entry:
  ...
  %img.addr = alloca %struct.ImageParameters*, align 8
  %canary = alloca i32
  store i32 819297817, i32* %canary
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
  store i32 0, i32* %i, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @FmoGetLastCodedMBOfSliceGroup.35(i32 %SliceGroupID) #0 {
entry:
  %canary = alloca i32
  store i32 233504184, i32* %canary
  %i = alloca i32, align 4
  %LastMB = alloca i32, align 4
  %SliceGroupID.addr = alloca i32, align 4
  store i32 %SliceGroupID, i32* %SliceGroupID.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @FmoGetPreviousMBNr.36(i32 %CurrentMbNr) #0 {
entry:
  %canary = alloca i32
  store i32 1392767122, i32* %canary
  %SliceGroupID = alloca i32, align 4
  %retval = alloca i32, align 4
  %CurrentMbNr.addr = alloca i32, align 4
  store i32 %CurrentMbNr, i32* %CurrentMbNr.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 1226107911, i32* %canary
  %img.addr = alloca %struct.ImageParameters*, align 8
  %iGroup = alloca i32, align 4
  %xTopLeft = alloca i32, align 4
  %yTopLeft = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @FmoGenerateMapUnitToSliceGroupMap.39(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %canary = alloca i32
  store i32 1020615352, i32* %canary
  %retval = alloca i32, align 4
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %img.addr = alloca %struct.ImageParameters*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
...
entry:
  %sps.addr = alloca %struct.seq_parameter_set_rbsp_t*, align 8
  %canary = alloca i32
  store i32 545253505, i32* %canary
  %i = alloca i32, align 4
  %img.addr = alloca %struct.ImageParameters*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.seq_parameter_set_rbsp_t* %sps, %struct.seq_parameter_set_rbsp_t** %sps.addr, align 8
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1003577367, i32* %canary
  %iGroup = alloca i32, align 4
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
  store i32 0, i32* %i, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @FmoInit.42(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps, %struct.seq_parameter_set_rbsp_t* %sps) #0 {
entry:
  %canary = alloca i32
  store i32 1841038273, i32* %canary
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %k = alloca i32, align 4
  %sps.addr = alloca %struct.seq_parameter_set_rbsp_t*, align 8
  %img.addr = alloca %struct.ImageParameters*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @FmoGenerateMBAmap.43(%struct.ImageParameters* %img, %struct.seq_parameter_set_rbsp_t* %sps) #0 {
entry:
  %img.addr = alloca %struct.ImageParameters*, align 8
  %canary = alloca i32
  store i32 948812763, i32* %canary
  %sps.addr = alloca %struct.seq_parameter_set_rbsp_t*, align 8
  %i = alloca i32, align 4
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.seq_parameter_set_rbsp_t* %sps, %struct.seq_parameter_set_rbsp_t** %sps.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FmoSetLastMacroblockInSlice.44(i32 %mb) #0 {
entry:
  %currSliceGroup = alloca i32, align 4
  %canary = alloca i32
  store i32 410108647, i32* %canary
  %mb.addr = alloca i32, align 4
  store i32 %mb, i32* %mb.addr, align 4
  %0 = load i32, i32* %mb.addr, align 4
  %call = call i32 @FmoMB2SliceGroup(i32 %0)
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @FmoGetLastCodedMBOfSliceGroup.45(i32 %SliceGroupID) #0 {
entry:
  %canary = alloca i32
  store i32 211118105, i32* %canary
  %SliceGroupID.addr = alloca i32, align 4
  %LastMB = alloca i32, align 4
  %i = alloca i32, align 4
  store i32 %SliceGroupID, i32* %SliceGroupID.addr, align 4
...
entry:
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %canary = alloca i32
  store i32 1916150350, i32* %canary
  %j = alloca i32, align 4
  %iGroup = alloca i32, align 4
  %i = alloca i32, align 4
  %img.addr = alloca %struct.ImageParameters*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @FmoGenerateMBAmap.47(%struct.ImageParameters* %img, %struct.seq_parameter_set_rbsp_t* %sps) #0 {
entry:
  %canary = alloca i32
  store i32 1420123291, i32* %canary
  %img.addr = alloca %struct.ImageParameters*, align 8
  %i = alloca i32, align 4
  %sps.addr = alloca %struct.seq_parameter_set_rbsp_t*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType3MapUnitMap.48(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %mapUnitVacant = alloca i32, align 4
  %i = alloca i32, align 4
  %leftBound = alloca i32, align 4
  %canary = alloca i32
  store i32 1170834277, i32* %canary
  %xDir = alloca i32, align 4
  %x = alloca i32, align 4
  %k = alloca i32, align 4
  %topBound = alloca i32, align 4
...
entry:
  ...
  %img.addr = alloca %struct.ImageParameters*, align 8
  %canary = alloca i32
  store i32 2062182293, i32* %canary
  %topBound = alloca i32, align 4
  %leftBound = alloca i32, align 4
  %rightBound = alloca i32, align 4
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType3MapUnitMap.50(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %topBound = alloca i32, align 4
  %k = alloca i32, align 4
  %canary = alloca i32
  store i32 1179391292, i32* %canary
  %mapUnitVacant = alloca i32, align 4
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %xDir = alloca i32, align 4
  %leftBound = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @FmoGenerateMapUnitToSliceGroupMap.52(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %img.addr = alloca %struct.ImageParameters*, align 8
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %canary = alloca i32
  store i32 679675614, i32* %canary
  %retval = alloca i32, align 4
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** %img.addr, align 8
...
entry:
  ...
  %sps.addr = alloca %struct.seq_parameter_set_rbsp_t*, align 8
  %canary = alloca i32
  store i32 1898187902, i32* %canary
  %k = alloca i32, align 4
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
  store %struct.seq_parameter_set_rbsp_t* %sps, %struct.seq_parameter_set_rbsp_t** %sps.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType5MapUnitMap.54(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %canary = alloca i32
  store i32 1083905110, i32* %canary
  %j = alloca i32, align 4
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %i = alloca i32, align 4
  %sizeOfUpperLeftGroup = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @FmoInit.55(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps, %struct.seq_parameter_set_rbsp_t* %sps) #0 {
entry:
  %canary = alloca i32
  store i32 1865976855, i32* %canary
  %img.addr = alloca %struct.ImageParameters*, align 8
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %k = alloca i32, align 4
  %sps.addr = alloca %struct.seq_parameter_set_rbsp_t*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType5MapUnitMap.56(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %mapUnitsInSliceGroup0 = alloca i32, align 4
  %img.addr = alloca %struct.ImageParameters*, align 8
  %j = alloca i32, align 4
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1597528868, i32* %canary
  %sizeOfUpperLeftGroup = alloca i32, align 4
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
...
entry:
  ...
  %x = alloca i32, align 4
  %canary = alloca i32
  store i32 901301503, i32* %canary
  %xTopLeft = alloca i32, align 4
  %iGroup = alloca i32, align 4
  %xBottomRight = alloca i32, align 4
  %yTopLeft = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType0MapUnitMap.58(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %img.addr = alloca %struct.ImageParameters*, align 8
  %canary = alloca i32
  store i32 1827516414, i32* %canary
  %i = alloca i32, align 4
  %iGroup = alloca i32, align 4
  %j = alloca i32, align 4
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @FmoSliceGroupCompletelyCoded.59(i32 %SliceGroupID) #0 {
entry:
  %canary = alloca i32
  store i32 1750069786, i32* %canary
  %SliceGroupID.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  store i32 %SliceGroupID, i32* %SliceGroupID.addr, align 4
...
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1397757226, i32* %canary
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %img.addr = alloca %struct.ImageParameters*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @FmoGenerateMBAmap.61(%struct.ImageParameters* %img, %struct.seq_parameter_set_rbsp_t* %sps) #0 {
entry:
  %canary = alloca i32
  store i32 633250964, i32* %canary
  %i = alloca i32, align 4
  %img.addr = alloca %struct.ImageParameters*, align 8
  %sps.addr = alloca %struct.seq_parameter_set_rbsp_t*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @FmoGetFirstMBOfSliceGroup.62(i32 %SliceGroupID) #0 {
entry:
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 264839592, i32* %canary
  %i = alloca i32, align 4
  %SliceGroupID.addr = alloca i32, align 4
  store i32 %SliceGroupID, i32* %SliceGroupID.addr, align 4
  store i32 0, i32* %i, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType6MapUnitMap.63(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %canary = alloca i32
  store i32 1536790474, i32* %canary
  %img.addr = alloca %struct.ImageParameters*, align 8
  %i = alloca i32, align 4
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
...
entry:
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %canary = alloca i32
  store i32 1301680993, i32* %canary
  %i = alloca i32, align 4
  %img.addr = alloca %struct.ImageParameters*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @FmoGetNextMBNr.65(i32 %CurrentMbNr) #0 {
entry:
  %SliceGroupID = alloca i32, align 4
  %canary = alloca i32
  store i32 1099803562, i32* %canary
  %retval = alloca i32, align 4
  %CurrentMbNr.addr = alloca i32, align 4
  store i32 %CurrentMbNr, i32* %CurrentMbNr.addr, align 4
  %0 = load i32, i32* %CurrentMbNr.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 942727325, i32* %canary
  %img.addr = alloca %struct.ImageParameters*, align 8
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %i = alloca i32, align 4
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @FmoGetPreviousMBNr.67(i32 %CurrentMbNr) #0 {
entry:
  %retval = alloca i32, align 4
  %SliceGroupID = alloca i32, align 4
  %canary = alloca i32
  store i32 406011841, i32* %canary
  %CurrentMbNr.addr = alloca i32, align 4
  store i32 %CurrentMbNr, i32* %CurrentMbNr.addr, align 4
  %0 = load i32, i32* %CurrentMbNr.addr, align 4
  %call = call i32 @FmoMB2SliceGroup(i32 %0)
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType0MapUnitMap.68(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %canary = alloca i32
  store i32 397656412, i32* %canary
  %i = alloca i32, align 4
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %iGroup = alloca i32, align 4
  %img.addr = alloca %struct.ImageParameters*, align 8
...
entry:
  %canary = alloca i32
  store i32 526202030, i32* %canary
  %retval = alloca i32, align 4
  %SliceGroupID.addr = alloca i32, align 4
  store i32 %SliceGroupID, i32* %SliceGroupID.addr, align 4
  %0 = load i32, i32* %SliceGroupID.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType2MapUnitMap.70(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %xBottomRight = alloca i32, align 4
  %canary = alloca i32
  store i32 1076070256, i32* %canary
  %i = alloca i32, align 4
  %yBottomRight = alloca i32, align 4
  %y = alloca i32, align 4
  %img.addr = alloca %struct.ImageParameters*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @FmoGenerateMapUnitToSliceGroupMap.71(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %retval = alloca i32, align 4
  %img.addr = alloca %struct.ImageParameters*, align 8
  %canary = alloca i32
  store i32 1555248736, i32* %canary
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** %img.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 326759094, i32* %canary
  %img.addr = alloca %struct.ImageParameters*, align 8
  %retval = alloca i32, align 4
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
...
entry:
  ...
  %img.addr = alloca %struct.ImageParameters*, align 8
  %canary = alloca i32
  store i32 1821886231, i32* %canary
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %mapUnitsInSliceGroup0 = alloca i32, align 4
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
...
entry:
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1136742327, i32* %canary
  %CurrentMbNr.addr = alloca i32, align 4
  %SliceGroupID = alloca i32, align 4
  store i32 %CurrentMbNr, i32* %CurrentMbNr.addr, align 4
  %0 = load i32, i32* %CurrentMbNr.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @FmoGenerateMBAmap.75(%struct.ImageParameters* %img, %struct.seq_parameter_set_rbsp_t* %sps) #0 {
entry:
  %sps.addr = alloca %struct.seq_parameter_set_rbsp_t*, align 8
  %img.addr = alloca %struct.ImageParameters*, align 8
  %canary = alloca i32
  store i32 506797543, i32* %canary
  %i = alloca i32, align 4
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.seq_parameter_set_rbsp_t* %sps, %struct.seq_parameter_set_rbsp_t** %sps.addr, align 8
  %0 = load i8*, i8** @MBAmap, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType4MapUnitMap.76(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %mapUnitsInSliceGroup0 = alloca i32, align 4
  %sizeOfUpperLeftGroup = alloca i32, align 4
  %canary = alloca i32
  store i32 893796045, i32* %canary
  %i = alloca i32, align 4
  %img.addr = alloca %struct.ImageParameters*, align 8
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType1MapUnitMap.77(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %img.addr = alloca %struct.ImageParameters*, align 8
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 90743710, i32* %canary
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
  store i32 0, i32* %i, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @FmoInit.78(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps, %struct.seq_parameter_set_rbsp_t* %sps) #0 {
entry:
  %sps.addr = alloca %struct.seq_parameter_set_rbsp_t*, align 8
  %canary = alloca i32
  store i32 1161658703, i32* %canary
  %img.addr = alloca %struct.ImageParameters*, align 8
  %k = alloca i32, align 4
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
...
entry:
  ...
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %canary = alloca i32
  store i32 1018354618, i32* %canary
  %mapUnitsInSliceGroup0 = alloca i32, align 4
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
  %0 = load %struct.pic_parameter_set_rbsp_t*, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @FmoGetFirstMBOfSliceGroup.80(i32 %SliceGroupID) #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 444706363, i32* %canary
  %SliceGroupID.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  store i32 %SliceGroupID, i32* %SliceGroupID.addr, align 4
  store i32 0, i32* %i, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType2MapUnitMap.81(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %xTopLeft = alloca i32, align 4
  %yBottomRight = alloca i32, align 4
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  ...
  %x = alloca i32, align 4
  %canary = alloca i32
  store i32 148186433, i32* %canary
  %img.addr = alloca %struct.ImageParameters*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
  store i32 0, i32* %i, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @FmoGetLastCodedMBOfSliceGroup.82(i32 %SliceGroupID) #0 {
entry:
  %SliceGroupID.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 375879775, i32* %canary
  %LastMB = alloca i32, align 4
  store i32 %SliceGroupID, i32* %SliceGroupID.addr, align 4
  store i32 -1, i32* %LastMB, align 4
  store i32 0, i32* %i, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType0MapUnitMap.83(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %iGroup = alloca i32, align 4
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 2032787070, i32* %canary
  %img.addr = alloca %struct.ImageParameters*, align 8
  %j = alloca i32, align 4
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @FmoGetNextMBNr.84(i32 %CurrentMbNr) #0 {
entry:
  %retval = alloca i32, align 4
  %SliceGroupID = alloca i32, align 4
  %canary = alloca i32
  store i32 1745710772, i32* %canary
  %CurrentMbNr.addr = alloca i32, align 4
  store i32 %CurrentMbNr, i32* %CurrentMbNr.addr, align 4
  %0 = load i32, i32* %CurrentMbNr.addr, align 4
  %call = call i32 @FmoMB2SliceGroup(i32 %0)
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType4MapUnitMap.85(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %mapUnitsInSliceGroup0 = alloca i32, align 4
  %i = alloca i32, align 4
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %canary = alloca i32
  store i32 1717222017, i32* %canary
  %img.addr = alloca %struct.ImageParameters*, align 8
  %sizeOfUpperLeftGroup = alloca i32, align 4
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType0MapUnitMap.86(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 2060808919, i32* %canary
  %iGroup = alloca i32, align 4
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %j = alloca i32, align 4
  %img.addr = alloca %struct.ImageParameters*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType5MapUnitMap.87(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %canary = alloca i32
  store i32 1030066346, i32* %canary
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %mapUnitsInSliceGroup0 = alloca i32, align 4
  %i = alloca i32, align 4
  %img.addr = alloca %struct.ImageParameters*, align 8
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1460337788, i32* %canary
  %retval = alloca i32, align 4
  store i32 %SliceGroupID, i32* %SliceGroupID.addr, align 4
  store i32 0, i32* %i, align 4
  br label %while.cond
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType5MapUnitMap.89(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %mapUnitsInSliceGroup0 = alloca i32, align 4
  %j = alloca i32, align 4
  %k = alloca i32, align 4
  ...
  %img.addr = alloca %struct.ImageParameters*, align 8
  %canary = alloca i32
  store i32 517300763, i32* %canary
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
  %0 = load %struct.pic_parameter_set_rbsp_t*, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @FmoGetNextMBNr.90(i32 %CurrentMbNr) #0 {
entry:
  %canary = alloca i32
  store i32 131421515, i32* %canary
  %CurrentMbNr.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  %SliceGroupID = alloca i32, align 4
  store i32 %CurrentMbNr, i32* %CurrentMbNr.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType2MapUnitMap.91(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %canary = alloca i32
  store i32 1953791894, i32* %canary
  %yTopLeft = alloca i32, align 4
  %iGroup = alloca i32, align 4
  %xBottomRight = alloca i32, align 4
  %x = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @FmoGetLastCodedMBOfSliceGroup.92(i32 %SliceGroupID) #0 {
entry:
  %canary = alloca i32
  store i32 1110447430, i32* %canary
  %LastMB = alloca i32, align 4
  %i = alloca i32, align 4
  %SliceGroupID.addr = alloca i32, align 4
  store i32 %SliceGroupID, i32* %SliceGroupID.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType0MapUnitMap.93(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %canary = alloca i32
  store i32 996864323, i32* %canary
  %iGroup = alloca i32, align 4
  %j = alloca i32, align 4
  %img.addr = alloca %struct.ImageParameters*, align 8
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @FmoGetFirstMBOfSliceGroup.94(i32 %SliceGroupID) #0 {
entry:
  %SliceGroupID.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 421367410, i32* %canary
  %i = alloca i32, align 4
  store i32 %SliceGroupID, i32* %SliceGroupID.addr, align 4
  store i32 0, i32* %i, align 4
  br label %while.cond
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType5MapUnitMap.95(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %canary = alloca i32
  store i32 361620993, i32* %canary
  %sizeOfUpperLeftGroup = alloca i32, align 4
  %j = alloca i32, align 4
  %k = alloca i32, align 4
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType5MapUnitMap.96(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %sizeOfUpperLeftGroup = alloca i32, align 4
  %k = alloca i32, align 4
  %img.addr = alloca %struct.ImageParameters*, align 8
  ...
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %canary = alloca i32
  store i32 1622125155, i32* %canary
  %mapUnitsInSliceGroup0 = alloca i32, align 4
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
  %0 = load %struct.pic_parameter_set_rbsp_t*, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType4MapUnitMap.97(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %mapUnitsInSliceGroup0 = alloca i32, align 4
  %img.addr = alloca %struct.ImageParameters*, align 8
  %canary = alloca i32
  store i32 1477826229, i32* %canary
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %sizeOfUpperLeftGroup = alloca i32, align 4
  %i = alloca i32, align 4
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType4MapUnitMap.98(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %img.addr = alloca %struct.ImageParameters*, align 8
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %mapUnitsInSliceGroup0 = alloca i32, align 4
  %canary = alloca i32
  store i32 2090322138, i32* %canary
  %i = alloca i32, align 4
  %sizeOfUpperLeftGroup = alloca i32, align 4
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
...
entry:
  ...
  %sizeOfUpperLeftGroup = alloca i32, align 4
  %canary = alloca i32
  store i32 1958152010, i32* %canary
  %img.addr = alloca %struct.ImageParameters*, align 8
  %i = alloca i32, align 4
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType4MapUnitMap.100(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %img.addr = alloca %struct.ImageParameters*, align 8
  %mapUnitsInSliceGroup0 = alloca i32, align 4
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1774357791, i32* %canary
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %sizeOfUpperLeftGroup = alloca i32, align 4
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
