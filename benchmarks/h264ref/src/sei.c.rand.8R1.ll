...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_write_sei_message.34, label %ctrl0

func_write_sei_message.34:                        ; preds = %rand_bb
  call void @write_sei_message.34(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type)
  ret void

func_write_sei_message.44:                        ; preds = %ctrl0
  call void @write_sei_message.44(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type)
  ret void

func_write_sei_message.57:                        ; preds = %ctrl1
  call void @write_sei_message.57(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type)
  ret void

func_write_sei_message.73:                        ; preds = %ctrl2
  call void @write_sei_message.73(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type)
  ret void

func_write_sei_message.79:                        ; preds = %ctrl3
  call void @write_sei_message.79(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type)
  ret void

func_write_sei_message.85:                        ; preds = %ctrl4
  call void @write_sei_message.85(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type)
  ret void

func_write_sei_message.90:                        ; preds = %ctrl5
  call void @write_sei_message.90(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type)
  ret void

func_write_sei_message.91:                        ; preds = %ctrl5
  call void @write_sei_message.91(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_write_sei_message.44, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_write_sei_message.57, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_write_sei_message.73, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_write_sei_message.79, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_write_sei_message.85, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_write_sei_message.90, label %func_write_sei_message.91
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_finalize_sei_message.13, label %func_finalize_sei_message.22

func_finalize_sei_message.13:                     ; preds = %rand_bb
  call void @finalize_sei_message.13(i32 %id)
  ret void

func_finalize_sei_message.22:                     ; preds = %rand_bb
  call void @finalize_sei_message.22(i32 %id)
  ret void
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_AppendTmpbits2Buf.2, label %ctrl0

func_AppendTmpbits2Buf.2:                         ; preds = %rand_bb
  call void @AppendTmpbits2Buf.2(%struct.Bitstream* %dest, %struct.Bitstream* %source)
  ret void

func_AppendTmpbits2Buf.19:                        ; preds = %ctrl0
  call void @AppendTmpbits2Buf.19(%struct.Bitstream* %dest, %struct.Bitstream* %source)
  ret void

func_AppendTmpbits2Buf.61:                        ; preds = %ctrl1
  call void @AppendTmpbits2Buf.61(%struct.Bitstream* %dest, %struct.Bitstream* %source)
  ret void

func_AppendTmpbits2Buf.64:                        ; preds = %ctrl2
  call void @AppendTmpbits2Buf.64(%struct.Bitstream* %dest, %struct.Bitstream* %source)
  ret void

func_AppendTmpbits2Buf.80:                        ; preds = %ctrl3
  call void @AppendTmpbits2Buf.80(%struct.Bitstream* %dest, %struct.Bitstream* %source)
  ret void

func_AppendTmpbits2Buf.86:                        ; preds = %ctrl4
  call void @AppendTmpbits2Buf.86(%struct.Bitstream* %dest, %struct.Bitstream* %source)
  ret void
...
func_AppendTmpbits2Buf.96:                        ; preds = %ctrl5
  call void @AppendTmpbits2Buf.96(%struct.Bitstream* %dest, %struct.Bitstream* %source)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_AppendTmpbits2Buf.19, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_AppendTmpbits2Buf.61, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_AppendTmpbits2Buf.64, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_AppendTmpbits2Buf.80, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_AppendTmpbits2Buf.86, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_AppendTmpbits2Buf.94, label %func_AppendTmpbits2Buf.96
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_ComposeSparePictureMessage.12, label %ctrl0

func_ComposeSparePictureMessage.12:               ; preds = %rand_bb
  call void @ComposeSparePictureMessage.12(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream)
  ret void

func_ComposeSparePictureMessage.21:               ; preds = %ctrl0
  call void @ComposeSparePictureMessage.21(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream)
  ret void

func_ComposeSparePictureMessage.30:               ; preds = %ctrl1
  call void @ComposeSparePictureMessage.30(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream)
  ret void

func_ComposeSparePictureMessage.52:               ; preds = %ctrl2
  call void @ComposeSparePictureMessage.52(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream)
  ret void

func_ComposeSparePictureMessage.60:               ; preds = %ctrl3
  call void @ComposeSparePictureMessage.60(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream)
  ret void

func_ComposeSparePictureMessage.70:               ; preds = %ctrl4
  call void @ComposeSparePictureMessage.70(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream)
  ret void

func_ComposeSparePictureMessage.72:               ; preds = %ctrl5
  call void @ComposeSparePictureMessage.72(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream)
  ret void

func_ComposeSparePictureMessage.81:               ; preds = %ctrl5
  call void @ComposeSparePictureMessage.81(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_ComposeSparePictureMessage.21, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_ComposeSparePictureMessage.30, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_ComposeSparePictureMessage.52, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_ComposeSparePictureMessage.60, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_ComposeSparePictureMessage.70, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_ComposeSparePictureMessage.72, label %func_ComposeSparePictureMessage.81
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_CompressSpareMBMap.6, label %ctrl0

func_CompressSpareMBMap.6:                        ; preds = %rand_bb
  %2 = call i32 @CompressSpareMBMap.6(i8** %map_sp, %struct.Bitstream* %bitstream)
  ret i32 %2

func_CompressSpareMBMap.25:                       ; preds = %ctrl0
  %3 = call i32 @CompressSpareMBMap.25(i8** %map_sp, %struct.Bitstream* %bitstream)
  ret i32 %3

func_CompressSpareMBMap.48:                       ; preds = %ctrl1
  %4 = call i32 @CompressSpareMBMap.48(i8** %map_sp, %struct.Bitstream* %bitstream)
  ret i32 %4

func_CompressSpareMBMap.50:                       ; preds = %ctrl2
  %5 = call i32 @CompressSpareMBMap.50(i8** %map_sp, %struct.Bitstream* %bitstream)
  ret i32 %5

func_CompressSpareMBMap.63:                       ; preds = %ctrl3
  %6 = call i32 @CompressSpareMBMap.63(i8** %map_sp, %struct.Bitstream* %bitstream)
  ret i32 %6

func_CompressSpareMBMap.66:                       ; preds = %ctrl4
  %7 = call i32 @CompressSpareMBMap.66(i8** %map_sp, %struct.Bitstream* %bitstream)
  ret i32 %7

func_CompressSpareMBMap.68:                       ; preds = %ctrl5
  %8 = call i32 @CompressSpareMBMap.68(i8** %map_sp, %struct.Bitstream* %bitstream)
  ret i32 %8

func_CompressSpareMBMap.69:                       ; preds = %ctrl5
  %9 = call i32 @CompressSpareMBMap.69(i8** %map_sp, %struct.Bitstream* %bitstream)
  ret i32 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_CompressSpareMBMap.25, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_CompressSpareMBMap.48, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_CompressSpareMBMap.50, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_CompressSpareMBMap.63, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_CompressSpareMBMap.66, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_CompressSpareMBMap.68, label %func_CompressSpareMBMap.69
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FinalizeSpareMBMap.1, label %ctrl0

func_FinalizeSpareMBMap.1:                        ; preds = %rand_bb
  call void @FinalizeSpareMBMap.1()
  ret void

func_FinalizeSpareMBMap.7:                        ; preds = %ctrl0
  call void @FinalizeSpareMBMap.7()
  ret void

func_FinalizeSpareMBMap.16:                       ; preds = %ctrl1
  call void @FinalizeSpareMBMap.16()
  ret void

func_FinalizeSpareMBMap.20:                       ; preds = %ctrl2
  call void @FinalizeSpareMBMap.20()
  ret void

func_FinalizeSpareMBMap.35:                       ; preds = %ctrl3
  call void @FinalizeSpareMBMap.35()
  ret void

func_FinalizeSpareMBMap.41:                       ; preds = %ctrl4
  call void @FinalizeSpareMBMap.41()
  ret void

func_FinalizeSpareMBMap.42:                       ; preds = %ctrl5
  call void @FinalizeSpareMBMap.42()
  ret void

func_FinalizeSpareMBMap.56:                       ; preds = %ctrl5
  call void @FinalizeSpareMBMap.56()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_FinalizeSpareMBMap.7, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_FinalizeSpareMBMap.16, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_FinalizeSpareMBMap.20, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_FinalizeSpareMBMap.35, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_FinalizeSpareMBMap.41, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_FinalizeSpareMBMap.42, label %func_FinalizeSpareMBMap.56
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FinalizeSubseqInfo.14, label %ctrl0

func_FinalizeSubseqInfo.14:                       ; preds = %rand_bb
  call void @FinalizeSubseqInfo.14(i32 %currLayer)
  ret void

func_FinalizeSubseqInfo.17:                       ; preds = %ctrl0
  call void @FinalizeSubseqInfo.17(i32 %currLayer)
  ret void

func_FinalizeSubseqInfo.76:                       ; preds = %ctrl1
  call void @FinalizeSubseqInfo.76(i32 %currLayer)
  ret void

func_FinalizeSubseqInfo.84:                       ; preds = %ctrl2
  call void @FinalizeSubseqInfo.84(i32 %currLayer)
  ret void

func_FinalizeSubseqInfo.87:                       ; preds = %ctrl3
  call void @FinalizeSubseqInfo.87(i32 %currLayer)
  ret void

func_FinalizeSubseqInfo.88:                       ; preds = %ctrl3
  call void @FinalizeSubseqInfo.88(i32 %currLayer)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_FinalizeSubseqInfo.17, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_FinalizeSubseqInfo.76, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_FinalizeSubseqInfo.84, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_FinalizeSubseqInfo.87, label %func_FinalizeSubseqInfo.88
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FinalizeSubseqLayerInfo.43, label %func_FinalizeSubseqLayerInfo.74

func_FinalizeSubseqLayerInfo.43:                  ; preds = %rand_bb
  call void @FinalizeSubseqLayerInfo.43()
  ret void

func_FinalizeSubseqLayerInfo.74:                  ; preds = %rand_bb
  call void @FinalizeSubseqLayerInfo.74()
  ret void
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FinalizeSubseqChar.11, label %ctrl0

func_FinalizeSubseqChar.11:                       ; preds = %rand_bb
  call void @FinalizeSubseqChar.11()
  ret void
...
func_FinalizeSubseqChar.29:                       ; preds = %ctrl1
  call void @FinalizeSubseqChar.29()
  ret void
...
func_FinalizeSubseqChar.58:                       ; preds = %ctrl3
  call void @FinalizeSubseqChar.58()
  ret void

func_FinalizeSubseqChar.65:                       ; preds = %ctrl3
  call void @FinalizeSubseqChar.65()
  ret void
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_FinalizeSubseqChar.29, label %ctrl2
...
ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_FinalizeSubseqChar.58, label %func_FinalizeSubseqChar.65
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FinalizeSceneInformation.3, label %func_FinalizeSceneInformation.5

func_FinalizeSceneInformation.3:                  ; preds = %rand_bb
  call void @FinalizeSceneInformation.3()
  ret void
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_UpdateSceneInformation.38, label %ctrl0

func_UpdateSceneInformation.38:                   ; preds = %rand_bb
  call void @UpdateSceneInformation.38(i32 %HasSceneInformation, i32 %sceneID, i32 %sceneTransType, i32 %secondSceneID)
  ret void

func_UpdateSceneInformation.47:                   ; preds = %ctrl0
  call void @UpdateSceneInformation.47(i32 %HasSceneInformation, i32 %sceneID, i32 %sceneTransType, i32 %secondSceneID)
  ret void

func_UpdateSceneInformation.49:                   ; preds = %ctrl1
  call void @UpdateSceneInformation.49(i32 %HasSceneInformation, i32 %sceneID, i32 %sceneTransType, i32 %secondSceneID)
  ret void

func_UpdateSceneInformation.59:                   ; preds = %ctrl2
  call void @UpdateSceneInformation.59(i32 %HasSceneInformation, i32 %sceneID, i32 %sceneTransType, i32 %secondSceneID)
  ret void

func_UpdateSceneInformation.82:                   ; preds = %ctrl3
  call void @UpdateSceneInformation.82(i32 %HasSceneInformation, i32 %sceneID, i32 %sceneTransType, i32 %secondSceneID)
  ret void

func_UpdateSceneInformation.92:                   ; preds = %ctrl4
  call void @UpdateSceneInformation.92(i32 %HasSceneInformation, i32 %sceneID, i32 %sceneTransType, i32 %secondSceneID)
  ret void

func_UpdateSceneInformation.93:                   ; preds = %ctrl5
  call void @UpdateSceneInformation.93(i32 %HasSceneInformation, i32 %sceneID, i32 %sceneTransType, i32 %secondSceneID)
  ret void

func_UpdateSceneInformation.95:                   ; preds = %ctrl5
  call void @UpdateSceneInformation.95(i32 %HasSceneInformation, i32 %sceneID, i32 %sceneTransType, i32 %secondSceneID)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_UpdateSceneInformation.47, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_UpdateSceneInformation.49, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_UpdateSceneInformation.59, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_UpdateSceneInformation.82, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_UpdateSceneInformation.92, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_UpdateSceneInformation.93, label %func_UpdateSceneInformation.95
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FinalizePanScanRectInfo.4, label %func_FinalizePanScanRectInfo.8

func_FinalizePanScanRectInfo.4:                   ; preds = %rand_bb
  call void @FinalizePanScanRectInfo.4()
  ret void

func_FinalizePanScanRectInfo.8:                   ; preds = %rand_bb
  call void @FinalizePanScanRectInfo.8()
  ret void
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_UpdateUser_data_unregistered.9, label %ctrl0

func_UpdateUser_data_unregistered.9:              ; preds = %rand_bb
  call void @UpdateUser_data_unregistered.9()
  ret void

func_UpdateUser_data_unregistered.18:             ; preds = %ctrl0
  call void @UpdateUser_data_unregistered.18()
  ret void

func_UpdateUser_data_unregistered.27:             ; preds = %ctrl1
  call void @UpdateUser_data_unregistered.27()
  ret void

func_UpdateUser_data_unregistered.33:             ; preds = %ctrl2
  call void @UpdateUser_data_unregistered.33()
  ret void

func_UpdateUser_data_unregistered.36:             ; preds = %ctrl3
  call void @UpdateUser_data_unregistered.36()
  ret void

func_UpdateUser_data_unregistered.39:             ; preds = %ctrl3
  call void @UpdateUser_data_unregistered.39()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_UpdateUser_data_unregistered.18, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_UpdateUser_data_unregistered.27, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_UpdateUser_data_unregistered.33, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_UpdateUser_data_unregistered.36, label %func_UpdateUser_data_unregistered.39
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FinalizeUser_data_unregistered.26, label %ctrl0

func_FinalizeUser_data_unregistered.26:           ; preds = %rand_bb
  call void @FinalizeUser_data_unregistered.26()
  ret void

func_FinalizeUser_data_unregistered.46:           ; preds = %ctrl0
  call void @FinalizeUser_data_unregistered.46()
  ret void

func_FinalizeUser_data_unregistered.51:           ; preds = %ctrl1
  call void @FinalizeUser_data_unregistered.51()
  ret void

func_FinalizeUser_data_unregistered.67:           ; preds = %ctrl2
  call void @FinalizeUser_data_unregistered.67()
  ret void

func_FinalizeUser_data_unregistered.71:           ; preds = %ctrl3
  call void @FinalizeUser_data_unregistered.71()
  ret void

func_FinalizeUser_data_unregistered.77:           ; preds = %ctrl3
  call void @FinalizeUser_data_unregistered.77()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_FinalizeUser_data_unregistered.46, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_FinalizeUser_data_unregistered.51, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_FinalizeUser_data_unregistered.67, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_FinalizeUser_data_unregistered.71, label %func_FinalizeUser_data_unregistered.77
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_UpdateUser_data_registered_itu_t_t35.23, label %ctrl0

func_UpdateUser_data_registered_itu_t_t35.23:     ; preds = %rand_bb
  call void @UpdateUser_data_registered_itu_t_t35.23()
  ret void

func_UpdateUser_data_registered_itu_t_t35.31:     ; preds = %ctrl0
  call void @UpdateUser_data_registered_itu_t_t35.31()
  ret void

func_UpdateUser_data_registered_itu_t_t35.37:     ; preds = %ctrl1
  call void @UpdateUser_data_registered_itu_t_t35.37()
  ret void

func_UpdateUser_data_registered_itu_t_t35.45:     ; preds = %ctrl2
  call void @UpdateUser_data_registered_itu_t_t35.45()
  ret void
...
func_UpdateUser_data_registered_itu_t_t35.78:     ; preds = %ctrl4
  call void @UpdateUser_data_registered_itu_t_t35.78()
  ret void

func_UpdateUser_data_registered_itu_t_t35.83:     ; preds = %ctrl5
  call void @UpdateUser_data_registered_itu_t_t35.83()
  ret void

func_UpdateUser_data_registered_itu_t_t35.89:     ; preds = %ctrl5
  call void @UpdateUser_data_registered_itu_t_t35.89()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_UpdateUser_data_registered_itu_t_t35.31, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_UpdateUser_data_registered_itu_t_t35.37, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_UpdateUser_data_registered_itu_t_t35.45, label %ctrl3
...
ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_UpdateUser_data_registered_itu_t_t35.78, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_UpdateUser_data_registered_itu_t_t35.83, label %func_UpdateUser_data_registered_itu_t_t35.89
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FinalizeUser_data_registered_itu_t_t35.10, label %ctrl0

func_FinalizeUser_data_registered_itu_t_t35.10:   ; preds = %rand_bb
  call void @FinalizeUser_data_registered_itu_t_t35.10()
  ret void

func_FinalizeUser_data_registered_itu_t_t35.15:   ; preds = %ctrl0
  call void @FinalizeUser_data_registered_itu_t_t35.15()
  ret void

func_FinalizeUser_data_registered_itu_t_t35.24:   ; preds = %ctrl1
  call void @FinalizeUser_data_registered_itu_t_t35.24()
  ret void

func_FinalizeUser_data_registered_itu_t_t35.53:   ; preds = %ctrl2
...
func_FinalizeUser_data_registered_itu_t_t35.75:   ; preds = %ctrl3
  call void @FinalizeUser_data_registered_itu_t_t35.75()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_FinalizeUser_data_registered_itu_t_t35.15, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_FinalizeUser_data_registered_itu_t_t35.24, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_FinalizeUser_data_registered_itu_t_t35.53, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_FinalizeUser_data_registered_itu_t_t35.62, label %func_FinalizeUser_data_registered_itu_t_t35.75
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FinalizeRandomAccess.32, label %func_FinalizeRandomAccess.40

func_FinalizeRandomAccess.32:                     ; preds = %rand_bb
  call void @FinalizeRandomAccess.32()
  ret void

func_FinalizeRandomAccess.40:                     ; preds = %rand_bb
  call void @FinalizeRandomAccess.40()
  ret void
}
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSpareMBMap.1() #0 {
entry:
  ...
  %canary = alloca i32
  store i32 2039312390, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @AppendTmpbits2Buf.2(%struct.Bitstream* %dest, %struct.Bitstream* %source) #0 {
entry:
  %i = alloca i32, align 4
  %source.addr = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 1045902984, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSceneInformation.3() #0 {
entry:
  %dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 62747059, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.scene_information_struct, %struct.scene_information_struct* @seiSceneInformation, i32 0, i32 3), align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizePanScanRectInfo.4() #0 {
entry:
  %sym = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 1177714305, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.panscanrect_information_struct, %struct.panscanrect_information_struct* @seiPanScanRectInfo, i32 0, i32 5), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
  %type = getelementptr inbounds %struct.syntaxelement, %struct.syntaxelement* %sym, i32 0, i32 0
...
entry:
  %sym = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 1796676712, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.scene_information_struct, %struct.scene_information_struct* @seiSceneInformation, i32 0, i32 3), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
  %type = getelementptr inbounds %struct.syntaxelement, %struct.syntaxelement* %sym, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @CompressSpareMBMap.6(i8** %map_sp, %struct.Bitstream* %bitstream) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 1252600005, i32* %canary
...
if.end190:                                        ; preds = %for.end189, %if.end141
  ...
  %123 = icmp eq i32 %122, 1252600005
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSpareMBMap.7() #0 {
entry:
  %canary = alloca i32
  store i32 500675611, i32* %canary
  %delta_frame_num = alloca i32, align 4
  %source = alloca %struct.Bitstream*, align 8
  %CurrFrameNum = alloca i32, align 4
  %sym = alloca %struct.syntaxelement, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizePanScanRectInfo.8() #0 {
entry:
  %dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 1972250701, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.panscanrect_information_struct, %struct.panscanrect_information_struct* @seiPanScanRectInfo, i32 0, i32 5), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
  %type = getelementptr inbounds %struct.syntaxelement, %struct.syntaxelement* %sym, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateUser_data_unregistered.9() #0 {
entry:
  %temp_data = alloca i32, align 4
  %canary = alloca i32
  store i32 1840955637, i32* %canary
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeUser_data_registered_itu_t_t35.10() #0 {
entry:
  %dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 1015053213, i32* %canary
  %i = alloca i32, align 4
  %sym = alloca %struct.syntaxelement, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_registered_itu_t_t35_information_struct, %struct.user_data_registered_itu_t_t35_information_struct* @seiUser_data_registered_itu_t_t35, i32 0, i32 4), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSubseqChar.11() #0 {
entry:
  %canary = alloca i32
  store i32 515489112, i32* %canary
  %i = alloca i32, align 4
  %dest = alloca %struct.Bitstream*, align 8
  %sym = alloca %struct.syntaxelement, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.subseq_char_information_struct, %struct.subseq_char_information_struct* @seiSubseqChar, i32 0, i32 10), align 8
...
entry:
  %sym = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 136949828, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @finalize_sei_message.13(i32 %id) #0 {
entry:
  %id.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 504632095, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSubseqInfo.14(i32 %currLayer) #0 {
entry:
  %canary = alloca i32
  store i32 1837002437, i32* %canary
  %currLayer.addr = alloca i32, align 4
  %sym = alloca %struct.syntaxelement, align 8
  %dest = alloca %struct.Bitstream*, align 8
  store i32 %currLayer, i32* %currLayer.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeUser_data_registered_itu_t_t35.15() #0 {
entry:
  %canary = alloca i32
  store i32 101855248, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  %sym = alloca %struct.syntaxelement, align 8
  %i = alloca i32, align 4
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_registered_itu_t_t35_information_struct, %struct.user_data_registered_itu_t_t35_information_struct* @seiUser_data_registered_itu_t_t35, i32 0, i32 4), align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSpareMBMap.16() #0 {
entry:
  %CurrFrameNum = alloca i32, align 4
  %dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 1418741245, i32* %canary
  %source = alloca %struct.Bitstream*, align 8
  %delta_frame_num = alloca i32, align 4
  %sym = alloca %struct.syntaxelement, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSubseqInfo.17(i32 %currLayer) #0 {
entry:
  %sym = alloca %struct.syntaxelement, align 8
  %currLayer.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1074280845, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  store i32 %currLayer, i32* %currLayer.addr, align 4
  %0 = load i32, i32* %currLayer.addr, align 4
  %idxprom = sext i32 %0 to i64
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateUser_data_unregistered.18() #0 {
entry:
  %total_byte = alloca i32, align 4
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 690597871, i32* %canary
  %temp_data = alloca i32, align 4
  store i32 7, i32* %total_byte, align 4
  store i32 0, i32* %i, align 4
  br label %for.cond
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @AppendTmpbits2Buf.19(%struct.Bitstream* %dest, %struct.Bitstream* %source) #0 {
entry:
  %i = alloca i32, align 4
  %source.addr = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 732231841, i32* %canary
  %mask = alloca i8, align 1
  %bits_in_last_byte = alloca i32, align 4
  %dest.addr = alloca %struct.Bitstream*, align 8
  %j = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSpareMBMap.20() #0 {
entry:
  %source = alloca %struct.Bitstream*, align 8
  %CurrFrameNum = alloca i32, align 4
  %dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 1843320191, i32* %canary
  %delta_frame_num = alloca i32, align 4
  %sym = alloca %struct.syntaxelement, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %number = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @ComposeSparePictureMessage.21(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream) #0 {
entry:
  %delta_spare_frame_num.addr = alloca i32, align 4
  %bitstream = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 561193375, i32* %canary
  %ref_area_indicator.addr = alloca i32, align 4
  %tmpBitstream.addr = alloca %struct.Bitstream*, align 8
  %sym = alloca %struct.syntaxelement, align 8
  store i32 %delta_spare_frame_num, i32* %delta_spare_frame_num.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @finalize_sei_message.22(i32 %id) #0 {
entry:
  %canary = alloca i32
  store i32 1317321028, i32* %canary
  %offset = alloca i32, align 4
  %id.addr = alloca i32, align 4
  store i32 %id, i32* %id.addr, align 4
  %0 = load i32, i32* %id.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateUser_data_registered_itu_t_t35.23() #0 {
entry:
  %temp_data = alloca i32, align 4
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 46771305, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeUser_data_registered_itu_t_t35.24() #0 {
entry:
  %i = alloca i32, align 4
  %dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 28196992, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_registered_itu_t_t35_information_struct, %struct.user_data_registered_itu_t_t35_information_struct* @seiUser_data_registered_itu_t_t35, i32 0, i32 4), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
  %type = getelementptr inbounds %struct.syntaxelement, %struct.syntaxelement* %sym, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @CompressSpareMBMap.25(i8** %map_sp, %struct.Bitstream* %bitstream) #0 {
entry:
  %left = alloca i32, align 4
  %noc = alloca i32, align 4
  %bit1 = alloca i32, align 4
  ...
  %size_uncompressed = alloca i32, align 4
  %canary = alloca i32
  store i32 793518270, i32* %canary
  %size_compressed = alloca i32, align 4
  store i8** %map_sp, i8*** %map_sp.addr, align 8
  store %struct.Bitstream* %bitstream, %struct.Bitstream** %bitstream.addr, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
entry:
  ...
  %sym = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 291491409, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_unregistered_information_struct, %struct.user_data_unregistered_information_struct* @seiUser_data_unregistered, i32 0, i32 2), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
  %type = getelementptr inbounds %struct.syntaxelement, %struct.syntaxelement* %sym, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateUser_data_unregistered.27() #0 {
entry:
  %canary = alloca i32
  store i32 1834956904, i32* %canary
  %i = alloca i32, align 4
  %total_byte = alloca i32, align 4
  %temp_data = alloca i32, align 4
  store i32 7, i32* %total_byte, align 4
...
entry:
  ...
  %sym = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 1719529587, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.subseq_char_information_struct, %struct.subseq_char_information_struct* @seiSubseqChar, i32 0, i32 10), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
  %type = getelementptr inbounds %struct.syntaxelement, %struct.syntaxelement* %sym, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSubseqChar.29() #0 {
entry:
  %canary = alloca i32
  store i32 846033592, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %dest = alloca %struct.Bitstream*, align 8
  %i = alloca i32, align 4
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.subseq_char_information_struct, %struct.subseq_char_information_struct* @seiSubseqChar, i32 0, i32 10), align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @ComposeSparePictureMessage.30(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream) #0 {
entry:
  %bitstream = alloca %struct.Bitstream*, align 8
  %sym = alloca %struct.syntaxelement, align 8
  %tmpBitstream.addr = alloca %struct.Bitstream*, align 8
  %delta_spare_frame_num.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1616657011, i32* %canary
  %ref_area_indicator.addr = alloca i32, align 4
  store i32 %delta_spare_frame_num, i32* %delta_spare_frame_num.addr, align 4
  store i32 %ref_area_indicator, i32* %ref_area_indicator.addr, align 4
  store %struct.Bitstream* %tmpBitstream, %struct.Bitstream** %tmpBitstream.addr, align 8
...
entry:
  %country_code = alloca i32, align 4
  %canary = alloca i32
  store i32 1362985351, i32* %canary
  %total_byte = alloca i32, align 4
  %temp_data = alloca i32, align 4
  %i = alloca i32, align 4
  store i32 82, i32* %country_code, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeRandomAccess.32() #0 {
entry:
  %sym = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 1239381615, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.randomaccess_information_struct, %struct.randomaccess_information_struct* @seiRandomAccess, i32 0, i32 3), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
  %type = getelementptr inbounds %struct.syntaxelement, %struct.syntaxelement* %sym, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateUser_data_unregistered.33() #0 {
entry:
  %canary = alloca i32
  store i32 539191376, i32* %canary
  %total_byte = alloca i32, align 4
  %temp_data = alloca i32, align 4
  %i = alloca i32, align 4
  store i32 7, i32* %total_byte, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 347406776, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSpareMBMap.35() #0 {
entry:
  %sym = alloca %struct.syntaxelement, align 8
  %source = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 991755830, i32* %canary
  %delta_frame_num = alloca i32, align 4
  %CurrFrameNum = alloca i32, align 4
  %dest = alloca %struct.Bitstream*, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateUser_data_unregistered.36() #0 {
entry:
  %temp_data = alloca i32, align 4
  %total_byte = alloca i32, align 4
  %canary = alloca i32
  store i32 1925359561, i32* %canary
  %i = alloca i32, align 4
  store i32 7, i32* %total_byte, align 4
  store i32 0, i32* %i, align 4
  br label %for.cond
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateUser_data_registered_itu_t_t35.37() #0 {
entry:
  %temp_data = alloca i32, align 4
  %canary = alloca i32
  store i32 1195190111, i32* %canary
  %country_code = alloca i32, align 4
  %i = alloca i32, align 4
  %total_byte = alloca i32, align 4
  store i32 82, i32* %country_code, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateSceneInformation.38(i32 %HasSceneInformation, i32 %sceneID, i32 %sceneTransType, i32 %secondSceneID) #0 {
entry:
  %canary = alloca i32
  store i32 565925565, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateUser_data_unregistered.39() #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 2110802548, i32* %canary
  %temp_data = alloca i32, align 4
  %total_byte = alloca i32, align 4
  store i32 7, i32* %total_byte, align 4
  store i32 0, i32* %i, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeRandomAccess.40() #0 {
entry:
  %canary = alloca i32
  store i32 923860523, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  %sym = alloca %struct.syntaxelement, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.randomaccess_information_struct, %struct.randomaccess_information_struct* @seiRandomAccess, i32 0, i32 3), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSpareMBMap.41() #0 {
entry:
  %canary = alloca i32
  store i32 1259173563, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %source = alloca %struct.Bitstream*, align 8
  %CurrFrameNum = alloca i32, align 4
  %dest = alloca %struct.Bitstream*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSpareMBMap.42() #0 {
entry:
  %sym = alloca %struct.syntaxelement, align 8
  %delta_frame_num = alloca i32, align 4
  %canary = alloca i32
  store i32 2030126139, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  %source = alloca %struct.Bitstream*, align 8
  %CurrFrameNum = alloca i32, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSubseqLayerInfo.43() #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 252577868, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 571763150, i32* %canary
  %size = alloca i32, align 4
  %payload_type.addr = alloca i32, align 4
  %payload_size.addr = alloca i32, align 4
  %offset = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateUser_data_registered_itu_t_t35.45() #0 {
entry:
  %canary = alloca i32
  store i32 1652352911, i32* %canary
  %i = alloca i32, align 4
  %temp_data = alloca i32, align 4
  %total_byte = alloca i32, align 4
  %country_code = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeUser_data_unregistered.46() #0 {
entry:
  %dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 333983924, i32* %canary
  %i = alloca i32, align 4
  %sym = alloca %struct.syntaxelement, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_unregistered_information_struct, %struct.user_data_unregistered_information_struct* @seiUser_data_unregistered, i32 0, i32 2), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateSceneInformation.47(i32 %HasSceneInformation, i32 %sceneID, i32 %sceneTransType, i32 %secondSceneID) #0 {
entry:
  %secondSceneID.addr = alloca i32, align 4
  %sceneID.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1819435844, i32* %canary
  %HasSceneInformation.addr = alloca i32, align 4
  %sceneTransType.addr = alloca i32, align 4
  store i32 %HasSceneInformation, i32* %HasSceneInformation.addr, align 4
  store i32 %sceneID, i32* %sceneID.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @CompressSpareMBMap.48(i8** %map_sp, %struct.Bitstream* %bitstream) #0 {
entry:
  %y = alloca i32, align 4
  %directx = alloca i32, align 4
  %noc = alloca i32, align 4
  ...
  %ret = alloca i32, align 4
  %canary = alloca i32
  store i32 1133224843, i32* %canary
  %bitc = alloca i32, align 4
  %bitstream.addr = alloca %struct.Bitstream*, align 8
  %map_sp.addr = alloca i8**, align 8
  %directy = alloca i32, align 4
...
if.end190:                                        ; preds = %for.end189, %if.end141
  %121 = load i32, i32* %ret, align 4
  %122 = load i32, i32* %canary
  %123 = icmp eq i32 %122, 1133224843
  br i1 %123, label %124, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateSceneInformation.49(i32 %HasSceneInformation, i32 %sceneID, i32 %sceneTransType, i32 %secondSceneID) #0 {
entry:
  %sceneTransType.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1434165056, i32* %canary
  %sceneID.addr = alloca i32, align 4
  %secondSceneID.addr = alloca i32, align 4
  %HasSceneInformation.addr = alloca i32, align 4
  store i32 %HasSceneInformation, i32* %HasSceneInformation.addr, align 4
...
entry:
  ...
  %size_uncompressed = alloca i32, align 4
  %canary = alloca i32
  store i32 767598335, i32* %canary
  %directy = alloca i32, align 4
  %top = alloca i32, align 4
  %map_sp.addr = alloca i8**, align 8
  %size_compressed = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeUser_data_unregistered.51() #0 {
entry:
  %canary = alloca i32
  store i32 1398251306, i32* %canary
  %i = alloca i32, align 4
  %dest = alloca %struct.Bitstream*, align 8
  %sym = alloca %struct.syntaxelement, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_unregistered_information_struct, %struct.user_data_unregistered_information_struct* @seiUser_data_unregistered, i32 0, i32 2), align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @ComposeSparePictureMessage.52(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream) #0 {
entry:
  %bitstream = alloca %struct.Bitstream*, align 8
  %delta_spare_frame_num.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 316670890, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %ref_area_indicator.addr = alloca i32, align 4
  %tmpBitstream.addr = alloca %struct.Bitstream*, align 8
  store i32 %delta_spare_frame_num, i32* %delta_spare_frame_num.addr, align 4
...
entry:
  ...
  %dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 164414117, i32* %canary
  %i = alloca i32, align 4
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_registered_itu_t_t35_information_struct, %struct.user_data_registered_itu_t_t35_information_struct* @seiUser_data_registered_itu_t_t35, i32 0, i32 4), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
  %type = getelementptr inbounds %struct.syntaxelement, %struct.syntaxelement* %sym, i32 0, i32 0
...
entry:
  %country_code = alloca i32, align 4
  %canary = alloca i32
  store i32 1312297379, i32* %canary
  %temp_data = alloca i32, align 4
  %total_byte = alloca i32, align 4
  %i = alloca i32, align 4
  store i32 82, i32* %country_code, align 4
...
entry:
  %canary = alloca i32
  store i32 2006962355, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  %sym = alloca %struct.syntaxelement, align 8
  %i = alloca i32, align 4
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.subseq_char_information_struct, %struct.subseq_char_information_struct* @seiSubseqChar, i32 0, i32 10), align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSpareMBMap.56() #0 {
entry:
  %dest = alloca %struct.Bitstream*, align 8
  %source = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 1806244514, i32* %canary
  %CurrFrameNum = alloca i32, align 4
  %delta_frame_num = alloca i32, align 4
  %sym = alloca %struct.syntaxelement, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_sei_message.57(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type) #0 {
entry:
  %payload_type.addr = alloca i32, align 4
  %payload.addr = alloca i8*, align 8
  %size = alloca i32, align 4
  ...
  %payload_size.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2026793023, i32* %canary
  %id.addr = alloca i32, align 4
  store i32 %id, i32* %id.addr, align 4
  store i8* %payload, i8** %payload.addr, align 8
  store i32 %payload_size, i32* %payload_size.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSubseqChar.58() #0 {
entry:
  %sym = alloca %struct.syntaxelement, align 8
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1188890726, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.subseq_char_information_struct, %struct.subseq_char_information_struct* @seiSubseqChar, i32 0, i32 10), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
  %type = getelementptr inbounds %struct.syntaxelement, %struct.syntaxelement* %sym, i32 0, i32 0
...
entry:
  %sceneID.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1091751188, i32* %canary
  %secondSceneID.addr = alloca i32, align 4
  %sceneTransType.addr = alloca i32, align 4
  %HasSceneInformation.addr = alloca i32, align 4
  store i32 %HasSceneInformation, i32* %HasSceneInformation.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @ComposeSparePictureMessage.60(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream) #0 {
entry:
  %canary = alloca i32
  store i32 336174975, i32* %canary
  %tmpBitstream.addr = alloca %struct.Bitstream*, align 8
  %delta_spare_frame_num.addr = alloca i32, align 4
  %bitstream = alloca %struct.Bitstream*, align 8
  %ref_area_indicator.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @AppendTmpbits2Buf.61(%struct.Bitstream* %dest, %struct.Bitstream* %source) #0 {
entry:
  %j = alloca i32, align 4
  %dest.addr = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 1211550527, i32* %canary
  %mask = alloca i8, align 1
  %bits_in_last_byte = alloca i32, align 4
  %i = alloca i32, align 4
  %source.addr = alloca %struct.Bitstream*, align 8
...
entry:
  %sym = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 424055667, i32* %canary
  %i = alloca i32, align 4
  %dest = alloca %struct.Bitstream*, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_registered_itu_t_t35_information_struct, %struct.user_data_registered_itu_t_t35_information_struct* @seiUser_data_registered_itu_t_t35, i32 0, i32 4), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @CompressSpareMBMap.63(i8** %map_sp, %struct.Bitstream* %bitstream) #0 {
entry:
  %directx = alloca i32, align 4
  %size_compressed = alloca i32, align 4
  %map_sp.addr = alloca i8**, align 8
  ...
  %k = alloca i32, align 4
  %canary = alloca i32
  store i32 1958037906, i32* %canary
  %bottom = alloca i32, align 4
  %bitc = alloca i32, align 4
  %directy = alloca i32, align 4
  %size_uncompressed = alloca i32, align 4
...
if.end190:                                        ; preds = %for.end189, %if.end141
  %121 = load i32, i32* %ret, align 4
  %122 = load i32, i32* %canary
  %123 = icmp eq i32 %122, 1958037906
  br i1 %123, label %124, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSubseqChar.65() #0 {
entry:
  %dest = alloca %struct.Bitstream*, align 8
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1540205103, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.subseq_char_information_struct, %struct.subseq_char_information_struct* @seiSubseqChar, i32 0, i32 10), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
  %type = getelementptr inbounds %struct.syntaxelement, %struct.syntaxelement* %sym, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @CompressSpareMBMap.66(i8** %map_sp, %struct.Bitstream* %bitstream) #0 {
entry:
  %directx = alloca i32, align 4
  %k = alloca i32, align 4
  %sym = alloca %struct.syntaxelement, align 8
  ...
  %directy = alloca i32, align 4
  %canary = alloca i32
  store i32 814557148, i32* %canary
  %bottom = alloca i32, align 4
  %map_sp.addr = alloca i8**, align 8
  %bitc = alloca i32, align 4
  %ret = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeUser_data_unregistered.67() #0 {
entry:
  %canary = alloca i32
  store i32 1497037899, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  %sym = alloca %struct.syntaxelement, align 8
  %i = alloca i32, align 4
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_unregistered_information_struct, %struct.user_data_unregistered_information_struct* @seiUser_data_unregistered, i32 0, i32 2), align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @CompressSpareMBMap.68(i8** %map_sp, %struct.Bitstream* %bitstream) #0 {
entry:
  %map_sp.addr = alloca i8**, align 8
  %directy = alloca i32, align 4
  %bit0 = alloca i32, align 4
  ...
  %ret = alloca i32, align 4
  %canary = alloca i32
  store i32 675842949, i32* %canary
  %size_uncompressed = alloca i32, align 4
  %bitc = alloca i32, align 4
  %bit1 = alloca i32, align 4
  %y = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @CompressSpareMBMap.69(i8** %map_sp, %struct.Bitstream* %bitstream) #0 {
entry:
  %size_uncompressed = alloca i32, align 4
  %sym = alloca %struct.syntaxelement, align 8
  %directy = alloca i32, align 4
  %canary = alloca i32
  store i32 2134257139, i32* %canary
  %j = alloca i32, align 4
  %map_sp.addr = alloca i8**, align 8
  %bottom = alloca i32, align 4
  %top = alloca i32, align 4
...
if.end190:                                        ; preds = %for.end189, %if.end141
  %121 = load i32, i32* %ret, align 4
  %122 = load i32, i32* %canary
  %123 = icmp eq i32 %122, 2134257139
  br i1 %123, label %124, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @ComposeSparePictureMessage.70(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream) #0 {
entry:
  %bitstream = alloca %struct.Bitstream*, align 8
  %sym = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 1950443225, i32* %canary
  %delta_spare_frame_num.addr = alloca i32, align 4
  %tmpBitstream.addr = alloca %struct.Bitstream*, align 8
  %ref_area_indicator.addr = alloca i32, align 4
  store i32 %delta_spare_frame_num, i32* %delta_spare_frame_num.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeUser_data_unregistered.71() #0 {
entry:
  %canary = alloca i32
  store i32 1895300946, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %i = alloca i32, align 4
  %dest = alloca %struct.Bitstream*, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_unregistered_information_struct, %struct.user_data_unregistered_information_struct* @seiUser_data_unregistered, i32 0, i32 2), align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @ComposeSparePictureMessage.72(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream) #0 {
entry:
  %ref_area_indicator.addr = alloca i32, align 4
  %sym = alloca %struct.syntaxelement, align 8
  %tmpBitstream.addr = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 562439932, i32* %canary
  %delta_spare_frame_num.addr = alloca i32, align 4
  %bitstream = alloca %struct.Bitstream*, align 8
  store i32 %delta_spare_frame_num, i32* %delta_spare_frame_num.addr, align 4
  store i32 %ref_area_indicator, i32* %ref_area_indicator.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_sei_message.73(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type) #0 {
entry:
  %payload_size.addr = alloca i32, align 4
  %payload.addr = alloca i8*, align 8
  %offset = alloca i32, align 4
  %type = alloca i32, align 4
  %canary = alloca i32
  store i32 1363421246, i32* %canary
  %payload_type.addr = alloca i32, align 4
  %size = alloca i32, align 4
  %id.addr = alloca i32, align 4
  store i32 %id, i32* %id.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSubseqLayerInfo.74() #0 {
entry:
  %pos = alloca i32, align 4
  %canary = alloca i32
  store i32 248046700, i32* %canary
  %i = alloca i32, align 4
  store i32 0, i32* %pos, align 4
  store i32 0, i32* getelementptr inbounds (%struct.subseq_layer_information_struct, %struct.subseq_layer_information_struct* @seiSubseqLayerInfo, i32 0, i32 4), align 4
  store i32 0, i32* %i, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeUser_data_registered_itu_t_t35.75() #0 {
entry:
  %canary = alloca i32
  store i32 1151553441, i32* %canary
  %i = alloca i32, align 4
  %sym = alloca %struct.syntaxelement, align 8
  %dest = alloca %struct.Bitstream*, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_registered_itu_t_t35_information_struct, %struct.user_data_registered_itu_t_t35_information_struct* @seiUser_data_registered_itu_t_t35, i32 0, i32 4), align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSubseqInfo.76(i32 %currLayer) #0 {
entry:
  %dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 1606141014, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %currLayer.addr = alloca i32, align 4
  store i32 %currLayer, i32* %currLayer.addr, align 4
  %0 = load i32, i32* %currLayer.addr, align 4
...
entry:
  %sym = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 1514509302, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  %i = alloca i32, align 4
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_unregistered_information_struct, %struct.user_data_unregistered_information_struct* @seiUser_data_unregistered, i32 0, i32 2), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateUser_data_registered_itu_t_t35.78() #0 {
entry:
  %canary = alloca i32
  store i32 2053699222, i32* %canary
  %country_code = alloca i32, align 4
  %temp_data = alloca i32, align 4
  %i = alloca i32, align 4
  %total_byte = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_sei_message.79(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type) #0 {
entry:
  %payload_type.addr = alloca i32, align 4
  %size = alloca i32, align 4
  %id.addr = alloca i32, align 4
  ...
  %payload.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1259326826, i32* %canary
  %offset = alloca i32, align 4
  %payload_size.addr = alloca i32, align 4
  store i32 %id, i32* %id.addr, align 4
  store i8* %payload, i8** %payload.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @AppendTmpbits2Buf.80(%struct.Bitstream* %dest, %struct.Bitstream* %source) #0 {
entry:
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 181240692, i32* %canary
  %bits_in_last_byte = alloca i32, align 4
  %dest.addr = alloca %struct.Bitstream*, align 8
  %i = alloca i32, align 4
  %mask = alloca i8, align 1
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @ComposeSparePictureMessage.81(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream) #0 {
entry:
  %tmpBitstream.addr = alloca %struct.Bitstream*, align 8
  %delta_spare_frame_num.addr = alloca i32, align 4
  %ref_area_indicator.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1421223045, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %bitstream = alloca %struct.Bitstream*, align 8
  store i32 %delta_spare_frame_num, i32* %delta_spare_frame_num.addr, align 4
  store i32 %ref_area_indicator, i32* %ref_area_indicator.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateSceneInformation.82(i32 %HasSceneInformation, i32 %sceneID, i32 %sceneTransType, i32 %secondSceneID) #0 {
entry:
  %sceneID.addr = alloca i32, align 4
  %secondSceneID.addr = alloca i32, align 4
  %HasSceneInformation.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1797550730, i32* %canary
  %sceneTransType.addr = alloca i32, align 4
  store i32 %HasSceneInformation, i32* %HasSceneInformation.addr, align 4
  store i32 %sceneID, i32* %sceneID.addr, align 4
  store i32 %sceneTransType, i32* %sceneTransType.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateUser_data_registered_itu_t_t35.83() #0 {
entry:
  %canary = alloca i32
  store i32 1696992318, i32* %canary
  %i = alloca i32, align 4
  %temp_data = alloca i32, align 4
  %country_code = alloca i32, align 4
  %total_byte = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSubseqInfo.84(i32 %currLayer) #0 {
entry:
  %canary = alloca i32
  store i32 1497767506, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %dest = alloca %struct.Bitstream*, align 8
  %currLayer.addr = alloca i32, align 4
  store i32 %currLayer, i32* %currLayer.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_sei_message.85(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type) #0 {
entry:
  %canary = alloca i32
  store i32 520393778, i32* %canary
  %size = alloca i32, align 4
  %payload_size.addr = alloca i32, align 4
  %id.addr = alloca i32, align 4
  %offset = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @AppendTmpbits2Buf.86(%struct.Bitstream* %dest, %struct.Bitstream* %source) #0 {
entry:
  %canary = alloca i32
  store i32 991184730, i32* %canary
  %mask = alloca i8, align 1
  %i = alloca i32, align 4
  %dest.addr = alloca %struct.Bitstream*, align 8
  %source.addr = alloca %struct.Bitstream*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSubseqInfo.87(i32 %currLayer) #0 {
entry:
  %canary = alloca i32
  store i32 1271370746, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  %currLayer.addr = alloca i32, align 4
  %sym = alloca %struct.syntaxelement, align 8
  store i32 %currLayer, i32* %currLayer.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSubseqInfo.88(i32 %currLayer) #0 {
entry:
  %currLayer.addr = alloca i32, align 4
  %dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 751407707, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  store i32 %currLayer, i32* %currLayer.addr, align 4
  %0 = load i32, i32* %currLayer.addr, align 4
  %idxprom = sext i32 %0 to i64
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateUser_data_registered_itu_t_t35.89() #0 {
entry:
  %canary = alloca i32
  store i32 132867482, i32* %canary
  %i = alloca i32, align 4
  %country_code = alloca i32, align 4
  %total_byte = alloca i32, align 4
  %temp_data = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_sei_message.90(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type) #0 {
entry:
  %payload_size.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1897756863, i32* %canary
  %payload_type.addr = alloca i32, align 4
  %payload.addr = alloca i8*, align 8
  %type = alloca i32, align 4
  %size = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_sei_message.91(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type) #0 {
entry:
  %payload_type.addr = alloca i32, align 4
  %payload_size.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1128811615, i32* %canary
  %size = alloca i32, align 4
  %type = alloca i32, align 4
  %id.addr = alloca i32, align 4
  %payload.addr = alloca i8*, align 8
...
entry:
  ...
  %sceneTransType.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1736887923, i32* %canary
  %sceneID.addr = alloca i32, align 4
  %HasSceneInformation.addr = alloca i32, align 4
  store i32 %HasSceneInformation, i32* %HasSceneInformation.addr, align 4
  store i32 %sceneID, i32* %sceneID.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateSceneInformation.93(i32 %HasSceneInformation, i32 %sceneID, i32 %sceneTransType, i32 %secondSceneID) #0 {
entry:
  %canary = alloca i32
  store i32 2100002097, i32* %canary
  %secondSceneID.addr = alloca i32, align 4
  %HasSceneInformation.addr = alloca i32, align 4
  %sceneID.addr = alloca i32, align 4
  %sceneTransType.addr = alloca i32, align 4
...
entry:
  ...
  %source.addr = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 1312172557, i32* %canary
  %j = alloca i32, align 4
  store %struct.Bitstream* %dest, %struct.Bitstream** %dest.addr, align 8
  store %struct.Bitstream* %source, %struct.Bitstream** %source.addr, align 8
  store i32 0, i32* %i, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateSceneInformation.95(i32 %HasSceneInformation, i32 %sceneID, i32 %sceneTransType, i32 %secondSceneID) #0 {
entry:
  %secondSceneID.addr = alloca i32, align 4
  %HasSceneInformation.addr = alloca i32, align 4
  %sceneTransType.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 15654749, i32* %canary
  %sceneID.addr = alloca i32, align 4
  store i32 %HasSceneInformation, i32* %HasSceneInformation.addr, align 4
  store i32 %sceneID, i32* %sceneID.addr, align 4
  store i32 %sceneTransType, i32* %sceneTransType.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @AppendTmpbits2Buf.96(%struct.Bitstream* %dest, %struct.Bitstream* %source) #0 {
entry:
  %i = alloca i32, align 4
  %dest.addr = alloca %struct.Bitstream*, align 8
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 318683447, i32* %canary
  %source.addr = alloca %struct.Bitstream*, align 8
  %bits_in_last_byte = alloca i32, align 4
  %mask = alloca i8, align 1
  store %struct.Bitstream* %dest, %struct.Bitstream** %dest.addr, align 8
