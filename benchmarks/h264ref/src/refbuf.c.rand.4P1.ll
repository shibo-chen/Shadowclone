...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_PutPel_14.28, label %func_PutPel_14.29
}
...
func_PutPel_11.8:                                 ; preds = %ctrl0
  call void @PutPel_11.8(i16* %Pic, i32 %y, i32 %x, i16 %val, i32 %width)
  ret void
...
func_PutPel_11.20:                                ; preds = %ctrl1
  call void @PutPel_11.20(i16* %Pic, i32 %y, i32 %x, i16 %val, i32 %width)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_PutPel_11.8, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_PutPel_11.19, label %func_PutPel_11.20
}
...
func_FastLine16Y_11.11:                           ; preds = %ctrl0
  %3 = call i16* @FastLine16Y_11.11(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %3

func_FastLine16Y_11.12:                           ; preds = %ctrl1
  %4 = call i16* @FastLine16Y_11.12(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %4
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_FastLine16Y_11.11, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_FastLine16Y_11.12, label %func_FastLine16Y_11.22
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_UMVLine16Y_11.4, label %ctrl0

func_UMVLine16Y_11.4:                             ; preds = %rand_bb
  %2 = call i16* @UMVLine16Y_11.4(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %2

func_UMVLine16Y_11.13:                            ; preds = %ctrl0
  %3 = call i16* @UMVLine16Y_11.13(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %3

func_UMVLine16Y_11.25:                            ; preds = %ctrl1
  %4 = call i16* @UMVLine16Y_11.25(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %4
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_UMVLine16Y_11.13, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_UMVLine16Y_11.25, label %func_UMVLine16Y_11.26
}
...
func_FastLineX.18:                                ; preds = %ctrl1
  %4 = call i16* @FastLineX.18(i32 %dummy, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %4

func_FastLineX.24:                                ; preds = %ctrl1
  %5 = call i16* @FastLineX.24(i32 %dummy, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_FastLineX.14, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_FastLineX.18, label %func_FastLineX.24
}
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_UMVLineX.15, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_UMVLineX.16, label %func_UMVLineX.17
}
...
func_UMVPelY_14.21:                               ; preds = %ctrl1
  %5 = call i16 @UMVPelY_14.21(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_UMVPelY_14.7, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_UMVPelY_14.10, label %func_UMVPelY_14.21
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FastPelY_14.27, label %ctrl0

func_FastPelY_14.27:                              ; preds = %rand_bb
  %2 = call i16 @FastPelY_14.27(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16 %2

func_FastPelY_14.30:                              ; preds = %ctrl0
  %3 = call i16 @FastPelY_14.30(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16 %3

func_FastPelY_14.31:                              ; preds = %ctrl1
  %4 = call i16 @FastPelY_14.31(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16 %4

func_FastPelY_14.32:                              ; preds = %ctrl1
  %5 = call i16 @FastPelY_14.32(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_FastPelY_14.30, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_FastPelY_14.31, label %func_FastPelY_14.32
}
...
entry:
  ...
  %canary = alloca i32
  store i32 2084098239, i32* %canary
...
entry:
  %x.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 985750780, i32* %canary
  %Pic.addr = alloca i16*, align 8
  %width.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1592870716, i32* %canary
  %width.addr = alloca i32, align 4
  %height.addr = alloca i32, align 4
  %x.addr = alloca i32, align 4
...
entry:
  ...
  %height.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1981704523, i32* %canary
  %x.addr = alloca i32, align 4
  %retval = alloca i16*, align 8
  store i16* %Pic, i16** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
...
entry:
  ...
  %val.addr = alloca i16, align 2
  %canary = alloca i32
  store i32 921266033, i32* %canary
  %y.addr = alloca i32, align 4
  store i16** %Pic, i16*** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
  store i32 %x, i32* %x.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 1158089773, i32* %canary
  %Pic.addr = alloca i16*, align 8
  %x.addr = alloca i32, align 4
  %height.addr = alloca i32, align 4
  %width.addr = alloca i32, align 4
...
entry:
  ...
  %x.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1056372468, i32* %canary
  %retval = alloca i16, align 2
  %height.addr = alloca i32, align 4
  %Pic.addr = alloca i16**, align 8
  %width4 = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @PutPel_11.8(i16* %Pic, i32 %y, i32 %x, i16 zeroext %val, i32 %width) #0 {
entry:
  %width.addr = alloca i32, align 4
  %Pic.addr = alloca i16*, align 8
  %val.addr = alloca i16, align 2
  %canary = alloca i32
  store i32 1278671538, i32* %canary
  %x.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
  store i16* %Pic, i16** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
...
entry:
  %x.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 569094220, i32* %canary
  %height.addr = alloca i32, align 4
  %width.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
  %Pic.addr = alloca i16*, align 8
...
entry:
  ...
  %retval = alloca i16, align 2
  %canary = alloca i32
  store i32 198037434, i32* %canary
  %width.addr = alloca i32, align 4
  store i16** %Pic, i16*** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
  store i32 %x, i32* %x.addr, align 4
...
entry:
  ...
  %x.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1665753979, i32* %canary
  %height.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
  store i16* %Pic, i16** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
...
entry:
  ...
  %y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 207482512, i32* %canary
  %Pic.addr = alloca i16*, align 8
  %height.addr = alloca i32, align 4
  store i16* %Pic, i16** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 586570430, i32* %canary
  %Pic.addr = alloca i16*, align 8
  %Picy = alloca i16*, align 8
  %i = alloca i32, align 4
  %height.addr = alloca i32, align 4
...
entry:
  ...
  %x.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1520915791, i32* %canary
  %width.addr = alloca i32, align 4
  store i32 %dummy, i32* %dummy.addr, align 4
  store i16* %Pic, i16** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
...
entry:
  ...
  %width.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1840222157, i32* %canary
  %Picy = alloca i16*, align 8
  %Pic.addr = alloca i16*, align 8
  %size.addr = alloca i32, align 4
  %retval = alloca i16*, align 8
...
entry:
  ...
  %height.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 640693387, i32* %canary
  %Pic.addr = alloca i16*, align 8
  %size.addr = alloca i32, align 4
  %retval = alloca i16*, align 8
  %x.addr = alloca i32, align 4
...
entry:
  ...
  %retval = alloca i16*, align 8
  %canary = alloca i32
  store i32 1277862201, i32* %canary
  %size.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %y.addr = alloca i32, align 4
  %height.addr = alloca i32, align 4
...
entry:
  ...
  %width.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1166032282, i32* %canary
  %y.addr = alloca i32, align 4
  %dummy.addr = alloca i32, align 4
  store i32 %dummy, i32* %dummy.addr, align 4
  store i16* %Pic, i16** %Pic.addr, align 8
...
entry:
  ...
  %width.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 488486409, i32* %canary
  %val.addr = alloca i16, align 2
  %Pic.addr = alloca i16*, align 8
  %y.addr = alloca i32, align 4
  store i16* %Pic, i16** %Pic.addr, align 8
...
entry:
  ...
  %width.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1548600668, i32* %canary
  %y.addr = alloca i32, align 4
  store i16* %Pic, i16** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
  store i32 %x, i32* %x.addr, align 4
...
entry:
  ...
  %width4 = alloca i32, align 4
  %canary = alloca i32
  store i32 293911329, i32* %canary
  %retval = alloca i16, align 2
  store i16** %Pic, i16*** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
  store i32 %x, i32* %x.addr, align 4
...
entry:
  ...
  %Pic.addr = alloca i16*, align 8
  %canary = alloca i32
  store i32 1314378165, i32* %canary
  %width.addr = alloca i32, align 4
  store i16* %Pic, i16** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
  store i32 %x, i32* %x.addr, align 4
...
entry:
  ...
  %y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 964134601, i32* %canary
  %x.addr = alloca i32, align 4
  %val.addr = alloca i16, align 2
  store i16** %Pic, i16*** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
...
entry:
  ...
  %y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1030818807, i32* %canary
  %height.addr = alloca i32, align 4
  %dummy.addr = alloca i32, align 4
  %x.addr = alloca i32, align 4
  store i32 %dummy, i32* %dummy.addr, align 4
...
entry:
  %Pic.addr = alloca i16*, align 8
  %canary = alloca i32
  store i32 1870293675, i32* %canary
  %x.addr = alloca i32, align 4
  %maxx = alloca i32, align 4
  %i = alloca i32, align 4
  %retval = alloca i16*, align 8
...
entry:
  ...
  %retval = alloca i16*, align 8
  %canary = alloca i32
  store i32 1678385969, i32* %canary
  %Picy = alloca i16*, align 8
  %width.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %x.addr = alloca i32, align 4
...
entry:
  ...
  %x.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1536937584, i32* %canary
  %width.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
  %Pic.addr = alloca i16**, align 8
  store i16** %Pic, i16*** %Pic.addr, align 8
...
entry:
  ...
  %x.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1837466581, i32* %canary
  %val.addr = alloca i16, align 2
  %Pic.addr = alloca i16**, align 8
  store i16** %Pic, i16*** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
...
entry:
  %Pic.addr = alloca i16**, align 8
  %canary = alloca i32
  store i32 1624427968, i32* %canary
  %x.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
  %val.addr = alloca i16, align 2
  store i16** %Pic, i16*** %Pic.addr, align 8
...
entry:
  ...
  %width.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 756176169, i32* %canary
  %Pic.addr = alloca i16**, align 8
  store i16** %Pic, i16*** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
  store i32 %x, i32* %x.addr, align 4
...
entry:
  ...
  %Pic.addr = alloca i16**, align 8
  %canary = alloca i32
  store i32 393482228, i32* %canary
  %x.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
  store i16** %Pic, i16*** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
...
entry:
  ...
  %Pic.addr = alloca i16**, align 8
  %canary = alloca i32
  store i32 2007737297, i32* %canary
  %x.addr = alloca i32, align 4
  store i16** %Pic, i16*** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
  store i32 %x, i32* %x.addr, align 4
