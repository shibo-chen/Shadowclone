...
# %bb.1:                                # %func_WriteRTPNALU.2
	...
	.cfi_def_cfa %rsp, 8
	retq
.LBB2_2:                                # %func_WriteRTPNALU.8
	.cfi_def_cfa %rbp, 16
	movq	%rbx, %rdi
	callq	WriteRTPNALU.8
	addq	$8, %rsp
	popq	%rbx
	popq	%rbp
	.cfi_def_cfa %rsp, 8
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$978587112, -36(%rbp)   # imm = 0x3A540DE8
	movq	%rdi, -24(%rbp)
	movq	%rsi, -32(%rbp)
	movl	$-1, -40(%rbp)
	movq	-24(%rbp), %rdi
...
.LBB6_7:                                # %return
	movl	-12(%rbp), %ebx
	cmpl	$978587112, -36(%rbp)   # imm = 0x3A540DE8
	jne	.LBB6_9
.LBB6_8:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$1102738769, -28(%rbp)  # imm = 0x41BA7551
	movq	%rdi, -24(%rbp)
	movq	-24(%rbp), %rax
	movl	20(%rax), %eax
	shll	$7, %eax
...
.LBB7_10:                               # %if.end32
	...
	movl	4(%rax), %ebx
	shll	$3, %ebx
	cmpl	$1102738769, -28(%rbp)  # imm = 0x41BA7551
	jne	.LBB7_12
.LBB7_11:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$962497384, -36(%rbp)   # imm = 0x395E8B68
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movl	$-1, -40(%rbp)
	movq	-32(%rbp), %rdi
...
.LBB8_7:                                # %return
	movl	-12(%rbp), %ebx
	cmpl	$962497384, -36(%rbp)   # imm = 0x395E8B68
	jne	.LBB8_9
.LBB8_8:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$16, %rsp
	movl	$121625229, -12(%rbp)   # imm = 0x73FDA8D
	movl	%edi, -8(%rbp)
...
.LBB9_5:                                # %return
	cmpl	$121625229, -12(%rbp)   # imm = 0x73FDA8D
	jne	.LBB9_7
.LBB9_6:
	addq	$16, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$16, %rsp
	movl	$1885315277, -12(%rbp)  # imm = 0x705FA0CD
	movl	%edi, -8(%rbp)
	cmpl	$-1, RTPUpdateTimestamp.oldtr
	jne	.LBB10_2
# %bb.1:                                # %if.then
...
.LBB10_4:                               # %if.end3
	...
	movl	%eax, RTPUpdateTimestamp.oldtr
.LBB10_5:                               # %return
	cmpl	$1885315277, -12(%rbp)  # imm = 0x705FA0CD
	jne	.LBB10_7
.LBB10_6:
	addq	$16, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$90344369, -40(%rbp)    # imm = 0x5628BB1
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movl	$-1, -36(%rbp)
	movq	-32(%rbp), %rdi
...
.LBB11_7:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$90344369, -40(%rbp)    # imm = 0x5628BB1
	jne	.LBB11_9
.LBB11_8:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$211683974, -40(%rbp)   # imm = 0xC9E0A86
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movl	$-1, -36(%rbp)
	movq	-32(%rbp), %rdi
...
.LBB12_7:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$211683974, -40(%rbp)   # imm = 0xC9E0A86
	jne	.LBB12_9
.LBB12_8:
	movl	%ebx, %eax
	addq	$40, %rsp
...
.Lfunc_end12:
	...
	.cfi_endproc
                                        # -- End function
	.globl	WriteRTPNALU.8          # -- Begin function WriteRTPNALU.8
	.p2align	4, 0x90
	.type	WriteRTPNALU.8,@function
WriteRTPNALU.8:                         # @WriteRTPNALU.8
	.cfi_startproc
# %bb.0:                                # %entry
	pushq	%rbp
	.cfi_def_cfa_offset 16
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$1706433703, -28(%rbp)  # imm = 0x65B61CA7
	movq	%rdi, -24(%rbp)
	movq	-24(%rbp), %rax
	movl	20(%rax), %eax
	shll	$7, %eax
...
.LBB13_10:                              # %if.end32
	...
	movl	4(%rax), %ebx
	shll	$3, %ebx
	cmpl	$1706433703, -28(%rbp)  # imm = 0x65B61CA7
	jne	.LBB13_12
.LBB13_11:
	movl	%ebx, %eax
	addq	$24, %rsp
...
.LBB13_12:                              # %func_exit
	...
	jmp	.LBB13_11
.Lfunc_end13:
	.size	WriteRTPNALU.8, .Lfunc_end13-WriteRTPNALU.8
	.cfi_endproc
                                        # -- End function
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$1652124101, -36(%rbp)  # imm = 0x627969C5
	movq	%rdi, -24(%rbp)
	movq	%rsi, -32(%rbp)
	movl	$-1, -40(%rbp)
	movq	-24(%rbp), %rdi
...
.LBB14_7:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$1652124101, -36(%rbp)  # imm = 0x627969C5
	jne	.LBB14_9
.LBB14_8:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$886802086, -40(%rbp)   # imm = 0x34DB86A6
	movq	%rdi, -24(%rbp)
	movq	%rsi, -32(%rbp)
	movl	$-1, -36(%rbp)
	movq	-24(%rbp), %rdi
...
.LBB15_7:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$886802086, -40(%rbp)   # imm = 0x34DB86A6
	jne	.LBB15_9
.LBB15_8:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$981886345, -40(%rbp)   # imm = 0x3A866589
	movq	%rdi, -24(%rbp)
	movq	%rsi, -32(%rbp)
	movl	$-1, -36(%rbp)
	movq	-24(%rbp), %rdi
...
.LBB16_7:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$981886345, -40(%rbp)   # imm = 0x3A866589
	jne	.LBB16_9
.LBB16_8:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$691351048, -36(%rbp)   # imm = 0x29352E08
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movl	$-1, -40(%rbp)
	movq	-32(%rbp), %rdi
...
.LBB17_7:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$691351048, -36(%rbp)   # imm = 0x29352E08
	jne	.LBB17_9
.LBB17_8:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$260022309, -36(%rbp)   # imm = 0xF7FA025
	movq	%rdi, -24(%rbp)
	movq	%rsi, -32(%rbp)
	movl	$-1, -40(%rbp)
	movq	-24(%rbp), %rdi
...
.LBB18_7:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$260022309, -36(%rbp)   # imm = 0xF7FA025
	jne	.LBB18_9
.LBB18_8:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$1702457581, -36(%rbp)  # imm = 0x657970ED
	movq	%rdi, -24(%rbp)
	movq	%rsi, -32(%rbp)
	movl	$-1, -40(%rbp)
	movq	-24(%rbp), %rdi
...
.LBB19_7:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$1702457581, -36(%rbp)  # imm = 0x657970ED
	jne	.LBB19_9
.LBB19_8:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$1132994252, -36(%rbp)  # imm = 0x43881ECC
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movl	$-1, -40(%rbp)
	movq	-32(%rbp), %rdi
...
.LBB20_7:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$1132994252, -36(%rbp)  # imm = 0x43881ECC
	jne	.LBB20_9
.LBB20_8:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$1522339583, -36(%rbp)  # imm = 0x5ABD0EFF
	movq	%rdi, -24(%rbp)
	movq	%rsi, -32(%rbp)
	movl	$-1, -40(%rbp)
	movq	-24(%rbp), %rdi
...
.LBB21_7:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$1522339583, -36(%rbp)  # imm = 0x5ABD0EFF
	jne	.LBB21_9
.LBB21_8:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$920833084, -40(%rbp)   # imm = 0x36E2CC3C
	movq	%rdi, -24(%rbp)
	movq	%rsi, -32(%rbp)
	movl	$-1, -36(%rbp)
	movq	-24(%rbp), %rdi
...
.LBB22_7:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$920833084, -40(%rbp)   # imm = 0x36E2CC3C
	jne	.LBB22_9
.LBB22_8:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$1338855987, -40(%rbp)  # imm = 0x4FCD5233
	movq	%rdi, -24(%rbp)
	movq	%rsi, -32(%rbp)
	movl	$-1, -36(%rbp)
	movq	-24(%rbp), %rdi
...
.LBB23_7:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$1338855987, -40(%rbp)  # imm = 0x4FCD5233
	jne	.LBB23_9
.LBB23_8:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$1079296238, -40(%rbp)  # imm = 0x4054C0EE
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movl	$-1, -36(%rbp)
	movq	-32(%rbp), %rdi
...
.LBB24_7:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$1079296238, -40(%rbp)  # imm = 0x4054C0EE
	jne	.LBB24_9
.LBB24_8:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$1425109847, -40(%rbp)  # imm = 0x54F17357
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movl	$-1, -36(%rbp)
	movq	-32(%rbp), %rdi
...
.LBB25_7:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$1425109847, -40(%rbp)  # imm = 0x54F17357
	jne	.LBB25_9
.LBB25_8:
	movl	%ebx, %eax
	addq	$40, %rsp
