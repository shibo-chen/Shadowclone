...
# %bb.0:                                # %rand_bb
	...
	cmpl	$0, %eax
	jne	.LBB2_2
# %bb.1:                                # %func_WriteRTPNALU.7
	movq	%rbx, %rdi
	callq	WriteRTPNALU.7
	addq	$8, %rsp
	popq	%rbx
	popq	%rbp
	.cfi_def_cfa %rsp, 8
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$320734592, -40(%rbp)   # imm = 0x131E0580
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movl	$-1, -36(%rbp)
	movq	-32(%rbp), %rdi
...
.LBB6_7:                                # %return
	movl	-12(%rbp), %ebx
	cmpl	$320734592, -40(%rbp)   # imm = 0x131E0580
	jne	.LBB6_9
.LBB6_8:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$690686636, -36(%rbp)   # imm = 0x292B0AAC
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movl	$-1, -40(%rbp)
	movq	-32(%rbp), %rdi
...
.LBB7_7:                                # %return
	movl	-12(%rbp), %ebx
	cmpl	$690686636, -36(%rbp)   # imm = 0x292B0AAC
	jne	.LBB7_9
.LBB7_8:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$16, %rsp
	movl	$1391609726, -12(%rbp)  # imm = 0x52F2477E
	movl	%edi, -8(%rbp)
...
.LBB8_5:                                # %return
	cmpl	$1391609726, -12(%rbp)  # imm = 0x52F2477E
	jne	.LBB8_7
.LBB8_6:
	addq	$16, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$349348133, -40(%rbp)   # imm = 0x14D2A125
	movq	%rdi, -24(%rbp)
	movq	%rsi, -32(%rbp)
	movl	$-1, -36(%rbp)
	movq	-24(%rbp), %rdi
...
.LBB9_7:                                # %return
	movl	-12(%rbp), %ebx
	cmpl	$349348133, -40(%rbp)   # imm = 0x14D2A125
	jne	.LBB9_9
.LBB9_8:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$1834875317, -40(%rbp)  # imm = 0x6D5DF9B5
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movl	$-1, -36(%rbp)
	movq	-32(%rbp), %rdi
...
.LBB10_7:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$1834875317, -40(%rbp)  # imm = 0x6D5DF9B5
	jne	.LBB10_9
.LBB10_8:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$16, %rsp
	movl	$1604376418, -12(%rbp)  # imm = 0x5FA0D762
	movl	%edi, -8(%rbp)
	cmpl	$-1, RTPUpdateTimestamp.oldtr
	jne	.LBB11_2
# %bb.1:                                # %if.then
...
.LBB11_4:                               # %if.end3
	...
	movl	%eax, RTPUpdateTimestamp.oldtr
.LBB11_5:                               # %return
	cmpl	$1604376418, -12(%rbp)  # imm = 0x5FA0D762
	jne	.LBB11_7
.LBB11_6:
	addq	$16, %rsp
	popq	%rbp
...
.Lfunc_end11:
	...
	.cfi_endproc
                                        # -- End function
	.globl	WriteRTPNALU.7          # -- Begin function WriteRTPNALU.7
	.p2align	4, 0x90
	.type	WriteRTPNALU.7,@function
WriteRTPNALU.7:                         # @WriteRTPNALU.7
	.cfi_startproc
# %bb.0:                                # %entry
	pushq	%rbp
	.cfi_def_cfa_offset 16
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$736094597, -28(%rbp)   # imm = 0x2BDFE985
	movq	%rdi, -24(%rbp)
	movq	-24(%rbp), %rax
	movl	20(%rax), %eax
	shll	$7, %eax
...
.LBB12_10:                              # %if.end32
	...
	movl	4(%rax), %ebx
	shll	$3, %ebx
	cmpl	$736094597, -28(%rbp)   # imm = 0x2BDFE985
	jne	.LBB12_12
.LBB12_11:
	movl	%ebx, %eax
	addq	$24, %rsp
...
.LBB12_12:                              # %func_exit
	...
	jmp	.LBB12_11
.Lfunc_end12:
	.size	WriteRTPNALU.7, .Lfunc_end12-WriteRTPNALU.7
	.cfi_endproc
                                        # -- End function
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$484951988, -28(%rbp)   # imm = 0x1CE7C7B4
	movq	%rdi, -24(%rbp)
	movq	-24(%rbp), %rax
	movl	20(%rax), %eax
	shll	$7, %eax
...
.LBB13_10:                              # %if.end32
	...
	movl	4(%rax), %ebx
	shll	$3, %ebx
	cmpl	$484951988, -28(%rbp)   # imm = 0x1CE7C7B4
	jne	.LBB13_12
.LBB13_11:
	movl	%ebx, %eax
	addq	$24, %rsp
