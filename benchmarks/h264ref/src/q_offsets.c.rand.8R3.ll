; ModuleID = 'q_offsets.c.rand.8R3.bc'
...
func_CheckOffsetParameterName.5:                  ; preds = %ctrl0
  %3 = call i32 @CheckOffsetParameterName.5(i8* %s, i32* %type)
  ret i32 %3

func_CheckOffsetParameterName.11:                 ; preds = %ctrl1
  %4 = call i32 @CheckOffsetParameterName.11(i8* %s, i32* %type)
  ret i32 %4

func_CheckOffsetParameterName.20:                 ; preds = %ctrl2
  %5 = call i32 @CheckOffsetParameterName.20(i8* %s, i32* %type)
  ret i32 %5
...
func_CheckOffsetParameterName.28:                 ; preds = %ctrl5
  %8 = call i32 @CheckOffsetParameterName.28(i8* %s, i32* %type)
  ret i32 %8
...
ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_CheckOffsetParameterName.5, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_CheckOffsetParameterName.11, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_CheckOffsetParameterName.20, label %ctrl3
...
ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_CheckOffsetParameterName.24, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_CheckOffsetParameterName.28, label %func_CheckOffsetParameterName.30
}
...
ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_ParseQOffsetMatrix.13, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_ParseQOffsetMatrix.14, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_ParseQOffsetMatrix.16, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_ParseQOffsetMatrix.18, label %func_ParseQOffsetMatrix.19
}
...
func_CalculateOffsetParam.2:                      ; preds = %ctrl0
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_CalculateOffsetParam.2, label %ctrl1
...
ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_CalculateOffsetParam.27, label %func_CalculateOffsetParam.29
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_CalculateOffset8Param.6, label %ctrl0

func_CalculateOffset8Param.6:                     ; preds = %rand_bb
...
func_CalculateOffset8Param.12:                    ; preds = %ctrl1
  call void @CalculateOffset8Param.12()
  ret void

func_CalculateOffset8Param.15:                    ; preds = %ctrl2
...
func_CalculateOffset8Param.22:                    ; preds = %ctrl4
  call void @CalculateOffset8Param.22()
  ret void
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_CalculateOffset8Param.12, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_CalculateOffset8Param.15, label %ctrl3
...
ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_CalculateOffset8Param.22, label %ctrl5
...
entry:
  ...
  %canary = alloca i32
  store i32 1053360443, i32* %canary
...
if.end225:                                        ; preds = %for.end224, %for.end102
  ...
  %133 = icmp eq i32 %132, 1053360443
...
entry:
  ...
  %temp = alloca i32, align 4
  %canary = alloca i32
  store i32 136242108, i32* %canary
  %qp_per = alloca i32, align 4
  %j = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %OffsetMatrixPresentFlag = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 147
...
entry:
  ...
  %canary = alloca i32
  store i32 310524208, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1928055746, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @CheckOffsetParameterName.5(i8* %s, i32* %type) #0 {
entry:
  %retval = alloca i32, align 4
  %s.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1731636477, i32* %canary
  %type.addr = alloca i32*, align 8
  %i = alloca i32, align 4
  store i8* %s, i8** %s.addr, align 8
  store i32* %type, i32** %type.addr, align 8
...
entry:
  ...
  %k = alloca i32, align 4
  %canary = alloca i32
  store i32 233456071, i32* %canary
  %temp = alloca i32, align 4
  %j = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %OffsetMatrixPresentFlag = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 147
...
entry:
  %temp = alloca i32, align 4
  %canary = alloca i32
  store i32 1786057819, i32* %canary
  %j = alloca i32, align 4
  %k = alloca i32, align 4
  %qp_per = alloca i32, align 4
  %i = alloca i32, align 4
...
if.end225:                                        ; preds = %for.end224, %for.end102
  %132 = load i32, i32* %canary
  %133 = icmp eq i32 %132, 1786057819
  br i1 %133, label %134, label %func_exit
...
entry:
  %items = alloca [1000 x i8*], align 16
  %canary = alloca i32
  store i32 1211919443, i32* %canary
  %IntContent = alloca i32, align 4
  %cnt = alloca i32, align 4
  %InItem = alloca i32, align 4
  %item = alloca i32, align 4
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1395669626, i32* %canary
  %q_bits = alloca i32, align 4
  %k = alloca i32, align 4
  %j = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
entry:
  ...
  %OffsetList = alloca i16*, align 8
  %canary = alloca i32
  store i32 2028869126, i32* %canary
  %p = alloca i8*, align 8
  %MapIdx = alloca i32, align 4
  %type = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
...
entry:
  %s.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1380020240, i32* %canary
  %type.addr = alloca i32*, align 8
  %retval = alloca i32, align 4
  %i = alloca i32, align 4
  store i8* %s, i8** %s.addr, align 8
...
entry:
  ...
  %k = alloca i32, align 4
  %canary = alloca i32
  store i32 803770650, i32* %canary
  %q_bits = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %OffsetMatrixPresentFlag = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 147
  %1 = load i32, i32* %OffsetMatrixPresentFlag, align 8
...
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1228024079, i32* %canary
  %p = alloca i8*, align 8
  %range = alloca i32, align 4
  %items = alloca [1000 x i8*], align 16
  %IntContent = alloca i32, align 4
...
entry:
  ...
  %IntContent = alloca i32, align 4
  %canary = alloca i32
  store i32 412805320, i32* %canary
  %bufsize.addr = alloca i32, align 4
  %p = alloca i8*, align 8
  %range = alloca i32, align 4
  %type = alloca i32, align 4
...
entry:
  %q_bits = alloca i32, align 4
  %canary = alloca i32
  store i32 441240335, i32* %canary
  %k = alloca i32, align 4
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %temp = alloca i32, align 4
...
entry:
  %item = alloca i32, align 4
  %canary = alloca i32
  store i32 1488061436, i32* %canary
  %OffsetList = alloca i16*, align 8
  %buf.addr = alloca i8*, align 8
  %IntContent = alloca i32, align 4
  %bufsize.addr = alloca i32, align 4
...
entry:
  ...
  %item = alloca i32, align 4
  %canary = alloca i32
  store i32 1436214574, i32* %canary
  %MapIdx = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %j = alloca i32, align 4
  %bufsize.addr = alloca i32, align 4
...
entry:
  ...
  %buf.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 885025339, i32* %canary
  %bufend = alloca i8*, align 8
  %MapIdx = alloca i32, align 4
  %range = alloca i32, align 4
  %OffsetList = alloca i16*, align 8
...
entry:
  %canary = alloca i32
  store i32 1187659595, i32* %canary
  %s.addr = alloca i8*, align 8
  %i = alloca i32, align 4
  %retval = alloca i32, align 4
  %type.addr = alloca i32*, align 8
...
entry:
  ...
  %temp = alloca i32, align 4
  %canary = alloca i32
  store i32 1300138729, i32* %canary
  %j = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %OffsetMatrixPresentFlag = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 147
  %1 = load i32, i32* %OffsetMatrixPresentFlag, align 8
...
if.end225:                                        ; preds = %for.end224, %for.end102
  %132 = load i32, i32* %canary
  %133 = icmp eq i32 %132, 1300138729
  br i1 %133, label %134, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @CalculateOffset8Param.22() #0 {
entry:
  %canary = alloca i32
  store i32 1933845480, i32* %canary
  %k = alloca i32, align 4
  %temp = alloca i32, align 4
  %q_bits = alloca i32, align 4
  %i = alloca i32, align 4
...
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 2092650239, i32* %canary
  %type.addr = alloca i32*, align 8
  %s.addr = alloca i8*, align 8
  %retval = alloca i32, align 4
  store i8* %s, i8** %s.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 2051171769, i32* %canary
  %s.addr = alloca i8*, align 8
  %retval = alloca i32, align 4
  %i = alloca i32, align 4
  %type.addr = alloca i32*, align 8
...
entry:
  ...
  %temp = alloca i32, align 4
  %canary = alloca i32
  store i32 517235160, i32* %canary
  %i = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %OffsetMatrixPresentFlag = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 147
  %1 = load i32, i32* %OffsetMatrixPresentFlag, align 8
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 2068630387, i32* %canary
  %temp = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %OffsetMatrixPresentFlag = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 147
  %1 = load i32, i32* %OffsetMatrixPresentFlag, align 8
...
if.end225:                                        ; preds = %for.end224, %for.end102
  %132 = load i32, i32* %canary
  %133 = icmp eq i32 %132, 2068630387
  br i1 %133, label %134, label %func_exit
...
entry:
  ...
  %temp = alloca i32, align 4
  %canary = alloca i32
  store i32 1839141029, i32* %canary
  %i = alloca i32, align 4
  %k = alloca i32, align 4
  %j = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
if.end225:                                        ; preds = %for.end224, %for.end102
  %132 = load i32, i32* %canary
  %133 = icmp eq i32 %132, 1839141029
  br i1 %133, label %134, label %func_exit
...
entry:
  %canary = alloca i32
  store i32 1811155008, i32* %canary
  %retval = alloca i32, align 4
  %i = alloca i32, align 4
  %s.addr = alloca i8*, align 8
  %type.addr = alloca i32*, align 8
...
entry:
  %k = alloca i32, align 4
  %canary = alloca i32
  store i32 1716196543, i32* %canary
  %j = alloca i32, align 4
  %qp_per = alloca i32, align 4
  %temp = alloca i32, align 4
  %i = alloca i32, align 4
...
if.end225:                                        ; preds = %for.end224, %for.end102
  %132 = load i32, i32* %canary
  %133 = icmp eq i32 %132, 1716196543
  br i1 %133, label %134, label %func_exit
...
entry:
  ...
  %s.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 163314269, i32* %canary
  %i = alloca i32, align 4
  store i8* %s, i8** %s.addr, align 8
  store i32* %type, i32** %type.addr, align 8
  store i32 0, i32* %i, align 4
...
entry:
  ...
  %q_bits = alloca i32, align 4
  %canary = alloca i32
  store i32 750531440, i32* %canary
  %j = alloca i32, align 4
  %i = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %OffsetMatrixPresentFlag = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 147
...
entry:
  %canary = alloca i32
  store i32 848137068, i32* %canary
  %q_bits = alloca i32, align 4
  %j = alloca i32, align 4
  %i = alloca i32, align 4
  %k = alloca i32, align 4
