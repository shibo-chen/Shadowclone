...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_GenerateParameterSets.1, label %func_GenerateParameterSets.7

func_GenerateParameterSets.1:                     ; preds = %rand_bb
  call void @GenerateParameterSets.1()
  ret void

func_GenerateParameterSets.7:                     ; preds = %rand_bb
  call void @GenerateParameterSets.7()
  ret void
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_GenerateSequenceParameterSet.8, label %ctrl0

func_GenerateSequenceParameterSet.8:              ; preds = %rand_bb
  call void @GenerateSequenceParameterSet.8(%struct.seq_parameter_set_rbsp_t* %sps, i32 %SPS_id)
  ret void

func_GenerateSequenceParameterSet.9:              ; preds = %ctrl0
  call void @GenerateSequenceParameterSet.9(%struct.seq_parameter_set_rbsp_t* %sps, i32 %SPS_id)
  ret void

func_GenerateSequenceParameterSet.10:             ; preds = %ctrl1
  call void @GenerateSequenceParameterSet.10(%struct.seq_parameter_set_rbsp_t* %sps, i32 %SPS_id)
  ret void

func_GenerateSequenceParameterSet.16:             ; preds = %ctrl1
  call void @GenerateSequenceParameterSet.16(%struct.seq_parameter_set_rbsp_t* %sps, i32 %SPS_id)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_GenerateSequenceParameterSet.9, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_GenerateSequenceParameterSet.10, label %func_GenerateSequenceParameterSet.16
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_GeneratePictureParameterSet.12, label %ctrl0

func_GeneratePictureParameterSet.12:              ; preds = %rand_bb
  call void @GeneratePictureParameterSet.12(%struct.pic_parameter_set_rbsp_t* %pps, %struct.seq_parameter_set_rbsp_t* %sps, i32 %PPS_id, i32 %WeightedPrediction, i32 %WeightedBiprediction, i32 %cb_qp_index_offset, i32 %cr_qp_index_offset)
  ret void

func_GeneratePictureParameterSet.15:              ; preds = %ctrl0
  call void @GeneratePictureParameterSet.15(%struct.pic_parameter_set_rbsp_t* %pps, %struct.seq_parameter_set_rbsp_t* %sps, i32 %PPS_id, i32 %WeightedPrediction, i32 %WeightedBiprediction, i32 %cb_qp_index_offset, i32 %cr_qp_index_offset)
  ret void

func_GeneratePictureParameterSet.18:              ; preds = %ctrl1
  call void @GeneratePictureParameterSet.18(%struct.pic_parameter_set_rbsp_t* %pps, %struct.seq_parameter_set_rbsp_t* %sps, i32 %PPS_id, i32 %WeightedPrediction, i32 %WeightedBiprediction, i32 %cb_qp_index_offset, i32 %cr_qp_index_offset)
  ret void

func_GeneratePictureParameterSet.23:              ; preds = %ctrl1
  call void @GeneratePictureParameterSet.23(%struct.pic_parameter_set_rbsp_t* %pps, %struct.seq_parameter_set_rbsp_t* %sps, i32 %PPS_id, i32 %WeightedPrediction, i32 %WeightedBiprediction, i32 %cb_qp_index_offset, i32 %cr_qp_index_offset)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_GeneratePictureParameterSet.15, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_GeneratePictureParameterSet.18, label %func_GeneratePictureParameterSet.23
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_GenerateSeq_parameter_set_NALU.5, label %ctrl0

func_GenerateSeq_parameter_set_NALU.5:            ; preds = %rand_bb
  %2 = call %struct.NALU_t* @GenerateSeq_parameter_set_NALU.5()
  ret %struct.NALU_t* %2

func_GenerateSeq_parameter_set_NALU.17:           ; preds = %ctrl0
  %3 = call %struct.NALU_t* @GenerateSeq_parameter_set_NALU.17()
  ret %struct.NALU_t* %3

func_GenerateSeq_parameter_set_NALU.25:           ; preds = %ctrl1
  %4 = call %struct.NALU_t* @GenerateSeq_parameter_set_NALU.25()
  ret %struct.NALU_t* %4

func_GenerateSeq_parameter_set_NALU.30:           ; preds = %ctrl1
  %5 = call %struct.NALU_t* @GenerateSeq_parameter_set_NALU.30()
  ret %struct.NALU_t* %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_GenerateSeq_parameter_set_NALU.17, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_GenerateSeq_parameter_set_NALU.25, label %func_GenerateSeq_parameter_set_NALU.30
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_GenerateSeq_parameter_set_rbsp.6, label %ctrl0

func_GenerateSeq_parameter_set_rbsp.6:            ; preds = %rand_bb
  %2 = call i32 @GenerateSeq_parameter_set_rbsp.6(%struct.seq_parameter_set_rbsp_t* %sps, i8* %rbsp)
  ret i32 %2

func_GenerateSeq_parameter_set_rbsp.13:           ; preds = %ctrl0
  %3 = call i32 @GenerateSeq_parameter_set_rbsp.13(%struct.seq_parameter_set_rbsp_t* %sps, i8* %rbsp)
  ret i32 %3

func_GenerateSeq_parameter_set_rbsp.27:           ; preds = %ctrl1
  %4 = call i32 @GenerateSeq_parameter_set_rbsp.27(%struct.seq_parameter_set_rbsp_t* %sps, i8* %rbsp)
  ret i32 %4

func_GenerateSeq_parameter_set_rbsp.28:           ; preds = %ctrl1
  %5 = call i32 @GenerateSeq_parameter_set_rbsp.28(%struct.seq_parameter_set_rbsp_t* %sps, i8* %rbsp)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_GenerateSeq_parameter_set_rbsp.13, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_GenerateSeq_parameter_set_rbsp.27, label %func_GenerateSeq_parameter_set_rbsp.28
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_GeneratePic_parameter_set_NALU.3, label %ctrl0

func_GeneratePic_parameter_set_NALU.3:            ; preds = %rand_bb
  %2 = call %struct.NALU_t* @GeneratePic_parameter_set_NALU.3(i32 %PPS_id)
  ret %struct.NALU_t* %2

func_GeneratePic_parameter_set_NALU.20:           ; preds = %ctrl0
  %3 = call %struct.NALU_t* @GeneratePic_parameter_set_NALU.20(i32 %PPS_id)
  ret %struct.NALU_t* %3

func_GeneratePic_parameter_set_NALU.24:           ; preds = %ctrl1
  %4 = call %struct.NALU_t* @GeneratePic_parameter_set_NALU.24(i32 %PPS_id)
  ret %struct.NALU_t* %4

func_GeneratePic_parameter_set_NALU.29:           ; preds = %ctrl1
  %5 = call %struct.NALU_t* @GeneratePic_parameter_set_NALU.29(i32 %PPS_id)
  ret %struct.NALU_t* %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_GeneratePic_parameter_set_NALU.20, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_GeneratePic_parameter_set_NALU.24, label %func_GeneratePic_parameter_set_NALU.29
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_GeneratePic_parameter_set_rbsp.2, label %ctrl0

func_GeneratePic_parameter_set_rbsp.2:            ; preds = %rand_bb
  %2 = call i32 @GeneratePic_parameter_set_rbsp.2(%struct.pic_parameter_set_rbsp_t* %pps, i8* %rbsp)
  ret i32 %2

func_GeneratePic_parameter_set_rbsp.4:            ; preds = %ctrl0
  %3 = call i32 @GeneratePic_parameter_set_rbsp.4(%struct.pic_parameter_set_rbsp_t* %pps, i8* %rbsp)
  ret i32 %3

func_GeneratePic_parameter_set_rbsp.31:           ; preds = %ctrl1
  %4 = call i32 @GeneratePic_parameter_set_rbsp.31(%struct.pic_parameter_set_rbsp_t* %pps, i8* %rbsp)
  ret i32 %4

func_GeneratePic_parameter_set_rbsp.32:           ; preds = %ctrl1
  %5 = call i32 @GeneratePic_parameter_set_rbsp.32(%struct.pic_parameter_set_rbsp_t* %pps, i8* %rbsp)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_GeneratePic_parameter_set_rbsp.4, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_GeneratePic_parameter_set_rbsp.31, label %func_GeneratePic_parameter_set_rbsp.32
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_Scaling_List.11, label %ctrl0

func_Scaling_List.11:                             ; preds = %rand_bb
  %2 = call i32 @Scaling_List.11(i16* %scalingListinput, i16* %scalingList, i32 %sizeOfScalingList, i16* %UseDefaultScalingMatrix, %struct.datapartition* %partition)
  ret i32 %2

func_Scaling_List.19:                             ; preds = %ctrl0
  %3 = call i32 @Scaling_List.19(i16* %scalingListinput, i16* %scalingList, i32 %sizeOfScalingList, i16* %UseDefaultScalingMatrix, %struct.datapartition* %partition)
  ret i32 %3

func_Scaling_List.22:                             ; preds = %ctrl1
  %4 = call i32 @Scaling_List.22(i16* %scalingListinput, i16* %scalingList, i32 %sizeOfScalingList, i16* %UseDefaultScalingMatrix, %struct.datapartition* %partition)
  ret i32 %4

func_Scaling_List.26:                             ; preds = %ctrl1
  %5 = call i32 @Scaling_List.26(i16* %scalingListinput, i16* %scalingList, i32 %sizeOfScalingList, i16* %UseDefaultScalingMatrix, %struct.datapartition* %partition)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_Scaling_List.19, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_Scaling_List.22, label %func_Scaling_List.26
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_GenerateVUISequenceParameters.14, label %func_GenerateVUISequenceParameters.21

func_GenerateVUISequenceParameters.14:            ; preds = %rand_bb
  %2 = call i32 @GenerateVUISequenceParameters.14(%struct.datapartition* %partition)
  ret i32 %2

func_GenerateVUISequenceParameters.21:            ; preds = %rand_bb
  %3 = call i32 @GenerateVUISequenceParameters.21(%struct.datapartition* %partition)
  ret i32 %3
}
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @GenerateParameterSets.1() #0 {
entry:
  %canary = alloca i32
  store i32 1181690902, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @GeneratePic_parameter_set_rbsp.2(%struct.pic_parameter_set_rbsp_t* %pps, i8* %rbsp) #0 {
entry:
  %LenInBytes = alloca i32, align 4
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %profile_idc = alloca i32, align 4
  %canary = alloca i32
  store i32 1693628315, i32* %canary
  ...
  %call = call noalias i8* @calloc(i64 1, i64 120) #5
...
if.end:                                           ; preds = %if.then, %entry
  %call1 = call noalias i8* @calloc(i64 1, i64 48) #5
...
if.end201:                                        ; preds = %if.end198, %lor.lhs.false143
  ...
  %202 = icmp eq i32 %201, 1693628315
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct.NALU_t* @GeneratePic_parameter_set_NALU.3(i32 %PPS_id) #0 {
entry:
  %canary = alloca i32
  store i32 708198008, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @GeneratePic_parameter_set_rbsp.4(%struct.pic_parameter_set_rbsp_t* %pps, i8* %rbsp) #0 {
entry:
  %partition = alloca %struct.datapartition*, align 8
  %NumberBitsPerSliceGroupId = alloca i32, align 4
  %rbsp.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 726774782, i32* %canary
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %LenInBytes = alloca i32, align 4
  %len = alloca i32, align 4
  %profile_idc = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct.NALU_t* @GenerateSeq_parameter_set_NALU.5() #0 {
entry:
  %NALUlen = alloca i32, align 4
  %n = alloca %struct.NALU_t*, align 8
  %canary = alloca i32
  store i32 1757989516, i32* %canary
  %rbsp = alloca [64000 x i8], align 16
  %RBSPlen = alloca i32, align 4
  %call = call %struct.NALU_t* (i32, ...) bitcast (%struct.NALU_t* (...)* @AllocNALU to %struct.NALU_t* (i32, ...)*)(i32 64000)
  store %struct.NALU_t* %call, %struct.NALU_t** %n, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @GenerateSeq_parameter_set_rbsp.6(%struct.seq_parameter_set_rbsp_t* %sps, i8* %rbsp) #0 {
entry:
  %len = alloca i32, align 4
  %rbsp.addr = alloca i8*, align 8
  %i = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
  %canary = alloca i32
  store i32 1533746046, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @GenerateParameterSets.7() #0 {
entry:
  %pps = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %canary = alloca i32
  store i32 1703017928, i32* %canary
  %sps = alloca %struct.seq_parameter_set_rbsp_t*, align 8
  store %struct.seq_parameter_set_rbsp_t* null, %struct.seq_parameter_set_rbsp_t** %sps, align 8
  store %struct.pic_parameter_set_rbsp_t* null, %struct.pic_parameter_set_rbsp_t** %pps, align 8
  %call = call %struct.seq_parameter_set_rbsp_t* (...) @AllocSPS()
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1717643222, i32* %canary
...
if.end137:                                        ; preds = %if.else135, %if.end134
  ...
  %163 = icmp eq i32 %162, 1717643222
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @GenerateSequenceParameterSet.9(%struct.seq_parameter_set_rbsp_t* %sps, i32 %SPS_id) #0 {
entry:
  %SubWidthC = alloca [4 x i32], align 16
  %SPS_id.addr = alloca i32, align 4
  %PicWidthInMbs = alloca i32, align 4
  ...
  %width = alloca i32, align 4
  %canary = alloca i32
  store i32 1828320656, i32* %canary
  %height = alloca i32, align 4
  %FrameHeightInMbs = alloca i32, align 4
  store %struct.seq_parameter_set_rbsp_t* %sps, %struct.seq_parameter_set_rbsp_t** %sps.addr, align 8
  store i32 %SPS_id, i32* %SPS_id.addr, align 4
...
if.end137:                                        ; preds = %if.else135, %if.end134
  %162 = load i32, i32* %canary
  %163 = icmp eq i32 %162, 1828320656
  br i1 %163, label %164, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @GenerateSequenceParameterSet.10(%struct.seq_parameter_set_rbsp_t* %sps, i32 %SPS_id) #0 {
entry:
  %canary = alloca i32
  store i32 620357524, i32* %canary
  %SubHeightC = alloca [4 x i32], align 16
  %frext_profile = alloca i32, align 4
  %PicWidthInMbs = alloca i32, align 4
  %SubWidthC = alloca [4 x i32], align 16
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @Scaling_List.11(i16* %scalingListinput, i16* %scalingList, i32 %sizeOfScalingList, i16* %UseDefaultScalingMatrix, %struct.datapartition* %partition) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 1789646716, i32* %canary
  %len = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @GeneratePictureParameterSet.12(%struct.pic_parameter_set_rbsp_t* %pps, %struct.seq_parameter_set_rbsp_t* %sps, i32 %PPS_id, i32 %WeightedPrediction, i32 %WeightedBiprediction, i32 %cb_qp_index_offset, i32 %cr_qp_index_offset) #0 {
entry:
  %sps.addr = alloca %struct.seq_parameter_set_rbsp_t*, align 8
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 2072701312, i32* %canary
...
if.end139:                                        ; preds = %if.else135, %if.then132
  ...
  %152 = icmp eq i32 %151, 2072701312
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @GenerateSeq_parameter_set_rbsp.13(%struct.seq_parameter_set_rbsp_t* %sps, i8* %rbsp) #0 {
entry:
  %sps.addr = alloca %struct.seq_parameter_set_rbsp_t*, align 8
  %partition = alloca %struct.datapartition*, align 8
  %LenInBytes = alloca i32, align 4
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 957976123, i32* %canary
  %len = alloca i32, align 4
  %rbsp.addr = alloca i8*, align 8
  store %struct.seq_parameter_set_rbsp_t* %sps, %struct.seq_parameter_set_rbsp_t** %sps.addr, align 8
  store i8* %rbsp, i8** %rbsp.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @GenerateVUISequenceParameters.14(%struct.datapartition* %partition) #0 {
entry:
  %canary = alloca i32
  store i32 477938812, i32* %canary
  %len = alloca i32, align 4
  %partition.addr = alloca %struct.datapartition*, align 8
  store %struct.datapartition* %partition, %struct.datapartition** %partition.addr, align 8
  store i32 0, i32* %len, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @GeneratePictureParameterSet.15(%struct.pic_parameter_set_rbsp_t* %pps, %struct.seq_parameter_set_rbsp_t* %sps, i32 %PPS_id, i32 %WeightedPrediction, i32 %WeightedBiprediction, i32 %cb_qp_index_offset, i32 %cr_qp_index_offset) #0 {
entry:
  %sps.addr = alloca %struct.seq_parameter_set_rbsp_t*, align 8
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %WeightedPrediction.addr = alloca i32, align 4
  ...
  %WeightedBiprediction.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1524007362, i32* %canary
  %PPS_id.addr = alloca i32, align 4
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
  store %struct.seq_parameter_set_rbsp_t* %sps, %struct.seq_parameter_set_rbsp_t** %sps.addr, align 8
  store i32 %PPS_id, i32* %PPS_id.addr, align 4
...
if.end139:                                        ; preds = %if.else135, %if.then132
  ...
  store i32 0, i32* %redundant_pic_cnt_present_flag, align 4
  %151 = load i32, i32* %canary
  %152 = icmp eq i32 %151, 1524007362
  br i1 %152, label %153, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @GenerateSequenceParameterSet.16(%struct.seq_parameter_set_rbsp_t* %sps, i32 %SPS_id) #0 {
entry:
  %SubHeightC = alloca [4 x i32], align 16
  %frext_profile = alloca i32, align 4
  %PicHeightInMapUnits = alloca i32, align 4
  %canary = alloca i32
  store i32 1260061492, i32* %canary
  %SubWidthC = alloca [4 x i32], align 16
  %width = alloca i32, align 4
  %i = alloca i32, align 4
  %height = alloca i32, align 4
...
if.end137:                                        ; preds = %if.else135, %if.end134
  %162 = load i32, i32* %canary
  %163 = icmp eq i32 %162, 1260061492
  br i1 %163, label %164, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct.NALU_t* @GenerateSeq_parameter_set_NALU.17() #0 {
entry:
  %rbsp = alloca [64000 x i8], align 16
  %NALUlen = alloca i32, align 4
  %canary = alloca i32
  store i32 1130944554, i32* %canary
  %RBSPlen = alloca i32, align 4
  %n = alloca %struct.NALU_t*, align 8
  %call = call %struct.NALU_t* (i32, ...) bitcast (%struct.NALU_t* (...)* @AllocNALU to %struct.NALU_t* (i32, ...)*)(i32 64000)
  store %struct.NALU_t* %call, %struct.NALU_t** %n, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @GeneratePictureParameterSet.18(%struct.pic_parameter_set_rbsp_t* %pps, %struct.seq_parameter_set_rbsp_t* %sps, i32 %PPS_id, i32 %WeightedPrediction, i32 %WeightedBiprediction, i32 %cb_qp_index_offset, i32 %cr_qp_index_offset) #0 {
entry:
  %WeightedPrediction.addr = alloca i32, align 4
  %PPS_id.addr = alloca i32, align 4
  %WeightedBiprediction.addr = alloca i32, align 4
  ...
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %canary = alloca i32
  store i32 461436062, i32* %canary
  %frext_profile = alloca i32, align 4
  %cr_qp_index_offset.addr = alloca i32, align 4
  %sps.addr = alloca %struct.seq_parameter_set_rbsp_t*, align 8
  %cb_qp_index_offset.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @Scaling_List.19(i16* %scalingListinput, i16* %scalingList, i32 %sizeOfScalingList, i16* %UseDefaultScalingMatrix, %struct.datapartition* %partition) #0 {
entry:
  %j = alloca i32, align 4
  %delta_scale = alloca i32, align 4
  %len = alloca i32, align 4
  ...
  %nextScale = alloca i32, align 4
  %canary = alloca i32
  store i32 216750054, i32* %canary
  %lastScale = alloca i32, align 4
  store i16* %scalingListinput, i16** %scalingListinput.addr, align 8
  store i16* %scalingList, i16** %scalingList.addr, align 8
  store i32 %sizeOfScalingList, i32* %sizeOfScalingList.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct.NALU_t* @GeneratePic_parameter_set_NALU.20(i32 %PPS_id) #0 {
entry:
  %rbsp = alloca [64000 x i8], align 16
  %canary = alloca i32
  store i32 1013428079, i32* %canary
  %n = alloca %struct.NALU_t*, align 8
  %PPS_id.addr = alloca i32, align 4
  %NALUlen = alloca i32, align 4
  %RBSPlen = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @GenerateVUISequenceParameters.21(%struct.datapartition* %partition) #0 {
entry:
  %canary = alloca i32
  store i32 1568346319, i32* %canary
  %partition.addr = alloca %struct.datapartition*, align 8
  %len = alloca i32, align 4
  store %struct.datapartition* %partition, %struct.datapartition** %partition.addr, align 8
  store i32 0, i32* %len, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @Scaling_List.22(i16* %scalingListinput, i16* %scalingList, i32 %sizeOfScalingList, i16* %UseDefaultScalingMatrix, %struct.datapartition* %partition) #0 {
entry:
  %j = alloca i32, align 4
  %UseDefaultScalingMatrix.addr = alloca i16*, align 8
  %scanj = alloca i32, align 4
  %lastScale = alloca i32, align 4
  %canary = alloca i32
  store i32 888185607, i32* %canary
  %scalingList.addr = alloca i16*, align 8
  %partition.addr = alloca %struct.datapartition*, align 8
  %scalingListinput.addr = alloca i16*, align 8
  %nextScale = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @GeneratePictureParameterSet.23(%struct.pic_parameter_set_rbsp_t* %pps, %struct.seq_parameter_set_rbsp_t* %sps, i32 %PPS_id, i32 %WeightedPrediction, i32 %WeightedBiprediction, i32 %cb_qp_index_offset, i32 %cr_qp_index_offset) #0 {
entry:
  %i = alloca i32, align 4
  %sps.addr = alloca %struct.seq_parameter_set_rbsp_t*, align 8
  %PPS_id.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 132145498, i32* %canary
  %WeightedBiprediction.addr = alloca i32, align 4
  %cb_qp_index_offset.addr = alloca i32, align 4
  %frext_profile = alloca i32, align 4
  %WeightedPrediction.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct.NALU_t* @GeneratePic_parameter_set_NALU.24(i32 %PPS_id) #0 {
entry:
  %PPS_id.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 741582878, i32* %canary
  %n = alloca %struct.NALU_t*, align 8
  %RBSPlen = alloca i32, align 4
  %NALUlen = alloca i32, align 4
  %rbsp = alloca [64000 x i8], align 16
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct.NALU_t* @GenerateSeq_parameter_set_NALU.25() #0 {
entry:
  %RBSPlen = alloca i32, align 4
  %rbsp = alloca [64000 x i8], align 16
  %canary = alloca i32
  store i32 1676517706, i32* %canary
  %NALUlen = alloca i32, align 4
  %n = alloca %struct.NALU_t*, align 8
  %call = call %struct.NALU_t* (i32, ...) bitcast (%struct.NALU_t* (...)* @AllocNALU to %struct.NALU_t* (i32, ...)*)(i32 64000)
  store %struct.NALU_t* %call, %struct.NALU_t** %n, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @Scaling_List.26(i16* %scalingListinput, i16* %scalingList, i32 %sizeOfScalingList, i16* %UseDefaultScalingMatrix, %struct.datapartition* %partition) #0 {
entry:
  %canary = alloca i32
  store i32 1236339732, i32* %canary
  %lastScale = alloca i32, align 4
  %UseDefaultScalingMatrix.addr = alloca i16*, align 8
  %sizeOfScalingList.addr = alloca i32, align 4
  %scanj = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @GenerateSeq_parameter_set_rbsp.27(%struct.seq_parameter_set_rbsp_t* %sps, i8* %rbsp) #0 {
entry:
  %LenInBytes = alloca i32, align 4
  %i = alloca i32, align 4
  %sps.addr = alloca %struct.seq_parameter_set_rbsp_t*, align 8
  %canary = alloca i32
  store i32 2076470773, i32* %canary
  %partition = alloca %struct.datapartition*, align 8
  %len = alloca i32, align 4
  %rbsp.addr = alloca i8*, align 8
  store %struct.seq_parameter_set_rbsp_t* %sps, %struct.seq_parameter_set_rbsp_t** %sps.addr, align 8
...
if.end158:                                        ; preds = %if.then155, %if.end150
  ...
  %206 = load i32, i32* %LenInBytes, align 4
  %207 = load i32, i32* %canary
  %208 = icmp eq i32 %207, 2076470773
  br i1 %208, label %209, label %func_exit
...
entry:
  ...
  %LenInBytes = alloca i32, align 4
  %canary = alloca i32
  store i32 517031827, i32* %canary
  %rbsp.addr = alloca i8*, align 8
  %i = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
  store %struct.seq_parameter_set_rbsp_t* %sps, %struct.seq_parameter_set_rbsp_t** %sps.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct.NALU_t* @GeneratePic_parameter_set_NALU.29(i32 %PPS_id) #0 {
entry:
  %canary = alloca i32
  store i32 1157240511, i32* %canary
  %RBSPlen = alloca i32, align 4
  %NALUlen = alloca i32, align 4
  %n = alloca %struct.NALU_t*, align 8
  %PPS_id.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct.NALU_t* @GenerateSeq_parameter_set_NALU.30() #0 {
entry:
  %rbsp = alloca [64000 x i8], align 16
  %NALUlen = alloca i32, align 4
  %canary = alloca i32
  store i32 971852508, i32* %canary
  %n = alloca %struct.NALU_t*, align 8
  %RBSPlen = alloca i32, align 4
  %call = call %struct.NALU_t* (i32, ...) bitcast (%struct.NALU_t* (...)* @AllocNALU to %struct.NALU_t* (i32, ...)*)(i32 64000)
  store %struct.NALU_t* %call, %struct.NALU_t** %n, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @GeneratePic_parameter_set_rbsp.31(%struct.pic_parameter_set_rbsp_t* %pps, i8* %rbsp) #0 {
entry:
  %rbsp.addr = alloca i8*, align 8
  %NumberBitsPerSliceGroupId = alloca i32, align 4
  %canary = alloca i32
  store i32 1106766192, i32* %canary
  %len = alloca i32, align 4
  %profile_idc = alloca i32, align 4
  %i = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
...
if.end201:                                        ; preds = %if.end198, %lor.lhs.false143
  ...
  %200 = load i32, i32* %LenInBytes, align 4
  %201 = load i32, i32* %canary
  %202 = icmp eq i32 %201, 1106766192
  br i1 %202, label %203, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @GeneratePic_parameter_set_rbsp.32(%struct.pic_parameter_set_rbsp_t* %pps, i8* %rbsp) #0 {
entry:
  %LenInBytes = alloca i32, align 4
  %profile_idc = alloca i32, align 4
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1392754876, i32* %canary
  %rbsp.addr = alloca i8*, align 8
  %NumberBitsPerSliceGroupId = alloca i32, align 4
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %partition = alloca %struct.datapartition*, align 8
...
if.end201:                                        ; preds = %if.end198, %lor.lhs.false143
  ...
  %200 = load i32, i32* %LenInBytes, align 4
  %201 = load i32, i32* %canary
  %202 = icmp eq i32 %201, 1392754876
  br i1 %202, label %203, label %func_exit
