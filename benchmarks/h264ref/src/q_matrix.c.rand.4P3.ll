; ModuleID = 'q_matrix.c.rand.4P3.bc'
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_CheckParameterName.8, label %ctrl0

func_CheckParameterName.8:                        ; preds = %rand_bb
  %2 = call i32 @CheckParameterName.8(i8* %s, i32* %type)
  ret i32 %2

func_CheckParameterName.17:                       ; preds = %ctrl0
  %3 = call i32 @CheckParameterName.17(i8* %s, i32* %type)
  ret i32 %3

func_CheckParameterName.18:                       ; preds = %ctrl1
  %4 = call i32 @CheckParameterName.18(i8* %s, i32* %type)
  ret i32 %4

func_CheckParameterName.20:                       ; preds = %ctrl1
  %5 = call i32 @CheckParameterName.20(i8* %s, i32* %type)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_CheckParameterName.17, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_CheckParameterName.18, label %func_CheckParameterName.20
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_ParseMatrix.7, label %ctrl0

func_ParseMatrix.7:                               ; preds = %rand_bb
  call void @ParseMatrix.7(i8* %buf, i32 %bufsize)
  ret void

func_ParseMatrix.12:                              ; preds = %ctrl0
  call void @ParseMatrix.12(i8* %buf, i32 %bufsize)
  ret void

func_ParseMatrix.13:                              ; preds = %ctrl1
  call void @ParseMatrix.13(i8* %buf, i32 %bufsize)
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_ParseMatrix.12, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_ParseMatrix.13, label %func_ParseMatrix.16
}
...
func_PatchMatrix.6:                               ; preds = %ctrl0
  call void @PatchMatrix.6()
  ret void
...
func_PatchMatrix.15:                              ; preds = %ctrl1
  call void @PatchMatrix.15()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_PatchMatrix.6, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_PatchMatrix.11, label %func_PatchMatrix.15
}
...
func_CalculateQuantParam.3:                       ; preds = %ctrl0
  call void @CalculateQuantParam.3()
  ret void

func_CalculateQuantParam.5:                       ; preds = %ctrl1
  call void @CalculateQuantParam.5()
  ret void

func_CalculateQuantParam.10:                      ; preds = %ctrl1
  call void @CalculateQuantParam.10()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_CalculateQuantParam.3, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_CalculateQuantParam.5, label %func_CalculateQuantParam.10
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_CalculateQuant8Param.4, label %ctrl0

func_CalculateQuant8Param.4:                      ; preds = %rand_bb
  call void @CalculateQuant8Param.4()
  ret void

func_CalculateQuant8Param.9:                      ; preds = %ctrl0
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_CalculateQuant8Param.9, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_CalculateQuant8Param.14, label %func_CalculateQuant8Param.19
}
...
entry:
  ...
  %canary = alloca i32
  store i32 1574359857, i32* %canary
...
if.end682:                                        ; preds = %for.end681, %for.end200
  ...
  %360 = icmp eq i32 %359, 1574359857
...
entry:
  %canary = alloca i32
  store i32 973706733, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @CalculateQuantParam.3() #0 {
entry:
  %i = alloca i32, align 4
  %no_q_matrix = alloca i32, align 4
  %k = alloca i32, align 4
  %canary = alloca i32
  store i32 239395753, i32* %canary
  %j = alloca i32, align 4
  %temp = alloca i32, align 4
  %present = alloca [6 x i32], align 16
  store i32 0, i32* %no_q_matrix, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @CalculateQuant8Param.4() #0 {
entry:
  %i = alloca i32, align 4
  %k = alloca i32, align 4
  %temp = alloca i32, align 4
  %canary = alloca i32
  store i32 2132451542, i32* %canary
  %no_q_matrix = alloca i32, align 4
...
if.end257:                                        ; preds = %for.end256, %for.end91
  ...
  %142 = icmp eq i32 %141, 2132451542
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1972515505, i32* %canary
  %temp = alloca i32, align 4
  %k = alloca i32, align 4
  %j = alloca i32, align 4
  %no_q_matrix = alloca i32, align 4
...
if.end682:                                        ; preds = %for.end681, %for.end200
  %359 = load i32, i32* %canary
  %360 = icmp eq i32 %359, 1972515505
  br i1 %360, label %361, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @PatchMatrix.6() #0 {
entry:
  %canary = alloca i32
  store i32 434551016, i32* %canary
  %ScalingList = alloca i16*, align 8
  %i = alloca i32, align 4
  %fail = alloca i32, align 4
  %cnt = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @ParseMatrix.7(i8* %buf, i32 %bufsize) #0 {
entry:
  %bufsize.addr = alloca i32, align 4
  %InString = alloca i32, align 4
  %canary = alloca i32
  store i32 939826601, i32* %canary
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 215500525, i32* %canary
...
entry:
  ...
  %no_q_matrix = alloca i32, align 4
  %canary = alloca i32
  store i32 323276983, i32* %canary
  %temp = alloca i32, align 4
  %i = alloca i32, align 4
  %present = alloca [2 x i32], align 4
  store i32 0, i32* %no_q_matrix, align 4
...
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 932788880, i32* %canary
  %cnt = alloca i32, align 4
  %fail = alloca i32, align 4
  %ScalingList = alloca i16*, align 8
  store i32 0, i32* %i, align 4
...
entry:
  ...
  %range = alloca i32, align 4
  %canary = alloca i32
  store i32 105401864, i32* %canary
  %InString = alloca i32, align 4
  %InItem = alloca i32, align 4
  %j = alloca i32, align 4
  %bufsize.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @ParseMatrix.13(i8* %buf, i32 %bufsize) #0 {
entry:
  %item = alloca i32, align 4
  %canary = alloca i32
  store i32 1720214600, i32* %canary
  %MapIdx = alloca i32, align 4
  %bufsize.addr = alloca i32, align 4
  %type = alloca i32, align 4
  %j = alloca i32, align 4
...
entry:
  ...
  %no_q_matrix = alloca i32, align 4
  %canary = alloca i32
  store i32 865761202, i32* %canary
  %j = alloca i32, align 4
  %k = alloca i32, align 4
  %temp = alloca i32, align 4
  store i32 0, i32* %no_q_matrix, align 4
...
entry:
  ...
  %ScalingList = alloca i16*, align 8
  %canary = alloca i32
  store i32 2127352328, i32* %canary
  %fail = alloca i32, align 4
  %cnt = alloca i32, align 4
  store i32 0, i32* %i, align 4
  br label %for.cond
...
entry:
  %range = alloca i32, align 4
  %canary = alloca i32
  store i32 1336861817, i32* %canary
  %type = alloca i32, align 4
  %MapIdx = alloca i32, align 4
  %bufend = alloca i8*, align 8
  %item = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @CheckParameterName.17(i8* %s, i32* %type) #0 {
entry:
  %canary = alloca i32
  store i32 1332985678, i32* %canary
  %s.addr = alloca i8*, align 8
  %i = alloca i32, align 4
  %type.addr = alloca i32*, align 8
  %retval = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @CheckParameterName.18(i8* %s, i32* %type) #0 {
entry:
  %s.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1384076834, i32* %canary
  %type.addr = alloca i32*, align 8
  %i = alloca i32, align 4
  %retval = alloca i32, align 4
  store i8* %s, i8** %s.addr, align 8
...
entry:
  %temp = alloca i32, align 4
  %canary = alloca i32
  store i32 684482793, i32* %canary
  %present = alloca [2 x i32], align 4
  %i = alloca i32, align 4
  %no_q_matrix = alloca i32, align 4
  %j = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @CheckParameterName.20(i8* %s, i32* %type) #0 {
entry:
  %type.addr = alloca i32*, align 8
  %retval = alloca i32, align 4
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1450434073, i32* %canary
  %s.addr = alloca i8*, align 8
  store i8* %s, i8** %s.addr, align 8
  store i32* %type, i32** %type.addr, align 8
  store i32 0, i32* %i, align 4
