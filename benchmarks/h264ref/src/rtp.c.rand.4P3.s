...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$16, %rsp
	movl	$254848999, -12(%rbp)   # imm = 0xF30AFE7
	movl	%edi, -8(%rbp)
...
.LBB6_5:                                # %return
	cmpl	$254848999, -12(%rbp)   # imm = 0xF30AFE7
	jne	.LBB6_7
.LBB6_6:
	addq	$16, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$1078859124, -28(%rbp)  # imm = 0x404E1574
	movq	%rdi, -24(%rbp)
	movq	-24(%rbp), %rax
	movl	20(%rax), %eax
	shll	$7, %eax
...
.LBB7_10:                               # %if.end32
	...
	movl	4(%rax), %ebx
	shll	$3, %ebx
	cmpl	$1078859124, -28(%rbp)  # imm = 0x404E1574
	jne	.LBB7_12
.LBB7_11:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$1026002292, -40(%rbp)  # imm = 0x3D278D74
	movq	%rdi, -24(%rbp)
	movq	%rsi, -32(%rbp)
	movl	$-1, -36(%rbp)
	movq	-24(%rbp), %rdi
...
.LBB8_7:                                # %return
	movl	-12(%rbp), %ebx
	cmpl	$1026002292, -40(%rbp)  # imm = 0x3D278D74
	jne	.LBB8_9
.LBB8_8:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$55472603, -40(%rbp)    # imm = 0x34E71DB
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movl	$-1, -36(%rbp)
	movq	-32(%rbp), %rdi
...
.LBB9_7:                                # %return
	movl	-12(%rbp), %ebx
	cmpl	$55472603, -40(%rbp)    # imm = 0x34E71DB
	jne	.LBB9_9
.LBB9_8:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$16, %rsp
	movl	$956959425, -12(%rbp)   # imm = 0x390A0AC1
	movl	%edi, -8(%rbp)
	cmpl	$-1, RTPUpdateTimestamp.oldtr
	jne	.LBB10_2
# %bb.1:                                # %if.then
...
.LBB10_4:                               # %if.end3
	...
	movl	%eax, RTPUpdateTimestamp.oldtr
.LBB10_5:                               # %return
	cmpl	$956959425, -12(%rbp)   # imm = 0x390A0AC1
	jne	.LBB10_7
.LBB10_6:
	addq	$16, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$594001276, -36(%rbp)   # imm = 0x2367BD7C
	movq	%rdi, -24(%rbp)
	movq	%rsi, -32(%rbp)
	movl	$-1, -40(%rbp)
	movq	-24(%rbp), %rdi
...
.LBB11_7:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$594001276, -36(%rbp)   # imm = 0x2367BD7C
	jne	.LBB11_9
.LBB11_8:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$1749713781, -28(%rbp)  # imm = 0x684A8375
	movq	%rdi, -24(%rbp)
	movq	-24(%rbp), %rax
	movl	20(%rax), %eax
	shll	$7, %eax
...
.LBB12_10:                              # %if.end32
	...
	movl	4(%rax), %ebx
	shll	$3, %ebx
	cmpl	$1749713781, -28(%rbp)  # imm = 0x684A8375
	jne	.LBB12_12
.LBB12_11:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$1398993329, -40(%rbp)  # imm = 0x5362F1B1
	movq	%rdi, -24(%rbp)
	movq	%rsi, -32(%rbp)
	movl	$-1, -36(%rbp)
	movq	-24(%rbp), %rdi
...
.LBB13_7:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$1398993329, -40(%rbp)  # imm = 0x5362F1B1
	jne	.LBB13_9
.LBB13_8:
	movl	%ebx, %eax
	addq	$40, %rsp
