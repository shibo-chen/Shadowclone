...
.LBB0_2:                                # %func_RandomIntraInit.9
	...
	.cfi_def_cfa %rsp, 8
	retq
.LBB0_3:                                # %func_RandomIntraInit.10
	.cfi_def_cfa %rbp, 16
	movl	%ebx, %edi
	movl	%r15d, %esi
	movl	%r14d, %edx
	...
	.cfi_def_cfa %rsp, 8
	retq
.LBB0_4:                                # %func_RandomIntraInit.11
	.cfi_def_cfa %rbp, 16
	movl	%ebx, %edi
	movl	%r15d, %esi
	movl	%r14d, %edx
	...
	.cfi_def_cfa %rsp, 8
	retq
.LBB0_5:                                # %func_RandomIntraInit.12
	.cfi_def_cfa %rbp, 16
	movl	%ebx, %edi
	movl	%r15d, %esi
	movl	%r14d, %edx
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$16, %rsp
	movl	$684431759, -12(%rbp)   # imm = 0x28CB998F
...
# %bb.3:                                # %for.inc
	...
	jmp	.LBB4_1
.LBB4_4:                                # %for.end
	cmpl	$684431759, -12(%rbp)   # imm = 0x28CB998F
	jne	.LBB4_6
.LBB4_5:
	addq	$16, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$16, %rsp
	movl	$551036922, -12(%rbp)   # imm = 0x20D827FA
	movl	NumberIntraPerPicture, %eax
	addl	WalkAround, %eax
	movl	%eax, WalkAround
	movl	$0, -4(%rbp)
...
# %bb.3:                                # %for.inc
	...
	jmp	.LBB5_1
.LBB5_4:                                # %for.end
	cmpl	$551036922, -12(%rbp)   # imm = 0x20D827FA
	jne	.LBB5_6
.LBB5_5:
	addq	$16, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$2110467890, -24(%rbp)  # imm = 0x7DCB2F32
	movl	%edi, -20(%rbp)
	movl	$0, -12(%rbp)
.LBB6_1:                                # %for.cond
                                        # =>This Inner Loop Header: Depth=1
...
.LBB6_7:                                # %return
	movl	-16(%rbp), %ebx
	cmpl	$2110467890, -24(%rbp)  # imm = 0x7DCB2F32
	jne	.LBB6_9
.LBB6_8:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$1808693587, -24(%rbp)  # imm = 0x6BCE7953
	movl	%edi, -20(%rbp)
	movl	$0, -12(%rbp)
.LBB7_1:                                # %for.cond
                                        # =>This Inner Loop Header: Depth=1
...
.LBB7_7:                                # %return
	movl	-16(%rbp), %ebx
	cmpl	$1808693587, -24(%rbp)  # imm = 0x6BCE7953
	jne	.LBB7_9
.LBB7_8:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1863082744, -20(%rbp)  # imm = 0x6F0C62F8
	movl	%edi, -16(%rbp)
	movl	%esi, -24(%rbp)
	movl	%edx, -12(%rbp)
	movl	$1, %edi
...
# %bb.14:                               # %for.inc23
	...
	jmp	.LBB8_9
.LBB8_15:                               # %for.end25
	cmpl	$1863082744, -20(%rbp)  # imm = 0x6F0C62F8
	jne	.LBB8_17
.LBB8_16:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$1333430917, -24(%rbp)  # imm = 0x4F7A8A85
	movl	%edi, -20(%rbp)
	movl	$0, -12(%rbp)
.LBB9_1:                                # %for.cond
                                        # =>This Inner Loop Header: Depth=1
...
.LBB9_7:                                # %return
	movl	-16(%rbp), %ebx
	cmpl	$1333430917, -24(%rbp)  # imm = 0x4F7A8A85
	jne	.LBB9_9
.LBB9_8:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$1695390585, -24(%rbp)  # imm = 0x650D9B79
	movl	%edi, -20(%rbp)
	movl	$0, -12(%rbp)
.LBB10_1:                               # %for.cond
                                        # =>This Inner Loop Header: Depth=1
...
.LBB10_7:                               # %return
	movl	-16(%rbp), %ebx
	cmpl	$1695390585, -24(%rbp)  # imm = 0x650D9B79
	jne	.LBB10_9
.LBB10_8:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$1935884465, -20(%rbp)  # imm = 0x736340B1
	movl	%edi, -24(%rbp)
	movl	$0, -12(%rbp)
.LBB11_1:                               # %for.cond
                                        # =>This Inner Loop Header: Depth=1
...
.LBB11_7:                               # %return
	movl	-16(%rbp), %ebx
	cmpl	$1935884465, -20(%rbp)  # imm = 0x736340B1
	jne	.LBB11_9
.LBB11_8:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1719180917, -24(%rbp)  # imm = 0x66789E75
	movl	%edi, -20(%rbp)
	movl	%esi, -16(%rbp)
	movl	%edx, -8(%rbp)
	movl	$1, %edi
...
# %bb.14:                               # %for.inc23
	...
	jmp	.LBB12_9
.LBB12_15:                              # %for.end25
	cmpl	$1719180917, -24(%rbp)  # imm = 0x66789E75
	jne	.LBB12_17
.LBB12_16:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1732477081, -16(%rbp)  # imm = 0x67438099
	movl	%edi, -20(%rbp)
	movl	%esi, -24(%rbp)
	movl	%edx, -12(%rbp)
	movl	$1, %edi
...
# %bb.14:                               # %for.inc23
	...
	jmp	.LBB13_9
.LBB13_15:                              # %for.end25
	cmpl	$1732477081, -16(%rbp)  # imm = 0x67438099
	jne	.LBB13_17
.LBB13_16:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$392067181, -20(%rbp)   # imm = 0x175E786D
	movl	%edi, -16(%rbp)
	movl	%esi, -24(%rbp)
	movl	%edx, -8(%rbp)
	movl	$1, %edi
...
# %bb.14:                               # %for.inc23
	...
	jmp	.LBB14_9
.LBB14_15:                              # %for.end25
	cmpl	$392067181, -20(%rbp)   # imm = 0x175E786D
	jne	.LBB14_17
.LBB14_16:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$28203619, -24(%rbp)    # imm = 0x1AE5A63
	movl	%edi, -16(%rbp)
	movl	%esi, -20(%rbp)
	movl	%edx, -8(%rbp)
	movl	$1, %edi
...
# %bb.14:                               # %for.inc23
	...
	jmp	.LBB15_9
.LBB15_15:                              # %for.end25
	cmpl	$28203619, -24(%rbp)    # imm = 0x1AE5A63
	jne	.LBB15_17
.LBB15_16:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1762957707, -20(%rbp)  # imm = 0x6914998B
	movl	%edi, -24(%rbp)
	movl	%esi, -16(%rbp)
	movl	%edx, -12(%rbp)
	movl	$1, %edi
...
# %bb.14:                               # %for.inc23
	...
	jmp	.LBB16_9
.LBB16_15:                              # %for.end25
	cmpl	$1762957707, -20(%rbp)  # imm = 0x6914998B
	jne	.LBB16_17
.LBB16_16:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$2004130680, -24(%rbp)  # imm = 0x77749B78
	movl	%edi, -20(%rbp)
	movl	$0, -12(%rbp)
.LBB17_1:                               # %for.cond
                                        # =>This Inner Loop Header: Depth=1
...
.LBB17_7:                               # %return
	movl	-16(%rbp), %ebx
	cmpl	$2004130680, -24(%rbp)  # imm = 0x77749B78
	jne	.LBB17_9
.LBB17_8:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1837948925, -20(%rbp)  # imm = 0x6D8CDFFD
	movl	%edi, -24(%rbp)
	movl	%esi, -16(%rbp)
	movl	%edx, -8(%rbp)
	movl	$1, %edi
...
# %bb.14:                               # %for.inc23
	...
	jmp	.LBB18_9
.LBB18_15:                              # %for.end25
	cmpl	$1837948925, -20(%rbp)  # imm = 0x6D8CDFFD
	jne	.LBB18_17
.LBB18_16:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$768175922, -24(%rbp)   # imm = 0x2DC96F32
	movl	%edi, -16(%rbp)
	movl	%esi, -20(%rbp)
	movl	%edx, -12(%rbp)
	movl	$1, %edi
...
# %bb.14:                               # %for.inc23
	...
	jmp	.LBB19_9
.LBB19_15:                              # %for.end25
	cmpl	$768175922, -24(%rbp)   # imm = 0x2DC96F32
	jne	.LBB19_17
.LBB19_16:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$64532501, -16(%rbp)    # imm = 0x3D8B015
	movl	%edi, -20(%rbp)
	movl	%esi, -24(%rbp)
	movl	%edx, -8(%rbp)
	movl	$1, %edi
...
# %bb.14:                               # %for.inc23
	...
	jmp	.LBB20_9
.LBB20_15:                              # %for.end25
	cmpl	$64532501, -16(%rbp)    # imm = 0x3D8B015
	jne	.LBB20_17
.LBB20_16:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$2084886185, -20(%rbp)  # imm = 0x7C44D6A9
	movl	%edi, -16(%rbp)
	movl	%esi, -24(%rbp)
	movl	%edx, -8(%rbp)
	movl	$1, %edi
...
# %bb.14:                               # %for.inc23
	...
	jmp	.LBB21_9
.LBB21_15:                              # %for.end25
	cmpl	$2084886185, -20(%rbp)  # imm = 0x7C44D6A9
	jne	.LBB21_17
.LBB21_16:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$682935139, -24(%rbp)   # imm = 0x28B4C363
	movl	%edi, -16(%rbp)
	movl	%esi, -20(%rbp)
	movl	%edx, -8(%rbp)
	movl	$1, %edi
...
# %bb.14:                               # %for.inc23
	...
	jmp	.LBB22_9
.LBB22_15:                              # %for.end25
	cmpl	$682935139, -24(%rbp)   # imm = 0x28B4C363
	jne	.LBB22_17
.LBB22_16:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$2060542062, -24(%rbp)  # imm = 0x7AD1606E
	movl	%edi, -16(%rbp)
	movl	%esi, -20(%rbp)
	movl	%edx, -12(%rbp)
	movl	$1, %edi
...
# %bb.14:                               # %for.inc23
	...
	jmp	.LBB23_9
.LBB23_15:                              # %for.end25
	cmpl	$2060542062, -24(%rbp)  # imm = 0x7AD1606E
	jne	.LBB23_17
.LBB23_16:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$756485278, -24(%rbp)   # imm = 0x2D170C9E
	movl	%edi, -20(%rbp)
	movl	%esi, -16(%rbp)
	movl	%edx, -8(%rbp)
	movl	$1, %edi
...
# %bb.14:                               # %for.inc23
	...
	jmp	.LBB24_9
.LBB24_15:                              # %for.end25
	cmpl	$756485278, -24(%rbp)   # imm = 0x2D170C9E
	jne	.LBB24_17
.LBB24_16:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$486711542, -20(%rbp)   # imm = 0x1D02A0F6
	movl	%edi, -16(%rbp)
	movl	%esi, -24(%rbp)
	movl	%edx, -8(%rbp)
	movl	$1, %edi
...
# %bb.14:                               # %for.inc23
	...
	jmp	.LBB25_9
.LBB25_15:                              # %for.end25
	cmpl	$486711542, -20(%rbp)   # imm = 0x1D02A0F6
	jne	.LBB25_17
.LBB25_16:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$236473544, -20(%rbp)   # imm = 0xE184CC8
	movl	%edi, -24(%rbp)
	movl	%esi, -16(%rbp)
	movl	%edx, -8(%rbp)
	movl	$1, %edi
...
# %bb.14:                               # %for.inc23
	...
	jmp	.LBB26_9
.LBB26_15:                              # %for.end25
	cmpl	$236473544, -20(%rbp)   # imm = 0xE184CC8
	jne	.LBB26_17
.LBB26_16:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1008385706, -16(%rbp)  # imm = 0x3C1ABEAA
	movl	%edi, -20(%rbp)
	movl	%esi, -24(%rbp)
	movl	%edx, -8(%rbp)
	movl	$1, %edi
...
# %bb.14:                               # %for.inc23
	...
	jmp	.LBB27_9
.LBB27_15:                              # %for.end25
	cmpl	$1008385706, -16(%rbp)  # imm = 0x3C1ABEAA
	jne	.LBB27_17
.LBB27_16:
	addq	$32, %rsp
	popq	%rbp
