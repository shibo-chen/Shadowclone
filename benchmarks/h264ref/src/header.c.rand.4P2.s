...
# %bb.1:                                # %func_SliceHeader.1
	...
	.cfi_def_cfa %rsp, 8
	retq
.LBB0_2:                                # %func_SliceHeader.6
	.cfi_def_cfa %rbp, 16
	callq	SliceHeader.6
	popq	%rbp
	.cfi_def_cfa %rsp, 8
	retq
.LBB0_3:                                # %func_SliceHeader.20
	.cfi_def_cfa %rbp, 16
...
# %bb.1:                                # %func_get_picture_type.2
	...
	.cfi_def_cfa %rsp, 8
	retq
.LBB1_2:                                # %func_get_picture_type.9
	.cfi_def_cfa %rbp, 16
	callq	get_picture_type.9
	popq	%rbp
	.cfi_def_cfa %rsp, 8
	retq
.Lfunc_end1:
...
# %bb.1:                                # %func_Partition_BC_Header.5
	...
	.cfi_def_cfa %rsp, 8
	retq
.LBB2_2:                                # %func_Partition_BC_Header.11
	.cfi_def_cfa %rbp, 16
	movl	%ebx, %edi
...
# %bb.1:                                # %func_ref_pic_list_reordering.4
	...
	.cfi_def_cfa %rsp, 8
	retq
.LBB3_2:                                # %func_ref_pic_list_reordering.7
	.cfi_def_cfa %rbp, 16
	callq	ref_pic_list_reordering.7
	popq	%rbp
	.cfi_def_cfa %rsp, 8
	retq
.LBB3_3:                                # %func_ref_pic_list_reordering.13
	.cfi_def_cfa %rbp, 16
...
.LBB4_2:                                # %func_dec_ref_pic_marking.10
	...
	.cfi_def_cfa %rsp, 8
	retq
.LBB4_3:                                # %func_dec_ref_pic_marking.16
	.cfi_def_cfa %rbp, 16
...
# %bb.0:                                # %entry
	...
	subq	$72, %rsp
	.cfi_offset %rbx, -24
	movl	$507661989, -52(%rbp)   # imm = 0x1E424EA5
	movq	input, %rax
	movslq	2364(%rax), %rax
...
.LBB6_75:                               # %if.end239
	movl	-12(%rbp), %ebx
	cmpl	$507661989, -52(%rbp)   # imm = 0x1E424EA5
	jne	.LBB6_77
.LBB6_76:
	movl	%ebx, %eax
	addq	$72, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$258327801, -20(%rbp)   # imm = 0xF65C4F9
	movl	$5, -16(%rbp)
	movq	img(%rip), %rax
	movl	24(%rax), %eax
	movq	%rax, %rcx
...
.LBB7_8:                                # %return
	movl	-12(%rbp), %ebx
	cmpl	$258327801, -20(%rbp)   # imm = 0xF65C4F9
	jne	.LBB7_10
.LBB7_9:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$1703908778, -36(%rbp)  # imm = 0x658F95AA
	movq	input, %rax
	movslq	2364(%rax), %rax
	movq	assignSE2partition(,%rax,8), %rax
	movl	(%rax), %eax
...
.LBB8_20:                               # %if.end51
	movl	-12(%rbp), %ebx
	cmpl	$1703908778, -36(%rbp)  # imm = 0x658F95AA
	jne	.LBB8_22
.LBB8_21:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$691238387, -40(%rbp)   # imm = 0x293375F3
	movq	input, %rax
	movslq	2364(%rax), %rax
	movq	assignSE2partition(,%rax,8), %rax
	movl	(%rax), %eax
...
.LBB9_26:                               # %if.end87
	movl	-16(%rbp), %ebx
	cmpl	$691238387, -40(%rbp)   # imm = 0x293375F3
	jne	.LBB9_28
.LBB9_27:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$88, %rsp
	.cfi_offset %rbx, -24
	movl	$2088994136, -32(%rbp)  # imm = 0x7C838558
	movl	%edi, -28(%rbp)
	movq	img, %rax
	movq	14160(%rax), %rax
	movq	24(%rax), %rax
...
.LBB10_2:                               # %if.end
	movl	-12(%rbp), %ebx
	cmpl	$2088994136, -32(%rbp)  # imm = 0x7C838558
	jne	.LBB10_4
.LBB10_3:
	movl	%ebx, %eax
	addq	$88, %rsp
...
.Lfunc_end10:
	...
	.cfi_endproc
                                        # -- End function
	.section	.rodata.cst8,"aM",@progbits,8
	.p2align	3               # -- Begin function SliceHeader.6
.LCPI11_0:
	.quad	4611686018427387904     # double 2
	.section	.rodata.cst4,"aM",@progbits,4
	.p2align	2
.LCPI11_1:
	...
	.globl	SliceHeader.6
	.p2align	4, 0x90
	.type	SliceHeader.6,@function
SliceHeader.6:                          # @SliceHeader.6
	.cfi_startproc
# %bb.0:                                # %entry
	pushq	%rbp
	.cfi_def_cfa_offset 16
	...
	subq	$72, %rsp
	.cfi_offset %rbx, -24
	movl	$417752993, -52(%rbp)   # imm = 0x18E667A1
	movq	input, %rax
	movslq	2364(%rax), %rax
	movq	assignSE2partition(,%rax,8), %rax
	movl	(%rax), %eax
...
# %bb.50:                               # %lor.lhs.false153
	...
	cmpl	$3, 24(%rax)
	jne	.LBB11_52
.LBB11_51:                              # %land.lhs.true156
	movq	active_pps, %rax
	cmpl	$0, 192(%rax)
	jne	.LBB11_54
.LBB11_52:                              # %lor.lhs.false158
	movq	img, %rax
	cmpl	$1, 24(%rax)
	jne	.LBB11_55
# %bb.53:                               # %land.lhs.true161
...
.LBB11_75:                              # %if.end239
	movl	-12(%rbp), %ebx
	cmpl	$417752993, -52(%rbp)   # imm = 0x18E667A1
	jne	.LBB11_77
.LBB11_76:
	movl	%ebx, %eax
	addq	$72, %rsp
...
.LBB11_77:                              # %func_exit
	...
	jmp	.LBB11_76
.Lfunc_end11:
	.size	SliceHeader.6, .Lfunc_end11-SliceHeader.6
	.cfi_endproc
                                        # -- End function
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$1854972326, -36(%rbp)  # imm = 0x6E90A1A6
	movq	input, %rax
	movslq	2364(%rax), %rax
	movq	assignSE2partition(,%rax,8), %rax
	movl	(%rax), %eax
...
.LBB12_26:                              # %if.end87
	movl	-16(%rbp), %ebx
	cmpl	$1854972326, -36(%rbp)  # imm = 0x6E90A1A6
	jne	.LBB12_28
.LBB12_27:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$910089548, -36(%rbp)   # imm = 0x363EDD4C
	movq	input, %rax
	movslq	2364(%rax), %rax
	movq	assignSE2partition(,%rax,8), %rax
	movl	(%rax), %eax
...
.LBB13_38:                              # %if.end175
	movl	-12(%rbp), %ebx
	cmpl	$910089548, -36(%rbp)   # imm = 0x363EDD4C
	jne	.LBB13_40
.LBB13_39:
	movl	%ebx, %eax
	addq	$40, %rsp
...
.Lfunc_end13:
	...
	.cfi_endproc
                                        # -- End function
	.globl	get_picture_type.9      # -- Begin function get_picture_type.9
	.p2align	4, 0x90
	.type	get_picture_type.9,@function
get_picture_type.9:                     # @get_picture_type.9
	.cfi_startproc
# %bb.0:                                # %entry
	pushq	%rbp
	.cfi_def_cfa_offset 16
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$1766806619, -20(%rbp)  # imm = 0x694F545B
	movl	$5, -16(%rbp)
	movq	img(%rip), %rax
	movl	24(%rax), %eax
	movq	%rax, %rcx
...
.LBB14_8:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$1766806619, -20(%rbp)  # imm = 0x694F545B
	jne	.LBB14_10
.LBB14_9:
	movl	%ebx, %eax
	addq	$24, %rsp
...
.LBB14_10:                              # %func_exit
	...
	jmp	.LBB14_9
.Lfunc_end14:
	.size	get_picture_type.9, .Lfunc_end14-get_picture_type.9
	.cfi_endproc
	.section	.rodata,"a",@progbits
	.p2align	3
.LJTI14_0:
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$1422749935, -36(%rbp)  # imm = 0x54CD70EF
	movq	input, %rax
	movslq	2364(%rax), %rax
	movq	assignSE2partition(,%rax,8), %rax
	movl	(%rax), %eax
...
.LBB15_20:                              # %if.end51
	movl	-12(%rbp), %ebx
	cmpl	$1422749935, -36(%rbp)  # imm = 0x54CD70EF
	jne	.LBB15_22
.LBB15_21:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$88, %rsp
	.cfi_offset %rbx, -24
	movl	$141077149, -28(%rbp)   # imm = 0x868AA9D
	movl	%edi, -32(%rbp)
	movq	img, %rax
	movq	14160(%rax), %rax
	movq	24(%rax), %rax
...
.LBB16_2:                               # %if.end
	movl	-12(%rbp), %ebx
	cmpl	$141077149, -28(%rbp)   # imm = 0x868AA9D
	jne	.LBB16_4
.LBB16_3:
	movl	%ebx, %eax
	addq	$88, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$761686451, -40(%rbp)   # imm = 0x2D6669B3
	movq	input, %rax
	movslq	2364(%rax), %rax
	movq	assignSE2partition(,%rax,8), %rax
	movl	(%rax), %eax
...
.LBB17_38:                              # %if.end175
	movl	-12(%rbp), %ebx
	cmpl	$761686451, -40(%rbp)   # imm = 0x2D6669B3
	jne	.LBB17_40
.LBB17_39:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$1328836973, -40(%rbp)  # imm = 0x4F34716D
	movq	input, %rax
	movslq	2364(%rax), %rax
	movq	assignSE2partition(,%rax,8), %rax
	movl	(%rax), %eax
...
.LBB18_26:                              # %if.end87
	movl	-16(%rbp), %ebx
	cmpl	$1328836973, -40(%rbp)  # imm = 0x4F34716D
	jne	.LBB18_28
.LBB18_27:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$1392391907, -36(%rbp)  # imm = 0x52FE36E3
	movq	input, %rax
	movslq	2364(%rax), %rax
	movq	assignSE2partition(,%rax,8), %rax
	movl	(%rax), %eax
...
.LBB19_38:                              # %if.end175
	movl	-12(%rbp), %ebx
	cmpl	$1392391907, -36(%rbp)  # imm = 0x52FE36E3
	jne	.LBB19_40
.LBB19_39:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$714178196, -36(%rbp)   # imm = 0x2A917E94
	movq	input, %rax
	movslq	2364(%rax), %rax
	movq	assignSE2partition(,%rax,8), %rax
	movl	(%rax), %eax
...
.LBB20_38:                              # %if.end175
	movl	-12(%rbp), %ebx
	cmpl	$714178196, -36(%rbp)   # imm = 0x2A917E94
	jne	.LBB20_40
.LBB20_39:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$1987277179, -36(%rbp)  # imm = 0x7673717B
	movq	input, %rax
	movslq	2364(%rax), %rax
	movq	assignSE2partition(,%rax,8), %rax
	movl	(%rax), %eax
...
.LBB21_20:                              # %if.end51
	movl	-12(%rbp), %ebx
	cmpl	$1987277179, -36(%rbp)  # imm = 0x7673717B
	jne	.LBB21_22
.LBB21_21:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$602215821, -40(%rbp)   # imm = 0x23E5158D
	movq	input, %rax
	movslq	2364(%rax), %rax
	movq	assignSE2partition(,%rax,8), %rax
	movl	(%rax), %eax
...
.LBB22_26:                              # %if.end87
	movl	-16(%rbp), %ebx
	cmpl	$602215821, -40(%rbp)   # imm = 0x23E5158D
	jne	.LBB22_28
.LBB22_27:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$88, %rsp
	.cfi_offset %rbx, -24
	movl	$1793201507, -28(%rbp)  # imm = 0x6AE21563
	movl	%edi, -32(%rbp)
	movq	img, %rax
	movq	14160(%rax), %rax
	movq	24(%rax), %rax
...
.LBB23_2:                               # %if.end
	movl	-12(%rbp), %ebx
	cmpl	$1793201507, -28(%rbp)  # imm = 0x6AE21563
	jne	.LBB23_4
.LBB23_3:
	movl	%ebx, %eax
	addq	$88, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$88, %rsp
	.cfi_offset %rbx, -24
	movl	$1754131318, -32(%rbp)  # imm = 0x688DEB76
	movl	%edi, -28(%rbp)
	movq	img, %rax
	movq	14160(%rax), %rax
	movq	24(%rax), %rax
...
.LBB24_2:                               # %if.end
	movl	-12(%rbp), %ebx
	cmpl	$1754131318, -32(%rbp)  # imm = 0x688DEB76
	jne	.LBB24_4
.LBB24_3:
	movl	%ebx, %eax
	addq	$88, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$72, %rsp
	.cfi_offset %rbx, -24
	movl	$828074094, -48(%rbp)   # imm = 0x315B686E
	movq	input, %rax
	movslq	2364(%rax), %rax
	movq	assignSE2partition(,%rax,8), %rax
	movl	(%rax), %eax
...
.LBB25_75:                              # %if.end239
	movl	-12(%rbp), %ebx
	cmpl	$828074094, -48(%rbp)   # imm = 0x315B686E
	jne	.LBB25_77
.LBB25_76:
	movl	%ebx, %eax
	addq	$72, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$72, %rsp
	.cfi_offset %rbx, -24
	movl	$1741080198, -40(%rbp)  # imm = 0x67C6C686
	movq	input, %rax
	movslq	2364(%rax), %rax
	movq	assignSE2partition(,%rax,8), %rax
	movl	(%rax), %eax
...
.LBB26_75:                              # %if.end239
	movl	-12(%rbp), %ebx
	cmpl	$1741080198, -40(%rbp)  # imm = 0x67C6C686
	jne	.LBB26_77
.LBB26_76:
	movl	%ebx, %eax
	addq	$72, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$880412393, -40(%rbp)   # imm = 0x347A06E9
	movq	input, %rax
	movslq	2364(%rax), %rax
	movq	assignSE2partition(,%rax,8), %rax
	movl	(%rax), %eax
...
.LBB27_20:                              # %if.end51
	movl	-12(%rbp), %ebx
	cmpl	$880412393, -40(%rbp)   # imm = 0x347A06E9
	jne	.LBB27_22
.LBB27_21:
	movl	%ebx, %eax
	addq	$40, %rsp
