; ModuleID = 'context_ini.c.rand.4P2.bc'
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_create_context_memory.1, label %ctrl0

func_create_context_memory.1:                     ; preds = %rand_bb
  call void @create_context_memory.1()
  ret void

func_create_context_memory.2:                     ; preds = %ctrl0
...
func_create_context_memory.18:                    ; preds = %ctrl1
  call void @create_context_memory.18()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_create_context_memory.2, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_create_context_memory.12, label %func_create_context_memory.18
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_free_context_memory.7, label %func_free_context_memory.17

func_free_context_memory.7:                       ; preds = %rand_bb
  call void @free_context_memory.7()
  ret void

func_free_context_memory.17:                      ; preds = %rand_bb
  call void @free_context_memory.17()
  ret void
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_SetCtxModelNumber.13, label %ctrl0

func_SetCtxModelNumber.13:                        ; preds = %rand_bb
  call void @SetCtxModelNumber.13()
  ret void

func_SetCtxModelNumber.23:                        ; preds = %ctrl0
  call void @SetCtxModelNumber.23()
  ret void

func_SetCtxModelNumber.28:                        ; preds = %ctrl1
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_SetCtxModelNumber.23, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_SetCtxModelNumber.28, label %func_SetCtxModelNumber.30
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_init_contexts.3, label %ctrl0

func_init_contexts.3:                             ; preds = %rand_bb
  call void @init_contexts.3()
  ret void

func_init_contexts.4:                             ; preds = %ctrl0
  call void @init_contexts.4()
  ret void

func_init_contexts.9:                             ; preds = %ctrl1
  call void @init_contexts.9()
  ret void

func_init_contexts.24:                            ; preds = %ctrl1
  call void @init_contexts.24()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_init_contexts.4, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_init_contexts.9, label %func_init_contexts.24
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_XRate.22, label %ctrl0

func_XRate.22:                                    ; preds = %rand_bb
  %2 = call double @XRate.22(%struct.BiContextType* %ctx, i32* %model)
  ret double %2

func_XRate.25:                                    ; preds = %ctrl0
  %3 = call double @XRate.25(%struct.BiContextType* %ctx, i32* %model)
  ret double %3

func_XRate.27:                                    ; preds = %ctrl1
  %4 = call double @XRate.27(%struct.BiContextType* %ctx, i32* %model)
  ret double %4

func_XRate.29:                                    ; preds = %ctrl1
  %5 = call double @XRate.29(%struct.BiContextType* %ctx, i32* %model)
  ret double %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_XRate.25, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_XRate.27, label %func_XRate.29
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_GetCtxModelNumber.6, label %ctrl0

func_GetCtxModelNumber.6:                         ; preds = %rand_bb
  call void @GetCtxModelNumber.6(i32* %mnumber, %struct.MotionInfoContexts* %mc, %struct.TextureInfoContexts* %tc)
  ret void

func_GetCtxModelNumber.10:                        ; preds = %ctrl0
  call void @GetCtxModelNumber.10(i32* %mnumber, %struct.MotionInfoContexts* %mc, %struct.TextureInfoContexts* %tc)
  ret void

func_GetCtxModelNumber.11:                        ; preds = %ctrl1
  call void @GetCtxModelNumber.11(i32* %mnumber, %struct.MotionInfoContexts* %mc, %struct.TextureInfoContexts* %tc)
  ret void

func_GetCtxModelNumber.21:                        ; preds = %ctrl1
  call void @GetCtxModelNumber.21(i32* %mnumber, %struct.MotionInfoContexts* %mc, %struct.TextureInfoContexts* %tc)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_GetCtxModelNumber.10, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_GetCtxModelNumber.11, label %func_GetCtxModelNumber.21
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_store_contexts.5, label %ctrl0

func_store_contexts.5:                            ; preds = %rand_bb
  call void @store_contexts.5()
  ret void

func_store_contexts.8:                            ; preds = %ctrl0
  call void @store_contexts.8()
  ret void

func_store_contexts.16:                           ; preds = %ctrl1
  call void @store_contexts.16()
  ret void

func_store_contexts.26:                           ; preds = %ctrl1
  call void @store_contexts.26()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_store_contexts.8, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_store_contexts.16, label %func_store_contexts.26
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_update_field_frame_contexts.14, label %ctrl0

func_update_field_frame_contexts.14:              ; preds = %rand_bb
  call void @update_field_frame_contexts.14(i32 %field)
  ret void

func_update_field_frame_contexts.15:              ; preds = %ctrl0
  call void @update_field_frame_contexts.15(i32 %field)
  ret void

func_update_field_frame_contexts.19:              ; preds = %ctrl1
  call void @update_field_frame_contexts.19(i32 %field)
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_update_field_frame_contexts.15, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_update_field_frame_contexts.19, label %func_update_field_frame_contexts.20
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @create_context_memory.1() #0 {
entry:
  %canary = alloca i32
  store i32 1652128993, i32* %canary
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 278894990, i32* %canary
  %num_mb = alloca i32, align 4
  %i = alloca i32, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %FrameSizeInMbs = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 111
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @init_contexts.3() #0 {
entry:
  %i = alloca i32, align 4
  %mc = alloca %struct.MotionInfoContexts*, align 8
  %canary = alloca i32
  store i32 651707656, i32* %canary
  %j = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @init_contexts.4() #0 {
entry:
  %canary = alloca i32
  store i32 1937108669, i32* %canary
  %j = alloca i32, align 4
  %tc = alloca %struct.TextureInfoContexts*, align 8
  %i = alloca i32, align 4
  %mc = alloca %struct.MotionInfoContexts*, align 8
...
for.end642:                                       ; preds = %for.cond601
  %316 = load i32, i32* %canary
  %317 = icmp eq i32 %316, 1937108669
  br i1 %317, label %318, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @store_contexts.5() #0 {
entry:
  %img_type = alloca i32, align 4
  %canary = alloca i32
  store i32 1462077143, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @GetCtxModelNumber.6(i32* %mnumber, %struct.MotionInfoContexts* %mc, %struct.TextureInfoContexts* %tc) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 1128725039, i32* %canary
  %i = alloca i32, align 4
...
for.end685:                                       ; preds = %for.cond
  ...
  %322 = icmp eq i32 %321, 1128725039
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_context_memory.7() #0 {
entry:
  %canary = alloca i32
  store i32 1381019799, i32* %canary
  %k = alloca i32, align 4
  %i = alloca i32, align 4
  store i32 0, i32* %k, align 4
  br label %for.cond
...
entry:
  %frame_field = alloca i32, align 4
  %canary = alloca i32
  store i32 1716668328, i32* %canary
  %img_type = alloca i32, align 4
  %ctx_number = alloca i32, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %field_picture = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 100
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @init_contexts.9() #0 {
entry:
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1132817870, i32* %canary
  %i = alloca i32, align 4
  %mc = alloca %struct.MotionInfoContexts*, align 8
  %tc = alloca %struct.TextureInfoContexts*, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
for.end642:                                       ; preds = %for.cond601
  %316 = load i32, i32* %canary
  %317 = icmp eq i32 %316, 1132817870
  br i1 %317, label %318, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @GetCtxModelNumber.10(i32* %mnumber, %struct.MotionInfoContexts* %mc, %struct.TextureInfoContexts* %tc) #0 {
entry:
  %min_xr = alloca double, align 8
  %num_models = alloca i32, align 4
  %model = alloca i32, align 4
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 654954683, i32* %canary
  %mnumber.addr = alloca i32*, align 8
  %mc.addr = alloca %struct.MotionInfoContexts*, align 8
  store i32* %mnumber, i32** %mnumber.addr, align 8
  store %struct.MotionInfoContexts* %mc, %struct.MotionInfoContexts** %mc.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @GetCtxModelNumber.11(i32* %mnumber, %struct.MotionInfoContexts* %mc, %struct.TextureInfoContexts* %tc) #0 {
entry:
  %i = alloca i32, align 4
  %xr = alloca double, align 8
  %mc.addr = alloca %struct.MotionInfoContexts*, align 8
  ...
  %mnumber.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 1236508402, i32* %canary
  %num_models = alloca i32, align 4
  %model = alloca i32, align 4
  %j = alloca i32, align 4
  %min_xr = alloca double, align 8
...
for.end685:                                       ; preds = %for.cond
  %321 = load i32, i32* %canary
  %322 = icmp eq i32 %321, 1236508402
  br i1 %322, label %323, label %func_exit
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1493462638, i32* %canary
  %i = alloca i32, align 4
  %num_mb = alloca i32, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %FrameSizeInMbs = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 111
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @SetCtxModelNumber.13() #0 {
entry:
  %canary = alloca i32
  store i32 345841459, i32* %canary
  %frame_field = alloca i32, align 4
  %ctx_number = alloca i32, align 4
  %img_type = alloca i32, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @update_field_frame_contexts.14(i32 %field) #0 {
entry:
  %field.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1497688659, i32* %canary
  %j = alloca i32, align 4
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @update_field_frame_contexts.15(i32 %field) #0 {
entry:
  %i = alloca i32, align 4
  %field.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1522661101, i32* %canary
  %j = alloca i32, align 4
  store i32 %field, i32* %field.addr, align 4
  %0 = load i32, i32* %field.addr, align 4
  %tobool = icmp ne i32 %0, 0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @store_contexts.16() #0 {
entry:
  %canary = alloca i32
  store i32 788416710, i32* %canary
  %ctx_number = alloca i32, align 4
  %frame_field = alloca i32, align 4
  %img_type = alloca i32, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_context_memory.17() #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1126431023, i32* %canary
  %k = alloca i32, align 4
  store i32 0, i32* %k, align 4
  br label %for.cond
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @create_context_memory.18() #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 420950833, i32* %canary
  %num_mb = alloca i32, align 4
  %k = alloca i32, align 4
  %j = alloca i32, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @update_field_frame_contexts.19(i32 %field) #0 {
entry:
  %canary = alloca i32
  store i32 1085348172, i32* %canary
  %field.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  store i32 %field, i32* %field.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 834174849, i32* %canary
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %field.addr = alloca i32, align 4
  store i32 %field, i32* %field.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @GetCtxModelNumber.21(i32* %mnumber, %struct.MotionInfoContexts* %mc, %struct.TextureInfoContexts* %tc) #0 {
entry:
  %i = alloca i32, align 4
  %num_models = alloca i32, align 4
  %model = alloca i32, align 4
  ...
  %mc.addr = alloca %struct.MotionInfoContexts*, align 8
  %canary = alloca i32
  store i32 1263946417, i32* %canary
  %mnumber.addr = alloca i32*, align 8
  %j = alloca i32, align 4
  %min_xr = alloca double, align 8
  store i32* %mnumber, i32** %mnumber.addr, align 8
...
for.end685:                                       ; preds = %for.cond
  %321 = load i32, i32* %canary
  %322 = icmp eq i32 %321, 1263946417
  br i1 %322, label %323, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local double @XRate.22(%struct.BiContextType* %ctx, i32* %model) #0 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @SetCtxModelNumber.23() #0 {
entry:
  %canary = alloca i32
  store i32 1547514595, i32* %canary
  %ctx_number = alloca i32, align 4
  %img_type = alloca i32, align 4
  %frame_field = alloca i32, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @init_contexts.24() #0 {
entry:
  %tc = alloca %struct.TextureInfoContexts*, align 8
  %canary = alloca i32
  store i32 129709476, i32* %canary
  %mc = alloca %struct.MotionInfoContexts*, align 8
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local double @XRate.25(%struct.BiContextType* %ctx, i32* %model) #0 {
entry:
  %weight = alloca double, align 8
  %qp = alloca i32, align 4
  %ctx_state = alloca i32, align 4
  ...
  %xr = alloca double, align 8
  %canary = alloca i32
  store i32 1415040181, i32* %canary
  %mod_state = alloca i32, align 4
  store %struct.BiContextType* %ctx, %struct.BiContextType** %ctx.addr, align 8
  store i32* %model, i32** %model.addr, align 8
  store double 0.000000e+00, double* %xr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @store_contexts.26() #0 {
entry:
  %img_type = alloca i32, align 4
  %ctx_number = alloca i32, align 4
  %canary = alloca i32
  store i32 219421736, i32* %canary
  %frame_field = alloca i32, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %field_picture = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 100
  %1 = load i32, i32* %field_picture, align 4
...
entry:
  ...
  %ctx.addr = alloca %struct.BiContextType*, align 8
  %canary = alloca i32
  store i32 1303770019, i32* %canary
  %ctx_state = alloca i32, align 4
  store %struct.BiContextType* %ctx, %struct.BiContextType** %ctx.addr, align 8
  store i32* %model, i32** %model.addr, align 8
  store double 0.000000e+00, double* %xr, align 8
...
entry:
  %img_type = alloca i32, align 4
  %canary = alloca i32
  store i32 730783995, i32* %canary
  %ctx_number = alloca i32, align 4
  %frame_field = alloca i32, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %field_picture = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 100
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local double @XRate.29(%struct.BiContextType* %ctx, i32* %model) #0 {
entry:
  %canary = alloca i32
  store i32 1766378076, i32* %canary
  %ctx.addr = alloca %struct.BiContextType*, align 8
  %weight = alloca double, align 8
  %ctx_state = alloca i32, align 4
  %mod_state = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1357863653, i32* %canary
  %frame_field = alloca i32, align 4
  %img_type = alloca i32, align 4
  %ctx_number = alloca i32, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
