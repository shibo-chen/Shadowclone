; ModuleID = 'rdopt_coding_state.c.rand.16R3.bc'
...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_store_coding_state.1, label %ctrl0

func_store_coding_state.1:                        ; preds = %rand_bb
  call void @store_coding_state.1(%struct.CSobj* %cs)
  ret void
...
func_store_coding_state.7:                        ; preds = %ctrl1
  call void @store_coding_state.7(%struct.CSobj* %cs)
  ret void

func_store_coding_state.10:                       ; preds = %ctrl2
  call void @store_coding_state.10(%struct.CSobj* %cs)
  ret void

func_store_coding_state.11:                       ; preds = %ctrl3
  call void @store_coding_state.11(%struct.CSobj* %cs)
  ret void

func_store_coding_state.12:                       ; preds = %ctrl4
  call void @store_coding_state.12(%struct.CSobj* %cs)
  ret void

func_store_coding_state.13:                       ; preds = %ctrl5
  call void @store_coding_state.13(%struct.CSobj* %cs)
  ret void

func_store_coding_state.15:                       ; preds = %ctrl6
  call void @store_coding_state.15(%struct.CSobj* %cs)
  ret void

func_store_coding_state.17:                       ; preds = %ctrl7
  call void @store_coding_state.17(%struct.CSobj* %cs)
  ret void

func_store_coding_state.20:                       ; preds = %ctrl8
  call void @store_coding_state.20(%struct.CSobj* %cs)
  ret void

func_store_coding_state.22:                       ; preds = %ctrl9
  call void @store_coding_state.22(%struct.CSobj* %cs)
  ret void

func_store_coding_state.23:                       ; preds = %ctrl10
  call void @store_coding_state.23(%struct.CSobj* %cs)
  ret void

func_store_coding_state.28:                       ; preds = %ctrl11
  call void @store_coding_state.28(%struct.CSobj* %cs)
  ret void

func_store_coding_state.30:                       ; preds = %ctrl12
  call void @store_coding_state.30(%struct.CSobj* %cs)
  ret void

func_store_coding_state.31:                       ; preds = %ctrl13
  call void @store_coding_state.31(%struct.CSobj* %cs)
  ret void

func_store_coding_state.32:                       ; preds = %ctrl13
  call void @store_coding_state.32(%struct.CSobj* %cs)
  ret void
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_store_coding_state.7, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_store_coding_state.10, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_store_coding_state.11, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_store_coding_state.12, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_store_coding_state.13, label %ctrl6

ctrl6:                                            ; preds = %ctrl5
  %8 = icmp eq i32 %0, 7
  br i1 %8, label %func_store_coding_state.15, label %ctrl7

ctrl7:                                            ; preds = %ctrl6
  %9 = icmp eq i32 %0, 8
  br i1 %9, label %func_store_coding_state.17, label %ctrl8

ctrl8:                                            ; preds = %ctrl7
  %10 = icmp eq i32 %0, 9
  br i1 %10, label %func_store_coding_state.20, label %ctrl9

ctrl9:                                            ; preds = %ctrl8
  %11 = icmp eq i32 %0, 10
  br i1 %11, label %func_store_coding_state.22, label %ctrl10

ctrl10:                                           ; preds = %ctrl9
  %12 = icmp eq i32 %0, 11
  br i1 %12, label %func_store_coding_state.23, label %ctrl11

ctrl11:                                           ; preds = %ctrl10
  %13 = icmp eq i32 %0, 12
  br i1 %13, label %func_store_coding_state.28, label %ctrl12

ctrl12:                                           ; preds = %ctrl11
  %14 = icmp eq i32 %0, 13
  br i1 %14, label %func_store_coding_state.30, label %ctrl13

ctrl13:                                           ; preds = %ctrl12
  %15 = icmp eq i32 %0, 14
  br i1 %15, label %func_store_coding_state.31, label %func_store_coding_state.32
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_reset_coding_state.2, label %ctrl0

func_reset_coding_state.2:                        ; preds = %rand_bb
  call void @reset_coding_state.2(%struct.CSobj* %cs)
  ret void
...
func_reset_coding_state.5:                        ; preds = %ctrl1
  call void @reset_coding_state.5(%struct.CSobj* %cs)
  ret void

func_reset_coding_state.6:                        ; preds = %ctrl2
  call void @reset_coding_state.6(%struct.CSobj* %cs)
  ret void

func_reset_coding_state.8:                        ; preds = %ctrl3
  call void @reset_coding_state.8(%struct.CSobj* %cs)
  ret void

func_reset_coding_state.9:                        ; preds = %ctrl4
  call void @reset_coding_state.9(%struct.CSobj* %cs)
  ret void

func_reset_coding_state.14:                       ; preds = %ctrl5
  call void @reset_coding_state.14(%struct.CSobj* %cs)
  ret void

func_reset_coding_state.16:                       ; preds = %ctrl6
  call void @reset_coding_state.16(%struct.CSobj* %cs)
  ret void

func_reset_coding_state.18:                       ; preds = %ctrl7
  call void @reset_coding_state.18(%struct.CSobj* %cs)
  ret void

func_reset_coding_state.19:                       ; preds = %ctrl8
  call void @reset_coding_state.19(%struct.CSobj* %cs)
  ret void

func_reset_coding_state.21:                       ; preds = %ctrl9
  call void @reset_coding_state.21(%struct.CSobj* %cs)
  ret void

func_reset_coding_state.24:                       ; preds = %ctrl10
  call void @reset_coding_state.24(%struct.CSobj* %cs)
  ret void

func_reset_coding_state.25:                       ; preds = %ctrl11
  call void @reset_coding_state.25(%struct.CSobj* %cs)
  ret void

func_reset_coding_state.26:                       ; preds = %ctrl12
  call void @reset_coding_state.26(%struct.CSobj* %cs)
  ret void

func_reset_coding_state.27:                       ; preds = %ctrl13
  call void @reset_coding_state.27(%struct.CSobj* %cs)
  ret void

func_reset_coding_state.29:                       ; preds = %ctrl13
  call void @reset_coding_state.29(%struct.CSobj* %cs)
  ret void
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_reset_coding_state.5, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_reset_coding_state.6, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_reset_coding_state.8, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_reset_coding_state.9, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_reset_coding_state.14, label %ctrl6

ctrl6:                                            ; preds = %ctrl5
  %8 = icmp eq i32 %0, 7
  br i1 %8, label %func_reset_coding_state.16, label %ctrl7

ctrl7:                                            ; preds = %ctrl6
  %9 = icmp eq i32 %0, 8
  br i1 %9, label %func_reset_coding_state.18, label %ctrl8

ctrl8:                                            ; preds = %ctrl7
  %10 = icmp eq i32 %0, 9
  br i1 %10, label %func_reset_coding_state.19, label %ctrl9

ctrl9:                                            ; preds = %ctrl8
  %11 = icmp eq i32 %0, 10
  br i1 %11, label %func_reset_coding_state.21, label %ctrl10

ctrl10:                                           ; preds = %ctrl9
  %12 = icmp eq i32 %0, 11
  br i1 %12, label %func_reset_coding_state.24, label %ctrl11

ctrl11:                                           ; preds = %ctrl10
  %13 = icmp eq i32 %0, 12
  br i1 %13, label %func_reset_coding_state.25, label %ctrl12

ctrl12:                                           ; preds = %ctrl11
  %14 = icmp eq i32 %0, 13
  br i1 %14, label %func_reset_coding_state.26, label %ctrl13

ctrl13:                                           ; preds = %ctrl12
  %15 = icmp eq i32 %0, 14
  br i1 %15, label %func_reset_coding_state.27, label %func_reset_coding_state.29
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @store_coding_state.1(%struct.CSobj* %cs) #0 {
entry:
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 1489834608, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @reset_coding_state.2(%struct.CSobj* %cs) #0 {
entry:
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %bs_src = alloca %struct.Bitstream*, align 8
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  ...
  %cs.addr = alloca %struct.CSobj*, align 8
  %canary = alloca i32
  store i32 1695670286, i32* %canary
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  store %struct.CSobj* %cs, %struct.CSobj** %cs.addr, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %currentSlice = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 50
...
entry:
  ...
  %bs_src = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 1781957695, i32* %canary
  %cs.addr = alloca %struct.CSobj*, align 8
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %currMB = alloca %struct.macroblock*, align 8
  %bs_dest = alloca %struct.Bitstream*, align 8
...
entry:
  ...
  %bs_src = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 698885889, i32* %canary
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %currMB = alloca %struct.macroblock*, align 8
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  store %struct.CSobj* %cs, %struct.CSobj** %cs.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @reset_coding_state.5(%struct.CSobj* %cs) #0 {
entry:
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %bs_src = alloca %struct.Bitstream*, align 8
  %cs.addr = alloca %struct.CSobj*, align 8
  ...
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 1045417910, i32* %canary
  %currMB = alloca %struct.macroblock*, align 8
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  store %struct.CSobj* %cs, %struct.CSobj** %cs.addr, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @reset_coding_state.6(%struct.CSobj* %cs) #0 {
entry:
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %currMB = alloca %struct.macroblock*, align 8
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 805772743, i32* %canary
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  store %struct.CSobj* %cs, %struct.CSobj** %cs.addr, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %currentSlice = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 50
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @store_coding_state.7(%struct.CSobj* %cs) #0 {
entry:
  %currMB = alloca %struct.macroblock*, align 8
  %bs_dest = alloca %struct.Bitstream*, align 8
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  ...
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %canary = alloca i32
  store i32 1595171961, i32* %canary
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  store %struct.CSobj* %cs, %struct.CSobj** %cs.addr, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @reset_coding_state.8(%struct.CSobj* %cs) #0 {
entry:
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %bs_dest = alloca %struct.Bitstream*, align 8
  %currMB = alloca %struct.macroblock*, align 8
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 2114280678, i32* %canary
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %bs_src = alloca %struct.Bitstream*, align 8
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @store_coding_state.10(%struct.CSobj* %cs) #0 {
entry:
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %bs_dest = alloca %struct.Bitstream*, align 8
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  ...
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %canary = alloca i32
  store i32 803361599, i32* %canary
  %i = alloca i32, align 4
  %cs.addr = alloca %struct.CSobj*, align 8
  %bs_src = alloca %struct.Bitstream*, align 8
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @store_coding_state.11(%struct.CSobj* %cs) #0 {
entry:
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %currMB = alloca %struct.macroblock*, align 8
  %bs_dest = alloca %struct.Bitstream*, align 8
  ...
  %bs_src = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 1954084359, i32* %canary
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  store %struct.CSobj* %cs, %struct.CSobj** %cs.addr, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %currentSlice = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 50
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @store_coding_state.12(%struct.CSobj* %cs) #0 {
entry:
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  ...
  %cs.addr = alloca %struct.CSobj*, align 8
  %canary = alloca i32
  store i32 1167269400, i32* %canary
  %bs_src = alloca %struct.Bitstream*, align 8
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  store %struct.CSobj* %cs, %struct.CSobj** %cs.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @store_coding_state.13(%struct.CSobj* %cs) #0 {
entry:
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %currMB = alloca %struct.macroblock*, align 8
  %cs.addr = alloca %struct.CSobj*, align 8
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1838303489, i32* %canary
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %bs_src = alloca %struct.Bitstream*, align 8
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @reset_coding_state.14(%struct.CSobj* %cs) #0 {
entry:
  %cs.addr = alloca %struct.CSobj*, align 8
  %currMB = alloca %struct.macroblock*, align 8
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %bs_src = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 104619746, i32* %canary
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
...
entry:
  ...
  %bs_dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 1954563696, i32* %canary
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @reset_coding_state.16(%struct.CSobj* %cs) #0 {
entry:
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %i = alloca i32, align 4
  %bs_dest = alloca %struct.Bitstream*, align 8
  ...
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %canary = alloca i32
  store i32 541294891, i32* %canary
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %currMB = alloca %struct.macroblock*, align 8
  store %struct.CSobj* %cs, %struct.CSobj** %cs.addr, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @store_coding_state.17(%struct.CSobj* %cs) #0 {
entry:
  %i = alloca i32, align 4
  %currMB = alloca %struct.macroblock*, align 8
  %cs.addr = alloca %struct.CSobj*, align 8
  ...
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %canary = alloca i32
  store i32 1920110255, i32* %canary
  %bs_src = alloca %struct.Bitstream*, align 8
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %bs_dest = alloca %struct.Bitstream*, align 8
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @reset_coding_state.18(%struct.CSobj* %cs) #0 {
entry:
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %bs_src = alloca %struct.Bitstream*, align 8
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %canary = alloca i32
  store i32 1161722397, i32* %canary
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @reset_coding_state.19(%struct.CSobj* %cs) #0 {
entry:
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %canary = alloca i32
  store i32 1043482278, i32* %canary
  %cs.addr = alloca %struct.CSobj*, align 8
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %i = alloca i32, align 4
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @store_coding_state.20(%struct.CSobj* %cs) #0 {
entry:
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %i = alloca i32, align 4
  %bs_dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 559929374, i32* %canary
  %bs_src = alloca %struct.Bitstream*, align 8
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @reset_coding_state.21(%struct.CSobj* %cs) #0 {
entry:
  %cs.addr = alloca %struct.CSobj*, align 8
  %currMB = alloca %struct.macroblock*, align 8
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %bs_src = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 337354160, i32* %canary
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %bs_dest = alloca %struct.Bitstream*, align 8
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @store_coding_state.22(%struct.CSobj* %cs) #0 {
entry:
  %canary = alloca i32
  store i32 357552643, i32* %canary
  %bs_src = alloca %struct.Bitstream*, align 8
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %bs_dest = alloca %struct.Bitstream*, align 8
  %currMB = alloca %struct.macroblock*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @store_coding_state.23(%struct.CSobj* %cs) #0 {
entry:
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 126946323, i32* %canary
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  store %struct.CSobj* %cs, %struct.CSobj** %cs.addr, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %currentSlice = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 50
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @reset_coding_state.24(%struct.CSobj* %cs) #0 {
entry:
  %bs_src = alloca %struct.Bitstream*, align 8
  %cs.addr = alloca %struct.CSobj*, align 8
  %bs_dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 2077273163, i32* %canary
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %i = alloca i32, align 4
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @reset_coding_state.25(%struct.CSobj* %cs) #0 {
entry:
  %i = alloca i32, align 4
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  ...
  %bs_dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 1914671437, i32* %canary
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  store %struct.CSobj* %cs, %struct.CSobj** %cs.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @reset_coding_state.26(%struct.CSobj* %cs) #0 {
entry:
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  ...
  %cs.addr = alloca %struct.CSobj*, align 8
  %canary = alloca i32
  store i32 186553797, i32* %canary
  %i = alloca i32, align 4
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @reset_coding_state.27(%struct.CSobj* %cs) #0 {
entry:
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %bs_dest = alloca %struct.Bitstream*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @store_coding_state.28(%struct.CSobj* %cs) #0 {
entry:
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %canary = alloca i32
  store i32 564345580, i32* %canary
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %bs_src = alloca %struct.Bitstream*, align 8
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @reset_coding_state.29(%struct.CSobj* %cs) #0 {
entry:
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %canary = alloca i32
  store i32 2100835883, i32* %canary
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %i = alloca i32, align 4
  %cs.addr = alloca %struct.CSobj*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @store_coding_state.30(%struct.CSobj* %cs) #0 {
entry:
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  ...
  %bs_src = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 583335136, i32* %canary
  %currMB = alloca %struct.macroblock*, align 8
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @store_coding_state.31(%struct.CSobj* %cs) #0 {
entry:
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %cs.addr = alloca %struct.CSobj*, align 8
  %bs_src = alloca %struct.Bitstream*, align 8
  ...
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 1632267438, i32* %canary
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %currMB = alloca %struct.macroblock*, align 8
  store %struct.CSobj* %cs, %struct.CSobj** %cs.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @store_coding_state.32(%struct.CSobj* %cs) #0 {
entry:
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 1266081000, i32* %canary
  %currMB = alloca %struct.macroblock*, align 8
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %bs_src = alloca %struct.Bitstream*, align 8
