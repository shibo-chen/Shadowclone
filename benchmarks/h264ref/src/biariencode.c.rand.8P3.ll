; ModuleID = 'biariencode.c.rand.8P3.bc'
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_arienco_start_encoding.7, label %ctrl0

func_arienco_start_encoding.7:                    ; preds = %rand_bb
  call void @arienco_start_encoding.7(%struct.EncodingEnvironment* %eep, i8* %code_buffer, i32* %code_len, i32 %slice_type)
  ret void

func_arienco_start_encoding.10:                   ; preds = %ctrl0
  call void @arienco_start_encoding.10(%struct.EncodingEnvironment* %eep, i8* %code_buffer, i32* %code_len, i32 %slice_type)
  ret void

func_arienco_start_encoding.12:                   ; preds = %ctrl1
  call void @arienco_start_encoding.12(%struct.EncodingEnvironment* %eep, i8* %code_buffer, i32* %code_len, i32 %slice_type)
  ret void

func_arienco_start_encoding.14:                   ; preds = %ctrl2
  call void @arienco_start_encoding.14(%struct.EncodingEnvironment* %eep, i8* %code_buffer, i32* %code_len, i32 %slice_type)
  ret void

func_arienco_start_encoding.22:                   ; preds = %ctrl3
  call void @arienco_start_encoding.22(%struct.EncodingEnvironment* %eep, i8* %code_buffer, i32* %code_len, i32 %slice_type)
  ret void

func_arienco_start_encoding.23:                   ; preds = %ctrl4
  call void @arienco_start_encoding.23(%struct.EncodingEnvironment* %eep, i8* %code_buffer, i32* %code_len, i32 %slice_type)
  ret void
...
func_arienco_start_encoding.28:                   ; preds = %ctrl5
  call void @arienco_start_encoding.28(%struct.EncodingEnvironment* %eep, i8* %code_buffer, i32* %code_len, i32 %slice_type)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_arienco_start_encoding.10, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_arienco_start_encoding.12, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_arienco_start_encoding.14, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_arienco_start_encoding.22, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_arienco_start_encoding.23, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_arienco_start_encoding.27, label %func_arienco_start_encoding.28
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_biari_encode_symbol.2, label %ctrl0

func_biari_encode_symbol.2:                       ; preds = %rand_bb
  call void @biari_encode_symbol.2(%struct.EncodingEnvironment* %eep, i16 %symbol, %struct.BiContextType* %bi_ct)
  ret void

func_biari_encode_symbol.9:                       ; preds = %ctrl0
  call void @biari_encode_symbol.9(%struct.EncodingEnvironment* %eep, i16 %symbol, %struct.BiContextType* %bi_ct)
  ret void

func_biari_encode_symbol.20:                      ; preds = %ctrl1
  call void @biari_encode_symbol.20(%struct.EncodingEnvironment* %eep, i16 %symbol, %struct.BiContextType* %bi_ct)
  ret void

func_biari_encode_symbol.24:                      ; preds = %ctrl2
  call void @biari_encode_symbol.24(%struct.EncodingEnvironment* %eep, i16 %symbol, %struct.BiContextType* %bi_ct)
  ret void

func_biari_encode_symbol.25:                      ; preds = %ctrl3
  call void @biari_encode_symbol.25(%struct.EncodingEnvironment* %eep, i16 %symbol, %struct.BiContextType* %bi_ct)
  ret void

func_biari_encode_symbol.26:                      ; preds = %ctrl4
  call void @biari_encode_symbol.26(%struct.EncodingEnvironment* %eep, i16 %symbol, %struct.BiContextType* %bi_ct)
  ret void
...
func_biari_encode_symbol.34:                      ; preds = %ctrl5
  call void @biari_encode_symbol.34(%struct.EncodingEnvironment* %eep, i16 %symbol, %struct.BiContextType* %bi_ct)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_biari_encode_symbol.9, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_biari_encode_symbol.20, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_biari_encode_symbol.24, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_biari_encode_symbol.25, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_biari_encode_symbol.26, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_biari_encode_symbol.29, label %func_biari_encode_symbol.34
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_biari_encode_symbol_eq_prob.1, label %ctrl0

func_biari_encode_symbol_eq_prob.1:               ; preds = %rand_bb
  call void @biari_encode_symbol_eq_prob.1(%struct.EncodingEnvironment* %eep, i16 %symbol)
  ret void

func_biari_encode_symbol_eq_prob.5:               ; preds = %ctrl0
  call void @biari_encode_symbol_eq_prob.5(%struct.EncodingEnvironment* %eep, i16 %symbol)
  ret void
...
func_biari_encode_symbol_eq_prob.16:              ; preds = %ctrl2
  call void @biari_encode_symbol_eq_prob.16(%struct.EncodingEnvironment* %eep, i16 %symbol)
  ret void

func_biari_encode_symbol_eq_prob.19:              ; preds = %ctrl3
  call void @biari_encode_symbol_eq_prob.19(%struct.EncodingEnvironment* %eep, i16 %symbol)
  ret void

func_biari_encode_symbol_eq_prob.21:              ; preds = %ctrl3
  call void @biari_encode_symbol_eq_prob.21(%struct.EncodingEnvironment* %eep, i16 %symbol)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_biari_encode_symbol_eq_prob.5, label %ctrl1
...
ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_biari_encode_symbol_eq_prob.16, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_biari_encode_symbol_eq_prob.19, label %func_biari_encode_symbol_eq_prob.21
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_biari_encode_symbol_final.11, label %ctrl0

func_biari_encode_symbol_final.11:                ; preds = %rand_bb
  call void @biari_encode_symbol_final.11(%struct.EncodingEnvironment* %eep, i16 %symbol)
  ret void

func_biari_encode_symbol_final.13:                ; preds = %ctrl0
  call void @biari_encode_symbol_final.13(%struct.EncodingEnvironment* %eep, i16 %symbol)
  ret void

func_biari_encode_symbol_final.30:                ; preds = %ctrl1
  call void @biari_encode_symbol_final.30(%struct.EncodingEnvironment* %eep, i16 %symbol)
  ret void

func_biari_encode_symbol_final.31:                ; preds = %ctrl2
  call void @biari_encode_symbol_final.31(%struct.EncodingEnvironment* %eep, i16 %symbol)
  ret void

func_biari_encode_symbol_final.32:                ; preds = %ctrl3
  call void @biari_encode_symbol_final.32(%struct.EncodingEnvironment* %eep, i16 %symbol)
  ret void

func_biari_encode_symbol_final.33:                ; preds = %ctrl4
  call void @biari_encode_symbol_final.33(%struct.EncodingEnvironment* %eep, i16 %symbol)
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_biari_encode_symbol_final.13, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_biari_encode_symbol_final.30, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_biari_encode_symbol_final.31, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_biari_encode_symbol_final.32, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_biari_encode_symbol_final.33, label %ctrl5
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_biari_init_context.3, label %ctrl0

func_biari_init_context.3:                        ; preds = %rand_bb
  call void @biari_init_context.3(%struct.BiContextType* %ctx, i32* %ini)
  ret void

func_biari_init_context.4:                        ; preds = %ctrl0
  call void @biari_init_context.4(%struct.BiContextType* %ctx, i32* %ini)
  ret void

func_biari_init_context.6:                        ; preds = %ctrl1
  call void @biari_init_context.6(%struct.BiContextType* %ctx, i32* %ini)
  ret void

func_biari_init_context.15:                       ; preds = %ctrl2
  call void @biari_init_context.15(%struct.BiContextType* %ctx, i32* %ini)
  ret void

func_biari_init_context.17:                       ; preds = %ctrl3
  call void @biari_init_context.17(%struct.BiContextType* %ctx, i32* %ini)
  ret void

func_biari_init_context.18:                       ; preds = %ctrl3
  call void @biari_init_context.18(%struct.BiContextType* %ctx, i32* %ini)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_biari_init_context.4, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_biari_init_context.6, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_biari_init_context.15, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_biari_init_context.17, label %func_biari_init_context.18
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_encode_symbol_eq_prob.1(%struct.EncodingEnvironment* %eep, i16 signext %symbol) #0 {
entry:
  %symbol.addr = alloca i16, align 2
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 65758022, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_encode_symbol.2(%struct.EncodingEnvironment* %eep, i16 signext %symbol, %struct.BiContextType* %bi_ct) #0 {
entry:
  %rLPS = alloca i32, align 4
  %low = alloca i32, align 4
  %canary = alloca i32
  store i32 672563747, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_init_context.3(%struct.BiContextType* %ctx, i32* %ini) #0 {
entry:
  %canary = alloca i32
  store i32 766968957, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_init_context.4(%struct.BiContextType* %ctx, i32* %ini) #0 {
entry:
  %canary = alloca i32
  store i32 911426221, i32* %canary
  %pstate = alloca i32, align 4
  %ini.addr = alloca i32*, align 8
  %ctx.addr = alloca %struct.BiContextType*, align 8
  store %struct.BiContextType* %ctx, %struct.BiContextType** %ctx.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_encode_symbol_eq_prob.5(%struct.EncodingEnvironment* %eep, i16 signext %symbol) #0 {
entry:
  %canary = alloca i32
  store i32 1925480797, i32* %canary
  %low = alloca i32, align 4
  %symbol.addr = alloca i16, align 2
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
...
if.end124:                                        ; preds = %if.end123, %while.end51
  ...
  store i32 %inc127, i32* %C126, align 8
  %104 = load i32, i32* %canary
  %105 = icmp eq i32 %104, 1925480797
  br i1 %105, label %106, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_init_context.6(%struct.BiContextType* %ctx, i32* %ini) #0 {
entry:
  %ctx.addr = alloca %struct.BiContextType*, align 8
  %canary = alloca i32
  store i32 675056062, i32* %canary
  %ini.addr = alloca i32*, align 8
  %pstate = alloca i32, align 4
  store %struct.BiContextType* %ctx, %struct.BiContextType** %ctx.addr, align 8
  store i32* %ini, i32** %ini.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @arienco_start_encoding.7(%struct.EncodingEnvironment* %eep, i8* %code_buffer, i32* %code_len, i32 %slice_type) #0 {
entry:
  %code_buffer.addr = alloca i8*, align 8
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 1694060216, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1621309201, i32* %canary
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %low = alloca i32, align 4
  %symbol.addr = alloca i16, align 2
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
...
if.end124:                                        ; preds = %if.end123, %while.end51
  ...
  store i32 %inc127, i32* %C126, align 8
  %104 = load i32, i32* %canary
  %105 = icmp eq i32 %104, 1621309201
  br i1 %105, label %106, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_encode_symbol.9(%struct.EncodingEnvironment* %eep, i16 signext %symbol, %struct.BiContextType* %bi_ct) #0 {
entry:
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %symbol.addr = alloca i16, align 2
  %rLPS = alloca i32, align 4
  %canary = alloca i32
  store i32 2055534936, i32* %canary
  %range = alloca i32, align 4
  %bi_ct.addr = alloca %struct.BiContextType*, align 8
  %low = alloca i32, align 4
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
...
while.end162:                                     ; preds = %while.cond
  ...
  store i32 %inc166, i32* %C165, align 8
  %136 = load i32, i32* %canary
  %137 = icmp eq i32 %136, 2055534936
  br i1 %137, label %138, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @arienco_start_encoding.10(%struct.EncodingEnvironment* %eep, i8* %code_buffer, i32* %code_len, i32 %slice_type) #0 {
entry:
  %code_buffer.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 172154221, i32* %canary
  %code_len.addr = alloca i32*, align 8
  %slice_type.addr = alloca i32, align 4
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_encode_symbol_final.11(%struct.EncodingEnvironment* %eep, i16 signext %symbol) #0 {
entry:
  %canary = alloca i32
  store i32 1322546795, i32* %canary
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %range = alloca i32, align 4
  %symbol.addr = alloca i16, align 2
  %low = alloca i32, align 4
...
while.end125:                                     ; preds = %while.cond
  ...
  %111 = icmp eq i32 %110, 1322546795
...
entry:
  %canary = alloca i32
  store i32 1651060578, i32* %canary
  %code_len.addr = alloca i32*, align 8
  %code_buffer.addr = alloca i8*, align 8
  %slice_type.addr = alloca i32, align 4
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_encode_symbol_final.13(%struct.EncodingEnvironment* %eep, i16 signext %symbol) #0 {
entry:
  %symbol.addr = alloca i16, align 2
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %low = alloca i32, align 4
  %canary = alloca i32
  store i32 1547054311, i32* %canary
  %range = alloca i32, align 4
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
  %0 = load %struct.EncodingEnvironment*, %struct.EncodingEnvironment** %eep.addr, align 8
...
while.end125:                                     ; preds = %while.cond
  ...
  store i32 %inc129, i32* %C128, align 8
  %110 = load i32, i32* %canary
  %111 = icmp eq i32 %110, 1547054311
  br i1 %111, label %112, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @arienco_start_encoding.14(%struct.EncodingEnvironment* %eep, i8* %code_buffer, i32* %code_len, i32 %slice_type) #0 {
entry:
  %canary = alloca i32
  store i32 1408171550, i32* %canary
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %code_len.addr = alloca i32*, align 8
  %slice_type.addr = alloca i32, align 4
  %code_buffer.addr = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_init_context.15(%struct.BiContextType* %ctx, i32* %ini) #0 {
entry:
  %canary = alloca i32
  store i32 1951346538, i32* %canary
  %ctx.addr = alloca %struct.BiContextType*, align 8
  %pstate = alloca i32, align 4
  %ini.addr = alloca i32*, align 8
  store %struct.BiContextType* %ctx, %struct.BiContextType** %ctx.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_encode_symbol_eq_prob.16(%struct.EncodingEnvironment* %eep, i16 signext %symbol) #0 {
entry:
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 1798093328, i32* %canary
  %symbol.addr = alloca i16, align 2
  %low = alloca i32, align 4
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
...
if.end124:                                        ; preds = %if.end123, %while.end51
  ...
  store i32 %inc127, i32* %C126, align 8
  %104 = load i32, i32* %canary
  %105 = icmp eq i32 %104, 1798093328
  br i1 %105, label %106, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_init_context.17(%struct.BiContextType* %ctx, i32* %ini) #0 {
entry:
  %pstate = alloca i32, align 4
  %ctx.addr = alloca %struct.BiContextType*, align 8
  %canary = alloca i32
  store i32 717481821, i32* %canary
  %ini.addr = alloca i32*, align 8
  store %struct.BiContextType* %ctx, %struct.BiContextType** %ctx.addr, align 8
  store i32* %ini, i32** %ini.addr, align 8
  %0 = load i32*, i32** %ini.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 809825719, i32* %canary
  %ini.addr = alloca i32*, align 8
  %ctx.addr = alloca %struct.BiContextType*, align 8
  %pstate = alloca i32, align 4
  store %struct.BiContextType* %ctx, %struct.BiContextType** %ctx.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_encode_symbol_eq_prob.19(%struct.EncodingEnvironment* %eep, i16 signext %symbol) #0 {
entry:
  %low = alloca i32, align 4
  %canary = alloca i32
  store i32 800491433, i32* %canary
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %symbol.addr = alloca i16, align 2
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
...
entry:
  %canary = alloca i32
  store i32 1435462237, i32* %canary
  %rLPS = alloca i32, align 4
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %range = alloca i32, align 4
  %bi_ct.addr = alloca %struct.BiContextType*, align 8
...
while.end162:                                     ; preds = %while.cond
  ...
  store i32 %inc166, i32* %C165, align 8
  %136 = load i32, i32* %canary
  %137 = icmp eq i32 %136, 1435462237
  br i1 %137, label %138, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_encode_symbol_eq_prob.21(%struct.EncodingEnvironment* %eep, i16 signext %symbol) #0 {
entry:
  %symbol.addr = alloca i16, align 2
  %low = alloca i32, align 4
  %canary = alloca i32
  store i32 2116954609, i32* %canary
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
  %0 = load %struct.EncodingEnvironment*, %struct.EncodingEnvironment** %eep.addr, align 8
...
if.end124:                                        ; preds = %if.end123, %while.end51
  ...
  store i32 %inc127, i32* %C126, align 8
  %104 = load i32, i32* %canary
  %105 = icmp eq i32 %104, 2116954609
  br i1 %105, label %106, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @arienco_start_encoding.22(%struct.EncodingEnvironment* %eep, i8* %code_buffer, i32* %code_len, i32 %slice_type) #0 {
entry:
  %canary = alloca i32
  store i32 1175464365, i32* %canary
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %code_buffer.addr = alloca i8*, align 8
  %slice_type.addr = alloca i32, align 4
  %code_len.addr = alloca i32*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @arienco_start_encoding.23(%struct.EncodingEnvironment* %eep, i8* %code_buffer, i32* %code_len, i32 %slice_type) #0 {
entry:
  %code_buffer.addr = alloca i8*, align 8
  %code_len.addr = alloca i32*, align 8
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 1014801692, i32* %canary
  %slice_type.addr = alloca i32, align 4
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i8* %code_buffer, i8** %code_buffer.addr, align 8
  store i32* %code_len, i32** %code_len.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 974616385, i32* %canary
  %low = alloca i32, align 4
  %bi_ct.addr = alloca %struct.BiContextType*, align 8
  %range = alloca i32, align 4
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_encode_symbol.25(%struct.EncodingEnvironment* %eep, i16 signext %symbol, %struct.BiContextType* %bi_ct) #0 {
entry:
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %symbol.addr = alloca i16, align 2
  %range = alloca i32, align 4
  %bi_ct.addr = alloca %struct.BiContextType*, align 8
  %canary = alloca i32
  store i32 2029890376, i32* %canary
  %low = alloca i32, align 4
  %rLPS = alloca i32, align 4
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
...
while.end162:                                     ; preds = %while.cond
  ...
  store i32 %inc166, i32* %C165, align 8
  %136 = load i32, i32* %canary
  %137 = icmp eq i32 %136, 2029890376
  br i1 %137, label %138, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_encode_symbol.26(%struct.EncodingEnvironment* %eep, i16 signext %symbol, %struct.BiContextType* %bi_ct) #0 {
entry:
  %symbol.addr = alloca i16, align 2
  %canary = alloca i32
  store i32 780690635, i32* %canary
  %range = alloca i32, align 4
  %bi_ct.addr = alloca %struct.BiContextType*, align 8
  %rLPS = alloca i32, align 4
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
...
entry:
  ...
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 1875531408, i32* %canary
  %slice_type.addr = alloca i32, align 4
  %code_buffer.addr = alloca i8*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i8* %code_buffer, i8** %code_buffer.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @arienco_start_encoding.28(%struct.EncodingEnvironment* %eep, i8* %code_buffer, i32* %code_len, i32 %slice_type) #0 {
entry:
  %code_buffer.addr = alloca i8*, align 8
  %slice_type.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1770614937, i32* %canary
  %code_len.addr = alloca i32*, align 8
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i8* %code_buffer, i8** %code_buffer.addr, align 8
...
entry:
  ...
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 430034814, i32* %canary
  %bi_ct.addr = alloca %struct.BiContextType*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
  store %struct.BiContextType* %bi_ct, %struct.BiContextType** %bi_ct.addr, align 8
...
entry:
  ...
  %symbol.addr = alloca i16, align 2
  %canary = alloca i32
  store i32 1846761684, i32* %canary
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %range = alloca i32, align 4
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
...
while.end125:                                     ; preds = %while.cond
  ...
  store i32 %inc129, i32* %C128, align 8
  %110 = load i32, i32* %canary
  %111 = icmp eq i32 %110, 1846761684
  br i1 %111, label %112, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_encode_symbol_final.31(%struct.EncodingEnvironment* %eep, i16 signext %symbol) #0 {
entry:
  %symbol.addr = alloca i16, align 2
  %canary = alloca i32
  store i32 1748999273, i32* %canary
  %range = alloca i32, align 4
  %low = alloca i32, align 4
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
...
while.end125:                                     ; preds = %while.cond
  ...
  store i32 %inc129, i32* %C128, align 8
  %110 = load i32, i32* %canary
  %111 = icmp eq i32 %110, 1748999273
  br i1 %111, label %112, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_encode_symbol_final.32(%struct.EncodingEnvironment* %eep, i16 signext %symbol) #0 {
entry:
  %canary = alloca i32
  store i32 967142098, i32* %canary
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %range = alloca i32, align 4
  %low = alloca i32, align 4
  %symbol.addr = alloca i16, align 2
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_encode_symbol_final.33(%struct.EncodingEnvironment* %eep, i16 signext %symbol) #0 {
entry:
  %canary = alloca i32
  store i32 2014236220, i32* %canary
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %symbol.addr = alloca i16, align 2
  %range = alloca i32, align 4
  %low = alloca i32, align 4
...
while.end125:                                     ; preds = %while.cond
  ...
  store i32 %inc129, i32* %C128, align 8
  %110 = load i32, i32* %canary
  %111 = icmp eq i32 %110, 2014236220
  br i1 %111, label %112, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_encode_symbol.34(%struct.EncodingEnvironment* %eep, i16 signext %symbol, %struct.BiContextType* %bi_ct) #0 {
entry:
  %canary = alloca i32
  store i32 1234460482, i32* %canary
  %bi_ct.addr = alloca %struct.BiContextType*, align 8
  %range = alloca i32, align 4
  %low = alloca i32, align 4
  %rLPS = alloca i32, align 4
...
while.end162:                                     ; preds = %while.cond
  ...
  store i32 %inc166, i32* %C165, align 8
  %136 = load i32, i32* %canary
  %137 = icmp eq i32 %136, 1234460482
  br i1 %137, label %138, label %func_exit
...
entry:
  %range = alloca i32, align 4
  %canary = alloca i32
  store i32 1942200791, i32* %canary
  %symbol.addr = alloca i16, align 2
  %low = alloca i32, align 4
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
...
while.end125:                                     ; preds = %while.cond
  ...
  store i32 %inc129, i32* %C128, align 8
  %110 = load i32, i32* %canary
  %111 = icmp eq i32 %110, 1942200791
  br i1 %111, label %112, label %func_exit
...
entry:
  %canary = alloca i32
  store i32 181818406, i32* %canary
  %range = alloca i32, align 4
  %symbol.addr = alloca i16, align 2
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %low = alloca i32, align 4
