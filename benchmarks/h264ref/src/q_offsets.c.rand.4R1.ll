; ModuleID = 'q_offsets.c.rand.4R1.bc'
...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_CheckOffsetParameterName.3, label %ctrl0

func_CheckOffsetParameterName.3:                  ; preds = %rand_bb
  %2 = call i32 @CheckOffsetParameterName.3(i8* %s, i32* %type)
  ret i32 %2
...
func_CheckOffsetParameterName.12:                 ; preds = %ctrl1
  %4 = call i32 @CheckOffsetParameterName.12(i8* %s, i32* %type)
  ret i32 %4

func_CheckOffsetParameterName.14:                 ; preds = %ctrl1
  %5 = call i32 @CheckOffsetParameterName.14(i8* %s, i32* %type)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_CheckOffsetParameterName.4, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_CheckOffsetParameterName.12, label %func_CheckOffsetParameterName.14
}
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_ParseQOffsetMatrix.9, label %func_ParseQOffsetMatrix.10
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_CalculateOffsetParam.6, label %ctrl0

func_CalculateOffsetParam.6:                      ; preds = %rand_bb
  call void @CalculateOffsetParam.6()
  ret void

func_CalculateOffsetParam.13:                     ; preds = %ctrl0
  call void @CalculateOffsetParam.13()
  ret void

func_CalculateOffsetParam.15:                     ; preds = %ctrl1
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_CalculateOffsetParam.13, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_CalculateOffsetParam.15, label %func_CalculateOffsetParam.16
}
...
func_CalculateOffset8Param.7:                     ; preds = %ctrl0
  call void @CalculateOffset8Param.7()
  ret void

func_CalculateOffset8Param.8:                     ; preds = %ctrl1
  call void @CalculateOffset8Param.8()
  ret void

func_CalculateOffset8Param.11:                    ; preds = %ctrl1
  call void @CalculateOffset8Param.11()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_CalculateOffset8Param.7, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_CalculateOffset8Param.8, label %func_CalculateOffset8Param.11
}
...
entry:
  ...
  %canary = alloca i32
  store i32 1184553990, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 489250711, i32* %canary
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1021940811, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1565314393, i32* %canary
  %retval = alloca i32, align 4
  %i = alloca i32, align 4
  %type.addr = alloca i32*, align 8
  %s.addr = alloca i8*, align 8
...
entry:
  ...
  %IntContent = alloca i32, align 4
  %canary = alloca i32
  store i32 1365730667, i32* %canary
  %InItem = alloca i32, align 4
  %OffsetList = alloca i16*, align 8
  %cnt = alloca i32, align 4
  %MapIdx = alloca i32, align 4
...
entry:
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1894304852, i32* %canary
  %k = alloca i32, align 4
...
if.end225:                                        ; preds = %for.end224, %for.end102
  ...
  %133 = icmp eq i32 %132, 1894304852
...
entry:
  %canary = alloca i32
  store i32 529238099, i32* %canary
  %q_bits = alloca i32, align 4
  %i = alloca i32, align 4
  %temp = alloca i32, align 4
  %j = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 123674806, i32* %canary
  %q_bits = alloca i32, align 4
  %i = alloca i32, align 4
  %temp = alloca i32, align 4
  %k = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1714124223, i32* %canary
  %cnt = alloca i32, align 4
  %MapIdx = alloca i32, align 4
  %items = alloca [1000 x i8*], align 16
  %bufend = alloca i8*, align 8
...
entry:
  ...
  %buf.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 737445157, i32* %canary
  %cnt = alloca i32, align 4
  %item = alloca i32, align 4
  %InString = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1167447109, i32* %canary
  %j = alloca i32, align 4
  %temp = alloca i32, align 4
  %k = alloca i32, align 4
  %i = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 511704016, i32* %canary
  %type.addr = alloca i32*, align 8
  %i = alloca i32, align 4
  %s.addr = alloca i8*, align 8
  %retval = alloca i32, align 4
...
entry:
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 517486952, i32* %canary
  %qp_per = alloca i32, align 4
  %temp = alloca i32, align 4
  %i = alloca i32, align 4
  %k = alloca i32, align 4
...
entry:
  ...
  %s.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1218457938, i32* %canary
  %type.addr = alloca i32*, align 8
  %i = alloca i32, align 4
  store i8* %s, i8** %s.addr, align 8
  store i32* %type, i32** %type.addr, align 8
...
entry:
  ...
  %qp_per = alloca i32, align 4
  %canary = alloca i32
  store i32 2117914301, i32* %canary
  %i = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %OffsetMatrixPresentFlag = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 147
  %1 = load i32, i32* %OffsetMatrixPresentFlag, align 8
...
if.end225:                                        ; preds = %for.end224, %for.end102
  %132 = load i32, i32* %canary
  %133 = icmp eq i32 %132, 2117914301
  br i1 %133, label %134, label %func_exit
...
entry:
  %qp_per = alloca i32, align 4
  %canary = alloca i32
  store i32 1441906025, i32* %canary
  %i = alloca i32, align 4
  %temp = alloca i32, align 4
  %j = alloca i32, align 4
  %k = alloca i32, align 4
...
if.end225:                                        ; preds = %for.end224, %for.end102
  %132 = load i32, i32* %canary
  %133 = icmp eq i32 %132, 1441906025
  br i1 %133, label %134, label %func_exit
