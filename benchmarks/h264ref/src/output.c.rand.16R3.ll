; ModuleID = 'output.c.rand.16R3.bc'
...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_testEndian.17, label %func_testEndian.20

func_testEndian.17:                               ; preds = %rand_bb
  %2 = call i32 @testEndian.17()
  ret i32 %2

func_testEndian.20:                               ; preds = %rand_bb
  %3 = call i32 @testEndian.20()
  ret i32 %3
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_img2buf.11, label %ctrl0

func_img2buf.11:                                  ; preds = %rand_bb
  call void @img2buf.11(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom)
  ret void

func_img2buf.28:                                  ; preds = %ctrl0
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_img2buf.28, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_img2buf.29, label %ctrl2
...
ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_img2buf.33, label %ctrl4
...
ctrl6:                                            ; preds = %ctrl5
  %8 = icmp eq i32 %0, 7
  br i1 %8, label %func_img2buf.41, label %ctrl7

ctrl7:                                            ; preds = %ctrl6
  %9 = icmp eq i32 %0, 8
  br i1 %9, label %func_img2buf.44, label %ctrl8
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_write_picture.22, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_write_picture.23, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_write_picture.24, label %ctrl3
...
func_write_out_picture.6:                         ; preds = %ctrl0
  call void @write_out_picture.6(%struct.storable_picture* %p, i32 %p_out)
  ret void

func_write_out_picture.8:                         ; preds = %ctrl1
  call void @write_out_picture.8(%struct.storable_picture* %p, i32 %p_out)
  ret void

func_write_out_picture.12:                        ; preds = %ctrl2
  call void @write_out_picture.12(%struct.storable_picture* %p, i32 %p_out)
  ret void
...
func_write_out_picture.27:                        ; preds = %ctrl4
  call void @write_out_picture.27(%struct.storable_picture* %p, i32 %p_out)
  ret void

func_write_out_picture.31:                        ; preds = %ctrl5
...
func_write_out_picture.40:                        ; preds = %ctrl11
...
func_write_out_picture.43:                        ; preds = %ctrl13
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_write_out_picture.6, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_write_out_picture.8, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_write_out_picture.12, label %ctrl3
...
ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_write_out_picture.27, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_write_out_picture.31, label %ctrl6
...
ctrl11:                                           ; preds = %ctrl10
  %13 = icmp eq i32 %0, 12
  br i1 %13, label %func_write_out_picture.40, label %ctrl12
...
ctrl13:                                           ; preds = %ctrl12
  %15 = icmp eq i32 %0, 14
  br i1 %15, label %func_write_out_picture.43, label %func_write_out_picture.45
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_clear_picture.10, label %func_clear_picture.18

func_clear_picture.10:                            ; preds = %rand_bb
  call void @clear_picture.10(%struct.storable_picture* %p)
  ret void

func_clear_picture.18:                            ; preds = %rand_bb
  call void @clear_picture.18(%struct.storable_picture* %p)
  ret void
}
...
func_write_unpaired_field.3:                      ; preds = %ctrl0
  call void @write_unpaired_field.3(%struct.frame_store* %fs, i32 %p_out)
  ret void

func_write_unpaired_field.7:                      ; preds = %ctrl1
  call void @write_unpaired_field.7(%struct.frame_store* %fs, i32 %p_out)
  ret void

func_write_unpaired_field.9:                      ; preds = %ctrl2
  call void @write_unpaired_field.9(%struct.frame_store* %fs, i32 %p_out)
  ret void

func_write_unpaired_field.13:                     ; preds = %ctrl3
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_write_unpaired_field.3, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_write_unpaired_field.7, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_write_unpaired_field.9, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_write_unpaired_field.13, label %func_write_unpaired_field.19
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_write_stored_frame.14, label %func_write_stored_frame.16
...
entry:
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2087806577, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 188917995, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_unpaired_field.3(%struct.frame_store* %fs, i32 %p_out) #0 {
entry:
  %fs.addr = alloca %struct.frame_store*, align 8
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1100904855, i32* %canary
  %p = alloca %struct.storable_picture*, align 8
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  %0 = load %struct.frame_store*, %struct.frame_store** %fs.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1644440734, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  %p_out.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 488849643, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_out_picture.6(%struct.storable_picture* %p, i32 %p_out) #0 {
entry:
  %crop_right = alloca i32, align 4
  %rgb_output = alloca i32, align 4
  %SubHeightC = alloca [4 x i32], align 16
  ...
  %SubWidthC = alloca [4 x i32], align 16
  %canary = alloca i32
  store i32 761754433, i32* %canary
  %symbol_size_in_bytes = alloca i32, align 4
  %crop_bottom = alloca i32, align 4
  %crop_top = alloca i32, align 4
  %buf = alloca i8*, align 8
...
entry:
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 826833423, i32* %canary
  %p = alloca %struct.storable_picture*, align 8
  %fs.addr = alloca %struct.frame_store*, align 8
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  ...
  %SubWidthC = alloca [4 x i32], align 16
  %canary = alloca i32
  store i32 825507270, i32* %canary
  %crop_right = alloca i32, align 4
  %crop_top = alloca i32, align 4
  %buf = alloca i8*, align 8
  %symbol_size_in_bytes = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1640637621, i32* %canary
  %p_out.addr = alloca i32, align 4
  %fs.addr = alloca %struct.frame_store*, align 8
  %p = alloca %struct.storable_picture*, align 8
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @clear_picture.10(%struct.storable_picture* %p) #0 {
entry:
  %canary = alloca i32
  store i32 741406413, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @img2buf.11(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 1727987369, i32* %canary
  %i = alloca i32, align 4
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  ...
  %109 = icmp eq i32 %108, 1727987369
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_out_picture.12(%struct.storable_picture* %p, i32 %p_out) #0 {
entry:
  %buf = alloca i8*, align 8
  %rgb_output = alloca i32, align 4
  %SubHeightC = alloca [4 x i32], align 16
  %canary = alloca i32
  store i32 1923075711, i32* %canary
  %p_out.addr = alloca i32, align 4
  %crop_bottom = alloca i32, align 4
  %crop_right = alloca i32, align 4
  %p.addr = alloca %struct.storable_picture*, align 8
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1923075711
  br i1 %193, label %194, label %func_exit
...
entry:
  %fs.addr = alloca %struct.frame_store*, align 8
  %canary = alloca i32
  store i32 423967558, i32* %canary
  %p = alloca %struct.storable_picture*, align 8
  %p_out.addr = alloca i32, align 4
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  %fs.addr = alloca %struct.frame_store*, align 8
  %canary = alloca i32
  store i32 1902467562, i32* %canary
  %p_out.addr = alloca i32, align 4
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 1050388032, i32* %canary
  %p_out.addr = alloca i32, align 4
...
entry:
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 665881127, i32* %canary
  %fs.addr = alloca %struct.frame_store*, align 8
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  %0 = load i32, i32* %p_out.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @testEndian.17() #0 {
entry:
  %canary = alloca i32
  store i32 672884127, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @clear_picture.18(%struct.storable_picture* %p) #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 609883067, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 0, i32* %i, align 4
  br label %for.cond
...
entry:
  ...
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 427583712, i32* %canary
  %fs.addr = alloca %struct.frame_store*, align 8
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  %0 = load %struct.frame_store*, %struct.frame_store** %fs.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @testEndian.20() #0 {
entry:
  %canary = alloca i32
  store i32 2085567446, i32* %canary
  %p = alloca i8*, align 8
  %s = alloca i16, align 2
  %0 = bitcast i16* %s to i8*
  store i8* %0, i8** %p, align 8
...
entry:
  %crop_right = alloca i32, align 4
  %canary = alloca i32
  store i32 1439023681, i32* %canary
  %crop_bottom = alloca i32, align 4
  %buf = alloca i8*, align 8
  %p.addr = alloca %struct.storable_picture*, align 8
  %crop_left = alloca i32, align 4
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1439023681
  br i1 %193, label %194, label %func_exit
...
entry:
  ...
  %p.addr = alloca %struct.storable_picture*, align 8
  %canary = alloca i32
  store i32 1830139230, i32* %canary
  %real_structure.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  store i32 %real_structure, i32* %real_structure.addr, align 4
...
entry:
  %p.addr = alloca %struct.storable_picture*, align 8
  %canary = alloca i32
  store i32 450494306, i32* %canary
  %real_structure.addr = alloca i32, align 4
  %p_out.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  ...
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 974725740, i32* %canary
  %real_structure.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  store i32 %real_structure, i32* %real_structure.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 2142796348, i32* %canary
  %real_structure.addr = alloca i32, align 4
  %p_out.addr = alloca i32, align 4
  %p.addr = alloca %struct.storable_picture*, align 8
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 871522531, i32* %canary
  %real_structure.addr = alloca i32, align 4
  %p.addr = alloca %struct.storable_picture*, align 8
  %p_out.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
...
entry:
  ...
  %SubWidthC = alloca [4 x i32], align 16
  %canary = alloca i32
  store i32 816923794, i32* %canary
  %crop_bottom = alloca i32, align 4
  %crop_top = alloca i32, align 4
  %buf = alloca i8*, align 8
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
...
entry:
  ...
  %crop_top.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1807234084, i32* %canary
  %size_x.addr = alloca i32, align 4
  %tmp16 = alloca i16, align 2
  %symbol_size_in_bytes.addr = alloca i32, align 4
  %ui8 = alloca i8, align 1
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1807234084
  br i1 %109, label %110, label %func_exit
...
entry:
  ...
  %size_y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 230958005, i32* %canary
  %ui8 = alloca i8, align 1
  %tmp32 = alloca i64, align 8
  %size = alloca i32, align 4
  store i16** %imgX, i16*** %imgX.addr, align 8
...
entry:
  ...
  %crop_bottom.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 274913826, i32* %canary
  %theight = alloca i32, align 4
  %ui32 = alloca i64, align 8
  %crop_right.addr = alloca i32, align 4
  store i16** %imgX, i16*** %imgX.addr, align 8
...
entry:
  ...
  %symbol_size_in_bytes = alloca i32, align 4
  %canary = alloca i32
  store i32 907153842, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  %crop_right = alloca i32, align 4
  %crop_top = alloca i32, align 4
  %SubWidthC = alloca [4 x i32], align 16
...
entry:
  ...
  %size_x.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 562355426, i32* %canary
  %imgX.addr = alloca i16**, align 8
  %theight = alloca i32, align 4
  %size = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
...
entry:
  ...
  %tmp32 = alloca i64, align 8
  %canary = alloca i32
  store i32 657138208, i32* %canary
  %size_y.addr = alloca i32, align 4
  %ui8 = alloca i8, align 1
  %theight = alloca i32, align 4
  %i = alloca i32, align 4
...
entry:
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1422622344, i32* %canary
  %crop_left = alloca i32, align 4
  %SubWidthC = alloca [4 x i32], align 16
  %crop_bottom = alloca i32, align 4
  %symbol_size_in_bytes = alloca i32, align 4
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1422622344
  br i1 %193, label %194, label %func_exit
...
entry:
  ...
  %p.addr = alloca %struct.storable_picture*, align 8
  %canary = alloca i32
  store i32 793946106, i32* %canary
  %crop_bottom = alloca i32, align 4
  %crop_right = alloca i32, align 4
  %symbol_size_in_bytes = alloca i32, align 4
  %buf = alloca i8*, align 8
...
entry:
  ...
  %crop_left = alloca i32, align 4
  %canary = alloca i32
  store i32 1707761445, i32* %canary
  %SubWidthC = alloca [4 x i32], align 16
  %crop_bottom = alloca i32, align 4
  %buf = alloca i8*, align 8
  %p.addr = alloca %struct.storable_picture*, align 8
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1707761445
  br i1 %193, label %194, label %func_exit
...
entry:
  ...
  %ui8 = alloca i8, align 1
  %canary = alloca i32
  store i32 1676202527, i32* %canary
  %crop_bottom.addr = alloca i32, align 4
  %imgX.addr = alloca i16**, align 8
  %crop_right.addr = alloca i32, align 4
  store i16** %imgX, i16*** %imgX.addr, align 8
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1676202527
  br i1 %109, label %110, label %func_exit
...
entry:
  ...
  %crop_top = alloca i32, align 4
  %canary = alloca i32
  store i32 1486039754, i32* %canary
  %p_out.addr = alloca i32, align 4
  %rgb_output = alloca i32, align 4
  %p.addr = alloca %struct.storable_picture*, align 8
  %buf = alloca i8*, align 8
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1486039754
  br i1 %193, label %194, label %func_exit
...
entry:
  ...
  %rgb_output = alloca i32, align 4
  %canary = alloca i32
  store i32 1210045843, i32* %canary
  %buf = alloca i8*, align 8
  %SubWidthC = alloca [4 x i32], align 16
  %crop_bottom = alloca i32, align 4
  %SubHeightC = alloca [4 x i32], align 16
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1210045843
  br i1 %193, label %194, label %func_exit
...
entry:
  ...
  %ui16 = alloca i16, align 2
  %canary = alloca i32
  store i32 312429828, i32* %canary
  %buf.addr = alloca i8*, align 8
  %crop_top.addr = alloca i32, align 4
  %tmp16 = alloca i16, align 2
  %imgX.addr = alloca i16**, align 8
...
entry:
  ...
  %crop_top = alloca i32, align 4
  %canary = alloca i32
  store i32 126816203, i32* %canary
  %rgb_output = alloca i32, align 4
  %buf = alloca i8*, align 8
  %crop_right = alloca i32, align 4
  %crop_bottom = alloca i32, align 4
...
entry:
  ...
  %crop_right = alloca i32, align 4
  %canary = alloca i32
  store i32 790960778, i32* %canary
  %SubHeightC = alloca [4 x i32], align 16
  %symbol_size_in_bytes = alloca i32, align 4
  %crop_top = alloca i32, align 4
  %SubWidthC = alloca [4 x i32], align 16
...
entry:
  %canary = alloca i32
  store i32 961086615, i32* %canary
  %crop_right.addr = alloca i32, align 4
  %symbol_size_in_bytes.addr = alloca i32, align 4
  %size_x.addr = alloca i32, align 4
  %tmp16 = alloca i16, align 2
...
entry:
  %canary = alloca i32
  store i32 793839174, i32* %canary
  %SubHeightC = alloca [4 x i32], align 16
  %p_out.addr = alloca i32, align 4
  %SubWidthC = alloca [4 x i32], align 16
  %buf = alloca i8*, align 8
...
entry:
  %canary = alloca i32
  store i32 181869157, i32* %canary
  %symbol_size_in_bytes.addr = alloca i32, align 4
  %size_x.addr = alloca i32, align 4
  %j = alloca i32, align 4
  %tmp32 = alloca i64, align 8
...
entry:
  ...
  %size_y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1070601197, i32* %canary
  %crop_top.addr = alloca i32, align 4
  %crop_bottom.addr = alloca i32, align 4
  %ui16 = alloca i16, align 2
  %j = alloca i32, align 4
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1070601197
  br i1 %109, label %110, label %func_exit
...
entry:
  ...
  %size_y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 270855847, i32* %canary
  %symbol_size_in_bytes.addr = alloca i32, align 4
  %crop_left.addr = alloca i32, align 4
  %j = alloca i32, align 4
  %twidth = alloca i32, align 4
...
entry:
  ...
  %buf.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 658261003, i32* %canary
  %tmp16 = alloca i16, align 2
  %crop_top.addr = alloca i32, align 4
  %tmp32 = alloca i64, align 8
  %j = alloca i32, align 4
...
entry:
  ...
  %twidth = alloca i32, align 4
  %canary = alloca i32
  store i32 1290481671, i32* %canary
  %symbol_size_in_bytes.addr = alloca i32, align 4
  %crop_left.addr = alloca i32, align 4
  %tmp32 = alloca i64, align 8
  %size = alloca i32, align 4
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1290481671
  br i1 %109, label %110, label %func_exit
...
entry:
  ...
  %theight = alloca i32, align 4
  %canary = alloca i32
  store i32 288719445, i32* %canary
  %symbol_size_in_bytes.addr = alloca i32, align 4
  %crop_left.addr = alloca i32, align 4
  %crop_bottom.addr = alloca i32, align 4
  %size_y.addr = alloca i32, align 4
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1665170635, i32* %canary
  %ui16 = alloca i16, align 2
  %size = alloca i32, align 4
  %ui8 = alloca i8, align 1
  %crop_left.addr = alloca i32, align 4
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1665170635
  br i1 %109, label %110, label %func_exit
