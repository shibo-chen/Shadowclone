...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_PutPel_14.4, label %ctrl0

func_PutPel_14.4:                                 ; preds = %rand_bb
  call void @PutPel_14.4(i16** %Pic, i32 %y, i32 %x, i16 %val)
  ret void

func_PutPel_14.7:                                 ; preds = %ctrl0
  call void @PutPel_14.7(i16** %Pic, i32 %y, i32 %x, i16 %val)
  ret void

func_PutPel_14.13:                                ; preds = %ctrl1
  call void @PutPel_14.13(i16** %Pic, i32 %y, i32 %x, i16 %val)
  ret void

func_PutPel_14.30:                                ; preds = %ctrl2
  call void @PutPel_14.30(i16** %Pic, i32 %y, i32 %x, i16 %val)
  ret void

func_PutPel_14.36:                                ; preds = %ctrl3
...
func_PutPel_14.52:                                ; preds = %ctrl5
  call void @PutPel_14.52(i16** %Pic, i32 %y, i32 %x, i16 %val)
  ret void

func_PutPel_14.54:                                ; preds = %ctrl5
  call void @PutPel_14.54(i16** %Pic, i32 %y, i32 %x, i16 %val)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_PutPel_14.7, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_PutPel_14.13, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_PutPel_14.30, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_PutPel_14.36, label %ctrl4
...
ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_PutPel_14.52, label %func_PutPel_14.54
}
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_PutPel_11.31, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_PutPel_11.46, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_PutPel_11.57, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_PutPel_11.62, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_PutPel_11.63, label %func_PutPel_11.64
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FastLine16Y_11.14, label %ctrl0

func_FastLine16Y_11.14:                           ; preds = %rand_bb
  %2 = call i16* @FastLine16Y_11.14(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %2

func_FastLine16Y_11.15:                           ; preds = %ctrl0
  %3 = call i16* @FastLine16Y_11.15(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %3

func_FastLine16Y_11.22:                           ; preds = %ctrl1
  %4 = call i16* @FastLine16Y_11.22(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %4

func_FastLine16Y_11.25:                           ; preds = %ctrl2
  %5 = call i16* @FastLine16Y_11.25(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %5

func_FastLine16Y_11.28:                           ; preds = %ctrl3
  %6 = call i16* @FastLine16Y_11.28(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %6

func_FastLine16Y_11.37:                           ; preds = %ctrl4
  %7 = call i16* @FastLine16Y_11.37(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %7

func_FastLine16Y_11.41:                           ; preds = %ctrl5
  %8 = call i16* @FastLine16Y_11.41(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %8

func_FastLine16Y_11.42:                           ; preds = %ctrl5
  %9 = call i16* @FastLine16Y_11.42(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_FastLine16Y_11.15, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_FastLine16Y_11.22, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_FastLine16Y_11.25, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_FastLine16Y_11.28, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_FastLine16Y_11.37, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_FastLine16Y_11.41, label %func_FastLine16Y_11.42
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_UMVLine16Y_11.9, label %ctrl0

func_UMVLine16Y_11.9:                             ; preds = %rand_bb
  %2 = call i16* @UMVLine16Y_11.9(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %2
...
func_UMVLine16Y_11.20:                            ; preds = %ctrl1
  %4 = call i16* @UMVLine16Y_11.20(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %4
...
func_UMVLine16Y_11.27:                            ; preds = %ctrl3
  %6 = call i16* @UMVLine16Y_11.27(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %6

func_UMVLine16Y_11.47:                            ; preds = %ctrl4
  %7 = call i16* @UMVLine16Y_11.47(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %7

func_UMVLine16Y_11.51:                            ; preds = %ctrl5
  %8 = call i16* @UMVLine16Y_11.51(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %8

func_UMVLine16Y_11.55:                            ; preds = %ctrl5
  %9 = call i16* @UMVLine16Y_11.55(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_UMVLine16Y_11.19, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_UMVLine16Y_11.20, label %ctrl2
...
ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_UMVLine16Y_11.27, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_UMVLine16Y_11.47, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_UMVLine16Y_11.51, label %func_UMVLine16Y_11.55
}
...
func_FastLineX.35:                                ; preds = %ctrl3
  %6 = call i16* @FastLineX.35(i32 %dummy, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %6

func_FastLineX.38:                                ; preds = %ctrl4
  %7 = call i16* @FastLineX.38(i32 %dummy, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %7
...
func_FastLineX.44:                                ; preds = %ctrl5
  %9 = call i16* @FastLineX.44(i32 %dummy, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_FastLineX.8, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_FastLineX.21, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_FastLineX.32, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_FastLineX.35, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_FastLineX.38, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_FastLineX.39, label %func_FastLineX.44
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_UMVLineX.3, label %ctrl0

func_UMVLineX.3:                                  ; preds = %rand_bb
  %2 = call i16* @UMVLineX.3(i32 %size, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %2
...
func_UMVLineX.11:                                 ; preds = %ctrl1
  %4 = call i16* @UMVLineX.11(i32 %size, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %4

func_UMVLineX.17:                                 ; preds = %ctrl2
  %5 = call i16* @UMVLineX.17(i32 %size, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %5

func_UMVLineX.48:                                 ; preds = %ctrl3
  %6 = call i16* @UMVLineX.48(i32 %size, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %6

func_UMVLineX.49:                                 ; preds = %ctrl4
  %7 = call i16* @UMVLineX.49(i32 %size, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %7

func_UMVLineX.56:                                 ; preds = %ctrl5
  %8 = call i16* @UMVLineX.56(i32 %size, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %8

func_UMVLineX.59:                                 ; preds = %ctrl5
  %9 = call i16* @UMVLineX.59(i32 %size, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_UMVLineX.10, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_UMVLineX.11, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_UMVLineX.17, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_UMVLineX.48, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_UMVLineX.49, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_UMVLineX.56, label %func_UMVLineX.59
}
...
func_UMVPelY_14.23:                               ; preds = %ctrl1
  %4 = call i16 @UMVPelY_14.23(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16 %4
...
func_UMVPelY_14.40:                               ; preds = %ctrl4
  %7 = call i16 @UMVPelY_14.40(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16 %7

func_UMVPelY_14.50:                               ; preds = %ctrl5
  %8 = call i16 @UMVPelY_14.50(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16 %8

func_UMVPelY_14.60:                               ; preds = %ctrl5
  %9 = call i16 @UMVPelY_14.60(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_UMVPelY_14.16, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_UMVPelY_14.23, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_UMVPelY_14.29, label %ctrl3
...
ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_UMVPelY_14.40, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_UMVPelY_14.50, label %func_UMVPelY_14.60
}
...
func_FastPelY_14.18:                              ; preds = %ctrl0
  %3 = call i16 @FastPelY_14.18(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16 %3

func_FastPelY_14.24:                              ; preds = %ctrl1
  %4 = call i16 @FastPelY_14.24(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16 %4

func_FastPelY_14.33:                              ; preds = %ctrl2
  %5 = call i16 @FastPelY_14.33(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16 %5

func_FastPelY_14.43:                              ; preds = %ctrl3
  %6 = call i16 @FastPelY_14.43(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16 %6

func_FastPelY_14.53:                              ; preds = %ctrl4
  %7 = call i16 @FastPelY_14.53(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16 %7

func_FastPelY_14.58:                              ; preds = %ctrl5
  %8 = call i16 @FastPelY_14.58(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16 %8

func_FastPelY_14.61:                              ; preds = %ctrl5
  %9 = call i16 @FastPelY_14.61(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_FastPelY_14.18, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_FastPelY_14.24, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_FastPelY_14.33, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_FastPelY_14.43, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_FastPelY_14.53, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_FastPelY_14.58, label %func_FastPelY_14.61
}
...
entry:
  ...
  %height.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 679515157, i32* %canary
  %width.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
  %Pic.addr = alloca i16**, align 8
  store i16** %Pic, i16*** %Pic.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i16* @UMVLineX.3(i32 %size, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width) #0 {
entry:
  %y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2035282106, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @PutPel_14.4(i16** %Pic, i32 %y, i32 %x, i16 zeroext %val) #0 {
entry:
  %y.addr = alloca i32, align 4
  %Pic.addr = alloca i16**, align 8
  %x.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1012657444, i32* %canary
...
entry:
  ...
  %val.addr = alloca i16, align 2
  %canary = alloca i32
  store i32 896191826, i32* %canary
  %Pic.addr = alloca i16*, align 8
  store i16* %Pic, i16** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
  store i32 %x, i32* %x.addr, align 4
...
entry:
  ...
  %width.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1979717224, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @PutPel_14.7(i16** %Pic, i32 %y, i32 %x, i16 zeroext %val) #0 {
entry:
  %x.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 860012442, i32* %canary
  %val.addr = alloca i16, align 2
  %Pic.addr = alloca i16**, align 8
  store i16** %Pic, i16*** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
...
entry:
  %dummy.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1553325304, i32* %canary
  %Pic.addr = alloca i16*, align 8
  %y.addr = alloca i32, align 4
  %x.addr = alloca i32, align 4
  %height.addr = alloca i32, align 4
...
entry:
  ...
  %maxx = alloca i32, align 4
  %canary = alloca i32
  store i32 1625477176, i32* %canary
  %y.addr = alloca i32, align 4
  %retval = alloca i16*, align 8
  %width.addr = alloca i32, align 4
  store i16* %Pic, i16** %Pic.addr, align 8
...
entry:
  ...
  %y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1811102601, i32* %canary
  %retval = alloca i16*, align 8
  %height.addr = alloca i32, align 4
  store i32 %size, i32* %size.addr, align 4
  store i16* %Pic, i16** %Pic.addr, align 8
...
entry:
  ...
  %retval = alloca i16*, align 8
  %canary = alloca i32
  store i32 825523446, i32* %canary
  %width.addr = alloca i32, align 4
  %Picy = alloca i16*, align 8
  %x.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1382716418, i32* %canary
  %x.addr = alloca i32, align 4
  %val.addr = alloca i16, align 2
  %width.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
...
entry:
  ...
  %Pic.addr = alloca i16**, align 8
  %canary = alloca i32
  store i32 574207140, i32* %canary
  %val.addr = alloca i16, align 2
  %x.addr = alloca i32, align 4
  store i16** %Pic, i16*** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
...
entry:
  ...
  %y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2002874439, i32* %canary
  %width.addr = alloca i32, align 4
  %Pic.addr = alloca i16*, align 8
  %height.addr = alloca i32, align 4
  store i16* %Pic, i16** %Pic.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1883776092, i32* %canary
  %x.addr = alloca i32, align 4
  %width.addr = alloca i32, align 4
  %height.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
...
entry:
  ...
  %width4 = alloca i32, align 4
  %canary = alloca i32
  store i32 337548539, i32* %canary
  %height.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
  %Pic.addr = alloca i16**, align 8
  store i16** %Pic, i16*** %Pic.addr, align 8
...
entry:
  ...
  %width.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 532127198, i32* %canary
  %Pic.addr = alloca i16*, align 8
  %x.addr = alloca i32, align 4
  store i32 %size, i32* %size.addr, align 4
  store i16* %Pic, i16** %Pic.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1748182154, i32* %canary
  %x.addr = alloca i32, align 4
  %height.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
  %Pic.addr = alloca i16**, align 8
...
entry:
  %canary = alloca i32
  store i32 1688003446, i32* %canary
  %height.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %Pic.addr = alloca i16*, align 8
  %y.addr = alloca i32, align 4
...
entry:
  ...
  %Picy = alloca i16*, align 8
  %canary = alloca i32
  store i32 1391947584, i32* %canary
  %Pic.addr = alloca i16*, align 8
  %width.addr = alloca i32, align 4
  %maxx = alloca i32, align 4
  %height.addr = alloca i32, align 4
...
entry:
  %y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 215777764, i32* %canary
  %Pic.addr = alloca i16*, align 8
  %dummy.addr = alloca i32, align 4
  %x.addr = alloca i32, align 4
  %width.addr = alloca i32, align 4
...
entry:
  ...
  %width.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1487753406, i32* %canary
  %width4 = alloca i32, align 4
  %y.addr = alloca i32, align 4
  %x.addr = alloca i32, align 4
  store i16** %Pic, i16*** %Pic.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local zeroext i16 @FastPelY_14.24(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width) #0 {
entry:
  %x.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1314357535, i32* %canary
  %Pic.addr = alloca i16**, align 8
  %width.addr = alloca i32, align 4
  %height.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
...
entry:
  ...
  %width.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 299936331, i32* %canary
  %height.addr = alloca i32, align 4
  store i16* %Pic, i16** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
  store i32 %x, i32* %x.addr, align 4
...
entry:
  %width.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1046550767, i32* %canary
  %i = alloca i32, align 4
  %height.addr = alloca i32, align 4
  %x.addr = alloca i32, align 4
  %Picy = alloca i16*, align 8
...
entry:
  ...
  %x.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 742301483, i32* %canary
  %y.addr = alloca i32, align 4
  %height.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %Pic.addr = alloca i16*, align 8
...
entry:
  %canary = alloca i32
  store i32 794796412, i32* %canary
  %width.addr = alloca i32, align 4
  %height.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
  %x.addr = alloca i32, align 4
...
entry:
  ...
  %width4 = alloca i32, align 4
  %canary = alloca i32
  store i32 141186154, i32* %canary
  %x.addr = alloca i32, align 4
  %width.addr = alloca i32, align 4
  %Pic.addr = alloca i16**, align 8
  %height.addr = alloca i32, align 4
...
entry:
  ...
  %val.addr = alloca i16, align 2
  %canary = alloca i32
  store i32 1084709241, i32* %canary
  %y.addr = alloca i32, align 4
  store i16** %Pic, i16*** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
  store i32 %x, i32* %x.addr, align 4
...
entry:
  %y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 170143467, i32* %canary
  %width.addr = alloca i32, align 4
  %val.addr = alloca i16, align 2
  %Pic.addr = alloca i16*, align 8
  %x.addr = alloca i32, align 4
...
entry:
  %y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1270459353, i32* %canary
  %dummy.addr = alloca i32, align 4
  %height.addr = alloca i32, align 4
  %x.addr = alloca i32, align 4
  %width.addr = alloca i32, align 4
...
entry:
  ...
  %y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1828494995, i32* %canary
  %height.addr = alloca i32, align 4
  %width.addr = alloca i32, align 4
  %x.addr = alloca i32, align 4
  store i16** %Pic, i16*** %Pic.addr, align 8
...
entry:
  ...
  %height.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 417979547, i32* %canary
  %Pic.addr = alloca i16**, align 8
  %width.addr = alloca i32, align 4
  %x.addr = alloca i32, align 4
  %retval = alloca i16, align 2
...
entry:
  %x.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1240566214, i32* %canary
  %y.addr = alloca i32, align 4
  %dummy.addr = alloca i32, align 4
  %width.addr = alloca i32, align 4
  %height.addr = alloca i32, align 4
...
entry:
  ...
  %y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1533085507, i32* %canary
  %Pic.addr = alloca i16**, align 8
  %val.addr = alloca i16, align 2
  store i16** %Pic, i16*** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
...
entry:
  ...
  %Pic.addr = alloca i16*, align 8
  %canary = alloca i32
  store i32 1675957536, i32* %canary
  %width.addr = alloca i32, align 4
  store i16* %Pic, i16** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
  store i32 %x, i32* %x.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i16* @FastLineX.38(i32 %dummy, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width) #0 {
entry:
  %canary = alloca i32
  store i32 1531459140, i32* %canary
  %width.addr = alloca i32, align 4
  %Pic.addr = alloca i16*, align 8
  %height.addr = alloca i32, align 4
  %x.addr = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 149484101, i32* %canary
  %x.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
  %height.addr = alloca i32, align 4
  %width.addr = alloca i32, align 4
...
entry:
  %width4 = alloca i32, align 4
  %canary = alloca i32
  store i32 1383286479, i32* %canary
  %height.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
  %width.addr = alloca i32, align 4
  %x.addr = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 307774095, i32* %canary
  %width.addr = alloca i32, align 4
  %x.addr = alloca i32, align 4
  %height.addr = alloca i32, align 4
  %Pic.addr = alloca i16*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i16* @FastLine16Y_11.42(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width) #0 {
entry:
  %x.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 437581636, i32* %canary
  %height.addr = alloca i32, align 4
  %Pic.addr = alloca i16*, align 8
  %width.addr = alloca i32, align 4
  store i16* %Pic, i16** %Pic.addr, align 8
...
entry:
  %height.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 463508722, i32* %canary
  %width.addr = alloca i32, align 4
  %x.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
  %Pic.addr = alloca i16**, align 8
...
entry:
  %dummy.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1722163160, i32* %canary
  %y.addr = alloca i32, align 4
  %Pic.addr = alloca i16*, align 8
  %width.addr = alloca i32, align 4
  %x.addr = alloca i32, align 4
...
entry:
  %val.addr = alloca i16, align 2
  %canary = alloca i32
  store i32 1368204338, i32* %canary
  %y.addr = alloca i32, align 4
  %x.addr = alloca i32, align 4
  %Pic.addr = alloca i16**, align 8
  store i16** %Pic, i16*** %Pic.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 590175918, i32* %canary
  %val.addr = alloca i16, align 2
  %x.addr = alloca i32, align 4
  %Pic.addr = alloca i16*, align 8
  %width.addr = alloca i32, align 4
...
entry:
  ...
  %width.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1988907278, i32* %canary
  %retval = alloca i16*, align 8
  %i = alloca i32, align 4
  %height.addr = alloca i32, align 4
  %Pic.addr = alloca i16*, align 8
...
entry:
  %canary = alloca i32
  store i32 1201570807, i32* %canary
  %x.addr = alloca i32, align 4
  %Picy = alloca i16*, align 8
  %maxx = alloca i32, align 4
  %Pic.addr = alloca i16*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i16* @UMVLineX.49(i32 %size, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width) #0 {
entry:
  %height.addr = alloca i32, align 4
  %Picy = alloca i16*, align 8
  %size.addr = alloca i32, align 4
  ...
  %Pic.addr = alloca i16*, align 8
  %canary = alloca i32
  store i32 2113320672, i32* %canary
  %width.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %x.addr = alloca i32, align 4
...
entry:
  ...
  %height.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1260855247, i32* %canary
  %x.addr = alloca i32, align 4
  %width.addr = alloca i32, align 4
  %Pic.addr = alloca i16**, align 8
  %retval = alloca i16, align 2
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1699199563, i32* %canary
  %y.addr = alloca i32, align 4
  %retval = alloca i16*, align 8
  %x.addr = alloca i32, align 4
  %Picy = alloca i16*, align 8
...
entry:
  %y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1979298271, i32* %canary
  %val.addr = alloca i16, align 2
  %Pic.addr = alloca i16**, align 8
  %x.addr = alloca i32, align 4
  store i16** %Pic, i16*** %Pic.addr, align 8
...
entry:
  ...
  %Pic.addr = alloca i16**, align 8
  %canary = alloca i32
  store i32 1181675241, i32* %canary
  %y.addr = alloca i32, align 4
  store i16** %Pic, i16*** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
  store i32 %x, i32* %x.addr, align 4
...
entry:
  ...
  %x.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1064525808, i32* %canary
  %y.addr = alloca i32, align 4
  store i16** %Pic, i16*** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
  store i32 %x, i32* %x.addr, align 4
...
entry:
  ...
  %width.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 832751296, i32* %canary
  %retval = alloca i16*, align 8
  store i16* %Pic, i16** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
  store i32 %x, i32* %x.addr, align 4
...
entry:
  ...
  %Pic.addr = alloca i16*, align 8
  %canary = alloca i32
  store i32 1525159956, i32* %canary
  %maxx = alloca i32, align 4
  %size.addr = alloca i32, align 4
  %retval = alloca i16*, align 8
  %Picy = alloca i16*, align 8
...
entry:
  ...
  %Pic.addr = alloca i16*, align 8
  %canary = alloca i32
  store i32 1924361816, i32* %canary
  %x.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
  store i16* %Pic, i16** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local zeroext i16 @FastPelY_14.58(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width) #0 {
entry:
  %width.addr = alloca i32, align 4
  %height.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 891858799, i32* %canary
  %Pic.addr = alloca i16**, align 8
  %x.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
  store i16** %Pic, i16*** %Pic.addr, align 8
...
entry:
  ...
  %retval = alloca i16*, align 8
  %canary = alloca i32
  store i32 1656862830, i32* %canary
  %i = alloca i32, align 4
  %height.addr = alloca i32, align 4
  %Pic.addr = alloca i16*, align 8
  %width.addr = alloca i32, align 4
...
entry:
  %width4 = alloca i32, align 4
  %canary = alloca i32
  store i32 1215956698, i32* %canary
  %height.addr = alloca i32, align 4
  %height4 = alloca i32, align 4
  %Pic.addr = alloca i16**, align 8
  %y.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local zeroext i16 @FastPelY_14.61(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width) #0 {
entry:
  %y.addr = alloca i32, align 4
  %height.addr = alloca i32, align 4
  %width.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 432858215, i32* %canary
  %Pic.addr = alloca i16**, align 8
  %x.addr = alloca i32, align 4
  store i16** %Pic, i16*** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
...
entry:
  ...
  %width.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 272192715, i32* %canary
  %x.addr = alloca i32, align 4
  %Pic.addr = alloca i16*, align 8
  store i16* %Pic, i16** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 1711269384, i32* %canary
  %y.addr = alloca i32, align 4
  %Pic.addr = alloca i16*, align 8
  %x.addr = alloca i32, align 4
  %val.addr = alloca i16, align 2
...
entry:
  %canary = alloca i32
  store i32 1227232891, i32* %canary
  %width.addr = alloca i32, align 4
  %Pic.addr = alloca i16*, align 8
  %x.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
