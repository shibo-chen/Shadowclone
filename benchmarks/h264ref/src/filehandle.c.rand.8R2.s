...
# %bb.1:                                # %func_start_sequence.1
	...
	.cfi_def_cfa %rsp, 8
	retq
.LBB2_2:                                # %func_start_sequence.2
	.cfi_def_cfa %rbp, 16
	callq	start_sequence.2
	popq	%rbp
	.cfi_def_cfa %rsp, 8
	retq
.LBB2_3:                                # %func_start_sequence.5
	.cfi_def_cfa %rbp, 16
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$305315489, -40(%rbp)   # imm = 0x1232BEA1
	movl	$0, -12(%rbp)
	movq	input(%rip), %rax
	movl	60(%rax), %eax
	xorl	%ecx, %ecx
...
.LBB4_10:                               # %return
	movl	-20(%rbp), %ebx
	cmpl	$305315489, -40(%rbp)   # imm = 0x1232BEA1
	jne	.LBB4_12
.LBB4_11:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$485219692, -36(%rbp)   # imm = 0x1CEBDD6C
	movl	$0, -12(%rbp)
	movq	input(%rip), %rax
	movl	60(%rax), %eax
	xorl	%ecx, %ecx
...
.LBB5_10:                               # %return
	movl	-20(%rbp), %ebx
	cmpl	$485219692, -36(%rbp)   # imm = 0x1CEBDD6C
	jne	.LBB5_12
.LBB5_11:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$678578992, -32(%rbp)   # imm = 0x28724B30
	movl	%edi, -12(%rbp)
	movl	%esi, -28(%rbp)
	movq	$0, -24(%rbp)
	movl	-28(%rbp), %edi
	...
	callq	FreeNALU
	movl	-12(%rbp), %ebx
	cmpl	$678578992, -32(%rbp)   # imm = 0x28724B30
	jne	.LBB6_2
.LBB6_1:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$1642119118, -32(%rbp)  # imm = 0x61E0BFCE
	movl	%edi, -12(%rbp)
	movl	%esi, -28(%rbp)
	movq	$0, -24(%rbp)
	movl	-28(%rbp), %edi
	...
	callq	FreeNALU
	movl	-12(%rbp), %ebx
	cmpl	$1642119118, -32(%rbp)  # imm = 0x61E0BFCE
	jne	.LBB7_2
.LBB7_1:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$422849848, -40(%rbp)   # imm = 0x19342D38
	movl	$0, -12(%rbp)
	movq	input(%rip), %rax
	movl	60(%rax), %eax
	xorl	%ecx, %ecx
...
.LBB8_10:                               # %return
	movl	-20(%rbp), %ebx
	cmpl	$422849848, -40(%rbp)   # imm = 0x19342D38
	jne	.LBB8_12
.LBB8_11:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$323958323, -20(%rbp)   # imm = 0x134F3633
	movq	%rdi, -16(%rbp)
	movl	%esi, -4(%rbp)
	movq	stderr, %rdi
	movq	-16(%rbp), %rdx
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1419483876, -20(%rbp)  # imm = 0x549B9AE4
	movq	%rdi, -16(%rbp)
	movl	%esi, -4(%rbp)
	movq	stderr, %rdi
	movq	-16(%rbp), %rdx
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$697378334, -28(%rbp)   # imm = 0x2991261E
	movl	%edi, -12(%rbp)
	movl	%esi, -32(%rbp)
	movq	$0, -24(%rbp)
	movl	-32(%rbp), %edi
	...
	callq	FreeNALU
	movl	-12(%rbp), %ebx
	cmpl	$697378334, -28(%rbp)   # imm = 0x2991261E
	jne	.LBB11_2
.LBB11_1:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$1183513438, -40(%rbp)  # imm = 0x468AFB5E
	movl	$0, -12(%rbp)
	movq	input(%rip), %rax
	movl	60(%rax), %eax
	xorl	%ecx, %ecx
...
.LBB12_10:                              # %return
	movl	-20(%rbp), %ebx
	cmpl	$1183513438, -40(%rbp)  # imm = 0x468AFB5E
	jne	.LBB12_12
.LBB12_11:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$1117596366, -36(%rbp)  # imm = 0x429D2ACE
	movl	$0, -12(%rbp)
	movq	input(%rip), %rax
	movl	60(%rax), %eax
	xorl	%ecx, %ecx
...
.LBB13_10:                              # %return
	movl	-20(%rbp), %ebx
	cmpl	$1117596366, -36(%rbp)  # imm = 0x429D2ACE
	jne	.LBB13_12
.LBB13_11:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$1736212811, -32(%rbp)  # imm = 0x677C814B
	movl	%edi, -12(%rbp)
	movl	%esi, -28(%rbp)
	movq	$0, -24(%rbp)
	movl	-28(%rbp), %edi
	...
	callq	FreeNALU
	movl	-12(%rbp), %ebx
	cmpl	$1736212811, -32(%rbp)  # imm = 0x677C814B
	jne	.LBB14_2
.LBB14_1:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$772304588, -40(%rbp)   # imm = 0x2E086ECC
	movl	$0, -12(%rbp)
	movq	input(%rip), %rax
	movl	60(%rax), %eax
	xorl	%ecx, %ecx
...
.LBB15_10:                              # %return
	movl	-20(%rbp), %ebx
	cmpl	$772304588, -40(%rbp)   # imm = 0x2E086ECC
	jne	.LBB15_12
.LBB15_11:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$1844826961, -32(%rbp)  # imm = 0x6DF5D351
	movl	%edi, -12(%rbp)
	movl	%esi, -28(%rbp)
	movq	$0, -24(%rbp)
	movl	-28(%rbp), %edi
	...
	callq	FreeNALU
	movl	-12(%rbp), %ebx
	cmpl	$1844826961, -32(%rbp)  # imm = 0x6DF5D351
	jne	.LBB16_2
.LBB16_1:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$52801980, -40(%rbp)    # imm = 0x325B1BC
	movl	$0, -12(%rbp)
	movq	input(%rip), %rax
	movl	60(%rax), %eax
	xorl	%ecx, %ecx
...
.LBB17_10:                              # %return
	movl	-20(%rbp), %ebx
	cmpl	$52801980, -40(%rbp)    # imm = 0x325B1BC
	jne	.LBB17_12
.LBB17_11:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$854715098, -40(%rbp)   # imm = 0x32F1EADA
	movl	$0, -12(%rbp)
	movq	input(%rip), %rax
	movl	60(%rax), %eax
	xorl	%ecx, %ecx
...
.LBB18_10:                              # %return
	movl	-20(%rbp), %ebx
	cmpl	$854715098, -40(%rbp)   # imm = 0x32F1EADA
	jne	.LBB18_12
.LBB18_11:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$1265786287, -28(%rbp)  # imm = 0x4B725DAF
	movl	%edi, -12(%rbp)
	movl	%esi, -32(%rbp)
	movq	$0, -24(%rbp)
	movl	-32(%rbp), %edi
	...
	callq	FreeNALU
	movl	-12(%rbp), %ebx
	cmpl	$1265786287, -28(%rbp)  # imm = 0x4B725DAF
	jne	.LBB19_2
.LBB19_1:
	movl	%ebx, %eax
	addq	$24, %rsp
