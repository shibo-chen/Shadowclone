...
.LBB0_5:                                # %func_RandomIntraInit.8
	...
	.cfi_def_cfa %rsp, 8
	retq
.LBB0_6:                                # %func_RandomIntraInit.12
	.cfi_def_cfa %rbp, 16
	movl	%ebx, %edi
	movl	%r15d, %esi
	movl	%r14d, %edx
	...
	.cfi_def_cfa %rsp, 8
	retq
.LBB0_7:                                # %func_RandomIntraInit.14
	.cfi_def_cfa %rbp, 16
	movl	%ebx, %edi
	movl	%r15d, %esi
	movl	%r14d, %edx
	...
	.cfi_def_cfa %rsp, 8
	retq
.LBB0_8:                                # %func_RandomIntraInit.15
	.cfi_def_cfa %rbp, 16
	movl	%ebx, %edi
	movl	%r15d, %esi
	movl	%r14d, %edx
...
# %bb.0:                                # %rand_bb
	...
	cmpl	$0, %eax
	jne	.LBB2_2
# %bb.1:                                # %func_RandomIntraNewPicture.11
	callq	RandomIntraNewPicture.11
	popq	%rbp
	.cfi_def_cfa %rsp, 8
	retq
.LBB2_2:                                # %func_RandomIntraNewPicture.13
	.cfi_def_cfa %rbp, 16
	callq	RandomIntraNewPicture.13
	popq	%rbp
	.cfi_def_cfa %rsp, 8
	retq
.Lfunc_end2:
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1697035819, -20(%rbp)  # imm = 0x6526B62B
	movl	%edi, -24(%rbp)
	movl	%esi, -16(%rbp)
	movl	%edx, -12(%rbp)
	movl	$1, %edi
...
# %bb.14:                               # %for.inc23
	...
	jmp	.LBB4_9
.LBB4_15:                               # %for.end25
	cmpl	$1697035819, -20(%rbp)  # imm = 0x6526B62B
	jne	.LBB4_17
.LBB4_16:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1320523102, -24(%rbp)  # imm = 0x4EB5955E
	movl	%edi, -16(%rbp)
	movl	%esi, -20(%rbp)
	movl	%edx, -8(%rbp)
	movl	$1, %edi
...
# %bb.14:                               # %for.inc23
	...
	jmp	.LBB5_9
.LBB5_15:                               # %for.end25
	cmpl	$1320523102, -24(%rbp)  # imm = 0x4EB5955E
	jne	.LBB5_17
.LBB5_16:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$320143434, -24(%rbp)   # imm = 0x1315004A
	movl	%edi, -16(%rbp)
	movl	%esi, -20(%rbp)
	movl	%edx, -8(%rbp)
	movl	$1, %edi
...
# %bb.14:                               # %for.inc23
	...
	jmp	.LBB6_9
.LBB6_15:                               # %for.end25
	cmpl	$320143434, -24(%rbp)   # imm = 0x1315004A
	jne	.LBB6_17
.LBB6_16:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1866371105, -20(%rbp)  # imm = 0x6F3E9021
	movl	%edi, -16(%rbp)
	movl	%esi, -24(%rbp)
	movl	%edx, -8(%rbp)
	movl	$1, %edi
...
# %bb.14:                               # %for.inc23
	...
	jmp	.LBB7_9
.LBB7_15:                               # %for.end25
	cmpl	$1866371105, -20(%rbp)  # imm = 0x6F3E9021
	jne	.LBB7_17
.LBB7_16:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$857045551, -24(%rbp)   # imm = 0x33157A2F
	movl	%edi, -20(%rbp)
	movl	$0, -12(%rbp)
.LBB8_1:                                # %for.cond
                                        # =>This Inner Loop Header: Depth=1
...
.LBB8_7:                                # %return
	movl	-16(%rbp), %ebx
	cmpl	$857045551, -24(%rbp)   # imm = 0x33157A2F
	jne	.LBB8_9
.LBB8_8:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$1676494750, -24(%rbp)  # imm = 0x63ED479E
	movl	%edi, -20(%rbp)
	movl	$0, -12(%rbp)
.LBB9_1:                                # %for.cond
                                        # =>This Inner Loop Header: Depth=1
...
.LBB9_7:                                # %return
	movl	-16(%rbp), %ebx
	cmpl	$1676494750, -24(%rbp)  # imm = 0x63ED479E
	jne	.LBB9_9
.LBB9_8:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$2119486924, -24(%rbp)  # imm = 0x7E54CDCC
	movl	%edi, -20(%rbp)
	movl	$0, -12(%rbp)
.LBB10_1:                               # %for.cond
                                        # =>This Inner Loop Header: Depth=1
...
.LBB10_7:                               # %return
	movl	-16(%rbp), %ebx
	cmpl	$2119486924, -24(%rbp)  # imm = 0x7E54CDCC
	jne	.LBB10_9
.LBB10_8:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$50090690, -20(%rbp)    # imm = 0x2FC52C2
	movl	%edi, -24(%rbp)
	movl	%esi, -16(%rbp)
	movl	%edx, -12(%rbp)
	movl	$1, %edi
...
# %bb.14:                               # %for.inc23
	...
	jmp	.LBB11_9
.LBB11_15:                              # %for.end25
	cmpl	$50090690, -20(%rbp)    # imm = 0x2FC52C2
	jne	.LBB11_17
.LBB11_16:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$352753297, -20(%rbp)   # imm = 0x15069691
	movl	%edi, -24(%rbp)
	movl	$0, -12(%rbp)
.LBB12_1:                               # %for.cond
                                        # =>This Inner Loop Header: Depth=1
...
.LBB12_7:                               # %return
	movl	-16(%rbp), %ebx
	cmpl	$352753297, -20(%rbp)   # imm = 0x15069691
	jne	.LBB12_9
.LBB12_8:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$988133532, -24(%rbp)   # imm = 0x3AE5B89C
	movl	%edi, -20(%rbp)
	movl	$0, -12(%rbp)
.LBB13_1:                               # %for.cond
                                        # =>This Inner Loop Header: Depth=1
...
.LBB13_7:                               # %return
	movl	-16(%rbp), %ebx
	cmpl	$988133532, -24(%rbp)   # imm = 0x3AE5B89C
	jne	.LBB13_9
.LBB13_8:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$16, %rsp
	movl	$511148708, -12(%rbp)   # imm = 0x1E7782A4
...
# %bb.3:                                # %for.inc
	...
	jmp	.LBB14_1
.LBB14_4:                               # %for.end
	cmpl	$511148708, -12(%rbp)   # imm = 0x1E7782A4
	jne	.LBB14_6
.LBB14_5:
	addq	$16, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1461983955, -20(%rbp)  # imm = 0x57241AD3
	movl	%edi, -16(%rbp)
	movl	%esi, -24(%rbp)
	movl	%edx, -8(%rbp)
	movl	$1, %edi
...
# %bb.14:                               # %for.inc23
	...
	jmp	.LBB15_9
.LBB15_15:                              # %for.end25
	cmpl	$1461983955, -20(%rbp)  # imm = 0x57241AD3
	jne	.LBB15_17
.LBB15_16:
	addq	$32, %rsp
	popq	%rbp
...
.Lfunc_end15:
	...
	.cfi_endproc
                                        # -- End function
	.globl	RandomIntraNewPicture.13 # -- Begin function RandomIntraNewPicture.13
	.p2align	4, 0x90
	.type	RandomIntraNewPicture.13,@function
RandomIntraNewPicture.13:               # @RandomIntraNewPicture.13
	.cfi_startproc
# %bb.0:                                # %entry
	pushq	%rbp
	.cfi_def_cfa_offset 16
	...
	.cfi_def_cfa_register %rbp
	subq	$16, %rsp
	movl	$1033848060, -12(%rbp)  # imm = 0x3D9F44FC
	movl	NumberIntraPerPicture, %eax
	addl	WalkAround, %eax
	movl	%eax, WalkAround
	movl	$0, -4(%rbp)
...
# %bb.3:                                # %for.inc
	...
	jmp	.LBB16_1
.LBB16_4:                               # %for.end
	cmpl	$1033848060, -12(%rbp)  # imm = 0x3D9F44FC
	jne	.LBB16_6
.LBB16_5:
	addq	$16, %rsp
	popq	%rbp
...
.LBB16_6:                               # %func_exit
	...
	jmp	.LBB16_5
.Lfunc_end16:
	.size	RandomIntraNewPicture.13, .Lfunc_end16-RandomIntraNewPicture.13
	.cfi_endproc
                                        # -- End function
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1634509286, -24(%rbp)  # imm = 0x616CA1E6
	movl	%edi, -16(%rbp)
	movl	%esi, -20(%rbp)
	movl	%edx, -12(%rbp)
	movl	$1, %edi
...
# %bb.14:                               # %for.inc23
	...
	jmp	.LBB17_9
.LBB17_15:                              # %for.end25
	cmpl	$1634509286, -24(%rbp)  # imm = 0x616CA1E6
	jne	.LBB17_17
.LBB17_16:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1461381272, -24(%rbp)  # imm = 0x571AE898
	movl	%edi, -20(%rbp)
	movl	%esi, -16(%rbp)
	movl	%edx, -12(%rbp)
	movl	$1, %edi
...
# %bb.14:                               # %for.inc23
	...
	jmp	.LBB18_9
.LBB18_15:                              # %for.end25
	cmpl	$1461381272, -24(%rbp)  # imm = 0x571AE898
	jne	.LBB18_17
.LBB18_16:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$824332945, -20(%rbp)   # imm = 0x31225291
	movl	%edi, -24(%rbp)
	movl	$0, -12(%rbp)
.LBB19_1:                               # %for.cond
                                        # =>This Inner Loop Header: Depth=1
...
.LBB19_7:                               # %return
	movl	-16(%rbp), %ebx
	cmpl	$824332945, -20(%rbp)   # imm = 0x31225291
	jne	.LBB19_9
.LBB19_8:
	movl	%ebx, %eax
	addq	$24, %rsp
