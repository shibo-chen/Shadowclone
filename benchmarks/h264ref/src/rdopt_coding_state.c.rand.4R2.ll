; ModuleID = 'rdopt_coding_state.c.rand.4R2.bc'
...
func_store_coding_state.8:                        ; preds = %ctrl1
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_store_coding_state.7, label %func_store_coding_state.8
}
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_reset_coding_state.5, label %func_reset_coding_state.6
}
...
entry:
  %canary = alloca i32
  store i32 1745774059, i32* %canary
...
entry:
  ...
  %bs_dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 2013143471, i32* %canary
  %i = alloca i32, align 4
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
...
entry:
  ...
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 1805776843, i32* %canary
  %bs_src = alloca %struct.Bitstream*, align 8
  store %struct.CSobj* %cs, %struct.CSobj** %cs.addr, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %currentSlice = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 50
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1128458992, i32* %canary
  %bs_dest = alloca %struct.Bitstream*, align 8
  %currMB = alloca %struct.macroblock*, align 8
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
...
entry:
  ...
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 1143224681, i32* %canary
  %currMB = alloca %struct.macroblock*, align 8
  store %struct.CSobj* %cs, %struct.CSobj** %cs.addr, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %currentSlice = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 50
...
entry:
  ...
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %canary = alloca i32
  store i32 634179039, i32* %canary
  %bs_dest = alloca %struct.Bitstream*, align 8
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %currMB = alloca %struct.macroblock*, align 8
...
entry:
  ...
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 2137185265, i32* %canary
  %currMB = alloca %struct.macroblock*, align 8
  %cs.addr = alloca %struct.CSobj*, align 8
  %i = alloca i32, align 4
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
...
entry:
  ...
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %canary = alloca i32
  store i32 1609449288, i32* %canary
  %currMB = alloca %struct.macroblock*, align 8
  %bs_src = alloca %struct.Bitstream*, align 8
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %cs.addr = alloca %struct.CSobj*, align 8
