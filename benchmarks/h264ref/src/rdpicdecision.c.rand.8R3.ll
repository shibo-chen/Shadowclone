; ModuleID = 'rdpicdecision.c.rand.8R3.bc'
...
func_rd_pic_decision.9:                           ; preds = %ctrl3
  %6 = call i32 @rd_pic_decision.9(double %snrY_version1, double %snrY_version2, i32 %bits_version1, i32 %bits_version2, double %lambda_picture)
  ret i32 %6
...
ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_rd_pic_decision.9, label %ctrl4
...
ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_rd_pic_decision.13, label %func_rd_pic_decision.14
}
...
func_picture_coding_decision.8:                   ; preds = %ctrl2
  %5 = call i32 @picture_coding_decision.8(%struct.Picture* %picture1, %struct.Picture* %picture2, i32 %qp)
  ret i32 %5

func_picture_coding_decision.11:                  ; preds = %ctrl3
  %6 = call i32 @picture_coding_decision.11(%struct.Picture* %picture1, %struct.Picture* %picture2, i32 %qp)
  ret i32 %6
...
ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_picture_coding_decision.8, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_picture_coding_decision.11, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_picture_coding_decision.12, label %ctrl5
...
entry:
  ...
  %canary = alloca i32
  store i32 1874257222, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 520907552, i32* %canary
...
entry:
  ...
  %snrY_version1.addr = alloca double, align 8
  %canary = alloca i32
  store i32 1801713923, i32* %canary
  %cost_version2 = alloca double, align 8
  %lambda_picture.addr = alloca double, align 8
  %snrY_version2.addr = alloca double, align 8
  %bits_version2.addr = alloca i32, align 4
...
entry:
  ...
  %bit_picture1 = alloca i32, align 4
  %canary = alloca i32
  store i32 875260009, i32* %canary
  %qp.addr = alloca i32, align 4
  %bframe = alloca i32, align 4
  %snr_picture2 = alloca double, align 8
  %lambda_picture = alloca double, align 8
...
entry:
  ...
  %bits_version1.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 556697396, i32* %canary
  %snrY_version1.addr = alloca double, align 8
  %bits_version2.addr = alloca i32, align 4
  %cost_version1 = alloca double, align 8
  %snrY_version2.addr = alloca double, align 8
...
entry:
  %snr_picture2 = alloca double, align 8
  %canary = alloca i32
  store i32 1672437906, i32* %canary
  %bit_picture2 = alloca i32, align 4
  %picture1.addr = alloca %struct.Picture*, align 8
  %qp.addr = alloca i32, align 4
  %snr_picture1 = alloca double, align 8
...
entry:
  ...
  %snrY_version1.addr = alloca double, align 8
  %canary = alloca i32
  store i32 102108473, i32* %canary
  %bits_version1.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  store double %snrY_version1, double* %snrY_version1.addr, align 8
  store double %snrY_version2, double* %snrY_version2.addr, align 8
...
entry:
  ...
  %lambda_picture = alloca double, align 8
  %canary = alloca i32
  store i32 1838284540, i32* %canary
  %snr_picture2 = alloca double, align 8
  %spframe = alloca i32, align 4
  %picture1.addr = alloca %struct.Picture*, align 8
  store %struct.Picture* %picture1, %struct.Picture** %picture1.addr, align 8
...
entry:
  ...
  %bits_version2.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 763306031, i32* %canary
  %cost_version1 = alloca double, align 8
  store double %snrY_version1, double* %snrY_version1.addr, align 8
  store double %snrY_version2, double* %snrY_version2.addr, align 8
  store i32 %bits_version1, i32* %bits_version1.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 2132840314, i32* %canary
  %bits_version1.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  %snrY_version1.addr = alloca double, align 8
  %cost_version1 = alloca double, align 8
...
entry:
  %bframe = alloca i32, align 4
  %canary = alloca i32
  store i32 1831561781, i32* %canary
  %bit_picture1 = alloca i32, align 4
  %snr_picture1 = alloca double, align 8
  %picture2.addr = alloca %struct.Picture*, align 8
  %picture1.addr = alloca %struct.Picture*, align 8
...
entry:
  ...
  %picture1.addr = alloca %struct.Picture*, align 8
  %canary = alloca i32
  store i32 2039134512, i32* %canary
  %lambda_picture = alloca double, align 8
  %snr_picture1 = alloca double, align 8
  %snr_picture2 = alloca double, align 8
  %spframe = alloca i32, align 4
...
entry:
  ...
  %lambda_picture.addr = alloca double, align 8
  %canary = alloca i32
  store i32 591599907, i32* %canary
  %cost_version1 = alloca double, align 8
  %snrY_version2.addr = alloca double, align 8
  %cost_version2 = alloca double, align 8
  store double %snrY_version1, double* %snrY_version1.addr, align 8
...
entry:
  %lambda_picture.addr = alloca double, align 8
  %canary = alloca i32
  store i32 1021193260, i32* %canary
  %snrY_version1.addr = alloca double, align 8
  %retval = alloca i32, align 4
  %bits_version2.addr = alloca i32, align 4
  %cost_version2 = alloca double, align 8
...
entry:
  ...
  %spframe = alloca i32, align 4
  %canary = alloca i32
  store i32 900416777, i32* %canary
  %lambda_picture = alloca double, align 8
  %bframe = alloca i32, align 4
  %picture2.addr = alloca %struct.Picture*, align 8
  %bit_picture1 = alloca i32, align 4
...
entry:
  ...
  %lambda_picture = alloca double, align 8
  %canary = alloca i32
  store i32 1626709458, i32* %canary
  %picture2.addr = alloca %struct.Picture*, align 8
  store %struct.Picture* %picture1, %struct.Picture** %picture1.addr, align 8
  store %struct.Picture* %picture2, %struct.Picture** %picture2.addr, align 8
  store i32 %qp, i32* %qp.addr, align 4
