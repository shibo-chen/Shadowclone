; ModuleID = 'biariencode.c.rand.8P1.bc'
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_arienco_start_encoding.1, label %ctrl0

func_arienco_start_encoding.1:                    ; preds = %rand_bb
  call void @arienco_start_encoding.1(%struct.EncodingEnvironment* %eep, i8* %code_buffer, i32* %code_len, i32 %slice_type)
  ret void

func_arienco_start_encoding.5:                    ; preds = %ctrl0
  call void @arienco_start_encoding.5(%struct.EncodingEnvironment* %eep, i8* %code_buffer, i32* %code_len, i32 %slice_type)
  ret void

func_arienco_start_encoding.11:                   ; preds = %ctrl1
  call void @arienco_start_encoding.11(%struct.EncodingEnvironment* %eep, i8* %code_buffer, i32* %code_len, i32 %slice_type)
  ret void

func_arienco_start_encoding.12:                   ; preds = %ctrl2
  call void @arienco_start_encoding.12(%struct.EncodingEnvironment* %eep, i8* %code_buffer, i32* %code_len, i32 %slice_type)
  ret void

func_arienco_start_encoding.13:                   ; preds = %ctrl3
  call void @arienco_start_encoding.13(%struct.EncodingEnvironment* %eep, i8* %code_buffer, i32* %code_len, i32 %slice_type)
  ret void

func_arienco_start_encoding.17:                   ; preds = %ctrl4
  call void @arienco_start_encoding.17(%struct.EncodingEnvironment* %eep, i8* %code_buffer, i32* %code_len, i32 %slice_type)
  ret void

func_arienco_start_encoding.27:                   ; preds = %ctrl5
  call void @arienco_start_encoding.27(%struct.EncodingEnvironment* %eep, i8* %code_buffer, i32* %code_len, i32 %slice_type)
  ret void

func_arienco_start_encoding.33:                   ; preds = %ctrl5
  call void @arienco_start_encoding.33(%struct.EncodingEnvironment* %eep, i8* %code_buffer, i32* %code_len, i32 %slice_type)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_arienco_start_encoding.5, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_arienco_start_encoding.11, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_arienco_start_encoding.12, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_arienco_start_encoding.13, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_arienco_start_encoding.17, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_arienco_start_encoding.27, label %func_arienco_start_encoding.33
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_biari_encode_symbol.7, label %ctrl0

func_biari_encode_symbol.7:                       ; preds = %rand_bb
  call void @biari_encode_symbol.7(%struct.EncodingEnvironment* %eep, i16 %symbol, %struct.BiContextType* %bi_ct)
  ret void

func_biari_encode_symbol.14:                      ; preds = %ctrl0
  call void @biari_encode_symbol.14(%struct.EncodingEnvironment* %eep, i16 %symbol, %struct.BiContextType* %bi_ct)
  ret void

func_biari_encode_symbol.19:                      ; preds = %ctrl1
  call void @biari_encode_symbol.19(%struct.EncodingEnvironment* %eep, i16 %symbol, %struct.BiContextType* %bi_ct)
  ret void

func_biari_encode_symbol.20:                      ; preds = %ctrl2
  call void @biari_encode_symbol.20(%struct.EncodingEnvironment* %eep, i16 %symbol, %struct.BiContextType* %bi_ct)
  ret void

func_biari_encode_symbol.21:                      ; preds = %ctrl3
  call void @biari_encode_symbol.21(%struct.EncodingEnvironment* %eep, i16 %symbol, %struct.BiContextType* %bi_ct)
  ret void

func_biari_encode_symbol.23:                      ; preds = %ctrl4
  call void @biari_encode_symbol.23(%struct.EncodingEnvironment* %eep, i16 %symbol, %struct.BiContextType* %bi_ct)
  ret void

func_biari_encode_symbol.24:                      ; preds = %ctrl5
  call void @biari_encode_symbol.24(%struct.EncodingEnvironment* %eep, i16 %symbol, %struct.BiContextType* %bi_ct)
  ret void

func_biari_encode_symbol.29:                      ; preds = %ctrl5
  call void @biari_encode_symbol.29(%struct.EncodingEnvironment* %eep, i16 %symbol, %struct.BiContextType* %bi_ct)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_biari_encode_symbol.14, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_biari_encode_symbol.19, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_biari_encode_symbol.20, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_biari_encode_symbol.21, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_biari_encode_symbol.23, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_biari_encode_symbol.24, label %func_biari_encode_symbol.29
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_biari_encode_symbol_eq_prob.2, label %ctrl0

func_biari_encode_symbol_eq_prob.2:               ; preds = %rand_bb
  call void @biari_encode_symbol_eq_prob.2(%struct.EncodingEnvironment* %eep, i16 %symbol)
  ret void

func_biari_encode_symbol_eq_prob.3:               ; preds = %ctrl0
  call void @biari_encode_symbol_eq_prob.3(%struct.EncodingEnvironment* %eep, i16 %symbol)
  ret void

func_biari_encode_symbol_eq_prob.8:               ; preds = %ctrl1
  call void @biari_encode_symbol_eq_prob.8(%struct.EncodingEnvironment* %eep, i16 %symbol)
  ret void

func_biari_encode_symbol_eq_prob.9:               ; preds = %ctrl2
  call void @biari_encode_symbol_eq_prob.9(%struct.EncodingEnvironment* %eep, i16 %symbol)
  ret void

func_biari_encode_symbol_eq_prob.10:              ; preds = %ctrl3
  call void @biari_encode_symbol_eq_prob.10(%struct.EncodingEnvironment* %eep, i16 %symbol)
  ret void

func_biari_encode_symbol_eq_prob.15:              ; preds = %ctrl3
  call void @biari_encode_symbol_eq_prob.15(%struct.EncodingEnvironment* %eep, i16 %symbol)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_biari_encode_symbol_eq_prob.3, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_biari_encode_symbol_eq_prob.8, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_biari_encode_symbol_eq_prob.9, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_biari_encode_symbol_eq_prob.10, label %func_biari_encode_symbol_eq_prob.15
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_biari_encode_symbol_final.4, label %ctrl0

func_biari_encode_symbol_final.4:                 ; preds = %rand_bb
  call void @biari_encode_symbol_final.4(%struct.EncodingEnvironment* %eep, i16 %symbol)
  ret void

func_biari_encode_symbol_final.6:                 ; preds = %ctrl0
  call void @biari_encode_symbol_final.6(%struct.EncodingEnvironment* %eep, i16 %symbol)
  ret void

func_biari_encode_symbol_final.22:                ; preds = %ctrl1
  call void @biari_encode_symbol_final.22(%struct.EncodingEnvironment* %eep, i16 %symbol)
  ret void

func_biari_encode_symbol_final.25:                ; preds = %ctrl2
  call void @biari_encode_symbol_final.25(%struct.EncodingEnvironment* %eep, i16 %symbol)
  ret void

func_biari_encode_symbol_final.30:                ; preds = %ctrl3
  call void @biari_encode_symbol_final.30(%struct.EncodingEnvironment* %eep, i16 %symbol)
  ret void

func_biari_encode_symbol_final.34:                ; preds = %ctrl4
  call void @biari_encode_symbol_final.34(%struct.EncodingEnvironment* %eep, i16 %symbol)
  ret void

func_biari_encode_symbol_final.35:                ; preds = %ctrl5
  call void @biari_encode_symbol_final.35(%struct.EncodingEnvironment* %eep, i16 %symbol)
  ret void

func_biari_encode_symbol_final.36:                ; preds = %ctrl5
  call void @biari_encode_symbol_final.36(%struct.EncodingEnvironment* %eep, i16 %symbol)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_biari_encode_symbol_final.6, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_biari_encode_symbol_final.22, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_biari_encode_symbol_final.25, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_biari_encode_symbol_final.30, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_biari_encode_symbol_final.34, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_biari_encode_symbol_final.35, label %func_biari_encode_symbol_final.36
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_biari_init_context.16, label %ctrl0

func_biari_init_context.16:                       ; preds = %rand_bb
  call void @biari_init_context.16(%struct.BiContextType* %ctx, i32* %ini)
  ret void

func_biari_init_context.18:                       ; preds = %ctrl0
  call void @biari_init_context.18(%struct.BiContextType* %ctx, i32* %ini)
  ret void

func_biari_init_context.26:                       ; preds = %ctrl1
  call void @biari_init_context.26(%struct.BiContextType* %ctx, i32* %ini)
  ret void

func_biari_init_context.28:                       ; preds = %ctrl2
  call void @biari_init_context.28(%struct.BiContextType* %ctx, i32* %ini)
  ret void

func_biari_init_context.31:                       ; preds = %ctrl3
  call void @biari_init_context.31(%struct.BiContextType* %ctx, i32* %ini)
  ret void

func_biari_init_context.32:                       ; preds = %ctrl3
  call void @biari_init_context.32(%struct.BiContextType* %ctx, i32* %ini)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_biari_init_context.18, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_biari_init_context.26, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_biari_init_context.28, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_biari_init_context.31, label %func_biari_init_context.32
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @arienco_start_encoding.1(%struct.EncodingEnvironment* %eep, i8* %code_buffer, i32* %code_len, i32 %slice_type) #0 {
entry:
  %canary = alloca i32
  store i32 417869868, i32* %canary
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  ...
  %15 = icmp eq i32 %14, 417869868
  br i1 %15, label %16, label %func_exit

16:                                               ; preds = %entry, %func_exit
  ret void
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_encode_symbol_eq_prob.2(%struct.EncodingEnvironment* %eep, i16 signext %symbol) #0 {
entry:
  %canary = alloca i32
  store i32 1491996289, i32* %canary
...
if.end124:                                        ; preds = %if.end123, %while.end51
  ...
  %104 = load i32, i32* %canary
  %105 = icmp eq i32 %104, 1491996289
  br i1 %105, label %106, label %func_exit

106:                                              ; preds = %if.end124, %func_exit
  ret void

func_exit:                                        ; preds = %if.end124
  call void @detect_breach()
  br label %106
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_encode_symbol_eq_prob.3(%struct.EncodingEnvironment* %eep, i16 signext %symbol) #0 {
entry:
  %canary = alloca i32
  store i32 665252570, i32* %canary
  %low = alloca i32, align 4
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %symbol.addr = alloca i16, align 2
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_encode_symbol_final.4(%struct.EncodingEnvironment* %eep, i16 signext %symbol) #0 {
entry:
  %symbol.addr = alloca i16, align 2
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %low = alloca i32, align 4
  %canary = alloca i32
  store i32 1929254647, i32* %canary
...
while.end125:                                     ; preds = %while.cond
  ...
  %110 = load i32, i32* %canary
  %111 = icmp eq i32 %110, 1929254647
  br i1 %111, label %112, label %func_exit

112:                                              ; preds = %while.end125, %func_exit
  ret void

func_exit:                                        ; preds = %while.end125
  call void @detect_breach()
  br label %112
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @arienco_start_encoding.5(%struct.EncodingEnvironment* %eep, i8* %code_buffer, i32* %code_len, i32 %slice_type) #0 {
entry:
  %code_len.addr = alloca i32*, align 8
  %code_buffer.addr = alloca i8*, align 8
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 917364945, i32* %canary
  %slice_type.addr = alloca i32, align 4
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i8* %code_buffer, i8** %code_buffer.addr, align 8
  store i32* %code_len, i32** %code_len.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_encode_symbol_final.6(%struct.EncodingEnvironment* %eep, i16 signext %symbol) #0 {
entry:
  %symbol.addr = alloca i16, align 2
  %low = alloca i32, align 4
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 764776596, i32* %canary
  %range = alloca i32, align 4
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
  %0 = load %struct.EncodingEnvironment*, %struct.EncodingEnvironment** %eep.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_encode_symbol.7(%struct.EncodingEnvironment* %eep, i16 signext %symbol, %struct.BiContextType* %bi_ct) #0 {
entry:
  %low = alloca i32, align 4
  %symbol.addr = alloca i16, align 2
  %range = alloca i32, align 4
  %canary = alloca i32
  store i32 1178084633, i32* %canary
...
while.end162:                                     ; preds = %while.cond
  ...
  %137 = icmp eq i32 %136, 1178084633
  br i1 %137, label %138, label %func_exit

138:                                              ; preds = %while.end162, %func_exit
  ret void

func_exit:                                        ; preds = %while.end162
  call void @detect_breach()
  br label %138
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_encode_symbol_eq_prob.8(%struct.EncodingEnvironment* %eep, i16 signext %symbol) #0 {
entry:
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 683725083, i32* %canary
  %low = alloca i32, align 4
  %symbol.addr = alloca i16, align 2
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_encode_symbol_eq_prob.9(%struct.EncodingEnvironment* %eep, i16 signext %symbol) #0 {
entry:
  %canary = alloca i32
  store i32 875044315, i32* %canary
  %low = alloca i32, align 4
  %symbol.addr = alloca i16, align 2
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_encode_symbol_eq_prob.10(%struct.EncodingEnvironment* %eep, i16 signext %symbol) #0 {
entry:
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %symbol.addr = alloca i16, align 2
  %canary = alloca i32
  store i32 1290281531, i32* %canary
  %low = alloca i32, align 4
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
  %0 = load %struct.EncodingEnvironment*, %struct.EncodingEnvironment** %eep.addr, align 8
...
if.end124:                                        ; preds = %if.end123, %while.end51
  ...
  store i32 %inc127, i32* %C126, align 8
  %104 = load i32, i32* %canary
  %105 = icmp eq i32 %104, 1290281531
  br i1 %105, label %106, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @arienco_start_encoding.11(%struct.EncodingEnvironment* %eep, i8* %code_buffer, i32* %code_len, i32 %slice_type) #0 {
entry:
  %code_len.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 1050773818, i32* %canary
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %slice_type.addr = alloca i32, align 4
  %code_buffer.addr = alloca i8*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @arienco_start_encoding.12(%struct.EncodingEnvironment* %eep, i8* %code_buffer, i32* %code_len, i32 %slice_type) #0 {
entry:
  %canary = alloca i32
  store i32 1813040854, i32* %canary
  %slice_type.addr = alloca i32, align 4
  %code_len.addr = alloca i32*, align 8
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %code_buffer.addr = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @arienco_start_encoding.13(%struct.EncodingEnvironment* %eep, i8* %code_buffer, i32* %code_len, i32 %slice_type) #0 {
entry:
  %canary = alloca i32
  store i32 1888807210, i32* %canary
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %slice_type.addr = alloca i32, align 4
  %code_buffer.addr = alloca i8*, align 8
  %code_len.addr = alloca i32*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_encode_symbol.14(%struct.EncodingEnvironment* %eep, i16 signext %symbol, %struct.BiContextType* %bi_ct) #0 {
entry:
  %canary = alloca i32
  store i32 405769037, i32* %canary
  %low = alloca i32, align 4
  %bi_ct.addr = alloca %struct.BiContextType*, align 8
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %rLPS = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_encode_symbol_eq_prob.15(%struct.EncodingEnvironment* %eep, i16 signext %symbol) #0 {
entry:
  %symbol.addr = alloca i16, align 2
  %low = alloca i32, align 4
  %canary = alloca i32
  store i32 265751958, i32* %canary
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
  %0 = load %struct.EncodingEnvironment*, %struct.EncodingEnvironment** %eep.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_init_context.16(%struct.BiContextType* %ctx, i32* %ini) #0 {
entry:
  %canary = alloca i32
  store i32 1164324530, i32* %canary
...
if.end:                                           ; preds = %if.else, %if.then
  ...
  %21 = icmp eq i32 %20, 1164324530
  br i1 %21, label %22, label %func_exit

22:                                               ; preds = %if.end, %func_exit
  ret void
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @arienco_start_encoding.17(%struct.EncodingEnvironment* %eep, i8* %code_buffer, i32* %code_len, i32 %slice_type) #0 {
entry:
  %code_len.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 1945625709, i32* %canary
  %code_buffer.addr = alloca i8*, align 8
  %slice_type.addr = alloca i32, align 4
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_init_context.18(%struct.BiContextType* %ctx, i32* %ini) #0 {
entry:
  %canary = alloca i32
  store i32 1992975100, i32* %canary
  %ctx.addr = alloca %struct.BiContextType*, align 8
  %pstate = alloca i32, align 4
  %ini.addr = alloca i32*, align 8
  store %struct.BiContextType* %ctx, %struct.BiContextType** %ctx.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_encode_symbol.19(%struct.EncodingEnvironment* %eep, i16 signext %symbol, %struct.BiContextType* %bi_ct) #0 {
entry:
  %symbol.addr = alloca i16, align 2
  %canary = alloca i32
  store i32 1771231500, i32* %canary
  %low = alloca i32, align 4
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %rLPS = alloca i32, align 4
  %range = alloca i32, align 4
...
while.end162:                                     ; preds = %while.cond
  ...
  store i32 %inc166, i32* %C165, align 8
  %136 = load i32, i32* %canary
  %137 = icmp eq i32 %136, 1771231500
  br i1 %137, label %138, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_encode_symbol.20(%struct.EncodingEnvironment* %eep, i16 signext %symbol, %struct.BiContextType* %bi_ct) #0 {
entry:
  %range = alloca i32, align 4
  %bi_ct.addr = alloca %struct.BiContextType*, align 8
  %canary = alloca i32
  store i32 1088574529, i32* %canary
  %symbol.addr = alloca i16, align 2
  %low = alloca i32, align 4
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %rLPS = alloca i32, align 4
...
while.end162:                                     ; preds = %while.cond
  ...
  store i32 %inc166, i32* %C165, align 8
  %136 = load i32, i32* %canary
  %137 = icmp eq i32 %136, 1088574529
  br i1 %137, label %138, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_encode_symbol.21(%struct.EncodingEnvironment* %eep, i16 signext %symbol, %struct.BiContextType* %bi_ct) #0 {
entry:
  %bi_ct.addr = alloca %struct.BiContextType*, align 8
  %canary = alloca i32
  store i32 1030000154, i32* %canary
  %range = alloca i32, align 4
  %rLPS = alloca i32, align 4
  %symbol.addr = alloca i16, align 2
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
...
while.end162:                                     ; preds = %while.cond
  ...
  store i32 %inc166, i32* %C165, align 8
  %136 = load i32, i32* %canary
  %137 = icmp eq i32 %136, 1030000154
  br i1 %137, label %138, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_encode_symbol_final.22(%struct.EncodingEnvironment* %eep, i16 signext %symbol) #0 {
entry:
  %canary = alloca i32
  store i32 348036935, i32* %canary
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %range = alloca i32, align 4
  %low = alloca i32, align 4
  %symbol.addr = alloca i16, align 2
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_encode_symbol.23(%struct.EncodingEnvironment* %eep, i16 signext %symbol, %struct.BiContextType* %bi_ct) #0 {
entry:
  %symbol.addr = alloca i16, align 2
  %low = alloca i32, align 4
  %range = alloca i32, align 4
  ...
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 1568086381, i32* %canary
  %bi_ct.addr = alloca %struct.BiContextType*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
  store %struct.BiContextType* %bi_ct, %struct.BiContextType** %bi_ct.addr, align 8
...
while.end162:                                     ; preds = %while.cond
  ...
  store i32 %inc166, i32* %C165, align 8
  %136 = load i32, i32* %canary
  %137 = icmp eq i32 %136, 1568086381
  br i1 %137, label %138, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_encode_symbol.24(%struct.EncodingEnvironment* %eep, i16 signext %symbol, %struct.BiContextType* %bi_ct) #0 {
entry:
  %low = alloca i32, align 4
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %range = alloca i32, align 4
  ...
  %symbol.addr = alloca i16, align 2
  %canary = alloca i32
  store i32 153255242, i32* %canary
  %bi_ct.addr = alloca %struct.BiContextType*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
  store %struct.BiContextType* %bi_ct, %struct.BiContextType** %bi_ct.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_encode_symbol_final.25(%struct.EncodingEnvironment* %eep, i16 signext %symbol) #0 {
entry:
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %low = alloca i32, align 4
  %canary = alloca i32
  store i32 1325090967, i32* %canary
  %symbol.addr = alloca i16, align 2
  %range = alloca i32, align 4
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
...
while.end125:                                     ; preds = %while.cond
  ...
  store i32 %inc129, i32* %C128, align 8
  %110 = load i32, i32* %canary
  %111 = icmp eq i32 %110, 1325090967
  br i1 %111, label %112, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_init_context.26(%struct.BiContextType* %ctx, i32* %ini) #0 {
entry:
  %canary = alloca i32
  store i32 332795593, i32* %canary
  %ctx.addr = alloca %struct.BiContextType*, align 8
  %ini.addr = alloca i32*, align 8
  %pstate = alloca i32, align 4
  store %struct.BiContextType* %ctx, %struct.BiContextType** %ctx.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @arienco_start_encoding.27(%struct.EncodingEnvironment* %eep, i8* %code_buffer, i32* %code_len, i32 %slice_type) #0 {
entry:
  %code_buffer.addr = alloca i8*, align 8
  %slice_type.addr = alloca i32, align 4
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 2130984283, i32* %canary
  %code_len.addr = alloca i32*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i8* %code_buffer, i8** %code_buffer.addr, align 8
  store i32* %code_len, i32** %code_len.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_init_context.28(%struct.BiContextType* %ctx, i32* %ini) #0 {
entry:
  %pstate = alloca i32, align 4
  %ctx.addr = alloca %struct.BiContextType*, align 8
  %canary = alloca i32
  store i32 584045694, i32* %canary
  %ini.addr = alloca i32*, align 8
  store %struct.BiContextType* %ctx, %struct.BiContextType** %ctx.addr, align 8
  store i32* %ini, i32** %ini.addr, align 8
  %0 = load i32*, i32** %ini.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_encode_symbol.29(%struct.EncodingEnvironment* %eep, i16 signext %symbol, %struct.BiContextType* %bi_ct) #0 {
entry:
  %bi_ct.addr = alloca %struct.BiContextType*, align 8
  %rLPS = alloca i32, align 4
  %symbol.addr = alloca i16, align 2
  ...
  %range = alloca i32, align 4
  %canary = alloca i32
  store i32 323120372, i32* %canary
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
  store %struct.BiContextType* %bi_ct, %struct.BiContextType** %bi_ct.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_encode_symbol_final.30(%struct.EncodingEnvironment* %eep, i16 signext %symbol) #0 {
entry:
  %low = alloca i32, align 4
  %range = alloca i32, align 4
  %canary = alloca i32
  store i32 1961331103, i32* %canary
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %symbol.addr = alloca i16, align 2
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
...
while.end125:                                     ; preds = %while.cond
  ...
  store i32 %inc129, i32* %C128, align 8
  %110 = load i32, i32* %canary
  %111 = icmp eq i32 %110, 1961331103
  br i1 %111, label %112, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_init_context.31(%struct.BiContextType* %ctx, i32* %ini) #0 {
entry:
  %ini.addr = alloca i32*, align 8
  %pstate = alloca i32, align 4
  %canary = alloca i32
  store i32 1826249050, i32* %canary
  %ctx.addr = alloca %struct.BiContextType*, align 8
  store %struct.BiContextType* %ctx, %struct.BiContextType** %ctx.addr, align 8
  store i32* %ini, i32** %ini.addr, align 8
  %0 = load i32*, i32** %ini.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_init_context.32(%struct.BiContextType* %ctx, i32* %ini) #0 {
entry:
  %pstate = alloca i32, align 4
  %ini.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 2116296821, i32* %canary
  %ctx.addr = alloca %struct.BiContextType*, align 8
  store %struct.BiContextType* %ctx, %struct.BiContextType** %ctx.addr, align 8
  store i32* %ini, i32** %ini.addr, align 8
  %0 = load i32*, i32** %ini.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @arienco_start_encoding.33(%struct.EncodingEnvironment* %eep, i8* %code_buffer, i32* %code_len, i32 %slice_type) #0 {
entry:
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %slice_type.addr = alloca i32, align 4
  %code_len.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 1918322954, i32* %canary
  %code_buffer.addr = alloca i8*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i8* %code_buffer, i8** %code_buffer.addr, align 8
  store i32* %code_len, i32** %code_len.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_encode_symbol_final.34(%struct.EncodingEnvironment* %eep, i16 signext %symbol) #0 {
entry:
  %canary = alloca i32
  store i32 1113644087, i32* %canary
  %range = alloca i32, align 4
  %symbol.addr = alloca i16, align 2
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %low = alloca i32, align 4
...
while.end125:                                     ; preds = %while.cond
  ...
  store i32 %inc129, i32* %C128, align 8
  %110 = load i32, i32* %canary
  %111 = icmp eq i32 %110, 1113644087
  br i1 %111, label %112, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_encode_symbol_final.35(%struct.EncodingEnvironment* %eep, i16 signext %symbol) #0 {
entry:
  %symbol.addr = alloca i16, align 2
  %range = alloca i32, align 4
  %low = alloca i32, align 4
  %canary = alloca i32
  store i32 1778479988, i32* %canary
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
  %0 = load %struct.EncodingEnvironment*, %struct.EncodingEnvironment** %eep.addr, align 8
...
while.end125:                                     ; preds = %while.cond
  ...
  store i32 %inc129, i32* %C128, align 8
  %110 = load i32, i32* %canary
  %111 = icmp eq i32 %110, 1778479988
  br i1 %111, label %112, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_encode_symbol_final.36(%struct.EncodingEnvironment* %eep, i16 signext %symbol) #0 {
entry:
  %canary = alloca i32
  store i32 1487219464, i32* %canary
  %symbol.addr = alloca i16, align 2
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %range = alloca i32, align 4
  %low = alloca i32, align 4
...
while.end125:                                     ; preds = %while.cond
  ...
  store i32 %inc129, i32* %C128, align 8
  %110 = load i32, i32* %canary
  %111 = icmp eq i32 %110, 1487219464
  br i1 %111, label %112, label %func_exit
