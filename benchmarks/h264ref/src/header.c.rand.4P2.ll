...
func_SliceHeader.6:                               ; preds = %ctrl0
  %3 = call i32 @SliceHeader.6()
  ret i32 %3

func_SliceHeader.20:                              ; preds = %ctrl1
  %4 = call i32 @SliceHeader.20()
  ret i32 %4

func_SliceHeader.21:                              ; preds = %ctrl1
  %5 = call i32 @SliceHeader.21()
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_SliceHeader.6, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_SliceHeader.20, label %func_SliceHeader.21
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_get_picture_type.2, label %func_get_picture_type.9
...
func_Partition_BC_Header.11:                      ; preds = %ctrl0
  %3 = call i32 @Partition_BC_Header.11(i32 %PartNo)
  ret i32 %3

func_Partition_BC_Header.18:                      ; preds = %ctrl1
  %4 = call i32 @Partition_BC_Header.18(i32 %PartNo)
  ret i32 %4

func_Partition_BC_Header.19:                      ; preds = %ctrl1
  %5 = call i32 @Partition_BC_Header.19(i32 %PartNo)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_Partition_BC_Header.11, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_Partition_BC_Header.18, label %func_Partition_BC_Header.19
}
...
func_ref_pic_list_reordering.13:                  ; preds = %ctrl1
  %4 = call i32 @ref_pic_list_reordering.13()
  ret i32 %4

func_ref_pic_list_reordering.17:                  ; preds = %ctrl1
  %5 = call i32 @ref_pic_list_reordering.17()
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_ref_pic_list_reordering.7, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_ref_pic_list_reordering.13, label %func_ref_pic_list_reordering.17
}
...
func_dec_ref_pic_marking.22:                      ; preds = %ctrl1
...
ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_dec_ref_pic_marking.16, label %func_dec_ref_pic_marking.22
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_pred_weight_table.8, label %ctrl0

func_pred_weight_table.8:                         ; preds = %rand_bb
  %2 = call i32 @pred_weight_table.8()
  ret i32 %2
...
func_pred_weight_table.15:                        ; preds = %ctrl1
  %5 = call i32 @pred_weight_table.15()
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_pred_weight_table.12, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_pred_weight_table.14, label %func_pred_weight_table.15
}
...
entry:
  %canary = alloca i32
  store i32 507661989, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 258327801, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1703908778, i32* %canary
  %partition = alloca %struct.datapartition*, align 8
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
  %1 = load i32, i32* %partition_mode, align 4
...
entry:
  %partition = alloca %struct.datapartition*, align 8
  %canary = alloca i32
  store i32 691238387, i32* %canary
  %len = alloca i32, align 4
  %dP_nr = alloca i32, align 4
...
entry:
  ...
  %len = alloca i32, align 4
  %canary = alloca i32
  store i32 2088994136, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @SliceHeader.6() #0 {
entry:
  %canary = alloca i32
  store i32 417752993, i32* %canary
  %override_flag = alloca i32, align 4
  %dP_nr = alloca i32, align 4
  %num_bits_slice_group_change_cycle = alloca i32, align 4
  %field_pic_flag = alloca i32, align 4
...
entry:
  ...
  %len = alloca i32, align 4
  %canary = alloca i32
  store i32 1854972326, i32* %canary
  %currSlice = alloca %struct.Slice*, align 8
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
  %1 = load i32, i32* %partition_mode, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @pred_weight_table.8() #0 {
entry:
  %j = alloca i32, align 4
  %i = alloca i32, align 4
  %dP_nr = alloca i32, align 4
  %canary = alloca i32
  store i32 910089548, i32* %canary
  %len = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
...
entry:
  %canary = alloca i32
  store i32 1766806619, i32* %canary
  %retval = alloca i32, align 4
  %same_slicetype_for_whole_frame = alloca i32, align 4
  store i32 5, i32* %same_slicetype_for_whole_frame, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
entry:
  ...
  %partition = alloca %struct.datapartition*, align 8
  %canary = alloca i32
  store i32 1422749935, i32* %canary
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
  %val = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
...
entry:
  ...
  %PartNo.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 141077149, i32* %canary
  %partition = alloca %struct.datapartition*, align 8
  %sym = alloca %struct.syntaxelement*, align 8
  store i32 %PartNo, i32* %PartNo.addr, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
entry:
  %canary = alloca i32
  store i32 761686451, i32* %canary
  %j = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
  %i = alloca i32, align 4
  %dP_nr = alloca i32, align 4
...
entry:
  %currSlice = alloca %struct.Slice*, align 8
  %canary = alloca i32
  store i32 1328836973, i32* %canary
  %dP_nr = alloca i32, align 4
  %i = alloca i32, align 4
  %len = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
...
entry:
  %dP_nr = alloca i32, align 4
  %canary = alloca i32
  store i32 1392391907, i32* %canary
  %i = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
  %len = alloca i32, align 4
  %j = alloca i32, align 4
...
if.end175:                                        ; preds = %for.end174, %for.end83
  %170 = load i32, i32* %len, align 4
  %171 = load i32, i32* %canary
  %172 = icmp eq i32 %171, 1392391907
  br i1 %172, label %173, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @pred_weight_table.15() #0 {
entry:
  %dP_nr = alloca i32, align 4
  %len = alloca i32, align 4
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 714178196, i32* %canary
  %i = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
...
entry:
  ...
  %partition = alloca %struct.datapartition*, align 8
  %canary = alloca i32
  store i32 1987277179, i32* %canary
  %val = alloca i32, align 4
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @ref_pic_list_reordering.17() #0 {
entry:
  %i = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
  %currSlice = alloca %struct.Slice*, align 8
  %len = alloca i32, align 4
  %canary = alloca i32
  store i32 602215821, i32* %canary
  %dP_nr = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
  %1 = load i32, i32* %partition_mode, align 4
...
entry:
  %PartNo.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1793201507, i32* %canary
  %sym = alloca %struct.syntaxelement*, align 8
  %partition = alloca %struct.datapartition*, align 8
  %symbol = alloca %struct.syntaxelement, align 8
  %len = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1754131318, i32* %canary
  %sym = alloca %struct.syntaxelement*, align 8
  %partition = alloca %struct.datapartition*, align 8
  %len = alloca i32, align 4
  %symbol = alloca %struct.syntaxelement, align 8
...
entry:
  %dP_nr = alloca i32, align 4
  %canary = alloca i32
  store i32 828074094, i32* %canary
  %field_pic_flag = alloca i32, align 4
  %len = alloca i32, align 4
  %bottom_field_flag = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
...
entry:
  ...
  %field_pic_flag = alloca i32, align 4
  %canary = alloca i32
  store i32 1741080198, i32* %canary
  %bottom_field_flag = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
  %1 = load i32, i32* %partition_mode, align 4
...
if.end239:                                        ; preds = %if.then236, %land.lhs.true232, %if.end229
  %236 = load i32, i32* %len, align 4
  %237 = load i32, i32* %canary
  %238 = icmp eq i32 %237, 1741080198
  br i1 %238, label %239, label %func_exit
...
entry:
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
  %canary = alloca i32
  store i32 880412393, i32* %canary
  %val = alloca i32, align 4
  %len = alloca i32, align 4
  %dP_nr = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
