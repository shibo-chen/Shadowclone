; ModuleID = 'mb_access.c.rand.8P3.bc'
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_mb_is_available.1, label %ctrl0

func_mb_is_available.1:                           ; preds = %rand_bb
  %2 = call i32 @mb_is_available.1(i32 %mbAddr, i32 %currMbAddr)
  ret i32 %2

func_mb_is_available.6:                           ; preds = %ctrl0
  %3 = call i32 @mb_is_available.6(i32 %mbAddr, i32 %currMbAddr)
  ret i32 %3

func_mb_is_available.10:                          ; preds = %ctrl1
  %4 = call i32 @mb_is_available.10(i32 %mbAddr, i32 %currMbAddr)
  ret i32 %4

func_mb_is_available.14:                          ; preds = %ctrl2
  %5 = call i32 @mb_is_available.14(i32 %mbAddr, i32 %currMbAddr)
  ret i32 %5

func_mb_is_available.15:                          ; preds = %ctrl3
  %6 = call i32 @mb_is_available.15(i32 %mbAddr, i32 %currMbAddr)
  ret i32 %6

func_mb_is_available.18:                          ; preds = %ctrl3
  %7 = call i32 @mb_is_available.18(i32 %mbAddr, i32 %currMbAddr)
  ret i32 %7

ctrl0:                                            ; preds = %rand_bb
  %8 = icmp eq i32 %0, 1
  br i1 %8, label %func_mb_is_available.6, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %9 = icmp eq i32 %0, 2
  br i1 %9, label %func_mb_is_available.10, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %10 = icmp eq i32 %0, 3
  br i1 %10, label %func_mb_is_available.14, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %11 = icmp eq i32 %0, 4
  br i1 %11, label %func_mb_is_available.15, label %func_mb_is_available.18
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_CheckAvailabilityOfNeighbors.20, label %func_CheckAvailabilityOfNeighbors.21
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_get_mb_block_pos.2, label %ctrl0

func_get_mb_block_pos.2:                          ; preds = %rand_bb
  call void @get_mb_block_pos.2(i32 %mb_addr, i32* %x, i32* %y)
  ret void

func_get_mb_block_pos.23:                         ; preds = %ctrl0
  call void @get_mb_block_pos.23(i32 %mb_addr, i32* %x, i32* %y)
  ret void

func_get_mb_block_pos.31:                         ; preds = %ctrl1
  call void @get_mb_block_pos.31(i32 %mb_addr, i32* %x, i32* %y)
  ret void

func_get_mb_block_pos.37:                         ; preds = %ctrl2
  call void @get_mb_block_pos.37(i32 %mb_addr, i32* %x, i32* %y)
  ret void

func_get_mb_block_pos.42:                         ; preds = %ctrl3
  call void @get_mb_block_pos.42(i32 %mb_addr, i32* %x, i32* %y)
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_get_mb_block_pos.23, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_get_mb_block_pos.31, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_get_mb_block_pos.37, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_get_mb_block_pos.42, label %func_get_mb_block_pos.48
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_get_mb_pos.16, label %ctrl0

func_get_mb_pos.16:                               ; preds = %rand_bb
  call void @get_mb_pos.16(i32 %mb_addr, i32* %x, i32* %y)
  ret void

func_get_mb_pos.17:                               ; preds = %ctrl0
  call void @get_mb_pos.17(i32 %mb_addr, i32* %x, i32* %y)
  ret void

func_get_mb_pos.34:                               ; preds = %ctrl1
  call void @get_mb_pos.34(i32 %mb_addr, i32* %x, i32* %y)
  ret void

func_get_mb_pos.35:                               ; preds = %ctrl2
  call void @get_mb_pos.35(i32 %mb_addr, i32* %x, i32* %y)
  ret void

func_get_mb_pos.43:                               ; preds = %ctrl3
  call void @get_mb_pos.43(i32 %mb_addr, i32* %x, i32* %y)
  ret void

func_get_mb_pos.44:                               ; preds = %ctrl3
  call void @get_mb_pos.44(i32 %mb_addr, i32* %x, i32* %y)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_get_mb_pos.17, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_get_mb_pos.34, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_get_mb_pos.35, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_get_mb_pos.43, label %func_get_mb_pos.44
}
...
func_getNonAffNeighbour.5:                        ; preds = %ctrl0
  call void @getNonAffNeighbour.5(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

func_getNonAffNeighbour.40:                       ; preds = %ctrl1
  call void @getNonAffNeighbour.40(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

func_getNonAffNeighbour.41:                       ; preds = %ctrl2
  call void @getNonAffNeighbour.41(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

func_getNonAffNeighbour.50:                       ; preds = %ctrl3
  call void @getNonAffNeighbour.50(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

func_getNonAffNeighbour.51:                       ; preds = %ctrl4
  call void @getNonAffNeighbour.51(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

func_getNonAffNeighbour.57:                       ; preds = %ctrl5
  call void @getNonAffNeighbour.57(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

func_getNonAffNeighbour.58:                       ; preds = %ctrl5
  call void @getNonAffNeighbour.58(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_getNonAffNeighbour.5, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_getNonAffNeighbour.40, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_getNonAffNeighbour.41, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_getNonAffNeighbour.50, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_getNonAffNeighbour.51, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_getNonAffNeighbour.57, label %func_getNonAffNeighbour.58
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_getAffNeighbour.33, label %ctrl0

func_getAffNeighbour.33:                          ; preds = %rand_bb
...
func_getAffNeighbour.47:                          ; preds = %ctrl1
  call void @getAffNeighbour.47(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

func_getAffNeighbour.53:                          ; preds = %ctrl2
  call void @getAffNeighbour.53(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

func_getAffNeighbour.54:                          ; preds = %ctrl3
  call void @getAffNeighbour.54(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

func_getAffNeighbour.55:                          ; preds = %ctrl4
...
func_getAffNeighbour.59:                          ; preds = %ctrl5
  call void @getAffNeighbour.59(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_getAffNeighbour.47, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_getAffNeighbour.53, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_getAffNeighbour.54, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_getAffNeighbour.55, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_getAffNeighbour.56, label %func_getAffNeighbour.59
}
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_getNeighbour.9, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_getNeighbour.11, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_getNeighbour.24, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_getNeighbour.27, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_getNeighbour.30, label %func_getNeighbour.32
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_getLuma4x4Neighbour.29, label %ctrl0

func_getLuma4x4Neighbour.29:                      ; preds = %rand_bb
  call void @getLuma4x4Neighbour.29(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix)
  ret void

func_getLuma4x4Neighbour.36:                      ; preds = %ctrl0
  call void @getLuma4x4Neighbour.36(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix)
  ret void
...
func_getLuma4x4Neighbour.45:                      ; preds = %ctrl2
  call void @getLuma4x4Neighbour.45(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix)
  ret void
...
func_getLuma4x4Neighbour.49:                      ; preds = %ctrl4
  call void @getLuma4x4Neighbour.49(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix)
  ret void

func_getLuma4x4Neighbour.52:                      ; preds = %ctrl5
  call void @getLuma4x4Neighbour.52(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix)
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_getLuma4x4Neighbour.36, label %ctrl1
...
ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_getLuma4x4Neighbour.45, label %ctrl3
...
ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_getLuma4x4Neighbour.49, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_getLuma4x4Neighbour.52, label %func_getLuma4x4Neighbour.60
}
...
func_getChroma4x4Neighbour.12:                    ; preds = %ctrl0
  call void @getChroma4x4Neighbour.12(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix)
  ret void

func_getChroma4x4Neighbour.13:                    ; preds = %ctrl1
  call void @getChroma4x4Neighbour.13(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix)
  ret void

func_getChroma4x4Neighbour.19:                    ; preds = %ctrl2
  call void @getChroma4x4Neighbour.19(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix)
  ret void

func_getChroma4x4Neighbour.22:                    ; preds = %ctrl3
  call void @getChroma4x4Neighbour.22(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix)
  ret void

func_getChroma4x4Neighbour.25:                    ; preds = %ctrl4
  call void @getChroma4x4Neighbour.25(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix)
  ret void

func_getChroma4x4Neighbour.26:                    ; preds = %ctrl5
  call void @getChroma4x4Neighbour.26(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix)
  ret void

func_getChroma4x4Neighbour.28:                    ; preds = %ctrl5
  call void @getChroma4x4Neighbour.28(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_getChroma4x4Neighbour.12, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_getChroma4x4Neighbour.13, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_getChroma4x4Neighbour.19, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_getChroma4x4Neighbour.22, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_getChroma4x4Neighbour.25, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_getChroma4x4Neighbour.26, label %func_getChroma4x4Neighbour.28
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @mb_is_available.1(i32 %mbAddr, i32 %currMbAddr) #0 {
entry:
  %mbAddr.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 713136304, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @get_mb_block_pos.2(i32 %mb_addr, i32* %x, i32* %y) #0 {
entry:
  %x.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 822360207, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1716488504, i32* %canary
...
entry:
  %yN.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2072954576, i32* %canary
  %pix.addr = alloca %struct.pix_pos*, align 8
  %luma.addr = alloca i32, align 4
...
entry:
  ...
  %maxH = alloca i32, align 4
  %canary = alloca i32
  store i32 875240162, i32* %canary
  %yN.addr = alloca i32, align 4
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
  store i32 %xN, i32* %xN.addr, align 4
  store i32 %yN, i32* %yN.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @mb_is_available.6(i32 %mbAddr, i32 %currMbAddr) #0 {
entry:
  %canary = alloca i32
  store i32 1231667046, i32* %canary
  %mbAddr.addr = alloca i32, align 4
  %currMbAddr.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  store i32 %mbAddr, i32* %mbAddr.addr, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 1522629056, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 763215987, i32* %canary
  %xN.addr = alloca i32, align 4
  %yN.addr = alloca i32, align 4
  %luma.addr = alloca i32, align 4
  %curr_mb_nr.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getNeighbour.9(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix) #0 {
entry:
  %canary = alloca i32
  store i32 1878085022, i32* %canary
  %curr_mb_nr.addr = alloca i32, align 4
  %luma.addr = alloca i32, align 4
  %xN.addr = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @mb_is_available.10(i32 %mbAddr, i32 %currMbAddr) #0 {
entry:
  %currMbAddr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 15489150, i32* %canary
  %mbAddr.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  store i32 %mbAddr, i32* %mbAddr.addr, align 4
  store i32 %currMbAddr, i32* %currMbAddr.addr, align 4
...
entry:
  ...
  %pix.addr = alloca %struct.pix_pos*, align 8
  %canary = alloca i32
  store i32 1640886785, i32* %canary
  %luma.addr = alloca i32, align 4
  %yN.addr = alloca i32, align 4
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
  store i32 %xN, i32* %xN.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getChroma4x4Neighbour.12(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix) #0 {
entry:
  %block_y.addr = alloca i32, align 4
  %x = alloca i32, align 4
  %rel_y.addr = alloca i32, align 4
  ...
  %rel_x.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 291987771, i32* %canary
  %block_x.addr = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
  store i32 %block_x, i32* %block_x.addr, align 4
...
entry:
  ...
  %block_y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 864216780, i32* %canary
  %rel_y.addr = alloca i32, align 4
  %block_x.addr = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
  %curr_mb_nr.addr = alloca i32, align 4
...
entry:
  ...
  %mbAddr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1432662742, i32* %canary
  %currMbAddr.addr = alloca i32, align 4
  store i32 %mbAddr, i32* %mbAddr.addr, align 4
  store i32 %currMbAddr, i32* %currMbAddr.addr, align 4
  %0 = load i32, i32* %mbAddr.addr, align 4
...
entry:
  %currMbAddr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 788066700, i32* %canary
  %retval = alloca i32, align 4
  %mbAddr.addr = alloca i32, align 4
  store i32 %mbAddr, i32* %mbAddr.addr, align 4
  store i32 %currMbAddr, i32* %currMbAddr.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @get_mb_pos.16(i32 %mb_addr, i32* %x, i32* %y) #0 {
entry:
  %canary = alloca i32
  store i32 607107061, i32* %canary
  %y.addr = alloca i32*, align 8
  %mb_addr.addr = alloca i32, align 4
  %x.addr = alloca i32*, align 8
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @get_mb_pos.17(i32 %mb_addr, i32* %x, i32* %y) #0 {
entry:
  %canary = alloca i32
  store i32 978837423, i32* %canary
  %x.addr = alloca i32*, align 8
  %mb_addr.addr = alloca i32, align 4
  %y.addr = alloca i32*, align 8
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @mb_is_available.18(i32 %mbAddr, i32 %currMbAddr) #0 {
entry:
  %canary = alloca i32
  store i32 1037461427, i32* %canary
  %retval = alloca i32, align 4
  %currMbAddr.addr = alloca i32, align 4
  %mbAddr.addr = alloca i32, align 4
  store i32 %mbAddr, i32* %mbAddr.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getChroma4x4Neighbour.19(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix) #0 {
entry:
  %block_y.addr = alloca i32, align 4
  %rel_x.addr = alloca i32, align 4
  %y = alloca i32, align 4
  %rel_y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 654458751, i32* %canary
  %x = alloca i32, align 4
  %block_x.addr = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
  %curr_mb_nr.addr = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 526578383, i32* %canary
  %currMB = alloca %struct.macroblock*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getChroma4x4Neighbour.22(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix) #0 {
entry:
  %pix.addr = alloca %struct.pix_pos*, align 8
  %x = alloca i32, align 4
  %block_x.addr = alloca i32, align 4
  ...
  %block_y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1275373821, i32* %canary
  %rel_y.addr = alloca i32, align 4
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
  store i32 %block_x, i32* %block_x.addr, align 4
  store i32 %block_y, i32* %block_y.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 224072428, i32* %canary
  %x.addr = alloca i32*, align 8
  %y.addr = alloca i32*, align 8
  %mb_addr.addr = alloca i32, align 4
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 1282351297, i32* %canary
  %xN.addr = alloca i32, align 4
  %curr_mb_nr.addr = alloca i32, align 4
  %yN.addr = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getChroma4x4Neighbour.25(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix) #0 {
entry:
  %rel_x.addr = alloca i32, align 4
  %block_y.addr = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
  %curr_mb_nr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1328900014, i32* %canary
  %block_x.addr = alloca i32, align 4
  %x = alloca i32, align 4
  %rel_y.addr = alloca i32, align 4
  %y = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getChroma4x4Neighbour.26(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix) #0 {
entry:
  %y = alloca i32, align 4
  %rel_x.addr = alloca i32, align 4
  %rel_y.addr = alloca i32, align 4
  ...
  %x = alloca i32, align 4
  %canary = alloca i32
  store i32 1349385648, i32* %canary
  %block_x.addr = alloca i32, align 4
  %curr_mb_nr.addr = alloca i32, align 4
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
  store i32 %block_x, i32* %block_x.addr, align 4
...
entry:
  ...
  %pix.addr = alloca %struct.pix_pos*, align 8
  %canary = alloca i32
  store i32 908549827, i32* %canary
  %luma.addr = alloca i32, align 4
  %xN.addr = alloca i32, align 4
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
  store i32 %xN, i32* %xN.addr, align 4
...
entry:
  ...
  %block_x.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2046996883, i32* %canary
  %rel_x.addr = alloca i32, align 4
  %y = alloca i32, align 4
  %rel_y.addr = alloca i32, align 4
  %x = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getLuma4x4Neighbour.29(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix) #0 {
entry:
  %pix.addr = alloca %struct.pix_pos*, align 8
  %canary = alloca i32
  store i32 650358953, i32* %canary
  %y = alloca i32, align 4
  %curr_mb_nr.addr = alloca i32, align 4
  %block_x.addr = alloca i32, align 4
  %block_y.addr = alloca i32, align 4
...
entry:
  ...
  %xN.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1550662079, i32* %canary
  %yN.addr = alloca i32, align 4
  %curr_mb_nr.addr = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
...
entry:
  %mb_addr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1133567009, i32* %canary
  %y.addr = alloca i32*, align 8
  %x.addr = alloca i32*, align 8
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
  store i32* %x, i32** %x.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 303498630, i32* %canary
  %luma.addr = alloca i32, align 4
  %curr_mb_nr.addr = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
  %xN.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @get_mb_pos.34(i32 %mb_addr, i32* %x, i32* %y) #0 {
entry:
  %mb_addr.addr = alloca i32, align 4
  %y.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 1897344160, i32* %canary
  %x.addr = alloca i32*, align 8
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
  store i32* %x, i32** %x.addr, align 8
  store i32* %y, i32** %y.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 374017164, i32* %canary
  %y.addr = alloca i32*, align 8
  %x.addr = alloca i32*, align 8
  %mb_addr.addr = alloca i32, align 4
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getLuma4x4Neighbour.36(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix) #0 {
entry:
  %curr_mb_nr.addr = alloca i32, align 4
  %y = alloca i32, align 4
  %rel_x.addr = alloca i32, align 4
  ...
  %rel_y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 668324489, i32* %canary
  %block_x.addr = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
  %x = alloca i32, align 4
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
...
entry:
  %y.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 1828985962, i32* %canary
  %mb_addr.addr = alloca i32, align 4
  %x.addr = alloca i32*, align 8
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
  store i32* %x, i32** %x.addr, align 8
...
entry:
  ...
  %curr_mb_nr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1492325697, i32* %canary
  %rel_x.addr = alloca i32, align 4
  %block_y.addr = alloca i32, align 4
  %y = alloca i32, align 4
  %x = alloca i32, align 4
...
entry:
  ...
  %maxH = alloca i32, align 4
  %canary = alloca i32
  store i32 1638950985, i32* %canary
  %pix.addr = alloca %struct.pix_pos*, align 8
  %luma.addr = alloca i32, align 4
  %currMb = alloca %struct.macroblock*, align 8
  %maxW = alloca i32, align 4
...
if.end376:                                        ; preds = %if.end375, %lor.lhs.false, %if.then8, %if.then1
  %309 = load i32, i32* %canary
  %310 = icmp eq i32 %309, 1638950985
  br i1 %310, label %311, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getNonAffNeighbour.40(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix) #0 {
entry:
  %canary = alloca i32
  store i32 153381568, i32* %canary
  %currMb = alloca %struct.macroblock*, align 8
  %luma.addr = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
  %maxH = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @get_mb_block_pos.42(i32 %mb_addr, i32* %x, i32* %y) #0 {
entry:
  %mb_addr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1326136023, i32* %canary
  %x.addr = alloca i32*, align 8
  %y.addr = alloca i32*, align 8
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
  store i32* %x, i32** %x.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @get_mb_pos.43(i32 %mb_addr, i32* %x, i32* %y) #0 {
entry:
  %canary = alloca i32
  store i32 870095787, i32* %canary
  %mb_addr.addr = alloca i32, align 4
  %x.addr = alloca i32*, align 8
  %y.addr = alloca i32*, align 8
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @get_mb_pos.44(i32 %mb_addr, i32* %x, i32* %y) #0 {
entry:
  %x.addr = alloca i32*, align 8
  %y.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 1664380183, i32* %canary
  %mb_addr.addr = alloca i32, align 4
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
  store i32* %x, i32** %x.addr, align 8
  store i32* %y, i32** %y.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getLuma4x4Neighbour.45(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix) #0 {
entry:
  %rel_y.addr = alloca i32, align 4
  %rel_x.addr = alloca i32, align 4
  %curr_mb_nr.addr = alloca i32, align 4
  ...
  %pix.addr = alloca %struct.pix_pos*, align 8
  %canary = alloca i32
  store i32 1812494032, i32* %canary
  %block_y.addr = alloca i32, align 4
  %y = alloca i32, align 4
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
  store i32 %block_x, i32* %block_x.addr, align 4
...
entry:
  ...
  %block_x.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 956019516, i32* %canary
  %block_y.addr = alloca i32, align 4
  %rel_x.addr = alloca i32, align 4
  %curr_mb_nr.addr = alloca i32, align 4
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
...
entry:
  ...
  %pix.addr = alloca %struct.pix_pos*, align 8
  %canary = alloca i32
  store i32 382978649, i32* %canary
  %maxH = alloca i32, align 4
  %luma.addr = alloca i32, align 4
  %curr_mb_nr.addr = alloca i32, align 4
  %currMb = alloca %struct.macroblock*, align 8
...
entry:
  %y.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 263692893, i32* %canary
  %x.addr = alloca i32*, align 8
  %mb_addr.addr = alloca i32, align 4
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
  store i32* %x, i32** %x.addr, align 8
...
entry:
  ...
  %pix.addr = alloca %struct.pix_pos*, align 8
  %canary = alloca i32
  store i32 1183801477, i32* %canary
  %rel_y.addr = alloca i32, align 4
  %y = alloca i32, align 4
  %block_y.addr = alloca i32, align 4
  %curr_mb_nr.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getNonAffNeighbour.50(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix) #0 {
entry:
  %pix.addr = alloca %struct.pix_pos*, align 8
  %maxH = alloca i32, align 4
  %luma.addr = alloca i32, align 4
  ...
  %xN.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 878209163, i32* %canary
  %currMb = alloca %struct.macroblock*, align 8
  %maxW = alloca i32, align 4
  %curr_mb_nr.addr = alloca i32, align 4
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getNonAffNeighbour.51(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix) #0 {
entry:
  %maxW = alloca i32, align 4
  %luma.addr = alloca i32, align 4
  %yN.addr = alloca i32, align 4
  ...
  %maxH = alloca i32, align 4
  %canary = alloca i32
  store i32 821096571, i32* %canary
  %pix.addr = alloca %struct.pix_pos*, align 8
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
  store i32 %xN, i32* %xN.addr, align 4
  store i32 %yN, i32* %yN.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getLuma4x4Neighbour.52(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix) #0 {
entry:
  %x = alloca i32, align 4
  %rel_x.addr = alloca i32, align 4
  %block_y.addr = alloca i32, align 4
  ...
  %pix.addr = alloca %struct.pix_pos*, align 8
  %canary = alloca i32
  store i32 1129165237, i32* %canary
  %rel_y.addr = alloca i32, align 4
  %curr_mb_nr.addr = alloca i32, align 4
  %y = alloca i32, align 4
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
...
entry:
  ...
  %maxW = alloca i32, align 4
  %canary = alloca i32
  store i32 1304412447, i32* %canary
  %yM = alloca i32, align 4
  %xN.addr = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
  %currMb = alloca %struct.macroblock*, align 8
...
if.end376:                                        ; preds = %if.end375, %lor.lhs.false, %if.then8, %if.then1
  %309 = load i32, i32* %canary
  %310 = icmp eq i32 %309, 1304412447
  br i1 %310, label %311, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getAffNeighbour.54(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix) #0 {
entry:
  %yM = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
  %maxW = alloca i32, align 4
  %maxH = alloca i32, align 4
  %canary = alloca i32
  store i32 1819137989, i32* %canary
  %luma.addr = alloca i32, align 4
  %yN.addr = alloca i32, align 4
  %xN.addr = alloca i32, align 4
  %curr_mb_nr.addr = alloca i32, align 4
...
if.end376:                                        ; preds = %if.end375, %lor.lhs.false, %if.then8, %if.then1
  %309 = load i32, i32* %canary
  %310 = icmp eq i32 %309, 1819137989
  br i1 %310, label %311, label %func_exit
...
entry:
  ...
  %pix.addr = alloca %struct.pix_pos*, align 8
  %canary = alloca i32
  store i32 803981243, i32* %canary
  %maxH = alloca i32, align 4
  %luma.addr = alloca i32, align 4
  %currMb = alloca %struct.macroblock*, align 8
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
...
entry:
  ...
  %yN.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1441085948, i32* %canary
  %luma.addr = alloca i32, align 4
  %curr_mb_nr.addr = alloca i32, align 4
  %currMb = alloca %struct.macroblock*, align 8
  %maxH = alloca i32, align 4
...
if.end376:                                        ; preds = %if.end375, %lor.lhs.false, %if.then8, %if.then1
  %309 = load i32, i32* %canary
  %310 = icmp eq i32 %309, 1441085948
  br i1 %310, label %311, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getNonAffNeighbour.57(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix) #0 {
entry:
  %currMb = alloca %struct.macroblock*, align 8
  %maxW = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
  ...
  %yN.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1686263248, i32* %canary
  %maxH = alloca i32, align 4
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
  store i32 %xN, i32* %xN.addr, align 4
  store i32 %yN, i32* %yN.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getNonAffNeighbour.58(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix) #0 {
entry:
  %currMb = alloca %struct.macroblock*, align 8
  %pix.addr = alloca %struct.pix_pos*, align 8
  %maxW = alloca i32, align 4
  ...
  %luma.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 863964514, i32* %canary
  %curr_mb_nr.addr = alloca i32, align 4
  %yN.addr = alloca i32, align 4
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
  store i32 %xN, i32* %xN.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getAffNeighbour.59(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix) #0 {
entry:
  %currMb = alloca %struct.macroblock*, align 8
  %maxW = alloca i32, align 4
  %maxH = alloca i32, align 4
  ...
  %pix.addr = alloca %struct.pix_pos*, align 8
  %canary = alloca i32
  store i32 549638843, i32* %canary
  %yM = alloca i32, align 4
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
  store i32 %xN, i32* %xN.addr, align 4
  store i32 %yN, i32* %yN.addr, align 4
...
entry:
  ...
  %block_y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1565609300, i32* %canary
  %rel_y.addr = alloca i32, align 4
  %rel_x.addr = alloca i32, align 4
  %y = alloca i32, align 4
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
