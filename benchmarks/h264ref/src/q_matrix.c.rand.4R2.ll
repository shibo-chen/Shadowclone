; ModuleID = 'q_matrix.c.rand.4R2.bc'
...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_CheckParameterName.6, label %ctrl0

func_CheckParameterName.6:                        ; preds = %rand_bb
  %2 = call i32 @CheckParameterName.6(i8* %s, i32* %type)
  ret i32 %2

func_CheckParameterName.7:                        ; preds = %ctrl0
  %3 = call i32 @CheckParameterName.7(i8* %s, i32* %type)
  ret i32 %3
...
func_CheckParameterName.11:                       ; preds = %ctrl1
  %5 = call i32 @CheckParameterName.11(i8* %s, i32* %type)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_CheckParameterName.7, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_CheckParameterName.8, label %func_CheckParameterName.11
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_ParseMatrix.12, label %ctrl0

func_ParseMatrix.12:                              ; preds = %rand_bb
  call void @ParseMatrix.12(i8* %buf, i32 %bufsize)
  ret void

func_ParseMatrix.15:                              ; preds = %ctrl0
  call void @ParseMatrix.15(i8* %buf, i32 %bufsize)
  ret void
...
func_ParseMatrix.20:                              ; preds = %ctrl1
  call void @ParseMatrix.20(i8* %buf, i32 %bufsize)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_ParseMatrix.15, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_ParseMatrix.19, label %func_ParseMatrix.20
}
...
func_PatchMatrix.16:                              ; preds = %ctrl1
  call void @PatchMatrix.16()
  ret void

func_PatchMatrix.17:                              ; preds = %ctrl1
  call void @PatchMatrix.17()
  ret void
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_PatchMatrix.16, label %func_PatchMatrix.17
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_CalculateQuantParam.4, label %ctrl0

func_CalculateQuantParam.4:                       ; preds = %rand_bb
  call void @CalculateQuantParam.4()
  ret void

func_CalculateQuantParam.10:                      ; preds = %ctrl0
  call void @CalculateQuantParam.10()
  ret void

func_CalculateQuantParam.13:                      ; preds = %ctrl1
  call void @CalculateQuantParam.13()
  ret void

func_CalculateQuantParam.18:                      ; preds = %ctrl1
  call void @CalculateQuantParam.18()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_CalculateQuantParam.10, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_CalculateQuantParam.13, label %func_CalculateQuantParam.18
}
...
func_CalculateQuant8Param.2:                      ; preds = %ctrl0
  call void @CalculateQuant8Param.2()
  ret void

func_CalculateQuant8Param.3:                      ; preds = %ctrl1
  call void @CalculateQuant8Param.3()
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_CalculateQuant8Param.2, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_CalculateQuant8Param.3, label %func_CalculateQuant8Param.14
}
...
entry:
  ...
  %canary = alloca i32
  store i32 774285871, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @CalculateQuant8Param.2() #0 {
entry:
  %j = alloca i32, align 4
  %present = alloca [2 x i32], align 4
  %canary = alloca i32
  store i32 1670047759, i32* %canary
  %k = alloca i32, align 4
  %i = alloca i32, align 4
  %temp = alloca i32, align 4
  %no_q_matrix = alloca i32, align 4
...
if.end257:                                        ; preds = %for.end256, %for.end91
  %141 = load i32, i32* %canary
  %142 = icmp eq i32 %141, 1670047759
  br i1 %142, label %143, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @CalculateQuant8Param.3() #0 {
entry:
  %present = alloca [2 x i32], align 4
  %temp = alloca i32, align 4
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1790915474, i32* %canary
  %k = alloca i32, align 4
  %no_q_matrix = alloca i32, align 4
  %i = alloca i32, align 4
  store i32 0, i32* %no_q_matrix, align 4
...
if.end257:                                        ; preds = %for.end256, %for.end91
  %141 = load i32, i32* %canary
  %142 = icmp eq i32 %141, 1790915474
  br i1 %142, label %143, label %func_exit
...
entry:
  %no_q_matrix = alloca i32, align 4
  %canary = alloca i32
  store i32 2039037867, i32* %canary
  %i = alloca i32, align 4
  %k = alloca i32, align 4
...
if.end682:                                        ; preds = %for.end681, %for.end200
  ...
  %360 = icmp eq i32 %359, 2039037867
...
entry:
  ...
  %canary = alloca i32
  store i32 517123500, i32* %canary
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @CheckParameterName.6(i8* %s, i32* %type) #0 {
entry:
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 396770348, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1069583018, i32* %canary
  %s.addr = alloca i8*, align 8
  %retval = alloca i32, align 4
  %type.addr = alloca i32*, align 8
  %i = alloca i32, align 4
...
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1876619260, i32* %canary
  %type.addr = alloca i32*, align 8
  %s.addr = alloca i8*, align 8
  %retval = alloca i32, align 4
  store i8* %s, i8** %s.addr, align 8
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 369028336, i32* %canary
  %fail = alloca i32, align 4
  %ScalingList = alloca i16*, align 8
  store i32 0, i32* %i, align 4
  br label %for.cond
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @CalculateQuantParam.10() #0 {
entry:
  %no_q_matrix = alloca i32, align 4
  %k = alloca i32, align 4
  %j = alloca i32, align 4
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1540691285, i32* %canary
  %present = alloca [6 x i32], align 16
  %temp = alloca i32, align 4
  store i32 0, i32* %no_q_matrix, align 4
  %0 = load %struct.seq_parameter_set_rbsp_t*, %struct.seq_parameter_set_rbsp_t** @active_sps, align 8
...
if.end682:                                        ; preds = %for.end681, %for.end200
  %359 = load i32, i32* %canary
  %360 = icmp eq i32 %359, 1540691285
  br i1 %360, label %361, label %func_exit
...
entry:
  ...
  %type.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 1995218138, i32* %canary
  %i = alloca i32, align 4
  store i8* %s, i8** %s.addr, align 8
  store i32* %type, i32** %type.addr, align 8
  store i32 0, i32* %i, align 4
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 876996378, i32* %canary
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 470636964, i32* %canary
  %no_q_matrix = alloca i32, align 4
  store i32 0, i32* %no_q_matrix, align 4
  %0 = load %struct.seq_parameter_set_rbsp_t*, %struct.seq_parameter_set_rbsp_t** @active_sps, align 8
  %seq_scaling_matrix_present_flag = getelementptr inbounds %struct.seq_parameter_set_rbsp_t, %struct.seq_parameter_set_rbsp_t* %0, i32 0, i32 9
...
entry:
  ...
  %temp = alloca i32, align 4
  %canary = alloca i32
  store i32 385525493, i32* %canary
  %k = alloca i32, align 4
  %present = alloca [2 x i32], align 4
  %j = alloca i32, align 4
  store i32 0, i32* %no_q_matrix, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @ParseMatrix.15(i8* %buf, i32 %bufsize) #0 {
entry:
  %ScalingList = alloca i16*, align 8
  %buf.addr = alloca i8*, align 8
  %InString = alloca i32, align 4
  ...
  %item = alloca i32, align 4
  %canary = alloca i32
  store i32 575742029, i32* %canary
  %i = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %bufsize, i32* %bufsize.addr, align 4
  store i32 0, i32* %item, align 4
...
entry:
  %canary = alloca i32
  store i32 839096710, i32* %canary
  %fail = alloca i32, align 4
  %cnt = alloca i32, align 4
  %ScalingList = alloca i16*, align 8
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @PatchMatrix.17() #0 {
entry:
  %i = alloca i32, align 4
  %fail = alloca i32, align 4
  %ScalingList = alloca i16*, align 8
  %canary = alloca i32
  store i32 1557765776, i32* %canary
  %cnt = alloca i32, align 4
  store i32 0, i32* %i, align 4
  br label %for.cond
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @CalculateQuantParam.18() #0 {
entry:
  %present = alloca [6 x i32], align 16
  %j = alloca i32, align 4
  %k = alloca i32, align 4
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 299260369, i32* %canary
  %no_q_matrix = alloca i32, align 4
  store i32 0, i32* %no_q_matrix, align 4
  %0 = load %struct.seq_parameter_set_rbsp_t*, %struct.seq_parameter_set_rbsp_t** @active_sps, align 8
  %seq_scaling_matrix_present_flag = getelementptr inbounds %struct.seq_parameter_set_rbsp_t, %struct.seq_parameter_set_rbsp_t* %0, i32 0, i32 9
...
entry:
  ...
  %p = alloca i8*, align 8
  %canary = alloca i32
  store i32 958625747, i32* %canary
  %range = alloca i32, align 4
  %IntContent = alloca i32, align 4
  %i = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @ParseMatrix.20(i8* %buf, i32 %bufsize) #0 {
entry:
  %MapIdx = alloca i32, align 4
  %range = alloca i32, align 4
  %IntContent = alloca i32, align 4
  ...
  %InString = alloca i32, align 4
  %canary = alloca i32
  store i32 1947708635, i32* %canary
  %i = alloca i32, align 4
  %type = alloca i32, align 4
  %bufend = alloca i8*, align 8
  %ScalingList = alloca i16*, align 8
