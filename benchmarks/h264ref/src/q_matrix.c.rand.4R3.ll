; ModuleID = 'q_matrix.c.rand.4R3.bc'
...
func_ParseMatrix.17:                              ; preds = %ctrl1
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_ParseMatrix.16, label %func_ParseMatrix.17
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_PatchMatrix.9, label %ctrl0

func_PatchMatrix.9:                               ; preds = %rand_bb
  call void @PatchMatrix.9()
  ret void

func_PatchMatrix.13:                              ; preds = %ctrl0
  call void @PatchMatrix.13()
  ret void
...
func_PatchMatrix.19:                              ; preds = %ctrl1
  call void @PatchMatrix.19()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_PatchMatrix.13, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_PatchMatrix.14, label %func_PatchMatrix.19
}
...
func_CalculateQuantParam.11:                      ; preds = %ctrl0
  call void @CalculateQuantParam.11()
  ret void
...
func_CalculateQuantParam.20:                      ; preds = %ctrl1
  call void @CalculateQuantParam.20()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_CalculateQuantParam.11, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_CalculateQuantParam.15, label %func_CalculateQuantParam.20
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_CalculateQuant8Param.2, label %ctrl0

func_CalculateQuant8Param.2:                      ; preds = %rand_bb
  call void @CalculateQuant8Param.2()
  ret void

func_CalculateQuant8Param.5:                      ; preds = %ctrl0
  call void @CalculateQuant8Param.5()
  ret void

func_CalculateQuant8Param.6:                      ; preds = %ctrl1
  call void @CalculateQuant8Param.6()
  ret void

func_CalculateQuant8Param.18:                     ; preds = %ctrl1
  call void @CalculateQuant8Param.18()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_CalculateQuant8Param.5, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_CalculateQuant8Param.6, label %func_CalculateQuant8Param.18
}
...
entry:
  ...
  %canary = alloca i32
  store i32 872701065, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1719556673, i32* %canary
...
if.end257:                                        ; preds = %for.end256, %for.end91
  ...
  %142 = icmp eq i32 %141, 1719556673
...
entry:
  ...
  %canary = alloca i32
  store i32 1439003116, i32* %canary
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1431435017, i32* %canary
  %s.addr = alloca i8*, align 8
  store i8* %s, i8** %s.addr, align 8
  store i32* %type, i32** %type.addr, align 8
  store i32 0, i32* %i, align 4
...
entry:
  ...
  %temp = alloca i32, align 4
  %canary = alloca i32
  store i32 1539828197, i32* %canary
  %present = alloca [2 x i32], align 4
  store i32 0, i32* %no_q_matrix, align 4
  %0 = load %struct.seq_parameter_set_rbsp_t*, %struct.seq_parameter_set_rbsp_t** @active_sps, align 8
  %seq_scaling_matrix_present_flag = getelementptr inbounds %struct.seq_parameter_set_rbsp_t, %struct.seq_parameter_set_rbsp_t* %0, i32 0, i32 9
...
if.end257:                                        ; preds = %for.end256, %for.end91
  %141 = load i32, i32* %canary
  %142 = icmp eq i32 %141, 1539828197
  br i1 %142, label %143, label %func_exit
...
entry:
  ...
  %k = alloca i32, align 4
  %canary = alloca i32
  store i32 547327047, i32* %canary
  %j = alloca i32, align 4
  store i32 0, i32* %no_q_matrix, align 4
  %0 = load %struct.seq_parameter_set_rbsp_t*, %struct.seq_parameter_set_rbsp_t** @active_sps, align 8
  %seq_scaling_matrix_present_flag = getelementptr inbounds %struct.seq_parameter_set_rbsp_t, %struct.seq_parameter_set_rbsp_t* %0, i32 0, i32 9
...
entry:
  ...
  %canary = alloca i32
  store i32 447305893, i32* %canary
  %k = alloca i32, align 4
  store i32 0, i32* %no_q_matrix, align 4
  %0 = load %struct.seq_parameter_set_rbsp_t*, %struct.seq_parameter_set_rbsp_t** @active_sps, align 8
  %seq_scaling_matrix_present_flag = getelementptr inbounds %struct.seq_parameter_set_rbsp_t, %struct.seq_parameter_set_rbsp_t* %0, i32 0, i32 9
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 628408163, i32* %canary
  %retval = alloca i32, align 4
  store i8* %s, i8** %s.addr, align 8
  store i32* %type, i32** %type.addr, align 8
  store i32 0, i32* %i, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 1047891750, i32* %canary
  %cnt = alloca i32, align 4
  store i32 0, i32* %i, align 4
  br label %for.cond
...
entry:
  %type.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 1709222667, i32* %canary
  %retval = alloca i32, align 4
  %i = alloca i32, align 4
  %s.addr = alloca i8*, align 8
  store i8* %s, i8** %s.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @CalculateQuantParam.11() #0 {
entry:
  %no_q_matrix = alloca i32, align 4
  %j = alloca i32, align 4
  %i = alloca i32, align 4
  ...
  %present = alloca [6 x i32], align 16
  %canary = alloca i32
  store i32 2143238152, i32* %canary
  %k = alloca i32, align 4
  store i32 0, i32* %no_q_matrix, align 4
  %0 = load %struct.seq_parameter_set_rbsp_t*, %struct.seq_parameter_set_rbsp_t** @active_sps, align 8
  %seq_scaling_matrix_present_flag = getelementptr inbounds %struct.seq_parameter_set_rbsp_t, %struct.seq_parameter_set_rbsp_t* %0, i32 0, i32 9
...
if.end682:                                        ; preds = %for.end681, %for.end200
  %359 = load i32, i32* %canary
  %360 = icmp eq i32 %359, 2143238152
  br i1 %360, label %361, label %func_exit
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1971963898, i32* %canary
  %MapIdx = alloca i32, align 4
  %items = alloca [1000 x i8*], align 16
  %IntContent = alloca i32, align 4
  %InItem = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @PatchMatrix.13() #0 {
entry:
  %i = alloca i32, align 4
  %ScalingList = alloca i16*, align 8
  %canary = alloca i32
  store i32 2010579182, i32* %canary
  %cnt = alloca i32, align 4
  %fail = alloca i32, align 4
  store i32 0, i32* %i, align 4
  br label %for.cond
...
entry:
  %canary = alloca i32
  store i32 2073328398, i32* %canary
  %fail = alloca i32, align 4
  %i = alloca i32, align 4
  %cnt = alloca i32, align 4
  %ScalingList = alloca i16*, align 8
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 621039526, i32* %canary
  %no_q_matrix = alloca i32, align 4
  %present = alloca [6 x i32], align 16
  %k = alloca i32, align 4
  store i32 0, i32* %no_q_matrix, align 4
...
entry:
  ...
  %cnt = alloca i32, align 4
  %canary = alloca i32
  store i32 1079551045, i32* %canary
  %MapIdx = alloca i32, align 4
  %range = alloca i32, align 4
  %j = alloca i32, align 4
  %ScalingList = alloca i16*, align 8
...
entry:
  ...
  %type = alloca i32, align 4
  %canary = alloca i32
  store i32 1481635923, i32* %canary
  %buf.addr = alloca i8*, align 8
  %item = alloca i32, align 4
  %IntContent = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @CalculateQuant8Param.18() #0 {
entry:
  %canary = alloca i32
  store i32 1517343242, i32* %canary
  %i = alloca i32, align 4
  %temp = alloca i32, align 4
  %present = alloca [2 x i32], align 4
  %no_q_matrix = alloca i32, align 4
...
if.end257:                                        ; preds = %for.end256, %for.end91
  %141 = load i32, i32* %canary
  %142 = icmp eq i32 %141, 1517343242
  br i1 %142, label %143, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @PatchMatrix.19() #0 {
entry:
  %canary = alloca i32
  store i32 794934725, i32* %canary
  %i = alloca i32, align 4
  %fail = alloca i32, align 4
  %cnt = alloca i32, align 4
  %ScalingList = alloca i16*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @CalculateQuantParam.20() #0 {
entry:
  %temp = alloca i32, align 4
  %no_q_matrix = alloca i32, align 4
  %present = alloca [6 x i32], align 16
  %k = alloca i32, align 4
  %canary = alloca i32
  store i32 1359760143, i32* %canary
  %j = alloca i32, align 4
  %i = alloca i32, align 4
  store i32 0, i32* %no_q_matrix, align 4
  %0 = load %struct.seq_parameter_set_rbsp_t*, %struct.seq_parameter_set_rbsp_t** @active_sps, align 8
...
if.end682:                                        ; preds = %for.end681, %for.end200
  %359 = load i32, i32* %canary
  %360 = icmp eq i32 %359, 1359760143
  br i1 %360, label %361, label %func_exit
