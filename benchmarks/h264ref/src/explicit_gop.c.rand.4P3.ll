; ModuleID = 'explicit_gop.c.rand.4P3.bc'
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_create_pyramid.2, label %ctrl0

func_create_pyramid.2:                            ; preds = %rand_bb
  call void @create_pyramid.2()
  ret void

func_create_pyramid.3:                            ; preds = %ctrl0
  call void @create_pyramid.3()
  ret void

func_create_pyramid.9:                            ; preds = %ctrl1
  call void @create_pyramid.9()
  ret void

func_create_pyramid.14:                           ; preds = %ctrl1
  call void @create_pyramid.14()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_create_pyramid.3, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_create_pyramid.9, label %func_create_pyramid.14
}
...
func_gop_pyramid.13:                              ; preds = %ctrl1
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_gop_pyramid.7, label %func_gop_pyramid.13
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_interpret_gop_structure.4, label %ctrl0

func_interpret_gop_structure.4:                   ; preds = %rand_bb
  call void @interpret_gop_structure.4()
  ret void

func_interpret_gop_structure.12:                  ; preds = %ctrl0
  call void @interpret_gop_structure.12()
  ret void

func_interpret_gop_structure.15:                  ; preds = %ctrl1
  call void @interpret_gop_structure.15()
  ret void

func_interpret_gop_structure.16:                  ; preds = %ctrl1
  call void @interpret_gop_structure.16()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_interpret_gop_structure.12, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_interpret_gop_structure.15, label %func_interpret_gop_structure.16
}
...
func_poc_based_ref_management.10:                 ; preds = %ctrl1
  call void @poc_based_ref_management.10(i32 %current_pic_num)
  ret void

func_poc_based_ref_management.11:                 ; preds = %ctrl1
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_poc_based_ref_management.10, label %func_poc_based_ref_management.11
}
...
entry:
  ...
  %canary = alloca i32
  store i32 1520100967, i32* %canary
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 2002540371, i32* %canary
...
if.end200:                                        ; preds = %for.end199, %for.end
  ...
  %162 = icmp eq i32 %161, 2002540371
...
entry:
  ...
  %i28 = alloca i32, align 4
  %canary = alloca i32
  store i32 1269189758, i32* %canary
  %levelrefs = alloca i32, align 4
  %GOPlevels = alloca i32, align 4
  %i = alloca i32, align 4
  %curGOPLeveldist = alloca i32*, align 8
...
if.end200:                                        ; preds = %for.end199, %for.end
  %161 = load i32, i32* %canary
  %162 = icmp eq i32 %161, 1269189758
  br i1 %162, label %163, label %func_exit
...
entry:
  %canary = alloca i32
  store i32 135350522, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1862480278, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1658657939, i32* %canary
  %pyramid_structure.addr = alloca %struct.GOP_DATA*, align 8
  %frm_no.addr = alloca i32, align 4
  %level.addr = alloca i32, align 4
  %frames.addr = alloca i32, align 4
...
entry:
  %level.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 473779375, i32* %canary
  %frm_no.addr = alloca i32, align 4
  %frames.addr = alloca i32, align 4
  %pyramid_structure.addr = alloca %struct.GOP_DATA*, align 8
  store i32 %level, i32* %level.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 1844036390, i32* %canary
  %pic_num = alloca i32, align 4
  %min_poc = alloca i32, align 4
  %current_pic_num.addr = alloca i32, align 4
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
...
entry:
  ...
  %GOPlevels = alloca i32, align 4
  %canary = alloca i32
  store i32 135659563, i32* %canary
  %levelrefs = alloca i32, align 4
  %curGOPLeveldist = alloca i32*, align 8
  %j = alloca i32, align 4
  %curGOPLevelfrm = alloca i32*, align 8
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 240715750, i32* %canary
  %min_poc = alloca i32, align 4
  %pic_num = alloca i32, align 4
  store i32 %current_pic_num, i32* %current_pic_num.addr, align 4
  store i32 0, i32* %pic_num, align 4
...
entry:
  ...
  %current_pic_num.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2059107040, i32* %canary
  %min_poc = alloca i32, align 4
  %tmp_drpm2 = alloca %struct.DecRefPicMarking_s*, align 8
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
  store i32 %current_pic_num, i32* %current_pic_num.addr, align 4
...
entry:
  ...
  %stored_read = alloca i32, align 4
  %canary = alloca i32
  store i32 932581191, i32* %canary
  %order_read = alloca i32, align 4
  %i = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %ExplicitPyramidFormat = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 56
...
entry:
  ...
  %frames.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 372248682, i32* %canary
  %level.addr = alloca i32, align 4
  %frm_no.addr = alloca i32, align 4
  store i32 %level, i32* %level.addr, align 4
  store i32 %frm_no, i32* %frm_no.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @create_pyramid.14() #0 {
entry:
  %curGOPLeveldist = alloca i32*, align 8
  %canary = alloca i32
  store i32 1875199333, i32* %canary
  %tempnum = alloca i32, align 4
  %curGOPLevelfrm = alloca i32*, align 8
  %i = alloca i32, align 4
  %j = alloca i32, align 4
...
if.end200:                                        ; preds = %for.end199, %for.end
  %161 = load i32, i32* %canary
  %162 = icmp eq i32 %161, 1875199333
  br i1 %162, label %163, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @interpret_gop_structure.15() #0 {
entry:
  %canary = alloca i32
  store i32 701482882, i32* %canary
  %qp = alloca i32, align 4
  %stored_read = alloca i32, align 4
  %i = alloca i32, align 4
  %slice_read = alloca i32, align 4
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 316941501, i32* %canary
  %qp_read = alloca i32, align 4
  %slice_read = alloca i32, align 4
  %qp = alloca i32, align 4
  %order_read = alloca i32, align 4
