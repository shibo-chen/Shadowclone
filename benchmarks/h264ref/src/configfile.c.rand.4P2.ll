; ModuleID = 'configfile.c.rand.4P2.bc'
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_Configure.3, label %ctrl0

func_Configure.3:                                 ; preds = %rand_bb
  call void @Configure.3(i32 %ac, i8** %av)
  ret void

func_Configure.7:                                 ; preds = %ctrl0
  call void @Configure.7(i32 %ac, i8** %av)
  ret void
...
func_Configure.20:                                ; preds = %ctrl1
  call void @Configure.20(i32 %ac, i8** %av)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_Configure.7, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_Configure.11, label %func_Configure.20
}
...
func_GetConfigFileContent.9:                      ; preds = %ctrl0
  %3 = call i8* @GetConfigFileContent.9(i8* %Filename)
  ret i8* %3

func_GetConfigFileContent.14:                     ; preds = %ctrl1
  %4 = call i8* @GetConfigFileContent.14(i8* %Filename)
  ret i8* %4
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_GetConfigFileContent.9, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_GetConfigFileContent.14, label %func_GetConfigFileContent.26
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_ParseContent.13, label %ctrl0

func_ParseContent.13:                             ; preds = %rand_bb
  call void @ParseContent.13(i8* %buf, i32 %bufsize)
  ret void

func_ParseContent.21:                             ; preds = %ctrl0
  call void @ParseContent.21(i8* %buf, i32 %bufsize)
  ret void
...
func_ParseContent.23:                             ; preds = %ctrl1
  call void @ParseContent.23(i8* %buf, i32 %bufsize)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_ParseContent.21, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_ParseContent.22, label %func_ParseContent.23
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_CeilLog2.10, label %ctrl0

func_CeilLog2.10:                                 ; preds = %rand_bb
  %2 = call i32 @CeilLog2.10(i32 %uiVal)
  ret i32 %2
...
func_CeilLog2.24:                                 ; preds = %ctrl1
  %4 = call i32 @CeilLog2.24(i32 %uiVal)
  ret i32 %4

func_CeilLog2.25:                                 ; preds = %ctrl1
  %5 = call i32 @CeilLog2.25(i32 %uiVal)
  ret i32 %5
...
ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_CeilLog2.24, label %func_CeilLog2.25
}
...
func_ParameterNameToMapIndex.4:                   ; preds = %ctrl0
  %3 = call i32 @ParameterNameToMapIndex.4(i8* %s)
  ret i32 %3

func_ParameterNameToMapIndex.5:                   ; preds = %ctrl1
  %4 = call i32 @ParameterNameToMapIndex.5(i8* %s)
  ret i32 %4

func_ParameterNameToMapIndex.19:                  ; preds = %ctrl1
  %5 = call i32 @ParameterNameToMapIndex.19(i8* %s)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_ParameterNameToMapIndex.4, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_ParameterNameToMapIndex.5, label %func_ParameterNameToMapIndex.19
}
...
func_PatchInp.8:                                  ; preds = %ctrl0
  call void @PatchInp.8()
  ret void

func_PatchInp.16:                                 ; preds = %ctrl1
  call void @PatchInp.16()
  ret void

func_PatchInp.17:                                 ; preds = %ctrl1
  call void @PatchInp.17()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_PatchInp.8, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_PatchInp.16, label %func_PatchInp.17
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_TestEncoderParams.12, label %func_TestEncoderParams.15

func_TestEncoderParams.12:                        ; preds = %rand_bb
  %2 = call i32 @TestEncoderParams.12(i32 %bitdepth_qp_scale)
  ret i32 %2

func_TestEncoderParams.15:                        ; preds = %rand_bb
  %3 = call i32 @TestEncoderParams.15(i32 %bitdepth_qp_scale)
  ret i32 %3
}
...
entry:
  ...
  %canary = alloca i32
  store i32 1747801325, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1140717441, i32* %canary
...
if.end649:                                        ; preds = %if.then647, %land.lhs.true645, %if.end641
  ...
  %372 = icmp eq i32 %371, 1140717441
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Configure.3(i32 %ac, i8** %av) #0 {
entry:
  %av.addr = alloca i8**, align 8
  %canary = alloca i32
  store i32 461526453, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @ParameterNameToMapIndex.4(i8* %s) #0 {
entry:
  %retval = alloca i32, align 4
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1206671546, i32* %canary
  %s.addr = alloca i8*, align 8
  store i8* %s, i8** %s.addr, align 8
  store i32 0, i32* %i, align 4
  br label %while.cond
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @ParameterNameToMapIndex.5(i8* %s) #0 {
entry:
  %i = alloca i32, align 4
  %s.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1266356579, i32* %canary
  %retval = alloca i32, align 4
  store i8* %s, i8** %s.addr, align 8
  store i32 0, i32* %i, align 4
  br label %while.cond
...
entry:
  ...
  %canary = alloca i32
  store i32 1118364604, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Configure.7(i32 %ac, i8** %av) #0 {
entry:
  %ContentLen = alloca i32, align 4
  %canary = alloca i32
  store i32 731844170, i32* %canary
  %content = alloca i8*, align 8
  %filename = alloca i8*, align 8
  %av.addr = alloca i8**, align 8
  %destin = alloca i8*, align 8
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 2111379089, i32* %canary
  %mapunit_height = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %BitDepthLuma = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 135
  %1 = load i32, i32* %BitDepthLuma, align 8
...
if.end649:                                        ; preds = %if.then647, %land.lhs.true645, %if.end641
  ...
  call void @LevelCheck()
  %371 = load i32, i32* %canary
  %372 = icmp eq i32 %371, 2111379089
  br i1 %372, label %373, label %func_exit
...
entry:
  ...
  %FileSize = alloca i64, align 8
  %canary = alloca i32
  store i32 1837738632, i32* %canary
  %Filename.addr = alloca i8*, align 8
  store i8* %Filename, i8** %Filename.addr, align 8
  %0 = load i8*, i8** %Filename.addr, align 8
  %call = call %struct._IO_FILE* @fopen(i8* %0, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.12, i64 0, i64 0))
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @CeilLog2.10(i32 %uiVal) #0 {
entry:
  %canary = alloca i32
  store i32 374886301, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1122489131, i32* %canary
  %NumberParams = alloca i32, align 4
  %ContentLen = alloca i32, align 4
  %destin = alloca i8*, align 8
  %av.addr = alloca i8**, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @TestEncoderParams.12(i32 %bitdepth_qp_scale) #0 {
entry:
  %bitdepth_qp_scale.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 628885541, i32* %canary
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @ParseContent.13(i8* %buf, i32 %bufsize) #0 {
entry:
  %canary = alloca i32
  store i32 1890958707, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i8* @GetConfigFileContent.14(i8* %Filename) #0 {
entry:
  %canary = alloca i32
  store i32 660386435, i32* %canary
  %f = alloca %struct._IO_FILE*, align 8
  %buf = alloca i8*, align 8
  %FileSize = alloca i64, align 8
  %retval = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @TestEncoderParams.15(i32 %bitdepth_qp_scale) #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1728840985, i32* %canary
  %bitdepth_qp_scale.addr = alloca i32, align 4
  store i32 %bitdepth_qp_scale, i32* %bitdepth_qp_scale.addr, align 4
  store i32 0, i32* %i, align 4
  br label %while.cond
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @PatchInp.16() #0 {
entry:
  %tmp = alloca i32, align 4
  %canary = alloca i32
  store i32 2092929727, i32* %canary
  %sgfile = alloca %struct._IO_FILE*, align 8
  %frame_mb_only = alloca i32, align 4
  %i = alloca i32, align 4
  %storedBplus1 = alloca i32, align 4
...
if.end649:                                        ; preds = %if.then647, %land.lhs.true645, %if.end641
  ...
  call void @LevelCheck()
  %371 = load i32, i32* %canary
  %372 = icmp eq i32 %371, 2092929727
  br i1 %372, label %373, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @PatchInp.17() #0 {
entry:
  %mapunit_height = alloca i32, align 4
  %tmp = alloca i32, align 4
  %storedBplus1 = alloca i32, align 4
  ...
  %bitdepth_qp_scale = alloca i32, align 4
  %canary = alloca i32
  store i32 416037714, i32* %canary
  %sgfile = alloca %struct._IO_FILE*, align 8
  %i = alloca i32, align 4
  %frame_mb_only = alloca i32, align 4
  %mb_width = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 697277350, i32* %canary
  %uiTmp = alloca i32, align 4
  %uiRet = alloca i32, align 4
  %uiVal.addr = alloca i32, align 4
  store i32 %uiVal, i32* %uiVal.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @ParameterNameToMapIndex.19(i8* %s) #0 {
entry:
  %canary = alloca i32
  store i32 55794653, i32* %canary
  %retval = alloca i32, align 4
  %s.addr = alloca i8*, align 8
  %i = alloca i32, align 4
  store i8* %s, i8** %s.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Configure.20(i32 %ac, i8** %av) #0 {
entry:
  %destin = alloca i8*, align 8
  %canary = alloca i32
  store i32 2109086535, i32* %canary
  %filename = alloca i8*, align 8
  %ac.addr = alloca i32, align 4
  %source = alloca i8*, align 8
  %content = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @ParseContent.21(i8* %buf, i32 %bufsize) #0 {
entry:
  %DoubleContent = alloca double, align 8
  %bufend = alloca i8*, align 8
  %i = alloca i32, align 4
  ...
  %p = alloca i8*, align 8
  %canary = alloca i32
  store i32 241583478, i32* %canary
  %items = alloca [10000 x i8*], align 16
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %bufsize, i32* %bufsize.addr, align 4
  store i32 0, i32* %item, align 4
...
entry:
  ...
  %IntContent = alloca i32, align 4
  %canary = alloca i32
  store i32 1603443979, i32* %canary
  %bufend = alloca i8*, align 8
  %InString = alloca i32, align 4
  %DoubleContent = alloca double, align 8
  %MapIdx = alloca i32, align 4
...
entry:
  ...
  %MapIdx = alloca i32, align 4
  %canary = alloca i32
  store i32 1400310258, i32* %canary
  %IntContent = alloca i32, align 4
  %InString = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %bufsize, i32* %bufsize.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @CeilLog2.24(i32 %uiVal) #0 {
entry:
  %canary = alloca i32
  store i32 1645445656, i32* %canary
  %uiRet = alloca i32, align 4
  %uiTmp = alloca i32, align 4
  %uiVal.addr = alloca i32, align 4
  store i32 %uiVal, i32* %uiVal.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @CeilLog2.25(i32 %uiVal) #0 {
entry:
  %uiVal.addr = alloca i32, align 4
  %uiRet = alloca i32, align 4
  %canary = alloca i32
  store i32 12105214, i32* %canary
  %uiTmp = alloca i32, align 4
  store i32 %uiVal, i32* %uiVal.addr, align 4
  %0 = load i32, i32* %uiVal.addr, align 4
  %sub = sub i32 %0, 1
...
entry:
  ...
  %f = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 373553444, i32* %canary
  %retval = alloca i8*, align 8
  store i8* %Filename, i8** %Filename.addr, align 8
  %0 = load i8*, i8** %Filename.addr, align 8
  %call = call %struct._IO_FILE* @fopen(i8* %0, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.12, i64 0, i64 0))
