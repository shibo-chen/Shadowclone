; ModuleID = 'specrand.c.rand.4P1.bc'
...
entry:
  ...
  %canary = alloca i32
  store i32 820711561, i32* %canary
...
entry:
  ...
  %hi = alloca i32, align 4
  %canary = alloca i32
  store i32 935855600, i32* %canary
  %lo = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
  %conv = sext i32 %0 to i64
  %div = sdiv i64 %conv, 127773
...
entry:
  %hi = alloca i32, align 4
  %canary = alloca i32
  store i32 847889653, i32* %canary
  %test = alloca i32, align 4
  %lo = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
  %conv = sext i32 %0 to i64
...
entry:
  ...
  %hi = alloca i32, align 4
  %canary = alloca i32
  store i32 1931412227, i32* %canary
  %test = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
  %conv = sext i32 %0 to i64
  %div = sdiv i64 %conv, 127773
