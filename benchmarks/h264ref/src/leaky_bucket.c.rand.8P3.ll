; ModuleID = 'leaky_bucket.c.rand.8P3.bc'
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_get_LeakyBucketRate.6, label %ctrl0

func_get_LeakyBucketRate.6:                       ; preds = %rand_bb
  %2 = call i32 @get_LeakyBucketRate.6(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret i32 %2
...
func_get_LeakyBucketRate.28:                      ; preds = %ctrl3
  %6 = call i32 @get_LeakyBucketRate.28(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret i32 %6

func_get_LeakyBucketRate.32:                      ; preds = %ctrl4
  %7 = call i32 @get_LeakyBucketRate.32(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret i32 %7
...
func_get_LeakyBucketRate.34:                      ; preds = %ctrl5
...
ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_get_LeakyBucketRate.15, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_get_LeakyBucketRate.27, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_get_LeakyBucketRate.28, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_get_LeakyBucketRate.32, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_get_LeakyBucketRate.33, label %func_get_LeakyBucketRate.34
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_write_buffer.12, label %ctrl0

func_write_buffer.12:                             ; preds = %rand_bb
...
func_write_buffer.23:                             ; preds = %ctrl3
...
func_write_buffer.30:                             ; preds = %ctrl5
...
ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_write_buffer.23, label %ctrl4
...
ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_write_buffer.30, label %func_write_buffer.31
}
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_Sort.9, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_Sort.11, label %ctrl3
...
ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_Sort.17, label %ctrl5
...
func_calc_buffer.20:                              ; preds = %ctrl3
  call void @calc_buffer.20()
  ret void

func_calc_buffer.21:                              ; preds = %ctrl4
...
func_calc_buffer.24:                              ; preds = %ctrl5
...
ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_calc_buffer.20, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_calc_buffer.21, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_calc_buffer.22, label %func_calc_buffer.24
}
...
entry:
  ...
  %canary = alloca i32
  store i32 1865460521, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 702930724, i32* %canary
...
entry:
  ...
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1679748435, i32* %canary
  %i = alloca i64, align 8
  %Rmin.addr = alloca i64*, align 8
  %j = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
...
entry:
  ...
  %maxBuffer = alloca i64, align 8
  %canary = alloca i32
  store i32 1208487512, i32* %canary
  %NumberLeakyBuckets = alloca i64, align 8
  %iBucket = alloca i64, align 8
  %Bmin = alloca i64*, align 8
  %minB = alloca i64, align 8
...
for.end136:                                       ; preds = %for.cond57
  ...
  call void @free(i8* %148) #3
  %149 = load i32, i32* %canary
  %150 = icmp eq i32 %149, 1208487512
  br i1 %150, label %151, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_LeakyBucketRate.6(i64 %NumberLeakyBuckets, i64* %Rmin) #0 {
entry:
  %Rmin.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 442692812, i32* %canary
  %i = alloca i64, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
...
entry:
  %canary = alloca i32
  store i32 962373513, i32* %canary
  %fp.addr = alloca %struct._IO_FILE*, align 8
  %dw.addr = alloca i64, align 8
  store i64 %dw, i64* %dw.addr, align 8
  store %struct._IO_FILE* %fp, %struct._IO_FILE** %fp.addr, align 8
...
entry:
  ...
  %minB = alloca i64, align 8
  %canary = alloca i32
  store i32 1567168991, i32* %canary
  %FrameIndex = alloca i64, align 8
  %iChannelRate = alloca i64, align 8
  %Fmin = alloca i64*, align 8
  store i64 0, i64* %FrameIndex, align 8
...
for.end136:                                       ; preds = %for.cond57
  ...
  call void @free(i8* %148) #3
  %149 = load i32, i32* %canary
  %150 = icmp eq i32 %149, 1567168991
  br i1 %150, label %151, label %func_exit
...
entry:
  %i = alloca i64, align 8
  %canary = alloca i32
  store i32 2033752648, i32* %canary
  %Rmin.addr = alloca i64*, align 8
  %j = alloca i64, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %temp = alloca i64, align 8
...
entry:
  %canary = alloca i32
  store i32 400960799, i32* %canary
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %Rmin.addr = alloca i64*, align 8
  %i = alloca i64, align 8
  %buf = alloca i64, align 8
...
entry:
  %canary = alloca i32
  store i32 1472038384, i32* %canary
  %i = alloca i64, align 8
  %j = alloca i64, align 8
  %temp = alloca i64, align 8
  %Rmin.addr = alloca i64*, align 8
...
entry:
  ...
  %canary = alloca i32
  store i32 1590209454, i32* %canary
  %Rmin.addr = alloca i64*, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
...
entry:
  ...
  %i = alloca i64, align 8
  %canary = alloca i32
  store i32 1545019469, i32* %canary
  %temp = alloca i64, align 8
  %Rmin.addr = alloca i64*, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
...
entry:
  ...
  %Bmin.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 1408997880, i32* %canary
  %iBucket = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
  store i64* %Bmin, i64** %Bmin.addr, align 8
...
entry:
  ...
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 500767402, i32* %canary
  %Rmin.addr = alloca i64*, align 8
  %buf = alloca i64, align 8
  %retval = alloca i32, align 4
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
...
entry:
  ...
  %Fmin.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 113388067, i32* %canary
  %Bmin.addr = alloca i64*, align 8
  %Rmin.addr = alloca i64*, align 8
  %iBucket = alloca i64, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
...
entry:
  ...
  %i = alloca i64, align 8
  %canary = alloca i32
  store i32 800829366, i32* %canary
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %Rmin.addr = alloca i64*, align 8
  %j = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
...
entry:
  ...
  %TotalRate = alloca i64, align 8
  %canary = alloca i32
  store i32 1283382010, i32* %canary
  %iFrame = alloca i64, align 8
  %iChannelRate = alloca i64, align 8
  %Fmin = alloca i64*, align 8
  %buffer_frame = alloca i64*, align 8
...
for.end136:                                       ; preds = %for.cond57
  ...
  call void @free(i8* %148) #3
  %149 = load i32, i32* %canary
  %150 = icmp eq i32 %149, 1283382010
  br i1 %150, label %151, label %func_exit
...
entry:
  ...
  %iBucket = alloca i64, align 8
  %canary = alloca i32
  store i32 165222955, i32* %canary
  %buffer_frame = alloca i64*, align 8
  %FrameIndex = alloca i64, align 8
  %AvgRate = alloca i64, align 8
  %Bmin = alloca i64*, align 8
...
entry:
  ...
  %Fmin = alloca i64*, align 8
  %canary = alloca i32
  store i32 1963926986, i32* %canary
  %AvgRate = alloca i64, align 8
  %buffer_frame = alloca i64*, align 8
  %iChannelRate = alloca i64, align 8
  %iBucket = alloca i64, align 8
...
for.end136:                                       ; preds = %for.cond57
  ...
  call void @free(i8* %148) #3
  %149 = load i32, i32* %canary
  %150 = icmp eq i32 %149, 1963926986
  br i1 %150, label %151, label %func_exit
...
entry:
  %AvgRate = alloca i64, align 8
  %canary = alloca i32
  store i32 607941160, i32* %canary
  %Bmin = alloca i64*, align 8
  %NumberLeakyBuckets = alloca i64, align 8
  %iFrame = alloca i64, align 8
  %minB = alloca i64, align 8
...
entry:
  ...
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 151000981, i32* %canary
  %outf = alloca %struct._IO_FILE*, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
  store i64* %Bmin, i64** %Bmin.addr, align 8
...
entry:
  ...
  %Fmin = alloca i64*, align 8
  %canary = alloca i32
  store i32 832961269, i32* %canary
  %iFrame = alloca i64, align 8
  %buffer_frame = alloca i64*, align 8
  %FrameIndex = alloca i64, align 8
  %InitFullness = alloca i64, align 8
...
entry:
  ...
  %i = alloca i64, align 8
  %canary = alloca i32
  store i32 1031598436, i32* %canary
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %Rmin.addr = alloca i64*, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1055188480, i32* %canary
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %Rmin.addr = alloca i64*, align 8
  %i = alloca i64, align 8
  %j = alloca i64, align 8
...
entry:
  %canary = alloca i32
  store i32 1243864043, i32* %canary
  %buf = alloca i64, align 8
  %i = alloca i64, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %f = alloca %struct._IO_FILE*, align 8
...
entry:
  ...
  %Rmin.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 1657458858, i32* %canary
  %NumberLeakyBuckets.addr = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
entry:
  ...
  %iBucket = alloca i64, align 8
  %canary = alloca i32
  store i32 1262644478, i32* %canary
  %Rmin.addr = alloca i64*, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
  store i64* %Bmin, i64** %Bmin.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 505620178, i32* %canary
  %Bmin.addr = alloca i64*, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %Rmin.addr = alloca i64*, align 8
  %outf = alloca %struct._IO_FILE*, align 8
...
entry:
  ...
  %Rmin.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 497012155, i32* %canary
  %Fmin.addr = alloca i64*, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
...
entry:
  ...
  %Rmin.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 1751056593, i32* %canary
  %retval = alloca i32, align 4
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 366653835, i32* %canary
  %NumberLeakyBuckets.addr = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
