; ModuleID = 'explicit_gop.c.rand.4P1.bc'
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_create_pyramid.5, label %ctrl0

func_create_pyramid.5:                            ; preds = %rand_bb
  call void @create_pyramid.5()
  ret void

func_create_pyramid.8:                            ; preds = %ctrl0
  call void @create_pyramid.8()
  ret void

func_create_pyramid.15:                           ; preds = %ctrl1
  call void @create_pyramid.15()
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_create_pyramid.8, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_create_pyramid.15, label %func_create_pyramid.16
}
...
func_gop_pyramid.3:                               ; preds = %ctrl0
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_gop_pyramid.3, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_gop_pyramid.7, label %func_gop_pyramid.10
}
...
func_interpret_gop_structure.9:                   ; preds = %ctrl0
  call void @interpret_gop_structure.9()
  ret void
...
func_interpret_gop_structure.14:                  ; preds = %ctrl1
  call void @interpret_gop_structure.14()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_interpret_gop_structure.9, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_interpret_gop_structure.13, label %func_interpret_gop_structure.14
}
...
func_poc_based_ref_management.4:                  ; preds = %ctrl0
...
func_poc_based_ref_management.12:                 ; preds = %ctrl1
  call void @poc_based_ref_management.12(i32 %current_pic_num)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_poc_based_ref_management.4, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_poc_based_ref_management.11, label %func_poc_based_ref_management.12
}
...
entry:
  %canary = alloca i32
  store i32 1730899304, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1541498194, i32* %canary
...
entry:
  %pyramid_structure.addr = alloca %struct.GOP_DATA*, align 8
  %canary = alloca i32
  store i32 527130030, i32* %canary
  %frm_no.addr = alloca i32, align 4
  %level.addr = alloca i32, align 4
  %frames.addr = alloca i32, align 4
  store i32 %level, i32* %level.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 946289538, i32* %canary
  %current_pic_num.addr = alloca i32, align 4
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
  %i = alloca i32, align 4
  %pic_num = alloca i32, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 479463395, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1403591813, i32* %canary
...
entry:
  ...
  %pyramid_structure.addr = alloca %struct.GOP_DATA*, align 8
  %canary = alloca i32
  store i32 358904669, i32* %canary
  %frames.addr = alloca i32, align 4
  %frm_no.addr = alloca i32, align 4
  store i32 %level, i32* %level.addr, align 4
  store i32 %frm_no, i32* %frm_no.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @create_pyramid.8() #0 {
entry:
  %i = alloca i32, align 4
  %Bframes = alloca i32, align 4
  %centerB = alloca i32, align 4
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 176133947, i32* %canary
  %curlevel = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %successive_Bframe = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 34
  %1 = load i32, i32* %successive_Bframe, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @interpret_gop_structure.9() #0 {
entry:
  %qp = alloca i32, align 4
  %canary = alloca i32
  store i32 1592451592, i32* %canary
  %display_no = alloca i32, align 4
  %coded_frame = alloca i32, align 4
  %i = alloca i32, align 4
  %nLength = alloca i32, align 4
...
entry:
  ...
  %pyramid_structure.addr = alloca %struct.GOP_DATA*, align 8
  %canary = alloca i32
  store i32 1491248584, i32* %canary
  %frm_no.addr = alloca i32, align 4
  %frames.addr = alloca i32, align 4
  store i32 %level, i32* %level.addr, align 4
  store i32 %frm_no, i32* %frm_no.addr, align 4
...
entry:
  %pic_num = alloca i32, align 4
  %canary = alloca i32
  store i32 1712377213, i32* %canary
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
  %current_pic_num.addr = alloca i32, align 4
  %min_poc = alloca i32, align 4
  %i = alloca i32, align 4
...
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1242669138, i32* %canary
  %current_pic_num.addr = alloca i32, align 4
  %tmp_drpm2 = alloca %struct.DecRefPicMarking_s*, align 8
  %min_poc = alloca i32, align 4
  %pic_num = alloca i32, align 4
...
entry:
  ...
  %coded_frame = alloca i32, align 4
  %canary = alloca i32
  store i32 1543478020, i32* %canary
  %i = alloca i32, align 4
  %nLength = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %ExplicitPyramidFormat = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 56
...
entry:
  ...
  %qp_read = alloca i32, align 4
  %canary = alloca i32
  store i32 321296262, i32* %canary
  %slice_read = alloca i32, align 4
  %stored_read = alloca i32, align 4
  %qp = alloca i32, align 4
  %coded_frame = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @create_pyramid.15() #0 {
entry:
  %canary = alloca i32
  store i32 146218555, i32* %canary
  %centerB = alloca i32, align 4
  %levelrefs = alloca i32, align 4
  %tempnum = alloca i32, align 4
  %j = alloca i32, align 4
...
entry:
  ...
  %levelrefs = alloca i32, align 4
  %canary = alloca i32
  store i32 876746934, i32* %canary
  %tempnum = alloca i32, align 4
  %j = alloca i32, align 4
  %i = alloca i32, align 4
  %centerB = alloca i32, align 4
