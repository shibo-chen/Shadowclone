; ModuleID = 'intrarefresh.c.rand.4R3.bc'
...
func_RandomIntraInit.6:                           ; preds = %ctrl1
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_RandomIntraInit.5, label %func_RandomIntraInit.6
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_RandomIntra.7, label %ctrl0

func_RandomIntra.7:                               ; preds = %rand_bb
  %2 = call i32 @RandomIntra.7(i32 %mb)
  ret i32 %2

func_RandomIntra.8:                               ; preds = %ctrl0
  %3 = call i32 @RandomIntra.8(i32 %mb)
  ret i32 %3

func_RandomIntra.9:                               ; preds = %ctrl1
  %4 = call i32 @RandomIntra.9(i32 %mb)
  ret i32 %4
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_RandomIntra.8, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_RandomIntra.9, label %func_RandomIntra.10
}
...
entry:
  ...
  %canary = alloca i32
  store i32 2011559167, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 204471587, i32* %canary
  %xsize.addr = alloca i32, align 4
  %ysize.addr = alloca i32, align 4
  %refresh.addr = alloca i32, align 4
  %pos = alloca i32, align 4
...
entry:
  ...
  %pos = alloca i32, align 4
  %canary = alloca i32
  store i32 1677197036, i32* %canary
  %i = alloca i32, align 4
  %refresh.addr = alloca i32, align 4
  %xsize.addr = alloca i32, align 4
  store i32 %xsize, i32* %xsize.addr, align 4
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 112220596, i32* %canary
  %pos = alloca i32, align 4
  %ysize.addr = alloca i32, align 4
  %xsize.addr = alloca i32, align 4
  store i32 %xsize, i32* %xsize.addr, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 385273081, i32* %canary
  %i = alloca i32, align 4
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 190954582, i32* %canary
  %mb.addr = alloca i32, align 4
  store i32 %mb, i32* %mb.addr, align 4
  store i32 0, i32* %i, align 4
  br label %for.cond
...
entry:
  %canary = alloca i32
  store i32 1056932502, i32* %canary
  %i = alloca i32, align 4
  %mb.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  store i32 %mb, i32* %mb.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 274551720, i32* %canary
  %retval = alloca i32, align 4
  %i = alloca i32, align 4
  %mb.addr = alloca i32, align 4
  store i32 %mb, i32* %mb.addr, align 4
