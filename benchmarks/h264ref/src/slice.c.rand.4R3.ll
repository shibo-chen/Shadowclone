...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_start_slice.15, label %ctrl0

func_start_slice.15:                              ; preds = %rand_bb
  %2 = call i32 @start_slice.15()
  ret i32 %2

func_start_slice.20:                              ; preds = %ctrl0
  %3 = call i32 @start_slice.20()
  ret i32 %3

func_start_slice.25:                              ; preds = %ctrl1
  %4 = call i32 @start_slice.25()
  ret i32 %4

func_start_slice.28:                              ; preds = %ctrl1
  %5 = call i32 @start_slice.28()
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_start_slice.20, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_start_slice.25, label %func_start_slice.28
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_terminate_slice.7, label %ctrl0

func_terminate_slice.7:                           ; preds = %rand_bb
  %2 = call i32 @terminate_slice.7()
  ret i32 %2

func_terminate_slice.8:                           ; preds = %ctrl0
  %3 = call i32 @terminate_slice.8()
  ret i32 %3

func_terminate_slice.9:                           ; preds = %ctrl1
  %4 = call i32 @terminate_slice.9()
  ret i32 %4

func_terminate_slice.11:                          ; preds = %ctrl1
  %5 = call i32 @terminate_slice.11()
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_terminate_slice.8, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_terminate_slice.9, label %func_terminate_slice.11
}
...
func_encode_one_slice.29:                         ; preds = %ctrl1
  %4 = call i32 @encode_one_slice.29(i32 %SliceGroupId, %struct.Picture* %pic)
  ret i32 %4

func_encode_one_slice.33:                         ; preds = %ctrl1
  %5 = call i32 @encode_one_slice.33(i32 %SliceGroupId, %struct.Picture* %pic)
  ret i32 %5
...
ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_encode_one_slice.29, label %func_encode_one_slice.33
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_init_slice.1, label %ctrl0

func_init_slice.1:                                ; preds = %rand_bb
  call void @init_slice.1(i32 %start_mb_addr)
  ret void

func_init_slice.31:                               ; preds = %ctrl0
  call void @init_slice.31(i32 %start_mb_addr)
  ret void

func_init_slice.32:                               ; preds = %ctrl1
  call void @init_slice.32(i32 %start_mb_addr)
  ret void

func_init_slice.34:                               ; preds = %ctrl1
  call void @init_slice.34(i32 %start_mb_addr)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_init_slice.31, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_init_slice.32, label %func_init_slice.34
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_free_slice_list.2, label %func_free_slice_list.12

func_free_slice_list.2:                           ; preds = %rand_bb
  call void @free_slice_list.2(%struct.Picture* %currPic)
  ret void
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_free_slice.16, label %ctrl0

func_free_slice.16:                               ; preds = %rand_bb
  call void @free_slice.16(%struct.Slice* %slice)
  ret void

func_free_slice.18:                               ; preds = %ctrl0
  call void @free_slice.18(%struct.Slice* %slice)
  ret void
...
func_free_slice.21:                               ; preds = %ctrl1
  call void @free_slice.21(%struct.Slice* %slice)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_free_slice.18, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_free_slice.19, label %func_free_slice.21
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_modify_redundant_pic_cnt.10, label %func_modify_redundant_pic_cnt.13

func_modify_redundant_pic_cnt.10:                 ; preds = %rand_bb
  call void @modify_redundant_pic_cnt.10(i8* %buffer)
  ret void

func_modify_redundant_pic_cnt.13:                 ; preds = %rand_bb
  call void @modify_redundant_pic_cnt.13(i8* %buffer)
  ret void
}
...
func_poc_ref_pic_reorder.14:                      ; preds = %ctrl0
  call void @poc_ref_pic_reorder.14(%struct.storable_picture** %list, i32 %num_ref_idx_lX_active, i32* %remapping_of_pic_nums_idc, i32* %abs_diff_pic_num_minus1, i32* %long_term_pic_idx, i32 %weighted_prediction, i32 %list_no)
  ret void

func_poc_ref_pic_reorder.22:                      ; preds = %ctrl1
  call void @poc_ref_pic_reorder.22(%struct.storable_picture** %list, i32 %num_ref_idx_lX_active, i32* %remapping_of_pic_nums_idc, i32* %abs_diff_pic_num_minus1, i32* %long_term_pic_idx, i32 %weighted_prediction, i32 %list_no)
  ret void

func_poc_ref_pic_reorder.26:                      ; preds = %ctrl1
  call void @poc_ref_pic_reorder.26(%struct.storable_picture** %list, i32 %num_ref_idx_lX_active, i32* %remapping_of_pic_nums_idc, i32* %abs_diff_pic_num_minus1, i32* %long_term_pic_idx, i32 %weighted_prediction, i32 %list_no)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_poc_ref_pic_reorder.14, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_poc_ref_pic_reorder.22, label %func_poc_ref_pic_reorder.26
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_malloc_slice.23, label %ctrl0

func_malloc_slice.23:                             ; preds = %rand_bb
  %2 = call %struct.Slice* @malloc_slice.23()
  ret %struct.Slice* %2

func_malloc_slice.24:                             ; preds = %ctrl0
  %3 = call %struct.Slice* @malloc_slice.24()
  ret %struct.Slice* %3
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_malloc_slice.24, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_malloc_slice.27, label %func_malloc_slice.30
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_set_ref_pic_num.4, label %func_set_ref_pic_num.6

func_set_ref_pic_num.4:                           ; preds = %rand_bb
  call void @set_ref_pic_num.4()
  ret void

func_set_ref_pic_num.6:                           ; preds = %rand_bb
  call void @set_ref_pic_num.6()
  ret void
}
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @init_slice.1(i32 %start_mb_addr) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 704162851, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_slice_list.2(%struct.Picture* %currPic) #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 183590201, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1836890954, i32* %canary
...
while.end:                                        ; preds = %while.cond
  ...
  %137 = icmp eq i32 %136, 1836890954
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @set_ref_pic_num.4() #0 {
entry:
  %canary = alloca i32
  store i32 1271291847, i32* %canary
...
if.end158:                                        ; preds = %if.end, %for.end79
  ...
  %113 = icmp eq i32 %112, 1271291847
...
entry:
  ...
  %canary = alloca i32
  store i32 457624595, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @set_ref_pic_num.6() #0 {
entry:
  %canary = alloca i32
  store i32 1294214734, i32* %canary
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  store i32 0, i32* %i, align 4
  br label %for.cond
...
if.end158:                                        ; preds = %if.end, %for.end79
  %112 = load i32, i32* %canary
  %113 = icmp eq i32 %112, 1294214734
  br i1 %113, label %114, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @terminate_slice.7() #0 {
entry:
  ...
  %currSlice = alloca %struct.Slice*, align 8
  %canary = alloca i32
  store i32 1644844208, i32* %canary
  %currStream = alloca %struct.Bitstream*, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %currentSlice = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 50
  %1 = load %struct.Slice*, %struct.Slice** %currentSlice, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @terminate_slice.8() #0 {
entry:
  %eep = alloca %struct.EncodingEnvironment*, align 8
  %byte_pos_before_startcode_emu_prevention = alloca i32, align 4
  %currStream = alloca %struct.Bitstream*, align 8
  %bytes_written = alloca i32, align 4
  %canary = alloca i32
  store i32 279431085, i32* %canary
  %currSlice = alloca %struct.Slice*, align 8
  %i = alloca i32, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %currentSlice = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 50
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @terminate_slice.9() #0 {
entry:
  %byte_pos_before_startcode_emu_prevention = alloca i32, align 4
  %eep = alloca %struct.EncodingEnvironment*, align 8
  %currStream = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 559752013, i32* %canary
  %bytes_written = alloca i32, align 4
  %i = alloca i32, align 4
  %currSlice = alloca %struct.Slice*, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
entry:
  %canary = alloca i32
  store i32 654812378, i32* %canary
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1844124792, i32* %canary
  %currStream = alloca %struct.Bitstream*, align 8
  %byte_pos_before_startcode_emu_prevention = alloca i32, align 4
  %eep = alloca %struct.EncodingEnvironment*, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
entry:
  %currPic.addr = alloca %struct.Picture*, align 8
  %canary = alloca i32
  store i32 1929654284, i32* %canary
  %i = alloca i32, align 4
  store %struct.Picture* %currPic, %struct.Picture** %currPic.addr, align 8
  store i32 0, i32* %i, align 4
  br label %for.cond
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @modify_redundant_pic_cnt.13(i8* %buffer) #0 {
entry:
  %canary = alloca i32
  store i32 749769926, i32* %canary
  %tmp = alloca i8, align 1
  %buffer.addr = alloca i8*, align 8
  store i8* %buffer, i8** %buffer.addr, align 8
  %0 = load i32, i32* @rpc_bits_to_go, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @poc_ref_pic_reorder.14(%struct.storable_picture** %list, i32 %num_ref_idx_lX_active, i32* %remapping_of_pic_nums_idc, i32* %abs_diff_pic_num_minus1, i32* %long_term_pic_idx, i32 %weighted_prediction, i32 %list_no) #0 {
entry:
  %MaxFrameNum = alloca i32, align 4
  %no_reorder = alloca i32, align 4
  %diff = alloca i32, align 4
  ...
  %k = alloca i32, align 4
  %canary = alloca i32
  store i32 349960790, i32* %canary
  %weighted_prediction.addr = alloca i32, align 4
  %j = alloca i32, align 4
  %tmp_reorder = alloca [32 x i32], align 16
  %abs_diff_pic_num_minus1.addr = alloca i32*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @start_slice.15() #0 {
entry:
  %NumberOfPartitions = alloca i32, align 4
  %canary = alloca i32
  store i32 1734814261, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @free_slice.16(%struct.Slice* %slice) #0 {
entry:
  %dataPart = alloca %struct.datapartition*, align 8
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 574044143, i32* %canary
...
entry:
  ...
  %FieldRDCost = alloca double, align 8
  %canary = alloca i32
  store i32 2126575887, i32* %canary
  %NumberOfCodedMBs = alloca i32, align 4
  %pic.addr = alloca %struct.Picture*, align 8
  %end_of_slice = alloca i32, align 4
  %len = alloca i32, align 4
...
while.end:                                        ; preds = %while.cond
  ...
  %135 = load i32, i32* %NumberOfCodedMBs, align 4
  %136 = load i32, i32* %canary
  %137 = icmp eq i32 %136, 2126575887
  br i1 %137, label %138, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @free_slice.18(%struct.Slice* %slice) #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 287770404, i32* %canary
  %slice.addr = alloca %struct.Slice*, align 8
  %dataPart = alloca %struct.datapartition*, align 8
  store %struct.Slice* %slice, %struct.Slice** %slice.addr, align 8
  %0 = load %struct.Slice*, %struct.Slice** %slice.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 675963373, i32* %canary
  %slice.addr = alloca %struct.Slice*, align 8
  %i = alloca i32, align 4
  %dataPart = alloca %struct.datapartition*, align 8
  store %struct.Slice* %slice, %struct.Slice** %slice.addr, align 8
...
entry:
  ...
  %header_len = alloca i32, align 4
  %canary = alloca i32
  store i32 1530346654, i32* %canary
  %currSlice = alloca %struct.Slice*, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %currentSlice = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 50
  %1 = load %struct.Slice*, %struct.Slice** %currentSlice, align 8
...
entry:
  %canary = alloca i32
  store i32 2051243476, i32* %canary
  %dataPart = alloca %struct.datapartition*, align 8
  %slice.addr = alloca %struct.Slice*, align 8
  %i = alloca i32, align 4
  store %struct.Slice* %slice, %struct.Slice** %slice.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @poc_ref_pic_reorder.22(%struct.storable_picture** %list, i32 %num_ref_idx_lX_active, i32* %remapping_of_pic_nums_idc, i32* %abs_diff_pic_num_minus1, i32* %long_term_pic_idx, i32 %weighted_prediction, i32 %list_no) #0 {
entry:
  %k = alloca i32, align 4
  %num_ref_idx_lX_active.addr = alloca i32, align 4
  %currPicNum = alloca i32, align 4
  %tmp_value = alloca i32, align 4
  %canary = alloca i32
  store i32 907331875, i32* %canary
  %list_no.addr = alloca i32, align 4
  %abs_diff_pic_num_minus1.addr = alloca i32*, align 8
  %picNumLXPred = alloca i32, align 4
  %remapping_of_pic_nums_idc.addr = alloca i32*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal %struct.Slice* @malloc_slice.23() #0 {
entry:
  %buffer_size = alloca i32, align 4
  %dataPart = alloca %struct.datapartition*, align 8
  %canary = alloca i32
  store i32 231321695, i32* %canary
  %i = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 101204962, i32* %canary
  %i = alloca i32, align 4
  %slice = alloca %struct.Slice*, align 8
  %buffer_size = alloca i32, align 4
  %dataPart = alloca %struct.datapartition*, align 8
...
entry:
  %currSlice = alloca %struct.Slice*, align 8
  %canary = alloca i32
  store i32 674607797, i32* %canary
  %i = alloca i32, align 4
  %header_len = alloca i32, align 4
  %NumberOfPartitions = alloca i32, align 4
  %currStream = alloca %struct.Bitstream*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @poc_ref_pic_reorder.26(%struct.storable_picture** %list, i32 %num_ref_idx_lX_active, i32* %remapping_of_pic_nums_idc, i32* %abs_diff_pic_num_minus1, i32* %long_term_pic_idx, i32 %weighted_prediction, i32 %list_no) #0 {
entry:
  %picNumLXPred = alloca i32, align 4
  %currPicNum = alloca i32, align 4
  %list_sign = alloca [32 x i32], align 16
  ...
  %default_order = alloca [32 x i32], align 16
  %canary = alloca i32
  store i32 1988572566, i32* %canary
  %diff = alloca i32, align 4
  %k = alloca i32, align 4
  %num_ref_idx_lX_active.addr = alloca i32, align 4
  %weighted_prediction.addr = alloca i32, align 4
...
if.end240:                                        ; preds = %if.end239, %for.end135
  %187 = load i32, i32* %canary
  %188 = icmp eq i32 %187, 1988572566
  br i1 %188, label %189, label %func_exit
...
entry:
  %canary = alloca i32
  store i32 1032861281, i32* %canary
  %i = alloca i32, align 4
  %buffer_size = alloca i32, align 4
  %slice = alloca %struct.Slice*, align 8
  %dataPart = alloca %struct.datapartition*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @start_slice.28() #0 {
entry:
  %canary = alloca i32
  store i32 295500381, i32* %canary
  %currSlice = alloca %struct.Slice*, align 8
  %header_len = alloca i32, align 4
  %currStream = alloca %struct.Bitstream*, align 8
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @encode_one_slice.29(i32 %SliceGroupId, %struct.Picture* %pic) #0 {
entry:
  %pic.addr = alloca %struct.Picture*, align 8
  %SliceGroupId.addr = alloca i32, align 4
  %FieldRDCost = alloca double, align 8
  ...
  %recode_macroblock = alloca i32, align 4
  %canary = alloca i32
  store i32 212950071, i32* %canary
  %FrameRDCost = alloca double, align 8
  store i32 %SliceGroupId, i32* %SliceGroupId.addr, align 4
  store %struct.Picture* %pic, %struct.Picture** %pic.addr, align 8
  store i32 0, i32* %end_of_slice, align 4
...
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1513671060, i32* %canary
  %dataPart = alloca %struct.datapartition*, align 8
  %buffer_size = alloca i32, align 4
  %slice = alloca %struct.Slice*, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @init_slice.32(i32 %start_mb_addr) #0 {
entry:
  %i100 = alloca i32, align 4
  %start_mb_addr.addr = alloca i32, align 4
  %dataPart = alloca %struct.datapartition*, align 8
  %canary = alloca i32
  store i32 1664093599, i32* %canary
  %currSlice = alloca %struct.Slice*, align 8
  %num_ref = alloca i32, align 4
  %currStream = alloca %struct.Bitstream*, align 8
  %i = alloca i32, align 4
...
if.end206:                                        ; preds = %if.then205, %if.end202
  %229 = load i32, i32* %canary
  %230 = icmp eq i32 %229, 1664093599
  br i1 %230, label %231, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @encode_one_slice.33(i32 %SliceGroupId, %struct.Picture* %pic) #0 {
entry:
  %len = alloca i32, align 4
  %CurrentMbAddr = alloca i32, align 4
  %FrameRDCost = alloca double, align 8
  ...
  %recode_macroblock = alloca i32, align 4
  %canary = alloca i32
  store i32 831949751, i32* %canary
  %pic.addr = alloca %struct.Picture*, align 8
  store i32 %SliceGroupId, i32* %SliceGroupId.addr, align 4
  store %struct.Picture* %pic, %struct.Picture** %pic.addr, align 8
  store i32 0, i32* %end_of_slice, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @init_slice.34(i32 %start_mb_addr) #0 {
entry:
  %canary = alloca i32
  store i32 480736627, i32* %canary
  %start_mb_addr.addr = alloca i32, align 4
  %dataPart = alloca %struct.datapartition*, align 8
  %i100 = alloca i32, align 4
  %i = alloca i32, align 4
