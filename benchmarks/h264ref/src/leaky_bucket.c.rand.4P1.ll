; ModuleID = 'leaky_bucket.c.rand.4P1.bc'
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_get_LeakyBucketRate.2, label %ctrl0

func_get_LeakyBucketRate.2:                       ; preds = %rand_bb
  %2 = call i32 @get_LeakyBucketRate.2(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret i32 %2

func_get_LeakyBucketRate.4:                       ; preds = %ctrl0
  %3 = call i32 @get_LeakyBucketRate.4(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret i32 %3

func_get_LeakyBucketRate.6:                       ; preds = %ctrl1
  %4 = call i32 @get_LeakyBucketRate.6(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret i32 %4

func_get_LeakyBucketRate.8:                       ; preds = %ctrl1
  %5 = call i32 @get_LeakyBucketRate.8(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_get_LeakyBucketRate.4, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_get_LeakyBucketRate.6, label %func_get_LeakyBucketRate.8
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_PutBigDoubleWord.9, label %func_PutBigDoubleWord.13
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_write_buffer.5, label %ctrl0

func_write_buffer.5:                              ; preds = %rand_bb
  call void @write_buffer.5(i64 %NumberLeakyBuckets, i64* %Rmin, i64* %Bmin, i64* %Fmin)
  ret void

func_write_buffer.7:                              ; preds = %ctrl0
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_write_buffer.7, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_write_buffer.10, label %func_write_buffer.11
}
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_Sort.12, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_Sort.15, label %func_Sort.16
}
...
func_calc_buffer.14:                              ; preds = %ctrl0
...
func_calc_buffer.18:                              ; preds = %ctrl1
  call void @calc_buffer.18()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_calc_buffer.14, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_calc_buffer.17, label %func_calc_buffer.18
}
...
entry:
  ...
  %canary = alloca i32
  store i32 1053145061, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1369867402, i32* %canary
  %i = alloca i64, align 8
...
entry:
  %canary = alloca i32
  store i32 723704589, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 2055979208, i32* %canary
  %retval = alloca i32, align 4
  %buf = alloca i64, align 8
  %Rmin.addr = alloca i64*, align 8
  %i = alloca i64, align 8
...
entry:
  ...
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1900319403, i32* %canary
...
entry:
  ...
  %f = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 469498936, i32* %canary
  %Rmin.addr = alloca i64*, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
entry:
  ...
  %Bmin.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 374692723, i32* %canary
  %Rmin.addr = alloca i64*, align 8
  %iBucket = alloca i64, align 8
  %Fmin.addr = alloca i64*, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 674381145, i32* %canary
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %buf = alloca i64, align 8
  %Rmin.addr = alloca i64*, align 8
  %f = alloca %struct._IO_FILE*, align 8
...
entry:
  %canary = alloca i32
  store i32 2117088680, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 737829116, i32* %canary
  %Fmin.addr = alloca i64*, align 8
  %Bmin.addr = alloca i64*, align 8
  %iBucket = alloca i64, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
...
entry:
  %Rmin.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 486228339, i32* %canary
  %outf = alloca %struct._IO_FILE*, align 8
  %Fmin.addr = alloca i64*, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %iBucket = alloca i64, align 8
...
entry:
  ...
  %j = alloca i64, align 8
  %canary = alloca i32
  store i32 1997989332, i32* %canary
  %Rmin.addr = alloca i64*, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
  store i64 0, i64* %i, align 8
...
entry:
  %dw.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 618083024, i32* %canary
  %fp.addr = alloca %struct._IO_FILE*, align 8
  store i64 %dw, i64* %dw.addr, align 8
  store %struct._IO_FILE* %fp, %struct._IO_FILE** %fp.addr, align 8
  %0 = load i64, i64* %dw.addr, align 8
...
entry:
  ...
  %maxBuffer = alloca i64, align 8
  %canary = alloca i32
  store i32 409447304, i32* %canary
  %iFrame = alloca i64, align 8
  %NumberLeakyBuckets = alloca i64, align 8
  %Bmin = alloca i64*, align 8
  %Fmin = alloca i64*, align 8
...
entry:
  ...
  %temp = alloca i64, align 8
  %canary = alloca i32
  store i32 1290851450, i32* %canary
  %Rmin.addr = alloca i64*, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
  store i64 0, i64* %i, align 8
...
entry:
  %temp = alloca i64, align 8
  %canary = alloca i32
  store i32 528421604, i32* %canary
  %i = alloca i64, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %Rmin.addr = alloca i64*, align 8
  %j = alloca i64, align 8
...
entry:
  ...
  %iFrame = alloca i64, align 8
  %canary = alloca i32
  store i32 412526053, i32* %canary
  %iBucket = alloca i64, align 8
  %buffer_frame = alloca i64*, align 8
  %TotalRate = alloca i64, align 8
  %InitFullness = alloca i64, align 8
...
entry:
  ...
  %Bmin = alloca i64*, align 8
  %canary = alloca i32
  store i32 1595359734, i32* %canary
  %iFrame = alloca i64, align 8
  store i64 0, i64* %FrameIndex, align 8
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8
  %call = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %0, i8* getelementptr inbounds ([81 x i8], [81 x i8]* @.str.8, i64 0, i64 0))
...
for.end136:                                       ; preds = %for.cond57
  ...
  call void @free(i8* %148) #3
  %149 = load i32, i32* %canary
  %150 = icmp eq i32 %149, 1595359734
  br i1 %150, label %151, label %func_exit
