...
func_FmoInit.30:                                  ; preds = %ctrl0
  %3 = call i32 @FmoInit.30(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps, %struct.seq_parameter_set_rbsp_t* %sps)
  ret i32 %3

func_FmoInit.48:                                  ; preds = %ctrl1
  %4 = call i32 @FmoInit.48(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps, %struct.seq_parameter_set_rbsp_t* %sps)
  ret i32 %4

func_FmoInit.53:                                  ; preds = %ctrl1
  %5 = call i32 @FmoInit.53(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps, %struct.seq_parameter_set_rbsp_t* %sps)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_FmoInit.30, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_FmoInit.48, label %func_FmoInit.53
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FmoGenerateMapUnitToSliceGroupMap.13, label %ctrl0

func_FmoGenerateMapUnitToSliceGroupMap.13:        ; preds = %rand_bb
  %2 = call i32 @FmoGenerateMapUnitToSliceGroupMap.13(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret i32 %2

func_FmoGenerateMapUnitToSliceGroupMap.31:        ; preds = %ctrl0
  %3 = call i32 @FmoGenerateMapUnitToSliceGroupMap.31(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret i32 %3

func_FmoGenerateMapUnitToSliceGroupMap.49:        ; preds = %ctrl1
  %4 = call i32 @FmoGenerateMapUnitToSliceGroupMap.49(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret i32 %4

func_FmoGenerateMapUnitToSliceGroupMap.54:        ; preds = %ctrl1
  %5 = call i32 @FmoGenerateMapUnitToSliceGroupMap.54(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_FmoGenerateMapUnitToSliceGroupMap.31, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_FmoGenerateMapUnitToSliceGroupMap.49, label %func_FmoGenerateMapUnitToSliceGroupMap.54
}
...
func_FmoGenerateMBAmap.28:                        ; preds = %ctrl0
  %3 = call i32 @FmoGenerateMBAmap.28(%struct.ImageParameters* %img, %struct.seq_parameter_set_rbsp_t* %sps)
  ret i32 %3

func_FmoGenerateMBAmap.47:                        ; preds = %ctrl1
  %4 = call i32 @FmoGenerateMBAmap.47(%struct.ImageParameters* %img, %struct.seq_parameter_set_rbsp_t* %sps)
  ret i32 %4

func_FmoGenerateMBAmap.52:                        ; preds = %ctrl1
  %5 = call i32 @FmoGenerateMBAmap.52(%struct.ImageParameters* %img, %struct.seq_parameter_set_rbsp_t* %sps)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_FmoGenerateMBAmap.28, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_FmoGenerateMBAmap.47, label %func_FmoGenerateMBAmap.52
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FmoGetFirstMBOfSliceGroup.8, label %ctrl0

func_FmoGetFirstMBOfSliceGroup.8:                 ; preds = %rand_bb
  %2 = call i32 @FmoGetFirstMBOfSliceGroup.8(i32 %SliceGroupID)
  ret i32 %2

func_FmoGetFirstMBOfSliceGroup.27:                ; preds = %ctrl0
  %3 = call i32 @FmoGetFirstMBOfSliceGroup.27(i32 %SliceGroupID)
  ret i32 %3

func_FmoGetFirstMBOfSliceGroup.37:                ; preds = %ctrl1
  %4 = call i32 @FmoGetFirstMBOfSliceGroup.37(i32 %SliceGroupID)
  ret i32 %4

func_FmoGetFirstMBOfSliceGroup.44:                ; preds = %ctrl1
  %5 = call i32 @FmoGetFirstMBOfSliceGroup.44(i32 %SliceGroupID)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_FmoGetFirstMBOfSliceGroup.27, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_FmoGetFirstMBOfSliceGroup.37, label %func_FmoGetFirstMBOfSliceGroup.44
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FmoGetNextMBNr.7, label %ctrl0

func_FmoGetNextMBNr.7:                            ; preds = %rand_bb
  %2 = call i32 @FmoGetNextMBNr.7(i32 %CurrentMbNr)
  ret i32 %2

func_FmoGetNextMBNr.23:                           ; preds = %ctrl0
  %3 = call i32 @FmoGetNextMBNr.23(i32 %CurrentMbNr)
  ret i32 %3
...
func_FmoGetNextMBNr.55:                           ; preds = %ctrl1
  %5 = call i32 @FmoGetNextMBNr.55(i32 %CurrentMbNr)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_FmoGetNextMBNr.23, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_FmoGetNextMBNr.42, label %func_FmoGetNextMBNr.55
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FmoGetPreviousMBNr.32, label %ctrl0

func_FmoGetPreviousMBNr.32:                       ; preds = %rand_bb
  %2 = call i32 @FmoGetPreviousMBNr.32(i32 %CurrentMbNr)
  ret i32 %2

func_FmoGetPreviousMBNr.39:                       ; preds = %ctrl0
  %3 = call i32 @FmoGetPreviousMBNr.39(i32 %CurrentMbNr)
  ret i32 %3

func_FmoGetPreviousMBNr.45:                       ; preds = %ctrl1
  %4 = call i32 @FmoGetPreviousMBNr.45(i32 %CurrentMbNr)
  ret i32 %4

func_FmoGetPreviousMBNr.50:                       ; preds = %ctrl1
  %5 = call i32 @FmoGetPreviousMBNr.50(i32 %CurrentMbNr)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_FmoGetPreviousMBNr.39, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_FmoGetPreviousMBNr.45, label %func_FmoGetPreviousMBNr.50
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FmoGetLastCodedMBOfSliceGroup.5, label %ctrl0

func_FmoGetLastCodedMBOfSliceGroup.5:             ; preds = %rand_bb
  %2 = call i32 @FmoGetLastCodedMBOfSliceGroup.5(i32 %SliceGroupID)
  ret i32 %2
...
func_FmoGetLastCodedMBOfSliceGroup.29:            ; preds = %ctrl1
  %4 = call i32 @FmoGetLastCodedMBOfSliceGroup.29(i32 %SliceGroupID)
  ret i32 %4

func_FmoGetLastCodedMBOfSliceGroup.41:            ; preds = %ctrl1
  %5 = call i32 @FmoGetLastCodedMBOfSliceGroup.41(i32 %SliceGroupID)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_FmoGetLastCodedMBOfSliceGroup.26, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_FmoGetLastCodedMBOfSliceGroup.29, label %func_FmoGetLastCodedMBOfSliceGroup.41
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FmoSetLastMacroblockInSlice.14, label %func_FmoSetLastMacroblockInSlice.24

func_FmoSetLastMacroblockInSlice.14:              ; preds = %rand_bb
  call void @FmoSetLastMacroblockInSlice.14(i32 %mb)
  ret void

func_FmoSetLastMacroblockInSlice.24:              ; preds = %rand_bb
  call void @FmoSetLastMacroblockInSlice.24(i32 %mb)
  ret void
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FmoSliceGroupCompletelyCoded.10, label %func_FmoSliceGroupCompletelyCoded.11

func_FmoSliceGroupCompletelyCoded.10:             ; preds = %rand_bb
  %2 = call i32 @FmoSliceGroupCompletelyCoded.10(i32 %SliceGroupID)
  ret i32 %2

func_FmoSliceGroupCompletelyCoded.11:             ; preds = %rand_bb
  %3 = call i32 @FmoSliceGroupCompletelyCoded.11(i32 %SliceGroupID)
  ret i32 %3
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FmoGenerateType0MapUnitMap.9, label %ctrl0

func_FmoGenerateType0MapUnitMap.9:                ; preds = %rand_bb
  call void @FmoGenerateType0MapUnitMap.9(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType0MapUnitMap.16:               ; preds = %ctrl0
  call void @FmoGenerateType0MapUnitMap.16(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType0MapUnitMap.21:               ; preds = %ctrl1
  call void @FmoGenerateType0MapUnitMap.21(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType0MapUnitMap.56:               ; preds = %ctrl1
  call void @FmoGenerateType0MapUnitMap.56(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_FmoGenerateType0MapUnitMap.16, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_FmoGenerateType0MapUnitMap.21, label %func_FmoGenerateType0MapUnitMap.56
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FmoGenerateType1MapUnitMap.57, label %ctrl0

func_FmoGenerateType1MapUnitMap.57:               ; preds = %rand_bb
  call void @FmoGenerateType1MapUnitMap.57(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType1MapUnitMap.58:               ; preds = %ctrl0
  call void @FmoGenerateType1MapUnitMap.58(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void
...
func_FmoGenerateType1MapUnitMap.60:               ; preds = %ctrl1
  call void @FmoGenerateType1MapUnitMap.60(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_FmoGenerateType1MapUnitMap.58, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_FmoGenerateType1MapUnitMap.59, label %func_FmoGenerateType1MapUnitMap.60
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FmoGenerateType2MapUnitMap.3, label %ctrl0

func_FmoGenerateType2MapUnitMap.3:                ; preds = %rand_bb
  call void @FmoGenerateType2MapUnitMap.3(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void
...
func_FmoGenerateType2MapUnitMap.35:               ; preds = %ctrl1
  call void @FmoGenerateType2MapUnitMap.35(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType2MapUnitMap.40:               ; preds = %ctrl1
  call void @FmoGenerateType2MapUnitMap.40(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_FmoGenerateType2MapUnitMap.35, label %func_FmoGenerateType2MapUnitMap.40
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FmoGenerateType3MapUnitMap.19, label %ctrl0

func_FmoGenerateType3MapUnitMap.19:               ; preds = %rand_bb
  call void @FmoGenerateType3MapUnitMap.19(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType3MapUnitMap.25:               ; preds = %ctrl0
...
func_FmoGenerateType3MapUnitMap.36:               ; preds = %ctrl1
  call void @FmoGenerateType3MapUnitMap.36(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_FmoGenerateType3MapUnitMap.25, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_FmoGenerateType3MapUnitMap.33, label %func_FmoGenerateType3MapUnitMap.36
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FmoGenerateType4MapUnitMap.18, label %ctrl0

func_FmoGenerateType4MapUnitMap.18:               ; preds = %rand_bb
  call void @FmoGenerateType4MapUnitMap.18(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType4MapUnitMap.22:               ; preds = %ctrl0
  call void @FmoGenerateType4MapUnitMap.22(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType4MapUnitMap.43:               ; preds = %ctrl1
  call void @FmoGenerateType4MapUnitMap.43(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType4MapUnitMap.51:               ; preds = %ctrl1
  call void @FmoGenerateType4MapUnitMap.51(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_FmoGenerateType4MapUnitMap.22, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_FmoGenerateType4MapUnitMap.43, label %func_FmoGenerateType4MapUnitMap.51
}
...
func_FmoGenerateType5MapUnitMap.4:                ; preds = %ctrl0
  call void @FmoGenerateType5MapUnitMap.4(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType5MapUnitMap.38:               ; preds = %ctrl1
  call void @FmoGenerateType5MapUnitMap.38(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType5MapUnitMap.46:               ; preds = %ctrl1
  call void @FmoGenerateType5MapUnitMap.46(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_FmoGenerateType5MapUnitMap.4, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_FmoGenerateType5MapUnitMap.38, label %func_FmoGenerateType5MapUnitMap.46
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FmoGenerateType6MapUnitMap.1, label %ctrl0

func_FmoGenerateType6MapUnitMap.1:                ; preds = %rand_bb
  call void @FmoGenerateType6MapUnitMap.1(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_FmoGenerateType6MapUnitMap.15, label %func_FmoGenerateType6MapUnitMap.34
}

; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType6MapUnitMap.1(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %canary = alloca i32
  store i32 189587423, i32* %canary
  %i = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1283526628, i32* %canary
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %img.addr = alloca %struct.ImageParameters*, align 8
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType2MapUnitMap.3(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
...
entry:
  %canary = alloca i32
  store i32 1200106681, i32* %canary
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %j = alloca i32, align 4
  %img.addr = alloca %struct.ImageParameters*, align 8
  %mapUnitsInSliceGroup0 = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @FmoGetLastCodedMBOfSliceGroup.5(i32 %SliceGroupID) #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1723818322, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1395397184, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @FmoGetNextMBNr.7(i32 %CurrentMbNr) #0 {
entry:
  %canary = alloca i32
  store i32 884034679, i32* %canary
...
entry:
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 394463203, i32* %canary
  %SliceGroupID.addr = alloca i32, align 4
  %i = alloca i32, align 4
  store i32 %SliceGroupID, i32* %SliceGroupID.addr, align 4
  store i32 0, i32* %i, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType0MapUnitMap.9(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %j = alloca i32, align 4
  %iGroup = alloca i32, align 4
  %img.addr = alloca %struct.ImageParameters*, align 8
  %canary = alloca i32
  store i32 1178549086, i32* %canary
  %i = alloca i32, align 4
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @FmoSliceGroupCompletelyCoded.10(i32 %SliceGroupID) #0 {
entry:
  %canary = alloca i32
  store i32 1041275079, i32* %canary
  %SliceGroupID.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  store i32 %SliceGroupID, i32* %SliceGroupID.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @FmoSliceGroupCompletelyCoded.11(i32 %SliceGroupID) #0 {
entry:
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1743891136, i32* %canary
  %SliceGroupID.addr = alloca i32, align 4
  store i32 %SliceGroupID, i32* %SliceGroupID.addr, align 4
  %0 = load i32, i32* %SliceGroupID.addr, align 4
  %call = call i32 @FmoGetFirstMacroblockInSlice(i32 %0)
...
entry:
  %img.addr = alloca %struct.ImageParameters*, align 8
  %canary = alloca i32
  store i32 2055811397, i32* %canary
  %i = alloca i32, align 4
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @FmoGenerateMapUnitToSliceGroupMap.13(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %canary = alloca i32
  store i32 1140914780, i32* %canary
  %img.addr = alloca %struct.ImageParameters*, align 8
  %retval = alloca i32, align 4
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
...
entry:
  %mb.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1207902525, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1516768413, i32* %canary
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %img.addr = alloca %struct.ImageParameters*, align 8
  %i = alloca i32, align 4
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType0MapUnitMap.16(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %i = alloca i32, align 4
  %iGroup = alloca i32, align 4
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 436798323, i32* %canary
  %img.addr = alloca %struct.ImageParameters*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
  store i32 0, i32* %i, align 4
...
entry:
  ...
  %iGroup = alloca i32, align 4
  %canary = alloca i32
  store i32 2089078440, i32* %canary
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
  store i32 0, i32* %i, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType4MapUnitMap.18(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %canary = alloca i32
  store i32 1537225836, i32* %canary
  %i = alloca i32, align 4
  %img.addr = alloca %struct.ImageParameters*, align 8
  %mapUnitsInSliceGroup0 = alloca i32, align 4
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType3MapUnitMap.19(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 1843246534, i32* %canary
...
entry:
  %img.addr = alloca %struct.ImageParameters*, align 8
  %canary = alloca i32
  store i32 2132950814, i32* %canary
  %sps.addr = alloca %struct.seq_parameter_set_rbsp_t*, align 8
  %i = alloca i32, align 4
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.seq_parameter_set_rbsp_t* %sps, %struct.seq_parameter_set_rbsp_t** %sps.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType0MapUnitMap.21(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %j = alloca i32, align 4
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 373473542, i32* %canary
  %iGroup = alloca i32, align 4
  %img.addr = alloca %struct.ImageParameters*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
...
entry:
  %sizeOfUpperLeftGroup = alloca i32, align 4
  %canary = alloca i32
  store i32 1446988703, i32* %canary
  %mapUnitsInSliceGroup0 = alloca i32, align 4
  %img.addr = alloca %struct.ImageParameters*, align 8
  %i = alloca i32, align 4
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @FmoGetNextMBNr.23(i32 %CurrentMbNr) #0 {
entry:
  %SliceGroupID = alloca i32, align 4
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 2015865087, i32* %canary
  %CurrentMbNr.addr = alloca i32, align 4
  store i32 %CurrentMbNr, i32* %CurrentMbNr.addr, align 4
  %0 = load i32, i32* %CurrentMbNr.addr, align 4
  %call = call i32 @FmoMB2SliceGroup(i32 %0)
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FmoSetLastMacroblockInSlice.24(i32 %mb) #0 {
entry:
  %canary = alloca i32
  store i32 1565227911, i32* %canary
  %currSliceGroup = alloca i32, align 4
  %mb.addr = alloca i32, align 4
  store i32 %mb, i32* %mb.addr, align 4
  %0 = load i32, i32* %mb.addr, align 4
...
entry:
  ...
  %leftBound = alloca i32, align 4
  %canary = alloca i32
  store i32 512239701, i32* %canary
  %mapUnitsInSliceGroup0 = alloca i32, align 4
  %yDir = alloca i32, align 4
  %k = alloca i32, align 4
  %mapUnitVacant = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 830940996, i32* %canary
  %LastMB = alloca i32, align 4
  %SliceGroupID.addr = alloca i32, align 4
  %i = alloca i32, align 4
  store i32 %SliceGroupID, i32* %SliceGroupID.addr, align 4
...
entry:
  %SliceGroupID.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1595846121, i32* %canary
  %retval = alloca i32, align 4
  %i = alloca i32, align 4
  store i32 %SliceGroupID, i32* %SliceGroupID.addr, align 4
  store i32 0, i32* %i, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @FmoGenerateMBAmap.28(%struct.ImageParameters* %img, %struct.seq_parameter_set_rbsp_t* %sps) #0 {
entry:
  %canary = alloca i32
  store i32 645300223, i32* %canary
  %sps.addr = alloca %struct.seq_parameter_set_rbsp_t*, align 8
  %i = alloca i32, align 4
  %img.addr = alloca %struct.ImageParameters*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
...
entry:
  %SliceGroupID.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 305834892, i32* %canary
  %LastMB = alloca i32, align 4
  %i = alloca i32, align 4
  store i32 %SliceGroupID, i32* %SliceGroupID.addr, align 4
  store i32 -1, i32* %LastMB, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @FmoInit.30(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps, %struct.seq_parameter_set_rbsp_t* %sps) #0 {
entry:
  %sps.addr = alloca %struct.seq_parameter_set_rbsp_t*, align 8
  %canary = alloca i32
  store i32 833322708, i32* %canary
  %k = alloca i32, align 4
  %img.addr = alloca %struct.ImageParameters*, align 8
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 2076112578, i32* %canary
  %retval = alloca i32, align 4
  %img.addr = alloca %struct.ImageParameters*, align 8
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
...
entry:
  ...
  %SliceGroupID = alloca i32, align 4
  %canary = alloca i32
  store i32 1696025902, i32* %canary
  %retval = alloca i32, align 4
  store i32 %CurrentMbNr, i32* %CurrentMbNr.addr, align 4
  %0 = load i32, i32* %CurrentMbNr.addr, align 4
  %call = call i32 @FmoMB2SliceGroup(i32 %0)
...
entry:
  %canary = alloca i32
  store i32 924070405, i32* %canary
  %topBound = alloca i32, align 4
  %mapUnitVacant = alloca i32, align 4
  %mapUnitsInSliceGroup0 = alloca i32, align 4
  %bottomBound = alloca i32, align 4
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1666131478, i32* %canary
  %img.addr = alloca %struct.ImageParameters*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
  store i32 0, i32* %i, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType2MapUnitMap.35(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %i = alloca i32, align 4
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %xTopLeft = alloca i32, align 4
  ...
  %iGroup = alloca i32, align 4
  %canary = alloca i32
  store i32 1291603091, i32* %canary
  %x = alloca i32, align 4
  %y = alloca i32, align 4
  %yTopLeft = alloca i32, align 4
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
...
entry:
  ...
  %leftBound = alloca i32, align 4
  %canary = alloca i32
  store i32 161333871, i32* %canary
  %topBound = alloca i32, align 4
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @FmoGetFirstMBOfSliceGroup.37(i32 %SliceGroupID) #0 {
entry:
  %i = alloca i32, align 4
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 172488241, i32* %canary
  %SliceGroupID.addr = alloca i32, align 4
  store i32 %SliceGroupID, i32* %SliceGroupID.addr, align 4
  store i32 0, i32* %i, align 4
  br label %while.cond
...
entry:
  %canary = alloca i32
  store i32 974688355, i32* %canary
  %sizeOfUpperLeftGroup = alloca i32, align 4
  %mapUnitsInSliceGroup0 = alloca i32, align 4
  %k = alloca i32, align 4
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @FmoGetPreviousMBNr.39(i32 %CurrentMbNr) #0 {
entry:
  %canary = alloca i32
  store i32 665345832, i32* %canary
  %retval = alloca i32, align 4
  %CurrentMbNr.addr = alloca i32, align 4
  %SliceGroupID = alloca i32, align 4
  store i32 %CurrentMbNr, i32* %CurrentMbNr.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType2MapUnitMap.40(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %iGroup = alloca i32, align 4
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %xTopLeft = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @FmoGetLastCodedMBOfSliceGroup.41(i32 %SliceGroupID) #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1526660587, i32* %canary
  %SliceGroupID.addr = alloca i32, align 4
  %LastMB = alloca i32, align 4
  store i32 %SliceGroupID, i32* %SliceGroupID.addr, align 4
  store i32 -1, i32* %LastMB, align 4
...
entry:
  %canary = alloca i32
  store i32 1479753488, i32* %canary
  %CurrentMbNr.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  %SliceGroupID = alloca i32, align 4
  store i32 %CurrentMbNr, i32* %CurrentMbNr.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType4MapUnitMap.43(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %i = alloca i32, align 4
  %sizeOfUpperLeftGroup = alloca i32, align 4
  %img.addr = alloca %struct.ImageParameters*, align 8
  %canary = alloca i32
  store i32 1410875304, i32* %canary
  %mapUnitsInSliceGroup0 = alloca i32, align 4
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
  %0 = load %struct.pic_parameter_set_rbsp_t*, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 852729755, i32* %canary
  %SliceGroupID.addr = alloca i32, align 4
  store i32 %SliceGroupID, i32* %SliceGroupID.addr, align 4
  store i32 0, i32* %i, align 4
  br label %while.cond
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @FmoGetPreviousMBNr.45(i32 %CurrentMbNr) #0 {
entry:
  %canary = alloca i32
  store i32 702711825, i32* %canary
  %SliceGroupID = alloca i32, align 4
  %retval = alloca i32, align 4
  %CurrentMbNr.addr = alloca i32, align 4
  store i32 %CurrentMbNr, i32* %CurrentMbNr.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType5MapUnitMap.46(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %sizeOfUpperLeftGroup = alloca i32, align 4
  %img.addr = alloca %struct.ImageParameters*, align 8
  %k = alloca i32, align 4
  ...
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %canary = alloca i32
  store i32 1283642208, i32* %canary
  %j = alloca i32, align 4
  %i = alloca i32, align 4
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1239977821, i32* %canary
  %i = alloca i32, align 4
  %img.addr = alloca %struct.ImageParameters*, align 8
  %sps.addr = alloca %struct.seq_parameter_set_rbsp_t*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
...
entry:
  %k = alloca i32, align 4
  %canary = alloca i32
  store i32 448635754, i32* %canary
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %sps.addr = alloca %struct.seq_parameter_set_rbsp_t*, align 8
  %img.addr = alloca %struct.ImageParameters*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1577259631, i32* %canary
  %img.addr = alloca %struct.ImageParameters*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** %img.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @FmoGetPreviousMBNr.50(i32 %CurrentMbNr) #0 {
entry:
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1448678935, i32* %canary
  %SliceGroupID = alloca i32, align 4
  %CurrentMbNr.addr = alloca i32, align 4
  store i32 %CurrentMbNr, i32* %CurrentMbNr.addr, align 4
  %0 = load i32, i32* %CurrentMbNr.addr, align 4
...
entry:
  ...
  %mapUnitsInSliceGroup0 = alloca i32, align 4
  %canary = alloca i32
  store i32 760984718, i32* %canary
  %img.addr = alloca %struct.ImageParameters*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
  %0 = load %struct.pic_parameter_set_rbsp_t*, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @FmoGenerateMBAmap.52(%struct.ImageParameters* %img, %struct.seq_parameter_set_rbsp_t* %sps) #0 {
entry:
  %canary = alloca i32
  store i32 46762254, i32* %canary
  %sps.addr = alloca %struct.seq_parameter_set_rbsp_t*, align 8
  %img.addr = alloca %struct.ImageParameters*, align 8
  %i = alloca i32, align 4
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
...
entry:
  ...
  %sps.addr = alloca %struct.seq_parameter_set_rbsp_t*, align 8
  %canary = alloca i32
  store i32 1903939591, i32* %canary
  %k = alloca i32, align 4
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
  store %struct.seq_parameter_set_rbsp_t* %sps, %struct.seq_parameter_set_rbsp_t** %sps.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @FmoGenerateMapUnitToSliceGroupMap.54(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %retval = alloca i32, align 4
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %canary = alloca i32
  store i32 692823452, i32* %canary
  %img.addr = alloca %struct.ImageParameters*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** %img.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @FmoGetNextMBNr.55(i32 %CurrentMbNr) #0 {
entry:
  %canary = alloca i32
  store i32 531798176, i32* %canary
  %SliceGroupID = alloca i32, align 4
  %CurrentMbNr.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  store i32 %CurrentMbNr, i32* %CurrentMbNr.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType0MapUnitMap.56(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %img.addr = alloca %struct.ImageParameters*, align 8
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %canary = alloca i32
  store i32 1803545870, i32* %canary
  %i = alloca i32, align 4
  %iGroup = alloca i32, align 4
  %j = alloca i32, align 4
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1153535688, i32* %canary
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
  store i32 0, i32* %i, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType1MapUnitMap.58(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %canary = alloca i32
  store i32 1513947904, i32* %canary
  %img.addr = alloca %struct.ImageParameters*, align 8
  %i = alloca i32, align 4
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
...
entry:
  ...
  %img.addr = alloca %struct.ImageParameters*, align 8
  %canary = alloca i32
  store i32 337779991, i32* %canary
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
  store i32 0, i32* %i, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType1MapUnitMap.60(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %i = alloca i32, align 4
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %canary = alloca i32
  store i32 1192481546, i32* %canary
  %img.addr = alloca %struct.ImageParameters*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
  store i32 0, i32* %i, align 4
