...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_write_sei_message.43, label %ctrl0

func_write_sei_message.43:                        ; preds = %rand_bb
  call void @write_sei_message.43(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type)
  ret void

func_write_sei_message.49:                        ; preds = %ctrl0
  call void @write_sei_message.49(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type)
  ret void

func_write_sei_message.50:                        ; preds = %ctrl1
  call void @write_sei_message.50(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type)
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_write_sei_message.49, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_write_sei_message.50, label %func_write_sei_message.52
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_finalize_sei_message.29, label %func_finalize_sei_message.48

func_finalize_sei_message.29:                     ; preds = %rand_bb
  call void @finalize_sei_message.29(i32 %id)
  ret void

func_finalize_sei_message.48:                     ; preds = %rand_bb
  call void @finalize_sei_message.48(i32 %id)
  ret void
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_AppendTmpbits2Buf.3, label %ctrl0

func_AppendTmpbits2Buf.3:                         ; preds = %rand_bb
  call void @AppendTmpbits2Buf.3(%struct.Bitstream* %dest, %struct.Bitstream* %source)
  ret void

func_AppendTmpbits2Buf.9:                         ; preds = %ctrl0
  call void @AppendTmpbits2Buf.9(%struct.Bitstream* %dest, %struct.Bitstream* %source)
  ret void

func_AppendTmpbits2Buf.14:                        ; preds = %ctrl1
  call void @AppendTmpbits2Buf.14(%struct.Bitstream* %dest, %struct.Bitstream* %source)
  ret void

func_AppendTmpbits2Buf.15:                        ; preds = %ctrl1
  call void @AppendTmpbits2Buf.15(%struct.Bitstream* %dest, %struct.Bitstream* %source)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_AppendTmpbits2Buf.9, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_AppendTmpbits2Buf.14, label %func_AppendTmpbits2Buf.15
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_ComposeSparePictureMessage.4, label %ctrl0

func_ComposeSparePictureMessage.4:                ; preds = %rand_bb
  call void @ComposeSparePictureMessage.4(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream)
  ret void

func_ComposeSparePictureMessage.18:               ; preds = %ctrl0
  call void @ComposeSparePictureMessage.18(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream)
  ret void

func_ComposeSparePictureMessage.27:               ; preds = %ctrl1
  call void @ComposeSparePictureMessage.27(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream)
  ret void

func_ComposeSparePictureMessage.42:               ; preds = %ctrl1
  call void @ComposeSparePictureMessage.42(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_ComposeSparePictureMessage.18, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_ComposeSparePictureMessage.27, label %func_ComposeSparePictureMessage.42
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_CompressSpareMBMap.31, label %ctrl0

func_CompressSpareMBMap.31:                       ; preds = %rand_bb
  %2 = call i32 @CompressSpareMBMap.31(i8** %map_sp, %struct.Bitstream* %bitstream)
  ret i32 %2

func_CompressSpareMBMap.36:                       ; preds = %ctrl0
  %3 = call i32 @CompressSpareMBMap.36(i8** %map_sp, %struct.Bitstream* %bitstream)
  ret i32 %3

func_CompressSpareMBMap.44:                       ; preds = %ctrl1
  %4 = call i32 @CompressSpareMBMap.44(i8** %map_sp, %struct.Bitstream* %bitstream)
  ret i32 %4

func_CompressSpareMBMap.45:                       ; preds = %ctrl1
  %5 = call i32 @CompressSpareMBMap.45(i8** %map_sp, %struct.Bitstream* %bitstream)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_CompressSpareMBMap.36, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_CompressSpareMBMap.44, label %func_CompressSpareMBMap.45
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FinalizeSpareMBMap.11, label %ctrl0

func_FinalizeSpareMBMap.11:                       ; preds = %rand_bb
  call void @FinalizeSpareMBMap.11()
  ret void

func_FinalizeSpareMBMap.30:                       ; preds = %ctrl0
  call void @FinalizeSpareMBMap.30()
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_FinalizeSpareMBMap.30, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_FinalizeSpareMBMap.53, label %func_FinalizeSpareMBMap.55
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FinalizeSubseqInfo.25, label %ctrl0

func_FinalizeSubseqInfo.25:                       ; preds = %rand_bb
  call void @FinalizeSubseqInfo.25(i32 %currLayer)
  ret void

func_FinalizeSubseqInfo.35:                       ; preds = %ctrl0
  call void @FinalizeSubseqInfo.35(i32 %currLayer)
  ret void

func_FinalizeSubseqInfo.37:                       ; preds = %ctrl1
  call void @FinalizeSubseqInfo.37(i32 %currLayer)
  ret void

func_FinalizeSubseqInfo.40:                       ; preds = %ctrl1
  call void @FinalizeSubseqInfo.40(i32 %currLayer)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_FinalizeSubseqInfo.35, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_FinalizeSubseqInfo.37, label %func_FinalizeSubseqInfo.40
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FinalizeSubseqLayerInfo.10, label %func_FinalizeSubseqLayerInfo.21

func_FinalizeSubseqLayerInfo.10:                  ; preds = %rand_bb
  call void @FinalizeSubseqLayerInfo.10()
  ret void

func_FinalizeSubseqLayerInfo.21:                  ; preds = %rand_bb
  call void @FinalizeSubseqLayerInfo.21()
  ret void
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FinalizeSubseqChar.6, label %ctrl0

func_FinalizeSubseqChar.6:                        ; preds = %rand_bb
  call void @FinalizeSubseqChar.6()
  ret void

func_FinalizeSubseqChar.22:                       ; preds = %ctrl0
  call void @FinalizeSubseqChar.22()
  ret void

func_FinalizeSubseqChar.34:                       ; preds = %ctrl1
  call void @FinalizeSubseqChar.34()
  ret void

func_FinalizeSubseqChar.41:                       ; preds = %ctrl1
  call void @FinalizeSubseqChar.41()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_FinalizeSubseqChar.22, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_FinalizeSubseqChar.34, label %func_FinalizeSubseqChar.41
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FinalizeSceneInformation.1, label %func_FinalizeSceneInformation.32

func_FinalizeSceneInformation.1:                  ; preds = %rand_bb
  call void @FinalizeSceneInformation.1()
  ret void

func_FinalizeSceneInformation.32:                 ; preds = %rand_bb
  call void @FinalizeSceneInformation.32()
  ret void
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_UpdateSceneInformation.7, label %ctrl0

func_UpdateSceneInformation.7:                    ; preds = %rand_bb
  call void @UpdateSceneInformation.7(i32 %HasSceneInformation, i32 %sceneID, i32 %sceneTransType, i32 %secondSceneID)
  ret void

func_UpdateSceneInformation.17:                   ; preds = %ctrl0
  call void @UpdateSceneInformation.17(i32 %HasSceneInformation, i32 %sceneID, i32 %sceneTransType, i32 %secondSceneID)
  ret void

func_UpdateSceneInformation.24:                   ; preds = %ctrl1
  call void @UpdateSceneInformation.24(i32 %HasSceneInformation, i32 %sceneID, i32 %sceneTransType, i32 %secondSceneID)
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_UpdateSceneInformation.17, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_UpdateSceneInformation.24, label %func_UpdateSceneInformation.26
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FinalizePanScanRectInfo.16, label %func_FinalizePanScanRectInfo.23

func_FinalizePanScanRectInfo.16:                  ; preds = %rand_bb
  call void @FinalizePanScanRectInfo.16()
  ret void
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_UpdateUser_data_unregistered.19, label %ctrl0

func_UpdateUser_data_unregistered.19:             ; preds = %rand_bb
  call void @UpdateUser_data_unregistered.19()
  ret void

func_UpdateUser_data_unregistered.38:             ; preds = %ctrl0
...
func_UpdateUser_data_unregistered.56:             ; preds = %ctrl1
  call void @UpdateUser_data_unregistered.56()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_UpdateUser_data_unregistered.38, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_UpdateUser_data_unregistered.47, label %func_UpdateUser_data_unregistered.56
}
...
func_FinalizeUser_data_unregistered.5:            ; preds = %ctrl0
  call void @FinalizeUser_data_unregistered.5()
  ret void

func_FinalizeUser_data_unregistered.8:            ; preds = %ctrl1
  call void @FinalizeUser_data_unregistered.8()
  ret void

func_FinalizeUser_data_unregistered.12:           ; preds = %ctrl1
  call void @FinalizeUser_data_unregistered.12()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_FinalizeUser_data_unregistered.5, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_FinalizeUser_data_unregistered.8, label %func_FinalizeUser_data_unregistered.12
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_UpdateUser_data_registered_itu_t_t35.39, label %ctrl0

func_UpdateUser_data_registered_itu_t_t35.39:     ; preds = %rand_bb
  call void @UpdateUser_data_registered_itu_t_t35.39()
  ret void

func_UpdateUser_data_registered_itu_t_t35.54:     ; preds = %ctrl0
  call void @UpdateUser_data_registered_itu_t_t35.54()
  ret void

func_UpdateUser_data_registered_itu_t_t35.57:     ; preds = %ctrl1
  call void @UpdateUser_data_registered_itu_t_t35.57()
  ret void

func_UpdateUser_data_registered_itu_t_t35.58:     ; preds = %ctrl1
  call void @UpdateUser_data_registered_itu_t_t35.58()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_UpdateUser_data_registered_itu_t_t35.54, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_UpdateUser_data_registered_itu_t_t35.57, label %func_UpdateUser_data_registered_itu_t_t35.58
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FinalizeUser_data_registered_itu_t_t35.13, label %ctrl0

func_FinalizeUser_data_registered_itu_t_t35.13:   ; preds = %rand_bb
  call void @FinalizeUser_data_registered_itu_t_t35.13()
  ret void

func_FinalizeUser_data_registered_itu_t_t35.28:   ; preds = %ctrl0
  call void @FinalizeUser_data_registered_itu_t_t35.28()
  ret void
...
func_FinalizeUser_data_registered_itu_t_t35.51:   ; preds = %ctrl1
  call void @FinalizeUser_data_registered_itu_t_t35.51()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_FinalizeUser_data_registered_itu_t_t35.28, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_FinalizeUser_data_registered_itu_t_t35.46, label %func_FinalizeUser_data_registered_itu_t_t35.51
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FinalizeRandomAccess.20, label %func_FinalizeRandomAccess.33

func_FinalizeRandomAccess.20:                     ; preds = %rand_bb
  call void @FinalizeRandomAccess.20()
  ret void

func_FinalizeRandomAccess.33:                     ; preds = %rand_bb
  call void @FinalizeRandomAccess.33()
  ret void
}
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSceneInformation.1() #0 {
entry:
  %dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 1928756897, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 859873772, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @ComposeSparePictureMessage.4(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 1264234376, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
...
entry:
  ...
  %sym = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 751619543, i32* %canary
  %i = alloca i32, align 4
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_unregistered_information_struct, %struct.user_data_unregistered_information_struct* @seiUser_data_unregistered, i32 0, i32 2), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
  %type = getelementptr inbounds %struct.syntaxelement, %struct.syntaxelement* %sym, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSubseqChar.6() #0 {
entry:
  %sym = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 926472742, i32* %canary
  %i = alloca i32, align 4
  %dest = alloca %struct.Bitstream*, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.subseq_char_information_struct, %struct.subseq_char_information_struct* @seiSubseqChar, i32 0, i32 10), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateSceneInformation.7(i32 %HasSceneInformation, i32 %sceneID, i32 %sceneTransType, i32 %secondSceneID) #0 {
entry:
  %canary = alloca i32
  store i32 403244418, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeUser_data_unregistered.8() #0 {
entry:
  %dest = alloca %struct.Bitstream*, align 8
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1661757979, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_unregistered_information_struct, %struct.user_data_unregistered_information_struct* @seiUser_data_unregistered, i32 0, i32 2), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
  %type = getelementptr inbounds %struct.syntaxelement, %struct.syntaxelement* %sym, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @AppendTmpbits2Buf.9(%struct.Bitstream* %dest, %struct.Bitstream* %source) #0 {
entry:
  %dest.addr = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 2025911025, i32* %canary
  %mask = alloca i8, align 1
  %j = alloca i32, align 4
  %bits_in_last_byte = alloca i32, align 4
  %i = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1320028779, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSpareMBMap.11() #0 {
entry:
  %sym = alloca %struct.syntaxelement, align 8
  ...
  %canary = alloca i32
  store i32 1732096458, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1394052763, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %dest = alloca %struct.Bitstream*, align 8
  %i = alloca i32, align 4
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_unregistered_information_struct, %struct.user_data_unregistered_information_struct* @seiUser_data_unregistered, i32 0, i32 2), align 8
...
entry:
  ...
  %sym = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 1537502987, i32* %canary
  %i = alloca i32, align 4
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_registered_itu_t_t35_information_struct, %struct.user_data_registered_itu_t_t35_information_struct* @seiUser_data_registered_itu_t_t35, i32 0, i32 4), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
  %type = getelementptr inbounds %struct.syntaxelement, %struct.syntaxelement* %sym, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @AppendTmpbits2Buf.14(%struct.Bitstream* %dest, %struct.Bitstream* %source) #0 {
entry:
  %mask = alloca i8, align 1
  %canary = alloca i32
  store i32 561990223, i32* %canary
  %bits_in_last_byte = alloca i32, align 4
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %dest.addr = alloca %struct.Bitstream*, align 8
...
entry:
  %mask = alloca i8, align 1
  %canary = alloca i32
  store i32 910077837, i32* %canary
  %i = alloca i32, align 4
  %source.addr = alloca %struct.Bitstream*, align 8
  %dest.addr = alloca %struct.Bitstream*, align 8
  %j = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizePanScanRectInfo.16() #0 {
entry:
  %dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 2076792472, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.panscanrect_information_struct, %struct.panscanrect_information_struct* @seiPanScanRectInfo, i32 0, i32 5), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
  %type = getelementptr inbounds %struct.syntaxelement, %struct.syntaxelement* %sym, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateSceneInformation.17(i32 %HasSceneInformation, i32 %sceneID, i32 %sceneTransType, i32 %secondSceneID) #0 {
entry:
  %sceneID.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 844449930, i32* %canary
  %secondSceneID.addr = alloca i32, align 4
  %sceneTransType.addr = alloca i32, align 4
  %HasSceneInformation.addr = alloca i32, align 4
  store i32 %HasSceneInformation, i32* %HasSceneInformation.addr, align 4
...
entry:
  ...
  %bitstream = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 1720483143, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %ref_area_indicator.addr = alloca i32, align 4
  %delta_spare_frame_num.addr = alloca i32, align 4
  store i32 %delta_spare_frame_num, i32* %delta_spare_frame_num.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateUser_data_unregistered.19() #0 {
entry:
  %i = alloca i32, align 4
  %total_byte = alloca i32, align 4
  %canary = alloca i32
  store i32 540328471, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeRandomAccess.20() #0 {
entry:
  %canary = alloca i32
  store i32 272966372, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  %sym = alloca %struct.syntaxelement, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.randomaccess_information_struct, %struct.randomaccess_information_struct* @seiRandomAccess, i32 0, i32 3), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSubseqLayerInfo.21() #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 501951243, i32* %canary
  %pos = alloca i32, align 4
  store i32 0, i32* %pos, align 4
  store i32 0, i32* getelementptr inbounds (%struct.subseq_layer_information_struct, %struct.subseq_layer_information_struct* @seiSubseqLayerInfo, i32 0, i32 4), align 4
  store i32 0, i32* %i, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSubseqChar.22() #0 {
entry:
  %dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 2062251528, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %i = alloca i32, align 4
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.subseq_char_information_struct, %struct.subseq_char_information_struct* @seiSubseqChar, i32 0, i32 10), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateSceneInformation.24(i32 %HasSceneInformation, i32 %sceneID, i32 %sceneTransType, i32 %secondSceneID) #0 {
entry:
  %canary = alloca i32
  store i32 154406053, i32* %canary
  %sceneID.addr = alloca i32, align 4
  %HasSceneInformation.addr = alloca i32, align 4
  %sceneTransType.addr = alloca i32, align 4
  %secondSceneID.addr = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 702863371, i32* %canary
  %currLayer.addr = alloca i32, align 4
  %sym = alloca %struct.syntaxelement, align 8
  %dest = alloca %struct.Bitstream*, align 8
  store i32 %currLayer, i32* %currLayer.addr, align 4
...
entry:
  %HasSceneInformation.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1015234536, i32* %canary
  %sceneID.addr = alloca i32, align 4
  %sceneTransType.addr = alloca i32, align 4
  %secondSceneID.addr = alloca i32, align 4
  store i32 %HasSceneInformation, i32* %HasSceneInformation.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @ComposeSparePictureMessage.27(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream) #0 {
entry:
  %sym = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 1338487754, i32* %canary
  %bitstream = alloca %struct.Bitstream*, align 8
  %tmpBitstream.addr = alloca %struct.Bitstream*, align 8
  %delta_spare_frame_num.addr = alloca i32, align 4
  %ref_area_indicator.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeUser_data_registered_itu_t_t35.28() #0 {
entry:
  %i = alloca i32, align 4
  %dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 49087185, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_registered_itu_t_t35_information_struct, %struct.user_data_registered_itu_t_t35_information_struct* @seiUser_data_registered_itu_t_t35, i32 0, i32 4), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
  %type = getelementptr inbounds %struct.syntaxelement, %struct.syntaxelement* %sym, i32 0, i32 0
...
entry:
  %canary = alloca i32
  store i32 1872473999, i32* %canary
  %id.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSpareMBMap.30() #0 {
entry:
  %dest = alloca %struct.Bitstream*, align 8
  %CurrFrameNum = alloca i32, align 4
  %source = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 1445425011, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %delta_frame_num = alloca i32, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %number = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSceneInformation.32() #0 {
entry:
  %canary = alloca i32
  store i32 1298099909, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %dest = alloca %struct.Bitstream*, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.scene_information_struct, %struct.scene_information_struct* @seiSceneInformation, i32 0, i32 3), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeRandomAccess.33() #0 {
entry:
  %sym = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 657967393, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.randomaccess_information_struct, %struct.randomaccess_information_struct* @seiRandomAccess, i32 0, i32 3), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
  %type = getelementptr inbounds %struct.syntaxelement, %struct.syntaxelement* %sym, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSubseqChar.34() #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 684003333, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %dest = alloca %struct.Bitstream*, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.subseq_char_information_struct, %struct.subseq_char_information_struct* @seiSubseqChar, i32 0, i32 10), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
...
entry:
  %currLayer.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1383276402, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  %sym = alloca %struct.syntaxelement, align 8
  store i32 %currLayer, i32* %currLayer.addr, align 4
  %0 = load i32, i32* %currLayer.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @CompressSpareMBMap.36(i8** %map_sp, %struct.Bitstream* %bitstream) #0 {
entry:
  %k = alloca i32, align 4
  %ret = alloca i32, align 4
  %directy = alloca i32, align 4
  ...
  %x = alloca i32, align 4
  %canary = alloca i32
  store i32 223702664, i32* %canary
  %right = alloca i32, align 4
  %bottom = alloca i32, align 4
  %noc = alloca i32, align 4
  %bit1 = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSubseqInfo.37(i32 %currLayer) #0 {
entry:
  %dest = alloca %struct.Bitstream*, align 8
  %sym = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 239156226, i32* %canary
  %currLayer.addr = alloca i32, align 4
  store i32 %currLayer, i32* %currLayer.addr, align 4
  %0 = load i32, i32* %currLayer.addr, align 4
  %idxprom = sext i32 %0 to i64
...
entry:
  %temp_data = alloca i32, align 4
  %canary = alloca i32
  store i32 1261844114, i32* %canary
  %i = alloca i32, align 4
  %total_byte = alloca i32, align 4
  store i32 7, i32* %total_byte, align 4
  store i32 0, i32* %i, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateUser_data_registered_itu_t_t35.39() #0 {
entry:
  %canary = alloca i32
  store i32 169512783, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSubseqInfo.40(i32 %currLayer) #0 {
entry:
  %dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 294370172, i32* %canary
  %currLayer.addr = alloca i32, align 4
  %sym = alloca %struct.syntaxelement, align 8
  store i32 %currLayer, i32* %currLayer.addr, align 4
  %0 = load i32, i32* %currLayer.addr, align 4
...
entry:
  %dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 1024168940, i32* %canary
  %i = alloca i32, align 4
  %sym = alloca %struct.syntaxelement, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.subseq_char_information_struct, %struct.subseq_char_information_struct* @seiSubseqChar, i32 0, i32 10), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
...
entry:
  ...
  %bitstream = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 561488624, i32* %canary
  %ref_area_indicator.addr = alloca i32, align 4
  store i32 %delta_spare_frame_num, i32* %delta_spare_frame_num.addr, align 4
  store i32 %ref_area_indicator, i32* %ref_area_indicator.addr, align 4
  store %struct.Bitstream* %tmpBitstream, %struct.Bitstream** %tmpBitstream.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_sei_message.43(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type) #0 {
entry:
  ...
  %offset = alloca i32, align 4
  %canary = alloca i32
  store i32 164791193, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @CompressSpareMBMap.44(i8** %map_sp, %struct.Bitstream* %bitstream) #0 {
entry:
  %directx = alloca i32, align 4
  %x = alloca i32, align 4
  %bitstream.addr = alloca %struct.Bitstream*, align 8
  ...
  %k = alloca i32, align 4
  %canary = alloca i32
  store i32 1539703782, i32* %canary
  %y = alloca i32, align 4
  %map_sp.addr = alloca i8**, align 8
  store i8** %map_sp, i8*** %map_sp.addr, align 8
  store %struct.Bitstream* %bitstream, %struct.Bitstream** %bitstream.addr, align 8
...
if.end190:                                        ; preds = %for.end189, %if.end141
  %121 = load i32, i32* %ret, align 4
  %122 = load i32, i32* %canary
  %123 = icmp eq i32 %122, 1539703782
  br i1 %123, label %124, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @CompressSpareMBMap.45(i8** %map_sp, %struct.Bitstream* %bitstream) #0 {
entry:
  %size_compressed = alloca i32, align 4
  %bitc = alloca i32, align 4
  %bit0 = alloca i32, align 4
  ...
  %left = alloca i32, align 4
  %canary = alloca i32
  store i32 1128892042, i32* %canary
  %top = alloca i32, align 4
  %y = alloca i32, align 4
  %map_sp.addr = alloca i8**, align 8
  %j = alloca i32, align 4
...
if.end190:                                        ; preds = %for.end189, %if.end141
  %121 = load i32, i32* %ret, align 4
  %122 = load i32, i32* %canary
  %123 = icmp eq i32 %122, 1128892042
  br i1 %123, label %124, label %func_exit
...
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 324460924, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %dest = alloca %struct.Bitstream*, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_registered_itu_t_t35_information_struct, %struct.user_data_registered_itu_t_t35_information_struct* @seiUser_data_registered_itu_t_t35, i32 0, i32 4), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
...
entry:
  %temp_data = alloca i32, align 4
  %canary = alloca i32
  store i32 568384647, i32* %canary
  %total_byte = alloca i32, align 4
  %i = alloca i32, align 4
  store i32 7, i32* %total_byte, align 4
  store i32 0, i32* %i, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @finalize_sei_message.48(i32 %id) #0 {
entry:
  %canary = alloca i32
  store i32 1193628931, i32* %canary
  %offset = alloca i32, align 4
  %id.addr = alloca i32, align 4
  store i32 %id, i32* %id.addr, align 4
  %0 = load i32, i32* %id.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_sei_message.49(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type) #0 {
entry:
  %size = alloca i32, align 4
  %payload_size.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 723685473, i32* %canary
  %offset = alloca i32, align 4
  %type = alloca i32, align 4
  %payload_type.addr = alloca i32, align 4
  %id.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_sei_message.50(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type) #0 {
entry:
  %canary = alloca i32
  store i32 1257273620, i32* %canary
  %type = alloca i32, align 4
  %payload_size.addr = alloca i32, align 4
  %offset = alloca i32, align 4
  %size = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1117243322, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  %i = alloca i32, align 4
  %sym = alloca %struct.syntaxelement, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_registered_itu_t_t35_information_struct, %struct.user_data_registered_itu_t_t35_information_struct* @seiUser_data_registered_itu_t_t35, i32 0, i32 4), align 8
...
entry:
  ...
  %payload_size.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1677174866, i32* %canary
  %id.addr = alloca i32, align 4
  store i32 %id, i32* %id.addr, align 4
  store i8* %payload, i8** %payload.addr, align 8
  store i32 %payload_size, i32* %payload_size.addr, align 4
...
entry:
  ...
  %country_code = alloca i32, align 4
  %canary = alloca i32
  store i32 1380493003, i32* %canary
  %total_byte = alloca i32, align 4
  %temp_data = alloca i32, align 4
  store i32 82, i32* %country_code, align 4
  %0 = load i32, i32* %country_code, align 4
...
entry:
  ...
  %sym = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 930524524, i32* %canary
  %CurrFrameNum = alloca i32, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %number = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 0
  %1 = load i32, i32* %number, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateUser_data_unregistered.56() #0 {
entry:
  %canary = alloca i32
  store i32 1162658759, i32* %canary
  %total_byte = alloca i32, align 4
  %temp_data = alloca i32, align 4
  %i = alloca i32, align 4
  store i32 7, i32* %total_byte, align 4
...
entry:
  ...
  %total_byte = alloca i32, align 4
  %canary = alloca i32
  store i32 1012110992, i32* %canary
  %country_code = alloca i32, align 4
  store i32 82, i32* %country_code, align 4
  %0 = load i32, i32* %country_code, align 4
  %cmp = icmp slt i32 %0, 255
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 626139263, i32* %canary
  %country_code = alloca i32, align 4
  store i32 82, i32* %country_code, align 4
  %0 = load i32, i32* %country_code, align 4
  %cmp = icmp slt i32 %0, 255
