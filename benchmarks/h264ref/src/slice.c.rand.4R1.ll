...
func_start_slice.10:                              ; preds = %ctrl0
  %3 = call i32 @start_slice.10()
  ret i32 %3
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_start_slice.10, label %ctrl1
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_terminate_slice.17, label %ctrl0

func_terminate_slice.17:                          ; preds = %rand_bb
  %2 = call i32 @terminate_slice.17()
  ret i32 %2
...
func_terminate_slice.26:                          ; preds = %ctrl1
  %4 = call i32 @terminate_slice.26()
  ret i32 %4

func_terminate_slice.28:                          ; preds = %ctrl1
  %5 = call i32 @terminate_slice.28()
  ret i32 %5
...
ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_terminate_slice.26, label %func_terminate_slice.28
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_encode_one_slice.4, label %ctrl0

func_encode_one_slice.4:                          ; preds = %rand_bb
  %2 = call i32 @encode_one_slice.4(i32 %SliceGroupId, %struct.Picture* %pic)
  ret i32 %2

func_encode_one_slice.6:                          ; preds = %ctrl0
  %3 = call i32 @encode_one_slice.6(i32 %SliceGroupId, %struct.Picture* %pic)
  ret i32 %3

func_encode_one_slice.13:                         ; preds = %ctrl1
  %4 = call i32 @encode_one_slice.13(i32 %SliceGroupId, %struct.Picture* %pic)
  ret i32 %4

func_encode_one_slice.14:                         ; preds = %ctrl1
  %5 = call i32 @encode_one_slice.14(i32 %SliceGroupId, %struct.Picture* %pic)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_encode_one_slice.6, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_encode_one_slice.13, label %func_encode_one_slice.14
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_init_slice.16, label %ctrl0

func_init_slice.16:                               ; preds = %rand_bb
  call void @init_slice.16(i32 %start_mb_addr)
  ret void

func_init_slice.21:                               ; preds = %ctrl0
  call void @init_slice.21(i32 %start_mb_addr)
  ret void

func_init_slice.29:                               ; preds = %ctrl1
  call void @init_slice.29(i32 %start_mb_addr)
  ret void

func_init_slice.31:                               ; preds = %ctrl1
  call void @init_slice.31(i32 %start_mb_addr)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_init_slice.21, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_init_slice.29, label %func_init_slice.31
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_free_slice_list.19, label %func_free_slice_list.32

func_free_slice_list.19:                          ; preds = %rand_bb
  call void @free_slice_list.19(%struct.Picture* %currPic)
  ret void

func_free_slice_list.32:                          ; preds = %rand_bb
  call void @free_slice_list.32(%struct.Picture* %currPic)
  ret void
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_free_slice.8, label %ctrl0

func_free_slice.8:                                ; preds = %rand_bb
  call void @free_slice.8(%struct.Slice* %slice)
  ret void

func_free_slice.11:                               ; preds = %ctrl0
  call void @free_slice.11(%struct.Slice* %slice)
  ret void

func_free_slice.20:                               ; preds = %ctrl1
  call void @free_slice.20(%struct.Slice* %slice)
  ret void

func_free_slice.22:                               ; preds = %ctrl1
  call void @free_slice.22(%struct.Slice* %slice)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_free_slice.11, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_free_slice.20, label %func_free_slice.22
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_modify_redundant_pic_cnt.12, label %func_modify_redundant_pic_cnt.15

func_modify_redundant_pic_cnt.12:                 ; preds = %rand_bb
  call void @modify_redundant_pic_cnt.12(i8* %buffer)
  ret void

func_modify_redundant_pic_cnt.15:                 ; preds = %rand_bb
  call void @modify_redundant_pic_cnt.15(i8* %buffer)
  ret void
}
...
func_poc_ref_pic_reorder.9:                       ; preds = %ctrl0
  call void @poc_ref_pic_reorder.9(%struct.storable_picture** %list, i32 %num_ref_idx_lX_active, i32* %remapping_of_pic_nums_idc, i32* %abs_diff_pic_num_minus1, i32* %long_term_pic_idx, i32 %weighted_prediction, i32 %list_no)
  ret void

func_poc_ref_pic_reorder.23:                      ; preds = %ctrl1
  call void @poc_ref_pic_reorder.23(%struct.storable_picture** %list, i32 %num_ref_idx_lX_active, i32* %remapping_of_pic_nums_idc, i32* %abs_diff_pic_num_minus1, i32* %long_term_pic_idx, i32 %weighted_prediction, i32 %list_no)
  ret void

func_poc_ref_pic_reorder.27:                      ; preds = %ctrl1
  call void @poc_ref_pic_reorder.27(%struct.storable_picture** %list, i32 %num_ref_idx_lX_active, i32* %remapping_of_pic_nums_idc, i32* %abs_diff_pic_num_minus1, i32* %long_term_pic_idx, i32 %weighted_prediction, i32 %list_no)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_poc_ref_pic_reorder.9, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_poc_ref_pic_reorder.23, label %func_poc_ref_pic_reorder.27
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_malloc_slice.7, label %ctrl0

func_malloc_slice.7:                              ; preds = %rand_bb
  %2 = call %struct.Slice* @malloc_slice.7()
  ret %struct.Slice* %2
...
func_malloc_slice.25:                             ; preds = %ctrl1
  %4 = call %struct.Slice* @malloc_slice.25()
  ret %struct.Slice* %4
...
ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_malloc_slice.25, label %func_malloc_slice.30
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_set_ref_pic_num.1, label %func_set_ref_pic_num.2

func_set_ref_pic_num.1:                           ; preds = %rand_bb
  call void @set_ref_pic_num.1()
  ret void

func_set_ref_pic_num.2:                           ; preds = %rand_bb
  call void @set_ref_pic_num.2()
  ret void
}
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @set_ref_pic_num.1() #0 {
entry:
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 666262586, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @set_ref_pic_num.2() #0 {
entry:
  %canary = alloca i32
  store i32 2135433378, i32* %canary
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  store i32 0, i32* %i, align 4
  br label %for.cond
...
if.end158:                                        ; preds = %if.end, %for.end79
  %112 = load i32, i32* %canary
  %113 = icmp eq i32 %112, 2135433378
  br i1 %113, label %114, label %func_exit
...
entry:
  ...
  %currSlice = alloca %struct.Slice*, align 8
  %canary = alloca i32
  store i32 967231406, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1140192351, i32* %canary
...
while.end:                                        ; preds = %while.cond
  ...
  %137 = icmp eq i32 %136, 1140192351
...
entry:
  ...
  %canary = alloca i32
  store i32 989785931, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @encode_one_slice.6(i32 %SliceGroupId, %struct.Picture* %pic) #0 {
entry:
  %end_of_slice = alloca i32, align 4
  %FieldRDCost = alloca double, align 8
  %pic.addr = alloca %struct.Picture*, align 8
  %canary = alloca i32
  store i32 574444042, i32* %canary
  %SliceGroupId.addr = alloca i32, align 4
  %recode_macroblock = alloca i32, align 4
  %len = alloca i32, align 4
  %NumberOfCodedMBs = alloca i32, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 394492929, i32* %canary
...
entry:
  %dataPart = alloca %struct.datapartition*, align 8
  %canary = alloca i32
  store i32 1591874108, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @poc_ref_pic_reorder.9(%struct.storable_picture** %list, i32 %num_ref_idx_lX_active, i32* %remapping_of_pic_nums_idc, i32* %abs_diff_pic_num_minus1, i32* %long_term_pic_idx, i32 %weighted_prediction, i32 %list_no) #0 {
entry:
  %tmp_value = alloca i32, align 4
  %num_ref_idx_lX_active.addr = alloca i32, align 4
  %k = alloca i32, align 4
  ...
  %tmp_reorder = alloca [32 x i32], align 16
  %canary = alloca i32
  store i32 735630614, i32* %canary
  %re_order = alloca [32 x i32], align 16
  %maxPicNum = alloca i32, align 4
  %list.addr = alloca %struct.storable_picture**, align 8
  %abs_poc_dist = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @start_slice.10() #0 {
entry:
  %i = alloca i32, align 4
  %eep = alloca %struct.EncodingEnvironment*, align 8
  %NumberOfPartitions = alloca i32, align 4
  %currSlice = alloca %struct.Slice*, align 8
  %canary = alloca i32
  store i32 472078389, i32* %canary
  %currStream = alloca %struct.Bitstream*, align 8
  %header_len = alloca i32, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %currentSlice = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 50
...
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 421867355, i32* %canary
  %slice.addr = alloca %struct.Slice*, align 8
  %dataPart = alloca %struct.datapartition*, align 8
  store %struct.Slice* %slice, %struct.Slice** %slice.addr, align 8
  %0 = load %struct.Slice*, %struct.Slice** %slice.addr, align 8
...
entry:
  ...
  %canary = alloca i32
  store i32 496904658, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @encode_one_slice.13(i32 %SliceGroupId, %struct.Picture* %pic) #0 {
entry:
  %CurrentMbAddr = alloca i32, align 4
  %canary = alloca i32
  store i32 972066770, i32* %canary
  %len = alloca i32, align 4
  %recode_macroblock = alloca i32, align 4
  %end_of_slice = alloca i32, align 4
  %NumberOfCodedMBs = alloca i32, align 4
...
entry:
  ...
  %CurrentMbAddr = alloca i32, align 4
  %canary = alloca i32
  store i32 1664366796, i32* %canary
  %NumberOfCodedMBs = alloca i32, align 4
  %FrameRDCost = alloca double, align 8
  store i32 %SliceGroupId, i32* %SliceGroupId.addr, align 4
  store %struct.Picture* %pic, %struct.Picture** %pic.addr, align 8
...
while.end:                                        ; preds = %while.cond
  ...
  %135 = load i32, i32* %NumberOfCodedMBs, align 4
  %136 = load i32, i32* %canary
  %137 = icmp eq i32 %136, 1664366796
  br i1 %137, label %138, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @modify_redundant_pic_cnt.15(i8* %buffer) #0 {
entry:
  %canary = alloca i32
  store i32 407628089, i32* %canary
  %tmp = alloca i8, align 1
  %buffer.addr = alloca i8*, align 8
  store i8* %buffer, i8** %buffer.addr, align 8
  %0 = load i32, i32* @rpc_bits_to_go, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @init_slice.16(i32 %start_mb_addr) #0 {
entry:
  %currSlice = alloca %struct.Slice*, align 8
  %canary = alloca i32
  store i32 1273116040, i32* %canary
  %dataPart = alloca %struct.datapartition*, align 8
...
if.end206:                                        ; preds = %if.then205, %if.end202
  ...
  %230 = icmp eq i32 %229, 1273116040
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @terminate_slice.17() #0 {
entry:
  %eep = alloca %struct.EncodingEnvironment*, align 8
  %currStream = alloca %struct.Bitstream*, align 8
  %bytes_written = alloca i32, align 4
  %canary = alloca i32
  store i32 1371481234, i32* %canary
  %i = alloca i32, align 4
  %currSlice = alloca %struct.Slice*, align 8
...
entry:
  %canary = alloca i32
  store i32 1828864319, i32* %canary
  %buffer_size = alloca i32, align 4
  %slice = alloca %struct.Slice*, align 8
  %dataPart = alloca %struct.datapartition*, align 8
  %i = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1384597081, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @free_slice.20(%struct.Slice* %slice) #0 {
entry:
  %dataPart = alloca %struct.datapartition*, align 8
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1159171080, i32* %canary
  %slice.addr = alloca %struct.Slice*, align 8
  store %struct.Slice* %slice, %struct.Slice** %slice.addr, align 8
  %0 = load %struct.Slice*, %struct.Slice** %slice.addr, align 8
  %cmp = icmp ne %struct.Slice* %0, null
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @init_slice.21(i32 %start_mb_addr) #0 {
entry:
  %i100 = alloca i32, align 4
  %dataPart = alloca %struct.datapartition*, align 8
  %i = alloca i32, align 4
  %start_mb_addr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 230496752, i32* %canary
  %num_ref = alloca i32, align 4
  %currPic = alloca %struct.Picture*, align 8
  %currStream = alloca %struct.Bitstream*, align 8
  %currSlice = alloca %struct.Slice*, align 8
...
entry:
  %canary = alloca i32
  store i32 955533805, i32* %canary
  %slice.addr = alloca %struct.Slice*, align 8
  %i = alloca i32, align 4
  %dataPart = alloca %struct.datapartition*, align 8
  store %struct.Slice* %slice, %struct.Slice** %slice.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @poc_ref_pic_reorder.23(%struct.storable_picture** %list, i32 %num_ref_idx_lX_active, i32* %remapping_of_pic_nums_idc, i32* %abs_diff_pic_num_minus1, i32* %long_term_pic_idx, i32 %weighted_prediction, i32 %list_no) #0 {
entry:
  %tmp_value = alloca i32, align 4
  %k = alloca i32, align 4
  %diff = alloca i32, align 4
  ...
  %abs_poc_dist = alloca i32, align 4
  %canary = alloca i32
  store i32 1374688711, i32* %canary
  %num_ref_idx_lX_active.addr = alloca i32, align 4
  %no_reorder = alloca i32, align 4
  %list.addr = alloca %struct.storable_picture**, align 8
  %long_term_pic_idx.addr = alloca i32*, align 8
...
if.end240:                                        ; preds = %if.end239, %for.end135
  %187 = load i32, i32* %canary
  %188 = icmp eq i32 %187, 1374688711
  br i1 %188, label %189, label %func_exit
...
entry:
  ...
  %eep = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 787197744, i32* %canary
  %bytes_written = alloca i32, align 4
  %byte_pos_before_startcode_emu_prevention = alloca i32, align 4
  %currStream = alloca %struct.Bitstream*, align 8
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal %struct.Slice* @malloc_slice.25() #0 {
entry:
  %i = alloca i32, align 4
  %buffer_size = alloca i32, align 4
  %slice = alloca %struct.Slice*, align 8
  %canary = alloca i32
  store i32 1953926069, i32* %canary
  %dataPart = alloca %struct.datapartition*, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %width = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 13
  %1 = load i32, i32* %width, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @terminate_slice.26() #0 {
entry:
  %currStream = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 1577997574, i32* %canary
  %currSlice = alloca %struct.Slice*, align 8
  %i = alloca i32, align 4
  %bytes_written = alloca i32, align 4
  %byte_pos_before_startcode_emu_prevention = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @poc_ref_pic_reorder.27(%struct.storable_picture** %list, i32 %num_ref_idx_lX_active, i32* %remapping_of_pic_nums_idc, i32* %abs_diff_pic_num_minus1, i32* %long_term_pic_idx, i32 %weighted_prediction, i32 %list_no) #0 {
entry:
  %reorder_stop = alloca i32, align 4
  %abs_poc_dist = alloca i32, align 4
  %re_order = alloca [32 x i32], align 16
  ...
  %maxPicNum = alloca i32, align 4
  %canary = alloca i32
  store i32 1890711542, i32* %canary
  %picNumLXPred = alloca i32, align 4
  %long_term_pic_idx.addr = alloca i32*, align 8
  %j = alloca i32, align 4
  %num_ref_idx_lX_active.addr = alloca i32, align 4
...
if.end240:                                        ; preds = %if.end239, %for.end135
  %187 = load i32, i32* %canary
  %188 = icmp eq i32 %187, 1890711542
  br i1 %188, label %189, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @terminate_slice.28() #0 {
entry:
  %eep = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 1575438078, i32* %canary
  %currStream = alloca %struct.Bitstream*, align 8
  %currSlice = alloca %struct.Slice*, align 8
  %bytes_written = alloca i32, align 4
  %byte_pos_before_startcode_emu_prevention = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @init_slice.29(i32 %start_mb_addr) #0 {
entry:
  %dataPart = alloca %struct.datapartition*, align 8
  %i = alloca i32, align 4
  %start_mb_addr.addr = alloca i32, align 4
  %currStream = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 576141143, i32* %canary
  %num_ref = alloca i32, align 4
  %currPic = alloca %struct.Picture*, align 8
  %i100 = alloca i32, align 4
  %currSlice = alloca %struct.Slice*, align 8
...
entry:
  %canary = alloca i32
  store i32 1412567254, i32* %canary
  %dataPart = alloca %struct.datapartition*, align 8
  %buffer_size = alloca i32, align 4
  %i = alloca i32, align 4
  %slice = alloca %struct.Slice*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @init_slice.31(i32 %start_mb_addr) #0 {
entry:
  %currPic = alloca %struct.Picture*, align 8
  %canary = alloca i32
  store i32 1872543978, i32* %canary
  %start_mb_addr.addr = alloca i32, align 4
  %currStream = alloca %struct.Bitstream*, align 8
  %currSlice = alloca %struct.Slice*, align 8
  %i = alloca i32, align 4
...
if.end206:                                        ; preds = %if.then205, %if.end202
  %229 = load i32, i32* %canary
  %230 = icmp eq i32 %229, 1872543978
  br i1 %230, label %231, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_slice_list.32(%struct.Picture* %currPic) #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 763705488, i32* %canary
  %currPic.addr = alloca %struct.Picture*, align 8
  store %struct.Picture* %currPic, %struct.Picture** %currPic.addr, align 8
  store i32 0, i32* %i, align 4
  br label %for.cond
...
entry:
  ...
  %NumberOfPartitions = alloca i32, align 4
  %canary = alloca i32
  store i32 1575175218, i32* %canary
  %i = alloca i32, align 4
  %currStream = alloca %struct.Bitstream*, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %currentSlice = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 50
...
entry:
  %canary = alloca i32
  store i32 484364220, i32* %canary
  %i = alloca i32, align 4
  %header_len = alloca i32, align 4
  %currSlice = alloca %struct.Slice*, align 8
  %currStream = alloca %struct.Bitstream*, align 8
