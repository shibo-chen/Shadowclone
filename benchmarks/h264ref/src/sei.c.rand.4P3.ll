...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_write_sei_message.19, label %ctrl0

func_write_sei_message.19:                        ; preds = %rand_bb
  call void @write_sei_message.19(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type)
  ret void

func_write_sei_message.42:                        ; preds = %ctrl0
  call void @write_sei_message.42(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type)
  ret void

func_write_sei_message.52:                        ; preds = %ctrl1
  call void @write_sei_message.52(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type)
  ret void

func_write_sei_message.55:                        ; preds = %ctrl1
  call void @write_sei_message.55(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_write_sei_message.42, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_write_sei_message.52, label %func_write_sei_message.55
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_finalize_sei_message.4, label %func_finalize_sei_message.32

func_finalize_sei_message.4:                      ; preds = %rand_bb
  call void @finalize_sei_message.4(i32 %id)
  ret void

func_finalize_sei_message.32:                     ; preds = %rand_bb
  call void @finalize_sei_message.32(i32 %id)
  ret void
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_AppendTmpbits2Buf.20, label %ctrl0

func_AppendTmpbits2Buf.20:                        ; preds = %rand_bb
  call void @AppendTmpbits2Buf.20(%struct.Bitstream* %dest, %struct.Bitstream* %source)
  ret void

func_AppendTmpbits2Buf.38:                        ; preds = %ctrl0
  call void @AppendTmpbits2Buf.38(%struct.Bitstream* %dest, %struct.Bitstream* %source)
  ret void

func_AppendTmpbits2Buf.39:                        ; preds = %ctrl1
  call void @AppendTmpbits2Buf.39(%struct.Bitstream* %dest, %struct.Bitstream* %source)
  ret void

func_AppendTmpbits2Buf.40:                        ; preds = %ctrl1
  call void @AppendTmpbits2Buf.40(%struct.Bitstream* %dest, %struct.Bitstream* %source)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_AppendTmpbits2Buf.38, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_AppendTmpbits2Buf.39, label %func_AppendTmpbits2Buf.40
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_ComposeSparePictureMessage.36, label %ctrl0

func_ComposeSparePictureMessage.36:               ; preds = %rand_bb
  call void @ComposeSparePictureMessage.36(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream)
  ret void

func_ComposeSparePictureMessage.53:               ; preds = %ctrl0
  call void @ComposeSparePictureMessage.53(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream)
  ret void

func_ComposeSparePictureMessage.54:               ; preds = %ctrl1
  call void @ComposeSparePictureMessage.54(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream)
  ret void

func_ComposeSparePictureMessage.57:               ; preds = %ctrl1
  call void @ComposeSparePictureMessage.57(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_ComposeSparePictureMessage.53, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_ComposeSparePictureMessage.54, label %func_ComposeSparePictureMessage.57
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_CompressSpareMBMap.14, label %ctrl0

func_CompressSpareMBMap.14:                       ; preds = %rand_bb
  %2 = call i32 @CompressSpareMBMap.14(i8** %map_sp, %struct.Bitstream* %bitstream)
  ret i32 %2

func_CompressSpareMBMap.30:                       ; preds = %ctrl0
  %3 = call i32 @CompressSpareMBMap.30(i8** %map_sp, %struct.Bitstream* %bitstream)
  ret i32 %3
...
func_CompressSpareMBMap.58:                       ; preds = %ctrl1
  %5 = call i32 @CompressSpareMBMap.58(i8** %map_sp, %struct.Bitstream* %bitstream)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_CompressSpareMBMap.30, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_CompressSpareMBMap.56, label %func_CompressSpareMBMap.58
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FinalizeSpareMBMap.27, label %ctrl0

func_FinalizeSpareMBMap.27:                       ; preds = %rand_bb
  call void @FinalizeSpareMBMap.27()
  ret void

func_FinalizeSpareMBMap.28:                       ; preds = %ctrl0
  call void @FinalizeSpareMBMap.28()
  ret void

func_FinalizeSpareMBMap.44:                       ; preds = %ctrl1
  call void @FinalizeSpareMBMap.44()
  ret void

func_FinalizeSpareMBMap.47:                       ; preds = %ctrl1
  call void @FinalizeSpareMBMap.47()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_FinalizeSpareMBMap.28, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_FinalizeSpareMBMap.44, label %func_FinalizeSpareMBMap.47
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FinalizeSubseqInfo.5, label %ctrl0

func_FinalizeSubseqInfo.5:                        ; preds = %rand_bb
  call void @FinalizeSubseqInfo.5(i32 %currLayer)
  ret void

func_FinalizeSubseqInfo.6:                        ; preds = %ctrl0
  call void @FinalizeSubseqInfo.6(i32 %currLayer)
  ret void

func_FinalizeSubseqInfo.8:                        ; preds = %ctrl1
  call void @FinalizeSubseqInfo.8(i32 %currLayer)
  ret void

func_FinalizeSubseqInfo.22:                       ; preds = %ctrl1
  call void @FinalizeSubseqInfo.22(i32 %currLayer)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_FinalizeSubseqInfo.6, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_FinalizeSubseqInfo.8, label %func_FinalizeSubseqInfo.22
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FinalizeSubseqLayerInfo.7, label %func_FinalizeSubseqLayerInfo.33

func_FinalizeSubseqLayerInfo.7:                   ; preds = %rand_bb
  call void @FinalizeSubseqLayerInfo.7()
  ret void

func_FinalizeSubseqLayerInfo.33:                  ; preds = %rand_bb
  call void @FinalizeSubseqLayerInfo.33()
  ret void
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FinalizeSubseqChar.1, label %ctrl0

func_FinalizeSubseqChar.1:                        ; preds = %rand_bb
  call void @FinalizeSubseqChar.1()
  ret void

func_FinalizeSubseqChar.48:                       ; preds = %ctrl0
  call void @FinalizeSubseqChar.48()
  ret void

func_FinalizeSubseqChar.49:                       ; preds = %ctrl1
  call void @FinalizeSubseqChar.49()
  ret void

func_FinalizeSubseqChar.50:                       ; preds = %ctrl1
  call void @FinalizeSubseqChar.50()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_FinalizeSubseqChar.48, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_FinalizeSubseqChar.49, label %func_FinalizeSubseqChar.50
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FinalizeSceneInformation.18, label %func_FinalizeSceneInformation.26

func_FinalizeSceneInformation.18:                 ; preds = %rand_bb
  call void @FinalizeSceneInformation.18()
  ret void

func_FinalizeSceneInformation.26:                 ; preds = %rand_bb
  call void @FinalizeSceneInformation.26()
  ret void
}
...
func_UpdateSceneInformation.45:                   ; preds = %ctrl0
  call void @UpdateSceneInformation.45(i32 %HasSceneInformation, i32 %sceneID, i32 %sceneTransType, i32 %secondSceneID)
  ret void
...
func_UpdateSceneInformation.51:                   ; preds = %ctrl1
  call void @UpdateSceneInformation.51(i32 %HasSceneInformation, i32 %sceneID, i32 %sceneTransType, i32 %secondSceneID)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_UpdateSceneInformation.45, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_UpdateSceneInformation.46, label %func_UpdateSceneInformation.51
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FinalizePanScanRectInfo.10, label %func_FinalizePanScanRectInfo.17

func_FinalizePanScanRectInfo.10:                  ; preds = %rand_bb
  call void @FinalizePanScanRectInfo.10()
  ret void

func_FinalizePanScanRectInfo.17:                  ; preds = %rand_bb
  call void @FinalizePanScanRectInfo.17()
  ret void
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_UpdateUser_data_unregistered.24, label %ctrl0

func_UpdateUser_data_unregistered.24:             ; preds = %rand_bb
  call void @UpdateUser_data_unregistered.24()
  ret void

func_UpdateUser_data_unregistered.34:             ; preds = %ctrl0
  call void @UpdateUser_data_unregistered.34()
  ret void

func_UpdateUser_data_unregistered.35:             ; preds = %ctrl1
  call void @UpdateUser_data_unregistered.35()
  ret void

func_UpdateUser_data_unregistered.41:             ; preds = %ctrl1
  call void @UpdateUser_data_unregistered.41()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_UpdateUser_data_unregistered.34, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_UpdateUser_data_unregistered.35, label %func_UpdateUser_data_unregistered.41
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FinalizeUser_data_unregistered.2, label %ctrl0

func_FinalizeUser_data_unregistered.2:            ; preds = %rand_bb
  call void @FinalizeUser_data_unregistered.2()
  ret void

func_FinalizeUser_data_unregistered.15:           ; preds = %ctrl0
  call void @FinalizeUser_data_unregistered.15()
  ret void

func_FinalizeUser_data_unregistered.16:           ; preds = %ctrl1
  call void @FinalizeUser_data_unregistered.16()
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_FinalizeUser_data_unregistered.15, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_FinalizeUser_data_unregistered.16, label %func_FinalizeUser_data_unregistered.31
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_UpdateUser_data_registered_itu_t_t35.3, label %ctrl0

func_UpdateUser_data_registered_itu_t_t35.3:      ; preds = %rand_bb
  call void @UpdateUser_data_registered_itu_t_t35.3()
  ret void

func_UpdateUser_data_registered_itu_t_t35.12:     ; preds = %ctrl0
  call void @UpdateUser_data_registered_itu_t_t35.12()
  ret void

func_UpdateUser_data_registered_itu_t_t35.23:     ; preds = %ctrl1
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_UpdateUser_data_registered_itu_t_t35.12, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_UpdateUser_data_registered_itu_t_t35.23, label %func_UpdateUser_data_registered_itu_t_t35.29
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FinalizeUser_data_registered_itu_t_t35.9, label %ctrl0

func_FinalizeUser_data_registered_itu_t_t35.9:    ; preds = %rand_bb
  call void @FinalizeUser_data_registered_itu_t_t35.9()
  ret void

func_FinalizeUser_data_registered_itu_t_t35.11:   ; preds = %ctrl0
  call void @FinalizeUser_data_registered_itu_t_t35.11()
  ret void

func_FinalizeUser_data_registered_itu_t_t35.21:   ; preds = %ctrl1
  call void @FinalizeUser_data_registered_itu_t_t35.21()
  ret void

func_FinalizeUser_data_registered_itu_t_t35.43:   ; preds = %ctrl1
  call void @FinalizeUser_data_registered_itu_t_t35.43()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_FinalizeUser_data_registered_itu_t_t35.11, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_FinalizeUser_data_registered_itu_t_t35.21, label %func_FinalizeUser_data_registered_itu_t_t35.43
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FinalizeRandomAccess.13, label %func_FinalizeRandomAccess.25

func_FinalizeRandomAccess.13:                     ; preds = %rand_bb
  call void @FinalizeRandomAccess.13()
  ret void

func_FinalizeRandomAccess.25:                     ; preds = %rand_bb
  call void @FinalizeRandomAccess.25()
  ret void
}
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSubseqChar.1() #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 236600875, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeUser_data_unregistered.2() #0 {
entry:
  %dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 1921434419, i32* %canary
  %i = alloca i32, align 4
  %sym = alloca %struct.syntaxelement, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_unregistered_information_struct, %struct.user_data_unregistered_information_struct* @seiUser_data_unregistered, i32 0, i32 2), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateUser_data_registered_itu_t_t35.3() #0 {
entry:
  %total_byte = alloca i32, align 4
  %i = alloca i32, align 4
  %temp_data = alloca i32, align 4
  %canary = alloca i32
  store i32 33540925, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @finalize_sei_message.4(i32 %id) #0 {
entry:
  %canary = alloca i32
  store i32 1338020571, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSubseqInfo.5(i32 %currLayer) #0 {
entry:
  %sym = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 1990582138, i32* %canary
  %currLayer.addr = alloca i32, align 4
  %dest = alloca %struct.Bitstream*, align 8
  store i32 %currLayer, i32* %currLayer.addr, align 4
  %0 = load i32, i32* %currLayer.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSubseqInfo.6(i32 %currLayer) #0 {
entry:
  %currLayer.addr = alloca i32, align 4
  %sym = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 949495165, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  store i32 %currLayer, i32* %currLayer.addr, align 4
  %0 = load i32, i32* %currLayer.addr, align 4
  %idxprom = sext i32 %0 to i64
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSubseqLayerInfo.7() #0 {
entry:
  %canary = alloca i32
  store i32 1169842828, i32* %canary
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSubseqInfo.8(i32 %currLayer) #0 {
entry:
  %canary = alloca i32
  store i32 1515960496, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  %currLayer.addr = alloca i32, align 4
  %sym = alloca %struct.syntaxelement, align 8
  store i32 %currLayer, i32* %currLayer.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeUser_data_registered_itu_t_t35.9() #0 {
entry:
  %dest = alloca %struct.Bitstream*, align 8
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1905460386, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_registered_itu_t_t35_information_struct, %struct.user_data_registered_itu_t_t35_information_struct* @seiUser_data_registered_itu_t_t35, i32 0, i32 4), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
  %type = getelementptr inbounds %struct.syntaxelement, %struct.syntaxelement* %sym, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizePanScanRectInfo.10() #0 {
entry:
  %sym = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 1259534602, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.panscanrect_information_struct, %struct.panscanrect_information_struct* @seiPanScanRectInfo, i32 0, i32 5), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
  %type = getelementptr inbounds %struct.syntaxelement, %struct.syntaxelement* %sym, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeUser_data_registered_itu_t_t35.11() #0 {
entry:
  %canary = alloca i32
  store i32 1228681823, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %i = alloca i32, align 4
  %dest = alloca %struct.Bitstream*, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_registered_itu_t_t35_information_struct, %struct.user_data_registered_itu_t_t35_information_struct* @seiUser_data_registered_itu_t_t35, i32 0, i32 4), align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateUser_data_registered_itu_t_t35.12() #0 {
entry:
  %canary = alloca i32
  store i32 1434655256, i32* %canary
  %total_byte = alloca i32, align 4
  %i = alloca i32, align 4
  %country_code = alloca i32, align 4
  %temp_data = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeRandomAccess.13() #0 {
entry:
  %sym = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 501607630, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.randomaccess_information_struct, %struct.randomaccess_information_struct* @seiRandomAccess, i32 0, i32 3), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
  %type = getelementptr inbounds %struct.syntaxelement, %struct.syntaxelement* %sym, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @CompressSpareMBMap.14(i8** %map_sp, %struct.Bitstream* %bitstream) #0 {
entry:
  %canary = alloca i32
  store i32 725267911, i32* %canary
...
entry:
  %dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 287563348, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %i = alloca i32, align 4
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_unregistered_information_struct, %struct.user_data_unregistered_information_struct* @seiUser_data_unregistered, i32 0, i32 2), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeUser_data_unregistered.16() #0 {
entry:
  %i = alloca i32, align 4
  %sym = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 1218882068, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_unregistered_information_struct, %struct.user_data_unregistered_information_struct* @seiUser_data_unregistered, i32 0, i32 2), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
  %type = getelementptr inbounds %struct.syntaxelement, %struct.syntaxelement* %sym, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizePanScanRectInfo.17() #0 {
entry:
  %canary = alloca i32
  store i32 254776410, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  %sym = alloca %struct.syntaxelement, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.panscanrect_information_struct, %struct.panscanrect_information_struct* @seiPanScanRectInfo, i32 0, i32 5), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSceneInformation.18() #0 {
entry:
  %dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 231875915, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.scene_information_struct, %struct.scene_information_struct* @seiSceneInformation, i32 0, i32 3), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
  %type = getelementptr inbounds %struct.syntaxelement, %struct.syntaxelement* %sym, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_sei_message.19(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type) #0 {
entry:
  %payload.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 2127771182, i32* %canary
  %id.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @AppendTmpbits2Buf.20(%struct.Bitstream* %dest, %struct.Bitstream* %source) #0 {
entry:
  %canary = alloca i32
  store i32 231103648, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeUser_data_registered_itu_t_t35.21() #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 921387287, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  %sym = alloca %struct.syntaxelement, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_registered_itu_t_t35_information_struct, %struct.user_data_registered_itu_t_t35_information_struct* @seiUser_data_registered_itu_t_t35, i32 0, i32 4), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSubseqInfo.22(i32 %currLayer) #0 {
entry:
  %dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 558102574, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %currLayer.addr = alloca i32, align 4
  store i32 %currLayer, i32* %currLayer.addr, align 4
  %0 = load i32, i32* %currLayer.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 1221066788, i32* %canary
  %country_code = alloca i32, align 4
  %temp_data = alloca i32, align 4
  %i = alloca i32, align 4
  %total_byte = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateUser_data_unregistered.24() #0 {
entry:
  %temp_data = alloca i32, align 4
  %canary = alloca i32
  store i32 1950301949, i32* %canary
  %total_byte = alloca i32, align 4
  %i = alloca i32, align 4
  store i32 7, i32* %total_byte, align 4
  store i32 0, i32* %i, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeRandomAccess.25() #0 {
entry:
  %canary = alloca i32
  store i32 1907088268, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  %sym = alloca %struct.syntaxelement, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.randomaccess_information_struct, %struct.randomaccess_information_struct* @seiRandomAccess, i32 0, i32 3), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSceneInformation.26() #0 {
entry:
  %canary = alloca i32
  store i32 498124747, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %dest = alloca %struct.Bitstream*, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.scene_information_struct, %struct.scene_information_struct* @seiSceneInformation, i32 0, i32 3), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
...
entry:
  %canary = alloca i32
  store i32 1573794385, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSpareMBMap.28() #0 {
entry:
  %sym = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 743878843, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  %CurrFrameNum = alloca i32, align 4
  %source = alloca %struct.Bitstream*, align 8
  %delta_frame_num = alloca i32, align 4
...
entry:
  ...
  %total_byte = alloca i32, align 4
  %canary = alloca i32
  store i32 1906167498, i32* %canary
  %country_code = alloca i32, align 4
  store i32 82, i32* %country_code, align 4
  %0 = load i32, i32* %country_code, align 4
  %cmp = icmp slt i32 %0, 255
...
entry:
  %map_sp.addr = alloca i8**, align 8
  %canary = alloca i32
  store i32 1994730534, i32* %canary
  %directx = alloca i32, align 4
  %top = alloca i32, align 4
  %size_compressed = alloca i32, align 4
  %noc = alloca i32, align 4
...
if.end190:                                        ; preds = %for.end189, %if.end141
  %121 = load i32, i32* %ret, align 4
  %122 = load i32, i32* %canary
  %123 = icmp eq i32 %122, 1994730534
  br i1 %123, label %124, label %func_exit
...
entry:
  %sym = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 2046134285, i32* %canary
  %i = alloca i32, align 4
  %dest = alloca %struct.Bitstream*, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_unregistered_information_struct, %struct.user_data_unregistered_information_struct* @seiUser_data_unregistered, i32 0, i32 2), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @finalize_sei_message.32(i32 %id) #0 {
entry:
  %canary = alloca i32
  store i32 1961752166, i32* %canary
  %id.addr = alloca i32, align 4
  %offset = alloca i32, align 4
  store i32 %id, i32* %id.addr, align 4
  %0 = load i32, i32* %id.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSubseqLayerInfo.33() #0 {
entry:
  %pos = alloca i32, align 4
  %canary = alloca i32
  store i32 372181438, i32* %canary
  %i = alloca i32, align 4
  store i32 0, i32* %pos, align 4
  store i32 0, i32* getelementptr inbounds (%struct.subseq_layer_information_struct, %struct.subseq_layer_information_struct* @seiSubseqLayerInfo, i32 0, i32 4), align 4
  store i32 0, i32* %i, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateUser_data_unregistered.34() #0 {
entry:
  %i = alloca i32, align 4
  %total_byte = alloca i32, align 4
  %canary = alloca i32
  store i32 1331046841, i32* %canary
  %temp_data = alloca i32, align 4
  store i32 7, i32* %total_byte, align 4
  store i32 0, i32* %i, align 4
  br label %for.cond
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1284821844, i32* %canary
  %total_byte = alloca i32, align 4
  store i32 7, i32* %total_byte, align 4
  store i32 0, i32* %i, align 4
  br label %for.cond
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @ComposeSparePictureMessage.36(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream) #0 {
entry:
  %sym = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 1743003378, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1456772770, i32* %canary
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 828992491, i32* %canary
  %dest.addr = alloca %struct.Bitstream*, align 8
  %mask = alloca i8, align 1
  %bits_in_last_byte = alloca i32, align 4
  store %struct.Bitstream* %dest, %struct.Bitstream** %dest.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 373097368, i32* %canary
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %mask = alloca i8, align 1
  %dest.addr = alloca %struct.Bitstream*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @AppendTmpbits2Buf.40(%struct.Bitstream* %dest, %struct.Bitstream* %source) #0 {
entry:
  %dest.addr = alloca %struct.Bitstream*, align 8
  %bits_in_last_byte = alloca i32, align 4
  %j = alloca i32, align 4
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1191210294, i32* %canary
  %source.addr = alloca %struct.Bitstream*, align 8
  %mask = alloca i8, align 1
  store %struct.Bitstream* %dest, %struct.Bitstream** %dest.addr, align 8
  store %struct.Bitstream* %source, %struct.Bitstream** %source.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateUser_data_unregistered.41() #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 583936097, i32* %canary
  %temp_data = alloca i32, align 4
  %total_byte = alloca i32, align 4
  store i32 7, i32* %total_byte, align 4
  store i32 0, i32* %i, align 4
...
entry:
  ...
  %payload_type.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1574023477, i32* %canary
  %id.addr = alloca i32, align 4
  %payload.addr = alloca i8*, align 8
  %payload_size.addr = alloca i32, align 4
  %type = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeUser_data_registered_itu_t_t35.43() #0 {
entry:
  %dest = alloca %struct.Bitstream*, align 8
  %sym = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 433006930, i32* %canary
  %i = alloca i32, align 4
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_registered_itu_t_t35_information_struct, %struct.user_data_registered_itu_t_t35_information_struct* @seiUser_data_registered_itu_t_t35, i32 0, i32 4), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
  %type = getelementptr inbounds %struct.syntaxelement, %struct.syntaxelement* %sym, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSpareMBMap.44() #0 {
entry:
  %source = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 1628085223, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  %sym = alloca %struct.syntaxelement, align 8
  %CurrFrameNum = alloca i32, align 4
  %delta_frame_num = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateSceneInformation.45(i32 %HasSceneInformation, i32 %sceneID, i32 %sceneTransType, i32 %secondSceneID) #0 {
entry:
  %HasSceneInformation.addr = alloca i32, align 4
  %sceneTransType.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 884291616, i32* %canary
  %secondSceneID.addr = alloca i32, align 4
  %sceneID.addr = alloca i32, align 4
  store i32 %HasSceneInformation, i32* %HasSceneInformation.addr, align 4
  store i32 %sceneID, i32* %sceneID.addr, align 4
...
entry:
  ...
  %HasSceneInformation.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1532387183, i32* %canary
  %secondSceneID.addr = alloca i32, align 4
  %sceneID.addr = alloca i32, align 4
  store i32 %HasSceneInformation, i32* %HasSceneInformation.addr, align 4
  store i32 %sceneID, i32* %sceneID.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSpareMBMap.47() #0 {
entry:
  %CurrFrameNum = alloca i32, align 4
  %delta_frame_num = alloca i32, align 4
  %canary = alloca i32
  store i32 1563973196, i32* %canary
  %source = alloca %struct.Bitstream*, align 8
  %sym = alloca %struct.syntaxelement, align 8
  %dest = alloca %struct.Bitstream*, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSubseqChar.48() #0 {
entry:
  %dest = alloca %struct.Bitstream*, align 8
  %sym = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 1469861127, i32* %canary
  %i = alloca i32, align 4
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.subseq_char_information_struct, %struct.subseq_char_information_struct* @seiSubseqChar, i32 0, i32 10), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
  %type = getelementptr inbounds %struct.syntaxelement, %struct.syntaxelement* %sym, i32 0, i32 0
...
entry:
  %canary = alloca i32
  store i32 1799685364, i32* %canary
  %i = alloca i32, align 4
  %dest = alloca %struct.Bitstream*, align 8
  %sym = alloca %struct.syntaxelement, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.subseq_char_information_struct, %struct.subseq_char_information_struct* @seiSubseqChar, i32 0, i32 10), align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSubseqChar.50() #0 {
entry:
  %sym = alloca %struct.syntaxelement, align 8
  %dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 559072330, i32* %canary
  %i = alloca i32, align 4
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.subseq_char_information_struct, %struct.subseq_char_information_struct* @seiSubseqChar, i32 0, i32 10), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
  %type = getelementptr inbounds %struct.syntaxelement, %struct.syntaxelement* %sym, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateSceneInformation.51(i32 %HasSceneInformation, i32 %sceneID, i32 %sceneTransType, i32 %secondSceneID) #0 {
entry:
  %sceneID.addr = alloca i32, align 4
  %sceneTransType.addr = alloca i32, align 4
  %HasSceneInformation.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 963810869, i32* %canary
  %secondSceneID.addr = alloca i32, align 4
  store i32 %HasSceneInformation, i32* %HasSceneInformation.addr, align 4
  store i32 %sceneID, i32* %sceneID.addr, align 4
  store i32 %sceneTransType, i32* %sceneTransType.addr, align 4
...
entry:
  %payload_type.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 606149589, i32* %canary
  %payload.addr = alloca i8*, align 8
  %id.addr = alloca i32, align 4
  %type = alloca i32, align 4
  %size = alloca i32, align 4
...
entry:
  %bitstream = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 432266525, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %ref_area_indicator.addr = alloca i32, align 4
  %tmpBitstream.addr = alloca %struct.Bitstream*, align 8
  %delta_spare_frame_num.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @ComposeSparePictureMessage.54(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream) #0 {
entry:
  %delta_spare_frame_num.addr = alloca i32, align 4
  %sym = alloca %struct.syntaxelement, align 8
  %bitstream = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 23036725, i32* %canary
  %ref_area_indicator.addr = alloca i32, align 4
  %tmpBitstream.addr = alloca %struct.Bitstream*, align 8
  store i32 %delta_spare_frame_num, i32* %delta_spare_frame_num.addr, align 4
  store i32 %ref_area_indicator, i32* %ref_area_indicator.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 1216030562, i32* %canary
  %id.addr = alloca i32, align 4
  %payload.addr = alloca i8*, align 8
  %size = alloca i32, align 4
  %payload_type.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @ComposeSparePictureMessage.57(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream) #0 {
entry:
  %bitstream = alloca %struct.Bitstream*, align 8
  %sym = alloca %struct.syntaxelement, align 8
  %delta_spare_frame_num.addr = alloca i32, align 4
  %tmpBitstream.addr = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 1395747598, i32* %canary
  %ref_area_indicator.addr = alloca i32, align 4
  store i32 %delta_spare_frame_num, i32* %delta_spare_frame_num.addr, align 4
  store i32 %ref_area_indicator, i32* %ref_area_indicator.addr, align 4
  store %struct.Bitstream* %tmpBitstream, %struct.Bitstream** %tmpBitstream.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @CompressSpareMBMap.58(i8** %map_sp, %struct.Bitstream* %bitstream) #0 {
entry:
  %bottom = alloca i32, align 4
  %bitstream.addr = alloca %struct.Bitstream*, align 8
  %size_uncompressed = alloca i32, align 4
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1126995381, i32* %canary
  %top = alloca i32, align 4
  %right = alloca i32, align 4
  %noc = alloca i32, align 4
  %bit1 = alloca i32, align 4
...
if.end190:                                        ; preds = %for.end189, %if.end141
  %121 = load i32, i32* %ret, align 4
  %122 = load i32, i32* %canary
  %123 = icmp eq i32 %122, 1126995381
  br i1 %123, label %124, label %func_exit
