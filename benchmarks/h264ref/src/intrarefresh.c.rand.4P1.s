...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$1441479185, -24(%rbp)  # imm = 0x55EB3A11
	movl	%edi, -20(%rbp)
	movl	$0, -12(%rbp)
.LBB4_1:                                # %for.cond
...
.LBB4_7:                                # %return
	movl	-16(%rbp), %ebx
	cmpl	$1441479185, -24(%rbp)  # imm = 0x55EB3A11
	jne	.LBB4_9
.LBB4_8:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$606731207, -20(%rbp)   # imm = 0x2429FBC7
	movl	%edi, -24(%rbp)
	movl	$0, -12(%rbp)
.LBB5_1:                                # %for.cond
                                        # =>This Inner Loop Header: Depth=1
...
.LBB5_7:                                # %return
	movl	-16(%rbp), %ebx
	cmpl	$606731207, -20(%rbp)   # imm = 0x2429FBC7
	jne	.LBB5_9
.LBB5_8:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1976034224, -24(%rbp)  # imm = 0x75C7E3B0
	movl	%edi, -20(%rbp)
	movl	%esi, -16(%rbp)
	movl	%edx, -8(%rbp)
	movl	$1, %edi
...
# %bb.14:                               # %for.inc23
	...
	jmp	.LBB6_9
.LBB6_15:                               # %for.end25
	cmpl	$1976034224, -24(%rbp)  # imm = 0x75C7E3B0
	jne	.LBB6_17
.LBB6_16:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$16, %rsp
	movl	$1238124390, -12(%rbp)  # imm = 0x49CC4766
...
# %bb.3:                                # %for.inc
	...
	jmp	.LBB7_1
.LBB7_4:                                # %for.end
	cmpl	$1238124390, -12(%rbp)  # imm = 0x49CC4766
	jne	.LBB7_6
.LBB7_5:
	addq	$16, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$16, %rsp
	movl	$664332178, -12(%rbp)   # imm = 0x2798E792
	movl	NumberIntraPerPicture, %eax
	addl	WalkAround, %eax
	movl	%eax, WalkAround
	movl	$0, -4(%rbp)
...
# %bb.3:                                # %for.inc
	...
	jmp	.LBB8_1
.LBB8_4:                                # %for.end
	cmpl	$664332178, -12(%rbp)   # imm = 0x2798E792
	jne	.LBB8_6
.LBB8_5:
	addq	$16, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$2071258984, -24(%rbp)  # imm = 0x7B74E768
	movl	%edi, -20(%rbp)
	movl	$0, -12(%rbp)
.LBB9_1:                                # %for.cond
                                        # =>This Inner Loop Header: Depth=1
...
.LBB9_7:                                # %return
	movl	-16(%rbp), %ebx
	cmpl	$2071258984, -24(%rbp)  # imm = 0x7B74E768
	jne	.LBB9_9
.LBB9_8:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$415453695, -20(%rbp)   # imm = 0x18C351FF
	movl	%edi, -24(%rbp)
	movl	%esi, -16(%rbp)
	movl	%edx, -12(%rbp)
	movl	$1, %edi
...
# %bb.14:                               # %for.inc23
	...
	jmp	.LBB10_9
.LBB10_15:                              # %for.end25
	cmpl	$415453695, -20(%rbp)   # imm = 0x18C351FF
	jne	.LBB10_17
.LBB10_16:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1287944541, -24(%rbp)  # imm = 0x4CC4795D
	movl	%edi, -20(%rbp)
	movl	%esi, -16(%rbp)
	movl	%edx, -8(%rbp)
	movl	$1, %edi
...
# %bb.14:                               # %for.inc23
	...
	jmp	.LBB11_9
.LBB11_15:                              # %for.end25
	cmpl	$1287944541, -24(%rbp)  # imm = 0x4CC4795D
	jne	.LBB11_17
.LBB11_16:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$22750335, -24(%rbp)    # imm = 0x15B247F
	movl	%edi, -16(%rbp)
	movl	%esi, -20(%rbp)
	movl	%edx, -12(%rbp)
	movl	$1, %edi
...
# %bb.14:                               # %for.inc23
	...
	jmp	.LBB12_9
.LBB12_15:                              # %for.end25
	cmpl	$22750335, -24(%rbp)    # imm = 0x15B247F
	jne	.LBB12_17
.LBB12_16:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$749072368, -24(%rbp)   # imm = 0x2CA5EFF0
	movl	%edi, -20(%rbp)
	movl	$0, -12(%rbp)
.LBB13_1:                               # %for.cond
                                        # =>This Inner Loop Header: Depth=1
...
.LBB13_7:                               # %return
	movl	-16(%rbp), %ebx
	cmpl	$749072368, -24(%rbp)   # imm = 0x2CA5EFF0
	jne	.LBB13_9
.LBB13_8:
	movl	%ebx, %eax
	addq	$24, %rsp
