...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_WriteRTPPacket.1, label %ctrl0

func_WriteRTPPacket.1:                            ; preds = %rand_bb
  %2 = call i32 @WriteRTPPacket.1(%struct.RTPpacket_t* %p, %struct._IO_FILE* %f)
  ret i32 %2

func_WriteRTPPacket.2:                            ; preds = %ctrl0
  %3 = call i32 @WriteRTPPacket.2(%struct.RTPpacket_t* %p, %struct._IO_FILE* %f)
  ret i32 %3

func_WriteRTPPacket.6:                            ; preds = %ctrl1
  %4 = call i32 @WriteRTPPacket.6(%struct.RTPpacket_t* %p, %struct._IO_FILE* %f)
  ret i32 %4

func_WriteRTPPacket.7:                            ; preds = %ctrl2
  %5 = call i32 @WriteRTPPacket.7(%struct.RTPpacket_t* %p, %struct._IO_FILE* %f)
  ret i32 %5

func_WriteRTPPacket.8:                            ; preds = %ctrl3
  %6 = call i32 @WriteRTPPacket.8(%struct.RTPpacket_t* %p, %struct._IO_FILE* %f)
  ret i32 %6
...
func_WriteRTPPacket.12:                           ; preds = %ctrl6
  %9 = call i32 @WriteRTPPacket.12(%struct.RTPpacket_t* %p, %struct._IO_FILE* %f)
  ret i32 %9

func_WriteRTPPacket.13:                           ; preds = %ctrl7
  %10 = call i32 @WriteRTPPacket.13(%struct.RTPpacket_t* %p, %struct._IO_FILE* %f)
  ret i32 %10

func_WriteRTPPacket.14:                           ; preds = %ctrl8
  %11 = call i32 @WriteRTPPacket.14(%struct.RTPpacket_t* %p, %struct._IO_FILE* %f)
  ret i32 %11

func_WriteRTPPacket.15:                           ; preds = %ctrl9
  %12 = call i32 @WriteRTPPacket.15(%struct.RTPpacket_t* %p, %struct._IO_FILE* %f)
  ret i32 %12

func_WriteRTPPacket.16:                           ; preds = %ctrl10
  %13 = call i32 @WriteRTPPacket.16(%struct.RTPpacket_t* %p, %struct._IO_FILE* %f)
  ret i32 %13

func_WriteRTPPacket.17:                           ; preds = %ctrl11
  %14 = call i32 @WriteRTPPacket.17(%struct.RTPpacket_t* %p, %struct._IO_FILE* %f)
  ret i32 %14

func_WriteRTPPacket.18:                           ; preds = %ctrl12
  %15 = call i32 @WriteRTPPacket.18(%struct.RTPpacket_t* %p, %struct._IO_FILE* %f)
  ret i32 %15

func_WriteRTPPacket.19:                           ; preds = %ctrl13
  %16 = call i32 @WriteRTPPacket.19(%struct.RTPpacket_t* %p, %struct._IO_FILE* %f)
  ret i32 %16

func_WriteRTPPacket.20:                           ; preds = %ctrl13
  %17 = call i32 @WriteRTPPacket.20(%struct.RTPpacket_t* %p, %struct._IO_FILE* %f)
  ret i32 %17

ctrl0:                                            ; preds = %rand_bb
  %18 = icmp eq i32 %0, 1
  br i1 %18, label %func_WriteRTPPacket.2, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %19 = icmp eq i32 %0, 2
  br i1 %19, label %func_WriteRTPPacket.6, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %20 = icmp eq i32 %0, 3
  br i1 %20, label %func_WriteRTPPacket.7, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %21 = icmp eq i32 %0, 4
  br i1 %21, label %func_WriteRTPPacket.8, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %22 = icmp eq i32 %0, 5
  br i1 %22, label %func_WriteRTPPacket.10, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %23 = icmp eq i32 %0, 6
  br i1 %23, label %func_WriteRTPPacket.11, label %ctrl6

ctrl6:                                            ; preds = %ctrl5
  %24 = icmp eq i32 %0, 7
  br i1 %24, label %func_WriteRTPPacket.12, label %ctrl7

ctrl7:                                            ; preds = %ctrl6
  %25 = icmp eq i32 %0, 8
  br i1 %25, label %func_WriteRTPPacket.13, label %ctrl8

ctrl8:                                            ; preds = %ctrl7
  %26 = icmp eq i32 %0, 9
  br i1 %26, label %func_WriteRTPPacket.14, label %ctrl9

ctrl9:                                            ; preds = %ctrl8
  %27 = icmp eq i32 %0, 10
  br i1 %27, label %func_WriteRTPPacket.15, label %ctrl10

ctrl10:                                           ; preds = %ctrl9
  %28 = icmp eq i32 %0, 11
  br i1 %28, label %func_WriteRTPPacket.16, label %ctrl11

ctrl11:                                           ; preds = %ctrl10
  %29 = icmp eq i32 %0, 12
  br i1 %29, label %func_WriteRTPPacket.17, label %ctrl12

ctrl12:                                           ; preds = %ctrl11
  %30 = icmp eq i32 %0, 13
  br i1 %30, label %func_WriteRTPPacket.18, label %ctrl13

ctrl13:                                           ; preds = %ctrl12
  %31 = icmp eq i32 %0, 14
  br i1 %31, label %func_WriteRTPPacket.19, label %func_WriteRTPPacket.20
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_WriteRTPNALU.3, label %func_WriteRTPNALU.9

func_WriteRTPNALU.3:                              ; preds = %rand_bb
  %2 = call i32 @WriteRTPNALU.3(%struct.NALU_t* %n)
  ret i32 %2

func_WriteRTPNALU.9:                              ; preds = %rand_bb
  %3 = call i32 @WriteRTPNALU.9(%struct.NALU_t* %n)
  ret i32 %3
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_RTPUpdateTimestamp.4, label %func_RTPUpdateTimestamp.5

func_RTPUpdateTimestamp.4:                        ; preds = %rand_bb
  call void @RTPUpdateTimestamp.4(i32 %tr)
  ret void

func_RTPUpdateTimestamp.5:                        ; preds = %rand_bb
  call void @RTPUpdateTimestamp.5(i32 %tr)
  ret void
}
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @WriteRTPPacket.1(%struct.RTPpacket_t* %p, %struct._IO_FILE* %f) #0 {
entry:
  %f.addr = alloca %struct._IO_FILE*, align 8
  %p.addr = alloca %struct.RTPpacket_t*, align 8
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 507742644, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @WriteRTPPacket.2(%struct.RTPpacket_t* %p, %struct._IO_FILE* %f) #0 {
entry:
  %p.addr = alloca %struct.RTPpacket_t*, align 8
  %canary = alloca i32
  store i32 771312898, i32* %canary
  %f.addr = alloca %struct._IO_FILE*, align 8
  %intime = alloca i32, align 4
  %retval = alloca i32, align 4
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @WriteRTPNALU.3(%struct.NALU_t* %n) #0 {
entry:
  %p = alloca %struct.RTPpacket_t*, align 8
  %canary = alloca i32
  store i32 583013037, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1670606882, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @RTPUpdateTimestamp.5(i32 %tr) #0 {
entry:
  %canary = alloca i32
  store i32 1377455698, i32* %canary
  %delta = alloca i32, align 4
  %tr.addr = alloca i32, align 4
  store i32 %tr, i32* %tr.addr, align 4
  %0 = load i32, i32* @RTPUpdateTimestamp.oldtr, align 4
...
entry:
  ...
  %p.addr = alloca %struct.RTPpacket_t*, align 8
  %canary = alloca i32
  store i32 1412807185, i32* %canary
  %retval = alloca i32, align 4
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
  store i32 -1, i32* %intime, align 4
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1472875349, i32* %canary
  %p.addr = alloca %struct.RTPpacket_t*, align 8
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
  store i32 -1, i32* %intime, align 4
...
entry:
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 916485008, i32* %canary
  %intime = alloca i32, align 4
  %f.addr = alloca %struct._IO_FILE*, align 8
  %p.addr = alloca %struct.RTPpacket_t*, align 8
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @WriteRTPNALU.9(%struct.NALU_t* %n) #0 {
entry:
  %canary = alloca i32
  store i32 1776270324, i32* %canary
  %n.addr = alloca %struct.NALU_t*, align 8
  %p = alloca %struct.RTPpacket_t*, align 8
  store %struct.NALU_t* %n, %struct.NALU_t** %n.addr, align 8
  %0 = load %struct.NALU_t*, %struct.NALU_t** %n.addr, align 8
...
entry:
  ...
  %p.addr = alloca %struct.RTPpacket_t*, align 8
  %canary = alloca i32
  store i32 1390845284, i32* %canary
  %f.addr = alloca %struct._IO_FILE*, align 8
  %intime = alloca i32, align 4
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1215974019, i32* %canary
  %f.addr = alloca %struct._IO_FILE*, align 8
  %intime = alloca i32, align 4
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @WriteRTPPacket.13(%struct.RTPpacket_t* %p, %struct._IO_FILE* %f) #0 {
entry:
  %intime = alloca i32, align 4
  %p.addr = alloca %struct.RTPpacket_t*, align 8
  %f.addr = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 1007094304, i32* %canary
  %retval = alloca i32, align 4
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
  store i32 -1, i32* %intime, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @WriteRTPPacket.14(%struct.RTPpacket_t* %p, %struct._IO_FILE* %f) #0 {
entry:
  %f.addr = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 581000445, i32* %canary
  %retval = alloca i32, align 4
  %p.addr = alloca %struct.RTPpacket_t*, align 8
  %intime = alloca i32, align 4
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @WriteRTPPacket.15(%struct.RTPpacket_t* %p, %struct._IO_FILE* %f) #0 {
entry:
  %f.addr = alloca %struct._IO_FILE*, align 8
  %p.addr = alloca %struct.RTPpacket_t*, align 8
  %canary = alloca i32
  store i32 1320243714, i32* %canary
  %intime = alloca i32, align 4
  %retval = alloca i32, align 4
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @WriteRTPPacket.16(%struct.RTPpacket_t* %p, %struct._IO_FILE* %f) #0 {
entry:
  %canary = alloca i32
  store i32 1506213029, i32* %canary
  %p.addr = alloca %struct.RTPpacket_t*, align 8
  %f.addr = alloca %struct._IO_FILE*, align 8
  %retval = alloca i32, align 4
  %intime = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @WriteRTPPacket.17(%struct.RTPpacket_t* %p, %struct._IO_FILE* %f) #0 {
entry:
  %f.addr = alloca %struct._IO_FILE*, align 8
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 776474544, i32* %canary
  %intime = alloca i32, align 4
  %p.addr = alloca %struct.RTPpacket_t*, align 8
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @WriteRTPPacket.18(%struct.RTPpacket_t* %p, %struct._IO_FILE* %f) #0 {
entry:
  %p.addr = alloca %struct.RTPpacket_t*, align 8
  %retval = alloca i32, align 4
  %intime = alloca i32, align 4
  %canary = alloca i32
  store i32 791109042, i32* %canary
  %f.addr = alloca %struct._IO_FILE*, align 8
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
  store i32 -1, i32* %intime, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @WriteRTPPacket.19(%struct.RTPpacket_t* %p, %struct._IO_FILE* %f) #0 {
entry:
  %intime = alloca i32, align 4
  %retval = alloca i32, align 4
  %p.addr = alloca %struct.RTPpacket_t*, align 8
  %canary = alloca i32
  store i32 2135382878, i32* %canary
  %f.addr = alloca %struct._IO_FILE*, align 8
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
  store i32 -1, i32* %intime, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @WriteRTPPacket.20(%struct.RTPpacket_t* %p, %struct._IO_FILE* %f) #0 {
entry:
  %canary = alloca i32
  store i32 1927024545, i32* %canary
  %retval = alloca i32, align 4
  %intime = alloca i32, align 4
  %p.addr = alloca %struct.RTPpacket_t*, align 8
  %f.addr = alloca %struct._IO_FILE*, align 8
