; ModuleID = 'intrarefresh.c.rand.4P3.bc'
...
func_RandomIntra.3:                               ; preds = %ctrl1
  %4 = call i32 @RandomIntra.3(i32 %mb)
  ret i32 %4

func_RandomIntra.5:                               ; preds = %ctrl1
  %5 = call i32 @RandomIntra.5(i32 %mb)
  ret i32 %5
...
ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_RandomIntra.3, label %func_RandomIntra.5
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_RandomIntraNewPicture.6, label %func_RandomIntraNewPicture.7

func_RandomIntraNewPicture.6:                     ; preds = %rand_bb
  call void @RandomIntraNewPicture.6()
  ret void

func_RandomIntraNewPicture.7:                     ; preds = %rand_bb
  call void @RandomIntraNewPicture.7()
  ret void
}
...
entry:
  %canary = alloca i32
  store i32 1645684392, i32* %canary
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1010193678, i32* %canary
  %mb.addr = alloca i32, align 4
  store i32 %mb, i32* %mb.addr, align 4
  store i32 0, i32* %i, align 4
  br label %for.cond
...
entry:
  %canary = alloca i32
  store i32 645195902, i32* %canary
  %retval = alloca i32, align 4
  %mb.addr = alloca i32, align 4
  %i = alloca i32, align 4
  store i32 %mb, i32* %mb.addr, align 4
...
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 221671948, i32* %canary
...
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1651360987, i32* %canary
  %retval = alloca i32, align 4
  %mb.addr = alloca i32, align 4
  store i32 %mb, i32* %mb.addr, align 4
  store i32 0, i32* %i, align 4
...
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1841537955, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @RandomIntraNewPicture.7() #0 {
entry:
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 617510643, i32* %canary
  %i = alloca i32, align 4
  %0 = load i32, i32* @NumberIntraPerPicture, align 4
  %1 = load i32, i32* @WalkAround, align 4
  %add = add nsw i32 %1, %0
...
entry:
  %refresh.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1886980873, i32* %canary
  %ysize.addr = alloca i32, align 4
  %xsize.addr = alloca i32, align 4
  %pos = alloca i32, align 4
  %i = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1315319464, i32* %canary
  %i = alloca i32, align 4
  %xsize.addr = alloca i32, align 4
  %pos = alloca i32, align 4
  %ysize.addr = alloca i32, align 4
...
entry:
  ...
  %refresh.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 448315146, i32* %canary
  %i = alloca i32, align 4
  %pos = alloca i32, align 4
  store i32 %xsize, i32* %xsize.addr, align 4
  store i32 %ysize, i32* %ysize.addr, align 4
