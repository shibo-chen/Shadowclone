; ModuleID = 'leaky_bucket.c.rand.8P1.bc'
...
func_get_LeakyBucketRate.7:                       ; preds = %ctrl0
  %3 = call i32 @get_LeakyBucketRate.7(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret i32 %3

func_get_LeakyBucketRate.21:                      ; preds = %ctrl1
  %4 = call i32 @get_LeakyBucketRate.21(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret i32 %4

func_get_LeakyBucketRate.22:                      ; preds = %ctrl2
  %5 = call i32 @get_LeakyBucketRate.22(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret i32 %5

func_get_LeakyBucketRate.24:                      ; preds = %ctrl3
  %6 = call i32 @get_LeakyBucketRate.24(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret i32 %6

func_get_LeakyBucketRate.25:                      ; preds = %ctrl4
  %7 = call i32 @get_LeakyBucketRate.25(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret i32 %7
...
func_get_LeakyBucketRate.31:                      ; preds = %ctrl5
  %9 = call i32 @get_LeakyBucketRate.31(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret i32 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_get_LeakyBucketRate.7, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_get_LeakyBucketRate.21, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_get_LeakyBucketRate.22, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_get_LeakyBucketRate.24, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_get_LeakyBucketRate.25, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_get_LeakyBucketRate.30, label %func_get_LeakyBucketRate.31
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_PutBigDoubleWord.3, label %func_PutBigDoubleWord.12

func_PutBigDoubleWord.3:                          ; preds = %rand_bb
  call void @PutBigDoubleWord.3(i64 %dw, %struct._IO_FILE* %fp)
  ret void

func_PutBigDoubleWord.12:                         ; preds = %rand_bb
  call void @PutBigDoubleWord.12(i64 %dw, %struct._IO_FILE* %fp)
  ret void
}
...
func_write_buffer.4:                              ; preds = %ctrl0
...
ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_write_buffer.19, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_write_buffer.26, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_write_buffer.32, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_write_buffer.33, label %func_write_buffer.34
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_Sort.15, label %ctrl0

func_Sort.15:                                     ; preds = %rand_bb
  call void @Sort.15(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret void

func_Sort.17:                                     ; preds = %ctrl0
  call void @Sort.17(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret void

func_Sort.18:                                     ; preds = %ctrl1
...
func_Sort.29:                                     ; preds = %ctrl5
  call void @Sort.29(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_Sort.17, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_Sort.18, label %ctrl2
...
ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_Sort.23, label %ctrl4
...
ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_Sort.28, label %func_Sort.29
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_calc_buffer.5, label %ctrl0

func_calc_buffer.5:                               ; preds = %rand_bb
  call void @calc_buffer.5()
  ret void

func_calc_buffer.6:                               ; preds = %ctrl0
  call void @calc_buffer.6()
  ret void

func_calc_buffer.9:                               ; preds = %ctrl1
...
func_calc_buffer.11:                              ; preds = %ctrl3
  call void @calc_buffer.11()
  ret void

func_calc_buffer.13:                              ; preds = %ctrl4
  call void @calc_buffer.13()
  ret void

func_calc_buffer.14:                              ; preds = %ctrl5
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_calc_buffer.6, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_calc_buffer.9, label %ctrl2
...
ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_calc_buffer.11, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_calc_buffer.13, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_calc_buffer.14, label %func_calc_buffer.16
}
...
entry:
  ...
  %canary = alloca i32
  store i32 1002416491, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 143182436, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1782677927, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1645466878, i32* %canary
...
for.end136:                                       ; preds = %for.cond57
  ...
  %150 = icmp eq i32 %149, 1645466878
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @calc_buffer.6() #0 {
entry:
  %minB = alloca i64, align 8
  %Fmin = alloca i64*, align 8
  %iChannelRate = alloca i64, align 8
  ...
  %Bmin = alloca i64*, align 8
  %canary = alloca i32
  store i32 1698963993, i32* %canary
  %Rmin = alloca i64*, align 8
  %iFrame = alloca i64, align 8
  store i64 0, i64* %FrameIndex, align 8
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8
...
for.end136:                                       ; preds = %for.cond57
  ...
  call void @free(i8* %148) #3
  %149 = load i32, i32* %canary
  %150 = icmp eq i32 %149, 1698963993
  br i1 %150, label %151, label %func_exit
...
entry:
  ...
  %i = alloca i64, align 8
  %canary = alloca i32
  store i32 1718262910, i32* %canary
  %retval = alloca i32, align 4
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
entry:
  ...
  %Rmin.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 1730734979, i32* %canary
  %iBucket = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
  store i64* %Bmin, i64** %Bmin.addr, align 8
...
entry:
  %Rmin = alloca i64*, align 8
  %canary = alloca i32
  store i32 1295677519, i32* %canary
  %NumberLeakyBuckets = alloca i64, align 8
  %Bmin = alloca i64*, align 8
  %minB = alloca i64, align 8
  %buffer_frame = alloca i64*, align 8
...
for.end136:                                       ; preds = %for.cond57
  ...
  call void @free(i8* %148) #3
  %149 = load i32, i32* %canary
  %150 = icmp eq i32 %149, 1295677519
  br i1 %150, label %151, label %func_exit
...
entry:
  ...
  %buffer_frame = alloca i64*, align 8
  %canary = alloca i32
  store i32 2044686764, i32* %canary
  %InitFullness = alloca i64, align 8
  %TotalRate = alloca i64, align 8
  %FrameIndex = alloca i64, align 8
  %Rmin = alloca i64*, align 8
...
for.end136:                                       ; preds = %for.cond57
  ...
  call void @free(i8* %148) #3
  %149 = load i32, i32* %canary
  %150 = icmp eq i32 %149, 2044686764
  br i1 %150, label %151, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @calc_buffer.11() #0 {
entry:
  %TotalRate = alloca i64, align 8
  %NumberLeakyBuckets = alloca i64, align 8
  %FrameIndex = alloca i64, align 8
  ...
  %iBucket = alloca i64, align 8
  %canary = alloca i32
  store i32 293489612, i32* %canary
  %Bmin = alloca i64*, align 8
  %iChannelRate = alloca i64, align 8
  %Rmin = alloca i64*, align 8
  %buffer_frame = alloca i64*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @PutBigDoubleWord.12(i64 %dw, %struct._IO_FILE* %fp) #0 {
entry:
  %fp.addr = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 162707374, i32* %canary
  %dw.addr = alloca i64, align 8
  store i64 %dw, i64* %dw.addr, align 8
  store %struct._IO_FILE* %fp, %struct._IO_FILE** %fp.addr, align 8
  %0 = load i64, i64* %dw.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @calc_buffer.13() #0 {
entry:
  %canary = alloca i32
  store i32 248589880, i32* %canary
  %buffer_frame = alloca i64*, align 8
  %Rmin = alloca i64*, align 8
  %iFrame = alloca i64, align 8
  %minB = alloca i64, align 8
...
entry:
  ...
  %maxBuffer = alloca i64, align 8
  %canary = alloca i32
  store i32 1085860934, i32* %canary
  %iFrame = alloca i64, align 8
  %actualBuffer = alloca i64, align 8
  %minB = alloca i64, align 8
  store i64 0, i64* %FrameIndex, align 8
...
for.end136:                                       ; preds = %for.cond57
  ...
  call void @free(i8* %148) #3
  %149 = load i32, i32* %canary
  %150 = icmp eq i32 %149, 1085860934
  br i1 %150, label %151, label %func_exit
...
entry:
  %Rmin.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 1183715474, i32* %canary
...
entry:
  ...
  %iFrame = alloca i64, align 8
  %canary = alloca i32
  store i32 2090586462, i32* %canary
  %buffer_frame = alloca i64*, align 8
  %maxBuffer = alloca i64, align 8
  %actualBuffer = alloca i64, align 8
  %iBucket = alloca i64, align 8
...
for.end136:                                       ; preds = %for.cond57
  ...
  call void @free(i8* %148) #3
  %149 = load i32, i32* %canary
  %150 = icmp eq i32 %149, 2090586462
  br i1 %150, label %151, label %func_exit
...
entry:
  ...
  %temp = alloca i64, align 8
  %canary = alloca i32
  store i32 148065289, i32* %canary
  %NumberLeakyBuckets.addr = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
  store i64 0, i64* %i, align 8
...
entry:
  ...
  %Rmin.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 947886260, i32* %canary
  %j = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
  store i64 0, i64* %i, align 8
...
entry:
  %canary = alloca i32
  store i32 1437252730, i32* %canary
  %iBucket = alloca i64, align 8
  %Bmin.addr = alloca i64*, align 8
  %Fmin.addr = alloca i64*, align 8
  %outf = alloca %struct._IO_FILE*, align 8
...
entry:
  %j = alloca i64, align 8
  %canary = alloca i32
  store i32 1969282848, i32* %canary
  %Rmin.addr = alloca i64*, align 8
  %i = alloca i64, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %temp = alloca i64, align 8
...
entry:
  ...
  %i = alloca i64, align 8
  %canary = alloca i32
  store i32 811417677, i32* %canary
  %retval = alloca i32, align 4
  %Rmin.addr = alloca i64*, align 8
  %f = alloca %struct._IO_FILE*, align 8
  %buf = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_LeakyBucketRate.22(i64 %NumberLeakyBuckets, i64* %Rmin) #0 {
entry:
  %canary = alloca i32
  store i32 1404970415, i32* %canary
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %f = alloca %struct._IO_FILE*, align 8
  %buf = alloca i64, align 8
  %i = alloca i64, align 8
...
entry:
  ...
  %j = alloca i64, align 8
  %canary = alloca i32
  store i32 867775509, i32* %canary
  %temp = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
  store i64 0, i64* %i, align 8
...
entry:
  %canary = alloca i32
  store i32 1328108714, i32* %canary
  %Rmin.addr = alloca i64*, align 8
  %retval = alloca i32, align 4
  %i = alloca i64, align 8
  %buf = alloca i64, align 8
...
entry:
  %buf = alloca i64, align 8
  %canary = alloca i32
  store i32 372314831, i32* %canary
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %Rmin.addr = alloca i64*, align 8
  %retval = alloca i32, align 4
  %i = alloca i64, align 8
...
entry:
  %Fmin.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 1282619975, i32* %canary
  %outf = alloca %struct._IO_FILE*, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %Rmin.addr = alloca i64*, align 8
  %Bmin.addr = alloca i64*, align 8
...
entry:
  ...
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1759680682, i32* %canary
  %Rmin.addr = alloca i64*, align 8
  %temp = alloca i64, align 8
  %j = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1422740960, i32* %canary
  %i = alloca i64, align 8
  %temp = alloca i64, align 8
  %j = alloca i64, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
...
entry:
  %i = alloca i64, align 8
  %canary = alloca i32
  store i32 1476253932, i32* %canary
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %f = alloca %struct._IO_FILE*, align 8
  %retval = alloca i32, align 4
  %Rmin.addr = alloca i64*, align 8
...
entry:
  ...
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1692768267, i32* %canary
  %retval = alloca i32, align 4
  %buf = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
...
entry:
  ...
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1314901056, i32* %canary
  %Rmin.addr = alloca i64*, align 8
  %iBucket = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1005390203, i32* %canary
  %Rmin.addr = alloca i64*, align 8
  %Fmin.addr = alloca i64*, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %Bmin.addr = alloca i64*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_buffer.34(i64 %NumberLeakyBuckets, i64* %Rmin, i64* %Bmin, i64* %Fmin) #0 {
entry:
  %Rmin.addr = alloca i64*, align 8
  %Fmin.addr = alloca i64*, align 8
  %iBucket = alloca i64, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 434737742, i32* %canary
  %Bmin.addr = alloca i64*, align 8
  %outf = alloca %struct._IO_FILE*, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
