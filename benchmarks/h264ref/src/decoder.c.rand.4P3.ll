; ModuleID = 'decoder.c.rand.4P3.bc'
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_decode_one_b8block.3, label %ctrl0

func_decode_one_b8block.3:                        ; preds = %rand_bb
  call void @decode_one_b8block.3(i32 %decoder, i32 %mbmode, i32 %b8block, i32 %b8mode, i32 %b8ref)
  ret void

func_decode_one_b8block.15:                       ; preds = %ctrl0
  call void @decode_one_b8block.15(i32 %decoder, i32 %mbmode, i32 %b8block, i32 %b8mode, i32 %b8ref)
  ret void

func_decode_one_b8block.18:                       ; preds = %ctrl1
  call void @decode_one_b8block.18(i32 %decoder, i32 %mbmode, i32 %b8block, i32 %b8mode, i32 %b8ref)
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_decode_one_b8block.15, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_decode_one_b8block.18, label %func_decode_one_b8block.20
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_Get_Reference_Block.26, label %ctrl0

func_Get_Reference_Block.26:                      ; preds = %rand_bb
  call void @Get_Reference_Block.26(i16** %imY, i32 %block_y, i32 %block_x, i32 %mvhor, i32 %mvver, i16** %out)
  ret void

func_Get_Reference_Block.28:                      ; preds = %ctrl0
  call void @Get_Reference_Block.28(i16** %imY, i32 %block_y, i32 %block_x, i32 %mvhor, i32 %mvver, i16** %out)
  ret void

func_Get_Reference_Block.30:                      ; preds = %ctrl1
  call void @Get_Reference_Block.30(i16** %imY, i32 %block_y, i32 %block_x, i32 %mvhor, i32 %mvver, i16** %out)
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_Get_Reference_Block.28, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_Get_Reference_Block.30, label %func_Get_Reference_Block.32
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_decode_one_mb.5, label %func_decode_one_mb.16

func_decode_one_mb.5:                             ; preds = %rand_bb
  call void @decode_one_mb.5(i32 %decoder, %struct.macroblock* %currMB)
  ret void

func_decode_one_mb.16:                            ; preds = %rand_bb
  call void @decode_one_mb.16(i32 %decoder, %struct.macroblock* %currMB)
  ret void
}
...
func_Get_Reference_Pixel.17:                      ; preds = %ctrl0
  %3 = call i8 @Get_Reference_Pixel.17(i16** %imY, i32 %y_pos, i32 %x_pos)
  ret i8 %3

func_Get_Reference_Pixel.29:                      ; preds = %ctrl1
  %4 = call i8 @Get_Reference_Pixel.29(i16** %imY, i32 %y_pos, i32 %x_pos)
  ret i8 %4

func_Get_Reference_Pixel.33:                      ; preds = %ctrl1
  %5 = call i8 @Get_Reference_Pixel.33(i16** %imY, i32 %y_pos, i32 %x_pos)
  ret i8 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_Get_Reference_Pixel.17, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_Get_Reference_Pixel.29, label %func_Get_Reference_Pixel.33
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_Build_Status_Map.7, label %ctrl0

func_Build_Status_Map.7:                          ; preds = %rand_bb
  call void @Build_Status_Map.7(i8** %s_map)
  ret void

func_Build_Status_Map.12:                         ; preds = %ctrl0
  call void @Build_Status_Map.12(i8** %s_map)
  ret void

func_Build_Status_Map.23:                         ; preds = %ctrl1
  call void @Build_Status_Map.23(i8** %s_map)
  ret void

func_Build_Status_Map.24:                         ; preds = %ctrl1
  call void @Build_Status_Map.24(i8** %s_map)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_Build_Status_Map.12, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_Build_Status_Map.23, label %func_Build_Status_Map.24
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_Error_Concealment.19, label %ctrl0

func_Error_Concealment.19:                        ; preds = %rand_bb
  call void @Error_Concealment.19(i16** %inY, i8** %s_map, i16*** %refY)
  ret void
...
func_Error_Concealment.31:                        ; preds = %ctrl1
  call void @Error_Concealment.31(i16** %inY, i8** %s_map, i16*** %refY)
  ret void

func_Error_Concealment.34:                        ; preds = %ctrl1
  call void @Error_Concealment.34(i16** %inY, i8** %s_map, i16*** %refY)
  ret void
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_Error_Concealment.31, label %func_Error_Concealment.34
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_DecOneForthPix.2, label %ctrl0

func_DecOneForthPix.2:                            ; preds = %rand_bb
  call void @DecOneForthPix.2(i16** %dY, i16*** %dref)
  ret void

func_DecOneForthPix.11:                           ; preds = %ctrl0
  call void @DecOneForthPix.11(i16** %dY, i16*** %dref)
  ret void

func_DecOneForthPix.22:                           ; preds = %ctrl1
  call void @DecOneForthPix.22(i16** %dY, i16*** %dref)
  ret void

func_DecOneForthPix.27:                           ; preds = %ctrl1
  call void @DecOneForthPix.27(i16** %dY, i16*** %dref)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_DecOneForthPix.11, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_DecOneForthPix.22, label %func_DecOneForthPix.27
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_compute_residue_b8block.6, label %ctrl0

func_compute_residue_b8block.6:                   ; preds = %rand_bb
  call void @compute_residue_b8block.6(i32 %b8block, i32 %i16mode)
  ret void

func_compute_residue_b8block.8:                   ; preds = %ctrl0
  call void @compute_residue_b8block.8(i32 %b8block, i32 %i16mode)
  ret void

func_compute_residue_b8block.9:                   ; preds = %ctrl1
  call void @compute_residue_b8block.9(i32 %b8block, i32 %i16mode)
  ret void

func_compute_residue_b8block.10:                  ; preds = %ctrl1
  call void @compute_residue_b8block.10(i32 %b8block, i32 %i16mode)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_compute_residue_b8block.8, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_compute_residue_b8block.9, label %func_compute_residue_b8block.10
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_Conceal_Error.4, label %ctrl0

func_Conceal_Error.4:                             ; preds = %rand_bb
  call void @Conceal_Error.4(i16** %inY, i32 %mb_y, i32 %mb_x, i16*** %refY, i8** %s_map)
  ret void

func_Conceal_Error.13:                            ; preds = %ctrl0
  call void @Conceal_Error.13(i16** %inY, i32 %mb_y, i32 %mb_x, i16*** %refY, i8** %s_map)
  ret void
...
func_Conceal_Error.21:                            ; preds = %ctrl1
  call void @Conceal_Error.21(i16** %inY, i32 %mb_y, i32 %mb_x, i16*** %refY, i8** %s_map)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_Conceal_Error.13, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_Conceal_Error.14, label %func_Conceal_Error.21
}
...
entry:
  ...
  %canary = alloca i32
  store i32 732304967, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @DecOneForthPix.2(i16** %dY, i16*** %dref) #0 {
entry:
  %dref.addr = alloca i16***, align 8
  %ref = alloca i32, align 4
  %dY.addr = alloca i16**, align 8
  %canary = alloca i32
  store i32 483850742, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @decode_one_b8block.3(i32 %decoder, i32 %mbmode, i32 %b8block, i32 %b8mode, i32 %b8ref) #0 {
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 708569123, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Conceal_Error.4(i16** %inY, i32 %mb_y, i32 %mb_x, i16*** %refY, i8** %s_map) #0 {
entry:
  %canary = alloca i32
  store i32 947588994, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @decode_one_mb.5(i32 %decoder, %struct.macroblock* %currMB) #0 {
entry:
  %canary = alloca i32
  store i32 282900840, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @compute_residue_b8block.6(i32 %b8block, i32 %i16mode) #0 {
entry:
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1622693407, i32* %canary
  %i1 = alloca i32, align 4
  %i0 = alloca i32, align 4
  %b8block.addr = alloca i32, align 4
  %i = alloca i32, align 4
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 701489370, i32* %canary
  %s_map.addr = alloca i8**, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @compute_residue_b8block.8(i32 %b8block, i32 %i16mode) #0 {
entry:
  %canary = alloca i32
  store i32 273376415, i32* %canary
  %i0 = alloca i32, align 4
  %b8block.addr = alloca i32, align 4
  %i1 = alloca i32, align 4
  %j = alloca i32, align 4
...
entry:
  ...
  %i1 = alloca i32, align 4
  %canary = alloca i32
  store i32 1359443369, i32* %canary
  %j1 = alloca i32, align 4
  %i = alloca i32, align 4
  %j0 = alloca i32, align 4
  %b8block.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @compute_residue_b8block.10(i32 %b8block, i32 %i16mode) #0 {
entry:
  %i1 = alloca i32, align 4
  %j = alloca i32, align 4
  %i0 = alloca i32, align 4
  %canary = alloca i32
  store i32 1744509004, i32* %canary
  %b8block.addr = alloca i32, align 4
  %j0 = alloca i32, align 4
  %i16mode.addr = alloca i32, align 4
  %j1 = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @DecOneForthPix.11(i16** %dY, i16*** %dref) #0 {
entry:
  %dref.addr = alloca i16***, align 8
  %dY.addr = alloca i16**, align 8
  %canary = alloca i32
  store i32 499924132, i32* %canary
  %ref = alloca i32, align 4
  %j = alloca i32, align 4
  store i16** %dY, i16*** %dY.addr, align 8
  store i16*** %dref, i16**** %dref.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Build_Status_Map.12(i8** %s_map) #0 {
entry:
  %packet_lost = alloca i32, align 4
  %canary = alloca i32
  store i32 1355272507, i32* %canary
  %mb = alloca i32, align 4
  %ii = alloca i32, align 4
  %s_map.addr = alloca i8**, align 8
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Conceal_Error.13(i16** %inY, i32 %mb_y, i32 %mb_x, i16*** %refY, i8** %s_map) #0 {
entry:
  %ref_inx = alloca i32, align 4
  %refY.addr = alloca i16***, align 8
  %block_x = alloca i32, align 4
  ...
  %mb_y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 651283048, i32* %canary
  %block_y = alloca i32, align 4
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  store i16** %inY, i16*** %inY.addr, align 8
...
entry:
  ...
  %refY.addr = alloca i16***, align 8
  %canary = alloca i32
  store i32 1464755180, i32* %canary
  %ref_inx = alloca i32, align 4
  %pos_x = alloca i32, align 4
  %inter = alloca i32, align 4
  %mb_x.addr = alloca i32, align 4
...
sw.epilog:                                        ; preds = %if.end545, %if.end487, %if.end321, %if.end, %land.end54
  %325 = load i32, i32* %canary
  %326 = icmp eq i32 %325, 1464755180
  br i1 %326, label %327, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @decode_one_b8block.15(i32 %decoder, i32 %mbmode, i32 %b8block, i32 %b8mode, i32 %b8ref) #0 {
entry:
  %resY_tmp = alloca [16 x [16 x i32]], align 16
  %j1 = alloca i32, align 4
  %by0 = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @decode_one_mb.16(i32 %decoder, %struct.macroblock* %currMB) #0 {
entry:
  %canary = alloca i32
  store i32 1593103879, i32* %canary
  %decoder.addr = alloca i32, align 4
  %currMB.addr = alloca %struct.macroblock*, align 8
  store i32 %decoder, i32* %decoder.addr, align 4
  store %struct.macroblock* %currMB, %struct.macroblock** %currMB.addr, align 8
  %0 = load i32, i32* %canary
  %1 = icmp eq i32 %0, 1593103879
  br i1 %1, label %2, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local zeroext i8 @Get_Reference_Pixel.17(i16** %imY, i32 %y_pos, i32 %x_pos) #0 {
entry:
  %pres_y = alloca i32, align 4
  %y = alloca i32, align 4
  %result2 = alloca i32, align 4
  %canary = alloca i32
  store i32 122861068, i32* %canary
  %dx = alloca i32, align 4
  %maxold_y = alloca i32, align 4
  %result1 = alloca i32, align 4
  %pres_x = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @decode_one_b8block.18(i32 %decoder, i32 %mbmode, i32 %b8block, i32 %b8mode, i32 %b8ref) #0 {
entry:
  %resY_tmp = alloca [16 x [16 x i32]], align 16
  %b8ref.addr = alloca i32, align 4
  %by = alloca i32, align 4
  ...
  %b8mode.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 897996763, i32* %canary
  %i1 = alloca i32, align 4
  %b8block.addr = alloca i32, align 4
  %ref_inx = alloca i32, align 4
  %i0 = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Error_Concealment.19(i16** %inY, i8** %s_map, i16*** %refY) #0 {
entry:
  ...
  %s_map.addr = alloca i8**, align 8
  %canary = alloca i32
  store i32 1305844486, i32* %canary
  %inY.addr = alloca i16**, align 8
...
entry:
  ...
  %i0 = alloca i32, align 4
  %canary = alloca i32
  store i32 1532990871, i32* %canary
  %bx0 = alloca i32, align 4
  %resY_tmp = alloca [16 x [16 x i32]], align 16
  %by1 = alloca i32, align 4
  %decoder.addr = alloca i32, align 4
...
if.end315:                                        ; preds = %if.end314, %for.end28
  %241 = load i32, i32* %canary
  %242 = icmp eq i32 %241, 1532990871
  br i1 %242, label %243, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Conceal_Error.21(i16** %inY, i32 %mb_y, i32 %mb_x, i16*** %refY, i8** %s_map) #0 {
entry:
  %j = alloca i32, align 4
  %block_y = alloca i32, align 4
  %block_x = alloca i32, align 4
  %canary = alloca i32
  store i32 223334682, i32* %canary
  %resY = alloca [16 x [16 x i32]], align 16
  %mb_x.addr = alloca i32, align 4
  %inY.addr = alloca i16**, align 8
  %refY.addr = alloca i16***, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @DecOneForthPix.22(i16** %dY, i16*** %dref) #0 {
entry:
  %j = alloca i32, align 4
  %dY.addr = alloca i16**, align 8
  %ref = alloca i32, align 4
  %canary = alloca i32
  store i32 61487953, i32* %canary
  %dref.addr = alloca i16***, align 8
  store i16** %dY, i16*** %dY.addr, align 8
  store i16*** %dref, i16**** %dref.addr, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Build_Status_Map.23(i8** %s_map) #0 {
entry:
  %ii = alloca i32, align 4
  %j = alloca i32, align 4
  %jj = alloca i32, align 4
  %mb = alloca i32, align 4
  %canary = alloca i32
  store i32 880405391, i32* %canary
  %packet_lost = alloca i32, align 4
  %slice = alloca i32, align 4
  %s_map.addr = alloca i8**, align 8
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Build_Status_Map.24(i8** %s_map) #0 {
entry:
  %s_map.addr = alloca i8**, align 8
  %slice = alloca i32, align 4
  %packet_lost = alloca i32, align 4
  ...
  %ii = alloca i32, align 4
  %canary = alloca i32
  store i32 325020565, i32* %canary
  %mb = alloca i32, align 4
  %jj = alloca i32, align 4
  %j = alloca i32, align 4
  store i8** %s_map, i8*** %s_map.addr, align 8
...
entry:
  ...
  %mb_y = alloca i32, align 4
  %canary = alloca i32
  store i32 1810491550, i32* %canary
  %s_map.addr = alloca i8**, align 8
  %mb_h = alloca i32, align 4
  %inY.addr = alloca i16**, align 8
  %mb_w = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Get_Reference_Block.26(i16** %imY, i32 %block_y, i32 %block_x, i32 %mvhor, i32 %mvver, i16** %out) #0 {
entry:
  %block_x.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 920584902, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @DecOneForthPix.27(i16** %dY, i16*** %dref) #0 {
entry:
  %dY.addr = alloca i16**, align 8
  %dref.addr = alloca i16***, align 8
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1954965881, i32* %canary
  %ref = alloca i32, align 4
  store i16** %dY, i16*** %dY.addr, align 8
  store i16*** %dref, i16**** %dref.addr, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Get_Reference_Block.28(i16** %imY, i32 %block_y, i32 %block_x, i32 %mvhor, i32 %mvver, i16** %out) #0 {
entry:
  %block_y.addr = alloca i32, align 4
  %y = alloca i32, align 4
  %x = alloca i32, align 4
  %canary = alloca i32
  store i32 286661516, i32* %canary
  %mvhor.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %out.addr = alloca i16**, align 8
  %block_x.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local zeroext i8 @Get_Reference_Pixel.29(i16** %imY, i32 %y_pos, i32 %x_pos) #0 {
entry:
  %y = alloca i32, align 4
  %dx = alloca i32, align 4
  %y_pos.addr = alloca i32, align 4
  ...
  %pres_x = alloca i32, align 4
  %canary = alloca i32
  store i32 1954788327, i32* %canary
  %maxold_y = alloca i32, align 4
  %x = alloca i32, align 4
  %pres_y = alloca i32, align 4
  %x_pos.addr = alloca i32, align 4
...
if.end926:                                        ; preds = %if.end925, %cond.end31
  ...
  %conv927 = trunc i32 %436 to i8
  %437 = load i32, i32* %canary
  %438 = icmp eq i32 %437, 1954788327
  br i1 %438, label %439, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Get_Reference_Block.30(i16** %imY, i32 %block_y, i32 %block_x, i32 %mvhor, i32 %mvver, i16** %out) #0 {
entry:
  %mvhor.addr = alloca i32, align 4
  %block_x.addr = alloca i32, align 4
  %out.addr = alloca i16**, align 8
  ...
  %mvver.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 332723703, i32* %canary
  %x = alloca i32, align 4
  %imY.addr = alloca i16**, align 8
  %i = alloca i32, align 4
  %block_y.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Error_Concealment.31(i16** %inY, i8** %s_map, i16*** %refY) #0 {
entry:
  %mb_y = alloca i32, align 4
  %mb_w = alloca i32, align 4
  %mb_h = alloca i32, align 4
...
entry:
  ...
  %block_y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1545241303, i32* %canary
  %imY.addr = alloca i16**, align 8
  store i16** %imY, i16*** %imY.addr, align 8
  store i32 %block_y, i32* %block_y.addr, align 4
  store i32 %block_x, i32* %block_x.addr, align 4
...
entry:
  ...
  %result2 = alloca i32, align 4
  %canary = alloca i32
  store i32 1409570558, i32* %canary
  %result1 = alloca i32, align 4
  store i16** %imY, i16*** %imY.addr, align 8
  store i32 %y_pos, i32* %y_pos.addr, align 4
  store i32 %x_pos, i32* %x_pos.addr, align 4
...
if.end926:                                        ; preds = %if.end925, %cond.end31
  ...
  %conv927 = trunc i32 %436 to i8
  %437 = load i32, i32* %canary
  %438 = icmp eq i32 %437, 1409570558
  br i1 %438, label %439, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Error_Concealment.34(i16** %inY, i8** %s_map, i16*** %refY) #0 {
entry:
  %inY.addr = alloca i16**, align 8
  %canary = alloca i32
  store i32 1239638460, i32* %canary
  %mb_y = alloca i32, align 4
  %mb_h = alloca i32, align 4
  %mb_w = alloca i32, align 4
  %refY.addr = alloca i16***, align 8
