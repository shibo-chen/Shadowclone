; ModuleID = 'specrand.c.rand.16P2.bc'
...
entry:
  ...
  %canary = alloca i32
  store i32 431970736, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 525479946, i32* %canary
  %lo = alloca i32, align 4
  %hi = alloca i32, align 4
  %test = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
...
entry:
  %test = alloca i32, align 4
  %canary = alloca i32
  store i32 419006595, i32* %canary
  %lo = alloca i32, align 4
  %hi = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
  %conv = sext i32 %0 to i64
...
entry:
  %test = alloca i32, align 4
  %canary = alloca i32
  store i32 1147959069, i32* %canary
  %hi = alloca i32, align 4
  %lo = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
  %conv = sext i32 %0 to i64
...
entry:
  ...
  %test = alloca i32, align 4
  %canary = alloca i32
  store i32 366085384, i32* %canary
  %lo = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
  %conv = sext i32 %0 to i64
  %div = sdiv i64 %conv, 127773
...
entry:
  %canary = alloca i32
  store i32 423343834, i32* %canary
  %hi = alloca i32, align 4
  %lo = alloca i32, align 4
  %test = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
