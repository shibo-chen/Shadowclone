; ModuleID = 'filehandle.c.rand.4P2.bc'
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_error.2, label %func_error.7
...
func_write_PPS.6:                                 ; preds = %ctrl1
  %5 = call i32 @write_PPS.6(i32 %len, i32 %PPS_id)
  ret i32 %5
...
ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_write_PPS.5, label %func_write_PPS.6
}
...
func_start_sequence.8:                            ; preds = %ctrl0
  %3 = call i32 @start_sequence.8()
  ret i32 %3
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_start_sequence.8, label %ctrl1
...
entry:
  ...
  %canary = alloca i32
  store i32 1910475137, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1345023764, i32* %canary
...
entry:
  %len.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 322176766, i32* %canary
  %PPS_id.addr = alloca i32, align 4
  %nalu = alloca %struct.NALU_t*, align 8
  store i32 %len, i32* %len.addr, align 4
  store i32 %PPS_id, i32* %PPS_id.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 414844353, i32* %canary
  %nalu = alloca %struct.NALU_t*, align 8
...
entry:
  %PPS_id.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 391545860, i32* %canary
  %nalu = alloca %struct.NALU_t*, align 8
  %len.addr = alloca i32, align 4
  store i32 %len, i32* %len.addr, align 4
  store i32 %PPS_id, i32* %PPS_id.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 1161838321, i32* %canary
  %nalu = alloca %struct.NALU_t*, align 8
  %PPS_id.addr = alloca i32, align 4
  %len.addr = alloca i32, align 4
  store i32 %len, i32* %len.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 1235224175, i32* %canary
  %code.addr = alloca i32, align 4
  %text.addr = alloca i8*, align 8
  store i8* %text, i8** %text.addr, align 8
  store i32 %code, i32* %code.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 935913806, i32* %canary
  %nalu = alloca %struct.NALU_t*, align 8
  %i = alloca i32, align 4
  %total_pps = alloca i32, align 4
  %retval = alloca i32, align 4
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 270137107, i32* %canary
  %len = alloca i32, align 4
  store i32 0, i32* %len, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %GenerateMultiplePPS = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 15
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 2030234804, i32* %canary
  %len = alloca i32, align 4
  %i = alloca i32, align 4
  store i32 0, i32* %len, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
