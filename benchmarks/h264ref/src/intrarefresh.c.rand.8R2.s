...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$16, %rsp
	movl	$1059507057, -12(%rbp)  # imm = 0x3F26CB71
...
# %bb.3:                                # %for.inc
	...
	jmp	.LBB4_1
.LBB4_4:                                # %for.end
	cmpl	$1059507057, -12(%rbp)  # imm = 0x3F26CB71
	jne	.LBB4_6
.LBB4_5:
	addq	$16, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$550528386, -20(%rbp)   # imm = 0x20D06582
	movl	%edi, -24(%rbp)
	movl	%esi, -16(%rbp)
	movl	%edx, -12(%rbp)
	movl	$1, %edi
...
# %bb.14:                               # %for.inc23
	...
	jmp	.LBB5_9
.LBB5_15:                               # %for.end25
	cmpl	$550528386, -20(%rbp)   # imm = 0x20D06582
	jne	.LBB5_17
.LBB5_16:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$16, %rsp
	movl	$247226721, -12(%rbp)   # imm = 0xEBC6161
	movl	NumberIntraPerPicture, %eax
	addl	WalkAround, %eax
	movl	%eax, WalkAround
	movl	$0, -4(%rbp)
...
# %bb.3:                                # %for.inc
	...
	jmp	.LBB6_1
.LBB6_4:                                # %for.end
	cmpl	$247226721, -12(%rbp)   # imm = 0xEBC6161
	jne	.LBB6_6
.LBB6_5:
	addq	$16, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1157033027, -24(%rbp)  # imm = 0x44F6EC43
	movl	%edi, -16(%rbp)
	movl	%esi, -20(%rbp)
	movl	%edx, -8(%rbp)
	movl	$1, %edi
...
# %bb.14:                               # %for.inc23
	...
	jmp	.LBB7_9
.LBB7_15:                               # %for.end25
	cmpl	$1157033027, -24(%rbp)  # imm = 0x44F6EC43
	jne	.LBB7_17
.LBB7_16:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$1443136378, -24(%rbp)  # imm = 0x5604837A
	movl	%edi, -20(%rbp)
	movl	$0, -12(%rbp)
.LBB8_1:                                # %for.cond
                                        # =>This Inner Loop Header: Depth=1
...
.LBB8_7:                                # %return
	movl	-16(%rbp), %ebx
	cmpl	$1443136378, -24(%rbp)  # imm = 0x5604837A
	jne	.LBB8_9
.LBB8_8:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$509583268, -20(%rbp)   # imm = 0x1E5F9FA4
	movl	%edi, -24(%rbp)
	movl	$0, -12(%rbp)
.LBB9_1:                                # %for.cond
                                        # =>This Inner Loop Header: Depth=1
...
.LBB9_7:                                # %return
	movl	-16(%rbp), %ebx
	cmpl	$509583268, -20(%rbp)   # imm = 0x1E5F9FA4
	jne	.LBB9_9
.LBB9_8:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$100741134, -20(%rbp)   # imm = 0x601300E
	movl	%edi, -24(%rbp)
	movl	$0, -12(%rbp)
.LBB10_1:                               # %for.cond
                                        # =>This Inner Loop Header: Depth=1
...
.LBB10_7:                               # %return
	movl	-16(%rbp), %ebx
	cmpl	$100741134, -20(%rbp)   # imm = 0x601300E
	jne	.LBB10_9
.LBB10_8:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$2007579587, -24(%rbp)  # imm = 0x77A93BC3
	movl	%edi, -20(%rbp)
	movl	$0, -12(%rbp)
.LBB11_1:                               # %for.cond
                                        # =>This Inner Loop Header: Depth=1
...
.LBB11_7:                               # %return
	movl	-16(%rbp), %ebx
	cmpl	$2007579587, -24(%rbp)  # imm = 0x77A93BC3
	jne	.LBB11_9
.LBB11_8:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$1853414839, -24(%rbp)  # imm = 0x6E78DDB7
	movl	%edi, -20(%rbp)
	movl	$0, -12(%rbp)
.LBB12_1:                               # %for.cond
                                        # =>This Inner Loop Header: Depth=1
...
.LBB12_7:                               # %return
	movl	-16(%rbp), %ebx
	cmpl	$1853414839, -24(%rbp)  # imm = 0x6E78DDB7
	jne	.LBB12_9
.LBB12_8:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$784666787, -24(%rbp)   # imm = 0x2EC510A3
	movl	%edi, -20(%rbp)
	movl	%esi, -16(%rbp)
	movl	%edx, -12(%rbp)
	movl	$1, %edi
...
# %bb.14:                               # %for.inc23
	...
	jmp	.LBB13_9
.LBB13_15:                              # %for.end25
	cmpl	$784666787, -24(%rbp)   # imm = 0x2EC510A3
	jne	.LBB13_17
.LBB13_16:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$553749925, -20(%rbp)   # imm = 0x21018DA5
	movl	%edi, -16(%rbp)
	movl	%esi, -24(%rbp)
	movl	%edx, -8(%rbp)
	movl	$1, %edi
...
# %bb.14:                               # %for.inc23
	...
	jmp	.LBB14_9
.LBB14_15:                              # %for.end25
	cmpl	$553749925, -20(%rbp)   # imm = 0x21018DA5
	jne	.LBB14_17
.LBB14_16:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$656740976, -16(%rbp)   # imm = 0x27251270
	movl	%edi, -24(%rbp)
	movl	%esi, -20(%rbp)
	movl	%edx, -12(%rbp)
	movl	$1, %edi
...
# %bb.14:                               # %for.inc23
	...
	jmp	.LBB15_9
.LBB15_15:                              # %for.end25
	cmpl	$656740976, -16(%rbp)   # imm = 0x27251270
	jne	.LBB15_17
.LBB15_16:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$1189917515, -24(%rbp)  # imm = 0x46ECB34B
	movl	%edi, -20(%rbp)
	movl	$0, -12(%rbp)
.LBB16_1:                               # %for.cond
                                        # =>This Inner Loop Header: Depth=1
...
.LBB16_7:                               # %return
	movl	-16(%rbp), %ebx
	cmpl	$1189917515, -24(%rbp)  # imm = 0x46ECB34B
	jne	.LBB16_9
.LBB16_8:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1124941539, -20(%rbp)  # imm = 0x430D3EE3
	movl	%edi, -16(%rbp)
	movl	%esi, -24(%rbp)
	movl	%edx, -8(%rbp)
	movl	$1, %edi
...
# %bb.14:                               # %for.inc23
	...
	jmp	.LBB17_9
.LBB17_15:                              # %for.end25
	cmpl	$1124941539, -20(%rbp)  # imm = 0x430D3EE3
	jne	.LBB17_17
.LBB17_16:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1736145793, -16(%rbp)  # imm = 0x677B7B81
	movl	%edi, -20(%rbp)
	movl	%esi, -24(%rbp)
	movl	%edx, -8(%rbp)
	movl	$1, %edi
...
# %bb.14:                               # %for.inc23
	...
	jmp	.LBB18_9
.LBB18_15:                              # %for.end25
	cmpl	$1736145793, -16(%rbp)  # imm = 0x677B7B81
	jne	.LBB18_17
.LBB18_16:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1779449585, -20(%rbp)  # imm = 0x6A103EF1
	movl	%edi, -24(%rbp)
	movl	%esi, -16(%rbp)
	movl	%edx, -12(%rbp)
	movl	$1, %edi
...
# %bb.14:                               # %for.inc23
	...
	jmp	.LBB19_9
.LBB19_15:                              # %for.end25
	cmpl	$1779449585, -20(%rbp)  # imm = 0x6A103EF1
	jne	.LBB19_17
.LBB19_16:
	addq	$32, %rsp
	popq	%rbp
