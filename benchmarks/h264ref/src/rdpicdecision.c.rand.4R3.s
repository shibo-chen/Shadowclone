...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$829690409, -20(%rbp)   # imm = 0x31741229
	vmovsd	%xmm0, -32(%rbp)
	vmovsd	%xmm1, -56(%rbp)
	movl	%edi, -16(%rbp)
	movl	%esi, -24(%rbp)
...
.LBB2_5:                                # %return
	movl	-12(%rbp), %ebx
	cmpl	$829690409, -20(%rbp)   # imm = 0x31741229
	jne	.LBB2_7
.LBB2_6:
	movl	%ebx, %eax
	addq	$56, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$601758615, -16(%rbp)   # imm = 0x23DE1B97
	vmovsd	%xmm0, -48(%rbp)
	vmovsd	%xmm1, -40(%rbp)
	movl	%edi, -20(%rbp)
	movl	%esi, -24(%rbp)
...
.LBB3_5:                                # %return
	movl	-12(%rbp), %ebx
	cmpl	$601758615, -16(%rbp)   # imm = 0x23DE1B97
	jne	.LBB3_7
.LBB3_6:
	movl	%ebx, %eax
	addq	$56, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$1437256427, -20(%rbp)  # imm = 0x55AACAEB
	vmovsd	%xmm0, -48(%rbp)
	vmovsd	%xmm1, -32(%rbp)
	movl	%edi, -16(%rbp)
	movl	%esi, -24(%rbp)
...
.LBB4_5:                                # %return
	movl	-12(%rbp), %ebx
	cmpl	$1437256427, -20(%rbp)  # imm = 0x55AACAEB
	jne	.LBB4_7
.LBB4_6:
	movl	%ebx, %eax
	addq	$56, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$2007965720, -24(%rbp)  # imm = 0x77AF2018
	vmovsd	%xmm0, -40(%rbp)
	vmovsd	%xmm1, -56(%rbp)
	movl	%edi, -16(%rbp)
	movl	%esi, -20(%rbp)
...
.LBB5_5:                                # %return
	movl	-12(%rbp), %ebx
	cmpl	$2007965720, -24(%rbp)  # imm = 0x77AF2018
	jne	.LBB5_7
.LBB5_6:
	movl	%ebx, %eax
	addq	$56, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$72, %rsp
	.cfi_offset %rbx, -24
	movl	$2015643104, -48(%rbp)  # imm = 0x782445E0
	movq	%rdi, -24(%rbp)
	movq	%rsi, -32(%rbp)
	movl	%edx, -12(%rbp)
	movq	img, %rax
...
.LBB6_5:                                # %if.end
	...
	movl	%eax, %ebx
	cmpl	$2015643104, -48(%rbp)  # imm = 0x782445E0
	jne	.LBB6_7
.LBB6_6:
	movl	%ebx, %eax
	addq	$72, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$72, %rsp
	.cfi_offset %rbx, -24
	movl	$23163923, -44(%rbp)    # imm = 0x1617413
	movq	%rdi, -24(%rbp)
	movq	%rsi, -32(%rbp)
	movl	%edx, -12(%rbp)
	movq	img, %rax
...
.LBB7_5:                                # %if.end
	...
	callq	rd_pic_decision
	movl	%eax, %ebx
	cmpl	$23163923, -44(%rbp)    # imm = 0x1617413
	jne	.LBB7_7
.LBB7_6:
	movl	%ebx, %eax
	addq	$72, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$72, %rsp
	.cfi_offset %rbx, -24
	movl	$327892749, -44(%rbp)   # imm = 0x138B3F0D
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movl	%edx, -12(%rbp)
	movq	img, %rax
...
.LBB8_5:                                # %if.end
	...
	callq	rd_pic_decision
	movl	%eax, %ebx
	cmpl	$327892749, -44(%rbp)   # imm = 0x138B3F0D
	jne	.LBB8_7
.LBB8_6:
	movl	%ebx, %eax
	addq	$72, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$72, %rsp
	.cfi_offset %rbx, -24
	movl	$1214474842, -40(%rbp)  # imm = 0x48636A5A
	movq	%rdi, -24(%rbp)
	movq	%rsi, -32(%rbp)
	movl	%edx, -12(%rbp)
	movq	img, %rax
...
.LBB9_5:                                # %if.end
	...
	callq	rd_pic_decision
	movl	%eax, %ebx
	cmpl	$1214474842, -40(%rbp)  # imm = 0x48636A5A
	jne	.LBB9_7
.LBB9_6:
	movl	%ebx, %eax
	addq	$72, %rsp
