...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$1629392835, -44(%rbp)  # imm = 0x611E8FC3
	movq	%rdi, -32(%rbp)
	movl	%esi, -24(%rbp)
	movl	%edx, -36(%rbp)
	movl	%ecx, -40(%rbp)
...
.LBB4_17:                               # %while.end
	movl	-12(%rbp), %ebx
	cmpl	$1629392835, -44(%rbp)  # imm = 0x611E8FC3
	jne	.LBB4_19
.LBB4_18:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$604385937, -44(%rbp)   # imm = 0x24063291
	movq	%rdi, -32(%rbp)
	movl	%esi, -24(%rbp)
	movl	%edx, -36(%rbp)
	movl	%ecx, -40(%rbp)
...
.LBB5_17:                               # %while.end
	movl	-12(%rbp), %ebx
	cmpl	$604385937, -44(%rbp)   # imm = 0x24063291
	jne	.LBB5_19
.LBB5_18:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$1562065461, -44(%rbp)  # imm = 0x5D1B3A35
	movq	%rdi, -32(%rbp)
	movl	%esi, -24(%rbp)
	movl	%edx, -36(%rbp)
	movl	%ecx, -40(%rbp)
...
.LBB6_17:                               # %while.end
	movl	-12(%rbp), %ebx
	cmpl	$1562065461, -44(%rbp)  # imm = 0x5D1B3A35
	jne	.LBB6_19
.LBB6_18:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$1719524346, -44(%rbp)  # imm = 0x667DDBFA
	movq	%rdi, -32(%rbp)
	movl	%esi, -24(%rbp)
	movl	%edx, -36(%rbp)
	movl	%ecx, -40(%rbp)
...
.LBB7_17:                               # %while.end
	movl	-12(%rbp), %ebx
	cmpl	$1719524346, -44(%rbp)  # imm = 0x667DDBFA
	jne	.LBB7_19
.LBB7_18:
	movl	%ebx, %eax
	addq	$40, %rsp
