...
ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_SliceHeader.17, label %func_SliceHeader.21
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_get_picture_type.10, label %func_get_picture_type.12

func_get_picture_type.10:                         ; preds = %rand_bb
  %2 = call i32 @get_picture_type.10()
  ret i32 %2

func_get_picture_type.12:                         ; preds = %rand_bb
  %3 = call i32 @get_picture_type.12()
  ret i32 %3
}
...
func_Partition_BC_Header.13:                      ; preds = %ctrl0
  %3 = call i32 @Partition_BC_Header.13(i32 %PartNo)
  ret i32 %3
...
func_Partition_BC_Header.22:                      ; preds = %ctrl1
  %5 = call i32 @Partition_BC_Header.22(i32 %PartNo)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_Partition_BC_Header.13, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_Partition_BC_Header.15, label %func_Partition_BC_Header.22
}
...
func_ref_pic_list_reordering.14:                  ; preds = %ctrl1
  %4 = call i32 @ref_pic_list_reordering.14()
  ret i32 %4

func_ref_pic_list_reordering.20:                  ; preds = %ctrl1
  %5 = call i32 @ref_pic_list_reordering.20()
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_ref_pic_list_reordering.9, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_ref_pic_list_reordering.14, label %func_ref_pic_list_reordering.20
}
...
func_pred_weight_table.8:                         ; preds = %ctrl1
  %4 = call i32 @pred_weight_table.8()
  ret i32 %4
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_pred_weight_table.7, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_pred_weight_table.8, label %func_pred_weight_table.16
}
...
entry:
  ...
  %dP_nr = alloca i32, align 4
  %canary = alloca i32
  store i32 2045708393, i32* %canary
...
entry:
  ...
  %dP_nr = alloca i32, align 4
  %canary = alloca i32
  store i32 1509791382, i32* %canary
  %partition = alloca %struct.datapartition*, align 8
  %i = alloca i32, align 4
  %len = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
if.end175:                                        ; preds = %for.end174, %for.end83
  ...
  %172 = icmp eq i32 %171, 1509791382
...
entry:
  ...
  %canary = alloca i32
  store i32 933866883, i32* %canary
  %partition = alloca %struct.datapartition*, align 8
  %len = alloca i32, align 4
...
entry:
  ...
  %val = alloca i32, align 4
  %canary = alloca i32
  store i32 1534017686, i32* %canary
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
  %1 = load i32, i32* %partition_mode, align 4
...
entry:
  ...
  %len = alloca i32, align 4
  %canary = alloca i32
  store i32 2108892829, i32* %canary
  %i = alloca i32, align 4
  %dP_nr = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
...
if.end175:                                        ; preds = %for.end174, %for.end83
  %170 = load i32, i32* %len, align 4
  %171 = load i32, i32* %canary
  %172 = icmp eq i32 %171, 2108892829
  br i1 %172, label %173, label %func_exit
...
entry:
  %canary = alloca i32
  store i32 728371455, i32* %canary
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
  %len = alloca i32, align 4
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 269247356, i32* %canary
  %len = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_picture_type.10() #0 {
entry:
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 473635482, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_picture_type.12() #0 {
entry:
  %canary = alloca i32
  store i32 625802741, i32* %canary
  %same_slicetype_for_whole_frame = alloca i32, align 4
  %retval = alloca i32, align 4
  store i32 5, i32* %same_slicetype_for_whole_frame, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
entry:
  ...
  %len = alloca i32, align 4
  %canary = alloca i32
  store i32 619337008, i32* %canary
  %sym = alloca %struct.syntaxelement*, align 8
  %symbol = alloca %struct.syntaxelement, align 8
  store i32 %PartNo, i32* %PartNo.addr, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
entry:
  %dP_nr = alloca i32, align 4
  %canary = alloca i32
  store i32 657229685, i32* %canary
  %i = alloca i32, align 4
  %currSlice = alloca %struct.Slice*, align 8
  %partition = alloca %struct.datapartition*, align 8
  %len = alloca i32, align 4
...
entry:
  ...
  %symbol = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 207473709, i32* %canary
  %sym = alloca %struct.syntaxelement*, align 8
  %PartNo.addr = alloca i32, align 4
  %len = alloca i32, align 4
  store i32 %PartNo, i32* %PartNo.addr, align 4
...
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1421937099, i32* %canary
  %len = alloca i32, align 4
  %j = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
  %dP_nr = alloca i32, align 4
...
if.end175:                                        ; preds = %for.end174, %for.end83
  %170 = load i32, i32* %len, align 4
  %171 = load i32, i32* %canary
  %172 = icmp eq i32 %171, 1421937099
  br i1 %172, label %173, label %func_exit
...
entry:
  %canary = alloca i32
  store i32 916499637, i32* %canary
  %num_bits_slice_group_change_cycle = alloca i32, align 4
  %currSlice = alloca %struct.Slice*, align 8
  %bottom_field_flag = alloca i32, align 4
  %override_flag = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 386950978, i32* %canary
  %len = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
  %val = alloca i32, align 4
  %dP_nr = alloca i32, align 4
...
entry:
  ...
  %partition = alloca %struct.datapartition*, align 8
  %canary = alloca i32
  store i32 737276859, i32* %canary
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
  %dP_nr = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
...
entry:
  ...
  %dP_nr = alloca i32, align 4
  %canary = alloca i32
  store i32 198164008, i32* %canary
  %len = alloca i32, align 4
  %i = alloca i32, align 4
  %currSlice = alloca %struct.Slice*, align 8
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
entry:
  %currSlice = alloca %struct.Slice*, align 8
  %canary = alloca i32
  store i32 2062945844, i32* %canary
  %num_bits_slice_group_change_cycle = alloca i32, align 4
  %field_pic_flag = alloca i32, align 4
  %bottom_field_flag = alloca i32, align 4
  %override_flag = alloca i32, align 4
...
if.end239:                                        ; preds = %if.then236, %land.lhs.true232, %if.end229
  %236 = load i32, i32* %len, align 4
  %237 = load i32, i32* %canary
  %238 = icmp eq i32 %237, 2062945844
  br i1 %238, label %239, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @Partition_BC_Header.22(i32 %PartNo) #0 {
entry:
  %len = alloca i32, align 4
  %sym = alloca %struct.syntaxelement*, align 8
  %canary = alloca i32
  store i32 1970898185, i32* %canary
  %PartNo.addr = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
  %symbol = alloca %struct.syntaxelement, align 8
  store i32 %PartNo, i32* %PartNo.addr, align 4
