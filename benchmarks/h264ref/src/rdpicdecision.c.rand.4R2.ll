; ModuleID = 'rdpicdecision.c.rand.4R2.bc'
...
ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_rd_pic_decision.5, label %func_rd_pic_decision.7
}
...
ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_picture_coding_decision.6, label %func_picture_coding_decision.8
}
...
entry:
  ...
  %canary = alloca i32
  store i32 1526424170, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 159339103, i32* %canary
...
entry:
  %snrY_version2.addr = alloca double, align 8
  %canary = alloca i32
  store i32 1548241540, i32* %canary
  %cost_version2 = alloca double, align 8
  %lambda_picture.addr = alloca double, align 8
  %retval = alloca i32, align 4
  %bits_version2.addr = alloca i32, align 4
...
entry:
  ...
  %spframe = alloca i32, align 4
  %canary = alloca i32
  store i32 202792277, i32* %canary
  %bit_picture1 = alloca i32, align 4
  %qp.addr = alloca i32, align 4
  %bit_picture2 = alloca i32, align 4
  store %struct.Picture* %picture1, %struct.Picture** %picture1.addr, align 8
...
entry:
  ...
  %lambda_picture.addr = alloca double, align 8
  %canary = alloca i32
  store i32 1200496932, i32* %canary
  %cost_version2 = alloca double, align 8
  store double %snrY_version1, double* %snrY_version1.addr, align 8
  store double %snrY_version2, double* %snrY_version2.addr, align 8
  store i32 %bits_version1, i32* %bits_version1.addr, align 4
...
entry:
  ...
  %bframe = alloca i32, align 4
  %canary = alloca i32
  store i32 1350858068, i32* %canary
  %bit_picture1 = alloca i32, align 4
  %spframe = alloca i32, align 4
  %bit_picture2 = alloca i32, align 4
  store %struct.Picture* %picture1, %struct.Picture** %picture1.addr, align 8
...
entry:
  ...
  %bits_version2.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1274508946, i32* %canary
  %lambda_picture.addr = alloca double, align 8
  %cost_version1 = alloca double, align 8
  %retval = alloca i32, align 4
  store double %snrY_version1, double* %snrY_version1.addr, align 8
...
entry:
  ...
  %bit_picture2 = alloca i32, align 4
  %canary = alloca i32
  store i32 1941992085, i32* %canary
  %snr_picture2 = alloca double, align 8
  %snr_picture1 = alloca double, align 8
  %bframe = alloca i32, align 4
  %qp.addr = alloca i32, align 4
