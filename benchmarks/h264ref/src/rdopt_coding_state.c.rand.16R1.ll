; ModuleID = 'rdopt_coding_state.c.rand.16R1.bc'
...
func_store_coding_state.3:                        ; preds = %ctrl1
  call void @store_coding_state.3(%struct.CSobj* %cs)
  ret void
...
func_store_coding_state.7:                        ; preds = %ctrl3
  call void @store_coding_state.7(%struct.CSobj* %cs)
  ret void

func_store_coding_state.11:                       ; preds = %ctrl4
  call void @store_coding_state.11(%struct.CSobj* %cs)
  ret void

func_store_coding_state.12:                       ; preds = %ctrl5
  call void @store_coding_state.12(%struct.CSobj* %cs)
  ret void

func_store_coding_state.13:                       ; preds = %ctrl6
  call void @store_coding_state.13(%struct.CSobj* %cs)
  ret void

func_store_coding_state.14:                       ; preds = %ctrl7
  call void @store_coding_state.14(%struct.CSobj* %cs)
  ret void

func_store_coding_state.15:                       ; preds = %ctrl8
  call void @store_coding_state.15(%struct.CSobj* %cs)
  ret void

func_store_coding_state.21:                       ; preds = %ctrl9
  call void @store_coding_state.21(%struct.CSobj* %cs)
  ret void

func_store_coding_state.24:                       ; preds = %ctrl10
  call void @store_coding_state.24(%struct.CSobj* %cs)
  ret void

func_store_coding_state.25:                       ; preds = %ctrl11
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_store_coding_state.3, label %ctrl2
...
ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_store_coding_state.7, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_store_coding_state.11, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_store_coding_state.12, label %ctrl6

ctrl6:                                            ; preds = %ctrl5
  %8 = icmp eq i32 %0, 7
  br i1 %8, label %func_store_coding_state.13, label %ctrl7

ctrl7:                                            ; preds = %ctrl6
  %9 = icmp eq i32 %0, 8
  br i1 %9, label %func_store_coding_state.14, label %ctrl8

ctrl8:                                            ; preds = %ctrl7
  %10 = icmp eq i32 %0, 9
  br i1 %10, label %func_store_coding_state.15, label %ctrl9

ctrl9:                                            ; preds = %ctrl8
  %11 = icmp eq i32 %0, 10
  br i1 %11, label %func_store_coding_state.21, label %ctrl10

ctrl10:                                           ; preds = %ctrl9
  %12 = icmp eq i32 %0, 11
  br i1 %12, label %func_store_coding_state.24, label %ctrl11

ctrl11:                                           ; preds = %ctrl10
  %13 = icmp eq i32 %0, 12
  br i1 %13, label %func_store_coding_state.25, label %ctrl12
...
ctrl13:                                           ; preds = %ctrl12
  %15 = icmp eq i32 %0, 14
  br i1 %15, label %func_store_coding_state.29, label %func_store_coding_state.31
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_reset_coding_state.4, label %ctrl0

func_reset_coding_state.4:                        ; preds = %rand_bb
  call void @reset_coding_state.4(%struct.CSobj* %cs)
  ret void

func_reset_coding_state.5:                        ; preds = %ctrl0
  call void @reset_coding_state.5(%struct.CSobj* %cs)
  ret void

func_reset_coding_state.8:                        ; preds = %ctrl1
...
func_reset_coding_state.16:                       ; preds = %ctrl4
  call void @reset_coding_state.16(%struct.CSobj* %cs)
  ret void

func_reset_coding_state.17:                       ; preds = %ctrl5
  call void @reset_coding_state.17(%struct.CSobj* %cs)
  ret void

func_reset_coding_state.18:                       ; preds = %ctrl6
  call void @reset_coding_state.18(%struct.CSobj* %cs)
  ret void

func_reset_coding_state.19:                       ; preds = %ctrl7
  call void @reset_coding_state.19(%struct.CSobj* %cs)
  ret void

func_reset_coding_state.20:                       ; preds = %ctrl8
  call void @reset_coding_state.20(%struct.CSobj* %cs)
  ret void

func_reset_coding_state.22:                       ; preds = %ctrl9
  call void @reset_coding_state.22(%struct.CSobj* %cs)
  ret void

func_reset_coding_state.23:                       ; preds = %ctrl10
  call void @reset_coding_state.23(%struct.CSobj* %cs)
  ret void

func_reset_coding_state.26:                       ; preds = %ctrl11
  call void @reset_coding_state.26(%struct.CSobj* %cs)
  ret void

func_reset_coding_state.28:                       ; preds = %ctrl12
  call void @reset_coding_state.28(%struct.CSobj* %cs)
  ret void

func_reset_coding_state.30:                       ; preds = %ctrl13
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_reset_coding_state.5, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_reset_coding_state.8, label %ctrl2
...
ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_reset_coding_state.16, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_reset_coding_state.17, label %ctrl6

ctrl6:                                            ; preds = %ctrl5
  %8 = icmp eq i32 %0, 7
  br i1 %8, label %func_reset_coding_state.18, label %ctrl7

ctrl7:                                            ; preds = %ctrl6
  %9 = icmp eq i32 %0, 8
  br i1 %9, label %func_reset_coding_state.19, label %ctrl8

ctrl8:                                            ; preds = %ctrl7
  %10 = icmp eq i32 %0, 9
  br i1 %10, label %func_reset_coding_state.20, label %ctrl9

ctrl9:                                            ; preds = %ctrl8
  %11 = icmp eq i32 %0, 10
  br i1 %11, label %func_reset_coding_state.22, label %ctrl10

ctrl10:                                           ; preds = %ctrl9
  %12 = icmp eq i32 %0, 11
  br i1 %12, label %func_reset_coding_state.23, label %ctrl11

ctrl11:                                           ; preds = %ctrl10
  %13 = icmp eq i32 %0, 12
  br i1 %13, label %func_reset_coding_state.26, label %ctrl12

ctrl12:                                           ; preds = %ctrl11
  %14 = icmp eq i32 %0, 13
  br i1 %14, label %func_reset_coding_state.28, label %ctrl13

ctrl13:                                           ; preds = %ctrl12
  %15 = icmp eq i32 %0, 14
  br i1 %15, label %func_reset_coding_state.30, label %func_reset_coding_state.32
}
...
entry:
  ...
  %canary = alloca i32
  store i32 464522252, i32* %canary
...
entry:
  ...
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 361283711, i32* %canary
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %i = alloca i32, align 4
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  store %struct.CSobj* %cs, %struct.CSobj** %cs.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @store_coding_state.3(%struct.CSobj* %cs) #0 {
entry:
  %bs_dest = alloca %struct.Bitstream*, align 8
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %canary = alloca i32
  store i32 811057670, i32* %canary
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %cs.addr = alloca %struct.CSobj*, align 8
  %currMB = alloca %struct.macroblock*, align 8
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @reset_coding_state.4(%struct.CSobj* %cs) #0 {
entry:
  %bs_dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 1325868438, i32* %canary
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %currMB = alloca %struct.macroblock*, align 8
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %cs.addr = alloca %struct.CSobj*, align 8
...
entry:
  ...
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %canary = alloca i32
  store i32 191624549, i32* %canary
  %cs.addr = alloca %struct.CSobj*, align 8
  store %struct.CSobj* %cs, %struct.CSobj** %cs.addr, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %currentSlice = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 50
...
entry:
  ...
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 556226819, i32* %canary
  %bs_dest = alloca %struct.Bitstream*, align 8
  %currMB = alloca %struct.macroblock*, align 8
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
...
entry:
  ...
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %canary = alloca i32
  store i32 2008856455, i32* %canary
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %currMB = alloca %struct.macroblock*, align 8
  %i = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1480610534, i32* %canary
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %cs.addr = alloca %struct.CSobj*, align 8
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
...
entry:
  ...
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %canary = alloca i32
  store i32 2030108078, i32* %canary
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %i = alloca i32, align 4
  store %struct.CSobj* %cs, %struct.CSobj** %cs.addr, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
entry:
  ...
  %bs_src = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 554739601, i32* %canary
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %bs_dest = alloca %struct.Bitstream*, align 8
...
entry:
  ...
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %canary = alloca i32
  store i32 856378062, i32* %canary
  %i = alloca i32, align 4
  %bs_src = alloca %struct.Bitstream*, align 8
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
...
entry:
  ...
  %currMB = alloca %struct.macroblock*, align 8
  %canary = alloca i32
  store i32 1386788135, i32* %canary
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %cs.addr = alloca %struct.CSobj*, align 8
  %bs_src = alloca %struct.Bitstream*, align 8
...
entry:
  %canary = alloca i32
  store i32 1695721609, i32* %canary
  %i = alloca i32, align 4
  %cs.addr = alloca %struct.CSobj*, align 8
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %bs_dest = alloca %struct.Bitstream*, align 8
...
entry:
  ...
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %canary = alloca i32
  store i32 1198511321, i32* %canary
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %cs.addr = alloca %struct.CSobj*, align 8
  %i = alloca i32, align 4
...
entry:
  ...
  %cs.addr = alloca %struct.CSobj*, align 8
  %canary = alloca i32
  store i32 791762306, i32* %canary
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %i = alloca i32, align 4
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
...
entry:
  %cs.addr = alloca %struct.CSobj*, align 8
  %canary = alloca i32
  store i32 1206225501, i32* %canary
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %bs_src = alloca %struct.Bitstream*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @reset_coding_state.17(%struct.CSobj* %cs) #0 {
entry:
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %currMB = alloca %struct.macroblock*, align 8
  %canary = alloca i32
  store i32 623883806, i32* %canary
  %i = alloca i32, align 4
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %bs_dest = alloca %struct.Bitstream*, align 8
  %cs.addr = alloca %struct.CSobj*, align 8
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1707503882, i32* %canary
  %currMB = alloca %struct.macroblock*, align 8
  %bs_src = alloca %struct.Bitstream*, align 8
  %cs.addr = alloca %struct.CSobj*, align 8
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @reset_coding_state.20(%struct.CSobj* %cs) #0 {
entry:
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %currMB = alloca %struct.macroblock*, align 8
  ...
  %bs_dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 811375799, i32* %canary
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  store %struct.CSobj* %cs, %struct.CSobj** %cs.addr, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @store_coding_state.21(%struct.CSobj* %cs) #0 {
entry:
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  ...
  %cs.addr = alloca %struct.CSobj*, align 8
  %canary = alloca i32
  store i32 2057392287, i32* %canary
  %i = alloca i32, align 4
  %bs_dest = alloca %struct.Bitstream*, align 8
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %currMB = alloca %struct.macroblock*, align 8
...
entry:
  ...
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %canary = alloca i32
  store i32 227576569, i32* %canary
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %currMB = alloca %struct.macroblock*, align 8
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %bs_src = alloca %struct.Bitstream*, align 8
...
entry:
  ...
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 1072953669, i32* %canary
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %i = alloca i32, align 4
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  store %struct.CSobj* %cs, %struct.CSobj** %cs.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @store_coding_state.24(%struct.CSobj* %cs) #0 {
entry:
  %i = alloca i32, align 4
  %bs_src = alloca %struct.Bitstream*, align 8
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  ...
  %cs.addr = alloca %struct.CSobj*, align 8
  %canary = alloca i32
  store i32 1281066061, i32* %canary
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %bs_dest = alloca %struct.Bitstream*, align 8
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
...
entry:
  ...
  %cs.addr = alloca %struct.CSobj*, align 8
  %canary = alloca i32
  store i32 701390059, i32* %canary
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %i = alloca i32, align 4
...
entry:
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %canary = alloca i32
  store i32 162569323, i32* %canary
  %bs_src = alloca %struct.Bitstream*, align 8
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %cs.addr = alloca %struct.CSobj*, align 8
  %currMB = alloca %struct.macroblock*, align 8
...
entry:
  ...
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 801820774, i32* %canary
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %i = alloca i32, align 4
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  store %struct.CSobj* %cs, %struct.CSobj** %cs.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @reset_coding_state.28(%struct.CSobj* %cs) #0 {
entry:
  %currMB = alloca %struct.macroblock*, align 8
  %bs_src = alloca %struct.Bitstream*, align 8
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1966503241, i32* %canary
  %cs.addr = alloca %struct.CSobj*, align 8
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %bs_dest = alloca %struct.Bitstream*, align 8
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
...
entry:
  ...
  %bs_dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 272821624, i32* %canary
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %currMB = alloca %struct.macroblock*, align 8
  %i = alloca i32, align 4
...
entry:
  ...
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %canary = alloca i32
  store i32 2132459163, i32* %canary
  %i = alloca i32, align 4
  store %struct.CSobj* %cs, %struct.CSobj** %cs.addr, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %currentSlice = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 50
...
entry:
  ...
  %bs_dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 1846348319, i32* %canary
  %cs.addr = alloca %struct.CSobj*, align 8
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
...
entry:
  ...
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 605294225, i32* %canary
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %i = alloca i32, align 4
  %currMB = alloca %struct.macroblock*, align 8
