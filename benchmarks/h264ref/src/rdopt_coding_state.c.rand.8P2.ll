; ModuleID = 'rdopt_coding_state.c.rand.8P2.bc'
...
func_store_coding_state.7:                        ; preds = %ctrl2
...
func_store_coding_state.11:                       ; preds = %ctrl5
...
ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_store_coding_state.7, label %ctrl3
...
ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_store_coding_state.10, label %func_store_coding_state.11
}
...
func_reset_coding_state.4:                        ; preds = %ctrl0
...
func_reset_coding_state.14:                       ; preds = %ctrl4
  call void @reset_coding_state.14(%struct.CSobj* %cs)
  ret void

func_reset_coding_state.15:                       ; preds = %ctrl5
  call void @reset_coding_state.15(%struct.CSobj* %cs)
  ret void

func_reset_coding_state.16:                       ; preds = %ctrl5
  call void @reset_coding_state.16(%struct.CSobj* %cs)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_reset_coding_state.4, label %ctrl1
...
ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_reset_coding_state.14, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_reset_coding_state.15, label %func_reset_coding_state.16
}
...
entry:
  ...
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 2027453307, i32* %canary
  %currMB = alloca %struct.macroblock*, align 8
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %bs_src = alloca %struct.Bitstream*, align 8
  %bs_dest = alloca %struct.Bitstream*, align 8
...
entry:
  ...
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %canary = alloca i32
  store i32 622646798, i32* %canary
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %cs.addr = alloca %struct.CSobj*, align 8
  store %struct.CSobj* %cs, %struct.CSobj** %cs.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 498242797, i32* %canary
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %cs.addr = alloca %struct.CSobj*, align 8
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %i = alloca i32, align 4
...
entry:
  ...
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 1985226242, i32* %canary
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
...
entry:
  ...
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %canary = alloca i32
  store i32 992993810, i32* %canary
  %i = alloca i32, align 4
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %cs.addr = alloca %struct.CSobj*, align 8
  %bs_src = alloca %struct.Bitstream*, align 8
...
entry:
  ...
  %cs.addr = alloca %struct.CSobj*, align 8
  %canary = alloca i32
  store i32 1991312559, i32* %canary
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %currMB = alloca %struct.macroblock*, align 8
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %i = alloca i32, align 4
...
entry:
  ...
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %canary = alloca i32
  store i32 1716994208, i32* %canary
  %cs.addr = alloca %struct.CSobj*, align 8
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %bs_src = alloca %struct.Bitstream*, align 8
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
...
entry:
  ...
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %canary = alloca i32
  store i32 148831248, i32* %canary
  %bs_dest = alloca %struct.Bitstream*, align 8
  %bs_src = alloca %struct.Bitstream*, align 8
  %i = alloca i32, align 4
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
...
entry:
  ...
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 386925530, i32* %canary
  %bs_dest = alloca %struct.Bitstream*, align 8
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
...
entry:
  ...
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 702475260, i32* %canary
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %bs_dest = alloca %struct.Bitstream*, align 8
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %bs_src = alloca %struct.Bitstream*, align 8
...
entry:
  ...
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %canary = alloca i32
  store i32 1987043056, i32* %canary
  %currMB = alloca %struct.macroblock*, align 8
  %bs_dest = alloca %struct.Bitstream*, align 8
  %i = alloca i32, align 4
  store %struct.CSobj* %cs, %struct.CSobj** %cs.addr, align 8
...
entry:
  ...
  %cs.addr = alloca %struct.CSobj*, align 8
  %canary = alloca i32
  store i32 896077056, i32* %canary
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %bs_src = alloca %struct.Bitstream*, align 8
  %bs_dest = alloca %struct.Bitstream*, align 8
...
entry:
  ...
  %bs_dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 2052317497, i32* %canary
  %bs_src = alloca %struct.Bitstream*, align 8
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  store %struct.CSobj* %cs, %struct.CSobj** %cs.addr, align 8
