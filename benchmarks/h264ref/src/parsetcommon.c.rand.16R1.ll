; ModuleID = 'parsetcommon.c.rand.16R1.bc'
source_filename = "parsetcommon.c"
...
if.then:                                          ; preds = %entry
  call void @no_mem_exit(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str, i64 0, i64 0))
  br label %if.end
...
if.then:                                          ; preds = %entry
  call void @no_mem_exit(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.2, i64 0, i64 0))
  br label %if.end
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FreePPS(%struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FreeSPS(%struct.seq_parameter_set_rbsp_t* %sps) #0 {
entry:
