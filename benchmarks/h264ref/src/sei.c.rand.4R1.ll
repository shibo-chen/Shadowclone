...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_write_sei_message.18, label %ctrl0

func_write_sei_message.18:                        ; preds = %rand_bb
  call void @write_sei_message.18(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type)
  ret void

func_write_sei_message.22:                        ; preds = %ctrl0
  call void @write_sei_message.22(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type)
  ret void

func_write_sei_message.47:                        ; preds = %ctrl1
  call void @write_sei_message.47(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type)
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_write_sei_message.22, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_write_sei_message.47, label %func_write_sei_message.56
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_finalize_sei_message.10, label %func_finalize_sei_message.32

func_finalize_sei_message.10:                     ; preds = %rand_bb
  call void @finalize_sei_message.10(i32 %id)
  ret void
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_AppendTmpbits2Buf.4, label %ctrl0

func_AppendTmpbits2Buf.4:                         ; preds = %rand_bb
  call void @AppendTmpbits2Buf.4(%struct.Bitstream* %dest, %struct.Bitstream* %source)
  ret void

func_AppendTmpbits2Buf.12:                        ; preds = %ctrl0
  call void @AppendTmpbits2Buf.12(%struct.Bitstream* %dest, %struct.Bitstream* %source)
  ret void

func_AppendTmpbits2Buf.36:                        ; preds = %ctrl1
  call void @AppendTmpbits2Buf.36(%struct.Bitstream* %dest, %struct.Bitstream* %source)
  ret void

func_AppendTmpbits2Buf.46:                        ; preds = %ctrl1
  call void @AppendTmpbits2Buf.46(%struct.Bitstream* %dest, %struct.Bitstream* %source)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_AppendTmpbits2Buf.12, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_AppendTmpbits2Buf.36, label %func_AppendTmpbits2Buf.46
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_ComposeSparePictureMessage.16, label %ctrl0

func_ComposeSparePictureMessage.16:               ; preds = %rand_bb
  call void @ComposeSparePictureMessage.16(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream)
  ret void

func_ComposeSparePictureMessage.30:               ; preds = %ctrl0
  call void @ComposeSparePictureMessage.30(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream)
  ret void

func_ComposeSparePictureMessage.38:               ; preds = %ctrl1
  call void @ComposeSparePictureMessage.38(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream)
  ret void

func_ComposeSparePictureMessage.41:               ; preds = %ctrl1
  call void @ComposeSparePictureMessage.41(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_ComposeSparePictureMessage.30, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_ComposeSparePictureMessage.38, label %func_ComposeSparePictureMessage.41
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_CompressSpareMBMap.53, label %ctrl0

func_CompressSpareMBMap.53:                       ; preds = %rand_bb
  %2 = call i32 @CompressSpareMBMap.53(i8** %map_sp, %struct.Bitstream* %bitstream)
  ret i32 %2

func_CompressSpareMBMap.54:                       ; preds = %ctrl0
  %3 = call i32 @CompressSpareMBMap.54(i8** %map_sp, %struct.Bitstream* %bitstream)
  ret i32 %3

func_CompressSpareMBMap.57:                       ; preds = %ctrl1
  %4 = call i32 @CompressSpareMBMap.57(i8** %map_sp, %struct.Bitstream* %bitstream)
  ret i32 %4
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_CompressSpareMBMap.54, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_CompressSpareMBMap.57, label %func_CompressSpareMBMap.58
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FinalizeSpareMBMap.24, label %ctrl0

func_FinalizeSpareMBMap.24:                       ; preds = %rand_bb
  call void @FinalizeSpareMBMap.24()
  ret void

func_FinalizeSpareMBMap.25:                       ; preds = %ctrl0
  call void @FinalizeSpareMBMap.25()
  ret void

func_FinalizeSpareMBMap.37:                       ; preds = %ctrl1
  call void @FinalizeSpareMBMap.37()
  ret void

func_FinalizeSpareMBMap.49:                       ; preds = %ctrl1
  call void @FinalizeSpareMBMap.49()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_FinalizeSpareMBMap.25, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_FinalizeSpareMBMap.37, label %func_FinalizeSpareMBMap.49
}
...
func_FinalizeSubseqInfo.7:                        ; preds = %ctrl0
  call void @FinalizeSubseqInfo.7(i32 %currLayer)
  ret void

func_FinalizeSubseqInfo.17:                       ; preds = %ctrl1
  call void @FinalizeSubseqInfo.17(i32 %currLayer)
  ret void

func_FinalizeSubseqInfo.34:                       ; preds = %ctrl1
  call void @FinalizeSubseqInfo.34(i32 %currLayer)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_FinalizeSubseqInfo.7, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_FinalizeSubseqInfo.17, label %func_FinalizeSubseqInfo.34
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FinalizeSubseqLayerInfo.50, label %func_FinalizeSubseqLayerInfo.52

func_FinalizeSubseqLayerInfo.50:                  ; preds = %rand_bb
  call void @FinalizeSubseqLayerInfo.50()
  ret void

func_FinalizeSubseqLayerInfo.52:                  ; preds = %rand_bb
  call void @FinalizeSubseqLayerInfo.52()
  ret void
}
...
func_FinalizeSubseqChar.39:                       ; preds = %ctrl1
  call void @FinalizeSubseqChar.39()
  ret void

func_FinalizeSubseqChar.51:                       ; preds = %ctrl1
  call void @FinalizeSubseqChar.51()
  ret void
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_FinalizeSubseqChar.39, label %func_FinalizeSubseqChar.51
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FinalizeSceneInformation.20, label %func_FinalizeSceneInformation.29

func_FinalizeSceneInformation.20:                 ; preds = %rand_bb
  call void @FinalizeSceneInformation.20()
  ret void

func_FinalizeSceneInformation.29:                 ; preds = %rand_bb
  call void @FinalizeSceneInformation.29()
  ret void
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_UpdateSceneInformation.26, label %ctrl0

func_UpdateSceneInformation.26:                   ; preds = %rand_bb
  call void @UpdateSceneInformation.26(i32 %HasSceneInformation, i32 %sceneID, i32 %sceneTransType, i32 %secondSceneID)
  ret void

func_UpdateSceneInformation.42:                   ; preds = %ctrl0
  call void @UpdateSceneInformation.42(i32 %HasSceneInformation, i32 %sceneID, i32 %sceneTransType, i32 %secondSceneID)
  ret void

func_UpdateSceneInformation.45:                   ; preds = %ctrl1
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_UpdateSceneInformation.42, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_UpdateSceneInformation.45, label %func_UpdateSceneInformation.48
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FinalizePanScanRectInfo.23, label %func_FinalizePanScanRectInfo.35

func_FinalizePanScanRectInfo.23:                  ; preds = %rand_bb
  call void @FinalizePanScanRectInfo.23()
  ret void

func_FinalizePanScanRectInfo.35:                  ; preds = %rand_bb
  call void @FinalizePanScanRectInfo.35()
  ret void
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_UpdateUser_data_unregistered.1, label %ctrl0

func_UpdateUser_data_unregistered.1:              ; preds = %rand_bb
  call void @UpdateUser_data_unregistered.1()
  ret void
...
func_UpdateUser_data_unregistered.14:             ; preds = %ctrl1
  call void @UpdateUser_data_unregistered.14()
  ret void

func_UpdateUser_data_unregistered.21:             ; preds = %ctrl1
  call void @UpdateUser_data_unregistered.21()
  ret void
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_UpdateUser_data_unregistered.14, label %func_UpdateUser_data_unregistered.21
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FinalizeUser_data_unregistered.8, label %ctrl0

func_FinalizeUser_data_unregistered.8:            ; preds = %rand_bb
  call void @FinalizeUser_data_unregistered.8()
  ret void

func_FinalizeUser_data_unregistered.9:            ; preds = %ctrl0
  call void @FinalizeUser_data_unregistered.9()
  ret void

func_FinalizeUser_data_unregistered.15:           ; preds = %ctrl1
  call void @FinalizeUser_data_unregistered.15()
  ret void

func_FinalizeUser_data_unregistered.19:           ; preds = %ctrl1
  call void @FinalizeUser_data_unregistered.19()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_FinalizeUser_data_unregistered.9, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_FinalizeUser_data_unregistered.15, label %func_FinalizeUser_data_unregistered.19
}
...
func_UpdateUser_data_registered_itu_t_t35.43:     ; preds = %ctrl1
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_UpdateUser_data_registered_itu_t_t35.43, label %func_UpdateUser_data_registered_itu_t_t35.44
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FinalizeUser_data_registered_itu_t_t35.11, label %ctrl0

func_FinalizeUser_data_registered_itu_t_t35.11:   ; preds = %rand_bb
  call void @FinalizeUser_data_registered_itu_t_t35.11()
  ret void

func_FinalizeUser_data_registered_itu_t_t35.27:   ; preds = %ctrl0
  call void @FinalizeUser_data_registered_itu_t_t35.27()
  ret void

func_FinalizeUser_data_registered_itu_t_t35.40:   ; preds = %ctrl1
  call void @FinalizeUser_data_registered_itu_t_t35.40()
  ret void

func_FinalizeUser_data_registered_itu_t_t35.55:   ; preds = %ctrl1
  call void @FinalizeUser_data_registered_itu_t_t35.55()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_FinalizeUser_data_registered_itu_t_t35.27, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_FinalizeUser_data_registered_itu_t_t35.40, label %func_FinalizeUser_data_registered_itu_t_t35.55
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FinalizeRandomAccess.2, label %func_FinalizeRandomAccess.31

func_FinalizeRandomAccess.2:                      ; preds = %rand_bb
  call void @FinalizeRandomAccess.2()
  ret void

func_FinalizeRandomAccess.31:                     ; preds = %rand_bb
  call void @FinalizeRandomAccess.31()
  ret void
}
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateUser_data_unregistered.1() #0 {
entry:
  %canary = alloca i32
  store i32 860732030, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeRandomAccess.2() #0 {
entry:
  %sym = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 280439930, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1443262520, i32* %canary
  %temp_data = alloca i32, align 4
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @AppendTmpbits2Buf.4(%struct.Bitstream* %dest, %struct.Bitstream* %source) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 909127535, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1293554436, i32* %canary
  %currLayer.addr = alloca i32, align 4
  %dest = alloca %struct.Bitstream*, align 8
  %sym = alloca %struct.syntaxelement, align 8
  store i32 %currLayer, i32* %currLayer.addr, align 4
...
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 956678670, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %dest = alloca %struct.Bitstream*, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.subseq_char_information_struct, %struct.subseq_char_information_struct* @seiSubseqChar, i32 0, i32 10), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSubseqInfo.7(i32 %currLayer) #0 {
entry:
  %canary = alloca i32
  store i32 1680490536, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  %sym = alloca %struct.syntaxelement, align 8
  %currLayer.addr = alloca i32, align 4
  store i32 %currLayer, i32* %currLayer.addr, align 4
...
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 2140884391, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  %sym = alloca %struct.syntaxelement, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_unregistered_information_struct, %struct.user_data_unregistered_information_struct* @seiUser_data_unregistered, i32 0, i32 2), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
...
entry:
  %canary = alloca i32
  store i32 1711191863, i32* %canary
  %i = alloca i32, align 4
  %sym = alloca %struct.syntaxelement, align 8
  %dest = alloca %struct.Bitstream*, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_unregistered_information_struct, %struct.user_data_unregistered_information_struct* @seiUser_data_unregistered, i32 0, i32 2), align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @finalize_sei_message.10(i32 %id) #0 {
entry:
  %canary = alloca i32
  store i32 358563063, i32* %canary
  %id.addr = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 2120862407, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  %sym = alloca %struct.syntaxelement, align 8
  %i = alloca i32, align 4
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_registered_itu_t_t35_information_struct, %struct.user_data_registered_itu_t_t35_information_struct* @seiUser_data_registered_itu_t_t35, i32 0, i32 4), align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @AppendTmpbits2Buf.12(%struct.Bitstream* %dest, %struct.Bitstream* %source) #0 {
entry:
  %bits_in_last_byte = alloca i32, align 4
  %source.addr = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 1208361707, i32* %canary
  %j = alloca i32, align 4
  %dest.addr = alloca %struct.Bitstream*, align 8
  %i = alloca i32, align 4
  %mask = alloca i8, align 1
...
entry:
  %canary = alloca i32
  store i32 168506893, i32* %canary
  %temp_data = alloca i32, align 4
  %i = alloca i32, align 4
  %total_byte = alloca i32, align 4
  store i32 7, i32* %total_byte, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateUser_data_unregistered.14() #0 {
entry:
  %temp_data = alloca i32, align 4
  %canary = alloca i32
  store i32 418707602, i32* %canary
  %total_byte = alloca i32, align 4
  %i = alloca i32, align 4
  store i32 7, i32* %total_byte, align 4
  store i32 0, i32* %i, align 4
...
entry:
  %dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 1589373271, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %i = alloca i32, align 4
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_unregistered_information_struct, %struct.user_data_unregistered_information_struct* @seiUser_data_unregistered, i32 0, i32 2), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
...
entry:
  %canary = alloca i32
  store i32 1560015690, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1586632948, i32* %canary
  %currLayer.addr = alloca i32, align 4
  %sym = alloca %struct.syntaxelement, align 8
  %dest = alloca %struct.Bitstream*, align 8
  store i32 %currLayer, i32* %currLayer.addr, align 4
...
entry:
  ...
  %offset = alloca i32, align 4
  %canary = alloca i32
  store i32 1024699061, i32* %canary
...
entry:
  %dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 417996327, i32* %canary
  %i = alloca i32, align 4
  %sym = alloca %struct.syntaxelement, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_unregistered_information_struct, %struct.user_data_unregistered_information_struct* @seiUser_data_unregistered, i32 0, i32 2), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSceneInformation.20() #0 {
entry:
  %canary = alloca i32
  store i32 794194454, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  %sym = alloca %struct.syntaxelement, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.scene_information_struct, %struct.scene_information_struct* @seiSceneInformation, i32 0, i32 3), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateUser_data_unregistered.21() #0 {
entry:
  %canary = alloca i32
  store i32 1161443847, i32* %canary
  %i = alloca i32, align 4
  %temp_data = alloca i32, align 4
  %total_byte = alloca i32, align 4
  store i32 7, i32* %total_byte, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_sei_message.22(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type) #0 {
entry:
  %canary = alloca i32
  store i32 1703168081, i32* %canary
  %payload_size.addr = alloca i32, align 4
  %size = alloca i32, align 4
  %offset = alloca i32, align 4
  %payload.addr = alloca i8*, align 8
...
entry:
  %dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 2068106231, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.panscanrect_information_struct, %struct.panscanrect_information_struct* @seiPanScanRectInfo, i32 0, i32 5), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
  %type = getelementptr inbounds %struct.syntaxelement, %struct.syntaxelement* %sym, i32 0, i32 0
...
entry:
  ...
  %canary = alloca i32
  store i32 509503746, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSpareMBMap.25() #0 {
entry:
  %CurrFrameNum = alloca i32, align 4
  %delta_frame_num = alloca i32, align 4
  %canary = alloca i32
  store i32 1999073094, i32* %canary
  %source = alloca %struct.Bitstream*, align 8
  %dest = alloca %struct.Bitstream*, align 8
  %sym = alloca %struct.syntaxelement, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
entry:
  ...
  %canary = alloca i32
  store i32 1950297279, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeUser_data_registered_itu_t_t35.27() #0 {
entry:
  %canary = alloca i32
  store i32 465375128, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %dest = alloca %struct.Bitstream*, align 8
  %i = alloca i32, align 4
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_registered_itu_t_t35_information_struct, %struct.user_data_registered_itu_t_t35_information_struct* @seiUser_data_registered_itu_t_t35, i32 0, i32 4), align 8
...
entry:
  ...
  %dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 1141799821, i32* %canary
  %i = alloca i32, align 4
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.subseq_char_information_struct, %struct.subseq_char_information_struct* @seiSubseqChar, i32 0, i32 10), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
  %type = getelementptr inbounds %struct.syntaxelement, %struct.syntaxelement* %sym, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSceneInformation.29() #0 {
entry:
  %canary = alloca i32
  store i32 252200498, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %dest = alloca %struct.Bitstream*, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.scene_information_struct, %struct.scene_information_struct* @seiSceneInformation, i32 0, i32 3), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
...
entry:
  ...
  %bitstream = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 2001841847, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  store i32 %delta_spare_frame_num, i32* %delta_spare_frame_num.addr, align 4
  store i32 %ref_area_indicator, i32* %ref_area_indicator.addr, align 4
  store %struct.Bitstream* %tmpBitstream, %struct.Bitstream** %tmpBitstream.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeRandomAccess.31() #0 {
entry:
  %dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 1012969627, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.randomaccess_information_struct, %struct.randomaccess_information_struct* @seiRandomAccess, i32 0, i32 3), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
  %type = getelementptr inbounds %struct.syntaxelement, %struct.syntaxelement* %sym, i32 0, i32 0
...
entry:
  %canary = alloca i32
  store i32 872244120, i32* %canary
  %offset = alloca i32, align 4
  %id.addr = alloca i32, align 4
  store i32 %id, i32* %id.addr, align 4
  %0 = load i32, i32* %id.addr, align 4
...
entry:
  ...
  %country_code = alloca i32, align 4
  %canary = alloca i32
  store i32 764479930, i32* %canary
  %i = alloca i32, align 4
  %temp_data = alloca i32, align 4
  store i32 82, i32* %country_code, align 4
  %0 = load i32, i32* %country_code, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSubseqInfo.34(i32 %currLayer) #0 {
entry:
  %sym = alloca %struct.syntaxelement, align 8
  %dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 1508147444, i32* %canary
  %currLayer.addr = alloca i32, align 4
  store i32 %currLayer, i32* %currLayer.addr, align 4
  %0 = load i32, i32* %currLayer.addr, align 4
  %idxprom = sext i32 %0 to i64
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizePanScanRectInfo.35() #0 {
entry:
  %canary = alloca i32
  store i32 2041740220, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %dest = alloca %struct.Bitstream*, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.panscanrect_information_struct, %struct.panscanrect_information_struct* @seiPanScanRectInfo, i32 0, i32 5), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @AppendTmpbits2Buf.36(%struct.Bitstream* %dest, %struct.Bitstream* %source) #0 {
entry:
  %dest.addr = alloca %struct.Bitstream*, align 8
  %bits_in_last_byte = alloca i32, align 4
  %canary = alloca i32
  store i32 865470802, i32* %canary
  %i = alloca i32, align 4
  %source.addr = alloca %struct.Bitstream*, align 8
  %mask = alloca i8, align 1
  %j = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSpareMBMap.37() #0 {
entry:
  %canary = alloca i32
  store i32 481256743, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %CurrFrameNum = alloca i32, align 4
  %delta_frame_num = alloca i32, align 4
  %dest = alloca %struct.Bitstream*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @ComposeSparePictureMessage.38(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream) #0 {
entry:
  %bitstream = alloca %struct.Bitstream*, align 8
  %ref_area_indicator.addr = alloca i32, align 4
  %delta_spare_frame_num.addr = alloca i32, align 4
  %sym = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 899707436, i32* %canary
  %tmpBitstream.addr = alloca %struct.Bitstream*, align 8
  store i32 %delta_spare_frame_num, i32* %delta_spare_frame_num.addr, align 4
  store i32 %ref_area_indicator, i32* %ref_area_indicator.addr, align 4
  store %struct.Bitstream* %tmpBitstream, %struct.Bitstream** %tmpBitstream.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSubseqChar.39() #0 {
entry:
  %canary = alloca i32
  store i32 1873118086, i32* %canary
  %i = alloca i32, align 4
  %dest = alloca %struct.Bitstream*, align 8
  %sym = alloca %struct.syntaxelement, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.subseq_char_information_struct, %struct.subseq_char_information_struct* @seiSubseqChar, i32 0, i32 10), align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeUser_data_registered_itu_t_t35.40() #0 {
entry:
  %canary = alloca i32
  store i32 1545948058, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %i = alloca i32, align 4
  %dest = alloca %struct.Bitstream*, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_registered_itu_t_t35_information_struct, %struct.user_data_registered_itu_t_t35_information_struct* @seiUser_data_registered_itu_t_t35, i32 0, i32 4), align 8
...
entry:
  %bitstream = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 1589350175, i32* %canary
  %tmpBitstream.addr = alloca %struct.Bitstream*, align 8
  %delta_spare_frame_num.addr = alloca i32, align 4
  %ref_area_indicator.addr = alloca i32, align 4
  %sym = alloca %struct.syntaxelement, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateSceneInformation.42(i32 %HasSceneInformation, i32 %sceneID, i32 %sceneTransType, i32 %secondSceneID) #0 {
entry:
  %canary = alloca i32
  store i32 1018906275, i32* %canary
  %secondSceneID.addr = alloca i32, align 4
  %HasSceneInformation.addr = alloca i32, align 4
  %sceneID.addr = alloca i32, align 4
  %sceneTransType.addr = alloca i32, align 4
...
entry:
  %total_byte = alloca i32, align 4
  %canary = alloca i32
  store i32 1985050221, i32* %canary
  %i = alloca i32, align 4
  %temp_data = alloca i32, align 4
  %country_code = alloca i32, align 4
  store i32 82, i32* %country_code, align 4
...
entry:
  %canary = alloca i32
  store i32 1819564959, i32* %canary
  %total_byte = alloca i32, align 4
  %i = alloca i32, align 4
  %country_code = alloca i32, align 4
  %temp_data = alloca i32, align 4
...
entry:
  ...
  %sceneID.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 981566942, i32* %canary
  %secondSceneID.addr = alloca i32, align 4
  store i32 %HasSceneInformation, i32* %HasSceneInformation.addr, align 4
  store i32 %sceneID, i32* %sceneID.addr, align 4
  store i32 %sceneTransType, i32* %sceneTransType.addr, align 4
...
entry:
  ...
  %bits_in_last_byte = alloca i32, align 4
  %canary = alloca i32
  store i32 1526623119, i32* %canary
  %dest.addr = alloca %struct.Bitstream*, align 8
  %j = alloca i32, align 4
  store %struct.Bitstream* %dest, %struct.Bitstream** %dest.addr, align 8
  store %struct.Bitstream* %source, %struct.Bitstream** %source.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_sei_message.47(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type) #0 {
entry:
  %offset = alloca i32, align 4
  %payload_type.addr = alloca i32, align 4
  %payload_size.addr = alloca i32, align 4
  ...
  %id.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1127091335, i32* %canary
  %size = alloca i32, align 4
  %type = alloca i32, align 4
  store i32 %id, i32* %id.addr, align 4
  store i8* %payload, i8** %payload.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 747502622, i32* %canary
  %secondSceneID.addr = alloca i32, align 4
  %sceneID.addr = alloca i32, align 4
  %HasSceneInformation.addr = alloca i32, align 4
  %sceneTransType.addr = alloca i32, align 4
...
entry:
  ...
  %dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 2036000156, i32* %canary
  %source = alloca %struct.Bitstream*, align 8
  %delta_frame_num = alloca i32, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %number = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 0
...
entry:
  %canary = alloca i32
  store i32 556813608, i32* %canary
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSubseqChar.51() #0 {
entry:
  %sym = alloca %struct.syntaxelement, align 8
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1346794143, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.subseq_char_information_struct, %struct.subseq_char_information_struct* @seiSubseqChar, i32 0, i32 10), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
  %type = getelementptr inbounds %struct.syntaxelement, %struct.syntaxelement* %sym, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSubseqLayerInfo.52() #0 {
entry:
  %pos = alloca i32, align 4
  %canary = alloca i32
  store i32 2075043311, i32* %canary
  %i = alloca i32, align 4
  store i32 0, i32* %pos, align 4
  store i32 0, i32* getelementptr inbounds (%struct.subseq_layer_information_struct, %struct.subseq_layer_information_struct* @seiSubseqLayerInfo, i32 0, i32 4), align 4
  store i32 0, i32* %i, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @CompressSpareMBMap.53(i8** %map_sp, %struct.Bitstream* %bitstream) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 553663446, i32* %canary
...
entry:
  ...
  %directy = alloca i32, align 4
  %canary = alloca i32
  store i32 185070868, i32* %canary
  %left = alloca i32, align 4
  %size_uncompressed = alloca i32, align 4
  %bit1 = alloca i32, align 4
  %sym = alloca %struct.syntaxelement, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeUser_data_registered_itu_t_t35.55() #0 {
entry:
  %dest = alloca %struct.Bitstream*, align 8
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1028894220, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_registered_itu_t_t35_information_struct, %struct.user_data_registered_itu_t_t35_information_struct* @seiUser_data_registered_itu_t_t35, i32 0, i32 4), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
  %type = getelementptr inbounds %struct.syntaxelement, %struct.syntaxelement* %sym, i32 0, i32 0
...
entry:
  %canary = alloca i32
  store i32 1889008417, i32* %canary
  %offset = alloca i32, align 4
  %payload_size.addr = alloca i32, align 4
  %payload.addr = alloca i8*, align 8
  %payload_type.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @CompressSpareMBMap.57(i8** %map_sp, %struct.Bitstream* %bitstream) #0 {
entry:
  %directy = alloca i32, align 4
  %right = alloca i32, align 4
  %j = alloca i32, align 4
  ...
  %bit1 = alloca i32, align 4
  %canary = alloca i32
  store i32 1374630063, i32* %canary
  %noc = alloca i32, align 4
  %k = alloca i32, align 4
  %bitstream.addr = alloca %struct.Bitstream*, align 8
  %ret = alloca i32, align 4
...
if.end190:                                        ; preds = %for.end189, %if.end141
  %121 = load i32, i32* %ret, align 4
  %122 = load i32, i32* %canary
  %123 = icmp eq i32 %122, 1374630063
  br i1 %123, label %124, label %func_exit
...
entry:
  ...
  %noc = alloca i32, align 4
  %canary = alloca i32
  store i32 1111609931, i32* %canary
  %bottom = alloca i32, align 4
  %directx = alloca i32, align 4
  %k = alloca i32, align 4
  %x = alloca i32, align 4
...
if.end190:                                        ; preds = %for.end189, %if.end141
  %121 = load i32, i32* %ret, align 4
  %122 = load i32, i32* %canary
  %123 = icmp eq i32 %122, 1111609931
  br i1 %123, label %124, label %func_exit
