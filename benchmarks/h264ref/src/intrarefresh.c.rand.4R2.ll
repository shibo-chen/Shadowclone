; ModuleID = 'intrarefresh.c.rand.4R2.bc'
...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_RandomIntraInit.3, label %ctrl0

func_RandomIntraInit.3:                           ; preds = %rand_bb
  call void @RandomIntraInit.3(i32 %xsize, i32 %ysize, i32 %refresh)
  ret void

func_RandomIntraInit.8:                           ; preds = %ctrl0
  call void @RandomIntraInit.8(i32 %xsize, i32 %ysize, i32 %refresh)
  ret void

func_RandomIntraInit.9:                           ; preds = %ctrl1
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_RandomIntraInit.8, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_RandomIntraInit.9, label %func_RandomIntraInit.10
}
...
func_RandomIntra.2:                               ; preds = %ctrl0
  %3 = call i32 @RandomIntra.2(i32 %mb)
  ret i32 %3
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_RandomIntra.2, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_RandomIntra.4, label %func_RandomIntra.7
}
...
entry:
  ...
  %canary = alloca i32
  store i32 487831173, i32* %canary
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1047712853, i32* %canary
  %mb.addr = alloca i32, align 4
  store i32 %mb, i32* %mb.addr, align 4
  store i32 0, i32* %i, align 4
  br label %for.cond
...
entry:
  ...
  %canary = alloca i32
  store i32 752471671, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 288925989, i32* %canary
  %mb.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %retval = alloca i32, align 4
  store i32 %mb, i32* %mb.addr, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 1779861175, i32* %canary
  %i = alloca i32, align 4
...
entry:
  ...
  %mb.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 203975434, i32* %canary
  %retval = alloca i32, align 4
  store i32 %mb, i32* %mb.addr, align 4
  store i32 0, i32* %i, align 4
  br label %for.cond
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1575098303, i32* %canary
  %ysize.addr = alloca i32, align 4
  %xsize.addr = alloca i32, align 4
  store i32 %xsize, i32* %xsize.addr, align 4
  store i32 %ysize, i32* %ysize.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 937298339, i32* %canary
  %pos = alloca i32, align 4
  %i = alloca i32, align 4
  %xsize.addr = alloca i32, align 4
  %ysize.addr = alloca i32, align 4
...
entry:
  ...
  %refresh.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1603771653, i32* %canary
  %i = alloca i32, align 4
  %ysize.addr = alloca i32, align 4
  store i32 %xsize, i32* %xsize.addr, align 4
  store i32 %ysize, i32* %ysize.addr, align 4
