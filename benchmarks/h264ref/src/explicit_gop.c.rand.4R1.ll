; ModuleID = 'explicit_gop.c.rand.4R1.bc'
...
func_create_pyramid.4:                            ; preds = %ctrl0
  call void @create_pyramid.4()
  ret void

func_create_pyramid.6:                            ; preds = %ctrl1
  call void @create_pyramid.6()
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_create_pyramid.4, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_create_pyramid.6, label %func_create_pyramid.14
}
...
func_gop_pyramid.8:                               ; preds = %ctrl0
  call void @gop_pyramid.8(i32 %level, i32 %frm_no, i32 %frames, %struct.GOP_DATA* %pyramid_structure)
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_gop_pyramid.8, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_gop_pyramid.10, label %func_gop_pyramid.11
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_interpret_gop_structure.9, label %ctrl0

func_interpret_gop_structure.9:                   ; preds = %rand_bb
...
func_poc_based_ref_management.7:                  ; preds = %ctrl1
  call void @poc_based_ref_management.7(i32 %current_pic_num)
  ret void

func_poc_based_ref_management.13:                 ; preds = %ctrl1
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_poc_based_ref_management.7, label %func_poc_based_ref_management.13
}
...
entry:
  %canary = alloca i32
  store i32 1407754994, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1526895763, i32* %canary
...
if.end200:                                        ; preds = %for.end199, %for.end
  ...
  %162 = icmp eq i32 %161, 1526895763
...
entry:
  ...
  %canary = alloca i32
  store i32 1381324853, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @create_pyramid.4() #0 {
entry:
  %tempnum = alloca i32, align 4
  %j = alloca i32, align 4
  %centerB = alloca i32, align 4
  %prvlevelrefs = alloca i32, align 4
  %canary = alloca i32
  store i32 681483981, i32* %canary
  %levelrefs = alloca i32, align 4
  %curGOPLeveldist = alloca i32*, align 8
  %i = alloca i32, align 4
  %Bframes = alloca i32, align 4
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 935103614, i32* %canary
  %tmp_drpm2 = alloca %struct.DecRefPicMarking_s*, align 8
  %pic_num = alloca i32, align 4
  %min_poc = alloca i32, align 4
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @create_pyramid.6() #0 {
entry:
  %curlevel = alloca i32, align 4
  %GOPlevels = alloca i32, align 4
  %Bframes = alloca i32, align 4
  ...
  %tempnum = alloca i32, align 4
  %canary = alloca i32
  store i32 1450554353, i32* %canary
  %i28 = alloca i32, align 4
  %prvlevelrefs = alloca i32, align 4
  %curGOPLevelfrm = alloca i32*, align 8
  %centerB = alloca i32, align 4
...
if.end200:                                        ; preds = %for.end199, %for.end
  %161 = load i32, i32* %canary
  %162 = icmp eq i32 %161, 1450554353
  br i1 %162, label %163, label %func_exit
...
entry:
  %canary = alloca i32
  store i32 131533512, i32* %canary
  %min_poc = alloca i32, align 4
  %pic_num = alloca i32, align 4
  %i = alloca i32, align 4
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @gop_pyramid.8(i32 %level, i32 %frm_no, i32 %frames, %struct.GOP_DATA* %pyramid_structure) #0 {
entry:
  %canary = alloca i32
  store i32 1657874630, i32* %canary
  %frames.addr = alloca i32, align 4
  %frm_no.addr = alloca i32, align 4
  %pyramid_structure.addr = alloca %struct.GOP_DATA*, align 8
  %level.addr = alloca i32, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 1494148032, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 114312606, i32* %canary
  %level.addr = alloca i32, align 4
  %frames.addr = alloca i32, align 4
  %frm_no.addr = alloca i32, align 4
  %pyramid_structure.addr = alloca %struct.GOP_DATA*, align 8
...
entry:
  ...
  %pyramid_structure.addr = alloca %struct.GOP_DATA*, align 8
  %canary = alloca i32
  store i32 1624003031, i32* %canary
  %frames.addr = alloca i32, align 4
  %level.addr = alloca i32, align 4
  store i32 %level, i32* %level.addr, align 4
  store i32 %frm_no, i32* %frm_no.addr, align 4
...
entry:
  ...
  %order_read = alloca i32, align 4
  %canary = alloca i32
  store i32 588255657, i32* %canary
  %coded_frame = alloca i32, align 4
  %qp_read = alloca i32, align 4
  %nLength = alloca i32, align 4
  %i = alloca i32, align 4
...
entry:
  ...
  %pic_num = alloca i32, align 4
  %canary = alloca i32
  store i32 1693916558, i32* %canary
  %current_pic_num.addr = alloca i32, align 4
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
  %i = alloca i32, align 4
  store i32 %current_pic_num, i32* %current_pic_num.addr, align 4
...
entry:
  ...
  %curGOPLevelfrm = alloca i32*, align 8
  %canary = alloca i32
  store i32 2062748785, i32* %canary
  %i28 = alloca i32, align 4
  %Bframes = alloca i32, align 4
  %levelrefs = alloca i32, align 4
  %curGOPLeveldist = alloca i32*, align 8
...
if.end200:                                        ; preds = %for.end199, %for.end
  %161 = load i32, i32* %canary
  %162 = icmp eq i32 %161, 2062748785
  br i1 %162, label %163, label %func_exit
...
entry:
  ...
  %qp_read = alloca i32, align 4
  %canary = alloca i32
  store i32 1615771424, i32* %canary
  %k = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %ExplicitPyramidFormat = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 56
  %arraydecay = getelementptr inbounds [1024 x i8], [1024 x i8]* %ExplicitPyramidFormat, i64 0, i64 0
...
entry:
  ...
  %k = alloca i32, align 4
  %canary = alloca i32
  store i32 1473254094, i32* %canary
  %qp = alloca i32, align 4
  %i = alloca i32, align 4
  %order_read = alloca i32, align 4
  %nLength = alloca i32, align 4
