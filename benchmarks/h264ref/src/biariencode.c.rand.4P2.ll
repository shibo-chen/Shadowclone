; ModuleID = 'biariencode.c.rand.4P2.bc'
...
func_arienco_start_encoding.16:                   ; preds = %ctrl0
...
func_arienco_start_encoding.20:                   ; preds = %ctrl1
  call void @arienco_start_encoding.20(%struct.EncodingEnvironment* %eep, i8* %code_buffer, i32* %code_len, i32 %slice_type)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_arienco_start_encoding.16, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_arienco_start_encoding.18, label %func_arienco_start_encoding.20
}
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_biari_encode_symbol.11, label %func_biari_encode_symbol.13
}
...
func_biari_encode_symbol_eq_prob.19:              ; preds = %ctrl1
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_biari_encode_symbol_eq_prob.17, label %func_biari_encode_symbol_eq_prob.19
}
...
func_biari_encode_symbol_final.9:                 ; preds = %ctrl0
...
func_biari_encode_symbol_final.15:                ; preds = %ctrl1
  call void @biari_encode_symbol_final.15(%struct.EncodingEnvironment* %eep, i16 %symbol)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_biari_encode_symbol_final.9, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_biari_encode_symbol_final.10, label %func_biari_encode_symbol_final.15
}
...
func_biari_init_context.5:                        ; preds = %ctrl0
...
func_biari_init_context.14:                       ; preds = %ctrl1
  call void @biari_init_context.14(%struct.BiContextType* %ctx, i32* %ini)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_biari_init_context.5, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_biari_init_context.6, label %func_biari_init_context.14
}
...
entry:
  ...
  %canary = alloca i32
  store i32 883236915, i32* %canary
...
entry:
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 777891102, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1836639335, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 208607897, i32* %canary
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %low = alloca i32, align 4
  %range = alloca i32, align 4
  %symbol.addr = alloca i16, align 2
...
entry:
  %canary = alloca i32
  store i32 656812501, i32* %canary
  %pstate = alloca i32, align 4
  %ctx.addr = alloca %struct.BiContextType*, align 8
  %ini.addr = alloca i32*, align 8
  store %struct.BiContextType* %ctx, %struct.BiContextType** %ctx.addr, align 8
...
entry:
  %ini.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 1759931918, i32* %canary
  %ctx.addr = alloca %struct.BiContextType*, align 8
  %pstate = alloca i32, align 4
  store %struct.BiContextType* %ctx, %struct.BiContextType** %ctx.addr, align 8
  store i32* %ini, i32** %ini.addr, align 8
...
entry:
  %low = alloca i32, align 4
  %canary = alloca i32
  store i32 272321562, i32* %canary
  %bi_ct.addr = alloca %struct.BiContextType*, align 8
  %rLPS = alloca i32, align 4
  %symbol.addr = alloca i16, align 2
  %range = alloca i32, align 4
...
entry:
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 1466764804, i32* %canary
  %symbol.addr = alloca i16, align 2
  %low = alloca i32, align 4
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
...
if.end124:                                        ; preds = %if.end123, %while.end51
  ...
  %105 = icmp eq i32 %104, 1466764804
...
entry:
  ...
  %low = alloca i32, align 4
  %canary = alloca i32
  store i32 1998388900, i32* %canary
  %range = alloca i32, align 4
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
...
while.end125:                                     ; preds = %while.cond
  ...
  store i32 %inc129, i32* %C128, align 8
  %110 = load i32, i32* %canary
  %111 = icmp eq i32 %110, 1998388900
  br i1 %111, label %112, label %func_exit
...
entry:
  ...
  %low = alloca i32, align 4
  %canary = alloca i32
  store i32 300894962, i32* %canary
  %symbol.addr = alloca i16, align 2
  %range = alloca i32, align 4
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
...
entry:
  %rLPS = alloca i32, align 4
  %canary = alloca i32
  store i32 1983905196, i32* %canary
  %symbol.addr = alloca i16, align 2
  %bi_ct.addr = alloca %struct.BiContextType*, align 8
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %low = alloca i32, align 4
...
while.end162:                                     ; preds = %while.cond
  ...
  store i32 %inc166, i32* %C165, align 8
  %136 = load i32, i32* %canary
  %137 = icmp eq i32 %136, 1983905196
  br i1 %137, label %138, label %func_exit
...
entry:
  %canary = alloca i32
  store i32 1653848720, i32* %canary
  %low = alloca i32, align 4
  %symbol.addr = alloca i16, align 2
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
...
if.end124:                                        ; preds = %if.end123, %while.end51
  ...
  store i32 %inc127, i32* %C126, align 8
  %104 = load i32, i32* %canary
  %105 = icmp eq i32 %104, 1653848720
  br i1 %105, label %106, label %func_exit
...
entry:
  ...
  %range = alloca i32, align 4
  %canary = alloca i32
  store i32 1134094897, i32* %canary
  %low = alloca i32, align 4
  %bi_ct.addr = alloca %struct.BiContextType*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
...
while.end162:                                     ; preds = %while.cond
  ...
  store i32 %inc166, i32* %C165, align 8
  %136 = load i32, i32* %canary
  %137 = icmp eq i32 %136, 1134094897
  br i1 %137, label %138, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_init_context.14(%struct.BiContextType* %ctx, i32* %ini) #0 {
entry:
  %canary = alloca i32
  store i32 588328901, i32* %canary
  %ini.addr = alloca i32*, align 8
  %pstate = alloca i32, align 4
  %ctx.addr = alloca %struct.BiContextType*, align 8
  store %struct.BiContextType* %ctx, %struct.BiContextType** %ctx.addr, align 8
...
entry:
  %range = alloca i32, align 4
  %canary = alloca i32
  store i32 339953618, i32* %canary
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %symbol.addr = alloca i16, align 2
  %low = alloca i32, align 4
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 701193803, i32* %canary
  %symbol.addr = alloca i16, align 2
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %low = alloca i32, align 4
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
...
entry:
  ...
  %code_len.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 1446325709, i32* %canary
  %code_buffer.addr = alloca i8*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i8* %code_buffer, i8** %code_buffer.addr, align 8
  store i32* %code_len, i32** %code_len.addr, align 8
...
entry:
  %symbol.addr = alloca i16, align 2
  %canary = alloca i32
  store i32 705433153, i32* %canary
  %low = alloca i32, align 4
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @arienco_start_encoding.20(%struct.EncodingEnvironment* %eep, i8* %code_buffer, i32* %code_len, i32 %slice_type) #0 {
entry:
  %code_buffer.addr = alloca i8*, align 8
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %slice_type.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1320509470, i32* %canary
  %code_len.addr = alloca i32*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i8* %code_buffer, i8** %code_buffer.addr, align 8
  store i32* %code_len, i32** %code_len.addr, align 8
