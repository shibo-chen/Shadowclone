; ModuleID = 'explicit_gop.c.rand.4R3.bc'
...
func_create_pyramid.13:                           ; preds = %ctrl1
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_create_pyramid.10, label %func_create_pyramid.13
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_gop_pyramid.8, label %ctrl0

func_gop_pyramid.8:                               ; preds = %rand_bb
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_gop_pyramid.12, label %func_gop_pyramid.14
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_interpret_gop_structure.1, label %ctrl0

func_interpret_gop_structure.1:                   ; preds = %rand_bb
  call void @interpret_gop_structure.1()
  ret void
...
func_interpret_gop_structure.11:                  ; preds = %ctrl1
  call void @interpret_gop_structure.11()
  ret void
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_interpret_gop_structure.7, label %func_interpret_gop_structure.11
}
...
func_poc_based_ref_management.16:                 ; preds = %ctrl1
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_poc_based_ref_management.15, label %func_poc_based_ref_management.16
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @interpret_gop_structure.1() #0 {
entry:
  %nLength = alloca i32, align 4
  %canary = alloca i32
  store i32 2024712135, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 160084492, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1201283415, i32* %canary
...
if.end200:                                        ; preds = %for.end199, %for.end
  ...
  %162 = icmp eq i32 %161, 1201283415
...
entry:
  %qp_read = alloca i32, align 4
  %canary = alloca i32
  store i32 551047073, i32* %canary
  %i = alloca i32, align 4
  %k = alloca i32, align 4
  %qp = alloca i32, align 4
  %order_read = alloca i32, align 4
...
entry:
  ...
  %i28 = alloca i32, align 4
  %canary = alloca i32
  store i32 1622224394, i32* %canary
  %i = alloca i32, align 4
  %centerB = alloca i32, align 4
  %Bframes = alloca i32, align 4
  %prvlevelrefs = alloca i32, align 4
...
if.end200:                                        ; preds = %for.end199, %for.end
  %161 = load i32, i32* %canary
  %162 = icmp eq i32 %161, 1622224394
  br i1 %162, label %163, label %func_exit
...
entry:
  %canary = alloca i32
  store i32 1724841501, i32* %canary
  %i = alloca i32, align 4
  %current_pic_num.addr = alloca i32, align 4
  %min_poc = alloca i32, align 4
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
...
entry:
  ...
  %order_read = alloca i32, align 4
  %canary = alloca i32
  store i32 495071182, i32* %canary
  %nLength = alloca i32, align 4
  %k = alloca i32, align 4
  %qp_read = alloca i32, align 4
  %display_no = alloca i32, align 4
...
entry:
  ...
  %level.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1252713999, i32* %canary
  %frm_no.addr = alloca i32, align 4
  store i32 %level, i32* %level.addr, align 4
  store i32 %frm_no, i32* %frm_no.addr, align 4
  store i32 %frames, i32* %frames.addr, align 4
...
entry:
  ...
  %centerB = alloca i32, align 4
  %canary = alloca i32
  store i32 1106877256, i32* %canary
  %tempnum = alloca i32, align 4
  %Bframes = alloca i32, align 4
  %levelrefs = alloca i32, align 4
  %i = alloca i32, align 4
...
if.end200:                                        ; preds = %for.end199, %for.end
  %161 = load i32, i32* %canary
  %162 = icmp eq i32 %161, 1106877256
  br i1 %162, label %163, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @interpret_gop_structure.11() #0 {
entry:
  %i = alloca i32, align 4
  %order_read = alloca i32, align 4
  %qp = alloca i32, align 4
  ...
  %k = alloca i32, align 4
  %canary = alloca i32
  store i32 1600877006, i32* %canary
  %coded_frame = alloca i32, align 4
  %slice_read = alloca i32, align 4
  %qp_read = alloca i32, align 4
  %display_no = alloca i32, align 4
...
entry:
  ...
  %frm_no.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 113364126, i32* %canary
  %pyramid_structure.addr = alloca %struct.GOP_DATA*, align 8
  store i32 %level, i32* %level.addr, align 4
  store i32 %frm_no, i32* %frm_no.addr, align 4
  store i32 %frames, i32* %frames.addr, align 4
...
entry:
  ...
  %Bframes = alloca i32, align 4
  %canary = alloca i32
  store i32 1791961826, i32* %canary
  %i28 = alloca i32, align 4
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %curlevel = alloca i32, align 4
...
if.end200:                                        ; preds = %for.end199, %for.end
  %161 = load i32, i32* %canary
  %162 = icmp eq i32 %161, 1791961826
  br i1 %162, label %163, label %func_exit
...
entry:
  ...
  %pyramid_structure.addr = alloca %struct.GOP_DATA*, align 8
  %canary = alloca i32
  store i32 346958280, i32* %canary
  %frm_no.addr = alloca i32, align 4
  %level.addr = alloca i32, align 4
  store i32 %level, i32* %level.addr, align 4
  store i32 %frm_no, i32* %frm_no.addr, align 4
...
entry:
  ...
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
  %canary = alloca i32
  store i32 2133810040, i32* %canary
  %pic_num = alloca i32, align 4
  %i = alloca i32, align 4
  store i32 %current_pic_num, i32* %current_pic_num.addr, align 4
  store i32 0, i32* %pic_num, align 4
...
entry:
  %canary = alloca i32
  store i32 874614107, i32* %canary
  %min_poc = alloca i32, align 4
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
  %tmp_drpm2 = alloca %struct.DecRefPicMarking_s*, align 8
  %current_pic_num.addr = alloca i32, align 4
