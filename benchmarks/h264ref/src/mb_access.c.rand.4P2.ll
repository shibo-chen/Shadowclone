; ModuleID = 'mb_access.c.rand.4P2.bc'
...
func_mb_is_available.8:                           ; preds = %ctrl1
  %4 = call i32 @mb_is_available.8(i32 %mbAddr, i32 %currMbAddr)
  ret i32 %4

func_mb_is_available.14:                          ; preds = %ctrl1
  %5 = call i32 @mb_is_available.14(i32 %mbAddr, i32 %currMbAddr)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_mb_is_available.7, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_mb_is_available.8, label %func_mb_is_available.14
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_CheckAvailabilityOfNeighbors.1, label %func_CheckAvailabilityOfNeighbors.20
...
func_get_mb_block_pos.6:                          ; preds = %ctrl0
  call void @get_mb_block_pos.6(i32 %mb_addr, i32* %x, i32* %y)
  ret void

func_get_mb_block_pos.16:                         ; preds = %ctrl1
  call void @get_mb_block_pos.16(i32 %mb_addr, i32* %x, i32* %y)
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_get_mb_block_pos.6, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_get_mb_block_pos.16, label %func_get_mb_block_pos.19
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_get_mb_pos.11, label %ctrl0

func_get_mb_pos.11:                               ; preds = %rand_bb
...
func_get_mb_pos.31:                               ; preds = %ctrl1
  call void @get_mb_pos.31(i32 %mb_addr, i32* %x, i32* %y)
  ret void
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_get_mb_pos.31, label %func_get_mb_pos.32
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_getNonAffNeighbour.29, label %ctrl0

func_getNonAffNeighbour.29:                       ; preds = %rand_bb
  call void @getNonAffNeighbour.29(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

func_getNonAffNeighbour.30:                       ; preds = %ctrl0
  call void @getNonAffNeighbour.30(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

func_getNonAffNeighbour.33:                       ; preds = %ctrl1
  call void @getNonAffNeighbour.33(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

func_getNonAffNeighbour.34:                       ; preds = %ctrl1
  call void @getNonAffNeighbour.34(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_getNonAffNeighbour.30, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_getNonAffNeighbour.33, label %func_getNonAffNeighbour.34
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_getAffNeighbour.2, label %ctrl0

func_getAffNeighbour.2:                           ; preds = %rand_bb
  call void @getAffNeighbour.2(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

func_getAffNeighbour.4:                           ; preds = %ctrl0
  call void @getAffNeighbour.4(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

func_getAffNeighbour.21:                          ; preds = %ctrl1
  call void @getAffNeighbour.21(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

func_getAffNeighbour.25:                          ; preds = %ctrl1
  call void @getAffNeighbour.25(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_getAffNeighbour.4, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_getAffNeighbour.21, label %func_getAffNeighbour.25
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_getNeighbour.17, label %ctrl0

func_getNeighbour.17:                             ; preds = %rand_bb
  call void @getNeighbour.17(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void
...
func_getNeighbour.24:                             ; preds = %ctrl1
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_getNeighbour.24, label %func_getNeighbour.26
}
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_getChroma4x4Neighbour.27, label %func_getChroma4x4Neighbour.28
}
...
entry:
  %canary = alloca i32
  store i32 1346127844, i32* %canary
...
if.end104:                                        ; preds = %if.then98, %if.end95
  ...
  %108 = icmp eq i32 %107, 1346127844
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getAffNeighbour.2(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix) #0 {
entry:
...
entry:
  ...
  %canary = alloca i32
  store i32 1888065000, i32* %canary
...
entry:
  ...
  %yN.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 785635855, i32* %canary
  %maxW = alloca i32, align 4
  %luma.addr = alloca i32, align 4
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
  store i32 %xN, i32* %xN.addr, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 1876008563, i32* %canary
...
entry:
  ...
  %mb_addr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 827477910, i32* %canary
  %x.addr = alloca i32*, align 8
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
  store i32* %x, i32** %x.addr, align 8
  store i32* %y, i32** %y.addr, align 8
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 395557208, i32* %canary
  %currMbAddr.addr = alloca i32, align 4
  store i32 %mbAddr, i32* %mbAddr.addr, align 4
  store i32 %currMbAddr, i32* %currMbAddr.addr, align 4
  %0 = load i32, i32* %mbAddr.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 1090989696, i32* %canary
  %mbAddr.addr = alloca i32, align 4
  %currMbAddr.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  store i32 %mbAddr, i32* %mbAddr.addr, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 944814009, i32* %canary
  %curr_mb_nr.addr = alloca i32, align 4
...
entry:
  ...
  %curr_mb_nr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 819865045, i32* %canary
  %x = alloca i32, align 4
  %block_y.addr = alloca i32, align 4
  %block_x.addr = alloca i32, align 4
  %rel_y.addr = alloca i32, align 4
...
entry:
  ...
  %y.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 1267996039, i32* %canary
  %mb_addr.addr = alloca i32, align 4
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
  store i32* %x, i32** %x.addr, align 8
  store i32* %y, i32** %y.addr, align 8
...
entry:
  %block_x.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1019311051, i32* %canary
  %block_y.addr = alloca i32, align 4
  %rel_y.addr = alloca i32, align 4
  %curr_mb_nr.addr = alloca i32, align 4
  %rel_x.addr = alloca i32, align 4
...
entry:
  ...
  %block_y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1374777635, i32* %canary
  %rel_x.addr = alloca i32, align 4
  %curr_mb_nr.addr = alloca i32, align 4
  %y = alloca i32, align 4
  %rel_y.addr = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1268819244, i32* %canary
  %retval = alloca i32, align 4
  %currMbAddr.addr = alloca i32, align 4
  %mbAddr.addr = alloca i32, align 4
  store i32 %mbAddr, i32* %mbAddr.addr, align 4
...
entry:
  ...
  %y = alloca i32, align 4
  %canary = alloca i32
  store i32 1815432930, i32* %canary
  %block_y.addr = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
  %x = alloca i32, align 4
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @get_mb_block_pos.16(i32 %mb_addr, i32* %x, i32* %y) #0 {
entry:
  %canary = alloca i32
  store i32 1135367603, i32* %canary
  %x.addr = alloca i32*, align 8
  %mb_addr.addr = alloca i32, align 4
  %y.addr = alloca i32*, align 8
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getNeighbour.17(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix) #0 {
entry:
  %yN.addr = alloca i32, align 4
  %curr_mb_nr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1348970370, i32* %canary
  %luma.addr = alloca i32, align 4
  %xN.addr = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
...
entry:
  %y = alloca i32, align 4
  %canary = alloca i32
  store i32 517253987, i32* %canary
  %block_x.addr = alloca i32, align 4
  %block_y.addr = alloca i32, align 4
  %rel_y.addr = alloca i32, align 4
  %x = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 2082295814, i32* %canary
  %currMB = alloca %struct.macroblock*, align 8
  %mb_nr = alloca i32, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %current_mb_nr = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 3
...
if.end104:                                        ; preds = %if.then98, %if.end95
  %107 = load i32, i32* %canary
  %108 = icmp eq i32 %107, 2082295814
  br i1 %108, label %109, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getAffNeighbour.21(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix) #0 {
entry:
  %xN.addr = alloca i32, align 4
  %luma.addr = alloca i32, align 4
  %curr_mb_nr.addr = alloca i32, align 4
  ...
  %maxW = alloca i32, align 4
  %canary = alloca i32
  store i32 426426358, i32* %canary
  %pix.addr = alloca %struct.pix_pos*, align 8
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
  store i32 %xN, i32* %xN.addr, align 4
  store i32 %yN, i32* %yN.addr, align 4
...
entry:
  ...
  %xN.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1437875411, i32* %canary
  %yN.addr = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
  %luma.addr = alloca i32, align 4
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
...
entry:
  ...
  %mb_addr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 398582915, i32* %canary
  %x.addr = alloca i32*, align 8
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
  store i32* %x, i32** %x.addr, align 8
  store i32* %y, i32** %y.addr, align 8
...
entry:
  ...
  %luma.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 222136809, i32* %canary
  %yN.addr = alloca i32, align 4
  %curr_mb_nr.addr = alloca i32, align 4
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
  store i32 %xN, i32* %xN.addr, align 4
...
entry:
  ...
  %pix.addr = alloca %struct.pix_pos*, align 8
  %canary = alloca i32
  store i32 621437048, i32* %canary
  %luma.addr = alloca i32, align 4
  %yM = alloca i32, align 4
  %currMb = alloca %struct.macroblock*, align 8
  %xN.addr = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 384927689, i32* %canary
  %pix.addr = alloca %struct.pix_pos*, align 8
  %xN.addr = alloca i32, align 4
  %yN.addr = alloca i32, align 4
  %luma.addr = alloca i32, align 4
...
entry:
  ...
  %x = alloca i32, align 4
  %canary = alloca i32
  store i32 1466826530, i32* %canary
  %curr_mb_nr.addr = alloca i32, align 4
  %rel_y.addr = alloca i32, align 4
  %rel_x.addr = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
...
entry:
  ...
  %curr_mb_nr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1921283522, i32* %canary
  %x = alloca i32, align 4
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
  store i32 %block_x, i32* %block_x.addr, align 4
  store i32 %block_y, i32* %block_y.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getNonAffNeighbour.29(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix) #0 {
entry:
  %yN.addr = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
  %luma.addr = alloca i32, align 4
  ...
  %curr_mb_nr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1056030970, i32* %canary
  %xN.addr = alloca i32, align 4
  %maxH = alloca i32, align 4
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
  store i32 %xN, i32* %xN.addr, align 4
...
entry:
  ...
  %yN.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 472769186, i32* %canary
  %maxH = alloca i32, align 4
  %luma.addr = alloca i32, align 4
  %curr_mb_nr.addr = alloca i32, align 4
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @get_mb_pos.31(i32 %mb_addr, i32* %x, i32* %y) #0 {
entry:
  %canary = alloca i32
  store i32 606329219, i32* %canary
  %x.addr = alloca i32*, align 8
  %mb_addr.addr = alloca i32, align 4
  %y.addr = alloca i32*, align 8
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
...
entry:
  %mb_addr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 130158435, i32* %canary
  %x.addr = alloca i32*, align 8
  %y.addr = alloca i32*, align 8
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
  store i32* %x, i32** %x.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getNonAffNeighbour.33(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix) #0 {
entry:
  %pix.addr = alloca %struct.pix_pos*, align 8
  %xN.addr = alloca i32, align 4
  %curr_mb_nr.addr = alloca i32, align 4
  %maxH = alloca i32, align 4
  %canary = alloca i32
  store i32 1625295044, i32* %canary
  %yN.addr = alloca i32, align 4
  %currMb = alloca %struct.macroblock*, align 8
  %luma.addr = alloca i32, align 4
  %maxW = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getNonAffNeighbour.34(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix) #0 {
entry:
  %xN.addr = alloca i32, align 4
  %luma.addr = alloca i32, align 4
  %yN.addr = alloca i32, align 4
  ...
  %maxW = alloca i32, align 4
  %canary = alloca i32
  store i32 1785482799, i32* %canary
  %maxH = alloca i32, align 4
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
  store i32 %xN, i32* %xN.addr, align 4
  store i32 %yN, i32* %yN.addr, align 4
