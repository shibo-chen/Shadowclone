...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_testEndian.1, label %func_testEndian.9
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_img2buf.16, label %ctrl0

func_img2buf.16:                                  ; preds = %rand_bb
...
func_img2buf.19:                                  ; preds = %ctrl0
  call void @img2buf.19(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom)
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_img2buf.19, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_img2buf.22, label %func_img2buf.23
}
...
func_write_picture.8:                             ; preds = %ctrl0
...
func_write_picture.15:                            ; preds = %ctrl1
  call void @write_picture.15(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_write_picture.8, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_write_picture.11, label %func_write_picture.15
}
...
func_write_out_picture.18:                        ; preds = %ctrl1
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_write_out_picture.18, label %func_write_out_picture.21
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_clear_picture.12, label %func_clear_picture.13

func_clear_picture.12:                            ; preds = %rand_bb
  call void @clear_picture.12(%struct.storable_picture* %p)
  ret void

func_clear_picture.13:                            ; preds = %rand_bb
  call void @clear_picture.13(%struct.storable_picture* %p)
  ret void
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_write_unpaired_field.4, label %ctrl0

func_write_unpaired_field.4:                      ; preds = %rand_bb
  call void @write_unpaired_field.4(%struct.frame_store* %fs, i32 %p_out)
  ret void
...
func_write_unpaired_field.24:                     ; preds = %ctrl1
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_write_unpaired_field.20, label %func_write_unpaired_field.24
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_write_stored_frame.7, label %func_write_stored_frame.17

func_write_stored_frame.7:                        ; preds = %rand_bb
  call void @write_stored_frame.7(%struct.frame_store* %fs, i32 %p_out)
  ret void

func_write_stored_frame.17:                       ; preds = %rand_bb
  call void @write_stored_frame.17(%struct.frame_store* %fs, i32 %p_out)
  ret void
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_direct_output.3, label %func_direct_output.6

func_direct_output.3:                             ; preds = %rand_bb
  call void @direct_output.3(%struct.storable_picture* %p, i32 %p_out)
  ret void

func_direct_output.6:                             ; preds = %rand_bb
  call void @direct_output.6(%struct.storable_picture* %p, i32 %p_out)
  ret void
}
...
entry:
  %canary = alloca i32
  store i32 694187169, i32* %canary
  %p = alloca i8*, align 8
...
entry:
  ...
  %canary = alloca i32
  store i32 1081042636, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1058031245, i32* %canary
  %p_out.addr = alloca i32, align 4
  %p.addr = alloca %struct.storable_picture*, align 8
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_unpaired_field.4(%struct.frame_store* %fs, i32 %p_out) #0 {
entry:
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 795562713, i32* %canary
...
entry:
  ...
  %p.addr = alloca %struct.storable_picture*, align 8
  %canary = alloca i32
  store i32 1474862937, i32* %canary
...
return:                                           ; preds = %if.end139, %if.then
  ...
  %193 = icmp eq i32 %192, 1474862937
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @direct_output.6(%struct.storable_picture* %p, i32 %p_out) #0 {
entry:
  %p.addr = alloca %struct.storable_picture*, align 8
  %canary = alloca i32
  store i32 223737926, i32* %canary
  %p_out.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  %0 = load %struct.storable_picture*, %struct.storable_picture** %p.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_stored_frame.7(%struct.frame_store* %fs, i32 %p_out) #0 {
entry:
  %fs.addr = alloca %struct.frame_store*, align 8
  %canary = alloca i32
  store i32 2042387027, i32* %canary
  %p_out.addr = alloca i32, align 4
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  %p.addr = alloca %struct.storable_picture*, align 8
  %canary = alloca i32
  store i32 1442311066, i32* %canary
  %p_out.addr = alloca i32, align 4
  %real_structure.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  %s = alloca i16, align 2
  %canary = alloca i32
  store i32 1440178740, i32* %canary
  %p = alloca i8*, align 8
  %0 = bitcast i16* %s to i8*
  store i8* %0, i8** %p, align 8
  store i16 1, i16* %s, align 2
...
entry:
  ...
  %symbol_size_in_bytes = alloca i32, align 4
  %canary = alloca i32
  store i32 1077215110, i32* %canary
  %SubWidthC = alloca [4 x i32], align 16
  %buf = alloca i8*, align 8
  %crop_bottom = alloca i32, align 4
  %p_out.addr = alloca i32, align 4
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1077215110
  br i1 %193, label %194, label %func_exit
...
entry:
  %canary = alloca i32
  store i32 1084339038, i32* %canary
  %real_structure.addr = alloca i32, align 4
  %p.addr = alloca %struct.storable_picture*, align 8
  %p_out.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1517297654, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @clear_picture.13(%struct.storable_picture* %p) #0 {
entry:
  %canary = alloca i32
  store i32 677261112, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  %i = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 0, i32* %i, align 4
...
entry:
  %fs.addr = alloca %struct.frame_store*, align 8
  %canary = alloca i32
  store i32 443255403, i32* %canary
  %p_out.addr = alloca i32, align 4
  %p = alloca %struct.storable_picture*, align 8
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  ...
  %p.addr = alloca %struct.storable_picture*, align 8
  %canary = alloca i32
  store i32 802798880, i32* %canary
  %real_structure.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  store i32 %real_structure, i32* %real_structure.addr, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 1214125999, i32* %canary
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  ...
  %109 = icmp eq i32 %108, 1214125999
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_stored_frame.17(%struct.frame_store* %fs, i32 %p_out) #0 {
entry:
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 366225882, i32* %canary
  %fs.addr = alloca %struct.frame_store*, align 8
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  %0 = load i32, i32* %p_out.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 122629671, i32* %canary
  %crop_left = alloca i32, align 4
  %buf = alloca i8*, align 8
  %rgb_output = alloca i32, align 4
  %SubWidthC = alloca [4 x i32], align 16
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @img2buf.19(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom) #0 {
entry:
  %size_y.addr = alloca i32, align 4
  %imgX.addr = alloca i16**, align 8
  %buf.addr = alloca i8*, align 8
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1383037737, i32* %canary
  %ui16 = alloca i16, align 2
  %tmp16 = alloca i16, align 2
  %crop_right.addr = alloca i32, align 4
  %crop_top.addr = alloca i32, align 4
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1383037737
  br i1 %109, label %110, label %func_exit
...
entry:
  %canary = alloca i32
  store i32 1915762814, i32* %canary
  %p_out.addr = alloca i32, align 4
  %fs.addr = alloca %struct.frame_store*, align 8
  %p = alloca %struct.storable_picture*, align 8
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
...
entry:
  ...
  %SubHeightC = alloca [4 x i32], align 16
  %canary = alloca i32
  store i32 1279581202, i32* %canary
  %crop_top = alloca i32, align 4
  %crop_right = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1279581202
  br i1 %193, label %194, label %func_exit
...
entry:
  ...
  %ui8 = alloca i8, align 1
  %canary = alloca i32
  store i32 1362045497, i32* %canary
  %ui32 = alloca i64, align 8
  %crop_left.addr = alloca i32, align 4
  %crop_bottom.addr = alloca i32, align 4
  %crop_top.addr = alloca i32, align 4
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1362045497
  br i1 %109, label %110, label %func_exit
...
entry:
  ...
  %crop_top.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2086632566, i32* %canary
  %ui32 = alloca i64, align 8
  %tmp16 = alloca i16, align 2
  %crop_right.addr = alloca i32, align 4
  %crop_bottom.addr = alloca i32, align 4
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 2086632566
  br i1 %109, label %110, label %func_exit
...
entry:
  %canary = alloca i32
  store i32 1159263754, i32* %canary
  %p = alloca %struct.storable_picture*, align 8
  %fs.addr = alloca %struct.frame_store*, align 8
  %p_out.addr = alloca i32, align 4
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
