...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_start_slice.3, label %ctrl0

func_start_slice.3:                               ; preds = %rand_bb
  %2 = call i32 @start_slice.3()
  ret i32 %2

func_start_slice.9:                               ; preds = %ctrl0
  %3 = call i32 @start_slice.9()
  ret i32 %3

func_start_slice.20:                              ; preds = %ctrl1
  %4 = call i32 @start_slice.20()
  ret i32 %4

func_start_slice.26:                              ; preds = %ctrl1
  %5 = call i32 @start_slice.26()
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_start_slice.9, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_start_slice.20, label %func_start_slice.26
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_terminate_slice.13, label %ctrl0

func_terminate_slice.13:                          ; preds = %rand_bb
  %2 = call i32 @terminate_slice.13()
  ret i32 %2

func_terminate_slice.16:                          ; preds = %ctrl0
  %3 = call i32 @terminate_slice.16()
  ret i32 %3

func_terminate_slice.21:                          ; preds = %ctrl1
  %4 = call i32 @terminate_slice.21()
  ret i32 %4

func_terminate_slice.24:                          ; preds = %ctrl1
  %5 = call i32 @terminate_slice.24()
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_terminate_slice.16, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_terminate_slice.21, label %func_terminate_slice.24
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_encode_one_slice.1, label %ctrl0

func_encode_one_slice.1:                          ; preds = %rand_bb
  %2 = call i32 @encode_one_slice.1(i32 %SliceGroupId, %struct.Picture* %pic)
  ret i32 %2

func_encode_one_slice.4:                          ; preds = %ctrl0
  %3 = call i32 @encode_one_slice.4(i32 %SliceGroupId, %struct.Picture* %pic)
  ret i32 %3

func_encode_one_slice.8:                          ; preds = %ctrl1
  %4 = call i32 @encode_one_slice.8(i32 %SliceGroupId, %struct.Picture* %pic)
  ret i32 %4

func_encode_one_slice.28:                         ; preds = %ctrl1
  %5 = call i32 @encode_one_slice.28(i32 %SliceGroupId, %struct.Picture* %pic)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_encode_one_slice.4, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_encode_one_slice.8, label %func_encode_one_slice.28
}
...
func_init_slice.10:                               ; preds = %ctrl0
  call void @init_slice.10(i32 %start_mb_addr)
  ret void

func_init_slice.11:                               ; preds = %ctrl1
  call void @init_slice.11(i32 %start_mb_addr)
  ret void

func_init_slice.17:                               ; preds = %ctrl1
  call void @init_slice.17(i32 %start_mb_addr)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_init_slice.10, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_init_slice.11, label %func_init_slice.17
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_free_slice_list.15, label %func_free_slice_list.19

func_free_slice_list.15:                          ; preds = %rand_bb
  call void @free_slice_list.15(%struct.Picture* %currPic)
  ret void

func_free_slice_list.19:                          ; preds = %rand_bb
  call void @free_slice_list.19(%struct.Picture* %currPic)
  ret void
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_free_slice.22, label %ctrl0

func_free_slice.22:                               ; preds = %rand_bb
  call void @free_slice.22(%struct.Slice* %slice)
  ret void

func_free_slice.27:                               ; preds = %ctrl0
  call void @free_slice.27(%struct.Slice* %slice)
  ret void

func_free_slice.31:                               ; preds = %ctrl1
  call void @free_slice.31(%struct.Slice* %slice)
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_free_slice.27, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_free_slice.31, label %func_free_slice.34
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_modify_redundant_pic_cnt.12, label %func_modify_redundant_pic_cnt.14

func_modify_redundant_pic_cnt.12:                 ; preds = %rand_bb
  call void @modify_redundant_pic_cnt.12(i8* %buffer)
  ret void

func_modify_redundant_pic_cnt.14:                 ; preds = %rand_bb
  call void @modify_redundant_pic_cnt.14(i8* %buffer)
  ret void
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_poc_ref_pic_reorder.6, label %ctrl0

func_poc_ref_pic_reorder.6:                       ; preds = %rand_bb
  call void @poc_ref_pic_reorder.6(%struct.storable_picture** %list, i32 %num_ref_idx_lX_active, i32* %remapping_of_pic_nums_idc, i32* %abs_diff_pic_num_minus1, i32* %long_term_pic_idx, i32 %weighted_prediction, i32 %list_no)
  ret void

func_poc_ref_pic_reorder.25:                      ; preds = %ctrl0
...
func_poc_ref_pic_reorder.32:                      ; preds = %ctrl1
  call void @poc_ref_pic_reorder.32(%struct.storable_picture** %list, i32 %num_ref_idx_lX_active, i32* %remapping_of_pic_nums_idc, i32* %abs_diff_pic_num_minus1, i32* %long_term_pic_idx, i32 %weighted_prediction, i32 %list_no)
  ret void

func_poc_ref_pic_reorder.33:                      ; preds = %ctrl1
  call void @poc_ref_pic_reorder.33(%struct.storable_picture** %list, i32 %num_ref_idx_lX_active, i32* %remapping_of_pic_nums_idc, i32* %abs_diff_pic_num_minus1, i32* %long_term_pic_idx, i32 %weighted_prediction, i32 %list_no)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_poc_ref_pic_reorder.25, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_poc_ref_pic_reorder.32, label %func_poc_ref_pic_reorder.33
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_malloc_slice.5, label %ctrl0

func_malloc_slice.5:                              ; preds = %rand_bb
  %2 = call %struct.Slice* @malloc_slice.5()
  ret %struct.Slice* %2

func_malloc_slice.7:                              ; preds = %ctrl0
  %3 = call %struct.Slice* @malloc_slice.7()
  ret %struct.Slice* %3

func_malloc_slice.18:                             ; preds = %ctrl1
  %4 = call %struct.Slice* @malloc_slice.18()
  ret %struct.Slice* %4

func_malloc_slice.30:                             ; preds = %ctrl1
  %5 = call %struct.Slice* @malloc_slice.30()
  ret %struct.Slice* %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_malloc_slice.7, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_malloc_slice.18, label %func_malloc_slice.30
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_set_ref_pic_num.23, label %func_set_ref_pic_num.29

func_set_ref_pic_num.23:                          ; preds = %rand_bb
  call void @set_ref_pic_num.23()
  ret void

func_set_ref_pic_num.29:                          ; preds = %rand_bb
  call void @set_ref_pic_num.29()
  ret void
}
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @encode_one_slice.1(i32 %SliceGroupId, %struct.Picture* %pic) #0 {
entry:
  %end_of_slice = alloca i32, align 4
  %canary = alloca i32
  store i32 627370079, i32* %canary
...
entry:
  ...
  %currSlice = alloca %struct.Slice*, align 8
  %canary = alloca i32
  store i32 1863475460, i32* %canary
...
if.end206:                                        ; preds = %if.then205, %if.end202
  ...
  %230 = icmp eq i32 %229, 1863475460
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @start_slice.3() #0 {
entry:
  %header_len = alloca i32, align 4
  %canary = alloca i32
  store i32 761131858, i32* %canary
  %currStream = alloca %struct.Bitstream*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @encode_one_slice.4(i32 %SliceGroupId, %struct.Picture* %pic) #0 {
entry:
  %FieldRDCost = alloca double, align 8
  %CurrentMbAddr = alloca i32, align 4
  %recode_macroblock = alloca i32, align 4
  ...
  %pic.addr = alloca %struct.Picture*, align 8
  %canary = alloca i32
  store i32 974472323, i32* %canary
  %NumberOfCodedMBs = alloca i32, align 4
  store i32 %SliceGroupId, i32* %SliceGroupId.addr, align 4
  store %struct.Picture* %pic, %struct.Picture** %pic.addr, align 8
  store i32 0, i32* %end_of_slice, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal %struct.Slice* @malloc_slice.5() #0 {
entry:
  %i = alloca i32, align 4
  %slice = alloca %struct.Slice*, align 8
  %buffer_size = alloca i32, align 4
  %canary = alloca i32
  store i32 1173450989, i32* %canary
  %dataPart = alloca %struct.datapartition*, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @poc_ref_pic_reorder.6(%struct.storable_picture** %list, i32 %num_ref_idx_lX_active, i32* %remapping_of_pic_nums_idc, i32* %abs_diff_pic_num_minus1, i32* %long_term_pic_idx, i32 %weighted_prediction, i32 %list_no) #0 {
entry:
  %canary = alloca i32
  store i32 256319890, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal %struct.Slice* @malloc_slice.7() #0 {
entry:
  %buffer_size = alloca i32, align 4
  %dataPart = alloca %struct.datapartition*, align 8
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1069207445, i32* %canary
  %slice = alloca %struct.Slice*, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %width = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 13
  %1 = load i32, i32* %width, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @encode_one_slice.8(i32 %SliceGroupId, %struct.Picture* %pic) #0 {
entry:
  %recode_macroblock = alloca i32, align 4
  %canary = alloca i32
  store i32 188011183, i32* %canary
  %CurrentMbAddr = alloca i32, align 4
  %end_of_slice = alloca i32, align 4
  %pic.addr = alloca %struct.Picture*, align 8
  %SliceGroupId.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @start_slice.9() #0 {
entry:
  %header_len = alloca i32, align 4
  %eep = alloca %struct.EncodingEnvironment*, align 8
  %NumberOfPartitions = alloca i32, align 4
  ...
  %currStream = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 792129647, i32* %canary
  %currSlice = alloca %struct.Slice*, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %currentSlice = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 50
  %1 = load %struct.Slice*, %struct.Slice** %currentSlice, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @init_slice.10(i32 %start_mb_addr) #0 {
entry:
  %start_mb_addr.addr = alloca i32, align 4
  %currStream = alloca %struct.Bitstream*, align 8
  %currSlice = alloca %struct.Slice*, align 8
  ...
  %i100 = alloca i32, align 4
  %canary = alloca i32
  store i32 816654281, i32* %canary
  %num_ref = alloca i32, align 4
  %currPic = alloca %struct.Picture*, align 8
  store i32 %start_mb_addr, i32* %start_mb_addr.addr, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @init_slice.11(i32 %start_mb_addr) #0 {
entry:
  %canary = alloca i32
  store i32 1402385305, i32* %canary
  %dataPart = alloca %struct.datapartition*, align 8
  %num_ref = alloca i32, align 4
  %currSlice = alloca %struct.Slice*, align 8
  %i100 = alloca i32, align 4
...
if.end206:                                        ; preds = %if.then205, %if.end202
  %229 = load i32, i32* %canary
  %230 = icmp eq i32 %229, 1402385305
  br i1 %230, label %231, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @modify_redundant_pic_cnt.12(i8* %buffer) #0 {
entry:
  %buffer.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 216726766, i32* %canary
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 228049716, i32* %canary
  %eep = alloca %struct.EncodingEnvironment*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @modify_redundant_pic_cnt.14(i8* %buffer) #0 {
entry:
  %canary = alloca i32
  store i32 277754049, i32* %canary
  %tmp = alloca i8, align 1
  %buffer.addr = alloca i8*, align 8
  store i8* %buffer, i8** %buffer.addr, align 8
  %0 = load i32, i32* @rpc_bits_to_go, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_slice_list.15(%struct.Picture* %currPic) #0 {
entry:
  %canary = alloca i32
  store i32 1629199301, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1273713849, i32* %canary
  %byte_pos_before_startcode_emu_prevention = alloca i32, align 4
  %currSlice = alloca %struct.Slice*, align 8
  %i = alloca i32, align 4
  %currStream = alloca %struct.Bitstream*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @init_slice.17(i32 %start_mb_addr) #0 {
entry:
  %canary = alloca i32
  store i32 1138558302, i32* %canary
  %currStream = alloca %struct.Bitstream*, align 8
  %currPic = alloca %struct.Picture*, align 8
  %num_ref = alloca i32, align 4
  %i100 = alloca i32, align 4
...
if.end206:                                        ; preds = %if.then205, %if.end202
  %229 = load i32, i32* %canary
  %230 = icmp eq i32 %229, 1138558302
  br i1 %230, label %231, label %func_exit
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1370008109, i32* %canary
  %buffer_size = alloca i32, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %width = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 13
  %1 = load i32, i32* %width, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_slice_list.19(%struct.Picture* %currPic) #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 281850541, i32* %canary
  %currPic.addr = alloca %struct.Picture*, align 8
  store %struct.Picture* %currPic, %struct.Picture** %currPic.addr, align 8
  store i32 0, i32* %i, align 4
  br label %for.cond
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @start_slice.20() #0 {
entry:
  %canary = alloca i32
  store i32 1428217482, i32* %canary
  %eep = alloca %struct.EncodingEnvironment*, align 8
  %header_len = alloca i32, align 4
  %i = alloca i32, align 4
  %currStream = alloca %struct.Bitstream*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @terminate_slice.21() #0 {
entry:
  %currStream = alloca %struct.Bitstream*, align 8
  %byte_pos_before_startcode_emu_prevention = alloca i32, align 4
  %eep = alloca %struct.EncodingEnvironment*, align 8
  ...
  %currSlice = alloca %struct.Slice*, align 8
  %canary = alloca i32
  store i32 2093287936, i32* %canary
  %bytes_written = alloca i32, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %currentSlice = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 50
  %1 = load %struct.Slice*, %struct.Slice** %currentSlice, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @free_slice.22(%struct.Slice* %slice) #0 {
entry:
  %dataPart = alloca %struct.datapartition*, align 8
  %canary = alloca i32
  store i32 1364800246, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @set_ref_pic_num.23() #0 {
entry:
  %canary = alloca i32
  store i32 608632099, i32* %canary
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  store i32 0, i32* %i, align 4
  br label %for.cond
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @terminate_slice.24() #0 {
entry:
  %currStream = alloca %struct.Bitstream*, align 8
  %eep = alloca %struct.EncodingEnvironment*, align 8
  %byte_pos_before_startcode_emu_prevention = alloca i32, align 4
  ...
  %bytes_written = alloca i32, align 4
  %canary = alloca i32
  store i32 121186451, i32* %canary
  %currSlice = alloca %struct.Slice*, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %currentSlice = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 50
  %1 = load %struct.Slice*, %struct.Slice** %currentSlice, align 8
...
entry:
  ...
  %picNumLXPred = alloca i32, align 4
  %canary = alloca i32
  store i32 439732910, i32* %canary
  %list_sign = alloca [32 x i32], align 16
  %k = alloca i32, align 4
  %remapping_of_pic_nums_idc.addr = alloca i32*, align 8
  %list.addr = alloca %struct.storable_picture**, align 8
...
entry:
  ...
  %eep = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 635676353, i32* %canary
  %i = alloca i32, align 4
  %NumberOfPartitions = alloca i32, align 4
  %currStream = alloca %struct.Bitstream*, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @free_slice.27(%struct.Slice* %slice) #0 {
entry:
  %canary = alloca i32
  store i32 1587593042, i32* %canary
  %dataPart = alloca %struct.datapartition*, align 8
  %i = alloca i32, align 4
  %slice.addr = alloca %struct.Slice*, align 8
  store %struct.Slice* %slice, %struct.Slice** %slice.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @encode_one_slice.28(i32 %SliceGroupId, %struct.Picture* %pic) #0 {
entry:
  %CurrentMbAddr = alloca i32, align 4
  %end_of_slice = alloca i32, align 4
  %FieldRDCost = alloca double, align 8
  ...
  %SliceGroupId.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 739952320, i32* %canary
  %recode_macroblock = alloca i32, align 4
  %NumberOfCodedMBs = alloca i32, align 4
  store i32 %SliceGroupId, i32* %SliceGroupId.addr, align 4
  store %struct.Picture* %pic, %struct.Picture** %pic.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @set_ref_pic_num.29() #0 {
entry:
  %canary = alloca i32
  store i32 1279264321, i32* %canary
  %j = alloca i32, align 4
  %i = alloca i32, align 4
  store i32 0, i32* %i, align 4
  br label %for.cond
...
if.end158:                                        ; preds = %if.end, %for.end79
  %112 = load i32, i32* %canary
  %113 = icmp eq i32 %112, 1279264321
  br i1 %113, label %114, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define internal %struct.Slice* @malloc_slice.30() #0 {
entry:
  %i = alloca i32, align 4
  %dataPart = alloca %struct.datapartition*, align 8
  %canary = alloca i32
  store i32 522631122, i32* %canary
  %slice = alloca %struct.Slice*, align 8
  %buffer_size = alloca i32, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %width = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 13
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @free_slice.31(%struct.Slice* %slice) #0 {
entry:
  %canary = alloca i32
  store i32 1162847778, i32* %canary
  %i = alloca i32, align 4
  %slice.addr = alloca %struct.Slice*, align 8
  %dataPart = alloca %struct.datapartition*, align 8
  store %struct.Slice* %slice, %struct.Slice** %slice.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @poc_ref_pic_reorder.32(%struct.storable_picture** %list, i32 %num_ref_idx_lX_active, i32* %remapping_of_pic_nums_idc, i32* %abs_diff_pic_num_minus1, i32* %long_term_pic_idx, i32 %weighted_prediction, i32 %list_no) #0 {
entry:
  %weighted_prediction.addr = alloca i32, align 4
  %j = alloca i32, align 4
  %diff = alloca i32, align 4
  ...
  %remapping_of_pic_nums_idc.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 510638535, i32* %canary
  %k = alloca i32, align 4
  %maxPicNum = alloca i32, align 4
  %no_reorder = alloca i32, align 4
  %long_term_pic_idx.addr = alloca i32*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @poc_ref_pic_reorder.33(%struct.storable_picture** %list, i32 %num_ref_idx_lX_active, i32* %remapping_of_pic_nums_idc, i32* %abs_diff_pic_num_minus1, i32* %long_term_pic_idx, i32 %weighted_prediction, i32 %list_no) #0 {
entry:
  %picNumLXPred = alloca i32, align 4
  %MaxFrameNum = alloca i32, align 4
  %num_ref_idx_lX_active.addr = alloca i32, align 4
  ...
  %list_sign = alloca [32 x i32], align 16
  %canary = alloca i32
  store i32 1222812323, i32* %canary
  %tmp_value = alloca i32, align 4
  %list.addr = alloca %struct.storable_picture**, align 8
  %long_term_pic_idx.addr = alloca i32*, align 8
  %k = alloca i32, align 4
...
if.end240:                                        ; preds = %if.end239, %for.end135
  %187 = load i32, i32* %canary
  %188 = icmp eq i32 %187, 1222812323
  br i1 %188, label %189, label %func_exit
...
entry:
  %slice.addr = alloca %struct.Slice*, align 8
  %canary = alloca i32
  store i32 574932565, i32* %canary
  %dataPart = alloca %struct.datapartition*, align 8
  %i = alloca i32, align 4
  store %struct.Slice* %slice, %struct.Slice** %slice.addr, align 8
  %0 = load %struct.Slice*, %struct.Slice** %slice.addr, align 8
