; ModuleID = 'intrarefresh.c.rand.8R1.bc'
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_RandomIntraInit.3, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_RandomIntraInit.4, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_RandomIntraInit.8, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_RandomIntraInit.12, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_RandomIntraInit.14, label %func_RandomIntraInit.15
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_RandomIntra.5, label %ctrl0

func_RandomIntra.5:                               ; preds = %rand_bb
  %2 = call i32 @RandomIntra.5(i32 %mb)
  ret i32 %2
...
func_RandomIntra.10:                              ; preds = %ctrl3
  %6 = call i32 @RandomIntra.10(i32 %mb)
  ret i32 %6

func_RandomIntra.16:                              ; preds = %ctrl3
  %7 = call i32 @RandomIntra.16(i32 %mb)
  ret i32 %7
...
ctrl3:                                            ; preds = %ctrl2
  %11 = icmp eq i32 %0, 4
  br i1 %11, label %func_RandomIntra.10, label %func_RandomIntra.16
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_RandomIntraNewPicture.11, label %func_RandomIntraNewPicture.13

func_RandomIntraNewPicture.11:                    ; preds = %rand_bb
  call void @RandomIntraNewPicture.11()
  ret void

func_RandomIntraNewPicture.13:                    ; preds = %rand_bb
  call void @RandomIntraNewPicture.13()
  ret void
}
...
entry:
  ...
  %canary = alloca i32
  store i32 1697035819, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1320523102, i32* %canary
  %ysize.addr = alloca i32, align 4
  %pos = alloca i32, align 4
  %i = alloca i32, align 4
  %xsize.addr = alloca i32, align 4
...
entry:
  %pos = alloca i32, align 4
  %canary = alloca i32
  store i32 320143434, i32* %canary
  %i = alloca i32, align 4
  %ysize.addr = alloca i32, align 4
  %refresh.addr = alloca i32, align 4
  %xsize.addr = alloca i32, align 4
...
entry:
  ...
  %ysize.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1866371105, i32* %canary
  %xsize.addr = alloca i32, align 4
  %pos = alloca i32, align 4
  %refresh.addr = alloca i32, align 4
  store i32 %xsize, i32* %xsize.addr, align 4
...
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 857045551, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1676494750, i32* %canary
  %i = alloca i32, align 4
  %retval = alloca i32, align 4
  %mb.addr = alloca i32, align 4
  store i32 %mb, i32* %mb.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 2119486924, i32* %canary
  %retval = alloca i32, align 4
  %mb.addr = alloca i32, align 4
  %i = alloca i32, align 4
  store i32 %mb, i32* %mb.addr, align 4
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 352753297, i32* %canary
  %retval = alloca i32, align 4
  store i32 %mb, i32* %mb.addr, align 4
  store i32 0, i32* %i, align 4
  br label %for.cond
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 988133532, i32* %canary
  %mb.addr = alloca i32, align 4
  store i32 %mb, i32* %mb.addr, align 4
  store i32 0, i32* %i, align 4
  br label %for.cond
...
entry:
  ...
  %canary = alloca i32
  store i32 511148708, i32* %canary
  %i = alloca i32, align 4
...
entry:
  ...
  %refresh.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1461983955, i32* %canary
  %i = alloca i32, align 4
  %xsize.addr = alloca i32, align 4
  store i32 %xsize, i32* %xsize.addr, align 4
  store i32 %ysize, i32* %ysize.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @RandomIntraNewPicture.13() #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1033848060, i32* %canary
  %j = alloca i32, align 4
  %0 = load i32, i32* @NumberIntraPerPicture, align 4
  %1 = load i32, i32* @WalkAround, align 4
  %add = add nsw i32 %1, %0
...
entry:
  %canary = alloca i32
  store i32 1634509286, i32* %canary
  %refresh.addr = alloca i32, align 4
  %ysize.addr = alloca i32, align 4
  %pos = alloca i32, align 4
  %i = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1461381272, i32* %canary
  %refresh.addr = alloca i32, align 4
  %pos = alloca i32, align 4
  %i = alloca i32, align 4
  %xsize.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @RandomIntra.16(i32 %mb) #0 {
entry:
  %mb.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 824332945, i32* %canary
  %retval = alloca i32, align 4
  %i = alloca i32, align 4
  store i32 %mb, i32* %mb.addr, align 4
  store i32 0, i32* %i, align 4
