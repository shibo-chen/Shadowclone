...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_GenerateParameterSets.8, label %func_GenerateParameterSets.27

func_GenerateParameterSets.8:                     ; preds = %rand_bb
  call void @GenerateParameterSets.8()
  ret void

func_GenerateParameterSets.27:                    ; preds = %rand_bb
  call void @GenerateParameterSets.27()
  ret void
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_GenerateSequenceParameterSet.14, label %ctrl0

func_GenerateSequenceParameterSet.14:             ; preds = %rand_bb
  call void @GenerateSequenceParameterSet.14(%struct.seq_parameter_set_rbsp_t* %sps, i32 %SPS_id)
  ret void

func_GenerateSequenceParameterSet.30:             ; preds = %ctrl0
  call void @GenerateSequenceParameterSet.30(%struct.seq_parameter_set_rbsp_t* %sps, i32 %SPS_id)
  ret void

func_GenerateSequenceParameterSet.31:             ; preds = %ctrl1
  call void @GenerateSequenceParameterSet.31(%struct.seq_parameter_set_rbsp_t* %sps, i32 %SPS_id)
  ret void

func_GenerateSequenceParameterSet.32:             ; preds = %ctrl1
  call void @GenerateSequenceParameterSet.32(%struct.seq_parameter_set_rbsp_t* %sps, i32 %SPS_id)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_GenerateSequenceParameterSet.30, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_GenerateSequenceParameterSet.31, label %func_GenerateSequenceParameterSet.32
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_GeneratePictureParameterSet.6, label %ctrl0

func_GeneratePictureParameterSet.6:               ; preds = %rand_bb
  call void @GeneratePictureParameterSet.6(%struct.pic_parameter_set_rbsp_t* %pps, %struct.seq_parameter_set_rbsp_t* %sps, i32 %PPS_id, i32 %WeightedPrediction, i32 %WeightedBiprediction, i32 %cb_qp_index_offset, i32 %cr_qp_index_offset)
  ret void

func_GeneratePictureParameterSet.9:               ; preds = %ctrl0
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_GeneratePictureParameterSet.9, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_GeneratePictureParameterSet.18, label %func_GeneratePictureParameterSet.25
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_GenerateSeq_parameter_set_NALU.2, label %ctrl0

func_GenerateSeq_parameter_set_NALU.2:            ; preds = %rand_bb
  %2 = call %struct.NALU_t* @GenerateSeq_parameter_set_NALU.2()
  ret %struct.NALU_t* %2

func_GenerateSeq_parameter_set_NALU.16:           ; preds = %ctrl0
  %3 = call %struct.NALU_t* @GenerateSeq_parameter_set_NALU.16()
  ret %struct.NALU_t* %3

func_GenerateSeq_parameter_set_NALU.17:           ; preds = %ctrl1
  %4 = call %struct.NALU_t* @GenerateSeq_parameter_set_NALU.17()
  ret %struct.NALU_t* %4

func_GenerateSeq_parameter_set_NALU.23:           ; preds = %ctrl1
  %5 = call %struct.NALU_t* @GenerateSeq_parameter_set_NALU.23()
  ret %struct.NALU_t* %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_GenerateSeq_parameter_set_NALU.16, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_GenerateSeq_parameter_set_NALU.17, label %func_GenerateSeq_parameter_set_NALU.23
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_GenerateSeq_parameter_set_rbsp.1, label %ctrl0

func_GenerateSeq_parameter_set_rbsp.1:            ; preds = %rand_bb
  %2 = call i32 @GenerateSeq_parameter_set_rbsp.1(%struct.seq_parameter_set_rbsp_t* %sps, i8* %rbsp)
  ret i32 %2

func_GenerateSeq_parameter_set_rbsp.5:            ; preds = %ctrl0
  %3 = call i32 @GenerateSeq_parameter_set_rbsp.5(%struct.seq_parameter_set_rbsp_t* %sps, i8* %rbsp)
  ret i32 %3
...
func_GenerateSeq_parameter_set_rbsp.21:           ; preds = %ctrl1
  %5 = call i32 @GenerateSeq_parameter_set_rbsp.21(%struct.seq_parameter_set_rbsp_t* %sps, i8* %rbsp)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_GenerateSeq_parameter_set_rbsp.5, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_GenerateSeq_parameter_set_rbsp.11, label %func_GenerateSeq_parameter_set_rbsp.21
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_GeneratePic_parameter_set_NALU.7, label %ctrl0

func_GeneratePic_parameter_set_NALU.7:            ; preds = %rand_bb
  %2 = call %struct.NALU_t* @GeneratePic_parameter_set_NALU.7(i32 %PPS_id)
  ret %struct.NALU_t* %2

func_GeneratePic_parameter_set_NALU.10:           ; preds = %ctrl0
  %3 = call %struct.NALU_t* @GeneratePic_parameter_set_NALU.10(i32 %PPS_id)
  ret %struct.NALU_t* %3

func_GeneratePic_parameter_set_NALU.20:           ; preds = %ctrl1
  %4 = call %struct.NALU_t* @GeneratePic_parameter_set_NALU.20(i32 %PPS_id)
  ret %struct.NALU_t* %4

func_GeneratePic_parameter_set_NALU.28:           ; preds = %ctrl1
  %5 = call %struct.NALU_t* @GeneratePic_parameter_set_NALU.28(i32 %PPS_id)
  ret %struct.NALU_t* %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_GeneratePic_parameter_set_NALU.10, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_GeneratePic_parameter_set_NALU.20, label %func_GeneratePic_parameter_set_NALU.28
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_GeneratePic_parameter_set_rbsp.12, label %ctrl0

func_GeneratePic_parameter_set_rbsp.12:           ; preds = %rand_bb
  %2 = call i32 @GeneratePic_parameter_set_rbsp.12(%struct.pic_parameter_set_rbsp_t* %pps, i8* %rbsp)
  ret i32 %2

func_GeneratePic_parameter_set_rbsp.22:           ; preds = %ctrl0
  %3 = call i32 @GeneratePic_parameter_set_rbsp.22(%struct.pic_parameter_set_rbsp_t* %pps, i8* %rbsp)
  ret i32 %3

func_GeneratePic_parameter_set_rbsp.24:           ; preds = %ctrl1
  %4 = call i32 @GeneratePic_parameter_set_rbsp.24(%struct.pic_parameter_set_rbsp_t* %pps, i8* %rbsp)
  ret i32 %4

func_GeneratePic_parameter_set_rbsp.26:           ; preds = %ctrl1
  %5 = call i32 @GeneratePic_parameter_set_rbsp.26(%struct.pic_parameter_set_rbsp_t* %pps, i8* %rbsp)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_GeneratePic_parameter_set_rbsp.22, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_GeneratePic_parameter_set_rbsp.24, label %func_GeneratePic_parameter_set_rbsp.26
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_Scaling_List.4, label %ctrl0

func_Scaling_List.4:                              ; preds = %rand_bb
  %2 = call i32 @Scaling_List.4(i16* %scalingListinput, i16* %scalingList, i32 %sizeOfScalingList, i16* %UseDefaultScalingMatrix, %struct.datapartition* %partition)
  ret i32 %2

func_Scaling_List.15:                             ; preds = %ctrl0
  %3 = call i32 @Scaling_List.15(i16* %scalingListinput, i16* %scalingList, i32 %sizeOfScalingList, i16* %UseDefaultScalingMatrix, %struct.datapartition* %partition)
  ret i32 %3

func_Scaling_List.19:                             ; preds = %ctrl1
  %4 = call i32 @Scaling_List.19(i16* %scalingListinput, i16* %scalingList, i32 %sizeOfScalingList, i16* %UseDefaultScalingMatrix, %struct.datapartition* %partition)
  ret i32 %4

func_Scaling_List.29:                             ; preds = %ctrl1
  %5 = call i32 @Scaling_List.29(i16* %scalingListinput, i16* %scalingList, i32 %sizeOfScalingList, i16* %UseDefaultScalingMatrix, %struct.datapartition* %partition)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_Scaling_List.15, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_Scaling_List.19, label %func_Scaling_List.29
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_GenerateVUISequenceParameters.3, label %func_GenerateVUISequenceParameters.13

func_GenerateVUISequenceParameters.3:             ; preds = %rand_bb
  %2 = call i32 @GenerateVUISequenceParameters.3(%struct.datapartition* %partition)
  ret i32 %2

func_GenerateVUISequenceParameters.13:            ; preds = %rand_bb
  %3 = call i32 @GenerateVUISequenceParameters.13(%struct.datapartition* %partition)
  ret i32 %3
}
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @GenerateSeq_parameter_set_rbsp.1(%struct.seq_parameter_set_rbsp_t* %sps, i8* %rbsp) #0 {
entry:
  %rbsp.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1194412924, i32* %canary
...
if.end158:                                        ; preds = %if.then155, %if.end150
  ...
  %208 = icmp eq i32 %207, 1194412924
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct.NALU_t* @GenerateSeq_parameter_set_NALU.2() #0 {
entry:
  %canary = alloca i32
  store i32 1035638961, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @GenerateVUISequenceParameters.3(%struct.datapartition* %partition) #0 {
entry:
  %canary = alloca i32
  store i32 2094842930, i32* %canary
  %len = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @Scaling_List.4(i16* %scalingListinput, i16* %scalingList, i32 %sizeOfScalingList, i16* %UseDefaultScalingMatrix, %struct.datapartition* %partition) #0 {
entry:
  %len = alloca i32, align 4
  ...
  %partition.addr = alloca %struct.datapartition*, align 8
  %canary = alloca i32
  store i32 1998223294, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @GenerateSeq_parameter_set_rbsp.5(%struct.seq_parameter_set_rbsp_t* %sps, i8* %rbsp) #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1810628983, i32* %canary
  %len = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
  %sps.addr = alloca %struct.seq_parameter_set_rbsp_t*, align 8
  %LenInBytes = alloca i32, align 4
...
if.end158:                                        ; preds = %if.then155, %if.end150
  ...
  %206 = load i32, i32* %LenInBytes, align 4
  %207 = load i32, i32* %canary
  %208 = icmp eq i32 %207, 1810628983
  br i1 %208, label %209, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @GeneratePictureParameterSet.6(%struct.pic_parameter_set_rbsp_t* %pps, %struct.seq_parameter_set_rbsp_t* %sps, i32 %PPS_id, i32 %WeightedPrediction, i32 %WeightedBiprediction, i32 %cb_qp_index_offset, i32 %cr_qp_index_offset) #0 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct.NALU_t* @GeneratePic_parameter_set_NALU.7(i32 %PPS_id) #0 {
entry:
  %rbsp = alloca [64000 x i8], align 16
  %n = alloca %struct.NALU_t*, align 8
  %NALUlen = alloca i32, align 4
  %RBSPlen = alloca i32, align 4
  %canary = alloca i32
  store i32 538784297, i32* %canary
  %PPS_id.addr = alloca i32, align 4
  store i32 %PPS_id, i32* %PPS_id.addr, align 4
  %call = call %struct.NALU_t* (i32, ...) bitcast (%struct.NALU_t* (...)* @AllocNALU to %struct.NALU_t* (i32, ...)*)(i32 64000)
  store %struct.NALU_t* %call, %struct.NALU_t** %n, align 8
...
entry:
  ...
  %canary = alloca i32
  store i32 320109585, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 410210496, i32* %canary
  %PPS_id.addr = alloca i32, align 4
  %frext_profile = alloca i32, align 4
  %cb_qp_index_offset.addr = alloca i32, align 4
  %sps.addr = alloca %struct.seq_parameter_set_rbsp_t*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct.NALU_t* @GeneratePic_parameter_set_NALU.10(i32 %PPS_id) #0 {
entry:
  %RBSPlen = alloca i32, align 4
  %canary = alloca i32
  store i32 357792064, i32* %canary
  %NALUlen = alloca i32, align 4
  %rbsp = alloca [64000 x i8], align 16
  %n = alloca %struct.NALU_t*, align 8
  %PPS_id.addr = alloca i32, align 4
...
entry:
  ...
  %LenInBytes = alloca i32, align 4
  %canary = alloca i32
  store i32 1025115554, i32* %canary
  %i = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
  %rbsp.addr = alloca i8*, align 8
  store %struct.seq_parameter_set_rbsp_t* %sps, %struct.seq_parameter_set_rbsp_t** %sps.addr, align 8
...
if.end158:                                        ; preds = %if.then155, %if.end150
  ...
  %206 = load i32, i32* %LenInBytes, align 4
  %207 = load i32, i32* %canary
  %208 = icmp eq i32 %207, 1025115554
  br i1 %208, label %209, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @GeneratePic_parameter_set_rbsp.12(%struct.pic_parameter_set_rbsp_t* %pps, i8* %rbsp) #0 {
entry:
  %len = alloca i32, align 4
  %canary = alloca i32
  store i32 1988607694, i32* %canary
  %LenInBytes = alloca i32, align 4
  %rbsp.addr = alloca i8*, align 8
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
...
if.end201:                                        ; preds = %if.end198, %lor.lhs.false143
  ...
  %202 = icmp eq i32 %201, 1988607694
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @GenerateVUISequenceParameters.13(%struct.datapartition* %partition) #0 {
entry:
  %partition.addr = alloca %struct.datapartition*, align 8
  %canary = alloca i32
  store i32 1252372285, i32* %canary
  %len = alloca i32, align 4
  store %struct.datapartition* %partition, %struct.datapartition** %partition.addr, align 8
  store i32 0, i32* %len, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @GenerateSequenceParameterSet.14(%struct.seq_parameter_set_rbsp_t* %sps, i32 %SPS_id) #0 {
entry:
  ...
  %frext_profile = alloca i32, align 4
  %canary = alloca i32
  store i32 343331803, i32* %canary
  %i = alloca i32, align 4
...
entry:
  ...
  %sizeOfScalingList.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1731302796, i32* %canary
  %delta_scale = alloca i32, align 4
  %lastScale = alloca i32, align 4
  %scanj = alloca i32, align 4
  %len = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct.NALU_t* @GenerateSeq_parameter_set_NALU.16() #0 {
entry:
  %canary = alloca i32
  store i32 704674846, i32* %canary
  %RBSPlen = alloca i32, align 4
  %rbsp = alloca [64000 x i8], align 16
  %n = alloca %struct.NALU_t*, align 8
  %NALUlen = alloca i32, align 4
...
entry:
  ...
  %delta_scale = alloca i32, align 4
  %canary = alloca i32
  store i32 1381257602, i32* %canary
  %scanj = alloca i32, align 4
  %partition.addr = alloca %struct.datapartition*, align 8
  %scalingListinput.addr = alloca i16*, align 8
  %UseDefaultScalingMatrix.addr = alloca i16*, align 8
...
entry:
  ...
  %rbsp = alloca [64000 x i8], align 16
  %canary = alloca i32
  store i32 1665942712, i32* %canary
  %n = alloca %struct.NALU_t*, align 8
  store i32 %PPS_id, i32* %PPS_id.addr, align 4
  %call = call %struct.NALU_t* (i32, ...) bitcast (%struct.NALU_t* (...)* @AllocNALU to %struct.NALU_t* (i32, ...)*)(i32 64000)
  store %struct.NALU_t* %call, %struct.NALU_t** %n, align 8
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1363967223, i32* %canary
  %sps.addr = alloca %struct.seq_parameter_set_rbsp_t*, align 8
  store %struct.seq_parameter_set_rbsp_t* %sps, %struct.seq_parameter_set_rbsp_t** %sps.addr, align 8
  store i8* %rbsp, i8** %rbsp.addr, align 8
  store i32 0, i32* %len, align 4
...
if.end158:                                        ; preds = %if.then155, %if.end150
  ...
  %206 = load i32, i32* %LenInBytes, align 4
  %207 = load i32, i32* %canary
  %208 = icmp eq i32 %207, 1363967223
  br i1 %208, label %209, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @GeneratePic_parameter_set_rbsp.22(%struct.pic_parameter_set_rbsp_t* %pps, i8* %rbsp) #0 {
entry:
  %canary = alloca i32
  store i32 1230853208, i32* %canary
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %rbsp.addr = alloca i8*, align 8
  %profile_idc = alloca i32, align 4
  %LenInBytes = alloca i32, align 4
...
if.end201:                                        ; preds = %if.end198, %lor.lhs.false143
  ...
  %200 = load i32, i32* %LenInBytes, align 4
  %201 = load i32, i32* %canary
  %202 = icmp eq i32 %201, 1230853208
  br i1 %202, label %203, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct.NALU_t* @GenerateSeq_parameter_set_NALU.23() #0 {
entry:
  %n = alloca %struct.NALU_t*, align 8
  %canary = alloca i32
  store i32 1146281412, i32* %canary
  %rbsp = alloca [64000 x i8], align 16
  %NALUlen = alloca i32, align 4
  %RBSPlen = alloca i32, align 4
  %call = call %struct.NALU_t* (i32, ...) bitcast (%struct.NALU_t* (...)* @AllocNALU to %struct.NALU_t* (i32, ...)*)(i32 64000)
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @GeneratePic_parameter_set_rbsp.24(%struct.pic_parameter_set_rbsp_t* %pps, i8* %rbsp) #0 {
entry:
  %NumberBitsPerSliceGroupId = alloca i32, align 4
  %i = alloca i32, align 4
  %LenInBytes = alloca i32, align 4
  ...
  %profile_idc = alloca i32, align 4
  %canary = alloca i32
  store i32 1553301056, i32* %canary
  %partition = alloca %struct.datapartition*, align 8
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %rbsp.addr = alloca i8*, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
...
if.end201:                                        ; preds = %if.end198, %lor.lhs.false143
  ...
  %200 = load i32, i32* %LenInBytes, align 4
  %201 = load i32, i32* %canary
  %202 = icmp eq i32 %201, 1553301056
  br i1 %202, label %203, label %func_exit
...
entry:
  ...
  %sps.addr = alloca %struct.seq_parameter_set_rbsp_t*, align 8
  %canary = alloca i32
  store i32 2138352862, i32* %canary
  %WeightedPrediction.addr = alloca i32, align 4
  %PPS_id.addr = alloca i32, align 4
  %frext_profile = alloca i32, align 4
  %WeightedBiprediction.addr = alloca i32, align 4
...
if.end139:                                        ; preds = %if.else135, %if.then132
  ...
  store i32 0, i32* %redundant_pic_cnt_present_flag, align 4
  %151 = load i32, i32* %canary
  %152 = icmp eq i32 %151, 2138352862
  br i1 %152, label %153, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @GeneratePic_parameter_set_rbsp.26(%struct.pic_parameter_set_rbsp_t* %pps, i8* %rbsp) #0 {
entry:
  %len = alloca i32, align 4
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 457762608, i32* %canary
  %partition = alloca %struct.datapartition*, align 8
  %LenInBytes = alloca i32, align 4
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %NumberBitsPerSliceGroupId = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @GenerateParameterSets.27() #0 {
entry:
  %pps = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %canary = alloca i32
  store i32 2115663510, i32* %canary
  %sps = alloca %struct.seq_parameter_set_rbsp_t*, align 8
  store %struct.seq_parameter_set_rbsp_t* null, %struct.seq_parameter_set_rbsp_t** %sps, align 8
  store %struct.pic_parameter_set_rbsp_t* null, %struct.pic_parameter_set_rbsp_t** %pps, align 8
  %call = call %struct.seq_parameter_set_rbsp_t* (...) @AllocSPS()
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct.NALU_t* @GeneratePic_parameter_set_NALU.28(i32 %PPS_id) #0 {
entry:
  %NALUlen = alloca i32, align 4
  %n = alloca %struct.NALU_t*, align 8
  %RBSPlen = alloca i32, align 4
  %PPS_id.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 844460707, i32* %canary
  %rbsp = alloca [64000 x i8], align 16
  store i32 %PPS_id, i32* %PPS_id.addr, align 4
  %call = call %struct.NALU_t* (i32, ...) bitcast (%struct.NALU_t* (...)* @AllocNALU to %struct.NALU_t* (i32, ...)*)(i32 64000)
  store %struct.NALU_t* %call, %struct.NALU_t** %n, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @Scaling_List.29(i16* %scalingListinput, i16* %scalingList, i32 %sizeOfScalingList, i16* %UseDefaultScalingMatrix, %struct.datapartition* %partition) #0 {
entry:
  %sizeOfScalingList.addr = alloca i32, align 4
  %UseDefaultScalingMatrix.addr = alloca i16*, align 8
  %delta_scale = alloca i32, align 4
  ...
  %nextScale = alloca i32, align 4
  %canary = alloca i32
  store i32 565820493, i32* %canary
  %j = alloca i32, align 4
  %scalingListinput.addr = alloca i16*, align 8
  %lastScale = alloca i32, align 4
  %len = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @GenerateSequenceParameterSet.30(%struct.seq_parameter_set_rbsp_t* %sps, i32 %SPS_id) #0 {
entry:
  %width = alloca i32, align 4
  %PicWidthInMbs = alloca i32, align 4
  %FrameHeightInMbs = alloca i32, align 4
  ...
  %SPS_id.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1656861077, i32* %canary
  %frext_profile = alloca i32, align 4
  %SubWidthC = alloca [4 x i32], align 16
  %PicHeightInMapUnits = alloca i32, align 4
  %sps.addr = alloca %struct.seq_parameter_set_rbsp_t*, align 8
...
if.end137:                                        ; preds = %if.else135, %if.end134
  %162 = load i32, i32* %canary
  %163 = icmp eq i32 %162, 1656861077
  br i1 %163, label %164, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @GenerateSequenceParameterSet.31(%struct.seq_parameter_set_rbsp_t* %sps, i32 %SPS_id) #0 {
entry:
  %height = alloca i32, align 4
  %SubWidthC = alloca [4 x i32], align 16
  %i = alloca i32, align 4
  ...
  %sps.addr = alloca %struct.seq_parameter_set_rbsp_t*, align 8
  %canary = alloca i32
  store i32 1651712488, i32* %canary
  %FrameHeightInMbs = alloca i32, align 4
  %PicHeightInMapUnits = alloca i32, align 4
  %width = alloca i32, align 4
  %SubHeightC = alloca [4 x i32], align 16
...
if.end137:                                        ; preds = %if.else135, %if.end134
  %162 = load i32, i32* %canary
  %163 = icmp eq i32 %162, 1651712488
  br i1 %163, label %164, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @GenerateSequenceParameterSet.32(%struct.seq_parameter_set_rbsp_t* %sps, i32 %SPS_id) #0 {
entry:
  %sps.addr = alloca %struct.seq_parameter_set_rbsp_t*, align 8
  %SubWidthC = alloca [4 x i32], align 16
  %PicWidthInMbs = alloca i32, align 4
  ...
  %height = alloca i32, align 4
  %canary = alloca i32
  store i32 1530982466, i32* %canary
  %FrameHeightInMbs = alloca i32, align 4
  %SPS_id.addr = alloca i32, align 4
  %width = alloca i32, align 4
  %PicHeightInMapUnits = alloca i32, align 4
...
if.end137:                                        ; preds = %if.else135, %if.end134
  %162 = load i32, i32* %canary
  %163 = icmp eq i32 %162, 1530982466
  br i1 %163, label %164, label %func_exit
