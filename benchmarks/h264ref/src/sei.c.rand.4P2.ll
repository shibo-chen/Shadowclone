...
func_write_sei_message.11:                        ; preds = %ctrl0
  call void @write_sei_message.11(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type)
  ret void

func_write_sei_message.26:                        ; preds = %ctrl1
  call void @write_sei_message.26(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type)
  ret void

func_write_sei_message.28:                        ; preds = %ctrl1
  call void @write_sei_message.28(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_write_sei_message.11, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_write_sei_message.26, label %func_write_sei_message.28
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_finalize_sei_message.13, label %func_finalize_sei_message.19

func_finalize_sei_message.13:                     ; preds = %rand_bb
  call void @finalize_sei_message.13(i32 %id)
  ret void

func_finalize_sei_message.19:                     ; preds = %rand_bb
  call void @finalize_sei_message.19(i32 %id)
  ret void
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_AppendTmpbits2Buf.14, label %ctrl0

func_AppendTmpbits2Buf.14:                        ; preds = %rand_bb
  call void @AppendTmpbits2Buf.14(%struct.Bitstream* %dest, %struct.Bitstream* %source)
  ret void

func_AppendTmpbits2Buf.27:                        ; preds = %ctrl0
  call void @AppendTmpbits2Buf.27(%struct.Bitstream* %dest, %struct.Bitstream* %source)
  ret void

func_AppendTmpbits2Buf.29:                        ; preds = %ctrl1
  call void @AppendTmpbits2Buf.29(%struct.Bitstream* %dest, %struct.Bitstream* %source)
  ret void

func_AppendTmpbits2Buf.32:                        ; preds = %ctrl1
  call void @AppendTmpbits2Buf.32(%struct.Bitstream* %dest, %struct.Bitstream* %source)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_AppendTmpbits2Buf.27, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_AppendTmpbits2Buf.29, label %func_AppendTmpbits2Buf.32
}
...
func_ComposeSparePictureMessage.24:               ; preds = %ctrl1
  call void @ComposeSparePictureMessage.24(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream)
  ret void

func_ComposeSparePictureMessage.31:               ; preds = %ctrl1
  call void @ComposeSparePictureMessage.31(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream)
  ret void
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_ComposeSparePictureMessage.24, label %func_ComposeSparePictureMessage.31
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_CompressSpareMBMap.38, label %ctrl0

func_CompressSpareMBMap.38:                       ; preds = %rand_bb
  %2 = call i32 @CompressSpareMBMap.38(i8** %map_sp, %struct.Bitstream* %bitstream)
  ret i32 %2

func_CompressSpareMBMap.50:                       ; preds = %ctrl0
  %3 = call i32 @CompressSpareMBMap.50(i8** %map_sp, %struct.Bitstream* %bitstream)
  ret i32 %3
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_CompressSpareMBMap.50, label %ctrl1
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FinalizeSpareMBMap.17, label %ctrl0

func_FinalizeSpareMBMap.17:                       ; preds = %rand_bb
  call void @FinalizeSpareMBMap.17()
  ret void
...
func_FinalizeSpareMBMap.41:                       ; preds = %ctrl1
  call void @FinalizeSpareMBMap.41()
  ret void

func_FinalizeSpareMBMap.56:                       ; preds = %ctrl1
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_FinalizeSpareMBMap.41, label %func_FinalizeSpareMBMap.56
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FinalizeSubseqInfo.35, label %ctrl0

func_FinalizeSubseqInfo.35:                       ; preds = %rand_bb
  call void @FinalizeSubseqInfo.35(i32 %currLayer)
  ret void

func_FinalizeSubseqInfo.43:                       ; preds = %ctrl0
...
func_FinalizeSubseqInfo.55:                       ; preds = %ctrl1
  call void @FinalizeSubseqInfo.55(i32 %currLayer)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_FinalizeSubseqInfo.43, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_FinalizeSubseqInfo.54, label %func_FinalizeSubseqInfo.55
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FinalizeSubseqLayerInfo.9, label %func_FinalizeSubseqLayerInfo.20
...
func_FinalizeSubseqChar.22:                       ; preds = %ctrl1
  call void @FinalizeSubseqChar.22()
  ret void

func_FinalizeSubseqChar.25:                       ; preds = %ctrl1
  call void @FinalizeSubseqChar.25()
  ret void
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_FinalizeSubseqChar.22, label %func_FinalizeSubseqChar.25
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FinalizeSceneInformation.47, label %func_FinalizeSceneInformation.52

func_FinalizeSceneInformation.47:                 ; preds = %rand_bb
  call void @FinalizeSceneInformation.47()
  ret void

func_FinalizeSceneInformation.52:                 ; preds = %rand_bb
  call void @FinalizeSceneInformation.52()
  ret void
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_UpdateSceneInformation.18, label %ctrl0

func_UpdateSceneInformation.18:                   ; preds = %rand_bb
  call void @UpdateSceneInformation.18(i32 %HasSceneInformation, i32 %sceneID, i32 %sceneTransType, i32 %secondSceneID)
  ret void

func_UpdateSceneInformation.40:                   ; preds = %ctrl0
  call void @UpdateSceneInformation.40(i32 %HasSceneInformation, i32 %sceneID, i32 %sceneTransType, i32 %secondSceneID)
  ret void

func_UpdateSceneInformation.42:                   ; preds = %ctrl1
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_UpdateSceneInformation.40, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_UpdateSceneInformation.42, label %func_UpdateSceneInformation.49
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FinalizePanScanRectInfo.12, label %func_FinalizePanScanRectInfo.15

func_FinalizePanScanRectInfo.12:                  ; preds = %rand_bb
  call void @FinalizePanScanRectInfo.12()
  ret void

func_FinalizePanScanRectInfo.15:                  ; preds = %rand_bb
  call void @FinalizePanScanRectInfo.15()
  ret void
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_UpdateUser_data_unregistered.23, label %ctrl0

func_UpdateUser_data_unregistered.23:             ; preds = %rand_bb
  call void @UpdateUser_data_unregistered.23()
  ret void

func_UpdateUser_data_unregistered.44:             ; preds = %ctrl0
  call void @UpdateUser_data_unregistered.44()
  ret void

func_UpdateUser_data_unregistered.45:             ; preds = %ctrl1
  call void @UpdateUser_data_unregistered.45()
  ret void

func_UpdateUser_data_unregistered.48:             ; preds = %ctrl1
  call void @UpdateUser_data_unregistered.48()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_UpdateUser_data_unregistered.44, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_UpdateUser_data_unregistered.45, label %func_UpdateUser_data_unregistered.48
}
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_FinalizeUser_data_unregistered.8, label %func_FinalizeUser_data_unregistered.16
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_UpdateUser_data_registered_itu_t_t35.1, label %ctrl0

func_UpdateUser_data_registered_itu_t_t35.1:      ; preds = %rand_bb
  call void @UpdateUser_data_registered_itu_t_t35.1()
  ret void

func_UpdateUser_data_registered_itu_t_t35.2:      ; preds = %ctrl0
  call void @UpdateUser_data_registered_itu_t_t35.2()
  ret void

func_UpdateUser_data_registered_itu_t_t35.33:     ; preds = %ctrl1
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_UpdateUser_data_registered_itu_t_t35.2, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_UpdateUser_data_registered_itu_t_t35.33, label %func_UpdateUser_data_registered_itu_t_t35.37
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FinalizeUser_data_registered_itu_t_t35.34, label %ctrl0

func_FinalizeUser_data_registered_itu_t_t35.34:   ; preds = %rand_bb
  call void @FinalizeUser_data_registered_itu_t_t35.34()
  ret void

func_FinalizeUser_data_registered_itu_t_t35.36:   ; preds = %ctrl0
  call void @FinalizeUser_data_registered_itu_t_t35.36()
  ret void

func_FinalizeUser_data_registered_itu_t_t35.39:   ; preds = %ctrl1
  call void @FinalizeUser_data_registered_itu_t_t35.39()
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_FinalizeUser_data_registered_itu_t_t35.36, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_FinalizeUser_data_registered_itu_t_t35.39, label %func_FinalizeUser_data_registered_itu_t_t35.46
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FinalizeRandomAccess.51, label %func_FinalizeRandomAccess.53

func_FinalizeRandomAccess.51:                     ; preds = %rand_bb
  call void @FinalizeRandomAccess.51()
  ret void

func_FinalizeRandomAccess.53:                     ; preds = %rand_bb
  call void @FinalizeRandomAccess.53()
  ret void
}
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateUser_data_registered_itu_t_t35.1() #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 2077352804, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateUser_data_registered_itu_t_t35.2() #0 {
entry:
  %total_byte = alloca i32, align 4
  %temp_data = alloca i32, align 4
  %canary = alloca i32
  store i32 1022646533, i32* %canary
  %i = alloca i32, align 4
  %country_code = alloca i32, align 4
  store i32 82, i32* %country_code, align 4
  %0 = load i32, i32* %country_code, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 2079648803, i32* %canary
  %i = alloca i32, align 4
...
entry:
  %sym = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 1205020596, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  %i = alloca i32, align 4
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_unregistered_information_struct, %struct.user_data_unregistered_information_struct* @seiUser_data_unregistered, i32 0, i32 2), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
...
entry:
  ...
  %sym = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 1685554551, i32* %canary
  %i = alloca i32, align 4
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_unregistered_information_struct, %struct.user_data_unregistered_information_struct* @seiUser_data_unregistered, i32 0, i32 2), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
  %type = getelementptr inbounds %struct.syntaxelement, %struct.syntaxelement* %sym, i32 0, i32 0
...
entry:
  ...
  %canary = alloca i32
  store i32 397787532, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 619295614, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 2018651145, i32* %canary
  %i = alloca i32, align 4
  %sym = alloca %struct.syntaxelement, align 8
  %dest = alloca %struct.Bitstream*, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_unregistered_information_struct, %struct.user_data_unregistered_information_struct* @seiUser_data_unregistered, i32 0, i32 2), align 8
...
entry:
  ...
  %sym = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 811800763, i32* %canary
  %i = alloca i32, align 4
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.subseq_char_information_struct, %struct.subseq_char_information_struct* @seiSubseqChar, i32 0, i32 10), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
  %type = getelementptr inbounds %struct.syntaxelement, %struct.syntaxelement* %sym, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_sei_message.11(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type) #0 {
entry:
  %type = alloca i32, align 4
  %payload_size.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 639868080, i32* %canary
  %offset = alloca i32, align 4
  %id.addr = alloca i32, align 4
  %payload_type.addr = alloca i32, align 4
  %payload.addr = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizePanScanRectInfo.12() #0 {
entry:
  %dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 1394757813, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.panscanrect_information_struct, %struct.panscanrect_information_struct* @seiPanScanRectInfo, i32 0, i32 5), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
  %type = getelementptr inbounds %struct.syntaxelement, %struct.syntaxelement* %sym, i32 0, i32 0
...
entry:
  %id.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1008557201, i32* %canary
  %offset = alloca i32, align 4
  store i32 %id, i32* %id.addr, align 4
  %0 = load i32, i32* %id.addr, align 4
  %idxprom = sext i32 %0 to i64
...
entry:
  ...
  %canary = alloca i32
  store i32 1320496776, i32* %canary
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizePanScanRectInfo.15() #0 {
entry:
  %canary = alloca i32
  store i32 1265141466, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %dest = alloca %struct.Bitstream*, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.panscanrect_information_struct, %struct.panscanrect_information_struct* @seiPanScanRectInfo, i32 0, i32 5), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1389257153, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_unregistered_information_struct, %struct.user_data_unregistered_information_struct* @seiUser_data_unregistered, i32 0, i32 2), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
  %type = getelementptr inbounds %struct.syntaxelement, %struct.syntaxelement* %sym, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSpareMBMap.17() #0 {
entry:
  %delta_frame_num = alloca i32, align 4
  %source = alloca %struct.Bitstream*, align 8
  %sym = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 458082428, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateSceneInformation.18(i32 %HasSceneInformation, i32 %sceneID, i32 %sceneTransType, i32 %secondSceneID) #0 {
entry:
  %secondSceneID.addr = alloca i32, align 4
  %sceneID.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1731419730, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @finalize_sei_message.19(i32 %id) #0 {
entry:
  %canary = alloca i32
  store i32 224093862, i32* %canary
  %offset = alloca i32, align 4
  %id.addr = alloca i32, align 4
  store i32 %id, i32* %id.addr, align 4
  %0 = load i32, i32* %id.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 825159899, i32* %canary
  %i = alloca i32, align 4
  %pos = alloca i32, align 4
  store i32 0, i32* %pos, align 4
  store i32 0, i32* getelementptr inbounds (%struct.subseq_layer_information_struct, %struct.subseq_layer_information_struct* @seiSubseqLayerInfo, i32 0, i32 4), align 4
...
entry:
  %bitstream = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 552702301, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %delta_spare_frame_num.addr = alloca i32, align 4
  %tmpBitstream.addr = alloca %struct.Bitstream*, align 8
  %ref_area_indicator.addr = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 939880438, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %i = alloca i32, align 4
  %dest = alloca %struct.Bitstream*, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.subseq_char_information_struct, %struct.subseq_char_information_struct* @seiSubseqChar, i32 0, i32 10), align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateUser_data_unregistered.23() #0 {
entry:
  %canary = alloca i32
  store i32 357983020, i32* %canary
  %i = alloca i32, align 4
  %temp_data = alloca i32, align 4
  %total_byte = alloca i32, align 4
  store i32 7, i32* %total_byte, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @ComposeSparePictureMessage.24(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream) #0 {
entry:
  %ref_area_indicator.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1987490403, i32* %canary
  %delta_spare_frame_num.addr = alloca i32, align 4
  %sym = alloca %struct.syntaxelement, align 8
  %tmpBitstream.addr = alloca %struct.Bitstream*, align 8
  %bitstream = alloca %struct.Bitstream*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSubseqChar.25() #0 {
entry:
  %sym = alloca %struct.syntaxelement, align 8
  %dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 1430525790, i32* %canary
  %i = alloca i32, align 4
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.subseq_char_information_struct, %struct.subseq_char_information_struct* @seiSubseqChar, i32 0, i32 10), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
  %type = getelementptr inbounds %struct.syntaxelement, %struct.syntaxelement* %sym, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_sei_message.26(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type) #0 {
entry:
  %type = alloca i32, align 4
  %canary = alloca i32
  store i32 761468479, i32* %canary
  %offset = alloca i32, align 4
  %id.addr = alloca i32, align 4
  %size = alloca i32, align 4
  %payload_type.addr = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 987487853, i32* %canary
  %i = alloca i32, align 4
  %bits_in_last_byte = alloca i32, align 4
  %source.addr = alloca %struct.Bitstream*, align 8
  %mask = alloca i8, align 1
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_sei_message.28(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type) #0 {
entry:
  %payload_type.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1646032320, i32* %canary
  %size = alloca i32, align 4
  %payload.addr = alloca i8*, align 8
  %payload_size.addr = alloca i32, align 4
  %id.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @AppendTmpbits2Buf.29(%struct.Bitstream* %dest, %struct.Bitstream* %source) #0 {
entry:
  %bits_in_last_byte = alloca i32, align 4
  %dest.addr = alloca %struct.Bitstream*, align 8
  %mask = alloca i8, align 1
  %source.addr = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 1207011933, i32* %canary
  %j = alloca i32, align 4
  %i = alloca i32, align 4
  store %struct.Bitstream* %dest, %struct.Bitstream** %dest.addr, align 8
  store %struct.Bitstream* %source, %struct.Bitstream** %source.addr, align 8
...
entry:
  %dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 337100993, i32* %canary
  %CurrFrameNum = alloca i32, align 4
  %source = alloca %struct.Bitstream*, align 8
  %sym = alloca %struct.syntaxelement, align 8
  %delta_frame_num = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @ComposeSparePictureMessage.31(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream) #0 {
entry:
  %tmpBitstream.addr = alloca %struct.Bitstream*, align 8
  %bitstream = alloca %struct.Bitstream*, align 8
  %sym = alloca %struct.syntaxelement, align 8
  %ref_area_indicator.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2121362720, i32* %canary
  %delta_spare_frame_num.addr = alloca i32, align 4
  store i32 %delta_spare_frame_num, i32* %delta_spare_frame_num.addr, align 4
  store i32 %ref_area_indicator, i32* %ref_area_indicator.addr, align 4
  store %struct.Bitstream* %tmpBitstream, %struct.Bitstream** %tmpBitstream.addr, align 8
...
entry:
  ...
  %bits_in_last_byte = alloca i32, align 4
  %canary = alloca i32
  store i32 1428558505, i32* %canary
  %dest.addr = alloca %struct.Bitstream*, align 8
  store %struct.Bitstream* %dest, %struct.Bitstream** %dest.addr, align 8
  store %struct.Bitstream* %source, %struct.Bitstream** %source.addr, align 8
  store i32 0, i32* %i, align 4
...
entry:
  ...
  %country_code = alloca i32, align 4
  %canary = alloca i32
  store i32 1466513059, i32* %canary
  %temp_data = alloca i32, align 4
  %i = alloca i32, align 4
  store i32 82, i32* %country_code, align 4
  %0 = load i32, i32* %country_code, align 4
...
entry:
  ...
  %sym = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 1952980097, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_registered_itu_t_t35_information_struct, %struct.user_data_registered_itu_t_t35_information_struct* @seiUser_data_registered_itu_t_t35, i32 0, i32 4), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
  %type = getelementptr inbounds %struct.syntaxelement, %struct.syntaxelement* %sym, i32 0, i32 0
...
entry:
  %canary = alloca i32
  store i32 667206647, i32* %canary
  %currLayer.addr = alloca i32, align 4
  %dest = alloca %struct.Bitstream*, align 8
  %sym = alloca %struct.syntaxelement, align 8
  store i32 %currLayer, i32* %currLayer.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeUser_data_registered_itu_t_t35.36() #0 {
entry:
  %sym = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 752869847, i32* %canary
  %i = alloca i32, align 4
  %dest = alloca %struct.Bitstream*, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_registered_itu_t_t35_information_struct, %struct.user_data_registered_itu_t_t35_information_struct* @seiUser_data_registered_itu_t_t35, i32 0, i32 4), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
...
entry:
  %canary = alloca i32
  store i32 2139852654, i32* %canary
  %i = alloca i32, align 4
  %temp_data = alloca i32, align 4
  %total_byte = alloca i32, align 4
  %country_code = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @CompressSpareMBMap.38(i8** %map_sp, %struct.Bitstream* %bitstream) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 2130265201, i32* %canary
...
if.end190:                                        ; preds = %for.end189, %if.end141
  ...
  %123 = icmp eq i32 %122, 2130265201
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeUser_data_registered_itu_t_t35.39() #0 {
entry:
  %canary = alloca i32
  store i32 376643058, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  %sym = alloca %struct.syntaxelement, align 8
  %i = alloca i32, align 4
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_registered_itu_t_t35_information_struct, %struct.user_data_registered_itu_t_t35_information_struct* @seiUser_data_registered_itu_t_t35, i32 0, i32 4), align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateSceneInformation.40(i32 %HasSceneInformation, i32 %sceneID, i32 %sceneTransType, i32 %secondSceneID) #0 {
entry:
  %canary = alloca i32
  store i32 203149278, i32* %canary
  %secondSceneID.addr = alloca i32, align 4
  %HasSceneInformation.addr = alloca i32, align 4
  %sceneTransType.addr = alloca i32, align 4
  %sceneID.addr = alloca i32, align 4
...
entry:
  ...
  %secondSceneID.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1314761409, i32* %canary
  %HasSceneInformation.addr = alloca i32, align 4
  %sceneID.addr = alloca i32, align 4
  store i32 %HasSceneInformation, i32* %HasSceneInformation.addr, align 4
  store i32 %sceneID, i32* %sceneID.addr, align 4
...
entry:
  ...
  %currLayer.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1453719994, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  store i32 %currLayer, i32* %currLayer.addr, align 4
  %0 = load i32, i32* %currLayer.addr, align 4
  %idxprom = sext i32 %0 to i64
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateUser_data_unregistered.44() #0 {
entry:
  %total_byte = alloca i32, align 4
  %temp_data = alloca i32, align 4
  %canary = alloca i32
  store i32 391338535, i32* %canary
  %i = alloca i32, align 4
  store i32 7, i32* %total_byte, align 4
  store i32 0, i32* %i, align 4
  br label %for.cond
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateUser_data_unregistered.45() #0 {
entry:
  %canary = alloca i32
  store i32 1342971653, i32* %canary
  %total_byte = alloca i32, align 4
  %i = alloca i32, align 4
  %temp_data = alloca i32, align 4
  store i32 7, i32* %total_byte, align 4
...
entry:
  %dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 1846978068, i32* %canary
  %i = alloca i32, align 4
  %sym = alloca %struct.syntaxelement, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_registered_itu_t_t35_information_struct, %struct.user_data_registered_itu_t_t35_information_struct* @seiUser_data_registered_itu_t_t35, i32 0, i32 4), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSceneInformation.47() #0 {
entry:
  %canary = alloca i32
  store i32 152640346, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %dest = alloca %struct.Bitstream*, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.scene_information_struct, %struct.scene_information_struct* @seiSceneInformation, i32 0, i32 3), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateUser_data_unregistered.48() #0 {
entry:
  %temp_data = alloca i32, align 4
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1313492640, i32* %canary
  %total_byte = alloca i32, align 4
  store i32 7, i32* %total_byte, align 4
  store i32 0, i32* %i, align 4
  br label %for.cond
...
entry:
  ...
  %sceneTransType.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 896872771, i32* %canary
  %HasSceneInformation.addr = alloca i32, align 4
  %secondSceneID.addr = alloca i32, align 4
  store i32 %HasSceneInformation, i32* %HasSceneInformation.addr, align 4
  store i32 %sceneID, i32* %sceneID.addr, align 4
...
entry:
  ...
  %size_compressed = alloca i32, align 4
  %canary = alloca i32
  store i32 290135718, i32* %canary
  %left = alloca i32, align 4
  %j = alloca i32, align 4
  %directx = alloca i32, align 4
  %bit0 = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeRandomAccess.51() #0 {
entry:
  %canary = alloca i32
  store i32 1132091111, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  %sym = alloca %struct.syntaxelement, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.randomaccess_information_struct, %struct.randomaccess_information_struct* @seiRandomAccess, i32 0, i32 3), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSceneInformation.52() #0 {
entry:
  %dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 666881850, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.scene_information_struct, %struct.scene_information_struct* @seiSceneInformation, i32 0, i32 3), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
  %type = getelementptr inbounds %struct.syntaxelement, %struct.syntaxelement* %sym, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeRandomAccess.53() #0 {
entry:
  %sym = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 2030368243, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.randomaccess_information_struct, %struct.randomaccess_information_struct* @seiRandomAccess, i32 0, i32 3), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
  %type = getelementptr inbounds %struct.syntaxelement, %struct.syntaxelement* %sym, i32 0, i32 0
...
entry:
  %sym = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 1980174206, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  %currLayer.addr = alloca i32, align 4
  store i32 %currLayer, i32* %currLayer.addr, align 4
  %0 = load i32, i32* %currLayer.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSubseqInfo.55(i32 %currLayer) #0 {
entry:
  %currLayer.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 215152658, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %dest = alloca %struct.Bitstream*, align 8
  store i32 %currLayer, i32* %currLayer.addr, align 4
  %0 = load i32, i32* %currLayer.addr, align 4
...
entry:
  %sym = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 1770306802, i32* %canary
  %delta_frame_num = alloca i32, align 4
  %dest = alloca %struct.Bitstream*, align 8
  %source = alloca %struct.Bitstream*, align 8
  %CurrFrameNum = alloca i32, align 4
...
entry:
  ...
  %left = alloca i32, align 4
  %canary = alloca i32
  store i32 2100704027, i32* %canary
  %map_sp.addr = alloca i8**, align 8
  %size_uncompressed = alloca i32, align 4
  %y = alloca i32, align 4
  %bitc = alloca i32, align 4
...
if.end190:                                        ; preds = %for.end189, %if.end141
  %121 = load i32, i32* %ret, align 4
  %122 = load i32, i32* %canary
  %123 = icmp eq i32 %122, 2100704027
  br i1 %123, label %124, label %func_exit
...
entry:
  ...
  %bitc = alloca i32, align 4
  %canary = alloca i32
  store i32 1831337525, i32* %canary
  %noc = alloca i32, align 4
  %size_uncompressed = alloca i32, align 4
  %right = alloca i32, align 4
  store i8** %map_sp, i8*** %map_sp.addr, align 8
...
if.end190:                                        ; preds = %for.end189, %if.end141
  %121 = load i32, i32* %ret, align 4
  %122 = load i32, i32* %canary
  %123 = icmp eq i32 %122, 1831337525
  br i1 %123, label %124, label %func_exit
