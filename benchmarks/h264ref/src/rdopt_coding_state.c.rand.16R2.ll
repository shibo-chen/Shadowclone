; ModuleID = 'rdopt_coding_state.c.rand.16R2.bc'
...
func_store_coding_state.8:                        ; preds = %ctrl4
  call void @store_coding_state.8(%struct.CSobj* %cs)
  ret void

func_store_coding_state.14:                       ; preds = %ctrl5
...
func_store_coding_state.16:                       ; preds = %ctrl7
  call void @store_coding_state.16(%struct.CSobj* %cs)
  ret void

func_store_coding_state.21:                       ; preds = %ctrl8
...
func_store_coding_state.29:                       ; preds = %ctrl12
...
ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_store_coding_state.8, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_store_coding_state.14, label %ctrl6
...
ctrl7:                                            ; preds = %ctrl6
  %9 = icmp eq i32 %0, 8
  br i1 %9, label %func_store_coding_state.16, label %ctrl8

ctrl8:                                            ; preds = %ctrl7
  %10 = icmp eq i32 %0, 9
  br i1 %10, label %func_store_coding_state.21, label %ctrl9
...
ctrl12:                                           ; preds = %ctrl11
  %14 = icmp eq i32 %0, 13
  br i1 %14, label %func_store_coding_state.29, label %ctrl13
...
func_reset_coding_state.10:                       ; preds = %ctrl2
  call void @reset_coding_state.10(%struct.CSobj* %cs)
  ret void

func_reset_coding_state.11:                       ; preds = %ctrl3
  call void @reset_coding_state.11(%struct.CSobj* %cs)
  ret void

func_reset_coding_state.12:                       ; preds = %ctrl4
...
func_reset_coding_state.17:                       ; preds = %ctrl6
...
func_reset_coding_state.20:                       ; preds = %ctrl9
...
ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_reset_coding_state.10, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_reset_coding_state.11, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_reset_coding_state.12, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_reset_coding_state.13, label %ctrl6

ctrl6:                                            ; preds = %ctrl5
  %8 = icmp eq i32 %0, 7
  br i1 %8, label %func_reset_coding_state.17, label %ctrl7
...
ctrl9:                                            ; preds = %ctrl8
  %11 = icmp eq i32 %0, 10
  br i1 %11, label %func_reset_coding_state.20, label %ctrl10
...
ctrl13:                                           ; preds = %ctrl12
  %15 = icmp eq i32 %0, 14
  br i1 %15, label %func_reset_coding_state.27, label %func_reset_coding_state.30
}
...
entry:
  ...
  %canary = alloca i32
  store i32 558223172, i32* %canary
...
entry:
  ...
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %canary = alloca i32
  store i32 1210865451, i32* %canary
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %bs_src = alloca %struct.Bitstream*, align 8
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
...
entry:
  ...
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %canary = alloca i32
  store i32 1796038206, i32* %canary
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  store %struct.CSobj* %cs, %struct.CSobj** %cs.addr, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %currentSlice = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 50
...
entry:
  ...
  %cs.addr = alloca %struct.CSobj*, align 8
  %canary = alloca i32
  store i32 1879990871, i32* %canary
  %i = alloca i32, align 4
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %bs_src = alloca %struct.Bitstream*, align 8
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
...
entry:
  ...
  %currMB = alloca %struct.macroblock*, align 8
  %canary = alloca i32
  store i32 1038302343, i32* %canary
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %cs.addr = alloca %struct.CSobj*, align 8
...
entry:
  ...
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %canary = alloca i32
  store i32 1749164924, i32* %canary
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %bs_src = alloca %struct.Bitstream*, align 8
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %bs_dest = alloca %struct.Bitstream*, align 8
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 428279303, i32* %canary
  %cs.addr = alloca %struct.CSobj*, align 8
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %currMB = alloca %struct.macroblock*, align 8
  %bs_dest = alloca %struct.Bitstream*, align 8
...
entry:
  ...
  %bs_dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 2086314116, i32* %canary
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %cs.addr = alloca %struct.CSobj*, align 8
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
...
entry:
  ...
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %canary = alloca i32
  store i32 1207350879, i32* %canary
  %i = alloca i32, align 4
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  store %struct.CSobj* %cs, %struct.CSobj** %cs.addr, align 8
...
entry:
  %cs.addr = alloca %struct.CSobj*, align 8
  %canary = alloca i32
  store i32 2079202622, i32* %canary
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %bs_src = alloca %struct.Bitstream*, align 8
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
...
entry:
  ...
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %canary = alloca i32
  store i32 627452829, i32* %canary
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %currMB = alloca %struct.macroblock*, align 8
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  store %struct.CSobj* %cs, %struct.CSobj** %cs.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1680095273, i32* %canary
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %currMB = alloca %struct.macroblock*, align 8
  %cs.addr = alloca %struct.CSobj*, align 8
...
entry:
  %bs_src = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 1564434253, i32* %canary
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %currMB = alloca %struct.macroblock*, align 8
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 123166894, i32* %canary
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %cs.addr = alloca %struct.CSobj*, align 8
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1056402313, i32* %canary
  %bs_src = alloca %struct.Bitstream*, align 8
  store %struct.CSobj* %cs, %struct.CSobj** %cs.addr, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %currentSlice = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 50
...
entry:
  ...
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %canary = alloca i32
  store i32 1433228718, i32* %canary
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  store %struct.CSobj* %cs, %struct.CSobj** %cs.addr, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
entry:
  %canary = alloca i32
  store i32 478322585, i32* %canary
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %currMB = alloca %struct.macroblock*, align 8
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
...
entry:
  ...
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %canary = alloca i32
  store i32 1460035056, i32* %canary
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %currMB = alloca %struct.macroblock*, align 8
  store %struct.CSobj* %cs, %struct.CSobj** %cs.addr, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
entry:
  ...
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %canary = alloca i32
  store i32 1233631120, i32* %canary
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %i = alloca i32, align 4
  %bs_src = alloca %struct.Bitstream*, align 8
  %cs.addr = alloca %struct.CSobj*, align 8
...
entry:
  ...
  %currMB = alloca %struct.macroblock*, align 8
  %canary = alloca i32
  store i32 908499705, i32* %canary
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  store %struct.CSobj* %cs, %struct.CSobj** %cs.addr, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %currentSlice = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 50
...
entry:
  ...
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %canary = alloca i32
  store i32 1791507186, i32* %canary
  %bs_dest = alloca %struct.Bitstream*, align 8
  store %struct.CSobj* %cs, %struct.CSobj** %cs.addr, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %currentSlice = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 50
...
entry:
  %bs_src = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 1524461976, i32* %canary
  %cs.addr = alloca %struct.CSobj*, align 8
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %currMB = alloca %struct.macroblock*, align 8
...
entry:
  ...
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %canary = alloca i32
  store i32 556321353, i32* %canary
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %cs.addr = alloca %struct.CSobj*, align 8
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
...
entry:
  ...
  %bs_dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 255233481, i32* %canary
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
...
entry:
  ...
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 591981707, i32* %canary
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %cs.addr = alloca %struct.CSobj*, align 8
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %bs_dest = alloca %struct.Bitstream*, align 8
...
entry:
  ...
  %currMB = alloca %struct.macroblock*, align 8
  %canary = alloca i32
  store i32 1452406644, i32* %canary
  %cs.addr = alloca %struct.CSobj*, align 8
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
...
entry:
  ...
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 1174161763, i32* %canary
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %cs.addr = alloca %struct.CSobj*, align 8
  %i = alloca i32, align 4
...
entry:
  ...
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %canary = alloca i32
  store i32 121170871, i32* %canary
  %cs.addr = alloca %struct.CSobj*, align 8
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %bs_dest = alloca %struct.Bitstream*, align 8
...
entry:
  ...
  %currMB = alloca %struct.macroblock*, align 8
  %canary = alloca i32
  store i32 275273550, i32* %canary
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
