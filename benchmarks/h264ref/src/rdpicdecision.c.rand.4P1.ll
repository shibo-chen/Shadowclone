; ModuleID = 'rdpicdecision.c.rand.4P1.bc'
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_rd_pic_decision.5, label %ctrl0

func_rd_pic_decision.5:                           ; preds = %rand_bb
  %2 = call i32 @rd_pic_decision.5(double %snrY_version1, double %snrY_version2, i32 %bits_version1, i32 %bits_version2, double %lambda_picture)
  ret i32 %2
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_rd_pic_decision.6, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_rd_pic_decision.7, label %func_rd_pic_decision.8
}
...
func_picture_coding_decision.3:                   ; preds = %ctrl1
  %4 = call i32 @picture_coding_decision.3(%struct.Picture* %picture1, %struct.Picture* %picture2, i32 %qp)
  ret i32 %4

func_picture_coding_decision.4:                   ; preds = %ctrl1
  %5 = call i32 @picture_coding_decision.4(%struct.Picture* %picture1, %struct.Picture* %picture2, i32 %qp)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_picture_coding_decision.2, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_picture_coding_decision.3, label %func_picture_coding_decision.4
}
...
entry:
  ...
  %canary = alloca i32
  store i32 1958344817, i32* %canary
...
entry:
  ...
  %bit_picture2 = alloca i32, align 4
  %canary = alloca i32
  store i32 542807942, i32* %canary
  %bframe = alloca i32, align 4
  %picture1.addr = alloca %struct.Picture*, align 8
  %lambda_picture = alloca double, align 8
  %picture2.addr = alloca %struct.Picture*, align 8
...
entry:
  ...
  %spframe = alloca i32, align 4
  %canary = alloca i32
  store i32 1087540776, i32* %canary
  %bit_picture1 = alloca i32, align 4
  %lambda_picture = alloca double, align 8
  %bit_picture2 = alloca i32, align 4
  store %struct.Picture* %picture1, %struct.Picture** %picture1.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 567403939, i32* %canary
  %bframe = alloca i32, align 4
  %spframe = alloca i32, align 4
  %bit_picture2 = alloca i32, align 4
  %qp.addr = alloca i32, align 4
...
entry:
  ...
  %lambda_picture.addr = alloca double, align 8
  %canary = alloca i32
  store i32 1476413724, i32* %canary
  %bits_version2.addr = alloca i32, align 4
  %snrY_version1.addr = alloca double, align 8
  %cost_version2 = alloca double, align 8
  %bits_version1.addr = alloca i32, align 4
...
entry:
  ...
  %cost_version2 = alloca double, align 8
  %canary = alloca i32
  store i32 1788277065, i32* %canary
  %cost_version1 = alloca double, align 8
  %retval = alloca i32, align 4
  %snrY_version2.addr = alloca double, align 8
  %snrY_version1.addr = alloca double, align 8
...
entry:
  ...
  %bits_version1.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1231357364, i32* %canary
  %snrY_version2.addr = alloca double, align 8
  %bits_version2.addr = alloca i32, align 4
  %cost_version1 = alloca double, align 8
  %snrY_version1.addr = alloca double, align 8
