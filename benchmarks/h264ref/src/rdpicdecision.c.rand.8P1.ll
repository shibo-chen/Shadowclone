; ModuleID = 'rdpicdecision.c.rand.8P1.bc'
...
func_rd_pic_decision.13:                          ; preds = %ctrl4
  %7 = call i32 @rd_pic_decision.13(double %snrY_version1, double %snrY_version2, i32 %bits_version1, i32 %bits_version2, double %lambda_picture)
  ret i32 %7

func_rd_pic_decision.14:                          ; preds = %ctrl5
  %8 = call i32 @rd_pic_decision.14(double %snrY_version1, double %snrY_version2, i32 %bits_version1, i32 %bits_version2, double %lambda_picture)
  ret i32 %8

func_rd_pic_decision.15:                          ; preds = %ctrl5
...
ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_rd_pic_decision.4, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_rd_pic_decision.6, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_rd_pic_decision.7, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_rd_pic_decision.8, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_rd_pic_decision.13, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_rd_pic_decision.14, label %func_rd_pic_decision.15
}
...
func_picture_coding_decision.12:                  ; preds = %ctrl5
  %8 = call i32 @picture_coding_decision.12(%struct.Picture* %picture1, %struct.Picture* %picture2, i32 %qp)
  ret i32 %8
...
ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_picture_coding_decision.3, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_picture_coding_decision.5, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_picture_coding_decision.9, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_picture_coding_decision.10, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_picture_coding_decision.11, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_picture_coding_decision.12, label %func_picture_coding_decision.16
}
...
entry:
  %canary = alloca i32
  store i32 1263929387, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1537463805, i32* %canary
...
entry:
  ...
  %bframe = alloca i32, align 4
  %canary = alloca i32
  store i32 679922934, i32* %canary
  %snr_picture1 = alloca double, align 8
  %spframe = alloca i32, align 4
  %bit_picture1 = alloca i32, align 4
  %snr_picture2 = alloca double, align 8
...
entry:
  ...
  %cost_version2 = alloca double, align 8
  %canary = alloca i32
  store i32 1825292462, i32* %canary
  %retval = alloca i32, align 4
  %cost_version1 = alloca double, align 8
  %snrY_version1.addr = alloca double, align 8
  %snrY_version2.addr = alloca double, align 8
...
entry:
  ...
  %picture1.addr = alloca %struct.Picture*, align 8
  %canary = alloca i32
  store i32 321293259, i32* %canary
  %qp.addr = alloca i32, align 4
  %picture2.addr = alloca %struct.Picture*, align 8
  %bit_picture1 = alloca i32, align 4
  %snr_picture2 = alloca double, align 8
...
entry:
  ...
  %bits_version1.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 686684505, i32* %canary
  %cost_version2 = alloca double, align 8
  %cost_version1 = alloca double, align 8
  store double %snrY_version1, double* %snrY_version1.addr, align 8
  store double %snrY_version2, double* %snrY_version2.addr, align 8
...
entry:
  ...
  %bits_version2.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1839532959, i32* %canary
  %lambda_picture.addr = alloca double, align 8
  store double %snrY_version1, double* %snrY_version1.addr, align 8
  store double %snrY_version2, double* %snrY_version2.addr, align 8
  store i32 %bits_version1, i32* %bits_version1.addr, align 4
...
entry:
  ...
  %cost_version1 = alloca double, align 8
  %canary = alloca i32
  store i32 238101042, i32* %canary
  %bits_version2.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  %snrY_version1.addr = alloca double, align 8
  %cost_version2 = alloca double, align 8
...
entry:
  ...
  %picture1.addr = alloca %struct.Picture*, align 8
  %canary = alloca i32
  store i32 503483443, i32* %canary
  %bit_picture2 = alloca i32, align 4
  %qp.addr = alloca i32, align 4
  %spframe = alloca i32, align 4
  %bit_picture1 = alloca i32, align 4
...
entry:
  ...
  %bit_picture2 = alloca i32, align 4
  %canary = alloca i32
  store i32 1050387072, i32* %canary
  %lambda_picture = alloca double, align 8
  %spframe = alloca i32, align 4
  %snr_picture1 = alloca double, align 8
  %picture1.addr = alloca %struct.Picture*, align 8
...
entry:
  ...
  %bit_picture1 = alloca i32, align 4
  %canary = alloca i32
  store i32 1905939962, i32* %canary
  %bframe = alloca i32, align 4
  %picture1.addr = alloca %struct.Picture*, align 8
  %spframe = alloca i32, align 4
  %snr_picture2 = alloca double, align 8
...
entry:
  ...
  %snr_picture1 = alloca double, align 8
  %canary = alloca i32
  store i32 477971854, i32* %canary
  %lambda_picture = alloca double, align 8
  %spframe = alloca i32, align 4
  %picture1.addr = alloca %struct.Picture*, align 8
  %picture2.addr = alloca %struct.Picture*, align 8
...
entry:
  %canary = alloca i32
  store i32 1906019167, i32* %canary
  %bits_version1.addr = alloca i32, align 4
  %snrY_version1.addr = alloca double, align 8
  %retval = alloca i32, align 4
  %lambda_picture.addr = alloca double, align 8
...
entry:
  ...
  %lambda_picture.addr = alloca double, align 8
  %canary = alloca i32
  store i32 564131776, i32* %canary
  %snrY_version2.addr = alloca double, align 8
  store double %snrY_version1, double* %snrY_version1.addr, align 8
  store double %snrY_version2, double* %snrY_version2.addr, align 8
  store i32 %bits_version1, i32* %bits_version1.addr, align 4
...
entry:
  ...
  %snr_picture2 = alloca double, align 8
  %canary = alloca i32
  store i32 1064534833, i32* %canary
  %bframe = alloca i32, align 4
  %bit_picture2 = alloca i32, align 4
  %qp.addr = alloca i32, align 4
  store %struct.Picture* %picture1, %struct.Picture** %picture1.addr, align 8
