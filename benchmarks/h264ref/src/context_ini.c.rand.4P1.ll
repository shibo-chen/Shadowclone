; ModuleID = 'context_ini.c.rand.4P1.bc'
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_create_context_memory.20, label %ctrl0

func_create_context_memory.20:                    ; preds = %rand_bb
  call void @create_context_memory.20()
  ret void

func_create_context_memory.21:                    ; preds = %ctrl0
  call void @create_context_memory.21()
  ret void

func_create_context_memory.26:                    ; preds = %ctrl1
  call void @create_context_memory.26()
  ret void

func_create_context_memory.30:                    ; preds = %ctrl1
  call void @create_context_memory.30()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_create_context_memory.21, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_create_context_memory.26, label %func_create_context_memory.30
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_free_context_memory.2, label %func_free_context_memory.13

func_free_context_memory.2:                       ; preds = %rand_bb
  call void @free_context_memory.2()
  ret void
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_SetCtxModelNumber.9, label %ctrl0

func_SetCtxModelNumber.9:                         ; preds = %rand_bb
  call void @SetCtxModelNumber.9()
  ret void

func_SetCtxModelNumber.10:                        ; preds = %ctrl0
  call void @SetCtxModelNumber.10()
  ret void
...
func_SetCtxModelNumber.14:                        ; preds = %ctrl1
  call void @SetCtxModelNumber.14()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_SetCtxModelNumber.10, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_SetCtxModelNumber.11, label %func_SetCtxModelNumber.14
}
...
func_init_contexts.5:                             ; preds = %ctrl0
  call void @init_contexts.5()
  ret void

func_init_contexts.6:                             ; preds = %ctrl1
  call void @init_contexts.6()
  ret void

func_init_contexts.7:                             ; preds = %ctrl1
  call void @init_contexts.7()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_init_contexts.5, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_init_contexts.6, label %func_init_contexts.7
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_XRate.3, label %ctrl0

func_XRate.3:                                     ; preds = %rand_bb
  %2 = call double @XRate.3(%struct.BiContextType* %ctx, i32* %model)
  ret double %2

func_XRate.4:                                     ; preds = %ctrl0
  %3 = call double @XRate.4(%struct.BiContextType* %ctx, i32* %model)
  ret double %3

func_XRate.8:                                     ; preds = %ctrl1
  %4 = call double @XRate.8(%struct.BiContextType* %ctx, i32* %model)
  ret double %4

func_XRate.16:                                    ; preds = %ctrl1
  %5 = call double @XRate.16(%struct.BiContextType* %ctx, i32* %model)
  ret double %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_XRate.4, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_XRate.8, label %func_XRate.16
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_GetCtxModelNumber.22, label %ctrl0

func_GetCtxModelNumber.22:                        ; preds = %rand_bb
  call void @GetCtxModelNumber.22(i32* %mnumber, %struct.MotionInfoContexts* %mc, %struct.TextureInfoContexts* %tc)
  ret void

func_GetCtxModelNumber.24:                        ; preds = %ctrl0
  call void @GetCtxModelNumber.24(i32* %mnumber, %struct.MotionInfoContexts* %mc, %struct.TextureInfoContexts* %tc)
  ret void

func_GetCtxModelNumber.27:                        ; preds = %ctrl1
  call void @GetCtxModelNumber.27(i32* %mnumber, %struct.MotionInfoContexts* %mc, %struct.TextureInfoContexts* %tc)
  ret void

func_GetCtxModelNumber.29:                        ; preds = %ctrl1
  call void @GetCtxModelNumber.29(i32* %mnumber, %struct.MotionInfoContexts* %mc, %struct.TextureInfoContexts* %tc)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_GetCtxModelNumber.24, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_GetCtxModelNumber.27, label %func_GetCtxModelNumber.29
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_store_contexts.17, label %ctrl0

func_store_contexts.17:                           ; preds = %rand_bb
  call void @store_contexts.17()
  ret void
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_update_field_frame_contexts.12, label %ctrl0

func_update_field_frame_contexts.12:              ; preds = %rand_bb
  call void @update_field_frame_contexts.12(i32 %field)
  ret void
...
func_update_field_frame_contexts.18:              ; preds = %ctrl1
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_update_field_frame_contexts.18, label %func_update_field_frame_contexts.19
}
...
entry:
  ...
  %canary = alloca i32
  store i32 1034069468, i32* %canary
...
for.end642:                                       ; preds = %for.cond601
  ...
  %317 = icmp eq i32 %316, 1034069468
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_context_memory.2() #0 {
entry:
  %k = alloca i32, align 4
  %canary = alloca i32
  store i32 745979399, i32* %canary
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local double @XRate.3(%struct.BiContextType* %ctx, i32* %model) #0 {
entry:
  %weight = alloca double, align 8
  %model.addr = alloca i32*, align 8
  %xr = alloca double, align 8
  %canary = alloca i32
  store i32 1793594973, i32* %canary
...
entry:
  ...
  %xr = alloca double, align 8
  %canary = alloca i32
  store i32 1865721512, i32* %canary
  %mod_state = alloca i32, align 4
  %ctx.addr = alloca %struct.BiContextType*, align 8
  %ctx_state = alloca i32, align 4
  store %struct.BiContextType* %ctx, %struct.BiContextType** %ctx.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @init_contexts.5() #0 {
entry:
  %j = alloca i32, align 4
  %mc = alloca %struct.MotionInfoContexts*, align 8
  %canary = alloca i32
  store i32 693325802, i32* %canary
  %i = alloca i32, align 4
  %tc = alloca %struct.TextureInfoContexts*, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %currentSlice = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 50
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @init_contexts.6() #0 {
entry:
  %i = alloca i32, align 4
  %tc = alloca %struct.TextureInfoContexts*, align 8
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 567028826, i32* %canary
  %mc = alloca %struct.MotionInfoContexts*, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %currentSlice = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 50
  %1 = load %struct.Slice*, %struct.Slice** %currentSlice, align 8
...
entry:
  %canary = alloca i32
  store i32 488426823, i32* %canary
  %mc = alloca %struct.MotionInfoContexts*, align 8
  %j = alloca i32, align 4
  %tc = alloca %struct.TextureInfoContexts*, align 8
  %i = alloca i32, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 1835768913, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @SetCtxModelNumber.10() #0 {
entry:
  %frame_field = alloca i32, align 4
  %ctx_number = alloca i32, align 4
  %canary = alloca i32
  store i32 323138962, i32* %canary
  %img_type = alloca i32, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %field_picture = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 100
  %1 = load i32, i32* %field_picture, align 4
...
entry:
  %canary = alloca i32
  store i32 282280412, i32* %canary
  %img_type = alloca i32, align 4
  %frame_field = alloca i32, align 4
  %ctx_number = alloca i32, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @update_field_frame_contexts.12(i32 %field) #0 {
entry:
  %field.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1093137886, i32* %canary
  %j = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1246822501, i32* %canary
  %i = alloca i32, align 4
  %k = alloca i32, align 4
  store i32 0, i32* %k, align 4
  br label %for.cond
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @SetCtxModelNumber.14() #0 {
entry:
  %canary = alloca i32
  store i32 1493844461, i32* %canary
  %img_type = alloca i32, align 4
  %ctx_number = alloca i32, align 4
  %frame_field = alloca i32, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
entry:
  ...
  %field.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1362789094, i32* %canary
  %i = alloca i32, align 4
  store i32 %field, i32* %field.addr, align 4
  %0 = load i32, i32* %field.addr, align 4
  %tobool = icmp ne i32 %0, 0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local double @XRate.16(%struct.BiContextType* %ctx, i32* %model) #0 {
entry:
  %xr = alloca double, align 8
  %ctx.addr = alloca %struct.BiContextType*, align 8
  %model.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 1415162066, i32* %canary
  %ctx_state = alloca i32, align 4
  %qp = alloca i32, align 4
  %mod_state = alloca i32, align 4
  %weight = alloca double, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @store_contexts.17() #0 {
entry:
  %img_type = alloca i32, align 4
  %frame_field = alloca i32, align 4
  %canary = alloca i32
  store i32 1956565179, i32* %canary
  %ctx_number = alloca i32, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %field_picture = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 100
  %1 = load i32, i32* %field_picture, align 4
...
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1217882403, i32* %canary
  %j = alloca i32, align 4
  %field.addr = alloca i32, align 4
  store i32 %field, i32* %field.addr, align 4
  %0 = load i32, i32* %field.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @create_context_memory.20() #0 {
entry:
  %i = alloca i32, align 4
  %num_mb = alloca i32, align 4
  %canary = alloca i32
  store i32 217294965, i32* %canary
  %j = alloca i32, align 4
  %k = alloca i32, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
entry:
  %canary = alloca i32
  store i32 352206495, i32* %canary
  %num_mb = alloca i32, align 4
  %k = alloca i32, align 4
  %j = alloca i32, align 4
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @GetCtxModelNumber.22(i32* %mnumber, %struct.MotionInfoContexts* %mc, %struct.TextureInfoContexts* %tc) #0 {
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1925915511, i32* %canary
...
for.end685:                                       ; preds = %for.cond
  ...
  %322 = icmp eq i32 %321, 1925915511
...
entry:
  %canary = alloca i32
  store i32 958197274, i32* %canary
  %img_type = alloca i32, align 4
  %ctx_number = alloca i32, align 4
  %frame_field = alloca i32, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @GetCtxModelNumber.24(i32* %mnumber, %struct.MotionInfoContexts* %mc, %struct.TextureInfoContexts* %tc) #0 {
entry:
  %model = alloca i32, align 4
  %min_xr = alloca double, align 8
  %tc.addr = alloca %struct.TextureInfoContexts*, align 8
  ...
  %num_models = alloca i32, align 4
  %canary = alloca i32
  store i32 373287133, i32* %canary
  %j = alloca i32, align 4
  %mnumber.addr = alloca i32*, align 8
  %xr = alloca double, align 8
  store i32* %mnumber, i32** %mnumber.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @create_context_memory.26() #0 {
entry:
  %k = alloca i32, align 4
  %canary = alloca i32
  store i32 1951060811, i32* %canary
  %j = alloca i32, align 4
  %i = alloca i32, align 4
  %num_mb = alloca i32, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @GetCtxModelNumber.27(i32* %mnumber, %struct.MotionInfoContexts* %mc, %struct.TextureInfoContexts* %tc) #0 {
entry:
  %num_models = alloca i32, align 4
  %tc.addr = alloca %struct.TextureInfoContexts*, align 8
  %mc.addr = alloca %struct.MotionInfoContexts*, align 8
  ...
  %mnumber.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 1714206904, i32* %canary
  %min_xr = alloca double, align 8
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  store i32* %mnumber, i32** %mnumber.addr, align 8
...
for.end685:                                       ; preds = %for.cond
  %321 = load i32, i32* %canary
  %322 = icmp eq i32 %321, 1714206904
  br i1 %322, label %323, label %func_exit
...
entry:
  %frame_field = alloca i32, align 4
  %canary = alloca i32
  store i32 2008633842, i32* %canary
  %ctx_number = alloca i32, align 4
  %img_type = alloca i32, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %field_picture = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 100
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @GetCtxModelNumber.29(i32* %mnumber, %struct.MotionInfoContexts* %mc, %struct.TextureInfoContexts* %tc) #0 {
entry:
  %canary = alloca i32
  store i32 589442568, i32* %canary
  %tc.addr = alloca %struct.TextureInfoContexts*, align 8
  %min_xr = alloca double, align 8
  %i = alloca i32, align 4
  %mc.addr = alloca %struct.MotionInfoContexts*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @create_context_memory.30() #0 {
entry:
  %k = alloca i32, align 4
  %num_mb = alloca i32, align 4
  %canary = alloca i32
  store i32 1231173556, i32* %canary
  %j = alloca i32, align 4
  %i = alloca i32, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %FrameSizeInMbs = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 111
