; ModuleID = 'specrand.c.rand.16R1.bc'
...
entry:
  ...
  %canary = alloca i32
  store i32 832590116, i32* %canary
...
entry:
  ...
  %test = alloca i32, align 4
  %canary = alloca i32
  store i32 797857114, i32* %canary
  %hi = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
  %conv = sext i32 %0 to i64
  %div = sdiv i64 %conv, 127773
...
entry:
  ...
  %lo = alloca i32, align 4
  %canary = alloca i32
  store i32 600688894, i32* %canary
  %test = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
  %conv = sext i32 %0 to i64
  %div = sdiv i64 %conv, 127773
...
entry:
  ...
  %test = alloca i32, align 4
  %canary = alloca i32
  store i32 1571437913, i32* %canary
  %lo = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
  %conv = sext i32 %0 to i64
  %div = sdiv i64 %conv, 127773
...
entry:
  ...
  %lo = alloca i32, align 4
  %canary = alloca i32
  store i32 1813559260, i32* %canary
  %hi = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
  %conv = sext i32 %0 to i64
  %div = sdiv i64 %conv, 127773
...
entry:
  %test = alloca i32, align 4
  %canary = alloca i32
  store i32 1345823379, i32* %canary
  %hi = alloca i32, align 4
  %lo = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
  %conv = sext i32 %0 to i64
