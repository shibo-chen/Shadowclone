...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_testEndian.10, label %func_testEndian.16
...
func_img2buf.18:                                  ; preds = %ctrl1
  call void @img2buf.18(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom)
  ret void
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_img2buf.17, label %func_img2buf.18
}
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_write_picture.9, label %func_write_picture.13
}
...
func_write_out_picture.15:                        ; preds = %ctrl0
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_write_out_picture.15, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_write_out_picture.21, label %func_write_out_picture.23
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_clear_picture.6, label %func_clear_picture.11

func_clear_picture.6:                             ; preds = %rand_bb
  call void @clear_picture.6(%struct.storable_picture* %p)
  ret void

func_clear_picture.11:                            ; preds = %rand_bb
  call void @clear_picture.11(%struct.storable_picture* %p)
  ret void
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_write_unpaired_field.19, label %ctrl0

func_write_unpaired_field.19:                     ; preds = %rand_bb
  call void @write_unpaired_field.19(%struct.frame_store* %fs, i32 %p_out)
  ret void

func_write_unpaired_field.20:                     ; preds = %ctrl0
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_write_unpaired_field.20, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_write_unpaired_field.22, label %func_write_unpaired_field.24
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_write_stored_frame.4, label %func_write_stored_frame.12
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_direct_output.3, label %func_direct_output.5
...
entry:
  ...
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 685228439, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1185114755, i32* %canary
...
return:                                           ; preds = %if.end139, %if.then
  ...
  %193 = icmp eq i32 %192, 1185114755
...
entry:
  %canary = alloca i32
  store i32 1326936178, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  %p_out.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 910839936, i32* %canary
...
entry:
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1971743281, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  %0 = load %struct.storable_picture*, %struct.storable_picture** %p.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1595908014, i32* %canary
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  ...
  %109 = icmp eq i32 %108, 1595908014
...
entry:
  ...
  %p.addr = alloca %struct.storable_picture*, align 8
  %canary = alloca i32
  store i32 328022887, i32* %canary
  %p_out.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  store i32 %real_structure, i32* %real_structure.addr, align 4
...
entry:
  %p.addr = alloca %struct.storable_picture*, align 8
  %canary = alloca i32
  store i32 1271080384, i32* %canary
  %real_structure.addr = alloca i32, align 4
  %p_out.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  %p = alloca i8*, align 8
  %canary = alloca i32
  store i32 919590327, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @clear_picture.11(%struct.storable_picture* %p) #0 {
entry:
  %canary = alloca i32
  store i32 1666214460, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  %i = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 0, i32* %i, align 4
...
entry:
  %canary = alloca i32
  store i32 298279667, i32* %canary
  %fs.addr = alloca %struct.frame_store*, align 8
  %p_out.addr = alloca i32, align 4
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 1381264472, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  %p_out.addr = alloca i32, align 4
  %real_structure.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
...
entry:
  ...
  %size = alloca i32, align 4
  %canary = alloca i32
  store i32 1505407562, i32* %canary
  %tmp16 = alloca i16, align 2
  %twidth = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %tmp32 = alloca i64, align 8
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1505407562
  br i1 %109, label %110, label %func_exit
...
entry:
  %canary = alloca i32
  store i32 705929610, i32* %canary
  %s = alloca i16, align 2
  %p = alloca i8*, align 8
  %0 = bitcast i16* %s to i8*
  store i8* %0, i8** %p, align 8
...
entry:
  ...
  %ui16 = alloca i16, align 2
  %canary = alloca i32
  store i32 1450471016, i32* %canary
  %ui32 = alloca i64, align 8
  %imgX.addr = alloca i16**, align 8
  %crop_left.addr = alloca i32, align 4
  %theight = alloca i32, align 4
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1450471016
  br i1 %109, label %110, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @img2buf.18(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom) #0 {
entry:
  %canary = alloca i32
  store i32 977076483, i32* %canary
  %size = alloca i32, align 4
  %imgX.addr = alloca i16**, align 8
  %ui32 = alloca i64, align 8
  %i = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 868233996, i32* %canary
  %fs.addr = alloca %struct.frame_store*, align 8
...
entry:
  ...
  %fs.addr = alloca %struct.frame_store*, align 8
  %canary = alloca i32
  store i32 528048486, i32* %canary
  %p_out.addr = alloca i32, align 4
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  %0 = load %struct.frame_store*, %struct.frame_store** %fs.addr, align 8
...
entry:
  ...
  %buf = alloca i8*, align 8
  %canary = alloca i32
  store i32 1513806067, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  %symbol_size_in_bytes = alloca i32, align 4
  %crop_right = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1513806067
  br i1 %193, label %194, label %func_exit
...
entry:
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 171019044, i32* %canary
  %fs.addr = alloca %struct.frame_store*, align 8
  %p = alloca %struct.storable_picture*, align 8
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 1140836674, i32* %canary
  %buf = alloca i8*, align 8
  %crop_right = alloca i32, align 4
  %SubHeightC = alloca [4 x i32], align 16
  %p.addr = alloca %struct.storable_picture*, align 8
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1140836674
  br i1 %193, label %194, label %func_exit
...
entry:
  %canary = alloca i32
  store i32 451236006, i32* %canary
  %fs.addr = alloca %struct.frame_store*, align 8
  %p_out.addr = alloca i32, align 4
  %p = alloca %struct.storable_picture*, align 8
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
