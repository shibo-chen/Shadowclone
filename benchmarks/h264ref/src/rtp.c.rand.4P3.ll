...
func_WriteRTPPacket.8:                            ; preds = %ctrl1
  %5 = call i32 @WriteRTPPacket.8(%struct.RTPpacket_t* %p, %struct._IO_FILE* %f)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_WriteRTPPacket.4, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_WriteRTPPacket.6, label %func_WriteRTPPacket.8
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_WriteRTPNALU.2, label %func_WriteRTPNALU.7
...
func_WriteRTPNALU.7:                              ; preds = %rand_bb
  %3 = call i32 @WriteRTPNALU.7(%struct.NALU_t* %n)
  ret i32 %3
}
...
entry:
  %canary = alloca i32
  store i32 254848999, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1078859124, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1026002292, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 956959425, i32* %canary
  %delta = alloca i32, align 4
  %tr.addr = alloca i32, align 4
  store i32 %tr, i32* %tr.addr, align 4
  %0 = load i32, i32* @RTPUpdateTimestamp.oldtr, align 4
...
entry:
  ...
  %p.addr = alloca %struct.RTPpacket_t*, align 8
  %canary = alloca i32
  store i32 594001276, i32* %canary
  %retval = alloca i32, align 4
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
  store i32 -1, i32* %intime, align 4
...
entry:
  %canary = alloca i32
  store i32 1749713781, i32* %canary
  %p = alloca %struct.RTPpacket_t*, align 8
  %n.addr = alloca %struct.NALU_t*, align 8
  store %struct.NALU_t* %n, %struct.NALU_t** %n.addr, align 8
  %0 = load %struct.NALU_t*, %struct.NALU_t** %n.addr, align 8
...
entry:
  ...
  %p.addr = alloca %struct.RTPpacket_t*, align 8
  %canary = alloca i32
  store i32 1398993329, i32* %canary
  %intime = alloca i32, align 4
  %retval = alloca i32, align 4
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
