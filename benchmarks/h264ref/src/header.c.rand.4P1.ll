...
func_SliceHeader.7:                               ; preds = %ctrl0
  %3 = call i32 @SliceHeader.7()
  ret i32 %3

func_SliceHeader.13:                              ; preds = %ctrl1
  %4 = call i32 @SliceHeader.13()
  ret i32 %4

func_SliceHeader.18:                              ; preds = %ctrl1
  %5 = call i32 @SliceHeader.18()
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_SliceHeader.7, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_SliceHeader.13, label %func_SliceHeader.18
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_get_picture_type.20, label %func_get_picture_type.21

func_get_picture_type.20:                         ; preds = %rand_bb
  %2 = call i32 @get_picture_type.20()
  ret i32 %2

func_get_picture_type.21:                         ; preds = %rand_bb
  %3 = call i32 @get_picture_type.21()
  ret i32 %3
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_Partition_BC_Header.3, label %ctrl0

func_Partition_BC_Header.3:                       ; preds = %rand_bb
  %2 = call i32 @Partition_BC_Header.3(i32 %PartNo)
  ret i32 %2

func_Partition_BC_Header.12:                      ; preds = %ctrl0
  %3 = call i32 @Partition_BC_Header.12(i32 %PartNo)
  ret i32 %3
...
func_Partition_BC_Header.17:                      ; preds = %ctrl1
  %5 = call i32 @Partition_BC_Header.17(i32 %PartNo)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_Partition_BC_Header.12, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_Partition_BC_Header.15, label %func_Partition_BC_Header.17
}
...
func_ref_pic_list_reordering.9:                   ; preds = %ctrl1
  %4 = call i32 @ref_pic_list_reordering.9()
  ret i32 %4

func_ref_pic_list_reordering.11:                  ; preds = %ctrl1
  %5 = call i32 @ref_pic_list_reordering.11()
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_ref_pic_list_reordering.8, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_ref_pic_list_reordering.9, label %func_ref_pic_list_reordering.11
}
...
func_dec_ref_pic_marking.10:                      ; preds = %ctrl0
  %3 = call i32 @dec_ref_pic_marking.10()
  ret i32 %3

func_dec_ref_pic_marking.14:                      ; preds = %ctrl1
  %4 = call i32 @dec_ref_pic_marking.14()
  ret i32 %4

func_dec_ref_pic_marking.16:                      ; preds = %ctrl1
  %5 = call i32 @dec_ref_pic_marking.16()
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_dec_ref_pic_marking.10, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_dec_ref_pic_marking.14, label %func_dec_ref_pic_marking.16
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_pred_weight_table.2, label %ctrl0

func_pred_weight_table.2:                         ; preds = %rand_bb
  %2 = call i32 @pred_weight_table.2()
  ret i32 %2
...
func_pred_weight_table.19:                        ; preds = %ctrl1
  %4 = call i32 @pred_weight_table.19()
  ret i32 %4

func_pred_weight_table.22:                        ; preds = %ctrl1
  %5 = call i32 @pred_weight_table.22()
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_pred_weight_table.5, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_pred_weight_table.19, label %func_pred_weight_table.22
}
...
entry:
  ...
  %canary = alloca i32
  store i32 1791629337, i32* %canary
...
if.end239:                                        ; preds = %if.then236, %land.lhs.true232, %if.end229
  ...
  %238 = icmp eq i32 %237, 1791629337
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @pred_weight_table.2() #0 {
entry:
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 2111197386, i32* %canary
  %partition = alloca %struct.datapartition*, align 8
  %dP_nr = alloca i32, align 4
  %len = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
if.end175:                                        ; preds = %for.end174, %for.end83
  ...
  %172 = icmp eq i32 %171, 2111197386
...
entry:
  ...
  %canary = alloca i32
  store i32 615805878, i32* %canary
  %len = alloca i32, align 4
...
entry:
  ...
  %partition = alloca %struct.datapartition*, align 8
  %canary = alloca i32
  store i32 502734084, i32* %canary
  %dP_nr = alloca i32, align 4
  %i = alloca i32, align 4
  %len = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 2105293814, i32* %canary
  %partition = alloca %struct.datapartition*, align 8
  %dP_nr = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
...
if.end175:                                        ; preds = %for.end174, %for.end83
  %170 = load i32, i32* %len, align 4
  %171 = load i32, i32* %canary
  %172 = icmp eq i32 %171, 2105293814
  br i1 %172, label %173, label %func_exit
...
entry:
  %dP_nr = alloca i32, align 4
  %canary = alloca i32
  store i32 656144074, i32* %canary
...
entry:
  ...
  %currSlice = alloca %struct.Slice*, align 8
  %canary = alloca i32
  store i32 1075064744, i32* %canary
  %partition = alloca %struct.datapartition*, align 8
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
  %1 = load i32, i32* %partition_mode, align 4
...
if.end239:                                        ; preds = %if.then236, %land.lhs.true232, %if.end229
  %236 = load i32, i32* %len, align 4
  %237 = load i32, i32* %canary
  %238 = icmp eq i32 %237, 1075064744
  br i1 %238, label %239, label %func_exit
...
entry:
  %canary = alloca i32
  store i32 1665334924, i32* %canary
  %currSlice = alloca %struct.Slice*, align 8
  %dP_nr = alloca i32, align 4
  %i = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
...
entry:
  ...
  %dP_nr = alloca i32, align 4
  %canary = alloca i32
  store i32 375206991, i32* %canary
  %currSlice = alloca %struct.Slice*, align 8
  %len = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
...
entry:
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
  %canary = alloca i32
  store i32 1913902088, i32* %canary
  %val = alloca i32, align 4
  %len = alloca i32, align 4
  %dP_nr = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
...
entry:
  ...
  %partition = alloca %struct.datapartition*, align 8
  %canary = alloca i32
  store i32 628266089, i32* %canary
  %i = alloca i32, align 4
  %currSlice = alloca %struct.Slice*, align 8
  %len = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @Partition_BC_Header.12(i32 %PartNo) #0 {
entry:
  %partition = alloca %struct.datapartition*, align 8
  %sym = alloca %struct.syntaxelement*, align 8
  %len = alloca i32, align 4
  %canary = alloca i32
  store i32 486635811, i32* %canary
  %symbol = alloca %struct.syntaxelement, align 8
  %PartNo.addr = alloca i32, align 4
  store i32 %PartNo, i32* %PartNo.addr, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
entry:
  ...
  %field_pic_flag = alloca i32, align 4
  %canary = alloca i32
  store i32 1998053263, i32* %canary
  %num_bits_slice_group_change_cycle = alloca i32, align 4
  %numtmp = alloca float, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
...
if.end239:                                        ; preds = %if.then236, %land.lhs.true232, %if.end229
  %236 = load i32, i32* %len, align 4
  %237 = load i32, i32* %canary
  %238 = icmp eq i32 %237, 1998053263
  br i1 %238, label %239, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @dec_ref_pic_marking.14() #0 {
entry:
  %len = alloca i32, align 4
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
  %canary = alloca i32
  store i32 1769559320, i32* %canary
  %val = alloca i32, align 4
  %dP_nr = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
entry:
  %canary = alloca i32
  store i32 129934472, i32* %canary
  %len = alloca i32, align 4
  %dP_nr = alloca i32, align 4
  %val = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
...
entry:
  ...
  %symbol = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 1744512187, i32* %canary
  %sym = alloca %struct.syntaxelement*, align 8
  %len = alloca i32, align 4
  %PartNo.addr = alloca i32, align 4
  store i32 %PartNo, i32* %PartNo.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @SliceHeader.18() #0 {
entry:
  %num_bits_slice_group_change_cycle = alloca i32, align 4
  %bottom_field_flag = alloca i32, align 4
  %currSlice = alloca %struct.Slice*, align 8
  ...
  %len = alloca i32, align 4
  %canary = alloca i32
  store i32 621093289, i32* %canary
  %partition = alloca %struct.datapartition*, align 8
  %numtmp = alloca float, align 4
  %field_pic_flag = alloca i32, align 4
  %override_flag = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @pred_weight_table.19() #0 {
entry:
  %partition = alloca %struct.datapartition*, align 8
  %j = alloca i32, align 4
  %dP_nr = alloca i32, align 4
  %canary = alloca i32
  store i32 2091803904, i32* %canary
  %i = alloca i32, align 4
  %len = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
...
if.end175:                                        ; preds = %for.end174, %for.end83
  %170 = load i32, i32* %len, align 4
  %171 = load i32, i32* %canary
  %172 = icmp eq i32 %171, 2091803904
  br i1 %172, label %173, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_picture_type.20() #0 {
entry:
  %same_slicetype_for_whole_frame = alloca i32, align 4
  %canary = alloca i32
  store i32 1444922907, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_picture_type.21() #0 {
entry:
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1729365806, i32* %canary
  %same_slicetype_for_whole_frame = alloca i32, align 4
  store i32 5, i32* %same_slicetype_for_whole_frame, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %type = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 6
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @pred_weight_table.22() #0 {
entry:
  %partition = alloca %struct.datapartition*, align 8
  %dP_nr = alloca i32, align 4
  %canary = alloca i32
  store i32 1778735971, i32* %canary
  %j = alloca i32, align 4
  %len = alloca i32, align 4
  %i = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
if.end175:                                        ; preds = %for.end174, %for.end83
  %170 = load i32, i32* %len, align 4
  %171 = load i32, i32* %canary
  %172 = icmp eq i32 %171, 1778735971
  br i1 %172, label %173, label %func_exit
