; ModuleID = 'intrarefresh.c.rand.8R2.bc'
...
ctrl3:                                            ; preds = %ctrl2
  %11 = icmp eq i32 %0, 4
  br i1 %11, label %func_RandomIntra.9, label %func_RandomIntra.13
}
...
entry:
  %canary = alloca i32
  store i32 1059507057, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 550528386, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 247226721, i32* %canary
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %0 = load i32, i32* @NumberIntraPerPicture, align 4
  %1 = load i32, i32* @WalkAround, align 4
...
entry:
  %canary = alloca i32
  store i32 1157033027, i32* %canary
  %i = alloca i32, align 4
  %pos = alloca i32, align 4
  %ysize.addr = alloca i32, align 4
  %refresh.addr = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1443136378, i32* %canary
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 509583268, i32* %canary
  %i = alloca i32, align 4
  store i32 %mb, i32* %mb.addr, align 4
  store i32 0, i32* %i, align 4
  br label %for.cond
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 100741134, i32* %canary
  %retval = alloca i32, align 4
  store i32 %mb, i32* %mb.addr, align 4
  store i32 0, i32* %i, align 4
  br label %for.cond
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 2007579587, i32* %canary
  %mb.addr = alloca i32, align 4
  store i32 %mb, i32* %mb.addr, align 4
  store i32 0, i32* %i, align 4
  br label %for.cond
...
entry:
  %canary = alloca i32
  store i32 1853414839, i32* %canary
  %retval = alloca i32, align 4
  %i = alloca i32, align 4
  %mb.addr = alloca i32, align 4
  store i32 %mb, i32* %mb.addr, align 4
...
entry:
  ...
  %pos = alloca i32, align 4
  %canary = alloca i32
  store i32 784666787, i32* %canary
  %xsize.addr = alloca i32, align 4
  %ysize.addr = alloca i32, align 4
  store i32 %xsize, i32* %xsize.addr, align 4
  store i32 %ysize, i32* %ysize.addr, align 4
...
entry:
  ...
  %ysize.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 553749925, i32* %canary
  %refresh.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %xsize.addr = alloca i32, align 4
  store i32 %xsize, i32* %xsize.addr, align 4
...
entry:
  ...
  %pos = alloca i32, align 4
  %canary = alloca i32
  store i32 656740976, i32* %canary
  %i = alloca i32, align 4
  store i32 %xsize, i32* %xsize.addr, align 4
  store i32 %ysize, i32* %ysize.addr, align 4
  store i32 %refresh, i32* %refresh.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 1189917515, i32* %canary
  %i = alloca i32, align 4
  %mb.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  store i32 %mb, i32* %mb.addr, align 4
...
entry:
  ...
  %ysize.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1124941539, i32* %canary
  %xsize.addr = alloca i32, align 4
  %refresh.addr = alloca i32, align 4
  %i = alloca i32, align 4
  store i32 %xsize, i32* %xsize.addr, align 4
...
entry:
  ...
  %xsize.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1736145793, i32* %canary
  %i = alloca i32, align 4
  %pos = alloca i32, align 4
  %refresh.addr = alloca i32, align 4
  store i32 %xsize, i32* %xsize.addr, align 4
...
entry:
  ...
  %pos = alloca i32, align 4
  %canary = alloca i32
  store i32 1779449585, i32* %canary
  %ysize.addr = alloca i32, align 4
  store i32 %xsize, i32* %xsize.addr, align 4
  store i32 %ysize, i32* %ysize.addr, align 4
  store i32 %refresh, i32* %refresh.addr, align 4
