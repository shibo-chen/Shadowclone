; ModuleID = 'context_ini.c.rand.4R1.bc'
...
func_create_context_memory.14:                    ; preds = %ctrl1
  call void @create_context_memory.14()
  ret void

func_create_context_memory.19:                    ; preds = %ctrl1
  call void @create_context_memory.19()
  ret void
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_create_context_memory.14, label %func_create_context_memory.19
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_free_context_memory.5, label %func_free_context_memory.29

func_free_context_memory.5:                       ; preds = %rand_bb
  call void @free_context_memory.5()
  ret void

func_free_context_memory.29:                      ; preds = %rand_bb
  call void @free_context_memory.29()
  ret void
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_SetCtxModelNumber.24, label %ctrl0

func_SetCtxModelNumber.24:                        ; preds = %rand_bb
  call void @SetCtxModelNumber.24()
  ret void

func_SetCtxModelNumber.26:                        ; preds = %ctrl0
  call void @SetCtxModelNumber.26()
  ret void

func_SetCtxModelNumber.27:                        ; preds = %ctrl1
  call void @SetCtxModelNumber.27()
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_SetCtxModelNumber.26, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_SetCtxModelNumber.27, label %func_SetCtxModelNumber.30
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_init_contexts.1, label %ctrl0

func_init_contexts.1:                             ; preds = %rand_bb
  call void @init_contexts.1()
  ret void
...
func_init_contexts.12:                            ; preds = %ctrl1
  call void @init_contexts.12()
  ret void

func_init_contexts.17:                            ; preds = %ctrl1
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_init_contexts.12, label %func_init_contexts.17
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_XRate.8, label %ctrl0

func_XRate.8:                                     ; preds = %rand_bb
  %2 = call double @XRate.8(%struct.BiContextType* %ctx, i32* %model)
  ret double %2

func_XRate.9:                                     ; preds = %ctrl0
  %3 = call double @XRate.9(%struct.BiContextType* %ctx, i32* %model)
  ret double %3
...
func_XRate.13:                                    ; preds = %ctrl1
  %5 = call double @XRate.13(%struct.BiContextType* %ctx, i32* %model)
  ret double %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_XRate.9, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_XRate.11, label %func_XRate.13
}
...
func_GetCtxModelNumber.15:                        ; preds = %ctrl1
  call void @GetCtxModelNumber.15(i32* %mnumber, %struct.MotionInfoContexts* %mc, %struct.TextureInfoContexts* %tc)
  ret void

func_GetCtxModelNumber.18:                        ; preds = %ctrl1
  call void @GetCtxModelNumber.18(i32* %mnumber, %struct.MotionInfoContexts* %mc, %struct.TextureInfoContexts* %tc)
  ret void
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_GetCtxModelNumber.15, label %func_GetCtxModelNumber.18
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_store_contexts.22, label %ctrl0

func_store_contexts.22:                           ; preds = %rand_bb
  call void @store_contexts.22()
  ret void

func_store_contexts.23:                           ; preds = %ctrl0
  call void @store_contexts.23()
  ret void

func_store_contexts.25:                           ; preds = %ctrl1
  call void @store_contexts.25()
  ret void

func_store_contexts.28:                           ; preds = %ctrl1
  call void @store_contexts.28()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_store_contexts.23, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_store_contexts.25, label %func_store_contexts.28
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_update_field_frame_contexts.3, label %ctrl0

func_update_field_frame_contexts.3:               ; preds = %rand_bb
  call void @update_field_frame_contexts.3(i32 %field)
  ret void

func_update_field_frame_contexts.16:              ; preds = %ctrl0
...
func_update_field_frame_contexts.21:              ; preds = %ctrl1
  call void @update_field_frame_contexts.21(i32 %field)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_update_field_frame_contexts.16, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_update_field_frame_contexts.20, label %func_update_field_frame_contexts.21
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @init_contexts.1() #0 {
entry:
  %mc = alloca %struct.MotionInfoContexts*, align 8
  %canary = alloca i32
  store i32 1975214979, i32* %canary
...
for.end642:                                       ; preds = %for.cond601
  ...
  %317 = icmp eq i32 %316, 1975214979
...
entry:
  %canary = alloca i32
  store i32 662396542, i32* %canary
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @update_field_frame_contexts.3(i32 %field) #0 {
entry:
  %canary = alloca i32
  store i32 1091203859, i32* %canary
...
entry:
  %mc = alloca %struct.MotionInfoContexts*, align 8
  %canary = alloca i32
  store i32 1243924706, i32* %canary
  %i = alloca i32, align 4
  %tc = alloca %struct.TextureInfoContexts*, align 8
  %j = alloca i32, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
for.end642:                                       ; preds = %for.cond601
  %316 = load i32, i32* %canary
  %317 = icmp eq i32 %316, 1243924706
  br i1 %317, label %318, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_context_memory.5() #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1330256837, i32* %canary
  %k = alloca i32, align 4
  store i32 0, i32* %k, align 4
  br label %for.cond
...
entry:
  ...
  %canary = alloca i32
  store i32 1369289190, i32* %canary
  %i = alloca i32, align 4
...
for.end685:                                       ; preds = %for.cond
  ...
  %322 = icmp eq i32 %321, 1369289190
...
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1794596230, i32* %canary
  %k = alloca i32, align 4
  %num_mb = alloca i32, align 4
  %j = alloca i32, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local double @XRate.8(%struct.BiContextType* %ctx, i32* %model) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 421188635, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local double @XRate.9(%struct.BiContextType* %ctx, i32* %model) #0 {
entry:
  %xr = alloca double, align 8
  %canary = alloca i32
  store i32 317209999, i32* %canary
  %ctx.addr = alloca %struct.BiContextType*, align 8
  %qp = alloca i32, align 4
  %ctx_state = alloca i32, align 4
  %model.addr = alloca i32*, align 8
...
entry:
  ...
  %mc.addr = alloca %struct.MotionInfoContexts*, align 8
  %canary = alloca i32
  store i32 563965586, i32* %canary
  %i = alloca i32, align 4
  store i32* %mnumber, i32** %mnumber.addr, align 8
  store %struct.MotionInfoContexts* %mc, %struct.MotionInfoContexts** %mc.addr, align 8
  store %struct.TextureInfoContexts* %tc, %struct.TextureInfoContexts** %tc.addr, align 8
...
entry:
  ...
  %xr = alloca double, align 8
  %canary = alloca i32
  store i32 747136169, i32* %canary
  %mod_state = alloca i32, align 4
  %weight = alloca double, align 8
  %ctx.addr = alloca %struct.BiContextType*, align 8
  store %struct.BiContextType* %ctx, %struct.BiContextType** %ctx.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @init_contexts.12() #0 {
entry:
  %mc = alloca %struct.MotionInfoContexts*, align 8
  %canary = alloca i32
  store i32 707438879, i32* %canary
  %tc = alloca %struct.TextureInfoContexts*, align 8
  %j = alloca i32, align 4
  %i = alloca i32, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local double @XRate.13(%struct.BiContextType* %ctx, i32* %model) #0 {
entry:
  %mod_state = alloca i32, align 4
  %ctx.addr = alloca %struct.BiContextType*, align 8
  %weight = alloca double, align 8
  ...
  %model.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 1999672114, i32* %canary
  %ctx_state = alloca i32, align 4
  store %struct.BiContextType* %ctx, %struct.BiContextType** %ctx.addr, align 8
  store i32* %model, i32** %model.addr, align 8
  store double 0.000000e+00, double* %xr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @create_context_memory.14() #0 {
entry:
  %canary = alloca i32
  store i32 949854518, i32* %canary
  %k = alloca i32, align 4
  %j = alloca i32, align 4
  %i = alloca i32, align 4
  %num_mb = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @GetCtxModelNumber.15(i32* %mnumber, %struct.MotionInfoContexts* %mc, %struct.TextureInfoContexts* %tc) #0 {
entry:
  %i = alloca i32, align 4
  %mnumber.addr = alloca i32*, align 8
  %tc.addr = alloca %struct.TextureInfoContexts*, align 8
  ...
  %mc.addr = alloca %struct.MotionInfoContexts*, align 8
  %canary = alloca i32
  store i32 1397996813, i32* %canary
  %num_models = alloca i32, align 4
  store i32* %mnumber, i32** %mnumber.addr, align 8
  store %struct.MotionInfoContexts* %mc, %struct.MotionInfoContexts** %mc.addr, align 8
  store %struct.TextureInfoContexts* %tc, %struct.TextureInfoContexts** %tc.addr, align 8
...
for.end685:                                       ; preds = %for.cond
  %321 = load i32, i32* %canary
  %322 = icmp eq i32 %321, 1397996813
  br i1 %322, label %323, label %func_exit
...
entry:
  ...
  %field.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 421150241, i32* %canary
  %i = alloca i32, align 4
  store i32 %field, i32* %field.addr, align 4
  %0 = load i32, i32* %field.addr, align 4
  %tobool = icmp ne i32 %0, 0
...
entry:
  ...
  %tc = alloca %struct.TextureInfoContexts*, align 8
  %canary = alloca i32
  store i32 1171664766, i32* %canary
  %mc = alloca %struct.MotionInfoContexts*, align 8
  %i = alloca i32, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %currentSlice = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 50
...
for.end642:                                       ; preds = %for.cond601
  %316 = load i32, i32* %canary
  %317 = icmp eq i32 %316, 1171664766
  br i1 %317, label %318, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @GetCtxModelNumber.18(i32* %mnumber, %struct.MotionInfoContexts* %mc, %struct.TextureInfoContexts* %tc) #0 {
entry:
  %model = alloca i32, align 4
  %xr = alloca double, align 8
  %min_xr = alloca double, align 8
  ...
  %mnumber.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 1168312926, i32* %canary
  %tc.addr = alloca %struct.TextureInfoContexts*, align 8
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %num_models = alloca i32, align 4
...
for.end685:                                       ; preds = %for.cond
  %321 = load i32, i32* %canary
  %322 = icmp eq i32 %321, 1168312926
  br i1 %322, label %323, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @create_context_memory.19() #0 {
entry:
  %canary = alloca i32
  store i32 1775436515, i32* %canary
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %k = alloca i32, align 4
  %num_mb = alloca i32, align 4
...
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 177941514, i32* %canary
  %field.addr = alloca i32, align 4
  %j = alloca i32, align 4
  store i32 %field, i32* %field.addr, align 4
  %0 = load i32, i32* %field.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @update_field_frame_contexts.21(i32 %field) #0 {
entry:
  %canary = alloca i32
  store i32 168608779, i32* %canary
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %field.addr = alloca i32, align 4
  store i32 %field, i32* %field.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @store_contexts.22() #0 {
entry:
  %img_type = alloca i32, align 4
  %ctx_number = alloca i32, align 4
  %canary = alloca i32
  store i32 1760174293, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @store_contexts.23() #0 {
entry:
  %canary = alloca i32
  store i32 498798550, i32* %canary
  %img_type = alloca i32, align 4
  %frame_field = alloca i32, align 4
  %ctx_number = alloca i32, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @SetCtxModelNumber.24() #0 {
entry:
  %img_type = alloca i32, align 4
  %ctx_number = alloca i32, align 4
  %canary = alloca i32
  store i32 1346815619, i32* %canary
  %frame_field = alloca i32, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %field_picture = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 100
  %1 = load i32, i32* %field_picture, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @store_contexts.25() #0 {
entry:
  %ctx_number = alloca i32, align 4
  %canary = alloca i32
  store i32 497389961, i32* %canary
  %frame_field = alloca i32, align 4
  %img_type = alloca i32, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %field_picture = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 100
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @SetCtxModelNumber.26() #0 {
entry:
  %ctx_number = alloca i32, align 4
  %img_type = alloca i32, align 4
  %canary = alloca i32
  store i32 79204656, i32* %canary
  %frame_field = alloca i32, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %field_picture = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 100
  %1 = load i32, i32* %field_picture, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @SetCtxModelNumber.27() #0 {
entry:
  %img_type = alloca i32, align 4
  %canary = alloca i32
  store i32 1318385791, i32* %canary
  %frame_field = alloca i32, align 4
  %ctx_number = alloca i32, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %field_picture = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 100
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @store_contexts.28() #0 {
entry:
  %canary = alloca i32
  store i32 2033582450, i32* %canary
  %frame_field = alloca i32, align 4
  %img_type = alloca i32, align 4
  %ctx_number = alloca i32, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_context_memory.29() #0 {
entry:
  %k = alloca i32, align 4
  %canary = alloca i32
  store i32 2055673611, i32* %canary
  %i = alloca i32, align 4
  store i32 0, i32* %k, align 4
  br label %for.cond
...
entry:
  ...
  %img_type = alloca i32, align 4
  %canary = alloca i32
  store i32 1606332267, i32* %canary
  %ctx_number = alloca i32, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %field_picture = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 100
  %1 = load i32, i32* %field_picture, align 4
