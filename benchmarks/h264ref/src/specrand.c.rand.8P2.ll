; ModuleID = 'specrand.c.rand.8P2.bc'
...
entry:
  ...
  %canary = alloca i32
  store i32 1466396199, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 331642702, i32* %canary
  %lo = alloca i32, align 4
  %hi = alloca i32, align 4
  %test = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
...
entry:
  ...
  %hi = alloca i32, align 4
  %canary = alloca i32
  store i32 1804698687, i32* %canary
  %lo = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
  %conv = sext i32 %0 to i64
  %div = sdiv i64 %conv, 127773
...
entry:
  ...
  %test = alloca i32, align 4
  %canary = alloca i32
  store i32 2059799950, i32* %canary
  %lo = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
  %conv = sext i32 %0 to i64
  %div = sdiv i64 %conv, 127773
...
entry:
  %canary = alloca i32
  store i32 1171833111, i32* %canary
  %lo = alloca i32, align 4
  %test = alloca i32, align 4
  %hi = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
...
entry:
  ...
  %lo = alloca i32, align 4
  %canary = alloca i32
  store i32 773011580, i32* %canary
  %hi = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
  %conv = sext i32 %0 to i64
  %div = sdiv i64 %conv, 127773
