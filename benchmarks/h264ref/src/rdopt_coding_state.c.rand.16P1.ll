; ModuleID = 'rdopt_coding_state.c.rand.16P1.bc'
...
func_store_coding_state.2:                        ; preds = %ctrl0
  call void @store_coding_state.2(%struct.CSobj* %cs)
  ret void

func_store_coding_state.4:                        ; preds = %ctrl1
  call void @store_coding_state.4(%struct.CSobj* %cs)
  ret void

func_store_coding_state.5:                        ; preds = %ctrl2
  call void @store_coding_state.5(%struct.CSobj* %cs)
  ret void

func_store_coding_state.6:                        ; preds = %ctrl3
  call void @store_coding_state.6(%struct.CSobj* %cs)
  ret void

func_store_coding_state.7:                        ; preds = %ctrl4
  call void @store_coding_state.7(%struct.CSobj* %cs)
  ret void

func_store_coding_state.10:                       ; preds = %ctrl5
  call void @store_coding_state.10(%struct.CSobj* %cs)
  ret void

func_store_coding_state.11:                       ; preds = %ctrl6
  call void @store_coding_state.11(%struct.CSobj* %cs)
  ret void

func_store_coding_state.12:                       ; preds = %ctrl7
  call void @store_coding_state.12(%struct.CSobj* %cs)
  ret void

func_store_coding_state.16:                       ; preds = %ctrl8
  call void @store_coding_state.16(%struct.CSobj* %cs)
  ret void

func_store_coding_state.17:                       ; preds = %ctrl9
  call void @store_coding_state.17(%struct.CSobj* %cs)
  ret void

func_store_coding_state.20:                       ; preds = %ctrl10
  call void @store_coding_state.20(%struct.CSobj* %cs)
  ret void

func_store_coding_state.26:                       ; preds = %ctrl11
  call void @store_coding_state.26(%struct.CSobj* %cs)
  ret void

func_store_coding_state.27:                       ; preds = %ctrl12
  call void @store_coding_state.27(%struct.CSobj* %cs)
  ret void

func_store_coding_state.28:                       ; preds = %ctrl13
  call void @store_coding_state.28(%struct.CSobj* %cs)
  ret void

func_store_coding_state.29:                       ; preds = %ctrl13
  call void @store_coding_state.29(%struct.CSobj* %cs)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_store_coding_state.2, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_store_coding_state.4, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_store_coding_state.5, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_store_coding_state.6, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_store_coding_state.7, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_store_coding_state.10, label %ctrl6

ctrl6:                                            ; preds = %ctrl5
  %8 = icmp eq i32 %0, 7
  br i1 %8, label %func_store_coding_state.11, label %ctrl7

ctrl7:                                            ; preds = %ctrl6
  %9 = icmp eq i32 %0, 8
  br i1 %9, label %func_store_coding_state.12, label %ctrl8

ctrl8:                                            ; preds = %ctrl7
  %10 = icmp eq i32 %0, 9
  br i1 %10, label %func_store_coding_state.16, label %ctrl9

ctrl9:                                            ; preds = %ctrl8
  %11 = icmp eq i32 %0, 10
  br i1 %11, label %func_store_coding_state.17, label %ctrl10

ctrl10:                                           ; preds = %ctrl9
  %12 = icmp eq i32 %0, 11
  br i1 %12, label %func_store_coding_state.20, label %ctrl11

ctrl11:                                           ; preds = %ctrl10
  %13 = icmp eq i32 %0, 12
  br i1 %13, label %func_store_coding_state.26, label %ctrl12

ctrl12:                                           ; preds = %ctrl11
  %14 = icmp eq i32 %0, 13
  br i1 %14, label %func_store_coding_state.27, label %ctrl13

ctrl13:                                           ; preds = %ctrl12
  %15 = icmp eq i32 %0, 14
  br i1 %15, label %func_store_coding_state.28, label %func_store_coding_state.29
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_reset_coding_state.3, label %ctrl0

func_reset_coding_state.3:                        ; preds = %rand_bb
  call void @reset_coding_state.3(%struct.CSobj* %cs)
  ret void

func_reset_coding_state.8:                        ; preds = %ctrl0
  call void @reset_coding_state.8(%struct.CSobj* %cs)
  ret void

func_reset_coding_state.9:                        ; preds = %ctrl1
  call void @reset_coding_state.9(%struct.CSobj* %cs)
  ret void

func_reset_coding_state.13:                       ; preds = %ctrl2
  call void @reset_coding_state.13(%struct.CSobj* %cs)
  ret void

func_reset_coding_state.14:                       ; preds = %ctrl3
  call void @reset_coding_state.14(%struct.CSobj* %cs)
  ret void

func_reset_coding_state.15:                       ; preds = %ctrl4
  call void @reset_coding_state.15(%struct.CSobj* %cs)
  ret void

func_reset_coding_state.18:                       ; preds = %ctrl5
  call void @reset_coding_state.18(%struct.CSobj* %cs)
  ret void

func_reset_coding_state.19:                       ; preds = %ctrl6
  call void @reset_coding_state.19(%struct.CSobj* %cs)
  ret void

func_reset_coding_state.21:                       ; preds = %ctrl7
  call void @reset_coding_state.21(%struct.CSobj* %cs)
  ret void

func_reset_coding_state.22:                       ; preds = %ctrl8
  call void @reset_coding_state.22(%struct.CSobj* %cs)
  ret void

func_reset_coding_state.23:                       ; preds = %ctrl9
...
func_reset_coding_state.30:                       ; preds = %ctrl12
  call void @reset_coding_state.30(%struct.CSobj* %cs)
  ret void

func_reset_coding_state.31:                       ; preds = %ctrl13
  call void @reset_coding_state.31(%struct.CSobj* %cs)
  ret void

func_reset_coding_state.32:                       ; preds = %ctrl13
  call void @reset_coding_state.32(%struct.CSobj* %cs)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_reset_coding_state.8, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_reset_coding_state.9, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_reset_coding_state.13, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_reset_coding_state.14, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_reset_coding_state.15, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_reset_coding_state.18, label %ctrl6

ctrl6:                                            ; preds = %ctrl5
  %8 = icmp eq i32 %0, 7
  br i1 %8, label %func_reset_coding_state.19, label %ctrl7

ctrl7:                                            ; preds = %ctrl6
  %9 = icmp eq i32 %0, 8
  br i1 %9, label %func_reset_coding_state.21, label %ctrl8

ctrl8:                                            ; preds = %ctrl7
  %10 = icmp eq i32 %0, 9
  br i1 %10, label %func_reset_coding_state.22, label %ctrl9

ctrl9:                                            ; preds = %ctrl8
  %11 = icmp eq i32 %0, 10
  br i1 %11, label %func_reset_coding_state.23, label %ctrl10
...
ctrl12:                                           ; preds = %ctrl11
  %14 = icmp eq i32 %0, 13
  br i1 %14, label %func_reset_coding_state.30, label %ctrl13

ctrl13:                                           ; preds = %ctrl12
  %15 = icmp eq i32 %0, 14
  br i1 %15, label %func_reset_coding_state.31, label %func_reset_coding_state.32
}
...
entry:
  ...
  %canary = alloca i32
  store i32 1256692948, i32* %canary
...
entry:
  ...
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %canary = alloca i32
  store i32 2003654907, i32* %canary
  %cs.addr = alloca %struct.CSobj*, align 8
  %i = alloca i32, align 4
  %currMB = alloca %struct.macroblock*, align 8
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
...
entry:
  ...
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 1666331844, i32* %canary
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %cs.addr = alloca %struct.CSobj*, align 8
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  store %struct.CSobj* %cs, %struct.CSobj** %cs.addr, align 8
...
entry:
  ...
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 284589312, i32* %canary
  %cs.addr = alloca %struct.CSobj*, align 8
  %currMB = alloca %struct.macroblock*, align 8
  %bs_src = alloca %struct.Bitstream*, align 8
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
...
entry:
  ...
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 2141528336, i32* %canary
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %bs_dest = alloca %struct.Bitstream*, align 8
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  store %struct.CSobj* %cs, %struct.CSobj** %cs.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1632551882, i32* %canary
  %i = alloca i32, align 4
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
...
entry:
  ...
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %canary = alloca i32
  store i32 472203614, i32* %canary
  %i = alloca i32, align 4
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %currMB = alloca %struct.macroblock*, align 8
...
entry:
  %canary = alloca i32
  store i32 1714613748, i32* %canary
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
...
entry:
  ...
  %bs_dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 1351136275, i32* %canary
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %i = alloca i32, align 4
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
...
entry:
  ...
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %canary = alloca i32
  store i32 1265447696, i32* %canary
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %bs_dest = alloca %struct.Bitstream*, align 8
  %i = alloca i32, align 4
  %cs.addr = alloca %struct.CSobj*, align 8
...
entry:
  %canary = alloca i32
  store i32 2110002015, i32* %canary
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %currMB = alloca %struct.macroblock*, align 8
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
...
entry:
  ...
  %cs.addr = alloca %struct.CSobj*, align 8
  %canary = alloca i32
  store i32 1524103039, i32* %canary
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %bs_dest = alloca %struct.Bitstream*, align 8
  %bs_src = alloca %struct.Bitstream*, align 8
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
...
entry:
  ...
  %currMB = alloca %struct.macroblock*, align 8
  %canary = alloca i32
  store i32 1551138148, i32* %canary
  %bs_dest = alloca %struct.Bitstream*, align 8
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  store %struct.CSobj* %cs, %struct.CSobj** %cs.addr, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
entry:
  ...
  %bs_src = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 1158804452, i32* %canary
  %bs_dest = alloca %struct.Bitstream*, align 8
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  store %struct.CSobj* %cs, %struct.CSobj** %cs.addr, align 8
...
entry:
  ...
  %currMB = alloca %struct.macroblock*, align 8
  %canary = alloca i32
  store i32 1540527648, i32* %canary
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %bs_dest = alloca %struct.Bitstream*, align 8
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
...
entry:
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %canary = alloca i32
  store i32 2020795264, i32* %canary
  %currMB = alloca %struct.macroblock*, align 8
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
...
entry:
  ...
  %currMB = alloca %struct.macroblock*, align 8
  %canary = alloca i32
  store i32 150985765, i32* %canary
  %i = alloca i32, align 4
  store %struct.CSobj* %cs, %struct.CSobj** %cs.addr, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %currentSlice = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 50
...
entry:
  ...
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 1742179657, i32* %canary
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %currMB = alloca %struct.macroblock*, align 8
  %bs_dest = alloca %struct.Bitstream*, align 8
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
...
entry:
  %canary = alloca i32
  store i32 1130509908, i32* %canary
  %cs.addr = alloca %struct.CSobj*, align 8
  %bs_src = alloca %struct.Bitstream*, align 8
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %currMB = alloca %struct.macroblock*, align 8
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1577760444, i32* %canary
  %cs.addr = alloca %struct.CSobj*, align 8
  %currMB = alloca %struct.macroblock*, align 8
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  store %struct.CSobj* %cs, %struct.CSobj** %cs.addr, align 8
...
entry:
  ...
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %canary = alloca i32
  store i32 711115870, i32* %canary
  %bs_src = alloca %struct.Bitstream*, align 8
  store %struct.CSobj* %cs, %struct.CSobj** %cs.addr, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %currentSlice = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 50
...
entry:
  ...
  %cs.addr = alloca %struct.CSobj*, align 8
  %canary = alloca i32
  store i32 1688672485, i32* %canary
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %bs_src = alloca %struct.Bitstream*, align 8
  %i = alloca i32, align 4
...
entry:
  ...
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 1769413257, i32* %canary
  %cs.addr = alloca %struct.CSobj*, align 8
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  store %struct.CSobj* %cs, %struct.CSobj** %cs.addr, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @store_coding_state.26(%struct.CSobj* %cs) #0 {
entry:
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1679175248, i32* %canary
  %cs.addr = alloca %struct.CSobj*, align 8
  %currMB = alloca %struct.macroblock*, align 8
  %bs_src = alloca %struct.Bitstream*, align 8
  store %struct.CSobj* %cs, %struct.CSobj** %cs.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @store_coding_state.27(%struct.CSobj* %cs) #0 {
entry:
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %bs_dest = alloca %struct.Bitstream*, align 8
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  ...
  %cs.addr = alloca %struct.CSobj*, align 8
  %canary = alloca i32
  store i32 1296032185, i32* %canary
  %currMB = alloca %struct.macroblock*, align 8
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %bs_src = alloca %struct.Bitstream*, align 8
  store %struct.CSobj* %cs, %struct.CSobj** %cs.addr, align 8
...
entry:
  ...
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %canary = alloca i32
  store i32 1323980043, i32* %canary
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %bs_src = alloca %struct.Bitstream*, align 8
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
...
entry:
  ...
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %canary = alloca i32
  store i32 2056461828, i32* %canary
  %bs_src = alloca %struct.Bitstream*, align 8
  %cs.addr = alloca %struct.CSobj*, align 8
  %currMB = alloca %struct.macroblock*, align 8
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @reset_coding_state.30(%struct.CSobj* %cs) #0 {
entry:
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %cs.addr = alloca %struct.CSobj*, align 8
  ...
  %bs_src = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 1824324704, i32* %canary
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  store %struct.CSobj* %cs, %struct.CSobj** %cs.addr, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %currentSlice = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 50
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @reset_coding_state.31(%struct.CSobj* %cs) #0 {
entry:
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 1927027155, i32* %canary
  %bs_dest = alloca %struct.Bitstream*, align 8
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @reset_coding_state.32(%struct.CSobj* %cs) #0 {
entry:
  %bs_src = alloca %struct.Bitstream*, align 8
  %cs.addr = alloca %struct.CSobj*, align 8
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %bs_dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 1049980285, i32* %canary
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %i = alloca i32, align 4
  %currMB = alloca %struct.macroblock*, align 8
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
