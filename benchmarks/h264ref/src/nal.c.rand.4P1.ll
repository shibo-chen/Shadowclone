...
entry:
  ...
  %canary = alloca i32
  store i32 246017724, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1439180176, i32* %canary
  %streamBuffer.addr = alloca i8*, align 8
  %end_bytepos.addr = alloca i32, align 4
  %count = alloca i32, align 4
  %j = alloca i32, align 4
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1747653858, i32* %canary
  %count = alloca i32, align 4
  %i = alloca i32, align 4
  %streamBuffer.addr = alloca i8*, align 8
  %end_bytepos.addr = alloca i32, align 4
...
entry:
  ...
  %min_num_bytes.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1568870628, i32* %canary
  %streamBuffer.addr = alloca i8*, align 8
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  store i8* %streamBuffer, i8** %streamBuffer.addr, align 8
