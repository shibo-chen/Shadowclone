...
# %bb.0:                                # %entry
	...
	.cfi_offset %rbx, -24
	movl	16(%rbp), %eax
	movl	$119433195, -36(%rbp)   # imm = 0x71E67EB
	movq	%rdi, -48(%rbp)
	movq	%rsi, -16(%rbp)
	movl	%edx, -24(%rbp)
	movl	%ecx, -40(%rbp)
	...
	movl	%eax, 4(%rcx)
	movl	-20(%rbp), %ebx
	cmpl	$119433195, -36(%rbp)   # imm = 0x71E67EB
	jne	.LBB1_2
.LBB1_1:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_offset %rbx, -24
	movl	16(%rbp), %eax
	movl	$673744390, -40(%rbp)   # imm = 0x28288606
	movq	%rdi, -48(%rbp)
	movq	%rsi, -16(%rbp)
	movl	%edx, -20(%rbp)
	movl	%ecx, -36(%rbp)
	...
	movl	%eax, 4(%rcx)
	movl	-24(%rbp), %ebx
	cmpl	$673744390, -40(%rbp)   # imm = 0x28288606
	jne	.LBB2_2
.LBB2_1:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_offset %rbx, -24
	movl	16(%rbp), %eax
	movl	$1242304296, -28(%rbp)  # imm = 0x4A0C0F28
	movq	%rdi, -48(%rbp)
	movq	%rsi, -16(%rbp)
	movl	%edx, -24(%rbp)
	movl	%ecx, -32(%rbp)
	...
	movl	%eax, 4(%rcx)
	movl	-20(%rbp), %ebx
	cmpl	$1242304296, -28(%rbp)  # imm = 0x4A0C0F28
	jne	.LBB3_2
.LBB3_1:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_offset %rbx, -24
	movl	16(%rbp), %eax
	movl	$1547888599, -36(%rbp)  # imm = 0x5C42E7D7
	movq	%rdi, -48(%rbp)
	movq	%rsi, -16(%rbp)
	movl	%edx, -20(%rbp)
	movl	%ecx, -32(%rbp)
	...
	movl	%eax, 4(%rcx)
	movl	-24(%rbp), %ebx
	cmpl	$1547888599, -36(%rbp)  # imm = 0x5C42E7D7
	jne	.LBB4_2
.LBB4_1:
	movl	%ebx, %eax
	addq	$40, %rsp
