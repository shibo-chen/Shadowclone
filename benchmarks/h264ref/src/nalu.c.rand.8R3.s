...
# %bb.0:                                # %entry
	...
	.cfi_offset %rbx, -24
	movl	16(%rbp), %eax
	movl	$409390808, -36(%rbp)   # imm = 0x1866CED8
	movq	%rdi, -48(%rbp)
	movq	%rsi, -16(%rbp)
	movl	%edx, -24(%rbp)
	movl	%ecx, -40(%rbp)
	...
	movl	%eax, 4(%rcx)
	movl	-20(%rbp), %ebx
	cmpl	$409390808, -36(%rbp)   # imm = 0x1866CED8
	jne	.LBB1_2
.LBB1_1:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_offset %rbx, -24
	movl	16(%rbp), %eax
	movl	$1617585093, -40(%rbp)  # imm = 0x606A63C5
	movq	%rdi, -48(%rbp)
	movq	%rsi, -16(%rbp)
	movl	%edx, -24(%rbp)
	movl	%ecx, -32(%rbp)
	...
	movl	%eax, 4(%rcx)
	movl	-20(%rbp), %ebx
	cmpl	$1617585093, -40(%rbp)  # imm = 0x606A63C5
	jne	.LBB2_2
.LBB2_1:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_offset %rbx, -24
	movl	16(%rbp), %eax
	movl	$1055153802, -28(%rbp)  # imm = 0x3EE45E8A
	movq	%rdi, -48(%rbp)
	movq	%rsi, -16(%rbp)
	movl	%edx, -20(%rbp)
	movl	%ecx, -32(%rbp)
	...
	movl	%eax, 4(%rcx)
	movl	-24(%rbp), %ebx
	cmpl	$1055153802, -28(%rbp)  # imm = 0x3EE45E8A
	jne	.LBB3_2
.LBB3_1:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_offset %rbx, -24
	movl	16(%rbp), %eax
	movl	$1970960693, -32(%rbp)  # imm = 0x757A7935
	movq	%rdi, -48(%rbp)
	movq	%rsi, -16(%rbp)
	movl	%edx, -24(%rbp)
	movl	%ecx, -40(%rbp)
	...
	movl	%eax, 4(%rcx)
	movl	-20(%rbp), %ebx
	cmpl	$1970960693, -32(%rbp)  # imm = 0x757A7935
	jne	.LBB4_2
.LBB4_1:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_offset %rbx, -24
	movl	16(%rbp), %eax
	movl	$38761630, -40(%rbp)    # imm = 0x24F749E
	movq	%rdi, -48(%rbp)
	movq	%rsi, -16(%rbp)
	movl	%edx, -24(%rbp)
	movl	%ecx, -32(%rbp)
	...
	movl	%eax, 4(%rcx)
	movl	-20(%rbp), %ebx
	cmpl	$38761630, -40(%rbp)    # imm = 0x24F749E
	jne	.LBB5_2
.LBB5_1:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_offset %rbx, -24
	movl	16(%rbp), %eax
	movl	$267926993, -28(%rbp)   # imm = 0xFF83DD1
	movq	%rdi, -48(%rbp)
	movq	%rsi, -16(%rbp)
	movl	%edx, -20(%rbp)
	movl	%ecx, -36(%rbp)
	...
	movl	%eax, 4(%rcx)
	movl	-24(%rbp), %ebx
	cmpl	$267926993, -28(%rbp)   # imm = 0xFF83DD1
	jne	.LBB6_2
.LBB6_1:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_offset %rbx, -24
	movl	16(%rbp), %eax
	movl	$685524374, -40(%rbp)   # imm = 0x28DC4596
	movq	%rdi, -48(%rbp)
	movq	%rsi, -16(%rbp)
	movl	%edx, -24(%rbp)
	movl	%ecx, -32(%rbp)
	...
	movl	%eax, 4(%rcx)
	movl	-20(%rbp), %ebx
	cmpl	$685524374, -40(%rbp)   # imm = 0x28DC4596
	jne	.LBB7_2
.LBB7_1:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_offset %rbx, -24
	movl	16(%rbp), %eax
	movl	$585979606, -40(%rbp)   # imm = 0x22ED56D6
	movq	%rdi, -48(%rbp)
	movq	%rsi, -16(%rbp)
	movl	%edx, -24(%rbp)
	movl	%ecx, -32(%rbp)
	...
	movl	%eax, 4(%rcx)
	movl	-20(%rbp), %ebx
	cmpl	$585979606, -40(%rbp)   # imm = 0x22ED56D6
	jne	.LBB8_2
.LBB8_1:
	movl	%ebx, %eax
	addq	$40, %rsp
