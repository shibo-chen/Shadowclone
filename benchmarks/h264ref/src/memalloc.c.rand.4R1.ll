; ModuleID = 'memalloc.c.rand.4R1.bc'
...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_init_top_bot_planes.50, label %ctrl0

func_init_top_bot_planes.50:                      ; preds = %rand_bb
  %2 = call i32 @init_top_bot_planes.50(i16** %imgFrame, i32 %rows, i32 %columns, i16*** %imgTopField, i16*** %imgBotField)
  ret i32 %2

func_init_top_bot_planes.62:                      ; preds = %ctrl0
  %3 = call i32 @init_top_bot_planes.62(i16** %imgFrame, i32 %rows, i32 %columns, i16*** %imgTopField, i16*** %imgBotField)
  ret i32 %3
...
func_init_top_bot_planes.74:                      ; preds = %ctrl1
  %5 = call i32 @init_top_bot_planes.74(i16** %imgFrame, i32 %rows, i32 %columns, i16*** %imgTopField, i16*** %imgBotField)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_init_top_bot_planes.62, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_init_top_bot_planes.69, label %func_init_top_bot_planes.74
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_free_top_bot_planes.24, label %func_free_top_bot_planes.25

func_free_top_bot_planes.24:                      ; preds = %rand_bb
  call void @free_top_bot_planes.24(i16** %imgTopField, i16** %imgBotField)
  ret void

func_free_top_bot_planes.25:                      ; preds = %rand_bb
  call void @free_top_bot_planes.25(i16** %imgTopField, i16** %imgBotField)
  ret void
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_get_mem2Dpel.54, label %ctrl0

func_get_mem2Dpel.54:                             ; preds = %rand_bb
  %2 = call i32 @get_mem2Dpel.54(i16*** %array2D, i32 %rows, i32 %columns)
  ret i32 %2

func_get_mem2Dpel.73:                             ; preds = %ctrl0
  %3 = call i32 @get_mem2Dpel.73(i16*** %array2D, i32 %rows, i32 %columns)
  ret i32 %3

func_get_mem2Dpel.80:                             ; preds = %ctrl1
  %4 = call i32 @get_mem2Dpel.80(i16*** %array2D, i32 %rows, i32 %columns)
  ret i32 %4
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_get_mem2Dpel.73, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_get_mem2Dpel.80, label %func_get_mem2Dpel.82
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_get_mem3Dpel.51, label %ctrl0

func_get_mem3Dpel.51:                             ; preds = %rand_bb
  %2 = call i32 @get_mem3Dpel.51(i16**** %array3D, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %2

func_get_mem3Dpel.52:                             ; preds = %ctrl0
  %3 = call i32 @get_mem3Dpel.52(i16**** %array3D, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %3

func_get_mem3Dpel.63:                             ; preds = %ctrl1
  %4 = call i32 @get_mem3Dpel.63(i16**** %array3D, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %4

func_get_mem3Dpel.70:                             ; preds = %ctrl1
  %5 = call i32 @get_mem3Dpel.70(i16**** %array3D, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_get_mem3Dpel.52, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_get_mem3Dpel.63, label %func_get_mem3Dpel.70
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_free_mem3Dpel.41, label %ctrl0

func_free_mem3Dpel.41:                            ; preds = %rand_bb
  call void @free_mem3Dpel.41(i16*** %array3D, i32 %frames)
  ret void

func_free_mem3Dpel.55:                            ; preds = %ctrl0
  call void @free_mem3Dpel.55(i16*** %array3D, i32 %frames)
  ret void

func_free_mem3Dpel.79:                            ; preds = %ctrl1
  call void @free_mem3Dpel.79(i16*** %array3D, i32 %frames)
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_free_mem3Dpel.55, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_free_mem3Dpel.79, label %func_free_mem3Dpel.81
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_get_mem2D.2, label %ctrl0

func_get_mem2D.2:                                 ; preds = %rand_bb
  %2 = call i32 @get_mem2D.2(i8*** %array2D, i32 %rows, i32 %columns)
  ret i32 %2

func_get_mem2D.48:                                ; preds = %ctrl0
  %3 = call i32 @get_mem2D.48(i8*** %array2D, i32 %rows, i32 %columns)
  ret i32 %3
...
func_get_mem2D.72:                                ; preds = %ctrl1
  %5 = call i32 @get_mem2D.72(i8*** %array2D, i32 %rows, i32 %columns)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_get_mem2D.48, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_get_mem2D.60, label %func_get_mem2D.72
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_get_mem2Dint.6, label %ctrl0

func_get_mem2Dint.6:                              ; preds = %rand_bb
  %2 = call i32 @get_mem2Dint.6(i32*** %array2D, i32 %rows, i32 %columns)
  ret i32 %2

func_get_mem2Dint.16:                             ; preds = %ctrl0
  %3 = call i32 @get_mem2Dint.16(i32*** %array2D, i32 %rows, i32 %columns)
  ret i32 %3

func_get_mem2Dint.35:                             ; preds = %ctrl1
  %4 = call i32 @get_mem2Dint.35(i32*** %array2D, i32 %rows, i32 %columns)
  ret i32 %4

func_get_mem2Dint.49:                             ; preds = %ctrl1
  %5 = call i32 @get_mem2Dint.49(i32*** %array2D, i32 %rows, i32 %columns)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_get_mem2Dint.16, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_get_mem2Dint.35, label %func_get_mem2Dint.49
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_get_mem2Dint64.37, label %ctrl0

func_get_mem2Dint64.37:                           ; preds = %rand_bb
  %2 = call i32 @get_mem2Dint64.37(i64*** %array2D, i32 %rows, i32 %columns)
  ret i32 %2

func_get_mem2Dint64.58:                           ; preds = %ctrl0
  %3 = call i32 @get_mem2Dint64.58(i64*** %array2D, i32 %rows, i32 %columns)
  ret i32 %3

func_get_mem2Dint64.61:                           ; preds = %ctrl1
  %4 = call i32 @get_mem2Dint64.61(i64*** %array2D, i32 %rows, i32 %columns)
  ret i32 %4

func_get_mem2Dint64.76:                           ; preds = %ctrl1
  %5 = call i32 @get_mem2Dint64.76(i64*** %array2D, i32 %rows, i32 %columns)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_get_mem2Dint64.58, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_get_mem2Dint64.61, label %func_get_mem2Dint64.76
}
...
func_get_mem3D.29:                                ; preds = %ctrl0
  %3 = call i32 @get_mem3D.29(i8**** %array3D, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %3

func_get_mem3D.45:                                ; preds = %ctrl1
  %4 = call i32 @get_mem3D.45(i8**** %array3D, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %4

func_get_mem3D.47:                                ; preds = %ctrl1
  %5 = call i32 @get_mem3D.47(i8**** %array3D, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_get_mem3D.29, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_get_mem3D.45, label %func_get_mem3D.47
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_get_mem3Dint.12, label %ctrl0

func_get_mem3Dint.12:                             ; preds = %rand_bb
  %2 = call i32 @get_mem3Dint.12(i32**** %array3D, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %2

func_get_mem3Dint.33:                             ; preds = %ctrl0
  %3 = call i32 @get_mem3Dint.33(i32**** %array3D, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %3
...
func_get_mem3Dint.65:                             ; preds = %ctrl1
  %5 = call i32 @get_mem3Dint.65(i32**** %array3D, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_get_mem3Dint.33, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_get_mem3Dint.56, label %func_get_mem3Dint.65
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_get_mem3Dint64.3, label %ctrl0

func_get_mem3Dint64.3:                            ; preds = %rand_bb
  %2 = call i32 @get_mem3Dint64.3(i64**** %array3D, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %2

func_get_mem3Dint64.10:                           ; preds = %ctrl0
  %3 = call i32 @get_mem3Dint64.10(i64**** %array3D, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %3

func_get_mem3Dint64.17:                           ; preds = %ctrl1
  %4 = call i32 @get_mem3Dint64.17(i64**** %array3D, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %4

func_get_mem3Dint64.34:                           ; preds = %ctrl1
  %5 = call i32 @get_mem3Dint64.34(i64**** %array3D, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_get_mem3Dint64.10, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_get_mem3Dint64.17, label %func_get_mem3Dint64.34
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_get_mem4Dint.4, label %ctrl0

func_get_mem4Dint.4:                              ; preds = %rand_bb
  %2 = call i32 @get_mem4Dint.4(i32***** %array4D, i32 %idx, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %2

func_get_mem4Dint.15:                             ; preds = %ctrl0
  %3 = call i32 @get_mem4Dint.15(i32***** %array4D, i32 %idx, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %3

func_get_mem4Dint.30:                             ; preds = %ctrl1
  %4 = call i32 @get_mem4Dint.30(i32***** %array4D, i32 %idx, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %4
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_get_mem4Dint.15, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_get_mem4Dint.30, label %func_get_mem4Dint.64
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_free_mem3D.5, label %ctrl0

func_free_mem3D.5:                                ; preds = %rand_bb
  call void @free_mem3D.5(i8*** %array3D, i32 %frames)
  ret void

func_free_mem3D.19:                               ; preds = %ctrl0
  call void @free_mem3D.19(i8*** %array3D, i32 %frames)
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_free_mem3D.19, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_free_mem3D.67, label %func_free_mem3D.68
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_free_mem3Dint.1, label %ctrl0

func_free_mem3Dint.1:                             ; preds = %rand_bb
  call void @free_mem3Dint.1(i32*** %array3D, i32 %frames)
  ret void

func_free_mem3Dint.8:                             ; preds = %ctrl0
  call void @free_mem3Dint.8(i32*** %array3D, i32 %frames)
  ret void

func_free_mem3Dint.39:                            ; preds = %ctrl1
  call void @free_mem3Dint.39(i32*** %array3D, i32 %frames)
  ret void

func_free_mem3Dint.43:                            ; preds = %ctrl1
  call void @free_mem3Dint.43(i32*** %array3D, i32 %frames)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_free_mem3Dint.8, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_free_mem3Dint.39, label %func_free_mem3Dint.43
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_free_mem3Dint64.26, label %ctrl0

func_free_mem3Dint64.26:                          ; preds = %rand_bb
  call void @free_mem3Dint64.26(i64*** %array3D, i32 %frames)
  ret void

func_free_mem3Dint64.32:                          ; preds = %ctrl0
...
func_free_mem3Dint64.77:                          ; preds = %ctrl1
  call void @free_mem3Dint64.77(i64*** %array3D, i32 %frames)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_free_mem3Dint64.32, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_free_mem3Dint64.75, label %func_free_mem3Dint64.77
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_free_mem4Dint.20, label %ctrl0

func_free_mem4Dint.20:                            ; preds = %rand_bb
  call void @free_mem4Dint.20(i32**** %array4D, i32 %idx, i32 %frames)
  ret void

func_free_mem4Dint.40:                            ; preds = %ctrl0
  call void @free_mem4Dint.40(i32**** %array4D, i32 %idx, i32 %frames)
  ret void

func_free_mem4Dint.71:                            ; preds = %ctrl1
  call void @free_mem4Dint.71(i32**** %array4D, i32 %idx, i32 %frames)
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_free_mem4Dint.40, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_free_mem4Dint.71, label %func_free_mem4Dint.78
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_get_mem2Dshort.14, label %ctrl0

func_get_mem2Dshort.14:                           ; preds = %rand_bb
  %2 = call i32 @get_mem2Dshort.14(i16*** %array2D, i32 %rows, i32 %columns)
  ret i32 %2

func_get_mem2Dshort.27:                           ; preds = %ctrl0
  %3 = call i32 @get_mem2Dshort.27(i16*** %array2D, i32 %rows, i32 %columns)
  ret i32 %3

func_get_mem2Dshort.28:                           ; preds = %ctrl1
  %4 = call i32 @get_mem2Dshort.28(i16*** %array2D, i32 %rows, i32 %columns)
  ret i32 %4

func_get_mem2Dshort.36:                           ; preds = %ctrl1
  %5 = call i32 @get_mem2Dshort.36(i16*** %array2D, i32 %rows, i32 %columns)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_get_mem2Dshort.27, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_get_mem2Dshort.28, label %func_get_mem2Dshort.36
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_get_mem3Dshort.18, label %ctrl0

func_get_mem3Dshort.18:                           ; preds = %rand_bb
  %2 = call i32 @get_mem3Dshort.18(i16**** %array3D, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %2
...
func_get_mem3Dshort.46:                           ; preds = %ctrl1
  %4 = call i32 @get_mem3Dshort.46(i16**** %array3D, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %4

func_get_mem3Dshort.66:                           ; preds = %ctrl1
  %5 = call i32 @get_mem3Dshort.66(i16**** %array3D, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %5
...
ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_get_mem3Dshort.46, label %func_get_mem3Dshort.66
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_get_mem4Dshort.7, label %ctrl0

func_get_mem4Dshort.7:                            ; preds = %rand_bb
  %2 = call i32 @get_mem4Dshort.7(i16***** %array4D, i32 %idx, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %2

func_get_mem4Dshort.53:                           ; preds = %ctrl0
  %3 = call i32 @get_mem4Dshort.53(i16***** %array4D, i32 %idx, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %3

func_get_mem4Dshort.57:                           ; preds = %ctrl1
  %4 = call i32 @get_mem4Dshort.57(i16***** %array4D, i32 %idx, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %4

func_get_mem4Dshort.59:                           ; preds = %ctrl1
  %5 = call i32 @get_mem4Dshort.59(i16***** %array4D, i32 %idx, i32 %frames, i32 %rows, i32 %columns)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_get_mem4Dshort.53, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_get_mem4Dshort.57, label %func_get_mem4Dshort.59
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_free_mem3Dshort.13, label %ctrl0

func_free_mem3Dshort.13:                          ; preds = %rand_bb
  call void @free_mem3Dshort.13(i16*** %array3D, i32 %frames)
  ret void

func_free_mem3Dshort.21:                          ; preds = %ctrl0
  call void @free_mem3Dshort.21(i16*** %array3D, i32 %frames)
  ret void

func_free_mem3Dshort.38:                          ; preds = %ctrl1
  call void @free_mem3Dshort.38(i16*** %array3D, i32 %frames)
  ret void

func_free_mem3Dshort.44:                          ; preds = %ctrl1
  call void @free_mem3Dshort.44(i16*** %array3D, i32 %frames)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_free_mem3Dshort.21, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_free_mem3Dshort.38, label %func_free_mem3Dshort.44
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_free_mem4Dshort.9, label %ctrl0

func_free_mem4Dshort.9:                           ; preds = %rand_bb
  call void @free_mem4Dshort.9(i16**** %array4D, i32 %idx, i32 %frames)
  ret void

func_free_mem4Dshort.22:                          ; preds = %ctrl0
  call void @free_mem4Dshort.22(i16**** %array4D, i32 %idx, i32 %frames)
  ret void

func_free_mem4Dshort.31:                          ; preds = %ctrl1
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_free_mem4Dshort.22, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_free_mem4Dshort.31, label %func_free_mem4Dshort.42
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_mem3Dint.1(i32*** %array3D, i32 %frames) #0 {
entry:
  %frames.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 951476311, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem2D.2(i8*** %array2D, i32 %rows, i32 %columns) #0 {
entry:
  %columns.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1925719757, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem3Dint64.3(i64**** %array3D, i32 %frames, i32 %rows, i32 %columns) #0 {
entry:
  %columns.addr = alloca i32, align 4
  %frames.addr = alloca i32, align 4
  ...
  %canary = alloca i32
  store i32 279298406, i32* %canary
  %rows.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem4Dint.4(i32***** %array4D, i32 %idx, i32 %frames, i32 %rows, i32 %columns) #0 {
entry:
  %frames.addr = alloca i32, align 4
  %rows.addr = alloca i32, align 4
  %j = alloca i32, align 4
  ...
  %canary = alloca i32
  store i32 1005517079, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_mem3D.5(i8*** %array3D, i32 %frames) #0 {
entry:
  %canary = alloca i32
  store i32 1080112740, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem2Dint.6(i32*** %array2D, i32 %rows, i32 %columns) #0 {
entry:
  %columns.addr = alloca i32, align 4
  %array2D.addr = alloca i32***, align 8
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 167460460, i32* %canary
  %rows.addr = alloca i32, align 4
  store i32*** %array2D, i32**** %array2D.addr, align 8
  store i32 %rows, i32* %rows.addr, align 4
  store i32 %columns, i32* %columns.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem4Dshort.7(i16***** %array4D, i32 %idx, i32 %frames, i32 %rows, i32 %columns) #0 {
entry:
  %j = alloca i32, align 4
  %array4D.addr = alloca i16*****, align 8
  %canary = alloca i32
  store i32 1418574073, i32* %canary
  %columns.addr = alloca i32, align 4
  %rows.addr = alloca i32, align 4
  %idx.addr = alloca i32, align 4
  %frames.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_mem3Dint.8(i32*** %array3D, i32 %frames) #0 {
entry:
  %i = alloca i32, align 4
  %frames.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2138801160, i32* %canary
  %array3D.addr = alloca i32***, align 8
  store i32*** %array3D, i32**** %array3D.addr, align 8
  store i32 %frames, i32* %frames.addr, align 4
  %0 = load i32***, i32**** %array3D.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_mem4Dshort.9(i16**** %array4D, i32 %idx, i32 %frames) #0 {
entry:
  %idx.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1966832552, i32* %canary
  %j = alloca i32, align 4
  %array4D.addr = alloca i16****, align 8
  %frames.addr = alloca i32, align 4
  store i16**** %array4D, i16***** %array4D.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem3Dint64.10(i64**** %array3D, i32 %frames, i32 %rows, i32 %columns) #0 {
entry:
  %canary = alloca i32
  store i32 1119675974, i32* %canary
  %frames.addr = alloca i32, align 4
  %j = alloca i32, align 4
  %columns.addr = alloca i32, align 4
  %rows.addr = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1712287904, i32* %canary
  %frames.addr = alloca i32, align 4
  %rows.addr = alloca i32, align 4
  %array3D.addr = alloca i8****, align 8
  %j = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem3Dint.12(i32**** %array3D, i32 %frames, i32 %rows, i32 %columns) #0 {
entry:
  %canary = alloca i32
  store i32 308582096, i32* %canary
  %frames.addr = alloca i32, align 4
  %j = alloca i32, align 4
  %array3D.addr = alloca i32****, align 8
  %columns.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_mem3Dshort.13(i16*** %array3D, i32 %frames) #0 {
entry:
  %i = alloca i32, align 4
  %array3D.addr = alloca i16***, align 8
  %canary = alloca i32
  store i32 1758912115, i32* %canary
  %frames.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem2Dshort.14(i16*** %array2D, i32 %rows, i32 %columns) #0 {
entry:
  %rows.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 2000242129, i32* %canary
  %columns.addr = alloca i32, align 4
  %array2D.addr = alloca i16***, align 8
  store i16*** %array2D, i16**** %array2D.addr, align 8
  store i32 %rows, i32* %rows.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem4Dint.15(i32***** %array4D, i32 %idx, i32 %frames, i32 %rows, i32 %columns) #0 {
entry:
  %j = alloca i32, align 4
  %idx.addr = alloca i32, align 4
  %array4D.addr = alloca i32*****, align 8
  ...
  %frames.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 487155699, i32* %canary
  %rows.addr = alloca i32, align 4
  store i32***** %array4D, i32****** %array4D.addr, align 8
  store i32 %idx, i32* %idx.addr, align 4
  store i32 %frames, i32* %frames.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem2Dint.16(i32*** %array2D, i32 %rows, i32 %columns) #0 {
entry:
  %array2D.addr = alloca i32***, align 8
  %rows.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 873551614, i32* %canary
  %i = alloca i32, align 4
  %columns.addr = alloca i32, align 4
  store i32*** %array2D, i32**** %array2D.addr, align 8
  store i32 %rows, i32* %rows.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem3Dint64.17(i64**** %array3D, i32 %frames, i32 %rows, i32 %columns) #0 {
entry:
  %frames.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1091385504, i32* %canary
  %rows.addr = alloca i32, align 4
  %columns.addr = alloca i32, align 4
  %j = alloca i32, align 4
  %array3D.addr = alloca i64****, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem3Dshort.18(i16**** %array3D, i32 %frames, i32 %rows, i32 %columns) #0 {
entry:
  %frames.addr = alloca i32, align 4
  %array3D.addr = alloca i16****, align 8
  %canary = alloca i32
  store i32 1927926082, i32* %canary
  %rows.addr = alloca i32, align 4
  %j = alloca i32, align 4
  %columns.addr = alloca i32, align 4
  store i16**** %array3D, i16***** %array3D.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_mem3D.19(i8*** %array3D, i32 %frames) #0 {
entry:
  %canary = alloca i32
  store i32 496932384, i32* %canary
  %i = alloca i32, align 4
  %array3D.addr = alloca i8***, align 8
  %frames.addr = alloca i32, align 4
  store i8*** %array3D, i8**** %array3D.addr, align 8
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 386960421, i32* %canary
  %idx.addr = alloca i32, align 4
  store i32**** %array4D, i32***** %array4D.addr, align 8
  store i32 %idx, i32* %idx.addr, align 4
  store i32 %frames, i32* %frames.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_mem3Dshort.21(i16*** %array3D, i32 %frames) #0 {
entry:
  %canary = alloca i32
  store i32 625268113, i32* %canary
  %array3D.addr = alloca i16***, align 8
  %frames.addr = alloca i32, align 4
  %i = alloca i32, align 4
  store i16*** %array3D, i16**** %array3D.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_mem4Dshort.22(i16**** %array4D, i32 %idx, i32 %frames) #0 {
entry:
  %frames.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1981968176, i32* %canary
  %array4D.addr = alloca i16****, align 8
  %j = alloca i32, align 4
  %idx.addr = alloca i32, align 4
  store i16**** %array4D, i16***** %array4D.addr, align 8
...
entry:
  %columns.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 520370960, i32* %canary
  %rows.addr = alloca i32, align 4
  %array3D.addr = alloca i16****, align 8
  %frames.addr = alloca i32, align 4
  %j = alloca i32, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 721157596, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_top_bot_planes.25(i16** %imgTopField, i16** %imgBotField) #0 {
entry:
  %imgTopField.addr = alloca i16**, align 8
  %canary = alloca i32
  store i32 1695375973, i32* %canary
  %imgBotField.addr = alloca i16**, align 8
  store i16** %imgTopField, i16*** %imgTopField.addr, align 8
  store i16** %imgBotField, i16*** %imgBotField.addr, align 8
  %0 = load i16**, i16*** %imgTopField.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_mem3Dint64.26(i64*** %array3D, i32 %frames) #0 {
entry:
  %canary = alloca i32
  store i32 1268000555, i32* %canary
  %i = alloca i32, align 4
  %frames.addr = alloca i32, align 4
  %array3D.addr = alloca i64***, align 8
  store i64*** %array3D, i64**** %array3D.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem2Dshort.27(i16*** %array2D, i32 %rows, i32 %columns) #0 {
entry:
  %i = alloca i32, align 4
  %rows.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 964709582, i32* %canary
  %array2D.addr = alloca i16***, align 8
  %columns.addr = alloca i32, align 4
  store i16*** %array2D, i16**** %array2D.addr, align 8
  store i32 %rows, i32* %rows.addr, align 4
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1716590795, i32* %canary
  %columns.addr = alloca i32, align 4
  %rows.addr = alloca i32, align 4
  store i16*** %array2D, i16**** %array2D.addr, align 8
  store i32 %rows, i32* %rows.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem4Dint.30(i32***** %array4D, i32 %idx, i32 %frames, i32 %rows, i32 %columns) #0 {
entry:
  %canary = alloca i32
  store i32 339714291, i32* %canary
  %j = alloca i32, align 4
  %idx.addr = alloca i32, align 4
  %rows.addr = alloca i32, align 4
  %frames.addr = alloca i32, align 4
...
entry:
  ...
  %idx.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1439358181, i32* %canary
  %array4D.addr = alloca i16****, align 8
  store i16**** %array4D, i16***** %array4D.addr, align 8
  store i32 %idx, i32* %idx.addr, align 4
  store i32 %frames, i32* %frames.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 1018443438, i32* %canary
  %frames.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %array3D.addr = alloca i64***, align 8
  store i64*** %array3D, i64**** %array3D.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem3Dint.33(i32**** %array3D, i32 %frames, i32 %rows, i32 %columns) #0 {
entry:
  %canary = alloca i32
  store i32 1739911118, i32* %canary
  %columns.addr = alloca i32, align 4
  %frames.addr = alloca i32, align 4
  %array3D.addr = alloca i32****, align 8
  %rows.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem3Dint64.34(i64**** %array3D, i32 %frames, i32 %rows, i32 %columns) #0 {
entry:
  %columns.addr = alloca i32, align 4
  %array3D.addr = alloca i64****, align 8
  %frames.addr = alloca i32, align 4
  %rows.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 461266855, i32* %canary
  %j = alloca i32, align 4
  store i64**** %array3D, i64***** %array3D.addr, align 8
  store i32 %frames, i32* %frames.addr, align 4
  store i32 %rows, i32* %rows.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem2Dint.35(i32*** %array2D, i32 %rows, i32 %columns) #0 {
entry:
  %canary = alloca i32
  store i32 671088938, i32* %canary
  %array2D.addr = alloca i32***, align 8
  %columns.addr = alloca i32, align 4
  %rows.addr = alloca i32, align 4
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem2Dshort.36(i16*** %array2D, i32 %rows, i32 %columns) #0 {
entry:
  %canary = alloca i32
  store i32 1725188935, i32* %canary
  %columns.addr = alloca i32, align 4
  %rows.addr = alloca i32, align 4
  %array2D.addr = alloca i16***, align 8
  %i = alloca i32, align 4
...
entry:
  ...
  %columns.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 737977954, i32* %canary
  %rows.addr = alloca i32, align 4
  store i64*** %array2D, i64**** %array2D.addr, align 8
  store i32 %rows, i32* %rows.addr, align 4
  store i32 %columns, i32* %columns.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_mem3Dshort.38(i16*** %array3D, i32 %frames) #0 {
entry:
  %frames.addr = alloca i32, align 4
  %array3D.addr = alloca i16***, align 8
  %canary = alloca i32
  store i32 973797446, i32* %canary
  %i = alloca i32, align 4
  store i16*** %array3D, i16**** %array3D.addr, align 8
  store i32 %frames, i32* %frames.addr, align 4
  %0 = load i16***, i16**** %array3D.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_mem3Dint.39(i32*** %array3D, i32 %frames) #0 {
entry:
  %array3D.addr = alloca i32***, align 8
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 18367651, i32* %canary
  %frames.addr = alloca i32, align 4
  store i32*** %array3D, i32**** %array3D.addr, align 8
  store i32 %frames, i32* %frames.addr, align 4
  %0 = load i32***, i32**** %array3D.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_mem4Dint.40(i32**** %array4D, i32 %idx, i32 %frames) #0 {
entry:
  %j = alloca i32, align 4
  %idx.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1430726206, i32* %canary
  %array4D.addr = alloca i32****, align 8
  %frames.addr = alloca i32, align 4
  store i32**** %array4D, i32***** %array4D.addr, align 8
  store i32 %idx, i32* %idx.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_mem3Dpel.41(i16*** %array3D, i32 %frames) #0 {
entry:
  %array3D.addr = alloca i16***, align 8
  %frames.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1989707567, i32* %canary
  %i = alloca i32, align 4
  store i16*** %array3D, i16**** %array3D.addr, align 8
  store i32 %frames, i32* %frames.addr, align 4
  %0 = load i16***, i16**** %array3D.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1472747528, i32* %canary
  %frames.addr = alloca i32, align 4
  %idx.addr = alloca i32, align 4
  %array4D.addr = alloca i16****, align 8
  %j = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_mem3Dint.43(i32*** %array3D, i32 %frames) #0 {
entry:
  %array3D.addr = alloca i32***, align 8
  %frames.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1732387716, i32* %canary
  %i = alloca i32, align 4
  store i32*** %array3D, i32**** %array3D.addr, align 8
  store i32 %frames, i32* %frames.addr, align 4
  %0 = load i32***, i32**** %array3D.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_mem3Dshort.44(i16*** %array3D, i32 %frames) #0 {
entry:
  %frames.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 697915509, i32* %canary
  %array3D.addr = alloca i16***, align 8
  store i16*** %array3D, i16**** %array3D.addr, align 8
  store i32 %frames, i32* %frames.addr, align 4
  %0 = load i16***, i16**** %array3D.addr, align 8
...
entry:
  %columns.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1003128121, i32* %canary
  %array3D.addr = alloca i8****, align 8
  %rows.addr = alloca i32, align 4
  %j = alloca i32, align 4
  %frames.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem3Dshort.46(i16**** %array3D, i32 %frames, i32 %rows, i32 %columns) #0 {
entry:
  %j = alloca i32, align 4
  %rows.addr = alloca i32, align 4
  %frames.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 71259097, i32* %canary
  %columns.addr = alloca i32, align 4
  %array3D.addr = alloca i16****, align 8
  store i16**** %array3D, i16***** %array3D.addr, align 8
  store i32 %frames, i32* %frames.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 368131992, i32* %canary
  %rows.addr = alloca i32, align 4
  %columns.addr = alloca i32, align 4
  %j = alloca i32, align 4
  %array3D.addr = alloca i8****, align 8
...
entry:
  ...
  %array2D.addr = alloca i8***, align 8
  %canary = alloca i32
  store i32 448625380, i32* %canary
  %i = alloca i32, align 4
  %columns.addr = alloca i32, align 4
  store i8*** %array2D, i8**** %array2D.addr, align 8
  store i32 %rows, i32* %rows.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem2Dint.49(i32*** %array2D, i32 %rows, i32 %columns) #0 {
entry:
  %i = alloca i32, align 4
  %columns.addr = alloca i32, align 4
  %rows.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 477116432, i32* %canary
  %array2D.addr = alloca i32***, align 8
  store i32*** %array2D, i32**** %array2D.addr, align 8
  store i32 %rows, i32* %rows.addr, align 4
  store i32 %columns, i32* %columns.addr, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 992647017, i32* %canary
  %imgBotField.addr = alloca i16***, align 8
...
entry:
  %canary = alloca i32
  store i32 573032302, i32* %canary
  %rows.addr = alloca i32, align 4
  %frames.addr = alloca i32, align 4
  %columns.addr = alloca i32, align 4
  %j = alloca i32, align 4
...
entry:
  %frames.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1578610606, i32* %canary
  %columns.addr = alloca i32, align 4
  %j = alloca i32, align 4
  %rows.addr = alloca i32, align 4
  %array3D.addr = alloca i16****, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem4Dshort.53(i16***** %array4D, i32 %idx, i32 %frames, i32 %rows, i32 %columns) #0 {
entry:
  %j = alloca i32, align 4
  %frames.addr = alloca i32, align 4
  %idx.addr = alloca i32, align 4
  %array4D.addr = alloca i16*****, align 8
  %canary = alloca i32
  store i32 437941368, i32* %canary
  %rows.addr = alloca i32, align 4
  %columns.addr = alloca i32, align 4
  store i16***** %array4D, i16****** %array4D.addr, align 8
  store i32 %idx, i32* %idx.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem2Dpel.54(i16*** %array2D, i32 %rows, i32 %columns) #0 {
entry:
  %rows.addr = alloca i32, align 4
  %array2D.addr = alloca i16***, align 8
  %canary = alloca i32
  store i32 928662819, i32* %canary
  %i = alloca i32, align 4
  %columns.addr = alloca i32, align 4
  store i16*** %array2D, i16**** %array2D.addr, align 8
  store i32 %rows, i32* %rows.addr, align 4
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 954387190, i32* %canary
  %array3D.addr = alloca i16***, align 8
  store i16*** %array3D, i16**** %array3D.addr, align 8
  store i32 %frames, i32* %frames.addr, align 4
  %0 = load i16***, i16**** %array3D.addr, align 8
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1504339710, i32* %canary
  %array3D.addr = alloca i32****, align 8
  store i32**** %array3D, i32***** %array3D.addr, align 8
  store i32 %frames, i32* %frames.addr, align 4
  store i32 %rows, i32* %rows.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem4Dshort.57(i16***** %array4D, i32 %idx, i32 %frames, i32 %rows, i32 %columns) #0 {
entry:
  %j = alloca i32, align 4
  %columns.addr = alloca i32, align 4
  %frames.addr = alloca i32, align 4
  %idx.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 141025895, i32* %canary
  %rows.addr = alloca i32, align 4
  %array4D.addr = alloca i16*****, align 8
  store i16***** %array4D, i16****** %array4D.addr, align 8
  store i32 %idx, i32* %idx.addr, align 4
...
entry:
  ...
  %columns.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1970377607, i32* %canary
  %i = alloca i32, align 4
  store i64*** %array2D, i64**** %array2D.addr, align 8
  store i32 %rows, i32* %rows.addr, align 4
  store i32 %columns, i32* %columns.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem4Dshort.59(i16***** %array4D, i32 %idx, i32 %frames, i32 %rows, i32 %columns) #0 {
entry:
  %idx.addr = alloca i32, align 4
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1130199416, i32* %canary
  %frames.addr = alloca i32, align 4
  %rows.addr = alloca i32, align 4
  %columns.addr = alloca i32, align 4
  %array4D.addr = alloca i16*****, align 8
...
entry:
  ...
  %array2D.addr = alloca i8***, align 8
  %canary = alloca i32
  store i32 1022278464, i32* %canary
  %rows.addr = alloca i32, align 4
  store i8*** %array2D, i8**** %array2D.addr, align 8
  store i32 %rows, i32* %rows.addr, align 4
  store i32 %columns, i32* %columns.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem2Dint64.61(i64*** %array2D, i32 %rows, i32 %columns) #0 {
entry:
  %array2D.addr = alloca i64***, align 8
  %canary = alloca i32
  store i32 1311015832, i32* %canary
  %columns.addr = alloca i32, align 4
  %rows.addr = alloca i32, align 4
  %i = alloca i32, align 4
  store i64*** %array2D, i64**** %array2D.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @init_top_bot_planes.62(i16** %imgFrame, i32 %rows, i32 %columns, i16*** %imgTopField, i16*** %imgBotField) #0 {
entry:
  %imgBotField.addr = alloca i16***, align 8
  %imgFrame.addr = alloca i16**, align 8
  %rows.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1098397156, i32* %canary
  %columns.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %imgTopField.addr = alloca i16***, align 8
  store i16** %imgFrame, i16*** %imgFrame.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem3Dpel.63(i16**** %array3D, i32 %frames, i32 %rows, i32 %columns) #0 {
entry:
  %canary = alloca i32
  store i32 1744089434, i32* %canary
  %rows.addr = alloca i32, align 4
  %columns.addr = alloca i32, align 4
  %frames.addr = alloca i32, align 4
  %j = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 397660502, i32* %canary
  %columns.addr = alloca i32, align 4
  %j = alloca i32, align 4
  %idx.addr = alloca i32, align 4
  %array4D.addr = alloca i32*****, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem3Dint.65(i32**** %array3D, i32 %frames, i32 %rows, i32 %columns) #0 {
entry:
  %array3D.addr = alloca i32****, align 8
  %rows.addr = alloca i32, align 4
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 176168562, i32* %canary
  %columns.addr = alloca i32, align 4
  %frames.addr = alloca i32, align 4
  store i32**** %array3D, i32***** %array3D.addr, align 8
  store i32 %frames, i32* %frames.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem3Dshort.66(i16**** %array3D, i32 %frames, i32 %rows, i32 %columns) #0 {
entry:
  %frames.addr = alloca i32, align 4
  %columns.addr = alloca i32, align 4
  %array3D.addr = alloca i16****, align 8
  %canary = alloca i32
  store i32 868723022, i32* %canary
  %rows.addr = alloca i32, align 4
  %j = alloca i32, align 4
  store i16**** %array3D, i16***** %array3D.addr, align 8
  store i32 %frames, i32* %frames.addr, align 4
...
entry:
  ...
  %frames.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1775671554, i32* %canary
  %array3D.addr = alloca i8***, align 8
  store i8*** %array3D, i8**** %array3D.addr, align 8
  store i32 %frames, i32* %frames.addr, align 4
  %0 = load i8***, i8**** %array3D.addr, align 8
...
entry:
  %frames.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2065465312, i32* %canary
  %i = alloca i32, align 4
  %array3D.addr = alloca i8***, align 8
  store i8*** %array3D, i8**** %array3D.addr, align 8
  store i32 %frames, i32* %frames.addr, align 4
...
entry:
  ...
  %imgFrame.addr = alloca i16**, align 8
  %canary = alloca i32
  store i32 1349052796, i32* %canary
  %columns.addr = alloca i32, align 4
  %rows.addr = alloca i32, align 4
  %imgBotField.addr = alloca i16***, align 8
  %imgTopField.addr = alloca i16***, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem3Dpel.70(i16**** %array3D, i32 %frames, i32 %rows, i32 %columns) #0 {
entry:
  %array3D.addr = alloca i16****, align 8
  %j = alloca i32, align 4
  %rows.addr = alloca i32, align 4
  %columns.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1631927090, i32* %canary
  %frames.addr = alloca i32, align 4
  store i16**** %array3D, i16***** %array3D.addr, align 8
  store i32 %frames, i32* %frames.addr, align 4
  store i32 %rows, i32* %rows.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_mem4Dint.71(i32**** %array4D, i32 %idx, i32 %frames) #0 {
entry:
  %canary = alloca i32
  store i32 1090741751, i32* %canary
  %idx.addr = alloca i32, align 4
  %j = alloca i32, align 4
  %frames.addr = alloca i32, align 4
  %array4D.addr = alloca i32****, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem2D.72(i8*** %array2D, i32 %rows, i32 %columns) #0 {
entry:
  %array2D.addr = alloca i8***, align 8
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 569708389, i32* %canary
  %columns.addr = alloca i32, align 4
  %rows.addr = alloca i32, align 4
  store i8*** %array2D, i8**** %array2D.addr, align 8
  store i32 %rows, i32* %rows.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem2Dpel.73(i16*** %array2D, i32 %rows, i32 %columns) #0 {
entry:
  %columns.addr = alloca i32, align 4
  %rows.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 959489373, i32* %canary
  %array2D.addr = alloca i16***, align 8
  store i16*** %array2D, i16**** %array2D.addr, align 8
  store i32 %rows, i32* %rows.addr, align 4
  store i32 %columns, i32* %columns.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @init_top_bot_planes.74(i16** %imgFrame, i32 %rows, i32 %columns, i16*** %imgTopField, i16*** %imgBotField) #0 {
entry:
  %i = alloca i32, align 4
  %imgTopField.addr = alloca i16***, align 8
  %imgFrame.addr = alloca i16**, align 8
  ...
  %rows.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 365045952, i32* %canary
  %imgBotField.addr = alloca i16***, align 8
  store i16** %imgFrame, i16*** %imgFrame.addr, align 8
  store i32 %rows, i32* %rows.addr, align 4
  store i32 %columns, i32* %columns.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 746930510, i32* %canary
  %i = alloca i32, align 4
  %array3D.addr = alloca i64***, align 8
  %frames.addr = alloca i32, align 4
  store i64*** %array3D, i64**** %array3D.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_mem2Dint64.76(i64*** %array2D, i32 %rows, i32 %columns) #0 {
entry:
  %rows.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1318441367, i32* %canary
  %columns.addr = alloca i32, align 4
  %array2D.addr = alloca i64***, align 8
  store i64*** %array2D, i64**** %array2D.addr, align 8
  store i32 %rows, i32* %rows.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_mem3Dint64.77(i64*** %array3D, i32 %frames) #0 {
entry:
  %frames.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 838169613, i32* %canary
  %array3D.addr = alloca i64***, align 8
  %i = alloca i32, align 4
  store i64*** %array3D, i64**** %array3D.addr, align 8
  store i32 %frames, i32* %frames.addr, align 4
...
entry:
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 556558708, i32* %canary
  %idx.addr = alloca i32, align 4
  %frames.addr = alloca i32, align 4
  %array4D.addr = alloca i32****, align 8
  store i32**** %array4D, i32***** %array4D.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_mem3Dpel.79(i16*** %array3D, i32 %frames) #0 {
entry:
  %frames.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 412582691, i32* %canary
  %array3D.addr = alloca i16***, align 8
  %i = alloca i32, align 4
  store i16*** %array3D, i16**** %array3D.addr, align 8
  store i32 %frames, i32* %frames.addr, align 4
...
entry:
  %rows.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 695226974, i32* %canary
  %array2D.addr = alloca i16***, align 8
  %columns.addr = alloca i32, align 4
  %i = alloca i32, align 4
  store i16*** %array2D, i16**** %array2D.addr, align 8
...
entry:
  %array3D.addr = alloca i16***, align 8
  %canary = alloca i32
  store i32 323221770, i32* %canary
  %i = alloca i32, align 4
  %frames.addr = alloca i32, align 4
  store i16*** %array3D, i16**** %array3D.addr, align 8
  store i32 %frames, i32* %frames.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 1090037714, i32* %canary
  %rows.addr = alloca i32, align 4
  %columns.addr = alloca i32, align 4
  %array2D.addr = alloca i16***, align 8
  %i = alloca i32, align 4
