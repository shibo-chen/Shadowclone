...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_testEndian.8, label %func_testEndian.16
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_img2buf.9, label %func_img2buf.12
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_write_picture.20, label %ctrl0

func_write_picture.20:                            ; preds = %rand_bb
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_write_picture.23, label %func_write_picture.24
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_write_out_picture.6, label %ctrl0

func_write_out_picture.6:                         ; preds = %rand_bb
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_write_out_picture.19, label %func_write_out_picture.21
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_clear_picture.7, label %func_clear_picture.18

func_clear_picture.7:                             ; preds = %rand_bb
  call void @clear_picture.7(%struct.storable_picture* %p)
  ret void
...
func_write_unpaired_field.5:                      ; preds = %ctrl0
  call void @write_unpaired_field.5(%struct.frame_store* %fs, i32 %p_out)
  ret void

func_write_unpaired_field.10:                     ; preds = %ctrl1
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_write_unpaired_field.5, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_write_unpaired_field.10, label %func_write_unpaired_field.11
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_direct_output.3, label %func_direct_output.13

func_direct_output.3:                             ; preds = %rand_bb
  call void @direct_output.3(%struct.storable_picture* %p, i32 %p_out)
  ret void

func_direct_output.13:                            ; preds = %rand_bb
  call void @direct_output.13(%struct.storable_picture* %p, i32 %p_out)
  ret void
}
...
entry:
  ...
  %canary = alloca i32
  store i32 2069678239, i32* %canary
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  ...
  %109 = icmp eq i32 %108, 2069678239
...
entry:
  ...
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 973507039, i32* %canary
...
entry:
  ...
  %crop_right.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1441658129, i32* %canary
  %symbol_size_in_bytes.addr = alloca i32, align 4
  %crop_left.addr = alloca i32, align 4
  %crop_top.addr = alloca i32, align 4
  %tmp32 = alloca i64, align 8
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1441658129
  br i1 %109, label %110, label %func_exit
...
entry:
  %fs.addr = alloca %struct.frame_store*, align 8
  %canary = alloca i32
  store i32 1255970576, i32* %canary
  %p = alloca %struct.storable_picture*, align 8
  %p_out.addr = alloca i32, align 4
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 1734067210, i32* %canary
...
return:                                           ; preds = %if.end139, %if.then
  ...
  %193 = icmp eq i32 %192, 1734067210
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @clear_picture.7(%struct.storable_picture* %p) #0 {
entry:
  %p.addr = alloca %struct.storable_picture*, align 8
  %canary = alloca i32
  store i32 744805925, i32* %canary
  %i = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
...
entry:
  %p = alloca i8*, align 8
  %canary = alloca i32
  store i32 1864180445, i32* %canary
...
entry:
  ...
  %size_y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1128349967, i32* %canary
  %crop_bottom.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %crop_top.addr = alloca i32, align 4
  %tmp32 = alloca i64, align 8
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1128349967
  br i1 %109, label %110, label %func_exit
...
entry:
  ...
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 682638066, i32* %canary
  %fs.addr = alloca %struct.frame_store*, align 8
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  %0 = load %struct.frame_store*, %struct.frame_store** %fs.addr, align 8
...
entry:
  %p = alloca %struct.storable_picture*, align 8
  %canary = alloca i32
  store i32 289892068, i32* %canary
  %fs.addr = alloca %struct.frame_store*, align 8
  %p_out.addr = alloca i32, align 4
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  ...
  %size = alloca i32, align 4
  %canary = alloca i32
  store i32 1435252213, i32* %canary
  %twidth = alloca i32, align 4
  %j = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %size_y.addr = alloca i32, align 4
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1435252213
  br i1 %109, label %110, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @direct_output.13(%struct.storable_picture* %p, i32 %p_out) #0 {
entry:
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1641638299, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  %0 = load %struct.storable_picture*, %struct.storable_picture** %p.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 2044744227, i32* %canary
  %p_out.addr = alloca i32, align 4
  %fs.addr = alloca %struct.frame_store*, align 8
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  %fs.addr = alloca %struct.frame_store*, align 8
  %canary = alloca i32
  store i32 770663862, i32* %canary
  %p_out.addr = alloca i32, align 4
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  %0 = load i32, i32* %p_out.addr, align 4
...
entry:
  %s = alloca i16, align 2
  %canary = alloca i32
  store i32 445042538, i32* %canary
  %p = alloca i8*, align 8
  %0 = bitcast i16* %s to i8*
  store i8* %0, i8** %p, align 8
  store i16 1, i16* %s, align 2
...
entry:
  ...
  %crop_left = alloca i32, align 4
  %canary = alloca i32
  store i32 1992173717, i32* %canary
  %symbol_size_in_bytes = alloca i32, align 4
  %buf = alloca i8*, align 8
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1992173717
  br i1 %193, label %194, label %func_exit
...
entry:
  %canary = alloca i32
  store i32 126435542, i32* %canary
  %i = alloca i32, align 4
  %p.addr = alloca %struct.storable_picture*, align 8
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 0, i32* %i, align 4
...
entry:
  ...
  %buf = alloca i8*, align 8
  %canary = alloca i32
  store i32 1242057552, i32* %canary
  %SubHeightC = alloca [4 x i32], align 16
  %rgb_output = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1242057552
  br i1 %193, label %194, label %func_exit
...
entry:
  ...
  %canary = alloca i32
  store i32 516793636, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  %p_out.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  %SubWidthC = alloca [4 x i32], align 16
  %canary = alloca i32
  store i32 1859877835, i32* %canary
  %symbol_size_in_bytes = alloca i32, align 4
  %buf = alloca i8*, align 8
  %rgb_output = alloca i32, align 4
  %p.addr = alloca %struct.storable_picture*, align 8
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1859877835
  br i1 %193, label %194, label %func_exit
...
entry:
  %canary = alloca i32
  store i32 1249218428, i32* %canary
  %p_out.addr = alloca i32, align 4
  %p.addr = alloca %struct.storable_picture*, align 8
  %real_structure.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
...
entry:
  %p.addr = alloca %struct.storable_picture*, align 8
  %canary = alloca i32
  store i32 646374580, i32* %canary
  %p_out.addr = alloca i32, align 4
  %real_structure.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  ...
  %real_structure.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1744026746, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  store i32 %real_structure, i32* %real_structure.addr, align 4
