...
func_SliceHeader.12:                              ; preds = %ctrl0
  %3 = call i32 @SliceHeader.12()
  ret i32 %3

func_SliceHeader.17:                              ; preds = %ctrl1
  %4 = call i32 @SliceHeader.17()
  ret i32 %4

func_SliceHeader.31:                              ; preds = %ctrl2
  %5 = call i32 @SliceHeader.31()
  ret i32 %5

func_SliceHeader.32:                              ; preds = %ctrl3
  %6 = call i32 @SliceHeader.32()
  ret i32 %6

func_SliceHeader.33:                              ; preds = %ctrl4
  %7 = call i32 @SliceHeader.33()
  ret i32 %7

func_SliceHeader.34:                              ; preds = %ctrl5
  %8 = call i32 @SliceHeader.34()
  ret i32 %8

func_SliceHeader.35:                              ; preds = %ctrl5
  %9 = call i32 @SliceHeader.35()
  ret i32 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_SliceHeader.12, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_SliceHeader.17, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_SliceHeader.31, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_SliceHeader.32, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_SliceHeader.33, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_SliceHeader.34, label %func_SliceHeader.35
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_get_picture_type.3, label %func_get_picture_type.14

func_get_picture_type.3:                          ; preds = %rand_bb
  %2 = call i32 @get_picture_type.3()
  ret i32 %2

func_get_picture_type.14:                         ; preds = %rand_bb
  %3 = call i32 @get_picture_type.14()
  ret i32 %3
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_Partition_BC_Header.5, label %ctrl0

func_Partition_BC_Header.5:                       ; preds = %rand_bb
  %2 = call i32 @Partition_BC_Header.5(i32 %PartNo)
  ret i32 %2
...
func_Partition_BC_Header.20:                      ; preds = %ctrl1
  %4 = call i32 @Partition_BC_Header.20(i32 %PartNo)
  ret i32 %4

func_Partition_BC_Header.21:                      ; preds = %ctrl2
  %5 = call i32 @Partition_BC_Header.21(i32 %PartNo)
  ret i32 %5

func_Partition_BC_Header.24:                      ; preds = %ctrl3
  %6 = call i32 @Partition_BC_Header.24(i32 %PartNo)
  ret i32 %6

func_Partition_BC_Header.26:                      ; preds = %ctrl4
  %7 = call i32 @Partition_BC_Header.26(i32 %PartNo)
  ret i32 %7

func_Partition_BC_Header.38:                      ; preds = %ctrl5
  %8 = call i32 @Partition_BC_Header.38(i32 %PartNo)
  ret i32 %8
...
ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_Partition_BC_Header.20, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_Partition_BC_Header.21, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_Partition_BC_Header.24, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_Partition_BC_Header.26, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_Partition_BC_Header.38, label %func_Partition_BC_Header.39
}
...
func_ref_pic_list_reordering.7:                   ; preds = %ctrl0
  %3 = call i32 @ref_pic_list_reordering.7()
  ret i32 %3

func_ref_pic_list_reordering.8:                   ; preds = %ctrl1
  %4 = call i32 @ref_pic_list_reordering.8()
  ret i32 %4

func_ref_pic_list_reordering.9:                   ; preds = %ctrl2
  %5 = call i32 @ref_pic_list_reordering.9()
  ret i32 %5

func_ref_pic_list_reordering.10:                  ; preds = %ctrl3
  %6 = call i32 @ref_pic_list_reordering.10()
  ret i32 %6

func_ref_pic_list_reordering.13:                  ; preds = %ctrl4
  %7 = call i32 @ref_pic_list_reordering.13()
  ret i32 %7

func_ref_pic_list_reordering.15:                  ; preds = %ctrl5
  %8 = call i32 @ref_pic_list_reordering.15()
  ret i32 %8

func_ref_pic_list_reordering.16:                  ; preds = %ctrl5
  %9 = call i32 @ref_pic_list_reordering.16()
  ret i32 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_ref_pic_list_reordering.7, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_ref_pic_list_reordering.8, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_ref_pic_list_reordering.9, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_ref_pic_list_reordering.10, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_ref_pic_list_reordering.13, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_ref_pic_list_reordering.15, label %func_ref_pic_list_reordering.16
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_dec_ref_pic_marking.1, label %ctrl0

func_dec_ref_pic_marking.1:                       ; preds = %rand_bb
  %2 = call i32 @dec_ref_pic_marking.1()
  ret i32 %2

func_dec_ref_pic_marking.6:                       ; preds = %ctrl0
  %3 = call i32 @dec_ref_pic_marking.6()
  ret i32 %3

func_dec_ref_pic_marking.18:                      ; preds = %ctrl1
  %4 = call i32 @dec_ref_pic_marking.18()
  ret i32 %4

func_dec_ref_pic_marking.22:                      ; preds = %ctrl2
  %5 = call i32 @dec_ref_pic_marking.22()
  ret i32 %5

func_dec_ref_pic_marking.23:                      ; preds = %ctrl3
  %6 = call i32 @dec_ref_pic_marking.23()
  ret i32 %6

func_dec_ref_pic_marking.30:                      ; preds = %ctrl4
  %7 = call i32 @dec_ref_pic_marking.30()
  ret i32 %7

func_dec_ref_pic_marking.36:                      ; preds = %ctrl5
  %8 = call i32 @dec_ref_pic_marking.36()
  ret i32 %8

func_dec_ref_pic_marking.37:                      ; preds = %ctrl5
  %9 = call i32 @dec_ref_pic_marking.37()
  ret i32 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_dec_ref_pic_marking.6, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_dec_ref_pic_marking.18, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_dec_ref_pic_marking.22, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_dec_ref_pic_marking.23, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_dec_ref_pic_marking.30, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_dec_ref_pic_marking.36, label %func_dec_ref_pic_marking.37
}
...
func_pred_weight_table.25:                        ; preds = %ctrl0
  %3 = call i32 @pred_weight_table.25()
  ret i32 %3

func_pred_weight_table.27:                        ; preds = %ctrl1
  %4 = call i32 @pred_weight_table.27()
  ret i32 %4

func_pred_weight_table.28:                        ; preds = %ctrl2
  %5 = call i32 @pred_weight_table.28()
  ret i32 %5

func_pred_weight_table.29:                        ; preds = %ctrl3
  %6 = call i32 @pred_weight_table.29()
  ret i32 %6

func_pred_weight_table.40:                        ; preds = %ctrl4
  %7 = call i32 @pred_weight_table.40()
  ret i32 %7

func_pred_weight_table.41:                        ; preds = %ctrl5
  %8 = call i32 @pred_weight_table.41()
  ret i32 %8

func_pred_weight_table.42:                        ; preds = %ctrl5
  %9 = call i32 @pred_weight_table.42()
  ret i32 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_pred_weight_table.25, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_pred_weight_table.27, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_pred_weight_table.28, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_pred_weight_table.29, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_pred_weight_table.40, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_pred_weight_table.41, label %func_pred_weight_table.42
}

; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @dec_ref_pic_marking.1() #0 {
entry:
  ...
  %canary = alloca i32
  store i32 370452651, i32* %canary
...
entry:
  ...
  %len = alloca i32, align 4
  %canary = alloca i32
  store i32 793985620, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_picture_type.3() #0 {
entry:
  %canary = alloca i32
  store i32 1038902769, i32* %canary
...
entry:
  ...
  %currSlice = alloca %struct.Slice*, align 8
  %canary = alloca i32
  store i32 1353826684, i32* %canary
  %partition = alloca %struct.datapartition*, align 8
  %len = alloca i32, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 388374242, i32* %canary
  %len = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @dec_ref_pic_marking.6() #0 {
entry:
  %canary = alloca i32
  store i32 668290536, i32* %canary
  %dP_nr = alloca i32, align 4
  %len = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
  %val = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @ref_pic_list_reordering.7() #0 {
entry:
  %i = alloca i32, align 4
  %len = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
  %canary = alloca i32
  store i32 1067046598, i32* %canary
  %dP_nr = alloca i32, align 4
  %currSlice = alloca %struct.Slice*, align 8
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @ref_pic_list_reordering.8() #0 {
entry:
  %canary = alloca i32
  store i32 701443011, i32* %canary
  %len = alloca i32, align 4
  %currSlice = alloca %struct.Slice*, align 8
  %partition = alloca %struct.datapartition*, align 8
  %i = alloca i32, align 4
...
entry:
  ...
  %len = alloca i32, align 4
  %canary = alloca i32
  store i32 148616187, i32* %canary
  %dP_nr = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
  %1 = load i32, i32* %partition_mode, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @ref_pic_list_reordering.10() #0 {
entry:
  %canary = alloca i32
  store i32 1190834666, i32* %canary
  %partition = alloca %struct.datapartition*, align 8
  %dP_nr = alloca i32, align 4
  %currSlice = alloca %struct.Slice*, align 8
  %len = alloca i32, align 4
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1329164178, i32* %canary
  %len = alloca i32, align 4
  %dP_nr = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
...
if.end175:                                        ; preds = %for.end174, %for.end83
  ...
  %172 = icmp eq i32 %171, 1329164178
...
entry:
  ...
  %dP_nr = alloca i32, align 4
  %canary = alloca i32
  store i32 1394213797, i32* %canary
  %field_pic_flag = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
  %1 = load i32, i32* %partition_mode, align 4
...
if.end239:                                        ; preds = %if.then236, %land.lhs.true232, %if.end229
  %236 = load i32, i32* %len, align 4
  %237 = load i32, i32* %canary
  %238 = icmp eq i32 %237, 1394213797
  br i1 %238, label %239, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @ref_pic_list_reordering.13() #0 {
entry:
  %currSlice = alloca %struct.Slice*, align 8
  %dP_nr = alloca i32, align 4
  %len = alloca i32, align 4
  %canary = alloca i32
  store i32 1511236562, i32* %canary
  %partition = alloca %struct.datapartition*, align 8
  %i = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_picture_type.14() #0 {
entry:
  %canary = alloca i32
  store i32 2120083580, i32* %canary
  %retval = alloca i32, align 4
  %same_slicetype_for_whole_frame = alloca i32, align 4
  store i32 5, i32* %same_slicetype_for_whole_frame, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
entry:
  ...
  %len = alloca i32, align 4
  %canary = alloca i32
  store i32 230046090, i32* %canary
  %dP_nr = alloca i32, align 4
  %currSlice = alloca %struct.Slice*, align 8
  %partition = alloca %struct.datapartition*, align 8
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @ref_pic_list_reordering.16() #0 {
entry:
  %i = alloca i32, align 4
  %currSlice = alloca %struct.Slice*, align 8
  %len = alloca i32, align 4
  %dP_nr = alloca i32, align 4
  %canary = alloca i32
  store i32 536409442, i32* %canary
  %partition = alloca %struct.datapartition*, align 8
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
  %1 = load i32, i32* %partition_mode, align 4
...
entry:
  %numtmp = alloca float, align 4
  %canary = alloca i32
  store i32 368962353, i32* %canary
  %currSlice = alloca %struct.Slice*, align 8
  %dP_nr = alloca i32, align 4
  %len = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
...
entry:
  ...
  %partition = alloca %struct.datapartition*, align 8
  %canary = alloca i32
  store i32 654078864, i32* %canary
  %dP_nr = alloca i32, align 4
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
...
entry:
  %len = alloca i32, align 4
  %canary = alloca i32
  store i32 1411589942, i32* %canary
  %sym = alloca %struct.syntaxelement*, align 8
  %symbol = alloca %struct.syntaxelement, align 8
  %PartNo.addr = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @Partition_BC_Header.20(i32 %PartNo) #0 {
entry:
  %sym = alloca %struct.syntaxelement*, align 8
  %symbol = alloca %struct.syntaxelement, align 8
  %len = alloca i32, align 4
  %PartNo.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1723652551, i32* %canary
  %partition = alloca %struct.datapartition*, align 8
  store i32 %PartNo, i32* %PartNo.addr, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %currentSlice = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 50
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @Partition_BC_Header.21(i32 %PartNo) #0 {
entry:
  %canary = alloca i32
  store i32 283531745, i32* %canary
  %partition = alloca %struct.datapartition*, align 8
  %len = alloca i32, align 4
  %symbol = alloca %struct.syntaxelement, align 8
  %sym = alloca %struct.syntaxelement*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @dec_ref_pic_marking.22() #0 {
entry:
  %dP_nr = alloca i32, align 4
  %canary = alloca i32
  store i32 7355956, i32* %canary
  %partition = alloca %struct.datapartition*, align 8
  %val = alloca i32, align 4
  %len = alloca i32, align 4
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
...
entry:
  ...
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
  %canary = alloca i32
  store i32 1875050864, i32* %canary
  %val = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
  %dP_nr = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
entry:
  ...
  %len = alloca i32, align 4
  %canary = alloca i32
  store i32 1350410788, i32* %canary
  %partition = alloca %struct.datapartition*, align 8
  store i32 %PartNo, i32* %PartNo.addr, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %currentSlice = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 50
...
entry:
  %partition = alloca %struct.datapartition*, align 8
  %canary = alloca i32
  store i32 808096034, i32* %canary
  %i = alloca i32, align 4
  %len = alloca i32, align 4
  %dP_nr = alloca i32, align 4
  %j = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @Partition_BC_Header.26(i32 %PartNo) #0 {
entry:
  %sym = alloca %struct.syntaxelement*, align 8
  %canary = alloca i32
  store i32 922729319, i32* %canary
  %PartNo.addr = alloca i32, align 4
  %symbol = alloca %struct.syntaxelement, align 8
  %partition = alloca %struct.datapartition*, align 8
  %len = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 182857121, i32* %canary
  %i = alloca i32, align 4
  %len = alloca i32, align 4
  %j = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
...
entry:
  %canary = alloca i32
  store i32 1023810831, i32* %canary
  %len = alloca i32, align 4
  %dP_nr = alloca i32, align 4
  %i = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
...
if.end175:                                        ; preds = %for.end174, %for.end83
  %170 = load i32, i32* %len, align 4
  %171 = load i32, i32* %canary
  %172 = icmp eq i32 %171, 1023810831
  br i1 %172, label %173, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @pred_weight_table.29() #0 {
entry:
  %partition = alloca %struct.datapartition*, align 8
  %dP_nr = alloca i32, align 4
  %len = alloca i32, align 4
  %canary = alloca i32
  store i32 148426537, i32* %canary
  %j = alloca i32, align 4
  %i = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
...
entry:
  %dP_nr = alloca i32, align 4
  %canary = alloca i32
  store i32 1540951514, i32* %canary
  %len = alloca i32, align 4
  %val = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @SliceHeader.31() #0 {
entry:
  %num_bits_slice_group_change_cycle = alloca i32, align 4
  %canary = alloca i32
  store i32 1066143705, i32* %canary
  %override_flag = alloca i32, align 4
  %dP_nr = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
  %bottom_field_flag = alloca i32, align 4
...
if.end239:                                        ; preds = %if.then236, %land.lhs.true232, %if.end229
  %236 = load i32, i32* %len, align 4
  %237 = load i32, i32* %canary
  %238 = icmp eq i32 %237, 1066143705
  br i1 %238, label %239, label %func_exit
...
entry:
  ...
  %len = alloca i32, align 4
  %canary = alloca i32
  store i32 2007247457, i32* %canary
  %numtmp = alloca float, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
  %1 = load i32, i32* %partition_mode, align 4
...
if.end239:                                        ; preds = %if.then236, %land.lhs.true232, %if.end229
  %236 = load i32, i32* %len, align 4
  %237 = load i32, i32* %canary
  %238 = icmp eq i32 %237, 2007247457
  br i1 %238, label %239, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @SliceHeader.34() #0 {
entry:
  %dP_nr = alloca i32, align 4
  %num_bits_slice_group_change_cycle = alloca i32, align 4
  %len = alloca i32, align 4
  %canary = alloca i32
  store i32 712618518, i32* %canary
  %currSlice = alloca %struct.Slice*, align 8
  %partition = alloca %struct.datapartition*, align 8
  %bottom_field_flag = alloca i32, align 4
  %override_flag = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @SliceHeader.35() #0 {
entry:
  %bottom_field_flag = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
  %canary = alloca i32
  store i32 1121917802, i32* %canary
  %currSlice = alloca %struct.Slice*, align 8
  %dP_nr = alloca i32, align 4
  %len = alloca i32, align 4
  %field_pic_flag = alloca i32, align 4
...
if.end239:                                        ; preds = %if.then236, %land.lhs.true232, %if.end229
  %236 = load i32, i32* %len, align 4
  %237 = load i32, i32* %canary
  %238 = icmp eq i32 %237, 1121917802
  br i1 %238, label %239, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @dec_ref_pic_marking.36() #0 {
entry:
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
  %dP_nr = alloca i32, align 4
  %len = alloca i32, align 4
  %canary = alloca i32
  store i32 113287113, i32* %canary
  %partition = alloca %struct.datapartition*, align 8
  %val = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @dec_ref_pic_marking.37() #0 {
entry:
  %len = alloca i32, align 4
  %val = alloca i32, align 4
  %dP_nr = alloca i32, align 4
  %canary = alloca i32
  store i32 1891016482, i32* %canary
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
  %partition = alloca %struct.datapartition*, align 8
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @Partition_BC_Header.38(i32 %PartNo) #0 {
entry:
  %PartNo.addr = alloca i32, align 4
  %len = alloca i32, align 4
  %canary = alloca i32
  store i32 1423647468, i32* %canary
  %symbol = alloca %struct.syntaxelement, align 8
  %partition = alloca %struct.datapartition*, align 8
  %sym = alloca %struct.syntaxelement*, align 8
  store i32 %PartNo, i32* %PartNo.addr, align 4
...
entry:
  ...
  %len = alloca i32, align 4
  %canary = alloca i32
  store i32 136269483, i32* %canary
  %sym = alloca %struct.syntaxelement*, align 8
  store i32 %PartNo, i32* %PartNo.addr, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %currentSlice = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 50
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @pred_weight_table.40() #0 {
entry:
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 977206001, i32* %canary
  %dP_nr = alloca i32, align 4
  %i = alloca i32, align 4
  %len = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @pred_weight_table.41() #0 {
entry:
  %dP_nr = alloca i32, align 4
  %i = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 120248014, i32* %canary
  %len = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
  %1 = load i32, i32* %partition_mode, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @pred_weight_table.42() #0 {
entry:
  %partition = alloca %struct.datapartition*, align 8
  %canary = alloca i32
  store i32 1360909594, i32* %canary
  %j = alloca i32, align 4
  %dP_nr = alloca i32, align 4
  %i = alloca i32, align 4
  %len = alloca i32, align 4
...
if.end175:                                        ; preds = %for.end174, %for.end83
  %170 = load i32, i32* %len, align 4
  %171 = load i32, i32* %canary
  %172 = icmp eq i32 %171, 1360909594
  br i1 %172, label %173, label %func_exit
