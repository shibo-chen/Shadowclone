; ModuleID = 'specrand.c.rand.8R2.bc'
...
entry:
  ...
  %canary = alloca i32
  store i32 1681989157, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 2044306674, i32* %canary
  %test = alloca i32, align 4
  %lo = alloca i32, align 4
  %hi = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
...
entry:
  %hi = alloca i32, align 4
  %canary = alloca i32
  store i32 785704982, i32* %canary
  %lo = alloca i32, align 4
  %test = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
  %conv = sext i32 %0 to i64
...
entry:
  %lo = alloca i32, align 4
  %canary = alloca i32
  store i32 1856503825, i32* %canary
  %test = alloca i32, align 4
  %hi = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
  %conv = sext i32 %0 to i64
...
entry:
  %canary = alloca i32
  store i32 1482413776, i32* %canary
  %lo = alloca i32, align 4
  %hi = alloca i32, align 4
  %test = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
...
entry:
  %hi = alloca i32, align 4
  %canary = alloca i32
  store i32 930740703, i32* %canary
  %test = alloca i32, align 4
  %lo = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
  %conv = sext i32 %0 to i64
