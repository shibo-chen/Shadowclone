; ModuleID = 'loopFilter.c.rand.4P1.bc'
...
func_DeblockFrame.5:                              ; preds = %ctrl0
  call void @DeblockFrame.5(%struct.ImageParameters* %img, i16** %imgY, i16*** %imgUV)
  ret void

func_DeblockFrame.9:                              ; preds = %ctrl1
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_DeblockFrame.5, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_DeblockFrame.9, label %func_DeblockFrame.14
}
...
func_DeblockMb.13:                                ; preds = %ctrl0
  call void @DeblockMb.13(%struct.ImageParameters* %img, i16** %imgY, i16*** %imgUV, i32 %MbQAddr)
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_DeblockMb.13, label %ctrl1
...
func_GetStrength.7:                               ; preds = %ctrl1
  call void @GetStrength.7(i8* %Strength, %struct.ImageParameters* %img, i32 %MbQAddr, i32 %dir, i32 %edge, i32 %mvlimit)
  ret void

func_GetStrength.11:                              ; preds = %ctrl1
  call void @GetStrength.11(i8* %Strength, %struct.ImageParameters* %img, i32 %MbQAddr, i32 %dir, i32 %edge, i32 %mvlimit)
  ret void
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_GetStrength.7, label %func_GetStrength.11
}
...
func_EdgeLoop.12:                                 ; preds = %ctrl1
  call void @EdgeLoop.12(i16** %Img, i8* %Strength, %struct.ImageParameters* %img, i32 %MbQAddr, i32 %AlphaC0Offset, i32 %BetaOffset, i32 %dir, i32 %edge, i32 %width, i32 %yuv, i32 %uv)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_EdgeLoop.8, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_EdgeLoop.10, label %func_EdgeLoop.12
}
...
entry:
  ...
  %canary = alloca i32
  store i32 328657264, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1358851085, i32* %canary
  %img.addr = alloca %struct.ImageParameters*, align 8
...
entry:
  ...
  %blkP = alloca i32, align 4
  %canary = alloca i32
  store i32 514873342, i32* %canary
  %ref_p0 = alloca i64, align 8
  %MbQ = alloca %struct.macroblock*, align 8
  %yP = alloca i32, align 4
  %blk_x2 = alloca i32, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 115301464, i32* %canary
  %yQ = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @DeblockFrame.5(%struct.ImageParameters* %img, i16** %imgY, i16*** %imgUV) #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1530734547, i32* %canary
  %imgY.addr = alloca i16**, align 8
  %img.addr = alloca %struct.ImageParameters*, align 8
  %imgUV.addr = alloca i16***, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
...
entry:
  ...
  %img.addr = alloca %struct.ImageParameters*, align 8
  %canary = alloca i32
  store i32 853702018, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1241258722, i32* %canary
  %Alpha = alloca i32, align 4
  %R2 = alloca i32, align 4
  %xQ = alloca i32, align 4
  %AbsDelta = alloca i32, align 4
...
for.end:                                          ; preds = %for.cond
  %347 = load i32, i32* %canary
  %348 = icmp eq i32 %347, 1241258722
  br i1 %348, label %349, label %func_exit
...
entry:
  ...
  %imgY.addr = alloca i16**, align 8
  %canary = alloca i32
  store i32 1563075773, i32* %canary
  %imgUV.addr = alloca i16***, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store i16** %imgY, i16*** %imgY.addr, align 8
  store i16*** %imgUV, i16**** %imgUV.addr, align 8
...
entry:
  ...
  %dir.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 558029547, i32* %canary
  %MbP = alloca %struct.macroblock*, align 8
  %MbQAddr.addr = alloca i32, align 4
  %Img.addr = alloca i16**, align 8
  %c0 = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @GetStrength.11(i8* %Strength, %struct.ImageParameters* %img, i32 %MbQAddr, i32 %dir, i32 %edge, i32 %mvlimit) #0 {
entry:
  %xQ = alloca i32, align 4
  %dir.addr = alloca i32, align 4
  %mvlimit.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @EdgeLoop.12(i16** %Img, i8* %Strength, %struct.ImageParameters* %img, i32 %MbQAddr, i32 %AlphaC0Offset, i32 %BetaOffset, i32 %dir, i32 %edge, i32 %width, i32 %yuv, i32 %uv) #0 {
entry:
  %dif = alloca i32, align 4
  %MbQAddr.addr = alloca i32, align 4
  %RL0 = alloca i32, align 4
  ...
  %ClipTab = alloca i8*, align 8
  %canary = alloca i32
  store i32 1658784720, i32* %canary
  %pixQ = alloca %struct.pix_pos, align 4
  %R0 = alloca i32, align 4
  %C0 = alloca i32, align 4
  %SrcPtrQ = alloca i16*, align 8
...
for.end:                                          ; preds = %for.cond
  %347 = load i32, i32* %canary
  %348 = icmp eq i32 %347, 1658784720
  br i1 %348, label %349, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @DeblockMb.13(%struct.ImageParameters* %img, i16** %imgY, i16*** %imgUV, i32 %MbQAddr) #0 {
entry:
  %imgY.addr = alloca i16**, align 8
  %filterTopMbEdgeFlag = alloca i32, align 4
  %MbQAddr.addr = alloca i32, align 4
  ...
  %EdgeCondition = alloca i32, align 4
  %canary = alloca i32
  store i32 1271480774, i32* %canary
  %dir = alloca i32, align 4
  %edge = alloca i32, align 4
  %imgUV.addr = alloca i16***, align 8
  %mb_y = alloca i32, align 4
...
return:                                           ; preds = %for.end152, %if.then25
  %160 = load i32, i32* %canary
  %161 = icmp eq i32 %160, 1271480774
  br i1 %161, label %162, label %func_exit
...
entry:
  %img.addr = alloca %struct.ImageParameters*, align 8
  %canary = alloca i32
  store i32 1269194888, i32* %canary
  %imgUV.addr = alloca i16***, align 8
  %i = alloca i32, align 4
  %imgY.addr = alloca i16**, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
...
entry:
  ...
  %filterNon8x8LumaEdgesFlag = alloca [4 x i32], align 16
  %canary = alloca i32
  store i32 998911567, i32* %canary
  %i = alloca i32, align 4
  %fieldModeMbFlag = alloca i32, align 4
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store i16** %imgY, i16*** %imgY.addr, align 8
...
entry:
  ...
  %fieldModeMbFlag = alloca i32, align 4
  %canary = alloca i32
  store i32 1484590098, i32* %canary
  %EdgeCondition = alloca i32, align 4
  %mb_y = alloca i32, align 4
  %imgUV.addr = alloca i16***, align 8
  %i = alloca i32, align 4
...
return:                                           ; preds = %for.end152, %if.then25
  %160 = load i32, i32* %canary
  %161 = icmp eq i32 %160, 1484590098
  br i1 %161, label %162, label %func_exit
