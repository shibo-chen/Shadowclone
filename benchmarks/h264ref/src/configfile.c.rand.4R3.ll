; ModuleID = 'configfile.c.rand.4R3.bc'
...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_Configure.1, label %ctrl0

func_Configure.1:                                 ; preds = %rand_bb
  call void @Configure.1(i32 %ac, i8** %av)
  ret void

func_Configure.10:                                ; preds = %ctrl0
...
func_Configure.13:                                ; preds = %ctrl1
  call void @Configure.13(i32 %ac, i8** %av)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_Configure.10, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_Configure.11, label %func_Configure.13
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_GetConfigFileContent.2, label %ctrl0

func_GetConfigFileContent.2:                      ; preds = %rand_bb
  %2 = call i8* @GetConfigFileContent.2(i8* %Filename)
  ret i8* %2

func_GetConfigFileContent.6:                      ; preds = %ctrl0
  %3 = call i8* @GetConfigFileContent.6(i8* %Filename)
  ret i8* %3

func_GetConfigFileContent.15:                     ; preds = %ctrl1
  %4 = call i8* @GetConfigFileContent.15(i8* %Filename)
  ret i8* %4

func_GetConfigFileContent.18:                     ; preds = %ctrl1
  %5 = call i8* @GetConfigFileContent.18(i8* %Filename)
  ret i8* %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_GetConfigFileContent.6, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_GetConfigFileContent.15, label %func_GetConfigFileContent.18
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_ParseContent.4, label %ctrl0

func_ParseContent.4:                              ; preds = %rand_bb
...
func_ParseContent.20:                             ; preds = %ctrl1
  call void @ParseContent.20(i8* %buf, i32 %bufsize)
  ret void
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_ParseContent.20, label %func_ParseContent.23
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_CeilLog2.5, label %ctrl0

func_CeilLog2.5:                                  ; preds = %rand_bb
  %2 = call i32 @CeilLog2.5(i32 %uiVal)
  ret i32 %2

func_CeilLog2.19:                                 ; preds = %ctrl0
  %3 = call i32 @CeilLog2.19(i32 %uiVal)
  ret i32 %3

func_CeilLog2.22:                                 ; preds = %ctrl1
  %4 = call i32 @CeilLog2.22(i32 %uiVal)
  ret i32 %4

func_CeilLog2.24:                                 ; preds = %ctrl1
  %5 = call i32 @CeilLog2.24(i32 %uiVal)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_CeilLog2.19, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_CeilLog2.22, label %func_CeilLog2.24
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_ParameterNameToMapIndex.7, label %ctrl0

func_ParameterNameToMapIndex.7:                   ; preds = %rand_bb
  %2 = call i32 @ParameterNameToMapIndex.7(i8* %s)
  ret i32 %2

func_ParameterNameToMapIndex.21:                  ; preds = %ctrl0
  %3 = call i32 @ParameterNameToMapIndex.21(i8* %s)
  ret i32 %3

func_ParameterNameToMapIndex.25:                  ; preds = %ctrl1
  %4 = call i32 @ParameterNameToMapIndex.25(i8* %s)
  ret i32 %4
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_ParameterNameToMapIndex.21, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_ParameterNameToMapIndex.25, label %func_ParameterNameToMapIndex.26
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_PatchInp.9, label %ctrl0

func_PatchInp.9:                                  ; preds = %rand_bb
  call void @PatchInp.9()
  ret void

func_PatchInp.12:                                 ; preds = %ctrl0
  call void @PatchInp.12()
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_PatchInp.12, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_PatchInp.14, label %func_PatchInp.16
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_TestEncoderParams.3, label %func_TestEncoderParams.8

func_TestEncoderParams.3:                         ; preds = %rand_bb
  %2 = call i32 @TestEncoderParams.3(i32 %bitdepth_qp_scale)
  ret i32 %2

func_TestEncoderParams.8:                         ; preds = %rand_bb
  %3 = call i32 @TestEncoderParams.8(i32 %bitdepth_qp_scale)
  ret i32 %3
}
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Configure.1(i32 %ac, i8** %av) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 1411720764, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i8* @GetConfigFileContent.2(i8* %Filename) #0 {
entry:
  %Filename.addr = alloca i8*, align 8
  %FileSize = alloca i64, align 8
  %f = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 1153862607, i32* %canary
...
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 2125216019, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 226957152, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 518074915, i32* %canary
...
entry:
  ...
  %FileSize = alloca i64, align 8
  %canary = alloca i32
  store i32 1891771753, i32* %canary
  %buf = alloca i8*, align 8
  store i8* %Filename, i8** %Filename.addr, align 8
  %0 = load i8*, i8** %Filename.addr, align 8
  %call = call %struct._IO_FILE* @fopen(i8* %0, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.12, i64 0, i64 0))
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @ParameterNameToMapIndex.7(i8* %s) #0 {
entry:
  %canary = alloca i32
  store i32 1215813654, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @TestEncoderParams.8(i32 %bitdepth_qp_scale) #0 {
entry:
  %bitdepth_qp_scale.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 937046553, i32* %canary
  %i = alloca i32, align 4
  store i32 %bitdepth_qp_scale, i32* %bitdepth_qp_scale.addr, align 4
  store i32 0, i32* %i, align 4
  br label %while.cond
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @PatchInp.9() #0 {
entry:
  ...
  %canary = alloca i32
  store i32 247455983, i32* %canary
...
entry:
  %NumberParams = alloca i32, align 4
  %canary = alloca i32
  store i32 1238122460, i32* %canary
  %source = alloca i8*, align 8
  %content = alloca i8*, align 8
  %CLcount = alloca i32, align 4
  %ContentLen = alloca i32, align 4
...
entry:
  ...
  %CLcount = alloca i32, align 4
  %canary = alloca i32
  store i32 279275406, i32* %canary
  %ac.addr = alloca i32, align 4
  store i32 %ac, i32* %ac.addr, align 4
  store i8** %av, i8*** %av.addr, align 8
  store i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.1, i64 0, i64 0), i8** %filename, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @PatchInp.12() #0 {
entry:
  %bitdepth_qp_scale = alloca i32, align 4
  %mb_width = alloca i32, align 4
  %canary = alloca i32
  store i32 774672874, i32* %canary
  %mb_height = alloca i32, align 4
  %sgfile = alloca %struct._IO_FILE*, align 8
  %storedBplus1 = alloca i32, align 4
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Configure.13(i32 %ac, i8** %av) #0 {
entry:
  %ac.addr = alloca i32, align 4
  %CLcount = alloca i32, align 4
  %canary = alloca i32
  store i32 1001509463, i32* %canary
  %av.addr = alloca i8**, align 8
  %filename = alloca i8*, align 8
  %NumberParams = alloca i32, align 4
  %content = alloca i8*, align 8
...
entry:
  ...
  %storedBplus1 = alloca i32, align 4
  %canary = alloca i32
  store i32 1123679782, i32* %canary
  %mapunit_height = alloca i32, align 4
  %i = alloca i32, align 4
  %mb_height = alloca i32, align 4
  %sgfile = alloca %struct._IO_FILE*, align 8
...
if.end649:                                        ; preds = %if.then647, %land.lhs.true645, %if.end641
  ...
  call void @LevelCheck()
  %371 = load i32, i32* %canary
  %372 = icmp eq i32 %371, 1123679782
  br i1 %372, label %373, label %func_exit
...
entry:
  %retval = alloca i8*, align 8
  %canary = alloca i32
  store i32 314190788, i32* %canary
  %f = alloca %struct._IO_FILE*, align 8
  %FileSize = alloca i64, align 8
  %Filename.addr = alloca i8*, align 8
  %buf = alloca i8*, align 8
...
entry:
  ...
  %mb_height = alloca i32, align 4
  %canary = alloca i32
  store i32 1872810986, i32* %canary
  %i = alloca i32, align 4
  %sgfile = alloca %struct._IO_FILE*, align 8
  %storedBplus1 = alloca i32, align 4
  %frame_mb_only = alloca i32, align 4
...
if.end649:                                        ; preds = %if.then647, %land.lhs.true645, %if.end641
  ...
  call void @LevelCheck()
  %371 = load i32, i32* %canary
  %372 = icmp eq i32 %371, 1872810986
  br i1 %372, label %373, label %func_exit
...
entry:
  ...
  %InString = alloca i32, align 4
  %canary = alloca i32
  store i32 111209583, i32* %canary
  %InItem = alloca i32, align 4
  %bufsize.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i8* @GetConfigFileContent.18(i8* %Filename) #0 {
entry:
  %f = alloca %struct._IO_FILE*, align 8
  %Filename.addr = alloca i8*, align 8
  %buf = alloca i8*, align 8
  %canary = alloca i32
  store i32 1297053647, i32* %canary
  %retval = alloca i8*, align 8
  %FileSize = alloca i64, align 8
  store i8* %Filename, i8** %Filename.addr, align 8
  %0 = load i8*, i8** %Filename.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @CeilLog2.19(i32 %uiVal) #0 {
entry:
  %canary = alloca i32
  store i32 1312690348, i32* %canary
  %uiVal.addr = alloca i32, align 4
  %uiTmp = alloca i32, align 4
  %uiRet = alloca i32, align 4
  store i32 %uiVal, i32* %uiVal.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @ParseContent.20(i8* %buf, i32 %bufsize) #0 {
entry:
  %items = alloca [10000 x i8*], align 16
  %InItem = alloca i32, align 4
  %MapIdx = alloca i32, align 4
  ...
  %p = alloca i8*, align 8
  %canary = alloca i32
  store i32 147327799, i32* %canary
  %item = alloca i32, align 4
  %bufsize.addr = alloca i32, align 4
  %DoubleContent = alloca double, align 8
  store i8* %buf, i8** %buf.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @ParameterNameToMapIndex.21(i8* %s) #0 {
entry:
  %canary = alloca i32
  store i32 248169209, i32* %canary
  %i = alloca i32, align 4
  %s.addr = alloca i8*, align 8
  %retval = alloca i32, align 4
  store i8* %s, i8** %s.addr, align 8
...
entry:
  ...
  %uiVal.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 164418045, i32* %canary
  %uiRet = alloca i32, align 4
  store i32 %uiVal, i32* %uiVal.addr, align 4
  %0 = load i32, i32* %uiVal.addr, align 4
  %sub = sub i32 %0, 1
...
entry:
  ...
  %p = alloca i8*, align 8
  %canary = alloca i32
  store i32 225759256, i32* %canary
  %bufsize.addr = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %bufsize, i32* %bufsize.addr, align 4
  store i32 0, i32* %item, align 4
...
entry:
  %uiTmp = alloca i32, align 4
  %canary = alloca i32
  store i32 1272719978, i32* %canary
  %uiRet = alloca i32, align 4
  %uiVal.addr = alloca i32, align 4
  store i32 %uiVal, i32* %uiVal.addr, align 4
  %0 = load i32, i32* %uiVal.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @ParameterNameToMapIndex.25(i8* %s) #0 {
entry:
  %s.addr = alloca i8*, align 8
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1675107120, i32* %canary
  %retval = alloca i32, align 4
  store i8* %s, i8** %s.addr, align 8
  store i32 0, i32* %i, align 4
  br label %while.cond
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1452136386, i32* %canary
  %s.addr = alloca i8*, align 8
  store i8* %s, i8** %s.addr, align 8
  store i32 0, i32* %i, align 4
  br label %while.cond
