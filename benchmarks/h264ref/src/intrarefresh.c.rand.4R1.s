...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$16, %rsp
	movl	$1876859350, -12(%rbp)  # imm = 0x6FDE99D6
...
# %bb.3:                                # %for.inc
	...
	jmp	.LBB4_1
.LBB4_4:                                # %for.end
	cmpl	$1876859350, -12(%rbp)  # imm = 0x6FDE99D6
	jne	.LBB4_6
.LBB4_5:
	addq	$16, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$16, %rsp
	movl	$1378989017, -12(%rbp)  # imm = 0x5231B3D9
	movl	NumberIntraPerPicture, %eax
	addl	WalkAround, %eax
	movl	%eax, WalkAround
	movl	$0, -4(%rbp)
...
# %bb.3:                                # %for.inc
	...
	jmp	.LBB5_1
.LBB5_4:                                # %for.end
	cmpl	$1378989017, -12(%rbp)  # imm = 0x5231B3D9
	jne	.LBB5_6
.LBB5_5:
	addq	$16, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$283354688, -24(%rbp)   # imm = 0x10E3A640
	movl	%edi, -20(%rbp)
	movl	$0, -12(%rbp)
.LBB6_1:                                # %for.cond
                                        # =>This Inner Loop Header: Depth=1
...
.LBB6_7:                                # %return
	movl	-16(%rbp), %ebx
	cmpl	$283354688, -24(%rbp)   # imm = 0x10E3A640
	jne	.LBB6_9
.LBB6_8:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$1500183770, -24(%rbp)  # imm = 0x596AFCDA
	movl	%edi, -20(%rbp)
	movl	$0, -12(%rbp)
.LBB7_1:                                # %for.cond
                                        # =>This Inner Loop Header: Depth=1
...
.LBB7_7:                                # %return
	movl	-16(%rbp), %ebx
	cmpl	$1500183770, -24(%rbp)  # imm = 0x596AFCDA
	jne	.LBB7_9
.LBB7_8:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$1605484019, -24(%rbp)  # imm = 0x5FB1BDF3
	movl	%edi, -20(%rbp)
	movl	$0, -12(%rbp)
.LBB8_1:                                # %for.cond
                                        # =>This Inner Loop Header: Depth=1
...
.LBB8_7:                                # %return
	movl	-16(%rbp), %ebx
	cmpl	$1605484019, -24(%rbp)  # imm = 0x5FB1BDF3
	jne	.LBB8_9
.LBB8_8:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$494543614, -20(%rbp)   # imm = 0x1D7A22FE
	movl	%edi, -24(%rbp)
	movl	%esi, -16(%rbp)
	movl	%edx, -12(%rbp)
	movl	$1, %edi
...
# %bb.14:                               # %for.inc23
	...
	jmp	.LBB9_9
.LBB9_15:                               # %for.end25
	cmpl	$494543614, -20(%rbp)   # imm = 0x1D7A22FE
	jne	.LBB9_17
.LBB9_16:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$105654707, -24(%rbp)   # imm = 0x64C29B3
	movl	%edi, -20(%rbp)
	movl	$0, -12(%rbp)
.LBB10_1:                               # %for.cond
                                        # =>This Inner Loop Header: Depth=1
...
.LBB10_7:                               # %return
	movl	-16(%rbp), %ebx
	cmpl	$105654707, -24(%rbp)   # imm = 0x64C29B3
	jne	.LBB10_9
.LBB10_8:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$371516859, -24(%rbp)   # imm = 0x1624E5BB
	movl	%edi, -16(%rbp)
	movl	%esi, -20(%rbp)
	movl	%edx, -8(%rbp)
	movl	$1, %edi
...
# %bb.14:                               # %for.inc23
	...
	jmp	.LBB11_9
.LBB11_15:                              # %for.end25
	cmpl	$371516859, -24(%rbp)   # imm = 0x1624E5BB
	jne	.LBB11_17
.LBB11_16:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$2110025451, -20(%rbp)  # imm = 0x7DC46EEB
	movl	%edi, -24(%rbp)
	movl	%esi, -16(%rbp)
	movl	%edx, -8(%rbp)
	movl	$1, %edi
...
# %bb.14:                               # %for.inc23
	...
	jmp	.LBB12_9
.LBB12_15:                              # %for.end25
	cmpl	$2110025451, -20(%rbp)  # imm = 0x7DC46EEB
	jne	.LBB12_17
.LBB12_16:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$495954923, -24(%rbp)   # imm = 0x1D8FABEB
	movl	%edi, -16(%rbp)
	movl	%esi, -20(%rbp)
	movl	%edx, -12(%rbp)
	movl	$1, %edi
...
# %bb.14:                               # %for.inc23
	...
	jmp	.LBB13_9
.LBB13_15:                              # %for.end25
	cmpl	$495954923, -24(%rbp)   # imm = 0x1D8FABEB
	jne	.LBB13_17
.LBB13_16:
	addq	$32, %rsp
	popq	%rbp
