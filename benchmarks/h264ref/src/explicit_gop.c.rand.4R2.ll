; ModuleID = 'explicit_gop.c.rand.4R2.bc'
...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_create_pyramid.4, label %ctrl0

func_create_pyramid.4:                            ; preds = %rand_bb
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_create_pyramid.14, label %func_create_pyramid.16
}
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_gop_pyramid.11, label %func_gop_pyramid.13
}
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_interpret_gop_structure.12, label %func_interpret_gop_structure.15
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_poc_based_ref_management.2, label %ctrl0

func_poc_based_ref_management.2:                  ; preds = %rand_bb
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_poc_based_ref_management.9, label %func_poc_based_ref_management.10
}
...
entry:
  ...
  %canary = alloca i32
  store i32 1464453164, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1781108848, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1317148287, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 562912142, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1960606290, i32* %canary
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
  %current_pic_num.addr = alloca i32, align 4
  %pic_num = alloca i32, align 4
  %i = alloca i32, align 4
...
entry:
  %frames.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 445226554, i32* %canary
  %pyramid_structure.addr = alloca %struct.GOP_DATA*, align 8
  %frm_no.addr = alloca i32, align 4
  %level.addr = alloca i32, align 4
  store i32 %level, i32* %level.addr, align 4
...
entry:
  ...
  %slice_read = alloca i32, align 4
  %canary = alloca i32
  store i32 1262283126, i32* %canary
  %stored_read = alloca i32, align 4
  %k = alloca i32, align 4
  %order_read = alloca i32, align 4
  %i = alloca i32, align 4
...
entry:
  ...
  %tempnum = alloca i32, align 4
  %canary = alloca i32
  store i32 1147665008, i32* %canary
  %centerB = alloca i32, align 4
  %i28 = alloca i32, align 4
  %prvlevelrefs = alloca i32, align 4
  %curlevel = alloca i32, align 4
...
if.end200:                                        ; preds = %for.end199, %for.end
  %161 = load i32, i32* %canary
  %162 = icmp eq i32 %161, 1147665008
  br i1 %162, label %163, label %func_exit
...
entry:
  ...
  %min_poc = alloca i32, align 4
  %canary = alloca i32
  store i32 1218745191, i32* %canary
  %tmp_drpm2 = alloca %struct.DecRefPicMarking_s*, align 8
  store i32 %current_pic_num, i32* %current_pic_num.addr, align 4
  store i32 0, i32* %pic_num, align 4
  store i32 2147483647, i32* %min_poc, align 4
...
entry:
  %canary = alloca i32
  store i32 1217058319, i32* %canary
  %i = alloca i32, align 4
  %min_poc = alloca i32, align 4
  %current_pic_num.addr = alloca i32, align 4
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
...
entry:
  %canary = alloca i32
  store i32 1327514293, i32* %canary
  %frames.addr = alloca i32, align 4
  %level.addr = alloca i32, align 4
  %frm_no.addr = alloca i32, align 4
  %pyramid_structure.addr = alloca %struct.GOP_DATA*, align 8
...
entry:
  %canary = alloca i32
  store i32 460563555, i32* %canary
  %qp = alloca i32, align 4
  %display_no = alloca i32, align 4
  %order_read = alloca i32, align 4
  %coded_frame = alloca i32, align 4
...
entry:
  ...
  %frm_no.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1043555627, i32* %canary
  %frames.addr = alloca i32, align 4
  %level.addr = alloca i32, align 4
  store i32 %level, i32* %level.addr, align 4
  store i32 %frm_no, i32* %frm_no.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 1563716983, i32* %canary
  %levelrefs = alloca i32, align 4
  %curGOPLevelfrm = alloca i32*, align 8
  %centerB = alloca i32, align 4
  %GOPlevels = alloca i32, align 4
...
if.end200:                                        ; preds = %for.end199, %for.end
  %161 = load i32, i32* %canary
  %162 = icmp eq i32 %161, 1563716983
  br i1 %162, label %163, label %func_exit
...
entry:
  %qp_read = alloca i32, align 4
  %canary = alloca i32
  store i32 1422555123, i32* %canary
  %display_no = alloca i32, align 4
  %nLength = alloca i32, align 4
  %slice_read = alloca i32, align 4
  %qp = alloca i32, align 4
...
entry:
  ...
  %centerB = alloca i32, align 4
  %canary = alloca i32
  store i32 141300196, i32* %canary
  %tempnum = alloca i32, align 4
  %GOPlevels = alloca i32, align 4
  %curlevel = alloca i32, align 4
  %levelrefs = alloca i32, align 4
