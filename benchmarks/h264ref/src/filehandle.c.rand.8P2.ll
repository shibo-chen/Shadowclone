; ModuleID = 'filehandle.c.rand.8P2.bc'
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_write_PPS.5, label %ctrl0

func_write_PPS.5:                                 ; preds = %rand_bb
  %2 = call i32 @write_PPS.5(i32 %len, i32 %PPS_id)
  ret i32 %2
...
func_write_PPS.12:                                ; preds = %ctrl1
  %4 = call i32 @write_PPS.12(i32 %len, i32 %PPS_id)
  ret i32 %4
...
func_write_PPS.15:                                ; preds = %ctrl3
  %6 = call i32 @write_PPS.15(i32 %len, i32 %PPS_id)
  ret i32 %6
...
ctrl1:                                            ; preds = %ctrl0
  %9 = icmp eq i32 %0, 2
  br i1 %9, label %func_write_PPS.12, label %ctrl2
...
ctrl3:                                            ; preds = %ctrl2
  %11 = icmp eq i32 %0, 4
  br i1 %11, label %func_write_PPS.15, label %func_write_PPS.16
}
...
func_start_sequence.10:                           ; preds = %ctrl4
  %7 = call i32 @start_sequence.10()
  ret i32 %7

func_start_sequence.11:                           ; preds = %ctrl5
  %8 = call i32 @start_sequence.11()
  ret i32 %8
...
ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_start_sequence.4, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_start_sequence.6, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_start_sequence.8, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_start_sequence.9, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_start_sequence.10, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_start_sequence.11, label %func_start_sequence.14
}
...
entry:
  %canary = alloca i32
  store i32 1160294474, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 676894262, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 256085497, i32* %canary
  %text.addr = alloca i8*, align 8
  %code.addr = alloca i32, align 4
  store i8* %text, i8** %text.addr, align 8
  store i32 %code, i32* %code.addr, align 4
...
entry:
  %total_pps = alloca i32, align 4
  %canary = alloca i32
  store i32 488673603, i32* %canary
  %len = alloca i32, align 4
  %retval = alloca i32, align 4
  %nalu = alloca %struct.NALU_t*, align 8
  %i = alloca i32, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 241397189, i32* %canary
  %nalu = alloca %struct.NALU_t*, align 8
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1384940276, i32* %canary
  %retval = alloca i32, align 4
  store i32 0, i32* %len, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %GenerateMultiplePPS = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 15
...
entry:
  %canary = alloca i32
  store i32 1755693922, i32* %canary
  %len.addr = alloca i32, align 4
  %nalu = alloca %struct.NALU_t*, align 8
  %PPS_id.addr = alloca i32, align 4
  store i32 %len, i32* %len.addr, align 4
...
entry:
  ...
  %nalu = alloca %struct.NALU_t*, align 8
  %canary = alloca i32
  store i32 1630155172, i32* %canary
  %i = alloca i32, align 4
  %total_pps = alloca i32, align 4
  %len = alloca i32, align 4
  store i32 0, i32* %len, align 4
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 163143764, i32* %canary
  %len = alloca i32, align 4
  store i32 0, i32* %len, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %GenerateMultiplePPS = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 15
...
entry:
  %nalu = alloca %struct.NALU_t*, align 8
  %canary = alloca i32
  store i32 1667676468, i32* %canary
  %i = alloca i32, align 4
  %len = alloca i32, align 4
  %retval = alloca i32, align 4
  %total_pps = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1139427293, i32* %canary
  %retval = alloca i32, align 4
  %total_pps = alloca i32, align 4
  %i = alloca i32, align 4
  %len = alloca i32, align 4
...
entry:
  %nalu = alloca %struct.NALU_t*, align 8
  %canary = alloca i32
  store i32 291388911, i32* %canary
  %PPS_id.addr = alloca i32, align 4
  %len.addr = alloca i32, align 4
  store i32 %len, i32* %len.addr, align 4
  store i32 %PPS_id, i32* %PPS_id.addr, align 4
...
entry:
  ...
  %len.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 458065596, i32* %canary
  %nalu = alloca %struct.NALU_t*, align 8
  store i32 %len, i32* %len.addr, align 4
  store i32 %PPS_id, i32* %PPS_id.addr, align 4
  store %struct.NALU_t* null, %struct.NALU_t** %nalu, align 8
...
entry:
  %canary = alloca i32
  store i32 1422726449, i32* %canary
  %total_pps = alloca i32, align 4
  %nalu = alloca %struct.NALU_t*, align 8
  %i = alloca i32, align 4
  %len = alloca i32, align 4
...
entry:
  %nalu = alloca %struct.NALU_t*, align 8
  %canary = alloca i32
  store i32 368135006, i32* %canary
  %len.addr = alloca i32, align 4
  %PPS_id.addr = alloca i32, align 4
  store i32 %len, i32* %len.addr, align 4
  store i32 %PPS_id, i32* %PPS_id.addr, align 4
...
entry:
  ...
  %PPS_id.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1593462173, i32* %canary
  %nalu = alloca %struct.NALU_t*, align 8
  store i32 %len, i32* %len.addr, align 4
  store i32 %PPS_id, i32* %PPS_id.addr, align 4
  store %struct.NALU_t* null, %struct.NALU_t** %nalu, align 8
