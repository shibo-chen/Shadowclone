; ModuleID = 'q_offsets.c.rand.4R2.bc'
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_CheckOffsetParameterName.5, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_CheckOffsetParameterName.11, label %func_CheckOffsetParameterName.12
}
...
func_ParseQOffsetMatrix.7:                        ; preds = %ctrl0
  call void @ParseQOffsetMatrix.7(i8* %buf, i32 %bufsize)
  ret void

func_ParseQOffsetMatrix.14:                       ; preds = %ctrl1
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_ParseQOffsetMatrix.7, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_ParseQOffsetMatrix.14, label %func_ParseQOffsetMatrix.16
}
...
func_CalculateOffsetParam.8:                      ; preds = %ctrl0
  call void @CalculateOffsetParam.8()
  ret void

func_CalculateOffsetParam.10:                     ; preds = %ctrl1
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_CalculateOffsetParam.8, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_CalculateOffsetParam.10, label %func_CalculateOffsetParam.15
}
...
func_CalculateOffset8Param.13:                    ; preds = %ctrl1
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_CalculateOffset8Param.9, label %func_CalculateOffset8Param.13
}
...
entry:
  ...
  %canary = alloca i32
  store i32 405878395, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1818712917, i32* %canary
  %i = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 2061658478, i32* %canary
  %j = alloca i32, align 4
  %i = alloca i32, align 4
  %q_bits = alloca i32, align 4
  %temp = alloca i32, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 1858426463, i32* %canary
  %k = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %OffsetMatrixPresentFlag = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 147
  %1 = load i32, i32* %OffsetMatrixPresentFlag, align 8
...
if.end225:                                        ; preds = %for.end224, %for.end102
  ...
  %133 = icmp eq i32 %132, 1858426463
...
entry:
  %canary = alloca i32
  store i32 1560603235, i32* %canary
  %retval = alloca i32, align 4
  %s.addr = alloca i8*, align 8
  %type.addr = alloca i32*, align 8
  %i = alloca i32, align 4
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 2045128148, i32* %canary
  %p = alloca i8*, align 8
...
entry:
  ...
  %buf.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1750021988, i32* %canary
  %bufend = alloca i8*, align 8
  %cnt = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %bufsize, i32* %bufsize.addr, align 4
...
entry:
  ...
  %qp_per = alloca i32, align 4
  %canary = alloca i32
  store i32 972845768, i32* %canary
  %k = alloca i32, align 4
  %temp = alloca i32, align 4
  %j = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
entry:
  ...
  %k = alloca i32, align 4
  %canary = alloca i32
  store i32 2042068009, i32* %canary
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %temp = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 220052556, i32* %canary
  %qp_per = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %OffsetMatrixPresentFlag = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 147
  %1 = load i32, i32* %OffsetMatrixPresentFlag, align 8
...
entry:
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1398045183, i32* %canary
  %i = alloca i32, align 4
  %type.addr = alloca i32*, align 8
  %s.addr = alloca i8*, align 8
  store i8* %s, i8** %s.addr, align 8
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1317468203, i32* %canary
  %s.addr = alloca i8*, align 8
  %type.addr = alloca i32*, align 8
  store i8* %s, i8** %s.addr, align 8
  store i32* %type, i32** %type.addr, align 8
...
entry:
  ...
  %k = alloca i32, align 4
  %canary = alloca i32
  store i32 1381727649, i32* %canary
  %temp = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %OffsetMatrixPresentFlag = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 147
  %1 = load i32, i32* %OffsetMatrixPresentFlag, align 8
...
entry:
  ...
  %OffsetList = alloca i16*, align 8
  %canary = alloca i32
  store i32 825035691, i32* %canary
  %j = alloca i32, align 4
  %InItem = alloca i32, align 4
  %p = alloca i8*, align 8
  %bufend = alloca i8*, align 8
...
entry:
  %canary = alloca i32
  store i32 239664390, i32* %canary
  %temp = alloca i32, align 4
  %qp_per = alloca i32, align 4
  %i = alloca i32, align 4
  %k = alloca i32, align 4
...
entry:
  ...
  %items = alloca [1000 x i8*], align 16
  %canary = alloca i32
  store i32 1551658956, i32* %canary
  %bufend = alloca i8*, align 8
  %i = alloca i32, align 4
  %p = alloca i8*, align 8
  %range = alloca i32, align 4
