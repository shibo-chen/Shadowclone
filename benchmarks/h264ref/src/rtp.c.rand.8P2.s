...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$16, %rsp
	movl	$962954698, -12(%rbp)   # imm = 0x396585CA
	movl	%edi, -8(%rbp)
...
.LBB6_5:                                # %return
	cmpl	$962954698, -12(%rbp)   # imm = 0x396585CA
	jne	.LBB6_7
.LBB6_6:
	addq	$16, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$776770903, -36(%rbp)   # imm = 0x2E4C9557
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movl	$-1, -40(%rbp)
	movq	-32(%rbp), %rdi
...
.LBB7_7:                                # %return
	movl	-12(%rbp), %ebx
	cmpl	$776770903, -36(%rbp)   # imm = 0x2E4C9557
	jne	.LBB7_9
.LBB7_8:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$721876731, -40(%rbp)   # imm = 0x2B06F6FB
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movl	$-1, -36(%rbp)
	movq	-32(%rbp), %rdi
...
.LBB8_7:                                # %return
	movl	-12(%rbp), %ebx
	cmpl	$721876731, -40(%rbp)   # imm = 0x2B06F6FB
	jne	.LBB8_9
.LBB8_8:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$16, %rsp
	movl	$75568372, -12(%rbp)    # imm = 0x48114F4
	movl	%edi, -8(%rbp)
	cmpl	$-1, RTPUpdateTimestamp.oldtr
	jne	.LBB9_2
# %bb.1:                                # %if.then
...
.LBB9_4:                                # %if.end3
	...
	movl	%eax, RTPUpdateTimestamp.oldtr
.LBB9_5:                                # %return
	cmpl	$75568372, -12(%rbp)    # imm = 0x48114F4
	jne	.LBB9_7
.LBB9_6:
	addq	$16, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$2041926349, -28(%rbp)  # imm = 0x79B552CD
	movq	%rdi, -24(%rbp)
	movq	-24(%rbp), %rax
	movl	20(%rax), %eax
	shll	$7, %eax
...
.LBB10_10:                              # %if.end32
	...
	movl	4(%rax), %ebx
	shll	$3, %ebx
	cmpl	$2041926349, -28(%rbp)  # imm = 0x79B552CD
	jne	.LBB10_12
.LBB10_11:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$673655619, -36(%rbp)   # imm = 0x28272B43
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movl	$-1, -40(%rbp)
	movq	-32(%rbp), %rdi
...
.LBB11_7:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$673655619, -36(%rbp)   # imm = 0x28272B43
	jne	.LBB11_9
.LBB11_8:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$2049771285, -40(%rbp)  # imm = 0x7A2D0715
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movl	$-1, -36(%rbp)
	movq	-32(%rbp), %rdi
...
.LBB12_7:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$2049771285, -40(%rbp)  # imm = 0x7A2D0715
	jne	.LBB12_9
.LBB12_8:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$2123823067, -28(%rbp)  # imm = 0x7E96F7DB
	movq	%rdi, -24(%rbp)
	movq	-24(%rbp), %rax
	movl	20(%rax), %eax
	shll	$7, %eax
...
.LBB13_10:                              # %if.end32
	...
	movl	4(%rax), %ebx
	shll	$3, %ebx
	cmpl	$2123823067, -28(%rbp)  # imm = 0x7E96F7DB
	jne	.LBB13_12
.LBB13_11:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$1475849863, -40(%rbp)  # imm = 0x57F7AE87
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movl	$-1, -36(%rbp)
	movq	-32(%rbp), %rdi
...
.LBB14_7:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$1475849863, -40(%rbp)  # imm = 0x57F7AE87
	jne	.LBB14_9
.LBB14_8:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$1135467811, -40(%rbp)  # imm = 0x43ADDD23
	movq	%rdi, -24(%rbp)
	movq	%rsi, -32(%rbp)
	movl	$-1, -36(%rbp)
	movq	-24(%rbp), %rdi
...
.LBB15_7:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$1135467811, -40(%rbp)  # imm = 0x43ADDD23
	jne	.LBB15_9
.LBB15_8:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$1398591292, -36(%rbp)  # imm = 0x535CCF3C
	movq	%rdi, -24(%rbp)
	movq	%rsi, -32(%rbp)
	movl	$-1, -40(%rbp)
	movq	-24(%rbp), %rdi
...
.LBB16_7:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$1398591292, -36(%rbp)  # imm = 0x535CCF3C
	jne	.LBB16_9
.LBB16_8:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$1253330816, -40(%rbp)  # imm = 0x4AB44F80
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movl	$-1, -36(%rbp)
	movq	-32(%rbp), %rdi
...
.LBB17_7:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$1253330816, -40(%rbp)  # imm = 0x4AB44F80
	jne	.LBB17_9
.LBB17_8:
	movl	%ebx, %eax
	addq	$40, %rsp
