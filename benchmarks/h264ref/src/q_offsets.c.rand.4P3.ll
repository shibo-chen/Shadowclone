; ModuleID = 'q_offsets.c.rand.4P3.bc'
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_CheckOffsetParameterName.12, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_CheckOffsetParameterName.13, label %func_CheckOffsetParameterName.16
}
...
func_ParseQOffsetMatrix.9:                        ; preds = %ctrl0
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_ParseQOffsetMatrix.9, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_ParseQOffsetMatrix.10, label %func_ParseQOffsetMatrix.15
}
...
func_CalculateOffsetParam.7:                      ; preds = %ctrl0
...
func_CalculateOffsetParam.14:                     ; preds = %ctrl1
  call void @CalculateOffsetParam.14()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_CalculateOffsetParam.7, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_CalculateOffsetParam.11, label %func_CalculateOffsetParam.14
}
...
func_CalculateOffset8Param.4:                     ; preds = %ctrl1
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_CalculateOffset8Param.4, label %func_CalculateOffset8Param.5
}
...
entry:
  ...
  %canary = alloca i32
  store i32 1364878705, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1331285152, i32* %canary
  %i = alloca i32, align 4
...
entry:
  ...
  %k = alloca i32, align 4
  %canary = alloca i32
  store i32 2042254218, i32* %canary
  %j = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %OffsetMatrixPresentFlag = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 147
  %1 = load i32, i32* %OffsetMatrixPresentFlag, align 8
...
entry:
  %canary = alloca i32
  store i32 769678280, i32* %canary
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %k = alloca i32, align 4
  %q_bits = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1358627144, i32* %canary
  %j = alloca i32, align 4
  %temp = alloca i32, align 4
  %q_bits = alloca i32, align 4
  %k = alloca i32, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 1478715291, i32* %canary
  %temp = alloca i32, align 4
  %k = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %OffsetMatrixPresentFlag = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 147
...
if.end225:                                        ; preds = %for.end224, %for.end102
  ...
  %133 = icmp eq i32 %132, 1478715291
...
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 865180211, i32* %canary
  %j = alloca i32, align 4
  %k = alloca i32, align 4
  %qp_per = alloca i32, align 4
  %temp = alloca i32, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 1852589000, i32* %canary
...
entry:
  ...
  %bufsize.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1391170844, i32* %canary
  %bufend = alloca i8*, align 8
  %i = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %cnt = alloca i32, align 4
...
entry:
  ...
  %bufend = alloca i8*, align 8
  %canary = alloca i32
  store i32 812134301, i32* %canary
  %OffsetList = alloca i16*, align 8
  %bufsize.addr = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %bufsize, i32* %bufsize.addr, align 4
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 661441994, i32* %canary
  %temp = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %OffsetMatrixPresentFlag = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 147
  %1 = load i32, i32* %OffsetMatrixPresentFlag, align 8
...
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 486566729, i32* %canary
  %type.addr = alloca i32*, align 8
  %retval = alloca i32, align 4
  %s.addr = alloca i8*, align 8
  store i8* %s, i8** %s.addr, align 8
...
entry:
  ...
  %s.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1420868274, i32* %canary
  %i = alloca i32, align 4
  store i8* %s, i8** %s.addr, align 8
  store i32* %type, i32** %type.addr, align 8
  store i32 0, i32* %i, align 4
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1672291195, i32* %canary
  %k = alloca i32, align 4
  %qp_per = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %OffsetMatrixPresentFlag = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 147
...
if.end225:                                        ; preds = %for.end224, %for.end102
  %132 = load i32, i32* %canary
  %133 = icmp eq i32 %132, 1672291195
  br i1 %133, label %134, label %func_exit
...
entry:
  ...
  %InItem = alloca i32, align 4
  %canary = alloca i32
  store i32 1191118410, i32* %canary
  %MapIdx = alloca i32, align 4
  %InString = alloca i32, align 4
  %OffsetList = alloca i16*, align 8
  %items = alloca [1000 x i8*], align 16
...
entry:
  %canary = alloca i32
  store i32 184509203, i32* %canary
  %s.addr = alloca i8*, align 8
  %i = alloca i32, align 4
  %type.addr = alloca i32*, align 8
  %retval = alloca i32, align 4
