...
# %bb.1:                                # %func_ParseQOffsetMatrix.5
	...
	.cfi_def_cfa %rsp, 8
	retq
.LBB1_2:                                # %func_ParseQOffsetMatrix.12
	.cfi_def_cfa %rbp, 16
	movq	%rbx, %rdi
	movl	%r14d, %esi
...
# %bb.1:                                # %func_CalculateOffsetParam.4
	...
	.cfi_def_cfa %rsp, 8
	retq
.LBB3_2:                                # %func_CalculateOffsetParam.10
	.cfi_def_cfa %rbp, 16
...
.LBB3_3:                                # %func_CalculateOffsetParam.11
	...
	.cfi_def_cfa %rsp, 8
	retq
.LBB3_4:                                # %func_CalculateOffsetParam.13
	.cfi_def_cfa %rbp, 16
...
# %bb.1:                                # %func_CalculateOffset8Param.1
	...
	.cfi_def_cfa %rsp, 8
	retq
.LBB4_2:                                # %func_CalculateOffset8Param.6
	.cfi_def_cfa %rbp, 16
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1176386628, -24(%rbp)  # imm = 0x461E3C44
	movq	input, %rax
	cmpl	$0, 3584(%rax)
	je	.LBB5_17
# %bb.1:                                # %if.then
...
.LBB5_32:                               # %for.end104
	jmp	.LBB5_33
.LBB5_33:                               # %if.end105
	cmpl	$1176386628, -24(%rbp)  # imm = 0x461E3C44
	jne	.LBB5_35
.LBB5_34:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$106560567, -20(%rbp)   # imm = 0x659FC37
	movq	%rdi, -40(%rbp)
	movq	%rsi, -32(%rbp)
	movl	$0, -12(%rbp)
	movq	-32(%rbp), %rax
...
.LBB6_17:                               # %return
	movl	-16(%rbp), %ebx
	cmpl	$106560567, -20(%rbp)   # imm = 0x659FC37
	jne	.LBB6_19
.LBB6_18:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$891385601, -20(%rbp)   # imm = 0x35217701
	movq	%rdi, -32(%rbp)
	movq	%rsi, -40(%rbp)
	movl	$0, -12(%rbp)
	movq	-40(%rbp), %rax
...
.LBB7_17:                               # %return
	movl	-16(%rbp), %ebx
	cmpl	$891385601, -20(%rbp)   # imm = 0x35217701
	jne	.LBB7_19
.LBB7_18:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1789450847, -24(%rbp)  # imm = 0x6AA8DA5F
	movq	input, %rax
	cmpl	$0, 3584(%rax)
	je	.LBB8_17
# %bb.1:                                # %if.then
...
.LBB8_32:                               # %for.end224
	jmp	.LBB8_33
.LBB8_33:                               # %if.end225
	cmpl	$1789450847, -24(%rbp)  # imm = 0x6AA8DA5F
	jne	.LBB8_35
.LBB8_34:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	movl	$852643518, -52(%rbp)   # imm = 0x32D24EBE
	movq	%rdi, -72(%rbp)
	movl	%esi, -56(%rbp)
	movl	$0, -32(%rbp)
	movl	$0, -36(%rbp)
...
# %bb.41:                               # %for.inc96
	...
	jmp	.LBB9_26
.LBB9_42:                               # %for.end98
	cmpl	$852643518, -52(%rbp)   # imm = 0x32D24EBE
	jne	.LBB9_44
.LBB9_43:
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$99546735, -24(%rbp)    # imm = 0x5EEF66F
	movq	input, %rax
	cmpl	$0, 3584(%rax)
	je	.LBB10_17
# %bb.1:                                # %if.then
...
.LBB10_32:                              # %for.end104
	jmp	.LBB10_33
.LBB10_33:                              # %if.end105
	cmpl	$99546735, -24(%rbp)    # imm = 0x5EEF66F
	jne	.LBB10_35
.LBB10_34:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$577169337, -24(%rbp)   # imm = 0x2266E7B9
	movq	input, %rax
	cmpl	$0, 3584(%rax)
	je	.LBB11_17
# %bb.1:                                # %if.then
...
.LBB11_32:                              # %for.end104
	jmp	.LBB11_33
.LBB11_33:                              # %if.end105
	cmpl	$577169337, -24(%rbp)   # imm = 0x2266E7B9
	jne	.LBB11_35
.LBB11_34:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1312964545, -24(%rbp)  # imm = 0x4E423FC1
	movq	input, %rax
	cmpl	$0, 3584(%rax)
	je	.LBB12_17
# %bb.1:                                # %if.then
...
.LBB12_32:                              # %for.end104
	jmp	.LBB12_33
.LBB12_33:                              # %if.end105
	cmpl	$1312964545, -24(%rbp)  # imm = 0x4E423FC1
	jne	.LBB12_35
.LBB12_34:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$459532586, -20(%rbp)   # imm = 0x1B63E92A
	movq	%rdi, -32(%rbp)
	movq	%rsi, -40(%rbp)
	movl	$0, -12(%rbp)
	movq	-40(%rbp), %rax
...
.LBB13_17:                              # %return
	movl	-16(%rbp), %ebx
	cmpl	$459532586, -20(%rbp)   # imm = 0x1B63E92A
	jne	.LBB13_19
.LBB13_18:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$633686680, -24(%rbp)   # imm = 0x25C54A98
	movq	input, %rax
	cmpl	$0, 3584(%rax)
	je	.LBB14_17
# %bb.1:                                # %if.then
...
.LBB14_32:                              # %for.end224
	jmp	.LBB14_33
.LBB14_33:                              # %if.end225
	cmpl	$633686680, -24(%rbp)   # imm = 0x25C54A98
	jne	.LBB14_35
.LBB14_34:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1041775343, -24(%rbp)  # imm = 0x3E183AEF
	movq	input, %rax
	cmpl	$0, 3584(%rax)
	je	.LBB15_17
# %bb.1:                                # %if.then
...
.LBB15_32:                              # %for.end224
	jmp	.LBB15_33
.LBB15_33:                              # %if.end225
	cmpl	$1041775343, -24(%rbp)  # imm = 0x3E183AEF
	jne	.LBB15_35
.LBB15_34:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$8096, %rsp             # imm = 0x1FA0
	movl	$1209556459, -56(%rbp)  # imm = 0x48185DEB
	movq	%rdi, -88(%rbp)
	movl	%esi, -52(%rbp)
	movl	$0, -32(%rbp)
	movl	$0, -36(%rbp)
...
# %bb.41:                               # %for.inc96
	...
	jmp	.LBB16_26
.LBB16_42:                              # %for.end98
	cmpl	$1209556459, -56(%rbp)  # imm = 0x48185DEB
	jne	.LBB16_44
.LBB16_43:
	addq	$8096, %rsp             # imm = 0x1FA0
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1101048970, -24(%rbp)  # imm = 0x41A0AC8A
	movq	input, %rax
	cmpl	$0, 3584(%rax)
	je	.LBB17_17
# %bb.1:                                # %if.then
...
.LBB17_32:                              # %for.end224
	jmp	.LBB17_33
.LBB17_33:                              # %if.end225
	cmpl	$1101048970, -24(%rbp)  # imm = 0x41A0AC8A
	jne	.LBB17_35
.LBB17_34:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$1942544729, -20(%rbp)  # imm = 0x73C8E159
	movq	%rdi, -40(%rbp)
	movq	%rsi, -32(%rbp)
	movl	$0, -12(%rbp)
	movq	-32(%rbp), %rax
...
.LBB18_17:                              # %return
	movl	-16(%rbp), %ebx
	cmpl	$1942544729, -20(%rbp)  # imm = 0x73C8E159
	jne	.LBB18_19
.LBB18_18:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$8096, %rsp             # imm = 0x1FA0
	movl	$1853417124, -60(%rbp)  # imm = 0x6E78E6A4
	movq	%rdi, -88(%rbp)
	movl	%esi, -52(%rbp)
	movl	$0, -28(%rbp)
	movl	$0, -36(%rbp)
...
# %bb.41:                               # %for.inc96
	...
	jmp	.LBB19_26
.LBB19_42:                              # %for.end98
	cmpl	$1853417124, -60(%rbp)  # imm = 0x6E78E6A4
	jne	.LBB19_44
.LBB19_43:
	addq	$8096, %rsp             # imm = 0x1FA0
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$8096, %rsp             # imm = 0x1FA0
	movl	$447695191, -56(%rbp)   # imm = 0x1AAF4957
	movq	%rdi, -80(%rbp)
	movl	%esi, -48(%rbp)
	movl	$0, -28(%rbp)
	movl	$0, -36(%rbp)
...
# %bb.41:                               # %for.inc96
	...
	jmp	.LBB20_26
.LBB20_42:                              # %for.end98
	cmpl	$447695191, -56(%rbp)   # imm = 0x1AAF4957
	jne	.LBB20_44
.LBB20_43:
	addq	$8096, %rsp             # imm = 0x1FA0
	popq	%rbp
