; ModuleID = 'decoder.c.rand.4P2.bc'
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_decode_one_b8block.2, label %ctrl0

func_decode_one_b8block.2:                        ; preds = %rand_bb
  call void @decode_one_b8block.2(i32 %decoder, i32 %mbmode, i32 %b8block, i32 %b8mode, i32 %b8ref)
  ret void

func_decode_one_b8block.3:                        ; preds = %ctrl0
  call void @decode_one_b8block.3(i32 %decoder, i32 %mbmode, i32 %b8block, i32 %b8mode, i32 %b8ref)
  ret void

func_decode_one_b8block.6:                        ; preds = %ctrl1
  call void @decode_one_b8block.6(i32 %decoder, i32 %mbmode, i32 %b8block, i32 %b8mode, i32 %b8ref)
  ret void

func_decode_one_b8block.11:                       ; preds = %ctrl1
  call void @decode_one_b8block.11(i32 %decoder, i32 %mbmode, i32 %b8block, i32 %b8mode, i32 %b8ref)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_decode_one_b8block.3, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_decode_one_b8block.6, label %func_decode_one_b8block.11
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_Get_Reference_Block.14, label %ctrl0

func_Get_Reference_Block.14:                      ; preds = %rand_bb
  call void @Get_Reference_Block.14(i16** %imY, i32 %block_y, i32 %block_x, i32 %mvhor, i32 %mvver, i16** %out)
  ret void

func_Get_Reference_Block.18:                      ; preds = %ctrl0
  call void @Get_Reference_Block.18(i16** %imY, i32 %block_y, i32 %block_x, i32 %mvhor, i32 %mvver, i16** %out)
  ret void

func_Get_Reference_Block.24:                      ; preds = %ctrl1
  call void @Get_Reference_Block.24(i16** %imY, i32 %block_y, i32 %block_x, i32 %mvhor, i32 %mvver, i16** %out)
  ret void

func_Get_Reference_Block.26:                      ; preds = %ctrl1
  call void @Get_Reference_Block.26(i16** %imY, i32 %block_y, i32 %block_x, i32 %mvhor, i32 %mvver, i16** %out)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_Get_Reference_Block.18, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_Get_Reference_Block.24, label %func_Get_Reference_Block.26
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_decode_one_mb.7, label %func_decode_one_mb.15
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_Get_Reference_Pixel.9, label %ctrl0

func_Get_Reference_Pixel.9:                       ; preds = %rand_bb
  %2 = call i8 @Get_Reference_Pixel.9(i16** %imY, i32 %y_pos, i32 %x_pos)
  ret i8 %2

func_Get_Reference_Pixel.21:                      ; preds = %ctrl0
  %3 = call i8 @Get_Reference_Pixel.21(i16** %imY, i32 %y_pos, i32 %x_pos)
  ret i8 %3

func_Get_Reference_Pixel.30:                      ; preds = %ctrl1
  %4 = call i8 @Get_Reference_Pixel.30(i16** %imY, i32 %y_pos, i32 %x_pos)
  ret i8 %4

func_Get_Reference_Pixel.31:                      ; preds = %ctrl1
  %5 = call i8 @Get_Reference_Pixel.31(i16** %imY, i32 %y_pos, i32 %x_pos)
  ret i8 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_Get_Reference_Pixel.21, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_Get_Reference_Pixel.30, label %func_Get_Reference_Pixel.31
}
...
func_Build_Status_Map.22:                         ; preds = %ctrl1
  call void @Build_Status_Map.22(i8** %s_map)
  ret void
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_Build_Status_Map.19, label %func_Build_Status_Map.22
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_Error_Concealment.28, label %ctrl0

func_Error_Concealment.28:                        ; preds = %rand_bb
  call void @Error_Concealment.28(i16** %inY, i8** %s_map, i16*** %refY)
  ret void

func_Error_Concealment.29:                        ; preds = %ctrl0
  call void @Error_Concealment.29(i16** %inY, i8** %s_map, i16*** %refY)
  ret void

func_Error_Concealment.33:                        ; preds = %ctrl1
  call void @Error_Concealment.33(i16** %inY, i8** %s_map, i16*** %refY)
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_Error_Concealment.29, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_Error_Concealment.33, label %func_Error_Concealment.34
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_DecOneForthPix.4, label %ctrl0

func_DecOneForthPix.4:                            ; preds = %rand_bb
  call void @DecOneForthPix.4(i16** %dY, i16*** %dref)
  ret void

func_DecOneForthPix.17:                           ; preds = %ctrl0
  call void @DecOneForthPix.17(i16** %dY, i16*** %dref)
  ret void

func_DecOneForthPix.20:                           ; preds = %ctrl1
  call void @DecOneForthPix.20(i16** %dY, i16*** %dref)
  ret void

func_DecOneForthPix.32:                           ; preds = %ctrl1
  call void @DecOneForthPix.32(i16** %dY, i16*** %dref)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_DecOneForthPix.17, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_DecOneForthPix.20, label %func_DecOneForthPix.32
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_compute_residue_b8block.5, label %ctrl0

func_compute_residue_b8block.5:                   ; preds = %rand_bb
  call void @compute_residue_b8block.5(i32 %b8block, i32 %i16mode)
  ret void

func_compute_residue_b8block.10:                  ; preds = %ctrl0
  call void @compute_residue_b8block.10(i32 %b8block, i32 %i16mode)
  ret void

func_compute_residue_b8block.13:                  ; preds = %ctrl1
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_compute_residue_b8block.10, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_compute_residue_b8block.13, label %func_compute_residue_b8block.25
}
...
func_Conceal_Error.16:                            ; preds = %ctrl0
  call void @Conceal_Error.16(i16** %inY, i32 %mb_y, i32 %mb_x, i16*** %refY, i8** %s_map)
  ret void

func_Conceal_Error.23:                            ; preds = %ctrl1
  call void @Conceal_Error.23(i16** %inY, i32 %mb_y, i32 %mb_x, i16*** %refY, i8** %s_map)
  ret void

func_Conceal_Error.27:                            ; preds = %ctrl1
  call void @Conceal_Error.27(i16** %inY, i32 %mb_y, i32 %mb_x, i16*** %refY, i8** %s_map)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_Conceal_Error.16, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_Conceal_Error.23, label %func_Conceal_Error.27
}
...
entry:
  %canary = alloca i32
  store i32 971404318, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @decode_one_b8block.2(i32 %decoder, i32 %mbmode, i32 %b8block, i32 %b8mode, i32 %b8ref) #0 {
entry:
  %j = alloca i32, align 4
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1851495452, i32* %canary
...
if.end315:                                        ; preds = %if.end314, %for.end28
  ...
  %242 = icmp eq i32 %241, 1851495452
...
entry:
  ...
  %b8block.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 816295246, i32* %canary
  %bx = alloca i32, align 4
  %mbmode.addr = alloca i32, align 4
  %j = alloca i32, align 4
  %mv = alloca [2 x [4 x [4 x i32]]], align 16
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @DecOneForthPix.4(i16** %dY, i16*** %dref) #0 {
entry:
  %canary = alloca i32
  store i32 933921461, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @compute_residue_b8block.5(i32 %b8block, i32 %i16mode) #0 {
entry:
  %j0 = alloca i32, align 4
  %j1 = alloca i32, align 4
  %j = alloca i32, align 4
  ...
  %i1 = alloca i32, align 4
  %canary = alloca i32
  store i32 940327402, i32* %canary
  %i = alloca i32, align 4
  %b8block.addr = alloca i32, align 4
  %i16mode.addr = alloca i32, align 4
  store i32 %b8block, i32* %b8block.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @decode_one_b8block.6(i32 %decoder, i32 %mbmode, i32 %b8block, i32 %b8mode, i32 %b8ref) #0 {
entry:
  %bx1 = alloca i32, align 4
  %decoder.addr = alloca i32, align 4
  %j = alloca i32, align 4
  ...
  %j1 = alloca i32, align 4
  %canary = alloca i32
  store i32 1723360161, i32* %canary
  %b8mode.addr = alloca i32, align 4
  %mbmode.addr = alloca i32, align 4
  %i1 = alloca i32, align 4
  %by = alloca i32, align 4
...
if.end315:                                        ; preds = %if.end314, %for.end28
  %241 = load i32, i32* %canary
  %242 = icmp eq i32 %241, 1723360161
  br i1 %242, label %243, label %func_exit
...
entry:
  %canary = alloca i32
  store i32 1350757187, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 650400230, i32* %canary
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local zeroext i8 @Get_Reference_Pixel.9(i16** %imY, i32 %y_pos, i32 %x_pos) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 2123351971, i32* %canary
...
if.end926:                                        ; preds = %if.end925, %cond.end31
  ...
  %438 = icmp eq i32 %437, 2123351971
...
entry:
  %canary = alloca i32
  store i32 1003611622, i32* %canary
  %j = alloca i32, align 4
  %i0 = alloca i32, align 4
  %i = alloca i32, align 4
  %b8block.addr = alloca i32, align 4
...
entry:
  ...
  %mbmode.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 758581414, i32* %canary
  %by0 = alloca i32, align 4
  %bx0 = alloca i32, align 4
  store i32 %decoder, i32* %decoder.addr, align 4
  store i32 %mbmode, i32* %mbmode.addr, align 4
...
entry:
  ...
  %s_map.addr = alloca i8**, align 8
  %canary = alloca i32
  store i32 2111970530, i32* %canary
  %mb = alloca i32, align 4
  store i8** %s_map, i8*** %s_map.addr, align 8
  store i32 -1, i32* %slice, align 4
  store i32 0, i32* %mb, align 4
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1639261674, i32* %canary
  %j0 = alloca i32, align 4
  store i32 %b8block, i32* %b8block.addr, align 4
  store i32 %i16mode, i32* %i16mode.addr, align 4
  %0 = load i32, i32* %b8block.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Get_Reference_Block.14(i16** %imY, i32 %block_y, i32 %block_x, i32 %mvhor, i32 %mvver, i16** %out) #0 {
entry:
  %mvhor.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 196767766, i32* %canary
...
entry:
  %decoder.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1203766607, i32* %canary
  %currMB.addr = alloca %struct.macroblock*, align 8
  store i32 %decoder, i32* %decoder.addr, align 4
  store %struct.macroblock* %currMB, %struct.macroblock** %currMB.addr, align 8
  %0 = load i32, i32* %canary
  %1 = icmp eq i32 %0, 1203766607
  br i1 %1, label %2, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Conceal_Error.16(i16** %inY, i32 %mb_y, i32 %mb_x, i16*** %refY, i8** %s_map) #0 {
entry:
  %block_y = alloca i32, align 4
  %refY.addr = alloca i16***, align 8
  %j = alloca i32, align 4
  ...
  %ref_inx = alloca i32, align 4
  %canary = alloca i32
  store i32 881074227, i32* %canary
  %resY = alloca [16 x [16 x i32]], align 16
  %mv = alloca [2 x [4 x [4 x i32]]], align 16
  store i16** %inY, i16*** %inY.addr, align 8
  store i32 %mb_y, i32* %mb_y.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @DecOneForthPix.17(i16** %dY, i16*** %dref) #0 {
entry:
  %dref.addr = alloca i16***, align 8
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 738584973, i32* %canary
  %ref = alloca i32, align 4
  %dY.addr = alloca i16**, align 8
  store i16** %dY, i16*** %dY.addr, align 8
  store i16*** %dref, i16**** %dref.addr, align 8
...
entry:
  ...
  %out.addr = alloca i16**, align 8
  %canary = alloca i32
  store i32 1721531204, i32* %canary
  %block_x.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %mvhor.addr = alloca i32, align 4
  %imY.addr = alloca i16**, align 8
...
entry:
  ...
  %slice = alloca i32, align 4
  %canary = alloca i32
  store i32 1559417690, i32* %canary
  %j = alloca i32, align 4
  %ii = alloca i32, align 4
  %packet_lost = alloca i32, align 4
  %mb = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @DecOneForthPix.20(i16** %dY, i16*** %dref) #0 {
entry:
  %canary = alloca i32
  store i32 765069180, i32* %canary
  %dref.addr = alloca i16***, align 8
  %dY.addr = alloca i16**, align 8
  %j = alloca i32, align 4
  %ref = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local zeroext i8 @Get_Reference_Pixel.21(i16** %imY, i32 %y_pos, i32 %x_pos) #0 {
entry:
  %imY.addr = alloca i16**, align 8
  %x_pos.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 752858770, i32* %canary
  %result = alloca i32, align 4
  %y = alloca i32, align 4
  %result1 = alloca i32, align 4
  %result2 = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Build_Status_Map.22(i8** %s_map) #0 {
entry:
  %packet_lost = alloca i32, align 4
  %ii = alloca i32, align 4
  %mb = alloca i32, align 4
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 876095347, i32* %canary
  %jj = alloca i32, align 4
  store i8** %s_map, i8*** %s_map.addr, align 8
  store i32 -1, i32* %slice, align 4
  store i32 0, i32* %mb, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Conceal_Error.23(i16** %inY, i32 %mb_y, i32 %mb_x, i16*** %refY, i8** %s_map) #0 {
entry:
  %copy = alloca i32, align 4
  %resY = alloca [16 x [16 x i32]], align 16
  %tmp_mv = alloca i16***, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Get_Reference_Block.24(i16** %imY, i32 %block_y, i32 %block_x, i32 %mvhor, i32 %mvver, i16** %out) #0 {
entry:
  %canary = alloca i32
  store i32 822102221, i32* %canary
  %out.addr = alloca i16**, align 8
  %y = alloca i32, align 4
  %i = alloca i32, align 4
  %j = alloca i32, align 4
...
entry:
  %j0 = alloca i32, align 4
  %canary = alloca i32
  store i32 1735229634, i32* %canary
  %b8block.addr = alloca i32, align 4
  %j = alloca i32, align 4
  %j1 = alloca i32, align 4
  %i16mode.addr = alloca i32, align 4
...
entry:
  ...
  %x = alloca i32, align 4
  %canary = alloca i32
  store i32 1132145873, i32* %canary
  %mvhor.addr = alloca i32, align 4
  %imY.addr = alloca i16**, align 8
  %j = alloca i32, align 4
  store i16** %imY, i16*** %imY.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Conceal_Error.27(i16** %inY, i32 %mb_y, i32 %mb_x, i16*** %refY, i8** %s_map) #0 {
entry:
  %s_map.addr = alloca i8**, align 8
  %tmp_mv = alloca i16***, align 8
  %inY.addr = alloca i16**, align 8
  ...
  %mv = alloca [2 x [4 x [4 x i32]]], align 16
  %canary = alloca i32
  store i32 1459976542, i32* %canary
  %ref_inx = alloca i32, align 4
  %block_y = alloca i32, align 4
  %block_x = alloca i32, align 4
  %mb_y.addr = alloca i32, align 4
...
sw.epilog:                                        ; preds = %if.end545, %if.end487, %if.end321, %if.end, %land.end54
  %325 = load i32, i32* %canary
  %326 = icmp eq i32 %325, 1459976542
  br i1 %326, label %327, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Error_Concealment.28(i16** %inY, i8** %s_map, i16*** %refY) #0 {
entry:
  %inY.addr = alloca i16**, align 8
  %mb_x = alloca i32, align 4
  %canary = alloca i32
  store i32 1970698066, i32* %canary
...
entry:
  ...
  %mb_w = alloca i32, align 4
  %canary = alloca i32
  store i32 375249273, i32* %canary
  %refY.addr = alloca i16***, align 8
  %inY.addr = alloca i16**, align 8
  %mb_y = alloca i32, align 4
  %s_map.addr = alloca i8**, align 8
...
entry:
  ...
  %result1 = alloca i32, align 4
  %canary = alloca i32
  store i32 697087280, i32* %canary
  %pres_x = alloca i32, align 4
  %y_pos.addr = alloca i32, align 4
  %imY.addr = alloca i16**, align 8
  %maxold_x = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local zeroext i8 @Get_Reference_Pixel.31(i16** %imY, i32 %y_pos, i32 %x_pos) #0 {
entry:
  %y_pos.addr = alloca i32, align 4
  %x = alloca i32, align 4
  %imY.addr = alloca i16**, align 8
  %canary = alloca i32
  store i32 1023572325, i32* %canary
  %result2 = alloca i32, align 4
  %result = alloca i32, align 4
  %dx = alloca i32, align 4
  %maxold_x = alloca i32, align 4
...
if.end926:                                        ; preds = %if.end925, %cond.end31
  ...
  %conv927 = trunc i32 %436 to i8
  %437 = load i32, i32* %canary
  %438 = icmp eq i32 %437, 1023572325
  br i1 %438, label %439, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @DecOneForthPix.32(i16** %dY, i16*** %dref) #0 {
entry:
  %j = alloca i32, align 4
  %dref.addr = alloca i16***, align 8
  %canary = alloca i32
  store i32 959654687, i32* %canary
  %ref = alloca i32, align 4
  %dY.addr = alloca i16**, align 8
  store i16** %dY, i16*** %dY.addr, align 8
  store i16*** %dref, i16**** %dref.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Error_Concealment.33(i16** %inY, i8** %s_map, i16*** %refY) #0 {
entry:
  %mb_h = alloca i32, align 4
  %mb_y = alloca i32, align 4
  %inY.addr = alloca i16**, align 8
  ...
  %refY.addr = alloca i16***, align 8
  %canary = alloca i32
  store i32 1539775030, i32* %canary
  %mb_w = alloca i32, align 4
  store i16** %inY, i16*** %inY.addr, align 8
  store i8** %s_map, i8*** %s_map.addr, align 8
  store i16*** %refY, i16**** %refY.addr, align 8
...
entry:
  ...
  %mb_h = alloca i32, align 4
  %canary = alloca i32
  store i32 1780312193, i32* %canary
  %mb_y = alloca i32, align 4
  %s_map.addr = alloca i8**, align 8
  %mb_x = alloca i32, align 4
  store i16** %inY, i16*** %inY.addr, align 8
