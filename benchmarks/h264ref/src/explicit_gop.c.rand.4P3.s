...
.LBB0_2:                                # %func_create_pyramid.3
	...
	.cfi_def_cfa %rsp, 8
	retq
.LBB0_3:                                # %func_create_pyramid.9
	.cfi_def_cfa %rbp, 16
	callq	create_pyramid.9
	popq	%rbp
	.cfi_def_cfa %rsp, 8
	retq
.LBB0_4:                                # %func_create_pyramid.14
	.cfi_def_cfa %rbp, 16
...
# %bb.0:                                # %rand_bb
	...
	cmpl	$0, %eax
	jne	.LBB4_5
# %bb.1:                                # %func_interpret_gop_structure.4
	callq	interpret_gop_structure.4
	popq	%rbp
	.cfi_def_cfa %rsp, 8
	retq
.LBB4_2:                                # %func_interpret_gop_structure.12
	.cfi_def_cfa %rbp, 16
...
.LBB4_3:                                # %func_interpret_gop_structure.15
	...
	.cfi_def_cfa %rsp, 8
	retq
.LBB4_4:                                # %func_interpret_gop_structure.16
	.cfi_def_cfa %rbp, 16
...
.LBB6_2:                                # %func_poc_based_ref_management.8
	...
	.cfi_def_cfa %rsp, 8
	retq
.LBB6_3:                                # %func_poc_based_ref_management.10
	.cfi_def_cfa %rbp, 16
	movl	%ebx, %edi
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$48, %rsp
	movl	$1520100967, -40(%rbp)  # imm = 0x5A9AE667
	movl	%edi, -36(%rbp)
	movl	$0, -12(%rbp)
...
.LBB7_16:                               # %if.end27
	...
	movq	%rax, 72512(%rcx)
.LBB7_17:                               # %return
	cmpl	$1520100967, -40(%rbp)  # imm = 0x5A9AE667
	jne	.LBB7_19
.LBB7_18:
	addq	$48, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$2002540371, -60(%rbp)  # imm = 0x775C5753
	movq	input, %rax
	movl	1236(%rax), %eax
	cltd
	movl	$2, %ecx
...
.LBB8_37:                               # %for.end199
	jmp	.LBB8_38
.LBB8_38:                               # %if.end200
	cmpl	$2002540371, -60(%rbp)  # imm = 0x775C5753
	jne	.LBB8_40
.LBB8_39:
	addq	$64, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$1269189758, -60(%rbp)  # imm = 0x4BA64C7E
	movq	input, %rax
	movl	1236(%rax), %eax
	cltd
	movl	$2, %ecx
...
.LBB9_37:                               # %for.end199
	jmp	.LBB9_38
.LBB9_38:                               # %if.end200
	cmpl	$1269189758, -60(%rbp)  # imm = 0x4BA64C7E
	jne	.LBB9_40
.LBB9_39:
	addq	$64, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$48, %rsp
	movl	$135350522, -44(%rbp)   # imm = 0x81148FA
	movq	input, %rdi
...
.LBB10_65:                              # %if.end171
	...
	movq	input, %rcx
	movl	%eax, 1236(%rcx)
	cmpl	$135350522, -44(%rbp)   # imm = 0x81148FA
	jne	.LBB10_67
.LBB10_66:
	addq	$48, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1862480278, -28(%rbp)  # imm = 0x6F033196
	movl	%edi, -20(%rbp)
	movl	%esi, -4(%rbp)
	movl	%edx, -24(%rbp)
	movq	%rcx, -16(%rbp)
...
.LBB11_9:                               # %if.end32
	...
	callq	gop_pyramid
.LBB11_10:                              # %if.end42
	cmpl	$1862480278, -28(%rbp)  # imm = 0x6F033196
	jne	.LBB11_12
.LBB11_11:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1658657939, -28(%rbp)  # imm = 0x62DD1C93
	movl	%edi, -24(%rbp)
	movl	%esi, -4(%rbp)
	movl	%edx, -20(%rbp)
	movq	%rcx, -16(%rbp)
...
.LBB12_9:                               # %if.end32
	...
	callq	gop_pyramid
.LBB12_10:                              # %if.end42
	cmpl	$1658657939, -28(%rbp)  # imm = 0x62DD1C93
	jne	.LBB12_12
.LBB12_11:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$473779375, -28(%rbp)   # imm = 0x1C3D4CAF
	movl	%edi, -24(%rbp)
	movl	%esi, -4(%rbp)
	movl	%edx, -20(%rbp)
	movq	%rcx, -16(%rbp)
...
.LBB13_9:                               # %if.end32
	...
	callq	gop_pyramid
.LBB13_10:                              # %if.end42
	cmpl	$473779375, -28(%rbp)   # imm = 0x1C3D4CAF
	jne	.LBB13_12
.LBB13_11:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$48, %rsp
	movl	$1844036390, -40(%rbp)  # imm = 0x6DE9C326
	movl	%edi, -36(%rbp)
	movl	$0, -12(%rbp)
	movl	$2147483647, -8(%rbp)   # imm = 0x7FFFFFFF
	movq	img, %rax
...
.LBB14_16:                              # %if.end27
	...
	movq	%rax, 72512(%rcx)
.LBB14_17:                              # %return
	cmpl	$1844036390, -40(%rbp)  # imm = 0x6DE9C326
	jne	.LBB14_19
.LBB14_18:
	addq	$48, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$135659563, -60(%rbp)   # imm = 0x816002B
	movq	input, %rax
	movl	1236(%rax), %eax
	cltd
	movl	$2, %ecx
...
.LBB15_37:                              # %for.end199
	jmp	.LBB15_38
.LBB15_38:                              # %if.end200
	cmpl	$135659563, -60(%rbp)   # imm = 0x816002B
	jne	.LBB15_40
.LBB15_39:
	addq	$64, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$48, %rsp
	movl	$240715750, -36(%rbp)   # imm = 0xE5907E6
	movl	%edi, -40(%rbp)
	movl	$0, -8(%rbp)
...
.LBB16_16:                              # %if.end27
	...
	movq	%rax, 72512(%rcx)
.LBB16_17:                              # %return
	cmpl	$240715750, -36(%rbp)   # imm = 0xE5907E6
	jne	.LBB16_19
.LBB16_18:
	addq	$48, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$48, %rsp
	movl	$2059107040, -36(%rbp)  # imm = 0x7ABB7AE0
	movl	%edi, -40(%rbp)
	movl	$0, -12(%rbp)
	movl	$2147483647, -8(%rbp)   # imm = 0x7FFFFFFF
	movq	img, %rax
...
.LBB17_16:                              # %if.end27
	...
	movq	%rax, 72512(%rcx)
.LBB17_17:                              # %return
	cmpl	$2059107040, -36(%rbp)  # imm = 0x7ABB7AE0
	jne	.LBB17_19
.LBB17_18:
	addq	$48, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$48, %rsp
	movl	$932581191, -44(%rbp)   # imm = 0x37960F47
	movq	input, %rdi
	addq	$1324, %rdi             # imm = 0x52C
	callq	strlen
	movl	%eax, -32(%rbp)
...
.LBB18_65:                              # %if.end171
	...
	movq	input, %rcx
	movl	%eax, 1236(%rcx)
	cmpl	$932581191, -44(%rbp)   # imm = 0x37960F47
	jne	.LBB18_67
.LBB18_66:
	addq	$48, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$372248682, -28(%rbp)   # imm = 0x1630106A
	movl	%edi, -20(%rbp)
	movl	%esi, -4(%rbp)
	movl	%edx, -24(%rbp)
	movq	%rcx, -16(%rbp)
...
.LBB19_9:                               # %if.end32
	...
	callq	gop_pyramid
.LBB19_10:                              # %if.end42
	cmpl	$372248682, -28(%rbp)   # imm = 0x1630106A
	jne	.LBB19_12
.LBB19_11:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$1875199333, -60(%rbp)  # imm = 0x6FC54565
	movq	input, %rax
	movl	1236(%rax), %eax
	cltd
	movl	$2, %ecx
...
.LBB20_37:                              # %for.end199
	jmp	.LBB20_38
.LBB20_38:                              # %if.end200
	cmpl	$1875199333, -60(%rbp)  # imm = 0x6FC54565
	jne	.LBB20_40
.LBB20_39:
	addq	$64, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$48, %rsp
	movl	$701482882, -44(%rbp)   # imm = 0x29CFC782
	movq	input, %rdi
	addq	$1324, %rdi             # imm = 0x52C
	callq	strlen
	movl	%eax, -32(%rbp)
...
.LBB21_65:                              # %if.end171
	...
	movq	input, %rcx
	movl	%eax, 1236(%rcx)
	cmpl	$701482882, -44(%rbp)   # imm = 0x29CFC782
	jne	.LBB21_67
.LBB21_66:
	addq	$48, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$48, %rsp
	movl	$316941501, -44(%rbp)   # imm = 0x12E424BD
	movq	input, %rdi
	addq	$1324, %rdi             # imm = 0x52C
	callq	strlen
	movl	%eax, -40(%rbp)
...
.LBB22_65:                              # %if.end171
	...
	movq	input, %rcx
	movl	%eax, 1236(%rcx)
	cmpl	$316941501, -44(%rbp)   # imm = 0x12E424BD
	jne	.LBB22_67
.LBB22_66:
	addq	$48, %rsp
	popq	%rbp
