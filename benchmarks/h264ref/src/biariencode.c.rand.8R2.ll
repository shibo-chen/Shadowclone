; ModuleID = 'biariencode.c.rand.8R2.bc'
...
func_arienco_start_encoding.9:                    ; preds = %ctrl0
  call void @arienco_start_encoding.9(%struct.EncodingEnvironment* %eep, i8* %code_buffer, i32* %code_len, i32 %slice_type)
  ret void

func_arienco_start_encoding.18:                   ; preds = %ctrl1
  call void @arienco_start_encoding.18(%struct.EncodingEnvironment* %eep, i8* %code_buffer, i32* %code_len, i32 %slice_type)
  ret void

func_arienco_start_encoding.19:                   ; preds = %ctrl2
  call void @arienco_start_encoding.19(%struct.EncodingEnvironment* %eep, i8* %code_buffer, i32* %code_len, i32 %slice_type)
  ret void

func_arienco_start_encoding.23:                   ; preds = %ctrl3
  call void @arienco_start_encoding.23(%struct.EncodingEnvironment* %eep, i8* %code_buffer, i32* %code_len, i32 %slice_type)
  ret void

func_arienco_start_encoding.27:                   ; preds = %ctrl4
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_arienco_start_encoding.9, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_arienco_start_encoding.18, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_arienco_start_encoding.19, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_arienco_start_encoding.23, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_arienco_start_encoding.27, label %ctrl5
...
func_biari_encode_symbol.11:                      ; preds = %ctrl1
  call void @biari_encode_symbol.11(%struct.EncodingEnvironment* %eep, i16 %symbol, %struct.BiContextType* %bi_ct)
  ret void

func_biari_encode_symbol.12:                      ; preds = %ctrl2
  call void @biari_encode_symbol.12(%struct.EncodingEnvironment* %eep, i16 %symbol, %struct.BiContextType* %bi_ct)
  ret void

func_biari_encode_symbol.17:                      ; preds = %ctrl3
  call void @biari_encode_symbol.17(%struct.EncodingEnvironment* %eep, i16 %symbol, %struct.BiContextType* %bi_ct)
  ret void

func_biari_encode_symbol.22:                      ; preds = %ctrl4
...
func_biari_encode_symbol.28:                      ; preds = %ctrl5
  call void @biari_encode_symbol.28(%struct.EncodingEnvironment* %eep, i16 %symbol, %struct.BiContextType* %bi_ct)
  ret void
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_biari_encode_symbol.11, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_biari_encode_symbol.12, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_biari_encode_symbol.17, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_biari_encode_symbol.22, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_biari_encode_symbol.24, label %func_biari_encode_symbol.28
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_biari_encode_symbol_eq_prob.6, label %ctrl0

func_biari_encode_symbol_eq_prob.6:               ; preds = %rand_bb
  call void @biari_encode_symbol_eq_prob.6(%struct.EncodingEnvironment* %eep, i16 %symbol)
  ret void

func_biari_encode_symbol_eq_prob.7:               ; preds = %ctrl0
  call void @biari_encode_symbol_eq_prob.7(%struct.EncodingEnvironment* %eep, i16 %symbol)
  ret void
...
func_biari_encode_symbol_eq_prob.10:              ; preds = %ctrl2
  call void @biari_encode_symbol_eq_prob.10(%struct.EncodingEnvironment* %eep, i16 %symbol)
  ret void

func_biari_encode_symbol_eq_prob.14:              ; preds = %ctrl3
  call void @biari_encode_symbol_eq_prob.14(%struct.EncodingEnvironment* %eep, i16 %symbol)
  ret void

func_biari_encode_symbol_eq_prob.20:              ; preds = %ctrl3
  call void @biari_encode_symbol_eq_prob.20(%struct.EncodingEnvironment* %eep, i16 %symbol)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_biari_encode_symbol_eq_prob.7, label %ctrl1
...
ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_biari_encode_symbol_eq_prob.10, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_biari_encode_symbol_eq_prob.14, label %func_biari_encode_symbol_eq_prob.20
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_biari_encode_symbol_final.1, label %ctrl0

func_biari_encode_symbol_final.1:                 ; preds = %rand_bb
  call void @biari_encode_symbol_final.1(%struct.EncodingEnvironment* %eep, i16 %symbol)
  ret void

func_biari_encode_symbol_final.16:                ; preds = %ctrl0
  call void @biari_encode_symbol_final.16(%struct.EncodingEnvironment* %eep, i16 %symbol)
  ret void

func_biari_encode_symbol_final.21:                ; preds = %ctrl1
  call void @biari_encode_symbol_final.21(%struct.EncodingEnvironment* %eep, i16 %symbol)
  ret void
...
func_biari_encode_symbol_final.26:                ; preds = %ctrl3
  call void @biari_encode_symbol_final.26(%struct.EncodingEnvironment* %eep, i16 %symbol)
  ret void

func_biari_encode_symbol_final.31:                ; preds = %ctrl4
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_biari_encode_symbol_final.16, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_biari_encode_symbol_final.21, label %ctrl2
...
ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_biari_encode_symbol_final.26, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_biari_encode_symbol_final.31, label %ctrl5
...
func_biari_init_context.13:                       ; preds = %ctrl0
  call void @biari_init_context.13(%struct.BiContextType* %ctx, i32* %ini)
  ret void

func_biari_init_context.15:                       ; preds = %ctrl1
  call void @biari_init_context.15(%struct.BiContextType* %ctx, i32* %ini)
  ret void

func_biari_init_context.29:                       ; preds = %ctrl2
  call void @biari_init_context.29(%struct.BiContextType* %ctx, i32* %ini)
  ret void

func_biari_init_context.30:                       ; preds = %ctrl3
  call void @biari_init_context.30(%struct.BiContextType* %ctx, i32* %ini)
  ret void

func_biari_init_context.36:                       ; preds = %ctrl3
  call void @biari_init_context.36(%struct.BiContextType* %ctx, i32* %ini)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_biari_init_context.13, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_biari_init_context.15, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_biari_init_context.29, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_biari_init_context.30, label %func_biari_init_context.36
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_encode_symbol_final.1(%struct.EncodingEnvironment* %eep, i16 signext %symbol) #0 {
entry:
  %low = alloca i32, align 4
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %symbol.addr = alloca i16, align 2
  %canary = alloca i32
  store i32 94925513, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1472385346, i32* %canary
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %symbol.addr = alloca i16, align 2
...
while.end162:                                     ; preds = %while.cond
  ...
  %137 = icmp eq i32 %136, 1472385346
...
entry:
  %canary = alloca i32
  store i32 578745387, i32* %canary
...
entry:
  ...
  %symbol.addr = alloca i16, align 2
  %canary = alloca i32
  store i32 1263142818, i32* %canary
  %range = alloca i32, align 4
  %rLPS = alloca i32, align 4
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %bi_ct.addr = alloca %struct.BiContextType*, align 8
...
while.end162:                                     ; preds = %while.cond
  ...
  store i32 %inc166, i32* %C165, align 8
  %136 = load i32, i32* %canary
  %137 = icmp eq i32 %136, 1263142818
  br i1 %137, label %138, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_encode_symbol_eq_prob.6(%struct.EncodingEnvironment* %eep, i16 signext %symbol) #0 {
entry:
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 669586722, i32* %canary
  %symbol.addr = alloca i16, align 2
  %low = alloca i32, align 4
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_encode_symbol_eq_prob.7(%struct.EncodingEnvironment* %eep, i16 signext %symbol) #0 {
entry:
  %canary = alloca i32
  store i32 2054975011, i32* %canary
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %low = alloca i32, align 4
  %symbol.addr = alloca i16, align 2
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
...
if.end124:                                        ; preds = %if.end123, %while.end51
  ...
  store i32 %inc127, i32* %C126, align 8
  %104 = load i32, i32* %canary
  %105 = icmp eq i32 %104, 2054975011
  br i1 %105, label %106, label %func_exit
...
entry:
  %low = alloca i32, align 4
  %canary = alloca i32
  store i32 1744247656, i32* %canary
  %symbol.addr = alloca i16, align 2
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
...
if.end124:                                        ; preds = %if.end123, %while.end51
  ...
  store i32 %inc127, i32* %C126, align 8
  %104 = load i32, i32* %canary
  %105 = icmp eq i32 %104, 1744247656
  br i1 %105, label %106, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @arienco_start_encoding.9(%struct.EncodingEnvironment* %eep, i8* %code_buffer, i32* %code_len, i32 %slice_type) #0 {
entry:
  %canary = alloca i32
  store i32 1506673208, i32* %canary
  %slice_type.addr = alloca i32, align 4
  %code_len.addr = alloca i32*, align 8
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %code_buffer.addr = alloca i8*, align 8
...
entry:
  %canary = alloca i32
  store i32 1481621894, i32* %canary
  %symbol.addr = alloca i16, align 2
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %low = alloca i32, align 4
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
...
if.end124:                                        ; preds = %if.end123, %while.end51
  ...
  store i32 %inc127, i32* %C126, align 8
  %104 = load i32, i32* %canary
  %105 = icmp eq i32 %104, 1481621894
  br i1 %105, label %106, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_encode_symbol.11(%struct.EncodingEnvironment* %eep, i16 signext %symbol, %struct.BiContextType* %bi_ct) #0 {
entry:
  %canary = alloca i32
  store i32 1720103576, i32* %canary
  %rLPS = alloca i32, align 4
  %symbol.addr = alloca i16, align 2
  %low = alloca i32, align 4
  %bi_ct.addr = alloca %struct.BiContextType*, align 8
...
while.end162:                                     ; preds = %while.cond
  ...
  store i32 %inc166, i32* %C165, align 8
  %136 = load i32, i32* %canary
  %137 = icmp eq i32 %136, 1720103576
  br i1 %137, label %138, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_encode_symbol.12(%struct.EncodingEnvironment* %eep, i16 signext %symbol, %struct.BiContextType* %bi_ct) #0 {
entry:
  %rLPS = alloca i32, align 4
  %canary = alloca i32
  store i32 222898317, i32* %canary
  %range = alloca i32, align 4
  %low = alloca i32, align 4
  %symbol.addr = alloca i16, align 2
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
...
entry:
  %ini.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 909413748, i32* %canary
  %pstate = alloca i32, align 4
  %ctx.addr = alloca %struct.BiContextType*, align 8
  store %struct.BiContextType* %ctx, %struct.BiContextType** %ctx.addr, align 8
  store i32* %ini, i32** %ini.addr, align 8
...
entry:
  %ctx.addr = alloca %struct.BiContextType*, align 8
  %canary = alloca i32
  store i32 1726449982, i32* %canary
  %pstate = alloca i32, align 4
  %ini.addr = alloca i32*, align 8
  store %struct.BiContextType* %ctx, %struct.BiContextType** %ctx.addr, align 8
  store i32* %ini, i32** %ini.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_encode_symbol.17(%struct.EncodingEnvironment* %eep, i16 signext %symbol, %struct.BiContextType* %bi_ct) #0 {
entry:
  %low = alloca i32, align 4
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %symbol.addr = alloca i16, align 2
  ...
  %bi_ct.addr = alloca %struct.BiContextType*, align 8
  %canary = alloca i32
  store i32 1929857932, i32* %canary
  %rLPS = alloca i32, align 4
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
  store %struct.BiContextType* %bi_ct, %struct.BiContextType** %bi_ct.addr, align 8
...
while.end162:                                     ; preds = %while.cond
  ...
  store i32 %inc166, i32* %C165, align 8
  %136 = load i32, i32* %canary
  %137 = icmp eq i32 %136, 1929857932
  br i1 %137, label %138, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @arienco_start_encoding.18(%struct.EncodingEnvironment* %eep, i8* %code_buffer, i32* %code_len, i32 %slice_type) #0 {
entry:
  %canary = alloca i32
  store i32 1259743720, i32* %canary
  %slice_type.addr = alloca i32, align 4
  %code_buffer.addr = alloca i8*, align 8
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %code_len.addr = alloca i32*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @arienco_start_encoding.19(%struct.EncodingEnvironment* %eep, i8* %code_buffer, i32* %code_len, i32 %slice_type) #0 {
entry:
  %canary = alloca i32
  store i32 259881880, i32* %canary
  %code_buffer.addr = alloca i8*, align 8
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %code_len.addr = alloca i32*, align 8
  %slice_type.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_encode_symbol_eq_prob.20(%struct.EncodingEnvironment* %eep, i16 signext %symbol) #0 {
entry:
  %symbol.addr = alloca i16, align 2
  %canary = alloca i32
  store i32 1602055463, i32* %canary
  %low = alloca i32, align 4
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
...
if.end124:                                        ; preds = %if.end123, %while.end51
  ...
  store i32 %inc127, i32* %C126, align 8
  %104 = load i32, i32* %canary
  %105 = icmp eq i32 %104, 1602055463
  br i1 %105, label %106, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_encode_symbol_final.21(%struct.EncodingEnvironment* %eep, i16 signext %symbol) #0 {
entry:
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %low = alloca i32, align 4
  %canary = alloca i32
  store i32 1538375408, i32* %canary
  %range = alloca i32, align 4
  %symbol.addr = alloca i16, align 2
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
...
while.end125:                                     ; preds = %while.cond
  ...
  store i32 %inc129, i32* %C128, align 8
  %110 = load i32, i32* %canary
  %111 = icmp eq i32 %110, 1538375408
  br i1 %111, label %112, label %func_exit
...
entry:
  ...
  %low = alloca i32, align 4
  %canary = alloca i32
  store i32 878949531, i32* %canary
  %symbol.addr = alloca i16, align 2
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
  store %struct.BiContextType* %bi_ct, %struct.BiContextType** %bi_ct.addr, align 8
...
entry:
  ...
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 143330488, i32* %canary
  %slice_type.addr = alloca i32, align 4
  %code_len.addr = alloca i32*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i8* %code_buffer, i8** %code_buffer.addr, align 8
...
entry:
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 967073278, i32* %canary
  %rLPS = alloca i32, align 4
  %low = alloca i32, align 4
  %bi_ct.addr = alloca %struct.BiContextType*, align 8
  %symbol.addr = alloca i16, align 2
...
entry:
  ...
  %range = alloca i32, align 4
  %canary = alloca i32
  store i32 999061891, i32* %canary
  %low = alloca i32, align 4
  %symbol.addr = alloca i16, align 2
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
...
entry:
  %symbol.addr = alloca i16, align 2
  %canary = alloca i32
  store i32 1586427610, i32* %canary
  %range = alloca i32, align 4
  %low = alloca i32, align 4
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
...
while.end125:                                     ; preds = %while.cond
  ...
  store i32 %inc129, i32* %C128, align 8
  %110 = load i32, i32* %canary
  %111 = icmp eq i32 %110, 1586427610
  br i1 %111, label %112, label %func_exit
...
entry:
  %canary = alloca i32
  store i32 1642108204, i32* %canary
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %slice_type.addr = alloca i32, align 4
  %code_len.addr = alloca i32*, align 8
  %code_buffer.addr = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_encode_symbol.28(%struct.EncodingEnvironment* %eep, i16 signext %symbol, %struct.BiContextType* %bi_ct) #0 {
entry:
  %bi_ct.addr = alloca %struct.BiContextType*, align 8
  %canary = alloca i32
  store i32 250924698, i32* %canary
  %low = alloca i32, align 4
  %range = alloca i32, align 4
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %rLPS = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_init_context.29(%struct.BiContextType* %ctx, i32* %ini) #0 {
entry:
  %canary = alloca i32
  store i32 555225406, i32* %canary
  %ctx.addr = alloca %struct.BiContextType*, align 8
  %ini.addr = alloca i32*, align 8
  %pstate = alloca i32, align 4
  store %struct.BiContextType* %ctx, %struct.BiContextType** %ctx.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_init_context.30(%struct.BiContextType* %ctx, i32* %ini) #0 {
entry:
  %canary = alloca i32
  store i32 1621327970, i32* %canary
  %pstate = alloca i32, align 4
  %ini.addr = alloca i32*, align 8
  %ctx.addr = alloca %struct.BiContextType*, align 8
  store %struct.BiContextType* %ctx, %struct.BiContextType** %ctx.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1008540954, i32* %canary
  %range = alloca i32, align 4
  %symbol.addr = alloca i16, align 2
  %low = alloca i32, align 4
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
...
while.end125:                                     ; preds = %while.cond
  ...
  store i32 %inc129, i32* %C128, align 8
  %110 = load i32, i32* %canary
  %111 = icmp eq i32 %110, 1008540954
  br i1 %111, label %112, label %func_exit
...
entry:
  ...
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 1734969129, i32* %canary
  %low = alloca i32, align 4
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
  %0 = load %struct.EncodingEnvironment*, %struct.EncodingEnvironment** %eep.addr, align 8
...
while.end125:                                     ; preds = %while.cond
  ...
  store i32 %inc129, i32* %C128, align 8
  %110 = load i32, i32* %canary
  %111 = icmp eq i32 %110, 1734969129
  br i1 %111, label %112, label %func_exit
...
entry:
  ...
  %symbol.addr = alloca i16, align 2
  %canary = alloca i32
  store i32 632994690, i32* %canary
  %low = alloca i32, align 4
  %range = alloca i32, align 4
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
...
entry:
  %code_len.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 1727241445, i32* %canary
  %slice_type.addr = alloca i32, align 4
  %code_buffer.addr = alloca i8*, align 8
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
...
entry:
  %code_len.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 1221429848, i32* %canary
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %slice_type.addr = alloca i32, align 4
  %code_buffer.addr = alloca i8*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_init_context.36(%struct.BiContextType* %ctx, i32* %ini) #0 {
entry:
  %ini.addr = alloca i32*, align 8
  %ctx.addr = alloca %struct.BiContextType*, align 8
  %canary = alloca i32
  store i32 1749327515, i32* %canary
  %pstate = alloca i32, align 4
  store %struct.BiContextType* %ctx, %struct.BiContextType** %ctx.addr, align 8
  store i32* %ini, i32** %ini.addr, align 8
  %0 = load i32*, i32** %ini.addr, align 8
