...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_testEndian.16, label %func_testEndian.17

func_testEndian.16:                               ; preds = %rand_bb
  %2 = call i32 @testEndian.16()
  ret i32 %2

func_testEndian.17:                               ; preds = %rand_bb
  %3 = call i32 @testEndian.17()
  ret i32 %3
}
...
func_img2buf.12:                                  ; preds = %ctrl1
  call void @img2buf.12(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom)
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_img2buf.8, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_img2buf.12, label %func_img2buf.14
}
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_write_picture.20, label %func_write_picture.24
}
...
func_write_out_picture.21:                        ; preds = %ctrl0
  call void @write_out_picture.21(%struct.storable_picture* %p, i32 %p_out)
  ret void

func_write_out_picture.22:                        ; preds = %ctrl1
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_write_out_picture.21, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_write_out_picture.22, label %func_write_out_picture.23
}
...
func_write_unpaired_field.9:                      ; preds = %ctrl0
  call void @write_unpaired_field.9(%struct.frame_store* %fs, i32 %p_out)
  ret void

func_write_unpaired_field.11:                     ; preds = %ctrl1
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_write_unpaired_field.9, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_write_unpaired_field.11, label %func_write_unpaired_field.18
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_write_stored_frame.1, label %func_write_stored_frame.10

func_write_stored_frame.1:                        ; preds = %rand_bb
  call void @write_stored_frame.1(%struct.frame_store* %fs, i32 %p_out)
  ret void
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_direct_output.4, label %func_direct_output.7
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_stored_frame.1(%struct.frame_store* %fs, i32 %p_out) #0 {
entry:
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 520167066, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 143730129, i32* %canary
...
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 653770031, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 540270379, i32* %canary
  %p_out.addr = alloca i32, align 4
  %p.addr = alloca %struct.storable_picture*, align 8
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 516962771, i32* %canary
  %p_out.addr = alloca i32, align 4
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 2032651512, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  %i = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 0, i32* %i, align 4
...
entry:
  %canary = alloca i32
  store i32 140398399, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  %p_out.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  ...
  %size = alloca i32, align 4
  %canary = alloca i32
  store i32 1367746090, i32* %canary
  %ui8 = alloca i8, align 1
  %crop_right.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %crop_bottom.addr = alloca i32, align 4
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1367746090
  br i1 %109, label %110, label %func_exit
...
entry:
  ...
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1519410132, i32* %canary
  %p = alloca %struct.storable_picture*, align 8
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  %0 = load %struct.frame_store*, %struct.frame_store** %fs.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1924603094, i32* %canary
  %fs.addr = alloca %struct.frame_store*, align 8
  %p_out.addr = alloca i32, align 4
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1488076052, i32* %canary
  %fs.addr = alloca %struct.frame_store*, align 8
  %p = alloca %struct.storable_picture*, align 8
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @img2buf.12(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom) #0 {
entry:
  %crop_right.addr = alloca i32, align 4
  %imgX.addr = alloca i16**, align 8
  %ui8 = alloca i8, align 1
  %size_y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1256242637, i32* %canary
  %buf.addr = alloca i8*, align 8
  %crop_bottom.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %ui32 = alloca i64, align 8
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1256242637
  br i1 %109, label %110, label %func_exit
...
entry:
  ...
  %canary = alloca i32
  store i32 1828466316, i32* %canary
...
return:                                           ; preds = %if.end139, %if.then
  ...
  %193 = icmp eq i32 %192, 1828466316
...
entry:
  ...
  %size_x.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1624574020, i32* %canary
  %imgX.addr = alloca i16**, align 8
  %tmp16 = alloca i16, align 2
  %size = alloca i32, align 4
  %i = alloca i32, align 4
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1624574020
  br i1 %109, label %110, label %func_exit
...
entry:
  %p.addr = alloca %struct.storable_picture*, align 8
  %canary = alloca i32
  store i32 283530590, i32* %canary
  %p_out.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @testEndian.16() #0 {
entry:
  %s = alloca i16, align 2
  %canary = alloca i32
  store i32 1433290148, i32* %canary
  %p = alloca i8*, align 8
...
entry:
  %p = alloca i8*, align 8
  %canary = alloca i32
  store i32 1828509320, i32* %canary
  %s = alloca i16, align 2
  %0 = bitcast i16* %s to i8*
  store i8* %0, i8** %p, align 8
  store i16 1, i16* %s, align 2
...
entry:
  %canary = alloca i32
  store i32 1561260496, i32* %canary
  %real_structure.addr = alloca i32, align 4
  %p.addr = alloca %struct.storable_picture*, align 8
  %p_out.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
...
entry:
  ...
  %real_structure.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1923553377, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  store i32 %real_structure, i32* %real_structure.addr, align 4
...
entry:
  %SubWidthC = alloca [4 x i32], align 16
  %canary = alloca i32
  store i32 710865464, i32* %canary
  %symbol_size_in_bytes = alloca i32, align 4
  %crop_top = alloca i32, align 4
  %crop_right = alloca i32, align 4
  %crop_left = alloca i32, align 4
...
entry:
  ...
  %buf = alloca i8*, align 8
  %canary = alloca i32
  store i32 1164046471, i32* %canary
  %crop_top = alloca i32, align 4
  %rgb_output = alloca i32, align 4
  %symbol_size_in_bytes = alloca i32, align 4
  %p_out.addr = alloca i32, align 4
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1164046471
  br i1 %193, label %194, label %func_exit
...
entry:
  ...
  %SubWidthC = alloca [4 x i32], align 16
  %canary = alloca i32
  store i32 2061836960, i32* %canary
  %symbol_size_in_bytes = alloca i32, align 4
  %crop_top = alloca i32, align 4
  %buf = alloca i8*, align 8
  %crop_right = alloca i32, align 4
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 2061836960
  br i1 %193, label %194, label %func_exit
...
entry:
  %canary = alloca i32
  store i32 127056219, i32* %canary
  %real_structure.addr = alloca i32, align 4
  %p_out.addr = alloca i32, align 4
  %p.addr = alloca %struct.storable_picture*, align 8
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
