...
.LBB0_3:                                # %func_get_LeakyBucketRate.6
	...
	.cfi_def_cfa %rsp, 8
	retq
.LBB0_4:                                # %func_get_LeakyBucketRate.7
	.cfi_def_cfa %rbp, 16
	movq	%rbx, %rdi
	movq	%r14, %rsi
...
# %bb.0:                                # %rand_bb
	...
	cmpl	$0, %eax
	jne	.LBB1_2
# %bb.1:                                # %func_PutBigDoubleWord.11
	movq	%rbx, %rdi
	movq	%r14, %rsi
	callq	PutBigDoubleWord.11
	popq	%rbx
	popq	%r14
	popq	%rbp
	.cfi_def_cfa %rsp, 8
...
.LBB4_2:                                # %func_calc_buffer.9
	...
	.cfi_def_cfa %rsp, 8
	retq
.LBB4_3:                                # %func_calc_buffer.14
	.cfi_def_cfa %rbp, 16
	callq	calc_buffer.14
	popq	%rbp
	.cfi_def_cfa %rsp, 8
	retq
.LBB4_4:                                # %func_calc_buffer.16
	.cfi_def_cfa %rbp, 16
...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$786902216, -36(%rbp)   # imm = 0x2EE72CC8
	movq	%rdi, -64(%rbp)
	movq	%rsi, -56(%rbp)
	movq	input, %rdi
...
.LBB5_9:                                # %return
	movl	-12(%rbp), %ebx
	cmpl	$786902216, -36(%rbp)   # imm = 0x2EE72CC8
	jne	.LBB5_11
.LBB5_10:
	movl	%ebx, %eax
	addq	$56, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$1422804864, -28(%rbp)  # imm = 0x54CE4780
	movq	%rdi, -24(%rbp)
	movq	%rsi, -56(%rbp)
	movq	%rdx, -48(%rbp)
	movq	%rcx, -40(%rbp)
...
.LBB6_6:                                # %for.end
	movq	-16(%rbp), %rdi
	callq	fclose
	cmpl	$1422804864, -28(%rbp)  # imm = 0x54CE4780
	jne	.LBB6_8
.LBB6_7:
	addq	$64, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$881658744, -36(%rbp)   # imm = 0x348D0B78
	movq	%rdi, -48(%rbp)
	movq	%rsi, -64(%rbp)
	movq	input, %rdi
	addq	$2480, %rdi             # imm = 0x9B0
...
.LBB7_9:                                # %return
	movl	-12(%rbp), %ebx
	cmpl	$881658744, -36(%rbp)   # imm = 0x348D0B78
	jne	.LBB7_11
.LBB7_10:
	movl	%ebx, %eax
	addq	$56, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$520908145, -28(%rbp)   # imm = 0x1F0C6D71
	movq	%rdi, -24(%rbp)
	movq	%rsi, -56(%rbp)
	movq	%rdx, -40(%rbp)
	movq	%rcx, -48(%rbp)
...
.LBB8_6:                                # %for.end
	movq	-16(%rbp), %rdi
	callq	fclose
	cmpl	$520908145, -28(%rbp)   # imm = 0x1F0C6D71
	jne	.LBB8_8
.LBB8_7:
	addq	$64, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$128, %rsp
	movl	$2145734506, -100(%rbp) # imm = 0x7FE54F6A
	movq	$0, -112(%rbp)
	movq	stdout, %rdi
	movabsq	$.L.str.8, %rsi
	movb	$0, %al
...
.LBB9_52:                               # %for.end136
	...
	movq	-72(%rbp), %rdi
	callq	free
	cmpl	$2145734506, -100(%rbp) # imm = 0x7FE54F6A
	jne	.LBB9_54
.LBB9_53:
	addq	$128, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$405538295, -36(%rbp)   # imm = 0x182C05F7
	movq	%rdi, -48(%rbp)
	movq	%rsi, -64(%rbp)
	movq	input, %rdi
	addq	$2480, %rdi             # imm = 0x9B0
...
.LBB10_9:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$405538295, -36(%rbp)   # imm = 0x182C05F7
	jne	.LBB10_11
.LBB10_10:
	movl	%ebx, %eax
	addq	$56, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$1938331504, -36(%rbp)  # imm = 0x73889770
	movq	%rdi, -64(%rbp)
	movq	%rsi, -48(%rbp)
	movq	input, %rdi
	addq	$2480, %rdi             # imm = 0x9B0
...
.LBB11_9:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$1938331504, -36(%rbp)  # imm = 0x73889770
	jne	.LBB11_11
.LBB11_10:
	movl	%ebx, %eax
	addq	$56, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$48, %rsp
	movl	$1413022633, -28(%rbp)  # imm = 0x543903A9
	movq	%rdi, -40(%rbp)
	movq	%rsi, -24(%rbp)
	movq	$0, -8(%rbp)
.LBB12_1:                               # %for.cond
...
.LBB12_9:                               # %for.inc10
	...
	jmp	.LBB12_1
.LBB12_10:                              # %for.end12
	cmpl	$1413022633, -28(%rbp)  # imm = 0x543903A9
	jne	.LBB12_12
.LBB12_11:
	addq	$48, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$128, %rsp
	movl	$414470885, -100(%rbp)  # imm = 0x18B452E5
	movq	$0, -112(%rbp)
	movq	stdout, %rdi
	movabsq	$.L.str.8, %rsi
	movb	$0, %al
...
.LBB13_52:                              # %for.end136
	...
	movq	-72(%rbp), %rdi
	callq	free
	cmpl	$414470885, -100(%rbp)  # imm = 0x18B452E5
	jne	.LBB13_54
.LBB13_53:
	addq	$128, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$48, %rsp
	movl	$1798326396, -28(%rbp)  # imm = 0x6B30487C
	movq	%rdi, -40(%rbp)
	movq	%rsi, -16(%rbp)
	movq	$0, -8(%rbp)
.LBB14_1:                               # %for.cond
...
.LBB14_9:                               # %for.inc10
	...
	jmp	.LBB14_1
.LBB14_10:                              # %for.end12
	cmpl	$1798326396, -28(%rbp)  # imm = 0x6B30487C
	jne	.LBB14_12
.LBB14_11:
	addq	$48, %rsp
	popq	%rbp
...
.Lfunc_end14:
	...
	.cfi_endproc
                                        # -- End function
	.globl	PutBigDoubleWord.11     # -- Begin function PutBigDoubleWord.11
	.p2align	4, 0x90
	.type	PutBigDoubleWord.11,@function
PutBigDoubleWord.11:                    # @PutBigDoubleWord.11
	.cfi_startproc
# %bb.0:                                # %entry
	pushq	%rbp
	.cfi_def_cfa_offset 16
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$2017057374, -20(%rbp)  # imm = 0x7839DA5E
	movq	%rdi, -8(%rbp)
	movq	%rsi, -16(%rbp)
	movq	-8(%rbp), %rdi
	shrq	$24, %rdi
	...
	movq	-16(%rbp), %rsi
                                        # kill: def $edi killed $edi killed $rdi
	callq	fputc
	cmpl	$2017057374, -20(%rbp)  # imm = 0x7839DA5E
	jne	.LBB15_2
.LBB15_1:
	addq	$32, %rsp
	popq	%rbp
...
.LBB15_2:                               # %func_exit
	...
	jmp	.LBB15_1
.Lfunc_end15:
	.size	PutBigDoubleWord.11, .Lfunc_end15-PutBigDoubleWord.11
	.cfi_endproc
                                        # -- End function
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$254453498, -28(%rbp)   # imm = 0xF2AA6FA
	movq	%rdi, -24(%rbp)
	movq	%rsi, -40(%rbp)
	movq	%rdx, -56(%rbp)
	movq	%rcx, -48(%rbp)
...
.LBB16_6:                               # %for.end
	movq	-16(%rbp), %rdi
	callq	fclose
	cmpl	$254453498, -28(%rbp)   # imm = 0xF2AA6FA
	jne	.LBB16_8
.LBB16_7:
	addq	$64, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$729520589, -28(%rbp)   # imm = 0x2B7B99CD
	movq	%rdi, -24(%rbp)
	movq	%rsi, -40(%rbp)
	movq	%rdx, -56(%rbp)
	movq	%rcx, -48(%rbp)
...
.LBB17_6:                               # %for.end
	movq	-16(%rbp), %rdi
	callq	fclose
	cmpl	$729520589, -28(%rbp)   # imm = 0x2B7B99CD
	jne	.LBB17_8
.LBB17_7:
	addq	$64, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$128, %rsp
	movl	$1560905150, -100(%rbp) # imm = 0x5D0985BE
	movq	$0, -112(%rbp)
	movq	stdout, %rdi
	movabsq	$.L.str.8, %rsi
	movb	$0, %al
...
.LBB18_52:                              # %for.end136
	...
	movq	-64(%rbp), %rdi
	callq	free
	cmpl	$1560905150, -100(%rbp) # imm = 0x5D0985BE
	jne	.LBB18_54
.LBB18_53:
	addq	$128, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$48, %rsp
	movl	$522201249, -28(%rbp)   # imm = 0x1F2028A1
	movq	%rdi, -40(%rbp)
	movq	%rsi, -24(%rbp)
	movq	$0, -8(%rbp)
.LBB19_1:                               # %for.cond
...
.LBB19_9:                               # %for.inc10
	...
	jmp	.LBB19_1
.LBB19_10:                              # %for.end12
	cmpl	$522201249, -28(%rbp)   # imm = 0x1F2028A1
	jne	.LBB19_12
.LBB19_11:
	addq	$48, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$128, %rsp
	movl	$1007851955, -100(%rbp) # imm = 0x3C1299B3
	movq	$0, -128(%rbp)
	movq	stdout, %rdi
	movabsq	$.L.str.8, %rsi
	movb	$0, %al
...
.LBB20_52:                              # %for.end136
	...
	movq	-72(%rbp), %rdi
	callq	free
	cmpl	$1007851955, -100(%rbp) # imm = 0x3C1299B3
	jne	.LBB20_54
.LBB20_53:
	addq	$128, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$2138935598, -20(%rbp)  # imm = 0x7F7D912E
	movq	%rdi, -16(%rbp)
	movq	%rsi, -8(%rbp)
	movq	-16(%rbp), %rdi
	shrq	$24, %rdi
	...
	movq	-8(%rbp), %rsi
                                        # kill: def $edi killed $edi killed $rdi
	callq	fputc
	cmpl	$2138935598, -20(%rbp)  # imm = 0x7F7D912E
	jne	.LBB21_2
.LBB21_1:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$48, %rsp
	movl	$389294241, -28(%rbp)   # imm = 0x173428A1
	movq	%rdi, -40(%rbp)
	movq	%rsi, -24(%rbp)
	movq	$0, -8(%rbp)
.LBB22_1:                               # %for.cond
...
.LBB22_9:                               # %for.inc10
	...
	jmp	.LBB22_1
.LBB22_10:                              # %for.end12
	cmpl	$389294241, -28(%rbp)   # imm = 0x173428A1
	jne	.LBB22_12
.LBB22_11:
	addq	$48, %rsp
	popq	%rbp
