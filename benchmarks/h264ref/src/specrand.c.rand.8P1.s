...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1042894695, -16(%rbp)  # imm = 0x3E294F67
	movslq	seedi, %rax
	cqto
...
.LBB2_3:                                # %if.end
	...
	cmpl	$1042894695, -16(%rbp)  # imm = 0x3E294F67
	jne	.LBB2_5
.LBB2_4:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1163866474, -8(%rbp)   # imm = 0x455F316A
	movslq	seedi, %rax
	cqto
	movl	$127773, %ecx           # imm = 0x1F31D
	idivq	%rcx
...
.LBB3_3:                                # %if.end
	...
	vcvtsi2sdl	seedi, %xmm0, %xmm1
	vdivsd	%xmm0, %xmm1, %xmm0
	cmpl	$1163866474, -8(%rbp)   # imm = 0x455F316A
	jne	.LBB3_5
.LBB3_4:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$585337991, -16(%rbp)   # imm = 0x22E38C87
	movslq	seedi, %rax
	cqto
	movl	$127773, %ecx           # imm = 0x1F31D
	idivq	%rcx
...
.LBB4_3:                                # %if.end
	...
	vcvtsi2sdl	seedi, %xmm0, %xmm1
	vdivsd	%xmm0, %xmm1, %xmm0
	cmpl	$585337991, -16(%rbp)   # imm = 0x22E38C87
	jne	.LBB4_5
.LBB4_4:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$56536024, -12(%rbp)    # imm = 0x35EABD8
	movslq	seedi, %rax
	cqto
	movl	$127773, %ecx           # imm = 0x1F31D
	idivq	%rcx
...
.LBB5_3:                                # %if.end
	...
	vcvtsi2sdl	seedi, %xmm0, %xmm1
	vdivsd	%xmm0, %xmm1, %xmm0
	cmpl	$56536024, -12(%rbp)    # imm = 0x35EABD8
	jne	.LBB5_5
.LBB5_4:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$112811366, -12(%rbp)   # imm = 0x6B95D66
	movslq	seedi, %rax
	cqto
	movl	$127773, %ecx           # imm = 0x1F31D
	idivq	%rcx
...
.LBB6_3:                                # %if.end
	...
	vcvtsi2sdl	seedi, %xmm0, %xmm1
	vdivsd	%xmm0, %xmm1, %xmm0
	cmpl	$112811366, -12(%rbp)   # imm = 0x6B95D66
	jne	.LBB6_5
.LBB6_4:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$34783628, -12(%rbp)    # imm = 0x212C18C
	movslq	seedi, %rax
	cqto
	movl	$127773, %ecx           # imm = 0x1F31D
	idivq	%rcx
...
.LBB7_3:                                # %if.end
	...
	vcvtsi2sdl	seedi, %xmm0, %xmm1
	vdivsd	%xmm0, %xmm1, %xmm0
	cmpl	$34783628, -12(%rbp)    # imm = 0x212C18C
	jne	.LBB7_5
.LBB7_4:
	addq	$32, %rsp
	popq	%rbp
