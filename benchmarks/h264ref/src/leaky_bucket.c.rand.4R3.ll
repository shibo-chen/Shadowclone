; ModuleID = 'leaky_bucket.c.rand.4R3.bc'
...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_get_LeakyBucketRate.3, label %ctrl0

func_get_LeakyBucketRate.3:                       ; preds = %rand_bb
  %2 = call i32 @get_LeakyBucketRate.3(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret i32 %2
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_get_LeakyBucketRate.10, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_get_LeakyBucketRate.12, label %func_get_LeakyBucketRate.15
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_PutBigDoubleWord.7, label %func_PutBigDoubleWord.8
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_write_buffer.14, label %func_write_buffer.17
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_Sort.11, label %ctrl0

func_Sort.11:                                     ; preds = %rand_bb
  call void @Sort.11(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret void

func_Sort.13:                                     ; preds = %ctrl0
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_Sort.13, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_Sort.16, label %func_Sort.18
}
...
func_calc_buffer.6:                               ; preds = %ctrl1
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_calc_buffer.5, label %func_calc_buffer.6
}
...
entry:
  ...
  %canary = alloca i32
  store i32 427168699, i32* %canary
...
entry:
  ...
  %Bmin = alloca i64*, align 8
  %canary = alloca i32
  store i32 899127742, i32* %canary
  %iBucket = alloca i64, align 8
  store i64 0, i64* %FrameIndex, align 8
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8
  %call = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %0, i8* getelementptr inbounds ([81 x i8], [81 x i8]* @.str.8, i64 0, i64 0))
...
entry:
  ...
  %canary = alloca i32
  store i32 1084580386, i32* %canary
...
entry:
  ...
  %iChannelRate = alloca i64, align 8
  %canary = alloca i32
  store i32 1508584731, i32* %canary
  %Rmin = alloca i64*, align 8
  %buffer_frame = alloca i64*, align 8
  store i64 0, i64* %FrameIndex, align 8
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8
...
for.end136:                                       ; preds = %for.cond57
  ...
  call void @free(i8* %148) #3
  %149 = load i32, i32* %canary
  %150 = icmp eq i32 %149, 1508584731
  br i1 %150, label %151, label %func_exit
...
entry:
  ...
  %iFrame = alloca i64, align 8
  %canary = alloca i32
  store i32 877821842, i32* %canary
  %Fmin = alloca i64*, align 8
  %AvgRate = alloca i64, align 8
  %maxBuffer = alloca i64, align 8
  %TotalRate = alloca i64, align 8
...
entry:
  %canary = alloca i32
  store i32 1526374303, i32* %canary
...
entry:
  %dw.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1524734894, i32* %canary
  %fp.addr = alloca %struct._IO_FILE*, align 8
  store i64 %dw, i64* %dw.addr, align 8
  store %struct._IO_FILE* %fp, %struct._IO_FILE** %fp.addr, align 8
  %0 = load i64, i64* %dw.addr, align 8
...
entry:
  ...
  %Rmin.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 1317732171, i32* %canary
  %Bmin.addr = alloca i64*, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
  store i64* %Bmin, i64** %Bmin.addr, align 8
...
entry:
  %Rmin.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 562915347, i32* %canary
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %i = alloca i64, align 8
  %f = alloca %struct._IO_FILE*, align 8
  %buf = alloca i64, align 8
...
entry:
  ...
  %i = alloca i64, align 8
  %canary = alloca i32
  store i32 199950717, i32* %canary
...
entry:
  ...
  %f = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 1774568337, i32* %canary
  %buf = alloca i64, align 8
  %i = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1237540547, i32* %canary
  %temp = alloca i64, align 8
  %j = alloca i64, align 8
  %Rmin.addr = alloca i64*, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
...
entry:
  ...
  %Bmin.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 1849561938, i32* %canary
  %outf = alloca %struct._IO_FILE*, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
  store i64* %Bmin, i64** %Bmin.addr, align 8
...
entry:
  ...
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 972253964, i32* %canary
  %buf = alloca i64, align 8
  %retval = alloca i32, align 4
  %i = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
...
entry:
  ...
  %Rmin.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 1221196470, i32* %canary
  %j = alloca i64, align 8
  %i = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
...
entry:
  ...
  %temp = alloca i64, align 8
  %canary = alloca i32
  store i32 1748002145, i32* %canary
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %j = alloca i64, align 8
  %i = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
