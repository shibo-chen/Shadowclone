...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$96, %rsp
	movl	$1745774059, -44(%rbp)  # imm = 0x680E65EB
	movq	%rdi, -16(%rbp)
	movq	img, %rax
	movq	14160(%rax), %rax
	movq	32(%rax), %rax
...
.LBB4_19:                               # %if.end41
	...
	movq	%rax, 344(%rcx)
.LBB4_20:                               # %return
	cmpl	$1745774059, -44(%rbp)  # imm = 0x680E65EB
	jne	.LBB4_22
.LBB4_21:
	addq	$96, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$96, %rsp
	movl	$2013143471, -44(%rbp)  # imm = 0x77FE21AF
	movq	%rdi, -16(%rbp)
	movq	img, %rax
	movq	14160(%rax), %rax
	movq	32(%rax), %rax
...
.LBB5_19:                               # %if.end41
	...
	movq	%rax, 504(%rcx)
.LBB5_20:                               # %return
	cmpl	$2013143471, -44(%rbp)  # imm = 0x77FE21AF
	jne	.LBB5_22
.LBB5_21:
	addq	$96, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$96, %rsp
	movl	$1805776843, -44(%rbp)  # imm = 0x6BA1F7CB
	movq	%rdi, -16(%rbp)
	movq	img, %rax
	movq	14160(%rax), %rax
	movq	32(%rax), %rax
...
.LBB6_19:                               # %if.end41
	...
	movq	%rax, 344(%rcx)
.LBB6_20:                               # %return
	cmpl	$1805776843, -44(%rbp)  # imm = 0x6BA1F7CB
	jne	.LBB6_22
.LBB6_21:
	addq	$96, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$96, %rsp
	movl	$1128458992, -44(%rbp)  # imm = 0x4342EAF0
	movq	%rdi, -16(%rbp)
	movq	img, %rax
	movq	14160(%rax), %rax
	movq	32(%rax), %rax
...
.LBB7_19:                               # %if.end41
	...
	movq	%rax, 504(%rcx)
.LBB7_20:                               # %return
	cmpl	$1128458992, -44(%rbp)  # imm = 0x4342EAF0
	jne	.LBB7_22
.LBB7_21:
	addq	$96, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$96, %rsp
	movl	$1143224681, -44(%rbp)  # imm = 0x44243969
	movq	%rdi, -16(%rbp)
	movq	img, %rax
	movq	14160(%rax), %rax
	movq	32(%rax), %rax
...
.LBB8_19:                               # %if.end41
	...
	movq	%rax, 504(%rcx)
.LBB8_20:                               # %return
	cmpl	$1143224681, -44(%rbp)  # imm = 0x44243969
	jne	.LBB8_22
.LBB8_21:
	addq	$96, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$96, %rsp
	movl	$634179039, -44(%rbp)   # imm = 0x25CCCDDF
	movq	%rdi, -16(%rbp)
	movq	img, %rax
	movq	14160(%rax), %rax
	movq	32(%rax), %rax
...
.LBB9_19:                               # %if.end41
	...
	movq	%rax, 504(%rcx)
.LBB9_20:                               # %return
	cmpl	$634179039, -44(%rbp)   # imm = 0x25CCCDDF
	jne	.LBB9_22
.LBB9_21:
	addq	$96, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$96, %rsp
	movl	$2137185265, -44(%rbp)  # imm = 0x7F62DBF1
	movq	%rdi, -16(%rbp)
	movq	img, %rax
	movq	14160(%rax), %rax
	movq	32(%rax), %rax
...
.LBB10_19:                              # %if.end41
	...
	movq	%rax, 344(%rcx)
.LBB10_20:                              # %return
	cmpl	$2137185265, -44(%rbp)  # imm = 0x7F62DBF1
	jne	.LBB10_22
.LBB10_21:
	addq	$96, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$96, %rsp
	movl	$1609449288, -44(%rbp)  # imm = 0x5FEE3F48
	movq	%rdi, -16(%rbp)
	movq	img, %rax
	movq	14160(%rax), %rax
	movq	32(%rax), %rax
...
.LBB11_19:                              # %if.end41
	...
	movq	%rax, 344(%rcx)
.LBB11_20:                              # %return
	cmpl	$1609449288, -44(%rbp)  # imm = 0x5FEE3F48
	jne	.LBB11_22
.LBB11_21:
	addq	$96, %rsp
	popq	%rbp
