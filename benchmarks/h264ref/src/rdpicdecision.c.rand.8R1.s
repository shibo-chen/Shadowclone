...
.LBB1_4:                                # %func_picture_coding_decision.10
	...
	.cfi_def_cfa %rsp, 8
	retq
.LBB1_5:                                # %func_picture_coding_decision.12
	.cfi_def_cfa %rbp, 16
	movq	%rbx, %rdi
	movq	%r15, %rsi
	movl	%r14d, %edx
	...
	.cfi_def_cfa %rsp, 8
	retq
.LBB1_6:                                # %func_picture_coding_decision.13
	.cfi_def_cfa %rbp, 16
	movq	%rbx, %rdi
	movq	%r15, %rsi
	movl	%r14d, %edx
...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$181462096, -24(%rbp)   # imm = 0xAD0E450
	vmovsd	%xmm0, -32(%rbp)
	vmovsd	%xmm1, -40(%rbp)
	movl	%edi, -16(%rbp)
	movl	%esi, -20(%rbp)
...
.LBB2_5:                                # %return
	movl	-12(%rbp), %ebx
	cmpl	$181462096, -24(%rbp)   # imm = 0xAD0E450
	jne	.LBB2_7
.LBB2_6:
	movl	%ebx, %eax
	addq	$56, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$464969794, -24(%rbp)   # imm = 0x1BB6E042
	vmovsd	%xmm0, -48(%rbp)
	vmovsd	%xmm1, -64(%rbp)
	movl	%edi, -16(%rbp)
	movl	%esi, -20(%rbp)
...
.LBB3_5:                                # %return
	movl	-12(%rbp), %ebx
	cmpl	$464969794, -24(%rbp)   # imm = 0x1BB6E042
	jne	.LBB3_7
.LBB3_6:
	movl	%ebx, %eax
	addq	$56, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$1721764064, -20(%rbp)  # imm = 0x66A008E0
	vmovsd	%xmm0, -64(%rbp)
	vmovsd	%xmm1, -40(%rbp)
	movl	%edi, -24(%rbp)
	movl	%esi, -16(%rbp)
...
.LBB4_5:                                # %return
	movl	-12(%rbp), %ebx
	cmpl	$1721764064, -20(%rbp)  # imm = 0x66A008E0
	jne	.LBB4_7
.LBB4_6:
	movl	%ebx, %eax
	addq	$56, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$1980787149, -20(%rbp)  # imm = 0x761069CD
	vmovsd	%xmm0, -64(%rbp)
	vmovsd	%xmm1, -40(%rbp)
	movl	%edi, -16(%rbp)
	movl	%esi, -24(%rbp)
...
.LBB5_5:                                # %return
	movl	-12(%rbp), %ebx
	cmpl	$1980787149, -20(%rbp)  # imm = 0x761069CD
	jne	.LBB5_7
.LBB5_6:
	movl	%ebx, %eax
	addq	$56, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$1972634453, -24(%rbp)  # imm = 0x75940355
	vmovsd	%xmm0, -32(%rbp)
	vmovsd	%xmm1, -40(%rbp)
	movl	%edi, -16(%rbp)
	movl	%esi, -20(%rbp)
...
.LBB6_5:                                # %return
	movl	-12(%rbp), %ebx
	cmpl	$1972634453, -24(%rbp)  # imm = 0x75940355
	jne	.LBB6_7
.LBB6_6:
	movl	%ebx, %eax
	addq	$56, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$72, %rsp
	.cfi_offset %rbx, -24
	movl	$1010611057, -44(%rbp)  # imm = 0x3C3CB371
	movq	%rdi, -24(%rbp)
	movq	%rsi, -32(%rbp)
	movl	%edx, -12(%rbp)
	movq	img, %rax
...
.LBB7_5:                                # %if.end
	...
	movl	%eax, %ebx
	cmpl	$1010611057, -44(%rbp)  # imm = 0x3C3CB371
	jne	.LBB7_7
.LBB7_6:
	movl	%ebx, %eax
	addq	$72, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$72, %rsp
	.cfi_offset %rbx, -24
	movl	$1106886988, -52(%rbp)  # imm = 0x41F9C14C
	movq	%rdi, -24(%rbp)
	movq	%rsi, -32(%rbp)
	movl	%edx, -12(%rbp)
	movq	img, %rax
...
.LBB8_5:                                # %if.end
	...
	callq	rd_pic_decision
	movl	%eax, %ebx
	cmpl	$1106886988, -52(%rbp)  # imm = 0x41F9C14C
	jne	.LBB8_7
.LBB8_6:
	movl	%ebx, %eax
	addq	$72, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$72, %rsp
	.cfi_offset %rbx, -24
	movl	$1362174538, -40(%rbp)  # imm = 0x5131224A
	movq	%rdi, -24(%rbp)
	movq	%rsi, -32(%rbp)
	movl	%edx, -12(%rbp)
	movq	img, %rax
...
.LBB9_5:                                # %if.end
	...
	callq	rd_pic_decision
	movl	%eax, %ebx
	cmpl	$1362174538, -40(%rbp)  # imm = 0x5131224A
	jne	.LBB9_7
.LBB9_6:
	movl	%ebx, %eax
	addq	$72, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$862617983, -24(%rbp)   # imm = 0x336A817F
	vmovsd	%xmm0, -32(%rbp)
	vmovsd	%xmm1, -56(%rbp)
	movl	%edi, -20(%rbp)
	movl	%esi, -16(%rbp)
...
.LBB10_5:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$862617983, -24(%rbp)   # imm = 0x336A817F
	jne	.LBB10_7
.LBB10_6:
	movl	%ebx, %eax
	addq	$56, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$72, %rsp
	.cfi_offset %rbx, -24
	movl	$1128712137, -40(%rbp)  # imm = 0x4346C7C9
	movq	%rdi, -24(%rbp)
	movq	%rsi, -32(%rbp)
	movl	%edx, -12(%rbp)
	movq	img, %rax
...
.LBB11_5:                               # %if.end
	...
	callq	rd_pic_decision
	movl	%eax, %ebx
	cmpl	$1128712137, -40(%rbp)  # imm = 0x4346C7C9
	jne	.LBB11_7
.LBB11_6:
	movl	%ebx, %eax
	addq	$72, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$1058339722, -16(%rbp)  # imm = 0x3F14FB8A
	vmovsd	%xmm0, -40(%rbp)
	vmovsd	%xmm1, -32(%rbp)
	movl	%edi, -24(%rbp)
	movl	%esi, -20(%rbp)
...
.LBB12_5:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$1058339722, -16(%rbp)  # imm = 0x3F14FB8A
	jne	.LBB12_7
.LBB12_6:
	movl	%ebx, %eax
	addq	$56, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$72, %rsp
	.cfi_offset %rbx, -24
	movl	$1285829398, -52(%rbp)  # imm = 0x4CA43316
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movl	%edx, -12(%rbp)
	movq	img, %rax
...
.LBB13_5:                               # %if.end
	...
	callq	rd_pic_decision
	movl	%eax, %ebx
	cmpl	$1285829398, -52(%rbp)  # imm = 0x4CA43316
	jne	.LBB13_7
.LBB13_6:
	movl	%ebx, %eax
	addq	$72, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$72, %rsp
	.cfi_offset %rbx, -24
	movl	$803308036, -48(%rbp)   # imm = 0x2FE18204
	movq	%rdi, -24(%rbp)
	movq	%rsi, -32(%rbp)
	movl	%edx, -12(%rbp)
	movq	img, %rax
...
.LBB14_5:                               # %if.end
	...
	callq	rd_pic_decision
	movl	%eax, %ebx
	cmpl	$803308036, -48(%rbp)   # imm = 0x2FE18204
	jne	.LBB14_7
.LBB14_6:
	movl	%ebx, %eax
	addq	$72, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$629446625, -20(%rbp)   # imm = 0x258497E1
	vmovsd	%xmm0, -48(%rbp)
	vmovsd	%xmm1, -64(%rbp)
	movl	%edi, -24(%rbp)
	movl	%esi, -16(%rbp)
...
.LBB15_5:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$629446625, -20(%rbp)   # imm = 0x258497E1
	jne	.LBB15_7
.LBB15_6:
	movl	%ebx, %eax
	addq	$56, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$72, %rsp
	.cfi_offset %rbx, -24
	movl	$1990894949, -40(%rbp)  # imm = 0x76AAA565
	movq	%rdi, -24(%rbp)
	movq	%rsi, -32(%rbp)
	movl	%edx, -12(%rbp)
	movq	img, %rax
...
.LBB16_5:                               # %if.end
	...
	callq	rd_pic_decision
	movl	%eax, %ebx
	cmpl	$1990894949, -40(%rbp)  # imm = 0x76AAA565
	jne	.LBB16_7
.LBB16_6:
	movl	%ebx, %eax
	addq	$72, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$72, %rsp
	.cfi_offset %rbx, -24
	movl	$568129103, -48(%rbp)   # imm = 0x21DCF64F
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movl	%edx, -12(%rbp)
	movq	img, %rax
...
.LBB17_5:                               # %if.end
	...
	callq	rd_pic_decision
	movl	%eax, %ebx
	cmpl	$568129103, -48(%rbp)   # imm = 0x21DCF64F
	jne	.LBB17_7
.LBB17_6:
	movl	%ebx, %eax
	addq	$72, %rsp
