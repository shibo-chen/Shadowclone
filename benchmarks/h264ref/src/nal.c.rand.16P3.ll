...
func_RBSPtoEBSP.4:                                ; preds = %ctrl2
  %5 = call i32 @RBSPtoEBSP.4(i8* %streamBuffer, i32 %begin_bytepos, i32 %end_bytepos, i32 %min_num_bytes)
  ret i32 %5

func_RBSPtoEBSP.5:                                ; preds = %ctrl3
  %6 = call i32 @RBSPtoEBSP.5(i8* %streamBuffer, i32 %begin_bytepos, i32 %end_bytepos, i32 %min_num_bytes)
  ret i32 %6

func_RBSPtoEBSP.6:                                ; preds = %ctrl4
  %7 = call i32 @RBSPtoEBSP.6(i8* %streamBuffer, i32 %begin_bytepos, i32 %end_bytepos, i32 %min_num_bytes)
  ret i32 %7

func_RBSPtoEBSP.7:                                ; preds = %ctrl5
  %8 = call i32 @RBSPtoEBSP.7(i8* %streamBuffer, i32 %begin_bytepos, i32 %end_bytepos, i32 %min_num_bytes)
  ret i32 %8

func_RBSPtoEBSP.8:                                ; preds = %ctrl6
  %9 = call i32 @RBSPtoEBSP.8(i8* %streamBuffer, i32 %begin_bytepos, i32 %end_bytepos, i32 %min_num_bytes)
  ret i32 %9

func_RBSPtoEBSP.9:                                ; preds = %ctrl7
  %10 = call i32 @RBSPtoEBSP.9(i8* %streamBuffer, i32 %begin_bytepos, i32 %end_bytepos, i32 %min_num_bytes)
  ret i32 %10

func_RBSPtoEBSP.10:                               ; preds = %ctrl8
  %11 = call i32 @RBSPtoEBSP.10(i8* %streamBuffer, i32 %begin_bytepos, i32 %end_bytepos, i32 %min_num_bytes)
  ret i32 %11

func_RBSPtoEBSP.11:                               ; preds = %ctrl9
  %12 = call i32 @RBSPtoEBSP.11(i8* %streamBuffer, i32 %begin_bytepos, i32 %end_bytepos, i32 %min_num_bytes)
  ret i32 %12

func_RBSPtoEBSP.12:                               ; preds = %ctrl10
  %13 = call i32 @RBSPtoEBSP.12(i8* %streamBuffer, i32 %begin_bytepos, i32 %end_bytepos, i32 %min_num_bytes)
  ret i32 %13

func_RBSPtoEBSP.13:                               ; preds = %ctrl11
  %14 = call i32 @RBSPtoEBSP.13(i8* %streamBuffer, i32 %begin_bytepos, i32 %end_bytepos, i32 %min_num_bytes)
  ret i32 %14

func_RBSPtoEBSP.14:                               ; preds = %ctrl12
  %15 = call i32 @RBSPtoEBSP.14(i8* %streamBuffer, i32 %begin_bytepos, i32 %end_bytepos, i32 %min_num_bytes)
  ret i32 %15

func_RBSPtoEBSP.15:                               ; preds = %ctrl13
  %16 = call i32 @RBSPtoEBSP.15(i8* %streamBuffer, i32 %begin_bytepos, i32 %end_bytepos, i32 %min_num_bytes)
  ret i32 %16

func_RBSPtoEBSP.16:                               ; preds = %ctrl13
  %17 = call i32 @RBSPtoEBSP.16(i8* %streamBuffer, i32 %begin_bytepos, i32 %end_bytepos, i32 %min_num_bytes)
  ret i32 %17

ctrl0:                                            ; preds = %rand_bb
  %18 = icmp eq i32 %0, 1
  br i1 %18, label %func_RBSPtoEBSP.2, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %19 = icmp eq i32 %0, 2
  br i1 %19, label %func_RBSPtoEBSP.3, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %20 = icmp eq i32 %0, 3
  br i1 %20, label %func_RBSPtoEBSP.4, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %21 = icmp eq i32 %0, 4
  br i1 %21, label %func_RBSPtoEBSP.5, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %22 = icmp eq i32 %0, 5
  br i1 %22, label %func_RBSPtoEBSP.6, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %23 = icmp eq i32 %0, 6
  br i1 %23, label %func_RBSPtoEBSP.7, label %ctrl6

ctrl6:                                            ; preds = %ctrl5
  %24 = icmp eq i32 %0, 7
  br i1 %24, label %func_RBSPtoEBSP.8, label %ctrl7

ctrl7:                                            ; preds = %ctrl6
  %25 = icmp eq i32 %0, 8
  br i1 %25, label %func_RBSPtoEBSP.9, label %ctrl8

ctrl8:                                            ; preds = %ctrl7
  %26 = icmp eq i32 %0, 9
  br i1 %26, label %func_RBSPtoEBSP.10, label %ctrl9

ctrl9:                                            ; preds = %ctrl8
  %27 = icmp eq i32 %0, 10
  br i1 %27, label %func_RBSPtoEBSP.11, label %ctrl10

ctrl10:                                           ; preds = %ctrl9
  %28 = icmp eq i32 %0, 11
  br i1 %28, label %func_RBSPtoEBSP.12, label %ctrl11

ctrl11:                                           ; preds = %ctrl10
  %29 = icmp eq i32 %0, 12
  br i1 %29, label %func_RBSPtoEBSP.13, label %ctrl12

ctrl12:                                           ; preds = %ctrl11
  %30 = icmp eq i32 %0, 13
  br i1 %30, label %func_RBSPtoEBSP.14, label %ctrl13

ctrl13:                                           ; preds = %ctrl12
  %31 = icmp eq i32 %0, 14
  br i1 %31, label %func_RBSPtoEBSP.15, label %func_RBSPtoEBSP.16
}
...
entry:
  ...
  %canary = alloca i32
  store i32 281279518, i32* %canary
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 355887716, i32* %canary
  %count = alloca i32, align 4
  %end_bytepos.addr = alloca i32, align 4
  store i8* %streamBuffer, i8** %streamBuffer.addr, align 8
  store i32 %begin_bytepos, i32* %begin_bytepos.addr, align 4
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1925187996, i32* %canary
  %i = alloca i32, align 4
  %end_bytepos.addr = alloca i32, align 4
  %count = alloca i32, align 4
  %begin_bytepos.addr = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1932962199, i32* %canary
  %streamBuffer.addr = alloca i8*, align 8
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %end_bytepos.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @RBSPtoEBSP.5(i8* %streamBuffer, i32 %begin_bytepos, i32 %end_bytepos, i32 %min_num_bytes) #0 {
entry:
  %begin_bytepos.addr = alloca i32, align 4
  %min_num_bytes.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1264933704, i32* %canary
  %count = alloca i32, align 4
  %end_bytepos.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %j = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @RBSPtoEBSP.6(i8* %streamBuffer, i32 %begin_bytepos, i32 %end_bytepos, i32 %min_num_bytes) #0 {
entry:
  %i = alloca i32, align 4
  %count = alloca i32, align 4
  %min_num_bytes.addr = alloca i32, align 4
  ...
  %end_bytepos.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1776816886, i32* %canary
  %j = alloca i32, align 4
  store i8* %streamBuffer, i8** %streamBuffer.addr, align 8
  store i32 %begin_bytepos, i32* %begin_bytepos.addr, align 4
  store i32 %end_bytepos, i32* %end_bytepos.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @RBSPtoEBSP.7(i8* %streamBuffer, i32 %begin_bytepos, i32 %end_bytepos, i32 %min_num_bytes) #0 {
entry:
  %count = alloca i32, align 4
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 2032659276, i32* %canary
  %streamBuffer.addr = alloca i8*, align 8
  %begin_bytepos.addr = alloca i32, align 4
  %end_bytepos.addr = alloca i32, align 4
  %min_num_bytes.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @RBSPtoEBSP.8(i8* %streamBuffer, i32 %begin_bytepos, i32 %end_bytepos, i32 %min_num_bytes) #0 {
entry:
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %end_bytepos.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 425475714, i32* %canary
  %min_num_bytes.addr = alloca i32, align 4
  %begin_bytepos.addr = alloca i32, align 4
  %streamBuffer.addr = alloca i8*, align 8
  %count = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @RBSPtoEBSP.9(i8* %streamBuffer, i32 %begin_bytepos, i32 %end_bytepos, i32 %min_num_bytes) #0 {
entry:
  %min_num_bytes.addr = alloca i32, align 4
  %j = alloca i32, align 4
  %count = alloca i32, align 4
  ...
  %begin_bytepos.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1490644688, i32* %canary
  %streamBuffer.addr = alloca i8*, align 8
  %i = alloca i32, align 4
  store i8* %streamBuffer, i8** %streamBuffer.addr, align 8
  store i32 %begin_bytepos, i32* %begin_bytepos.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @RBSPtoEBSP.10(i8* %streamBuffer, i32 %begin_bytepos, i32 %end_bytepos, i32 %min_num_bytes) #0 {
entry:
  %min_num_bytes.addr = alloca i32, align 4
  %streamBuffer.addr = alloca i8*, align 8
  %begin_bytepos.addr = alloca i32, align 4
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 465426692, i32* %canary
  %i = alloca i32, align 4
  %end_bytepos.addr = alloca i32, align 4
  %count = alloca i32, align 4
  store i8* %streamBuffer, i8** %streamBuffer.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @RBSPtoEBSP.11(i8* %streamBuffer, i32 %begin_bytepos, i32 %end_bytepos, i32 %min_num_bytes) #0 {
entry:
  %canary = alloca i32
  store i32 862557923, i32* %canary
  %end_bytepos.addr = alloca i32, align 4
  %count = alloca i32, align 4
  %begin_bytepos.addr = alloca i32, align 4
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @RBSPtoEBSP.12(i8* %streamBuffer, i32 %begin_bytepos, i32 %end_bytepos, i32 %min_num_bytes) #0 {
entry:
  %begin_bytepos.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %min_num_bytes.addr = alloca i32, align 4
  %end_bytepos.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1339371901, i32* %canary
  %streamBuffer.addr = alloca i8*, align 8
  %count = alloca i32, align 4
  %j = alloca i32, align 4
  store i8* %streamBuffer, i8** %streamBuffer.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @RBSPtoEBSP.13(i8* %streamBuffer, i32 %begin_bytepos, i32 %end_bytepos, i32 %min_num_bytes) #0 {
entry:
  %end_bytepos.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 2137240299, i32* %canary
  %begin_bytepos.addr = alloca i32, align 4
  %count = alloca i32, align 4
  %j = alloca i32, align 4
  %min_num_bytes.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @RBSPtoEBSP.14(i8* %streamBuffer, i32 %begin_bytepos, i32 %end_bytepos, i32 %min_num_bytes) #0 {
entry:
  %i = alloca i32, align 4
  %min_num_bytes.addr = alloca i32, align 4
  %begin_bytepos.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2040430640, i32* %canary
  %end_bytepos.addr = alloca i32, align 4
  %j = alloca i32, align 4
  %streamBuffer.addr = alloca i8*, align 8
  %count = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @RBSPtoEBSP.15(i8* %streamBuffer, i32 %begin_bytepos, i32 %end_bytepos, i32 %min_num_bytes) #0 {
entry:
  %begin_bytepos.addr = alloca i32, align 4
  %end_bytepos.addr = alloca i32, align 4
  %count = alloca i32, align 4
  ...
  %min_num_bytes.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1491875697, i32* %canary
  %j = alloca i32, align 4
  %i = alloca i32, align 4
  store i8* %streamBuffer, i8** %streamBuffer.addr, align 8
  store i32 %begin_bytepos, i32* %begin_bytepos.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @RBSPtoEBSP.16(i8* %streamBuffer, i32 %begin_bytepos, i32 %end_bytepos, i32 %min_num_bytes) #0 {
entry:
  %i = alloca i32, align 4
  %streamBuffer.addr = alloca i8*, align 8
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 916831705, i32* %canary
  %count = alloca i32, align 4
  %begin_bytepos.addr = alloca i32, align 4
  %end_bytepos.addr = alloca i32, align 4
  %min_num_bytes.addr = alloca i32, align 4
