...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_testEndian.13, label %func_testEndian.17

func_testEndian.13:                               ; preds = %rand_bb
  %2 = call i32 @testEndian.13()
  ret i32 %2
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_img2buf.12, label %ctrl0

func_img2buf.12:                                  ; preds = %rand_bb
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_img2buf.16, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_img2buf.20, label %func_img2buf.23
}
...
func_write_picture.3:                             ; preds = %ctrl0
  call void @write_picture.3(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure)
  ret void

func_write_picture.10:                            ; preds = %ctrl1
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_write_picture.3, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_write_picture.10, label %func_write_picture.15
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_write_out_picture.8, label %ctrl0

func_write_out_picture.8:                         ; preds = %rand_bb
  call void @write_out_picture.8(%struct.storable_picture* %p, i32 %p_out)
  ret void

func_write_out_picture.14:                        ; preds = %ctrl0
  call void @write_out_picture.14(%struct.storable_picture* %p, i32 %p_out)
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_write_out_picture.14, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_write_out_picture.18, label %func_write_out_picture.24
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_clear_picture.5, label %func_clear_picture.6
...
func_write_unpaired_field.19:                     ; preds = %ctrl0
  call void @write_unpaired_field.19(%struct.frame_store* %fs, i32 %p_out)
  ret void

func_write_unpaired_field.21:                     ; preds = %ctrl1
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_write_unpaired_field.19, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_write_unpaired_field.21, label %func_write_unpaired_field.22
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_write_stored_frame.2, label %func_write_stored_frame.7

func_write_stored_frame.2:                        ; preds = %rand_bb
  call void @write_stored_frame.2(%struct.frame_store* %fs, i32 %p_out)
  ret void
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_direct_output.4, label %func_direct_output.9

func_direct_output.4:                             ; preds = %rand_bb
  call void @direct_output.4(%struct.storable_picture* %p, i32 %p_out)
  ret void

func_direct_output.9:                             ; preds = %rand_bb
  call void @direct_output.9(%struct.storable_picture* %p, i32 %p_out)
  ret void
}
...
entry:
  ...
  %canary = alloca i32
  store i32 183478823, i32* %canary
  %p_out.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_stored_frame.2(%struct.frame_store* %fs, i32 %p_out) #0 {
entry:
  %canary = alloca i32
  store i32 396627610, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_picture.3(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure) #0 {
entry:
  %p_out.addr = alloca i32, align 4
  %real_structure.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 705298512, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  store i32 %real_structure, i32* %real_structure.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 1447527859, i32* %canary
  %p_out.addr = alloca i32, align 4
  %p.addr = alloca %struct.storable_picture*, align 8
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 1584471528, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1148202345, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  %i = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 0, i32* %i, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 1293996247, i32* %canary
  %p_out.addr = alloca i32, align 4
...
return:                                           ; preds = %if.end139, %if.then
  ...
  %193 = icmp eq i32 %192, 1293996247
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @direct_output.9(%struct.storable_picture* %p, i32 %p_out) #0 {
entry:
  %p.addr = alloca %struct.storable_picture*, align 8
  %canary = alloca i32
  store i32 108266296, i32* %canary
  %p_out.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  %0 = load %struct.storable_picture*, %struct.storable_picture** %p.addr, align 8
...
entry:
  %real_structure.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2098829947, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  %p_out.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 1661618521, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1275229207, i32* %canary
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  ...
  %109 = icmp eq i32 %108, 1275229207
...
entry:
  ...
  %canary = alloca i32
  store i32 1870640637, i32* %canary
  %p = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_out_picture.14(%struct.storable_picture* %p, i32 %p_out) #0 {
entry:
  %SubHeightC = alloca [4 x i32], align 16
  %rgb_output = alloca i32, align 4
  %p_out.addr = alloca i32, align 4
  ...
  %symbol_size_in_bytes = alloca i32, align 4
  %canary = alloca i32
  store i32 721447155, i32* %canary
  %crop_top = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  %0 = bitcast [4 x i32]* %SubWidthC to i8*
...
entry:
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 708397297, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  %real_structure.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  ...
  %crop_top.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 475234571, i32* %canary
  %crop_left.addr = alloca i32, align 4
  %size = alloca i32, align 4
  %symbol_size_in_bytes.addr = alloca i32, align 4
  %size_x.addr = alloca i32, align 4
...
entry:
  %p = alloca i8*, align 8
  %canary = alloca i32
  store i32 1063247233, i32* %canary
  %s = alloca i16, align 2
  %0 = bitcast i16* %s to i8*
  store i8* %0, i8** %p, align 8
  store i16 1, i16* %s, align 2
...
entry:
  %rgb_output = alloca i32, align 4
  %canary = alloca i32
  store i32 320648966, i32* %canary
  %crop_right = alloca i32, align 4
  %crop_left = alloca i32, align 4
  %p.addr = alloca %struct.storable_picture*, align 8
  %buf = alloca i8*, align 8
...
entry:
  ...
  %p = alloca %struct.storable_picture*, align 8
  %canary = alloca i32
  store i32 882571280, i32* %canary
  %fs.addr = alloca %struct.frame_store*, align 8
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  %0 = load %struct.frame_store*, %struct.frame_store** %fs.addr, align 8
...
entry:
  %ui8 = alloca i8, align 1
  %canary = alloca i32
  store i32 1773430593, i32* %canary
  %theight = alloca i32, align 4
  %crop_left.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %tmp32 = alloca i64, align 8
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1773430593
  br i1 %109, label %110, label %func_exit
...
entry:
  %p = alloca %struct.storable_picture*, align 8
  %canary = alloca i32
  store i32 1501666517, i32* %canary
  %fs.addr = alloca %struct.frame_store*, align 8
  %p_out.addr = alloca i32, align 4
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 1250191302, i32* %canary
  %fs.addr = alloca %struct.frame_store*, align 8
  %p_out.addr = alloca i32, align 4
  %p = alloca %struct.storable_picture*, align 8
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 215651592, i32* %canary
  %size_y.addr = alloca i32, align 4
  %theight = alloca i32, align 4
  %size = alloca i32, align 4
  %crop_right.addr = alloca i32, align 4
...
entry:
  ...
  %SubWidthC = alloca [4 x i32], align 16
  %canary = alloca i32
  store i32 451656186, i32* %canary
  %symbol_size_in_bytes = alloca i32, align 4
  %p_out.addr = alloca i32, align 4
  %crop_bottom = alloca i32, align 4
  %rgb_output = alloca i32, align 4
