; ModuleID = 'biariencode.c.rand.8R1.bc'
...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_arienco_start_encoding.6, label %ctrl0

func_arienco_start_encoding.6:                    ; preds = %rand_bb
  call void @arienco_start_encoding.6(%struct.EncodingEnvironment* %eep, i8* %code_buffer, i32* %code_len, i32 %slice_type)
  ret void

func_arienco_start_encoding.17:                   ; preds = %ctrl0
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_arienco_start_encoding.17, label %ctrl1
...
ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_arienco_start_encoding.21, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_arienco_start_encoding.26, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_arienco_start_encoding.27, label %func_arienco_start_encoding.34
}
...
func_biari_encode_symbol.13:                      ; preds = %ctrl0
  call void @biari_encode_symbol.13(%struct.EncodingEnvironment* %eep, i16 %symbol, %struct.BiContextType* %bi_ct)
  ret void

func_biari_encode_symbol.16:                      ; preds = %ctrl1
  call void @biari_encode_symbol.16(%struct.EncodingEnvironment* %eep, i16 %symbol, %struct.BiContextType* %bi_ct)
  ret void

func_biari_encode_symbol.22:                      ; preds = %ctrl2
  call void @biari_encode_symbol.22(%struct.EncodingEnvironment* %eep, i16 %symbol, %struct.BiContextType* %bi_ct)
  ret void

func_biari_encode_symbol.24:                      ; preds = %ctrl3
  call void @biari_encode_symbol.24(%struct.EncodingEnvironment* %eep, i16 %symbol, %struct.BiContextType* %bi_ct)
  ret void

func_biari_encode_symbol.25:                      ; preds = %ctrl4
...
func_biari_encode_symbol.32:                      ; preds = %ctrl5
  call void @biari_encode_symbol.32(%struct.EncodingEnvironment* %eep, i16 %symbol, %struct.BiContextType* %bi_ct)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_biari_encode_symbol.13, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_biari_encode_symbol.16, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_biari_encode_symbol.22, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_biari_encode_symbol.24, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_biari_encode_symbol.25, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_biari_encode_symbol.29, label %func_biari_encode_symbol.32
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_biari_encode_symbol_eq_prob.10, label %ctrl0

func_biari_encode_symbol_eq_prob.10:              ; preds = %rand_bb
  call void @biari_encode_symbol_eq_prob.10(%struct.EncodingEnvironment* %eep, i16 %symbol)
  ret void

func_biari_encode_symbol_eq_prob.12:              ; preds = %ctrl0
  call void @biari_encode_symbol_eq_prob.12(%struct.EncodingEnvironment* %eep, i16 %symbol)
  ret void

func_biari_encode_symbol_eq_prob.14:              ; preds = %ctrl1
  call void @biari_encode_symbol_eq_prob.14(%struct.EncodingEnvironment* %eep, i16 %symbol)
  ret void

func_biari_encode_symbol_eq_prob.20:              ; preds = %ctrl2
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_biari_encode_symbol_eq_prob.12, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_biari_encode_symbol_eq_prob.14, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_biari_encode_symbol_eq_prob.20, label %ctrl3
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_biari_encode_symbol_final.3, label %ctrl0

func_biari_encode_symbol_final.3:                 ; preds = %rand_bb
  call void @biari_encode_symbol_final.3(%struct.EncodingEnvironment* %eep, i16 %symbol)
  ret void

func_biari_encode_symbol_final.5:                 ; preds = %ctrl0
  call void @biari_encode_symbol_final.5(%struct.EncodingEnvironment* %eep, i16 %symbol)
  ret void

func_biari_encode_symbol_final.11:                ; preds = %ctrl1
  call void @biari_encode_symbol_final.11(%struct.EncodingEnvironment* %eep, i16 %symbol)
  ret void

func_biari_encode_symbol_final.15:                ; preds = %ctrl2
  call void @biari_encode_symbol_final.15(%struct.EncodingEnvironment* %eep, i16 %symbol)
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_biari_encode_symbol_final.5, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_biari_encode_symbol_final.11, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_biari_encode_symbol_final.15, label %ctrl3
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_biari_init_context.1, label %ctrl0

func_biari_init_context.1:                        ; preds = %rand_bb
  call void @biari_init_context.1(%struct.BiContextType* %ctx, i32* %ini)
  ret void

func_biari_init_context.2:                        ; preds = %ctrl0
  call void @biari_init_context.2(%struct.BiContextType* %ctx, i32* %ini)
  ret void

func_biari_init_context.4:                        ; preds = %ctrl1
  call void @biari_init_context.4(%struct.BiContextType* %ctx, i32* %ini)
  ret void

func_biari_init_context.8:                        ; preds = %ctrl2
  call void @biari_init_context.8(%struct.BiContextType* %ctx, i32* %ini)
  ret void

func_biari_init_context.9:                        ; preds = %ctrl3
  call void @biari_init_context.9(%struct.BiContextType* %ctx, i32* %ini)
  ret void

func_biari_init_context.23:                       ; preds = %ctrl3
  call void @biari_init_context.23(%struct.BiContextType* %ctx, i32* %ini)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_biari_init_context.2, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_biari_init_context.4, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_biari_init_context.8, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_biari_init_context.9, label %func_biari_init_context.23
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_init_context.1(%struct.BiContextType* %ctx, i32* %ini) #0 {
entry:
  %ini.addr = alloca i32*, align 8
  %pstate = alloca i32, align 4
  %canary = alloca i32
  store i32 914218241, i32* %canary
...
entry:
  ...
  %ctx.addr = alloca %struct.BiContextType*, align 8
  %canary = alloca i32
  store i32 204631665, i32* %canary
  %pstate = alloca i32, align 4
  store %struct.BiContextType* %ctx, %struct.BiContextType** %ctx.addr, align 8
  store i32* %ini, i32** %ini.addr, align 8
  %0 = load i32*, i32** %ini.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_encode_symbol_final.3(%struct.EncodingEnvironment* %eep, i16 signext %symbol) #0 {
entry:
  %range = alloca i32, align 4
  %canary = alloca i32
  store i32 3585410, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1055772554, i32* %canary
  %ctx.addr = alloca %struct.BiContextType*, align 8
  %pstate = alloca i32, align 4
  %ini.addr = alloca i32*, align 8
  store %struct.BiContextType* %ctx, %struct.BiContextType** %ctx.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_encode_symbol_final.5(%struct.EncodingEnvironment* %eep, i16 signext %symbol) #0 {
entry:
  %symbol.addr = alloca i16, align 2
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 133161447, i32* %canary
  %low = alloca i32, align 4
  %range = alloca i32, align 4
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @arienco_start_encoding.6(%struct.EncodingEnvironment* %eep, i8* %code_buffer, i32* %code_len, i32 %slice_type) #0 {
entry:
  %code_buffer.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1491540983, i32* %canary
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
...
entry:
  ...
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 647481147, i32* %canary
  %low = alloca i32, align 4
  %symbol.addr = alloca i16, align 2
  %range = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_init_context.8(%struct.BiContextType* %ctx, i32* %ini) #0 {
entry:
  %pstate = alloca i32, align 4
  %canary = alloca i32
  store i32 173497566, i32* %canary
  %ctx.addr = alloca %struct.BiContextType*, align 8
  %ini.addr = alloca i32*, align 8
  store %struct.BiContextType* %ctx, %struct.BiContextType** %ctx.addr, align 8
  store i32* %ini, i32** %ini.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_init_context.9(%struct.BiContextType* %ctx, i32* %ini) #0 {
entry:
  %pstate = alloca i32, align 4
  %ini.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 1699218983, i32* %canary
  %ctx.addr = alloca %struct.BiContextType*, align 8
  store %struct.BiContextType* %ctx, %struct.BiContextType** %ctx.addr, align 8
  store i32* %ini, i32** %ini.addr, align 8
  %0 = load i32*, i32** %ini.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 231537715, i32* %canary
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %low = alloca i32, align 4
  %symbol.addr = alloca i16, align 2
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
...
entry:
  ...
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 1932021256, i32* %canary
  %range = alloca i32, align 4
  %low = alloca i32, align 4
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
...
while.end125:                                     ; preds = %while.cond
  ...
  store i32 %inc129, i32* %C128, align 8
  %110 = load i32, i32* %canary
  %111 = icmp eq i32 %110, 1932021256
  br i1 %111, label %112, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_encode_symbol_eq_prob.12(%struct.EncodingEnvironment* %eep, i16 signext %symbol) #0 {
entry:
  %low = alloca i32, align 4
  %symbol.addr = alloca i16, align 2
  %canary = alloca i32
  store i32 1684816284, i32* %canary
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
  %0 = load %struct.EncodingEnvironment*, %struct.EncodingEnvironment** %eep.addr, align 8
...
if.end124:                                        ; preds = %if.end123, %while.end51
  ...
  store i32 %inc127, i32* %C126, align 8
  %104 = load i32, i32* %canary
  %105 = icmp eq i32 %104, 1684816284
  br i1 %105, label %106, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_encode_symbol.13(%struct.EncodingEnvironment* %eep, i16 signext %symbol, %struct.BiContextType* %bi_ct) #0 {
entry:
  %range = alloca i32, align 4
  %low = alloca i32, align 4
  %bi_ct.addr = alloca %struct.BiContextType*, align 8
  %symbol.addr = alloca i16, align 2
  %canary = alloca i32
  store i32 954597446, i32* %canary
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %rLPS = alloca i32, align 4
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
...
entry:
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 872793115, i32* %canary
  %symbol.addr = alloca i16, align 2
  %low = alloca i32, align 4
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_encode_symbol_final.15(%struct.EncodingEnvironment* %eep, i16 signext %symbol) #0 {
entry:
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %low = alloca i32, align 4
  %symbol.addr = alloca i16, align 2
  %canary = alloca i32
  store i32 633608057, i32* %canary
  %range = alloca i32, align 4
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
  %0 = load %struct.EncodingEnvironment*, %struct.EncodingEnvironment** %eep.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_encode_symbol.16(%struct.EncodingEnvironment* %eep, i16 signext %symbol, %struct.BiContextType* %bi_ct) #0 {
entry:
  %bi_ct.addr = alloca %struct.BiContextType*, align 8
  %low = alloca i32, align 4
  %rLPS = alloca i32, align 4
  ...
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 1889972127, i32* %canary
  %symbol.addr = alloca i16, align 2
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
  store %struct.BiContextType* %bi_ct, %struct.BiContextType** %bi_ct.addr, align 8
...
while.end162:                                     ; preds = %while.cond
  ...
  store i32 %inc166, i32* %C165, align 8
  %136 = load i32, i32* %canary
  %137 = icmp eq i32 %136, 1889972127
  br i1 %137, label %138, label %func_exit
...
entry:
  ...
  %code_buffer.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1993400534, i32* %canary
  %code_len.addr = alloca i32*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i8* %code_buffer, i8** %code_buffer.addr, align 8
  store i32* %code_len, i32** %code_len.addr, align 8
...
entry:
  ...
  %code_buffer.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 380107623, i32* %canary
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %code_len.addr = alloca i32*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i8* %code_buffer, i8** %code_buffer.addr, align 8
...
entry:
  ...
  %code_len.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 544401271, i32* %canary
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i8* %code_buffer, i8** %code_buffer.addr, align 8
  store i32* %code_len, i32** %code_len.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 925815749, i32* %canary
  %symbol.addr = alloca i16, align 2
  %low = alloca i32, align 4
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
...
entry:
  ...
  %slice_type.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 569600780, i32* %canary
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %code_buffer.addr = alloca i8*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i8* %code_buffer, i8** %code_buffer.addr, align 8
...
entry:
  ...
  %low = alloca i32, align 4
  %canary = alloca i32
  store i32 168765163, i32* %canary
  %bi_ct.addr = alloca %struct.BiContextType*, align 8
  %symbol.addr = alloca i16, align 2
  %rLPS = alloca i32, align 4
  %range = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_init_context.23(%struct.BiContextType* %ctx, i32* %ini) #0 {
entry:
  %ctx.addr = alloca %struct.BiContextType*, align 8
  %canary = alloca i32
  store i32 503637048, i32* %canary
  %ini.addr = alloca i32*, align 8
  %pstate = alloca i32, align 4
  store %struct.BiContextType* %ctx, %struct.BiContextType** %ctx.addr, align 8
  store i32* %ini, i32** %ini.addr, align 8
...
entry:
  ...
  %bi_ct.addr = alloca %struct.BiContextType*, align 8
  %canary = alloca i32
  store i32 2129029334, i32* %canary
  %rLPS = alloca i32, align 4
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
  store %struct.BiContextType* %bi_ct, %struct.BiContextType** %bi_ct.addr, align 8
...
while.end162:                                     ; preds = %while.cond
  ...
  store i32 %inc166, i32* %C165, align 8
  %136 = load i32, i32* %canary
  %137 = icmp eq i32 %136, 2129029334
  br i1 %137, label %138, label %func_exit
...
entry:
  ...
  %range = alloca i32, align 4
  %canary = alloca i32
  store i32 1022325718, i32* %canary
  %low = alloca i32, align 4
  %rLPS = alloca i32, align 4
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
...
while.end162:                                     ; preds = %while.cond
  ...
  store i32 %inc166, i32* %C165, align 8
  %136 = load i32, i32* %canary
  %137 = icmp eq i32 %136, 1022325718
  br i1 %137, label %138, label %func_exit
...
entry:
  ...
  %slice_type.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1254962387, i32* %canary
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %code_len.addr = alloca i32*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i8* %code_buffer, i8** %code_buffer.addr, align 8
...
entry:
  ...
  %code_len.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 1594007218, i32* %canary
  %code_buffer.addr = alloca i8*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i8* %code_buffer, i8** %code_buffer.addr, align 8
  store i32* %code_len, i32** %code_len.addr, align 8
...
entry:
  %low = alloca i32, align 4
  %canary = alloca i32
  store i32 668182386, i32* %canary
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %symbol.addr = alloca i16, align 2
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
...
entry:
  ...
  %range = alloca i32, align 4
  %canary = alloca i32
  store i32 528048340, i32* %canary
  %symbol.addr = alloca i16, align 2
  %rLPS = alloca i32, align 4
  %low = alloca i32, align 4
  %bi_ct.addr = alloca %struct.BiContextType*, align 8
...
entry:
  %canary = alloca i32
  store i32 1166923291, i32* %canary
  %low = alloca i32, align 4
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %symbol.addr = alloca i16, align 2
  %range = alloca i32, align 4
...
while.end125:                                     ; preds = %while.cond
  ...
  store i32 %inc129, i32* %C128, align 8
  %110 = load i32, i32* %canary
  %111 = icmp eq i32 %110, 1166923291
  br i1 %111, label %112, label %func_exit
...
entry:
  %canary = alloca i32
  store i32 219745751, i32* %canary
  %symbol.addr = alloca i16, align 2
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %low = alloca i32, align 4
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_encode_symbol.32(%struct.EncodingEnvironment* %eep, i16 signext %symbol, %struct.BiContextType* %bi_ct) #0 {
entry:
  %rLPS = alloca i32, align 4
  %symbol.addr = alloca i16, align 2
  %low = alloca i32, align 4
  ...
  %range = alloca i32, align 4
  %canary = alloca i32
  store i32 951744511, i32* %canary
  %bi_ct.addr = alloca %struct.BiContextType*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
  store %struct.BiContextType* %bi_ct, %struct.BiContextType** %bi_ct.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 376804467, i32* %canary
  %low = alloca i32, align 4
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %range = alloca i32, align 4
  %symbol.addr = alloca i16, align 2
...
entry:
  ...
  %code_len.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 459437674, i32* %canary
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %slice_type.addr = alloca i32, align 4
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i8* %code_buffer, i8** %code_buffer.addr, align 8
...
entry:
  ...
  %low = alloca i32, align 4
  %canary = alloca i32
  store i32 1714155050, i32* %canary
  %symbol.addr = alloca i16, align 2
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
...
while.end125:                                     ; preds = %while.cond
  ...
  store i32 %inc129, i32* %C128, align 8
  %110 = load i32, i32* %canary
  %111 = icmp eq i32 %110, 1714155050
  br i1 %111, label %112, label %func_exit
...
entry:
  %range = alloca i32, align 4
  %canary = alloca i32
  store i32 603855530, i32* %canary
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %low = alloca i32, align 4
  %symbol.addr = alloca i16, align 2
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
