; ModuleID = 'explicit_gop.c.rand.8R1.bc'
...
func_create_pyramid.11:                           ; preds = %ctrl0
  call void @create_pyramid.11()
  ret void

func_create_pyramid.18:                           ; preds = %ctrl1
  call void @create_pyramid.18()
  ret void
...
func_create_pyramid.22:                           ; preds = %ctrl3
  call void @create_pyramid.22()
  ret void

func_create_pyramid.25:                           ; preds = %ctrl4
  call void @create_pyramid.25()
  ret void

func_create_pyramid.27:                           ; preds = %ctrl5
  call void @create_pyramid.27()
  ret void

func_create_pyramid.30:                           ; preds = %ctrl5
  call void @create_pyramid.30()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_create_pyramid.11, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_create_pyramid.18, label %ctrl2
...
ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_create_pyramid.22, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_create_pyramid.25, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_create_pyramid.27, label %func_create_pyramid.30
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_gop_pyramid.2, label %ctrl0

func_gop_pyramid.2:                               ; preds = %rand_bb
  call void @gop_pyramid.2(i32 %level, i32 %frm_no, i32 %frames, %struct.GOP_DATA* %pyramid_structure)
  ret void

func_gop_pyramid.5:                               ; preds = %ctrl0
  call void @gop_pyramid.5(i32 %level, i32 %frm_no, i32 %frames, %struct.GOP_DATA* %pyramid_structure)
  ret void

func_gop_pyramid.7:                               ; preds = %ctrl1
  call void @gop_pyramid.7(i32 %level, i32 %frm_no, i32 %frames, %struct.GOP_DATA* %pyramid_structure)
  ret void
...
func_gop_pyramid.19:                              ; preds = %ctrl3
  call void @gop_pyramid.19(i32 %level, i32 %frm_no, i32 %frames, %struct.GOP_DATA* %pyramid_structure)
  ret void

func_gop_pyramid.24:                              ; preds = %ctrl4
  call void @gop_pyramid.24(i32 %level, i32 %frm_no, i32 %frames, %struct.GOP_DATA* %pyramid_structure)
  ret void

func_gop_pyramid.28:                              ; preds = %ctrl5
  call void @gop_pyramid.28(i32 %level, i32 %frm_no, i32 %frames, %struct.GOP_DATA* %pyramid_structure)
  ret void

func_gop_pyramid.31:                              ; preds = %ctrl5
  call void @gop_pyramid.31(i32 %level, i32 %frm_no, i32 %frames, %struct.GOP_DATA* %pyramid_structure)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_gop_pyramid.5, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_gop_pyramid.7, label %ctrl2
...
ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_gop_pyramid.19, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_gop_pyramid.24, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_gop_pyramid.28, label %func_gop_pyramid.31
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_interpret_gop_structure.3, label %ctrl0

func_interpret_gop_structure.3:                   ; preds = %rand_bb
  call void @interpret_gop_structure.3()
  ret void
...
func_interpret_gop_structure.10:                  ; preds = %ctrl1
  call void @interpret_gop_structure.10()
  ret void

func_interpret_gop_structure.13:                  ; preds = %ctrl2
  call void @interpret_gop_structure.13()
  ret void

func_interpret_gop_structure.14:                  ; preds = %ctrl3
  call void @interpret_gop_structure.14()
  ret void

func_interpret_gop_structure.16:                  ; preds = %ctrl4
  call void @interpret_gop_structure.16()
  ret void

func_interpret_gop_structure.26:                  ; preds = %ctrl5
  call void @interpret_gop_structure.26()
  ret void

func_interpret_gop_structure.29:                  ; preds = %ctrl5
  call void @interpret_gop_structure.29()
  ret void
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_interpret_gop_structure.10, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_interpret_gop_structure.13, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_interpret_gop_structure.14, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_interpret_gop_structure.16, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_interpret_gop_structure.26, label %func_interpret_gop_structure.29
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_poc_based_ref_management.4, label %ctrl0

func_poc_based_ref_management.4:                  ; preds = %rand_bb
  call void @poc_based_ref_management.4(i32 %current_pic_num)
  ret void

func_poc_based_ref_management.6:                  ; preds = %ctrl0
  call void @poc_based_ref_management.6(i32 %current_pic_num)
  ret void

func_poc_based_ref_management.9:                  ; preds = %ctrl1
  call void @poc_based_ref_management.9(i32 %current_pic_num)
  ret void

func_poc_based_ref_management.12:                 ; preds = %ctrl2
  call void @poc_based_ref_management.12(i32 %current_pic_num)
  ret void

func_poc_based_ref_management.17:                 ; preds = %ctrl3
  call void @poc_based_ref_management.17(i32 %current_pic_num)
  ret void

func_poc_based_ref_management.21:                 ; preds = %ctrl4
  call void @poc_based_ref_management.21(i32 %current_pic_num)
  ret void

func_poc_based_ref_management.23:                 ; preds = %ctrl5
  call void @poc_based_ref_management.23(i32 %current_pic_num)
  ret void

func_poc_based_ref_management.32:                 ; preds = %ctrl5
  call void @poc_based_ref_management.32(i32 %current_pic_num)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_poc_based_ref_management.6, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_poc_based_ref_management.9, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_poc_based_ref_management.12, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_poc_based_ref_management.17, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_poc_based_ref_management.21, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_poc_based_ref_management.23, label %func_poc_based_ref_management.32
}
...
entry:
  ...
  %canary = alloca i32
  store i32 1938496890, i32* %canary
...
if.end200:                                        ; preds = %for.end199, %for.end
  ...
  %162 = icmp eq i32 %161, 1938496890
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @gop_pyramid.2(i32 %level, i32 %frm_no, i32 %frames, %struct.GOP_DATA* %pyramid_structure) #0 {
entry:
  %frm_no.addr = alloca i32, align 4
  %frames.addr = alloca i32, align 4
  %level.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1642289897, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @interpret_gop_structure.3() #0 {
entry:
  ...
  %canary = alloca i32
  store i32 475052204, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @poc_based_ref_management.4(i32 %current_pic_num) #0 {
entry:
  %i = alloca i32, align 4
  %min_poc = alloca i32, align 4
  %tmp_drpm2 = alloca %struct.DecRefPicMarking_s*, align 8
  %canary = alloca i32
  store i32 779100060, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1250114024, i32* %canary
  %frames.addr = alloca i32, align 4
  %pyramid_structure.addr = alloca %struct.GOP_DATA*, align 8
  %level.addr = alloca i32, align 4
  %frm_no.addr = alloca i32, align 4
...
entry:
  ...
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
  %canary = alloca i32
  store i32 1415011872, i32* %canary
  %tmp_drpm2 = alloca %struct.DecRefPicMarking_s*, align 8
  %i = alloca i32, align 4
  %min_poc = alloca i32, align 4
  %current_pic_num.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @gop_pyramid.7(i32 %level, i32 %frm_no, i32 %frames, %struct.GOP_DATA* %pyramid_structure) #0 {
entry:
  %canary = alloca i32
  store i32 1412035088, i32* %canary
  %pyramid_structure.addr = alloca %struct.GOP_DATA*, align 8
  %frm_no.addr = alloca i32, align 4
  %level.addr = alloca i32, align 4
  %frames.addr = alloca i32, align 4
...
entry:
  ...
  %stored_read = alloca i32, align 4
  %canary = alloca i32
  store i32 625723206, i32* %canary
  %slice_read = alloca i32, align 4
  %qp = alloca i32, align 4
  %k = alloca i32, align 4
  %qp_read = alloca i32, align 4
...
entry:
  ...
  %min_poc = alloca i32, align 4
  %canary = alloca i32
  store i32 756226748, i32* %canary
  %i = alloca i32, align 4
  %tmp_drpm2 = alloca %struct.DecRefPicMarking_s*, align 8
  %pic_num = alloca i32, align 4
  store i32 %current_pic_num, i32* %current_pic_num.addr, align 4
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 279750320, i32* %canary
  %stored_read = alloca i32, align 4
  %qp_read = alloca i32, align 4
  %slice_read = alloca i32, align 4
  %k = alloca i32, align 4
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 691468501, i32* %canary
  %curGOPLeveldist = alloca i32*, align 8
  %prvlevelrefs = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %successive_Bframe = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 34
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @poc_based_ref_management.12(i32 %current_pic_num) #0 {
entry:
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
  %tmp_drpm2 = alloca %struct.DecRefPicMarking_s*, align 8
  %i = alloca i32, align 4
  ...
  %pic_num = alloca i32, align 4
  %canary = alloca i32
  store i32 1420801787, i32* %canary
  %min_poc = alloca i32, align 4
  store i32 %current_pic_num, i32* %current_pic_num.addr, align 4
  store i32 0, i32* %pic_num, align 4
  store i32 2147483647, i32* %min_poc, align 4
...
entry:
  ...
  %qp = alloca i32, align 4
  %canary = alloca i32
  store i32 102356205, i32* %canary
  %order_read = alloca i32, align 4
  %k = alloca i32, align 4
  %stored_read = alloca i32, align 4
  %slice_read = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @interpret_gop_structure.14() #0 {
entry:
  %nLength = alloca i32, align 4
  %stored_read = alloca i32, align 4
  %i = alloca i32, align 4
  %order_read = alloca i32, align 4
  %canary = alloca i32
  store i32 1761456149, i32* %canary
  %qp_read = alloca i32, align 4
  %coded_frame = alloca i32, align 4
  %qp = alloca i32, align 4
  %slice_read = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 636481420, i32* %canary
  %pyramid_structure.addr = alloca %struct.GOP_DATA*, align 8
  %level.addr = alloca i32, align 4
  %frm_no.addr = alloca i32, align 4
  %frames.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @interpret_gop_structure.16() #0 {
entry:
  %canary = alloca i32
  store i32 890729929, i32* %canary
  %display_no = alloca i32, align 4
  %order_read = alloca i32, align 4
  %coded_frame = alloca i32, align 4
  %slice_read = alloca i32, align 4
...
entry:
  ...
  %tmp_drpm2 = alloca %struct.DecRefPicMarking_s*, align 8
  %canary = alloca i32
  store i32 477472832, i32* %canary
  %current_pic_num.addr = alloca i32, align 4
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
  %i = alloca i32, align 4
  store i32 %current_pic_num, i32* %current_pic_num.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @create_pyramid.18() #0 {
entry:
  %prvlevelrefs = alloca i32, align 4
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  ...
  %curGOPLeveldist = alloca i32*, align 8
  %canary = alloca i32
  store i32 1523267800, i32* %canary
  %curlevel = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %successive_Bframe = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 34
  %1 = load i32, i32* %successive_Bframe, align 4
...
if.end200:                                        ; preds = %for.end199, %for.end
  %161 = load i32, i32* %canary
  %162 = icmp eq i32 %161, 1523267800
  br i1 %162, label %163, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @gop_pyramid.19(i32 %level, i32 %frm_no, i32 %frames, %struct.GOP_DATA* %pyramid_structure) #0 {
entry:
  %pyramid_structure.addr = alloca %struct.GOP_DATA*, align 8
  %frames.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 469476488, i32* %canary
  %frm_no.addr = alloca i32, align 4
  %level.addr = alloca i32, align 4
  store i32 %level, i32* %level.addr, align 4
  store i32 %frm_no, i32* %frm_no.addr, align 4
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 907007702, i32* %canary
  %levelrefs = alloca i32, align 4
  %GOPlevels = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %successive_Bframe = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 34
...
entry:
  %canary = alloca i32
  store i32 1990721474, i32* %canary
  %pic_num = alloca i32, align 4
  %i = alloca i32, align 4
  %current_pic_num.addr = alloca i32, align 4
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @create_pyramid.22() #0 {
entry:
  %curGOPLevelfrm = alloca i32*, align 8
  %centerB = alloca i32, align 4
  %curGOPLeveldist = alloca i32*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @poc_based_ref_management.23(i32 %current_pic_num) #0 {
entry:
  %tmp_drpm2 = alloca %struct.DecRefPicMarking_s*, align 8
  %i = alloca i32, align 4
  %pic_num = alloca i32, align 4
  ...
  %min_poc = alloca i32, align 4
  %canary = alloca i32
  store i32 910846030, i32* %canary
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
  store i32 %current_pic_num, i32* %current_pic_num.addr, align 4
  store i32 0, i32* %pic_num, align 4
  store i32 2147483647, i32* %min_poc, align 4
...
entry:
  %frm_no.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 313884364, i32* %canary
  %level.addr = alloca i32, align 4
  %frames.addr = alloca i32, align 4
  %pyramid_structure.addr = alloca %struct.GOP_DATA*, align 8
  store i32 %level, i32* %level.addr, align 4
...
entry:
  ...
  %tempnum = alloca i32, align 4
  %canary = alloca i32
  store i32 128027607, i32* %canary
  %curlevel = alloca i32, align 4
  %prvlevelrefs = alloca i32, align 4
  %centerB = alloca i32, align 4
  %i28 = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @interpret_gop_structure.26() #0 {
entry:
  %qp = alloca i32, align 4
  %qp_read = alloca i32, align 4
  %coded_frame = alloca i32, align 4
  ...
  %nLength = alloca i32, align 4
  %canary = alloca i32
  store i32 667255907, i32* %canary
  %slice_read = alloca i32, align 4
  %order_read = alloca i32, align 4
  %display_no = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
entry:
  ...
  %prvlevelrefs = alloca i32, align 4
  %canary = alloca i32
  store i32 1770389715, i32* %canary
  %levelrefs = alloca i32, align 4
  %tempnum = alloca i32, align 4
  %curlevel = alloca i32, align 4
  %centerB = alloca i32, align 4
...
if.end200:                                        ; preds = %for.end199, %for.end
  %161 = load i32, i32* %canary
  %162 = icmp eq i32 %161, 1770389715
  br i1 %162, label %163, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @gop_pyramid.28(i32 %level, i32 %frm_no, i32 %frames, %struct.GOP_DATA* %pyramid_structure) #0 {
entry:
  %frm_no.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 928569345, i32* %canary
  %level.addr = alloca i32, align 4
  %pyramid_structure.addr = alloca %struct.GOP_DATA*, align 8
  %frames.addr = alloca i32, align 4
  store i32 %level, i32* %level.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @interpret_gop_structure.29() #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 841799773, i32* %canary
  %qp = alloca i32, align 4
  %qp_read = alloca i32, align 4
  %nLength = alloca i32, align 4
  %slice_read = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @create_pyramid.30() #0 {
entry:
  %j = alloca i32, align 4
  %levelrefs = alloca i32, align 4
  %centerB = alloca i32, align 4
  %canary = alloca i32
  store i32 238749326, i32* %canary
  %Bframes = alloca i32, align 4
  %curlevel = alloca i32, align 4
  %prvlevelrefs = alloca i32, align 4
  %curGOPLeveldist = alloca i32*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @gop_pyramid.31(i32 %level, i32 %frm_no, i32 %frames, %struct.GOP_DATA* %pyramid_structure) #0 {
entry:
  %level.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 910808367, i32* %canary
  %frames.addr = alloca i32, align 4
  %pyramid_structure.addr = alloca %struct.GOP_DATA*, align 8
  %frm_no.addr = alloca i32, align 4
  store i32 %level, i32* %level.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @poc_based_ref_management.32(i32 %current_pic_num) #0 {
entry:
  %tmp_drpm2 = alloca %struct.DecRefPicMarking_s*, align 8
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
  %min_poc = alloca i32, align 4
  %canary = alloca i32
  store i32 2053708155, i32* %canary
  %pic_num = alloca i32, align 4
  %current_pic_num.addr = alloca i32, align 4
  %i = alloca i32, align 4
  store i32 %current_pic_num, i32* %current_pic_num.addr, align 4
