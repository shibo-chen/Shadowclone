; ModuleID = 'filehandle.c.rand.16R1.bc'
...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_error.2, label %func_error.3
...
func_write_PPS.10:                                ; preds = %ctrl0
  %3 = call i32 @write_PPS.10(i32 %len, i32 %PPS_id)
  ret i32 %3

func_write_PPS.11:                                ; preds = %ctrl1
  %4 = call i32 @write_PPS.11(i32 %len, i32 %PPS_id)
  ret i32 %4

func_write_PPS.12:                                ; preds = %ctrl2
  %5 = call i32 @write_PPS.12(i32 %len, i32 %PPS_id)
  ret i32 %5
...
ctrl0:                                            ; preds = %rand_bb
  %8 = icmp eq i32 %0, 1
  br i1 %8, label %func_write_PPS.10, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %9 = icmp eq i32 %0, 2
  br i1 %9, label %func_write_PPS.11, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %10 = icmp eq i32 %0, 3
  br i1 %10, label %func_write_PPS.12, label %ctrl3
...
func_start_sequence.8:                            ; preds = %ctrl3
  %6 = call i32 @start_sequence.8()
  ret i32 %6

func_start_sequence.9:                            ; preds = %ctrl4
  %7 = call i32 @start_sequence.9()
  ret i32 %7
...
ctrl3:                                            ; preds = %ctrl2
  %21 = icmp eq i32 %0, 4
  br i1 %21, label %func_start_sequence.8, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %22 = icmp eq i32 %0, 5
  br i1 %22, label %func_start_sequence.9, label %ctrl5
...
entry:
  %canary = alloca i32
  store i32 237298794, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1758353918, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1650785072, i32* %canary
  %code.addr = alloca i32, align 4
  %text.addr = alloca i8*, align 8
  store i8* %text, i8** %text.addr, align 8
  store i32 %code, i32* %code.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 1076723141, i32* %canary
...
entry:
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 243325901, i32* %canary
  %len = alloca i32, align 4
  %i = alloca i32, align 4
  %total_pps = alloca i32, align 4
  %nalu = alloca %struct.NALU_t*, align 8
...
entry:
  %len = alloca i32, align 4
  %canary = alloca i32
  store i32 1266056352, i32* %canary
  %retval = alloca i32, align 4
  %nalu = alloca %struct.NALU_t*, align 8
  %total_pps = alloca i32, align 4
  %i = alloca i32, align 4
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 746361560, i32* %canary
  %retval = alloca i32, align 4
  store i32 0, i32* %len, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %GenerateMultiplePPS = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 15
...
entry:
  %nalu = alloca %struct.NALU_t*, align 8
  %canary = alloca i32
  store i32 1241856526, i32* %canary
  %i = alloca i32, align 4
  %len = alloca i32, align 4
  %total_pps = alloca i32, align 4
  %retval = alloca i32, align 4
...
entry:
  ...
  %total_pps = alloca i32, align 4
  %canary = alloca i32
  store i32 150647254, i32* %canary
  %nalu = alloca %struct.NALU_t*, align 8
  %i = alloca i32, align 4
  %len = alloca i32, align 4
  store i32 0, i32* %len, align 4
...
entry:
  ...
  %len.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 399614254, i32* %canary
  %nalu = alloca %struct.NALU_t*, align 8
  store i32 %len, i32* %len.addr, align 4
  store i32 %PPS_id, i32* %PPS_id.addr, align 4
  store %struct.NALU_t* null, %struct.NALU_t** %nalu, align 8
...
entry:
  %len.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1292287583, i32* %canary
  %nalu = alloca %struct.NALU_t*, align 8
  %PPS_id.addr = alloca i32, align 4
  store i32 %len, i32* %len.addr, align 4
  store i32 %PPS_id, i32* %PPS_id.addr, align 4
...
entry:
  ...
  %nalu = alloca %struct.NALU_t*, align 8
  %canary = alloca i32
  store i32 1540862258, i32* %canary
  %len.addr = alloca i32, align 4
  store i32 %len, i32* %len.addr, align 4
  store i32 %PPS_id, i32* %PPS_id.addr, align 4
  store %struct.NALU_t* null, %struct.NALU_t** %nalu, align 8
...
entry:
  %canary = alloca i32
  store i32 774868727, i32* %canary
  %nalu = alloca %struct.NALU_t*, align 8
  %len.addr = alloca i32, align 4
  %PPS_id.addr = alloca i32, align 4
  store i32 %len, i32* %len.addr, align 4
...
entry:
  ...
  %PPS_id.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1012092903, i32* %canary
  %len.addr = alloca i32, align 4
  store i32 %len, i32* %len.addr, align 4
  store i32 %PPS_id, i32* %PPS_id.addr, align 4
  store %struct.NALU_t* null, %struct.NALU_t** %nalu, align 8
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 292585438, i32* %canary
  %len = alloca i32, align 4
  %i = alloca i32, align 4
  store i32 0, i32* %len, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 2114425090, i32* %canary
  %len = alloca i32, align 4
  %total_pps = alloca i32, align 4
  store i32 0, i32* %len, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
entry:
  %canary = alloca i32
  store i32 337329047, i32* %canary
  %retval = alloca i32, align 4
  %nalu = alloca %struct.NALU_t*, align 8
  %total_pps = alloca i32, align 4
  %i = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 194387734, i32* %canary
  %len = alloca i32, align 4
  %i = alloca i32, align 4
  %total_pps = alloca i32, align 4
  %retval = alloca i32, align 4
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 2116880391, i32* %canary
  %total_pps = alloca i32, align 4
  %len = alloca i32, align 4
  %i = alloca i32, align 4
  store i32 0, i32* %len, align 4
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 159476190, i32* %canary
  %retval = alloca i32, align 4
  %len = alloca i32, align 4
  store i32 0, i32* %len, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1982837633, i32* %canary
  %nalu = alloca %struct.NALU_t*, align 8
  store i32 0, i32* %len, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %GenerateMultiplePPS = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 15
...
entry:
  ...
  %nalu = alloca %struct.NALU_t*, align 8
  %canary = alloca i32
  store i32 661877965, i32* %canary
  %len = alloca i32, align 4
  %i = alloca i32, align 4
  %total_pps = alloca i32, align 4
  store i32 0, i32* %len, align 4
...
entry:
  %canary = alloca i32
  store i32 1913393768, i32* %canary
  %total_pps = alloca i32, align 4
  %nalu = alloca %struct.NALU_t*, align 8
  %retval = alloca i32, align 4
  %i = alloca i32, align 4
