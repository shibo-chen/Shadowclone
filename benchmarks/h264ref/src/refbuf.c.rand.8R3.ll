...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_PutPel_14.22, label %ctrl0

func_PutPel_14.22:                                ; preds = %rand_bb
  call void @PutPel_14.22(i16** %Pic, i32 %y, i32 %x, i16 %val)
  ret void
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_PutPel_14.31, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_PutPel_14.45, label %ctrl3
...
ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_PutPel_14.60, label %func_PutPel_14.61
}
...
func_PutPel_11.12:                                ; preds = %ctrl0
  call void @PutPel_11.12(i16* %Pic, i32 %y, i32 %x, i16 %val, i32 %width)
  ret void

func_PutPel_11.14:                                ; preds = %ctrl1
  call void @PutPel_11.14(i16* %Pic, i32 %y, i32 %x, i16 %val, i32 %width)
  ret void

func_PutPel_11.19:                                ; preds = %ctrl2
  call void @PutPel_11.19(i16* %Pic, i32 %y, i32 %x, i16 %val, i32 %width)
  ret void
...
func_PutPel_11.41:                                ; preds = %ctrl4
  call void @PutPel_11.41(i16* %Pic, i32 %y, i32 %x, i16 %val, i32 %width)
  ret void

func_PutPel_11.52:                                ; preds = %ctrl5
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_PutPel_11.12, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_PutPel_11.14, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_PutPel_11.19, label %ctrl3
...
ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_PutPel_11.41, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_PutPel_11.52, label %func_PutPel_11.56
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FastLine16Y_11.9, label %ctrl0

func_FastLine16Y_11.9:                            ; preds = %rand_bb
  %2 = call i16* @FastLine16Y_11.9(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %2
...
func_FastLine16Y_11.15:                           ; preds = %ctrl1
  %4 = call i16* @FastLine16Y_11.15(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %4

func_FastLine16Y_11.18:                           ; preds = %ctrl2
  %5 = call i16* @FastLine16Y_11.18(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %5

func_FastLine16Y_11.25:                           ; preds = %ctrl3
  %6 = call i16* @FastLine16Y_11.25(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %6

func_FastLine16Y_11.39:                           ; preds = %ctrl4
  %7 = call i16* @FastLine16Y_11.39(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %7
...
func_FastLine16Y_11.63:                           ; preds = %ctrl5
  %9 = call i16* @FastLine16Y_11.63(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_FastLine16Y_11.10, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_FastLine16Y_11.15, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_FastLine16Y_11.18, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_FastLine16Y_11.25, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_FastLine16Y_11.39, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_FastLine16Y_11.49, label %func_FastLine16Y_11.63
}
...
func_UMVLine16Y_11.4:                             ; preds = %ctrl0
  %3 = call i16* @UMVLine16Y_11.4(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %3

func_UMVLine16Y_11.13:                            ; preds = %ctrl1
  %4 = call i16* @UMVLine16Y_11.13(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %4

func_UMVLine16Y_11.20:                            ; preds = %ctrl2
  %5 = call i16* @UMVLine16Y_11.20(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %5

func_UMVLine16Y_11.21:                            ; preds = %ctrl3
  %6 = call i16* @UMVLine16Y_11.21(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %6

func_UMVLine16Y_11.29:                            ; preds = %ctrl4
  %7 = call i16* @UMVLine16Y_11.29(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %7

func_UMVLine16Y_11.36:                            ; preds = %ctrl5
  %8 = call i16* @UMVLine16Y_11.36(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %8

func_UMVLine16Y_11.37:                            ; preds = %ctrl5
  %9 = call i16* @UMVLine16Y_11.37(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_UMVLine16Y_11.4, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_UMVLine16Y_11.13, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_UMVLine16Y_11.20, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_UMVLine16Y_11.21, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_UMVLine16Y_11.29, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_UMVLine16Y_11.36, label %func_UMVLine16Y_11.37
}
...
func_FastLineX.30:                                ; preds = %ctrl0
  %3 = call i16* @FastLineX.30(i32 %dummy, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %3

func_FastLineX.44:                                ; preds = %ctrl1
  %4 = call i16* @FastLineX.44(i32 %dummy, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %4

func_FastLineX.48:                                ; preds = %ctrl2
  %5 = call i16* @FastLineX.48(i32 %dummy, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %5
...
func_FastLineX.54:                                ; preds = %ctrl4
  %7 = call i16* @FastLineX.54(i32 %dummy, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %7

func_FastLineX.55:                                ; preds = %ctrl5
  %8 = call i16* @FastLineX.55(i32 %dummy, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %8

func_FastLineX.59:                                ; preds = %ctrl5
  %9 = call i16* @FastLineX.59(i32 %dummy, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_FastLineX.30, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_FastLineX.44, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_FastLineX.48, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_FastLineX.51, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_FastLineX.54, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_FastLineX.55, label %func_FastLineX.59
}
...
func_UMVLineX.11:                                 ; preds = %ctrl0
  %3 = call i16* @UMVLineX.11(i32 %size, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %3

func_UMVLineX.26:                                 ; preds = %ctrl1
  %4 = call i16* @UMVLineX.26(i32 %size, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %4

func_UMVLineX.28:                                 ; preds = %ctrl2
  %5 = call i16* @UMVLineX.28(i32 %size, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %5

func_UMVLineX.40:                                 ; preds = %ctrl3
  %6 = call i16* @UMVLineX.40(i32 %size, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %6
...
func_UMVLineX.62:                                 ; preds = %ctrl5
  %8 = call i16* @UMVLineX.62(i32 %size, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %8

func_UMVLineX.64:                                 ; preds = %ctrl5
  %9 = call i16* @UMVLineX.64(i32 %size, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_UMVLineX.11, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_UMVLineX.26, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_UMVLineX.28, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_UMVLineX.40, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_UMVLineX.58, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_UMVLineX.62, label %func_UMVLineX.64
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_UMVPelY_14.3, label %ctrl0

func_UMVPelY_14.3:                                ; preds = %rand_bb
  %2 = call i16 @UMVPelY_14.3(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16 %2
...
func_UMVPelY_14.16:                               ; preds = %ctrl1
  %4 = call i16 @UMVPelY_14.16(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16 %4

func_UMVPelY_14.27:                               ; preds = %ctrl2
  %5 = call i16 @UMVPelY_14.27(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16 %5

func_UMVPelY_14.32:                               ; preds = %ctrl3
  %6 = call i16 @UMVPelY_14.32(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16 %6

func_UMVPelY_14.33:                               ; preds = %ctrl4
  %7 = call i16 @UMVPelY_14.33(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16 %7

func_UMVPelY_14.43:                               ; preds = %ctrl5
  %8 = call i16 @UMVPelY_14.43(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16 %8
...
ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_UMVPelY_14.7, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_UMVPelY_14.16, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_UMVPelY_14.27, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_UMVPelY_14.32, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_UMVPelY_14.33, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_UMVPelY_14.43, label %func_UMVPelY_14.50
}
...
func_FastPelY_14.17:                              ; preds = %ctrl0
  %3 = call i16 @FastPelY_14.17(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16 %3

func_FastPelY_14.23:                              ; preds = %ctrl1
  %4 = call i16 @FastPelY_14.23(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16 %4

func_FastPelY_14.34:                              ; preds = %ctrl2
  %5 = call i16 @FastPelY_14.34(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16 %5

func_FastPelY_14.38:                              ; preds = %ctrl3
  %6 = call i16 @FastPelY_14.38(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16 %6

func_FastPelY_14.42:                              ; preds = %ctrl4
  %7 = call i16 @FastPelY_14.42(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16 %7

func_FastPelY_14.47:                              ; preds = %ctrl5
  %8 = call i16 @FastPelY_14.47(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16 %8

func_FastPelY_14.53:                              ; preds = %ctrl5
  %9 = call i16 @FastPelY_14.53(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_FastPelY_14.17, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_FastPelY_14.23, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_FastPelY_14.34, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_FastPelY_14.38, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_FastPelY_14.42, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_FastPelY_14.47, label %func_FastPelY_14.53
}
...
entry:
  ...
  %canary = alloca i32
  store i32 1958756878, i32* %canary
...
entry:
  ...
  %width.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 630814482, i32* %canary
  %Pic.addr = alloca i16*, align 8
  store i16* %Pic, i16** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
  store i32 %x, i32* %x.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local zeroext i16 @UMVPelY_14.3(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width) #0 {
entry:
  %x.addr = alloca i32, align 4
  %width.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
  %height.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1752519145, i32* %canary
...
entry:
  ...
  %maxx = alloca i32, align 4
  %canary = alloca i32
  store i32 909849220, i32* %canary
  %width.addr = alloca i32, align 4
  store i16* %Pic, i16** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
  store i32 %x, i32* %x.addr, align 4
...
entry:
  %x.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2143174341, i32* %canary
  %maxx = alloca i32, align 4
  %y.addr = alloca i32, align 4
  %width.addr = alloca i32, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 1166195982, i32* %canary
  %width.addr = alloca i32, align 4
  %x.addr = alloca i32, align 4
  %Pic.addr = alloca i16*, align 8
...
entry:
  %canary = alloca i32
  store i32 1679770441, i32* %canary
  %width.addr = alloca i32, align 4
  %retval = alloca i16, align 2
  %width4 = alloca i32, align 4
  %x.addr = alloca i32, align 4
...
entry:
  %x.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 271716263, i32* %canary
  %height.addr = alloca i32, align 4
  %Pic.addr = alloca i16**, align 8
  %width.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i16* @FastLine16Y_11.9(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width) #0 {
entry:
  %y.addr = alloca i32, align 4
  %x.addr = alloca i32, align 4
  %height.addr = alloca i32, align 4
  %Pic.addr = alloca i16*, align 8
  %canary = alloca i32
  store i32 1461853842, i32* %canary
  %width.addr = alloca i32, align 4
  store i16* %Pic, i16** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
  store i32 %x, i32* %x.addr, align 4
...
entry:
  ...
  %width.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 755057620, i32* %canary
  %height.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
  %x.addr = alloca i32, align 4
  store i16* %Pic, i16** %Pic.addr, align 8
...
entry:
  ...
  %width.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 649686446, i32* %canary
  %maxx = alloca i32, align 4
  %i = alloca i32, align 4
  %x.addr = alloca i32, align 4
  %retval = alloca i16*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i16* @UMVLine16Y_11.13(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width) #0 {
entry:
  %i = alloca i32, align 4
  %y.addr = alloca i32, align 4
  %height.addr = alloca i32, align 4
  ...
  %retval = alloca i16*, align 8
  %canary = alloca i32
  store i32 606935073, i32* %canary
  %width.addr = alloca i32, align 4
  %Picy = alloca i16*, align 8
  %x.addr = alloca i32, align 4
  %Pic.addr = alloca i16*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @PutPel_11.14(i16* %Pic, i32 %y, i32 %x, i16 zeroext %val, i32 %width) #0 {
entry:
  %y.addr = alloca i32, align 4
  %Pic.addr = alloca i16*, align 8
  %x.addr = alloca i32, align 4
  %val.addr = alloca i16, align 2
  %canary = alloca i32
  store i32 2057295423, i32* %canary
  %width.addr = alloca i32, align 4
  store i16* %Pic, i16** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
  store i32 %x, i32* %x.addr, align 4
...
entry:
  ...
  %x.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 962778997, i32* %canary
  %Pic.addr = alloca i16*, align 8
  store i16* %Pic, i16** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
  store i32 %x, i32* %x.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 370400069, i32* %canary
  %width.addr = alloca i32, align 4
  %Pic.addr = alloca i16**, align 8
  %width4 = alloca i32, align 4
  %y.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local zeroext i16 @FastPelY_14.17(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width) #0 {
entry:
  %Pic.addr = alloca i16**, align 8
  %y.addr = alloca i32, align 4
  %x.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 586695312, i32* %canary
  %height.addr = alloca i32, align 4
  %width.addr = alloca i32, align 4
  store i16** %Pic, i16*** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 1357790319, i32* %canary
  %y.addr = alloca i32, align 4
  %height.addr = alloca i32, align 4
  %x.addr = alloca i32, align 4
  %Pic.addr = alloca i16*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @PutPel_11.19(i16* %Pic, i32 %y, i32 %x, i16 zeroext %val, i32 %width) #0 {
entry:
  %y.addr = alloca i32, align 4
  %x.addr = alloca i32, align 4
  %width.addr = alloca i32, align 4
  %val.addr = alloca i16, align 2
  %canary = alloca i32
  store i32 1806835816, i32* %canary
  %Pic.addr = alloca i16*, align 8
  store i16* %Pic, i16** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
  store i32 %x, i32* %x.addr, align 4
...
entry:
  ...
  %y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 878348677, i32* %canary
  %width.addr = alloca i32, align 4
  store i16* %Pic, i16** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
  store i32 %x, i32* %x.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i16* @UMVLine16Y_11.21(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width) #0 {
entry:
  %retval = alloca i16*, align 8
  %Picy = alloca i16*, align 8
  %width.addr = alloca i32, align 4
  ...
  %height.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 696934399, i32* %canary
  %maxx = alloca i32, align 4
  %x.addr = alloca i32, align 4
  %Pic.addr = alloca i16*, align 8
  %y.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @PutPel_14.22(i16** %Pic, i32 %y, i32 %x, i16 zeroext %val) #0 {
entry:
  %x.addr = alloca i32, align 4
  %val.addr = alloca i16, align 2
  %canary = alloca i32
  store i32 338955507, i32* %canary
  %y.addr = alloca i32, align 4
  %Pic.addr = alloca i16**, align 8
  store i16** %Pic, i16*** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local zeroext i16 @FastPelY_14.23(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width) #0 {
entry:
  %canary = alloca i32
  store i32 956876493, i32* %canary
  %height.addr = alloca i32, align 4
  %Pic.addr = alloca i16**, align 8
  %width.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
...
entry:
  ...
  %Pic.addr = alloca i16*, align 8
  %canary = alloca i32
  store i32 470646232, i32* %canary
  %height.addr = alloca i32, align 4
  %x.addr = alloca i32, align 4
  store i16* %Pic, i16** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
...
entry:
  ...
  %y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1321132379, i32* %canary
  %i = alloca i32, align 4
  %retval = alloca i16*, align 8
  store i32 %size, i32* %size.addr, align 4
  store i16* %Pic, i16** %Pic.addr, align 8
...
entry:
  %x.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1356127978, i32* %canary
  %y.addr = alloca i32, align 4
  %height.addr = alloca i32, align 4
  %Pic.addr = alloca i16**, align 8
  %width4 = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i16* @UMVLineX.28(i32 %size, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width) #0 {
entry:
  %Picy = alloca i16*, align 8
  %maxx = alloca i32, align 4
  %retval = alloca i16*, align 8
  ...
  %size.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1780886058, i32* %canary
  %i = alloca i32, align 4
  %y.addr = alloca i32, align 4
  store i32 %size, i32* %size.addr, align 4
  store i16* %Pic, i16** %Pic.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i16* @UMVLine16Y_11.29(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width) #0 {
entry:
  %x.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 914762771, i32* %canary
  %Pic.addr = alloca i16*, align 8
  %height.addr = alloca i32, align 4
  %Picy = alloca i16*, align 8
  %y.addr = alloca i32, align 4
...
entry:
  ...
  %Pic.addr = alloca i16*, align 8
  %canary = alloca i32
  store i32 895062944, i32* %canary
  %height.addr = alloca i32, align 4
  store i32 %dummy, i32* %dummy.addr, align 4
  store i16* %Pic, i16** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
...
entry:
  ...
  %x.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 156930357, i32* %canary
  %Pic.addr = alloca i16**, align 8
  %y.addr = alloca i32, align 4
  store i16** %Pic, i16*** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
...
entry:
  ...
  %x.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1174327682, i32* %canary
  %height4 = alloca i32, align 4
  store i16** %Pic, i16*** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
  store i32 %x, i32* %x.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local zeroext i16 @UMVPelY_14.33(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width) #0 {
entry:
  %retval = alloca i16, align 2
  %canary = alloca i32
  store i32 855752276, i32* %canary
  %width4 = alloca i32, align 4
  %height4 = alloca i32, align 4
  %x.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local zeroext i16 @FastPelY_14.34(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width) #0 {
entry:
  %Pic.addr = alloca i16**, align 8
  %width.addr = alloca i32, align 4
  %x.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1364193633, i32* %canary
  %height.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
  store i16** %Pic, i16*** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
...
entry:
  ...
  %val.addr = alloca i16, align 2
  %canary = alloca i32
  store i32 1336125535, i32* %canary
  %width.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
  store i16* %Pic, i16** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i16* @UMVLine16Y_11.36(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width) #0 {
entry:
  %i = alloca i32, align 4
  %maxx = alloca i32, align 4
  %width.addr = alloca i32, align 4
  ...
  %x.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 535135079, i32* %canary
  %y.addr = alloca i32, align 4
  %retval = alloca i16*, align 8
  %height.addr = alloca i32, align 4
  store i16* %Pic, i16** %Pic.addr, align 8
...
entry:
  ...
  %retval = alloca i16*, align 8
  %canary = alloca i32
  store i32 1878604758, i32* %canary
  %Pic.addr = alloca i16*, align 8
  store i16* %Pic, i16** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
  store i32 %x, i32* %x.addr, align 4
...
entry:
  %y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2115293258, i32* %canary
  %x.addr = alloca i32, align 4
  %height.addr = alloca i32, align 4
  %width.addr = alloca i32, align 4
  %Pic.addr = alloca i16**, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i16* @FastLine16Y_11.39(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width) #0 {
entry:
  %height.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1074256477, i32* %canary
  %y.addr = alloca i32, align 4
  %x.addr = alloca i32, align 4
  %width.addr = alloca i32, align 4
  %Pic.addr = alloca i16*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i16* @UMVLineX.40(i32 %size, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width) #0 {
entry:
  %Picy = alloca i16*, align 8
  %maxx = alloca i32, align 4
  %y.addr = alloca i32, align 4
  ...
  %Pic.addr = alloca i16*, align 8
  %canary = alloca i32
  store i32 1915700764, i32* %canary
  %width.addr = alloca i32, align 4
  %height.addr = alloca i32, align 4
  %retval = alloca i16*, align 8
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @PutPel_11.41(i16* %Pic, i32 %y, i32 %x, i16 zeroext %val, i32 %width) #0 {
entry:
  %val.addr = alloca i16, align 2
  %canary = alloca i32
  store i32 1799795483, i32* %canary
  %y.addr = alloca i32, align 4
  %Pic.addr = alloca i16*, align 8
  %width.addr = alloca i32, align 4
  %x.addr = alloca i32, align 4
...
entry:
  ...
  %Pic.addr = alloca i16**, align 8
  %canary = alloca i32
  store i32 401558929, i32* %canary
  %y.addr = alloca i32, align 4
  %x.addr = alloca i32, align 4
  %height.addr = alloca i32, align 4
  store i16** %Pic, i16*** %Pic.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 2052835558, i32* %canary
  %width4 = alloca i32, align 4
  %y.addr = alloca i32, align 4
  %retval = alloca i16, align 2
  %width.addr = alloca i32, align 4
...
entry:
  ...
  %x.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1567203445, i32* %canary
  %dummy.addr = alloca i32, align 4
  store i32 %dummy, i32* %dummy.addr, align 4
  store i16* %Pic, i16** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
...
entry:
  ...
  %val.addr = alloca i16, align 2
  %canary = alloca i32
  store i32 714678251, i32* %canary
  %Pic.addr = alloca i16**, align 8
  store i16** %Pic, i16*** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
  store i32 %x, i32* %x.addr, align 4
...
entry:
  ...
  %Pic.addr = alloca i16**, align 8
  %canary = alloca i32
  store i32 873802437, i32* %canary
  %y.addr = alloca i32, align 4
  %x.addr = alloca i32, align 4
  store i16** %Pic, i16*** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 537438809, i32* %canary
  %height.addr = alloca i32, align 4
  %width.addr = alloca i32, align 4
  %x.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i16* @FastLineX.48(i32 %dummy, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width) #0 {
entry:
  %Pic.addr = alloca i16*, align 8
  %canary = alloca i32
  store i32 745336181, i32* %canary
  %y.addr = alloca i32, align 4
  %width.addr = alloca i32, align 4
  %x.addr = alloca i32, align 4
  %height.addr = alloca i32, align 4
...
entry:
  ...
  %y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1495104589, i32* %canary
  %width.addr = alloca i32, align 4
  %Pic.addr = alloca i16*, align 8
  store i16* %Pic, i16** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
...
entry:
  %Pic.addr = alloca i16*, align 8
  %canary = alloca i32
  store i32 1781453179, i32* %canary
  %x.addr = alloca i32, align 4
  %width.addr = alloca i32, align 4
  %dummy.addr = alloca i32, align 4
  %height.addr = alloca i32, align 4
...
entry:
  ...
  %y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 648109251, i32* %canary
  %width.addr = alloca i32, align 4
  %height.addr = alloca i32, align 4
  store i16** %Pic, i16*** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
...
entry:
  ...
  %Pic.addr = alloca i16*, align 8
  %canary = alloca i32
  store i32 572413360, i32* %canary
  %x.addr = alloca i32, align 4
  store i32 %dummy, i32* %dummy.addr, align 4
  store i16* %Pic, i16** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
...
entry:
  ...
  %width.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 637092276, i32* %canary
  %dummy.addr = alloca i32, align 4
  %x.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
  store i32 %dummy, i32* %dummy.addr, align 4
...
entry:
  ...
  %y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1316449727, i32* %canary
  %Pic.addr = alloca i16*, align 8
  %width.addr = alloca i32, align 4
  store i16* %Pic, i16** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
...
entry:
  ...
  %Pic.addr = alloca i16**, align 8
  %canary = alloca i32
  store i32 1900062339, i32* %canary
  %y.addr = alloca i32, align 4
  store i16** %Pic, i16*** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
  store i32 %x, i32* %x.addr, align 4
...
entry:
  ...
  %width.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1109270249, i32* %canary
  %y.addr = alloca i32, align 4
  %retval = alloca i16*, align 8
  %Picy = alloca i16*, align 8
  store i32 %size, i32* %size.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 1324071643, i32* %canary
  %dummy.addr = alloca i32, align 4
  %height.addr = alloca i32, align 4
  %width.addr = alloca i32, align 4
  %Pic.addr = alloca i16*, align 8
...
entry:
  ...
  %Pic.addr = alloca i16**, align 8
  %canary = alloca i32
  store i32 2132951043, i32* %canary
  %x.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
  store i16** %Pic, i16*** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i16* @UMVLineX.62(i32 %size, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width) #0 {
entry:
  %canary = alloca i32
  store i32 816606647, i32* %canary
  %Pic.addr = alloca i16*, align 8
  %maxx = alloca i32, align 4
  %size.addr = alloca i32, align 4
  %height.addr = alloca i32, align 4
...
entry:
  ...
  %width.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 654279364, i32* %canary
  %Pic.addr = alloca i16*, align 8
  %x.addr = alloca i32, align 4
  store i16* %Pic, i16** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
...
entry:
  ...
  %retval = alloca i16*, align 8
  %canary = alloca i32
  store i32 373081259, i32* %canary
  %y.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %width.addr = alloca i32, align 4
  %height.addr = alloca i32, align 4
