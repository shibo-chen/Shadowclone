...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$16, %rsp
	movl	$1907676249, -12(%rbp)  # imm = 0x71B4D459
...
# %bb.3:                                # %for.inc
	...
	jmp	.LBB4_1
.LBB4_4:                                # %for.end
	cmpl	$1907676249, -12(%rbp)  # imm = 0x71B4D459
	jne	.LBB4_6
.LBB4_5:
	addq	$16, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$16, %rsp
	movl	$877160354, -12(%rbp)   # imm = 0x344867A2
	movl	NumberIntraPerPicture, %eax
	addl	WalkAround, %eax
	movl	%eax, WalkAround
	movl	$0, -4(%rbp)
...
# %bb.3:                                # %for.inc
	...
	jmp	.LBB5_1
.LBB5_4:                                # %for.end
	cmpl	$877160354, -12(%rbp)   # imm = 0x344867A2
	jne	.LBB5_6
.LBB5_5:
	addq	$16, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$631920815, -24(%rbp)   # imm = 0x25AA58AF
	movl	%edi, -20(%rbp)
	movl	$0, -12(%rbp)
.LBB6_1:                                # %for.cond
                                        # =>This Inner Loop Header: Depth=1
...
.LBB6_7:                                # %return
	movl	-16(%rbp), %ebx
	cmpl	$631920815, -24(%rbp)   # imm = 0x25AA58AF
	jne	.LBB6_9
.LBB6_8:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1706221458, -20(%rbp)  # imm = 0x65B2DF92
	movl	%edi, -16(%rbp)
	movl	%esi, -24(%rbp)
	movl	%edx, -8(%rbp)
	movl	$1, %edi
...
# %bb.14:                               # %for.inc23
	...
	jmp	.LBB7_9
.LBB7_15:                               # %for.end25
	cmpl	$1706221458, -20(%rbp)  # imm = 0x65B2DF92
	jne	.LBB7_17
.LBB7_16:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1568495024, -20(%rbp)  # imm = 0x5D7D55B0
	movl	%edi, -16(%rbp)
	movl	%esi, -24(%rbp)
	movl	%edx, -12(%rbp)
	movl	$1, %edi
...
# %bb.14:                               # %for.inc23
	...
	jmp	.LBB8_9
.LBB8_15:                               # %for.end25
	cmpl	$1568495024, -20(%rbp)  # imm = 0x5D7D55B0
	jne	.LBB8_17
.LBB8_16:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$1559967750, -20(%rbp)  # imm = 0x5CFB3806
	movl	%edi, -24(%rbp)
	movl	$0, -12(%rbp)
.LBB9_1:                                # %for.cond
                                        # =>This Inner Loop Header: Depth=1
...
.LBB9_7:                                # %return
	movl	-16(%rbp), %ebx
	cmpl	$1559967750, -20(%rbp)  # imm = 0x5CFB3806
	jne	.LBB9_9
.LBB9_8:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1484977889, -24(%rbp)  # imm = 0x5882F6E1
	movl	%edi, -16(%rbp)
	movl	%esi, -20(%rbp)
	movl	%edx, -8(%rbp)
	movl	$1, %edi
...
# %bb.14:                               # %for.inc23
	...
	jmp	.LBB10_9
.LBB10_15:                              # %for.end25
	cmpl	$1484977889, -24(%rbp)  # imm = 0x5882F6E1
	jne	.LBB10_17
.LBB10_16:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$432614821, -20(%rbp)   # imm = 0x19C92DA5
	movl	%edi, -24(%rbp)
	movl	$0, -12(%rbp)
.LBB11_1:                               # %for.cond
                                        # =>This Inner Loop Header: Depth=1
...
.LBB11_7:                               # %return
	movl	-16(%rbp), %ebx
	cmpl	$432614821, -20(%rbp)   # imm = 0x19C92DA5
	jne	.LBB11_9
.LBB11_8:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$1563766713, -24(%rbp)  # imm = 0x5D352FB9
	movl	%edi, -20(%rbp)
	movl	$0, -12(%rbp)
.LBB12_1:                               # %for.cond
                                        # =>This Inner Loop Header: Depth=1
...
.LBB12_7:                               # %return
	movl	-16(%rbp), %ebx
	cmpl	$1563766713, -24(%rbp)  # imm = 0x5D352FB9
	jne	.LBB12_9
.LBB12_8:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1711788378, -20(%rbp)  # imm = 0x6607D15A
	movl	%edi, -24(%rbp)
	movl	%esi, -16(%rbp)
	movl	%edx, -12(%rbp)
	movl	$1, %edi
...
# %bb.14:                               # %for.inc23
	...
	jmp	.LBB13_9
.LBB13_15:                              # %for.end25
	cmpl	$1711788378, -20(%rbp)  # imm = 0x6607D15A
	jne	.LBB13_17
.LBB13_16:
	addq	$32, %rsp
	popq	%rbp
