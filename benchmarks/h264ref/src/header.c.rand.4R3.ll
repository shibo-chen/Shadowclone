...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_SliceHeader.10, label %ctrl0

func_SliceHeader.10:                              ; preds = %rand_bb
  %2 = call i32 @SliceHeader.10()
  ret i32 %2
...
func_SliceHeader.18:                              ; preds = %ctrl1
  %4 = call i32 @SliceHeader.18()
  ret i32 %4

func_SliceHeader.20:                              ; preds = %ctrl1
  %5 = call i32 @SliceHeader.20()
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_SliceHeader.11, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_SliceHeader.18, label %func_SliceHeader.20
}
...
func_Partition_BC_Header.9:                       ; preds = %ctrl0
  %3 = call i32 @Partition_BC_Header.9(i32 %PartNo)
  ret i32 %3

func_Partition_BC_Header.12:                      ; preds = %ctrl1
  %4 = call i32 @Partition_BC_Header.12(i32 %PartNo)
  ret i32 %4
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_Partition_BC_Header.9, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_Partition_BC_Header.12, label %func_Partition_BC_Header.13
}
...
func_ref_pic_list_reordering.4:                   ; preds = %ctrl1
  %4 = call i32 @ref_pic_list_reordering.4()
  ret i32 %4
...
ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_ref_pic_list_reordering.4, label %func_ref_pic_list_reordering.19
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_dec_ref_pic_marking.5, label %ctrl0

func_dec_ref_pic_marking.5:                       ; preds = %rand_bb
  %2 = call i32 @dec_ref_pic_marking.5()
  ret i32 %2
...
func_dec_ref_pic_marking.21:                      ; preds = %ctrl1
  %4 = call i32 @dec_ref_pic_marking.21()
  ret i32 %4
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_dec_ref_pic_marking.6, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_dec_ref_pic_marking.21, label %func_dec_ref_pic_marking.22
}
...
func_pred_weight_table.17:                        ; preds = %ctrl1
  %5 = call i32 @pred_weight_table.17()
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_pred_weight_table.14, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_pred_weight_table.16, label %func_pred_weight_table.17
}
...
entry:
  ...
  %canary = alloca i32
  store i32 953328160, i32* %canary
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 612215436, i32* %canary
  %currSlice = alloca %struct.Slice*, align 8
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
  %1 = load i32, i32* %partition_mode, align 4
...
entry:
  ...
  %dP_nr = alloca i32, align 4
  %canary = alloca i32
  store i32 571260127, i32* %canary
  %len = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
  %1 = load i32, i32* %partition_mode, align 4
...
entry:
  %canary = alloca i32
  store i32 1419391945, i32* %canary
  %partition = alloca %struct.datapartition*, align 8
  %currSlice = alloca %struct.Slice*, align 8
  %i = alloca i32, align 4
  %len = alloca i32, align 4
...
entry:
  ...
  %partition = alloca %struct.datapartition*, align 8
  %canary = alloca i32
  store i32 2065021614, i32* %canary
...
entry:
  ...
  %val = alloca i32, align 4
  %canary = alloca i32
  store i32 1309923067, i32* %canary
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
  %partition = alloca %struct.datapartition*, align 8
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
...
entry:
  %canary = alloca i32
  store i32 1502188777, i32* %canary
...
entry:
  ...
  %partition = alloca %struct.datapartition*, align 8
  %canary = alloca i32
  store i32 727033876, i32* %canary
...
entry:
  ...
  %symbol = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 1681819636, i32* %canary
  %partition = alloca %struct.datapartition*, align 8
  store i32 %PartNo, i32* %PartNo.addr, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %currentSlice = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 50
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @SliceHeader.10() #0 {
entry:
  %currSlice = alloca %struct.Slice*, align 8
  %partition = alloca %struct.datapartition*, align 8
  ...
  %canary = alloca i32
  store i32 1978442363, i32* %canary
...
if.end239:                                        ; preds = %if.then236, %land.lhs.true232, %if.end229
  ...
  %238 = icmp eq i32 %237, 1978442363
...
entry:
  ...
  %dP_nr = alloca i32, align 4
  %canary = alloca i32
  store i32 1861525538, i32* %canary
  %num_bits_slice_group_change_cycle = alloca i32, align 4
  %len = alloca i32, align 4
  %field_pic_flag = alloca i32, align 4
  %numtmp = alloca float, align 4
...
if.end239:                                        ; preds = %if.then236, %land.lhs.true232, %if.end229
  %236 = load i32, i32* %len, align 4
  %237 = load i32, i32* %canary
  %238 = icmp eq i32 %237, 1861525538
  br i1 %238, label %239, label %func_exit
...
entry:
  ...
  %symbol = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 409410170, i32* %canary
  %sym = alloca %struct.syntaxelement*, align 8
  store i32 %PartNo, i32* %PartNo.addr, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %currentSlice = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 50
...
entry:
  %partition = alloca %struct.datapartition*, align 8
  %canary = alloca i32
  store i32 1299960127, i32* %canary
  %symbol = alloca %struct.syntaxelement, align 8
  %sym = alloca %struct.syntaxelement*, align 8
  %len = alloca i32, align 4
  %PartNo.addr = alloca i32, align 4
...
entry:
  ...
  %partition = alloca %struct.datapartition*, align 8
  %canary = alloca i32
  store i32 790062125, i32* %canary
  %len = alloca i32, align 4
  %i = alloca i32, align 4
  %dP_nr = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
entry:
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1148003102, i32* %canary
  %same_slicetype_for_whole_frame = alloca i32, align 4
  store i32 5, i32* %same_slicetype_for_whole_frame, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %type = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 6
...
entry:
  ...
  %dP_nr = alloca i32, align 4
  %canary = alloca i32
  store i32 1419674894, i32* %canary
  %i = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
...
if.end175:                                        ; preds = %for.end174, %for.end83
  %170 = load i32, i32* %len, align 4
  %171 = load i32, i32* %canary
  %172 = icmp eq i32 %171, 1419674894
  br i1 %172, label %173, label %func_exit
...
entry:
  %partition = alloca %struct.datapartition*, align 8
  %canary = alloca i32
  store i32 1359664219, i32* %canary
  %len = alloca i32, align 4
  %dP_nr = alloca i32, align 4
  %j = alloca i32, align 4
  %i = alloca i32, align 4
...
if.end175:                                        ; preds = %for.end174, %for.end83
  %170 = load i32, i32* %len, align 4
  %171 = load i32, i32* %canary
  %172 = icmp eq i32 %171, 1359664219
  br i1 %172, label %173, label %func_exit
...
entry:
  %canary = alloca i32
  store i32 1713652715, i32* %canary
  %dP_nr = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
  %currSlice = alloca %struct.Slice*, align 8
  %num_bits_slice_group_change_cycle = alloca i32, align 4
...
if.end239:                                        ; preds = %if.then236, %land.lhs.true232, %if.end229
  %236 = load i32, i32* %len, align 4
  %237 = load i32, i32* %canary
  %238 = icmp eq i32 %237, 1713652715
  br i1 %238, label %239, label %func_exit
...
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1613981706, i32* %canary
  %dP_nr = alloca i32, align 4
  %len = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
  %currSlice = alloca %struct.Slice*, align 8
...
entry:
  ...
  %field_pic_flag = alloca i32, align 4
  %canary = alloca i32
  store i32 471352987, i32* %canary
  %len = alloca i32, align 4
  %bottom_field_flag = alloca i32, align 4
  %num_bits_slice_group_change_cycle = alloca i32, align 4
  %dP_nr = alloca i32, align 4
...
entry:
  ...
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
  %canary = alloca i32
  store i32 717240606, i32* %canary
  %partition = alloca %struct.datapartition*, align 8
  %dP_nr = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
...
entry:
  ...
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
  %canary = alloca i32
  store i32 403744515, i32* %canary
  %len = alloca i32, align 4
  %val = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
