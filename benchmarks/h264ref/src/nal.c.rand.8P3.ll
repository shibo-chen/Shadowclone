...
entry:
  %canary = alloca i32
  store i32 992624059, i32* %canary
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1736756595, i32* %canary
  %streamBuffer.addr = alloca i8*, align 8
  store i8* %streamBuffer, i8** %streamBuffer.addr, align 8
  store i32 %begin_bytepos, i32* %begin_bytepos.addr, align 4
  store i32 %end_bytepos, i32* %end_bytepos.addr, align 4
...
entry:
  %begin_bytepos.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1743963670, i32* %canary
  %count = alloca i32, align 4
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %end_bytepos.addr = alloca i32, align 4
...
entry:
  ...
  %count = alloca i32, align 4
  %canary = alloca i32
  store i32 814276787, i32* %canary
  %end_bytepos.addr = alloca i32, align 4
  %min_num_bytes.addr = alloca i32, align 4
  store i8* %streamBuffer, i8** %streamBuffer.addr, align 8
  store i32 %begin_bytepos, i32* %begin_bytepos.addr, align 4
...
entry:
  ...
  %min_num_bytes.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2067046012, i32* %canary
  %streamBuffer.addr = alloca i8*, align 8
  %count = alloca i32, align 4
  %end_bytepos.addr = alloca i32, align 4
  %i = alloca i32, align 4
...
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 972151163, i32* %canary
  %min_num_bytes.addr = alloca i32, align 4
  %streamBuffer.addr = alloca i8*, align 8
  %count = alloca i32, align 4
  %begin_bytepos.addr = alloca i32, align 4
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1808430060, i32* %canary
  %i = alloca i32, align 4
  store i8* %streamBuffer, i8** %streamBuffer.addr, align 8
  store i32 %begin_bytepos, i32* %begin_bytepos.addr, align 4
  store i32 %end_bytepos, i32* %end_bytepos.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 767929381, i32* %canary
  %j = alloca i32, align 4
  %begin_bytepos.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %streamBuffer.addr = alloca i8*, align 8
