; ModuleID = 'rdopt_coding_state.c.rand.8P1.bc'
...
func_store_coding_state.6:                        ; preds = %ctrl0
  call void @store_coding_state.6(%struct.CSobj* %cs)
  ret void

func_store_coding_state.9:                        ; preds = %ctrl1
  call void @store_coding_state.9(%struct.CSobj* %cs)
  ret void

func_store_coding_state.12:                       ; preds = %ctrl2
  call void @store_coding_state.12(%struct.CSobj* %cs)
  ret void

func_store_coding_state.13:                       ; preds = %ctrl3
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_store_coding_state.6, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_store_coding_state.9, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_store_coding_state.12, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_store_coding_state.13, label %ctrl4
...
func_reset_coding_state.5:                        ; preds = %ctrl2
  call void @reset_coding_state.5(%struct.CSobj* %cs)
  ret void

func_reset_coding_state.7:                        ; preds = %ctrl3
  call void @reset_coding_state.7(%struct.CSobj* %cs)
  ret void

func_reset_coding_state.8:                        ; preds = %ctrl4
  call void @reset_coding_state.8(%struct.CSobj* %cs)
  ret void

func_reset_coding_state.10:                       ; preds = %ctrl5
...
ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_reset_coding_state.5, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_reset_coding_state.7, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_reset_coding_state.8, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_reset_coding_state.10, label %func_reset_coding_state.11
}
...
entry:
  ...
  %canary = alloca i32
  store i32 673813294, i32* %canary
...
entry:
  ...
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %canary = alloca i32
  store i32 1290778722, i32* %canary
  %bs_src = alloca %struct.Bitstream*, align 8
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
...
entry:
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 454219288, i32* %canary
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %bs_dest = alloca %struct.Bitstream*, align 8
  %bs_src = alloca %struct.Bitstream*, align 8
  %cs.addr = alloca %struct.CSobj*, align 8
...
entry:
  ...
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %canary = alloca i32
  store i32 1531133783, i32* %canary
  %bs_src = alloca %struct.Bitstream*, align 8
  %bs_dest = alloca %struct.Bitstream*, align 8
  %currMB = alloca %struct.macroblock*, align 8
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
...
entry:
  ...
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %canary = alloca i32
  store i32 1563351044, i32* %canary
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  store %struct.CSobj* %cs, %struct.CSobj** %cs.addr, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %currentSlice = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 50
...
entry:
  %canary = alloca i32
  store i32 1947631059, i32* %canary
  %bs_dest = alloca %struct.Bitstream*, align 8
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %currMB = alloca %struct.macroblock*, align 8
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
...
entry:
  ...
  %cs.addr = alloca %struct.CSobj*, align 8
  %canary = alloca i32
  store i32 684251142, i32* %canary
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  store %struct.CSobj* %cs, %struct.CSobj** %cs.addr, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %currentSlice = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 50
...
entry:
  ...
  %bs_dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 1520465670, i32* %canary
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %i = alloca i32, align 4
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
...
entry:
  ...
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %canary = alloca i32
  store i32 1022710234, i32* %canary
  %currMB = alloca %struct.macroblock*, align 8
  %cs.addr = alloca %struct.CSobj*, align 8
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
...
entry:
  ...
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %canary = alloca i32
  store i32 1502386112, i32* %canary
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %bs_src = alloca %struct.Bitstream*, align 8
  %i = alloca i32, align 4
...
entry:
  ...
  %currMB = alloca %struct.macroblock*, align 8
  %canary = alloca i32
  store i32 325773821, i32* %canary
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %i = alloca i32, align 4
  %bs_dest = alloca %struct.Bitstream*, align 8
...
entry:
  ...
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %canary = alloca i32
  store i32 1917791764, i32* %canary
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %i = alloca i32, align 4
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
...
entry:
  ...
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 1072639684, i32* %canary
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %cs.addr = alloca %struct.CSobj*, align 8
  store %struct.CSobj* %cs, %struct.CSobj** %cs.addr, align 8
...
entry:
  ...
  %cs.addr = alloca %struct.CSobj*, align 8
  %canary = alloca i32
  store i32 110835438, i32* %canary
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %i = alloca i32, align 4
  %currMB = alloca %struct.macroblock*, align 8
...
entry:
  ...
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %canary = alloca i32
  store i32 1474671584, i32* %canary
  %currMB = alloca %struct.macroblock*, align 8
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  store %struct.CSobj* %cs, %struct.CSobj** %cs.addr, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 592948488, i32* %canary
  %cs.addr = alloca %struct.CSobj*, align 8
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %bs_dest = alloca %struct.Bitstream*, align 8
