; ModuleID = 'biariencode.c.rand.4R2.bc'
...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_arienco_start_encoding.2, label %ctrl0

func_arienco_start_encoding.2:                    ; preds = %rand_bb
  call void @arienco_start_encoding.2(%struct.EncodingEnvironment* %eep, i8* %code_buffer, i32* %code_len, i32 %slice_type)
  ret void
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_arienco_start_encoding.14, label %func_arienco_start_encoding.17
}
...
func_biari_encode_symbol.3:                       ; preds = %ctrl0
  call void @biari_encode_symbol.3(%struct.EncodingEnvironment* %eep, i16 %symbol, %struct.BiContextType* %bi_ct)
  ret void

func_biari_encode_symbol.7:                       ; preds = %ctrl1
  call void @biari_encode_symbol.7(%struct.EncodingEnvironment* %eep, i16 %symbol, %struct.BiContextType* %bi_ct)
  ret void

func_biari_encode_symbol.10:                      ; preds = %ctrl1
  call void @biari_encode_symbol.10(%struct.EncodingEnvironment* %eep, i16 %symbol, %struct.BiContextType* %bi_ct)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_biari_encode_symbol.3, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_biari_encode_symbol.7, label %func_biari_encode_symbol.10
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_biari_encode_symbol_eq_prob.8, label %ctrl0

func_biari_encode_symbol_eq_prob.8:               ; preds = %rand_bb
  call void @biari_encode_symbol_eq_prob.8(%struct.EncodingEnvironment* %eep, i16 %symbol)
  ret void

func_biari_encode_symbol_eq_prob.13:              ; preds = %ctrl0
  call void @biari_encode_symbol_eq_prob.13(%struct.EncodingEnvironment* %eep, i16 %symbol)
  ret void

func_biari_encode_symbol_eq_prob.15:              ; preds = %ctrl1
  call void @biari_encode_symbol_eq_prob.15(%struct.EncodingEnvironment* %eep, i16 %symbol)
  ret void

func_biari_encode_symbol_eq_prob.18:              ; preds = %ctrl1
  call void @biari_encode_symbol_eq_prob.18(%struct.EncodingEnvironment* %eep, i16 %symbol)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_biari_encode_symbol_eq_prob.13, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_biari_encode_symbol_eq_prob.15, label %func_biari_encode_symbol_eq_prob.18
}
...
func_biari_encode_symbol_final.19:                ; preds = %ctrl1
  call void @biari_encode_symbol_final.19(%struct.EncodingEnvironment* %eep, i16 %symbol)
  ret void

func_biari_encode_symbol_final.20:                ; preds = %ctrl1
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_biari_encode_symbol_final.19, label %func_biari_encode_symbol_final.20
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_biari_init_context.6, label %ctrl0

func_biari_init_context.6:                        ; preds = %rand_bb
...
func_biari_init_context.16:                       ; preds = %ctrl1
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_biari_init_context.12, label %func_biari_init_context.16
}
...
entry:
  %canary = alloca i32
  store i32 1270673072, i32* %canary
...
while.end162:                                     ; preds = %while.cond
  ...
  %137 = icmp eq i32 %136, 1270673072
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @arienco_start_encoding.2(%struct.EncodingEnvironment* %eep, i8* %code_buffer, i32* %code_len, i32 %slice_type) #0 {
entry:
  %canary = alloca i32
  store i32 813551023, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_encode_symbol.3(%struct.EncodingEnvironment* %eep, i16 signext %symbol, %struct.BiContextType* %bi_ct) #0 {
entry:
  %canary = alloca i32
  store i32 2074968756, i32* %canary
  %bi_ct.addr = alloca %struct.BiContextType*, align 8
  %symbol.addr = alloca i16, align 2
  %low = alloca i32, align 4
  %range = alloca i32, align 4
...
while.end162:                                     ; preds = %while.cond
  ...
  store i32 %inc166, i32* %C165, align 8
  %136 = load i32, i32* %canary
  %137 = icmp eq i32 %136, 2074968756
  br i1 %137, label %138, label %func_exit
...
entry:
  %range = alloca i32, align 4
  %canary = alloca i32
  store i32 2118135126, i32* %canary
  %low = alloca i32, align 4
  %symbol.addr = alloca i16, align 2
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
...
while.end125:                                     ; preds = %while.cond
  ...
  %111 = icmp eq i32 %110, 2118135126
...
entry:
  ...
  %symbol.addr = alloca i16, align 2
  %canary = alloca i32
  store i32 699304798, i32* %canary
  %range = alloca i32, align 4
  %low = alloca i32, align 4
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
...
entry:
  ...
  %canary = alloca i32
  store i32 1596318166, i32* %canary
...
entry:
  %rLPS = alloca i32, align 4
  %canary = alloca i32
  store i32 1493481250, i32* %canary
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %range = alloca i32, align 4
  %low = alloca i32, align 4
  %symbol.addr = alloca i16, align 2
...
while.end162:                                     ; preds = %while.cond
  ...
  store i32 %inc166, i32* %C165, align 8
  %136 = load i32, i32* %canary
  %137 = icmp eq i32 %136, 1493481250
  br i1 %137, label %138, label %func_exit
...
entry:
  %canary = alloca i32
  store i32 1451433637, i32* %canary
  %low = alloca i32, align 4
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %symbol.addr = alloca i16, align 2
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
...
if.end124:                                        ; preds = %if.end123, %while.end51
  ...
  %105 = icmp eq i32 %104, 1451433637
...
entry:
  %code_len.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 162050878, i32* %canary
  %code_buffer.addr = alloca i8*, align 8
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %slice_type.addr = alloca i32, align 4
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
...
entry:
  %bi_ct.addr = alloca %struct.BiContextType*, align 8
  %canary = alloca i32
  store i32 239211198, i32* %canary
  %symbol.addr = alloca i16, align 2
  %range = alloca i32, align 4
  %low = alloca i32, align 4
  %rLPS = alloca i32, align 4
...
entry:
  %ctx.addr = alloca %struct.BiContextType*, align 8
  %canary = alloca i32
  store i32 486200061, i32* %canary
  %pstate = alloca i32, align 4
  %ini.addr = alloca i32*, align 8
  store %struct.BiContextType* %ctx, %struct.BiContextType** %ctx.addr, align 8
  store i32* %ini, i32** %ini.addr, align 8
...
entry:
  ...
  %ini.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 309480722, i32* %canary
  %ctx.addr = alloca %struct.BiContextType*, align 8
  store %struct.BiContextType* %ctx, %struct.BiContextType** %ctx.addr, align 8
  store i32* %ini, i32** %ini.addr, align 8
  %0 = load i32*, i32** %ini.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_encode_symbol_eq_prob.13(%struct.EncodingEnvironment* %eep, i16 signext %symbol) #0 {
entry:
  %canary = alloca i32
  store i32 203828558, i32* %canary
  %symbol.addr = alloca i16, align 2
  %low = alloca i32, align 4
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
...
entry:
  ...
  %code_len.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 1496570094, i32* %canary
  %slice_type.addr = alloca i32, align 4
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i8* %code_buffer, i8** %code_buffer.addr, align 8
  store i32* %code_len, i32** %code_len.addr, align 8
...
entry:
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 330223669, i32* %canary
  %low = alloca i32, align 4
  %symbol.addr = alloca i16, align 2
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
...
entry:
  ...
  %ini.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 612789804, i32* %canary
  %pstate = alloca i32, align 4
  store %struct.BiContextType* %ctx, %struct.BiContextType** %ctx.addr, align 8
  store i32* %ini, i32** %ini.addr, align 8
  %0 = load i32*, i32** %ini.addr, align 8
...
entry:
  ...
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 179957097, i32* %canary
  %slice_type.addr = alloca i32, align 4
  %code_len.addr = alloca i32*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i8* %code_buffer, i8** %code_buffer.addr, align 8
...
entry:
  ...
  %symbol.addr = alloca i16, align 2
  %canary = alloca i32
  store i32 1578432152, i32* %canary
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
  %0 = load %struct.EncodingEnvironment*, %struct.EncodingEnvironment** %eep.addr, align 8
...
if.end124:                                        ; preds = %if.end123, %while.end51
  ...
  store i32 %inc127, i32* %C126, align 8
  %104 = load i32, i32* %canary
  %105 = icmp eq i32 %104, 1578432152
  br i1 %105, label %106, label %func_exit
...
entry:
  %canary = alloca i32
  store i32 1565832733, i32* %canary
  %symbol.addr = alloca i16, align 2
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %range = alloca i32, align 4
  %low = alloca i32, align 4
...
while.end125:                                     ; preds = %while.cond
  ...
  store i32 %inc129, i32* %C128, align 8
  %110 = load i32, i32* %canary
  %111 = icmp eq i32 %110, 1565832733
  br i1 %111, label %112, label %func_exit
...
entry:
  %canary = alloca i32
  store i32 1300400196, i32* %canary
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %range = alloca i32, align 4
  %symbol.addr = alloca i16, align 2
  %low = alloca i32, align 4
...
while.end125:                                     ; preds = %while.cond
  ...
  store i32 %inc129, i32* %C128, align 8
  %110 = load i32, i32* %canary
  %111 = icmp eq i32 %110, 1300400196
  br i1 %111, label %112, label %func_exit
