...
.LBB0_5:                                # %func_RandomIntraInit.9
	...
	.cfi_def_cfa %rsp, 8
	retq
.LBB0_6:                                # %func_RandomIntraInit.11
	.cfi_def_cfa %rbp, 16
	movl	%ebx, %edi
	movl	%r15d, %esi
	movl	%r14d, %edx
	...
	.cfi_def_cfa %rsp, 8
	retq
.LBB0_7:                                # %func_RandomIntraInit.12
	.cfi_def_cfa %rbp, 16
	movl	%ebx, %edi
	movl	%r15d, %esi
	movl	%r14d, %edx
...
.LBB0_8:                                # %func_RandomIntraInit.13
	...
	.cfi_def_cfa %rsp, 8
	retq
.LBB0_9:                                # %func_RandomIntraInit.16
	.cfi_def_cfa %rbp, 16
	movl	%ebx, %edi
	movl	%r15d, %esi
	movl	%r14d, %edx
	...
	.cfi_def_cfa %rsp, 8
	retq
.LBB0_10:                               # %func_RandomIntraInit.17
	.cfi_def_cfa %rbp, 16
	movl	%ebx, %edi
	movl	%r15d, %esi
	movl	%r14d, %edx
	...
	.cfi_def_cfa %rsp, 8
	retq
.LBB0_11:                               # %func_RandomIntraInit.18
	.cfi_def_cfa %rbp, 16
	movl	%ebx, %edi
	movl	%r15d, %esi
	movl	%r14d, %edx
	...
	.cfi_def_cfa %rsp, 8
	retq
.LBB0_12:                               # %func_RandomIntraInit.19
	.cfi_def_cfa %rbp, 16
	movl	%ebx, %edi
	movl	%r15d, %esi
	movl	%r14d, %edx
...
.LBB1_5:                                # %func_RandomIntra.15
	...
	.cfi_def_cfa %rsp, 8
	retq
.LBB1_6:                                # %func_RandomIntra.20
	.cfi_def_cfa %rbp, 16
	movl	%ebx, %edi
	callq	RandomIntra.20
	addq	$8, %rsp
	popq	%rbx
	popq	%rbp
	.cfi_def_cfa %rsp, 8
...
# %bb.0:                                # %rand_bb
	...
	cmpl	$0, %eax
	jne	.LBB2_2
# %bb.1:                                # %func_RandomIntraNewPicture.3
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$124581605, -24(%rbp)   # imm = 0x76CF6E5
	movl	%edi, -20(%rbp)
	movl	%esi, -16(%rbp)
	movl	%edx, -8(%rbp)
	movl	$1, %edi
...
# %bb.14:                               # %for.inc23
	...
	jmp	.LBB4_9
.LBB4_15:                               # %for.end25
	cmpl	$124581605, -24(%rbp)   # imm = 0x76CF6E5
	jne	.LBB4_17
.LBB4_16:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1994702894, -24(%rbp)  # imm = 0x76E4C02E
	movl	%edi, -16(%rbp)
	movl	%esi, -20(%rbp)
	movl	%edx, -12(%rbp)
	movl	$1, %edi
...
# %bb.14:                               # %for.inc23
	...
	jmp	.LBB5_9
.LBB5_15:                               # %for.end25
	cmpl	$1994702894, -24(%rbp)  # imm = 0x76E4C02E
	jne	.LBB5_17
.LBB5_16:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$16, %rsp
	movl	$761689028, -12(%rbp)   # imm = 0x2D6673C4
...
# %bb.3:                                # %for.inc
	...
	jmp	.LBB6_1
.LBB6_4:                                # %for.end
	cmpl	$761689028, -12(%rbp)   # imm = 0x2D6673C4
	jne	.LBB6_6
.LBB6_5:
	addq	$16, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$1359352389, -24(%rbp)  # imm = 0x51061245
	movl	%edi, -20(%rbp)
	movl	$0, -12(%rbp)
.LBB7_1:                                # %for.cond
                                        # =>This Inner Loop Header: Depth=1
...
.LBB7_7:                                # %return
	movl	-16(%rbp), %ebx
	cmpl	$1359352389, -24(%rbp)  # imm = 0x51061245
	jne	.LBB7_9
.LBB7_8:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$16, %rsp
	movl	$1717717732, -12(%rbp)  # imm = 0x66624AE4
	movl	NumberIntraPerPicture, %eax
	addl	WalkAround, %eax
	movl	%eax, WalkAround
	movl	$0, -4(%rbp)
...
# %bb.3:                                # %for.inc
	...
	jmp	.LBB8_1
.LBB8_4:                                # %for.end
	cmpl	$1717717732, -12(%rbp)  # imm = 0x66624AE4
	jne	.LBB8_6
.LBB8_5:
	addq	$16, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$1183039603, -20(%rbp)  # imm = 0x4683C073
	movl	%edi, -24(%rbp)
	movl	$0, -12(%rbp)
.LBB9_1:                                # %for.cond
                                        # =>This Inner Loop Header: Depth=1
...
.LBB9_7:                                # %return
	movl	-16(%rbp), %ebx
	cmpl	$1183039603, -20(%rbp)  # imm = 0x4683C073
	jne	.LBB9_9
.LBB9_8:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1028063074, -24(%rbp)  # imm = 0x3D46FF62
	movl	%edi, -16(%rbp)
	movl	%esi, -20(%rbp)
	movl	%edx, -12(%rbp)
	movl	$1, %edi
...
# %bb.14:                               # %for.inc23
	...
	jmp	.LBB10_9
.LBB10_15:                              # %for.end25
	cmpl	$1028063074, -24(%rbp)  # imm = 0x3D46FF62
	jne	.LBB10_17
.LBB10_16:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1242310904, -20(%rbp)  # imm = 0x4A0C28F8
	movl	%edi, -16(%rbp)
	movl	%esi, -24(%rbp)
	movl	%edx, -12(%rbp)
	movl	$1, %edi
...
# %bb.14:                               # %for.inc23
	...
	jmp	.LBB11_9
.LBB11_15:                              # %for.end25
	cmpl	$1242310904, -20(%rbp)  # imm = 0x4A0C28F8
	jne	.LBB11_17
.LBB11_16:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1230945489, -20(%rbp)  # imm = 0x495EBCD1
	movl	%edi, -24(%rbp)
	movl	%esi, -16(%rbp)
	movl	%edx, -12(%rbp)
	movl	$1, %edi
...
# %bb.14:                               # %for.inc23
	...
	jmp	.LBB12_9
.LBB12_15:                              # %for.end25
	cmpl	$1230945489, -20(%rbp)  # imm = 0x495EBCD1
	jne	.LBB12_17
.LBB12_16:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$2123371136, -20(%rbp)  # imm = 0x7E901280
	movl	%edi, -24(%rbp)
	movl	$0, -12(%rbp)
.LBB13_1:                               # %for.cond
                                        # =>This Inner Loop Header: Depth=1
...
.LBB13_7:                               # %return
	movl	-16(%rbp), %ebx
	cmpl	$2123371136, -20(%rbp)  # imm = 0x7E901280
	jne	.LBB13_9
.LBB13_8:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1254439763, -24(%rbp)  # imm = 0x4AC53B53
	movl	%edi, -16(%rbp)
	movl	%esi, -20(%rbp)
	movl	%edx, -8(%rbp)
	movl	$1, %edi
...
# %bb.14:                               # %for.inc23
	...
	jmp	.LBB14_9
.LBB14_15:                              # %for.end25
	cmpl	$1254439763, -24(%rbp)  # imm = 0x4AC53B53
	jne	.LBB14_17
.LBB14_16:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$56698460, -16(%rbp)    # imm = 0x361265C
	movl	%edi, -20(%rbp)
	movl	%esi, -24(%rbp)
	movl	%edx, -8(%rbp)
	movl	$1, %edi
...
# %bb.14:                               # %for.inc23
	...
	jmp	.LBB15_9
.LBB15_15:                              # %for.end25
	cmpl	$56698460, -16(%rbp)    # imm = 0x361265C
	jne	.LBB15_17
.LBB15_16:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1376904271, -24(%rbp)  # imm = 0x5211E44F
	movl	%edi, -20(%rbp)
	movl	%esi, -16(%rbp)
	movl	%edx, -8(%rbp)
	movl	$1, %edi
...
# %bb.14:                               # %for.inc23
	...
	jmp	.LBB16_9
.LBB16_15:                              # %for.end25
	cmpl	$1376904271, -24(%rbp)  # imm = 0x5211E44F
	jne	.LBB16_17
.LBB16_16:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$430228864, -20(%rbp)   # imm = 0x19A4C580
	movl	%edi, -24(%rbp)
	movl	$0, -12(%rbp)
.LBB17_1:                               # %for.cond
                                        # =>This Inner Loop Header: Depth=1
...
.LBB17_7:                               # %return
	movl	-16(%rbp), %ebx
	cmpl	$430228864, -20(%rbp)   # imm = 0x19A4C580
	jne	.LBB17_9
.LBB17_8:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$767859377, -24(%rbp)   # imm = 0x2DC49AB1
	movl	%edi, -20(%rbp)
	movl	$0, -12(%rbp)
.LBB18_1:                               # %for.cond
                                        # =>This Inner Loop Header: Depth=1
...
.LBB18_7:                               # %return
	movl	-16(%rbp), %ebx
	cmpl	$767859377, -24(%rbp)   # imm = 0x2DC49AB1
	jne	.LBB18_9
.LBB18_8:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$2032211479, -20(%rbp)  # imm = 0x79211617
	movl	%edi, -24(%rbp)
	movl	%esi, -16(%rbp)
	movl	%edx, -8(%rbp)
	movl	$1, %edi
...
# %bb.14:                               # %for.inc23
	...
	jmp	.LBB19_9
.LBB19_15:                              # %for.end25
	cmpl	$2032211479, -20(%rbp)  # imm = 0x79211617
	jne	.LBB19_17
.LBB19_16:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$878439419, -20(%rbp)   # imm = 0x345BEBFB
	movl	%edi, -16(%rbp)
	movl	%esi, -24(%rbp)
	movl	%edx, -8(%rbp)
	movl	$1, %edi
...
# %bb.14:                               # %for.inc23
	...
	jmp	.LBB20_9
.LBB20_15:                              # %for.end25
	cmpl	$878439419, -20(%rbp)   # imm = 0x345BEBFB
	jne	.LBB20_17
.LBB20_16:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1849459957, -24(%rbp)  # imm = 0x6E3C84F5
	movl	%edi, -16(%rbp)
	movl	%esi, -20(%rbp)
	movl	%edx, -12(%rbp)
	movl	$1, %edi
...
# %bb.14:                               # %for.inc23
	...
	jmp	.LBB21_9
.LBB21_15:                              # %for.end25
	cmpl	$1849459957, -24(%rbp)  # imm = 0x6E3C84F5
	jne	.LBB21_17
.LBB21_16:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1854758325, -20(%rbp)  # imm = 0x6E8D5DB5
	movl	%edi, -16(%rbp)
	movl	%esi, -24(%rbp)
	movl	%edx, -8(%rbp)
	movl	$1, %edi
...
# %bb.14:                               # %for.inc23
	...
	jmp	.LBB22_9
.LBB22_15:                              # %for.end25
	cmpl	$1854758325, -20(%rbp)  # imm = 0x6E8D5DB5
	jne	.LBB22_17
.LBB22_16:
	addq	$32, %rsp
	popq	%rbp
...
.Lfunc_end22:
	...
	.cfi_endproc
                                        # -- End function
	.globl	RandomIntra.20          # -- Begin function RandomIntra.20
	.p2align	4, 0x90
	.type	RandomIntra.20,@function
RandomIntra.20:                         # @RandomIntra.20
	.cfi_startproc
# %bb.0:                                # %entry
	pushq	%rbp
	.cfi_def_cfa_offset 16
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$642169757, -24(%rbp)   # imm = 0x2646BB9D
	movl	%edi, -20(%rbp)
	movl	$0, -12(%rbp)
.LBB23_1:                               # %for.cond
                                        # =>This Inner Loop Header: Depth=1
...
.LBB23_7:                               # %return
	movl	-16(%rbp), %ebx
	cmpl	$642169757, -24(%rbp)   # imm = 0x2646BB9D
	jne	.LBB23_9
.LBB23_8:
	movl	%ebx, %eax
	addq	$24, %rsp
...
.LBB23_9:                               # %func_exit
	...
	jmp	.LBB23_8
.Lfunc_end23:
	.size	RandomIntra.20, .Lfunc_end23-RandomIntra.20
	.cfi_endproc
                                        # -- End function
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$552020533, -20(%rbp)   # imm = 0x20E72A35
	movl	%edi, -16(%rbp)
	movl	%esi, -24(%rbp)
	movl	%edx, -8(%rbp)
	movl	$1, %edi
...
# %bb.14:                               # %for.inc23
	...
	jmp	.LBB24_9
.LBB24_15:                              # %for.end25
	cmpl	$552020533, -20(%rbp)   # imm = 0x20E72A35
	jne	.LBB24_17
.LBB24_16:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1485772709, -24(%rbp)  # imm = 0x588F17A5
	movl	%edi, -16(%rbp)
	movl	%esi, -20(%rbp)
	movl	%edx, -12(%rbp)
	movl	$1, %edi
...
# %bb.14:                               # %for.inc23
	...
	jmp	.LBB25_9
.LBB25_15:                              # %for.end25
	cmpl	$1485772709, -24(%rbp)  # imm = 0x588F17A5
	jne	.LBB25_17
.LBB25_16:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1183191315, -24(%rbp)  # imm = 0x46861113
	movl	%edi, -16(%rbp)
	movl	%esi, -20(%rbp)
	movl	%edx, -12(%rbp)
	movl	$1, %edi
...
# %bb.14:                               # %for.inc23
	...
	jmp	.LBB26_9
.LBB26_15:                              # %for.end25
	cmpl	$1183191315, -24(%rbp)  # imm = 0x46861113
	jne	.LBB26_17
.LBB26_16:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$777991526, -20(%rbp)   # imm = 0x2E5F3566
	movl	%edi, -24(%rbp)
	movl	%esi, -16(%rbp)
	movl	%edx, -8(%rbp)
	movl	$1, %edi
...
# %bb.14:                               # %for.inc23
	...
	jmp	.LBB27_9
.LBB27_15:                              # %for.end25
	cmpl	$777991526, -20(%rbp)   # imm = 0x2E5F3566
	jne	.LBB27_17
.LBB27_16:
	addq	$32, %rsp
	popq	%rbp
