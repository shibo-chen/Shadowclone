...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_GenerateParameterSets.10, label %func_GenerateParameterSets.16

func_GenerateParameterSets.10:                    ; preds = %rand_bb
  call void @GenerateParameterSets.10()
  ret void

func_GenerateParameterSets.16:                    ; preds = %rand_bb
  call void @GenerateParameterSets.16()
  ret void
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_GenerateSequenceParameterSet.4, label %ctrl0

func_GenerateSequenceParameterSet.4:              ; preds = %rand_bb
  call void @GenerateSequenceParameterSet.4(%struct.seq_parameter_set_rbsp_t* %sps, i32 %SPS_id)
  ret void
...
func_GenerateSequenceParameterSet.7:              ; preds = %ctrl1
  call void @GenerateSequenceParameterSet.7(%struct.seq_parameter_set_rbsp_t* %sps, i32 %SPS_id)
  ret void
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_GenerateSequenceParameterSet.7, label %func_GenerateSequenceParameterSet.8
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_GeneratePictureParameterSet.1, label %ctrl0

func_GeneratePictureParameterSet.1:               ; preds = %rand_bb
  call void @GeneratePictureParameterSet.1(%struct.pic_parameter_set_rbsp_t* %pps, %struct.seq_parameter_set_rbsp_t* %sps, i32 %PPS_id, i32 %WeightedPrediction, i32 %WeightedBiprediction, i32 %cb_qp_index_offset, i32 %cr_qp_index_offset)
  ret void
...
func_GeneratePictureParameterSet.25:              ; preds = %ctrl1
  call void @GeneratePictureParameterSet.25(%struct.pic_parameter_set_rbsp_t* %pps, %struct.seq_parameter_set_rbsp_t* %sps, i32 %PPS_id, i32 %WeightedPrediction, i32 %WeightedBiprediction, i32 %cb_qp_index_offset, i32 %cr_qp_index_offset)
  ret void

func_GeneratePictureParameterSet.27:              ; preds = %ctrl1
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_GeneratePictureParameterSet.25, label %func_GeneratePictureParameterSet.27
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_GenerateSeq_parameter_set_NALU.14, label %ctrl0

func_GenerateSeq_parameter_set_NALU.14:           ; preds = %rand_bb
  %2 = call %struct.NALU_t* @GenerateSeq_parameter_set_NALU.14()
  ret %struct.NALU_t* %2
...
func_GenerateSeq_parameter_set_NALU.20:           ; preds = %ctrl1
  %4 = call %struct.NALU_t* @GenerateSeq_parameter_set_NALU.20()
  ret %struct.NALU_t* %4

func_GenerateSeq_parameter_set_NALU.28:           ; preds = %ctrl1
  %5 = call %struct.NALU_t* @GenerateSeq_parameter_set_NALU.28()
  ret %struct.NALU_t* %5
...
ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_GenerateSeq_parameter_set_NALU.20, label %func_GenerateSeq_parameter_set_NALU.28
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_GenerateSeq_parameter_set_rbsp.3, label %ctrl0

func_GenerateSeq_parameter_set_rbsp.3:            ; preds = %rand_bb
  %2 = call i32 @GenerateSeq_parameter_set_rbsp.3(%struct.seq_parameter_set_rbsp_t* %sps, i8* %rbsp)
  ret i32 %2
...
func_GenerateSeq_parameter_set_rbsp.21:           ; preds = %ctrl1
  %4 = call i32 @GenerateSeq_parameter_set_rbsp.21(%struct.seq_parameter_set_rbsp_t* %sps, i8* %rbsp)
  ret i32 %4

func_GenerateSeq_parameter_set_rbsp.26:           ; preds = %ctrl1
  %5 = call i32 @GenerateSeq_parameter_set_rbsp.26(%struct.seq_parameter_set_rbsp_t* %sps, i8* %rbsp)
  ret i32 %5
...
ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_GenerateSeq_parameter_set_rbsp.21, label %func_GenerateSeq_parameter_set_rbsp.26
}
...
func_GeneratePic_parameter_set_NALU.11:           ; preds = %ctrl0
  %3 = call %struct.NALU_t* @GeneratePic_parameter_set_NALU.11(i32 %PPS_id)
  ret %struct.NALU_t* %3

func_GeneratePic_parameter_set_NALU.18:           ; preds = %ctrl1
  %4 = call %struct.NALU_t* @GeneratePic_parameter_set_NALU.18(i32 %PPS_id)
  ret %struct.NALU_t* %4

func_GeneratePic_parameter_set_NALU.22:           ; preds = %ctrl1
  %5 = call %struct.NALU_t* @GeneratePic_parameter_set_NALU.22(i32 %PPS_id)
  ret %struct.NALU_t* %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_GeneratePic_parameter_set_NALU.11, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_GeneratePic_parameter_set_NALU.18, label %func_GeneratePic_parameter_set_NALU.22
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_GeneratePic_parameter_set_rbsp.6, label %ctrl0

func_GeneratePic_parameter_set_rbsp.6:            ; preds = %rand_bb
  %2 = call i32 @GeneratePic_parameter_set_rbsp.6(%struct.pic_parameter_set_rbsp_t* %pps, i8* %rbsp)
  ret i32 %2

func_GeneratePic_parameter_set_rbsp.29:           ; preds = %ctrl0
  %3 = call i32 @GeneratePic_parameter_set_rbsp.29(%struct.pic_parameter_set_rbsp_t* %pps, i8* %rbsp)
  ret i32 %3
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_GeneratePic_parameter_set_rbsp.29, label %ctrl1
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_Scaling_List.19, label %ctrl0

func_Scaling_List.19:                             ; preds = %rand_bb
  %2 = call i32 @Scaling_List.19(i16* %scalingListinput, i16* %scalingList, i32 %sizeOfScalingList, i16* %UseDefaultScalingMatrix, %struct.datapartition* %partition)
  ret i32 %2

func_Scaling_List.23:                             ; preds = %ctrl0
  %3 = call i32 @Scaling_List.23(i16* %scalingListinput, i16* %scalingList, i32 %sizeOfScalingList, i16* %UseDefaultScalingMatrix, %struct.datapartition* %partition)
  ret i32 %3

func_Scaling_List.24:                             ; preds = %ctrl1
  %4 = call i32 @Scaling_List.24(i16* %scalingListinput, i16* %scalingList, i32 %sizeOfScalingList, i16* %UseDefaultScalingMatrix, %struct.datapartition* %partition)
  ret i32 %4

func_Scaling_List.30:                             ; preds = %ctrl1
  %5 = call i32 @Scaling_List.30(i16* %scalingListinput, i16* %scalingList, i32 %sizeOfScalingList, i16* %UseDefaultScalingMatrix, %struct.datapartition* %partition)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_Scaling_List.23, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_Scaling_List.24, label %func_Scaling_List.30
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_GenerateVUISequenceParameters.2, label %func_GenerateVUISequenceParameters.12

func_GenerateVUISequenceParameters.2:             ; preds = %rand_bb
  %2 = call i32 @GenerateVUISequenceParameters.2(%struct.datapartition* %partition)
  ret i32 %2
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @GeneratePictureParameterSet.1(%struct.pic_parameter_set_rbsp_t* %pps, %struct.seq_parameter_set_rbsp_t* %sps, i32 %PPS_id, i32 %WeightedPrediction, i32 %WeightedBiprediction, i32 %cb_qp_index_offset, i32 %cr_qp_index_offset) #0 {
entry:
  %canary = alloca i32
  store i32 568260986, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @GenerateVUISequenceParameters.2(%struct.datapartition* %partition) #0 {
entry:
  %partition.addr = alloca %struct.datapartition*, align 8
  %canary = alloca i32
  store i32 540151810, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @GenerateSeq_parameter_set_rbsp.3(%struct.seq_parameter_set_rbsp_t* %sps, i8* %rbsp) #0 {
entry:
  %canary = alloca i32
  store i32 807524594, i32* %canary
  %len = alloca i32, align 4
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @GenerateSequenceParameterSet.4(%struct.seq_parameter_set_rbsp_t* %sps, i32 %SPS_id) #0 {
entry:
  %sps.addr = alloca %struct.seq_parameter_set_rbsp_t*, align 8
  ...
  %canary = alloca i32
  store i32 2088051970, i32* %canary
...
if.end137:                                        ; preds = %if.else135, %if.end134
  ...
  %163 = icmp eq i32 %162, 2088051970
...
entry:
  ...
  %height = alloca i32, align 4
  %canary = alloca i32
  store i32 614181339, i32* %canary
  %FrameHeightInMbs = alloca i32, align 4
  %sps.addr = alloca %struct.seq_parameter_set_rbsp_t*, align 8
  store %struct.seq_parameter_set_rbsp_t* %sps, %struct.seq_parameter_set_rbsp_t** %sps.addr, align 8
  store i32 %SPS_id, i32* %SPS_id.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @GeneratePic_parameter_set_rbsp.6(%struct.pic_parameter_set_rbsp_t* %pps, i8* %rbsp) #0 {
entry:
  %i = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  ...
  %canary = alloca i32
  store i32 1420586524, i32* %canary
  %len = alloca i32, align 4
  %rbsp.addr = alloca i8*, align 8
  %LenInBytes = alloca i32, align 4
...
if.end201:                                        ; preds = %if.end198, %lor.lhs.false143
  ...
  %202 = icmp eq i32 %201, 1420586524
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @GenerateSequenceParameterSet.7(%struct.seq_parameter_set_rbsp_t* %sps, i32 %SPS_id) #0 {
entry:
  %height = alloca i32, align 4
  %PicHeightInMapUnits = alloca i32, align 4
  %sps.addr = alloca %struct.seq_parameter_set_rbsp_t*, align 8
  %frext_profile = alloca i32, align 4
  %canary = alloca i32
  store i32 2144207728, i32* %canary
  %PicWidthInMbs = alloca i32, align 4
  %SPS_id.addr = alloca i32, align 4
  %FrameHeightInMbs = alloca i32, align 4
  %i = alloca i32, align 4
...
if.end137:                                        ; preds = %if.else135, %if.end134
  %162 = load i32, i32* %canary
  %163 = icmp eq i32 %162, 2144207728
  br i1 %163, label %164, label %func_exit
...
entry:
  ...
  %sps.addr = alloca %struct.seq_parameter_set_rbsp_t*, align 8
  %canary = alloca i32
  store i32 1138813893, i32* %canary
  %frext_profile = alloca i32, align 4
  %i = alloca i32, align 4
  %SubWidthC = alloca [4 x i32], align 16
  %SPS_id.addr = alloca i32, align 4
...
if.end137:                                        ; preds = %if.else135, %if.end134
  %162 = load i32, i32* %canary
  %163 = icmp eq i32 %162, 1138813893
  br i1 %163, label %164, label %func_exit
...
entry:
  ...
  %canary = alloca i32
  store i32 346249144, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1655189766, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct.NALU_t* @GeneratePic_parameter_set_NALU.11(i32 %PPS_id) #0 {
entry:
  %RBSPlen = alloca i32, align 4
  %canary = alloca i32
  store i32 1794809998, i32* %canary
  %rbsp = alloca [64000 x i8], align 16
  %n = alloca %struct.NALU_t*, align 8
  %NALUlen = alloca i32, align 4
  %PPS_id.addr = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1576773580, i32* %canary
  %len = alloca i32, align 4
  %partition.addr = alloca %struct.datapartition*, align 8
  store %struct.datapartition* %partition, %struct.datapartition** %partition.addr, align 8
  store i32 0, i32* %len, align 4
...
entry:
  ...
  %len = alloca i32, align 4
  %canary = alloca i32
  store i32 1877867975, i32* %canary
  %partition = alloca %struct.datapartition*, align 8
  store %struct.seq_parameter_set_rbsp_t* %sps, %struct.seq_parameter_set_rbsp_t** %sps.addr, align 8
  store i8* %rbsp, i8** %rbsp.addr, align 8
  store i32 0, i32* %len, align 4
...
if.end158:                                        ; preds = %if.then155, %if.end150
  ...
  %206 = load i32, i32* %LenInBytes, align 4
  %207 = load i32, i32* %canary
  %208 = icmp eq i32 %207, 1877867975
  br i1 %208, label %209, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct.NALU_t* @GenerateSeq_parameter_set_NALU.14() #0 {
entry:
  %rbsp = alloca [64000 x i8], align 16
  %canary = alloca i32
  store i32 1953399553, i32* %canary
  %RBSPlen = alloca i32, align 4
  %NALUlen = alloca i32, align 4
  %n = alloca %struct.NALU_t*, align 8
  %call = call %struct.NALU_t* (i32, ...) bitcast (%struct.NALU_t* (...)* @AllocNALU to %struct.NALU_t* (i32, ...)*)(i32 64000)
...
entry:
  %frext_profile = alloca i32, align 4
  %canary = alloca i32
  store i32 1311645955, i32* %canary
  %sps.addr = alloca %struct.seq_parameter_set_rbsp_t*, align 8
  %cr_qp_index_offset.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %cb_qp_index_offset.addr = alloca i32, align 4
...
if.end139:                                        ; preds = %if.else135, %if.then132
  ...
  store i32 0, i32* %redundant_pic_cnt_present_flag, align 4
  %151 = load i32, i32* %canary
  %152 = icmp eq i32 %151, 1311645955
  br i1 %152, label %153, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @GenerateParameterSets.16() #0 {
entry:
  %canary = alloca i32
  store i32 1911899955, i32* %canary
  %sps = alloca %struct.seq_parameter_set_rbsp_t*, align 8
  %pps = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  store %struct.seq_parameter_set_rbsp_t* null, %struct.seq_parameter_set_rbsp_t** %sps, align 8
  store %struct.pic_parameter_set_rbsp_t* null, %struct.pic_parameter_set_rbsp_t** %pps, align 8
...
entry:
  ...
  %rbsp = alloca [64000 x i8], align 16
  %canary = alloca i32
  store i32 2019302898, i32* %canary
  %NALUlen = alloca i32, align 4
  %call = call %struct.NALU_t* (i32, ...) bitcast (%struct.NALU_t* (...)* @AllocNALU to %struct.NALU_t* (i32, ...)*)(i32 64000)
  store %struct.NALU_t* %call, %struct.NALU_t** %n, align 8
  store i32 0, i32* %RBSPlen, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct.NALU_t* @GeneratePic_parameter_set_NALU.18(i32 %PPS_id) #0 {
entry:
  %rbsp = alloca [64000 x i8], align 16
  %n = alloca %struct.NALU_t*, align 8
  %RBSPlen = alloca i32, align 4
  %PPS_id.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1218538199, i32* %canary
  %NALUlen = alloca i32, align 4
  store i32 %PPS_id, i32* %PPS_id.addr, align 4
  %call = call %struct.NALU_t* (i32, ...) bitcast (%struct.NALU_t* (...)* @AllocNALU to %struct.NALU_t* (i32, ...)*)(i32 64000)
  store %struct.NALU_t* %call, %struct.NALU_t** %n, align 8
...
entry:
  ...
  %partition.addr = alloca %struct.datapartition*, align 8
  %canary = alloca i32
  store i32 123955354, i32* %canary
...
entry:
  ...
  %n = alloca %struct.NALU_t*, align 8
  %canary = alloca i32
  store i32 1576985379, i32* %canary
  %RBSPlen = alloca i32, align 4
  %NALUlen = alloca i32, align 4
  %call = call %struct.NALU_t* (i32, ...) bitcast (%struct.NALU_t* (...)* @AllocNALU to %struct.NALU_t* (i32, ...)*)(i32 64000)
  store %struct.NALU_t* %call, %struct.NALU_t** %n, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @GenerateSeq_parameter_set_rbsp.21(%struct.seq_parameter_set_rbsp_t* %sps, i8* %rbsp) #0 {
entry:
  %canary = alloca i32
  store i32 281786944, i32* %canary
  %LenInBytes = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
  %rbsp.addr = alloca i8*, align 8
  %len = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct.NALU_t* @GeneratePic_parameter_set_NALU.22(i32 %PPS_id) #0 {
entry:
  %NALUlen = alloca i32, align 4
  %rbsp = alloca [64000 x i8], align 16
  %RBSPlen = alloca i32, align 4
  %n = alloca %struct.NALU_t*, align 8
  %canary = alloca i32
  store i32 1390800064, i32* %canary
  %PPS_id.addr = alloca i32, align 4
  store i32 %PPS_id, i32* %PPS_id.addr, align 4
  %call = call %struct.NALU_t* (i32, ...) bitcast (%struct.NALU_t* (...)* @AllocNALU to %struct.NALU_t* (i32, ...)*)(i32 64000)
  store %struct.NALU_t* %call, %struct.NALU_t** %n, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @Scaling_List.23(i16* %scalingListinput, i16* %scalingList, i32 %sizeOfScalingList, i16* %UseDefaultScalingMatrix, %struct.datapartition* %partition) #0 {
entry:
  %scalingList.addr = alloca i16*, align 8
  %scanj = alloca i32, align 4
  %lastScale = alloca i32, align 4
  ...
  %scalingListinput.addr = alloca i16*, align 8
  %canary = alloca i32
  store i32 1944920727, i32* %canary
  %UseDefaultScalingMatrix.addr = alloca i16*, align 8
  %len = alloca i32, align 4
  store i16* %scalingListinput, i16** %scalingListinput.addr, align 8
  store i16* %scalingList, i16** %scalingList.addr, align 8
...
entry:
  ...
  %UseDefaultScalingMatrix.addr = alloca i16*, align 8
  %canary = alloca i32
  store i32 638191135, i32* %canary
  %sizeOfScalingList.addr = alloca i32, align 4
  %j = alloca i32, align 4
  store i16* %scalingListinput, i16** %scalingListinput.addr, align 8
  store i16* %scalingList, i16** %scalingList.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @GeneratePictureParameterSet.25(%struct.pic_parameter_set_rbsp_t* %pps, %struct.seq_parameter_set_rbsp_t* %sps, i32 %PPS_id, i32 %WeightedPrediction, i32 %WeightedBiprediction, i32 %cb_qp_index_offset, i32 %cr_qp_index_offset) #0 {
entry:
  %PPS_id.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %canary = alloca i32
  store i32 307739984, i32* %canary
  %cb_qp_index_offset.addr = alloca i32, align 4
  %sps.addr = alloca %struct.seq_parameter_set_rbsp_t*, align 8
  %WeightedPrediction.addr = alloca i32, align 4
  %WeightedBiprediction.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @GenerateSeq_parameter_set_rbsp.26(%struct.seq_parameter_set_rbsp_t* %sps, i8* %rbsp) #0 {
entry:
  %partition = alloca %struct.datapartition*, align 8
  %i = alloca i32, align 4
  %LenInBytes = alloca i32, align 4
  ...
  %rbsp.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 630560244, i32* %canary
  %sps.addr = alloca %struct.seq_parameter_set_rbsp_t*, align 8
  store %struct.seq_parameter_set_rbsp_t* %sps, %struct.seq_parameter_set_rbsp_t** %sps.addr, align 8
  store i8* %rbsp, i8** %rbsp.addr, align 8
  store i32 0, i32* %len, align 4
...
entry:
  ...
  %PPS_id.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1294555752, i32* %canary
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %frext_profile = alloca i32, align 4
  %WeightedBiprediction.addr = alloca i32, align 4
  %i = alloca i32, align 4
...
if.end139:                                        ; preds = %if.else135, %if.then132
  ...
  store i32 0, i32* %redundant_pic_cnt_present_flag, align 4
  %151 = load i32, i32* %canary
  %152 = icmp eq i32 %151, 1294555752
  br i1 %152, label %153, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct.NALU_t* @GenerateSeq_parameter_set_NALU.28() #0 {
entry:
  %n = alloca %struct.NALU_t*, align 8
  %rbsp = alloca [64000 x i8], align 16
  %NALUlen = alloca i32, align 4
  %canary = alloca i32
  store i32 500656533, i32* %canary
  %RBSPlen = alloca i32, align 4
  %call = call %struct.NALU_t* (i32, ...) bitcast (%struct.NALU_t* (...)* @AllocNALU to %struct.NALU_t* (i32, ...)*)(i32 64000)
  store %struct.NALU_t* %call, %struct.NALU_t** %n, align 8
  store i32 0, i32* %RBSPlen, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @GeneratePic_parameter_set_rbsp.29(%struct.pic_parameter_set_rbsp_t* %pps, i8* %rbsp) #0 {
entry:
  %canary = alloca i32
  store i32 1001908292, i32* %canary
  %partition = alloca %struct.datapartition*, align 8
  %len = alloca i32, align 4
  %profile_idc = alloca i32, align 4
  %NumberBitsPerSliceGroupId = alloca i32, align 4
...
if.end201:                                        ; preds = %if.end198, %lor.lhs.false143
  ...
  %200 = load i32, i32* %LenInBytes, align 4
  %201 = load i32, i32* %canary
  %202 = icmp eq i32 %201, 1001908292
  br i1 %202, label %203, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @Scaling_List.30(i16* %scalingListinput, i16* %scalingList, i32 %sizeOfScalingList, i16* %UseDefaultScalingMatrix, %struct.datapartition* %partition) #0 {
entry:
  %delta_scale = alloca i32, align 4
  %lastScale = alloca i32, align 4
  %nextScale = alloca i32, align 4
  ...
  %scalingList.addr = alloca i16*, align 8
  %canary = alloca i32
  store i32 221195944, i32* %canary
  %j = alloca i32, align 4
  %partition.addr = alloca %struct.datapartition*, align 8
  %UseDefaultScalingMatrix.addr = alloca i16*, align 8
  %sizeOfScalingList.addr = alloca i32, align 4
...
entry:
  %partition = alloca %struct.datapartition*, align 8
  %canary = alloca i32
  store i32 492229062, i32* %canary
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %LenInBytes = alloca i32, align 4
  %i = alloca i32, align 4
  %NumberBitsPerSliceGroupId = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1653407954, i32* %canary
  %profile_idc = alloca i32, align 4
  %i = alloca i32, align 4
  %LenInBytes = alloca i32, align 4
  %rbsp.addr = alloca i8*, align 8
...
if.end201:                                        ; preds = %if.end198, %lor.lhs.false143
  ...
  %200 = load i32, i32* %LenInBytes, align 4
  %201 = load i32, i32* %canary
  %202 = icmp eq i32 %201, 1653407954
  br i1 %202, label %203, label %func_exit
