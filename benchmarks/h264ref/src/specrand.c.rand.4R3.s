...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1068326820, -12(%rbp)  # imm = 0x3FAD5FA4
	movslq	seedi, %rax
	cqto
...
.LBB2_3:                                # %if.end
	...
	cmpl	$1068326820, -12(%rbp)  # imm = 0x3FAD5FA4
	jne	.LBB2_5
.LBB2_4:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$660037431, -12(%rbp)   # imm = 0x27575F37
	movslq	seedi, %rax
	cqto
	movl	$127773, %ecx           # imm = 0x1F31D
	idivq	%rcx
...
.LBB3_3:                                # %if.end
	...
	vcvtsi2sdl	seedi, %xmm0, %xmm1
	vdivsd	%xmm0, %xmm1, %xmm0
	cmpl	$660037431, -12(%rbp)   # imm = 0x27575F37
	jne	.LBB3_5
.LBB3_4:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1141177717, -8(%rbp)   # imm = 0x4404FD75
	movslq	seedi, %rax
	cqto
	movl	$127773, %ecx           # imm = 0x1F31D
	idivq	%rcx
...
.LBB4_3:                                # %if.end
	...
	vcvtsi2sdl	seedi, %xmm0, %xmm1
	vdivsd	%xmm0, %xmm1, %xmm0
	cmpl	$1141177717, -8(%rbp)   # imm = 0x4404FD75
	jne	.LBB4_5
.LBB4_4:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$63779335, -16(%rbp)    # imm = 0x3CD3207
	movslq	seedi, %rax
	cqto
	movl	$127773, %ecx           # imm = 0x1F31D
	idivq	%rcx
...
.LBB5_3:                                # %if.end
	...
	vcvtsi2sdl	seedi, %xmm0, %xmm1
	vdivsd	%xmm0, %xmm1, %xmm0
	cmpl	$63779335, -16(%rbp)    # imm = 0x3CD3207
	jne	.LBB5_5
.LBB5_4:
	addq	$32, %rsp
	popq	%rbp
