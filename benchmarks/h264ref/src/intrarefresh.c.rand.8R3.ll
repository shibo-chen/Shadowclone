; ModuleID = 'intrarefresh.c.rand.8R3.bc'
...
ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_RandomIntraInit.14, label %func_RandomIntraInit.16
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_RandomIntra.6, label %ctrl0

func_RandomIntra.6:                               ; preds = %rand_bb
  %2 = call i32 @RandomIntra.6(i32 %mb)
  ret i32 %2

func_RandomIntra.7:                               ; preds = %ctrl0
  %3 = call i32 @RandomIntra.7(i32 %mb)
  ret i32 %3
...
func_RandomIntra.15:                              ; preds = %ctrl3
  %7 = call i32 @RandomIntra.15(i32 %mb)
  ret i32 %7

ctrl0:                                            ; preds = %rand_bb
  %8 = icmp eq i32 %0, 1
  br i1 %8, label %func_RandomIntra.7, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %9 = icmp eq i32 %0, 2
  br i1 %9, label %func_RandomIntra.8, label %ctrl2
...
ctrl3:                                            ; preds = %ctrl2
  %11 = icmp eq i32 %0, 4
  br i1 %11, label %func_RandomIntra.10, label %func_RandomIntra.15
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_RandomIntraNewPicture.1, label %func_RandomIntraNewPicture.4
...
entry:
  ...
  %canary = alloca i32
  store i32 340244908, i32* %canary
...
entry:
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1914109259, i32* %canary
  %i = alloca i32, align 4
  %0 = load i32, i32* @NumberIntraPerPicture, align 4
  %1 = load i32, i32* @WalkAround, align 4
  %add = add nsw i32 %1, %0
...
entry:
  ...
  %pos = alloca i32, align 4
  %canary = alloca i32
  store i32 2086587061, i32* %canary
  %xsize.addr = alloca i32, align 4
  %ysize.addr = alloca i32, align 4
  store i32 %xsize, i32* %xsize.addr, align 4
  store i32 %ysize, i32* %ysize.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 225966353, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 551873504, i32* %canary
  %retval = alloca i32, align 4
  %mb.addr = alloca i32, align 4
  %i = alloca i32, align 4
  store i32 %mb, i32* %mb.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 729866473, i32* %canary
  %i = alloca i32, align 4
  %mb.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  store i32 %mb, i32* %mb.addr, align 4
...
entry:
  %mb.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 841991019, i32* %canary
  %i = alloca i32, align 4
  %retval = alloca i32, align 4
  store i32 %mb, i32* %mb.addr, align 4
  store i32 0, i32* %i, align 4
...
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 941161297, i32* %canary
  %retval = alloca i32, align 4
  %mb.addr = alloca i32, align 4
  store i32 %mb, i32* %mb.addr, align 4
  store i32 0, i32* %i, align 4
...
entry:
  ...
  %pos = alloca i32, align 4
  %canary = alloca i32
  store i32 208276366, i32* %canary
  %refresh.addr = alloca i32, align 4
  store i32 %xsize, i32* %xsize.addr, align 4
  store i32 %ysize, i32* %ysize.addr, align 4
  store i32 %refresh, i32* %refresh.addr, align 4
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 459849406, i32* %canary
  %pos = alloca i32, align 4
  %refresh.addr = alloca i32, align 4
  store i32 %xsize, i32* %xsize.addr, align 4
  store i32 %ysize, i32* %ysize.addr, align 4
...
entry:
  %pos = alloca i32, align 4
  %canary = alloca i32
  store i32 2038297784, i32* %canary
  %i = alloca i32, align 4
  %xsize.addr = alloca i32, align 4
  %ysize.addr = alloca i32, align 4
  %refresh.addr = alloca i32, align 4
...
entry:
  %pos = alloca i32, align 4
  %canary = alloca i32
  store i32 1532101782, i32* %canary
  %i = alloca i32, align 4
  %ysize.addr = alloca i32, align 4
  %refresh.addr = alloca i32, align 4
  %xsize.addr = alloca i32, align 4
