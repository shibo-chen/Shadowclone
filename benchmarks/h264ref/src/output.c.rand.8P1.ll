...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_testEndian.3, label %func_testEndian.4

func_testEndian.3:                                ; preds = %rand_bb
  %2 = call i32 @testEndian.3()
  ret i32 %2
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_img2buf.17, label %ctrl0

func_img2buf.17:                                  ; preds = %rand_bb
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_img2buf.21, label %ctrl1
...
ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_img2buf.32, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_img2buf.33, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_img2buf.34, label %func_img2buf.35
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_write_picture.8, label %ctrl0

func_write_picture.8:                             ; preds = %rand_bb
  call void @write_picture.8(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure)
  ret void
...
func_write_picture.14:                            ; preds = %ctrl1
  call void @write_picture.14(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure)
  ret void

func_write_picture.18:                            ; preds = %ctrl2
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_write_picture.14, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_write_picture.18, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_write_picture.23, label %func_write_picture.28
}
...
func_write_out_picture.11:                        ; preds = %ctrl0
...
func_write_out_picture.25:                        ; preds = %ctrl2
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_write_out_picture.11, label %ctrl1
...
ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_write_out_picture.25, label %ctrl3
...
ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_write_out_picture.31, label %func_write_out_picture.36
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_clear_picture.6, label %func_clear_picture.20
...
func_write_unpaired_field.10:                     ; preds = %ctrl0
  call void @write_unpaired_field.10(%struct.frame_store* %fs, i32 %p_out)
  ret void

func_write_unpaired_field.13:                     ; preds = %ctrl1
...
func_write_unpaired_field.16:                     ; preds = %ctrl3
  call void @write_unpaired_field.16(%struct.frame_store* %fs, i32 %p_out)
  ret void

func_write_unpaired_field.29:                     ; preds = %ctrl3
  call void @write_unpaired_field.29(%struct.frame_store* %fs, i32 %p_out)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_write_unpaired_field.10, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_write_unpaired_field.13, label %ctrl2
...
ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_write_unpaired_field.16, label %func_write_unpaired_field.29
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_write_stored_frame.12, label %func_write_stored_frame.24

func_write_stored_frame.12:                       ; preds = %rand_bb
  call void @write_stored_frame.12(%struct.frame_store* %fs, i32 %p_out)
  ret void

func_write_stored_frame.24:                       ; preds = %rand_bb
  call void @write_stored_frame.24(%struct.frame_store* %fs, i32 %p_out)
  ret void
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_direct_output.5, label %func_direct_output.7

func_direct_output.5:                             ; preds = %rand_bb
  call void @direct_output.5(%struct.storable_picture* %p, i32 %p_out)
  ret void
...
entry:
  ...
  %canary = alloca i32
  store i32 1674758059, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1827935164, i32* %canary
...
return:                                           ; preds = %if.end139, %if.then
  ...
  %193 = icmp eq i32 %192, 1827935164
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @testEndian.3() #0 {
entry:
  %canary = alloca i32
  store i32 1874903668, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1735744966, i32* %canary
  %p = alloca i8*, align 8
  %s = alloca i16, align 2
  %0 = bitcast i16* %s to i8*
  store i8* %0, i8** %p, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @direct_output.5(%struct.storable_picture* %p, i32 %p_out) #0 {
entry:
  %p.addr = alloca %struct.storable_picture*, align 8
  %canary = alloca i32
  store i32 639430892, i32* %canary
  %p_out.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 221143877, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1945902083, i32* %canary
  %p_out.addr = alloca i32, align 4
  %p.addr = alloca %struct.storable_picture*, align 8
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_picture.8(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure) #0 {
entry:
  %p.addr = alloca %struct.storable_picture*, align 8
  %real_structure.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1893384942, i32* %canary
  %p_out.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  %p.addr = alloca %struct.storable_picture*, align 8
  %canary = alloca i32
  store i32 683502347, i32* %canary
  %p_out.addr = alloca i32, align 4
  %real_structure.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_unpaired_field.10(%struct.frame_store* %fs, i32 %p_out) #0 {
entry:
  %canary = alloca i32
  store i32 980038885, i32* %canary
  %p_out.addr = alloca i32, align 4
  %p = alloca %struct.storable_picture*, align 8
  %fs.addr = alloca %struct.frame_store*, align 8
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
...
entry:
  ...
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1071144596, i32* %canary
  %crop_left = alloca i32, align 4
  %buf = alloca i8*, align 8
  %symbol_size_in_bytes = alloca i32, align 4
  %crop_right = alloca i32, align 4
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1071144596
  br i1 %193, label %194, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_stored_frame.12(%struct.frame_store* %fs, i32 %p_out) #0 {
entry:
  %canary = alloca i32
  store i32 337497647, i32* %canary
  %fs.addr = alloca %struct.frame_store*, align 8
  %p_out.addr = alloca i32, align 4
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 745399041, i32* %canary
  %fs.addr = alloca %struct.frame_store*, align 8
  %p = alloca %struct.storable_picture*, align 8
  %p_out.addr = alloca i32, align 4
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_picture.14(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure) #0 {
entry:
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 241291209, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  %real_structure.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  %p = alloca %struct.storable_picture*, align 8
  %canary = alloca i32
  store i32 331705924, i32* %canary
  %p_out.addr = alloca i32, align 4
  %fs.addr = alloca %struct.frame_store*, align 8
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  ...
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1223880989, i32* %canary
  %p = alloca %struct.storable_picture*, align 8
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  %0 = load %struct.frame_store*, %struct.frame_store** %fs.addr, align 8
...
entry:
  ...
  %canary = alloca i32
  store i32 1644852669, i32* %canary
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  ...
  %109 = icmp eq i32 %108, 1644852669
...
entry:
  ...
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 546995850, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  store i32 %real_structure, i32* %real_structure.addr, align 4
...
entry:
  ...
  %SubWidthC = alloca [4 x i32], align 16
  %canary = alloca i32
  store i32 1931021962, i32* %canary
  %crop_top = alloca i32, align 4
  %p_out.addr = alloca i32, align 4
  %crop_left = alloca i32, align 4
  %buf = alloca i8*, align 8
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1931021962
  br i1 %193, label %194, label %func_exit
...
entry:
  %p.addr = alloca %struct.storable_picture*, align 8
  %canary = alloca i32
  store i32 2015088483, i32* %canary
  %i = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 0, i32* %i, align 4
  br label %for.cond
...
entry:
  ...
  %twidth = alloca i32, align 4
  %canary = alloca i32
  store i32 1429368428, i32* %canary
  %crop_right.addr = alloca i32, align 4
  %size_x.addr = alloca i32, align 4
  %crop_top.addr = alloca i32, align 4
  %tmp32 = alloca i64, align 8
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1429368428
  br i1 %109, label %110, label %func_exit
...
entry:
  %crop_right.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 314022294, i32* %canary
  %j = alloca i32, align 4
  %twidth = alloca i32, align 4
  %size = alloca i32, align 4
  %crop_bottom.addr = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 627935029, i32* %canary
  %p_out.addr = alloca i32, align 4
  %real_structure.addr = alloca i32, align 4
  %p.addr = alloca %struct.storable_picture*, align 8
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_stored_frame.24(%struct.frame_store* %fs, i32 %p_out) #0 {
entry:
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1041477865, i32* %canary
  %fs.addr = alloca %struct.frame_store*, align 8
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  %0 = load i32, i32* %p_out.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 1335119132, i32* %canary
  %SubHeightC = alloca [4 x i32], align 16
  %crop_left = alloca i32, align 4
  %rgb_output = alloca i32, align 4
  %SubWidthC = alloca [4 x i32], align 16
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1335119132
  br i1 %193, label %194, label %func_exit
...
entry:
  ...
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 739154178, i32* %canary
  %buf = alloca i8*, align 8
  %crop_top = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  ...
  %p.addr = alloca %struct.storable_picture*, align 8
  %canary = alloca i32
  store i32 800260759, i32* %canary
  %p_out.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  store i32 %real_structure, i32* %real_structure.addr, align 4
...
entry:
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1628027837, i32* %canary
  %fs.addr = alloca %struct.frame_store*, align 8
  %p = alloca %struct.storable_picture*, align 8
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  ...
  %size_y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1054633749, i32* %canary
  %theight = alloca i32, align 4
  %ui8 = alloca i8, align 1
  %j = alloca i32, align 4
  %tmp16 = alloca i16, align 2
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1054633749
  br i1 %109, label %110, label %func_exit
...
entry:
  %canary = alloca i32
  store i32 1530478630, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  %p_out.addr = alloca i32, align 4
  %crop_bottom = alloca i32, align 4
  %SubHeightC = alloca [4 x i32], align 16
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1530478630
  br i1 %193, label %194, label %func_exit
...
entry:
  ...
  %size_y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2098898416, i32* %canary
  %buf.addr = alloca i8*, align 8
  %crop_left.addr = alloca i32, align 4
  %size = alloca i32, align 4
  store i16** %imgX, i16*** %imgX.addr, align 8
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 2098898416
  br i1 %109, label %110, label %func_exit
...
entry:
  ...
  %tmp32 = alloca i64, align 8
  %canary = alloca i32
  store i32 624354695, i32* %canary
  %crop_right.addr = alloca i32, align 4
  %crop_left.addr = alloca i32, align 4
  %size_y.addr = alloca i32, align 4
  %theight = alloca i32, align 4
...
entry:
  ...
  %size_y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1243791449, i32* %canary
  %ui8 = alloca i8, align 1
  store i16** %imgX, i16*** %imgX.addr, align 8
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size_x, i32* %size_x.addr, align 4
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1243791449
  br i1 %109, label %110, label %func_exit
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1636811892, i32* %canary
  %symbol_size_in_bytes.addr = alloca i32, align 4
  %theight = alloca i32, align 4
  %ui8 = alloca i8, align 1
  %crop_top.addr = alloca i32, align 4
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1636811892
  br i1 %109, label %110, label %func_exit
...
entry:
  %crop_top = alloca i32, align 4
  %canary = alloca i32
  store i32 964651383, i32* %canary
  %crop_left = alloca i32, align 4
  %SubWidthC = alloca [4 x i32], align 16
  %buf = alloca i8*, align 8
  %crop_bottom = alloca i32, align 4
