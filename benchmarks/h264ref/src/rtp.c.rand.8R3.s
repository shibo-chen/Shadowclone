...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$16, %rsp
	movl	$1976089208, -12(%rbp)  # imm = 0x75C8BA78
	movl	%edi, -8(%rbp)
...
.LBB6_5:                                # %return
	cmpl	$1976089208, -12(%rbp)  # imm = 0x75C8BA78
	jne	.LBB6_7
.LBB6_6:
	addq	$16, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$426023327, -28(%rbp)   # imm = 0x1964999F
	movq	%rdi, -24(%rbp)
	movq	-24(%rbp), %rax
	movl	20(%rax), %eax
	shll	$7, %eax
...
.LBB7_10:                               # %if.end32
	...
	movl	4(%rax), %ebx
	shll	$3, %ebx
	cmpl	$426023327, -28(%rbp)   # imm = 0x1964999F
	jne	.LBB7_12
.LBB7_11:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$16, %rsp
	movl	$1006290761, -12(%rbp)  # imm = 0x3BFAC749
	movl	%edi, -8(%rbp)
	cmpl	$-1, RTPUpdateTimestamp.oldtr
	jne	.LBB8_2
# %bb.1:                                # %if.then
...
.LBB8_4:                                # %if.end3
	...
	movl	%eax, RTPUpdateTimestamp.oldtr
.LBB8_5:                                # %return
	cmpl	$1006290761, -12(%rbp)  # imm = 0x3BFAC749
	jne	.LBB8_7
.LBB8_6:
	addq	$16, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$844889545, -36(%rbp)   # imm = 0x325BFDC9
	movq	%rdi, -24(%rbp)
	movq	%rsi, -32(%rbp)
	movl	$-1, -40(%rbp)
	movq	-24(%rbp), %rdi
...
.LBB9_7:                                # %return
	movl	-12(%rbp), %ebx
	cmpl	$844889545, -36(%rbp)   # imm = 0x325BFDC9
	jne	.LBB9_9
.LBB9_8:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$249767794, -40(%rbp)   # imm = 0xEE32772
	movq	%rdi, -24(%rbp)
	movq	%rsi, -32(%rbp)
	movl	$-1, -36(%rbp)
	movq	-24(%rbp), %rdi
...
.LBB10_7:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$249767794, -40(%rbp)   # imm = 0xEE32772
	jne	.LBB10_9
.LBB10_8:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$1969721007, -36(%rbp)  # imm = 0x75678EAF
	movq	%rdi, -24(%rbp)
	movq	%rsi, -32(%rbp)
	movl	$-1, -40(%rbp)
	movq	-24(%rbp), %rdi
...
.LBB11_7:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$1969721007, -36(%rbp)  # imm = 0x75678EAF
	jne	.LBB11_9
.LBB11_8:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$913996539, -28(%rbp)   # imm = 0x367A7AFB
	movq	%rdi, -24(%rbp)
	movq	-24(%rbp), %rax
	movl	20(%rax), %eax
	shll	$7, %eax
...
.LBB12_10:                              # %if.end32
	...
	movl	4(%rax), %ebx
	shll	$3, %ebx
	cmpl	$913996539, -28(%rbp)   # imm = 0x367A7AFB
	jne	.LBB12_12
.LBB12_11:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$2053334239, -36(%rbp)  # imm = 0x7A6364DF
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movl	$-1, -40(%rbp)
	movq	-32(%rbp), %rdi
...
.LBB13_7:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$2053334239, -36(%rbp)  # imm = 0x7A6364DF
	jne	.LBB13_9
.LBB13_8:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$794802954, -40(%rbp)   # imm = 0x2F5FBB0A
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movl	$-1, -36(%rbp)
	movq	-32(%rbp), %rdi
...
.LBB14_7:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$794802954, -40(%rbp)   # imm = 0x2F5FBB0A
	jne	.LBB14_9
.LBB14_8:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$905062586, -40(%rbp)   # imm = 0x35F228BA
	movq	%rdi, -24(%rbp)
	movq	%rsi, -32(%rbp)
	movl	$-1, -36(%rbp)
	movq	-24(%rbp), %rdi
...
.LBB15_7:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$905062586, -40(%rbp)   # imm = 0x35F228BA
	jne	.LBB15_9
.LBB15_8:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$1338417552, -36(%rbp)  # imm = 0x4FC6A190
	movq	%rdi, -24(%rbp)
	movq	%rsi, -32(%rbp)
	movl	$-1, -40(%rbp)
	movq	-24(%rbp), %rdi
...
.LBB16_7:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$1338417552, -36(%rbp)  # imm = 0x4FC6A190
	jne	.LBB16_9
.LBB16_8:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$361756943, -40(%rbp)   # imm = 0x158FF90F
	movq	%rdi, -24(%rbp)
	movq	%rsi, -32(%rbp)
	movl	$-1, -36(%rbp)
	movq	-24(%rbp), %rdi
...
.LBB17_7:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$361756943, -40(%rbp)   # imm = 0x158FF90F
	jne	.LBB17_9
.LBB17_8:
	movl	%ebx, %eax
	addq	$40, %rsp
