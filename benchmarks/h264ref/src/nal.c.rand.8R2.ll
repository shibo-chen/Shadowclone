...
entry:
  ...
  %canary = alloca i32
  store i32 379880047, i32* %canary
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1884725632, i32* %canary
  %min_num_bytes.addr = alloca i32, align 4
  %streamBuffer.addr = alloca i8*, align 8
  %begin_bytepos.addr = alloca i32, align 4
  %j = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 592537164, i32* %canary
  %j = alloca i32, align 4
  %count = alloca i32, align 4
  %i = alloca i32, align 4
  %end_bytepos.addr = alloca i32, align 4
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 295095749, i32* %canary
  %streamBuffer.addr = alloca i8*, align 8
  %end_bytepos.addr = alloca i32, align 4
  %count = alloca i32, align 4
  %i = alloca i32, align 4
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 112602550, i32* %canary
  %i = alloca i32, align 4
  %min_num_bytes.addr = alloca i32, align 4
  store i8* %streamBuffer, i8** %streamBuffer.addr, align 8
  store i32 %begin_bytepos, i32* %begin_bytepos.addr, align 4
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1145093621, i32* %canary
  %min_num_bytes.addr = alloca i32, align 4
  %end_bytepos.addr = alloca i32, align 4
  %count = alloca i32, align 4
  store i8* %streamBuffer, i8** %streamBuffer.addr, align 8
...
entry:
  ...
  %count = alloca i32, align 4
  %canary = alloca i32
  store i32 1863321296, i32* %canary
  %streamBuffer.addr = alloca i8*, align 8
  %end_bytepos.addr = alloca i32, align 4
  %min_num_bytes.addr = alloca i32, align 4
  %begin_bytepos.addr = alloca i32, align 4
...
entry:
  ...
  %count = alloca i32, align 4
  %canary = alloca i32
  store i32 1330629217, i32* %canary
  %j = alloca i32, align 4
  %begin_bytepos.addr = alloca i32, align 4
  %min_num_bytes.addr = alloca i32, align 4
  store i8* %streamBuffer, i8** %streamBuffer.addr, align 8
