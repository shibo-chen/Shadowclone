; ModuleID = 'explicit_gop.c.rand.8R2.bc'
...
func_create_pyramid.12:                           ; preds = %ctrl0
  call void @create_pyramid.12()
  ret void
...
func_create_pyramid.22:                           ; preds = %ctrl2
  call void @create_pyramid.22()
  ret void

func_create_pyramid.23:                           ; preds = %ctrl3
  call void @create_pyramid.23()
  ret void

func_create_pyramid.24:                           ; preds = %ctrl4
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_create_pyramid.12, label %ctrl1
...
ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_create_pyramid.22, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_create_pyramid.23, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_create_pyramid.24, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_create_pyramid.27, label %func_create_pyramid.31
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_gop_pyramid.1, label %ctrl0

func_gop_pyramid.1:                               ; preds = %rand_bb
  call void @gop_pyramid.1(i32 %level, i32 %frm_no, i32 %frames, %struct.GOP_DATA* %pyramid_structure)
  ret void

func_gop_pyramid.2:                               ; preds = %ctrl0
  call void @gop_pyramid.2(i32 %level, i32 %frm_no, i32 %frames, %struct.GOP_DATA* %pyramid_structure)
  ret void

func_gop_pyramid.3:                               ; preds = %ctrl1
  call void @gop_pyramid.3(i32 %level, i32 %frm_no, i32 %frames, %struct.GOP_DATA* %pyramid_structure)
  ret void

func_gop_pyramid.9:                               ; preds = %ctrl2
  call void @gop_pyramid.9(i32 %level, i32 %frm_no, i32 %frames, %struct.GOP_DATA* %pyramid_structure)
  ret void

func_gop_pyramid.10:                              ; preds = %ctrl3
  call void @gop_pyramid.10(i32 %level, i32 %frm_no, i32 %frames, %struct.GOP_DATA* %pyramid_structure)
  ret void

func_gop_pyramid.13:                              ; preds = %ctrl4
  call void @gop_pyramid.13(i32 %level, i32 %frm_no, i32 %frames, %struct.GOP_DATA* %pyramid_structure)
  ret void

func_gop_pyramid.14:                              ; preds = %ctrl5
  call void @gop_pyramid.14(i32 %level, i32 %frm_no, i32 %frames, %struct.GOP_DATA* %pyramid_structure)
  ret void

func_gop_pyramid.15:                              ; preds = %ctrl5
  call void @gop_pyramid.15(i32 %level, i32 %frm_no, i32 %frames, %struct.GOP_DATA* %pyramid_structure)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_gop_pyramid.2, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_gop_pyramid.3, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_gop_pyramid.9, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_gop_pyramid.10, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_gop_pyramid.13, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_gop_pyramid.14, label %func_gop_pyramid.15
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_interpret_gop_structure.6, label %ctrl0

func_interpret_gop_structure.6:                   ; preds = %rand_bb
  call void @interpret_gop_structure.6()
  ret void

func_interpret_gop_structure.16:                  ; preds = %ctrl0
  call void @interpret_gop_structure.16()
  ret void

func_interpret_gop_structure.25:                  ; preds = %ctrl1
  call void @interpret_gop_structure.25()
  ret void

func_interpret_gop_structure.26:                  ; preds = %ctrl2
  call void @interpret_gop_structure.26()
  ret void

func_interpret_gop_structure.28:                  ; preds = %ctrl3
  call void @interpret_gop_structure.28()
  ret void

func_interpret_gop_structure.29:                  ; preds = %ctrl4
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_interpret_gop_structure.16, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_interpret_gop_structure.25, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_interpret_gop_structure.26, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_interpret_gop_structure.28, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_interpret_gop_structure.29, label %ctrl5
...
func_poc_based_ref_management.11:                 ; preds = %ctrl2
  call void @poc_based_ref_management.11(i32 %current_pic_num)
  ret void
...
func_poc_based_ref_management.19:                 ; preds = %ctrl4
  call void @poc_based_ref_management.19(i32 %current_pic_num)
  ret void

func_poc_based_ref_management.20:                 ; preds = %ctrl5
  call void @poc_based_ref_management.20(i32 %current_pic_num)
  ret void
...
ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_poc_based_ref_management.11, label %ctrl3
...
ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_poc_based_ref_management.19, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_poc_based_ref_management.20, label %func_poc_based_ref_management.21
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @gop_pyramid.1(i32 %level, i32 %frm_no, i32 %frames, %struct.GOP_DATA* %pyramid_structure) #0 {
entry:
  %canary = alloca i32
  store i32 111075585, i32* %canary
...
entry:
  ...
  %frm_no.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1949620407, i32* %canary
  %frames.addr = alloca i32, align 4
  store i32 %level, i32* %level.addr, align 4
  store i32 %frm_no, i32* %frm_no.addr, align 4
  store i32 %frames, i32* %frames.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 1178300981, i32* %canary
  %frames.addr = alloca i32, align 4
  %pyramid_structure.addr = alloca %struct.GOP_DATA*, align 8
  %level.addr = alloca i32, align 4
  %frm_no.addr = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 428982091, i32* %canary
...
entry:
  ...
  %min_poc = alloca i32, align 4
  %canary = alloca i32
  store i32 176988354, i32* %canary
  %pic_num = alloca i32, align 4
  %i = alloca i32, align 4
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
  store i32 %current_pic_num, i32* %current_pic_num.addr, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 1719294608, i32* %canary
...
if.end200:                                        ; preds = %for.end199, %for.end
  ...
  %162 = icmp eq i32 %161, 1215935330
...
entry:
  %min_poc = alloca i32, align 4
  %canary = alloca i32
  store i32 542543751, i32* %canary
  %i = alloca i32, align 4
  %current_pic_num.addr = alloca i32, align 4
  %tmp_drpm2 = alloca %struct.DecRefPicMarking_s*, align 8
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
...
entry:
  %frm_no.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 354707003, i32* %canary
  %pyramid_structure.addr = alloca %struct.GOP_DATA*, align 8
  %frames.addr = alloca i32, align 4
  %level.addr = alloca i32, align 4
  store i32 %level, i32* %level.addr, align 4
...
entry:
  ...
  %frames.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1261504856, i32* %canary
  %frm_no.addr = alloca i32, align 4
  %level.addr = alloca i32, align 4
  store i32 %level, i32* %level.addr, align 4
  store i32 %frm_no, i32* %frm_no.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @poc_based_ref_management.11(i32 %current_pic_num) #0 {
entry:
  %tmp_drpm2 = alloca %struct.DecRefPicMarking_s*, align 8
  %i = alloca i32, align 4
  %current_pic_num.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 963900016, i32* %canary
  %pic_num = alloca i32, align 4
  %min_poc = alloca i32, align 4
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
  store i32 %current_pic_num, i32* %current_pic_num.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @create_pyramid.12() #0 {
entry:
  %canary = alloca i32
  store i32 1912019997, i32* %canary
  %levelrefs = alloca i32, align 4
  %curGOPLevelfrm = alloca i32*, align 8
  %i28 = alloca i32, align 4
  %Bframes = alloca i32, align 4
...
if.end200:                                        ; preds = %for.end199, %for.end
  %161 = load i32, i32* %canary
  %162 = icmp eq i32 %161, 1912019997
  br i1 %162, label %163, label %func_exit
...
entry:
  %pyramid_structure.addr = alloca %struct.GOP_DATA*, align 8
  %canary = alloca i32
  store i32 879333164, i32* %canary
  %level.addr = alloca i32, align 4
  %frm_no.addr = alloca i32, align 4
  %frames.addr = alloca i32, align 4
  store i32 %level, i32* %level.addr, align 4
...
entry:
  ...
  %level.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 741263482, i32* %canary
  %frames.addr = alloca i32, align 4
  %frm_no.addr = alloca i32, align 4
  store i32 %level, i32* %level.addr, align 4
  store i32 %frm_no, i32* %frm_no.addr, align 4
...
entry:
  ...
  %level.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1164464280, i32* %canary
  %pyramid_structure.addr = alloca %struct.GOP_DATA*, align 8
  store i32 %level, i32* %level.addr, align 4
  store i32 %frm_no, i32* %frm_no.addr, align 4
  store i32 %frames, i32* %frames.addr, align 4
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 623037039, i32* %canary
  %nLength = alloca i32, align 4
  %qp_read = alloca i32, align 4
  %order_read = alloca i32, align 4
  %k = alloca i32, align 4
...
entry:
  ...
  %pic_num = alloca i32, align 4
  %canary = alloca i32
  store i32 1190893480, i32* %canary
  %tmp_drpm2 = alloca %struct.DecRefPicMarking_s*, align 8
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
  store i32 %current_pic_num, i32* %current_pic_num.addr, align 4
  store i32 0, i32* %pic_num, align 4
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 509310071, i32* %canary
  %prvlevelrefs = alloca i32, align 4
  %Bframes = alloca i32, align 4
  %GOPlevels = alloca i32, align 4
  %levelrefs = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @poc_based_ref_management.19(i32 %current_pic_num) #0 {
entry:
  %canary = alloca i32
  store i32 759902235, i32* %canary
  %tmp_drpm2 = alloca %struct.DecRefPicMarking_s*, align 8
  %min_poc = alloca i32, align 4
  %pic_num = alloca i32, align 4
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @poc_based_ref_management.20(i32 %current_pic_num) #0 {
entry:
  %pic_num = alloca i32, align 4
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
  %i = alloca i32, align 4
  ...
  %tmp_drpm2 = alloca %struct.DecRefPicMarking_s*, align 8
  %canary = alloca i32
  store i32 713670492, i32* %canary
  %min_poc = alloca i32, align 4
  store i32 %current_pic_num, i32* %current_pic_num.addr, align 4
  store i32 0, i32* %pic_num, align 4
  store i32 2147483647, i32* %min_poc, align 4
...
entry:
  %canary = alloca i32
  store i32 1933598007, i32* %canary
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
  %min_poc = alloca i32, align 4
  %current_pic_num.addr = alloca i32, align 4
  %tmp_drpm2 = alloca %struct.DecRefPicMarking_s*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @create_pyramid.23() #0 {
entry:
  %canary = alloca i32
  store i32 2109750711, i32* %canary
  %i = alloca i32, align 4
  %Bframes = alloca i32, align 4
  %centerB = alloca i32, align 4
  %GOPlevels = alloca i32, align 4
...
if.end200:                                        ; preds = %for.end199, %for.end
  %161 = load i32, i32* %canary
  %162 = icmp eq i32 %161, 2109750711
  br i1 %162, label %163, label %func_exit
...
entry:
  ...
  %i28 = alloca i32, align 4
  %canary = alloca i32
  store i32 381382693, i32* %canary
  %prvlevelrefs = alloca i32, align 4
  %i = alloca i32, align 4
  %GOPlevels = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @interpret_gop_structure.25() #0 {
entry:
  %slice_read = alloca i32, align 4
  %qp = alloca i32, align 4
  %coded_frame = alloca i32, align 4
  ...
  %stored_read = alloca i32, align 4
  %canary = alloca i32
  store i32 1051397218, i32* %canary
  %order_read = alloca i32, align 4
  %qp_read = alloca i32, align 4
  %display_no = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
entry:
  ...
  %k = alloca i32, align 4
  %canary = alloca i32
  store i32 1165481786, i32* %canary
  %order_read = alloca i32, align 4
  %slice_read = alloca i32, align 4
  %nLength = alloca i32, align 4
  %qp_read = alloca i32, align 4
...
entry:
  ...
  %levelrefs = alloca i32, align 4
  %canary = alloca i32
  store i32 235302077, i32* %canary
  %tempnum = alloca i32, align 4
  %curGOPLeveldist = alloca i32*, align 8
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %successive_Bframe = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 34
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @interpret_gop_structure.28() #0 {
entry:
  %k = alloca i32, align 4
  %i = alloca i32, align 4
  %qp = alloca i32, align 4
  ...
  %coded_frame = alloca i32, align 4
  %canary = alloca i32
  store i32 1770585793, i32* %canary
  %order_read = alloca i32, align 4
  %qp_read = alloca i32, align 4
  %display_no = alloca i32, align 4
  %slice_read = alloca i32, align 4
...
entry:
  %slice_read = alloca i32, align 4
  %canary = alloca i32
  store i32 1737400425, i32* %canary
  %i = alloca i32, align 4
  %qp = alloca i32, align 4
  %qp_read = alloca i32, align 4
  %stored_read = alloca i32, align 4
...
entry:
  ...
  %display_no = alloca i32, align 4
  %canary = alloca i32
  store i32 186345272, i32* %canary
  %slice_read = alloca i32, align 4
  %i = alloca i32, align 4
  %order_read = alloca i32, align 4
  %stored_read = alloca i32, align 4
