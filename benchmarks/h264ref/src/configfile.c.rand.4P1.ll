; ModuleID = 'configfile.c.rand.4P1.bc'
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_Configure.2, label %ctrl0

func_Configure.2:                                 ; preds = %rand_bb
  call void @Configure.2(i32 %ac, i8** %av)
  ret void

func_Configure.4:                                 ; preds = %ctrl0
  call void @Configure.4(i32 %ac, i8** %av)
  ret void

func_Configure.11:                                ; preds = %ctrl1
  call void @Configure.11(i32 %ac, i8** %av)
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_Configure.4, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_Configure.11, label %func_Configure.14
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_GetConfigFileContent.19, label %ctrl0

func_GetConfigFileContent.19:                     ; preds = %rand_bb
  %2 = call i8* @GetConfigFileContent.19(i8* %Filename)
  ret i8* %2

func_GetConfigFileContent.20:                     ; preds = %ctrl0
  %3 = call i8* @GetConfigFileContent.20(i8* %Filename)
  ret i8* %3

func_GetConfigFileContent.23:                     ; preds = %ctrl1
  %4 = call i8* @GetConfigFileContent.23(i8* %Filename)
  ret i8* %4

func_GetConfigFileContent.26:                     ; preds = %ctrl1
  %5 = call i8* @GetConfigFileContent.26(i8* %Filename)
  ret i8* %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_GetConfigFileContent.20, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_GetConfigFileContent.23, label %func_GetConfigFileContent.26
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_ParseContent.16, label %ctrl0

func_ParseContent.16:                             ; preds = %rand_bb
  call void @ParseContent.16(i8* %buf, i32 %bufsize)
  ret void

func_ParseContent.17:                             ; preds = %ctrl0
  call void @ParseContent.17(i8* %buf, i32 %bufsize)
  ret void

func_ParseContent.22:                             ; preds = %ctrl1
  call void @ParseContent.22(i8* %buf, i32 %bufsize)
  ret void

func_ParseContent.24:                             ; preds = %ctrl1
  call void @ParseContent.24(i8* %buf, i32 %bufsize)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_ParseContent.17, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_ParseContent.22, label %func_ParseContent.24
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_CeilLog2.1, label %ctrl0

func_CeilLog2.1:                                  ; preds = %rand_bb
  %2 = call i32 @CeilLog2.1(i32 %uiVal)
  ret i32 %2

func_CeilLog2.5:                                  ; preds = %ctrl0
  %3 = call i32 @CeilLog2.5(i32 %uiVal)
  ret i32 %3

func_CeilLog2.13:                                 ; preds = %ctrl1
  %4 = call i32 @CeilLog2.13(i32 %uiVal)
  ret i32 %4

func_CeilLog2.15:                                 ; preds = %ctrl1
  %5 = call i32 @CeilLog2.15(i32 %uiVal)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_CeilLog2.5, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_CeilLog2.13, label %func_CeilLog2.15
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_ParameterNameToMapIndex.3, label %ctrl0

func_ParameterNameToMapIndex.3:                   ; preds = %rand_bb
  %2 = call i32 @ParameterNameToMapIndex.3(i8* %s)
  ret i32 %2

func_ParameterNameToMapIndex.9:                   ; preds = %ctrl0
  %3 = call i32 @ParameterNameToMapIndex.9(i8* %s)
  ret i32 %3

func_ParameterNameToMapIndex.12:                  ; preds = %ctrl1
  %4 = call i32 @ParameterNameToMapIndex.12(i8* %s)
  ret i32 %4

func_ParameterNameToMapIndex.18:                  ; preds = %ctrl1
  %5 = call i32 @ParameterNameToMapIndex.18(i8* %s)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_ParameterNameToMapIndex.9, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_ParameterNameToMapIndex.12, label %func_ParameterNameToMapIndex.18
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_PatchInp.8, label %ctrl0

func_PatchInp.8:                                  ; preds = %rand_bb
  call void @PatchInp.8()
  ret void
...
func_PatchInp.21:                                 ; preds = %ctrl1
  call void @PatchInp.21()
  ret void

func_PatchInp.25:                                 ; preds = %ctrl1
  call void @PatchInp.25()
  ret void
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_PatchInp.21, label %func_PatchInp.25
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_TestEncoderParams.6, label %func_TestEncoderParams.7

func_TestEncoderParams.6:                         ; preds = %rand_bb
  %2 = call i32 @TestEncoderParams.6(i32 %bitdepth_qp_scale)
  ret i32 %2

func_TestEncoderParams.7:                         ; preds = %rand_bb
  %3 = call i32 @TestEncoderParams.7(i32 %bitdepth_qp_scale)
  ret i32 %3
}
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @CeilLog2.1(i32 %uiVal) #0 {
entry:
  %uiRet = alloca i32, align 4
  %uiTmp = alloca i32, align 4
  %canary = alloca i32
  store i32 2083388086, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Configure.2(i32 %ac, i8** %av) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 1717809523, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @ParameterNameToMapIndex.3(i8* %s) #0 {
entry:
  %canary = alloca i32
  store i32 62293599, i32* %canary
  %i = alloca i32, align 4
...
entry:
  ...
  %filename = alloca i8*, align 8
  %canary = alloca i32
  store i32 2015707421, i32* %canary
  %ac.addr = alloca i32, align 4
  %NumberParams = alloca i32, align 4
  %ContentLen = alloca i32, align 4
  store i32 %ac, i32* %ac.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @CeilLog2.5(i32 %uiVal) #0 {
entry:
  %uiVal.addr = alloca i32, align 4
  %uiTmp = alloca i32, align 4
  %canary = alloca i32
  store i32 1051467924, i32* %canary
  %uiRet = alloca i32, align 4
  store i32 %uiVal, i32* %uiVal.addr, align 4
  %0 = load i32, i32* %uiVal.addr, align 4
  %sub = sub i32 %0, 1
...
entry:
  %canary = alloca i32
  store i32 1332896234, i32* %canary
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @TestEncoderParams.7(i32 %bitdepth_qp_scale) #0 {
entry:
  %bitdepth_qp_scale.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1825042107, i32* %canary
  %i = alloca i32, align 4
  store i32 %bitdepth_qp_scale, i32* %bitdepth_qp_scale.addr, align 4
  store i32 0, i32* %i, align 4
  br label %while.cond
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @PatchInp.8() #0 {
entry:
  ...
  %canary = alloca i32
  store i32 2028155235, i32* %canary
...
if.end649:                                        ; preds = %if.then647, %land.lhs.true645, %if.end641
  ...
  %372 = icmp eq i32 %371, 2028155235
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @ParameterNameToMapIndex.9(i8* %s) #0 {
entry:
  %s.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 770394648, i32* %canary
  %i = alloca i32, align 4
  %retval = alloca i32, align 4
  store i8* %s, i8** %s.addr, align 8
  store i32 0, i32* %i, align 4
...
entry:
  ...
  %tmp = alloca i32, align 4
  %canary = alloca i32
  store i32 2027869401, i32* %canary
  %mb_width = alloca i32, align 4
  %i = alloca i32, align 4
  %frame_mb_only = alloca i32, align 4
  %mb_height = alloca i32, align 4
...
if.end649:                                        ; preds = %if.then647, %land.lhs.true645, %if.end641
  ...
  call void @LevelCheck()
  %371 = load i32, i32* %canary
  %372 = icmp eq i32 %371, 2027869401
  br i1 %372, label %373, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Configure.11(i32 %ac, i8** %av) #0 {
entry:
  %av.addr = alloca i8**, align 8
  %CLcount = alloca i32, align 4
  %ac.addr = alloca i32, align 4
  ...
  %destin = alloca i8*, align 8
  %canary = alloca i32
  store i32 1716757534, i32* %canary
  %filename = alloca i8*, align 8
  store i32 %ac, i32* %ac.addr, align 4
  store i8** %av, i8*** %av.addr, align 8
  store i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.1, i64 0, i64 0), i8** %filename, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @ParameterNameToMapIndex.12(i8* %s) #0 {
entry:
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1060419798, i32* %canary
  %i = alloca i32, align 4
  %s.addr = alloca i8*, align 8
  store i8* %s, i8** %s.addr, align 8
  store i32 0, i32* %i, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @CeilLog2.13(i32 %uiVal) #0 {
entry:
  %uiTmp = alloca i32, align 4
  %uiVal.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1461262280, i32* %canary
  %uiRet = alloca i32, align 4
  store i32 %uiVal, i32* %uiVal.addr, align 4
  %0 = load i32, i32* %uiVal.addr, align 4
  %sub = sub i32 %0, 1
...
entry:
  %canary = alloca i32
  store i32 946567052, i32* %canary
  %content = alloca i8*, align 8
  %destin = alloca i8*, align 8
  %ac.addr = alloca i32, align 4
  %source = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @CeilLog2.15(i32 %uiVal) #0 {
entry:
  %uiTmp = alloca i32, align 4
  %canary = alloca i32
  store i32 1333832464, i32* %canary
  %uiRet = alloca i32, align 4
  %uiVal.addr = alloca i32, align 4
  store i32 %uiVal, i32* %uiVal.addr, align 4
  %0 = load i32, i32* %uiVal.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @ParseContent.16(i8* %buf, i32 %bufsize) #0 {
entry:
  %buf.addr = alloca i8*, align 8
  %items = alloca [10000 x i8*], align 16
  %canary = alloca i32
  store i32 994677397, i32* %canary
  %p = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @ParseContent.17(i8* %buf, i32 %bufsize) #0 {
entry:
  %item = alloca i32, align 4
  %DoubleContent = alloca double, align 8
  %MapIdx = alloca i32, align 4
  %canary = alloca i32
  store i32 583242616, i32* %canary
  %bufsize.addr = alloca i32, align 4
  %IntContent = alloca i32, align 4
  %i = alloca i32, align 4
  %items = alloca [10000 x i8*], align 16
...
entry:
  %s.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 665048071, i32* %canary
  %retval = alloca i32, align 4
  %i = alloca i32, align 4
  store i8* %s, i8** %s.addr, align 8
  store i32 0, i32* %i, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i8* @GetConfigFileContent.19(i8* %Filename) #0 {
entry:
  %buf = alloca i8*, align 8
  %f = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 358658406, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1384153075, i32* %canary
  %buf = alloca i8*, align 8
  %f = alloca %struct._IO_FILE*, align 8
  %Filename.addr = alloca i8*, align 8
  %retval = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @PatchInp.21() #0 {
entry:
  %mb_height = alloca i32, align 4
  %i = alloca i32, align 4
  %tmp = alloca i32, align 4
  ...
  %sgfile = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 1730201533, i32* %canary
  %frame_mb_only = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %BitDepthLuma = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 135
  %1 = load i32, i32* %BitDepthLuma, align 8
...
if.end649:                                        ; preds = %if.then647, %land.lhs.true645, %if.end641
  ...
  call void @LevelCheck()
  %371 = load i32, i32* %canary
  %372 = icmp eq i32 %371, 1730201533
  br i1 %372, label %373, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @ParseContent.22(i8* %buf, i32 %bufsize) #0 {
entry:
  %canary = alloca i32
  store i32 1604790624, i32* %canary
  %MapIdx = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %bufend = alloca i8*, align 8
  %DoubleContent = alloca double, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i8* @GetConfigFileContent.23(i8* %Filename) #0 {
entry:
  %retval = alloca i8*, align 8
  %FileSize = alloca i64, align 8
  %Filename.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1117255811, i32* %canary
  %buf = alloca i8*, align 8
  %f = alloca %struct._IO_FILE*, align 8
  store i8* %Filename, i8** %Filename.addr, align 8
  %0 = load i8*, i8** %Filename.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @ParseContent.24(i8* %buf, i32 %bufsize) #0 {
entry:
  %bufsize.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %InItem = alloca i32, align 4
  ...
  %items = alloca [10000 x i8*], align 16
  %canary = alloca i32
  store i32 1802978456, i32* %canary
  %item = alloca i32, align 4
  %IntContent = alloca i32, align 4
  %InString = alloca i32, align 4
  %MapIdx = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @PatchInp.25() #0 {
entry:
  %canary = alloca i32
  store i32 186078800, i32* %canary
  %mapunit_height = alloca i32, align 4
  %sgfile = alloca %struct._IO_FILE*, align 8
  %frame_mb_only = alloca i32, align 4
  %storedBplus1 = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i8* @GetConfigFileContent.26(i8* %Filename) #0 {
entry:
  %FileSize = alloca i64, align 8
  %Filename.addr = alloca i8*, align 8
  %retval = alloca i8*, align 8
  %buf = alloca i8*, align 8
  %canary = alloca i32
  store i32 787896713, i32* %canary
  %f = alloca %struct._IO_FILE*, align 8
  store i8* %Filename, i8** %Filename.addr, align 8
  %0 = load i8*, i8** %Filename.addr, align 8
  %call = call %struct._IO_FILE* @fopen(i8* %0, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.12, i64 0, i64 0))
