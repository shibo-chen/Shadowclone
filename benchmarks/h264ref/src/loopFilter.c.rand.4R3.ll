; ModuleID = 'loopFilter.c.rand.4R3.bc'
...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_DeblockFrame.3, label %ctrl0

func_DeblockFrame.3:                              ; preds = %rand_bb
  call void @DeblockFrame.3(%struct.ImageParameters* %img, i16** %imgY, i16*** %imgUV)
  ret void

func_DeblockFrame.12:                             ; preds = %ctrl0
  call void @DeblockFrame.12(%struct.ImageParameters* %img, i16** %imgY, i16*** %imgUV)
  ret void

func_DeblockFrame.14:                             ; preds = %ctrl1
  call void @DeblockFrame.14(%struct.ImageParameters* %img, i16** %imgY, i16*** %imgUV)
  ret void

func_DeblockFrame.16:                             ; preds = %ctrl1
  call void @DeblockFrame.16(%struct.ImageParameters* %img, i16** %imgY, i16*** %imgUV)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_DeblockFrame.12, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_DeblockFrame.14, label %func_DeblockFrame.16
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_DeblockMb.2, label %ctrl0

func_DeblockMb.2:                                 ; preds = %rand_bb
  call void @DeblockMb.2(%struct.ImageParameters* %img, i16** %imgY, i16*** %imgUV, i32 %MbQAddr)
  ret void

func_DeblockMb.6:                                 ; preds = %ctrl0
  call void @DeblockMb.6(%struct.ImageParameters* %img, i16** %imgY, i16*** %imgUV, i32 %MbQAddr)
  ret void

func_DeblockMb.11:                                ; preds = %ctrl1
  call void @DeblockMb.11(%struct.ImageParameters* %img, i16** %imgY, i16*** %imgUV, i32 %MbQAddr)
  ret void

func_DeblockMb.15:                                ; preds = %ctrl1
  call void @DeblockMb.15(%struct.ImageParameters* %img, i16** %imgY, i16*** %imgUV, i32 %MbQAddr)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_DeblockMb.6, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_DeblockMb.11, label %func_DeblockMb.15
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_GetStrength.1, label %ctrl0

func_GetStrength.1:                               ; preds = %rand_bb
  call void @GetStrength.1(i8* %Strength, %struct.ImageParameters* %img, i32 %MbQAddr, i32 %dir, i32 %edge, i32 %mvlimit)
  ret void

func_GetStrength.7:                               ; preds = %ctrl0
  call void @GetStrength.7(i8* %Strength, %struct.ImageParameters* %img, i32 %MbQAddr, i32 %dir, i32 %edge, i32 %mvlimit)
  ret void

func_GetStrength.10:                              ; preds = %ctrl1
  call void @GetStrength.10(i8* %Strength, %struct.ImageParameters* %img, i32 %MbQAddr, i32 %dir, i32 %edge, i32 %mvlimit)
  ret void

func_GetStrength.13:                              ; preds = %ctrl1
  call void @GetStrength.13(i8* %Strength, %struct.ImageParameters* %img, i32 %MbQAddr, i32 %dir, i32 %edge, i32 %mvlimit)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_GetStrength.7, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_GetStrength.10, label %func_GetStrength.13
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_EdgeLoop.4, label %ctrl0

func_EdgeLoop.4:                                  ; preds = %rand_bb
  call void @EdgeLoop.4(i16** %Img, i8* %Strength, %struct.ImageParameters* %img, i32 %MbQAddr, i32 %AlphaC0Offset, i32 %BetaOffset, i32 %dir, i32 %edge, i32 %width, i32 %yuv, i32 %uv)
  ret void
...
func_EdgeLoop.8:                                  ; preds = %ctrl1
  call void @EdgeLoop.8(i16** %Img, i8* %Strength, %struct.ImageParameters* %img, i32 %MbQAddr, i32 %AlphaC0Offset, i32 %BetaOffset, i32 %dir, i32 %edge, i32 %width, i32 %yuv, i32 %uv)
  ret void

func_EdgeLoop.9:                                  ; preds = %ctrl1
  call void @EdgeLoop.9(i16** %Img, i8* %Strength, %struct.ImageParameters* %img, i32 %MbQAddr, i32 %AlphaC0Offset, i32 %BetaOffset, i32 %dir, i32 %edge, i32 %width, i32 %yuv, i32 %uv)
  ret void
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_EdgeLoop.8, label %func_EdgeLoop.9
}
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @GetStrength.1(i8* %Strength, %struct.ImageParameters* %img, i32 %MbQAddr, i32 %dir, i32 %edge, i32 %mvlimit) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 1295466201, i32* %canary
...
for.end:                                          ; preds = %for.cond
  ...
  %394 = icmp eq i32 %393, 1295466201
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @DeblockMb.2(%struct.ImageParameters* %img, i16** %imgY, i16*** %imgUV, i32 %MbQAddr) #0 {
entry:
  %img.addr = alloca %struct.ImageParameters*, align 8
  ...
  %canary = alloca i32
  store i32 575798237, i32* %canary
...
entry:
  ...
  %img.addr = alloca %struct.ImageParameters*, align 8
  %canary = alloca i32
  store i32 238760519, i32* %canary
  %imgUV.addr = alloca i16***, align 8
  %i = alloca i32, align 4
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store i16** %imgY, i16*** %imgY.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @EdgeLoop.4(i16** %Img, i8* %Strength, %struct.ImageParameters* %img, i32 %MbQAddr, i32 %AlphaC0Offset, i32 %BetaOffset, i32 %dir, i32 %edge, i32 %width, i32 %yuv, i32 %uv) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 294868892, i32* %canary
  %MbQAddr.addr = alloca i32, align 4
...
entry:
  ...
  %ClipTab = alloca i8*, align 8
  %canary = alloca i32
  store i32 777688195, i32* %canary
  %SrcPtrQ = alloca i16*, align 8
  %MbP = alloca %struct.macroblock*, align 8
  %c0 = alloca i32, align 4
  %BetaOffset.addr = alloca i32, align 4
...
entry:
  ...
  %StrengthSum = alloca i32, align 4
  %canary = alloca i32
  store i32 1927671654, i32* %canary
  %MbQ = alloca %struct.macroblock*, align 8
  %filterLeftMbEdgeFlag = alloca i32, align 4
  %filterTopMbEdgeFlag = alloca i32, align 4
  %mvlimit = alloca i32, align 4
...
return:                                           ; preds = %for.end152, %if.then25
  %160 = load i32, i32* %canary
  %161 = icmp eq i32 %160, 1927671654
  br i1 %161, label %162, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @GetStrength.7(i8* %Strength, %struct.ImageParameters* %img, i32 %MbQAddr, i32 %dir, i32 %edge, i32 %mvlimit) #0 {
entry:
  %yQ = alloca i32, align 4
  %blk_y = alloca i32, align 4
  %ref_q1 = alloca i64, align 8
  ...
  %list1_mv = alloca i16***, align 8
  %canary = alloca i32
  store i32 883360273, i32* %canary
  %img.addr = alloca %struct.ImageParameters*, align 8
  %MbP = alloca %struct.macroblock*, align 8
  %blk_y2 = alloca i32, align 4
  %mb_y = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @EdgeLoop.8(i16** %Img, i8* %Strength, %struct.ImageParameters* %img, i32 %MbQAddr, i32 %AlphaC0Offset, i32 %BetaOffset, i32 %dir, i32 %edge, i32 %width, i32 %yuv, i32 %uv) #0 {
entry:
  %Delta = alloca i32, align 4
  %ap = alloca i32, align 4
  %xQ = alloca i32, align 4
  ...
  %SrcPtrP = alloca i16*, align 8
  %canary = alloca i32
  store i32 1037350650, i32* %canary
  %pelnum_cr = alloca [2 x [4 x i32]], align 16
  %small_gap = alloca i32, align 4
  %xP = alloca i32, align 4
  %MbQAddr.addr = alloca i32, align 4
...
for.end:                                          ; preds = %for.cond
  %347 = load i32, i32* %canary
  %348 = icmp eq i32 %347, 1037350650
  br i1 %348, label %349, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @EdgeLoop.9(i16** %Img, i8* %Strength, %struct.ImageParameters* %img, i32 %MbQAddr, i32 %AlphaC0Offset, i32 %BetaOffset, i32 %dir, i32 %edge, i32 %width, i32 %yuv, i32 %uv) #0 {
entry:
  %edge.addr = alloca i32, align 4
  %L0 = alloca i32, align 4
  %incP = alloca i32, align 4
  ...
  %xQ = alloca i32, align 4
  %canary = alloca i32
  store i32 1137890000, i32* %canary
  %R2 = alloca i32, align 4
  %width.addr = alloca i32, align 4
  %StrengthIdx = alloca i32, align 4
  %SrcPtrQ = alloca i16*, align 8
...
for.end:                                          ; preds = %for.cond
  %347 = load i32, i32* %canary
  %348 = icmp eq i32 %347, 1137890000
  br i1 %348, label %349, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @GetStrength.10(i8* %Strength, %struct.ImageParameters* %img, i32 %MbQAddr, i32 %dir, i32 %edge, i32 %mvlimit) #0 {
entry:
  %mb_y = alloca i32, align 4
  %list0_refIdxArr = alloca i16**, align 8
  %blkP = alloca i32, align 4
  ...
  %blk_y2 = alloca i32, align 4
  %canary = alloca i32
  store i32 1893665918, i32* %canary
  %dir.addr = alloca i32, align 4
  store i8* %Strength, i8** %Strength.addr, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store i32 %MbQAddr, i32* %MbQAddr.addr, align 4
...
for.end:                                          ; preds = %for.cond
  %393 = load i32, i32* %canary
  %394 = icmp eq i32 %393, 1893665918
  br i1 %394, label %395, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @DeblockMb.11(%struct.ImageParameters* %img, i16** %imgY, i16*** %imgUV, i32 %MbQAddr) #0 {
entry:
  %dir = alloca i32, align 4
  %edge = alloca i32, align 4
  %img.addr = alloca %struct.ImageParameters*, align 8
  ...
  %mvlimit = alloca i32, align 4
  %canary = alloca i32
  store i32 1495781751, i32* %canary
  %i = alloca i32, align 4
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store i16** %imgY, i16*** %imgY.addr, align 8
  store i16*** %imgUV, i16**** %imgUV.addr, align 8
...
return:                                           ; preds = %for.end152, %if.then25
  %160 = load i32, i32* %canary
  %161 = icmp eq i32 %160, 1495781751
  br i1 %161, label %162, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @DeblockFrame.12(%struct.ImageParameters* %img, i16** %imgY, i16*** %imgUV) #0 {
entry:
  %canary = alloca i32
  store i32 920311609, i32* %canary
  %img.addr = alloca %struct.ImageParameters*, align 8
  %i = alloca i32, align 4
  %imgY.addr = alloca i16**, align 8
  %imgUV.addr = alloca i16***, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @GetStrength.13(i8* %Strength, %struct.ImageParameters* %img, i32 %MbQAddr, i32 %dir, i32 %edge, i32 %mvlimit) #0 {
entry:
  %mvlimit.addr = alloca i32, align 4
  %blk_y2 = alloca i32, align 4
  %ref_q1 = alloca i64, align 8
  ...
  %mb_y = alloca i32, align 4
  %canary = alloca i32
  store i32 1251933254, i32* %canary
  %Strength.addr = alloca i8*, align 8
  %list1_mv = alloca i16***, align 8
  %ref_q0 = alloca i64, align 8
  %list1_refPicIdArr = alloca i64**, align 8
...
for.end:                                          ; preds = %for.cond
  %393 = load i32, i32* %canary
  %394 = icmp eq i32 %393, 1251933254
  br i1 %394, label %395, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @DeblockFrame.14(%struct.ImageParameters* %img, i16** %imgY, i16*** %imgUV) #0 {
entry:
  %img.addr = alloca %struct.ImageParameters*, align 8
  %imgUV.addr = alloca i16***, align 8
  %imgY.addr = alloca i16**, align 8
  %canary = alloca i32
  store i32 166282065, i32* %canary
  %i = alloca i32, align 4
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store i16** %imgY, i16*** %imgY.addr, align 8
  store i16*** %imgUV, i16**** %imgUV.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @DeblockMb.15(%struct.ImageParameters* %img, i16** %imgY, i16*** %imgUV, i32 %MbQAddr) #0 {
entry:
  %filterNon8x8LumaEdgesFlag = alloca [4 x i32], align 16
  %MbQ = alloca %struct.macroblock*, align 8
  %mb_y = alloca i32, align 4
  ...
  %mb_x = alloca i32, align 4
  %canary = alloca i32
  store i32 1428382884, i32* %canary
  %img.addr = alloca %struct.ImageParameters*, align 8
  %edge_cr = alloca i32, align 4
  %imgY.addr = alloca i16**, align 8
  %fieldModeMbFlag = alloca i32, align 4
...
return:                                           ; preds = %for.end152, %if.then25
  %160 = load i32, i32* %canary
  %161 = icmp eq i32 %160, 1428382884
  br i1 %161, label %162, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @DeblockFrame.16(%struct.ImageParameters* %img, i16** %imgY, i16*** %imgUV) #0 {
entry:
  %canary = alloca i32
  store i32 1578237069, i32* %canary
  %i = alloca i32, align 4
  %imgY.addr = alloca i16**, align 8
  %imgUV.addr = alloca i16***, align 8
  %img.addr = alloca %struct.ImageParameters*, align 8
