...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_PutPel_14.9, label %ctrl0

func_PutPel_14.9:                                 ; preds = %rand_bb
  call void @PutPel_14.9(i16** %Pic, i32 %y, i32 %x, i16 %val)
  ret void
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_PutPel_14.30, label %func_PutPel_14.31
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_PutPel_11.3, label %ctrl0

func_PutPel_11.3:                                 ; preds = %rand_bb
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_PutPel_11.19, label %func_PutPel_11.23
}
...
func_FastLine16Y_11.29:                           ; preds = %ctrl1
  %5 = call i16* @FastLine16Y_11.29(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_FastLine16Y_11.22, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_FastLine16Y_11.26, label %func_FastLine16Y_11.29
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_UMVLine16Y_11.5, label %ctrl0

func_UMVLine16Y_11.5:                             ; preds = %rand_bb
  %2 = call i16* @UMVLine16Y_11.5(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %2

func_UMVLine16Y_11.17:                            ; preds = %ctrl0
  %3 = call i16* @UMVLine16Y_11.17(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %3

func_UMVLine16Y_11.18:                            ; preds = %ctrl1
  %4 = call i16* @UMVLine16Y_11.18(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %4
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_UMVLine16Y_11.17, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_UMVLine16Y_11.18, label %func_UMVLine16Y_11.20
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FastLineX.14, label %ctrl0

func_FastLineX.14:                                ; preds = %rand_bb
  %2 = call i16* @FastLineX.14(i32 %dummy, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %2

func_FastLineX.25:                                ; preds = %ctrl0
  %3 = call i16* @FastLineX.25(i32 %dummy, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %3

func_FastLineX.27:                                ; preds = %ctrl1
  %4 = call i16* @FastLineX.27(i32 %dummy, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %4

func_FastLineX.32:                                ; preds = %ctrl1
  %5 = call i16* @FastLineX.32(i32 %dummy, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_FastLineX.25, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_FastLineX.27, label %func_FastLineX.32
}
...
func_UMVLineX.2:                                  ; preds = %ctrl0
  %3 = call i16* @UMVLineX.2(i32 %size, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %3

func_UMVLineX.16:                                 ; preds = %ctrl1
  %4 = call i16* @UMVLineX.16(i32 %size, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %4

func_UMVLineX.24:                                 ; preds = %ctrl1
  %5 = call i16* @UMVLineX.24(i32 %size, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_UMVLineX.2, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_UMVLineX.16, label %func_UMVLineX.24
}
...
func_UMVPelY_14.13:                               ; preds = %ctrl0
  %3 = call i16 @UMVPelY_14.13(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16 %3

func_UMVPelY_14.15:                               ; preds = %ctrl1
  %4 = call i16 @UMVPelY_14.15(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16 %4

func_UMVPelY_14.28:                               ; preds = %ctrl1
  %5 = call i16 @UMVPelY_14.28(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_UMVPelY_14.13, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_UMVPelY_14.15, label %func_UMVPelY_14.28
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FastPelY_14.4, label %ctrl0

func_FastPelY_14.4:                               ; preds = %rand_bb
  %2 = call i16 @FastPelY_14.4(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16 %2

func_FastPelY_14.6:                               ; preds = %ctrl0
  %3 = call i16 @FastPelY_14.6(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16 %3
...
func_FastPelY_14.11:                              ; preds = %ctrl1
  %5 = call i16 @FastPelY_14.11(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_FastPelY_14.6, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_FastPelY_14.10, label %func_FastPelY_14.11
}
...
entry:
  ...
  %canary = alloca i32
  store i32 1475783112, i32* %canary
...
entry:
  ...
  %size.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 726336722, i32* %canary
  %Picy = alloca i16*, align 8
  %width.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
  %x.addr = alloca i32, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 1282809457, i32* %canary
  %y.addr = alloca i32, align 4
  %width.addr = alloca i32, align 4
  %x.addr = alloca i32, align 4
  store i16* %Pic, i16** %Pic.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local zeroext i16 @FastPelY_14.4(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width) #0 {
entry:
  %y.addr = alloca i32, align 4
  %height.addr = alloca i32, align 4
  %x.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 254225846, i32* %canary
  %width.addr = alloca i32, align 4
  %Pic.addr = alloca i16**, align 8
  store i16** %Pic, i16*** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i16* @UMVLine16Y_11.5(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width) #0 {
entry:
  %retval = alloca i16*, align 8
  %canary = alloca i32
  store i32 165229659, i32* %canary
  %x.addr = alloca i32, align 4
  %maxx = alloca i32, align 4
  %width.addr = alloca i32, align 4
  %i = alloca i32, align 4
...
entry:
  ...
  %height.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 417640062, i32* %canary
  %x.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
  %width.addr = alloca i32, align 4
  store i16** %Pic, i16*** %Pic.addr, align 8
...
entry:
  ...
  %canary = alloca i32
  store i32 630771339, i32* %canary
  %Pic.addr = alloca i16**, align 8
  %y.addr = alloca i32, align 4
  %height.addr = alloca i32, align 4
...
entry:
  ...
  %height.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1908516472, i32* %canary
  %x.addr = alloca i32, align 4
  store i16* %Pic, i16** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
  store i32 %x, i32* %x.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @PutPel_14.9(i16** %Pic, i32 %y, i32 %x, i16 zeroext %val) #0 {
entry:
  %x.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 110445186, i32* %canary
  %val.addr = alloca i16, align 2
  %Pic.addr = alloca i16**, align 8
  store i16** %Pic, i16*** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
...
entry:
  ...
  %width.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1324604669, i32* %canary
  %Pic.addr = alloca i16**, align 8
  %x.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
  store i16** %Pic, i16*** %Pic.addr, align 8
...
entry:
  %width.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1638203543, i32* %canary
  %height.addr = alloca i32, align 4
  %Pic.addr = alloca i16**, align 8
  %x.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
...
entry:
  %y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 156098768, i32* %canary
  %x.addr = alloca i32, align 4
  %val.addr = alloca i16, align 2
  %Pic.addr = alloca i16*, align 8
  %width.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local zeroext i16 @UMVPelY_14.13(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width) #0 {
entry:
  %retval = alloca i16, align 2
  %Pic.addr = alloca i16**, align 8
  %height.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1593552875, i32* %canary
  %y.addr = alloca i32, align 4
  %width4 = alloca i32, align 4
  %x.addr = alloca i32, align 4
  %width.addr = alloca i32, align 4
...
entry:
  ...
  %Pic.addr = alloca i16*, align 8
  %canary = alloca i32
  store i32 803264621, i32* %canary
  %y.addr = alloca i32, align 4
  %height.addr = alloca i32, align 4
...
entry:
  ...
  %Pic.addr = alloca i16**, align 8
  %canary = alloca i32
  store i32 1692365073, i32* %canary
  %width.addr = alloca i32, align 4
  %height4 = alloca i32, align 4
  %x.addr = alloca i32, align 4
  %height.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i16* @UMVLineX.16(i32 %size, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width) #0 {
entry:
  %canary = alloca i32
  store i32 1278572636, i32* %canary
  %Picy = alloca i16*, align 8
  %retval = alloca i16*, align 8
  %y.addr = alloca i32, align 4
  %maxx = alloca i32, align 4
...
entry:
  ...
  %x.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 914490841, i32* %canary
  %y.addr = alloca i32, align 4
  %Picy = alloca i16*, align 8
  %width.addr = alloca i32, align 4
  %i = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 533694316, i32* %canary
  %height.addr = alloca i32, align 4
  %Pic.addr = alloca i16*, align 8
  %width.addr = alloca i32, align 4
  %retval = alloca i16*, align 8
...
entry:
  ...
  %width.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1868463736, i32* %canary
  %val.addr = alloca i16, align 2
  %y.addr = alloca i32, align 4
  store i16* %Pic, i16** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
...
entry:
  ...
  %Pic.addr = alloca i16*, align 8
  %canary = alloca i32
  store i32 2146500365, i32* %canary
  %maxx = alloca i32, align 4
  %width.addr = alloca i32, align 4
  store i16* %Pic, i16** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 1805030120, i32* %canary
  %val.addr = alloca i16, align 2
  %y.addr = alloca i32, align 4
  %Pic.addr = alloca i16**, align 8
  %x.addr = alloca i32, align 4
...
entry:
  %x.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 220133105, i32* %canary
  %height.addr = alloca i32, align 4
  %Pic.addr = alloca i16*, align 8
  %width.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
...
entry:
  ...
  %width.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 774896532, i32* %canary
  %val.addr = alloca i16, align 2
  store i16* %Pic, i16** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
  store i32 %x, i32* %x.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i16* @UMVLineX.24(i32 %size, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width) #0 {
entry:
  %y.addr = alloca i32, align 4
  %maxx = alloca i32, align 4
  %Pic.addr = alloca i16*, align 8
  ...
  %size.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 732208650, i32* %canary
  %Picy = alloca i16*, align 8
  store i32 %size, i32* %size.addr, align 4
  store i16* %Pic, i16** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
...
entry:
  ...
  %x.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 600900179, i32* %canary
  %Pic.addr = alloca i16*, align 8
  %y.addr = alloca i32, align 4
  %height.addr = alloca i32, align 4
  %dummy.addr = alloca i32, align 4
...
entry:
  ...
  %width.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2124221155, i32* %canary
  %y.addr = alloca i32, align 4
  %x.addr = alloca i32, align 4
  store i16* %Pic, i16** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
...
entry:
  ...
  %width.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1785339452, i32* %canary
  %height.addr = alloca i32, align 4
  %dummy.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
  %Pic.addr = alloca i16*, align 8
...
entry:
  ...
  %width4 = alloca i32, align 4
  %canary = alloca i32
  store i32 1763176732, i32* %canary
  %x.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
  store i16** %Pic, i16*** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i16* @FastLine16Y_11.29(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width) #0 {
entry:
  %Pic.addr = alloca i16*, align 8
  %width.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 289613277, i32* %canary
  %height.addr = alloca i32, align 4
  %x.addr = alloca i32, align 4
  store i16* %Pic, i16** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 185671347, i32* %canary
  %x.addr = alloca i32, align 4
  %Pic.addr = alloca i16**, align 8
  %val.addr = alloca i16, align 2
  %y.addr = alloca i32, align 4
...
entry:
  ...
  %width.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 733818731, i32* %canary
  %y.addr = alloca i32, align 4
  %dummy.addr = alloca i32, align 4
  %Pic.addr = alloca i16*, align 8
  %height.addr = alloca i32, align 4
