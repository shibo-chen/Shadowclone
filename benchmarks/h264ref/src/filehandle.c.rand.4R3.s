...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$670593335, -32(%rbp)   # imm = 0x27F87137
	movl	%edi, -12(%rbp)
	movl	%esi, -28(%rbp)
	movq	$0, -24(%rbp)
	movl	-28(%rbp), %edi
	...
	callq	FreeNALU
	movl	-12(%rbp), %ebx
	cmpl	$670593335, -32(%rbp)   # imm = 0x27F87137
	jne	.LBB4_2
.LBB4_1:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1641485178, -20(%rbp)  # imm = 0x61D7137A
	movq	%rdi, -16(%rbp)
	movl	%esi, -4(%rbp)
	movq	stderr, %rdi
	movq	-16(%rbp), %rdx
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$41581193, -32(%rbp)    # imm = 0x27A7A89
	movl	%edi, -12(%rbp)
	movl	%esi, -28(%rbp)
	movq	$0, -24(%rbp)
	movl	-28(%rbp), %edi
	...
	callq	FreeNALU
	movl	-12(%rbp), %ebx
	cmpl	$41581193, -32(%rbp)    # imm = 0x27A7A89
	jne	.LBB6_2
.LBB6_1:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$1278939325, -40(%rbp)  # imm = 0x4C3B10BD
	movl	$0, -12(%rbp)
	movq	input(%rip), %rax
	movl	60(%rax), %eax
	xorl	%ecx, %ecx
...
.LBB7_10:                               # %return
	movl	-20(%rbp), %ebx
	cmpl	$1278939325, -40(%rbp)  # imm = 0x4C3B10BD
	jne	.LBB7_12
.LBB7_11:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$1494652489, -36(%rbp)  # imm = 0x59169649
	movl	$0, -12(%rbp)
	movq	input(%rip), %rax
	movl	60(%rax), %eax
	xorl	%ecx, %ecx
...
.LBB8_10:                               # %return
	movl	-20(%rbp), %ebx
	cmpl	$1494652489, -36(%rbp)  # imm = 0x59169649
	jne	.LBB8_12
.LBB8_11:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$1200771410, -36(%rbp)  # imm = 0x47925152
	movl	$0, -12(%rbp)
	movq	input(%rip), %rax
	movl	60(%rax), %eax
	xorl	%ecx, %ecx
...
.LBB9_10:                               # %return
	movl	-20(%rbp), %ebx
	cmpl	$1200771410, -36(%rbp)  # imm = 0x47925152
	jne	.LBB9_12
.LBB9_11:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$36050608, -40(%rbp)    # imm = 0x22616B0
	movl	$0, -12(%rbp)
	movq	input(%rip), %rax
	movl	60(%rax), %eax
	xorl	%ecx, %ecx
...
.LBB10_10:                              # %return
	movl	-20(%rbp), %ebx
	cmpl	$36050608, -40(%rbp)    # imm = 0x22616B0
	jne	.LBB10_12
.LBB10_11:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$1184571924, -28(%rbp)  # imm = 0x469B2214
	movl	%edi, -12(%rbp)
	movl	%esi, -32(%rbp)
	movq	$0, -24(%rbp)
	movl	-32(%rbp), %edi
	...
	callq	FreeNALU
	movl	-12(%rbp), %ebx
	cmpl	$1184571924, -28(%rbp)  # imm = 0x469B2214
	jne	.LBB11_2
.LBB11_1:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$1875486773, -28(%rbp)  # imm = 0x6FC9A835
	movl	%edi, -12(%rbp)
	movl	%esi, -32(%rbp)
	movq	$0, -24(%rbp)
	movl	-32(%rbp), %edi
	...
	callq	FreeNALU
	movl	-12(%rbp), %ebx
	cmpl	$1875486773, -28(%rbp)  # imm = 0x6FC9A835
	jne	.LBB12_2
.LBB12_1:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1098042873, -20(%rbp)  # imm = 0x4172CDF9
	movq	%rdi, -16(%rbp)
	movl	%esi, -4(%rbp)
	movq	stderr, %rdi
	movq	-16(%rbp), %rdx
