...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_SliceHeader.9, label %ctrl0

func_SliceHeader.9:                               ; preds = %rand_bb
  %2 = call i32 @SliceHeader.9()
  ret i32 %2
...
func_SliceHeader.14:                              ; preds = %ctrl1
  %4 = call i32 @SliceHeader.14()
  ret i32 %4
...
func_SliceHeader.23:                              ; preds = %ctrl3
  %6 = call i32 @SliceHeader.23()
  ret i32 %6

func_SliceHeader.28:                              ; preds = %ctrl4
  %7 = call i32 @SliceHeader.28()
  ret i32 %7

func_SliceHeader.30:                              ; preds = %ctrl5
  %8 = call i32 @SliceHeader.30()
  ret i32 %8
...
ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_SliceHeader.14, label %ctrl2
...
ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_SliceHeader.23, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_SliceHeader.28, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_SliceHeader.30, label %func_SliceHeader.32
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_get_picture_type.2, label %func_get_picture_type.13

func_get_picture_type.2:                          ; preds = %rand_bb
  %2 = call i32 @get_picture_type.2()
  ret i32 %2

func_get_picture_type.13:                         ; preds = %rand_bb
  %3 = call i32 @get_picture_type.13()
  ret i32 %3
}
...
func_Partition_BC_Header.4:                       ; preds = %ctrl0
  %3 = call i32 @Partition_BC_Header.4(i32 %PartNo)
  ret i32 %3

func_Partition_BC_Header.15:                      ; preds = %ctrl1
  %4 = call i32 @Partition_BC_Header.15(i32 %PartNo)
  ret i32 %4
...
func_Partition_BC_Header.27:                      ; preds = %ctrl3
  %6 = call i32 @Partition_BC_Header.27(i32 %PartNo)
  ret i32 %6

func_Partition_BC_Header.37:                      ; preds = %ctrl4
  %7 = call i32 @Partition_BC_Header.37(i32 %PartNo)
  ret i32 %7

func_Partition_BC_Header.40:                      ; preds = %ctrl5
  %8 = call i32 @Partition_BC_Header.40(i32 %PartNo)
  ret i32 %8
...
ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_Partition_BC_Header.4, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_Partition_BC_Header.15, label %ctrl2
...
ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_Partition_BC_Header.27, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_Partition_BC_Header.37, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_Partition_BC_Header.40, label %func_Partition_BC_Header.42
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_ref_pic_list_reordering.7, label %ctrl0

func_ref_pic_list_reordering.7:                   ; preds = %rand_bb
  %2 = call i32 @ref_pic_list_reordering.7()
  ret i32 %2

func_ref_pic_list_reordering.8:                   ; preds = %ctrl0
  %3 = call i32 @ref_pic_list_reordering.8()
  ret i32 %3

func_ref_pic_list_reordering.11:                  ; preds = %ctrl1
  %4 = call i32 @ref_pic_list_reordering.11()
  ret i32 %4

func_ref_pic_list_reordering.18:                  ; preds = %ctrl2
  %5 = call i32 @ref_pic_list_reordering.18()
  ret i32 %5

func_ref_pic_list_reordering.20:                  ; preds = %ctrl3
  %6 = call i32 @ref_pic_list_reordering.20()
  ret i32 %6

func_ref_pic_list_reordering.29:                  ; preds = %ctrl4
  %7 = call i32 @ref_pic_list_reordering.29()
  ret i32 %7
...
func_ref_pic_list_reordering.38:                  ; preds = %ctrl5
  %9 = call i32 @ref_pic_list_reordering.38()
  ret i32 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_ref_pic_list_reordering.8, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_ref_pic_list_reordering.11, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_ref_pic_list_reordering.18, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_ref_pic_list_reordering.20, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_ref_pic_list_reordering.29, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_ref_pic_list_reordering.33, label %func_ref_pic_list_reordering.38
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_dec_ref_pic_marking.6, label %ctrl0

func_dec_ref_pic_marking.6:                       ; preds = %rand_bb
  %2 = call i32 @dec_ref_pic_marking.6()
  ret i32 %2

func_dec_ref_pic_marking.17:                      ; preds = %ctrl0
  %3 = call i32 @dec_ref_pic_marking.17()
  ret i32 %3

func_dec_ref_pic_marking.19:                      ; preds = %ctrl1
  %4 = call i32 @dec_ref_pic_marking.19()
  ret i32 %4
...
func_dec_ref_pic_marking.24:                      ; preds = %ctrl3
  %6 = call i32 @dec_ref_pic_marking.24()
  ret i32 %6

func_dec_ref_pic_marking.31:                      ; preds = %ctrl4
  %7 = call i32 @dec_ref_pic_marking.31()
  ret i32 %7

func_dec_ref_pic_marking.34:                      ; preds = %ctrl5
  %8 = call i32 @dec_ref_pic_marking.34()
  ret i32 %8
...
ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_dec_ref_pic_marking.17, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_dec_ref_pic_marking.19, label %ctrl2
...
ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_dec_ref_pic_marking.24, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_dec_ref_pic_marking.31, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_dec_ref_pic_marking.34, label %func_dec_ref_pic_marking.35
}
...
func_pred_weight_table.5:                         ; preds = %ctrl0
  %3 = call i32 @pred_weight_table.5()
  ret i32 %3

func_pred_weight_table.10:                        ; preds = %ctrl1
  %4 = call i32 @pred_weight_table.10()
  ret i32 %4

func_pred_weight_table.25:                        ; preds = %ctrl2
  %5 = call i32 @pred_weight_table.25()
  ret i32 %5

func_pred_weight_table.26:                        ; preds = %ctrl3
  %6 = call i32 @pred_weight_table.26()
  ret i32 %6

func_pred_weight_table.36:                        ; preds = %ctrl4
  %7 = call i32 @pred_weight_table.36()
  ret i32 %7

func_pred_weight_table.39:                        ; preds = %ctrl5
  %8 = call i32 @pred_weight_table.39()
  ret i32 %8

func_pred_weight_table.41:                        ; preds = %ctrl5
  %9 = call i32 @pred_weight_table.41()
  ret i32 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_pred_weight_table.5, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_pred_weight_table.10, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_pred_weight_table.25, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_pred_weight_table.26, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_pred_weight_table.36, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_pred_weight_table.39, label %func_pred_weight_table.41
}
...
entry:
  ...
  %canary = alloca i32
  store i32 847876454, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_picture_type.2() #0 {
entry:
  %canary = alloca i32
  store i32 2143713375, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1522805302, i32* %canary
...
if.end175:                                        ; preds = %for.end174, %for.end83
  ...
  %172 = icmp eq i32 %171, 1522805302
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @Partition_BC_Header.4(i32 %PartNo) #0 {
entry:
  %len = alloca i32, align 4
  %canary = alloca i32
  store i32 1155675264, i32* %canary
  %partition = alloca %struct.datapartition*, align 8
  %symbol = alloca %struct.syntaxelement, align 8
  %PartNo.addr = alloca i32, align 4
  %sym = alloca %struct.syntaxelement*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @pred_weight_table.5() #0 {
entry:
  %i = alloca i32, align 4
  %len = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1939640941, i32* %canary
  %dP_nr = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
  %1 = load i32, i32* %partition_mode, align 4
...
if.end175:                                        ; preds = %for.end174, %for.end83
  %170 = load i32, i32* %len, align 4
  %171 = load i32, i32* %canary
  %172 = icmp eq i32 %171, 1939640941
  br i1 %172, label %173, label %func_exit
...
entry:
  ...
  %len = alloca i32, align 4
  %canary = alloca i32
  store i32 143158357, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 406221252, i32* %canary
...
entry:
  ...
  %dP_nr = alloca i32, align 4
  %canary = alloca i32
  store i32 257099745, i32* %canary
  %currSlice = alloca %struct.Slice*, align 8
  %len = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
entry:
  ...
  %dP_nr = alloca i32, align 4
  %canary = alloca i32
  store i32 107148642, i32* %canary
  %currSlice = alloca %struct.Slice*, align 8
  %partition = alloca %struct.datapartition*, align 8
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @pred_weight_table.10() #0 {
entry:
  %canary = alloca i32
  store i32 23458547, i32* %canary
  %partition = alloca %struct.datapartition*, align 8
  %dP_nr = alloca i32, align 4
  %j = alloca i32, align 4
  %len = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @ref_pic_list_reordering.11() #0 {
entry:
  %partition = alloca %struct.datapartition*, align 8
  %dP_nr = alloca i32, align 4
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1233553762, i32* %canary
  %len = alloca i32, align 4
  %currSlice = alloca %struct.Slice*, align 8
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
...
entry:
  %canary = alloca i32
  store i32 1141591962, i32* %canary
  %len = alloca i32, align 4
  %field_pic_flag = alloca i32, align 4
  %numtmp = alloca float, align 4
  %num_bits_slice_group_change_cycle = alloca i32, align 4
...
if.end239:                                        ; preds = %if.then236, %land.lhs.true232, %if.end229
  %236 = load i32, i32* %len, align 4
  %237 = load i32, i32* %canary
  %238 = icmp eq i32 %237, 1141591962
  br i1 %238, label %239, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_picture_type.13() #0 {
entry:
  %canary = alloca i32
  store i32 759090660, i32* %canary
  %same_slicetype_for_whole_frame = alloca i32, align 4
  %retval = alloca i32, align 4
  store i32 5, i32* %same_slicetype_for_whole_frame, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @SliceHeader.14() #0 {
entry:
  %bottom_field_flag = alloca i32, align 4
  %numtmp = alloca float, align 4
  %canary = alloca i32
  store i32 364695683, i32* %canary
  %dP_nr = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
  %len = alloca i32, align 4
  %currSlice = alloca %struct.Slice*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @Partition_BC_Header.15(i32 %PartNo) #0 {
entry:
  %symbol = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 761283584, i32* %canary
  %partition = alloca %struct.datapartition*, align 8
  %len = alloca i32, align 4
  %sym = alloca %struct.syntaxelement*, align 8
  %PartNo.addr = alloca i32, align 4
...
entry:
  ...
  %num_bits_slice_group_change_cycle = alloca i32, align 4
  %canary = alloca i32
  store i32 973330104, i32* %canary
  %numtmp = alloca float, align 4
  %dP_nr = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
  %len = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @dec_ref_pic_marking.17() #0 {
entry:
  %canary = alloca i32
  store i32 520950478, i32* %canary
  %partition = alloca %struct.datapartition*, align 8
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
  %dP_nr = alloca i32, align 4
  %val = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @ref_pic_list_reordering.18() #0 {
entry:
  %partition = alloca %struct.datapartition*, align 8
  %dP_nr = alloca i32, align 4
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 2087526740, i32* %canary
  %currSlice = alloca %struct.Slice*, align 8
  %len = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @dec_ref_pic_marking.19() #0 {
entry:
  %canary = alloca i32
  store i32 256015098, i32* %canary
  %partition = alloca %struct.datapartition*, align 8
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
  %len = alloca i32, align 4
  %dP_nr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @ref_pic_list_reordering.20() #0 {
entry:
  %currSlice = alloca %struct.Slice*, align 8
  %canary = alloca i32
  store i32 657156066, i32* %canary
  %len = alloca i32, align 4
  %i = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
  %dP_nr = alloca i32, align 4
...
entry:
  ...
  %sym = alloca %struct.syntaxelement*, align 8
  %canary = alloca i32
  store i32 1965847912, i32* %canary
  %len = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
  store i32 %PartNo, i32* %PartNo.addr, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
entry:
  %partition = alloca %struct.datapartition*, align 8
  %canary = alloca i32
  store i32 2038031306, i32* %canary
  %dP_nr = alloca i32, align 4
  %val = alloca i32, align 4
  %len = alloca i32, align 4
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
...
entry:
  ...
  %partition = alloca %struct.datapartition*, align 8
  %canary = alloca i32
  store i32 454381715, i32* %canary
  %override_flag = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
  %1 = load i32, i32* %partition_mode, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @dec_ref_pic_marking.24() #0 {
entry:
  %canary = alloca i32
  store i32 1764378298, i32* %canary
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
  %dP_nr = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
  %val = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 747014947, i32* %canary
  %partition = alloca %struct.datapartition*, align 8
  %j = alloca i32, align 4
  %i = alloca i32, align 4
  %len = alloca i32, align 4
...
entry:
  %len = alloca i32, align 4
  %canary = alloca i32
  store i32 1563438606, i32* %canary
  %partition = alloca %struct.datapartition*, align 8
  %j = alloca i32, align 4
  %i = alloca i32, align 4
  %dP_nr = alloca i32, align 4
...
if.end175:                                        ; preds = %for.end174, %for.end83
  %170 = load i32, i32* %len, align 4
  %171 = load i32, i32* %canary
  %172 = icmp eq i32 %171, 1563438606
  br i1 %172, label %173, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @Partition_BC_Header.27(i32 %PartNo) #0 {
entry:
  %canary = alloca i32
  store i32 1626426517, i32* %canary
  %symbol = alloca %struct.syntaxelement, align 8
  %sym = alloca %struct.syntaxelement*, align 8
  %len = alloca i32, align 4
  %PartNo.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @SliceHeader.28() #0 {
entry:
  %dP_nr = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
  %numtmp = alloca float, align 4
  ...
  %currSlice = alloca %struct.Slice*, align 8
  %canary = alloca i32
  store i32 1261017383, i32* %canary
  %num_bits_slice_group_change_cycle = alloca i32, align 4
  %bottom_field_flag = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
...
if.end239:                                        ; preds = %if.then236, %land.lhs.true232, %if.end229
  %236 = load i32, i32* %len, align 4
  %237 = load i32, i32* %canary
  %238 = icmp eq i32 %237, 1261017383
  br i1 %238, label %239, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @ref_pic_list_reordering.29() #0 {
entry:
  %canary = alloca i32
  store i32 1352937242, i32* %canary
  %currSlice = alloca %struct.Slice*, align 8
  %i = alloca i32, align 4
  %len = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @SliceHeader.30() #0 {
entry:
  %override_flag = alloca i32, align 4
  %currSlice = alloca %struct.Slice*, align 8
  %bottom_field_flag = alloca i32, align 4
  %dP_nr = alloca i32, align 4
  %canary = alloca i32
  store i32 546983179, i32* %canary
  %field_pic_flag = alloca i32, align 4
  %num_bits_slice_group_change_cycle = alloca i32, align 4
  %len = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @dec_ref_pic_marking.31() #0 {
entry:
  %len = alloca i32, align 4
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
  %partition = alloca %struct.datapartition*, align 8
  %dP_nr = alloca i32, align 4
  %canary = alloca i32
  store i32 1646136208, i32* %canary
  %val = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
  %1 = load i32, i32* %partition_mode, align 4
...
entry:
  %field_pic_flag = alloca i32, align 4
  %canary = alloca i32
  store i32 140796751, i32* %canary
  %numtmp = alloca float, align 4
  %currSlice = alloca %struct.Slice*, align 8
  %len = alloca i32, align 4
  %num_bits_slice_group_change_cycle = alloca i32, align 4
...
entry:
  ...
  %currSlice = alloca %struct.Slice*, align 8
  %canary = alloca i32
  store i32 351964656, i32* %canary
  %len = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
  %dP_nr = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @dec_ref_pic_marking.34() #0 {
entry:
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
  %partition = alloca %struct.datapartition*, align 8
  %canary = alloca i32
  store i32 1630072842, i32* %canary
  %dP_nr = alloca i32, align 4
  %val = alloca i32, align 4
  %len = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
entry:
  ...
  %partition = alloca %struct.datapartition*, align 8
  %canary = alloca i32
  store i32 1533158828, i32* %canary
  %val = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
  %1 = load i32, i32* %partition_mode, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @pred_weight_table.36() #0 {
entry:
  %canary = alloca i32
  store i32 298069672, i32* %canary
  %dP_nr = alloca i32, align 4
  %len = alloca i32, align 4
  %i = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @Partition_BC_Header.37(i32 %PartNo) #0 {
entry:
  %PartNo.addr = alloca i32, align 4
  %len = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
  %sym = alloca %struct.syntaxelement*, align 8
  %canary = alloca i32
  store i32 641248452, i32* %canary
  %symbol = alloca %struct.syntaxelement, align 8
  store i32 %PartNo, i32* %PartNo.addr, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %currentSlice = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 50
...
entry:
  ...
  %currSlice = alloca %struct.Slice*, align 8
  %canary = alloca i32
  store i32 1065431271, i32* %canary
  %dP_nr = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
  %len = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
entry:
  %dP_nr = alloca i32, align 4
  %canary = alloca i32
  store i32 1779899021, i32* %canary
  %j = alloca i32, align 4
  %i = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
  %len = alloca i32, align 4
...
if.end175:                                        ; preds = %for.end174, %for.end83
  %170 = load i32, i32* %len, align 4
  %171 = load i32, i32* %canary
  %172 = icmp eq i32 %171, 1779899021
  br i1 %172, label %173, label %func_exit
...
entry:
  %len = alloca i32, align 4
  %canary = alloca i32
  store i32 1274756901, i32* %canary
  %sym = alloca %struct.syntaxelement*, align 8
  %symbol = alloca %struct.syntaxelement, align 8
  %PartNo.addr = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
...
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1205826782, i32* %canary
  %partition = alloca %struct.datapartition*, align 8
  %j = alloca i32, align 4
  %dP_nr = alloca i32, align 4
  %len = alloca i32, align 4
...
if.end175:                                        ; preds = %for.end174, %for.end83
  %170 = load i32, i32* %len, align 4
  %171 = load i32, i32* %canary
  %172 = icmp eq i32 %171, 1205826782
  br i1 %172, label %173, label %func_exit
...
entry:
  %partition = alloca %struct.datapartition*, align 8
  %canary = alloca i32
  store i32 2052230766, i32* %canary
  %len = alloca i32, align 4
  %sym = alloca %struct.syntaxelement*, align 8
  %PartNo.addr = alloca i32, align 4
  %symbol = alloca %struct.syntaxelement, align 8
