; ModuleID = 'mb_access.c.rand.4R1.bc'
...
func_mb_is_available.8:                           ; preds = %ctrl0
  %3 = call i32 @mb_is_available.8(i32 %mbAddr, i32 %currMbAddr)
  ret i32 %3

func_mb_is_available.17:                          ; preds = %ctrl1
  %4 = call i32 @mb_is_available.17(i32 %mbAddr, i32 %currMbAddr)
  ret i32 %4
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_mb_is_available.8, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_mb_is_available.17, label %func_mb_is_available.19
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_CheckAvailabilityOfNeighbors.11, label %func_CheckAvailabilityOfNeighbors.12
...
func_get_mb_block_pos.28:                         ; preds = %ctrl0
  call void @get_mb_block_pos.28(i32 %mb_addr, i32* %x, i32* %y)
  ret void
...
func_get_mb_block_pos.32:                         ; preds = %ctrl1
  call void @get_mb_block_pos.32(i32 %mb_addr, i32* %x, i32* %y)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_get_mb_block_pos.28, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_get_mb_block_pos.31, label %func_get_mb_block_pos.32
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_get_mb_pos.9, label %ctrl0

func_get_mb_pos.9:                                ; preds = %rand_bb
  call void @get_mb_pos.9(i32 %mb_addr, i32* %x, i32* %y)
  ret void

func_get_mb_pos.23:                               ; preds = %ctrl0
  call void @get_mb_pos.23(i32 %mb_addr, i32* %x, i32* %y)
  ret void

func_get_mb_pos.33:                               ; preds = %ctrl1
  call void @get_mb_pos.33(i32 %mb_addr, i32* %x, i32* %y)
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_get_mb_pos.23, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_get_mb_pos.33, label %func_get_mb_pos.34
}
...
func_getNonAffNeighbour.6:                        ; preds = %ctrl0
  call void @getNonAffNeighbour.6(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_getNonAffNeighbour.6, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_getNonAffNeighbour.10, label %func_getNonAffNeighbour.16
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_getAffNeighbour.1, label %ctrl0

func_getAffNeighbour.1:                           ; preds = %rand_bb
  call void @getAffNeighbour.1(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

func_getAffNeighbour.5:                           ; preds = %ctrl0
  call void @getAffNeighbour.5(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

func_getAffNeighbour.14:                          ; preds = %ctrl1
  call void @getAffNeighbour.14(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_getAffNeighbour.5, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_getAffNeighbour.14, label %func_getAffNeighbour.20
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_getNeighbour.4, label %ctrl0

func_getNeighbour.4:                              ; preds = %rand_bb
  call void @getNeighbour.4(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

func_getNeighbour.18:                             ; preds = %ctrl0
  call void @getNeighbour.18(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void
...
func_getNeighbour.30:                             ; preds = %ctrl1
  call void @getNeighbour.30(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_getNeighbour.18, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_getNeighbour.22, label %func_getNeighbour.30
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_getLuma4x4Neighbour.13, label %ctrl0

func_getLuma4x4Neighbour.13:                      ; preds = %rand_bb
  call void @getLuma4x4Neighbour.13(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix)
  ret void

func_getLuma4x4Neighbour.21:                      ; preds = %ctrl0
  call void @getLuma4x4Neighbour.21(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix)
  ret void
...
func_getLuma4x4Neighbour.26:                      ; preds = %ctrl1
  call void @getLuma4x4Neighbour.26(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_getLuma4x4Neighbour.21, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_getLuma4x4Neighbour.25, label %func_getLuma4x4Neighbour.26
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_getChroma4x4Neighbour.15, label %ctrl0

func_getChroma4x4Neighbour.15:                    ; preds = %rand_bb
...
func_getChroma4x4Neighbour.27:                    ; preds = %ctrl1
  call void @getChroma4x4Neighbour.27(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix)
  ret void

func_getChroma4x4Neighbour.29:                    ; preds = %ctrl1
  call void @getChroma4x4Neighbour.29(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix)
  ret void
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_getChroma4x4Neighbour.27, label %func_getChroma4x4Neighbour.29
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getAffNeighbour.1(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 508347586, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1280198504, i32* %canary
...
entry:
  ...
  %currMb = alloca %struct.macroblock*, align 8
  %canary = alloca i32
  store i32 1521089639, i32* %canary
  %maxH = alloca i32, align 4
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
  store i32 %xN, i32* %xN.addr, align 4
  store i32 %yN, i32* %yN.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getNeighbour.4(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix) #0 {
entry:
  %pix.addr = alloca %struct.pix_pos*, align 8
  %curr_mb_nr.addr = alloca i32, align 4
  %yN.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1582054589, i32* %canary
  %luma.addr = alloca i32, align 4
  %xN.addr = alloca i32, align 4
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
  store i32 %xN, i32* %xN.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getAffNeighbour.5(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix) #0 {
entry:
  %currMb = alloca %struct.macroblock*, align 8
  %yN.addr = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
  %canary = alloca i32
  store i32 1680627869, i32* %canary
  %luma.addr = alloca i32, align 4
  %maxW = alloca i32, align 4
  %yM = alloca i32, align 4
  %xN.addr = alloca i32, align 4
...
if.end376:                                        ; preds = %if.end375, %lor.lhs.false, %if.then8, %if.then1
  %309 = load i32, i32* %canary
  %310 = icmp eq i32 %309, 1680627869
  br i1 %310, label %311, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getNonAffNeighbour.6(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix) #0 {
entry:
  %maxW = alloca i32, align 4
  %xN.addr = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
  ...
  %maxH = alloca i32, align 4
  %canary = alloca i32
  store i32 1383823165, i32* %canary
  %luma.addr = alloca i32, align 4
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
  store i32 %xN, i32* %xN.addr, align 4
  store i32 %yN, i32* %yN.addr, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 1037768030, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @mb_is_available.8(i32 %mbAddr, i32 %currMbAddr) #0 {
entry:
  %mbAddr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 414725365, i32* %canary
  %currMbAddr.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  store i32 %mbAddr, i32* %mbAddr.addr, align 4
  store i32 %currMbAddr, i32* %currMbAddr.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 641998272, i32* %canary
  %x.addr = alloca i32*, align 8
  %y.addr = alloca i32*, align 8
  %mb_addr.addr = alloca i32, align 4
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 1524198462, i32* %canary
  %luma.addr = alloca i32, align 4
  %xN.addr = alloca i32, align 4
  %currMb = alloca %struct.macroblock*, align 8
  %maxH = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 853953955, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 992745603, i32* %canary
  %currMB = alloca %struct.macroblock*, align 8
  %mb_nr = alloca i32, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %current_mb_nr = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 3
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getLuma4x4Neighbour.13(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix) #0 {
entry:
  %block_y.addr = alloca i32, align 4
  %rel_y.addr = alloca i32, align 4
  %y = alloca i32, align 4
  %canary = alloca i32
  store i32 59241651, i32* %canary
  %curr_mb_nr.addr = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getAffNeighbour.14(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix) #0 {
entry:
  %canary = alloca i32
  store i32 588560767, i32* %canary
  %currMb = alloca %struct.macroblock*, align 8
  %yM = alloca i32, align 4
  %luma.addr = alloca i32, align 4
  %xN.addr = alloca i32, align 4
...
entry:
  ...
  %rel_y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1940118842, i32* %canary
  %pix.addr = alloca %struct.pix_pos*, align 8
  %block_y.addr = alloca i32, align 4
  %rel_x.addr = alloca i32, align 4
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
...
entry:
  ...
  %pix.addr = alloca %struct.pix_pos*, align 8
  %canary = alloca i32
  store i32 241809646, i32* %canary
  %luma.addr = alloca i32, align 4
  %currMb = alloca %struct.macroblock*, align 8
  %yN.addr = alloca i32, align 4
  %xN.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @mb_is_available.17(i32 %mbAddr, i32 %currMbAddr) #0 {
entry:
  %canary = alloca i32
  store i32 1466453851, i32* %canary
  %retval = alloca i32, align 4
  %mbAddr.addr = alloca i32, align 4
  %currMbAddr.addr = alloca i32, align 4
  store i32 %mbAddr, i32* %mbAddr.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getNeighbour.18(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix) #0 {
entry:
  %yN.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 349245184, i32* %canary
  %luma.addr = alloca i32, align 4
  %curr_mb_nr.addr = alloca i32, align 4
  %xN.addr = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
...
entry:
  %mbAddr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1569796487, i32* %canary
  %retval = alloca i32, align 4
  %currMbAddr.addr = alloca i32, align 4
  store i32 %mbAddr, i32* %mbAddr.addr, align 4
  store i32 %currMbAddr, i32* %currMbAddr.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 360743949, i32* %canary
  %maxH = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
  %currMb = alloca %struct.macroblock*, align 8
  %luma.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getLuma4x4Neighbour.21(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix) #0 {
entry:
  %curr_mb_nr.addr = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
  %rel_y.addr = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 413123074, i32* %canary
  %xN.addr = alloca i32, align 4
  %yN.addr = alloca i32, align 4
  %curr_mb_nr.addr = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
...
entry:
  ...
  %x.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 1973077063, i32* %canary
  %y.addr = alloca i32*, align 8
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
  store i32* %x, i32** %x.addr, align 8
  store i32* %y, i32** %y.addr, align 8
...
entry:
  ...
  %block_x.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 800397015, i32* %canary
  %block_y.addr = alloca i32, align 4
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
  store i32 %block_x, i32* %block_x.addr, align 4
  store i32 %block_y, i32* %block_y.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 799832894, i32* %canary
  %curr_mb_nr.addr = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
  %rel_x.addr = alloca i32, align 4
  %block_x.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getLuma4x4Neighbour.26(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix) #0 {
entry:
  %canary = alloca i32
  store i32 320792600, i32* %canary
  %block_x.addr = alloca i32, align 4
  %block_y.addr = alloca i32, align 4
  %rel_x.addr = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getChroma4x4Neighbour.27(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix) #0 {
entry:
  %canary = alloca i32
  store i32 2132068328, i32* %canary
  %block_y.addr = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
  %block_x.addr = alloca i32, align 4
  %rel_x.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @get_mb_block_pos.28(i32 %mb_addr, i32* %x, i32* %y) #0 {
entry:
  %x.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 784788183, i32* %canary
  %mb_addr.addr = alloca i32, align 4
  %y.addr = alloca i32*, align 8
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
  store i32* %x, i32** %x.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getChroma4x4Neighbour.29(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix) #0 {
entry:
  %y = alloca i32, align 4
  %x = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
  %canary = alloca i32
  store i32 260606988, i32* %canary
  %block_x.addr = alloca i32, align 4
  %block_y.addr = alloca i32, align 4
  %rel_x.addr = alloca i32, align 4
  %curr_mb_nr.addr = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 2123180118, i32* %canary
  %luma.addr = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
  %curr_mb_nr.addr = alloca i32, align 4
  %xN.addr = alloca i32, align 4
...
entry:
  %y.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 1782794405, i32* %canary
  %mb_addr.addr = alloca i32, align 4
  %x.addr = alloca i32*, align 8
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
  store i32* %x, i32** %x.addr, align 8
...
entry:
  %mb_addr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2065092644, i32* %canary
  %x.addr = alloca i32*, align 8
  %y.addr = alloca i32*, align 8
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
  store i32* %x, i32** %x.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @get_mb_pos.33(i32 %mb_addr, i32* %x, i32* %y) #0 {
entry:
  %canary = alloca i32
  store i32 689037679, i32* %canary
  %mb_addr.addr = alloca i32, align 4
  %y.addr = alloca i32*, align 8
  %x.addr = alloca i32*, align 8
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
...
entry:
  %y.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 761479013, i32* %canary
  %mb_addr.addr = alloca i32, align 4
  %x.addr = alloca i32*, align 8
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
  store i32* %x, i32** %x.addr, align 8
