...
# %bb.1:                                # %func_get_LeakyBucketRate.2
	...
	.cfi_def_cfa %rsp, 8
	retq
.LBB0_2:                                # %func_get_LeakyBucketRate.4
	.cfi_def_cfa %rbp, 16
	movq	%rbx, %rdi
	movq	%r14, %rsi
	...
	.cfi_def_cfa %rsp, 8
	retq
.LBB0_3:                                # %func_get_LeakyBucketRate.6
	.cfi_def_cfa %rbp, 16
	movq	%rbx, %rdi
	movq	%r14, %rsi
	...
	.cfi_def_cfa %rsp, 8
	retq
.LBB0_4:                                # %func_get_LeakyBucketRate.8
	.cfi_def_cfa %rbp, 16
	movq	%rbx, %rdi
	movq	%r14, %rsi
...
# %bb.1:                                # %func_PutBigDoubleWord.9
	...
	.cfi_def_cfa %rsp, 8
	retq
.LBB1_2:                                # %func_PutBigDoubleWord.13
	.cfi_def_cfa %rbp, 16
	movq	%rbx, %rdi
	movq	%r14, %rsi
	callq	PutBigDoubleWord.13
	popq	%rbx
	popq	%r14
	popq	%rbp
	.cfi_def_cfa %rsp, 8
...
.LBB2_2:                                # %func_write_buffer.7
	...
	.cfi_def_cfa %rsp, 8
	retq
.LBB2_3:                                # %func_write_buffer.10
	.cfi_def_cfa %rbp, 16
	movq	%rbx, %rdi
	movq	%r12, %rsi
	movq	%r15, %rdx
	movq	%r14, %rcx
	callq	write_buffer.10
	popq	%rbx
	popq	%r12
	popq	%r14
	popq	%r15
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$48, %rsp
	movl	$1053145061, -28(%rbp)  # imm = 0x3EC5B7E5
	movq	%rdi, -40(%rbp)
	movq	%rsi, -16(%rbp)
	movq	$0, -8(%rbp)
.LBB5_1:                                # %for.cond
...
.LBB5_9:                                # %for.inc10
	...
	jmp	.LBB5_1
.LBB5_10:                               # %for.end12
	cmpl	$1053145061, -28(%rbp)  # imm = 0x3EC5B7E5
	jne	.LBB5_12
.LBB5_11:
	addq	$48, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$1369867402, -36(%rbp)  # imm = 0x51A6848A
	movq	%rdi, -64(%rbp)
	movq	%rsi, -48(%rbp)
	movq	input, %rdi
...
.LBB6_9:                                # %return
	movl	-12(%rbp), %ebx
	cmpl	$1369867402, -36(%rbp)  # imm = 0x51A6848A
	jne	.LBB6_11
.LBB6_10:
	movl	%ebx, %eax
	addq	$56, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$128, %rsp
	movl	$723704589, -100(%rbp)  # imm = 0x2B22DB0D
	movq	$0, -120(%rbp)
	movq	stdout, %rdi
	movabsq	$.L.str.8, %rsi
	movb	$0, %al
...
.LBB7_52:                               # %for.end136
	...
	movq	-64(%rbp), %rdi
	callq	free
	cmpl	$723704589, -100(%rbp)  # imm = 0x2B22DB0D
	jne	.LBB7_54
.LBB7_53:
	addq	$128, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$2055979208, -36(%rbp)  # imm = 0x7A8BC0C8
	movq	%rdi, -48(%rbp)
	movq	%rsi, -56(%rbp)
	movq	input, %rdi
	addq	$2480, %rdi             # imm = 0x9B0
...
.LBB8_9:                                # %return
	movl	-12(%rbp), %ebx
	cmpl	$2055979208, -36(%rbp)  # imm = 0x7A8BC0C8
	jne	.LBB8_11
.LBB8_10:
	movl	%ebx, %eax
	addq	$56, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$1900319403, -28(%rbp)  # imm = 0x714492AB
	movq	%rdi, -24(%rbp)
	movq	%rsi, -40(%rbp)
	movq	%rdx, -56(%rbp)
	movq	%rcx, -48(%rbp)
...
.LBB9_6:                                # %for.end
	movq	-16(%rbp), %rdi
	callq	fclose
	cmpl	$1900319403, -28(%rbp)  # imm = 0x714492AB
	jne	.LBB9_8
.LBB9_7:
	addq	$64, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$469498936, -36(%rbp)   # imm = 0x1BFBFC38
	movq	%rdi, -56(%rbp)
	movq	%rsi, -48(%rbp)
	movq	input, %rdi
	addq	$2480, %rdi             # imm = 0x9B0
...
.LBB10_9:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$469498936, -36(%rbp)   # imm = 0x1BFBFC38
	jne	.LBB10_11
.LBB10_10:
	movl	%ebx, %eax
	addq	$56, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$374692723, -28(%rbp)   # imm = 0x16555B73
	movq	%rdi, -24(%rbp)
	movq	%rsi, -48(%rbp)
	movq	%rdx, -56(%rbp)
	movq	%rcx, -40(%rbp)
...
.LBB11_6:                               # %for.end
	movq	-16(%rbp), %rdi
	callq	fclose
	cmpl	$374692723, -28(%rbp)   # imm = 0x16555B73
	jne	.LBB11_8
.LBB11_7:
	addq	$64, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$674381145, -36(%rbp)   # imm = 0x28323D59
	movq	%rdi, -64(%rbp)
	movq	%rsi, -48(%rbp)
	movq	input, %rdi
	addq	$2480, %rdi             # imm = 0x9B0
...
.LBB12_9:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$674381145, -36(%rbp)   # imm = 0x28323D59
	jne	.LBB12_11
.LBB12_10:
	movl	%ebx, %eax
	addq	$56, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$2117088680, -20(%rbp)  # imm = 0x7E3035A8
	movq	%rdi, -8(%rbp)
	movq	%rsi, -16(%rbp)
	movq	-8(%rbp), %rdi
	shrq	$24, %rdi
	...
	movq	-16(%rbp), %rsi
                                        # kill: def $edi killed $edi killed $rdi
	callq	fputc
	cmpl	$2117088680, -20(%rbp)  # imm = 0x7E3035A8
	jne	.LBB13_2
.LBB13_1:
	addq	$32, %rsp
	popq	%rbp
...
.Lfunc_end13:
	...
	.cfi_endproc
                                        # -- End function
	.globl	write_buffer.10         # -- Begin function write_buffer.10
	.p2align	4, 0x90
	.type	write_buffer.10,@function
write_buffer.10:                        # @write_buffer.10
	.cfi_startproc
# %bb.0:                                # %entry
	pushq	%rbp
	.cfi_def_cfa_offset 16
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$737829116, -28(%rbp)   # imm = 0x2BFA60FC
	movq	%rdi, -24(%rbp)
	movq	%rsi, -40(%rbp)
	movq	%rdx, -48(%rbp)
	movq	%rcx, -56(%rbp)
...
.LBB14_6:                               # %for.end
	movq	-16(%rbp), %rdi
	callq	fclose
	cmpl	$737829116, -28(%rbp)   # imm = 0x2BFA60FC
	jne	.LBB14_8
.LBB14_7:
	addq	$64, %rsp
	popq	%rbp
...
.LBB14_8:                               # %func_exit
	...
	jmp	.LBB14_7
.Lfunc_end14:
	.size	write_buffer.10, .Lfunc_end14-write_buffer.10
	.cfi_endproc
                                        # -- End function
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$486228339, -28(%rbp)   # imm = 0x1CFB4173
	movq	%rdi, -24(%rbp)
	movq	%rsi, -56(%rbp)
	movq	%rdx, -40(%rbp)
	movq	%rcx, -48(%rbp)
...
.LBB15_6:                               # %for.end
	movq	-16(%rbp), %rdi
	callq	fclose
	cmpl	$486228339, -28(%rbp)   # imm = 0x1CFB4173
	jne	.LBB15_8
.LBB15_7:
	addq	$64, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$48, %rsp
	movl	$1997989332, -28(%rbp)  # imm = 0x7716E5D4
	movq	%rdi, -40(%rbp)
	movq	%rsi, -16(%rbp)
	movq	$0, -8(%rbp)
.LBB16_1:                               # %for.cond
...
.LBB16_9:                               # %for.inc10
	...
	jmp	.LBB16_1
.LBB16_10:                              # %for.end12
	cmpl	$1997989332, -28(%rbp)  # imm = 0x7716E5D4
	jne	.LBB16_12
.LBB16_11:
	addq	$48, %rsp
	popq	%rbp
...
.Lfunc_end16:
	...
	.cfi_endproc
                                        # -- End function
	.globl	PutBigDoubleWord.13     # -- Begin function PutBigDoubleWord.13
	.p2align	4, 0x90
	.type	PutBigDoubleWord.13,@function
PutBigDoubleWord.13:                    # @PutBigDoubleWord.13
	.cfi_startproc
# %bb.0:                                # %entry
	pushq	%rbp
	.cfi_def_cfa_offset 16
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$618083024, -20(%rbp)   # imm = 0x24D732D0
	movq	%rdi, -16(%rbp)
	movq	%rsi, -8(%rbp)
	movq	-16(%rbp), %rdi
	shrq	$24, %rdi
	...
	movq	-8(%rbp), %rsi
                                        # kill: def $edi killed $edi killed $rdi
	callq	fputc
	cmpl	$618083024, -20(%rbp)   # imm = 0x24D732D0
	jne	.LBB17_2
.LBB17_1:
	addq	$32, %rsp
	popq	%rbp
...
.LBB17_2:                               # %func_exit
	...
	jmp	.LBB17_1
.Lfunc_end17:
	.size	PutBigDoubleWord.13, .Lfunc_end17-PutBigDoubleWord.13
	.cfi_endproc
                                        # -- End function
	.section	.rodata.cst4,"aM",@progbits,4
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$128, %rsp
	movl	$409447304, -100(%rbp)  # imm = 0x1867AB88
	movq	$0, -120(%rbp)
	movq	stdout, %rdi
	movabsq	$.L.str.8, %rsi
	movb	$0, %al
...
.LBB18_52:                              # %for.end136
	...
	movq	-64(%rbp), %rdi
	callq	free
	cmpl	$409447304, -100(%rbp)  # imm = 0x1867AB88
	jne	.LBB18_54
.LBB18_53:
	addq	$128, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$48, %rsp
	movl	$1290851450, -28(%rbp)  # imm = 0x4CF0D47A
	movq	%rdi, -40(%rbp)
	movq	%rsi, -16(%rbp)
	movq	$0, -8(%rbp)
.LBB19_1:                               # %for.cond
...
.LBB19_9:                               # %for.inc10
	...
	jmp	.LBB19_1
.LBB19_10:                              # %for.end12
	cmpl	$1290851450, -28(%rbp)  # imm = 0x4CF0D47A
	jne	.LBB19_12
.LBB19_11:
	addq	$48, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$48, %rsp
	movl	$528421604, -28(%rbp)   # imm = 0x1F7F12E4
	movq	%rdi, -40(%rbp)
	movq	%rsi, -24(%rbp)
	movq	$0, -8(%rbp)
.LBB20_1:                               # %for.cond
...
.LBB20_9:                               # %for.inc10
	...
	jmp	.LBB20_1
.LBB20_10:                              # %for.end12
	cmpl	$528421604, -28(%rbp)   # imm = 0x1F7F12E4
	jne	.LBB20_12
.LBB20_11:
	addq	$48, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$128, %rsp
	movl	$412526053, -100(%rbp)  # imm = 0x1896A5E5
	movq	$0, -112(%rbp)
	movq	stdout, %rdi
	movabsq	$.L.str.8, %rsi
	movb	$0, %al
...
.LBB21_52:                              # %for.end136
	...
	movq	-64(%rbp), %rdi
	callq	free
	cmpl	$412526053, -100(%rbp)  # imm = 0x1896A5E5
	jne	.LBB21_54
.LBB21_53:
	addq	$128, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$128, %rsp
	movl	$1595359734, -100(%rbp) # imm = 0x5F1741F6
	movq	$0, -112(%rbp)
	movq	stdout, %rdi
	movabsq	$.L.str.8, %rsi
	movb	$0, %al
...
.LBB22_52:                              # %for.end136
	...
	movq	-72(%rbp), %rdi
	callq	free
	cmpl	$1595359734, -100(%rbp) # imm = 0x5F1741F6
	jne	.LBB22_54
.LBB22_53:
	addq	$128, %rsp
	popq	%rbp
