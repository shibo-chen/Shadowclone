; ModuleID = 'biariencode.c.rand.8R3.bc'
...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_arienco_start_encoding.3, label %ctrl0

func_arienco_start_encoding.3:                    ; preds = %rand_bb
  call void @arienco_start_encoding.3(%struct.EncodingEnvironment* %eep, i8* %code_buffer, i32* %code_len, i32 %slice_type)
  ret void

func_arienco_start_encoding.7:                    ; preds = %ctrl0
  call void @arienco_start_encoding.7(%struct.EncodingEnvironment* %eep, i8* %code_buffer, i32* %code_len, i32 %slice_type)
  ret void

func_arienco_start_encoding.8:                    ; preds = %ctrl1
  call void @arienco_start_encoding.8(%struct.EncodingEnvironment* %eep, i8* %code_buffer, i32* %code_len, i32 %slice_type)
  ret void

func_arienco_start_encoding.21:                   ; preds = %ctrl2
  call void @arienco_start_encoding.21(%struct.EncodingEnvironment* %eep, i8* %code_buffer, i32* %code_len, i32 %slice_type)
  ret void

func_arienco_start_encoding.25:                   ; preds = %ctrl3
  call void @arienco_start_encoding.25(%struct.EncodingEnvironment* %eep, i8* %code_buffer, i32* %code_len, i32 %slice_type)
  ret void

func_arienco_start_encoding.31:                   ; preds = %ctrl4
  call void @arienco_start_encoding.31(%struct.EncodingEnvironment* %eep, i8* %code_buffer, i32* %code_len, i32 %slice_type)
  ret void

func_arienco_start_encoding.34:                   ; preds = %ctrl5
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_arienco_start_encoding.7, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_arienco_start_encoding.8, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_arienco_start_encoding.21, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_arienco_start_encoding.25, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_arienco_start_encoding.31, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_arienco_start_encoding.34, label %func_arienco_start_encoding.35
}
...
func_biari_encode_symbol.4:                       ; preds = %ctrl0
  call void @biari_encode_symbol.4(%struct.EncodingEnvironment* %eep, i16 %symbol, %struct.BiContextType* %bi_ct)
  ret void
...
func_biari_encode_symbol.33:                      ; preds = %ctrl5
  call void @biari_encode_symbol.33(%struct.EncodingEnvironment* %eep, i16 %symbol, %struct.BiContextType* %bi_ct)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_biari_encode_symbol.4, label %ctrl1
...
ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_biari_encode_symbol.10, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_biari_encode_symbol.19, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_biari_encode_symbol.24, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_biari_encode_symbol.29, label %func_biari_encode_symbol.33
}
...
func_biari_encode_symbol_eq_prob.22:              ; preds = %ctrl1
  call void @biari_encode_symbol_eq_prob.22(%struct.EncodingEnvironment* %eep, i16 %symbol)
  ret void

func_biari_encode_symbol_eq_prob.27:              ; preds = %ctrl2
  call void @biari_encode_symbol_eq_prob.27(%struct.EncodingEnvironment* %eep, i16 %symbol)
  ret void
...
func_biari_encode_symbol_eq_prob.36:              ; preds = %ctrl3
  call void @biari_encode_symbol_eq_prob.36(%struct.EncodingEnvironment* %eep, i16 %symbol)
  ret void
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_biari_encode_symbol_eq_prob.22, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_biari_encode_symbol_eq_prob.27, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_biari_encode_symbol_eq_prob.28, label %func_biari_encode_symbol_eq_prob.36
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_biari_encode_symbol_final.9, label %ctrl0

func_biari_encode_symbol_final.9:                 ; preds = %rand_bb
  call void @biari_encode_symbol_final.9(%struct.EncodingEnvironment* %eep, i16 %symbol)
  ret void

func_biari_encode_symbol_final.14:                ; preds = %ctrl0
  call void @biari_encode_symbol_final.14(%struct.EncodingEnvironment* %eep, i16 %symbol)
  ret void

func_biari_encode_symbol_final.17:                ; preds = %ctrl1
  call void @biari_encode_symbol_final.17(%struct.EncodingEnvironment* %eep, i16 %symbol)
  ret void

func_biari_encode_symbol_final.20:                ; preds = %ctrl2
  call void @biari_encode_symbol_final.20(%struct.EncodingEnvironment* %eep, i16 %symbol)
  ret void

func_biari_encode_symbol_final.23:                ; preds = %ctrl3
  call void @biari_encode_symbol_final.23(%struct.EncodingEnvironment* %eep, i16 %symbol)
  ret void

func_biari_encode_symbol_final.26:                ; preds = %ctrl4
  call void @biari_encode_symbol_final.26(%struct.EncodingEnvironment* %eep, i16 %symbol)
  ret void

func_biari_encode_symbol_final.30:                ; preds = %ctrl5
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_biari_encode_symbol_final.14, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_biari_encode_symbol_final.17, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_biari_encode_symbol_final.20, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_biari_encode_symbol_final.23, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_biari_encode_symbol_final.26, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_biari_encode_symbol_final.30, label %func_biari_encode_symbol_final.32
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_biari_init_context.5, label %ctrl0

func_biari_init_context.5:                        ; preds = %rand_bb
  call void @biari_init_context.5(%struct.BiContextType* %ctx, i32* %ini)
  ret void

func_biari_init_context.11:                       ; preds = %ctrl0
  call void @biari_init_context.11(%struct.BiContextType* %ctx, i32* %ini)
  ret void

func_biari_init_context.12:                       ; preds = %ctrl1
  call void @biari_init_context.12(%struct.BiContextType* %ctx, i32* %ini)
  ret void

func_biari_init_context.13:                       ; preds = %ctrl2
  call void @biari_init_context.13(%struct.BiContextType* %ctx, i32* %ini)
  ret void

func_biari_init_context.15:                       ; preds = %ctrl3
  call void @biari_init_context.15(%struct.BiContextType* %ctx, i32* %ini)
  ret void

func_biari_init_context.16:                       ; preds = %ctrl3
  call void @biari_init_context.16(%struct.BiContextType* %ctx, i32* %ini)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_biari_init_context.11, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_biari_init_context.12, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_biari_init_context.13, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_biari_init_context.15, label %func_biari_init_context.16
}
...
entry:
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 898476680, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 309074260, i32* %canary
  %symbol.addr = alloca i16, align 2
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @arienco_start_encoding.3(%struct.EncodingEnvironment* %eep, i8* %code_buffer, i32* %code_len, i32 %slice_type) #0 {
entry:
  %code_len.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 477530944, i32* %canary
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_encode_symbol.4(%struct.EncodingEnvironment* %eep, i16 signext %symbol, %struct.BiContextType* %bi_ct) #0 {
entry:
  %bi_ct.addr = alloca %struct.BiContextType*, align 8
  %range = alloca i32, align 4
  %symbol.addr = alloca i16, align 2
  ...
  %low = alloca i32, align 4
  %canary = alloca i32
  store i32 1125363018, i32* %canary
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
  store %struct.BiContextType* %bi_ct, %struct.BiContextType** %bi_ct.addr, align 8
...
while.end162:                                     ; preds = %while.cond
  ...
  store i32 %inc166, i32* %C165, align 8
  %136 = load i32, i32* %canary
  %137 = icmp eq i32 %136, 1125363018
  br i1 %137, label %138, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_init_context.5(%struct.BiContextType* %ctx, i32* %ini) #0 {
entry:
  %ini.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 2025592679, i32* %canary
...
entry:
  ...
  %bi_ct.addr = alloca %struct.BiContextType*, align 8
  %canary = alloca i32
  store i32 1545844081, i32* %canary
  %symbol.addr = alloca i16, align 2
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
  store %struct.BiContextType* %bi_ct, %struct.BiContextType** %bi_ct.addr, align 8
...
while.end162:                                     ; preds = %while.cond
  ...
  store i32 %inc166, i32* %C165, align 8
  %136 = load i32, i32* %canary
  %137 = icmp eq i32 %136, 1545844081
  br i1 %137, label %138, label %func_exit
...
entry:
  %canary = alloca i32
  store i32 2109760230, i32* %canary
  %code_len.addr = alloca i32*, align 8
  %slice_type.addr = alloca i32, align 4
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %code_buffer.addr = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @arienco_start_encoding.8(%struct.EncodingEnvironment* %eep, i8* %code_buffer, i32* %code_len, i32 %slice_type) #0 {
entry:
  %canary = alloca i32
  store i32 405192202, i32* %canary
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %code_len.addr = alloca i32*, align 8
  %code_buffer.addr = alloca i8*, align 8
  %slice_type.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_encode_symbol_final.9(%struct.EncodingEnvironment* %eep, i16 signext %symbol) #0 {
entry:
  %low = alloca i32, align 4
  %canary = alloca i32
  store i32 2047495108, i32* %canary
  %range = alloca i32, align 4
  %symbol.addr = alloca i16, align 2
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
...
while.end125:                                     ; preds = %while.cond
  ...
  %111 = icmp eq i32 %110, 2047495108
...
entry:
  ...
  %range = alloca i32, align 4
  %canary = alloca i32
  store i32 124837503, i32* %canary
  %bi_ct.addr = alloca %struct.BiContextType*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
  store %struct.BiContextType* %bi_ct, %struct.BiContextType** %bi_ct.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_init_context.11(%struct.BiContextType* %ctx, i32* %ini) #0 {
entry:
  %ctx.addr = alloca %struct.BiContextType*, align 8
  %ini.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 1275171576, i32* %canary
  %pstate = alloca i32, align 4
  store %struct.BiContextType* %ctx, %struct.BiContextType** %ctx.addr, align 8
  store i32* %ini, i32** %ini.addr, align 8
  %0 = load i32*, i32** %ini.addr, align 8
...
entry:
  %pstate = alloca i32, align 4
  %canary = alloca i32
  store i32 506155021, i32* %canary
  %ctx.addr = alloca %struct.BiContextType*, align 8
  %ini.addr = alloca i32*, align 8
  store %struct.BiContextType* %ctx, %struct.BiContextType** %ctx.addr, align 8
  store i32* %ini, i32** %ini.addr, align 8
...
entry:
  %pstate = alloca i32, align 4
  %canary = alloca i32
  store i32 841485642, i32* %canary
  %ini.addr = alloca i32*, align 8
  %ctx.addr = alloca %struct.BiContextType*, align 8
  store %struct.BiContextType* %ctx, %struct.BiContextType** %ctx.addr, align 8
  store i32* %ini, i32** %ini.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_encode_symbol_final.14(%struct.EncodingEnvironment* %eep, i16 signext %symbol) #0 {
entry:
  %symbol.addr = alloca i16, align 2
  %canary = alloca i32
  store i32 1932682827, i32* %canary
  %range = alloca i32, align 4
  %low = alloca i32, align 4
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
...
while.end125:                                     ; preds = %while.cond
  ...
  store i32 %inc129, i32* %C128, align 8
  %110 = load i32, i32* %canary
  %111 = icmp eq i32 %110, 1932682827
  br i1 %111, label %112, label %func_exit
...
entry:
  %ini.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 1229766110, i32* %canary
  %ctx.addr = alloca %struct.BiContextType*, align 8
  %pstate = alloca i32, align 4
  store %struct.BiContextType* %ctx, %struct.BiContextType** %ctx.addr, align 8
  store i32* %ini, i32** %ini.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_encode_symbol_final.17(%struct.EncodingEnvironment* %eep, i16 signext %symbol) #0 {
entry:
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %range = alloca i32, align 4
  %symbol.addr = alloca i16, align 2
  %canary = alloca i32
  store i32 1686714932, i32* %canary
  %low = alloca i32, align 4
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
  %0 = load %struct.EncodingEnvironment*, %struct.EncodingEnvironment** %eep.addr, align 8
...
while.end125:                                     ; preds = %while.cond
  ...
  store i32 %inc129, i32* %C128, align 8
  %110 = load i32, i32* %canary
  %111 = icmp eq i32 %110, 1686714932
  br i1 %111, label %112, label %func_exit
...
entry:
  %canary = alloca i32
  store i32 1605288085, i32* %canary
  %low = alloca i32, align 4
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %symbol.addr = alloca i16, align 2
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
...
if.end124:                                        ; preds = %if.end123, %while.end51
  ...
  store i32 %inc127, i32* %C126, align 8
  %104 = load i32, i32* %canary
  %105 = icmp eq i32 %104, 1605288085
  br i1 %105, label %106, label %func_exit
...
entry:
  ...
  %bi_ct.addr = alloca %struct.BiContextType*, align 8
  %canary = alloca i32
  store i32 566095765, i32* %canary
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %symbol.addr = alloca i16, align 2
  %range = alloca i32, align 4
  %low = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_encode_symbol_final.20(%struct.EncodingEnvironment* %eep, i16 signext %symbol) #0 {
entry:
  %canary = alloca i32
  store i32 1694209719, i32* %canary
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %symbol.addr = alloca i16, align 2
  %range = alloca i32, align 4
  %low = alloca i32, align 4
...
while.end125:                                     ; preds = %while.cond
  ...
  store i32 %inc129, i32* %C128, align 8
  %110 = load i32, i32* %canary
  %111 = icmp eq i32 %110, 1694209719
  br i1 %111, label %112, label %func_exit
...
entry:
  %slice_type.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 554471635, i32* %canary
  %code_len.addr = alloca i32*, align 8
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %code_buffer.addr = alloca i8*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_encode_symbol_eq_prob.22(%struct.EncodingEnvironment* %eep, i16 signext %symbol) #0 {
entry:
  %canary = alloca i32
  store i32 1911610263, i32* %canary
  %symbol.addr = alloca i16, align 2
  %low = alloca i32, align 4
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
...
if.end124:                                        ; preds = %if.end123, %while.end51
  ...
  store i32 %inc127, i32* %C126, align 8
  %104 = load i32, i32* %canary
  %105 = icmp eq i32 %104, 1911610263
  br i1 %105, label %106, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_encode_symbol_final.23(%struct.EncodingEnvironment* %eep, i16 signext %symbol) #0 {
entry:
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 1074318354, i32* %canary
  %low = alloca i32, align 4
  %symbol.addr = alloca i16, align 2
  %range = alloca i32, align 4
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
...
while.end125:                                     ; preds = %while.cond
  ...
  store i32 %inc129, i32* %C128, align 8
  %110 = load i32, i32* %canary
  %111 = icmp eq i32 %110, 1074318354
  br i1 %111, label %112, label %func_exit
...
entry:
  ...
  %range = alloca i32, align 4
  %canary = alloca i32
  store i32 1142685913, i32* %canary
  %low = alloca i32, align 4
  %symbol.addr = alloca i16, align 2
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
...
while.end162:                                     ; preds = %while.cond
  ...
  store i32 %inc166, i32* %C165, align 8
  %136 = load i32, i32* %canary
  %137 = icmp eq i32 %136, 1142685913
  br i1 %137, label %138, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @arienco_start_encoding.25(%struct.EncodingEnvironment* %eep, i8* %code_buffer, i32* %code_len, i32 %slice_type) #0 {
entry:
  %code_buffer.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1137178692, i32* %canary
  %code_len.addr = alloca i32*, align 8
  %slice_type.addr = alloca i32, align 4
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_encode_symbol_final.26(%struct.EncodingEnvironment* %eep, i16 signext %symbol) #0 {
entry:
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %low = alloca i32, align 4
  %canary = alloca i32
  store i32 1316142515, i32* %canary
  %range = alloca i32, align 4
  %symbol.addr = alloca i16, align 2
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
...
while.end125:                                     ; preds = %while.cond
  ...
  store i32 %inc129, i32* %C128, align 8
  %110 = load i32, i32* %canary
  %111 = icmp eq i32 %110, 1316142515
  br i1 %111, label %112, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_encode_symbol_eq_prob.27(%struct.EncodingEnvironment* %eep, i16 signext %symbol) #0 {
entry:
  %canary = alloca i32
  store i32 403704403, i32* %canary
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %symbol.addr = alloca i16, align 2
  %low = alloca i32, align 4
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
...
entry:
  %symbol.addr = alloca i16, align 2
  %canary = alloca i32
  store i32 1597004399, i32* %canary
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %low = alloca i32, align 4
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
...
if.end124:                                        ; preds = %if.end123, %while.end51
  ...
  store i32 %inc127, i32* %C126, align 8
  %104 = load i32, i32* %canary
  %105 = icmp eq i32 %104, 1597004399
  br i1 %105, label %106, label %func_exit
...
entry:
  ...
  %range = alloca i32, align 4
  %canary = alloca i32
  store i32 1529171747, i32* %canary
  %low = alloca i32, align 4
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
  %0 = load %struct.EncodingEnvironment*, %struct.EncodingEnvironment** %eep.addr, align 8
...
while.end125:                                     ; preds = %while.cond
  ...
  store i32 %inc129, i32* %C128, align 8
  %110 = load i32, i32* %canary
  %111 = icmp eq i32 %110, 1529171747
  br i1 %111, label %112, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @arienco_start_encoding.31(%struct.EncodingEnvironment* %eep, i8* %code_buffer, i32* %code_len, i32 %slice_type) #0 {
entry:
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 32780830, i32* %canary
  %code_buffer.addr = alloca i8*, align 8
  %slice_type.addr = alloca i32, align 4
  %code_len.addr = alloca i32*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
...
entry:
  ...
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 1304264107, i32* %canary
  %symbol.addr = alloca i16, align 2
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
  %0 = load %struct.EncodingEnvironment*, %struct.EncodingEnvironment** %eep.addr, align 8
...
while.end125:                                     ; preds = %while.cond
  ...
  store i32 %inc129, i32* %C128, align 8
  %110 = load i32, i32* %canary
  %111 = icmp eq i32 %110, 1304264107
  br i1 %111, label %112, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_encode_symbol.33(%struct.EncodingEnvironment* %eep, i16 signext %symbol, %struct.BiContextType* %bi_ct) #0 {
entry:
  %canary = alloca i32
  store i32 2032334201, i32* %canary
  %bi_ct.addr = alloca %struct.BiContextType*, align 8
  %low = alloca i32, align 4
  %rLPS = alloca i32, align 4
  %symbol.addr = alloca i16, align 2
...
while.end162:                                     ; preds = %while.cond
  ...
  store i32 %inc166, i32* %C165, align 8
  %136 = load i32, i32* %canary
  %137 = icmp eq i32 %136, 2032334201
  br i1 %137, label %138, label %func_exit
...
entry:
  %canary = alloca i32
  store i32 471447829, i32* %canary
  %code_len.addr = alloca i32*, align 8
  %code_buffer.addr = alloca i8*, align 8
  %slice_type.addr = alloca i32, align 4
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
...
entry:
  ...
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 446193649, i32* %canary
  %slice_type.addr = alloca i32, align 4
  %code_buffer.addr = alloca i8*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i8* %code_buffer, i8** %code_buffer.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_encode_symbol_eq_prob.36(%struct.EncodingEnvironment* %eep, i16 signext %symbol) #0 {
entry:
  %canary = alloca i32
  store i32 312827758, i32* %canary
  %low = alloca i32, align 4
  %symbol.addr = alloca i16, align 2
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
