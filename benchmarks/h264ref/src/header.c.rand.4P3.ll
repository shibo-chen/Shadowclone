...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_SliceHeader.15, label %ctrl0

func_SliceHeader.15:                              ; preds = %rand_bb
  %2 = call i32 @SliceHeader.15()
  ret i32 %2

func_SliceHeader.20:                              ; preds = %ctrl0
  %3 = call i32 @SliceHeader.20()
  ret i32 %3
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_SliceHeader.20, label %ctrl1
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_get_picture_type.7, label %func_get_picture_type.11

func_get_picture_type.7:                          ; preds = %rand_bb
  %2 = call i32 @get_picture_type.7()
  ret i32 %2

func_get_picture_type.11:                         ; preds = %rand_bb
  %3 = call i32 @get_picture_type.11()
  ret i32 %3
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_Partition_BC_Header.2, label %ctrl0

func_Partition_BC_Header.2:                       ; preds = %rand_bb
  %2 = call i32 @Partition_BC_Header.2(i32 %PartNo)
  ret i32 %2
...
func_Partition_BC_Header.13:                      ; preds = %ctrl1
  %4 = call i32 @Partition_BC_Header.13(i32 %PartNo)
  ret i32 %4
...
ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_Partition_BC_Header.13, label %func_Partition_BC_Header.17
}
...
func_ref_pic_list_reordering.12:                  ; preds = %ctrl0
  %3 = call i32 @ref_pic_list_reordering.12()
  ret i32 %3

func_ref_pic_list_reordering.18:                  ; preds = %ctrl1
  %4 = call i32 @ref_pic_list_reordering.18()
  ret i32 %4
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_ref_pic_list_reordering.12, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_ref_pic_list_reordering.18, label %func_ref_pic_list_reordering.19
}
...
func_dec_ref_pic_marking.6:                       ; preds = %ctrl1
  %4 = call i32 @dec_ref_pic_marking.6()
  ret i32 %4

func_dec_ref_pic_marking.10:                      ; preds = %ctrl1
  %5 = call i32 @dec_ref_pic_marking.10()
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_dec_ref_pic_marking.5, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_dec_ref_pic_marking.6, label %func_dec_ref_pic_marking.10
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_pred_weight_table.1, label %ctrl0

func_pred_weight_table.1:                         ; preds = %rand_bb
  %2 = call i32 @pred_weight_table.1()
  ret i32 %2

func_pred_weight_table.8:                         ; preds = %ctrl0
  %3 = call i32 @pred_weight_table.8()
  ret i32 %3
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_pred_weight_table.8, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_pred_weight_table.14, label %func_pred_weight_table.16
}

; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @pred_weight_table.1() #0 {
entry:
  ...
  %canary = alloca i32
  store i32 1257903441, i32* %canary
...
if.end175:                                        ; preds = %for.end174, %for.end83
  ...
  %172 = icmp eq i32 %171, 1257903441
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @Partition_BC_Header.2(i32 %PartNo) #0 {
entry:
  %partition = alloca %struct.datapartition*, align 8
  ...
  %canary = alloca i32
  store i32 1644929101, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1885612565, i32* %canary
  %len = alloca i32, align 4
...
entry:
  ...
  %dP_nr = alloca i32, align 4
  %canary = alloca i32
  store i32 746073963, i32* %canary
  %partition = alloca %struct.datapartition*, align 8
  %i = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
...
entry:
  ...
  %val = alloca i32, align 4
  %canary = alloca i32
  store i32 1807876221, i32* %canary
  %len = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
  %1 = load i32, i32* %partition_mode, align 4
...
entry:
  %val = alloca i32, align 4
  %canary = alloca i32
  store i32 1142858256, i32* %canary
  %dP_nr = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
  %len = alloca i32, align 4
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
...
entry:
  %canary = alloca i32
  store i32 490120906, i32* %canary
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
  %len = alloca i32, align 4
...
entry:
  ...
  %partition = alloca %struct.datapartition*, align 8
  %canary = alloca i32
  store i32 1358525035, i32* %canary
  %len = alloca i32, align 4
  %sym = alloca %struct.syntaxelement*, align 8
  store i32 %PartNo, i32* %PartNo.addr, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
entry:
  ...
  %partition = alloca %struct.datapartition*, align 8
  %canary = alloca i32
  store i32 727722297, i32* %canary
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
  %dP_nr = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_picture_type.11() #0 {
entry:
  %canary = alloca i32
  store i32 1631583483, i32* %canary
  %same_slicetype_for_whole_frame = alloca i32, align 4
  %retval = alloca i32, align 4
  store i32 5, i32* %same_slicetype_for_whole_frame, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @ref_pic_list_reordering.12() #0 {
entry:
  %partition = alloca %struct.datapartition*, align 8
  %len = alloca i32, align 4
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 622040864, i32* %canary
  %currSlice = alloca %struct.Slice*, align 8
  %dP_nr = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
...
entry:
  ...
  %PartNo.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 339197212, i32* %canary
  %symbol = alloca %struct.syntaxelement, align 8
  %partition = alloca %struct.datapartition*, align 8
  %sym = alloca %struct.syntaxelement*, align 8
  store i32 %PartNo, i32* %PartNo.addr, align 4
...
entry:
  %partition = alloca %struct.datapartition*, align 8
  %canary = alloca i32
  store i32 1966918707, i32* %canary
  %i = alloca i32, align 4
  %dP_nr = alloca i32, align 4
  %len = alloca i32, align 4
  %j = alloca i32, align 4
...
if.end175:                                        ; preds = %for.end174, %for.end83
  %170 = load i32, i32* %len, align 4
  %171 = load i32, i32* %canary
  %172 = icmp eq i32 %171, 1966918707
  br i1 %172, label %173, label %func_exit
...
entry:
  ...
  %currSlice = alloca %struct.Slice*, align 8
  %canary = alloca i32
  store i32 1629619250, i32* %canary
...
if.end239:                                        ; preds = %if.then236, %land.lhs.true232, %if.end229
  ...
  %238 = icmp eq i32 %237, 1629619250
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1480235239, i32* %canary
  %j = alloca i32, align 4
  %len = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
...
if.end175:                                        ; preds = %for.end174, %for.end83
  %170 = load i32, i32* %len, align 4
  %171 = load i32, i32* %canary
  %172 = icmp eq i32 %171, 1480235239
  br i1 %172, label %173, label %func_exit
...
entry:
  %canary = alloca i32
  store i32 755515764, i32* %canary
  %partition = alloca %struct.datapartition*, align 8
  %symbol = alloca %struct.syntaxelement, align 8
  %PartNo.addr = alloca i32, align 4
  %len = alloca i32, align 4
...
entry:
  ...
  %currSlice = alloca %struct.Slice*, align 8
  %canary = alloca i32
  store i32 1277721917, i32* %canary
  %partition = alloca %struct.datapartition*, align 8
  %i = alloca i32, align 4
  %dP_nr = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
entry:
  %canary = alloca i32
  store i32 587824114, i32* %canary
  %len = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
  %i = alloca i32, align 4
  %dP_nr = alloca i32, align 4
...
entry:
  ...
  %numtmp = alloca float, align 4
  %canary = alloca i32
  store i32 360308721, i32* %canary
  %currSlice = alloca %struct.Slice*, align 8
  %len = alloca i32, align 4
  %dP_nr = alloca i32, align 4
  %num_bits_slice_group_change_cycle = alloca i32, align 4
...
entry:
  ...
  %bottom_field_flag = alloca i32, align 4
  %canary = alloca i32
  store i32 1462350865, i32* %canary
  %numtmp = alloca float, align 4
  %num_bits_slice_group_change_cycle = alloca i32, align 4
  %dP_nr = alloca i32, align 4
  %len = alloca i32, align 4
...
if.end239:                                        ; preds = %if.then236, %land.lhs.true232, %if.end229
  %236 = load i32, i32* %len, align 4
  %237 = load i32, i32* %canary
  %238 = icmp eq i32 %237, 1462350865
  br i1 %238, label %239, label %func_exit
...
entry:
  ...
  %dP_nr = alloca i32, align 4
  %canary = alloca i32
  store i32 737954044, i32* %canary
  %currSlice = alloca %struct.Slice*, align 8
  %bottom_field_flag = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
  %override_flag = alloca i32, align 4
