...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$1910475137, -32(%rbp)  # imm = 0x71DF8981
	movl	%edi, -12(%rbp)
	movl	%esi, -28(%rbp)
	movq	$0, -24(%rbp)
	movl	-28(%rbp), %edi
	...
	callq	FreeNALU
	movl	-12(%rbp), %ebx
	cmpl	$1910475137, -32(%rbp)  # imm = 0x71DF8981
	jne	.LBB4_2
.LBB4_1:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1345023764, -20(%rbp)  # imm = 0x502B6F14
	movq	%rdi, -16(%rbp)
	movl	%esi, -4(%rbp)
	movq	stderr, %rdi
	movq	-16(%rbp), %rdx
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$322176766, -32(%rbp)   # imm = 0x133406FE
	movl	%edi, -12(%rbp)
	movl	%esi, -28(%rbp)
	movq	$0, -24(%rbp)
	movl	-28(%rbp), %edi
	...
	callq	FreeNALU
	movl	-12(%rbp), %ebx
	cmpl	$322176766, -32(%rbp)   # imm = 0x133406FE
	jne	.LBB6_2
.LBB6_1:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$414844353, -40(%rbp)   # imm = 0x18BA05C1
	movl	$0, -12(%rbp)
	movq	input(%rip), %rax
	movl	60(%rax), %eax
	xorl	%ecx, %ecx
...
.LBB7_10:                               # %return
	movl	-20(%rbp), %ebx
	cmpl	$414844353, -40(%rbp)   # imm = 0x18BA05C1
	jne	.LBB7_12
.LBB7_11:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$391545860, -28(%rbp)   # imm = 0x17568404
	movl	%edi, -12(%rbp)
	movl	%esi, -32(%rbp)
	movq	$0, -24(%rbp)
	movl	-32(%rbp), %edi
	...
	callq	FreeNALU
	movl	-12(%rbp), %ebx
	cmpl	$391545860, -28(%rbp)   # imm = 0x17568404
	jne	.LBB8_2
.LBB8_1:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$1161838321, -32(%rbp)  # imm = 0x45403EF1
	movl	%edi, -12(%rbp)
	movl	%esi, -28(%rbp)
	movq	$0, -24(%rbp)
	movl	-28(%rbp), %edi
	...
	callq	FreeNALU
	movl	-12(%rbp), %ebx
	cmpl	$1161838321, -32(%rbp)  # imm = 0x45403EF1
	jne	.LBB9_2
.LBB9_1:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1235224175, -20(%rbp)  # imm = 0x49A0066F
	movq	%rdi, -16(%rbp)
	movl	%esi, -4(%rbp)
	movq	stderr, %rdi
	movq	-16(%rbp), %rdx
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$935913806, -40(%rbp)   # imm = 0x37C8E94E
	movl	$0, -12(%rbp)
	movq	input(%rip), %rax
	movl	60(%rax), %eax
	xorl	%ecx, %ecx
...
.LBB11_10:                              # %return
	movl	-20(%rbp), %ebx
	cmpl	$935913806, -40(%rbp)   # imm = 0x37C8E94E
	jne	.LBB11_12
.LBB11_11:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$270137107, -36(%rbp)   # imm = 0x1019F713
	movl	$0, -12(%rbp)
	movq	input(%rip), %rax
	movl	60(%rax), %eax
	xorl	%ecx, %ecx
...
.LBB12_10:                              # %return
	movl	-20(%rbp), %ebx
	cmpl	$270137107, -36(%rbp)   # imm = 0x1019F713
	jne	.LBB12_12
.LBB12_11:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$2030234804, -36(%rbp)  # imm = 0x7902ECB4
	movl	$0, -12(%rbp)
	movq	input(%rip), %rax
	movl	60(%rax), %eax
	xorl	%ecx, %ecx
...
.LBB13_10:                              # %return
	movl	-20(%rbp), %ebx
	cmpl	$2030234804, -36(%rbp)  # imm = 0x7902ECB4
	jne	.LBB13_12
.LBB13_11:
	movl	%ebx, %eax
	addq	$40, %rsp
