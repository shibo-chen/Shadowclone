...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_testEndian.1, label %func_testEndian.5
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_img2buf.23, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_img2buf.26, label %ctrl2
...
ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_img2buf.35, label %func_img2buf.36
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_write_picture.2, label %ctrl0

func_write_picture.2:                             ; preds = %rand_bb
  call void @write_picture.2(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure)
  ret void
...
func_write_picture.32:                            ; preds = %ctrl3
  call void @write_picture.32(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure)
  ret void
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_write_picture.20, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_write_picture.29, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_write_picture.31, label %func_write_picture.32
}
...
func_write_out_picture.9:                         ; preds = %ctrl0
  call void @write_out_picture.9(%struct.storable_picture* %p, i32 %p_out)
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_write_out_picture.9, label %ctrl1
...
ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_write_out_picture.15, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_write_out_picture.18, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_write_out_picture.24, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_write_out_picture.27, label %func_write_out_picture.30
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_write_unpaired_field.8, label %ctrl0

func_write_unpaired_field.8:                      ; preds = %rand_bb
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_write_unpaired_field.12, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_write_unpaired_field.19, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_write_unpaired_field.22, label %func_write_unpaired_field.25
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_direct_output.11, label %func_direct_output.21

func_direct_output.11:                            ; preds = %rand_bb
  call void @direct_output.11(%struct.storable_picture* %p, i32 %p_out)
  ret void

func_direct_output.21:                            ; preds = %rand_bb
  call void @direct_output.21(%struct.storable_picture* %p, i32 %p_out)
  ret void
}
...
entry:
  ...
  %canary = alloca i32
  store i32 1626607042, i32* %canary
  %p = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_picture.2(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure) #0 {
entry:
  %p.addr = alloca %struct.storable_picture*, align 8
  %canary = alloca i32
  store i32 848241545, i32* %canary
  %p_out.addr = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 729400387, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
...
entry:
  ...
  %canary = alloca i32
  store i32 1959225624, i32* %canary
...
return:                                           ; preds = %if.end139, %if.then
  ...
  %193 = icmp eq i32 %192, 1959225624
...
entry:
  %canary = alloca i32
  store i32 276146717, i32* %canary
  %p = alloca i8*, align 8
  %s = alloca i16, align 2
  %0 = bitcast i16* %s to i8*
  store i8* %0, i8** %p, align 8
...
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 2133838411, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 0, i32* %i, align 4
  br label %for.cond
...
entry:
  ...
  %canary = alloca i32
  store i32 923077460, i32* %canary
...
entry:
  ...
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1831883964, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_out_picture.9(%struct.storable_picture* %p, i32 %p_out) #0 {
entry:
  %canary = alloca i32
  store i32 1354738019, i32* %canary
  %crop_top = alloca i32, align 4
  %SubHeightC = alloca [4 x i32], align 16
  %crop_right = alloca i32, align 4
  %p.addr = alloca %struct.storable_picture*, align 8
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1354738019
  br i1 %193, label %194, label %func_exit
...
entry:
  %canary = alloca i32
  store i32 554054484, i32* %canary
  %fs.addr = alloca %struct.frame_store*, align 8
  %p = alloca %struct.storable_picture*, align 8
  %p_out.addr = alloca i32, align 4
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
...
entry:
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1972772711, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  %0 = load %struct.storable_picture*, %struct.storable_picture** %p.addr, align 8
...
entry:
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 726429569, i32* %canary
  %p = alloca %struct.storable_picture*, align 8
  %fs.addr = alloca %struct.frame_store*, align 8
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  ...
  %p.addr = alloca %struct.storable_picture*, align 8
  %canary = alloca i32
  store i32 1307681495, i32* %canary
  %crop_right = alloca i32, align 4
  %buf = alloca i8*, align 8
  %crop_bottom = alloca i32, align 4
  %crop_left = alloca i32, align 4
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1307681495
  br i1 %193, label %194, label %func_exit
...
entry:
  %fs.addr = alloca %struct.frame_store*, align 8
  %canary = alloca i32
  store i32 580570467, i32* %canary
  %p_out.addr = alloca i32, align 4
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 1121031266, i32* %canary
  %SubHeightC = alloca [4 x i32], align 16
  %crop_right = alloca i32, align 4
  %rgb_output = alloca i32, align 4
  %buf = alloca i8*, align 8
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1121031266
  br i1 %193, label %194, label %func_exit
...
entry:
  %canary = alloca i32
  store i32 1611991159, i32* %canary
  %p_out.addr = alloca i32, align 4
  %fs.addr = alloca %struct.frame_store*, align 8
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  ...
  %p.addr = alloca %struct.storable_picture*, align 8
  %canary = alloca i32
  store i32 1577326873, i32* %canary
  %real_structure.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  store i32 %real_structure, i32* %real_structure.addr, align 4
...
entry:
  ...
  %buf = alloca i8*, align 8
  %canary = alloca i32
  store i32 1964321004, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  %rgb_output = alloca i32, align 4
  %SubHeightC = alloca [4 x i32], align 16
  %crop_top = alloca i32, align 4
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1964321004
  br i1 %193, label %194, label %func_exit
...
entry:
  %canary = alloca i32
  store i32 999756698, i32* %canary
  %p = alloca %struct.storable_picture*, align 8
  %fs.addr = alloca %struct.frame_store*, align 8
  %p_out.addr = alloca i32, align 4
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 537142186, i32* %canary
  %real_structure.addr = alloca i32, align 4
  %p_out.addr = alloca i32, align 4
  %p.addr = alloca %struct.storable_picture*, align 8
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @direct_output.21(%struct.storable_picture* %p, i32 %p_out) #0 {
entry:
  %p.addr = alloca %struct.storable_picture*, align 8
  %canary = alloca i32
  store i32 171536781, i32* %canary
  %p_out.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  %0 = load %struct.storable_picture*, %struct.storable_picture** %p.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1846777219, i32* %canary
  %p_out.addr = alloca i32, align 4
  %fs.addr = alloca %struct.frame_store*, align 8
  %p = alloca %struct.storable_picture*, align 8
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 2093240178, i32* %canary
  %size = alloca i32, align 4
  %theight = alloca i32, align 4
  %ui8 = alloca i8, align 1
  %size_x.addr = alloca i32, align 4
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 2093240178
  br i1 %109, label %110, label %func_exit
...
entry:
  ...
  %rgb_output = alloca i32, align 4
  %canary = alloca i32
  store i32 1383587536, i32* %canary
  %p_out.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  %0 = bitcast [4 x i32]* %SubWidthC to i8*
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1383587536
  br i1 %193, label %194, label %func_exit
...
entry:
  ...
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1563598773, i32* %canary
  %fs.addr = alloca %struct.frame_store*, align 8
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  %0 = load %struct.frame_store*, %struct.frame_store** %fs.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 356172747, i32* %canary
  %size_x.addr = alloca i32, align 4
  %crop_top.addr = alloca i32, align 4
  %j = alloca i32, align 4
  %symbol_size_in_bytes.addr = alloca i32, align 4
...
entry:
  ...
  %size_y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1804320955, i32* %canary
  %imgX.addr = alloca i16**, align 8
  %crop_left.addr = alloca i32, align 4
  %crop_top.addr = alloca i32, align 4
  %j = alloca i32, align 4
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1804320955
  br i1 %109, label %110, label %func_exit
...
entry:
  %real_structure.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 792687948, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  %p_out.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  %rgb_output = alloca i32, align 4
  %canary = alloca i32
  store i32 1557962681, i32* %canary
  %buf = alloca i8*, align 8
  %symbol_size_in_bytes = alloca i32, align 4
  %crop_left = alloca i32, align 4
  %SubWidthC = alloca [4 x i32], align 16
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1557962681
  br i1 %193, label %194, label %func_exit
...
entry:
  %canary = alloca i32
  store i32 837358517, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  %real_structure.addr = alloca i32, align 4
  %p_out.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_picture.32(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure) #0 {
entry:
  %p_out.addr = alloca i32, align 4
  %real_structure.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1825982256, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  store i32 %real_structure, i32* %real_structure.addr, align 4
...
entry:
  ...
  %ui16 = alloca i16, align 2
  %canary = alloca i32
  store i32 939001070, i32* %canary
  %theight = alloca i32, align 4
  %crop_right.addr = alloca i32, align 4
  %symbol_size_in_bytes.addr = alloca i32, align 4
  %crop_bottom.addr = alloca i32, align 4
...
entry:
  ...
  %ui8 = alloca i8, align 1
  %canary = alloca i32
  store i32 1466641205, i32* %canary
  %crop_bottom.addr = alloca i32, align 4
  %j = alloca i32, align 4
  %twidth = alloca i32, align 4
  %theight = alloca i32, align 4
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1466641205
  br i1 %109, label %110, label %func_exit
...
entry:
  ...
  %ui32 = alloca i64, align 8
  %canary = alloca i32
  store i32 1346774954, i32* %canary
  %crop_bottom.addr = alloca i32, align 4
  %crop_right.addr = alloca i32, align 4
  %crop_left.addr = alloca i32, align 4
  %i = alloca i32, align 4
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1346774954
  br i1 %109, label %110, label %func_exit
...
entry:
  ...
  %imgX.addr = alloca i16**, align 8
  %canary = alloca i32
  store i32 777820987, i32* %canary
  %crop_bottom.addr = alloca i32, align 4
  %crop_top.addr = alloca i32, align 4
  %theight = alloca i32, align 4
  %j = alloca i32, align 4
