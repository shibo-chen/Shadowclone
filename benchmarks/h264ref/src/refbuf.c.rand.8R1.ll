...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_PutPel_14.18, label %ctrl0

func_PutPel_14.18:                                ; preds = %rand_bb
  call void @PutPel_14.18(i16** %Pic, i32 %y, i32 %x, i16 %val)
  ret void

func_PutPel_14.21:                                ; preds = %ctrl0
  call void @PutPel_14.21(i16** %Pic, i32 %y, i32 %x, i16 %val)
  ret void

func_PutPel_14.24:                                ; preds = %ctrl1
  call void @PutPel_14.24(i16** %Pic, i32 %y, i32 %x, i16 %val)
  ret void

func_PutPel_14.27:                                ; preds = %ctrl2
  call void @PutPel_14.27(i16** %Pic, i32 %y, i32 %x, i16 %val)
  ret void
...
func_PutPel_14.54:                                ; preds = %ctrl4
  call void @PutPel_14.54(i16** %Pic, i32 %y, i32 %x, i16 %val)
  ret void

func_PutPel_14.55:                                ; preds = %ctrl5
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_PutPel_14.21, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_PutPel_14.24, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_PutPel_14.27, label %ctrl3
...
ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_PutPel_14.54, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_PutPel_14.55, label %func_PutPel_14.57
}
...
func_PutPel_11.3:                                 ; preds = %ctrl0
  call void @PutPel_11.3(i16* %Pic, i32 %y, i32 %x, i16 %val, i32 %width)
  ret void

func_PutPel_11.7:                                 ; preds = %ctrl1
  call void @PutPel_11.7(i16* %Pic, i32 %y, i32 %x, i16 %val, i32 %width)
  ret void

func_PutPel_11.13:                                ; preds = %ctrl2
  call void @PutPel_11.13(i16* %Pic, i32 %y, i32 %x, i16 %val, i32 %width)
  ret void

func_PutPel_11.19:                                ; preds = %ctrl3
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_PutPel_11.3, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_PutPel_11.7, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_PutPel_11.13, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_PutPel_11.19, label %ctrl4
...
ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_PutPel_11.61, label %func_PutPel_11.63
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FastLine16Y_11.5, label %ctrl0

func_FastLine16Y_11.5:                            ; preds = %rand_bb
  %2 = call i16* @FastLine16Y_11.5(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %2

func_FastLine16Y_11.22:                           ; preds = %ctrl0
  %3 = call i16* @FastLine16Y_11.22(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %3

func_FastLine16Y_11.37:                           ; preds = %ctrl1
  %4 = call i16* @FastLine16Y_11.37(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %4

func_FastLine16Y_11.42:                           ; preds = %ctrl2
  %5 = call i16* @FastLine16Y_11.42(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %5

func_FastLine16Y_11.48:                           ; preds = %ctrl3
  %6 = call i16* @FastLine16Y_11.48(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %6

func_FastLine16Y_11.59:                           ; preds = %ctrl4
  %7 = call i16* @FastLine16Y_11.59(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %7
...
ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_FastLine16Y_11.22, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_FastLine16Y_11.37, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_FastLine16Y_11.42, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_FastLine16Y_11.48, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_FastLine16Y_11.59, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_FastLine16Y_11.62, label %func_FastLine16Y_11.64
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_UMVLine16Y_11.16, label %ctrl0

func_UMVLine16Y_11.16:                            ; preds = %rand_bb
  %2 = call i16* @UMVLine16Y_11.16(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %2

func_UMVLine16Y_11.25:                            ; preds = %ctrl0
  %3 = call i16* @UMVLine16Y_11.25(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %3

func_UMVLine16Y_11.30:                            ; preds = %ctrl1
  %4 = call i16* @UMVLine16Y_11.30(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %4
...
func_UMVLine16Y_11.45:                            ; preds = %ctrl4
  %7 = call i16* @UMVLine16Y_11.45(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %7
...
func_UMVLine16Y_11.52:                            ; preds = %ctrl5
  %9 = call i16* @UMVLine16Y_11.52(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_UMVLine16Y_11.25, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_UMVLine16Y_11.30, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_UMVLine16Y_11.31, label %ctrl3
...
ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_UMVLine16Y_11.45, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_UMVLine16Y_11.47, label %func_UMVLine16Y_11.52
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FastLineX.8, label %ctrl0

func_FastLineX.8:                                 ; preds = %rand_bb
  %2 = call i16* @FastLineX.8(i32 %dummy, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %2
...
func_FastLineX.34:                                ; preds = %ctrl2
  %5 = call i16* @FastLineX.34(i32 %dummy, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %5

func_FastLineX.49:                                ; preds = %ctrl3
  %6 = call i16* @FastLineX.49(i32 %dummy, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %6

func_FastLineX.50:                                ; preds = %ctrl4
  %7 = call i16* @FastLineX.50(i32 %dummy, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %7

func_FastLineX.53:                                ; preds = %ctrl5
  %8 = call i16* @FastLineX.53(i32 %dummy, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %8

func_FastLineX.56:                                ; preds = %ctrl5
  %9 = call i16* @FastLineX.56(i32 %dummy, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_FastLineX.9, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_FastLineX.14, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_FastLineX.34, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_FastLineX.49, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_FastLineX.50, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_FastLineX.53, label %func_FastLineX.56
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_UMVLineX.15, label %ctrl0

func_UMVLineX.15:                                 ; preds = %rand_bb
  %2 = call i16* @UMVLineX.15(i32 %size, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %2
...
func_UMVLineX.33:                                 ; preds = %ctrl1
  %4 = call i16* @UMVLineX.33(i32 %size, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %4

func_UMVLineX.41:                                 ; preds = %ctrl2
  %5 = call i16* @UMVLineX.41(i32 %size, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %5

func_UMVLineX.43:                                 ; preds = %ctrl3
  %6 = call i16* @UMVLineX.43(i32 %size, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %6
...
ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_UMVLineX.33, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_UMVLineX.41, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_UMVLineX.43, label %ctrl4
...
func_UMVPelY_14.6:                                ; preds = %ctrl0
  %3 = call i16 @UMVPelY_14.6(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16 %3

func_UMVPelY_14.10:                               ; preds = %ctrl1
  %4 = call i16 @UMVPelY_14.10(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16 %4

func_UMVPelY_14.12:                               ; preds = %ctrl2
  %5 = call i16 @UMVPelY_14.12(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16 %5

func_UMVPelY_14.20:                               ; preds = %ctrl3
  %6 = call i16 @UMVPelY_14.20(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16 %6

func_UMVPelY_14.23:                               ; preds = %ctrl4
  %7 = call i16 @UMVPelY_14.23(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16 %7

func_UMVPelY_14.35:                               ; preds = %ctrl5
  %8 = call i16 @UMVPelY_14.35(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16 %8

func_UMVPelY_14.44:                               ; preds = %ctrl5
  %9 = call i16 @UMVPelY_14.44(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_UMVPelY_14.6, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_UMVPelY_14.10, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_UMVPelY_14.12, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_UMVPelY_14.20, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_UMVPelY_14.23, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_UMVPelY_14.35, label %func_UMVPelY_14.44
}
...
func_FastPelY_14.17:                              ; preds = %ctrl1
  %4 = call i16 @FastPelY_14.17(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16 %4

func_FastPelY_14.28:                              ; preds = %ctrl2
  %5 = call i16 @FastPelY_14.28(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16 %5

func_FastPelY_14.32:                              ; preds = %ctrl3
  %6 = call i16 @FastPelY_14.32(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16 %6

func_FastPelY_14.36:                              ; preds = %ctrl4
  %7 = call i16 @FastPelY_14.36(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16 %7

func_FastPelY_14.38:                              ; preds = %ctrl5
  %8 = call i16 @FastPelY_14.38(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16 %8

func_FastPelY_14.40:                              ; preds = %ctrl5
  %9 = call i16 @FastPelY_14.40(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_FastPelY_14.11, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_FastPelY_14.17, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_FastPelY_14.28, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_FastPelY_14.32, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_FastPelY_14.36, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_FastPelY_14.38, label %func_FastPelY_14.40
}
...
entry:
  %canary = alloca i32
  store i32 1987669967, i32* %canary
...
entry:
  %y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1264026276, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @PutPel_11.3(i16* %Pic, i32 %y, i32 %x, i16 zeroext %val, i32 %width) #0 {
entry:
  %width.addr = alloca i32, align 4
  %Pic.addr = alloca i16*, align 8
  %x.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 636549486, i32* %canary
  %val.addr = alloca i16, align 2
  store i16* %Pic, i16** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
  store i32 %x, i32* %x.addr, align 4
...
entry:
  ...
  %x.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 711978221, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i16* @FastLine16Y_11.5(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width) #0 {
entry:
  %canary = alloca i32
  store i32 902902395, i32* %canary
  %y.addr = alloca i32, align 4
  %width.addr = alloca i32, align 4
  %Pic.addr = alloca i16*, align 8
  %height.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local zeroext i16 @UMVPelY_14.6(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width) #0 {
entry:
  %y.addr = alloca i32, align 4
  %height.addr = alloca i32, align 4
  %retval = alloca i16, align 2
  %canary = alloca i32
  store i32 1902622183, i32* %canary
  %x.addr = alloca i32, align 4
  %width.addr = alloca i32, align 4
  %width4 = alloca i32, align 4
  %height4 = alloca i32, align 4
...
entry:
  ...
  %x.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 721591633, i32* %canary
  %width.addr = alloca i32, align 4
  store i16* %Pic, i16** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
  store i32 %x, i32* %x.addr, align 4
...
entry:
  ...
  %y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1116521697, i32* %canary
...
entry:
  ...
  %x.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 383303365, i32* %canary
  %width.addr = alloca i32, align 4
  store i32 %dummy, i32* %dummy.addr, align 4
  store i16* %Pic, i16** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
...
entry:
  %width.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2043944218, i32* %canary
  %Pic.addr = alloca i16**, align 8
  %height.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
  %height4 = alloca i32, align 4
...
entry:
  ...
  %width.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2086047067, i32* %canary
  %x.addr = alloca i32, align 4
  %height.addr = alloca i32, align 4
  %Pic.addr = alloca i16**, align 8
  store i16** %Pic, i16*** %Pic.addr, align 8
...
entry:
  ...
  %Pic.addr = alloca i16**, align 8
  %canary = alloca i32
  store i32 1109122358, i32* %canary
  %x.addr = alloca i32, align 4
  %width.addr = alloca i32, align 4
  %height.addr = alloca i32, align 4
  %width4 = alloca i32, align 4
...
entry:
  ...
  %width.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 960327670, i32* %canary
  %y.addr = alloca i32, align 4
  %val.addr = alloca i16, align 2
  store i16* %Pic, i16** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 989328220, i32* %canary
  %y.addr = alloca i32, align 4
  %dummy.addr = alloca i32, align 4
  %x.addr = alloca i32, align 4
  %height.addr = alloca i32, align 4
...
entry:
  ...
  %y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 209926142, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i16* @UMVLine16Y_11.16(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width) #0 {
entry:
  %retval = alloca i16*, align 8
  %canary = alloca i32
  store i32 679518882, i32* %canary
  %Pic.addr = alloca i16*, align 8
  %y.addr = alloca i32, align 4
  %Picy = alloca i16*, align 8
  %maxx = alloca i32, align 4
...
entry:
  %y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1509205835, i32* %canary
  %width.addr = alloca i32, align 4
  %height.addr = alloca i32, align 4
  %Pic.addr = alloca i16**, align 8
  %x.addr = alloca i32, align 4
...
entry:
  ...
  %y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1294432689, i32* %canary
  %Pic.addr = alloca i16**, align 8
  store i16** %Pic, i16*** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
  store i32 %x, i32* %x.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 611811307, i32* %canary
  %Pic.addr = alloca i16*, align 8
  %x.addr = alloca i32, align 4
  %width.addr = alloca i32, align 4
  %val.addr = alloca i16, align 2
...
entry:
  ...
  %width.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 205988712, i32* %canary
  %width4 = alloca i32, align 4
  %height4 = alloca i32, align 4
  %height.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
...
entry:
  %val.addr = alloca i16, align 2
  %canary = alloca i32
  store i32 1232446529, i32* %canary
  %Pic.addr = alloca i16**, align 8
  %y.addr = alloca i32, align 4
  %x.addr = alloca i32, align 4
  store i16** %Pic, i16*** %Pic.addr, align 8
...
entry:
  ...
  %height4 = alloca i32, align 4
  %canary = alloca i32
  store i32 1864603910, i32* %canary
  %retval = alloca i16, align 2
  %y.addr = alloca i32, align 4
  %width4 = alloca i32, align 4
  %height.addr = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 882180370, i32* %canary
  %val.addr = alloca i16, align 2
  %y.addr = alloca i32, align 4
  %Pic.addr = alloca i16**, align 8
  %x.addr = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 136702869, i32* %canary
  %y.addr = alloca i32, align 4
  %Pic.addr = alloca i16*, align 8
  %height.addr = alloca i32, align 4
  %width.addr = alloca i32, align 4
...
entry:
  %height.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 123889027, i32* %canary
  %retval = alloca i16*, align 8
  %Picy = alloca i16*, align 8
  %maxx = alloca i32, align 4
  %width.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @PutPel_14.27(i16** %Pic, i32 %y, i32 %x, i16 zeroext %val) #0 {
entry:
  %Pic.addr = alloca i16**, align 8
  %val.addr = alloca i16, align 2
  %x.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 699552069, i32* %canary
  %y.addr = alloca i32, align 4
  store i16** %Pic, i16*** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
  store i32 %x, i32* %x.addr, align 4
...
entry:
  ...
  %height.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1885760624, i32* %canary
  %width.addr = alloca i32, align 4
  %x.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
  store i16** %Pic, i16*** %Pic.addr, align 8
...
entry:
  ...
  %Pic.addr = alloca i16**, align 8
  %canary = alloca i32
  store i32 1408164244, i32* %canary
  %val.addr = alloca i16, align 2
  store i16** %Pic, i16*** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
  store i32 %x, i32* %x.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i16* @UMVLine16Y_11.30(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width) #0 {
entry:
  %canary = alloca i32
  store i32 1645220776, i32* %canary
  %x.addr = alloca i32, align 4
  %Pic.addr = alloca i16*, align 8
  %width.addr = alloca i32, align 4
  %Picy = alloca i16*, align 8
...
entry:
  ...
  %height.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 251471080, i32* %canary
  %x.addr = alloca i32, align 4
  %Pic.addr = alloca i16*, align 8
  %width.addr = alloca i32, align 4
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local zeroext i16 @FastPelY_14.32(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width) #0 {
entry:
  %width.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
  %height.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 560409943, i32* %canary
  %x.addr = alloca i32, align 4
  %Pic.addr = alloca i16**, align 8
  store i16** %Pic, i16*** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
...
entry:
  ...
  %height.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1376922269, i32* %canary
  %x.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %retval = alloca i16*, align 8
  %Pic.addr = alloca i16*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i16* @FastLineX.34(i32 %dummy, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width) #0 {
entry:
  %Pic.addr = alloca i16*, align 8
  %dummy.addr = alloca i32, align 4
  %width.addr = alloca i32, align 4
  %x.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1909578598, i32* %canary
  %height.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
  store i32 %dummy, i32* %dummy.addr, align 4
  store i16* %Pic, i16** %Pic.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 420615956, i32* %canary
  %width.addr = alloca i32, align 4
  %x.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
  %Pic.addr = alloca i16**, align 8
...
entry:
  ...
  %width.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1508915715, i32* %canary
  %Pic.addr = alloca i16*, align 8
  %y.addr = alloca i32, align 4
  %x.addr = alloca i32, align 4
  store i16* %Pic, i16** %Pic.addr, align 8
...
entry:
  ...
  %Pic.addr = alloca i16**, align 8
  %canary = alloca i32
  store i32 311521341, i32* %canary
  %height.addr = alloca i32, align 4
  %width.addr = alloca i32, align 4
  %x.addr = alloca i32, align 4
  store i16** %Pic, i16*** %Pic.addr, align 8
...
entry:
  ...
  %height.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 161792898, i32* %canary
  %Picy = alloca i16*, align 8
  %x.addr = alloca i32, align 4
  %Pic.addr = alloca i16*, align 8
  %width.addr = alloca i32, align 4
...
entry:
  %height.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1130540205, i32* %canary
  %Pic.addr = alloca i16**, align 8
  %width.addr = alloca i32, align 4
  %x.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
...
entry:
  ...
  %x.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 406182465, i32* %canary
  %Pic.addr = alloca i16*, align 8
  %Picy = alloca i16*, align 8
  %retval = alloca i16*, align 8
  %height.addr = alloca i32, align 4
...
entry:
  ...
  %width.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 413606904, i32* %canary
  %height.addr = alloca i32, align 4
  store i16* %Pic, i16** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
  store i32 %x, i32* %x.addr, align 4
...
entry:
  ...
  %retval = alloca i16*, align 8
  %canary = alloca i32
  store i32 1619648613, i32* %canary
  %y.addr = alloca i32, align 4
  %Pic.addr = alloca i16*, align 8
  %width.addr = alloca i32, align 4
  store i32 %size, i32* %size.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 1368716162, i32* %canary
  %width4 = alloca i32, align 4
  %height4 = alloca i32, align 4
  %y.addr = alloca i32, align 4
  %retval = alloca i16, align 2
...
entry:
  %canary = alloca i32
  store i32 1769225488, i32* %canary
  %x.addr = alloca i32, align 4
  %maxx = alloca i32, align 4
  %Pic.addr = alloca i16*, align 8
  %Picy = alloca i16*, align 8
...
entry:
  %val.addr = alloca i16, align 2
  %canary = alloca i32
  store i32 1815711140, i32* %canary
  %Pic.addr = alloca i16*, align 8
  %y.addr = alloca i32, align 4
  %x.addr = alloca i32, align 4
  %width.addr = alloca i32, align 4
...
entry:
  %x.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1565705093, i32* %canary
  %width.addr = alloca i32, align 4
  %Picy = alloca i16*, align 8
  %i = alloca i32, align 4
  %y.addr = alloca i32, align 4
...
entry:
  ...
  %width.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 858467286, i32* %canary
  %height.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
  store i16* %Pic, i16** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i16* @FastLineX.50(i32 %dummy, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width) #0 {
entry:
  %width.addr = alloca i32, align 4
  %Pic.addr = alloca i16*, align 8
  %height.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 690465458, i32* %canary
  %dummy.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
  %x.addr = alloca i32, align 4
  store i32 %dummy, i32* %dummy.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i16* @UMVLine16Y_11.52(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width) #0 {
entry:
  %Picy = alloca i16*, align 8
  %Pic.addr = alloca i16*, align 8
  %height.addr = alloca i32, align 4
  ...
  %retval = alloca i16*, align 8
  %canary = alloca i32
  store i32 1041128399, i32* %canary
  %maxx = alloca i32, align 4
  store i16* %Pic, i16** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
  store i32 %x, i32* %x.addr, align 4
...
entry:
  ...
  %dummy.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 889275290, i32* %canary
  %Pic.addr = alloca i16*, align 8
  %x.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
  store i32 %dummy, i32* %dummy.addr, align 4
...
entry:
  ...
  %val.addr = alloca i16, align 2
  %canary = alloca i32
  store i32 1134323074, i32* %canary
  %Pic.addr = alloca i16**, align 8
  store i16** %Pic, i16*** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
  store i32 %x, i32* %x.addr, align 4
...
entry:
  ...
  %val.addr = alloca i16, align 2
  %canary = alloca i32
  store i32 1933973448, i32* %canary
  %x.addr = alloca i32, align 4
  store i16** %Pic, i16*** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
  store i32 %x, i32* %x.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i16* @FastLineX.56(i32 %dummy, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width) #0 {
entry:
  %width.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 243086633, i32* %canary
  %Pic.addr = alloca i16*, align 8
  %dummy.addr = alloca i32, align 4
  %height.addr = alloca i32, align 4
  %x.addr = alloca i32, align 4
...
entry:
  ...
  %val.addr = alloca i16, align 2
  %canary = alloca i32
  store i32 1047436339, i32* %canary
  %Pic.addr = alloca i16**, align 8
  store i16** %Pic, i16*** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
  store i32 %x, i32* %x.addr, align 4
...
entry:
  %retval = alloca i16*, align 8
  %canary = alloca i32
  store i32 1616089061, i32* %canary
  %y.addr = alloca i32, align 4
  %maxx = alloca i32, align 4
  %Pic.addr = alloca i16*, align 8
  %i = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 942686046, i32* %canary
  %y.addr = alloca i32, align 4
  %width.addr = alloca i32, align 4
  %x.addr = alloca i32, align 4
  %Pic.addr = alloca i16*, align 8
...
entry:
  %canary = alloca i32
  store i32 864122520, i32* %canary
  %x.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %retval = alloca i16*, align 8
...
entry:
  ...
  %val.addr = alloca i16, align 2
  %canary = alloca i32
  store i32 1620446429, i32* %canary
  %width.addr = alloca i32, align 4
  store i16* %Pic, i16** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
  store i32 %x, i32* %x.addr, align 4
...
entry:
  %x.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 931102969, i32* %canary
  %height.addr = alloca i32, align 4
  %Pic.addr = alloca i16*, align 8
  %width.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
...
entry:
  ...
  %val.addr = alloca i16, align 2
  %canary = alloca i32
  store i32 960483695, i32* %canary
  %width.addr = alloca i32, align 4
  %x.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
  store i16* %Pic, i16** %Pic.addr, align 8
...
entry:
  ...
  %x.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 824484556, i32* %canary
  %Pic.addr = alloca i16*, align 8
  %height.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
  store i16* %Pic, i16** %Pic.addr, align 8
