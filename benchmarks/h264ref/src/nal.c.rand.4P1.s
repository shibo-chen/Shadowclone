...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$246017724, -40(%rbp)   # imm = 0xEA9EEBC
	movq	%rdi, -32(%rbp)
	movl	%esi, -24(%rbp)
	movl	%edx, -36(%rbp)
	movl	%ecx, -44(%rbp)
...
.LBB4_17:                               # %while.end
	movl	-12(%rbp), %ebx
	cmpl	$246017724, -40(%rbp)   # imm = 0xEA9EEBC
	jne	.LBB4_19
.LBB4_18:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$1439180176, -44(%rbp)  # imm = 0x55C82590
	movq	%rdi, -32(%rbp)
	movl	%esi, -24(%rbp)
	movl	%edx, -36(%rbp)
	movl	%ecx, -40(%rbp)
...
.LBB5_17:                               # %while.end
	movl	-12(%rbp), %ebx
	cmpl	$1439180176, -44(%rbp)  # imm = 0x55C82590
	jne	.LBB5_19
.LBB5_18:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$1747653858, -40(%rbp)  # imm = 0x682B14E2
	movq	%rdi, -32(%rbp)
	movl	%esi, -24(%rbp)
	movl	%edx, -36(%rbp)
	movl	%ecx, -44(%rbp)
...
.LBB6_17:                               # %while.end
	movl	-12(%rbp), %ebx
	cmpl	$1747653858, -40(%rbp)  # imm = 0x682B14E2
	jne	.LBB6_19
.LBB6_18:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$1568870628, -40(%rbp)  # imm = 0x5D8310E4
	movq	%rdi, -32(%rbp)
	movl	%esi, -24(%rbp)
	movl	%edx, -36(%rbp)
	movl	%ecx, -44(%rbp)
...
.LBB7_17:                               # %while.end
	movl	-12(%rbp), %ebx
	cmpl	$1568870628, -40(%rbp)  # imm = 0x5D8310E4
	jne	.LBB7_19
.LBB7_18:
	movl	%ebx, %eax
	addq	$40, %rsp
