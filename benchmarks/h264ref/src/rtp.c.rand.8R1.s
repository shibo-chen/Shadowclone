...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$16, %rsp
	movl	$768116835, -12(%rbp)   # imm = 0x2DC88863
	movl	%edi, -8(%rbp)
...
.LBB6_5:                                # %return
	cmpl	$768116835, -12(%rbp)   # imm = 0x2DC88863
	jne	.LBB6_7
.LBB6_6:
	addq	$16, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$167807872, -40(%rbp)   # imm = 0xA008B80
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movl	$-1, -36(%rbp)
	movq	-32(%rbp), %rdi
...
.LBB7_7:                                # %return
	movl	-12(%rbp), %ebx
	cmpl	$167807872, -40(%rbp)   # imm = 0xA008B80
	jne	.LBB7_9
.LBB7_8:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$16, %rsp
	movl	$391979629, -12(%rbp)   # imm = 0x175D226D
	movl	%edi, -8(%rbp)
	cmpl	$-1, RTPUpdateTimestamp.oldtr
	jne	.LBB8_2
# %bb.1:                                # %if.then
...
.LBB8_4:                                # %if.end3
	...
	movl	%eax, RTPUpdateTimestamp.oldtr
.LBB8_5:                                # %return
	cmpl	$391979629, -12(%rbp)   # imm = 0x175D226D
	jne	.LBB8_7
.LBB8_6:
	addq	$16, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$670961244, -28(%rbp)   # imm = 0x27FE0E5C
	movq	%rdi, -24(%rbp)
	movq	-24(%rbp), %rax
	movl	20(%rax), %eax
	shll	$7, %eax
...
.LBB9_10:                               # %if.end32
	...
	movl	4(%rax), %ebx
	shll	$3, %ebx
	cmpl	$670961244, -28(%rbp)   # imm = 0x27FE0E5C
	jne	.LBB9_12
.LBB9_11:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$282002429, -28(%rbp)   # imm = 0x10CF03FD
	movq	%rdi, -24(%rbp)
	movq	-24(%rbp), %rax
	movl	20(%rax), %eax
	shll	$7, %eax
...
.LBB10_10:                              # %if.end32
	...
	movl	4(%rax), %ebx
	shll	$3, %ebx
	cmpl	$282002429, -28(%rbp)   # imm = 0x10CF03FD
	jne	.LBB10_12
.LBB10_11:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$1195803374, -36(%rbp)  # imm = 0x474682EE
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movl	$-1, -40(%rbp)
	movq	-32(%rbp), %rdi
...
.LBB11_7:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$1195803374, -36(%rbp)  # imm = 0x474682EE
	jne	.LBB11_9
.LBB11_8:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$499108848, -40(%rbp)   # imm = 0x1DBFCBF0
	movq	%rdi, -24(%rbp)
	movq	%rsi, -32(%rbp)
	movl	$-1, -36(%rbp)
	movq	-24(%rbp), %rdi
...
.LBB12_7:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$499108848, -40(%rbp)   # imm = 0x1DBFCBF0
	jne	.LBB12_9
.LBB12_8:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$351469535, -40(%rbp)   # imm = 0x14F2FFDF
	movq	%rdi, -24(%rbp)
	movq	%rsi, -32(%rbp)
	movl	$-1, -36(%rbp)
	movq	-24(%rbp), %rdi
...
.LBB13_7:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$351469535, -40(%rbp)   # imm = 0x14F2FFDF
	jne	.LBB13_9
.LBB13_8:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$2119783271, -36(%rbp)  # imm = 0x7E595367
	movq	%rdi, -24(%rbp)
	movq	%rsi, -32(%rbp)
	movl	$-1, -40(%rbp)
	movq	-24(%rbp), %rdi
...
.LBB14_7:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$2119783271, -36(%rbp)  # imm = 0x7E595367
	jne	.LBB14_9
.LBB14_8:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$369908163, -40(%rbp)   # imm = 0x160C59C3
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movl	$-1, -36(%rbp)
	movq	-32(%rbp), %rdi
...
.LBB15_7:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$369908163, -40(%rbp)   # imm = 0x160C59C3
	jne	.LBB15_9
.LBB15_8:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$532456596, -40(%rbp)   # imm = 0x1FBCA494
	movq	%rdi, -24(%rbp)
	movq	%rsi, -32(%rbp)
	movl	$-1, -36(%rbp)
	movq	-24(%rbp), %rdi
...
.LBB16_7:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$532456596, -40(%rbp)   # imm = 0x1FBCA494
	jne	.LBB16_9
.LBB16_8:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$153683369, -40(%rbp)   # imm = 0x92905A9
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movl	$-1, -36(%rbp)
	movq	-32(%rbp), %rdi
...
.LBB17_7:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$153683369, -40(%rbp)   # imm = 0x92905A9
	jne	.LBB17_9
.LBB17_8:
	movl	%ebx, %eax
	addq	$40, %rsp
