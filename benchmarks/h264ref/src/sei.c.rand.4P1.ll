...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_write_sei_message.15, label %ctrl0

func_write_sei_message.15:                        ; preds = %rand_bb
  call void @write_sei_message.15(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type)
  ret void
...
func_write_sei_message.56:                        ; preds = %ctrl1
  call void @write_sei_message.56(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type)
  ret void
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_write_sei_message.37, label %func_write_sei_message.56
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_finalize_sei_message.13, label %func_finalize_sei_message.45

func_finalize_sei_message.13:                     ; preds = %rand_bb
  call void @finalize_sei_message.13(i32 %id)
  ret void

func_finalize_sei_message.45:                     ; preds = %rand_bb
  call void @finalize_sei_message.45(i32 %id)
  ret void
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_AppendTmpbits2Buf.22, label %ctrl0

func_AppendTmpbits2Buf.22:                        ; preds = %rand_bb
  call void @AppendTmpbits2Buf.22(%struct.Bitstream* %dest, %struct.Bitstream* %source)
  ret void
...
func_AppendTmpbits2Buf.57:                        ; preds = %ctrl1
  call void @AppendTmpbits2Buf.57(%struct.Bitstream* %dest, %struct.Bitstream* %source)
  ret void

func_AppendTmpbits2Buf.58:                        ; preds = %ctrl1
  call void @AppendTmpbits2Buf.58(%struct.Bitstream* %dest, %struct.Bitstream* %source)
  ret void
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_AppendTmpbits2Buf.57, label %func_AppendTmpbits2Buf.58
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_ComposeSparePictureMessage.8, label %ctrl0

func_ComposeSparePictureMessage.8:                ; preds = %rand_bb
  call void @ComposeSparePictureMessage.8(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream)
  ret void

func_ComposeSparePictureMessage.44:               ; preds = %ctrl0
  call void @ComposeSparePictureMessage.44(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream)
  ret void

func_ComposeSparePictureMessage.49:               ; preds = %ctrl1
  call void @ComposeSparePictureMessage.49(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream)
  ret void

func_ComposeSparePictureMessage.51:               ; preds = %ctrl1
  call void @ComposeSparePictureMessage.51(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_ComposeSparePictureMessage.44, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_ComposeSparePictureMessage.49, label %func_ComposeSparePictureMessage.51
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_CompressSpareMBMap.26, label %ctrl0

func_CompressSpareMBMap.26:                       ; preds = %rand_bb
  %2 = call i32 @CompressSpareMBMap.26(i8** %map_sp, %struct.Bitstream* %bitstream)
  ret i32 %2
...
func_CompressSpareMBMap.34:                       ; preds = %ctrl1
  %4 = call i32 @CompressSpareMBMap.34(i8** %map_sp, %struct.Bitstream* %bitstream)
  ret i32 %4

func_CompressSpareMBMap.40:                       ; preds = %ctrl1
  %5 = call i32 @CompressSpareMBMap.40(i8** %map_sp, %struct.Bitstream* %bitstream)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_CompressSpareMBMap.31, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_CompressSpareMBMap.34, label %func_CompressSpareMBMap.40
}
...
func_FinalizeSpareMBMap.9:                        ; preds = %ctrl0
  call void @FinalizeSpareMBMap.9()
  ret void
...
func_FinalizeSpareMBMap.32:                       ; preds = %ctrl1
  call void @FinalizeSpareMBMap.32()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_FinalizeSpareMBMap.9, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_FinalizeSpareMBMap.24, label %func_FinalizeSpareMBMap.32
}
...
func_FinalizeSubseqInfo.25:                       ; preds = %ctrl1
  call void @FinalizeSubseqInfo.25(i32 %currLayer)
  ret void

func_FinalizeSubseqInfo.47:                       ; preds = %ctrl1
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_FinalizeSubseqInfo.25, label %func_FinalizeSubseqInfo.47
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FinalizeSubseqLayerInfo.6, label %func_FinalizeSubseqLayerInfo.14

func_FinalizeSubseqLayerInfo.6:                   ; preds = %rand_bb
  call void @FinalizeSubseqLayerInfo.6()
  ret void
...
func_FinalizeSubseqChar.12:                       ; preds = %ctrl0
  call void @FinalizeSubseqChar.12()
  ret void

func_FinalizeSubseqChar.16:                       ; preds = %ctrl1
  call void @FinalizeSubseqChar.16()
  ret void

func_FinalizeSubseqChar.20:                       ; preds = %ctrl1
  call void @FinalizeSubseqChar.20()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_FinalizeSubseqChar.12, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_FinalizeSubseqChar.16, label %func_FinalizeSubseqChar.20
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FinalizeSceneInformation.2, label %func_FinalizeSceneInformation.7

func_FinalizeSceneInformation.2:                  ; preds = %rand_bb
  call void @FinalizeSceneInformation.2()
  ret void

func_FinalizeSceneInformation.7:                  ; preds = %rand_bb
  call void @FinalizeSceneInformation.7()
  ret void
}
...
func_UpdateSceneInformation.43:                   ; preds = %ctrl0
  call void @UpdateSceneInformation.43(i32 %HasSceneInformation, i32 %sceneID, i32 %sceneTransType, i32 %secondSceneID)
  ret void

func_UpdateSceneInformation.48:                   ; preds = %ctrl1
  call void @UpdateSceneInformation.48(i32 %HasSceneInformation, i32 %sceneID, i32 %sceneTransType, i32 %secondSceneID)
  ret void

func_UpdateSceneInformation.52:                   ; preds = %ctrl1
  call void @UpdateSceneInformation.52(i32 %HasSceneInformation, i32 %sceneID, i32 %sceneTransType, i32 %secondSceneID)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_UpdateSceneInformation.43, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_UpdateSceneInformation.48, label %func_UpdateSceneInformation.52
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FinalizePanScanRectInfo.23, label %func_FinalizePanScanRectInfo.41

func_FinalizePanScanRectInfo.23:                  ; preds = %rand_bb
  call void @FinalizePanScanRectInfo.23()
  ret void

func_FinalizePanScanRectInfo.41:                  ; preds = %rand_bb
  call void @FinalizePanScanRectInfo.41()
  ret void
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_UpdateUser_data_unregistered.18, label %ctrl0

func_UpdateUser_data_unregistered.18:             ; preds = %rand_bb
  call void @UpdateUser_data_unregistered.18()
  ret void

func_UpdateUser_data_unregistered.36:             ; preds = %ctrl0
  call void @UpdateUser_data_unregistered.36()
  ret void

func_UpdateUser_data_unregistered.50:             ; preds = %ctrl1
  call void @UpdateUser_data_unregistered.50()
  ret void

func_UpdateUser_data_unregistered.55:             ; preds = %ctrl1
  call void @UpdateUser_data_unregistered.55()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_UpdateUser_data_unregistered.36, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_UpdateUser_data_unregistered.50, label %func_UpdateUser_data_unregistered.55
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FinalizeUser_data_unregistered.5, label %ctrl0

func_FinalizeUser_data_unregistered.5:            ; preds = %rand_bb
  call void @FinalizeUser_data_unregistered.5()
  ret void

func_FinalizeUser_data_unregistered.19:           ; preds = %ctrl0
  call void @FinalizeUser_data_unregistered.19()
  ret void

func_FinalizeUser_data_unregistered.29:           ; preds = %ctrl1
  call void @FinalizeUser_data_unregistered.29()
  ret void

func_FinalizeUser_data_unregistered.54:           ; preds = %ctrl1
  call void @FinalizeUser_data_unregistered.54()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_FinalizeUser_data_unregistered.19, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_FinalizeUser_data_unregistered.29, label %func_FinalizeUser_data_unregistered.54
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_UpdateUser_data_registered_itu_t_t35.11, label %ctrl0

func_UpdateUser_data_registered_itu_t_t35.11:     ; preds = %rand_bb
  call void @UpdateUser_data_registered_itu_t_t35.11()
  ret void

func_UpdateUser_data_registered_itu_t_t35.33:     ; preds = %ctrl0
  call void @UpdateUser_data_registered_itu_t_t35.33()
  ret void

func_UpdateUser_data_registered_itu_t_t35.35:     ; preds = %ctrl1
  call void @UpdateUser_data_registered_itu_t_t35.35()
  ret void

func_UpdateUser_data_registered_itu_t_t35.42:     ; preds = %ctrl1
  call void @UpdateUser_data_registered_itu_t_t35.42()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_UpdateUser_data_registered_itu_t_t35.33, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_UpdateUser_data_registered_itu_t_t35.35, label %func_UpdateUser_data_registered_itu_t_t35.42
}
...
func_FinalizeUser_data_registered_itu_t_t35.21:   ; preds = %ctrl0
...
func_FinalizeUser_data_registered_itu_t_t35.53:   ; preds = %ctrl1
  call void @FinalizeUser_data_registered_itu_t_t35.53()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_FinalizeUser_data_registered_itu_t_t35.21, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_FinalizeUser_data_registered_itu_t_t35.46, label %func_FinalizeUser_data_registered_itu_t_t35.53
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FinalizeRandomAccess.30, label %func_FinalizeRandomAccess.39

func_FinalizeRandomAccess.30:                     ; preds = %rand_bb
  call void @FinalizeRandomAccess.30()
  ret void

func_FinalizeRandomAccess.39:                     ; preds = %rand_bb
  call void @FinalizeRandomAccess.39()
  ret void
}
...
entry:
  %canary = alloca i32
  store i32 391137948, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSceneInformation.2() #0 {
entry:
  %sym = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 102283049, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.scene_information_struct, %struct.scene_information_struct* @seiSceneInformation, i32 0, i32 3), align 8
...
entry:
  ...
  %sym = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 450478790, i32* %canary
  %currLayer.addr = alloca i32, align 4
  store i32 %currLayer, i32* %currLayer.addr, align 4
  %0 = load i32, i32* %currLayer.addr, align 4
  %idxprom = sext i32 %0 to i64
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 868239343, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.subseq_char_information_struct, %struct.subseq_char_information_struct* @seiSubseqChar, i32 0, i32 10), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
  %type = getelementptr inbounds %struct.syntaxelement, %struct.syntaxelement* %sym, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeUser_data_unregistered.5() #0 {
entry:
  %sym = alloca %struct.syntaxelement, align 8
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1540282297, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_unregistered_information_struct, %struct.user_data_unregistered_information_struct* @seiUser_data_unregistered, i32 0, i32 2), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
  %type = getelementptr inbounds %struct.syntaxelement, %struct.syntaxelement* %sym, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSubseqLayerInfo.6() #0 {
entry:
  %canary = alloca i32
  store i32 1680353588, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSceneInformation.7() #0 {
entry:
  %canary = alloca i32
  store i32 1188714650, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  %sym = alloca %struct.syntaxelement, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.scene_information_struct, %struct.scene_information_struct* @seiSceneInformation, i32 0, i32 3), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @ComposeSparePictureMessage.8(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream) #0 {
entry:
  %sym = alloca %struct.syntaxelement, align 8
  %delta_spare_frame_num.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 642950923, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSpareMBMap.9() #0 {
entry:
  %CurrFrameNum = alloca i32, align 4
  %canary = alloca i32
  store i32 647687523, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %delta_frame_num = alloca i32, align 4
  %dest = alloca %struct.Bitstream*, align 8
  %source = alloca %struct.Bitstream*, align 8
...
entry:
  %canary = alloca i32
  store i32 1847618261, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  %sym = alloca %struct.syntaxelement, align 8
  %i = alloca i32, align 4
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_registered_itu_t_t35_information_struct, %struct.user_data_registered_itu_t_t35_information_struct* @seiUser_data_registered_itu_t_t35, i32 0, i32 4), align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateUser_data_registered_itu_t_t35.11() #0 {
entry:
  %temp_data = alloca i32, align 4
  %total_byte = alloca i32, align 4
  %canary = alloca i32
  store i32 382684071, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSubseqChar.12() #0 {
entry:
  %sym = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 210043571, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  %i = alloca i32, align 4
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.subseq_char_information_struct, %struct.subseq_char_information_struct* @seiSubseqChar, i32 0, i32 10), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
...
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1292127956, i32* %canary
  %pos = alloca i32, align 4
  store i32 0, i32* %pos, align 4
  store i32 0, i32* getelementptr inbounds (%struct.subseq_layer_information_struct, %struct.subseq_layer_information_struct* @seiSubseqLayerInfo, i32 0, i32 4), align 4
  store i32 0, i32* %i, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_sei_message.15(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type) #0 {
entry:
  %payload_type.addr = alloca i32, align 4
  %offset = alloca i32, align 4
  %payload.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1754589631, i32* %canary
...
entry:
  %dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 783873843, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %i = alloca i32, align 4
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.subseq_char_information_struct, %struct.subseq_char_information_struct* @seiSubseqChar, i32 0, i32 10), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
...
entry:
  %canary = alloca i32
  store i32 1646025175, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %dest = alloca %struct.Bitstream*, align 8
  %currLayer.addr = alloca i32, align 4
  store i32 %currLayer, i32* %currLayer.addr, align 4
...
entry:
  ...
  %total_byte = alloca i32, align 4
  %canary = alloca i32
  store i32 158917512, i32* %canary
  %temp_data = alloca i32, align 4
  store i32 7, i32* %total_byte, align 4
  store i32 0, i32* %i, align 4
  br label %for.cond
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeUser_data_unregistered.19() #0 {
entry:
  %canary = alloca i32
  store i32 1121726051, i32* %canary
  %i = alloca i32, align 4
  %sym = alloca %struct.syntaxelement, align 8
  %dest = alloca %struct.Bitstream*, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_unregistered_information_struct, %struct.user_data_unregistered_information_struct* @seiUser_data_unregistered, i32 0, i32 2), align 8
...
entry:
  %sym = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 1964594696, i32* %canary
  %i = alloca i32, align 4
  %dest = alloca %struct.Bitstream*, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.subseq_char_information_struct, %struct.subseq_char_information_struct* @seiSubseqChar, i32 0, i32 10), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 424143815, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_registered_itu_t_t35_information_struct, %struct.user_data_registered_itu_t_t35_information_struct* @seiUser_data_registered_itu_t_t35, i32 0, i32 4), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
  %type = getelementptr inbounds %struct.syntaxelement, %struct.syntaxelement* %sym, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @AppendTmpbits2Buf.22(%struct.Bitstream* %dest, %struct.Bitstream* %source) #0 {
entry:
  %i = alloca i32, align 4
  ...
  %canary = alloca i32
  store i32 392875595, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizePanScanRectInfo.23() #0 {
entry:
  %dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 1297418167, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.panscanrect_information_struct, %struct.panscanrect_information_struct* @seiPanScanRectInfo, i32 0, i32 5), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
  %type = getelementptr inbounds %struct.syntaxelement, %struct.syntaxelement* %sym, i32 0, i32 0
...
entry:
  ...
  %source = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 405283643, i32* %canary
  %delta_frame_num = alloca i32, align 4
  %sym = alloca %struct.syntaxelement, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %number = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSubseqInfo.25(i32 %currLayer) #0 {
entry:
  %canary = alloca i32
  store i32 1308679619, i32* %canary
  %currLayer.addr = alloca i32, align 4
  %dest = alloca %struct.Bitstream*, align 8
  %sym = alloca %struct.syntaxelement, align 8
  store i32 %currLayer, i32* %currLayer.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @CompressSpareMBMap.26(i8** %map_sp, %struct.Bitstream* %bitstream) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 628361592, i32* %canary
...
entry:
  ...
  %payload_type.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1314940060, i32* %canary
  %size = alloca i32, align 4
  store i32 %id, i32* %id.addr, align 4
  store i8* %payload, i8** %payload.addr, align 8
  store i32 %payload_size, i32* %payload_size.addr, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 444501313, i32* %canary
...
entry:
  ...
  %sym = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 1096478223, i32* %canary
  %i = alloca i32, align 4
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_unregistered_information_struct, %struct.user_data_unregistered_information_struct* @seiUser_data_unregistered, i32 0, i32 2), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
  %type = getelementptr inbounds %struct.syntaxelement, %struct.syntaxelement* %sym, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeRandomAccess.30() #0 {
entry:
  %sym = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 984595678, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.randomaccess_information_struct, %struct.randomaccess_information_struct* @seiRandomAccess, i32 0, i32 3), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
  %type = getelementptr inbounds %struct.syntaxelement, %struct.syntaxelement* %sym, i32 0, i32 0
...
entry:
  ...
  %top = alloca i32, align 4
  %canary = alloca i32
  store i32 449256752, i32* %canary
  %map_sp.addr = alloca i8**, align 8
  %bit0 = alloca i32, align 4
  %j = alloca i32, align 4
  %bitstream.addr = alloca %struct.Bitstream*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeSpareMBMap.32() #0 {
entry:
  %sym = alloca %struct.syntaxelement, align 8
  %source = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 887488075, i32* %canary
  %delta_frame_num = alloca i32, align 4
  %dest = alloca %struct.Bitstream*, align 8
  %CurrFrameNum = alloca i32, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
entry:
  %country_code = alloca i32, align 4
  %canary = alloca i32
  store i32 962717031, i32* %canary
  %total_byte = alloca i32, align 4
  %i = alloca i32, align 4
  %temp_data = alloca i32, align 4
  store i32 82, i32* %country_code, align 4
...
entry:
  ...
  %bitstream.addr = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 2114738436, i32* %canary
  %j = alloca i32, align 4
  %right = alloca i32, align 4
  %size_uncompressed = alloca i32, align 4
  %map_sp.addr = alloca i8**, align 8
...
if.end190:                                        ; preds = %for.end189, %if.end141
  %121 = load i32, i32* %ret, align 4
  %122 = load i32, i32* %canary
  %123 = icmp eq i32 %122, 2114738436
  br i1 %123, label %124, label %func_exit
...
entry:
  %canary = alloca i32
  store i32 1100494378, i32* %canary
  %i = alloca i32, align 4
  %country_code = alloca i32, align 4
  %total_byte = alloca i32, align 4
  %temp_data = alloca i32, align 4
...
entry:
  %temp_data = alloca i32, align 4
  %canary = alloca i32
  store i32 157193828, i32* %canary
  %i = alloca i32, align 4
  %total_byte = alloca i32, align 4
  store i32 7, i32* %total_byte, align 4
  store i32 0, i32* %i, align 4
...
entry:
  %dest.addr = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 469044524, i32* %canary
  %i = alloca i32, align 4
  %source.addr = alloca %struct.Bitstream*, align 8
  %j = alloca i32, align 4
  %bits_in_last_byte = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeRandomAccess.39() #0 {
entry:
  %dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 1768311081, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.randomaccess_information_struct, %struct.randomaccess_information_struct* @seiRandomAccess, i32 0, i32 3), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
  %type = getelementptr inbounds %struct.syntaxelement, %struct.syntaxelement* %sym, i32 0, i32 0
...
entry:
  ...
  %map_sp.addr = alloca i8**, align 8
  %canary = alloca i32
  store i32 483525224, i32* %canary
  %noc = alloca i32, align 4
  %y = alloca i32, align 4
  %ret = alloca i32, align 4
  %size_compressed = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizePanScanRectInfo.41() #0 {
entry:
  %sym = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 429972479, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.panscanrect_information_struct, %struct.panscanrect_information_struct* @seiPanScanRectInfo, i32 0, i32 5), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
  %type = getelementptr inbounds %struct.syntaxelement, %struct.syntaxelement* %sym, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateUser_data_registered_itu_t_t35.42() #0 {
entry:
  %temp_data = alloca i32, align 4
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 475662985, i32* %canary
  %country_code = alloca i32, align 4
  %total_byte = alloca i32, align 4
  store i32 82, i32* %country_code, align 4
  %0 = load i32, i32* %country_code, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateSceneInformation.43(i32 %HasSceneInformation, i32 %sceneID, i32 %sceneTransType, i32 %secondSceneID) #0 {
entry:
  %secondSceneID.addr = alloca i32, align 4
  %sceneTransType.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 836860326, i32* %canary
  %sceneID.addr = alloca i32, align 4
  %HasSceneInformation.addr = alloca i32, align 4
  store i32 %HasSceneInformation, i32* %HasSceneInformation.addr, align 4
  store i32 %sceneID, i32* %sceneID.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @ComposeSparePictureMessage.44(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream) #0 {
entry:
  %delta_spare_frame_num.addr = alloca i32, align 4
  %ref_area_indicator.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1291884519, i32* %canary
  %bitstream = alloca %struct.Bitstream*, align 8
  %sym = alloca %struct.syntaxelement, align 8
  %tmpBitstream.addr = alloca %struct.Bitstream*, align 8
  store i32 %delta_spare_frame_num, i32* %delta_spare_frame_num.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @finalize_sei_message.45(i32 %id) #0 {
entry:
  %canary = alloca i32
  store i32 868977274, i32* %canary
  %offset = alloca i32, align 4
  %id.addr = alloca i32, align 4
  store i32 %id, i32* %id.addr, align 4
  %0 = load i32, i32* %id.addr, align 4
...
entry:
  %sym = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 1047044130, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  %i = alloca i32, align 4
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_registered_itu_t_t35_information_struct, %struct.user_data_registered_itu_t_t35_information_struct* @seiUser_data_registered_itu_t_t35, i32 0, i32 4), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
...
entry:
  ...
  %sym = alloca %struct.syntaxelement, align 8
  %canary = alloca i32
  store i32 1191093841, i32* %canary
  %dest = alloca %struct.Bitstream*, align 8
  store i32 %currLayer, i32* %currLayer.addr, align 4
  %0 = load i32, i32* %currLayer.addr, align 4
  %idxprom = sext i32 %0 to i64
...
entry:
  %canary = alloca i32
  store i32 306759483, i32* %canary
  %HasSceneInformation.addr = alloca i32, align 4
  %sceneTransType.addr = alloca i32, align 4
  %secondSceneID.addr = alloca i32, align 4
  %sceneID.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @ComposeSparePictureMessage.49(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream) #0 {
entry:
  %canary = alloca i32
  store i32 547074520, i32* %canary
  %bitstream = alloca %struct.Bitstream*, align 8
  %delta_spare_frame_num.addr = alloca i32, align 4
  %tmpBitstream.addr = alloca %struct.Bitstream*, align 8
  %sym = alloca %struct.syntaxelement, align 8
...
entry:
  ...
  %total_byte = alloca i32, align 4
  %canary = alloca i32
  store i32 1451571568, i32* %canary
  %i = alloca i32, align 4
  store i32 7, i32* %total_byte, align 4
  store i32 0, i32* %i, align 4
  br label %for.cond
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @ComposeSparePictureMessage.51(i32 %delta_spare_frame_num, i32 %ref_area_indicator, %struct.Bitstream* %tmpBitstream) #0 {
entry:
  %delta_spare_frame_num.addr = alloca i32, align 4
  %tmpBitstream.addr = alloca %struct.Bitstream*, align 8
  %sym = alloca %struct.syntaxelement, align 8
  %ref_area_indicator.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1514378923, i32* %canary
  %bitstream = alloca %struct.Bitstream*, align 8
  store i32 %delta_spare_frame_num, i32* %delta_spare_frame_num.addr, align 4
  store i32 %ref_area_indicator, i32* %ref_area_indicator.addr, align 4
  store %struct.Bitstream* %tmpBitstream, %struct.Bitstream** %tmpBitstream.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateSceneInformation.52(i32 %HasSceneInformation, i32 %sceneID, i32 %sceneTransType, i32 %secondSceneID) #0 {
entry:
  %canary = alloca i32
  store i32 884962095, i32* %canary
  %sceneTransType.addr = alloca i32, align 4
  %secondSceneID.addr = alloca i32, align 4
  %HasSceneInformation.addr = alloca i32, align 4
  %sceneID.addr = alloca i32, align 4
...
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 808685827, i32* %canary
  %sym = alloca %struct.syntaxelement, align 8
  %dest = alloca %struct.Bitstream*, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_registered_itu_t_t35_information_struct, %struct.user_data_registered_itu_t_t35_information_struct* @seiUser_data_registered_itu_t_t35, i32 0, i32 4), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FinalizeUser_data_unregistered.54() #0 {
entry:
  %dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 1033420233, i32* %canary
  %i = alloca i32, align 4
  %sym = alloca %struct.syntaxelement, align 8
  %0 = load %struct.Bitstream*, %struct.Bitstream** getelementptr inbounds (%struct.user_data_unregistered_information_struct, %struct.user_data_unregistered_information_struct* @seiUser_data_unregistered, i32 0, i32 2), align 8
  store %struct.Bitstream* %0, %struct.Bitstream** %dest, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @UpdateUser_data_unregistered.55() #0 {
entry:
  %canary = alloca i32
  store i32 1649749212, i32* %canary
  %total_byte = alloca i32, align 4
  %temp_data = alloca i32, align 4
  %i = alloca i32, align 4
  store i32 7, i32* %total_byte, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_sei_message.56(i32 %id, i8* %payload, i32 %payload_size, i32 %payload_type) #0 {
entry:
  %size = alloca i32, align 4
  %offset = alloca i32, align 4
  %canary = alloca i32
  store i32 1283693692, i32* %canary
  %id.addr = alloca i32, align 4
  %type = alloca i32, align 4
  %payload_size.addr = alloca i32, align 4
  %payload_type.addr = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 2073062597, i32* %canary
  %dest.addr = alloca %struct.Bitstream*, align 8
  %bits_in_last_byte = alloca i32, align 4
  %mask = alloca i8, align 1
  %source.addr = alloca %struct.Bitstream*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @AppendTmpbits2Buf.58(%struct.Bitstream* %dest, %struct.Bitstream* %source) #0 {
entry:
  %i = alloca i32, align 4
  %source.addr = alloca %struct.Bitstream*, align 8
  %bits_in_last_byte = alloca i32, align 4
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 708720597, i32* %canary
  %dest.addr = alloca %struct.Bitstream*, align 8
  store %struct.Bitstream* %dest, %struct.Bitstream** %dest.addr, align 8
  store %struct.Bitstream* %source, %struct.Bitstream** %source.addr, align 8
  store i32 0, i32* %i, align 4
