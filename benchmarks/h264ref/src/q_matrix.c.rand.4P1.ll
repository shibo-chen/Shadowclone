; ModuleID = 'q_matrix.c.rand.4P1.bc'
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_CheckParameterName.3, label %ctrl0

func_CheckParameterName.3:                        ; preds = %rand_bb
  %2 = call i32 @CheckParameterName.3(i8* %s, i32* %type)
  ret i32 %2

func_CheckParameterName.4:                        ; preds = %ctrl0
  %3 = call i32 @CheckParameterName.4(i8* %s, i32* %type)
  ret i32 %3

func_CheckParameterName.7:                        ; preds = %ctrl1
  %4 = call i32 @CheckParameterName.7(i8* %s, i32* %type)
  ret i32 %4

func_CheckParameterName.9:                        ; preds = %ctrl1
  %5 = call i32 @CheckParameterName.9(i8* %s, i32* %type)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_CheckParameterName.4, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_CheckParameterName.7, label %func_CheckParameterName.9
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_ParseMatrix.1, label %ctrl0

func_ParseMatrix.1:                               ; preds = %rand_bb
  call void @ParseMatrix.1(i8* %buf, i32 %bufsize)
  ret void

func_ParseMatrix.6:                               ; preds = %ctrl0
  call void @ParseMatrix.6(i8* %buf, i32 %bufsize)
  ret void

func_ParseMatrix.16:                              ; preds = %ctrl1
  call void @ParseMatrix.16(i8* %buf, i32 %bufsize)
  ret void

func_ParseMatrix.18:                              ; preds = %ctrl1
  call void @ParseMatrix.18(i8* %buf, i32 %bufsize)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_ParseMatrix.6, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_ParseMatrix.16, label %func_ParseMatrix.18
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_PatchMatrix.2, label %ctrl0

func_PatchMatrix.2:                               ; preds = %rand_bb
  call void @PatchMatrix.2()
  ret void

func_PatchMatrix.8:                               ; preds = %ctrl0
  call void @PatchMatrix.8()
  ret void

func_PatchMatrix.10:                              ; preds = %ctrl1
  call void @PatchMatrix.10()
  ret void

func_PatchMatrix.11:                              ; preds = %ctrl1
  call void @PatchMatrix.11()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_PatchMatrix.8, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_PatchMatrix.10, label %func_PatchMatrix.11
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_CalculateQuantParam.5, label %ctrl0

func_CalculateQuantParam.5:                       ; preds = %rand_bb
  call void @CalculateQuantParam.5()
  ret void

func_CalculateQuantParam.13:                      ; preds = %ctrl0
  call void @CalculateQuantParam.13()
  ret void

func_CalculateQuantParam.15:                      ; preds = %ctrl1
  call void @CalculateQuantParam.15()
  ret void

func_CalculateQuantParam.17:                      ; preds = %ctrl1
  call void @CalculateQuantParam.17()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_CalculateQuantParam.13, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_CalculateQuantParam.15, label %func_CalculateQuantParam.17
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_CalculateQuant8Param.12, label %ctrl0

func_CalculateQuant8Param.12:                     ; preds = %rand_bb
  call void @CalculateQuant8Param.12()
  ret void

func_CalculateQuant8Param.14:                     ; preds = %ctrl0
  call void @CalculateQuant8Param.14()
  ret void

func_CalculateQuant8Param.19:                     ; preds = %ctrl1
  call void @CalculateQuant8Param.19()
  ret void

func_CalculateQuant8Param.20:                     ; preds = %ctrl1
  call void @CalculateQuant8Param.20()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_CalculateQuant8Param.14, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_CalculateQuant8Param.19, label %func_CalculateQuant8Param.20
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @ParseMatrix.1(i8* %buf, i32 %bufsize) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 502682311, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @PatchMatrix.2() #0 {
entry:
  %cnt = alloca i32, align 4
  %canary = alloca i32
  store i32 2054755148, i32* %canary
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @CheckParameterName.3(i8* %s, i32* %type) #0 {
entry:
  %type.addr = alloca i32*, align 8
  %s.addr = alloca i8*, align 8
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 616922990, i32* %canary
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @CheckParameterName.4(i8* %s, i32* %type) #0 {
entry:
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 2071275977, i32* %canary
  %i = alloca i32, align 4
  %type.addr = alloca i32*, align 8
  %s.addr = alloca i8*, align 8
  store i8* %s, i8** %s.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @CalculateQuantParam.5() #0 {
entry:
  %j = alloca i32, align 4
  %k = alloca i32, align 4
  %canary = alloca i32
  store i32 1830776994, i32* %canary
  %i = alloca i32, align 4
...
if.end682:                                        ; preds = %for.end681, %for.end200
  ...
  %360 = icmp eq i32 %359, 1830776994
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @ParseMatrix.6(i8* %buf, i32 %bufsize) #0 {
entry:
  %items = alloca [1000 x i8*], align 16
  %buf.addr = alloca i8*, align 8
  %p = alloca i8*, align 8
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1594066187, i32* %canary
  %bufsize.addr = alloca i32, align 4
  %type = alloca i32, align 4
  %InString = alloca i32, align 4
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @CheckParameterName.7(i8* %s, i32* %type) #0 {
entry:
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1666358801, i32* %canary
  %s.addr = alloca i8*, align 8
  %type.addr = alloca i32*, align 8
  %i = alloca i32, align 4
  store i8* %s, i8** %s.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @PatchMatrix.8() #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1573058603, i32* %canary
  %ScalingList = alloca i16*, align 8
  %cnt = alloca i32, align 4
  %fail = alloca i32, align 4
  store i32 0, i32* %i, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @CheckParameterName.9(i8* %s, i32* %type) #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 935445772, i32* %canary
  %retval = alloca i32, align 4
  %type.addr = alloca i32*, align 8
  %s.addr = alloca i8*, align 8
  store i8* %s, i8** %s.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @PatchMatrix.10() #0 {
entry:
  %canary = alloca i32
  store i32 168289466, i32* %canary
  %fail = alloca i32, align 4
  %cnt = alloca i32, align 4
  %i = alloca i32, align 4
  %ScalingList = alloca i16*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @PatchMatrix.11() #0 {
entry:
  %i = alloca i32, align 4
  %cnt = alloca i32, align 4
  %fail = alloca i32, align 4
  %canary = alloca i32
  store i32 483240321, i32* %canary
  %ScalingList = alloca i16*, align 8
  store i32 0, i32* %i, align 4
  br label %for.cond
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @CalculateQuant8Param.12() #0 {
entry:
  %temp = alloca i32, align 4
  %no_q_matrix = alloca i32, align 4
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1445048417, i32* %canary
  %k = alloca i32, align 4
  %i = alloca i32, align 4
  store i32 0, i32* %no_q_matrix, align 4
  %0 = load %struct.seq_parameter_set_rbsp_t*, %struct.seq_parameter_set_rbsp_t** @active_sps, align 8
...
if.end257:                                        ; preds = %for.end256, %for.end91
  ...
  %142 = icmp eq i32 %141, 1445048417
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @CalculateQuantParam.13() #0 {
entry:
  %i = alloca i32, align 4
  %no_q_matrix = alloca i32, align 4
  %present = alloca [6 x i32], align 16
  %canary = alloca i32
  store i32 537522949, i32* %canary
  %k = alloca i32, align 4
  %j = alloca i32, align 4
  %temp = alloca i32, align 4
  store i32 0, i32* %no_q_matrix, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @CalculateQuant8Param.14() #0 {
entry:
  %i = alloca i32, align 4
  %k = alloca i32, align 4
  %temp = alloca i32, align 4
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 305143644, i32* %canary
  %present = alloca [2 x i32], align 4
  store i32 0, i32* %no_q_matrix, align 4
  %0 = load %struct.seq_parameter_set_rbsp_t*, %struct.seq_parameter_set_rbsp_t** @active_sps, align 8
  %seq_scaling_matrix_present_flag = getelementptr inbounds %struct.seq_parameter_set_rbsp_t, %struct.seq_parameter_set_rbsp_t* %0, i32 0, i32 9
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @CalculateQuantParam.15() #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 658418520, i32* %canary
  %present = alloca [6 x i32], align 16
  %k = alloca i32, align 4
  %temp = alloca i32, align 4
  %no_q_matrix = alloca i32, align 4
...
entry:
  ...
  %cnt = alloca i32, align 4
  %canary = alloca i32
  store i32 1633444407, i32* %canary
  %j = alloca i32, align 4
  %i = alloca i32, align 4
  %p = alloca i8*, align 8
  store i8* %buf, i8** %buf.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @CalculateQuantParam.17() #0 {
entry:
  %temp = alloca i32, align 4
  %canary = alloca i32
  store i32 800401654, i32* %canary
  %k = alloca i32, align 4
  %j = alloca i32, align 4
  %i = alloca i32, align 4
  %no_q_matrix = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @ParseMatrix.18(i8* %buf, i32 %bufsize) #0 {
entry:
  %j = alloca i32, align 4
  %ScalingList = alloca i16*, align 8
  %p = alloca i8*, align 8
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1767553006, i32* %canary
  %no_q_matrix = alloca i32, align 4
  store i32 0, i32* %no_q_matrix, align 4
  %0 = load %struct.seq_parameter_set_rbsp_t*, %struct.seq_parameter_set_rbsp_t** @active_sps, align 8
  %seq_scaling_matrix_present_flag = getelementptr inbounds %struct.seq_parameter_set_rbsp_t, %struct.seq_parameter_set_rbsp_t* %0, i32 0, i32 9
...
if.end257:                                        ; preds = %for.end256, %for.end91
  %141 = load i32, i32* %canary
  %142 = icmp eq i32 %141, 1767553006
  br i1 %142, label %143, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @CalculateQuant8Param.20() #0 {
entry:
  %present = alloca [2 x i32], align 4
  %k = alloca i32, align 4
  %i = alloca i32, align 4
  ...
  %temp = alloca i32, align 4
  %canary = alloca i32
  store i32 1064763728, i32* %canary
  %no_q_matrix = alloca i32, align 4
  store i32 0, i32* %no_q_matrix, align 4
  %0 = load %struct.seq_parameter_set_rbsp_t*, %struct.seq_parameter_set_rbsp_t** @active_sps, align 8
  %seq_scaling_matrix_present_flag = getelementptr inbounds %struct.seq_parameter_set_rbsp_t, %struct.seq_parameter_set_rbsp_t* %0, i32 0, i32 9
...
if.end257:                                        ; preds = %for.end256, %for.end91
  %141 = load i32, i32* %canary
  %142 = icmp eq i32 %141, 1064763728
  br i1 %142, label %143, label %func_exit
