...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FmoInit.5, label %ctrl0

func_FmoInit.5:                                   ; preds = %rand_bb
  %2 = call i32 @FmoInit.5(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps, %struct.seq_parameter_set_rbsp_t* %sps)
  ret i32 %2
...
func_FmoInit.49:                                  ; preds = %ctrl1
  %4 = call i32 @FmoInit.49(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps, %struct.seq_parameter_set_rbsp_t* %sps)
  ret i32 %4

func_FmoInit.50:                                  ; preds = %ctrl2
  %5 = call i32 @FmoInit.50(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps, %struct.seq_parameter_set_rbsp_t* %sps)
  ret i32 %5

func_FmoInit.64:                                  ; preds = %ctrl3
  %6 = call i32 @FmoInit.64(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps, %struct.seq_parameter_set_rbsp_t* %sps)
  ret i32 %6

func_FmoInit.74:                                  ; preds = %ctrl4
  %7 = call i32 @FmoInit.74(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps, %struct.seq_parameter_set_rbsp_t* %sps)
  ret i32 %7

func_FmoInit.82:                                  ; preds = %ctrl5
  %8 = call i32 @FmoInit.82(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps, %struct.seq_parameter_set_rbsp_t* %sps)
  ret i32 %8

func_FmoInit.94:                                  ; preds = %ctrl5
  %9 = call i32 @FmoInit.94(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps, %struct.seq_parameter_set_rbsp_t* %sps)
  ret i32 %9
...
ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_FmoInit.49, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_FmoInit.50, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_FmoInit.64, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_FmoInit.74, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_FmoInit.82, label %func_FmoInit.94
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FmoGenerateMapUnitToSliceGroupMap.9, label %ctrl0

func_FmoGenerateMapUnitToSliceGroupMap.9:         ; preds = %rand_bb
  %2 = call i32 @FmoGenerateMapUnitToSliceGroupMap.9(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret i32 %2

func_FmoGenerateMapUnitToSliceGroupMap.10:        ; preds = %ctrl0
  %3 = call i32 @FmoGenerateMapUnitToSliceGroupMap.10(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret i32 %3

func_FmoGenerateMapUnitToSliceGroupMap.14:        ; preds = %ctrl1
  %4 = call i32 @FmoGenerateMapUnitToSliceGroupMap.14(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret i32 %4

func_FmoGenerateMapUnitToSliceGroupMap.18:        ; preds = %ctrl2
  %5 = call i32 @FmoGenerateMapUnitToSliceGroupMap.18(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret i32 %5

func_FmoGenerateMapUnitToSliceGroupMap.53:        ; preds = %ctrl3
  %6 = call i32 @FmoGenerateMapUnitToSliceGroupMap.53(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret i32 %6

func_FmoGenerateMapUnitToSliceGroupMap.65:        ; preds = %ctrl3
  %7 = call i32 @FmoGenerateMapUnitToSliceGroupMap.65(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret i32 %7

ctrl0:                                            ; preds = %rand_bb
  %8 = icmp eq i32 %0, 1
  br i1 %8, label %func_FmoGenerateMapUnitToSliceGroupMap.10, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %9 = icmp eq i32 %0, 2
  br i1 %9, label %func_FmoGenerateMapUnitToSliceGroupMap.14, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %10 = icmp eq i32 %0, 3
  br i1 %10, label %func_FmoGenerateMapUnitToSliceGroupMap.18, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %11 = icmp eq i32 %0, 4
  br i1 %11, label %func_FmoGenerateMapUnitToSliceGroupMap.53, label %func_FmoGenerateMapUnitToSliceGroupMap.65
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FmoGenerateMBAmap.11, label %ctrl0

func_FmoGenerateMBAmap.11:                        ; preds = %rand_bb
  %2 = call i32 @FmoGenerateMBAmap.11(%struct.ImageParameters* %img, %struct.seq_parameter_set_rbsp_t* %sps)
  ret i32 %2
...
func_FmoGenerateMBAmap.26:                        ; preds = %ctrl1
  %4 = call i32 @FmoGenerateMBAmap.26(%struct.ImageParameters* %img, %struct.seq_parameter_set_rbsp_t* %sps)
  ret i32 %4

func_FmoGenerateMBAmap.76:                        ; preds = %ctrl2
  %5 = call i32 @FmoGenerateMBAmap.76(%struct.ImageParameters* %img, %struct.seq_parameter_set_rbsp_t* %sps)
  ret i32 %5

func_FmoGenerateMBAmap.83:                        ; preds = %ctrl3
  %6 = call i32 @FmoGenerateMBAmap.83(%struct.ImageParameters* %img, %struct.seq_parameter_set_rbsp_t* %sps)
  ret i32 %6

func_FmoGenerateMBAmap.84:                        ; preds = %ctrl3
  %7 = call i32 @FmoGenerateMBAmap.84(%struct.ImageParameters* %img, %struct.seq_parameter_set_rbsp_t* %sps)
  ret i32 %7

ctrl0:                                            ; preds = %rand_bb
  %8 = icmp eq i32 %0, 1
  br i1 %8, label %func_FmoGenerateMBAmap.22, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %9 = icmp eq i32 %0, 2
  br i1 %9, label %func_FmoGenerateMBAmap.26, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %10 = icmp eq i32 %0, 3
  br i1 %10, label %func_FmoGenerateMBAmap.76, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %11 = icmp eq i32 %0, 4
  br i1 %11, label %func_FmoGenerateMBAmap.83, label %func_FmoGenerateMBAmap.84
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FmoGetFirstMBOfSliceGroup.4, label %ctrl0

func_FmoGetFirstMBOfSliceGroup.4:                 ; preds = %rand_bb
  %2 = call i32 @FmoGetFirstMBOfSliceGroup.4(i32 %SliceGroupID)
  ret i32 %2

func_FmoGetFirstMBOfSliceGroup.8:                 ; preds = %ctrl0
  %3 = call i32 @FmoGetFirstMBOfSliceGroup.8(i32 %SliceGroupID)
  ret i32 %3

func_FmoGetFirstMBOfSliceGroup.13:                ; preds = %ctrl1
  %4 = call i32 @FmoGetFirstMBOfSliceGroup.13(i32 %SliceGroupID)
  ret i32 %4

func_FmoGetFirstMBOfSliceGroup.28:                ; preds = %ctrl2
  %5 = call i32 @FmoGetFirstMBOfSliceGroup.28(i32 %SliceGroupID)
  ret i32 %5

func_FmoGetFirstMBOfSliceGroup.30:                ; preds = %ctrl3
  %6 = call i32 @FmoGetFirstMBOfSliceGroup.30(i32 %SliceGroupID)
  ret i32 %6

func_FmoGetFirstMBOfSliceGroup.55:                ; preds = %ctrl3
  %7 = call i32 @FmoGetFirstMBOfSliceGroup.55(i32 %SliceGroupID)
  ret i32 %7

ctrl0:                                            ; preds = %rand_bb
  %8 = icmp eq i32 %0, 1
  br i1 %8, label %func_FmoGetFirstMBOfSliceGroup.8, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %9 = icmp eq i32 %0, 2
  br i1 %9, label %func_FmoGetFirstMBOfSliceGroup.13, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %10 = icmp eq i32 %0, 3
  br i1 %10, label %func_FmoGetFirstMBOfSliceGroup.28, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %11 = icmp eq i32 %0, 4
  br i1 %11, label %func_FmoGetFirstMBOfSliceGroup.30, label %func_FmoGetFirstMBOfSliceGroup.55
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FmoGetNextMBNr.2, label %ctrl0

func_FmoGetNextMBNr.2:                            ; preds = %rand_bb
  %2 = call i32 @FmoGetNextMBNr.2(i32 %CurrentMbNr)
  ret i32 %2

func_FmoGetNextMBNr.32:                           ; preds = %ctrl0
  %3 = call i32 @FmoGetNextMBNr.32(i32 %CurrentMbNr)
  ret i32 %3

func_FmoGetNextMBNr.56:                           ; preds = %ctrl1
  %4 = call i32 @FmoGetNextMBNr.56(i32 %CurrentMbNr)
  ret i32 %4

func_FmoGetNextMBNr.59:                           ; preds = %ctrl2
  %5 = call i32 @FmoGetNextMBNr.59(i32 %CurrentMbNr)
  ret i32 %5

func_FmoGetNextMBNr.73:                           ; preds = %ctrl3
  %6 = call i32 @FmoGetNextMBNr.73(i32 %CurrentMbNr)
  ret i32 %6

func_FmoGetNextMBNr.86:                           ; preds = %ctrl3
  %7 = call i32 @FmoGetNextMBNr.86(i32 %CurrentMbNr)
  ret i32 %7

ctrl0:                                            ; preds = %rand_bb
  %8 = icmp eq i32 %0, 1
  br i1 %8, label %func_FmoGetNextMBNr.32, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %9 = icmp eq i32 %0, 2
  br i1 %9, label %func_FmoGetNextMBNr.56, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %10 = icmp eq i32 %0, 3
  br i1 %10, label %func_FmoGetNextMBNr.59, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %11 = icmp eq i32 %0, 4
  br i1 %11, label %func_FmoGetNextMBNr.73, label %func_FmoGetNextMBNr.86
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FmoGetPreviousMBNr.12, label %ctrl0

func_FmoGetPreviousMBNr.12:                       ; preds = %rand_bb
  %2 = call i32 @FmoGetPreviousMBNr.12(i32 %CurrentMbNr)
  ret i32 %2

func_FmoGetPreviousMBNr.19:                       ; preds = %ctrl0
  %3 = call i32 @FmoGetPreviousMBNr.19(i32 %CurrentMbNr)
  ret i32 %3

func_FmoGetPreviousMBNr.27:                       ; preds = %ctrl1
  %4 = call i32 @FmoGetPreviousMBNr.27(i32 %CurrentMbNr)
  ret i32 %4

func_FmoGetPreviousMBNr.37:                       ; preds = %ctrl2
  %5 = call i32 @FmoGetPreviousMBNr.37(i32 %CurrentMbNr)
  ret i32 %5

func_FmoGetPreviousMBNr.62:                       ; preds = %ctrl3
  %6 = call i32 @FmoGetPreviousMBNr.62(i32 %CurrentMbNr)
  ret i32 %6

func_FmoGetPreviousMBNr.70:                       ; preds = %ctrl3
  %7 = call i32 @FmoGetPreviousMBNr.70(i32 %CurrentMbNr)
  ret i32 %7

ctrl0:                                            ; preds = %rand_bb
  %8 = icmp eq i32 %0, 1
  br i1 %8, label %func_FmoGetPreviousMBNr.19, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %9 = icmp eq i32 %0, 2
  br i1 %9, label %func_FmoGetPreviousMBNr.27, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %10 = icmp eq i32 %0, 3
  br i1 %10, label %func_FmoGetPreviousMBNr.37, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %11 = icmp eq i32 %0, 4
  br i1 %11, label %func_FmoGetPreviousMBNr.62, label %func_FmoGetPreviousMBNr.70
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FmoGetLastCodedMBOfSliceGroup.20, label %ctrl0

func_FmoGetLastCodedMBOfSliceGroup.20:            ; preds = %rand_bb
  %2 = call i32 @FmoGetLastCodedMBOfSliceGroup.20(i32 %SliceGroupID)
  ret i32 %2

func_FmoGetLastCodedMBOfSliceGroup.24:            ; preds = %ctrl0
  %3 = call i32 @FmoGetLastCodedMBOfSliceGroup.24(i32 %SliceGroupID)
  ret i32 %3

func_FmoGetLastCodedMBOfSliceGroup.36:            ; preds = %ctrl1
  %4 = call i32 @FmoGetLastCodedMBOfSliceGroup.36(i32 %SliceGroupID)
  ret i32 %4

func_FmoGetLastCodedMBOfSliceGroup.40:            ; preds = %ctrl2
  %5 = call i32 @FmoGetLastCodedMBOfSliceGroup.40(i32 %SliceGroupID)
  ret i32 %5

func_FmoGetLastCodedMBOfSliceGroup.57:            ; preds = %ctrl3
  %6 = call i32 @FmoGetLastCodedMBOfSliceGroup.57(i32 %SliceGroupID)
  ret i32 %6

func_FmoGetLastCodedMBOfSliceGroup.58:            ; preds = %ctrl3
  %7 = call i32 @FmoGetLastCodedMBOfSliceGroup.58(i32 %SliceGroupID)
  ret i32 %7

ctrl0:                                            ; preds = %rand_bb
  %8 = icmp eq i32 %0, 1
  br i1 %8, label %func_FmoGetLastCodedMBOfSliceGroup.24, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %9 = icmp eq i32 %0, 2
  br i1 %9, label %func_FmoGetLastCodedMBOfSliceGroup.36, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %10 = icmp eq i32 %0, 3
  br i1 %10, label %func_FmoGetLastCodedMBOfSliceGroup.40, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %11 = icmp eq i32 %0, 4
  br i1 %11, label %func_FmoGetLastCodedMBOfSliceGroup.57, label %func_FmoGetLastCodedMBOfSliceGroup.58
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FmoSetLastMacroblockInSlice.6, label %func_FmoSetLastMacroblockInSlice.33

func_FmoSetLastMacroblockInSlice.6:               ; preds = %rand_bb
  call void @FmoSetLastMacroblockInSlice.6(i32 %mb)
  ret void

func_FmoSetLastMacroblockInSlice.33:              ; preds = %rand_bb
  call void @FmoSetLastMacroblockInSlice.33(i32 %mb)
  ret void
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FmoSliceGroupCompletelyCoded.35, label %func_FmoSliceGroupCompletelyCoded.39

func_FmoSliceGroupCompletelyCoded.35:             ; preds = %rand_bb
  %2 = call i32 @FmoSliceGroupCompletelyCoded.35(i32 %SliceGroupID)
  ret i32 %2

func_FmoSliceGroupCompletelyCoded.39:             ; preds = %rand_bb
  %3 = call i32 @FmoSliceGroupCompletelyCoded.39(i32 %SliceGroupID)
  ret i32 %3
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FmoGenerateType0MapUnitMap.43, label %ctrl0

func_FmoGenerateType0MapUnitMap.43:               ; preds = %rand_bb
  call void @FmoGenerateType0MapUnitMap.43(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType0MapUnitMap.45:               ; preds = %ctrl0
  call void @FmoGenerateType0MapUnitMap.45(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType0MapUnitMap.46:               ; preds = %ctrl1
  call void @FmoGenerateType0MapUnitMap.46(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType0MapUnitMap.47:               ; preds = %ctrl2
  call void @FmoGenerateType0MapUnitMap.47(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType0MapUnitMap.63:               ; preds = %ctrl3
  call void @FmoGenerateType0MapUnitMap.63(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType0MapUnitMap.78:               ; preds = %ctrl4
  call void @FmoGenerateType0MapUnitMap.78(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType0MapUnitMap.95:               ; preds = %ctrl5
  call void @FmoGenerateType0MapUnitMap.95(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType0MapUnitMap.98:               ; preds = %ctrl5
  call void @FmoGenerateType0MapUnitMap.98(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_FmoGenerateType0MapUnitMap.45, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_FmoGenerateType0MapUnitMap.46, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_FmoGenerateType0MapUnitMap.47, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_FmoGenerateType0MapUnitMap.63, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_FmoGenerateType0MapUnitMap.78, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_FmoGenerateType0MapUnitMap.95, label %func_FmoGenerateType0MapUnitMap.98
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FmoGenerateType1MapUnitMap.1, label %ctrl0

func_FmoGenerateType1MapUnitMap.1:                ; preds = %rand_bb
  call void @FmoGenerateType1MapUnitMap.1(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType1MapUnitMap.15:               ; preds = %ctrl0
  call void @FmoGenerateType1MapUnitMap.15(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType1MapUnitMap.23:               ; preds = %ctrl1
  call void @FmoGenerateType1MapUnitMap.23(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType1MapUnitMap.29:               ; preds = %ctrl2
  call void @FmoGenerateType1MapUnitMap.29(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType1MapUnitMap.38:               ; preds = %ctrl3
  call void @FmoGenerateType1MapUnitMap.38(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType1MapUnitMap.51:               ; preds = %ctrl3
  call void @FmoGenerateType1MapUnitMap.51(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_FmoGenerateType1MapUnitMap.15, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_FmoGenerateType1MapUnitMap.23, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_FmoGenerateType1MapUnitMap.29, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_FmoGenerateType1MapUnitMap.38, label %func_FmoGenerateType1MapUnitMap.51
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FmoGenerateType2MapUnitMap.17, label %ctrl0

func_FmoGenerateType2MapUnitMap.17:               ; preds = %rand_bb
  call void @FmoGenerateType2MapUnitMap.17(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType2MapUnitMap.60:               ; preds = %ctrl0
  call void @FmoGenerateType2MapUnitMap.60(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType2MapUnitMap.69:               ; preds = %ctrl1
  call void @FmoGenerateType2MapUnitMap.69(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType2MapUnitMap.75:               ; preds = %ctrl2
  call void @FmoGenerateType2MapUnitMap.75(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType2MapUnitMap.85:               ; preds = %ctrl3
  call void @FmoGenerateType2MapUnitMap.85(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType2MapUnitMap.92:               ; preds = %ctrl4
  call void @FmoGenerateType2MapUnitMap.92(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType2MapUnitMap.93:               ; preds = %ctrl5
  call void @FmoGenerateType2MapUnitMap.93(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_FmoGenerateType2MapUnitMap.60, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_FmoGenerateType2MapUnitMap.69, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_FmoGenerateType2MapUnitMap.75, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_FmoGenerateType2MapUnitMap.85, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_FmoGenerateType2MapUnitMap.92, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_FmoGenerateType2MapUnitMap.93, label %func_FmoGenerateType2MapUnitMap.100
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FmoGenerateType3MapUnitMap.54, label %ctrl0

func_FmoGenerateType3MapUnitMap.54:               ; preds = %rand_bb
  call void @FmoGenerateType3MapUnitMap.54(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType3MapUnitMap.80:               ; preds = %ctrl0
  call void @FmoGenerateType3MapUnitMap.80(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType3MapUnitMap.81:               ; preds = %ctrl1
  call void @FmoGenerateType3MapUnitMap.81(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType3MapUnitMap.88:               ; preds = %ctrl2
  call void @FmoGenerateType3MapUnitMap.88(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType3MapUnitMap.89:               ; preds = %ctrl3
  call void @FmoGenerateType3MapUnitMap.89(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType3MapUnitMap.90:               ; preds = %ctrl4
  call void @FmoGenerateType3MapUnitMap.90(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType3MapUnitMap.91:               ; preds = %ctrl5
  call void @FmoGenerateType3MapUnitMap.91(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType3MapUnitMap.97:               ; preds = %ctrl5
  call void @FmoGenerateType3MapUnitMap.97(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_FmoGenerateType3MapUnitMap.80, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_FmoGenerateType3MapUnitMap.81, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_FmoGenerateType3MapUnitMap.88, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_FmoGenerateType3MapUnitMap.89, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_FmoGenerateType3MapUnitMap.90, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_FmoGenerateType3MapUnitMap.91, label %func_FmoGenerateType3MapUnitMap.97
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FmoGenerateType4MapUnitMap.7, label %ctrl0

func_FmoGenerateType4MapUnitMap.7:                ; preds = %rand_bb
  call void @FmoGenerateType4MapUnitMap.7(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType4MapUnitMap.41:               ; preds = %ctrl0
  call void @FmoGenerateType4MapUnitMap.41(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType4MapUnitMap.42:               ; preds = %ctrl1
  call void @FmoGenerateType4MapUnitMap.42(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType4MapUnitMap.67:               ; preds = %ctrl2
  call void @FmoGenerateType4MapUnitMap.67(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType4MapUnitMap.79:               ; preds = %ctrl3
  call void @FmoGenerateType4MapUnitMap.79(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType4MapUnitMap.87:               ; preds = %ctrl4
  call void @FmoGenerateType4MapUnitMap.87(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType4MapUnitMap.96:               ; preds = %ctrl5
  call void @FmoGenerateType4MapUnitMap.96(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType4MapUnitMap.99:               ; preds = %ctrl5
  call void @FmoGenerateType4MapUnitMap.99(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_FmoGenerateType4MapUnitMap.41, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_FmoGenerateType4MapUnitMap.42, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_FmoGenerateType4MapUnitMap.67, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_FmoGenerateType4MapUnitMap.79, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_FmoGenerateType4MapUnitMap.87, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_FmoGenerateType4MapUnitMap.96, label %func_FmoGenerateType4MapUnitMap.99
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FmoGenerateType5MapUnitMap.21, label %ctrl0

func_FmoGenerateType5MapUnitMap.21:               ; preds = %rand_bb
  call void @FmoGenerateType5MapUnitMap.21(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType5MapUnitMap.44:               ; preds = %ctrl0
  call void @FmoGenerateType5MapUnitMap.44(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType5MapUnitMap.48:               ; preds = %ctrl1
  call void @FmoGenerateType5MapUnitMap.48(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType5MapUnitMap.52:               ; preds = %ctrl2
  call void @FmoGenerateType5MapUnitMap.52(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType5MapUnitMap.61:               ; preds = %ctrl3
  call void @FmoGenerateType5MapUnitMap.61(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType5MapUnitMap.66:               ; preds = %ctrl4
  call void @FmoGenerateType5MapUnitMap.66(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType5MapUnitMap.68:               ; preds = %ctrl5
  call void @FmoGenerateType5MapUnitMap.68(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType5MapUnitMap.77:               ; preds = %ctrl5
  call void @FmoGenerateType5MapUnitMap.77(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_FmoGenerateType5MapUnitMap.44, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_FmoGenerateType5MapUnitMap.48, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_FmoGenerateType5MapUnitMap.52, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_FmoGenerateType5MapUnitMap.61, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_FmoGenerateType5MapUnitMap.66, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_FmoGenerateType5MapUnitMap.68, label %func_FmoGenerateType5MapUnitMap.77
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FmoGenerateType6MapUnitMap.3, label %ctrl0

func_FmoGenerateType6MapUnitMap.3:                ; preds = %rand_bb
  call void @FmoGenerateType6MapUnitMap.3(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType6MapUnitMap.16:               ; preds = %ctrl0
  call void @FmoGenerateType6MapUnitMap.16(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType6MapUnitMap.31:               ; preds = %ctrl1
  call void @FmoGenerateType6MapUnitMap.31(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType6MapUnitMap.34:               ; preds = %ctrl2
  call void @FmoGenerateType6MapUnitMap.34(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType6MapUnitMap.71:               ; preds = %ctrl3
  call void @FmoGenerateType6MapUnitMap.71(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

func_FmoGenerateType6MapUnitMap.72:               ; preds = %ctrl3
  call void @FmoGenerateType6MapUnitMap.72(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_FmoGenerateType6MapUnitMap.16, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_FmoGenerateType6MapUnitMap.31, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_FmoGenerateType6MapUnitMap.34, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_FmoGenerateType6MapUnitMap.71, label %func_FmoGenerateType6MapUnitMap.72
}

; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType1MapUnitMap.1(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %canary = alloca i32
  store i32 1499375605, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @FmoGetNextMBNr.2(i32 %CurrentMbNr) #0 {
entry:
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 552777320, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType6MapUnitMap.3(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %canary = alloca i32
  store i32 1060690309, i32* %canary
  %img.addr = alloca %struct.ImageParameters*, align 8
  %i = alloca i32, align 4
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 2038076080, i32* %canary
  %retval = alloca i32, align 4
  %i = alloca i32, align 4
...
entry:
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %canary = alloca i32
  store i32 430253164, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 2099281338, i32* %canary
  %mb.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType4MapUnitMap.7(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %sizeOfUpperLeftGroup = alloca i32, align 4
  %img.addr = alloca %struct.ImageParameters*, align 8
  %canary = alloca i32
  store i32 408116167, i32* %canary
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @FmoGetFirstMBOfSliceGroup.8(i32 %SliceGroupID) #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1572334802, i32* %canary
  %retval = alloca i32, align 4
  %SliceGroupID.addr = alloca i32, align 4
  store i32 %SliceGroupID, i32* %SliceGroupID.addr, align 4
  store i32 0, i32* %i, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @FmoGenerateMapUnitToSliceGroupMap.9(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %canary = alloca i32
  store i32 568090882, i32* %canary
  %retval = alloca i32, align 4
  %img.addr = alloca %struct.ImageParameters*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @FmoGenerateMapUnitToSliceGroupMap.10(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %canary = alloca i32
  store i32 473306143, i32* %canary
  %img.addr = alloca %struct.ImageParameters*, align 8
  %retval = alloca i32, align 4
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @FmoGenerateMBAmap.11(%struct.ImageParameters* %img, %struct.seq_parameter_set_rbsp_t* %sps) #0 {
entry:
  %img.addr = alloca %struct.ImageParameters*, align 8
  %sps.addr = alloca %struct.seq_parameter_set_rbsp_t*, align 8
  %canary = alloca i32
  store i32 1955278716, i32* %canary
  %i = alloca i32, align 4
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.seq_parameter_set_rbsp_t* %sps, %struct.seq_parameter_set_rbsp_t** %sps.addr, align 8
  %0 = load i8*, i8** @MBAmap, align 8
...
entry:
  %canary = alloca i32
  store i32 910355672, i32* %canary
  %retval = alloca i32, align 4
  %SliceGroupID = alloca i32, align 4
  %CurrentMbNr.addr = alloca i32, align 4
  store i32 %CurrentMbNr, i32* %CurrentMbNr.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @FmoGetFirstMBOfSliceGroup.13(i32 %SliceGroupID) #0 {
entry:
  %canary = alloca i32
  store i32 1875903316, i32* %canary
  %SliceGroupID.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %retval = alloca i32, align 4
  store i32 %SliceGroupID, i32* %SliceGroupID.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 1271282555, i32* %canary
  %retval = alloca i32, align 4
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %img.addr = alloca %struct.ImageParameters*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType1MapUnitMap.15(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %canary = alloca i32
  store i32 571104909, i32* %canary
  %i = alloca i32, align 4
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %img.addr = alloca %struct.ImageParameters*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType6MapUnitMap.16(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %canary = alloca i32
  store i32 548905290, i32* %canary
  %i = alloca i32, align 4
  %img.addr = alloca %struct.ImageParameters*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType2MapUnitMap.17(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %canary = alloca i32
  store i32 67713822, i32* %canary
  %img.addr = alloca %struct.ImageParameters*, align 8
...
entry:
  %img.addr = alloca %struct.ImageParameters*, align 8
  %canary = alloca i32
  store i32 386302063, i32* %canary
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %retval = alloca i32, align 4
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @FmoGetPreviousMBNr.19(i32 %CurrentMbNr) #0 {
entry:
  %SliceGroupID = alloca i32, align 4
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1765577589, i32* %canary
  %CurrentMbNr.addr = alloca i32, align 4
  store i32 %CurrentMbNr, i32* %CurrentMbNr.addr, align 4
  %0 = load i32, i32* %CurrentMbNr.addr, align 4
  %call = call i32 @FmoMB2SliceGroup(i32 %0)
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @FmoGetLastCodedMBOfSliceGroup.20(i32 %SliceGroupID) #0 {
entry:
  %i = alloca i32, align 4
  %LastMB = alloca i32, align 4
  %canary = alloca i32
  store i32 1299750087, i32* %canary
  %SliceGroupID.addr = alloca i32, align 4
  store i32 %SliceGroupID, i32* %SliceGroupID.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType5MapUnitMap.21(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %canary = alloca i32
  store i32 1977845821, i32* %canary
  %i = alloca i32, align 4
  %sizeOfUpperLeftGroup = alloca i32, align 4
  %img.addr = alloca %struct.ImageParameters*, align 8
  %mapUnitsInSliceGroup0 = alloca i32, align 4
...
entry:
  %sps.addr = alloca %struct.seq_parameter_set_rbsp_t*, align 8
  %canary = alloca i32
  store i32 1314961170, i32* %canary
  %i = alloca i32, align 4
  %img.addr = alloca %struct.ImageParameters*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.seq_parameter_set_rbsp_t* %sps, %struct.seq_parameter_set_rbsp_t** %sps.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType1MapUnitMap.23(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %img.addr = alloca %struct.ImageParameters*, align 8
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 563541432, i32* %canary
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
  store i32 0, i32* %i, align 4
...
entry:
  ...
  %LastMB = alloca i32, align 4
  %canary = alloca i32
  store i32 1146996953, i32* %canary
  %i = alloca i32, align 4
  store i32 %SliceGroupID, i32* %SliceGroupID.addr, align 4
  store i32 -1, i32* %LastMB, align 4
  store i32 0, i32* %i, align 4
...
entry:
  ...
  %sps.addr = alloca %struct.seq_parameter_set_rbsp_t*, align 8
  %canary = alloca i32
  store i32 280908073, i32* %canary
  %img.addr = alloca %struct.ImageParameters*, align 8
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @FmoGenerateMBAmap.26(%struct.ImageParameters* %img, %struct.seq_parameter_set_rbsp_t* %sps) #0 {
entry:
  %img.addr = alloca %struct.ImageParameters*, align 8
  %canary = alloca i32
  store i32 772318438, i32* %canary
  %i = alloca i32, align 4
  %sps.addr = alloca %struct.seq_parameter_set_rbsp_t*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.seq_parameter_set_rbsp_t* %sps, %struct.seq_parameter_set_rbsp_t** %sps.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @FmoGetPreviousMBNr.27(i32 %CurrentMbNr) #0 {
entry:
  %SliceGroupID = alloca i32, align 4
  %canary = alloca i32
  store i32 1677869426, i32* %canary
  %CurrentMbNr.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  store i32 %CurrentMbNr, i32* %CurrentMbNr.addr, align 4
  %0 = load i32, i32* %CurrentMbNr.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @FmoGetFirstMBOfSliceGroup.28(i32 %SliceGroupID) #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1627769417, i32* %canary
  %SliceGroupID.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  store i32 %SliceGroupID, i32* %SliceGroupID.addr, align 4
  store i32 0, i32* %i, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType1MapUnitMap.29(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %img.addr = alloca %struct.ImageParameters*, align 8
  %canary = alloca i32
  store i32 357555812, i32* %canary
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %i = alloca i32, align 4
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @FmoGetFirstMBOfSliceGroup.30(i32 %SliceGroupID) #0 {
entry:
  %SliceGroupID.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 483306457, i32* %canary
  %retval = alloca i32, align 4
  %i = alloca i32, align 4
  store i32 %SliceGroupID, i32* %SliceGroupID.addr, align 4
  store i32 0, i32* %i, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType6MapUnitMap.31(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %img.addr = alloca %struct.ImageParameters*, align 8
  %canary = alloca i32
  store i32 227251843, i32* %canary
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %i = alloca i32, align 4
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @FmoGetNextMBNr.32(i32 %CurrentMbNr) #0 {
entry:
  %SliceGroupID = alloca i32, align 4
  %CurrentMbNr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 750750977, i32* %canary
  %retval = alloca i32, align 4
  store i32 %CurrentMbNr, i32* %CurrentMbNr.addr, align 4
  %0 = load i32, i32* %CurrentMbNr.addr, align 4
  %call = call i32 @FmoMB2SliceGroup(i32 %0)
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @FmoSetLastMacroblockInSlice.33(i32 %mb) #0 {
entry:
  %canary = alloca i32
  store i32 1080904128, i32* %canary
  %currSliceGroup = alloca i32, align 4
  %mb.addr = alloca i32, align 4
  store i32 %mb, i32* %mb.addr, align 4
  %0 = load i32, i32* %mb.addr, align 4
...
entry:
  ...
  %img.addr = alloca %struct.ImageParameters*, align 8
  %canary = alloca i32
  store i32 1826210501, i32* %canary
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
  store i32 0, i32* %i, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @FmoSliceGroupCompletelyCoded.35(i32 %SliceGroupID) #0 {
entry:
  %canary = alloca i32
  store i32 364150211, i32* %canary
  %retval = alloca i32, align 4
  %SliceGroupID.addr = alloca i32, align 4
  store i32 %SliceGroupID, i32* %SliceGroupID.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @FmoGetLastCodedMBOfSliceGroup.36(i32 %SliceGroupID) #0 {
entry:
  %SliceGroupID.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1206468763, i32* %canary
  %LastMB = alloca i32, align 4
  store i32 %SliceGroupID, i32* %SliceGroupID.addr, align 4
  store i32 -1, i32* %LastMB, align 4
  store i32 0, i32* %i, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @FmoGetPreviousMBNr.37(i32 %CurrentMbNr) #0 {
entry:
  %CurrentMbNr.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1775693583, i32* %canary
  %SliceGroupID = alloca i32, align 4
  store i32 %CurrentMbNr, i32* %CurrentMbNr.addr, align 4
  %0 = load i32, i32* %CurrentMbNr.addr, align 4
  %call = call i32 @FmoMB2SliceGroup(i32 %0)
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType1MapUnitMap.38(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 228828547, i32* %canary
  %img.addr = alloca %struct.ImageParameters*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
  store i32 0, i32* %i, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @FmoSliceGroupCompletelyCoded.39(i32 %SliceGroupID) #0 {
entry:
  %canary = alloca i32
  store i32 699599111, i32* %canary
  %SliceGroupID.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  store i32 %SliceGroupID, i32* %SliceGroupID.addr, align 4
  %0 = load i32, i32* %SliceGroupID.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @FmoGetLastCodedMBOfSliceGroup.40(i32 %SliceGroupID) #0 {
entry:
  %canary = alloca i32
  store i32 420251232, i32* %canary
  %LastMB = alloca i32, align 4
  %SliceGroupID.addr = alloca i32, align 4
  %i = alloca i32, align 4
  store i32 %SliceGroupID, i32* %SliceGroupID.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType4MapUnitMap.41(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %sizeOfUpperLeftGroup = alloca i32, align 4
  %canary = alloca i32
  store i32 1100447418, i32* %canary
  %i = alloca i32, align 4
  %mapUnitsInSliceGroup0 = alloca i32, align 4
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %img.addr = alloca %struct.ImageParameters*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType4MapUnitMap.42(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %img.addr = alloca %struct.ImageParameters*, align 8
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %mapUnitsInSliceGroup0 = alloca i32, align 4
  %sizeOfUpperLeftGroup = alloca i32, align 4
  %canary = alloca i32
  store i32 779321807, i32* %canary
  %i = alloca i32, align 4
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
  %0 = load %struct.pic_parameter_set_rbsp_t*, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType0MapUnitMap.43(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %img.addr = alloca %struct.ImageParameters*, align 8
  %i = alloca i32, align 4
  %iGroup = alloca i32, align 4
  %canary = alloca i32
  store i32 1489293073, i32* %canary
  %j = alloca i32, align 4
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
  store i32 0, i32* %i, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType5MapUnitMap.44(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %img.addr = alloca %struct.ImageParameters*, align 8
  %mapUnitsInSliceGroup0 = alloca i32, align 4
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 222185975, i32* %canary
  %sizeOfUpperLeftGroup = alloca i32, align 4
  %k = alloca i32, align 4
  %j = alloca i32, align 4
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType0MapUnitMap.45(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %i = alloca i32, align 4
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %img.addr = alloca %struct.ImageParameters*, align 8
  %iGroup = alloca i32, align 4
  %canary = alloca i32
  store i32 1986268033, i32* %canary
  %j = alloca i32, align 4
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
  store i32 0, i32* %i, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType0MapUnitMap.46(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %img.addr = alloca %struct.ImageParameters*, align 8
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 421205572, i32* %canary
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %iGroup = alloca i32, align 4
  %j = alloca i32, align 4
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType0MapUnitMap.47(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %img.addr = alloca %struct.ImageParameters*, align 8
  %canary = alloca i32
  store i32 319144948, i32* %canary
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %j = alloca i32, align 4
  %iGroup = alloca i32, align 4
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType5MapUnitMap.48(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %sizeOfUpperLeftGroup = alloca i32, align 4
  %k = alloca i32, align 4
  %canary = alloca i32
  store i32 1032359680, i32* %canary
  %img.addr = alloca %struct.ImageParameters*, align 8
  %mapUnitsInSliceGroup0 = alloca i32, align 4
  %j = alloca i32, align 4
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @FmoInit.49(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps, %struct.seq_parameter_set_rbsp_t* %sps) #0 {
entry:
  %canary = alloca i32
  store i32 1374268257, i32* %canary
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %img.addr = alloca %struct.ImageParameters*, align 8
  %sps.addr = alloca %struct.seq_parameter_set_rbsp_t*, align 8
  %k = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @FmoInit.50(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps, %struct.seq_parameter_set_rbsp_t* %sps) #0 {
entry:
  %sps.addr = alloca %struct.seq_parameter_set_rbsp_t*, align 8
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %k = alloca i32, align 4
  %canary = alloca i32
  store i32 1054100175, i32* %canary
  %img.addr = alloca %struct.ImageParameters*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
  store %struct.seq_parameter_set_rbsp_t* %sps, %struct.seq_parameter_set_rbsp_t** %sps.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType1MapUnitMap.51(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %i = alloca i32, align 4
  %img.addr = alloca %struct.ImageParameters*, align 8
  %canary = alloca i32
  store i32 1194103375, i32* %canary
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
  store i32 0, i32* %i, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType5MapUnitMap.52(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %mapUnitsInSliceGroup0 = alloca i32, align 4
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %k = alloca i32, align 4
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 191122528, i32* %canary
  %i = alloca i32, align 4
  %img.addr = alloca %struct.ImageParameters*, align 8
  %sizeOfUpperLeftGroup = alloca i32, align 4
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @FmoGenerateMapUnitToSliceGroupMap.53(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %canary = alloca i32
  store i32 1782822685, i32* %canary
  %img.addr = alloca %struct.ImageParameters*, align 8
  %retval = alloca i32, align 4
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType3MapUnitMap.54(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 801230769, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1375982508, i32* %canary
  %retval = alloca i32, align 4
  %SliceGroupID.addr = alloca i32, align 4
  %i = alloca i32, align 4
  store i32 %SliceGroupID, i32* %SliceGroupID.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @FmoGetNextMBNr.56(i32 %CurrentMbNr) #0 {
entry:
  %retval = alloca i32, align 4
  %SliceGroupID = alloca i32, align 4
  %canary = alloca i32
  store i32 432583338, i32* %canary
  %CurrentMbNr.addr = alloca i32, align 4
  store i32 %CurrentMbNr, i32* %CurrentMbNr.addr, align 4
  %0 = load i32, i32* %CurrentMbNr.addr, align 4
  %call = call i32 @FmoMB2SliceGroup(i32 %0)
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @FmoGetLastCodedMBOfSliceGroup.57(i32 %SliceGroupID) #0 {
entry:
  %canary = alloca i32
  store i32 936477383, i32* %canary
  %LastMB = alloca i32, align 4
  %i = alloca i32, align 4
  %SliceGroupID.addr = alloca i32, align 4
  store i32 %SliceGroupID, i32* %SliceGroupID.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 1958343132, i32* %canary
  %i = alloca i32, align 4
  %SliceGroupID.addr = alloca i32, align 4
  %LastMB = alloca i32, align 4
  store i32 %SliceGroupID, i32* %SliceGroupID.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @FmoGetNextMBNr.59(i32 %CurrentMbNr) #0 {
entry:
  %canary = alloca i32
  store i32 1244293322, i32* %canary
  %CurrentMbNr.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  %SliceGroupID = alloca i32, align 4
  store i32 %CurrentMbNr, i32* %CurrentMbNr.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType2MapUnitMap.60(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %yTopLeft = alloca i32, align 4
  %xBottomRight = alloca i32, align 4
  ...
  %y = alloca i32, align 4
  %canary = alloca i32
  store i32 223390975, i32* %canary
  %x = alloca i32, align 4
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
  store i32 0, i32* %i, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType5MapUnitMap.61(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %k = alloca i32, align 4
  %j = alloca i32, align 4
  %img.addr = alloca %struct.ImageParameters*, align 8
  %canary = alloca i32
  store i32 1788077701, i32* %canary
  %sizeOfUpperLeftGroup = alloca i32, align 4
  %mapUnitsInSliceGroup0 = alloca i32, align 4
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @FmoGetPreviousMBNr.62(i32 %CurrentMbNr) #0 {
entry:
  %CurrentMbNr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1471168544, i32* %canary
  %SliceGroupID = alloca i32, align 4
  %retval = alloca i32, align 4
  store i32 %CurrentMbNr, i32* %CurrentMbNr.addr, align 4
  %0 = load i32, i32* %CurrentMbNr.addr, align 4
...
entry:
  ...
  %img.addr = alloca %struct.ImageParameters*, align 8
  %canary = alloca i32
  store i32 1942043854, i32* %canary
  %iGroup = alloca i32, align 4
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
  store i32 0, i32* %i, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @FmoInit.64(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps, %struct.seq_parameter_set_rbsp_t* %sps) #0 {
entry:
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %canary = alloca i32
  store i32 420639633, i32* %canary
  %img.addr = alloca %struct.ImageParameters*, align 8
  %k = alloca i32, align 4
  %sps.addr = alloca %struct.seq_parameter_set_rbsp_t*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @FmoGenerateMapUnitToSliceGroupMap.65(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %canary = alloca i32
  store i32 1601897395, i32* %canary
  %retval = alloca i32, align 4
  %img.addr = alloca %struct.ImageParameters*, align 8
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType5MapUnitMap.66(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %canary = alloca i32
  store i32 1535893062, i32* %canary
  %j = alloca i32, align 4
  %i = alloca i32, align 4
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %sizeOfUpperLeftGroup = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType4MapUnitMap.67(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %mapUnitsInSliceGroup0 = alloca i32, align 4
  %sizeOfUpperLeftGroup = alloca i32, align 4
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %canary = alloca i32
  store i32 1143723133, i32* %canary
  %img.addr = alloca %struct.ImageParameters*, align 8
  %i = alloca i32, align 4
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType5MapUnitMap.68(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %j = alloca i32, align 4
  %k = alloca i32, align 4
  %mapUnitsInSliceGroup0 = alloca i32, align 4
  %canary = alloca i32
  store i32 1618969971, i32* %canary
  %img.addr = alloca %struct.ImageParameters*, align 8
  %i = alloca i32, align 4
  %sizeOfUpperLeftGroup = alloca i32, align 4
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType2MapUnitMap.69(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %xBottomRight = alloca i32, align 4
  %yBottomRight = alloca i32, align 4
  ...
  %x = alloca i32, align 4
  %canary = alloca i32
  store i32 1503479469, i32* %canary
  %iGroup = alloca i32, align 4
  %xTopLeft = alloca i32, align 4
  %yTopLeft = alloca i32, align 4
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @FmoGetPreviousMBNr.70(i32 %CurrentMbNr) #0 {
entry:
  %retval = alloca i32, align 4
  %CurrentMbNr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 449629767, i32* %canary
  %SliceGroupID = alloca i32, align 4
  store i32 %CurrentMbNr, i32* %CurrentMbNr.addr, align 4
  %0 = load i32, i32* %CurrentMbNr.addr, align 4
  %call = call i32 @FmoMB2SliceGroup(i32 %0)
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType6MapUnitMap.71(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %canary = alloca i32
  store i32 574823845, i32* %canary
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %img.addr = alloca %struct.ImageParameters*, align 8
  %i = alloca i32, align 4
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType6MapUnitMap.72(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 2027759345, i32* %canary
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %img.addr = alloca %struct.ImageParameters*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @FmoGetNextMBNr.73(i32 %CurrentMbNr) #0 {
entry:
  %SliceGroupID = alloca i32, align 4
  %canary = alloca i32
  store i32 597724899, i32* %canary
  %retval = alloca i32, align 4
  %CurrentMbNr.addr = alloca i32, align 4
  store i32 %CurrentMbNr, i32* %CurrentMbNr.addr, align 4
  %0 = load i32, i32* %CurrentMbNr.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @FmoInit.74(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps, %struct.seq_parameter_set_rbsp_t* %sps) #0 {
entry:
  %img.addr = alloca %struct.ImageParameters*, align 8
  %sps.addr = alloca %struct.seq_parameter_set_rbsp_t*, align 8
  %canary = alloca i32
  store i32 891611261, i32* %canary
  %k = alloca i32, align 4
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType2MapUnitMap.75(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %xTopLeft = alloca i32, align 4
  %canary = alloca i32
  store i32 1978380606, i32* %canary
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %x = alloca i32, align 4
  %yTopLeft = alloca i32, align 4
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @FmoGenerateMBAmap.76(%struct.ImageParameters* %img, %struct.seq_parameter_set_rbsp_t* %sps) #0 {
entry:
  %sps.addr = alloca %struct.seq_parameter_set_rbsp_t*, align 8
  %img.addr = alloca %struct.ImageParameters*, align 8
  %canary = alloca i32
  store i32 1851578316, i32* %canary
  %i = alloca i32, align 4
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.seq_parameter_set_rbsp_t* %sps, %struct.seq_parameter_set_rbsp_t** %sps.addr, align 8
  %0 = load i8*, i8** @MBAmap, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType5MapUnitMap.77(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %img.addr = alloca %struct.ImageParameters*, align 8
  %j = alloca i32, align 4
  %mapUnitsInSliceGroup0 = alloca i32, align 4
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1823590845, i32* %canary
  %sizeOfUpperLeftGroup = alloca i32, align 4
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
  %0 = load %struct.pic_parameter_set_rbsp_t*, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType0MapUnitMap.78(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %j = alloca i32, align 4
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 687769663, i32* %canary
  %iGroup = alloca i32, align 4
  %img.addr = alloca %struct.ImageParameters*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType4MapUnitMap.79(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %mapUnitsInSliceGroup0 = alloca i32, align 4
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 348536150, i32* %canary
  %img.addr = alloca %struct.ImageParameters*, align 8
  %sizeOfUpperLeftGroup = alloca i32, align 4
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType3MapUnitMap.80(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %rightBound = alloca i32, align 4
  %leftBound = alloca i32, align 4
  ...
  %mapUnitVacant = alloca i32, align 4
  %canary = alloca i32
  store i32 1134968545, i32* %canary
  %y = alloca i32, align 4
  %topBound = alloca i32, align 4
  %i = alloca i32, align 4
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType3MapUnitMap.81(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %xDir = alloca i32, align 4
  %mapUnitVacant = alloca i32, align 4
  %canary = alloca i32
  store i32 920884954, i32* %canary
  %rightBound = alloca i32, align 4
  %y = alloca i32, align 4
  %mapUnitsInSliceGroup0 = alloca i32, align 4
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @FmoInit.82(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps, %struct.seq_parameter_set_rbsp_t* %sps) #0 {
entry:
  %img.addr = alloca %struct.ImageParameters*, align 8
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %sps.addr = alloca %struct.seq_parameter_set_rbsp_t*, align 8
  %canary = alloca i32
  store i32 263584701, i32* %canary
  %k = alloca i32, align 4
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
  store %struct.seq_parameter_set_rbsp_t* %sps, %struct.seq_parameter_set_rbsp_t** %sps.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @FmoGenerateMBAmap.83(%struct.ImageParameters* %img, %struct.seq_parameter_set_rbsp_t* %sps) #0 {
entry:
  %canary = alloca i32
  store i32 1092413966, i32* %canary
  %i = alloca i32, align 4
  %sps.addr = alloca %struct.seq_parameter_set_rbsp_t*, align 8
  %img.addr = alloca %struct.ImageParameters*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @FmoGenerateMBAmap.84(%struct.ImageParameters* %img, %struct.seq_parameter_set_rbsp_t* %sps) #0 {
entry:
  %i = alloca i32, align 4
  %img.addr = alloca %struct.ImageParameters*, align 8
  %canary = alloca i32
  store i32 1747413801, i32* %canary
  %sps.addr = alloca %struct.seq_parameter_set_rbsp_t*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.seq_parameter_set_rbsp_t* %sps, %struct.seq_parameter_set_rbsp_t** %sps.addr, align 8
  %0 = load i8*, i8** @MBAmap, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType2MapUnitMap.85(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %xTopLeft = alloca i32, align 4
  %y = alloca i32, align 4
  %img.addr = alloca %struct.ImageParameters*, align 8
  %canary = alloca i32
  store i32 1830198389, i32* %canary
  %x = alloca i32, align 4
  %iGroup = alloca i32, align 4
  %xBottomRight = alloca i32, align 4
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @FmoGetNextMBNr.86(i32 %CurrentMbNr) #0 {
entry:
  %CurrentMbNr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 298139371, i32* %canary
  %SliceGroupID = alloca i32, align 4
  %retval = alloca i32, align 4
  store i32 %CurrentMbNr, i32* %CurrentMbNr.addr, align 4
  %0 = load i32, i32* %CurrentMbNr.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType4MapUnitMap.87(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %mapUnitsInSliceGroup0 = alloca i32, align 4
  %canary = alloca i32
  store i32 204061279, i32* %canary
  %img.addr = alloca %struct.ImageParameters*, align 8
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %sizeOfUpperLeftGroup = alloca i32, align 4
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType3MapUnitMap.88(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %x = alloca i32, align 4
  %mapUnitVacant = alloca i32, align 4
  %yDir = alloca i32, align 4
  %canary = alloca i32
  store i32 787818784, i32* %canary
  %topBound = alloca i32, align 4
  %xDir = alloca i32, align 4
  %leftBound = alloca i32, align 4
  %bottomBound = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType3MapUnitMap.89(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %rightBound = alloca i32, align 4
  %img.addr = alloca %struct.ImageParameters*, align 8
  %leftBound = alloca i32, align 4
  ...
  %x = alloca i32, align 4
  %canary = alloca i32
  store i32 505870620, i32* %canary
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %i = alloca i32, align 4
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType3MapUnitMap.90(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %rightBound = alloca i32, align 4
  %mapUnitsInSliceGroup0 = alloca i32, align 4
  %leftBound = alloca i32, align 4
  ...
  %mapUnitVacant = alloca i32, align 4
  %canary = alloca i32
  store i32 1136177896, i32* %canary
  %yDir = alloca i32, align 4
  %img.addr = alloca %struct.ImageParameters*, align 8
  %x = alloca i32, align 4
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType3MapUnitMap.91(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %img.addr = alloca %struct.ImageParameters*, align 8
  %rightBound = alloca i32, align 4
  %mapUnitsInSliceGroup0 = alloca i32, align 4
  ...
  %x = alloca i32, align 4
  %canary = alloca i32
  store i32 640531251, i32* %canary
  %mapUnitVacant = alloca i32, align 4
  %y = alloca i32, align 4
  %xDir = alloca i32, align 4
  %k = alloca i32, align 4
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1232494666, i32* %canary
  %x = alloca i32, align 4
  %y = alloca i32, align 4
  %yTopLeft = alloca i32, align 4
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType2MapUnitMap.93(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %yBottomRight = alloca i32, align 4
  %canary = alloca i32
  store i32 1441964361, i32* %canary
  %y = alloca i32, align 4
  %i = alloca i32, align 4
  %xBottomRight = alloca i32, align 4
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @FmoInit.94(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps, %struct.seq_parameter_set_rbsp_t* %sps) #0 {
entry:
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %k = alloca i32, align 4
  %sps.addr = alloca %struct.seq_parameter_set_rbsp_t*, align 8
  %canary = alloca i32
  store i32 559958746, i32* %canary
  %img.addr = alloca %struct.ImageParameters*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
  store %struct.seq_parameter_set_rbsp_t* %sps, %struct.seq_parameter_set_rbsp_t** %sps.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType0MapUnitMap.95(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %canary = alloca i32
  store i32 1702992686, i32* %canary
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %iGroup = alloca i32, align 4
  %i = alloca i32, align 4
  %img.addr = alloca %struct.ImageParameters*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType4MapUnitMap.96(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %canary = alloca i32
  store i32 335817121, i32* %canary
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %i = alloca i32, align 4
  %img.addr = alloca %struct.ImageParameters*, align 8
  %mapUnitsInSliceGroup0 = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType3MapUnitMap.97(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %topBound = alloca i32, align 4
  %x = alloca i32, align 4
  %y = alloca i32, align 4
  ...
  %mapUnitVacant = alloca i32, align 4
  %canary = alloca i32
  store i32 1010725586, i32* %canary
  %mapUnitsInSliceGroup0 = alloca i32, align 4
  %i = alloca i32, align 4
  %leftBound = alloca i32, align 4
  %k = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType0MapUnitMap.98(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 95190004, i32* %canary
  %iGroup = alloca i32, align 4
  %img.addr = alloca %struct.ImageParameters*, align 8
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @FmoGenerateType4MapUnitMap.99(%struct.ImageParameters* %img, %struct.pic_parameter_set_rbsp_t* %pps) #0 {
entry:
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %mapUnitsInSliceGroup0 = alloca i32, align 4
  %canary = alloca i32
  store i32 631145504, i32* %canary
  %i = alloca i32, align 4
  %img.addr = alloca %struct.ImageParameters*, align 8
  %sizeOfUpperLeftGroup = alloca i32, align 4
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
...
entry:
  ...
  %xTopLeft = alloca i32, align 4
  %canary = alloca i32
  store i32 1128473665, i32* %canary
  %x = alloca i32, align 4
  %y = alloca i32, align 4
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
