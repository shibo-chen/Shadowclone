...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_WriteRTPPacket.4, label %ctrl0

func_WriteRTPPacket.4:                            ; preds = %rand_bb
  %2 = call i32 @WriteRTPPacket.4(%struct.RTPpacket_t* %p, %struct._IO_FILE* %f)
  ret i32 %2

func_WriteRTPPacket.5:                            ; preds = %ctrl0
  %3 = call i32 @WriteRTPPacket.5(%struct.RTPpacket_t* %p, %struct._IO_FILE* %f)
  ret i32 %3
...
ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_WriteRTPPacket.5, label %ctrl1
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_RTPUpdateTimestamp.1, label %func_RTPUpdateTimestamp.3
...
entry:
  %canary = alloca i32
  store i32 1976089208, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 426023327, i32* %canary
...
entry:
  %tr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1006290761, i32* %canary
  %delta = alloca i32, align 4
  store i32 %tr, i32* %tr.addr, align 4
  %0 = load i32, i32* @RTPUpdateTimestamp.oldtr, align 4
  %cmp = icmp eq i32 %0, -1
...
entry:
  ...
  %canary = alloca i32
  store i32 844889545, i32* %canary
  %p.addr = alloca %struct.RTPpacket_t*, align 8
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
...
entry:
  %f.addr = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 249767794, i32* %canary
  %retval = alloca i32, align 4
  %intime = alloca i32, align 4
  %p.addr = alloca %struct.RTPpacket_t*, align 8
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
...
entry:
  %intime = alloca i32, align 4
  %canary = alloca i32
  store i32 1969721007, i32* %canary
  %retval = alloca i32, align 4
  %f.addr = alloca %struct._IO_FILE*, align 8
  %p.addr = alloca %struct.RTPpacket_t*, align 8
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 913996539, i32* %canary
  %p = alloca %struct.RTPpacket_t*, align 8
  %n.addr = alloca %struct.NALU_t*, align 8
  store %struct.NALU_t* %n, %struct.NALU_t** %n.addr, align 8
  %0 = load %struct.NALU_t*, %struct.NALU_t** %n.addr, align 8
...
entry:
  ...
  %p.addr = alloca %struct.RTPpacket_t*, align 8
  %canary = alloca i32
  store i32 2053334239, i32* %canary
  %f.addr = alloca %struct._IO_FILE*, align 8
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
  store i32 -1, i32* %intime, align 4
...
entry:
  %p.addr = alloca %struct.RTPpacket_t*, align 8
  %canary = alloca i32
  store i32 794802954, i32* %canary
  %f.addr = alloca %struct._IO_FILE*, align 8
  %intime = alloca i32, align 4
  %retval = alloca i32, align 4
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
...
entry:
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 905062586, i32* %canary
  %f.addr = alloca %struct._IO_FILE*, align 8
  %intime = alloca i32, align 4
  %p.addr = alloca %struct.RTPpacket_t*, align 8
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
...
entry:
  ...
  %intime = alloca i32, align 4
  %canary = alloca i32
  store i32 1338417552, i32* %canary
  %retval = alloca i32, align 4
  %p.addr = alloca %struct.RTPpacket_t*, align 8
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 361756943, i32* %canary
  %f.addr = alloca %struct._IO_FILE*, align 8
  %intime = alloca i32, align 4
  %p.addr = alloca %struct.RTPpacket_t*, align 8
  %retval = alloca i32, align 4
