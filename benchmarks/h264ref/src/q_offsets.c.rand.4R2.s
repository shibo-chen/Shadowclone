...
# %bb.1:                                # %func_CheckOffsetParameterName.2
	...
	.cfi_def_cfa %rsp, 8
	retq
.LBB0_2:                                # %func_CheckOffsetParameterName.5
	.cfi_def_cfa %rbp, 16
	movq	%rbx, %rdi
	movq	%r14, %rsi
	callq	CheckOffsetParameterName.5
	popq	%rbx
	popq	%r14
	popq	%rbp
	.cfi_def_cfa %rsp, 8
	retq
.LBB0_3:                                # %func_CheckOffsetParameterName.11
	.cfi_def_cfa %rbp, 16
	movq	%rbx, %rdi
	movq	%r14, %rsi
...
# %bb.1:                                # %func_ParseQOffsetMatrix.6
	...
	.cfi_def_cfa %rsp, 8
	retq
.LBB1_2:                                # %func_ParseQOffsetMatrix.7
	.cfi_def_cfa %rbp, 16
	movq	%rbx, %rdi
	movl	%r14d, %esi
	...
	.cfi_def_cfa %rsp, 8
	retq
.LBB1_3:                                # %func_ParseQOffsetMatrix.14
	.cfi_def_cfa %rbp, 16
	movq	%rbx, %rdi
	movl	%r14d, %esi
	...
	.cfi_def_cfa %rsp, 8
	retq
.LBB1_4:                                # %func_ParseQOffsetMatrix.16
	.cfi_def_cfa %rbp, 16
	movq	%rbx, %rdi
	movl	%r14d, %esi
...
# %bb.1:                                # %func_CalculateOffsetParam.4
	...
	.cfi_def_cfa %rsp, 8
	retq
.LBB3_2:                                # %func_CalculateOffsetParam.8
	.cfi_def_cfa %rbp, 16
	callq	CalculateOffsetParam.8
	popq	%rbp
	.cfi_def_cfa %rsp, 8
	retq
.LBB3_3:                                # %func_CalculateOffsetParam.10
	.cfi_def_cfa %rbp, 16
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$405878395, -24(%rbp)   # imm = 0x1831367B
	movq	input, %rax
	cmpl	$0, 3584(%rax)
	je	.LBB5_17
# %bb.1:                                # %if.then
...
.LBB5_32:                               # %for.end104
	jmp	.LBB5_33
.LBB5_33:                               # %if.end105
	cmpl	$405878395, -24(%rbp)   # imm = 0x1831367B
	jne	.LBB5_35
.LBB5_34:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$1818712917, -20(%rbp)  # imm = 0x6C675B55
	movq	%rdi, -32(%rbp)
	movq	%rsi, -40(%rbp)
	movl	$0, -12(%rbp)
	movq	-40(%rbp), %rax
...
.LBB6_17:                               # %return
	movl	-16(%rbp), %ebx
	cmpl	$1818712917, -20(%rbp)  # imm = 0x6C675B55
	jne	.LBB6_19
.LBB6_18:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$2061658478, -24(%rbp)  # imm = 0x7AE2696E
	movq	input, %rax
	cmpl	$0, 3584(%rax)
	je	.LBB7_17
# %bb.1:                                # %if.then
...
.LBB7_32:                               # %for.end104
	jmp	.LBB7_33
.LBB7_33:                               # %if.end105
	cmpl	$2061658478, -24(%rbp)  # imm = 0x7AE2696E
	jne	.LBB7_35
.LBB7_34:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1858426463, -24(%rbp)  # imm = 0x6EC5565F
	movq	input, %rax
	cmpl	$0, 3584(%rax)
	je	.LBB8_17
# %bb.1:                                # %if.then
...
.LBB8_32:                               # %for.end224
	jmp	.LBB8_33
.LBB8_33:                               # %if.end225
	cmpl	$1858426463, -24(%rbp)  # imm = 0x6EC5565F
	jne	.LBB8_35
.LBB8_34:
	addq	$32, %rsp
	popq	%rbp
...
.Lfunc_end8:
	...
	.cfi_endproc
                                        # -- End function
	.globl	CheckOffsetParameterName.5 # -- Begin function CheckOffsetParameterName.5
	.p2align	4, 0x90
	.type	CheckOffsetParameterName.5,@function
CheckOffsetParameterName.5:             # @CheckOffsetParameterName.5
	.cfi_startproc
# %bb.0:                                # %entry
	pushq	%rbp
	.cfi_def_cfa_offset 16
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$1560603235, -20(%rbp)  # imm = 0x5D04EA63
	movq	%rdi, -40(%rbp)
	movq	%rsi, -32(%rbp)
	movl	$0, -12(%rbp)
	movq	-32(%rbp), %rax
...
.LBB9_17:                               # %return
	movl	-16(%rbp), %ebx
	cmpl	$1560603235, -20(%rbp)  # imm = 0x5D04EA63
	jne	.LBB9_19
.LBB9_18:
	movl	%ebx, %eax
	addq	$40, %rsp
...
.LBB9_19:                               # %func_exit
	...
	jmp	.LBB9_18
.Lfunc_end9:
	.size	CheckOffsetParameterName.5, .Lfunc_end9-CheckOffsetParameterName.5
	.cfi_endproc
                                        # -- End function
...
# %bb.0:                                # %entry
	...
	movl	$2045128148, -56(%rbp)  # imm = 0x79E62DD4
	movq	%rdi, -80(%rbp)
	movl	%esi, -60(%rbp)
	movl	$0, -28(%rbp)
	movl	$0, -36(%rbp)
...
# %bb.41:                               # %for.inc96
	...
	jmp	.LBB10_26
.LBB10_42:                              # %for.end98
	cmpl	$2045128148, -56(%rbp)  # imm = 0x79E62DD4
	jne	.LBB10_44
.LBB10_43:
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$8096, %rsp             # imm = 0x1FA0
	movl	$1750021988, -48(%rbp)  # imm = 0x684F3764
	movq	%rdi, -80(%rbp)
	movl	%esi, -56(%rbp)
	movl	$0, -32(%rbp)
	movl	$0, -36(%rbp)
...
# %bb.41:                               # %for.inc96
	...
	jmp	.LBB11_26
.LBB11_42:                              # %for.end98
	cmpl	$1750021988, -48(%rbp)  # imm = 0x684F3764
	jne	.LBB11_44
.LBB11_43:
	addq	$8096, %rsp             # imm = 0x1FA0
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$972845768, -24(%rbp)   # imm = 0x39FC72C8
	movq	input, %rax
	cmpl	$0, 3584(%rax)
	je	.LBB12_17
# %bb.1:                                # %if.then
...
.LBB12_32:                              # %for.end224
	jmp	.LBB12_33
.LBB12_33:                              # %if.end225
	cmpl	$972845768, -24(%rbp)   # imm = 0x39FC72C8
	jne	.LBB12_35
.LBB12_34:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$2042068009, -24(%rbp)  # imm = 0x79B77C29
	movq	input, %rax
	cmpl	$0, 3584(%rax)
	je	.LBB13_17
# %bb.1:                                # %if.then
...
.LBB13_32:                              # %for.end104
	jmp	.LBB13_33
.LBB13_33:                              # %if.end105
	cmpl	$2042068009, -24(%rbp)  # imm = 0x79B77C29
	jne	.LBB13_35
.LBB13_34:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$220052556, -24(%rbp)   # imm = 0xD1DBC4C
	movq	input, %rax
	cmpl	$0, 3584(%rax)
	je	.LBB14_17
# %bb.1:                                # %if.then
...
.LBB14_32:                              # %for.end224
	jmp	.LBB14_33
.LBB14_33:                              # %if.end225
	cmpl	$220052556, -24(%rbp)   # imm = 0xD1DBC4C
	jne	.LBB14_35
.LBB14_34:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$1398045183, -20(%rbp)  # imm = 0x535479FF
	movq	%rdi, -32(%rbp)
	movq	%rsi, -40(%rbp)
	movl	$0, -12(%rbp)
	movq	-40(%rbp), %rax
...
.LBB15_17:                              # %return
	movl	-16(%rbp), %ebx
	cmpl	$1398045183, -20(%rbp)  # imm = 0x535479FF
	jne	.LBB15_19
.LBB15_18:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$1317468203, -20(%rbp)  # imm = 0x4E86F82B
	movq	%rdi, -40(%rbp)
	movq	%rsi, -32(%rbp)
	movl	$0, -12(%rbp)
	movq	-32(%rbp), %rax
...
.LBB16_17:                              # %return
	movl	-16(%rbp), %ebx
	cmpl	$1317468203, -20(%rbp)  # imm = 0x4E86F82B
	jne	.LBB16_19
.LBB16_18:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1381727649, -24(%rbp)  # imm = 0x525B7DA1
	movq	input, %rax
	cmpl	$0, 3584(%rax)
	je	.LBB17_17
# %bb.1:                                # %if.then
...
.LBB17_32:                              # %for.end104
	jmp	.LBB17_33
.LBB17_33:                              # %if.end105
	cmpl	$1381727649, -24(%rbp)  # imm = 0x525B7DA1
	jne	.LBB17_35
.LBB17_34:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$8096, %rsp             # imm = 0x1FA0
	movl	$825035691, -48(%rbp)   # imm = 0x312D0BAB
	movq	%rdi, -88(%rbp)
	movl	%esi, -56(%rbp)
	movl	$0, -32(%rbp)
	movl	$0, -36(%rbp)
...
# %bb.41:                               # %for.inc96
	...
	jmp	.LBB18_26
.LBB18_42:                              # %for.end98
	cmpl	$825035691, -48(%rbp)   # imm = 0x312D0BAB
	jne	.LBB18_44
.LBB18_43:
	addq	$8096, %rsp             # imm = 0x1FA0
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$239664390, -24(%rbp)   # imm = 0xE48FD06
	movq	input, %rax
	cmpl	$0, 3584(%rax)
	je	.LBB19_17
# %bb.1:                                # %if.then
...
.LBB19_32:                              # %for.end224
	jmp	.LBB19_33
.LBB19_33:                              # %if.end225
	cmpl	$239664390, -24(%rbp)   # imm = 0xE48FD06
	jne	.LBB19_35
.LBB19_34:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$8096, %rsp             # imm = 0x1FA0
	movl	$1551658956, -60(%rbp)  # imm = 0x5C7C6FCC
	movq	%rdi, -72(%rbp)
	movl	%esi, -48(%rbp)
	movl	$0, -32(%rbp)
	movl	$0, -36(%rbp)
...
# %bb.41:                               # %for.inc96
	...
	jmp	.LBB20_26
.LBB20_42:                              # %for.end98
	cmpl	$1551658956, -60(%rbp)  # imm = 0x5C7C6FCC
	jne	.LBB20_44
.LBB20_43:
	addq	$8096, %rsp             # imm = 0x1FA0
	popq	%rbp
