; ModuleID = 'context_ini.c.rand.4R2.bc'
...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_create_context_memory.5, label %ctrl0

func_create_context_memory.5:                     ; preds = %rand_bb
  call void @create_context_memory.5()
  ret void

func_create_context_memory.15:                    ; preds = %ctrl0
  call void @create_context_memory.15()
  ret void

func_create_context_memory.17:                    ; preds = %ctrl1
  call void @create_context_memory.17()
  ret void

func_create_context_memory.20:                    ; preds = %ctrl1
  call void @create_context_memory.20()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_create_context_memory.15, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_create_context_memory.17, label %func_create_context_memory.20
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_free_context_memory.16, label %func_free_context_memory.22

func_free_context_memory.16:                      ; preds = %rand_bb
  call void @free_context_memory.16()
  ret void

func_free_context_memory.22:                      ; preds = %rand_bb
  call void @free_context_memory.22()
  ret void
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_SetCtxModelNumber.2, label %ctrl0

func_SetCtxModelNumber.2:                         ; preds = %rand_bb
  call void @SetCtxModelNumber.2()
  ret void
...
func_SetCtxModelNumber.18:                        ; preds = %ctrl1
  call void @SetCtxModelNumber.18()
  ret void

func_SetCtxModelNumber.26:                        ; preds = %ctrl1
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_SetCtxModelNumber.18, label %func_SetCtxModelNumber.26
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_init_contexts.10, label %ctrl0

func_init_contexts.10:                            ; preds = %rand_bb
  call void @init_contexts.10()
  ret void

func_init_contexts.25:                            ; preds = %ctrl0
  call void @init_contexts.25()
  ret void

func_init_contexts.28:                            ; preds = %ctrl1
  call void @init_contexts.28()
  ret void

func_init_contexts.29:                            ; preds = %ctrl1
  call void @init_contexts.29()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_init_contexts.25, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_init_contexts.28, label %func_init_contexts.29
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_XRate.1, label %ctrl0

func_XRate.1:                                     ; preds = %rand_bb
  %2 = call double @XRate.1(%struct.BiContextType* %ctx, i32* %model)
  ret double %2

func_XRate.3:                                     ; preds = %ctrl0
  %3 = call double @XRate.3(%struct.BiContextType* %ctx, i32* %model)
  ret double %3
...
func_XRate.14:                                    ; preds = %ctrl1
  %5 = call double @XRate.14(%struct.BiContextType* %ctx, i32* %model)
  ret double %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_XRate.3, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_XRate.8, label %func_XRate.14
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_GetCtxModelNumber.19, label %ctrl0

func_GetCtxModelNumber.19:                        ; preds = %rand_bb
  call void @GetCtxModelNumber.19(i32* %mnumber, %struct.MotionInfoContexts* %mc, %struct.TextureInfoContexts* %tc)
  ret void

func_GetCtxModelNumber.21:                        ; preds = %ctrl0
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_GetCtxModelNumber.21, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_GetCtxModelNumber.27, label %func_GetCtxModelNumber.30
}
...
func_store_contexts.12:                           ; preds = %ctrl0
  call void @store_contexts.12()
  ret void

func_store_contexts.23:                           ; preds = %ctrl1
  call void @store_contexts.23()
  ret void

func_store_contexts.24:                           ; preds = %ctrl1
  call void @store_contexts.24()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_store_contexts.12, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_store_contexts.23, label %func_store_contexts.24
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_update_field_frame_contexts.4, label %ctrl0

func_update_field_frame_contexts.4:               ; preds = %rand_bb
  call void @update_field_frame_contexts.4(i32 %field)
  ret void

func_update_field_frame_contexts.7:               ; preds = %ctrl0
  call void @update_field_frame_contexts.7(i32 %field)
  ret void

func_update_field_frame_contexts.11:              ; preds = %ctrl1
  call void @update_field_frame_contexts.11(i32 %field)
  ret void

func_update_field_frame_contexts.13:              ; preds = %ctrl1
  call void @update_field_frame_contexts.13(i32 %field)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_update_field_frame_contexts.7, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_update_field_frame_contexts.11, label %func_update_field_frame_contexts.13
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local double @XRate.1(%struct.BiContextType* %ctx, i32* %model) #0 {
entry:
  %canary = alloca i32
  store i32 1421612619, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @SetCtxModelNumber.2() #0 {
entry:
  %img_type = alloca i32, align 4
  %canary = alloca i32
  store i32 1467319405, i32* %canary
...
entry:
  ...
  %weight = alloca double, align 8
  %canary = alloca i32
  store i32 319831998, i32* %canary
  %mod_state = alloca i32, align 4
  store %struct.BiContextType* %ctx, %struct.BiContextType** %ctx.addr, align 8
  store i32* %model, i32** %model.addr, align 8
  store double 0.000000e+00, double* %xr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @update_field_frame_contexts.4(i32 %field) #0 {
entry:
  %field.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2125136598, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @create_context_memory.5() #0 {
entry:
  %j = alloca i32, align 4
  %num_mb = alloca i32, align 4
  %k = alloca i32, align 4
  %canary = alloca i32
  store i32 550231459, i32* %canary
  %i = alloca i32, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
entry:
  %canary = alloca i32
  store i32 218609935, i32* %canary
  %frame_field = alloca i32, align 4
  %img_type = alloca i32, align 4
  %ctx_number = alloca i32, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @update_field_frame_contexts.7(i32 %field) #0 {
entry:
  %canary = alloca i32
  store i32 341121207, i32* %canary
  %field.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  store i32 %field, i32* %field.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 1572363283, i32* %canary
  %qp = alloca i32, align 4
  %ctx_state = alloca i32, align 4
  %mod_state = alloca i32, align 4
  %model.addr = alloca i32*, align 8
...
entry:
  %frame_field = alloca i32, align 4
  %canary = alloca i32
  store i32 757025156, i32* %canary
  %img_type = alloca i32, align 4
  %ctx_number = alloca i32, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %field_picture = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 100
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @init_contexts.10() #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1288089245, i32* %canary
...
for.end642:                                       ; preds = %for.cond601
  ...
  %317 = icmp eq i32 %316, 1288089245
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @update_field_frame_contexts.11(i32 %field) #0 {
entry:
  %canary = alloca i32
  store i32 936215973, i32* %canary
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %field.addr = alloca i32, align 4
  store i32 %field, i32* %field.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @store_contexts.12() #0 {
entry:
  %canary = alloca i32
  store i32 1447718900, i32* %canary
  %ctx_number = alloca i32, align 4
  %frame_field = alloca i32, align 4
  %img_type = alloca i32, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @update_field_frame_contexts.13(i32 %field) #0 {
entry:
  %i = alloca i32, align 4
  %field.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 992852685, i32* %canary
  %j = alloca i32, align 4
  store i32 %field, i32* %field.addr, align 4
  %0 = load i32, i32* %field.addr, align 4
  %tobool = icmp ne i32 %0, 0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local double @XRate.14(%struct.BiContextType* %ctx, i32* %model) #0 {
entry:
  %mod_state = alloca i32, align 4
  %weight = alloca double, align 8
  %canary = alloca i32
  store i32 2030779267, i32* %canary
  %qp = alloca i32, align 4
  %ctx_state = alloca i32, align 4
  %ctx.addr = alloca %struct.BiContextType*, align 8
  %xr = alloca double, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @create_context_memory.15() #0 {
entry:
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 452562254, i32* %canary
  %num_mb = alloca i32, align 4
  %k = alloca i32, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %FrameSizeInMbs = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 111
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_context_memory.16() #0 {
entry:
  %canary = alloca i32
  store i32 1788779288, i32* %canary
  %i = alloca i32, align 4
  %k = alloca i32, align 4
  store i32 0, i32* %k, align 4
  br label %for.cond
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @create_context_memory.17() #0 {
entry:
  %k = alloca i32, align 4
  %num_mb = alloca i32, align 4
  %canary = alloca i32
  store i32 1820201980, i32* %canary
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %FrameSizeInMbs = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 111
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @SetCtxModelNumber.18() #0 {
entry:
  %canary = alloca i32
  store i32 309069354, i32* %canary
  %ctx_number = alloca i32, align 4
  %frame_field = alloca i32, align 4
  %img_type = alloca i32, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
entry:
  ...
  %canary = alloca i32
  store i32 369304709, i32* %canary
  %j = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1153525897, i32* %canary
  %num_mb = alloca i32, align 4
  %j = alloca i32, align 4
  %k = alloca i32, align 4
  %i = alloca i32, align 4
...
entry:
  ...
  %mc.addr = alloca %struct.MotionInfoContexts*, align 8
  %canary = alloca i32
  store i32 1170241007, i32* %canary
  %tc.addr = alloca %struct.TextureInfoContexts*, align 8
  %min_xr = alloca double, align 8
  %i = alloca i32, align 4
  %xr = alloca double, align 8
...
for.end685:                                       ; preds = %for.cond
  %321 = load i32, i32* %canary
  %322 = icmp eq i32 %321, 1170241007
  br i1 %322, label %323, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_context_memory.22() #0 {
entry:
  %canary = alloca i32
  store i32 899890427, i32* %canary
  %k = alloca i32, align 4
  %i = alloca i32, align 4
  store i32 0, i32* %k, align 4
  br label %for.cond
...
entry:
  %frame_field = alloca i32, align 4
  %canary = alloca i32
  store i32 256802340, i32* %canary
  %ctx_number = alloca i32, align 4
  %img_type = alloca i32, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %field_picture = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 100
...
entry:
  %canary = alloca i32
  store i32 1264796286, i32* %canary
  %img_type = alloca i32, align 4
  %ctx_number = alloca i32, align 4
  %frame_field = alloca i32, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 812014242, i32* %canary
  %tc = alloca %struct.TextureInfoContexts*, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %currentSlice = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 50
  %1 = load %struct.Slice*, %struct.Slice** %currentSlice, align 8
...
entry:
  %frame_field = alloca i32, align 4
  %canary = alloca i32
  store i32 558421195, i32* %canary
  %ctx_number = alloca i32, align 4
  %img_type = alloca i32, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %field_picture = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 100
...
entry:
  ...
  %xr = alloca double, align 8
  %canary = alloca i32
  store i32 1042330417, i32* %canary
  %num_models = alloca i32, align 4
  %tc.addr = alloca %struct.TextureInfoContexts*, align 8
  %mnumber.addr = alloca i32*, align 8
  %model = alloca i32, align 4
...
for.end685:                                       ; preds = %for.cond
  %321 = load i32, i32* %canary
  %322 = icmp eq i32 %321, 1042330417
  br i1 %322, label %323, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @init_contexts.28() #0 {
entry:
  %tc = alloca %struct.TextureInfoContexts*, align 8
  %mc = alloca %struct.MotionInfoContexts*, align 8
  %canary = alloca i32
  store i32 696707787, i32* %canary
  %j = alloca i32, align 4
  %i = alloca i32, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %currentSlice = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 50
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @init_contexts.29() #0 {
entry:
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 71526433, i32* %canary
  %tc = alloca %struct.TextureInfoContexts*, align 8
  %i = alloca i32, align 4
  %mc = alloca %struct.MotionInfoContexts*, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
entry:
  ...
  %mnumber.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 697612331, i32* %canary
  %tc.addr = alloca %struct.TextureInfoContexts*, align 8
  %mc.addr = alloca %struct.MotionInfoContexts*, align 8
  %j = alloca i32, align 4
  %xr = alloca double, align 8
