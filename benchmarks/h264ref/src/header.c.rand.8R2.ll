...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_SliceHeader.1, label %ctrl0

func_SliceHeader.1:                               ; preds = %rand_bb
  %2 = call i32 @SliceHeader.1()
  ret i32 %2

func_SliceHeader.9:                               ; preds = %ctrl0
  %3 = call i32 @SliceHeader.9()
  ret i32 %3
...
func_SliceHeader.13:                              ; preds = %ctrl2
  %5 = call i32 @SliceHeader.13()
  ret i32 %5

func_SliceHeader.20:                              ; preds = %ctrl3
  %6 = call i32 @SliceHeader.20()
  ret i32 %6

func_SliceHeader.21:                              ; preds = %ctrl4
  %7 = call i32 @SliceHeader.21()
  ret i32 %7

func_SliceHeader.22:                              ; preds = %ctrl5
  %8 = call i32 @SliceHeader.22()
  ret i32 %8

func_SliceHeader.32:                              ; preds = %ctrl5
  %9 = call i32 @SliceHeader.32()
  ret i32 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_SliceHeader.9, label %ctrl1
...
ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_SliceHeader.13, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_SliceHeader.20, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_SliceHeader.21, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_SliceHeader.22, label %func_SliceHeader.32
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_get_picture_type.4, label %func_get_picture_type.6

func_get_picture_type.4:                          ; preds = %rand_bb
  %2 = call i32 @get_picture_type.4()
  ret i32 %2

func_get_picture_type.6:                          ; preds = %rand_bb
  %3 = call i32 @get_picture_type.6()
  ret i32 %3
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_Partition_BC_Header.8, label %ctrl0

func_Partition_BC_Header.8:                       ; preds = %rand_bb
  %2 = call i32 @Partition_BC_Header.8(i32 %PartNo)
  ret i32 %2

func_Partition_BC_Header.19:                      ; preds = %ctrl0
  %3 = call i32 @Partition_BC_Header.19(i32 %PartNo)
  ret i32 %3

func_Partition_BC_Header.29:                      ; preds = %ctrl1
  %4 = call i32 @Partition_BC_Header.29(i32 %PartNo)
  ret i32 %4

func_Partition_BC_Header.30:                      ; preds = %ctrl2
  %5 = call i32 @Partition_BC_Header.30(i32 %PartNo)
  ret i32 %5

func_Partition_BC_Header.31:                      ; preds = %ctrl3
  %6 = call i32 @Partition_BC_Header.31(i32 %PartNo)
  ret i32 %6

func_Partition_BC_Header.33:                      ; preds = %ctrl4
  %7 = call i32 @Partition_BC_Header.33(i32 %PartNo)
  ret i32 %7

func_Partition_BC_Header.34:                      ; preds = %ctrl5
  %8 = call i32 @Partition_BC_Header.34(i32 %PartNo)
  ret i32 %8

func_Partition_BC_Header.39:                      ; preds = %ctrl5
  %9 = call i32 @Partition_BC_Header.39(i32 %PartNo)
  ret i32 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_Partition_BC_Header.19, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_Partition_BC_Header.29, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_Partition_BC_Header.30, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_Partition_BC_Header.31, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_Partition_BC_Header.33, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_Partition_BC_Header.34, label %func_Partition_BC_Header.39
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_ref_pic_list_reordering.28, label %ctrl0

func_ref_pic_list_reordering.28:                  ; preds = %rand_bb
  %2 = call i32 @ref_pic_list_reordering.28()
  ret i32 %2

func_ref_pic_list_reordering.35:                  ; preds = %ctrl0
  %3 = call i32 @ref_pic_list_reordering.35()
  ret i32 %3

func_ref_pic_list_reordering.36:                  ; preds = %ctrl1
  %4 = call i32 @ref_pic_list_reordering.36()
  ret i32 %4

func_ref_pic_list_reordering.37:                  ; preds = %ctrl2
  %5 = call i32 @ref_pic_list_reordering.37()
  ret i32 %5

func_ref_pic_list_reordering.38:                  ; preds = %ctrl3
  %6 = call i32 @ref_pic_list_reordering.38()
  ret i32 %6

func_ref_pic_list_reordering.40:                  ; preds = %ctrl4
  %7 = call i32 @ref_pic_list_reordering.40()
  ret i32 %7

func_ref_pic_list_reordering.41:                  ; preds = %ctrl5
  %8 = call i32 @ref_pic_list_reordering.41()
  ret i32 %8

func_ref_pic_list_reordering.42:                  ; preds = %ctrl5
  %9 = call i32 @ref_pic_list_reordering.42()
  ret i32 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_ref_pic_list_reordering.35, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_ref_pic_list_reordering.36, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_ref_pic_list_reordering.37, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_ref_pic_list_reordering.38, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_ref_pic_list_reordering.40, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_ref_pic_list_reordering.41, label %func_ref_pic_list_reordering.42
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_dec_ref_pic_marking.2, label %ctrl0

func_dec_ref_pic_marking.2:                       ; preds = %rand_bb
  %2 = call i32 @dec_ref_pic_marking.2()
  ret i32 %2
...
func_dec_ref_pic_marking.7:                       ; preds = %ctrl1
  %4 = call i32 @dec_ref_pic_marking.7()
  ret i32 %4

func_dec_ref_pic_marking.10:                      ; preds = %ctrl2
  %5 = call i32 @dec_ref_pic_marking.10()
  ret i32 %5

func_dec_ref_pic_marking.15:                      ; preds = %ctrl3
  %6 = call i32 @dec_ref_pic_marking.15()
  ret i32 %6

func_dec_ref_pic_marking.18:                      ; preds = %ctrl4
  %7 = call i32 @dec_ref_pic_marking.18()
  ret i32 %7

func_dec_ref_pic_marking.23:                      ; preds = %ctrl5
  %8 = call i32 @dec_ref_pic_marking.23()
  ret i32 %8

func_dec_ref_pic_marking.25:                      ; preds = %ctrl5
  %9 = call i32 @dec_ref_pic_marking.25()
  ret i32 %9
...
ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_dec_ref_pic_marking.7, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_dec_ref_pic_marking.10, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_dec_ref_pic_marking.15, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_dec_ref_pic_marking.18, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_dec_ref_pic_marking.23, label %func_dec_ref_pic_marking.25
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_pred_weight_table.3, label %ctrl0

func_pred_weight_table.3:                         ; preds = %rand_bb
  %2 = call i32 @pred_weight_table.3()
  ret i32 %2

func_pred_weight_table.11:                        ; preds = %ctrl0
  %3 = call i32 @pred_weight_table.11()
  ret i32 %3

func_pred_weight_table.14:                        ; preds = %ctrl1
  %4 = call i32 @pred_weight_table.14()
  ret i32 %4

func_pred_weight_table.16:                        ; preds = %ctrl2
  %5 = call i32 @pred_weight_table.16()
  ret i32 %5

func_pred_weight_table.17:                        ; preds = %ctrl3
  %6 = call i32 @pred_weight_table.17()
  ret i32 %6

func_pred_weight_table.24:                        ; preds = %ctrl4
  %7 = call i32 @pred_weight_table.24()
  ret i32 %7

func_pred_weight_table.26:                        ; preds = %ctrl5
  %8 = call i32 @pred_weight_table.26()
  ret i32 %8

func_pred_weight_table.27:                        ; preds = %ctrl5
  %9 = call i32 @pred_weight_table.27()
  ret i32 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_pred_weight_table.11, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_pred_weight_table.14, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_pred_weight_table.16, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_pred_weight_table.17, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_pred_weight_table.24, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_pred_weight_table.26, label %func_pred_weight_table.27
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @SliceHeader.1() #0 {
entry:
  %canary = alloca i32
  store i32 2045004089, i32* %canary
...
if.end239:                                        ; preds = %if.then236, %land.lhs.true232, %if.end229
  ...
  %238 = icmp eq i32 %237, 2045004089
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @dec_ref_pic_marking.2() #0 {
entry:
  %canary = alloca i32
  store i32 585291055, i32* %canary
  %len = alloca i32, align 4
  %dP_nr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @pred_weight_table.3() #0 {
entry:
  %dP_nr = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
  %canary = alloca i32
  store i32 1236190658, i32* %canary
  %len = alloca i32, align 4
...
if.end175:                                        ; preds = %for.end174, %for.end83
  ...
  %172 = icmp eq i32 %171, 1236190658
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_picture_type.4() #0 {
entry:
  %same_slicetype_for_whole_frame = alloca i32, align 4
  %canary = alloca i32
  store i32 1413800502, i32* %canary
...
entry:
  ...
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
  %canary = alloca i32
  store i32 1240365598, i32* %canary
  %dP_nr = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
  %val = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_picture_type.6() #0 {
entry:
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 289368645, i32* %canary
  %same_slicetype_for_whole_frame = alloca i32, align 4
  store i32 5, i32* %same_slicetype_for_whole_frame, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %type = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 6
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @dec_ref_pic_marking.7() #0 {
entry:
  %len = alloca i32, align 4
  %dP_nr = alloca i32, align 4
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
  %canary = alloca i32
  store i32 934338950, i32* %canary
  %partition = alloca %struct.datapartition*, align 8
  %val = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @Partition_BC_Header.8(i32 %PartNo) #0 {
entry:
  %symbol = alloca %struct.syntaxelement, align 8
  %partition = alloca %struct.datapartition*, align 8
  %canary = alloca i32
  store i32 304699639, i32* %canary
  %len = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @SliceHeader.9() #0 {
entry:
  %numtmp = alloca float, align 4
  %num_bits_slice_group_change_cycle = alloca i32, align 4
  %canary = alloca i32
  store i32 829726602, i32* %canary
  %field_pic_flag = alloca i32, align 4
  %bottom_field_flag = alloca i32, align 4
  %len = alloca i32, align 4
  %override_flag = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @dec_ref_pic_marking.10() #0 {
entry:
  %partition = alloca %struct.datapartition*, align 8
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
  %dP_nr = alloca i32, align 4
  %canary = alloca i32
  store i32 913332044, i32* %canary
  %len = alloca i32, align 4
  %val = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @pred_weight_table.11() #0 {
entry:
  %canary = alloca i32
  store i32 898106855, i32* %canary
  %i = alloca i32, align 4
  %len = alloca i32, align 4
  %j = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
...
entry:
  ...
  %currSlice = alloca %struct.Slice*, align 8
  %canary = alloca i32
  store i32 1896050346, i32* %canary
  %num_bits_slice_group_change_cycle = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
  %override_flag = alloca i32, align 4
  %bottom_field_flag = alloca i32, align 4
...
if.end239:                                        ; preds = %if.then236, %land.lhs.true232, %if.end229
  %236 = load i32, i32* %len, align 4
  %237 = load i32, i32* %canary
  %238 = icmp eq i32 %237, 1896050346
  br i1 %238, label %239, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @SliceHeader.13() #0 {
entry:
  %len = alloca i32, align 4
  %currSlice = alloca %struct.Slice*, align 8
  %override_flag = alloca i32, align 4
  ...
  %num_bits_slice_group_change_cycle = alloca i32, align 4
  %canary = alloca i32
  store i32 1639346632, i32* %canary
  %field_pic_flag = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
  %1 = load i32, i32* %partition_mode, align 4
...
if.end239:                                        ; preds = %if.then236, %land.lhs.true232, %if.end229
  %236 = load i32, i32* %len, align 4
  %237 = load i32, i32* %canary
  %238 = icmp eq i32 %237, 1639346632
  br i1 %238, label %239, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @pred_weight_table.14() #0 {
entry:
  %len = alloca i32, align 4
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 373150617, i32* %canary
  %partition = alloca %struct.datapartition*, align 8
  %dP_nr = alloca i32, align 4
  %i = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @dec_ref_pic_marking.15() #0 {
entry:
  %len = alloca i32, align 4
  %val = alloca i32, align 4
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
  %canary = alloca i32
  store i32 1310898469, i32* %canary
  %partition = alloca %struct.datapartition*, align 8
  %dP_nr = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @pred_weight_table.16() #0 {
entry:
  %partition = alloca %struct.datapartition*, align 8
  %dP_nr = alloca i32, align 4
  %j = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @pred_weight_table.17() #0 {
entry:
  %len = alloca i32, align 4
  %dP_nr = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
  %canary = alloca i32
  store i32 1464193510, i32* %canary
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
...
if.end175:                                        ; preds = %for.end174, %for.end83
  %170 = load i32, i32* %len, align 4
  %171 = load i32, i32* %canary
  %172 = icmp eq i32 %171, 1464193510
  br i1 %172, label %173, label %func_exit
...
entry:
  ...
  %partition = alloca %struct.datapartition*, align 8
  %canary = alloca i32
  store i32 408877982, i32* %canary
  %val = alloca i32, align 4
  %len = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @Partition_BC_Header.19(i32 %PartNo) #0 {
entry:
  %partition = alloca %struct.datapartition*, align 8
  %symbol = alloca %struct.syntaxelement, align 8
  %sym = alloca %struct.syntaxelement*, align 8
  %canary = alloca i32
  store i32 605255135, i32* %canary
  %len = alloca i32, align 4
  %PartNo.addr = alloca i32, align 4
  store i32 %PartNo, i32* %PartNo.addr, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @SliceHeader.20() #0 {
entry:
  %field_pic_flag = alloca i32, align 4
  %bottom_field_flag = alloca i32, align 4
  %override_flag = alloca i32, align 4
  ...
  %partition = alloca %struct.datapartition*, align 8
  %canary = alloca i32
  store i32 367475220, i32* %canary
  %currSlice = alloca %struct.Slice*, align 8
  %dP_nr = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @SliceHeader.21() #0 {
entry:
  %field_pic_flag = alloca i32, align 4
  %len = alloca i32, align 4
  %canary = alloca i32
  store i32 1408629922, i32* %canary
  %override_flag = alloca i32, align 4
  %numtmp = alloca float, align 4
  %dP_nr = alloca i32, align 4
  %currSlice = alloca %struct.Slice*, align 8
...
if.end239:                                        ; preds = %if.then236, %land.lhs.true232, %if.end229
  %236 = load i32, i32* %len, align 4
  %237 = load i32, i32* %canary
  %238 = icmp eq i32 %237, 1408629922
  br i1 %238, label %239, label %func_exit
...
entry:
  %currSlice = alloca %struct.Slice*, align 8
  %canary = alloca i32
  store i32 2118195681, i32* %canary
  %numtmp = alloca float, align 4
  %num_bits_slice_group_change_cycle = alloca i32, align 4
  %override_flag = alloca i32, align 4
  %field_pic_flag = alloca i32, align 4
...
if.end239:                                        ; preds = %if.then236, %land.lhs.true232, %if.end229
  %236 = load i32, i32* %len, align 4
  %237 = load i32, i32* %canary
  %238 = icmp eq i32 %237, 2118195681
  br i1 %238, label %239, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @dec_ref_pic_marking.23() #0 {
entry:
  %dP_nr = alloca i32, align 4
  %canary = alloca i32
  store i32 1088137372, i32* %canary
  %len = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
  %val = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @pred_weight_table.24() #0 {
entry:
  %len = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1361944319, i32* %canary
  %j = alloca i32, align 4
  %dP_nr = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
...
if.end175:                                        ; preds = %for.end174, %for.end83
  %170 = load i32, i32* %len, align 4
  %171 = load i32, i32* %canary
  %172 = icmp eq i32 %171, 1361944319
  br i1 %172, label %173, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @dec_ref_pic_marking.25() #0 {
entry:
  %partition = alloca %struct.datapartition*, align 8
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
  %canary = alloca i32
  store i32 875012501, i32* %canary
  %val = alloca i32, align 4
  %len = alloca i32, align 4
  %dP_nr = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @pred_weight_table.26() #0 {
entry:
  %dP_nr = alloca i32, align 4
  %canary = alloca i32
  store i32 659088363, i32* %canary
  %partition = alloca %struct.datapartition*, align 8
  %j = alloca i32, align 4
  %i = alloca i32, align 4
  %len = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @pred_weight_table.27() #0 {
entry:
  %canary = alloca i32
  store i32 1654925804, i32* %canary
  %i = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
  %len = alloca i32, align 4
  %dP_nr = alloca i32, align 4
...
if.end175:                                        ; preds = %for.end174, %for.end83
  %170 = load i32, i32* %len, align 4
  %171 = load i32, i32* %canary
  %172 = icmp eq i32 %171, 1654925804
  br i1 %172, label %173, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @ref_pic_list_reordering.28() #0 {
entry:
  %partition = alloca %struct.datapartition*, align 8
  %currSlice = alloca %struct.Slice*, align 8
  %len = alloca i32, align 4
  %canary = alloca i32
  store i32 1108866737, i32* %canary
  %dP_nr = alloca i32, align 4
  %i = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @Partition_BC_Header.29(i32 %PartNo) #0 {
entry:
  %canary = alloca i32
  store i32 1552920500, i32* %canary
  %symbol = alloca %struct.syntaxelement, align 8
  %sym = alloca %struct.syntaxelement*, align 8
  %partition = alloca %struct.datapartition*, align 8
  %PartNo.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @Partition_BC_Header.30(i32 %PartNo) #0 {
entry:
  %symbol = alloca %struct.syntaxelement, align 8
  %PartNo.addr = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
  %len = alloca i32, align 4
  %canary = alloca i32
  store i32 351773415, i32* %canary
  %sym = alloca %struct.syntaxelement*, align 8
  store i32 %PartNo, i32* %PartNo.addr, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %currentSlice = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 50
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @Partition_BC_Header.31(i32 %PartNo) #0 {
entry:
  %sym = alloca %struct.syntaxelement*, align 8
  %symbol = alloca %struct.syntaxelement, align 8
  %len = alloca i32, align 4
  %PartNo.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 484718846, i32* %canary
  %partition = alloca %struct.datapartition*, align 8
  store i32 %PartNo, i32* %PartNo.addr, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %currentSlice = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 50
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @SliceHeader.32() #0 {
entry:
  %currSlice = alloca %struct.Slice*, align 8
  %override_flag = alloca i32, align 4
  %num_bits_slice_group_change_cycle = alloca i32, align 4
  ...
  %len = alloca i32, align 4
  %canary = alloca i32
  store i32 227537179, i32* %canary
  %partition = alloca %struct.datapartition*, align 8
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
  %1 = load i32, i32* %partition_mode, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @Partition_BC_Header.33(i32 %PartNo) #0 {
entry:
  %canary = alloca i32
  store i32 235434545, i32* %canary
  %PartNo.addr = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
  %symbol = alloca %struct.syntaxelement, align 8
  %sym = alloca %struct.syntaxelement*, align 8
...
entry:
  ...
  %len = alloca i32, align 4
  %canary = alloca i32
  store i32 2028616335, i32* %canary
  %symbol = alloca %struct.syntaxelement, align 8
  %sym = alloca %struct.syntaxelement*, align 8
  %PartNo.addr = alloca i32, align 4
  store i32 %PartNo, i32* %PartNo.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @ref_pic_list_reordering.35() #0 {
entry:
  %currSlice = alloca %struct.Slice*, align 8
  %i = alloca i32, align 4
  %len = alloca i32, align 4
  %canary = alloca i32
  store i32 1182915199, i32* %canary
  %partition = alloca %struct.datapartition*, align 8
  %dP_nr = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 606125070, i32* %canary
  %len = alloca i32, align 4
  %currSlice = alloca %struct.Slice*, align 8
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @ref_pic_list_reordering.37() #0 {
entry:
  %partition = alloca %struct.datapartition*, align 8
  %dP_nr = alloca i32, align 4
  %currSlice = alloca %struct.Slice*, align 8
  %len = alloca i32, align 4
  %canary = alloca i32
  store i32 1114348900, i32* %canary
  %i = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
  %1 = load i32, i32* %partition_mode, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @ref_pic_list_reordering.38() #0 {
entry:
  %currSlice = alloca %struct.Slice*, align 8
  %partition = alloca %struct.datapartition*, align 8
  %i = alloca i32, align 4
  %dP_nr = alloca i32, align 4
  %canary = alloca i32
  store i32 2087728421, i32* %canary
  %len = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
  %1 = load i32, i32* %partition_mode, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @Partition_BC_Header.39(i32 %PartNo) #0 {
entry:
  %symbol = alloca %struct.syntaxelement, align 8
  %partition = alloca %struct.datapartition*, align 8
  %canary = alloca i32
  store i32 976845998, i32* %canary
  %PartNo.addr = alloca i32, align 4
  %len = alloca i32, align 4
  %sym = alloca %struct.syntaxelement*, align 8
  store i32 %PartNo, i32* %PartNo.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @ref_pic_list_reordering.40() #0 {
entry:
  %i = alloca i32, align 4
  %currSlice = alloca %struct.Slice*, align 8
  %partition = alloca %struct.datapartition*, align 8
  %dP_nr = alloca i32, align 4
  %canary = alloca i32
  store i32 1399621941, i32* %canary
  %len = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
  %1 = load i32, i32* %partition_mode, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @ref_pic_list_reordering.41() #0 {
entry:
  %canary = alloca i32
  store i32 2065301954, i32* %canary
  %partition = alloca %struct.datapartition*, align 8
  %len = alloca i32, align 4
  %currSlice = alloca %struct.Slice*, align 8
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @ref_pic_list_reordering.42() #0 {
entry:
  %len = alloca i32, align 4
  %currSlice = alloca %struct.Slice*, align 8
  %canary = alloca i32
  store i32 1616376035, i32* %canary
  %dP_nr = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
  %i = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
