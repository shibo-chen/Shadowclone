; ModuleID = 'output.c.rand.16P3.bc'
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_testEndian.30, label %func_testEndian.31

func_testEndian.30:                               ; preds = %rand_bb
  %2 = call i32 @testEndian.30()
  ret i32 %2

func_testEndian.31:                               ; preds = %rand_bb
  %3 = call i32 @testEndian.31()
  ret i32 %3
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_img2buf.13, label %ctrl0

func_img2buf.13:                                  ; preds = %rand_bb
...
func_img2buf.17:                                  ; preds = %ctrl0
  call void @img2buf.17(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom)
  ret void

func_img2buf.22:                                  ; preds = %ctrl1
  call void @img2buf.22(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom)
  ret void

func_img2buf.23:                                  ; preds = %ctrl2
  call void @img2buf.23(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom)
  ret void

func_img2buf.28:                                  ; preds = %ctrl3
...
func_img2buf.38:                                  ; preds = %ctrl5
  call void @img2buf.38(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom)
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_img2buf.17, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_img2buf.22, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_img2buf.23, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_img2buf.28, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_img2buf.36, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_img2buf.38, label %ctrl6
...
ctrl8:                                            ; preds = %ctrl7
  %10 = icmp eq i32 %0, 9
  br i1 %10, label %func_img2buf.42, label %ctrl9

ctrl9:                                            ; preds = %ctrl8
  %11 = icmp eq i32 %0, 10
  br i1 %11, label %func_img2buf.44, label %ctrl10

ctrl10:                                           ; preds = %ctrl9
  %12 = icmp eq i32 %0, 11
  br i1 %12, label %func_img2buf.45, label %ctrl11
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_write_picture.5, label %ctrl0

func_write_picture.5:                             ; preds = %rand_bb
  call void @write_picture.5(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure)
  ret void

func_write_picture.9:                             ; preds = %ctrl0
  call void @write_picture.9(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure)
  ret void

func_write_picture.11:                            ; preds = %ctrl1
  call void @write_picture.11(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure)
  ret void

func_write_picture.12:                            ; preds = %ctrl2
  call void @write_picture.12(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure)
  ret void

func_write_picture.15:                            ; preds = %ctrl3
  call void @write_picture.15(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure)
  ret void

func_write_picture.21:                            ; preds = %ctrl3
  call void @write_picture.21(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_write_picture.9, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_write_picture.11, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_write_picture.12, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_write_picture.15, label %func_write_picture.21
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_write_out_picture.7, label %ctrl0

func_write_out_picture.7:                         ; preds = %rand_bb
  call void @write_out_picture.7(%struct.storable_picture* %p, i32 %p_out)
  ret void

func_write_out_picture.8:                         ; preds = %ctrl0
  call void @write_out_picture.8(%struct.storable_picture* %p, i32 %p_out)
  ret void

func_write_out_picture.16:                        ; preds = %ctrl1
  call void @write_out_picture.16(%struct.storable_picture* %p, i32 %p_out)
  ret void

func_write_out_picture.19:                        ; preds = %ctrl2
  call void @write_out_picture.19(%struct.storable_picture* %p, i32 %p_out)
  ret void

func_write_out_picture.25:                        ; preds = %ctrl3
  call void @write_out_picture.25(%struct.storable_picture* %p, i32 %p_out)
  ret void
...
func_write_out_picture.34:                        ; preds = %ctrl7
  call void @write_out_picture.34(%struct.storable_picture* %p, i32 %p_out)
  ret void

func_write_out_picture.35:                        ; preds = %ctrl8
  call void @write_out_picture.35(%struct.storable_picture* %p, i32 %p_out)
  ret void

func_write_out_picture.37:                        ; preds = %ctrl9
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_write_out_picture.8, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_write_out_picture.16, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_write_out_picture.19, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_write_out_picture.25, label %ctrl4
...
ctrl7:                                            ; preds = %ctrl6
  %9 = icmp eq i32 %0, 8
  br i1 %9, label %func_write_out_picture.34, label %ctrl8

ctrl8:                                            ; preds = %ctrl7
  %10 = icmp eq i32 %0, 9
  br i1 %10, label %func_write_out_picture.35, label %ctrl9

ctrl9:                                            ; preds = %ctrl8
  %11 = icmp eq i32 %0, 10
  br i1 %11, label %func_write_out_picture.37, label %ctrl10
...
ctrl11:                                           ; preds = %ctrl10
  %13 = icmp eq i32 %0, 12
  br i1 %13, label %func_write_out_picture.43, label %ctrl12

ctrl12:                                           ; preds = %ctrl11
  %14 = icmp eq i32 %0, 13
  br i1 %14, label %func_write_out_picture.46, label %ctrl13

ctrl13:                                           ; preds = %ctrl12
  %15 = icmp eq i32 %0, 14
  br i1 %15, label %func_write_out_picture.47, label %func_write_out_picture.48
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_clear_picture.3, label %func_clear_picture.6
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_write_unpaired_field.2, label %ctrl0

func_write_unpaired_field.2:                      ; preds = %rand_bb
  call void @write_unpaired_field.2(%struct.frame_store* %fs, i32 %p_out)
  ret void

func_write_unpaired_field.18:                     ; preds = %ctrl0
  call void @write_unpaired_field.18(%struct.frame_store* %fs, i32 %p_out)
  ret void

func_write_unpaired_field.20:                     ; preds = %ctrl1
  call void @write_unpaired_field.20(%struct.frame_store* %fs, i32 %p_out)
  ret void

func_write_unpaired_field.24:                     ; preds = %ctrl2
  call void @write_unpaired_field.24(%struct.frame_store* %fs, i32 %p_out)
  ret void

func_write_unpaired_field.26:                     ; preds = %ctrl3
  call void @write_unpaired_field.26(%struct.frame_store* %fs, i32 %p_out)
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_write_unpaired_field.18, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_write_unpaired_field.20, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_write_unpaired_field.24, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_write_unpaired_field.26, label %func_write_unpaired_field.27
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_write_stored_frame.10, label %func_write_stored_frame.14

func_write_stored_frame.10:                       ; preds = %rand_bb
  call void @write_stored_frame.10(%struct.frame_store* %fs, i32 %p_out)
  ret void
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_direct_output.1, label %func_direct_output.4

func_direct_output.1:                             ; preds = %rand_bb
  call void @direct_output.1(%struct.storable_picture* %p, i32 %p_out)
  ret void

func_direct_output.4:                             ; preds = %rand_bb
  call void @direct_output.4(%struct.storable_picture* %p, i32 %p_out)
  ret void
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @direct_output.1(%struct.storable_picture* %p, i32 %p_out) #0 {
entry:
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1679450843, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_unpaired_field.2(%struct.frame_store* %fs, i32 %p_out) #0 {
entry:
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 123116451, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1071030485, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @direct_output.4(%struct.storable_picture* %p, i32 %p_out) #0 {
entry:
  %p.addr = alloca %struct.storable_picture*, align 8
  %canary = alloca i32
  store i32 1013641189, i32* %canary
  %p_out.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  %0 = load %struct.storable_picture*, %struct.storable_picture** %p.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_picture.5(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure) #0 {
entry:
  %canary = alloca i32
  store i32 1685177123, i32* %canary
  %p_out.addr = alloca i32, align 4
  %p.addr = alloca %struct.storable_picture*, align 8
...
entry:
  %canary = alloca i32
  store i32 1786706388, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  %i = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 0, i32* %i, align 4
...
entry:
  %canary = alloca i32
  store i32 1482120847, i32* %canary
  %p_out.addr = alloca i32, align 4
...
return:                                           ; preds = %if.end139, %if.then
  ...
  %193 = icmp eq i32 %192, 1482120847
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_out_picture.8(%struct.storable_picture* %p, i32 %p_out) #0 {
entry:
  %p_out.addr = alloca i32, align 4
  %crop_top = alloca i32, align 4
  %crop_bottom = alloca i32, align 4
  %canary = alloca i32
  store i32 942268597, i32* %canary
  %buf = alloca i8*, align 8
  %p.addr = alloca %struct.storable_picture*, align 8
  %crop_left = alloca i32, align 4
  %SubHeightC = alloca [4 x i32], align 16
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_picture.9(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure) #0 {
entry:
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 205457821, i32* %canary
  %real_structure.addr = alloca i32, align 4
  %p.addr = alloca %struct.storable_picture*, align 8
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_stored_frame.10(%struct.frame_store* %fs, i32 %p_out) #0 {
entry:
  %canary = alloca i32
  store i32 898034778, i32* %canary
  %p_out.addr = alloca i32, align 4
  %fs.addr = alloca %struct.frame_store*, align 8
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  ...
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 926652982, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  store i32 %real_structure, i32* %real_structure.addr, align 4
...
entry:
  %real_structure.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 239342503, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  %p_out.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 1493792744, i32* %canary
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  ...
  %109 = icmp eq i32 %108, 1493792744
...
entry:
  %fs.addr = alloca %struct.frame_store*, align 8
  %canary = alloca i32
  store i32 270327068, i32* %canary
  %p_out.addr = alloca i32, align 4
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  %0 = load i32, i32* %p_out.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 890854560, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  %p_out.addr = alloca i32, align 4
  %real_structure.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_out_picture.16(%struct.storable_picture* %p, i32 %p_out) #0 {
entry:
  %crop_right = alloca i32, align 4
  %p.addr = alloca %struct.storable_picture*, align 8
  %crop_bottom = alloca i32, align 4
  ...
  %buf = alloca i8*, align 8
  %canary = alloca i32
  store i32 1988797619, i32* %canary
  %p_out.addr = alloca i32, align 4
  %crop_left = alloca i32, align 4
  %rgb_output = alloca i32, align 4
  %symbol_size_in_bytes = alloca i32, align 4
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1988797619
  br i1 %193, label %194, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @img2buf.17(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom) #0 {
entry:
  %crop_right.addr = alloca i32, align 4
  %symbol_size_in_bytes.addr = alloca i32, align 4
  %tmp16 = alloca i16, align 2
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 447758438, i32* %canary
  %tmp32 = alloca i64, align 8
  %theight = alloca i32, align 4
  %size = alloca i32, align 4
  %ui16 = alloca i16, align 2
...
entry:
  %canary = alloca i32
  store i32 1758509033, i32* %canary
  %fs.addr = alloca %struct.frame_store*, align 8
  %p = alloca %struct.storable_picture*, align 8
  %p_out.addr = alloca i32, align 4
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
...
entry:
  ...
  %SubHeightC = alloca [4 x i32], align 16
  %canary = alloca i32
  store i32 203279300, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  %crop_top = alloca i32, align 4
  %crop_bottom = alloca i32, align 4
  %crop_right = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_unpaired_field.20(%struct.frame_store* %fs, i32 %p_out) #0 {
entry:
  %canary = alloca i32
  store i32 1431096004, i32* %canary
  %fs.addr = alloca %struct.frame_store*, align 8
  %p_out.addr = alloca i32, align 4
  %p = alloca %struct.storable_picture*, align 8
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_picture.21(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure) #0 {
entry:
  %p.addr = alloca %struct.storable_picture*, align 8
  %real_structure.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1198746223, i32* %canary
  %p_out.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  store i32 %real_structure, i32* %real_structure.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @img2buf.22(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom) #0 {
entry:
  %tmp16 = alloca i16, align 2
  %twidth = alloca i32, align 4
  %ui32 = alloca i64, align 8
  ...
  %ui8 = alloca i8, align 1
  %canary = alloca i32
  store i32 1999148095, i32* %canary
  %crop_right.addr = alloca i32, align 4
  %size_y.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %size = alloca i32, align 4
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1999148095
  br i1 %109, label %110, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @img2buf.23(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom) #0 {
entry:
  %size_x.addr = alloca i32, align 4
  %tmp16 = alloca i16, align 2
  %crop_left.addr = alloca i32, align 4
  ...
  %ui8 = alloca i8, align 1
  %canary = alloca i32
  store i32 681419737, i32* %canary
  %imgX.addr = alloca i16**, align 8
  %tmp32 = alloca i64, align 8
  %i = alloca i32, align 4
  %crop_top.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_unpaired_field.24(%struct.frame_store* %fs, i32 %p_out) #0 {
entry:
  %canary = alloca i32
  store i32 708269568, i32* %canary
  %p_out.addr = alloca i32, align 4
  %p = alloca %struct.storable_picture*, align 8
  %fs.addr = alloca %struct.frame_store*, align 8
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_out_picture.25(%struct.storable_picture* %p, i32 %p_out) #0 {
entry:
  %SubWidthC = alloca [4 x i32], align 16
  %crop_right = alloca i32, align 4
  %SubHeightC = alloca [4 x i32], align 16
  ...
  %crop_left = alloca i32, align 4
  %canary = alloca i32
  store i32 132001836, i32* %canary
  %rgb_output = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  %0 = bitcast [4 x i32]* %SubWidthC to i8*
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_unpaired_field.26(%struct.frame_store* %fs, i32 %p_out) #0 {
entry:
  %p = alloca %struct.storable_picture*, align 8
  %fs.addr = alloca %struct.frame_store*, align 8
  %canary = alloca i32
  store i32 1232766847, i32* %canary
  %p_out.addr = alloca i32, align 4
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  %0 = load %struct.frame_store*, %struct.frame_store** %fs.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 848516174, i32* %canary
  %p = alloca %struct.storable_picture*, align 8
  %p_out.addr = alloca i32, align 4
  %fs.addr = alloca %struct.frame_store*, align 8
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
...
entry:
  ...
  %crop_right.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 264184244, i32* %canary
  %theight = alloca i32, align 4
  %size_x.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %crop_left.addr = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1087314237, i32* %canary
  %crop_right = alloca i32, align 4
  %buf = alloca i8*, align 8
  %crop_bottom = alloca i32, align 4
  %SubHeightC = alloca [4 x i32], align 16
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1087314237
  br i1 %193, label %194, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @testEndian.30() #0 {
entry:
  %p = alloca i8*, align 8
  %canary = alloca i32
  store i32 1393515779, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @testEndian.31() #0 {
entry:
  %s = alloca i16, align 2
  %canary = alloca i32
  store i32 915871514, i32* %canary
  %p = alloca i8*, align 8
  %0 = bitcast i16* %s to i8*
  store i8* %0, i8** %p, align 8
  store i16 1, i16* %s, align 2
...
entry:
  ...
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1019068829, i32* %canary
  %crop_top = alloca i32, align 4
  %SubWidthC = alloca [4 x i32], align 16
  %crop_bottom = alloca i32, align 4
  %rgb_output = alloca i32, align 4
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1019068829
  br i1 %193, label %194, label %func_exit
...
entry:
  ...
  %crop_right = alloca i32, align 4
  %canary = alloca i32
  store i32 1969703692, i32* %canary
  %p_out.addr = alloca i32, align 4
  %p.addr = alloca %struct.storable_picture*, align 8
  %SubWidthC = alloca [4 x i32], align 16
  %symbol_size_in_bytes = alloca i32, align 4
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1969703692
  br i1 %193, label %194, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_out_picture.34(%struct.storable_picture* %p, i32 %p_out) #0 {
entry:
  %SubHeightC = alloca [4 x i32], align 16
  %crop_right = alloca i32, align 4
  %buf = alloca i8*, align 8
  ...
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1397563829, i32* %canary
  %crop_top = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  %0 = bitcast [4 x i32]* %SubWidthC to i8*
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1397563829
  br i1 %193, label %194, label %func_exit
...
entry:
  ...
  %p.addr = alloca %struct.storable_picture*, align 8
  %canary = alloca i32
  store i32 711004295, i32* %canary
  %crop_right = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  %0 = bitcast [4 x i32]* %SubWidthC to i8*
...
entry:
  ...
  %tmp32 = alloca i64, align 8
  %canary = alloca i32
  store i32 1918955378, i32* %canary
  %crop_top.addr = alloca i32, align 4
  %symbol_size_in_bytes.addr = alloca i32, align 4
  %ui32 = alloca i64, align 8
  %size_x.addr = alloca i32, align 4
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1918955378
  br i1 %109, label %110, label %func_exit
...
entry:
  ...
  %symbol_size_in_bytes = alloca i32, align 4
  %canary = alloca i32
  store i32 1704859410, i32* %canary
  %SubWidthC = alloca [4 x i32], align 16
  %crop_bottom = alloca i32, align 4
  %buf = alloca i8*, align 8
  %SubHeightC = alloca [4 x i32], align 16
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1704859410
  br i1 %193, label %194, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @img2buf.38(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom) #0 {
entry:
  %twidth = alloca i32, align 4
  %crop_right.addr = alloca i32, align 4
  %tmp32 = alloca i64, align 8
  ...
  %crop_left.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 442272572, i32* %canary
  %size = alloca i32, align 4
  %theight = alloca i32, align 4
  %crop_top.addr = alloca i32, align 4
  %ui32 = alloca i64, align 8
...
entry:
  %canary = alloca i32
  store i32 717786241, i32* %canary
  %size_x.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %crop_top.addr = alloca i32, align 4
  %tmp32 = alloca i64, align 8
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 463573872, i32* %canary
  %size = alloca i32, align 4
  %theight = alloca i32, align 4
  %imgX.addr = alloca i16**, align 8
  %crop_right.addr = alloca i32, align 4
...
entry:
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1053271026, i32* %canary
  %SubWidthC = alloca [4 x i32], align 16
  %rgb_output = alloca i32, align 4
  %buf = alloca i8*, align 8
  %crop_right = alloca i32, align 4
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1053271026
  br i1 %193, label %194, label %func_exit
...
entry:
  ...
  %tmp16 = alloca i16, align 2
  %canary = alloca i32
  store i32 1398401562, i32* %canary
  %size = alloca i32, align 4
  %size_x.addr = alloca i32, align 4
  %theight = alloca i32, align 4
  %symbol_size_in_bytes.addr = alloca i32, align 4
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1398401562
  br i1 %109, label %110, label %func_exit
...
entry:
  %SubWidthC = alloca [4 x i32], align 16
  %canary = alloca i32
  store i32 1395903646, i32* %canary
  %symbol_size_in_bytes = alloca i32, align 4
  %crop_top = alloca i32, align 4
  %p_out.addr = alloca i32, align 4
  %crop_left = alloca i32, align 4
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1395903646
  br i1 %193, label %194, label %func_exit
...
entry:
  ...
  %crop_right.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1174647428, i32* %canary
  %i = alloca i32, align 4
  %size_x.addr = alloca i32, align 4
  %ui16 = alloca i16, align 2
  %imgX.addr = alloca i16**, align 8
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1174647428
  br i1 %109, label %110, label %func_exit
...
entry:
  ...
  %tmp32 = alloca i64, align 8
  %canary = alloca i32
  store i32 1200098428, i32* %canary
  %crop_bottom.addr = alloca i32, align 4
  %crop_top.addr = alloca i32, align 4
  %twidth = alloca i32, align 4
  %size_x.addr = alloca i32, align 4
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1200098428
  br i1 %109, label %110, label %func_exit
...
entry:
  ...
  %rgb_output = alloca i32, align 4
  %canary = alloca i32
  store i32 553161883, i32* %canary
  %p_out.addr = alloca i32, align 4
  %SubWidthC = alloca [4 x i32], align 16
  %crop_right = alloca i32, align 4
  %crop_top = alloca i32, align 4
...
entry:
  ...
  %crop_top = alloca i32, align 4
  %canary = alloca i32
  store i32 537428388, i32* %canary
  %SubHeightC = alloca [4 x i32], align 16
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  %0 = bitcast [4 x i32]* %SubWidthC to i8*
...
entry:
  ...
  %crop_left = alloca i32, align 4
  %canary = alloca i32
  store i32 2109818066, i32* %canary
  %SubHeightC = alloca [4 x i32], align 16
  %crop_top = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 2109818066
  br i1 %193, label %194, label %func_exit
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 843864698, i32* %canary
  %size_y.addr = alloca i32, align 4
  %j = alloca i32, align 4
  %ui8 = alloca i8, align 1
  %ui16 = alloca i16, align 2
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 2084777150, i32* %canary
  %buf.addr = alloca i8*, align 8
  %crop_top.addr = alloca i32, align 4
  %imgX.addr = alloca i16**, align 8
  %tmp16 = alloca i16, align 2
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 2084777150
  br i1 %109, label %110, label %func_exit
...
entry:
  ...
  %size_x.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1751411789, i32* %canary
  %theight = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %crop_right.addr = alloca i32, align 4
  %imgX.addr = alloca i16**, align 8
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1751411789
  br i1 %109, label %110, label %func_exit
...
entry:
  ...
  %ui8 = alloca i8, align 1
  %canary = alloca i32
  store i32 1192560974, i32* %canary
  %ui16 = alloca i16, align 2
  %crop_left.addr = alloca i32, align 4
  %size_x.addr = alloca i32, align 4
  %twidth = alloca i32, align 4
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1192560974
  br i1 %109, label %110, label %func_exit
