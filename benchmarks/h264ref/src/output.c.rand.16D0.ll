; ModuleID = 'output.c.rand.16D0.bc'
...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_testEndian.2, label %func_testEndian.4

func_testEndian.2:                                ; preds = %rand_bb
  %2 = call i32 @testEndian.2()
  ret i32 %2

func_testEndian.4:                                ; preds = %rand_bb
  %3 = call i32 @testEndian.4()
  ret i32 %3
}
...
func_img2buf.14:                                  ; preds = %ctrl0
  call void @img2buf.14(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom)
  ret void

func_img2buf.20:                                  ; preds = %ctrl1
...
func_img2buf.26:                                  ; preds = %ctrl4
  call void @img2buf.26(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom)
  ret void

func_img2buf.31:                                  ; preds = %ctrl5
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_img2buf.14, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_img2buf.20, label %ctrl2
...
ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_img2buf.26, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_img2buf.31, label %ctrl6

ctrl6:                                            ; preds = %ctrl5
  %8 = icmp eq i32 %0, 7
  br i1 %8, label %func_img2buf.35, label %ctrl7

ctrl7:                                            ; preds = %ctrl6
  %9 = icmp eq i32 %0, 8
  br i1 %9, label %func_img2buf.37, label %ctrl8

ctrl8:                                            ; preds = %ctrl7
  %10 = icmp eq i32 %0, 9
  br i1 %10, label %func_img2buf.43, label %ctrl9
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_write_picture.12, label %ctrl0

func_write_picture.12:                            ; preds = %rand_bb
  call void @write_picture.12(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure)
  ret void

func_write_picture.17:                            ; preds = %ctrl0
...
func_write_picture.25:                            ; preds = %ctrl2
  call void @write_picture.25(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure)
  ret void

func_write_picture.27:                            ; preds = %ctrl3
  call void @write_picture.27(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure)
  ret void

func_write_picture.36:                            ; preds = %ctrl3
  call void @write_picture.36(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_write_picture.17, label %ctrl1
...
ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_write_picture.25, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_write_picture.27, label %func_write_picture.36
}
...
func_write_out_picture.10:                        ; preds = %ctrl0
  call void @write_out_picture.10(%struct.storable_picture* %p, i32 %p_out)
  ret void

func_write_out_picture.13:                        ; preds = %ctrl1
  call void @write_out_picture.13(%struct.storable_picture* %p, i32 %p_out)
  ret void
...
func_write_out_picture.44:                        ; preds = %ctrl12
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_write_out_picture.10, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_write_out_picture.13, label %ctrl2
...
ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_write_out_picture.28, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_write_out_picture.30, label %ctrl6

ctrl6:                                            ; preds = %ctrl5
  %8 = icmp eq i32 %0, 7
  br i1 %8, label %func_write_out_picture.32, label %ctrl7

ctrl7:                                            ; preds = %ctrl6
  %9 = icmp eq i32 %0, 8
  br i1 %9, label %func_write_out_picture.33, label %ctrl8

ctrl8:                                            ; preds = %ctrl7
  %10 = icmp eq i32 %0, 9
  br i1 %10, label %func_write_out_picture.38, label %ctrl9

ctrl9:                                            ; preds = %ctrl8
  %11 = icmp eq i32 %0, 10
  br i1 %11, label %func_write_out_picture.39, label %ctrl10

ctrl10:                                           ; preds = %ctrl9
  %12 = icmp eq i32 %0, 11
  br i1 %12, label %func_write_out_picture.40, label %ctrl11
...
ctrl12:                                           ; preds = %ctrl11
  %14 = icmp eq i32 %0, 13
  br i1 %14, label %func_write_out_picture.44, label %ctrl13
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_clear_picture.6, label %func_clear_picture.9

func_clear_picture.6:                             ; preds = %rand_bb
  call void @clear_picture.6(%struct.storable_picture* %p)
  ret void

func_clear_picture.9:                             ; preds = %rand_bb
  call void @clear_picture.9(%struct.storable_picture* %p)
  ret void
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_write_unpaired_field.5, label %ctrl0

func_write_unpaired_field.5:                      ; preds = %rand_bb
  call void @write_unpaired_field.5(%struct.frame_store* %fs, i32 %p_out)
  ret void
...
func_write_unpaired_field.22:                     ; preds = %ctrl1
  call void @write_unpaired_field.22(%struct.frame_store* %fs, i32 %p_out)
  ret void

func_write_unpaired_field.29:                     ; preds = %ctrl2
  call void @write_unpaired_field.29(%struct.frame_store* %fs, i32 %p_out)
  ret void
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_write_unpaired_field.22, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_write_unpaired_field.29, label %ctrl3
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_write_stored_frame.3, label %func_write_stored_frame.16

func_write_stored_frame.3:                        ; preds = %rand_bb
  call void @write_stored_frame.3(%struct.frame_store* %fs, i32 %p_out)
  ret void

func_write_stored_frame.16:                       ; preds = %rand_bb
  call void @write_stored_frame.16(%struct.frame_store* %fs, i32 %p_out)
  ret void
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_direct_output.11, label %func_direct_output.15

func_direct_output.11:                            ; preds = %rand_bb
  call void @direct_output.11(%struct.storable_picture* %p, i32 %p_out)
  ret void

func_direct_output.15:                            ; preds = %rand_bb
  call void @direct_output.15(%struct.storable_picture* %p, i32 %p_out)
  ret void
}
...
entry:
  ...
  %canary = alloca i32
  store i32 1898706942, i32* %canary
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  ...
  %109 = icmp eq i32 %108, 1898706942
...
entry:
  ...
  %canary = alloca i32
  store i32 360913447, i32* %canary
  %p = alloca i8*, align 8
...
entry:
  %canary = alloca i32
  store i32 1729258138, i32* %canary
  %p_out.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @testEndian.4() #0 {
entry:
  %p = alloca i8*, align 8
  %canary = alloca i32
  store i32 892681815, i32* %canary
  %s = alloca i16, align 2
  %0 = bitcast i16* %s to i8*
  store i8* %0, i8** %p, align 8
  store i16 1, i16* %s, align 2
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_unpaired_field.5(%struct.frame_store* %fs, i32 %p_out) #0 {
entry:
  %canary = alloca i32
  store i32 732423056, i32* %canary
  %p_out.addr = alloca i32, align 4
  %fs.addr = alloca %struct.frame_store*, align 8
...
entry:
  %canary = alloca i32
  store i32 1851909754, i32* %canary
  %i = alloca i32, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 849783321, i32* %canary
  %p_out.addr = alloca i32, align 4
...
entry:
  %fs.addr = alloca %struct.frame_store*, align 8
  %canary = alloca i32
  store i32 931629240, i32* %canary
  %p_out.addr = alloca i32, align 4
  %p = alloca %struct.storable_picture*, align 8
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @clear_picture.9(%struct.storable_picture* %p) #0 {
entry:
  %p.addr = alloca %struct.storable_picture*, align 8
  %canary = alloca i32
  store i32 535916414, i32* %canary
  %i = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 0, i32* %i, align 4
  br label %for.cond
...
entry:
  ...
  %rgb_output = alloca i32, align 4
  %canary = alloca i32
  store i32 547321352, i32* %canary
  %buf = alloca i8*, align 8
  %p.addr = alloca %struct.storable_picture*, align 8
  %SubHeightC = alloca [4 x i32], align 16
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @direct_output.11(%struct.storable_picture* %p, i32 %p_out) #0 {
entry:
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 650540085, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1590707475, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_out_picture.13(%struct.storable_picture* %p, i32 %p_out) #0 {
entry:
  %symbol_size_in_bytes = alloca i32, align 4
  %crop_top = alloca i32, align 4
  %SubWidthC = alloca [4 x i32], align 16
  ...
  %p.addr = alloca %struct.storable_picture*, align 8
  %canary = alloca i32
  store i32 1045063437, i32* %canary
  %crop_right = alloca i32, align 4
  %p_out.addr = alloca i32, align 4
  %SubHeightC = alloca [4 x i32], align 16
  %crop_bottom = alloca i32, align 4
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1045063437
  br i1 %193, label %194, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @img2buf.14(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom) #0 {
entry:
  %twidth = alloca i32, align 4
  %ui16 = alloca i16, align 2
  %crop_left.addr = alloca i32, align 4
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 583332000, i32* %canary
  %buf.addr = alloca i8*, align 8
  %ui32 = alloca i64, align 8
  %tmp16 = alloca i16, align 2
  store i16** %imgX, i16*** %imgX.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @direct_output.15(%struct.storable_picture* %p, i32 %p_out) #0 {
entry:
  %canary = alloca i32
  store i32 653985166, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  %p_out.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_stored_frame.16(%struct.frame_store* %fs, i32 %p_out) #0 {
entry:
  %fs.addr = alloca %struct.frame_store*, align 8
  %canary = alloca i32
  store i32 935471237, i32* %canary
  %p_out.addr = alloca i32, align 4
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  %0 = load i32, i32* %p_out.addr, align 4
...
entry:
  %real_structure.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2110937360, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  %p_out.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 1566723061, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  %real_structure.addr = alloca i32, align 4
  %p_out.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
...
entry:
  ...
  %buf = alloca i8*, align 8
  %canary = alloca i32
  store i32 1555632637, i32* %canary
  %rgb_output = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  %0 = bitcast [4 x i32]* %SubWidthC to i8*
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1555632637
  br i1 %193, label %194, label %func_exit
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1465398248, i32* %canary
  %i = alloca i32, align 4
  %ui8 = alloca i8, align 1
  %crop_top.addr = alloca i32, align 4
  %size = alloca i32, align 4
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1465398248
  br i1 %109, label %110, label %func_exit
...
entry:
  %p.addr = alloca %struct.storable_picture*, align 8
  %canary = alloca i32
  store i32 1383779871, i32* %canary
  %symbol_size_in_bytes = alloca i32, align 4
  %crop_left = alloca i32, align 4
  %crop_right = alloca i32, align 4
  %crop_bottom = alloca i32, align 4
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1383779871
  br i1 %193, label %194, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_unpaired_field.22(%struct.frame_store* %fs, i32 %p_out) #0 {
entry:
  %p = alloca %struct.storable_picture*, align 8
  %fs.addr = alloca %struct.frame_store*, align 8
  %canary = alloca i32
  store i32 49901699, i32* %canary
  %p_out.addr = alloca i32, align 4
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  %0 = load %struct.frame_store*, %struct.frame_store** %fs.addr, align 8
...
entry:
  %crop_right.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1522330725, i32* %canary
  %size_y.addr = alloca i32, align 4
  %symbol_size_in_bytes.addr = alloca i32, align 4
  %theight = alloca i32, align 4
  %crop_left.addr = alloca i32, align 4
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1522330725
  br i1 %109, label %110, label %func_exit
...
entry:
  ...
  %size_x.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1998279186, i32* %canary
  %crop_top.addr = alloca i32, align 4
  %crop_left.addr = alloca i32, align 4
  %ui16 = alloca i16, align 2
  %imgX.addr = alloca i16**, align 8
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1998279186
  br i1 %109, label %110, label %func_exit
...
entry:
  %real_structure.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1596800649, i32* %canary
  %p_out.addr = alloca i32, align 4
  %p.addr = alloca %struct.storable_picture*, align 8
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @img2buf.26(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom) #0 {
entry:
  %j = alloca i32, align 4
  %ui32 = alloca i64, align 8
  %ui16 = alloca i16, align 2
  ...
  %size_x.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 588164854, i32* %canary
  %crop_left.addr = alloca i32, align 4
  store i16** %imgX, i16*** %imgX.addr, align 8
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size_x, i32* %size_x.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_picture.27(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure) #0 {
entry:
  %canary = alloca i32
  store i32 499661372, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  %p_out.addr = alloca i32, align 4
  %real_structure.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
...
entry:
  ...
  %SubHeightC = alloca [4 x i32], align 16
  %canary = alloca i32
  store i32 1990282030, i32* %canary
  %buf = alloca i8*, align 8
  %crop_bottom = alloca i32, align 4
  %crop_right = alloca i32, align 4
  %symbol_size_in_bytes = alloca i32, align 4
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1990282030
  br i1 %193, label %194, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_unpaired_field.29(%struct.frame_store* %fs, i32 %p_out) #0 {
entry:
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1030305637, i32* %canary
  %p = alloca %struct.storable_picture*, align 8
  %fs.addr = alloca %struct.frame_store*, align 8
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_out_picture.30(%struct.storable_picture* %p, i32 %p_out) #0 {
entry:
  %canary = alloca i32
  store i32 1108743582, i32* %canary
  %crop_top = alloca i32, align 4
  %p_out.addr = alloca i32, align 4
  %rgb_output = alloca i32, align 4
  %crop_left = alloca i32, align 4
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1108743582
  br i1 %193, label %194, label %func_exit
...
entry:
  %canary = alloca i32
  store i32 475147717, i32* %canary
  %buf.addr = alloca i8*, align 8
  %crop_left.addr = alloca i32, align 4
  %crop_right.addr = alloca i32, align 4
  %crop_bottom.addr = alloca i32, align 4
...
entry:
  ...
  %crop_left = alloca i32, align 4
  %canary = alloca i32
  store i32 569065620, i32* %canary
  %symbol_size_in_bytes = alloca i32, align 4
  %crop_bottom = alloca i32, align 4
  %buf = alloca i8*, align 8
  %SubHeightC = alloca [4 x i32], align 16
...
entry:
  ...
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 412703050, i32* %canary
  %crop_top = alloca i32, align 4
  %crop_bottom = alloca i32, align 4
  %SubHeightC = alloca [4 x i32], align 16
  %crop_right = alloca i32, align 4
...
entry:
  ...
  %p = alloca %struct.storable_picture*, align 8
  %canary = alloca i32
  store i32 1224142508, i32* %canary
  %p_out.addr = alloca i32, align 4
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  %0 = load %struct.frame_store*, %struct.frame_store** %fs.addr, align 8
...
entry:
  ...
  %size_y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1123931334, i32* %canary
  %crop_left.addr = alloca i32, align 4
  %theight = alloca i32, align 4
  %ui32 = alloca i64, align 8
  %ui8 = alloca i8, align 1
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1123931334
  br i1 %109, label %110, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_picture.36(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure) #0 {
entry:
  %p_out.addr = alloca i32, align 4
  %real_structure.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 852314964, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  store i32 %real_structure, i32* %real_structure.addr, align 4
...
entry:
  ...
  %SubHeightC = alloca [4 x i32], align 16
  %canary = alloca i32
  store i32 1879086435, i32* %canary
  %p_out.addr = alloca i32, align 4
  %buf = alloca i8*, align 8
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1879086435
  br i1 %193, label %194, label %func_exit
...
entry:
  ...
  %SubWidthC = alloca [4 x i32], align 16
  %canary = alloca i32
  store i32 1128430617, i32* %canary
  %p_out.addr = alloca i32, align 4
  %SubHeightC = alloca [4 x i32], align 16
  %p.addr = alloca %struct.storable_picture*, align 8
  %rgb_output = alloca i32, align 4
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1128430617
  br i1 %193, label %194, label %func_exit
...
entry:
  ...
  %symbol_size_in_bytes = alloca i32, align 4
  %canary = alloca i32
  store i32 1097396369, i32* %canary
  %crop_top = alloca i32, align 4
  %SubWidthC = alloca [4 x i32], align 16
  %p_out.addr = alloca i32, align 4
  %p.addr = alloca %struct.storable_picture*, align 8
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1097396369
  br i1 %193, label %194, label %func_exit
...
entry:
  ...
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 760538860, i32* %canary
  %fs.addr = alloca %struct.frame_store*, align 8
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  %0 = load %struct.frame_store*, %struct.frame_store** %fs.addr, align 8
...
entry:
  ...
  %buf = alloca i8*, align 8
  %canary = alloca i32
  store i32 607061685, i32* %canary
  %crop_top = alloca i32, align 4
  %crop_bottom = alloca i32, align 4
  %rgb_output = alloca i32, align 4
  %crop_right = alloca i32, align 4
...
entry:
  ...
  %crop_right.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 993893577, i32* %canary
  %size_x.addr = alloca i32, align 4
  %twidth = alloca i32, align 4
  %size_y.addr = alloca i32, align 4
  %imgX.addr = alloca i16**, align 8
...
entry:
  ...
  %crop_left = alloca i32, align 4
  %canary = alloca i32
  store i32 1629737153, i32* %canary
  %SubWidthC = alloca [4 x i32], align 16
  %crop_top = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1629737153
  br i1 %193, label %194, label %func_exit
...
entry:
  ...
  %ui16 = alloca i16, align 2
  %canary = alloca i32
  store i32 1324550675, i32* %canary
  %crop_right.addr = alloca i32, align 4
  %theight = alloca i32, align 4
  %crop_left.addr = alloca i32, align 4
  %tmp16 = alloca i16, align 2
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1324550675
  br i1 %109, label %110, label %func_exit
...
entry:
  ...
  %crop_top = alloca i32, align 4
  %canary = alloca i32
  store i32 901731037, i32* %canary
  %crop_left = alloca i32, align 4
  %crop_right = alloca i32, align 4
  %rgb_output = alloca i32, align 4
  %symbol_size_in_bytes = alloca i32, align 4
...
entry:
  ...
  %theight = alloca i32, align 4
  %canary = alloca i32
  store i32 1956230631, i32* %canary
  %imgX.addr = alloca i16**, align 8
  %crop_right.addr = alloca i32, align 4
  %tmp32 = alloca i64, align 8
  %size = alloca i32, align 4
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1956230631
  br i1 %109, label %110, label %func_exit
...
entry:
  ...
  %symbol_size_in_bytes = alloca i32, align 4
  %canary = alloca i32
  store i32 1307671557, i32* %canary
  %crop_bottom = alloca i32, align 4
  %p_out.addr = alloca i32, align 4
  %crop_top = alloca i32, align 4
  %buf = alloca i8*, align 8
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1307671557
  br i1 %193, label %194, label %func_exit
...
entry:
  ...
  %size = alloca i32, align 4
  %canary = alloca i32
  store i32 520812237, i32* %canary
  %size_x.addr = alloca i32, align 4
  %twidth = alloca i32, align 4
  %ui32 = alloca i64, align 8
  %crop_bottom.addr = alloca i32, align 4
...
entry:
  ...
  %symbol_size_in_bytes.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1282844529, i32* %canary
  %crop_bottom.addr = alloca i32, align 4
  %size = alloca i32, align 4
  %i = alloca i32, align 4
  %j = alloca i32, align 4
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1282844529
  br i1 %109, label %110, label %func_exit
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 487602612, i32* %canary
  %ui8 = alloca i8, align 1
  %ui32 = alloca i64, align 8
  %symbol_size_in_bytes.addr = alloca i32, align 4
  %ui16 = alloca i16, align 2
...
entry:
  ...
  %ui16 = alloca i16, align 2
  %canary = alloca i32
  store i32 1365220711, i32* %canary
  %ui8 = alloca i8, align 1
  %crop_top.addr = alloca i32, align 4
  store i16** %imgX, i16*** %imgX.addr, align 8
  store i8* %buf, i8** %buf.addr, align 8
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1365220711
  br i1 %109, label %110, label %func_exit
