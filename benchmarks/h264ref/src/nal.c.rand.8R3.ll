...
func_RBSPtoEBSP.8:                                ; preds = %ctrl5
  %9 = call i32 @RBSPtoEBSP.8(i8* %streamBuffer, i32 %begin_bytepos, i32 %end_bytepos, i32 %min_num_bytes)
  ret i32 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_RBSPtoEBSP.2, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_RBSPtoEBSP.3, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_RBSPtoEBSP.4, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_RBSPtoEBSP.5, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_RBSPtoEBSP.6, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_RBSPtoEBSP.7, label %func_RBSPtoEBSP.8
}
...
entry:
  ...
  %canary = alloca i32
  store i32 1074190483, i32* %canary
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 679456723, i32* %canary
  %end_bytepos.addr = alloca i32, align 4
  store i8* %streamBuffer, i8** %streamBuffer.addr, align 8
  store i32 %begin_bytepos, i32* %begin_bytepos.addr, align 4
  store i32 %end_bytepos, i32* %end_bytepos.addr, align 4
...
entry:
  ...
  %begin_bytepos.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2067483021, i32* %canary
  %end_bytepos.addr = alloca i32, align 4
  %min_num_bytes.addr = alloca i32, align 4
  %streamBuffer.addr = alloca i8*, align 8
  store i8* %streamBuffer, i8** %streamBuffer.addr, align 8
...
entry:
  ...
  %min_num_bytes.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1564128323, i32* %canary
  %count = alloca i32, align 4
  %begin_bytepos.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %streamBuffer.addr = alloca i8*, align 8
...
entry:
  ...
  %begin_bytepos.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 409390808, i32* %canary
  %min_num_bytes.addr = alloca i32, align 4
  %streamBuffer.addr = alloca i8*, align 8
  %j = alloca i32, align 4
  %i = alloca i32, align 4
...
entry:
  %count = alloca i32, align 4
  %canary = alloca i32
  store i32 1617585093, i32* %canary
  %i = alloca i32, align 4
  %begin_bytepos.addr = alloca i32, align 4
  %streamBuffer.addr = alloca i8*, align 8
  %end_bytepos.addr = alloca i32, align 4
...
entry:
  ...
  %end_bytepos.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1055153802, i32* %canary
  %j = alloca i32, align 4
  %begin_bytepos.addr = alloca i32, align 4
  %count = alloca i32, align 4
  %streamBuffer.addr = alloca i8*, align 8
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1970960693, i32* %canary
  %count = alloca i32, align 4
  %end_bytepos.addr = alloca i32, align 4
  %streamBuffer.addr = alloca i8*, align 8
  store i8* %streamBuffer, i8** %streamBuffer.addr, align 8
