...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_WriteRTPPacket.2, label %ctrl0

func_WriteRTPPacket.2:                            ; preds = %rand_bb
  %2 = call i32 @WriteRTPPacket.2(%struct.RTPpacket_t* %p, %struct._IO_FILE* %f)
  ret i32 %2

func_WriteRTPPacket.3:                            ; preds = %ctrl0
  %3 = call i32 @WriteRTPPacket.3(%struct.RTPpacket_t* %p, %struct._IO_FILE* %f)
  ret i32 %3
...
ctrl0:                                            ; preds = %rand_bb
  %18 = icmp eq i32 %0, 1
  br i1 %18, label %func_WriteRTPPacket.3, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %19 = icmp eq i32 %0, 2
  br i1 %19, label %func_WriteRTPPacket.7, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %20 = icmp eq i32 %0, 3
  br i1 %20, label %func_WriteRTPPacket.8, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %21 = icmp eq i32 %0, 4
  br i1 %21, label %func_WriteRTPPacket.9, label %ctrl4
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_WriteRTPNALU.4, label %func_WriteRTPNALU.5

func_WriteRTPNALU.4:                              ; preds = %rand_bb
  %2 = call i32 @WriteRTPNALU.4(%struct.NALU_t* %n)
  ret i32 %2

func_WriteRTPNALU.5:                              ; preds = %rand_bb
  %3 = call i32 @WriteRTPNALU.5(%struct.NALU_t* %n)
  ret i32 %3
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_RTPUpdateTimestamp.1, label %func_RTPUpdateTimestamp.6

func_RTPUpdateTimestamp.1:                        ; preds = %rand_bb
  call void @RTPUpdateTimestamp.1(i32 %tr)
  ret void

func_RTPUpdateTimestamp.6:                        ; preds = %rand_bb
  call void @RTPUpdateTimestamp.6(i32 %tr)
  ret void
}
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @RTPUpdateTimestamp.1(i32 %tr) #0 {
entry:
  %canary = alloca i32
  store i32 1399624003, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 171374052, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @WriteRTPPacket.3(%struct.RTPpacket_t* %p, %struct._IO_FILE* %f) #0 {
entry:
  %f.addr = alloca %struct._IO_FILE*, align 8
  %intime = alloca i32, align 4
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 863698905, i32* %canary
  %p.addr = alloca %struct.RTPpacket_t*, align 8
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
  store i32 -1, i32* %intime, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @WriteRTPNALU.4(%struct.NALU_t* %n) #0 {
entry:
  %canary = alloca i32
  store i32 1939584488, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @WriteRTPNALU.5(%struct.NALU_t* %n) #0 {
entry:
  %canary = alloca i32
  store i32 2098254252, i32* %canary
  %p = alloca %struct.RTPpacket_t*, align 8
  %n.addr = alloca %struct.NALU_t*, align 8
  store %struct.NALU_t* %n, %struct.NALU_t** %n.addr, align 8
  %0 = load %struct.NALU_t*, %struct.NALU_t** %n.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @RTPUpdateTimestamp.6(i32 %tr) #0 {
entry:
  %tr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 570799112, i32* %canary
  %delta = alloca i32, align 4
  store i32 %tr, i32* %tr.addr, align 4
  %0 = load i32, i32* @RTPUpdateTimestamp.oldtr, align 4
  %cmp = icmp eq i32 %0, -1
...
entry:
  ...
  %f.addr = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 638252888, i32* %canary
  %intime = alloca i32, align 4
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
  store i32 -1, i32* %intime, align 4
...
entry:
  ...
  %p.addr = alloca %struct.RTPpacket_t*, align 8
  %canary = alloca i32
  store i32 161629425, i32* %canary
  %retval = alloca i32, align 4
  %intime = alloca i32, align 4
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1652508283, i32* %canary
  %f.addr = alloca %struct._IO_FILE*, align 8
  %retval = alloca i32, align 4
  %p.addr = alloca %struct.RTPpacket_t*, align 8
  %intime = alloca i32, align 4
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 934071897, i32* %canary
  %f.addr = alloca %struct._IO_FILE*, align 8
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
  store i32 -1, i32* %intime, align 4
...
entry:
  %p.addr = alloca %struct.RTPpacket_t*, align 8
  %canary = alloca i32
  store i32 1243614832, i32* %canary
  %retval = alloca i32, align 4
  %f.addr = alloca %struct._IO_FILE*, align 8
  %intime = alloca i32, align 4
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1295512410, i32* %canary
  %intime = alloca i32, align 4
  %retval = alloca i32, align 4
  %p.addr = alloca %struct.RTPpacket_t*, align 8
  %f.addr = alloca %struct._IO_FILE*, align 8
...
entry:
  %intime = alloca i32, align 4
  %canary = alloca i32
  store i32 2052762500, i32* %canary
  %p.addr = alloca %struct.RTPpacket_t*, align 8
  %retval = alloca i32, align 4
  %f.addr = alloca %struct._IO_FILE*, align 8
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
...
entry:
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 378745985, i32* %canary
  %intime = alloca i32, align 4
  %p.addr = alloca %struct.RTPpacket_t*, align 8
  %f.addr = alloca %struct._IO_FILE*, align 8
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 992204591, i32* %canary
  %retval = alloca i32, align 4
  %p.addr = alloca %struct.RTPpacket_t*, align 8
  %intime = alloca i32, align 4
  %f.addr = alloca %struct._IO_FILE*, align 8
...
entry:
  ...
  %p.addr = alloca %struct.RTPpacket_t*, align 8
  %canary = alloca i32
  store i32 1831163342, i32* %canary
  %retval = alloca i32, align 4
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
  store i32 -1, i32* %intime, align 4
...
entry:
  ...
  %intime = alloca i32, align 4
  %canary = alloca i32
  store i32 1857384042, i32* %canary
  %f.addr = alloca %struct._IO_FILE*, align 8
  %p.addr = alloca %struct.RTPpacket_t*, align 8
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
...
entry:
  ...
  %f.addr = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 494170912, i32* %canary
  %p.addr = alloca %struct.RTPpacket_t*, align 8
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
  store i32 -1, i32* %intime, align 4
...
entry:
  %f.addr = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 1494241405, i32* %canary
  %p.addr = alloca %struct.RTPpacket_t*, align 8
  %intime = alloca i32, align 4
  %retval = alloca i32, align 4
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 661247299, i32* %canary
  %intime = alloca i32, align 4
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
  store i32 -1, i32* %intime, align 4
