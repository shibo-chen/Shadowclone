...
.LBB6_2:                                # %func_poc_based_ref_management.6
	...
	.cfi_def_cfa %rsp, 8
	retq
.LBB6_3:                                # %func_poc_based_ref_management.15
	.cfi_def_cfa %rbp, 16
	movl	%ebx, %edi
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$48, %rsp
	movl	$2024712135, -44(%rbp)  # imm = 0x78AEA7C7
	movq	input, %rdi
...
.LBB7_65:                               # %if.end171
	...
	movq	input, %rcx
	movl	%eax, 1236(%rcx)
	cmpl	$2024712135, -44(%rbp)  # imm = 0x78AEA7C7
	jne	.LBB7_67
.LBB7_66:
	addq	$48, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$48, %rsp
	movl	$160084492, -40(%rbp)   # imm = 0x98AB20C
	movl	%edi, -36(%rbp)
	movl	$0, -8(%rbp)
...
.LBB8_16:                               # %if.end27
	...
	movq	%rax, 72512(%rcx)
.LBB8_17:                               # %return
	cmpl	$160084492, -40(%rbp)   # imm = 0x98AB20C
	jne	.LBB8_19
.LBB8_18:
	addq	$48, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$1201283415, -60(%rbp)  # imm = 0x479A2157
	movq	input, %rax
	movl	1236(%rax), %eax
	cltd
	movl	$2, %ecx
...
.LBB9_37:                               # %for.end199
	jmp	.LBB9_38
.LBB9_38:                               # %if.end200
	cmpl	$1201283415, -60(%rbp)  # imm = 0x479A2157
	jne	.LBB9_40
.LBB9_39:
	addq	$64, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$48, %rsp
	movl	$551047073, -44(%rbp)   # imm = 0x20D84FA1
	movq	input, %rdi
	addq	$1324, %rdi             # imm = 0x52C
	callq	strlen
	movl	%eax, -32(%rbp)
...
.LBB10_65:                              # %if.end171
	...
	movq	input, %rcx
	movl	%eax, 1236(%rcx)
	cmpl	$551047073, -44(%rbp)   # imm = 0x20D84FA1
	jne	.LBB10_67
.LBB10_66:
	addq	$48, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$1622224394, -60(%rbp)  # imm = 0x60B12E0A
	movq	input, %rax
	movl	1236(%rax), %eax
	cltd
	movl	$2, %ecx
...
.LBB11_37:                              # %for.end199
	jmp	.LBB11_38
.LBB11_38:                              # %if.end200
	cmpl	$1622224394, -60(%rbp)  # imm = 0x60B12E0A
	jne	.LBB11_40
.LBB11_39:
	addq	$64, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$48, %rsp
	movl	$1724841501, -40(%rbp)  # imm = 0x66CEFE1D
	movl	%edi, -36(%rbp)
	movl	$0, -8(%rbp)
	movl	$2147483647, -12(%rbp)  # imm = 0x7FFFFFFF
	movq	img, %rax
...
.LBB12_16:                              # %if.end27
	...
	movq	%rax, 72512(%rcx)
.LBB12_17:                              # %return
	cmpl	$1724841501, -40(%rbp)  # imm = 0x66CEFE1D
	jne	.LBB12_19
.LBB12_18:
	addq	$48, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$48, %rsp
	movl	$495071182, -44(%rbp)   # imm = 0x1D822FCE
	movq	input, %rdi
	addq	$1324, %rdi             # imm = 0x52C
	callq	strlen
	movl	%eax, -36(%rbp)
...
.LBB13_65:                              # %if.end171
	...
	movq	input, %rcx
	movl	%eax, 1236(%rcx)
	cmpl	$495071182, -44(%rbp)   # imm = 0x1D822FCE
	jne	.LBB13_67
.LBB13_66:
	addq	$48, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$48765509, -28(%rbp)    # imm = 0x2E81A45
	movl	%edi, -24(%rbp)
	movl	%esi, -4(%rbp)
	movl	%edx, -20(%rbp)
	movq	%rcx, -16(%rbp)
...
.LBB14_9:                               # %if.end32
	...
	callq	gop_pyramid
.LBB14_10:                              # %if.end42
	cmpl	$48765509, -28(%rbp)    # imm = 0x2E81A45
	jne	.LBB14_12
.LBB14_11:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1252713999, -28(%rbp)  # imm = 0x4AAAE60F
	movl	%edi, -20(%rbp)
	movl	%esi, -4(%rbp)
	movl	%edx, -24(%rbp)
	movq	%rcx, -16(%rbp)
...
.LBB15_9:                               # %if.end32
	...
	callq	gop_pyramid
.LBB15_10:                              # %if.end42
	cmpl	$1252713999, -28(%rbp)  # imm = 0x4AAAE60F
	jne	.LBB15_12
.LBB15_11:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$1106877256, -60(%rbp)  # imm = 0x41F99B48
	movq	input, %rax
	movl	1236(%rax), %eax
	cltd
	movl	$2, %ecx
...
.LBB16_37:                              # %for.end199
	jmp	.LBB16_38
.LBB16_38:                              # %if.end200
	cmpl	$1106877256, -60(%rbp)  # imm = 0x41F99B48
	jne	.LBB16_40
.LBB16_39:
	addq	$64, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$48, %rsp
	movl	$1600877006, -44(%rbp)  # imm = 0x5F6B71CE
	movq	input, %rdi
	addq	$1324, %rdi             # imm = 0x52C
	callq	strlen
	movl	%eax, -36(%rbp)
...
.LBB17_65:                              # %if.end171
	...
	movq	input, %rcx
	movl	%eax, 1236(%rcx)
	cmpl	$1600877006, -44(%rbp)  # imm = 0x5F6B71CE
	jne	.LBB17_67
.LBB17_66:
	addq	$48, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$113364126, -28(%rbp)   # imm = 0x6C1CC9E
	movl	%edi, -24(%rbp)
	movl	%esi, -4(%rbp)
	movl	%edx, -20(%rbp)
	movq	%rcx, -16(%rbp)
...
.LBB18_9:                               # %if.end32
	...
	callq	gop_pyramid
.LBB18_10:                              # %if.end42
	cmpl	$113364126, -28(%rbp)   # imm = 0x6C1CC9E
	jne	.LBB18_12
.LBB18_11:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$1791961826, -60(%rbp)  # imm = 0x6ACF2AE2
	movq	input, %rax
	movl	1236(%rax), %eax
	cltd
	movl	$2, %ecx
...
.LBB19_37:                              # %for.end199
	jmp	.LBB19_38
.LBB19_38:                              # %if.end200
	cmpl	$1791961826, -60(%rbp)  # imm = 0x6ACF2AE2
	jne	.LBB19_40
.LBB19_39:
	addq	$64, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$346958280, -28(%rbp)   # imm = 0x14AE29C8
	movl	%edi, -20(%rbp)
	movl	%esi, -4(%rbp)
	movl	%edx, -24(%rbp)
	movq	%rcx, -16(%rbp)
...
.LBB20_9:                               # %if.end32
	...
	callq	gop_pyramid
.LBB20_10:                              # %if.end42
	cmpl	$346958280, -28(%rbp)   # imm = 0x14AE29C8
	jne	.LBB20_12
.LBB20_11:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$48, %rsp
	movl	$2133810040, -36(%rbp)  # imm = 0x7F2F5B78
	movl	%edi, -40(%rbp)
	movl	$0, -8(%rbp)
	movl	$2147483647, -12(%rbp)  # imm = 0x7FFFFFFF
	movq	img, %rax
...
.LBB21_16:                              # %if.end27
	...
	movq	%rax, 72512(%rcx)
.LBB21_17:                              # %return
	cmpl	$2133810040, -36(%rbp)  # imm = 0x7F2F5B78
	jne	.LBB21_19
.LBB21_18:
	addq	$48, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$48, %rsp
	movl	$874614107, -40(%rbp)   # imm = 0x34218D5B
	movl	%edi, -36(%rbp)
	movl	$0, -8(%rbp)
	movl	$2147483647, -12(%rbp)  # imm = 0x7FFFFFFF
	movq	img, %rax
...
.LBB22_16:                              # %if.end27
	...
	movq	%rax, 72512(%rcx)
.LBB22_17:                              # %return
	cmpl	$874614107, -40(%rbp)   # imm = 0x34218D5B
	jne	.LBB22_19
.LBB22_18:
	addq	$48, %rsp
	popq	%rbp
