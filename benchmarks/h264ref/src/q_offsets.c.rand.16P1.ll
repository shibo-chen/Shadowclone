; ModuleID = 'q_offsets.c.rand.16P1.bc'
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_CheckOffsetParameterName.12, label %ctrl0

func_CheckOffsetParameterName.12:                 ; preds = %rand_bb
  %2 = call i32 @CheckOffsetParameterName.12(i8* %s, i32* %type)
  ret i32 %2
...
func_CheckOffsetParameterName.16:                 ; preds = %ctrl1
  %4 = call i32 @CheckOffsetParameterName.16(i8* %s, i32* %type)
  ret i32 %4
...
func_CheckOffsetParameterName.32:                 ; preds = %ctrl4
  %7 = call i32 @CheckOffsetParameterName.32(i8* %s, i32* %type)
  ret i32 %7

func_CheckOffsetParameterName.45:                 ; preds = %ctrl5
  %8 = call i32 @CheckOffsetParameterName.45(i8* %s, i32* %type)
  ret i32 %8

func_CheckOffsetParameterName.50:                 ; preds = %ctrl6
  %9 = call i32 @CheckOffsetParameterName.50(i8* %s, i32* %type)
  ret i32 %9

func_CheckOffsetParameterName.51:                 ; preds = %ctrl7
  %10 = call i32 @CheckOffsetParameterName.51(i8* %s, i32* %type)
  ret i32 %10
...
func_CheckOffsetParameterName.57:                 ; preds = %ctrl9
  %12 = call i32 @CheckOffsetParameterName.57(i8* %s, i32* %type)
  ret i32 %12

func_CheckOffsetParameterName.60:                 ; preds = %ctrl10
  %13 = call i32 @CheckOffsetParameterName.60(i8* %s, i32* %type)
  ret i32 %13

func_CheckOffsetParameterName.61:                 ; preds = %ctrl11
  %14 = call i32 @CheckOffsetParameterName.61(i8* %s, i32* %type)
  ret i32 %14

func_CheckOffsetParameterName.62:                 ; preds = %ctrl12
  %15 = call i32 @CheckOffsetParameterName.62(i8* %s, i32* %type)
  ret i32 %15

func_CheckOffsetParameterName.63:                 ; preds = %ctrl13
  %16 = call i32 @CheckOffsetParameterName.63(i8* %s, i32* %type)
  ret i32 %16
...
ctrl1:                                            ; preds = %ctrl0
  %19 = icmp eq i32 %0, 2
  br i1 %19, label %func_CheckOffsetParameterName.16, label %ctrl2
...
ctrl3:                                            ; preds = %ctrl2
  %21 = icmp eq i32 %0, 4
  br i1 %21, label %func_CheckOffsetParameterName.25, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %22 = icmp eq i32 %0, 5
  br i1 %22, label %func_CheckOffsetParameterName.32, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %23 = icmp eq i32 %0, 6
  br i1 %23, label %func_CheckOffsetParameterName.45, label %ctrl6

ctrl6:                                            ; preds = %ctrl5
  %24 = icmp eq i32 %0, 7
  br i1 %24, label %func_CheckOffsetParameterName.50, label %ctrl7

ctrl7:                                            ; preds = %ctrl6
  %25 = icmp eq i32 %0, 8
  br i1 %25, label %func_CheckOffsetParameterName.51, label %ctrl8
...
ctrl9:                                            ; preds = %ctrl8
  %27 = icmp eq i32 %0, 10
  br i1 %27, label %func_CheckOffsetParameterName.57, label %ctrl10

ctrl10:                                           ; preds = %ctrl9
  %28 = icmp eq i32 %0, 11
  br i1 %28, label %func_CheckOffsetParameterName.60, label %ctrl11

ctrl11:                                           ; preds = %ctrl10
  %29 = icmp eq i32 %0, 12
  br i1 %29, label %func_CheckOffsetParameterName.61, label %ctrl12

ctrl12:                                           ; preds = %ctrl11
  %30 = icmp eq i32 %0, 13
  br i1 %30, label %func_CheckOffsetParameterName.62, label %ctrl13

ctrl13:                                           ; preds = %ctrl12
  %31 = icmp eq i32 %0, 14
  br i1 %31, label %func_CheckOffsetParameterName.63, label %func_CheckOffsetParameterName.64
}
...
func_ParseQOffsetMatrix.19:                       ; preds = %ctrl0
  call void @ParseQOffsetMatrix.19(i8* %buf, i32 %bufsize)
  ret void

func_ParseQOffsetMatrix.20:                       ; preds = %ctrl1
  call void @ParseQOffsetMatrix.20(i8* %buf, i32 %bufsize)
  ret void

func_ParseQOffsetMatrix.22:                       ; preds = %ctrl2
  call void @ParseQOffsetMatrix.22(i8* %buf, i32 %bufsize)
  ret void

func_ParseQOffsetMatrix.23:                       ; preds = %ctrl3
...
func_ParseQOffsetMatrix.34:                       ; preds = %ctrl5
  call void @ParseQOffsetMatrix.34(i8* %buf, i32 %bufsize)
  ret void
...
func_ParseQOffsetMatrix.40:                       ; preds = %ctrl7
  call void @ParseQOffsetMatrix.40(i8* %buf, i32 %bufsize)
  ret void

func_ParseQOffsetMatrix.42:                       ; preds = %ctrl8
  call void @ParseQOffsetMatrix.42(i8* %buf, i32 %bufsize)
  ret void

func_ParseQOffsetMatrix.43:                       ; preds = %ctrl9
  call void @ParseQOffsetMatrix.43(i8* %buf, i32 %bufsize)
  ret void

func_ParseQOffsetMatrix.44:                       ; preds = %ctrl10
  call void @ParseQOffsetMatrix.44(i8* %buf, i32 %bufsize)
  ret void

func_ParseQOffsetMatrix.52:                       ; preds = %ctrl11
  call void @ParseQOffsetMatrix.52(i8* %buf, i32 %bufsize)
  ret void

func_ParseQOffsetMatrix.56:                       ; preds = %ctrl12
  call void @ParseQOffsetMatrix.56(i8* %buf, i32 %bufsize)
  ret void

func_ParseQOffsetMatrix.58:                       ; preds = %ctrl13
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_ParseQOffsetMatrix.19, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_ParseQOffsetMatrix.20, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_ParseQOffsetMatrix.22, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_ParseQOffsetMatrix.23, label %ctrl4
...
ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_ParseQOffsetMatrix.34, label %ctrl6
...
ctrl7:                                            ; preds = %ctrl6
  %9 = icmp eq i32 %0, 8
  br i1 %9, label %func_ParseQOffsetMatrix.40, label %ctrl8

ctrl8:                                            ; preds = %ctrl7
  %10 = icmp eq i32 %0, 9
  br i1 %10, label %func_ParseQOffsetMatrix.42, label %ctrl9

ctrl9:                                            ; preds = %ctrl8
  %11 = icmp eq i32 %0, 10
  br i1 %11, label %func_ParseQOffsetMatrix.43, label %ctrl10

ctrl10:                                           ; preds = %ctrl9
  %12 = icmp eq i32 %0, 11
  br i1 %12, label %func_ParseQOffsetMatrix.44, label %ctrl11

ctrl11:                                           ; preds = %ctrl10
  %13 = icmp eq i32 %0, 12
  br i1 %13, label %func_ParseQOffsetMatrix.52, label %ctrl12

ctrl12:                                           ; preds = %ctrl11
  %14 = icmp eq i32 %0, 13
  br i1 %14, label %func_ParseQOffsetMatrix.56, label %ctrl13

ctrl13:                                           ; preds = %ctrl12
  %15 = icmp eq i32 %0, 14
  br i1 %15, label %func_ParseQOffsetMatrix.58, label %func_ParseQOffsetMatrix.59
}
...
func_CalculateOffsetParam.10:                     ; preds = %ctrl2
  call void @CalculateOffsetParam.10()
  ret void
...
func_CalculateOffsetParam.13:                     ; preds = %ctrl4
  call void @CalculateOffsetParam.13()
  ret void

func_CalculateOffsetParam.15:                     ; preds = %ctrl5
  call void @CalculateOffsetParam.15()
  ret void

func_CalculateOffsetParam.24:                     ; preds = %ctrl6
  call void @CalculateOffsetParam.24()
  ret void

func_CalculateOffsetParam.26:                     ; preds = %ctrl7
  call void @CalculateOffsetParam.26()
  ret void

func_CalculateOffsetParam.27:                     ; preds = %ctrl8
  call void @CalculateOffsetParam.27()
  ret void

func_CalculateOffsetParam.28:                     ; preds = %ctrl9
  call void @CalculateOffsetParam.28()
  ret void

func_CalculateOffsetParam.29:                     ; preds = %ctrl10
  call void @CalculateOffsetParam.29()
  ret void

func_CalculateOffsetParam.30:                     ; preds = %ctrl11
  call void @CalculateOffsetParam.30()
  ret void

func_CalculateOffsetParam.31:                     ; preds = %ctrl12
  call void @CalculateOffsetParam.31()
  ret void

func_CalculateOffsetParam.35:                     ; preds = %ctrl13
  call void @CalculateOffsetParam.35()
  ret void

func_CalculateOffsetParam.37:                     ; preds = %ctrl13
...
ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_CalculateOffsetParam.10, label %ctrl3
...
ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_CalculateOffsetParam.13, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_CalculateOffsetParam.15, label %ctrl6

ctrl6:                                            ; preds = %ctrl5
  %8 = icmp eq i32 %0, 7
  br i1 %8, label %func_CalculateOffsetParam.24, label %ctrl7

ctrl7:                                            ; preds = %ctrl6
  %9 = icmp eq i32 %0, 8
  br i1 %9, label %func_CalculateOffsetParam.26, label %ctrl8

ctrl8:                                            ; preds = %ctrl7
  %10 = icmp eq i32 %0, 9
  br i1 %10, label %func_CalculateOffsetParam.27, label %ctrl9

ctrl9:                                            ; preds = %ctrl8
  %11 = icmp eq i32 %0, 10
  br i1 %11, label %func_CalculateOffsetParam.28, label %ctrl10

ctrl10:                                           ; preds = %ctrl9
  %12 = icmp eq i32 %0, 11
  br i1 %12, label %func_CalculateOffsetParam.29, label %ctrl11

ctrl11:                                           ; preds = %ctrl10
  %13 = icmp eq i32 %0, 12
  br i1 %13, label %func_CalculateOffsetParam.30, label %ctrl12

ctrl12:                                           ; preds = %ctrl11
  %14 = icmp eq i32 %0, 13
  br i1 %14, label %func_CalculateOffsetParam.31, label %ctrl13

ctrl13:                                           ; preds = %ctrl12
  %15 = icmp eq i32 %0, 14
  br i1 %15, label %func_CalculateOffsetParam.35, label %func_CalculateOffsetParam.37
}
...
func_CalculateOffset8Param.7:                     ; preds = %ctrl1
  call void @CalculateOffset8Param.7()
  ret void

func_CalculateOffset8Param.8:                     ; preds = %ctrl2
...
func_CalculateOffset8Param.18:                    ; preds = %ctrl4
  call void @CalculateOffset8Param.18()
  ret void

func_CalculateOffset8Param.21:                    ; preds = %ctrl5
  call void @CalculateOffset8Param.21()
  ret void

func_CalculateOffset8Param.36:                    ; preds = %ctrl6
  call void @CalculateOffset8Param.36()
  ret void

func_CalculateOffset8Param.39:                    ; preds = %ctrl7
  call void @CalculateOffset8Param.39()
  ret void

func_CalculateOffset8Param.41:                    ; preds = %ctrl8
...
func_CalculateOffset8Param.48:                    ; preds = %ctrl11
  call void @CalculateOffset8Param.48()
  ret void

func_CalculateOffset8Param.49:                    ; preds = %ctrl12
  call void @CalculateOffset8Param.49()
  ret void

func_CalculateOffset8Param.54:                    ; preds = %ctrl13
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_CalculateOffset8Param.7, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_CalculateOffset8Param.8, label %ctrl3
...
ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_CalculateOffset8Param.18, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_CalculateOffset8Param.21, label %ctrl6

ctrl6:                                            ; preds = %ctrl5
  %8 = icmp eq i32 %0, 7
  br i1 %8, label %func_CalculateOffset8Param.36, label %ctrl7

ctrl7:                                            ; preds = %ctrl6
  %9 = icmp eq i32 %0, 8
  br i1 %9, label %func_CalculateOffset8Param.39, label %ctrl8

ctrl8:                                            ; preds = %ctrl7
  %10 = icmp eq i32 %0, 9
  br i1 %10, label %func_CalculateOffset8Param.41, label %ctrl9
...
ctrl11:                                           ; preds = %ctrl10
  %13 = icmp eq i32 %0, 12
  br i1 %13, label %func_CalculateOffset8Param.48, label %ctrl12

ctrl12:                                           ; preds = %ctrl11
  %14 = icmp eq i32 %0, 13
  br i1 %14, label %func_CalculateOffset8Param.49, label %ctrl13

ctrl13:                                           ; preds = %ctrl12
  %15 = icmp eq i32 %0, 14
  br i1 %15, label %func_CalculateOffset8Param.54, label %func_CalculateOffset8Param.55
}
...
entry:
  %canary = alloca i32
  store i32 655132571, i32* %canary
...
entry:
  %k = alloca i32, align 4
  %canary = alloca i32
  store i32 2069618318, i32* %canary
  %j = alloca i32, align 4
...
entry:
  ...
  %q_bits = alloca i32, align 4
  %canary = alloca i32
  store i32 355282486, i32* %canary
  %i = alloca i32, align 4
  %temp = alloca i32, align 4
  %j = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
entry:
  %canary = alloca i32
  store i32 2113100698, i32* %canary
  %k = alloca i32, align 4
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %qp_per = alloca i32, align 4
...
if.end225:                                        ; preds = %for.end224, %for.end102
  %132 = load i32, i32* %canary
  %133 = icmp eq i32 %132, 2113100698
  br i1 %133, label %134, label %func_exit
...
entry:
  ...
  %temp = alloca i32, align 4
  %canary = alloca i32
  store i32 1467172483, i32* %canary
  %j = alloca i32, align 4
  %i = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %OffsetMatrixPresentFlag = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 147
...
if.end225:                                        ; preds = %for.end224, %for.end102
  %132 = load i32, i32* %canary
  %133 = icmp eq i32 %132, 1467172483
  br i1 %133, label %134, label %func_exit
...
entry:
  ...
  %p = alloca i8*, align 8
  %canary = alloca i32
  store i32 2100156460, i32* %canary
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 701157511, i32* %canary
  %i = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %OffsetMatrixPresentFlag = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 147
  %1 = load i32, i32* %OffsetMatrixPresentFlag, align 8
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1304297054, i32* %canary
  %temp = alloca i32, align 4
  %k = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %OffsetMatrixPresentFlag = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 147
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 221965928, i32* %canary
  %i = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %OffsetMatrixPresentFlag = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 147
  %1 = load i32, i32* %OffsetMatrixPresentFlag, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @CalculateOffsetParam.10() #0 {
entry:
  %qp_per = alloca i32, align 4
  %j = alloca i32, align 4
  %k = alloca i32, align 4
  %temp = alloca i32, align 4
  %canary = alloca i32
  store i32 1223475084, i32* %canary
  %i = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %OffsetMatrixPresentFlag = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 147
  %1 = load i32, i32* %OffsetMatrixPresentFlag, align 8
...
if.end225:                                        ; preds = %for.end224, %for.end102
  %132 = load i32, i32* %canary
  %133 = icmp eq i32 %132, 1223475084
  br i1 %133, label %134, label %func_exit
...
entry:
  ...
  %temp = alloca i32, align 4
  %canary = alloca i32
  store i32 314698243, i32* %canary
  %j = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %OffsetMatrixPresentFlag = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 147
  %1 = load i32, i32* %OffsetMatrixPresentFlag, align 8
...
entry:
  ...
  %canary = alloca i32
  store i32 1425686038, i32* %canary
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @CalculateOffsetParam.13() #0 {
entry:
  %k = alloca i32, align 4
  %canary = alloca i32
  store i32 1344096480, i32* %canary
  %temp = alloca i32, align 4
  %j = alloca i32, align 4
  %i = alloca i32, align 4
  %qp_per = alloca i32, align 4
...
if.end225:                                        ; preds = %for.end224, %for.end102
  %132 = load i32, i32* %canary
  %133 = icmp eq i32 %132, 1344096480
  br i1 %133, label %134, label %func_exit
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 2067197113, i32* %canary
  %type.addr = alloca i32*, align 8
  %s.addr = alloca i8*, align 8
  store i8* %s, i8** %s.addr, align 8
  store i32* %type, i32** %type.addr, align 8
...
entry:
  ...
  %k = alloca i32, align 4
  %canary = alloca i32
  store i32 1537426198, i32* %canary
  %j = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %OffsetMatrixPresentFlag = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 147
  %1 = load i32, i32* %OffsetMatrixPresentFlag, align 8
...
if.end225:                                        ; preds = %for.end224, %for.end102
  %132 = load i32, i32* %canary
  %133 = icmp eq i32 %132, 1537426198
  br i1 %133, label %134, label %func_exit
...
entry:
  ...
  %s.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 313398781, i32* %canary
  %retval = alloca i32, align 4
  %i = alloca i32, align 4
  store i8* %s, i8** %s.addr, align 8
  store i32* %type, i32** %type.addr, align 8
...
entry:
  %s.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 484065406, i32* %canary
  %type.addr = alloca i32*, align 8
  %i = alloca i32, align 4
  %retval = alloca i32, align 4
  store i8* %s, i8** %s.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1706484180, i32* %canary
  %i = alloca i32, align 4
  %temp = alloca i32, align 4
  %q_bits = alloca i32, align 4
  %j = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @ParseQOffsetMatrix.19(i8* %buf, i32 %bufsize) #0 {
entry:
  %OffsetList = alloca i16*, align 8
  %cnt = alloca i32, align 4
  %type = alloca i32, align 4
  ...
  %IntContent = alloca i32, align 4
  %canary = alloca i32
  store i32 665581583, i32* %canary
  %bufsize.addr = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %bufsize, i32* %bufsize.addr, align 4
  store i32 0, i32* %item, align 4
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1782384379, i32* %canary
  %InString = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %IntContent = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1348249327, i32* %canary
  %k = alloca i32, align 4
  %i = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %OffsetMatrixPresentFlag = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 147
...
entry:
  ...
  %type = alloca i32, align 4
  %canary = alloca i32
  store i32 1091850231, i32* %canary
  %p = alloca i8*, align 8
  %item = alloca i32, align 4
  %items = alloca [1000 x i8*], align 16
  %buf.addr = alloca i8*, align 8
...
entry:
  ...
  %items = alloca [1000 x i8*], align 16
  %canary = alloca i32
  store i32 871192378, i32* %canary
  %IntContent = alloca i32, align 4
  %j = alloca i32, align 4
  %p = alloca i8*, align 8
  %InItem = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1925058597, i32* %canary
  %i = alloca i32, align 4
  %temp = alloca i32, align 4
  %k = alloca i32, align 4
  %qp_per = alloca i32, align 4
...
if.end225:                                        ; preds = %for.end224, %for.end102
  %132 = load i32, i32* %canary
  %133 = icmp eq i32 %132, 1925058597
  br i1 %133, label %134, label %func_exit
...
entry:
  %canary = alloca i32
  store i32 937040640, i32* %canary
  %type.addr = alloca i32*, align 8
  %s.addr = alloca i8*, align 8
  %i = alloca i32, align 4
  %retval = alloca i32, align 4
...
entry:
  %temp = alloca i32, align 4
  %canary = alloca i32
  store i32 2076760068, i32* %canary
  %k = alloca i32, align 4
  %qp_per = alloca i32, align 4
  %i = alloca i32, align 4
  %j = alloca i32, align 4
...
if.end225:                                        ; preds = %for.end224, %for.end102
  %132 = load i32, i32* %canary
  %133 = icmp eq i32 %132, 2076760068
  br i1 %133, label %134, label %func_exit
...
entry:
  ...
  %qp_per = alloca i32, align 4
  %canary = alloca i32
  store i32 931839323, i32* %canary
  %i = alloca i32, align 4
  %temp = alloca i32, align 4
  %k = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
entry:
  ...
  %k = alloca i32, align 4
  %canary = alloca i32
  store i32 1166504117, i32* %canary
  %i = alloca i32, align 4
  %qp_per = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %OffsetMatrixPresentFlag = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 147
...
if.end225:                                        ; preds = %for.end224, %for.end102
  %132 = load i32, i32* %canary
  %133 = icmp eq i32 %132, 1166504117
  br i1 %133, label %134, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @CalculateOffsetParam.29() #0 {
entry:
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 719238161, i32* %canary
  %k = alloca i32, align 4
  %temp = alloca i32, align 4
  %i = alloca i32, align 4
  %qp_per = alloca i32, align 4
...
entry:
  %qp_per = alloca i32, align 4
  %canary = alloca i32
  store i32 549862210, i32* %canary
  %i = alloca i32, align 4
  %temp = alloca i32, align 4
  %j = alloca i32, align 4
  %k = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 493665134, i32* %canary
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %temp = alloca i32, align 4
  %qp_per = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @CheckOffsetParameterName.32(i8* %s, i32* %type) #0 {
entry:
  %s.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1050491424, i32* %canary
  %retval = alloca i32, align 4
  %type.addr = alloca i32*, align 8
  %i = alloca i32, align 4
  store i8* %s, i8** %s.addr, align 8
...
entry:
  ...
  %p = alloca i8*, align 8
  %canary = alloca i32
  store i32 1410109832, i32* %canary
  %cnt = alloca i32, align 4
  %OffsetList = alloca i16*, align 8
  %bufend = alloca i8*, align 8
  %InString = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @ParseQOffsetMatrix.34(i8* %buf, i32 %bufsize) #0 {
entry:
  %canary = alloca i32
  store i32 737974548, i32* %canary
  %j = alloca i32, align 4
  %bufend = alloca i8*, align 8
  %items = alloca [1000 x i8*], align 16
  %InString = alloca i32, align 4
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 2078776589, i32* %canary
  %q_bits = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %OffsetMatrixPresentFlag = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 147
  %1 = load i32, i32* %OffsetMatrixPresentFlag, align 8
...
entry:
  %temp = alloca i32, align 4
  %canary = alloca i32
  store i32 2006990378, i32* %canary
  %qp_per = alloca i32, align 4
  %k = alloca i32, align 4
  %i = alloca i32, align 4
  %j = alloca i32, align 4
...
if.end225:                                        ; preds = %for.end224, %for.end102
  %132 = load i32, i32* %canary
  %133 = icmp eq i32 %132, 2006990378
  br i1 %133, label %134, label %func_exit
...
entry:
  ...
  %OffsetList = alloca i16*, align 8
  %canary = alloca i32
  store i32 1682481028, i32* %canary
  %InItem = alloca i32, align 4
  %MapIdx = alloca i32, align 4
  %i = alloca i32, align 4
  %bufend = alloca i8*, align 8
...
entry:
  ...
  %k = alloca i32, align 4
  %canary = alloca i32
  store i32 997296453, i32* %canary
  %j = alloca i32, align 4
  %i = alloca i32, align 4
  %temp = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @ParseQOffsetMatrix.40(i8* %buf, i32 %bufsize) #0 {
entry:
  %MapIdx = alloca i32, align 4
  %InString = alloca i32, align 4
  %j = alloca i32, align 4
  ...
  %type = alloca i32, align 4
  %canary = alloca i32
  store i32 1373423686, i32* %canary
  %buf.addr = alloca i8*, align 8
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %bufsize, i32* %bufsize.addr, align 4
  store i32 0, i32* %item, align 4
...
entry:
  ...
  %q_bits = alloca i32, align 4
  %canary = alloca i32
  store i32 446587761, i32* %canary
  %i = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %OffsetMatrixPresentFlag = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 147
  %1 = load i32, i32* %OffsetMatrixPresentFlag, align 8
...
entry:
  ...
  %bufend = alloca i8*, align 8
  %canary = alloca i32
  store i32 183422299, i32* %canary
  %i = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %bufsize.addr = alloca i32, align 4
  %IntContent = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @ParseQOffsetMatrix.44(i8* %buf, i32 %bufsize) #0 {
entry:
  %cnt = alloca i32, align 4
  %bufsize.addr = alloca i32, align 4
  %bufend = alloca i8*, align 8
  ...
  %InItem = alloca i32, align 4
  %canary = alloca i32
  store i32 955978654, i32* %canary
  %MapIdx = alloca i32, align 4
  %p = alloca i8*, align 8
  %buf.addr = alloca i8*, align 8
  %range = alloca i32, align 4
...
entry:
  ...
  %s.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1625162996, i32* %canary
  %type.addr = alloca i32*, align 8
  store i8* %s, i8** %s.addr, align 8
  store i32* %type, i32** %type.addr, align 8
  store i32 0, i32* %i, align 4
...
entry:
  %k = alloca i32, align 4
  %canary = alloca i32
  store i32 891502652, i32* %canary
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %q_bits = alloca i32, align 4
  %temp = alloca i32, align 4
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 139139374, i32* %canary
  %k = alloca i32, align 4
  %j = alloca i32, align 4
  %temp = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @CalculateOffset8Param.48() #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1140203995, i32* %canary
  %j = alloca i32, align 4
  %q_bits = alloca i32, align 4
  %k = alloca i32, align 4
  %temp = alloca i32, align 4
...
entry:
  ...
  %q_bits = alloca i32, align 4
  %canary = alloca i32
  store i32 403406407, i32* %canary
  %j = alloca i32, align 4
  %temp = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %OffsetMatrixPresentFlag = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 147
...
entry:
  %type.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 2027486838, i32* %canary
  %retval = alloca i32, align 4
  %s.addr = alloca i8*, align 8
  %i = alloca i32, align 4
  store i8* %s, i8** %s.addr, align 8
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 408413098, i32* %canary
  %type.addr = alloca i32*, align 8
  store i8* %s, i8** %s.addr, align 8
  store i32* %type, i32** %type.addr, align 8
  store i32 0, i32* %i, align 4
...
entry:
  ...
  %type = alloca i32, align 4
  %canary = alloca i32
  store i32 469618769, i32* %canary
  %OffsetList = alloca i16*, align 8
  %IntContent = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %bufsize, i32* %bufsize.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 1461729511, i32* %canary
  %i = alloca i32, align 4
  %s.addr = alloca i8*, align 8
  %retval = alloca i32, align 4
  %type.addr = alloca i32*, align 8
...
entry:
  ...
  %temp = alloca i32, align 4
  %canary = alloca i32
  store i32 659326709, i32* %canary
  %j = alloca i32, align 4
  %k = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %OffsetMatrixPresentFlag = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 147
...
entry:
  ...
  %q_bits = alloca i32, align 4
  %canary = alloca i32
  store i32 2011143997, i32* %canary
  %i = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %OffsetMatrixPresentFlag = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 147
  %1 = load i32, i32* %OffsetMatrixPresentFlag, align 8
...
entry:
  ...
  %range = alloca i32, align 4
  %canary = alloca i32
  store i32 1291650967, i32* %canary
  %type = alloca i32, align 4
  %item = alloca i32, align 4
  %p = alloca i8*, align 8
  %i = alloca i32, align 4
...
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1148393424, i32* %canary
  %type.addr = alloca i32*, align 8
  %retval = alloca i32, align 4
  %s.addr = alloca i8*, align 8
  store i8* %s, i8** %s.addr, align 8
...
entry:
  ...
  %item = alloca i32, align 4
  %canary = alloca i32
  store i32 1044411740, i32* %canary
  %i = alloca i32, align 4
  %cnt = alloca i32, align 4
  %InItem = alloca i32, align 4
  %type = alloca i32, align 4
...
entry:
  ...
  %item = alloca i32, align 4
  %canary = alloca i32
  store i32 1257272328, i32* %canary
  %type = alloca i32, align 4
  %bufsize.addr = alloca i32, align 4
  %items = alloca [1000 x i8*], align 16
  %OffsetList = alloca i16*, align 8
...
entry:
  ...
  %type.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 1990323918, i32* %canary
  %s.addr = alloca i8*, align 8
  store i8* %s, i8** %s.addr, align 8
  store i32* %type, i32** %type.addr, align 8
  store i32 0, i32* %i, align 4
...
entry:
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 717260506, i32* %canary
  %i = alloca i32, align 4
  %s.addr = alloca i8*, align 8
  %type.addr = alloca i32*, align 8
  store i8* %s, i8** %s.addr, align 8
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 523699373, i32* %canary
  %s.addr = alloca i8*, align 8
  store i8* %s, i8** %s.addr, align 8
  store i32* %type, i32** %type.addr, align 8
  store i32 0, i32* %i, align 4
...
entry:
  ...
  %type.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 248506672, i32* %canary
  %s.addr = alloca i8*, align 8
  %retval = alloca i32, align 4
  store i8* %s, i8** %s.addr, align 8
  store i32* %type, i32** %type.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1833411276, i32* %canary
  %s.addr = alloca i8*, align 8
  %type.addr = alloca i32*, align 8
  %retval = alloca i32, align 4
  %i = alloca i32, align 4
