...
# %bb.0:                                # %entry
	...
	subq	$72, %rsp
	.cfi_offset %rbx, -24
	movl	$156633803, -44(%rbp)   # imm = 0x9560ACB
	movq	%rdi, -24(%rbp)
	movq	%rsi, -32(%rbp)
	movl	%edx, -12(%rbp)
	movq	img, %rax
...
.LBB2_5:                                # %if.end
	...
	movl	%eax, %ebx
	cmpl	$156633803, -44(%rbp)   # imm = 0x9560ACB
	jne	.LBB2_7
.LBB2_6:
	movl	%ebx, %eax
	addq	$72, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$1215703315, -24(%rbp)  # imm = 0x48762913
	vmovsd	%xmm0, -40(%rbp)
	vmovsd	%xmm1, -32(%rbp)
	movl	%edi, -20(%rbp)
	movl	%esi, -16(%rbp)
...
.LBB3_5:                                # %return
	movl	-12(%rbp), %ebx
	cmpl	$1215703315, -24(%rbp)  # imm = 0x48762913
	jne	.LBB3_7
.LBB3_6:
	movl	%ebx, %eax
	addq	$56, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$1812683216, -24(%rbp)  # imm = 0x6C0B59D0
	vmovsd	%xmm0, -40(%rbp)
	vmovsd	%xmm1, -32(%rbp)
	movl	%edi, -20(%rbp)
	movl	%esi, -16(%rbp)
...
.LBB4_5:                                # %return
	movl	-12(%rbp), %ebx
	cmpl	$1812683216, -24(%rbp)  # imm = 0x6C0B59D0
	jne	.LBB4_7
.LBB4_6:
	movl	%ebx, %eax
	addq	$56, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$72, %rsp
	.cfi_offset %rbx, -24
	movl	$368515065, -44(%rbp)   # imm = 0x15F717F9
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movl	%edx, -12(%rbp)
	movq	img, %rax
...
.LBB5_5:                                # %if.end
	...
	callq	rd_pic_decision
	movl	%eax, %ebx
	cmpl	$368515065, -44(%rbp)   # imm = 0x15F717F9
	jne	.LBB5_7
.LBB5_6:
	movl	%ebx, %eax
	addq	$72, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$72, %rsp
	.cfi_offset %rbx, -24
	movl	$1360567528, -44(%rbp)  # imm = 0x51189CE8
	movq	%rdi, -24(%rbp)
	movq	%rsi, -32(%rbp)
	movl	%edx, -12(%rbp)
	movq	img, %rax
...
.LBB6_5:                                # %if.end
	...
	callq	rd_pic_decision
	movl	%eax, %ebx
	cmpl	$1360567528, -44(%rbp)  # imm = 0x51189CE8
	jne	.LBB6_7
.LBB6_6:
	movl	%ebx, %eax
	addq	$72, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$72, %rsp
	.cfi_offset %rbx, -24
	movl	$2083200191, -48(%rbp)  # imm = 0x7C2B1CBF
	movq	%rdi, -24(%rbp)
	movq	%rsi, -32(%rbp)
	movl	%edx, -12(%rbp)
	movq	img, %rax
...
.LBB7_5:                                # %if.end
	...
	callq	rd_pic_decision
	movl	%eax, %ebx
	cmpl	$2083200191, -48(%rbp)  # imm = 0x7C2B1CBF
	jne	.LBB7_7
.LBB7_6:
	movl	%ebx, %eax
	addq	$72, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$775926945, -20(%rbp)   # imm = 0x2E3FB4A1
	vmovsd	%xmm0, -56(%rbp)
	vmovsd	%xmm1, -32(%rbp)
	movl	%edi, -24(%rbp)
	movl	%esi, -16(%rbp)
...
.LBB8_5:                                # %return
	movl	-12(%rbp), %ebx
	cmpl	$775926945, -20(%rbp)   # imm = 0x2E3FB4A1
	jne	.LBB8_7
.LBB8_6:
	movl	%ebx, %eax
	addq	$56, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$1273836812, -20(%rbp)  # imm = 0x4BED350C
	vmovsd	%xmm0, -40(%rbp)
	vmovsd	%xmm1, -56(%rbp)
	movl	%edi, -16(%rbp)
	movl	%esi, -24(%rbp)
...
.LBB9_5:                                # %return
	movl	-12(%rbp), %ebx
	cmpl	$1273836812, -20(%rbp)  # imm = 0x4BED350C
	jne	.LBB9_7
.LBB9_6:
	movl	%ebx, %eax
	addq	$56, %rsp
