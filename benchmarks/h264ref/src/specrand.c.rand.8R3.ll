; ModuleID = 'specrand.c.rand.8R3.bc'
...
entry:
  %canary = alloca i32
  store i32 1474940667, i32* %canary
...
entry:
  ...
  %lo = alloca i32, align 4
  %canary = alloca i32
  store i32 304037171, i32* %canary
  %hi = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
  %conv = sext i32 %0 to i64
  %div = sdiv i64 %conv, 127773
...
entry:
  %canary = alloca i32
  store i32 1231435798, i32* %canary
  %lo = alloca i32, align 4
  %hi = alloca i32, align 4
  %test = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
...
entry:
  %hi = alloca i32, align 4
  %canary = alloca i32
  store i32 2007438127, i32* %canary
  %lo = alloca i32, align 4
  %test = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
  %conv = sext i32 %0 to i64
...
entry:
  %hi = alloca i32, align 4
  %canary = alloca i32
  store i32 1968789185, i32* %canary
  %test = alloca i32, align 4
  %lo = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
  %conv = sext i32 %0 to i64
...
entry:
  %canary = alloca i32
  store i32 1382485698, i32* %canary
  %test = alloca i32, align 4
  %hi = alloca i32, align 4
  %lo = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
