; ModuleID = 'specrand.c.rand.4R2.bc'
...
entry:
  ...
  %canary = alloca i32
  store i32 1463483483, i32* %canary
...
entry:
  %hi = alloca i32, align 4
  %canary = alloca i32
  store i32 1087011140, i32* %canary
  %test = alloca i32, align 4
  %lo = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
  %conv = sext i32 %0 to i64
...
entry:
  ...
  %test = alloca i32, align 4
  %canary = alloca i32
  store i32 1323192182, i32* %canary
  %hi = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
  %conv = sext i32 %0 to i64
  %div = sdiv i64 %conv, 127773
...
entry:
  %canary = alloca i32
  store i32 443002333, i32* %canary
  %test = alloca i32, align 4
  %lo = alloca i32, align 4
  %hi = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
