; ModuleID = 'specrand.c.rand.8P1.bc'
...
entry:
  %canary = alloca i32
  store i32 1042894695, i32* %canary
...
entry:
  ...
  %lo = alloca i32, align 4
  %canary = alloca i32
  store i32 1163866474, i32* %canary
  %test = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
  %conv = sext i32 %0 to i64
  %div = sdiv i64 %conv, 127773
...
entry:
  %canary = alloca i32
  store i32 585337991, i32* %canary
  %lo = alloca i32, align 4
  %hi = alloca i32, align 4
  %test = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
...
entry:
  %lo = alloca i32, align 4
  %canary = alloca i32
  store i32 112811366, i32* %canary
  %test = alloca i32, align 4
  %hi = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
  %conv = sext i32 %0 to i64
