...
# %bb.1:                                # %func_RandomIntraNewPicture.6
	...
	.cfi_def_cfa %rsp, 8
	retq
.LBB2_2:                                # %func_RandomIntraNewPicture.7
	.cfi_def_cfa %rbp, 16
	callq	RandomIntraNewPicture.7
	popq	%rbp
	.cfi_def_cfa %rsp, 8
	retq
.Lfunc_end2:
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$1645684392, -24(%rbp)  # imm = 0x621726A8
	movl	%edi, -20(%rbp)
	movl	$0, -12(%rbp)
.LBB4_1:                                # %for.cond
...
.LBB4_7:                                # %return
	movl	-16(%rbp), %ebx
	cmpl	$1645684392, -24(%rbp)  # imm = 0x621726A8
	jne	.LBB4_9
.LBB4_8:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$1010193678, -24(%rbp)  # imm = 0x3C36550E
	movl	%edi, -20(%rbp)
	movl	$0, -12(%rbp)
.LBB5_1:                                # %for.cond
                                        # =>This Inner Loop Header: Depth=1
...
.LBB5_7:                                # %return
	movl	-16(%rbp), %ebx
	cmpl	$1010193678, -24(%rbp)  # imm = 0x3C36550E
	jne	.LBB5_9
.LBB5_8:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$645195902, -24(%rbp)   # imm = 0x2674E87E
	movl	%edi, -20(%rbp)
	movl	$0, -12(%rbp)
.LBB6_1:                                # %for.cond
                                        # =>This Inner Loop Header: Depth=1
...
.LBB6_7:                                # %return
	movl	-16(%rbp), %ebx
	cmpl	$645195902, -24(%rbp)   # imm = 0x2674E87E
	jne	.LBB6_9
.LBB6_8:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$221671948, -24(%rbp)   # imm = 0xD36720C
	movl	%edi, -20(%rbp)
	movl	%esi, -16(%rbp)
	movl	%edx, -8(%rbp)
	movl	$1, %edi
...
# %bb.14:                               # %for.inc23
	...
	jmp	.LBB7_9
.LBB7_15:                               # %for.end25
	cmpl	$221671948, -24(%rbp)   # imm = 0xD36720C
	jne	.LBB7_17
.LBB7_16:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$1651360987, -24(%rbp)  # imm = 0x626DC4DB
	movl	%edi, -20(%rbp)
	movl	$0, -12(%rbp)
.LBB8_1:                                # %for.cond
                                        # =>This Inner Loop Header: Depth=1
...
.LBB8_7:                                # %return
	movl	-16(%rbp), %ebx
	cmpl	$1651360987, -24(%rbp)  # imm = 0x626DC4DB
	jne	.LBB8_9
.LBB8_8:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$16, %rsp
	movl	$1841537955, -12(%rbp)  # imm = 0x6DC3A3A3
...
# %bb.3:                                # %for.inc
	...
	jmp	.LBB9_1
.LBB9_4:                                # %for.end
	cmpl	$1841537955, -12(%rbp)  # imm = 0x6DC3A3A3
	jne	.LBB9_6
.LBB9_5:
	addq	$16, %rsp
	popq	%rbp
...
.Lfunc_end9:
	...
	.cfi_endproc
                                        # -- End function
	.globl	RandomIntraNewPicture.7 # -- Begin function RandomIntraNewPicture.7
	.p2align	4, 0x90
	.type	RandomIntraNewPicture.7,@function
RandomIntraNewPicture.7:                # @RandomIntraNewPicture.7
	.cfi_startproc
# %bb.0:                                # %entry
	pushq	%rbp
	.cfi_def_cfa_offset 16
	...
	.cfi_def_cfa_register %rbp
	subq	$16, %rsp
	movl	$617510643, -12(%rbp)   # imm = 0x24CE76F3
	movl	NumberIntraPerPicture, %eax
	addl	WalkAround, %eax
	movl	%eax, WalkAround
	movl	$0, -4(%rbp)
...
# %bb.3:                                # %for.inc
	...
	jmp	.LBB10_1
.LBB10_4:                               # %for.end
	cmpl	$617510643, -12(%rbp)   # imm = 0x24CE76F3
	jne	.LBB10_6
.LBB10_5:
	addq	$16, %rsp
	popq	%rbp
...
.LBB10_6:                               # %func_exit
	...
	jmp	.LBB10_5
.Lfunc_end10:
	.size	RandomIntraNewPicture.7, .Lfunc_end10-RandomIntraNewPicture.7
	.cfi_endproc
                                        # -- End function
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1886980873, -24(%rbp)  # imm = 0x70790B09
	movl	%edi, -16(%rbp)
	movl	%esi, -20(%rbp)
	movl	%edx, -12(%rbp)
	movl	$1, %edi
...
# %bb.14:                               # %for.inc23
	...
	jmp	.LBB11_9
.LBB11_15:                              # %for.end25
	cmpl	$1886980873, -24(%rbp)  # imm = 0x70790B09
	jne	.LBB11_17
.LBB11_16:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1315319464, -24(%rbp)  # imm = 0x4E662EA8
	movl	%edi, -20(%rbp)
	movl	%esi, -16(%rbp)
	movl	%edx, -8(%rbp)
	movl	$1, %edi
...
# %bb.14:                               # %for.inc23
	...
	jmp	.LBB12_9
.LBB12_15:                              # %for.end25
	cmpl	$1315319464, -24(%rbp)  # imm = 0x4E662EA8
	jne	.LBB12_17
.LBB12_16:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$448315146, -16(%rbp)   # imm = 0x1AB8BF0A
	movl	%edi, -20(%rbp)
	movl	%esi, -24(%rbp)
	movl	%edx, -12(%rbp)
	movl	$1, %edi
...
# %bb.14:                               # %for.inc23
	...
	jmp	.LBB13_9
.LBB13_15:                              # %for.end25
	cmpl	$448315146, -16(%rbp)   # imm = 0x1AB8BF0A
	jne	.LBB13_17
.LBB13_16:
	addq	$32, %rsp
	popq	%rbp
