; ModuleID = 'filehandle.c.rand.16D0.bc'
...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_error.10, label %func_error.11

func_error.10:                                    ; preds = %rand_bb
  call void @error.10(i8* %text, i32 %code)
  ret void

func_error.11:                                    ; preds = %rand_bb
  call void @error.11(i8* %text, i32 %code)
  ret void
}
...
func_write_PPS.6:                                 ; preds = %ctrl1
  %4 = call i32 @write_PPS.6(i32 %len, i32 %PPS_id)
  ret i32 %4

func_write_PPS.7:                                 ; preds = %ctrl2
  %5 = call i32 @write_PPS.7(i32 %len, i32 %PPS_id)
  ret i32 %5

func_write_PPS.8:                                 ; preds = %ctrl3
  %6 = call i32 @write_PPS.8(i32 %len, i32 %PPS_id)
  ret i32 %6

func_write_PPS.9:                                 ; preds = %ctrl3
  %7 = call i32 @write_PPS.9(i32 %len, i32 %PPS_id)
  ret i32 %7
...
ctrl1:                                            ; preds = %ctrl0
  %9 = icmp eq i32 %0, 2
  br i1 %9, label %func_write_PPS.6, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %10 = icmp eq i32 %0, 3
  br i1 %10, label %func_write_PPS.7, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %11 = icmp eq i32 %0, 4
  br i1 %11, label %func_write_PPS.8, label %func_write_PPS.9
}
...
func_start_sequence.4:                            ; preds = %ctrl1
  %4 = call i32 @start_sequence.4()
  ret i32 %4

func_start_sequence.12:                           ; preds = %ctrl2
  %5 = call i32 @start_sequence.12()
  ret i32 %5
...
ctrl1:                                            ; preds = %ctrl0
  %19 = icmp eq i32 %0, 2
  br i1 %19, label %func_start_sequence.4, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %20 = icmp eq i32 %0, 3
  br i1 %20, label %func_start_sequence.12, label %ctrl3
...
entry:
  %canary = alloca i32
  store i32 1883027895, i32* %canary
...
entry:
  %nalu = alloca %struct.NALU_t*, align 8
  %canary = alloca i32
  store i32 1770127353, i32* %canary
...
entry:
  %nalu = alloca %struct.NALU_t*, align 8
  %canary = alloca i32
  store i32 1523276696, i32* %canary
  %total_pps = alloca i32, align 4
  %i = alloca i32, align 4
  %len = alloca i32, align 4
  %retval = alloca i32, align 4
...
entry:
  ...
  %len.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1539066415, i32* %canary
  %nalu = alloca %struct.NALU_t*, align 8
  store i32 %len, i32* %len.addr, align 4
  store i32 %PPS_id, i32* %PPS_id.addr, align 4
  store %struct.NALU_t* null, %struct.NALU_t** %nalu, align 8
...
entry:
  ...
  %PPS_id.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1035551671, i32* %canary
  %len.addr = alloca i32, align 4
  store i32 %len, i32* %len.addr, align 4
  store i32 %PPS_id, i32* %PPS_id.addr, align 4
  store %struct.NALU_t* null, %struct.NALU_t** %nalu, align 8
...
entry:
  %canary = alloca i32
  store i32 284046519, i32* %canary
  %PPS_id.addr = alloca i32, align 4
  %nalu = alloca %struct.NALU_t*, align 8
  %len.addr = alloca i32, align 4
  store i32 %len, i32* %len.addr, align 4
...
entry:
  ...
  %nalu = alloca %struct.NALU_t*, align 8
  %canary = alloca i32
  store i32 1164353590, i32* %canary
  %PPS_id.addr = alloca i32, align 4
  store i32 %len, i32* %len.addr, align 4
  store i32 %PPS_id, i32* %PPS_id.addr, align 4
  store %struct.NALU_t* null, %struct.NALU_t** %nalu, align 8
...
entry:
  %canary = alloca i32
  store i32 1534776315, i32* %canary
  %len.addr = alloca i32, align 4
  %PPS_id.addr = alloca i32, align 4
  %nalu = alloca %struct.NALU_t*, align 8
  store i32 %len, i32* %len.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @error.10(i8* %text, i32 %code) #0 {
entry:
  %canary = alloca i32
  store i32 511401307, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @error.11(i8* %text, i32 %code) #0 {
entry:
  %text.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 2136325848, i32* %canary
  %code.addr = alloca i32, align 4
  store i8* %text, i8** %text.addr, align 8
  store i32 %code, i32* %code.addr, align 4
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 319830970, i32* %canary
  %total_pps = alloca i32, align 4
  store i32 0, i32* %len, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %GenerateMultiplePPS = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 15
...
entry:
  ...
  %nalu = alloca %struct.NALU_t*, align 8
  %canary = alloca i32
  store i32 1534362873, i32* %canary
  %i = alloca i32, align 4
  %retval = alloca i32, align 4
  store i32 0, i32* %len, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1177156169, i32* %canary
  %total_pps = alloca i32, align 4
  store i32 0, i32* %len, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %GenerateMultiplePPS = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 15
...
entry:
  ...
  %nalu = alloca %struct.NALU_t*, align 8
  %canary = alloca i32
  store i32 1345776245, i32* %canary
  %retval = alloca i32, align 4
  %i = alloca i32, align 4
  store i32 0, i32* %len, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
entry:
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1433742700, i32* %canary
  %len = alloca i32, align 4
  %i = alloca i32, align 4
  %nalu = alloca %struct.NALU_t*, align 8
  %total_pps = alloca i32, align 4
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1290937324, i32* %canary
  %nalu = alloca %struct.NALU_t*, align 8
  store i32 0, i32* %len, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %GenerateMultiplePPS = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 15
...
entry:
  %canary = alloca i32
  store i32 1159311907, i32* %canary
  %total_pps = alloca i32, align 4
  %len = alloca i32, align 4
  %i = alloca i32, align 4
  %nalu = alloca %struct.NALU_t*, align 8
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 335435083, i32* %canary
  %len = alloca i32, align 4
  store i32 0, i32* %len, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %GenerateMultiplePPS = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 15
...
entry:
  %total_pps = alloca i32, align 4
  %canary = alloca i32
  store i32 271319897, i32* %canary
  %i = alloca i32, align 4
  %len = alloca i32, align 4
  %retval = alloca i32, align 4
  %nalu = alloca %struct.NALU_t*, align 8
...
entry:
  %nalu = alloca %struct.NALU_t*, align 8
  %canary = alloca i32
  store i32 229620688, i32* %canary
  %retval = alloca i32, align 4
  %i = alloca i32, align 4
  %total_pps = alloca i32, align 4
  %len = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 365050311, i32* %canary
  %total_pps = alloca i32, align 4
  %retval = alloca i32, align 4
  %nalu = alloca %struct.NALU_t*, align 8
  %len = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1365532103, i32* %canary
  %nalu = alloca %struct.NALU_t*, align 8
  %total_pps = alloca i32, align 4
  %i = alloca i32, align 4
  %retval = alloca i32, align 4
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1528782582, i32* %canary
  %total_pps = alloca i32, align 4
  %len = alloca i32, align 4
  store i32 0, i32* %len, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
