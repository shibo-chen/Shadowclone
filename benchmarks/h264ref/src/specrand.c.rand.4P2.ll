; ModuleID = 'specrand.c.rand.4P2.bc'
...
entry:
  ...
  %canary = alloca i32
  store i32 986566599, i32* %canary
...
entry:
  %hi = alloca i32, align 4
  %canary = alloca i32
  store i32 775653791, i32* %canary
  %test = alloca i32, align 4
  %lo = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
  %conv = sext i32 %0 to i64
...
entry:
  ...
  %lo = alloca i32, align 4
  %canary = alloca i32
  store i32 1087952054, i32* %canary
  %test = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
  %conv = sext i32 %0 to i64
  %div = sdiv i64 %conv, 127773
