; ModuleID = 'mb_access.c.rand.4P3.bc'
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_mb_is_available.9, label %ctrl0

func_mb_is_available.9:                           ; preds = %rand_bb
  %2 = call i32 @mb_is_available.9(i32 %mbAddr, i32 %currMbAddr)
  ret i32 %2
...
func_mb_is_available.30:                          ; preds = %ctrl1
  %5 = call i32 @mb_is_available.30(i32 %mbAddr, i32 %currMbAddr)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_mb_is_available.25, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_mb_is_available.29, label %func_mb_is_available.30
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_CheckAvailabilityOfNeighbors.4, label %func_CheckAvailabilityOfNeighbors.7

func_CheckAvailabilityOfNeighbors.4:              ; preds = %rand_bb
  call void @CheckAvailabilityOfNeighbors.4()
  ret void

func_CheckAvailabilityOfNeighbors.7:              ; preds = %rand_bb
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_get_mb_block_pos.3, label %ctrl0

func_get_mb_block_pos.3:                          ; preds = %rand_bb
  call void @get_mb_block_pos.3(i32 %mb_addr, i32* %x, i32* %y)
  ret void

func_get_mb_block_pos.12:                         ; preds = %ctrl0
  call void @get_mb_block_pos.12(i32 %mb_addr, i32* %x, i32* %y)
  ret void

func_get_mb_block_pos.14:                         ; preds = %ctrl1
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_get_mb_block_pos.12, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_get_mb_block_pos.14, label %func_get_mb_block_pos.21
}
...
func_get_mb_pos.15:                               ; preds = %ctrl0
  call void @get_mb_pos.15(i32 %mb_addr, i32* %x, i32* %y)
  ret void

func_get_mb_pos.20:                               ; preds = %ctrl1
  call void @get_mb_pos.20(i32 %mb_addr, i32* %x, i32* %y)
  ret void

func_get_mb_pos.27:                               ; preds = %ctrl1
  call void @get_mb_pos.27(i32 %mb_addr, i32* %x, i32* %y)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_get_mb_pos.15, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_get_mb_pos.20, label %func_get_mb_pos.27
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_getNonAffNeighbour.17, label %ctrl0

func_getNonAffNeighbour.17:                       ; preds = %rand_bb
  call void @getNonAffNeighbour.17(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

func_getNonAffNeighbour.18:                       ; preds = %ctrl0
  call void @getNonAffNeighbour.18(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

func_getNonAffNeighbour.23:                       ; preds = %ctrl1
  call void @getNonAffNeighbour.23(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

func_getNonAffNeighbour.32:                       ; preds = %ctrl1
  call void @getNonAffNeighbour.32(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_getNonAffNeighbour.18, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_getNonAffNeighbour.23, label %func_getNonAffNeighbour.32
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_getAffNeighbour.5, label %ctrl0

func_getAffNeighbour.5:                           ; preds = %rand_bb
  call void @getAffNeighbour.5(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

func_getAffNeighbour.11:                          ; preds = %ctrl0
  call void @getAffNeighbour.11(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

func_getAffNeighbour.16:                          ; preds = %ctrl1
  call void @getAffNeighbour.16(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

func_getAffNeighbour.26:                          ; preds = %ctrl1
  call void @getAffNeighbour.26(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_getAffNeighbour.11, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_getAffNeighbour.16, label %func_getAffNeighbour.26
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_getNeighbour.2, label %ctrl0

func_getNeighbour.2:                              ; preds = %rand_bb
  call void @getNeighbour.2(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

func_getNeighbour.13:                             ; preds = %ctrl0
  call void @getNeighbour.13(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_getNeighbour.13, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_getNeighbour.24, label %func_getNeighbour.28
}
...
func_getLuma4x4Neighbour.6:                       ; preds = %ctrl0
  call void @getLuma4x4Neighbour.6(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix)
  ret void

func_getLuma4x4Neighbour.10:                      ; preds = %ctrl1
  call void @getLuma4x4Neighbour.10(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix)
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_getLuma4x4Neighbour.6, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_getLuma4x4Neighbour.10, label %func_getLuma4x4Neighbour.19
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_getChroma4x4Neighbour.22, label %ctrl0

func_getChroma4x4Neighbour.22:                    ; preds = %rand_bb
  call void @getChroma4x4Neighbour.22(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix)
  ret void

func_getChroma4x4Neighbour.31:                    ; preds = %ctrl0
...
func_getChroma4x4Neighbour.34:                    ; preds = %ctrl1
  call void @getChroma4x4Neighbour.34(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_getChroma4x4Neighbour.31, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_getChroma4x4Neighbour.33, label %func_getChroma4x4Neighbour.34
}
...
entry:
  ...
  %canary = alloca i32
  store i32 1988399006, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getNeighbour.2(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix) #0 {
entry:
  %luma.addr = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
  %canary = alloca i32
  store i32 2035325185, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @get_mb_block_pos.3(i32 %mb_addr, i32* %x, i32* %y) #0 {
entry:
  %y.addr = alloca i32*, align 8
  %mb_addr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1609571089, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @CheckAvailabilityOfNeighbors.4() #0 {
entry:
  %canary = alloca i32
  store i32 359329794, i32* %canary
...
entry:
  ...
  %luma.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1338849152, i32* %canary
...
if.end376:                                        ; preds = %if.end375, %lor.lhs.false, %if.then8, %if.then1
  ...
  %310 = icmp eq i32 %309, 1338849152
...
entry:
  ...
  %rel_y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 173628458, i32* %canary
  %pix.addr = alloca %struct.pix_pos*, align 8
  %rel_x.addr = alloca i32, align 4
  %curr_mb_nr.addr = alloca i32, align 4
  %x = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @CheckAvailabilityOfNeighbors.7() #0 {
entry:
  %canary = alloca i32
  store i32 135140535, i32* %canary
  %mb_nr = alloca i32, align 4
  %currMB = alloca %struct.macroblock*, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %current_mb_nr = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 3
...
entry:
  ...
  %mb_addr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1046569577, i32* %canary
  %y.addr = alloca i32*, align 8
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
  store i32* %x, i32** %x.addr, align 8
  store i32* %y, i32** %y.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @mb_is_available.9(i32 %mbAddr, i32 %currMbAddr) #0 {
entry:
  %canary = alloca i32
  store i32 734367227, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getLuma4x4Neighbour.10(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix) #0 {
entry:
  %x = alloca i32, align 4
  %rel_x.addr = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
  ...
  %block_x.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1311347114, i32* %canary
  %curr_mb_nr.addr = alloca i32, align 4
  %rel_y.addr = alloca i32, align 4
  %block_y.addr = alloca i32, align 4
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 2018795102, i32* %canary
  %curr_mb_nr.addr = alloca i32, align 4
  %maxW = alloca i32, align 4
  %yN.addr = alloca i32, align 4
  %yM = alloca i32, align 4
...
if.end376:                                        ; preds = %if.end375, %lor.lhs.false, %if.then8, %if.then1
  %309 = load i32, i32* %canary
  %310 = icmp eq i32 %309, 2018795102
  br i1 %310, label %311, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @get_mb_block_pos.12(i32 %mb_addr, i32* %x, i32* %y) #0 {
entry:
  %x.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 1330448520, i32* %canary
  %y.addr = alloca i32*, align 8
  %mb_addr.addr = alloca i32, align 4
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
  store i32* %x, i32** %x.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getNeighbour.13(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix) #0 {
entry:
  %xN.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2146368542, i32* %canary
  %yN.addr = alloca i32, align 4
  %luma.addr = alloca i32, align 4
  %curr_mb_nr.addr = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
...
entry:
  %canary = alloca i32
  store i32 2056743709, i32* %canary
  %mb_addr.addr = alloca i32, align 4
  %x.addr = alloca i32*, align 8
  %y.addr = alloca i32*, align 8
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
...
entry:
  ...
  %x.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 1927413794, i32* %canary
  %y.addr = alloca i32*, align 8
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
  store i32* %x, i32** %x.addr, align 8
  store i32* %y, i32** %y.addr, align 8
...
entry:
  ...
  %xN.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1755268864, i32* %canary
  %maxW = alloca i32, align 4
  %yM = alloca i32, align 4
  %yN.addr = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
...
if.end376:                                        ; preds = %if.end375, %lor.lhs.false, %if.then8, %if.then1
  %309 = load i32, i32* %canary
  %310 = icmp eq i32 %309, 1755268864
  br i1 %310, label %311, label %func_exit
...
entry:
  ...
  %curr_mb_nr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2001716550, i32* %canary
  %yN.addr = alloca i32, align 4
  %maxH = alloca i32, align 4
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
  store i32 %xN, i32* %xN.addr, align 4
...
entry:
  ...
  %maxW = alloca i32, align 4
  %canary = alloca i32
  store i32 1054559031, i32* %canary
  %pix.addr = alloca %struct.pix_pos*, align 8
  %curr_mb_nr.addr = alloca i32, align 4
  %yN.addr = alloca i32, align 4
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
...
entry:
  ...
  %pix.addr = alloca %struct.pix_pos*, align 8
  %canary = alloca i32
  store i32 727077191, i32* %canary
  %curr_mb_nr.addr = alloca i32, align 4
  %block_x.addr = alloca i32, align 4
  %rel_x.addr = alloca i32, align 4
  %x = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @get_mb_pos.20(i32 %mb_addr, i32* %x, i32* %y) #0 {
entry:
  %y.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 1660089090, i32* %canary
  %x.addr = alloca i32*, align 8
  %mb_addr.addr = alloca i32, align 4
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
  store i32* %x, i32** %x.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getNonAffNeighbour.23(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix) #0 {
entry:
  %currMb = alloca %struct.macroblock*, align 8
  %pix.addr = alloca %struct.pix_pos*, align 8
  %xN.addr = alloca i32, align 4
  ...
  %maxH = alloca i32, align 4
  %canary = alloca i32
  store i32 1840006784, i32* %canary
  %maxW = alloca i32, align 4
  %luma.addr = alloca i32, align 4
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
  store i32 %xN, i32* %xN.addr, align 4
...
entry:
  %curr_mb_nr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 544637655, i32* %canary
  %pix.addr = alloca %struct.pix_pos*, align 8
  %xN.addr = alloca i32, align 4
  %luma.addr = alloca i32, align 4
  %yN.addr = alloca i32, align 4
...
entry:
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1560032782, i32* %canary
  %mbAddr.addr = alloca i32, align 4
  %currMbAddr.addr = alloca i32, align 4
  store i32 %mbAddr, i32* %mbAddr.addr, align 4
  store i32 %currMbAddr, i32* %currMbAddr.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getAffNeighbour.26(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix) #0 {
entry:
  %pix.addr = alloca %struct.pix_pos*, align 8
  %maxW = alloca i32, align 4
  %maxH = alloca i32, align 4
  ...
  %xN.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 941040577, i32* %canary
  %curr_mb_nr.addr = alloca i32, align 4
  %luma.addr = alloca i32, align 4
  %yN.addr = alloca i32, align 4
  %yM = alloca i32, align 4
...
entry:
  %y.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 1879385379, i32* %canary
  %mb_addr.addr = alloca i32, align 4
  %x.addr = alloca i32*, align 8
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
  store i32* %x, i32** %x.addr, align 8
...
entry:
  %pix.addr = alloca %struct.pix_pos*, align 8
  %canary = alloca i32
  store i32 1052825336, i32* %canary
  %xN.addr = alloca i32, align 4
  %yN.addr = alloca i32, align 4
  %curr_mb_nr.addr = alloca i32, align 4
  %luma.addr = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1711581356, i32* %canary
  %mbAddr.addr = alloca i32, align 4
  %currMbAddr.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  store i32 %mbAddr, i32* %mbAddr.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @mb_is_available.30(i32 %mbAddr, i32 %currMbAddr) #0 {
entry:
  %retval = alloca i32, align 4
  %currMbAddr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1682066757, i32* %canary
  %mbAddr.addr = alloca i32, align 4
  store i32 %mbAddr, i32* %mbAddr.addr, align 4
  store i32 %currMbAddr, i32* %currMbAddr.addr, align 4
  %0 = load i32, i32* %mbAddr.addr, align 4
...
entry:
  ...
  %curr_mb_nr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 934626520, i32* %canary
  %rel_y.addr = alloca i32, align 4
  %block_y.addr = alloca i32, align 4
  %x = alloca i32, align 4
  %rel_x.addr = alloca i32, align 4
...
entry:
  ...
  %xN.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1468507108, i32* %canary
  %luma.addr = alloca i32, align 4
  %curr_mb_nr.addr = alloca i32, align 4
  %currMb = alloca %struct.macroblock*, align 8
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
...
entry:
  ...
  %pix.addr = alloca %struct.pix_pos*, align 8
  %canary = alloca i32
  store i32 333076962, i32* %canary
  %rel_y.addr = alloca i32, align 4
  %block_x.addr = alloca i32, align 4
  %rel_x.addr = alloca i32, align 4
  %block_y.addr = alloca i32, align 4
...
entry:
  ...
  %pix.addr = alloca %struct.pix_pos*, align 8
  %canary = alloca i32
  store i32 1462043938, i32* %canary
  %rel_x.addr = alloca i32, align 4
  %y = alloca i32, align 4
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
  store i32 %block_x, i32* %block_x.addr, align 4
