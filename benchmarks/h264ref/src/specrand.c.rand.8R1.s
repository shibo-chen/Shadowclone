...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$228624052, -16(%rbp)   # imm = 0xDA086B4
	movslq	seedi, %rax
	cqto
...
.LBB2_3:                                # %if.end
	...
	cmpl	$228624052, -16(%rbp)   # imm = 0xDA086B4
	jne	.LBB2_5
.LBB2_4:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$594872010, -12(%rbp)   # imm = 0x237506CA
	movslq	seedi, %rax
	cqto
	movl	$127773, %ecx           # imm = 0x1F31D
	idivq	%rcx
...
.LBB3_3:                                # %if.end
	...
	vcvtsi2sdl	seedi, %xmm0, %xmm1
	vdivsd	%xmm0, %xmm1, %xmm0
	cmpl	$594872010, -12(%rbp)   # imm = 0x237506CA
	jne	.LBB3_5
.LBB3_4:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$860937408, -12(%rbp)   # imm = 0x3350DCC0
	movslq	seedi, %rax
	cqto
	movl	$127773, %ecx           # imm = 0x1F31D
	idivq	%rcx
...
.LBB4_3:                                # %if.end
	...
	vcvtsi2sdl	seedi, %xmm0, %xmm1
	vdivsd	%xmm0, %xmm1, %xmm0
	cmpl	$860937408, -12(%rbp)   # imm = 0x3350DCC0
	jne	.LBB4_5
.LBB4_4:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$64300746, -12(%rbp)    # imm = 0x3D526CA
	movslq	seedi, %rax
	cqto
	movl	$127773, %ecx           # imm = 0x1F31D
	idivq	%rcx
...
.LBB5_3:                                # %if.end
	...
	vcvtsi2sdl	seedi, %xmm0, %xmm1
	vdivsd	%xmm0, %xmm1, %xmm0
	cmpl	$64300746, -12(%rbp)    # imm = 0x3D526CA
	jne	.LBB5_5
.LBB5_4:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$643020533, -16(%rbp)   # imm = 0x2653B6F5
	movslq	seedi, %rax
	cqto
	movl	$127773, %ecx           # imm = 0x1F31D
	idivq	%rcx
...
.LBB6_3:                                # %if.end
	...
	vcvtsi2sdl	seedi, %xmm0, %xmm1
	vdivsd	%xmm0, %xmm1, %xmm0
	cmpl	$643020533, -16(%rbp)   # imm = 0x2653B6F5
	jne	.LBB6_5
.LBB6_4:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1219642326, -12(%rbp)  # imm = 0x48B243D6
	movslq	seedi, %rax
	cqto
	movl	$127773, %ecx           # imm = 0x1F31D
	idivq	%rcx
...
.LBB7_3:                                # %if.end
	...
	vcvtsi2sdl	seedi, %xmm0, %xmm1
	vdivsd	%xmm0, %xmm1, %xmm0
	cmpl	$1219642326, -12(%rbp)  # imm = 0x48B243D6
	jne	.LBB7_5
.LBB7_4:
	addq	$32, %rsp
	popq	%rbp
