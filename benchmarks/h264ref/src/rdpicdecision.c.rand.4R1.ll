; ModuleID = 'rdpicdecision.c.rand.4R1.bc'
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_rd_pic_decision.2, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_rd_pic_decision.3, label %func_rd_pic_decision.4
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_picture_coding_decision.5, label %ctrl0

func_picture_coding_decision.5:                   ; preds = %rand_bb
  %2 = call i32 @picture_coding_decision.5(%struct.Picture* %picture1, %struct.Picture* %picture2, i32 %qp)
  ret i32 %2

func_picture_coding_decision.6:                   ; preds = %ctrl0
  %3 = call i32 @picture_coding_decision.6(%struct.Picture* %picture1, %struct.Picture* %picture2, i32 %qp)
  ret i32 %3
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_picture_coding_decision.6, label %ctrl1
...
entry:
  ...
  %canary = alloca i32
  store i32 1968488856, i32* %canary
...
entry:
  ...
  %cost_version1 = alloca double, align 8
  %canary = alloca i32
  store i32 1411992467, i32* %canary
  %snrY_version2.addr = alloca double, align 8
  %bits_version2.addr = alloca i32, align 4
  %bits_version1.addr = alloca i32, align 4
  store double %snrY_version1, double* %snrY_version1.addr, align 8
...
entry:
  ...
  %cost_version1 = alloca double, align 8
  %canary = alloca i32
  store i32 1203126870, i32* %canary
  %lambda_picture.addr = alloca double, align 8
  %cost_version2 = alloca double, align 8
  %snrY_version2.addr = alloca double, align 8
  store double %snrY_version1, double* %snrY_version1.addr, align 8
...
entry:
  ...
  %bits_version1.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 971269240, i32* %canary
  %snrY_version2.addr = alloca double, align 8
  %cost_version1 = alloca double, align 8
  store double %snrY_version1, double* %snrY_version1.addr, align 8
  store double %snrY_version2, double* %snrY_version2.addr, align 8
...
entry:
  ...
  %canary = alloca i32
  store i32 1156225532, i32* %canary
...
entry:
  ...
  %picture1.addr = alloca %struct.Picture*, align 8
  %canary = alloca i32
  store i32 1507754136, i32* %canary
  %bit_picture2 = alloca i32, align 4
  %picture2.addr = alloca %struct.Picture*, align 8
  %lambda_picture = alloca double, align 8
  %qp.addr = alloca i32, align 4
...
entry:
  ...
  %spframe = alloca i32, align 4
  %canary = alloca i32
  store i32 1122091881, i32* %canary
  %bit_picture2 = alloca i32, align 4
  %lambda_picture = alloca double, align 8
  %qp.addr = alloca i32, align 4
  %bframe = alloca i32, align 4
...
entry:
  ...
  %snr_picture2 = alloca double, align 8
  %canary = alloca i32
  store i32 1017629391, i32* %canary
  %picture1.addr = alloca %struct.Picture*, align 8
  %bit_picture2 = alloca i32, align 4
  %lambda_picture = alloca double, align 8
  %qp.addr = alloca i32, align 4
