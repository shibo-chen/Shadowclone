; ModuleID = 'rdpicdecision.c.rand.4P2.bc'
...
ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_rd_pic_decision.4, label %func_rd_pic_decision.6
}
...
func_picture_coding_decision.7:                   ; preds = %ctrl1
  %4 = call i32 @picture_coding_decision.7(%struct.Picture* %picture1, %struct.Picture* %picture2, i32 %qp)
  ret i32 %4
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_picture_coding_decision.5, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_picture_coding_decision.7, label %func_picture_coding_decision.8
}
...
entry:
  ...
  %canary = alloca i32
  store i32 115313058, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1979066875, i32* %canary
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 2041579540, i32* %canary
  %snrY_version1.addr = alloca double, align 8
  %lambda_picture.addr = alloca double, align 8
  %bits_version1.addr = alloca i32, align 4
  store double %snrY_version1, double* %snrY_version1.addr, align 8
...
entry:
  ...
  %cost_version1 = alloca double, align 8
  %canary = alloca i32
  store i32 1035134845, i32* %canary
  %bits_version2.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  %cost_version2 = alloca double, align 8
  store double %snrY_version1, double* %snrY_version1.addr, align 8
...
entry:
  ...
  %bits_version2.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 361676934, i32* %canary
  %bits_version1.addr = alloca i32, align 4
  %cost_version1 = alloca double, align 8
  store double %snrY_version1, double* %snrY_version1.addr, align 8
  store double %snrY_version2, double* %snrY_version2.addr, align 8
