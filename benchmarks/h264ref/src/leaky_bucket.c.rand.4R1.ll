; ModuleID = 'leaky_bucket.c.rand.4R1.bc'
...
func_get_LeakyBucketRate.2:                       ; preds = %ctrl0
  %3 = call i32 @get_LeakyBucketRate.2(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret i32 %3

func_get_LeakyBucketRate.4:                       ; preds = %ctrl1
  %4 = call i32 @get_LeakyBucketRate.4(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret i32 %4

func_get_LeakyBucketRate.11:                      ; preds = %ctrl1
  %5 = call i32 @get_LeakyBucketRate.11(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_get_LeakyBucketRate.2, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_get_LeakyBucketRate.4, label %func_get_LeakyBucketRate.11
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_PutBigDoubleWord.16, label %func_PutBigDoubleWord.17

func_PutBigDoubleWord.16:                         ; preds = %rand_bb
  call void @PutBigDoubleWord.16(i64 %dw, %struct._IO_FILE* %fp)
  ret void

func_PutBigDoubleWord.17:                         ; preds = %rand_bb
  call void @PutBigDoubleWord.17(i64 %dw, %struct._IO_FILE* %fp)
  ret void
}
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_write_buffer.12, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_write_buffer.15, label %func_write_buffer.18
}
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_Sort.9, label %func_Sort.13
}
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_calc_buffer.10, label %func_calc_buffer.14
}
...
entry:
  ...
  %canary = alloca i32
  store i32 274271725, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_LeakyBucketRate.2(i64 %NumberLeakyBuckets, i64* %Rmin) #0 {
entry:
  %f = alloca %struct._IO_FILE*, align 8
  %i = alloca i64, align 8
  %retval = alloca i32, align 4
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1789690512, i32* %canary
  %buf = alloca i64, align 8
  %Rmin.addr = alloca i64*, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
...
entry:
  ...
  %canary = alloca i32
  store i32 1734489750, i32* %canary
...
for.end136:                                       ; preds = %for.cond57
  ...
  %150 = icmp eq i32 %149, 1734489750
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_LeakyBucketRate.4(i64 %NumberLeakyBuckets, i64* %Rmin) #0 {
entry:
  %i = alloca i64, align 8
  %canary = alloca i32
  store i32 1851911379, i32* %canary
  %Rmin.addr = alloca i64*, align 8
  %retval = alloca i32, align 4
  %buf = alloca i64, align 8
  %f = alloca %struct._IO_FILE*, align 8
...
entry:
  %canary = alloca i32
  store i32 1056935475, i32* %canary
  %Bmin = alloca i64*, align 8
  %FrameIndex = alloca i64, align 8
  %iBucket = alloca i64, align 8
  %iFrame = alloca i64, align 8
...
for.end136:                                       ; preds = %for.cond57
  ...
  call void @free(i8* %148) #3
  %149 = load i32, i32* %canary
  %150 = icmp eq i32 %149, 1056935475
  br i1 %150, label %151, label %func_exit
...
entry:
  ...
  %canary = alloca i32
  store i32 1749111642, i32* %canary
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %Rmin.addr = alloca i64*, align 8
...
entry:
  ...
  %i = alloca i64, align 8
  %canary = alloca i32
  store i32 2050770817, i32* %canary
  %j = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
  store i64 0, i64* %i, align 8
...
entry:
  %j = alloca i64, align 8
  %canary = alloca i32
  store i32 840699243, i32* %canary
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %Rmin.addr = alloca i64*, align 8
  %temp = alloca i64, align 8
  %i = alloca i64, align 8
...
entry:
  ...
  %iChannelRate = alloca i64, align 8
  %canary = alloca i32
  store i32 2105793585, i32* %canary
  %iFrame = alloca i64, align 8
  store i64 0, i64* %FrameIndex, align 8
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8
  %call = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %0, i8* getelementptr inbounds ([81 x i8], [81 x i8]* @.str.8, i64 0, i64 0))
...
for.end136:                                       ; preds = %for.cond57
  ...
  call void @free(i8* %148) #3
  %149 = load i32, i32* %canary
  %150 = icmp eq i32 %149, 2105793585
  br i1 %150, label %151, label %func_exit
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1274015243, i32* %canary
  %buf = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
entry:
  ...
  %Bmin.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 584286851, i32* %canary
  %iBucket = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
  store i64* %Bmin, i64** %Bmin.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 502528185, i32* %canary
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %j = alloca i64, align 8
  %temp = alloca i64, align 8
  %i = alloca i64, align 8
...
entry:
  ...
  %iFrame = alloca i64, align 8
  %canary = alloca i32
  store i32 538233073, i32* %canary
  %FrameIndex = alloca i64, align 8
  %Fmin = alloca i64*, align 8
  %iChannelRate = alloca i64, align 8
  %Bmin = alloca i64*, align 8
...
entry:
  ...
  %Rmin.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 1390541198, i32* %canary
  %NumberLeakyBuckets.addr = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
  store i64* %Bmin, i64** %Bmin.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @PutBigDoubleWord.16(i64 %dw, %struct._IO_FILE* %fp) #0 {
entry:
  %canary = alloca i32
  store i32 800472374, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @PutBigDoubleWord.17(i64 %dw, %struct._IO_FILE* %fp) #0 {
entry:
  %dw.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 661301975, i32* %canary
  %fp.addr = alloca %struct._IO_FILE*, align 8
  store i64 %dw, i64* %dw.addr, align 8
  store %struct._IO_FILE* %fp, %struct._IO_FILE** %fp.addr, align 8
  %0 = load i64, i64* %dw.addr, align 8
...
entry:
  %iBucket = alloca i64, align 8
  %canary = alloca i32
  store i32 1942090044, i32* %canary
  %outf = alloca %struct._IO_FILE*, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %Bmin.addr = alloca i64*, align 8
  %Rmin.addr = alloca i64*, align 8
