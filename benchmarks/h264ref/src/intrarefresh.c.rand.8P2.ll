; ModuleID = 'intrarefresh.c.rand.8P2.bc'
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_RandomIntraInit.2, label %ctrl0

func_RandomIntraInit.2:                           ; preds = %rand_bb
  call void @RandomIntraInit.2(i32 %xsize, i32 %ysize, i32 %refresh)
  ret void

func_RandomIntraInit.3:                           ; preds = %ctrl0
  call void @RandomIntraInit.3(i32 %xsize, i32 %ysize, i32 %refresh)
  ret void
...
func_RandomIntraInit.11:                          ; preds = %ctrl3
...
func_RandomIntraInit.16:                          ; preds = %ctrl5
  call void @RandomIntraInit.16(i32 %xsize, i32 %ysize, i32 %refresh)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_RandomIntraInit.3, label %ctrl1
...
ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_RandomIntraInit.11, label %ctrl4
...
ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_RandomIntraInit.15, label %func_RandomIntraInit.16
}
...
func_RandomIntra.9:                               ; preds = %ctrl2
  %5 = call i32 @RandomIntra.9(i32 %mb)
  ret i32 %5

func_RandomIntra.12:                              ; preds = %ctrl3
  %6 = call i32 @RandomIntra.12(i32 %mb)
  ret i32 %6
...
ctrl2:                                            ; preds = %ctrl1
  %10 = icmp eq i32 %0, 3
  br i1 %10, label %func_RandomIntra.9, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %11 = icmp eq i32 %0, 4
  br i1 %11, label %func_RandomIntra.12, label %func_RandomIntra.14
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_RandomIntraNewPicture.5, label %func_RandomIntraNewPicture.6
...
entry:
  %canary = alloca i32
  store i32 1702613847, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1845599718, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @RandomIntraInit.3(i32 %xsize, i32 %ysize, i32 %refresh) #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1692251134, i32* %canary
  %xsize.addr = alloca i32, align 4
  %ysize.addr = alloca i32, align 4
  %pos = alloca i32, align 4
  %refresh.addr = alloca i32, align 4
...
entry:
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1486073243, i32* %canary
  %i = alloca i32, align 4
  %mb.addr = alloca i32, align 4
  store i32 %mb, i32* %mb.addr, align 4
  store i32 0, i32* %i, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 1358226033, i32* %canary
  %i = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1995506504, i32* %canary
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %0 = load i32, i32* @NumberIntraPerPicture, align 4
  %1 = load i32, i32* @WalkAround, align 4
...
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1742033838, i32* %canary
  %mb.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  store i32 %mb, i32* %mb.addr, align 4
  store i32 0, i32* %i, align 4
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1790077888, i32* %canary
  %refresh.addr = alloca i32, align 4
  store i32 %xsize, i32* %xsize.addr, align 4
  store i32 %ysize, i32* %ysize.addr, align 4
  store i32 %refresh, i32* %refresh.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 585902592, i32* %canary
  %i = alloca i32, align 4
  %retval = alloca i32, align 4
  %mb.addr = alloca i32, align 4
  store i32 %mb, i32* %mb.addr, align 4
...
entry:
  ...
  %pos = alloca i32, align 4
  %canary = alloca i32
  store i32 534061749, i32* %canary
  %ysize.addr = alloca i32, align 4
  %i = alloca i32, align 4
  store i32 %xsize, i32* %xsize.addr, align 4
  store i32 %ysize, i32* %ysize.addr, align 4
...
entry:
  ...
  %ysize.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1000847601, i32* %canary
  %refresh.addr = alloca i32, align 4
  %pos = alloca i32, align 4
  %i = alloca i32, align 4
  store i32 %xsize, i32* %xsize.addr, align 4
...
entry:
  ...
  %mb.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 150680007, i32* %canary
  %i = alloca i32, align 4
  store i32 %mb, i32* %mb.addr, align 4
  store i32 0, i32* %i, align 4
  br label %for.cond
...
entry:
  %mb.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1606406811, i32* %canary
  %i = alloca i32, align 4
  %retval = alloca i32, align 4
  store i32 %mb, i32* %mb.addr, align 4
  store i32 0, i32* %i, align 4
...
entry:
  %canary = alloca i32
  store i32 1652764189, i32* %canary
  %ysize.addr = alloca i32, align 4
  %xsize.addr = alloca i32, align 4
  %pos = alloca i32, align 4
  %refresh.addr = alloca i32, align 4
...
entry:
  ...
  %xsize.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1155742644, i32* %canary
  %pos = alloca i32, align 4
  %refresh.addr = alloca i32, align 4
  %ysize.addr = alloca i32, align 4
  store i32 %xsize, i32* %xsize.addr, align 4
