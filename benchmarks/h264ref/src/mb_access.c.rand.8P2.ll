; ModuleID = 'mb_access.c.rand.8P2.bc'
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_mb_is_available.5, label %ctrl0

func_mb_is_available.5:                           ; preds = %rand_bb
  %2 = call i32 @mb_is_available.5(i32 %mbAddr, i32 %currMbAddr)
  ret i32 %2

func_mb_is_available.7:                           ; preds = %ctrl0
  %3 = call i32 @mb_is_available.7(i32 %mbAddr, i32 %currMbAddr)
  ret i32 %3

func_mb_is_available.19:                          ; preds = %ctrl1
  %4 = call i32 @mb_is_available.19(i32 %mbAddr, i32 %currMbAddr)
  ret i32 %4

func_mb_is_available.22:                          ; preds = %ctrl2
  %5 = call i32 @mb_is_available.22(i32 %mbAddr, i32 %currMbAddr)
  ret i32 %5

func_mb_is_available.29:                          ; preds = %ctrl3
  %6 = call i32 @mb_is_available.29(i32 %mbAddr, i32 %currMbAddr)
  ret i32 %6

func_mb_is_available.32:                          ; preds = %ctrl3
  %7 = call i32 @mb_is_available.32(i32 %mbAddr, i32 %currMbAddr)
  ret i32 %7

ctrl0:                                            ; preds = %rand_bb
  %8 = icmp eq i32 %0, 1
  br i1 %8, label %func_mb_is_available.7, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %9 = icmp eq i32 %0, 2
  br i1 %9, label %func_mb_is_available.19, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %10 = icmp eq i32 %0, 3
  br i1 %10, label %func_mb_is_available.22, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %11 = icmp eq i32 %0, 4
  br i1 %11, label %func_mb_is_available.29, label %func_mb_is_available.32
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_CheckAvailabilityOfNeighbors.12, label %func_CheckAvailabilityOfNeighbors.13

func_CheckAvailabilityOfNeighbors.12:             ; preds = %rand_bb
  call void @CheckAvailabilityOfNeighbors.12()
  ret void
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_get_mb_block_pos.36, label %ctrl0

func_get_mb_block_pos.36:                         ; preds = %rand_bb
  call void @get_mb_block_pos.36(i32 %mb_addr, i32* %x, i32* %y)
  ret void

func_get_mb_block_pos.46:                         ; preds = %ctrl0
  call void @get_mb_block_pos.46(i32 %mb_addr, i32* %x, i32* %y)
  ret void

func_get_mb_block_pos.47:                         ; preds = %ctrl1
  call void @get_mb_block_pos.47(i32 %mb_addr, i32* %x, i32* %y)
  ret void

func_get_mb_block_pos.49:                         ; preds = %ctrl2
  call void @get_mb_block_pos.49(i32 %mb_addr, i32* %x, i32* %y)
  ret void

func_get_mb_block_pos.54:                         ; preds = %ctrl3
  call void @get_mb_block_pos.54(i32 %mb_addr, i32* %x, i32* %y)
  ret void

func_get_mb_block_pos.56:                         ; preds = %ctrl3
  call void @get_mb_block_pos.56(i32 %mb_addr, i32* %x, i32* %y)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_get_mb_block_pos.46, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_get_mb_block_pos.47, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_get_mb_block_pos.49, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_get_mb_block_pos.54, label %func_get_mb_block_pos.56
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_get_mb_pos.3, label %ctrl0

func_get_mb_pos.3:                                ; preds = %rand_bb
  call void @get_mb_pos.3(i32 %mb_addr, i32* %x, i32* %y)
  ret void
...
func_get_mb_pos.15:                               ; preds = %ctrl1
  call void @get_mb_pos.15(i32 %mb_addr, i32* %x, i32* %y)
  ret void

func_get_mb_pos.23:                               ; preds = %ctrl2
  call void @get_mb_pos.23(i32 %mb_addr, i32* %x, i32* %y)
  ret void

func_get_mb_pos.27:                               ; preds = %ctrl3
  call void @get_mb_pos.27(i32 %mb_addr, i32* %x, i32* %y)
  ret void

func_get_mb_pos.45:                               ; preds = %ctrl3
  call void @get_mb_pos.45(i32 %mb_addr, i32* %x, i32* %y)
  ret void
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_get_mb_pos.15, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_get_mb_pos.23, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_get_mb_pos.27, label %func_get_mb_pos.45
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_getNonAffNeighbour.1, label %ctrl0

func_getNonAffNeighbour.1:                        ; preds = %rand_bb
  call void @getNonAffNeighbour.1(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

func_getNonAffNeighbour.4:                        ; preds = %ctrl0
  call void @getNonAffNeighbour.4(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

func_getNonAffNeighbour.14:                       ; preds = %ctrl1
  call void @getNonAffNeighbour.14(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

func_getNonAffNeighbour.21:                       ; preds = %ctrl2
  call void @getNonAffNeighbour.21(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

func_getNonAffNeighbour.26:                       ; preds = %ctrl3
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_getNonAffNeighbour.4, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_getNonAffNeighbour.14, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_getNonAffNeighbour.21, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_getNonAffNeighbour.26, label %ctrl4
...
ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_getNonAffNeighbour.41, label %func_getNonAffNeighbour.53
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_getAffNeighbour.16, label %ctrl0

func_getAffNeighbour.16:                          ; preds = %rand_bb
  call void @getAffNeighbour.16(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

func_getAffNeighbour.17:                          ; preds = %ctrl0
  call void @getAffNeighbour.17(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

func_getAffNeighbour.20:                          ; preds = %ctrl1
  call void @getAffNeighbour.20(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

func_getAffNeighbour.44:                          ; preds = %ctrl2
  call void @getAffNeighbour.44(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

func_getAffNeighbour.48:                          ; preds = %ctrl3
  call void @getAffNeighbour.48(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

func_getAffNeighbour.51:                          ; preds = %ctrl4
  call void @getAffNeighbour.51(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

func_getAffNeighbour.52:                          ; preds = %ctrl5
  call void @getAffNeighbour.52(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

func_getAffNeighbour.55:                          ; preds = %ctrl5
  call void @getAffNeighbour.55(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_getAffNeighbour.17, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_getAffNeighbour.20, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_getAffNeighbour.44, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_getAffNeighbour.48, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_getAffNeighbour.51, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_getAffNeighbour.52, label %func_getAffNeighbour.55
}
...
func_getNeighbour.33:                             ; preds = %ctrl0
  call void @getNeighbour.33(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

func_getNeighbour.37:                             ; preds = %ctrl1
  call void @getNeighbour.37(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

func_getNeighbour.43:                             ; preds = %ctrl2
  call void @getNeighbour.43(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

func_getNeighbour.57:                             ; preds = %ctrl3
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_getNeighbour.33, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_getNeighbour.37, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_getNeighbour.43, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_getNeighbour.57, label %ctrl4
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_getLuma4x4Neighbour.8, label %ctrl0

func_getLuma4x4Neighbour.8:                       ; preds = %rand_bb
  call void @getLuma4x4Neighbour.8(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix)
  ret void

func_getLuma4x4Neighbour.9:                       ; preds = %ctrl0
  call void @getLuma4x4Neighbour.9(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix)
  ret void

func_getLuma4x4Neighbour.11:                      ; preds = %ctrl1
  call void @getLuma4x4Neighbour.11(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix)
  ret void
...
func_getLuma4x4Neighbour.25:                      ; preds = %ctrl3
  call void @getLuma4x4Neighbour.25(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix)
  ret void

func_getLuma4x4Neighbour.30:                      ; preds = %ctrl4
  call void @getLuma4x4Neighbour.30(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix)
  ret void

func_getLuma4x4Neighbour.38:                      ; preds = %ctrl5
  call void @getLuma4x4Neighbour.38(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix)
  ret void

func_getLuma4x4Neighbour.42:                      ; preds = %ctrl5
  call void @getLuma4x4Neighbour.42(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_getLuma4x4Neighbour.9, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_getLuma4x4Neighbour.11, label %ctrl2
...
ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_getLuma4x4Neighbour.25, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_getLuma4x4Neighbour.30, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_getLuma4x4Neighbour.38, label %func_getLuma4x4Neighbour.42
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_getChroma4x4Neighbour.2, label %ctrl0

func_getChroma4x4Neighbour.2:                     ; preds = %rand_bb
  call void @getChroma4x4Neighbour.2(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix)
  ret void

func_getChroma4x4Neighbour.24:                    ; preds = %ctrl0
  call void @getChroma4x4Neighbour.24(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix)
  ret void

func_getChroma4x4Neighbour.28:                    ; preds = %ctrl1
  call void @getChroma4x4Neighbour.28(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix)
  ret void

func_getChroma4x4Neighbour.31:                    ; preds = %ctrl2
  call void @getChroma4x4Neighbour.31(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix)
  ret void

func_getChroma4x4Neighbour.34:                    ; preds = %ctrl3
  call void @getChroma4x4Neighbour.34(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix)
  ret void

func_getChroma4x4Neighbour.35:                    ; preds = %ctrl4
  call void @getChroma4x4Neighbour.35(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix)
  ret void

func_getChroma4x4Neighbour.40:                    ; preds = %ctrl5
  call void @getChroma4x4Neighbour.40(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix)
  ret void

func_getChroma4x4Neighbour.50:                    ; preds = %ctrl5
  call void @getChroma4x4Neighbour.50(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_getChroma4x4Neighbour.24, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_getChroma4x4Neighbour.28, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_getChroma4x4Neighbour.31, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_getChroma4x4Neighbour.34, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_getChroma4x4Neighbour.35, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_getChroma4x4Neighbour.40, label %func_getChroma4x4Neighbour.50
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getNonAffNeighbour.1(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix) #0 {
entry:
  %xN.addr = alloca i32, align 4
  %luma.addr = alloca i32, align 4
  %yN.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1691806452, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1710561114, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @get_mb_pos.3(i32 %mb_addr, i32* %x, i32* %y) #0 {
entry:
  %x.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 596988674, i32* %canary
...
entry:
  ...
  %curr_mb_nr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1675410312, i32* %canary
  %currMb = alloca %struct.macroblock*, align 8
  %yN.addr = alloca i32, align 4
  %maxH = alloca i32, align 4
  %maxW = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1291283332, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1039982718, i32* %canary
  %xN.addr = alloca i32, align 4
  %luma.addr = alloca i32, align 4
  %curr_mb_nr.addr = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @mb_is_available.7(i32 %mbAddr, i32 %currMbAddr) #0 {
entry:
  %retval = alloca i32, align 4
  %mbAddr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1703981497, i32* %canary
  %currMbAddr.addr = alloca i32, align 4
  store i32 %mbAddr, i32* %mbAddr.addr, align 4
  store i32 %currMbAddr, i32* %currMbAddr.addr, align 4
  %0 = load i32, i32* %mbAddr.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getLuma4x4Neighbour.8(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix) #0 {
entry:
  %y = alloca i32, align 4
  %canary = alloca i32
  store i32 289115608, i32* %canary
  %curr_mb_nr.addr = alloca i32, align 4
  %block_y.addr = alloca i32, align 4
  %x = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getLuma4x4Neighbour.9(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix) #0 {
entry:
  %block_y.addr = alloca i32, align 4
  %block_x.addr = alloca i32, align 4
  %curr_mb_nr.addr = alloca i32, align 4
  ...
  %x = alloca i32, align 4
  %canary = alloca i32
  store i32 491677081, i32* %canary
  %rel_y.addr = alloca i32, align 4
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
  store i32 %block_x, i32* %block_x.addr, align 4
  store i32 %block_y, i32* %block_y.addr, align 4
...
entry:
  ...
  %x.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 982601764, i32* %canary
  %y.addr = alloca i32*, align 8
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
  store i32* %x, i32** %x.addr, align 8
  store i32* %y, i32** %y.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getLuma4x4Neighbour.11(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix) #0 {
entry:
  %pix.addr = alloca %struct.pix_pos*, align 8
  %curr_mb_nr.addr = alloca i32, align 4
  %block_y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2057077383, i32* %canary
  %y = alloca i32, align 4
  %block_x.addr = alloca i32, align 4
  %rel_y.addr = alloca i32, align 4
  %x = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @CheckAvailabilityOfNeighbors.12() #0 {
entry:
  %mb_nr = alloca i32, align 4
  %canary = alloca i32
  store i32 1369346644, i32* %canary
  %currMB = alloca %struct.macroblock*, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
if.end104:                                        ; preds = %if.then98, %if.end95
  ...
  %108 = icmp eq i32 %107, 1369346644
...
entry:
  %currMB = alloca %struct.macroblock*, align 8
  %canary = alloca i32
  store i32 1705303230, i32* %canary
  %mb_nr = alloca i32, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %current_mb_nr = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 3
  %1 = load i32, i32* %current_mb_nr, align 4
...
if.end104:                                        ; preds = %if.then98, %if.end95
  %107 = load i32, i32* %canary
  %108 = icmp eq i32 %107, 1705303230
  br i1 %108, label %109, label %func_exit
...
entry:
  ...
  %yN.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1365536755, i32* %canary
  %curr_mb_nr.addr = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
  %maxW = alloca i32, align 4
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @get_mb_pos.15(i32 %mb_addr, i32* %x, i32* %y) #0 {
entry:
  %x.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 435064554, i32* %canary
  %mb_addr.addr = alloca i32, align 4
  %y.addr = alloca i32*, align 8
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
  store i32* %x, i32** %x.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getAffNeighbour.16(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix) #0 {
entry:
  %yN.addr = alloca i32, align 4
  %xN.addr = alloca i32, align 4
  ...
  %maxH = alloca i32, align 4
  %canary = alloca i32
  store i32 247511632, i32* %canary
  %currMb = alloca %struct.macroblock*, align 8
  %luma.addr = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
  %curr_mb_nr.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getAffNeighbour.17(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix) #0 {
entry:
  %maxW = alloca i32, align 4
  %luma.addr = alloca i32, align 4
  %yN.addr = alloca i32, align 4
  ...
  %xN.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2013018203, i32* %canary
  %currMb = alloca %struct.macroblock*, align 8
  %maxH = alloca i32, align 4
  %curr_mb_nr.addr = alloca i32, align 4
  %yM = alloca i32, align 4
...
if.end376:                                        ; preds = %if.end375, %lor.lhs.false, %if.then8, %if.then1
  %309 = load i32, i32* %canary
  %310 = icmp eq i32 %309, 2013018203
  br i1 %310, label %311, label %func_exit
...
entry:
  ...
  %y = alloca i32, align 4
  %canary = alloca i32
  store i32 1058521404, i32* %canary
  %rel_y.addr = alloca i32, align 4
  %curr_mb_nr.addr = alloca i32, align 4
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
  store i32 %block_x, i32* %block_x.addr, align 4
...
entry:
  %currMbAddr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 935290740, i32* %canary
  %mbAddr.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  store i32 %mbAddr, i32* %mbAddr.addr, align 4
  store i32 %currMbAddr, i32* %currMbAddr.addr, align 4
...
entry:
  ...
  %luma.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 145640240, i32* %canary
  %xN.addr = alloca i32, align 4
  %yM = alloca i32, align 4
  %yN.addr = alloca i32, align 4
  %curr_mb_nr.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getNonAffNeighbour.21(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix) #0 {
entry:
  %luma.addr = alloca i32, align 4
  %yN.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 102110423, i32* %canary
  %maxH = alloca i32, align 4
  %currMb = alloca %struct.macroblock*, align 8
  %curr_mb_nr.addr = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @mb_is_available.22(i32 %mbAddr, i32 %currMbAddr) #0 {
entry:
  %currMbAddr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 920123278, i32* %canary
  %retval = alloca i32, align 4
  %mbAddr.addr = alloca i32, align 4
  store i32 %mbAddr, i32* %mbAddr.addr, align 4
  store i32 %currMbAddr, i32* %currMbAddr.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @get_mb_pos.23(i32 %mb_addr, i32* %x, i32* %y) #0 {
entry:
  %mb_addr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1776377969, i32* %canary
  %y.addr = alloca i32*, align 8
  %x.addr = alloca i32*, align 8
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
  store i32* %x, i32** %x.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getChroma4x4Neighbour.24(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix) #0 {
entry:
  %canary = alloca i32
  store i32 955568571, i32* %canary
  %pix.addr = alloca %struct.pix_pos*, align 8
  %x = alloca i32, align 4
  %y = alloca i32, align 4
  %block_x.addr = alloca i32, align 4
...
entry:
  ...
  %rel_x.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2044079247, i32* %canary
  %block_y.addr = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
  %curr_mb_nr.addr = alloca i32, align 4
  %y = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 372999028, i32* %canary
  %maxW = alloca i32, align 4
  %luma.addr = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
  %maxH = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @get_mb_pos.27(i32 %mb_addr, i32* %x, i32* %y) #0 {
entry:
  %canary = alloca i32
  store i32 416927773, i32* %canary
  %y.addr = alloca i32*, align 8
  %x.addr = alloca i32*, align 8
  %mb_addr.addr = alloca i32, align 4
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getChroma4x4Neighbour.28(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix) #0 {
entry:
  %pix.addr = alloca %struct.pix_pos*, align 8
  %block_y.addr = alloca i32, align 4
  %y = alloca i32, align 4
  %canary = alloca i32
  store i32 407565610, i32* %canary
  %rel_x.addr = alloca i32, align 4
  %curr_mb_nr.addr = alloca i32, align 4
  %block_x.addr = alloca i32, align 4
  %rel_y.addr = alloca i32, align 4
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1543641467, i32* %canary
  %currMbAddr.addr = alloca i32, align 4
  store i32 %mbAddr, i32* %mbAddr.addr, align 4
  store i32 %currMbAddr, i32* %currMbAddr.addr, align 4
  %0 = load i32, i32* %mbAddr.addr, align 4
...
entry:
  ...
  %y = alloca i32, align 4
  %canary = alloca i32
  store i32 2089432931, i32* %canary
  %rel_x.addr = alloca i32, align 4
  %x = alloca i32, align 4
  %block_x.addr = alloca i32, align 4
  %block_y.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getChroma4x4Neighbour.31(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix) #0 {
entry:
  %rel_y.addr = alloca i32, align 4
  %rel_x.addr = alloca i32, align 4
  %y = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @mb_is_available.32(i32 %mbAddr, i32 %currMbAddr) #0 {
entry:
  %canary = alloca i32
  store i32 1514104599, i32* %canary
  %retval = alloca i32, align 4
  %currMbAddr.addr = alloca i32, align 4
  %mbAddr.addr = alloca i32, align 4
  store i32 %mbAddr, i32* %mbAddr.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getNeighbour.33(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix) #0 {
entry:
  %pix.addr = alloca %struct.pix_pos*, align 8
  %curr_mb_nr.addr = alloca i32, align 4
  %xN.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1661343307, i32* %canary
  %yN.addr = alloca i32, align 4
  %luma.addr = alloca i32, align 4
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
  store i32 %xN, i32* %xN.addr, align 4
...
entry:
  ...
  %x = alloca i32, align 4
  %canary = alloca i32
  store i32 314957094, i32* %canary
  %rel_x.addr = alloca i32, align 4
  %curr_mb_nr.addr = alloca i32, align 4
  %block_y.addr = alloca i32, align 4
  %y = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1506938463, i32* %canary
  %rel_y.addr = alloca i32, align 4
  %block_y.addr = alloca i32, align 4
  %block_x.addr = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
...
entry:
  %y.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 1875246755, i32* %canary
  %x.addr = alloca i32*, align 8
  %mb_addr.addr = alloca i32, align 4
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
  store i32* %x, i32** %x.addr, align 8
...
entry:
  ...
  %curr_mb_nr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1507293093, i32* %canary
  %pix.addr = alloca %struct.pix_pos*, align 8
  %yN.addr = alloca i32, align 4
  %luma.addr = alloca i32, align 4
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
...
entry:
  ...
  %maxW = alloca i32, align 4
  %canary = alloca i32
  store i32 342878119, i32* %canary
  %maxH = alloca i32, align 4
  %luma.addr = alloca i32, align 4
  %yN.addr = alloca i32, align 4
  %curr_mb_nr.addr = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 2080159505, i32* %canary
  %block_x.addr = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
  %block_y.addr = alloca i32, align 4
  %rel_x.addr = alloca i32, align 4
...
entry:
  ...
  %yN.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 113999549, i32* %canary
  %pix.addr = alloca %struct.pix_pos*, align 8
  %curr_mb_nr.addr = alloca i32, align 4
  %xN.addr = alloca i32, align 4
  %luma.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getLuma4x4Neighbour.42(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix) #0 {
entry:
  %block_x.addr = alloca i32, align 4
  %rel_x.addr = alloca i32, align 4
  %x = alloca i32, align 4
  ...
  %rel_y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1847470638, i32* %canary
  %y = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
  store i32 %block_x, i32* %block_x.addr, align 4
...
entry:
  %curr_mb_nr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1753714862, i32* %canary
  %xN.addr = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
  %luma.addr = alloca i32, align 4
  %yN.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getAffNeighbour.44(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix) #0 {
entry:
  %yN.addr = alloca i32, align 4
  %curr_mb_nr.addr = alloca i32, align 4
  %xN.addr = alloca i32, align 4
  ...
  %maxH = alloca i32, align 4
  %canary = alloca i32
  store i32 1461924627, i32* %canary
  %maxW = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
  store i32 %xN, i32* %xN.addr, align 4
...
if.end376:                                        ; preds = %if.end375, %lor.lhs.false, %if.then8, %if.then1
  %309 = load i32, i32* %canary
  %310 = icmp eq i32 %309, 1461924627
  br i1 %310, label %311, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @get_mb_pos.45(i32 %mb_addr, i32* %x, i32* %y) #0 {
entry:
  %y.addr = alloca i32*, align 8
  %mb_addr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1483271185, i32* %canary
  %x.addr = alloca i32*, align 8
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
  store i32* %x, i32** %x.addr, align 8
  store i32* %y, i32** %y.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 979959867, i32* %canary
  %mb_addr.addr = alloca i32, align 4
  %y.addr = alloca i32*, align 8
  %x.addr = alloca i32*, align 8
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @get_mb_block_pos.47(i32 %mb_addr, i32* %x, i32* %y) #0 {
entry:
  %canary = alloca i32
  store i32 1291730349, i32* %canary
  %y.addr = alloca i32*, align 8
  %mb_addr.addr = alloca i32, align 4
  %x.addr = alloca i32*, align 8
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
...
entry:
  ...
  %y.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 704239667, i32* %canary
  %mb_addr.addr = alloca i32, align 4
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
  store i32* %x, i32** %x.addr, align 8
  store i32* %y, i32** %y.addr, align 8
...
entry:
  ...
  %x = alloca i32, align 4
  %canary = alloca i32
  store i32 1697646662, i32* %canary
  %curr_mb_nr.addr = alloca i32, align 4
  %rel_x.addr = alloca i32, align 4
  %block_x.addr = alloca i32, align 4
  %y = alloca i32, align 4
...
entry:
  ...
  %yN.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 675320710, i32* %canary
  %luma.addr = alloca i32, align 4
  %curr_mb_nr.addr = alloca i32, align 4
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
  store i32 %xN, i32* %xN.addr, align 4
...
entry:
  ...
  %maxW = alloca i32, align 4
  %canary = alloca i32
  store i32 908557684, i32* %canary
  %maxH = alloca i32, align 4
  %curr_mb_nr.addr = alloca i32, align 4
  %xN.addr = alloca i32, align 4
  %luma.addr = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1538276784, i32* %canary
  %xN.addr = alloca i32, align 4
  %maxH = alloca i32, align 4
  %curr_mb_nr.addr = alloca i32, align 4
  %yN.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @get_mb_block_pos.54(i32 %mb_addr, i32* %x, i32* %y) #0 {
entry:
  %canary = alloca i32
  store i32 510715838, i32* %canary
  %x.addr = alloca i32*, align 8
  %mb_addr.addr = alloca i32, align 4
  %y.addr = alloca i32*, align 8
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getAffNeighbour.55(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix) #0 {
entry:
  %xN.addr = alloca i32, align 4
  %luma.addr = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
  ...
  %yM = alloca i32, align 4
  %canary = alloca i32
  store i32 1544332616, i32* %canary
  %curr_mb_nr.addr = alloca i32, align 4
  %yN.addr = alloca i32, align 4
  %maxH = alloca i32, align 4
  %maxW = alloca i32, align 4
...
if.end376:                                        ; preds = %if.end375, %lor.lhs.false, %if.then8, %if.then1
  %309 = load i32, i32* %canary
  %310 = icmp eq i32 %309, 1544332616
  br i1 %310, label %311, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @get_mb_block_pos.56(i32 %mb_addr, i32* %x, i32* %y) #0 {
entry:
  %canary = alloca i32
  store i32 778124010, i32* %canary
  %mb_addr.addr = alloca i32, align 4
  %x.addr = alloca i32*, align 8
  %y.addr = alloca i32*, align 8
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
...
entry:
  %yN.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1347543670, i32* %canary
  %curr_mb_nr.addr = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
  %luma.addr = alloca i32, align 4
  %xN.addr = alloca i32, align 4
...
entry:
  ...
  %curr_mb_nr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 873457405, i32* %canary
  %luma.addr = alloca i32, align 4
  %yN.addr = alloca i32, align 4
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
  store i32 %xN, i32* %xN.addr, align 4
...
entry:
  ...
  %yN.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 831711943, i32* %canary
  %curr_mb_nr.addr = alloca i32, align 4
  %luma.addr = alloca i32, align 4
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
  store i32 %xN, i32* %xN.addr, align 4
...
entry:
  ...
  %pix.addr = alloca %struct.pix_pos*, align 8
  %canary = alloca i32
  store i32 159364816, i32* %canary
  %yN.addr = alloca i32, align 4
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
  store i32 %xN, i32* %xN.addr, align 4
  store i32 %yN, i32* %yN.addr, align 4
