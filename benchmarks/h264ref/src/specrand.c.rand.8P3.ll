; ModuleID = 'specrand.c.rand.8P3.bc'
...
entry:
  ...
  %canary = alloca i32
  store i32 316485726, i32* %canary
...
entry:
  ...
  %test = alloca i32, align 4
  %canary = alloca i32
  store i32 138270650, i32* %canary
  %lo = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
  %conv = sext i32 %0 to i64
  %div = sdiv i64 %conv, 127773
...
entry:
  %canary = alloca i32
  store i32 1390992748, i32* %canary
  %lo = alloca i32, align 4
  %hi = alloca i32, align 4
  %test = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
...
entry:
  %lo = alloca i32, align 4
  %canary = alloca i32
  store i32 943767817, i32* %canary
  %test = alloca i32, align 4
  %hi = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
  %conv = sext i32 %0 to i64
...
entry:
  %hi = alloca i32, align 4
  %canary = alloca i32
  store i32 1993211048, i32* %canary
  %lo = alloca i32, align 4
  %test = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
  %conv = sext i32 %0 to i64
...
entry:
  %canary = alloca i32
  store i32 1446282919, i32* %canary
  %test = alloca i32, align 4
  %lo = alloca i32, align 4
  %hi = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
