...
# %bb.0:                                # %entry
	...
	.cfi_offset %rbx, -24
	movl	16(%rbp), %eax
	movl	$2072109872, -32(%rbp)  # imm = 0x7B81E330
	movq	%rdi, -48(%rbp)
	movq	%rsi, -16(%rbp)
	movl	%edx, -24(%rbp)
	movl	%ecx, -40(%rbp)
	...
	movl	%eax, 4(%rcx)
	movl	-20(%rbp), %ebx
	cmpl	$2072109872, -32(%rbp)  # imm = 0x7B81E330
	jne	.LBB1_2
.LBB1_1:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_offset %rbx, -24
	movl	16(%rbp), %eax
	movl	$1082452061, -36(%rbp)  # imm = 0x4084E85D
	movq	%rdi, -48(%rbp)
	movq	%rsi, -16(%rbp)
	movl	%edx, -20(%rbp)
	movl	%ecx, -40(%rbp)
	...
	movl	%eax, 4(%rcx)
	movl	-24(%rbp), %ebx
	cmpl	$1082452061, -36(%rbp)  # imm = 0x4084E85D
	jne	.LBB2_2
.LBB2_1:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_offset %rbx, -24
	movl	16(%rbp), %eax
	movl	$1977288233, -36(%rbp)  # imm = 0x75DB0629
	movq	%rdi, -48(%rbp)
	movq	%rsi, -16(%rbp)
	movl	%edx, -24(%rbp)
	movl	%ecx, -32(%rbp)
	...
	movl	%eax, 4(%rcx)
	movl	-20(%rbp), %ebx
	cmpl	$1977288233, -36(%rbp)  # imm = 0x75DB0629
	jne	.LBB3_2
.LBB3_1:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_offset %rbx, -24
	movl	16(%rbp), %eax
	movl	$32213543, -36(%rbp)    # imm = 0x1EB8A27
	movq	%rdi, -48(%rbp)
	movq	%rsi, -16(%rbp)
	movl	%edx, -20(%rbp)
	movl	%ecx, -28(%rbp)
	...
	movl	%eax, 4(%rcx)
	movl	-24(%rbp), %ebx
	cmpl	$32213543, -36(%rbp)    # imm = 0x1EB8A27
	jne	.LBB4_2
.LBB4_1:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_offset %rbx, -24
	movl	16(%rbp), %eax
	movl	$1211168444, -28(%rbp)  # imm = 0x4830F6BC
	movq	%rdi, -48(%rbp)
	movq	%rsi, -16(%rbp)
	movl	%edx, -20(%rbp)
	movl	%ecx, -36(%rbp)
	...
	movl	%eax, 4(%rcx)
	movl	-24(%rbp), %ebx
	cmpl	$1211168444, -28(%rbp)  # imm = 0x4830F6BC
	jne	.LBB5_2
.LBB5_1:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_offset %rbx, -24
	movl	16(%rbp), %eax
	movl	$1476385274, -36(%rbp)  # imm = 0x57FFD9FA
	movq	%rdi, -48(%rbp)
	movq	%rsi, -16(%rbp)
	movl	%edx, -24(%rbp)
	movl	%ecx, -40(%rbp)
	...
	movl	%eax, 4(%rcx)
	movl	-20(%rbp), %ebx
	cmpl	$1476385274, -36(%rbp)  # imm = 0x57FFD9FA
	jne	.LBB6_2
.LBB6_1:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_offset %rbx, -24
	movl	16(%rbp), %eax
	movl	$1037286988, -36(%rbp)  # imm = 0x3DD3BE4C
	movq	%rdi, -48(%rbp)
	movq	%rsi, -16(%rbp)
	movl	%edx, -24(%rbp)
	movl	%ecx, -40(%rbp)
	...
	movl	%eax, 4(%rcx)
	movl	-20(%rbp), %ebx
	cmpl	$1037286988, -36(%rbp)  # imm = 0x3DD3BE4C
	jne	.LBB7_2
.LBB7_1:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_offset %rbx, -24
	movl	16(%rbp), %eax
	movl	$1788640396, -36(%rbp)  # imm = 0x6A9C7C8C
	movq	%rdi, -48(%rbp)
	movq	%rsi, -16(%rbp)
	movl	%edx, -24(%rbp)
	movl	%ecx, -28(%rbp)
	...
	movl	%eax, 4(%rcx)
	movl	-20(%rbp), %ebx
	cmpl	$1788640396, -36(%rbp)  # imm = 0x6A9C7C8C
	jne	.LBB8_2
.LBB8_1:
	movl	%ebx, %eax
	addq	$40, %rsp
