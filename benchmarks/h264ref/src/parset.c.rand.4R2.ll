...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_GenerateParameterSets.16, label %func_GenerateParameterSets.21

func_GenerateParameterSets.16:                    ; preds = %rand_bb
  call void @GenerateParameterSets.16()
  ret void

func_GenerateParameterSets.21:                    ; preds = %rand_bb
  call void @GenerateParameterSets.21()
  ret void
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_GenerateSequenceParameterSet.12, label %ctrl0

func_GenerateSequenceParameterSet.12:             ; preds = %rand_bb
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_GeneratePictureParameterSet.17, label %ctrl0

func_GeneratePictureParameterSet.17:              ; preds = %rand_bb
  call void @GeneratePictureParameterSet.17(%struct.pic_parameter_set_rbsp_t* %pps, %struct.seq_parameter_set_rbsp_t* %sps, i32 %PPS_id, i32 %WeightedPrediction, i32 %WeightedBiprediction, i32 %cb_qp_index_offset, i32 %cr_qp_index_offset)
  ret void

func_GeneratePictureParameterSet.22:              ; preds = %ctrl0
...
func_GeneratePictureParameterSet.26:              ; preds = %ctrl1
  call void @GeneratePictureParameterSet.26(%struct.pic_parameter_set_rbsp_t* %pps, %struct.seq_parameter_set_rbsp_t* %sps, i32 %PPS_id, i32 %WeightedPrediction, i32 %WeightedBiprediction, i32 %cb_qp_index_offset, i32 %cr_qp_index_offset)
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_GeneratePictureParameterSet.22, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_GeneratePictureParameterSet.26, label %func_GeneratePictureParameterSet.27
}
...
func_GenerateSeq_parameter_set_NALU.9:            ; preds = %ctrl0
  %3 = call %struct.NALU_t* @GenerateSeq_parameter_set_NALU.9()
  ret %struct.NALU_t* %3

func_GenerateSeq_parameter_set_NALU.15:           ; preds = %ctrl1
  %4 = call %struct.NALU_t* @GenerateSeq_parameter_set_NALU.15()
  ret %struct.NALU_t* %4
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_GenerateSeq_parameter_set_NALU.9, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_GenerateSeq_parameter_set_NALU.15, label %func_GenerateSeq_parameter_set_NALU.23
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_GenerateSeq_parameter_set_rbsp.5, label %ctrl0

func_GenerateSeq_parameter_set_rbsp.5:            ; preds = %rand_bb
  %2 = call i32 @GenerateSeq_parameter_set_rbsp.5(%struct.seq_parameter_set_rbsp_t* %sps, i8* %rbsp)
  ret i32 %2

func_GenerateSeq_parameter_set_rbsp.11:           ; preds = %ctrl0
  %3 = call i32 @GenerateSeq_parameter_set_rbsp.11(%struct.seq_parameter_set_rbsp_t* %sps, i8* %rbsp)
  ret i32 %3

func_GenerateSeq_parameter_set_rbsp.24:           ; preds = %ctrl1
  %4 = call i32 @GenerateSeq_parameter_set_rbsp.24(%struct.seq_parameter_set_rbsp_t* %sps, i8* %rbsp)
  ret i32 %4
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_GenerateSeq_parameter_set_rbsp.11, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_GenerateSeq_parameter_set_rbsp.24, label %func_GenerateSeq_parameter_set_rbsp.28
}
...
func_GeneratePic_parameter_set_NALU.25:           ; preds = %ctrl1
  %4 = call %struct.NALU_t* @GeneratePic_parameter_set_NALU.25(i32 %PPS_id)
  ret %struct.NALU_t* %4
...
ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_GeneratePic_parameter_set_NALU.25, label %func_GeneratePic_parameter_set_NALU.29
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_GeneratePic_parameter_set_rbsp.4, label %ctrl0

func_GeneratePic_parameter_set_rbsp.4:            ; preds = %rand_bb
  %2 = call i32 @GeneratePic_parameter_set_rbsp.4(%struct.pic_parameter_set_rbsp_t* %pps, i8* %rbsp)
  ret i32 %2

func_GeneratePic_parameter_set_rbsp.13:           ; preds = %ctrl0
  %3 = call i32 @GeneratePic_parameter_set_rbsp.13(%struct.pic_parameter_set_rbsp_t* %pps, i8* %rbsp)
  ret i32 %3

func_GeneratePic_parameter_set_rbsp.19:           ; preds = %ctrl1
  %4 = call i32 @GeneratePic_parameter_set_rbsp.19(%struct.pic_parameter_set_rbsp_t* %pps, i8* %rbsp)
  ret i32 %4

func_GeneratePic_parameter_set_rbsp.20:           ; preds = %ctrl1
  %5 = call i32 @GeneratePic_parameter_set_rbsp.20(%struct.pic_parameter_set_rbsp_t* %pps, i8* %rbsp)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_GeneratePic_parameter_set_rbsp.13, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_GeneratePic_parameter_set_rbsp.19, label %func_GeneratePic_parameter_set_rbsp.20
}
...
func_Scaling_List.2:                              ; preds = %ctrl0
  %3 = call i32 @Scaling_List.2(i16* %scalingListinput, i16* %scalingList, i32 %sizeOfScalingList, i16* %UseDefaultScalingMatrix, %struct.datapartition* %partition)
  ret i32 %3

func_Scaling_List.3:                              ; preds = %ctrl1
  %4 = call i32 @Scaling_List.3(i16* %scalingListinput, i16* %scalingList, i32 %sizeOfScalingList, i16* %UseDefaultScalingMatrix, %struct.datapartition* %partition)
  ret i32 %4

func_Scaling_List.8:                              ; preds = %ctrl1
  %5 = call i32 @Scaling_List.8(i16* %scalingListinput, i16* %scalingList, i32 %sizeOfScalingList, i16* %UseDefaultScalingMatrix, %struct.datapartition* %partition)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_Scaling_List.2, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_Scaling_List.3, label %func_Scaling_List.8
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_GenerateVUISequenceParameters.10, label %func_GenerateVUISequenceParameters.18

func_GenerateVUISequenceParameters.10:            ; preds = %rand_bb
  %2 = call i32 @GenerateVUISequenceParameters.10(%struct.datapartition* %partition)
  ret i32 %2

func_GenerateVUISequenceParameters.18:            ; preds = %rand_bb
  %3 = call i32 @GenerateVUISequenceParameters.18(%struct.datapartition* %partition)
  ret i32 %3
}
...
entry:
  ...
  %canary = alloca i32
  store i32 420579435, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @Scaling_List.2(i16* %scalingListinput, i16* %scalingList, i32 %sizeOfScalingList, i16* %UseDefaultScalingMatrix, %struct.datapartition* %partition) #0 {
entry:
  %len = alloca i32, align 4
  %lastScale = alloca i32, align 4
  %scalingList.addr = alloca i16*, align 8
...
entry:
  ...
  %nextScale = alloca i32, align 4
  %canary = alloca i32
  store i32 742061971, i32* %canary
  %scalingList.addr = alloca i16*, align 8
  store i16* %scalingListinput, i16** %scalingListinput.addr, align 8
  store i16* %scalingList, i16** %scalingList.addr, align 8
  store i32 %sizeOfScalingList, i32* %sizeOfScalingList.addr, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 1247993947, i32* %canary
  %len = alloca i32, align 4
...
if.end201:                                        ; preds = %if.end198, %lor.lhs.false143
  ...
  %202 = icmp eq i32 %201, 1247993947
...
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1572537184, i32* %canary
  %partition = alloca %struct.datapartition*, align 8
  %LenInBytes = alloca i32, align 4
...
if.end158:                                        ; preds = %if.then155, %if.end150
  ...
  %208 = icmp eq i32 %207, 1572537184
...
entry:
  %canary = alloca i32
  store i32 329667929, i32* %canary
...
entry:
  ...
  %NALUlen = alloca i32, align 4
  %canary = alloca i32
  store i32 1512350708, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @Scaling_List.8(i16* %scalingListinput, i16* %scalingList, i32 %sizeOfScalingList, i16* %UseDefaultScalingMatrix, %struct.datapartition* %partition) #0 {
entry:
  %len = alloca i32, align 4
  %lastScale = alloca i32, align 4
  %UseDefaultScalingMatrix.addr = alloca i16*, align 8
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1044716896, i32* %canary
  %scanj = alloca i32, align 4
  store i16* %scalingListinput, i16** %scalingListinput.addr, align 8
  store i16* %scalingList, i16** %scalingList.addr, align 8
  store i32 %sizeOfScalingList, i32* %sizeOfScalingList.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct.NALU_t* @GenerateSeq_parameter_set_NALU.9() #0 {
entry:
  %canary = alloca i32
  store i32 1748765208, i32* %canary
  %rbsp = alloca [64000 x i8], align 16
  %n = alloca %struct.NALU_t*, align 8
  %RBSPlen = alloca i32, align 4
  %NALUlen = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @GenerateVUISequenceParameters.10(%struct.datapartition* %partition) #0 {
entry:
  %partition.addr = alloca %struct.datapartition*, align 8
  %canary = alloca i32
  store i32 940387731, i32* %canary
  %len = alloca i32, align 4
  store %struct.datapartition* %partition, %struct.datapartition** %partition.addr, align 8
  store i32 0, i32* %len, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
entry:
  %canary = alloca i32
  store i32 218622117, i32* %canary
  %rbsp.addr = alloca i8*, align 8
  %i = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
  %sps.addr = alloca %struct.seq_parameter_set_rbsp_t*, align 8
...
entry:
  ...
  %canary = alloca i32
  store i32 684757822, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @GeneratePic_parameter_set_rbsp.13(%struct.pic_parameter_set_rbsp_t* %pps, i8* %rbsp) #0 {
entry:
  %len = alloca i32, align 4
  %NumberBitsPerSliceGroupId = alloca i32, align 4
  %rbsp.addr = alloca i8*, align 8
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1659957846, i32* %canary
  %profile_idc = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
  store i8* %rbsp, i8** %rbsp.addr, align 8
...
if.end201:                                        ; preds = %if.end198, %lor.lhs.false143
  ...
  %200 = load i32, i32* %LenInBytes, align 4
  %201 = load i32, i32* %canary
  %202 = icmp eq i32 %201, 1659957846
  br i1 %202, label %203, label %func_exit
...
entry:
  %canary = alloca i32
  store i32 2032227870, i32* %canary
  %n = alloca %struct.NALU_t*, align 8
  %NALUlen = alloca i32, align 4
  %rbsp = alloca [64000 x i8], align 16
  %PPS_id.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct.NALU_t* @GenerateSeq_parameter_set_NALU.15() #0 {
entry:
  %canary = alloca i32
  store i32 931784720, i32* %canary
  %rbsp = alloca [64000 x i8], align 16
  %RBSPlen = alloca i32, align 4
  %NALUlen = alloca i32, align 4
  %n = alloca %struct.NALU_t*, align 8
...
entry:
  %canary = alloca i32
  store i32 360047043, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @GeneratePictureParameterSet.17(%struct.pic_parameter_set_rbsp_t* %pps, %struct.seq_parameter_set_rbsp_t* %sps, i32 %PPS_id, i32 %WeightedPrediction, i32 %WeightedBiprediction, i32 %cb_qp_index_offset, i32 %cr_qp_index_offset) #0 {
entry:
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %WeightedBiprediction.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 459695962, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @GenerateVUISequenceParameters.18(%struct.datapartition* %partition) #0 {
entry:
  %len = alloca i32, align 4
  %canary = alloca i32
  store i32 1839974568, i32* %canary
  %partition.addr = alloca %struct.datapartition*, align 8
  store %struct.datapartition* %partition, %struct.datapartition** %partition.addr, align 8
  store i32 0, i32* %len, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @GeneratePic_parameter_set_rbsp.19(%struct.pic_parameter_set_rbsp_t* %pps, i8* %rbsp) #0 {
entry:
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %LenInBytes = alloca i32, align 4
  %len = alloca i32, align 4
  ...
  %profile_idc = alloca i32, align 4
  %canary = alloca i32
  store i32 1535951326, i32* %canary
  %i = alloca i32, align 4
  %rbsp.addr = alloca i8*, align 8
  %partition = alloca %struct.datapartition*, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
...
if.end201:                                        ; preds = %if.end198, %lor.lhs.false143
  ...
  %200 = load i32, i32* %LenInBytes, align 4
  %201 = load i32, i32* %canary
  %202 = icmp eq i32 %201, 1535951326
  br i1 %202, label %203, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @GeneratePic_parameter_set_rbsp.20(%struct.pic_parameter_set_rbsp_t* %pps, i8* %rbsp) #0 {
entry:
  %profile_idc = alloca i32, align 4
  %len = alloca i32, align 4
  %rbsp.addr = alloca i8*, align 8
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 2039693109, i32* %canary
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %partition = alloca %struct.datapartition*, align 8
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
  store i8* %rbsp, i8** %rbsp.addr, align 8
...
if.end201:                                        ; preds = %if.end198, %lor.lhs.false143
  ...
  %200 = load i32, i32* %LenInBytes, align 4
  %201 = load i32, i32* %canary
  %202 = icmp eq i32 %201, 2039693109
  br i1 %202, label %203, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @GenerateParameterSets.21() #0 {
entry:
  %canary = alloca i32
  store i32 896796682, i32* %canary
  %sps = alloca %struct.seq_parameter_set_rbsp_t*, align 8
  %pps = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  store %struct.seq_parameter_set_rbsp_t* null, %struct.seq_parameter_set_rbsp_t** %sps, align 8
  store %struct.pic_parameter_set_rbsp_t* null, %struct.pic_parameter_set_rbsp_t** %pps, align 8
...
entry:
  %canary = alloca i32
  store i32 879218388, i32* %canary
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %cb_qp_index_offset.addr = alloca i32, align 4
  %sps.addr = alloca %struct.seq_parameter_set_rbsp_t*, align 8
  %WeightedBiprediction.addr = alloca i32, align 4
...
entry:
  ...
  %RBSPlen = alloca i32, align 4
  %canary = alloca i32
  store i32 474881879, i32* %canary
  %n = alloca %struct.NALU_t*, align 8
  %call = call %struct.NALU_t* (i32, ...) bitcast (%struct.NALU_t* (...)* @AllocNALU to %struct.NALU_t* (i32, ...)*)(i32 64000)
  store %struct.NALU_t* %call, %struct.NALU_t** %n, align 8
  store i32 0, i32* %RBSPlen, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @GenerateSeq_parameter_set_rbsp.24(%struct.seq_parameter_set_rbsp_t* %sps, i8* %rbsp) #0 {
entry:
  %LenInBytes = alloca i32, align 4
  %sps.addr = alloca %struct.seq_parameter_set_rbsp_t*, align 8
  %len = alloca i32, align 4
  ...
  %partition = alloca %struct.datapartition*, align 8
  %canary = alloca i32
  store i32 1149013620, i32* %canary
  %i = alloca i32, align 4
  store %struct.seq_parameter_set_rbsp_t* %sps, %struct.seq_parameter_set_rbsp_t** %sps.addr, align 8
  store i8* %rbsp, i8** %rbsp.addr, align 8
  store i32 0, i32* %len, align 4
...
if.end158:                                        ; preds = %if.then155, %if.end150
  ...
  %206 = load i32, i32* %LenInBytes, align 4
  %207 = load i32, i32* %canary
  %208 = icmp eq i32 %207, 1149013620
  br i1 %208, label %209, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct.NALU_t* @GeneratePic_parameter_set_NALU.25(i32 %PPS_id) #0 {
entry:
  %RBSPlen = alloca i32, align 4
  %NALUlen = alloca i32, align 4
  %canary = alloca i32
  store i32 1576710043, i32* %canary
  %PPS_id.addr = alloca i32, align 4
  %rbsp = alloca [64000 x i8], align 16
  %n = alloca %struct.NALU_t*, align 8
  store i32 %PPS_id, i32* %PPS_id.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @GeneratePictureParameterSet.26(%struct.pic_parameter_set_rbsp_t* %pps, %struct.seq_parameter_set_rbsp_t* %sps, i32 %PPS_id, i32 %WeightedPrediction, i32 %WeightedBiprediction, i32 %cb_qp_index_offset, i32 %cr_qp_index_offset) #0 {
entry:
  %WeightedPrediction.addr = alloca i32, align 4
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %sps.addr = alloca %struct.seq_parameter_set_rbsp_t*, align 8
  ...
  %frext_profile = alloca i32, align 4
  %canary = alloca i32
  store i32 204805774, i32* %canary
  %WeightedBiprediction.addr = alloca i32, align 4
  %cb_qp_index_offset.addr = alloca i32, align 4
  store %struct.pic_parameter_set_rbsp_t* %pps, %struct.pic_parameter_set_rbsp_t** %pps.addr, align 8
  store %struct.seq_parameter_set_rbsp_t* %sps, %struct.seq_parameter_set_rbsp_t** %sps.addr, align 8
...
entry:
  ...
  %PPS_id.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 225219678, i32* %canary
  %WeightedBiprediction.addr = alloca i32, align 4
  %pps.addr = alloca %struct.pic_parameter_set_rbsp_t*, align 8
  %WeightedPrediction.addr = alloca i32, align 4
  %i = alloca i32, align 4
...
entry:
  ...
  %rbsp.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1493428751, i32* %canary
  %len = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
  %LenInBytes = alloca i32, align 4
  %i = alloca i32, align 4
...
if.end158:                                        ; preds = %if.then155, %if.end150
  ...
  %206 = load i32, i32* %LenInBytes, align 4
  %207 = load i32, i32* %canary
  %208 = icmp eq i32 %207, 1493428751
  br i1 %208, label %209, label %func_exit
...
entry:
  ...
  %NALUlen = alloca i32, align 4
  %canary = alloca i32
  store i32 1294242502, i32* %canary
  %rbsp = alloca [64000 x i8], align 16
  %PPS_id.addr = alloca i32, align 4
  %n = alloca %struct.NALU_t*, align 8
  store i32 %PPS_id, i32* %PPS_id.addr, align 4
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1720681042, i32* %canary
  %height = alloca i32, align 4
  %SubHeightC = alloca [4 x i32], align 16
  %PicHeightInMapUnits = alloca i32, align 4
  %SPS_id.addr = alloca i32, align 4
...
if.end137:                                        ; preds = %if.else135, %if.end134
  %162 = load i32, i32* %canary
  %163 = icmp eq i32 %162, 1720681042
  br i1 %163, label %164, label %func_exit
...
entry:
  ...
  %PicHeightInMapUnits = alloca i32, align 4
  %canary = alloca i32
  store i32 563210093, i32* %canary
  %height = alloca i32, align 4
  %SPS_id.addr = alloca i32, align 4
  %frext_profile = alloca i32, align 4
  %i = alloca i32, align 4
