; ModuleID = 'configfile.c.rand.4P3.bc'
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_Configure.4, label %ctrl0

func_Configure.4:                                 ; preds = %rand_bb
  call void @Configure.4(i32 %ac, i8** %av)
  ret void

func_Configure.5:                                 ; preds = %ctrl0
  call void @Configure.5(i32 %ac, i8** %av)
  ret void

func_Configure.10:                                ; preds = %ctrl1
  call void @Configure.10(i32 %ac, i8** %av)
  ret void

func_Configure.14:                                ; preds = %ctrl1
  call void @Configure.14(i32 %ac, i8** %av)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_Configure.5, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_Configure.10, label %func_Configure.14
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_GetConfigFileContent.3, label %ctrl0

func_GetConfigFileContent.3:                      ; preds = %rand_bb
  %2 = call i8* @GetConfigFileContent.3(i8* %Filename)
  ret i8* %2

func_GetConfigFileContent.7:                      ; preds = %ctrl0
  %3 = call i8* @GetConfigFileContent.7(i8* %Filename)
  ret i8* %3

func_GetConfigFileContent.9:                      ; preds = %ctrl1
  %4 = call i8* @GetConfigFileContent.9(i8* %Filename)
  ret i8* %4

func_GetConfigFileContent.15:                     ; preds = %ctrl1
  %5 = call i8* @GetConfigFileContent.15(i8* %Filename)
  ret i8* %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_GetConfigFileContent.7, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_GetConfigFileContent.9, label %func_GetConfigFileContent.15
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_ParseContent.12, label %ctrl0

func_ParseContent.12:                             ; preds = %rand_bb
  call void @ParseContent.12(i8* %buf, i32 %bufsize)
  ret void

func_ParseContent.23:                             ; preds = %ctrl0
  call void @ParseContent.23(i8* %buf, i32 %bufsize)
  ret void

func_ParseContent.25:                             ; preds = %ctrl1
  call void @ParseContent.25(i8* %buf, i32 %bufsize)
  ret void

func_ParseContent.26:                             ; preds = %ctrl1
  call void @ParseContent.26(i8* %buf, i32 %bufsize)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_ParseContent.23, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_ParseContent.25, label %func_ParseContent.26
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_CeilLog2.17, label %ctrl0

func_CeilLog2.17:                                 ; preds = %rand_bb
  %2 = call i32 @CeilLog2.17(i32 %uiVal)
  ret i32 %2

func_CeilLog2.18:                                 ; preds = %ctrl0
  %3 = call i32 @CeilLog2.18(i32 %uiVal)
  ret i32 %3
...
func_CeilLog2.22:                                 ; preds = %ctrl1
  %5 = call i32 @CeilLog2.22(i32 %uiVal)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_CeilLog2.18, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_CeilLog2.21, label %func_CeilLog2.22
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_ParameterNameToMapIndex.1, label %ctrl0

func_ParameterNameToMapIndex.1:                   ; preds = %rand_bb
  %2 = call i32 @ParameterNameToMapIndex.1(i8* %s)
  ret i32 %2

func_ParameterNameToMapIndex.8:                   ; preds = %ctrl0
  %3 = call i32 @ParameterNameToMapIndex.8(i8* %s)
  ret i32 %3

func_ParameterNameToMapIndex.11:                  ; preds = %ctrl1
  %4 = call i32 @ParameterNameToMapIndex.11(i8* %s)
  ret i32 %4

func_ParameterNameToMapIndex.16:                  ; preds = %ctrl1
  %5 = call i32 @ParameterNameToMapIndex.16(i8* %s)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_ParameterNameToMapIndex.8, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_ParameterNameToMapIndex.11, label %func_ParameterNameToMapIndex.16
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_PatchInp.13, label %ctrl0

func_PatchInp.13:                                 ; preds = %rand_bb
  call void @PatchInp.13()
  ret void

func_PatchInp.19:                                 ; preds = %ctrl0
  call void @PatchInp.19()
  ret void

func_PatchInp.20:                                 ; preds = %ctrl1
  call void @PatchInp.20()
  ret void

func_PatchInp.24:                                 ; preds = %ctrl1
  call void @PatchInp.24()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_PatchInp.19, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_PatchInp.20, label %func_PatchInp.24
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_TestEncoderParams.2, label %func_TestEncoderParams.6

func_TestEncoderParams.2:                         ; preds = %rand_bb
  %2 = call i32 @TestEncoderParams.2(i32 %bitdepth_qp_scale)
  ret i32 %2

func_TestEncoderParams.6:                         ; preds = %rand_bb
  %3 = call i32 @TestEncoderParams.6(i32 %bitdepth_qp_scale)
  ret i32 %3
}
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @ParameterNameToMapIndex.1(i8* %s) #0 {
entry:
  %canary = alloca i32
  store i32 1051071286, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @TestEncoderParams.2(i32 %bitdepth_qp_scale) #0 {
entry:
  %canary = alloca i32
  store i32 486425412, i32* %canary
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i8* @GetConfigFileContent.3(i8* %Filename) #0 {
entry:
  %Filename.addr = alloca i8*, align 8
  %f = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 831250107, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Configure.4(i32 %ac, i8** %av) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 975024538, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Configure.5(i32 %ac, i8** %av) #0 {
entry:
  %content = alloca i8*, align 8
  %CLcount = alloca i32, align 4
  %ContentLen = alloca i32, align 4
  %canary = alloca i32
  store i32 1949781366, i32* %canary
  %destin = alloca i8*, align 8
  %av.addr = alloca i8**, align 8
  %filename = alloca i8*, align 8
  %ac.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @TestEncoderParams.6(i32 %bitdepth_qp_scale) #0 {
entry:
  %bitdepth_qp_scale.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 663947288, i32* %canary
  %i = alloca i32, align 4
  store i32 %bitdepth_qp_scale, i32* %bitdepth_qp_scale.addr, align 4
  store i32 0, i32* %i, align 4
  br label %while.cond
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i8* @GetConfigFileContent.7(i8* %Filename) #0 {
entry:
  %f = alloca %struct._IO_FILE*, align 8
  %retval = alloca i8*, align 8
  %buf = alloca i8*, align 8
  %canary = alloca i32
  store i32 896306912, i32* %canary
  %FileSize = alloca i64, align 8
  %Filename.addr = alloca i8*, align 8
  store i8* %Filename, i8** %Filename.addr, align 8
  %0 = load i8*, i8** %Filename.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @ParameterNameToMapIndex.8(i8* %s) #0 {
entry:
  %s.addr = alloca i8*, align 8
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 730456821, i32* %canary
  %i = alloca i32, align 4
  store i8* %s, i8** %s.addr, align 8
  store i32 0, i32* %i, align 4
  br label %while.cond
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i8* @GetConfigFileContent.9(i8* %Filename) #0 {
entry:
  %Filename.addr = alloca i8*, align 8
  %buf = alloca i8*, align 8
  %FileSize = alloca i64, align 8
  %canary = alloca i32
  store i32 817119499, i32* %canary
  %retval = alloca i8*, align 8
  %f = alloca %struct._IO_FILE*, align 8
  store i8* %Filename, i8** %Filename.addr, align 8
  %0 = load i8*, i8** %Filename.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Configure.10(i32 %ac, i8** %av) #0 {
entry:
  %content = alloca i8*, align 8
  %canary = alloca i32
  store i32 525437007, i32* %canary
  %ac.addr = alloca i32, align 4
  %destin = alloca i8*, align 8
  %av.addr = alloca i8**, align 8
  %CLcount = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @ParameterNameToMapIndex.11(i8* %s) #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1331636631, i32* %canary
  %s.addr = alloca i8*, align 8
  %retval = alloca i32, align 4
  store i8* %s, i8** %s.addr, align 8
  store i32 0, i32* %i, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @ParseContent.12(i8* %buf, i32 %bufsize) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 165720284, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 704931619, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Configure.14(i32 %ac, i8** %av) #0 {
entry:
  %CLcount = alloca i32, align 4
  %canary = alloca i32
  store i32 898740601, i32* %canary
  %ContentLen = alloca i32, align 4
  %filename = alloca i8*, align 8
  %av.addr = alloca i8**, align 8
  %ac.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i8* @GetConfigFileContent.15(i8* %Filename) #0 {
entry:
  %FileSize = alloca i64, align 8
  %f = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 1733434629, i32* %canary
  %Filename.addr = alloca i8*, align 8
  %buf = alloca i8*, align 8
  %retval = alloca i8*, align 8
  store i8* %Filename, i8** %Filename.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @ParameterNameToMapIndex.16(i8* %s) #0 {
entry:
  %retval = alloca i32, align 4
  %s.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1705669993, i32* %canary
  %i = alloca i32, align 4
  store i8* %s, i8** %s.addr, align 8
  store i32 0, i32* %i, align 4
  br label %while.cond
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @CeilLog2.17(i32 %uiVal) #0 {
entry:
  %canary = alloca i32
  store i32 1235009327, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @CeilLog2.18(i32 %uiVal) #0 {
entry:
  %canary = alloca i32
  store i32 1045735253, i32* %canary
  %uiRet = alloca i32, align 4
  %uiVal.addr = alloca i32, align 4
  %uiTmp = alloca i32, align 4
  store i32 %uiVal, i32* %uiVal.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @PatchInp.19() #0 {
entry:
  %sgfile = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 502538556, i32* %canary
  %mapunit_height = alloca i32, align 4
  %mb_width = alloca i32, align 4
  %frame_mb_only = alloca i32, align 4
  %mb_height = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @PatchInp.20() #0 {
entry:
  %mapunit_height = alloca i32, align 4
  %mb_height = alloca i32, align 4
  %bitdepth_qp_scale = alloca i32, align 4
  %storedBplus1 = alloca i32, align 4
  %canary = alloca i32
  store i32 941185972, i32* %canary
  %sgfile = alloca %struct._IO_FILE*, align 8
  %mb_width = alloca i32, align 4
  %frame_mb_only = alloca i32, align 4
  %tmp = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1636140694, i32* %canary
  %uiTmp = alloca i32, align 4
  %uiVal.addr = alloca i32, align 4
  %uiRet = alloca i32, align 4
  store i32 %uiVal, i32* %uiVal.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @CeilLog2.22(i32 %uiVal) #0 {
entry:
  %uiTmp = alloca i32, align 4
  %uiRet = alloca i32, align 4
  %canary = alloca i32
  store i32 228973230, i32* %canary
  %uiVal.addr = alloca i32, align 4
  store i32 %uiVal, i32* %uiVal.addr, align 4
  %0 = load i32, i32* %uiVal.addr, align 4
  %sub = sub i32 %0, 1
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @ParseContent.23(i8* %buf, i32 %bufsize) #0 {
entry:
  %p = alloca i8*, align 8
  %canary = alloca i32
  store i32 368421608, i32* %canary
  %bufsize.addr = alloca i32, align 4
  %IntContent = alloca i32, align 4
  %DoubleContent = alloca double, align 8
  %InString = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @PatchInp.24() #0 {
entry:
  %sgfile = alloca %struct._IO_FILE*, align 8
  %mb_height = alloca i32, align 4
  %bitdepth_qp_scale = alloca i32, align 4
  ...
  %frame_mb_only = alloca i32, align 4
  %canary = alloca i32
  store i32 2125270481, i32* %canary
  %tmp = alloca i32, align 4
  %mapunit_height = alloca i32, align 4
  %mb_width = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
if.end649:                                        ; preds = %if.then647, %land.lhs.true645, %if.end641
  ...
  call void @LevelCheck()
  %371 = load i32, i32* %canary
  %372 = icmp eq i32 %371, 2125270481
  br i1 %372, label %373, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @ParseContent.25(i8* %buf, i32 %bufsize) #0 {
entry:
  %p = alloca i8*, align 8
  %InItem = alloca i32, align 4
  %MapIdx = alloca i32, align 4
  ...
  %bufsize.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1863806074, i32* %canary
  %buf.addr = alloca i8*, align 8
  %InString = alloca i32, align 4
  %DoubleContent = alloca double, align 8
  %IntContent = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @ParseContent.26(i8* %buf, i32 %bufsize) #0 {
entry:
  %DoubleContent = alloca double, align 8
  %p = alloca i8*, align 8
  %items = alloca [10000 x i8*], align 16
  ...
  %item = alloca i32, align 4
  %canary = alloca i32
  store i32 245993976, i32* %canary
  %buf.addr = alloca i8*, align 8
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %bufsize, i32* %bufsize.addr, align 4
  store i32 0, i32* %item, align 4
