...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1395495366, -12(%rbp)  # imm = 0x532D91C6
	movslq	seedi, %rax
	cqto
...
.LBB2_3:                                # %if.end
	...
	cmpl	$1395495366, -12(%rbp)  # imm = 0x532D91C6
	jne	.LBB2_5
.LBB2_4:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1805660728, -16(%rbp)  # imm = 0x6BA03238
	movslq	seedi, %rax
	cqto
	movl	$127773, %ecx           # imm = 0x1F31D
	idivq	%rcx
...
.LBB3_3:                                # %if.end
	...
	vcvtsi2sdl	seedi, %xmm0, %xmm1
	vdivsd	%xmm0, %xmm1, %xmm0
	cmpl	$1805660728, -16(%rbp)  # imm = 0x6BA03238
	jne	.LBB3_5
.LBB3_4:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$525191821, -12(%rbp)   # imm = 0x1F4DCA8D
	movslq	seedi, %rax
	cqto
	movl	$127773, %ecx           # imm = 0x1F31D
	idivq	%rcx
...
.LBB4_3:                                # %if.end
	...
	vcvtsi2sdl	seedi, %xmm0, %xmm1
	vdivsd	%xmm0, %xmm1, %xmm0
	cmpl	$525191821, -12(%rbp)   # imm = 0x1F4DCA8D
	jne	.LBB4_5
.LBB4_4:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$2069744396, -12(%rbp)  # imm = 0x7B5DCB0C
	movslq	seedi, %rax
	cqto
	movl	$127773, %ecx           # imm = 0x1F31D
	idivq	%rcx
...
.LBB5_3:                                # %if.end
	...
	vcvtsi2sdl	seedi, %xmm0, %xmm1
	vdivsd	%xmm0, %xmm1, %xmm0
	cmpl	$2069744396, -12(%rbp)  # imm = 0x7B5DCB0C
	jne	.LBB5_5
.LBB5_4:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1852301148, -12(%rbp)  # imm = 0x6E67DF5C
	movslq	seedi, %rax
	cqto
	movl	$127773, %ecx           # imm = 0x1F31D
	idivq	%rcx
...
.LBB6_3:                                # %if.end
	...
	vcvtsi2sdl	seedi, %xmm0, %xmm1
	vdivsd	%xmm0, %xmm1, %xmm0
	cmpl	$1852301148, -12(%rbp)  # imm = 0x6E67DF5C
	jne	.LBB6_5
.LBB6_4:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1634252640, -16(%rbp)  # imm = 0x6168B760
	movslq	seedi, %rax
	cqto
	movl	$127773, %ecx           # imm = 0x1F31D
	idivq	%rcx
...
.LBB7_3:                                # %if.end
	...
	vcvtsi2sdl	seedi, %xmm0, %xmm1
	vdivsd	%xmm0, %xmm1, %xmm0
	cmpl	$1634252640, -16(%rbp)  # imm = 0x6168B760
	jne	.LBB7_5
.LBB7_4:
	addq	$32, %rsp
	popq	%rbp
