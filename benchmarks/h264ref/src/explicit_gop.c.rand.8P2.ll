; ModuleID = 'explicit_gop.c.rand.8P2.bc'
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_create_pyramid.12, label %ctrl0

func_create_pyramid.12:                           ; preds = %rand_bb
  call void @create_pyramid.12()
  ret void

func_create_pyramid.17:                           ; preds = %ctrl0
  call void @create_pyramid.17()
  ret void

func_create_pyramid.23:                           ; preds = %ctrl1
  call void @create_pyramid.23()
  ret void

func_create_pyramid.24:                           ; preds = %ctrl2
  call void @create_pyramid.24()
  ret void

func_create_pyramid.26:                           ; preds = %ctrl3
...
func_create_pyramid.32:                           ; preds = %ctrl5
  call void @create_pyramid.32()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_create_pyramid.17, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_create_pyramid.23, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_create_pyramid.24, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_create_pyramid.26, label %ctrl4
...
ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_create_pyramid.28, label %func_create_pyramid.32
}
...
func_gop_pyramid.6:                               ; preds = %ctrl1
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_gop_pyramid.6, label %ctrl2
...
func_interpret_gop_structure.7:                   ; preds = %ctrl1
  call void @interpret_gop_structure.7()
  ret void

func_interpret_gop_structure.8:                   ; preds = %ctrl2
  call void @interpret_gop_structure.8()
  ret void

func_interpret_gop_structure.16:                  ; preds = %ctrl3
  call void @interpret_gop_structure.16()
  ret void

func_interpret_gop_structure.18:                  ; preds = %ctrl4
  call void @interpret_gop_structure.18()
  ret void

func_interpret_gop_structure.21:                  ; preds = %ctrl5
  call void @interpret_gop_structure.21()
  ret void

func_interpret_gop_structure.22:                  ; preds = %ctrl5
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_interpret_gop_structure.7, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_interpret_gop_structure.8, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_interpret_gop_structure.16, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_interpret_gop_structure.18, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_interpret_gop_structure.21, label %func_interpret_gop_structure.22
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_poc_based_ref_management.5, label %ctrl0

func_poc_based_ref_management.5:                  ; preds = %rand_bb
  call void @poc_based_ref_management.5(i32 %current_pic_num)
  ret void

func_poc_based_ref_management.11:                 ; preds = %ctrl0
  call void @poc_based_ref_management.11(i32 %current_pic_num)
  ret void

func_poc_based_ref_management.19:                 ; preds = %ctrl1
  call void @poc_based_ref_management.19(i32 %current_pic_num)
  ret void

func_poc_based_ref_management.20:                 ; preds = %ctrl2
  call void @poc_based_ref_management.20(i32 %current_pic_num)
  ret void

func_poc_based_ref_management.25:                 ; preds = %ctrl3
  call void @poc_based_ref_management.25(i32 %current_pic_num)
  ret void

func_poc_based_ref_management.29:                 ; preds = %ctrl4
  call void @poc_based_ref_management.29(i32 %current_pic_num)
  ret void

func_poc_based_ref_management.30:                 ; preds = %ctrl5
  call void @poc_based_ref_management.30(i32 %current_pic_num)
  ret void

func_poc_based_ref_management.31:                 ; preds = %ctrl5
  call void @poc_based_ref_management.31(i32 %current_pic_num)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_poc_based_ref_management.11, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_poc_based_ref_management.19, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_poc_based_ref_management.20, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_poc_based_ref_management.25, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_poc_based_ref_management.29, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_poc_based_ref_management.30, label %func_poc_based_ref_management.31
}
...
entry:
  ...
  %canary = alloca i32
  store i32 1808601086, i32* %canary
...
entry:
  ...
  %pyramid_structure.addr = alloca %struct.GOP_DATA*, align 8
  %canary = alloca i32
  store i32 2019920706, i32* %canary
  %frames.addr = alloca i32, align 4
  store i32 %level, i32* %level.addr, align 4
  store i32 %frm_no, i32* %frm_no.addr, align 4
  store i32 %frames, i32* %frames.addr, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 1843815574, i32* %canary
...
entry:
  ...
  %order_read = alloca i32, align 4
  %canary = alloca i32
  store i32 600333457, i32* %canary
  %display_no = alloca i32, align 4
  %k = alloca i32, align 4
  %stored_read = alloca i32, align 4
  %qp = alloca i32, align 4
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 968696866, i32* %canary
...
entry:
  ...
  %frames.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 758615668, i32* %canary
  %pyramid_structure.addr = alloca %struct.GOP_DATA*, align 8
  store i32 %level, i32* %level.addr, align 4
  store i32 %frm_no, i32* %frm_no.addr, align 4
  store i32 %frames, i32* %frames.addr, align 4
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1530548735, i32* %canary
  %stored_read = alloca i32, align 4
  %k = alloca i32, align 4
  %nLength = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
entry:
  %canary = alloca i32
  store i32 393994830, i32* %canary
  %stored_read = alloca i32, align 4
  %k = alloca i32, align 4
  %display_no = alloca i32, align 4
  %coded_frame = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1504229190, i32* %canary
  %frm_no.addr = alloca i32, align 4
  %frames.addr = alloca i32, align 4
  %pyramid_structure.addr = alloca %struct.GOP_DATA*, align 8
  %level.addr = alloca i32, align 4
...
entry:
  ...
  %frm_no.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 888466274, i32* %canary
  %level.addr = alloca i32, align 4
  %frames.addr = alloca i32, align 4
  store i32 %level, i32* %level.addr, align 4
  store i32 %frm_no, i32* %frm_no.addr, align 4
...
entry:
  ...
  %current_pic_num.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1862724640, i32* %canary
  %i = alloca i32, align 4
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
  %tmp_drpm2 = alloca %struct.DecRefPicMarking_s*, align 8
  store i32 %current_pic_num, i32* %current_pic_num.addr, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 1715053079, i32* %canary
...
if.end200:                                        ; preds = %for.end199, %for.end
  ...
  %162 = icmp eq i32 %161, 1715053079
...
entry:
  %canary = alloca i32
  store i32 1006465388, i32* %canary
  %pyramid_structure.addr = alloca %struct.GOP_DATA*, align 8
  %level.addr = alloca i32, align 4
  %frm_no.addr = alloca i32, align 4
  %frames.addr = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1505315426, i32* %canary
  %level.addr = alloca i32, align 4
  %pyramid_structure.addr = alloca %struct.GOP_DATA*, align 8
  %frm_no.addr = alloca i32, align 4
  %frames.addr = alloca i32, align 4
...
entry:
  ...
  %pyramid_structure.addr = alloca %struct.GOP_DATA*, align 8
  %canary = alloca i32
  store i32 1796248525, i32* %canary
  %frames.addr = alloca i32, align 4
  %level.addr = alloca i32, align 4
  store i32 %level, i32* %level.addr, align 4
  store i32 %frm_no, i32* %frm_no.addr, align 4
...
entry:
  ...
  %k = alloca i32, align 4
  %canary = alloca i32
  store i32 479111337, i32* %canary
  %qp_read = alloca i32, align 4
  %i = alloca i32, align 4
  %coded_frame = alloca i32, align 4
  %stored_read = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @create_pyramid.17() #0 {
entry:
  %levelrefs = alloca i32, align 4
  %tempnum = alloca i32, align 4
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 980861958, i32* %canary
  %curGOPLevelfrm = alloca i32*, align 8
  %GOPlevels = alloca i32, align 4
  %i = alloca i32, align 4
  %centerB = alloca i32, align 4
...
entry:
  ...
  %stored_read = alloca i32, align 4
  %canary = alloca i32
  store i32 2086721808, i32* %canary
  %coded_frame = alloca i32, align 4
  %qp_read = alloca i32, align 4
  %order_read = alloca i32, align 4
  %qp = alloca i32, align 4
...
entry:
  ...
  %pic_num = alloca i32, align 4
  %canary = alloca i32
  store i32 1329008677, i32* %canary
  %current_pic_num.addr = alloca i32, align 4
  %i = alloca i32, align 4
  store i32 %current_pic_num, i32* %current_pic_num.addr, align 4
  store i32 0, i32* %pic_num, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @interpret_gop_structure.21() #0 {
entry:
  %stored_read = alloca i32, align 4
  %coded_frame = alloca i32, align 4
  %display_no = alloca i32, align 4
  ...
  %slice_read = alloca i32, align 4
  %canary = alloca i32
  store i32 141262687, i32* %canary
  %qp = alloca i32, align 4
  %nLength = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %ExplicitPyramidFormat = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 56
...
entry:
  ...
  %display_no = alloca i32, align 4
  %canary = alloca i32
  store i32 1984214756, i32* %canary
  %order_read = alloca i32, align 4
  %slice_read = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %ExplicitPyramidFormat = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 56
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 979520510, i32* %canary
  %Bframes = alloca i32, align 4
  %j = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %successive_Bframe = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 34
...
entry:
  ...
  %prvlevelrefs = alloca i32, align 4
  %canary = alloca i32
  store i32 951539641, i32* %canary
  %GOPlevels = alloca i32, align 4
  %j = alloca i32, align 4
  %tempnum = alloca i32, align 4
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @poc_based_ref_management.25(i32 %current_pic_num) #0 {
entry:
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
  %pic_num = alloca i32, align 4
  %canary = alloca i32
  store i32 1795125052, i32* %canary
  %min_poc = alloca i32, align 4
  %tmp_drpm2 = alloca %struct.DecRefPicMarking_s*, align 8
  %current_pic_num.addr = alloca i32, align 4
  %i = alloca i32, align 4
...
entry:
  ...
  %centerB = alloca i32, align 4
  %canary = alloca i32
  store i32 279224604, i32* %canary
  %GOPlevels = alloca i32, align 4
  %levelrefs = alloca i32, align 4
  %j = alloca i32, align 4
  %i = alloca i32, align 4
...
entry:
  ...
  %GOPlevels = alloca i32, align 4
  %canary = alloca i32
  store i32 1418064645, i32* %canary
  %tempnum = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %successive_Bframe = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 34
  %1 = load i32, i32* %successive_Bframe, align 4
...
if.end200:                                        ; preds = %for.end199, %for.end
  %161 = load i32, i32* %canary
  %162 = icmp eq i32 %161, 1418064645
  br i1 %162, label %163, label %func_exit
...
entry:
  %Bframes = alloca i32, align 4
  %canary = alloca i32
  store i32 745990275, i32* %canary
  %levelrefs = alloca i32, align 4
  %curGOPLeveldist = alloca i32*, align 8
  %i = alloca i32, align 4
  %centerB = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @poc_based_ref_management.29(i32 %current_pic_num) #0 {
entry:
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
  %canary = alloca i32
  store i32 2114229379, i32* %canary
  %i = alloca i32, align 4
  %current_pic_num.addr = alloca i32, align 4
  %tmp_drpm2 = alloca %struct.DecRefPicMarking_s*, align 8
  %min_poc = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @poc_based_ref_management.30(i32 %current_pic_num) #0 {
entry:
  %tmp_drpm2 = alloca %struct.DecRefPicMarking_s*, align 8
  %min_poc = alloca i32, align 4
  %canary = alloca i32
  store i32 1575469144, i32* %canary
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
  %pic_num = alloca i32, align 4
  %i = alloca i32, align 4
  %current_pic_num.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @poc_based_ref_management.31(i32 %current_pic_num) #0 {
entry:
  %min_poc = alloca i32, align 4
  %canary = alloca i32
  store i32 1631786808, i32* %canary
  %tmp_drpm2 = alloca %struct.DecRefPicMarking_s*, align 8
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
  %i = alloca i32, align 4
  %pic_num = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @create_pyramid.32() #0 {
entry:
  %i = alloca i32, align 4
  %levelrefs = alloca i32, align 4
  %canary = alloca i32
  store i32 1842898359, i32* %canary
  %j = alloca i32, align 4
  %i28 = alloca i32, align 4
  %tempnum = alloca i32, align 4
  %curlevel = alloca i32, align 4
...
if.end200:                                        ; preds = %for.end199, %for.end
  %161 = load i32, i32* %canary
  %162 = icmp eq i32 %161, 1842898359
  br i1 %162, label %163, label %func_exit
