...
func_WriteRTPPacket.4:                            ; preds = %ctrl1
  %4 = call i32 @WriteRTPPacket.4(%struct.RTPpacket_t* %p, %struct._IO_FILE* %f)
  ret i32 %4

func_WriteRTPPacket.5:                            ; preds = %ctrl1
  %5 = call i32 @WriteRTPPacket.5(%struct.RTPpacket_t* %p, %struct._IO_FILE* %f)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_WriteRTPPacket.2, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_WriteRTPPacket.4, label %func_WriteRTPPacket.5
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_WriteRTPNALU.7, label %func_WriteRTPNALU.8

func_WriteRTPNALU.7:                              ; preds = %rand_bb
  %2 = call i32 @WriteRTPNALU.7(%struct.NALU_t* %n)
  ret i32 %2
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_RTPUpdateTimestamp.3, label %func_RTPUpdateTimestamp.6
...
entry:
  %p.addr = alloca %struct.RTPpacket_t*, align 8
  %canary = alloca i32
  store i32 320734592, i32* %canary
...
entry:
  %intime = alloca i32, align 4
  %canary = alloca i32
  store i32 690686636, i32* %canary
  %retval = alloca i32, align 4
  %p.addr = alloca %struct.RTPpacket_t*, align 8
  %f.addr = alloca %struct._IO_FILE*, align 8
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
...
entry:
  ...
  %canary = alloca i32
  store i32 1391609726, i32* %canary
...
entry:
  %f.addr = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 349348133, i32* %canary
  %p.addr = alloca %struct.RTPpacket_t*, align 8
  %intime = alloca i32, align 4
  %retval = alloca i32, align 4
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1834875317, i32* %canary
  %retval = alloca i32, align 4
  %intime = alloca i32, align 4
  %p.addr = alloca %struct.RTPpacket_t*, align 8
  %f.addr = alloca %struct._IO_FILE*, align 8
...
entry:
  %canary = alloca i32
  store i32 1604376418, i32* %canary
  %tr.addr = alloca i32, align 4
  %delta = alloca i32, align 4
  store i32 %tr, i32* %tr.addr, align 4
  %0 = load i32, i32* @RTPUpdateTimestamp.oldtr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @WriteRTPNALU.7(%struct.NALU_t* %n) #0 {
entry:
  %n.addr = alloca %struct.NALU_t*, align 8
  %canary = alloca i32
  store i32 736094597, i32* %canary
...
entry:
  %p = alloca %struct.RTPpacket_t*, align 8
  %canary = alloca i32
  store i32 484951988, i32* %canary
  %n.addr = alloca %struct.NALU_t*, align 8
  store %struct.NALU_t* %n, %struct.NALU_t** %n.addr, align 8
  %0 = load %struct.NALU_t*, %struct.NALU_t** %n.addr, align 8
  %forbidden_bit = getelementptr inbounds %struct.NALU_t, %struct.NALU_t* %0, i32 0, i32 5
