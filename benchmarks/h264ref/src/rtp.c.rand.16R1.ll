...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_RTPUpdateTimestamp.5, label %func_RTPUpdateTimestamp.6
...
entry:
  %canary = alloca i32
  store i32 436357059, i32* %canary
...
entry:
  %n.addr = alloca %struct.NALU_t*, align 8
  %canary = alloca i32
  store i32 1809228121, i32* %canary
  %p = alloca %struct.RTPpacket_t*, align 8
  store %struct.NALU_t* %n, %struct.NALU_t** %n.addr, align 8
  %0 = load %struct.NALU_t*, %struct.NALU_t** %n.addr, align 8
  %forbidden_bit = getelementptr inbounds %struct.NALU_t, %struct.NALU_t* %0, i32 0, i32 5
...
entry:
  ...
  %p.addr = alloca %struct.RTPpacket_t*, align 8
  %canary = alloca i32
  store i32 858669767, i32* %canary
...
entry:
  ...
  %f.addr = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 793334917, i32* %canary
  %intime = alloca i32, align 4
  %retval = alloca i32, align 4
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
...
entry:
  ...
  %canary = alloca i32
  store i32 1469871403, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 646319045, i32* %canary
  %delta = alloca i32, align 4
  %tr.addr = alloca i32, align 4
  store i32 %tr, i32* %tr.addr, align 4
  %0 = load i32, i32* @RTPUpdateTimestamp.oldtr, align 4
...
entry:
  ...
  %intime = alloca i32, align 4
  %canary = alloca i32
  store i32 1450340686, i32* %canary
  %f.addr = alloca %struct._IO_FILE*, align 8
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
  store i32 -1, i32* %intime, align 4
...
entry:
  ...
  %p.addr = alloca %struct.RTPpacket_t*, align 8
  %canary = alloca i32
  store i32 1291827812, i32* %canary
  %retval = alloca i32, align 4
  %intime = alloca i32, align 4
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 426954900, i32* %canary
  %intime = alloca i32, align 4
  %p.addr = alloca %struct.RTPpacket_t*, align 8
  %retval = alloca i32, align 4
  %f.addr = alloca %struct._IO_FILE*, align 8
...
entry:
  ...
  %f.addr = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 407389190, i32* %canary
  %retval = alloca i32, align 4
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
  store i32 -1, i32* %intime, align 4
...
entry:
  %canary = alloca i32
  store i32 1327012854, i32* %canary
  %retval = alloca i32, align 4
  %f.addr = alloca %struct._IO_FILE*, align 8
  %p.addr = alloca %struct.RTPpacket_t*, align 8
  %intime = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1272907960, i32* %canary
  %f.addr = alloca %struct._IO_FILE*, align 8
  %intime = alloca i32, align 4
  %retval = alloca i32, align 4
  %p.addr = alloca %struct.RTPpacket_t*, align 8
...
entry:
  %canary = alloca i32
  store i32 1848762971, i32* %canary
  %f.addr = alloca %struct._IO_FILE*, align 8
  %retval = alloca i32, align 4
  %p.addr = alloca %struct.RTPpacket_t*, align 8
  %intime = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 160207980, i32* %canary
  %f.addr = alloca %struct._IO_FILE*, align 8
  %retval = alloca i32, align 4
  %intime = alloca i32, align 4
  %p.addr = alloca %struct.RTPpacket_t*, align 8
...
entry:
  %intime = alloca i32, align 4
  %canary = alloca i32
  store i32 1750496869, i32* %canary
  %retval = alloca i32, align 4
  %f.addr = alloca %struct._IO_FILE*, align 8
  %p.addr = alloca %struct.RTPpacket_t*, align 8
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1013440822, i32* %canary
  %f.addr = alloca %struct._IO_FILE*, align 8
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
  store i32 -1, i32* %intime, align 4
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1934059107, i32* %canary
  %intime = alloca i32, align 4
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
  store i32 -1, i32* %intime, align 4
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1587716067, i32* %canary
  %intime = alloca i32, align 4
  %f.addr = alloca %struct._IO_FILE*, align 8
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
...
entry:
  ...
  %intime = alloca i32, align 4
  %canary = alloca i32
  store i32 812624965, i32* %canary
  %p.addr = alloca %struct.RTPpacket_t*, align 8
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
  store i32 -1, i32* %intime, align 4
...
entry:
  ...
  %p.addr = alloca %struct.RTPpacket_t*, align 8
  %canary = alloca i32
  store i32 849708267, i32* %canary
  %f.addr = alloca %struct._IO_FILE*, align 8
  %intime = alloca i32, align 4
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
