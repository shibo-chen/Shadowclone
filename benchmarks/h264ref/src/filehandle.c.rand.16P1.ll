; ModuleID = 'filehandle.c.rand.16P1.bc'
...
func_write_PPS.15:                                ; preds = %ctrl3
  %7 = call i32 @write_PPS.15(i32 %len, i32 %PPS_id)
  ret i32 %7
...
ctrl3:                                            ; preds = %ctrl2
  %11 = icmp eq i32 %0, 4
  br i1 %11, label %func_write_PPS.9, label %func_write_PPS.15
}
...
func_start_sequence.10:                           ; preds = %ctrl1
  %4 = call i32 @start_sequence.10()
  ret i32 %4

func_start_sequence.11:                           ; preds = %ctrl2
  %5 = call i32 @start_sequence.11()
  ret i32 %5

func_start_sequence.12:                           ; preds = %ctrl3
  %6 = call i32 @start_sequence.12()
  ret i32 %6

func_start_sequence.13:                           ; preds = %ctrl4
  %7 = call i32 @start_sequence.13()
  ret i32 %7
...
ctrl0:                                            ; preds = %rand_bb
  %18 = icmp eq i32 %0, 1
  br i1 %18, label %func_start_sequence.5, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %19 = icmp eq i32 %0, 2
  br i1 %19, label %func_start_sequence.10, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %20 = icmp eq i32 %0, 3
  br i1 %20, label %func_start_sequence.11, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %21 = icmp eq i32 %0, 4
  br i1 %21, label %func_start_sequence.12, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %22 = icmp eq i32 %0, 5
  br i1 %22, label %func_start_sequence.13, label %ctrl5
...
entry:
  ...
  %canary = alloca i32
  store i32 1418489230, i32* %canary
...
entry:
  %code.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2060759151, i32* %canary
  %text.addr = alloca i8*, align 8
  store i8* %text, i8** %text.addr, align 8
  store i32 %code, i32* %code.addr, align 4
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
...
entry:
  %canary = alloca i32
  store i32 1311786341, i32* %canary
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 2139792735, i32* %canary
  %nalu = alloca %struct.NALU_t*, align 8
...
entry:
  ...
  %len = alloca i32, align 4
  %canary = alloca i32
  store i32 1337886194, i32* %canary
  %retval = alloca i32, align 4
  store i32 0, i32* %len, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %GenerateMultiplePPS = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 15
...
entry:
  %len.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1847945236, i32* %canary
  %nalu = alloca %struct.NALU_t*, align 8
  %PPS_id.addr = alloca i32, align 4
  store i32 %len, i32* %len.addr, align 4
  store i32 %PPS_id, i32* %PPS_id.addr, align 4
...
entry:
  %len.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1305298964, i32* %canary
  %PPS_id.addr = alloca i32, align 4
  %nalu = alloca %struct.NALU_t*, align 8
  store i32 %len, i32* %len.addr, align 4
  store i32 %PPS_id, i32* %PPS_id.addr, align 4
...
entry:
  %nalu = alloca %struct.NALU_t*, align 8
  %canary = alloca i32
  store i32 222897737, i32* %canary
  %PPS_id.addr = alloca i32, align 4
  %len.addr = alloca i32, align 4
  store i32 %len, i32* %len.addr, align 4
  store i32 %PPS_id, i32* %PPS_id.addr, align 4
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 573565877, i32* %canary
  %len = alloca i32, align 4
  %i = alloca i32, align 4
  %nalu = alloca %struct.NALU_t*, align 8
  store i32 0, i32* %len, align 4
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1856373609, i32* %canary
  %len = alloca i32, align 4
  %total_pps = alloca i32, align 4
  %nalu = alloca %struct.NALU_t*, align 8
  store i32 0, i32* %len, align 4
...
entry:
  ...
  %len = alloca i32, align 4
  %canary = alloca i32
  store i32 455483497, i32* %canary
  %nalu = alloca %struct.NALU_t*, align 8
  store i32 0, i32* %len, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %GenerateMultiplePPS = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 15
...
entry:
  %nalu = alloca %struct.NALU_t*, align 8
  %canary = alloca i32
  store i32 1419969857, i32* %canary
  %i = alloca i32, align 4
  %retval = alloca i32, align 4
  %len = alloca i32, align 4
  %total_pps = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1485585357, i32* %canary
  %len = alloca i32, align 4
  %retval = alloca i32, align 4
  %nalu = alloca %struct.NALU_t*, align 8
  %total_pps = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @write_PPS.15(i32 %len, i32 %PPS_id) #0 {
entry:
  %PPS_id.addr = alloca i32, align 4
  %nalu = alloca %struct.NALU_t*, align 8
  %canary = alloca i32
  store i32 985607028, i32* %canary
  %len.addr = alloca i32, align 4
  store i32 %len, i32* %len.addr, align 4
  store i32 %PPS_id, i32* %PPS_id.addr, align 4
  store %struct.NALU_t* null, %struct.NALU_t** %nalu, align 8
...
entry:
  ...
  %nalu = alloca %struct.NALU_t*, align 8
  %canary = alloca i32
  store i32 1444123270, i32* %canary
  %len = alloca i32, align 4
  store i32 0, i32* %len, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %GenerateMultiplePPS = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 15
...
entry:
  ...
  %total_pps = alloca i32, align 4
  %canary = alloca i32
  store i32 1677843509, i32* %canary
  %len = alloca i32, align 4
  store i32 0, i32* %len, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %GenerateMultiplePPS = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 15
...
entry:
  ...
  %total_pps = alloca i32, align 4
  %canary = alloca i32
  store i32 1961688050, i32* %canary
  %retval = alloca i32, align 4
  %nalu = alloca %struct.NALU_t*, align 8
  store i32 0, i32* %len, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
entry:
  %canary = alloca i32
  store i32 763164448, i32* %canary
  %nalu = alloca %struct.NALU_t*, align 8
  %retval = alloca i32, align 4
  %len = alloca i32, align 4
  %total_pps = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 661242197, i32* %canary
  %len = alloca i32, align 4
  %nalu = alloca %struct.NALU_t*, align 8
  %i = alloca i32, align 4
  %retval = alloca i32, align 4
...
entry:
  ...
  %len = alloca i32, align 4
  %canary = alloca i32
  store i32 1618453869, i32* %canary
  %total_pps = alloca i32, align 4
  %i = alloca i32, align 4
  store i32 0, i32* %len, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
entry:
  ...
  %len = alloca i32, align 4
  %canary = alloca i32
  store i32 956536473, i32* %canary
  %retval = alloca i32, align 4
  %nalu = alloca %struct.NALU_t*, align 8
  store i32 0, i32* %len, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
entry:
  ...
  %len = alloca i32, align 4
  %canary = alloca i32
  store i32 914134730, i32* %canary
  %retval = alloca i32, align 4
  %i = alloca i32, align 4
  store i32 0, i32* %len, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
entry:
  %len = alloca i32, align 4
  %canary = alloca i32
  store i32 446104741, i32* %canary
  %total_pps = alloca i32, align 4
  %nalu = alloca %struct.NALU_t*, align 8
  %retval = alloca i32, align 4
  %i = alloca i32, align 4
