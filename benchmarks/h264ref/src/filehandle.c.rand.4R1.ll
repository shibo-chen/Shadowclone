; ModuleID = 'filehandle.c.rand.4R1.bc'
...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_error.5, label %func_error.8

func_error.5:                                     ; preds = %rand_bb
  call void @error.5(i8* %text, i32 %code)
  ret void

func_error.8:                                     ; preds = %rand_bb
  call void @error.8(i8* %text, i32 %code)
  ret void
}
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_write_PPS.3, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_write_PPS.4, label %func_write_PPS.7
}
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_start_sequence.6, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_start_sequence.9, label %func_start_sequence.10
}
...
entry:
  ...
  %canary = alloca i32
  store i32 190210611, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1601816244, i32* %canary
  %nalu = alloca %struct.NALU_t*, align 8
...
entry:
  %len.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1795519946, i32* %canary
  %PPS_id.addr = alloca i32, align 4
  %nalu = alloca %struct.NALU_t*, align 8
  store i32 %len, i32* %len.addr, align 4
  store i32 %PPS_id, i32* %PPS_id.addr, align 4
...
entry:
  %PPS_id.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 854474655, i32* %canary
  %nalu = alloca %struct.NALU_t*, align 8
  %len.addr = alloca i32, align 4
  store i32 %len, i32* %len.addr, align 4
  store i32 %PPS_id, i32* %PPS_id.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 197422185, i32* %canary
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 2067121747, i32* %canary
  %i = alloca i32, align 4
  %nalu = alloca %struct.NALU_t*, align 8
  store i32 0, i32* %len, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
entry:
  %canary = alloca i32
  store i32 662408674, i32* %canary
  %nalu = alloca %struct.NALU_t*, align 8
  %len.addr = alloca i32, align 4
  %PPS_id.addr = alloca i32, align 4
  store i32 %len, i32* %len.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @error.8(i8* %text, i32 %code) #0 {
entry:
  %text.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 457261003, i32* %canary
  %code.addr = alloca i32, align 4
  store i8* %text, i8** %text.addr, align 8
  store i32 %code, i32* %code.addr, align 4
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
...
entry:
  %canary = alloca i32
  store i32 974758886, i32* %canary
  %retval = alloca i32, align 4
  %i = alloca i32, align 4
  %len = alloca i32, align 4
  %nalu = alloca %struct.NALU_t*, align 8
...
entry:
  ...
  %total_pps = alloca i32, align 4
  %canary = alloca i32
  store i32 1071707448, i32* %canary
  %i = alloca i32, align 4
  %len = alloca i32, align 4
  store i32 0, i32* %len, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
