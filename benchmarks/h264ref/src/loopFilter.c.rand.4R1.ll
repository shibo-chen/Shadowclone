; ModuleID = 'loopFilter.c.rand.4R1.bc'
...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_DeblockFrame.9, label %ctrl0

func_DeblockFrame.9:                              ; preds = %rand_bb
  call void @DeblockFrame.9(%struct.ImageParameters* %img, i16** %imgY, i16*** %imgUV)
  ret void
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_DeblockFrame.13, label %func_DeblockFrame.14
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_DeblockMb.8, label %ctrl0

func_DeblockMb.8:                                 ; preds = %rand_bb
  call void @DeblockMb.8(%struct.ImageParameters* %img, i16** %imgY, i16*** %imgUV, i32 %MbQAddr)
  ret void

func_DeblockMb.11:                                ; preds = %ctrl0
...
func_DeblockMb.16:                                ; preds = %ctrl1
  call void @DeblockMb.16(%struct.ImageParameters* %img, i16** %imgY, i16*** %imgUV, i32 %MbQAddr)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_DeblockMb.11, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_DeblockMb.15, label %func_DeblockMb.16
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_GetStrength.2, label %ctrl0

func_GetStrength.2:                               ; preds = %rand_bb
  call void @GetStrength.2(i8* %Strength, %struct.ImageParameters* %img, i32 %MbQAddr, i32 %dir, i32 %edge, i32 %mvlimit)
  ret void

func_GetStrength.3:                               ; preds = %ctrl0
  call void @GetStrength.3(i8* %Strength, %struct.ImageParameters* %img, i32 %MbQAddr, i32 %dir, i32 %edge, i32 %mvlimit)
  ret void

func_GetStrength.4:                               ; preds = %ctrl1
  call void @GetStrength.4(i8* %Strength, %struct.ImageParameters* %img, i32 %MbQAddr, i32 %dir, i32 %edge, i32 %mvlimit)
  ret void

func_GetStrength.6:                               ; preds = %ctrl1
  call void @GetStrength.6(i8* %Strength, %struct.ImageParameters* %img, i32 %MbQAddr, i32 %dir, i32 %edge, i32 %mvlimit)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_GetStrength.3, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_GetStrength.4, label %func_GetStrength.6
}
...
func_EdgeLoop.7:                                  ; preds = %ctrl1
  call void @EdgeLoop.7(i16** %Img, i8* %Strength, %struct.ImageParameters* %img, i32 %MbQAddr, i32 %AlphaC0Offset, i32 %BetaOffset, i32 %dir, i32 %edge, i32 %width, i32 %yuv, i32 %uv)
  ret void

func_EdgeLoop.10:                                 ; preds = %ctrl1
  call void @EdgeLoop.10(i16** %Img, i8* %Strength, %struct.ImageParameters* %img, i32 %MbQAddr, i32 %AlphaC0Offset, i32 %BetaOffset, i32 %dir, i32 %edge, i32 %width, i32 %yuv, i32 %uv)
  ret void
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_EdgeLoop.7, label %func_EdgeLoop.10
}
...
entry:
  ...
  %canary = alloca i32
  store i32 1980032224, i32* %canary
...
for.end:                                          ; preds = %for.cond
  ...
  %348 = icmp eq i32 %347, 1980032224
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @GetStrength.2(i8* %Strength, %struct.ImageParameters* %img, i32 %MbQAddr, i32 %dir, i32 %edge, i32 %mvlimit) #0 {
entry:
  ...
  %pixP = alloca %struct.pix_pos, align 4
  %canary = alloca i32
  store i32 521915576, i32* %canary
  %dir.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @GetStrength.3(i8* %Strength, %struct.ImageParameters* %img, i32 %MbQAddr, i32 %dir, i32 %edge, i32 %mvlimit) #0 {
entry:
  %ref_p1 = alloca i64, align 8
  %blkQ = alloca i32, align 4
  %mvlimit.addr = alloca i32, align 4
  ...
  %idx = alloca i32, align 4
  %canary = alloca i32
  store i32 186586484, i32* %canary
  %list1_mv = alloca i16***, align 8
  %dir.addr = alloca i32, align 4
  %ref_q1 = alloca i64, align 8
  %edge.addr = alloca i32, align 4
...
entry:
  ...
  %ref_p1 = alloca i64, align 8
  %canary = alloca i32
  store i32 1775822345, i32* %canary
  %list1_refIdxArr = alloca i16**, align 8
  %edge.addr = alloca i32, align 4
  store i8* %Strength, i8** %Strength.addr, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
...
for.end:                                          ; preds = %for.cond
  %393 = load i32, i32* %canary
  %394 = icmp eq i32 %393, 1775822345
  br i1 %394, label %395, label %func_exit
...
entry:
  ...
  %StrengthIdx = alloca i32, align 4
  %canary = alloca i32
  store i32 1888972138, i32* %canary
  %dif = alloca i32, align 4
  %Strength.addr = alloca i8*, align 8
  %L0 = alloca i32, align 4
  %c0 = alloca i32, align 4
...
for.end:                                          ; preds = %for.cond
  %347 = load i32, i32* %canary
  %348 = icmp eq i32 %347, 1888972138
  br i1 %348, label %349, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @GetStrength.6(i8* %Strength, %struct.ImageParameters* %img, i32 %MbQAddr, i32 %dir, i32 %edge, i32 %mvlimit) #0 {
entry:
  %blk_y2 = alloca i32, align 4
  %MbQ = alloca %struct.macroblock*, align 8
  %xP = alloca i32, align 4
  ...
  %yP = alloca i32, align 4
  %canary = alloca i32
  store i32 833566796, i32* %canary
  %blk_x2 = alloca i32, align 4
  %mb_x = alloca i32, align 4
  %edge.addr = alloca i32, align 4
  %ref_p1 = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @EdgeLoop.7(i16** %Img, i8* %Strength, %struct.ImageParameters* %img, i32 %MbQAddr, i32 %AlphaC0Offset, i32 %BetaOffset, i32 %dir, i32 %edge, i32 %width, i32 %yuv, i32 %uv) #0 {
entry:
  %dir.addr = alloca i32, align 4
  %SrcPtrQ = alloca i16*, align 8
  %edge.addr = alloca i32, align 4
  ...
  %MbP = alloca %struct.macroblock*, align 8
  %canary = alloca i32
  store i32 111161551, i32* %canary
  %L1 = alloca i32, align 4
  %L2 = alloca i32, align 4
  %yP = alloca i32, align 4
  %Alpha = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @DeblockMb.8(%struct.ImageParameters* %img, i16** %imgY, i16*** %imgUV, i32 %MbQAddr) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 1781235373, i32* %canary
...
return:                                           ; preds = %for.end152, %if.then25
  ...
  %161 = icmp eq i32 %160, 1781235373
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @DeblockFrame.9(%struct.ImageParameters* %img, i16** %imgY, i16*** %imgUV) #0 {
entry:
  %canary = alloca i32
  store i32 616699375, i32* %canary
  %i = alloca i32, align 4
  %img.addr = alloca %struct.ImageParameters*, align 8
  %imgUV.addr = alloca i16***, align 8
  %imgY.addr = alloca i16**, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @EdgeLoop.10(i16** %Img, i8* %Strength, %struct.ImageParameters* %img, i32 %MbQAddr, i32 %AlphaC0Offset, i32 %BetaOffset, i32 %dir, i32 %edge, i32 %width, i32 %yuv, i32 %uv) #0 {
entry:
  %indexB = alloca i32, align 4
  %pixP = alloca %struct.pix_pos, align 4
  %MbP = alloca %struct.macroblock*, align 8
  ...
  %Strng = alloca i32, align 4
  %canary = alloca i32
  store i32 2068193113, i32* %canary
  %pel = alloca i32, align 4
  %c0 = alloca i32, align 4
  %Alpha = alloca i32, align 4
  %dif = alloca i32, align 4
...
for.end:                                          ; preds = %for.cond
  %347 = load i32, i32* %canary
  %348 = icmp eq i32 %347, 2068193113
  br i1 %348, label %349, label %func_exit
...
entry:
  ...
  %mvlimit = alloca i32, align 4
  %canary = alloca i32
  store i32 582205012, i32* %canary
  %imgY.addr = alloca i16**, align 8
  %imgUV.addr = alloca i16***, align 8
  %img.addr = alloca %struct.ImageParameters*, align 8
  %filterNon8x8LumaEdgesFlag = alloca [4 x i32], align 16
...
entry:
  ...
  %imgY.addr = alloca i16**, align 8
  %canary = alloca i32
  store i32 400398413, i32* %canary
  %imgUV.addr = alloca i16***, align 8
  %i = alloca i32, align 4
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store i16** %imgY, i16*** %imgY.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 363434419, i32* %canary
  %imgUV.addr = alloca i16***, align 8
  %img.addr = alloca %struct.ImageParameters*, align 8
  %imgY.addr = alloca i16**, align 8
  %i = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 562734294, i32* %canary
  %i = alloca i32, align 4
  %imgUV.addr = alloca i16***, align 8
  %imgY.addr = alloca i16**, align 8
  %img.addr = alloca %struct.ImageParameters*, align 8
...
entry:
  ...
  %MbQ = alloca %struct.macroblock*, align 8
  %canary = alloca i32
  store i32 1682938227, i32* %canary
  %fieldModeMbFlag = alloca i32, align 4
  %dir = alloca i32, align 4
  %img.addr = alloca %struct.ImageParameters*, align 8
  %EdgeCondition = alloca i32, align 4
...
return:                                           ; preds = %for.end152, %if.then25
  %160 = load i32, i32* %canary
  %161 = icmp eq i32 %160, 1682938227
  br i1 %161, label %162, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @DeblockMb.16(%struct.ImageParameters* %img, i16** %imgY, i16*** %imgUV, i32 %MbQAddr) #0 {
entry:
  %Strength = alloca [16 x i8], align 16
  %dir = alloca i32, align 4
  %EdgeCondition = alloca i32, align 4
  ...
  %MbQ = alloca %struct.macroblock*, align 8
  %canary = alloca i32
  store i32 841368526, i32* %canary
  %fieldModeMbFlag = alloca i32, align 4
  %filterNon8x8LumaEdgesFlag = alloca [4 x i32], align 16
  %filterLeftMbEdgeFlag = alloca i32, align 4
  %i = alloca i32, align 4
