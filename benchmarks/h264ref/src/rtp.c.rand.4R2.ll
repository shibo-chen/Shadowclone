...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_WriteRTPPacket.3, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_WriteRTPPacket.7, label %func_WriteRTPPacket.8
}
...
entry:
  %canary = alloca i32
  store i32 1612158483, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 995772550, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1346487685, i32* %canary
  %p.addr = alloca %struct.RTPpacket_t*, align 8
  %intime = alloca i32, align 4
  %retval = alloca i32, align 4
  %f.addr = alloca %struct._IO_FILE*, align 8
...
entry:
  %p = alloca %struct.RTPpacket_t*, align 8
  %canary = alloca i32
  store i32 1169863441, i32* %canary
  %n.addr = alloca %struct.NALU_t*, align 8
  store %struct.NALU_t* %n, %struct.NALU_t** %n.addr, align 8
  %0 = load %struct.NALU_t*, %struct.NALU_t** %n.addr, align 8
  %forbidden_bit = getelementptr inbounds %struct.NALU_t, %struct.NALU_t* %0, i32 0, i32 5
...
entry:
  ...
  %canary = alloca i32
  store i32 738582327, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1452592742, i32* %canary
  %tr.addr = alloca i32, align 4
  %delta = alloca i32, align 4
  store i32 %tr, i32* %tr.addr, align 4
  %0 = load i32, i32* @RTPUpdateTimestamp.oldtr, align 4
...
entry:
  ...
  %p.addr = alloca %struct.RTPpacket_t*, align 8
  %canary = alloca i32
  store i32 1913557206, i32* %canary
  %f.addr = alloca %struct._IO_FILE*, align 8
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
  store i32 -1, i32* %intime, align 4
