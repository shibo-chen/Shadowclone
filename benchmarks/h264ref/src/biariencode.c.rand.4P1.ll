; ModuleID = 'biariencode.c.rand.4P1.bc'
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_arienco_start_encoding.16, label %ctrl0

func_arienco_start_encoding.16:                   ; preds = %rand_bb
  call void @arienco_start_encoding.16(%struct.EncodingEnvironment* %eep, i8* %code_buffer, i32* %code_len, i32 %slice_type)
  ret void

func_arienco_start_encoding.18:                   ; preds = %ctrl0
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_arienco_start_encoding.18, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_arienco_start_encoding.19, label %func_arienco_start_encoding.20
}
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_biari_encode_symbol.10, label %func_biari_encode_symbol.13
}
...
func_biari_encode_symbol_eq_prob.9:               ; preds = %ctrl1
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_biari_encode_symbol_eq_prob.9, label %func_biari_encode_symbol_eq_prob.17
}
...
func_biari_encode_symbol_final.14:                ; preds = %ctrl1
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_biari_encode_symbol_final.14, label %func_biari_encode_symbol_final.15
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_biari_init_context.4, label %ctrl0

func_biari_init_context.4:                        ; preds = %rand_bb
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_biari_init_context.7, label %func_biari_init_context.12
}
...
entry:
  ...
  %canary = alloca i32
  store i32 906084679, i32* %canary
...
entry:
  %symbol.addr = alloca i16, align 2
  %canary = alloca i32
  store i32 1272304236, i32* %canary
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %low = alloca i32, align 4
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
...
if.end124:                                        ; preds = %if.end123, %while.end51
  ...
  %105 = icmp eq i32 %104, 1272304236
...
entry:
  %symbol.addr = alloca i16, align 2
  %canary = alloca i32
  store i32 883948676, i32* %canary
  %low = alloca i32, align 4
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
...
entry:
  ...
  %canary = alloca i32
  store i32 116055415, i32* %canary
...
entry:
  ...
  %ctx.addr = alloca %struct.BiContextType*, align 8
  %canary = alloca i32
  store i32 116851982, i32* %canary
  %ini.addr = alloca i32*, align 8
  store %struct.BiContextType* %ctx, %struct.BiContextType** %ctx.addr, align 8
  store i32* %ini, i32** %ini.addr, align 8
  %0 = load i32*, i32** %ini.addr, align 8
...
entry:
  ...
  %range = alloca i32, align 4
  %canary = alloca i32
  store i32 254974851, i32* %canary
  %symbol.addr = alloca i16, align 2
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
  store %struct.BiContextType* %bi_ct, %struct.BiContextType** %bi_ct.addr, align 8
...
entry:
  ...
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 328683549, i32* %canary
  %symbol.addr = alloca i16, align 2
  %range = alloca i32, align 4
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
...
entry:
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 1776894223, i32* %canary
  %low = alloca i32, align 4
  %symbol.addr = alloca i16, align 2
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
...
if.end124:                                        ; preds = %if.end123, %while.end51
  ...
  store i32 %inc127, i32* %C126, align 8
  %104 = load i32, i32* %canary
  %105 = icmp eq i32 %104, 1776894223
  br i1 %105, label %106, label %func_exit
...
entry:
  ...
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 988968079, i32* %canary
  %range = alloca i32, align 4
  %bi_ct.addr = alloca %struct.BiContextType*, align 8
  %low = alloca i32, align 4
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
...
entry:
  %range = alloca i32, align 4
  %canary = alloca i32
  store i32 1774917543, i32* %canary
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %low = alloca i32, align 4
  %symbol.addr = alloca i16, align 2
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
...
while.end125:                                     ; preds = %while.cond
  ...
  store i32 %inc129, i32* %C128, align 8
  %110 = load i32, i32* %canary
  %111 = icmp eq i32 %110, 1774917543
  br i1 %111, label %112, label %func_exit
...
entry:
  %canary = alloca i32
  store i32 1236950764, i32* %canary
  %symbol.addr = alloca i16, align 2
  %bi_ct.addr = alloca %struct.BiContextType*, align 8
  %low = alloca i32, align 4
  %range = alloca i32, align 4
...
while.end162:                                     ; preds = %while.cond
  ...
  store i32 %inc166, i32* %C165, align 8
  %136 = load i32, i32* %canary
  %137 = icmp eq i32 %136, 1236950764
  br i1 %137, label %138, label %func_exit
...
entry:
  ...
  %low = alloca i32, align 4
  %canary = alloca i32
  store i32 917583460, i32* %canary
  %range = alloca i32, align 4
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
...
entry:
  ...
  %symbol.addr = alloca i16, align 2
  %canary = alloca i32
  store i32 1398305753, i32* %canary
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
  %0 = load %struct.EncodingEnvironment*, %struct.EncodingEnvironment** %eep.addr, align 8
...
while.end125:                                     ; preds = %while.cond
  ...
  store i32 %inc129, i32* %C128, align 8
  %110 = load i32, i32* %canary
  %111 = icmp eq i32 %110, 1398305753
  br i1 %111, label %112, label %func_exit
...
entry:
  ...
  %canary = alloca i32
  store i32 126518969, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1017675332, i32* %canary
  %low = alloca i32, align 4
  %symbol.addr = alloca i16, align 2
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
...
if.end124:                                        ; preds = %if.end123, %while.end51
  ...
  store i32 %inc127, i32* %C126, align 8
  %104 = load i32, i32* %canary
  %105 = icmp eq i32 %104, 1017675332
  br i1 %105, label %106, label %func_exit
...
entry:
  ...
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 897629950, i32* %canary
  %code_buffer.addr = alloca i8*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i8* %code_buffer, i8** %code_buffer.addr, align 8
  store i32* %code_len, i32** %code_len.addr, align 8
...
entry:
  %code_len.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 1709039463, i32* %canary
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %slice_type.addr = alloca i32, align 4
  %code_buffer.addr = alloca i8*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
...
entry:
  %code_len.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 749110792, i32* %canary
  %code_buffer.addr = alloca i8*, align 8
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %slice_type.addr = alloca i32, align 4
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
