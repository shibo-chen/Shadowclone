...
entry:
  ...
  %canary = alloca i32
  store i32 1937814971, i32* %canary
...
entry:
  ...
  %UseAnnexbLongStartcode.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1760295044, i32* %canary
  %nal_reference_idc.addr = alloca i32, align 4
  %nalu.addr = alloca %struct.NALU_t*, align 8
  %rbsp_size.addr = alloca i32, align 4
  %len = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1752445541, i32* %canary
  %rbsp_size.addr = alloca i32, align 4
  %rbsp.addr = alloca i8*, align 8
  %len = alloca i32, align 4
  %nal_unit_type.addr = alloca i32, align 4
...
entry:
  ...
  %len = alloca i32, align 4
  %canary = alloca i32
  store i32 1658743980, i32* %canary
  %nal_unit_type.addr = alloca i32, align 4
  store i8* %rbsp, i8** %rbsp.addr, align 8
  store %struct.NALU_t* %nalu, %struct.NALU_t** %nalu.addr, align 8
  store i32 %rbsp_size, i32* %rbsp_size.addr, align 4
...
entry:
  ...
  %nalu.addr = alloca %struct.NALU_t*, align 8
  %canary = alloca i32
  store i32 1380448110, i32* %canary
  %nal_unit_type.addr = alloca i32, align 4
  store i8* %rbsp, i8** %rbsp.addr, align 8
  store %struct.NALU_t* %nalu, %struct.NALU_t** %nalu.addr, align 8
  store i32 %rbsp_size, i32* %rbsp_size.addr, align 4
...
entry:
  ...
  %min_num_bytes.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 633475693, i32* %canary
  %rbsp_size.addr = alloca i32, align 4
  %nalu.addr = alloca %struct.NALU_t*, align 8
  %nal_reference_idc.addr = alloca i32, align 4
  store i8* %rbsp, i8** %rbsp.addr, align 8
...
entry:
  ...
  %rbsp.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 109610406, i32* %canary
  %rbsp_size.addr = alloca i32, align 4
  %min_num_bytes.addr = alloca i32, align 4
  %len = alloca i32, align 4
  %nal_unit_type.addr = alloca i32, align 4
...
entry:
  ...
  %rbsp.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1517602848, i32* %canary
  %min_num_bytes.addr = alloca i32, align 4
  %UseAnnexbLongStartcode.addr = alloca i32, align 4
  store i8* %rbsp, i8** %rbsp.addr, align 8
  store %struct.NALU_t* %nalu, %struct.NALU_t** %nalu.addr, align 8
...
entry:
  ...
  %nal_reference_idc.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 455808729, i32* %canary
  %UseAnnexbLongStartcode.addr = alloca i32, align 4
  store i8* %rbsp, i8** %rbsp.addr, align 8
  store %struct.NALU_t* %nalu, %struct.NALU_t** %nalu.addr, align 8
  store i32 %rbsp_size, i32* %rbsp_size.addr, align 4
...
entry:
  ...
  %nal_reference_idc.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 922570620, i32* %canary
  %rbsp.addr = alloca i8*, align 8
  %UseAnnexbLongStartcode.addr = alloca i32, align 4
  %min_num_bytes.addr = alloca i32, align 4
  %rbsp_size.addr = alloca i32, align 4
...
entry:
  ...
  %nal_reference_idc.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 189662211, i32* %canary
  %nalu.addr = alloca %struct.NALU_t*, align 8
  %rbsp.addr = alloca i8*, align 8
  %rbsp_size.addr = alloca i32, align 4
  store i8* %rbsp, i8** %rbsp.addr, align 8
...
entry:
  ...
  %nal_reference_idc.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 187995997, i32* %canary
  %len = alloca i32, align 4
  %min_num_bytes.addr = alloca i32, align 4
  %UseAnnexbLongStartcode.addr = alloca i32, align 4
  %rbsp.addr = alloca i8*, align 8
...
entry:
  ...
  %rbsp.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 899930476, i32* %canary
  %len = alloca i32, align 4
  store i8* %rbsp, i8** %rbsp.addr, align 8
  store %struct.NALU_t* %nalu, %struct.NALU_t** %nalu.addr, align 8
  store i32 %rbsp_size, i32* %rbsp_size.addr, align 4
...
entry:
  ...
  %UseAnnexbLongStartcode.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1249295191, i32* %canary
  %nal_reference_idc.addr = alloca i32, align 4
  %rbsp.addr = alloca i8*, align 8
  store i8* %rbsp, i8** %rbsp.addr, align 8
  store %struct.NALU_t* %nalu, %struct.NALU_t** %nalu.addr, align 8
...
entry:
  %len = alloca i32, align 4
  %canary = alloca i32
  store i32 352712392, i32* %canary
  %nalu.addr = alloca %struct.NALU_t*, align 8
  %UseAnnexbLongStartcode.addr = alloca i32, align 4
  %rbsp.addr = alloca i8*, align 8
  %min_num_bytes.addr = alloca i32, align 4
...
entry:
  ...
  %UseAnnexbLongStartcode.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1850409215, i32* %canary
  %rbsp.addr = alloca i8*, align 8
  store i8* %rbsp, i8** %rbsp.addr, align 8
  store %struct.NALU_t* %nalu, %struct.NALU_t** %nalu.addr, align 8
  store i32 %rbsp_size, i32* %rbsp_size.addr, align 4
