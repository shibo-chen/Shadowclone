...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_testEndian.9, label %func_testEndian.13

func_testEndian.9:                                ; preds = %rand_bb
  %2 = call i32 @testEndian.9()
  ret i32 %2

func_testEndian.13:                               ; preds = %rand_bb
  %3 = call i32 @testEndian.13()
  ret i32 %3
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_img2buf.2, label %ctrl0

func_img2buf.2:                                   ; preds = %rand_bb
  call void @img2buf.2(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom)
  ret void

func_img2buf.4:                                   ; preds = %ctrl0
...
func_img2buf.8:                                   ; preds = %ctrl1
  call void @img2buf.8(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom)
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_img2buf.4, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_img2buf.8, label %ctrl2
...
ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_img2buf.21, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_img2buf.29, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_img2buf.33, label %func_img2buf.34
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_write_picture.6, label %ctrl0

func_write_picture.6:                             ; preds = %rand_bb
  call void @write_picture.6(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure)
  ret void

func_write_picture.10:                            ; preds = %ctrl0
...
ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_write_picture.15, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_write_picture.18, label %func_write_picture.19
}
...
func_write_out_picture.24:                        ; preds = %ctrl0
  call void @write_out_picture.24(%struct.storable_picture* %p, i32 %p_out)
  ret void

func_write_out_picture.26:                        ; preds = %ctrl1
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_write_out_picture.24, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_write_out_picture.26, label %ctrl2
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_clear_picture.3, label %func_clear_picture.17

func_clear_picture.3:                             ; preds = %rand_bb
  call void @clear_picture.3(%struct.storable_picture* %p)
  ret void

func_clear_picture.17:                            ; preds = %rand_bb
  call void @clear_picture.17(%struct.storable_picture* %p)
  ret void
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_write_unpaired_field.11, label %ctrl0

func_write_unpaired_field.11:                     ; preds = %rand_bb
  call void @write_unpaired_field.11(%struct.frame_store* %fs, i32 %p_out)
  ret void

func_write_unpaired_field.16:                     ; preds = %ctrl0
  call void @write_unpaired_field.16(%struct.frame_store* %fs, i32 %p_out)
  ret void

func_write_unpaired_field.23:                     ; preds = %ctrl1
  call void @write_unpaired_field.23(%struct.frame_store* %fs, i32 %p_out)
  ret void

func_write_unpaired_field.25:                     ; preds = %ctrl2
...
func_write_unpaired_field.28:                     ; preds = %ctrl3
  call void @write_unpaired_field.28(%struct.frame_store* %fs, i32 %p_out)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_write_unpaired_field.16, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_write_unpaired_field.23, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_write_unpaired_field.25, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_write_unpaired_field.27, label %func_write_unpaired_field.28
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_write_stored_frame.14, label %func_write_stored_frame.22
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_direct_output.1, label %func_direct_output.7
...
entry:
  %canary = alloca i32
  store i32 1611829485, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @img2buf.2(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom) #0 {
entry:
  %ui32 = alloca i64, align 8
  %canary = alloca i32
  store i32 1115085945, i32* %canary
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  ...
  %109 = icmp eq i32 %108, 1115085945
...
entry:
  %canary = alloca i32
  store i32 1847727640, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  %i = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
...
entry:
  ...
  %imgX.addr = alloca i16**, align 8
  %canary = alloca i32
  store i32 1562830344, i32* %canary
  %twidth = alloca i32, align 4
  %crop_right.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %i = alloca i32, align 4
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1562830344
  br i1 %109, label %110, label %func_exit
...
entry:
  ...
  %p.addr = alloca %struct.storable_picture*, align 8
  %canary = alloca i32
  store i32 1109465115, i32* %canary
...
return:                                           ; preds = %if.end139, %if.then
  ...
  %193 = icmp eq i32 %192, 1109465115
...
entry:
  %p.addr = alloca %struct.storable_picture*, align 8
  %canary = alloca i32
  store i32 361149614, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 526237788, i32* %canary
  %p_out.addr = alloca i32, align 4
  %p.addr = alloca %struct.storable_picture*, align 8
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @img2buf.8(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom) #0 {
entry:
  %size_x.addr = alloca i32, align 4
  %j = alloca i32, align 4
  %ui8 = alloca i8, align 1
  ...
  %crop_top.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1152413218, i32* %canary
  %size_y.addr = alloca i32, align 4
  %twidth = alloca i32, align 4
  %theight = alloca i32, align 4
  %crop_bottom.addr = alloca i32, align 4
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1152413218
  br i1 %109, label %110, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @testEndian.9() #0 {
entry:
  %canary = alloca i32
  store i32 480921332, i32* %canary
...
entry:
  %real_structure.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 787364019, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  %p_out.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 1786868853, i32* %canary
  %p_out.addr = alloca i32, align 4
...
entry:
  ...
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 176183577, i32* %canary
  %real_structure.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  store i32 %real_structure, i32* %real_structure.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @testEndian.13() #0 {
entry:
  %p = alloca i8*, align 8
  %canary = alloca i32
  store i32 564278569, i32* %canary
  %s = alloca i16, align 2
  %0 = bitcast i16* %s to i8*
  store i8* %0, i8** %p, align 8
  store i16 1, i16* %s, align 2
...
entry:
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 320281620, i32* %canary
  %fs.addr = alloca %struct.frame_store*, align 8
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  %real_structure.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1002474122, i32* %canary
  %p_out.addr = alloca i32, align 4
  %p.addr = alloca %struct.storable_picture*, align 8
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  ...
  %p = alloca %struct.storable_picture*, align 8
  %canary = alloca i32
  store i32 1409566175, i32* %canary
  %p_out.addr = alloca i32, align 4
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  %0 = load %struct.frame_store*, %struct.frame_store** %fs.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @clear_picture.17(%struct.storable_picture* %p) #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 466573376, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 0, i32* %i, align 4
  br label %for.cond
...
entry:
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2118764731, i32* %canary
  %real_structure.addr = alloca i32, align 4
  %p.addr = alloca %struct.storable_picture*, align 8
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1458199919, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  %real_structure.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  ...
  %twidth = alloca i32, align 4
  %canary = alloca i32
  store i32 1736997219, i32* %canary
  %crop_right.addr = alloca i32, align 4
  %size_x.addr = alloca i32, align 4
  %crop_left.addr = alloca i32, align 4
  %tmp16 = alloca i16, align 2
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1736997219
  br i1 %109, label %110, label %func_exit
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1691710548, i32* %canary
  %size_y.addr = alloca i32, align 4
  %size = alloca i32, align 4
  %size_x.addr = alloca i32, align 4
  %crop_left.addr = alloca i32, align 4
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1691710548
  br i1 %109, label %110, label %func_exit
...
entry:
  %canary = alloca i32
  store i32 1710027136, i32* %canary
  %fs.addr = alloca %struct.frame_store*, align 8
  %p_out.addr = alloca i32, align 4
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 1846388639, i32* %canary
  %p_out.addr = alloca i32, align 4
  %p = alloca %struct.storable_picture*, align 8
  %fs.addr = alloca %struct.frame_store*, align 8
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
...
entry:
  ...
  %SubHeightC = alloca [4 x i32], align 16
  %canary = alloca i32
  store i32 1587196868, i32* %canary
  %rgb_output = alloca i32, align 4
  %crop_right = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1587196868
  br i1 %193, label %194, label %func_exit
...
entry:
  ...
  %fs.addr = alloca %struct.frame_store*, align 8
  %canary = alloca i32
  store i32 1915270181, i32* %canary
  %p_out.addr = alloca i32, align 4
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  %0 = load %struct.frame_store*, %struct.frame_store** %fs.addr, align 8
...
entry:
  ...
  %fs.addr = alloca %struct.frame_store*, align 8
  %canary = alloca i32
  store i32 784809554, i32* %canary
  %p = alloca %struct.storable_picture*, align 8
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  %0 = load %struct.frame_store*, %struct.frame_store** %fs.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_unpaired_field.28(%struct.frame_store* %fs, i32 %p_out) #0 {
entry:
  %canary = alloca i32
  store i32 669817341, i32* %canary
  %fs.addr = alloca %struct.frame_store*, align 8
  %p_out.addr = alloca i32, align 4
  %p = alloca %struct.storable_picture*, align 8
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
...
entry:
  ...
  %ui16 = alloca i16, align 2
  %canary = alloca i32
  store i32 1228081353, i32* %canary
  %crop_top.addr = alloca i32, align 4
  %tmp16 = alloca i16, align 2
  %theight = alloca i32, align 4
  %crop_right.addr = alloca i32, align 4
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1228081353
  br i1 %109, label %110, label %func_exit
...
entry:
  %canary = alloca i32
  store i32 637282541, i32* %canary
  %SubHeightC = alloca [4 x i32], align 16
  %symbol_size_in_bytes = alloca i32, align 4
  %buf = alloca i8*, align 8
  %p_out.addr = alloca i32, align 4
...
entry:
  ...
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1685358145, i32* %canary
  %crop_bottom = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  %0 = bitcast [4 x i32]* %SubWidthC to i8*
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1685358145
  br i1 %193, label %194, label %func_exit
...
entry:
  ...
  %p.addr = alloca %struct.storable_picture*, align 8
  %canary = alloca i32
  store i32 1279163523, i32* %canary
  %crop_bottom = alloca i32, align 4
  %rgb_output = alloca i32, align 4
  %crop_right = alloca i32, align 4
  %SubWidthC = alloca [4 x i32], align 16
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1279163523
  br i1 %193, label %194, label %func_exit
...
entry:
  ...
  %imgX.addr = alloca i16**, align 8
  %canary = alloca i32
  store i32 2129426948, i32* %canary
  %buf.addr = alloca i8*, align 8
  %ui32 = alloca i64, align 8
  %ui16 = alloca i16, align 2
  %i = alloca i32, align 4
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 2129426948
  br i1 %109, label %110, label %func_exit
...
entry:
  ...
  %theight = alloca i32, align 4
  %canary = alloca i32
  store i32 1852943486, i32* %canary
  %tmp16 = alloca i16, align 2
  %ui16 = alloca i16, align 2
  %size_x.addr = alloca i32, align 4
  %crop_right.addr = alloca i32, align 4
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1852943486
  br i1 %109, label %110, label %func_exit
...
entry:
  ...
  %rgb_output = alloca i32, align 4
  %canary = alloca i32
  store i32 1626789865, i32* %canary
  %symbol_size_in_bytes = alloca i32, align 4
  %crop_right = alloca i32, align 4
  %p_out.addr = alloca i32, align 4
  %crop_left = alloca i32, align 4
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1626789865
  br i1 %193, label %194, label %func_exit
...
entry:
  ...
  %SubWidthC = alloca [4 x i32], align 16
  %canary = alloca i32
  store i32 1992857789, i32* %canary
  %crop_left = alloca i32, align 4
  %rgb_output = alloca i32, align 4
  %symbol_size_in_bytes = alloca i32, align 4
  %p.addr = alloca %struct.storable_picture*, align 8
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1992857789
  br i1 %193, label %194, label %func_exit
