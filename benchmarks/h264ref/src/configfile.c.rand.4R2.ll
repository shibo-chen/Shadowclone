; ModuleID = 'configfile.c.rand.4R2.bc'
...
func_Configure.12:                                ; preds = %ctrl0
  call void @Configure.12(i32 %ac, i8** %av)
  ret void

func_Configure.17:                                ; preds = %ctrl1
  call void @Configure.17(i32 %ac, i8** %av)
  ret void

func_Configure.18:                                ; preds = %ctrl1
  call void @Configure.18(i32 %ac, i8** %av)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_Configure.12, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_Configure.17, label %func_Configure.18
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_GetConfigFileContent.11, label %ctrl0

func_GetConfigFileContent.11:                     ; preds = %rand_bb
  %2 = call i8* @GetConfigFileContent.11(i8* %Filename)
  ret i8* %2

func_GetConfigFileContent.13:                     ; preds = %ctrl0
  %3 = call i8* @GetConfigFileContent.13(i8* %Filename)
  ret i8* %3

func_GetConfigFileContent.19:                     ; preds = %ctrl1
  %4 = call i8* @GetConfigFileContent.19(i8* %Filename)
  ret i8* %4

func_GetConfigFileContent.23:                     ; preds = %ctrl1
  %5 = call i8* @GetConfigFileContent.23(i8* %Filename)
  ret i8* %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_GetConfigFileContent.13, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_GetConfigFileContent.19, label %func_GetConfigFileContent.23
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_ParseContent.2, label %ctrl0

func_ParseContent.2:                              ; preds = %rand_bb
  call void @ParseContent.2(i8* %buf, i32 %bufsize)
  ret void
...
func_ParseContent.6:                              ; preds = %ctrl1
  call void @ParseContent.6(i8* %buf, i32 %bufsize)
  ret void

func_ParseContent.14:                             ; preds = %ctrl1
  call void @ParseContent.14(i8* %buf, i32 %bufsize)
  ret void
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_ParseContent.6, label %func_ParseContent.14
}
...
func_CeilLog2.7:                                  ; preds = %ctrl0
  %3 = call i32 @CeilLog2.7(i32 %uiVal)
  ret i32 %3

func_CeilLog2.9:                                  ; preds = %ctrl1
  %4 = call i32 @CeilLog2.9(i32 %uiVal)
  ret i32 %4
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_CeilLog2.7, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_CeilLog2.9, label %func_CeilLog2.15
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_ParameterNameToMapIndex.20, label %ctrl0

func_ParameterNameToMapIndex.20:                  ; preds = %rand_bb
  %2 = call i32 @ParameterNameToMapIndex.20(i8* %s)
  ret i32 %2
...
func_ParameterNameToMapIndex.24:                  ; preds = %ctrl1
  %5 = call i32 @ParameterNameToMapIndex.24(i8* %s)
  ret i32 %5
...
ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_ParameterNameToMapIndex.22, label %func_ParameterNameToMapIndex.24
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_PatchInp.1, label %ctrl0

func_PatchInp.1:                                  ; preds = %rand_bb
  call void @PatchInp.1()
  ret void
...
func_PatchInp.26:                                 ; preds = %ctrl1
  call void @PatchInp.26()
  ret void
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_PatchInp.25, label %func_PatchInp.26
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_TestEncoderParams.8, label %func_TestEncoderParams.16

func_TestEncoderParams.8:                         ; preds = %rand_bb
  %2 = call i32 @TestEncoderParams.8(i32 %bitdepth_qp_scale)
  ret i32 %2

func_TestEncoderParams.16:                        ; preds = %rand_bb
  %3 = call i32 @TestEncoderParams.16(i32 %bitdepth_qp_scale)
  ret i32 %3
}
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @PatchInp.1() #0 {
entry:
  ...
  %canary = alloca i32
  store i32 1431063062, i32* %canary
...
if.end649:                                        ; preds = %if.then647, %land.lhs.true645, %if.end641
  ...
  %372 = icmp eq i32 %371, 1431063062
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @ParseContent.2(i8* %buf, i32 %bufsize) #0 {
entry:
  %canary = alloca i32
  store i32 813416633, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1171877005, i32* %canary
...
entry:
  ...
  %bufend = alloca i8*, align 8
  %canary = alloca i32
  store i32 2046475989, i32* %canary
  %items = alloca [10000 x i8*], align 16
  %i = alloca i32, align 4
  %bufsize.addr = alloca i32, align 4
  %MapIdx = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 894231900, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @ParseContent.6(i8* %buf, i32 %bufsize) #0 {
entry:
  %i = alloca i32, align 4
  %items = alloca [10000 x i8*], align 16
  %p = alloca i8*, align 8
  ...
  %IntContent = alloca i32, align 4
  %canary = alloca i32
  store i32 867721873, i32* %canary
  %InItem = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %bufsize.addr = alloca i32, align 4
  %item = alloca i32, align 4
...
entry:
  %uiVal.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 997511286, i32* %canary
  %uiRet = alloca i32, align 4
  %uiTmp = alloca i32, align 4
  store i32 %uiVal, i32* %uiVal.addr, align 4
  %0 = load i32, i32* %uiVal.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 744545237, i32* %canary
  %i = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 221242263, i32* %canary
  %uiTmp = alloca i32, align 4
  %uiVal.addr = alloca i32, align 4
  %uiRet = alloca i32, align 4
  store i32 %uiVal, i32* %uiVal.addr, align 4
...
entry:
  ...
  %storedBplus1 = alloca i32, align 4
  %canary = alloca i32
  store i32 1824578849, i32* %canary
  %mapunit_height = alloca i32, align 4
  %mb_height = alloca i32, align 4
  %sgfile = alloca %struct._IO_FILE*, align 8
  %i = alloca i32, align 4
...
if.end649:                                        ; preds = %if.then647, %land.lhs.true645, %if.end641
  ...
  call void @LevelCheck()
  %371 = load i32, i32* %canary
  %372 = icmp eq i32 %371, 1824578849
  br i1 %372, label %373, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i8* @GetConfigFileContent.11(i8* %Filename) #0 {
entry:
  %Filename.addr = alloca i8*, align 8
  %buf = alloca i8*, align 8
  %retval = alloca i8*, align 8
  %canary = alloca i32
  store i32 1697141948, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Configure.12(i32 %ac, i8** %av) #0 {
entry:
  %NumberParams = alloca i32, align 4
  %ContentLen = alloca i32, align 4
  %destin = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i8* @GetConfigFileContent.13(i8* %Filename) #0 {
entry:
  %buf = alloca i8*, align 8
  %canary = alloca i32
  store i32 763472798, i32* %canary
  %FileSize = alloca i64, align 8
  %f = alloca %struct._IO_FILE*, align 8
  %Filename.addr = alloca i8*, align 8
  %retval = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @ParseContent.14(i8* %buf, i32 %bufsize) #0 {
entry:
  %InItem = alloca i32, align 4
  %i = alloca i32, align 4
  %bufend = alloca i8*, align 8
  ...
  %p = alloca i8*, align 8
  %canary = alloca i32
  store i32 373631518, i32* %canary
  %buf.addr = alloca i8*, align 8
  %IntContent = alloca i32, align 4
  %bufsize.addr = alloca i32, align 4
  %MapIdx = alloca i32, align 4
...
entry:
  %uiVal.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 352882283, i32* %canary
  %uiTmp = alloca i32, align 4
  %uiRet = alloca i32, align 4
  store i32 %uiVal, i32* %uiVal.addr, align 4
  %0 = load i32, i32* %uiVal.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @TestEncoderParams.16(i32 %bitdepth_qp_scale) #0 {
entry:
  %canary = alloca i32
  store i32 770784399, i32* %canary
  %bitdepth_qp_scale.addr = alloca i32, align 4
  %i = alloca i32, align 4
  store i32 %bitdepth_qp_scale, i32* %bitdepth_qp_scale.addr, align 4
  store i32 0, i32* %i, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Configure.18(i32 %ac, i8** %av) #0 {
entry:
  %source = alloca i8*, align 8
  %ac.addr = alloca i32, align 4
  %av.addr = alloca i8**, align 8
  ...
  %destin = alloca i8*, align 8
  %canary = alloca i32
  store i32 1624365949, i32* %canary
  %content = alloca i8*, align 8
  store i32 %ac, i32* %ac.addr, align 4
  store i8** %av, i8*** %av.addr, align 8
  store i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.1, i64 0, i64 0), i8** %filename, align 8
...
entry:
  ...
  %buf = alloca i8*, align 8
  %canary = alloca i32
  store i32 675214742, i32* %canary
  %retval = alloca i8*, align 8
  %Filename.addr = alloca i8*, align 8
  store i8* %Filename, i8** %Filename.addr, align 8
  %0 = load i8*, i8** %Filename.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @ParameterNameToMapIndex.20(i8* %s) #0 {
entry:
  %canary = alloca i32
  store i32 1058674822, i32* %canary
...
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 810523525, i32* %canary
  %s.addr = alloca i8*, align 8
  %retval = alloca i32, align 4
  store i8* %s, i8** %s.addr, align 8
  store i32 0, i32* %i, align 4
...
entry:
  %canary = alloca i32
  store i32 251328736, i32* %canary
  %retval = alloca i32, align 4
  %s.addr = alloca i8*, align 8
  %i = alloca i32, align 4
  store i8* %s, i8** %s.addr, align 8
...
entry:
  ...
  %retval = alloca i8*, align 8
  %canary = alloca i32
  store i32 744681206, i32* %canary
  %f = alloca %struct._IO_FILE*, align 8
  %buf = alloca i8*, align 8
  store i8* %Filename, i8** %Filename.addr, align 8
  %0 = load i8*, i8** %Filename.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @ParameterNameToMapIndex.24(i8* %s) #0 {
entry:
  %s.addr = alloca i8*, align 8
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 978972650, i32* %canary
  %i = alloca i32, align 4
  store i8* %s, i8** %s.addr, align 8
  store i32 0, i32* %i, align 4
  br label %while.cond
...
entry:
  ...
  %bitdepth_qp_scale = alloca i32, align 4
  %canary = alloca i32
  store i32 380837381, i32* %canary
  %i = alloca i32, align 4
  %sgfile = alloca %struct._IO_FILE*, align 8
  %mb_width = alloca i32, align 4
  %mapunit_height = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @PatchInp.26() #0 {
entry:
  %mapunit_height = alloca i32, align 4
  %canary = alloca i32
  store i32 805012905, i32* %canary
  %frame_mb_only = alloca i32, align 4
  %bitdepth_qp_scale = alloca i32, align 4
  %storedBplus1 = alloca i32, align 4
  %sgfile = alloca %struct._IO_FILE*, align 8
