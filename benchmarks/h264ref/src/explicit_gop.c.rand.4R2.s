...
.LBB4_3:                                # %func_interpret_gop_structure.12
	...
	.cfi_def_cfa %rsp, 8
	retq
.LBB4_4:                                # %func_interpret_gop_structure.15
	.cfi_def_cfa %rbp, 16
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1464453164, -28(%rbp)  # imm = 0x5749C82C
	movl	%edi, -24(%rbp)
	movl	%esi, -4(%rbp)
	movl	%edx, -20(%rbp)
	movq	%rcx, -16(%rbp)
...
.LBB7_9:                                # %if.end32
	...
	callq	gop_pyramid
.LBB7_10:                               # %if.end42
	cmpl	$1464453164, -28(%rbp)  # imm = 0x5749C82C
	jne	.LBB7_12
.LBB7_11:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$48, %rsp
	movl	$1781108848, -36(%rbp)  # imm = 0x6A299070
	movl	%edi, -40(%rbp)
	movl	$0, -12(%rbp)
...
.LBB8_16:                               # %if.end27
	...
	movq	%rax, 72512(%rcx)
.LBB8_17:                               # %return
	cmpl	$1781108848, -36(%rbp)  # imm = 0x6A299070
	jne	.LBB8_19
.LBB8_18:
	addq	$48, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$48, %rsp
	movl	$1317148287, -44(%rbp)  # imm = 0x4E82167F
	movq	input, %rdi
...
.LBB9_65:                               # %if.end171
	...
	movq	input, %rcx
	movl	%eax, 1236(%rcx)
	cmpl	$1317148287, -44(%rbp)  # imm = 0x4E82167F
	jne	.LBB9_67
.LBB9_66:
	addq	$48, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$562912142, -60(%rbp)   # imm = 0x218D5B8E
	movq	input, %rax
	movl	1236(%rax), %eax
	cltd
	movl	$2, %ecx
...
.LBB10_37:                              # %for.end199
	jmp	.LBB10_38
.LBB10_38:                              # %if.end200
	cmpl	$562912142, -60(%rbp)   # imm = 0x218D5B8E
	jne	.LBB10_40
.LBB10_39:
	addq	$64, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$48, %rsp
	movl	$1960606290, -40(%rbp)  # imm = 0x74DC7A52
	movl	%edi, -36(%rbp)
	movl	$0, -12(%rbp)
	movl	$2147483647, -8(%rbp)   # imm = 0x7FFFFFFF
	movq	img, %rax
...
.LBB11_16:                              # %if.end27
	...
	movq	%rax, 72512(%rcx)
.LBB11_17:                              # %return
	cmpl	$1960606290, -40(%rbp)  # imm = 0x74DC7A52
	jne	.LBB11_19
.LBB11_18:
	addq	$48, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$445226554, -28(%rbp)   # imm = 0x1A899E3A
	movl	%edi, -20(%rbp)
	movl	%esi, -4(%rbp)
	movl	%edx, -24(%rbp)
	movq	%rcx, -16(%rbp)
...
.LBB12_9:                               # %if.end32
	...
	callq	gop_pyramid
.LBB12_10:                              # %if.end42
	cmpl	$445226554, -28(%rbp)   # imm = 0x1A899E3A
	jne	.LBB12_12
.LBB12_11:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$48, %rsp
	movl	$1262283126, -44(%rbp)  # imm = 0x4B3CE976
	movq	input, %rdi
	addq	$1324, %rdi             # imm = 0x52C
	callq	strlen
	movl	%eax, -40(%rbp)
...
.LBB13_65:                              # %if.end171
	...
	movq	input, %rcx
	movl	%eax, 1236(%rcx)
	cmpl	$1262283126, -44(%rbp)  # imm = 0x4B3CE976
	jne	.LBB13_67
.LBB13_66:
	addq	$48, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$1147665008, -60(%rbp)  # imm = 0x4467FA70
	movq	input, %rax
	movl	1236(%rax), %eax
	cltd
	movl	$2, %ecx
...
.LBB14_37:                              # %for.end199
	jmp	.LBB14_38
.LBB14_38:                              # %if.end200
	cmpl	$1147665008, -60(%rbp)  # imm = 0x4467FA70
	jne	.LBB14_40
.LBB14_39:
	addq	$64, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$48, %rsp
	movl	$1218745191, -36(%rbp)  # imm = 0x48A49367
	movl	%edi, -40(%rbp)
	movl	$0, -12(%rbp)
	movl	$2147483647, -8(%rbp)   # imm = 0x7FFFFFFF
	movq	img, %rax
...
.LBB15_16:                              # %if.end27
	...
	movq	%rax, 72512(%rcx)
.LBB15_17:                              # %return
	cmpl	$1218745191, -36(%rbp)  # imm = 0x48A49367
	jne	.LBB15_19
.LBB15_18:
	addq	$48, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$48, %rsp
	movl	$1217058319, -40(%rbp)  # imm = 0x488AD60F
	movl	%edi, -36(%rbp)
	movl	$0, -8(%rbp)
...
.LBB16_16:                              # %if.end27
	...
	movq	%rax, 72512(%rcx)
.LBB16_17:                              # %return
	cmpl	$1217058319, -40(%rbp)  # imm = 0x488AD60F
	jne	.LBB16_19
.LBB16_18:
	addq	$48, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1327514293, -28(%rbp)  # imm = 0x4F2042B5
	movl	%edi, -20(%rbp)
	movl	%esi, -4(%rbp)
	movl	%edx, -24(%rbp)
	movq	%rcx, -16(%rbp)
...
.LBB17_9:                               # %if.end32
	...
	callq	gop_pyramid
.LBB17_10:                              # %if.end42
	cmpl	$1327514293, -28(%rbp)  # imm = 0x4F2042B5
	jne	.LBB17_12
.LBB17_11:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$48, %rsp
	movl	$460563555, -44(%rbp)   # imm = 0x1B73A463
	movq	input, %rdi
	addq	$1324, %rdi             # imm = 0x52C
	callq	strlen
	movl	%eax, -32(%rbp)
...
.LBB18_65:                              # %if.end171
	...
	movq	input, %rcx
	movl	%eax, 1236(%rcx)
	cmpl	$460563555, -44(%rbp)   # imm = 0x1B73A463
	jne	.LBB18_67
.LBB18_66:
	addq	$48, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1043555627, -28(%rbp)  # imm = 0x3E33652B
	movl	%edi, -20(%rbp)
	movl	%esi, -4(%rbp)
	movl	%edx, -24(%rbp)
	movq	%rcx, -16(%rbp)
...
.LBB19_9:                               # %if.end32
	...
	callq	gop_pyramid
.LBB19_10:                              # %if.end42
	cmpl	$1043555627, -28(%rbp)  # imm = 0x3E33652B
	jne	.LBB19_12
.LBB19_11:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$1563716983, -60(%rbp)  # imm = 0x5D346D77
	movq	input, %rax
	movl	1236(%rax), %eax
	cltd
	movl	$2, %ecx
...
.LBB20_37:                              # %for.end199
	jmp	.LBB20_38
.LBB20_38:                              # %if.end200
	cmpl	$1563716983, -60(%rbp)  # imm = 0x5D346D77
	jne	.LBB20_40
.LBB20_39:
	addq	$64, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$48, %rsp
	movl	$1422555123, -44(%rbp)  # imm = 0x54CA77F3
	movq	input, %rdi
	addq	$1324, %rdi             # imm = 0x52C
	callq	strlen
	movl	%eax, -40(%rbp)
...
.LBB21_65:                              # %if.end171
	...
	movq	input, %rcx
	movl	%eax, 1236(%rcx)
	cmpl	$1422555123, -44(%rbp)  # imm = 0x54CA77F3
	jne	.LBB21_67
.LBB21_66:
	addq	$48, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$141300196, -60(%rbp)   # imm = 0x86C11E4
	movq	input, %rax
	movl	1236(%rax), %eax
	cltd
	movl	$2, %ecx
...
.LBB22_37:                              # %for.end199
	jmp	.LBB22_38
.LBB22_38:                              # %if.end200
	cmpl	$141300196, -60(%rbp)   # imm = 0x86C11E4
	jne	.LBB22_40
.LBB22_39:
	addq	$64, %rsp
	popq	%rbp
