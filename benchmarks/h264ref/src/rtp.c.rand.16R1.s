...
# %bb.0:                                # %rand_bb
	...
	cmpl	$0, %eax
	jne	.LBB3_2
# %bb.1:                                # %func_RTPUpdateTimestamp.5
	movl	%ebx, %edi
	...
	.cfi_def_cfa %rsp, 8
	retq
.LBB3_2:                                # %func_RTPUpdateTimestamp.6
	.cfi_def_cfa %rbp, 16
	movl	%ebx, %edi
	callq	RTPUpdateTimestamp.6
	addq	$8, %rsp
	popq	%rbx
	popq	%rbp
	.cfi_def_cfa %rsp, 8
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$436357059, -28(%rbp)   # imm = 0x1A0247C3
	movq	%rdi, -24(%rbp)
	movq	-24(%rbp), %rax
	movl	20(%rax), %eax
	shll	$7, %eax
...
.LBB6_10:                               # %if.end32
	...
	movl	4(%rax), %ebx
	shll	$3, %ebx
	cmpl	$436357059, -28(%rbp)   # imm = 0x1A0247C3
	jne	.LBB6_12
.LBB6_11:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$1809228121, -28(%rbp)  # imm = 0x6BD6A159
	movq	%rdi, -24(%rbp)
	movq	-24(%rbp), %rax
	movl	20(%rax), %eax
	shll	$7, %eax
...
.LBB7_10:                               # %if.end32
	...
	movl	4(%rax), %ebx
	shll	$3, %ebx
	cmpl	$1809228121, -28(%rbp)  # imm = 0x6BD6A159
	jne	.LBB7_12
.LBB7_11:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$858669767, -36(%rbp)   # imm = 0x332E42C7
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movl	$-1, -40(%rbp)
	movq	-32(%rbp), %rdi
...
.LBB8_7:                                # %return
	movl	-12(%rbp), %ebx
	cmpl	$858669767, -36(%rbp)   # imm = 0x332E42C7
	jne	.LBB8_9
.LBB8_8:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$793334917, -40(%rbp)   # imm = 0x2F495485
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movl	$-1, -36(%rbp)
	movq	-32(%rbp), %rdi
...
.LBB9_7:                                # %return
	movl	-12(%rbp), %ebx
	cmpl	$793334917, -40(%rbp)   # imm = 0x2F495485
	jne	.LBB9_9
.LBB9_8:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$16, %rsp
	movl	$1469871403, -12(%rbp)  # imm = 0x579C752B
	movl	%edi, -8(%rbp)
...
.LBB10_5:                               # %return
	cmpl	$1469871403, -12(%rbp)  # imm = 0x579C752B
	jne	.LBB10_7
.LBB10_6:
	addq	$16, %rsp
	popq	%rbp
...
.Lfunc_end10:
	...
	.cfi_endproc
                                        # -- End function
	.globl	RTPUpdateTimestamp.6    # -- Begin function RTPUpdateTimestamp.6
	.p2align	4, 0x90
	.type	RTPUpdateTimestamp.6,@function
RTPUpdateTimestamp.6:                   # @RTPUpdateTimestamp.6
	.cfi_startproc
# %bb.0:                                # %entry
	pushq	%rbp
	.cfi_def_cfa_offset 16
	...
	.cfi_def_cfa_register %rbp
	subq	$16, %rsp
	movl	$646319045, -12(%rbp)   # imm = 0x26860BC5
	movl	%edi, -8(%rbp)
	cmpl	$-1, RTPUpdateTimestamp.oldtr
	jne	.LBB11_2
# %bb.1:                                # %if.then
...
.LBB11_4:                               # %if.end3
	...
	movl	%eax, RTPUpdateTimestamp.oldtr
.LBB11_5:                               # %return
	cmpl	$646319045, -12(%rbp)   # imm = 0x26860BC5
	jne	.LBB11_7
.LBB11_6:
	addq	$16, %rsp
	popq	%rbp
...
.LBB11_7:                               # %func_exit
	...
	jmp	.LBB11_6
.Lfunc_end11:
	.size	RTPUpdateTimestamp.6, .Lfunc_end11-RTPUpdateTimestamp.6
	.cfi_endproc
                                        # -- End function
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$1450340686, -36(%rbp)  # imm = 0x5672714E
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movl	$-1, -40(%rbp)
	movq	-32(%rbp), %rdi
...
.LBB12_7:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$1450340686, -36(%rbp)  # imm = 0x5672714E
	jne	.LBB12_9
.LBB12_8:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$1291827812, -40(%rbp)  # imm = 0x4CFFBA64
	movq	%rdi, -24(%rbp)
	movq	%rsi, -32(%rbp)
	movl	$-1, -36(%rbp)
	movq	-24(%rbp), %rdi
...
.LBB13_7:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$1291827812, -40(%rbp)  # imm = 0x4CFFBA64
	jne	.LBB13_9
.LBB13_8:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$426954900, -40(%rbp)   # imm = 0x1972D094
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movl	$-1, -36(%rbp)
	movq	-32(%rbp), %rdi
...
.LBB14_7:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$426954900, -40(%rbp)   # imm = 0x1972D094
	jne	.LBB14_9
.LBB14_8:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$407389190, -36(%rbp)   # imm = 0x18484406
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movl	$-1, -40(%rbp)
	movq	-32(%rbp), %rdi
...
.LBB15_7:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$407389190, -36(%rbp)   # imm = 0x18484406
	jne	.LBB15_9
.LBB15_8:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$1327012854, -40(%rbp)  # imm = 0x4F189BF6
	movq	%rdi, -24(%rbp)
	movq	%rsi, -32(%rbp)
	movl	$-1, -36(%rbp)
	movq	-24(%rbp), %rdi
...
.LBB16_7:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$1327012854, -40(%rbp)  # imm = 0x4F189BF6
	jne	.LBB16_9
.LBB16_8:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$1272907960, -40(%rbp)  # imm = 0x4BDF08B8
	movq	%rdi, -24(%rbp)
	movq	%rsi, -32(%rbp)
	movl	$-1, -36(%rbp)
	movq	-24(%rbp), %rdi
...
.LBB17_7:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$1272907960, -40(%rbp)  # imm = 0x4BDF08B8
	jne	.LBB17_9
.LBB17_8:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$1848762971, -40(%rbp)  # imm = 0x6E31E25B
	movq	%rdi, -24(%rbp)
	movq	%rsi, -32(%rbp)
	movl	$-1, -36(%rbp)
	movq	-24(%rbp), %rdi
...
.LBB18_7:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$1848762971, -40(%rbp)  # imm = 0x6E31E25B
	jne	.LBB18_9
.LBB18_8:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$160207980, -40(%rbp)   # imm = 0x98C946C
	movq	%rdi, -24(%rbp)
	movq	%rsi, -32(%rbp)
	movl	$-1, -36(%rbp)
	movq	-24(%rbp), %rdi
...
.LBB19_7:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$160207980, -40(%rbp)   # imm = 0x98C946C
	jne	.LBB19_9
.LBB19_8:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$1750496869, -36(%rbp)  # imm = 0x68567665
	movq	%rdi, -24(%rbp)
	movq	%rsi, -32(%rbp)
	movl	$-1, -40(%rbp)
	movq	-24(%rbp), %rdi
...
.LBB20_7:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$1750496869, -36(%rbp)  # imm = 0x68567665
	jne	.LBB20_9
.LBB20_8:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$1013440822, -36(%rbp)  # imm = 0x3C67E136
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movl	$-1, -40(%rbp)
	movq	-32(%rbp), %rdi
...
.LBB21_7:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$1013440822, -36(%rbp)  # imm = 0x3C67E136
	jne	.LBB21_9
.LBB21_8:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$1934059107, -40(%rbp)  # imm = 0x73476663
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movl	$-1, -36(%rbp)
	movq	-32(%rbp), %rdi
...
.LBB22_7:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$1934059107, -40(%rbp)  # imm = 0x73476663
	jne	.LBB22_9
.LBB22_8:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$1587716067, -40(%rbp)  # imm = 0x5EA29FE3
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movl	$-1, -36(%rbp)
	movq	-32(%rbp), %rdi
...
.LBB23_7:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$1587716067, -40(%rbp)  # imm = 0x5EA29FE3
	jne	.LBB23_9
.LBB23_8:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$812624965, -36(%rbp)   # imm = 0x306FAC45
	movq	%rdi, -24(%rbp)
	movq	%rsi, -32(%rbp)
	movl	$-1, -40(%rbp)
	movq	-24(%rbp), %rdi
...
.LBB24_7:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$812624965, -36(%rbp)   # imm = 0x306FAC45
	jne	.LBB24_9
.LBB24_8:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$849708267, -40(%rbp)   # imm = 0x32A584EB
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movl	$-1, -36(%rbp)
	movq	-32(%rbp), %rdi
...
.LBB25_7:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$849708267, -40(%rbp)   # imm = 0x32A584EB
	jne	.LBB25_9
.LBB25_8:
	movl	%ebx, %eax
	addq	$40, %rsp
