...
# %bb.0:                                # %entry
	...
	subq	$216, %rsp
	.cfi_offset %rbx, -24
	movl	$606967244, -140(%rbp)  # imm = 0x242D95CC
	movq	%rdi, -72(%rbp)
	movq	%rsi, -56(%rbp)
	movl	%edx, -96(%rbp)
	movl	%ecx, -60(%rbp)
...
.LBB4_80:                               # %for.inc
	...
	jmp	.LBB4_1
.LBB4_81:                               # %for.end
	cmpl	$606967244, -140(%rbp)  # imm = 0x242D95CC
	jne	.LBB4_83
.LBB4_82:
	addq	$216, %rsp
	popq	%rbx
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$176, %rsp
	movl	$581636165, -112(%rbp)  # imm = 0x22AB1045
	movq	%rdi, -16(%rbp)
	movq	%rsi, -136(%rbp)
	movq	%rdx, -64(%rbp)
	movl	%ecx, -20(%rbp)
...
.LBB5_60:                               # %for.end152
	...
	movl	$0, 72636(%rax)
.LBB5_61:                               # %return
	cmpl	$581636165, -112(%rbp)  # imm = 0x22AB1045
	jne	.LBB5_63
.LBB5_62:
	addq	$176, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	movl	24(%rbp), %eax
	movl	16(%rbp), %eax
	movl	$1983164250, -192(%rbp) # imm = 0x7634AF5A
	movq	%rdi, -216(%rbp)
	movq	%rsi, -248(%rbp)
	movq	%rdx, -56(%rbp)
	movl	%ecx, -148(%rbp)
...
.LBB6_158:                              # %for.inc
	...
	jmp	.LBB6_7
.LBB6_159:                              # %for.end
	cmpl	$1983164250, -192(%rbp) # imm = 0x7634AF5A
	jne	.LBB6_161
.LBB6_160:
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$176, %rsp
	movl	$235606053, -100(%rbp)  # imm = 0xE0B1025
	movq	%rdi, -16(%rbp)
	movq	%rsi, -136(%rbp)
	movq	%rdx, -64(%rbp)
	movl	%ecx, -20(%rbp)
...
.LBB7_60:                               # %for.end152
	...
	movl	$0, 72636(%rax)
.LBB7_61:                               # %return
	cmpl	$235606053, -100(%rbp)  # imm = 0xE0B1025
	jne	.LBB7_63
.LBB7_62:
	addq	$176, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$176, %rsp
	movl	$940849648, -112(%rbp)  # imm = 0x381439F0
	movq	%rdi, -16(%rbp)
	movq	%rsi, -136(%rbp)
	movq	%rdx, -64(%rbp)
	movl	%ecx, -20(%rbp)
...
.LBB8_60:                               # %for.end152
	...
	movl	$0, 72636(%rax)
.LBB8_61:                               # %return
	cmpl	$940849648, -112(%rbp)  # imm = 0x381439F0
	jne	.LBB8_63
.LBB8_62:
	addq	$176, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	movl	24(%rbp), %eax
	movl	16(%rbp), %eax
	movl	$739592267, -188(%rbp)  # imm = 0x2C15484B
	movq	%rdi, -216(%rbp)
	movq	%rsi, -248(%rbp)
	movq	%rdx, -56(%rbp)
	movl	%ecx, -140(%rbp)
...
.LBB9_158:                              # %for.inc
	...
	jmp	.LBB9_7
.LBB9_159:                              # %for.end
	cmpl	$739592267, -188(%rbp)  # imm = 0x2C15484B
	jne	.LBB9_161
.LBB9_160:
	addq	$312, %rsp              # imm = 0x138
	popq	%rbx
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1407094130, -8(%rbp)   # imm = 0x53DE8D72
	movq	%rdi, -16(%rbp)
	movq	%rsi, -24(%rbp)
	movq	%rdx, -32(%rbp)
	movl	$0, -4(%rbp)
...
# %bb.3:                                # %for.inc
	...
	jmp	.LBB10_1
.LBB10_4:                               # %for.end
	cmpl	$1407094130, -8(%rbp)   # imm = 0x53DE8D72
	jne	.LBB10_6
.LBB10_5:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$176, %rsp
	movl	$1076929329, -104(%rbp) # imm = 0x4030A331
	movq	%rdi, -16(%rbp)
	movq	%rsi, -136(%rbp)
	movq	%rdx, -64(%rbp)
	movl	%ecx, -20(%rbp)
...
.LBB11_60:                              # %for.end152
	...
	movl	$0, 72636(%rax)
.LBB11_61:                              # %return
	cmpl	$1076929329, -104(%rbp) # imm = 0x4030A331
	jne	.LBB11_63
.LBB11_62:
	addq	$176, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$751525411, -8(%rbp)    # imm = 0x2CCB5E23
	movq	%rdi, -16(%rbp)
	movq	%rsi, -24(%rbp)
	movq	%rdx, -32(%rbp)
	movl	$0, -4(%rbp)
...
# %bb.3:                                # %for.inc
	...
	jmp	.LBB12_1
.LBB12_4:                               # %for.end
	cmpl	$751525411, -8(%rbp)    # imm = 0x2CCB5E23
	jne	.LBB12_6
.LBB12_5:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	subq	$216, %rsp
	.cfi_offset %rbx, -24
	movl	$679222863, -136(%rbp)  # imm = 0x287C1E4F
	movq	%rdi, -72(%rbp)
	movq	%rsi, -56(%rbp)
	movl	%edx, -96(%rbp)
	movl	%ecx, -60(%rbp)
...
.LBB13_80:                              # %for.inc
	...
	jmp	.LBB13_1
.LBB13_81:                              # %for.end
	cmpl	$679222863, -136(%rbp)  # imm = 0x287C1E4F
	jne	.LBB13_83
.LBB13_82:
	addq	$216, %rsp
	popq	%rbx
...
# %bb.0:                                # %entry
	...
	subq	$216, %rsp
	.cfi_offset %rbx, -24
	movl	$764464802, -152(%rbp)  # imm = 0x2D90CEA2
	movq	%rdi, -72(%rbp)
	movq	%rsi, -56(%rbp)
	movl	%edx, -92(%rbp)
	movl	%ecx, -60(%rbp)
...
.LBB14_80:                              # %for.inc
	...
	jmp	.LBB14_1
.LBB14_81:                              # %for.end
	cmpl	$764464802, -152(%rbp)  # imm = 0x2D90CEA2
	jne	.LBB14_83
.LBB14_82:
	addq	$216, %rsp
	popq	%rbx
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$674279549, -8(%rbp)    # imm = 0x2830B07D
	movq	%rdi, -16(%rbp)
	movq	%rsi, -32(%rbp)
	movq	%rdx, -24(%rbp)
	movl	$0, -4(%rbp)
...
# %bb.3:                                # %for.inc
	...
	jmp	.LBB15_1
.LBB15_4:                               # %for.end
	cmpl	$674279549, -8(%rbp)    # imm = 0x2830B07D
	jne	.LBB15_6
.LBB15_5:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1533235499, -8(%rbp)   # imm = 0x5B63512B
	movq	%rdi, -16(%rbp)
	movq	%rsi, -24(%rbp)
	movq	%rdx, -32(%rbp)
	movl	$0, -4(%rbp)
...
# %bb.3:                                # %for.inc
	...
	jmp	.LBB16_1
.LBB16_4:                               # %for.end
	cmpl	$1533235499, -8(%rbp)   # imm = 0x5B63512B
	jne	.LBB16_6
.LBB16_5:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	subq	$216, %rsp
	.cfi_offset %rbx, -24
	movl	$462588886, -136(%rbp)  # imm = 0x1B928BD6
	movq	%rdi, -72(%rbp)
	movq	%rsi, -56(%rbp)
	movl	%edx, -92(%rbp)
	movl	%ecx, -60(%rbp)
...
.LBB17_80:                              # %for.inc
	...
	jmp	.LBB17_1
.LBB17_81:                              # %for.end
	cmpl	$462588886, -136(%rbp)  # imm = 0x1B928BD6
	jne	.LBB17_83
.LBB17_82:
	addq	$216, %rsp
	popq	%rbx
...
# %bb.0:                                # %entry
	...
	movl	24(%rbp), %eax
	movl	16(%rbp), %eax
	movl	$1536504013, -188(%rbp) # imm = 0x5B9530CD
	movq	%rdi, -208(%rbp)
	movq	%rsi, -248(%rbp)
	movq	%rdx, -56(%rbp)
	movl	%ecx, -136(%rbp)
...
.LBB18_158:                             # %for.inc
	...
	jmp	.LBB18_7
.LBB18_159:                             # %for.end
	cmpl	$1536504013, -188(%rbp) # imm = 0x5B9530CD
	jne	.LBB18_161
.LBB18_160:
	addq	$312, %rsp              # imm = 0x138
	popq	%rbx
...
# %bb.0:                                # %entry
	...
	movl	24(%rbp), %eax
	movl	16(%rbp), %eax
	movl	$122166986, -188(%rbp)  # imm = 0x7481ECA
	movq	%rdi, -208(%rbp)
	movq	%rsi, -248(%rbp)
	movq	%rdx, -56(%rbp)
	movl	%ecx, -144(%rbp)
...
.LBB19_158:                             # %for.inc
	...
	jmp	.LBB19_7
.LBB19_159:                             # %for.end
	cmpl	$122166986, -188(%rbp)  # imm = 0x7481ECA
	jne	.LBB19_161
.LBB19_160:
	addq	$312, %rsp              # imm = 0x138
	popq	%rbx
