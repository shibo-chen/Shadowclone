...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_testEndian.10, label %func_testEndian.25

func_testEndian.10:                               ; preds = %rand_bb
  %2 = call i32 @testEndian.10()
  ret i32 %2

func_testEndian.25:                               ; preds = %rand_bb
  %3 = call i32 @testEndian.25()
  ret i32 %3
}
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_img2buf.11, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_img2buf.17, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_img2buf.22, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_img2buf.23, label %ctrl4
...
ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_img2buf.28, label %func_img2buf.31
}
...
func_write_picture.29:                            ; preds = %ctrl0
  call void @write_picture.29(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure)
  ret void

func_write_picture.30:                            ; preds = %ctrl1
  call void @write_picture.30(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure)
  ret void

func_write_picture.33:                            ; preds = %ctrl2
...
func_write_picture.35:                            ; preds = %ctrl3
  call void @write_picture.35(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_write_picture.29, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_write_picture.30, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_write_picture.33, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_write_picture.34, label %func_write_picture.35
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_write_out_picture.1, label %ctrl0

func_write_out_picture.1:                         ; preds = %rand_bb
  call void @write_out_picture.1(%struct.storable_picture* %p, i32 %p_out)
  ret void

func_write_out_picture.2:                         ; preds = %ctrl0
  call void @write_out_picture.2(%struct.storable_picture* %p, i32 %p_out)
  ret void

func_write_out_picture.20:                        ; preds = %ctrl1
  call void @write_out_picture.20(%struct.storable_picture* %p, i32 %p_out)
  ret void

func_write_out_picture.21:                        ; preds = %ctrl2
  call void @write_out_picture.21(%struct.storable_picture* %p, i32 %p_out)
  ret void

func_write_out_picture.24:                        ; preds = %ctrl3
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_write_out_picture.2, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_write_out_picture.20, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_write_out_picture.21, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_write_out_picture.24, label %ctrl4
...
ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_write_out_picture.32, label %func_write_out_picture.36
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_clear_picture.9, label %func_clear_picture.12
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_write_unpaired_field.3, label %ctrl0

func_write_unpaired_field.3:                      ; preds = %rand_bb
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_write_unpaired_field.14, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_write_unpaired_field.15, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_write_unpaired_field.18, label %func_write_unpaired_field.19
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_write_stored_frame.6, label %func_write_stored_frame.8

func_write_stored_frame.6:                        ; preds = %rand_bb
  call void @write_stored_frame.6(%struct.frame_store* %fs, i32 %p_out)
  ret void
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_out_picture.1(%struct.storable_picture* %p, i32 %p_out) #0 {
entry:
  %symbol_size_in_bytes = alloca i32, align 4
  %canary = alloca i32
  store i32 2126309886, i32* %canary
...
return:                                           ; preds = %if.end139, %if.then
  ...
  %193 = icmp eq i32 %192, 2126309886
...
entry:
  %crop_left = alloca i32, align 4
  %canary = alloca i32
  store i32 1752770958, i32* %canary
  %SubHeightC = alloca [4 x i32], align 16
  %crop_top = alloca i32, align 4
  %crop_right = alloca i32, align 4
  %p.addr = alloca %struct.storable_picture*, align 8
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1752770958
  br i1 %193, label %194, label %func_exit
...
entry:
  %canary = alloca i32
  store i32 853423270, i32* %canary
  %p_out.addr = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 898519504, i32* %canary
  %p_out.addr = alloca i32, align 4
  %p.addr = alloca %struct.storable_picture*, align 8
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 1579468523, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_stored_frame.6(%struct.frame_store* %fs, i32 %p_out) #0 {
entry:
  %canary = alloca i32
  store i32 939798452, i32* %canary
  %fs.addr = alloca %struct.frame_store*, align 8
  %p_out.addr = alloca i32, align 4
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 1365437625, i32* %canary
  %p_out.addr = alloca i32, align 4
  %fs.addr = alloca %struct.frame_store*, align 8
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 334951079, i32* %canary
  %i = alloca i32, align 4
  %p.addr = alloca %struct.storable_picture*, align 8
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @testEndian.10() #0 {
entry:
  %canary = alloca i32
  store i32 391643849, i32* %canary
  %p = alloca i8*, align 8
...
entry:
  ...
  %twidth = alloca i32, align 4
  %canary = alloca i32
  store i32 1722444497, i32* %canary
  %ui8 = alloca i8, align 1
  %size = alloca i32, align 4
  %size_y.addr = alloca i32, align 4
  %crop_bottom.addr = alloca i32, align 4
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1722444497
  br i1 %109, label %110, label %func_exit
...
entry:
  %p.addr = alloca %struct.storable_picture*, align 8
  %canary = alloca i32
  store i32 891113166, i32* %canary
  %i = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 0, i32* %i, align 4
  br label %for.cond
...
entry:
  %canary = alloca i32
  store i32 1238536425, i32* %canary
  %fs.addr = alloca %struct.frame_store*, align 8
  %p_out.addr = alloca i32, align 4
  %p = alloca %struct.storable_picture*, align 8
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1000590154, i32* %canary
  %p = alloca %struct.storable_picture*, align 8
  %p_out.addr = alloca i32, align 4
  %fs.addr = alloca %struct.frame_store*, align 8
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
...
entry:
  ...
  %fs.addr = alloca %struct.frame_store*, align 8
  %canary = alloca i32
  store i32 1612819281, i32* %canary
  %p = alloca %struct.storable_picture*, align 8
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  %0 = load %struct.frame_store*, %struct.frame_store** %fs.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1225611084, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  %p_out.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  ...
  %symbol_size_in_bytes.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1130252013, i32* %canary
  %crop_left.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %size_x.addr = alloca i32, align 4
  %imgX.addr = alloca i16**, align 8
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1130252013
  br i1 %109, label %110, label %func_exit
...
entry:
  ...
  %p = alloca %struct.storable_picture*, align 8
  %canary = alloca i32
  store i32 162118950, i32* %canary
  %p_out.addr = alloca i32, align 4
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  %0 = load %struct.frame_store*, %struct.frame_store** %fs.addr, align 8
...
entry:
  ...
  %fs.addr = alloca %struct.frame_store*, align 8
  %canary = alloca i32
  store i32 740605507, i32* %canary
  %p_out.addr = alloca i32, align 4
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  %0 = load %struct.frame_store*, %struct.frame_store** %fs.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_out_picture.20(%struct.storable_picture* %p, i32 %p_out) #0 {
entry:
  %crop_top = alloca i32, align 4
  %canary = alloca i32
  store i32 916708146, i32* %canary
  %crop_right = alloca i32, align 4
  %rgb_output = alloca i32, align 4
  %buf = alloca i8*, align 8
  %symbol_size_in_bytes = alloca i32, align 4
...
entry:
  ...
  %SubHeightC = alloca [4 x i32], align 16
  %canary = alloca i32
  store i32 116171121, i32* %canary
  %p_out.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  %0 = bitcast [4 x i32]* %SubWidthC to i8*
...
entry:
  ...
  %ui8 = alloca i8, align 1
  %canary = alloca i32
  store i32 1208343238, i32* %canary
  %i = alloca i32, align 4
  %twidth = alloca i32, align 4
  %crop_bottom.addr = alloca i32, align 4
  %j = alloca i32, align 4
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1208343238
  br i1 %109, label %110, label %func_exit
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 2095029387, i32* %canary
  %theight = alloca i32, align 4
  %crop_right.addr = alloca i32, align 4
  %tmp16 = alloca i16, align 2
  %crop_top.addr = alloca i32, align 4
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 2095029387
  br i1 %109, label %110, label %func_exit
...
entry:
  ...
  %rgb_output = alloca i32, align 4
  %canary = alloca i32
  store i32 1346717454, i32* %canary
  %crop_left = alloca i32, align 4
  %crop_bottom = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1346717454
  br i1 %193, label %194, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @testEndian.25() #0 {
entry:
  %canary = alloca i32
  store i32 1379845437, i32* %canary
  %s = alloca i16, align 2
  %p = alloca i8*, align 8
  %0 = bitcast i16* %s to i8*
  store i8* %0, i8** %p, align 8
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1469457948, i32* %canary
  %crop_top.addr = alloca i32, align 4
  %crop_bottom.addr = alloca i32, align 4
  %theight = alloca i32, align 4
  %i = alloca i32, align 4
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1469457948
  br i1 %109, label %110, label %func_exit
...
entry:
  ...
  %symbol_size_in_bytes = alloca i32, align 4
  %canary = alloca i32
  store i32 1700300104, i32* %canary
  %crop_top = alloca i32, align 4
  %crop_bottom = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1700300104
  br i1 %193, label %194, label %func_exit
...
entry:
  ...
  %size_x.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1319835470, i32* %canary
  %theight = alloca i32, align 4
  %crop_left.addr = alloca i32, align 4
  %size_y.addr = alloca i32, align 4
  %size = alloca i32, align 4
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1319835470
  br i1 %109, label %110, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_picture.29(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure) #0 {
entry:
  %real_structure.addr = alloca i32, align 4
  %p.addr = alloca %struct.storable_picture*, align 8
  %canary = alloca i32
  store i32 580777778, i32* %canary
  %p_out.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  store i32 %real_structure, i32* %real_structure.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_picture.30(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure) #0 {
entry:
  %p.addr = alloca %struct.storable_picture*, align 8
  %canary = alloca i32
  store i32 1800463611, i32* %canary
  %p_out.addr = alloca i32, align 4
  %real_structure.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1980881523, i32* %canary
  %crop_right.addr = alloca i32, align 4
  %symbol_size_in_bytes.addr = alloca i32, align 4
  %imgX.addr = alloca i16**, align 8
  %buf.addr = alloca i8*, align 8
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1980881523
  br i1 %109, label %110, label %func_exit
...
entry:
  ...
  %crop_left = alloca i32, align 4
  %canary = alloca i32
  store i32 554541466, i32* %canary
  %crop_top = alloca i32, align 4
  %crop_bottom = alloca i32, align 4
  %rgb_output = alloca i32, align 4
  %symbol_size_in_bytes = alloca i32, align 4
...
entry:
  %real_structure.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 691687067, i32* %canary
  %p_out.addr = alloca i32, align 4
  %p.addr = alloca %struct.storable_picture*, align 8
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 1067697794, i32* %canary
  %p_out.addr = alloca i32, align 4
  %p.addr = alloca %struct.storable_picture*, align 8
  %real_structure.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_picture.35(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure) #0 {
entry:
  %p.addr = alloca %struct.storable_picture*, align 8
  %canary = alloca i32
  store i32 24166209, i32* %canary
  %real_structure.addr = alloca i32, align 4
  %p_out.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
