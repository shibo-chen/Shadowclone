; ModuleID = 'q_offsets.c.rand.8P3.bc'
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_CheckOffsetParameterName.6, label %ctrl0

func_CheckOffsetParameterName.6:                  ; preds = %rand_bb
  %2 = call i32 @CheckOffsetParameterName.6(i8* %s, i32* %type)
  ret i32 %2

func_CheckOffsetParameterName.9:                  ; preds = %ctrl0
  %3 = call i32 @CheckOffsetParameterName.9(i8* %s, i32* %type)
  ret i32 %3
...
func_CheckOffsetParameterName.21:                 ; preds = %ctrl3
  %6 = call i32 @CheckOffsetParameterName.21(i8* %s, i32* %type)
  ret i32 %6
...
ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_CheckOffsetParameterName.9, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_CheckOffsetParameterName.13, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_CheckOffsetParameterName.17, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_CheckOffsetParameterName.21, label %ctrl4
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_ParseQOffsetMatrix.11, label %ctrl0

func_ParseQOffsetMatrix.11:                       ; preds = %rand_bb
  call void @ParseQOffsetMatrix.11(i8* %buf, i32 %bufsize)
  ret void
...
func_ParseQOffsetMatrix.18:                       ; preds = %ctrl2
  call void @ParseQOffsetMatrix.18(i8* %buf, i32 %bufsize)
  ret void

func_ParseQOffsetMatrix.22:                       ; preds = %ctrl3
  call void @ParseQOffsetMatrix.22(i8* %buf, i32 %bufsize)
  ret void

func_ParseQOffsetMatrix.28:                       ; preds = %ctrl4
  call void @ParseQOffsetMatrix.28(i8* %buf, i32 %bufsize)
  ret void
...
ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_ParseQOffsetMatrix.18, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_ParseQOffsetMatrix.22, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_ParseQOffsetMatrix.28, label %ctrl5
...
func_CalculateOffsetParam.16:                     ; preds = %ctrl1
  call void @CalculateOffsetParam.16()
  ret void

func_CalculateOffsetParam.19:                     ; preds = %ctrl2
  call void @CalculateOffsetParam.19()
  ret void

func_CalculateOffsetParam.20:                     ; preds = %ctrl3
  call void @CalculateOffsetParam.20()
  ret void

func_CalculateOffsetParam.23:                     ; preds = %ctrl4
  call void @CalculateOffsetParam.23()
  ret void

func_CalculateOffsetParam.25:                     ; preds = %ctrl5
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_CalculateOffsetParam.16, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_CalculateOffsetParam.19, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_CalculateOffsetParam.20, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_CalculateOffsetParam.23, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_CalculateOffsetParam.25, label %func_CalculateOffsetParam.27
}
...
func_CalculateOffset8Param.5:                     ; preds = %ctrl1
...
func_CalculateOffset8Param.8:                     ; preds = %ctrl3
...
func_CalculateOffset8Param.12:                    ; preds = %ctrl5
  call void @CalculateOffset8Param.12()
  ret void

func_CalculateOffset8Param.26:                    ; preds = %ctrl5
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_CalculateOffset8Param.5, label %ctrl2
...
ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_CalculateOffset8Param.8, label %ctrl4
...
ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_CalculateOffset8Param.12, label %func_CalculateOffset8Param.26
}
...
entry:
  ...
  %canary = alloca i32
  store i32 1520463609, i32* %canary
...
if.end225:                                        ; preds = %for.end224, %for.end102
  ...
  %133 = icmp eq i32 %132, 1520463609
...
entry:
  %canary = alloca i32
  store i32 1134414737, i32* %canary
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %temp = alloca i32, align 4
  %k = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 2014826836, i32* %canary
  %temp = alloca i32, align 4
  %qp_per = alloca i32, align 4
  %j = alloca i32, align 4
  %k = alloca i32, align 4
...
if.end225:                                        ; preds = %for.end224, %for.end102
  %132 = load i32, i32* %canary
  %133 = icmp eq i32 %132, 2014826836
  br i1 %133, label %134, label %func_exit
...
entry:
  %k = alloca i32, align 4
  %canary = alloca i32
  store i32 1962934915, i32* %canary
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %q_bits = alloca i32, align 4
  %temp = alloca i32, align 4
...
entry:
  ...
  %temp = alloca i32, align 4
  %canary = alloca i32
  store i32 1939436301, i32* %canary
  %i = alloca i32, align 4
  %q_bits = alloca i32, align 4
  %j = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
entry:
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 649917123, i32* %canary
  %k = alloca i32, align 4
  %i = alloca i32, align 4
  %temp = alloca i32, align 4
  %q_bits = alloca i32, align 4
...
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 978909608, i32* %canary
  %k = alloca i32, align 4
  %temp = alloca i32, align 4
  %q_bits = alloca i32, align 4
  %j = alloca i32, align 4
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 863142081, i32* %canary
  %type.addr = alloca i32*, align 8
  %s.addr = alloca i8*, align 8
  store i8* %s, i8** %s.addr, align 8
  store i32* %type, i32** %type.addr, align 8
...
entry:
  %temp = alloca i32, align 4
  %canary = alloca i32
  store i32 1300776503, i32* %canary
  %k = alloca i32, align 4
  %q_bits = alloca i32, align 4
  %i = alloca i32, align 4
  %j = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @ParseQOffsetMatrix.11(i8* %buf, i32 %bufsize) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 605184106, i32* %canary
...
entry:
  ...
  %k = alloca i32, align 4
  %canary = alloca i32
  store i32 1515020511, i32* %canary
  %i = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %OffsetMatrixPresentFlag = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 147
  %1 = load i32, i32* %OffsetMatrixPresentFlag, align 8
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1728391419, i32* %canary
  %s.addr = alloca i8*, align 8
  %retval = alloca i32, align 4
  store i8* %s, i8** %s.addr, align 8
  store i32* %type, i32** %type.addr, align 8
...
entry:
  ...
  %p = alloca i8*, align 8
  %canary = alloca i32
  store i32 1483676310, i32* %canary
  %item = alloca i32, align 4
  %type = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %i = alloca i32, align 4
...
entry:
  ...
  %InString = alloca i32, align 4
  %canary = alloca i32
  store i32 1325120016, i32* %canary
  %cnt = alloca i32, align 4
  %j = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %bufsize.addr = alloca i32, align 4
...
entry:
  ...
  %temp = alloca i32, align 4
  %canary = alloca i32
  store i32 1578576730, i32* %canary
  %i = alloca i32, align 4
  %k = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %OffsetMatrixPresentFlag = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 147
...
if.end225:                                        ; preds = %for.end224, %for.end102
  %132 = load i32, i32* %canary
  %133 = icmp eq i32 %132, 1578576730
  br i1 %133, label %134, label %func_exit
...
entry:
  %canary = alloca i32
  store i32 1691062611, i32* %canary
  %type.addr = alloca i32*, align 8
  %i = alloca i32, align 4
  %retval = alloca i32, align 4
  %s.addr = alloca i8*, align 8
...
entry:
  ...
  %InString = alloca i32, align 4
  %canary = alloca i32
  store i32 1803655989, i32* %canary
  %type = alloca i32, align 4
  %range = alloca i32, align 4
  %i = alloca i32, align 4
  %IntContent = alloca i32, align 4
...
entry:
  ...
  %temp = alloca i32, align 4
  %canary = alloca i32
  store i32 530670769, i32* %canary
  %i = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %OffsetMatrixPresentFlag = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 147
  %1 = load i32, i32* %OffsetMatrixPresentFlag, align 8
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1038111874, i32* %canary
  %i = alloca i32, align 4
  %temp = alloca i32, align 4
  %qp_per = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
if.end225:                                        ; preds = %for.end224, %for.end102
  %132 = load i32, i32* %canary
  %133 = icmp eq i32 %132, 1038111874
  br i1 %133, label %134, label %func_exit
...
entry:
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 717360429, i32* %canary
  %s.addr = alloca i8*, align 8
  %i = alloca i32, align 4
  %type.addr = alloca i32*, align 8
  store i8* %s, i8** %s.addr, align 8
...
entry:
  ...
  %item = alloca i32, align 4
  %canary = alloca i32
  store i32 1822700950, i32* %canary
  %InString = alloca i32, align 4
  %OffsetList = alloca i16*, align 8
  %p = alloca i8*, align 8
  %range = alloca i32, align 4
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1596953858, i32* %canary
  %k = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %OffsetMatrixPresentFlag = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 147
  %1 = load i32, i32* %OffsetMatrixPresentFlag, align 8
...
if.end225:                                        ; preds = %for.end224, %for.end102
  %132 = load i32, i32* %canary
  %133 = icmp eq i32 %132, 1596953858
  br i1 %133, label %134, label %func_exit
...
entry:
  %s.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1534602301, i32* %canary
  %retval = alloca i32, align 4
  %i = alloca i32, align 4
  %type.addr = alloca i32*, align 8
  store i8* %s, i8** %s.addr, align 8
...
entry:
  ...
  %qp_per = alloca i32, align 4
  %canary = alloca i32
  store i32 564734148, i32* %canary
  %j = alloca i32, align 4
  %i = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %OffsetMatrixPresentFlag = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 147
...
entry:
  ...
  %temp = alloca i32, align 4
  %canary = alloca i32
  store i32 322118118, i32* %canary
  %j = alloca i32, align 4
  %q_bits = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %OffsetMatrixPresentFlag = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 147
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 234382742, i32* %canary
  %temp = alloca i32, align 4
  %j = alloca i32, align 4
  %k = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @ParseQOffsetMatrix.28(i8* %buf, i32 %bufsize) #0 {
entry:
  %bufend = alloca i8*, align 8
  %MapIdx = alloca i32, align 4
  %item = alloca i32, align 4
  ...
  %InItem = alloca i32, align 4
  %canary = alloca i32
  store i32 1884200516, i32* %canary
  %range = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %cnt = alloca i32, align 4
  %bufsize.addr = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 311853468, i32* %canary
  %i = alloca i32, align 4
  %type.addr = alloca i32*, align 8
  %retval = alloca i32, align 4
  %s.addr = alloca i8*, align 8
...
entry:
  ...
  %OffsetList = alloca i16*, align 8
  %canary = alloca i32
  store i32 1163807469, i32* %canary
  %cnt = alloca i32, align 4
  %InItem = alloca i32, align 4
  %type = alloca i32, align 4
  %range = alloca i32, align 4
...
entry:
  ...
  %item = alloca i32, align 4
  %canary = alloca i32
  store i32 178443906, i32* %canary
  %IntContent = alloca i32, align 4
  %bufend = alloca i8*, align 8
  %cnt = alloca i32, align 4
  %j = alloca i32, align 4
