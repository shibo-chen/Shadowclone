...
# %bb.0:                                # %entry
	...
	.cfi_offset %rbx, -24
	movl	16(%rbp), %eax
	movl	$1430783755, -36(%rbp)  # imm = 0x5548070B
	movq	%rdi, -48(%rbp)
	movq	%rsi, -16(%rbp)
	movl	%edx, -24(%rbp)
	movl	%ecx, -32(%rbp)
	...
	movl	%eax, 4(%rcx)
	movl	-20(%rbp), %ebx
	cmpl	$1430783755, -36(%rbp)  # imm = 0x5548070B
	jne	.LBB1_2
.LBB1_1:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_offset %rbx, -24
	movl	16(%rbp), %eax
	movl	$679895042, -40(%rbp)   # imm = 0x28866002
	movq	%rdi, -48(%rbp)
	movq	%rsi, -16(%rbp)
	movl	%edx, -20(%rbp)
	movl	%ecx, -32(%rbp)
	...
	movl	%eax, 4(%rcx)
	movl	-24(%rbp), %ebx
	cmpl	$679895042, -40(%rbp)   # imm = 0x28866002
	jne	.LBB2_2
.LBB2_1:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_offset %rbx, -24
	movl	16(%rbp), %eax
	movl	$741614171, -40(%rbp)   # imm = 0x2C34225B
	movq	%rdi, -48(%rbp)
	movq	%rsi, -16(%rbp)
	movl	%edx, -20(%rbp)
	movl	%ecx, -36(%rbp)
	...
	movl	%eax, 4(%rcx)
	movl	-24(%rbp), %ebx
	cmpl	$741614171, -40(%rbp)   # imm = 0x2C34225B
	jne	.LBB3_2
.LBB3_1:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_offset %rbx, -24
	movl	16(%rbp), %eax
	movl	$995907054, -28(%rbp)   # imm = 0x3B5C55EE
	movq	%rdi, -48(%rbp)
	movq	%rsi, -16(%rbp)
	movl	%edx, -20(%rbp)
	movl	%ecx, -32(%rbp)
	...
	movl	%eax, 4(%rcx)
	movl	-24(%rbp), %ebx
	cmpl	$995907054, -28(%rbp)   # imm = 0x3B5C55EE
	jne	.LBB4_2
.LBB4_1:
	movl	%ebx, %eax
	addq	$40, %rsp
