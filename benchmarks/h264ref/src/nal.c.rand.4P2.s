...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$722921396, -40(%rbp)   # imm = 0x2B16E7B4
	movq	%rdi, -32(%rbp)
	movl	%esi, -24(%rbp)
	movl	%edx, -36(%rbp)
	movl	%ecx, -44(%rbp)
...
.LBB4_17:                               # %while.end
	movl	-12(%rbp), %ebx
	cmpl	$722921396, -40(%rbp)   # imm = 0x2B16E7B4
	jne	.LBB4_19
.LBB4_18:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$311207767, -44(%rbp)   # imm = 0x128CA757
	movq	%rdi, -32(%rbp)
	movl	%esi, -24(%rbp)
	movl	%edx, -36(%rbp)
	movl	%ecx, -40(%rbp)
...
.LBB5_17:                               # %while.end
	movl	-12(%rbp), %ebx
	cmpl	$311207767, -44(%rbp)   # imm = 0x128CA757
	jne	.LBB5_19
.LBB5_18:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$1355427287, -44(%rbp)  # imm = 0x50CA2DD7
	movq	%rdi, -32(%rbp)
	movl	%esi, -24(%rbp)
	movl	%edx, -36(%rbp)
	movl	%ecx, -40(%rbp)
...
.LBB6_17:                               # %while.end
	movl	-12(%rbp), %ebx
	cmpl	$1355427287, -44(%rbp)  # imm = 0x50CA2DD7
	jne	.LBB6_19
.LBB6_18:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$1728430904, -40(%rbp)  # imm = 0x6705C338
	movq	%rdi, -32(%rbp)
	movl	%esi, -24(%rbp)
	movl	%edx, -36(%rbp)
	movl	%ecx, -44(%rbp)
...
.LBB7_17:                               # %while.end
	movl	-12(%rbp), %ebx
	cmpl	$1728430904, -40(%rbp)  # imm = 0x6705C338
	jne	.LBB7_19
.LBB7_18:
	movl	%ebx, %eax
	addq	$40, %rsp
