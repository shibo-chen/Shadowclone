...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_start_slice.4, label %ctrl0

func_start_slice.4:                               ; preds = %rand_bb
  %2 = call i32 @start_slice.4()
  ret i32 %2

func_start_slice.6:                               ; preds = %ctrl0
  %3 = call i32 @start_slice.6()
  ret i32 %3

func_start_slice.29:                              ; preds = %ctrl1
  %4 = call i32 @start_slice.29()
  ret i32 %4

func_start_slice.30:                              ; preds = %ctrl1
  %5 = call i32 @start_slice.30()
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_start_slice.6, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_start_slice.29, label %func_start_slice.30
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_terminate_slice.1, label %ctrl0

func_terminate_slice.1:                           ; preds = %rand_bb
  %2 = call i32 @terminate_slice.1()
  ret i32 %2

func_terminate_slice.11:                          ; preds = %ctrl0
  %3 = call i32 @terminate_slice.11()
  ret i32 %3

func_terminate_slice.13:                          ; preds = %ctrl1
  %4 = call i32 @terminate_slice.13()
  ret i32 %4
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_terminate_slice.11, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_terminate_slice.13, label %func_terminate_slice.16
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_encode_one_slice.3, label %ctrl0

func_encode_one_slice.3:                          ; preds = %rand_bb
  %2 = call i32 @encode_one_slice.3(i32 %SliceGroupId, %struct.Picture* %pic)
  ret i32 %2

func_encode_one_slice.5:                          ; preds = %ctrl0
  %3 = call i32 @encode_one_slice.5(i32 %SliceGroupId, %struct.Picture* %pic)
  ret i32 %3

func_encode_one_slice.7:                          ; preds = %ctrl1
  %4 = call i32 @encode_one_slice.7(i32 %SliceGroupId, %struct.Picture* %pic)
  ret i32 %4

func_encode_one_slice.22:                         ; preds = %ctrl1
  %5 = call i32 @encode_one_slice.22(i32 %SliceGroupId, %struct.Picture* %pic)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_encode_one_slice.5, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_encode_one_slice.7, label %func_encode_one_slice.22
}
...
func_init_slice.14:                               ; preds = %ctrl0
  call void @init_slice.14(i32 %start_mb_addr)
  ret void

func_init_slice.24:                               ; preds = %ctrl1
  call void @init_slice.24(i32 %start_mb_addr)
  ret void

func_init_slice.26:                               ; preds = %ctrl1
  call void @init_slice.26(i32 %start_mb_addr)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_init_slice.14, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_init_slice.24, label %func_init_slice.26
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_free_slice_list.8, label %func_free_slice_list.12

func_free_slice_list.8:                           ; preds = %rand_bb
  call void @free_slice_list.8(%struct.Picture* %currPic)
  ret void

func_free_slice_list.12:                          ; preds = %rand_bb
  call void @free_slice_list.12(%struct.Picture* %currPic)
  ret void
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_free_slice.21, label %ctrl0

func_free_slice.21:                               ; preds = %rand_bb
  call void @free_slice.21(%struct.Slice* %slice)
  ret void

func_free_slice.23:                               ; preds = %ctrl0
  call void @free_slice.23(%struct.Slice* %slice)
  ret void

func_free_slice.33:                               ; preds = %ctrl1
  call void @free_slice.33(%struct.Slice* %slice)
  ret void

func_free_slice.34:                               ; preds = %ctrl1
  call void @free_slice.34(%struct.Slice* %slice)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_free_slice.23, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_free_slice.33, label %func_free_slice.34
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_modify_redundant_pic_cnt.9, label %func_modify_redundant_pic_cnt.19

func_modify_redundant_pic_cnt.9:                  ; preds = %rand_bb
  call void @modify_redundant_pic_cnt.9(i8* %buffer)
  ret void

func_modify_redundant_pic_cnt.19:                 ; preds = %rand_bb
  call void @modify_redundant_pic_cnt.19(i8* %buffer)
  ret void
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_poc_ref_pic_reorder.10, label %ctrl0

func_poc_ref_pic_reorder.10:                      ; preds = %rand_bb
  call void @poc_ref_pic_reorder.10(%struct.storable_picture** %list, i32 %num_ref_idx_lX_active, i32* %remapping_of_pic_nums_idc, i32* %abs_diff_pic_num_minus1, i32* %long_term_pic_idx, i32 %weighted_prediction, i32 %list_no)
  ret void

func_poc_ref_pic_reorder.17:                      ; preds = %ctrl0
  call void @poc_ref_pic_reorder.17(%struct.storable_picture** %list, i32 %num_ref_idx_lX_active, i32* %remapping_of_pic_nums_idc, i32* %abs_diff_pic_num_minus1, i32* %long_term_pic_idx, i32 %weighted_prediction, i32 %list_no)
  ret void

func_poc_ref_pic_reorder.18:                      ; preds = %ctrl1
  call void @poc_ref_pic_reorder.18(%struct.storable_picture** %list, i32 %num_ref_idx_lX_active, i32* %remapping_of_pic_nums_idc, i32* %abs_diff_pic_num_minus1, i32* %long_term_pic_idx, i32 %weighted_prediction, i32 %list_no)
  ret void

func_poc_ref_pic_reorder.25:                      ; preds = %ctrl1
  call void @poc_ref_pic_reorder.25(%struct.storable_picture** %list, i32 %num_ref_idx_lX_active, i32* %remapping_of_pic_nums_idc, i32* %abs_diff_pic_num_minus1, i32* %long_term_pic_idx, i32 %weighted_prediction, i32 %list_no)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_poc_ref_pic_reorder.17, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_poc_ref_pic_reorder.18, label %func_poc_ref_pic_reorder.25
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_malloc_slice.27, label %ctrl0

func_malloc_slice.27:                             ; preds = %rand_bb
  %2 = call %struct.Slice* @malloc_slice.27()
  ret %struct.Slice* %2

func_malloc_slice.28:                             ; preds = %ctrl0
  %3 = call %struct.Slice* @malloc_slice.28()
  ret %struct.Slice* %3

func_malloc_slice.31:                             ; preds = %ctrl1
  %4 = call %struct.Slice* @malloc_slice.31()
  ret %struct.Slice* %4

func_malloc_slice.32:                             ; preds = %ctrl1
  %5 = call %struct.Slice* @malloc_slice.32()
  ret %struct.Slice* %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_malloc_slice.28, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_malloc_slice.31, label %func_malloc_slice.32
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_set_ref_pic_num.15, label %func_set_ref_pic_num.20

func_set_ref_pic_num.15:                          ; preds = %rand_bb
  call void @set_ref_pic_num.15()
  ret void

func_set_ref_pic_num.20:                          ; preds = %rand_bb
  call void @set_ref_pic_num.20()
  ret void
}
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @terminate_slice.1() #0 {
entry:
  %i = alloca i32, align 4
  %currSlice = alloca %struct.Slice*, align 8
  %bytes_written = alloca i32, align 4
  %canary = alloca i32
  store i32 1490146193, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 384165248, i32* %canary
  %currStream = alloca %struct.Bitstream*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @encode_one_slice.3(i32 %SliceGroupId, %struct.Picture* %pic) #0 {
entry:
  %FrameRDCost = alloca double, align 8
  %SliceGroupId.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1654446753, i32* %canary
...
while.end:                                        ; preds = %while.cond
  ...
  %137 = icmp eq i32 %136, 1654446753
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @start_slice.4() #0 {
entry:
  %canary = alloca i32
  store i32 2059736083, i32* %canary
  %eep = alloca %struct.EncodingEnvironment*, align 8
  %currSlice = alloca %struct.Slice*, align 8
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @encode_one_slice.5(i32 %SliceGroupId, %struct.Picture* %pic) #0 {
entry:
  %len = alloca i32, align 4
  %CurrentMbAddr = alloca i32, align 4
  %FieldRDCost = alloca double, align 8
  ...
  %SliceGroupId.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1527144203, i32* %canary
  %end_of_slice = alloca i32, align 4
  %pic.addr = alloca %struct.Picture*, align 8
  %FrameRDCost = alloca double, align 8
  %NumberOfCodedMBs = alloca i32, align 4
...
while.end:                                        ; preds = %while.cond
  ...
  %135 = load i32, i32* %NumberOfCodedMBs, align 4
  %136 = load i32, i32* %canary
  %137 = icmp eq i32 %136, 1527144203
  br i1 %137, label %138, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @start_slice.6() #0 {
entry:
  %eep = alloca %struct.EncodingEnvironment*, align 8
  %currStream = alloca %struct.Bitstream*, align 8
  %currSlice = alloca %struct.Slice*, align 8
  ...
  %NumberOfPartitions = alloca i32, align 4
  %canary = alloca i32
  store i32 1036117364, i32* %canary
  %i = alloca i32, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %currentSlice = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 50
  %1 = load %struct.Slice*, %struct.Slice** %currentSlice, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @encode_one_slice.7(i32 %SliceGroupId, %struct.Picture* %pic) #0 {
entry:
  %SliceGroupId.addr = alloca i32, align 4
  %end_of_slice = alloca i32, align 4
  %recode_macroblock = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_slice_list.8(%struct.Picture* %currPic) #0 {
entry:
  %canary = alloca i32
  store i32 658522828, i32* %canary
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @modify_redundant_pic_cnt.9(i8* %buffer) #0 {
entry:
  %canary = alloca i32
  store i32 989139673, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @poc_ref_pic_reorder.10(%struct.storable_picture** %list, i32 %num_ref_idx_lX_active, i32* %remapping_of_pic_nums_idc, i32* %abs_diff_pic_num_minus1, i32* %long_term_pic_idx, i32 %weighted_prediction, i32 %list_no) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 1078683953, i32* %canary
...
if.end240:                                        ; preds = %if.end239, %for.end135
  ...
  %188 = icmp eq i32 %187, 1078683953
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @terminate_slice.11() #0 {
entry:
  %currSlice = alloca %struct.Slice*, align 8
  %currStream = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 1018175780, i32* %canary
  %bytes_written = alloca i32, align 4
  %i = alloca i32, align 4
  %eep = alloca %struct.EncodingEnvironment*, align 8
  %byte_pos_before_startcode_emu_prevention = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_slice_list.12(%struct.Picture* %currPic) #0 {
entry:
  %canary = alloca i32
  store i32 960034392, i32* %canary
  %currPic.addr = alloca %struct.Picture*, align 8
  %i = alloca i32, align 4
  store %struct.Picture* %currPic, %struct.Picture** %currPic.addr, align 8
  store i32 0, i32* %i, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @terminate_slice.13() #0 {
entry:
  %byte_pos_before_startcode_emu_prevention = alloca i32, align 4
  %eep = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 1928233811, i32* %canary
  %bytes_written = alloca i32, align 4
  %i = alloca i32, align 4
  %currStream = alloca %struct.Bitstream*, align 8
  %currSlice = alloca %struct.Slice*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @init_slice.14(i32 %start_mb_addr) #0 {
entry:
  %num_ref = alloca i32, align 4
  %currPic = alloca %struct.Picture*, align 8
  %i100 = alloca i32, align 4
  ...
  %currStream = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 1736233269, i32* %canary
  %currSlice = alloca %struct.Slice*, align 8
  store i32 %start_mb_addr, i32* %start_mb_addr.addr, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %currentPicture = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 49
...
if.end206:                                        ; preds = %if.then205, %if.end202
  %229 = load i32, i32* %canary
  %230 = icmp eq i32 %229, 1736233269
  br i1 %230, label %231, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @set_ref_pic_num.15() #0 {
entry:
  %canary = alloca i32
  store i32 554169986, i32* %canary
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  store i32 0, i32* %i, align 4
  br label %for.cond
...
entry:
  %canary = alloca i32
  store i32 307811278, i32* %canary
  %i = alloca i32, align 4
  %eep = alloca %struct.EncodingEnvironment*, align 8
  %bytes_written = alloca i32, align 4
  %currStream = alloca %struct.Bitstream*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @poc_ref_pic_reorder.17(%struct.storable_picture** %list, i32 %num_ref_idx_lX_active, i32* %remapping_of_pic_nums_idc, i32* %abs_diff_pic_num_minus1, i32* %long_term_pic_idx, i32 %weighted_prediction, i32 %list_no) #0 {
entry:
  %re_order = alloca [32 x i32], align 16
  %poc_diff = alloca [32 x i32], align 16
  %k = alloca i32, align 4
  ...
  %tmp_value = alloca i32, align 4
  %canary = alloca i32
  store i32 1316527946, i32* %canary
  %picNumLXPred = alloca i32, align 4
  %j = alloca i32, align 4
  %currPicNum = alloca i32, align 4
  store %struct.storable_picture** %list, %struct.storable_picture*** %list.addr, align 8
...
if.end240:                                        ; preds = %if.end239, %for.end135
  %187 = load i32, i32* %canary
  %188 = icmp eq i32 %187, 1316527946
  br i1 %188, label %189, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @poc_ref_pic_reorder.18(%struct.storable_picture** %list, i32 %num_ref_idx_lX_active, i32* %remapping_of_pic_nums_idc, i32* %abs_diff_pic_num_minus1, i32* %long_term_pic_idx, i32 %weighted_prediction, i32 %list_no) #0 {
entry:
  %maxPicNum = alloca i32, align 4
  %canary = alloca i32
  store i32 335820889, i32* %canary
  %num_ref_idx_lX_active.addr = alloca i32, align 4
  %j = alloca i32, align 4
  %currPicNum = alloca i32, align 4
  %list.addr = alloca %struct.storable_picture**, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @modify_redundant_pic_cnt.19(i8* %buffer) #0 {
entry:
  %canary = alloca i32
  store i32 935238837, i32* %canary
  %buffer.addr = alloca i8*, align 8
  %tmp = alloca i8, align 1
  store i8* %buffer, i8** %buffer.addr, align 8
  %0 = load i32, i32* @rpc_bits_to_go, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @set_ref_pic_num.20() #0 {
entry:
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1182320737, i32* %canary
  %i = alloca i32, align 4
  store i32 0, i32* %i, align 4
  br label %for.cond
...
if.end158:                                        ; preds = %if.end, %for.end79
  %112 = load i32, i32* %canary
  %113 = icmp eq i32 %112, 1182320737
  br i1 %113, label %114, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @free_slice.21(%struct.Slice* %slice) #0 {
entry:
  %dataPart = alloca %struct.datapartition*, align 8
  %slice.addr = alloca %struct.Slice*, align 8
  %canary = alloca i32
  store i32 1268437655, i32* %canary
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @encode_one_slice.22(i32 %SliceGroupId, %struct.Picture* %pic) #0 {
entry:
  %recode_macroblock = alloca i32, align 4
  %end_of_slice = alloca i32, align 4
  %CurrentMbAddr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @free_slice.23(%struct.Slice* %slice) #0 {
entry:
  %canary = alloca i32
  store i32 739880304, i32* %canary
  %i = alloca i32, align 4
  %dataPart = alloca %struct.datapartition*, align 8
  %slice.addr = alloca %struct.Slice*, align 8
  store %struct.Slice* %slice, %struct.Slice** %slice.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @init_slice.24(i32 %start_mb_addr) #0 {
entry:
  %i = alloca i32, align 4
  %currPic = alloca %struct.Picture*, align 8
  %num_ref = alloca i32, align 4
  %canary = alloca i32
  store i32 1383962511, i32* %canary
  %currStream = alloca %struct.Bitstream*, align 8
  %i100 = alloca i32, align 4
  %currSlice = alloca %struct.Slice*, align 8
  %dataPart = alloca %struct.datapartition*, align 8
...
if.end206:                                        ; preds = %if.then205, %if.end202
  %229 = load i32, i32* %canary
  %230 = icmp eq i32 %229, 1383962511
  br i1 %230, label %231, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @poc_ref_pic_reorder.25(%struct.storable_picture** %list, i32 %num_ref_idx_lX_active, i32* %remapping_of_pic_nums_idc, i32* %abs_diff_pic_num_minus1, i32* %long_term_pic_idx, i32 %weighted_prediction, i32 %list_no) #0 {
entry:
  %picNumLXPred = alloca i32, align 4
  %list.addr = alloca %struct.storable_picture**, align 8
  %no_reorder = alloca i32, align 4
  ...
  %abs_poc_dist = alloca i32, align 4
  %canary = alloca i32
  store i32 905528670, i32* %canary
  %reorder_stop = alloca i32, align 4
  %k = alloca i32, align 4
  %j = alloca i32, align 4
  %list_no.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @init_slice.26(i32 %start_mb_addr) #0 {
entry:
  %num_ref = alloca i32, align 4
  %currSlice = alloca %struct.Slice*, align 8
  %dataPart = alloca %struct.datapartition*, align 8
  ...
  %currPic = alloca %struct.Picture*, align 8
  %canary = alloca i32
  store i32 514325902, i32* %canary
  %currStream = alloca %struct.Bitstream*, align 8
  %start_mb_addr.addr = alloca i32, align 4
  %i100 = alloca i32, align 4
  store i32 %start_mb_addr, i32* %start_mb_addr.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal %struct.Slice* @malloc_slice.27() #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 712561162, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal %struct.Slice* @malloc_slice.28() #0 {
entry:
  %slice = alloca %struct.Slice*, align 8
  %dataPart = alloca %struct.datapartition*, align 8
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1164051394, i32* %canary
  %buffer_size = alloca i32, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %width = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 13
  %1 = load i32, i32* %width, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @start_slice.29() #0 {
entry:
  %header_len = alloca i32, align 4
  %i = alloca i32, align 4
  %currStream = alloca %struct.Bitstream*, align 8
  %currSlice = alloca %struct.Slice*, align 8
  %canary = alloca i32
  store i32 825940473, i32* %canary
  %NumberOfPartitions = alloca i32, align 4
  %eep = alloca %struct.EncodingEnvironment*, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %currentSlice = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 50
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @start_slice.30() #0 {
entry:
  %currStream = alloca %struct.Bitstream*, align 8
  %eep = alloca %struct.EncodingEnvironment*, align 8
  %header_len = alloca i32, align 4
  ...
  %currSlice = alloca %struct.Slice*, align 8
  %canary = alloca i32
  store i32 1043339785, i32* %canary
  %NumberOfPartitions = alloca i32, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %currentSlice = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 50
  %1 = load %struct.Slice*, %struct.Slice** %currentSlice, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal %struct.Slice* @malloc_slice.31() #0 {
entry:
  %dataPart = alloca %struct.datapartition*, align 8
  %slice = alloca %struct.Slice*, align 8
  %buffer_size = alloca i32, align 4
  %canary = alloca i32
  store i32 1006602486, i32* %canary
  %i = alloca i32, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %width = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 13
  %1 = load i32, i32* %width, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal %struct.Slice* @malloc_slice.32() #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1727896989, i32* %canary
  %dataPart = alloca %struct.datapartition*, align 8
  %buffer_size = alloca i32, align 4
  %slice = alloca %struct.Slice*, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @free_slice.33(%struct.Slice* %slice) #0 {
entry:
  %slice.addr = alloca %struct.Slice*, align 8
  %canary = alloca i32
  store i32 652353280, i32* %canary
  %i = alloca i32, align 4
  %dataPart = alloca %struct.datapartition*, align 8
  store %struct.Slice* %slice, %struct.Slice** %slice.addr, align 8
  %0 = load %struct.Slice*, %struct.Slice** %slice.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @free_slice.34(%struct.Slice* %slice) #0 {
entry:
  %canary = alloca i32
  store i32 1694838453, i32* %canary
  %i = alloca i32, align 4
  %slice.addr = alloca %struct.Slice*, align 8
  %dataPart = alloca %struct.datapartition*, align 8
  store %struct.Slice* %slice, %struct.Slice** %slice.addr, align 8
