...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_testEndian.14, label %func_testEndian.18

func_testEndian.14:                               ; preds = %rand_bb
  %2 = call i32 @testEndian.14()
  ret i32 %2

func_testEndian.18:                               ; preds = %rand_bb
  %3 = call i32 @testEndian.18()
  ret i32 %3
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_img2buf.7, label %ctrl0

func_img2buf.7:                                   ; preds = %rand_bb
  call void @img2buf.7(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom)
  ret void

func_img2buf.9:                                   ; preds = %ctrl0
...
func_img2buf.10:                                  ; preds = %ctrl1
  call void @img2buf.10(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom)
  ret void

func_img2buf.16:                                  ; preds = %ctrl2
...
func_img2buf.21:                                  ; preds = %ctrl4
  call void @img2buf.21(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom)
  ret void

func_img2buf.26:                                  ; preds = %ctrl5
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_img2buf.9, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_img2buf.10, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_img2buf.16, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_img2buf.20, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_img2buf.21, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_img2buf.26, label %func_img2buf.33
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_write_picture.13, label %ctrl0

func_write_picture.13:                            ; preds = %rand_bb
  call void @write_picture.13(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure)
  ret void

func_write_picture.19:                            ; preds = %ctrl0
  call void @write_picture.19(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure)
  ret void
...
func_write_picture.28:                            ; preds = %ctrl3
  call void @write_picture.28(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure)
  ret void

func_write_picture.34:                            ; preds = %ctrl3
  call void @write_picture.34(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_write_picture.19, label %ctrl1
...
ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_write_picture.28, label %func_write_picture.34
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_write_out_picture.2, label %ctrl0

func_write_out_picture.2:                         ; preds = %rand_bb
  call void @write_out_picture.2(%struct.storable_picture* %p, i32 %p_out)
  ret void
...
func_write_out_picture.35:                        ; preds = %ctrl5
  call void @write_out_picture.35(%struct.storable_picture* %p, i32 %p_out)
  ret void

func_write_out_picture.36:                        ; preds = %ctrl5
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_write_out_picture.29, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_write_out_picture.30, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_write_out_picture.31, label %ctrl4
...
ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_write_out_picture.35, label %func_write_out_picture.36
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_clear_picture.15, label %func_clear_picture.25

func_clear_picture.15:                            ; preds = %rand_bb
  call void @clear_picture.15(%struct.storable_picture* %p)
  ret void

func_clear_picture.25:                            ; preds = %rand_bb
  call void @clear_picture.25(%struct.storable_picture* %p)
  ret void
}
...
func_write_unpaired_field.5:                      ; preds = %ctrl1
  call void @write_unpaired_field.5(%struct.frame_store* %fs, i32 %p_out)
  ret void

func_write_unpaired_field.11:                     ; preds = %ctrl2
  call void @write_unpaired_field.11(%struct.frame_store* %fs, i32 %p_out)
  ret void

func_write_unpaired_field.12:                     ; preds = %ctrl3
  call void @write_unpaired_field.12(%struct.frame_store* %fs, i32 %p_out)
  ret void

func_write_unpaired_field.17:                     ; preds = %ctrl3
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_write_unpaired_field.5, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_write_unpaired_field.11, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_write_unpaired_field.12, label %func_write_unpaired_field.17
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_write_stored_frame.4, label %func_write_stored_frame.8

func_write_stored_frame.4:                        ; preds = %rand_bb
  call void @write_stored_frame.4(%struct.frame_store* %fs, i32 %p_out)
  ret void

func_write_stored_frame.8:                        ; preds = %rand_bb
  call void @write_stored_frame.8(%struct.frame_store* %fs, i32 %p_out)
  ret void
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_direct_output.22, label %func_direct_output.27

func_direct_output.22:                            ; preds = %rand_bb
  call void @direct_output.22(%struct.storable_picture* %p, i32 %p_out)
  ret void

func_direct_output.27:                            ; preds = %rand_bb
  call void @direct_output.27(%struct.storable_picture* %p, i32 %p_out)
  ret void
}
...
entry:
  ...
  %canary = alloca i32
  store i32 996502356, i32* %canary
  %p_out.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_out_picture.2(%struct.storable_picture* %p, i32 %p_out) #0 {
entry:
  %crop_top = alloca i32, align 4
  %SubHeightC = alloca [4 x i32], align 16
  %rgb_output = alloca i32, align 4
  %canary = alloca i32
  store i32 1596641391, i32* %canary
...
return:                                           ; preds = %if.end139, %if.then
  ...
  %193 = icmp eq i32 %192, 1596641391
...
entry:
  %canary = alloca i32
  store i32 1977795761, i32* %canary
  %p_out.addr = alloca i32, align 4
  %fs.addr = alloca %struct.frame_store*, align 8
  %p = alloca %struct.storable_picture*, align 8
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_stored_frame.4(%struct.frame_store* %fs, i32 %p_out) #0 {
entry:
  %canary = alloca i32
  store i32 908866194, i32* %canary
  %p_out.addr = alloca i32, align 4
  %fs.addr = alloca %struct.frame_store*, align 8
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  ...
  %p = alloca %struct.storable_picture*, align 8
  %canary = alloca i32
  store i32 870913730, i32* %canary
  %p_out.addr = alloca i32, align 4
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  %0 = load %struct.frame_store*, %struct.frame_store** %fs.addr, align 8
...
entry:
  ...
  %crop_right = alloca i32, align 4
  %canary = alloca i32
  store i32 1154446862, i32* %canary
  %crop_bottom = alloca i32, align 4
  %crop_left = alloca i32, align 4
  %symbol_size_in_bytes = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1154446862
  br i1 %193, label %194, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @img2buf.7(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 707292788, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_stored_frame.8(%struct.frame_store* %fs, i32 %p_out) #0 {
entry:
  %canary = alloca i32
  store i32 1936593825, i32* %canary
  %fs.addr = alloca %struct.frame_store*, align 8
  %p_out.addr = alloca i32, align 4
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  ...
  %tmp16 = alloca i16, align 2
  %canary = alloca i32
  store i32 1679901062, i32* %canary
  %size_y.addr = alloca i32, align 4
  %tmp32 = alloca i64, align 8
  %theight = alloca i32, align 4
  %i = alloca i32, align 4
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1679901062
  br i1 %109, label %110, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @img2buf.10(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom) #0 {
entry:
  %tmp16 = alloca i16, align 2
  %crop_left.addr = alloca i32, align 4
  %imgX.addr = alloca i16**, align 8
  ...
  %symbol_size_in_bytes.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1363506748, i32* %canary
  %size_x.addr = alloca i32, align 4
  %twidth = alloca i32, align 4
  %tmp32 = alloca i64, align 8
  %ui8 = alloca i8, align 1
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1363506748
  br i1 %109, label %110, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_unpaired_field.11(%struct.frame_store* %fs, i32 %p_out) #0 {
entry:
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 893172651, i32* %canary
  %p = alloca %struct.storable_picture*, align 8
  %fs.addr = alloca %struct.frame_store*, align 8
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  ...
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 306152766, i32* %canary
  %fs.addr = alloca %struct.frame_store*, align 8
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  %0 = load %struct.frame_store*, %struct.frame_store** %fs.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_picture.13(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure) #0 {
entry:
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1138512256, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @testEndian.14() #0 {
entry:
  %s = alloca i16, align 2
  %canary = alloca i32
  store i32 404771988, i32* %canary
  %p = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @clear_picture.15(%struct.storable_picture* %p) #0 {
entry:
  %p.addr = alloca %struct.storable_picture*, align 8
  %canary = alloca i32
  store i32 768086075, i32* %canary
  %i = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
...
entry:
  ...
  %crop_top.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 783532767, i32* %canary
  %crop_bottom.addr = alloca i32, align 4
  %tmp32 = alloca i64, align 8
  %crop_left.addr = alloca i32, align 4
  %ui8 = alloca i8, align 1
...
entry:
  %canary = alloca i32
  store i32 1437706202, i32* %canary
  %fs.addr = alloca %struct.frame_store*, align 8
  %p_out.addr = alloca i32, align 4
  %p = alloca %struct.storable_picture*, align 8
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @testEndian.18() #0 {
entry:
  %p = alloca i8*, align 8
  %canary = alloca i32
  store i32 1829088306, i32* %canary
  %s = alloca i16, align 2
  %0 = bitcast i16* %s to i8*
  store i8* %0, i8** %p, align 8
  store i16 1, i16* %s, align 2
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_picture.19(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure) #0 {
entry:
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1634105546, i32* %canary
  %real_structure.addr = alloca i32, align 4
  %p.addr = alloca %struct.storable_picture*, align 8
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  ...
  %size_y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 412795993, i32* %canary
  %theight = alloca i32, align 4
  %ui8 = alloca i8, align 1
  store i16** %imgX, i16*** %imgX.addr, align 8
  store i8* %buf, i8** %buf.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @img2buf.21(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom) #0 {
entry:
  %tmp16 = alloca i16, align 2
  %crop_right.addr = alloca i32, align 4
  %crop_bottom.addr = alloca i32, align 4
  ...
  %crop_left.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 213368501, i32* %canary
  %symbol_size_in_bytes.addr = alloca i32, align 4
  %size_y.addr = alloca i32, align 4
  %imgX.addr = alloca i16**, align 8
  store i16** %imgX, i16*** %imgX.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 151238059, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  %p_out.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  ...
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2093807472, i32* %canary
  %real_structure.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  store i32 %real_structure, i32* %real_structure.addr, align 4
...
entry:
  %real_structure.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 425551104, i32* %canary
  %p_out.addr = alloca i32, align 4
  %p.addr = alloca %struct.storable_picture*, align 8
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @clear_picture.25(%struct.storable_picture* %p) #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1291032733, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 0, i32* %i, align 4
  br label %for.cond
...
entry:
  ...
  %crop_left.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 726186269, i32* %canary
  %imgX.addr = alloca i16**, align 8
  %theight = alloca i32, align 4
  %size_y.addr = alloca i32, align 4
  %ui16 = alloca i16, align 2
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @direct_output.27(%struct.storable_picture* %p, i32 %p_out) #0 {
entry:
  %canary = alloca i32
  store i32 999030728, i32* %canary
  %p_out.addr = alloca i32, align 4
  %p.addr = alloca %struct.storable_picture*, align 8
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_picture.28(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure) #0 {
entry:
  %p.addr = alloca %struct.storable_picture*, align 8
  %real_structure.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1258241246, i32* %canary
  %p_out.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  store i32 %real_structure, i32* %real_structure.addr, align 4
...
entry:
  ...
  %buf = alloca i8*, align 8
  %canary = alloca i32
  store i32 966526777, i32* %canary
  %crop_top = alloca i32, align 4
  %crop_right = alloca i32, align 4
  %SubWidthC = alloca [4 x i32], align 16
  %crop_bottom = alloca i32, align 4
...
entry:
  ...
  %crop_bottom = alloca i32, align 4
  %canary = alloca i32
  store i32 1661628329, i32* %canary
  %p_out.addr = alloca i32, align 4
  %rgb_output = alloca i32, align 4
  %crop_left = alloca i32, align 4
  %SubHeightC = alloca [4 x i32], align 16
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1661628329
  br i1 %193, label %194, label %func_exit
...
entry:
  ...
  %crop_top = alloca i32, align 4
  %canary = alloca i32
  store i32 1853719296, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  %SubWidthC = alloca [4 x i32], align 16
  %crop_left = alloca i32, align 4
  %rgb_output = alloca i32, align 4
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1853719296
  br i1 %193, label %194, label %func_exit
...
entry:
  ...
  %crop_right = alloca i32, align 4
  %canary = alloca i32
  store i32 392726011, i32* %canary
  %rgb_output = alloca i32, align 4
  %crop_top = alloca i32, align 4
  %buf = alloca i8*, align 8
  %crop_bottom = alloca i32, align 4
...
entry:
  ...
  %twidth = alloca i32, align 4
  %canary = alloca i32
  store i32 1119344207, i32* %canary
  %j = alloca i32, align 4
  %crop_left.addr = alloca i32, align 4
  %theight = alloca i32, align 4
  %size = alloca i32, align 4
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1119344207
  br i1 %109, label %110, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_picture.34(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure) #0 {
entry:
  %canary = alloca i32
  store i32 1619354443, i32* %canary
  %real_structure.addr = alloca i32, align 4
  %p.addr = alloca %struct.storable_picture*, align 8
  %p_out.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
...
entry:
  ...
  %crop_left = alloca i32, align 4
  %canary = alloca i32
  store i32 1001708164, i32* %canary
  %crop_bottom = alloca i32, align 4
  %SubWidthC = alloca [4 x i32], align 16
  %p_out.addr = alloca i32, align 4
  %symbol_size_in_bytes = alloca i32, align 4
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1001708164
  br i1 %193, label %194, label %func_exit
...
entry:
  ...
  %symbol_size_in_bytes = alloca i32, align 4
  %canary = alloca i32
  store i32 1761529813, i32* %canary
  %crop_top = alloca i32, align 4
  %p.addr = alloca %struct.storable_picture*, align 8
  %p_out.addr = alloca i32, align 4
  %crop_bottom = alloca i32, align 4
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1761529813
  br i1 %193, label %194, label %func_exit
