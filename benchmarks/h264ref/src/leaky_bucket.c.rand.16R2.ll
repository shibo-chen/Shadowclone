; ModuleID = 'leaky_bucket.c.rand.16R2.bc'
...
func_get_LeakyBucketRate.8:                       ; preds = %ctrl0
  %3 = call i32 @get_LeakyBucketRate.8(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret i32 %3

func_get_LeakyBucketRate.12:                      ; preds = %ctrl1
  %4 = call i32 @get_LeakyBucketRate.12(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret i32 %4

func_get_LeakyBucketRate.13:                      ; preds = %ctrl2
  %5 = call i32 @get_LeakyBucketRate.13(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret i32 %5

func_get_LeakyBucketRate.15:                      ; preds = %ctrl3
  %6 = call i32 @get_LeakyBucketRate.15(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret i32 %6

func_get_LeakyBucketRate.17:                      ; preds = %ctrl4
  %7 = call i32 @get_LeakyBucketRate.17(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret i32 %7

func_get_LeakyBucketRate.18:                      ; preds = %ctrl5
  %8 = call i32 @get_LeakyBucketRate.18(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret i32 %8
...
func_get_LeakyBucketRate.31:                      ; preds = %ctrl9
  %12 = call i32 @get_LeakyBucketRate.31(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret i32 %12

func_get_LeakyBucketRate.37:                      ; preds = %ctrl10
  %13 = call i32 @get_LeakyBucketRate.37(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret i32 %13
...
func_get_LeakyBucketRate.47:                      ; preds = %ctrl12
  %15 = call i32 @get_LeakyBucketRate.47(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret i32 %15

func_get_LeakyBucketRate.49:                      ; preds = %ctrl13
  %16 = call i32 @get_LeakyBucketRate.49(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret i32 %16

func_get_LeakyBucketRate.50:                      ; preds = %ctrl13
  %17 = call i32 @get_LeakyBucketRate.50(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret i32 %17

ctrl0:                                            ; preds = %rand_bb
  %18 = icmp eq i32 %0, 1
  br i1 %18, label %func_get_LeakyBucketRate.8, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %19 = icmp eq i32 %0, 2
  br i1 %19, label %func_get_LeakyBucketRate.12, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %20 = icmp eq i32 %0, 3
  br i1 %20, label %func_get_LeakyBucketRate.13, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %21 = icmp eq i32 %0, 4
  br i1 %21, label %func_get_LeakyBucketRate.15, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %22 = icmp eq i32 %0, 5
  br i1 %22, label %func_get_LeakyBucketRate.17, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %23 = icmp eq i32 %0, 6
  br i1 %23, label %func_get_LeakyBucketRate.18, label %ctrl6
...
ctrl9:                                            ; preds = %ctrl8
  %27 = icmp eq i32 %0, 10
  br i1 %27, label %func_get_LeakyBucketRate.31, label %ctrl10

ctrl10:                                           ; preds = %ctrl9
  %28 = icmp eq i32 %0, 11
  br i1 %28, label %func_get_LeakyBucketRate.37, label %ctrl11
...
ctrl12:                                           ; preds = %ctrl11
  %30 = icmp eq i32 %0, 13
  br i1 %30, label %func_get_LeakyBucketRate.47, label %ctrl13

ctrl13:                                           ; preds = %ctrl12
  %31 = icmp eq i32 %0, 14
  br i1 %31, label %func_get_LeakyBucketRate.49, label %func_get_LeakyBucketRate.50
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_PutBigDoubleWord.3, label %func_PutBigDoubleWord.9

func_PutBigDoubleWord.3:                          ; preds = %rand_bb
  call void @PutBigDoubleWord.3(i64 %dw, %struct._IO_FILE* %fp)
  ret void

func_PutBigDoubleWord.9:                          ; preds = %rand_bb
  call void @PutBigDoubleWord.9(i64 %dw, %struct._IO_FILE* %fp)
  ret void
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_write_buffer.2, label %ctrl0

func_write_buffer.2:                              ; preds = %rand_bb
  call void @write_buffer.2(i64 %NumberLeakyBuckets, i64* %Rmin, i64* %Bmin, i64* %Fmin)
  ret void

func_write_buffer.11:                             ; preds = %ctrl0
  call void @write_buffer.11(i64 %NumberLeakyBuckets, i64* %Rmin, i64* %Bmin, i64* %Fmin)
  ret void

func_write_buffer.30:                             ; preds = %ctrl1
  call void @write_buffer.30(i64 %NumberLeakyBuckets, i64* %Rmin, i64* %Bmin, i64* %Fmin)
  ret void

func_write_buffer.33:                             ; preds = %ctrl2
  call void @write_buffer.33(i64 %NumberLeakyBuckets, i64* %Rmin, i64* %Bmin, i64* %Fmin)
  ret void

func_write_buffer.38:                             ; preds = %ctrl3
  call void @write_buffer.38(i64 %NumberLeakyBuckets, i64* %Rmin, i64* %Bmin, i64* %Fmin)
  ret void

func_write_buffer.40:                             ; preds = %ctrl4
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_write_buffer.11, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_write_buffer.30, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_write_buffer.33, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_write_buffer.38, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_write_buffer.40, label %ctrl5
...
ctrl7:                                            ; preds = %ctrl6
  %9 = icmp eq i32 %0, 8
  br i1 %9, label %func_write_buffer.53, label %ctrl8

ctrl8:                                            ; preds = %ctrl7
  %10 = icmp eq i32 %0, 9
  br i1 %10, label %func_write_buffer.54, label %ctrl9

ctrl9:                                            ; preds = %ctrl8
  %11 = icmp eq i32 %0, 10
  br i1 %11, label %func_write_buffer.57, label %ctrl10

ctrl10:                                           ; preds = %ctrl9
  %12 = icmp eq i32 %0, 11
  br i1 %12, label %func_write_buffer.60, label %ctrl11

ctrl11:                                           ; preds = %ctrl10
  %13 = icmp eq i32 %0, 12
  br i1 %13, label %func_write_buffer.62, label %ctrl12
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_Sort.6, label %ctrl0

func_Sort.6:                                      ; preds = %rand_bb
  call void @Sort.6(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret void

func_Sort.14:                                     ; preds = %ctrl0
  call void @Sort.14(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret void

func_Sort.16:                                     ; preds = %ctrl1
  call void @Sort.16(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret void

func_Sort.21:                                     ; preds = %ctrl2
...
func_Sort.45:                                     ; preds = %ctrl10
  call void @Sort.45(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret void

func_Sort.55:                                     ; preds = %ctrl11
...
func_Sort.58:                                     ; preds = %ctrl13
  call void @Sort.58(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_Sort.14, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_Sort.16, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_Sort.21, label %ctrl3
...
ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_Sort.28, label %ctrl6

ctrl6:                                            ; preds = %ctrl5
  %8 = icmp eq i32 %0, 7
  br i1 %8, label %func_Sort.29, label %ctrl7

ctrl7:                                            ; preds = %ctrl6
  %9 = icmp eq i32 %0, 8
  br i1 %9, label %func_Sort.34, label %ctrl8

ctrl8:                                            ; preds = %ctrl7
  %10 = icmp eq i32 %0, 9
  br i1 %10, label %func_Sort.35, label %ctrl9
...
ctrl10:                                           ; preds = %ctrl9
  %12 = icmp eq i32 %0, 11
  br i1 %12, label %func_Sort.45, label %ctrl11

ctrl11:                                           ; preds = %ctrl10
  %13 = icmp eq i32 %0, 12
  br i1 %13, label %func_Sort.55, label %ctrl12
...
ctrl13:                                           ; preds = %ctrl12
  %15 = icmp eq i32 %0, 14
  br i1 %15, label %func_Sort.58, label %func_Sort.61
}
...
func_calc_buffer.10:                              ; preds = %ctrl2
  call void @calc_buffer.10()
  ret void

func_calc_buffer.19:                              ; preds = %ctrl3
  call void @calc_buffer.19()
  ret void

func_calc_buffer.20:                              ; preds = %ctrl4
  call void @calc_buffer.20()
  ret void

func_calc_buffer.22:                              ; preds = %ctrl5
  call void @calc_buffer.22()
  ret void

func_calc_buffer.32:                              ; preds = %ctrl6
  call void @calc_buffer.32()
  ret void

func_calc_buffer.39:                              ; preds = %ctrl7
  call void @calc_buffer.39()
  ret void
...
func_calc_buffer.51:                              ; preds = %ctrl11
  call void @calc_buffer.51()
  ret void

func_calc_buffer.52:                              ; preds = %ctrl12
  call void @calc_buffer.52()
  ret void
...
ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_calc_buffer.10, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_calc_buffer.19, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_calc_buffer.20, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_calc_buffer.22, label %ctrl6

ctrl6:                                            ; preds = %ctrl5
  %8 = icmp eq i32 %0, 7
  br i1 %8, label %func_calc_buffer.32, label %ctrl7

ctrl7:                                            ; preds = %ctrl6
  %9 = icmp eq i32 %0, 8
  br i1 %9, label %func_calc_buffer.39, label %ctrl8
...
ctrl11:                                           ; preds = %ctrl10
  %13 = icmp eq i32 %0, 12
  br i1 %13, label %func_calc_buffer.51, label %ctrl12

ctrl12:                                           ; preds = %ctrl11
  %14 = icmp eq i32 %0, 13
  br i1 %14, label %func_calc_buffer.52, label %ctrl13

ctrl13:                                           ; preds = %ctrl12
  %15 = icmp eq i32 %0, 14
  br i1 %15, label %func_calc_buffer.59, label %func_calc_buffer.63
}
...
entry:
  ...
  %canary = alloca i32
  store i32 787993893, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_buffer.2(i64 %NumberLeakyBuckets, i64* %Rmin, i64* %Bmin, i64* %Fmin) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 1027329662, i32* %canary
  %iBucket = alloca i64, align 8
...
entry:
  ...
  %canary = alloca i32
  store i32 345080282, i32* %canary
...
entry:
  ...
  %NumberLeakyBuckets = alloca i64, align 8
  %canary = alloca i32
  store i32 2130916437, i32* %canary
  %InitFullness = alloca i64, align 8
  %Fmin = alloca i64*, align 8
  %AvgRate = alloca i64, align 8
  %iBucket = alloca i64, align 8
...
for.end136:                                       ; preds = %for.cond57
  ...
  call void @free(i8* %148) #3
  %149 = load i32, i32* %canary
  %150 = icmp eq i32 %149, 2130916437
  br i1 %150, label %151, label %func_exit
...
entry:
  ...
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1597649030, i32* %canary
...
entry:
  ...
  %i = alloca i64, align 8
  %canary = alloca i32
  store i32 1404048616, i32* %canary
...
entry:
  ...
  %actualBuffer = alloca i64, align 8
  %canary = alloca i32
  store i32 1267189705, i32* %canary
  %iFrame = alloca i64, align 8
  %minB = alloca i64, align 8
  %InitFullness = alloca i64, align 8
  store i64 0, i64* %FrameIndex, align 8
...
for.end136:                                       ; preds = %for.cond57
  ...
  call void @free(i8* %148) #3
  %149 = load i32, i32* %canary
  %150 = icmp eq i32 %149, 1267189705
  br i1 %150, label %151, label %func_exit
...
entry:
  ...
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1600321863, i32* %canary
  %i = alloca i64, align 8
  %buf = alloca i64, align 8
  %f = alloca %struct._IO_FILE*, align 8
  %Rmin.addr = alloca i64*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @PutBigDoubleWord.9(i64 %dw, %struct._IO_FILE* %fp) #0 {
entry:
  %dw.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1709109114, i32* %canary
  %fp.addr = alloca %struct._IO_FILE*, align 8
  store i64 %dw, i64* %dw.addr, align 8
  store %struct._IO_FILE* %fp, %struct._IO_FILE** %fp.addr, align 8
  %0 = load i64, i64* %dw.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @calc_buffer.10() #0 {
entry:
  %AvgRate = alloca i64, align 8
  %minB = alloca i64, align 8
  %TotalRate = alloca i64, align 8
  ...
  %maxBuffer = alloca i64, align 8
  %canary = alloca i32
  store i32 928275183, i32* %canary
  %InitFullness = alloca i64, align 8
  %Bmin = alloca i64*, align 8
  %iFrame = alloca i64, align 8
  %FrameIndex = alloca i64, align 8
...
entry:
  %Fmin.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 776513667, i32* %canary
  %Rmin.addr = alloca i64*, align 8
  %iBucket = alloca i64, align 8
  %Bmin.addr = alloca i64*, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 292109814, i32* %canary
  %buf = alloca i64, align 8
  %f = alloca %struct._IO_FILE*, align 8
  %Rmin.addr = alloca i64*, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
...
entry:
  %canary = alloca i32
  store i32 526087635, i32* %canary
  %f = alloca %struct._IO_FILE*, align 8
  %retval = alloca i32, align 4
  %buf = alloca i64, align 8
  %i = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Sort.14(i64 %NumberLeakyBuckets, i64* %Rmin) #0 {
entry:
  %temp = alloca i64, align 8
  %canary = alloca i32
  store i32 538322069, i32* %canary
  %Rmin.addr = alloca i64*, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %i = alloca i64, align 8
  %j = alloca i64, align 8
...
entry:
  ...
  %Rmin.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 1344446273, i32* %canary
  %i = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Sort.16(i64 %NumberLeakyBuckets, i64* %Rmin) #0 {
entry:
  %canary = alloca i32
  store i32 1570190901, i32* %canary
  %Rmin.addr = alloca i64*, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %temp = alloca i64, align 8
  %j = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_LeakyBucketRate.17(i64 %NumberLeakyBuckets, i64* %Rmin) #0 {
entry:
  %canary = alloca i32
  store i32 152822227, i32* %canary
  %Rmin.addr = alloca i64*, align 8
  %i = alloca i64, align 8
  %f = alloca %struct._IO_FILE*, align 8
  %retval = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_LeakyBucketRate.18(i64 %NumberLeakyBuckets, i64* %Rmin) #0 {
entry:
  %i = alloca i64, align 8
  %Rmin.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 486883072, i32* %canary
  %retval = alloca i32, align 4
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %buf = alloca i64, align 8
  %f = alloca %struct._IO_FILE*, align 8
...
entry:
  %NumberLeakyBuckets = alloca i64, align 8
  %canary = alloca i32
  store i32 361286507, i32* %canary
  %iFrame = alloca i64, align 8
  %Bmin = alloca i64*, align 8
  %buffer_frame = alloca i64*, align 8
  %TotalRate = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @calc_buffer.20() #0 {
entry:
  %InitFullness = alloca i64, align 8
  %iFrame = alloca i64, align 8
  %canary = alloca i32
  store i32 1789783366, i32* %canary
  %NumberLeakyBuckets = alloca i64, align 8
  %iBucket = alloca i64, align 8
  %minB = alloca i64, align 8
  %actualBuffer = alloca i64, align 8
...
for.end136:                                       ; preds = %for.cond57
  ...
  call void @free(i8* %148) #3
  %149 = load i32, i32* %canary
  %150 = icmp eq i32 %149, 1789783366
  br i1 %150, label %151, label %func_exit
...
entry:
  ...
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 2126268900, i32* %canary
  %i = alloca i64, align 8
  %temp = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
...
entry:
  ...
  %Fmin = alloca i64*, align 8
  %canary = alloca i32
  store i32 1114519915, i32* %canary
  %InitFullness = alloca i64, align 8
  %TotalRate = alloca i64, align 8
  %iFrame = alloca i64, align 8
  %iChannelRate = alloca i64, align 8
...
for.end136:                                       ; preds = %for.cond57
  ...
  call void @free(i8* %148) #3
  %149 = load i32, i32* %canary
  %150 = icmp eq i32 %149, 1114519915
  br i1 %150, label %151, label %func_exit
...
entry:
  %f = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 1598881509, i32* %canary
  %Rmin.addr = alloca i64*, align 8
  %buf = alloca i64, align 8
  %retval = alloca i32, align 4
  %NumberLeakyBuckets.addr = alloca i64, align 8
...
entry:
  ...
  %Rmin.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 687428011, i32* %canary
  %i = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
  store i64 0, i64* %i, align 8
...
entry:
  ...
  %buf = alloca i64, align 8
  %canary = alloca i32
  store i32 1463949541, i32* %canary
  %f = alloca %struct._IO_FILE*, align 8
  %Rmin.addr = alloca i64*, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
...
entry:
  %Rmin.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 116493506, i32* %canary
  %retval = alloca i32, align 4
  %i = alloca i64, align 8
  %buf = alloca i64, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
...
entry:
  %temp = alloca i64, align 8
  %canary = alloca i32
  store i32 577242576, i32* %canary
  %j = alloca i64, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %Rmin.addr = alloca i64*, align 8
  %i = alloca i64, align 8
...
entry:
  ...
  %temp = alloca i64, align 8
  %canary = alloca i32
  store i32 1210042648, i32* %canary
  %j = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
  store i64 0, i64* %i, align 8
...
entry:
  ...
  %i = alloca i64, align 8
  %canary = alloca i32
  store i32 833615943, i32* %canary
  %NumberLeakyBuckets.addr = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
  store i64 0, i64* %i, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_buffer.30(i64 %NumberLeakyBuckets, i64* %Rmin, i64* %Bmin, i64* %Fmin) #0 {
entry:
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %Fmin.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 975986424, i32* %canary
  %Rmin.addr = alloca i64*, align 8
  %outf = alloca %struct._IO_FILE*, align 8
  %iBucket = alloca i64, align 8
  %Bmin.addr = alloca i64*, align 8
...
entry:
  ...
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 403884883, i32* %canary
  %Rmin.addr = alloca i64*, align 8
  %f = alloca %struct._IO_FILE*, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
...
entry:
  ...
  %iChannelRate = alloca i64, align 8
  %canary = alloca i32
  store i32 2083144416, i32* %canary
  %FrameIndex = alloca i64, align 8
  %buffer_frame = alloca i64*, align 8
  %TotalRate = alloca i64, align 8
  %maxBuffer = alloca i64, align 8
...
for.end136:                                       ; preds = %for.cond57
  ...
  call void @free(i8* %148) #3
  %149 = load i32, i32* %canary
  %150 = icmp eq i32 %149, 2083144416
  br i1 %150, label %151, label %func_exit
...
entry:
  ...
  %Bmin.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 1123762359, i32* %canary
  %Fmin.addr = alloca i64*, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
  store i64* %Bmin, i64** %Bmin.addr, align 8
...
entry:
  ...
  %Rmin.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 584261321, i32* %canary
  %temp = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
  store i64 0, i64* %i, align 8
...
entry:
  %Rmin.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 1035790892, i32* %canary
  %j = alloca i64, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %temp = alloca i64, align 8
  %i = alloca i64, align 8
...
entry:
  %canary = alloca i32
  store i32 1523045422, i32* %canary
  %i = alloca i64, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %f = alloca %struct._IO_FILE*, align 8
  %buf = alloca i64, align 8
...
entry:
  ...
  %Bmin.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 1937621390, i32* %canary
  %iBucket = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
  store i64* %Bmin, i64** %Bmin.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @calc_buffer.39() #0 {
entry:
  %Bmin = alloca i64*, align 8
  %iChannelRate = alloca i64, align 8
  %minB = alloca i64, align 8
  ...
  %TotalRate = alloca i64, align 8
  %canary = alloca i32
  store i32 320429861, i32* %canary
  %actualBuffer = alloca i64, align 8
  store i64 0, i64* %FrameIndex, align 8
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8
  %call = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %0, i8* getelementptr inbounds ([81 x i8], [81 x i8]* @.str.8, i64 0, i64 0))
...
entry:
  ...
  %outf = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 1253227092, i32* %canary
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %Rmin.addr = alloca i64*, align 8
  %Bmin.addr = alloca i64*, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
...
entry:
  ...
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 343593935, i32* %canary
  %Bmin.addr = alloca i64*, align 8
  %Rmin.addr = alloca i64*, align 8
  %outf = alloca %struct._IO_FILE*, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
...
entry:
  ...
  %Rmin.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 2132223390, i32* %canary
  %Fmin.addr = alloca i64*, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %Bmin.addr = alloca i64*, align 8
  %iBucket = alloca i64, align 8
...
entry:
  ...
  %Bmin = alloca i64*, align 8
  %canary = alloca i32
  store i32 646154311, i32* %canary
  %AvgRate = alloca i64, align 8
  %iChannelRate = alloca i64, align 8
  %iBucket = alloca i64, align 8
  %minB = alloca i64, align 8
...
entry:
  ...
  %iFrame = alloca i64, align 8
  %canary = alloca i32
  store i32 100681336, i32* %canary
  %TotalRate = alloca i64, align 8
  %InitFullness = alloca i64, align 8
  %NumberLeakyBuckets = alloca i64, align 8
  %Bmin = alloca i64*, align 8
...
entry:
  %i = alloca i64, align 8
  %canary = alloca i32
  store i32 1505988631, i32* %canary
  %Rmin.addr = alloca i64*, align 8
  %f = alloca %struct._IO_FILE*, align 8
  %retval = alloca i32, align 4
  %NumberLeakyBuckets.addr = alloca i64, align 8
...
entry:
  ...
  %Rmin.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 1545822128, i32* %canary
  %buf = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
entry:
  ...
  %minB = alloca i64, align 8
  %canary = alloca i32
  store i32 1530022210, i32* %canary
  %buffer_frame = alloca i64*, align 8
  %iChannelRate = alloca i64, align 8
  %actualBuffer = alloca i64, align 8
  %AvgRate = alloca i64, align 8
...
for.end136:                                       ; preds = %for.cond57
  ...
  call void @free(i8* %148) #3
  %149 = load i32, i32* %canary
  %150 = icmp eq i32 %149, 1530022210
  br i1 %150, label %151, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_LeakyBucketRate.49(i64 %NumberLeakyBuckets, i64* %Rmin) #0 {
entry:
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %buf = alloca i64, align 8
  %canary = alloca i32
  store i32 1438806820, i32* %canary
  %Rmin.addr = alloca i64*, align 8
  %retval = alloca i32, align 4
  %i = alloca i64, align 8
  %f = alloca %struct._IO_FILE*, align 8
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1507656425, i32* %canary
  %buf = alloca i64, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %Rmin.addr = alloca i64*, align 8
  %f = alloca %struct._IO_FILE*, align 8
...
entry:
  ...
  %Rmin = alloca i64*, align 8
  %canary = alloca i32
  store i32 1786654167, i32* %canary
  %iChannelRate = alloca i64, align 8
  %Fmin = alloca i64*, align 8
  %FrameIndex = alloca i64, align 8
  %actualBuffer = alloca i64, align 8
...
for.end136:                                       ; preds = %for.cond57
  ...
  call void @free(i8* %148) #3
  %149 = load i32, i32* %canary
  %150 = icmp eq i32 %149, 1786654167
  br i1 %150, label %151, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @calc_buffer.52() #0 {
entry:
  %FrameIndex = alloca i64, align 8
  %canary = alloca i32
  store i32 1477087641, i32* %canary
  %Fmin = alloca i64*, align 8
  %Rmin = alloca i64*, align 8
  %AvgRate = alloca i64, align 8
  %buffer_frame = alloca i64*, align 8
...
for.end136:                                       ; preds = %for.cond57
  ...
  call void @free(i8* %148) #3
  %149 = load i32, i32* %canary
  %150 = icmp eq i32 %149, 1477087641
  br i1 %150, label %151, label %func_exit
...
entry:
  ...
  %outf = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 1987705910, i32* %canary
  %Fmin.addr = alloca i64*, align 8
  %iBucket = alloca i64, align 8
  %Bmin.addr = alloca i64*, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
...
entry:
  ...
  %iBucket = alloca i64, align 8
  %canary = alloca i32
  store i32 166486552, i32* %canary
  %Rmin.addr = alloca i64*, align 8
  %Bmin.addr = alloca i64*, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
...
entry:
  ...
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1213231795, i32* %canary
  %i = alloca i64, align 8
  %j = alloca i64, align 8
  %Rmin.addr = alloca i64*, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 667999268, i32* %canary
  %temp = alloca i64, align 8
  %j = alloca i64, align 8
  %Rmin.addr = alloca i64*, align 8
  %i = alloca i64, align 8
...
entry:
  ...
  %iBucket = alloca i64, align 8
  %canary = alloca i32
  store i32 1482584962, i32* %canary
  %Fmin.addr = alloca i64*, align 8
  %outf = alloca %struct._IO_FILE*, align 8
  %Rmin.addr = alloca i64*, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Sort.58(i64 %NumberLeakyBuckets, i64* %Rmin) #0 {
entry:
  %j = alloca i64, align 8
  %temp = alloca i64, align 8
  %i = alloca i64, align 8
  %canary = alloca i32
  store i32 328082943, i32* %canary
  %Rmin.addr = alloca i64*, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
...
entry:
  ...
  %InitFullness = alloca i64, align 8
  %canary = alloca i32
  store i32 1015777955, i32* %canary
  %FrameIndex = alloca i64, align 8
  %Fmin = alloca i64*, align 8
  %iChannelRate = alloca i64, align 8
  %NumberLeakyBuckets = alloca i64, align 8
...
for.end136:                                       ; preds = %for.cond57
  ...
  call void @free(i8* %148) #3
  %149 = load i32, i32* %canary
  %150 = icmp eq i32 %149, 1015777955
  br i1 %150, label %151, label %func_exit
...
entry:
  ...
  %Rmin.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 1112991589, i32* %canary
  %iBucket = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
  store i64* %Bmin, i64** %Bmin.addr, align 8
...
entry:
  ...
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1048245851, i32* %canary
  %j = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
  store i64 0, i64* %i, align 8
...
entry:
  %canary = alloca i32
  store i32 107602524, i32* %canary
  %Fmin.addr = alloca i64*, align 8
  %Bmin.addr = alloca i64*, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %iBucket = alloca i64, align 8
...
entry:
  ...
  %maxBuffer = alloca i64, align 8
  %canary = alloca i32
  store i32 488708418, i32* %canary
  %Rmin = alloca i64*, align 8
  %FrameIndex = alloca i64, align 8
  %InitFullness = alloca i64, align 8
  %actualBuffer = alloca i64, align 8
...
entry:
  %canary = alloca i32
  store i32 1864051297, i32* %canary
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %outf = alloca %struct._IO_FILE*, align 8
  %Rmin.addr = alloca i64*, align 8
  %iBucket = alloca i64, align 8
...
entry:
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 144406409, i32* %canary
  %Rmin.addr = alloca i64*, align 8
  %Fmin.addr = alloca i64*, align 8
  %outf = alloca %struct._IO_FILE*, align 8
  %iBucket = alloca i64, align 8
...
entry:
  ...
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1936088920, i32* %canary
  %Fmin.addr = alloca i64*, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
  store i64* %Bmin, i64** %Bmin.addr, align 8
