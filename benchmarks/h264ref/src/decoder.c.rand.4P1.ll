; ModuleID = 'decoder.c.rand.4P1.bc'
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_decode_one_b8block.12, label %ctrl0

func_decode_one_b8block.12:                       ; preds = %rand_bb
  call void @decode_one_b8block.12(i32 %decoder, i32 %mbmode, i32 %b8block, i32 %b8mode, i32 %b8ref)
  ret void

func_decode_one_b8block.25:                       ; preds = %ctrl0
  call void @decode_one_b8block.25(i32 %decoder, i32 %mbmode, i32 %b8block, i32 %b8mode, i32 %b8ref)
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_decode_one_b8block.25, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_decode_one_b8block.27, label %func_decode_one_b8block.34
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_Get_Reference_Block.3, label %ctrl0

func_Get_Reference_Block.3:                       ; preds = %rand_bb
  call void @Get_Reference_Block.3(i16** %imY, i32 %block_y, i32 %block_x, i32 %mvhor, i32 %mvver, i16** %out)
  ret void

func_Get_Reference_Block.15:                      ; preds = %ctrl0
  call void @Get_Reference_Block.15(i16** %imY, i32 %block_y, i32 %block_x, i32 %mvhor, i32 %mvver, i16** %out)
  ret void

func_Get_Reference_Block.16:                      ; preds = %ctrl1
  call void @Get_Reference_Block.16(i16** %imY, i32 %block_y, i32 %block_x, i32 %mvhor, i32 %mvver, i16** %out)
  ret void

func_Get_Reference_Block.17:                      ; preds = %ctrl1
  call void @Get_Reference_Block.17(i16** %imY, i32 %block_y, i32 %block_x, i32 %mvhor, i32 %mvver, i16** %out)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_Get_Reference_Block.15, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_Get_Reference_Block.16, label %func_Get_Reference_Block.17
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_decode_one_mb.4, label %func_decode_one_mb.6

func_decode_one_mb.4:                             ; preds = %rand_bb
  call void @decode_one_mb.4(i32 %decoder, %struct.macroblock* %currMB)
  ret void

func_decode_one_mb.6:                             ; preds = %rand_bb
  call void @decode_one_mb.6(i32 %decoder, %struct.macroblock* %currMB)
  ret void
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_Get_Reference_Pixel.11, label %ctrl0

func_Get_Reference_Pixel.11:                      ; preds = %rand_bb
  %2 = call i8 @Get_Reference_Pixel.11(i16** %imY, i32 %y_pos, i32 %x_pos)
  ret i8 %2

func_Get_Reference_Pixel.24:                      ; preds = %ctrl0
  %3 = call i8 @Get_Reference_Pixel.24(i16** %imY, i32 %y_pos, i32 %x_pos)
  ret i8 %3
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_Get_Reference_Pixel.24, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_Get_Reference_Pixel.30, label %func_Get_Reference_Pixel.33
}
...
func_Build_Status_Map.9:                          ; preds = %ctrl0
  call void @Build_Status_Map.9(i8** %s_map)
  ret void
...
func_Build_Status_Map.28:                         ; preds = %ctrl1
  call void @Build_Status_Map.28(i8** %s_map)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_Build_Status_Map.9, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_Build_Status_Map.23, label %func_Build_Status_Map.28
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_Error_Concealment.8, label %ctrl0

func_Error_Concealment.8:                         ; preds = %rand_bb
  call void @Error_Concealment.8(i16** %inY, i8** %s_map, i16*** %refY)
  ret void

func_Error_Concealment.13:                        ; preds = %ctrl0
  call void @Error_Concealment.13(i16** %inY, i8** %s_map, i16*** %refY)
  ret void

func_Error_Concealment.20:                        ; preds = %ctrl1
  call void @Error_Concealment.20(i16** %inY, i8** %s_map, i16*** %refY)
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_Error_Concealment.13, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_Error_Concealment.20, label %func_Error_Concealment.26
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_DecOneForthPix.1, label %ctrl0

func_DecOneForthPix.1:                            ; preds = %rand_bb
  call void @DecOneForthPix.1(i16** %dY, i16*** %dref)
  ret void

func_DecOneForthPix.14:                           ; preds = %ctrl0
  call void @DecOneForthPix.14(i16** %dY, i16*** %dref)
  ret void

func_DecOneForthPix.18:                           ; preds = %ctrl1
  call void @DecOneForthPix.18(i16** %dY, i16*** %dref)
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_DecOneForthPix.14, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_DecOneForthPix.18, label %func_DecOneForthPix.29
}
...
func_compute_residue_b8block.7:                   ; preds = %ctrl0
  call void @compute_residue_b8block.7(i32 %b8block, i32 %i16mode)
  ret void

func_compute_residue_b8block.19:                  ; preds = %ctrl1
  call void @compute_residue_b8block.19(i32 %b8block, i32 %i16mode)
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_compute_residue_b8block.7, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_compute_residue_b8block.19, label %func_compute_residue_b8block.22
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_Conceal_Error.10, label %ctrl0

func_Conceal_Error.10:                            ; preds = %rand_bb
  call void @Conceal_Error.10(i16** %inY, i32 %mb_y, i32 %mb_x, i16*** %refY, i8** %s_map)
  ret void

func_Conceal_Error.21:                            ; preds = %ctrl0
  call void @Conceal_Error.21(i16** %inY, i32 %mb_y, i32 %mb_x, i16*** %refY, i8** %s_map)
  ret void

func_Conceal_Error.31:                            ; preds = %ctrl1
  call void @Conceal_Error.31(i16** %inY, i32 %mb_y, i32 %mb_x, i16*** %refY, i8** %s_map)
  ret void

func_Conceal_Error.32:                            ; preds = %ctrl1
  call void @Conceal_Error.32(i16** %inY, i32 %mb_y, i32 %mb_x, i16*** %refY, i8** %s_map)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_Conceal_Error.21, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_Conceal_Error.31, label %func_Conceal_Error.32
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @DecOneForthPix.1(i16** %dY, i16*** %dref) #0 {
entry:
  %canary = alloca i32
  store i32 1468396242, i32* %canary
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 974288459, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Get_Reference_Block.3(i16** %imY, i32 %block_y, i32 %block_x, i32 %mvhor, i32 %mvver, i16** %out) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 1039273082, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @decode_one_mb.4(i32 %decoder, %struct.macroblock* %currMB) #0 {
entry:
  %canary = alloca i32
  store i32 1567298597, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @decode_one_mb.6(i32 %decoder, %struct.macroblock* %currMB) #0 {
entry:
  %canary = alloca i32
  store i32 1700098085, i32* %canary
  %decoder.addr = alloca i32, align 4
  %currMB.addr = alloca %struct.macroblock*, align 8
  store i32 %decoder, i32* %decoder.addr, align 4
  store %struct.macroblock* %currMB, %struct.macroblock** %currMB.addr, align 8
  %0 = load i32, i32* %canary
  %1 = icmp eq i32 %0, 1700098085
  br i1 %1, label %2, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @compute_residue_b8block.7(i32 %b8block, i32 %i16mode) #0 {
entry:
  %i1 = alloca i32, align 4
  %i = alloca i32, align 4
  %j0 = alloca i32, align 4
  ...
  %i16mode.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1140592483, i32* %canary
  %j = alloca i32, align 4
  store i32 %b8block, i32* %b8block.addr, align 4
  store i32 %i16mode, i32* %i16mode.addr, align 4
  %0 = load i32, i32* %b8block.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Error_Concealment.8(i16** %inY, i8** %s_map, i16*** %refY) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 425564851, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Build_Status_Map.9(i8** %s_map) #0 {
entry:
  %canary = alloca i32
  store i32 1285576889, i32* %canary
  %packet_lost = alloca i32, align 4
  %jj = alloca i32, align 4
  %slice = alloca i32, align 4
  %mb = alloca i32, align 4
...
entry:
  ...
  %refY.addr = alloca i16***, align 8
  %canary = alloca i32
  store i32 759657619, i32* %canary
  %inY.addr = alloca i16**, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local zeroext i8 @Get_Reference_Pixel.11(i16** %imY, i32 %y_pos, i32 %x_pos) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 2055939013, i32* %canary
  %imY.addr = alloca i16**, align 8
...
if.end926:                                        ; preds = %if.end925, %cond.end31
  ...
  %438 = icmp eq i32 %437, 2055939013
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @decode_one_b8block.12(i32 %decoder, i32 %mbmode, i32 %b8block, i32 %b8mode, i32 %b8ref) #0 {
entry:
  %j = alloca i32, align 4
  ...
  %block_x = alloca i32, align 4
  %canary = alloca i32
  store i32 2086095633, i32* %canary
  %i1 = alloca i32, align 4
  store i32 %decoder, i32* %decoder.addr, align 4
...
if.end315:                                        ; preds = %if.end314, %for.end28
  ...
  %242 = icmp eq i32 %241, 2086095633
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Error_Concealment.13(i16** %inY, i8** %s_map, i16*** %refY) #0 {
entry:
  %s_map.addr = alloca i8**, align 8
  %mb_y = alloca i32, align 4
  %refY.addr = alloca i16***, align 8
  ...
  %inY.addr = alloca i16**, align 8
  %canary = alloca i32
  store i32 634670695, i32* %canary
  %mb_w = alloca i32, align 4
  %mb_h = alloca i32, align 4
  store i16** %inY, i16*** %inY.addr, align 8
  store i8** %s_map, i8*** %s_map.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @DecOneForthPix.14(i16** %dY, i16*** %dref) #0 {
entry:
  %j = alloca i32, align 4
  %dY.addr = alloca i16**, align 8
  %canary = alloca i32
  store i32 715605506, i32* %canary
  %ref = alloca i32, align 4
  %dref.addr = alloca i16***, align 8
  store i16** %dY, i16*** %dY.addr, align 8
  store i16*** %dref, i16**** %dref.addr, align 8
...
entry:
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1033304360, i32* %canary
  %mvver.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %imY.addr = alloca i16**, align 8
  %out.addr = alloca i16**, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Get_Reference_Block.17(i16** %imY, i32 %block_y, i32 %block_x, i32 %mvhor, i32 %mvver, i16** %out) #0 {
entry:
  %j = alloca i32, align 4
  %block_y.addr = alloca i32, align 4
  %imY.addr = alloca i16**, align 8
  ...
  %mvhor.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1542031192, i32* %canary
  %block_x.addr = alloca i32, align 4
  %y = alloca i32, align 4
  %x = alloca i32, align 4
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @DecOneForthPix.18(i16** %dY, i16*** %dref) #0 {
entry:
  %canary = alloca i32
  store i32 118014473, i32* %canary
  %dY.addr = alloca i16**, align 8
  %j = alloca i32, align 4
  %ref = alloca i32, align 4
  %dref.addr = alloca i16***, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @compute_residue_b8block.19(i32 %b8block, i32 %i16mode) #0 {
entry:
  %i16mode.addr = alloca i32, align 4
  %j1 = alloca i32, align 4
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1359749507, i32* %canary
  %i = alloca i32, align 4
  %i1 = alloca i32, align 4
  %b8block.addr = alloca i32, align 4
  %i0 = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Error_Concealment.20(i16** %inY, i8** %s_map, i16*** %refY) #0 {
entry:
  %canary = alloca i32
  store i32 1450681986, i32* %canary
  %inY.addr = alloca i16**, align 8
  %mb_w = alloca i32, align 4
  %mb_y = alloca i32, align 4
  %refY.addr = alloca i16***, align 8
...
entry:
  ...
  %pos_y = alloca i32, align 4
  %canary = alloca i32
  store i32 1656537395, i32* %canary
  %pos_x = alloca i32, align 4
  %tmp_mv = alloca i16***, align 8
  %resY = alloca [16 x [16 x i32]], align 16
  %block_x = alloca i32, align 4
...
sw.epilog:                                        ; preds = %if.end545, %if.end487, %if.end321, %if.end, %land.end54
  %325 = load i32, i32* %canary
  %326 = icmp eq i32 %325, 1656537395
  br i1 %326, label %327, label %func_exit
...
entry:
  ...
  %j1 = alloca i32, align 4
  %canary = alloca i32
  store i32 1402770939, i32* %canary
  %i16mode.addr = alloca i32, align 4
  %i1 = alloca i32, align 4
  %j0 = alloca i32, align 4
  store i32 %b8block, i32* %b8block.addr, align 4
...
entry:
  ...
  %slice = alloca i32, align 4
  %canary = alloca i32
  store i32 1376053696, i32* %canary
  %s_map.addr = alloca i8**, align 8
  %j = alloca i32, align 4
  %jj = alloca i32, align 4
  %ii = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local zeroext i8 @Get_Reference_Pixel.24(i16** %imY, i32 %y_pos, i32 %x_pos) #0 {
entry:
  %maxold_y = alloca i32, align 4
  %pres_y = alloca i32, align 4
  %dy = alloca i32, align 4
  %canary = alloca i32
  store i32 668339280, i32* %canary
  %x = alloca i32, align 4
  %maxold_x = alloca i32, align 4
  %tmp_res = alloca [6 x i32], align 16
  %dx = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @decode_one_b8block.25(i32 %decoder, i32 %mbmode, i32 %b8block, i32 %b8mode, i32 %b8ref) #0 {
entry:
  %by1 = alloca i32, align 4
  %block_y = alloca i32, align 4
  %bx = alloca i32, align 4
  ...
  %j0 = alloca i32, align 4
  %canary = alloca i32
  store i32 198840521, i32* %canary
  %bx1 = alloca i32, align 4
  %b8ref.addr = alloca i32, align 4
  %decoder.addr = alloca i32, align 4
  %j = alloca i32, align 4
...
entry:
  ...
  %mb_y = alloca i32, align 4
  %canary = alloca i32
  store i32 958387319, i32* %canary
  %s_map.addr = alloca i8**, align 8
  %inY.addr = alloca i16**, align 8
  %mb_w = alloca i32, align 4
  store i16** %inY, i16*** %inY.addr, align 8
...
entry:
  ...
  %bx1 = alloca i32, align 4
  %canary = alloca i32
  store i32 1394059490, i32* %canary
  %j0 = alloca i32, align 4
  %block_x = alloca i32, align 4
  %resY_tmp = alloca [16 x [16 x i32]], align 16
  %i0 = alloca i32, align 4
...
if.end315:                                        ; preds = %if.end314, %for.end28
  %241 = load i32, i32* %canary
  %242 = icmp eq i32 %241, 1394059490
  br i1 %242, label %243, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Build_Status_Map.28(i8** %s_map) #0 {
entry:
  %packet_lost = alloca i32, align 4
  %s_map.addr = alloca i8**, align 8
  %ii = alloca i32, align 4
  ...
  %slice = alloca i32, align 4
  %canary = alloca i32
  store i32 648994212, i32* %canary
  %i = alloca i32, align 4
  %jj = alloca i32, align 4
  %j = alloca i32, align 4
  store i8** %s_map, i8*** %s_map.addr, align 8
...
entry:
  ...
  %dref.addr = alloca i16***, align 8
  %canary = alloca i32
  store i32 910899174, i32* %canary
  %dY.addr = alloca i16**, align 8
  %ref = alloca i32, align 4
  store i16** %dY, i16*** %dY.addr, align 8
  store i16*** %dref, i16**** %dref.addr, align 8
...
entry:
  ...
  %result1 = alloca i32, align 4
  %canary = alloca i32
  store i32 1368301366, i32* %canary
  %imY.addr = alloca i16**, align 8
  %tmp_res = alloca [6 x i32], align 16
  %x = alloca i32, align 4
  %maxold_y = alloca i32, align 4
...
if.end926:                                        ; preds = %if.end925, %cond.end31
  ...
  %conv927 = trunc i32 %436 to i8
  %437 = load i32, i32* %canary
  %438 = icmp eq i32 %437, 1368301366
  br i1 %438, label %439, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Conceal_Error.31(i16** %inY, i32 %mb_y, i32 %mb_x, i16*** %refY, i8** %s_map) #0 {
entry:
  %mv = alloca [2 x [4 x [4 x i32]]], align 16
  %s_map.addr = alloca i8**, align 8
  %resY = alloca [16 x [16 x i32]], align 16
  ...
  %mb_x.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 939929590, i32* %canary
  %inY.addr = alloca i16**, align 8
  %j = alloca i32, align 4
  %block_y = alloca i32, align 4
  %tmp_mv = alloca i16***, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Conceal_Error.32(i16** %inY, i32 %mb_y, i32 %mb_x, i16*** %refY, i8** %s_map) #0 {
entry:
  %s_map.addr = alloca i8**, align 8
  %copy = alloca i32, align 4
  %refY.addr = alloca i16***, align 8
  ...
  %resY = alloca [16 x [16 x i32]], align 16
  %canary = alloca i32
  store i32 1705522238, i32* %canary
  %mb_y.addr = alloca i32, align 4
  %mb_x.addr = alloca i32, align 4
  %inY.addr = alloca i16**, align 8
  %block_x = alloca i32, align 4
...
sw.epilog:                                        ; preds = %if.end545, %if.end487, %if.end321, %if.end, %land.end54
  %325 = load i32, i32* %canary
  %326 = icmp eq i32 %325, 1705522238
  br i1 %326, label %327, label %func_exit
...
entry:
  ...
  %y_pos.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 423700735, i32* %canary
  %y = alloca i32, align 4
  %pres_x = alloca i32, align 4
  %dy = alloca i32, align 4
  store i16** %imY, i16*** %imY.addr, align 8
...
entry:
  ...
  %by0 = alloca i32, align 4
  %canary = alloca i32
  store i32 613031289, i32* %canary
  %i0 = alloca i32, align 4
  %mv = alloca [2 x [4 x [4 x i32]]], align 16
  %bx1 = alloca i32, align 4
  %by = alloca i32, align 4
