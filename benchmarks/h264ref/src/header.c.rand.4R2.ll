...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_SliceHeader.8, label %ctrl0

func_SliceHeader.8:                               ; preds = %rand_bb
  %2 = call i32 @SliceHeader.8()
  ret i32 %2
...
func_SliceHeader.21:                              ; preds = %ctrl1
  %4 = call i32 @SliceHeader.21()
  ret i32 %4

func_SliceHeader.22:                              ; preds = %ctrl1
  %5 = call i32 @SliceHeader.22()
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_SliceHeader.12, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_SliceHeader.21, label %func_SliceHeader.22
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_get_picture_type.7, label %func_get_picture_type.15

func_get_picture_type.7:                          ; preds = %rand_bb
  %2 = call i32 @get_picture_type.7()
  ret i32 %2

func_get_picture_type.15:                         ; preds = %rand_bb
  %3 = call i32 @get_picture_type.15()
  ret i32 %3
}
...
func_Partition_BC_Header.6:                       ; preds = %ctrl0
  %3 = call i32 @Partition_BC_Header.6(i32 %PartNo)
  ret i32 %3

func_Partition_BC_Header.11:                      ; preds = %ctrl1
  %4 = call i32 @Partition_BC_Header.11(i32 %PartNo)
  ret i32 %4

func_Partition_BC_Header.13:                      ; preds = %ctrl1
  %5 = call i32 @Partition_BC_Header.13(i32 %PartNo)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_Partition_BC_Header.6, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_Partition_BC_Header.11, label %func_Partition_BC_Header.13
}
...
func_ref_pic_list_reordering.2:                   ; preds = %ctrl0
  %3 = call i32 @ref_pic_list_reordering.2()
  ret i32 %3

func_ref_pic_list_reordering.3:                   ; preds = %ctrl1
  %4 = call i32 @ref_pic_list_reordering.3()
  ret i32 %4

func_ref_pic_list_reordering.10:                  ; preds = %ctrl1
  %5 = call i32 @ref_pic_list_reordering.10()
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_ref_pic_list_reordering.2, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_ref_pic_list_reordering.3, label %func_ref_pic_list_reordering.10
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_dec_ref_pic_marking.16, label %ctrl0

func_dec_ref_pic_marking.16:                      ; preds = %rand_bb
  %2 = call i32 @dec_ref_pic_marking.16()
  ret i32 %2
...
func_dec_ref_pic_marking.19:                      ; preds = %ctrl1
  %5 = call i32 @dec_ref_pic_marking.19()
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_dec_ref_pic_marking.17, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_dec_ref_pic_marking.18, label %func_dec_ref_pic_marking.19
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_pred_weight_table.4, label %ctrl0

func_pred_weight_table.4:                         ; preds = %rand_bb
  %2 = call i32 @pred_weight_table.4()
  ret i32 %2

func_pred_weight_table.9:                         ; preds = %ctrl0
  %3 = call i32 @pred_weight_table.9()
  ret i32 %3
...
func_pred_weight_table.20:                        ; preds = %ctrl1
  %5 = call i32 @pred_weight_table.20()
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_pred_weight_table.9, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_pred_weight_table.14, label %func_pred_weight_table.20
}
...
entry:
  ...
  %canary = alloca i32
  store i32 1851033849, i32* %canary
...
entry:
  ...
  %currSlice = alloca %struct.Slice*, align 8
  %canary = alloca i32
  store i32 961092514, i32* %canary
  %len = alloca i32, align 4
  %dP_nr = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @ref_pic_list_reordering.3() #0 {
entry:
  %dP_nr = alloca i32, align 4
  %len = alloca i32, align 4
  %currSlice = alloca %struct.Slice*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @pred_weight_table.4() #0 {
entry:
  %canary = alloca i32
  store i32 1733586131, i32* %canary
...
if.end175:                                        ; preds = %for.end174, %for.end83
  ...
  %172 = icmp eq i32 %171, 1733586131
...
entry:
  ...
  %canary = alloca i32
  store i32 493064455, i32* %canary
  %partition = alloca %struct.datapartition*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @Partition_BC_Header.6(i32 %PartNo) #0 {
entry:
  %canary = alloca i32
  store i32 1650153585, i32* %canary
  %sym = alloca %struct.syntaxelement*, align 8
  %len = alloca i32, align 4
  %symbol = alloca %struct.syntaxelement, align 8
  %partition = alloca %struct.datapartition*, align 8
...
entry:
  ...
  %canary = alloca i32
  store i32 1734679346, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @SliceHeader.8() #0 {
entry:
  %override_flag = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
  %canary = alloca i32
  store i32 1134493135, i32* %canary
...
if.end239:                                        ; preds = %if.then236, %land.lhs.true232, %if.end229
  ...
  %238 = icmp eq i32 %237, 1134493135
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @pred_weight_table.9() #0 {
entry:
  %len = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
  %canary = alloca i32
  store i32 1427427776, i32* %canary
  %dP_nr = alloca i32, align 4
  %j = alloca i32, align 4
  %i = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
if.end175:                                        ; preds = %for.end174, %for.end83
  %170 = load i32, i32* %len, align 4
  %171 = load i32, i32* %canary
  %172 = icmp eq i32 %171, 1427427776
  br i1 %172, label %173, label %func_exit
...
entry:
  ...
  %dP_nr = alloca i32, align 4
  %canary = alloca i32
  store i32 1203509017, i32* %canary
  %partition = alloca %struct.datapartition*, align 8
  %i = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @Partition_BC_Header.11(i32 %PartNo) #0 {
entry:
  %sym = alloca %struct.syntaxelement*, align 8
  %canary = alloca i32
  store i32 1713126779, i32* %canary
  %partition = alloca %struct.datapartition*, align 8
  %PartNo.addr = alloca i32, align 4
  %len = alloca i32, align 4
  %symbol = alloca %struct.syntaxelement, align 8
...
entry:
  ...
  %field_pic_flag = alloca i32, align 4
  %canary = alloca i32
  store i32 1216182434, i32* %canary
  %len = alloca i32, align 4
  %dP_nr = alloca i32, align 4
  %bottom_field_flag = alloca i32, align 4
  %currSlice = alloca %struct.Slice*, align 8
...
if.end239:                                        ; preds = %if.then236, %land.lhs.true232, %if.end229
  %236 = load i32, i32* %len, align 4
  %237 = load i32, i32* %canary
  %238 = icmp eq i32 %237, 1216182434
  br i1 %238, label %239, label %func_exit
...
entry:
  ...
  %len = alloca i32, align 4
  %canary = alloca i32
  store i32 1409970904, i32* %canary
  %sym = alloca %struct.syntaxelement*, align 8
  store i32 %PartNo, i32* %PartNo.addr, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %currentSlice = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 50
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 152719611, i32* %canary
  %partition = alloca %struct.datapartition*, align 8
  %dP_nr = alloca i32, align 4
  %len = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_picture_type.15() #0 {
entry:
  %canary = alloca i32
  store i32 1841411206, i32* %canary
  %same_slicetype_for_whole_frame = alloca i32, align 4
  %retval = alloca i32, align 4
  store i32 5, i32* %same_slicetype_for_whole_frame, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
entry:
  ...
  %len = alloca i32, align 4
  %canary = alloca i32
  store i32 1199283288, i32* %canary
  %partition = alloca %struct.datapartition*, align 8
  %dP_nr = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
...
entry:
  ...
  %dP_nr = alloca i32, align 4
  %canary = alloca i32
  store i32 832493699, i32* %canary
  %len = alloca i32, align 4
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
...
entry:
  ...
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
  %canary = alloca i32
  store i32 1604130034, i32* %canary
  %len = alloca i32, align 4
  %val = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
...
entry:
  %len = alloca i32, align 4
  %canary = alloca i32
  store i32 1099448145, i32* %canary
  %val = alloca i32, align 4
  %dP_nr = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1688219260, i32* %canary
  %len = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
  %1 = load i32, i32* %partition_mode, align 4
...
if.end175:                                        ; preds = %for.end174, %for.end83
  %170 = load i32, i32* %len, align 4
  %171 = load i32, i32* %canary
  %172 = icmp eq i32 %171, 1688219260
  br i1 %172, label %173, label %func_exit
...
entry:
  ...
  %bottom_field_flag = alloca i32, align 4
  %canary = alloca i32
  store i32 1426721177, i32* %canary
  %override_flag = alloca i32, align 4
  %numtmp = alloca float, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
...
if.end239:                                        ; preds = %if.then236, %land.lhs.true232, %if.end229
  %236 = load i32, i32* %len, align 4
  %237 = load i32, i32* %canary
  %238 = icmp eq i32 %237, 1426721177
  br i1 %238, label %239, label %func_exit
...
entry:
  ...
  %numtmp = alloca float, align 4
  %canary = alloca i32
  store i32 1140110961, i32* %canary
  %override_flag = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
  %1 = load i32, i32* %partition_mode, align 4
...
if.end239:                                        ; preds = %if.then236, %land.lhs.true232, %if.end229
  %236 = load i32, i32* %len, align 4
  %237 = load i32, i32* %canary
  %238 = icmp eq i32 %237, 1140110961
  br i1 %238, label %239, label %func_exit
