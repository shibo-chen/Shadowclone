...
# %bb.0:                                # %entry
	...
	subq	$72, %rsp
	.cfi_offset %rbx, -24
	movl	$1946543805, -52(%rbp)  # imm = 0x7405E6BD
	movq	%rdi, -24(%rbp)
	movq	%rsi, -32(%rbp)
	movl	%edx, -12(%rbp)
	movq	img, %rax
...
.LBB2_5:                                # %if.end
	...
	movl	%eax, %ebx
	cmpl	$1946543805, -52(%rbp)  # imm = 0x7405E6BD
	jne	.LBB2_7
.LBB2_6:
	movl	%ebx, %eax
	addq	$72, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$954206926, -20(%rbp)   # imm = 0x38E00ACE
	vmovsd	%xmm0, -56(%rbp)
	vmovsd	%xmm1, -48(%rbp)
	movl	%edi, -24(%rbp)
	movl	%esi, -16(%rbp)
...
.LBB3_5:                                # %return
	movl	-12(%rbp), %ebx
	cmpl	$954206926, -20(%rbp)   # imm = 0x38E00ACE
	jne	.LBB3_7
.LBB3_6:
	movl	%ebx, %eax
	addq	$56, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$574174793, -24(%rbp)   # imm = 0x22393649
	vmovsd	%xmm0, -64(%rbp)
	vmovsd	%xmm1, -32(%rbp)
	movl	%edi, -20(%rbp)
	movl	%esi, -16(%rbp)
...
.LBB4_5:                                # %return
	movl	-12(%rbp), %ebx
	cmpl	$574174793, -24(%rbp)   # imm = 0x22393649
	jne	.LBB4_7
.LBB4_6:
	movl	%ebx, %eax
	addq	$56, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$72, %rsp
	.cfi_offset %rbx, -24
	movl	$290724518, -36(%rbp)   # imm = 0x11541AA6
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movl	%edx, -12(%rbp)
	movq	img, %rax
...
.LBB5_5:                                # %if.end
	...
	callq	rd_pic_decision
	movl	%eax, %ebx
	cmpl	$290724518, -36(%rbp)   # imm = 0x11541AA6
	jne	.LBB5_7
.LBB5_6:
	movl	%ebx, %eax
	addq	$72, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$519640362, -24(%rbp)   # imm = 0x1EF9152A
	vmovsd	%xmm0, -48(%rbp)
	vmovsd	%xmm1, -40(%rbp)
	movl	%edi, -20(%rbp)
	movl	%esi, -16(%rbp)
...
.LBB6_5:                                # %return
	movl	-12(%rbp), %ebx
	cmpl	$519640362, -24(%rbp)   # imm = 0x1EF9152A
	jne	.LBB6_7
.LBB6_6:
	movl	%ebx, %eax
	addq	$56, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$72, %rsp
	.cfi_offset %rbx, -24
	movl	$634091719, -44(%rbp)   # imm = 0x25CB78C7
	movq	%rdi, -24(%rbp)
	movq	%rsi, -32(%rbp)
	movl	%edx, -12(%rbp)
	movq	img, %rax
...
.LBB7_5:                                # %if.end
	...
	callq	rd_pic_decision
	movl	%eax, %ebx
	cmpl	$634091719, -44(%rbp)   # imm = 0x25CB78C7
	jne	.LBB7_7
.LBB7_6:
	movl	%ebx, %eax
	addq	$72, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$1980139380, -20(%rbp)  # imm = 0x76068774
	vmovsd	%xmm0, -64(%rbp)
	vmovsd	%xmm1, -48(%rbp)
	movl	%edi, -16(%rbp)
	movl	%esi, -24(%rbp)
...
.LBB8_5:                                # %return
	movl	-12(%rbp), %ebx
	cmpl	$1980139380, -20(%rbp)  # imm = 0x76068774
	jne	.LBB8_7
.LBB8_6:
	movl	%ebx, %eax
	addq	$56, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$684531123, -24(%rbp)   # imm = 0x28CD1DB3
	vmovsd	%xmm0, -48(%rbp)
	vmovsd	%xmm1, -40(%rbp)
	movl	%edi, -20(%rbp)
	movl	%esi, -16(%rbp)
...
.LBB9_5:                                # %return
	movl	-12(%rbp), %ebx
	cmpl	$684531123, -24(%rbp)   # imm = 0x28CD1DB3
	jne	.LBB9_7
.LBB9_6:
	movl	%ebx, %eax
	addq	$56, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$72, %rsp
	.cfi_offset %rbx, -24
	movl	$420840895, -36(%rbp)   # imm = 0x191585BF
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movl	%edx, -12(%rbp)
	movq	img, %rax
...
.LBB10_5:                               # %if.end
	...
	callq	rd_pic_decision
	movl	%eax, %ebx
	cmpl	$420840895, -36(%rbp)   # imm = 0x191585BF
	jne	.LBB10_7
.LBB10_6:
	movl	%ebx, %eax
	addq	$72, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$1014652507, -16(%rbp)  # imm = 0x3C7A5E5B
	vmovsd	%xmm0, -40(%rbp)
	vmovsd	%xmm1, -48(%rbp)
	movl	%edi, -20(%rbp)
	movl	%esi, -24(%rbp)
...
.LBB11_5:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$1014652507, -16(%rbp)  # imm = 0x3C7A5E5B
	jne	.LBB11_7
.LBB11_6:
	movl	%ebx, %eax
	addq	$56, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$821417731, -16(%rbp)   # imm = 0x30F5D703
	vmovsd	%xmm0, -64(%rbp)
	vmovsd	%xmm1, -48(%rbp)
	movl	%edi, -24(%rbp)
	movl	%esi, -20(%rbp)
...
.LBB12_5:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$821417731, -16(%rbp)   # imm = 0x30F5D703
	jne	.LBB12_7
.LBB12_6:
	movl	%ebx, %eax
	addq	$56, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$694440113, -20(%rbp)   # imm = 0x296450B1
	vmovsd	%xmm0, -64(%rbp)
	vmovsd	%xmm1, -40(%rbp)
	movl	%edi, -16(%rbp)
	movl	%esi, -24(%rbp)
...
.LBB13_5:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$694440113, -20(%rbp)   # imm = 0x296450B1
	jne	.LBB13_7
.LBB13_6:
	movl	%ebx, %eax
	addq	$56, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$72, %rsp
	.cfi_offset %rbx, -24
	movl	$807042850, -36(%rbp)   # imm = 0x301A7F22
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movl	%edx, -12(%rbp)
	movq	img, %rax
...
.LBB14_5:                               # %if.end
	...
	callq	rd_pic_decision
	movl	%eax, %ebx
	cmpl	$807042850, -36(%rbp)   # imm = 0x301A7F22
	jne	.LBB14_7
.LBB14_6:
	movl	%ebx, %eax
	addq	$72, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$72, %rsp
	.cfi_offset %rbx, -24
	movl	$1366299140, -36(%rbp)  # imm = 0x51701204
	movq	%rdi, -24(%rbp)
	movq	%rsi, -32(%rbp)
	movl	%edx, -12(%rbp)
	movq	img, %rax
...
.LBB15_5:                               # %if.end
	...
	callq	rd_pic_decision
	movl	%eax, %ebx
	cmpl	$1366299140, -36(%rbp)  # imm = 0x51701204
	jne	.LBB15_7
.LBB15_6:
	movl	%ebx, %eax
	addq	$72, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$72, %rsp
	.cfi_offset %rbx, -24
	movl	$299822428, -36(%rbp)   # imm = 0x11DEED5C
	movq	%rdi, -24(%rbp)
	movq	%rsi, -32(%rbp)
	movl	%edx, -12(%rbp)
	movq	img, %rax
...
.LBB16_5:                               # %if.end
	...
	callq	rd_pic_decision
	movl	%eax, %ebx
	cmpl	$299822428, -36(%rbp)   # imm = 0x11DEED5C
	jne	.LBB16_7
.LBB16_6:
	movl	%ebx, %eax
	addq	$72, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$72, %rsp
	.cfi_offset %rbx, -24
	movl	$375577153, -36(%rbp)   # imm = 0x1662DA41
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movl	%edx, -12(%rbp)
	movq	img, %rax
...
.LBB17_5:                               # %if.end
	...
	callq	rd_pic_decision
	movl	%eax, %ebx
	cmpl	$375577153, -36(%rbp)   # imm = 0x1662DA41
	jne	.LBB17_7
.LBB17_6:
	movl	%ebx, %eax
	addq	$72, %rsp
