...
func_PutPel_14.25:                                ; preds = %ctrl1
  call void @PutPel_14.25(i16** %Pic, i32 %y, i32 %x, i16 %val)
  ret void

func_PutPel_14.27:                                ; preds = %ctrl1
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_PutPel_14.25, label %func_PutPel_14.27
}
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_PutPel_11.13, label %func_PutPel_11.17
}
...
func_FastLine16Y_11.7:                            ; preds = %ctrl0
  %3 = call i16* @FastLine16Y_11.7(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %3
...
func_FastLine16Y_11.14:                           ; preds = %ctrl1
  %5 = call i16* @FastLine16Y_11.14(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_FastLine16Y_11.7, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_FastLine16Y_11.11, label %func_FastLine16Y_11.14
}
...
func_UMVLine16Y_11.26:                            ; preds = %ctrl0
  %3 = call i16* @UMVLine16Y_11.26(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %3

func_UMVLine16Y_11.28:                            ; preds = %ctrl1
  %4 = call i16* @UMVLine16Y_11.28(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %4

func_UMVLine16Y_11.29:                            ; preds = %ctrl1
  %5 = call i16* @UMVLine16Y_11.29(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_UMVLine16Y_11.26, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_UMVLine16Y_11.28, label %func_UMVLine16Y_11.29
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FastLineX.18, label %ctrl0

func_FastLineX.18:                                ; preds = %rand_bb
  %2 = call i16* @FastLineX.18(i32 %dummy, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %2
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_FastLineX.19, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_FastLineX.20, label %func_FastLineX.21
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_UMVLineX.8, label %ctrl0

func_UMVLineX.8:                                  ; preds = %rand_bb
  %2 = call i16* @UMVLineX.8(i32 %size, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %2

func_UMVLineX.30:                                 ; preds = %ctrl0
  %3 = call i16* @UMVLineX.30(i32 %size, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %3

func_UMVLineX.31:                                 ; preds = %ctrl1
  %4 = call i16* @UMVLineX.31(i32 %size, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %4
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_UMVLineX.30, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_UMVLineX.31, label %func_UMVLineX.32
}
...
func_UMVPelY_14.10:                               ; preds = %ctrl0
  %3 = call i16 @UMVPelY_14.10(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16 %3
...
func_UMVPelY_14.22:                               ; preds = %ctrl1
  %5 = call i16 @UMVPelY_14.22(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_UMVPelY_14.10, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_UMVPelY_14.15, label %func_UMVPelY_14.22
}
...
func_FastPelY_14.16:                              ; preds = %ctrl1
  %4 = call i16 @FastPelY_14.16(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16 %4

func_FastPelY_14.24:                              ; preds = %ctrl1
  %5 = call i16 @FastPelY_14.24(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_FastPelY_14.3, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_FastPelY_14.16, label %func_FastPelY_14.24
}
...
entry:
  ...
  %canary = alloca i32
  store i32 1664435027, i32* %canary
...
entry:
  ...
  %x.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 585623487, i32* %canary
  %Pic.addr = alloca i16**, align 8
...
entry:
  ...
  %y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 536831686, i32* %canary
  %Pic.addr = alloca i16**, align 8
  %x.addr = alloca i32, align 4
  store i16** %Pic, i16*** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 1146937643, i32* %canary
  %width.addr = alloca i32, align 4
...
entry:
  ...
  %Pic.addr = alloca i16*, align 8
  %canary = alloca i32
  store i32 1639829030, i32* %canary
  %width.addr = alloca i32, align 4
  store i16* %Pic, i16** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
  store i32 %x, i32* %x.addr, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 796396778, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i16* @FastLine16Y_11.7(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width) #0 {
entry:
  %x.addr = alloca i32, align 4
  %Pic.addr = alloca i16*, align 8
  %width.addr = alloca i32, align 4
  %height.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 314599440, i32* %canary
  %y.addr = alloca i32, align 4
  store i16* %Pic, i16** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
  store i32 %x, i32* %x.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i16* @UMVLineX.8(i32 %size, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width) #0 {
entry:
  %y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1443336382, i32* %canary
  %Picy = alloca i16*, align 8
  %width.addr = alloca i32, align 4
  %height.addr = alloca i32, align 4
  %maxx = alloca i32, align 4
...
entry:
  ...
  %width.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 538422994, i32* %canary
  %Pic.addr = alloca i16*, align 8
  %x.addr = alloca i32, align 4
  %val.addr = alloca i16, align 2
  store i16* %Pic, i16** %Pic.addr, align 8
...
entry:
  ...
  %retval = alloca i16, align 2
  %canary = alloca i32
  store i32 1815741006, i32* %canary
  %x.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
  %height4 = alloca i32, align 4
  store i16** %Pic, i16*** %Pic.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1381650795, i32* %canary
  %x.addr = alloca i32, align 4
  %width.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
  %Pic.addr = alloca i16*, align 8
...
entry:
  %y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1741902403, i32* %canary
  %width.addr = alloca i32, align 4
  %val.addr = alloca i16, align 2
  %Pic.addr = alloca i16*, align 8
  %x.addr = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1850777094, i32* %canary
  %width.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
  %val.addr = alloca i16, align 2
  %Pic.addr = alloca i16*, align 8
...
entry:
  %x.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1394480368, i32* %canary
  %height.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
  %width.addr = alloca i32, align 4
  %retval = alloca i16, align 2
...
entry:
  ...
  %y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1883677527, i32* %canary
  %width.addr = alloca i32, align 4
  store i16* %Pic, i16** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
  store i32 %x, i32* %x.addr, align 4
...
entry:
  ...
  %width.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1578373861, i32* %canary
  %height.addr = alloca i32, align 4
...
entry:
  %Pic.addr = alloca i16*, align 8
  %canary = alloca i32
  store i32 249225506, i32* %canary
  %x.addr = alloca i32, align 4
  %height.addr = alloca i32, align 4
  %dummy.addr = alloca i32, align 4
  %width.addr = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 866037994, i32* %canary
  %width.addr = alloca i32, align 4
  %x.addr = alloca i32, align 4
  %height.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
...
entry:
  ...
  %Pic.addr = alloca i16*, align 8
  %canary = alloca i32
  store i32 499394248, i32* %canary
  %height.addr = alloca i32, align 4
  %x.addr = alloca i32, align 4
  %width.addr = alloca i32, align 4
  store i32 %dummy, i32* %dummy.addr, align 4
...
entry:
  ...
  %width4 = alloca i32, align 4
  %canary = alloca i32
  store i32 1908458407, i32* %canary
  %Pic.addr = alloca i16**, align 8
  %x.addr = alloca i32, align 4
  %height.addr = alloca i32, align 4
  %height4 = alloca i32, align 4
...
entry:
  ...
  %y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1730658734, i32* %canary
  %val.addr = alloca i16, align 2
  %Pic.addr = alloca i16**, align 8
  store i16** %Pic, i16*** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
...
entry:
  ...
  %width.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 943153951, i32* %canary
  %Pic.addr = alloca i16**, align 8
  store i16** %Pic, i16*** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
  store i32 %x, i32* %x.addr, align 4
...
entry:
  ...
  %x.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 253805534, i32* %canary
  %y.addr = alloca i32, align 4
  store i16** %Pic, i16*** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
  store i32 %x, i32* %x.addr, align 4
...
entry:
  ...
  %x.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1179473329, i32* %canary
  %width.addr = alloca i32, align 4
  %retval = alloca i16*, align 8
  %y.addr = alloca i32, align 4
  %height.addr = alloca i32, align 4
...
entry:
  %y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 563547347, i32* %canary
  %val.addr = alloca i16, align 2
  %x.addr = alloca i32, align 4
  %Pic.addr = alloca i16**, align 8
  store i16** %Pic, i16*** %Pic.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i16* @UMVLine16Y_11.28(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width) #0 {
entry:
  %y.addr = alloca i32, align 4
  %Picy = alloca i16*, align 8
  %canary = alloca i32
  store i32 1294248234, i32* %canary
  %retval = alloca i16*, align 8
  %i = alloca i32, align 4
  %maxx = alloca i32, align 4
  %height.addr = alloca i32, align 4
...
entry:
  ...
  %height.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2048376058, i32* %canary
  %Pic.addr = alloca i16*, align 8
  %i = alloca i32, align 4
  %maxx = alloca i32, align 4
  %retval = alloca i16*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i16* @UMVLineX.30(i32 %size, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width) #0 {
entry:
  %x.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 127539332, i32* %canary
  %Pic.addr = alloca i16*, align 8
  %Picy = alloca i16*, align 8
  %size.addr = alloca i32, align 4
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i16* @UMVLineX.31(i32 %size, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width) #0 {
entry:
  %x.addr = alloca i32, align 4
  %retval = alloca i16*, align 8
  %i = alloca i32, align 4
  ...
  %Pic.addr = alloca i16*, align 8
  %canary = alloca i32
  store i32 806435935, i32* %canary
  %height.addr = alloca i32, align 4
  %width.addr = alloca i32, align 4
  %Picy = alloca i16*, align 8
  %y.addr = alloca i32, align 4
...
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1097726597, i32* %canary
  %height.addr = alloca i32, align 4
  %maxx = alloca i32, align 4
  %Picy = alloca i16*, align 8
  %x.addr = alloca i32, align 4
