...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_WriteRTPPacket.6, label %ctrl1
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_WriteRTPNALU.1, label %func_WriteRTPNALU.3
...
func_WriteRTPNALU.3:                              ; preds = %rand_bb
  %3 = call i32 @WriteRTPNALU.3(%struct.NALU_t* %n)
  ret i32 %3
}
...
entry:
  %canary = alloca i32
  store i32 520450669, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1381492175, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1379431370, i32* %canary
  %n.addr = alloca %struct.NALU_t*, align 8
  %p = alloca %struct.RTPpacket_t*, align 8
  store %struct.NALU_t* %n, %struct.NALU_t** %n.addr, align 8
  %0 = load %struct.NALU_t*, %struct.NALU_t** %n.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1154779232, i32* %canary
  %delta = alloca i32, align 4
  %tr.addr = alloca i32, align 4
  store i32 %tr, i32* %tr.addr, align 4
  %0 = load i32, i32* @RTPUpdateTimestamp.oldtr, align 4
...
entry:
  ...
  %intime = alloca i32, align 4
  %canary = alloca i32
  store i32 424102156, i32* %canary
  %f.addr = alloca %struct._IO_FILE*, align 8
  %p.addr = alloca %struct.RTPpacket_t*, align 8
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
...
entry:
  ...
  %intime = alloca i32, align 4
  %canary = alloca i32
  store i32 511872991, i32* %canary
  %f.addr = alloca %struct._IO_FILE*, align 8
  %retval = alloca i32, align 4
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
