...
# %bb.1:                                # %func_estimate_weighting_factor_B_slice.6
	...
	.cfi_def_cfa %rsp, 8
	retq
.LBB1_2:                                # %func_estimate_weighting_factor_B_slice.13
	.cfi_def_cfa %rbp, 16
...
# %bb.0:                                # %entry
	...
	.cfi_offset %rbx, -24
	movl	$1245869542, -84(%rbp)  # imm = 0x4A4275E6
	movl	%edi, -80(%rbp)
...
.LBB4_164:                              # %for.end656
	movl	-48(%rbp), %ebx
	cmpl	$1245869542, -84(%rbp)  # imm = 0x4A4275E6
	jne	.LBB4_166
.LBB4_165:
	movl	%ebx, %eax
...
# %bb.0:                                # %entry
	...
	.cfi_offset %rbx, -24
	movl	$810493978, -60(%rbp)   # imm = 0x304F281A
	movl	%edi, -64(%rbp)
	vxorps	%xmm0, %xmm0, %xmm0
	vmovsd	%xmm0, -56(%rbp)
	movq	img, %rax
...
.LBB5_73:                               # %for.end264
	movl	-40(%rbp), %ebx
	cmpl	$810493978, -60(%rbp)   # imm = 0x304F281A
	jne	.LBB5_75
.LBB5_74:
	movl	%ebx, %eax
...
# %bb.0:                                # %entry
	...
	movl	$407544779, -60(%rbp)   # imm = 0x184AA3CB
	movl	%edi, -64(%rbp)
	vxorps	%xmm0, %xmm0, %xmm0
	vmovsd	%xmm0, -48(%rbp)
	movq	img, %rax
...
.LBB6_86:                               # %for.inc455
	...
	jmp	.LBB6_76
.LBB6_87:                               # %for.end457
	cmpl	$407544779, -60(%rbp)   # imm = 0x184AA3CB
	jne	.LBB6_89
.LBB6_88:
...
# %bb.0:                                # %entry
	...
	subq	$936, %rsp              # imm = 0x3A8
	.cfi_offset %rbx, -24
	movl	$102395226, -60(%rbp)   # imm = 0x61A6D5A
	movl	%edi, -64(%rbp)
	vxorps	%xmm0, %xmm0, %xmm0
	vmovsd	%xmm0, -56(%rbp)
	movq	img, %rax
...
.LBB7_73:                               # %for.end264
	movl	-40(%rbp), %ebx
	cmpl	$102395226, -60(%rbp)   # imm = 0x61A6D5A
	jne	.LBB7_75
.LBB7_74:
	movl	%ebx, %eax
	addq	$936, %rsp              # imm = 0x3A8
...
# %bb.0:                                # %entry
	...
	subq	$936, %rsp              # imm = 0x3A8
	.cfi_offset %rbx, -24
	movl	$189220404, -64(%rbp)   # imm = 0xB474634
	movl	%edi, -60(%rbp)
	vxorps	%xmm0, %xmm0, %xmm0
	vmovsd	%xmm0, -56(%rbp)
	movq	img, %rax
...
.LBB8_73:                               # %for.end264
	movl	-40(%rbp), %ebx
	cmpl	$189220404, -64(%rbp)   # imm = 0xB474634
	jne	.LBB8_75
.LBB8_74:
	movl	%ebx, %eax
	addq	$936, %rsp              # imm = 0x3A8
...
# %bb.0:                                # %entry
	...
	movl	$971226334, -88(%rbp)   # imm = 0x39E3BCDE
	vxorps	%xmm0, %xmm0, %xmm0
	vmovsd	%xmm0, -80(%rbp)
	movq	img, %rax
	cmpl	$0, 72400(%rax)
...
.LBB9_188:                              # %for.end839
	jmp	.LBB9_189
.LBB9_189:                              # %if.end840
	cmpl	$971226334, -88(%rbp)   # imm = 0x39E3BCDE
	jne	.LBB9_191
.LBB9_190:
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$928, %rsp              # imm = 0x3A0
	movl	$799592259, -60(%rbp)   # imm = 0x2FA8CF43
	movl	%edi, -64(%rbp)
	vxorps	%xmm0, %xmm0, %xmm0
	vmovsd	%xmm0, -48(%rbp)
	movq	img, %rax
...
.LBB10_86:                              # %for.inc455
	...
	jmp	.LBB10_76
.LBB10_87:                              # %for.end457
	cmpl	$799592259, -60(%rbp)   # imm = 0x2FA8CF43
	jne	.LBB10_89
.LBB10_88:
	addq	$928, %rsp              # imm = 0x3A0
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	subq	$35416, %rsp            # imm = 0x8A58
	.cfi_offset %rbx, -24
	movl	$1760255980, -84(%rbp)  # imm = 0x68EB5FEC
	movl	%edi, -88(%rbp)
	vxorps	%xmm0, %xmm0, %xmm0
	vmovsd	%xmm0, -72(%rbp)
	movq	img, %rax
...
.LBB11_164:                             # %for.end656
	movl	-48(%rbp), %ebx
	cmpl	$1760255980, -84(%rbp)  # imm = 0x68EB5FEC
	jne	.LBB11_166
.LBB11_165:
	movl	%ebx, %eax
	addq	$35416, %rsp            # imm = 0x8A58
...
# %bb.0:                                # %entry
	...
	subq	$936, %rsp              # imm = 0x3A8
	.cfi_offset %rbx, -24
	movl	$810791383, -60(%rbp)   # imm = 0x3053B1D7
	movl	%edi, -64(%rbp)
	vxorps	%xmm0, %xmm0, %xmm0
	vmovsd	%xmm0, -56(%rbp)
	movq	img, %rax
...
.LBB12_73:                              # %for.end264
	movl	-40(%rbp), %ebx
	cmpl	$810791383, -60(%rbp)   # imm = 0x3053B1D7
	jne	.LBB12_75
.LBB12_74:
	movl	%ebx, %eax
	addq	$936, %rsp              # imm = 0x3A8
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$928, %rsp              # imm = 0x3A0
	movl	$2144562262, -64(%rbp)  # imm = 0x7FD36C56
	movl	%edi, -60(%rbp)
	vxorps	%xmm0, %xmm0, %xmm0
	vmovsd	%xmm0, -56(%rbp)
	movq	img, %rax
...
.LBB13_86:                              # %for.inc455
	...
	jmp	.LBB13_76
.LBB13_87:                              # %for.end457
	cmpl	$2144562262, -64(%rbp)  # imm = 0x7FD36C56
	jne	.LBB13_89
.LBB13_88:
	addq	$928, %rsp              # imm = 0x3A0
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	subq	$35416, %rsp            # imm = 0x8A58
	.cfi_offset %rbx, -24
	movl	$2136019852, -88(%rbp)  # imm = 0x7F51138C
	movl	%edi, -84(%rbp)
	vxorps	%xmm0, %xmm0, %xmm0
	vmovsd	%xmm0, -72(%rbp)
	movq	img, %rax
...
.LBB14_164:                             # %for.end656
	movl	-48(%rbp), %ebx
	cmpl	$2136019852, -88(%rbp)  # imm = 0x7F51138C
	jne	.LBB14_166
.LBB14_165:
	movl	%ebx, %eax
	addq	$35416, %rsp            # imm = 0x8A58
...
# %bb.0:                                # %entry
	...
	subq	$35416, %rsp            # imm = 0x8A58
	.cfi_offset %rbx, -24
	movl	$1456240593, -88(%rbp)  # imm = 0x56CC77D1
	movl	%edi, -76(%rbp)
	vxorps	%xmm0, %xmm0, %xmm0
	vmovsd	%xmm0, -72(%rbp)
	movq	img, %rax
...
.LBB15_164:                             # %for.end656
	movl	-48(%rbp), %ebx
	cmpl	$1456240593, -88(%rbp)  # imm = 0x56CC77D1
	jne	.LBB15_166
.LBB15_165:
	movl	%ebx, %eax
	addq	$35416, %rsp            # imm = 0x8A58
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$35424, %rsp            # imm = 0x8A60
	movl	$1274887178, -88(%rbp)  # imm = 0x4BFD3C0A
	vxorps	%xmm0, %xmm0, %xmm0
	vmovsd	%xmm0, -80(%rbp)
	movq	img, %rax
	cmpl	$0, 72400(%rax)
...
.LBB16_188:                             # %for.end839
	jmp	.LBB16_189
.LBB16_189:                             # %if.end840
	cmpl	$1274887178, -88(%rbp)  # imm = 0x4BFD3C0A
	jne	.LBB16_191
.LBB16_190:
	addq	$35424, %rsp            # imm = 0x8A60
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$928, %rsp              # imm = 0x3A0
	movl	$170015976, -64(%rbp)   # imm = 0xA223CE8
	movl	%edi, -60(%rbp)
	vxorps	%xmm0, %xmm0, %xmm0
	vmovsd	%xmm0, -56(%rbp)
	movq	img, %rax
...
.LBB17_86:                              # %for.inc455
	...
	jmp	.LBB17_76
.LBB17_87:                              # %for.end457
	cmpl	$170015976, -64(%rbp)   # imm = 0xA223CE8
	jne	.LBB17_89
.LBB17_88:
	addq	$928, %rsp              # imm = 0x3A0
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$35424, %rsp            # imm = 0x8A60
	movl	$1978174978, -88(%rbp)  # imm = 0x75E88E02
	vxorps	%xmm0, %xmm0, %xmm0
	vmovsd	%xmm0, -80(%rbp)
	movq	img, %rax
	cmpl	$0, 72400(%rax)
...
.LBB18_188:                             # %for.end839
	jmp	.LBB18_189
.LBB18_189:                             # %if.end840
	cmpl	$1978174978, -88(%rbp)  # imm = 0x75E88E02
	jne	.LBB18_191
.LBB18_190:
	addq	$35424, %rsp            # imm = 0x8A60
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$35424, %rsp            # imm = 0x8A60
	movl	$1021019753, -88(%rbp)  # imm = 0x3CDB8669
	vxorps	%xmm0, %xmm0, %xmm0
	vmovsd	%xmm0, -80(%rbp)
	movq	img, %rax
	cmpl	$0, 72400(%rax)
...
.LBB19_188:                             # %for.end839
	jmp	.LBB19_189
.LBB19_189:                             # %if.end840
	cmpl	$1021019753, -88(%rbp)  # imm = 0x3CDB8669
	jne	.LBB19_191
.LBB19_190:
	addq	$35424, %rsp            # imm = 0x8A60
	popq	%rbp
