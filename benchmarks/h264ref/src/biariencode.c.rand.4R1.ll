; ModuleID = 'biariencode.c.rand.4R1.bc'
...
func_arienco_start_encoding.14:                   ; preds = %ctrl0
  call void @arienco_start_encoding.14(%struct.EncodingEnvironment* %eep, i8* %code_buffer, i32* %code_len, i32 %slice_type)
  ret void

func_arienco_start_encoding.16:                   ; preds = %ctrl1
  call void @arienco_start_encoding.16(%struct.EncodingEnvironment* %eep, i8* %code_buffer, i32* %code_len, i32 %slice_type)
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_arienco_start_encoding.14, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_arienco_start_encoding.16, label %func_arienco_start_encoding.19
}
...
func_biari_encode_symbol.5:                       ; preds = %ctrl1
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_biari_encode_symbol.5, label %func_biari_encode_symbol.7
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_biari_encode_symbol_eq_prob.3, label %ctrl0

func_biari_encode_symbol_eq_prob.3:               ; preds = %rand_bb
...
func_biari_encode_symbol_eq_prob.10:              ; preds = %ctrl1
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_biari_encode_symbol_eq_prob.10, label %func_biari_encode_symbol_eq_prob.15
}
...
func_biari_encode_symbol_final.12:                ; preds = %ctrl1
  call void @biari_encode_symbol_final.12(%struct.EncodingEnvironment* %eep, i16 %symbol)
  ret void
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_biari_encode_symbol_final.12, label %func_biari_encode_symbol_final.13
}
...
func_biari_init_context.17:                       ; preds = %ctrl0
  call void @biari_init_context.17(%struct.BiContextType* %ctx, i32* %ini)
  ret void

func_biari_init_context.18:                       ; preds = %ctrl1
  call void @biari_init_context.18(%struct.BiContextType* %ctx, i32* %ini)
  ret void

func_biari_init_context.20:                       ; preds = %ctrl1
  call void @biari_init_context.20(%struct.BiContextType* %ctx, i32* %ini)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_biari_init_context.17, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_biari_init_context.18, label %func_biari_init_context.20
}
...
entry:
  ...
  %canary = alloca i32
  store i32 485090941, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 751047609, i32* %canary
...
entry:
  ...
  %symbol.addr = alloca i16, align 2
  %canary = alloca i32
  store i32 130960217, i32* %canary
  %low = alloca i32, align 4
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
  %0 = load %struct.EncodingEnvironment*, %struct.EncodingEnvironment** %eep.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 681512136, i32* %canary
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %rLPS = alloca i32, align 4
  %low = alloca i32, align 4
  %range = alloca i32, align 4
...
entry:
  ...
  %low = alloca i32, align 4
  %canary = alloca i32
  store i32 1221653932, i32* %canary
  %range = alloca i32, align 4
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
...
while.end162:                                     ; preds = %while.cond
  ...
  store i32 %inc166, i32* %C165, align 8
  %136 = load i32, i32* %canary
  %137 = icmp eq i32 %136, 1221653932
  br i1 %137, label %138, label %func_exit
...
entry:
  ...
  %canary = alloca i32
  store i32 725991418, i32* %canary
...
entry:
  ...
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 442028545, i32* %canary
  %range = alloca i32, align 4
  %symbol.addr = alloca i16, align 2
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
...
entry:
  %range = alloca i32, align 4
  %canary = alloca i32
  store i32 1939026844, i32* %canary
  %low = alloca i32, align 4
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %symbol.addr = alloca i16, align 2
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
...
while.end125:                                     ; preds = %while.cond
  ...
  %111 = icmp eq i32 %110, 1939026844
...
entry:
  ...
  %low = alloca i32, align 4
  %canary = alloca i32
  store i32 2067854278, i32* %canary
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
  %0 = load %struct.EncodingEnvironment*, %struct.EncodingEnvironment** %eep.addr, align 8
...
if.end124:                                        ; preds = %if.end123, %while.end51
  ...
  store i32 %inc127, i32* %C126, align 8
  %104 = load i32, i32* %canary
  %105 = icmp eq i32 %104, 2067854278
  br i1 %105, label %106, label %func_exit
...
entry:
  %low = alloca i32, align 4
  %canary = alloca i32
  store i32 1225963451, i32* %canary
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %symbol.addr = alloca i16, align 2
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
...
if.end124:                                        ; preds = %if.end123, %while.end51
  ...
  store i32 %inc127, i32* %C126, align 8
  %104 = load i32, i32* %canary
  %105 = icmp eq i32 %104, 1225963451
  br i1 %105, label %106, label %func_exit
...
entry:
  ...
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 1801572442, i32* %canary
  %symbol.addr = alloca i16, align 2
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
  %0 = load %struct.EncodingEnvironment*, %struct.EncodingEnvironment** %eep.addr, align 8
...
while.end125:                                     ; preds = %while.cond
  ...
  store i32 %inc129, i32* %C128, align 8
  %110 = load i32, i32* %canary
  %111 = icmp eq i32 %110, 1801572442
  br i1 %111, label %112, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_encode_symbol_final.12(%struct.EncodingEnvironment* %eep, i16 signext %symbol) #0 {
entry:
  %range = alloca i32, align 4
  %symbol.addr = alloca i16, align 2
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 675016598, i32* %canary
  %low = alloca i32, align 4
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
  %0 = load %struct.EncodingEnvironment*, %struct.EncodingEnvironment** %eep.addr, align 8
...
entry:
  ...
  %symbol.addr = alloca i16, align 2
  %canary = alloca i32
  store i32 148893437, i32* %canary
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
  %0 = load %struct.EncodingEnvironment*, %struct.EncodingEnvironment** %eep.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 202424708, i32* %canary
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %code_len.addr = alloca i32*, align 8
  %code_buffer.addr = alloca i8*, align 8
  %slice_type.addr = alloca i32, align 4
...
entry:
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 136635974, i32* %canary
  %low = alloca i32, align 4
  %symbol.addr = alloca i16, align 2
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i16 %symbol, i16* %symbol.addr, align 2
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @arienco_start_encoding.16(%struct.EncodingEnvironment* %eep, i8* %code_buffer, i32* %code_len, i32 %slice_type) #0 {
entry:
  %slice_type.addr = alloca i32, align 4
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %code_len.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 1643919218, i32* %canary
  %code_buffer.addr = alloca i8*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i8* %code_buffer, i8** %code_buffer.addr, align 8
  store i32* %code_len, i32** %code_len.addr, align 8
...
entry:
  ...
  %ini.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 384030744, i32* %canary
  %ctx.addr = alloca %struct.BiContextType*, align 8
  store %struct.BiContextType* %ctx, %struct.BiContextType** %ctx.addr, align 8
  store i32* %ini, i32** %ini.addr, align 8
  %0 = load i32*, i32** %ini.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 233919778, i32* %canary
  %ctx.addr = alloca %struct.BiContextType*, align 8
  %ini.addr = alloca i32*, align 8
  %pstate = alloca i32, align 4
  store %struct.BiContextType* %ctx, %struct.BiContextType** %ctx.addr, align 8
...
entry:
  ...
  %eep.addr = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 1726398077, i32* %canary
  %slice_type.addr = alloca i32, align 4
  %code_buffer.addr = alloca i8*, align 8
  store %struct.EncodingEnvironment* %eep, %struct.EncodingEnvironment** %eep.addr, align 8
  store i8* %code_buffer, i8** %code_buffer.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @biari_init_context.20(%struct.BiContextType* %ctx, i32* %ini) #0 {
entry:
  %ini.addr = alloca i32*, align 8
  %pstate = alloca i32, align 4
  %canary = alloca i32
  store i32 1830730473, i32* %canary
  %ctx.addr = alloca %struct.BiContextType*, align 8
  store %struct.BiContextType* %ctx, %struct.BiContextType** %ctx.addr, align 8
  store i32* %ini, i32** %ini.addr, align 8
  %0 = load i32*, i32** %ini.addr, align 8
