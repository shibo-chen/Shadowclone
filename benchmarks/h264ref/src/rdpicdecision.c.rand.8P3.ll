; ModuleID = 'rdpicdecision.c.rand.8P3.bc'
...
func_rd_pic_decision.4:                           ; preds = %ctrl1
  %4 = call i32 @rd_pic_decision.4(double %snrY_version1, double %snrY_version2, i32 %bits_version1, i32 %bits_version2, double %lambda_picture)
  ret i32 %4
...
ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_rd_pic_decision.4, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_rd_pic_decision.6, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_rd_pic_decision.7, label %ctrl4
...
func_picture_coding_decision.5:                   ; preds = %ctrl0
  %3 = call i32 @picture_coding_decision.5(%struct.Picture* %picture1, %struct.Picture* %picture2, i32 %qp)
  ret i32 %3
...
ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_picture_coding_decision.5, label %ctrl1
...
entry:
  ...
  %canary = alloca i32
  store i32 1206776359, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1153882973, i32* %canary
...
entry:
  ...
  %bits_version2.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1552556582, i32* %canary
  %cost_version2 = alloca double, align 8
  %bits_version1.addr = alloca i32, align 4
  %cost_version1 = alloca double, align 8
  %retval = alloca i32, align 4
...
entry:
  ...
  %cost_version1 = alloca double, align 8
  %canary = alloca i32
  store i32 1310804204, i32* %canary
  %bits_version2.addr = alloca i32, align 4
  %snrY_version2.addr = alloca double, align 8
  %cost_version2 = alloca double, align 8
  %snrY_version1.addr = alloca double, align 8
...
entry:
  ...
  %picture2.addr = alloca %struct.Picture*, align 8
  %canary = alloca i32
  store i32 733482811, i32* %canary
  %spframe = alloca i32, align 4
  %bit_picture2 = alloca i32, align 4
  %snr_picture2 = alloca double, align 8
  %bit_picture1 = alloca i32, align 4
...
entry:
  ...
  %cost_version1 = alloca double, align 8
  %canary = alloca i32
  store i32 704065309, i32* %canary
  %snrY_version2.addr = alloca double, align 8
  store double %snrY_version1, double* %snrY_version1.addr, align 8
  store double %snrY_version2, double* %snrY_version2.addr, align 8
  store i32 %bits_version1, i32* %bits_version1.addr, align 4
...
entry:
  ...
  %cost_version1 = alloca double, align 8
  %canary = alloca i32
  store i32 1028286568, i32* %canary
  %snrY_version2.addr = alloca double, align 8
  %bits_version2.addr = alloca i32, align 4
  %lambda_picture.addr = alloca double, align 8
  %bits_version1.addr = alloca i32, align 4
...
entry:
  ...
  %bit_picture2 = alloca i32, align 4
  %canary = alloca i32
  store i32 262491490, i32* %canary
  %bit_picture1 = alloca i32, align 4
  %spframe = alloca i32, align 4
  %bframe = alloca i32, align 4
  %qp.addr = alloca i32, align 4
...
entry:
  ...
  %qp.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 301043877, i32* %canary
  %spframe = alloca i32, align 4
  %snr_picture2 = alloca double, align 8
  store %struct.Picture* %picture1, %struct.Picture** %picture1.addr, align 8
  store %struct.Picture* %picture2, %struct.Picture** %picture2.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1029565244, i32* %canary
  %retval = alloca i32, align 4
  %snrY_version1.addr = alloca double, align 8
  %cost_version2 = alloca double, align 8
  %bits_version2.addr = alloca i32, align 4
...
entry:
  %bits_version2.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1384048105, i32* %canary
  %snrY_version1.addr = alloca double, align 8
  %bits_version1.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  %cost_version2 = alloca double, align 8
...
entry:
  %canary = alloca i32
  store i32 418927816, i32* %canary
  %spframe = alloca i32, align 4
  %lambda_picture = alloca double, align 8
  %qp.addr = alloca i32, align 4
  %snr_picture1 = alloca double, align 8
