; ModuleID = 'mb_access.c.rand.4R3.bc'
...
func_mb_is_available.14:                          ; preds = %ctrl1
  %4 = call i32 @mb_is_available.14(i32 %mbAddr, i32 %currMbAddr)
  ret i32 %4

func_mb_is_available.23:                          ; preds = %ctrl1
  %5 = call i32 @mb_is_available.23(i32 %mbAddr, i32 %currMbAddr)
  ret i32 %5
...
ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_mb_is_available.14, label %func_mb_is_available.23
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_CheckAvailabilityOfNeighbors.1, label %func_CheckAvailabilityOfNeighbors.27

func_CheckAvailabilityOfNeighbors.1:              ; preds = %rand_bb
  call void @CheckAvailabilityOfNeighbors.1()
  ret void

func_CheckAvailabilityOfNeighbors.27:             ; preds = %rand_bb
  call void @CheckAvailabilityOfNeighbors.27()
  ret void
}
...
func_get_mb_block_pos.26:                         ; preds = %ctrl1
  call void @get_mb_block_pos.26(i32 %mb_addr, i32* %x, i32* %y)
  ret void

func_get_mb_block_pos.34:                         ; preds = %ctrl1
  call void @get_mb_block_pos.34(i32 %mb_addr, i32* %x, i32* %y)
  ret void
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_get_mb_block_pos.26, label %func_get_mb_block_pos.34
}
...
func_get_mb_pos.12:                               ; preds = %ctrl0
  call void @get_mb_pos.12(i32 %mb_addr, i32* %x, i32* %y)
  ret void

func_get_mb_pos.13:                               ; preds = %ctrl1
  call void @get_mb_pos.13(i32 %mb_addr, i32* %x, i32* %y)
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_get_mb_pos.12, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_get_mb_pos.13, label %func_get_mb_pos.15
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_getNonAffNeighbour.22, label %ctrl0

func_getNonAffNeighbour.22:                       ; preds = %rand_bb
  call void @getNonAffNeighbour.22(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

func_getNonAffNeighbour.28:                       ; preds = %ctrl0
  call void @getNonAffNeighbour.28(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

func_getNonAffNeighbour.29:                       ; preds = %ctrl1
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_getNonAffNeighbour.28, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_getNonAffNeighbour.29, label %func_getNonAffNeighbour.32
}
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_getAffNeighbour.5, label %func_getAffNeighbour.24
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_getLuma4x4Neighbour.6, label %ctrl0

func_getLuma4x4Neighbour.6:                       ; preds = %rand_bb
...
func_getLuma4x4Neighbour.30:                      ; preds = %ctrl1
  call void @getLuma4x4Neighbour.30(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix)
  ret void

func_getLuma4x4Neighbour.31:                      ; preds = %ctrl1
  call void @getLuma4x4Neighbour.31(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix)
  ret void
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_getLuma4x4Neighbour.30, label %func_getLuma4x4Neighbour.31
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_getChroma4x4Neighbour.16, label %ctrl0

func_getChroma4x4Neighbour.16:                    ; preds = %rand_bb
  call void @getChroma4x4Neighbour.16(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix)
  ret void

func_getChroma4x4Neighbour.20:                    ; preds = %ctrl0
  call void @getChroma4x4Neighbour.20(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix)
  ret void

func_getChroma4x4Neighbour.25:                    ; preds = %ctrl1
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_getChroma4x4Neighbour.20, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_getChroma4x4Neighbour.25, label %func_getChroma4x4Neighbour.33
}
...
entry:
  ...
  %canary = alloca i32
  store i32 1106756799, i32* %canary
...
if.end104:                                        ; preds = %if.then98, %if.end95
  ...
  %108 = icmp eq i32 %107, 1106756799
...
entry:
  %canary = alloca i32
  store i32 1524058084, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1477836502, i32* %canary
...
if.end376:                                        ; preds = %if.end375, %lor.lhs.false, %if.then8, %if.then1
  ...
  %310 = icmp eq i32 %309, 1477836502
...
entry:
  %curr_mb_nr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 782184764, i32* %canary
  %maxH = alloca i32, align 4
  %currMb = alloca %struct.macroblock*, align 8
  %pix.addr = alloca %struct.pix_pos*, align 8
  %xN.addr = alloca i32, align 4
...
entry:
  ...
  %luma.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1756561367, i32* %canary
  %curr_mb_nr.addr = alloca i32, align 4
  %currMb = alloca %struct.macroblock*, align 8
  %maxH = alloca i32, align 4
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
...
if.end376:                                        ; preds = %if.end375, %lor.lhs.false, %if.then8, %if.then1
  %309 = load i32, i32* %canary
  %310 = icmp eq i32 %309, 1756561367
  br i1 %310, label %311, label %func_exit
...
entry:
  %canary = alloca i32
  store i32 976003530, i32* %canary
...
entry:
  ...
  %currMbAddr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2039493419, i32* %canary
  %mbAddr.addr = alloca i32, align 4
  store i32 %mbAddr, i32* %mbAddr.addr, align 4
  store i32 %currMbAddr, i32* %currMbAddr.addr, align 4
  %0 = load i32, i32* %mbAddr.addr, align 4
...
entry:
  ...
  %yN.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 804613559, i32* %canary
  %pix.addr = alloca %struct.pix_pos*, align 8
  %luma.addr = alloca i32, align 4
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
  store i32 %xN, i32* %xN.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 499385868, i32* %canary
  %curr_mb_nr.addr = alloca i32, align 4
  %luma.addr = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
  %xN.addr = alloca i32, align 4
...
entry:
  %x.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 644885947, i32* %canary
  %y.addr = alloca i32*, align 8
  %mb_addr.addr = alloca i32, align 4
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
  store i32* %x, i32** %x.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @get_mb_pos.13(i32 %mb_addr, i32* %x, i32* %y) #0 {
entry:
  %y.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 234231062, i32* %canary
  %x.addr = alloca i32*, align 8
  %mb_addr.addr = alloca i32, align 4
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
  store i32* %x, i32** %x.addr, align 8
...
entry:
  %currMbAddr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2027700966, i32* %canary
  %retval = alloca i32, align 4
  %mbAddr.addr = alloca i32, align 4
  store i32 %mbAddr, i32* %mbAddr.addr, align 4
  store i32 %currMbAddr, i32* %currMbAddr.addr, align 4
...
entry:
  ...
  %mb_addr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 837190658, i32* %canary
  %x.addr = alloca i32*, align 8
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
  store i32* %x, i32** %x.addr, align 8
  store i32* %y, i32** %y.addr, align 8
...
entry:
  ...
  %y = alloca i32, align 4
  %canary = alloca i32
  store i32 259967861, i32* %canary
  %pix.addr = alloca %struct.pix_pos*, align 8
  %block_y.addr = alloca i32, align 4
  %rel_x.addr = alloca i32, align 4
  %x = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 301529193, i32* %canary
  %luma.addr = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
  %yN.addr = alloca i32, align 4
  %xN.addr = alloca i32, align 4
...
entry:
  ...
  %pix.addr = alloca %struct.pix_pos*, align 8
  %canary = alloca i32
  store i32 1576625537, i32* %canary
  %yN.addr = alloca i32, align 4
  %curr_mb_nr.addr = alloca i32, align 4
  %xN.addr = alloca i32, align 4
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
...
entry:
  ...
  %rel_y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1014191889, i32* %canary
  %rel_x.addr = alloca i32, align 4
  %block_y.addr = alloca i32, align 4
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
  store i32 %block_x, i32* %block_x.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getChroma4x4Neighbour.20(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix) #0 {
entry:
  %block_y.addr = alloca i32, align 4
  %rel_x.addr = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
  %canary = alloca i32
  store i32 361886733, i32* %canary
  %block_x.addr = alloca i32, align 4
  %x = alloca i32, align 4
  %rel_y.addr = alloca i32, align 4
  %y = alloca i32, align 4
...
entry:
  ...
  %mb_addr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1425028860, i32* %canary
  %x.addr = alloca i32*, align 8
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
  store i32* %x, i32** %x.addr, align 8
  store i32* %y, i32** %y.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getNonAffNeighbour.22(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix) #0 {
entry:
  %canary = alloca i32
  store i32 1795690873, i32* %canary
  %maxW = alloca i32, align 4
  %curr_mb_nr.addr = alloca i32, align 4
  %luma.addr = alloca i32, align 4
  %xN.addr = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 220756283, i32* %canary
  %currMbAddr.addr = alloca i32, align 4
  %mbAddr.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  store i32 %mbAddr, i32* %mbAddr.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 775945841, i32* %canary
  %maxW = alloca i32, align 4
  %yM = alloca i32, align 4
  %curr_mb_nr.addr = alloca i32, align 4
  %xN.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @get_mb_block_pos.26(i32 %mb_addr, i32* %x, i32* %y) #0 {
entry:
  %x.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 480047314, i32* %canary
  %y.addr = alloca i32*, align 8
  %mb_addr.addr = alloca i32, align 4
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
  store i32* %x, i32** %x.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @CheckAvailabilityOfNeighbors.27() #0 {
entry:
  %canary = alloca i32
  store i32 739317333, i32* %canary
  %mb_nr = alloca i32, align 4
  %currMB = alloca %struct.macroblock*, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %current_mb_nr = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 3
...
entry:
  ...
  %luma.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 628032542, i32* %canary
  %yN.addr = alloca i32, align 4
  %xN.addr = alloca i32, align 4
  %currMb = alloca %struct.macroblock*, align 8
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
...
entry:
  ...
  %luma.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 480175747, i32* %canary
  %xN.addr = alloca i32, align 4
  %maxH = alloca i32, align 4
  %currMb = alloca %struct.macroblock*, align 8
  %pix.addr = alloca %struct.pix_pos*, align 8
...
entry:
  ...
  %x = alloca i32, align 4
  %canary = alloca i32
  store i32 2037599691, i32* %canary
  %y = alloca i32, align 4
  %curr_mb_nr.addr = alloca i32, align 4
  %rel_x.addr = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getLuma4x4Neighbour.31(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix) #0 {
entry:
  %curr_mb_nr.addr = alloca i32, align 4
  %rel_x.addr = alloca i32, align 4
  %rel_y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2074797865, i32* %canary
  %block_y.addr = alloca i32, align 4
  %x = alloca i32, align 4
  %y = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
...
entry:
  ...
  %curr_mb_nr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1864483521, i32* %canary
  %maxW = alloca i32, align 4
  %yN.addr = alloca i32, align 4
  %xN.addr = alloca i32, align 4
  %maxH = alloca i32, align 4
...
entry:
  ...
  %curr_mb_nr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1730820042, i32* %canary
  %y = alloca i32, align 4
  %x = alloca i32, align 4
  %rel_x.addr = alloca i32, align 4
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @get_mb_block_pos.34(i32 %mb_addr, i32* %x, i32* %y) #0 {
entry:
  %canary = alloca i32
  store i32 1040637048, i32* %canary
  %mb_addr.addr = alloca i32, align 4
  %x.addr = alloca i32*, align 8
  %y.addr = alloca i32*, align 8
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
