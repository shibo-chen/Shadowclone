; ModuleID = 'leaky_bucket.c.rand.4P2.bc'
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_get_LeakyBucketRate.3, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_get_LeakyBucketRate.13, label %func_get_LeakyBucketRate.15
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_PutBigDoubleWord.6, label %func_PutBigDoubleWord.9
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_write_buffer.17, label %func_write_buffer.18
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_Sort.4, label %ctrl0

func_Sort.4:                                      ; preds = %rand_bb
  call void @Sort.4(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret void
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_Sort.14, label %func_Sort.16
}
...
func_calc_buffer.7:                               ; preds = %ctrl0
  call void @calc_buffer.7()
  ret void

func_calc_buffer.10:                              ; preds = %ctrl1
  call void @calc_buffer.10()
  ret void

func_calc_buffer.12:                              ; preds = %ctrl1
  call void @calc_buffer.12()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_calc_buffer.7, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_calc_buffer.10, label %func_calc_buffer.12
}
...
entry:
  ...
  %canary = alloca i32
  store i32 598018007, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 581569633, i32* %canary
...
entry:
  ...
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1509808902, i32* %canary
  %Rmin.addr = alloca i64*, align 8
  %retval = alloca i32, align 4
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Sort.4(i64 %NumberLeakyBuckets, i64* %Rmin) #0 {
entry:
  %i = alloca i64, align 8
  ...
  %canary = alloca i32
  store i32 1705297297, i32* %canary
  %Rmin.addr = alloca i64*, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
  store i64 0, i64* %i, align 8
...
entry:
  ...
  %canary = alloca i32
  store i32 100748043, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 104424161, i32* %canary
...
entry:
  ...
  %iChannelRate = alloca i64, align 8
  %canary = alloca i32
  store i32 531196642, i32* %canary
  %iFrame = alloca i64, align 8
  %Rmin = alloca i64*, align 8
  %InitFullness = alloca i64, align 8
  %NumberLeakyBuckets = alloca i64, align 8
...
entry:
  ...
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1082243390, i32* %canary
  %j = alloca i64, align 8
  %i = alloca i64, align 8
  %temp = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
...
entry:
  %fp.addr = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 1818097632, i32* %canary
  %dw.addr = alloca i64, align 8
  store i64 %dw, i64* %dw.addr, align 8
  store %struct._IO_FILE* %fp, %struct._IO_FILE** %fp.addr, align 8
  %0 = load i64, i64* %dw.addr, align 8
...
entry:
  ...
  %Rmin = alloca i64*, align 8
  %canary = alloca i32
  store i32 681525937, i32* %canary
  %TotalRate = alloca i64, align 8
  %Fmin = alloca i64*, align 8
  %minB = alloca i64, align 8
  %maxBuffer = alloca i64, align 8
...
entry:
  %canary = alloca i32
  store i32 661991588, i32* %canary
  %Fmin.addr = alloca i64*, align 8
  %Rmin.addr = alloca i64*, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %iBucket = alloca i64, align 8
...
entry:
  ...
  %Fmin = alloca i64*, align 8
  %canary = alloca i32
  store i32 1443439484, i32* %canary
  %InitFullness = alloca i64, align 8
  %FrameIndex = alloca i64, align 8
  %AvgRate = alloca i64, align 8
  %iChannelRate = alloca i64, align 8
...
for.end136:                                       ; preds = %for.cond57
  ...
  call void @free(i8* %148) #3
  %149 = load i32, i32* %canary
  %150 = icmp eq i32 %149, 1443439484
  br i1 %150, label %151, label %func_exit
...
entry:
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 227435638, i32* %canary
  %Rmin.addr = alloca i64*, align 8
  %i = alloca i64, align 8
  %buf = alloca i64, align 8
  %f = alloca %struct._IO_FILE*, align 8
...
entry:
  %Rmin.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 1482051369, i32* %canary
  %i = alloca i64, align 8
  %temp = alloca i64, align 8
  %j = alloca i64, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
...
entry:
  ...
  %f = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 873348360, i32* %canary
  %i = alloca i64, align 8
  %buf = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
...
entry:
  ...
  %i = alloca i64, align 8
  %canary = alloca i32
  store i32 825377077, i32* %canary
  %j = alloca i64, align 8
  %Rmin.addr = alloca i64*, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
...
entry:
  ...
  %Fmin.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 1227587177, i32* %canary
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %Rmin.addr = alloca i64*, align 8
  %outf = alloca %struct._IO_FILE*, align 8
  %iBucket = alloca i64, align 8
...
entry:
  %iBucket = alloca i64, align 8
  %canary = alloca i32
  store i32 1396802130, i32* %canary
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %Rmin.addr = alloca i64*, align 8
  %Bmin.addr = alloca i64*, align 8
  %outf = alloca %struct._IO_FILE*, align 8
