; ModuleID = 'rdopt_coding_state.c.rand.16P2.bc'
...
func_store_coding_state.6:                        ; preds = %ctrl1
  call void @store_coding_state.6(%struct.CSobj* %cs)
  ret void

func_store_coding_state.8:                        ; preds = %ctrl2
  call void @store_coding_state.8(%struct.CSobj* %cs)
  ret void

func_store_coding_state.15:                       ; preds = %ctrl3
  call void @store_coding_state.15(%struct.CSobj* %cs)
  ret void

func_store_coding_state.16:                       ; preds = %ctrl4
  call void @store_coding_state.16(%struct.CSobj* %cs)
  ret void

func_store_coding_state.17:                       ; preds = %ctrl5
  call void @store_coding_state.17(%struct.CSobj* %cs)
  ret void

func_store_coding_state.19:                       ; preds = %ctrl6
  call void @store_coding_state.19(%struct.CSobj* %cs)
  ret void

func_store_coding_state.21:                       ; preds = %ctrl7
  call void @store_coding_state.21(%struct.CSobj* %cs)
  ret void

func_store_coding_state.23:                       ; preds = %ctrl8
...
func_store_coding_state.26:                       ; preds = %ctrl10
  call void @store_coding_state.26(%struct.CSobj* %cs)
  ret void

func_store_coding_state.27:                       ; preds = %ctrl11
  call void @store_coding_state.27(%struct.CSobj* %cs)
  ret void

func_store_coding_state.28:                       ; preds = %ctrl12
...
func_store_coding_state.30:                       ; preds = %ctrl13
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_store_coding_state.6, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_store_coding_state.8, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_store_coding_state.15, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_store_coding_state.16, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_store_coding_state.17, label %ctrl6

ctrl6:                                            ; preds = %ctrl5
  %8 = icmp eq i32 %0, 7
  br i1 %8, label %func_store_coding_state.19, label %ctrl7

ctrl7:                                            ; preds = %ctrl6
  %9 = icmp eq i32 %0, 8
  br i1 %9, label %func_store_coding_state.21, label %ctrl8

ctrl8:                                            ; preds = %ctrl7
  %10 = icmp eq i32 %0, 9
  br i1 %10, label %func_store_coding_state.23, label %ctrl9
...
ctrl10:                                           ; preds = %ctrl9
  %12 = icmp eq i32 %0, 11
  br i1 %12, label %func_store_coding_state.26, label %ctrl11

ctrl11:                                           ; preds = %ctrl10
  %13 = icmp eq i32 %0, 12
  br i1 %13, label %func_store_coding_state.27, label %ctrl12

ctrl12:                                           ; preds = %ctrl11
  %14 = icmp eq i32 %0, 13
  br i1 %14, label %func_store_coding_state.28, label %ctrl13

ctrl13:                                           ; preds = %ctrl12
  %15 = icmp eq i32 %0, 14
  br i1 %15, label %func_store_coding_state.29, label %func_store_coding_state.30
}
...
func_reset_coding_state.9:                        ; preds = %ctrl3
...
ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_reset_coding_state.9, label %ctrl4
...
ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_reset_coding_state.11, label %ctrl6

ctrl6:                                            ; preds = %ctrl5
  %8 = icmp eq i32 %0, 7
  br i1 %8, label %func_reset_coding_state.12, label %ctrl7

ctrl7:                                            ; preds = %ctrl6
  %9 = icmp eq i32 %0, 8
  br i1 %9, label %func_reset_coding_state.13, label %ctrl8

ctrl8:                                            ; preds = %ctrl7
  %10 = icmp eq i32 %0, 9
  br i1 %10, label %func_reset_coding_state.14, label %ctrl9

ctrl9:                                            ; preds = %ctrl8
  %11 = icmp eq i32 %0, 10
  br i1 %11, label %func_reset_coding_state.18, label %ctrl10

ctrl10:                                           ; preds = %ctrl9
  %12 = icmp eq i32 %0, 11
  br i1 %12, label %func_reset_coding_state.20, label %ctrl11

ctrl11:                                           ; preds = %ctrl10
  %13 = icmp eq i32 %0, 12
  br i1 %13, label %func_reset_coding_state.22, label %ctrl12
...
entry:
  ...
  %canary = alloca i32
  store i32 2081982785, i32* %canary
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 2016931607, i32* %canary
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  store %struct.CSobj* %cs, %struct.CSobj** %cs.addr, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
entry:
  %canary = alloca i32
  store i32 1989951722, i32* %canary
  %bs_src = alloca %struct.Bitstream*, align 8
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %currMB = alloca %struct.macroblock*, align 8
...
entry:
  ...
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %canary = alloca i32
  store i32 1406884076, i32* %canary
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  store %struct.CSobj* %cs, %struct.CSobj** %cs.addr, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
entry:
  %canary = alloca i32
  store i32 1415677890, i32* %canary
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %bs_dest = alloca %struct.Bitstream*, align 8
...
entry:
  ...
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 171232306, i32* %canary
  %cs.addr = alloca %struct.CSobj*, align 8
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  store %struct.CSobj* %cs, %struct.CSobj** %cs.addr, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
entry:
  %canary = alloca i32
  store i32 734968298, i32* %canary
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %bs_src = alloca %struct.Bitstream*, align 8
  %bs_dest = alloca %struct.Bitstream*, align 8
...
entry:
  ...
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %canary = alloca i32
  store i32 788355390, i32* %canary
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %bs_dest = alloca %struct.Bitstream*, align 8
  %currMB = alloca %struct.macroblock*, align 8
...
entry:
  ...
  %bs_src = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 1672249684, i32* %canary
  %i = alloca i32, align 4
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
...
entry:
  ...
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %canary = alloca i32
  store i32 140468705, i32* %canary
  %bs_dest = alloca %struct.Bitstream*, align 8
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %cs.addr = alloca %struct.CSobj*, align 8
  %i = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 2071808998, i32* %canary
  %cs.addr = alloca %struct.CSobj*, align 8
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1281415575, i32* %canary
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %bs_src = alloca %struct.Bitstream*, align 8
  %cs.addr = alloca %struct.CSobj*, align 8
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
...
entry:
  ...
  %bs_src = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 427484249, i32* %canary
  %i = alloca i32, align 4
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %cs.addr = alloca %struct.CSobj*, align 8
  store %struct.CSobj* %cs, %struct.CSobj** %cs.addr, align 8
...
entry:
  ...
  %currMB = alloca %struct.macroblock*, align 8
  %canary = alloca i32
  store i32 506070899, i32* %canary
  %i = alloca i32, align 4
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  store %struct.CSobj* %cs, %struct.CSobj** %cs.addr, align 8
...
entry:
  ...
  %bs_dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 1472464115, i32* %canary
  %currMB = alloca %struct.macroblock*, align 8
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %cs.addr = alloca %struct.CSobj*, align 8
...
entry:
  %currMB = alloca %struct.macroblock*, align 8
  %canary = alloca i32
  store i32 1574535416, i32* %canary
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %cs.addr = alloca %struct.CSobj*, align 8
  %bs_src = alloca %struct.Bitstream*, align 8
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
...
entry:
  ...
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %canary = alloca i32
  store i32 1025488568, i32* %canary
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %i = alloca i32, align 4
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %currMB = alloca %struct.macroblock*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @store_coding_state.19(%struct.CSobj* %cs) #0 {
entry:
  %cs.addr = alloca %struct.CSobj*, align 8
  %i = alloca i32, align 4
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  ...
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 1812700381, i32* %canary
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %currMB = alloca %struct.macroblock*, align 8
  %bs_dest = alloca %struct.Bitstream*, align 8
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
...
entry:
  ...
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %canary = alloca i32
  store i32 526959011, i32* %canary
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %bs_dest = alloca %struct.Bitstream*, align 8
  %i = alloca i32, align 4
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
...
entry:
  ...
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 136703772, i32* %canary
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %cs.addr = alloca %struct.CSobj*, align 8
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %currMB = alloca %struct.macroblock*, align 8
...
entry:
  ...
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 1913280433, i32* %canary
  %i = alloca i32, align 4
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
...
entry:
  ...
  %bs_src = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 1627306559, i32* %canary
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %i = alloca i32, align 4
  %cs.addr = alloca %struct.CSobj*, align 8
...
entry:
  ...
  %cs.addr = alloca %struct.CSobj*, align 8
  %canary = alloca i32
  store i32 1617099294, i32* %canary
  %i = alloca i32, align 4
  %bs_dest = alloca %struct.Bitstream*, align 8
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
...
entry:
  ...
  %bs_dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 338807013, i32* %canary
  %cs.addr = alloca %struct.CSobj*, align 8
  %bs_src = alloca %struct.Bitstream*, align 8
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %currMB = alloca %struct.macroblock*, align 8
...
entry:
  ...
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 1236807378, i32* %canary
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %cs.addr = alloca %struct.CSobj*, align 8
  store %struct.CSobj* %cs, %struct.CSobj** %cs.addr, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
entry:
  %bs_dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 1950399791, i32* %canary
  %currMB = alloca %struct.macroblock*, align 8
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %i = alloca i32, align 4
...
entry:
  ...
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %canary = alloca i32
  store i32 1864182279, i32* %canary
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %i = alloca i32, align 4
...
entry:
  ...
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %canary = alloca i32
  store i32 1909731124, i32* %canary
  %currMB = alloca %struct.macroblock*, align 8
  store %struct.CSobj* %cs, %struct.CSobj** %cs.addr, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %currentSlice = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 50
...
entry:
  ...
  %cs.addr = alloca %struct.CSobj*, align 8
  %canary = alloca i32
  store i32 953451186, i32* %canary
  %i = alloca i32, align 4
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %bs_src = alloca %struct.Bitstream*, align 8
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
...
entry:
  ...
  %bs_src = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 974415928, i32* %canary
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %cs.addr = alloca %struct.CSobj*, align 8
...
entry:
  ...
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %canary = alloca i32
  store i32 1274677414, i32* %canary
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %cs.addr = alloca %struct.CSobj*, align 8
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  store %struct.CSobj* %cs, %struct.CSobj** %cs.addr, align 8
