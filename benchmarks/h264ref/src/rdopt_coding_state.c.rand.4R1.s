...
.LBB2_3:                                # %func_store_coding_state.3
	...
	.cfi_def_cfa %rsp, 8
	retq
.LBB2_4:                                # %func_store_coding_state.4
	.cfi_def_cfa %rbp, 16
	movq	%rbx, %rdi
...
# %bb.0:                                # %rand_bb
	...
	cmpl	$0, %eax
	jne	.LBB3_5
# %bb.1:                                # %func_reset_coding_state.5
	movq	%rbx, %rdi
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$96, %rsp
	movl	$1309409228, -44(%rbp)  # imm = 0x4E0BFFCC
	movq	%rdi, -16(%rbp)
	movq	img, %rax
	movq	14160(%rax), %rax
	movq	32(%rax), %rax
...
.LBB4_19:                               # %if.end41
	...
	movq	%rax, 344(%rcx)
.LBB4_20:                               # %return
	cmpl	$1309409228, -44(%rbp)  # imm = 0x4E0BFFCC
	jne	.LBB4_22
.LBB4_21:
	addq	$96, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$96, %rsp
	movl	$1119112694, -44(%rbp)  # imm = 0x42B44DF6
	movq	%rdi, -16(%rbp)
	movq	img, %rax
	movq	14160(%rax), %rax
	movq	32(%rax), %rax
...
.LBB5_19:                               # %if.end41
	...
	movq	%rax, 344(%rcx)
.LBB5_20:                               # %return
	cmpl	$1119112694, -44(%rbp)  # imm = 0x42B44DF6
	jne	.LBB5_22
.LBB5_21:
	addq	$96, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$96, %rsp
	movl	$1517295713, -44(%rbp)  # imm = 0x5A701861
	movq	%rdi, -16(%rbp)
	movq	img, %rax
	movq	14160(%rax), %rax
	movq	32(%rax), %rax
...
.LBB6_19:                               # %if.end41
	...
	movq	%rax, 344(%rcx)
.LBB6_20:                               # %return
	cmpl	$1517295713, -44(%rbp)  # imm = 0x5A701861
	jne	.LBB6_22
.LBB6_21:
	addq	$96, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$96, %rsp
	movl	$1872365524, -44(%rbp)  # imm = 0x6F9A07D4
	movq	%rdi, -16(%rbp)
	movq	img, %rax
	movq	14160(%rax), %rax
	movq	32(%rax), %rax
...
.LBB7_19:                               # %if.end41
	...
	movq	%rax, 344(%rcx)
.LBB7_20:                               # %return
	cmpl	$1872365524, -44(%rbp)  # imm = 0x6F9A07D4
	jne	.LBB7_22
.LBB7_21:
	addq	$96, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$96, %rsp
	movl	$1170281956, -44(%rbp)  # imm = 0x45C115E4
	movq	%rdi, -16(%rbp)
	movq	img, %rax
	movq	14160(%rax), %rax
	movq	32(%rax), %rax
...
.LBB8_19:                               # %if.end41
	...
	movq	%rax, 504(%rcx)
.LBB8_20:                               # %return
	cmpl	$1170281956, -44(%rbp)  # imm = 0x45C115E4
	jne	.LBB8_22
.LBB8_21:
	addq	$96, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$96, %rsp
	movl	$1141885782, -44(%rbp)  # imm = 0x440FCB56
	movq	%rdi, -16(%rbp)
	movq	img, %rax
	movq	14160(%rax), %rax
	movq	32(%rax), %rax
...
.LBB9_19:                               # %if.end41
	...
	movq	%rax, 504(%rcx)
.LBB9_20:                               # %return
	cmpl	$1141885782, -44(%rbp)  # imm = 0x440FCB56
	jne	.LBB9_22
.LBB9_21:
	addq	$96, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$96, %rsp
	movl	$618017146, -44(%rbp)   # imm = 0x24D6317A
	movq	%rdi, -16(%rbp)
	movq	img, %rax
	movq	14160(%rax), %rax
	movq	32(%rax), %rax
...
.LBB10_19:                              # %if.end41
	...
	movq	%rax, 504(%rcx)
.LBB10_20:                              # %return
	cmpl	$618017146, -44(%rbp)   # imm = 0x24D6317A
	jne	.LBB10_22
.LBB10_21:
	addq	$96, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$96, %rsp
	movl	$1632998784, -44(%rbp)  # imm = 0x61559580
	movq	%rdi, -16(%rbp)
	movq	img, %rax
	movq	14160(%rax), %rax
	movq	32(%rax), %rax
...
.LBB11_19:                              # %if.end41
	...
	movq	%rax, 504(%rcx)
.LBB11_20:                              # %return
	cmpl	$1632998784, -44(%rbp)  # imm = 0x61559580
	jne	.LBB11_22
.LBB11_21:
	addq	$96, %rsp
	popq	%rbp
