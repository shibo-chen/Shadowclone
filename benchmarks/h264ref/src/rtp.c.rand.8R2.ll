...
func_WriteRTPPacket.5:                            ; preds = %ctrl1
  %4 = call i32 @WriteRTPPacket.5(%struct.RTPpacket_t* %p, %struct._IO_FILE* %f)
  ret i32 %4

func_WriteRTPPacket.6:                            ; preds = %ctrl2
  %5 = call i32 @WriteRTPPacket.6(%struct.RTPpacket_t* %p, %struct._IO_FILE* %f)
  ret i32 %5

func_WriteRTPPacket.7:                            ; preds = %ctrl3
  %6 = call i32 @WriteRTPPacket.7(%struct.RTPpacket_t* %p, %struct._IO_FILE* %f)
  ret i32 %6
...
ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_WriteRTPPacket.3, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_WriteRTPPacket.5, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_WriteRTPPacket.6, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_WriteRTPPacket.7, label %ctrl4
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_WriteRTPNALU.8, label %func_WriteRTPNALU.9

func_WriteRTPNALU.8:                              ; preds = %rand_bb
  %2 = call i32 @WriteRTPNALU.8(%struct.NALU_t* %n)
  ret i32 %2
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_RTPUpdateTimestamp.1, label %func_RTPUpdateTimestamp.4
...
entry:
  ...
  %canary = alloca i32
  store i32 1993652485, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1352106930, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1859801417, i32* %canary
  %retval = alloca i32, align 4
  %f.addr = alloca %struct._IO_FILE*, align 8
  %p.addr = alloca %struct.RTPpacket_t*, align 8
  %intime = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1541701569, i32* %canary
  %tr.addr = alloca i32, align 4
  %delta = alloca i32, align 4
  store i32 %tr, i32* %tr.addr, align 4
  %0 = load i32, i32* @RTPUpdateTimestamp.oldtr, align 4
...
entry:
  ...
  %intime = alloca i32, align 4
  %canary = alloca i32
  store i32 710630583, i32* %canary
  %p.addr = alloca %struct.RTPpacket_t*, align 8
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
  store i32 -1, i32* %intime, align 4
...
entry:
  %p.addr = alloca %struct.RTPpacket_t*, align 8
  %canary = alloca i32
  store i32 139410703, i32* %canary
  %retval = alloca i32, align 4
  %intime = alloca i32, align 4
  %f.addr = alloca %struct._IO_FILE*, align 8
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 2114358758, i32* %canary
  %f.addr = alloca %struct._IO_FILE*, align 8
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
  store i32 -1, i32* %intime, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 1312921186, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 332859667, i32* %canary
  %p = alloca %struct.RTPpacket_t*, align 8
  %n.addr = alloca %struct.NALU_t*, align 8
  store %struct.NALU_t* %n, %struct.NALU_t** %n.addr, align 8
  %0 = load %struct.NALU_t*, %struct.NALU_t** %n.addr, align 8
...
entry:
  ...
  %intime = alloca i32, align 4
  %canary = alloca i32
  store i32 1692030872, i32* %canary
  %f.addr = alloca %struct._IO_FILE*, align 8
  %retval = alloca i32, align 4
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
...
entry:
  ...
  %intime = alloca i32, align 4
  %canary = alloca i32
  store i32 1525379852, i32* %canary
  %retval = alloca i32, align 4
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
  store i32 -1, i32* %intime, align 4
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1076180717, i32* %canary
  %intime = alloca i32, align 4
  store %struct.RTPpacket_t* %p, %struct.RTPpacket_t** %p.addr, align 8
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
  store i32 -1, i32* %intime, align 4
