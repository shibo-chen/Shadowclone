...
ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_RBSPtoNALU.2, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_RBSPtoNALU.3, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_RBSPtoNALU.4, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_RBSPtoNALU.5, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_RBSPtoNALU.6, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_RBSPtoNALU.7, label %func_RBSPtoNALU.8
}
...
entry:
  %canary = alloca i32
  store i32 1232103908, i32* %canary
  %len = alloca i32, align 4
  %nalu.addr = alloca %struct.NALU_t*, align 8
  %nal_unit_type.addr = alloca i32, align 4
  %rbsp_size.addr = alloca i32, align 4
...
entry:
  ...
  %nalu.addr = alloca %struct.NALU_t*, align 8
  %canary = alloca i32
  store i32 902466920, i32* %canary
  %len = alloca i32, align 4
  %rbsp.addr = alloca i8*, align 8
  %rbsp_size.addr = alloca i32, align 4
  %nal_unit_type.addr = alloca i32, align 4
...
entry:
  ...
  %rbsp_size.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1291017008, i32* %canary
  %nalu.addr = alloca %struct.NALU_t*, align 8
  %nal_reference_idc.addr = alloca i32, align 4
  store i8* %rbsp, i8** %rbsp.addr, align 8
  store %struct.NALU_t* %nalu, %struct.NALU_t** %nalu.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 155282864, i32* %canary
  %rbsp.addr = alloca i8*, align 8
  %nal_reference_idc.addr = alloca i32, align 4
  %UseAnnexbLongStartcode.addr = alloca i32, align 4
  %rbsp_size.addr = alloca i32, align 4
