; ModuleID = 'filehandle.c.rand.8R2.bc'
...
ctrl3:                                            ; preds = %ctrl2
  %11 = icmp eq i32 %0, 4
  br i1 %11, label %func_write_PPS.13, label %func_write_PPS.16
}
...
func_start_sequence.2:                            ; preds = %ctrl0
  %3 = call i32 @start_sequence.2()
  ret i32 %3

func_start_sequence.5:                            ; preds = %ctrl1
  %4 = call i32 @start_sequence.5()
  ret i32 %4
...
ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_start_sequence.2, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_start_sequence.5, label %ctrl2
...
ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_start_sequence.12, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_start_sequence.14, label %func_start_sequence.15
}
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 305315489, i32* %canary
...
entry:
  ...
  %nalu = alloca %struct.NALU_t*, align 8
  %canary = alloca i32
  store i32 485219692, i32* %canary
  %len = alloca i32, align 4
  %retval = alloca i32, align 4
  store i32 0, i32* %len, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
entry:
  ...
  %nalu = alloca %struct.NALU_t*, align 8
  %canary = alloca i32
  store i32 678578992, i32* %canary
...
entry:
  ...
  %len.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1642119118, i32* %canary
  %PPS_id.addr = alloca i32, align 4
  store i32 %len, i32* %len.addr, align 4
  store i32 %PPS_id, i32* %PPS_id.addr, align 4
  store %struct.NALU_t* null, %struct.NALU_t** %nalu, align 8
...
entry:
  %canary = alloca i32
  store i32 422849848, i32* %canary
  %retval = alloca i32, align 4
  %total_pps = alloca i32, align 4
  %i = alloca i32, align 4
  %nalu = alloca %struct.NALU_t*, align 8
...
entry:
  ...
  %canary = alloca i32
  store i32 323958323, i32* %canary
...
entry:
  %text.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1419483876, i32* %canary
  %code.addr = alloca i32, align 4
  store i8* %text, i8** %text.addr, align 8
  store i32 %code, i32* %code.addr, align 4
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
...
entry:
  %PPS_id.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 697378334, i32* %canary
  %len.addr = alloca i32, align 4
  %nalu = alloca %struct.NALU_t*, align 8
  store i32 %len, i32* %len.addr, align 4
  store i32 %PPS_id, i32* %PPS_id.addr, align 4
...
entry:
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1183513438, i32* %canary
  %nalu = alloca %struct.NALU_t*, align 8
  %i = alloca i32, align 4
  %total_pps = alloca i32, align 4
  %len = alloca i32, align 4
...
entry:
  ...
  %nalu = alloca %struct.NALU_t*, align 8
  %canary = alloca i32
  store i32 1117596366, i32* %canary
  %i = alloca i32, align 4
  store i32 0, i32* %len, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %GenerateMultiplePPS = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 15
...
entry:
  %canary = alloca i32
  store i32 1736212811, i32* %canary
  %nalu = alloca %struct.NALU_t*, align 8
  %PPS_id.addr = alloca i32, align 4
  %len.addr = alloca i32, align 4
  store i32 %len, i32* %len.addr, align 4
...
entry:
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 772304588, i32* %canary
  %total_pps = alloca i32, align 4
  %nalu = alloca %struct.NALU_t*, align 8
  %len = alloca i32, align 4
  %i = alloca i32, align 4
...
entry:
  %len.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1844826961, i32* %canary
  %PPS_id.addr = alloca i32, align 4
  %nalu = alloca %struct.NALU_t*, align 8
  store i32 %len, i32* %len.addr, align 4
  store i32 %PPS_id, i32* %PPS_id.addr, align 4
...
entry:
  ...
  %len = alloca i32, align 4
  %canary = alloca i32
  store i32 854715098, i32* %canary
  %i = alloca i32, align 4
  %nalu = alloca %struct.NALU_t*, align 8
  %total_pps = alloca i32, align 4
  store i32 0, i32* %len, align 4
...
entry:
  ...
  %nalu = alloca %struct.NALU_t*, align 8
  %canary = alloca i32
  store i32 1265786287, i32* %canary
  %len.addr = alloca i32, align 4
  store i32 %len, i32* %len.addr, align 4
  store i32 %PPS_id, i32* %PPS_id.addr, align 4
  store %struct.NALU_t* null, %struct.NALU_t** %nalu, align 8
