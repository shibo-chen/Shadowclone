; ModuleID = 'filehandle.c.rand.8P3.bc'
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_error.5, label %func_error.6
...
func_write_PPS.4:                                 ; preds = %ctrl1
  %4 = call i32 @write_PPS.4(i32 %len, i32 %PPS_id)
  ret i32 %4
...
ctrl1:                                            ; preds = %ctrl0
  %9 = icmp eq i32 %0, 2
  br i1 %9, label %func_write_PPS.4, label %ctrl2
...
func_start_sequence.10:                           ; preds = %ctrl0
  %3 = call i32 @start_sequence.10()
  ret i32 %3
...
ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_start_sequence.10, label %ctrl1
...
entry:
  ...
  %canary = alloca i32
  store i32 1584863084, i32* %canary
  %retval = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1490125478, i32* %canary
...
entry:
  %len.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1647600329, i32* %canary
  %PPS_id.addr = alloca i32, align 4
  %nalu = alloca %struct.NALU_t*, align 8
  store i32 %len, i32* %len.addr, align 4
  store i32 %PPS_id, i32* %PPS_id.addr, align 4
...
entry:
  %PPS_id.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1860543917, i32* %canary
  %nalu = alloca %struct.NALU_t*, align 8
  %len.addr = alloca i32, align 4
  store i32 %len, i32* %len.addr, align 4
  store i32 %PPS_id, i32* %PPS_id.addr, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 1386598097, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1726185910, i32* %canary
  %text.addr = alloca i8*, align 8
  %code.addr = alloca i32, align 4
  store i8* %text, i8** %text.addr, align 8
  store i32 %code, i32* %code.addr, align 4
...
entry:
  ...
  %PPS_id.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1174339032, i32* %canary
  %len.addr = alloca i32, align 4
  store i32 %len, i32* %len.addr, align 4
  store i32 %PPS_id, i32* %PPS_id.addr, align 4
  store %struct.NALU_t* null, %struct.NALU_t** %nalu, align 8
...
entry:
  ...
  %len.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 222623651, i32* %canary
  %nalu = alloca %struct.NALU_t*, align 8
  store i32 %len, i32* %len.addr, align 4
  store i32 %PPS_id, i32* %PPS_id.addr, align 4
  store %struct.NALU_t* null, %struct.NALU_t** %nalu, align 8
...
entry:
  ...
  %len.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 280937177, i32* %canary
  %PPS_id.addr = alloca i32, align 4
  store i32 %len, i32* %len.addr, align 4
  store i32 %PPS_id, i32* %PPS_id.addr, align 4
  store %struct.NALU_t* null, %struct.NALU_t** %nalu, align 8
...
entry:
  %canary = alloca i32
  store i32 1166671850, i32* %canary
  %nalu = alloca %struct.NALU_t*, align 8
  %i = alloca i32, align 4
  %total_pps = alloca i32, align 4
  %len = alloca i32, align 4
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 257236667, i32* %canary
  %nalu = alloca %struct.NALU_t*, align 8
  store i32 0, i32* %len, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %GenerateMultiplePPS = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 15
...
entry:
  ...
  %len = alloca i32, align 4
  %canary = alloca i32
  store i32 1135077358, i32* %canary
  %nalu = alloca %struct.NALU_t*, align 8
  %retval = alloca i32, align 4
  %i = alloca i32, align 4
  store i32 0, i32* %len, align 4
...
entry:
  ...
  %len = alloca i32, align 4
  %canary = alloca i32
  store i32 159739899, i32* %canary
  %retval = alloca i32, align 4
  %i = alloca i32, align 4
  store i32 0, i32* %len, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
entry:
  %total_pps = alloca i32, align 4
  %canary = alloca i32
  store i32 388101386, i32* %canary
  %len = alloca i32, align 4
  %retval = alloca i32, align 4
  %nalu = alloca %struct.NALU_t*, align 8
  %i = alloca i32, align 4
...
entry:
  ...
  %len = alloca i32, align 4
  %canary = alloca i32
  store i32 862728795, i32* %canary
  %i = alloca i32, align 4
  store i32 0, i32* %len, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %GenerateMultiplePPS = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 15
...
entry:
  ...
  %nalu = alloca %struct.NALU_t*, align 8
  %canary = alloca i32
  store i32 443046332, i32* %canary
  %len = alloca i32, align 4
  %total_pps = alloca i32, align 4
  store i32 0, i32* %len, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
