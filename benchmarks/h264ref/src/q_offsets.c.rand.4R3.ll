; ModuleID = 'q_offsets.c.rand.4R3.bc'
...
func_CheckOffsetParameterName.10:                 ; preds = %ctrl1
  %4 = call i32 @CheckOffsetParameterName.10(i8* %s, i32* %type)
  ret i32 %4

func_CheckOffsetParameterName.16:                 ; preds = %ctrl1
  %5 = call i32 @CheckOffsetParameterName.16(i8* %s, i32* %type)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_CheckOffsetParameterName.7, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_CheckOffsetParameterName.10, label %func_CheckOffsetParameterName.16
}
...
func_ParseQOffsetMatrix.13:                       ; preds = %ctrl1
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_ParseQOffsetMatrix.13, label %func_ParseQOffsetMatrix.15
}
...
func_CalculateOffsetParam.4:                      ; preds = %ctrl1
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_CalculateOffsetParam.4, label %func_CalculateOffsetParam.8
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_CalculateOffset8Param.3, label %ctrl0

func_CalculateOffset8Param.3:                     ; preds = %rand_bb
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_CalculateOffset8Param.11, label %func_CalculateOffset8Param.14
}
...
entry:
  ...
  %canary = alloca i32
  store i32 2054944241, i32* %canary
...
if.end225:                                        ; preds = %for.end224, %for.end102
  ...
  %133 = icmp eq i32 %132, 2054944241
...
entry:
  ...
  %qp_per = alloca i32, align 4
  %canary = alloca i32
  store i32 421991761, i32* %canary
  %j = alloca i32, align 4
  %temp = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %OffsetMatrixPresentFlag = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 147
...
entry:
  ...
  %canary = alloca i32
  store i32 723318190, i32* %canary
  %i = alloca i32, align 4
  %k = alloca i32, align 4
  %temp = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
entry:
  %canary = alloca i32
  store i32 971134716, i32* %canary
  %qp_per = alloca i32, align 4
  %temp = alloca i32, align 4
  %k = alloca i32, align 4
  %i = alloca i32, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 1288721391, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 126014354, i32* %canary
  %i = alloca i32, align 4
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 844635918, i32* %canary
  %type.addr = alloca i32*, align 8
  %i = alloca i32, align 4
  store i8* %s, i8** %s.addr, align 8
  store i32* %type, i32** %type.addr, align 8
...
entry:
  ...
  %temp = alloca i32, align 4
  %canary = alloca i32
  store i32 2119732354, i32* %canary
  %i = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %OffsetMatrixPresentFlag = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 147
  %1 = load i32, i32* %OffsetMatrixPresentFlag, align 8
...
if.end225:                                        ; preds = %for.end224, %for.end102
  %132 = load i32, i32* %canary
  %133 = icmp eq i32 %132, 2119732354
  br i1 %133, label %134, label %func_exit
...
entry:
  %temp = alloca i32, align 4
  %canary = alloca i32
  store i32 1132808645, i32* %canary
  %j = alloca i32, align 4
  %k = alloca i32, align 4
  %q_bits = alloca i32, align 4
  %i = alloca i32, align 4
...
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 108486408, i32* %canary
  %type.addr = alloca i32*, align 8
  %s.addr = alloca i8*, align 8
  %retval = alloca i32, align 4
  store i8* %s, i8** %s.addr, align 8
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1796311038, i32* %canary
  %temp = alloca i32, align 4
  %k = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %OffsetMatrixPresentFlag = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 147
...
entry:
  %canary = alloca i32
  store i32 1095940424, i32* %canary
  %MapIdx = alloca i32, align 4
  %items = alloca [1000 x i8*], align 16
  %item = alloca i32, align 4
  %OffsetList = alloca i16*, align 8
...
entry:
  ...
  %temp = alloca i32, align 4
  %canary = alloca i32
  store i32 1826960767, i32* %canary
  %k = alloca i32, align 4
  %i = alloca i32, align 4
  %q_bits = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
entry:
  ...
  %InString = alloca i32, align 4
  %canary = alloca i32
  store i32 1662576755, i32* %canary
  %bufsize.addr = alloca i32, align 4
  %cnt = alloca i32, align 4
  %OffsetList = alloca i16*, align 8
  %IntContent = alloca i32, align 4
...
entry:
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 527415705, i32* %canary
  %s.addr = alloca i8*, align 8
  %i = alloca i32, align 4
  %type.addr = alloca i32*, align 8
  store i8* %s, i8** %s.addr, align 8
