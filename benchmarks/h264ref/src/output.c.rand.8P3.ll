...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_testEndian.8, label %func_testEndian.12

func_testEndian.8:                                ; preds = %rand_bb
  %2 = call i32 @testEndian.8()
  ret i32 %2

func_testEndian.12:                               ; preds = %rand_bb
  %3 = call i32 @testEndian.12()
  ret i32 %3
}
...
func_img2buf.15:                                  ; preds = %ctrl1
  call void @img2buf.15(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom)
  ret void

func_img2buf.21:                                  ; preds = %ctrl2
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_img2buf.15, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_img2buf.21, label %ctrl3
...
func_write_picture.6:                             ; preds = %ctrl0
  call void @write_picture.6(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure)
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_write_picture.6, label %ctrl1
...
ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_write_picture.19, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_write_picture.20, label %func_write_picture.28
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_write_out_picture.13, label %ctrl0

func_write_out_picture.13:                        ; preds = %rand_bb
  call void @write_out_picture.13(%struct.storable_picture* %p, i32 %p_out)
  ret void

func_write_out_picture.16:                        ; preds = %ctrl0
  call void @write_out_picture.16(%struct.storable_picture* %p, i32 %p_out)
  ret void

func_write_out_picture.24:                        ; preds = %ctrl1
...
func_write_out_picture.30:                        ; preds = %ctrl4
...
func_write_out_picture.33:                        ; preds = %ctrl5
  call void @write_out_picture.33(%struct.storable_picture* %p, i32 %p_out)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_write_out_picture.16, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_write_out_picture.24, label %ctrl2
...
ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_write_out_picture.30, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_write_out_picture.32, label %func_write_out_picture.33
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_clear_picture.1, label %func_clear_picture.3

func_clear_picture.1:                             ; preds = %rand_bb
  call void @clear_picture.1(%struct.storable_picture* %p)
  ret void
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_write_unpaired_field.9, label %ctrl0

func_write_unpaired_field.9:                      ; preds = %rand_bb
  call void @write_unpaired_field.9(%struct.frame_store* %fs, i32 %p_out)
  ret void

func_write_unpaired_field.17:                     ; preds = %ctrl0
...
func_write_unpaired_field.23:                     ; preds = %ctrl2
  call void @write_unpaired_field.23(%struct.frame_store* %fs, i32 %p_out)
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_write_unpaired_field.17, label %ctrl1
...
ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_write_unpaired_field.23, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_write_unpaired_field.27, label %func_write_unpaired_field.29
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_write_stored_frame.5, label %func_write_stored_frame.10

func_write_stored_frame.5:                        ; preds = %rand_bb
  call void @write_stored_frame.5(%struct.frame_store* %fs, i32 %p_out)
  ret void
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_direct_output.7, label %func_direct_output.11
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @clear_picture.1(%struct.storable_picture* %p) #0 {
entry:
  %p.addr = alloca %struct.storable_picture*, align 8
  %canary = alloca i32
  store i32 160072257, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 860345110, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1545536972, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 0, i32* %i, align 4
  br label %for.cond
...
entry:
  ...
  %canary = alloca i32
  store i32 763146049, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_stored_frame.5(%struct.frame_store* %fs, i32 %p_out) #0 {
entry:
  %canary = alloca i32
  store i32 159950560, i32* %canary
  %p_out.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_picture.6(%struct.storable_picture* %p, i32 %p_out, i32 %real_structure) #0 {
entry:
  %real_structure.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1927921584, i32* %canary
  %p_out.addr = alloca i32, align 4
  %p.addr = alloca %struct.storable_picture*, align 8
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 915753336, i32* %canary
  %p_out.addr = alloca i32, align 4
  %p.addr = alloca %struct.storable_picture*, align 8
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 1929733671, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1069167522, i32* %canary
...
entry:
  %fs.addr = alloca %struct.frame_store*, align 8
  %canary = alloca i32
  store i32 873202086, i32* %canary
  %p_out.addr = alloca i32, align 4
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  %0 = load i32, i32* %p_out.addr, align 4
...
entry:
  %p.addr = alloca %struct.storable_picture*, align 8
  %canary = alloca i32
  store i32 2078259049, i32* %canary
  %p_out.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  %0 = load %struct.storable_picture*, %struct.storable_picture** %p.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @testEndian.12() #0 {
entry:
  %canary = alloca i32
  store i32 918910516, i32* %canary
  %p = alloca i8*, align 8
  %s = alloca i16, align 2
  %0 = bitcast i16* %s to i8*
  store i8* %0, i8** %p, align 8
...
entry:
  ...
  %p.addr = alloca %struct.storable_picture*, align 8
  %canary = alloca i32
  store i32 1872565846, i32* %canary
...
return:                                           ; preds = %if.end139, %if.then
  ...
  %193 = icmp eq i32 %192, 1872565846
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @img2buf.15(i16** %imgX, i8* %buf, i32 %size_x, i32 %size_y, i32 %symbol_size_in_bytes, i32 %crop_left, i32 %crop_right, i32 %crop_top, i32 %crop_bottom) #0 {
entry:
  %size = alloca i32, align 4
  %canary = alloca i32
  store i32 1880628870, i32* %canary
  %twidth = alloca i32, align 4
  %ui32 = alloca i64, align 8
  %size_y.addr = alloca i32, align 4
  %tmp16 = alloca i16, align 2
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1880628870
  br i1 %109, label %110, label %func_exit
...
entry:
  ...
  %symbol_size_in_bytes = alloca i32, align 4
  %canary = alloca i32
  store i32 1956326467, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  %0 = bitcast [4 x i32]* %SubWidthC to i8*
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1956326467
  br i1 %193, label %194, label %func_exit
...
entry:
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1290360695, i32* %canary
  %fs.addr = alloca %struct.frame_store*, align 8
  %p = alloca %struct.storable_picture*, align 8
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 1050750098, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  %p_out.addr = alloca i32, align 4
  %real_structure.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
...
entry:
  ...
  %real_structure.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1423738624, i32* %canary
  %p_out.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  store i32 %real_structure, i32* %real_structure.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 863734104, i32* %canary
  %real_structure.addr = alloca i32, align 4
  %p.addr = alloca %struct.storable_picture*, align 8
  %p_out.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
...
entry:
  ...
  %crop_right.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1988405797, i32* %canary
  %tmp16 = alloca i16, align 2
  %symbol_size_in_bytes.addr = alloca i32, align 4
  %twidth = alloca i32, align 4
  %crop_left.addr = alloca i32, align 4
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1988405797
  br i1 %109, label %110, label %func_exit
...
entry:
  ...
  %p = alloca %struct.storable_picture*, align 8
  %canary = alloca i32
  store i32 1346653818, i32* %canary
  %fs.addr = alloca %struct.frame_store*, align 8
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  %0 = load %struct.frame_store*, %struct.frame_store** %fs.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_unpaired_field.23(%struct.frame_store* %fs, i32 %p_out) #0 {
entry:
  %canary = alloca i32
  store i32 1654197895, i32* %canary
  %p = alloca %struct.storable_picture*, align 8
  %fs.addr = alloca %struct.frame_store*, align 8
  %p_out.addr = alloca i32, align 4
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
...
entry:
  ...
  %crop_left = alloca i32, align 4
  %canary = alloca i32
  store i32 264885858, i32* %canary
  %buf = alloca i8*, align 8
  %SubWidthC = alloca [4 x i32], align 16
  %symbol_size_in_bytes = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
...
entry:
  ...
  %SubWidthC = alloca [4 x i32], align 16
  %canary = alloca i32
  store i32 1173708153, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  %rgb_output = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1173708153
  br i1 %193, label %194, label %func_exit
...
entry:
  ...
  %crop_right = alloca i32, align 4
  %canary = alloca i32
  store i32 2076733477, i32* %canary
  %crop_left = alloca i32, align 4
  %SubWidthC = alloca [4 x i32], align 16
  %symbol_size_in_bytes = alloca i32, align 4
  %buf = alloca i8*, align 8
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 2076733477
  br i1 %193, label %194, label %func_exit
...
entry:
  ...
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1260175496, i32* %canary
  %p = alloca %struct.storable_picture*, align 8
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  %0 = load %struct.frame_store*, %struct.frame_store** %fs.addr, align 8
...
entry:
  %p_out.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 525158443, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  %real_structure.addr = alloca i32, align 4
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
...
entry:
  ...
  %p = alloca %struct.storable_picture*, align 8
  %canary = alloca i32
  store i32 583081962, i32* %canary
  %p_out.addr = alloca i32, align 4
  store %struct.frame_store* %fs, %struct.frame_store** %fs.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  %0 = load %struct.frame_store*, %struct.frame_store** %fs.addr, align 8
...
entry:
  ...
  %buf = alloca i8*, align 8
  %canary = alloca i32
  store i32 1891837012, i32* %canary
  %SubWidthC = alloca [4 x i32], align 16
  %rgb_output = alloca i32, align 4
  %crop_left = alloca i32, align 4
  %crop_right = alloca i32, align 4
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1891837012
  br i1 %193, label %194, label %func_exit
...
entry:
  ...
  %imgX.addr = alloca i16**, align 8
  %canary = alloca i32
  store i32 1887310666, i32* %canary
  %ui16 = alloca i16, align 2
  %size_y.addr = alloca i32, align 4
  %size = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
...
if.end123:                                        ; preds = %for.end122, %sw.epilog
  %108 = load i32, i32* %canary
  %109 = icmp eq i32 %108, 1887310666
  br i1 %109, label %110, label %func_exit
...
entry:
  %canary = alloca i32
  store i32 104717801, i32* %canary
  %SubHeightC = alloca [4 x i32], align 16
  %crop_left = alloca i32, align 4
  %crop_bottom = alloca i32, align 4
  %crop_right = alloca i32, align 4
...
entry:
  ...
  %crop_left = alloca i32, align 4
  %canary = alloca i32
  store i32 1854724478, i32* %canary
  %p.addr = alloca %struct.storable_picture*, align 8
  store %struct.storable_picture* %p, %struct.storable_picture** %p.addr, align 8
  store i32 %p_out, i32* %p_out.addr, align 4
  %0 = bitcast [4 x i32]* %SubWidthC to i8*
...
return:                                           ; preds = %if.end139, %if.then
  %192 = load i32, i32* %canary
  %193 = icmp eq i32 %192, 1854724478
  br i1 %193, label %194, label %func_exit
...
entry:
  ...
  %crop_right.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 390788848, i32* %canary
  %tmp32 = alloca i64, align 8
  %theight = alloca i32, align 4
  %j = alloca i32, align 4
  %crop_left.addr = alloca i32, align 4
...
entry:
  ...
  %crop_top.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 584695105, i32* %canary
  %twidth = alloca i32, align 4
  %size_x.addr = alloca i32, align 4
  %ui8 = alloca i8, align 1
  %i = alloca i32, align 4
...
entry:
  ...
  %theight = alloca i32, align 4
  %canary = alloca i32
  store i32 880879402, i32* %canary
  %crop_left.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %ui16 = alloca i16, align 2
  %crop_top.addr = alloca i32, align 4
