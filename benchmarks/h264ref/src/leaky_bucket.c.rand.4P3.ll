; ModuleID = 'leaky_bucket.c.rand.4P3.bc'
...
func_get_LeakyBucketRate.7:                       ; preds = %ctrl1
  %5 = call i32 @get_LeakyBucketRate.7(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret i32 %5
...
ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_get_LeakyBucketRate.6, label %func_get_LeakyBucketRate.7
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_PutBigDoubleWord.11, label %func_PutBigDoubleWord.17

func_PutBigDoubleWord.11:                         ; preds = %rand_bb
  call void @PutBigDoubleWord.11(i64 %dw, %struct._IO_FILE* %fp)
  ret void
...
func_write_buffer.12:                             ; preds = %ctrl1
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_write_buffer.12, label %func_write_buffer.13
}
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_Sort.15, label %func_Sort.18
}
...
func_calc_buffer.16:                              ; preds = %ctrl1
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_calc_buffer.14, label %func_calc_buffer.16
}
...
entry:
  ...
  %canary = alloca i32
  store i32 786902216, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1422804864, i32* %canary
  %Rmin.addr = alloca i64*, align 8
...
entry:
  %i = alloca i64, align 8
  %canary = alloca i32
  store i32 881658744, i32* %canary
  %Rmin.addr = alloca i64*, align 8
  %buf = alloca i64, align 8
  %retval = alloca i32, align 4
  %NumberLeakyBuckets.addr = alloca i64, align 8
...
entry:
  ...
  %outf = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 520908145, i32* %canary
  %Bmin.addr = alloca i64*, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
  store i64* %Bmin, i64** %Bmin.addr, align 8
...
entry:
  ...
  %canary = alloca i32
  store i32 2145734506, i32* %canary
...
for.end136:                                       ; preds = %for.cond57
  ...
  %150 = icmp eq i32 %149, 2145734506
...
entry:
  ...
  %buf = alloca i64, align 8
  %canary = alloca i32
  store i32 405538295, i32* %canary
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %i = alloca i64, align 8
  %retval = alloca i32, align 4
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
...
entry:
  ...
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1938331504, i32* %canary
  %retval = alloca i32, align 4
  %buf = alloca i64, align 8
  %Rmin.addr = alloca i64*, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
...
entry:
  ...
  %Rmin.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 1413022633, i32* %canary
...
entry:
  ...
  %FrameIndex = alloca i64, align 8
  %canary = alloca i32
  store i32 414470885, i32* %canary
  %iBucket = alloca i64, align 8
  %Rmin = alloca i64*, align 8
  %Bmin = alloca i64*, align 8
  %NumberLeakyBuckets = alloca i64, align 8
...
entry:
  %i = alloca i64, align 8
  %canary = alloca i32
  store i32 1798326396, i32* %canary
  %j = alloca i64, align 8
  %Rmin.addr = alloca i64*, align 8
  %temp = alloca i64, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @PutBigDoubleWord.11(i64 %dw, %struct._IO_FILE* %fp) #0 {
entry:
  %canary = alloca i32
  store i32 2017057374, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 254453498, i32* %canary
  %iBucket = alloca i64, align 8
  %outf = alloca %struct._IO_FILE*, align 8
  %Bmin.addr = alloca i64*, align 8
  %Fmin.addr = alloca i64*, align 8
...
entry:
  ...
  %iBucket = alloca i64, align 8
  %canary = alloca i32
  store i32 729520589, i32* %canary
  %Rmin.addr = alloca i64*, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
  store i64* %Bmin, i64** %Bmin.addr, align 8
...
entry:
  ...
  %InitFullness = alloca i64, align 8
  %canary = alloca i32
  store i32 1560905150, i32* %canary
  %buffer_frame = alloca i64*, align 8
  %Fmin = alloca i64*, align 8
  %maxBuffer = alloca i64, align 8
  store i64 0, i64* %FrameIndex, align 8
...
for.end136:                                       ; preds = %for.cond57
  ...
  call void @free(i8* %148) #3
  %149 = load i32, i32* %canary
  %150 = icmp eq i32 %149, 1560905150
  br i1 %150, label %151, label %func_exit
...
entry:
  ...
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 522201249, i32* %canary
  %temp = alloca i64, align 8
  %j = alloca i64, align 8
  %i = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
...
entry:
  ...
  %minB = alloca i64, align 8
  %canary = alloca i32
  store i32 1007851955, i32* %canary
  %Rmin = alloca i64*, align 8
  %buffer_frame = alloca i64*, align 8
  store i64 0, i64* %FrameIndex, align 8
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8
...
for.end136:                                       ; preds = %for.cond57
  ...
  call void @free(i8* %148) #3
  %149 = load i32, i32* %canary
  %150 = icmp eq i32 %149, 1007851955
  br i1 %150, label %151, label %func_exit
...
entry:
  %canary = alloca i32
  store i32 2138935598, i32* %canary
  %dw.addr = alloca i64, align 8
  %fp.addr = alloca %struct._IO_FILE*, align 8
  store i64 %dw, i64* %dw.addr, align 8
  store %struct._IO_FILE* %fp, %struct._IO_FILE** %fp.addr, align 8
...
entry:
  ...
  %j = alloca i64, align 8
  %canary = alloca i32
  store i32 389294241, i32* %canary
  %temp = alloca i64, align 8
  %i = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
