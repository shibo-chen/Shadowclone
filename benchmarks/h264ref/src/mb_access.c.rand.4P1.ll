; ModuleID = 'mb_access.c.rand.4P1.bc'
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_mb_is_available.13, label %ctrl0

func_mb_is_available.13:                          ; preds = %rand_bb
  %2 = call i32 @mb_is_available.13(i32 %mbAddr, i32 %currMbAddr)
  ret i32 %2

func_mb_is_available.24:                          ; preds = %ctrl0
  %3 = call i32 @mb_is_available.24(i32 %mbAddr, i32 %currMbAddr)
  ret i32 %3
...
func_mb_is_available.34:                          ; preds = %ctrl1
  %5 = call i32 @mb_is_available.34(i32 %mbAddr, i32 %currMbAddr)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_mb_is_available.24, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_mb_is_available.29, label %func_mb_is_available.34
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_CheckAvailabilityOfNeighbors.1, label %func_CheckAvailabilityOfNeighbors.31

func_CheckAvailabilityOfNeighbors.1:              ; preds = %rand_bb
  call void @CheckAvailabilityOfNeighbors.1()
  ret void

func_CheckAvailabilityOfNeighbors.31:             ; preds = %rand_bb
  call void @CheckAvailabilityOfNeighbors.31()
  ret void
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_get_mb_block_pos.14, label %ctrl0

func_get_mb_block_pos.14:                         ; preds = %rand_bb
  call void @get_mb_block_pos.14(i32 %mb_addr, i32* %x, i32* %y)
  ret void

func_get_mb_block_pos.18:                         ; preds = %ctrl0
  call void @get_mb_block_pos.18(i32 %mb_addr, i32* %x, i32* %y)
  ret void

func_get_mb_block_pos.19:                         ; preds = %ctrl1
  call void @get_mb_block_pos.19(i32 %mb_addr, i32* %x, i32* %y)
  ret void

func_get_mb_block_pos.22:                         ; preds = %ctrl1
  call void @get_mb_block_pos.22(i32 %mb_addr, i32* %x, i32* %y)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_get_mb_block_pos.18, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_get_mb_block_pos.19, label %func_get_mb_block_pos.22
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_get_mb_pos.6, label %ctrl0

func_get_mb_pos.6:                                ; preds = %rand_bb
  call void @get_mb_pos.6(i32 %mb_addr, i32* %x, i32* %y)
  ret void
...
func_get_mb_pos.23:                               ; preds = %ctrl1
  call void @get_mb_pos.23(i32 %mb_addr, i32* %x, i32* %y)
  ret void

func_get_mb_pos.25:                               ; preds = %ctrl1
  call void @get_mb_pos.25(i32 %mb_addr, i32* %x, i32* %y)
  ret void
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_get_mb_pos.23, label %func_get_mb_pos.25
}
...
func_getNonAffNeighbour.11:                       ; preds = %ctrl0
  call void @getNonAffNeighbour.11(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_getNonAffNeighbour.11, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_getNonAffNeighbour.17, label %func_getNonAffNeighbour.20
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_getAffNeighbour.4, label %ctrl0

func_getAffNeighbour.4:                           ; preds = %rand_bb
  call void @getAffNeighbour.4(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void
...
func_getAffNeighbour.7:                           ; preds = %ctrl1
  call void @getAffNeighbour.7(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

func_getAffNeighbour.10:                          ; preds = %ctrl1
  call void @getAffNeighbour.10(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_getAffNeighbour.7, label %func_getAffNeighbour.10
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_getNeighbour.12, label %ctrl0

func_getNeighbour.12:                             ; preds = %rand_bb
  call void @getNeighbour.12(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

func_getNeighbour.21:                             ; preds = %ctrl0
  call void @getNeighbour.21(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

func_getNeighbour.28:                             ; preds = %ctrl1
  call void @getNeighbour.28(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_getNeighbour.21, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_getNeighbour.28, label %func_getNeighbour.30
}
...
func_getLuma4x4Neighbour.15:                      ; preds = %ctrl0
  call void @getLuma4x4Neighbour.15(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix)
  ret void

func_getLuma4x4Neighbour.16:                      ; preds = %ctrl1
  call void @getLuma4x4Neighbour.16(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix)
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_getLuma4x4Neighbour.15, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_getLuma4x4Neighbour.16, label %func_getLuma4x4Neighbour.26
}
...
func_getChroma4x4Neighbour.27:                    ; preds = %ctrl0
  call void @getChroma4x4Neighbour.27(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix)
  ret void

func_getChroma4x4Neighbour.32:                    ; preds = %ctrl1
  call void @getChroma4x4Neighbour.32(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix)
  ret void

func_getChroma4x4Neighbour.33:                    ; preds = %ctrl1
  call void @getChroma4x4Neighbour.33(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_getChroma4x4Neighbour.27, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_getChroma4x4Neighbour.32, label %func_getChroma4x4Neighbour.33
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @CheckAvailabilityOfNeighbors.1() #0 {
entry:
  %canary = alloca i32
  store i32 911426808, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 2087469102, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1388243073, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getAffNeighbour.4(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix) #0 {
entry:
  %xN.addr = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
  %maxW = alloca i32, align 4
  %canary = alloca i32
  store i32 903675164, i32* %canary
  %yN.addr = alloca i32, align 4
  %currMb = alloca %struct.macroblock*, align 8
  %luma.addr = alloca i32, align 4
  %curr_mb_nr.addr = alloca i32, align 4
...
entry:
  ...
  %maxH = alloca i32, align 4
  %canary = alloca i32
  store i32 653404352, i32* %canary
  %yN.addr = alloca i32, align 4
  %yM = alloca i32, align 4
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
  store i32 %xN, i32* %xN.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @get_mb_pos.6(i32 %mb_addr, i32* %x, i32* %y) #0 {
entry:
  %canary = alloca i32
  store i32 1306262507, i32* %canary
...
entry:
  ...
  %currMb = alloca %struct.macroblock*, align 8
  %canary = alloca i32
  store i32 579656652, i32* %canary
  %yM = alloca i32, align 4
  %luma.addr = alloca i32, align 4
  %maxH = alloca i32, align 4
  %curr_mb_nr.addr = alloca i32, align 4
...
entry:
  ...
  %pix.addr = alloca %struct.pix_pos*, align 8
  %canary = alloca i32
  store i32 280726445, i32* %canary
  %block_y.addr = alloca i32, align 4
  %rel_y.addr = alloca i32, align 4
  %curr_mb_nr.addr = alloca i32, align 4
  %rel_x.addr = alloca i32, align 4
...
entry:
  ...
  %mb_addr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 622248028, i32* %canary
  %y.addr = alloca i32*, align 8
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
  store i32* %x, i32** %x.addr, align 8
  store i32* %y, i32** %y.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getAffNeighbour.10(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix) #0 {
entry:
  %currMb = alloca %struct.macroblock*, align 8
  %yM = alloca i32, align 4
  %maxH = alloca i32, align 4
  ...
  %curr_mb_nr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 739268513, i32* %canary
  %yN.addr = alloca i32, align 4
  %maxW = alloca i32, align 4
  %luma.addr = alloca i32, align 4
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getNonAffNeighbour.11(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix) #0 {
entry:
  %currMb = alloca %struct.macroblock*, align 8
  %yN.addr = alloca i32, align 4
  %xN.addr = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
  %canary = alloca i32
  store i32 1197913808, i32* %canary
  %maxW = alloca i32, align 4
  %maxH = alloca i32, align 4
  %luma.addr = alloca i32, align 4
  %curr_mb_nr.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getNeighbour.12(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix) #0 {
entry:
  %yN.addr = alloca i32, align 4
  %curr_mb_nr.addr = alloca i32, align 4
  %xN.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @mb_is_available.13(i32 %mbAddr, i32 %currMbAddr) #0 {
entry:
  %currMbAddr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 758733564, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @get_mb_block_pos.14(i32 %mb_addr, i32* %x, i32* %y) #0 {
entry:
  %y.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 406488268, i32* %canary
  %mb_addr.addr = alloca i32, align 4
  %x.addr = alloca i32*, align 8
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
  store i32* %x, i32** %x.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getLuma4x4Neighbour.15(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix) #0 {
entry:
  %block_y.addr = alloca i32, align 4
  %rel_x.addr = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
  ...
  %block_x.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1085185746, i32* %canary
  %x = alloca i32, align 4
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
  store i32 %block_x, i32* %block_x.addr, align 4
  store i32 %block_y, i32* %block_y.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getLuma4x4Neighbour.16(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix) #0 {
entry:
  %curr_mb_nr.addr = alloca i32, align 4
  %block_y.addr = alloca i32, align 4
  %block_x.addr = alloca i32, align 4
  ...
  %rel_y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 653003405, i32* %canary
  %y = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
  %x = alloca i32, align 4
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
...
entry:
  ...
  %pix.addr = alloca %struct.pix_pos*, align 8
  %canary = alloca i32
  store i32 1289427756, i32* %canary
  %xN.addr = alloca i32, align 4
  %currMb = alloca %struct.macroblock*, align 8
  %curr_mb_nr.addr = alloca i32, align 4
  %maxH = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @get_mb_block_pos.18(i32 %mb_addr, i32* %x, i32* %y) #0 {
entry:
  %mb_addr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 802975186, i32* %canary
  %x.addr = alloca i32*, align 8
  %y.addr = alloca i32*, align 8
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
  store i32* %x, i32** %x.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 748943202, i32* %canary
  %x.addr = alloca i32*, align 8
  %mb_addr.addr = alloca i32, align 4
  %y.addr = alloca i32*, align 8
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
...
entry:
  ...
  %luma.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1572387611, i32* %canary
  %maxW = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
  %currMb = alloca %struct.macroblock*, align 8
  %yN.addr = alloca i32, align 4
...
entry:
  ...
  %xN.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 288667122, i32* %canary
  %curr_mb_nr.addr = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
  %luma.addr = alloca i32, align 4
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @get_mb_block_pos.22(i32 %mb_addr, i32* %x, i32* %y) #0 {
entry:
  %canary = alloca i32
  store i32 2109372443, i32* %canary
  %x.addr = alloca i32*, align 8
  %y.addr = alloca i32*, align 8
  %mb_addr.addr = alloca i32, align 4
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
...
entry:
  ...
  %y.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 2005039711, i32* %canary
  %mb_addr.addr = alloca i32, align 4
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
  store i32* %x, i32** %x.addr, align 8
  store i32* %y, i32** %y.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @mb_is_available.24(i32 %mbAddr, i32 %currMbAddr) #0 {
entry:
  %retval = alloca i32, align 4
  %mbAddr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1363973418, i32* %canary
  %currMbAddr.addr = alloca i32, align 4
  store i32 %mbAddr, i32* %mbAddr.addr, align 4
  store i32 %currMbAddr, i32* %currMbAddr.addr, align 4
  %0 = load i32, i32* %mbAddr.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @get_mb_pos.25(i32 %mb_addr, i32* %x, i32* %y) #0 {
entry:
  %mb_addr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 875354850, i32* %canary
  %y.addr = alloca i32*, align 8
  %x.addr = alloca i32*, align 8
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
  store i32* %x, i32** %x.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1746734879, i32* %canary
  %block_y.addr = alloca i32, align 4
  %rel_x.addr = alloca i32, align 4
  %x = alloca i32, align 4
  %rel_y.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getNeighbour.28(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix) #0 {
entry:
  %luma.addr = alloca i32, align 4
  %curr_mb_nr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1091334335, i32* %canary
  %yN.addr = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
  %xN.addr = alloca i32, align 4
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
...
entry:
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 361949355, i32* %canary
  %currMbAddr.addr = alloca i32, align 4
  %mbAddr.addr = alloca i32, align 4
  store i32 %mbAddr, i32* %mbAddr.addr, align 4
  store i32 %currMbAddr, i32* %currMbAddr.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 526237162, i32* %canary
  %pix.addr = alloca %struct.pix_pos*, align 8
  %yN.addr = alloca i32, align 4
  %curr_mb_nr.addr = alloca i32, align 4
  %luma.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @CheckAvailabilityOfNeighbors.31() #0 {
entry:
  %mb_nr = alloca i32, align 4
  %canary = alloca i32
  store i32 242493143, i32* %canary
  %currMB = alloca %struct.macroblock*, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %current_mb_nr = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 3
  %1 = load i32, i32* %current_mb_nr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getChroma4x4Neighbour.32(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix) #0 {
entry:
  %pix.addr = alloca %struct.pix_pos*, align 8
  %canary = alloca i32
  store i32 1778093599, i32* %canary
  %x = alloca i32, align 4
  %block_x.addr = alloca i32, align 4
  %rel_x.addr = alloca i32, align 4
  %block_y.addr = alloca i32, align 4
...
entry:
  ...
  %y = alloca i32, align 4
  %canary = alloca i32
  store i32 487037891, i32* %canary
  %rel_y.addr = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
  %rel_x.addr = alloca i32, align 4
  %block_y.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @mb_is_available.34(i32 %mbAddr, i32 %currMbAddr) #0 {
entry:
  %canary = alloca i32
  store i32 323032283, i32* %canary
  %mbAddr.addr = alloca i32, align 4
  %currMbAddr.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  store i32 %mbAddr, i32* %mbAddr.addr, align 4
