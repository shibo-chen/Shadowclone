; ModuleID = 'q_offsets.c.rand.8R1.bc'
...
func_CheckOffsetParameterName.2:                  ; preds = %ctrl0
  %3 = call i32 @CheckOffsetParameterName.2(i8* %s, i32* %type)
  ret i32 %3
...
func_CheckOffsetParameterName.29:                 ; preds = %ctrl3
  %6 = call i32 @CheckOffsetParameterName.29(i8* %s, i32* %type)
  ret i32 %6

func_CheckOffsetParameterName.30:                 ; preds = %ctrl4
  %7 = call i32 @CheckOffsetParameterName.30(i8* %s, i32* %type)
  ret i32 %7

func_CheckOffsetParameterName.31:                 ; preds = %ctrl5
  %8 = call i32 @CheckOffsetParameterName.31(i8* %s, i32* %type)
  ret i32 %8

func_CheckOffsetParameterName.32:                 ; preds = %ctrl5
  %9 = call i32 @CheckOffsetParameterName.32(i8* %s, i32* %type)
  ret i32 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_CheckOffsetParameterName.2, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_CheckOffsetParameterName.8, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_CheckOffsetParameterName.10, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_CheckOffsetParameterName.29, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_CheckOffsetParameterName.30, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_CheckOffsetParameterName.31, label %func_CheckOffsetParameterName.32
}
...
func_ParseQOffsetMatrix.5:                        ; preds = %ctrl0
  call void @ParseQOffsetMatrix.5(i8* %buf, i32 %bufsize)
  ret void

func_ParseQOffsetMatrix.6:                        ; preds = %ctrl1
  call void @ParseQOffsetMatrix.6(i8* %buf, i32 %bufsize)
  ret void

func_ParseQOffsetMatrix.12:                       ; preds = %ctrl2
...
func_ParseQOffsetMatrix.19:                       ; preds = %ctrl4
...
func_ParseQOffsetMatrix.22:                       ; preds = %ctrl5
  call void @ParseQOffsetMatrix.22(i8* %buf, i32 %bufsize)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_ParseQOffsetMatrix.5, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_ParseQOffsetMatrix.6, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_ParseQOffsetMatrix.12, label %ctrl3
...
ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_ParseQOffsetMatrix.19, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_ParseQOffsetMatrix.21, label %func_ParseQOffsetMatrix.22
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_CalculateOffsetParam.4, label %ctrl0

func_CalculateOffsetParam.4:                      ; preds = %rand_bb
  call void @CalculateOffsetParam.4()
  ret void

func_CalculateOffsetParam.9:                      ; preds = %ctrl0
  call void @CalculateOffsetParam.9()
  ret void

func_CalculateOffsetParam.11:                     ; preds = %ctrl1
...
func_CalculateOffsetParam.16:                     ; preds = %ctrl3
  call void @CalculateOffsetParam.16()
  ret void
...
func_CalculateOffsetParam.27:                     ; preds = %ctrl5
  call void @CalculateOffsetParam.27()
  ret void

func_CalculateOffsetParam.28:                     ; preds = %ctrl5
  call void @CalculateOffsetParam.28()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_CalculateOffsetParam.9, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_CalculateOffsetParam.11, label %ctrl2
...
ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_CalculateOffsetParam.16, label %ctrl4
...
ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_CalculateOffsetParam.27, label %func_CalculateOffsetParam.28
}
...
func_CalculateOffset8Param.13:                    ; preds = %ctrl0
  call void @CalculateOffset8Param.13()
  ret void

func_CalculateOffset8Param.14:                    ; preds = %ctrl1
  call void @CalculateOffset8Param.14()
  ret void

func_CalculateOffset8Param.18:                    ; preds = %ctrl2
  call void @CalculateOffset8Param.18()
  ret void

func_CalculateOffset8Param.20:                    ; preds = %ctrl3
  call void @CalculateOffset8Param.20()
  ret void

func_CalculateOffset8Param.23:                    ; preds = %ctrl4
...
func_CalculateOffset8Param.25:                    ; preds = %ctrl5
  call void @CalculateOffset8Param.25()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_CalculateOffset8Param.13, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_CalculateOffset8Param.14, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_CalculateOffset8Param.18, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_CalculateOffset8Param.20, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_CalculateOffset8Param.23, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_CalculateOffset8Param.24, label %func_CalculateOffset8Param.25
}
...
entry:
  ...
  %type.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 507939583, i32* %canary
  %retval = alloca i32, align 4
  store i8* %s, i8** %s.addr, align 8
  store i32* %type, i32** %type.addr, align 8
  store i32 0, i32* %i, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 2131670252, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 550932227, i32* %canary
  %i = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %OffsetMatrixPresentFlag = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 147
  %1 = load i32, i32* %OffsetMatrixPresentFlag, align 8
...
entry:
  ...
  %IntContent = alloca i32, align 4
  %canary = alloca i32
  store i32 1152333888, i32* %canary
  %type = alloca i32, align 4
  %InString = alloca i32, align 4
  %InItem = alloca i32, align 4
  %bufsize.addr = alloca i32, align 4
...
entry:
  ...
  %bufsize.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1556305276, i32* %canary
  %InItem = alloca i32, align 4
  %p = alloca i8*, align 8
  %buf.addr = alloca i8*, align 8
  store i8* %buf, i8** %buf.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 929132210, i32* %canary
  %j = alloca i32, align 4
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1198848026, i32* %canary
  %type.addr = alloca i32*, align 8
  store i8* %s, i8** %s.addr, align 8
  store i32* %type, i32** %type.addr, align 8
  store i32 0, i32* %i, align 4
...
entry:
  ...
  %qp_per = alloca i32, align 4
  %canary = alloca i32
  store i32 1808353701, i32* %canary
  %i = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %OffsetMatrixPresentFlag = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 147
  %1 = load i32, i32* %OffsetMatrixPresentFlag, align 8
...
if.end225:                                        ; preds = %for.end224, %for.end102
  %132 = load i32, i32* %canary
  %133 = icmp eq i32 %132, 1808353701
  br i1 %133, label %134, label %func_exit
...
entry:
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1639307082, i32* %canary
  %s.addr = alloca i8*, align 8
  %i = alloca i32, align 4
  %type.addr = alloca i32*, align 8
  store i8* %s, i8** %s.addr, align 8
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1847358749, i32* %canary
  %j = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %OffsetMatrixPresentFlag = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 147
  %1 = load i32, i32* %OffsetMatrixPresentFlag, align 8
...
if.end225:                                        ; preds = %for.end224, %for.end102
  %132 = load i32, i32* %canary
  %133 = icmp eq i32 %132, 1847358749
  br i1 %133, label %134, label %func_exit
...
entry:
  ...
  %buf.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1863084661, i32* %canary
  %OffsetList = alloca i16*, align 8
  %bufend = alloca i8*, align 8
  %InString = alloca i32, align 4
  %item = alloca i32, align 4
...
entry:
  %temp = alloca i32, align 4
  %canary = alloca i32
  store i32 182078512, i32* %canary
  %k = alloca i32, align 4
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %q_bits = alloca i32, align 4
...
entry:
  ...
  %temp = alloca i32, align 4
  %canary = alloca i32
  store i32 1813929714, i32* %canary
  %k = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %OffsetMatrixPresentFlag = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 147
  %1 = load i32, i32* %OffsetMatrixPresentFlag, align 8
...
entry:
  %canary = alloca i32
  store i32 780205350, i32* %canary
  %i = alloca i32, align 4
  %qp_per = alloca i32, align 4
  %k = alloca i32, align 4
  %j = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @CalculateOffsetParam.16() #0 {
entry:
  %k = alloca i32, align 4
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %temp = alloca i32, align 4
  %canary = alloca i32
  store i32 425388020, i32* %canary
  %qp_per = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %OffsetMatrixPresentFlag = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 147
  %1 = load i32, i32* %OffsetMatrixPresentFlag, align 8
...
entry:
  ...
  %InString = alloca i32, align 4
  %canary = alloca i32
  store i32 243087930, i32* %canary
  %bufend = alloca i8*, align 8
  %bufsize.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %item = alloca i32, align 4
...
entry:
  ...
  %temp = alloca i32, align 4
  %canary = alloca i32
  store i32 430402083, i32* %canary
  %q_bits = alloca i32, align 4
  %k = alloca i32, align 4
  %j = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
entry:
  ...
  %buf.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 165636245, i32* %canary
  %j = alloca i32, align 4
  %i = alloca i32, align 4
  %cnt = alloca i32, align 4
  %type = alloca i32, align 4
...
entry:
  ...
  %q_bits = alloca i32, align 4
  %canary = alloca i32
  store i32 815906990, i32* %canary
  %i = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %OffsetMatrixPresentFlag = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 147
  %1 = load i32, i32* %OffsetMatrixPresentFlag, align 8
...
entry:
  ...
  %MapIdx = alloca i32, align 4
  %canary = alloca i32
  store i32 1154104307, i32* %canary
  %InItem = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %bufsize, i32* %bufsize.addr, align 4
  store i32 0, i32* %item, align 4
...
entry:
  ...
  %bufend = alloca i8*, align 8
  %canary = alloca i32
  store i32 766131274, i32* %canary
  %p = alloca i8*, align 8
  %IntContent = alloca i32, align 4
  %OffsetList = alloca i16*, align 8
  %item = alloca i32, align 4
...
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1493168386, i32* %canary
  %j = alloca i32, align 4
  %k = alloca i32, align 4
  %q_bits = alloca i32, align 4
  %temp = alloca i32, align 4
...
entry:
  ...
  %temp = alloca i32, align 4
  %canary = alloca i32
  store i32 462276859, i32* %canary
  %k = alloca i32, align 4
  %i = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %OffsetMatrixPresentFlag = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 147
...
entry:
  %canary = alloca i32
  store i32 469917727, i32* %canary
  %temp = alloca i32, align 4
  %k = alloca i32, align 4
  %j = alloca i32, align 4
  %i = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1564651544, i32* %canary
  %temp = alloca i32, align 4
  %i = alloca i32, align 4
  %k = alloca i32, align 4
  %qp_per = alloca i32, align 4
...
if.end225:                                        ; preds = %for.end224, %for.end102
  %132 = load i32, i32* %canary
  %133 = icmp eq i32 %132, 1564651544
  br i1 %133, label %134, label %func_exit
...
entry:
  %canary = alloca i32
  store i32 768778046, i32* %canary
  %qp_per = alloca i32, align 4
  %temp = alloca i32, align 4
  %i = alloca i32, align 4
  %j = alloca i32, align 4
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 558320502, i32* %canary
  %s.addr = alloca i8*, align 8
  %i = alloca i32, align 4
  store i8* %s, i8** %s.addr, align 8
  store i32* %type, i32** %type.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1058248907, i32* %canary
  %i = alloca i32, align 4
  %retval = alloca i32, align 4
  %s.addr = alloca i8*, align 8
  %type.addr = alloca i32*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @CheckOffsetParameterName.31(i8* %s, i32* %type) #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1852072851, i32* %canary
  %type.addr = alloca i32*, align 8
  %retval = alloca i32, align 4
  %s.addr = alloca i8*, align 8
  store i8* %s, i8** %s.addr, align 8
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1192523645, i32* %canary
  %i = alloca i32, align 4
  %s.addr = alloca i8*, align 8
  store i8* %s, i8** %s.addr, align 8
  store i32* %type, i32** %type.addr, align 8
