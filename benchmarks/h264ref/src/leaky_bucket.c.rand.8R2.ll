; ModuleID = 'leaky_bucket.c.rand.8R2.bc'
...
func_get_LeakyBucketRate.15:                      ; preds = %ctrl2
  %5 = call i32 @get_LeakyBucketRate.15(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret i32 %5

func_get_LeakyBucketRate.16:                      ; preds = %ctrl3
  %6 = call i32 @get_LeakyBucketRate.16(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret i32 %6
...
func_get_LeakyBucketRate.20:                      ; preds = %ctrl5
  %8 = call i32 @get_LeakyBucketRate.20(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret i32 %8
...
ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_get_LeakyBucketRate.10, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_get_LeakyBucketRate.13, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_get_LeakyBucketRate.15, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_get_LeakyBucketRate.16, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_get_LeakyBucketRate.17, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_get_LeakyBucketRate.20, label %func_get_LeakyBucketRate.26
}
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_write_buffer.19, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_write_buffer.28, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_write_buffer.30, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_write_buffer.31, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_write_buffer.32, label %func_write_buffer.34
}
...
func_Sort.27:                                     ; preds = %ctrl5
  call void @Sort.27(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_Sort.3, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_Sort.8, label %ctrl2
...
ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_Sort.14, label %ctrl4
...
ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_Sort.22, label %func_Sort.27
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_calc_buffer.9, label %ctrl0

func_calc_buffer.9:                               ; preds = %rand_bb
  call void @calc_buffer.9()
  ret void

func_calc_buffer.11:                              ; preds = %ctrl0
  call void @calc_buffer.11()
  ret void

func_calc_buffer.21:                              ; preds = %ctrl1
...
func_calc_buffer.33:                              ; preds = %ctrl5
  call void @calc_buffer.33()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_calc_buffer.11, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_calc_buffer.21, label %ctrl2
...
ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_calc_buffer.29, label %func_calc_buffer.33
}
...
entry:
  ...
  %canary = alloca i32
  store i32 1150079238, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 505552681, i32* %canary
  %j = alloca i64, align 8
  %temp = alloca i64, align 8
  %i = alloca i64, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
...
entry:
  %canary = alloca i32
  store i32 1565575206, i32* %canary
...
entry:
  %fp.addr = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 836970695, i32* %canary
  %dw.addr = alloca i64, align 8
  store i64 %dw, i64* %dw.addr, align 8
  store %struct._IO_FILE* %fp, %struct._IO_FILE** %fp.addr, align 8
  %0 = load i64, i64* %dw.addr, align 8
...
entry:
  ...
  %Fmin.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 511809786, i32* %canary
  %iBucket = alloca i64, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
...
entry:
  ...
  %canary = alloca i32
  store i32 1065597150, i32* %canary
  %Rmin.addr = alloca i64*, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1719231965, i32* %canary
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %Rmin.addr = alloca i64*, align 8
  %temp = alloca i64, align 8
  %i = alloca i64, align 8
...
entry:
  ...
  %canary = alloca i32
  store i32 422915939, i32* %canary
...
entry:
  ...
  %buf = alloca i64, align 8
  %canary = alloca i32
  store i32 118199335, i32* %canary
  %retval = alloca i32, align 4
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %i = alloca i64, align 8
  %Rmin.addr = alloca i64*, align 8
...
entry:
  ...
  %iFrame = alloca i64, align 8
  %canary = alloca i32
  store i32 1631381530, i32* %canary
  %AvgRate = alloca i64, align 8
  %FrameIndex = alloca i64, align 8
  %maxBuffer = alloca i64, align 8
  %buffer_frame = alloca i64*, align 8
...
for.end136:                                       ; preds = %for.cond57
  ...
  call void @free(i8* %148) #3
  %149 = load i32, i32* %canary
  %150 = icmp eq i32 %149, 1631381530
  br i1 %150, label %151, label %func_exit
...
entry:
  ...
  %i = alloca i64, align 8
  %canary = alloca i32
  store i32 894236635, i32* %canary
  %Rmin.addr = alloca i64*, align 8
  %j = alloca i64, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 145249917, i32* %canary
  %buf = alloca i64, align 8
  %Rmin.addr = alloca i64*, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
...
entry:
  ...
  %i = alloca i64, align 8
  %canary = alloca i32
  store i32 1624951290, i32* %canary
  %Rmin.addr = alloca i64*, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
  store i64 0, i64* %i, align 8
...
entry:
  ...
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1408559973, i32* %canary
  %Rmin.addr = alloca i64*, align 8
  %buf = alloca i64, align 8
  %retval = alloca i32, align 4
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_LeakyBucketRate.16(i64 %NumberLeakyBuckets, i64* %Rmin) #0 {
entry:
  %f = alloca %struct._IO_FILE*, align 8
  %retval = alloca i32, align 4
  %i = alloca i64, align 8
  %Rmin.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 1815700038, i32* %canary
  %buf = alloca i64, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 124187339, i32* %canary
  %buf = alloca i64, align 8
  %i = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
...
entry:
  ...
  %i = alloca i64, align 8
  %canary = alloca i32
  store i32 1025499816, i32* %canary
  %j = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
  store i64 0, i64* %i, align 8
...
entry:
  ...
  %Rmin.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 161426500, i32* %canary
  %Bmin.addr = alloca i64*, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
  store i64* %Bmin, i64** %Bmin.addr, align 8
...
entry:
  ...
  %buf = alloca i64, align 8
  %canary = alloca i32
  store i32 1631254446, i32* %canary
  %Rmin.addr = alloca i64*, align 8
  %retval = alloca i32, align 4
  %i = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
...
entry:
  ...
  %Bmin = alloca i64*, align 8
  %canary = alloca i32
  store i32 252550456, i32* %canary
  %iBucket = alloca i64, align 8
  %actualBuffer = alloca i64, align 8
  %NumberLeakyBuckets = alloca i64, align 8
  %iChannelRate = alloca i64, align 8
...
entry:
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1013238296, i32* %canary
  %j = alloca i64, align 8
  %Rmin.addr = alloca i64*, align 8
  %temp = alloca i64, align 8
  %i = alloca i64, align 8
...
entry:
  ...
  %iBucket = alloca i64, align 8
  %canary = alloca i32
  store i32 321637593, i32* %canary
  %AvgRate = alloca i64, align 8
  %Rmin = alloca i64*, align 8
  %minB = alloca i64, align 8
  %InitFullness = alloca i64, align 8
...
entry:
  ...
  %actualBuffer = alloca i64, align 8
  %canary = alloca i32
  store i32 1678580718, i32* %canary
  %FrameIndex = alloca i64, align 8
  %Rmin = alloca i64*, align 8
  %iBucket = alloca i64, align 8
  %minB = alloca i64, align 8
...
for.end136:                                       ; preds = %for.cond57
  ...
  call void @free(i8* %148) #3
  %149 = load i32, i32* %canary
  %150 = icmp eq i32 %149, 1678580718
  br i1 %150, label %151, label %func_exit
...
entry:
  %canary = alloca i32
  store i32 1784712758, i32* %canary
  %actualBuffer = alloca i64, align 8
  %buffer_frame = alloca i64*, align 8
  %FrameIndex = alloca i64, align 8
  %iChannelRate = alloca i64, align 8
...
for.end136:                                       ; preds = %for.cond57
  ...
  call void @free(i8* %148) #3
  %149 = load i32, i32* %canary
  %150 = icmp eq i32 %149, 1784712758
  br i1 %150, label %151, label %func_exit
...
entry:
  ...
  %i = alloca i64, align 8
  %canary = alloca i32
  store i32 1887373874, i32* %canary
  %retval = alloca i32, align 4
  %buf = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
...
entry:
  ...
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 712193558, i32* %canary
  %Rmin.addr = alloca i64*, align 8
  %j = alloca i64, align 8
  %i = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
...
entry:
  %iBucket = alloca i64, align 8
  %canary = alloca i32
  store i32 917883625, i32* %canary
  %Fmin.addr = alloca i64*, align 8
  %Bmin.addr = alloca i64*, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %Rmin.addr = alloca i64*, align 8
...
entry:
  ...
  %maxBuffer = alloca i64, align 8
  %canary = alloca i32
  store i32 1125301658, i32* %canary
  %minB = alloca i64, align 8
  %iBucket = alloca i64, align 8
  %Rmin = alloca i64*, align 8
  %TotalRate = alloca i64, align 8
...
for.end136:                                       ; preds = %for.cond57
  ...
  call void @free(i8* %148) #3
  %149 = load i32, i32* %canary
  %150 = icmp eq i32 %149, 1125301658
  br i1 %150, label %151, label %func_exit
...
entry:
  ...
  %Fmin.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 1649829079, i32* %canary
  %Rmin.addr = alloca i64*, align 8
  %Bmin.addr = alloca i64*, align 8
  %iBucket = alloca i64, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
...
entry:
  %canary = alloca i32
  store i32 635755417, i32* %canary
  %iBucket = alloca i64, align 8
  %Bmin.addr = alloca i64*, align 8
  %Fmin.addr = alloca i64*, align 8
  %outf = alloca %struct._IO_FILE*, align 8
...
entry:
  %canary = alloca i32
  store i32 238067856, i32* %canary
  %Fmin.addr = alloca i64*, align 8
  %iBucket = alloca i64, align 8
  %outf = alloca %struct._IO_FILE*, align 8
  %Bmin.addr = alloca i64*, align 8
...
entry:
  ...
  %Bmin = alloca i64*, align 8
  %canary = alloca i32
  store i32 209792868, i32* %canary
  %iFrame = alloca i64, align 8
  %AvgRate = alloca i64, align 8
  %maxBuffer = alloca i64, align 8
  %NumberLeakyBuckets = alloca i64, align 8
...
entry:
  ...
  %Fmin.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 1953451337, i32* %canary
  %outf = alloca %struct._IO_FILE*, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
  store i64* %Bmin, i64** %Bmin.addr, align 8
