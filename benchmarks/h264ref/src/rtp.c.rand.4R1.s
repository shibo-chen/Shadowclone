...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$1235173714, -28(%rbp)  # imm = 0x499F4152
	movq	%rdi, -24(%rbp)
	movq	-24(%rbp), %rax
	movl	20(%rax), %eax
	shll	$7, %eax
...
.LBB6_10:                               # %if.end32
	...
	movl	4(%rax), %ebx
	shll	$3, %ebx
	cmpl	$1235173714, -28(%rbp)  # imm = 0x499F4152
	jne	.LBB6_12
.LBB6_11:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$16, %rsp
	movl	$1310263381, -12(%rbp)  # imm = 0x4E190855
	movl	%edi, -8(%rbp)
...
.LBB7_5:                                # %return
	cmpl	$1310263381, -12(%rbp)  # imm = 0x4E190855
	jne	.LBB7_7
.LBB7_6:
	addq	$16, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$16, %rsp
	movl	$479856846, -12(%rbp)   # imm = 0x1C9A08CE
	movl	%edi, -8(%rbp)
	cmpl	$-1, RTPUpdateTimestamp.oldtr
	jne	.LBB8_2
# %bb.1:                                # %if.then
...
.LBB8_4:                                # %if.end3
	...
	movl	%eax, RTPUpdateTimestamp.oldtr
.LBB8_5:                                # %return
	cmpl	$479856846, -12(%rbp)   # imm = 0x1C9A08CE
	jne	.LBB8_7
.LBB8_6:
	addq	$16, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$1896956232, -40(%rbp)  # imm = 0x71114148
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movl	$-1, -36(%rbp)
	movq	-32(%rbp), %rdi
...
.LBB9_7:                                # %return
	movl	-12(%rbp), %ebx
	cmpl	$1896956232, -40(%rbp)  # imm = 0x71114148
	jne	.LBB9_9
.LBB9_8:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$208975564, -40(%rbp)   # imm = 0xC74B6CC
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movl	$-1, -36(%rbp)
	movq	-32(%rbp), %rdi
...
.LBB10_7:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$208975564, -40(%rbp)   # imm = 0xC74B6CC
	jne	.LBB10_9
.LBB10_8:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$1724971180, -28(%rbp)  # imm = 0x66D0F8AC
	movq	%rdi, -24(%rbp)
	movq	-24(%rbp), %rax
	movl	20(%rax), %eax
	shll	$7, %eax
...
.LBB11_10:                              # %if.end32
	...
	movl	4(%rax), %ebx
	shll	$3, %ebx
	cmpl	$1724971180, -28(%rbp)  # imm = 0x66D0F8AC
	jne	.LBB11_12
.LBB11_11:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$114452014, -36(%rbp)   # imm = 0x6D2662E
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movl	$-1, -40(%rbp)
	movq	-32(%rbp), %rdi
...
.LBB12_7:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$114452014, -36(%rbp)   # imm = 0x6D2662E
	jne	.LBB12_9
.LBB12_8:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$1746998368, -36(%rbp)  # imm = 0x68211460
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movl	$-1, -40(%rbp)
	movq	-32(%rbp), %rdi
...
.LBB13_7:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$1746998368, -36(%rbp)  # imm = 0x68211460
	jne	.LBB13_9
.LBB13_8:
	movl	%ebx, %eax
	addq	$40, %rsp
