...
func_SliceHeader.4:                               ; preds = %ctrl0
  %3 = call i32 @SliceHeader.4()
  ret i32 %3

func_SliceHeader.7:                               ; preds = %ctrl1
  %4 = call i32 @SliceHeader.7()
  ret i32 %4
...
func_SliceHeader.15:                              ; preds = %ctrl3
  %6 = call i32 @SliceHeader.15()
  ret i32 %6

func_SliceHeader.23:                              ; preds = %ctrl4
  %7 = call i32 @SliceHeader.23()
  ret i32 %7

func_SliceHeader.26:                              ; preds = %ctrl5
  %8 = call i32 @SliceHeader.26()
  ret i32 %8
...
ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_SliceHeader.4, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_SliceHeader.7, label %ctrl2
...
ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_SliceHeader.15, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_SliceHeader.23, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_SliceHeader.26, label %func_SliceHeader.32
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_get_picture_type.9, label %func_get_picture_type.18

func_get_picture_type.9:                          ; preds = %rand_bb
  %2 = call i32 @get_picture_type.9()
  ret i32 %2

func_get_picture_type.18:                         ; preds = %rand_bb
  %3 = call i32 @get_picture_type.18()
  ret i32 %3
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_Partition_BC_Header.19, label %ctrl0

func_Partition_BC_Header.19:                      ; preds = %rand_bb
  %2 = call i32 @Partition_BC_Header.19(i32 %PartNo)
  ret i32 %2

func_Partition_BC_Header.30:                      ; preds = %ctrl0
  %3 = call i32 @Partition_BC_Header.30(i32 %PartNo)
  ret i32 %3

func_Partition_BC_Header.33:                      ; preds = %ctrl1
  %4 = call i32 @Partition_BC_Header.33(i32 %PartNo)
  ret i32 %4

func_Partition_BC_Header.38:                      ; preds = %ctrl2
  %5 = call i32 @Partition_BC_Header.38(i32 %PartNo)
  ret i32 %5

func_Partition_BC_Header.39:                      ; preds = %ctrl3
  %6 = call i32 @Partition_BC_Header.39(i32 %PartNo)
  ret i32 %6
...
ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_Partition_BC_Header.30, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_Partition_BC_Header.33, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_Partition_BC_Header.38, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_Partition_BC_Header.39, label %ctrl4
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_ref_pic_list_reordering.1, label %ctrl0

func_ref_pic_list_reordering.1:                   ; preds = %rand_bb
  %2 = call i32 @ref_pic_list_reordering.1()
  ret i32 %2
...
func_ref_pic_list_reordering.10:                  ; preds = %ctrl1
  %4 = call i32 @ref_pic_list_reordering.10()
  ret i32 %4

func_ref_pic_list_reordering.14:                  ; preds = %ctrl2
  %5 = call i32 @ref_pic_list_reordering.14()
  ret i32 %5

func_ref_pic_list_reordering.22:                  ; preds = %ctrl3
  %6 = call i32 @ref_pic_list_reordering.22()
  ret i32 %6

func_ref_pic_list_reordering.24:                  ; preds = %ctrl4
  %7 = call i32 @ref_pic_list_reordering.24()
  ret i32 %7

func_ref_pic_list_reordering.31:                  ; preds = %ctrl5
  %8 = call i32 @ref_pic_list_reordering.31()
  ret i32 %8

func_ref_pic_list_reordering.34:                  ; preds = %ctrl5
  %9 = call i32 @ref_pic_list_reordering.34()
  ret i32 %9
...
ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_ref_pic_list_reordering.10, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_ref_pic_list_reordering.14, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_ref_pic_list_reordering.22, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_ref_pic_list_reordering.24, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_ref_pic_list_reordering.31, label %func_ref_pic_list_reordering.34
}
...
func_dec_ref_pic_marking.11:                      ; preds = %ctrl1
  %4 = call i32 @dec_ref_pic_marking.11()
  ret i32 %4

func_dec_ref_pic_marking.17:                      ; preds = %ctrl2
  %5 = call i32 @dec_ref_pic_marking.17()
  ret i32 %5

func_dec_ref_pic_marking.20:                      ; preds = %ctrl3
  %6 = call i32 @dec_ref_pic_marking.20()
  ret i32 %6

func_dec_ref_pic_marking.21:                      ; preds = %ctrl4
  %7 = call i32 @dec_ref_pic_marking.21()
  ret i32 %7

func_dec_ref_pic_marking.27:                      ; preds = %ctrl5
  %8 = call i32 @dec_ref_pic_marking.27()
  ret i32 %8

func_dec_ref_pic_marking.29:                      ; preds = %ctrl5
  %9 = call i32 @dec_ref_pic_marking.29()
  ret i32 %9
...
ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_dec_ref_pic_marking.11, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_dec_ref_pic_marking.17, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_dec_ref_pic_marking.20, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_dec_ref_pic_marking.21, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_dec_ref_pic_marking.27, label %func_dec_ref_pic_marking.29
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_pred_weight_table.5, label %ctrl0

func_pred_weight_table.5:                         ; preds = %rand_bb
  %2 = call i32 @pred_weight_table.5()
  ret i32 %2

func_pred_weight_table.12:                        ; preds = %ctrl0
  %3 = call i32 @pred_weight_table.12()
  ret i32 %3

func_pred_weight_table.16:                        ; preds = %ctrl1
  %4 = call i32 @pred_weight_table.16()
  ret i32 %4
...
func_pred_weight_table.35:                        ; preds = %ctrl4
  %7 = call i32 @pred_weight_table.35()
  ret i32 %7

func_pred_weight_table.36:                        ; preds = %ctrl5
  %8 = call i32 @pred_weight_table.36()
  ret i32 %8
...
ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_pred_weight_table.12, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_pred_weight_table.16, label %ctrl2
...
ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_pred_weight_table.35, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_pred_weight_table.36, label %func_pred_weight_table.37
}

; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @ref_pic_list_reordering.1() #0 {
entry:
  %canary = alloca i32
  store i32 1892857491, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1948377140, i32* %canary
  %partition = alloca %struct.datapartition*, align 8
...
if.end239:                                        ; preds = %if.then236, %land.lhs.true232, %if.end229
  ...
  %238 = icmp eq i32 %237, 1948377140
...
entry:
  ...
  %partition = alloca %struct.datapartition*, align 8
  %canary = alloca i32
  store i32 823396338, i32* %canary
  %len = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
  %1 = load i32, i32* %partition_mode, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @SliceHeader.4() #0 {
entry:
  %bottom_field_flag = alloca i32, align 4
  %canary = alloca i32
  store i32 60225140, i32* %canary
  %field_pic_flag = alloca i32, align 4
  %override_flag = alloca i32, align 4
  %currSlice = alloca %struct.Slice*, align 8
  %dP_nr = alloca i32, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 713579160, i32* %canary
  %partition = alloca %struct.datapartition*, align 8
  %len = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
...
entry:
  ...
  %val = alloca i32, align 4
  %canary = alloca i32
  store i32 760975456, i32* %canary
  %partition = alloca %struct.datapartition*, align 8
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @SliceHeader.7() #0 {
entry:
  %field_pic_flag = alloca i32, align 4
  %dP_nr = alloca i32, align 4
  %canary = alloca i32
  store i32 249759214, i32* %canary
  %currSlice = alloca %struct.Slice*, align 8
  %num_bits_slice_group_change_cycle = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
  %bottom_field_flag = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1413979102, i32* %canary
  %i = alloca i32, align 4
  %currSlice = alloca %struct.Slice*, align 8
  %dP_nr = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_picture_type.9() #0 {
entry:
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1665871068, i32* %canary
...
entry:
  ...
  %currSlice = alloca %struct.Slice*, align 8
  %canary = alloca i32
  store i32 194594925, i32* %canary
  %len = alloca i32, align 4
  %i = alloca i32, align 4
  %dP_nr = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @dec_ref_pic_marking.11() #0 {
entry:
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
  %val = alloca i32, align 4
  %dP_nr = alloca i32, align 4
  %len = alloca i32, align 4
  %canary = alloca i32
  store i32 1454832849, i32* %canary
  %partition = alloca %struct.datapartition*, align 8
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
  %1 = load i32, i32* %partition_mode, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @pred_weight_table.12() #0 {
entry:
  %j = alloca i32, align 4
  %len = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
  %dP_nr = alloca i32, align 4
  %canary = alloca i32
  store i32 1889649045, i32* %canary
  %i = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
  %1 = load i32, i32* %partition_mode, align 4
...
if.end175:                                        ; preds = %for.end174, %for.end83
  %170 = load i32, i32* %len, align 4
  %171 = load i32, i32* %canary
  %172 = icmp eq i32 %171, 1889649045
  br i1 %172, label %173, label %func_exit
...
entry:
  %canary = alloca i32
  store i32 1962325781, i32* %canary
  %bottom_field_flag = alloca i32, align 4
  %override_flag = alloca i32, align 4
  %numtmp = alloca float, align 4
  %partition = alloca %struct.datapartition*, align 8
...
if.end239:                                        ; preds = %if.then236, %land.lhs.true232, %if.end229
  %236 = load i32, i32* %len, align 4
  %237 = load i32, i32* %canary
  %238 = icmp eq i32 %237, 1962325781
  br i1 %238, label %239, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @SliceHeader.15() #0 {
entry:
  %bottom_field_flag = alloca i32, align 4
  %num_bits_slice_group_change_cycle = alloca i32, align 4
  %currSlice = alloca %struct.Slice*, align 8
  ...
  %field_pic_flag = alloca i32, align 4
  %canary = alloca i32
  store i32 1856208749, i32* %canary
  %numtmp = alloca float, align 4
  %partition = alloca %struct.datapartition*, align 8
  %override_flag = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
if.end239:                                        ; preds = %if.then236, %land.lhs.true232, %if.end229
  %236 = load i32, i32* %len, align 4
  %237 = load i32, i32* %canary
  %238 = icmp eq i32 %237, 1856208749
  br i1 %238, label %239, label %func_exit
...
entry:
  %dP_nr = alloca i32, align 4
  %canary = alloca i32
  store i32 946721269, i32* %canary
  %len = alloca i32, align 4
  %j = alloca i32, align 4
  %i = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
...
entry:
  ...
  %len = alloca i32, align 4
  %canary = alloca i32
  store i32 177298339, i32* %canary
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
  %partition = alloca %struct.datapartition*, align 8
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @get_picture_type.18() #0 {
entry:
  %canary = alloca i32
  store i32 2030356636, i32* %canary
  %same_slicetype_for_whole_frame = alloca i32, align 4
  %retval = alloca i32, align 4
  store i32 5, i32* %same_slicetype_for_whole_frame, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
entry:
  ...
  %partition = alloca %struct.datapartition*, align 8
  %canary = alloca i32
  store i32 532395482, i32* %canary
  %len = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @dec_ref_pic_marking.20() #0 {
entry:
  %len = alloca i32, align 4
  %canary = alloca i32
  store i32 820233191, i32* %canary
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
  %val = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
  %dP_nr = alloca i32, align 4
...
entry:
  ...
  %len = alloca i32, align 4
  %canary = alloca i32
  store i32 1569558300, i32* %canary
  %dP_nr = alloca i32, align 4
  %val = alloca i32, align 4
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @ref_pic_list_reordering.22() #0 {
entry:
  %partition = alloca %struct.datapartition*, align 8
  %i = alloca i32, align 4
  %currSlice = alloca %struct.Slice*, align 8
  %canary = alloca i32
  store i32 1151763179, i32* %canary
  %len = alloca i32, align 4
  %dP_nr = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
...
entry:
  ...
  %override_flag = alloca i32, align 4
  %canary = alloca i32
  store i32 2146956696, i32* %canary
  %num_bits_slice_group_change_cycle = alloca i32, align 4
  %dP_nr = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
...
if.end239:                                        ; preds = %if.then236, %land.lhs.true232, %if.end229
  %236 = load i32, i32* %len, align 4
  %237 = load i32, i32* %canary
  %238 = icmp eq i32 %237, 2146956696
  br i1 %238, label %239, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @ref_pic_list_reordering.24() #0 {
entry:
  %currSlice = alloca %struct.Slice*, align 8
  %partition = alloca %struct.datapartition*, align 8
  %len = alloca i32, align 4
  %canary = alloca i32
  store i32 114306817, i32* %canary
  %dP_nr = alloca i32, align 4
  %i = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1966735422, i32* %canary
  %dP_nr = alloca i32, align 4
  %i = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
if.end175:                                        ; preds = %for.end174, %for.end83
  %170 = load i32, i32* %len, align 4
  %171 = load i32, i32* %canary
  %172 = icmp eq i32 %171, 1966735422
  br i1 %172, label %173, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @SliceHeader.26() #0 {
entry:
  %currSlice = alloca %struct.Slice*, align 8
  %field_pic_flag = alloca i32, align 4
  %bottom_field_flag = alloca i32, align 4
  ...
  %partition = alloca %struct.datapartition*, align 8
  %canary = alloca i32
  store i32 870265531, i32* %canary
  %len = alloca i32, align 4
  %numtmp = alloca float, align 4
  %override_flag = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @dec_ref_pic_marking.27() #0 {
entry:
  %canary = alloca i32
  store i32 682676880, i32* %canary
  %partition = alloca %struct.datapartition*, align 8
  %len = alloca i32, align 4
  %val = alloca i32, align 4
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
...
entry:
  ...
  %dP_nr = alloca i32, align 4
  %canary = alloca i32
  store i32 939411891, i32* %canary
  %len = alloca i32, align 4
  %j = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @dec_ref_pic_marking.29() #0 {
entry:
  %partition = alloca %struct.datapartition*, align 8
  %dP_nr = alloca i32, align 4
  %tmp_drpm = alloca %struct.DecRefPicMarking_s*, align 8
  %canary = alloca i32
  store i32 1255848410, i32* %canary
  %len = alloca i32, align 4
  %val = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
...
entry:
  %sym = alloca %struct.syntaxelement*, align 8
  %canary = alloca i32
  store i32 2129013802, i32* %canary
  %partition = alloca %struct.datapartition*, align 8
  %PartNo.addr = alloca i32, align 4
  %symbol = alloca %struct.syntaxelement, align 8
  %len = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1499183436, i32* %canary
  %currSlice = alloca %struct.Slice*, align 8
  %len = alloca i32, align 4
  %i = alloca i32, align 4
  %dP_nr = alloca i32, align 4
...
entry:
  ...
  %bottom_field_flag = alloca i32, align 4
  %canary = alloca i32
  store i32 2002335881, i32* %canary
  %field_pic_flag = alloca i32, align 4
  %len = alloca i32, align 4
  %dP_nr = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
...
if.end239:                                        ; preds = %if.then236, %land.lhs.true232, %if.end229
  %236 = load i32, i32* %len, align 4
  %237 = load i32, i32* %canary
  %238 = icmp eq i32 %237, 2002335881
  br i1 %238, label %239, label %func_exit
...
entry:
  ...
  %sym = alloca %struct.syntaxelement*, align 8
  %canary = alloca i32
  store i32 1257567735, i32* %canary
  %partition = alloca %struct.datapartition*, align 8
  store i32 %PartNo, i32* %PartNo.addr, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %currentSlice = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 50
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @ref_pic_list_reordering.34() #0 {
entry:
  %i = alloca i32, align 4
  %dP_nr = alloca i32, align 4
  %canary = alloca i32
  store i32 295162641, i32* %canary
  %len = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
  %currSlice = alloca %struct.Slice*, align 8
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
entry:
  ...
  %partition = alloca %struct.datapartition*, align 8
  %canary = alloca i32
  store i32 1890872775, i32* %canary
  %len = alloca i32, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %partition_mode = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 61
  %1 = load i32, i32* %partition_mode, align 4
...
if.end175:                                        ; preds = %for.end174, %for.end83
  %170 = load i32, i32* %len, align 4
  %171 = load i32, i32* %canary
  %172 = icmp eq i32 %171, 1890872775
  br i1 %172, label %173, label %func_exit
...
entry:
  %canary = alloca i32
  store i32 1180939900, i32* %canary
  %j = alloca i32, align 4
  %i = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
  %len = alloca i32, align 4
...
if.end175:                                        ; preds = %for.end174, %for.end83
  %170 = load i32, i32* %len, align 4
  %171 = load i32, i32* %canary
  %172 = icmp eq i32 %171, 1180939900
  br i1 %172, label %173, label %func_exit
...
entry:
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1737612929, i32* %canary
  %i = alloca i32, align 4
  %len = alloca i32, align 4
  %partition = alloca %struct.datapartition*, align 8
  %dP_nr = alloca i32, align 4
...
if.end175:                                        ; preds = %for.end174, %for.end83
  %170 = load i32, i32* %len, align 4
  %171 = load i32, i32* %canary
  %172 = icmp eq i32 %171, 1737612929
  br i1 %172, label %173, label %func_exit
...
entry:
  %canary = alloca i32
  store i32 895724594, i32* %canary
  %len = alloca i32, align 4
  %sym = alloca %struct.syntaxelement*, align 8
  %PartNo.addr = alloca i32, align 4
  %symbol = alloca %struct.syntaxelement, align 8
...
entry:
  ...
  %partition = alloca %struct.datapartition*, align 8
  %canary = alloca i32
  store i32 1046870351, i32* %canary
  %sym = alloca %struct.syntaxelement*, align 8
  store i32 %PartNo, i32* %PartNo.addr, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %currentSlice = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 50
...
entry:
  %canary = alloca i32
  store i32 533017363, i32* %canary
  %PartNo.addr = alloca i32, align 4
  %symbol = alloca %struct.syntaxelement, align 8
  %partition = alloca %struct.datapartition*, align 8
  %len = alloca i32, align 4
...
entry:
  ...
  %len = alloca i32, align 4
  %canary = alloca i32
  store i32 953374800, i32* %canary
  %symbol = alloca %struct.syntaxelement, align 8
  store i32 %PartNo, i32* %PartNo.addr, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %currentSlice = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 50
...
entry:
  ...
  %sym = alloca %struct.syntaxelement*, align 8
  %canary = alloca i32
  store i32 496176332, i32* %canary
  %len = alloca i32, align 4
  %PartNo.addr = alloca i32, align 4
  store i32 %PartNo, i32* %PartNo.addr, align 4
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
