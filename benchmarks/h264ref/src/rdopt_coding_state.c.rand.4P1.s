...
# %bb.0:                                # %rand_bb
	...
	cmpl	$0, %eax
	jne	.LBB2_5
# %bb.1:                                # %func_store_coding_state.5
	movq	%rbx, %rdi
...
.LBB3_3:                                # %func_reset_coding_state.3
	...
	.cfi_def_cfa %rsp, 8
	retq
.LBB3_4:                                # %func_reset_coding_state.4
	.cfi_def_cfa %rbp, 16
	movq	%rbx, %rdi
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$96, %rsp
	movl	$1408128234, -44(%rbp)  # imm = 0x53EE54EA
	movq	%rdi, -16(%rbp)
	movq	img, %rax
	movq	14160(%rax), %rax
	movq	32(%rax), %rax
...
.LBB4_19:                               # %if.end41
	...
	movq	%rax, 504(%rcx)
.LBB4_20:                               # %return
	cmpl	$1408128234, -44(%rbp)  # imm = 0x53EE54EA
	jne	.LBB4_22
.LBB4_21:
	addq	$96, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$96, %rsp
	movl	$73387428, -44(%rbp)    # imm = 0x45FCDA4
	movq	%rdi, -16(%rbp)
	movq	img, %rax
	movq	14160(%rax), %rax
	movq	32(%rax), %rax
...
.LBB5_19:                               # %if.end41
	...
	movq	%rax, 504(%rcx)
.LBB5_20:                               # %return
	cmpl	$73387428, -44(%rbp)    # imm = 0x45FCDA4
	jne	.LBB5_22
.LBB5_21:
	addq	$96, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$96, %rsp
	movl	$321091979, -44(%rbp)   # imm = 0x1323798B
	movq	%rdi, -16(%rbp)
	movq	img, %rax
	movq	14160(%rax), %rax
	movq	32(%rax), %rax
...
.LBB6_19:                               # %if.end41
	...
	movq	%rax, 504(%rcx)
.LBB6_20:                               # %return
	cmpl	$321091979, -44(%rbp)   # imm = 0x1323798B
	jne	.LBB6_22
.LBB6_21:
	addq	$96, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$96, %rsp
	movl	$1610196397, -44(%rbp)  # imm = 0x5FF9A5AD
	movq	%rdi, -16(%rbp)
	movq	img, %rax
	movq	14160(%rax), %rax
	movq	32(%rax), %rax
...
.LBB7_19:                               # %if.end41
	...
	movq	%rax, 504(%rcx)
.LBB7_20:                               # %return
	cmpl	$1610196397, -44(%rbp)  # imm = 0x5FF9A5AD
	jne	.LBB7_22
.LBB7_21:
	addq	$96, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$96, %rsp
	movl	$2057939322, -44(%rbp)  # imm = 0x7AA9A97A
	movq	%rdi, -16(%rbp)
	movq	img, %rax
	movq	14160(%rax), %rax
	movq	32(%rax), %rax
...
.LBB8_19:                               # %if.end41
	...
	movq	%rax, 344(%rcx)
.LBB8_20:                               # %return
	cmpl	$2057939322, -44(%rbp)  # imm = 0x7AA9A97A
	jne	.LBB8_22
.LBB8_21:
	addq	$96, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$96, %rsp
	movl	$767563950, -44(%rbp)   # imm = 0x2DC018AE
	movq	%rdi, -16(%rbp)
	movq	img, %rax
	movq	14160(%rax), %rax
	movq	32(%rax), %rax
...
.LBB9_19:                               # %if.end41
	...
	movq	%rax, 344(%rcx)
.LBB9_20:                               # %return
	cmpl	$767563950, -44(%rbp)   # imm = 0x2DC018AE
	jne	.LBB9_22
.LBB9_21:
	addq	$96, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$96, %rsp
	movl	$908020615, -44(%rbp)   # imm = 0x361F4B87
	movq	%rdi, -16(%rbp)
	movq	img, %rax
	movq	14160(%rax), %rax
	movq	32(%rax), %rax
...
.LBB10_19:                              # %if.end41
	...
	movq	%rax, 344(%rcx)
.LBB10_20:                              # %return
	cmpl	$908020615, -44(%rbp)   # imm = 0x361F4B87
	jne	.LBB10_22
.LBB10_21:
	addq	$96, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$96, %rsp
	movl	$1736374946, -44(%rbp)  # imm = 0x677EFAA2
	movq	%rdi, -16(%rbp)
	movq	img, %rax
	movq	14160(%rax), %rax
	movq	32(%rax), %rax
...
.LBB11_19:                              # %if.end41
	...
	movq	%rax, 344(%rcx)
.LBB11_20:                              # %return
	cmpl	$1736374946, -44(%rbp)  # imm = 0x677EFAA2
	jne	.LBB11_22
.LBB11_21:
	addq	$96, %rsp
	popq	%rbp
