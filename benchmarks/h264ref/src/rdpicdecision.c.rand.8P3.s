...
# %bb.1:                                # %func_picture_coding_decision.1
	...
	.cfi_def_cfa %rsp, 8
	retq
.LBB1_2:                                # %func_picture_coding_decision.5
	.cfi_def_cfa %rbp, 16
	movq	%rbx, %rdi
	movq	%r15, %rsi
	movl	%r14d, %edx
...
# %bb.0:                                # %entry
	...
	subq	$72, %rsp
	.cfi_offset %rbx, -24
	movl	$1206776359, -44(%rbp)  # imm = 0x47EDF227
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movl	%edx, -12(%rbp)
	movq	img, %rax
...
.LBB2_5:                                # %if.end
	...
	movl	%eax, %ebx
	cmpl	$1206776359, -44(%rbp)  # imm = 0x47EDF227
	jne	.LBB2_7
.LBB2_6:
	movl	%ebx, %eax
	addq	$72, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$1153882973, -24(%rbp)  # imm = 0x44C6DB5D
	vmovsd	%xmm0, -48(%rbp)
	vmovsd	%xmm1, -64(%rbp)
	movl	%edi, -20(%rbp)
	movl	%esi, -16(%rbp)
...
.LBB3_5:                                # %return
	movl	-12(%rbp), %ebx
	cmpl	$1153882973, -24(%rbp)  # imm = 0x44C6DB5D
	jne	.LBB3_7
.LBB3_6:
	movl	%ebx, %eax
	addq	$56, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$1552556582, -20(%rbp)  # imm = 0x5C8A2226
	vmovsd	%xmm0, -64(%rbp)
	vmovsd	%xmm1, -40(%rbp)
	movl	%edi, -16(%rbp)
	movl	%esi, -24(%rbp)
...
.LBB4_5:                                # %return
	movl	-12(%rbp), %ebx
	cmpl	$1552556582, -20(%rbp)  # imm = 0x5C8A2226
	jne	.LBB4_7
.LBB4_6:
	movl	%ebx, %eax
	addq	$56, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$1310804204, -20(%rbp)  # imm = 0x4E2148EC
	vmovsd	%xmm0, -32(%rbp)
	vmovsd	%xmm1, -48(%rbp)
	movl	%edi, -24(%rbp)
	movl	%esi, -16(%rbp)
...
.LBB5_5:                                # %return
	movl	-12(%rbp), %ebx
	cmpl	$1310804204, -20(%rbp)  # imm = 0x4E2148EC
	jne	.LBB5_7
.LBB5_6:
	movl	%ebx, %eax
	addq	$56, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$72, %rsp
	.cfi_offset %rbx, -24
	movl	$733482811, -52(%rbp)   # imm = 0x2BB80F3B
	movq	%rdi, -24(%rbp)
	movq	%rsi, -32(%rbp)
	movl	%edx, -12(%rbp)
	movq	img, %rax
...
.LBB6_5:                                # %if.end
	...
	callq	rd_pic_decision
	movl	%eax, %ebx
	cmpl	$733482811, -52(%rbp)   # imm = 0x2BB80F3B
	jne	.LBB6_7
.LBB6_6:
	movl	%ebx, %eax
	addq	$72, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$704065309, -16(%rbp)   # imm = 0x29F72F1D
	vmovsd	%xmm0, -48(%rbp)
	vmovsd	%xmm1, -32(%rbp)
	movl	%edi, -20(%rbp)
	movl	%esi, -24(%rbp)
...
.LBB7_5:                                # %return
	movl	-12(%rbp), %ebx
	cmpl	$704065309, -16(%rbp)   # imm = 0x29F72F1D
	jne	.LBB7_7
.LBB7_6:
	movl	%ebx, %eax
	addq	$56, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$1028286568, -24(%rbp)  # imm = 0x3D4A6868
	vmovsd	%xmm0, -32(%rbp)
	vmovsd	%xmm1, -48(%rbp)
	movl	%edi, -16(%rbp)
	movl	%esi, -20(%rbp)
...
.LBB8_5:                                # %return
	movl	-12(%rbp), %ebx
	cmpl	$1028286568, -24(%rbp)  # imm = 0x3D4A6868
	jne	.LBB8_7
.LBB8_6:
	movl	%ebx, %eax
	addq	$56, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$72, %rsp
	.cfi_offset %rbx, -24
	movl	$262491490, -48(%rbp)   # imm = 0xFA54D62
	movq	%rdi, -24(%rbp)
	movq	%rsi, -32(%rbp)
	movl	%edx, -12(%rbp)
	movq	img, %rax
...
.LBB9_5:                                # %if.end
	...
	callq	rd_pic_decision
	movl	%eax, %ebx
	cmpl	$262491490, -48(%rbp)   # imm = 0xFA54D62
	jne	.LBB9_7
.LBB9_6:
	movl	%ebx, %eax
	addq	$72, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$46608824, -24(%rbp)    # imm = 0x2C731B8
	vmovsd	%xmm0, -64(%rbp)
	vmovsd	%xmm1, -56(%rbp)
	movl	%edi, -20(%rbp)
	movl	%esi, -16(%rbp)
...
.LBB10_5:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$46608824, -24(%rbp)    # imm = 0x2C731B8
	jne	.LBB10_7
.LBB10_6:
	movl	%ebx, %eax
	addq	$56, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$72, %rsp
	.cfi_offset %rbx, -24
	movl	$301043877, -40(%rbp)   # imm = 0x11F190A5
	movq	%rdi, -24(%rbp)
	movq	%rsi, -32(%rbp)
	movl	%edx, -12(%rbp)
	movq	img, %rax
...
.LBB11_5:                               # %if.end
	...
	callq	rd_pic_decision
	movl	%eax, %ebx
	cmpl	$301043877, -40(%rbp)   # imm = 0x11F190A5
	jne	.LBB11_7
.LBB11_6:
	movl	%ebx, %eax
	addq	$72, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$1029565244, -24(%rbp)  # imm = 0x3D5DEB3C
	vmovsd	%xmm0, -64(%rbp)
	vmovsd	%xmm1, -40(%rbp)
	movl	%edi, -16(%rbp)
	movl	%esi, -20(%rbp)
...
.LBB12_5:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$1029565244, -24(%rbp)  # imm = 0x3D5DEB3C
	jne	.LBB12_7
.LBB12_6:
	movl	%ebx, %eax
	addq	$56, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$1384048105, -20(%rbp)  # imm = 0x527EE5E9
	vmovsd	%xmm0, -64(%rbp)
	vmovsd	%xmm1, -40(%rbp)
	movl	%edi, -16(%rbp)
	movl	%esi, -24(%rbp)
...
.LBB13_5:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$1384048105, -20(%rbp)  # imm = 0x527EE5E9
	jne	.LBB13_7
.LBB13_6:
	movl	%ebx, %eax
	addq	$56, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$72, %rsp
	.cfi_offset %rbx, -24
	movl	$418927816, -52(%rbp)   # imm = 0x18F854C8
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movl	%edx, -12(%rbp)
	movq	img, %rax
...
.LBB14_5:                               # %if.end
	...
	callq	rd_pic_decision
	movl	%eax, %ebx
	cmpl	$418927816, -52(%rbp)   # imm = 0x18F854C8
	jne	.LBB14_7
.LBB14_6:
	movl	%ebx, %eax
	addq	$72, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$72, %rsp
	.cfi_offset %rbx, -24
	movl	$1596680580, -44(%rbp)  # imm = 0x5F2B6984
	movq	%rdi, -24(%rbp)
	movq	%rsi, -32(%rbp)
	movl	%edx, -12(%rbp)
	movq	img, %rax
...
.LBB15_5:                               # %if.end
	...
	callq	rd_pic_decision
	movl	%eax, %ebx
	cmpl	$1596680580, -44(%rbp)  # imm = 0x5F2B6984
	jne	.LBB15_7
.LBB15_6:
	movl	%ebx, %eax
	addq	$72, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$72, %rsp
	.cfi_offset %rbx, -24
	movl	$1211924115, -36(%rbp)  # imm = 0x483C7E93
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movl	%edx, -12(%rbp)
	movq	img, %rax
...
.LBB16_5:                               # %if.end
	...
	callq	rd_pic_decision
	movl	%eax, %ebx
	cmpl	$1211924115, -36(%rbp)  # imm = 0x483C7E93
	jne	.LBB16_7
.LBB16_6:
	movl	%ebx, %eax
	addq	$72, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$72, %rsp
	.cfi_offset %rbx, -24
	movl	$214449227, -40(%rbp)   # imm = 0xCC83C4B
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movl	%edx, -12(%rbp)
	movq	img, %rax
...
.LBB17_5:                               # %if.end
	...
	callq	rd_pic_decision
	movl	%eax, %ebx
	cmpl	$214449227, -40(%rbp)   # imm = 0xCC83C4B
	jne	.LBB17_7
.LBB17_6:
	movl	%ebx, %eax
	addq	$72, %rsp
