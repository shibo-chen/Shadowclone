...
.LBB2_5:                                # %func_start_sequence.9
	...
	.cfi_def_cfa %rsp, 8
	retq
.LBB2_6:                                # %func_start_sequence.10
	.cfi_def_cfa %rbp, 16
	callq	start_sequence.10
	popq	%rbp
	.cfi_def_cfa %rsp, 8
	retq
.LBB2_7:                                # %func_start_sequence.11
	.cfi_def_cfa %rbp, 16
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1160294474, -20(%rbp)  # imm = 0x4528B04A
	movq	%rdi, -16(%rbp)
	movl	%esi, -4(%rbp)
	movq	stderr, %rdi
	movq	-16(%rbp), %rdx
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$676894262, -40(%rbp)   # imm = 0x28589636
	movl	$0, -12(%rbp)
	movq	input(%rip), %rax
	movl	60(%rax), %eax
	xorl	%ecx, %ecx
...
.LBB5_10:                               # %return
	movl	-20(%rbp), %ebx
	cmpl	$676894262, -40(%rbp)   # imm = 0x28589636
	jne	.LBB5_12
.LBB5_11:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$256085497, -20(%rbp)   # imm = 0xF438DF9
	movq	%rdi, -16(%rbp)
	movl	%esi, -4(%rbp)
	movq	stderr, %rdi
	movq	-16(%rbp), %rdx
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$488673603, -36(%rbp)   # imm = 0x1D209143
	movl	$0, -12(%rbp)
	movq	input(%rip), %rax
	movl	60(%rax), %eax
	xorl	%ecx, %ecx
...
.LBB7_10:                               # %return
	movl	-20(%rbp), %ebx
	cmpl	$488673603, -36(%rbp)   # imm = 0x1D209143
	jne	.LBB7_12
.LBB7_11:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$241397189, -28(%rbp)   # imm = 0xE636DC5
	movl	%edi, -12(%rbp)
	movl	%esi, -32(%rbp)
	movq	$0, -24(%rbp)
	movl	-32(%rbp), %edi
	...
	callq	FreeNALU
	movl	-12(%rbp), %ebx
	cmpl	$241397189, -28(%rbp)   # imm = 0xE636DC5
	jne	.LBB8_2
.LBB8_1:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$1384940276, -36(%rbp)  # imm = 0x528C82F4
	movl	$0, -12(%rbp)
	movq	input(%rip), %rax
	movl	60(%rax), %eax
	xorl	%ecx, %ecx
...
.LBB9_10:                               # %return
	movl	-20(%rbp), %ebx
	cmpl	$1384940276, -36(%rbp)  # imm = 0x528C82F4
	jne	.LBB9_12
.LBB9_11:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$1755693922, -32(%rbp)  # imm = 0x68A5C362
	movl	%edi, -12(%rbp)
	movl	%esi, -28(%rbp)
	movq	$0, -24(%rbp)
	movl	-28(%rbp), %edi
	...
	callq	FreeNALU
	movl	-12(%rbp), %ebx
	cmpl	$1755693922, -32(%rbp)  # imm = 0x68A5C362
	jne	.LBB10_2
.LBB10_1:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$1630155172, -40(%rbp)  # imm = 0x612A31A4
	movl	$0, -12(%rbp)
	movq	input(%rip), %rax
	movl	60(%rax), %eax
	xorl	%ecx, %ecx
...
.LBB11_10:                              # %return
	movl	-20(%rbp), %ebx
	cmpl	$1630155172, -40(%rbp)  # imm = 0x612A31A4
	jne	.LBB11_12
.LBB11_11:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$163143764, -36(%rbp)   # imm = 0x9B96054
	movl	$0, -12(%rbp)
	movq	input(%rip), %rax
	movl	60(%rax), %eax
	xorl	%ecx, %ecx
...
.LBB12_10:                              # %return
	movl	-20(%rbp), %ebx
	cmpl	$163143764, -36(%rbp)   # imm = 0x9B96054
	jne	.LBB12_12
.LBB12_11:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$1667676468, -40(%rbp)  # imm = 0x6366B934
	movl	$0, -12(%rbp)
	movq	input(%rip), %rax
	movl	60(%rax), %eax
	xorl	%ecx, %ecx
...
.LBB13_10:                              # %return
	movl	-20(%rbp), %ebx
	cmpl	$1667676468, -40(%rbp)  # imm = 0x6366B934
	jne	.LBB13_12
.LBB13_11:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$1139427293, -40(%rbp)  # imm = 0x43EA47DD
	movl	$0, -12(%rbp)
	movq	input(%rip), %rax
	movl	60(%rax), %eax
	xorl	%ecx, %ecx
...
.LBB14_10:                              # %return
	movl	-20(%rbp), %ebx
	cmpl	$1139427293, -40(%rbp)  # imm = 0x43EA47DD
	jne	.LBB14_12
.LBB14_11:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$291388911, -32(%rbp)   # imm = 0x115E3DEF
	movl	%edi, -12(%rbp)
	movl	%esi, -28(%rbp)
	movq	$0, -24(%rbp)
	movl	-28(%rbp), %edi
	...
	callq	FreeNALU
	movl	-12(%rbp), %ebx
	cmpl	$291388911, -32(%rbp)   # imm = 0x115E3DEF
	jne	.LBB15_2
.LBB15_1:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$458065596, -28(%rbp)   # imm = 0x1B4D86BC
	movl	%edi, -12(%rbp)
	movl	%esi, -32(%rbp)
	movq	$0, -24(%rbp)
	movl	-32(%rbp), %edi
	...
	callq	FreeNALU
	movl	-12(%rbp), %ebx
	cmpl	$458065596, -28(%rbp)   # imm = 0x1B4D86BC
	jne	.LBB16_2
.LBB16_1:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$40, %rsp
	.cfi_offset %rbx, -24
	movl	$1422726449, -40(%rbp)  # imm = 0x54CD1531
	movl	$0, -12(%rbp)
	movq	input(%rip), %rax
	movl	60(%rax), %eax
	xorl	%ecx, %ecx
...
.LBB17_10:                              # %return
	movl	-20(%rbp), %ebx
	cmpl	$1422726449, -40(%rbp)  # imm = 0x54CD1531
	jne	.LBB17_12
.LBB17_11:
	movl	%ebx, %eax
	addq	$40, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$368135006, -32(%rbp)   # imm = 0x15F14B5E
	movl	%edi, -12(%rbp)
	movl	%esi, -28(%rbp)
	movq	$0, -24(%rbp)
	movl	-28(%rbp), %edi
	...
	callq	FreeNALU
	movl	-12(%rbp), %ebx
	cmpl	$368135006, -32(%rbp)   # imm = 0x15F14B5E
	jne	.LBB18_2
.LBB18_1:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$1593462173, -28(%rbp)  # imm = 0x5EFA4D9D
	movl	%edi, -12(%rbp)
	movl	%esi, -32(%rbp)
	movq	$0, -24(%rbp)
	movl	-32(%rbp), %edi
	...
	callq	FreeNALU
	movl	-12(%rbp), %ebx
	cmpl	$1593462173, -28(%rbp)  # imm = 0x5EFA4D9D
	jne	.LBB19_2
.LBB19_1:
	movl	%ebx, %eax
	addq	$24, %rsp
