; ModuleID = 'decoder.c.rand.4R2.bc'
...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_decode_one_b8block.11, label %ctrl0

func_decode_one_b8block.11:                       ; preds = %rand_bb
  call void @decode_one_b8block.11(i32 %decoder, i32 %mbmode, i32 %b8block, i32 %b8mode, i32 %b8ref)
  ret void

func_decode_one_b8block.14:                       ; preds = %ctrl0
  call void @decode_one_b8block.14(i32 %decoder, i32 %mbmode, i32 %b8block, i32 %b8mode, i32 %b8ref)
  ret void

func_decode_one_b8block.26:                       ; preds = %ctrl1
  call void @decode_one_b8block.26(i32 %decoder, i32 %mbmode, i32 %b8block, i32 %b8mode, i32 %b8ref)
  ret void

func_decode_one_b8block.34:                       ; preds = %ctrl1
  call void @decode_one_b8block.34(i32 %decoder, i32 %mbmode, i32 %b8block, i32 %b8mode, i32 %b8ref)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_decode_one_b8block.14, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_decode_one_b8block.26, label %func_decode_one_b8block.34
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_Get_Reference_Block.15, label %ctrl0

func_Get_Reference_Block.15:                      ; preds = %rand_bb
  call void @Get_Reference_Block.15(i16** %imY, i32 %block_y, i32 %block_x, i32 %mvhor, i32 %mvver, i16** %out)
  ret void

func_Get_Reference_Block.16:                      ; preds = %ctrl0
  call void @Get_Reference_Block.16(i16** %imY, i32 %block_y, i32 %block_x, i32 %mvhor, i32 %mvver, i16** %out)
  ret void

func_Get_Reference_Block.21:                      ; preds = %ctrl1
  call void @Get_Reference_Block.21(i16** %imY, i32 %block_y, i32 %block_x, i32 %mvhor, i32 %mvver, i16** %out)
  ret void

func_Get_Reference_Block.31:                      ; preds = %ctrl1
  call void @Get_Reference_Block.31(i16** %imY, i32 %block_y, i32 %block_x, i32 %mvhor, i32 %mvver, i16** %out)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_Get_Reference_Block.16, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_Get_Reference_Block.21, label %func_Get_Reference_Block.31
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_decode_one_mb.7, label %func_decode_one_mb.8

func_decode_one_mb.7:                             ; preds = %rand_bb
  call void @decode_one_mb.7(i32 %decoder, %struct.macroblock* %currMB)
  ret void

func_decode_one_mb.8:                             ; preds = %rand_bb
  call void @decode_one_mb.8(i32 %decoder, %struct.macroblock* %currMB)
  ret void
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_Get_Reference_Pixel.2, label %ctrl0

func_Get_Reference_Pixel.2:                       ; preds = %rand_bb
  %2 = call i8 @Get_Reference_Pixel.2(i16** %imY, i32 %y_pos, i32 %x_pos)
  ret i8 %2
...
func_Get_Reference_Pixel.13:                      ; preds = %ctrl1
  %4 = call i8 @Get_Reference_Pixel.13(i16** %imY, i32 %y_pos, i32 %x_pos)
  ret i8 %4

func_Get_Reference_Pixel.19:                      ; preds = %ctrl1
  %5 = call i8 @Get_Reference_Pixel.19(i16** %imY, i32 %y_pos, i32 %x_pos)
  ret i8 %5
...
ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_Get_Reference_Pixel.13, label %func_Get_Reference_Pixel.19
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_Build_Status_Map.3, label %ctrl0

func_Build_Status_Map.3:                          ; preds = %rand_bb
  call void @Build_Status_Map.3(i8** %s_map)
  ret void

func_Build_Status_Map.17:                         ; preds = %ctrl0
  call void @Build_Status_Map.17(i8** %s_map)
  ret void

func_Build_Status_Map.18:                         ; preds = %ctrl1
  call void @Build_Status_Map.18(i8** %s_map)
  ret void

func_Build_Status_Map.32:                         ; preds = %ctrl1
  call void @Build_Status_Map.32(i8** %s_map)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_Build_Status_Map.17, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_Build_Status_Map.18, label %func_Build_Status_Map.32
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_Error_Concealment.22, label %ctrl0

func_Error_Concealment.22:                        ; preds = %rand_bb
  call void @Error_Concealment.22(i16** %inY, i8** %s_map, i16*** %refY)
  ret void

func_Error_Concealment.25:                        ; preds = %ctrl0
  call void @Error_Concealment.25(i16** %inY, i8** %s_map, i16*** %refY)
  ret void

func_Error_Concealment.29:                        ; preds = %ctrl1
  call void @Error_Concealment.29(i16** %inY, i8** %s_map, i16*** %refY)
  ret void

func_Error_Concealment.30:                        ; preds = %ctrl1
  call void @Error_Concealment.30(i16** %inY, i8** %s_map, i16*** %refY)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_Error_Concealment.25, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_Error_Concealment.29, label %func_Error_Concealment.30
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_DecOneForthPix.6, label %ctrl0

func_DecOneForthPix.6:                            ; preds = %rand_bb
  call void @DecOneForthPix.6(i16** %dY, i16*** %dref)
  ret void

func_DecOneForthPix.24:                           ; preds = %ctrl0
  call void @DecOneForthPix.24(i16** %dY, i16*** %dref)
  ret void

func_DecOneForthPix.28:                           ; preds = %ctrl1
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_DecOneForthPix.24, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_DecOneForthPix.28, label %func_DecOneForthPix.33
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_compute_residue_b8block.1, label %ctrl0

func_compute_residue_b8block.1:                   ; preds = %rand_bb
  call void @compute_residue_b8block.1(i32 %b8block, i32 %i16mode)
  ret void

func_compute_residue_b8block.9:                   ; preds = %ctrl0
  call void @compute_residue_b8block.9(i32 %b8block, i32 %i16mode)
  ret void
...
func_compute_residue_b8block.27:                  ; preds = %ctrl1
  call void @compute_residue_b8block.27(i32 %b8block, i32 %i16mode)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_compute_residue_b8block.9, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_compute_residue_b8block.23, label %func_compute_residue_b8block.27
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_Conceal_Error.5, label %ctrl0

func_Conceal_Error.5:                             ; preds = %rand_bb
  call void @Conceal_Error.5(i16** %inY, i32 %mb_y, i32 %mb_x, i16*** %refY, i8** %s_map)
  ret void

func_Conceal_Error.10:                            ; preds = %ctrl0
  call void @Conceal_Error.10(i16** %inY, i32 %mb_y, i32 %mb_x, i16*** %refY, i8** %s_map)
  ret void

func_Conceal_Error.12:                            ; preds = %ctrl1
  call void @Conceal_Error.12(i16** %inY, i32 %mb_y, i32 %mb_x, i16*** %refY, i8** %s_map)
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_Conceal_Error.10, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_Conceal_Error.12, label %func_Conceal_Error.20
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @compute_residue_b8block.1(i32 %b8block, i32 %i16mode) #0 {
entry:
  %i1 = alloca i32, align 4
  %i0 = alloca i32, align 4
  %canary = alloca i32
  store i32 1244111749, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local zeroext i8 @Get_Reference_Pixel.2(i16** %imY, i32 %y_pos, i32 %x_pos) #0 {
entry:
  %x_pos.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 841232719, i32* %canary
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 199900524, i32* %canary
...
entry:
  ...
  %result1 = alloca i32, align 4
  %canary = alloca i32
  store i32 795451242, i32* %canary
  %x = alloca i32, align 4
  %result = alloca i32, align 4
  %imY.addr = alloca i16**, align 8
  %result2 = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Conceal_Error.5(i16** %inY, i32 %mb_y, i32 %mb_x, i16*** %refY, i8** %s_map) #0 {
entry:
  %i = alloca i32, align 4
  ...
  %canary = alloca i32
  store i32 354513489, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @DecOneForthPix.6(i16** %dY, i16*** %dref) #0 {
entry:
  %dY.addr = alloca i16**, align 8
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 371604828, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @decode_one_mb.7(i32 %decoder, %struct.macroblock* %currMB) #0 {
entry:
  %currMB.addr = alloca %struct.macroblock*, align 8
  %canary = alloca i32
  store i32 1466196176, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @decode_one_mb.8(i32 %decoder, %struct.macroblock* %currMB) #0 {
entry:
  %canary = alloca i32
  store i32 1235411066, i32* %canary
  %decoder.addr = alloca i32, align 4
  %currMB.addr = alloca %struct.macroblock*, align 8
  store i32 %decoder, i32* %decoder.addr, align 4
  store %struct.macroblock* %currMB, %struct.macroblock** %currMB.addr, align 8
  %0 = load i32, i32* %canary
  %1 = icmp eq i32 %0, 1235411066
  br i1 %1, label %2, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @compute_residue_b8block.9(i32 %b8block, i32 %i16mode) #0 {
entry:
  %i0 = alloca i32, align 4
  %i = alloca i32, align 4
  %j0 = alloca i32, align 4
  ...
  %i1 = alloca i32, align 4
  %canary = alloca i32
  store i32 331541325, i32* %canary
  %j = alloca i32, align 4
  %j1 = alloca i32, align 4
  %b8block.addr = alloca i32, align 4
  store i32 %b8block, i32* %b8block.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Conceal_Error.10(i16** %inY, i32 %mb_y, i32 %mb_x, i16*** %refY, i8** %s_map) #0 {
entry:
  %ref_inx = alloca i32, align 4
  %resY = alloca [16 x [16 x i32]], align 16
  %tmp_mv = alloca i16***, align 8
  %copy = alloca i32, align 4
  %canary = alloca i32
  store i32 1818193333, i32* %canary
  %inY.addr = alloca i16**, align 8
  %inter = alloca i32, align 4
  %pos_y = alloca i32, align 4
  %s_map.addr = alloca i8**, align 8
...
sw.epilog:                                        ; preds = %if.end545, %if.end487, %if.end321, %if.end, %land.end54
  %325 = load i32, i32* %canary
  %326 = icmp eq i32 %325, 1818193333
  br i1 %326, label %327, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @decode_one_b8block.11(i32 %decoder, i32 %mbmode, i32 %b8block, i32 %b8mode, i32 %b8ref) #0 {
entry:
  %j1 = alloca i32, align 4
  ...
  %i1 = alloca i32, align 4
  %canary = alloca i32
  store i32 141022191, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Conceal_Error.12(i16** %inY, i32 %mb_y, i32 %mb_x, i16*** %refY, i8** %s_map) #0 {
entry:
  %tmp_mv = alloca i16***, align 8
  %block_x = alloca i32, align 4
  %canary = alloca i32
  store i32 828077650, i32* %canary
  %mv = alloca [2 x [4 x [4 x i32]]], align 16
  %ref_inx = alloca i32, align 4
  %i = alloca i32, align 4
  %mb_x.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local zeroext i8 @Get_Reference_Pixel.13(i16** %imY, i32 %y_pos, i32 %x_pos) #0 {
entry:
  %x_pos.addr = alloca i32, align 4
  %y_pos.addr = alloca i32, align 4
  %pres_y = alloca i32, align 4
  ...
  %maxold_y = alloca i32, align 4
  %canary = alloca i32
  store i32 459307542, i32* %canary
  %dy = alloca i32, align 4
  %result = alloca i32, align 4
  %result2 = alloca i32, align 4
  store i16** %imY, i16*** %imY.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @decode_one_b8block.14(i32 %decoder, i32 %mbmode, i32 %b8block, i32 %b8mode, i32 %b8ref) #0 {
entry:
  %bx0 = alloca i32, align 4
  %by1 = alloca i32, align 4
  %ref_inx = alloca i32, align 4
  ...
  %mbmode.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 483651725, i32* %canary
  %i1 = alloca i32, align 4
  %b8mode.addr = alloca i32, align 4
  %j0 = alloca i32, align 4
  %bx1 = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1131914274, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Get_Reference_Block.16(i16** %imY, i32 %block_y, i32 %block_x, i32 %mvhor, i32 %mvver, i16** %out) #0 {
entry:
  %block_x.addr = alloca i32, align 4
  %j = alloca i32, align 4
  %block_y.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Build_Status_Map.17(i8** %s_map) #0 {
entry:
  %packet_lost = alloca i32, align 4
  %jj = alloca i32, align 4
  %j = alloca i32, align 4
  ...
  %mb = alloca i32, align 4
  %canary = alloca i32
  store i32 138875107, i32* %canary
  %ii = alloca i32, align 4
  store i8** %s_map, i8*** %s_map.addr, align 8
  store i32 -1, i32* %slice, align 4
  store i32 0, i32* %mb, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Build_Status_Map.18(i8** %s_map) #0 {
entry:
  %slice = alloca i32, align 4
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 134490841, i32* %canary
  %ii = alloca i32, align 4
  %i = alloca i32, align 4
  %mb = alloca i32, align 4
  %packet_lost = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local zeroext i8 @Get_Reference_Pixel.19(i16** %imY, i32 %y_pos, i32 %x_pos) #0 {
entry:
  %y_pos.addr = alloca i32, align 4
  %pres_x = alloca i32, align 4
  %x = alloca i32, align 4
  ...
  %tmp_res = alloca [6 x i32], align 16
  %canary = alloca i32
  store i32 1010609230, i32* %canary
  %dy = alloca i32, align 4
  %dx = alloca i32, align 4
  %result2 = alloca i32, align 4
  %imY.addr = alloca i16**, align 8
...
if.end926:                                        ; preds = %if.end925, %cond.end31
  ...
  %conv927 = trunc i32 %436 to i8
  %437 = load i32, i32* %canary
  %438 = icmp eq i32 %437, 1010609230
  br i1 %438, label %439, label %func_exit
...
entry:
  ...
  %pos_x = alloca i32, align 4
  %canary = alloca i32
  store i32 853352473, i32* %canary
  %mb_x.addr = alloca i32, align 4
  %copy = alloca i32, align 4
  %resY = alloca [16 x [16 x i32]], align 16
  %refY.addr = alloca i16***, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Get_Reference_Block.21(i16** %imY, i32 %block_y, i32 %block_x, i32 %mvhor, i32 %mvver, i16** %out) #0 {
entry:
  %j = alloca i32, align 4
  %mvver.addr = alloca i32, align 4
  %mvhor.addr = alloca i32, align 4
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1459549171, i32* %canary
  %block_x.addr = alloca i32, align 4
  %x = alloca i32, align 4
  store i16** %imY, i16*** %imY.addr, align 8
  store i32 %block_y, i32* %block_y.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Error_Concealment.22(i16** %inY, i8** %s_map, i16*** %refY) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 494890370, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @DecOneForthPix.24(i16** %dY, i16*** %dref) #0 {
entry:
  %dY.addr = alloca i16**, align 8
  %canary = alloca i32
  store i32 444922572, i32* %canary
  %ref = alloca i32, align 4
  %dref.addr = alloca i16***, align 8
  %j = alloca i32, align 4
  store i16** %dY, i16*** %dY.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Error_Concealment.25(i16** %inY, i8** %s_map, i16*** %refY) #0 {
entry:
  %mb_x = alloca i32, align 4
  %inY.addr = alloca i16**, align 8
  %mb_y = alloca i32, align 4
  ...
  %s_map.addr = alloca i8**, align 8
  %canary = alloca i32
  store i32 1386071353, i32* %canary
  %mb_h = alloca i32, align 4
  store i16** %inY, i16*** %inY.addr, align 8
  store i8** %s_map, i8*** %s_map.addr, align 8
  store i16*** %refY, i16**** %refY.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @decode_one_b8block.26(i32 %decoder, i32 %mbmode, i32 %b8block, i32 %b8mode, i32 %b8ref) #0 {
entry:
  %j1 = alloca i32, align 4
  %bx1 = alloca i32, align 4
  %resY_tmp = alloca [16 x [16 x i32]], align 16
  ...
  %block_y = alloca i32, align 4
  %canary = alloca i32
  store i32 1518705910, i32* %canary
  %bx = alloca i32, align 4
  %by = alloca i32, align 4
  %j = alloca i32, align 4
  %i0 = alloca i32, align 4
...
if.end315:                                        ; preds = %if.end314, %for.end28
  %241 = load i32, i32* %canary
  %242 = icmp eq i32 %241, 1518705910
  br i1 %242, label %243, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @compute_residue_b8block.27(i32 %b8block, i32 %i16mode) #0 {
entry:
  %canary = alloca i32
  store i32 822552043, i32* %canary
  %i = alloca i32, align 4
  %b8block.addr = alloca i32, align 4
  %j = alloca i32, align 4
  %i1 = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 495519975, i32* %canary
  %ref = alloca i32, align 4
  %j = alloca i32, align 4
  %dref.addr = alloca i16***, align 8
  %dY.addr = alloca i16**, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Error_Concealment.29(i16** %inY, i8** %s_map, i16*** %refY) #0 {
entry:
  %mb_w = alloca i32, align 4
  %s_map.addr = alloca i8**, align 8
  %mb_x = alloca i32, align 4
  ...
  %refY.addr = alloca i16***, align 8
  %canary = alloca i32
  store i32 999865075, i32* %canary
  %mb_y = alloca i32, align 4
  store i16** %inY, i16*** %inY.addr, align 8
  store i8** %s_map, i8*** %s_map.addr, align 8
  store i16*** %refY, i16**** %refY.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Error_Concealment.30(i16** %inY, i8** %s_map, i16*** %refY) #0 {
entry:
  %mb_x = alloca i32, align 4
  %canary = alloca i32
  store i32 1023444218, i32* %canary
  %mb_w = alloca i32, align 4
  %mb_h = alloca i32, align 4
  %mb_y = alloca i32, align 4
  %refY.addr = alloca i16***, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Get_Reference_Block.31(i16** %imY, i32 %block_y, i32 %block_x, i32 %mvhor, i32 %mvver, i16** %out) #0 {
entry:
  %block_x.addr = alloca i32, align 4
  %mvver.addr = alloca i32, align 4
  %block_y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1835383832, i32* %canary
  %imY.addr = alloca i16**, align 8
  %y = alloca i32, align 4
  %x = alloca i32, align 4
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Build_Status_Map.32(i8** %s_map) #0 {
entry:
  %s_map.addr = alloca i8**, align 8
  %jj = alloca i32, align 4
  %i = alloca i32, align 4
  %mb = alloca i32, align 4
  %canary = alloca i32
  store i32 258807553, i32* %canary
  %j = alloca i32, align 4
  %ii = alloca i32, align 4
  %slice = alloca i32, align 4
  %packet_lost = alloca i32, align 4
...
entry:
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1952784667, i32* %canary
  %dref.addr = alloca i16***, align 8
  %ref = alloca i32, align 4
  %dY.addr = alloca i16**, align 8
  store i16** %dY, i16*** %dY.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @decode_one_b8block.34(i32 %decoder, i32 %mbmode, i32 %b8block, i32 %b8mode, i32 %b8ref) #0 {
entry:
  %j = alloca i32, align 4
  %i1 = alloca i32, align 4
  %mbmode.addr = alloca i32, align 4
  ...
  %b8mode.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1507223270, i32* %canary
  %j1 = alloca i32, align 4
  %resY_tmp = alloca [16 x [16 x i32]], align 16
  %bx1 = alloca i32, align 4
  %b8block.addr = alloca i32, align 4
...
if.end315:                                        ; preds = %if.end314, %for.end28
  %241 = load i32, i32* %canary
  %242 = icmp eq i32 %241, 1507223270
  br i1 %242, label %243, label %func_exit
