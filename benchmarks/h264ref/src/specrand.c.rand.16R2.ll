; ModuleID = 'specrand.c.rand.16R2.bc'
...
entry:
  ...
  %canary = alloca i32
  store i32 125251545, i32* %canary
...
entry:
  ...
  %hi = alloca i32, align 4
  %canary = alloca i32
  store i32 219700993, i32* %canary
  %lo = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
  %conv = sext i32 %0 to i64
  %div = sdiv i64 %conv, 127773
...
entry:
  %canary = alloca i32
  store i32 833616016, i32* %canary
  %test = alloca i32, align 4
  %lo = alloca i32, align 4
  %hi = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
...
entry:
  %canary = alloca i32
  store i32 1265578193, i32* %canary
  %lo = alloca i32, align 4
  %hi = alloca i32, align 4
  %test = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
...
entry:
  %lo = alloca i32, align 4
  %canary = alloca i32
  store i32 1957654084, i32* %canary
  %test = alloca i32, align 4
  %hi = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
  %conv = sext i32 %0 to i64
...
entry:
  %hi = alloca i32, align 4
  %canary = alloca i32
  store i32 807622434, i32* %canary
  %test = alloca i32, align 4
  %lo = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
  %conv = sext i32 %0 to i64
