; ModuleID = 'rdopt_coding_state.c.rand.8R1.bc'
...
ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_store_coding_state.12, label %func_store_coding_state.15
}
...
func_reset_coding_state.13:                       ; preds = %ctrl4
...
ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_reset_coding_state.13, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_reset_coding_state.14, label %func_reset_coding_state.16
}
...
entry:
  ...
  %canary = alloca i32
  store i32 1289997083, i32* %canary
...
entry:
  ...
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %canary = alloca i32
  store i32 1924327405, i32* %canary
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
...
entry:
  ...
  %cs.addr = alloca %struct.CSobj*, align 8
  %canary = alloca i32
  store i32 692317483, i32* %canary
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %i = alloca i32, align 4
  %currMB = alloca %struct.macroblock*, align 8
  store %struct.CSobj* %cs, %struct.CSobj** %cs.addr, align 8
...
entry:
  ...
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %canary = alloca i32
  store i32 1353664101, i32* %canary
  %bs_src = alloca %struct.Bitstream*, align 8
  %i = alloca i32, align 4
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %cs.addr = alloca %struct.CSobj*, align 8
...
entry:
  ...
  %currMB = alloca %struct.macroblock*, align 8
  %canary = alloca i32
  store i32 1636122664, i32* %canary
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  store %struct.CSobj* %cs, %struct.CSobj** %cs.addr, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1563510279, i32* %canary
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %currMB = alloca %struct.macroblock*, align 8
  store %struct.CSobj* %cs, %struct.CSobj** %cs.addr, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1081278963, i32* %canary
  %bs_src = alloca %struct.Bitstream*, align 8
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %cs.addr = alloca %struct.CSobj*, align 8
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
...
entry:
  ...
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %canary = alloca i32
  store i32 2061290882, i32* %canary
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  store %struct.CSobj* %cs, %struct.CSobj** %cs.addr, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
...
entry:
  ...
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %canary = alloca i32
  store i32 2052912708, i32* %canary
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %i = alloca i32, align 4
  %ee_dest = alloca %struct.EncodingEnvironment*, align 8
  %bs_dest = alloca %struct.Bitstream*, align 8
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 161273399, i32* %canary
  %tc_dest = alloca %struct.TextureInfoContexts*, align 8
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %currMB = alloca %struct.macroblock*, align 8
  store %struct.CSobj* %cs, %struct.CSobj** %cs.addr, align 8
...
entry:
  ...
  %cs.addr = alloca %struct.CSobj*, align 8
  %canary = alloca i32
  store i32 587109935, i32* %canary
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %i = alloca i32, align 4
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %bs_src = alloca %struct.Bitstream*, align 8
...
entry:
  ...
  %bs_dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 1053064009, i32* %canary
  %i = alloca i32, align 4
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
...
entry:
  ...
  %bs_dest = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 581522252, i32* %canary
  %cs.addr = alloca %struct.CSobj*, align 8
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %mc_src = alloca %struct.MotionInfoContexts*, align 8
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
...
entry:
  ...
  %cs.addr = alloca %struct.CSobj*, align 8
  %canary = alloca i32
  store i32 562395438, i32* %canary
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %i = alloca i32, align 4
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
...
entry:
  ...
  %bs_src = alloca %struct.Bitstream*, align 8
  %canary = alloca i32
  store i32 1692032083, i32* %canary
  %i = alloca i32, align 4
  %cs.addr = alloca %struct.CSobj*, align 8
  %mc_dest = alloca %struct.MotionInfoContexts*, align 8
  %currMB = alloca %struct.macroblock*, align 8
...
entry:
  ...
  %currMB = alloca %struct.macroblock*, align 8
  %canary = alloca i32
  store i32 1695793794, i32* %canary
  %ee_src = alloca %struct.EncodingEnvironment*, align 8
  %cs.addr = alloca %struct.CSobj*, align 8
  %tc_src = alloca %struct.TextureInfoContexts*, align 8
  %i = alloca i32, align 4
