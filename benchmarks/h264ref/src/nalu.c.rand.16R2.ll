...
entry:
  ...
  %canary = alloca i32
  store i32 1975608320, i32* %canary
...
entry:
  ...
  %nalu.addr = alloca %struct.NALU_t*, align 8
  %canary = alloca i32
  store i32 730326077, i32* %canary
  %UseAnnexbLongStartcode.addr = alloca i32, align 4
  store i8* %rbsp, i8** %rbsp.addr, align 8
  store %struct.NALU_t* %nalu, %struct.NALU_t** %nalu.addr, align 8
  store i32 %rbsp_size, i32* %rbsp_size.addr, align 4
...
entry:
  ...
  %nal_reference_idc.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 270185034, i32* %canary
  %rbsp.addr = alloca i8*, align 8
  %min_num_bytes.addr = alloca i32, align 4
  %nal_unit_type.addr = alloca i32, align 4
  %UseAnnexbLongStartcode.addr = alloca i32, align 4
...
entry:
  ...
  %nalu.addr = alloca %struct.NALU_t*, align 8
  %canary = alloca i32
  store i32 1668720321, i32* %canary
  %rbsp.addr = alloca i8*, align 8
  %nal_unit_type.addr = alloca i32, align 4
  store i8* %rbsp, i8** %rbsp.addr, align 8
  store %struct.NALU_t* %nalu, %struct.NALU_t** %nalu.addr, align 8
...
entry:
  ...
  %len = alloca i32, align 4
  %canary = alloca i32
  store i32 1675947760, i32* %canary
  %nal_unit_type.addr = alloca i32, align 4
  %rbsp.addr = alloca i8*, align 8
  store i8* %rbsp, i8** %rbsp.addr, align 8
  store %struct.NALU_t* %nalu, %struct.NALU_t** %nalu.addr, align 8
...
entry:
  ...
  %min_num_bytes.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1864315364, i32* %canary
  %nal_reference_idc.addr = alloca i32, align 4
  %nalu.addr = alloca %struct.NALU_t*, align 8
  store i8* %rbsp, i8** %rbsp.addr, align 8
  store %struct.NALU_t* %nalu, %struct.NALU_t** %nalu.addr, align 8
...
entry:
  ...
  %nal_unit_type.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1621890437, i32* %canary
  %min_num_bytes.addr = alloca i32, align 4
  %nal_reference_idc.addr = alloca i32, align 4
  %len = alloca i32, align 4
  %nalu.addr = alloca %struct.NALU_t*, align 8
...
entry:
  ...
  %rbsp_size.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1534219494, i32* %canary
  %len = alloca i32, align 4
  %min_num_bytes.addr = alloca i32, align 4
  %rbsp.addr = alloca i8*, align 8
  %nalu.addr = alloca %struct.NALU_t*, align 8
...
entry:
  ...
  %rbsp.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 235101271, i32* %canary
  %rbsp_size.addr = alloca i32, align 4
  %nal_unit_type.addr = alloca i32, align 4
  %UseAnnexbLongStartcode.addr = alloca i32, align 4
  %nalu.addr = alloca %struct.NALU_t*, align 8
...
entry:
  ...
  %nalu.addr = alloca %struct.NALU_t*, align 8
  %canary = alloca i32
  store i32 141702089, i32* %canary
  %len = alloca i32, align 4
  %rbsp_size.addr = alloca i32, align 4
  %min_num_bytes.addr = alloca i32, align 4
  %UseAnnexbLongStartcode.addr = alloca i32, align 4
...
entry:
  ...
  %UseAnnexbLongStartcode.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1646553453, i32* %canary
  %len = alloca i32, align 4
  store i8* %rbsp, i8** %rbsp.addr, align 8
  store %struct.NALU_t* %nalu, %struct.NALU_t** %nalu.addr, align 8
  store i32 %rbsp_size, i32* %rbsp_size.addr, align 4
...
entry:
  %nal_reference_idc.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1437513826, i32* %canary
  %min_num_bytes.addr = alloca i32, align 4
  %rbsp.addr = alloca i8*, align 8
  %UseAnnexbLongStartcode.addr = alloca i32, align 4
  %nalu.addr = alloca %struct.NALU_t*, align 8
...
entry:
  ...
  %nal_reference_idc.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2134844099, i32* %canary
  %UseAnnexbLongStartcode.addr = alloca i32, align 4
  %rbsp_size.addr = alloca i32, align 4
  %min_num_bytes.addr = alloca i32, align 4
  %rbsp.addr = alloca i8*, align 8
...
entry:
  %nal_reference_idc.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 640356463, i32* %canary
  %rbsp.addr = alloca i8*, align 8
  %nal_unit_type.addr = alloca i32, align 4
  %UseAnnexbLongStartcode.addr = alloca i32, align 4
  %min_num_bytes.addr = alloca i32, align 4
...
entry:
  ...
  %nalu.addr = alloca %struct.NALU_t*, align 8
  %canary = alloca i32
  store i32 134836141, i32* %canary
  %min_num_bytes.addr = alloca i32, align 4
  %rbsp_size.addr = alloca i32, align 4
  store i8* %rbsp, i8** %rbsp.addr, align 8
  store %struct.NALU_t* %nalu, %struct.NALU_t** %nalu.addr, align 8
...
entry:
  ...
  %rbsp_size.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1866046111, i32* %canary
  %nal_reference_idc.addr = alloca i32, align 4
  %len = alloca i32, align 4
  %UseAnnexbLongStartcode.addr = alloca i32, align 4
  %min_num_bytes.addr = alloca i32, align 4
