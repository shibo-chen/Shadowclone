; ModuleID = 'loopFilter.c.rand.4P2.bc'
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_DeblockFrame.7, label %ctrl0

func_DeblockFrame.7:                              ; preds = %rand_bb
  call void @DeblockFrame.7(%struct.ImageParameters* %img, i16** %imgY, i16*** %imgUV)
  ret void

func_DeblockFrame.9:                              ; preds = %ctrl0
  call void @DeblockFrame.9(%struct.ImageParameters* %img, i16** %imgY, i16*** %imgUV)
  ret void

func_DeblockFrame.12:                             ; preds = %ctrl1
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_DeblockFrame.9, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_DeblockFrame.12, label %func_DeblockFrame.13
}
...
func_DeblockMb.4:                                 ; preds = %ctrl0
  call void @DeblockMb.4(%struct.ImageParameters* %img, i16** %imgY, i16*** %imgUV, i32 %MbQAddr)
  ret void

func_DeblockMb.5:                                 ; preds = %ctrl1
  call void @DeblockMb.5(%struct.ImageParameters* %img, i16** %imgY, i16*** %imgUV, i32 %MbQAddr)
  ret void

func_DeblockMb.8:                                 ; preds = %ctrl1
  call void @DeblockMb.8(%struct.ImageParameters* %img, i16** %imgY, i16*** %imgUV, i32 %MbQAddr)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_DeblockMb.4, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_DeblockMb.5, label %func_DeblockMb.8
}
...
func_GetStrength.10:                              ; preds = %ctrl0
...
func_GetStrength.14:                              ; preds = %ctrl1
  call void @GetStrength.14(i8* %Strength, %struct.ImageParameters* %img, i32 %MbQAddr, i32 %dir, i32 %edge, i32 %mvlimit)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_GetStrength.10, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_GetStrength.11, label %func_GetStrength.14
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_EdgeLoop.3, label %ctrl0

func_EdgeLoop.3:                                  ; preds = %rand_bb
  call void @EdgeLoop.3(i16** %Img, i8* %Strength, %struct.ImageParameters* %img, i32 %MbQAddr, i32 %AlphaC0Offset, i32 %BetaOffset, i32 %dir, i32 %edge, i32 %width, i32 %yuv, i32 %uv)
  ret void

func_EdgeLoop.6:                                  ; preds = %ctrl0
  call void @EdgeLoop.6(i16** %Img, i8* %Strength, %struct.ImageParameters* %img, i32 %MbQAddr, i32 %AlphaC0Offset, i32 %BetaOffset, i32 %dir, i32 %edge, i32 %width, i32 %yuv, i32 %uv)
  ret void

func_EdgeLoop.15:                                 ; preds = %ctrl1
  call void @EdgeLoop.15(i16** %Img, i8* %Strength, %struct.ImageParameters* %img, i32 %MbQAddr, i32 %AlphaC0Offset, i32 %BetaOffset, i32 %dir, i32 %edge, i32 %width, i32 %yuv, i32 %uv)
  ret void

func_EdgeLoop.16:                                 ; preds = %ctrl1
  call void @EdgeLoop.16(i16** %Img, i8* %Strength, %struct.ImageParameters* %img, i32 %MbQAddr, i32 %AlphaC0Offset, i32 %BetaOffset, i32 %dir, i32 %edge, i32 %width, i32 %yuv, i32 %uv)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_EdgeLoop.6, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_EdgeLoop.15, label %func_EdgeLoop.16
}
...
entry:
  ...
  %canary = alloca i32
  store i32 606967244, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 581636165, i32* %canary
  %MbQAddr.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @EdgeLoop.3(i16** %Img, i8* %Strength, %struct.ImageParameters* %img, i32 %MbQAddr, i32 %AlphaC0Offset, i32 %BetaOffset, i32 %dir, i32 %edge, i32 %width, i32 %yuv, i32 %uv) #0 {
entry:
  ...
  %yQ = alloca i32, align 4
  %canary = alloca i32
  store i32 1983164250, i32* %canary
...
for.end:                                          ; preds = %for.cond
  ...
  %348 = icmp eq i32 %347, 1983164250
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @DeblockMb.4(%struct.ImageParameters* %img, i16** %imgY, i16*** %imgUV, i32 %MbQAddr) #0 {
entry:
  %edge_cr = alloca i32, align 4
  %StrengthSum = alloca i32, align 4
  %mb_y = alloca i32, align 4
  ...
  %MbQAddr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 235606053, i32* %canary
  %imgY.addr = alloca i16**, align 8
  %Strength = alloca [16 x i8], align 16
  %filterNon8x8LumaEdgesFlag = alloca [4 x i32], align 16
  %imgUV.addr = alloca i16***, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @DeblockMb.5(%struct.ImageParameters* %img, i16** %imgY, i16*** %imgUV, i32 %MbQAddr) #0 {
entry:
  %imgY.addr = alloca i16**, align 8
  %i = alloca i32, align 4
  %dir = alloca i32, align 4
  %img.addr = alloca %struct.ImageParameters*, align 8
  %canary = alloca i32
  store i32 940849648, i32* %canary
  %imgUV.addr = alloca i16***, align 8
  %filterNon8x8LumaEdgesFlag = alloca [4 x i32], align 16
  %StrengthSum = alloca i32, align 4
  %MbQAddr.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @EdgeLoop.6(i16** %Img, i8* %Strength, %struct.ImageParameters* %img, i32 %MbQAddr, i32 %AlphaC0Offset, i32 %BetaOffset, i32 %dir, i32 %edge, i32 %width, i32 %yuv, i32 %uv) #0 {
entry:
  %Strng = alloca i32, align 4
  %Img.addr = alloca i16**, align 8
  %SrcPtrQ = alloca i16*, align 8
  ...
  %R0 = alloca i32, align 4
  %canary = alloca i32
  store i32 739592267, i32* %canary
  %incQ = alloca i32, align 4
  %L3 = alloca i32, align 4
  %xQ = alloca i32, align 4
  %indexA = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @DeblockFrame.7(%struct.ImageParameters* %img, i16** %imgY, i16*** %imgUV) #0 {
entry:
  %canary = alloca i32
  store i32 1407094130, i32* %canary
  %imgUV.addr = alloca i16***, align 8
  %img.addr = alloca %struct.ImageParameters*, align 8
  %imgY.addr = alloca i16**, align 8
  %i = alloca i32, align 4
...
entry:
  ...
  %StrengthSum = alloca i32, align 4
  %canary = alloca i32
  store i32 1076929329, i32* %canary
  %edge = alloca i32, align 4
  %filterLeftMbEdgeFlag = alloca i32, align 4
  %imgUV.addr = alloca i16***, align 8
  %dir = alloca i32, align 4
...
return:                                           ; preds = %for.end152, %if.then25
  %160 = load i32, i32* %canary
  %161 = icmp eq i32 %160, 1076929329
  br i1 %161, label %162, label %func_exit
...
entry:
  ...
  %imgUV.addr = alloca i16***, align 8
  %canary = alloca i32
  store i32 751525411, i32* %canary
  %img.addr = alloca %struct.ImageParameters*, align 8
  %imgY.addr = alloca i16**, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store i16** %imgY, i16*** %imgY.addr, align 8
...
entry:
  ...
  %xP = alloca i32, align 4
  %canary = alloca i32
  store i32 679222863, i32* %canary
  %MbQAddr.addr = alloca i32, align 4
  %list1_mv = alloca i16***, align 8
  %blk_x2 = alloca i32, align 4
  %idx = alloca i32, align 4
...
entry:
  ...
  %MbQ = alloca %struct.macroblock*, align 8
  %canary = alloca i32
  store i32 764464802, i32* %canary
  %list1_refIdxArr = alloca i16**, align 8
  %list0_refPicIdArr = alloca i64**, align 8
  %blkQ = alloca i32, align 4
  %MbP = alloca %struct.macroblock*, align 8
...
entry:
  %canary = alloca i32
  store i32 674279549, i32* %canary
  %i = alloca i32, align 4
  %imgY.addr = alloca i16**, align 8
  %img.addr = alloca %struct.ImageParameters*, align 8
  %imgUV.addr = alloca i16***, align 8
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1533235499, i32* %canary
  %imgY.addr = alloca i16**, align 8
  store %struct.ImageParameters* %img, %struct.ImageParameters** %img.addr, align 8
  store i16** %imgY, i16*** %imgY.addr, align 8
  store i16*** %imgUV, i16**** %imgUV.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @GetStrength.14(i8* %Strength, %struct.ImageParameters* %img, i32 %MbQAddr, i32 %dir, i32 %edge, i32 %mvlimit) #0 {
entry:
  %blk_y = alloca i32, align 4
  %list1_mv = alloca i16***, align 8
  %yP = alloca i32, align 4
  ...
  %pixP = alloca %struct.pix_pos, align 4
  %canary = alloca i32
  store i32 462588886, i32* %canary
  %blk_y2 = alloca i32, align 4
  %edge.addr = alloca i32, align 4
  %ref_q1 = alloca i64, align 8
  %img.addr = alloca %struct.ImageParameters*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @EdgeLoop.15(i16** %Img, i8* %Strength, %struct.ImageParameters* %img, i32 %MbQAddr, i32 %AlphaC0Offset, i32 %BetaOffset, i32 %dir, i32 %edge, i32 %width, i32 %yuv, i32 %uv) #0 {
entry:
  %StrengthIdx = alloca i32, align 4
  %QP = alloca i32, align 4
  %SrcPtrQ = alloca i16*, align 8
  ...
  %Img.addr = alloca i16**, align 8
  %canary = alloca i32
  store i32 1536504013, i32* %canary
  %R2 = alloca i32, align 4
  %RL0 = alloca i32, align 4
  %xQ = alloca i32, align 4
  %R0 = alloca i32, align 4
...
for.end:                                          ; preds = %for.cond
  %347 = load i32, i32* %canary
  %348 = icmp eq i32 %347, 1536504013
  br i1 %348, label %349, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @EdgeLoop.16(i16** %Img, i8* %Strength, %struct.ImageParameters* %img, i32 %MbQAddr, i32 %AlphaC0Offset, i32 %BetaOffset, i32 %dir, i32 %edge, i32 %width, i32 %yuv, i32 %uv) #0 {
entry:
  %QP = alloca i32, align 4
  %indexA = alloca i32, align 4
  %pelnum_cr = alloca [2 x [4 x i32]], align 16
  ...
  %SrcPtrP = alloca i16*, align 8
  %canary = alloca i32
  store i32 122166986, i32* %canary
  %L3 = alloca i32, align 4
  %pel = alloca i32, align 4
  %yuv.addr = alloca i32, align 4
  %ClipTab = alloca i8*, align 8
