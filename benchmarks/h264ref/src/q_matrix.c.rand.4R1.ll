; ModuleID = 'q_matrix.c.rand.4R1.bc'
...
func_CheckParameterName.8:                        ; preds = %ctrl1
  %4 = call i32 @CheckParameterName.8(i8* %s, i32* %type)
  ret i32 %4

func_CheckParameterName.10:                       ; preds = %ctrl1
  %5 = call i32 @CheckParameterName.10(i8* %s, i32* %type)
  ret i32 %5
...
ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_CheckParameterName.8, label %func_CheckParameterName.10
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_ParseMatrix.5, label %ctrl0

func_ParseMatrix.5:                               ; preds = %rand_bb
  call void @ParseMatrix.5(i8* %buf, i32 %bufsize)
  ret void

func_ParseMatrix.11:                              ; preds = %ctrl0
  call void @ParseMatrix.11(i8* %buf, i32 %bufsize)
  ret void

func_ParseMatrix.12:                              ; preds = %ctrl1
  call void @ParseMatrix.12(i8* %buf, i32 %bufsize)
  ret void

func_ParseMatrix.19:                              ; preds = %ctrl1
  call void @ParseMatrix.19(i8* %buf, i32 %bufsize)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_ParseMatrix.11, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_ParseMatrix.12, label %func_ParseMatrix.19
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_PatchMatrix.7, label %ctrl0

func_PatchMatrix.7:                               ; preds = %rand_bb
  call void @PatchMatrix.7()
  ret void

func_PatchMatrix.16:                              ; preds = %ctrl0
  call void @PatchMatrix.16()
  ret void

func_PatchMatrix.18:                              ; preds = %ctrl1
  call void @PatchMatrix.18()
  ret void

func_PatchMatrix.20:                              ; preds = %ctrl1
  call void @PatchMatrix.20()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_PatchMatrix.16, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_PatchMatrix.18, label %func_PatchMatrix.20
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_CalculateQuantParam.2, label %ctrl0

func_CalculateQuantParam.2:                       ; preds = %rand_bb
  call void @CalculateQuantParam.2()
  ret void
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_CalculateQuant8Param.1, label %ctrl0

func_CalculateQuant8Param.1:                      ; preds = %rand_bb
  call void @CalculateQuant8Param.1()
  ret void

func_CalculateQuant8Param.6:                      ; preds = %ctrl0
  call void @CalculateQuant8Param.6()
  ret void

func_CalculateQuant8Param.9:                      ; preds = %ctrl1
  call void @CalculateQuant8Param.9()
  ret void

func_CalculateQuant8Param.14:                     ; preds = %ctrl1
  call void @CalculateQuant8Param.14()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_CalculateQuant8Param.6, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_CalculateQuant8Param.9, label %func_CalculateQuant8Param.14
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @CalculateQuant8Param.1() #0 {
entry:
  %k = alloca i32, align 4
  %j = alloca i32, align 4
  %temp = alloca i32, align 4
  %canary = alloca i32
  store i32 79560587, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @CalculateQuantParam.2() #0 {
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1408716725, i32* %canary
  %no_q_matrix = alloca i32, align 4
  %temp = alloca i32, align 4
  store i32 0, i32* %no_q_matrix, align 4
  %0 = load %struct.seq_parameter_set_rbsp_t*, %struct.seq_parameter_set_rbsp_t** @active_sps, align 8
...
if.end682:                                        ; preds = %for.end681, %for.end200
  ...
  %360 = icmp eq i32 %359, 1408716725
...
entry:
  ...
  %canary = alloca i32
  store i32 1759047171, i32* %canary
  %i = alloca i32, align 4
...
entry:
  %s.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 305462906, i32* %canary
  %i = alloca i32, align 4
  %retval = alloca i32, align 4
  %type.addr = alloca i32*, align 8
  store i8* %s, i8** %s.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @ParseMatrix.5(i8* %buf, i32 %bufsize) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 1301254920, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 442140885, i32* %canary
  %no_q_matrix = alloca i32, align 4
  %k = alloca i32, align 4
  %j = alloca i32, align 4
  %present = alloca [2 x i32], align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @PatchMatrix.7() #0 {
entry:
  %ScalingList = alloca i16*, align 8
  %cnt = alloca i32, align 4
  %fail = alloca i32, align 4
  %canary = alloca i32
  store i32 1453627114, i32* %canary
  %i = alloca i32, align 4
  store i32 0, i32* %i, align 4
  br label %for.cond
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @CheckParameterName.8(i8* %s, i32* %type) #0 {
entry:
  %s.addr = alloca i8*, align 8
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1414286221, i32* %canary
  %type.addr = alloca i32*, align 8
  %retval = alloca i32, align 4
  store i8* %s, i8** %s.addr, align 8
  store i32* %type, i32** %type.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @CalculateQuant8Param.9() #0 {
entry:
  %present = alloca [2 x i32], align 4
  %temp = alloca i32, align 4
  %i = alloca i32, align 4
  ...
  %no_q_matrix = alloca i32, align 4
  %canary = alloca i32
  store i32 772345605, i32* %canary
  %j = alloca i32, align 4
  store i32 0, i32* %no_q_matrix, align 4
  %0 = load %struct.seq_parameter_set_rbsp_t*, %struct.seq_parameter_set_rbsp_t** @active_sps, align 8
  %seq_scaling_matrix_present_flag = getelementptr inbounds %struct.seq_parameter_set_rbsp_t, %struct.seq_parameter_set_rbsp_t* %0, i32 0, i32 9
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @CheckParameterName.10(i8* %s, i32* %type) #0 {
entry:
  %s.addr = alloca i8*, align 8
  %type.addr = alloca i32*, align 8
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1816065384, i32* %canary
  %i = alloca i32, align 4
  store i8* %s, i8** %s.addr, align 8
  store i32* %type, i32** %type.addr, align 8
  store i32 0, i32* %i, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @ParseMatrix.11(i8* %buf, i32 %bufsize) #0 {
entry:
  %type = alloca i32, align 4
  %InString = alloca i32, align 4
  %MapIdx = alloca i32, align 4
  ...
  %items = alloca [1000 x i8*], align 16
  %canary = alloca i32
  store i32 1103405220, i32* %canary
  %bufend = alloca i8*, align 8
  %p = alloca i8*, align 8
  %item = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @ParseMatrix.12(i8* %buf, i32 %bufsize) #0 {
entry:
  %type = alloca i32, align 4
  %canary = alloca i32
  store i32 2075256120, i32* %canary
  %p = alloca i8*, align 8
  %range = alloca i32, align 4
  %j = alloca i32, align 4
  %ScalingList = alloca i16*, align 8
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 645930976, i32* %canary
  %temp = alloca i32, align 4
  %j = alloca i32, align 4
  store i32 0, i32* %no_q_matrix, align 4
  %0 = load %struct.seq_parameter_set_rbsp_t*, %struct.seq_parameter_set_rbsp_t** @active_sps, align 8
...
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 2022082484, i32* %canary
  %k = alloca i32, align 4
  %j = alloca i32, align 4
  %no_q_matrix = alloca i32, align 4
  %present = alloca [2 x i32], align 4
...
if.end257:                                        ; preds = %for.end256, %for.end91
  %141 = load i32, i32* %canary
  %142 = icmp eq i32 %141, 2022082484
  br i1 %142, label %143, label %func_exit
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1757052548, i32* %canary
  %no_q_matrix = alloca i32, align 4
  %temp = alloca i32, align 4
  %k = alloca i32, align 4
  %present = alloca [6 x i32], align 16
...
if.end682:                                        ; preds = %for.end681, %for.end200
  %359 = load i32, i32* %canary
  %360 = icmp eq i32 %359, 1757052548
  br i1 %360, label %361, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @PatchMatrix.16() #0 {
entry:
  %i = alloca i32, align 4
  %cnt = alloca i32, align 4
  %ScalingList = alloca i16*, align 8
  %canary = alloca i32
  store i32 1627196072, i32* %canary
  %fail = alloca i32, align 4
  store i32 0, i32* %i, align 4
  br label %for.cond
...
entry:
  ...
  %cnt = alloca i32, align 4
  %canary = alloca i32
  store i32 834649712, i32* %canary
  %ScalingList = alloca i16*, align 8
  store i32 0, i32* %i, align 4
  br label %for.cond
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @ParseMatrix.19(i8* %buf, i32 %bufsize) #0 {
entry:
  %MapIdx = alloca i32, align 4
  %InItem = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  ...
  %items = alloca [1000 x i8*], align 16
  %canary = alloca i32
  store i32 1494024563, i32* %canary
  %type = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %bufsize, i32* %bufsize.addr, align 4
  store i32 0, i32* %item, align 4
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1676060120, i32* %canary
  %ScalingList = alloca i16*, align 8
  store i32 0, i32* %i, align 4
  br label %for.cond
