; ModuleID = 'leaky_bucket.c.rand.4R2.bc'
...
func_get_LeakyBucketRate.11:                      ; preds = %ctrl1
  %4 = call i32 @get_LeakyBucketRate.11(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret i32 %4

func_get_LeakyBucketRate.17:                      ; preds = %ctrl1
  %5 = call i32 @get_LeakyBucketRate.17(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_get_LeakyBucketRate.9, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_get_LeakyBucketRate.11, label %func_get_LeakyBucketRate.17
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_PutBigDoubleWord.1, label %func_PutBigDoubleWord.4
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_write_buffer.16, label %func_write_buffer.18
}
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_Sort.5, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_Sort.8, label %func_Sort.10
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_calc_buffer.6, label %ctrl0

func_calc_buffer.6:                               ; preds = %rand_bb
  call void @calc_buffer.6()
  ret void

func_calc_buffer.12:                              ; preds = %ctrl0
  call void @calc_buffer.12()
  ret void

func_calc_buffer.13:                              ; preds = %ctrl1
  call void @calc_buffer.13()
  ret void

func_calc_buffer.15:                              ; preds = %ctrl1
  call void @calc_buffer.15()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_calc_buffer.12, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_calc_buffer.13, label %func_calc_buffer.15
}
...
entry:
  ...
  %canary = alloca i32
  store i32 700738910, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1423257403, i32* %canary
...
entry:
  ...
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 241033956, i32* %canary
  %i = alloca i64, align 8
  %Rmin.addr = alloca i64*, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 361134035, i32* %canary
  %dw.addr = alloca i64, align 8
  %fp.addr = alloca %struct._IO_FILE*, align 8
  store i64 %dw, i64* %dw.addr, align 8
  store %struct._IO_FILE* %fp, %struct._IO_FILE** %fp.addr, align 8
...
entry:
  ...
  %Rmin.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 1832525870, i32* %canary
  %j = alloca i64, align 8
  %temp = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
...
entry:
  ...
  %canary = alloca i32
  store i32 386875741, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1996750316, i32* %canary
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %Rmin.addr = alloca i64*, align 8
  %iBucket = alloca i64, align 8
...
entry:
  %Rmin.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 711140991, i32* %canary
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %j = alloca i64, align 8
  %temp = alloca i64, align 8
  %i = alloca i64, align 8
...
entry:
  ...
  %buf = alloca i64, align 8
  %canary = alloca i32
  store i32 995003272, i32* %canary
  %i = alloca i64, align 8
  %retval = alloca i32, align 4
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 640306204, i32* %canary
  %j = alloca i64, align 8
  %Rmin.addr = alloca i64*, align 8
  %temp = alloca i64, align 8
  %i = alloca i64, align 8
...
entry:
  ...
  %buf = alloca i64, align 8
  %canary = alloca i32
  store i32 1222867707, i32* %canary
  %NumberLeakyBuckets.addr = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
entry:
  ...
  %iBucket = alloca i64, align 8
  %canary = alloca i32
  store i32 1772259004, i32* %canary
  %Bmin = alloca i64*, align 8
  %minB = alloca i64, align 8
  %Rmin = alloca i64*, align 8
  %actualBuffer = alloca i64, align 8
...
for.end136:                                       ; preds = %for.cond57
  ...
  call void @free(i8* %148) #3
  %149 = load i32, i32* %canary
  %150 = icmp eq i32 %149, 1772259004
  br i1 %150, label %151, label %func_exit
...
entry:
  ...
  %buffer_frame = alloca i64*, align 8
  %canary = alloca i32
  store i32 561269950, i32* %canary
  %minB = alloca i64, align 8
  %NumberLeakyBuckets = alloca i64, align 8
  %maxBuffer = alloca i64, align 8
  %iFrame = alloca i64, align 8
...
entry:
  %canary = alloca i32
  store i32 940786226, i32* %canary
  %Bmin.addr = alloca i64*, align 8
  %iBucket = alloca i64, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %outf = alloca %struct._IO_FILE*, align 8
...
entry:
  ...
  %buffer_frame = alloca i64*, align 8
  %canary = alloca i32
  store i32 273188589, i32* %canary
  %Fmin = alloca i64*, align 8
  %iBucket = alloca i64, align 8
  %Bmin = alloca i64*, align 8
  %maxBuffer = alloca i64, align 8
...
entry:
  ...
  %outf = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 1364080528, i32* %canary
  %Fmin.addr = alloca i64*, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
  store i64* %Bmin, i64** %Bmin.addr, align 8
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1553205036, i32* %canary
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %f = alloca %struct._IO_FILE*, align 8
  %Rmin.addr = alloca i64*, align 8
  %i = alloca i64, align 8
...
entry:
  ...
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1652962801, i32* %canary
  %Bmin.addr = alloca i64*, align 8
  %Rmin.addr = alloca i64*, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
