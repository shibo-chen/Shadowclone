...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_PutPel_14.15, label %func_PutPel_14.22
}
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_PutPel_11.11, label %func_PutPel_11.16
}
...
func_FastLine16Y_11.21:                           ; preds = %ctrl0
  %3 = call i16* @FastLine16Y_11.21(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %3

func_FastLine16Y_11.23:                           ; preds = %ctrl1
  %4 = call i16* @FastLine16Y_11.23(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %4

func_FastLine16Y_11.25:                           ; preds = %ctrl1
  %5 = call i16* @FastLine16Y_11.25(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_FastLine16Y_11.21, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_FastLine16Y_11.23, label %func_FastLine16Y_11.25
}
...
func_UMVLine16Y_11.27:                            ; preds = %ctrl0
  %3 = call i16* @UMVLine16Y_11.27(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %3

func_UMVLine16Y_11.31:                            ; preds = %ctrl1
  %4 = call i16* @UMVLine16Y_11.31(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %4

func_UMVLine16Y_11.32:                            ; preds = %ctrl1
  %5 = call i16* @UMVLine16Y_11.32(i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_UMVLine16Y_11.27, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_UMVLine16Y_11.31, label %func_UMVLine16Y_11.32
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_FastLineX.19, label %ctrl0

func_FastLineX.19:                                ; preds = %rand_bb
  %2 = call i16* @FastLineX.19(i32 %dummy, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %2

func_FastLineX.20:                                ; preds = %ctrl0
  %3 = call i16* @FastLineX.20(i32 %dummy, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %3

func_FastLineX.29:                                ; preds = %ctrl1
  %4 = call i16* @FastLineX.29(i32 %dummy, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %4

func_FastLineX.30:                                ; preds = %ctrl1
  %5 = call i16* @FastLineX.30(i32 %dummy, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_FastLineX.20, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_FastLineX.29, label %func_FastLineX.30
}
...
func_UMVLineX.4:                                  ; preds = %ctrl0
  %3 = call i16* @UMVLineX.4(i32 %size, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %3

func_UMVLineX.6:                                  ; preds = %ctrl1
  %4 = call i16* @UMVLineX.6(i32 %size, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %4

func_UMVLineX.17:                                 ; preds = %ctrl1
  %5 = call i16* @UMVLineX.17(i32 %size, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16* %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_UMVLineX.4, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_UMVLineX.6, label %func_UMVLineX.17
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_UMVPelY_14.13, label %ctrl0

func_UMVPelY_14.13:                               ; preds = %rand_bb
  %2 = call i16 @UMVPelY_14.13(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16 %2

func_UMVPelY_14.24:                               ; preds = %ctrl0
  %3 = call i16 @UMVPelY_14.24(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16 %3
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_UMVPelY_14.24, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_UMVPelY_14.26, label %func_UMVPelY_14.28
}
...
func_FastPelY_14.9:                               ; preds = %ctrl1
  %4 = call i16 @FastPelY_14.9(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16 %4

func_FastPelY_14.18:                              ; preds = %ctrl1
  %5 = call i16 @FastPelY_14.18(i16** %Pic, i32 %y, i32 %x, i32 %height, i32 %width)
  ret i16 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_FastPelY_14.7, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_FastPelY_14.9, label %func_FastPelY_14.18
}
...
entry:
  ...
  %canary = alloca i32
  store i32 688892587, i32* %canary
...
entry:
  ...
  %Pic.addr = alloca i16*, align 8
  %canary = alloca i32
  store i32 890409518, i32* %canary
  %val.addr = alloca i16, align 2
  store i16* %Pic, i16** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
  store i32 %x, i32* %x.addr, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 1638186617, i32* %canary
...
entry:
  ...
  %Picy = alloca i16*, align 8
  %canary = alloca i32
  store i32 963542025, i32* %canary
  %width.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
  %height.addr = alloca i32, align 4
  %Pic.addr = alloca i16*, align 8
...
entry:
  ...
  %Pic.addr = alloca i16**, align 8
  %canary = alloca i32
  store i32 1195484137, i32* %canary
  %height.addr = alloca i32, align 4
  %width.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
  store i16** %Pic, i16*** %Pic.addr, align 8
...
entry:
  ...
  %size.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1562148082, i32* %canary
  %height.addr = alloca i32, align 4
  store i32 %size, i32* %size.addr, align 4
  store i16* %Pic, i16** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 382112149, i32* %canary
  %x.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
  %width.addr = alloca i32, align 4
  %Pic.addr = alloca i16**, align 8
...
entry:
  ...
  %maxx = alloca i32, align 4
  %canary = alloca i32
  store i32 556458235, i32* %canary
  %Picy = alloca i16*, align 8
  %width.addr = alloca i32, align 4
  %retval = alloca i16*, align 8
  %Pic.addr = alloca i16*, align 8
...
entry:
  ...
  %width.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1448821738, i32* %canary
  %Pic.addr = alloca i16**, align 8
  store i16** %Pic, i16*** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
  store i32 %x, i32* %x.addr, align 4
...
entry:
  %val.addr = alloca i16, align 2
  %canary = alloca i32
  store i32 984422739, i32* %canary
  %x.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
  %Pic.addr = alloca i16*, align 8
  %width.addr = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1391455512, i32* %canary
  %Pic.addr = alloca i16*, align 8
  %val.addr = alloca i16, align 2
  %y.addr = alloca i32, align 4
  %x.addr = alloca i32, align 4
...
entry:
  ...
  %y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1727486334, i32* %canary
  %x.addr = alloca i32, align 4
  %val.addr = alloca i16, align 2
  store i16** %Pic, i16*** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
...
entry:
  ...
  %y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1491497021, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 718863938, i32* %canary
  %height.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
  %x.addr = alloca i32, align 4
  %width.addr = alloca i32, align 4
...
entry:
  %y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 419177645, i32* %canary
  %val.addr = alloca i16, align 2
  %Pic.addr = alloca i16**, align 8
  %x.addr = alloca i32, align 4
  store i16** %Pic, i16*** %Pic.addr, align 8
...
entry:
  %width.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 323968352, i32* %canary
  %Pic.addr = alloca i16*, align 8
  %y.addr = alloca i32, align 4
  %val.addr = alloca i16, align 2
  %x.addr = alloca i32, align 4
...
entry:
  ...
  %y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1328335299, i32* %canary
  %height.addr = alloca i32, align 4
  %Pic.addr = alloca i16*, align 8
  %x.addr = alloca i32, align 4
  %i = alloca i32, align 4
...
entry:
  %height.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2008688484, i32* %canary
  %y.addr = alloca i32, align 4
  %Pic.addr = alloca i16**, align 8
  %width.addr = alloca i32, align 4
  %x.addr = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1190729277, i32* %canary
  %y.addr = alloca i32, align 4
  %height.addr = alloca i32, align 4
  %Pic.addr = alloca i16*, align 8
  %x.addr = alloca i32, align 4
...
entry:
  %y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 728184459, i32* %canary
  %x.addr = alloca i32, align 4
  %width.addr = alloca i32, align 4
  %dummy.addr = alloca i32, align 4
  %height.addr = alloca i32, align 4
...
entry:
  ...
  %Pic.addr = alloca i16*, align 8
  %canary = alloca i32
  store i32 2081146226, i32* %canary
  %height.addr = alloca i32, align 4
  %x.addr = alloca i32, align 4
  %width.addr = alloca i32, align 4
  store i16* %Pic, i16** %Pic.addr, align 8
...
entry:
  ...
  %Pic.addr = alloca i16**, align 8
  %canary = alloca i32
  store i32 1564877765, i32* %canary
  %val.addr = alloca i16, align 2
  %x.addr = alloca i32, align 4
  store i16** %Pic, i16*** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 692281397, i32* %canary
  %y.addr = alloca i32, align 4
  %height.addr = alloca i32, align 4
  %width.addr = alloca i32, align 4
  %x.addr = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 307647202, i32* %canary
  %y.addr = alloca i32, align 4
  %retval = alloca i16, align 2
  %Pic.addr = alloca i16**, align 8
  %width4 = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1041091914, i32* %canary
  %x.addr = alloca i32, align 4
  %Pic.addr = alloca i16*, align 8
  %width.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
...
entry:
  ...
  %retval = alloca i16, align 2
  %canary = alloca i32
  store i32 2100060374, i32* %canary
  %width4 = alloca i32, align 4
  %height4 = alloca i32, align 4
  %width.addr = alloca i32, align 4
  store i16** %Pic, i16*** %Pic.addr, align 8
...
entry:
  ...
  %Pic.addr = alloca i16**, align 8
  %canary = alloca i32
  store i32 1287440169, i32* %canary
  %retval = alloca i16, align 2
  store i16** %Pic, i16*** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
  store i32 %x, i32* %x.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i16* @FastLineX.29(i32 %dummy, i16* %Pic, i32 %y, i32 %x, i32 %height, i32 %width) #0 {
entry:
  %Pic.addr = alloca i16*, align 8
  %dummy.addr = alloca i32, align 4
  %x.addr = alloca i32, align 4
  ...
  %width.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1330617144, i32* %canary
  %y.addr = alloca i32, align 4
  store i32 %dummy, i32* %dummy.addr, align 4
  store i16* %Pic, i16** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
...
entry:
  ...
  %width.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 369652843, i32* %canary
  %x.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
  %height.addr = alloca i32, align 4
  %dummy.addr = alloca i32, align 4
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 317471279, i32* %canary
  %y.addr = alloca i32, align 4
  %width.addr = alloca i32, align 4
  store i16* %Pic, i16** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
...
entry:
  ...
  %x.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1051979574, i32* %canary
  %Picy = alloca i16*, align 8
  store i16* %Pic, i16** %Pic.addr, align 8
  store i32 %y, i32* %y.addr, align 4
  store i32 %x, i32* %x.addr, align 4
