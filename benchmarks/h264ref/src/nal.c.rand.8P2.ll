...
entry:
  ...
  %canary = alloca i32
  store i32 1117776746, i32* %canary
...
entry:
  ...
  %begin_bytepos.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1991629065, i32* %canary
  %min_num_bytes.addr = alloca i32, align 4
  %streamBuffer.addr = alloca i8*, align 8
  %i = alloca i32, align 4
  store i8* %streamBuffer, i8** %streamBuffer.addr, align 8
...
entry:
  ...
  %begin_bytepos.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1532920401, i32* %canary
  %streamBuffer.addr = alloca i8*, align 8
  %end_bytepos.addr = alloca i32, align 4
  %i = alloca i32, align 4
  store i8* %streamBuffer, i8** %streamBuffer.addr, align 8
...
entry:
  ...
  %streamBuffer.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 903901763, i32* %canary
  %count = alloca i32, align 4
  store i8* %streamBuffer, i8** %streamBuffer.addr, align 8
  store i32 %begin_bytepos, i32* %begin_bytepos.addr, align 4
  store i32 %end_bytepos, i32* %end_bytepos.addr, align 4
...
entry:
  ...
  %min_num_bytes.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1978270400, i32* %canary
  %count = alloca i32, align 4
  %streamBuffer.addr = alloca i8*, align 8
  %j = alloca i32, align 4
  store i8* %streamBuffer, i8** %streamBuffer.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 987745743, i32* %canary
  %begin_bytepos.addr = alloca i32, align 4
  %min_num_bytes.addr = alloca i32, align 4
  %count = alloca i32, align 4
  %j = alloca i32, align 4
...
entry:
  ...
  %count = alloca i32, align 4
  %canary = alloca i32
  store i32 631096000, i32* %canary
  %min_num_bytes.addr = alloca i32, align 4
  %streamBuffer.addr = alloca i8*, align 8
  %end_bytepos.addr = alloca i32, align 4
  %j = alloca i32, align 4
...
entry:
  ...
  %begin_bytepos.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1772371771, i32* %canary
  %count = alloca i32, align 4
  %end_bytepos.addr = alloca i32, align 4
  %streamBuffer.addr = alloca i8*, align 8
  %j = alloca i32, align 4
