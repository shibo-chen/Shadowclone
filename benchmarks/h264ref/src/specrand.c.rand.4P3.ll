; ModuleID = 'specrand.c.rand.4P3.bc'
...
entry:
  %canary = alloca i32
  store i32 133347598, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1555494401, i32* %canary
  %lo = alloca i32, align 4
  %hi = alloca i32, align 4
  %test = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
...
entry:
  %canary = alloca i32
  store i32 1288012586, i32* %canary
  %lo = alloca i32, align 4
  %test = alloca i32, align 4
  %hi = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
...
entry:
  ...
  %test = alloca i32, align 4
  %canary = alloca i32
  store i32 710980286, i32* %canary
  %lo = alloca i32, align 4
  %0 = load i32, i32* @seedi, align 4
  %conv = sext i32 %0 to i64
  %div = sdiv i64 %conv, 127773
