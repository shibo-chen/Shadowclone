; ModuleID = 'filehandle.c.rand.8P1.bc'
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_error.1, label %func_error.3

func_error.1:                                     ; preds = %rand_bb
  call void @error.1(i8* %text, i32 %code)
  ret void

func_error.3:                                     ; preds = %rand_bb
  call void @error.3(i8* %text, i32 %code)
  ret void
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_write_PPS.4, label %ctrl0

func_write_PPS.4:                                 ; preds = %rand_bb
  %2 = call i32 @write_PPS.4(i32 %len, i32 %PPS_id)
  ret i32 %2
...
func_write_PPS.9:                                 ; preds = %ctrl3
  %6 = call i32 @write_PPS.9(i32 %len, i32 %PPS_id)
  ret i32 %6

func_write_PPS.10:                                ; preds = %ctrl3
  %7 = call i32 @write_PPS.10(i32 %len, i32 %PPS_id)
  ret i32 %7
...
ctrl3:                                            ; preds = %ctrl2
  %11 = icmp eq i32 %0, 4
  br i1 %11, label %func_write_PPS.9, label %func_write_PPS.10
}
...
func_start_sequence.7:                            ; preds = %ctrl0
  %3 = call i32 @start_sequence.7()
  ret i32 %3

func_start_sequence.11:                           ; preds = %ctrl1
  %4 = call i32 @start_sequence.11()
  ret i32 %4
...
func_start_sequence.16:                           ; preds = %ctrl5
  %9 = call i32 @start_sequence.16()
  ret i32 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_start_sequence.7, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_start_sequence.11, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_start_sequence.12, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_start_sequence.13, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_start_sequence.14, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_start_sequence.15, label %func_start_sequence.16
}
...
entry:
  ...
  %canary = alloca i32
  store i32 1614594243, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 165828678, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @error.3(i8* %text, i32 %code) #0 {
entry:
  %code.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 498069285, i32* %canary
  %text.addr = alloca i8*, align 8
  store i8* %text, i8** %text.addr, align 8
  store i32 %code, i32* %code.addr, align 4
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @write_PPS.4(i32 %len, i32 %PPS_id) #0 {
entry:
  %canary = alloca i32
  store i32 33481636, i32* %canary
...
entry:
  %PPS_id.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1447738589, i32* %canary
  %nalu = alloca %struct.NALU_t*, align 8
  %len.addr = alloca i32, align 4
  store i32 %len, i32* %len.addr, align 4
  store i32 %PPS_id, i32* %PPS_id.addr, align 4
...
entry:
  ...
  %len.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1729311191, i32* %canary
  %nalu = alloca %struct.NALU_t*, align 8
  store i32 %len, i32* %len.addr, align 4
  store i32 %PPS_id, i32* %PPS_id.addr, align 4
  store %struct.NALU_t* null, %struct.NALU_t** %nalu, align 8
...
entry:
  %canary = alloca i32
  store i32 856242956, i32* %canary
  %total_pps = alloca i32, align 4
  %len = alloca i32, align 4
  %nalu = alloca %struct.NALU_t*, align 8
  %retval = alloca i32, align 4
...
entry:
  ...
  %PPS_id.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1513735001, i32* %canary
  %len.addr = alloca i32, align 4
  store i32 %len, i32* %len.addr, align 4
  store i32 %PPS_id, i32* %PPS_id.addr, align 4
  store %struct.NALU_t* null, %struct.NALU_t** %nalu, align 8
...
entry:
  %canary = alloca i32
  store i32 348226253, i32* %canary
  %len.addr = alloca i32, align 4
  %nalu = alloca %struct.NALU_t*, align 8
  %PPS_id.addr = alloca i32, align 4
  store i32 %len, i32* %len.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 2125198295, i32* %canary
  %nalu = alloca %struct.NALU_t*, align 8
  %len.addr = alloca i32, align 4
  %PPS_id.addr = alloca i32, align 4
  store i32 %len, i32* %len.addr, align 4
...
entry:
  ...
  %total_pps = alloca i32, align 4
  %canary = alloca i32
  store i32 587502996, i32* %canary
  %len = alloca i32, align 4
  store i32 0, i32* %len, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %GenerateMultiplePPS = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 15
...
entry:
  %canary = alloca i32
  store i32 918140827, i32* %canary
  %len = alloca i32, align 4
  %i = alloca i32, align 4
  %nalu = alloca %struct.NALU_t*, align 8
  %retval = alloca i32, align 4
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 408519388, i32* %canary
  %len = alloca i32, align 4
  %i = alloca i32, align 4
  %total_pps = alloca i32, align 4
  store i32 0, i32* %len, align 4
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 749235316, i32* %canary
  %nalu = alloca %struct.NALU_t*, align 8
  %len = alloca i32, align 4
  %i = alloca i32, align 4
  store i32 0, i32* %len, align 4
...
entry:
  ...
  %total_pps = alloca i32, align 4
  %canary = alloca i32
  store i32 331601953, i32* %canary
  %i = alloca i32, align 4
  %nalu = alloca %struct.NALU_t*, align 8
  %len = alloca i32, align 4
  store i32 0, i32* %len, align 4
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 215327526, i32* %canary
  %nalu = alloca %struct.NALU_t*, align 8
  %len = alloca i32, align 4
  %total_pps = alloca i32, align 4
  store i32 0, i32* %len, align 4
