...
.LBB1_4:                                # %func_picture_coding_decision.8
	...
	.cfi_def_cfa %rsp, 8
	retq
.LBB1_5:                                # %func_picture_coding_decision.11
	.cfi_def_cfa %rbp, 16
	movq	%rbx, %rdi
	movq	%r15, %rsi
	movl	%r14d, %edx
...
# %bb.0:                                # %entry
	...
	subq	$72, %rsp
	.cfi_offset %rbx, -24
	movl	$1874257222, -36(%rbp)  # imm = 0x6FB6E546
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movl	%edx, -12(%rbp)
	movq	img, %rax
...
.LBB2_5:                                # %if.end
	...
	movl	%eax, %ebx
	cmpl	$1874257222, -36(%rbp)  # imm = 0x6FB6E546
	jne	.LBB2_7
.LBB2_6:
	movl	%ebx, %eax
	addq	$72, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$520907552, -24(%rbp)   # imm = 0x1F0C6B20
	vmovsd	%xmm0, -56(%rbp)
	vmovsd	%xmm1, -40(%rbp)
	movl	%edi, -20(%rbp)
	movl	%esi, -16(%rbp)
...
.LBB3_5:                                # %return
	movl	-12(%rbp), %ebx
	cmpl	$520907552, -24(%rbp)   # imm = 0x1F0C6B20
	jne	.LBB3_7
.LBB3_6:
	movl	%ebx, %eax
	addq	$56, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$1801713923, -24(%rbp)  # imm = 0x6B63F903
	vmovsd	%xmm0, -56(%rbp)
	vmovsd	%xmm1, -32(%rbp)
	movl	%edi, -16(%rbp)
	movl	%esi, -20(%rbp)
...
.LBB4_5:                                # %return
	movl	-12(%rbp), %ebx
	cmpl	$1801713923, -24(%rbp)  # imm = 0x6B63F903
	jne	.LBB4_7
.LBB4_6:
	movl	%ebx, %eax
	addq	$56, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$72, %rsp
	.cfi_offset %rbx, -24
	movl	$875260009, -44(%rbp)   # imm = 0x342B6869
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movl	%edx, -12(%rbp)
	movq	img, %rax
...
.LBB5_5:                                # %if.end
	...
	callq	rd_pic_decision
	movl	%eax, %ebx
	cmpl	$875260009, -44(%rbp)   # imm = 0x342B6869
	jne	.LBB5_7
.LBB5_6:
	movl	%ebx, %eax
	addq	$72, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$556697396, -20(%rbp)   # imm = 0x212E8734
	vmovsd	%xmm0, -48(%rbp)
	vmovsd	%xmm1, -32(%rbp)
	movl	%edi, -24(%rbp)
	movl	%esi, -16(%rbp)
...
.LBB6_5:                                # %return
	movl	-12(%rbp), %ebx
	cmpl	$556697396, -20(%rbp)   # imm = 0x212E8734
	jne	.LBB6_7
.LBB6_6:
	movl	%ebx, %eax
	addq	$56, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$72, %rsp
	.cfi_offset %rbx, -24
	movl	$1672437906, -52(%rbp)  # imm = 0x63AF6092
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movl	%edx, -12(%rbp)
	movq	img, %rax
...
.LBB7_5:                                # %if.end
	...
	callq	rd_pic_decision
	movl	%eax, %ebx
	cmpl	$1672437906, -52(%rbp)  # imm = 0x63AF6092
	jne	.LBB7_7
.LBB7_6:
	movl	%ebx, %eax
	addq	$72, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$102108473, -20(%rbp)   # imm = 0x6160D39
	vmovsd	%xmm0, -32(%rbp)
	vmovsd	%xmm1, -56(%rbp)
	movl	%edi, -16(%rbp)
	movl	%esi, -24(%rbp)
...
.LBB8_5:                                # %return
	movl	-12(%rbp), %ebx
	cmpl	$102108473, -20(%rbp)   # imm = 0x6160D39
	jne	.LBB8_7
.LBB8_6:
	movl	%ebx, %eax
	addq	$56, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$72, %rsp
	.cfi_offset %rbx, -24
	movl	$1838284540, -40(%rbp)  # imm = 0x6D91FEFC
	movq	%rdi, -24(%rbp)
	movq	%rsi, -32(%rbp)
	movl	%edx, -12(%rbp)
	movq	img, %rax
...
.LBB9_5:                                # %if.end
	...
	callq	rd_pic_decision
	movl	%eax, %ebx
	cmpl	$1838284540, -40(%rbp)  # imm = 0x6D91FEFC
	jne	.LBB9_7
.LBB9_6:
	movl	%ebx, %eax
	addq	$72, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$763306031, -16(%rbp)   # imm = 0x2D7F202F
	vmovsd	%xmm0, -64(%rbp)
	vmovsd	%xmm1, -56(%rbp)
	movl	%edi, -24(%rbp)
	movl	%esi, -20(%rbp)
...
.LBB10_5:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$763306031, -16(%rbp)   # imm = 0x2D7F202F
	jne	.LBB10_7
.LBB10_6:
	movl	%ebx, %eax
	addq	$56, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$2132840314, -24(%rbp)  # imm = 0x7F208F7A
	vmovsd	%xmm0, -64(%rbp)
	vmovsd	%xmm1, -48(%rbp)
	movl	%edi, -20(%rbp)
	movl	%esi, -16(%rbp)
...
.LBB11_5:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$2132840314, -24(%rbp)  # imm = 0x7F208F7A
	jne	.LBB11_7
.LBB11_6:
	movl	%ebx, %eax
	addq	$56, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$72, %rsp
	.cfi_offset %rbx, -24
	movl	$1831561781, -48(%rbp)  # imm = 0x6D2B6A35
	movq	%rdi, -24(%rbp)
	movq	%rsi, -32(%rbp)
	movl	%edx, -12(%rbp)
	movq	img, %rax
...
.LBB12_5:                               # %if.end
	...
	callq	rd_pic_decision
	movl	%eax, %ebx
	cmpl	$1831561781, -48(%rbp)  # imm = 0x6D2B6A35
	jne	.LBB12_7
.LBB12_6:
	movl	%ebx, %eax
	addq	$72, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$72, %rsp
	.cfi_offset %rbx, -24
	movl	$2039134512, -48(%rbp)  # imm = 0x798AB930
	movq	%rdi, -24(%rbp)
	movq	%rsi, -32(%rbp)
	movl	%edx, -12(%rbp)
	movq	img, %rax
...
.LBB13_5:                               # %if.end
	...
	callq	rd_pic_decision
	movl	%eax, %ebx
	cmpl	$2039134512, -48(%rbp)  # imm = 0x798AB930
	jne	.LBB13_7
.LBB13_6:
	movl	%ebx, %eax
	addq	$72, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$591599907, -16(%rbp)   # imm = 0x23431923
	vmovsd	%xmm0, -64(%rbp)
	vmovsd	%xmm1, -40(%rbp)
	movl	%edi, -20(%rbp)
	movl	%esi, -24(%rbp)
...
.LBB14_5:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$591599907, -16(%rbp)   # imm = 0x23431923
	jne	.LBB14_7
.LBB14_6:
	movl	%ebx, %eax
	addq	$56, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$1021193260, -24(%rbp)  # imm = 0x3CDE2C2C
	vmovsd	%xmm0, -56(%rbp)
	vmovsd	%xmm1, -40(%rbp)
	movl	%edi, -16(%rbp)
	movl	%esi, -20(%rbp)
...
.LBB15_5:                               # %return
	movl	-12(%rbp), %ebx
	cmpl	$1021193260, -24(%rbp)  # imm = 0x3CDE2C2C
	jne	.LBB15_7
.LBB15_6:
	movl	%ebx, %eax
	addq	$56, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$72, %rsp
	.cfi_offset %rbx, -24
	movl	$900416777, -48(%rbp)   # imm = 0x35AB4509
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movl	%edx, -12(%rbp)
	movq	img, %rax
...
.LBB16_5:                               # %if.end
	...
	callq	rd_pic_decision
	movl	%eax, %ebx
	cmpl	$900416777, -48(%rbp)   # imm = 0x35AB4509
	jne	.LBB16_7
.LBB16_6:
	movl	%ebx, %eax
	addq	$72, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$72, %rsp
	.cfi_offset %rbx, -24
	movl	$1626709458, -36(%rbp)  # imm = 0x60F59DD2
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movl	%edx, -12(%rbp)
	movq	img, %rax
...
.LBB17_5:                               # %if.end
	...
	callq	rd_pic_decision
	movl	%eax, %ebx
	cmpl	$1626709458, -36(%rbp)  # imm = 0x60F59DD2
	jne	.LBB17_7
.LBB17_6:
	movl	%ebx, %eax
	addq	$72, %rsp
