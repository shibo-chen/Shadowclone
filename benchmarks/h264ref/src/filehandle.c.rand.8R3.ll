; ModuleID = 'filehandle.c.rand.8R3.bc'
...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_error.2, label %func_error.6
...
func_write_PPS.4:                                 ; preds = %ctrl0
  %3 = call i32 @write_PPS.4(i32 %len, i32 %PPS_id)
  ret i32 %3

func_write_PPS.7:                                 ; preds = %ctrl1
  %4 = call i32 @write_PPS.7(i32 %len, i32 %PPS_id)
  ret i32 %4

func_write_PPS.13:                                ; preds = %ctrl2
  %5 = call i32 @write_PPS.13(i32 %len, i32 %PPS_id)
  ret i32 %5

func_write_PPS.14:                                ; preds = %ctrl3
  %6 = call i32 @write_PPS.14(i32 %len, i32 %PPS_id)
  ret i32 %6

func_write_PPS.16:                                ; preds = %ctrl3
  %7 = call i32 @write_PPS.16(i32 %len, i32 %PPS_id)
  ret i32 %7

ctrl0:                                            ; preds = %rand_bb
  %8 = icmp eq i32 %0, 1
  br i1 %8, label %func_write_PPS.4, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %9 = icmp eq i32 %0, 2
  br i1 %9, label %func_write_PPS.7, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %10 = icmp eq i32 %0, 3
  br i1 %10, label %func_write_PPS.13, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %11 = icmp eq i32 %0, 4
  br i1 %11, label %func_write_PPS.14, label %func_write_PPS.16
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_start_sequence.3, label %ctrl0

func_start_sequence.3:                            ; preds = %rand_bb
  %2 = call i32 @start_sequence.3()
  ret i32 %2
...
func_start_sequence.8:                            ; preds = %ctrl1
  %4 = call i32 @start_sequence.8()
  ret i32 %4

func_start_sequence.9:                            ; preds = %ctrl2
  %5 = call i32 @start_sequence.9()
  ret i32 %5
...
func_start_sequence.12:                           ; preds = %ctrl5
  %8 = call i32 @start_sequence.12()
  ret i32 %8
...
ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_start_sequence.5, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_start_sequence.8, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_start_sequence.9, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_start_sequence.10, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_start_sequence.11, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_start_sequence.12, label %func_start_sequence.15
}
...
entry:
  ...
  %canary = alloca i32
  store i32 1637997795, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1033034885, i32* %canary
...
entry:
  ...
  %nalu = alloca %struct.NALU_t*, align 8
  %canary = alloca i32
  store i32 271334982, i32* %canary
...
entry:
  %nalu = alloca %struct.NALU_t*, align 8
  %canary = alloca i32
  store i32 1957411169, i32* %canary
  %len.addr = alloca i32, align 4
  %PPS_id.addr = alloca i32, align 4
  store i32 %len, i32* %len.addr, align 4
  store i32 %PPS_id, i32* %PPS_id.addr, align 4
...
entry:
  ...
  %total_pps = alloca i32, align 4
  %canary = alloca i32
  store i32 1277815103, i32* %canary
  %nalu = alloca %struct.NALU_t*, align 8
  store i32 0, i32* %len, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
  %GenerateMultiplePPS = getelementptr inbounds %struct.InputParameters, %struct.InputParameters* %0, i32 0, i32 15
...
entry:
  %canary = alloca i32
  store i32 861289937, i32* %canary
  %code.addr = alloca i32, align 4
  %text.addr = alloca i8*, align 8
  store i8* %text, i8** %text.addr, align 8
  store i32 %code, i32* %code.addr, align 4
...
entry:
  ...
  %nalu = alloca %struct.NALU_t*, align 8
  %canary = alloca i32
  store i32 137219138, i32* %canary
  %len.addr = alloca i32, align 4
  store i32 %len, i32* %len.addr, align 4
  store i32 %PPS_id, i32* %PPS_id.addr, align 4
  store %struct.NALU_t* null, %struct.NALU_t** %nalu, align 8
...
entry:
  ...
  %total_pps = alloca i32, align 4
  %canary = alloca i32
  store i32 1434063513, i32* %canary
  %nalu = alloca %struct.NALU_t*, align 8
  %i = alloca i32, align 4
  %len = alloca i32, align 4
  store i32 0, i32* %len, align 4
...
entry:
  ...
  %len = alloca i32, align 4
  %canary = alloca i32
  store i32 1344917305, i32* %canary
  %retval = alloca i32, align 4
  %i = alloca i32, align 4
  store i32 0, i32* %len, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
entry:
  %canary = alloca i32
  store i32 997368556, i32* %canary
  %len = alloca i32, align 4
  %i = alloca i32, align 4
  %retval = alloca i32, align 4
  %total_pps = alloca i32, align 4
...
entry:
  ...
  %len = alloca i32, align 4
  %canary = alloca i32
  store i32 366468166, i32* %canary
  %i = alloca i32, align 4
  %retval = alloca i32, align 4
  %nalu = alloca %struct.NALU_t*, align 8
  store i32 0, i32* %len, align 4
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1694675196, i32* %canary
  %i = alloca i32, align 4
  %nalu = alloca %struct.NALU_t*, align 8
  store i32 0, i32* %len, align 4
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
entry:
  ...
  %len.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1501477033, i32* %canary
  %nalu = alloca %struct.NALU_t*, align 8
  store i32 %len, i32* %len.addr, align 4
  store i32 %PPS_id, i32* %PPS_id.addr, align 4
  store %struct.NALU_t* null, %struct.NALU_t** %nalu, align 8
...
entry:
  %canary = alloca i32
  store i32 1512921149, i32* %canary
  %nalu = alloca %struct.NALU_t*, align 8
  %PPS_id.addr = alloca i32, align 4
  %len.addr = alloca i32, align 4
  store i32 %len, i32* %len.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 2081023884, i32* %canary
  %len.addr = alloca i32, align 4
  %nalu = alloca %struct.NALU_t*, align 8
  %PPS_id.addr = alloca i32, align 4
  store i32 %len, i32* %len.addr, align 4
