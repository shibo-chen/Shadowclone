; ModuleID = 'mb_access.c.rand.8R1.bc'
...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_mb_is_available.12, label %ctrl0

func_mb_is_available.12:                          ; preds = %rand_bb
  %2 = call i32 @mb_is_available.12(i32 %mbAddr, i32 %currMbAddr)
  ret i32 %2

func_mb_is_available.14:                          ; preds = %ctrl0
  %3 = call i32 @mb_is_available.14(i32 %mbAddr, i32 %currMbAddr)
  ret i32 %3

func_mb_is_available.28:                          ; preds = %ctrl1
  %4 = call i32 @mb_is_available.28(i32 %mbAddr, i32 %currMbAddr)
  ret i32 %4

func_mb_is_available.33:                          ; preds = %ctrl2
  %5 = call i32 @mb_is_available.33(i32 %mbAddr, i32 %currMbAddr)
  ret i32 %5

func_mb_is_available.35:                          ; preds = %ctrl3
  %6 = call i32 @mb_is_available.35(i32 %mbAddr, i32 %currMbAddr)
  ret i32 %6

func_mb_is_available.38:                          ; preds = %ctrl3
  %7 = call i32 @mb_is_available.38(i32 %mbAddr, i32 %currMbAddr)
  ret i32 %7

ctrl0:                                            ; preds = %rand_bb
  %8 = icmp eq i32 %0, 1
  br i1 %8, label %func_mb_is_available.14, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %9 = icmp eq i32 %0, 2
  br i1 %9, label %func_mb_is_available.28, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %10 = icmp eq i32 %0, 3
  br i1 %10, label %func_mb_is_available.33, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %11 = icmp eq i32 %0, 4
  br i1 %11, label %func_mb_is_available.35, label %func_mb_is_available.38
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_CheckAvailabilityOfNeighbors.11, label %func_CheckAvailabilityOfNeighbors.13

func_CheckAvailabilityOfNeighbors.11:             ; preds = %rand_bb
  call void @CheckAvailabilityOfNeighbors.11()
  ret void

func_CheckAvailabilityOfNeighbors.13:             ; preds = %rand_bb
  call void @CheckAvailabilityOfNeighbors.13()
  ret void
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_get_mb_block_pos.5, label %ctrl0

func_get_mb_block_pos.5:                          ; preds = %rand_bb
  call void @get_mb_block_pos.5(i32 %mb_addr, i32* %x, i32* %y)
  ret void

func_get_mb_block_pos.21:                         ; preds = %ctrl0
  call void @get_mb_block_pos.21(i32 %mb_addr, i32* %x, i32* %y)
  ret void

func_get_mb_block_pos.24:                         ; preds = %ctrl1
  call void @get_mb_block_pos.24(i32 %mb_addr, i32* %x, i32* %y)
  ret void

func_get_mb_block_pos.31:                         ; preds = %ctrl2
  call void @get_mb_block_pos.31(i32 %mb_addr, i32* %x, i32* %y)
  ret void

func_get_mb_block_pos.36:                         ; preds = %ctrl3
  call void @get_mb_block_pos.36(i32 %mb_addr, i32* %x, i32* %y)
  ret void

func_get_mb_block_pos.37:                         ; preds = %ctrl3
  call void @get_mb_block_pos.37(i32 %mb_addr, i32* %x, i32* %y)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_get_mb_block_pos.21, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_get_mb_block_pos.24, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_get_mb_block_pos.31, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_get_mb_block_pos.36, label %func_get_mb_block_pos.37
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_get_mb_pos.8, label %ctrl0

func_get_mb_pos.8:                                ; preds = %rand_bb
...
func_get_mb_pos.10:                               ; preds = %ctrl1
  call void @get_mb_pos.10(i32 %mb_addr, i32* %x, i32* %y)
  ret void

func_get_mb_pos.42:                               ; preds = %ctrl2
  call void @get_mb_pos.42(i32 %mb_addr, i32* %x, i32* %y)
  ret void

func_get_mb_pos.47:                               ; preds = %ctrl3
  call void @get_mb_pos.47(i32 %mb_addr, i32* %x, i32* %y)
  ret void

func_get_mb_pos.53:                               ; preds = %ctrl3
  call void @get_mb_pos.53(i32 %mb_addr, i32* %x, i32* %y)
  ret void
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_get_mb_pos.10, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_get_mb_pos.42, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_get_mb_pos.47, label %func_get_mb_pos.53
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_getNonAffNeighbour.4, label %ctrl0

func_getNonAffNeighbour.4:                        ; preds = %rand_bb
  call void @getNonAffNeighbour.4(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void
...
func_getNonAffNeighbour.17:                       ; preds = %ctrl1
  call void @getNonAffNeighbour.17(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

func_getNonAffNeighbour.18:                       ; preds = %ctrl2
  call void @getNonAffNeighbour.18(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

func_getNonAffNeighbour.30:                       ; preds = %ctrl3
  call void @getNonAffNeighbour.30(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

func_getNonAffNeighbour.39:                       ; preds = %ctrl4
  call void @getNonAffNeighbour.39(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

func_getNonAffNeighbour.44:                       ; preds = %ctrl5
  call void @getNonAffNeighbour.44(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_getNonAffNeighbour.17, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_getNonAffNeighbour.18, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_getNonAffNeighbour.30, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_getNonAffNeighbour.39, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_getNonAffNeighbour.44, label %func_getNonAffNeighbour.52
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_getAffNeighbour.6, label %ctrl0

func_getAffNeighbour.6:                           ; preds = %rand_bb
  call void @getAffNeighbour.6(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

func_getAffNeighbour.20:                          ; preds = %ctrl0
  call void @getAffNeighbour.20(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

func_getAffNeighbour.23:                          ; preds = %ctrl1
  call void @getAffNeighbour.23(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

func_getAffNeighbour.29:                          ; preds = %ctrl2
  call void @getAffNeighbour.29(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

func_getAffNeighbour.43:                          ; preds = %ctrl3
  call void @getAffNeighbour.43(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

func_getAffNeighbour.48:                          ; preds = %ctrl4
  call void @getAffNeighbour.48(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

func_getAffNeighbour.51:                          ; preds = %ctrl5
  call void @getAffNeighbour.51(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

func_getAffNeighbour.58:                          ; preds = %ctrl5
  call void @getAffNeighbour.58(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_getAffNeighbour.20, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_getAffNeighbour.23, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_getAffNeighbour.29, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_getAffNeighbour.43, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_getAffNeighbour.48, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_getAffNeighbour.51, label %func_getAffNeighbour.58
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_getNeighbour.3, label %ctrl0

func_getNeighbour.3:                              ; preds = %rand_bb
  call void @getNeighbour.3(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

func_getNeighbour.22:                             ; preds = %ctrl0
  call void @getNeighbour.22(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

func_getNeighbour.26:                             ; preds = %ctrl1
  call void @getNeighbour.26(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void
...
func_getNeighbour.32:                             ; preds = %ctrl3
  call void @getNeighbour.32(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void

func_getNeighbour.57:                             ; preds = %ctrl4
  call void @getNeighbour.57(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix)
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_getNeighbour.22, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_getNeighbour.26, label %ctrl2
...
ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_getNeighbour.32, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_getNeighbour.57, label %ctrl5
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_getLuma4x4Neighbour.7, label %ctrl0

func_getLuma4x4Neighbour.7:                       ; preds = %rand_bb
  call void @getLuma4x4Neighbour.7(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix)
  ret void

func_getLuma4x4Neighbour.19:                      ; preds = %ctrl0
  call void @getLuma4x4Neighbour.19(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix)
  ret void

func_getLuma4x4Neighbour.25:                      ; preds = %ctrl1
  call void @getLuma4x4Neighbour.25(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix)
  ret void

func_getLuma4x4Neighbour.46:                      ; preds = %ctrl2
  call void @getLuma4x4Neighbour.46(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix)
  ret void

func_getLuma4x4Neighbour.49:                      ; preds = %ctrl3
  call void @getLuma4x4Neighbour.49(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix)
  ret void

func_getLuma4x4Neighbour.50:                      ; preds = %ctrl4
  call void @getLuma4x4Neighbour.50(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix)
  ret void

func_getLuma4x4Neighbour.55:                      ; preds = %ctrl5
  call void @getLuma4x4Neighbour.55(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix)
  ret void

func_getLuma4x4Neighbour.56:                      ; preds = %ctrl5
  call void @getLuma4x4Neighbour.56(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_getLuma4x4Neighbour.19, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_getLuma4x4Neighbour.25, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_getLuma4x4Neighbour.46, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_getLuma4x4Neighbour.49, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_getLuma4x4Neighbour.50, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_getLuma4x4Neighbour.55, label %func_getLuma4x4Neighbour.56
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_getChroma4x4Neighbour.1, label %ctrl0

func_getChroma4x4Neighbour.1:                     ; preds = %rand_bb
  call void @getChroma4x4Neighbour.1(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix)
  ret void

func_getChroma4x4Neighbour.2:                     ; preds = %ctrl0
  call void @getChroma4x4Neighbour.2(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix)
  ret void

func_getChroma4x4Neighbour.16:                    ; preds = %ctrl1
  call void @getChroma4x4Neighbour.16(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix)
  ret void
...
func_getChroma4x4Neighbour.45:                    ; preds = %ctrl5
  call void @getChroma4x4Neighbour.45(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix)
  ret void

func_getChroma4x4Neighbour.54:                    ; preds = %ctrl5
  call void @getChroma4x4Neighbour.54(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_getChroma4x4Neighbour.2, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_getChroma4x4Neighbour.16, label %ctrl2
...
ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_getChroma4x4Neighbour.45, label %func_getChroma4x4Neighbour.54
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getChroma4x4Neighbour.1(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 350446607, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getChroma4x4Neighbour.2(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix) #0 {
entry:
  %x = alloca i32, align 4
  %canary = alloca i32
  store i32 118246288, i32* %canary
  %rel_x.addr = alloca i32, align 4
  %block_y.addr = alloca i32, align 4
  %y = alloca i32, align 4
  %curr_mb_nr.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getNeighbour.3(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix) #0 {
entry:
  %curr_mb_nr.addr = alloca i32, align 4
  %yN.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1294380574, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getNonAffNeighbour.4(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix) #0 {
entry:
  %curr_mb_nr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1164656062, i32* %canary
  %xN.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @get_mb_block_pos.5(i32 %mb_addr, i32* %x, i32* %y) #0 {
entry:
  %x.addr = alloca i32*, align 8
  %mb_addr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1427686797, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getAffNeighbour.6(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix) #0 {
entry:
  %maxW = alloca i32, align 4
  %curr_mb_nr.addr = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
  ...
  %currMb = alloca %struct.macroblock*, align 8
  %canary = alloca i32
  store i32 442291654, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getLuma4x4Neighbour.7(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix) #0 {
entry:
  %x = alloca i32, align 4
  %canary = alloca i32
  store i32 1550889608, i32* %canary
  %rel_y.addr = alloca i32, align 4
  %block_x.addr = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
  %block_y.addr = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 675444650, i32* %canary
  %mb_addr.addr = alloca i32, align 4
  %y.addr = alloca i32*, align 8
  %x.addr = alloca i32*, align 8
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 1903832452, i32* %canary
  %y.addr = alloca i32*, align 8
  %mb_addr.addr = alloca i32, align 4
  %x.addr = alloca i32*, align 8
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 1766871367, i32* %canary
  %x.addr = alloca i32*, align 8
  %y.addr = alloca i32*, align 8
  %mb_addr.addr = alloca i32, align 4
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @CheckAvailabilityOfNeighbors.11() #0 {
entry:
  %canary = alloca i32
  store i32 2126701610, i32* %canary
  %currMB = alloca %struct.macroblock*, align 8
...
if.end104:                                        ; preds = %if.then98, %if.end95
  ...
  %108 = icmp eq i32 %107, 2126701610
...
entry:
  %canary = alloca i32
  store i32 1729909427, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @CheckAvailabilityOfNeighbors.13() #0 {
entry:
  %mb_nr = alloca i32, align 4
  %canary = alloca i32
  store i32 1098242934, i32* %canary
  %currMB = alloca %struct.macroblock*, align 8
  %0 = load %struct.ImageParameters*, %struct.ImageParameters** @img, align 8
  %current_mb_nr = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %0, i32 0, i32 3
  %1 = load i32, i32* %current_mb_nr, align 4
...
if.end104:                                        ; preds = %if.then98, %if.end95
  %107 = load i32, i32* %canary
  %108 = icmp eq i32 %107, 1098242934
  br i1 %108, label %109, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @mb_is_available.14(i32 %mbAddr, i32 %currMbAddr) #0 {
entry:
  %retval = alloca i32, align 4
  %mbAddr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 954551985, i32* %canary
  %currMbAddr.addr = alloca i32, align 4
  store i32 %mbAddr, i32* %mbAddr.addr, align 4
  store i32 %currMbAddr, i32* %currMbAddr.addr, align 4
  %0 = load i32, i32* %mbAddr.addr, align 4
...
entry:
  ...
  %yN.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2048339029, i32* %canary
  %luma.addr = alloca i32, align 4
  %xN.addr = alloca i32, align 4
  %curr_mb_nr.addr = alloca i32, align 4
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getChroma4x4Neighbour.16(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix) #0 {
entry:
  %curr_mb_nr.addr = alloca i32, align 4
  %rel_y.addr = alloca i32, align 4
  %rel_x.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getNonAffNeighbour.17(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix) #0 {
entry:
  %canary = alloca i32
  store i32 2088810570, i32* %canary
  %pix.addr = alloca %struct.pix_pos*, align 8
  %xN.addr = alloca i32, align 4
  %maxH = alloca i32, align 4
  %maxW = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getNonAffNeighbour.18(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix) #0 {
entry:
  %currMb = alloca %struct.macroblock*, align 8
  %maxH = alloca i32, align 4
  %curr_mb_nr.addr = alloca i32, align 4
  ...
  %xN.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 856491200, i32* %canary
  %pix.addr = alloca %struct.pix_pos*, align 8
  %luma.addr = alloca i32, align 4
  %maxW = alloca i32, align 4
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getLuma4x4Neighbour.19(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix) #0 {
entry:
  %pix.addr = alloca %struct.pix_pos*, align 8
  %y = alloca i32, align 4
  %block_y.addr = alloca i32, align 4
  ...
  %rel_y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1536343665, i32* %canary
  %curr_mb_nr.addr = alloca i32, align 4
  %x = alloca i32, align 4
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
  store i32 %block_x, i32* %block_x.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getAffNeighbour.20(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix) #0 {
entry:
  %maxW = alloca i32, align 4
  %yN.addr = alloca i32, align 4
  %maxH = alloca i32, align 4
  ...
  %yM = alloca i32, align 4
  %canary = alloca i32
  store i32 311567920, i32* %canary
  %curr_mb_nr.addr = alloca i32, align 4
  %luma.addr = alloca i32, align 4
  %currMb = alloca %struct.macroblock*, align 8
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
...
entry:
  ...
  %x.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 296697464, i32* %canary
  %y.addr = alloca i32*, align 8
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
  store i32* %x, i32** %x.addr, align 8
  store i32* %y, i32** %y.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getNeighbour.22(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix) #0 {
entry:
  %xN.addr = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
  %luma.addr = alloca i32, align 4
  %yN.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 440163237, i32* %canary
  %curr_mb_nr.addr = alloca i32, align 4
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
  store i32 %xN, i32* %xN.addr, align 4
  store i32 %yN, i32* %yN.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getAffNeighbour.23(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix) #0 {
entry:
  %yN.addr = alloca i32, align 4
  %yM = alloca i32, align 4
  %xN.addr = alloca i32, align 4
  ...
  %curr_mb_nr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2112430988, i32* %canary
  %luma.addr = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
  %currMb = alloca %struct.macroblock*, align 8
  %maxH = alloca i32, align 4
...
if.end376:                                        ; preds = %if.end375, %lor.lhs.false, %if.then8, %if.then1
  %309 = load i32, i32* %canary
  %310 = icmp eq i32 %309, 2112430988
  br i1 %310, label %311, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @get_mb_block_pos.24(i32 %mb_addr, i32* %x, i32* %y) #0 {
entry:
  %y.addr = alloca i32*, align 8
  %x.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 2053803796, i32* %canary
  %mb_addr.addr = alloca i32, align 4
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
  store i32* %x, i32** %x.addr, align 8
  store i32* %y, i32** %y.addr, align 8
...
entry:
  ...
  %rel_y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 792261508, i32* %canary
  %y = alloca i32, align 4
  %block_x.addr = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
  %rel_x.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getNeighbour.26(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix) #0 {
entry:
  %curr_mb_nr.addr = alloca i32, align 4
  %luma.addr = alloca i32, align 4
  %xN.addr = alloca i32, align 4
  %yN.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2030841243, i32* %canary
  %pix.addr = alloca %struct.pix_pos*, align 8
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
  store i32 %xN, i32* %xN.addr, align 4
  store i32 %yN, i32* %yN.addr, align 4
...
entry:
  ...
  %curr_mb_nr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 741442608, i32* %canary
  %yN.addr = alloca i32, align 4
  %luma.addr = alloca i32, align 4
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
  store i32 %xN, i32* %xN.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 1104036486, i32* %canary
  %mbAddr.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  %currMbAddr.addr = alloca i32, align 4
  store i32 %mbAddr, i32* %mbAddr.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getAffNeighbour.29(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix) #0 {
entry:
  %maxW = alloca i32, align 4
  %yM = alloca i32, align 4
  %yN.addr = alloca i32, align 4
  %maxH = alloca i32, align 4
  %canary = alloca i32
  store i32 1099794551, i32* %canary
  %luma.addr = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
  %curr_mb_nr.addr = alloca i32, align 4
  %currMb = alloca %struct.macroblock*, align 8
...
if.end376:                                        ; preds = %if.end375, %lor.lhs.false, %if.then8, %if.then1
  %309 = load i32, i32* %canary
  %310 = icmp eq i32 %309, 1099794551
  br i1 %310, label %311, label %func_exit
...
entry:
  %currMb = alloca %struct.macroblock*, align 8
  %canary = alloca i32
  store i32 1481968491, i32* %canary
  %luma.addr = alloca i32, align 4
  %xN.addr = alloca i32, align 4
  %maxW = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @get_mb_block_pos.31(i32 %mb_addr, i32* %x, i32* %y) #0 {
entry:
  %canary = alloca i32
  store i32 1307881981, i32* %canary
  %mb_addr.addr = alloca i32, align 4
  %y.addr = alloca i32*, align 8
  %x.addr = alloca i32*, align 8
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getNeighbour.32(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix) #0 {
entry:
  %canary = alloca i32
  store i32 784008599, i32* %canary
  %curr_mb_nr.addr = alloca i32, align 4
  %xN.addr = alloca i32, align 4
  %luma.addr = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @mb_is_available.33(i32 %mbAddr, i32 %currMbAddr) #0 {
entry:
  %canary = alloca i32
  store i32 249071626, i32* %canary
  %currMbAddr.addr = alloca i32, align 4
  %mbAddr.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  store i32 %mbAddr, i32* %mbAddr.addr, align 4
...
entry:
  ...
  %pix.addr = alloca %struct.pix_pos*, align 8
  %canary = alloca i32
  store i32 1396829349, i32* %canary
  %rel_y.addr = alloca i32, align 4
  %rel_x.addr = alloca i32, align 4
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
  store i32 %block_x, i32* %block_x.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @mb_is_available.35(i32 %mbAddr, i32 %currMbAddr) #0 {
entry:
  %mbAddr.addr = alloca i32, align 4
  %currMbAddr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 943105902, i32* %canary
  %retval = alloca i32, align 4
  store i32 %mbAddr, i32* %mbAddr.addr, align 4
  store i32 %currMbAddr, i32* %currMbAddr.addr, align 4
  %0 = load i32, i32* %mbAddr.addr, align 4
...
entry:
  %x.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 1580511673, i32* %canary
  %y.addr = alloca i32*, align 8
  %mb_addr.addr = alloca i32, align 4
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
  store i32* %x, i32** %x.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @get_mb_block_pos.37(i32 %mb_addr, i32* %x, i32* %y) #0 {
entry:
  %canary = alloca i32
  store i32 704288379, i32* %canary
  %y.addr = alloca i32*, align 8
  %mb_addr.addr = alloca i32, align 4
  %x.addr = alloca i32*, align 8
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
...
entry:
  ...
  %currMbAddr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 625004777, i32* %canary
  %mbAddr.addr = alloca i32, align 4
  store i32 %mbAddr, i32* %mbAddr.addr, align 4
  store i32 %currMbAddr, i32* %currMbAddr.addr, align 4
  %0 = load i32, i32* %mbAddr.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getNonAffNeighbour.39(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix) #0 {
entry:
  %yN.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 551196026, i32* %canary
  %curr_mb_nr.addr = alloca i32, align 4
  %xN.addr = alloca i32, align 4
  %currMb = alloca %struct.macroblock*, align 8
  %maxW = alloca i32, align 4
...
entry:
  ...
  %y = alloca i32, align 4
  %canary = alloca i32
  store i32 649934846, i32* %canary
  %block_y.addr = alloca i32, align 4
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
  store i32 %block_x, i32* %block_x.addr, align 4
  store i32 %block_y, i32* %block_y.addr, align 4
...
entry:
  ...
  %pix.addr = alloca %struct.pix_pos*, align 8
  %canary = alloca i32
  store i32 617188197, i32* %canary
  %x = alloca i32, align 4
  %rel_x.addr = alloca i32, align 4
  %y = alloca i32, align 4
  %rel_y.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @get_mb_pos.42(i32 %mb_addr, i32* %x, i32* %y) #0 {
entry:
  %canary = alloca i32
  store i32 1489884664, i32* %canary
  %x.addr = alloca i32*, align 8
  %mb_addr.addr = alloca i32, align 4
  %y.addr = alloca i32*, align 8
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
...
entry:
  ...
  %yM = alloca i32, align 4
  %canary = alloca i32
  store i32 720209512, i32* %canary
  %currMb = alloca %struct.macroblock*, align 8
  %maxW = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getNonAffNeighbour.44(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix) #0 {
entry:
  %yN.addr = alloca i32, align 4
  %maxH = alloca i32, align 4
  %currMb = alloca %struct.macroblock*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getChroma4x4Neighbour.45(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix) #0 {
entry:
  %curr_mb_nr.addr = alloca i32, align 4
  %block_y.addr = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
  ...
  %block_x.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1247509444, i32* %canary
  %x = alloca i32, align 4
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
  store i32 %block_x, i32* %block_x.addr, align 4
  store i32 %block_y, i32* %block_y.addr, align 4
...
entry:
  ...
  %pix.addr = alloca %struct.pix_pos*, align 8
  %canary = alloca i32
  store i32 1987243569, i32* %canary
  %block_x.addr = alloca i32, align 4
  %x = alloca i32, align 4
  %rel_y.addr = alloca i32, align 4
  %y = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @get_mb_pos.47(i32 %mb_addr, i32* %x, i32* %y) #0 {
entry:
  %canary = alloca i32
  store i32 244130822, i32* %canary
  %mb_addr.addr = alloca i32, align 4
  %x.addr = alloca i32*, align 8
  %y.addr = alloca i32*, align 8
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getAffNeighbour.48(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix) #0 {
entry:
  %luma.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1313647438, i32* %canary
  %curr_mb_nr.addr = alloca i32, align 4
  %xN.addr = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
  %yN.addr = alloca i32, align 4
...
if.end376:                                        ; preds = %if.end375, %lor.lhs.false, %if.then8, %if.then1
  %309 = load i32, i32* %canary
  %310 = icmp eq i32 %309, 1313647438
  br i1 %310, label %311, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getLuma4x4Neighbour.49(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix) #0 {
entry:
  %pix.addr = alloca %struct.pix_pos*, align 8
  %x = alloca i32, align 4
  %block_x.addr = alloca i32, align 4
  ...
  %rel_x.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 837873502, i32* %canary
  %rel_y.addr = alloca i32, align 4
  %y = alloca i32, align 4
  %curr_mb_nr.addr = alloca i32, align 4
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getLuma4x4Neighbour.50(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix) #0 {
entry:
  %pix.addr = alloca %struct.pix_pos*, align 8
  %block_y.addr = alloca i32, align 4
  %rel_y.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1290779146, i32* %canary
  %curr_mb_nr.addr = alloca i32, align 4
  %x = alloca i32, align 4
  %rel_x.addr = alloca i32, align 4
  %block_x.addr = alloca i32, align 4
...
entry:
  ...
  %currMb = alloca %struct.macroblock*, align 8
  %canary = alloca i32
  store i32 1873950136, i32* %canary
  %yN.addr = alloca i32, align 4
  %maxW = alloca i32, align 4
  %luma.addr = alloca i32, align 4
  %yM = alloca i32, align 4
...
if.end376:                                        ; preds = %if.end375, %lor.lhs.false, %if.then8, %if.then1
  %309 = load i32, i32* %canary
  %310 = icmp eq i32 %309, 1873950136
  br i1 %310, label %311, label %func_exit
...
entry:
  ...
  %pix.addr = alloca %struct.pix_pos*, align 8
  %canary = alloca i32
  store i32 1123190511, i32* %canary
  %luma.addr = alloca i32, align 4
  %currMb = alloca %struct.macroblock*, align 8
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
  store i32 %xN, i32* %xN.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @get_mb_pos.53(i32 %mb_addr, i32* %x, i32* %y) #0 {
entry:
  %y.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 151766652, i32* %canary
  %x.addr = alloca i32*, align 8
  %mb_addr.addr = alloca i32, align 4
  store i32 %mb_addr, i32* %mb_addr.addr, align 4
  store i32* %x, i32** %x.addr, align 8
...
entry:
  ...
  %pix.addr = alloca %struct.pix_pos*, align 8
  %canary = alloca i32
  store i32 935091060, i32* %canary
  %block_x.addr = alloca i32, align 4
  %x = alloca i32, align 4
  %rel_y.addr = alloca i32, align 4
  %block_y.addr = alloca i32, align 4
...
entry:
  ...
  %y = alloca i32, align 4
  %canary = alloca i32
  store i32 736809096, i32* %canary
  %rel_y.addr = alloca i32, align 4
  %block_y.addr = alloca i32, align 4
  %block_x.addr = alloca i32, align 4
  %x = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getLuma4x4Neighbour.56(i32 %curr_mb_nr, i32 %block_x, i32 %block_y, i32 %rel_x, i32 %rel_y, %struct.pix_pos* %pix) #0 {
entry:
  %block_y.addr = alloca i32, align 4
  %rel_x.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1139022249, i32* %canary
  %pix.addr = alloca %struct.pix_pos*, align 8
  %block_x.addr = alloca i32, align 4
  %curr_mb_nr.addr = alloca i32, align 4
  %y = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getNeighbour.57(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix) #0 {
entry:
  %luma.addr = alloca i32, align 4
  %curr_mb_nr.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1592019566, i32* %canary
  %xN.addr = alloca i32, align 4
  %yN.addr = alloca i32, align 4
  %pix.addr = alloca %struct.pix_pos*, align 8
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @getAffNeighbour.58(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %luma, %struct.pix_pos* %pix) #0 {
entry:
  %currMb = alloca %struct.macroblock*, align 8
  %xN.addr = alloca i32, align 4
  %curr_mb_nr.addr = alloca i32, align 4
...
entry:
  ...
  %pix.addr = alloca %struct.pix_pos*, align 8
  %canary = alloca i32
  store i32 2021134738, i32* %canary
  %xN.addr = alloca i32, align 4
  %yN.addr = alloca i32, align 4
  %curr_mb_nr.addr = alloca i32, align 4
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
...
entry:
  ...
  %luma.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 839498057, i32* %canary
  %curr_mb_nr.addr = alloca i32, align 4
  store i32 %curr_mb_nr, i32* %curr_mb_nr.addr, align 4
  store i32 %xN, i32* %xN.addr, align 4
  store i32 %yN, i32* %yN.addr, align 4
