; ModuleID = 'leaky_bucket.c.rand.8R3.bc'
...
func_get_LeakyBucketRate.16:                      ; preds = %ctrl2
  %5 = call i32 @get_LeakyBucketRate.16(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret i32 %5

func_get_LeakyBucketRate.17:                      ; preds = %ctrl3
  %6 = call i32 @get_LeakyBucketRate.17(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret i32 %6

func_get_LeakyBucketRate.23:                      ; preds = %ctrl4
  %7 = call i32 @get_LeakyBucketRate.23(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret i32 %7

func_get_LeakyBucketRate.29:                      ; preds = %ctrl5
  %8 = call i32 @get_LeakyBucketRate.29(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret i32 %8

func_get_LeakyBucketRate.32:                      ; preds = %ctrl5
  %9 = call i32 @get_LeakyBucketRate.32(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret i32 %9
...
ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_get_LeakyBucketRate.16, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_get_LeakyBucketRate.17, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_get_LeakyBucketRate.23, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_get_LeakyBucketRate.29, label %func_get_LeakyBucketRate.32
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_PutBigDoubleWord.4, label %func_PutBigDoubleWord.7

func_PutBigDoubleWord.4:                          ; preds = %rand_bb
  call void @PutBigDoubleWord.4(i64 %dw, %struct._IO_FILE* %fp)
  ret void

func_PutBigDoubleWord.7:                          ; preds = %rand_bb
  call void @PutBigDoubleWord.7(i64 %dw, %struct._IO_FILE* %fp)
  ret void
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_write_buffer.8, label %ctrl0

func_write_buffer.8:                              ; preds = %rand_bb
  call void @write_buffer.8(i64 %NumberLeakyBuckets, i64* %Rmin, i64* %Bmin, i64* %Fmin)
  ret void

func_write_buffer.10:                             ; preds = %ctrl0
...
func_write_buffer.15:                             ; preds = %ctrl2
  call void @write_buffer.15(i64 %NumberLeakyBuckets, i64* %Rmin, i64* %Bmin, i64* %Fmin)
  ret void

func_write_buffer.19:                             ; preds = %ctrl3
  call void @write_buffer.19(i64 %NumberLeakyBuckets, i64* %Rmin, i64* %Bmin, i64* %Fmin)
  ret void

func_write_buffer.20:                             ; preds = %ctrl4
  call void @write_buffer.20(i64 %NumberLeakyBuckets, i64* %Rmin, i64* %Bmin, i64* %Fmin)
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_write_buffer.10, label %ctrl1
...
ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_write_buffer.15, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_write_buffer.19, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_write_buffer.20, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_write_buffer.21, label %func_write_buffer.24
}
...
ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_Sort.18, label %ctrl4
...
ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_Sort.27, label %func_Sort.28
}
...
func_calc_buffer.3:                               ; preds = %ctrl0
  call void @calc_buffer.3()
  ret void

func_calc_buffer.25:                              ; preds = %ctrl1
  call void @calc_buffer.25()
  ret void

func_calc_buffer.26:                              ; preds = %ctrl2
  call void @calc_buffer.26()
  ret void

func_calc_buffer.30:                              ; preds = %ctrl3
  call void @calc_buffer.30()
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_calc_buffer.3, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_calc_buffer.25, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_calc_buffer.26, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_calc_buffer.30, label %ctrl4
...
ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_calc_buffer.33, label %func_calc_buffer.34
}
...
entry:
  ...
  %canary = alloca i32
  store i32 1917946519, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 323254025, i32* %canary
...
entry:
  ...
  %Fmin = alloca i64*, align 8
  %canary = alloca i32
  store i32 2071071614, i32* %canary
  %Rmin = alloca i64*, align 8
  %maxBuffer = alloca i64, align 8
  %buffer_frame = alloca i64*, align 8
  %FrameIndex = alloca i64, align 8
...
for.end136:                                       ; preds = %for.cond57
  ...
  call void @free(i8* %148) #3
  %149 = load i32, i32* %canary
  %150 = icmp eq i32 %149, 2071071614
  br i1 %150, label %151, label %func_exit
...
entry:
  %canary = alloca i32
  store i32 1356961466, i32* %canary
...
entry:
  ...
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1196918411, i32* %canary
  %i = alloca i64, align 8
...
entry:
  ...
  %j = alloca i64, align 8
  %canary = alloca i32
  store i32 348010902, i32* %canary
  %NumberLeakyBuckets.addr = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
  store i64 0, i64* %i, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @PutBigDoubleWord.7(i64 %dw, %struct._IO_FILE* %fp) #0 {
entry:
  %dw.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 684374669, i32* %canary
  %fp.addr = alloca %struct._IO_FILE*, align 8
  store i64 %dw, i64* %dw.addr, align 8
  store %struct._IO_FILE* %fp, %struct._IO_FILE** %fp.addr, align 8
  %0 = load i64, i64* %dw.addr, align 8
...
entry:
  ...
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1329214596, i32* %canary
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1852169852, i32* %canary
  %f = alloca %struct._IO_FILE*, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
entry:
  ...
  %Fmin.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 465346048, i32* %canary
  %Bmin.addr = alloca i64*, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
  store i64* %Bmin, i64** %Bmin.addr, align 8
...
entry:
  ...
  %j = alloca i64, align 8
  %canary = alloca i32
  store i32 1232717995, i32* %canary
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %Rmin.addr = alloca i64*, align 8
  %i = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
...
entry:
  ...
  %i = alloca i64, align 8
  %canary = alloca i32
  store i32 768166413, i32* %canary
  %retval = alloca i32, align 4
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
entry:
  ...
  %iBucket = alloca i64, align 8
  %canary = alloca i32
  store i32 345515408, i32* %canary
  %Bmin.addr = alloca i64*, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
  store i64* %Bmin, i64** %Bmin.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_buffer.15(i64 %NumberLeakyBuckets, i64* %Rmin, i64* %Bmin, i64* %Fmin) #0 {
entry:
  %Rmin.addr = alloca i64*, align 8
  %outf = alloca %struct._IO_FILE*, align 8
  %Bmin.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 8436961, i32* %canary
  %Fmin.addr = alloca i64*, align 8
  %iBucket = alloca i64, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 105111418, i32* %canary
  %i = alloca i64, align 8
  %buf = alloca i64, align 8
  %Rmin.addr = alloca i64*, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
...
entry:
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 494909804, i32* %canary
  %f = alloca %struct._IO_FILE*, align 8
  %i = alloca i64, align 8
  %Rmin.addr = alloca i64*, align 8
  %retval = alloca i32, align 4
...
entry:
  ...
  %Rmin.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 1001646877, i32* %canary
  %temp = alloca i64, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
...
entry:
  ...
  %outf = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 428768733, i32* %canary
  %Rmin.addr = alloca i64*, align 8
  %Fmin.addr = alloca i64*, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_buffer.20(i64 %NumberLeakyBuckets, i64* %Rmin, i64* %Bmin, i64* %Fmin) #0 {
entry:
  %Bmin.addr = alloca i64*, align 8
  %Rmin.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 559769224, i32* %canary
  %iBucket = alloca i64, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %outf = alloca %struct._IO_FILE*, align 8
  %Fmin.addr = alloca i64*, align 8
...
entry:
  %Fmin.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 1149224047, i32* %canary
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %outf = alloca %struct._IO_FILE*, align 8
  %Bmin.addr = alloca i64*, align 8
  %Rmin.addr = alloca i64*, align 8
...
entry:
  ...
  %i = alloca i64, align 8
  %canary = alloca i32
  store i32 105301031, i32* %canary
  %temp = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
  store i64 0, i64* %i, align 8
...
entry:
  ...
  %iBucket = alloca i64, align 8
  %canary = alloca i32
  store i32 912755638, i32* %canary
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %outf = alloca %struct._IO_FILE*, align 8
  %Rmin.addr = alloca i64*, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
...
entry:
  ...
  %iBucket = alloca i64, align 8
  %canary = alloca i32
  store i32 390829878, i32* %canary
  %Bmin = alloca i64*, align 8
  %iFrame = alloca i64, align 8
  %Fmin = alloca i64*, align 8
  %TotalRate = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @calc_buffer.26() #0 {
entry:
  %iChannelRate = alloca i64, align 8
  %Fmin = alloca i64*, align 8
  %buffer_frame = alloca i64*, align 8
  ...
  %minB = alloca i64, align 8
  %canary = alloca i32
  store i32 182736365, i32* %canary
  %Rmin = alloca i64*, align 8
  %NumberLeakyBuckets = alloca i64, align 8
  %InitFullness = alloca i64, align 8
  store i64 0, i64* %FrameIndex, align 8
...
entry:
  %canary = alloca i32
  store i32 1553804992, i32* %canary
  %temp = alloca i64, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %j = alloca i64, align 8
  %i = alloca i64, align 8
...
entry:
  ...
  %Rmin.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 2135053152, i32* %canary
  %j = alloca i64, align 8
  %i = alloca i64, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
...
entry:
  ...
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 2034756989, i32* %canary
  %i = alloca i64, align 8
  %retval = alloca i32, align 4
  %Rmin.addr = alloca i64*, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @calc_buffer.30() #0 {
entry:
  %iChannelRate = alloca i64, align 8
  %NumberLeakyBuckets = alloca i64, align 8
  %minB = alloca i64, align 8
  ...
  %Rmin = alloca i64*, align 8
  %canary = alloca i32
  store i32 606420990, i32* %canary
  %iBucket = alloca i64, align 8
  %InitFullness = alloca i64, align 8
  store i64 0, i64* %FrameIndex, align 8
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8
...
entry:
  ...
  %InitFullness = alloca i64, align 8
  %canary = alloca i32
  store i32 121257902, i32* %canary
  %iChannelRate = alloca i64, align 8
  %AvgRate = alloca i64, align 8
  %iFrame = alloca i64, align 8
  %actualBuffer = alloca i64, align 8
...
entry:
  ...
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 447615264, i32* %canary
  %i = alloca i64, align 8
  %retval = alloca i32, align 4
  %f = alloca %struct._IO_FILE*, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
...
entry:
  ...
  %iBucket = alloca i64, align 8
  %canary = alloca i32
  store i32 1069886413, i32* %canary
  %AvgRate = alloca i64, align 8
  %iChannelRate = alloca i64, align 8
  %Bmin = alloca i64*, align 8
  %Fmin = alloca i64*, align 8
...
for.end136:                                       ; preds = %for.cond57
  ...
  call void @free(i8* %148) #3
  %149 = load i32, i32* %canary
  %150 = icmp eq i32 %149, 1069886413
  br i1 %150, label %151, label %func_exit
...
entry:
  %InitFullness = alloca i64, align 8
  %canary = alloca i32
  store i32 1085613895, i32* %canary
  %NumberLeakyBuckets = alloca i64, align 8
  %Fmin = alloca i64*, align 8
  %iBucket = alloca i64, align 8
  %FrameIndex = alloca i64, align 8
...
for.end136:                                       ; preds = %for.cond57
  ...
  call void @free(i8* %148) #3
  %149 = load i32, i32* %canary
  %150 = icmp eq i32 %149, 1085613895
  br i1 %150, label %151, label %func_exit
