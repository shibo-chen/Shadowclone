; ModuleID = 'q_matrix.c.rand.4P2.bc'
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_CheckParameterName.10, label %ctrl0

func_CheckParameterName.10:                       ; preds = %rand_bb
  %2 = call i32 @CheckParameterName.10(i8* %s, i32* %type)
  ret i32 %2
...
func_CheckParameterName.14:                       ; preds = %ctrl1
  %4 = call i32 @CheckParameterName.14(i8* %s, i32* %type)
  ret i32 %4

func_CheckParameterName.15:                       ; preds = %ctrl1
  %5 = call i32 @CheckParameterName.15(i8* %s, i32* %type)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_CheckParameterName.12, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_CheckParameterName.14, label %func_CheckParameterName.15
}
...
func_ParseMatrix.2:                               ; preds = %ctrl0
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_ParseMatrix.2, label %ctrl1
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_PatchMatrix.3, label %ctrl0

func_PatchMatrix.3:                               ; preds = %rand_bb
  call void @PatchMatrix.3()
  ret void

func_PatchMatrix.4:                               ; preds = %ctrl0
  call void @PatchMatrix.4()
  ret void

func_PatchMatrix.9:                               ; preds = %ctrl1
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_PatchMatrix.4, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_PatchMatrix.9, label %func_PatchMatrix.11
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_CalculateQuantParam.7, label %ctrl0

func_CalculateQuantParam.7:                       ; preds = %rand_bb
  call void @CalculateQuantParam.7()
  ret void

func_CalculateQuantParam.8:                       ; preds = %ctrl0
  call void @CalculateQuantParam.8()
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_CalculateQuantParam.8, label %ctrl1
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_CalculateQuant8Param.5, label %ctrl0

func_CalculateQuant8Param.5:                      ; preds = %rand_bb
  call void @CalculateQuant8Param.5()
  ret void
...
func_CalculateQuant8Param.16:                     ; preds = %ctrl1
  call void @CalculateQuant8Param.16()
  ret void

func_CalculateQuant8Param.17:                     ; preds = %ctrl1
  call void @CalculateQuant8Param.17()
  ret void
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_CalculateQuant8Param.16, label %func_CalculateQuant8Param.17
}
...
entry:
  ...
  %canary = alloca i32
  store i32 1262469754, i32* %canary
...
entry:
  ...
  %item = alloca i32, align 4
  %canary = alloca i32
  store i32 2105756610, i32* %canary
  %p = alloca i8*, align 8
  %InString = alloca i32, align 4
  %j = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @PatchMatrix.3() #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1953244376, i32* %canary
  %cnt = alloca i32, align 4
  %ScalingList = alloca i16*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @PatchMatrix.4() #0 {
entry:
  %canary = alloca i32
  store i32 362301642, i32* %canary
  %fail = alloca i32, align 4
  %ScalingList = alloca i16*, align 8
  %i = alloca i32, align 4
  %cnt = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @CalculateQuant8Param.5() #0 {
entry:
  %canary = alloca i32
  store i32 281413348, i32* %canary
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1733836932, i32* %canary
  %present = alloca [2 x i32], align 4
  %temp = alloca i32, align 4
  store i32 0, i32* %no_q_matrix, align 4
  %0 = load %struct.seq_parameter_set_rbsp_t*, %struct.seq_parameter_set_rbsp_t** @active_sps, align 8
...
if.end257:                                        ; preds = %for.end256, %for.end91
  %141 = load i32, i32* %canary
  %142 = icmp eq i32 %141, 1733836932
  br i1 %142, label %143, label %func_exit
...
entry:
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 123004121, i32* %canary
  %i = alloca i32, align 4
  %k = alloca i32, align 4
  %no_q_matrix = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @CalculateQuantParam.8() #0 {
entry:
  %j = alloca i32, align 4
  %no_q_matrix = alloca i32, align 4
  %k = alloca i32, align 4
  %canary = alloca i32
  store i32 1250848114, i32* %canary
  %i = alloca i32, align 4
  %temp = alloca i32, align 4
  %present = alloca [6 x i32], align 16
  store i32 0, i32* %no_q_matrix, align 4
...
if.end682:                                        ; preds = %for.end681, %for.end200
  %359 = load i32, i32* %canary
  %360 = icmp eq i32 %359, 1250848114
  br i1 %360, label %361, label %func_exit
...
entry:
  %canary = alloca i32
  store i32 541529271, i32* %canary
  %ScalingList = alloca i16*, align 8
  %fail = alloca i32, align 4
  %cnt = alloca i32, align 4
  %i = alloca i32, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 2090845914, i32* %canary
  %i = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1523124037, i32* %canary
  %ScalingList = alloca i16*, align 8
  %cnt = alloca i32, align 4
  %i = alloca i32, align 4
  %fail = alloca i32, align 4
...
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 550573295, i32* %canary
  %s.addr = alloca i8*, align 8
  %retval = alloca i32, align 4
  %type.addr = alloca i32*, align 8
  store i8* %s, i8** %s.addr, align 8
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1468182977, i32* %canary
  %k = alloca i32, align 4
  %present = alloca [6 x i32], align 16
  %temp = alloca i32, align 4
  %no_q_matrix = alloca i32, align 4
...
if.end682:                                        ; preds = %for.end681, %for.end200
  %359 = load i32, i32* %canary
  %360 = icmp eq i32 %359, 1468182977
  br i1 %360, label %361, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @CheckParameterName.14(i8* %s, i32* %type) #0 {
entry:
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1676052877, i32* %canary
  %s.addr = alloca i8*, align 8
  %i = alloca i32, align 4
  %type.addr = alloca i32*, align 8
  store i8* %s, i8** %s.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @CheckParameterName.15(i8* %s, i32* %type) #0 {
entry:
  %type.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 1081950278, i32* %canary
  %s.addr = alloca i8*, align 8
  %retval = alloca i32, align 4
  %i = alloca i32, align 4
  store i8* %s, i8** %s.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @CalculateQuant8Param.16() #0 {
entry:
  %canary = alloca i32
  store i32 1999387526, i32* %canary
  %temp = alloca i32, align 4
  %present = alloca [2 x i32], align 4
  %no_q_matrix = alloca i32, align 4
  %k = alloca i32, align 4
...
if.end257:                                        ; preds = %for.end256, %for.end91
  %141 = load i32, i32* %canary
  %142 = icmp eq i32 %141, 1999387526
  br i1 %142, label %143, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @CalculateQuant8Param.17() #0 {
entry:
  %i = alloca i32, align 4
  %temp = alloca i32, align 4
  %j = alloca i32, align 4
  %present = alloca [2 x i32], align 4
  %canary = alloca i32
  store i32 592847654, i32* %canary
  %k = alloca i32, align 4
  %no_q_matrix = alloca i32, align 4
  store i32 0, i32* %no_q_matrix, align 4
  %0 = load %struct.seq_parameter_set_rbsp_t*, %struct.seq_parameter_set_rbsp_t** @active_sps, align 8
...
entry:
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 321048769, i32* %canary
  %temp = alloca i32, align 4
  %no_q_matrix = alloca i32, align 4
  %i = alloca i32, align 4
  %present = alloca [6 x i32], align 16
...
entry:
  ...
  %item = alloca i32, align 4
  %canary = alloca i32
  store i32 887223875, i32* %canary
  %IntContent = alloca i32, align 4
  %type = alloca i32, align 4
  %items = alloca [1000 x i8*], align 16
  %cnt = alloca i32, align 4
...
entry:
  ...
  %cnt = alloca i32, align 4
  %canary = alloca i32
  store i32 1704244067, i32* %canary
  %item = alloca i32, align 4
  %MapIdx = alloca i32, align 4
  %type = alloca i32, align 4
  %IntContent = alloca i32, align 4
