; ModuleID = 'leaky_bucket.c.rand.8R1.bc'
...
func_get_LeakyBucketRate.9:                       ; preds = %ctrl0
  %3 = call i32 @get_LeakyBucketRate.9(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret i32 %3

func_get_LeakyBucketRate.10:                      ; preds = %ctrl1
  %4 = call i32 @get_LeakyBucketRate.10(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret i32 %4
...
func_get_LeakyBucketRate.26:                      ; preds = %ctrl5
  %9 = call i32 @get_LeakyBucketRate.26(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret i32 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_get_LeakyBucketRate.9, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_get_LeakyBucketRate.10, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_get_LeakyBucketRate.13, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_get_LeakyBucketRate.19, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_get_LeakyBucketRate.20, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_get_LeakyBucketRate.21, label %func_get_LeakyBucketRate.26
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_PutBigDoubleWord.1, label %func_PutBigDoubleWord.2

func_PutBigDoubleWord.1:                          ; preds = %rand_bb
  call void @PutBigDoubleWord.1(i64 %dw, %struct._IO_FILE* %fp)
  ret void
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_write_buffer.3, label %ctrl0

func_write_buffer.3:                              ; preds = %rand_bb
  call void @write_buffer.3(i64 %NumberLeakyBuckets, i64* %Rmin, i64* %Bmin, i64* %Fmin)
  ret void

func_write_buffer.6:                              ; preds = %ctrl0
  call void @write_buffer.6(i64 %NumberLeakyBuckets, i64* %Rmin, i64* %Bmin, i64* %Fmin)
  ret void

func_write_buffer.8:                              ; preds = %ctrl1
...
func_write_buffer.23:                             ; preds = %ctrl5
  call void @write_buffer.23(i64 %NumberLeakyBuckets, i64* %Rmin, i64* %Bmin, i64* %Fmin)
  ret void

func_write_buffer.24:                             ; preds = %ctrl5
  call void @write_buffer.24(i64 %NumberLeakyBuckets, i64* %Rmin, i64* %Bmin, i64* %Fmin)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_write_buffer.6, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_write_buffer.8, label %ctrl2
...
ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_write_buffer.23, label %func_write_buffer.24
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_Sort.5, label %ctrl0

func_Sort.5:                                      ; preds = %rand_bb
  call void @Sort.5(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret void
...
func_Sort.33:                                     ; preds = %ctrl5
  call void @Sort.33(i64 %NumberLeakyBuckets, i64* %Rmin)
  ret void
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_Sort.27, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_Sort.28, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_Sort.29, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_Sort.30, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_Sort.32, label %func_Sort.33
}
...
func_calc_buffer.16:                              ; preds = %ctrl0
...
func_calc_buffer.18:                              ; preds = %ctrl2
  call void @calc_buffer.18()
  ret void

func_calc_buffer.22:                              ; preds = %ctrl3
...
func_calc_buffer.34:                              ; preds = %ctrl5
  call void @calc_buffer.34()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_calc_buffer.16, label %ctrl1
...
ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_calc_buffer.18, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_calc_buffer.22, label %ctrl4
...
ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_calc_buffer.31, label %func_calc_buffer.34
}
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @PutBigDoubleWord.1(i64 %dw, %struct._IO_FILE* %fp) #0 {
entry:
  %canary = alloca i32
  store i32 1145886529, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1759612858, i32* %canary
  %fp.addr = alloca %struct._IO_FILE*, align 8
  %dw.addr = alloca i64, align 8
  store i64 %dw, i64* %dw.addr, align 8
  store %struct._IO_FILE* %fp, %struct._IO_FILE** %fp.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_buffer.3(i64 %NumberLeakyBuckets, i64* %Rmin, i64* %Bmin, i64* %Fmin) #0 {
entry:
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %outf = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 18068569, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1050356869, i32* %canary
...
for.end136:                                       ; preds = %for.cond57
  ...
  %150 = icmp eq i32 %149, 1050356869
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Sort.5(i64 %NumberLeakyBuckets, i64* %Rmin) #0 {
entry:
  %Rmin.addr = alloca i64*, align 8
  %i = alloca i64, align 8
  %canary = alloca i32
  store i32 1255820377, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 981712395, i32* %canary
  %NumberLeakyBuckets.addr = alloca i64, align 8
...
entry:
  %canary = alloca i32
  store i32 588466281, i32* %canary
  %iBucket = alloca i64, align 8
  %Rmin.addr = alloca i64*, align 8
  %Fmin.addr = alloca i64*, align 8
  %outf = alloca %struct._IO_FILE*, align 8
...
entry:
  %canary = alloca i32
  store i32 1971298510, i32* %canary
  %Rmin.addr = alloca i64*, align 8
  %i = alloca i64, align 8
  %retval = alloca i32, align 4
  %buf = alloca i64, align 8
...
entry:
  ...
  %Bmin.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 535092478, i32* %canary
  %Fmin.addr = alloca i64*, align 8
  %outf = alloca %struct._IO_FILE*, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
...
entry:
  ...
  %outf = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 1953353793, i32* %canary
  %Bmin.addr = alloca i64*, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
  store i64* %Bmin, i64** %Bmin.addr, align 8
...
entry:
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1919095234, i32* %canary
  %f = alloca %struct._IO_FILE*, align 8
  %i = alloca i64, align 8
  %Rmin.addr = alloca i64*, align 8
  %buf = alloca i64, align 8
...
entry:
  ...
  %outf = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 521521553, i32* %canary
  %Rmin.addr = alloca i64*, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
  store i64* %Bmin, i64** %Bmin.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1248706350, i32* %canary
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %Rmin.addr = alloca i64*, align 8
  %j = alloca i64, align 8
  %temp = alloca i64, align 8
...
entry:
  ...
  %maxBuffer = alloca i64, align 8
  %canary = alloca i32
  store i32 520521793, i32* %canary
  %iBucket = alloca i64, align 8
  %iChannelRate = alloca i64, align 8
  %Rmin = alloca i64*, align 8
  %iFrame = alloca i64, align 8
...
entry:
  ...
  %Fmin = alloca i64*, align 8
  %canary = alloca i32
  store i32 1615550213, i32* %canary
  %NumberLeakyBuckets = alloca i64, align 8
  %FrameIndex = alloca i64, align 8
  %Bmin = alloca i64*, align 8
  %buffer_frame = alloca i64*, align 8
...
for.end136:                                       ; preds = %for.cond57
  ...
  call void @free(i8* %148) #3
  %149 = load i32, i32* %canary
  %150 = icmp eq i32 %149, 1615550213
  br i1 %150, label %151, label %func_exit
...
entry:
  ...
  %Rmin = alloca i64*, align 8
  %canary = alloca i32
  store i32 1023260357, i32* %canary
  %AvgRate = alloca i64, align 8
  %iFrame = alloca i64, align 8
  %iChannelRate = alloca i64, align 8
  %InitFullness = alloca i64, align 8
...
for.end136:                                       ; preds = %for.cond57
  ...
  call void @free(i8* %148) #3
  %149 = load i32, i32* %canary
  %150 = icmp eq i32 %149, 1023260357
  br i1 %150, label %151, label %func_exit
...
entry:
  ...
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1708486202, i32* %canary
  %Rmin.addr = alloca i64*, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
  %0 = load %struct.InputParameters*, %struct.InputParameters** @input, align 8
...
entry:
  %f = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 1122288583, i32* %canary
  %retval = alloca i32, align 4
  %i = alloca i64, align 8
  %buf = alloca i64, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
...
entry:
  ...
  %f = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 708070512, i32* %canary
  %i = alloca i64, align 8
  %Rmin.addr = alloca i64*, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_buffer.23(i64 %NumberLeakyBuckets, i64* %Rmin, i64* %Bmin, i64* %Fmin) #0 {
entry:
  %iBucket = alloca i64, align 8
  %outf = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 958190023, i32* %canary
  %Rmin.addr = alloca i64*, align 8
  %Bmin.addr = alloca i64*, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %Fmin.addr = alloca i64*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @write_buffer.24(i64 %NumberLeakyBuckets, i64* %Rmin, i64* %Bmin, i64* %Fmin) #0 {
entry:
  %iBucket = alloca i64, align 8
  %outf = alloca %struct._IO_FILE*, align 8
  %Bmin.addr = alloca i64*, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1372809853, i32* %canary
  %Rmin.addr = alloca i64*, align 8
  %Fmin.addr = alloca i64*, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
...
entry:
  ...
  %AvgRate = alloca i64, align 8
  %canary = alloca i32
  store i32 1633734664, i32* %canary
  %iBucket = alloca i64, align 8
  %actualBuffer = alloca i64, align 8
  %iChannelRate = alloca i64, align 8
  %maxBuffer = alloca i64, align 8
...
for.end136:                                       ; preds = %for.cond57
  ...
  call void @free(i8* %148) #3
  %149 = load i32, i32* %canary
  %150 = icmp eq i32 %149, 1633734664
  br i1 %150, label %151, label %func_exit
...
entry:
  %buf = alloca i64, align 8
  %canary = alloca i32
  store i32 1301285991, i32* %canary
  %i = alloca i64, align 8
  %retval = alloca i32, align 4
  %Rmin.addr = alloca i64*, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
...
entry:
  ...
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 410734949, i32* %canary
  %temp = alloca i64, align 8
  %Rmin.addr = alloca i64*, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
...
entry:
  %Rmin.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 1419682960, i32* %canary
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %temp = alloca i64, align 8
  %j = alloca i64, align 8
  %i = alloca i64, align 8
...
entry:
  ...
  %temp = alloca i64, align 8
  %canary = alloca i32
  store i32 1878946674, i32* %canary
  %i = alloca i64, align 8
  %Rmin.addr = alloca i64*, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
...
entry:
  ...
  %j = alloca i64, align 8
  %canary = alloca i32
  store i32 2068179149, i32* %canary
  %NumberLeakyBuckets.addr = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
  store i64 0, i64* %i, align 8
...
entry:
  ...
  %maxBuffer = alloca i64, align 8
  %canary = alloca i32
  store i32 1161875922, i32* %canary
  %actualBuffer = alloca i64, align 8
  %TotalRate = alloca i64, align 8
  %Bmin = alloca i64*, align 8
  %FrameIndex = alloca i64, align 8
...
for.end136:                                       ; preds = %for.cond57
  ...
  call void @free(i8* %148) #3
  %149 = load i32, i32* %canary
  %150 = icmp eq i32 %149, 1161875922
  br i1 %150, label %151, label %func_exit
...
entry:
  ...
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1298488316, i32* %canary
  %j = alloca i64, align 8
  %temp = alloca i64, align 8
  %i = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Sort.33(i64 %NumberLeakyBuckets, i64* %Rmin) #0 {
entry:
  %Rmin.addr = alloca i64*, align 8
  %temp = alloca i64, align 8
  %NumberLeakyBuckets.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 272109268, i32* %canary
  %j = alloca i64, align 8
  %i = alloca i64, align 8
  store i64 %NumberLeakyBuckets, i64* %NumberLeakyBuckets.addr, align 8
  store i64* %Rmin, i64** %Rmin.addr, align 8
...
entry:
  ...
  %iChannelRate = alloca i64, align 8
  %canary = alloca i32
  store i32 1157037996, i32* %canary
  %TotalRate = alloca i64, align 8
  store i64 0, i64* %FrameIndex, align 8
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8
  %call = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %0, i8* getelementptr inbounds ([81 x i8], [81 x i8]* @.str.8, i64 0, i64 0))
...
for.end136:                                       ; preds = %for.cond57
  ...
  call void @free(i8* %148) #3
  %149 = load i32, i32* %canary
  %150 = icmp eq i32 %149, 1157037996
  br i1 %150, label %151, label %func_exit
