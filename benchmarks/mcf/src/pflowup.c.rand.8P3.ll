; ModuleID = 'pflowup.c.rand.8P3.bc'
...
entry:
  ...
  %canary = alloca i32
  store i32 2082957962, i32* %canary
...
entry:
  %iplus.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1710897388, i32* %canary
  %jplus.addr = alloca %struct.node*, align 8
  %w.addr = alloca %struct.node*, align 8
  store %struct.node* %iplus, %struct.node** %iplus.addr, align 8
  store %struct.node* %jplus, %struct.node** %jplus.addr, align 8
...
entry:
  %jplus.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 2022269868, i32* %canary
  %w.addr = alloca %struct.node*, align 8
  %iplus.addr = alloca %struct.node*, align 8
  store %struct.node* %iplus, %struct.node** %iplus.addr, align 8
  store %struct.node* %jplus, %struct.node** %jplus.addr, align 8
...
entry:
  ...
  %w.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 580583860, i32* %canary
  %jplus.addr = alloca %struct.node*, align 8
  store %struct.node* %iplus, %struct.node** %iplus.addr, align 8
  store %struct.node* %jplus, %struct.node** %jplus.addr, align 8
  store %struct.node* %w, %struct.node** %w.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 582004191, i32* %canary
  %w.addr = alloca %struct.node*, align 8
  %jplus.addr = alloca %struct.node*, align 8
  %iplus.addr = alloca %struct.node*, align 8
  store %struct.node* %iplus, %struct.node** %iplus.addr, align 8
...
entry:
  %jplus.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 673067653, i32* %canary
  %iplus.addr = alloca %struct.node*, align 8
  %w.addr = alloca %struct.node*, align 8
  store %struct.node* %iplus, %struct.node** %iplus.addr, align 8
  store %struct.node* %jplus, %struct.node** %jplus.addr, align 8
