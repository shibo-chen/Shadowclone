...
# %bb.0:                                # %entry
	...
	.cfi_offset %rbx, -24
	xorl	%eax, %eax
	movl	$737586404, -60(%rbp)   # imm = 0x2BF6ACE4
	movq	%rdi, -80(%rbp)
	movq	%rsi, -24(%rbp)
	movq	$0, -40(%rbp)
	movq	-24(%rbp), %rcx
...
.LBB1_26:                               # %return
	movq	-56(%rbp), %rbx
	cmpl	$737586404, -60(%rbp)   # imm = 0x2BF6ACE4
	jne	.LBB1_28
.LBB1_27:
	movq	%rbx, %rax
	addq	$72, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_offset %rbx, -24
	xorl	%eax, %eax
	movl	$79609889, -60(%rbp)    # imm = 0x4BEC021
	movq	%rdi, -80(%rbp)
	movq	%rsi, -40(%rbp)
	movq	$0, -32(%rbp)
	movq	-40(%rbp), %rcx
...
.LBB2_26:                               # %return
	movq	-56(%rbp), %rbx
	cmpl	$79609889, -60(%rbp)    # imm = 0x4BEC021
	jne	.LBB2_28
.LBB2_27:
	movq	%rbx, %rax
	addq	$72, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_offset %rbx, -24
	xorl	%eax, %eax
	movl	$1444218619, -60(%rbp)  # imm = 0x561506FB
	movq	%rdi, -72(%rbp)
	movq	%rsi, -24(%rbp)
	movq	$0, -32(%rbp)
	movq	-24(%rbp), %rcx
...
.LBB3_26:                               # %return
	movq	-56(%rbp), %rbx
	cmpl	$1444218619, -60(%rbp)  # imm = 0x561506FB
	jne	.LBB3_28
.LBB3_27:
	movq	%rbx, %rax
	addq	$72, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_offset %rbx, -24
	xorl	%eax, %eax
	movl	$953138984, -60(%rbp)   # imm = 0x38CFBF28
	movq	%rdi, -80(%rbp)
	movq	%rsi, -32(%rbp)
	movq	$0, -40(%rbp)
	movq	-32(%rbp), %rcx
...
.LBB4_26:                               # %return
	movq	-56(%rbp), %rbx
	cmpl	$953138984, -60(%rbp)   # imm = 0x38CFBF28
	jne	.LBB4_28
.LBB4_27:
	movq	%rbx, %rax
	addq	$72, %rsp
