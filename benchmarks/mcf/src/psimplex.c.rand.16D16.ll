; ModuleID = 'psimplex.c.rand.16D16.bc'
...
entry:
  ...
  %canary = alloca i32
  store i32 1647967380, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 636679834, i32* %canary
  %new_flow = alloca i64, align 8
  %checksum = alloca i64*, align 8
  %new_set = alloca i64, align 8
  %jplus = alloca %struct.node*, align 8
...
entry:
  ...
  %red_cost_of_bea = alloca i64, align 8
  %canary = alloca i32
  store i32 240983104, i32* %canary
  %m = alloca i64, align 8
  %new_set = alloca i64, align 8
  %stop_arcs = alloca %struct.arc*, align 8
  %iterations = alloca i64*, align 8
...
entry:
  ...
  %temp = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 297684664, i32* %canary
  %bea = alloca %struct.arc*, align 8
  %iterations = alloca i64*, align 8
  %m = alloca i64, align 8
  %iplus = alloca %struct.node*, align 8
...
entry:
  ...
  %red_cost_of_bea = alloca i64, align 8
  %canary = alloca i32
  store i32 127123238, i32* %canary
  %iminus = alloca %struct.node*, align 8
  %new_orientation = alloca i64, align 8
  %temp = alloca %struct.node*, align 8
  %new_flow = alloca i64, align 8
...
entry:
  ...
  %bea = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1625603572, i32* %canary
  %new_flow = alloca i64, align 8
  %jminus = alloca %struct.node*, align 8
  %jplus = alloca %struct.node*, align 8
  %arcs = alloca %struct.arc*, align 8
...
entry:
  ...
  %bea = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 514972205, i32* %canary
  %temp = alloca %struct.node*, align 8
  %new_orientation = alloca i64, align 8
  %jminus = alloca %struct.node*, align 8
  %iplus = alloca %struct.node*, align 8
...
entry:
  ...
  %stop_arcs = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1696536666, i32* %canary
  %new_flow = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 0, i64* %opt, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
...
entry:
  ...
  %stop_arcs = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1110979795, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %m = alloca i64, align 8
  %bound_exchanges = alloca i64*, align 8
  %opt = alloca i64, align 8
...
entry:
  ...
  %checksum = alloca i64*, align 8
  %canary = alloca i32
  store i32 613161706, i32* %canary
  %iminus = alloca %struct.node*, align 8
  %opt = alloca i64, align 8
  %iplus = alloca %struct.node*, align 8
  %arcs = alloca %struct.arc*, align 8
...
entry:
  ...
  %opt = alloca i64, align 8
  %canary = alloca i32
  store i32 2024904190, i32* %canary
  %iminus = alloca %struct.node*, align 8
  %bla = alloca %struct.arc*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 0, i64* %opt, align 8
...
entry:
  ...
  %jminus = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1041911147, i32* %canary
  %temp = alloca %struct.node*, align 8
  %new_orientation = alloca i64, align 8
  %jplus = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  ...
  %opt = alloca i64, align 8
  %canary = alloca i32
  store i32 616062428, i32* %canary
  %iminus = alloca %struct.node*, align 8
  %xchange = alloca i64, align 8
  %iterations = alloca i64*, align 8
  %stop_arcs = alloca %struct.arc*, align 8
...
entry:
  %new_orientation = alloca i64, align 8
  %canary = alloca i32
  store i32 282214576, i32* %canary
  %m = alloca i64, align 8
  %temp = alloca %struct.node*, align 8
  %red_cost_of_bea = alloca i64, align 8
  %bla = alloca %struct.arc*, align 8
...
entry:
  ...
  %stop_arcs = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1665685532, i32* %canary
  %checksum = alloca i64*, align 8
  %bound_exchanges = alloca i64*, align 8
  %bla = alloca %struct.arc*, align 8
  %new_set = alloca i64, align 8
...
entry:
  %canary = alloca i32
  store i32 1028713303, i32* %canary
  %iminus = alloca %struct.node*, align 8
  %m = alloca i64, align 8
  %red_cost_of_bea = alloca i64, align 8
  %checksum = alloca i64*, align 8
