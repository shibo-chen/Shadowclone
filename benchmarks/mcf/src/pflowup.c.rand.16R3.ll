; ModuleID = 'pflowup.c.rand.16R3.bc'
...
entry:
  %canary = alloca i32
  store i32 741790087, i32* %canary
...
entry:
  %iplus.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1208642089, i32* %canary
  %jplus.addr = alloca %struct.node*, align 8
  %w.addr = alloca %struct.node*, align 8
  store %struct.node* %iplus, %struct.node** %iplus.addr, align 8
  store %struct.node* %jplus, %struct.node** %jplus.addr, align 8
...
entry:
  ...
  %iplus.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1157052721, i32* %canary
  %w.addr = alloca %struct.node*, align 8
  store %struct.node* %iplus, %struct.node** %iplus.addr, align 8
  store %struct.node* %jplus, %struct.node** %jplus.addr, align 8
  store %struct.node* %w, %struct.node** %w.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1311926707, i32* %canary
  %jplus.addr = alloca %struct.node*, align 8
  %w.addr = alloca %struct.node*, align 8
  %iplus.addr = alloca %struct.node*, align 8
  store %struct.node* %iplus, %struct.node** %iplus.addr, align 8
...
entry:
  %w.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 186033613, i32* %canary
  %iplus.addr = alloca %struct.node*, align 8
  %jplus.addr = alloca %struct.node*, align 8
  store %struct.node* %iplus, %struct.node** %iplus.addr, align 8
  store %struct.node* %jplus, %struct.node** %jplus.addr, align 8
...
entry:
  ...
  %w.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1890601658, i32* %canary
  %jplus.addr = alloca %struct.node*, align 8
  store %struct.node* %iplus, %struct.node** %iplus.addr, align 8
  store %struct.node* %jplus, %struct.node** %jplus.addr, align 8
  store %struct.node* %w, %struct.node** %w.addr, align 8
