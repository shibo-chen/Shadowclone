; ModuleID = 'pbeampp.c.rand.8P1.bc'
...
func_sort_basket.4:                               ; preds = %ctrl0
...
func_sort_basket.10:                              ; preds = %ctrl4
  call void @sort_basket.10(i64 %min, i64 %max)
  ret void

func_sort_basket.12:                              ; preds = %ctrl5
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_sort_basket.4, label %ctrl1
...
ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_sort_basket.10, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_sort_basket.12, label %func_sort_basket.18
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_primal_bea_mpp.5, label %ctrl0

func_primal_bea_mpp.5:                            ; preds = %rand_bb
  %2 = call %struct.arc* @primal_bea_mpp.5(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea)
  ret %struct.arc* %2

func_primal_bea_mpp.9:                            ; preds = %ctrl0
  %3 = call %struct.arc* @primal_bea_mpp.9(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea)
  ret %struct.arc* %3

func_primal_bea_mpp.11:                           ; preds = %ctrl1
  %4 = call %struct.arc* @primal_bea_mpp.11(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea)
  ret %struct.arc* %4

func_primal_bea_mpp.13:                           ; preds = %ctrl2
  %5 = call %struct.arc* @primal_bea_mpp.13(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea)
  ret %struct.arc* %5

func_primal_bea_mpp.14:                           ; preds = %ctrl3
  %6 = call %struct.arc* @primal_bea_mpp.14(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea)
  ret %struct.arc* %6
...
ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_primal_bea_mpp.9, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_primal_bea_mpp.11, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_primal_bea_mpp.13, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_primal_bea_mpp.14, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_primal_bea_mpp.15, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_primal_bea_mpp.16, label %func_primal_bea_mpp.17
}
...
entry:
  %canary = alloca i32
  store i32 506755452, i32* %canary
...
entry:
  %red_cost.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 2055171911, i32* %canary
  %arc.addr = alloca %struct.arc*, align 8
  store %struct.arc* %arc, %struct.arc** %arc.addr, align 8
  store i64 %red_cost, i64* %red_cost.addr, align 8
  %0 = load i64, i64* %red_cost.addr, align 8
...
entry:
  ...
  %canary = alloca i32
  store i32 1289722234, i32* %canary
...
entry:
  ...
  %r = alloca i64, align 8
  %canary = alloca i32
  store i32 484024043, i32* %canary
  %max.addr = alloca i64, align 8
  store i64 %min, i64* %min.addr, align 8
  store i64 %max, i64* %max.addr, align 8
  %0 = load i64, i64* %min.addr, align 8
...
entry:
  ...
  %canary = alloca i32
  store i32 713380420, i32* %canary
...
entry:
  ...
  %max.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1770172309, i32* %canary
  %min.addr = alloca i64, align 8
  %l = alloca i64, align 8
  store i64 %min, i64* %min.addr, align 8
  store i64 %max, i64* %max.addr, align 8
...
entry:
  %l = alloca i64, align 8
  %canary = alloca i32
  store i32 1248303122, i32* %canary
  %max.addr = alloca i64, align 8
  %cut = alloca i64, align 8
  %min.addr = alloca i64, align 8
  %xchange = alloca %struct.basket*, align 8
...
entry:
  ...
  %min.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1303260834, i32* %canary
  %l = alloca i64, align 8
  store i64 %min, i64* %min.addr, align 8
  store i64 %max, i64* %max.addr, align 8
  %0 = load i64, i64* %min.addr, align 8
...
entry:
  ...
  %m.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 650845598, i32* %canary
  %red_cost = alloca i64, align 8
  %retval = alloca %struct.arc*, align 8
  %old_group_pos = alloca i64, align 8
  %stop_arcs.addr = alloca %struct.arc*, align 8
...
entry:
  ...
  %cut = alloca i64, align 8
  %canary = alloca i32
  store i32 1676606315, i32* %canary
  %max.addr = alloca i64, align 8
  store i64 %min, i64* %min.addr, align 8
  store i64 %max, i64* %max.addr, align 8
  %0 = load i64, i64* %min.addr, align 8
...
entry:
  ...
  %r = alloca i64, align 8
  %canary = alloca i32
  store i32 1023687718, i32* %canary
  %xchange = alloca %struct.basket*, align 8
  %min.addr = alloca i64, align 8
  %l = alloca i64, align 8
  store i64 %min, i64* %min.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 650022473, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %red_cost = alloca i64, align 8
  %i = alloca i64, align 8
  %next = alloca i64, align 8
...
entry:
  %stop_arcs.addr = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 2104270017, i32* %canary
  %i = alloca i64, align 8
  %retval = alloca %struct.arc*, align 8
  %red_cost_of_bea.addr = alloca i64*, align 8
  %old_group_pos = alloca i64, align 8
...
entry:
  %i = alloca i64, align 8
  %canary = alloca i32
  store i32 495018172, i32* %canary
  %retval = alloca %struct.arc*, align 8
  %red_cost_of_bea.addr = alloca i64*, align 8
  %stop_arcs.addr = alloca %struct.arc*, align 8
  %arc = alloca %struct.arc*, align 8
...
entry:
  ...
  %red_cost = alloca i64, align 8
  %canary = alloca i32
  store i32 2092168043, i32* %canary
  %m.addr = alloca i64, align 8
  %arcs.addr = alloca %struct.arc*, align 8
  store i64 %m, i64* %m.addr, align 8
  store %struct.arc* %arcs, %struct.arc** %arcs.addr, align 8
...
entry:
  ...
  %retval = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1427437360, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %next = alloca i64, align 8
  %arcs.addr = alloca %struct.arc*, align 8
  %red_cost = alloca i64, align 8
...
entry:
  ...
  %xchange = alloca %struct.basket*, align 8
  %canary = alloca i32
  store i32 202804686, i32* %canary
  %max.addr = alloca i64, align 8
  %cut = alloca i64, align 8
  store i64 %min, i64* %min.addr, align 8
  store i64 %max, i64* %max.addr, align 8
