...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$48, %rsp
	movl	$990372632, -44(%rbp)   # imm = 0x3B07E318
	movq	%rdi, -32(%rbp)
	movq	-32(%rbp), %rax
	movq	552(%rax), %rax
	movq	%rax, -8(%rbp)
...
.LBB1_10:                               # %for.end21
	...
	movq	-16(%rbp), %rax
	movq	$0, 40(%rax)
	cmpl	$990372632, -44(%rbp)   # imm = 0x3B07E318
	jne	.LBB1_12
.LBB1_11:
	xorl	%eax, %eax
	addq	$48, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$48, %rsp
	movl	$1838439230, -44(%rbp)  # imm = 0x6D945B3E
	movq	%rdi, -32(%rbp)
	movq	-32(%rbp), %rax
	movq	552(%rax), %rax
	movq	%rax, -8(%rbp)
...
.LBB2_10:                               # %for.end21
	...
	movq	-16(%rbp), %rax
	movq	$0, 40(%rax)
	cmpl	$1838439230, -44(%rbp)  # imm = 0x6D945B3E
	jne	.LBB2_12
.LBB2_11:
	xorl	%eax, %eax
	addq	$48, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$48, %rsp
	movl	$365339778, -44(%rbp)   # imm = 0x15C6A482
	movq	%rdi, -32(%rbp)
	movq	-32(%rbp), %rax
	movq	552(%rax), %rax
	movq	%rax, -8(%rbp)
...
.LBB3_10:                               # %for.end21
	...
	movq	-16(%rbp), %rax
	movq	$0, 40(%rax)
	cmpl	$365339778, -44(%rbp)   # imm = 0x15C6A482
	jne	.LBB3_12
.LBB3_11:
	xorl	%eax, %eax
	addq	$48, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$48, %rsp
	movl	$2019961046, -44(%rbp)  # imm = 0x786628D6
	movq	%rdi, -32(%rbp)
	movq	-32(%rbp), %rax
	movq	552(%rax), %rax
	movq	%rax, -8(%rbp)
...
.LBB4_10:                               # %for.end21
	...
	movq	-16(%rbp), %rax
	movq	$0, 40(%rax)
	cmpl	$2019961046, -44(%rbp)  # imm = 0x786628D6
	jne	.LBB4_12
.LBB4_11:
	xorl	%eax, %eax
	addq	$48, %rsp
