...
entry:
  ...
  %canary = alloca i32
  store i32 1468275287, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 837409821, i32* %canary
  %outfile.addr = alloca i8*, align 8
  %arc2 = alloca %struct.arc*, align 8
  %arc = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
...
entry:
  ...
  %first_impl = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1719300115, i32* %canary
  %out = alloca %struct._IO_FILE*, align 8
  %block = alloca %struct.arc*, align 8
  %outfile.addr = alloca i8*, align 8
  store i8* %outfile, i8** %outfile.addr, align 8
...
entry:
  %outfile.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 565892101, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %first_impl = alloca %struct.arc*, align 8
  %out = alloca %struct._IO_FILE*, align 8
  %arc2 = alloca %struct.arc*, align 8
...
entry:
  ...
  %out = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 876579911, i32* %canary
  %arc2 = alloca %struct.arc*, align 8
  %retval = alloca i64, align 8
  %block = alloca %struct.arc*, align 8
  %outfile.addr = alloca i8*, align 8
...
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 574535485, i32* %canary
  %retval = alloca i64, align 8
  store i8* %outfile, i8** %outfile.addr, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store %struct._IO_FILE* null, %struct._IO_FILE** %out, align 8
...
entry:
  %canary = alloca i32
  store i32 1389982821, i32* %canary
  %arc2 = alloca %struct.arc*, align 8
  %arc = alloca %struct.arc*, align 8
  %first_impl = alloca %struct.arc*, align 8
  %outfile.addr = alloca i8*, align 8
...
entry:
  ...
  %arc2 = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1486910232, i32* %canary
  %outfile.addr = alloca i8*, align 8
  %retval = alloca i64, align 8
  %block = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
