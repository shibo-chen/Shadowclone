; ModuleID = 'treeup.c.rand.16P2.bc'
...
entry:
  ...
  %canary = alloca i32
  store i32 334889894, i32* %canary
...
entry:
  ...
  %new_flow.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 696152865, i32* %canary
  %new_pred = alloca %struct.node*, align 8
  %jminus.addr = alloca %struct.node*, align 8
  %new_basic_arc = alloca %struct.arc*, align 8
  %iminus.addr = alloca %struct.node*, align 8
...
entry:
  ...
  %depth_iminus = alloca i64, align 8
  %canary = alloca i32
  store i32 1271279551, i32* %canary
  %w.addr = alloca %struct.node*, align 8
  %new_flow.addr = alloca i64, align 8
  %cycle_ori.addr = alloca i64, align 8
  store i64 %cycle_ori, i64* %cycle_ori.addr, align 8
...
if.end128:                                        ; preds = %for.end127, %for.end108
  %152 = load i32, i32* %canary
  %153 = icmp eq i32 %152, 1271279551
  br i1 %153, label %154, label %func_exit
...
entry:
  ...
  %new_basic_arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 474562823, i32* %canary
  %sigma.addr = alloca i64, align 8
  %feas_tol.addr = alloca i64, align 8
  %new_depth = alloca i64, align 8
  %delta.addr = alloca i64, align 8
...
entry:
  ...
  %sigma.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1469243750, i32* %canary
  %depth_iminus = alloca i64, align 8
  %new_basic_arc = alloca %struct.arc*, align 8
  %new_pred = alloca %struct.node*, align 8
  %new_flow.addr = alloca i64, align 8
...
if.end128:                                        ; preds = %for.end127, %for.end108
  %152 = load i32, i32* %canary
  %153 = icmp eq i32 %152, 1469243750
  br i1 %153, label %154, label %func_exit
...
entry:
  ...
  %new_basic_arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1125519824, i32* %canary
  %jplus.addr = alloca %struct.node*, align 8
  %new_depth = alloca i64, align 8
  %depth_iminus = alloca i64, align 8
  %delta.addr = alloca i64, align 8
...
if.end128:                                        ; preds = %for.end127, %for.end108
  %152 = load i32, i32* %canary
  %153 = icmp eq i32 %152, 1125519824
  br i1 %153, label %154, label %func_exit
...
entry:
  ...
  %jminus.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1605642121, i32* %canary
  %temp = alloca %struct.node*, align 8
  %orientation_temp = alloca i64, align 8
  %sigma.addr = alloca i64, align 8
  store i64 %cycle_ori, i64* %cycle_ori.addr, align 8
...
if.end128:                                        ; preds = %for.end127, %for.end108
  %152 = load i32, i32* %canary
  %153 = icmp eq i32 %152, 1605642121
  br i1 %153, label %154, label %func_exit
...
entry:
  ...
  %cycle_ori.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 271364362, i32* %canary
  %feas_tol.addr = alloca i64, align 8
  %sigma.addr = alloca i64, align 8
  %orientation_temp = alloca i64, align 8
  %new_pred = alloca %struct.node*, align 8
...
entry:
  ...
  %father = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1550880083, i32* %canary
  %orientation_temp = alloca i64, align 8
  %sigma.addr = alloca i64, align 8
  store i64 %cycle_ori, i64* %cycle_ori.addr, align 8
  store i64 %new_orientation, i64* %new_orientation.addr, align 8
...
if.end128:                                        ; preds = %for.end127, %for.end108
  %152 = load i32, i32* %canary
  %153 = icmp eq i32 %152, 1550880083
  br i1 %153, label %154, label %func_exit
...
entry:
  ...
  %delta.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 549869674, i32* %canary
  %cycle_ori.addr = alloca i64, align 8
  %w.addr = alloca %struct.node*, align 8
  %jplus.addr = alloca %struct.node*, align 8
  %basic_arc_temp = alloca %struct.arc*, align 8
...
entry:
  ...
  %sigma.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1040640404, i32* %canary
  %w.addr = alloca %struct.node*, align 8
  %orientation_temp = alloca i64, align 8
  %father = alloca %struct.node*, align 8
  %bea.addr = alloca %struct.arc*, align 8
...
if.end128:                                        ; preds = %for.end127, %for.end108
  %152 = load i32, i32* %canary
  %153 = icmp eq i32 %152, 1040640404
  br i1 %153, label %154, label %func_exit
...
entry:
  ...
  %jminus.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 347547276, i32* %canary
  %temp = alloca %struct.node*, align 8
  %iminus.addr = alloca %struct.node*, align 8
  %father = alloca %struct.node*, align 8
  %new_pred = alloca %struct.node*, align 8
...
entry:
  ...
  %new_orientation.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1174367582, i32* %canary
  %flow_temp = alloca i64, align 8
  %orientation_temp = alloca i64, align 8
  %new_basic_arc = alloca %struct.arc*, align 8
  %iminus.addr = alloca %struct.node*, align 8
...
if.end128:                                        ; preds = %for.end127, %for.end108
  %152 = load i32, i32* %canary
  %153 = icmp eq i32 %152, 1174367582
  br i1 %153, label %154, label %func_exit
...
entry:
  ...
  %depth_temp = alloca i64, align 8
  %canary = alloca i32
  store i32 512575655, i32* %canary
  %cycle_ori.addr = alloca i64, align 8
  %iminus.addr = alloca %struct.node*, align 8
  %basic_arc_temp = alloca %struct.arc*, align 8
  %new_orientation.addr = alloca i64, align 8
