...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$48, %rsp
	movl	$1144052313, -44(%rbp)  # imm = 0x4430DA59
	movq	%rdi, -32(%rbp)
	movq	-32(%rbp), %rax
	movq	552(%rax), %rax
	movq	%rax, -8(%rbp)
...
.LBB1_10:                               # %for.end21
	...
	movq	-16(%rbp), %rax
	movq	$0, 40(%rax)
	cmpl	$1144052313, -44(%rbp)  # imm = 0x4430DA59
	jne	.LBB1_12
.LBB1_11:
	xorl	%eax, %eax
	addq	$48, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$48, %rsp
	movl	$337725178, -44(%rbp)   # imm = 0x142146FA
	movq	%rdi, -32(%rbp)
	movq	-32(%rbp), %rax
	movq	552(%rax), %rax
	movq	%rax, -8(%rbp)
...
.LBB2_10:                               # %for.end21
	...
	movq	-16(%rbp), %rax
	movq	$0, 40(%rax)
	cmpl	$337725178, -44(%rbp)   # imm = 0x142146FA
	jne	.LBB2_12
.LBB2_11:
	xorl	%eax, %eax
	addq	$48, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$48, %rsp
	movl	$634376132, -44(%rbp)   # imm = 0x25CFCFC4
	movq	%rdi, -32(%rbp)
	movq	-32(%rbp), %rax
	movq	552(%rax), %rax
	movq	%rax, -8(%rbp)
...
.LBB3_10:                               # %for.end21
	...
	movq	-16(%rbp), %rax
	movq	$0, 40(%rax)
	cmpl	$634376132, -44(%rbp)   # imm = 0x25CFCFC4
	jne	.LBB3_12
.LBB3_11:
	xorl	%eax, %eax
	addq	$48, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$48, %rsp
	movl	$1575727163, -44(%rbp)  # imm = 0x5DEBB03B
	movq	%rdi, -32(%rbp)
	movq	-32(%rbp), %rax
	movq	552(%rax), %rax
	movq	%rax, -8(%rbp)
...
.LBB4_10:                               # %for.end21
	...
	movq	-16(%rbp), %rax
	movq	$0, 40(%rax)
	cmpl	$1575727163, -44(%rbp)  # imm = 0x5DEBB03B
	jne	.LBB4_12
.LBB4_11:
	xorl	%eax, %eax
	addq	$48, %rsp
