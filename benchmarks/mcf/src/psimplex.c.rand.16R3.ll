; ModuleID = 'psimplex.c.rand.16R3.bc'
...
entry:
  ...
  %canary = alloca i32
  store i32 1560330459, i32* %canary
...
entry:
  ...
  %bla = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 667751109, i32* %canary
  %m = alloca i64, align 8
  %new_set = alloca i64, align 8
  %bea = alloca %struct.arc*, align 8
  %red_cost_of_bea = alloca i64, align 8
...
entry:
  ...
  %new_flow = alloca i64, align 8
  %canary = alloca i32
  store i32 866635442, i32* %canary
  %iterations = alloca i64*, align 8
  %arcs = alloca %struct.arc*, align 8
  %w = alloca %struct.node*, align 8
  %red_cost_of_bea = alloca i64, align 8
...
entry:
  ...
  %iminus = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 936229145, i32* %canary
  %checksum = alloca i64*, align 8
  %m = alloca i64, align 8
  %temp = alloca %struct.node*, align 8
  %delta = alloca i64, align 8
...
entry:
  %canary = alloca i32
  store i32 905013321, i32* %canary
  %temp = alloca %struct.node*, align 8
  %delta = alloca i64, align 8
  %iminus = alloca %struct.node*, align 8
  %arcs = alloca %struct.arc*, align 8
...
entry:
  ...
  %arcs = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 270113364, i32* %canary
  %jplus = alloca %struct.node*, align 8
  %new_set = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
  %w = alloca %struct.node*, align 8
...
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 255047134, i32* %canary
  %m = alloca i64, align 8
  %red_cost_of_bea = alloca i64, align 8
  %checksum = alloca i64*, align 8
  %new_orientation = alloca i64, align 8
...
entry:
  ...
  %new_flow = alloca i64, align 8
  %canary = alloca i32
  store i32 943429107, i32* %canary
  %iplus = alloca %struct.node*, align 8
  %bea = alloca %struct.arc*, align 8
  %new_orientation = alloca i64, align 8
  %checksum = alloca i64*, align 8
...
entry:
  ...
  %new_orientation = alloca i64, align 8
  %canary = alloca i32
  store i32 446726412, i32* %canary
  %jminus = alloca %struct.node*, align 8
  %jplus = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
  %red_cost_of_bea = alloca i64, align 8
...
entry:
  ...
  %xchange = alloca i64, align 8
  %canary = alloca i32
  store i32 804193919, i32* %canary
  %stop_arcs = alloca %struct.arc*, align 8
  %red_cost_of_bea = alloca i64, align 8
  %bla = alloca %struct.arc*, align 8
  %bea = alloca %struct.arc*, align 8
...
entry:
  ...
  %iterations = alloca i64*, align 8
  %canary = alloca i32
  store i32 853127136, i32* %canary
  %opt = alloca i64, align 8
  %jplus = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
  %stop_arcs = alloca %struct.arc*, align 8
...
entry:
  %iterations = alloca i64*, align 8
  %canary = alloca i32
  store i32 1822201468, i32* %canary
  %bea = alloca %struct.arc*, align 8
  %red_cost_of_bea = alloca i64, align 8
  %arcs = alloca %struct.arc*, align 8
  %w = alloca %struct.node*, align 8
...
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 1528594283, i32* %canary
  %bea = alloca %struct.arc*, align 8
  %opt = alloca i64, align 8
  %bound_exchanges = alloca i64*, align 8
  %jminus = alloca %struct.node*, align 8
...
entry:
  ...
  %stop_arcs = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1018123915, i32* %canary
  %jplus = alloca %struct.node*, align 8
  %iterations = alloca i64*, align 8
  %checksum = alloca i64*, align 8
  %temp = alloca %struct.node*, align 8
...
entry:
  ...
  %checksum = alloca i64*, align 8
  %canary = alloca i32
  store i32 619841904, i32* %canary
  %red_cost_of_bea = alloca i64, align 8
  %temp = alloca %struct.node*, align 8
  %xchange = alloca i64, align 8
  %iminus = alloca %struct.node*, align 8
...
entry:
  ...
  %xchange = alloca i64, align 8
  %canary = alloca i32
  store i32 693266256, i32* %canary
  %bla = alloca %struct.arc*, align 8
  %iplus = alloca %struct.node*, align 8
  %checksum = alloca i64*, align 8
  %jminus = alloca %struct.node*, align 8
