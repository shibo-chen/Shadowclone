...
# %bb.0:                                # %entry
	...
	.cfi_offset %rbx, -24
	movl	$1096369619, -76(%rbp)  # imm = 0x415945D3
	movq	%rdi, -16(%rbp)
	movq	$0, -72(%rbp)
	movq	-16(%rbp), %rdi
	movabsq	$.L.str, %rsi
...
.LBB1_46:                               # %return
	movq	-56(%rbp), %rbx
	cmpl	$1096369619, -76(%rbp)  # imm = 0x415945D3
	jne	.LBB1_48
.LBB1_47:
	movq	%rbx, %rax
...
# %bb.0:                                # %entry
	...
	subq	$296, %rsp              # imm = 0x128
	.cfi_offset %rbx, -24
	movl	$1337167594, -76(%rbp)  # imm = 0x4FB38EEA
	movq	%rdi, -16(%rbp)
	movq	$0, -72(%rbp)
	movq	-16(%rbp), %rdi
	movabsq	$.L.str, %rsi
...
.LBB2_46:                               # %return
	movq	-56(%rbp), %rbx
	cmpl	$1337167594, -76(%rbp)  # imm = 0x4FB38EEA
	jne	.LBB2_48
.LBB2_47:
	movq	%rbx, %rax
	addq	$296, %rsp              # imm = 0x128
...
# %bb.0:                                # %entry
	...
	subq	$296, %rsp              # imm = 0x128
	.cfi_offset %rbx, -24
	movl	$1234636138, -76(%rbp)  # imm = 0x49970D6A
	movq	%rdi, -16(%rbp)
	movq	$0, -72(%rbp)
	movq	-16(%rbp), %rdi
	movabsq	$.L.str, %rsi
...
.LBB3_46:                               # %return
	movq	-56(%rbp), %rbx
	cmpl	$1234636138, -76(%rbp)  # imm = 0x49970D6A
	jne	.LBB3_48
.LBB3_47:
	movq	%rbx, %rax
	addq	$296, %rsp              # imm = 0x128
...
# %bb.0:                                # %entry
	...
	subq	$296, %rsp              # imm = 0x128
	.cfi_offset %rbx, -24
	movl	$1067162416, -76(%rbp)  # imm = 0x3F9B9B30
	movq	%rdi, -16(%rbp)
	movq	$0, -72(%rbp)
	movq	-16(%rbp), %rdi
	movabsq	$.L.str, %rsi
...
.LBB4_46:                               # %return
	movq	-64(%rbp), %rbx
	cmpl	$1067162416, -76(%rbp)  # imm = 0x3F9B9B30
	jne	.LBB4_48
.LBB4_47:
	movq	%rbx, %rax
	addq	$296, %rsp              # imm = 0x128
