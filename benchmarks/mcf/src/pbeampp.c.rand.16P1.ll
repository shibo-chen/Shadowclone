; ModuleID = 'pbeampp.c.rand.16P1.bc'
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_bea_is_dual_infeasible.1, label %func_bea_is_dual_infeasible.2

func_bea_is_dual_infeasible.1:                    ; preds = %rand_bb
  %2 = call i32 @bea_is_dual_infeasible.1(%struct.arc* %arc, i64 %red_cost)
  ret i32 %2

func_bea_is_dual_infeasible.2:                    ; preds = %rand_bb
  %3 = call i32 @bea_is_dual_infeasible.2(%struct.arc* %arc, i64 %red_cost)
  ret i32 %3
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_sort_basket.5, label %ctrl0

func_sort_basket.5:                               ; preds = %rand_bb
  call void @sort_basket.5(i64 %min, i64 %max)
  ret void

func_sort_basket.6:                               ; preds = %ctrl0
  call void @sort_basket.6(i64 %min, i64 %max)
  ret void

func_sort_basket.8:                               ; preds = %ctrl1
  call void @sort_basket.8(i64 %min, i64 %max)
  ret void

func_sort_basket.10:                              ; preds = %ctrl2
  call void @sort_basket.10(i64 %min, i64 %max)
  ret void

func_sort_basket.11:                              ; preds = %ctrl3
  call void @sort_basket.11(i64 %min, i64 %max)
  ret void

func_sort_basket.13:                              ; preds = %ctrl4
  call void @sort_basket.13(i64 %min, i64 %max)
  ret void

func_sort_basket.14:                              ; preds = %ctrl5
  call void @sort_basket.14(i64 %min, i64 %max)
  ret void

func_sort_basket.16:                              ; preds = %ctrl6
  call void @sort_basket.16(i64 %min, i64 %max)
  ret void

func_sort_basket.23:                              ; preds = %ctrl7
  call void @sort_basket.23(i64 %min, i64 %max)
  ret void

func_sort_basket.26:                              ; preds = %ctrl8
  call void @sort_basket.26(i64 %min, i64 %max)
  ret void

func_sort_basket.27:                              ; preds = %ctrl9
  call void @sort_basket.27(i64 %min, i64 %max)
  ret void

func_sort_basket.28:                              ; preds = %ctrl10
  call void @sort_basket.28(i64 %min, i64 %max)
  ret void

func_sort_basket.31:                              ; preds = %ctrl11
  call void @sort_basket.31(i64 %min, i64 %max)
  ret void

func_sort_basket.32:                              ; preds = %ctrl12
  call void @sort_basket.32(i64 %min, i64 %max)
  ret void

func_sort_basket.33:                              ; preds = %ctrl13
  call void @sort_basket.33(i64 %min, i64 %max)
  ret void

func_sort_basket.34:                              ; preds = %ctrl13
  call void @sort_basket.34(i64 %min, i64 %max)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_sort_basket.6, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_sort_basket.8, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_sort_basket.10, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_sort_basket.11, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_sort_basket.13, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_sort_basket.14, label %ctrl6

ctrl6:                                            ; preds = %ctrl5
  %8 = icmp eq i32 %0, 7
  br i1 %8, label %func_sort_basket.16, label %ctrl7

ctrl7:                                            ; preds = %ctrl6
  %9 = icmp eq i32 %0, 8
  br i1 %9, label %func_sort_basket.23, label %ctrl8

ctrl8:                                            ; preds = %ctrl7
  %10 = icmp eq i32 %0, 9
  br i1 %10, label %func_sort_basket.26, label %ctrl9

ctrl9:                                            ; preds = %ctrl8
  %11 = icmp eq i32 %0, 10
  br i1 %11, label %func_sort_basket.27, label %ctrl10

ctrl10:                                           ; preds = %ctrl9
  %12 = icmp eq i32 %0, 11
  br i1 %12, label %func_sort_basket.28, label %ctrl11

ctrl11:                                           ; preds = %ctrl10
  %13 = icmp eq i32 %0, 12
  br i1 %13, label %func_sort_basket.31, label %ctrl12

ctrl12:                                           ; preds = %ctrl11
  %14 = icmp eq i32 %0, 13
  br i1 %14, label %func_sort_basket.32, label %ctrl13

ctrl13:                                           ; preds = %ctrl12
  %15 = icmp eq i32 %0, 14
  br i1 %15, label %func_sort_basket.33, label %func_sort_basket.34
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_primal_bea_mpp.3, label %ctrl0

func_primal_bea_mpp.3:                            ; preds = %rand_bb
  %2 = call %struct.arc* @primal_bea_mpp.3(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea)
  ret %struct.arc* %2

func_primal_bea_mpp.4:                            ; preds = %ctrl0
  %3 = call %struct.arc* @primal_bea_mpp.4(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea)
  ret %struct.arc* %3

func_primal_bea_mpp.7:                            ; preds = %ctrl1
  %4 = call %struct.arc* @primal_bea_mpp.7(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea)
  ret %struct.arc* %4

func_primal_bea_mpp.9:                            ; preds = %ctrl2
  %5 = call %struct.arc* @primal_bea_mpp.9(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea)
  ret %struct.arc* %5

func_primal_bea_mpp.12:                           ; preds = %ctrl3
  %6 = call %struct.arc* @primal_bea_mpp.12(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea)
  ret %struct.arc* %6

func_primal_bea_mpp.15:                           ; preds = %ctrl4
  %7 = call %struct.arc* @primal_bea_mpp.15(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea)
  ret %struct.arc* %7

func_primal_bea_mpp.17:                           ; preds = %ctrl5
  %8 = call %struct.arc* @primal_bea_mpp.17(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea)
  ret %struct.arc* %8

func_primal_bea_mpp.18:                           ; preds = %ctrl6
  %9 = call %struct.arc* @primal_bea_mpp.18(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea)
  ret %struct.arc* %9

func_primal_bea_mpp.19:                           ; preds = %ctrl7
  %10 = call %struct.arc* @primal_bea_mpp.19(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea)
  ret %struct.arc* %10

func_primal_bea_mpp.20:                           ; preds = %ctrl8
  %11 = call %struct.arc* @primal_bea_mpp.20(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea)
  ret %struct.arc* %11

func_primal_bea_mpp.21:                           ; preds = %ctrl9
  %12 = call %struct.arc* @primal_bea_mpp.21(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea)
  ret %struct.arc* %12

func_primal_bea_mpp.22:                           ; preds = %ctrl10
  %13 = call %struct.arc* @primal_bea_mpp.22(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea)
  ret %struct.arc* %13

func_primal_bea_mpp.24:                           ; preds = %ctrl11
  %14 = call %struct.arc* @primal_bea_mpp.24(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea)
  ret %struct.arc* %14

func_primal_bea_mpp.25:                           ; preds = %ctrl12
  %15 = call %struct.arc* @primal_bea_mpp.25(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea)
  ret %struct.arc* %15

func_primal_bea_mpp.29:                           ; preds = %ctrl13
  %16 = call %struct.arc* @primal_bea_mpp.29(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea)
  ret %struct.arc* %16

func_primal_bea_mpp.30:                           ; preds = %ctrl13
  %17 = call %struct.arc* @primal_bea_mpp.30(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea)
  ret %struct.arc* %17

ctrl0:                                            ; preds = %rand_bb
  %18 = icmp eq i32 %0, 1
  br i1 %18, label %func_primal_bea_mpp.4, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %19 = icmp eq i32 %0, 2
  br i1 %19, label %func_primal_bea_mpp.7, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %20 = icmp eq i32 %0, 3
  br i1 %20, label %func_primal_bea_mpp.9, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %21 = icmp eq i32 %0, 4
  br i1 %21, label %func_primal_bea_mpp.12, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %22 = icmp eq i32 %0, 5
  br i1 %22, label %func_primal_bea_mpp.15, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %23 = icmp eq i32 %0, 6
  br i1 %23, label %func_primal_bea_mpp.17, label %ctrl6

ctrl6:                                            ; preds = %ctrl5
  %24 = icmp eq i32 %0, 7
  br i1 %24, label %func_primal_bea_mpp.18, label %ctrl7

ctrl7:                                            ; preds = %ctrl6
  %25 = icmp eq i32 %0, 8
  br i1 %25, label %func_primal_bea_mpp.19, label %ctrl8

ctrl8:                                            ; preds = %ctrl7
  %26 = icmp eq i32 %0, 9
  br i1 %26, label %func_primal_bea_mpp.20, label %ctrl9

ctrl9:                                            ; preds = %ctrl8
  %27 = icmp eq i32 %0, 10
  br i1 %27, label %func_primal_bea_mpp.21, label %ctrl10

ctrl10:                                           ; preds = %ctrl9
  %28 = icmp eq i32 %0, 11
  br i1 %28, label %func_primal_bea_mpp.22, label %ctrl11

ctrl11:                                           ; preds = %ctrl10
  %29 = icmp eq i32 %0, 12
  br i1 %29, label %func_primal_bea_mpp.24, label %ctrl12

ctrl12:                                           ; preds = %ctrl11
  %30 = icmp eq i32 %0, 13
  br i1 %30, label %func_primal_bea_mpp.25, label %ctrl13

ctrl13:                                           ; preds = %ctrl12
  %31 = icmp eq i32 %0, 14
  br i1 %31, label %func_primal_bea_mpp.29, label %func_primal_bea_mpp.30
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @bea_is_dual_infeasible.1(%struct.arc* %arc, i64 %red_cost) #0 {
entry:
  %canary = alloca i32
  store i32 806450756, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @bea_is_dual_infeasible.2(%struct.arc* %arc, i64 %red_cost) #0 {
entry:
  %canary = alloca i32
  store i32 929488034, i32* %canary
  %arc.addr = alloca %struct.arc*, align 8
  %red_cost.addr = alloca i64, align 8
  store %struct.arc* %arc, %struct.arc** %arc.addr, align 8
  store i64 %red_cost, i64* %red_cost.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct.arc* @primal_bea_mpp.3(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 952194992, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct.arc* @primal_bea_mpp.4(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea) #0 {
entry:
  %red_cost_of_bea.addr = alloca i64*, align 8
  %m.addr = alloca i64, align 8
  %next = alloca i64, align 8
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1822650381, i32* %canary
  %arcs.addr = alloca %struct.arc*, align 8
  %stop_arcs.addr = alloca %struct.arc*, align 8
  %retval = alloca %struct.arc*, align 8
  store i64 %m, i64* %m.addr, align 8
...
entry:
  ...
  %canary = alloca i32
  store i32 1199284067, i32* %canary
...
entry:
  ...
  %max.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1172944083, i32* %canary
  %l = alloca i64, align 8
  %r = alloca i64, align 8
  store i64 %min, i64* %min.addr, align 8
  store i64 %max, i64* %max.addr, align 8
...
entry:
  ...
  %red_cost_of_bea.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 961462480, i32* %canary
  %old_group_pos = alloca i64, align 8
  %retval = alloca %struct.arc*, align 8
  %red_cost = alloca i64, align 8
  %stop_arcs.addr = alloca %struct.arc*, align 8
...
entry:
  ...
  %cut = alloca i64, align 8
  %canary = alloca i32
  store i32 1944117665, i32* %canary
  %min.addr = alloca i64, align 8
  %max.addr = alloca i64, align 8
  %r = alloca i64, align 8
  %l = alloca i64, align 8
...
entry:
  %canary = alloca i32
  store i32 289604354, i32* %canary
  %stop_arcs.addr = alloca %struct.arc*, align 8
  %red_cost = alloca i64, align 8
  %i = alloca i64, align 8
  %m.addr = alloca i64, align 8
...
entry:
  %canary = alloca i32
  store i32 1449330301, i32* %canary
  %min.addr = alloca i64, align 8
  %max.addr = alloca i64, align 8
  %l = alloca i64, align 8
  %xchange = alloca %struct.basket*, align 8
...
entry:
  ...
  %xchange = alloca %struct.basket*, align 8
  %canary = alloca i32
  store i32 1946410120, i32* %canary
  %l = alloca i64, align 8
  store i64 %min, i64* %min.addr, align 8
  store i64 %max, i64* %max.addr, align 8
  %0 = load i64, i64* %min.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct.arc* @primal_bea_mpp.12(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea) #0 {
entry:
  %m.addr = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
  %red_cost = alloca i64, align 8
  %canary = alloca i32
  store i32 1681714658, i32* %canary
  %next = alloca i64, align 8
  %arcs.addr = alloca %struct.arc*, align 8
  %stop_arcs.addr = alloca %struct.arc*, align 8
  %old_group_pos = alloca i64, align 8
...
entry:
  ...
  %l = alloca i64, align 8
  %canary = alloca i32
  store i32 1273512038, i32* %canary
  %max.addr = alloca i64, align 8
  store i64 %min, i64* %min.addr, align 8
  store i64 %max, i64* %max.addr, align 8
  %0 = load i64, i64* %min.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @sort_basket.14(i64 %min, i64 %max) #0 {
entry:
  %canary = alloca i32
  store i32 1316966658, i32* %canary
  %l = alloca i64, align 8
  %cut = alloca i64, align 8
  %xchange = alloca %struct.basket*, align 8
  %r = alloca i64, align 8
...
entry:
  ...
  %m.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 109703813, i32* %canary
  %red_cost = alloca i64, align 8
  %retval = alloca %struct.arc*, align 8
  %arcs.addr = alloca %struct.arc*, align 8
  %old_group_pos = alloca i64, align 8
...
entry:
  %canary = alloca i32
  store i32 2120500163, i32* %canary
  %max.addr = alloca i64, align 8
  %r = alloca i64, align 8
  %min.addr = alloca i64, align 8
  %l = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct.arc* @primal_bea_mpp.17(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea) #0 {
entry:
  %retval = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 282607381, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %stop_arcs.addr = alloca %struct.arc*, align 8
  %m.addr = alloca i64, align 8
  %next = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct.arc* @primal_bea_mpp.18(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea) #0 {
entry:
  %next = alloca i64, align 8
  %m.addr = alloca i64, align 8
  %i = alloca i64, align 8
  ...
  %arcs.addr = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 294529303, i32* %canary
  %stop_arcs.addr = alloca %struct.arc*, align 8
  store i64 %m, i64* %m.addr, align 8
  store %struct.arc* %arcs, %struct.arc** %arcs.addr, align 8
  store %struct.arc* %stop_arcs, %struct.arc** %stop_arcs.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct.arc* @primal_bea_mpp.20(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea) #0 {
entry:
  %arcs.addr = alloca %struct.arc*, align 8
  %retval = alloca %struct.arc*, align 8
  %old_group_pos = alloca i64, align 8
  %canary = alloca i32
  store i32 1221104062, i32* %canary
  %m.addr = alloca i64, align 8
  %i = alloca i64, align 8
  %stop_arcs.addr = alloca %struct.arc*, align 8
  %arc = alloca %struct.arc*, align 8
...
entry:
  %retval = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1012414419, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %arcs.addr = alloca %struct.arc*, align 8
  %red_cost_of_bea.addr = alloca i64*, align 8
  %i = alloca i64, align 8
...
entry:
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1877832116, i32* %canary
  %arcs.addr = alloca %struct.arc*, align 8
  %i = alloca i64, align 8
  %red_cost = alloca i64, align 8
  %next = alloca i64, align 8
...
entry:
  %l = alloca i64, align 8
  %canary = alloca i32
  store i32 190046004, i32* %canary
  %r = alloca i64, align 8
  %max.addr = alloca i64, align 8
  %xchange = alloca %struct.basket*, align 8
  %min.addr = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct.arc* @primal_bea_mpp.24(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea) #0 {
entry:
  %red_cost = alloca i64, align 8
  %next = alloca i64, align 8
  %arcs.addr = alloca %struct.arc*, align 8
  %m.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 470804879, i32* %canary
  %stop_arcs.addr = alloca %struct.arc*, align 8
  %i = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
  %red_cost_of_bea.addr = alloca i64*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct.arc* @primal_bea_mpp.25(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea) #0 {
entry:
  %old_group_pos = alloca i64, align 8
  %canary = alloca i32
  store i32 886717103, i32* %canary
  %i = alloca i64, align 8
  %retval = alloca %struct.arc*, align 8
  %stop_arcs.addr = alloca %struct.arc*, align 8
  %arc = alloca %struct.arc*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @sort_basket.26(i64 %min, i64 %max) #0 {
entry:
  %l = alloca i64, align 8
  %max.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1746916911, i32* %canary
  %min.addr = alloca i64, align 8
  %r = alloca i64, align 8
  %cut = alloca i64, align 8
  %xchange = alloca %struct.basket*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @sort_basket.27(i64 %min, i64 %max) #0 {
entry:
  %min.addr = alloca i64, align 8
  %r = alloca i64, align 8
  %cut = alloca i64, align 8
  ...
  %xchange = alloca %struct.basket*, align 8
  %canary = alloca i32
  store i32 231155781, i32* %canary
  %max.addr = alloca i64, align 8
  store i64 %min, i64* %min.addr, align 8
  store i64 %max, i64* %max.addr, align 8
  %0 = load i64, i64* %min.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @sort_basket.28(i64 %min, i64 %max) #0 {
entry:
  %l = alloca i64, align 8
  %min.addr = alloca i64, align 8
  %cut = alloca i64, align 8
  ...
  %r = alloca i64, align 8
  %canary = alloca i32
  store i32 1216560710, i32* %canary
  %max.addr = alloca i64, align 8
  store i64 %min, i64* %min.addr, align 8
  store i64 %max, i64* %max.addr, align 8
  %0 = load i64, i64* %min.addr, align 8
...
entry:
  ...
  %retval = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 909392031, i32* %canary
  %stop_arcs.addr = alloca %struct.arc*, align 8
  %red_cost_of_bea.addr = alloca i64*, align 8
  %i = alloca i64, align 8
  %old_group_pos = alloca i64, align 8
...
entry:
  %m.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1005035503, i32* %canary
  %retval = alloca %struct.arc*, align 8
  %next = alloca i64, align 8
  %stop_arcs.addr = alloca %struct.arc*, align 8
  %old_group_pos = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @sort_basket.31(i64 %min, i64 %max) #0 {
entry:
  %canary = alloca i32
  store i32 269583244, i32* %canary
  %max.addr = alloca i64, align 8
  %min.addr = alloca i64, align 8
  %cut = alloca i64, align 8
  %r = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @sort_basket.32(i64 %min, i64 %max) #0 {
entry:
  %min.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 411632090, i32* %canary
  %cut = alloca i64, align 8
  %max.addr = alloca i64, align 8
  %r = alloca i64, align 8
  %xchange = alloca %struct.basket*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @sort_basket.33(i64 %min, i64 %max) #0 {
entry:
  %cut = alloca i64, align 8
  %max.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 239535544, i32* %canary
  %l = alloca i64, align 8
  %min.addr = alloca i64, align 8
  %r = alloca i64, align 8
  %xchange = alloca %struct.basket*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @sort_basket.34(i64 %min, i64 %max) #0 {
entry:
  %r = alloca i64, align 8
  %canary = alloca i32
  store i32 932048185, i32* %canary
  %xchange = alloca %struct.basket*, align 8
  %max.addr = alloca i64, align 8
  %cut = alloca i64, align 8
  %min.addr = alloca i64, align 8
