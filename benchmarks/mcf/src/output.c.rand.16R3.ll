...
entry:
  ...
  %canary = alloca i32
  store i32 1275336189, i32* %canary
...
entry:
  ...
  %out = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 1478304272, i32* %canary
  %retval = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
  store i8* %outfile, i8** %outfile.addr, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  ...
  %retval = alloca i64, align 8
  %canary = alloca i32
  store i32 564568672, i32* %canary
  %outfile.addr = alloca i8*, align 8
  %block = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
  store i8* %outfile, i8** %outfile.addr, align 8
...
entry:
  ...
  %arc2 = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 264559962, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %block = alloca %struct.arc*, align 8
  %first_impl = alloca %struct.arc*, align 8
  store i8* %outfile, i8** %outfile.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1624764898, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %retval = alloca i64, align 8
  %first_impl = alloca %struct.arc*, align 8
  %outfile.addr = alloca i8*, align 8
...
entry:
  ...
  %first_impl = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 2117949399, i32* %canary
  %block = alloca %struct.arc*, align 8
  store i8* %outfile, i8** %outfile.addr, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store %struct._IO_FILE* null, %struct._IO_FILE** %out, align 8
...
entry:
  ...
  %block = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1839045442, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %arc2 = alloca %struct.arc*, align 8
  %out = alloca %struct._IO_FILE*, align 8
  %net.addr = alloca %struct.network*, align 8
...
entry:
  ...
  %retval = alloca i64, align 8
  %canary = alloca i32
  store i32 1786707582, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %outfile.addr = alloca i8*, align 8
  %first_impl = alloca %struct.arc*, align 8
  %block = alloca %struct.arc*, align 8
...
entry:
  %canary = alloca i32
  store i32 375269291, i32* %canary
  %arc2 = alloca %struct.arc*, align 8
  %arc = alloca %struct.arc*, align 8
  %outfile.addr = alloca i8*, align 8
  %retval = alloca i64, align 8
...
entry:
  ...
  %retval = alloca i64, align 8
  %canary = alloca i32
  store i32 633300493, i32* %canary
  %outfile.addr = alloca i8*, align 8
  %block = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
  %out = alloca %struct._IO_FILE*, align 8
...
entry:
  %canary = alloca i32
  store i32 1105565134, i32* %canary
  %retval = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
  %out = alloca %struct._IO_FILE*, align 8
  %arc2 = alloca %struct.arc*, align 8
...
entry:
  %canary = alloca i32
  store i32 330940939, i32* %canary
  %retval = alloca i64, align 8
  %arc2 = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
  %arc = alloca %struct.arc*, align 8
...
entry:
  ...
  %outfile.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1485227704, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %first_impl = alloca %struct.arc*, align 8
  %arc2 = alloca %struct.arc*, align 8
  %arc = alloca %struct.arc*, align 8
...
entry:
  ...
  %out = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 2045560174, i32* %canary
  %outfile.addr = alloca i8*, align 8
  %first_impl = alloca %struct.arc*, align 8
  store i8* %outfile, i8** %outfile.addr, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  ...
  %arc2 = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1849047537, i32* %canary
  %first_impl = alloca %struct.arc*, align 8
  %out = alloca %struct._IO_FILE*, align 8
  store i8* %outfile, i8** %outfile.addr, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
