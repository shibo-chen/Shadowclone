; ModuleID = 'mcfutil.c.rand.8P3.bc'
...
func_refresh_neighbour_lists.17:                  ; preds = %ctrl0
  call void @refresh_neighbour_lists.17(%struct.network* %net)
  ret void

func_refresh_neighbour_lists.20:                  ; preds = %ctrl1
  call void @refresh_neighbour_lists.20(%struct.network* %net)
  ret void

func_refresh_neighbour_lists.23:                  ; preds = %ctrl2
  call void @refresh_neighbour_lists.23(%struct.network* %net)
  ret void

func_refresh_neighbour_lists.33:                  ; preds = %ctrl3
  call void @refresh_neighbour_lists.33(%struct.network* %net)
  ret void

func_refresh_neighbour_lists.38:                  ; preds = %ctrl4
  call void @refresh_neighbour_lists.38(%struct.network* %net)
  ret void

func_refresh_neighbour_lists.42:                  ; preds = %ctrl5
  call void @refresh_neighbour_lists.42(%struct.network* %net)
  ret void

func_refresh_neighbour_lists.45:                  ; preds = %ctrl5
  call void @refresh_neighbour_lists.45(%struct.network* %net)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_refresh_neighbour_lists.17, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_refresh_neighbour_lists.20, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_refresh_neighbour_lists.23, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_refresh_neighbour_lists.33, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_refresh_neighbour_lists.38, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_refresh_neighbour_lists.42, label %func_refresh_neighbour_lists.45
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_refresh_potential.3, label %ctrl0

func_refresh_potential.3:                         ; preds = %rand_bb
  %2 = call i64 @refresh_potential.3(%struct.network* %net)
  ret i64 %2

func_refresh_potential.9:                         ; preds = %ctrl0
  %3 = call i64 @refresh_potential.9(%struct.network* %net)
  ret i64 %3

func_refresh_potential.14:                        ; preds = %ctrl1
  %4 = call i64 @refresh_potential.14(%struct.network* %net)
  ret i64 %4

func_refresh_potential.16:                        ; preds = %ctrl2
  %5 = call i64 @refresh_potential.16(%struct.network* %net)
  ret i64 %5

func_refresh_potential.29:                        ; preds = %ctrl3
  %6 = call i64 @refresh_potential.29(%struct.network* %net)
  ret i64 %6

func_refresh_potential.30:                        ; preds = %ctrl4
  %7 = call i64 @refresh_potential.30(%struct.network* %net)
  ret i64 %7

func_refresh_potential.39:                        ; preds = %ctrl5
  %8 = call i64 @refresh_potential.39(%struct.network* %net)
  ret i64 %8

func_refresh_potential.41:                        ; preds = %ctrl5
  %9 = call i64 @refresh_potential.41(%struct.network* %net)
  ret i64 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_refresh_potential.9, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_refresh_potential.14, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_refresh_potential.16, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_refresh_potential.29, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_refresh_potential.30, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_refresh_potential.39, label %func_refresh_potential.41
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_flow_cost.6, label %ctrl0

func_flow_cost.6:                                 ; preds = %rand_bb
  %2 = call double @flow_cost.6(%struct.network* %net)
  ret double %2

func_flow_cost.8:                                 ; preds = %ctrl0
  %3 = call double @flow_cost.8(%struct.network* %net)
  ret double %3
...
func_flow_cost.21:                                ; preds = %ctrl2
  %5 = call double @flow_cost.21(%struct.network* %net)
  ret double %5

func_flow_cost.24:                                ; preds = %ctrl3
  %6 = call double @flow_cost.24(%struct.network* %net)
  ret double %6

func_flow_cost.25:                                ; preds = %ctrl4
  %7 = call double @flow_cost.25(%struct.network* %net)
  ret double %7

func_flow_cost.26:                                ; preds = %ctrl5
  %8 = call double @flow_cost.26(%struct.network* %net)
  ret double %8

func_flow_cost.27:                                ; preds = %ctrl5
  %9 = call double @flow_cost.27(%struct.network* %net)
  ret double %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_flow_cost.8, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_flow_cost.19, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_flow_cost.21, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_flow_cost.24, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_flow_cost.25, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_flow_cost.26, label %func_flow_cost.27
}
...
func_flow_org_cost.5:                             ; preds = %ctrl1
  %4 = call double @flow_org_cost.5(%struct.network* %net)
  ret double %4

func_flow_org_cost.12:                            ; preds = %ctrl2
  %5 = call double @flow_org_cost.12(%struct.network* %net)
  ret double %5

func_flow_org_cost.13:                            ; preds = %ctrl3
  %6 = call double @flow_org_cost.13(%struct.network* %net)
  ret double %6
...
ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_flow_org_cost.4, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_flow_org_cost.5, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_flow_org_cost.12, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_flow_org_cost.13, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_flow_org_cost.32, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_flow_org_cost.34, label %func_flow_org_cost.36
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_primal_feasible.7, label %ctrl0

func_primal_feasible.7:                           ; preds = %rand_bb
  %2 = call i64 @primal_feasible.7(%struct.network* %net)
  ret i64 %2

func_primal_feasible.10:                          ; preds = %ctrl0
  %3 = call i64 @primal_feasible.10(%struct.network* %net)
  ret i64 %3

func_primal_feasible.37:                          ; preds = %ctrl1
  %4 = call i64 @primal_feasible.37(%struct.network* %net)
  ret i64 %4

func_primal_feasible.40:                          ; preds = %ctrl2
  %5 = call i64 @primal_feasible.40(%struct.network* %net)
  ret i64 %5

func_primal_feasible.43:                          ; preds = %ctrl3
  %6 = call i64 @primal_feasible.43(%struct.network* %net)
  ret i64 %6

func_primal_feasible.46:                          ; preds = %ctrl4
  %7 = call i64 @primal_feasible.46(%struct.network* %net)
  ret i64 %7

func_primal_feasible.47:                          ; preds = %ctrl5
  %8 = call i64 @primal_feasible.47(%struct.network* %net)
  ret i64 %8

func_primal_feasible.48:                          ; preds = %ctrl5
  %9 = call i64 @primal_feasible.48(%struct.network* %net)
  ret i64 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_primal_feasible.10, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_primal_feasible.37, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_primal_feasible.40, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_primal_feasible.43, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_primal_feasible.46, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_primal_feasible.47, label %func_primal_feasible.48
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_dual_feasible.11, label %ctrl0

func_dual_feasible.11:                            ; preds = %rand_bb
  %2 = call i64 @dual_feasible.11(%struct.network* %net)
  ret i64 %2

func_dual_feasible.15:                            ; preds = %ctrl0
  %3 = call i64 @dual_feasible.15(%struct.network* %net)
  ret i64 %3

func_dual_feasible.18:                            ; preds = %ctrl1
  %4 = call i64 @dual_feasible.18(%struct.network* %net)
  ret i64 %4

func_dual_feasible.22:                            ; preds = %ctrl2
  %5 = call i64 @dual_feasible.22(%struct.network* %net)
  ret i64 %5

func_dual_feasible.28:                            ; preds = %ctrl3
  %6 = call i64 @dual_feasible.28(%struct.network* %net)
  ret i64 %6

func_dual_feasible.31:                            ; preds = %ctrl4
  %7 = call i64 @dual_feasible.31(%struct.network* %net)
  ret i64 %7

func_dual_feasible.35:                            ; preds = %ctrl5
  %8 = call i64 @dual_feasible.35(%struct.network* %net)
  ret i64 %8

func_dual_feasible.44:                            ; preds = %ctrl5
  %9 = call i64 @dual_feasible.44(%struct.network* %net)
  ret i64 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_dual_feasible.15, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_dual_feasible.18, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_dual_feasible.22, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_dual_feasible.28, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_dual_feasible.31, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_dual_feasible.35, label %func_dual_feasible.44
}
...
entry:
  %canary = alloca i32
  store i32 2081501063, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1020983823, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @refresh_potential.3(%struct.network* %net) #0 {
entry:
  %node = alloca %struct.node*, align 8
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 1377671195, i32* %canary
...
entry:
  ...
  %fleet = alloca i64, align 8
  %canary = alloca i32
  store i32 1755355025, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 0, i64* %fleet, align 8
...
entry:
  ...
  %operational_cost = alloca i64, align 8
  %canary = alloca i32
  store i32 1295935058, i32* %canary
  %stop = alloca i8*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 0, i64* %fleet, align 8
  store i64 0, i64* %operational_cost, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local double @flow_cost.6(%struct.network* %net) #0 {
entry:
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 1159766813, i32* %canary
  %node = alloca %struct.node*, align 8
  %arc = alloca %struct.arc*, align 8
  %fleet = alloca i64, align 8
  %operational_cost = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @primal_feasible.7(%struct.network* %net) #0 {
entry:
  %canary = alloca i32
  store i32 313522354, i32* %canary
  %net.addr = alloca %struct.network*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local double @flow_cost.8(%struct.network* %net) #0 {
entry:
  %operational_cost = alloca i64, align 8
  %stop = alloca i8*, align 8
  %node = alloca %struct.node*, align 8
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1761081581, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %fleet = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 0, i64* %fleet, align 8
...
entry:
  ...
  %checksum = alloca i64, align 8
  %canary = alloca i32
  store i32 1170133735, i32* %canary
  %tmp = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
...
entry:
  ...
  %stop = alloca i8*, align 8
  %canary = alloca i32
  store i32 1018302038, i32* %canary
  %node = alloca %struct.node*, align 8
  %stop_dummy = alloca %struct.arc*, align 8
  %flow = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
...
entry:
  %canary = alloca i32
  store i32 1810774483, i32* %canary
  %retval = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local double @flow_org_cost.12(%struct.network* %net) #0 {
entry:
  %canary = alloca i32
  store i32 463675684, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %fleet = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
  %operational_cost = alloca i64, align 8
...
entry:
  ...
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1564390780, i32* %canary
  %arc = alloca %struct.arc*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 0, i64* %fleet, align 8
  store i64 0, i64* %operational_cost, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @refresh_potential.14(%struct.network* %net) #0 {
entry:
  %tmp = alloca %struct.node*, align 8
  %root = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1993060207, i32* %canary
  %checksum = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
  %node = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 886035148, i32* %canary
  %red_cost = alloca i64, align 8
  %stop = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  ...
  %root = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1258773547, i32* %canary
  %checksum = alloca i64, align 8
  %node = alloca %struct.node*, align 8
  %tmp = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @refresh_neighbour_lists.17(%struct.network* %net) #0 {
entry:
  %net.addr = alloca %struct.network*, align 8
  %stop = alloca i8*, align 8
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1261485036, i32* %canary
  %arc = alloca %struct.arc*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
  %nodes = getelementptr inbounds %struct.network, %struct.network* %0, i32 0, i32 21
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @dual_feasible.18(%struct.network* %net) #0 {
entry:
  %retval = alloca i64, align 8
  %stop = alloca %struct.arc*, align 8
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1986393267, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %red_cost = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
...
entry:
  ...
  %fleet = alloca i64, align 8
  %canary = alloca i32
  store i32 188240649, i32* %canary
  %stop = alloca i8*, align 8
  %node = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 0, i64* %fleet, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @refresh_neighbour_lists.20(%struct.network* %net) #0 {
entry:
  %stop = alloca i8*, align 8
  %node = alloca %struct.node*, align 8
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1786226980, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
  %nodes = getelementptr inbounds %struct.network, %struct.network* %0, i32 0, i32 21
...
entry:
  ...
  %operational_cost = alloca i64, align 8
  %canary = alloca i32
  store i32 1671227462, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %node = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 0, i64* %fleet, align 8
...
entry:
  ...
  %red_cost = alloca i64, align 8
  %canary = alloca i32
  store i32 1385168324, i32* %canary
  %stop = alloca %struct.arc*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
  %stop_arcs = getelementptr inbounds %struct.network, %struct.network* %0, i32 0, i32 24
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @refresh_neighbour_lists.23(%struct.network* %net) #0 {
entry:
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 2107444446, i32* %canary
  %node = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
  %stop = alloca i8*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  ...
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 723748668, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %fleet = alloca i64, align 8
  %stop = alloca i8*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1837330733, i32* %canary
  %operational_cost = alloca i64, align 8
  %node = alloca %struct.node*, align 8
  %stop = alloca i8*, align 8
  %arc = alloca %struct.arc*, align 8
...
entry:
  ...
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1334866559, i32* %canary
  %operational_cost = alloca i64, align 8
  %stop = alloca i8*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 0, i64* %fleet, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local double @flow_cost.27(%struct.network* %net) #0 {
entry:
  %canary = alloca i32
  store i32 1820903793, i32* %canary
  %fleet = alloca i64, align 8
  %operational_cost = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
  %node = alloca %struct.node*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @dual_feasible.28(%struct.network* %net) #0 {
entry:
  %arc = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
  %retval = alloca i64, align 8
  %canary = alloca i32
  store i32 971700396, i32* %canary
  %red_cost = alloca i64, align 8
  %stop = alloca %struct.arc*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @refresh_potential.29(%struct.network* %net) #0 {
entry:
  %canary = alloca i32
  store i32 575069500, i32* %canary
  %tmp = alloca %struct.node*, align 8
  %checksum = alloca i64, align 8
  %node = alloca %struct.node*, align 8
  %root = alloca %struct.node*, align 8
...
entry:
  ...
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1267024069, i32* %canary
  %checksum = alloca i64, align 8
  %tmp = alloca %struct.node*, align 8
  %root = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  ...
  %retval = alloca i64, align 8
  %canary = alloca i32
  store i32 189372797, i32* %canary
  %stop = alloca %struct.arc*, align 8
  %arc = alloca %struct.arc*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
...
entry:
  ...
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1067069747, i32* %canary
  %stop = alloca i8*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 0, i64* %fleet, align 8
  store i64 0, i64* %operational_cost, align 8
...
entry:
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 2147071972, i32* %canary
  %stop = alloca i8*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
  %nodes = getelementptr inbounds %struct.network, %struct.network* %0, i32 0, i32 21
...
entry:
  ...
  %fleet = alloca i64, align 8
  %canary = alloca i32
  store i32 1786467376, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %operational_cost = alloca i64, align 8
  %node = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 441935683, i32* %canary
  %arc = alloca %struct.arc*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
  %stop_arcs = getelementptr inbounds %struct.network, %struct.network* %0, i32 0, i32 24
...
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 1361103848, i32* %canary
  %operational_cost = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 0, i64* %fleet, align 8
  store i64 0, i64* %operational_cost, align 8
...
entry:
  ...
  %stop_dummy = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1880441054, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
...
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 375519341, i32* %canary
  %node = alloca %struct.node*, align 8
  %arc = alloca %struct.arc*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
...
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 1723775448, i32* %canary
  %checksum = alloca i64, align 8
  %root = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @primal_feasible.40(%struct.network* %net) #0 {
entry:
  %dummy = alloca %struct.arc*, align 8
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1217606639, i32* %canary
  %stop = alloca i8*, align 8
  %net.addr = alloca %struct.network*, align 8
  %node = alloca %struct.node*, align 8
  %flow = alloca i64, align 8
...
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 1148297534, i32* %canary
  %node = alloca %struct.node*, align 8
  %root = alloca %struct.node*, align 8
  %tmp = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  ...
  %stop = alloca i8*, align 8
  %canary = alloca i32
  store i32 2044900155, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
  %nodes = getelementptr inbounds %struct.network, %struct.network* %0, i32 0, i32 21
...
entry:
  ...
  %stop = alloca i8*, align 8
  %canary = alloca i32
  store i32 977303726, i32* %canary
  %node = alloca %struct.node*, align 8
  %flow = alloca i64, align 8
  %retval = alloca i64, align 8
  %stop_dummy = alloca %struct.arc*, align 8
...
entry:
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1575170485, i32* %canary
  %red_cost = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
  %stop_arcs = getelementptr inbounds %struct.network, %struct.network* %0, i32 0, i32 24
...
entry:
  ...
  %stop = alloca i8*, align 8
  %canary = alloca i32
  store i32 660200571, i32* %canary
  %node = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @primal_feasible.46(%struct.network* %net) #0 {
entry:
  %arc = alloca %struct.arc*, align 8
  %stop_dummy = alloca %struct.arc*, align 8
  %stop = alloca i8*, align 8
  ...
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 2012391134, i32* %canary
  %flow = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
  %dummy_arcs = getelementptr inbounds %struct.network, %struct.network* %0, i32 0, i32 25
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @primal_feasible.47(%struct.network* %net) #0 {
entry:
  %arc = alloca %struct.arc*, align 8
  %dummy = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 1044176144, i32* %canary
  %retval = alloca i64, align 8
  %flow = alloca i64, align 8
  %node = alloca %struct.node*, align 8
  %stop_dummy = alloca %struct.arc*, align 8
...
entry:
  ...
  %stop = alloca i8*, align 8
  %canary = alloca i32
  store i32 495482020, i32* %canary
  %retval = alloca i64, align 8
  %stop_dummy = alloca %struct.arc*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
