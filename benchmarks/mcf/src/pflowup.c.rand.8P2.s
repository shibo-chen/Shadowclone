...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$854106690, -20(%rbp)   # imm = 0x32E8A242
	movq	%rdi, -16(%rbp)
	movq	%rsi, -8(%rbp)
	movq	%rdx, -32(%rbp)
.LBB1_1:                                # %for.cond
...
.LBB1_13:                               # %for.inc12
	...
	jmp	.LBB1_8
.LBB1_14:                               # %for.end14
	cmpl	$854106690, -20(%rbp)   # imm = 0x32E8A242
	jne	.LBB1_16
.LBB1_15:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1314234576, -20(%rbp)  # imm = 0x4E55A0D0
	movq	%rdi, -16(%rbp)
	movq	%rsi, -8(%rbp)
	movq	%rdx, -32(%rbp)
.LBB2_1:                                # %for.cond
...
.LBB2_13:                               # %for.inc12
	...
	jmp	.LBB2_8
.LBB2_14:                               # %for.end14
	cmpl	$1314234576, -20(%rbp)  # imm = 0x4E55A0D0
	jne	.LBB2_16
.LBB2_15:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1353696685, -20(%rbp)  # imm = 0x50AFC5AD
	movq	%rdi, -8(%rbp)
	movq	%rsi, -16(%rbp)
	movq	%rdx, -32(%rbp)
.LBB3_1:                                # %for.cond
...
.LBB3_13:                               # %for.inc12
	...
	jmp	.LBB3_8
.LBB3_14:                               # %for.end14
	cmpl	$1353696685, -20(%rbp)  # imm = 0x50AFC5AD
	jne	.LBB3_16
.LBB3_15:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$352793455, -20(%rbp)   # imm = 0x1507336F
	movq	%rdi, -8(%rbp)
	movq	%rsi, -16(%rbp)
	movq	%rdx, -32(%rbp)
.LBB4_1:                                # %for.cond
...
.LBB4_13:                               # %for.inc12
	...
	jmp	.LBB4_8
.LBB4_14:                               # %for.end14
	cmpl	$352793455, -20(%rbp)   # imm = 0x1507336F
	jne	.LBB4_16
.LBB4_15:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1321920459, -20(%rbp)  # imm = 0x4ECAE7CB
	movq	%rdi, -8(%rbp)
	movq	%rsi, -16(%rbp)
	movq	%rdx, -32(%rbp)
.LBB5_1:                                # %for.cond
...
.LBB5_13:                               # %for.inc12
	...
	jmp	.LBB5_8
.LBB5_14:                               # %for.end14
	cmpl	$1321920459, -20(%rbp)  # imm = 0x4ECAE7CB
	jne	.LBB5_16
.LBB5_15:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$315208608, -20(%rbp)   # imm = 0x12C9B3A0
	movq	%rdi, -16(%rbp)
	movq	%rsi, -8(%rbp)
	movq	%rdx, -32(%rbp)
.LBB6_1:                                # %for.cond
...
.LBB6_13:                               # %for.inc12
	...
	jmp	.LBB6_8
.LBB6_14:                               # %for.end14
	cmpl	$315208608, -20(%rbp)   # imm = 0x12C9B3A0
	jne	.LBB6_16
.LBB6_15:
	addq	$32, %rsp
	popq	%rbp
