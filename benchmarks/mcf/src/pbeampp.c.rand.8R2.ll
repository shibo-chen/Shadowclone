; ModuleID = 'pbeampp.c.rand.8R2.bc'
...
func_sort_basket.11:                              ; preds = %ctrl4
...
ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_sort_basket.11, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_sort_basket.14, label %func_sort_basket.15
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_primal_bea_mpp.6, label %ctrl0

func_primal_bea_mpp.6:                            ; preds = %rand_bb
  %2 = call %struct.arc* @primal_bea_mpp.6(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea)
  ret %struct.arc* %2
...
func_primal_bea_mpp.12:                           ; preds = %ctrl2
  %5 = call %struct.arc* @primal_bea_mpp.12(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea)
  ret %struct.arc* %5
...
func_primal_bea_mpp.16:                           ; preds = %ctrl4
  %7 = call %struct.arc* @primal_bea_mpp.16(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea)
  ret %struct.arc* %7
...
ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_primal_bea_mpp.12, label %ctrl3
...
ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_primal_bea_mpp.16, label %ctrl5
...
entry:
  ...
  %canary = alloca i32
  store i32 932953609, i32* %canary
...
entry:
  %red_cost.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 395185971, i32* %canary
  %arc.addr = alloca %struct.arc*, align 8
  store %struct.arc* %arc, %struct.arc** %arc.addr, align 8
  store i64 %red_cost, i64* %red_cost.addr, align 8
  %0 = load i64, i64* %red_cost.addr, align 8
...
entry:
  ...
  %canary = alloca i32
  store i32 2005066928, i32* %canary
...
entry:
  ...
  %min.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 304102229, i32* %canary
  %xchange = alloca %struct.basket*, align 8
  %r = alloca i64, align 8
  %max.addr = alloca i64, align 8
  store i64 %min, i64* %min.addr, align 8
...
entry:
  ...
  %l = alloca i64, align 8
  %canary = alloca i32
  store i32 1273036418, i32* %canary
  %xchange = alloca %struct.basket*, align 8
  %cut = alloca i64, align 8
  %min.addr = alloca i64, align 8
  %r = alloca i64, align 8
...
entry:
  %canary = alloca i32
  store i32 1925482582, i32* %canary
  %cut = alloca i64, align 8
  %xchange = alloca %struct.basket*, align 8
  %min.addr = alloca i64, align 8
  %l = alloca i64, align 8
...
entry:
  %canary = alloca i32
  store i32 294661953, i32* %canary
  %old_group_pos = alloca i64, align 8
  %i = alloca i64, align 8
  %arcs.addr = alloca %struct.arc*, align 8
  %m.addr = alloca i64, align 8
...
entry:
  ...
  %m.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1222063465, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %next = alloca i64, align 8
  %retval = alloca %struct.arc*, align 8
  %red_cost_of_bea.addr = alloca i64*, align 8
...
entry:
  %min.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1174936805, i32* %canary
  %max.addr = alloca i64, align 8
  %xchange = alloca %struct.basket*, align 8
  %cut = alloca i64, align 8
  %r = alloca i64, align 8
...
entry:
  ...
  %l = alloca i64, align 8
  %canary = alloca i32
  store i32 1434605178, i32* %canary
  %min.addr = alloca i64, align 8
  store i64 %min, i64* %min.addr, align 8
  store i64 %max, i64* %max.addr, align 8
  %0 = load i64, i64* %min.addr, align 8
...
entry:
  ...
  %retval = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 562642113, i32* %canary
  %red_cost = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
  %i = alloca i64, align 8
  store i64 %m, i64* %m.addr, align 8
...
entry:
  %old_group_pos = alloca i64, align 8
  %canary = alloca i32
  store i32 321818321, i32* %canary
  %arcs.addr = alloca %struct.arc*, align 8
  %m.addr = alloca i64, align 8
  %stop_arcs.addr = alloca %struct.arc*, align 8
  %i = alloca i64, align 8
...
entry:
  ...
  %max.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 2033111473, i32* %canary
  %cut = alloca i64, align 8
  %min.addr = alloca i64, align 8
  %xchange = alloca %struct.basket*, align 8
  store i64 %min, i64* %min.addr, align 8
...
entry:
  ...
  %cut = alloca i64, align 8
  %canary = alloca i32
  store i32 141383123, i32* %canary
  %xchange = alloca %struct.basket*, align 8
  %max.addr = alloca i64, align 8
  %r = alloca i64, align 8
  %min.addr = alloca i64, align 8
...
entry:
  %red_cost = alloca i64, align 8
  %canary = alloca i32
  store i32 1769446511, i32* %canary
  %retval = alloca %struct.arc*, align 8
  %arc = alloca %struct.arc*, align 8
  %red_cost_of_bea.addr = alloca i64*, align 8
  %stop_arcs.addr = alloca %struct.arc*, align 8
...
entry:
  ...
  %arcs.addr = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1422951904, i32* %canary
  %m.addr = alloca i64, align 8
  %stop_arcs.addr = alloca %struct.arc*, align 8
  %old_group_pos = alloca i64, align 8
  %retval = alloca %struct.arc*, align 8
...
entry:
  ...
  %old_group_pos = alloca i64, align 8
  %canary = alloca i32
  store i32 334789058, i32* %canary
  %retval = alloca %struct.arc*, align 8
  %arcs.addr = alloca %struct.arc*, align 8
  %i = alloca i64, align 8
  %red_cost = alloca i64, align 8
