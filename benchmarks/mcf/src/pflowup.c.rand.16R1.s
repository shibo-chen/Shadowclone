...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$823754294, -20(%rbp)   # imm = 0x31197E36
	movq	%rdi, -16(%rbp)
	movq	%rsi, -8(%rbp)
	movq	%rdx, -32(%rbp)
.LBB1_1:                                # %for.cond
...
.LBB1_13:                               # %for.inc12
	...
	jmp	.LBB1_8
.LBB1_14:                               # %for.end14
	cmpl	$823754294, -20(%rbp)   # imm = 0x31197E36
	jne	.LBB1_16
.LBB1_15:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1460098674, -20(%rbp)  # imm = 0x57075672
	movq	%rdi, -8(%rbp)
	movq	%rsi, -16(%rbp)
	movq	%rdx, -32(%rbp)
.LBB2_1:                                # %for.cond
...
.LBB2_13:                               # %for.inc12
	...
	jmp	.LBB2_8
.LBB2_14:                               # %for.end14
	cmpl	$1460098674, -20(%rbp)  # imm = 0x57075672
	jne	.LBB2_16
.LBB2_15:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$2000655457, -20(%rbp)  # imm = 0x773F9461
	movq	%rdi, -16(%rbp)
	movq	%rsi, -8(%rbp)
	movq	%rdx, -32(%rbp)
.LBB3_1:                                # %for.cond
...
.LBB3_13:                               # %for.inc12
	...
	jmp	.LBB3_8
.LBB3_14:                               # %for.end14
	cmpl	$2000655457, -20(%rbp)  # imm = 0x773F9461
	jne	.LBB3_16
.LBB3_15:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$983043216, -20(%rbp)   # imm = 0x3A980C90
	movq	%rdi, -8(%rbp)
	movq	%rsi, -16(%rbp)
	movq	%rdx, -32(%rbp)
.LBB4_1:                                # %for.cond
...
.LBB4_13:                               # %for.inc12
	...
	jmp	.LBB4_8
.LBB4_14:                               # %for.end14
	cmpl	$983043216, -20(%rbp)   # imm = 0x3A980C90
	jne	.LBB4_16
.LBB4_15:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$560064617, -20(%rbp)   # imm = 0x2161E869
	movq	%rdi, -8(%rbp)
	movq	%rsi, -16(%rbp)
	movq	%rdx, -32(%rbp)
.LBB5_1:                                # %for.cond
...
.LBB5_13:                               # %for.inc12
	...
	jmp	.LBB5_8
.LBB5_14:                               # %for.end14
	cmpl	$560064617, -20(%rbp)   # imm = 0x2161E869
	jne	.LBB5_16
.LBB5_15:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$140687808, -20(%rbp)   # imm = 0x862B9C0
	movq	%rdi, -16(%rbp)
	movq	%rsi, -8(%rbp)
	movq	%rdx, -32(%rbp)
.LBB6_1:                                # %for.cond
...
.LBB6_13:                               # %for.inc12
	...
	jmp	.LBB6_8
.LBB6_14:                               # %for.end14
	cmpl	$140687808, -20(%rbp)   # imm = 0x862B9C0
	jne	.LBB6_16
.LBB6_15:
	addq	$32, %rsp
	popq	%rbp
