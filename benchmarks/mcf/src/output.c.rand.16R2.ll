...
entry:
  ...
  %canary = alloca i32
  store i32 1367941646, i32* %canary
...
entry:
  ...
  %first_impl = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1962717504, i32* %canary
  %block = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
  %retval = alloca i64, align 8
  %outfile.addr = alloca i8*, align 8
...
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 693402505, i32* %canary
  %block = alloca %struct.arc*, align 8
  %out = alloca %struct._IO_FILE*, align 8
  %retval = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
...
entry:
  ...
  %out = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 1224444771, i32* %canary
  %first_impl = alloca %struct.arc*, align 8
  %arc2 = alloca %struct.arc*, align 8
  store i8* %outfile, i8** %outfile.addr, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  ...
  %block = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 286372795, i32* %canary
  %first_impl = alloca %struct.arc*, align 8
  %arc = alloca %struct.arc*, align 8
  store i8* %outfile, i8** %outfile.addr, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  ...
  %outfile.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1010091373, i32* %canary
  %block = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
  %arc2 = alloca %struct.arc*, align 8
  %out = alloca %struct._IO_FILE*, align 8
...
entry:
  ...
  %outfile.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1437961656, i32* %canary
  %first_impl = alloca %struct.arc*, align 8
  %arc = alloca %struct.arc*, align 8
  %retval = alloca i64, align 8
  store i8* %outfile, i8** %outfile.addr, align 8
...
entry:
  %block = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 983874050, i32* %canary
  %retval = alloca i64, align 8
  %first_impl = alloca %struct.arc*, align 8
  %out = alloca %struct._IO_FILE*, align 8
  %outfile.addr = alloca i8*, align 8
...
entry:
  %first_impl = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 588876947, i32* %canary
  %out = alloca %struct._IO_FILE*, align 8
  %net.addr = alloca %struct.network*, align 8
  %retval = alloca i64, align 8
  %block = alloca %struct.arc*, align 8
...
entry:
  %out = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 1815302750, i32* %canary
  %outfile.addr = alloca i8*, align 8
  %arc = alloca %struct.arc*, align 8
  %retval = alloca i64, align 8
  %arc2 = alloca %struct.arc*, align 8
...
entry:
  %canary = alloca i32
  store i32 589752219, i32* %canary
  %first_impl = alloca %struct.arc*, align 8
  %arc2 = alloca %struct.arc*, align 8
  %arc = alloca %struct.arc*, align 8
  %outfile.addr = alloca i8*, align 8
...
entry:
  ...
  %outfile.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1834611858, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  store i8* %outfile, i8** %outfile.addr, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store %struct._IO_FILE* null, %struct._IO_FILE** %out, align 8
...
entry:
  ...
  %arc2 = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 2117030888, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %out = alloca %struct._IO_FILE*, align 8
  %first_impl = alloca %struct.arc*, align 8
  store i8* %outfile, i8** %outfile.addr, align 8
...
entry:
  ...
  %block = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1316829677, i32* %canary
  %first_impl = alloca %struct.arc*, align 8
  %arc2 = alloca %struct.arc*, align 8
  %outfile.addr = alloca i8*, align 8
  %out = alloca %struct._IO_FILE*, align 8
...
entry:
  %block = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1000680990, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %out = alloca %struct._IO_FILE*, align 8
  %first_impl = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
