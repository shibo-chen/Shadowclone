; ModuleID = 'mcfutil.c.rand.16R1.bc'
...
func_refresh_neighbour_lists.9:                   ; preds = %ctrl0
  call void @refresh_neighbour_lists.9(%struct.network* %net)
  ret void

func_refresh_neighbour_lists.14:                  ; preds = %ctrl1
  call void @refresh_neighbour_lists.14(%struct.network* %net)
  ret void

func_refresh_neighbour_lists.15:                  ; preds = %ctrl2
  call void @refresh_neighbour_lists.15(%struct.network* %net)
  ret void

func_refresh_neighbour_lists.21:                  ; preds = %ctrl3
  call void @refresh_neighbour_lists.21(%struct.network* %net)
  ret void

func_refresh_neighbour_lists.25:                  ; preds = %ctrl4
  call void @refresh_neighbour_lists.25(%struct.network* %net)
  ret void
...
func_refresh_neighbour_lists.29:                  ; preds = %ctrl6
  call void @refresh_neighbour_lists.29(%struct.network* %net)
  ret void

func_refresh_neighbour_lists.34:                  ; preds = %ctrl7
  call void @refresh_neighbour_lists.34(%struct.network* %net)
  ret void

func_refresh_neighbour_lists.35:                  ; preds = %ctrl8
  call void @refresh_neighbour_lists.35(%struct.network* %net)
  ret void
...
func_refresh_neighbour_lists.55:                  ; preds = %ctrl10
  call void @refresh_neighbour_lists.55(%struct.network* %net)
  ret void

func_refresh_neighbour_lists.57:                  ; preds = %ctrl11
  call void @refresh_neighbour_lists.57(%struct.network* %net)
  ret void

func_refresh_neighbour_lists.63:                  ; preds = %ctrl12
  call void @refresh_neighbour_lists.63(%struct.network* %net)
  ret void

func_refresh_neighbour_lists.66:                  ; preds = %ctrl13
  call void @refresh_neighbour_lists.66(%struct.network* %net)
  ret void

func_refresh_neighbour_lists.79:                  ; preds = %ctrl13
  call void @refresh_neighbour_lists.79(%struct.network* %net)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_refresh_neighbour_lists.9, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_refresh_neighbour_lists.14, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_refresh_neighbour_lists.15, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_refresh_neighbour_lists.21, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_refresh_neighbour_lists.25, label %ctrl5
...
ctrl6:                                            ; preds = %ctrl5
  %8 = icmp eq i32 %0, 7
  br i1 %8, label %func_refresh_neighbour_lists.29, label %ctrl7

ctrl7:                                            ; preds = %ctrl6
  %9 = icmp eq i32 %0, 8
  br i1 %9, label %func_refresh_neighbour_lists.34, label %ctrl8

ctrl8:                                            ; preds = %ctrl7
  %10 = icmp eq i32 %0, 9
  br i1 %10, label %func_refresh_neighbour_lists.35, label %ctrl9
...
ctrl10:                                           ; preds = %ctrl9
  %12 = icmp eq i32 %0, 11
  br i1 %12, label %func_refresh_neighbour_lists.55, label %ctrl11

ctrl11:                                           ; preds = %ctrl10
  %13 = icmp eq i32 %0, 12
  br i1 %13, label %func_refresh_neighbour_lists.57, label %ctrl12

ctrl12:                                           ; preds = %ctrl11
  %14 = icmp eq i32 %0, 13
  br i1 %14, label %func_refresh_neighbour_lists.63, label %ctrl13

ctrl13:                                           ; preds = %ctrl12
  %15 = icmp eq i32 %0, 14
  br i1 %15, label %func_refresh_neighbour_lists.66, label %func_refresh_neighbour_lists.79
}
...
func_refresh_potential.7:                         ; preds = %ctrl0
  %3 = call i64 @refresh_potential.7(%struct.network* %net)
  ret i64 %3
...
func_refresh_potential.10:                        ; preds = %ctrl2
  %5 = call i64 @refresh_potential.10(%struct.network* %net)
  ret i64 %5

func_refresh_potential.23:                        ; preds = %ctrl3
  %6 = call i64 @refresh_potential.23(%struct.network* %net)
  ret i64 %6

func_refresh_potential.32:                        ; preds = %ctrl4
  %7 = call i64 @refresh_potential.32(%struct.network* %net)
  ret i64 %7

func_refresh_potential.33:                        ; preds = %ctrl5
  %8 = call i64 @refresh_potential.33(%struct.network* %net)
  ret i64 %8

func_refresh_potential.37:                        ; preds = %ctrl6
  %9 = call i64 @refresh_potential.37(%struct.network* %net)
  ret i64 %9

func_refresh_potential.41:                        ; preds = %ctrl7
  %10 = call i64 @refresh_potential.41(%struct.network* %net)
  ret i64 %10

func_refresh_potential.53:                        ; preds = %ctrl8
  %11 = call i64 @refresh_potential.53(%struct.network* %net)
  ret i64 %11

func_refresh_potential.60:                        ; preds = %ctrl9
  %12 = call i64 @refresh_potential.60(%struct.network* %net)
  ret i64 %12

func_refresh_potential.61:                        ; preds = %ctrl10
  %13 = call i64 @refresh_potential.61(%struct.network* %net)
  ret i64 %13

func_refresh_potential.74:                        ; preds = %ctrl11
  %14 = call i64 @refresh_potential.74(%struct.network* %net)
  ret i64 %14

func_refresh_potential.76:                        ; preds = %ctrl12
  %15 = call i64 @refresh_potential.76(%struct.network* %net)
  ret i64 %15

func_refresh_potential.77:                        ; preds = %ctrl13
  %16 = call i64 @refresh_potential.77(%struct.network* %net)
  ret i64 %16

func_refresh_potential.82:                        ; preds = %ctrl13
  %17 = call i64 @refresh_potential.82(%struct.network* %net)
  ret i64 %17

ctrl0:                                            ; preds = %rand_bb
  %18 = icmp eq i32 %0, 1
  br i1 %18, label %func_refresh_potential.7, label %ctrl1
...
ctrl2:                                            ; preds = %ctrl1
  %20 = icmp eq i32 %0, 3
  br i1 %20, label %func_refresh_potential.10, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %21 = icmp eq i32 %0, 4
  br i1 %21, label %func_refresh_potential.23, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %22 = icmp eq i32 %0, 5
  br i1 %22, label %func_refresh_potential.32, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %23 = icmp eq i32 %0, 6
  br i1 %23, label %func_refresh_potential.33, label %ctrl6

ctrl6:                                            ; preds = %ctrl5
  %24 = icmp eq i32 %0, 7
  br i1 %24, label %func_refresh_potential.37, label %ctrl7

ctrl7:                                            ; preds = %ctrl6
  %25 = icmp eq i32 %0, 8
  br i1 %25, label %func_refresh_potential.41, label %ctrl8

ctrl8:                                            ; preds = %ctrl7
  %26 = icmp eq i32 %0, 9
  br i1 %26, label %func_refresh_potential.53, label %ctrl9

ctrl9:                                            ; preds = %ctrl8
  %27 = icmp eq i32 %0, 10
  br i1 %27, label %func_refresh_potential.60, label %ctrl10

ctrl10:                                           ; preds = %ctrl9
  %28 = icmp eq i32 %0, 11
  br i1 %28, label %func_refresh_potential.61, label %ctrl11

ctrl11:                                           ; preds = %ctrl10
  %29 = icmp eq i32 %0, 12
  br i1 %29, label %func_refresh_potential.74, label %ctrl12

ctrl12:                                           ; preds = %ctrl11
  %30 = icmp eq i32 %0, 13
  br i1 %30, label %func_refresh_potential.76, label %ctrl13

ctrl13:                                           ; preds = %ctrl12
  %31 = icmp eq i32 %0, 14
  br i1 %31, label %func_refresh_potential.77, label %func_refresh_potential.82
}
...
func_flow_cost.16:                                ; preds = %ctrl0
  %3 = call double @flow_cost.16(%struct.network* %net)
  ret double %3

func_flow_cost.19:                                ; preds = %ctrl1
  %4 = call double @flow_cost.19(%struct.network* %net)
  ret double %4

func_flow_cost.20:                                ; preds = %ctrl2
  %5 = call double @flow_cost.20(%struct.network* %net)
  ret double %5

func_flow_cost.22:                                ; preds = %ctrl3
  %6 = call double @flow_cost.22(%struct.network* %net)
  ret double %6
...
func_flow_cost.43:                                ; preds = %ctrl5
  %8 = call double @flow_cost.43(%struct.network* %net)
  ret double %8

func_flow_cost.44:                                ; preds = %ctrl6
  %9 = call double @flow_cost.44(%struct.network* %net)
  ret double %9

func_flow_cost.46:                                ; preds = %ctrl7
  %10 = call double @flow_cost.46(%struct.network* %net)
  ret double %10

func_flow_cost.48:                                ; preds = %ctrl8
  %11 = call double @flow_cost.48(%struct.network* %net)
  ret double %11

func_flow_cost.64:                                ; preds = %ctrl9
  %12 = call double @flow_cost.64(%struct.network* %net)
  ret double %12
...
func_flow_cost.78:                                ; preds = %ctrl11
  %14 = call double @flow_cost.78(%struct.network* %net)
  ret double %14

func_flow_cost.83:                                ; preds = %ctrl12
  %15 = call double @flow_cost.83(%struct.network* %net)
  ret double %15

func_flow_cost.87:                                ; preds = %ctrl13
  %16 = call double @flow_cost.87(%struct.network* %net)
  ret double %16

func_flow_cost.88:                                ; preds = %ctrl13
  %17 = call double @flow_cost.88(%struct.network* %net)
  ret double %17

ctrl0:                                            ; preds = %rand_bb
  %18 = icmp eq i32 %0, 1
  br i1 %18, label %func_flow_cost.16, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %19 = icmp eq i32 %0, 2
  br i1 %19, label %func_flow_cost.19, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %20 = icmp eq i32 %0, 3
  br i1 %20, label %func_flow_cost.20, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %21 = icmp eq i32 %0, 4
  br i1 %21, label %func_flow_cost.22, label %ctrl4
...
ctrl5:                                            ; preds = %ctrl4
  %23 = icmp eq i32 %0, 6
  br i1 %23, label %func_flow_cost.43, label %ctrl6

ctrl6:                                            ; preds = %ctrl5
  %24 = icmp eq i32 %0, 7
  br i1 %24, label %func_flow_cost.44, label %ctrl7

ctrl7:                                            ; preds = %ctrl6
  %25 = icmp eq i32 %0, 8
  br i1 %25, label %func_flow_cost.46, label %ctrl8

ctrl8:                                            ; preds = %ctrl7
  %26 = icmp eq i32 %0, 9
  br i1 %26, label %func_flow_cost.48, label %ctrl9

ctrl9:                                            ; preds = %ctrl8
  %27 = icmp eq i32 %0, 10
  br i1 %27, label %func_flow_cost.64, label %ctrl10
...
ctrl11:                                           ; preds = %ctrl10
  %29 = icmp eq i32 %0, 12
  br i1 %29, label %func_flow_cost.78, label %ctrl12

ctrl12:                                           ; preds = %ctrl11
  %30 = icmp eq i32 %0, 13
  br i1 %30, label %func_flow_cost.83, label %ctrl13

ctrl13:                                           ; preds = %ctrl12
  %31 = icmp eq i32 %0, 14
  br i1 %31, label %func_flow_cost.87, label %func_flow_cost.88
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_flow_org_cost.2, label %ctrl0

func_flow_org_cost.2:                             ; preds = %rand_bb
  %2 = call double @flow_org_cost.2(%struct.network* %net)
  ret double %2

func_flow_org_cost.3:                             ; preds = %ctrl0
  %3 = call double @flow_org_cost.3(%struct.network* %net)
  ret double %3

func_flow_org_cost.11:                            ; preds = %ctrl1
  %4 = call double @flow_org_cost.11(%struct.network* %net)
  ret double %4

func_flow_org_cost.13:                            ; preds = %ctrl2
  %5 = call double @flow_org_cost.13(%struct.network* %net)
  ret double %5

func_flow_org_cost.24:                            ; preds = %ctrl3
  %6 = call double @flow_org_cost.24(%struct.network* %net)
  ret double %6

func_flow_org_cost.27:                            ; preds = %ctrl4
  %7 = call double @flow_org_cost.27(%struct.network* %net)
  ret double %7

func_flow_org_cost.31:                            ; preds = %ctrl5
  %8 = call double @flow_org_cost.31(%struct.network* %net)
  ret double %8

func_flow_org_cost.36:                            ; preds = %ctrl6
  %9 = call double @flow_org_cost.36(%struct.network* %net)
  ret double %9

func_flow_org_cost.47:                            ; preds = %ctrl7
  %10 = call double @flow_org_cost.47(%struct.network* %net)
  ret double %10
...
func_flow_org_cost.54:                            ; preds = %ctrl9
  %12 = call double @flow_org_cost.54(%struct.network* %net)
  ret double %12

func_flow_org_cost.58:                            ; preds = %ctrl10
  %13 = call double @flow_org_cost.58(%struct.network* %net)
  ret double %13

func_flow_org_cost.62:                            ; preds = %ctrl11
  %14 = call double @flow_org_cost.62(%struct.network* %net)
  ret double %14

func_flow_org_cost.65:                            ; preds = %ctrl12
  %15 = call double @flow_org_cost.65(%struct.network* %net)
  ret double %15

func_flow_org_cost.67:                            ; preds = %ctrl13
  %16 = call double @flow_org_cost.67(%struct.network* %net)
  ret double %16

func_flow_org_cost.72:                            ; preds = %ctrl13
  %17 = call double @flow_org_cost.72(%struct.network* %net)
  ret double %17

ctrl0:                                            ; preds = %rand_bb
  %18 = icmp eq i32 %0, 1
  br i1 %18, label %func_flow_org_cost.3, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %19 = icmp eq i32 %0, 2
  br i1 %19, label %func_flow_org_cost.11, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %20 = icmp eq i32 %0, 3
  br i1 %20, label %func_flow_org_cost.13, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %21 = icmp eq i32 %0, 4
  br i1 %21, label %func_flow_org_cost.24, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %22 = icmp eq i32 %0, 5
  br i1 %22, label %func_flow_org_cost.27, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %23 = icmp eq i32 %0, 6
  br i1 %23, label %func_flow_org_cost.31, label %ctrl6

ctrl6:                                            ; preds = %ctrl5
  %24 = icmp eq i32 %0, 7
  br i1 %24, label %func_flow_org_cost.36, label %ctrl7

ctrl7:                                            ; preds = %ctrl6
  %25 = icmp eq i32 %0, 8
  br i1 %25, label %func_flow_org_cost.47, label %ctrl8
...
ctrl9:                                            ; preds = %ctrl8
  %27 = icmp eq i32 %0, 10
  br i1 %27, label %func_flow_org_cost.54, label %ctrl10

ctrl10:                                           ; preds = %ctrl9
  %28 = icmp eq i32 %0, 11
  br i1 %28, label %func_flow_org_cost.58, label %ctrl11

ctrl11:                                           ; preds = %ctrl10
  %29 = icmp eq i32 %0, 12
  br i1 %29, label %func_flow_org_cost.62, label %ctrl12

ctrl12:                                           ; preds = %ctrl11
  %30 = icmp eq i32 %0, 13
  br i1 %30, label %func_flow_org_cost.65, label %ctrl13

ctrl13:                                           ; preds = %ctrl12
  %31 = icmp eq i32 %0, 14
  br i1 %31, label %func_flow_org_cost.67, label %func_flow_org_cost.72
}
...
func_primal_feasible.17:                          ; preds = %ctrl0
  %3 = call i64 @primal_feasible.17(%struct.network* %net)
  ret i64 %3

func_primal_feasible.18:                          ; preds = %ctrl1
  %4 = call i64 @primal_feasible.18(%struct.network* %net)
  ret i64 %4

func_primal_feasible.30:                          ; preds = %ctrl2
  %5 = call i64 @primal_feasible.30(%struct.network* %net)
  ret i64 %5

func_primal_feasible.45:                          ; preds = %ctrl3
  %6 = call i64 @primal_feasible.45(%struct.network* %net)
  ret i64 %6

func_primal_feasible.49:                          ; preds = %ctrl4
  %7 = call i64 @primal_feasible.49(%struct.network* %net)
  ret i64 %7

func_primal_feasible.51:                          ; preds = %ctrl5
  %8 = call i64 @primal_feasible.51(%struct.network* %net)
  ret i64 %8

func_primal_feasible.69:                          ; preds = %ctrl6
  %9 = call i64 @primal_feasible.69(%struct.network* %net)
  ret i64 %9

func_primal_feasible.81:                          ; preds = %ctrl7
  %10 = call i64 @primal_feasible.81(%struct.network* %net)
  ret i64 %10

func_primal_feasible.84:                          ; preds = %ctrl8
  %11 = call i64 @primal_feasible.84(%struct.network* %net)
  ret i64 %11

func_primal_feasible.85:                          ; preds = %ctrl9
  %12 = call i64 @primal_feasible.85(%struct.network* %net)
  ret i64 %12

func_primal_feasible.89:                          ; preds = %ctrl10
  %13 = call i64 @primal_feasible.89(%struct.network* %net)
  ret i64 %13

func_primal_feasible.90:                          ; preds = %ctrl11
  %14 = call i64 @primal_feasible.90(%struct.network* %net)
  ret i64 %14

func_primal_feasible.91:                          ; preds = %ctrl12
  %15 = call i64 @primal_feasible.91(%struct.network* %net)
  ret i64 %15

func_primal_feasible.93:                          ; preds = %ctrl13
  %16 = call i64 @primal_feasible.93(%struct.network* %net)
  ret i64 %16

func_primal_feasible.95:                          ; preds = %ctrl13
  %17 = call i64 @primal_feasible.95(%struct.network* %net)
  ret i64 %17

ctrl0:                                            ; preds = %rand_bb
  %18 = icmp eq i32 %0, 1
  br i1 %18, label %func_primal_feasible.17, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %19 = icmp eq i32 %0, 2
  br i1 %19, label %func_primal_feasible.18, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %20 = icmp eq i32 %0, 3
  br i1 %20, label %func_primal_feasible.30, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %21 = icmp eq i32 %0, 4
  br i1 %21, label %func_primal_feasible.45, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %22 = icmp eq i32 %0, 5
  br i1 %22, label %func_primal_feasible.49, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %23 = icmp eq i32 %0, 6
  br i1 %23, label %func_primal_feasible.51, label %ctrl6

ctrl6:                                            ; preds = %ctrl5
  %24 = icmp eq i32 %0, 7
  br i1 %24, label %func_primal_feasible.69, label %ctrl7

ctrl7:                                            ; preds = %ctrl6
  %25 = icmp eq i32 %0, 8
  br i1 %25, label %func_primal_feasible.81, label %ctrl8

ctrl8:                                            ; preds = %ctrl7
  %26 = icmp eq i32 %0, 9
  br i1 %26, label %func_primal_feasible.84, label %ctrl9

ctrl9:                                            ; preds = %ctrl8
  %27 = icmp eq i32 %0, 10
  br i1 %27, label %func_primal_feasible.85, label %ctrl10

ctrl10:                                           ; preds = %ctrl9
  %28 = icmp eq i32 %0, 11
  br i1 %28, label %func_primal_feasible.89, label %ctrl11

ctrl11:                                           ; preds = %ctrl10
  %29 = icmp eq i32 %0, 12
  br i1 %29, label %func_primal_feasible.90, label %ctrl12

ctrl12:                                           ; preds = %ctrl11
  %30 = icmp eq i32 %0, 13
  br i1 %30, label %func_primal_feasible.91, label %ctrl13

ctrl13:                                           ; preds = %ctrl12
  %31 = icmp eq i32 %0, 14
  br i1 %31, label %func_primal_feasible.93, label %func_primal_feasible.95
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_dual_feasible.12, label %ctrl0

func_dual_feasible.12:                            ; preds = %rand_bb
  %2 = call i64 @dual_feasible.12(%struct.network* %net)
  ret i64 %2

func_dual_feasible.26:                            ; preds = %ctrl0
  %3 = call i64 @dual_feasible.26(%struct.network* %net)
  ret i64 %3

func_dual_feasible.38:                            ; preds = %ctrl1
  %4 = call i64 @dual_feasible.38(%struct.network* %net)
  ret i64 %4

func_dual_feasible.40:                            ; preds = %ctrl2
  %5 = call i64 @dual_feasible.40(%struct.network* %net)
  ret i64 %5

func_dual_feasible.50:                            ; preds = %ctrl3
  %6 = call i64 @dual_feasible.50(%struct.network* %net)
  ret i64 %6

func_dual_feasible.56:                            ; preds = %ctrl4
  %7 = call i64 @dual_feasible.56(%struct.network* %net)
  ret i64 %7

func_dual_feasible.59:                            ; preds = %ctrl5
  %8 = call i64 @dual_feasible.59(%struct.network* %net)
  ret i64 %8

func_dual_feasible.70:                            ; preds = %ctrl6
  %9 = call i64 @dual_feasible.70(%struct.network* %net)
  ret i64 %9

func_dual_feasible.71:                            ; preds = %ctrl7
  %10 = call i64 @dual_feasible.71(%struct.network* %net)
  ret i64 %10

func_dual_feasible.73:                            ; preds = %ctrl8
  %11 = call i64 @dual_feasible.73(%struct.network* %net)
  ret i64 %11

func_dual_feasible.75:                            ; preds = %ctrl9
  %12 = call i64 @dual_feasible.75(%struct.network* %net)
  ret i64 %12

func_dual_feasible.80:                            ; preds = %ctrl10
  %13 = call i64 @dual_feasible.80(%struct.network* %net)
  ret i64 %13

func_dual_feasible.86:                            ; preds = %ctrl11
  %14 = call i64 @dual_feasible.86(%struct.network* %net)
  ret i64 %14

func_dual_feasible.92:                            ; preds = %ctrl12
  %15 = call i64 @dual_feasible.92(%struct.network* %net)
  ret i64 %15

func_dual_feasible.94:                            ; preds = %ctrl13
  %16 = call i64 @dual_feasible.94(%struct.network* %net)
  ret i64 %16

func_dual_feasible.96:                            ; preds = %ctrl13
  %17 = call i64 @dual_feasible.96(%struct.network* %net)
  ret i64 %17

ctrl0:                                            ; preds = %rand_bb
  %18 = icmp eq i32 %0, 1
  br i1 %18, label %func_dual_feasible.26, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %19 = icmp eq i32 %0, 2
  br i1 %19, label %func_dual_feasible.38, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %20 = icmp eq i32 %0, 3
  br i1 %20, label %func_dual_feasible.40, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %21 = icmp eq i32 %0, 4
  br i1 %21, label %func_dual_feasible.50, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %22 = icmp eq i32 %0, 5
  br i1 %22, label %func_dual_feasible.56, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %23 = icmp eq i32 %0, 6
  br i1 %23, label %func_dual_feasible.59, label %ctrl6

ctrl6:                                            ; preds = %ctrl5
  %24 = icmp eq i32 %0, 7
  br i1 %24, label %func_dual_feasible.70, label %ctrl7

ctrl7:                                            ; preds = %ctrl6
  %25 = icmp eq i32 %0, 8
  br i1 %25, label %func_dual_feasible.71, label %ctrl8

ctrl8:                                            ; preds = %ctrl7
  %26 = icmp eq i32 %0, 9
  br i1 %26, label %func_dual_feasible.73, label %ctrl9

ctrl9:                                            ; preds = %ctrl8
  %27 = icmp eq i32 %0, 10
  br i1 %27, label %func_dual_feasible.75, label %ctrl10

ctrl10:                                           ; preds = %ctrl9
  %28 = icmp eq i32 %0, 11
  br i1 %28, label %func_dual_feasible.80, label %ctrl11

ctrl11:                                           ; preds = %ctrl10
  %29 = icmp eq i32 %0, 12
  br i1 %29, label %func_dual_feasible.86, label %ctrl12

ctrl12:                                           ; preds = %ctrl11
  %30 = icmp eq i32 %0, 13
  br i1 %30, label %func_dual_feasible.92, label %ctrl13

ctrl13:                                           ; preds = %ctrl12
  %31 = icmp eq i32 %0, 14
  br i1 %31, label %func_dual_feasible.94, label %func_dual_feasible.96
}
...
entry:
  ...
  %canary = alloca i32
  store i32 1598558000, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local double @flow_org_cost.2(%struct.network* %net) #0 {
entry:
  %node = alloca %struct.node*, align 8
  ...
  %canary = alloca i32
  store i32 359924651, i32* %canary
...
entry:
  ...
  %stop = alloca i8*, align 8
  %canary = alloca i32
  store i32 825913272, i32* %canary
  %operational_cost = alloca i64, align 8
  %fleet = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
  %node = alloca %struct.node*, align 8
...
entry:
  ...
  %canary = alloca i32
  store i32 1144964931, i32* %canary
...
entry:
  ...
  %operational_cost = alloca i64, align 8
  %canary = alloca i32
  store i32 1240869411, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %stop = alloca i8*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 0, i64* %fleet, align 8
...
entry:
  ...
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1564129780, i32* %canary
  %arc = alloca %struct.arc*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
  %nodes = getelementptr inbounds %struct.network, %struct.network* %0, i32 0, i32 21
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @refresh_potential.7(%struct.network* %net) #0 {
entry:
  %tmp = alloca %struct.node*, align 8
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 2094409506, i32* %canary
  %root = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
  %checksum = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 794240514, i32* %canary
  %node = alloca %struct.node*, align 8
  %root = alloca %struct.node*, align 8
  %tmp = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @refresh_neighbour_lists.9(%struct.network* %net) #0 {
entry:
  %node = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
  %stop = alloca i8*, align 8
  %canary = alloca i32
  store i32 1641290356, i32* %canary
  %arc = alloca %struct.arc*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
  %nodes = getelementptr inbounds %struct.network, %struct.network* %0, i32 0, i32 21
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @refresh_potential.10(%struct.network* %net) #0 {
entry:
  %root = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 2078759892, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %tmp = alloca %struct.node*, align 8
  %node = alloca %struct.node*, align 8
  %checksum = alloca i64, align 8
...
entry:
  ...
  %stop = alloca i8*, align 8
  %canary = alloca i32
  store i32 1420541596, i32* %canary
  %fleet = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 0, i64* %fleet, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @dual_feasible.12(%struct.network* %net) #0 {
entry:
  %canary = alloca i32
  store i32 431014622, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local double @flow_org_cost.13(%struct.network* %net) #0 {
entry:
  %net.addr = alloca %struct.network*, align 8
  %stop = alloca i8*, align 8
  %operational_cost = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1957739854, i32* %canary
  %node = alloca %struct.node*, align 8
  %fleet = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 0, i64* %fleet, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @refresh_neighbour_lists.14(%struct.network* %net) #0 {
entry:
  %arc = alloca %struct.arc*, align 8
  %node = alloca %struct.node*, align 8
  %stop = alloca i8*, align 8
  %canary = alloca i32
  store i32 607632925, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
  %nodes = getelementptr inbounds %struct.network, %struct.network* %0, i32 0, i32 21
...
entry:
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 397313150, i32* %canary
  %stop = alloca i8*, align 8
  %arc = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local double @flow_cost.16(%struct.network* %net) #0 {
entry:
  %canary = alloca i32
  store i32 166090682, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %fleet = alloca i64, align 8
  %stop = alloca i8*, align 8
  %operational_cost = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @primal_feasible.18(%struct.network* %net) #0 {
entry:
  %node = alloca %struct.node*, align 8
  %stop_dummy = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 341252955, i32* %canary
  %retval = alloca i64, align 8
  %stop = alloca i8*, align 8
  %arc = alloca %struct.arc*, align 8
  %flow = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local double @flow_cost.19(%struct.network* %net) #0 {
entry:
  %operational_cost = alloca i64, align 8
  %canary = alloca i32
  store i32 1336297133, i32* %canary
  %fleet = alloca i64, align 8
  %node = alloca %struct.node*, align 8
  %arc = alloca %struct.arc*, align 8
  %stop = alloca i8*, align 8
...
entry:
  ...
  %operational_cost = alloca i64, align 8
  %canary = alloca i32
  store i32 1582685943, i32* %canary
  %stop = alloca i8*, align 8
  %net.addr = alloca %struct.network*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 0, i64* %fleet, align 8
...
entry:
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 2037844252, i32* %canary
  %stop = alloca i8*, align 8
  %node = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local double @flow_cost.22(%struct.network* %net) #0 {
entry:
  %operational_cost = alloca i64, align 8
  %stop = alloca i8*, align 8
  %fleet = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1164786868, i32* %canary
  %node = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 0, i64* %fleet, align 8
...
entry:
  %tmp = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1356202821, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %node = alloca %struct.node*, align 8
  %root = alloca %struct.node*, align 8
  %checksum = alloca i64, align 8
...
entry:
  %canary = alloca i32
  store i32 778189447, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %operational_cost = alloca i64, align 8
  %node = alloca %struct.node*, align 8
  %stop = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @refresh_neighbour_lists.25(%struct.network* %net) #0 {
entry:
  %net.addr = alloca %struct.network*, align 8
  %arc = alloca %struct.arc*, align 8
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1182778801, i32* %canary
  %stop = alloca i8*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
  %nodes = getelementptr inbounds %struct.network, %struct.network* %0, i32 0, i32 21
...
entry:
  %canary = alloca i32
  store i32 1383890157, i32* %canary
  %retval = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
  %arc = alloca %struct.arc*, align 8
  %stop = alloca %struct.arc*, align 8
...
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 1526606674, i32* %canary
  %operational_cost = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
  %fleet = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  %stop = alloca i8*, align 8
  %canary = alloca i32
  store i32 1304983251, i32* %canary
  %node = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
  %arc = alloca %struct.arc*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 606226295, i32* %canary
  %node = alloca %struct.node*, align 8
  %arc = alloca %struct.arc*, align 8
  %stop = alloca i8*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  ...
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1084248923, i32* %canary
  %stop = alloca i8*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
  %dummy_arcs = getelementptr inbounds %struct.network, %struct.network* %0, i32 0, i32 25
...
entry:
  ...
  %fleet = alloca i64, align 8
  %canary = alloca i32
  store i32 1018255354, i32* %canary
  %stop = alloca i8*, align 8
  %arc = alloca %struct.arc*, align 8
  %node = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 1561740733, i32* %canary
  %root = alloca %struct.node*, align 8
  %checksum = alloca i64, align 8
  %tmp = alloca %struct.node*, align 8
  %node = alloca %struct.node*, align 8
...
entry:
  ...
  %checksum = alloca i64, align 8
  %canary = alloca i32
  store i32 874176529, i32* %canary
  %tmp = alloca %struct.node*, align 8
  %node = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @refresh_neighbour_lists.34(%struct.network* %net) #0 {
entry:
  %stop = alloca i8*, align 8
  %arc = alloca %struct.arc*, align 8
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 744056659, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
  %nodes = getelementptr inbounds %struct.network, %struct.network* %0, i32 0, i32 21
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @refresh_neighbour_lists.35(%struct.network* %net) #0 {
entry:
  %stop = alloca i8*, align 8
  %net.addr = alloca %struct.network*, align 8
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 358662450, i32* %canary
  %node = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
  %nodes = getelementptr inbounds %struct.network, %struct.network* %0, i32 0, i32 21
...
entry:
  %canary = alloca i32
  store i32 1834906403, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %arc = alloca %struct.arc*, align 8
  %fleet = alloca i64, align 8
  %node = alloca %struct.node*, align 8
...
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 1882082924, i32* %canary
  %root = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
  %nodes = getelementptr inbounds %struct.network, %struct.network* %0, i32 0, i32 21
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @dual_feasible.38(%struct.network* %net) #0 {
entry:
  %net.addr = alloca %struct.network*, align 8
  %stop = alloca %struct.arc*, align 8
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1988113008, i32* %canary
  %red_cost = alloca i64, align 8
  %retval = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
...
entry:
  ...
  %operational_cost = alloca i64, align 8
  %canary = alloca i32
  store i32 1299173093, i32* %canary
  %node = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
  %arc = alloca %struct.arc*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @dual_feasible.40(%struct.network* %net) #0 {
entry:
  %retval = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1967659150, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %red_cost = alloca i64, align 8
  %stop = alloca %struct.arc*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  ...
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1034840229, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
  %nodes = getelementptr inbounds %struct.network, %struct.network* %0, i32 0, i32 21
...
entry:
  %canary = alloca i32
  store i32 1799054027, i32* %canary
  %node = alloca %struct.node*, align 8
  %stop = alloca i8*, align 8
  %net.addr = alloca %struct.network*, align 8
  %arc = alloca %struct.arc*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local double @flow_cost.43(%struct.network* %net) #0 {
entry:
  %stop = alloca i8*, align 8
  %node = alloca %struct.node*, align 8
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1858402625, i32* %canary
  %operational_cost = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
  %fleet = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local double @flow_cost.44(%struct.network* %net) #0 {
entry:
  %operational_cost = alloca i64, align 8
  %canary = alloca i32
  store i32 1246382917, i32* %canary
  %node = alloca %struct.node*, align 8
  %fleet = alloca i64, align 8
  %stop = alloca i8*, align 8
  %arc = alloca %struct.arc*, align 8
...
entry:
  %canary = alloca i32
  store i32 124084673, i32* %canary
  %retval = alloca i64, align 8
  %dummy = alloca %struct.arc*, align 8
  %flow = alloca i64, align 8
  %node = alloca %struct.node*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local double @flow_cost.46(%struct.network* %net) #0 {
entry:
  %operational_cost = alloca i64, align 8
  %stop = alloca i8*, align 8
  %canary = alloca i32
  store i32 1070185253, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %arc = alloca %struct.arc*, align 8
  %fleet = alloca i64, align 8
  %node = alloca %struct.node*, align 8
...
entry:
  ...
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 483547461, i32* %canary
  %fleet = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
  %stop = alloca i8*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local double @flow_cost.48(%struct.network* %net) #0 {
entry:
  %fleet = alloca i64, align 8
  %operational_cost = alloca i64, align 8
  %stop = alloca i8*, align 8
  ...
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 131111826, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 0, i64* %fleet, align 8
  store i64 0, i64* %operational_cost, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @primal_feasible.49(%struct.network* %net) #0 {
entry:
  %arc = alloca %struct.arc*, align 8
  %stop = alloca i8*, align 8
  %node = alloca %struct.node*, align 8
  ...
  %flow = alloca i64, align 8
  %canary = alloca i32
  store i32 521556030, i32* %canary
  %dummy = alloca %struct.arc*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
  %dummy_arcs = getelementptr inbounds %struct.network, %struct.network* %0, i32 0, i32 25
...
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 1294729567, i32* %canary
  %stop = alloca %struct.arc*, align 8
  %red_cost = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @primal_feasible.51(%struct.network* %net) #0 {
entry:
  %flow = alloca i64, align 8
  %dummy = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
  ...
  %retval = alloca i64, align 8
  %canary = alloca i32
  store i32 860746720, i32* %canary
  %stop = alloca i8*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
  %dummy_arcs = getelementptr inbounds %struct.network, %struct.network* %0, i32 0, i32 25
...
entry:
  ...
  %stop = alloca i8*, align 8
  %canary = alloca i32
  store i32 2074219919, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 0, i64* %fleet, align 8
  store i64 0, i64* %operational_cost, align 8
...
entry:
  %root = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1875846880, i32* %canary
  %checksum = alloca i64, align 8
  %node = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
  %tmp = alloca %struct.node*, align 8
...
entry:
  ...
  %operational_cost = alloca i64, align 8
  %canary = alloca i32
  store i32 605236267, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 0, i64* %fleet, align 8
...
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 769180465, i32* %canary
  %node = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
  %nodes = getelementptr inbounds %struct.network, %struct.network* %0, i32 0, i32 21
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @dual_feasible.56(%struct.network* %net) #0 {
entry:
  %arc = alloca %struct.arc*, align 8
  %retval = alloca i64, align 8
  %canary = alloca i32
  store i32 517735795, i32* %canary
  %red_cost = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
  %stop = alloca %struct.arc*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @refresh_neighbour_lists.57(%struct.network* %net) #0 {
entry:
  %arc = alloca %struct.arc*, align 8
  %node = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 1003149187, i32* %canary
  %stop = alloca i8*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
  %nodes = getelementptr inbounds %struct.network, %struct.network* %0, i32 0, i32 21
...
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 562100125, i32* %canary
  %node = alloca %struct.node*, align 8
  %operational_cost = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @dual_feasible.59(%struct.network* %net) #0 {
entry:
  %arc = alloca %struct.arc*, align 8
  %stop = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 119102938, i32* %canary
  %red_cost = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
  %retval = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @refresh_potential.60(%struct.network* %net) #0 {
entry:
  %tmp = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 644761019, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %root = alloca %struct.node*, align 8
  %node = alloca %struct.node*, align 8
  %checksum = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @refresh_potential.61(%struct.network* %net) #0 {
entry:
  %canary = alloca i32
  store i32 1127062632, i32* %canary
  %root = alloca %struct.node*, align 8
  %node = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
  %tmp = alloca %struct.node*, align 8
...
entry:
  %canary = alloca i32
  store i32 1095413624, i32* %canary
  %stop = alloca i8*, align 8
  %operational_cost = alloca i64, align 8
  %fleet = alloca i64, align 8
  %node = alloca %struct.node*, align 8
...
entry:
  %canary = alloca i32
  store i32 848796046, i32* %canary
  %stop = alloca i8*, align 8
  %arc = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
  %node = alloca %struct.node*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local double @flow_cost.64(%struct.network* %net) #0 {
entry:
  %fleet = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
  %node = alloca %struct.node*, align 8
  ...
  %stop = alloca i8*, align 8
  %canary = alloca i32
  store i32 1483981228, i32* %canary
  %operational_cost = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 0, i64* %fleet, align 8
  store i64 0, i64* %operational_cost, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local double @flow_org_cost.65(%struct.network* %net) #0 {
entry:
  %fleet = alloca i64, align 8
  %stop = alloca i8*, align 8
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 251228857, i32* %canary
  %operational_cost = alloca i64, align 8
  %node = alloca %struct.node*, align 8
  %arc = alloca %struct.arc*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @refresh_neighbour_lists.66(%struct.network* %net) #0 {
entry:
  %arc = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 2036937691, i32* %canary
  %node = alloca %struct.node*, align 8
  %stop = alloca i8*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
...
entry:
  ...
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 2106890071, i32* %canary
  %fleet = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 0, i64* %fleet, align 8
  store i64 0, i64* %operational_cost, align 8
...
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 987821439, i32* %canary
  %operational_cost = alloca i64, align 8
  %fleet = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 0, i64* %fleet, align 8
...
entry:
  ...
  %stop = alloca i8*, align 8
  %canary = alloca i32
  store i32 1615388394, i32* %canary
  %node = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
  %stop_dummy = alloca %struct.arc*, align 8
  %retval = alloca i64, align 8
...
entry:
  ...
  %stop = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 566101029, i32* %canary
  %arc = alloca %struct.arc*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
  %stop_arcs = getelementptr inbounds %struct.network, %struct.network* %0, i32 0, i32 24
...
entry:
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1536580182, i32* %canary
  %retval = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
...
entry:
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1478956053, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %node = alloca %struct.node*, align 8
  %fleet = alloca i64, align 8
  %operational_cost = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @dual_feasible.73(%struct.network* %net) #0 {
entry:
  %red_cost = alloca i64, align 8
  %canary = alloca i32
  store i32 1605631287, i32* %canary
  %retval = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
  %arc = alloca %struct.arc*, align 8
  %stop = alloca %struct.arc*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @refresh_potential.74(%struct.network* %net) #0 {
entry:
  %canary = alloca i32
  store i32 910419577, i32* %canary
  %node = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
  %root = alloca %struct.node*, align 8
  %tmp = alloca %struct.node*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @dual_feasible.75(%struct.network* %net) #0 {
entry:
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 904187700, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %red_cost = alloca i64, align 8
  %stop = alloca %struct.arc*, align 8
  %retval = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @refresh_potential.76(%struct.network* %net) #0 {
entry:
  %checksum = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 1760939516, i32* %canary
  %root = alloca %struct.node*, align 8
  %tmp = alloca %struct.node*, align 8
  %node = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @refresh_potential.77(%struct.network* %net) #0 {
entry:
  %tmp = alloca %struct.node*, align 8
  %root = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1245718582, i32* %canary
  %checksum = alloca i64, align 8
  %node = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 358773055, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %operational_cost = alloca i64, align 8
  %fleet = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
...
entry:
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 472396911, i32* %canary
  %stop = alloca i8*, align 8
  %net.addr = alloca %struct.network*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
...
entry:
  ...
  %red_cost = alloca i64, align 8
  %canary = alloca i32
  store i32 834812174, i32* %canary
  %retval = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
  %stop = alloca %struct.arc*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 753072575, i32* %canary
  %flow = alloca i64, align 8
  %node = alloca %struct.node*, align 8
  %dummy = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
...
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 1102618623, i32* %canary
  %checksum = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
  %nodes = getelementptr inbounds %struct.network, %struct.network* %0, i32 0, i32 21
...
entry:
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 539093683, i32* %canary
  %node = alloca %struct.node*, align 8
  %stop = alloca i8*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 0, i64* %fleet, align 8
...
entry:
  ...
  %stop = alloca i8*, align 8
  %canary = alloca i32
  store i32 2115107262, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %retval = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
  %node = alloca %struct.node*, align 8
...
entry:
  ...
  %retval = alloca i64, align 8
  %canary = alloca i32
  store i32 1590115499, i32* %canary
  %flow = alloca i64, align 8
  %node = alloca %struct.node*, align 8
  %dummy = alloca %struct.arc*, align 8
  %stop = alloca i8*, align 8
...
entry:
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 1499763423, i32* %canary
  %retval = alloca i64, align 8
  %red_cost = alloca i64, align 8
  %stop = alloca %struct.arc*, align 8
  %arc = alloca %struct.arc*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local double @flow_cost.87(%struct.network* %net) #0 {
entry:
  %canary = alloca i32
  store i32 581157510, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %fleet = alloca i64, align 8
  %node = alloca %struct.node*, align 8
  %operational_cost = alloca i64, align 8
...
entry:
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1277751589, i32* %canary
  %node = alloca %struct.node*, align 8
  %stop = alloca i8*, align 8
  %net.addr = alloca %struct.network*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 968110073, i32* %canary
  %stop_dummy = alloca %struct.arc*, align 8
  %stop = alloca i8*, align 8
  %flow = alloca i64, align 8
  %node = alloca %struct.node*, align 8
...
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 1739545281, i32* %canary
  %stop_dummy = alloca %struct.arc*, align 8
  %retval = alloca i64, align 8
  %stop = alloca i8*, align 8
  %node = alloca %struct.node*, align 8
...
entry:
  ...
  %stop = alloca i8*, align 8
  %canary = alloca i32
  store i32 1073840385, i32* %canary
  %dummy = alloca %struct.arc*, align 8
  %arc = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
  %stop_dummy = alloca %struct.arc*, align 8
...
entry:
  %red_cost = alloca i64, align 8
  %canary = alloca i32
  store i32 878552943, i32* %canary
  %retval = alloca i64, align 8
  %stop = alloca %struct.arc*, align 8
  %arc = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @primal_feasible.93(%struct.network* %net) #0 {
entry:
  %net.addr = alloca %struct.network*, align 8
  %stop_dummy = alloca %struct.arc*, align 8
  %arc = alloca %struct.arc*, align 8
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1458446982, i32* %canary
  %stop = alloca i8*, align 8
  %flow = alloca i64, align 8
  %dummy = alloca %struct.arc*, align 8
  %retval = alloca i64, align 8
...
entry:
  ...
  %red_cost = alloca i64, align 8
  %canary = alloca i32
  store i32 1997459438, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %arc = alloca %struct.arc*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @primal_feasible.95(%struct.network* %net) #0 {
entry:
  %stop = alloca i8*, align 8
  %retval = alloca i64, align 8
  %node = alloca %struct.node*, align 8
  ...
  %stop_dummy = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1283824449, i32* %canary
  %dummy = alloca %struct.arc*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
  %dummy_arcs = getelementptr inbounds %struct.network, %struct.network* %0, i32 0, i32 25
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @dual_feasible.96(%struct.network* %net) #0 {
entry:
  %retval = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
  %red_cost = alloca i64, align 8
  %stop = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 675855575, i32* %canary
  %arc = alloca %struct.arc*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
  %stop_arcs = getelementptr inbounds %struct.network, %struct.network* %0, i32 0, i32 24
