; ModuleID = 'mcfutil.c.rand.4R3.bc'
...
func_refresh_neighbour_lists.2:                   ; preds = %ctrl0
  call void @refresh_neighbour_lists.2(%struct.network* %net)
  ret void

func_refresh_neighbour_lists.5:                   ; preds = %ctrl1
  call void @refresh_neighbour_lists.5(%struct.network* %net)
  ret void

func_refresh_neighbour_lists.16:                  ; preds = %ctrl1
  call void @refresh_neighbour_lists.16(%struct.network* %net)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_refresh_neighbour_lists.2, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_refresh_neighbour_lists.5, label %func_refresh_neighbour_lists.16
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_refresh_potential.8, label %ctrl0

func_refresh_potential.8:                         ; preds = %rand_bb
  %2 = call i64 @refresh_potential.8(%struct.network* %net)
  ret i64 %2

func_refresh_potential.15:                        ; preds = %ctrl0
  %3 = call i64 @refresh_potential.15(%struct.network* %net)
  ret i64 %3

func_refresh_potential.17:                        ; preds = %ctrl1
  %4 = call i64 @refresh_potential.17(%struct.network* %net)
  ret i64 %4

func_refresh_potential.20:                        ; preds = %ctrl1
  %5 = call i64 @refresh_potential.20(%struct.network* %net)
  ret i64 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_refresh_potential.15, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_refresh_potential.17, label %func_refresh_potential.20
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_flow_cost.18, label %ctrl0

func_flow_cost.18:                                ; preds = %rand_bb
  %2 = call double @flow_cost.18(%struct.network* %net)
  ret double %2
...
func_flow_cost.21:                                ; preds = %ctrl1
  %4 = call double @flow_cost.21(%struct.network* %net)
  ret double %4

func_flow_cost.24:                                ; preds = %ctrl1
  %5 = call double @flow_cost.24(%struct.network* %net)
  ret double %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_flow_cost.19, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_flow_cost.21, label %func_flow_cost.24
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_flow_org_cost.4, label %ctrl0

func_flow_org_cost.4:                             ; preds = %rand_bb
  %2 = call double @flow_org_cost.4(%struct.network* %net)
  ret double %2
...
func_flow_org_cost.13:                            ; preds = %ctrl1
  %4 = call double @flow_org_cost.13(%struct.network* %net)
  ret double %4

func_flow_org_cost.14:                            ; preds = %ctrl1
  %5 = call double @flow_org_cost.14(%struct.network* %net)
  ret double %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_flow_org_cost.7, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_flow_org_cost.13, label %func_flow_org_cost.14
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_primal_feasible.10, label %ctrl0

func_primal_feasible.10:                          ; preds = %rand_bb
  %2 = call i64 @primal_feasible.10(%struct.network* %net)
  ret i64 %2

func_primal_feasible.11:                          ; preds = %ctrl0
  %3 = call i64 @primal_feasible.11(%struct.network* %net)
  ret i64 %3

func_primal_feasible.22:                          ; preds = %ctrl1
  %4 = call i64 @primal_feasible.22(%struct.network* %net)
  ret i64 %4

func_primal_feasible.23:                          ; preds = %ctrl1
  %5 = call i64 @primal_feasible.23(%struct.network* %net)
  ret i64 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_primal_feasible.11, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_primal_feasible.22, label %func_primal_feasible.23
}
...
func_dual_feasible.9:                             ; preds = %ctrl1
  %4 = call i64 @dual_feasible.9(%struct.network* %net)
  ret i64 %4

func_dual_feasible.12:                            ; preds = %ctrl1
  %5 = call i64 @dual_feasible.12(%struct.network* %net)
  ret i64 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_dual_feasible.6, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_dual_feasible.9, label %func_dual_feasible.12
}
...
entry:
  %canary = alloca i32
  store i32 1425807635, i32* %canary
  %net.addr = alloca %struct.network*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @refresh_neighbour_lists.2(%struct.network* %net) #0 {
entry:
  %net.addr = alloca %struct.network*, align 8
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 572096996, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %stop = alloca i8*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
...
entry:
  ...
  %canary = alloca i32
  store i32 578382544, i32* %canary
  %net.addr = alloca %struct.network*, align 8
...
entry:
  ...
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 763782653, i32* %canary
  %stop = alloca i8*, align 8
  %arc = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @refresh_neighbour_lists.5(%struct.network* %net) #0 {
entry:
  %stop = alloca i8*, align 8
  %canary = alloca i32
  store i32 2080152341, i32* %canary
  %node = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
  %arc = alloca %struct.arc*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  ...
  %retval = alloca i64, align 8
  %canary = alloca i32
  store i32 1557858295, i32* %canary
  %red_cost = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
...
entry:
  ...
  %operational_cost = alloca i64, align 8
  %canary = alloca i32
  store i32 1991828257, i32* %canary
  %stop = alloca i8*, align 8
  %node = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 0, i64* %fleet, align 8
...
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 1643639135, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1297635569, i32* %canary
  %red_cost = alloca i64, align 8
  %stop = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
  %arc = alloca %struct.arc*, align 8
...
entry:
  %canary = alloca i32
  store i32 806038724, i32* %canary
  %node = alloca %struct.node*, align 8
...
entry:
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 490873800, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %stop_dummy = alloca %struct.arc*, align 8
  %stop = alloca i8*, align 8
  %arc = alloca %struct.arc*, align 8
...
entry:
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 1203523472, i32* %canary
  %retval = alloca i64, align 8
  %red_cost = alloca i64, align 8
  %stop = alloca %struct.arc*, align 8
  %arc = alloca %struct.arc*, align 8
...
entry:
  %canary = alloca i32
  store i32 1170453373, i32* %canary
  %fleet = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
  %operational_cost = alloca i64, align 8
  %node = alloca %struct.node*, align 8
...
entry:
  ...
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 505982009, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 0, i64* %fleet, align 8
  store i64 0, i64* %operational_cost, align 8
...
entry:
  ...
  %tmp = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 314761441, i32* %canary
  %node = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
  %checksum = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 2120892554, i32* %canary
  %node = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
  %nodes = getelementptr inbounds %struct.network, %struct.network* %0, i32 0, i32 21
...
entry:
  %checksum = alloca i64, align 8
  %canary = alloca i32
  store i32 1924977747, i32* %canary
  %root = alloca %struct.node*, align 8
  %node = alloca %struct.node*, align 8
  %tmp = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
...
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 974373230, i32* %canary
  %operational_cost = alloca i64, align 8
  %stop = alloca i8*, align 8
  %fleet = alloca i64, align 8
  %node = alloca %struct.node*, align 8
...
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 1123735946, i32* %canary
  %stop = alloca i8*, align 8
  %arc = alloca %struct.arc*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 0, i64* %fleet, align 8
...
entry:
  ...
  %checksum = alloca i64, align 8
  %canary = alloca i32
  store i32 1633954096, i32* %canary
  %tmp = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
  %nodes = getelementptr inbounds %struct.network, %struct.network* %0, i32 0, i32 21
...
entry:
  ...
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1902951462, i32* %canary
  %stop = alloca i8*, align 8
  %arc = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  ...
  %stop = alloca i8*, align 8
  %canary = alloca i32
  store i32 773888152, i32* %canary
  %node = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
  %dummy_arcs = getelementptr inbounds %struct.network, %struct.network* %0, i32 0, i32 25
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @primal_feasible.23(%struct.network* %net) #0 {
entry:
  %stop = alloca i8*, align 8
  %stop_dummy = alloca %struct.arc*, align 8
  %node = alloca %struct.node*, align 8
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 180511729, i32* %canary
  %dummy = alloca %struct.arc*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
  %dummy_arcs = getelementptr inbounds %struct.network, %struct.network* %0, i32 0, i32 25
...
entry:
  ...
  %stop = alloca i8*, align 8
  %canary = alloca i32
  store i32 462030121, i32* %canary
  %fleet = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
  %operational_cost = alloca i64, align 8
  %node = alloca %struct.node*, align 8
