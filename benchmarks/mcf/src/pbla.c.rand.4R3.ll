...
entry:
  ...
  %canary = alloca i32
  store i32 392807757, i32* %canary
...
entry:
  ...
  %delta.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 1836985697, i32* %canary
  %jplus.addr = alloca %struct.node*, align 8
  %iminus = alloca %struct.node*, align 8
  %iplus.addr = alloca %struct.node*, align 8
  %w.addr = alloca %struct.node**, align 8
...
entry:
  %canary = alloca i32
  store i32 2032707497, i32* %canary
  %w.addr = alloca %struct.node**, align 8
  %xchange.addr = alloca i64*, align 8
  %iminus = alloca %struct.node*, align 8
  %delta.addr = alloca i64*, align 8
...
entry:
  %canary = alloca i32
  store i32 1922211053, i32* %canary
  %xchange.addr = alloca i64*, align 8
  %iminus = alloca %struct.node*, align 8
  %w.addr = alloca %struct.node**, align 8
  %jplus.addr = alloca %struct.node*, align 8
