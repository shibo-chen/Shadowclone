; ModuleID = 'mcfutil.c.rand.4P1.bc'
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_refresh_neighbour_lists.7, label %ctrl0

func_refresh_neighbour_lists.7:                   ; preds = %rand_bb
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_refresh_neighbour_lists.16, label %func_refresh_neighbour_lists.20
}
...
func_refresh_potential.9:                         ; preds = %ctrl1
  %5 = call i64 @refresh_potential.9(%struct.network* %net)
  ret i64 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_refresh_potential.6, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_refresh_potential.8, label %func_refresh_potential.9
}
...
func_flow_cost.4:                                 ; preds = %ctrl0
  %3 = call double @flow_cost.4(%struct.network* %net)
  ret double %3
...
func_flow_cost.12:                                ; preds = %ctrl1
  %5 = call double @flow_cost.12(%struct.network* %net)
  ret double %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_flow_cost.4, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_flow_cost.10, label %func_flow_cost.12
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_flow_org_cost.11, label %ctrl0

func_flow_org_cost.11:                            ; preds = %rand_bb
  %2 = call double @flow_org_cost.11(%struct.network* %net)
  ret double %2

func_flow_org_cost.13:                            ; preds = %ctrl0
  %3 = call double @flow_org_cost.13(%struct.network* %net)
  ret double %3
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_flow_org_cost.13, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_flow_org_cost.14, label %func_flow_org_cost.19
}
...
func_primal_feasible.21:                          ; preds = %ctrl1
  %5 = call i64 @primal_feasible.21(%struct.network* %net)
  ret i64 %5
...
ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_primal_feasible.18, label %func_primal_feasible.21
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_dual_feasible.17, label %ctrl0

func_dual_feasible.17:                            ; preds = %rand_bb
  %2 = call i64 @dual_feasible.17(%struct.network* %net)
  ret i64 %2

func_dual_feasible.22:                            ; preds = %ctrl0
  %3 = call i64 @dual_feasible.22(%struct.network* %net)
  ret i64 %3

func_dual_feasible.23:                            ; preds = %ctrl1
  %4 = call i64 @dual_feasible.23(%struct.network* %net)
  ret i64 %4
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_dual_feasible.22, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_dual_feasible.23, label %func_dual_feasible.24
}
...
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 1629011586, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1884858396, i32* %canary
...
entry:
  ...
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 401159123, i32* %canary
...
entry:
  ...
  %operational_cost = alloca i64, align 8
  %canary = alloca i32
  store i32 1856093764, i32* %canary
  %fleet = alloca i64, align 8
  %node = alloca %struct.node*, align 8
  %stop = alloca i8*, align 8
  %net.addr = alloca %struct.network*, align 8
...
entry:
  ...
  %flow = alloca i64, align 8
  %canary = alloca i32
  store i32 1780693673, i32* %canary
  %dummy = alloca %struct.arc*, align 8
  %arc = alloca %struct.arc*, align 8
  %stop_dummy = alloca %struct.arc*, align 8
  %stop = alloca i8*, align 8
...
entry:
  %canary = alloca i32
  store i32 1533829332, i32* %canary
  %checksum = alloca i64, align 8
  %tmp = alloca %struct.node*, align 8
  %root = alloca %struct.node*, align 8
  %node = alloca %struct.node*, align 8
...
entry:
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1031367686, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %stop = alloca i8*, align 8
  %node = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  ...
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 833631675, i32* %canary
  %root = alloca %struct.node*, align 8
  %tmp = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
...
entry:
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 753150198, i32* %canary
  %node = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 0, i64* %fleet, align 8
  store i64 0, i64* %operational_cost, align 8
...
entry:
  ...
  %fleet = alloca i64, align 8
  %canary = alloca i32
  store i32 1103699728, i32* %canary
  %operational_cost = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 0, i64* %fleet, align 8
  store i64 0, i64* %operational_cost, align 8
...
entry:
  %canary = alloca i32
  store i32 1724681822, i32* %canary
  %operational_cost = alloca i64, align 8
  %node = alloca %struct.node*, align 8
  %stop = alloca i8*, align 8
  %arc = alloca %struct.arc*, align 8
...
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 766299857, i32* %canary
  %fleet = alloca i64, align 8
  %node = alloca %struct.node*, align 8
  %operational_cost = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  ...
  %operational_cost = alloca i64, align 8
  %canary = alloca i32
  store i32 906767031, i32* %canary
  %fleet = alloca i64, align 8
  %stop = alloca i8*, align 8
  %net.addr = alloca %struct.network*, align 8
  %node = alloca %struct.node*, align 8
...
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 641222319, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %node = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
...
entry:
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 2053207067, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %stop = alloca i8*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @dual_feasible.17(%struct.network* %net) #0 {
entry:
  %arc = alloca %struct.arc*, align 8
  %retval = alloca i64, align 8
  %stop = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 208437340, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 2035132224, i32* %canary
  %stop_dummy = alloca %struct.arc*, align 8
  %node = alloca %struct.node*, align 8
  %retval = alloca i64, align 8
  %stop = alloca i8*, align 8
...
entry:
  %canary = alloca i32
  store i32 1802701453, i32* %canary
  %operational_cost = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
  %node = alloca %struct.node*, align 8
  %fleet = alloca i64, align 8
...
entry:
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 803492803, i32* %canary
  %node = alloca %struct.node*, align 8
  %stop = alloca i8*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
...
entry:
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1837571706, i32* %canary
  %stop = alloca i8*, align 8
  %dummy = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
  %retval = alloca i64, align 8
...
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 1370180681, i32* %canary
  %red_cost = alloca i64, align 8
  %retval = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
