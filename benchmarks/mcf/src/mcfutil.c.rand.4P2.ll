; ModuleID = 'mcfutil.c.rand.4P2.bc'
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_refresh_neighbour_lists.5, label %ctrl0

func_refresh_neighbour_lists.5:                   ; preds = %rand_bb
  call void @refresh_neighbour_lists.5(%struct.network* %net)
  ret void

func_refresh_neighbour_lists.8:                   ; preds = %ctrl0
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_refresh_neighbour_lists.8, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_refresh_neighbour_lists.11, label %func_refresh_neighbour_lists.13
}
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_refresh_potential.4, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_refresh_potential.18, label %func_refresh_potential.22
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_flow_cost.20, label %ctrl0

func_flow_cost.20:                                ; preds = %rand_bb
  %2 = call double @flow_cost.20(%struct.network* %net)
  ret double %2

func_flow_cost.21:                                ; preds = %ctrl0
  %3 = call double @flow_cost.21(%struct.network* %net)
  ret double %3

func_flow_cost.23:                                ; preds = %ctrl1
  %4 = call double @flow_cost.23(%struct.network* %net)
  ret double %4
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_flow_cost.21, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_flow_cost.23, label %func_flow_cost.24
}
...
func_flow_org_cost.6:                             ; preds = %ctrl0
  %3 = call double @flow_org_cost.6(%struct.network* %net)
  ret double %3
...
func_flow_org_cost.10:                            ; preds = %ctrl1
  %5 = call double @flow_org_cost.10(%struct.network* %net)
  ret double %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_flow_org_cost.6, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_flow_org_cost.7, label %func_flow_org_cost.10
}
...
func_primal_feasible.15:                          ; preds = %ctrl0
  %3 = call i64 @primal_feasible.15(%struct.network* %net)
  ret i64 %3
...
func_primal_feasible.19:                          ; preds = %ctrl1
  %5 = call i64 @primal_feasible.19(%struct.network* %net)
  ret i64 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_primal_feasible.15, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_primal_feasible.17, label %func_primal_feasible.19
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_dual_feasible.9, label %ctrl0

func_dual_feasible.9:                             ; preds = %rand_bb
  %2 = call i64 @dual_feasible.9(%struct.network* %net)
  ret i64 %2

func_dual_feasible.12:                            ; preds = %ctrl0
  %3 = call i64 @dual_feasible.12(%struct.network* %net)
  ret i64 %3
...
func_dual_feasible.16:                            ; preds = %ctrl1
  %5 = call i64 @dual_feasible.16(%struct.network* %net)
  ret i64 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_dual_feasible.12, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_dual_feasible.14, label %func_dual_feasible.16
}
...
entry:
  ...
  %canary = alloca i32
  store i32 1641622034, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1381586330, i32* %canary
...
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 565342886, i32* %canary
...
entry:
  ...
  %tmp = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1430997928, i32* %canary
  %root = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
  %nodes = getelementptr inbounds %struct.network, %struct.network* %0, i32 0, i32 21
...
entry:
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1434330343, i32* %canary
  %node = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
  %stop = alloca i8*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1932869287, i32* %canary
  %node = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
  %stop = alloca i8*, align 8
  %operational_cost = alloca i64, align 8
...
entry:
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1839128444, i32* %canary
  %stop = alloca i8*, align 8
  %fleet = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
  %operational_cost = alloca i64, align 8
...
entry:
  ...
  %stop = alloca i8*, align 8
  %canary = alloca i32
  store i32 552539934, i32* %canary
  %node = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
...
entry:
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 1767179881, i32* %canary
...
entry:
  ...
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 988204969, i32* %canary
  %stop = alloca i8*, align 8
  %arc = alloca %struct.arc*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 0, i64* %fleet, align 8
...
entry:
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 1725612959, i32* %canary
  %stop = alloca %struct.arc*, align 8
  %retval = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
  %red_cost = alloca i64, align 8
...
entry:
  ...
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 901320761, i32* %canary
  %stop = alloca i8*, align 8
  %arc = alloca %struct.arc*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
...
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 1762215513, i32* %canary
  %stop = alloca %struct.arc*, align 8
  %retval = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
...
entry:
  ...
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 714789444, i32* %canary
  %dummy = alloca %struct.arc*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
  %dummy_arcs = getelementptr inbounds %struct.network, %struct.network* %0, i32 0, i32 25
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @dual_feasible.16(%struct.network* %net) #0 {
entry:
  %red_cost = alloca i64, align 8
  %stop = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 736838465, i32* %canary
  %retval = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
  %arc = alloca %struct.arc*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 880644241, i32* %canary
  %stop_dummy = alloca %struct.arc*, align 8
  %arc = alloca %struct.arc*, align 8
  %stop = alloca i8*, align 8
  %retval = alloca i64, align 8
...
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 1251095567, i32* %canary
  %checksum = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
  %nodes = getelementptr inbounds %struct.network, %struct.network* %0, i32 0, i32 21
...
entry:
  %retval = alloca i64, align 8
  %canary = alloca i32
  store i32 1696370883, i32* %canary
  %stop_dummy = alloca %struct.arc*, align 8
  %arc = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
  %dummy = alloca %struct.arc*, align 8
...
entry:
  %stop = alloca i8*, align 8
  %canary = alloca i32
  store i32 520229667, i32* %canary
  %operational_cost = alloca i64, align 8
  %node = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
  %arc = alloca %struct.arc*, align 8
...
entry:
  %stop = alloca i8*, align 8
  %canary = alloca i32
  store i32 1893800161, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %operational_cost = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
  %fleet = alloca i64, align 8
...
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 1058457529, i32* %canary
  %tmp = alloca %struct.node*, align 8
  %node = alloca %struct.node*, align 8
  %root = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1785673191, i32* %canary
  %node = alloca %struct.node*, align 8
  %operational_cost = alloca i64, align 8
  %stop = alloca i8*, align 8
  %arc = alloca %struct.arc*, align 8
...
entry:
  ...
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 911358544, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %arc = alloca %struct.arc*, align 8
  %operational_cost = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
