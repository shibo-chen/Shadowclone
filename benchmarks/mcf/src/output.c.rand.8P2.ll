...
func_write_circulations.8:                        ; preds = %ctrl5
  %9 = call i64 @write_circulations.8(i8* %outfile, %struct.network* %net)
  ret i64 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_write_circulations.2, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_write_circulations.3, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_write_circulations.4, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_write_circulations.5, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_write_circulations.6, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_write_circulations.7, label %func_write_circulations.8
}
...
entry:
  ...
  %canary = alloca i32
  store i32 1242234496, i32* %canary
...
entry:
  ...
  %outfile.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1927762675, i32* %canary
  %arc2 = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
  store i8* %outfile, i8** %outfile.addr, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  ...
  %first_impl = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 943094516, i32* %canary
  %arc2 = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
  %arc = alloca %struct.arc*, align 8
  %block = alloca %struct.arc*, align 8
...
entry:
  %canary = alloca i32
  store i32 379382066, i32* %canary
  %outfile.addr = alloca i8*, align 8
  %net.addr = alloca %struct.network*, align 8
  %block = alloca %struct.arc*, align 8
  %arc = alloca %struct.arc*, align 8
...
entry:
  ...
  %out = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 1704813796, i32* %canary
  %arc2 = alloca %struct.arc*, align 8
  %arc = alloca %struct.arc*, align 8
  %outfile.addr = alloca i8*, align 8
  %first_impl = alloca %struct.arc*, align 8
...
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 1066174326, i32* %canary
  %first_impl = alloca %struct.arc*, align 8
  %out = alloca %struct._IO_FILE*, align 8
  store i8* %outfile, i8** %outfile.addr, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  ...
  %arc2 = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1048630646, i32* %canary
  %first_impl = alloca %struct.arc*, align 8
  %retval = alloca i64, align 8
  store i8* %outfile, i8** %outfile.addr, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 1073627575, i32* %canary
  %arc2 = alloca %struct.arc*, align 8
  %retval = alloca i64, align 8
  %out = alloca %struct._IO_FILE*, align 8
  %arc = alloca %struct.arc*, align 8
