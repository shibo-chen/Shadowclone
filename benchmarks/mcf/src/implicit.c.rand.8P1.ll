; ModuleID = 'implicit.c.rand.8P1.bc'
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_resize_prob.21, label %ctrl0

func_resize_prob.21:                              ; preds = %rand_bb
  %2 = call i64 @resize_prob.21(%struct.network* %net)
  ret i64 %2

func_resize_prob.28:                              ; preds = %ctrl0
  %3 = call i64 @resize_prob.28(%struct.network* %net)
  ret i64 %3

func_resize_prob.29:                              ; preds = %ctrl1
  %4 = call i64 @resize_prob.29(%struct.network* %net)
  ret i64 %4

func_resize_prob.30:                              ; preds = %ctrl2
  %5 = call i64 @resize_prob.30(%struct.network* %net)
  ret i64 %5

func_resize_prob.32:                              ; preds = %ctrl3
  %6 = call i64 @resize_prob.32(%struct.network* %net)
  ret i64 %6

func_resize_prob.34:                              ; preds = %ctrl4
  %7 = call i64 @resize_prob.34(%struct.network* %net)
  ret i64 %7

func_resize_prob.39:                              ; preds = %ctrl5
  %8 = call i64 @resize_prob.39(%struct.network* %net)
  ret i64 %8
...
ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_resize_prob.28, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_resize_prob.29, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_resize_prob.30, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_resize_prob.32, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_resize_prob.34, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_resize_prob.39, label %func_resize_prob.40
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_insert_new_arc.3, label %ctrl0

func_insert_new_arc.3:                            ; preds = %rand_bb
  call void @insert_new_arc.3(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void

func_insert_new_arc.15:                           ; preds = %ctrl0
  call void @insert_new_arc.15(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void

func_insert_new_arc.17:                           ; preds = %ctrl1
  call void @insert_new_arc.17(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void

func_insert_new_arc.19:                           ; preds = %ctrl2
  call void @insert_new_arc.19(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void

func_insert_new_arc.27:                           ; preds = %ctrl3
  call void @insert_new_arc.27(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void

func_insert_new_arc.31:                           ; preds = %ctrl4
  call void @insert_new_arc.31(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void

func_insert_new_arc.35:                           ; preds = %ctrl5
  call void @insert_new_arc.35(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void

func_insert_new_arc.38:                           ; preds = %ctrl5
  call void @insert_new_arc.38(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_insert_new_arc.15, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_insert_new_arc.17, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_insert_new_arc.19, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_insert_new_arc.27, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_insert_new_arc.31, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_insert_new_arc.35, label %func_insert_new_arc.38
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_replace_weaker_arc.4, label %ctrl0

func_replace_weaker_arc.4:                        ; preds = %rand_bb
  call void @replace_weaker_arc.4(%struct.network* %net, %struct.arc* %new, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void

func_replace_weaker_arc.5:                        ; preds = %ctrl0
  call void @replace_weaker_arc.5(%struct.network* %net, %struct.arc* %new, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void
...
func_replace_weaker_arc.22:                       ; preds = %ctrl2
  call void @replace_weaker_arc.22(%struct.network* %net, %struct.arc* %new, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void

func_replace_weaker_arc.26:                       ; preds = %ctrl3
  call void @replace_weaker_arc.26(%struct.network* %net, %struct.arc* %new, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void

func_replace_weaker_arc.33:                       ; preds = %ctrl4
  call void @replace_weaker_arc.33(%struct.network* %net, %struct.arc* %new, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void

func_replace_weaker_arc.36:                       ; preds = %ctrl5
  call void @replace_weaker_arc.36(%struct.network* %net, %struct.arc* %new, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void

func_replace_weaker_arc.37:                       ; preds = %ctrl5
  call void @replace_weaker_arc.37(%struct.network* %net, %struct.arc* %new, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_replace_weaker_arc.5, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_replace_weaker_arc.14, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_replace_weaker_arc.22, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_replace_weaker_arc.26, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_replace_weaker_arc.33, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_replace_weaker_arc.36, label %func_replace_weaker_arc.37
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_price_out_impl.2, label %ctrl0

func_price_out_impl.2:                            ; preds = %rand_bb
  %2 = call i64 @price_out_impl.2(%struct.network* %net)
  ret i64 %2
...
func_price_out_impl.9:                            ; preds = %ctrl1
  %4 = call i64 @price_out_impl.9(%struct.network* %net)
  ret i64 %4

func_price_out_impl.12:                           ; preds = %ctrl2
  %5 = call i64 @price_out_impl.12(%struct.network* %net)
  ret i64 %5

func_price_out_impl.13:                           ; preds = %ctrl3
  %6 = call i64 @price_out_impl.13(%struct.network* %net)
  ret i64 %6

func_price_out_impl.16:                           ; preds = %ctrl4
  %7 = call i64 @price_out_impl.16(%struct.network* %net)
  ret i64 %7

func_price_out_impl.18:                           ; preds = %ctrl5
  %8 = call i64 @price_out_impl.18(%struct.network* %net)
  ret i64 %8

func_price_out_impl.20:                           ; preds = %ctrl5
  %9 = call i64 @price_out_impl.20(%struct.network* %net)
  ret i64 %9
...
ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_price_out_impl.9, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_price_out_impl.12, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_price_out_impl.13, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_price_out_impl.16, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_price_out_impl.18, label %func_price_out_impl.20
}
...
func_suspend_impl.6:                              ; preds = %ctrl0
  %3 = call i64 @suspend_impl.6(%struct.network* %net, i64 %threshold, i64 %all)
  ret i64 %3

func_suspend_impl.7:                              ; preds = %ctrl1
  %4 = call i64 @suspend_impl.7(%struct.network* %net, i64 %threshold, i64 %all)
  ret i64 %4
...
func_suspend_impl.11:                             ; preds = %ctrl3
  %6 = call i64 @suspend_impl.11(%struct.network* %net, i64 %threshold, i64 %all)
  ret i64 %6

func_suspend_impl.23:                             ; preds = %ctrl4
  %7 = call i64 @suspend_impl.23(%struct.network* %net, i64 %threshold, i64 %all)
  ret i64 %7

func_suspend_impl.24:                             ; preds = %ctrl5
  %8 = call i64 @suspend_impl.24(%struct.network* %net, i64 %threshold, i64 %all)
  ret i64 %8

func_suspend_impl.25:                             ; preds = %ctrl5
  %9 = call i64 @suspend_impl.25(%struct.network* %net, i64 %threshold, i64 %all)
  ret i64 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_suspend_impl.6, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_suspend_impl.7, label %ctrl2
...
ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_suspend_impl.11, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_suspend_impl.23, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_suspend_impl.24, label %func_suspend_impl.25
}
...
entry:
  ...
  %canary = alloca i32
  store i32 1375057732, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @price_out_impl.2(%struct.network* %net) #0 {
entry:
  %canary = alloca i32
  store i32 847236776, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @insert_new_arc.3(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost) #0 {
entry:
  %pos = alloca i64, align 8
  %head.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1382193795, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @replace_weaker_arc.4(%struct.network* %net, %struct.arc* %new, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost) #0 {
entry:
  %pos = alloca i64, align 8
  %canary = alloca i32
  store i32 1792129114, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %head.addr = alloca %struct.node*, align 8
  %new.addr = alloca %struct.arc*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @replace_weaker_arc.5(%struct.network* %net, %struct.arc* %new, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost) #0 {
entry:
  %new.addr = alloca %struct.arc*, align 8
  %head.addr = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @suspend_impl.6(%struct.network* %net, i64 %threshold, i64 %all) #0 {
entry:
  %susp = alloca i64, align 8
  %canary = alloca i32
  store i32 435699392, i32* %canary
  %all.addr = alloca i64, align 8
  %red_cost = alloca i64, align 8
  %stop = alloca i8*, align 8
  %new_arc = alloca %struct.arc*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @suspend_impl.7(%struct.network* %net, i64 %threshold, i64 %all) #0 {
entry:
  %susp = alloca i64, align 8
  %red_cost = alloca i64, align 8
  %canary = alloca i32
  store i32 378957686, i32* %canary
  %stop = alloca i8*, align 8
  %new_arc = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
  %arc = alloca %struct.arc*, align 8
...
entry:
  ...
  %resized = alloca i64, align 8
  %canary = alloca i32
  store i32 1359935992, i32* %canary
  %arcin = alloca %struct.arc*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 0, i64* %new_arcs, align 8
  store i64 0, i64* %resized, align 8
...
return:                                           ; preds = %if.end109, %if.then10
  %143 = load i64, i64* %retval, align 8
  %144 = load i32, i32* %canary
  %145 = icmp eq i32 %144, 1359935992
  br i1 %145, label %146, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @price_out_impl.9(%struct.network* %net) #0 {
entry:
  %arcout = alloca %struct.arc*, align 8
  %stop = alloca %struct.arc*, align 8
  %latest = alloca i64, align 8
  ...
  %head_potential = alloca i64, align 8
  %canary = alloca i32
  store i32 146612347, i32* %canary
  %arc_cost = alloca i64, align 8
  %arcin = alloca %struct.arc*, align 8
  %retval = alloca i64, align 8
  %new_arcs = alloca i64, align 8
...
entry:
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 805098267, i32* %canary
  %red_cost = alloca i64, align 8
  %stop = alloca i8*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 %threshold, i64* %threshold.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @suspend_impl.11(%struct.network* %net, i64 %threshold, i64 %all) #0 {
entry:
  %all.addr = alloca i64, align 8
  %new_arc = alloca %struct.arc*, align 8
  %susp = alloca i64, align 8
  ...
  %stop = alloca i8*, align 8
  %canary = alloca i32
  store i32 1698841403, i32* %canary
  %threshold.addr = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 %threshold, i64* %threshold.addr, align 8
  store i64 %all, i64* %all.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @price_out_impl.12(%struct.network* %net) #0 {
entry:
  %arcout = alloca %struct.arc*, align 8
  %bigM_minus_min_impl_duration = alloca i64, align 8
  %tail = alloca %struct.node*, align 8
  ...
  %resized = alloca i64, align 8
  %canary = alloca i32
  store i32 146483557, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %arc_cost = alloca i64, align 8
  %trips = alloca i64, align 8
  %head = alloca %struct.node*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @price_out_impl.13(%struct.network* %net) #0 {
entry:
  %bigM = alloca i64, align 8
  %i = alloca i64, align 8
  %bigM_minus_min_impl_duration = alloca i64, align 8
  %canary = alloca i32
  store i32 995263195, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %stop = alloca %struct.arc*, align 8
  %red_cost = alloca i64, align 8
  %head = alloca %struct.node*, align 8
...
entry:
  ...
  %new.addr = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 864282268, i32* %canary
  %red_cost.addr = alloca i64, align 8
  %cost.addr = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
  %pos = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @insert_new_arc.15(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost) #0 {
entry:
  %canary = alloca i32
  store i32 505499429, i32* %canary
  %new.addr = alloca %struct.arc*, align 8
  %tail.addr = alloca %struct.node*, align 8
  %pos = alloca i64, align 8
  %cost.addr = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @price_out_impl.16(%struct.network* %net) #0 {
entry:
  %latest = alloca i64, align 8
  %head_potential = alloca i64, align 8
  %first_of_sparse_list = alloca %struct.arc*, align 8
  ...
  %new_arcs = alloca i64, align 8
  %canary = alloca i32
  store i32 244041018, i32* %canary
  %bigM = alloca i64, align 8
  %retval = alloca i64, align 8
  %stop = alloca %struct.arc*, align 8
  %arcin = alloca %struct.arc*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @insert_new_arc.17(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost) #0 {
entry:
  %canary = alloca i32
  store i32 1297850900, i32* %canary
  %head.addr = alloca %struct.node*, align 8
  %pos = alloca i64, align 8
  %new.addr = alloca %struct.arc*, align 8
  %cost.addr = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @price_out_impl.18(%struct.network* %net) #0 {
entry:
  %head = alloca %struct.node*, align 8
  %min_impl_duration = alloca i64, align 8
  %retval = alloca i64, align 8
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 2117824830, i32* %canary
  %trips = alloca i64, align 8
  %stop = alloca %struct.arc*, align 8
  %arcout = alloca %struct.arc*, align 8
  %arcnew = alloca %struct.arc*, align 8
...
return:                                           ; preds = %if.end109, %if.then10
  %143 = load i64, i64* %retval, align 8
  %144 = load i32, i32* %canary
  %145 = icmp eq i32 %144, 2117824830
  br i1 %145, label %146, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @insert_new_arc.19(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost) #0 {
entry:
  %newpos.addr = alloca i64, align 8
  %tail.addr = alloca %struct.node*, align 8
  %new.addr = alloca %struct.arc*, align 8
  %pos = alloca i64, align 8
  %canary = alloca i32
  store i32 652478882, i32* %canary
  %head.addr = alloca %struct.node*, align 8
  %cost.addr = alloca i64, align 8
  %red_cost.addr = alloca i64, align 8
  store %struct.arc* %new, %struct.arc** %new.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @price_out_impl.20(%struct.network* %net) #0 {
entry:
  %retval = alloca i64, align 8
  %tail = alloca %struct.node*, align 8
  %trips = alloca i64, align 8
  ...
  %first_of_sparse_list = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 814604740, i32* %canary
  %arcnew = alloca %struct.arc*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 0, i64* %new_arcs, align 8
  store i64 0, i64* %resized, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @resize_prob.21(%struct.network* %net) #0 {
entry:
  %retval = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 323402404, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @replace_weaker_arc.22(%struct.network* %net, %struct.arc* %new, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost) #0 {
entry:
  %cost.addr = alloca i64, align 8
  %new.addr = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
  ...
  %red_cost.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1081606373, i32* %canary
  %head.addr = alloca %struct.node*, align 8
  %cmp = alloca i64, align 8
  %tail.addr = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @suspend_impl.23(%struct.network* %net, i64 %threshold, i64 %all) #0 {
entry:
  %threshold.addr = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 671661365, i32* %canary
  %all.addr = alloca i64, align 8
  %susp = alloca i64, align 8
  %red_cost = alloca i64, align 8
  %new_arc = alloca %struct.arc*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @suspend_impl.24(%struct.network* %net, i64 %threshold, i64 %all) #0 {
entry:
  %arc = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
  %all.addr = alloca i64, align 8
  ...
  %threshold.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 720870555, i32* %canary
  %new_arc = alloca %struct.arc*, align 8
  %red_cost = alloca i64, align 8
  %stop = alloca i8*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @suspend_impl.25(%struct.network* %net, i64 %threshold, i64 %all) #0 {
entry:
  %susp = alloca i64, align 8
  %stop = alloca i8*, align 8
  %threshold.addr = alloca i64, align 8
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 557848440, i32* %canary
  %all.addr = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 %threshold, i64* %threshold.addr, align 8
  store i64 %all, i64* %all.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @replace_weaker_arc.26(%struct.network* %net, %struct.arc* %new, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost) #0 {
entry:
  %pos = alloca i64, align 8
  %cost.addr = alloca i64, align 8
  %head.addr = alloca %struct.node*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @insert_new_arc.27(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost) #0 {
entry:
  %new.addr = alloca %struct.arc*, align 8
  %red_cost.addr = alloca i64, align 8
  %tail.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1933926949, i32* %canary
  %pos = alloca i64, align 8
  %newpos.addr = alloca i64, align 8
  %head.addr = alloca %struct.node*, align 8
  %cost.addr = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @resize_prob.28(%struct.network* %net) #0 {
entry:
  %canary = alloca i32
  store i32 1780886592, i32* %canary
  %retval = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
  %root = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @resize_prob.29(%struct.network* %net) #0 {
entry:
  %arc = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1845644873, i32* %canary
  %retval = alloca i64, align 8
  %stop = alloca %struct.node*, align 8
  %off = alloca i64, align 8
  %root = alloca %struct.node*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @resize_prob.30(%struct.network* %net) #0 {
entry:
  %off = alloca i64, align 8
  %node = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
  ...
  %root = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1150990636, i32* %canary
  %arc = alloca %struct.arc*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
  %max_new_m = getelementptr inbounds %struct.network, %struct.network* %0, i32 0, i32 9
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @insert_new_arc.31(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost) #0 {
entry:
  %pos = alloca i64, align 8
  %head.addr = alloca %struct.node*, align 8
  %new.addr = alloca %struct.arc*, align 8
  ...
  %red_cost.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 290044124, i32* %canary
  %newpos.addr = alloca i64, align 8
  %cost.addr = alloca i64, align 8
  store %struct.arc* %new, %struct.arc** %new.addr, align 8
  store i64 %newpos, i64* %newpos.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @resize_prob.32(%struct.network* %net) #0 {
entry:
  %canary = alloca i32
  store i32 615421522, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %node = alloca %struct.node*, align 8
  %arc = alloca %struct.arc*, align 8
  %off = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @replace_weaker_arc.33(%struct.network* %net, %struct.arc* %new, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost) #0 {
entry:
  %net.addr = alloca %struct.network*, align 8
  %head.addr = alloca %struct.node*, align 8
  %tail.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1272441516, i32* %canary
  %cmp = alloca i64, align 8
  %pos = alloca i64, align 8
  %cost.addr = alloca i64, align 8
  %new.addr = alloca %struct.arc*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @resize_prob.34(%struct.network* %net) #0 {
entry:
  %net.addr = alloca %struct.network*, align 8
  %stop = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 325861535, i32* %canary
  %root = alloca %struct.node*, align 8
  %off = alloca i64, align 8
  %retval = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @insert_new_arc.35(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost) #0 {
entry:
  %tail.addr = alloca %struct.node*, align 8
  %cost.addr = alloca i64, align 8
  %new.addr = alloca %struct.arc*, align 8
  ...
  %head.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1949245109, i32* %canary
  %newpos.addr = alloca i64, align 8
  store %struct.arc* %new, %struct.arc** %new.addr, align 8
  store i64 %newpos, i64* %newpos.addr, align 8
  store %struct.node* %tail, %struct.node** %tail.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @replace_weaker_arc.36(%struct.network* %net, %struct.arc* %new, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost) #0 {
entry:
  %red_cost.addr = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
  %head.addr = alloca %struct.node*, align 8
  ...
  %new.addr = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1937165368, i32* %canary
  %pos = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store %struct.arc* %new, %struct.arc** %new.addr, align 8
  store %struct.node* %tail, %struct.node** %tail.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @replace_weaker_arc.37(%struct.network* %net, %struct.arc* %new, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost) #0 {
entry:
  %pos = alloca i64, align 8
  %new.addr = alloca %struct.arc*, align 8
  %head.addr = alloca %struct.node*, align 8
  ...
  %tail.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1185085808, i32* %canary
  %cmp = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store %struct.arc* %new, %struct.arc** %new.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @insert_new_arc.38(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost) #0 {
entry:
  %canary = alloca i32
  store i32 1140053863, i32* %canary
  %tail.addr = alloca %struct.node*, align 8
  %newpos.addr = alloca i64, align 8
  %new.addr = alloca %struct.arc*, align 8
  %cost.addr = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @resize_prob.39(%struct.network* %net) #0 {
entry:
  %retval = alloca i64, align 8
  %root = alloca %struct.node*, align 8
  %stop = alloca %struct.node*, align 8
  ...
  %off = alloca i64, align 8
  %canary = alloca i32
  store i32 1232963718, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
...
entry:
  ...
  %root = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1984605198, i32* %canary
  %retval = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
  %off = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
