...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$2101086677, -20(%rbp)  # imm = 0x7D3C09D5
	movq	%rdi, -8(%rbp)
	movq	%rsi, -16(%rbp)
	movq	%rdx, -32(%rbp)
.LBB1_1:                                # %for.cond
...
.LBB1_13:                               # %for.inc12
	...
	jmp	.LBB1_8
.LBB1_14:                               # %for.end14
	cmpl	$2101086677, -20(%rbp)  # imm = 0x7D3C09D5
	jne	.LBB1_16
.LBB1_15:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$711715608, -20(%rbp)   # imm = 0x2A6BEB18
	movq	%rdi, -16(%rbp)
	movq	%rsi, -8(%rbp)
	movq	%rdx, -32(%rbp)
.LBB2_1:                                # %for.cond
...
.LBB2_13:                               # %for.inc12
	...
	jmp	.LBB2_8
.LBB2_14:                               # %for.end14
	cmpl	$711715608, -20(%rbp)   # imm = 0x2A6BEB18
	jne	.LBB2_16
.LBB2_15:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1842699998, -20(%rbp)  # imm = 0x6DD55EDE
	movq	%rdi, -8(%rbp)
	movq	%rsi, -16(%rbp)
	movq	%rdx, -32(%rbp)
.LBB3_1:                                # %for.cond
...
.LBB3_13:                               # %for.inc12
	...
	jmp	.LBB3_8
.LBB3_14:                               # %for.end14
	cmpl	$1842699998, -20(%rbp)  # imm = 0x6DD55EDE
	jne	.LBB3_16
.LBB3_15:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$6237599, -20(%rbp)     # imm = 0x5F2D9F
	movq	%rdi, -16(%rbp)
	movq	%rsi, -8(%rbp)
	movq	%rdx, -32(%rbp)
.LBB4_1:                                # %for.cond
...
.LBB4_13:                               # %for.inc12
	...
	jmp	.LBB4_8
.LBB4_14:                               # %for.end14
	cmpl	$6237599, -20(%rbp)     # imm = 0x5F2D9F
	jne	.LBB4_16
.LBB4_15:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$357738507, -20(%rbp)   # imm = 0x1552A80B
	movq	%rdi, -16(%rbp)
	movq	%rsi, -8(%rbp)
	movq	%rdx, -32(%rbp)
.LBB5_1:                                # %for.cond
...
.LBB5_13:                               # %for.inc12
	...
	jmp	.LBB5_8
.LBB5_14:                               # %for.end14
	cmpl	$357738507, -20(%rbp)   # imm = 0x1552A80B
	jne	.LBB5_16
.LBB5_15:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1606160805, -20(%rbp)  # imm = 0x5FBC11A5
	movq	%rdi, -8(%rbp)
	movq	%rsi, -16(%rbp)
	movq	%rdx, -32(%rbp)
.LBB6_1:                                # %for.cond
...
.LBB6_13:                               # %for.inc12
	...
	jmp	.LBB6_8
.LBB6_14:                               # %for.end14
	cmpl	$1606160805, -20(%rbp)  # imm = 0x5FBC11A5
	jne	.LBB6_16
.LBB6_15:
	addq	$32, %rsp
	popq	%rbp
