; ModuleID = 'treeup.c.rand.16P3.bc'
...
entry:
  ...
  %canary = alloca i32
  store i32 126191999, i32* %canary
...
entry:
  ...
  %temp = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1524624581, i32* %canary
  %feas_tol.addr = alloca i64, align 8
  %iminus.addr = alloca %struct.node*, align 8
  %bea.addr = alloca %struct.arc*, align 8
  %new_flow.addr = alloca i64, align 8
...
if.end128:                                        ; preds = %for.end127, %for.end108
  %152 = load i32, i32* %canary
  %153 = icmp eq i32 %152, 1524624581
  br i1 %153, label %154, label %func_exit
...
entry:
  ...
  %new_pred = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 302890925, i32* %canary
  %iplus.addr = alloca %struct.node*, align 8
  %father = alloca %struct.node*, align 8
  %depth_iminus = alloca i64, align 8
  %depth_temp = alloca i64, align 8
...
entry:
  ...
  %flow_temp = alloca i64, align 8
  %canary = alloca i32
  store i32 750434591, i32* %canary
  %depth_temp = alloca i64, align 8
  %bea.addr = alloca %struct.arc*, align 8
  %new_pred = alloca %struct.node*, align 8
  %jminus.addr = alloca %struct.node*, align 8
...
entry:
  ...
  %feas_tol.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 903356581, i32* %canary
  %new_depth = alloca i64, align 8
  %orientation_temp = alloca i64, align 8
  %cycle_ori.addr = alloca i64, align 8
  %flow_temp = alloca i64, align 8
...
entry:
  ...
  %basic_arc_temp = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1190937901, i32* %canary
  %feas_tol.addr = alloca i64, align 8
  %temp = alloca %struct.node*, align 8
  %jminus.addr = alloca %struct.node*, align 8
  %depth_iminus = alloca i64, align 8
...
if.end128:                                        ; preds = %for.end127, %for.end108
  %152 = load i32, i32* %canary
  %153 = icmp eq i32 %152, 1190937901
  br i1 %153, label %154, label %func_exit
...
entry:
  ...
  %orientation_temp = alloca i64, align 8
  %canary = alloca i32
  store i32 889428193, i32* %canary
  %flow_temp = alloca i64, align 8
  %new_orientation.addr = alloca i64, align 8
  %basic_arc_temp = alloca %struct.arc*, align 8
  %father = alloca %struct.node*, align 8
...
entry:
  ...
  %sigma.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1729447989, i32* %canary
  %jminus.addr = alloca %struct.node*, align 8
  %flow_temp = alloca i64, align 8
  %feas_tol.addr = alloca i64, align 8
  %delta.addr = alloca i64, align 8
...
if.end128:                                        ; preds = %for.end127, %for.end108
  %152 = load i32, i32* %canary
  %153 = icmp eq i32 %152, 1729447989
  br i1 %153, label %154, label %func_exit
...
entry:
  ...
  %new_depth = alloca i64, align 8
  %canary = alloca i32
  store i32 1187443269, i32* %canary
  %jminus.addr = alloca %struct.node*, align 8
  %jplus.addr = alloca %struct.node*, align 8
  %iminus.addr = alloca %struct.node*, align 8
  %delta.addr = alloca i64, align 8
...
if.end128:                                        ; preds = %for.end127, %for.end108
  %152 = load i32, i32* %canary
  %153 = icmp eq i32 %152, 1187443269
  br i1 %153, label %154, label %func_exit
...
entry:
  ...
  %iplus.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1541187846, i32* %canary
  %father = alloca %struct.node*, align 8
  %iminus.addr = alloca %struct.node*, align 8
  %feas_tol.addr = alloca i64, align 8
  %depth_temp = alloca i64, align 8
...
if.end128:                                        ; preds = %for.end127, %for.end108
  %152 = load i32, i32* %canary
  %153 = icmp eq i32 %152, 1541187846
  br i1 %153, label %154, label %func_exit
...
entry:
  ...
  %flow_temp = alloca i64, align 8
  %canary = alloca i32
  store i32 1480753680, i32* %canary
  %new_orientation.addr = alloca i64, align 8
  %delta.addr = alloca i64, align 8
  %iminus.addr = alloca %struct.node*, align 8
  %jminus.addr = alloca %struct.node*, align 8
...
if.end128:                                        ; preds = %for.end127, %for.end108
  %152 = load i32, i32* %canary
  %153 = icmp eq i32 %152, 1480753680
  br i1 %153, label %154, label %func_exit
...
entry:
  ...
  %new_depth = alloca i64, align 8
  %canary = alloca i32
  store i32 1739459311, i32* %canary
  %jminus.addr = alloca %struct.node*, align 8
  %jplus.addr = alloca %struct.node*, align 8
  %iminus.addr = alloca %struct.node*, align 8
  %depth_temp = alloca i64, align 8
...
if.end128:                                        ; preds = %for.end127, %for.end108
  %152 = load i32, i32* %canary
  %153 = icmp eq i32 %152, 1739459311
  br i1 %153, label %154, label %func_exit
...
entry:
  ...
  %new_orientation.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1511292545, i32* %canary
  %temp = alloca %struct.node*, align 8
  %jminus.addr = alloca %struct.node*, align 8
  %flow_temp = alloca i64, align 8
  %jplus.addr = alloca %struct.node*, align 8
...
if.end128:                                        ; preds = %for.end127, %for.end108
  %152 = load i32, i32* %canary
  %153 = icmp eq i32 %152, 1511292545
  br i1 %153, label %154, label %func_exit
...
entry:
  ...
  %bea.addr = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 645113017, i32* %canary
  %iminus.addr = alloca %struct.node*, align 8
  %flow_temp = alloca i64, align 8
  %cycle_ori.addr = alloca i64, align 8
  %feas_tol.addr = alloca i64, align 8
...
entry:
  ...
  %new_pred = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 505955147, i32* %canary
  %jplus.addr = alloca %struct.node*, align 8
  %bea.addr = alloca %struct.arc*, align 8
  %jminus.addr = alloca %struct.node*, align 8
  %feas_tol.addr = alloca i64, align 8
...
entry:
  ...
  %jplus.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1295380044, i32* %canary
  %new_flow.addr = alloca i64, align 8
  %delta.addr = alloca i64, align 8
  %cycle_ori.addr = alloca i64, align 8
  store i64 %cycle_ori, i64* %cycle_ori.addr, align 8
...
if.end128:                                        ; preds = %for.end127, %for.end108
  %152 = load i32, i32* %canary
  %153 = icmp eq i32 %152, 1295380044
  br i1 %153, label %154, label %func_exit
