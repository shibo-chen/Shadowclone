; ModuleID = 'implicit.c.rand.4R1.bc'
...
func_resize_prob.10:                              ; preds = %ctrl1
  %5 = call i64 @resize_prob.10(%struct.network* %net)
  ret i64 %5
...
ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_resize_prob.9, label %func_resize_prob.10
}
...
func_insert_new_arc.3:                            ; preds = %ctrl0
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_insert_new_arc.3, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_insert_new_arc.7, label %func_insert_new_arc.8
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_replace_weaker_arc.5, label %ctrl0

func_replace_weaker_arc.5:                        ; preds = %rand_bb
...
func_replace_weaker_arc.17:                       ; preds = %ctrl1
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_replace_weaker_arc.17, label %func_replace_weaker_arc.18
}
...
func_price_out_impl.14:                           ; preds = %ctrl0
  %3 = call i64 @price_out_impl.14(%struct.network* %net)
  ret i64 %3

func_price_out_impl.19:                           ; preds = %ctrl1
  %4 = call i64 @price_out_impl.19(%struct.network* %net)
  ret i64 %4

func_price_out_impl.20:                           ; preds = %ctrl1
  %5 = call i64 @price_out_impl.20(%struct.network* %net)
  ret i64 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_price_out_impl.14, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_price_out_impl.19, label %func_price_out_impl.20
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_suspend_impl.11, label %ctrl0

func_suspend_impl.11:                             ; preds = %rand_bb
  %2 = call i64 @suspend_impl.11(%struct.network* %net, i64 %threshold, i64 %all)
  ret i64 %2
...
func_suspend_impl.13:                             ; preds = %ctrl1
  %4 = call i64 @suspend_impl.13(%struct.network* %net, i64 %threshold, i64 %all)
  ret i64 %4

func_suspend_impl.16:                             ; preds = %ctrl1
  %5 = call i64 @suspend_impl.16(%struct.network* %net, i64 %threshold, i64 %all)
  ret i64 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_suspend_impl.12, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_suspend_impl.13, label %func_suspend_impl.16
}
...
entry:
  ...
  %canary = alloca i32
  store i32 713109412, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 995242015, i32* %canary
...
entry:
  ...
  %new.addr = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 282544821, i32* %canary
  %tail.addr = alloca %struct.node*, align 8
  %head.addr = alloca %struct.node*, align 8
  %pos = alloca i64, align 8
  %red_cost.addr = alloca i64, align 8
...
entry:
  %canary = alloca i32
  store i32 1750626049, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 504737266, i32* %canary
  %red_cost.addr = alloca i64, align 8
  %cost.addr = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store %struct.arc* %new, %struct.arc** %new.addr, align 8
...
entry:
  ...
  %cost.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 903243715, i32* %canary
  %head.addr = alloca %struct.node*, align 8
  %new.addr = alloca %struct.arc*, align 8
  %tail.addr = alloca %struct.node*, align 8
  %newpos.addr = alloca i64, align 8
...
entry:
  ...
  %pos = alloca i64, align 8
  %canary = alloca i32
  store i32 373755340, i32* %canary
  %head.addr = alloca %struct.node*, align 8
  store %struct.arc* %new, %struct.arc** %new.addr, align 8
  store i64 %newpos, i64* %newpos.addr, align 8
  store %struct.node* %tail, %struct.node** %tail.addr, align 8
...
entry:
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 141773146, i32* %canary
  %node = alloca %struct.node*, align 8
  %stop = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
  %root = alloca %struct.node*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @resize_prob.10(%struct.network* %net) #0 {
entry:
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 997896294, i32* %canary
  %retval = alloca i64, align 8
  %node = alloca %struct.node*, align 8
  %root = alloca %struct.node*, align 8
  %arc = alloca %struct.arc*, align 8
...
entry:
  %canary = alloca i32
  store i32 459139209, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %arc = alloca %struct.arc*, align 8
...
entry:
  ...
  %new_arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 298942747, i32* %canary
  %red_cost = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 %threshold, i64* %threshold.addr, align 8
  store i64 %all, i64* %all.addr, align 8
...
entry:
  ...
  %threshold.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1341396528, i32* %canary
  %all.addr = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
  %red_cost = alloca i64, align 8
...
entry:
  ...
  %red_cost = alloca i64, align 8
  %canary = alloca i32
  store i32 1077859430, i32* %canary
  %head = alloca %struct.node*, align 8
  %arcnew = alloca %struct.arc*, align 8
  %retval = alloca i64, align 8
  %new_arcs = alloca i64, align 8
...
return:                                           ; preds = %if.end109, %if.then10
  %143 = load i64, i64* %retval, align 8
  %144 = load i32, i32* %canary
  %145 = icmp eq i32 %144, 1077859430
  br i1 %145, label %146, label %func_exit
...
entry:
  %stop = alloca i8*, align 8
  %canary = alloca i32
  store i32 227507893, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
  %threshold.addr = alloca i64, align 8
  %new_arc = alloca %struct.arc*, align 8
...
entry:
  ...
  %cmp = alloca i64, align 8
  %canary = alloca i32
  store i32 1939292704, i32* %canary
  %new.addr = alloca %struct.arc*, align 8
  %tail.addr = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store %struct.arc* %new, %struct.arc** %new.addr, align 8
...
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 300230812, i32* %canary
  %tail.addr = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store %struct.arc* %new, %struct.arc** %new.addr, align 8
  store %struct.node* %tail, %struct.node** %tail.addr, align 8
...
entry:
  ...
  %latest = alloca i64, align 8
  %canary = alloca i32
  store i32 974125102, i32* %canary
  %tail = alloca %struct.node*, align 8
  %head = alloca %struct.node*, align 8
  %trips = alloca i64, align 8
  %new_arcs = alloca i64, align 8
...
entry:
  ...
  %latest = alloca i64, align 8
  %canary = alloca i32
  store i32 108013948, i32* %canary
  %new_arcs = alloca i64, align 8
  %bigM_minus_min_impl_duration = alloca i64, align 8
  %i = alloca i64, align 8
  %tail = alloca %struct.node*, align 8
