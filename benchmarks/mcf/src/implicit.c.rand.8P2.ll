; ModuleID = 'implicit.c.rand.8P2.bc'
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_resize_prob.4, label %ctrl0

func_resize_prob.4:                               ; preds = %rand_bb
  %2 = call i64 @resize_prob.4(%struct.network* %net)
  ret i64 %2
...
func_resize_prob.21:                              ; preds = %ctrl1
  %4 = call i64 @resize_prob.21(%struct.network* %net)
  ret i64 %4

func_resize_prob.22:                              ; preds = %ctrl2
  %5 = call i64 @resize_prob.22(%struct.network* %net)
  ret i64 %5

func_resize_prob.27:                              ; preds = %ctrl3
  %6 = call i64 @resize_prob.27(%struct.network* %net)
  ret i64 %6

func_resize_prob.35:                              ; preds = %ctrl4
  %7 = call i64 @resize_prob.35(%struct.network* %net)
  ret i64 %7

func_resize_prob.36:                              ; preds = %ctrl5
  %8 = call i64 @resize_prob.36(%struct.network* %net)
  ret i64 %8

func_resize_prob.39:                              ; preds = %ctrl5
  %9 = call i64 @resize_prob.39(%struct.network* %net)
  ret i64 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_resize_prob.6, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_resize_prob.21, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_resize_prob.22, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_resize_prob.27, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_resize_prob.35, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_resize_prob.36, label %func_resize_prob.39
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_insert_new_arc.7, label %ctrl0

func_insert_new_arc.7:                            ; preds = %rand_bb
  call void @insert_new_arc.7(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void

func_insert_new_arc.24:                           ; preds = %ctrl0
  call void @insert_new_arc.24(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void

func_insert_new_arc.28:                           ; preds = %ctrl1
  call void @insert_new_arc.28(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void

func_insert_new_arc.29:                           ; preds = %ctrl2
  call void @insert_new_arc.29(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void

func_insert_new_arc.30:                           ; preds = %ctrl3
  call void @insert_new_arc.30(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void

func_insert_new_arc.33:                           ; preds = %ctrl4
  call void @insert_new_arc.33(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void
...
func_insert_new_arc.40:                           ; preds = %ctrl5
  call void @insert_new_arc.40(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_insert_new_arc.24, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_insert_new_arc.28, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_insert_new_arc.29, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_insert_new_arc.30, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_insert_new_arc.33, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_insert_new_arc.38, label %func_insert_new_arc.40
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_replace_weaker_arc.1, label %ctrl0

func_replace_weaker_arc.1:                        ; preds = %rand_bb
  call void @replace_weaker_arc.1(%struct.network* %net, %struct.arc* %new, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void

func_replace_weaker_arc.8:                        ; preds = %ctrl0
  call void @replace_weaker_arc.8(%struct.network* %net, %struct.arc* %new, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void

func_replace_weaker_arc.13:                       ; preds = %ctrl1
  call void @replace_weaker_arc.13(%struct.network* %net, %struct.arc* %new, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void

func_replace_weaker_arc.16:                       ; preds = %ctrl2
...
func_replace_weaker_arc.18:                       ; preds = %ctrl3
  call void @replace_weaker_arc.18(%struct.network* %net, %struct.arc* %new, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void

func_replace_weaker_arc.19:                       ; preds = %ctrl4
  call void @replace_weaker_arc.19(%struct.network* %net, %struct.arc* %new, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void

func_replace_weaker_arc.25:                       ; preds = %ctrl5
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_replace_weaker_arc.8, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_replace_weaker_arc.13, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_replace_weaker_arc.16, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_replace_weaker_arc.18, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_replace_weaker_arc.19, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_replace_weaker_arc.25, label %func_replace_weaker_arc.37
}
...
func_price_out_impl.10:                           ; preds = %ctrl0
  %3 = call i64 @price_out_impl.10(%struct.network* %net)
  ret i64 %3

func_price_out_impl.12:                           ; preds = %ctrl1
  %4 = call i64 @price_out_impl.12(%struct.network* %net)
  ret i64 %4

func_price_out_impl.14:                           ; preds = %ctrl2
  %5 = call i64 @price_out_impl.14(%struct.network* %net)
  ret i64 %5

func_price_out_impl.20:                           ; preds = %ctrl3
  %6 = call i64 @price_out_impl.20(%struct.network* %net)
  ret i64 %6

func_price_out_impl.23:                           ; preds = %ctrl4
  %7 = call i64 @price_out_impl.23(%struct.network* %net)
  ret i64 %7

func_price_out_impl.31:                           ; preds = %ctrl5
  %8 = call i64 @price_out_impl.31(%struct.network* %net)
  ret i64 %8

func_price_out_impl.32:                           ; preds = %ctrl5
  %9 = call i64 @price_out_impl.32(%struct.network* %net)
  ret i64 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_price_out_impl.10, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_price_out_impl.12, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_price_out_impl.14, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_price_out_impl.20, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_price_out_impl.23, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_price_out_impl.31, label %func_price_out_impl.32
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_suspend_impl.3, label %ctrl0

func_suspend_impl.3:                              ; preds = %rand_bb
  %2 = call i64 @suspend_impl.3(%struct.network* %net, i64 %threshold, i64 %all)
  ret i64 %2

func_suspend_impl.5:                              ; preds = %ctrl0
  %3 = call i64 @suspend_impl.5(%struct.network* %net, i64 %threshold, i64 %all)
  ret i64 %3

func_suspend_impl.9:                              ; preds = %ctrl1
  %4 = call i64 @suspend_impl.9(%struct.network* %net, i64 %threshold, i64 %all)
  ret i64 %4

func_suspend_impl.11:                             ; preds = %ctrl2
  %5 = call i64 @suspend_impl.11(%struct.network* %net, i64 %threshold, i64 %all)
  ret i64 %5

func_suspend_impl.15:                             ; preds = %ctrl3
  %6 = call i64 @suspend_impl.15(%struct.network* %net, i64 %threshold, i64 %all)
  ret i64 %6

func_suspend_impl.17:                             ; preds = %ctrl4
  %7 = call i64 @suspend_impl.17(%struct.network* %net, i64 %threshold, i64 %all)
  ret i64 %7

func_suspend_impl.26:                             ; preds = %ctrl5
  %8 = call i64 @suspend_impl.26(%struct.network* %net, i64 %threshold, i64 %all)
  ret i64 %8

func_suspend_impl.34:                             ; preds = %ctrl5
  %9 = call i64 @suspend_impl.34(%struct.network* %net, i64 %threshold, i64 %all)
  ret i64 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_suspend_impl.5, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_suspend_impl.9, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_suspend_impl.11, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_suspend_impl.15, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_suspend_impl.17, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_suspend_impl.26, label %func_suspend_impl.34
}
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @replace_weaker_arc.1(%struct.network* %net, %struct.arc* %new, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost) #0 {
entry:
  %cmp = alloca i64, align 8
  %cost.addr = alloca i64, align 8
  %red_cost.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 165984770, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 353714930, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 980447261, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @resize_prob.4(%struct.network* %net) #0 {
entry:
  %stop = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1005531532, i32* %canary
...
entry:
  ...
  %all.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1657688289, i32* %canary
  %red_cost = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 %threshold, i64* %threshold.addr, align 8
  store i64 %all, i64* %all.addr, align 8
...
entry:
  ...
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1478569404, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
  %root = alloca %struct.node*, align 8
  %off = alloca i64, align 8
...
entry:
  ...
  %cost.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 805364255, i32* %canary
  %red_cost.addr = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @replace_weaker_arc.8(%struct.network* %net, %struct.arc* %new, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost) #0 {
entry:
  %canary = alloca i32
  store i32 25013888, i32* %canary
  %cmp = alloca i64, align 8
  %pos = alloca i64, align 8
  %red_cost.addr = alloca i64, align 8
  %new.addr = alloca %struct.arc*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @suspend_impl.9(%struct.network* %net, i64 %threshold, i64 %all) #0 {
entry:
  %threshold.addr = alloca i64, align 8
  %red_cost = alloca i64, align 8
  %susp = alloca i64, align 8
  ...
  %stop = alloca i8*, align 8
  %canary = alloca i32
  store i32 1092048193, i32* %canary
  %new_arc = alloca %struct.arc*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 %threshold, i64* %threshold.addr, align 8
  store i64 %all, i64* %all.addr, align 8
...
entry:
  ...
  %head = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 496229599, i32* %canary
  %stop = alloca %struct.arc*, align 8
  %new_arcs = alloca i64, align 8
  %arcin = alloca %struct.arc*, align 8
  %i = alloca i64, align 8
...
entry:
  ...
  %threshold.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 808796942, i32* %canary
  %new_arc = alloca %struct.arc*, align 8
  %red_cost = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 %threshold, i64* %threshold.addr, align 8
...
entry:
  ...
  %bigM_minus_min_impl_duration = alloca i64, align 8
  %canary = alloca i32
  store i32 1490863992, i32* %canary
  %bigM = alloca i64, align 8
  %arcout = alloca %struct.arc*, align 8
  %arcin = alloca %struct.arc*, align 8
  %head = alloca %struct.node*, align 8
...
return:                                           ; preds = %if.end109, %if.then10
  %143 = load i64, i64* %retval, align 8
  %144 = load i32, i32* %canary
  %145 = icmp eq i32 %144, 1490863992
  br i1 %145, label %146, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @replace_weaker_arc.13(%struct.network* %net, %struct.arc* %new, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost) #0 {
entry:
  %head.addr = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
  %tail.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1605886306, i32* %canary
  %cost.addr = alloca i64, align 8
  %new.addr = alloca %struct.arc*, align 8
  %red_cost.addr = alloca i64, align 8
  %cmp = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @price_out_impl.14(%struct.network* %net) #0 {
entry:
  %canary = alloca i32
  store i32 1865840458, i32* %canary
  %first_of_sparse_list = alloca %struct.arc*, align 8
  %red_cost = alloca i64, align 8
  %arc_cost = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
...
return:                                           ; preds = %if.end109, %if.then10
  %143 = load i64, i64* %retval, align 8
  %144 = load i32, i32* %canary
  %145 = icmp eq i32 %144, 1865840458
  br i1 %145, label %146, label %func_exit
...
entry:
  ...
  %susp = alloca i64, align 8
  %canary = alloca i32
  store i32 2047605355, i32* %canary
  %all.addr = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 %threshold, i64* %threshold.addr, align 8
  store i64 %all, i64* %all.addr, align 8
...
entry:
  ...
  %head.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1887087871, i32* %canary
  %new.addr = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store %struct.arc* %new, %struct.arc** %new.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @suspend_impl.17(%struct.network* %net, i64 %threshold, i64 %all) #0 {
entry:
  %threshold.addr = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
  %new_arc = alloca %struct.arc*, align 8
  %susp = alloca i64, align 8
  %canary = alloca i32
  store i32 901529035, i32* %canary
  %stop = alloca i8*, align 8
  %all.addr = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
  %red_cost = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @replace_weaker_arc.18(%struct.network* %net, %struct.arc* %new, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost) #0 {
entry:
  %pos = alloca i64, align 8
  %new.addr = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
  ...
  %red_cost.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 986651064, i32* %canary
  %cmp = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store %struct.arc* %new, %struct.arc** %new.addr, align 8
  store %struct.node* %tail, %struct.node** %tail.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @replace_weaker_arc.19(%struct.network* %net, %struct.arc* %new, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost) #0 {
entry:
  %pos = alloca i64, align 8
  %tail.addr = alloca %struct.node*, align 8
  %cost.addr = alloca i64, align 8
  ...
  %cmp = alloca i64, align 8
  %canary = alloca i32
  store i32 2035111388, i32* %canary
  %head.addr = alloca %struct.node*, align 8
  %new.addr = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  ...
  %arcin = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 529757955, i32* %canary
  %resized = alloca i64, align 8
  %i = alloca i64, align 8
  %min_impl_duration = alloca i64, align 8
  %first_of_sparse_list = alloca %struct.arc*, align 8
...
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 1697767565, i32* %canary
  %stop = alloca %struct.node*, align 8
  %node = alloca %struct.node*, align 8
  %off = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @resize_prob.22(%struct.network* %net) #0 {
entry:
  %root = alloca %struct.node*, align 8
  %arc = alloca %struct.arc*, align 8
  %off = alloca i64, align 8
  ...
  %retval = alloca i64, align 8
  %canary = alloca i32
  store i32 1447146392, i32* %canary
  %stop = alloca %struct.node*, align 8
  %node = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @price_out_impl.23(%struct.network* %net) #0 {
entry:
  %arc_cost = alloca i64, align 8
  %resized = alloca i64, align 8
  %arcout = alloca %struct.arc*, align 8
  ...
  %arcnew = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1495401278, i32* %canary
  %arcin = alloca %struct.arc*, align 8
  %first_of_sparse_list = alloca %struct.arc*, align 8
  %min_impl_duration = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
...
return:                                           ; preds = %if.end109, %if.then10
  %143 = load i64, i64* %retval, align 8
  %144 = load i32, i32* %canary
  %145 = icmp eq i32 %144, 1495401278
  br i1 %145, label %146, label %func_exit
...
entry:
  %canary = alloca i32
  store i32 1966600762, i32* %canary
  %cost.addr = alloca i64, align 8
  %tail.addr = alloca %struct.node*, align 8
  %pos = alloca i64, align 8
  %new.addr = alloca %struct.arc*, align 8
...
entry:
  %cmp = alloca i64, align 8
  %canary = alloca i32
  store i32 1858317342, i32* %canary
  %cost.addr = alloca i64, align 8
  %head.addr = alloca %struct.node*, align 8
  %new.addr = alloca %struct.arc*, align 8
  %tail.addr = alloca %struct.node*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @suspend_impl.26(%struct.network* %net, i64 %threshold, i64 %all) #0 {
entry:
  %threshold.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 2060243729, i32* %canary
  %red_cost = alloca i64, align 8
  %stop = alloca i8*, align 8
  %arc = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
...
entry:
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1988019243, i32* %canary
  %root = alloca %struct.node*, align 8
  %stop = alloca %struct.node*, align 8
  %off = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
...
entry:
  %newpos.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1012247323, i32* %canary
  %new.addr = alloca %struct.arc*, align 8
  %red_cost.addr = alloca i64, align 8
  %cost.addr = alloca i64, align 8
  %pos = alloca i64, align 8
...
entry:
  ...
  %cost.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1827126693, i32* %canary
  %red_cost.addr = alloca i64, align 8
  %new.addr = alloca %struct.arc*, align 8
  store %struct.arc* %new, %struct.arc** %new.addr, align 8
  store i64 %newpos, i64* %newpos.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @insert_new_arc.30(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost) #0 {
entry:
  %pos = alloca i64, align 8
  %head.addr = alloca %struct.node*, align 8
  %tail.addr = alloca %struct.node*, align 8
  ...
  %newpos.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 547739701, i32* %canary
  %new.addr = alloca %struct.arc*, align 8
  store %struct.arc* %new, %struct.arc** %new.addr, align 8
  store i64 %newpos, i64* %newpos.addr, align 8
  store %struct.node* %tail, %struct.node** %tail.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @price_out_impl.31(%struct.network* %net) #0 {
entry:
  %bigM_minus_min_impl_duration = alloca i64, align 8
  %canary = alloca i32
  store i32 689906105, i32* %canary
  %new_arcs = alloca i64, align 8
  %red_cost = alloca i64, align 8
  %i = alloca i64, align 8
  %tail = alloca %struct.node*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @price_out_impl.32(%struct.network* %net) #0 {
entry:
  %min_impl_duration = alloca i64, align 8
  %red_cost = alloca i64, align 8
  %bigM_minus_min_impl_duration = alloca i64, align 8
  ...
  %trips = alloca i64, align 8
  %canary = alloca i32
  store i32 1588475144, i32* %canary
  %arcnew = alloca %struct.arc*, align 8
  %head = alloca %struct.node*, align 8
  %arcin = alloca %struct.arc*, align 8
  %bigM = alloca i64, align 8
...
return:                                           ; preds = %if.end109, %if.then10
  %143 = load i64, i64* %retval, align 8
  %144 = load i32, i32* %canary
  %145 = icmp eq i32 %144, 1588475144
  br i1 %145, label %146, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @insert_new_arc.33(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost) #0 {
entry:
  %cost.addr = alloca i64, align 8
  %newpos.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1230859011, i32* %canary
  %pos = alloca i64, align 8
  %new.addr = alloca %struct.arc*, align 8
  %red_cost.addr = alloca i64, align 8
  %tail.addr = alloca %struct.node*, align 8
...
entry:
  ...
  %threshold.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1938400868, i32* %canary
  %new_arc = alloca %struct.arc*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 %threshold, i64* %threshold.addr, align 8
  store i64 %all, i64* %all.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @resize_prob.35(%struct.network* %net) #0 {
entry:
  %net.addr = alloca %struct.network*, align 8
  %node = alloca %struct.node*, align 8
  %arc = alloca %struct.arc*, align 8
  %stop = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 387315149, i32* %canary
  %off = alloca i64, align 8
  %root = alloca %struct.node*, align 8
  %retval = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @resize_prob.36(%struct.network* %net) #0 {
entry:
  %arc = alloca %struct.arc*, align 8
  %root = alloca %struct.node*, align 8
  %retval = alloca i64, align 8
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 500586037, i32* %canary
  %node = alloca %struct.node*, align 8
  %stop = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
...
entry:
  ...
  %cost.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 575186499, i32* %canary
  %cmp = alloca i64, align 8
  %head.addr = alloca %struct.node*, align 8
  %new.addr = alloca %struct.arc*, align 8
  %pos = alloca i64, align 8
...
entry:
  ...
  %head.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 364697004, i32* %canary
  %tail.addr = alloca %struct.node*, align 8
  store %struct.arc* %new, %struct.arc** %new.addr, align 8
  store i64 %newpos, i64* %newpos.addr, align 8
  store %struct.node* %tail, %struct.node** %tail.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1536034865, i32* %canary
  %node = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
  %retval = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @insert_new_arc.40(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost) #0 {
entry:
  %newpos.addr = alloca i64, align 8
  %tail.addr = alloca %struct.node*, align 8
  %cost.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1046867677, i32* %canary
  %new.addr = alloca %struct.arc*, align 8
  %pos = alloca i64, align 8
  %red_cost.addr = alloca i64, align 8
  %head.addr = alloca %struct.node*, align 8
