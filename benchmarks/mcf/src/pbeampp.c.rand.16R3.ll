; ModuleID = 'pbeampp.c.rand.16R3.bc'
...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_bea_is_dual_infeasible.3, label %func_bea_is_dual_infeasible.8

func_bea_is_dual_infeasible.3:                    ; preds = %rand_bb
  %2 = call i32 @bea_is_dual_infeasible.3(%struct.arc* %arc, i64 %red_cost)
  ret i32 %2

func_bea_is_dual_infeasible.8:                    ; preds = %rand_bb
  %3 = call i32 @bea_is_dual_infeasible.8(%struct.arc* %arc, i64 %red_cost)
  ret i32 %3
}
...
func_sort_basket.6:                               ; preds = %ctrl1
...
func_sort_basket.29:                              ; preds = %ctrl11
  call void @sort_basket.29(i64 %min, i64 %max)
  ret void

func_sort_basket.31:                              ; preds = %ctrl12
  call void @sort_basket.31(i64 %min, i64 %max)
  ret void

func_sort_basket.32:                              ; preds = %ctrl13
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_sort_basket.6, label %ctrl2
...
ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_sort_basket.13, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_sort_basket.14, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_sort_basket.15, label %ctrl6

ctrl6:                                            ; preds = %ctrl5
  %8 = icmp eq i32 %0, 7
  br i1 %8, label %func_sort_basket.18, label %ctrl7

ctrl7:                                            ; preds = %ctrl6
  %9 = icmp eq i32 %0, 8
  br i1 %9, label %func_sort_basket.19, label %ctrl8

ctrl8:                                            ; preds = %ctrl7
  %10 = icmp eq i32 %0, 9
  br i1 %10, label %func_sort_basket.22, label %ctrl9

ctrl9:                                            ; preds = %ctrl8
  %11 = icmp eq i32 %0, 10
  br i1 %11, label %func_sort_basket.24, label %ctrl10
...
ctrl11:                                           ; preds = %ctrl10
  %13 = icmp eq i32 %0, 12
  br i1 %13, label %func_sort_basket.29, label %ctrl12

ctrl12:                                           ; preds = %ctrl11
  %14 = icmp eq i32 %0, 13
  br i1 %14, label %func_sort_basket.31, label %ctrl13

ctrl13:                                           ; preds = %ctrl12
  %15 = icmp eq i32 %0, 14
  br i1 %15, label %func_sort_basket.32, label %func_sort_basket.33
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_primal_bea_mpp.4, label %ctrl0

func_primal_bea_mpp.4:                            ; preds = %rand_bb
  %2 = call %struct.arc* @primal_bea_mpp.4(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea)
  ret %struct.arc* %2
...
func_primal_bea_mpp.10:                           ; preds = %ctrl2
  %5 = call %struct.arc* @primal_bea_mpp.10(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea)
  ret %struct.arc* %5

func_primal_bea_mpp.11:                           ; preds = %ctrl3
  %6 = call %struct.arc* @primal_bea_mpp.11(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea)
  ret %struct.arc* %6

func_primal_bea_mpp.12:                           ; preds = %ctrl4
  %7 = call %struct.arc* @primal_bea_mpp.12(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea)
  ret %struct.arc* %7

func_primal_bea_mpp.16:                           ; preds = %ctrl5
  %8 = call %struct.arc* @primal_bea_mpp.16(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea)
  ret %struct.arc* %8

func_primal_bea_mpp.17:                           ; preds = %ctrl6
  %9 = call %struct.arc* @primal_bea_mpp.17(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea)
  ret %struct.arc* %9

func_primal_bea_mpp.20:                           ; preds = %ctrl7
  %10 = call %struct.arc* @primal_bea_mpp.20(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea)
  ret %struct.arc* %10

func_primal_bea_mpp.21:                           ; preds = %ctrl8
  %11 = call %struct.arc* @primal_bea_mpp.21(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea)
  ret %struct.arc* %11

func_primal_bea_mpp.23:                           ; preds = %ctrl9
  %12 = call %struct.arc* @primal_bea_mpp.23(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea)
  ret %struct.arc* %12

func_primal_bea_mpp.25:                           ; preds = %ctrl10
  %13 = call %struct.arc* @primal_bea_mpp.25(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea)
  ret %struct.arc* %13
...
func_primal_bea_mpp.30:                           ; preds = %ctrl13
  %16 = call %struct.arc* @primal_bea_mpp.30(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea)
  ret %struct.arc* %16
...
ctrl1:                                            ; preds = %ctrl0
  %19 = icmp eq i32 %0, 2
  br i1 %19, label %func_primal_bea_mpp.9, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %20 = icmp eq i32 %0, 3
  br i1 %20, label %func_primal_bea_mpp.10, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %21 = icmp eq i32 %0, 4
  br i1 %21, label %func_primal_bea_mpp.11, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %22 = icmp eq i32 %0, 5
  br i1 %22, label %func_primal_bea_mpp.12, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %23 = icmp eq i32 %0, 6
  br i1 %23, label %func_primal_bea_mpp.16, label %ctrl6

ctrl6:                                            ; preds = %ctrl5
  %24 = icmp eq i32 %0, 7
  br i1 %24, label %func_primal_bea_mpp.17, label %ctrl7

ctrl7:                                            ; preds = %ctrl6
  %25 = icmp eq i32 %0, 8
  br i1 %25, label %func_primal_bea_mpp.20, label %ctrl8

ctrl8:                                            ; preds = %ctrl7
  %26 = icmp eq i32 %0, 9
  br i1 %26, label %func_primal_bea_mpp.21, label %ctrl9

ctrl9:                                            ; preds = %ctrl8
  %27 = icmp eq i32 %0, 10
  br i1 %27, label %func_primal_bea_mpp.23, label %ctrl10

ctrl10:                                           ; preds = %ctrl9
  %28 = icmp eq i32 %0, 11
  br i1 %28, label %func_primal_bea_mpp.25, label %ctrl11
...
ctrl13:                                           ; preds = %ctrl12
  %31 = icmp eq i32 %0, 14
  br i1 %31, label %func_primal_bea_mpp.30, label %func_primal_bea_mpp.34
}
...
entry:
  ...
  %canary = alloca i32
  store i32 905350958, i32* %canary
...
entry:
  ...
  %l = alloca i64, align 8
  %canary = alloca i32
  store i32 628544124, i32* %canary
  %max.addr = alloca i64, align 8
  %min.addr = alloca i64, align 8
  %r = alloca i64, align 8
  store i64 %min, i64* %min.addr, align 8
...
entry:
  ...
  %canary = alloca i32
  store i32 1395241358, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1033505599, i32* %canary
...
entry:
  ...
  %stop_arcs.addr = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1288150358, i32* %canary
  %i = alloca i64, align 8
  store i64 %m, i64* %m.addr, align 8
  store %struct.arc* %arcs, %struct.arc** %arcs.addr, align 8
  store %struct.arc* %stop_arcs, %struct.arc** %stop_arcs.addr, align 8
...
entry:
  ...
  %xchange = alloca %struct.basket*, align 8
  %canary = alloca i32
  store i32 1031656000, i32* %canary
  %r = alloca i64, align 8
  %l = alloca i64, align 8
  %min.addr = alloca i64, align 8
  store i64 %min, i64* %min.addr, align 8
...
entry:
  ...
  %r = alloca i64, align 8
  %canary = alloca i32
  store i32 344305284, i32* %canary
  %min.addr = alloca i64, align 8
  store i64 %min, i64* %min.addr, align 8
  store i64 %max, i64* %max.addr, align 8
  %0 = load i64, i64* %min.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @bea_is_dual_infeasible.8(%struct.arc* %arc, i64 %red_cost) #0 {
entry:
  %arc.addr = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 2046922569, i32* %canary
  %red_cost.addr = alloca i64, align 8
  store %struct.arc* %arc, %struct.arc** %arc.addr, align 8
  store i64 %red_cost, i64* %red_cost.addr, align 8
  %0 = load i64, i64* %red_cost.addr, align 8
...
entry:
  ...
  %retval = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1719606348, i32* %canary
  %next = alloca i64, align 8
  %old_group_pos = alloca i64, align 8
  %i = alloca i64, align 8
  %m.addr = alloca i64, align 8
...
entry:
  ...
  %red_cost = alloca i64, align 8
  %canary = alloca i32
  store i32 701965031, i32* %canary
  %next = alloca i64, align 8
  %i = alloca i64, align 8
  %m.addr = alloca i64, align 8
  store i64 %m, i64* %m.addr, align 8
...
entry:
  ...
  %m.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 248980108, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %red_cost = alloca i64, align 8
  store i64 %m, i64* %m.addr, align 8
  store %struct.arc* %arcs, %struct.arc** %arcs.addr, align 8
...
entry:
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1878276336, i32* %canary
  %m.addr = alloca i64, align 8
  %arcs.addr = alloca %struct.arc*, align 8
  %red_cost_of_bea.addr = alloca i64*, align 8
  %i = alloca i64, align 8
...
entry:
  ...
  %xchange = alloca %struct.basket*, align 8
  %canary = alloca i32
  store i32 143839508, i32* %canary
  %max.addr = alloca i64, align 8
  store i64 %min, i64* %min.addr, align 8
  store i64 %max, i64* %max.addr, align 8
  %0 = load i64, i64* %min.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 701055254, i32* %canary
  %cut = alloca i64, align 8
  %r = alloca i64, align 8
  %min.addr = alloca i64, align 8
  %xchange = alloca %struct.basket*, align 8
...
entry:
  ...
  %min.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1452830565, i32* %canary
  %max.addr = alloca i64, align 8
  %l = alloca i64, align 8
  %r = alloca i64, align 8
  store i64 %min, i64* %min.addr, align 8
...
entry:
  ...
  %stop_arcs.addr = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1248876628, i32* %canary
  %red_cost_of_bea.addr = alloca i64*, align 8
  %retval = alloca %struct.arc*, align 8
  store i64 %m, i64* %m.addr, align 8
  store %struct.arc* %arcs, %struct.arc** %arcs.addr, align 8
...
entry:
  ...
  %stop_arcs.addr = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1226538642, i32* %canary
  %arcs.addr = alloca %struct.arc*, align 8
  %arc = alloca %struct.arc*, align 8
  %m.addr = alloca i64, align 8
  store i64 %m, i64* %m.addr, align 8
...
entry:
  ...
  %min.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1445247222, i32* %canary
  %xchange = alloca %struct.basket*, align 8
  %r = alloca i64, align 8
  %l = alloca i64, align 8
  store i64 %min, i64* %min.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 583396438, i32* %canary
  %l = alloca i64, align 8
  %max.addr = alloca i64, align 8
  %xchange = alloca %struct.basket*, align 8
  %min.addr = alloca i64, align 8
...
entry:
  %old_group_pos = alloca i64, align 8
  %canary = alloca i32
  store i32 529723928, i32* %canary
  %retval = alloca %struct.arc*, align 8
  %red_cost_of_bea.addr = alloca i64*, align 8
  %arc = alloca %struct.arc*, align 8
  %next = alloca i64, align 8
...
entry:
  %canary = alloca i32
  store i32 720647324, i32* %canary
  %m.addr = alloca i64, align 8
  %stop_arcs.addr = alloca %struct.arc*, align 8
  %arc = alloca %struct.arc*, align 8
  %next = alloca i64, align 8
...
entry:
  ...
  %r = alloca i64, align 8
  %canary = alloca i32
  store i32 751555186, i32* %canary
  %max.addr = alloca i64, align 8
  %cut = alloca i64, align 8
  store i64 %min, i64* %min.addr, align 8
  store i64 %max, i64* %max.addr, align 8
...
entry:
  ...
  %m.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1052507683, i32* %canary
  %red_cost = alloca i64, align 8
  %stop_arcs.addr = alloca %struct.arc*, align 8
  %old_group_pos = alloca i64, align 8
  %i = alloca i64, align 8
...
entry:
  ...
  %max.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1697128691, i32* %canary
  %l = alloca i64, align 8
  %min.addr = alloca i64, align 8
  store i64 %min, i64* %min.addr, align 8
  store i64 %max, i64* %max.addr, align 8
...
entry:
  ...
  %old_group_pos = alloca i64, align 8
  %canary = alloca i32
  store i32 1163916268, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %retval = alloca %struct.arc*, align 8
  %stop_arcs.addr = alloca %struct.arc*, align 8
  %i = alloca i64, align 8
...
entry:
  ...
  %next = alloca i64, align 8
  %canary = alloca i32
  store i32 857549848, i32* %canary
  %arcs.addr = alloca %struct.arc*, align 8
  %arc = alloca %struct.arc*, align 8
  %retval = alloca %struct.arc*, align 8
  %stop_arcs.addr = alloca %struct.arc*, align 8
...
entry:
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1611555048, i32* %canary
  %retval = alloca %struct.arc*, align 8
  %arcs.addr = alloca %struct.arc*, align 8
  %old_group_pos = alloca i64, align 8
  %next = alloca i64, align 8
...
entry:
  ...
  %r = alloca i64, align 8
  %canary = alloca i32
  store i32 1766248276, i32* %canary
  %max.addr = alloca i64, align 8
  %min.addr = alloca i64, align 8
  store i64 %min, i64* %min.addr, align 8
  store i64 %max, i64* %max.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @sort_basket.29(i64 %min, i64 %max) #0 {
entry:
  %xchange = alloca %struct.basket*, align 8
  %r = alloca i64, align 8
  %min.addr = alloca i64, align 8
  %max.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1397665822, i32* %canary
  %cut = alloca i64, align 8
  %l = alloca i64, align 8
  store i64 %min, i64* %min.addr, align 8
  store i64 %max, i64* %max.addr, align 8
...
entry:
  ...
  %red_cost = alloca i64, align 8
  %canary = alloca i32
  store i32 1745217556, i32* %canary
  %arc = alloca %struct.arc*, align 8
  store i64 %m, i64* %m.addr, align 8
  store %struct.arc* %arcs, %struct.arc** %arcs.addr, align 8
  store %struct.arc* %stop_arcs, %struct.arc** %stop_arcs.addr, align 8
...
entry:
  %max.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 230460379, i32* %canary
  %l = alloca i64, align 8
  %min.addr = alloca i64, align 8
  %xchange = alloca %struct.basket*, align 8
  %r = alloca i64, align 8
...
entry:
  ...
  %r = alloca i64, align 8
  %canary = alloca i32
  store i32 1487513106, i32* %canary
  %l = alloca i64, align 8
  store i64 %min, i64* %min.addr, align 8
  store i64 %max, i64* %max.addr, align 8
  %0 = load i64, i64* %min.addr, align 8
...
entry:
  ...
  %l = alloca i64, align 8
  %canary = alloca i32
  store i32 366978011, i32* %canary
  %r = alloca i64, align 8
  %max.addr = alloca i64, align 8
  store i64 %min, i64* %min.addr, align 8
  store i64 %max, i64* %max.addr, align 8
