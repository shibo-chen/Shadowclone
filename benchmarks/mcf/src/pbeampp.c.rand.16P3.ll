; ModuleID = 'pbeampp.c.rand.16P3.bc'
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_sort_basket.4, label %ctrl0

func_sort_basket.4:                               ; preds = %rand_bb
...
func_sort_basket.14:                              ; preds = %ctrl1
  call void @sort_basket.14(i64 %min, i64 %max)
  ret void

func_sort_basket.15:                              ; preds = %ctrl2
  call void @sort_basket.15(i64 %min, i64 %max)
  ret void

func_sort_basket.16:                              ; preds = %ctrl3
  call void @sort_basket.16(i64 %min, i64 %max)
  ret void

func_sort_basket.18:                              ; preds = %ctrl4
  call void @sort_basket.18(i64 %min, i64 %max)
  ret void

func_sort_basket.19:                              ; preds = %ctrl5
  call void @sort_basket.19(i64 %min, i64 %max)
  ret void

func_sort_basket.20:                              ; preds = %ctrl6
  call void @sort_basket.20(i64 %min, i64 %max)
  ret void

func_sort_basket.22:                              ; preds = %ctrl7
  call void @sort_basket.22(i64 %min, i64 %max)
  ret void

func_sort_basket.24:                              ; preds = %ctrl8
  call void @sort_basket.24(i64 %min, i64 %max)
  ret void

func_sort_basket.25:                              ; preds = %ctrl9
...
func_sort_basket.30:                              ; preds = %ctrl11
  call void @sort_basket.30(i64 %min, i64 %max)
  ret void
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_sort_basket.14, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_sort_basket.15, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_sort_basket.16, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_sort_basket.18, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_sort_basket.19, label %ctrl6

ctrl6:                                            ; preds = %ctrl5
  %8 = icmp eq i32 %0, 7
  br i1 %8, label %func_sort_basket.20, label %ctrl7

ctrl7:                                            ; preds = %ctrl6
  %9 = icmp eq i32 %0, 8
  br i1 %9, label %func_sort_basket.22, label %ctrl8

ctrl8:                                            ; preds = %ctrl7
  %10 = icmp eq i32 %0, 9
  br i1 %10, label %func_sort_basket.24, label %ctrl9

ctrl9:                                            ; preds = %ctrl8
  %11 = icmp eq i32 %0, 10
  br i1 %11, label %func_sort_basket.25, label %ctrl10
...
ctrl11:                                           ; preds = %ctrl10
  %13 = icmp eq i32 %0, 12
  br i1 %13, label %func_sort_basket.30, label %ctrl12
...
func_primal_bea_mpp.5:                            ; preds = %ctrl0
  %3 = call %struct.arc* @primal_bea_mpp.5(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea)
  ret %struct.arc* %3
...
func_primal_bea_mpp.8:                            ; preds = %ctrl2
  %5 = call %struct.arc* @primal_bea_mpp.8(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea)
  ret %struct.arc* %5

func_primal_bea_mpp.9:                            ; preds = %ctrl3
  %6 = call %struct.arc* @primal_bea_mpp.9(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea)
  ret %struct.arc* %6

func_primal_bea_mpp.10:                           ; preds = %ctrl4
  %7 = call %struct.arc* @primal_bea_mpp.10(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea)
  ret %struct.arc* %7

func_primal_bea_mpp.11:                           ; preds = %ctrl5
  %8 = call %struct.arc* @primal_bea_mpp.11(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea)
  ret %struct.arc* %8

func_primal_bea_mpp.12:                           ; preds = %ctrl6
  %9 = call %struct.arc* @primal_bea_mpp.12(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea)
  ret %struct.arc* %9

func_primal_bea_mpp.13:                           ; preds = %ctrl7
  %10 = call %struct.arc* @primal_bea_mpp.13(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea)
  ret %struct.arc* %10

func_primal_bea_mpp.17:                           ; preds = %ctrl8
  %11 = call %struct.arc* @primal_bea_mpp.17(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea)
  ret %struct.arc* %11
...
func_primal_bea_mpp.23:                           ; preds = %ctrl10
  %13 = call %struct.arc* @primal_bea_mpp.23(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea)
  ret %struct.arc* %13

func_primal_bea_mpp.26:                           ; preds = %ctrl11
  %14 = call %struct.arc* @primal_bea_mpp.26(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea)
  ret %struct.arc* %14

func_primal_bea_mpp.27:                           ; preds = %ctrl12
  %15 = call %struct.arc* @primal_bea_mpp.27(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea)
  ret %struct.arc* %15
...
func_primal_bea_mpp.31:                           ; preds = %ctrl13
  %17 = call %struct.arc* @primal_bea_mpp.31(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea)
  ret %struct.arc* %17

ctrl0:                                            ; preds = %rand_bb
  %18 = icmp eq i32 %0, 1
  br i1 %18, label %func_primal_bea_mpp.5, label %ctrl1
...
ctrl2:                                            ; preds = %ctrl1
  %20 = icmp eq i32 %0, 3
  br i1 %20, label %func_primal_bea_mpp.8, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %21 = icmp eq i32 %0, 4
  br i1 %21, label %func_primal_bea_mpp.9, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %22 = icmp eq i32 %0, 5
  br i1 %22, label %func_primal_bea_mpp.10, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %23 = icmp eq i32 %0, 6
  br i1 %23, label %func_primal_bea_mpp.11, label %ctrl6

ctrl6:                                            ; preds = %ctrl5
  %24 = icmp eq i32 %0, 7
  br i1 %24, label %func_primal_bea_mpp.12, label %ctrl7

ctrl7:                                            ; preds = %ctrl6
  %25 = icmp eq i32 %0, 8
  br i1 %25, label %func_primal_bea_mpp.13, label %ctrl8

ctrl8:                                            ; preds = %ctrl7
  %26 = icmp eq i32 %0, 9
  br i1 %26, label %func_primal_bea_mpp.17, label %ctrl9
...
ctrl10:                                           ; preds = %ctrl9
  %28 = icmp eq i32 %0, 11
  br i1 %28, label %func_primal_bea_mpp.23, label %ctrl11

ctrl11:                                           ; preds = %ctrl10
  %29 = icmp eq i32 %0, 12
  br i1 %29, label %func_primal_bea_mpp.26, label %ctrl12

ctrl12:                                           ; preds = %ctrl11
  %30 = icmp eq i32 %0, 13
  br i1 %30, label %func_primal_bea_mpp.27, label %ctrl13

ctrl13:                                           ; preds = %ctrl12
  %31 = icmp eq i32 %0, 14
  br i1 %31, label %func_primal_bea_mpp.29, label %func_primal_bea_mpp.31
}
...
entry:
  ...
  %canary = alloca i32
  store i32 712447407, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 403827612, i32* %canary
  %arc.addr = alloca %struct.arc*, align 8
  %red_cost.addr = alloca i64, align 8
  store %struct.arc* %arc, %struct.arc** %arc.addr, align 8
  store i64 %red_cost, i64* %red_cost.addr, align 8
...
entry:
  ...
  %canary = alloca i32
  store i32 1562104214, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1135391819, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct.arc* @primal_bea_mpp.5(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea) #0 {
entry:
  %next = alloca i64, align 8
  %retval = alloca %struct.arc*, align 8
  %old_group_pos = alloca i64, align 8
  ...
  %stop_arcs.addr = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 2078512168, i32* %canary
  %m.addr = alloca i64, align 8
  %i = alloca i64, align 8
  %arcs.addr = alloca %struct.arc*, align 8
  %red_cost_of_bea.addr = alloca i64*, align 8
...
entry:
  %canary = alloca i32
  store i32 1396664574, i32* %canary
  %r = alloca i64, align 8
  %max.addr = alloca i64, align 8
  %xchange = alloca %struct.basket*, align 8
  %cut = alloca i64, align 8
...
entry:
  ...
  %i = alloca i64, align 8
  %canary = alloca i32
  store i32 1378358955, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %retval = alloca %struct.arc*, align 8
  %old_group_pos = alloca i64, align 8
  %red_cost_of_bea.addr = alloca i64*, align 8
...
entry:
  ...
  %next = alloca i64, align 8
  %canary = alloca i32
  store i32 1071465010, i32* %canary
  %i = alloca i64, align 8
  %stop_arcs.addr = alloca %struct.arc*, align 8
  %red_cost_of_bea.addr = alloca i64*, align 8
  %m.addr = alloca i64, align 8
...
entry:
  ...
  %old_group_pos = alloca i64, align 8
  %canary = alloca i32
  store i32 952238307, i32* %canary
  %retval = alloca %struct.arc*, align 8
  %m.addr = alloca i64, align 8
  %i = alloca i64, align 8
  %red_cost_of_bea.addr = alloca i64*, align 8
...
entry:
  ...
  %stop_arcs.addr = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 582564446, i32* %canary
  %old_group_pos = alloca i64, align 8
  %i = alloca i64, align 8
  store i64 %m, i64* %m.addr, align 8
  store %struct.arc* %arcs, %struct.arc** %arcs.addr, align 8
...
entry:
  ...
  %retval = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 2135402016, i32* %canary
  %arcs.addr = alloca %struct.arc*, align 8
  %i = alloca i64, align 8
  %red_cost = alloca i64, align 8
  %m.addr = alloca i64, align 8
...
entry:
  ...
  %retval = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 681945340, i32* %canary
  %red_cost_of_bea.addr = alloca i64*, align 8
  %arc = alloca %struct.arc*, align 8
  %m.addr = alloca i64, align 8
  store i64 %m, i64* %m.addr, align 8
...
entry:
  ...
  %red_cost = alloca i64, align 8
  %canary = alloca i32
  store i32 823886178, i32* %canary
  %stop_arcs.addr = alloca %struct.arc*, align 8
  %arcs.addr = alloca %struct.arc*, align 8
  %i = alloca i64, align 8
  %red_cost_of_bea.addr = alloca i64*, align 8
...
entry:
  ...
  %max.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 901637397, i32* %canary
  %r = alloca i64, align 8
  store i64 %min, i64* %min.addr, align 8
  store i64 %max, i64* %max.addr, align 8
  %0 = load i64, i64* %min.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @sort_basket.15(i64 %min, i64 %max) #0 {
entry:
  %cut = alloca i64, align 8
  %min.addr = alloca i64, align 8
  %xchange = alloca %struct.basket*, align 8
  %r = alloca i64, align 8
  %canary = alloca i32
  store i32 1117960601, i32* %canary
  %max.addr = alloca i64, align 8
  %l = alloca i64, align 8
  store i64 %min, i64* %min.addr, align 8
  store i64 %max, i64* %max.addr, align 8
...
entry:
  ...
  %l = alloca i64, align 8
  %canary = alloca i32
  store i32 849224146, i32* %canary
  %cut = alloca i64, align 8
  %max.addr = alloca i64, align 8
  store i64 %min, i64* %min.addr, align 8
  store i64 %max, i64* %max.addr, align 8
...
entry:
  ...
  %red_cost_of_bea.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 1154314620, i32* %canary
  %old_group_pos = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
  %arcs.addr = alloca %struct.arc*, align 8
  %i = alloca i64, align 8
...
entry:
  %max.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1139773338, i32* %canary
  %l = alloca i64, align 8
  %min.addr = alloca i64, align 8
  %r = alloca i64, align 8
  %xchange = alloca %struct.basket*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @sort_basket.19(i64 %min, i64 %max) #0 {
entry:
  %cut = alloca i64, align 8
  %max.addr = alloca i64, align 8
  %xchange = alloca %struct.basket*, align 8
  %canary = alloca i32
  store i32 2018808992, i32* %canary
  %min.addr = alloca i64, align 8
  %l = alloca i64, align 8
  %r = alloca i64, align 8
  store i64 %min, i64* %min.addr, align 8
...
entry:
  ...
  %l = alloca i64, align 8
  %canary = alloca i32
  store i32 1951872971, i32* %canary
  %cut = alloca i64, align 8
  %min.addr = alloca i64, align 8
  %r = alloca i64, align 8
  %xchange = alloca %struct.basket*, align 8
...
entry:
  ...
  %stop_arcs.addr = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1362899950, i32* %canary
  %red_cost_of_bea.addr = alloca i64*, align 8
  %next = alloca i64, align 8
  %red_cost = alloca i64, align 8
  %m.addr = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @sort_basket.22(i64 %min, i64 %max) #0 {
entry:
  %r = alloca i64, align 8
  %max.addr = alloca i64, align 8
  %min.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 426880200, i32* %canary
  %l = alloca i64, align 8
  %cut = alloca i64, align 8
  %xchange = alloca %struct.basket*, align 8
  store i64 %min, i64* %min.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct.arc* @primal_bea_mpp.23(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea) #0 {
entry:
  %red_cost_of_bea.addr = alloca i64*, align 8
  %arcs.addr = alloca %struct.arc*, align 8
  %old_group_pos = alloca i64, align 8
  ...
  %m.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1723769189, i32* %canary
  %arc = alloca %struct.arc*, align 8
  store i64 %m, i64* %m.addr, align 8
  store %struct.arc* %arcs, %struct.arc** %arcs.addr, align 8
  store %struct.arc* %stop_arcs, %struct.arc** %stop_arcs.addr, align 8
...
entry:
  ...
  %xchange = alloca %struct.basket*, align 8
  %canary = alloca i32
  store i32 1640817507, i32* %canary
  %r = alloca i64, align 8
  %cut = alloca i64, align 8
  %max.addr = alloca i64, align 8
  store i64 %min, i64* %min.addr, align 8
...
entry:
  ...
  %retval = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1897455028, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %old_group_pos = alloca i64, align 8
  %m.addr = alloca i64, align 8
  %next = alloca i64, align 8
...
entry:
  ...
  %next = alloca i64, align 8
  %canary = alloca i32
  store i32 1540343564, i32* %canary
  %stop_arcs.addr = alloca %struct.arc*, align 8
  %old_group_pos = alloca i64, align 8
  %i = alloca i64, align 8
  %red_cost = alloca i64, align 8
...
entry:
  ...
  %r = alloca i64, align 8
  %canary = alloca i32
  store i32 1433128026, i32* %canary
  %l = alloca i64, align 8
  %xchange = alloca %struct.basket*, align 8
  %min.addr = alloca i64, align 8
  store i64 %min, i64* %min.addr, align 8
...
entry:
  ...
  %next = alloca i64, align 8
  %canary = alloca i32
  store i32 1142361368, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %arcs.addr = alloca %struct.arc*, align 8
  %old_group_pos = alloca i64, align 8
  %red_cost_of_bea.addr = alloca i64*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @sort_basket.30(i64 %min, i64 %max) #0 {
entry:
  %xchange = alloca %struct.basket*, align 8
  %cut = alloca i64, align 8
  %r = alloca i64, align 8
  %canary = alloca i32
  store i32 836221844, i32* %canary
  %max.addr = alloca i64, align 8
  %l = alloca i64, align 8
  %min.addr = alloca i64, align 8
  store i64 %min, i64* %min.addr, align 8
...
entry:
  %i = alloca i64, align 8
  %canary = alloca i32
  store i32 1527886659, i32* %canary
  %m.addr = alloca i64, align 8
  %next = alloca i64, align 8
  %retval = alloca %struct.arc*, align 8
  %red_cost = alloca i64, align 8
...
entry:
  %min.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1784144205, i32* %canary
  %l = alloca i64, align 8
  %cut = alloca i64, align 8
  %r = alloca i64, align 8
  %max.addr = alloca i64, align 8
...
entry:
  ...
  %l = alloca i64, align 8
  %canary = alloca i32
  store i32 283730496, i32* %canary
  %min.addr = alloca i64, align 8
  store i64 %min, i64* %min.addr, align 8
  store i64 %max, i64* %max.addr, align 8
  %0 = load i64, i64* %min.addr, align 8
...
entry:
  ...
  %l = alloca i64, align 8
  %canary = alloca i32
  store i32 1247607110, i32* %canary
  %min.addr = alloca i64, align 8
  %cut = alloca i64, align 8
  %r = alloca i64, align 8
  %max.addr = alloca i64, align 8
