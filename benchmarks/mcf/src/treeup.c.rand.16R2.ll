; ModuleID = 'treeup.c.rand.16R2.bc'
...
entry:
  ...
  %canary = alloca i32
  store i32 960558569, i32* %canary
...
entry:
  ...
  %bea.addr = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1542598666, i32* %canary
  %depth_temp = alloca i64, align 8
  %feas_tol.addr = alloca i64, align 8
  %depth_iminus = alloca i64, align 8
  %cycle_ori.addr = alloca i64, align 8
...
if.end128:                                        ; preds = %for.end127, %for.end108
  %152 = load i32, i32* %canary
  %153 = icmp eq i32 %152, 1542598666
  br i1 %153, label %154, label %func_exit
...
entry:
  ...
  %sigma.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 274204158, i32* %canary
  %father = alloca %struct.node*, align 8
  %new_flow.addr = alloca i64, align 8
  %feas_tol.addr = alloca i64, align 8
  %new_orientation.addr = alloca i64, align 8
...
entry:
  %flow_temp = alloca i64, align 8
  %canary = alloca i32
  store i32 1946266118, i32* %canary
  %feas_tol.addr = alloca i64, align 8
  %orientation_temp = alloca i64, align 8
  %iplus.addr = alloca %struct.node*, align 8
  %new_depth = alloca i64, align 8
...
if.end128:                                        ; preds = %for.end127, %for.end108
  %152 = load i32, i32* %canary
  %153 = icmp eq i32 %152, 1946266118
  br i1 %153, label %154, label %func_exit
...
entry:
  ...
  %new_orientation.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 655052140, i32* %canary
  %iplus.addr = alloca %struct.node*, align 8
  %father = alloca %struct.node*, align 8
  %temp = alloca %struct.node*, align 8
  store i64 %cycle_ori, i64* %cycle_ori.addr, align 8
...
entry:
  ...
  %sigma.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 2091763203, i32* %canary
  %cycle_ori.addr = alloca i64, align 8
  %new_depth = alloca i64, align 8
  %new_basic_arc = alloca %struct.arc*, align 8
  %jminus.addr = alloca %struct.node*, align 8
...
if.end128:                                        ; preds = %for.end127, %for.end108
  %152 = load i32, i32* %canary
  %153 = icmp eq i32 %152, 2091763203
  br i1 %153, label %154, label %func_exit
...
entry:
  ...
  %delta.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1709909633, i32* %canary
  %depth_temp = alloca i64, align 8
  %new_pred = alloca %struct.node*, align 8
  %iminus.addr = alloca %struct.node*, align 8
  %orientation_temp = alloca i64, align 8
...
if.end128:                                        ; preds = %for.end127, %for.end108
  %152 = load i32, i32* %canary
  %153 = icmp eq i32 %152, 1709909633
  br i1 %153, label %154, label %func_exit
...
entry:
  ...
  %w.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1703365125, i32* %canary
  %new_orientation.addr = alloca i64, align 8
  %new_basic_arc = alloca %struct.arc*, align 8
  %jplus.addr = alloca %struct.node*, align 8
  store i64 %cycle_ori, i64* %cycle_ori.addr, align 8
...
if.end128:                                        ; preds = %for.end127, %for.end108
  %152 = load i32, i32* %canary
  %153 = icmp eq i32 %152, 1703365125
  br i1 %153, label %154, label %func_exit
...
entry:
  ...
  %feas_tol.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1576230734, i32* %canary
  %new_basic_arc = alloca %struct.arc*, align 8
  %new_flow.addr = alloca i64, align 8
  %orientation_temp = alloca i64, align 8
  %cycle_ori.addr = alloca i64, align 8
...
if.end128:                                        ; preds = %for.end127, %for.end108
  %152 = load i32, i32* %canary
  %153 = icmp eq i32 %152, 1576230734
  br i1 %153, label %154, label %func_exit
...
entry:
  ...
  %new_pred = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 130481095, i32* %canary
  %iminus.addr = alloca %struct.node*, align 8
  %basic_arc_temp = alloca %struct.arc*, align 8
  %feas_tol.addr = alloca i64, align 8
  %depth_iminus = alloca i64, align 8
...
entry:
  ...
  %new_basic_arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1113307023, i32* %canary
  %new_orientation.addr = alloca i64, align 8
  %bea.addr = alloca %struct.arc*, align 8
  %basic_arc_temp = alloca %struct.arc*, align 8
  %depth_iminus = alloca i64, align 8
...
if.end128:                                        ; preds = %for.end127, %for.end108
  %152 = load i32, i32* %canary
  %153 = icmp eq i32 %152, 1113307023
  br i1 %153, label %154, label %func_exit
...
entry:
  ...
  %flow_temp = alloca i64, align 8
  %canary = alloca i32
  store i32 1703380123, i32* %canary
  %new_flow.addr = alloca i64, align 8
  %orientation_temp = alloca i64, align 8
  store i64 %cycle_ori, i64* %cycle_ori.addr, align 8
  store i64 %new_orientation, i64* %new_orientation.addr, align 8
...
if.end128:                                        ; preds = %for.end127, %for.end108
  %152 = load i32, i32* %canary
  %153 = icmp eq i32 %152, 1703380123
  br i1 %153, label %154, label %func_exit
...
entry:
  ...
  %delta.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1431651558, i32* %canary
  %new_orientation.addr = alloca i64, align 8
  %father = alloca %struct.node*, align 8
  %iplus.addr = alloca %struct.node*, align 8
  %feas_tol.addr = alloca i64, align 8
...
if.end128:                                        ; preds = %for.end127, %for.end108
  %152 = load i32, i32* %canary
  %153 = icmp eq i32 %152, 1431651558
  br i1 %153, label %154, label %func_exit
...
entry:
  ...
  %orientation_temp = alloca i64, align 8
  %canary = alloca i32
  store i32 290047501, i32* %canary
  %jminus.addr = alloca %struct.node*, align 8
  %cycle_ori.addr = alloca i64, align 8
  %iminus.addr = alloca %struct.node*, align 8
  %depth_temp = alloca i64, align 8
...
entry:
  ...
  %new_flow.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1027444491, i32* %canary
  %w.addr = alloca %struct.node*, align 8
  %jminus.addr = alloca %struct.node*, align 8
  store i64 %cycle_ori, i64* %cycle_ori.addr, align 8
  store i64 %new_orientation, i64* %new_orientation.addr, align 8
...
if.end128:                                        ; preds = %for.end127, %for.end108
  %152 = load i32, i32* %canary
  %153 = icmp eq i32 %152, 1027444491
  br i1 %153, label %154, label %func_exit
