; ModuleID = 'pbeampp.c.rand.4P2.bc'
...
func_sort_basket.8:                               ; preds = %ctrl0
  call void @sort_basket.8(i64 %min, i64 %max)
  ret void

func_sort_basket.9:                               ; preds = %ctrl1
  call void @sort_basket.9(i64 %min, i64 %max)
  ret void

func_sort_basket.10:                              ; preds = %ctrl1
  call void @sort_basket.10(i64 %min, i64 %max)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_sort_basket.8, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_sort_basket.9, label %func_sort_basket.10
}
...
func_primal_bea_mpp.6:                            ; preds = %ctrl1
  %4 = call %struct.arc* @primal_bea_mpp.6(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea)
  ret %struct.arc* %4

func_primal_bea_mpp.7:                            ; preds = %ctrl1
  %5 = call %struct.arc* @primal_bea_mpp.7(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea)
  ret %struct.arc* %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_primal_bea_mpp.5, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_primal_bea_mpp.6, label %func_primal_bea_mpp.7
}
...
entry:
  %canary = alloca i32
  store i32 1239625984, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1077374888, i32* %canary
...
entry:
  %red_cost.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1367307118, i32* %canary
  %arc.addr = alloca %struct.arc*, align 8
  store %struct.arc* %arc, %struct.arc** %arc.addr, align 8
  store i64 %red_cost, i64* %red_cost.addr, align 8
  %0 = load i64, i64* %red_cost.addr, align 8
...
entry:
  ...
  %canary = alloca i32
  store i32 306107581, i32* %canary
...
entry:
  ...
  %old_group_pos = alloca i64, align 8
  %canary = alloca i32
  store i32 2023112033, i32* %canary
  %i = alloca i64, align 8
  %arcs.addr = alloca %struct.arc*, align 8
  %red_cost_of_bea.addr = alloca i64*, align 8
  store i64 %m, i64* %m.addr, align 8
...
entry:
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 2079454284, i32* %canary
  %red_cost = alloca i64, align 8
  %red_cost_of_bea.addr = alloca i64*, align 8
  %arcs.addr = alloca %struct.arc*, align 8
  %m.addr = alloca i64, align 8
...
entry:
  ...
  %old_group_pos = alloca i64, align 8
  %canary = alloca i32
  store i32 352667151, i32* %canary
  %arcs.addr = alloca %struct.arc*, align 8
  %stop_arcs.addr = alloca %struct.arc*, align 8
  %red_cost = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
...
entry:
  ...
  %l = alloca i64, align 8
  %canary = alloca i32
  store i32 1751782152, i32* %canary
  %min.addr = alloca i64, align 8
  %r = alloca i64, align 8
  store i64 %min, i64* %min.addr, align 8
  store i64 %max, i64* %max.addr, align 8
...
entry:
  ...
  %min.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1672324745, i32* %canary
  %cut = alloca i64, align 8
  %xchange = alloca %struct.basket*, align 8
  %max.addr = alloca i64, align 8
  %l = alloca i64, align 8
...
entry:
  %xchange = alloca %struct.basket*, align 8
  %canary = alloca i32
  store i32 167091721, i32* %canary
  %l = alloca i64, align 8
  %min.addr = alloca i64, align 8
  %r = alloca i64, align 8
  %max.addr = alloca i64, align 8
