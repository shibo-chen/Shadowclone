; ModuleID = 'treeup.c.rand.16P1.bc'
...
entry:
  ...
  %canary = alloca i32
  store i32 1235015926, i32* %canary
...
if.end128:                                        ; preds = %for.end127, %for.end108
  ...
  %153 = icmp eq i32 %152, 1235015926
...
entry:
  ...
  %iplus.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1054210580, i32* %canary
  %depth_iminus = alloca i64, align 8
  %delta.addr = alloca i64, align 8
  %feas_tol.addr = alloca i64, align 8
  %jminus.addr = alloca %struct.node*, align 8
...
if.end128:                                        ; preds = %for.end127, %for.end108
  %152 = load i32, i32* %canary
  %153 = icmp eq i32 %152, 1054210580
  br i1 %153, label %154, label %func_exit
...
entry:
  ...
  %orientation_temp = alloca i64, align 8
  %canary = alloca i32
  store i32 980424089, i32* %canary
  %bea.addr = alloca %struct.arc*, align 8
  %new_basic_arc = alloca %struct.arc*, align 8
  %flow_temp = alloca i64, align 8
  %basic_arc_temp = alloca %struct.arc*, align 8
...
entry:
  %canary = alloca i32
  store i32 1449222238, i32* %canary
  %feas_tol.addr = alloca i64, align 8
  %w.addr = alloca %struct.node*, align 8
  %flow_temp = alloca i64, align 8
  %cycle_ori.addr = alloca i64, align 8
...
if.end128:                                        ; preds = %for.end127, %for.end108
  %152 = load i32, i32* %canary
  %153 = icmp eq i32 %152, 1449222238
  br i1 %153, label %154, label %func_exit
...
entry:
  ...
  %jplus.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1051095839, i32* %canary
  %new_pred = alloca %struct.node*, align 8
  %flow_temp = alloca i64, align 8
  %temp = alloca %struct.node*, align 8
  %new_depth = alloca i64, align 8
...
if.end128:                                        ; preds = %for.end127, %for.end108
  %152 = load i32, i32* %canary
  %153 = icmp eq i32 %152, 1051095839
  br i1 %153, label %154, label %func_exit
...
entry:
  ...
  %father = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1904616840, i32* %canary
  %orientation_temp = alloca i64, align 8
  %flow_temp = alloca i64, align 8
  %new_pred = alloca %struct.node*, align 8
  %jplus.addr = alloca %struct.node*, align 8
...
if.end128:                                        ; preds = %for.end127, %for.end108
  %152 = load i32, i32* %canary
  %153 = icmp eq i32 %152, 1904616840
  br i1 %153, label %154, label %func_exit
...
entry:
  ...
  %delta.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1397671652, i32* %canary
  %jminus.addr = alloca %struct.node*, align 8
  %basic_arc_temp = alloca %struct.arc*, align 8
  store i64 %cycle_ori, i64* %cycle_ori.addr, align 8
  store i64 %new_orientation, i64* %new_orientation.addr, align 8
...
if.end128:                                        ; preds = %for.end127, %for.end108
  %152 = load i32, i32* %canary
  %153 = icmp eq i32 %152, 1397671652
  br i1 %153, label %154, label %func_exit
...
entry:
  ...
  %father = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 352526838, i32* %canary
  %new_depth = alloca i64, align 8
  %feas_tol.addr = alloca i64, align 8
  store i64 %cycle_ori, i64* %cycle_ori.addr, align 8
  store i64 %new_orientation, i64* %new_orientation.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 329787013, i32* %canary
  %new_flow.addr = alloca i64, align 8
  %feas_tol.addr = alloca i64, align 8
  %w.addr = alloca %struct.node*, align 8
  %father = alloca %struct.node*, align 8
...
entry:
  ...
  %feas_tol.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1791675221, i32* %canary
  %flow_temp = alloca i64, align 8
  %new_basic_arc = alloca %struct.arc*, align 8
  %bea.addr = alloca %struct.arc*, align 8
  %depth_iminus = alloca i64, align 8
...
if.end128:                                        ; preds = %for.end127, %for.end108
  %152 = load i32, i32* %canary
  %153 = icmp eq i32 %152, 1791675221
  br i1 %153, label %154, label %func_exit
...
entry:
  ...
  %cycle_ori.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1483462891, i32* %canary
  %sigma.addr = alloca i64, align 8
  %new_basic_arc = alloca %struct.arc*, align 8
  %depth_temp = alloca i64, align 8
  %new_depth = alloca i64, align 8
...
if.end128:                                        ; preds = %for.end127, %for.end108
  %152 = load i32, i32* %canary
  %153 = icmp eq i32 %152, 1483462891
  br i1 %153, label %154, label %func_exit
...
entry:
  ...
  %new_basic_arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1137767467, i32* %canary
  %cycle_ori.addr = alloca i64, align 8
  %new_depth = alloca i64, align 8
  %jplus.addr = alloca %struct.node*, align 8
  %father = alloca %struct.node*, align 8
...
if.end128:                                        ; preds = %for.end127, %for.end108
  %152 = load i32, i32* %canary
  %153 = icmp eq i32 %152, 1137767467
  br i1 %153, label %154, label %func_exit
...
entry:
  ...
  %w.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 850311529, i32* %canary
  %basic_arc_temp = alloca %struct.arc*, align 8
  %new_depth = alloca i64, align 8
  %orientation_temp = alloca i64, align 8
  %temp = alloca %struct.node*, align 8
...
entry:
  ...
  %w.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 434186091, i32* %canary
  %iminus.addr = alloca %struct.node*, align 8
  %delta.addr = alloca i64, align 8
  %temp = alloca %struct.node*, align 8
  %jplus.addr = alloca %struct.node*, align 8
...
entry:
  ...
  %new_pred = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1444133315, i32* %canary
  %cycle_ori.addr = alloca i64, align 8
  %new_orientation.addr = alloca i64, align 8
  %depth_temp = alloca i64, align 8
  %delta.addr = alloca i64, align 8
...
if.end128:                                        ; preds = %for.end127, %for.end108
  %152 = load i32, i32* %canary
  %153 = icmp eq i32 %152, 1444133315
  br i1 %153, label %154, label %func_exit
