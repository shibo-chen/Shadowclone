; ModuleID = 'readmin.c.rand.8R2.bc'
...
func_read_min.8:                                  ; preds = %ctrl5
  %9 = call i64 @read_min.8(%struct.network* %net)
  ret i64 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_read_min.2, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_read_min.3, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_read_min.4, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_read_min.5, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_read_min.6, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_read_min.7, label %func_read_min.8
}
...
entry:
  %canary = alloca i32
  store i32 2127922280, i32* %canary
...
return:                                           ; preds = %for.end228, %if.then147, %if.then134, %if.then57, %if.then34, %if.then6, %if.then
  ...
  %249 = icmp eq i32 %248, 2127922280
...
entry:
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 2114153597, i32* %canary
  %i = alloca i64, align 8
  %retval = alloca i64, align 8
  %t = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
...
return:                                           ; preds = %for.end228, %if.then147, %if.then134, %if.then57, %if.then34, %if.then6, %if.then
  %247 = load i64, i64* %retval, align 8
  %248 = load i32, i32* %canary
  %249 = icmp eq i32 %248, 2114153597
  br i1 %249, label %250, label %func_exit
...
entry:
  ...
  %instring = alloca [201 x i8], align 16
  %canary = alloca i32
  store i32 1564004352, i32* %canary
  %in = alloca %struct._IO_FILE*, align 8
  %node = alloca %struct.node*, align 8
  %arc = alloca %struct.arc*, align 8
  %h = alloca i64, align 8
...
return:                                           ; preds = %for.end228, %if.then147, %if.then134, %if.then57, %if.then34, %if.then6, %if.then
  %247 = load i64, i64* %retval, align 8
  %248 = load i32, i32* %canary
  %249 = icmp eq i32 %248, 1564004352
  br i1 %249, label %250, label %func_exit
...
entry:
  ...
  %in = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 1333544525, i32* %canary
  %c = alloca i64, align 8
  %i = alloca i64, align 8
  %node = alloca %struct.node*, align 8
  %t = alloca i64, align 8
...
return:                                           ; preds = %for.end228, %if.then147, %if.then134, %if.then57, %if.then34, %if.then6, %if.then
  %247 = load i64, i64* %retval, align 8
  %248 = load i32, i32* %canary
  %249 = icmp eq i32 %248, 1333544525
  br i1 %249, label %250, label %func_exit
...
entry:
  ...
  %h = alloca i64, align 8
  %canary = alloca i32
  store i32 1594467248, i32* %canary
  %retval = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
  %c = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
...
return:                                           ; preds = %for.end228, %if.then147, %if.then134, %if.then57, %if.then34, %if.then6, %if.then
  %247 = load i64, i64* %retval, align 8
  %248 = load i32, i32* %canary
  %249 = icmp eq i32 %248, 1594467248
  br i1 %249, label %250, label %func_exit
...
entry:
  ...
  %i = alloca i64, align 8
  %canary = alloca i32
  store i32 423730885, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %in = alloca %struct._IO_FILE*, align 8
  %retval = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  ...
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 525480692, i32* %canary
  %h = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store %struct._IO_FILE* null, %struct._IO_FILE** %in, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1723456499, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %retval = alloca i64, align 8
  %c = alloca i64, align 8
  %instring = alloca [201 x i8], align 16
...
return:                                           ; preds = %for.end228, %if.then147, %if.then134, %if.then57, %if.then34, %if.then6, %if.then
  %247 = load i64, i64* %retval, align 8
  %248 = load i32, i32* %canary
  %249 = icmp eq i32 %248, 1723456499
  br i1 %249, label %250, label %func_exit
