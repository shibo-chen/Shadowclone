; ModuleID = 'pflowup.c.rand.8P2.bc'
...
entry:
  %canary = alloca i32
  store i32 854106690, i32* %canary
...
entry:
  %w.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1314234576, i32* %canary
  %iplus.addr = alloca %struct.node*, align 8
  %jplus.addr = alloca %struct.node*, align 8
  store %struct.node* %iplus, %struct.node** %iplus.addr, align 8
  store %struct.node* %jplus, %struct.node** %jplus.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1353696685, i32* %canary
  %jplus.addr = alloca %struct.node*, align 8
  %iplus.addr = alloca %struct.node*, align 8
  %w.addr = alloca %struct.node*, align 8
  store %struct.node* %iplus, %struct.node** %iplus.addr, align 8
...
entry:
  ...
  %w.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 352793455, i32* %canary
  %iplus.addr = alloca %struct.node*, align 8
  store %struct.node* %iplus, %struct.node** %iplus.addr, align 8
  store %struct.node* %jplus, %struct.node** %jplus.addr, align 8
  store %struct.node* %w, %struct.node** %w.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1321920459, i32* %canary
  %w.addr = alloca %struct.node*, align 8
  %jplus.addr = alloca %struct.node*, align 8
  %iplus.addr = alloca %struct.node*, align 8
  store %struct.node* %iplus, %struct.node** %iplus.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 315208608, i32* %canary
  %iplus.addr = alloca %struct.node*, align 8
  %jplus.addr = alloca %struct.node*, align 8
  %w.addr = alloca %struct.node*, align 8
  store %struct.node* %iplus, %struct.node** %iplus.addr, align 8
