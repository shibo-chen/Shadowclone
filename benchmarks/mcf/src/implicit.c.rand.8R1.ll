; ModuleID = 'implicit.c.rand.8R1.bc'
...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_resize_prob.3, label %ctrl0

func_resize_prob.3:                               ; preds = %rand_bb
  %2 = call i64 @resize_prob.3(%struct.network* %net)
  ret i64 %2

func_resize_prob.5:                               ; preds = %ctrl0
  %3 = call i64 @resize_prob.5(%struct.network* %net)
  ret i64 %3

func_resize_prob.18:                              ; preds = %ctrl1
  %4 = call i64 @resize_prob.18(%struct.network* %net)
  ret i64 %4

func_resize_prob.20:                              ; preds = %ctrl2
  %5 = call i64 @resize_prob.20(%struct.network* %net)
  ret i64 %5

func_resize_prob.21:                              ; preds = %ctrl3
  %6 = call i64 @resize_prob.21(%struct.network* %net)
  ret i64 %6

func_resize_prob.24:                              ; preds = %ctrl4
  %7 = call i64 @resize_prob.24(%struct.network* %net)
  ret i64 %7

func_resize_prob.25:                              ; preds = %ctrl5
  %8 = call i64 @resize_prob.25(%struct.network* %net)
  ret i64 %8

func_resize_prob.26:                              ; preds = %ctrl5
  %9 = call i64 @resize_prob.26(%struct.network* %net)
  ret i64 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_resize_prob.5, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_resize_prob.18, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_resize_prob.20, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_resize_prob.21, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_resize_prob.24, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_resize_prob.25, label %func_resize_prob.26
}
...
func_insert_new_arc.7:                            ; preds = %ctrl0
  call void @insert_new_arc.7(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void

func_insert_new_arc.10:                           ; preds = %ctrl1
  call void @insert_new_arc.10(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void
...
func_insert_new_arc.30:                           ; preds = %ctrl4
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_insert_new_arc.7, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_insert_new_arc.10, label %ctrl2
...
ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_insert_new_arc.30, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_insert_new_arc.31, label %func_insert_new_arc.32
}
...
func_replace_weaker_arc.2:                        ; preds = %ctrl0
  call void @replace_weaker_arc.2(%struct.network* %net, %struct.arc* %new, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void

func_replace_weaker_arc.9:                        ; preds = %ctrl1
  call void @replace_weaker_arc.9(%struct.network* %net, %struct.arc* %new, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void

func_replace_weaker_arc.12:                       ; preds = %ctrl2
...
func_replace_weaker_arc.15:                       ; preds = %ctrl3
...
func_replace_weaker_arc.16:                       ; preds = %ctrl4
...
func_replace_weaker_arc.17:                       ; preds = %ctrl5
...
func_replace_weaker_arc.22:                       ; preds = %ctrl5
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_replace_weaker_arc.2, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_replace_weaker_arc.9, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_replace_weaker_arc.12, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_replace_weaker_arc.15, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_replace_weaker_arc.16, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_replace_weaker_arc.17, label %func_replace_weaker_arc.22
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_price_out_impl.4, label %ctrl0

func_price_out_impl.4:                            ; preds = %rand_bb
  %2 = call i64 @price_out_impl.4(%struct.network* %net)
  ret i64 %2
...
func_price_out_impl.11:                           ; preds = %ctrl1
  %4 = call i64 @price_out_impl.11(%struct.network* %net)
  ret i64 %4

func_price_out_impl.13:                           ; preds = %ctrl2
  %5 = call i64 @price_out_impl.13(%struct.network* %net)
  ret i64 %5

func_price_out_impl.19:                           ; preds = %ctrl3
  %6 = call i64 @price_out_impl.19(%struct.network* %net)
  ret i64 %6
...
func_price_out_impl.34:                           ; preds = %ctrl5
  %8 = call i64 @price_out_impl.34(%struct.network* %net)
  ret i64 %8

func_price_out_impl.36:                           ; preds = %ctrl5
  %9 = call i64 @price_out_impl.36(%struct.network* %net)
  ret i64 %9
...
ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_price_out_impl.11, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_price_out_impl.13, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_price_out_impl.19, label %ctrl4
...
ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_price_out_impl.34, label %func_price_out_impl.36
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_suspend_impl.28, label %ctrl0

func_suspend_impl.28:                             ; preds = %rand_bb
  %2 = call i64 @suspend_impl.28(%struct.network* %net, i64 %threshold, i64 %all)
  ret i64 %2

func_suspend_impl.29:                             ; preds = %ctrl0
  %3 = call i64 @suspend_impl.29(%struct.network* %net, i64 %threshold, i64 %all)
  ret i64 %3

func_suspend_impl.33:                             ; preds = %ctrl1
  %4 = call i64 @suspend_impl.33(%struct.network* %net, i64 %threshold, i64 %all)
  ret i64 %4

func_suspend_impl.35:                             ; preds = %ctrl2
  %5 = call i64 @suspend_impl.35(%struct.network* %net, i64 %threshold, i64 %all)
  ret i64 %5

func_suspend_impl.37:                             ; preds = %ctrl3
  %6 = call i64 @suspend_impl.37(%struct.network* %net, i64 %threshold, i64 %all)
  ret i64 %6

func_suspend_impl.38:                             ; preds = %ctrl4
  %7 = call i64 @suspend_impl.38(%struct.network* %net, i64 %threshold, i64 %all)
  ret i64 %7

func_suspend_impl.39:                             ; preds = %ctrl5
  %8 = call i64 @suspend_impl.39(%struct.network* %net, i64 %threshold, i64 %all)
  ret i64 %8
...
ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_suspend_impl.29, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_suspend_impl.33, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_suspend_impl.35, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_suspend_impl.37, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_suspend_impl.38, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_suspend_impl.39, label %func_suspend_impl.40
}
...
entry:
  ...
  %canary = alloca i32
  store i32 1501877421, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @replace_weaker_arc.2(%struct.network* %net, %struct.arc* %new, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost) #0 {
entry:
  %tail.addr = alloca %struct.node*, align 8
  %cost.addr = alloca i64, align 8
  %head.addr = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 1822949188, i32* %canary
  %red_cost.addr = alloca i64, align 8
  %cmp = alloca i64, align 8
  %new.addr = alloca %struct.arc*, align 8
  %pos = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @resize_prob.3(%struct.network* %net) #0 {
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 367452287, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1174995076, i32* %canary
...
return:                                           ; preds = %if.end109, %if.then10
  ...
  %145 = icmp eq i32 %144, 1174995076
...
entry:
  %canary = alloca i32
  store i32 375528350, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %off = alloca i64, align 8
  %root = alloca %struct.node*, align 8
  %arc = alloca %struct.arc*, align 8
...
entry:
  ...
  %canary = alloca i32
  store i32 669336955, i32* %canary
  %head.addr = alloca %struct.node*, align 8
  %tail.addr = alloca %struct.node*, align 8
  store %struct.arc* %new, %struct.arc** %new.addr, align 8
...
entry:
  ...
  %new.addr = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 814213509, i32* %canary
  %newpos.addr = alloca i64, align 8
  %cost.addr = alloca i64, align 8
  %pos = alloca i64, align 8
  store %struct.arc* %new, %struct.arc** %new.addr, align 8
...
entry:
  ...
  %retval = alloca i64, align 8
  %canary = alloca i32
  store i32 515184852, i32* %canary
  %i = alloca i64, align 8
  %arc_cost = alloca i64, align 8
  %resized = alloca i64, align 8
  %bigM_minus_min_impl_duration = alloca i64, align 8
...
entry:
  ...
  %new.addr = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 476639661, i32* %canary
  %cmp = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store %struct.arc* %new, %struct.arc** %new.addr, align 8
  store %struct.node* %tail, %struct.node** %tail.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @insert_new_arc.10(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost) #0 {
entry:
  %new.addr = alloca %struct.arc*, align 8
  %head.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1397326612, i32* %canary
  %newpos.addr = alloca i64, align 8
  %cost.addr = alloca i64, align 8
  %tail.addr = alloca %struct.node*, align 8
  %red_cost.addr = alloca i64, align 8
...
entry:
  ...
  %min_impl_duration = alloca i64, align 8
  %canary = alloca i32
  store i32 1678907696, i32* %canary
  %latest = alloca i64, align 8
  %new_arcs = alloca i64, align 8
  %retval = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
return:                                           ; preds = %if.end109, %if.then10
  %143 = load i64, i64* %retval, align 8
  %144 = load i32, i32* %canary
  %145 = icmp eq i32 %144, 1678907696
  br i1 %145, label %146, label %func_exit
...
entry:
  ...
  %head.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1969973664, i32* %canary
  %cmp = alloca i64, align 8
  %tail.addr = alloca %struct.node*, align 8
  %new.addr = alloca %struct.arc*, align 8
  %pos = alloca i64, align 8
...
entry:
  ...
  %head = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 767187851, i32* %canary
  %new_arcs = alloca i64, align 8
  %arcout = alloca %struct.arc*, align 8
  %bigM = alloca i64, align 8
  %i = alloca i64, align 8
...
entry:
  %new.addr = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 798226118, i32* %canary
  %cost.addr = alloca i64, align 8
  %red_cost.addr = alloca i64, align 8
  %head.addr = alloca %struct.node*, align 8
  %pos = alloca i64, align 8
...
entry:
  ...
  %tail.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1933326018, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %pos = alloca i64, align 8
  %cost.addr = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 1853343398, i32* %canary
  %red_cost.addr = alloca i64, align 8
  %cost.addr = alloca i64, align 8
  %tail.addr = alloca %struct.node*, align 8
  %new.addr = alloca %struct.arc*, align 8
...
entry:
  ...
  %red_cost.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 142000935, i32* %canary
  %pos = alloca i64, align 8
  %tail.addr = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store %struct.arc* %new, %struct.arc** %new.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @resize_prob.18(%struct.network* %net) #0 {
entry:
  %root = alloca %struct.node*, align 8
  %off = alloca i64, align 8
  %stop = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1768164552, i32* %canary
  %retval = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
  %node = alloca %struct.node*, align 8
...
entry:
  ...
  %new_arcs = alloca i64, align 8
  %canary = alloca i32
  store i32 1448725656, i32* %canary
  %head_potential = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 0, i64* %new_arcs, align 8
  store i64 0, i64* %resized, align 8
...
return:                                           ; preds = %if.end109, %if.then10
  %143 = load i64, i64* %retval, align 8
  %144 = load i32, i32* %canary
  %145 = icmp eq i32 %144, 1448725656
  br i1 %145, label %146, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @resize_prob.20(%struct.network* %net) #0 {
entry:
  %root = alloca %struct.node*, align 8
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1272319483, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
  %stop = alloca %struct.node*, align 8
  %off = alloca i64, align 8
...
entry:
  ...
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1773568034, i32* %canary
  %off = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
  %stop = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
...
entry:
  ...
  %cmp = alloca i64, align 8
  %canary = alloca i32
  store i32 1507643784, i32* %canary
  %tail.addr = alloca %struct.node*, align 8
  %pos = alloca i64, align 8
  %head.addr = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @resize_prob.24(%struct.network* %net) #0 {
entry:
  %net.addr = alloca %struct.network*, align 8
  %off = alloca i64, align 8
  %canary = alloca i32
  store i32 145797292, i32* %canary
  %stop = alloca %struct.node*, align 8
  %arc = alloca %struct.arc*, align 8
  %node = alloca %struct.node*, align 8
  %root = alloca %struct.node*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @resize_prob.25(%struct.network* %net) #0 {
entry:
  %net.addr = alloca %struct.network*, align 8
  %root = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 364091210, i32* %canary
  %stop = alloca %struct.node*, align 8
  %off = alloca i64, align 8
  %node = alloca %struct.node*, align 8
  %arc = alloca %struct.arc*, align 8
...
entry:
  ...
  %off = alloca i64, align 8
  %canary = alloca i32
  store i32 784298405, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
  %max_new_m = getelementptr inbounds %struct.network, %struct.network* %0, i32 0, i32 9
...
entry:
  %red_cost.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1661876112, i32* %canary
  %newpos.addr = alloca i64, align 8
  %cost.addr = alloca i64, align 8
  %head.addr = alloca %struct.node*, align 8
  %tail.addr = alloca %struct.node*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @suspend_impl.28(%struct.network* %net, i64 %threshold, i64 %all) #0 {
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 430619585, i32* %canary
  %arc = alloca %struct.arc*, align 8
...
entry:
  ...
  %all.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1888846493, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %susp = alloca i64, align 8
  %threshold.addr = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
...
entry:
  ...
  %newpos.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1320118339, i32* %canary
  %head.addr = alloca %struct.node*, align 8
  %cost.addr = alloca i64, align 8
  %pos = alloca i64, align 8
  store %struct.arc* %new, %struct.arc** %new.addr, align 8
...
entry:
  ...
  %newpos.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 721741450, i32* %canary
  %cost.addr = alloca i64, align 8
  %pos = alloca i64, align 8
  %head.addr = alloca %struct.node*, align 8
  %red_cost.addr = alloca i64, align 8
...
entry:
  %newpos.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 965736931, i32* %canary
  %red_cost.addr = alloca i64, align 8
  %tail.addr = alloca %struct.node*, align 8
  %pos = alloca i64, align 8
  %cost.addr = alloca i64, align 8
...
entry:
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 152322437, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %threshold.addr = alloca i64, align 8
  %red_cost = alloca i64, align 8
  %all.addr = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @price_out_impl.34(%struct.network* %net) #0 {
entry:
  %min_impl_duration = alloca i64, align 8
  %bigM_minus_min_impl_duration = alloca i64, align 8
  %i = alloca i64, align 8
  ...
  %first_of_sparse_list = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 924557043, i32* %canary
  %resized = alloca i64, align 8
  %arcin = alloca %struct.arc*, align 8
  %arcout = alloca %struct.arc*, align 8
  %red_cost = alloca i64, align 8
...
entry:
  ...
  %stop = alloca i8*, align 8
  %canary = alloca i32
  store i32 1230841951, i32* %canary
  %threshold.addr = alloca i64, align 8
  %new_arc = alloca %struct.arc*, align 8
  %susp = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  ...
  %arc_cost = alloca i64, align 8
  %canary = alloca i32
  store i32 584423864, i32* %canary
  %min_impl_duration = alloca i64, align 8
  %head_potential = alloca i64, align 8
  %trips = alloca i64, align 8
  %resized = alloca i64, align 8
...
entry:
  ...
  %threshold.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1266835171, i32* %canary
  %new_arc = alloca %struct.arc*, align 8
  %stop = alloca i8*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 %threshold, i64* %threshold.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1197457489, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %red_cost = alloca i64, align 8
  %threshold.addr = alloca i64, align 8
  %all.addr = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @suspend_impl.39(%struct.network* %net, i64 %threshold, i64 %all) #0 {
entry:
  %red_cost = alloca i64, align 8
  %all.addr = alloca i64, align 8
  %threshold.addr = alloca i64, align 8
  ...
  %susp = alloca i64, align 8
  %canary = alloca i32
  store i32 1050570930, i32* %canary
  %stop = alloca i8*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 %threshold, i64* %threshold.addr, align 8
  store i64 %all, i64* %all.addr, align 8
...
entry:
  ...
  %threshold.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 125394363, i32* %canary
  %new_arc = alloca %struct.arc*, align 8
  %red_cost = alloca i64, align 8
  %stop = alloca i8*, align 8
  %net.addr = alloca %struct.network*, align 8
