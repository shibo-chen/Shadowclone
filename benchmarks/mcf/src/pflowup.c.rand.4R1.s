...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1018631685, -20(%rbp)  # imm = 0x3CB71605
	movq	%rdi, -8(%rbp)
	movq	%rsi, -16(%rbp)
	movq	%rdx, -32(%rbp)
.LBB1_1:                                # %for.cond
...
.LBB1_13:                               # %for.inc12
	...
	jmp	.LBB1_8
.LBB1_14:                               # %for.end14
	cmpl	$1018631685, -20(%rbp)  # imm = 0x3CB71605
	jne	.LBB1_16
.LBB1_15:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$2119462097, -20(%rbp)  # imm = 0x7E546CD1
	movq	%rdi, -8(%rbp)
	movq	%rsi, -16(%rbp)
	movq	%rdx, -32(%rbp)
.LBB2_1:                                # %for.cond
...
.LBB2_13:                               # %for.inc12
	...
	jmp	.LBB2_8
.LBB2_14:                               # %for.end14
	cmpl	$2119462097, -20(%rbp)  # imm = 0x7E546CD1
	jne	.LBB2_16
.LBB2_15:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1817050815, -20(%rbp)  # imm = 0x6C4DFEBF
	movq	%rdi, -16(%rbp)
	movq	%rsi, -8(%rbp)
	movq	%rdx, -32(%rbp)
.LBB3_1:                                # %for.cond
...
.LBB3_13:                               # %for.inc12
	...
	jmp	.LBB3_8
.LBB3_14:                               # %for.end14
	cmpl	$1817050815, -20(%rbp)  # imm = 0x6C4DFEBF
	jne	.LBB3_16
.LBB3_15:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$571619026, -20(%rbp)   # imm = 0x221236D2
	movq	%rdi, -8(%rbp)
	movq	%rsi, -16(%rbp)
	movq	%rdx, -32(%rbp)
.LBB4_1:                                # %for.cond
...
.LBB4_13:                               # %for.inc12
	...
	jmp	.LBB4_8
.LBB4_14:                               # %for.end14
	cmpl	$571619026, -20(%rbp)   # imm = 0x221236D2
	jne	.LBB4_16
.LBB4_15:
	addq	$32, %rsp
	popq	%rbp
