; ModuleID = 'pbeampp.c.rand.4P3.bc'
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_bea_is_dual_infeasible.7, label %func_bea_is_dual_infeasible.10

func_bea_is_dual_infeasible.7:                    ; preds = %rand_bb
  %2 = call i32 @bea_is_dual_infeasible.7(%struct.arc* %arc, i64 %red_cost)
  ret i32 %2

func_bea_is_dual_infeasible.10:                   ; preds = %rand_bb
  %3 = call i32 @bea_is_dual_infeasible.10(%struct.arc* %arc, i64 %red_cost)
  ret i32 %3
}
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_sort_basket.6, label %func_sort_basket.8
}
...
func_primal_bea_mpp.4:                            ; preds = %ctrl1
  %4 = call %struct.arc* @primal_bea_mpp.4(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea)
  ret %struct.arc* %4
...
ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_primal_bea_mpp.4, label %func_primal_bea_mpp.9
}
...
entry:
  ...
  %canary = alloca i32
  store i32 877065740, i32* %canary
...
entry:
  ...
  %m.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 933516555, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %red_cost_of_bea.addr = alloca i64*, align 8
  %retval = alloca %struct.arc*, align 8
  %arcs.addr = alloca %struct.arc*, align 8
...
entry:
  ...
  %canary = alloca i32
  store i32 513795862, i32* %canary
...
entry:
  ...
  %next = alloca i64, align 8
  %canary = alloca i32
  store i32 1930370411, i32* %canary
  %old_group_pos = alloca i64, align 8
  %arcs.addr = alloca %struct.arc*, align 8
  %retval = alloca %struct.arc*, align 8
  %stop_arcs.addr = alloca %struct.arc*, align 8
...
entry:
  ...
  %min.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 886879385, i32* %canary
  %max.addr = alloca i64, align 8
  store i64 %min, i64* %min.addr, align 8
  store i64 %max, i64* %max.addr, align 8
  %0 = load i64, i64* %min.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1220139210, i32* %canary
  %min.addr = alloca i64, align 8
  %max.addr = alloca i64, align 8
  %r = alloca i64, align 8
  %xchange = alloca %struct.basket*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @bea_is_dual_infeasible.7(%struct.arc* %arc, i64 %red_cost) #0 {
entry:
  %arc.addr = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1205765804, i32* %canary
...
entry:
  ...
  %min.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1736081414, i32* %canary
  %r = alloca i64, align 8
  %xchange = alloca %struct.basket*, align 8
  store i64 %min, i64* %min.addr, align 8
  store i64 %max, i64* %max.addr, align 8
...
entry:
  ...
  %arcs.addr = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1539362670, i32* %canary
  %i = alloca i64, align 8
  %red_cost = alloca i64, align 8
  store i64 %m, i64* %m.addr, align 8
  store %struct.arc* %arcs, %struct.arc** %arcs.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @bea_is_dual_infeasible.10(%struct.arc* %arc, i64 %red_cost) #0 {
entry:
  %canary = alloca i32
  store i32 1299583068, i32* %canary
  %red_cost.addr = alloca i64, align 8
  %arc.addr = alloca %struct.arc*, align 8
  store %struct.arc* %arc, %struct.arc** %arc.addr, align 8
  store i64 %red_cost, i64* %red_cost.addr, align 8
