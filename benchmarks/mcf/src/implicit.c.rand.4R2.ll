; ModuleID = 'implicit.c.rand.4R2.bc'
...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_resize_prob.10, label %ctrl0

func_resize_prob.10:                              ; preds = %rand_bb
  %2 = call i64 @resize_prob.10(%struct.network* %net)
  ret i64 %2

func_resize_prob.13:                              ; preds = %ctrl0
  %3 = call i64 @resize_prob.13(%struct.network* %net)
  ret i64 %3

func_resize_prob.15:                              ; preds = %ctrl1
  %4 = call i64 @resize_prob.15(%struct.network* %net)
  ret i64 %4
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_resize_prob.13, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_resize_prob.15, label %func_resize_prob.16
}
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_insert_new_arc.17, label %func_insert_new_arc.19
}
...
func_replace_weaker_arc.6:                        ; preds = %ctrl1
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_replace_weaker_arc.6, label %func_replace_weaker_arc.9
}
...
func_price_out_impl.2:                            ; preds = %ctrl0
  %3 = call i64 @price_out_impl.2(%struct.network* %net)
  ret i64 %3
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_price_out_impl.2, label %ctrl1
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_suspend_impl.11, label %ctrl1
...
entry:
  ...
  %canary = alloca i32
  store i32 1648727416, i32* %canary
...
return:                                           ; preds = %if.end109, %if.then10
  ...
  %145 = icmp eq i32 %144, 1648727416
...
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 1232603082, i32* %canary
  %i = alloca i64, align 8
  %stop = alloca %struct.arc*, align 8
  %latest = alloca i64, align 8
  %retval = alloca i64, align 8
...
return:                                           ; preds = %if.end109, %if.then10
  %143 = load i64, i64* %retval, align 8
  %144 = load i32, i32* %canary
  %145 = icmp eq i32 %144, 1232603082
  br i1 %145, label %146, label %func_exit
...
entry:
  %canary = alloca i32
  store i32 542341660, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1125966749, i32* %canary
  %pos = alloca i64, align 8
  %cost.addr = alloca i64, align 8
  %cmp = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
...
entry:
  ...
  %cmp = alloca i64, align 8
  %canary = alloca i32
  store i32 1388519219, i32* %canary
  %tail.addr = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store %struct.arc* %new, %struct.arc** %new.addr, align 8
  store %struct.node* %tail, %struct.node** %tail.addr, align 8
...
entry:
  ...
  %new.addr = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 471234381, i32* %canary
...
entry:
  ...
  %tail.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 2060533603, i32* %canary
  %pos = alloca i64, align 8
  %head.addr = alloca %struct.node*, align 8
  %cost.addr = alloca i64, align 8
  %newpos.addr = alloca i64, align 8
...
entry:
  ...
  %cost.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 677920766, i32* %canary
  %cmp = alloca i64, align 8
  %pos = alloca i64, align 8
  %head.addr = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
...
entry:
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1003234409, i32* %canary
...
entry:
  ...
  %susp = alloca i64, align 8
  %canary = alloca i32
  store i32 1801119108, i32* %canary
  %new_arc = alloca %struct.arc*, align 8
  %threshold.addr = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 %threshold, i64* %threshold.addr, align 8
...
entry:
  ...
  %arcnew = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1849960960, i32* %canary
  %trips = alloca i64, align 8
  %tail = alloca %struct.node*, align 8
  %arcin = alloca %struct.arc*, align 8
  %arcout = alloca %struct.arc*, align 8
...
return:                                           ; preds = %if.end109, %if.then10
  %143 = load i64, i64* %retval, align 8
  %144 = load i32, i32* %canary
  %145 = icmp eq i32 %144, 1849960960
  br i1 %145, label %146, label %func_exit
...
entry:
  ...
  %retval = alloca i64, align 8
  %canary = alloca i32
  store i32 880395539, i32* %canary
  %node = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
  %off = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
...
entry:
  ...
  %arcnew = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1430758534, i32* %canary
  %arc_cost = alloca i64, align 8
  %red_cost = alloca i64, align 8
  %min_impl_duration = alloca i64, align 8
  %new_arcs = alloca i64, align 8
...
return:                                           ; preds = %if.end109, %if.then10
  %143 = load i64, i64* %retval, align 8
  %144 = load i32, i32* %canary
  %145 = icmp eq i32 %144, 1430758534
  br i1 %145, label %146, label %func_exit
...
entry:
  ...
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 820976842, i32* %canary
  %off = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
  %stop = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
...
entry:
  ...
  %retval = alloca i64, align 8
  %canary = alloca i32
  store i32 1604534712, i32* %canary
  %stop = alloca %struct.node*, align 8
  %node = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  %pos = alloca i64, align 8
  %canary = alloca i32
  store i32 634425818, i32* %canary
  %new.addr = alloca %struct.arc*, align 8
  %head.addr = alloca %struct.node*, align 8
  %cost.addr = alloca i64, align 8
  %newpos.addr = alloca i64, align 8
...
entry:
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 931734197, i32* %canary
  %all.addr = alloca i64, align 8
  %susp = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 %threshold, i64* %threshold.addr, align 8
...
entry:
  ...
  %cost.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 938276982, i32* %canary
  %newpos.addr = alloca i64, align 8
  store %struct.arc* %new, %struct.arc** %new.addr, align 8
  store i64 %newpos, i64* %newpos.addr, align 8
  store %struct.node* %tail, %struct.node** %tail.addr, align 8
...
entry:
  ...
  %new_arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1221762017, i32* %canary
  %stop = alloca i8*, align 8
  %net.addr = alloca %struct.network*, align 8
  %threshold.addr = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
