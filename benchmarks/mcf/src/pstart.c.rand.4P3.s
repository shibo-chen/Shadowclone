...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$48, %rsp
	movl	$1305911904, -44(%rbp)  # imm = 0x4DD6A260
	movq	%rdi, -32(%rbp)
	movq	-32(%rbp), %rax
	movq	552(%rax), %rax
	movq	%rax, -8(%rbp)
...
.LBB1_10:                               # %for.end21
	...
	movq	-16(%rbp), %rax
	movq	$0, 40(%rax)
	cmpl	$1305911904, -44(%rbp)  # imm = 0x4DD6A260
	jne	.LBB1_12
.LBB1_11:
	xorl	%eax, %eax
	addq	$48, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$48, %rsp
	movl	$1920782207, -44(%rbp)  # imm = 0x727CCF7F
	movq	%rdi, -32(%rbp)
	movq	-32(%rbp), %rax
	movq	552(%rax), %rax
	movq	%rax, -8(%rbp)
...
.LBB2_10:                               # %for.end21
	...
	movq	-16(%rbp), %rax
	movq	$0, 40(%rax)
	cmpl	$1920782207, -44(%rbp)  # imm = 0x727CCF7F
	jne	.LBB2_12
.LBB2_11:
	xorl	%eax, %eax
	addq	$48, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$48, %rsp
	movl	$1817452477, -44(%rbp)  # imm = 0x6C541FBD
	movq	%rdi, -32(%rbp)
	movq	-32(%rbp), %rax
	movq	552(%rax), %rax
	movq	%rax, -8(%rbp)
...
.LBB3_10:                               # %for.end21
	...
	movq	-16(%rbp), %rax
	movq	$0, 40(%rax)
	cmpl	$1817452477, -44(%rbp)  # imm = 0x6C541FBD
	jne	.LBB3_12
.LBB3_11:
	xorl	%eax, %eax
	addq	$48, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$48, %rsp
	movl	$177987096, -44(%rbp)   # imm = 0xA9BDE18
	movq	%rdi, -32(%rbp)
	movq	-32(%rbp), %rax
	movq	552(%rax), %rax
	movq	%rax, -8(%rbp)
...
.LBB4_10:                               # %for.end21
	...
	movq	-16(%rbp), %rax
	movq	$0, 40(%rax)
	cmpl	$177987096, -44(%rbp)   # imm = 0xA9BDE18
	jne	.LBB4_12
.LBB4_11:
	xorl	%eax, %eax
	addq	$48, %rsp
