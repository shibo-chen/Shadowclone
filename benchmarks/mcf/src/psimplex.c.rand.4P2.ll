; ModuleID = 'psimplex.c.rand.4P2.bc'
...
func_primal_net_simplex.4:                        ; preds = %ctrl1
  %5 = call i64 @primal_net_simplex.4(%struct.network* %net)
  ret i64 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_primal_net_simplex.2, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_primal_net_simplex.3, label %func_primal_net_simplex.4
}
...
entry:
  ...
  %canary = alloca i32
  store i32 1412641312, i32* %canary
...
entry:
  ...
  %arcs = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 620097041, i32* %canary
  %jminus = alloca %struct.node*, align 8
  %iterations = alloca i64*, align 8
  %iplus = alloca %struct.node*, align 8
  %temp = alloca %struct.node*, align 8
...
entry:
  ...
  %bea = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1085868362, i32* %canary
  %opt = alloca i64, align 8
  %iterations = alloca i64*, align 8
  %bla = alloca %struct.arc*, align 8
  %arcs = alloca %struct.arc*, align 8
...
entry:
  ...
  %iminus = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 2134916548, i32* %canary
  %delta = alloca i64, align 8
  %w = alloca %struct.node*, align 8
  %bla = alloca %struct.arc*, align 8
  %jminus = alloca %struct.node*, align 8
