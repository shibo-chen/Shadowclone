; ModuleID = 'mcfutil.c.rand.4R2.bc'
...
func_refresh_neighbour_lists.17:                  ; preds = %ctrl1
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_refresh_neighbour_lists.17, label %func_refresh_neighbour_lists.19
}
...
ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_refresh_potential.8, label %func_refresh_potential.20
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_flow_cost.3, label %ctrl0

func_flow_cost.3:                                 ; preds = %rand_bb
  %2 = call double @flow_cost.3(%struct.network* %net)
  ret double %2
...
func_flow_cost.22:                                ; preds = %ctrl1
  %4 = call double @flow_cost.22(%struct.network* %net)
  ret double %4
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_flow_cost.12, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_flow_cost.22, label %func_flow_cost.24
}
...
func_flow_org_cost.18:                            ; preds = %ctrl1
  %5 = call double @flow_org_cost.18(%struct.network* %net)
  ret double %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_flow_org_cost.10, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_flow_org_cost.14, label %func_flow_org_cost.18
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_primal_feasible.2, label %ctrl0

func_primal_feasible.2:                           ; preds = %rand_bb
  %2 = call i64 @primal_feasible.2(%struct.network* %net)
  ret i64 %2
...
func_primal_feasible.9:                           ; preds = %ctrl1
  %5 = call i64 @primal_feasible.9(%struct.network* %net)
  ret i64 %5
...
ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_primal_feasible.6, label %func_primal_feasible.9
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_dual_feasible.13, label %ctrl0

func_dual_feasible.13:                            ; preds = %rand_bb
  %2 = call i64 @dual_feasible.13(%struct.network* %net)
  ret i64 %2

func_dual_feasible.16:                            ; preds = %ctrl0
  %3 = call i64 @dual_feasible.16(%struct.network* %net)
  ret i64 %3

func_dual_feasible.21:                            ; preds = %ctrl1
  %4 = call i64 @dual_feasible.21(%struct.network* %net)
  ret i64 %4

func_dual_feasible.23:                            ; preds = %ctrl1
  %5 = call i64 @dual_feasible.23(%struct.network* %net)
  ret i64 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_dual_feasible.16, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_dual_feasible.21, label %func_dual_feasible.23
}
...
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 1508968507, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 697419635, i32* %canary
  %net.addr = alloca %struct.network*, align 8
...
entry:
  ...
  %stop = alloca i8*, align 8
  %canary = alloca i32
  store i32 869687522, i32* %canary
...
entry:
  ...
  %tmp = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 2134700346, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %node = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
...
entry:
  ...
  %dummy = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 866161747, i32* %canary
  %retval = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
  %flow = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  ...
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1919216173, i32* %canary
  %arc = alloca %struct.arc*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
  %dummy_arcs = getelementptr inbounds %struct.network, %struct.network* %0, i32 0, i32 25
...
entry:
  ...
  %tmp = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 2082873216, i32* %canary
  %root = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
  %nodes = getelementptr inbounds %struct.network, %struct.network* %0, i32 0, i32 21
...
entry:
  ...
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 841032565, i32* %canary
  %operational_cost = alloca i64, align 8
  %stop = alloca i8*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 0, i64* %fleet, align 8
...
entry:
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 2032315919, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
  %stop = alloca i8*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 387127014, i32* %canary
  %stop = alloca i8*, align 8
  %operational_cost = alloca i64, align 8
  %node = alloca %struct.node*, align 8
  %fleet = alloca i64, align 8
...
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 281053987, i32* %canary
...
entry:
  %stop = alloca i8*, align 8
  %canary = alloca i32
  store i32 1669719668, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %fleet = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
  %operational_cost = alloca i64, align 8
...
entry:
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 315187880, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %stop = alloca i8*, align 8
  %node = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  %stop = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 971273615, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
  %red_cost = alloca i64, align 8
  %retval = alloca i64, align 8
...
entry:
  ...
  %stop = alloca i8*, align 8
  %canary = alloca i32
  store i32 1835410769, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
  %nodes = getelementptr inbounds %struct.network, %struct.network* %0, i32 0, i32 21
...
entry:
  ...
  %stop = alloca i8*, align 8
  %canary = alloca i32
  store i32 1617735129, i32* %canary
  %node = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
  %nodes = getelementptr inbounds %struct.network, %struct.network* %0, i32 0, i32 21
...
entry:
  ...
  %red_cost = alloca i64, align 8
  %canary = alloca i32
  store i32 806836722, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
...
entry:
  ...
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 264151447, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 0, i64* %fleet, align 8
  store i64 0, i64* %operational_cost, align 8
...
entry:
  ...
  %stop = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 2013711693, i32* %canary
  %arc = alloca %struct.arc*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
  %stop_arcs = getelementptr inbounds %struct.network, %struct.network* %0, i32 0, i32 24
...
entry:
  ...
  %fleet = alloca i64, align 8
  %canary = alloca i32
  store i32 428393779, i32* %canary
  %node = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 0, i64* %fleet, align 8
  store i64 0, i64* %operational_cost, align 8
