; ModuleID = 'pbeampp.c.rand.16R1.bc'
...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_bea_is_dual_infeasible.2, label %func_bea_is_dual_infeasible.4

func_bea_is_dual_infeasible.2:                    ; preds = %rand_bb
  %2 = call i32 @bea_is_dual_infeasible.2(%struct.arc* %arc, i64 %red_cost)
  ret i32 %2

func_bea_is_dual_infeasible.4:                    ; preds = %rand_bb
  %3 = call i32 @bea_is_dual_infeasible.4(%struct.arc* %arc, i64 %red_cost)
  ret i32 %3
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_sort_basket.3, label %ctrl0

func_sort_basket.3:                               ; preds = %rand_bb
  call void @sort_basket.3(i64 %min, i64 %max)
  ret void

func_sort_basket.5:                               ; preds = %ctrl0
  call void @sort_basket.5(i64 %min, i64 %max)
  ret void

func_sort_basket.7:                               ; preds = %ctrl1
  call void @sort_basket.7(i64 %min, i64 %max)
  ret void

func_sort_basket.8:                               ; preds = %ctrl2
...
func_sort_basket.19:                              ; preds = %ctrl6
...
func_sort_basket.23:                              ; preds = %ctrl8
...
func_sort_basket.27:                              ; preds = %ctrl10
  call void @sort_basket.27(i64 %min, i64 %max)
  ret void

func_sort_basket.28:                              ; preds = %ctrl11
  call void @sort_basket.28(i64 %min, i64 %max)
  ret void

func_sort_basket.29:                              ; preds = %ctrl12
  call void @sort_basket.29(i64 %min, i64 %max)
  ret void

func_sort_basket.30:                              ; preds = %ctrl13
  call void @sort_basket.30(i64 %min, i64 %max)
  ret void

func_sort_basket.31:                              ; preds = %ctrl13
  call void @sort_basket.31(i64 %min, i64 %max)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_sort_basket.5, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_sort_basket.7, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_sort_basket.8, label %ctrl3
...
ctrl6:                                            ; preds = %ctrl5
  %8 = icmp eq i32 %0, 7
  br i1 %8, label %func_sort_basket.19, label %ctrl7
...
ctrl8:                                            ; preds = %ctrl7
  %10 = icmp eq i32 %0, 9
  br i1 %10, label %func_sort_basket.23, label %ctrl9
...
ctrl10:                                           ; preds = %ctrl9
  %12 = icmp eq i32 %0, 11
  br i1 %12, label %func_sort_basket.27, label %ctrl11

ctrl11:                                           ; preds = %ctrl10
  %13 = icmp eq i32 %0, 12
  br i1 %13, label %func_sort_basket.28, label %ctrl12

ctrl12:                                           ; preds = %ctrl11
  %14 = icmp eq i32 %0, 13
  br i1 %14, label %func_sort_basket.29, label %ctrl13

ctrl13:                                           ; preds = %ctrl12
  %15 = icmp eq i32 %0, 14
  br i1 %15, label %func_sort_basket.30, label %func_sort_basket.31
}
...
func_primal_bea_mpp.6:                            ; preds = %ctrl0
  %3 = call %struct.arc* @primal_bea_mpp.6(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea)
  ret %struct.arc* %3
...
func_primal_bea_mpp.18:                           ; preds = %ctrl7
  %10 = call %struct.arc* @primal_bea_mpp.18(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea)
  ret %struct.arc* %10
...
ctrl0:                                            ; preds = %rand_bb
  %18 = icmp eq i32 %0, 1
  br i1 %18, label %func_primal_bea_mpp.6, label %ctrl1
...
ctrl3:                                            ; preds = %ctrl2
  %21 = icmp eq i32 %0, 4
  br i1 %21, label %func_primal_bea_mpp.13, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %22 = icmp eq i32 %0, 5
  br i1 %22, label %func_primal_bea_mpp.14, label %ctrl5
...
ctrl7:                                            ; preds = %ctrl6
  %25 = icmp eq i32 %0, 8
  br i1 %25, label %func_primal_bea_mpp.18, label %ctrl8
...
entry:
  ...
  %canary = alloca i32
  store i32 209644861, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 2016537618, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 943754703, i32* %canary
...
entry:
  %red_cost.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 692395177, i32* %canary
  %arc.addr = alloca %struct.arc*, align 8
  store %struct.arc* %arc, %struct.arc** %arc.addr, align 8
  store i64 %red_cost, i64* %red_cost.addr, align 8
  %0 = load i64, i64* %red_cost.addr, align 8
...
entry:
  %xchange = alloca %struct.basket*, align 8
  %canary = alloca i32
  store i32 1087491043, i32* %canary
  %max.addr = alloca i64, align 8
  %cut = alloca i64, align 8
  %min.addr = alloca i64, align 8
  %r = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct.arc* @primal_bea_mpp.6(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea) #0 {
entry:
  %canary = alloca i32
  store i32 1088787707, i32* %canary
  %red_cost = alloca i64, align 8
  %i = alloca i64, align 8
  %arcs.addr = alloca %struct.arc*, align 8
  %m.addr = alloca i64, align 8
...
entry:
  %xchange = alloca %struct.basket*, align 8
  %canary = alloca i32
  store i32 693114557, i32* %canary
  %min.addr = alloca i64, align 8
  %max.addr = alloca i64, align 8
  %l = alloca i64, align 8
  %cut = alloca i64, align 8
...
entry:
  %canary = alloca i32
  store i32 1603558099, i32* %canary
  %max.addr = alloca i64, align 8
  %xchange = alloca %struct.basket*, align 8
  %r = alloca i64, align 8
  %l = alloca i64, align 8
...
entry:
  ...
  %red_cost_of_bea.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 1949521979, i32* %canary
  %arcs.addr = alloca %struct.arc*, align 8
  store i64 %m, i64* %m.addr, align 8
  store %struct.arc* %arcs, %struct.arc** %arcs.addr, align 8
  store %struct.arc* %stop_arcs, %struct.arc** %stop_arcs.addr, align 8
...
entry:
  ...
  %next = alloca i64, align 8
  %canary = alloca i32
  store i32 1188590230, i32* %canary
  %red_cost_of_bea.addr = alloca i64*, align 8
  %i = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
  %arcs.addr = alloca %struct.arc*, align 8
...
entry:
  ...
  %min.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1250035875, i32* %canary
  %max.addr = alloca i64, align 8
  store i64 %min, i64* %min.addr, align 8
  store i64 %max, i64* %max.addr, align 8
  %0 = load i64, i64* %min.addr, align 8
...
entry:
  ...
  %xchange = alloca %struct.basket*, align 8
  %canary = alloca i32
  store i32 1227256516, i32* %canary
  %min.addr = alloca i64, align 8
  %r = alloca i64, align 8
  %l = alloca i64, align 8
  store i64 %min, i64* %min.addr, align 8
...
entry:
  ...
  %m.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 634945060, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %red_cost = alloca i64, align 8
  %red_cost_of_bea.addr = alloca i64*, align 8
  %arcs.addr = alloca %struct.arc*, align 8
...
entry:
  ...
  %retval = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1803107949, i32* %canary
  %m.addr = alloca i64, align 8
  %old_group_pos = alloca i64, align 8
  store i64 %m, i64* %m.addr, align 8
  store %struct.arc* %arcs, %struct.arc** %arcs.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1028857248, i32* %canary
  %l = alloca i64, align 8
  %min.addr = alloca i64, align 8
  %r = alloca i64, align 8
  %xchange = alloca %struct.basket*, align 8
...
entry:
  ...
  %next = alloca i64, align 8
  %canary = alloca i32
  store i32 2088777461, i32* %canary
  %m.addr = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
  %i = alloca i64, align 8
  %red_cost_of_bea.addr = alloca i64*, align 8
...
entry:
  %canary = alloca i32
  store i32 619588479, i32* %canary
  %arcs.addr = alloca %struct.arc*, align 8
  %old_group_pos = alloca i64, align 8
  %i = alloca i64, align 8
  %red_cost_of_bea.addr = alloca i64*, align 8
...
entry:
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 988653319, i32* %canary
  %m.addr = alloca i64, align 8
  %red_cost = alloca i64, align 8
  %red_cost_of_bea.addr = alloca i64*, align 8
  %next = alloca i64, align 8
...
entry:
  ...
  %min.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1014090574, i32* %canary
  %cut = alloca i64, align 8
  store i64 %min, i64* %min.addr, align 8
  store i64 %max, i64* %max.addr, align 8
  %0 = load i64, i64* %min.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1500972166, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %next = alloca i64, align 8
  %m.addr = alloca i64, align 8
  %red_cost = alloca i64, align 8
...
entry:
  ...
  %l = alloca i64, align 8
  %canary = alloca i32
  store i32 1390618575, i32* %canary
  %r = alloca i64, align 8
  store i64 %min, i64* %min.addr, align 8
  store i64 %max, i64* %max.addr, align 8
  %0 = load i64, i64* %min.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 850721118, i32* %canary
  %cut = alloca i64, align 8
  %l = alloca i64, align 8
  %max.addr = alloca i64, align 8
  %min.addr = alloca i64, align 8
...
entry:
  ...
  %r = alloca i64, align 8
  %canary = alloca i32
  store i32 1421860149, i32* %canary
  %xchange = alloca %struct.basket*, align 8
  %l = alloca i64, align 8
  %cut = alloca i64, align 8
  %max.addr = alloca i64, align 8
...
entry:
  ...
  %retval = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1075326335, i32* %canary
  %red_cost_of_bea.addr = alloca i64*, align 8
  %i = alloca i64, align 8
  %stop_arcs.addr = alloca %struct.arc*, align 8
  %old_group_pos = alloca i64, align 8
...
entry:
  ...
  %stop_arcs.addr = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1715017262, i32* %canary
  %red_cost_of_bea.addr = alloca i64*, align 8
  %i = alloca i64, align 8
  %m.addr = alloca i64, align 8
  %retval = alloca %struct.arc*, align 8
...
entry:
  %l = alloca i64, align 8
  %canary = alloca i32
  store i32 1399699181, i32* %canary
  %max.addr = alloca i64, align 8
  %r = alloca i64, align 8
  %cut = alloca i64, align 8
  %xchange = alloca %struct.basket*, align 8
...
entry:
  %canary = alloca i32
  store i32 361649093, i32* %canary
  %r = alloca i64, align 8
  %max.addr = alloca i64, align 8
  %min.addr = alloca i64, align 8
  %cut = alloca i64, align 8
...
entry:
  ...
  %max.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1536500634, i32* %canary
  %r = alloca i64, align 8
  %l = alloca i64, align 8
  %min.addr = alloca i64, align 8
  %xchange = alloca %struct.basket*, align 8
...
entry:
  ...
  %min.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1273878778, i32* %canary
  %r = alloca i64, align 8
  %xchange = alloca %struct.basket*, align 8
  %l = alloca i64, align 8
  store i64 %min, i64* %min.addr, align 8
...
entry:
  ...
  %max.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 558068680, i32* %canary
  %min.addr = alloca i64, align 8
  store i64 %min, i64* %min.addr, align 8
  store i64 %max, i64* %max.addr, align 8
  %0 = load i64, i64* %min.addr, align 8
...
entry:
  ...
  %retval = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1911484264, i32* %canary
  %arcs.addr = alloca %struct.arc*, align 8
  %stop_arcs.addr = alloca %struct.arc*, align 8
  %i = alloca i64, align 8
  %red_cost_of_bea.addr = alloca i64*, align 8
...
entry:
  %m.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1085377553, i32* %canary
  %stop_arcs.addr = alloca %struct.arc*, align 8
  %next = alloca i64, align 8
  %retval = alloca %struct.arc*, align 8
  %arcs.addr = alloca %struct.arc*, align 8
...
entry:
  ...
  %arcs.addr = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1321897053, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %retval = alloca %struct.arc*, align 8
  %m.addr = alloca i64, align 8
  store i64 %m, i64* %m.addr, align 8
