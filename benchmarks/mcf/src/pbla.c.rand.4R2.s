...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$788776262, -52(%rbp)   # imm = 0x2F03C546
	movq	%rdi, -32(%rbp)
	movq	%rsi, -48(%rbp)
	movq	%rdx, -16(%rbp)
	movq	%rcx, -24(%rbp)
...
.LBB1_24:                               # %while.end
	...
	movq	%rax, (%rcx)
	movq	-40(%rbp), %rbx
	cmpl	$788776262, -52(%rbp)   # imm = 0x2F03C546
	jne	.LBB1_26
.LBB1_25:
	movq	%rbx, %rax
	addq	$56, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$1730353453, -52(%rbp)  # imm = 0x6723192D
	movq	%rdi, -32(%rbp)
	movq	%rsi, -48(%rbp)
	movq	%rdx, -16(%rbp)
	movq	%rcx, -24(%rbp)
...
.LBB2_24:                               # %while.end
	...
	movq	%rax, (%rcx)
	movq	-40(%rbp), %rbx
	cmpl	$1730353453, -52(%rbp)  # imm = 0x6723192D
	jne	.LBB2_26
.LBB2_25:
	movq	%rbx, %rax
	addq	$56, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$400511319, -52(%rbp)   # imm = 0x17DF5157
	movq	%rdi, -32(%rbp)
	movq	%rsi, -48(%rbp)
	movq	%rdx, -16(%rbp)
	movq	%rcx, -24(%rbp)
...
.LBB3_24:                               # %while.end
	...
	movq	%rax, (%rcx)
	movq	-40(%rbp), %rbx
	cmpl	$400511319, -52(%rbp)   # imm = 0x17DF5157
	jne	.LBB3_26
.LBB3_25:
	movq	%rbx, %rax
	addq	$56, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$2060776595, -52(%rbp)  # imm = 0x7AD4F493
	movq	%rdi, -32(%rbp)
	movq	%rsi, -48(%rbp)
	movq	%rdx, -16(%rbp)
	movq	%rcx, -24(%rbp)
...
.LBB4_24:                               # %while.end
	...
	movq	%rax, (%rcx)
	movq	-40(%rbp), %rbx
	cmpl	$2060776595, -52(%rbp)  # imm = 0x7AD4F493
	jne	.LBB4_26
.LBB4_25:
	movq	%rbx, %rax
	addq	$56, %rsp
