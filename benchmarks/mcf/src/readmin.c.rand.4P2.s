...
# %bb.0:                                # %entry
	...
	.cfi_offset %rbx, -24
	movl	$768888879, -76(%rbp)   # imm = 0x2DD4502F
	movq	%rdi, -16(%rbp)
	movq	$0, -72(%rbp)
	movq	-16(%rbp), %rdi
	movabsq	$.L.str, %rsi
...
.LBB1_46:                               # %return
	movq	-56(%rbp), %rbx
	cmpl	$768888879, -76(%rbp)   # imm = 0x2DD4502F
	jne	.LBB1_48
.LBB1_47:
	movq	%rbx, %rax
...
# %bb.0:                                # %entry
	...
	subq	$296, %rsp              # imm = 0x128
	.cfi_offset %rbx, -24
	movl	$837003884, -76(%rbp)   # imm = 0x31E3AA6C
	movq	%rdi, -16(%rbp)
	movq	$0, -72(%rbp)
	movq	-16(%rbp), %rdi
	movabsq	$.L.str, %rsi
...
.LBB2_46:                               # %return
	movq	-56(%rbp), %rbx
	cmpl	$837003884, -76(%rbp)   # imm = 0x31E3AA6C
	jne	.LBB2_48
.LBB2_47:
	movq	%rbx, %rax
	addq	$296, %rsp              # imm = 0x128
...
# %bb.0:                                # %entry
	...
	subq	$296, %rsp              # imm = 0x128
	.cfi_offset %rbx, -24
	movl	$987069702, -76(%rbp)   # imm = 0x3AD57D06
	movq	%rdi, -16(%rbp)
	movq	$0, -72(%rbp)
	movq	-16(%rbp), %rdi
	movabsq	$.L.str, %rsi
...
.LBB3_46:                               # %return
	movq	-56(%rbp), %rbx
	cmpl	$987069702, -76(%rbp)   # imm = 0x3AD57D06
	jne	.LBB3_48
.LBB3_47:
	movq	%rbx, %rax
	addq	$296, %rsp              # imm = 0x128
...
# %bb.0:                                # %entry
	...
	subq	$296, %rsp              # imm = 0x128
	.cfi_offset %rbx, -24
	movl	$1852292306, -76(%rbp)  # imm = 0x6E67BCD2
	movq	%rdi, -16(%rbp)
	movq	$0, -72(%rbp)
	movq	-16(%rbp), %rdi
	movabsq	$.L.str, %rsi
...
.LBB4_46:                               # %return
	movq	-56(%rbp), %rbx
	cmpl	$1852292306, -76(%rbp)  # imm = 0x6E67BCD2
	jne	.LBB4_48
.LBB4_47:
	movq	%rbx, %rax
	addq	$296, %rsp              # imm = 0x128
