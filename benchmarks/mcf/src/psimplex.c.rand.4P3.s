...
# %bb.0:                                # %entry
	...
	.cfi_offset %r14, -32
	.cfi_offset %r15, -24
	movl	$390305525, -92(%rbp)   # imm = 0x174396F5
	movq	%rdi, -32(%rbp)
	movq	$0, -112(%rbp)
	movq	-32(%rbp), %rax
	movq	568(%rax), %rax
...
.LBB1_30:                               # %while.end
	...
	movq	-32(%rbp), %rdi
	callq	dual_feasible
	cmpl	$390305525, -92(%rbp)   # imm = 0x174396F5
	jne	.LBB1_32
.LBB1_31:
	xorl	%eax, %eax
	addq	$232, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_offset %r14, -32
	.cfi_offset %r15, -24
	movl	$1134783074, -92(%rbp)  # imm = 0x43A36A62
	movq	%rdi, -32(%rbp)
	movq	$0, -128(%rbp)
	movq	-32(%rbp), %rax
	movq	568(%rax), %rax
...
.LBB2_30:                               # %while.end
	...
	movq	-32(%rbp), %rdi
	callq	dual_feasible
	cmpl	$1134783074, -92(%rbp)  # imm = 0x43A36A62
	jne	.LBB2_32
.LBB2_31:
	xorl	%eax, %eax
	addq	$232, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_offset %r14, -32
	.cfi_offset %r15, -24
	movl	$472692220, -92(%rbp)   # imm = 0x1C2CB5FC
	movq	%rdi, -32(%rbp)
	movq	$0, -128(%rbp)
	movq	-32(%rbp), %rax
	movq	568(%rax), %rax
...
.LBB3_30:                               # %while.end
	...
	movq	-32(%rbp), %rdi
	callq	dual_feasible
	cmpl	$472692220, -92(%rbp)   # imm = 0x1C2CB5FC
	jne	.LBB3_32
.LBB3_31:
	xorl	%eax, %eax
	addq	$232, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_offset %r14, -32
	.cfi_offset %r15, -24
	movl	$970096290, -92(%rbp)   # imm = 0x39D27EA2
	movq	%rdi, -32(%rbp)
	movq	$0, -112(%rbp)
	movq	-32(%rbp), %rax
	movq	568(%rax), %rax
...
.LBB4_30:                               # %while.end
	...
	movq	-32(%rbp), %rdi
	callq	dual_feasible
	cmpl	$970096290, -92(%rbp)   # imm = 0x39D27EA2
	jne	.LBB4_32
.LBB4_31:
	xorl	%eax, %eax
	addq	$232, %rsp
