...
entry:
  ...
  %canary = alloca i32
  store i32 1144641453, i32* %canary
...
entry:
  %block = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 926202531, i32* %canary
  %out = alloca %struct._IO_FILE*, align 8
  %arc = alloca %struct.arc*, align 8
  %first_impl = alloca %struct.arc*, align 8
  %arc2 = alloca %struct.arc*, align 8
...
entry:
  ...
  %arc2 = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1492300777, i32* %canary
  %out = alloca %struct._IO_FILE*, align 8
  %arc = alloca %struct.arc*, align 8
  %block = alloca %struct.arc*, align 8
  store i8* %outfile, i8** %outfile.addr, align 8
...
entry:
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1753937988, i32* %canary
  %outfile.addr = alloca i8*, align 8
  %first_impl = alloca %struct.arc*, align 8
  store i8* %outfile, i8** %outfile.addr, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 539459073, i32* %canary
  %arc2 = alloca %struct.arc*, align 8
  %out = alloca %struct._IO_FILE*, align 8
  store i8* %outfile, i8** %outfile.addr, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  ...
  %outfile.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 381884621, i32* %canary
  %out = alloca %struct._IO_FILE*, align 8
  %first_impl = alloca %struct.arc*, align 8
  store i8* %outfile, i8** %outfile.addr, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 1990341122, i32* %canary
  %arc2 = alloca %struct.arc*, align 8
  %block = alloca %struct.arc*, align 8
  %first_impl = alloca %struct.arc*, align 8
  %outfile.addr = alloca i8*, align 8
