; ModuleID = 'mcfutil.c.rand.8P1.bc'
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_refresh_neighbour_lists.15, label %ctrl0

func_refresh_neighbour_lists.15:                  ; preds = %rand_bb
  call void @refresh_neighbour_lists.15(%struct.network* %net)
  ret void

func_refresh_neighbour_lists.18:                  ; preds = %ctrl0
  call void @refresh_neighbour_lists.18(%struct.network* %net)
  ret void

func_refresh_neighbour_lists.19:                  ; preds = %ctrl1
  call void @refresh_neighbour_lists.19(%struct.network* %net)
  ret void

func_refresh_neighbour_lists.25:                  ; preds = %ctrl2
  call void @refresh_neighbour_lists.25(%struct.network* %net)
  ret void

func_refresh_neighbour_lists.31:                  ; preds = %ctrl3
  call void @refresh_neighbour_lists.31(%struct.network* %net)
  ret void

func_refresh_neighbour_lists.37:                  ; preds = %ctrl4
  call void @refresh_neighbour_lists.37(%struct.network* %net)
  ret void

func_refresh_neighbour_lists.40:                  ; preds = %ctrl5
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_refresh_neighbour_lists.18, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_refresh_neighbour_lists.19, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_refresh_neighbour_lists.25, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_refresh_neighbour_lists.31, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_refresh_neighbour_lists.37, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_refresh_neighbour_lists.40, label %func_refresh_neighbour_lists.43
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_refresh_potential.6, label %ctrl0

func_refresh_potential.6:                         ; preds = %rand_bb
  %2 = call i64 @refresh_potential.6(%struct.network* %net)
  ret i64 %2
...
func_refresh_potential.11:                        ; preds = %ctrl1
  %4 = call i64 @refresh_potential.11(%struct.network* %net)
  ret i64 %4

func_refresh_potential.13:                        ; preds = %ctrl2
  %5 = call i64 @refresh_potential.13(%struct.network* %net)
  ret i64 %5

func_refresh_potential.17:                        ; preds = %ctrl3
  %6 = call i64 @refresh_potential.17(%struct.network* %net)
  ret i64 %6

func_refresh_potential.26:                        ; preds = %ctrl4
  %7 = call i64 @refresh_potential.26(%struct.network* %net)
  ret i64 %7

func_refresh_potential.27:                        ; preds = %ctrl5
  %8 = call i64 @refresh_potential.27(%struct.network* %net)
  ret i64 %8

func_refresh_potential.35:                        ; preds = %ctrl5
  %9 = call i64 @refresh_potential.35(%struct.network* %net)
  ret i64 %9
...
ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_refresh_potential.11, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_refresh_potential.13, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_refresh_potential.17, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_refresh_potential.26, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_refresh_potential.27, label %func_refresh_potential.35
}
...
func_flow_cost.16:                                ; preds = %ctrl2
  %5 = call double @flow_cost.16(%struct.network* %net)
  ret double %5

func_flow_cost.23:                                ; preds = %ctrl3
  %6 = call double @flow_cost.23(%struct.network* %net)
  ret double %6

func_flow_cost.30:                                ; preds = %ctrl4
  %7 = call double @flow_cost.30(%struct.network* %net)
  ret double %7

func_flow_cost.32:                                ; preds = %ctrl5
  %8 = call double @flow_cost.32(%struct.network* %net)
  ret double %8

func_flow_cost.33:                                ; preds = %ctrl5
  %9 = call double @flow_cost.33(%struct.network* %net)
  ret double %9
...
ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_flow_cost.12, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_flow_cost.16, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_flow_cost.23, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_flow_cost.30, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_flow_cost.32, label %func_flow_cost.33
}
...
func_flow_org_cost.10:                            ; preds = %ctrl0
  %3 = call double @flow_org_cost.10(%struct.network* %net)
  ret double %3

func_flow_org_cost.14:                            ; preds = %ctrl1
  %4 = call double @flow_org_cost.14(%struct.network* %net)
  ret double %4

func_flow_org_cost.21:                            ; preds = %ctrl2
  %5 = call double @flow_org_cost.21(%struct.network* %net)
  ret double %5
...
func_flow_org_cost.36:                            ; preds = %ctrl4
  %7 = call double @flow_org_cost.36(%struct.network* %net)
  ret double %7

func_flow_org_cost.38:                            ; preds = %ctrl5
  %8 = call double @flow_org_cost.38(%struct.network* %net)
  ret double %8

func_flow_org_cost.42:                            ; preds = %ctrl5
  %9 = call double @flow_org_cost.42(%struct.network* %net)
  ret double %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_flow_org_cost.10, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_flow_org_cost.14, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_flow_org_cost.21, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_flow_org_cost.29, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_flow_org_cost.36, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_flow_org_cost.38, label %func_flow_org_cost.42
}
...
func_primal_feasible.28:                          ; preds = %ctrl0
  %3 = call i64 @primal_feasible.28(%struct.network* %net)
  ret i64 %3

func_primal_feasible.34:                          ; preds = %ctrl1
  %4 = call i64 @primal_feasible.34(%struct.network* %net)
  ret i64 %4

func_primal_feasible.44:                          ; preds = %ctrl2
  %5 = call i64 @primal_feasible.44(%struct.network* %net)
  ret i64 %5
...
ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_primal_feasible.28, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_primal_feasible.34, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_primal_feasible.44, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_primal_feasible.45, label %ctrl4
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_dual_feasible.1, label %ctrl0

func_dual_feasible.1:                             ; preds = %rand_bb
  %2 = call i64 @dual_feasible.1(%struct.network* %net)
  ret i64 %2

func_dual_feasible.2:                             ; preds = %ctrl0
  %3 = call i64 @dual_feasible.2(%struct.network* %net)
  ret i64 %3

func_dual_feasible.5:                             ; preds = %ctrl1
  %4 = call i64 @dual_feasible.5(%struct.network* %net)
  ret i64 %4

func_dual_feasible.20:                            ; preds = %ctrl2
  %5 = call i64 @dual_feasible.20(%struct.network* %net)
  ret i64 %5

func_dual_feasible.22:                            ; preds = %ctrl3
  %6 = call i64 @dual_feasible.22(%struct.network* %net)
  ret i64 %6
...
func_dual_feasible.39:                            ; preds = %ctrl5
  %8 = call i64 @dual_feasible.39(%struct.network* %net)
  ret i64 %8

func_dual_feasible.41:                            ; preds = %ctrl5
  %9 = call i64 @dual_feasible.41(%struct.network* %net)
  ret i64 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_dual_feasible.2, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_dual_feasible.5, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_dual_feasible.20, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_dual_feasible.22, label %ctrl4
...
ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_dual_feasible.39, label %func_dual_feasible.41
}
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @dual_feasible.1(%struct.network* %net) #0 {
entry:
  %stop = alloca %struct.arc*, align 8
  %red_cost = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 2023756904, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 522459029, i32* %canary
...
entry:
  ...
  %operational_cost = alloca i64, align 8
  %canary = alloca i32
  store i32 1119847791, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %fleet = alloca i64, align 8
  %stop = alloca i8*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 940678998, i32* %canary
  %red_cost = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
  %retval = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @refresh_potential.6(%struct.network* %net) #0 {
entry:
  %checksum = alloca i64, align 8
  %root = alloca %struct.node*, align 8
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 913489389, i32* %canary
...
entry:
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 486804835, i32* %canary
...
entry:
  ...
  %operational_cost = alloca i64, align 8
  %canary = alloca i32
  store i32 652726592, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %fleet = alloca i64, align 8
  %stop = alloca i8*, align 8
  %node = alloca %struct.node*, align 8
...
entry:
  ...
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1510676699, i32* %canary
  %checksum = alloca i64, align 8
  %root = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local double @flow_org_cost.10(%struct.network* %net) #0 {
entry:
  %operational_cost = alloca i64, align 8
  %canary = alloca i32
  store i32 502191634, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %node = alloca %struct.node*, align 8
  %stop = alloca i8*, align 8
  %net.addr = alloca %struct.network*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @refresh_potential.11(%struct.network* %net) #0 {
entry:
  %root = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
  %checksum = alloca i64, align 8
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 350961447, i32* %canary
  %tmp = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
  %nodes = getelementptr inbounds %struct.network, %struct.network* %0, i32 0, i32 21
...
entry:
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1936618329, i32* %canary
  %node = alloca %struct.node*, align 8
  %operational_cost = alloca i64, align 8
  %stop = alloca i8*, align 8
  %net.addr = alloca %struct.network*, align 8
...
entry:
  ...
  %root = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 2017183586, i32* %canary
  %checksum = alloca i64, align 8
  %tmp = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1065732732, i32* %canary
  %node = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
  %fleet = alloca i64, align 8
  %stop = alloca i8*, align 8
...
entry:
  %canary = alloca i32
  store i32 1634286875, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
  %node = alloca %struct.node*, align 8
  %stop = alloca i8*, align 8
...
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 1685994595, i32* %canary
  %stop = alloca i8*, align 8
  %fleet = alloca i64, align 8
  %node = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  ...
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 559720362, i32* %canary
  %checksum = alloca i64, align 8
  %root = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
...
entry:
  ...
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 539186019, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
...
entry:
  ...
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 2102728961, i32* %canary
  %stop = alloca i8*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
  %nodes = getelementptr inbounds %struct.network, %struct.network* %0, i32 0, i32 21
...
entry:
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 605183369, i32* %canary
  %retval = alloca i64, align 8
  %red_cost = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
  %stop = alloca %struct.arc*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local double @flow_org_cost.21(%struct.network* %net) #0 {
entry:
  %net.addr = alloca %struct.network*, align 8
  %stop = alloca i8*, align 8
  %canary = alloca i32
  store i32 1220818279, i32* %canary
  %fleet = alloca i64, align 8
  %node = alloca %struct.node*, align 8
  %operational_cost = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local double @flow_cost.23(%struct.network* %net) #0 {
entry:
  %fleet = alloca i64, align 8
  %operational_cost = alloca i64, align 8
  %node = alloca %struct.node*, align 8
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 221460219, i32* %canary
  %arc = alloca %struct.arc*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 0, i64* %fleet, align 8
  store i64 0, i64* %operational_cost, align 8
...
entry:
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 267825988, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %red_cost = alloca i64, align 8
  %stop = alloca %struct.arc*, align 8
  %retval = alloca i64, align 8
...
entry:
  ...
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 2120427338, i32* %canary
  %stop = alloca i8*, align 8
  %arc = alloca %struct.arc*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @refresh_potential.26(%struct.network* %net) #0 {
entry:
  %checksum = alloca i64, align 8
  %canary = alloca i32
  store i32 746838629, i32* %canary
  %tmp = alloca %struct.node*, align 8
  %root = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
  %node = alloca %struct.node*, align 8
...
entry:
  ...
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1443153366, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %checksum = alloca i64, align 8
  %tmp = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  ...
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1961303371, i32* %canary
  %stop_dummy = alloca %struct.arc*, align 8
  %flow = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
  %stop = alloca i8*, align 8
...
entry:
  %operational_cost = alloca i64, align 8
  %canary = alloca i32
  store i32 684947454, i32* %canary
  %fleet = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
  %arc = alloca %struct.arc*, align 8
  %stop = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local double @flow_cost.30(%struct.network* %net) #0 {
entry:
  %fleet = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
  %stop = alloca i8*, align 8
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1922055312, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %operational_cost = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 0, i64* %fleet, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @refresh_neighbour_lists.31(%struct.network* %net) #0 {
entry:
  %arc = alloca %struct.arc*, align 8
  %node = alloca %struct.node*, align 8
  %stop = alloca i8*, align 8
  %canary = alloca i32
  store i32 1018051310, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
  %nodes = getelementptr inbounds %struct.network, %struct.network* %0, i32 0, i32 21
...
entry:
  ...
  %operational_cost = alloca i64, align 8
  %canary = alloca i32
  store i32 196117565, i32* %canary
  %node = alloca %struct.node*, align 8
  %stop = alloca i8*, align 8
  %fleet = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  ...
  %stop = alloca i8*, align 8
  %canary = alloca i32
  store i32 756393625, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %operational_cost = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 0, i64* %fleet, align 8
...
entry:
  ...
  %dummy = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 594993845, i32* %canary
  %stop = alloca i8*, align 8
  %flow = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
  %stop_dummy = alloca %struct.arc*, align 8
...
entry:
  ...
  %checksum = alloca i64, align 8
  %canary = alloca i32
  store i32 625981560, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %root = alloca %struct.node*, align 8
  %node = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  ...
  %stop = alloca i8*, align 8
  %canary = alloca i32
  store i32 186703357, i32* %canary
  %node = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
  %operational_cost = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
...
entry:
  ...
  %stop = alloca i8*, align 8
  %canary = alloca i32
  store i32 1165391590, i32* %canary
  %arc = alloca %struct.arc*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
  %nodes = getelementptr inbounds %struct.network, %struct.network* %0, i32 0, i32 21
...
entry:
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 290285282, i32* %canary
  %fleet = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
  %node = alloca %struct.node*, align 8
  %stop = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @dual_feasible.39(%struct.network* %net) #0 {
entry:
  %retval = alloca i64, align 8
  %canary = alloca i32
  store i32 778891746, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
  %red_cost = alloca i64, align 8
  %stop = alloca %struct.arc*, align 8
...
entry:
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 2016503414, i32* %canary
  %stop = alloca i8*, align 8
  %net.addr = alloca %struct.network*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @dual_feasible.41(%struct.network* %net) #0 {
entry:
  %stop = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
  %retval = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 952395543, i32* %canary
  %red_cost = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
  %stop_arcs = getelementptr inbounds %struct.network, %struct.network* %0, i32 0, i32 24
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local double @flow_org_cost.42(%struct.network* %net) #0 {
entry:
  %fleet = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
  %arc = alloca %struct.arc*, align 8
  %operational_cost = alloca i64, align 8
  %canary = alloca i32
  store i32 914594942, i32* %canary
  %node = alloca %struct.node*, align 8
  %stop = alloca i8*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 0, i64* %fleet, align 8
...
entry:
  %canary = alloca i32
  store i32 1232327783, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %stop = alloca i8*, align 8
  %net.addr = alloca %struct.network*, align 8
  %node = alloca %struct.node*, align 8
...
entry:
  ...
  %flow = alloca i64, align 8
  %canary = alloca i32
  store i32 1739438546, i32* %canary
  %node = alloca %struct.node*, align 8
  %arc = alloca %struct.arc*, align 8
  %stop = alloca i8*, align 8
  %stop_dummy = alloca %struct.arc*, align 8
...
entry:
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 896247224, i32* %canary
  %dummy = alloca %struct.arc*, align 8
  %stop = alloca i8*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
...
entry:
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 2130305984, i32* %canary
  %stop_dummy = alloca %struct.arc*, align 8
  %flow = alloca i64, align 8
  %node = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  ...
  %retval = alloca i64, align 8
  %canary = alloca i32
  store i32 424890263, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %flow = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
  %stop_dummy = alloca %struct.arc*, align 8
...
entry:
  ...
  %stop = alloca i8*, align 8
  %canary = alloca i32
  store i32 1477527638, i32* %canary
  %stop_dummy = alloca %struct.arc*, align 8
  %arc = alloca %struct.arc*, align 8
  %flow = alloca i64, align 8
  %retval = alloca i64, align 8
