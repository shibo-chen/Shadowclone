; ModuleID = 'pflowup.c.rand.16D16.bc'
...
entry:
  %canary = alloca i32
  store i32 2101086677, i32* %canary
...
entry:
  ...
  %w.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 711715608, i32* %canary
  %jplus.addr = alloca %struct.node*, align 8
  store %struct.node* %iplus, %struct.node** %iplus.addr, align 8
  store %struct.node* %jplus, %struct.node** %jplus.addr, align 8
  store %struct.node* %w, %struct.node** %w.addr, align 8
...
entry:
  ...
  %w.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1842699998, i32* %canary
  %iplus.addr = alloca %struct.node*, align 8
  store %struct.node* %iplus, %struct.node** %iplus.addr, align 8
  store %struct.node* %jplus, %struct.node** %jplus.addr, align 8
  store %struct.node* %w, %struct.node** %w.addr, align 8
...
entry:
  %w.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 357738507, i32* %canary
  %iplus.addr = alloca %struct.node*, align 8
  %jplus.addr = alloca %struct.node*, align 8
  store %struct.node* %iplus, %struct.node** %iplus.addr, align 8
  store %struct.node* %jplus, %struct.node** %jplus.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1606160805, i32* %canary
  %w.addr = alloca %struct.node*, align 8
  %jplus.addr = alloca %struct.node*, align 8
  %iplus.addr = alloca %struct.node*, align 8
  store %struct.node* %iplus, %struct.node** %iplus.addr, align 8
