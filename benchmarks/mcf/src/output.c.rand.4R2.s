...
# %bb.0:                                # %entry
	...
	.cfi_offset %rbx, -24
	xorl	%eax, %eax
	movl	$1798447977, -60(%rbp)  # imm = 0x6B322369
	movq	%rdi, -80(%rbp)
	movq	%rsi, -40(%rbp)
	movq	$0, -24(%rbp)
	movq	-40(%rbp), %rcx
...
.LBB1_26:                               # %return
	movq	-56(%rbp), %rbx
	cmpl	$1798447977, -60(%rbp)  # imm = 0x6B322369
	jne	.LBB1_28
.LBB1_27:
	movq	%rbx, %rax
	addq	$72, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_offset %rbx, -24
	xorl	%eax, %eax
	movl	$1473964395, -60(%rbp)  # imm = 0x57DAE96B
	movq	%rdi, -72(%rbp)
	movq	%rsi, -32(%rbp)
	movq	$0, -24(%rbp)
	movq	-32(%rbp), %rcx
...
.LBB2_26:                               # %return
	movq	-56(%rbp), %rbx
	cmpl	$1473964395, -60(%rbp)  # imm = 0x57DAE96B
	jne	.LBB2_28
.LBB2_27:
	movq	%rbx, %rax
	addq	$72, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_offset %rbx, -24
	xorl	%eax, %eax
	movl	$1812867429, -60(%rbp)  # imm = 0x6C0E2965
	movq	%rdi, -72(%rbp)
	movq	%rsi, -40(%rbp)
	movq	$0, -24(%rbp)
	movq	-40(%rbp), %rcx
...
.LBB3_26:                               # %return
	movq	-56(%rbp), %rbx
	cmpl	$1812867429, -60(%rbp)  # imm = 0x6C0E2965
	jne	.LBB3_28
.LBB3_27:
	movq	%rbx, %rax
	addq	$72, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_offset %rbx, -24
	xorl	%eax, %eax
	movl	$216099730, -60(%rbp)   # imm = 0xCE16B92
	movq	%rdi, -72(%rbp)
	movq	%rsi, -24(%rbp)
	movq	$0, -40(%rbp)
	movq	-24(%rbp), %rcx
...
.LBB4_26:                               # %return
	movq	-56(%rbp), %rbx
	cmpl	$216099730, -60(%rbp)   # imm = 0xCE16B92
	jne	.LBB4_28
.LBB4_27:
	movq	%rbx, %rax
	addq	$72, %rsp
