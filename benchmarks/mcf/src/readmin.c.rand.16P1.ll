; ModuleID = 'readmin.c.rand.16P1.bc'
...
entry:
  ...
  %canary = alloca i32
  store i32 848748151, i32* %canary
...
entry:
  ...
  %i = alloca i64, align 8
  %canary = alloca i32
  store i32 702773888, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %instring = alloca [201 x i8], align 16
  %arc = alloca %struct.arc*, align 8
  %c = alloca i64, align 8
...
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 832757302, i32* %canary
  %node = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store %struct._IO_FILE* null, %struct._IO_FILE** %in, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 450267531, i32* %canary
  %instring = alloca [201 x i8], align 16
  %node = alloca %struct.node*, align 8
  %retval = alloca i64, align 8
  %i = alloca i64, align 8
...
entry:
  ...
  %h = alloca i64, align 8
  %canary = alloca i32
  store i32 1876930350, i32* %canary
  %node = alloca %struct.node*, align 8
  %instring = alloca [201 x i8], align 16
  %t = alloca i64, align 8
  %retval = alloca i64, align 8
...
return:                                           ; preds = %for.end228, %if.then147, %if.then134, %if.then57, %if.then34, %if.then6, %if.then
  %247 = load i64, i64* %retval, align 8
  %248 = load i32, i32* %canary
  %249 = icmp eq i32 %248, 1876930350
  br i1 %249, label %250, label %func_exit
...
entry:
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 670936842, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %i = alloca i64, align 8
  %retval = alloca i64, align 8
  %t = alloca i64, align 8
...
entry:
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 443529119, i32* %canary
  %c = alloca i64, align 8
  %instring = alloca [201 x i8], align 16
  %t = alloca i64, align 8
  %in = alloca %struct._IO_FILE*, align 8
...
entry:
  ...
  %i = alloca i64, align 8
  %canary = alloca i32
  store i32 1916560134, i32* %canary
  %retval = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store %struct._IO_FILE* null, %struct._IO_FILE** %in, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
...
return:                                           ; preds = %for.end228, %if.then147, %if.then134, %if.then57, %if.then34, %if.then6, %if.then
  %247 = load i64, i64* %retval, align 8
  %248 = load i32, i32* %canary
  %249 = icmp eq i32 %248, 1916560134
  br i1 %249, label %250, label %func_exit
...
entry:
  %canary = alloca i32
  store i32 266767167, i32* %canary
  %node = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
  %in = alloca %struct._IO_FILE*, align 8
  %instring = alloca [201 x i8], align 16
...
entry:
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1111053796, i32* %canary
  %in = alloca %struct._IO_FILE*, align 8
  %t = alloca i64, align 8
  %instring = alloca [201 x i8], align 16
  %h = alloca i64, align 8
...
return:                                           ; preds = %for.end228, %if.then147, %if.then134, %if.then57, %if.then34, %if.then6, %if.then
  %247 = load i64, i64* %retval, align 8
  %248 = load i32, i32* %canary
  %249 = icmp eq i32 %248, 1111053796
  br i1 %249, label %250, label %func_exit
...
entry:
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 2011358918, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store %struct._IO_FILE* null, %struct._IO_FILE** %in, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
...
return:                                           ; preds = %for.end228, %if.then147, %if.then134, %if.then57, %if.then34, %if.then6, %if.then
  %247 = load i64, i64* %retval, align 8
  %248 = load i32, i32* %canary
  %249 = icmp eq i32 %248, 2011358918
  br i1 %249, label %250, label %func_exit
...
entry:
  ...
  %c = alloca i64, align 8
  %canary = alloca i32
  store i32 2142373823, i32* %canary
  %i = alloca i64, align 8
  %in = alloca %struct._IO_FILE*, align 8
  %arc = alloca %struct.arc*, align 8
  %retval = alloca i64, align 8
...
return:                                           ; preds = %for.end228, %if.then147, %if.then134, %if.then57, %if.then34, %if.then6, %if.then
  %247 = load i64, i64* %retval, align 8
  %248 = load i32, i32* %canary
  %249 = icmp eq i32 %248, 2142373823
  br i1 %249, label %250, label %func_exit
...
entry:
  ...
  %in = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 1968233936, i32* %canary
  %t = alloca i64, align 8
  %c = alloca i64, align 8
  %instring = alloca [201 x i8], align 16
  %arc = alloca %struct.arc*, align 8
...
return:                                           ; preds = %for.end228, %if.then147, %if.then134, %if.then57, %if.then34, %if.then6, %if.then
  %247 = load i64, i64* %retval, align 8
  %248 = load i32, i32* %canary
  %249 = icmp eq i32 %248, 1968233936
  br i1 %249, label %250, label %func_exit
...
entry:
  ...
  %retval = alloca i64, align 8
  %canary = alloca i32
  store i32 514437402, i32* %canary
  %c = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
  %node = alloca %struct.node*, align 8
  %i = alloca i64, align 8
...
entry:
  %canary = alloca i32
  store i32 209882592, i32* %canary
  %instring = alloca [201 x i8], align 16
  %h = alloca i64, align 8
  %t = alloca i64, align 8
  %node = alloca %struct.node*, align 8
