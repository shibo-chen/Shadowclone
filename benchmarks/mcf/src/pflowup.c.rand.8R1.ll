; ModuleID = 'pflowup.c.rand.8R1.bc'
...
entry:
  ...
  %canary = alloca i32
  store i32 266354399, i32* %canary
...
entry:
  %w.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 420704455, i32* %canary
  %jplus.addr = alloca %struct.node*, align 8
  %iplus.addr = alloca %struct.node*, align 8
  store %struct.node* %iplus, %struct.node** %iplus.addr, align 8
  store %struct.node* %jplus, %struct.node** %jplus.addr, align 8
...
entry:
  %jplus.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 2073431493, i32* %canary
  %w.addr = alloca %struct.node*, align 8
  %iplus.addr = alloca %struct.node*, align 8
  store %struct.node* %iplus, %struct.node** %iplus.addr, align 8
  store %struct.node* %jplus, %struct.node** %jplus.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 269271843, i32* %canary
  %jplus.addr = alloca %struct.node*, align 8
  %iplus.addr = alloca %struct.node*, align 8
  %w.addr = alloca %struct.node*, align 8
  store %struct.node* %iplus, %struct.node** %iplus.addr, align 8
...
entry:
  %iplus.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1074389136, i32* %canary
  %jplus.addr = alloca %struct.node*, align 8
  %w.addr = alloca %struct.node*, align 8
  store %struct.node* %iplus, %struct.node** %iplus.addr, align 8
  store %struct.node* %jplus, %struct.node** %jplus.addr, align 8
...
entry:
  %iplus.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 471583562, i32* %canary
  %w.addr = alloca %struct.node*, align 8
  %jplus.addr = alloca %struct.node*, align 8
  store %struct.node* %iplus, %struct.node** %iplus.addr, align 8
  store %struct.node* %jplus, %struct.node** %jplus.addr, align 8
