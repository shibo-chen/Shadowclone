; ModuleID = 'pbeampp.c.rand.16D16.bc'
...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_bea_is_dual_infeasible.4, label %func_bea_is_dual_infeasible.5
...
func_sort_basket.11:                              ; preds = %ctrl2
...
func_sort_basket.17:                              ; preds = %ctrl4
...
ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_sort_basket.11, label %ctrl3
...
ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_sort_basket.17, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_sort_basket.18, label %ctrl6
...
func_primal_bea_mpp.3:                            ; preds = %ctrl0
  %3 = call %struct.arc* @primal_bea_mpp.3(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea)
  ret %struct.arc* %3
...
func_primal_bea_mpp.10:                           ; preds = %ctrl3
  %6 = call %struct.arc* @primal_bea_mpp.10(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea)
  ret %struct.arc* %6
...
func_primal_bea_mpp.13:                           ; preds = %ctrl5
  %8 = call %struct.arc* @primal_bea_mpp.13(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea)
  ret %struct.arc* %8

func_primal_bea_mpp.14:                           ; preds = %ctrl6
  %9 = call %struct.arc* @primal_bea_mpp.14(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea)
  ret %struct.arc* %9

func_primal_bea_mpp.15:                           ; preds = %ctrl7
  %10 = call %struct.arc* @primal_bea_mpp.15(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea)
  ret %struct.arc* %10
...
ctrl0:                                            ; preds = %rand_bb
  %18 = icmp eq i32 %0, 1
  br i1 %18, label %func_primal_bea_mpp.3, label %ctrl1
...
ctrl3:                                            ; preds = %ctrl2
  %21 = icmp eq i32 %0, 4
  br i1 %21, label %func_primal_bea_mpp.10, label %ctrl4
...
ctrl5:                                            ; preds = %ctrl4
  %23 = icmp eq i32 %0, 6
  br i1 %23, label %func_primal_bea_mpp.13, label %ctrl6

ctrl6:                                            ; preds = %ctrl5
  %24 = icmp eq i32 %0, 7
  br i1 %24, label %func_primal_bea_mpp.14, label %ctrl7

ctrl7:                                            ; preds = %ctrl6
  %25 = icmp eq i32 %0, 8
  br i1 %25, label %func_primal_bea_mpp.15, label %ctrl8
...
entry:
  ...
  %canary = alloca i32
  store i32 1507828311, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1205266367, i32* %canary
...
entry:
  ...
  %red_cost_of_bea.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 606204990, i32* %canary
  %stop_arcs.addr = alloca %struct.arc*, align 8
  %old_group_pos = alloca i64, align 8
  %m.addr = alloca i64, align 8
  %red_cost = alloca i64, align 8
...
entry:
  %canary = alloca i32
  store i32 1705420373, i32* %canary
...
entry:
  %red_cost.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1464076992, i32* %canary
  %arc.addr = alloca %struct.arc*, align 8
  store %struct.arc* %arc, %struct.arc** %arc.addr, align 8
  store i64 %red_cost, i64* %red_cost.addr, align 8
  %0 = load i64, i64* %red_cost.addr, align 8
...
entry:
  ...
  %red_cost = alloca i64, align 8
  %canary = alloca i32
  store i32 495137958, i32* %canary
  %old_group_pos = alloca i64, align 8
  %arcs.addr = alloca %struct.arc*, align 8
  %retval = alloca %struct.arc*, align 8
  store i64 %m, i64* %m.addr, align 8
...
entry:
  ...
  %xchange = alloca %struct.basket*, align 8
  %canary = alloca i32
  store i32 1624581586, i32* %canary
  %min.addr = alloca i64, align 8
  %cut = alloca i64, align 8
  %r = alloca i64, align 8
  %max.addr = alloca i64, align 8
...
entry:
  ...
  %m.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 469024430, i32* %canary
  %stop_arcs.addr = alloca %struct.arc*, align 8
  %old_group_pos = alloca i64, align 8
  %retval = alloca %struct.arc*, align 8
  %red_cost_of_bea.addr = alloca i64*, align 8
...
entry:
  ...
  %i = alloca i64, align 8
  %canary = alloca i32
  store i32 618955672, i32* %canary
  %red_cost = alloca i64, align 8
  %red_cost_of_bea.addr = alloca i64*, align 8
  %next = alloca i64, align 8
  %stop_arcs.addr = alloca %struct.arc*, align 8
...
entry:
  ...
  %cut = alloca i64, align 8
  %canary = alloca i32
  store i32 1332844743, i32* %canary
  %max.addr = alloca i64, align 8
  %l = alloca i64, align 8
  %min.addr = alloca i64, align 8
  store i64 %min, i64* %min.addr, align 8
...
entry:
  %red_cost_of_bea.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 1982961149, i32* %canary
  %retval = alloca %struct.arc*, align 8
  %old_group_pos = alloca i64, align 8
  %m.addr = alloca i64, align 8
  %stop_arcs.addr = alloca %struct.arc*, align 8
...
entry:
  ...
  %red_cost_of_bea.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 453343904, i32* %canary
  %stop_arcs.addr = alloca %struct.arc*, align 8
  %i = alloca i64, align 8
  %old_group_pos = alloca i64, align 8
  %arcs.addr = alloca %struct.arc*, align 8
...
entry:
  ...
  %m.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1350853153, i32* %canary
  %old_group_pos = alloca i64, align 8
  %stop_arcs.addr = alloca %struct.arc*, align 8
  %red_cost = alloca i64, align 8
  %red_cost_of_bea.addr = alloca i64*, align 8
...
entry:
  %canary = alloca i32
  store i32 889081420, i32* %canary
  %arcs.addr = alloca %struct.arc*, align 8
  %red_cost_of_bea.addr = alloca i64*, align 8
  %arc = alloca %struct.arc*, align 8
  %stop_arcs.addr = alloca %struct.arc*, align 8
...
entry:
  %canary = alloca i32
  store i32 1251463422, i32* %canary
  %cut = alloca i64, align 8
  %xchange = alloca %struct.basket*, align 8
  %min.addr = alloca i64, align 8
  %max.addr = alloca i64, align 8
...
entry:
  ...
  %l = alloca i64, align 8
  %canary = alloca i32
  store i32 1073477651, i32* %canary
  %min.addr = alloca i64, align 8
  %max.addr = alloca i64, align 8
  store i64 %min, i64* %min.addr, align 8
  store i64 %max, i64* %max.addr, align 8
...
entry:
  ...
  %l = alloca i64, align 8
  %canary = alloca i32
  store i32 1775178086, i32* %canary
  %max.addr = alloca i64, align 8
  %min.addr = alloca i64, align 8
  %cut = alloca i64, align 8
  store i64 %min, i64* %min.addr, align 8
...
entry:
  ...
  %l = alloca i64, align 8
  %canary = alloca i32
  store i32 1944804225, i32* %canary
  %min.addr = alloca i64, align 8
  %cut = alloca i64, align 8
  %r = alloca i64, align 8
  store i64 %min, i64* %min.addr, align 8
...
entry:
  ...
  %next = alloca i64, align 8
  %canary = alloca i32
  store i32 1876916674, i32* %canary
  %red_cost_of_bea.addr = alloca i64*, align 8
  %red_cost = alloca i64, align 8
  %retval = alloca %struct.arc*, align 8
  %arc = alloca %struct.arc*, align 8
...
entry:
  ...
  %stop_arcs.addr = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 767323227, i32* %canary
  %arcs.addr = alloca %struct.arc*, align 8
  %red_cost = alloca i64, align 8
  store i64 %m, i64* %m.addr, align 8
  store %struct.arc* %arcs, %struct.arc** %arcs.addr, align 8
...
entry:
  ...
  %max.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1204429031, i32* %canary
  %xchange = alloca %struct.basket*, align 8
  %min.addr = alloca i64, align 8
  %l = alloca i64, align 8
  store i64 %min, i64* %min.addr, align 8
...
entry:
  ...
  %max.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1386158841, i32* %canary
  %xchange = alloca %struct.basket*, align 8
  %r = alloca i64, align 8
  %cut = alloca i64, align 8
  store i64 %min, i64* %min.addr, align 8
...
entry:
  ...
  %l = alloca i64, align 8
  %canary = alloca i32
  store i32 1727842127, i32* %canary
  %max.addr = alloca i64, align 8
  %min.addr = alloca i64, align 8
  %r = alloca i64, align 8
  store i64 %min, i64* %min.addr, align 8
...
entry:
  ...
  %m.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 869058306, i32* %canary
  %next = alloca i64, align 8
  %retval = alloca %struct.arc*, align 8
  %red_cost_of_bea.addr = alloca i64*, align 8
  %arc = alloca %struct.arc*, align 8
...
entry:
  ...
  %red_cost_of_bea.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 1291555915, i32* %canary
  %arc = alloca %struct.arc*, align 8
  store i64 %m, i64* %m.addr, align 8
  store %struct.arc* %arcs, %struct.arc** %arcs.addr, align 8
  store %struct.arc* %stop_arcs, %struct.arc** %stop_arcs.addr, align 8
...
entry:
  ...
  %cut = alloca i64, align 8
  %canary = alloca i32
  store i32 855817493, i32* %canary
  %r = alloca i64, align 8
  %max.addr = alloca i64, align 8
  %min.addr = alloca i64, align 8
  %l = alloca i64, align 8
...
entry:
  ...
  %max.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1370792906, i32* %canary
  %r = alloca i64, align 8
  %l = alloca i64, align 8
  store i64 %min, i64* %min.addr, align 8
  store i64 %max, i64* %max.addr, align 8
...
entry:
  ...
  %r = alloca i64, align 8
  %canary = alloca i32
  store i32 1121235164, i32* %canary
  %min.addr = alloca i64, align 8
  %xchange = alloca %struct.basket*, align 8
  %max.addr = alloca i64, align 8
  %cut = alloca i64, align 8
...
entry:
  ...
  %xchange = alloca %struct.basket*, align 8
  %canary = alloca i32
  store i32 1940605495, i32* %canary
  %r = alloca i64, align 8
  store i64 %min, i64* %min.addr, align 8
  store i64 %max, i64* %max.addr, align 8
  %0 = load i64, i64* %min.addr, align 8
...
entry:
  ...
  %next = alloca i64, align 8
  %canary = alloca i32
  store i32 454772875, i32* %canary
  %red_cost_of_bea.addr = alloca i64*, align 8
  %old_group_pos = alloca i64, align 8
  store i64 %m, i64* %m.addr, align 8
  store %struct.arc* %arcs, %struct.arc** %arcs.addr, align 8
...
entry:
  ...
  %next = alloca i64, align 8
  %canary = alloca i32
  store i32 1976893272, i32* %canary
  %red_cost = alloca i64, align 8
  store i64 %m, i64* %m.addr, align 8
  store %struct.arc* %arcs, %struct.arc** %arcs.addr, align 8
  store %struct.arc* %stop_arcs, %struct.arc** %stop_arcs.addr, align 8
...
entry:
  ...
  %retval = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1297852612, i32* %canary
  %m.addr = alloca i64, align 8
  %red_cost = alloca i64, align 8
  %red_cost_of_bea.addr = alloca i64*, align 8
  %next = alloca i64, align 8
