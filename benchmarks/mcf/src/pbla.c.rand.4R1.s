...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$47285402, -52(%rbp)    # imm = 0x2D1849A
	movq	%rdi, -32(%rbp)
	movq	%rsi, -48(%rbp)
	movq	%rdx, -16(%rbp)
	movq	%rcx, -24(%rbp)
...
.LBB1_24:                               # %while.end
	...
	movq	%rax, (%rcx)
	movq	-40(%rbp), %rbx
	cmpl	$47285402, -52(%rbp)    # imm = 0x2D1849A
	jne	.LBB1_26
.LBB1_25:
	movq	%rbx, %rax
	addq	$56, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$480083286, -52(%rbp)   # imm = 0x1C9D7D56
	movq	%rdi, -32(%rbp)
	movq	%rsi, -48(%rbp)
	movq	%rdx, -16(%rbp)
	movq	%rcx, -24(%rbp)
...
.LBB2_24:                               # %while.end
	...
	movq	%rax, (%rcx)
	movq	-40(%rbp), %rbx
	cmpl	$480083286, -52(%rbp)   # imm = 0x1C9D7D56
	jne	.LBB2_26
.LBB2_25:
	movq	%rbx, %rax
	addq	$56, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$1910471414, -52(%rbp)  # imm = 0x71DF7AF6
	movq	%rdi, -32(%rbp)
	movq	%rsi, -48(%rbp)
	movq	%rdx, -16(%rbp)
	movq	%rcx, -24(%rbp)
...
.LBB3_24:                               # %while.end
	...
	movq	%rax, (%rcx)
	movq	-40(%rbp), %rbx
	cmpl	$1910471414, -52(%rbp)  # imm = 0x71DF7AF6
	jne	.LBB3_26
.LBB3_25:
	movq	%rbx, %rax
	addq	$56, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$2108845160, -52(%rbp)  # imm = 0x7DB26C68
	movq	%rdi, -32(%rbp)
	movq	%rsi, -48(%rbp)
	movq	%rdx, -16(%rbp)
	movq	%rcx, -24(%rbp)
...
.LBB4_24:                               # %while.end
	...
	movq	%rax, (%rcx)
	movq	-40(%rbp), %rbx
	cmpl	$2108845160, -52(%rbp)  # imm = 0x7DB26C68
	jne	.LBB4_26
.LBB4_25:
	movq	%rbx, %rax
	addq	$56, %rsp
