; ModuleID = 'implicit.c.rand.8P3.bc'
...
func_resize_prob.7:                               ; preds = %ctrl0
  %3 = call i64 @resize_prob.7(%struct.network* %net)
  ret i64 %3
...
func_resize_prob.14:                              ; preds = %ctrl2
  %5 = call i64 @resize_prob.14(%struct.network* %net)
  ret i64 %5
...
func_resize_prob.27:                              ; preds = %ctrl4
  %7 = call i64 @resize_prob.27(%struct.network* %net)
  ret i64 %7

func_resize_prob.30:                              ; preds = %ctrl5
  %8 = call i64 @resize_prob.30(%struct.network* %net)
  ret i64 %8

func_resize_prob.32:                              ; preds = %ctrl5
  %9 = call i64 @resize_prob.32(%struct.network* %net)
  ret i64 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_resize_prob.7, label %ctrl1
...
ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_resize_prob.14, label %ctrl3
...
ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_resize_prob.27, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_resize_prob.30, label %func_resize_prob.32
}
...
func_insert_new_arc.20:                           ; preds = %ctrl0
  call void @insert_new_arc.20(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void

func_insert_new_arc.22:                           ; preds = %ctrl1
  call void @insert_new_arc.22(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void

func_insert_new_arc.24:                           ; preds = %ctrl2
  call void @insert_new_arc.24(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void

func_insert_new_arc.26:                           ; preds = %ctrl3
  call void @insert_new_arc.26(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void
...
func_insert_new_arc.29:                           ; preds = %ctrl5
  call void @insert_new_arc.29(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void

func_insert_new_arc.31:                           ; preds = %ctrl5
  call void @insert_new_arc.31(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_insert_new_arc.20, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_insert_new_arc.22, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_insert_new_arc.24, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_insert_new_arc.26, label %ctrl4
...
ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_insert_new_arc.29, label %func_insert_new_arc.31
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_replace_weaker_arc.10, label %ctrl0

func_replace_weaker_arc.10:                       ; preds = %rand_bb
  call void @replace_weaker_arc.10(%struct.network* %net, %struct.arc* %new, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void

func_replace_weaker_arc.15:                       ; preds = %ctrl0
  call void @replace_weaker_arc.15(%struct.network* %net, %struct.arc* %new, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void

func_replace_weaker_arc.16:                       ; preds = %ctrl1
  call void @replace_weaker_arc.16(%struct.network* %net, %struct.arc* %new, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void
...
func_replace_weaker_arc.25:                       ; preds = %ctrl3
  call void @replace_weaker_arc.25(%struct.network* %net, %struct.arc* %new, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void
...
func_replace_weaker_arc.35:                       ; preds = %ctrl5
  call void @replace_weaker_arc.35(%struct.network* %net, %struct.arc* %new, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void

func_replace_weaker_arc.39:                       ; preds = %ctrl5
  call void @replace_weaker_arc.39(%struct.network* %net, %struct.arc* %new, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_replace_weaker_arc.15, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_replace_weaker_arc.16, label %ctrl2
...
ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_replace_weaker_arc.25, label %ctrl4
...
ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_replace_weaker_arc.35, label %func_replace_weaker_arc.39
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_price_out_impl.1, label %ctrl0

func_price_out_impl.1:                            ; preds = %rand_bb
  %2 = call i64 @price_out_impl.1(%struct.network* %net)
  ret i64 %2
...
func_price_out_impl.5:                            ; preds = %ctrl1
  %4 = call i64 @price_out_impl.5(%struct.network* %net)
  ret i64 %4

func_price_out_impl.6:                            ; preds = %ctrl2
  %5 = call i64 @price_out_impl.6(%struct.network* %net)
  ret i64 %5

func_price_out_impl.9:                            ; preds = %ctrl3
  %6 = call i64 @price_out_impl.9(%struct.network* %net)
  ret i64 %6

func_price_out_impl.11:                           ; preds = %ctrl4
  %7 = call i64 @price_out_impl.11(%struct.network* %net)
  ret i64 %7

func_price_out_impl.17:                           ; preds = %ctrl5
  %8 = call i64 @price_out_impl.17(%struct.network* %net)
  ret i64 %8

func_price_out_impl.18:                           ; preds = %ctrl5
  %9 = call i64 @price_out_impl.18(%struct.network* %net)
  ret i64 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_price_out_impl.4, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_price_out_impl.5, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_price_out_impl.6, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_price_out_impl.9, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_price_out_impl.11, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_price_out_impl.17, label %func_price_out_impl.18
}
...
func_suspend_impl.12:                             ; preds = %ctrl0
  %3 = call i64 @suspend_impl.12(%struct.network* %net, i64 %threshold, i64 %all)
  ret i64 %3

func_suspend_impl.21:                             ; preds = %ctrl1
  %4 = call i64 @suspend_impl.21(%struct.network* %net, i64 %threshold, i64 %all)
  ret i64 %4

func_suspend_impl.34:                             ; preds = %ctrl2
  %5 = call i64 @suspend_impl.34(%struct.network* %net, i64 %threshold, i64 %all)
  ret i64 %5

func_suspend_impl.36:                             ; preds = %ctrl3
  %6 = call i64 @suspend_impl.36(%struct.network* %net, i64 %threshold, i64 %all)
  ret i64 %6

func_suspend_impl.37:                             ; preds = %ctrl4
  %7 = call i64 @suspend_impl.37(%struct.network* %net, i64 %threshold, i64 %all)
  ret i64 %7

func_suspend_impl.38:                             ; preds = %ctrl5
  %8 = call i64 @suspend_impl.38(%struct.network* %net, i64 %threshold, i64 %all)
  ret i64 %8

func_suspend_impl.40:                             ; preds = %ctrl5
  %9 = call i64 @suspend_impl.40(%struct.network* %net, i64 %threshold, i64 %all)
  ret i64 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_suspend_impl.12, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_suspend_impl.21, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_suspend_impl.34, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_suspend_impl.36, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_suspend_impl.37, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_suspend_impl.38, label %func_suspend_impl.40
}
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @price_out_impl.1(%struct.network* %net) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 273817133, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 866624257, i32* %canary
...
entry:
  ...
  %tail = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 192483824, i32* %canary
  %arcin = alloca %struct.arc*, align 8
  %retval = alloca i64, align 8
  %stop = alloca %struct.arc*, align 8
  %arcnew = alloca %struct.arc*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @price_out_impl.5(%struct.network* %net) #0 {
entry:
  %tail = alloca %struct.node*, align 8
  %min_impl_duration = alloca i64, align 8
  %bigM_minus_min_impl_duration = alloca i64, align 8
  ...
  %latest = alloca i64, align 8
  %canary = alloca i32
  store i32 1612584230, i32* %canary
  %red_cost = alloca i64, align 8
  %resized = alloca i64, align 8
  %arcout = alloca %struct.arc*, align 8
  %trips = alloca i64, align 8
...
return:                                           ; preds = %if.end109, %if.then10
  %143 = load i64, i64* %retval, align 8
  %144 = load i32, i32* %canary
  %145 = icmp eq i32 %144, 1612584230
  br i1 %145, label %146, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @price_out_impl.6(%struct.network* %net) #0 {
entry:
  %first_of_sparse_list = alloca %struct.arc*, align 8
  %red_cost = alloca i64, align 8
  %trips = alloca i64, align 8
  ...
  %retval = alloca i64, align 8
  %canary = alloca i32
  store i32 1982070803, i32* %canary
  %resized = alloca i64, align 8
  %bigM = alloca i64, align 8
  %bigM_minus_min_impl_duration = alloca i64, align 8
  %new_arcs = alloca i64, align 8
...
return:                                           ; preds = %if.end109, %if.then10
  %143 = load i64, i64* %retval, align 8
  %144 = load i32, i32* %canary
  %145 = icmp eq i32 %144, 1982070803
  br i1 %145, label %146, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @resize_prob.7(%struct.network* %net) #0 {
entry:
  %off = alloca i64, align 8
  %retval = alloca i64, align 8
  %stop = alloca %struct.node*, align 8
  ...
  %root = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1308629047, i32* %canary
  %node = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
...
entry:
  ...
  %canary = alloca i32
  store i32 2123437412, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  ...
  %i = alloca i64, align 8
  %canary = alloca i32
  store i32 233046456, i32* %canary
  %retval = alloca i64, align 8
  %trips = alloca i64, align 8
  %tail = alloca %struct.node*, align 8
  %new_arcs = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @replace_weaker_arc.10(%struct.network* %net, %struct.arc* %new, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost) #0 {
entry:
  %head.addr = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
  %new.addr = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 2045844947, i32* %canary
  %red_cost.addr = alloca i64, align 8
  %pos = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @price_out_impl.11(%struct.network* %net) #0 {
entry:
  %head = alloca %struct.node*, align 8
  %tail = alloca %struct.node*, align 8
  %trips = alloca i64, align 8
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 436074582, i32* %canary
  %retval = alloca i64, align 8
  %new_arcs = alloca i64, align 8
  %head_potential = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @suspend_impl.12(%struct.network* %net, i64 %threshold, i64 %all) #0 {
entry:
  %canary = alloca i32
  store i32 1312042767, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %stop = alloca i8*, align 8
  %arc = alloca %struct.arc*, align 8
  %all.addr = alloca i64, align 8
...
entry:
  ...
  %retval = alloca i64, align 8
  %canary = alloca i32
  store i32 2101961043, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %root = alloca %struct.node*, align 8
  %node = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @resize_prob.14(%struct.network* %net) #0 {
entry:
  %node = alloca %struct.node*, align 8
  %root = alloca %struct.node*, align 8
  %stop = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 783496698, i32* %canary
  %retval = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
  %arc = alloca %struct.arc*, align 8
  %off = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @replace_weaker_arc.15(%struct.network* %net, %struct.arc* %new, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost) #0 {
entry:
  %canary = alloca i32
  store i32 1121318063, i32* %canary
  %tail.addr = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
  %pos = alloca i64, align 8
  %cost.addr = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @replace_weaker_arc.16(%struct.network* %net, %struct.arc* %new, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost) #0 {
entry:
  %cmp = alloca i64, align 8
  %pos = alloca i64, align 8
  %canary = alloca i32
  store i32 1387999057, i32* %canary
  %tail.addr = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
  %cost.addr = alloca i64, align 8
  %new.addr = alloca %struct.arc*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @price_out_impl.17(%struct.network* %net) #0 {
entry:
  %i = alloca i64, align 8
  %stop = alloca %struct.arc*, align 8
  %latest = alloca i64, align 8
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 317602141, i32* %canary
  %first_of_sparse_list = alloca %struct.arc*, align 8
  %arc_cost = alloca i64, align 8
  %min_impl_duration = alloca i64, align 8
  %arcout = alloca %struct.arc*, align 8
...
entry:
  ...
  %i = alloca i64, align 8
  %canary = alloca i32
  store i32 2121253829, i32* %canary
  %bigM = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
  %latest = alloca i64, align 8
  %head_potential = alloca i64, align 8
...
return:                                           ; preds = %if.end109, %if.then10
  %143 = load i64, i64* %retval, align 8
  %144 = load i32, i32* %canary
  %145 = icmp eq i32 %144, 2121253829
  br i1 %145, label %146, label %func_exit
...
entry:
  ...
  %stop = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1732497523, i32* %canary
  %node = alloca %struct.node*, align 8
  %root = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
  %off = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @insert_new_arc.20(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost) #0 {
entry:
  %red_cost.addr = alloca i64, align 8
  %head.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 49109006, i32* %canary
  %new.addr = alloca %struct.arc*, align 8
  %tail.addr = alloca %struct.node*, align 8
  %newpos.addr = alloca i64, align 8
  %cost.addr = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @suspend_impl.21(%struct.network* %net, i64 %threshold, i64 %all) #0 {
entry:
  %canary = alloca i32
  store i32 1192196555, i32* %canary
  %all.addr = alloca i64, align 8
  %threshold.addr = alloca i64, align 8
  %susp = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @insert_new_arc.22(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost) #0 {
entry:
  %pos = alloca i64, align 8
  %red_cost.addr = alloca i64, align 8
  %head.addr = alloca %struct.node*, align 8
  %newpos.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 915849699, i32* %canary
  %new.addr = alloca %struct.arc*, align 8
  %cost.addr = alloca i64, align 8
  %tail.addr = alloca %struct.node*, align 8
  store %struct.arc* %new, %struct.arc** %new.addr, align 8
...
entry:
  ...
  %cost.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1101542186, i32* %canary
  %tail.addr = alloca %struct.node*, align 8
  %pos = alloca i64, align 8
  %cmp = alloca i64, align 8
  %red_cost.addr = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @insert_new_arc.24(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost) #0 {
entry:
  %canary = alloca i32
  store i32 1326927557, i32* %canary
  %pos = alloca i64, align 8
  %cost.addr = alloca i64, align 8
  %tail.addr = alloca %struct.node*, align 8
  %newpos.addr = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @replace_weaker_arc.25(%struct.network* %net, %struct.arc* %new, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost) #0 {
entry:
  %new.addr = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
  %red_cost.addr = alloca i64, align 8
  ...
  %pos = alloca i64, align 8
  %canary = alloca i32
  store i32 2067137672, i32* %canary
  %tail.addr = alloca %struct.node*, align 8
  %cmp = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store %struct.arc* %new, %struct.arc** %new.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @insert_new_arc.26(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost) #0 {
entry:
  %canary = alloca i32
  store i32 929169795, i32* %canary
  %new.addr = alloca %struct.arc*, align 8
  %newpos.addr = alloca i64, align 8
  %pos = alloca i64, align 8
  %red_cost.addr = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @resize_prob.27(%struct.network* %net) #0 {
entry:
  %arc = alloca %struct.arc*, align 8
  %root = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
  ...
  %off = alloca i64, align 8
  %canary = alloca i32
  store i32 408281341, i32* %canary
  %retval = alloca i64, align 8
  %node = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
...
entry:
  ...
  %head.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1316804723, i32* %canary
  %tail.addr = alloca %struct.node*, align 8
  %pos = alloca i64, align 8
  %new.addr = alloca %struct.arc*, align 8
  %red_cost.addr = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @insert_new_arc.29(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost) #0 {
entry:
  %cost.addr = alloca i64, align 8
  %new.addr = alloca %struct.arc*, align 8
  %pos = alloca i64, align 8
  %red_cost.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1497556029, i32* %canary
  %tail.addr = alloca %struct.node*, align 8
  %newpos.addr = alloca i64, align 8
  %head.addr = alloca %struct.node*, align 8
  store %struct.arc* %new, %struct.arc** %new.addr, align 8
...
entry:
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 1635343985, i32* %canary
  %root = alloca %struct.node*, align 8
  %node = alloca %struct.node*, align 8
  %retval = alloca i64, align 8
  %stop = alloca %struct.node*, align 8
...
entry:
  %canary = alloca i32
  store i32 426364061, i32* %canary
  %pos = alloca i64, align 8
  %head.addr = alloca %struct.node*, align 8
  %newpos.addr = alloca i64, align 8
  %red_cost.addr = alloca i64, align 8
...
entry:
  ...
  %root = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1442082488, i32* %canary
  %node = alloca %struct.node*, align 8
  %stop = alloca %struct.node*, align 8
  %retval = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  ...
  %red_cost.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1950850360, i32* %canary
  %tail.addr = alloca %struct.node*, align 8
  %pos = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store %struct.arc* %new, %struct.arc** %new.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @suspend_impl.34(%struct.network* %net, i64 %threshold, i64 %all) #0 {
entry:
  %net.addr = alloca %struct.network*, align 8
  %all.addr = alloca i64, align 8
  %new_arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 525016004, i32* %canary
  %red_cost = alloca i64, align 8
  %susp = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
  %stop = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @replace_weaker_arc.35(%struct.network* %net, %struct.arc* %new, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost) #0 {
entry:
  %canary = alloca i32
  store i32 1924929483, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %new.addr = alloca %struct.arc*, align 8
  %pos = alloca i64, align 8
  %cost.addr = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @suspend_impl.36(%struct.network* %net, i64 %threshold, i64 %all) #0 {
entry:
  %new_arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 379238317, i32* %canary
  %susp = alloca i64, align 8
  %threshold.addr = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
  %arc = alloca %struct.arc*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @suspend_impl.37(%struct.network* %net, i64 %threshold, i64 %all) #0 {
entry:
  %arc = alloca %struct.arc*, align 8
  %new_arc = alloca %struct.arc*, align 8
  %stop = alloca i8*, align 8
  ...
  %threshold.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 483386875, i32* %canary
  %all.addr = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
  %susp = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @suspend_impl.38(%struct.network* %net, i64 %threshold, i64 %all) #0 {
entry:
  %canary = alloca i32
  store i32 541223455, i32* %canary
  %susp = alloca i64, align 8
  %threshold.addr = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
  %red_cost = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @replace_weaker_arc.39(%struct.network* %net, %struct.arc* %new, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost) #0 {
entry:
  %red_cost.addr = alloca i64, align 8
  %cost.addr = alloca i64, align 8
  %tail.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 2040644994, i32* %canary
  %cmp = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
  %new.addr = alloca %struct.arc*, align 8
  %pos = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @suspend_impl.40(%struct.network* %net, i64 %threshold, i64 %all) #0 {
entry:
  %red_cost = alloca i64, align 8
  %all.addr = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 840328867, i32* %canary
  %threshold.addr = alloca i64, align 8
  %new_arc = alloca %struct.arc*, align 8
  %susp = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
