; ModuleID = 'pbeampp.c.rand.8P3.bc'
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_bea_is_dual_infeasible.1, label %func_bea_is_dual_infeasible.3
...
func_bea_is_dual_infeasible.3:                    ; preds = %rand_bb
  %3 = call i32 @bea_is_dual_infeasible.3(%struct.arc* %arc, i64 %red_cost)
  ret i32 %3
}
...
func_sort_basket.12:                              ; preds = %ctrl3
...
func_sort_basket.16:                              ; preds = %ctrl5
...
ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_sort_basket.12, label %ctrl4
...
ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_sort_basket.15, label %func_sort_basket.16
}
...
func_primal_bea_mpp.8:                            ; preds = %ctrl1
  %4 = call %struct.arc* @primal_bea_mpp.8(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea)
  ret %struct.arc* %4
...
func_primal_bea_mpp.13:                           ; preds = %ctrl4
  %7 = call %struct.arc* @primal_bea_mpp.13(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea)
  ret %struct.arc* %7
...
func_primal_bea_mpp.18:                           ; preds = %ctrl5
  %9 = call %struct.arc* @primal_bea_mpp.18(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea)
  ret %struct.arc* %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_primal_bea_mpp.5, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_primal_bea_mpp.8, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_primal_bea_mpp.9, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_primal_bea_mpp.11, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_primal_bea_mpp.13, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_primal_bea_mpp.17, label %func_primal_bea_mpp.18
}
...
entry:
  %canary = alloca i32
  store i32 1939725672, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 642835113, i32* %canary
...
entry:
  %arc.addr = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1979846488, i32* %canary
  %red_cost.addr = alloca i64, align 8
  store %struct.arc* %arc, %struct.arc** %arc.addr, align 8
  store i64 %red_cost, i64* %red_cost.addr, align 8
  %0 = load i64, i64* %red_cost.addr, align 8
...
entry:
  ...
  %canary = alloca i32
  store i32 1085174449, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 611486609, i32* %canary
  %arcs.addr = alloca %struct.arc*, align 8
  %red_cost_of_bea.addr = alloca i64*, align 8
  %m.addr = alloca i64, align 8
  %i = alloca i64, align 8
...
entry:
  %l = alloca i64, align 8
  %canary = alloca i32
  store i32 1398832153, i32* %canary
  %xchange = alloca %struct.basket*, align 8
  %max.addr = alloca i64, align 8
  %min.addr = alloca i64, align 8
  %r = alloca i64, align 8
...
entry:
  ...
  %max.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1012810647, i32* %canary
  %min.addr = alloca i64, align 8
  %cut = alloca i64, align 8
  %xchange = alloca %struct.basket*, align 8
  store i64 %min, i64* %min.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1829951959, i32* %canary
  %red_cost_of_bea.addr = alloca i64*, align 8
  %retval = alloca %struct.arc*, align 8
  %stop_arcs.addr = alloca %struct.arc*, align 8
  %i = alloca i64, align 8
...
entry:
  ...
  %red_cost = alloca i64, align 8
  %canary = alloca i32
  store i32 474522925, i32* %canary
  %m.addr = alloca i64, align 8
  %i = alloca i64, align 8
  %arcs.addr = alloca %struct.arc*, align 8
  %retval = alloca %struct.arc*, align 8
...
entry:
  %canary = alloca i32
  store i32 1074243839, i32* %canary
  %xchange = alloca %struct.basket*, align 8
  %l = alloca i64, align 8
  %cut = alloca i64, align 8
  %min.addr = alloca i64, align 8
...
entry:
  ...
  %i = alloca i64, align 8
  %canary = alloca i32
  store i32 830693099, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %old_group_pos = alloca i64, align 8
  store i64 %m, i64* %m.addr, align 8
  store %struct.arc* %arcs, %struct.arc** %arcs.addr, align 8
...
entry:
  ...
  %l = alloca i64, align 8
  %canary = alloca i32
  store i32 712525882, i32* %canary
  %max.addr = alloca i64, align 8
  %min.addr = alloca i64, align 8
  %r = alloca i64, align 8
  %cut = alloca i64, align 8
...
entry:
  %stop_arcs.addr = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1575423252, i32* %canary
  %red_cost = alloca i64, align 8
  %m.addr = alloca i64, align 8
  %arcs.addr = alloca %struct.arc*, align 8
  %next = alloca i64, align 8
...
entry:
  %canary = alloca i32
  store i32 1044118799, i32* %canary
  %r = alloca i64, align 8
  %cut = alloca i64, align 8
  %min.addr = alloca i64, align 8
  %l = alloca i64, align 8
...
entry:
  %canary = alloca i32
  store i32 812862508, i32* %canary
  %r = alloca i64, align 8
  %max.addr = alloca i64, align 8
  %xchange = alloca %struct.basket*, align 8
  %cut = alloca i64, align 8
...
entry:
  ...
  %r = alloca i64, align 8
  %canary = alloca i32
  store i32 2139015848, i32* %canary
  %xchange = alloca %struct.basket*, align 8
  %min.addr = alloca i64, align 8
  store i64 %min, i64* %min.addr, align 8
  store i64 %max, i64* %max.addr, align 8
...
entry:
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1881824321, i32* %canary
  %i = alloca i64, align 8
  %m.addr = alloca i64, align 8
  %old_group_pos = alloca i64, align 8
  %red_cost = alloca i64, align 8
...
entry:
  ...
  %i = alloca i64, align 8
  %canary = alloca i32
  store i32 287868153, i32* %canary
  %old_group_pos = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
  %red_cost = alloca i64, align 8
  store i64 %m, i64* %m.addr, align 8
