...
func_primal_iminus.8:                             ; preds = %ctrl5
  %9 = call %struct.node* @primal_iminus.8(i64* %delta, i64* %xchange, %struct.node* %iplus, %struct.node* %jplus, %struct.node** %w)
  ret %struct.node* %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_primal_iminus.2, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_primal_iminus.3, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_primal_iminus.4, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_primal_iminus.5, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_primal_iminus.6, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_primal_iminus.7, label %func_primal_iminus.8
}
...
entry:
  ...
  %canary = alloca i32
  store i32 1891717155, i32* %canary
...
entry:
  ...
  %w.addr = alloca %struct.node**, align 8
  %canary = alloca i32
  store i32 1552107748, i32* %canary
  %xchange.addr = alloca i64*, align 8
  store i64* %delta, i64** %delta.addr, align 8
  store i64* %xchange, i64** %xchange.addr, align 8
  store %struct.node* %iplus, %struct.node** %iplus.addr, align 8
...
entry:
  ...
  %jplus.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1558865843, i32* %canary
  %xchange.addr = alloca i64*, align 8
  %iplus.addr = alloca %struct.node*, align 8
  store i64* %delta, i64** %delta.addr, align 8
  store i64* %xchange, i64** %xchange.addr, align 8
...
entry:
  ...
  %iplus.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 334712861, i32* %canary
  %jplus.addr = alloca %struct.node*, align 8
  %iminus = alloca %struct.node*, align 8
  %w.addr = alloca %struct.node**, align 8
  %xchange.addr = alloca i64*, align 8
...
entry:
  ...
  %w.addr = alloca %struct.node**, align 8
  %canary = alloca i32
  store i32 670383416, i32* %canary
  %delta.addr = alloca i64*, align 8
  %iplus.addr = alloca %struct.node*, align 8
  %jplus.addr = alloca %struct.node*, align 8
  %iminus = alloca %struct.node*, align 8
...
entry:
  ...
  %xchange.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 886472445, i32* %canary
  %w.addr = alloca %struct.node**, align 8
  store i64* %delta, i64** %delta.addr, align 8
  store i64* %xchange, i64** %xchange.addr, align 8
  store %struct.node* %iplus, %struct.node** %iplus.addr, align 8
...
entry:
  ...
  %delta.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 1265644693, i32* %canary
  %iplus.addr = alloca %struct.node*, align 8
  %iminus = alloca %struct.node*, align 8
  store i64* %delta, i64** %delta.addr, align 8
  store i64* %xchange, i64** %xchange.addr, align 8
...
entry:
  ...
  %delta.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 1524335750, i32* %canary
  %iminus = alloca %struct.node*, align 8
  %jplus.addr = alloca %struct.node*, align 8
  %iplus.addr = alloca %struct.node*, align 8
  store i64* %delta, i64** %delta.addr, align 8
