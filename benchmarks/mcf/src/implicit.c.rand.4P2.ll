; ModuleID = 'implicit.c.rand.4P2.bc'
...
func_resize_prob.9:                               ; preds = %ctrl1
  %4 = call i64 @resize_prob.9(%struct.network* %net)
  ret i64 %4

func_resize_prob.15:                              ; preds = %ctrl1
  %5 = call i64 @resize_prob.15(%struct.network* %net)
  ret i64 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_resize_prob.5, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_resize_prob.9, label %func_resize_prob.15
}
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_insert_new_arc.10, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_insert_new_arc.18, label %func_insert_new_arc.19
}
...
func_replace_weaker_arc.7:                        ; preds = %ctrl0
  call void @replace_weaker_arc.7(%struct.network* %net, %struct.arc* %new, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void

func_replace_weaker_arc.11:                       ; preds = %ctrl1
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_replace_weaker_arc.7, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_replace_weaker_arc.11, label %func_replace_weaker_arc.20
}
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_price_out_impl.8, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_price_out_impl.12, label %func_price_out_impl.14
}
...
func_suspend_impl.13:                             ; preds = %ctrl0
  %3 = call i64 @suspend_impl.13(%struct.network* %net, i64 %threshold, i64 %all)
  ret i64 %3

func_suspend_impl.16:                             ; preds = %ctrl1
  %4 = call i64 @suspend_impl.16(%struct.network* %net, i64 %threshold, i64 %all)
  ret i64 %4
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_suspend_impl.13, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_suspend_impl.16, label %func_suspend_impl.17
}
...
entry:
  ...
  %canary = alloca i32
  store i32 457625719, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1582299801, i32* %canary
...
return:                                           ; preds = %if.end109, %if.then10
  ...
  %145 = icmp eq i32 %144, 1582299801
...
entry:
  ...
  %canary = alloca i32
  store i32 1967926477, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1296451088, i32* %canary
...
entry:
  ...
  %root = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 315712544, i32* %canary
  %node = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
  %retval = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
...
entry:
  ...
  %tail.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1425760493, i32* %canary
  %head.addr = alloca %struct.node*, align 8
  %new.addr = alloca %struct.arc*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store %struct.arc* %new, %struct.arc** %new.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @replace_weaker_arc.7(%struct.network* %net, %struct.arc* %new, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost) #0 {
entry:
  %head.addr = alloca %struct.node*, align 8
  %cost.addr = alloca i64, align 8
  %tail.addr = alloca %struct.node*, align 8
  ...
  %red_cost.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 2131435752, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %pos = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store %struct.arc* %new, %struct.arc** %new.addr, align 8
...
entry:
  ...
  %arcnew = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 705542941, i32* %canary
  %arcout = alloca %struct.arc*, align 8
  %red_cost = alloca i64, align 8
  %retval = alloca i64, align 8
  %trips = alloca i64, align 8
...
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 1405693218, i32* %canary
  %stop = alloca %struct.node*, align 8
  %retval = alloca i64, align 8
  %off = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
...
entry:
  ...
  %red_cost.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 593445582, i32* %canary
  %pos = alloca i64, align 8
  store %struct.arc* %new, %struct.arc** %new.addr, align 8
  store i64 %newpos, i64* %newpos.addr, align 8
  store %struct.node* %tail, %struct.node** %tail.addr, align 8
...
entry:
  ...
  %new.addr = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1670691968, i32* %canary
  %red_cost.addr = alloca i64, align 8
  %cmp = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store %struct.arc* %new, %struct.arc** %new.addr, align 8
...
entry:
  ...
  %min_impl_duration = alloca i64, align 8
  %canary = alloca i32
  store i32 2147266473, i32* %canary
  %arcout = alloca %struct.arc*, align 8
  %red_cost = alloca i64, align 8
  %bigM_minus_min_impl_duration = alloca i64, align 8
  %tail = alloca %struct.node*, align 8
...
return:                                           ; preds = %if.end109, %if.then10
  %143 = load i64, i64* %retval, align 8
  %144 = load i32, i32* %canary
  %145 = icmp eq i32 %144, 2147266473
  br i1 %145, label %146, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @suspend_impl.13(%struct.network* %net, i64 %threshold, i64 %all) #0 {
entry:
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 1824944937, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %red_cost = alloca i64, align 8
  %new_arc = alloca %struct.arc*, align 8
  %all.addr = alloca i64, align 8
...
entry:
  ...
  %new_arcs = alloca i64, align 8
  %canary = alloca i32
  store i32 1519807263, i32* %canary
  %stop = alloca %struct.arc*, align 8
  %retval = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
  %head_potential = alloca i64, align 8
...
return:                                           ; preds = %if.end109, %if.then10
  %143 = load i64, i64* %retval, align 8
  %144 = load i32, i32* %canary
  %145 = icmp eq i32 %144, 1519807263
  br i1 %145, label %146, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @resize_prob.15(%struct.network* %net) #0 {
entry:
  %net.addr = alloca %struct.network*, align 8
  %node = alloca %struct.node*, align 8
  %retval = alloca i64, align 8
  %root = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 993822306, i32* %canary
  %off = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
  %stop = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @suspend_impl.16(%struct.network* %net, i64 %threshold, i64 %all) #0 {
entry:
  %threshold.addr = alloca i64, align 8
  %all.addr = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 1468142170, i32* %canary
  %susp = alloca i64, align 8
  %new_arc = alloca %struct.arc*, align 8
  %stop = alloca i8*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  ...
  %threshold.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 111324948, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %stop = alloca i8*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 %threshold, i64* %threshold.addr, align 8
...
entry:
  ...
  %red_cost.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1758447596, i32* %canary
  %tail.addr = alloca %struct.node*, align 8
  store %struct.arc* %new, %struct.arc** %new.addr, align 8
  store i64 %newpos, i64* %newpos.addr, align 8
  store %struct.node* %tail, %struct.node** %tail.addr, align 8
...
entry:
  ...
  %head.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1297655439, i32* %canary
  %tail.addr = alloca %struct.node*, align 8
  %newpos.addr = alloca i64, align 8
  %red_cost.addr = alloca i64, align 8
  %cost.addr = alloca i64, align 8
...
entry:
  ...
  %tail.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 121762565, i32* %canary
  %cost.addr = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store %struct.arc* %new, %struct.arc** %new.addr, align 8
  store %struct.node* %tail, %struct.node** %tail.addr, align 8
