; ModuleID = 'pflowup.c.rand.16P2.bc'
...
entry:
  ...
  %canary = alloca i32
  store i32 1684111149, i32* %canary
...
entry:
  ...
  %jplus.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1793213284, i32* %canary
  %iplus.addr = alloca %struct.node*, align 8
  store %struct.node* %iplus, %struct.node** %iplus.addr, align 8
  store %struct.node* %jplus, %struct.node** %jplus.addr, align 8
  store %struct.node* %w, %struct.node** %w.addr, align 8
...
entry:
  %iplus.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 496880433, i32* %canary
  %w.addr = alloca %struct.node*, align 8
  %jplus.addr = alloca %struct.node*, align 8
  store %struct.node* %iplus, %struct.node** %iplus.addr, align 8
  store %struct.node* %jplus, %struct.node** %jplus.addr, align 8
...
entry:
  ...
  %iplus.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 465472745, i32* %canary
  %jplus.addr = alloca %struct.node*, align 8
  store %struct.node* %iplus, %struct.node** %iplus.addr, align 8
  store %struct.node* %jplus, %struct.node** %jplus.addr, align 8
  store %struct.node* %w, %struct.node** %w.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1793278589, i32* %canary
  %jplus.addr = alloca %struct.node*, align 8
  %w.addr = alloca %struct.node*, align 8
  %iplus.addr = alloca %struct.node*, align 8
  store %struct.node* %iplus, %struct.node** %iplus.addr, align 8
...
entry:
  %jplus.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1926632208, i32* %canary
  %iplus.addr = alloca %struct.node*, align 8
  %w.addr = alloca %struct.node*, align 8
  store %struct.node* %iplus, %struct.node** %iplus.addr, align 8
  store %struct.node* %jplus, %struct.node** %jplus.addr, align 8
