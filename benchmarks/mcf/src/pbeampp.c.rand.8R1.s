...
# %bb.0:                                # %entry
	...
	subq	$88, %rsp
	.cfi_offset %rbx, -24
	movl	$598648255, -44(%rbp)   # imm = 0x23AEA5BF
	movq	%rdi, -88(%rbp)
	movq	%rsi, -80(%rbp)
	movq	%rdx, -96(%rbp)
	movq	%rcx, -64(%rbp)
...
.LBB3_41:                               # %return
	movq	-56(%rbp), %rbx
	cmpl	$598648255, -44(%rbp)   # imm = 0x23AEA5BF
	jne	.LBB3_43
.LBB3_42:
	movq	%rbx, %rax
	addq	$88, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$578074000, -12(%rbp)   # imm = 0x2274B590
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	cmpq	$0, -24(%rbp)
	jge	.LBB4_2
...
.LBB4_5:                                # %lor.end
	andb	$1, %al
	movzbl	%al, %ebx
	cmpl	$578074000, -12(%rbp)   # imm = 0x2274B590
	jne	.LBB4_7
.LBB4_6:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$906624438, -36(%rbp)   # imm = 0x3609FDB6
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movq	-32(%rbp), %rax
	movq	%rax, -8(%rbp)
...
# %bb.17:                               # %if.then25
	...
	callq	sort_basket
.LBB5_18:                               # %if.end26
	cmpl	$906624438, -36(%rbp)   # imm = 0x3609FDB6
	jne	.LBB5_20
.LBB5_19:
	addq	$64, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	subq	$88, %rsp
	.cfi_offset %rbx, -24
	movl	$1861754666, -44(%rbp)  # imm = 0x6EF81F2A
	movq	%rdi, -72(%rbp)
	movq	%rsi, -88(%rbp)
	movq	%rdx, -80(%rbp)
	movq	%rcx, -56(%rbp)
...
.LBB6_41:                               # %return
	movq	-64(%rbp), %rbx
	cmpl	$1861754666, -44(%rbp)  # imm = 0x6EF81F2A
	jne	.LBB6_43
.LBB6_42:
	movq	%rbx, %rax
	addq	$88, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$7310521, -36(%rbp)     # imm = 0x6F8CB9
	movq	%rdi, -24(%rbp)
	movq	%rsi, -32(%rbp)
	movq	-24(%rbp), %rax
	movq	%rax, -8(%rbp)
...
# %bb.17:                               # %if.then25
	...
	callq	sort_basket
.LBB7_18:                               # %if.end26
	cmpl	$7310521, -36(%rbp)     # imm = 0x6F8CB9
	jne	.LBB7_20
.LBB7_19:
	addq	$64, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$701155998, -36(%rbp)   # imm = 0x29CACA9E
	movq	%rdi, -24(%rbp)
	movq	%rsi, -32(%rbp)
	movq	-24(%rbp), %rax
	movq	%rax, -8(%rbp)
...
# %bb.17:                               # %if.then25
	...
	callq	sort_basket
.LBB8_18:                               # %if.end26
	cmpl	$701155998, -36(%rbp)   # imm = 0x29CACA9E
	jne	.LBB8_20
.LBB8_19:
	addq	$64, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$2139873480, -36(%rbp)  # imm = 0x7F8BE0C8
	movq	%rdi, -24(%rbp)
	movq	%rsi, -32(%rbp)
	movq	-24(%rbp), %rax
	movq	%rax, -8(%rbp)
...
# %bb.17:                               # %if.then25
	...
	callq	sort_basket
.LBB9_18:                               # %if.end26
	cmpl	$2139873480, -36(%rbp)  # imm = 0x7F8BE0C8
	jne	.LBB9_20
.LBB9_19:
	addq	$64, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	subq	$88, %rsp
	.cfi_offset %rbx, -24
	movl	$733447308, -44(%rbp)   # imm = 0x2BB7848C
	movq	%rdi, -88(%rbp)
	movq	%rsi, -80(%rbp)
	movq	%rdx, -96(%rbp)
	movq	%rcx, -64(%rbp)
...
.LBB10_41:                              # %return
	movq	-56(%rbp), %rbx
	cmpl	$733447308, -44(%rbp)   # imm = 0x2BB7848C
	jne	.LBB10_43
.LBB10_42:
	movq	%rbx, %rax
	addq	$88, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$1092861795, -12(%rbp)  # imm = 0x4123BF63
	movq	%rdi, -24(%rbp)
	movq	%rsi, -32(%rbp)
	cmpq	$0, -32(%rbp)
	jge	.LBB11_2
...
.LBB11_5:                               # %lor.end
	andb	$1, %al
	movzbl	%al, %ebx
	cmpl	$1092861795, -12(%rbp)  # imm = 0x4123BF63
	jne	.LBB11_7
.LBB11_6:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$88, %rsp
	.cfi_offset %rbx, -24
	movl	$1290221622, -44(%rbp)  # imm = 0x4CE73836
	movq	%rdi, -88(%rbp)
	movq	%rsi, -96(%rbp)
	movq	%rdx, -72(%rbp)
	movq	%rcx, -64(%rbp)
...
.LBB12_41:                              # %return
	movq	-56(%rbp), %rbx
	cmpl	$1290221622, -44(%rbp)  # imm = 0x4CE73836
	jne	.LBB12_43
.LBB12_42:
	movq	%rbx, %rax
	addq	$88, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$88, %rsp
	.cfi_offset %rbx, -24
	movl	$56178028, -44(%rbp)    # imm = 0x359356C
	movq	%rdi, -72(%rbp)
	movq	%rsi, -88(%rbp)
	movq	%rdx, -96(%rbp)
	movq	%rcx, -56(%rbp)
...
.LBB13_41:                              # %return
	movq	-64(%rbp), %rbx
	cmpl	$56178028, -44(%rbp)    # imm = 0x359356C
	jne	.LBB13_43
.LBB13_42:
	movq	%rbx, %rax
	addq	$88, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$88, %rsp
	.cfi_offset %rbx, -24
	movl	$854724286, -44(%rbp)   # imm = 0x32F20EBE
	movq	%rdi, -72(%rbp)
	movq	%rsi, -96(%rbp)
	movq	%rdx, -80(%rbp)
	movq	%rcx, -64(%rbp)
...
.LBB14_41:                              # %return
	movq	-56(%rbp), %rbx
	cmpl	$854724286, -44(%rbp)   # imm = 0x32F20EBE
	jne	.LBB14_43
.LBB14_42:
	movq	%rbx, %rax
	addq	$88, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$143655171, -36(%rbp)   # imm = 0x8900103
	movq	%rdi, -24(%rbp)
	movq	%rsi, -32(%rbp)
	movq	-24(%rbp), %rax
	movq	%rax, -8(%rbp)
...
# %bb.17:                               # %if.then25
	...
	callq	sort_basket
.LBB15_18:                              # %if.end26
	cmpl	$143655171, -36(%rbp)   # imm = 0x8900103
	jne	.LBB15_20
.LBB15_19:
	addq	$64, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$1165160919, -36(%rbp)  # imm = 0x4572F1D7
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movq	-32(%rbp), %rax
	movq	%rax, -8(%rbp)
...
# %bb.17:                               # %if.then25
	...
	callq	sort_basket
.LBB16_18:                              # %if.end26
	cmpl	$1165160919, -36(%rbp)  # imm = 0x4572F1D7
	jne	.LBB16_20
.LBB16_19:
	addq	$64, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	subq	$88, %rsp
	.cfi_offset %rbx, -24
	movl	$167491182, -44(%rbp)   # imm = 0x9FBB66E
	movq	%rdi, -88(%rbp)
	movq	%rsi, -80(%rbp)
	movq	%rdx, -72(%rbp)
	movq	%rcx, -56(%rbp)
...
.LBB17_41:                              # %return
	movq	-64(%rbp), %rbx
	cmpl	$167491182, -44(%rbp)   # imm = 0x9FBB66E
	jne	.LBB17_43
.LBB17_42:
	movq	%rbx, %rax
	addq	$88, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$634534187, -36(%rbp)   # imm = 0x25D2392B
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movq	-32(%rbp), %rax
	movq	%rax, -8(%rbp)
...
# %bb.17:                               # %if.then25
	...
	callq	sort_basket
.LBB18_18:                              # %if.end26
	cmpl	$634534187, -36(%rbp)   # imm = 0x25D2392B
	jne	.LBB18_20
.LBB18_19:
	addq	$64, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	subq	$88, %rsp
	.cfi_offset %rbx, -24
	movl	$1643577501, -44(%rbp)  # imm = 0x61F7009D
	movq	%rdi, -88(%rbp)
	movq	%rsi, -72(%rbp)
	movq	%rdx, -80(%rbp)
	movq	%rcx, -64(%rbp)
...
.LBB19_41:                              # %return
	movq	-56(%rbp), %rbx
	cmpl	$1643577501, -44(%rbp)  # imm = 0x61F7009D
	jne	.LBB19_43
.LBB19_42:
	movq	%rbx, %rax
	addq	$88, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$56452341, -36(%rbp)    # imm = 0x35D64F5
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movq	-32(%rbp), %rax
	movq	%rax, -8(%rbp)
...
# %bb.17:                               # %if.then25
	...
	callq	sort_basket
.LBB20_18:                              # %if.end26
	cmpl	$56452341, -36(%rbp)    # imm = 0x35D64F5
	jne	.LBB20_20
.LBB20_19:
	addq	$64, %rsp
	popq	%rbp
