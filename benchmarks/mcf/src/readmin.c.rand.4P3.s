...
# %bb.0:                                # %entry
	...
	.cfi_offset %rbx, -24
	movl	$1505125112, -76(%rbp)  # imm = 0x59B662F8
	movq	%rdi, -16(%rbp)
	movq	$0, -72(%rbp)
	movq	-16(%rbp), %rdi
	movabsq	$.L.str, %rsi
...
.LBB1_46:                               # %return
	movq	-56(%rbp), %rbx
	cmpl	$1505125112, -76(%rbp)  # imm = 0x59B662F8
	jne	.LBB1_48
.LBB1_47:
	movq	%rbx, %rax
...
# %bb.0:                                # %entry
	...
	subq	$296, %rsp              # imm = 0x128
	.cfi_offset %rbx, -24
	movl	$1323304128, -76(%rbp)  # imm = 0x4EE004C0
	movq	%rdi, -16(%rbp)
	movq	$0, -72(%rbp)
	movq	-16(%rbp), %rdi
	movabsq	$.L.str, %rsi
...
.LBB2_46:                               # %return
	movq	-64(%rbp), %rbx
	cmpl	$1323304128, -76(%rbp)  # imm = 0x4EE004C0
	jne	.LBB2_48
.LBB2_47:
	movq	%rbx, %rax
	addq	$296, %rsp              # imm = 0x128
...
# %bb.0:                                # %entry
	...
	subq	$296, %rsp              # imm = 0x128
	.cfi_offset %rbx, -24
	movl	$764030107, -76(%rbp)   # imm = 0x2D8A2C9B
	movq	%rdi, -16(%rbp)
	movq	$0, -72(%rbp)
	movq	-16(%rbp), %rdi
	movabsq	$.L.str, %rsi
...
.LBB3_46:                               # %return
	movq	-56(%rbp), %rbx
	cmpl	$764030107, -76(%rbp)   # imm = 0x2D8A2C9B
	jne	.LBB3_48
.LBB3_47:
	movq	%rbx, %rax
	addq	$296, %rsp              # imm = 0x128
...
# %bb.0:                                # %entry
	...
	subq	$296, %rsp              # imm = 0x128
	.cfi_offset %rbx, -24
	movl	$1527785231, -76(%rbp)  # imm = 0x5B10270F
	movq	%rdi, -16(%rbp)
	movq	$0, -72(%rbp)
	movq	-16(%rbp), %rdi
	movabsq	$.L.str, %rsi
...
.LBB4_46:                               # %return
	movq	-64(%rbp), %rbx
	cmpl	$1527785231, -76(%rbp)  # imm = 0x5B10270F
	jne	.LBB4_48
.LBB4_47:
	movq	%rbx, %rax
	addq	$296, %rsp              # imm = 0x128
