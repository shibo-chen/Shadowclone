; ModuleID = 'readmin.c.rand.4P1.bc'
...
func_read_min.4:                                  ; preds = %ctrl1
  %5 = call i64 @read_min.4(%struct.network* %net)
  ret i64 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_read_min.2, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_read_min.3, label %func_read_min.4
}
...
entry:
  ...
  %canary = alloca i32
  store i32 1096369619, i32* %canary
...
return:                                           ; preds = %for.end228, %if.then147, %if.then134, %if.then57, %if.then34, %if.then6, %if.then
  ...
  %249 = icmp eq i32 %248, 1096369619
...
entry:
  ...
  %instring = alloca [201 x i8], align 16
  %canary = alloca i32
  store i32 1337167594, i32* %canary
  %i = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
  %t = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
return:                                           ; preds = %for.end228, %if.then147, %if.then134, %if.then57, %if.then34, %if.then6, %if.then
  %247 = load i64, i64* %retval, align 8
  %248 = load i32, i32* %canary
  %249 = icmp eq i32 %248, 1337167594
  br i1 %249, label %250, label %func_exit
...
entry:
  ...
  %i = alloca i64, align 8
  %canary = alloca i32
  store i32 1234636138, i32* %canary
  %h = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
  %instring = alloca [201 x i8], align 16
  %retval = alloca i64, align 8
...
return:                                           ; preds = %for.end228, %if.then147, %if.then134, %if.then57, %if.then34, %if.then6, %if.then
  %247 = load i64, i64* %retval, align 8
  %248 = load i32, i32* %canary
  %249 = icmp eq i32 %248, 1234636138
  br i1 %249, label %250, label %func_exit
...
entry:
  %instring = alloca [201 x i8], align 16
  %canary = alloca i32
  store i32 1067162416, i32* %canary
  %retval = alloca i64, align 8
  %node = alloca %struct.node*, align 8
  %h = alloca i64, align 8
  %t = alloca i64, align 8
...
return:                                           ; preds = %for.end228, %if.then147, %if.then134, %if.then57, %if.then34, %if.then6, %if.then
  %247 = load i64, i64* %retval, align 8
  %248 = load i32, i32* %canary
  %249 = icmp eq i32 %248, 1067162416
  br i1 %249, label %250, label %func_exit
