...
entry:
  %canary = alloca i32
  store i32 295569890, i32* %canary
...
entry:
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1217153339, i32* %canary
  %arc2 = alloca %struct.arc*, align 8
  %retval = alloca i64, align 8
  store i8* %outfile, i8** %outfile.addr, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  ...
  %block = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1307704622, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %first_impl = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
  %arc2 = alloca %struct.arc*, align 8
...
entry:
  ...
  %first_impl = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 395975944, i32* %canary
  %arc2 = alloca %struct.arc*, align 8
  %block = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
  %out = alloca %struct._IO_FILE*, align 8
...
entry:
  ...
  %block = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1116646737, i32* %canary
  %retval = alloca i64, align 8
  %out = alloca %struct._IO_FILE*, align 8
  %arc2 = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
...
entry:
  %canary = alloca i32
  store i32 1547447387, i32* %canary
  %retval = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
  %outfile.addr = alloca i8*, align 8
  %arc2 = alloca %struct.arc*, align 8
...
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 1059808147, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %outfile.addr = alloca i8*, align 8
  %arc2 = alloca %struct.arc*, align 8
  store i8* %outfile, i8** %outfile.addr, align 8
...
entry:
  ...
  %arc2 = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 146940368, i32* %canary
  %arc = alloca %struct.arc*, align 8
  store i8* %outfile, i8** %outfile.addr, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store %struct._IO_FILE* null, %struct._IO_FILE** %out, align 8
...
entry:
  ...
  %retval = alloca i64, align 8
  %canary = alloca i32
  store i32 163007550, i32* %canary
  %first_impl = alloca %struct.arc*, align 8
  %arc2 = alloca %struct.arc*, align 8
  %arc = alloca %struct.arc*, align 8
  store i8* %outfile, i8** %outfile.addr, align 8
...
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 520414790, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %retval = alloca i64, align 8
  %out = alloca %struct._IO_FILE*, align 8
  %first_impl = alloca %struct.arc*, align 8
...
entry:
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 428831469, i32* %canary
  %block = alloca %struct.arc*, align 8
  store i8* %outfile, i8** %outfile.addr, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store %struct._IO_FILE* null, %struct._IO_FILE** %out, align 8
...
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 416361681, i32* %canary
  %outfile.addr = alloca i8*, align 8
  %arc2 = alloca %struct.arc*, align 8
  %first_impl = alloca %struct.arc*, align 8
  %arc = alloca %struct.arc*, align 8
...
entry:
  ...
  %block = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 798691256, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %arc2 = alloca %struct.arc*, align 8
  %arc = alloca %struct.arc*, align 8
  store i8* %outfile, i8** %outfile.addr, align 8
...
entry:
  ...
  %arc2 = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1992528614, i32* %canary
  %block = alloca %struct.arc*, align 8
  %out = alloca %struct._IO_FILE*, align 8
  %outfile.addr = alloca i8*, align 8
  store i8* %outfile, i8** %outfile.addr, align 8
...
entry:
  ...
  %retval = alloca i64, align 8
  %canary = alloca i32
  store i32 1273688644, i32* %canary
  %block = alloca %struct.arc*, align 8
  %out = alloca %struct._IO_FILE*, align 8
  %outfile.addr = alloca i8*, align 8
  %arc = alloca %struct.arc*, align 8
