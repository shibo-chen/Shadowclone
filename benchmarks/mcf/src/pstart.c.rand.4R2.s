...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$48, %rsp
	movl	$1565850394, -44(%rbp)  # imm = 0x5D54FB1A
	movq	%rdi, -32(%rbp)
	movq	-32(%rbp), %rax
	movq	552(%rax), %rax
	movq	%rax, -8(%rbp)
...
.LBB1_10:                               # %for.end21
	...
	movq	-16(%rbp), %rax
	movq	$0, 40(%rax)
	cmpl	$1565850394, -44(%rbp)  # imm = 0x5D54FB1A
	jne	.LBB1_12
.LBB1_11:
	xorl	%eax, %eax
	addq	$48, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$48, %rsp
	movl	$1934558704, -44(%rbp)  # imm = 0x734F05F0
	movq	%rdi, -32(%rbp)
	movq	-32(%rbp), %rax
	movq	552(%rax), %rax
	movq	%rax, -8(%rbp)
...
.LBB2_10:                               # %for.end21
	...
	movq	-16(%rbp), %rax
	movq	$0, 40(%rax)
	cmpl	$1934558704, -44(%rbp)  # imm = 0x734F05F0
	jne	.LBB2_12
.LBB2_11:
	xorl	%eax, %eax
	addq	$48, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$48, %rsp
	movl	$1030320607, -44(%rbp)  # imm = 0x3D6971DF
	movq	%rdi, -32(%rbp)
	movq	-32(%rbp), %rax
	movq	552(%rax), %rax
	movq	%rax, -8(%rbp)
...
.LBB3_10:                               # %for.end21
	...
	movq	-16(%rbp), %rax
	movq	$0, 40(%rax)
	cmpl	$1030320607, -44(%rbp)  # imm = 0x3D6971DF
	jne	.LBB3_12
.LBB3_11:
	xorl	%eax, %eax
	addq	$48, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$48, %rsp
	movl	$406523198, -44(%rbp)   # imm = 0x183B0D3E
	movq	%rdi, -32(%rbp)
	movq	-32(%rbp), %rax
	movq	552(%rax), %rax
	movq	%rax, -8(%rbp)
...
.LBB4_10:                               # %for.end21
	...
	movq	-16(%rbp), %rax
	movq	$0, 40(%rax)
	cmpl	$406523198, -44(%rbp)   # imm = 0x183B0D3E
	jne	.LBB4_12
.LBB4_11:
	xorl	%eax, %eax
	addq	$48, %rsp
