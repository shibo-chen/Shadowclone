; ModuleID = 'mcfutil.c.rand.4R1.bc'
...
func_refresh_neighbour_lists.5:                   ; preds = %ctrl0
  call void @refresh_neighbour_lists.5(%struct.network* %net)
  ret void

func_refresh_neighbour_lists.8:                   ; preds = %ctrl1
  call void @refresh_neighbour_lists.8(%struct.network* %net)
  ret void

func_refresh_neighbour_lists.10:                  ; preds = %ctrl1
  call void @refresh_neighbour_lists.10(%struct.network* %net)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_refresh_neighbour_lists.5, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_refresh_neighbour_lists.8, label %func_refresh_neighbour_lists.10
}
...
func_refresh_potential.14:                        ; preds = %ctrl0
  %3 = call i64 @refresh_potential.14(%struct.network* %net)
  ret i64 %3
...
func_refresh_potential.22:                        ; preds = %ctrl1
  %5 = call i64 @refresh_potential.22(%struct.network* %net)
  ret i64 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_refresh_potential.14, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_refresh_potential.16, label %func_refresh_potential.22
}
...
func_flow_cost.23:                                ; preds = %ctrl1
  %5 = call double @flow_cost.23(%struct.network* %net)
  ret double %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_flow_cost.20, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_flow_cost.21, label %func_flow_cost.23
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_flow_org_cost.9, label %ctrl0

func_flow_org_cost.9:                             ; preds = %rand_bb
  %2 = call double @flow_org_cost.9(%struct.network* %net)
  ret double %2

func_flow_org_cost.12:                            ; preds = %ctrl0
  %3 = call double @flow_org_cost.12(%struct.network* %net)
  ret double %3

func_flow_org_cost.17:                            ; preds = %ctrl1
  %4 = call double @flow_org_cost.17(%struct.network* %net)
  ret double %4

func_flow_org_cost.19:                            ; preds = %ctrl1
  %5 = call double @flow_org_cost.19(%struct.network* %net)
  ret double %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_flow_org_cost.12, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_flow_org_cost.17, label %func_flow_org_cost.19
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_primal_feasible.1, label %ctrl0

func_primal_feasible.1:                           ; preds = %rand_bb
  %2 = call i64 @primal_feasible.1(%struct.network* %net)
  ret i64 %2

func_primal_feasible.2:                           ; preds = %ctrl0
  %3 = call i64 @primal_feasible.2(%struct.network* %net)
  ret i64 %3

func_primal_feasible.6:                           ; preds = %ctrl1
  %4 = call i64 @primal_feasible.6(%struct.network* %net)
  ret i64 %4

func_primal_feasible.13:                          ; preds = %ctrl1
  %5 = call i64 @primal_feasible.13(%struct.network* %net)
  ret i64 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_primal_feasible.2, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_primal_feasible.6, label %func_primal_feasible.13
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_dual_feasible.7, label %ctrl0

func_dual_feasible.7:                             ; preds = %rand_bb
  %2 = call i64 @dual_feasible.7(%struct.network* %net)
  ret i64 %2

func_dual_feasible.11:                            ; preds = %ctrl0
  %3 = call i64 @dual_feasible.11(%struct.network* %net)
  ret i64 %3
...
func_dual_feasible.24:                            ; preds = %ctrl1
  %5 = call i64 @dual_feasible.24(%struct.network* %net)
  ret i64 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_dual_feasible.11, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_dual_feasible.15, label %func_dual_feasible.24
}
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @primal_feasible.1(%struct.network* %net) #0 {
entry:
  %net.addr = alloca %struct.network*, align 8
  %node = alloca %struct.node*, align 8
  %flow = alloca i64, align 8
  %canary = alloca i32
  store i32 148110790, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @primal_feasible.2(%struct.network* %net) #0 {
entry:
  %dummy = alloca %struct.arc*, align 8
  %node = alloca %struct.node*, align 8
  %flow = alloca i64, align 8
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 2127239562, i32* %canary
  %retval = alloca i64, align 8
  %stop_dummy = alloca %struct.arc*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
...
entry:
  ...
  %stop = alloca i8*, align 8
  %canary = alloca i32
  store i32 1098477372, i32* %canary
  %node = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
  %nodes = getelementptr inbounds %struct.network, %struct.network* %0, i32 0, i32 21
...
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 418740633, i32* %canary
  %node = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
  %nodes = getelementptr inbounds %struct.network, %struct.network* %0, i32 0, i32 21
...
entry:
  ...
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1620405497, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
  %nodes = getelementptr inbounds %struct.network, %struct.network* %0, i32 0, i32 21
...
entry:
  ...
  %retval = alloca i64, align 8
  %canary = alloca i32
  store i32 1705094052, i32* %canary
  %stop = alloca i8*, align 8
  %stop_dummy = alloca %struct.arc*, align 8
  %arc = alloca %struct.arc*, align 8
  %dummy = alloca %struct.arc*, align 8
...
entry:
  ...
  %canary = alloca i32
  store i32 723936285, i32* %canary
  %net.addr = alloca %struct.network*, align 8
...
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 2012891118, i32* %canary
  %stop = alloca i8*, align 8
  %node = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local double @flow_org_cost.9(%struct.network* %net) #0 {
entry:
  %canary = alloca i32
  store i32 622186432, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %stop = alloca i8*, align 8
...
entry:
  ...
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1086115956, i32* %canary
  %stop = alloca i8*, align 8
  %arc = alloca %struct.arc*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1018000914, i32* %canary
  %retval = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
  %stop = alloca %struct.arc*, align 8
...
entry:
  ...
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1573709595, i32* %canary
  %fleet = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 0, i64* %fleet, align 8
  store i64 0, i64* %operational_cost, align 8
...
entry:
  ...
  %stop_dummy = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1704824780, i32* %canary
  %flow = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
  %dummy_arcs = getelementptr inbounds %struct.network, %struct.network* %0, i32 0, i32 25
...
entry:
  ...
  %tmp = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1468938172, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %root = alloca %struct.node*, align 8
  %node = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1692391967, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %red_cost = alloca i64, align 8
  %retval = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  ...
  %checksum = alloca i64, align 8
  %canary = alloca i32
  store i32 828382752, i32* %canary
  %node = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
  %nodes = getelementptr inbounds %struct.network, %struct.network* %0, i32 0, i32 21
...
entry:
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 1578410957, i32* %canary
  %stop = alloca i8*, align 8
  %arc = alloca %struct.arc*, align 8
  %fleet = alloca i64, align 8
  %operational_cost = alloca i64, align 8
...
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 623248545, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %stop = alloca i8*, align 8
  %fleet = alloca i64, align 8
  %node = alloca %struct.node*, align 8
...
entry:
  ...
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 951027542, i32* %canary
  %fleet = alloca i64, align 8
  %stop = alloca i8*, align 8
  %net.addr = alloca %struct.network*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  ...
  %fleet = alloca i64, align 8
  %canary = alloca i32
  store i32 838696828, i32* %canary
  %stop = alloca i8*, align 8
  %arc = alloca %struct.arc*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 0, i64* %fleet, align 8
...
entry:
  %tmp = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1496199585, i32* %canary
  %node = alloca %struct.node*, align 8
  %root = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
  %checksum = alloca i64, align 8
...
entry:
  %operational_cost = alloca i64, align 8
  %canary = alloca i32
  store i32 2145421520, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %stop = alloca i8*, align 8
  %node = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
...
entry:
  %retval = alloca i64, align 8
  %canary = alloca i32
  store i32 949304614, i32* %canary
  %red_cost = alloca i64, align 8
  %stop = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
  %arc = alloca %struct.arc*, align 8
