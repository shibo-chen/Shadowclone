...
entry:
  ...
  %canary = alloca i32
  store i32 161317200, i32* %canary
...
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 1244515242, i32* %canary
  %out = alloca %struct._IO_FILE*, align 8
  store i8* %outfile, i8** %outfile.addr, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store %struct._IO_FILE* null, %struct._IO_FILE** %out, align 8
...
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 596215321, i32* %canary
  %retval = alloca i64, align 8
  %block = alloca %struct.arc*, align 8
  %arc = alloca %struct.arc*, align 8
  %arc2 = alloca %struct.arc*, align 8
...
entry:
  %canary = alloca i32
  store i32 1146317760, i32* %canary
  %retval = alloca i64, align 8
  %arc2 = alloca %struct.arc*, align 8
  %first_impl = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
...
entry:
  ...
  %out = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 885569176, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %outfile.addr = alloca i8*, align 8
  %block = alloca %struct.arc*, align 8
  %first_impl = alloca %struct.arc*, align 8
...
entry:
  ...
  %out = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 827152567, i32* %canary
  %block = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
  store i8* %outfile, i8** %outfile.addr, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 1501315107, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %first_impl = alloca %struct.arc*, align 8
  %block = alloca %struct.arc*, align 8
  %retval = alloca i64, align 8
...
entry:
  ...
  %out = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 1033943357, i32* %canary
  %retval = alloca i64, align 8
  store i8* %outfile, i8** %outfile.addr, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store %struct._IO_FILE* null, %struct._IO_FILE** %out, align 8
