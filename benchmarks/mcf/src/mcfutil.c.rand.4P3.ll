; ModuleID = 'mcfutil.c.rand.4P3.bc'
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_refresh_neighbour_lists.4, label %ctrl0

func_refresh_neighbour_lists.4:                   ; preds = %rand_bb
  call void @refresh_neighbour_lists.4(%struct.network* %net)
  ret void

func_refresh_neighbour_lists.10:                  ; preds = %ctrl0
...
func_refresh_neighbour_lists.12:                  ; preds = %ctrl1
  call void @refresh_neighbour_lists.12(%struct.network* %net)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_refresh_neighbour_lists.10, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_refresh_neighbour_lists.11, label %func_refresh_neighbour_lists.12
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_refresh_potential.21, label %ctrl0

func_refresh_potential.21:                        ; preds = %rand_bb
  %2 = call i64 @refresh_potential.21(%struct.network* %net)
  ret i64 %2

func_refresh_potential.22:                        ; preds = %ctrl0
  %3 = call i64 @refresh_potential.22(%struct.network* %net)
  ret i64 %3

func_refresh_potential.23:                        ; preds = %ctrl1
  %4 = call i64 @refresh_potential.23(%struct.network* %net)
  ret i64 %4

func_refresh_potential.24:                        ; preds = %ctrl1
  %5 = call i64 @refresh_potential.24(%struct.network* %net)
  ret i64 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_refresh_potential.22, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_refresh_potential.23, label %func_refresh_potential.24
}
...
func_flow_cost.7:                                 ; preds = %ctrl0
  %3 = call double @flow_cost.7(%struct.network* %net)
  ret double %3

func_flow_cost.8:                                 ; preds = %ctrl1
  %4 = call double @flow_cost.8(%struct.network* %net)
  ret double %4

func_flow_cost.9:                                 ; preds = %ctrl1
  %5 = call double @flow_cost.9(%struct.network* %net)
  ret double %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_flow_cost.7, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_flow_cost.8, label %func_flow_cost.9
}
...
func_flow_org_cost.16:                            ; preds = %ctrl0
  %3 = call double @flow_org_cost.16(%struct.network* %net)
  ret double %3
...
func_flow_org_cost.20:                            ; preds = %ctrl1
  %5 = call double @flow_org_cost.20(%struct.network* %net)
  ret double %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_flow_org_cost.16, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_flow_org_cost.17, label %func_flow_org_cost.20
}
...
func_primal_feasible.5:                           ; preds = %ctrl0
  %3 = call i64 @primal_feasible.5(%struct.network* %net)
  ret i64 %3
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_primal_feasible.5, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_primal_feasible.15, label %func_primal_feasible.19
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_dual_feasible.6, label %ctrl0

func_dual_feasible.6:                             ; preds = %rand_bb
  %2 = call i64 @dual_feasible.6(%struct.network* %net)
  ret i64 %2

func_dual_feasible.13:                            ; preds = %ctrl0
  %3 = call i64 @dual_feasible.13(%struct.network* %net)
  ret i64 %3
...
func_dual_feasible.18:                            ; preds = %ctrl1
  %5 = call i64 @dual_feasible.18(%struct.network* %net)
  ret i64 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_dual_feasible.13, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_dual_feasible.14, label %func_dual_feasible.18
}
...
entry:
  ...
  %canary = alloca i32
  store i32 1234986119, i32* %canary
  %net.addr = alloca %struct.network*, align 8
...
entry:
  ...
  %operational_cost = alloca i64, align 8
  %canary = alloca i32
  store i32 222227982, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %arc = alloca %struct.arc*, align 8
  %stop = alloca i8*, align 8
  %fleet = alloca i64, align 8
...
entry:
  ...
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1773874194, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @refresh_neighbour_lists.4(%struct.network* %net) #0 {
entry:
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1560212504, i32* %canary
  %node = alloca %struct.node*, align 8
  %stop = alloca i8*, align 8
  %net.addr = alloca %struct.network*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @primal_feasible.5(%struct.network* %net) #0 {
entry:
  %arc = alloca %struct.arc*, align 8
  %retval = alloca i64, align 8
  %stop = alloca i8*, align 8
  ...
  %dummy = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1628028146, i32* %canary
  %stop_dummy = alloca %struct.arc*, align 8
  %node = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
...
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 1281407773, i32* %canary
...
entry:
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 606279429, i32* %canary
  %stop = alloca i8*, align 8
  %operational_cost = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
  %fleet = alloca i64, align 8
...
entry:
  ...
  %fleet = alloca i64, align 8
  %canary = alloca i32
  store i32 491716434, i32* %canary
  %node = alloca %struct.node*, align 8
  %arc = alloca %struct.arc*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 0, i64* %fleet, align 8
...
entry:
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 607602220, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %node = alloca %struct.node*, align 8
  %stop = alloca i8*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 1383646571, i32* %canary
  %stop = alloca i8*, align 8
  %arc = alloca %struct.arc*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 771207074, i32* %canary
  %stop = alloca i8*, align 8
  %arc = alloca %struct.arc*, align 8
  %node = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
...
entry:
  %red_cost = alloca i64, align 8
  %canary = alloca i32
  store i32 1625376101, i32* %canary
  %retval = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
  %stop = alloca %struct.arc*, align 8
...
entry:
  ...
  %retval = alloca i64, align 8
  %canary = alloca i32
  store i32 1647252339, i32* %canary
  %red_cost = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
  %stop_arcs = getelementptr inbounds %struct.network, %struct.network* %0, i32 0, i32 24
...
entry:
  %stop_dummy = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 2103133427, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %dummy = alloca %struct.arc*, align 8
  %node = alloca %struct.node*, align 8
  %flow = alloca i64, align 8
...
entry:
  ...
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 491444985, i32* %canary
  %arc = alloca %struct.arc*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 0, i64* %fleet, align 8
  store i64 0, i64* %operational_cost, align 8
...
entry:
  ...
  %fleet = alloca i64, align 8
  %canary = alloca i32
  store i32 1298735860, i32* %canary
  %stop = alloca i8*, align 8
  %net.addr = alloca %struct.network*, align 8
  %operational_cost = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
...
entry:
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1632124064, i32* %canary
  %retval = alloca i64, align 8
  %stop = alloca %struct.arc*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1674506766, i32* %canary
  %dummy = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
  %node = alloca %struct.node*, align 8
  %retval = alloca i64, align 8
...
entry:
  ...
  %operational_cost = alloca i64, align 8
  %canary = alloca i32
  store i32 2055535569, i32* %canary
  %stop = alloca i8*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 0, i64* %fleet, align 8
  store i64 0, i64* %operational_cost, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @refresh_potential.21(%struct.network* %net) #0 {
entry:
  %net.addr = alloca %struct.network*, align 8
  %tmp = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1048377870, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 248108753, i32* %canary
  %root = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
  %tmp = alloca %struct.node*, align 8
  %checksum = alloca i64, align 8
...
entry:
  %tmp = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1084025520, i32* %canary
  %node = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
  %checksum = alloca i64, align 8
  %root = alloca %struct.node*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @refresh_potential.24(%struct.network* %net) #0 {
entry:
  %net.addr = alloca %struct.network*, align 8
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 656474817, i32* %canary
  %root = alloca %struct.node*, align 8
  %tmp = alloca %struct.node*, align 8
  %checksum = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
