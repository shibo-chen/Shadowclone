...
# %bb.0:                                # %rand_bb
	...
	cmpl	$0, %eax
	jne	.LBB0_2
# %bb.1:                                # %func_bea_is_dual_infeasible.7
	movq	%rbx, %rdi
	movq	%r14, %rsi
	callq	bea_is_dual_infeasible.7
	popq	%rbx
	popq	%r14
	popq	%rbp
	.cfi_def_cfa %rsp, 8
	retq
.LBB0_2:                                # %func_bea_is_dual_infeasible.10
	.cfi_def_cfa %rbp, 16
	movq	%rbx, %rdi
	movq	%r14, %rsi
	callq	bea_is_dual_infeasible.10
	popq	%rbx
	popq	%r14
	popq	%rbp
	.cfi_def_cfa %rsp, 8
...
# %bb.0:                                # %entry
	...
	subq	$88, %rsp
	.cfi_offset %rbx, -24
	movl	$877065740, -44(%rbp)   # imm = 0x3446F60C
	movq	%rdi, -96(%rbp)
	movq	%rsi, -88(%rbp)
	movq	%rdx, -72(%rbp)
	movq	%rcx, -64(%rbp)
...
.LBB3_41:                               # %return
	movq	-56(%rbp), %rbx
	cmpl	$877065740, -44(%rbp)   # imm = 0x3446F60C
	jne	.LBB3_43
.LBB3_42:
	movq	%rbx, %rax
	addq	$88, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$88, %rsp
	.cfi_offset %rbx, -24
	movl	$933516555, -44(%rbp)   # imm = 0x37A4550B
	movq	%rdi, -96(%rbp)
	movq	%rsi, -88(%rbp)
	movq	%rdx, -72(%rbp)
	movq	%rcx, -64(%rbp)
...
.LBB4_41:                               # %return
	movq	-56(%rbp), %rbx
	cmpl	$933516555, -44(%rbp)   # imm = 0x37A4550B
	jne	.LBB4_43
.LBB4_42:
	movq	%rbx, %rax
	addq	$88, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$513795862, -36(%rbp)   # imm = 0x1E9FE716
	movq	%rdi, -24(%rbp)
	movq	%rsi, -32(%rbp)
	movq	-24(%rbp), %rax
	movq	%rax, -8(%rbp)
...
# %bb.17:                               # %if.then25
	...
	callq	sort_basket
.LBB5_18:                               # %if.end26
	cmpl	$513795862, -36(%rbp)   # imm = 0x1E9FE716
	jne	.LBB5_20
.LBB5_19:
	addq	$64, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	subq	$88, %rsp
	.cfi_offset %rbx, -24
	movl	$1930370411, -44(%rbp)  # imm = 0x730F1D6B
	movq	%rdi, -96(%rbp)
	movq	%rsi, -80(%rbp)
	movq	%rdx, -72(%rbp)
	movq	%rcx, -64(%rbp)
...
.LBB6_41:                               # %return
	movq	-56(%rbp), %rbx
	cmpl	$1930370411, -44(%rbp)  # imm = 0x730F1D6B
	jne	.LBB6_43
.LBB6_42:
	movq	%rbx, %rax
	addq	$88, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$886879385, -36(%rbp)   # imm = 0x34DCB499
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movq	-32(%rbp), %rax
	movq	%rax, -8(%rbp)
...
# %bb.17:                               # %if.then25
	...
	callq	sort_basket
.LBB7_18:                               # %if.end26
	cmpl	$886879385, -36(%rbp)   # imm = 0x34DCB499
	jne	.LBB7_20
.LBB7_19:
	addq	$64, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$1220139210, -36(%rbp)  # imm = 0x48B9D8CA
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movq	-32(%rbp), %rax
	movq	%rax, -8(%rbp)
...
# %bb.17:                               # %if.then25
	...
	callq	sort_basket
.LBB8_18:                               # %if.end26
	cmpl	$1220139210, -36(%rbp)  # imm = 0x48B9D8CA
	jne	.LBB8_20
.LBB8_19:
	addq	$64, %rsp
	popq	%rbp
...
.Lfunc_end8:
	...
	.cfi_endproc
                                        # -- End function
	.globl	bea_is_dual_infeasible.7 # -- Begin function bea_is_dual_infeasible.7
	.p2align	4, 0x90
	.type	bea_is_dual_infeasible.7,@function
bea_is_dual_infeasible.7:               # @bea_is_dual_infeasible.7
	.cfi_startproc
# %bb.0:                                # %entry
	pushq	%rbp
	.cfi_def_cfa_offset 16
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$1205765804, -12(%rbp)  # imm = 0x47DE86AC
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	cmpq	$0, -24(%rbp)
	jge	.LBB9_2
...
.LBB9_5:                                # %lor.end
	andb	$1, %al
	movzbl	%al, %ebx
	cmpl	$1205765804, -12(%rbp)  # imm = 0x47DE86AC
	jne	.LBB9_7
.LBB9_6:
	movl	%ebx, %eax
	addq	$24, %rsp
...
.LBB9_7:                                # %func_exit
	...
	jmp	.LBB9_6
.Lfunc_end9:
	.size	bea_is_dual_infeasible.7, .Lfunc_end9-bea_is_dual_infeasible.7
	.cfi_endproc
                                        # -- End function
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$1736081414, -36(%rbp)  # imm = 0x677A8006
	movq	%rdi, -24(%rbp)
	movq	%rsi, -32(%rbp)
	movq	-24(%rbp), %rax
	movq	%rax, -8(%rbp)
...
# %bb.17:                               # %if.then25
	...
	callq	sort_basket
.LBB10_18:                              # %if.end26
	cmpl	$1736081414, -36(%rbp)  # imm = 0x677A8006
	jne	.LBB10_20
.LBB10_19:
	addq	$64, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	subq	$88, %rsp
	.cfi_offset %rbx, -24
	movl	$1539362670, -44(%rbp)  # imm = 0x5BC0CF6E
	movq	%rdi, -88(%rbp)
	movq	%rsi, -72(%rbp)
	movq	%rdx, -96(%rbp)
	movq	%rcx, -56(%rbp)
...
.LBB11_41:                              # %return
	movq	-64(%rbp), %rbx
	cmpl	$1539362670, -44(%rbp)  # imm = 0x5BC0CF6E
	jne	.LBB11_43
.LBB11_42:
	movq	%rbx, %rax
	addq	$88, %rsp
...
.Lfunc_end11:
	...
	.cfi_endproc
                                        # -- End function
	.globl	bea_is_dual_infeasible.10 # -- Begin function bea_is_dual_infeasible.10
	.p2align	4, 0x90
	.type	bea_is_dual_infeasible.10,@function
bea_is_dual_infeasible.10:              # @bea_is_dual_infeasible.10
	.cfi_startproc
# %bb.0:                                # %entry
	pushq	%rbp
	.cfi_def_cfa_offset 16
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$1299583068, -12(%rbp)  # imm = 0x4D76105C
	movq	%rdi, -24(%rbp)
	movq	%rsi, -32(%rbp)
	cmpq	$0, -32(%rbp)
	jge	.LBB12_2
...
.LBB12_5:                               # %lor.end
	andb	$1, %al
	movzbl	%al, %ebx
	cmpl	$1299583068, -12(%rbp)  # imm = 0x4D76105C
	jne	.LBB12_7
.LBB12_6:
	movl	%ebx, %eax
	addq	$24, %rsp
...
.LBB12_7:                               # %func_exit
	...
	jmp	.LBB12_6
.Lfunc_end12:
	.size	bea_is_dual_infeasible.10, .Lfunc_end12-bea_is_dual_infeasible.10
	.cfi_endproc
                                        # -- End function
