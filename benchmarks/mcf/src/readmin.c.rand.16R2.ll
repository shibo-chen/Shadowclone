; ModuleID = 'readmin.c.rand.16R2.bc'
...
entry:
  ...
  %canary = alloca i32
  store i32 1752394076, i32* %canary
...
return:                                           ; preds = %for.end228, %if.then147, %if.then134, %if.then57, %if.then34, %if.then6, %if.then
  ...
  %249 = icmp eq i32 %248, 1752394076
...
entry:
  ...
  %t = alloca i64, align 8
  %canary = alloca i32
  store i32 356245995, i32* %canary
  %retval = alloca i64, align 8
  %in = alloca %struct._IO_FILE*, align 8
  %net.addr = alloca %struct.network*, align 8
  %instring = alloca [201 x i8], align 16
...
entry:
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 605649804, i32* %canary
  %in = alloca %struct._IO_FILE*, align 8
  %t = alloca i64, align 8
  %c = alloca i64, align 8
  %instring = alloca [201 x i8], align 16
...
entry:
  %instring = alloca [201 x i8], align 16
  %canary = alloca i32
  store i32 1520669570, i32* %canary
  %c = alloca i64, align 8
  %node = alloca %struct.node*, align 8
  %arc = alloca %struct.arc*, align 8
  %in = alloca %struct._IO_FILE*, align 8
...
return:                                           ; preds = %for.end228, %if.then147, %if.then134, %if.then57, %if.then34, %if.then6, %if.then
  %247 = load i64, i64* %retval, align 8
  %248 = load i32, i32* %canary
  %249 = icmp eq i32 %248, 1520669570
  br i1 %249, label %250, label %func_exit
...
entry:
  ...
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 673933170, i32* %canary
  %c = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store %struct._IO_FILE* null, %struct._IO_FILE** %in, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
...
entry:
  ...
  %c = alloca i64, align 8
  %canary = alloca i32
  store i32 1828658385, i32* %canary
  %node = alloca %struct.node*, align 8
  %i = alloca i64, align 8
  %in = alloca %struct._IO_FILE*, align 8
  %retval = alloca i64, align 8
...
return:                                           ; preds = %for.end228, %if.then147, %if.then134, %if.then57, %if.then34, %if.then6, %if.then
  %247 = load i64, i64* %retval, align 8
  %248 = load i32, i32* %canary
  %249 = icmp eq i32 %248, 1828658385
  br i1 %249, label %250, label %func_exit
...
entry:
  %canary = alloca i32
  store i32 1237336996, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %in = alloca %struct._IO_FILE*, align 8
  %node = alloca %struct.node*, align 8
  %retval = alloca i64, align 8
...
return:                                           ; preds = %for.end228, %if.then147, %if.then134, %if.then57, %if.then34, %if.then6, %if.then
  %247 = load i64, i64* %retval, align 8
  %248 = load i32, i32* %canary
  %249 = icmp eq i32 %248, 1237336996
  br i1 %249, label %250, label %func_exit
...
entry:
  ...
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1848684986, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %h = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store %struct._IO_FILE* null, %struct._IO_FILE** %in, align 8
...
return:                                           ; preds = %for.end228, %if.then147, %if.then134, %if.then57, %if.then34, %if.then6, %if.then
  %247 = load i64, i64* %retval, align 8
  %248 = load i32, i32* %canary
  %249 = icmp eq i32 %248, 1848684986
  br i1 %249, label %250, label %func_exit
...
entry:
  ...
  %h = alloca i64, align 8
  %canary = alloca i32
  store i32 1647331145, i32* %canary
  %in = alloca %struct._IO_FILE*, align 8
  %instring = alloca [201 x i8], align 16
  %retval = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
return:                                           ; preds = %for.end228, %if.then147, %if.then134, %if.then57, %if.then34, %if.then6, %if.then
  %247 = load i64, i64* %retval, align 8
  %248 = load i32, i32* %canary
  %249 = icmp eq i32 %248, 1647331145
  br i1 %249, label %250, label %func_exit
...
entry:
  ...
  %in = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 854276909, i32* %canary
  %arc = alloca %struct.arc*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store %struct._IO_FILE* null, %struct._IO_FILE** %in, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
...
entry:
  ...
  %t = alloca i64, align 8
  %canary = alloca i32
  store i32 1465729463, i32* %canary
  %node = alloca %struct.node*, align 8
  %retval = alloca i64, align 8
  %h = alloca i64, align 8
  %i = alloca i64, align 8
...
return:                                           ; preds = %for.end228, %if.then147, %if.then134, %if.then57, %if.then34, %if.then6, %if.then
  %247 = load i64, i64* %retval, align 8
  %248 = load i32, i32* %canary
  %249 = icmp eq i32 %248, 1465729463
  br i1 %249, label %250, label %func_exit
...
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 754110021, i32* %canary
  %h = alloca i64, align 8
  %node = alloca %struct.node*, align 8
  %retval = alloca i64, align 8
  %t = alloca i64, align 8
...
entry:
  ...
  %h = alloca i64, align 8
  %canary = alloca i32
  store i32 1740992225, i32* %canary
  %in = alloca %struct._IO_FILE*, align 8
  %net.addr = alloca %struct.network*, align 8
  %i = alloca i64, align 8
  %c = alloca i64, align 8
...
return:                                           ; preds = %for.end228, %if.then147, %if.then134, %if.then57, %if.then34, %if.then6, %if.then
  %247 = load i64, i64* %retval, align 8
  %248 = load i32, i32* %canary
  %249 = icmp eq i32 %248, 1740992225
  br i1 %249, label %250, label %func_exit
