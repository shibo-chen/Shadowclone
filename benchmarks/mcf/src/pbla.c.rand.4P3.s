...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$1507000446, -52(%rbp)  # imm = 0x59D3007E
	movq	%rdi, -32(%rbp)
	movq	%rsi, -48(%rbp)
	movq	%rdx, -16(%rbp)
	movq	%rcx, -24(%rbp)
...
.LBB1_24:                               # %while.end
	...
	movq	%rax, (%rcx)
	movq	-40(%rbp), %rbx
	cmpl	$1507000446, -52(%rbp)  # imm = 0x59D3007E
	jne	.LBB1_26
.LBB1_25:
	movq	%rbx, %rax
	addq	$56, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$348402100, -52(%rbp)   # imm = 0x14C431B4
	movq	%rdi, -32(%rbp)
	movq	%rsi, -48(%rbp)
	movq	%rdx, -16(%rbp)
	movq	%rcx, -24(%rbp)
...
.LBB2_24:                               # %while.end
	...
	movq	%rax, (%rcx)
	movq	-40(%rbp), %rbx
	cmpl	$348402100, -52(%rbp)   # imm = 0x14C431B4
	jne	.LBB2_26
.LBB2_25:
	movq	%rbx, %rax
	addq	$56, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$252927649, -52(%rbp)   # imm = 0xF135EA1
	movq	%rdi, -32(%rbp)
	movq	%rsi, -48(%rbp)
	movq	%rdx, -16(%rbp)
	movq	%rcx, -24(%rbp)
...
.LBB3_24:                               # %while.end
	...
	movq	%rax, (%rcx)
	movq	-40(%rbp), %rbx
	cmpl	$252927649, -52(%rbp)   # imm = 0xF135EA1
	jne	.LBB3_26
.LBB3_25:
	movq	%rbx, %rax
	addq	$56, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$1158561366, -52(%rbp)  # imm = 0x450E3E56
	movq	%rdi, -32(%rbp)
	movq	%rsi, -48(%rbp)
	movq	%rdx, -16(%rbp)
	movq	%rcx, -24(%rbp)
...
.LBB4_24:                               # %while.end
	...
	movq	%rax, (%rcx)
	movq	-40(%rbp), %rbx
	cmpl	$1158561366, -52(%rbp)  # imm = 0x450E3E56
	jne	.LBB4_26
.LBB4_25:
	movq	%rbx, %rax
	addq	$56, %rsp
