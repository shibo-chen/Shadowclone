; ModuleID = 'pbeampp.c.rand.8R1.bc'
...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_bea_is_dual_infeasible.2, label %func_bea_is_dual_infeasible.9

func_bea_is_dual_infeasible.2:                    ; preds = %rand_bb
  %2 = call i32 @bea_is_dual_infeasible.2(%struct.arc* %arc, i64 %red_cost)
  ret i32 %2

func_bea_is_dual_infeasible.9:                    ; preds = %rand_bb
  %3 = call i32 @bea_is_dual_infeasible.9(%struct.arc* %arc, i64 %red_cost)
  ret i32 %3
}
...
ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_sort_basket.16, label %func_sort_basket.18
}
...
ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_primal_bea_mpp.4, label %ctrl1
...
ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_primal_bea_mpp.10, label %ctrl3
...
ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_primal_bea_mpp.12, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_primal_bea_mpp.15, label %func_primal_bea_mpp.17
}
...
entry:
  %canary = alloca i32
  store i32 598648255, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 578074000, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 906624438, i32* %canary
...
entry:
  ...
  %stop_arcs.addr = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1861754666, i32* %canary
  %m.addr = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
  store i64 %m, i64* %m.addr, align 8
  store %struct.arc* %arcs, %struct.arc** %arcs.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 701155998, i32* %canary
  %xchange = alloca %struct.basket*, align 8
  %max.addr = alloca i64, align 8
  %r = alloca i64, align 8
  %min.addr = alloca i64, align 8
...
entry:
  ...
  %l = alloca i64, align 8
  %canary = alloca i32
  store i32 2139873480, i32* %canary
  %r = alloca i64, align 8
  %cut = alloca i64, align 8
  store i64 %min, i64* %min.addr, align 8
  store i64 %max, i64* %max.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 733447308, i32* %canary
  %i = alloca i64, align 8
  %next = alloca i64, align 8
  %stop_arcs.addr = alloca %struct.arc*, align 8
  %arc = alloca %struct.arc*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @bea_is_dual_infeasible.9(%struct.arc* %arc, i64 %red_cost) #0 {
entry:
  %red_cost.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1092861795, i32* %canary
  %arc.addr = alloca %struct.arc*, align 8
  store %struct.arc* %arc, %struct.arc** %arc.addr, align 8
  store i64 %red_cost, i64* %red_cost.addr, align 8
  %0 = load i64, i64* %red_cost.addr, align 8
...
entry:
  ...
  %stop_arcs.addr = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1290221622, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %red_cost = alloca i64, align 8
  %red_cost_of_bea.addr = alloca i64*, align 8
  %retval = alloca %struct.arc*, align 8
...
entry:
  ...
  %red_cost = alloca i64, align 8
  %canary = alloca i32
  store i32 854724286, i32* %canary
  %arcs.addr = alloca %struct.arc*, align 8
  %i = alloca i64, align 8
  %next = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
...
entry:
  ...
  %l = alloca i64, align 8
  %canary = alloca i32
  store i32 143655171, i32* %canary
  %min.addr = alloca i64, align 8
  %cut = alloca i64, align 8
  store i64 %min, i64* %min.addr, align 8
  store i64 %max, i64* %max.addr, align 8
...
entry:
  ...
  %cut = alloca i64, align 8
  %canary = alloca i32
  store i32 1165160919, i32* %canary
  %l = alloca i64, align 8
  %max.addr = alloca i64, align 8
  store i64 %min, i64* %min.addr, align 8
  store i64 %max, i64* %max.addr, align 8
...
entry:
  ...
  %retval = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 167491182, i32* %canary
  %i = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
  %old_group_pos = alloca i64, align 8
  %red_cost = alloca i64, align 8
...
entry:
  %cut = alloca i64, align 8
  %canary = alloca i32
  store i32 634534187, i32* %canary
  %l = alloca i64, align 8
  %r = alloca i64, align 8
  %min.addr = alloca i64, align 8
  %xchange = alloca %struct.basket*, align 8
...
entry:
  ...
  %retval = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1643577501, i32* %canary
  %stop_arcs.addr = alloca %struct.arc*, align 8
  %arcs.addr = alloca %struct.arc*, align 8
  %red_cost = alloca i64, align 8
  store i64 %m, i64* %m.addr, align 8
