; ModuleID = 'treeup.c.rand.16R1.bc'
...
entry:
  ...
  %canary = alloca i32
  store i32 1468927026, i32* %canary
...
if.end128:                                        ; preds = %for.end127, %for.end108
  ...
  %153 = icmp eq i32 %152, 1468927026
...
entry:
  ...
  %iminus.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1440400425, i32* %canary
  %new_flow.addr = alloca i64, align 8
  %feas_tol.addr = alloca i64, align 8
  %sigma.addr = alloca i64, align 8
  %jplus.addr = alloca %struct.node*, align 8
...
if.end128:                                        ; preds = %for.end127, %for.end108
  %152 = load i32, i32* %canary
  %153 = icmp eq i32 %152, 1440400425
  br i1 %153, label %154, label %func_exit
...
entry:
  ...
  %new_depth = alloca i64, align 8
  %canary = alloca i32
  store i32 104715785, i32* %canary
  %depth_iminus = alloca i64, align 8
  %temp = alloca %struct.node*, align 8
  store i64 %cycle_ori, i64* %cycle_ori.addr, align 8
  store i64 %new_orientation, i64* %new_orientation.addr, align 8
...
entry:
  ...
  %feas_tol.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1171920116, i32* %canary
  %jminus.addr = alloca %struct.node*, align 8
  %depth_temp = alloca i64, align 8
  %depth_iminus = alloca i64, align 8
  %jplus.addr = alloca %struct.node*, align 8
...
if.end128:                                        ; preds = %for.end127, %for.end108
  %152 = load i32, i32* %canary
  %153 = icmp eq i32 %152, 1171920116
  br i1 %153, label %154, label %func_exit
...
entry:
  ...
  %new_flow.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 494374230, i32* %canary
  %sigma.addr = alloca i64, align 8
  %jplus.addr = alloca %struct.node*, align 8
  %new_pred = alloca %struct.node*, align 8
  %temp = alloca %struct.node*, align 8
...
entry:
  ...
  %bea.addr = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 229855511, i32* %canary
  %new_basic_arc = alloca %struct.arc*, align 8
  %iplus.addr = alloca %struct.node*, align 8
  %new_flow.addr = alloca i64, align 8
  %basic_arc_temp = alloca %struct.arc*, align 8
...
entry:
  ...
  %jplus.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 142916115, i32* %canary
  %jminus.addr = alloca %struct.node*, align 8
  %father = alloca %struct.node*, align 8
  %iminus.addr = alloca %struct.node*, align 8
  %temp = alloca %struct.node*, align 8
...
entry:
  ...
  %iplus.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1726911634, i32* %canary
  %temp = alloca %struct.node*, align 8
  %basic_arc_temp = alloca %struct.arc*, align 8
  %depth_temp = alloca i64, align 8
  %sigma.addr = alloca i64, align 8
...
if.end128:                                        ; preds = %for.end127, %for.end108
  %152 = load i32, i32* %canary
  %153 = icmp eq i32 %152, 1726911634
  br i1 %153, label %154, label %func_exit
...
entry:
  ...
  %cycle_ori.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 115762583, i32* %canary
  %delta.addr = alloca i64, align 8
  %basic_arc_temp = alloca %struct.arc*, align 8
  %iplus.addr = alloca %struct.node*, align 8
  %jplus.addr = alloca %struct.node*, align 8
...
entry:
  ...
  %father = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1070966500, i32* %canary
  %bea.addr = alloca %struct.arc*, align 8
  %iplus.addr = alloca %struct.node*, align 8
  %w.addr = alloca %struct.node*, align 8
  %cycle_ori.addr = alloca i64, align 8
...
if.end128:                                        ; preds = %for.end127, %for.end108
  %152 = load i32, i32* %canary
  %153 = icmp eq i32 %152, 1070966500
  br i1 %153, label %154, label %func_exit
...
entry:
  ...
  %depth_iminus = alloca i64, align 8
  %canary = alloca i32
  store i32 1499247543, i32* %canary
  %jplus.addr = alloca %struct.node*, align 8
  store i64 %cycle_ori, i64* %cycle_ori.addr, align 8
  store i64 %new_orientation, i64* %new_orientation.addr, align 8
  store i64 %delta, i64* %delta.addr, align 8
...
if.end128:                                        ; preds = %for.end127, %for.end108
  %152 = load i32, i32* %canary
  %153 = icmp eq i32 %152, 1499247543
  br i1 %153, label %154, label %func_exit
...
entry:
  ...
  %iminus.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1986934821, i32* %canary
  %father = alloca %struct.node*, align 8
  %new_depth = alloca i64, align 8
  %cycle_ori.addr = alloca i64, align 8
  %new_pred = alloca %struct.node*, align 8
...
if.end128:                                        ; preds = %for.end127, %for.end108
  %152 = load i32, i32* %canary
  %153 = icmp eq i32 %152, 1986934821
  br i1 %153, label %154, label %func_exit
...
entry:
  ...
  %new_pred = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1440454221, i32* %canary
  %delta.addr = alloca i64, align 8
  %new_basic_arc = alloca %struct.arc*, align 8
  %orientation_temp = alloca i64, align 8
  %basic_arc_temp = alloca %struct.arc*, align 8
...
if.end128:                                        ; preds = %for.end127, %for.end108
  %152 = load i32, i32* %canary
  %153 = icmp eq i32 %152, 1440454221
  br i1 %153, label %154, label %func_exit
...
entry:
  ...
  %depth_iminus = alloca i64, align 8
  %canary = alloca i32
  store i32 1907895069, i32* %canary
  %cycle_ori.addr = alloca i64, align 8
  %father = alloca %struct.node*, align 8
  %temp = alloca %struct.node*, align 8
  %new_basic_arc = alloca %struct.arc*, align 8
...
if.end128:                                        ; preds = %for.end127, %for.end108
  %152 = load i32, i32* %canary
  %153 = icmp eq i32 %152, 1907895069
  br i1 %153, label %154, label %func_exit
