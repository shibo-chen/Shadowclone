; ModuleID = 'pbeampp.c.rand.4R1.bc'
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_sort_basket.6, label %func_sort_basket.7
}
...
func_primal_bea_mpp.10:                           ; preds = %ctrl1
  %5 = call %struct.arc* @primal_bea_mpp.10(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea)
  ret %struct.arc* %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_primal_bea_mpp.4, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_primal_bea_mpp.9, label %func_primal_bea_mpp.10
}
...
entry:
  ...
  %canary = alloca i32
  store i32 1791323909, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1252981094, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1628156506, i32* %canary
...
entry:
  ...
  %stop_arcs.addr = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 956393702, i32* %canary
  %retval = alloca %struct.arc*, align 8
  %red_cost = alloca i64, align 8
  %m.addr = alloca i64, align 8
  %red_cost_of_bea.addr = alloca i64*, align 8
...
entry:
  ...
  %cut = alloca i64, align 8
  %canary = alloca i32
  store i32 1237564187, i32* %canary
  %l = alloca i64, align 8
  %xchange = alloca %struct.basket*, align 8
  store i64 %min, i64* %min.addr, align 8
  store i64 %max, i64* %max.addr, align 8
...
entry:
  %l = alloca i64, align 8
  %canary = alloca i32
  store i32 1706447785, i32* %canary
  %cut = alloca i64, align 8
  %r = alloca i64, align 8
  %min.addr = alloca i64, align 8
  %xchange = alloca %struct.basket*, align 8
...
entry:
  ...
  %cut = alloca i64, align 8
  %canary = alloca i32
  store i32 895544431, i32* %canary
  %min.addr = alloca i64, align 8
  %max.addr = alloca i64, align 8
  %l = alloca i64, align 8
  %xchange = alloca %struct.basket*, align 8
...
entry:
  %arc.addr = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 979258899, i32* %canary
  %red_cost.addr = alloca i64, align 8
  store %struct.arc* %arc, %struct.arc** %arc.addr, align 8
  store i64 %red_cost, i64* %red_cost.addr, align 8
  %0 = load i64, i64* %red_cost.addr, align 8
...
entry:
  ...
  %red_cost = alloca i64, align 8
  %canary = alloca i32
  store i32 1969240381, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %i = alloca i64, align 8
  store i64 %m, i64* %m.addr, align 8
  store %struct.arc* %arcs, %struct.arc** %arcs.addr, align 8
...
entry:
  ...
  %m.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 228763927, i32* %canary
  %red_cost_of_bea.addr = alloca i64*, align 8
  store i64 %m, i64* %m.addr, align 8
  store %struct.arc* %arcs, %struct.arc** %arcs.addr, align 8
  store %struct.arc* %stop_arcs, %struct.arc** %stop_arcs.addr, align 8
