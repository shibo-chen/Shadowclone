; ModuleID = 'psimplex.c.rand.16P2.bc'
...
func_primal_net_simplex.8:                        ; preds = %ctrl6
  %9 = call i64 @primal_net_simplex.8(%struct.network* %net)
  ret i64 %9

func_primal_net_simplex.9:                        ; preds = %ctrl7
  %10 = call i64 @primal_net_simplex.9(%struct.network* %net)
  ret i64 %10

func_primal_net_simplex.10:                       ; preds = %ctrl8
  %11 = call i64 @primal_net_simplex.10(%struct.network* %net)
  ret i64 %11

func_primal_net_simplex.11:                       ; preds = %ctrl9
  %12 = call i64 @primal_net_simplex.11(%struct.network* %net)
  ret i64 %12

func_primal_net_simplex.12:                       ; preds = %ctrl10
  %13 = call i64 @primal_net_simplex.12(%struct.network* %net)
  ret i64 %13

func_primal_net_simplex.13:                       ; preds = %ctrl11
  %14 = call i64 @primal_net_simplex.13(%struct.network* %net)
  ret i64 %14

func_primal_net_simplex.14:                       ; preds = %ctrl12
  %15 = call i64 @primal_net_simplex.14(%struct.network* %net)
  ret i64 %15

func_primal_net_simplex.15:                       ; preds = %ctrl13
  %16 = call i64 @primal_net_simplex.15(%struct.network* %net)
  ret i64 %16

func_primal_net_simplex.16:                       ; preds = %ctrl13
  %17 = call i64 @primal_net_simplex.16(%struct.network* %net)
  ret i64 %17

ctrl0:                                            ; preds = %rand_bb
  %18 = icmp eq i32 %0, 1
  br i1 %18, label %func_primal_net_simplex.2, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %19 = icmp eq i32 %0, 2
  br i1 %19, label %func_primal_net_simplex.3, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %20 = icmp eq i32 %0, 3
  br i1 %20, label %func_primal_net_simplex.4, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %21 = icmp eq i32 %0, 4
  br i1 %21, label %func_primal_net_simplex.5, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %22 = icmp eq i32 %0, 5
  br i1 %22, label %func_primal_net_simplex.6, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %23 = icmp eq i32 %0, 6
  br i1 %23, label %func_primal_net_simplex.7, label %ctrl6

ctrl6:                                            ; preds = %ctrl5
  %24 = icmp eq i32 %0, 7
  br i1 %24, label %func_primal_net_simplex.8, label %ctrl7

ctrl7:                                            ; preds = %ctrl6
  %25 = icmp eq i32 %0, 8
  br i1 %25, label %func_primal_net_simplex.9, label %ctrl8

ctrl8:                                            ; preds = %ctrl7
  %26 = icmp eq i32 %0, 9
  br i1 %26, label %func_primal_net_simplex.10, label %ctrl9

ctrl9:                                            ; preds = %ctrl8
  %27 = icmp eq i32 %0, 10
  br i1 %27, label %func_primal_net_simplex.11, label %ctrl10

ctrl10:                                           ; preds = %ctrl9
  %28 = icmp eq i32 %0, 11
  br i1 %28, label %func_primal_net_simplex.12, label %ctrl11

ctrl11:                                           ; preds = %ctrl10
  %29 = icmp eq i32 %0, 12
  br i1 %29, label %func_primal_net_simplex.13, label %ctrl12

ctrl12:                                           ; preds = %ctrl11
  %30 = icmp eq i32 %0, 13
  br i1 %30, label %func_primal_net_simplex.14, label %ctrl13

ctrl13:                                           ; preds = %ctrl12
  %31 = icmp eq i32 %0, 14
  br i1 %31, label %func_primal_net_simplex.15, label %func_primal_net_simplex.16
}
...
entry:
  ...
  %canary = alloca i32
  store i32 1896960273, i32* %canary
...
entry:
  ...
  %iplus = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 404928076, i32* %canary
  %bound_exchanges = alloca i64*, align 8
  %m = alloca i64, align 8
  %checksum = alloca i64*, align 8
  %red_cost_of_bea = alloca i64, align 8
...
entry:
  ...
  %bea = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 355133920, i32* %canary
  %bla = alloca %struct.arc*, align 8
  %arcs = alloca %struct.arc*, align 8
  %new_flow = alloca i64, align 8
  %new_orientation = alloca i64, align 8
...
entry:
  ...
  %w = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1244415664, i32* %canary
  %red_cost_of_bea = alloca i64, align 8
  %stop_arcs = alloca %struct.arc*, align 8
  %opt = alloca i64, align 8
  %jplus = alloca %struct.node*, align 8
...
entry:
  ...
  %w = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 2135694618, i32* %canary
  %bound_exchanges = alloca i64*, align 8
  %temp = alloca %struct.node*, align 8
  %opt = alloca i64, align 8
  %jminus = alloca %struct.node*, align 8
...
entry:
  ...
  %arcs = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1347193534, i32* %canary
  %new_orientation = alloca i64, align 8
  %jplus = alloca %struct.node*, align 8
  %bound_exchanges = alloca i64*, align 8
  %new_set = alloca i64, align 8
...
entry:
  ...
  %iplus = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1770105150, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %new_set = alloca i64, align 8
  %delta = alloca i64, align 8
  %stop_arcs = alloca %struct.arc*, align 8
...
entry:
  ...
  %delta = alloca i64, align 8
  %canary = alloca i32
  store i32 1151256669, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %new_orientation = alloca i64, align 8
  %new_flow = alloca i64, align 8
  %xchange = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @primal_net_simplex.9(%struct.network* %net) #0 {
entry:
  %arcs = alloca %struct.arc*, align 8
  %stop_arcs = alloca %struct.arc*, align 8
  %delta = alloca i64, align 8
  ...
  %new_orientation = alloca i64, align 8
  %canary = alloca i32
  store i32 1310657045, i32* %canary
  %bound_exchanges = alloca i64*, align 8
  %net.addr = alloca %struct.network*, align 8
  %checksum = alloca i64*, align 8
  %new_flow = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @primal_net_simplex.10(%struct.network* %net) #0 {
entry:
  %iplus = alloca %struct.node*, align 8
  %temp = alloca %struct.node*, align 8
  %arcs = alloca %struct.arc*, align 8
  %iminus = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 942649207, i32* %canary
  %opt = alloca i64, align 8
  %delta = alloca i64, align 8
  %bea = alloca %struct.arc*, align 8
  %new_set = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @primal_net_simplex.11(%struct.network* %net) #0 {
entry:
  %arcs = alloca %struct.arc*, align 8
  %new_flow = alloca i64, align 8
  %canary = alloca i32
  store i32 2037734777, i32* %canary
  %stop_arcs = alloca %struct.arc*, align 8
  %delta = alloca i64, align 8
  %opt = alloca i64, align 8
  %checksum = alloca i64*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @primal_net_simplex.12(%struct.network* %net) #0 {
entry:
  %canary = alloca i32
  store i32 383210194, i32* %canary
  %bea = alloca %struct.arc*, align 8
  %w = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
  %red_cost_of_bea = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @primal_net_simplex.13(%struct.network* %net) #0 {
entry:
  %delta = alloca i64, align 8
  %new_orientation = alloca i64, align 8
  %temp = alloca %struct.node*, align 8
  ...
  %m = alloca i64, align 8
  %canary = alloca i32
  store i32 1379389352, i32* %canary
  %bound_exchanges = alloca i64*, align 8
  %jplus = alloca %struct.node*, align 8
  %new_set = alloca i64, align 8
  %iplus = alloca %struct.node*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @primal_net_simplex.14(%struct.network* %net) #0 {
entry:
  %iminus = alloca %struct.node*, align 8
  %m = alloca i64, align 8
  %canary = alloca i32
  store i32 112158080, i32* %canary
  %delta = alloca i64, align 8
  %w = alloca %struct.node*, align 8
  %red_cost_of_bea = alloca i64, align 8
  %opt = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @primal_net_simplex.15(%struct.network* %net) #0 {
entry:
  %new_orientation = alloca i64, align 8
  %checksum = alloca i64*, align 8
  %red_cost_of_bea = alloca i64, align 8
  ...
  %stop_arcs = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1886707269, i32* %canary
  %arcs = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
  %delta = alloca i64, align 8
  %new_flow = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @primal_net_simplex.16(%struct.network* %net) #0 {
entry:
  %new_flow = alloca i64, align 8
  %iplus = alloca %struct.node*, align 8
  %stop_arcs = alloca %struct.arc*, align 8
  ...
  %opt = alloca i64, align 8
  %canary = alloca i32
  store i32 1747079050, i32* %canary
  %red_cost_of_bea = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
  %temp = alloca %struct.node*, align 8
  %jplus = alloca %struct.node*, align 8
