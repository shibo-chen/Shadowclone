; ModuleID = 'mcfutil.c.rand.8R2.bc'
...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_refresh_neighbour_lists.8, label %ctrl0

func_refresh_neighbour_lists.8:                   ; preds = %rand_bb
  call void @refresh_neighbour_lists.8(%struct.network* %net)
  ret void

func_refresh_neighbour_lists.23:                  ; preds = %ctrl0
  call void @refresh_neighbour_lists.23(%struct.network* %net)
  ret void

func_refresh_neighbour_lists.32:                  ; preds = %ctrl1
  call void @refresh_neighbour_lists.32(%struct.network* %net)
  ret void

func_refresh_neighbour_lists.35:                  ; preds = %ctrl2
  call void @refresh_neighbour_lists.35(%struct.network* %net)
  ret void

func_refresh_neighbour_lists.39:                  ; preds = %ctrl3
  call void @refresh_neighbour_lists.39(%struct.network* %net)
  ret void

func_refresh_neighbour_lists.41:                  ; preds = %ctrl4
  call void @refresh_neighbour_lists.41(%struct.network* %net)
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_refresh_neighbour_lists.23, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_refresh_neighbour_lists.32, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_refresh_neighbour_lists.35, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_refresh_neighbour_lists.39, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_refresh_neighbour_lists.41, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_refresh_neighbour_lists.43, label %func_refresh_neighbour_lists.45
}
...
func_refresh_potential.4:                         ; preds = %ctrl0
  %3 = call i64 @refresh_potential.4(%struct.network* %net)
  ret i64 %3

func_refresh_potential.12:                        ; preds = %ctrl1
  %4 = call i64 @refresh_potential.12(%struct.network* %net)
  ret i64 %4

func_refresh_potential.15:                        ; preds = %ctrl2
  %5 = call i64 @refresh_potential.15(%struct.network* %net)
  ret i64 %5

func_refresh_potential.19:                        ; preds = %ctrl3
  %6 = call i64 @refresh_potential.19(%struct.network* %net)
  ret i64 %6

func_refresh_potential.20:                        ; preds = %ctrl4
  %7 = call i64 @refresh_potential.20(%struct.network* %net)
  ret i64 %7

func_refresh_potential.28:                        ; preds = %ctrl5
  %8 = call i64 @refresh_potential.28(%struct.network* %net)
  ret i64 %8

func_refresh_potential.31:                        ; preds = %ctrl5
  %9 = call i64 @refresh_potential.31(%struct.network* %net)
  ret i64 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_refresh_potential.4, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_refresh_potential.12, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_refresh_potential.15, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_refresh_potential.19, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_refresh_potential.20, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_refresh_potential.28, label %func_refresh_potential.31
}
...
func_flow_cost.17:                                ; preds = %ctrl1
  %4 = call double @flow_cost.17(%struct.network* %net)
  ret double %4

func_flow_cost.18:                                ; preds = %ctrl2
  %5 = call double @flow_cost.18(%struct.network* %net)
  ret double %5

func_flow_cost.26:                                ; preds = %ctrl3
  %6 = call double @flow_cost.26(%struct.network* %net)
  ret double %6

func_flow_cost.37:                                ; preds = %ctrl4
  %7 = call double @flow_cost.37(%struct.network* %net)
  ret double %7

func_flow_cost.47:                                ; preds = %ctrl5
  %8 = call double @flow_cost.47(%struct.network* %net)
  ret double %8

func_flow_cost.48:                                ; preds = %ctrl5
  %9 = call double @flow_cost.48(%struct.network* %net)
  ret double %9
...
ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_flow_cost.17, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_flow_cost.18, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_flow_cost.26, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_flow_cost.37, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_flow_cost.47, label %func_flow_cost.48
}
...
func_flow_org_cost.7:                             ; preds = %ctrl0
  %3 = call double @flow_org_cost.7(%struct.network* %net)
  ret double %3

func_flow_org_cost.10:                            ; preds = %ctrl1
  %4 = call double @flow_org_cost.10(%struct.network* %net)
  ret double %4
...
func_flow_org_cost.24:                            ; preds = %ctrl4
  %7 = call double @flow_org_cost.24(%struct.network* %net)
  ret double %7

func_flow_org_cost.25:                            ; preds = %ctrl5
  %8 = call double @flow_org_cost.25(%struct.network* %net)
  ret double %8

func_flow_org_cost.40:                            ; preds = %ctrl5
  %9 = call double @flow_org_cost.40(%struct.network* %net)
  ret double %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_flow_org_cost.7, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_flow_org_cost.10, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_flow_org_cost.13, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_flow_org_cost.14, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_flow_org_cost.24, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_flow_org_cost.25, label %func_flow_org_cost.40
}
...
func_primal_feasible.21:                          ; preds = %ctrl1
  %4 = call i64 @primal_feasible.21(%struct.network* %net)
  ret i64 %4

func_primal_feasible.27:                          ; preds = %ctrl2
  %5 = call i64 @primal_feasible.27(%struct.network* %net)
  ret i64 %5
...
func_primal_feasible.36:                          ; preds = %ctrl4
  %7 = call i64 @primal_feasible.36(%struct.network* %net)
  ret i64 %7
...
func_primal_feasible.46:                          ; preds = %ctrl5
  %9 = call i64 @primal_feasible.46(%struct.network* %net)
  ret i64 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_primal_feasible.16, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_primal_feasible.21, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_primal_feasible.27, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_primal_feasible.30, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_primal_feasible.36, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_primal_feasible.44, label %func_primal_feasible.46
}
...
func_dual_feasible.22:                            ; preds = %ctrl1
  %4 = call i64 @dual_feasible.22(%struct.network* %net)
  ret i64 %4

func_dual_feasible.29:                            ; preds = %ctrl2
  %5 = call i64 @dual_feasible.29(%struct.network* %net)
  ret i64 %5

func_dual_feasible.33:                            ; preds = %ctrl3
  %6 = call i64 @dual_feasible.33(%struct.network* %net)
  ret i64 %6

func_dual_feasible.34:                            ; preds = %ctrl4
  %7 = call i64 @dual_feasible.34(%struct.network* %net)
  ret i64 %7

func_dual_feasible.38:                            ; preds = %ctrl5
  %8 = call i64 @dual_feasible.38(%struct.network* %net)
  ret i64 %8

func_dual_feasible.42:                            ; preds = %ctrl5
  %9 = call i64 @dual_feasible.42(%struct.network* %net)
  ret i64 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_dual_feasible.6, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_dual_feasible.22, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_dual_feasible.29, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_dual_feasible.33, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_dual_feasible.34, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_dual_feasible.38, label %func_dual_feasible.42
}
...
entry:
  ...
  %canary = alloca i32
  store i32 243113854, i32* %canary
  %net.addr = alloca %struct.network*, align 8
...
entry:
  %canary = alloca i32
  store i32 440808098, i32* %canary
  %node = alloca %struct.node*, align 8
...
entry:
  ...
  %canary = alloca i32
  store i32 516142912, i32* %canary
...
entry:
  ...
  %checksum = alloca i64, align 8
  %canary = alloca i32
  store i32 847735146, i32* %canary
  %tmp = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
  %nodes = getelementptr inbounds %struct.network, %struct.network* %0, i32 0, i32 21
...
entry:
  ...
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1999901894, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 0, i64* %fleet, align 8
  store i64 0, i64* %operational_cost, align 8
...
entry:
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1636710331, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %red_cost = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @refresh_neighbour_lists.8(%struct.network* %net) #0 {
entry:
  %stop = alloca i8*, align 8
  %canary = alloca i32
  store i32 1839560665, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %node = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  ...
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 2121043011, i32* %canary
  %stop = alloca i8*, align 8
  %operational_cost = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  ...
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 325964229, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %fleet = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 0, i64* %fleet, align 8
...
entry:
  ...
  %retval = alloca i64, align 8
  %canary = alloca i32
  store i32 1589947606, i32* %canary
...
entry:
  ...
  %tmp = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1431633708, i32* %canary
  %node = alloca %struct.node*, align 8
  %checksum = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
...
entry:
  ...
  %operational_cost = alloca i64, align 8
  %canary = alloca i32
  store i32 398965544, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %stop = alloca i8*, align 8
  %fleet = alloca i64, align 8
  %node = alloca %struct.node*, align 8
...
entry:
  ...
  %stop = alloca i8*, align 8
  %canary = alloca i32
  store i32 1726863883, i32* %canary
  %node = alloca %struct.node*, align 8
  %operational_cost = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 0, i64* %fleet, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @refresh_potential.15(%struct.network* %net) #0 {
entry:
  %root = alloca %struct.node*, align 8
  %tmp = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 756170313, i32* %canary
  %checksum = alloca i64, align 8
  %node = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  ...
  %retval = alloca i64, align 8
  %canary = alloca i32
  store i32 1515126383, i32* %canary
  %stop_dummy = alloca %struct.arc*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
  %dummy_arcs = getelementptr inbounds %struct.network, %struct.network* %0, i32 0, i32 25
...
entry:
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 410614707, i32* %canary
  %stop = alloca i8*, align 8
  %node = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 0, i64* %fleet, align 8
...
entry:
  %operational_cost = alloca i64, align 8
  %canary = alloca i32
  store i32 2133510104, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %stop = alloca i8*, align 8
  %node = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @refresh_potential.19(%struct.network* %net) #0 {
entry:
  %canary = alloca i32
  store i32 1469308188, i32* %canary
  %node = alloca %struct.node*, align 8
  %tmp = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
  %checksum = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @refresh_potential.20(%struct.network* %net) #0 {
entry:
  %canary = alloca i32
  store i32 2032384432, i32* %canary
  %node = alloca %struct.node*, align 8
  %checksum = alloca i64, align 8
  %root = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @primal_feasible.21(%struct.network* %net) #0 {
entry:
  %retval = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 523691641, i32* %canary
  %node = alloca %struct.node*, align 8
  %stop = alloca i8*, align 8
  %stop_dummy = alloca %struct.arc*, align 8
  %flow = alloca i64, align 8
...
entry:
  %canary = alloca i32
  store i32 447041615, i32* %canary
  %red_cost = alloca i64, align 8
  %retval = alloca i64, align 8
  %stop = alloca %struct.arc*, align 8
  %arc = alloca %struct.arc*, align 8
...
entry:
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 2120307155, i32* %canary
  %stop = alloca i8*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
  %nodes = getelementptr inbounds %struct.network, %struct.network* %0, i32 0, i32 21
...
entry:
  ...
  %fleet = alloca i64, align 8
  %canary = alloca i32
  store i32 1643468793, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %arc = alloca %struct.arc*, align 8
  %stop = alloca i8*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local double @flow_org_cost.25(%struct.network* %net) #0 {
entry:
  %fleet = alloca i64, align 8
  %operational_cost = alloca i64, align 8
  %node = alloca %struct.node*, align 8
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1486979411, i32* %canary
  %stop = alloca i8*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 0, i64* %fleet, align 8
  store i64 0, i64* %operational_cost, align 8
...
entry:
  ...
  %stop = alloca i8*, align 8
  %canary = alloca i32
  store i32 1640960239, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %node = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 0, i64* %fleet, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @primal_feasible.27(%struct.network* %net) #0 {
entry:
  %stop = alloca i8*, align 8
  %stop_dummy = alloca %struct.arc*, align 8
  %dummy = alloca %struct.arc*, align 8
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1309794555, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %flow = alloca i64, align 8
  %retval = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
...
entry:
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 799510653, i32* %canary
  %node = alloca %struct.node*, align 8
  %checksum = alloca i64, align 8
  %tmp = alloca %struct.node*, align 8
  %root = alloca %struct.node*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @dual_feasible.29(%struct.network* %net) #0 {
entry:
  %retval = alloca i64, align 8
  %canary = alloca i32
  store i32 1352433691, i32* %canary
  %red_cost = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
  %stop = alloca %struct.arc*, align 8
  %arc = alloca %struct.arc*, align 8
...
entry:
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1274436202, i32* %canary
  %dummy = alloca %struct.arc*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
  %dummy_arcs = getelementptr inbounds %struct.network, %struct.network* %0, i32 0, i32 25
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @refresh_potential.31(%struct.network* %net) #0 {
entry:
  %node = alloca %struct.node*, align 8
  %checksum = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 1744944200, i32* %canary
  %root = alloca %struct.node*, align 8
  %tmp = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1719047709, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %stop = alloca i8*, align 8
  %node = alloca %struct.node*, align 8
  %arc = alloca %struct.arc*, align 8
...
entry:
  ...
  %retval = alloca i64, align 8
  %canary = alloca i32
  store i32 347350350, i32* %canary
  %red_cost = alloca i64, align 8
  %stop = alloca %struct.arc*, align 8
  %arc = alloca %struct.arc*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 1614031284, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %stop = alloca %struct.arc*, align 8
  %red_cost = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 698908026, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %node = alloca %struct.node*, align 8
  %stop = alloca i8*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  %dummy = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1186483125, i32* %canary
  %stop = alloca i8*, align 8
  %stop_dummy = alloca %struct.arc*, align 8
  %flow = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local double @flow_cost.37(%struct.network* %net) #0 {
entry:
  %net.addr = alloca %struct.network*, align 8
  %fleet = alloca i64, align 8
  %stop = alloca i8*, align 8
  %canary = alloca i32
  store i32 293119126, i32* %canary
  %operational_cost = alloca i64, align 8
  %node = alloca %struct.node*, align 8
  %arc = alloca %struct.arc*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 183180718, i32* %canary
  %red_cost = alloca i64, align 8
  %stop = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
  %retval = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @refresh_neighbour_lists.39(%struct.network* %net) #0 {
entry:
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1019628621, i32* %canary
  %stop = alloca i8*, align 8
  %net.addr = alloca %struct.network*, align 8
  %node = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1044589823, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %node = alloca %struct.node*, align 8
  %stop = alloca i8*, align 8
  %operational_cost = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @refresh_neighbour_lists.41(%struct.network* %net) #0 {
entry:
  %net.addr = alloca %struct.network*, align 8
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1507438491, i32* %canary
  %stop = alloca i8*, align 8
  %node = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @dual_feasible.42(%struct.network* %net) #0 {
entry:
  %red_cost = alloca i64, align 8
  %canary = alloca i32
  store i32 1084821223, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %retval = alloca i64, align 8
  %stop = alloca %struct.arc*, align 8
  %arc = alloca %struct.arc*, align 8
...
entry:
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 940535929, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
  %stop = alloca i8*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  ...
  %retval = alloca i64, align 8
  %canary = alloca i32
  store i32 522759628, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
  %dummy_arcs = getelementptr inbounds %struct.network, %struct.network* %0, i32 0, i32 25
...
entry:
  ...
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1006850816, i32* %canary
  %stop = alloca i8*, align 8
  %net.addr = alloca %struct.network*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
...
entry:
  ...
  %retval = alloca i64, align 8
  %canary = alloca i32
  store i32 1625713523, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %stop_dummy = alloca %struct.arc*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
...
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 639752374, i32* %canary
  %fleet = alloca i64, align 8
  %stop = alloca i8*, align 8
  %operational_cost = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
...
entry:
  ...
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 917675166, i32* %canary
  %stop = alloca i8*, align 8
  %net.addr = alloca %struct.network*, align 8
  %operational_cost = alloca i64, align 8
  %fleet = alloca i64, align 8
