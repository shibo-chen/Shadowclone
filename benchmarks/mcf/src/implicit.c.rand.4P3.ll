; ModuleID = 'implicit.c.rand.4P3.bc'
...
func_resize_prob.8:                               ; preds = %ctrl1
  %4 = call i64 @resize_prob.8(%struct.network* %net)
  ret i64 %4

func_resize_prob.12:                              ; preds = %ctrl1
  %5 = call i64 @resize_prob.12(%struct.network* %net)
  ret i64 %5
...
ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_resize_prob.8, label %func_resize_prob.12
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_insert_new_arc.9, label %ctrl0

func_insert_new_arc.9:                            ; preds = %rand_bb
  call void @insert_new_arc.9(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void

func_insert_new_arc.18:                           ; preds = %ctrl0
  call void @insert_new_arc.18(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void

func_insert_new_arc.19:                           ; preds = %ctrl1
  call void @insert_new_arc.19(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void

func_insert_new_arc.20:                           ; preds = %ctrl1
  call void @insert_new_arc.20(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_insert_new_arc.18, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_insert_new_arc.19, label %func_insert_new_arc.20
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_replace_weaker_arc.2, label %ctrl0

func_replace_weaker_arc.2:                        ; preds = %rand_bb
  call void @replace_weaker_arc.2(%struct.network* %net, %struct.arc* %new, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void

func_replace_weaker_arc.10:                       ; preds = %ctrl0
...
func_replace_weaker_arc.15:                       ; preds = %ctrl1
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_replace_weaker_arc.10, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_replace_weaker_arc.13, label %func_replace_weaker_arc.15
}
...
func_price_out_impl.7:                            ; preds = %ctrl0
  %3 = call i64 @price_out_impl.7(%struct.network* %net)
  ret i64 %3

func_price_out_impl.14:                           ; preds = %ctrl1
  %4 = call i64 @price_out_impl.14(%struct.network* %net)
  ret i64 %4

func_price_out_impl.16:                           ; preds = %ctrl1
  %5 = call i64 @price_out_impl.16(%struct.network* %net)
  ret i64 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_price_out_impl.7, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_price_out_impl.14, label %func_price_out_impl.16
}
...
func_suspend_impl.11:                             ; preds = %ctrl1
  %4 = call i64 @suspend_impl.11(%struct.network* %net, i64 %threshold, i64 %all)
  ret i64 %4

func_suspend_impl.17:                             ; preds = %ctrl1
  %5 = call i64 @suspend_impl.17(%struct.network* %net, i64 %threshold, i64 %all)
  ret i64 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_suspend_impl.5, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_suspend_impl.11, label %func_suspend_impl.17
}
...
entry:
  %canary = alloca i32
  store i32 1507977060, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1676294643, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 791035640, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1233198281, i32* %canary
...
entry:
  ...
  %new_arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1681623836, i32* %canary
  %all.addr = alloca i64, align 8
  %threshold.addr = alloca i64, align 8
  %red_cost = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
...
entry:
  ...
  %stop = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1552905416, i32* %canary
  %off = alloca i64, align 8
  %root = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
  %node = alloca %struct.node*, align 8
...
entry:
  ...
  %retval = alloca i64, align 8
  %canary = alloca i32
  store i32 470149221, i32* %canary
  %new_arcs = alloca i64, align 8
  %bigM_minus_min_impl_duration = alloca i64, align 8
  %head = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @resize_prob.8(%struct.network* %net) #0 {
entry:
  %retval = alloca i64, align 8
  %root = alloca %struct.node*, align 8
  %off = alloca i64, align 8
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1404763201, i32* %canary
  %node = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
  %max_new_m = getelementptr inbounds %struct.network, %struct.network* %0, i32 0, i32 9
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @insert_new_arc.9(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost) #0 {
entry:
  %newpos.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1437113298, i32* %canary
  %pos = alloca i64, align 8
  %new.addr = alloca %struct.arc*, align 8
  %tail.addr = alloca %struct.node*, align 8
  %cost.addr = alloca i64, align 8
...
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 1560000131, i32* %canary
  %new.addr = alloca %struct.arc*, align 8
  %cmp = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store %struct.arc* %new, %struct.arc** %new.addr, align 8
...
entry:
  ...
  %red_cost = alloca i64, align 8
  %canary = alloca i32
  store i32 756363236, i32* %canary
  %threshold.addr = alloca i64, align 8
  %susp = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
  %stop = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @resize_prob.12(%struct.network* %net) #0 {
entry:
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 905544440, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %off = alloca i64, align 8
  %root = alloca %struct.node*, align 8
  %node = alloca %struct.node*, align 8
...
entry:
  ...
  %new.addr = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 947441299, i32* %canary
  %cost.addr = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store %struct.arc* %new, %struct.arc** %new.addr, align 8
  store %struct.node* %tail, %struct.node** %tail.addr, align 8
...
entry:
  %min_impl_duration = alloca i64, align 8
  %canary = alloca i32
  store i32 609979601, i32* %canary
  %resized = alloca i64, align 8
  %i = alloca i64, align 8
  %new_arcs = alloca i64, align 8
  %head = alloca %struct.node*, align 8
...
entry:
  ...
  %head.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 761363580, i32* %canary
  %pos = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store %struct.arc* %new, %struct.arc** %new.addr, align 8
  store %struct.node* %tail, %struct.node** %tail.addr, align 8
...
entry:
  ...
  %new_arcs = alloca i64, align 8
  %canary = alloca i32
  store i32 1662844325, i32* %canary
  %arcin = alloca %struct.arc*, align 8
  %bigM = alloca i64, align 8
  %arcnew = alloca %struct.arc*, align 8
  %tail = alloca %struct.node*, align 8
...
return:                                           ; preds = %if.end109, %if.then10
  %143 = load i64, i64* %retval, align 8
  %144 = load i32, i32* %canary
  %145 = icmp eq i32 %144, 1662844325
  br i1 %145, label %146, label %func_exit
...
entry:
  ...
  %stop = alloca i8*, align 8
  %canary = alloca i32
  store i32 106861664, i32* %canary
  %red_cost = alloca i64, align 8
  %all.addr = alloca i64, align 8
  %susp = alloca i64, align 8
  %threshold.addr = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @insert_new_arc.18(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost) #0 {
entry:
  %red_cost.addr = alloca i64, align 8
  %tail.addr = alloca %struct.node*, align 8
  %head.addr = alloca %struct.node*, align 8
  ...
  %newpos.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1751982993, i32* %canary
  %pos = alloca i64, align 8
  store %struct.arc* %new, %struct.arc** %new.addr, align 8
  store i64 %newpos, i64* %newpos.addr, align 8
  store %struct.node* %tail, %struct.node** %tail.addr, align 8
...
entry:
  ...
  %newpos.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1472617217, i32* %canary
  %cost.addr = alloca i64, align 8
  store %struct.arc* %new, %struct.arc** %new.addr, align 8
  store i64 %newpos, i64* %newpos.addr, align 8
  store %struct.node* %tail, %struct.node** %tail.addr, align 8
...
entry:
  ...
  %newpos.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 470576125, i32* %canary
  %red_cost.addr = alloca i64, align 8
  %tail.addr = alloca %struct.node*, align 8
  %cost.addr = alloca i64, align 8
  %head.addr = alloca %struct.node*, align 8
