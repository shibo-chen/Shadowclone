...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$502371448, -20(%rbp)   # imm = 0x1DF19478
	movq	%rdi, -16(%rbp)
	movq	%rsi, -8(%rbp)
	movq	%rdx, -32(%rbp)
.LBB1_1:                                # %for.cond
...
.LBB1_13:                               # %for.inc12
	...
	jmp	.LBB1_8
.LBB1_14:                               # %for.end14
	cmpl	$502371448, -20(%rbp)   # imm = 0x1DF19478
	jne	.LBB1_16
.LBB1_15:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$300493700, -20(%rbp)   # imm = 0x11E92B84
	movq	%rdi, -8(%rbp)
	movq	%rsi, -16(%rbp)
	movq	%rdx, -32(%rbp)
.LBB2_1:                                # %for.cond
...
.LBB2_13:                               # %for.inc12
	...
	jmp	.LBB2_8
.LBB2_14:                               # %for.end14
	cmpl	$300493700, -20(%rbp)   # imm = 0x11E92B84
	jne	.LBB2_16
.LBB2_15:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1016865445, -20(%rbp)  # imm = 0x3C9C22A5
	movq	%rdi, -8(%rbp)
	movq	%rsi, -16(%rbp)
	movq	%rdx, -32(%rbp)
.LBB3_1:                                # %for.cond
...
.LBB3_13:                               # %for.inc12
	...
	jmp	.LBB3_8
.LBB3_14:                               # %for.end14
	cmpl	$1016865445, -20(%rbp)  # imm = 0x3C9C22A5
	jne	.LBB3_16
.LBB3_15:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1346160613, -20(%rbp)  # imm = 0x503CC7E5
	movq	%rdi, -16(%rbp)
	movq	%rsi, -8(%rbp)
	movq	%rdx, -32(%rbp)
.LBB4_1:                                # %for.cond
...
.LBB4_13:                               # %for.inc12
	...
	jmp	.LBB4_8
.LBB4_14:                               # %for.end14
	cmpl	$1346160613, -20(%rbp)  # imm = 0x503CC7E5
	jne	.LBB4_16
.LBB4_15:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1227599041, -20(%rbp)  # imm = 0x492BACC1
	movq	%rdi, -8(%rbp)
	movq	%rsi, -16(%rbp)
	movq	%rdx, -32(%rbp)
.LBB5_1:                                # %for.cond
...
.LBB5_13:                               # %for.inc12
	...
	jmp	.LBB5_8
.LBB5_14:                               # %for.end14
	cmpl	$1227599041, -20(%rbp)  # imm = 0x492BACC1
	jne	.LBB5_16
.LBB5_15:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$675909613, -20(%rbp)   # imm = 0x28498FED
	movq	%rdi, -16(%rbp)
	movq	%rsi, -8(%rbp)
	movq	%rdx, -32(%rbp)
.LBB6_1:                                # %for.cond
...
.LBB6_13:                               # %for.inc12
	...
	jmp	.LBB6_8
.LBB6_14:                               # %for.end14
	cmpl	$675909613, -20(%rbp)   # imm = 0x28498FED
	jne	.LBB6_16
.LBB6_15:
	addq	$32, %rsp
	popq	%rbp
