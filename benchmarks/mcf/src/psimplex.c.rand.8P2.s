...
# %bb.0:                                # %entry
	...
	.cfi_offset %r14, -32
	.cfi_offset %r15, -24
	movl	$565469712, -92(%rbp)   # imm = 0x21B46210
	movq	%rdi, -32(%rbp)
	movq	$0, -136(%rbp)
	movq	-32(%rbp), %rax
	movq	568(%rax), %rax
...
.LBB1_30:                               # %while.end
	...
	movq	-32(%rbp), %rdi
	callq	dual_feasible
	cmpl	$565469712, -92(%rbp)   # imm = 0x21B46210
	jne	.LBB1_32
.LBB1_31:
	xorl	%eax, %eax
	addq	$232, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_offset %r14, -32
	.cfi_offset %r15, -24
	movl	$755183913, -92(%rbp)   # imm = 0x2D033129
	movq	%rdi, -32(%rbp)
	movq	$0, -152(%rbp)
	movq	-32(%rbp), %rax
	movq	568(%rax), %rax
...
.LBB2_30:                               # %while.end
	...
	movq	-32(%rbp), %rdi
	callq	dual_feasible
	cmpl	$755183913, -92(%rbp)   # imm = 0x2D033129
	jne	.LBB2_32
.LBB2_31:
	xorl	%eax, %eax
	addq	$232, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_offset %r14, -32
	.cfi_offset %r15, -24
	movl	$1564918473, -92(%rbp)  # imm = 0x5D46C2C9
	movq	%rdi, -32(%rbp)
	movq	$0, -104(%rbp)
	movq	-32(%rbp), %rax
	movq	568(%rax), %rax
...
.LBB3_30:                               # %while.end
	...
	movq	-32(%rbp), %rdi
	callq	dual_feasible
	cmpl	$1564918473, -92(%rbp)  # imm = 0x5D46C2C9
	jne	.LBB3_32
.LBB3_31:
	xorl	%eax, %eax
	addq	$232, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_offset %r14, -32
	.cfi_offset %r15, -24
	movl	$281375026, -92(%rbp)   # imm = 0x10C57132
	movq	%rdi, -32(%rbp)
	movq	$0, -128(%rbp)
	movq	-32(%rbp), %rax
	movq	568(%rax), %rax
...
.LBB4_30:                               # %while.end
	...
	movq	-32(%rbp), %rdi
	callq	dual_feasible
	cmpl	$281375026, -92(%rbp)   # imm = 0x10C57132
	jne	.LBB4_32
.LBB4_31:
	xorl	%eax, %eax
	addq	$232, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_offset %r14, -32
	.cfi_offset %r15, -24
	movl	$848279211, -92(%rbp)   # imm = 0x328FB6AB
	movq	%rdi, -32(%rbp)
	movq	$0, -128(%rbp)
	movq	-32(%rbp), %rax
	movq	568(%rax), %rax
...
.LBB5_30:                               # %while.end
	...
	movq	-32(%rbp), %rdi
	callq	dual_feasible
	cmpl	$848279211, -92(%rbp)   # imm = 0x328FB6AB
	jne	.LBB5_32
.LBB5_31:
	xorl	%eax, %eax
	addq	$232, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_offset %r14, -32
	.cfi_offset %r15, -24
	movl	$281352988, -92(%rbp)   # imm = 0x10C51B1C
	movq	%rdi, -32(%rbp)
	movq	$0, -128(%rbp)
	movq	-32(%rbp), %rax
	movq	568(%rax), %rax
...
.LBB6_30:                               # %while.end
	...
	movq	-32(%rbp), %rdi
	callq	dual_feasible
	cmpl	$281352988, -92(%rbp)   # imm = 0x10C51B1C
	jne	.LBB6_32
.LBB6_31:
	xorl	%eax, %eax
	addq	$232, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_offset %r14, -32
	.cfi_offset %r15, -24
	movl	$2032580692, -92(%rbp)  # imm = 0x7926B854
	movq	%rdi, -32(%rbp)
	movq	$0, -136(%rbp)
	movq	-32(%rbp), %rax
	movq	568(%rax), %rax
...
.LBB7_30:                               # %while.end
	...
	movq	-32(%rbp), %rdi
	callq	dual_feasible
	cmpl	$2032580692, -92(%rbp)  # imm = 0x7926B854
	jne	.LBB7_32
.LBB7_31:
	xorl	%eax, %eax
	addq	$232, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_offset %r14, -32
	.cfi_offset %r15, -24
	movl	$1856573445, -92(%rbp)  # imm = 0x6EA91005
	movq	%rdi, -32(%rbp)
	movq	$0, -128(%rbp)
	movq	-32(%rbp), %rax
	movq	568(%rax), %rax
...
.LBB8_30:                               # %while.end
	...
	movq	-32(%rbp), %rdi
	callq	dual_feasible
	cmpl	$1856573445, -92(%rbp)  # imm = 0x6EA91005
	jne	.LBB8_32
.LBB8_31:
	xorl	%eax, %eax
	addq	$232, %rsp
