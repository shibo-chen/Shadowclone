...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$1122339095, -52(%rbp)  # imm = 0x42E58917
	movq	%rdi, -32(%rbp)
	movq	%rsi, -48(%rbp)
	movq	%rdx, -16(%rbp)
	movq	%rcx, -24(%rbp)
...
.LBB1_24:                               # %while.end
	...
	movq	%rax, (%rcx)
	movq	-40(%rbp), %rbx
	cmpl	$1122339095, -52(%rbp)  # imm = 0x42E58917
	jne	.LBB1_26
.LBB1_25:
	movq	%rbx, %rax
	addq	$56, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$29810944, -52(%rbp)    # imm = 0x1C6E100
	movq	%rdi, -32(%rbp)
	movq	%rsi, -48(%rbp)
	movq	%rdx, -16(%rbp)
	movq	%rcx, -24(%rbp)
...
.LBB2_24:                               # %while.end
	...
	movq	%rax, (%rcx)
	movq	-40(%rbp), %rbx
	cmpl	$29810944, -52(%rbp)    # imm = 0x1C6E100
	jne	.LBB2_26
.LBB2_25:
	movq	%rbx, %rax
	addq	$56, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$1170650340, -52(%rbp)  # imm = 0x45C6B4E4
	movq	%rdi, -32(%rbp)
	movq	%rsi, -48(%rbp)
	movq	%rdx, -16(%rbp)
	movq	%rcx, -24(%rbp)
...
.LBB3_24:                               # %while.end
	...
	movq	%rax, (%rcx)
	movq	-40(%rbp), %rbx
	cmpl	$1170650340, -52(%rbp)  # imm = 0x45C6B4E4
	jne	.LBB3_26
.LBB3_25:
	movq	%rbx, %rax
	addq	$56, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$215023348, -52(%rbp)   # imm = 0xCD0FEF4
	movq	%rdi, -32(%rbp)
	movq	%rsi, -48(%rbp)
	movq	%rdx, -16(%rbp)
	movq	%rcx, -24(%rbp)
...
.LBB4_24:                               # %while.end
	...
	movq	%rax, (%rcx)
	movq	-40(%rbp), %rbx
	cmpl	$215023348, -52(%rbp)   # imm = 0xCD0FEF4
	jne	.LBB4_26
.LBB4_25:
	movq	%rbx, %rax
	addq	$56, %rsp
