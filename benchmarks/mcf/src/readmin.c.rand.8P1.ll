; ModuleID = 'readmin.c.rand.8P1.bc'
...
entry:
  %canary = alloca i32
  store i32 1765354841, i32* %canary
...
return:                                           ; preds = %for.end228, %if.then147, %if.then134, %if.then57, %if.then34, %if.then6, %if.then
  ...
  %249 = icmp eq i32 %248, 1765354841
...
entry:
  ...
  %retval = alloca i64, align 8
  %canary = alloca i32
  store i32 459917735, i32* %canary
  %instring = alloca [201 x i8], align 16
  %node = alloca %struct.node*, align 8
  %h = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  ...
  %retval = alloca i64, align 8
  %canary = alloca i32
  store i32 369613015, i32* %canary
  %node = alloca %struct.node*, align 8
  %arc = alloca %struct.arc*, align 8
  %h = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
...
entry:
  ...
  %c = alloca i64, align 8
  %canary = alloca i32
  store i32 691362152, i32* %canary
  %retval = alloca i64, align 8
  %instring = alloca [201 x i8], align 16
  %net.addr = alloca %struct.network*, align 8
  %t = alloca i64, align 8
...
entry:
  ...
  %t = alloca i64, align 8
  %canary = alloca i32
  store i32 593895130, i32* %canary
  %node = alloca %struct.node*, align 8
  %arc = alloca %struct.arc*, align 8
  %i = alloca i64, align 8
  %c = alloca i64, align 8
...
entry:
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 883362649, i32* %canary
  %instring = alloca [201 x i8], align 16
  %h = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
  %i = alloca i64, align 8
...
entry:
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1102441652, i32* %canary
  %in = alloca %struct._IO_FILE*, align 8
  %h = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
  %i = alloca i64, align 8
...
return:                                           ; preds = %for.end228, %if.then147, %if.then134, %if.then57, %if.then34, %if.then6, %if.then
  %247 = load i64, i64* %retval, align 8
  %248 = load i32, i32* %canary
  %249 = icmp eq i32 %248, 1102441652
  br i1 %249, label %250, label %func_exit
...
entry:
  ...
  %c = alloca i64, align 8
  %canary = alloca i32
  store i32 890868462, i32* %canary
  %t = alloca i64, align 8
  %i = alloca i64, align 8
  %node = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
