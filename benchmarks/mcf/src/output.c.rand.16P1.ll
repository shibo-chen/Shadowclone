...
entry:
  ...
  %canary = alloca i32
  store i32 139946016, i32* %canary
...
entry:
  ...
  %out = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 132595929, i32* %canary
  %first_impl = alloca %struct.arc*, align 8
  %outfile.addr = alloca i8*, align 8
  %net.addr = alloca %struct.network*, align 8
  %arc = alloca %struct.arc*, align 8
...
entry:
  ...
  %arc2 = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 342570250, i32* %canary
  %outfile.addr = alloca i8*, align 8
  %net.addr = alloca %struct.network*, align 8
  %block = alloca %struct.arc*, align 8
  %out = alloca %struct._IO_FILE*, align 8
...
entry:
  %canary = alloca i32
  store i32 169968878, i32* %canary
  %out = alloca %struct._IO_FILE*, align 8
  %arc = alloca %struct.arc*, align 8
  %arc2 = alloca %struct.arc*, align 8
  %outfile.addr = alloca i8*, align 8
...
entry:
  ...
  %out = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 967165259, i32* %canary
  %arc2 = alloca %struct.arc*, align 8
  %block = alloca %struct.arc*, align 8
  %retval = alloca i64, align 8
  store i8* %outfile, i8** %outfile.addr, align 8
...
entry:
  ...
  %first_impl = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1324327626, i32* %canary
  %arc2 = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
  %out = alloca %struct._IO_FILE*, align 8
  %block = alloca %struct.arc*, align 8
...
entry:
  ...
  %retval = alloca i64, align 8
  %canary = alloca i32
  store i32 1758037062, i32* %canary
  %arc2 = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
  %arc = alloca %struct.arc*, align 8
  %block = alloca %struct.arc*, align 8
...
entry:
  ...
  %out = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 1384062519, i32* %canary
  %retval = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
  %first_impl = alloca %struct.arc*, align 8
  store i8* %outfile, i8** %outfile.addr, align 8
...
entry:
  ...
  %first_impl = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1314741735, i32* %canary
  %block = alloca %struct.arc*, align 8
  %out = alloca %struct._IO_FILE*, align 8
  %arc2 = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
...
entry:
  ...
  %arc2 = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 2058739439, i32* %canary
  %block = alloca %struct.arc*, align 8
  %out = alloca %struct._IO_FILE*, align 8
  %arc = alloca %struct.arc*, align 8
  %outfile.addr = alloca i8*, align 8
...
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 1213892647, i32* %canary
  %out = alloca %struct._IO_FILE*, align 8
  %first_impl = alloca %struct.arc*, align 8
  %block = alloca %struct.arc*, align 8
  %retval = alloca i64, align 8
...
entry:
  %block = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1610434058, i32* %canary
  %out = alloca %struct._IO_FILE*, align 8
  %arc2 = alloca %struct.arc*, align 8
  %outfile.addr = alloca i8*, align 8
  %net.addr = alloca %struct.network*, align 8
...
entry:
  ...
  %outfile.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1378363440, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %block = alloca %struct.arc*, align 8
  %first_impl = alloca %struct.arc*, align 8
  %arc = alloca %struct.arc*, align 8
...
entry:
  ...
  %first_impl = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1439184330, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %retval = alloca i64, align 8
  %block = alloca %struct.arc*, align 8
  %arc = alloca %struct.arc*, align 8
...
entry:
  %canary = alloca i32
  store i32 1166663691, i32* %canary
  %arc2 = alloca %struct.arc*, align 8
  %retval = alloca i64, align 8
  %first_impl = alloca %struct.arc*, align 8
  %arc = alloca %struct.arc*, align 8
