...
# %bb.0:                                # %entry
	...
	.cfi_offset %rbx, -24
	movl	$1698953527, -76(%rbp)  # imm = 0x6543F937
	movq	%rdi, -16(%rbp)
	movq	$0, -72(%rbp)
	movq	-16(%rbp), %rdi
	movabsq	$.L.str, %rsi
...
.LBB1_46:                               # %return
	movq	-56(%rbp), %rbx
	cmpl	$1698953527, -76(%rbp)  # imm = 0x6543F937
	jne	.LBB1_48
.LBB1_47:
	movq	%rbx, %rax
...
# %bb.0:                                # %entry
	...
	subq	$296, %rsp              # imm = 0x128
	.cfi_offset %rbx, -24
	movl	$662456787, -76(%rbp)   # imm = 0x277C49D3
	movq	%rdi, -16(%rbp)
	movq	$0, -72(%rbp)
	movq	-16(%rbp), %rdi
	movabsq	$.L.str, %rsi
...
.LBB2_46:                               # %return
	movq	-64(%rbp), %rbx
	cmpl	$662456787, -76(%rbp)   # imm = 0x277C49D3
	jne	.LBB2_48
.LBB2_47:
	movq	%rbx, %rax
	addq	$296, %rsp              # imm = 0x128
...
# %bb.0:                                # %entry
	...
	subq	$296, %rsp              # imm = 0x128
	.cfi_offset %rbx, -24
	movl	$1967928268, -76(%rbp)  # imm = 0x754C33CC
	movq	%rdi, -16(%rbp)
	movq	$0, -72(%rbp)
	movq	-16(%rbp), %rdi
	movabsq	$.L.str, %rsi
...
.LBB3_46:                               # %return
	movq	-64(%rbp), %rbx
	cmpl	$1967928268, -76(%rbp)  # imm = 0x754C33CC
	jne	.LBB3_48
.LBB3_47:
	movq	%rbx, %rax
	addq	$296, %rsp              # imm = 0x128
...
# %bb.0:                                # %entry
	...
	subq	$296, %rsp              # imm = 0x128
	.cfi_offset %rbx, -24
	movl	$1217388950, -76(%rbp)  # imm = 0x488FE196
	movq	%rdi, -16(%rbp)
	movq	$0, -72(%rbp)
	movq	-16(%rbp), %rdi
	movabsq	$.L.str, %rsi
...
.LBB4_46:                               # %return
	movq	-64(%rbp), %rbx
	cmpl	$1217388950, -76(%rbp)  # imm = 0x488FE196
	jne	.LBB4_48
.LBB4_47:
	movq	%rbx, %rax
	addq	$296, %rsp              # imm = 0x128
