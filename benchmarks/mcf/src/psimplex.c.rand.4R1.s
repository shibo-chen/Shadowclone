...
# %bb.0:                                # %entry
	...
	.cfi_offset %r14, -32
	.cfi_offset %r15, -24
	movl	$423444369, -92(%rbp)   # imm = 0x193D3F91
	movq	%rdi, -32(%rbp)
	movq	$0, -120(%rbp)
	movq	-32(%rbp), %rax
	movq	568(%rax), %rax
...
.LBB1_30:                               # %while.end
	...
	movq	-32(%rbp), %rdi
	callq	dual_feasible
	cmpl	$423444369, -92(%rbp)   # imm = 0x193D3F91
	jne	.LBB1_32
.LBB1_31:
	xorl	%eax, %eax
	addq	$232, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_offset %r14, -32
	.cfi_offset %r15, -24
	movl	$588205490, -92(%rbp)   # imm = 0x230F4DB2
	movq	%rdi, -32(%rbp)
	movq	$0, -104(%rbp)
	movq	-32(%rbp), %rax
	movq	568(%rax), %rax
...
.LBB2_30:                               # %while.end
	...
	movq	-32(%rbp), %rdi
	callq	dual_feasible
	cmpl	$588205490, -92(%rbp)   # imm = 0x230F4DB2
	jne	.LBB2_32
.LBB2_31:
	xorl	%eax, %eax
	addq	$232, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_offset %r14, -32
	.cfi_offset %r15, -24
	movl	$1257355608, -92(%rbp)  # imm = 0x4AF1B958
	movq	%rdi, -32(%rbp)
	movq	$0, -104(%rbp)
	movq	-32(%rbp), %rax
	movq	568(%rax), %rax
...
.LBB3_30:                               # %while.end
	...
	movq	-32(%rbp), %rdi
	callq	dual_feasible
	cmpl	$1257355608, -92(%rbp)  # imm = 0x4AF1B958
	jne	.LBB3_32
.LBB3_31:
	xorl	%eax, %eax
	addq	$232, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_offset %r14, -32
	.cfi_offset %r15, -24
	movl	$1483775085, -92(%rbp)  # imm = 0x58709C6D
	movq	%rdi, -32(%rbp)
	movq	$0, -144(%rbp)
	movq	-32(%rbp), %rax
	movq	568(%rax), %rax
...
.LBB4_30:                               # %while.end
	...
	movq	-32(%rbp), %rdi
	callq	dual_feasible
	cmpl	$1483775085, -92(%rbp)  # imm = 0x58709C6D
	jne	.LBB4_32
.LBB4_31:
	xorl	%eax, %eax
	addq	$232, %rsp
