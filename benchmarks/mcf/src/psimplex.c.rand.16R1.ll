; ModuleID = 'psimplex.c.rand.16R1.bc'
...
entry:
  %canary = alloca i32
  store i32 1217953590, i32* %canary
...
entry:
  ...
  %jminus = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 971017096, i32* %canary
  %new_flow = alloca i64, align 8
  %xchange = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
  %w = alloca %struct.node*, align 8
...
entry:
  ...
  %delta = alloca i64, align 8
  %canary = alloca i32
  store i32 1184735097, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %opt = alloca i64, align 8
  %new_set = alloca i64, align 8
  %red_cost_of_bea = alloca i64, align 8
...
entry:
  ...
  %iminus = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1837479858, i32* %canary
  %red_cost_of_bea = alloca i64, align 8
  %bound_exchanges = alloca i64*, align 8
  %xchange = alloca i64, align 8
  %bea = alloca %struct.arc*, align 8
...
entry:
  ...
  %bound_exchanges = alloca i64*, align 8
  %canary = alloca i32
  store i32 1062233950, i32* %canary
  %jminus = alloca %struct.node*, align 8
  %new_set = alloca i64, align 8
  %w = alloca %struct.node*, align 8
  %opt = alloca i64, align 8
...
entry:
  ...
  %iplus = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1665509298, i32* %canary
  %stop_arcs = alloca %struct.arc*, align 8
  %iterations = alloca i64*, align 8
  %net.addr = alloca %struct.network*, align 8
  %jminus = alloca %struct.node*, align 8
...
entry:
  ...
  %checksum = alloca i64*, align 8
  %canary = alloca i32
  store i32 565813337, i32* %canary
  %w = alloca %struct.node*, align 8
  %new_set = alloca i64, align 8
  %jminus = alloca %struct.node*, align 8
  %iplus = alloca %struct.node*, align 8
...
entry:
  ...
  %bla = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1672622018, i32* %canary
  %iplus = alloca %struct.node*, align 8
  %temp = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
  %bound_exchanges = alloca i64*, align 8
...
entry:
  ...
  %jminus = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 906015567, i32* %canary
  %new_orientation = alloca i64, align 8
  %iterations = alloca i64*, align 8
  %xchange = alloca i64, align 8
  %checksum = alloca i64*, align 8
...
entry:
  ...
  %temp = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1253397926, i32* %canary
  %delta = alloca i64, align 8
  %checksum = alloca i64*, align 8
  %xchange = alloca i64, align 8
  %jminus = alloca %struct.node*, align 8
...
entry:
  %canary = alloca i32
  store i32 1612731344, i32* %canary
  %new_set = alloca i64, align 8
  %jminus = alloca %struct.node*, align 8
  %stop_arcs = alloca %struct.arc*, align 8
  %w = alloca %struct.node*, align 8
...
entry:
  ...
  %xchange = alloca i64, align 8
  %canary = alloca i32
  store i32 972136586, i32* %canary
  %red_cost_of_bea = alloca i64, align 8
  %arcs = alloca %struct.arc*, align 8
  %new_orientation = alloca i64, align 8
  %new_set = alloca i64, align 8
...
entry:
  ...
  %iplus = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 954917948, i32* %canary
  %temp = alloca %struct.node*, align 8
  %jminus = alloca %struct.node*, align 8
  %red_cost_of_bea = alloca i64, align 8
  %xchange = alloca i64, align 8
...
entry:
  ...
  %xchange = alloca i64, align 8
  %canary = alloca i32
  store i32 645045742, i32* %canary
  %temp = alloca %struct.node*, align 8
  %bea = alloca %struct.arc*, align 8
  %red_cost_of_bea = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  ...
  %temp = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 813976149, i32* %canary
  %bla = alloca %struct.arc*, align 8
  %m = alloca i64, align 8
  %bound_exchanges = alloca i64*, align 8
  %xchange = alloca i64, align 8
...
entry:
  %canary = alloca i32
  store i32 442959267, i32* %canary
  %stop_arcs = alloca %struct.arc*, align 8
  %jminus = alloca %struct.node*, align 8
  %iplus = alloca %struct.node*, align 8
  %m = alloca i64, align 8
