; ModuleID = 'psimplex.c.rand.16P1.bc'
...
entry:
  %canary = alloca i32
  store i32 1691989827, i32* %canary
...
entry:
  ...
  %delta = alloca i64, align 8
  %canary = alloca i32
  store i32 256029330, i32* %canary
  %bound_exchanges = alloca i64*, align 8
  %checksum = alloca i64*, align 8
  %bea = alloca %struct.arc*, align 8
  %m = alloca i64, align 8
...
entry:
  ...
  %jplus = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1283679559, i32* %canary
  %stop_arcs = alloca %struct.arc*, align 8
  %delta = alloca i64, align 8
  %checksum = alloca i64*, align 8
  %xchange = alloca i64, align 8
...
entry:
  ...
  %red_cost_of_bea = alloca i64, align 8
  %canary = alloca i32
  store i32 604341977, i32* %canary
  %checksum = alloca i64*, align 8
  %iplus = alloca %struct.node*, align 8
  %bea = alloca %struct.arc*, align 8
  %arcs = alloca %struct.arc*, align 8
...
entry:
  ...
  %xchange = alloca i64, align 8
  %canary = alloca i32
  store i32 1372940704, i32* %canary
  %checksum = alloca i64*, align 8
  %bound_exchanges = alloca i64*, align 8
  %bea = alloca %struct.arc*, align 8
  %iterations = alloca i64*, align 8
...
entry:
  ...
  %bea = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 578732072, i32* %canary
  %temp = alloca %struct.node*, align 8
  %red_cost_of_bea = alloca i64, align 8
  %stop_arcs = alloca %struct.arc*, align 8
  %new_flow = alloca i64, align 8
...
entry:
  ...
  %iterations = alloca i64*, align 8
  %canary = alloca i32
  store i32 500872093, i32* %canary
  %xchange = alloca i64, align 8
  %red_cost_of_bea = alloca i64, align 8
  %bla = alloca %struct.arc*, align 8
  %new_orientation = alloca i64, align 8
...
entry:
  ...
  %arcs = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 664166670, i32* %canary
  %new_flow = alloca i64, align 8
  %jminus = alloca %struct.node*, align 8
  %iminus = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  ...
  %bla = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1058484506, i32* %canary
  %xchange = alloca i64, align 8
  %w = alloca %struct.node*, align 8
  %jplus = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  ...
  %bea = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1249102006, i32* %canary
  %bla = alloca %struct.arc*, align 8
  %stop_arcs = alloca %struct.arc*, align 8
  %checksum = alloca i64*, align 8
  %iterations = alloca i64*, align 8
...
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 1598969720, i32* %canary
  %new_flow = alloca i64, align 8
  %jminus = alloca %struct.node*, align 8
  %xchange = alloca i64, align 8
  %w = alloca %struct.node*, align 8
...
entry:
  ...
  %jminus = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 513719480, i32* %canary
  %bound_exchanges = alloca i64*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 0, i64* %opt, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
...
entry:
  ...
  %temp = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1529947211, i32* %canary
  %arcs = alloca %struct.arc*, align 8
  %new_orientation = alloca i64, align 8
  %new_flow = alloca i64, align 8
  %bound_exchanges = alloca i64*, align 8
...
entry:
  ...
  %iplus = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 2119883958, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %iminus = alloca %struct.node*, align 8
  %red_cost_of_bea = alloca i64, align 8
  %jplus = alloca %struct.node*, align 8
...
entry:
  ...
  %m = alloca i64, align 8
  %canary = alloca i32
  store i32 1767604525, i32* %canary
  %iplus = alloca %struct.node*, align 8
  %temp = alloca %struct.node*, align 8
  %xchange = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  ...
  %w = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1461823066, i32* %canary
  %checksum = alloca i64*, align 8
  %iplus = alloca %struct.node*, align 8
  %new_orientation = alloca i64, align 8
  %stop_arcs = alloca %struct.arc*, align 8
