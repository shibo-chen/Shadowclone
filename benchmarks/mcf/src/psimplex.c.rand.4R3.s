...
# %bb.0:                                # %entry
	...
	.cfi_offset %r14, -32
	.cfi_offset %r15, -24
	movl	$292340371, -92(%rbp)   # imm = 0x116CC293
	movq	%rdi, -32(%rbp)
	movq	$0, -144(%rbp)
	movq	-32(%rbp), %rax
	movq	568(%rax), %rax
...
.LBB1_30:                               # %while.end
	...
	movq	-32(%rbp), %rdi
	callq	dual_feasible
	cmpl	$292340371, -92(%rbp)   # imm = 0x116CC293
	jne	.LBB1_32
.LBB1_31:
	xorl	%eax, %eax
	addq	$232, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_offset %r14, -32
	.cfi_offset %r15, -24
	movl	$383048041, -92(%rbp)   # imm = 0x16D4D969
	movq	%rdi, -32(%rbp)
	movq	$0, -152(%rbp)
	movq	-32(%rbp), %rax
	movq	568(%rax), %rax
...
.LBB2_30:                               # %while.end
	...
	movq	-32(%rbp), %rdi
	callq	dual_feasible
	cmpl	$383048041, -92(%rbp)   # imm = 0x16D4D969
	jne	.LBB2_32
.LBB2_31:
	xorl	%eax, %eax
	addq	$232, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_offset %r14, -32
	.cfi_offset %r15, -24
	movl	$706466126, -92(%rbp)   # imm = 0x2A1BD14E
	movq	%rdi, -32(%rbp)
	movq	$0, -120(%rbp)
	movq	-32(%rbp), %rax
	movq	568(%rax), %rax
...
.LBB3_30:                               # %while.end
	...
	movq	-32(%rbp), %rdi
	callq	dual_feasible
	cmpl	$706466126, -92(%rbp)   # imm = 0x2A1BD14E
	jne	.LBB3_32
.LBB3_31:
	xorl	%eax, %eax
	addq	$232, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_offset %r14, -32
	.cfi_offset %r15, -24
	movl	$310150597, -92(%rbp)   # imm = 0x127C85C5
	movq	%rdi, -32(%rbp)
	movq	$0, -152(%rbp)
	movq	-32(%rbp), %rax
	movq	568(%rax), %rax
...
.LBB4_30:                               # %while.end
	...
	movq	-32(%rbp), %rdi
	callq	dual_feasible
	cmpl	$310150597, -92(%rbp)   # imm = 0x127C85C5
	jne	.LBB4_32
.LBB4_31:
	xorl	%eax, %eax
	addq	$232, %rsp
