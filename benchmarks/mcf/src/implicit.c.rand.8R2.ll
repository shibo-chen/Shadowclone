; ModuleID = 'implicit.c.rand.8R2.bc'
...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_resize_prob.2, label %ctrl0

func_resize_prob.2:                               ; preds = %rand_bb
  %2 = call i64 @resize_prob.2(%struct.network* %net)
  ret i64 %2

func_resize_prob.9:                               ; preds = %ctrl0
  %3 = call i64 @resize_prob.9(%struct.network* %net)
  ret i64 %3

func_resize_prob.13:                              ; preds = %ctrl1
  %4 = call i64 @resize_prob.13(%struct.network* %net)
  ret i64 %4

func_resize_prob.16:                              ; preds = %ctrl2
  %5 = call i64 @resize_prob.16(%struct.network* %net)
  ret i64 %5

func_resize_prob.19:                              ; preds = %ctrl3
  %6 = call i64 @resize_prob.19(%struct.network* %net)
  ret i64 %6

func_resize_prob.26:                              ; preds = %ctrl4
  %7 = call i64 @resize_prob.26(%struct.network* %net)
  ret i64 %7

func_resize_prob.31:                              ; preds = %ctrl5
  %8 = call i64 @resize_prob.31(%struct.network* %net)
  ret i64 %8

func_resize_prob.40:                              ; preds = %ctrl5
  %9 = call i64 @resize_prob.40(%struct.network* %net)
  ret i64 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_resize_prob.9, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_resize_prob.13, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_resize_prob.16, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_resize_prob.19, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_resize_prob.26, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_resize_prob.31, label %func_resize_prob.40
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_insert_new_arc.4, label %ctrl0

func_insert_new_arc.4:                            ; preds = %rand_bb
  call void @insert_new_arc.4(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void

func_insert_new_arc.11:                           ; preds = %ctrl0
  call void @insert_new_arc.11(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void

func_insert_new_arc.12:                           ; preds = %ctrl1
  call void @insert_new_arc.12(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void

func_insert_new_arc.14:                           ; preds = %ctrl2
  call void @insert_new_arc.14(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void

func_insert_new_arc.25:                           ; preds = %ctrl3
  call void @insert_new_arc.25(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void

func_insert_new_arc.28:                           ; preds = %ctrl4
  call void @insert_new_arc.28(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void

func_insert_new_arc.32:                           ; preds = %ctrl5
  call void @insert_new_arc.32(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void

func_insert_new_arc.34:                           ; preds = %ctrl5
  call void @insert_new_arc.34(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_insert_new_arc.11, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_insert_new_arc.12, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_insert_new_arc.14, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_insert_new_arc.25, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_insert_new_arc.28, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_insert_new_arc.32, label %func_insert_new_arc.34
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_replace_weaker_arc.6, label %ctrl0

func_replace_weaker_arc.6:                        ; preds = %rand_bb
  call void @replace_weaker_arc.6(%struct.network* %net, %struct.arc* %new, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void

func_replace_weaker_arc.17:                       ; preds = %ctrl0
  call void @replace_weaker_arc.17(%struct.network* %net, %struct.arc* %new, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void

func_replace_weaker_arc.20:                       ; preds = %ctrl1
  call void @replace_weaker_arc.20(%struct.network* %net, %struct.arc* %new, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void

func_replace_weaker_arc.23:                       ; preds = %ctrl2
  call void @replace_weaker_arc.23(%struct.network* %net, %struct.arc* %new, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void

func_replace_weaker_arc.27:                       ; preds = %ctrl3
  call void @replace_weaker_arc.27(%struct.network* %net, %struct.arc* %new, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void

func_replace_weaker_arc.29:                       ; preds = %ctrl4
  call void @replace_weaker_arc.29(%struct.network* %net, %struct.arc* %new, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void

func_replace_weaker_arc.30:                       ; preds = %ctrl5
  call void @replace_weaker_arc.30(%struct.network* %net, %struct.arc* %new, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void

func_replace_weaker_arc.38:                       ; preds = %ctrl5
  call void @replace_weaker_arc.38(%struct.network* %net, %struct.arc* %new, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_replace_weaker_arc.17, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_replace_weaker_arc.20, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_replace_weaker_arc.23, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_replace_weaker_arc.27, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_replace_weaker_arc.29, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_replace_weaker_arc.30, label %func_replace_weaker_arc.38
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_price_out_impl.7, label %ctrl0

func_price_out_impl.7:                            ; preds = %rand_bb
  %2 = call i64 @price_out_impl.7(%struct.network* %net)
  ret i64 %2

func_price_out_impl.8:                            ; preds = %ctrl0
  %3 = call i64 @price_out_impl.8(%struct.network* %net)
  ret i64 %3

func_price_out_impl.15:                           ; preds = %ctrl1
  %4 = call i64 @price_out_impl.15(%struct.network* %net)
  ret i64 %4

func_price_out_impl.21:                           ; preds = %ctrl2
  %5 = call i64 @price_out_impl.21(%struct.network* %net)
  ret i64 %5

func_price_out_impl.24:                           ; preds = %ctrl3
  %6 = call i64 @price_out_impl.24(%struct.network* %net)
  ret i64 %6

func_price_out_impl.36:                           ; preds = %ctrl4
  %7 = call i64 @price_out_impl.36(%struct.network* %net)
  ret i64 %7

func_price_out_impl.37:                           ; preds = %ctrl5
  %8 = call i64 @price_out_impl.37(%struct.network* %net)
  ret i64 %8

func_price_out_impl.39:                           ; preds = %ctrl5
  %9 = call i64 @price_out_impl.39(%struct.network* %net)
  ret i64 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_price_out_impl.8, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_price_out_impl.15, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_price_out_impl.21, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_price_out_impl.24, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_price_out_impl.36, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_price_out_impl.37, label %func_price_out_impl.39
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_suspend_impl.1, label %ctrl0

func_suspend_impl.1:                              ; preds = %rand_bb
  %2 = call i64 @suspend_impl.1(%struct.network* %net, i64 %threshold, i64 %all)
  ret i64 %2

func_suspend_impl.3:                              ; preds = %ctrl0
  %3 = call i64 @suspend_impl.3(%struct.network* %net, i64 %threshold, i64 %all)
  ret i64 %3

func_suspend_impl.5:                              ; preds = %ctrl1
  %4 = call i64 @suspend_impl.5(%struct.network* %net, i64 %threshold, i64 %all)
  ret i64 %4

func_suspend_impl.10:                             ; preds = %ctrl2
  %5 = call i64 @suspend_impl.10(%struct.network* %net, i64 %threshold, i64 %all)
  ret i64 %5

func_suspend_impl.18:                             ; preds = %ctrl3
  %6 = call i64 @suspend_impl.18(%struct.network* %net, i64 %threshold, i64 %all)
  ret i64 %6

func_suspend_impl.22:                             ; preds = %ctrl4
  %7 = call i64 @suspend_impl.22(%struct.network* %net, i64 %threshold, i64 %all)
  ret i64 %7

func_suspend_impl.33:                             ; preds = %ctrl5
  %8 = call i64 @suspend_impl.33(%struct.network* %net, i64 %threshold, i64 %all)
  ret i64 %8

func_suspend_impl.35:                             ; preds = %ctrl5
  %9 = call i64 @suspend_impl.35(%struct.network* %net, i64 %threshold, i64 %all)
  ret i64 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_suspend_impl.3, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_suspend_impl.5, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_suspend_impl.10, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_suspend_impl.18, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_suspend_impl.22, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_suspend_impl.33, label %func_suspend_impl.35
}
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @suspend_impl.1(%struct.network* %net, i64 %threshold, i64 %all) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 1890921453, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @resize_prob.2(%struct.network* %net) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 1245273376, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @suspend_impl.3(%struct.network* %net, i64 %threshold, i64 %all) #0 {
entry:
  %threshold.addr = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
  %all.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1852195943, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %red_cost = alloca i64, align 8
  %stop = alloca i8*, align 8
  %susp = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @insert_new_arc.4(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost) #0 {
entry:
  %canary = alloca i32
  store i32 2074414669, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @suspend_impl.5(%struct.network* %net, i64 %threshold, i64 %all) #0 {
entry:
  %stop = alloca i8*, align 8
  %all.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1879363764, i32* %canary
  %susp = alloca i64, align 8
  %threshold.addr = alloca i64, align 8
  %new_arc = alloca %struct.arc*, align 8
  %arc = alloca %struct.arc*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @replace_weaker_arc.6(%struct.network* %net, %struct.arc* %new, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost) #0 {
entry:
  %head.addr = alloca %struct.node*, align 8
  %cost.addr = alloca i64, align 8
  %pos = alloca i64, align 8
  %canary = alloca i32
  store i32 351538165, i32* %canary
  %red_cost.addr = alloca i64, align 8
  %new.addr = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @price_out_impl.7(%struct.network* %net) #0 {
entry:
  %bigM_minus_min_impl_duration = alloca i64, align 8
  %canary = alloca i32
  store i32 803788931, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @price_out_impl.8(%struct.network* %net) #0 {
entry:
  %resized = alloca i64, align 8
  %arcout = alloca %struct.arc*, align 8
  %head_potential = alloca i64, align 8
  ...
  %head = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 2022064420, i32* %canary
  %arcnew = alloca %struct.arc*, align 8
  %i = alloca i64, align 8
  %new_arcs = alloca i64, align 8
  %arcin = alloca %struct.arc*, align 8
...
return:                                           ; preds = %if.end109, %if.then10
  %143 = load i64, i64* %retval, align 8
  %144 = load i32, i32* %canary
  %145 = icmp eq i32 %144, 2022064420
  br i1 %145, label %146, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @resize_prob.9(%struct.network* %net) #0 {
entry:
  %off = alloca i64, align 8
  %stop = alloca %struct.node*, align 8
  %retval = alloca i64, align 8
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 2036748763, i32* %canary
  %node = alloca %struct.node*, align 8
  %root = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @suspend_impl.10(%struct.network* %net, i64 %threshold, i64 %all) #0 {
entry:
  %red_cost = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
  %all.addr = alloca i64, align 8
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 789357106, i32* %canary
  %stop = alloca i8*, align 8
  %threshold.addr = alloca i64, align 8
  %susp = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @insert_new_arc.11(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost) #0 {
entry:
  %red_cost.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 884016735, i32* %canary
  %cost.addr = alloca i64, align 8
  %head.addr = alloca %struct.node*, align 8
  %pos = alloca i64, align 8
  %tail.addr = alloca %struct.node*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @insert_new_arc.12(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost) #0 {
entry:
  %head.addr = alloca %struct.node*, align 8
  %cost.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 537920092, i32* %canary
  %newpos.addr = alloca i64, align 8
  %tail.addr = alloca %struct.node*, align 8
  %new.addr = alloca %struct.arc*, align 8
  %red_cost.addr = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @resize_prob.13(%struct.network* %net) #0 {
entry:
  %retval = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
  %stop = alloca %struct.node*, align 8
  ...
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 460697178, i32* %canary
  %off = alloca i64, align 8
  %root = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @insert_new_arc.14(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost) #0 {
entry:
  %new.addr = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 861645845, i32* %canary
  %cost.addr = alloca i64, align 8
  %newpos.addr = alloca i64, align 8
  %pos = alloca i64, align 8
  %red_cost.addr = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @price_out_impl.15(%struct.network* %net) #0 {
entry:
  %stop = alloca %struct.arc*, align 8
  %trips = alloca i64, align 8
  %arc_cost = alloca i64, align 8
  ...
  %resized = alloca i64, align 8
  %canary = alloca i32
  store i32 315105528, i32* %canary
  %tail = alloca %struct.node*, align 8
  %new_arcs = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
  %head_potential = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @replace_weaker_arc.17(%struct.network* %net, %struct.arc* %new, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost) #0 {
entry:
  %head.addr = alloca %struct.node*, align 8
  %tail.addr = alloca %struct.node*, align 8
  %cmp = alloca i64, align 8
  ...
  %cost.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 363888095, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %red_cost.addr = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store %struct.arc* %new, %struct.arc** %new.addr, align 8
...
entry:
  ...
  %threshold.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1331751081, i32* %canary
  %susp = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 %threshold, i64* %threshold.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @resize_prob.19(%struct.network* %net) #0 {
entry:
  %stop = alloca %struct.node*, align 8
  %off = alloca i64, align 8
  %node = alloca %struct.node*, align 8
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1036957831, i32* %canary
  %retval = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
  %root = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @replace_weaker_arc.20(%struct.network* %net, %struct.arc* %new, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost) #0 {
entry:
  %cost.addr = alloca i64, align 8
  %tail.addr = alloca %struct.node*, align 8
  %new.addr = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 2109926733, i32* %canary
  %cmp = alloca i64, align 8
  %head.addr = alloca %struct.node*, align 8
  %red_cost.addr = alloca i64, align 8
  %pos = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @price_out_impl.21(%struct.network* %net) #0 {
entry:
  %tail = alloca %struct.node*, align 8
  %arcout = alloca %struct.arc*, align 8
  %arc_cost = alloca i64, align 8
  ...
  %arcnew = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 2081119959, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %bigM_minus_min_impl_duration = alloca i64, align 8
  %head_potential = alloca i64, align 8
  %red_cost = alloca i64, align 8
...
return:                                           ; preds = %if.end109, %if.then10
  %143 = load i64, i64* %retval, align 8
  %144 = load i32, i32* %canary
  %145 = icmp eq i32 %144, 2081119959
  br i1 %145, label %146, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @suspend_impl.22(%struct.network* %net, i64 %threshold, i64 %all) #0 {
entry:
  %all.addr = alloca i64, align 8
  %new_arc = alloca %struct.arc*, align 8
  %threshold.addr = alloca i64, align 8
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 1787620721, i32* %canary
  %red_cost = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 %threshold, i64* %threshold.addr, align 8
  store i64 %all, i64* %all.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @replace_weaker_arc.23(%struct.network* %net, %struct.arc* %new, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost) #0 {
entry:
  %red_cost.addr = alloca i64, align 8
  %pos = alloca i64, align 8
  %cmp = alloca i64, align 8
  %canary = alloca i32
  store i32 8537587, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %tail.addr = alloca %struct.node*, align 8
  %head.addr = alloca %struct.node*, align 8
  %cost.addr = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @price_out_impl.24(%struct.network* %net) #0 {
entry:
  %net.addr = alloca %struct.network*, align 8
  %resized = alloca i64, align 8
  %head_potential = alloca i64, align 8
  ...
  %trips = alloca i64, align 8
  %canary = alloca i32
  store i32 824467909, i32* %canary
  %arcnew = alloca %struct.arc*, align 8
  %bigM = alloca i64, align 8
  %latest = alloca i64, align 8
  %head = alloca %struct.node*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @insert_new_arc.25(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost) #0 {
entry:
  %newpos.addr = alloca i64, align 8
  %red_cost.addr = alloca i64, align 8
  %new.addr = alloca %struct.arc*, align 8
  %cost.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1115160703, i32* %canary
  %tail.addr = alloca %struct.node*, align 8
  %pos = alloca i64, align 8
  %head.addr = alloca %struct.node*, align 8
  store %struct.arc* %new, %struct.arc** %new.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @resize_prob.26(%struct.network* %net) #0 {
entry:
  %arc = alloca %struct.arc*, align 8
  %root = alloca %struct.node*, align 8
  %stop = alloca %struct.node*, align 8
  ...
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 529190007, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %off = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @replace_weaker_arc.27(%struct.network* %net, %struct.arc* %new, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost) #0 {
entry:
  %canary = alloca i32
  store i32 181869853, i32* %canary
  %cmp = alloca i64, align 8
  %tail.addr = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
  %head.addr = alloca %struct.node*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @insert_new_arc.28(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost) #0 {
entry:
  %head.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1559164068, i32* %canary
  %red_cost.addr = alloca i64, align 8
  %newpos.addr = alloca i64, align 8
  %new.addr = alloca %struct.arc*, align 8
  %tail.addr = alloca %struct.node*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @replace_weaker_arc.29(%struct.network* %net, %struct.arc* %new, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost) #0 {
entry:
  %pos = alloca i64, align 8
  %canary = alloca i32
  store i32 745844722, i32* %canary
  %new.addr = alloca %struct.arc*, align 8
  %cmp = alloca i64, align 8
  %tail.addr = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @replace_weaker_arc.30(%struct.network* %net, %struct.arc* %new, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost) #0 {
entry:
  %cmp = alloca i64, align 8
  %canary = alloca i32
  store i32 1421201949, i32* %canary
  %cost.addr = alloca i64, align 8
  %pos = alloca i64, align 8
  %new.addr = alloca %struct.arc*, align 8
  %tail.addr = alloca %struct.node*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @resize_prob.31(%struct.network* %net) #0 {
entry:
  %root = alloca %struct.node*, align 8
  %arc = alloca %struct.arc*, align 8
  %node = alloca %struct.node*, align 8
  %off = alloca i64, align 8
  %canary = alloca i32
  store i32 1931056938, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %stop = alloca %struct.node*, align 8
  %retval = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @insert_new_arc.32(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost) #0 {
entry:
  %red_cost.addr = alloca i64, align 8
  %head.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 284077967, i32* %canary
  %cost.addr = alloca i64, align 8
  %newpos.addr = alloca i64, align 8
  %tail.addr = alloca %struct.node*, align 8
  %new.addr = alloca %struct.arc*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @suspend_impl.33(%struct.network* %net, i64 %threshold, i64 %all) #0 {
entry:
  %stop = alloca i8*, align 8
  %all.addr = alloca i64, align 8
  %susp = alloca i64, align 8
  ...
  %threshold.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1477170421, i32* %canary
  %red_cost = alloca i64, align 8
  %new_arc = alloca %struct.arc*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 %threshold, i64* %threshold.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @insert_new_arc.34(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost) #0 {
entry:
  %pos = alloca i64, align 8
  %new.addr = alloca %struct.arc*, align 8
  %red_cost.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 145265809, i32* %canary
  %tail.addr = alloca %struct.node*, align 8
  %cost.addr = alloca i64, align 8
  %newpos.addr = alloca i64, align 8
  %head.addr = alloca %struct.node*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @suspend_impl.35(%struct.network* %net, i64 %threshold, i64 %all) #0 {
entry:
  %new_arc = alloca %struct.arc*, align 8
  %stop = alloca i8*, align 8
  %net.addr = alloca %struct.network*, align 8
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1042413245, i32* %canary
  %threshold.addr = alloca i64, align 8
  %all.addr = alloca i64, align 8
  %red_cost = alloca i64, align 8
  %susp = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @price_out_impl.36(%struct.network* %net) #0 {
entry:
  %trips = alloca i64, align 8
  %red_cost = alloca i64, align 8
  %new_arcs = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @price_out_impl.37(%struct.network* %net) #0 {
entry:
  %red_cost = alloca i64, align 8
  %i = alloca i64, align 8
  %bigM = alloca i64, align 8
  ...
  %new_arcs = alloca i64, align 8
  %canary = alloca i32
  store i32 388674394, i32* %canary
  %arc_cost = alloca i64, align 8
  %resized = alloca i64, align 8
  %min_impl_duration = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @replace_weaker_arc.38(%struct.network* %net, %struct.arc* %new, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost) #0 {
entry:
  %pos = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
  %cmp = alloca i64, align 8
  ...
  %tail.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 2113395304, i32* %canary
  %cost.addr = alloca i64, align 8
  %head.addr = alloca %struct.node*, align 8
  %red_cost.addr = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @price_out_impl.39(%struct.network* %net) #0 {
entry:
  %i = alloca i64, align 8
  %resized = alloca i64, align 8
  %retval = alloca i64, align 8
  ...
  %stop = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 2143962826, i32* %canary
  %arcin = alloca %struct.arc*, align 8
  %bigM = alloca i64, align 8
  %red_cost = alloca i64, align 8
  %latest = alloca i64, align 8
...
return:                                           ; preds = %if.end109, %if.then10
  %143 = load i64, i64* %retval, align 8
  %144 = load i32, i32* %canary
  %145 = icmp eq i32 %144, 2143962826
  br i1 %145, label %146, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @resize_prob.40(%struct.network* %net) #0 {
entry:
  %stop = alloca %struct.node*, align 8
  %off = alloca i64, align 8
  %canary = alloca i32
  store i32 866404280, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %retval = alloca i64, align 8
  %node = alloca %struct.node*, align 8
  %arc = alloca %struct.arc*, align 8
