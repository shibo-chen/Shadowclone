...
# %bb.0:                                # %entry
	...
	.cfi_offset %rbx, -24
	movl	$979803845, -76(%rbp)   # imm = 0x3A669EC5
	movq	%rdi, -16(%rbp)
	movq	$0, -72(%rbp)
	movq	-16(%rbp), %rdi
	movabsq	$.L.str, %rsi
...
.LBB1_46:                               # %return
	movq	-64(%rbp), %rbx
	cmpl	$979803845, -76(%rbp)   # imm = 0x3A669EC5
	jne	.LBB1_48
.LBB1_47:
	movq	%rbx, %rax
...
# %bb.0:                                # %entry
	...
	subq	$296, %rsp              # imm = 0x128
	.cfi_offset %rbx, -24
	movl	$1130501187, -76(%rbp)  # imm = 0x43621443
	movq	%rdi, -16(%rbp)
	movq	$0, -72(%rbp)
	movq	-16(%rbp), %rdi
	movabsq	$.L.str, %rsi
...
.LBB2_46:                               # %return
	movq	-64(%rbp), %rbx
	cmpl	$1130501187, -76(%rbp)  # imm = 0x43621443
	jne	.LBB2_48
.LBB2_47:
	movq	%rbx, %rax
	addq	$296, %rsp              # imm = 0x128
...
# %bb.0:                                # %entry
	...
	subq	$296, %rsp              # imm = 0x128
	.cfi_offset %rbx, -24
	movl	$534321096, -76(%rbp)   # imm = 0x1FD917C8
	movq	%rdi, -16(%rbp)
	movq	$0, -72(%rbp)
	movq	-16(%rbp), %rdi
	movabsq	$.L.str, %rsi
...
.LBB3_46:                               # %return
	movq	-56(%rbp), %rbx
	cmpl	$534321096, -76(%rbp)   # imm = 0x1FD917C8
	jne	.LBB3_48
.LBB3_47:
	movq	%rbx, %rax
	addq	$296, %rsp              # imm = 0x128
...
# %bb.0:                                # %entry
	...
	subq	$296, %rsp              # imm = 0x128
	.cfi_offset %rbx, -24
	movl	$1158395067, -76(%rbp)  # imm = 0x450BB4BB
	movq	%rdi, -16(%rbp)
	movq	$0, -72(%rbp)
	movq	-16(%rbp), %rdi
	movabsq	$.L.str, %rsi
...
.LBB4_46:                               # %return
	movq	-64(%rbp), %rbx
	cmpl	$1158395067, -76(%rbp)  # imm = 0x450BB4BB
	jne	.LBB4_48
.LBB4_47:
	movq	%rbx, %rax
	addq	$296, %rsp              # imm = 0x128
...
# %bb.0:                                # %entry
	...
	subq	$296, %rsp              # imm = 0x128
	.cfi_offset %rbx, -24
	movl	$932360654, -76(%rbp)   # imm = 0x3792B1CE
	movq	%rdi, -16(%rbp)
	movq	$0, -72(%rbp)
	movq	-16(%rbp), %rdi
	movabsq	$.L.str, %rsi
...
.LBB5_46:                               # %return
	movq	-56(%rbp), %rbx
	cmpl	$932360654, -76(%rbp)   # imm = 0x3792B1CE
	jne	.LBB5_48
.LBB5_47:
	movq	%rbx, %rax
	addq	$296, %rsp              # imm = 0x128
...
# %bb.0:                                # %entry
	...
	subq	$296, %rsp              # imm = 0x128
	.cfi_offset %rbx, -24
	movl	$1805231740, -76(%rbp)  # imm = 0x6B99A67C
	movq	%rdi, -16(%rbp)
	movq	$0, -72(%rbp)
	movq	-16(%rbp), %rdi
	movabsq	$.L.str, %rsi
...
.LBB6_46:                               # %return
	movq	-56(%rbp), %rbx
	cmpl	$1805231740, -76(%rbp)  # imm = 0x6B99A67C
	jne	.LBB6_48
.LBB6_47:
	movq	%rbx, %rax
	addq	$296, %rsp              # imm = 0x128
...
# %bb.0:                                # %entry
	...
	subq	$296, %rsp              # imm = 0x128
	.cfi_offset %rbx, -24
	movl	$179614739, -76(%rbp)   # imm = 0xAB4B413
	movq	%rdi, -16(%rbp)
	movq	$0, -72(%rbp)
	movq	-16(%rbp), %rdi
	movabsq	$.L.str, %rsi
...
.LBB7_46:                               # %return
	movq	-56(%rbp), %rbx
	cmpl	$179614739, -76(%rbp)   # imm = 0xAB4B413
	jne	.LBB7_48
.LBB7_47:
	movq	%rbx, %rax
	addq	$296, %rsp              # imm = 0x128
...
# %bb.0:                                # %entry
	...
	subq	$296, %rsp              # imm = 0x128
	.cfi_offset %rbx, -24
	movl	$783773585, -76(%rbp)   # imm = 0x2EB76F91
	movq	%rdi, -16(%rbp)
	movq	$0, -72(%rbp)
	movq	-16(%rbp), %rdi
	movabsq	$.L.str, %rsi
...
.LBB8_46:                               # %return
	movq	-64(%rbp), %rbx
	cmpl	$783773585, -76(%rbp)   # imm = 0x2EB76F91
	jne	.LBB8_48
.LBB8_47:
	movq	%rbx, %rax
	addq	$296, %rsp              # imm = 0x128
