; ModuleID = 'pbeampp.c.rand.4R2.bc'
...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_bea_is_dual_infeasible.5, label %func_bea_is_dual_infeasible.9
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_sort_basket.6, label %ctrl0

func_sort_basket.6:                               ; preds = %rand_bb
  call void @sort_basket.6(i64 %min, i64 %max)
  ret void

func_sort_basket.7:                               ; preds = %ctrl0
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_sort_basket.7, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_sort_basket.8, label %func_sort_basket.10
}
...
func_primal_bea_mpp.2:                            ; preds = %ctrl0
  %3 = call %struct.arc* @primal_bea_mpp.2(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea)
  ret %struct.arc* %3

func_primal_bea_mpp.3:                            ; preds = %ctrl1
  %4 = call %struct.arc* @primal_bea_mpp.3(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea)
  ret %struct.arc* %4

func_primal_bea_mpp.4:                            ; preds = %ctrl1
  %5 = call %struct.arc* @primal_bea_mpp.4(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea)
  ret %struct.arc* %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_primal_bea_mpp.2, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_primal_bea_mpp.3, label %func_primal_bea_mpp.4
}
...
entry:
  %canary = alloca i32
  store i32 1332939694, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct.arc* @primal_bea_mpp.2(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea) #0 {
entry:
  %i = alloca i64, align 8
  %red_cost = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
  ...
  %arcs.addr = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 120583129, i32* %canary
  %next = alloca i64, align 8
  store i64 %m, i64* %m.addr, align 8
  store %struct.arc* %arcs, %struct.arc** %arcs.addr, align 8
  store %struct.arc* %stop_arcs, %struct.arc** %stop_arcs.addr, align 8
...
entry:
  ...
  %stop_arcs.addr = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1246957845, i32* %canary
  %next = alloca i64, align 8
  %retval = alloca %struct.arc*, align 8
  %red_cost = alloca i64, align 8
  %red_cost_of_bea.addr = alloca i64*, align 8
...
entry:
  ...
  %arcs.addr = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1287700405, i32* %canary
  %red_cost_of_bea.addr = alloca i64*, align 8
  %stop_arcs.addr = alloca %struct.arc*, align 8
  store i64 %m, i64* %m.addr, align 8
  store %struct.arc* %arcs, %struct.arc** %arcs.addr, align 8
...
entry:
  ...
  %canary = alloca i32
  store i32 1352775093, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 967525771, i32* %canary
...
entry:
  ...
  %cut = alloca i64, align 8
  %canary = alloca i32
  store i32 411855838, i32* %canary
  %max.addr = alloca i64, align 8
  %l = alloca i64, align 8
  %min.addr = alloca i64, align 8
  %xchange = alloca %struct.basket*, align 8
...
entry:
  ...
  %max.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1886764466, i32* %canary
  %l = alloca i64, align 8
  %xchange = alloca %struct.basket*, align 8
  %r = alloca i64, align 8
  store i64 %min, i64* %min.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 2122654123, i32* %canary
  %red_cost.addr = alloca i64, align 8
  %arc.addr = alloca %struct.arc*, align 8
  store %struct.arc* %arc, %struct.arc** %arc.addr, align 8
  store i64 %red_cost, i64* %red_cost.addr, align 8
...
entry:
  ...
  %max.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1754030599, i32* %canary
  %r = alloca i64, align 8
  %min.addr = alloca i64, align 8
  %l = alloca i64, align 8
  %cut = alloca i64, align 8
