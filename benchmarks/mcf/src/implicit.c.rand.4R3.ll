; ModuleID = 'implicit.c.rand.4R3.bc'
...
func_resize_prob.11:                              ; preds = %ctrl1
  %4 = call i64 @resize_prob.11(%struct.network* %net)
  ret i64 %4

func_resize_prob.19:                              ; preds = %ctrl1
  %5 = call i64 @resize_prob.19(%struct.network* %net)
  ret i64 %5
...
ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_resize_prob.11, label %func_resize_prob.19
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_insert_new_arc.1, label %ctrl0

func_insert_new_arc.1:                            ; preds = %rand_bb
  call void @insert_new_arc.1(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void
...
func_insert_new_arc.8:                            ; preds = %ctrl1
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_insert_new_arc.8, label %func_insert_new_arc.10
}
...
func_replace_weaker_arc.12:                       ; preds = %ctrl0
...
func_replace_weaker_arc.18:                       ; preds = %ctrl1
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_replace_weaker_arc.12, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_replace_weaker_arc.15, label %func_replace_weaker_arc.18
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_price_out_impl.5, label %ctrl0

func_price_out_impl.5:                            ; preds = %rand_bb
  %2 = call i64 @price_out_impl.5(%struct.network* %net)
  ret i64 %2

func_price_out_impl.9:                            ; preds = %ctrl0
  %3 = call i64 @price_out_impl.9(%struct.network* %net)
  ret i64 %3

func_price_out_impl.13:                           ; preds = %ctrl1
  %4 = call i64 @price_out_impl.13(%struct.network* %net)
  ret i64 %4
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_price_out_impl.9, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_price_out_impl.13, label %func_price_out_impl.14
}
...
func_suspend_impl.16:                             ; preds = %ctrl0
  %3 = call i64 @suspend_impl.16(%struct.network* %net, i64 %threshold, i64 %all)
  ret i64 %3

func_suspend_impl.17:                             ; preds = %ctrl1
  %4 = call i64 @suspend_impl.17(%struct.network* %net, i64 %threshold, i64 %all)
  ret i64 %4
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_suspend_impl.16, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_suspend_impl.17, label %func_suspend_impl.20
}
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @insert_new_arc.1(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 407489327, i32* %canary
...
entry:
  ...
  %pos = alloca i64, align 8
  %canary = alloca i32
  store i32 350041810, i32* %canary
  %head.addr = alloca %struct.node*, align 8
...
entry:
  ...
  %canary = alloca i32
  store i32 1556397625, i32* %canary
...
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 1030252535, i32* %canary
  %arc = alloca %struct.arc*, align 8
...
entry:
  ...
  %canary = alloca i32
  store i32 1904375058, i32* %canary
  %retval = alloca i64, align 8
  %red_cost = alloca i64, align 8
...
return:                                           ; preds = %if.end109, %if.then10
  ...
  %145 = icmp eq i32 %144, 1904375058
...
entry:
  ...
  %retval = alloca i64, align 8
  %canary = alloca i32
  store i32 1889539376, i32* %canary
  %root = alloca %struct.node*, align 8
  %off = alloca i64, align 8
  %stop = alloca %struct.node*, align 8
  %arc = alloca %struct.arc*, align 8
...
entry:
  ...
  %cost.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 649222648, i32* %canary
  %new.addr = alloca %struct.arc*, align 8
  %red_cost.addr = alloca i64, align 8
  %head.addr = alloca %struct.node*, align 8
  store %struct.arc* %new, %struct.arc** %new.addr, align 8
...
entry:
  ...
  %head.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 990859685, i32* %canary
  %pos = alloca i64, align 8
  store %struct.arc* %new, %struct.arc** %new.addr, align 8
  store i64 %newpos, i64* %newpos.addr, align 8
  store %struct.node* %tail, %struct.node** %tail.addr, align 8
...
entry:
  ...
  %arcnew = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 685637381, i32* %canary
  %bigM_minus_min_impl_duration = alloca i64, align 8
  %first_of_sparse_list = alloca %struct.arc*, align 8
  %min_impl_duration = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1568242378, i32* %canary
  %tail.addr = alloca %struct.node*, align 8
  %new.addr = alloca %struct.arc*, align 8
  %pos = alloca i64, align 8
  %newpos.addr = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @resize_prob.11(%struct.network* %net) #0 {
entry:
  %node = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
  %root = alloca %struct.node*, align 8
  %stop = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 121546168, i32* %canary
  %retval = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
  %off = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  ...
  %red_cost.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 720884113, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %pos = alloca i64, align 8
  %new.addr = alloca %struct.arc*, align 8
  %head.addr = alloca %struct.node*, align 8
...
entry:
  ...
  %stop = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 944350065, i32* %canary
  %arcnew = alloca %struct.arc*, align 8
  %latest = alloca i64, align 8
  %trips = alloca i64, align 8
  %head = alloca %struct.node*, align 8
...
entry:
  %canary = alloca i32
  store i32 1316299621, i32* %canary
  %stop = alloca %struct.arc*, align 8
  %arcin = alloca %struct.arc*, align 8
  %head = alloca %struct.node*, align 8
  %resized = alloca i64, align 8
...
return:                                           ; preds = %if.end109, %if.then10
  %143 = load i64, i64* %retval, align 8
  %144 = load i32, i32* %canary
  %145 = icmp eq i32 %144, 1316299621
  br i1 %145, label %146, label %func_exit
...
entry:
  ...
  %tail.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1615157478, i32* %canary
  %new.addr = alloca %struct.arc*, align 8
  %red_cost.addr = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store %struct.arc* %new, %struct.arc** %new.addr, align 8
...
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 1108096277, i32* %canary
  %susp = alloca i64, align 8
  %threshold.addr = alloca i64, align 8
  %red_cost = alloca i64, align 8
  %all.addr = alloca i64, align 8
...
entry:
  ...
  %susp = alloca i64, align 8
  %canary = alloca i32
  store i32 754178538, i32* %canary
  %threshold.addr = alloca i64, align 8
  %new_arc = alloca %struct.arc*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 %threshold, i64* %threshold.addr, align 8
...
entry:
  ...
  %head.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1190019488, i32* %canary
  %tail.addr = alloca %struct.node*, align 8
  %cost.addr = alloca i64, align 8
  %new.addr = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
...
entry:
  ...
  %root = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1428347658, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %off = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 163671075, i32* %canary
  %new_arc = alloca %struct.arc*, align 8
  %red_cost = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
  %susp = alloca i64, align 8
