...
# %bb.0:                                # %entry
	...
	.cfi_offset %r14, -32
	.cfi_offset %r15, -24
	movl	$1945806063, -92(%rbp)  # imm = 0x73FAA4EF
	movq	%rdi, -32(%rbp)
	movq	$0, -152(%rbp)
	movq	-32(%rbp), %rax
	movq	568(%rax), %rax
...
.LBB1_30:                               # %while.end
	...
	movq	-32(%rbp), %rdi
	callq	dual_feasible
	cmpl	$1945806063, -92(%rbp)  # imm = 0x73FAA4EF
	jne	.LBB1_32
.LBB1_31:
	xorl	%eax, %eax
	addq	$232, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_offset %r14, -32
	.cfi_offset %r15, -24
	movl	$103389246, -92(%rbp)   # imm = 0x629983E
	movq	%rdi, -32(%rbp)
	movq	$0, -136(%rbp)
	movq	-32(%rbp), %rax
	movq	568(%rax), %rax
...
.LBB2_30:                               # %while.end
	...
	movq	-32(%rbp), %rdi
	callq	dual_feasible
	cmpl	$103389246, -92(%rbp)   # imm = 0x629983E
	jne	.LBB2_32
.LBB2_31:
	xorl	%eax, %eax
	addq	$232, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_offset %r14, -32
	.cfi_offset %r15, -24
	movl	$1425394105, -92(%rbp)  # imm = 0x54F5C9B9
	movq	%rdi, -32(%rbp)
	movq	$0, -120(%rbp)
	movq	-32(%rbp), %rax
	movq	568(%rax), %rax
...
.LBB3_30:                               # %while.end
	...
	movq	-32(%rbp), %rdi
	callq	dual_feasible
	cmpl	$1425394105, -92(%rbp)  # imm = 0x54F5C9B9
	jne	.LBB3_32
.LBB3_31:
	xorl	%eax, %eax
	addq	$232, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_offset %r14, -32
	.cfi_offset %r15, -24
	movl	$390580075, -92(%rbp)   # imm = 0x1747C76B
	movq	%rdi, -32(%rbp)
	movq	$0, -152(%rbp)
	movq	-32(%rbp), %rax
	movq	568(%rax), %rax
...
.LBB4_30:                               # %while.end
	...
	movq	-32(%rbp), %rdi
	callq	dual_feasible
	cmpl	$390580075, -92(%rbp)   # imm = 0x1747C76B
	jne	.LBB4_32
.LBB4_31:
	xorl	%eax, %eax
	addq	$232, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_offset %r14, -32
	.cfi_offset %r15, -24
	movl	$2125031417, -92(%rbp)  # imm = 0x7EA967F9
	movq	%rdi, -32(%rbp)
	movq	$0, -112(%rbp)
	movq	-32(%rbp), %rax
	movq	568(%rax), %rax
...
.LBB5_30:                               # %while.end
	...
	movq	-32(%rbp), %rdi
	callq	dual_feasible
	cmpl	$2125031417, -92(%rbp)  # imm = 0x7EA967F9
	jne	.LBB5_32
.LBB5_31:
	xorl	%eax, %eax
	addq	$232, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_offset %r14, -32
	.cfi_offset %r15, -24
	movl	$264022397, -92(%rbp)   # imm = 0xFBCA97D
	movq	%rdi, -32(%rbp)
	movq	$0, -112(%rbp)
	movq	-32(%rbp), %rax
	movq	568(%rax), %rax
...
.LBB6_30:                               # %while.end
	...
	movq	-32(%rbp), %rdi
	callq	dual_feasible
	cmpl	$264022397, -92(%rbp)   # imm = 0xFBCA97D
	jne	.LBB6_32
.LBB6_31:
	xorl	%eax, %eax
	addq	$232, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_offset %r14, -32
	.cfi_offset %r15, -24
	movl	$60437642, -92(%rbp)    # imm = 0x39A348A
	movq	%rdi, -32(%rbp)
	movq	$0, -120(%rbp)
	movq	-32(%rbp), %rax
	movq	568(%rax), %rax
...
.LBB7_30:                               # %while.end
	...
	movq	-32(%rbp), %rdi
	callq	dual_feasible
	cmpl	$60437642, -92(%rbp)    # imm = 0x39A348A
	jne	.LBB7_32
.LBB7_31:
	xorl	%eax, %eax
	addq	$232, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_offset %r14, -32
	.cfi_offset %r15, -24
	movl	$599468386, -92(%rbp)   # imm = 0x23BB2962
	movq	%rdi, -32(%rbp)
	movq	$0, -112(%rbp)
	movq	-32(%rbp), %rax
	movq	568(%rax), %rax
...
.LBB8_30:                               # %while.end
	...
	movq	-32(%rbp), %rdi
	callq	dual_feasible
	cmpl	$599468386, -92(%rbp)   # imm = 0x23BB2962
	jne	.LBB8_32
.LBB8_31:
	xorl	%eax, %eax
	addq	$232, %rsp
