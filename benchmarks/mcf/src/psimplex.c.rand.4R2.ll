; ModuleID = 'psimplex.c.rand.4R2.bc'
...
entry:
  %canary = alloca i32
  store i32 1401873966, i32* %canary
...
entry:
  ...
  %iterations = alloca i64*, align 8
  %canary = alloca i32
  store i32 596643904, i32* %canary
  %new_flow = alloca i64, align 8
  %m = alloca i64, align 8
  %new_orientation = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
