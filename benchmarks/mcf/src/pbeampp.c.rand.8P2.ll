; ModuleID = 'pbeampp.c.rand.8P2.bc'
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_bea_is_dual_infeasible.3, label %func_bea_is_dual_infeasible.6
...
func_sort_basket.9:                               ; preds = %ctrl2
...
func_sort_basket.16:                              ; preds = %ctrl4
...
ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_sort_basket.9, label %ctrl3
...
ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_sort_basket.16, label %ctrl5
...
func_primal_bea_mpp.14:                           ; preds = %ctrl5
  %8 = call %struct.arc* @primal_bea_mpp.14(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea)
  ret %struct.arc* %8

func_primal_bea_mpp.15:                           ; preds = %ctrl5
  %9 = call %struct.arc* @primal_bea_mpp.15(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea)
  ret %struct.arc* %9
...
ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_primal_bea_mpp.12, label %ctrl4
...
ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_primal_bea_mpp.14, label %func_primal_bea_mpp.15
}
...
entry:
  ...
  %canary = alloca i32
  store i32 1300115073, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 2066463544, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1820822657, i32* %canary
...
entry:
  ...
  %red_cost_of_bea.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 157603687, i32* %canary
  %next = alloca i64, align 8
  %retval = alloca %struct.arc*, align 8
  %arcs.addr = alloca %struct.arc*, align 8
  %old_group_pos = alloca i64, align 8
...
entry:
  %canary = alloca i32
  store i32 171390709, i32* %canary
  %r = alloca i64, align 8
  %xchange = alloca %struct.basket*, align 8
  %max.addr = alloca i64, align 8
  %l = alloca i64, align 8
...
entry:
  %arc.addr = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1708389624, i32* %canary
  %red_cost.addr = alloca i64, align 8
  store %struct.arc* %arc, %struct.arc** %arc.addr, align 8
  store i64 %red_cost, i64* %red_cost.addr, align 8
  %0 = load i64, i64* %red_cost.addr, align 8
...
entry:
  ...
  %l = alloca i64, align 8
  %canary = alloca i32
  store i32 1854586341, i32* %canary
  %xchange = alloca %struct.basket*, align 8
  %max.addr = alloca i64, align 8
  store i64 %min, i64* %min.addr, align 8
  store i64 %max, i64* %max.addr, align 8
...
entry:
  %old_group_pos = alloca i64, align 8
  %canary = alloca i32
  store i32 1438696252, i32* %canary
  %red_cost = alloca i64, align 8
  %arcs.addr = alloca %struct.arc*, align 8
  %next = alloca i64, align 8
  %stop_arcs.addr = alloca %struct.arc*, align 8
...
entry:
  ...
  %xchange = alloca %struct.basket*, align 8
  %canary = alloca i32
  store i32 1728538171, i32* %canary
  %r = alloca i64, align 8
  %cut = alloca i64, align 8
  %min.addr = alloca i64, align 8
  %max.addr = alloca i64, align 8
...
entry:
  ...
  %max.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 158378803, i32* %canary
  %cut = alloca i64, align 8
  store i64 %min, i64* %min.addr, align 8
  store i64 %max, i64* %max.addr, align 8
  %0 = load i64, i64* %min.addr, align 8
...
entry:
  ...
  %red_cost = alloca i64, align 8
  %canary = alloca i32
  store i32 316217423, i32* %canary
  %m.addr = alloca i64, align 8
  store i64 %m, i64* %m.addr, align 8
  store %struct.arc* %arcs, %struct.arc** %arcs.addr, align 8
  store %struct.arc* %stop_arcs, %struct.arc** %stop_arcs.addr, align 8
...
entry:
  ...
  %retval = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 943479674, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %red_cost = alloca i64, align 8
  %arcs.addr = alloca %struct.arc*, align 8
  %red_cost_of_bea.addr = alloca i64*, align 8
...
entry:
  ...
  %retval = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1475581177, i32* %canary
  %arcs.addr = alloca %struct.arc*, align 8
  store i64 %m, i64* %m.addr, align 8
  store %struct.arc* %arcs, %struct.arc** %arcs.addr, align 8
  store %struct.arc* %stop_arcs, %struct.arc** %stop_arcs.addr, align 8
...
entry:
  ...
  %m.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 180603755, i32* %canary
  %red_cost_of_bea.addr = alloca i64*, align 8
  store i64 %m, i64* %m.addr, align 8
  store %struct.arc* %arcs, %struct.arc** %arcs.addr, align 8
  store %struct.arc* %stop_arcs, %struct.arc** %stop_arcs.addr, align 8
...
entry:
  ...
  %red_cost_of_bea.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 1046980786, i32* %canary
  %retval = alloca %struct.arc*, align 8
  %m.addr = alloca i64, align 8
  store i64 %m, i64* %m.addr, align 8
  store %struct.arc* %arcs, %struct.arc** %arcs.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1566432369, i32* %canary
  %cut = alloca i64, align 8
  %l = alloca i64, align 8
  %max.addr = alloca i64, align 8
  %r = alloca i64, align 8
...
entry:
  %cut = alloca i64, align 8
  %canary = alloca i32
  store i32 520838045, i32* %canary
  %xchange = alloca %struct.basket*, align 8
  %r = alloca i64, align 8
  %max.addr = alloca i64, align 8
  %min.addr = alloca i64, align 8
...
entry:
  %canary = alloca i32
  store i32 1202502941, i32* %canary
  %l = alloca i64, align 8
  %max.addr = alloca i64, align 8
  %xchange = alloca %struct.basket*, align 8
  %r = alloca i64, align 8
