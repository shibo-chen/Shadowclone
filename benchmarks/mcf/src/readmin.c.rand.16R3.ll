; ModuleID = 'readmin.c.rand.16R3.bc'
...
entry:
  ...
  %canary = alloca i32
  store i32 263937499, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1135188365, i32* %canary
  %c = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
  %instring = alloca [201 x i8], align 16
  %retval = alloca i64, align 8
...
return:                                           ; preds = %for.end228, %if.then147, %if.then134, %if.then57, %if.then34, %if.then6, %if.then
  %247 = load i64, i64* %retval, align 8
  %248 = load i32, i32* %canary
  %249 = icmp eq i32 %248, 1135188365
  br i1 %249, label %250, label %func_exit
...
entry:
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 482896185, i32* %canary
  %i = alloca i64, align 8
  %c = alloca i64, align 8
  %t = alloca i64, align 8
  %h = alloca i64, align 8
...
entry:
  ...
  %h = alloca i64, align 8
  %canary = alloca i32
  store i32 682526448, i32* %canary
  %retval = alloca i64, align 8
  %c = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store %struct._IO_FILE* null, %struct._IO_FILE** %in, align 8
...
entry:
  ...
  %t = alloca i64, align 8
  %canary = alloca i32
  store i32 766562414, i32* %canary
  %node = alloca %struct.node*, align 8
  %retval = alloca i64, align 8
  %instring = alloca [201 x i8], align 16
  %h = alloca i64, align 8
...
entry:
  ...
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 2021343186, i32* %canary
  %t = alloca i64, align 8
  %h = alloca i64, align 8
  %retval = alloca i64, align 8
  %in = alloca %struct._IO_FILE*, align 8
...
return:                                           ; preds = %for.end228, %if.then147, %if.then134, %if.then57, %if.then34, %if.then6, %if.then
  %247 = load i64, i64* %retval, align 8
  %248 = load i32, i32* %canary
  %249 = icmp eq i32 %248, 2021343186
  br i1 %249, label %250, label %func_exit
...
entry:
  ...
  %c = alloca i64, align 8
  %canary = alloca i32
  store i32 1670108402, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %h = alloca i64, align 8
  %t = alloca i64, align 8
  %instring = alloca [201 x i8], align 16
...
return:                                           ; preds = %for.end228, %if.then147, %if.then134, %if.then57, %if.then34, %if.then6, %if.then
  %247 = load i64, i64* %retval, align 8
  %248 = load i32, i32* %canary
  %249 = icmp eq i32 %248, 1670108402
  br i1 %249, label %250, label %func_exit
...
entry:
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1644959136, i32* %canary
  %t = alloca i64, align 8
  %retval = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store %struct._IO_FILE* null, %struct._IO_FILE** %in, align 8
...
return:                                           ; preds = %for.end228, %if.then147, %if.then134, %if.then57, %if.then34, %if.then6, %if.then
  %247 = load i64, i64* %retval, align 8
  %248 = load i32, i32* %canary
  %249 = icmp eq i32 %248, 1644959136
  br i1 %249, label %250, label %func_exit
...
entry:
  ...
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 734239172, i32* %canary
  %h = alloca i64, align 8
  %t = alloca i64, align 8
  %retval = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
...
entry:
  %canary = alloca i32
  store i32 811557905, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %instring = alloca [201 x i8], align 16
  %node = alloca %struct.node*, align 8
  %i = alloca i64, align 8
...
entry:
  ...
  %c = alloca i64, align 8
  %canary = alloca i32
  store i32 1421291999, i32* %canary
  %in = alloca %struct._IO_FILE*, align 8
  %instring = alloca [201 x i8], align 16
  %h = alloca i64, align 8
  %i = alloca i64, align 8
...
return:                                           ; preds = %for.end228, %if.then147, %if.then134, %if.then57, %if.then34, %if.then6, %if.then
  %247 = load i64, i64* %retval, align 8
  %248 = load i32, i32* %canary
  %249 = icmp eq i32 %248, 1421291999
  br i1 %249, label %250, label %func_exit
...
entry:
  ...
  %in = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 1665321259, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %c = alloca i64, align 8
  %t = alloca i64, align 8
  %node = alloca %struct.node*, align 8
...
return:                                           ; preds = %for.end228, %if.then147, %if.then134, %if.then57, %if.then34, %if.then6, %if.then
  %247 = load i64, i64* %retval, align 8
  %248 = load i32, i32* %canary
  %249 = icmp eq i32 %248, 1665321259
  br i1 %249, label %250, label %func_exit
...
entry:
  %h = alloca i64, align 8
  %canary = alloca i32
  store i32 611223998, i32* %canary
  %t = alloca i64, align 8
  %i = alloca i64, align 8
  %node = alloca %struct.node*, align 8
  %c = alloca i64, align 8
...
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 1036183767, i32* %canary
  %c = alloca i64, align 8
  %retval = alloca i64, align 8
  %i = alloca i64, align 8
  %h = alloca i64, align 8
...
return:                                           ; preds = %for.end228, %if.then147, %if.then134, %if.then57, %if.then34, %if.then6, %if.then
  %247 = load i64, i64* %retval, align 8
  %248 = load i32, i32* %canary
  %249 = icmp eq i32 %248, 1036183767
  br i1 %249, label %250, label %func_exit
...
entry:
  %t = alloca i64, align 8
  %canary = alloca i32
  store i32 1605685364, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %in = alloca %struct._IO_FILE*, align 8
  %instring = alloca [201 x i8], align 16
  %h = alloca i64, align 8
...
return:                                           ; preds = %for.end228, %if.then147, %if.then134, %if.then57, %if.then34, %if.then6, %if.then
  %247 = load i64, i64* %retval, align 8
  %248 = load i32, i32* %canary
  %249 = icmp eq i32 %248, 1605685364
  br i1 %249, label %250, label %func_exit
...
entry:
  ...
  %t = alloca i64, align 8
  %canary = alloca i32
  store i32 1195366818, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %h = alloca i64, align 8
  %retval = alloca i64, align 8
  %node = alloca %struct.node*, align 8
...
return:                                           ; preds = %for.end228, %if.then147, %if.then134, %if.then57, %if.then34, %if.then6, %if.then
  %247 = load i64, i64* %retval, align 8
  %248 = load i32, i32* %canary
  %249 = icmp eq i32 %248, 1195366818
  br i1 %249, label %250, label %func_exit
