...
# %bb.0:                                # %entry
	...
	.cfi_offset %r14, -32
	.cfi_offset %r15, -24
	movl	$1673962746, -92(%rbp)  # imm = 0x63C6A4FA
	movq	%rdi, -32(%rbp)
	movq	$0, -120(%rbp)
	movq	-32(%rbp), %rax
	movq	568(%rax), %rax
...
.LBB1_30:                               # %while.end
	...
	movq	-32(%rbp), %rdi
	callq	dual_feasible
	cmpl	$1673962746, -92(%rbp)  # imm = 0x63C6A4FA
	jne	.LBB1_32
.LBB1_31:
	xorl	%eax, %eax
	addq	$232, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_offset %r14, -32
	.cfi_offset %r15, -24
	movl	$941447902, -92(%rbp)   # imm = 0x381D5ADE
	movq	%rdi, -32(%rbp)
	movq	$0, -128(%rbp)
	movq	-32(%rbp), %rax
	movq	568(%rax), %rax
...
.LBB2_30:                               # %while.end
	...
	movq	-32(%rbp), %rdi
	callq	dual_feasible
	cmpl	$941447902, -92(%rbp)   # imm = 0x381D5ADE
	jne	.LBB2_32
.LBB2_31:
	xorl	%eax, %eax
	addq	$232, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_offset %r14, -32
	.cfi_offset %r15, -24
	movl	$349629915, -92(%rbp)   # imm = 0x14D6EDDB
	movq	%rdi, -32(%rbp)
	movq	$0, -152(%rbp)
	movq	-32(%rbp), %rax
	movq	568(%rax), %rax
...
.LBB3_30:                               # %while.end
	...
	movq	-32(%rbp), %rdi
	callq	dual_feasible
	cmpl	$349629915, -92(%rbp)   # imm = 0x14D6EDDB
	jne	.LBB3_32
.LBB3_31:
	xorl	%eax, %eax
	addq	$232, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_offset %r14, -32
	.cfi_offset %r15, -24
	movl	$890113403, -92(%rbp)   # imm = 0x350E0D7B
	movq	%rdi, -32(%rbp)
	movq	$0, -152(%rbp)
	movq	-32(%rbp), %rax
	movq	568(%rax), %rax
...
.LBB4_30:                               # %while.end
	...
	movq	-32(%rbp), %rdi
	callq	dual_feasible
	cmpl	$890113403, -92(%rbp)   # imm = 0x350E0D7B
	jne	.LBB4_32
.LBB4_31:
	xorl	%eax, %eax
	addq	$232, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_offset %r14, -32
	.cfi_offset %r15, -24
	movl	$1788707020, -92(%rbp)  # imm = 0x6A9D80CC
	movq	%rdi, -32(%rbp)
	movq	$0, -136(%rbp)
	movq	-32(%rbp), %rax
	movq	568(%rax), %rax
...
.LBB5_30:                               # %while.end
	...
	movq	-32(%rbp), %rdi
	callq	dual_feasible
	cmpl	$1788707020, -92(%rbp)  # imm = 0x6A9D80CC
	jne	.LBB5_32
.LBB5_31:
	xorl	%eax, %eax
	addq	$232, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_offset %r14, -32
	.cfi_offset %r15, -24
	movl	$990537062, -92(%rbp)   # imm = 0x3B0A6566
	movq	%rdi, -32(%rbp)
	movq	$0, -104(%rbp)
	movq	-32(%rbp), %rax
	movq	568(%rax), %rax
...
.LBB6_30:                               # %while.end
	...
	movq	-32(%rbp), %rdi
	callq	dual_feasible
	cmpl	$990537062, -92(%rbp)   # imm = 0x3B0A6566
	jne	.LBB6_32
.LBB6_31:
	xorl	%eax, %eax
	addq	$232, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_offset %r14, -32
	.cfi_offset %r15, -24
	movl	$2017153328, -92(%rbp)  # imm = 0x783B5130
	movq	%rdi, -32(%rbp)
	movq	$0, -104(%rbp)
	movq	-32(%rbp), %rax
	movq	568(%rax), %rax
...
.LBB7_30:                               # %while.end
	...
	movq	-32(%rbp), %rdi
	callq	dual_feasible
	cmpl	$2017153328, -92(%rbp)  # imm = 0x783B5130
	jne	.LBB7_32
.LBB7_31:
	xorl	%eax, %eax
	addq	$232, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_offset %r14, -32
	.cfi_offset %r15, -24
	movl	$909397743, -92(%rbp)   # imm = 0x36344EEF
	movq	%rdi, -32(%rbp)
	movq	$0, -120(%rbp)
	movq	-32(%rbp), %rax
	movq	568(%rax), %rax
...
.LBB8_30:                               # %while.end
	...
	movq	-32(%rbp), %rdi
	callq	dual_feasible
	cmpl	$909397743, -92(%rbp)   # imm = 0x36344EEF
	jne	.LBB8_32
.LBB8_31:
	xorl	%eax, %eax
	addq	$232, %rsp
