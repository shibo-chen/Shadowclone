; ModuleID = 'pbeampp.c.rand.4P1.bc'
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_bea_is_dual_infeasible.3, label %func_bea_is_dual_infeasible.4
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_sort_basket.5, label %func_sort_basket.6
}
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_primal_bea_mpp.8, label %ctrl1
...
entry:
  ...
  %canary = alloca i32
  store i32 1916549090, i32* %canary
...
entry:
  ...
  %l = alloca i64, align 8
  %canary = alloca i32
  store i32 979095036, i32* %canary
  %r = alloca i64, align 8
  %min.addr = alloca i64, align 8
  store i64 %min, i64* %min.addr, align 8
  store i64 %max, i64* %max.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 992776966, i32* %canary
...
entry:
  %red_cost.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1355935352, i32* %canary
  %arc.addr = alloca %struct.arc*, align 8
  store %struct.arc* %arc, %struct.arc** %arc.addr, align 8
  store i64 %red_cost, i64* %red_cost.addr, align 8
  %0 = load i64, i64* %red_cost.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 249967395, i32* %canary
  %cut = alloca i64, align 8
  %r = alloca i64, align 8
  %xchange = alloca %struct.basket*, align 8
  %max.addr = alloca i64, align 8
...
entry:
  %xchange = alloca %struct.basket*, align 8
  %canary = alloca i32
  store i32 1884181503, i32* %canary
  %min.addr = alloca i64, align 8
  %max.addr = alloca i64, align 8
  %l = alloca i64, align 8
  %r = alloca i64, align 8
...
entry:
  ...
  %canary = alloca i32
  store i32 2143039505, i32* %canary
...
entry:
  ...
  %m.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 533210126, i32* %canary
  %stop_arcs.addr = alloca %struct.arc*, align 8
  %i = alloca i64, align 8
  %next = alloca i64, align 8
  %retval = alloca %struct.arc*, align 8
...
entry:
  ...
  %red_cost = alloca i64, align 8
  %canary = alloca i32
  store i32 1143697823, i32* %canary
  %m.addr = alloca i64, align 8
  %old_group_pos = alloca i64, align 8
  %stop_arcs.addr = alloca %struct.arc*, align 8
  %red_cost_of_bea.addr = alloca i64*, align 8
...
entry:
  %stop_arcs.addr = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1788955072, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %arcs.addr = alloca %struct.arc*, align 8
  %old_group_pos = alloca i64, align 8
  %red_cost = alloca i64, align 8
