; ModuleID = 'output.c.rand.16D16.bc'
...
entry:
  ...
  %canary = alloca i32
  store i32 246415572, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 620622070, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %arc = alloca %struct.arc*, align 8
  %out = alloca %struct._IO_FILE*, align 8
  %first_impl = alloca %struct.arc*, align 8
...
entry:
  ...
  %arc2 = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 628866127, i32* %canary
  %out = alloca %struct._IO_FILE*, align 8
  %first_impl = alloca %struct.arc*, align 8
  %block = alloca %struct.arc*, align 8
  store i8* %outfile, i8** %outfile.addr, align 8
...
entry:
  ...
  %arc2 = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 775819797, i32* %canary
  %block = alloca %struct.arc*, align 8
  %out = alloca %struct._IO_FILE*, align 8
  %net.addr = alloca %struct.network*, align 8
  %outfile.addr = alloca i8*, align 8
...
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 1530258289, i32* %canary
  %outfile.addr = alloca i8*, align 8
  %arc2 = alloca %struct.arc*, align 8
  %out = alloca %struct._IO_FILE*, align 8
  %block = alloca %struct.arc*, align 8
...
entry:
  ...
  %retval = alloca i64, align 8
  %canary = alloca i32
  store i32 102296535, i32* %canary
  %first_impl = alloca %struct.arc*, align 8
  store i8* %outfile, i8** %outfile.addr, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store %struct._IO_FILE* null, %struct._IO_FILE** %out, align 8
...
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 902418657, i32* %canary
  %first_impl = alloca %struct.arc*, align 8
  %outfile.addr = alloca i8*, align 8
  %retval = alloca i64, align 8
  %block = alloca %struct.arc*, align 8
...
entry:
  ...
  %retval = alloca i64, align 8
  %canary = alloca i32
  store i32 1748931233, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  store i8* %outfile, i8** %outfile.addr, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store %struct._IO_FILE* null, %struct._IO_FILE** %out, align 8
...
entry:
  ...
  %out = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 999364104, i32* %canary
  %block = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
  %arc2 = alloca %struct.arc*, align 8
  %first_impl = alloca %struct.arc*, align 8
...
entry:
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1566583929, i32* %canary
  %outfile.addr = alloca i8*, align 8
  %arc2 = alloca %struct.arc*, align 8
  %block = alloca %struct.arc*, align 8
  store i8* %outfile, i8** %outfile.addr, align 8
...
entry:
  %out = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 749921400, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %block = alloca %struct.arc*, align 8
  %retval = alloca i64, align 8
  %arc2 = alloca %struct.arc*, align 8
...
entry:
  ...
  %retval = alloca i64, align 8
  %canary = alloca i32
  store i32 1252499396, i32* %canary
  %out = alloca %struct._IO_FILE*, align 8
  %outfile.addr = alloca i8*, align 8
  %arc2 = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
...
entry:
  ...
  %retval = alloca i64, align 8
  %canary = alloca i32
  store i32 1728691016, i32* %canary
  %outfile.addr = alloca i8*, align 8
  store i8* %outfile, i8** %outfile.addr, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store %struct._IO_FILE* null, %struct._IO_FILE** %out, align 8
...
entry:
  ...
  %out = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 567620654, i32* %canary
  %arc2 = alloca %struct.arc*, align 8
  %block = alloca %struct.arc*, align 8
  %arc = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
...
entry:
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1806192335, i32* %canary
  %block = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
  %out = alloca %struct._IO_FILE*, align 8
  %arc2 = alloca %struct.arc*, align 8
...
entry:
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 2024301607, i32* %canary
  %outfile.addr = alloca i8*, align 8
  %out = alloca %struct._IO_FILE*, align 8
  %block = alloca %struct.arc*, align 8
  %first_impl = alloca %struct.arc*, align 8
