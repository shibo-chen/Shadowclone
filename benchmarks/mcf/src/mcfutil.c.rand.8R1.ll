; ModuleID = 'mcfutil.c.rand.8R1.bc'
...
func_refresh_neighbour_lists.25:                  ; preds = %ctrl3
  call void @refresh_neighbour_lists.25(%struct.network* %net)
  ret void

func_refresh_neighbour_lists.28:                  ; preds = %ctrl4
  call void @refresh_neighbour_lists.28(%struct.network* %net)
  ret void

func_refresh_neighbour_lists.37:                  ; preds = %ctrl5
  call void @refresh_neighbour_lists.37(%struct.network* %net)
  ret void

func_refresh_neighbour_lists.38:                  ; preds = %ctrl5
...
ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_refresh_neighbour_lists.25, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_refresh_neighbour_lists.28, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_refresh_neighbour_lists.37, label %func_refresh_neighbour_lists.38
}
...
func_refresh_potential.11:                        ; preds = %ctrl2
  %5 = call i64 @refresh_potential.11(%struct.network* %net)
  ret i64 %5

func_refresh_potential.15:                        ; preds = %ctrl3
  %6 = call i64 @refresh_potential.15(%struct.network* %net)
  ret i64 %6

func_refresh_potential.22:                        ; preds = %ctrl4
  %7 = call i64 @refresh_potential.22(%struct.network* %net)
  ret i64 %7

func_refresh_potential.40:                        ; preds = %ctrl5
  %8 = call i64 @refresh_potential.40(%struct.network* %net)
  ret i64 %8

func_refresh_potential.43:                        ; preds = %ctrl5
  %9 = call i64 @refresh_potential.43(%struct.network* %net)
  ret i64 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_refresh_potential.5, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_refresh_potential.8, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_refresh_potential.11, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_refresh_potential.15, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_refresh_potential.22, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_refresh_potential.40, label %func_refresh_potential.43
}
...
func_flow_cost.19:                                ; preds = %ctrl0
  %3 = call double @flow_cost.19(%struct.network* %net)
  ret double %3

func_flow_cost.20:                                ; preds = %ctrl1
  %4 = call double @flow_cost.20(%struct.network* %net)
  ret double %4

func_flow_cost.24:                                ; preds = %ctrl2
  %5 = call double @flow_cost.24(%struct.network* %net)
  ret double %5
...
func_flow_cost.34:                                ; preds = %ctrl4
  %7 = call double @flow_cost.34(%struct.network* %net)
  ret double %7
...
func_flow_cost.42:                                ; preds = %ctrl5
  %9 = call double @flow_cost.42(%struct.network* %net)
  ret double %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_flow_cost.19, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_flow_cost.20, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_flow_cost.24, label %ctrl3
...
ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_flow_cost.34, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_flow_cost.41, label %func_flow_cost.42
}
...
func_flow_org_cost.14:                            ; preds = %ctrl0
  %3 = call double @flow_org_cost.14(%struct.network* %net)
  ret double %3

func_flow_org_cost.27:                            ; preds = %ctrl1
  %4 = call double @flow_org_cost.27(%struct.network* %net)
  ret double %4

func_flow_org_cost.30:                            ; preds = %ctrl2
  %5 = call double @flow_org_cost.30(%struct.network* %net)
  ret double %5

func_flow_org_cost.33:                            ; preds = %ctrl3
  %6 = call double @flow_org_cost.33(%struct.network* %net)
  ret double %6

func_flow_org_cost.35:                            ; preds = %ctrl4
  %7 = call double @flow_org_cost.35(%struct.network* %net)
  ret double %7
...
func_flow_org_cost.44:                            ; preds = %ctrl5
  %9 = call double @flow_org_cost.44(%struct.network* %net)
  ret double %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_flow_org_cost.14, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_flow_org_cost.27, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_flow_org_cost.30, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_flow_org_cost.33, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_flow_org_cost.35, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_flow_org_cost.39, label %func_flow_org_cost.44
}
...
func_primal_feasible.16:                          ; preds = %ctrl1
  %4 = call i64 @primal_feasible.16(%struct.network* %net)
  ret i64 %4
...
func_primal_feasible.18:                          ; preds = %ctrl3
  %6 = call i64 @primal_feasible.18(%struct.network* %net)
  ret i64 %6
...
func_primal_feasible.36:                          ; preds = %ctrl5
  %9 = call i64 @primal_feasible.36(%struct.network* %net)
  ret i64 %9
...
ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_primal_feasible.16, label %ctrl2
...
ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_primal_feasible.18, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_primal_feasible.31, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_primal_feasible.32, label %func_primal_feasible.36
}
...
func_dual_feasible.13:                            ; preds = %ctrl1
  %4 = call i64 @dual_feasible.13(%struct.network* %net)
  ret i64 %4
...
func_dual_feasible.45:                            ; preds = %ctrl3
  %6 = call i64 @dual_feasible.45(%struct.network* %net)
  ret i64 %6

func_dual_feasible.46:                            ; preds = %ctrl4
  %7 = call i64 @dual_feasible.46(%struct.network* %net)
  ret i64 %7

func_dual_feasible.47:                            ; preds = %ctrl5
  %8 = call i64 @dual_feasible.47(%struct.network* %net)
  ret i64 %8

func_dual_feasible.48:                            ; preds = %ctrl5
  %9 = call i64 @dual_feasible.48(%struct.network* %net)
  ret i64 %9
...
ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_dual_feasible.13, label %ctrl2
...
ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_dual_feasible.45, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_dual_feasible.46, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_dual_feasible.47, label %func_dual_feasible.48
}
...
entry:
  ...
  %canary = alloca i32
  store i32 190231648, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1813858515, i32* %canary
  %net.addr = alloca %struct.network*, align 8
...
entry:
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 709820741, i32* %canary
  %retval = alloca i64, align 8
...
entry:
  ...
  %canary = alloca i32
  store i32 486101164, i32* %canary
...
entry:
  ...
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 2002402813, i32* %canary
  %checksum = alloca i64, align 8
  %root = alloca %struct.node*, align 8
  %tmp = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  ...
  %retval = alloca i64, align 8
  %canary = alloca i32
  store i32 985370768, i32* %canary
  %red_cost = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1499332882, i32* %canary
  %node = alloca %struct.node*, align 8
  %tmp = alloca %struct.node*, align 8
  %checksum = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
...
entry:
  %canary = alloca i32
  store i32 588657895, i32* %canary
  %node = alloca %struct.node*, align 8
  %dummy = alloca %struct.arc*, align 8
  %stop = alloca i8*, align 8
  %arc = alloca %struct.arc*, align 8
...
entry:
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 2098514915, i32* %canary
  %stop = alloca i8*, align 8
  %net.addr = alloca %struct.network*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
...
entry:
  %checksum = alloca i64, align 8
  %canary = alloca i32
  store i32 457418398, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %node = alloca %struct.node*, align 8
  %root = alloca %struct.node*, align 8
  %tmp = alloca %struct.node*, align 8
...
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 1100655184, i32* %canary
  %stop = alloca i8*, align 8
  %node = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
...
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 685735599, i32* %canary
  %retval = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
  %red_cost = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 863910218, i32* %canary
  %stop = alloca i8*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 0, i64* %fleet, align 8
  store i64 0, i64* %operational_cost, align 8
...
entry:
  %canary = alloca i32
  store i32 566849421, i32* %canary
  %checksum = alloca i64, align 8
  %tmp = alloca %struct.node*, align 8
  %root = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
...
entry:
  ...
  %stop = alloca i8*, align 8
  %canary = alloca i32
  store i32 689038319, i32* %canary
  %stop_dummy = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1789395733, i32* %canary
  %stop = alloca i8*, align 8
  %arc = alloca %struct.arc*, align 8
  %node = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
...
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 1454890357, i32* %canary
  %node = alloca %struct.node*, align 8
  %operational_cost = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 0, i64* %fleet, align 8
...
entry:
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1971189718, i32* %canary
  %operational_cost = alloca i64, align 8
  %fleet = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 0, i64* %fleet, align 8
...
entry:
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1696578031, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
  %nodes = getelementptr inbounds %struct.network, %struct.network* %0, i32 0, i32 21
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @refresh_potential.22(%struct.network* %net) #0 {
entry:
  %root = alloca %struct.node*, align 8
  %tmp = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 1533865518, i32* %canary
  %checksum = alloca i64, align 8
  %node = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
...
entry:
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1385774576, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %arc = alloca %struct.arc*, align 8
  %stop = alloca i8*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  %operational_cost = alloca i64, align 8
  %canary = alloca i32
  store i32 643190024, i32* %canary
  %fleet = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
  %stop = alloca i8*, align 8
  %node = alloca %struct.node*, align 8
...
entry:
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 367773178, i32* %canary
  %node = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
  %stop = alloca i8*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  ...
  %stop = alloca i8*, align 8
  %canary = alloca i32
  store i32 611043894, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 0, i64* %fleet, align 8
  store i64 0, i64* %operational_cost, align 8
...
entry:
  ...
  %fleet = alloca i64, align 8
  %canary = alloca i32
  store i32 2119836890, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 0, i64* %fleet, align 8
  store i64 0, i64* %operational_cost, align 8
...
entry:
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 284706542, i32* %canary
  %node = alloca %struct.node*, align 8
  %stop = alloca i8*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local double @flow_org_cost.30(%struct.network* %net) #0 {
entry:
  %operational_cost = alloca i64, align 8
  %stop = alloca i8*, align 8
  %arc = alloca %struct.arc*, align 8
  ...
  %fleet = alloca i64, align 8
  %canary = alloca i32
  store i32 1232386188, i32* %canary
  %node = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 0, i64* %fleet, align 8
  store i64 0, i64* %operational_cost, align 8
...
entry:
  ...
  %stop_dummy = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 246586723, i32* %canary
  %stop = alloca i8*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
  %dummy_arcs = getelementptr inbounds %struct.network, %struct.network* %0, i32 0, i32 25
...
entry:
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1639798879, i32* %canary
  %stop = alloca i8*, align 8
  %node = alloca %struct.node*, align 8
  %dummy = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local double @flow_org_cost.33(%struct.network* %net) #0 {
entry:
  %node = alloca %struct.node*, align 8
  %stop = alloca i8*, align 8
  %fleet = alloca i64, align 8
  %operational_cost = alloca i64, align 8
  %canary = alloca i32
  store i32 447297764, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %arc = alloca %struct.arc*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 0, i64* %fleet, align 8
...
entry:
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1027649449, i32* %canary
  %fleet = alloca i64, align 8
  %stop = alloca i8*, align 8
  %operational_cost = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local double @flow_org_cost.35(%struct.network* %net) #0 {
entry:
  %stop = alloca i8*, align 8
  %net.addr = alloca %struct.network*, align 8
  %fleet = alloca i64, align 8
  %canary = alloca i32
  store i32 255960790, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %operational_cost = alloca i64, align 8
  %node = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 979567125, i32* %canary
  %dummy = alloca %struct.arc*, align 8
  %flow = alloca i64, align 8
  %retval = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
...
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 801992378, i32* %canary
  %node = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
  %nodes = getelementptr inbounds %struct.network, %struct.network* %0, i32 0, i32 21
...
entry:
  ...
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1642487602, i32* %canary
  %arc = alloca %struct.arc*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
  %nodes = getelementptr inbounds %struct.network, %struct.network* %0, i32 0, i32 21
...
entry:
  %fleet = alloca i64, align 8
  %canary = alloca i32
  store i32 213449743, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %stop = alloca i8*, align 8
  %arc = alloca %struct.arc*, align 8
  %node = alloca %struct.node*, align 8
...
entry:
  %canary = alloca i32
  store i32 1910152499, i32* %canary
  %tmp = alloca %struct.node*, align 8
  %root = alloca %struct.node*, align 8
  %checksum = alloca i64, align 8
  %node = alloca %struct.node*, align 8
...
entry:
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 2000482987, i32* %canary
  %fleet = alloca i64, align 8
  %stop = alloca i8*, align 8
  %net.addr = alloca %struct.network*, align 8
  %operational_cost = alloca i64, align 8
...
entry:
  %canary = alloca i32
  store i32 1870359948, i32* %canary
  %stop = alloca i8*, align 8
  %operational_cost = alloca i64, align 8
  %node = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
...
entry:
  ...
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1954759719, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %tmp = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
...
entry:
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 2066984135, i32* %canary
  %operational_cost = alloca i64, align 8
  %stop = alloca i8*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 0, i64* %fleet, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @dual_feasible.45(%struct.network* %net) #0 {
entry:
  %retval = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
  %stop = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 2000707563, i32* %canary
  %red_cost = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @dual_feasible.46(%struct.network* %net) #0 {
entry:
  %retval = alloca i64, align 8
  %canary = alloca i32
  store i32 1914743080, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
  %stop = alloca %struct.arc*, align 8
  %red_cost = alloca i64, align 8
...
entry:
  ...
  %red_cost = alloca i64, align 8
  %canary = alloca i32
  store i32 1859937559, i32* %canary
  %retval = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
  %stop_arcs = getelementptr inbounds %struct.network, %struct.network* %0, i32 0, i32 24
...
entry:
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 902492253, i32* %canary
  %retval = alloca i64, align 8
  %stop = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
