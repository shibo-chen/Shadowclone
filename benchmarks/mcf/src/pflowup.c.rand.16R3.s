...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$741790087, -20(%rbp)   # imm = 0x2C36D187
	movq	%rdi, -8(%rbp)
	movq	%rsi, -16(%rbp)
	movq	%rdx, -32(%rbp)
.LBB1_1:                                # %for.cond
...
.LBB1_13:                               # %for.inc12
	...
	jmp	.LBB1_8
.LBB1_14:                               # %for.end14
	cmpl	$741790087, -20(%rbp)   # imm = 0x2C36D187
	jne	.LBB1_16
.LBB1_15:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1208642089, -20(%rbp)  # imm = 0x480A6A29
	movq	%rdi, -16(%rbp)
	movq	%rsi, -8(%rbp)
	movq	%rdx, -32(%rbp)
.LBB2_1:                                # %for.cond
...
.LBB2_13:                               # %for.inc12
	...
	jmp	.LBB2_8
.LBB2_14:                               # %for.end14
	cmpl	$1208642089, -20(%rbp)  # imm = 0x480A6A29
	jne	.LBB2_16
.LBB2_15:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1157052721, -20(%rbp)  # imm = 0x44F73931
	movq	%rdi, -8(%rbp)
	movq	%rsi, -16(%rbp)
	movq	%rdx, -32(%rbp)
.LBB3_1:                                # %for.cond
...
.LBB3_13:                               # %for.inc12
	...
	jmp	.LBB3_8
.LBB3_14:                               # %for.end14
	cmpl	$1157052721, -20(%rbp)  # imm = 0x44F73931
	jne	.LBB3_16
.LBB3_15:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1311926707, -20(%rbp)  # imm = 0x4E3269B3
	movq	%rdi, -8(%rbp)
	movq	%rsi, -16(%rbp)
	movq	%rdx, -32(%rbp)
.LBB4_1:                                # %for.cond
...
.LBB4_13:                               # %for.inc12
	...
	jmp	.LBB4_8
.LBB4_14:                               # %for.end14
	cmpl	$1311926707, -20(%rbp)  # imm = 0x4E3269B3
	jne	.LBB4_16
.LBB4_15:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$186033613, -20(%rbp)   # imm = 0xB16A5CD
	movq	%rdi, -16(%rbp)
	movq	%rsi, -8(%rbp)
	movq	%rdx, -32(%rbp)
.LBB5_1:                                # %for.cond
...
.LBB5_13:                               # %for.inc12
	...
	jmp	.LBB5_8
.LBB5_14:                               # %for.end14
	cmpl	$186033613, -20(%rbp)   # imm = 0xB16A5CD
	jne	.LBB5_16
.LBB5_15:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1890601658, -20(%rbp)  # imm = 0x70B04ABA
	movq	%rdi, -16(%rbp)
	movq	%rsi, -8(%rbp)
	movq	%rdx, -32(%rbp)
.LBB6_1:                                # %for.cond
...
.LBB6_13:                               # %for.inc12
	...
	jmp	.LBB6_8
.LBB6_14:                               # %for.end14
	cmpl	$1890601658, -20(%rbp)  # imm = 0x70B04ABA
	jne	.LBB6_16
.LBB6_15:
	addq	$32, %rsp
	popq	%rbp
