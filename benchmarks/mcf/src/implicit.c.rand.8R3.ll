; ModuleID = 'implicit.c.rand.8R3.bc'
...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_resize_prob.5, label %ctrl0

func_resize_prob.5:                               ; preds = %rand_bb
  %2 = call i64 @resize_prob.5(%struct.network* %net)
  ret i64 %2

func_resize_prob.14:                              ; preds = %ctrl0
  %3 = call i64 @resize_prob.14(%struct.network* %net)
  ret i64 %3

func_resize_prob.31:                              ; preds = %ctrl1
  %4 = call i64 @resize_prob.31(%struct.network* %net)
  ret i64 %4

func_resize_prob.32:                              ; preds = %ctrl2
  %5 = call i64 @resize_prob.32(%struct.network* %net)
  ret i64 %5

func_resize_prob.33:                              ; preds = %ctrl3
  %6 = call i64 @resize_prob.33(%struct.network* %net)
  ret i64 %6
...
func_resize_prob.37:                              ; preds = %ctrl5
  %8 = call i64 @resize_prob.37(%struct.network* %net)
  ret i64 %8
...
ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_resize_prob.14, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_resize_prob.31, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_resize_prob.32, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_resize_prob.33, label %ctrl4
...
ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_resize_prob.37, label %func_resize_prob.39
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_insert_new_arc.6, label %ctrl0

func_insert_new_arc.6:                            ; preds = %rand_bb
  call void @insert_new_arc.6(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void

func_insert_new_arc.8:                            ; preds = %ctrl0
  call void @insert_new_arc.8(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void
...
func_insert_new_arc.16:                           ; preds = %ctrl2
  call void @insert_new_arc.16(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void

func_insert_new_arc.17:                           ; preds = %ctrl3
  call void @insert_new_arc.17(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void

func_insert_new_arc.23:                           ; preds = %ctrl4
  call void @insert_new_arc.23(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void

func_insert_new_arc.27:                           ; preds = %ctrl5
  call void @insert_new_arc.27(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void

func_insert_new_arc.28:                           ; preds = %ctrl5
  call void @insert_new_arc.28(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_insert_new_arc.8, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_insert_new_arc.13, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_insert_new_arc.16, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_insert_new_arc.17, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_insert_new_arc.23, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_insert_new_arc.27, label %func_insert_new_arc.28
}
...
func_replace_weaker_arc.19:                       ; preds = %ctrl2
...
func_replace_weaker_arc.34:                       ; preds = %ctrl3
  call void @replace_weaker_arc.34(%struct.network* %net, %struct.arc* %new, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void

func_replace_weaker_arc.36:                       ; preds = %ctrl4
...
func_replace_weaker_arc.40:                       ; preds = %ctrl5
  call void @replace_weaker_arc.40(%struct.network* %net, %struct.arc* %new, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_replace_weaker_arc.9, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_replace_weaker_arc.10, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_replace_weaker_arc.19, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_replace_weaker_arc.34, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_replace_weaker_arc.36, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_replace_weaker_arc.38, label %func_replace_weaker_arc.40
}
...
func_price_out_impl.3:                            ; preds = %ctrl0
  %3 = call i64 @price_out_impl.3(%struct.network* %net)
  ret i64 %3

func_price_out_impl.4:                            ; preds = %ctrl1
  %4 = call i64 @price_out_impl.4(%struct.network* %net)
  ret i64 %4
...
func_price_out_impl.15:                           ; preds = %ctrl3
  %6 = call i64 @price_out_impl.15(%struct.network* %net)
  ret i64 %6

func_price_out_impl.18:                           ; preds = %ctrl4
  %7 = call i64 @price_out_impl.18(%struct.network* %net)
  ret i64 %7

func_price_out_impl.20:                           ; preds = %ctrl5
  %8 = call i64 @price_out_impl.20(%struct.network* %net)
  ret i64 %8

func_price_out_impl.22:                           ; preds = %ctrl5
  %9 = call i64 @price_out_impl.22(%struct.network* %net)
  ret i64 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_price_out_impl.3, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_price_out_impl.4, label %ctrl2
...
ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_price_out_impl.15, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_price_out_impl.18, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_price_out_impl.20, label %func_price_out_impl.22
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_suspend_impl.7, label %ctrl0

func_suspend_impl.7:                              ; preds = %rand_bb
  %2 = call i64 @suspend_impl.7(%struct.network* %net, i64 %threshold, i64 %all)
  ret i64 %2

func_suspend_impl.11:                             ; preds = %ctrl0
  %3 = call i64 @suspend_impl.11(%struct.network* %net, i64 %threshold, i64 %all)
  ret i64 %3
...
func_suspend_impl.24:                             ; preds = %ctrl2
  %5 = call i64 @suspend_impl.24(%struct.network* %net, i64 %threshold, i64 %all)
  ret i64 %5

func_suspend_impl.25:                             ; preds = %ctrl3
  %6 = call i64 @suspend_impl.25(%struct.network* %net, i64 %threshold, i64 %all)
  ret i64 %6

func_suspend_impl.26:                             ; preds = %ctrl4
  %7 = call i64 @suspend_impl.26(%struct.network* %net, i64 %threshold, i64 %all)
  ret i64 %7

func_suspend_impl.29:                             ; preds = %ctrl5
  %8 = call i64 @suspend_impl.29(%struct.network* %net, i64 %threshold, i64 %all)
  ret i64 %8

func_suspend_impl.30:                             ; preds = %ctrl5
  %9 = call i64 @suspend_impl.30(%struct.network* %net, i64 %threshold, i64 %all)
  ret i64 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_suspend_impl.11, label %ctrl1
...
ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_suspend_impl.24, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_suspend_impl.25, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_suspend_impl.26, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_suspend_impl.29, label %func_suspend_impl.30
}
...
entry:
  ...
  %canary = alloca i32
  store i32 194450990, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1741545802, i32* %canary
...
return:                                           ; preds = %if.end109, %if.then10
  ...
  %145 = icmp eq i32 %144, 1741545802
...
entry:
  ...
  %red_cost = alloca i64, align 8
  %canary = alloca i32
  store i32 995933766, i32* %canary
  %first_of_sparse_list = alloca %struct.arc*, align 8
  %resized = alloca i64, align 8
  %new_arcs = alloca i64, align 8
  %arc_cost = alloca i64, align 8
...
entry:
  ...
  %stop = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 939388302, i32* %canary
  %red_cost = alloca i64, align 8
  %arcin = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
  %latest = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @resize_prob.5(%struct.network* %net) #0 {
entry:
  %retval = alloca i64, align 8
  %canary = alloca i32
  store i32 1624600382, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @insert_new_arc.6(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost) #0 {
entry:
  %tail.addr = alloca %struct.node*, align 8
  %cost.addr = alloca i64, align 8
  %new.addr = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 278121752, i32* %canary
  %pos = alloca i64, align 8
...
entry:
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 348232799, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @insert_new_arc.8(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost) #0 {
entry:
  %newpos.addr = alloca i64, align 8
  %pos = alloca i64, align 8
  %canary = alloca i32
  store i32 702203486, i32* %canary
  %red_cost.addr = alloca i64, align 8
  %new.addr = alloca %struct.arc*, align 8
  %cost.addr = alloca i64, align 8
  %tail.addr = alloca %struct.node*, align 8
...
entry:
  ...
  %tail.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1231924802, i32* %canary
  %cmp = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
  %cost.addr = alloca i64, align 8
  %head.addr = alloca %struct.node*, align 8
...
entry:
  ...
  %red_cost.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 303192021, i32* %canary
  %new.addr = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
  %cmp = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  ...
  %susp = alloca i64, align 8
  %canary = alloca i32
  store i32 799130281, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %threshold.addr = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 %threshold, i64* %threshold.addr, align 8
...
entry:
  ...
  %retval = alloca i64, align 8
  %canary = alloca i32
  store i32 481909859, i32* %canary
  %head = alloca %struct.node*, align 8
  %head_potential = alloca i64, align 8
  %latest = alloca i64, align 8
  %first_of_sparse_list = alloca %struct.arc*, align 8
...
entry:
  %cost.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1698761638, i32* %canary
  %pos = alloca i64, align 8
  %head.addr = alloca %struct.node*, align 8
  %new.addr = alloca %struct.arc*, align 8
  %tail.addr = alloca %struct.node*, align 8
...
entry:
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1509648816, i32* %canary
  %retval = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
  %max_new_m = getelementptr inbounds %struct.network, %struct.network* %0, i32 0, i32 9
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @insert_new_arc.16(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost) #0 {
entry:
  %new.addr = alloca %struct.arc*, align 8
  %red_cost.addr = alloca i64, align 8
  %newpos.addr = alloca i64, align 8
  ...
  %head.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1823921039, i32* %canary
  %pos = alloca i64, align 8
  %tail.addr = alloca %struct.node*, align 8
  store %struct.arc* %new, %struct.arc** %new.addr, align 8
  store i64 %newpos, i64* %newpos.addr, align 8
...
entry:
  ...
  %retval = alloca i64, align 8
  %canary = alloca i32
  store i32 1436427053, i32* %canary
  %head_potential = alloca i64, align 8
  %arcin = alloca %struct.arc*, align 8
  %i = alloca i64, align 8
  %bigM_minus_min_impl_duration = alloca i64, align 8
...
return:                                           ; preds = %if.end109, %if.then10
  %143 = load i64, i64* %retval, align 8
  %144 = load i32, i32* %canary
  %145 = icmp eq i32 %144, 1436427053
  br i1 %145, label %146, label %func_exit
...
entry:
  ...
  %cost.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 397753213, i32* %canary
  %head.addr = alloca %struct.node*, align 8
  %cmp = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store %struct.arc* %new, %struct.arc** %new.addr, align 8
...
entry:
  %arcin = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 554708446, i32* %canary
  %i = alloca i64, align 8
  %bigM = alloca i64, align 8
  %latest = alloca i64, align 8
  %first_of_sparse_list = alloca %struct.arc*, align 8
...
entry:
  %susp = alloca i64, align 8
  %canary = alloca i32
  store i32 444484583, i32* %canary
  %all.addr = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
  %stop = alloca i8*, align 8
  %threshold.addr = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @price_out_impl.22(%struct.network* %net) #0 {
entry:
  %arcout = alloca %struct.arc*, align 8
  %trips = alloca i64, align 8
  %head = alloca %struct.node*, align 8
  ...
  %arc_cost = alloca i64, align 8
  %canary = alloca i32
  store i32 907104061, i32* %canary
  %bigM = alloca i64, align 8
  %red_cost = alloca i64, align 8
  %resized = alloca i64, align 8
  %first_of_sparse_list = alloca %struct.arc*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @insert_new_arc.23(%struct.arc* %new, i64 %newpos, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost) #0 {
entry:
  %pos = alloca i64, align 8
  %tail.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 965445160, i32* %canary
  %red_cost.addr = alloca i64, align 8
  %head.addr = alloca %struct.node*, align 8
  %new.addr = alloca %struct.arc*, align 8
  %cost.addr = alloca i64, align 8
...
entry:
  ...
  %all.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 523590109, i32* %canary
  %stop = alloca i8*, align 8
  %threshold.addr = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
  %susp = alloca i64, align 8
...
entry:
  ...
  %red_cost = alloca i64, align 8
  %canary = alloca i32
  store i32 907105023, i32* %canary
  %arc = alloca %struct.arc*, align 8
  %susp = alloca i64, align 8
  %new_arc = alloca %struct.arc*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  ...
  %red_cost = alloca i64, align 8
  %canary = alloca i32
  store i32 1656461878, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %all.addr = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 %threshold, i64* %threshold.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1080449031, i32* %canary
  %cost.addr = alloca i64, align 8
  %tail.addr = alloca %struct.node*, align 8
  %new.addr = alloca %struct.arc*, align 8
  %pos = alloca i64, align 8
...
entry:
  %head.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1107369009, i32* %canary
  %new.addr = alloca %struct.arc*, align 8
  %red_cost.addr = alloca i64, align 8
  %cost.addr = alloca i64, align 8
  %newpos.addr = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @suspend_impl.29(%struct.network* %net, i64 %threshold, i64 %all) #0 {
entry:
  %arc = alloca %struct.arc*, align 8
  %all.addr = alloca i64, align 8
  %susp = alloca i64, align 8
  %canary = alloca i32
  store i32 1158258343, i32* %canary
  %red_cost = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
  %stop = alloca i8*, align 8
  %threshold.addr = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @suspend_impl.30(%struct.network* %net, i64 %threshold, i64 %all) #0 {
entry:
  %net.addr = alloca %struct.network*, align 8
  %arc = alloca %struct.arc*, align 8
  %red_cost = alloca i64, align 8
  %canary = alloca i32
  store i32 1134617422, i32* %canary
  %all.addr = alloca i64, align 8
  %susp = alloca i64, align 8
  %new_arc = alloca %struct.arc*, align 8
  %threshold.addr = alloca i64, align 8
...
entry:
  ...
  %retval = alloca i64, align 8
  %canary = alloca i32
  store i32 660394970, i32* %canary
  %stop = alloca %struct.node*, align 8
  %off = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  ...
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1449233868, i32* %canary
  %retval = alloca i64, align 8
  %root = alloca %struct.node*, align 8
  %arc = alloca %struct.arc*, align 8
  %stop = alloca %struct.node*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @resize_prob.33(%struct.network* %net) #0 {
entry:
  %canary = alloca i32
  store i32 1729850701, i32* %canary
  %stop = alloca %struct.node*, align 8
  %node = alloca %struct.node*, align 8
  %root = alloca %struct.node*, align 8
  %retval = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @replace_weaker_arc.34(%struct.network* %net, %struct.arc* %new, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost) #0 {
entry:
  %head.addr = alloca %struct.node*, align 8
  %pos = alloca i64, align 8
  %tail.addr = alloca %struct.node*, align 8
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 2060022209, i32* %canary
  %new.addr = alloca %struct.arc*, align 8
  %red_cost.addr = alloca i64, align 8
  %cost.addr = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  ...
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1995437809, i32* %canary
  %stop = alloca %struct.node*, align 8
  %net.addr = alloca %struct.network*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  %0 = load %struct.network*, %struct.network** %net.addr, align 8
...
entry:
  ...
  %new.addr = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 2142901563, i32* %canary
  %tail.addr = alloca %struct.node*, align 8
  %pos = alloca i64, align 8
  %head.addr = alloca %struct.node*, align 8
  %cost.addr = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @resize_prob.37(%struct.network* %net) #0 {
entry:
  %arc = alloca %struct.arc*, align 8
  %retval = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 423476519, i32* %canary
  %node = alloca %struct.node*, align 8
  %root = alloca %struct.node*, align 8
  %off = alloca i64, align 8
  %stop = alloca %struct.node*, align 8
...
entry:
  ...
  %red_cost.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 510619894, i32* %canary
  %cost.addr = alloca i64, align 8
  %head.addr = alloca %struct.node*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store %struct.arc* %new, %struct.arc** %new.addr, align 8
...
entry:
  %node = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1854785085, i32* %canary
  %stop = alloca %struct.node*, align 8
  %root = alloca %struct.node*, align 8
  %retval = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @replace_weaker_arc.40(%struct.network* %net, %struct.arc* %new, %struct.node* %tail, %struct.node* %head, i64 %cost, i64 %red_cost) #0 {
entry:
  %pos = alloca i64, align 8
  %new.addr = alloca %struct.arc*, align 8
  %head.addr = alloca %struct.node*, align 8
  %tail.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1321065798, i32* %canary
  %red_cost.addr = alloca i64, align 8
  %cost.addr = alloca i64, align 8
  %cmp = alloca i64, align 8
  %net.addr = alloca %struct.network*, align 8
