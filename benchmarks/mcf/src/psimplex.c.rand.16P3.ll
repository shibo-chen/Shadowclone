; ModuleID = 'psimplex.c.rand.16P3.bc'
...
entry:
  ...
  %canary = alloca i32
  store i32 1294959944, i32* %canary
...
entry:
  ...
  %delta = alloca i64, align 8
  %canary = alloca i32
  store i32 492642460, i32* %canary
  %iplus = alloca %struct.node*, align 8
  %jplus = alloca %struct.node*, align 8
  %checksum = alloca i64*, align 8
  %iterations = alloca i64*, align 8
...
entry:
  ...
  %red_cost_of_bea = alloca i64, align 8
  %canary = alloca i32
  store i32 1573388109, i32* %canary
  %net.addr = alloca %struct.network*, align 8
  %stop_arcs = alloca %struct.arc*, align 8
  %m = alloca i64, align 8
  %bla = alloca %struct.arc*, align 8
...
entry:
  ...
  %iminus = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1326877669, i32* %canary
  %m = alloca i64, align 8
  %bla = alloca %struct.arc*, align 8
  %arcs = alloca %struct.arc*, align 8
  %bound_exchanges = alloca i64*, align 8
...
entry:
  ...
  %iplus = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 472389037, i32* %canary
  %jminus = alloca %struct.node*, align 8
  %bea = alloca %struct.arc*, align 8
  %opt = alloca i64, align 8
  %jplus = alloca %struct.node*, align 8
...
entry:
  ...
  %temp = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 2068773579, i32* %canary
  %new_set = alloca i64, align 8
  %bea = alloca %struct.arc*, align 8
  %new_flow = alloca i64, align 8
  %arcs = alloca %struct.arc*, align 8
...
entry:
  ...
  %arcs = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1269834121, i32* %canary
  %iminus = alloca %struct.node*, align 8
  %jplus = alloca %struct.node*, align 8
  %new_set = alloca i64, align 8
  %delta = alloca i64, align 8
...
entry:
  ...
  %m = alloca i64, align 8
  %canary = alloca i32
  store i32 441317178, i32* %canary
  %opt = alloca i64, align 8
  %bea = alloca %struct.arc*, align 8
  %net.addr = alloca %struct.network*, align 8
  %temp = alloca %struct.node*, align 8
...
entry:
  ...
  %new_set = alloca i64, align 8
  %canary = alloca i32
  store i32 1038612262, i32* %canary
  %stop_arcs = alloca %struct.arc*, align 8
  %bea = alloca %struct.arc*, align 8
  %new_flow = alloca i64, align 8
  %bound_exchanges = alloca i64*, align 8
...
entry:
  ...
  %m = alloca i64, align 8
  %canary = alloca i32
  store i32 796197924, i32* %canary
  %checksum = alloca i64*, align 8
  %temp = alloca %struct.node*, align 8
  %new_set = alloca i64, align 8
  %stop_arcs = alloca %struct.arc*, align 8
...
entry:
  ...
  %new_flow = alloca i64, align 8
  %canary = alloca i32
  store i32 742906627, i32* %canary
  %bound_exchanges = alloca i64*, align 8
  %bla = alloca %struct.arc*, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
  store i64 0, i64* %opt, align 8
...
entry:
  ...
  %new_set = alloca i64, align 8
  %canary = alloca i32
  store i32 583380545, i32* %canary
  %jplus = alloca %struct.node*, align 8
  %new_orientation = alloca i64, align 8
  %delta = alloca i64, align 8
  %checksum = alloca i64*, align 8
...
entry:
  ...
  %temp = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 2017210627, i32* %canary
  %iterations = alloca i64*, align 8
  %opt = alloca i64, align 8
  %new_flow = alloca i64, align 8
  %new_orientation = alloca i64, align 8
...
entry:
  ...
  %red_cost_of_bea = alloca i64, align 8
  %canary = alloca i32
  store i32 1373860432, i32* %canary
  %jminus = alloca %struct.node*, align 8
  %arcs = alloca %struct.arc*, align 8
  %bla = alloca %struct.arc*, align 8
  %bea = alloca %struct.arc*, align 8
...
entry:
  ...
  %stop_arcs = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1380085408, i32* %canary
  %checksum = alloca i64*, align 8
  %new_flow = alloca i64, align 8
  %new_orientation = alloca i64, align 8
  %delta = alloca i64, align 8
...
entry:
  ...
  %bla = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 260298884, i32* %canary
  %iminus = alloca %struct.node*, align 8
  %temp = alloca %struct.node*, align 8
  %delta = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
