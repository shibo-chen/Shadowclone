; ModuleID = 'pbeampp.c.rand.16R2.bc'
...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_bea_is_dual_infeasible.5, label %func_bea_is_dual_infeasible.6

func_bea_is_dual_infeasible.5:                    ; preds = %rand_bb
  %2 = call i32 @bea_is_dual_infeasible.5(%struct.arc* %arc, i64 %red_cost)
  ret i32 %2
...
func_sort_basket.3:                               ; preds = %ctrl1
...
func_sort_basket.26:                              ; preds = %ctrl13
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_sort_basket.3, label %ctrl2
...
ctrl7:                                            ; preds = %ctrl6
  %9 = icmp eq i32 %0, 8
  br i1 %9, label %func_sort_basket.17, label %ctrl8

ctrl8:                                            ; preds = %ctrl7
  %10 = icmp eq i32 %0, 9
  br i1 %10, label %func_sort_basket.18, label %ctrl9

ctrl9:                                            ; preds = %ctrl8
  %11 = icmp eq i32 %0, 10
  br i1 %11, label %func_sort_basket.19, label %ctrl10

ctrl10:                                           ; preds = %ctrl9
  %12 = icmp eq i32 %0, 11
  br i1 %12, label %func_sort_basket.20, label %ctrl11

ctrl11:                                           ; preds = %ctrl10
  %13 = icmp eq i32 %0, 12
  br i1 %13, label %func_sort_basket.22, label %ctrl12
...
ctrl13:                                           ; preds = %ctrl12
  %15 = icmp eq i32 %0, 14
  br i1 %15, label %func_sort_basket.24, label %func_sort_basket.26
}
...
func_primal_bea_mpp.21:                           ; preds = %ctrl5
  %8 = call %struct.arc* @primal_bea_mpp.21(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea)
  ret %struct.arc* %8

func_primal_bea_mpp.25:                           ; preds = %ctrl6
  %9 = call %struct.arc* @primal_bea_mpp.25(i64 %m, %struct.arc* %arcs, %struct.arc* %stop_arcs, i64* %red_cost_of_bea)
  ret %struct.arc* %9
...
ctrl0:                                            ; preds = %rand_bb
  %18 = icmp eq i32 %0, 1
  br i1 %18, label %func_primal_bea_mpp.8, label %ctrl1
...
ctrl2:                                            ; preds = %ctrl1
  %20 = icmp eq i32 %0, 3
  br i1 %20, label %func_primal_bea_mpp.11, label %ctrl3
...
ctrl5:                                            ; preds = %ctrl4
  %23 = icmp eq i32 %0, 6
  br i1 %23, label %func_primal_bea_mpp.21, label %ctrl6

ctrl6:                                            ; preds = %ctrl5
  %24 = icmp eq i32 %0, 7
  br i1 %24, label %func_primal_bea_mpp.25, label %ctrl7
...
entry:
  ...
  %canary = alloca i32
  store i32 2105926371, i32* %canary
...
entry:
  ...
  %xchange = alloca %struct.basket*, align 8
  %canary = alloca i32
  store i32 1047699638, i32* %canary
  %cut = alloca i64, align 8
  %l = alloca i64, align 8
  store i64 %min, i64* %min.addr, align 8
  store i64 %max, i64* %max.addr, align 8
...
entry:
  ...
  %cut = alloca i64, align 8
  %canary = alloca i32
  store i32 1821149034, i32* %canary
  %xchange = alloca %struct.basket*, align 8
  %l = alloca i64, align 8
  %min.addr = alloca i64, align 8
  store i64 %min, i64* %min.addr, align 8
...
entry:
  ...
  %canary = alloca i32
  store i32 409043481, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1515420247, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 986757697, i32* %canary
  %arc.addr = alloca %struct.arc*, align 8
  %red_cost.addr = alloca i64, align 8
  store %struct.arc* %arc, %struct.arc** %arc.addr, align 8
  store i64 %red_cost, i64* %red_cost.addr, align 8
...
entry:
  ...
  %cut = alloca i64, align 8
  %canary = alloca i32
  store i32 1601659570, i32* %canary
  %r = alloca i64, align 8
  %min.addr = alloca i64, align 8
  %l = alloca i64, align 8
  store i64 %min, i64* %min.addr, align 8
...
entry:
  ...
  %arcs.addr = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 448427404, i32* %canary
  %i = alloca i64, align 8
  %retval = alloca %struct.arc*, align 8
  %m.addr = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
...
entry:
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1644649968, i32* %canary
  %old_group_pos = alloca i64, align 8
  %i = alloca i64, align 8
  %m.addr = alloca i64, align 8
  %stop_arcs.addr = alloca %struct.arc*, align 8
...
entry:
  ...
  %next = alloca i64, align 8
  %canary = alloca i32
  store i32 313637792, i32* %canary
  %i = alloca i64, align 8
  %old_group_pos = alloca i64, align 8
  %stop_arcs.addr = alloca %struct.arc*, align 8
  %retval = alloca %struct.arc*, align 8
...
entry:
  ...
  %cut = alloca i64, align 8
  %canary = alloca i32
  store i32 233543347, i32* %canary
  %l = alloca i64, align 8
  store i64 %min, i64* %min.addr, align 8
  store i64 %max, i64* %max.addr, align 8
  %0 = load i64, i64* %min.addr, align 8
...
entry:
  ...
  %old_group_pos = alloca i64, align 8
  %canary = alloca i32
  store i32 1087775407, i32* %canary
  %i = alloca i64, align 8
  %arc = alloca %struct.arc*, align 8
  %m.addr = alloca i64, align 8
  %red_cost = alloca i64, align 8
...
entry:
  %canary = alloca i32
  store i32 1622495417, i32* %canary
  %r = alloca i64, align 8
  %xchange = alloca %struct.basket*, align 8
  %min.addr = alloca i64, align 8
  %l = alloca i64, align 8
...
entry:
  %canary = alloca i32
  store i32 506162862, i32* %canary
  %xchange = alloca %struct.basket*, align 8
  %r = alloca i64, align 8
  %l = alloca i64, align 8
  %max.addr = alloca i64, align 8
...
entry:
  %canary = alloca i32
  store i32 1633848138, i32* %canary
  %l = alloca i64, align 8
  %min.addr = alloca i64, align 8
  %max.addr = alloca i64, align 8
  %xchange = alloca %struct.basket*, align 8
...
entry:
  %cut = alloca i64, align 8
  %canary = alloca i32
  store i32 1473219932, i32* %canary
  %xchange = alloca %struct.basket*, align 8
  %r = alloca i64, align 8
  %min.addr = alloca i64, align 8
  %l = alloca i64, align 8
...
entry:
  ...
  %xchange = alloca %struct.basket*, align 8
  %canary = alloca i32
  store i32 1348882724, i32* %canary
  %min.addr = alloca i64, align 8
  %l = alloca i64, align 8
  %r = alloca i64, align 8
  %cut = alloca i64, align 8
...
entry:
  ...
  %arcs.addr = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1470774839, i32* %canary
  %red_cost = alloca i64, align 8
  %m.addr = alloca i64, align 8
  %stop_arcs.addr = alloca %struct.arc*, align 8
  %arc = alloca %struct.arc*, align 8
...
entry:
  ...
  %r = alloca i64, align 8
  %canary = alloca i32
  store i32 977925786, i32* %canary
  %xchange = alloca %struct.basket*, align 8
  %min.addr = alloca i64, align 8
  %l = alloca i64, align 8
  store i64 %min, i64* %min.addr, align 8
...
entry:
  ...
  %cut = alloca i64, align 8
  %canary = alloca i32
  store i32 392884451, i32* %canary
  %max.addr = alloca i64, align 8
  %min.addr = alloca i64, align 8
  %l = alloca i64, align 8
  %r = alloca i64, align 8
...
entry:
  ...
  %cut = alloca i64, align 8
  %canary = alloca i32
  store i32 982269551, i32* %canary
  %l = alloca i64, align 8
  %xchange = alloca %struct.basket*, align 8
  %r = alloca i64, align 8
  %max.addr = alloca i64, align 8
...
entry:
  ...
  %retval = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 914981032, i32* %canary
  %i = alloca i64, align 8
  %stop_arcs.addr = alloca %struct.arc*, align 8
  %arcs.addr = alloca %struct.arc*, align 8
  %arc = alloca %struct.arc*, align 8
...
entry:
  ...
  %max.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1883518319, i32* %canary
  %l = alloca i64, align 8
  store i64 %min, i64* %min.addr, align 8
  store i64 %max, i64* %max.addr, align 8
  %0 = load i64, i64* %min.addr, align 8
...
entry:
  ...
  %retval = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 533677422, i32* %canary
  %arcs.addr = alloca %struct.arc*, align 8
  %arc = alloca %struct.arc*, align 8
  %i = alloca i64, align 8
  %red_cost = alloca i64, align 8
...
entry:
  ...
  %retval = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 589145213, i32* %canary
  %next = alloca i64, align 8
  %arcs.addr = alloca %struct.arc*, align 8
  %red_cost = alloca i64, align 8
  %stop_arcs.addr = alloca %struct.arc*, align 8
...
entry:
  ...
  %arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 584065174, i32* %canary
  %red_cost = alloca i64, align 8
  %stop_arcs.addr = alloca %struct.arc*, align 8
  %old_group_pos = alloca i64, align 8
  %i = alloca i64, align 8
...
entry:
  ...
  %m.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1276916788, i32* %canary
  %stop_arcs.addr = alloca %struct.arc*, align 8
  %red_cost_of_bea.addr = alloca i64*, align 8
  %old_group_pos = alloca i64, align 8
  %retval = alloca %struct.arc*, align 8
...
entry:
  ...
  %i = alloca i64, align 8
  %canary = alloca i32
  store i32 1134157558, i32* %canary
  %red_cost = alloca i64, align 8
  %retval = alloca %struct.arc*, align 8
  store i64 %m, i64* %m.addr, align 8
  store %struct.arc* %arcs, %struct.arc** %arcs.addr, align 8
...
entry:
  ...
  %stop_arcs.addr = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1868918876, i32* %canary
  %m.addr = alloca i64, align 8
  %old_group_pos = alloca i64, align 8
  %red_cost = alloca i64, align 8
  %arcs.addr = alloca %struct.arc*, align 8
...
entry:
  ...
  %red_cost_of_bea.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 1799116643, i32* %canary
  %m.addr = alloca i64, align 8
  %stop_arcs.addr = alloca %struct.arc*, align 8
  %arcs.addr = alloca %struct.arc*, align 8
  store i64 %m, i64* %m.addr, align 8
...
entry:
  ...
  %arcs.addr = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 973447394, i32* %canary
  %m.addr = alloca i64, align 8
  store i64 %m, i64* %m.addr, align 8
  store %struct.arc* %arcs, %struct.arc** %arcs.addr, align 8
  store %struct.arc* %stop_arcs, %struct.arc** %stop_arcs.addr, align 8
