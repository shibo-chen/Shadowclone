...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$628559169, -36(%rbp)   # imm = 0x25770D41
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movq	-32(%rbp), %rax
	movq	%rax, -8(%rbp)
...
# %bb.17:                               # %if.then25
	...
	callq	sort_basket
.LBB3_18:                               # %if.end26
	cmpl	$628559169, -36(%rbp)   # imm = 0x25770D41
	jne	.LBB3_20
.LBB3_19:
	addq	$64, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$424710251, -36(%rbp)   # imm = 0x1950906B
	movq	%rdi, -24(%rbp)
	movq	%rsi, -32(%rbp)
	movq	-24(%rbp), %rax
	movq	%rax, -8(%rbp)
...
# %bb.17:                               # %if.then25
	...
	callq	sort_basket
.LBB4_18:                               # %if.end26
	cmpl	$424710251, -36(%rbp)   # imm = 0x1950906B
	jne	.LBB4_20
.LBB4_19:
	addq	$64, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$1282403663, -12(%rbp)  # imm = 0x4C6FED4F
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	cmpq	$0, -24(%rbp)
	jge	.LBB5_2
...
.LBB5_5:                                # %lor.end
	andb	$1, %al
	movzbl	%al, %ebx
	cmpl	$1282403663, -12(%rbp)  # imm = 0x4C6FED4F
	jne	.LBB5_7
.LBB5_6:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$24, %rsp
	.cfi_offset %rbx, -24
	movl	$1590580182, -12(%rbp)  # imm = 0x5ECE53D6
	movq	%rdi, -24(%rbp)
	movq	%rsi, -32(%rbp)
	cmpq	$0, -32(%rbp)
	jge	.LBB6_2
...
.LBB6_5:                                # %lor.end
	andb	$1, %al
	movzbl	%al, %ebx
	cmpl	$1590580182, -12(%rbp)  # imm = 0x5ECE53D6
	jne	.LBB6_7
.LBB6_6:
	movl	%ebx, %eax
	addq	$24, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$792554815, -36(%rbp)   # imm = 0x2F3D6D3F
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movq	-32(%rbp), %rax
	movq	%rax, -8(%rbp)
...
# %bb.17:                               # %if.then25
	...
	callq	sort_basket
.LBB7_18:                               # %if.end26
	cmpl	$792554815, -36(%rbp)   # imm = 0x2F3D6D3F
	jne	.LBB7_20
.LBB7_19:
	addq	$64, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$64, %rsp
	movl	$997559643, -36(%rbp)   # imm = 0x3B758D5B
	movq	%rdi, -32(%rbp)
	movq	%rsi, -24(%rbp)
	movq	-32(%rbp), %rax
	movq	%rax, -8(%rbp)
...
# %bb.17:                               # %if.then25
	...
	callq	sort_basket
.LBB8_18:                               # %if.end26
	cmpl	$997559643, -36(%rbp)   # imm = 0x3B758D5B
	jne	.LBB8_20
.LBB8_19:
	addq	$64, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	subq	$88, %rsp
	.cfi_offset %rbx, -24
	movl	$2095879925, -44(%rbp)  # imm = 0x7CEC96F5
	movq	%rdi, -80(%rbp)
	movq	%rsi, -72(%rbp)
	movq	%rdx, -96(%rbp)
	movq	%rcx, -56(%rbp)
...
.LBB9_41:                               # %return
	movq	-64(%rbp), %rbx
	cmpl	$2095879925, -44(%rbp)  # imm = 0x7CEC96F5
	jne	.LBB9_43
.LBB9_42:
	movq	%rbx, %rax
	addq	$88, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$88, %rsp
	.cfi_offset %rbx, -24
	movl	$1304080839, -44(%rbp)  # imm = 0x4DBAB1C7
	movq	%rdi, -72(%rbp)
	movq	%rsi, -80(%rbp)
	movq	%rdx, -96(%rbp)
	movq	%rcx, -56(%rbp)
...
.LBB10_41:                              # %return
	movq	-64(%rbp), %rbx
	cmpl	$1304080839, -44(%rbp)  # imm = 0x4DBAB1C7
	jne	.LBB10_43
.LBB10_42:
	movq	%rbx, %rax
	addq	$88, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$88, %rsp
	.cfi_offset %rbx, -24
	movl	$1634519827, -44(%rbp)  # imm = 0x616CCB13
	movq	%rdi, -80(%rbp)
	movq	%rsi, -88(%rbp)
	movq	%rdx, -72(%rbp)
	movq	%rcx, -64(%rbp)
...
.LBB11_41:                              # %return
	movq	-56(%rbp), %rbx
	cmpl	$1634519827, -44(%rbp)  # imm = 0x616CCB13
	jne	.LBB11_43
.LBB11_42:
	movq	%rbx, %rax
	addq	$88, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$88, %rsp
	.cfi_offset %rbx, -24
	movl	$1175135721, -44(%rbp)  # imm = 0x460B25E9
	movq	%rdi, -88(%rbp)
	movq	%rsi, -96(%rbp)
	movq	%rdx, -72(%rbp)
	movq	%rcx, -64(%rbp)
...
.LBB12_41:                              # %return
	movq	-56(%rbp), %rbx
	cmpl	$1175135721, -44(%rbp)  # imm = 0x460B25E9
	jne	.LBB12_43
.LBB12_42:
	movq	%rbx, %rax
	addq	$88, %rsp
