; ModuleID = 'psimplex.c.rand.16R2.bc'
...
entry:
  ...
  %canary = alloca i32
  store i32 286503493, i32* %canary
...
entry:
  ...
  %arcs = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 965797413, i32* %canary
  %iplus = alloca %struct.node*, align 8
  %temp = alloca %struct.node*, align 8
  %jplus = alloca %struct.node*, align 8
  %iminus = alloca %struct.node*, align 8
...
entry:
  ...
  %new_orientation = alloca i64, align 8
  %canary = alloca i32
  store i32 1690968253, i32* %canary
  %arcs = alloca %struct.arc*, align 8
  %jminus = alloca %struct.node*, align 8
  %bea = alloca %struct.arc*, align 8
  %w = alloca %struct.node*, align 8
...
entry:
  ...
  %delta = alloca i64, align 8
  %canary = alloca i32
  store i32 1788497496, i32* %canary
  %new_orientation = alloca i64, align 8
  %iterations = alloca i64*, align 8
  %bea = alloca %struct.arc*, align 8
  %arcs = alloca %struct.arc*, align 8
...
entry:
  ...
  %iterations = alloca i64*, align 8
  %canary = alloca i32
  store i32 1208522638, i32* %canary
  %w = alloca %struct.node*, align 8
  %jplus = alloca %struct.node*, align 8
  %bound_exchanges = alloca i64*, align 8
  %temp = alloca %struct.node*, align 8
...
entry:
  ...
  %net.addr = alloca %struct.network*, align 8
  %canary = alloca i32
  store i32 399677650, i32* %canary
  %stop_arcs = alloca %struct.arc*, align 8
  %bound_exchanges = alloca i64*, align 8
  %bla = alloca %struct.arc*, align 8
  %arcs = alloca %struct.arc*, align 8
...
entry:
  ...
  %m = alloca i64, align 8
  %canary = alloca i32
  store i32 765388167, i32* %canary
  %new_orientation = alloca i64, align 8
  %delta = alloca i64, align 8
  %xchange = alloca i64, align 8
  %opt = alloca i64, align 8
...
entry:
  %canary = alloca i32
  store i32 1509448118, i32* %canary
  %arcs = alloca %struct.arc*, align 8
  %m = alloca i64, align 8
  %w = alloca %struct.node*, align 8
  %new_orientation = alloca i64, align 8
...
entry:
  ...
  %red_cost_of_bea = alloca i64, align 8
  %canary = alloca i32
  store i32 489284219, i32* %canary
  %arcs = alloca %struct.arc*, align 8
  %m = alloca i64, align 8
  %xchange = alloca i64, align 8
  store %struct.network* %net, %struct.network** %net.addr, align 8
...
entry:
  ...
  %new_set = alloca i64, align 8
  %canary = alloca i32
  store i32 1012664890, i32* %canary
  %jplus = alloca %struct.node*, align 8
  %new_orientation = alloca i64, align 8
  %jminus = alloca %struct.node*, align 8
  %iplus = alloca %struct.node*, align 8
...
entry:
  ...
  %new_set = alloca i64, align 8
  %canary = alloca i32
  store i32 1094501608, i32* %canary
  %jminus = alloca %struct.node*, align 8
  %red_cost_of_bea = alloca i64, align 8
  %bea = alloca %struct.arc*, align 8
  %bound_exchanges = alloca i64*, align 8
...
entry:
  ...
  %jplus = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1728579815, i32* %canary
  %iplus = alloca %struct.node*, align 8
  %checksum = alloca i64*, align 8
  %new_orientation = alloca i64, align 8
  %temp = alloca %struct.node*, align 8
...
entry:
  ...
  %new_orientation = alloca i64, align 8
  %canary = alloca i32
  store i32 1868041549, i32* %canary
  %xchange = alloca i64, align 8
  %m = alloca i64, align 8
  %temp = alloca %struct.node*, align 8
  %jplus = alloca %struct.node*, align 8
...
entry:
  ...
  %w = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1930923883, i32* %canary
  %checksum = alloca i64*, align 8
  %new_set = alloca i64, align 8
  %arcs = alloca %struct.arc*, align 8
  %iminus = alloca %struct.node*, align 8
...
entry:
  ...
  %jminus = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1137336140, i32* %canary
  %iterations = alloca i64*, align 8
  %opt = alloca i64, align 8
  %iminus = alloca %struct.node*, align 8
  %m = alloca i64, align 8
