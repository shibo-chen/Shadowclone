...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$48, %rsp
	movl	$847434414, -44(%rbp)   # imm = 0x3282D2AE
	movq	%rdi, -32(%rbp)
	movq	-32(%rbp), %rax
	movq	552(%rax), %rax
	movq	%rax, -8(%rbp)
...
.LBB1_10:                               # %for.end21
	...
	movq	-16(%rbp), %rax
	movq	$0, 40(%rax)
	cmpl	$847434414, -44(%rbp)   # imm = 0x3282D2AE
	jne	.LBB1_12
.LBB1_11:
	xorl	%eax, %eax
	addq	$48, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$48, %rsp
	movl	$273202362, -44(%rbp)   # imm = 0x1048BCBA
	movq	%rdi, -32(%rbp)
	movq	-32(%rbp), %rax
	movq	552(%rax), %rax
	movq	%rax, -8(%rbp)
...
.LBB2_10:                               # %for.end21
	...
	movq	-16(%rbp), %rax
	movq	$0, 40(%rax)
	cmpl	$273202362, -44(%rbp)   # imm = 0x1048BCBA
	jne	.LBB2_12
.LBB2_11:
	xorl	%eax, %eax
	addq	$48, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$48, %rsp
	movl	$1370659655, -44(%rbp)  # imm = 0x51B29B47
	movq	%rdi, -32(%rbp)
	movq	-32(%rbp), %rax
	movq	552(%rax), %rax
	movq	%rax, -8(%rbp)
...
.LBB3_10:                               # %for.end21
	...
	movq	-16(%rbp), %rax
	movq	$0, 40(%rax)
	cmpl	$1370659655, -44(%rbp)  # imm = 0x51B29B47
	jne	.LBB3_12
.LBB3_11:
	xorl	%eax, %eax
	addq	$48, %rsp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$48, %rsp
	movl	$219911611, -44(%rbp)   # imm = 0xD1B95BB
	movq	%rdi, -32(%rbp)
	movq	-32(%rbp), %rax
	movq	552(%rax), %rax
	movq	%rax, -8(%rbp)
...
.LBB4_10:                               # %for.end21
	...
	movq	-16(%rbp), %rax
	movq	$0, 40(%rax)
	cmpl	$219911611, -44(%rbp)   # imm = 0xD1B95BB
	jne	.LBB4_12
.LBB4_11:
	xorl	%eax, %eax
	addq	$48, %rsp
