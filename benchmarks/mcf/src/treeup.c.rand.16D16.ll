; ModuleID = 'treeup.c.rand.16D16.bc'
...
entry:
  ...
  %canary = alloca i32
  store i32 1745526053, i32* %canary
...
if.end128:                                        ; preds = %for.end127, %for.end108
  ...
  %153 = icmp eq i32 %152, 1745526053
...
entry:
  ...
  %depth_temp = alloca i64, align 8
  %canary = alloca i32
  store i32 1548482463, i32* %canary
  %sigma.addr = alloca i64, align 8
  store i64 %cycle_ori, i64* %cycle_ori.addr, align 8
  store i64 %new_orientation, i64* %new_orientation.addr, align 8
  store i64 %delta, i64* %delta.addr, align 8
...
if.end128:                                        ; preds = %for.end127, %for.end108
  %152 = load i32, i32* %canary
  %153 = icmp eq i32 %152, 1548482463
  br i1 %153, label %154, label %func_exit
...
entry:
  ...
  %sigma.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 2104690788, i32* %canary
  %iplus.addr = alloca %struct.node*, align 8
  %orientation_temp = alloca i64, align 8
  %new_depth = alloca i64, align 8
  %feas_tol.addr = alloca i64, align 8
...
if.end128:                                        ; preds = %for.end127, %for.end108
  %152 = load i32, i32* %canary
  %153 = icmp eq i32 %152, 2104690788
  br i1 %153, label %154, label %func_exit
...
entry:
  ...
  %jminus.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1944825873, i32* %canary
  %basic_arc_temp = alloca %struct.arc*, align 8
  %iplus.addr = alloca %struct.node*, align 8
  %depth_iminus = alloca i64, align 8
  %new_depth = alloca i64, align 8
...
if.end128:                                        ; preds = %for.end127, %for.end108
  %152 = load i32, i32* %canary
  %153 = icmp eq i32 %152, 1944825873
  br i1 %153, label %154, label %func_exit
...
entry:
  ...
  %basic_arc_temp = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1497331651, i32* %canary
  %iplus.addr = alloca %struct.node*, align 8
  %depth_temp = alloca i64, align 8
  store i64 %cycle_ori, i64* %cycle_ori.addr, align 8
  store i64 %new_orientation, i64* %new_orientation.addr, align 8
...
if.end128:                                        ; preds = %for.end127, %for.end108
  %152 = load i32, i32* %canary
  %153 = icmp eq i32 %152, 1497331651
  br i1 %153, label %154, label %func_exit
...
entry:
  ...
  %flow_temp = alloca i64, align 8
  %canary = alloca i32
  store i32 168383553, i32* %canary
  %depth_temp = alloca i64, align 8
  %cycle_ori.addr = alloca i64, align 8
  %bea.addr = alloca %struct.arc*, align 8
  %orientation_temp = alloca i64, align 8
...
entry:
  ...
  %new_orientation.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1653717065, i32* %canary
  %depth_temp = alloca i64, align 8
  store i64 %cycle_ori, i64* %cycle_ori.addr, align 8
  store i64 %new_orientation, i64* %new_orientation.addr, align 8
  store i64 %delta, i64* %delta.addr, align 8
...
if.end128:                                        ; preds = %for.end127, %for.end108
  %152 = load i32, i32* %canary
  %153 = icmp eq i32 %152, 1653717065
  br i1 %153, label %154, label %func_exit
...
entry:
  ...
  %jplus.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 448021122, i32* %canary
  %new_pred = alloca %struct.node*, align 8
  %sigma.addr = alloca i64, align 8
  %jminus.addr = alloca %struct.node*, align 8
  %flow_temp = alloca i64, align 8
...
entry:
  ...
  %basic_arc_temp = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1313017825, i32* %canary
  %jplus.addr = alloca %struct.node*, align 8
  %new_flow.addr = alloca i64, align 8
  %jminus.addr = alloca %struct.node*, align 8
  store i64 %cycle_ori, i64* %cycle_ori.addr, align 8
...
if.end128:                                        ; preds = %for.end127, %for.end108
  %152 = load i32, i32* %canary
  %153 = icmp eq i32 %152, 1313017825
  br i1 %153, label %154, label %func_exit
...
entry:
  ...
  %temp = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 1472947608, i32* %canary
  %bea.addr = alloca %struct.arc*, align 8
  %delta.addr = alloca i64, align 8
  store i64 %cycle_ori, i64* %cycle_ori.addr, align 8
  store i64 %new_orientation, i64* %new_orientation.addr, align 8
...
if.end128:                                        ; preds = %for.end127, %for.end108
  %152 = load i32, i32* %canary
  %153 = icmp eq i32 %152, 1472947608
  br i1 %153, label %154, label %func_exit
...
entry:
  ...
  %new_basic_arc = alloca %struct.arc*, align 8
  %canary = alloca i32
  store i32 1000014267, i32* %canary
  %bea.addr = alloca %struct.arc*, align 8
  %orientation_temp = alloca i64, align 8
  %temp = alloca %struct.node*, align 8
  store i64 %cycle_ori, i64* %cycle_ori.addr, align 8
...
if.end128:                                        ; preds = %for.end127, %for.end108
  %152 = load i32, i32* %canary
  %153 = icmp eq i32 %152, 1000014267
  br i1 %153, label %154, label %func_exit
...
entry:
  ...
  %iminus.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 790440061, i32* %canary
  %new_pred = alloca %struct.node*, align 8
  %flow_temp = alloca i64, align 8
  %orientation_temp = alloca i64, align 8
  %temp = alloca %struct.node*, align 8
...
entry:
  ...
  %delta.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 548174435, i32* %canary
  %depth_iminus = alloca i64, align 8
  %new_pred = alloca %struct.node*, align 8
  %new_depth = alloca i64, align 8
  %w.addr = alloca %struct.node*, align 8
...
entry:
  ...
  %jminus.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 966689607, i32* %canary
  %temp = alloca %struct.node*, align 8
  store i64 %cycle_ori, i64* %cycle_ori.addr, align 8
  store i64 %new_orientation, i64* %new_orientation.addr, align 8
  store i64 %delta, i64* %delta.addr, align 8
...
entry:
  ...
  %delta.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 637175609, i32* %canary
  %depth_iminus = alloca i64, align 8
  %orientation_temp = alloca i64, align 8
  %jminus.addr = alloca %struct.node*, align 8
  %bea.addr = alloca %struct.arc*, align 8
...
entry:
  ...
  %jminus.addr = alloca %struct.node*, align 8
  %canary = alloca i32
  store i32 336562066, i32* %canary
  %bea.addr = alloca %struct.arc*, align 8
  %feas_tol.addr = alloca i64, align 8
  %depth_temp = alloca i64, align 8
  %orientation_temp = alloca i64, align 8
