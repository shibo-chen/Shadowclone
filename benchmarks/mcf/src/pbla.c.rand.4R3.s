...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$392807757, -52(%rbp)   # imm = 0x1769C54D
	movq	%rdi, -32(%rbp)
	movq	%rsi, -48(%rbp)
	movq	%rdx, -16(%rbp)
	movq	%rcx, -24(%rbp)
...
.LBB1_24:                               # %while.end
	...
	movq	%rax, (%rcx)
	movq	-40(%rbp), %rbx
	cmpl	$392807757, -52(%rbp)   # imm = 0x1769C54D
	jne	.LBB1_26
.LBB1_25:
	movq	%rbx, %rax
	addq	$56, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$1836985697, -52(%rbp)  # imm = 0x6D7E2D61
	movq	%rdi, -32(%rbp)
	movq	%rsi, -48(%rbp)
	movq	%rdx, -16(%rbp)
	movq	%rcx, -24(%rbp)
...
.LBB2_24:                               # %while.end
	...
	movq	%rax, (%rcx)
	movq	-40(%rbp), %rbx
	cmpl	$1836985697, -52(%rbp)  # imm = 0x6D7E2D61
	jne	.LBB2_26
.LBB2_25:
	movq	%rbx, %rax
	addq	$56, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$2032707497, -52(%rbp)  # imm = 0x7928A7A9
	movq	%rdi, -32(%rbp)
	movq	%rsi, -48(%rbp)
	movq	%rdx, -16(%rbp)
	movq	%rcx, -24(%rbp)
...
.LBB3_24:                               # %while.end
	...
	movq	%rax, (%rcx)
	movq	-40(%rbp), %rbx
	cmpl	$2032707497, -52(%rbp)  # imm = 0x7928A7A9
	jne	.LBB3_26
.LBB3_25:
	movq	%rbx, %rax
	addq	$56, %rsp
...
# %bb.0:                                # %entry
	...
	subq	$56, %rsp
	.cfi_offset %rbx, -24
	movl	$1922211053, -52(%rbp)  # imm = 0x72929CED
	movq	%rdi, -32(%rbp)
	movq	%rsi, -48(%rbp)
	movq	%rdx, -16(%rbp)
	movq	%rcx, -24(%rbp)
...
.LBB4_24:                               # %while.end
	...
	movq	%rax, (%rcx)
	movq	-40(%rbp), %rbx
	cmpl	$1922211053, -52(%rbp)  # imm = 0x72929CED
	jne	.LBB4_26
.LBB4_25:
	movq	%rbx, %rax
	addq	$56, %rsp
