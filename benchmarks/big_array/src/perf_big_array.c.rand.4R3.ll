; ModuleID = 'perf_big_array.c.rand.4R3.bc'
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1653670866, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1839565237, i32* %canary
  %j = alloca i32, align 4
  %i = alloca i32, align 4
  %B = alloca [1000 x double], align 16
  %temp = alloca double, align 8
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1646407217, i32* %canary
  %j = alloca i32, align 4
  %C = alloca [1000 x double], align 16
  %temp = alloca double, align 8
  %temp2 = alloca double, align 8
...
entry:
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 579695683, i32* %canary
  %temp = alloca double, align 8
  %B = alloca [1000 x double], align 16
  %A = alloca [1000 x double], align 16
  %i = alloca i32, align 4
