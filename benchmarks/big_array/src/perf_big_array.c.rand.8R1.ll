; ModuleID = 'perf_big_array.c.rand.8R1.bc'
...
entry:
  ...
  %canary = alloca i32
  store i32 771289847, i32* %canary
...
entry:
  ...
  %temp = alloca double, align 8
  %canary = alloca i32
  store i32 1123709573, i32* %canary
  %B = alloca [1000 x double], align 16
  %j = alloca i32, align 4
  %C = alloca [1000 x double], align 16
  %temp2 = alloca double, align 8
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 122733615, i32* %canary
  %B = alloca [1000 x double], align 16
  store i32 0, i32* %i, align 4
  br label %for.cond
...
entry:
  %C = alloca [1000 x double], align 16
  %canary = alloca i32
  store i32 1675566973, i32* %canary
  %temp = alloca double, align 8
  %i = alloca i32, align 4
  %B = alloca [1000 x double], align 16
  %A = alloca [1000 x double], align 16
...
entry:
  ...
  %temp2 = alloca double, align 8
  %canary = alloca i32
  store i32 737120729, i32* %canary
  %j = alloca i32, align 4
  %i = alloca i32, align 4
  %temp = alloca double, align 8
  %B = alloca [1000 x double], align 16
...
entry:
  ...
  %A = alloca [1000 x double], align 16
  %canary = alloca i32
  store i32 900926819, i32* %canary
  %i = alloca i32, align 4
  store i32 0, i32* %i, align 4
  br label %for.cond
...
entry:
  ...
  %A = alloca [1000 x double], align 16
  %canary = alloca i32
  store i32 2120919727, i32* %canary
  %C = alloca [1000 x double], align 16
  %i = alloca i32, align 4
  %B = alloca [1000 x double], align 16
  store i32 0, i32* %i, align 4
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1030215898, i32* %canary
  %B = alloca [1000 x double], align 16
  %C = alloca [1000 x double], align 16
  store i32 0, i32* %i, align 4
  br label %for.cond
