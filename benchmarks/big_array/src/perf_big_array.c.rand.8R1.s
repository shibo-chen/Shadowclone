...
# %bb.0:                                # %entry
	...
	movl	$771289847, -12(%rbp)   # imm = 0x2DF8F2F7
	movl	$0, -4(%rbp)
.LBB2_1:                                # %for.cond
                                        # =>This Inner Loop Header: Depth=1
...
.LBB2_9:                                # %for.inc33
	...
	jmp	.LBB2_5
.LBB2_10:                               # %for.end35
	cmpl	$771289847, -12(%rbp)   # imm = 0x2DF8F2F7
	jne	.LBB2_12
.LBB2_11:
	xorl	%eax, %eax
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$24032, %rsp            # imm = 0x5DE0
	movl	$1123709573, -12(%rbp)  # imm = 0x42FA7285
	movl	$0, -4(%rbp)
.LBB3_1:                                # %for.cond
                                        # =>This Inner Loop Header: Depth=1
	cmpl	$1000, -4(%rbp)         # imm = 0x3E8
...
.LBB3_9:                                # %for.inc33
	...
	jmp	.LBB3_5
.LBB3_10:                               # %for.end35
	cmpl	$1123709573, -12(%rbp)  # imm = 0x42FA7285
	jne	.LBB3_12
.LBB3_11:
	xorl	%eax, %eax
	addq	$24032, %rsp            # imm = 0x5DE0
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$24032, %rsp            # imm = 0x5DE0
	movl	$122733615, -12(%rbp)   # imm = 0x750C42F
	movl	$0, -4(%rbp)
.LBB4_1:                                # %for.cond
                                        # =>This Inner Loop Header: Depth=1
	cmpl	$1000, -4(%rbp)         # imm = 0x3E8
...
.LBB4_9:                                # %for.inc33
	...
	jmp	.LBB4_5
.LBB4_10:                               # %for.end35
	cmpl	$122733615, -12(%rbp)   # imm = 0x750C42F
	jne	.LBB4_12
.LBB4_11:
	xorl	%eax, %eax
	addq	$24032, %rsp            # imm = 0x5DE0
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$24032, %rsp            # imm = 0x5DE0
	movl	$1675566973, -12(%rbp)  # imm = 0x63DF1F7D
	movl	$0, -4(%rbp)
.LBB5_1:                                # %for.cond
                                        # =>This Inner Loop Header: Depth=1
	cmpl	$1000, -4(%rbp)         # imm = 0x3E8
...
.LBB5_9:                                # %for.inc33
	...
	jmp	.LBB5_5
.LBB5_10:                               # %for.end35
	cmpl	$1675566973, -12(%rbp)  # imm = 0x63DF1F7D
	jne	.LBB5_12
.LBB5_11:
	xorl	%eax, %eax
	addq	$24032, %rsp            # imm = 0x5DE0
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$24032, %rsp            # imm = 0x5DE0
	movl	$737120729, -12(%rbp)   # imm = 0x2BEF91D9
	movl	$0, -4(%rbp)
.LBB6_1:                                # %for.cond
                                        # =>This Inner Loop Header: Depth=1
	cmpl	$1000, -4(%rbp)         # imm = 0x3E8
...
.LBB6_9:                                # %for.inc33
	...
	jmp	.LBB6_5
.LBB6_10:                               # %for.end35
	cmpl	$737120729, -12(%rbp)   # imm = 0x2BEF91D9
	jne	.LBB6_12
.LBB6_11:
	xorl	%eax, %eax
	addq	$24032, %rsp            # imm = 0x5DE0
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$24032, %rsp            # imm = 0x5DE0
	movl	$900926819, -12(%rbp)   # imm = 0x35B30D63
	movl	$0, -4(%rbp)
.LBB7_1:                                # %for.cond
                                        # =>This Inner Loop Header: Depth=1
	cmpl	$1000, -4(%rbp)         # imm = 0x3E8
...
.LBB7_9:                                # %for.inc33
	...
	jmp	.LBB7_5
.LBB7_10:                               # %for.end35
	cmpl	$900926819, -12(%rbp)   # imm = 0x35B30D63
	jne	.LBB7_12
.LBB7_11:
	xorl	%eax, %eax
	addq	$24032, %rsp            # imm = 0x5DE0
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$24032, %rsp            # imm = 0x5DE0
	movl	$2120919727, -12(%rbp)  # imm = 0x7E6AAAAF
	movl	$0, -4(%rbp)
.LBB8_1:                                # %for.cond
                                        # =>This Inner Loop Header: Depth=1
	cmpl	$1000, -4(%rbp)         # imm = 0x3E8
...
.LBB8_9:                                # %for.inc33
	...
	jmp	.LBB8_5
.LBB8_10:                               # %for.end35
	cmpl	$2120919727, -12(%rbp)  # imm = 0x7E6AAAAF
	jne	.LBB8_12
.LBB8_11:
	xorl	%eax, %eax
	addq	$24032, %rsp            # imm = 0x5DE0
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$24032, %rsp            # imm = 0x5DE0
	movl	$1030215898, -12(%rbp)  # imm = 0x3D67D8DA
	movl	$0, -4(%rbp)
.LBB9_1:                                # %for.cond
                                        # =>This Inner Loop Header: Depth=1
	cmpl	$1000, -4(%rbp)         # imm = 0x3E8
...
.LBB9_9:                                # %for.inc33
	...
	jmp	.LBB9_5
.LBB9_10:                               # %for.end35
	cmpl	$1030215898, -12(%rbp)  # imm = 0x3D67D8DA
	jne	.LBB9_12
.LBB9_11:
	xorl	%eax, %eax
	addq	$24032, %rsp            # imm = 0x5DE0
