; ModuleID = 'perf_big_array.c.rand.4P1.bc'
...
entry:
  ...
  %A = alloca [1000 x double], align 16
  %canary = alloca i32
  store i32 815774945, i32* %canary
  %temp = alloca double, align 8
  store i32 0, i32* %i, align 4
  br label %for.cond
...
entry:
  %canary = alloca i32
  store i32 1910732782, i32* %canary
  %i = alloca i32, align 4
  %temp2 = alloca double, align 8
  %B = alloca [1000 x double], align 16
  %j = alloca i32, align 4
...
entry:
  ...
  %temp = alloca double, align 8
  %canary = alloca i32
  store i32 2008544964, i32* %canary
  %A = alloca [1000 x double], align 16
  %j = alloca i32, align 4
  %B = alloca [1000 x double], align 16
  store i32 0, i32* %i, align 4
