; ModuleID = 'perf_big_array.c.rand.8P1.bc'
...
entry:
  ...
  %canary = alloca i32
  store i32 393612955, i32* %canary
...
entry:
  ...
  %temp2 = alloca double, align 8
  %canary = alloca i32
  store i32 1432252068, i32* %canary
  %A = alloca [1000 x double], align 16
  %j = alloca i32, align 4
  store i32 0, i32* %i, align 4
  br label %for.cond
...
entry:
  ...
  %C = alloca [1000 x double], align 16
  %canary = alloca i32
  store i32 578703021, i32* %canary
  %i = alloca i32, align 4
  %A = alloca [1000 x double], align 16
  %temp = alloca double, align 8
  %temp2 = alloca double, align 8
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1956555418, i32* %canary
  %temp = alloca double, align 8
  store i32 0, i32* %i, align 4
  br label %for.cond
...
entry:
  ...
  %C = alloca [1000 x double], align 16
  %canary = alloca i32
  store i32 1902478241, i32* %canary
  %B = alloca [1000 x double], align 16
  %j = alloca i32, align 4
  %temp = alloca double, align 8
  %temp2 = alloca double, align 8
...
entry:
  ...
  %A = alloca [1000 x double], align 16
  %canary = alloca i32
  store i32 428879192, i32* %canary
  %temp = alloca double, align 8
  %j = alloca i32, align 4
  %temp2 = alloca double, align 8
  %i = alloca i32, align 4
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 490915853, i32* %canary
  %C = alloca [1000 x double], align 16
  store i32 0, i32* %i, align 4
  br label %for.cond
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 237397189, i32* %canary
  %A = alloca [1000 x double], align 16
  store i32 0, i32* %i, align 4
  br label %for.cond
