; ModuleID = 'perf_big_array.c.rand.8P3.bc'
...
entry:
  ...
  %canary = alloca i32
  store i32 1803644801, i32* %canary
...
entry:
  ...
  %temp2 = alloca double, align 8
  %canary = alloca i32
  store i32 221028560, i32* %canary
  %temp = alloca double, align 8
  %A = alloca [1000 x double], align 16
  %j = alloca i32, align 4
  store i32 0, i32* %i, align 4
...
entry:
  ...
  %C = alloca [1000 x double], align 16
  %canary = alloca i32
  store i32 444083504, i32* %canary
  %j = alloca i32, align 4
  %i = alloca i32, align 4
  store i32 0, i32* %i, align 4
  br label %for.cond
...
entry:
  ...
  %A = alloca [1000 x double], align 16
  %canary = alloca i32
  store i32 700030448, i32* %canary
  %C = alloca [1000 x double], align 16
  %temp = alloca double, align 8
  %i = alloca i32, align 4
  %temp2 = alloca double, align 8
...
entry:
  ...
  %temp2 = alloca double, align 8
  %canary = alloca i32
  store i32 1670802259, i32* %canary
  %j = alloca i32, align 4
  %C = alloca [1000 x double], align 16
  %temp = alloca double, align 8
  %i = alloca i32, align 4
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1522843540, i32* %canary
  %B = alloca [1000 x double], align 16
  %temp2 = alloca double, align 8
  %C = alloca [1000 x double], align 16
  %temp = alloca double, align 8
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 710327811, i32* %canary
  %temp = alloca double, align 8
  %temp2 = alloca double, align 8
  %B = alloca [1000 x double], align 16
  %A = alloca [1000 x double], align 16
