; ModuleID = 'perf_big_array.c.rand.4R1.bc'
...
entry:
  ...
  %canary = alloca i32
  store i32 848021526, i32* %canary
  %i = alloca i32, align 4
...
entry:
  ...
  %temp2 = alloca double, align 8
  %canary = alloca i32
  store i32 535315125, i32* %canary
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  store i32 0, i32* %i, align 4
  br label %for.cond
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1491105628, i32* %canary
  %temp2 = alloca double, align 8
  %temp = alloca double, align 8
  store i32 0, i32* %i, align 4
  br label %for.cond
...
entry:
  ...
  %temp = alloca double, align 8
  %canary = alloca i32
  store i32 1905133375, i32* %canary
  %C = alloca [1000 x double], align 16
  %j = alloca i32, align 4
  %i = alloca i32, align 4
  %A = alloca [1000 x double], align 16
