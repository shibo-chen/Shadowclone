...
# %bb.0:                                # %entry
	...
	movl	$848021526, -12(%rbp)   # imm = 0x328BC816
	movl	$0, -4(%rbp)
.LBB2_1:                                # %for.cond
                                        # =>This Inner Loop Header: Depth=1
...
.LBB2_9:                                # %for.inc33
	...
	jmp	.LBB2_5
.LBB2_10:                               # %for.end35
	cmpl	$848021526, -12(%rbp)   # imm = 0x328BC816
	jne	.LBB2_12
.LBB2_11:
	xorl	%eax, %eax
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$24032, %rsp            # imm = 0x5DE0
	movl	$535315125, -12(%rbp)   # imm = 0x1FE842B5
	movl	$0, -4(%rbp)
.LBB3_1:                                # %for.cond
                                        # =>This Inner Loop Header: Depth=1
	cmpl	$1000, -4(%rbp)         # imm = 0x3E8
...
.LBB3_9:                                # %for.inc33
	...
	jmp	.LBB3_5
.LBB3_10:                               # %for.end35
	cmpl	$535315125, -12(%rbp)   # imm = 0x1FE842B5
	jne	.LBB3_12
.LBB3_11:
	xorl	%eax, %eax
	addq	$24032, %rsp            # imm = 0x5DE0
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$24032, %rsp            # imm = 0x5DE0
	movl	$1491105628, -12(%rbp)  # imm = 0x58E0775C
	movl	$0, -4(%rbp)
.LBB4_1:                                # %for.cond
                                        # =>This Inner Loop Header: Depth=1
	cmpl	$1000, -4(%rbp)         # imm = 0x3E8
...
.LBB4_9:                                # %for.inc33
	...
	jmp	.LBB4_5
.LBB4_10:                               # %for.end35
	cmpl	$1491105628, -12(%rbp)  # imm = 0x58E0775C
	jne	.LBB4_12
.LBB4_11:
	xorl	%eax, %eax
	addq	$24032, %rsp            # imm = 0x5DE0
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$24032, %rsp            # imm = 0x5DE0
	movl	$1905133375, -12(%rbp)  # imm = 0x718E073F
	movl	$0, -4(%rbp)
.LBB5_1:                                # %for.cond
                                        # =>This Inner Loop Header: Depth=1
	cmpl	$1000, -4(%rbp)         # imm = 0x3E8
...
.LBB5_9:                                # %for.inc33
	...
	jmp	.LBB5_5
.LBB5_10:                               # %for.end35
	cmpl	$1905133375, -12(%rbp)  # imm = 0x718E073F
	jne	.LBB5_12
.LBB5_11:
	xorl	%eax, %eax
	addq	$24032, %rsp            # imm = 0x5DE0
