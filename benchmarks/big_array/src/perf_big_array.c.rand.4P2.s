...
# %bb.0:                                # %entry
	...
	movl	$1044560440, -12(%rbp)  # imm = 0x3E42BA38
	movl	$0, -4(%rbp)
.LBB2_1:                                # %for.cond
                                        # =>This Inner Loop Header: Depth=1
...
.LBB2_9:                                # %for.inc33
	...
	jmp	.LBB2_5
.LBB2_10:                               # %for.end35
	cmpl	$1044560440, -12(%rbp)  # imm = 0x3E42BA38
	jne	.LBB2_12
.LBB2_11:
	xorl	%eax, %eax
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$24032, %rsp            # imm = 0x5DE0
	movl	$1274868533, -12(%rbp)  # imm = 0x4BFCF335
	movl	$0, -4(%rbp)
.LBB3_1:                                # %for.cond
                                        # =>This Inner Loop Header: Depth=1
	cmpl	$1000, -4(%rbp)         # imm = 0x3E8
...
.LBB3_9:                                # %for.inc33
	...
	jmp	.LBB3_5
.LBB3_10:                               # %for.end35
	cmpl	$1274868533, -12(%rbp)  # imm = 0x4BFCF335
	jne	.LBB3_12
.LBB3_11:
	xorl	%eax, %eax
	addq	$24032, %rsp            # imm = 0x5DE0
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$24032, %rsp            # imm = 0x5DE0
	movl	$1241655764, -12(%rbp)  # imm = 0x4A0229D4
	movl	$0, -4(%rbp)
.LBB4_1:                                # %for.cond
                                        # =>This Inner Loop Header: Depth=1
	cmpl	$1000, -4(%rbp)         # imm = 0x3E8
...
.LBB4_9:                                # %for.inc33
	...
	jmp	.LBB4_5
.LBB4_10:                               # %for.end35
	cmpl	$1241655764, -12(%rbp)  # imm = 0x4A0229D4
	jne	.LBB4_12
.LBB4_11:
	xorl	%eax, %eax
	addq	$24032, %rsp            # imm = 0x5DE0
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$24032, %rsp            # imm = 0x5DE0
	movl	$2050808437, -12(%rbp)  # imm = 0x7A3CDA75
	movl	$0, -4(%rbp)
.LBB5_1:                                # %for.cond
                                        # =>This Inner Loop Header: Depth=1
	cmpl	$1000, -4(%rbp)         # imm = 0x3E8
...
.LBB5_9:                                # %for.inc33
	...
	jmp	.LBB5_5
.LBB5_10:                               # %for.end35
	cmpl	$2050808437, -12(%rbp)  # imm = 0x7A3CDA75
	jne	.LBB5_12
.LBB5_11:
	xorl	%eax, %eax
	addq	$24032, %rsp            # imm = 0x5DE0
