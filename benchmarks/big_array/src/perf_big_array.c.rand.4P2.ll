; ModuleID = 'perf_big_array.c.rand.4P2.bc'
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_func.2, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_func.3, label %func_func.4
}
...
entry:
  ...
  %canary = alloca i32
  store i32 1044560440, i32* %canary
...
entry:
  ...
  %A = alloca [1000 x double], align 16
  %canary = alloca i32
  store i32 1274868533, i32* %canary
  %temp2 = alloca double, align 8
  %i = alloca i32, align 4
  store i32 0, i32* %i, align 4
  br label %for.cond
...
entry:
  ...
  %temp2 = alloca double, align 8
  %canary = alloca i32
  store i32 1241655764, i32* %canary
  %i = alloca i32, align 4
  store i32 0, i32* %i, align 4
  br label %for.cond
...
entry:
  ...
  %A = alloca [1000 x double], align 16
  %canary = alloca i32
  store i32 2050808437, i32* %canary
  %C = alloca [1000 x double], align 16
  store i32 0, i32* %i, align 4
  br label %for.cond
