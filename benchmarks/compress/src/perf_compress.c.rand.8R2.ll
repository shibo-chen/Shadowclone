; ModuleID = 'perf_compress.c.rand.8R2.bc'
...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_copystat.5, label %ctrl0

func_copystat.5:                                  ; preds = %rand_bb
  call void @copystat.5(i8* %ifname, i8* %ofname)
  ret void
...
func_copystat.20:                                 ; preds = %ctrl1
  call void @copystat.20(i8* %ifname, i8* %ofname)
  ret void

func_copystat.30:                                 ; preds = %ctrl2
  call void @copystat.30(i8* %ifname, i8* %ofname)
  ret void

func_copystat.38:                                 ; preds = %ctrl3
  call void @copystat.38(i8* %ifname, i8* %ofname)
  ret void

func_copystat.45:                                 ; preds = %ctrl4
  call void @copystat.45(i8* %ifname, i8* %ofname)
  ret void

func_copystat.46:                                 ; preds = %ctrl5
  call void @copystat.46(i8* %ifname, i8* %ofname)
  ret void

func_copystat.50:                                 ; preds = %ctrl5
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_copystat.20, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_copystat.30, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_copystat.38, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_copystat.45, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_copystat.46, label %func_copystat.50
}
...
func_compress.10:                                 ; preds = %ctrl0
  call void @compress.10()
  ret void

func_compress.24:                                 ; preds = %ctrl1
...
func_compress.34:                                 ; preds = %ctrl3
  call void @compress.34()
  ret void

func_compress.36:                                 ; preds = %ctrl4
  call void @compress.36()
  ret void

func_compress.48:                                 ; preds = %ctrl5
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_compress.10, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_compress.24, label %ctrl2
...
ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_compress.34, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_compress.36, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_compress.48, label %func_compress.54
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_cl_hash.2, label %ctrl0

func_cl_hash.2:                                   ; preds = %rand_bb
  call void @cl_hash.2(i64 %hsize)
  ret void

func_cl_hash.25:                                  ; preds = %ctrl0
  call void @cl_hash.25(i64 %hsize)
  ret void

func_cl_hash.42:                                  ; preds = %ctrl1
  call void @cl_hash.42(i64 %hsize)
  ret void

func_cl_hash.49:                                  ; preds = %ctrl2
  call void @cl_hash.49(i64 %hsize)
  ret void

func_cl_hash.52:                                  ; preds = %ctrl3
  call void @cl_hash.52(i64 %hsize)
  ret void

func_cl_hash.58:                                  ; preds = %ctrl4
  call void @cl_hash.58(i64 %hsize)
  ret void

func_cl_hash.60:                                  ; preds = %ctrl5
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_cl_hash.25, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_cl_hash.42, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_cl_hash.49, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_cl_hash.52, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_cl_hash.58, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_cl_hash.60, label %func_cl_hash.61
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_scott_hack.4, label %ctrl0

func_scott_hack.4:                                ; preds = %rand_bb
  %2 = call i32 @scott_hack.4(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent)
  ret i32 %2
...
func_scott_hack.22:                               ; preds = %ctrl1
  %4 = call i32 @scott_hack.22(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent)
  ret i32 %4

func_scott_hack.23:                               ; preds = %ctrl2
  %5 = call i32 @scott_hack.23(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent)
  ret i32 %5
...
func_scott_hack.27:                               ; preds = %ctrl4
  %7 = call i32 @scott_hack.27(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent)
  ret i32 %7

func_scott_hack.31:                               ; preds = %ctrl5
  %8 = call i32 @scott_hack.31(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent)
  ret i32 %8

func_scott_hack.33:                               ; preds = %ctrl5
  %9 = call i32 @scott_hack.33(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent)
  ret i32 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_scott_hack.17, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_scott_hack.22, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_scott_hack.23, label %ctrl3
...
ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_scott_hack.27, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_scott_hack.31, label %func_scott_hack.33
}
...
func_output.9:                                    ; preds = %ctrl0
  call void @output.9(i64 %code)
  ret void

func_output.12:                                   ; preds = %ctrl1
  call void @output.12(i64 %code)
  ret void

func_output.13:                                   ; preds = %ctrl2
  call void @output.13(i64 %code)
  ret void

func_output.15:                                   ; preds = %ctrl3
  call void @output.15(i64 %code)
  ret void

func_output.29:                                   ; preds = %ctrl4
  call void @output.29(i64 %code)
  ret void

func_output.35:                                   ; preds = %ctrl5
  call void @output.35(i64 %code)
  ret void

func_output.51:                                   ; preds = %ctrl5
  call void @output.51(i64 %code)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_output.9, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_output.12, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_output.13, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_output.15, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_output.29, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_output.35, label %func_output.51
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_prratio.1, label %ctrl0

func_prratio.1:                                   ; preds = %rand_bb
  call void @prratio.1(%struct._IO_FILE* %stream, i64 %num, i64 %den)
  ret void

func_prratio.16:                                  ; preds = %ctrl0
  call void @prratio.16(%struct._IO_FILE* %stream, i64 %num, i64 %den)
  ret void

func_prratio.18:                                  ; preds = %ctrl1
  call void @prratio.18(%struct._IO_FILE* %stream, i64 %num, i64 %den)
  ret void

func_prratio.19:                                  ; preds = %ctrl2
  call void @prratio.19(%struct._IO_FILE* %stream, i64 %num, i64 %den)
  ret void

func_prratio.37:                                  ; preds = %ctrl3
  call void @prratio.37(%struct._IO_FILE* %stream, i64 %num, i64 %den)
  ret void

func_prratio.43:                                  ; preds = %ctrl4
  call void @prratio.43(%struct._IO_FILE* %stream, i64 %num, i64 %den)
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_prratio.16, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_prratio.18, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_prratio.19, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_prratio.37, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_prratio.43, label %ctrl5
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_decompress.3, label %ctrl0

func_decompress.3:                                ; preds = %rand_bb
  call void @decompress.3()
  ret void

func_decompress.14:                               ; preds = %ctrl0
  call void @decompress.14()
  ret void

func_decompress.21:                               ; preds = %ctrl1
  call void @decompress.21()
  ret void

func_decompress.39:                               ; preds = %ctrl2
  call void @decompress.39()
  ret void

func_decompress.44:                               ; preds = %ctrl3
  call void @decompress.44()
  ret void

func_decompress.53:                               ; preds = %ctrl4
  call void @decompress.53()
  ret void

func_decompress.55:                               ; preds = %ctrl5
  call void @decompress.55()
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_decompress.14, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_decompress.21, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_decompress.39, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_decompress.44, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_decompress.53, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_decompress.55, label %func_decompress.57
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_getcode.11, label %ctrl0

func_getcode.11:                                  ; preds = %rand_bb
  %2 = call i64 @getcode.11()
  ret i64 %2

func_getcode.28:                                  ; preds = %ctrl0
  %3 = call i64 @getcode.28()
  ret i64 %3

func_getcode.40:                                  ; preds = %ctrl1
  %4 = call i64 @getcode.40()
  ret i64 %4

func_getcode.41:                                  ; preds = %ctrl2
  %5 = call i64 @getcode.41()
  ret i64 %5

func_getcode.59:                                  ; preds = %ctrl3
  %6 = call i64 @getcode.59()
  ret i64 %6

func_getcode.62:                                  ; preds = %ctrl4
  %7 = call i64 @getcode.62()
  ret i64 %7

func_getcode.63:                                  ; preds = %ctrl5
  %8 = call i64 @getcode.63()
  ret i64 %8

func_getcode.64:                                  ; preds = %ctrl5
  %9 = call i64 @getcode.64()
  ret i64 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_getcode.28, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_getcode.40, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_getcode.41, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_getcode.59, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_getcode.62, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_getcode.63, label %func_getcode.64
}
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @prratio.1(%struct._IO_FILE* %stream, i64 %num, i64 %den) #0 {
entry:
  %stream.addr = alloca %struct._IO_FILE*, align 8
  %den.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 427120110, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @cl_hash.2(i64 %hsize) #0 {
entry:
  %htab_p = alloca i64*, align 8
  %hsize.addr = alloca i64, align 8
  %i = alloca i64, align 8
  %canary = alloca i32
  store i32 687938026, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @scott_hack.4(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent) #0 {
entry:
  %fcode.addr = alloca i64, align 8
  %retval = alloca i32, align 4
  %disp.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1576070491, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @copystat.5(i8* %ifname, i8* %ofname) #0 {
entry:
  %statbuf = alloca %struct.stat, align 8
  ...
  %canary = alloca i32
  store i32 1740755103, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1332983863, i32* %canary
  %mode = alloca i32, align 4
  %timep = alloca %struct.utimbuf, align 8
  %ifname.addr = alloca i8*, align 8
  %statbuf = alloca %struct.stat, align 8
...
entry:
  ...
  %i = alloca i64, align 8
  %canary = alloca i32
  store i32 487909843, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 2072887621, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @output.9(i64 %code) #0 {
entry:
  %bp = alloca i8*, align 8
  %code.addr = alloca i64, align 8
  %r_off = alloca i32, align 4
  %canary = alloca i32
  store i32 1136211389, i32* %canary
  %bits = alloca i32, align 4
  store i64 %code, i64* %code.addr, align 8
  %0 = load i32, i32* @offset, align 4
  store i32 %0, i32* %r_off, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @compress.10() #0 {
entry:
  %c = alloca i32, align 4
  %hsize_reg = alloca i64, align 8
  %ent = alloca i64, align 8
  %canary = alloca i32
  store i32 84975250, i32* %canary
  %disp = alloca i32, align 4
  %i = alloca i64, align 8
  %hshift = alloca i32, align 4
  %c95 = alloca i32, align 4
...
entry:
  ...
  %code = alloca i64, align 8
  %canary = alloca i32
  store i32 1363377190, i32* %canary
  %bits = alloca i32, align 4
  %r_off = alloca i32, align 4
  %bp = alloca i8*, align 8
...
entry:
  ...
  %bits = alloca i32, align 4
  %canary = alloca i32
  store i32 1544992548, i32* %canary
  %r_off = alloca i32, align 4
  store i64 %code, i64* %code.addr, align 8
  %0 = load i32, i32* @offset, align 4
  store i32 %0, i32* %r_off, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @output.13(i64 %code) #0 {
entry:
  %r_off = alloca i32, align 4
  %bp = alloca i8*, align 8
  %canary = alloca i32
  store i32 1256641118, i32* %canary
  %bits = alloca i32, align 4
  %code.addr = alloca i64, align 8
  store i64 %code, i64* %code.addr, align 8
  %0 = load i32, i32* @offset, align 4
...
entry:
  ...
  %finchar = alloca i32, align 4
  %canary = alloca i32
  store i32 144390624, i32* %canary
  %stackp = alloca i8*, align 8
  %incode = alloca i64, align 8
  store i32 9, i32* @n_bits, align 4
  store i64 511, i64* @maxcode, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @output.15(i64 %code) #0 {
entry:
  %r_off = alloca i32, align 4
  %code.addr = alloca i64, align 8
  %bits = alloca i32, align 4
  %canary = alloca i32
  store i32 1513651550, i32* %canary
  %bp = alloca i8*, align 8
  store i64 %code, i64* %code.addr, align 8
  %0 = load i32, i32* @offset, align 4
  store i32 %0, i32* %r_off, align 4
...
entry:
  %q = alloca i32, align 4
  %canary = alloca i32
  store i32 1654889433, i32* %canary
  %den.addr = alloca i64, align 8
  %num.addr = alloca i64, align 8
  %stream.addr = alloca %struct._IO_FILE*, align 8
  store %struct._IO_FILE* %stream, %struct._IO_FILE** %stream.addr, align 8
...
entry:
  %hsize_reg.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 169478387, i32* %canary
  %ent.addr = alloca i64*, align 8
  %disp.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  %i.addr = alloca i64*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @prratio.18(%struct._IO_FILE* %stream, i64 %num, i64 %den) #0 {
entry:
  %num.addr = alloca i64, align 8
  %den.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 2003207612, i32* %canary
  %q = alloca i32, align 4
  %stream.addr = alloca %struct._IO_FILE*, align 8
  store %struct._IO_FILE* %stream, %struct._IO_FILE** %stream.addr, align 8
  store i64 %num, i64* %num.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @prratio.19(%struct._IO_FILE* %stream, i64 %num, i64 %den) #0 {
entry:
  %den.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 71412341, i32* %canary
  %stream.addr = alloca %struct._IO_FILE*, align 8
  %q = alloca i32, align 4
  %num.addr = alloca i64, align 8
  store %struct._IO_FILE* %stream, %struct._IO_FILE** %stream.addr, align 8
...
entry:
  ...
  %ifname.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 2100418054, i32* %canary
  %statbuf = alloca %struct.stat, align 8
  store i8* %ifname, i8** %ifname.addr, align 8
  store i8* %ofname, i8** %ofname.addr, align 8
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8
...
entry:
  ...
  %stackp = alloca i8*, align 8
  %canary = alloca i32
  store i32 1339430602, i32* %canary
  %oldcode = alloca i64, align 8
  %finchar = alloca i32, align 4
  %code = alloca i64, align 8
  store i32 9, i32* @n_bits, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @scott_hack.22(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent) #0 {
entry:
  %retval = alloca i32, align 4
  %hsize_reg.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1956962454, i32* %canary
  %i.addr = alloca i64*, align 8
  %ent.addr = alloca i64*, align 8
  %disp.addr = alloca i32, align 4
  %fcode.addr = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @scott_hack.23(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent) #0 {
entry:
  %retval = alloca i32, align 4
  %fcode.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1785804841, i32* %canary
  %ent.addr = alloca i64*, align 8
  %hsize_reg.addr = alloca i32, align 4
  %i.addr = alloca i64*, align 8
  %disp.addr = alloca i32, align 4
...
entry:
  ...
  %c = alloca i32, align 4
  %canary = alloca i32
  store i32 1440202947, i32* %canary
  %hsize_reg = alloca i64, align 8
  %fcode = alloca i64, align 8
  %disp = alloca i32, align 4
  store i64 0, i64* %i, align 8
...
entry:
  ...
  %i = alloca i64, align 8
  %canary = alloca i32
  store i32 1396135508, i32* %canary
  %m1 = alloca i64, align 8
  store i64 %hsize, i64* %hsize.addr, align 8
  %0 = load i64, i64* %hsize.addr, align 8
  %add.ptr = getelementptr inbounds i64, i64* getelementptr inbounds ([69001 x i64], [69001 x i64]* @htab, i64 0, i64 0), i64 %0
...
entry:
  ...
  %hsize_reg.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1461671159, i32* %canary
  %ent.addr = alloca i64*, align 8
  %disp.addr = alloca i32, align 4
  %fcode.addr = alloca i64, align 8
  store i64* %i, i64** %i.addr, align 8
...
entry:
  ...
  %disp.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 359160391, i32* %canary
  %i.addr = alloca i64*, align 8
  store i64* %i, i64** %i.addr, align 8
  store i64 %fcode, i64* %fcode.addr, align 8
  store i32 %disp, i32* %disp.addr, align 4
...
entry:
  ...
  %retval = alloca i64, align 8
  %canary = alloca i32
  store i32 1799884009, i32* %canary
  %bp = alloca i8*, align 8
  %bits = alloca i32, align 4
  store i8* getelementptr inbounds ([16 x i8], [16 x i8]* @getcode.buf, i64 0, i64 0), i8** %bp, align 8
  %0 = load i32, i32* @clear_flg, align 4
...
entry:
  ...
  %r_off = alloca i32, align 4
  %canary = alloca i32
  store i32 1920099316, i32* %canary
  %code.addr = alloca i64, align 8
  %bits = alloca i32, align 4
  store i64 %code, i64* %code.addr, align 8
  %0 = load i32, i32* @offset, align 4
...
entry:
  ...
  %timep = alloca %struct.utimbuf, align 8
  %canary = alloca i32
  store i32 1424924248, i32* %canary
  %ifname.addr = alloca i8*, align 8
  %ofname.addr = alloca i8*, align 8
  %mode = alloca i32, align 4
  store i8* %ifname, i8** %ifname.addr, align 8
...
entry:
  ...
  %ent.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 1656353732, i32* %canary
  %i.addr = alloca i64*, align 8
  %retval = alloca i32, align 4
  store i64* %i, i64** %i.addr, align 8
  store i64 %fcode, i64* %fcode.addr, align 8
...
entry:
  ...
  %c95 = alloca i32, align 4
  %canary = alloca i32
  store i32 819186700, i32* %canary
  %hsize_reg = alloca i64, align 8
  %fcode = alloca i64, align 8
  %disp = alloca i32, align 4
  %ent = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @scott_hack.33(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent) #0 {
entry:
  %canary = alloca i32
  store i32 342906833, i32* %canary
  %fcode.addr = alloca i64, align 8
  %ent.addr = alloca i64*, align 8
  %i.addr = alloca i64*, align 8
  %retval = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @compress.34() #0 {
entry:
  %hsize_reg = alloca i64, align 8
  %ent = alloca i64, align 8
  %c = alloca i32, align 4
  %canary = alloca i32
  store i32 1082124350, i32* %canary
  %disp = alloca i32, align 4
  %hshift = alloca i32, align 4
  %i = alloca i64, align 8
  %c95 = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @output.35(i64 %code) #0 {
entry:
  %canary = alloca i32
  store i32 177581565, i32* %canary
  %r_off = alloca i32, align 4
  %bits = alloca i32, align 4
  %bp = alloca i8*, align 8
  %code.addr = alloca i64, align 8
...
entry:
  %canary = alloca i32
  store i32 2137307537, i32* %canary
  %disp = alloca i32, align 4
  %ent = alloca i64, align 8
  %c = alloca i32, align 4
  %fcode = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @prratio.37(%struct._IO_FILE* %stream, i64 %num, i64 %den) #0 {
entry:
  %den.addr = alloca i64, align 8
  %num.addr = alloca i64, align 8
  %q = alloca i32, align 4
  %canary = alloca i32
  store i32 367951653, i32* %canary
  %stream.addr = alloca %struct._IO_FILE*, align 8
  store %struct._IO_FILE* %stream, %struct._IO_FILE** %stream.addr, align 8
  store i64 %num, i64* %num.addr, align 8
  store i64 %den, i64* %den.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @copystat.38(i8* %ifname, i8* %ofname) #0 {
entry:
  %timep = alloca %struct.utimbuf, align 8
  %ifname.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 503246888, i32* %canary
  %ofname.addr = alloca i8*, align 8
  %statbuf = alloca %struct.stat, align 8
  %mode = alloca i32, align 4
  store i8* %ifname, i8** %ifname.addr, align 8
...
entry:
  ...
  %oldcode = alloca i64, align 8
  %canary = alloca i32
  store i32 1030341005, i32* %canary
  %stackp = alloca i8*, align 8
  %incode = alloca i64, align 8
  store i32 9, i32* @n_bits, align 4
  store i64 511, i64* @maxcode, align 8
...
entry:
  ...
  %code = alloca i64, align 8
  %canary = alloca i32
  store i32 467537828, i32* %canary
  %bp = alloca i8*, align 8
  store i8* getelementptr inbounds ([16 x i8], [16 x i8]* @getcode.buf, i64 0, i64 0), i8** %bp, align 8
  %0 = load i32, i32* @clear_flg, align 4
  %cmp = icmp sgt i32 %0, 0
...
entry:
  ...
  %retval = alloca i64, align 8
  %canary = alloca i32
  store i32 719217298, i32* %canary
  %bp = alloca i8*, align 8
  %r_off = alloca i32, align 4
  %bits = alloca i32, align 4
  store i8* getelementptr inbounds ([16 x i8], [16 x i8]* @getcode.buf, i64 0, i64 0), i8** %bp, align 8
...
entry:
  ...
  %htab_p = alloca i64*, align 8
  %canary = alloca i32
  store i32 1660853362, i32* %canary
  %i = alloca i64, align 8
  %hsize.addr = alloca i64, align 8
  store i64 %hsize, i64* %hsize.addr, align 8
  %0 = load i64, i64* %hsize.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @prratio.43(%struct._IO_FILE* %stream, i64 %num, i64 %den) #0 {
entry:
  %q = alloca i32, align 4
  %stream.addr = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 455927826, i32* %canary
  %den.addr = alloca i64, align 8
  %num.addr = alloca i64, align 8
  store %struct._IO_FILE* %stream, %struct._IO_FILE** %stream.addr, align 8
  store i64 %num, i64* %num.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @decompress.44() #0 {
entry:
  %canary = alloca i32
  store i32 811499864, i32* %canary
  %finchar = alloca i32, align 4
  %stackp = alloca i8*, align 8
  %code = alloca i64, align 8
  %oldcode = alloca i64, align 8
...
entry:
  ...
  %ofname.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1378338543, i32* %canary
  %ifname.addr = alloca i8*, align 8
  store i8* %ifname, i8** %ifname.addr, align 8
  store i8* %ofname, i8** %ofname.addr, align 8
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @copystat.46(i8* %ifname, i8* %ofname) #0 {
entry:
  %ifname.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1197447430, i32* %canary
  %ofname.addr = alloca i8*, align 8
  %mode = alloca i32, align 4
  %timep = alloca %struct.utimbuf, align 8
  %statbuf = alloca %struct.stat, align 8
...
entry:
  ...
  %q = alloca i32, align 4
  %canary = alloca i32
  store i32 774850516, i32* %canary
  %den.addr = alloca i64, align 8
  store %struct._IO_FILE* %stream, %struct._IO_FILE** %stream.addr, align 8
  store i64 %num, i64* %num.addr, align 8
  store i64 %den, i64* %den.addr, align 8
...
entry:
  ...
  %ent = alloca i64, align 8
  %canary = alloca i32
  store i32 2024787524, i32* %canary
  %disp = alloca i32, align 4
  store i64 0, i64* %i, align 8
  %0 = load i32, i32* @nomagic, align 4
  %cmp = icmp eq i32 %0, 0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @cl_hash.49(i64 %hsize) #0 {
entry:
  %i = alloca i64, align 8
  %canary = alloca i32
  store i32 757552447, i32* %canary
  %htab_p = alloca i64*, align 8
  %m1 = alloca i64, align 8
  %hsize.addr = alloca i64, align 8
  store i64 %hsize, i64* %hsize.addr, align 8
...
entry:
  ...
  %mode = alloca i32, align 4
  %canary = alloca i32
  store i32 1998904280, i32* %canary
  %statbuf = alloca %struct.stat, align 8
  store i8* %ifname, i8** %ifname.addr, align 8
  store i8* %ofname, i8** %ofname.addr, align 8
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @output.51(i64 %code) #0 {
entry:
  %code.addr = alloca i64, align 8
  %bits = alloca i32, align 4
  %canary = alloca i32
  store i32 40613162, i32* %canary
  %r_off = alloca i32, align 4
  %bp = alloca i8*, align 8
  store i64 %code, i64* %code.addr, align 8
  %0 = load i32, i32* @offset, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @cl_hash.52(i64 %hsize) #0 {
entry:
  %hsize.addr = alloca i64, align 8
  %m1 = alloca i64, align 8
  %canary = alloca i32
  store i32 1271108670, i32* %canary
  %htab_p = alloca i64*, align 8
  %i = alloca i64, align 8
  store i64 %hsize, i64* %hsize.addr, align 8
  %0 = load i64, i64* %hsize.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1054994762, i32* %canary
  %oldcode = alloca i64, align 8
  %finchar = alloca i32, align 4
  %stackp = alloca i8*, align 8
  %code = alloca i64, align 8
...
entry:
  ...
  %i = alloca i64, align 8
  %canary = alloca i32
  store i32 944054806, i32* %canary
  %ent = alloca i64, align 8
  %disp = alloca i32, align 4
  %hshift = alloca i32, align 4
  %c = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @decompress.55() #0 {
entry:
  %finchar = alloca i32, align 4
  %oldcode = alloca i64, align 8
  %stackp = alloca i8*, align 8
  %canary = alloca i32
  store i32 907457875, i32* %canary
  %code = alloca i64, align 8
  %incode = alloca i64, align 8
  store i32 9, i32* @n_bits, align 4
  store i64 511, i64* @maxcode, align 8
...
entry:
  %canary = alloca i32
  store i32 1779980853, i32* %canary
  %den.addr = alloca i64, align 8
  %stream.addr = alloca %struct._IO_FILE*, align 8
  %num.addr = alloca i64, align 8
  %q = alloca i32, align 4
...
entry:
  ...
  %stackp = alloca i8*, align 8
  %canary = alloca i32
  store i32 2120166511, i32* %canary
  %incode = alloca i64, align 8
  %code = alloca i64, align 8
  store i32 9, i32* @n_bits, align 4
  store i64 511, i64* @maxcode, align 8
...
entry:
  ...
  %m1 = alloca i64, align 8
  %canary = alloca i32
  store i32 1556713283, i32* %canary
  %i = alloca i64, align 8
  %hsize.addr = alloca i64, align 8
  store i64 %hsize, i64* %hsize.addr, align 8
  %0 = load i64, i64* %hsize.addr, align 8
...
entry:
  ...
  %bits = alloca i32, align 4
  %canary = alloca i32
  store i32 2049057354, i32* %canary
  %r_off = alloca i32, align 4
  %code = alloca i64, align 8
  store i8* getelementptr inbounds ([16 x i8], [16 x i8]* @getcode.buf, i64 0, i64 0), i8** %bp, align 8
  %0 = load i32, i32* @clear_flg, align 4
...
entry:
  ...
  %m1 = alloca i64, align 8
  %canary = alloca i32
  store i32 353141898, i32* %canary
  %i = alloca i64, align 8
  store i64 %hsize, i64* %hsize.addr, align 8
  %0 = load i64, i64* %hsize.addr, align 8
  %add.ptr = getelementptr inbounds i64, i64* getelementptr inbounds ([69001 x i64], [69001 x i64]* @htab, i64 0, i64 0), i64 %0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @getcode.62() #0 {
entry:
  %retval = alloca i64, align 8
  %canary = alloca i32
  store i32 446173161, i32* %canary
  %code = alloca i64, align 8
  %bp = alloca i8*, align 8
  %bits = alloca i32, align 4
  %r_off = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @getcode.63() #0 {
entry:
  %canary = alloca i32
  store i32 771728641, i32* %canary
  %r_off = alloca i32, align 4
  %code = alloca i64, align 8
  %bp = alloca i8*, align 8
  %retval = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @getcode.64() #0 {
entry:
  %canary = alloca i32
  store i32 407638595, i32* %canary
  %code = alloca i64, align 8
  %r_off = alloca i32, align 4
  %bits = alloca i32, align 4
  %bp = alloca i8*, align 8
