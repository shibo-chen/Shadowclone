; ModuleID = 'perf_compress.c.rand.8P3.bc'
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_copystat.3, label %ctrl0

func_copystat.3:                                  ; preds = %rand_bb
  call void @copystat.3(i8* %ifname, i8* %ofname)
  ret void

func_copystat.4:                                  ; preds = %ctrl0
  call void @copystat.4(i8* %ifname, i8* %ofname)
  ret void

func_copystat.8:                                  ; preds = %ctrl1
  call void @copystat.8(i8* %ifname, i8* %ofname)
  ret void

func_copystat.15:                                 ; preds = %ctrl2
  call void @copystat.15(i8* %ifname, i8* %ofname)
  ret void

func_copystat.33:                                 ; preds = %ctrl3
  call void @copystat.33(i8* %ifname, i8* %ofname)
  ret void

func_copystat.42:                                 ; preds = %ctrl4
  call void @copystat.42(i8* %ifname, i8* %ofname)
  ret void

func_copystat.58:                                 ; preds = %ctrl5
  call void @copystat.58(i8* %ifname, i8* %ofname)
  ret void

func_copystat.59:                                 ; preds = %ctrl5
  call void @copystat.59(i8* %ifname, i8* %ofname)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_copystat.4, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_copystat.8, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_copystat.15, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_copystat.33, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_copystat.42, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_copystat.58, label %func_copystat.59
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_compress.2, label %ctrl0

func_compress.2:                                  ; preds = %rand_bb
  call void @compress.2()
  ret void

func_compress.9:                                  ; preds = %ctrl0
  call void @compress.9()
  ret void

func_compress.18:                                 ; preds = %ctrl1
  call void @compress.18()
  ret void

func_compress.21:                                 ; preds = %ctrl2
  call void @compress.21()
  ret void

func_compress.24:                                 ; preds = %ctrl3
  call void @compress.24()
  ret void

func_compress.51:                                 ; preds = %ctrl4
...
func_compress.56:                                 ; preds = %ctrl5
  call void @compress.56()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_compress.9, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_compress.18, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_compress.21, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_compress.24, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_compress.51, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_compress.55, label %func_compress.56
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_cl_hash.1, label %ctrl0

func_cl_hash.1:                                   ; preds = %rand_bb
  call void @cl_hash.1(i64 %hsize)
  ret void

func_cl_hash.7:                                   ; preds = %ctrl0
  call void @cl_hash.7(i64 %hsize)
  ret void

func_cl_hash.11:                                  ; preds = %ctrl1
  call void @cl_hash.11(i64 %hsize)
  ret void

func_cl_hash.12:                                  ; preds = %ctrl2
  call void @cl_hash.12(i64 %hsize)
  ret void

func_cl_hash.23:                                  ; preds = %ctrl3
  call void @cl_hash.23(i64 %hsize)
  ret void

func_cl_hash.29:                                  ; preds = %ctrl4
  call void @cl_hash.29(i64 %hsize)
  ret void

func_cl_hash.37:                                  ; preds = %ctrl5
  call void @cl_hash.37(i64 %hsize)
  ret void

func_cl_hash.43:                                  ; preds = %ctrl5
  call void @cl_hash.43(i64 %hsize)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_cl_hash.7, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_cl_hash.11, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_cl_hash.12, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_cl_hash.23, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_cl_hash.29, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_cl_hash.37, label %func_cl_hash.43
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_scott_hack.31, label %ctrl0

func_scott_hack.31:                               ; preds = %rand_bb
  %2 = call i32 @scott_hack.31(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent)
  ret i32 %2

func_scott_hack.40:                               ; preds = %ctrl0
  %3 = call i32 @scott_hack.40(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent)
  ret i32 %3

func_scott_hack.50:                               ; preds = %ctrl1
  %4 = call i32 @scott_hack.50(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent)
  ret i32 %4

func_scott_hack.60:                               ; preds = %ctrl2
  %5 = call i32 @scott_hack.60(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent)
  ret i32 %5

func_scott_hack.61:                               ; preds = %ctrl3
  %6 = call i32 @scott_hack.61(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent)
  ret i32 %6

func_scott_hack.62:                               ; preds = %ctrl4
  %7 = call i32 @scott_hack.62(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent)
  ret i32 %7

func_scott_hack.63:                               ; preds = %ctrl5
  %8 = call i32 @scott_hack.63(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent)
  ret i32 %8

func_scott_hack.64:                               ; preds = %ctrl5
  %9 = call i32 @scott_hack.64(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent)
  ret i32 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_scott_hack.40, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_scott_hack.50, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_scott_hack.60, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_scott_hack.61, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_scott_hack.62, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_scott_hack.63, label %func_scott_hack.64
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_output.25, label %ctrl0

func_output.25:                                   ; preds = %rand_bb
  call void @output.25(i64 %code)
  ret void

func_output.26:                                   ; preds = %ctrl0
  call void @output.26(i64 %code)
  ret void

func_output.28:                                   ; preds = %ctrl1
  call void @output.28(i64 %code)
  ret void

func_output.32:                                   ; preds = %ctrl2
  call void @output.32(i64 %code)
  ret void

func_output.34:                                   ; preds = %ctrl3
  call void @output.34(i64 %code)
  ret void

func_output.41:                                   ; preds = %ctrl4
  call void @output.41(i64 %code)
  ret void

func_output.47:                                   ; preds = %ctrl5
  call void @output.47(i64 %code)
  ret void

func_output.54:                                   ; preds = %ctrl5
  call void @output.54(i64 %code)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_output.26, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_output.28, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_output.32, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_output.34, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_output.41, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_output.47, label %func_output.54
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_prratio.5, label %ctrl0

func_prratio.5:                                   ; preds = %rand_bb
  call void @prratio.5(%struct._IO_FILE* %stream, i64 %num, i64 %den)
  ret void

func_prratio.10:                                  ; preds = %ctrl0
  call void @prratio.10(%struct._IO_FILE* %stream, i64 %num, i64 %den)
  ret void

func_prratio.16:                                  ; preds = %ctrl1
  call void @prratio.16(%struct._IO_FILE* %stream, i64 %num, i64 %den)
  ret void

func_prratio.17:                                  ; preds = %ctrl2
  call void @prratio.17(%struct._IO_FILE* %stream, i64 %num, i64 %den)
  ret void

func_prratio.27:                                  ; preds = %ctrl3
  call void @prratio.27(%struct._IO_FILE* %stream, i64 %num, i64 %den)
  ret void

func_prratio.35:                                  ; preds = %ctrl4
  call void @prratio.35(%struct._IO_FILE* %stream, i64 %num, i64 %den)
  ret void

func_prratio.36:                                  ; preds = %ctrl5
  call void @prratio.36(%struct._IO_FILE* %stream, i64 %num, i64 %den)
  ret void

func_prratio.39:                                  ; preds = %ctrl5
  call void @prratio.39(%struct._IO_FILE* %stream, i64 %num, i64 %den)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_prratio.10, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_prratio.16, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_prratio.17, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_prratio.27, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_prratio.35, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_prratio.36, label %func_prratio.39
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_decompress.6, label %ctrl0

func_decompress.6:                                ; preds = %rand_bb
  call void @decompress.6()
  ret void

func_decompress.13:                               ; preds = %ctrl0
  call void @decompress.13()
  ret void

func_decompress.30:                               ; preds = %ctrl1
  call void @decompress.30()
  ret void

func_decompress.45:                               ; preds = %ctrl2
  call void @decompress.45()
  ret void

func_decompress.49:                               ; preds = %ctrl3
  call void @decompress.49()
  ret void

func_decompress.52:                               ; preds = %ctrl4
  call void @decompress.52()
  ret void

func_decompress.53:                               ; preds = %ctrl5
  call void @decompress.53()
  ret void

func_decompress.57:                               ; preds = %ctrl5
  call void @decompress.57()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_decompress.13, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_decompress.30, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_decompress.45, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_decompress.49, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_decompress.52, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_decompress.53, label %func_decompress.57
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_getcode.14, label %ctrl0

func_getcode.14:                                  ; preds = %rand_bb
  %2 = call i64 @getcode.14()
  ret i64 %2

func_getcode.19:                                  ; preds = %ctrl0
  %3 = call i64 @getcode.19()
  ret i64 %3

func_getcode.20:                                  ; preds = %ctrl1
  %4 = call i64 @getcode.20()
  ret i64 %4

func_getcode.22:                                  ; preds = %ctrl2
  %5 = call i64 @getcode.22()
  ret i64 %5

func_getcode.38:                                  ; preds = %ctrl3
  %6 = call i64 @getcode.38()
  ret i64 %6

func_getcode.44:                                  ; preds = %ctrl4
  %7 = call i64 @getcode.44()
  ret i64 %7

func_getcode.46:                                  ; preds = %ctrl5
  %8 = call i64 @getcode.46()
  ret i64 %8

func_getcode.48:                                  ; preds = %ctrl5
  %9 = call i64 @getcode.48()
  ret i64 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_getcode.19, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_getcode.20, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_getcode.22, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_getcode.38, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_getcode.44, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_getcode.46, label %func_getcode.48
}
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @cl_hash.1(i64 %hsize) #0 {
entry:
  %canary = alloca i32
  store i32 98259295, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @copystat.3(i8* %ifname, i8* %ofname) #0 {
entry:
  %statbuf = alloca %struct.stat, align 8
  %ofname.addr = alloca i8*, align 8
  %mode = alloca i32, align 4
  %canary = alloca i32
  store i32 212092574, i32* %canary
...
entry:
  %statbuf = alloca %struct.stat, align 8
  %canary = alloca i32
  store i32 1827855096, i32* %canary
  %timep = alloca %struct.utimbuf, align 8
  %ifname.addr = alloca i8*, align 8
  %mode = alloca i32, align 4
  %ofname.addr = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @prratio.5(%struct._IO_FILE* %stream, i64 %num, i64 %den) #0 {
entry:
  %q = alloca i32, align 4
  %canary = alloca i32
  store i32 1055725726, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 279746732, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @cl_hash.7(i64 %hsize) #0 {
entry:
  %hsize.addr = alloca i64, align 8
  %i = alloca i64, align 8
  %canary = alloca i32
  store i32 394344439, i32* %canary
  %htab_p = alloca i64*, align 8
  %m1 = alloca i64, align 8
  store i64 %hsize, i64* %hsize.addr, align 8
  %0 = load i64, i64* %hsize.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @copystat.8(i8* %ifname, i8* %ofname) #0 {
entry:
  %canary = alloca i32
  store i32 625392913, i32* %canary
  %ifname.addr = alloca i8*, align 8
  %ofname.addr = alloca i8*, align 8
  %statbuf = alloca %struct.stat, align 8
  %timep = alloca %struct.utimbuf, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @compress.9() #0 {
entry:
  %c = alloca i32, align 4
  %i = alloca i64, align 8
  %hsize_reg = alloca i64, align 8
  ...
  %c95 = alloca i32, align 4
  %canary = alloca i32
  store i32 1344637271, i32* %canary
  %fcode = alloca i64, align 8
  %hshift = alloca i32, align 4
  store i64 0, i64* %i, align 8
  %0 = load i32, i32* @nomagic, align 4
...
entry:
  ...
  %num.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1471981545, i32* %canary
  %den.addr = alloca i64, align 8
  %q = alloca i32, align 4
  store %struct._IO_FILE* %stream, %struct._IO_FILE** %stream.addr, align 8
  store i64 %num, i64* %num.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @cl_hash.11(i64 %hsize) #0 {
entry:
  %m1 = alloca i64, align 8
  %canary = alloca i32
  store i32 680995900, i32* %canary
  %hsize.addr = alloca i64, align 8
  %i = alloca i64, align 8
  %htab_p = alloca i64*, align 8
  store i64 %hsize, i64* %hsize.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @cl_hash.12(i64 %hsize) #0 {
entry:
  %i = alloca i64, align 8
  %m1 = alloca i64, align 8
  %canary = alloca i32
  store i32 680439623, i32* %canary
  %htab_p = alloca i64*, align 8
  %hsize.addr = alloca i64, align 8
  store i64 %hsize, i64* %hsize.addr, align 8
  %0 = load i64, i64* %hsize.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @decompress.13() #0 {
entry:
  %canary = alloca i32
  store i32 821518339, i32* %canary
  %finchar = alloca i32, align 4
  %incode = alloca i64, align 8
  %oldcode = alloca i64, align 8
  %stackp = alloca i8*, align 8
...
entry:
  %canary = alloca i32
  store i32 428151912, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @prratio.16(%struct._IO_FILE* %stream, i64 %num, i64 %den) #0 {
entry:
  %num.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1518003289, i32* %canary
  %stream.addr = alloca %struct._IO_FILE*, align 8
  %den.addr = alloca i64, align 8
  %q = alloca i32, align 4
  store %struct._IO_FILE* %stream, %struct._IO_FILE** %stream.addr, align 8
...
entry:
  ...
  %den.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 988899497, i32* %canary
  %num.addr = alloca i64, align 8
  store %struct._IO_FILE* %stream, %struct._IO_FILE** %stream.addr, align 8
  store i64 %num, i64* %num.addr, align 8
  store i64 %den, i64* %den.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @compress.18() #0 {
entry:
  %ent = alloca i64, align 8
  %c95 = alloca i32, align 4
  %hshift = alloca i32, align 4
  ...
  %hsize_reg = alloca i64, align 8
  %canary = alloca i32
  store i32 1877474404, i32* %canary
  %i = alloca i64, align 8
  store i64 0, i64* %i, align 8
  %0 = load i32, i32* @nomagic, align 4
  %cmp = icmp eq i32 %0, 0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @getcode.19() #0 {
entry:
  %retval = alloca i64, align 8
  %bits = alloca i32, align 4
  %bp = alloca i8*, align 8
  %canary = alloca i32
  store i32 662386958, i32* %canary
  %r_off = alloca i32, align 4
  %code = alloca i64, align 8
  store i8* getelementptr inbounds ([16 x i8], [16 x i8]* @getcode.buf, i64 0, i64 0), i8** %bp, align 8
  %0 = load i32, i32* @clear_flg, align 4
...
entry:
  ...
  %retval = alloca i64, align 8
  %canary = alloca i32
  store i32 1502487684, i32* %canary
  %r_off = alloca i32, align 4
  %bp = alloca i8*, align 8
  store i8* getelementptr inbounds ([16 x i8], [16 x i8]* @getcode.buf, i64 0, i64 0), i8** %bp, align 8
  %0 = load i32, i32* @clear_flg, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @compress.21() #0 {
entry:
  %hshift = alloca i32, align 4
  %hsize_reg = alloca i64, align 8
  %ent = alloca i64, align 8
  ...
  %fcode = alloca i64, align 8
  %canary = alloca i32
  store i32 1386052900, i32* %canary
  %i = alloca i64, align 8
  %disp = alloca i32, align 4
  store i64 0, i64* %i, align 8
  %0 = load i32, i32* @nomagic, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @getcode.22() #0 {
entry:
  %bp = alloca i8*, align 8
  %bits = alloca i32, align 4
  %retval = alloca i64, align 8
  %code = alloca i64, align 8
  %canary = alloca i32
  store i32 400240304, i32* %canary
  %r_off = alloca i32, align 4
  store i8* getelementptr inbounds ([16 x i8], [16 x i8]* @getcode.buf, i64 0, i64 0), i8** %bp, align 8
  %0 = load i32, i32* @clear_flg, align 4
  %cmp = icmp sgt i32 %0, 0
...
entry:
  ...
  %htab_p = alloca i64*, align 8
  %canary = alloca i32
  store i32 894357928, i32* %canary
  %hsize.addr = alloca i64, align 8
  store i64 %hsize, i64* %hsize.addr, align 8
  %0 = load i64, i64* %hsize.addr, align 8
  %add.ptr = getelementptr inbounds i64, i64* getelementptr inbounds ([69001 x i64], [69001 x i64]* @htab, i64 0, i64 0), i64 %0
...
entry:
  ...
  %c = alloca i32, align 4
  %canary = alloca i32
  store i32 1206483534, i32* %canary
  %ent = alloca i64, align 8
  store i64 0, i64* %i, align 8
  %0 = load i32, i32* @nomagic, align 4
  %cmp = icmp eq i32 %0, 0
...
entry:
  %bp = alloca i8*, align 8
  %canary = alloca i32
  store i32 1050965781, i32* %canary
  %bits = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @output.26(i64 %code) #0 {
entry:
  %r_off = alloca i32, align 4
  %code.addr = alloca i64, align 8
  %bits = alloca i32, align 4
  %canary = alloca i32
  store i32 439180467, i32* %canary
  %bp = alloca i8*, align 8
  store i64 %code, i64* %code.addr, align 8
  %0 = load i32, i32* @offset, align 4
  store i32 %0, i32* %r_off, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @prratio.27(%struct._IO_FILE* %stream, i64 %num, i64 %den) #0 {
entry:
  %num.addr = alloca i64, align 8
  %q = alloca i32, align 4
  %canary = alloca i32
  store i32 1771357667, i32* %canary
  %stream.addr = alloca %struct._IO_FILE*, align 8
  %den.addr = alloca i64, align 8
  store %struct._IO_FILE* %stream, %struct._IO_FILE** %stream.addr, align 8
  store i64 %num, i64* %num.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @output.28(i64 %code) #0 {
entry:
  %canary = alloca i32
  store i32 538695291, i32* %canary
  %r_off = alloca i32, align 4
  %bits = alloca i32, align 4
  %bp = alloca i8*, align 8
  %code.addr = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @cl_hash.29(i64 %hsize) #0 {
entry:
  %m1 = alloca i64, align 8
  %htab_p = alloca i64*, align 8
  %canary = alloca i32
  store i32 1163137239, i32* %canary
  %i = alloca i64, align 8
  %hsize.addr = alloca i64, align 8
  store i64 %hsize, i64* %hsize.addr, align 8
  %0 = load i64, i64* %hsize.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @decompress.30() #0 {
entry:
  %stackp = alloca i8*, align 8
  %oldcode = alloca i64, align 8
  %finchar = alloca i32, align 4
  %incode = alloca i64, align 8
  %canary = alloca i32
  store i32 232207481, i32* %canary
  %code = alloca i64, align 8
  store i32 9, i32* @n_bits, align 4
  store i64 511, i64* @maxcode, align 8
  store i64 255, i64* %code, align 8
...
entry:
  ...
  %canary = alloca i32
  store i32 489717240, i32* %canary
  %retval = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @output.32(i64 %code) #0 {
entry:
  %r_off = alloca i32, align 4
  %bp = alloca i8*, align 8
  %bits = alloca i32, align 4
  %canary = alloca i32
  store i32 2071088098, i32* %canary
  %code.addr = alloca i64, align 8
  store i64 %code, i64* %code.addr, align 8
  %0 = load i32, i32* @offset, align 4
  store i32 %0, i32* %r_off, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @copystat.33(i8* %ifname, i8* %ofname) #0 {
entry:
  %ifname.addr = alloca i8*, align 8
  %mode = alloca i32, align 4
  %statbuf = alloca %struct.stat, align 8
  %canary = alloca i32
  store i32 1582867434, i32* %canary
  %timep = alloca %struct.utimbuf, align 8
  %ofname.addr = alloca i8*, align 8
  store i8* %ifname, i8** %ifname.addr, align 8
  store i8* %ofname, i8** %ofname.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @output.34(i64 %code) #0 {
entry:
  %code.addr = alloca i64, align 8
  %r_off = alloca i32, align 4
  %bits = alloca i32, align 4
  %canary = alloca i32
  store i32 264563826, i32* %canary
  %bp = alloca i8*, align 8
  store i64 %code, i64* %code.addr, align 8
  %0 = load i32, i32* @offset, align 4
  store i32 %0, i32* %r_off, align 4
...
entry:
  %canary = alloca i32
  store i32 153880540, i32* %canary
  %num.addr = alloca i64, align 8
  %stream.addr = alloca %struct._IO_FILE*, align 8
  %q = alloca i32, align 4
  %den.addr = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @prratio.36(%struct._IO_FILE* %stream, i64 %num, i64 %den) #0 {
entry:
  %den.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 556196060, i32* %canary
  %num.addr = alloca i64, align 8
  %q = alloca i32, align 4
  %stream.addr = alloca %struct._IO_FILE*, align 8
  store %struct._IO_FILE* %stream, %struct._IO_FILE** %stream.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @cl_hash.37(i64 %hsize) #0 {
entry:
  %canary = alloca i32
  store i32 1374841279, i32* %canary
  %i = alloca i64, align 8
  %m1 = alloca i64, align 8
  %hsize.addr = alloca i64, align 8
  %htab_p = alloca i64*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @getcode.38() #0 {
entry:
  %r_off = alloca i32, align 4
  %bits = alloca i32, align 4
  %canary = alloca i32
  store i32 1207054146, i32* %canary
  %bp = alloca i8*, align 8
  %code = alloca i64, align 8
  %retval = alloca i64, align 8
  store i8* getelementptr inbounds ([16 x i8], [16 x i8]* @getcode.buf, i64 0, i64 0), i8** %bp, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @prratio.39(%struct._IO_FILE* %stream, i64 %num, i64 %den) #0 {
entry:
  %den.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1368319931, i32* %canary
  %num.addr = alloca i64, align 8
  %stream.addr = alloca %struct._IO_FILE*, align 8
  %q = alloca i32, align 4
  store %struct._IO_FILE* %stream, %struct._IO_FILE** %stream.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @scott_hack.40(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent) #0 {
entry:
  %disp.addr = alloca i32, align 4
  %fcode.addr = alloca i64, align 8
  %hsize_reg.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 442970853, i32* %canary
  %ent.addr = alloca i64*, align 8
  %i.addr = alloca i64*, align 8
  %retval = alloca i32, align 4
  store i64* %i, i64** %i.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @output.41(i64 %code) #0 {
entry:
  %code.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1601384355, i32* %canary
  %bits = alloca i32, align 4
  %r_off = alloca i32, align 4
  %bp = alloca i8*, align 8
  store i64 %code, i64* %code.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @copystat.42(i8* %ifname, i8* %ofname) #0 {
entry:
  %ofname.addr = alloca i8*, align 8
  %statbuf = alloca %struct.stat, align 8
  %mode = alloca i32, align 4
  %timep = alloca %struct.utimbuf, align 8
  %canary = alloca i32
  store i32 456387015, i32* %canary
  %ifname.addr = alloca i8*, align 8
  store i8* %ifname, i8** %ifname.addr, align 8
  store i8* %ofname, i8** %ofname.addr, align 8
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @cl_hash.43(i64 %hsize) #0 {
entry:
  %i = alloca i64, align 8
  %htab_p = alloca i64*, align 8
  %m1 = alloca i64, align 8
  %canary = alloca i32
  store i32 1303224285, i32* %canary
  %hsize.addr = alloca i64, align 8
  store i64 %hsize, i64* %hsize.addr, align 8
  %0 = load i64, i64* %hsize.addr, align 8
  %add.ptr = getelementptr inbounds i64, i64* getelementptr inbounds ([69001 x i64], [69001 x i64]* @htab, i64 0, i64 0), i64 %0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @getcode.44() #0 {
entry:
  %canary = alloca i32
  store i32 79605966, i32* %canary
  %bits = alloca i32, align 4
  %code = alloca i64, align 8
  %r_off = alloca i32, align 4
  %retval = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @decompress.45() #0 {
entry:
  %incode = alloca i64, align 8
  %code = alloca i64, align 8
  %stackp = alloca i8*, align 8
  %canary = alloca i32
  store i32 517653501, i32* %canary
  %finchar = alloca i32, align 4
  %oldcode = alloca i64, align 8
  store i32 9, i32* @n_bits, align 4
  store i64 511, i64* @maxcode, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @getcode.46() #0 {
entry:
  %bp = alloca i8*, align 8
  %r_off = alloca i32, align 4
  %code = alloca i64, align 8
  %canary = alloca i32
  store i32 911403436, i32* %canary
  %bits = alloca i32, align 4
  %retval = alloca i64, align 8
  store i8* getelementptr inbounds ([16 x i8], [16 x i8]* @getcode.buf, i64 0, i64 0), i8** %bp, align 8
  %0 = load i32, i32* @clear_flg, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @output.47(i64 %code) #0 {
entry:
  %bp = alloca i8*, align 8
  %canary = alloca i32
  store i32 117126230, i32* %canary
  %bits = alloca i32, align 4
  %r_off = alloca i32, align 4
  %code.addr = alloca i64, align 8
  store i64 %code, i64* %code.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @getcode.48() #0 {
entry:
  %code = alloca i64, align 8
  %bits = alloca i32, align 4
  %r_off = alloca i32, align 4
  %canary = alloca i32
  store i32 1117103468, i32* %canary
  %bp = alloca i8*, align 8
  %retval = alloca i64, align 8
  store i8* getelementptr inbounds ([16 x i8], [16 x i8]* @getcode.buf, i64 0, i64 0), i8** %bp, align 8
  %0 = load i32, i32* @clear_flg, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @decompress.49() #0 {
entry:
  %stackp = alloca i8*, align 8
  %incode = alloca i64, align 8
  %oldcode = alloca i64, align 8
  %canary = alloca i32
  store i32 1744647148, i32* %canary
  %code = alloca i64, align 8
  %finchar = alloca i32, align 4
  store i32 9, i32* @n_bits, align 4
  store i64 511, i64* @maxcode, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @scott_hack.50(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent) #0 {
entry:
  %disp.addr = alloca i32, align 4
  %hsize_reg.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1664700025, i32* %canary
  %ent.addr = alloca i64*, align 8
  %retval = alloca i32, align 4
  %fcode.addr = alloca i64, align 8
  %i.addr = alloca i64*, align 8
...
entry:
  ...
  %hshift = alloca i32, align 4
  %canary = alloca i32
  store i32 442989636, i32* %canary
  %disp = alloca i32, align 4
  %i = alloca i64, align 8
  %hsize_reg = alloca i64, align 8
  %ent = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @decompress.52() #0 {
entry:
  %stackp = alloca i8*, align 8
  %code = alloca i64, align 8
  %incode = alloca i64, align 8
  %canary = alloca i32
  store i32 206154813, i32* %canary
  %oldcode = alloca i64, align 8
  %finchar = alloca i32, align 4
  store i32 9, i32* @n_bits, align 4
  store i64 511, i64* @maxcode, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @decompress.53() #0 {
entry:
  %code = alloca i64, align 8
  %finchar = alloca i32, align 4
  %stackp = alloca i8*, align 8
  %oldcode = alloca i64, align 8
  %canary = alloca i32
  store i32 1662251013, i32* %canary
  %incode = alloca i64, align 8
  store i32 9, i32* @n_bits, align 4
  store i64 511, i64* @maxcode, align 8
  store i64 255, i64* %code, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @output.54(i64 %code) #0 {
entry:
  %canary = alloca i32
  store i32 924632644, i32* %canary
  %r_off = alloca i32, align 4
  %code.addr = alloca i64, align 8
  %bp = alloca i8*, align 8
  %bits = alloca i32, align 4
...
entry:
  ...
  %i = alloca i64, align 8
  %canary = alloca i32
  store i32 1584866955, i32* %canary
  %fcode = alloca i64, align 8
  %c = alloca i32, align 4
  %ent = alloca i64, align 8
  store i64 0, i64* %i, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @compress.56() #0 {
entry:
  %c = alloca i32, align 4
  %c95 = alloca i32, align 4
  %ent = alloca i64, align 8
  ...
  %fcode = alloca i64, align 8
  %canary = alloca i32
  store i32 1788545970, i32* %canary
  %hshift = alloca i32, align 4
  %hsize_reg = alloca i64, align 8
  store i64 0, i64* %i, align 8
  %0 = load i32, i32* @nomagic, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @decompress.57() #0 {
entry:
  %canary = alloca i32
  store i32 1771421508, i32* %canary
  %incode = alloca i64, align 8
  %finchar = alloca i32, align 4
  %stackp = alloca i8*, align 8
  %oldcode = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @copystat.58(i8* %ifname, i8* %ofname) #0 {
entry:
  %mode = alloca i32, align 4
  %statbuf = alloca %struct.stat, align 8
  %ofname.addr = alloca i8*, align 8
  %ifname.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 214922426, i32* %canary
  %timep = alloca %struct.utimbuf, align 8
  store i8* %ifname, i8** %ifname.addr, align 8
  store i8* %ofname, i8** %ofname.addr, align 8
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @copystat.59(i8* %ifname, i8* %ofname) #0 {
entry:
  %ofname.addr = alloca i8*, align 8
  %ifname.addr = alloca i8*, align 8
  %mode = alloca i32, align 4
  %timep = alloca %struct.utimbuf, align 8
  %canary = alloca i32
  store i32 519975208, i32* %canary
  %statbuf = alloca %struct.stat, align 8
  store i8* %ifname, i8** %ifname.addr, align 8
  store i8* %ofname, i8** %ofname.addr, align 8
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @scott_hack.60(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent) #0 {
entry:
  %hsize_reg.addr = alloca i32, align 4
  %fcode.addr = alloca i64, align 8
  %i.addr = alloca i64*, align 8
  %ent.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 1600364923, i32* %canary
  %disp.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  store i64* %i, i64** %i.addr, align 8
  store i64 %fcode, i64* %fcode.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @scott_hack.61(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent) #0 {
entry:
  %hsize_reg.addr = alloca i32, align 4
  %disp.addr = alloca i32, align 4
  %fcode.addr = alloca i64, align 8
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1357630553, i32* %canary
  %i.addr = alloca i64*, align 8
  store i64* %i, i64** %i.addr, align 8
  store i64 %fcode, i64* %fcode.addr, align 8
  store i32 %disp, i32* %disp.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @scott_hack.62(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent) #0 {
entry:
  %canary = alloca i32
  store i32 116102424, i32* %canary
  %i.addr = alloca i64*, align 8
  %ent.addr = alloca i64*, align 8
  %fcode.addr = alloca i64, align 8
  %retval = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @scott_hack.63(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent) #0 {
entry:
  %disp.addr = alloca i32, align 4
  %hsize_reg.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 928248041, i32* %canary
  %ent.addr = alloca i64*, align 8
  %fcode.addr = alloca i64, align 8
  %i.addr = alloca i64*, align 8
  store i64* %i, i64** %i.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @scott_hack.64(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent) #0 {
entry:
  %fcode.addr = alloca i64, align 8
  %i.addr = alloca i64*, align 8
  %ent.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 1505904098, i32* %canary
  %hsize_reg.addr = alloca i32, align 4
  %disp.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  store i64* %i, i64** %i.addr, align 8
