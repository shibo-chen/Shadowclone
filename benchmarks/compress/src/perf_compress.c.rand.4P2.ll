; ModuleID = 'perf_compress.c.rand.4P2.bc'
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_copystat.26, label %ctrl0

func_copystat.26:                                 ; preds = %rand_bb
  call void @copystat.26(i8* %ifname, i8* %ofname)
  ret void

func_copystat.29:                                 ; preds = %ctrl0
  call void @copystat.29(i8* %ifname, i8* %ofname)
  ret void

func_copystat.30:                                 ; preds = %ctrl1
  call void @copystat.30(i8* %ifname, i8* %ofname)
  ret void

func_copystat.32:                                 ; preds = %ctrl1
  call void @copystat.32(i8* %ifname, i8* %ofname)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_copystat.29, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_copystat.30, label %func_copystat.32
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_compress.5, label %ctrl0

func_compress.5:                                  ; preds = %rand_bb
  call void @compress.5()
  ret void

func_compress.21:                                 ; preds = %ctrl0
  call void @compress.21()
  ret void

func_compress.28:                                 ; preds = %ctrl1
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_compress.21, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_compress.28, label %func_compress.31
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_cl_hash.7, label %ctrl0

func_cl_hash.7:                                   ; preds = %rand_bb
  call void @cl_hash.7(i64 %hsize)
  ret void

func_cl_hash.14:                                  ; preds = %ctrl0
  call void @cl_hash.14(i64 %hsize)
  ret void

func_cl_hash.19:                                  ; preds = %ctrl1
  call void @cl_hash.19(i64 %hsize)
  ret void

func_cl_hash.24:                                  ; preds = %ctrl1
  call void @cl_hash.24(i64 %hsize)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_cl_hash.14, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_cl_hash.19, label %func_cl_hash.24
}
...
func_scott_hack.23:                               ; preds = %ctrl0
  %3 = call i32 @scott_hack.23(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent)
  ret i32 %3
...
func_scott_hack.27:                               ; preds = %ctrl1
  %5 = call i32 @scott_hack.27(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_scott_hack.23, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_scott_hack.25, label %func_scott_hack.27
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_output.11, label %ctrl0

func_output.11:                                   ; preds = %rand_bb
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_output.16, label %func_output.17
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_prratio.8, label %ctrl0

func_prratio.8:                                   ; preds = %rand_bb
  call void @prratio.8(%struct._IO_FILE* %stream, i64 %num, i64 %den)
  ret void

func_prratio.15:                                  ; preds = %ctrl0
  call void @prratio.15(%struct._IO_FILE* %stream, i64 %num, i64 %den)
  ret void
...
func_prratio.20:                                  ; preds = %ctrl1
  call void @prratio.20(%struct._IO_FILE* %stream, i64 %num, i64 %den)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_prratio.15, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_prratio.18, label %func_prratio.20
}
...
func_decompress.4:                                ; preds = %ctrl0
  call void @decompress.4()
  ret void

func_decompress.10:                               ; preds = %ctrl1
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_decompress.4, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_decompress.10, label %func_decompress.13
}
...
func_getcode.2:                                   ; preds = %ctrl0
  %3 = call i64 @getcode.2()
  ret i64 %3

func_getcode.6:                                   ; preds = %ctrl1
  %4 = call i64 @getcode.6()
  ret i64 %4

func_getcode.22:                                  ; preds = %ctrl1
  %5 = call i64 @getcode.22()
  ret i64 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_getcode.2, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_getcode.6, label %func_getcode.22
}
...
entry:
  ...
  %canary = alloca i32
  store i32 1409112830, i32* %canary
...
entry:
  ...
  %code = alloca i64, align 8
  %canary = alloca i32
  store i32 757139437, i32* %canary
  %bits = alloca i32, align 4
  %r_off = alloca i32, align 4
  store i8* getelementptr inbounds ([16 x i8], [16 x i8]* @getcode.buf, i64 0, i64 0), i8** %bp, align 8
  %0 = load i32, i32* @clear_flg, align 4
...
entry:
  %canary = alloca i32
  store i32 1692813004, i32* %canary
...
entry:
  ...
  %stackp = alloca i8*, align 8
  %canary = alloca i32
  store i32 484595462, i32* %canary
  %incode = alloca i64, align 8
  %finchar = alloca i32, align 4
  %code = alloca i64, align 8
  store i32 9, i32* @n_bits, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @compress.5() #0 {
entry:
  ...
  %canary = alloca i32
  store i32 936355124, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @getcode.6() #0 {
entry:
  %bits = alloca i32, align 4
  %canary = alloca i32
  store i32 889487418, i32* %canary
  %r_off = alloca i32, align 4
  %retval = alloca i64, align 8
  %bp = alloca i8*, align 8
  %code = alloca i64, align 8
...
entry:
  ...
  %canary = alloca i32
  store i32 845739541, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @prratio.8(%struct._IO_FILE* %stream, i64 %num, i64 %den) #0 {
entry:
  %den.addr = alloca i64, align 8
  %num.addr = alloca i64, align 8
  %stream.addr = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 454489238, i32* %canary
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1616701473, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 802842419, i32* %canary
  %oldcode = alloca i64, align 8
  %finchar = alloca i32, align 4
  %code = alloca i64, align 8
  %stackp = alloca i8*, align 8
...
entry:
  ...
  %bits = alloca i32, align 4
  %canary = alloca i32
  store i32 511474433, i32* %canary
  %bp = alloca i8*, align 8
...
entry:
  ...
  %code.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1221646416, i32* %canary
  %bp = alloca i8*, align 8
  store i64 %code, i64* %code.addr, align 8
  %0 = load i32, i32* @offset, align 4
  store i32 %0, i32* %r_off, align 4
...
entry:
  ...
  %incode = alloca i64, align 8
  %canary = alloca i32
  store i32 1506972692, i32* %canary
  %oldcode = alloca i64, align 8
  %finchar = alloca i32, align 4
  store i32 9, i32* @n_bits, align 4
  store i64 511, i64* @maxcode, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @cl_hash.14(i64 %hsize) #0 {
entry:
  %m1 = alloca i64, align 8
  %hsize.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 123144733, i32* %canary
  %htab_p = alloca i64*, align 8
  %i = alloca i64, align 8
  store i64 %hsize, i64* %hsize.addr, align 8
  %0 = load i64, i64* %hsize.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @prratio.15(%struct._IO_FILE* %stream, i64 %num, i64 %den) #0 {
entry:
  %canary = alloca i32
  store i32 556194596, i32* %canary
  %q = alloca i32, align 4
  %den.addr = alloca i64, align 8
  %num.addr = alloca i64, align 8
  %stream.addr = alloca %struct._IO_FILE*, align 8
...
entry:
  %bits = alloca i32, align 4
  %canary = alloca i32
  store i32 1239612367, i32* %canary
  %r_off = alloca i32, align 4
  %bp = alloca i8*, align 8
  %code.addr = alloca i64, align 8
  store i64 %code, i64* %code.addr, align 8
...
entry:
  ...
  %code.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1523000301, i32* %canary
  %r_off = alloca i32, align 4
  store i64 %code, i64* %code.addr, align 8
  %0 = load i32, i32* @offset, align 4
  store i32 %0, i32* %r_off, align 4
...
entry:
  %canary = alloca i32
  store i32 272770089, i32* %canary
  %num.addr = alloca i64, align 8
  %q = alloca i32, align 4
  %den.addr = alloca i64, align 8
  %stream.addr = alloca %struct._IO_FILE*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @cl_hash.19(i64 %hsize) #0 {
entry:
  %i = alloca i64, align 8
  %hsize.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1347519329, i32* %canary
  %m1 = alloca i64, align 8
  %htab_p = alloca i64*, align 8
  store i64 %hsize, i64* %hsize.addr, align 8
  %0 = load i64, i64* %hsize.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @prratio.20(%struct._IO_FILE* %stream, i64 %num, i64 %den) #0 {
entry:
  %stream.addr = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 1881183577, i32* %canary
  %num.addr = alloca i64, align 8
  %q = alloca i32, align 4
  %den.addr = alloca i64, align 8
  store %struct._IO_FILE* %stream, %struct._IO_FILE** %stream.addr, align 8
...
entry:
  ...
  %i = alloca i64, align 8
  %canary = alloca i32
  store i32 782378596, i32* %canary
  %c = alloca i32, align 4
  store i64 0, i64* %i, align 8
  %0 = load i32, i32* @nomagic, align 4
  %cmp = icmp eq i32 %0, 0
...
entry:
  %bits = alloca i32, align 4
  %canary = alloca i32
  store i32 954260782, i32* %canary
  %bp = alloca i8*, align 8
  %code = alloca i64, align 8
  %retval = alloca i64, align 8
  %r_off = alloca i32, align 4
...
entry:
  ...
  %disp.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1816373111, i32* %canary
  %retval = alloca i32, align 4
  %ent.addr = alloca i64*, align 8
  %fcode.addr = alloca i64, align 8
  store i64* %i, i64** %i.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @cl_hash.24(i64 %hsize) #0 {
entry:
  %hsize.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1401001751, i32* %canary
  %m1 = alloca i64, align 8
  %htab_p = alloca i64*, align 8
  %i = alloca i64, align 8
  store i64 %hsize, i64* %hsize.addr, align 8
...
entry:
  ...
  %fcode.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 630362045, i32* %canary
  %retval = alloca i32, align 4
  %i.addr = alloca i64*, align 8
  %ent.addr = alloca i64*, align 8
  store i64* %i, i64** %i.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 2069421352, i32* %canary
...
entry:
  ...
  %fcode.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 953127959, i32* %canary
  %disp.addr = alloca i32, align 4
  store i64* %i, i64** %i.addr, align 8
  store i64 %fcode, i64* %fcode.addr, align 8
  store i32 %disp, i32* %disp.addr, align 4
...
entry:
  ...
  %disp = alloca i32, align 4
  %canary = alloca i32
  store i32 260781040, i32* %canary
  %c = alloca i32, align 4
  %c95 = alloca i32, align 4
  %i = alloca i64, align 8
  %ent = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @copystat.29(i8* %ifname, i8* %ofname) #0 {
entry:
  %ifname.addr = alloca i8*, align 8
  %statbuf = alloca %struct.stat, align 8
  %mode = alloca i32, align 4
  %canary = alloca i32
  store i32 1999143331, i32* %canary
  %timep = alloca %struct.utimbuf, align 8
  %ofname.addr = alloca i8*, align 8
  store i8* %ifname, i8** %ifname.addr, align 8
  store i8* %ofname, i8** %ofname.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 587679383, i32* %canary
  %mode = alloca i32, align 4
  %statbuf = alloca %struct.stat, align 8
  %ifname.addr = alloca i8*, align 8
  %ofname.addr = alloca i8*, align 8
...
entry:
  %hshift = alloca i32, align 4
  %canary = alloca i32
  store i32 323052114, i32* %canary
  %ent = alloca i64, align 8
  %c = alloca i32, align 4
  %hsize_reg = alloca i64, align 8
  %fcode = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @copystat.32(i8* %ifname, i8* %ofname) #0 {
entry:
  %mode = alloca i32, align 4
  %ofname.addr = alloca i8*, align 8
  %ifname.addr = alloca i8*, align 8
  %timep = alloca %struct.utimbuf, align 8
  %canary = alloca i32
  store i32 725580184, i32* %canary
  %statbuf = alloca %struct.stat, align 8
  store i8* %ifname, i8** %ifname.addr, align 8
  store i8* %ofname, i8** %ofname.addr, align 8
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8
