; ModuleID = 'perf_compress.c.rand.8P1.bc'
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_copystat.7, label %ctrl0

func_copystat.7:                                  ; preds = %rand_bb
  call void @copystat.7(i8* %ifname, i8* %ofname)
  ret void

func_copystat.14:                                 ; preds = %ctrl0
  call void @copystat.14(i8* %ifname, i8* %ofname)
  ret void

func_copystat.15:                                 ; preds = %ctrl1
  call void @copystat.15(i8* %ifname, i8* %ofname)
  ret void

func_copystat.22:                                 ; preds = %ctrl2
  call void @copystat.22(i8* %ifname, i8* %ofname)
  ret void

func_copystat.50:                                 ; preds = %ctrl3
  call void @copystat.50(i8* %ifname, i8* %ofname)
  ret void

func_copystat.58:                                 ; preds = %ctrl4
  call void @copystat.58(i8* %ifname, i8* %ofname)
  ret void

func_copystat.60:                                 ; preds = %ctrl5
  call void @copystat.60(i8* %ifname, i8* %ofname)
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_copystat.14, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_copystat.15, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_copystat.22, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_copystat.50, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_copystat.58, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_copystat.60, label %func_copystat.63
}
...
func_compress.3:                                  ; preds = %rand_bb
  call void @compress.3()
  ret void

func_compress.16:                                 ; preds = %ctrl0
...
func_compress.28:                                 ; preds = %ctrl2
  call void @compress.28()
  ret void

func_compress.36:                                 ; preds = %ctrl3
  call void @compress.36()
  ret void

func_compress.37:                                 ; preds = %ctrl4
  call void @compress.37()
  ret void

func_compress.54:                                 ; preds = %ctrl5
  call void @compress.54()
  ret void

func_compress.61:                                 ; preds = %ctrl5
  call void @compress.61()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_compress.16, label %ctrl1
...
ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_compress.28, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_compress.36, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_compress.37, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_compress.54, label %func_compress.61
}
...
func_cl_hash.9:                                   ; preds = %ctrl0
  call void @cl_hash.9(i64 %hsize)
  ret void

func_cl_hash.20:                                  ; preds = %ctrl1
  call void @cl_hash.20(i64 %hsize)
  ret void

func_cl_hash.29:                                  ; preds = %ctrl2
  call void @cl_hash.29(i64 %hsize)
  ret void

func_cl_hash.30:                                  ; preds = %ctrl3
  call void @cl_hash.30(i64 %hsize)
  ret void

func_cl_hash.33:                                  ; preds = %ctrl4
  call void @cl_hash.33(i64 %hsize)
  ret void

func_cl_hash.35:                                  ; preds = %ctrl5
  call void @cl_hash.35(i64 %hsize)
  ret void

func_cl_hash.38:                                  ; preds = %ctrl5
  call void @cl_hash.38(i64 %hsize)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_cl_hash.9, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_cl_hash.20, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_cl_hash.29, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_cl_hash.30, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_cl_hash.33, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_cl_hash.35, label %func_cl_hash.38
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_scott_hack.10, label %ctrl0

func_scott_hack.10:                               ; preds = %rand_bb
  %2 = call i32 @scott_hack.10(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent)
  ret i32 %2

func_scott_hack.18:                               ; preds = %ctrl0
  %3 = call i32 @scott_hack.18(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent)
  ret i32 %3

func_scott_hack.25:                               ; preds = %ctrl1
  %4 = call i32 @scott_hack.25(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent)
  ret i32 %4

func_scott_hack.42:                               ; preds = %ctrl2
  %5 = call i32 @scott_hack.42(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent)
  ret i32 %5

func_scott_hack.43:                               ; preds = %ctrl3
  %6 = call i32 @scott_hack.43(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent)
  ret i32 %6

func_scott_hack.48:                               ; preds = %ctrl4
  %7 = call i32 @scott_hack.48(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent)
  ret i32 %7
...
func_scott_hack.55:                               ; preds = %ctrl5
  %9 = call i32 @scott_hack.55(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent)
  ret i32 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_scott_hack.18, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_scott_hack.25, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_scott_hack.42, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_scott_hack.43, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_scott_hack.48, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_scott_hack.49, label %func_scott_hack.55
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_output.6, label %ctrl0

func_output.6:                                    ; preds = %rand_bb
  call void @output.6(i64 %code)
  ret void

func_output.8:                                    ; preds = %ctrl0
  call void @output.8(i64 %code)
  ret void

func_output.19:                                   ; preds = %ctrl1
  call void @output.19(i64 %code)
  ret void

func_output.24:                                   ; preds = %ctrl2
  call void @output.24(i64 %code)
  ret void

func_output.26:                                   ; preds = %ctrl3
  call void @output.26(i64 %code)
  ret void

func_output.31:                                   ; preds = %ctrl4
  call void @output.31(i64 %code)
  ret void

func_output.32:                                   ; preds = %ctrl5
  call void @output.32(i64 %code)
  ret void

func_output.40:                                   ; preds = %ctrl5
  call void @output.40(i64 %code)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_output.8, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_output.19, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_output.24, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_output.26, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_output.31, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_output.32, label %func_output.40
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_prratio.4, label %ctrl0

func_prratio.4:                                   ; preds = %rand_bb
  call void @prratio.4(%struct._IO_FILE* %stream, i64 %num, i64 %den)
  ret void

func_prratio.21:                                  ; preds = %ctrl0
  call void @prratio.21(%struct._IO_FILE* %stream, i64 %num, i64 %den)
  ret void

func_prratio.34:                                  ; preds = %ctrl1
  call void @prratio.34(%struct._IO_FILE* %stream, i64 %num, i64 %den)
  ret void

func_prratio.39:                                  ; preds = %ctrl2
  call void @prratio.39(%struct._IO_FILE* %stream, i64 %num, i64 %den)
  ret void

func_prratio.41:                                  ; preds = %ctrl3
  call void @prratio.41(%struct._IO_FILE* %stream, i64 %num, i64 %den)
  ret void

func_prratio.44:                                  ; preds = %ctrl4
  call void @prratio.44(%struct._IO_FILE* %stream, i64 %num, i64 %den)
  ret void

func_prratio.47:                                  ; preds = %ctrl5
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_prratio.21, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_prratio.34, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_prratio.39, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_prratio.41, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_prratio.44, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_prratio.47, label %func_prratio.56
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_decompress.11, label %ctrl0

func_decompress.11:                               ; preds = %rand_bb
  call void @decompress.11()
  ret void

func_decompress.17:                               ; preds = %ctrl0
  call void @decompress.17()
  ret void

func_decompress.23:                               ; preds = %ctrl1
  call void @decompress.23()
  ret void
...
func_decompress.51:                               ; preds = %ctrl3
  call void @decompress.51()
  ret void

func_decompress.57:                               ; preds = %ctrl4
  call void @decompress.57()
  ret void

func_decompress.62:                               ; preds = %ctrl5
  call void @decompress.62()
  ret void

func_decompress.64:                               ; preds = %ctrl5
  call void @decompress.64()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_decompress.17, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_decompress.23, label %ctrl2
...
ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_decompress.51, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_decompress.57, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_decompress.62, label %func_decompress.64
}
...
func_getcode.5:                                   ; preds = %ctrl0
  %3 = call i64 @getcode.5()
  ret i64 %3

func_getcode.12:                                  ; preds = %ctrl1
  %4 = call i64 @getcode.12()
  ret i64 %4

func_getcode.13:                                  ; preds = %ctrl2
  %5 = call i64 @getcode.13()
  ret i64 %5

func_getcode.46:                                  ; preds = %ctrl3
  %6 = call i64 @getcode.46()
  ret i64 %6

func_getcode.52:                                  ; preds = %ctrl4
  %7 = call i64 @getcode.52()
  ret i64 %7

func_getcode.53:                                  ; preds = %ctrl5
  %8 = call i64 @getcode.53()
  ret i64 %8

func_getcode.59:                                  ; preds = %ctrl5
  %9 = call i64 @getcode.59()
  ret i64 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_getcode.5, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_getcode.12, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_getcode.13, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_getcode.46, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_getcode.52, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_getcode.53, label %func_getcode.59
}
...
entry:
  ...
  %canary = alloca i32
  store i32 1107056918, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 189247760, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @compress.3() #0 {
entry:
  %hsize_reg = alloca i64, align 8
  %i = alloca i64, align 8
  %canary = alloca i32
  store i32 62709103, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @prratio.4(%struct._IO_FILE* %stream, i64 %num, i64 %den) #0 {
entry:
  %canary = alloca i32
  store i32 1535041595, i32* %canary
...
entry:
  ...
  %r_off = alloca i32, align 4
  %canary = alloca i32
  store i32 1640957211, i32* %canary
  %bp = alloca i8*, align 8
  %code = alloca i64, align 8
  %retval = alloca i64, align 8
  store i8* getelementptr inbounds ([16 x i8], [16 x i8]* @getcode.buf, i64 0, i64 0), i8** %bp, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @output.6(i64 %code) #0 {
entry:
  %bp = alloca i8*, align 8
  %code.addr = alloca i64, align 8
  %bits = alloca i32, align 4
  %canary = alloca i32
  store i32 1980088539, i32* %canary
  %r_off = alloca i32, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 1983926181, i32* %canary
  %statbuf = alloca %struct.stat, align 8
...
entry:
  %canary = alloca i32
  store i32 2008405475, i32* %canary
  %code.addr = alloca i64, align 8
  %bits = alloca i32, align 4
  %bp = alloca i8*, align 8
  %r_off = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @cl_hash.9(i64 %hsize) #0 {
entry:
  %hsize.addr = alloca i64, align 8
  %htab_p = alloca i64*, align 8
  %canary = alloca i32
  store i32 1564135880, i32* %canary
  %m1 = alloca i64, align 8
  %i = alloca i64, align 8
  store i64 %hsize, i64* %hsize.addr, align 8
  %0 = load i64, i64* %hsize.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @scott_hack.10(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent) #0 {
entry:
  %ent.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 1623347214, i32* %canary
  %retval = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @decompress.11() #0 {
entry:
  %code = alloca i64, align 8
...
entry:
  %canary = alloca i32
  store i32 1910262106, i32* %canary
  %code = alloca i64, align 8
  %r_off = alloca i32, align 4
  %bp = alloca i8*, align 8
  %bits = alloca i32, align 4
...
entry:
  ...
  %bp = alloca i8*, align 8
  %canary = alloca i32
  store i32 181674886, i32* %canary
  %r_off = alloca i32, align 4
  %retval = alloca i64, align 8
  store i8* getelementptr inbounds ([16 x i8], [16 x i8]* @getcode.buf, i64 0, i64 0), i8** %bp, align 8
  %0 = load i32, i32* @clear_flg, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @copystat.14(i8* %ifname, i8* %ofname) #0 {
entry:
  %statbuf = alloca %struct.stat, align 8
  %timep = alloca %struct.utimbuf, align 8
  %ofname.addr = alloca i8*, align 8
  %ifname.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 622432338, i32* %canary
  %mode = alloca i32, align 4
  store i8* %ifname, i8** %ifname.addr, align 8
  store i8* %ofname, i8** %ofname.addr, align 8
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8
...
entry:
  %canary = alloca i32
  store i32 489938603, i32* %canary
  %timep = alloca %struct.utimbuf, align 8
  %ofname.addr = alloca i8*, align 8
  %statbuf = alloca %struct.stat, align 8
  %mode = alloca i32, align 4
...
entry:
  ...
  %c95 = alloca i32, align 4
  %canary = alloca i32
  store i32 1370792515, i32* %canary
  %ent = alloca i64, align 8
  %i = alloca i64, align 8
  %hsize_reg = alloca i64, align 8
  store i64 0, i64* %i, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @decompress.17() #0 {
entry:
  %stackp = alloca i8*, align 8
  %code = alloca i64, align 8
  %oldcode = alloca i64, align 8
  %canary = alloca i32
  store i32 514040967, i32* %canary
  %incode = alloca i64, align 8
  %finchar = alloca i32, align 4
  store i32 9, i32* @n_bits, align 4
  store i64 511, i64* @maxcode, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @scott_hack.18(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent) #0 {
entry:
  %i.addr = alloca i64*, align 8
  %hsize_reg.addr = alloca i32, align 4
  %ent.addr = alloca i64*, align 8
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1477325677, i32* %canary
  %fcode.addr = alloca i64, align 8
  store i64* %i, i64** %i.addr, align 8
  store i64 %fcode, i64* %fcode.addr, align 8
  store i32 %disp, i32* %disp.addr, align 4
...
entry:
  %bp = alloca i8*, align 8
  %canary = alloca i32
  store i32 1194267935, i32* %canary
  %r_off = alloca i32, align 4
  %bits = alloca i32, align 4
  %code.addr = alloca i64, align 8
  store i64 %code, i64* %code.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @cl_hash.20(i64 %hsize) #0 {
entry:
  %htab_p = alloca i64*, align 8
  %hsize.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 2003518936, i32* %canary
  %i = alloca i64, align 8
  %m1 = alloca i64, align 8
  store i64 %hsize, i64* %hsize.addr, align 8
  %0 = load i64, i64* %hsize.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @prratio.21(%struct._IO_FILE* %stream, i64 %num, i64 %den) #0 {
entry:
  %stream.addr = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 543215617, i32* %canary
  %num.addr = alloca i64, align 8
  %q = alloca i32, align 4
  %den.addr = alloca i64, align 8
  store %struct._IO_FILE* %stream, %struct._IO_FILE** %stream.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @copystat.22(i8* %ifname, i8* %ofname) #0 {
entry:
  %mode = alloca i32, align 4
  %timep = alloca %struct.utimbuf, align 8
  %ofname.addr = alloca i8*, align 8
  %statbuf = alloca %struct.stat, align 8
  %canary = alloca i32
  store i32 622829077, i32* %canary
  %ifname.addr = alloca i8*, align 8
  store i8* %ifname, i8** %ifname.addr, align 8
  store i8* %ofname, i8** %ofname.addr, align 8
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @decompress.23() #0 {
entry:
  %code = alloca i64, align 8
  %canary = alloca i32
  store i32 400164315, i32* %canary
  %incode = alloca i64, align 8
  %finchar = alloca i32, align 4
  %stackp = alloca i8*, align 8
  %oldcode = alloca i64, align 8
...
entry:
  %canary = alloca i32
  store i32 1502873520, i32* %canary
  %r_off = alloca i32, align 4
  %bp = alloca i8*, align 8
  %bits = alloca i32, align 4
  %code.addr = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @scott_hack.25(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent) #0 {
entry:
  %i.addr = alloca i64*, align 8
  %fcode.addr = alloca i64, align 8
  %hsize_reg.addr = alloca i32, align 4
  %ent.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 1524325760, i32* %canary
  %disp.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  store i64* %i, i64** %i.addr, align 8
  store i64 %fcode, i64* %fcode.addr, align 8
...
entry:
  ...
  %r_off = alloca i32, align 4
  %canary = alloca i32
  store i32 869465338, i32* %canary
  %code.addr = alloca i64, align 8
  %bp = alloca i8*, align 8
  store i64 %code, i64* %code.addr, align 8
  %0 = load i32, i32* @offset, align 4
...
entry:
  ...
  %fcode = alloca i64, align 8
  %canary = alloca i32
  store i32 1037920288, i32* %canary
  %hsize_reg = alloca i64, align 8
  store i64 0, i64* %i, align 8
  %0 = load i32, i32* @nomagic, align 4
  %cmp = icmp eq i32 %0, 0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @compress.28() #0 {
entry:
  %canary = alloca i32
  store i32 1484290612, i32* %canary
  %ent = alloca i64, align 8
  %hshift = alloca i32, align 4
  %disp = alloca i32, align 4
  %fcode = alloca i64, align 8
...
entry:
  ...
  %htab_p = alloca i64*, align 8
  %canary = alloca i32
  store i32 1165223772, i32* %canary
  %m1 = alloca i64, align 8
  store i64 %hsize, i64* %hsize.addr, align 8
  %0 = load i64, i64* %hsize.addr, align 8
  %add.ptr = getelementptr inbounds i64, i64* getelementptr inbounds ([69001 x i64], [69001 x i64]* @htab, i64 0, i64 0), i64 %0
...
entry:
  %i = alloca i64, align 8
  %canary = alloca i32
  store i32 1729796766, i32* %canary
  %m1 = alloca i64, align 8
  %hsize.addr = alloca i64, align 8
  %htab_p = alloca i64*, align 8
  store i64 %hsize, i64* %hsize.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 411339786, i32* %canary
  %r_off = alloca i32, align 4
  %bits = alloca i32, align 4
  %bp = alloca i8*, align 8
  %code.addr = alloca i64, align 8
...
entry:
  ...
  %code.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1558108496, i32* %canary
  %r_off = alloca i32, align 4
  %bits = alloca i32, align 4
  store i64 %code, i64* %code.addr, align 8
  %0 = load i32, i32* @offset, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @cl_hash.33(i64 %hsize) #0 {
entry:
  %m1 = alloca i64, align 8
  %hsize.addr = alloca i64, align 8
  %i = alloca i64, align 8
  %canary = alloca i32
  store i32 1140091789, i32* %canary
  %htab_p = alloca i64*, align 8
  store i64 %hsize, i64* %hsize.addr, align 8
  %0 = load i64, i64* %hsize.addr, align 8
  %add.ptr = getelementptr inbounds i64, i64* getelementptr inbounds ([69001 x i64], [69001 x i64]* @htab, i64 0, i64 0), i64 %0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @prratio.34(%struct._IO_FILE* %stream, i64 %num, i64 %den) #0 {
entry:
  %canary = alloca i32
  store i32 157779082, i32* %canary
  %q = alloca i32, align 4
  %den.addr = alloca i64, align 8
  %stream.addr = alloca %struct._IO_FILE*, align 8
  %num.addr = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @cl_hash.35(i64 %hsize) #0 {
entry:
  %htab_p = alloca i64*, align 8
  %i = alloca i64, align 8
  %hsize.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1968411138, i32* %canary
  %m1 = alloca i64, align 8
  store i64 %hsize, i64* %hsize.addr, align 8
  %0 = load i64, i64* %hsize.addr, align 8
  %add.ptr = getelementptr inbounds i64, i64* getelementptr inbounds ([69001 x i64], [69001 x i64]* @htab, i64 0, i64 0), i64 %0
...
entry:
  %canary = alloca i32
  store i32 1263414456, i32* %canary
  %c95 = alloca i32, align 4
  %fcode = alloca i64, align 8
  %ent = alloca i64, align 8
  %i = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @compress.37() #0 {
entry:
  %hshift = alloca i32, align 4
  %ent = alloca i64, align 8
  %canary = alloca i32
  store i32 1538065312, i32* %canary
  %disp = alloca i32, align 4
  %i = alloca i64, align 8
  %fcode = alloca i64, align 8
  %c = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @cl_hash.38(i64 %hsize) #0 {
entry:
  %canary = alloca i32
  store i32 364569737, i32* %canary
  %hsize.addr = alloca i64, align 8
  %i = alloca i64, align 8
  %m1 = alloca i64, align 8
  %htab_p = alloca i64*, align 8
...
entry:
  ...
  %num.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 903584478, i32* %canary
  %stream.addr = alloca %struct._IO_FILE*, align 8
  %q = alloca i32, align 4
  store %struct._IO_FILE* %stream, %struct._IO_FILE** %stream.addr, align 8
  store i64 %num, i64* %num.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @output.40(i64 %code) #0 {
entry:
  %bp = alloca i8*, align 8
  %bits = alloca i32, align 4
  %canary = alloca i32
  store i32 409449732, i32* %canary
  %code.addr = alloca i64, align 8
  %r_off = alloca i32, align 4
  store i64 %code, i64* %code.addr, align 8
  %0 = load i32, i32* @offset, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @prratio.41(%struct._IO_FILE* %stream, i64 %num, i64 %den) #0 {
entry:
  %canary = alloca i32
  store i32 1095652082, i32* %canary
  %stream.addr = alloca %struct._IO_FILE*, align 8
  %q = alloca i32, align 4
  %den.addr = alloca i64, align 8
  %num.addr = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @scott_hack.42(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent) #0 {
entry:
  %canary = alloca i32
  store i32 1454330250, i32* %canary
  %disp.addr = alloca i32, align 4
  %fcode.addr = alloca i64, align 8
  %i.addr = alloca i64*, align 8
  %ent.addr = alloca i64*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @scott_hack.43(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent) #0 {
entry:
  %ent.addr = alloca i64*, align 8
  %i.addr = alloca i64*, align 8
  %fcode.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1789891642, i32* %canary
  %hsize_reg.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  %disp.addr = alloca i32, align 4
  store i64* %i, i64** %i.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @prratio.44(%struct._IO_FILE* %stream, i64 %num, i64 %den) #0 {
entry:
  %q = alloca i32, align 4
  %num.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 464366420, i32* %canary
  %stream.addr = alloca %struct._IO_FILE*, align 8
  %den.addr = alloca i64, align 8
  store %struct._IO_FILE* %stream, %struct._IO_FILE** %stream.addr, align 8
  store i64 %num, i64* %num.addr, align 8
...
entry:
  ...
  %stackp = alloca i8*, align 8
  %canary = alloca i32
  store i32 584048531, i32* %canary
  %oldcode = alloca i64, align 8
  %incode = alloca i64, align 8
  %finchar = alloca i32, align 4
  store i32 9, i32* @n_bits, align 4
...
entry:
  ...
  %code = alloca i64, align 8
  %canary = alloca i32
  store i32 1149433741, i32* %canary
  %retval = alloca i64, align 8
  %r_off = alloca i32, align 4
  %bits = alloca i32, align 4
  store i8* getelementptr inbounds ([16 x i8], [16 x i8]* @getcode.buf, i64 0, i64 0), i8** %bp, align 8
...
entry:
  ...
  %num.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1758396663, i32* %canary
  %den.addr = alloca i64, align 8
  %stream.addr = alloca %struct._IO_FILE*, align 8
  store %struct._IO_FILE* %stream, %struct._IO_FILE** %stream.addr, align 8
  store i64 %num, i64* %num.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @scott_hack.48(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent) #0 {
entry:
  %disp.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 799846629, i32* %canary
  %fcode.addr = alloca i64, align 8
  %hsize_reg.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  %ent.addr = alloca i64*, align 8
...
entry:
  ...
  %hsize_reg.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 141158708, i32* %canary
  %ent.addr = alloca i64*, align 8
  store i64* %i, i64** %i.addr, align 8
  store i64 %fcode, i64* %fcode.addr, align 8
  store i32 %disp, i32* %disp.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 954221432, i32* %canary
  %statbuf = alloca %struct.stat, align 8
  %ifname.addr = alloca i8*, align 8
  %mode = alloca i32, align 4
  %timep = alloca %struct.utimbuf, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @decompress.51() #0 {
entry:
  %finchar = alloca i32, align 4
  %code = alloca i64, align 8
  %incode = alloca i64, align 8
  %canary = alloca i32
  store i32 1635712709, i32* %canary
  %stackp = alloca i8*, align 8
  %oldcode = alloca i64, align 8
  store i32 9, i32* @n_bits, align 4
  store i64 511, i64* @maxcode, align 8
...
entry:
  ...
  %r_off = alloca i32, align 4
  %canary = alloca i32
  store i32 1988569896, i32* %canary
  %retval = alloca i64, align 8
  store i8* getelementptr inbounds ([16 x i8], [16 x i8]* @getcode.buf, i64 0, i64 0), i8** %bp, align 8
  %0 = load i32, i32* @clear_flg, align 4
  %cmp = icmp sgt i32 %0, 0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @getcode.53() #0 {
entry:
  %r_off = alloca i32, align 4
  %canary = alloca i32
  store i32 1959914176, i32* %canary
  %retval = alloca i64, align 8
  %code = alloca i64, align 8
  %bp = alloca i8*, align 8
  %bits = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1127603536, i32* %canary
  %c95 = alloca i32, align 4
  %disp = alloca i32, align 4
  %hsize_reg = alloca i64, align 8
  %ent = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @scott_hack.55(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent) #0 {
entry:
  %hsize_reg.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1834598989, i32* %canary
  %i.addr = alloca i64*, align 8
  %disp.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  %fcode.addr = alloca i64, align 8
...
entry:
  %canary = alloca i32
  store i32 1365836460, i32* %canary
  %num.addr = alloca i64, align 8
  %q = alloca i32, align 4
  %stream.addr = alloca %struct._IO_FILE*, align 8
  %den.addr = alloca i64, align 8
...
entry:
  ...
  %stackp = alloca i8*, align 8
  %canary = alloca i32
  store i32 1058097168, i32* %canary
  %incode = alloca i64, align 8
  store i32 9, i32* @n_bits, align 4
  store i64 511, i64* @maxcode, align 8
  store i64 255, i64* %code, align 8
...
entry:
  ...
  %ofname.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 2042916111, i32* %canary
  %mode = alloca i32, align 4
  %statbuf = alloca %struct.stat, align 8
  store i8* %ifname, i8** %ifname.addr, align 8
  store i8* %ofname, i8** %ofname.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @getcode.59() #0 {
entry:
  %bp = alloca i8*, align 8
  %bits = alloca i32, align 4
  %r_off = alloca i32, align 4
  %code = alloca i64, align 8
  %canary = alloca i32
  store i32 119234710, i32* %canary
  %retval = alloca i64, align 8
  store i8* getelementptr inbounds ([16 x i8], [16 x i8]* @getcode.buf, i64 0, i64 0), i8** %bp, align 8
  %0 = load i32, i32* @clear_flg, align 4
  %cmp = icmp sgt i32 %0, 0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @copystat.60(i8* %ifname, i8* %ofname) #0 {
entry:
  %timep = alloca %struct.utimbuf, align 8
  %ofname.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1152391591, i32* %canary
  %ifname.addr = alloca i8*, align 8
  %mode = alloca i32, align 4
  %statbuf = alloca %struct.stat, align 8
  store i8* %ifname, i8** %ifname.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @compress.61() #0 {
entry:
  %hsize_reg = alloca i64, align 8
  %ent = alloca i64, align 8
  %c95 = alloca i32, align 4
  %disp = alloca i32, align 4
  %canary = alloca i32
  store i32 1514897284, i32* %canary
  %fcode = alloca i64, align 8
  %i = alloca i64, align 8
  %hshift = alloca i32, align 4
  %c = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @decompress.62() #0 {
entry:
  %oldcode = alloca i64, align 8
  %finchar = alloca i32, align 4
  %stackp = alloca i8*, align 8
  %incode = alloca i64, align 8
  %canary = alloca i32
  store i32 386546346, i32* %canary
  %code = alloca i64, align 8
  store i32 9, i32* @n_bits, align 4
  store i64 511, i64* @maxcode, align 8
  store i64 255, i64* %code, align 8
...
entry:
  %canary = alloca i32
  store i32 1291827348, i32* %canary
  %timep = alloca %struct.utimbuf, align 8
  %mode = alloca i32, align 4
  %ofname.addr = alloca i8*, align 8
  %statbuf = alloca %struct.stat, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @decompress.64() #0 {
entry:
  %canary = alloca i32
  store i32 288726040, i32* %canary
  %finchar = alloca i32, align 4
  %oldcode = alloca i64, align 8
  %incode = alloca i64, align 8
  %stackp = alloca i8*, align 8
