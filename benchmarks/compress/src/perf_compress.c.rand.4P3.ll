; ModuleID = 'perf_compress.c.rand.4P3.bc'
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_copystat.8, label %ctrl0

func_copystat.8:                                  ; preds = %rand_bb
  call void @copystat.8(i8* %ifname, i8* %ofname)
  ret void

func_copystat.11:                                 ; preds = %ctrl0
  call void @copystat.11(i8* %ifname, i8* %ofname)
  ret void

func_copystat.17:                                 ; preds = %ctrl1
  call void @copystat.17(i8* %ifname, i8* %ofname)
  ret void

func_copystat.18:                                 ; preds = %ctrl1
  call void @copystat.18(i8* %ifname, i8* %ofname)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_copystat.11, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_copystat.17, label %func_copystat.18
}
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_compress.22, label %func_compress.27
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_cl_hash.15, label %ctrl0

func_cl_hash.15:                                  ; preds = %rand_bb
  call void @cl_hash.15(i64 %hsize)
  ret void

func_cl_hash.29:                                  ; preds = %ctrl0
  call void @cl_hash.29(i64 %hsize)
  ret void

func_cl_hash.31:                                  ; preds = %ctrl1
  call void @cl_hash.31(i64 %hsize)
  ret void

func_cl_hash.32:                                  ; preds = %ctrl1
  call void @cl_hash.32(i64 %hsize)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_cl_hash.29, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_cl_hash.31, label %func_cl_hash.32
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_scott_hack.6, label %ctrl0

func_scott_hack.6:                                ; preds = %rand_bb
  %2 = call i32 @scott_hack.6(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent)
  ret i32 %2

func_scott_hack.9:                                ; preds = %ctrl0
  %3 = call i32 @scott_hack.9(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent)
  ret i32 %3

func_scott_hack.12:                               ; preds = %ctrl1
  %4 = call i32 @scott_hack.12(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent)
  ret i32 %4

func_scott_hack.26:                               ; preds = %ctrl1
  %5 = call i32 @scott_hack.26(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_scott_hack.9, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_scott_hack.12, label %func_scott_hack.26
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_output.10, label %ctrl0

func_output.10:                                   ; preds = %rand_bb
  call void @output.10(i64 %code)
  ret void

func_output.14:                                   ; preds = %ctrl0
  call void @output.14(i64 %code)
  ret void

func_output.23:                                   ; preds = %ctrl1
  call void @output.23(i64 %code)
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_output.14, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_output.23, label %func_output.24
}
...
func_prratio.30:                                  ; preds = %ctrl1
  call void @prratio.30(%struct._IO_FILE* %stream, i64 %num, i64 %den)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_prratio.5, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_prratio.28, label %func_prratio.30
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_decompress.2, label %ctrl0

func_decompress.2:                                ; preds = %rand_bb
  call void @decompress.2()
  ret void

func_decompress.7:                                ; preds = %ctrl0
  call void @decompress.7()
  ret void

func_decompress.13:                               ; preds = %ctrl1
  call void @decompress.13()
  ret void

func_decompress.16:                               ; preds = %ctrl1
  call void @decompress.16()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_decompress.7, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_decompress.13, label %func_decompress.16
}
...
func_getcode.21:                                  ; preds = %ctrl1
  %4 = call i64 @getcode.21()
  ret i64 %4

func_getcode.25:                                  ; preds = %ctrl1
  %5 = call i64 @getcode.25()
  ret i64 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_getcode.4, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_getcode.21, label %func_getcode.25
}
...
entry:
  ...
  %canary = alloca i32
  store i32 591436719, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1130022316, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 881395956, i32* %canary
  %code = alloca i64, align 8
...
entry:
  ...
  %bits = alloca i32, align 4
  %canary = alloca i32
  store i32 1114444238, i32* %canary
  %r_off = alloca i32, align 4
  %retval = alloca i64, align 8
  store i8* getelementptr inbounds ([16 x i8], [16 x i8]* @getcode.buf, i64 0, i64 0), i8** %bp, align 8
  %0 = load i32, i32* @clear_flg, align 4
...
entry:
  %canary = alloca i32
  store i32 1067330148, i32* %canary
  %stream.addr = alloca %struct._IO_FILE*, align 8
  %q = alloca i32, align 4
  %den.addr = alloca i64, align 8
  %num.addr = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @scott_hack.6(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 1059497260, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @decompress.7() #0 {
entry:
  %incode = alloca i64, align 8
  %canary = alloca i32
  store i32 1388340711, i32* %canary
  %oldcode = alloca i64, align 8
  %code = alloca i64, align 8
  %stackp = alloca i8*, align 8
  %finchar = alloca i32, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 465629411, i32* %canary
...
entry:
  %fcode.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 519706752, i32* %canary
  %hsize_reg.addr = alloca i32, align 4
  %i.addr = alloca i64*, align 8
  %disp.addr = alloca i32, align 4
  %retval = alloca i32, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 1331800600, i32* %canary
  %bp = alloca i8*, align 8
  %r_off = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @copystat.11(i8* %ifname, i8* %ofname) #0 {
entry:
  %ifname.addr = alloca i8*, align 8
  %timep = alloca %struct.utimbuf, align 8
  %ofname.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 265241187, i32* %canary
  %statbuf = alloca %struct.stat, align 8
  %mode = alloca i32, align 4
  store i8* %ifname, i8** %ifname.addr, align 8
  store i8* %ofname, i8** %ofname.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1095028132, i32* %canary
  %i.addr = alloca i64*, align 8
  %hsize_reg.addr = alloca i32, align 4
  %disp.addr = alloca i32, align 4
  %fcode.addr = alloca i64, align 8
...
entry:
  %code = alloca i64, align 8
  %canary = alloca i32
  store i32 1860380097, i32* %canary
  %stackp = alloca i8*, align 8
  %finchar = alloca i32, align 4
  %oldcode = alloca i64, align 8
  %incode = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @output.14(i64 %code) #0 {
entry:
  %r_off = alloca i32, align 4
  %canary = alloca i32
  store i32 1485050665, i32* %canary
  %bp = alloca i8*, align 8
  %code.addr = alloca i64, align 8
  %bits = alloca i32, align 4
  store i64 %code, i64* %code.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @cl_hash.15(i64 %hsize) #0 {
entry:
  %m1 = alloca i64, align 8
  %i = alloca i64, align 8
  %htab_p = alloca i64*, align 8
  %canary = alloca i32
  store i32 479817410, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @decompress.16() #0 {
entry:
  %canary = alloca i32
  store i32 2022694994, i32* %canary
  %code = alloca i64, align 8
  %oldcode = alloca i64, align 8
  %incode = alloca i64, align 8
  %finchar = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @copystat.17(i8* %ifname, i8* %ofname) #0 {
entry:
  %mode = alloca i32, align 4
  %canary = alloca i32
  store i32 256124063, i32* %canary
  %timep = alloca %struct.utimbuf, align 8
  %ifname.addr = alloca i8*, align 8
  %statbuf = alloca %struct.stat, align 8
  %ofname.addr = alloca i8*, align 8
...
entry:
  %statbuf = alloca %struct.stat, align 8
  %canary = alloca i32
  store i32 873398518, i32* %canary
  %ifname.addr = alloca i8*, align 8
  %timep = alloca %struct.utimbuf, align 8
  %mode = alloca i32, align 4
  %ofname.addr = alloca i8*, align 8
...
entry:
  %canary = alloca i32
  store i32 2133580397, i32* %canary
...
entry:
  ...
  %fcode = alloca i64, align 8
  %canary = alloca i32
  store i32 1895905460, i32* %canary
  %hshift = alloca i32, align 4
  %c = alloca i32, align 4
  %ent = alloca i64, align 8
  %disp = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @getcode.21() #0 {
entry:
  %code = alloca i64, align 8
  %retval = alloca i64, align 8
  %bits = alloca i32, align 4
  %bp = alloca i8*, align 8
  %canary = alloca i32
  store i32 1127804710, i32* %canary
  %r_off = alloca i32, align 4
  store i8* getelementptr inbounds ([16 x i8], [16 x i8]* @getcode.buf, i64 0, i64 0), i8** %bp, align 8
  %0 = load i32, i32* @clear_flg, align 4
  %cmp = icmp sgt i32 %0, 0
...
entry:
  ...
  %i = alloca i64, align 8
  %canary = alloca i32
  store i32 1350903979, i32* %canary
  %c = alloca i32, align 4
  %hshift = alloca i32, align 4
  %ent = alloca i64, align 8
  %c95 = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @output.23(i64 %code) #0 {
entry:
  %bits = alloca i32, align 4
  %r_off = alloca i32, align 4
  %canary = alloca i32
  store i32 398473527, i32* %canary
  %code.addr = alloca i64, align 8
  %bp = alloca i8*, align 8
  store i64 %code, i64* %code.addr, align 8
  %0 = load i32, i32* @offset, align 4
...
entry:
  ...
  %bits = alloca i32, align 4
  %canary = alloca i32
  store i32 208673993, i32* %canary
  %r_off = alloca i32, align 4
  %bp = alloca i8*, align 8
  store i64 %code, i64* %code.addr, align 8
  %0 = load i32, i32* @offset, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @getcode.25() #0 {
entry:
  %retval = alloca i64, align 8
  %bp = alloca i8*, align 8
  %canary = alloca i32
  store i32 1585393659, i32* %canary
  %code = alloca i64, align 8
  %r_off = alloca i32, align 4
  %bits = alloca i32, align 4
  store i8* getelementptr inbounds ([16 x i8], [16 x i8]* @getcode.buf, i64 0, i64 0), i8** %bp, align 8
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 221126281, i32* %canary
  %hsize_reg.addr = alloca i32, align 4
  store i64* %i, i64** %i.addr, align 8
  store i64 %fcode, i64* %fcode.addr, align 8
  store i32 %disp, i32* %disp.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 1139159119, i32* %canary
  %fcode = alloca i64, align 8
  %hshift = alloca i32, align 4
  %hsize_reg = alloca i64, align 8
  %i = alloca i64, align 8
...
entry:
  %den.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1000985415, i32* %canary
  %q = alloca i32, align 4
  %num.addr = alloca i64, align 8
  %stream.addr = alloca %struct._IO_FILE*, align 8
  store %struct._IO_FILE* %stream, %struct._IO_FILE** %stream.addr, align 8
...
entry:
  %hsize.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1742132731, i32* %canary
  %m1 = alloca i64, align 8
  %htab_p = alloca i64*, align 8
  %i = alloca i64, align 8
  store i64 %hsize, i64* %hsize.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @prratio.30(%struct._IO_FILE* %stream, i64 %num, i64 %den) #0 {
entry:
  %canary = alloca i32
  store i32 1732494030, i32* %canary
  %q = alloca i32, align 4
  %stream.addr = alloca %struct._IO_FILE*, align 8
  %num.addr = alloca i64, align 8
  %den.addr = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @cl_hash.31(i64 %hsize) #0 {
entry:
  %htab_p = alloca i64*, align 8
  %hsize.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1052846169, i32* %canary
  %m1 = alloca i64, align 8
  %i = alloca i64, align 8
  store i64 %hsize, i64* %hsize.addr, align 8
  %0 = load i64, i64* %hsize.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @cl_hash.32(i64 %hsize) #0 {
entry:
  %m1 = alloca i64, align 8
  %i = alloca i64, align 8
  %canary = alloca i32
  store i32 932061081, i32* %canary
  %hsize.addr = alloca i64, align 8
  %htab_p = alloca i64*, align 8
  store i64 %hsize, i64* %hsize.addr, align 8
  %0 = load i64, i64* %hsize.addr, align 8
