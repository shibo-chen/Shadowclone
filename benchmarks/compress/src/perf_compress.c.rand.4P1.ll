; ModuleID = 'perf_compress.c.rand.4P1.bc'
...
func_copystat.24:                                 ; preds = %ctrl0
  call void @copystat.24(i8* %ifname, i8* %ofname)
  ret void

func_copystat.27:                                 ; preds = %ctrl1
  call void @copystat.27(i8* %ifname, i8* %ofname)
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_copystat.24, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_copystat.27, label %func_copystat.32
}
...
func_compress.4:                                  ; preds = %ctrl0
  call void @compress.4()
  ret void

func_compress.7:                                  ; preds = %ctrl1
  call void @compress.7()
  ret void

func_compress.9:                                  ; preds = %ctrl1
  call void @compress.9()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_compress.4, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_compress.7, label %func_compress.9
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_cl_hash.19, label %ctrl0

func_cl_hash.19:                                  ; preds = %rand_bb
...
func_cl_hash.28:                                  ; preds = %ctrl1
  call void @cl_hash.28(i64 %hsize)
  ret void

func_cl_hash.29:                                  ; preds = %ctrl1
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_cl_hash.28, label %func_cl_hash.29
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_scott_hack.14, label %ctrl0

func_scott_hack.14:                               ; preds = %rand_bb
  %2 = call i32 @scott_hack.14(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent)
  ret i32 %2
...
func_scott_hack.20:                               ; preds = %ctrl1
  %4 = call i32 @scott_hack.20(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent)
  ret i32 %4

func_scott_hack.23:                               ; preds = %ctrl1
  %5 = call i32 @scott_hack.23(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_scott_hack.17, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_scott_hack.20, label %func_scott_hack.23
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_output.1, label %ctrl0

func_output.1:                                    ; preds = %rand_bb
  call void @output.1(i64 %code)
  ret void
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_output.16, label %func_output.18
}
...
func_prratio.31:                                  ; preds = %ctrl1
  call void @prratio.31(%struct._IO_FILE* %stream, i64 %num, i64 %den)
  ret void
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_prratio.30, label %func_prratio.31
}
...
func_decompress.21:                               ; preds = %ctrl0
  call void @decompress.21()
  ret void

func_decompress.22:                               ; preds = %ctrl1
  call void @decompress.22()
  ret void

func_decompress.26:                               ; preds = %ctrl1
  call void @decompress.26()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_decompress.21, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_decompress.22, label %func_decompress.26
}
...
func_getcode.8:                                   ; preds = %ctrl0
  %3 = call i64 @getcode.8()
  ret i64 %3
...
func_getcode.13:                                  ; preds = %ctrl1
  %5 = call i64 @getcode.13()
  ret i64 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_getcode.8, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_getcode.12, label %func_getcode.13
}
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @output.1(i64 %code) #0 {
entry:
  %code.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1452465634, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1387547645, i32* %canary
...
entry:
  ...
  %bits = alloca i32, align 4
  %canary = alloca i32
  store i32 972050536, i32* %canary
  %bp = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @compress.4() #0 {
entry:
  %canary = alloca i32
  store i32 643371250, i32* %canary
  %ent = alloca i64, align 8
  %c95 = alloca i32, align 4
  %hshift = alloca i32, align 4
  %hsize_reg = alloca i64, align 8
...
entry:
  ...
  %canary = alloca i32
  store i32 401182057, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 219943184, i32* %canary
...
entry:
  ...
  %hshift = alloca i32, align 4
  %canary = alloca i32
  store i32 2067637226, i32* %canary
  %hsize_reg = alloca i64, align 8
  %c95 = alloca i32, align 4
  %c = alloca i32, align 4
  %ent = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @getcode.8() #0 {
entry:
  %retval = alloca i64, align 8
  %canary = alloca i32
  store i32 1990220327, i32* %canary
  %bits = alloca i32, align 4
  %bp = alloca i8*, align 8
  %r_off = alloca i32, align 4
  %code = alloca i64, align 8
...
entry:
  ...
  %fcode = alloca i64, align 8
  %canary = alloca i32
  store i32 1778043502, i32* %canary
  %hshift = alloca i32, align 4
  %disp = alloca i32, align 4
  %hsize_reg = alloca i64, align 8
  %c95 = alloca i32, align 4
...
entry:
  %stream.addr = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 833460498, i32* %canary
  %num.addr = alloca i64, align 8
  %den.addr = alloca i64, align 8
  %q = alloca i32, align 4
  store %struct._IO_FILE* %stream, %struct._IO_FILE** %stream.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1920676187, i32* %canary
  %bp = alloca i8*, align 8
  %bits = alloca i32, align 4
  %r_off = alloca i32, align 4
  %code.addr = alloca i64, align 8
...
entry:
  ...
  %retval = alloca i64, align 8
  %canary = alloca i32
  store i32 2126892318, i32* %canary
  %bp = alloca i8*, align 8
  %bits = alloca i32, align 4
  store i8* getelementptr inbounds ([16 x i8], [16 x i8]* @getcode.buf, i64 0, i64 0), i8** %bp, align 8
  %0 = load i32, i32* @clear_flg, align 4
...
entry:
  ...
  %code = alloca i64, align 8
  %canary = alloca i32
  store i32 1140757125, i32* %canary
  %r_off = alloca i32, align 4
  %retval = alloca i64, align 8
  store i8* getelementptr inbounds ([16 x i8], [16 x i8]* @getcode.buf, i64 0, i64 0), i8** %bp, align 8
  %0 = load i32, i32* @clear_flg, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @scott_hack.14(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent) #0 {
entry:
  %fcode.addr = alloca i64, align 8
  %disp.addr = alloca i32, align 4
  %hsize_reg.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 654896897, i32* %canary
  %retval = alloca i32, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 1350781530, i32* %canary
  %statbuf = alloca %struct.stat, align 8
...
entry:
  ...
  %disp.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1834478576, i32* %canary
  %retval = alloca i32, align 4
  %ent.addr = alloca i64*, align 8
  %i.addr = alloca i64*, align 8
  store i64* %i, i64** %i.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 571174005, i32* %canary
  %bp = alloca i8*, align 8
  %bits = alloca i32, align 4
  %code.addr = alloca i64, align 8
  %r_off = alloca i32, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 1838729393, i32* %canary
  %i = alloca i64, align 8
...
entry:
  ...
  %disp.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1875212088, i32* %canary
  %hsize_reg.addr = alloca i32, align 4
  store i64* %i, i64** %i.addr, align 8
  store i64 %fcode, i64* %fcode.addr, align 8
  store i32 %disp, i32* %disp.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 142975279, i32* %canary
  %finchar = alloca i32, align 4
  %code = alloca i64, align 8
  %oldcode = alloca i64, align 8
  %stackp = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @decompress.22() #0 {
entry:
  %code = alloca i64, align 8
  %canary = alloca i32
  store i32 500136902, i32* %canary
  %finchar = alloca i32, align 4
  %incode = alloca i64, align 8
  %stackp = alloca i8*, align 8
  %oldcode = alloca i64, align 8
...
entry:
  ...
  %disp.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 841558653, i32* %canary
  %fcode.addr = alloca i64, align 8
  %retval = alloca i32, align 4
  %ent.addr = alloca i64*, align 8
  %i.addr = alloca i64*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @copystat.24(i8* %ifname, i8* %ofname) #0 {
entry:
  %canary = alloca i32
  store i32 1966260729, i32* %canary
  %ofname.addr = alloca i8*, align 8
  %mode = alloca i32, align 4
  %timep = alloca %struct.utimbuf, align 8
  %statbuf = alloca %struct.stat, align 8
...
entry:
  %canary = alloca i32
  store i32 902266028, i32* %canary
  %htab_p = alloca i64*, align 8
  %m1 = alloca i64, align 8
  %hsize.addr = alloca i64, align 8
  %i = alloca i64, align 8
...
entry:
  ...
  %finchar = alloca i32, align 4
  %canary = alloca i32
  store i32 119105130, i32* %canary
  %code = alloca i64, align 8
  %oldcode = alloca i64, align 8
  %stackp = alloca i8*, align 8
  store i32 9, i32* @n_bits, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @copystat.27(i8* %ifname, i8* %ofname) #0 {
entry:
  %timep = alloca %struct.utimbuf, align 8
  %ifname.addr = alloca i8*, align 8
  %mode = alloca i32, align 4
  %canary = alloca i32
  store i32 199967720, i32* %canary
  %statbuf = alloca %struct.stat, align 8
  %ofname.addr = alloca i8*, align 8
  store i8* %ifname, i8** %ifname.addr, align 8
  store i8* %ofname, i8** %ofname.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @cl_hash.28(i64 %hsize) #0 {
entry:
  %m1 = alloca i64, align 8
  %canary = alloca i32
  store i32 1547040703, i32* %canary
  %i = alloca i64, align 8
  %hsize.addr = alloca i64, align 8
  %htab_p = alloca i64*, align 8
  store i64 %hsize, i64* %hsize.addr, align 8
...
entry:
  ...
  %m1 = alloca i64, align 8
  %canary = alloca i32
  store i32 841709287, i32* %canary
  %hsize.addr = alloca i64, align 8
  store i64 %hsize, i64* %hsize.addr, align 8
  %0 = load i64, i64* %hsize.addr, align 8
  %add.ptr = getelementptr inbounds i64, i64* getelementptr inbounds ([69001 x i64], [69001 x i64]* @htab, i64 0, i64 0), i64 %0
...
entry:
  %q = alloca i32, align 4
  %canary = alloca i32
  store i32 676467810, i32* %canary
  %stream.addr = alloca %struct._IO_FILE*, align 8
  %num.addr = alloca i64, align 8
  %den.addr = alloca i64, align 8
  store %struct._IO_FILE* %stream, %struct._IO_FILE** %stream.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @prratio.31(%struct._IO_FILE* %stream, i64 %num, i64 %den) #0 {
entry:
  %num.addr = alloca i64, align 8
  %stream.addr = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 1212269857, i32* %canary
  %den.addr = alloca i64, align 8
  %q = alloca i32, align 4
  store %struct._IO_FILE* %stream, %struct._IO_FILE** %stream.addr, align 8
  store i64 %num, i64* %num.addr, align 8
...
entry:
  ...
  %ofname.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 113704348, i32* %canary
  %statbuf = alloca %struct.stat, align 8
  %mode = alloca i32, align 4
  store i8* %ifname, i8** %ifname.addr, align 8
  store i8* %ofname, i8** %ofname.addr, align 8
