; ModuleID = 'perf_compress.c.rand.8R3.bc'
...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_copystat.2, label %ctrl0

func_copystat.2:                                  ; preds = %rand_bb
  call void @copystat.2(i8* %ifname, i8* %ofname)
  ret void
...
func_copystat.10:                                 ; preds = %ctrl2
  call void @copystat.10(i8* %ifname, i8* %ofname)
  ret void

func_copystat.12:                                 ; preds = %ctrl3
  call void @copystat.12(i8* %ifname, i8* %ofname)
  ret void

func_copystat.20:                                 ; preds = %ctrl4
  call void @copystat.20(i8* %ifname, i8* %ofname)
  ret void

func_copystat.25:                                 ; preds = %ctrl5
  call void @copystat.25(i8* %ifname, i8* %ofname)
  ret void

func_copystat.45:                                 ; preds = %ctrl5
  call void @copystat.45(i8* %ifname, i8* %ofname)
  ret void
...
ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_copystat.10, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_copystat.12, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_copystat.20, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_copystat.25, label %func_copystat.45
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_compress.22, label %ctrl0

func_compress.22:                                 ; preds = %rand_bb
  call void @compress.22()
  ret void

func_compress.44:                                 ; preds = %ctrl0
  call void @compress.44()
  ret void

func_compress.46:                                 ; preds = %ctrl1
  call void @compress.46()
  ret void

func_compress.48:                                 ; preds = %ctrl2
  call void @compress.48()
  ret void

func_compress.50:                                 ; preds = %ctrl3
  call void @compress.50()
  ret void

func_compress.53:                                 ; preds = %ctrl4
  call void @compress.53()
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_compress.44, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_compress.46, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_compress.48, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_compress.50, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_compress.53, label %ctrl5
...
func_cl_hash.51:                                  ; preds = %ctrl0
  call void @cl_hash.51(i64 %hsize)
  ret void

func_cl_hash.58:                                  ; preds = %ctrl1
  call void @cl_hash.58(i64 %hsize)
  ret void

func_cl_hash.60:                                  ; preds = %ctrl2
  call void @cl_hash.60(i64 %hsize)
  ret void

func_cl_hash.61:                                  ; preds = %ctrl3
  call void @cl_hash.61(i64 %hsize)
  ret void

func_cl_hash.62:                                  ; preds = %ctrl4
  call void @cl_hash.62(i64 %hsize)
  ret void

func_cl_hash.63:                                  ; preds = %ctrl5
  call void @cl_hash.63(i64 %hsize)
  ret void

func_cl_hash.64:                                  ; preds = %ctrl5
  call void @cl_hash.64(i64 %hsize)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_cl_hash.51, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_cl_hash.58, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_cl_hash.60, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_cl_hash.61, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_cl_hash.62, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_cl_hash.63, label %func_cl_hash.64
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_scott_hack.13, label %ctrl0

func_scott_hack.13:                               ; preds = %rand_bb
  %2 = call i32 @scott_hack.13(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent)
  ret i32 %2

func_scott_hack.15:                               ; preds = %ctrl0
  %3 = call i32 @scott_hack.15(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent)
  ret i32 %3

func_scott_hack.21:                               ; preds = %ctrl1
  %4 = call i32 @scott_hack.21(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent)
  ret i32 %4

func_scott_hack.32:                               ; preds = %ctrl2
  %5 = call i32 @scott_hack.32(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent)
  ret i32 %5

func_scott_hack.34:                               ; preds = %ctrl3
  %6 = call i32 @scott_hack.34(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent)
  ret i32 %6
...
func_scott_hack.37:                               ; preds = %ctrl5
  %8 = call i32 @scott_hack.37(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent)
  ret i32 %8

func_scott_hack.39:                               ; preds = %ctrl5
  %9 = call i32 @scott_hack.39(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent)
  ret i32 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_scott_hack.15, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_scott_hack.21, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_scott_hack.32, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_scott_hack.34, label %ctrl4
...
ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_scott_hack.37, label %func_scott_hack.39
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_output.5, label %ctrl0

func_output.5:                                    ; preds = %rand_bb
...
func_output.16:                                   ; preds = %ctrl1
  call void @output.16(i64 %code)
  ret void

func_output.17:                                   ; preds = %ctrl2
  call void @output.17(i64 %code)
  ret void

func_output.18:                                   ; preds = %ctrl3
  call void @output.18(i64 %code)
  ret void

func_output.19:                                   ; preds = %ctrl4
  call void @output.19(i64 %code)
  ret void

func_output.29:                                   ; preds = %ctrl5
  call void @output.29(i64 %code)
  ret void

func_output.38:                                   ; preds = %ctrl5
  call void @output.38(i64 %code)
  ret void
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_output.16, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_output.17, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_output.18, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_output.19, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_output.29, label %func_output.38
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_prratio.3, label %ctrl0

func_prratio.3:                                   ; preds = %rand_bb
  call void @prratio.3(%struct._IO_FILE* %stream, i64 %num, i64 %den)
  ret void

func_prratio.23:                                  ; preds = %ctrl0
  call void @prratio.23(%struct._IO_FILE* %stream, i64 %num, i64 %den)
  ret void

func_prratio.24:                                  ; preds = %ctrl1
  call void @prratio.24(%struct._IO_FILE* %stream, i64 %num, i64 %den)
  ret void

func_prratio.35:                                  ; preds = %ctrl2
  call void @prratio.35(%struct._IO_FILE* %stream, i64 %num, i64 %den)
  ret void

func_prratio.42:                                  ; preds = %ctrl3
  call void @prratio.42(%struct._IO_FILE* %stream, i64 %num, i64 %den)
  ret void

func_prratio.54:                                  ; preds = %ctrl4
  call void @prratio.54(%struct._IO_FILE* %stream, i64 %num, i64 %den)
  ret void

func_prratio.57:                                  ; preds = %ctrl5
  call void @prratio.57(%struct._IO_FILE* %stream, i64 %num, i64 %den)
  ret void

func_prratio.59:                                  ; preds = %ctrl5
  call void @prratio.59(%struct._IO_FILE* %stream, i64 %num, i64 %den)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_prratio.23, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_prratio.24, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_prratio.35, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_prratio.42, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_prratio.54, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_prratio.57, label %func_prratio.59
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_decompress.14, label %ctrl0

func_decompress.14:                               ; preds = %rand_bb
  call void @decompress.14()
  ret void
...
func_decompress.27:                               ; preds = %ctrl1
  call void @decompress.27()
  ret void

func_decompress.28:                               ; preds = %ctrl2
  call void @decompress.28()
  ret void

func_decompress.31:                               ; preds = %ctrl3
  call void @decompress.31()
  ret void

func_decompress.43:                               ; preds = %ctrl4
  call void @decompress.43()
  ret void

func_decompress.47:                               ; preds = %ctrl5
  call void @decompress.47()
  ret void

func_decompress.49:                               ; preds = %ctrl5
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_decompress.27, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_decompress.28, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_decompress.31, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_decompress.43, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_decompress.47, label %func_decompress.49
}
...
func_getcode.7:                                   ; preds = %ctrl0
  %3 = call i64 @getcode.7()
  ret i64 %3

func_getcode.9:                                   ; preds = %ctrl1
  %4 = call i64 @getcode.9()
  ret i64 %4

func_getcode.30:                                  ; preds = %ctrl2
  %5 = call i64 @getcode.30()
  ret i64 %5

func_getcode.33:                                  ; preds = %ctrl3
  %6 = call i64 @getcode.33()
  ret i64 %6

func_getcode.40:                                  ; preds = %ctrl4
  %7 = call i64 @getcode.40()
  ret i64 %7

func_getcode.41:                                  ; preds = %ctrl5
  %8 = call i64 @getcode.41()
  ret i64 %8

func_getcode.52:                                  ; preds = %ctrl5
  %9 = call i64 @getcode.52()
  ret i64 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_getcode.7, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_getcode.9, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_getcode.30, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_getcode.33, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_getcode.40, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_getcode.41, label %func_getcode.52
}
...
entry:
  ...
  %canary = alloca i32
  store i32 851269306, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @copystat.2(i8* %ifname, i8* %ofname) #0 {
entry:
  %timep = alloca %struct.utimbuf, align 8
  %canary = alloca i32
  store i32 747860810, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @prratio.3(%struct._IO_FILE* %stream, i64 %num, i64 %den) #0 {
entry:
  %stream.addr = alloca %struct._IO_FILE*, align 8
  %num.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 986643685, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 928531611, i32* %canary
...
entry:
  %r_off = alloca i32, align 4
  %canary = alloca i32
  store i32 788343829, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1966679119, i32* %canary
  %retval = alloca i64, align 8
  %r_off = alloca i32, align 4
  %code = alloca i64, align 8
  %bits = alloca i32, align 4
...
entry:
  ...
  %statbuf = alloca %struct.stat, align 8
  %canary = alloca i32
  store i32 726032002, i32* %canary
  %mode = alloca i32, align 4
  %ofname.addr = alloca i8*, align 8
  store i8* %ifname, i8** %ifname.addr, align 8
  store i8* %ofname, i8** %ofname.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @getcode.9() #0 {
entry:
  %canary = alloca i32
  store i32 109889583, i32* %canary
  %bp = alloca i8*, align 8
  %bits = alloca i32, align 4
  %code = alloca i64, align 8
  %r_off = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @copystat.10(i8* %ifname, i8* %ofname) #0 {
entry:
  %timep = alloca %struct.utimbuf, align 8
  %mode = alloca i32, align 4
  %canary = alloca i32
  store i32 1243741898, i32* %canary
  %ofname.addr = alloca i8*, align 8
  %ifname.addr = alloca i8*, align 8
  %statbuf = alloca %struct.stat, align 8
  store i8* %ifname, i8** %ifname.addr, align 8
...
entry:
  %bp = alloca i8*, align 8
  %canary = alloca i32
  store i32 2015724148, i32* %canary
  %r_off = alloca i32, align 4
  %bits = alloca i32, align 4
  %code.addr = alloca i64, align 8
  store i64 %code, i64* %code.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @copystat.12(i8* %ifname, i8* %ofname) #0 {
entry:
  %timep = alloca %struct.utimbuf, align 8
  %ofname.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 195930051, i32* %canary
  %ifname.addr = alloca i8*, align 8
  %statbuf = alloca %struct.stat, align 8
  %mode = alloca i32, align 4
  store i8* %ifname, i8** %ifname.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @scott_hack.13(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 920381529, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @decompress.14() #0 {
entry:
  %code = alloca i64, align 8
  %finchar = alloca i32, align 4
  %incode = alloca i64, align 8
  %canary = alloca i32
  store i32 1719858426, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @scott_hack.15(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent) #0 {
entry:
  %i.addr = alloca i64*, align 8
  %disp.addr = alloca i32, align 4
  %ent.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 1582136192, i32* %canary
  %hsize_reg.addr = alloca i32, align 4
  %fcode.addr = alloca i64, align 8
  %retval = alloca i32, align 4
  store i64* %i, i64** %i.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @output.16(i64 %code) #0 {
entry:
  %code.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 705445105, i32* %canary
  %bp = alloca i8*, align 8
  %r_off = alloca i32, align 4
  %bits = alloca i32, align 4
  store i64 %code, i64* %code.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @output.17(i64 %code) #0 {
entry:
  %code.addr = alloca i64, align 8
  %r_off = alloca i32, align 4
  %bp = alloca i8*, align 8
  %canary = alloca i32
  store i32 1152717123, i32* %canary
  %bits = alloca i32, align 4
  store i64 %code, i64* %code.addr, align 8
  %0 = load i32, i32* @offset, align 4
  store i32 %0, i32* %r_off, align 4
...
entry:
  ...
  %r_off = alloca i32, align 4
  %canary = alloca i32
  store i32 1113357684, i32* %canary
  %bp = alloca i8*, align 8
  store i64 %code, i64* %code.addr, align 8
  %0 = load i32, i32* @offset, align 4
  store i32 %0, i32* %r_off, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @output.19(i64 %code) #0 {
entry:
  %code.addr = alloca i64, align 8
  %bp = alloca i8*, align 8
  %canary = alloca i32
  store i32 1089214973, i32* %canary
  %bits = alloca i32, align 4
  %r_off = alloca i32, align 4
  store i64 %code, i64* %code.addr, align 8
  %0 = load i32, i32* @offset, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @copystat.20(i8* %ifname, i8* %ofname) #0 {
entry:
  %statbuf = alloca %struct.stat, align 8
  %mode = alloca i32, align 4
  %timep = alloca %struct.utimbuf, align 8
  %ofname.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 796727441, i32* %canary
  %ifname.addr = alloca i8*, align 8
  store i8* %ifname, i8** %ifname.addr, align 8
  store i8* %ofname, i8** %ofname.addr, align 8
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @scott_hack.21(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent) #0 {
entry:
  %ent.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 60800226, i32* %canary
  %fcode.addr = alloca i64, align 8
  %i.addr = alloca i64*, align 8
  %disp.addr = alloca i32, align 4
  %retval = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @compress.22() #0 {
entry:
  %hshift = alloca i32, align 4
  %hsize_reg = alloca i64, align 8
  %canary = alloca i32
  store i32 539534330, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @prratio.23(%struct._IO_FILE* %stream, i64 %num, i64 %den) #0 {
entry:
  %stream.addr = alloca %struct._IO_FILE*, align 8
  %den.addr = alloca i64, align 8
  %q = alloca i32, align 4
  %canary = alloca i32
  store i32 914402319, i32* %canary
  %num.addr = alloca i64, align 8
  store %struct._IO_FILE* %stream, %struct._IO_FILE** %stream.addr, align 8
  store i64 %num, i64* %num.addr, align 8
  store i64 %den, i64* %den.addr, align 8
...
entry:
  ...
  %stream.addr = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 1272635379, i32* %canary
  %num.addr = alloca i64, align 8
  %q = alloca i32, align 4
  store %struct._IO_FILE* %stream, %struct._IO_FILE** %stream.addr, align 8
  store i64 %num, i64* %num.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @copystat.25(i8* %ifname, i8* %ofname) #0 {
entry:
  %timep = alloca %struct.utimbuf, align 8
  %canary = alloca i32
  store i32 526229763, i32* %canary
  %ifname.addr = alloca i8*, align 8
  %statbuf = alloca %struct.stat, align 8
  %mode = alloca i32, align 4
  %ofname.addr = alloca i8*, align 8
...
entry:
  %code = alloca i64, align 8
  %canary = alloca i32
  store i32 1879676033, i32* %canary
  %incode = alloca i64, align 8
  %oldcode = alloca i64, align 8
  %stackp = alloca i8*, align 8
  %finchar = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @decompress.27() #0 {
entry:
  %stackp = alloca i8*, align 8
  %canary = alloca i32
  store i32 763924599, i32* %canary
  %finchar = alloca i32, align 4
  %code = alloca i64, align 8
  %incode = alloca i64, align 8
  %oldcode = alloca i64, align 8
...
entry:
  ...
  %finchar = alloca i32, align 4
  %canary = alloca i32
  store i32 650987873, i32* %canary
  %incode = alloca i64, align 8
  store i32 9, i32* @n_bits, align 4
  store i64 511, i64* @maxcode, align 8
  store i64 255, i64* %code, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @output.29(i64 %code) #0 {
entry:
  %bits = alloca i32, align 4
  %code.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 40893303, i32* %canary
  %bp = alloca i8*, align 8
  %r_off = alloca i32, align 4
  store i64 %code, i64* %code.addr, align 8
  %0 = load i32, i32* @offset, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @getcode.30() #0 {
entry:
  %code = alloca i64, align 8
  %bp = alloca i8*, align 8
  %canary = alloca i32
  store i32 200543461, i32* %canary
  %bits = alloca i32, align 4
  %r_off = alloca i32, align 4
  %retval = alloca i64, align 8
  store i8* getelementptr inbounds ([16 x i8], [16 x i8]* @getcode.buf, i64 0, i64 0), i8** %bp, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @decompress.31() #0 {
entry:
  %incode = alloca i64, align 8
  %code = alloca i64, align 8
  %oldcode = alloca i64, align 8
  %finchar = alloca i32, align 4
  %canary = alloca i32
  store i32 1702996725, i32* %canary
  %stackp = alloca i8*, align 8
  store i32 9, i32* @n_bits, align 4
  store i64 511, i64* @maxcode, align 8
  store i64 255, i64* %code, align 8
...
entry:
  ...
  %disp.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1290926107, i32* %canary
  %hsize_reg.addr = alloca i32, align 4
  %fcode.addr = alloca i64, align 8
  %i.addr = alloca i64*, align 8
  %ent.addr = alloca i64*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @getcode.33() #0 {
entry:
  %r_off = alloca i32, align 4
  %bits = alloca i32, align 4
  %bp = alloca i8*, align 8
  %code = alloca i64, align 8
  %canary = alloca i32
  store i32 137226253, i32* %canary
  %retval = alloca i64, align 8
  store i8* getelementptr inbounds ([16 x i8], [16 x i8]* @getcode.buf, i64 0, i64 0), i8** %bp, align 8
  %0 = load i32, i32* @clear_flg, align 4
  %cmp = icmp sgt i32 %0, 0
...
entry:
  ...
  %i.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 2130620880, i32* %canary
  %hsize_reg.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  %disp.addr = alloca i32, align 4
  store i64* %i, i64** %i.addr, align 8
...
entry:
  ...
  %num.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 721092043, i32* %canary
  %stream.addr = alloca %struct._IO_FILE*, align 8
  store %struct._IO_FILE* %stream, %struct._IO_FILE** %stream.addr, align 8
  store i64 %num, i64* %num.addr, align 8
  store i64 %den, i64* %den.addr, align 8
...
entry:
  %i.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 1327488294, i32* %canary
  %disp.addr = alloca i32, align 4
  %hsize_reg.addr = alloca i32, align 4
  %ent.addr = alloca i64*, align 8
  %retval = alloca i32, align 4
...
entry:
  ...
  %i.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 948407457, i32* %canary
  %hsize_reg.addr = alloca i32, align 4
  %ent.addr = alloca i64*, align 8
  %disp.addr = alloca i32, align 4
  store i64* %i, i64** %i.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @output.38(i64 %code) #0 {
entry:
  %bp = alloca i8*, align 8
  %code.addr = alloca i64, align 8
  %r_off = alloca i32, align 4
  %canary = alloca i32
  store i32 513438179, i32* %canary
  %bits = alloca i32, align 4
  store i64 %code, i64* %code.addr, align 8
  %0 = load i32, i32* @offset, align 4
  store i32 %0, i32* %r_off, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @scott_hack.39(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent) #0 {
entry:
  %retval = alloca i32, align 4
  %fcode.addr = alloca i64, align 8
  %ent.addr = alloca i64*, align 8
  %i.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 2144237736, i32* %canary
  %disp.addr = alloca i32, align 4
  %hsize_reg.addr = alloca i32, align 4
  store i64* %i, i64** %i.addr, align 8
  store i64 %fcode, i64* %fcode.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @getcode.40() #0 {
entry:
  %r_off = alloca i32, align 4
  %bp = alloca i8*, align 8
  %code = alloca i64, align 8
  %canary = alloca i32
  store i32 55256289, i32* %canary
  %retval = alloca i64, align 8
  %bits = alloca i32, align 4
  store i8* getelementptr inbounds ([16 x i8], [16 x i8]* @getcode.buf, i64 0, i64 0), i8** %bp, align 8
  %0 = load i32, i32* @clear_flg, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @getcode.41() #0 {
entry:
  %bp = alloca i8*, align 8
  %code = alloca i64, align 8
  %canary = alloca i32
  store i32 1157382882, i32* %canary
  %r_off = alloca i32, align 4
  %retval = alloca i64, align 8
  %bits = alloca i32, align 4
  store i8* getelementptr inbounds ([16 x i8], [16 x i8]* @getcode.buf, i64 0, i64 0), i8** %bp, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @prratio.42(%struct._IO_FILE* %stream, i64 %num, i64 %den) #0 {
entry:
  %num.addr = alloca i64, align 8
  %q = alloca i32, align 4
  %den.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1891004124, i32* %canary
  %stream.addr = alloca %struct._IO_FILE*, align 8
  store %struct._IO_FILE* %stream, %struct._IO_FILE** %stream.addr, align 8
  store i64 %num, i64* %num.addr, align 8
  store i64 %den, i64* %den.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @decompress.43() #0 {
entry:
  %oldcode = alloca i64, align 8
  %code = alloca i64, align 8
  %canary = alloca i32
  store i32 830552192, i32* %canary
  %stackp = alloca i8*, align 8
  %incode = alloca i64, align 8
  %finchar = alloca i32, align 4
  store i32 9, i32* @n_bits, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @compress.44() #0 {
entry:
  %hsize_reg = alloca i64, align 8
  %c95 = alloca i32, align 4
  %disp = alloca i32, align 4
  ...
  %c = alloca i32, align 4
  %canary = alloca i32
  store i32 1201185894, i32* %canary
  %i = alloca i64, align 8
  %hshift = alloca i32, align 4
  %ent = alloca i64, align 8
  store i64 0, i64* %i, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @copystat.45(i8* %ifname, i8* %ofname) #0 {
entry:
  %statbuf = alloca %struct.stat, align 8
  %mode = alloca i32, align 4
  %canary = alloca i32
  store i32 792281950, i32* %canary
  %timep = alloca %struct.utimbuf, align 8
  %ifname.addr = alloca i8*, align 8
  %ofname.addr = alloca i8*, align 8
  store i8* %ifname, i8** %ifname.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @compress.46() #0 {
entry:
  %c = alloca i32, align 4
  %fcode = alloca i64, align 8
  %ent = alloca i64, align 8
  ...
  %c95 = alloca i32, align 4
  %canary = alloca i32
  store i32 2000202399, i32* %canary
  %hshift = alloca i32, align 4
  %hsize_reg = alloca i64, align 8
  store i64 0, i64* %i, align 8
  %0 = load i32, i32* @nomagic, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @decompress.47() #0 {
entry:
  %stackp = alloca i8*, align 8
  %canary = alloca i32
  store i32 659441812, i32* %canary
  %code = alloca i64, align 8
  %oldcode = alloca i64, align 8
  %finchar = alloca i32, align 4
  %incode = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @compress.48() #0 {
entry:
  %canary = alloca i32
  store i32 1777288584, i32* %canary
  %disp = alloca i32, align 4
  %c = alloca i32, align 4
  %i = alloca i64, align 8
  %hsize_reg = alloca i64, align 8
...
entry:
  ...
  %code = alloca i64, align 8
  %canary = alloca i32
  store i32 1401009485, i32* %canary
  %stackp = alloca i8*, align 8
  %finchar = alloca i32, align 4
  store i32 9, i32* @n_bits, align 4
  store i64 511, i64* @maxcode, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @compress.50() #0 {
entry:
  %hshift = alloca i32, align 4
  %hsize_reg = alloca i64, align 8
  %ent = alloca i64, align 8
  ...
  %c95 = alloca i32, align 4
  %canary = alloca i32
  store i32 1196106605, i32* %canary
  %c = alloca i32, align 4
  %fcode = alloca i64, align 8
  store i64 0, i64* %i, align 8
  %0 = load i32, i32* @nomagic, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @cl_hash.51(i64 %hsize) #0 {
entry:
  %canary = alloca i32
  store i32 658767197, i32* %canary
  %hsize.addr = alloca i64, align 8
  %i = alloca i64, align 8
  %m1 = alloca i64, align 8
  %htab_p = alloca i64*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @getcode.52() #0 {
entry:
  %canary = alloca i32
  store i32 263749288, i32* %canary
  %bits = alloca i32, align 4
  %r_off = alloca i32, align 4
  %retval = alloca i64, align 8
  %bp = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @compress.53() #0 {
entry:
  %ent = alloca i64, align 8
  %i = alloca i64, align 8
  %canary = alloca i32
  store i32 2034078015, i32* %canary
  %c = alloca i32, align 4
  %fcode = alloca i64, align 8
  %hshift = alloca i32, align 4
  %disp = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @prratio.54(%struct._IO_FILE* %stream, i64 %num, i64 %den) #0 {
entry:
  %canary = alloca i32
  store i32 57615354, i32* %canary
  %stream.addr = alloca %struct._IO_FILE*, align 8
  %q = alloca i32, align 4
  %den.addr = alloca i64, align 8
  %num.addr = alloca i64, align 8
...
entry:
  %canary = alloca i32
  store i32 1329446291, i32* %canary
  %hshift = alloca i32, align 4
  %c95 = alloca i32, align 4
  %hsize_reg = alloca i64, align 8
  %fcode = alloca i64, align 8
...
entry:
  %disp = alloca i32, align 4
  %canary = alloca i32
  store i32 931975388, i32* %canary
  %c95 = alloca i32, align 4
  %fcode = alloca i64, align 8
  %hshift = alloca i32, align 4
  %i = alloca i64, align 8
...
entry:
  %q = alloca i32, align 4
  %canary = alloca i32
  store i32 1800450154, i32* %canary
  %num.addr = alloca i64, align 8
  %stream.addr = alloca %struct._IO_FILE*, align 8
  %den.addr = alloca i64, align 8
  store %struct._IO_FILE* %stream, %struct._IO_FILE** %stream.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @cl_hash.58(i64 %hsize) #0 {
entry:
  %canary = alloca i32
  store i32 2091005751, i32* %canary
  %m1 = alloca i64, align 8
  %i = alloca i64, align 8
  %htab_p = alloca i64*, align 8
  %hsize.addr = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @prratio.59(%struct._IO_FILE* %stream, i64 %num, i64 %den) #0 {
entry:
  %num.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1283699695, i32* %canary
  %q = alloca i32, align 4
  %stream.addr = alloca %struct._IO_FILE*, align 8
  %den.addr = alloca i64, align 8
  store %struct._IO_FILE* %stream, %struct._IO_FILE** %stream.addr, align 8
...
entry:
  %m1 = alloca i64, align 8
  %canary = alloca i32
  store i32 1131844370, i32* %canary
  %i = alloca i64, align 8
  %hsize.addr = alloca i64, align 8
  %htab_p = alloca i64*, align 8
  store i64 %hsize, i64* %hsize.addr, align 8
...
entry:
  %m1 = alloca i64, align 8
  %canary = alloca i32
  store i32 707591623, i32* %canary
  %hsize.addr = alloca i64, align 8
  %i = alloca i64, align 8
  %htab_p = alloca i64*, align 8
  store i64 %hsize, i64* %hsize.addr, align 8
...
entry:
  %hsize.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 2011068564, i32* %canary
  %htab_p = alloca i64*, align 8
  %m1 = alloca i64, align 8
  %i = alloca i64, align 8
  store i64 %hsize, i64* %hsize.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @cl_hash.63(i64 %hsize) #0 {
entry:
  %canary = alloca i32
  store i32 2105290509, i32* %canary
  %i = alloca i64, align 8
  %hsize.addr = alloca i64, align 8
  %htab_p = alloca i64*, align 8
  %m1 = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @cl_hash.64(i64 %hsize) #0 {
entry:
  %htab_p = alloca i64*, align 8
  %i = alloca i64, align 8
  %m1 = alloca i64, align 8
  %canary = alloca i32
  store i32 2028736521, i32* %canary
  %hsize.addr = alloca i64, align 8
  store i64 %hsize, i64* %hsize.addr, align 8
  %0 = load i64, i64* %hsize.addr, align 8
  %add.ptr = getelementptr inbounds i64, i64* getelementptr inbounds ([69001 x i64], [69001 x i64]* @htab, i64 0, i64 0), i64 %0
