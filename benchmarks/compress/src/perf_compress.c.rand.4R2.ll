; ModuleID = 'perf_compress.c.rand.4R2.bc'
...
func_copystat.8:                                  ; preds = %ctrl0
  call void @copystat.8(i8* %ifname, i8* %ofname)
  ret void

func_copystat.9:                                  ; preds = %ctrl1
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_copystat.8, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_copystat.9, label %func_copystat.17
}
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_compress.18, label %func_compress.21
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_cl_hash.29, label %ctrl0

func_cl_hash.29:                                  ; preds = %rand_bb
  call void @cl_hash.29(i64 %hsize)
  ret void

func_cl_hash.30:                                  ; preds = %ctrl0
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_cl_hash.30, label %ctrl1
...
func_scott_hack.16:                               ; preds = %ctrl1
  %4 = call i32 @scott_hack.16(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent)
  ret i32 %4
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_scott_hack.12, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_scott_hack.16, label %func_scott_hack.19
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_output.4, label %ctrl0

func_output.4:                                    ; preds = %rand_bb
  call void @output.4(i64 %code)
  ret void

func_output.22:                                   ; preds = %ctrl0
...
func_output.26:                                   ; preds = %ctrl1
  call void @output.26(i64 %code)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_output.22, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_output.24, label %func_output.26
}
...
func_prratio.7:                                   ; preds = %ctrl0
  call void @prratio.7(%struct._IO_FILE* %stream, i64 %num, i64 %den)
  ret void

func_prratio.11:                                  ; preds = %ctrl1
  call void @prratio.11(%struct._IO_FILE* %stream, i64 %num, i64 %den)
  ret void

func_prratio.13:                                  ; preds = %ctrl1
  call void @prratio.13(%struct._IO_FILE* %stream, i64 %num, i64 %den)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_prratio.7, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_prratio.11, label %func_prratio.13
}
...
func_decompress.10:                               ; preds = %ctrl0
  call void @decompress.10()
  ret void

func_decompress.15:                               ; preds = %ctrl1
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_decompress.10, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_decompress.15, label %func_decompress.23
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_getcode.20, label %ctrl0

func_getcode.20:                                  ; preds = %rand_bb
  %2 = call i64 @getcode.20()
  ret i64 %2

func_getcode.25:                                  ; preds = %ctrl0
  %3 = call i64 @getcode.25()
  ret i64 %3

func_getcode.27:                                  ; preds = %ctrl1
  %4 = call i64 @getcode.27()
  ret i64 %4

func_getcode.28:                                  ; preds = %ctrl1
  %5 = call i64 @getcode.28()
  ret i64 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_getcode.25, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_getcode.27, label %func_getcode.28
}
...
entry:
  %canary = alloca i32
  store i32 677353166, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 988158357, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 220376520, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @output.4(i64 %code) #0 {
entry:
  %bp = alloca i8*, align 8
  %r_off = alloca i32, align 4
  %code.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1218006280, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 658589518, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @compress.6() #0 {
entry:
  ...
  %canary = alloca i32
  store i32 2105560383, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @prratio.7(%struct._IO_FILE* %stream, i64 %num, i64 %den) #0 {
entry:
  %canary = alloca i32
  store i32 1242453821, i32* %canary
  %stream.addr = alloca %struct._IO_FILE*, align 8
  %den.addr = alloca i64, align 8
  %q = alloca i32, align 4
  %num.addr = alloca i64, align 8
...
entry:
  ...
  %ofname.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1749970718, i32* %canary
  %mode = alloca i32, align 4
  %ifname.addr = alloca i8*, align 8
  %statbuf = alloca %struct.stat, align 8
  store i8* %ifname, i8** %ifname.addr, align 8
...
entry:
  %timep = alloca %struct.utimbuf, align 8
  %canary = alloca i32
  store i32 2068165321, i32* %canary
  %ifname.addr = alloca i8*, align 8
  %mode = alloca i32, align 4
  %statbuf = alloca %struct.stat, align 8
  %ofname.addr = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @decompress.10() #0 {
entry:
  %oldcode = alloca i64, align 8
  %stackp = alloca i8*, align 8
  %incode = alloca i64, align 8
  %code = alloca i64, align 8
  %canary = alloca i32
  store i32 1902637923, i32* %canary
  %finchar = alloca i32, align 4
  store i32 9, i32* @n_bits, align 4
  store i64 511, i64* @maxcode, align 8
  store i64 255, i64* %code, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @prratio.11(%struct._IO_FILE* %stream, i64 %num, i64 %den) #0 {
entry:
  %stream.addr = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 392092870, i32* %canary
  %q = alloca i32, align 4
  %num.addr = alloca i64, align 8
  %den.addr = alloca i64, align 8
  store %struct._IO_FILE* %stream, %struct._IO_FILE** %stream.addr, align 8
...
entry:
  %i.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 1606823786, i32* %canary
  %retval = alloca i32, align 4
  %ent.addr = alloca i64*, align 8
  %fcode.addr = alloca i64, align 8
  %disp.addr = alloca i32, align 4
...
entry:
  ...
  %den.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1746189845, i32* %canary
  %num.addr = alloca i64, align 8
  %stream.addr = alloca %struct._IO_FILE*, align 8
  store %struct._IO_FILE* %stream, %struct._IO_FILE** %stream.addr, align 8
  store i64 %num, i64* %num.addr, align 8
...
entry:
  ...
  %ent = alloca i64, align 8
  %canary = alloca i32
  store i32 124538270, i32* %canary
  %i = alloca i64, align 8
  %c = alloca i32, align 4
  %fcode = alloca i64, align 8
  %hshift = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1308010906, i32* %canary
  %finchar = alloca i32, align 4
  %stackp = alloca i8*, align 8
  %oldcode = alloca i64, align 8
  %code = alloca i64, align 8
...
entry:
  %canary = alloca i32
  store i32 1511286892, i32* %canary
  %fcode.addr = alloca i64, align 8
  %hsize_reg.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  %ent.addr = alloca i64*, align 8
...
entry:
  %canary = alloca i32
  store i32 327173737, i32* %canary
  %ifname.addr = alloca i8*, align 8
  %timep = alloca %struct.utimbuf, align 8
  %ofname.addr = alloca i8*, align 8
  %mode = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 605897566, i32* %canary
  %ent = alloca i64, align 8
  %disp = alloca i32, align 4
  %hsize_reg = alloca i64, align 8
  %c95 = alloca i32, align 4
...
entry:
  ...
  %hsize_reg.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1847027246, i32* %canary
  %i.addr = alloca i64*, align 8
  %ent.addr = alloca i64*, align 8
  %fcode.addr = alloca i64, align 8
  store i64* %i, i64** %i.addr, align 8
...
entry:
  %code = alloca i64, align 8
  %canary = alloca i32
  store i32 1141731306, i32* %canary
  %bits = alloca i32, align 4
  %bp = alloca i8*, align 8
...
entry:
  ...
  %hsize_reg = alloca i64, align 8
  %canary = alloca i32
  store i32 1986532518, i32* %canary
  %disp = alloca i32, align 4
  %i = alloca i64, align 8
  %c = alloca i32, align 4
  store i64 0, i64* %i, align 8
...
entry:
  ...
  %r_off = alloca i32, align 4
  %canary = alloca i32
  store i32 1583742654, i32* %canary
  %bits = alloca i32, align 4
  %code.addr = alloca i64, align 8
  store i64 %code, i64* %code.addr, align 8
  %0 = load i32, i32* @offset, align 4
...
entry:
  ...
  %code = alloca i64, align 8
  %canary = alloca i32
  store i32 411935733, i32* %canary
  %finchar = alloca i32, align 4
  %oldcode = alloca i64, align 8
  store i32 9, i32* @n_bits, align 4
  store i64 511, i64* @maxcode, align 8
...
entry:
  ...
  %bp = alloca i8*, align 8
  %canary = alloca i32
  store i32 527887094, i32* %canary
  %code.addr = alloca i64, align 8
  store i64 %code, i64* %code.addr, align 8
  %0 = load i32, i32* @offset, align 4
  store i32 %0, i32* %r_off, align 4
...
entry:
  ...
  %code = alloca i64, align 8
  %canary = alloca i32
  store i32 921794240, i32* %canary
  %bp = alloca i8*, align 8
  store i8* getelementptr inbounds ([16 x i8], [16 x i8]* @getcode.buf, i64 0, i64 0), i8** %bp, align 8
  %0 = load i32, i32* @clear_flg, align 4
  %cmp = icmp sgt i32 %0, 0
...
entry:
  %code.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 593981469, i32* %canary
  %r_off = alloca i32, align 4
  %bits = alloca i32, align 4
  %bp = alloca i8*, align 8
  store i64 %code, i64* %code.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @getcode.27() #0 {
entry:
  %r_off = alloca i32, align 4
  %canary = alloca i32
  store i32 1068875270, i32* %canary
  %code = alloca i64, align 8
  %retval = alloca i64, align 8
  %bp = alloca i8*, align 8
  %bits = alloca i32, align 4
...
entry:
  ...
  %r_off = alloca i32, align 4
  %canary = alloca i32
  store i32 112353864, i32* %canary
  %retval = alloca i64, align 8
  %bp = alloca i8*, align 8
  %bits = alloca i32, align 4
  store i8* getelementptr inbounds ([16 x i8], [16 x i8]* @getcode.buf, i64 0, i64 0), i8** %bp, align 8
...
entry:
  ...
  %canary = alloca i32
  store i32 1684194853, i32* %canary
  %i = alloca i64, align 8
...
entry:
  ...
  %htab_p = alloca i64*, align 8
  %canary = alloca i32
  store i32 719731164, i32* %canary
  %i = alloca i64, align 8
  store i64 %hsize, i64* %hsize.addr, align 8
  %0 = load i64, i64* %hsize.addr, align 8
  %add.ptr = getelementptr inbounds i64, i64* getelementptr inbounds ([69001 x i64], [69001 x i64]* @htab, i64 0, i64 0), i64 %0
...
entry:
  ...
  %htab_p = alloca i64*, align 8
  %canary = alloca i32
  store i32 450396077, i32* %canary
  %hsize.addr = alloca i64, align 8
  store i64 %hsize, i64* %hsize.addr, align 8
  %0 = load i64, i64* %hsize.addr, align 8
  %add.ptr = getelementptr inbounds i64, i64* getelementptr inbounds ([69001 x i64], [69001 x i64]* @htab, i64 0, i64 0), i64 %0
...
entry:
  %canary = alloca i32
  store i32 1960952059, i32* %canary
  %i = alloca i64, align 8
  %m1 = alloca i64, align 8
  %htab_p = alloca i64*, align 8
  %hsize.addr = alloca i64, align 8
