; ModuleID = 'perf_compress.c.rand.4R3.bc'
...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_copystat.1, label %ctrl0

func_copystat.1:                                  ; preds = %rand_bb
  call void @copystat.1(i8* %ifname, i8* %ofname)
  ret void

func_copystat.3:                                  ; preds = %ctrl0
  call void @copystat.3(i8* %ifname, i8* %ofname)
  ret void

func_copystat.4:                                  ; preds = %ctrl1
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_copystat.3, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_copystat.4, label %func_copystat.18
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_compress.21, label %ctrl0

func_compress.21:                                 ; preds = %rand_bb
  call void @compress.21()
  ret void

func_compress.26:                                 ; preds = %ctrl0
  call void @compress.26()
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_compress.26, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_compress.28, label %func_compress.29
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_cl_hash.12, label %ctrl0

func_cl_hash.12:                                  ; preds = %rand_bb
...
func_scott_hack.11:                               ; preds = %ctrl0
  %3 = call i32 @scott_hack.11(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent)
  ret i32 %3

func_scott_hack.15:                               ; preds = %ctrl1
  %4 = call i32 @scott_hack.15(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent)
  ret i32 %4

func_scott_hack.17:                               ; preds = %ctrl1
  %5 = call i32 @scott_hack.17(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_scott_hack.11, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_scott_hack.15, label %func_scott_hack.17
}
...
func_output.31:                                   ; preds = %ctrl1
  call void @output.31(i64 %code)
  ret void

func_output.32:                                   ; preds = %ctrl1
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_output.31, label %func_output.32
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_prratio.7, label %ctrl0

func_prratio.7:                                   ; preds = %rand_bb
  call void @prratio.7(%struct._IO_FILE* %stream, i64 %num, i64 %den)
  ret void

func_prratio.9:                                   ; preds = %ctrl0
  call void @prratio.9(%struct._IO_FILE* %stream, i64 %num, i64 %den)
  ret void
...
func_prratio.19:                                  ; preds = %ctrl1
  call void @prratio.19(%struct._IO_FILE* %stream, i64 %num, i64 %den)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_prratio.9, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_prratio.14, label %func_prratio.19
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_decompress.13, label %ctrl0

func_decompress.13:                               ; preds = %rand_bb
  call void @decompress.13()
  ret void

func_decompress.16:                               ; preds = %ctrl0
...
func_decompress.24:                               ; preds = %ctrl1
  call void @decompress.24()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_decompress.16, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_decompress.23, label %func_decompress.24
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_getcode.6, label %ctrl0

func_getcode.6:                                   ; preds = %rand_bb
  %2 = call i64 @getcode.6()
  ret i64 %2

func_getcode.10:                                  ; preds = %ctrl0
  %3 = call i64 @getcode.10()
  ret i64 %3
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_getcode.10, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_getcode.20, label %func_getcode.22
}
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @copystat.1(i8* %ifname, i8* %ofname) #0 {
entry:
  %mode = alloca i32, align 4
  %canary = alloca i32
  store i32 503201540, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1108813787, i32* %canary
...
entry:
  ...
  %timep = alloca %struct.utimbuf, align 8
  %canary = alloca i32
  store i32 636326438, i32* %canary
  %mode = alloca i32, align 4
  store i8* %ifname, i8** %ifname.addr, align 8
  store i8* %ofname, i8** %ofname.addr, align 8
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8
...
entry:
  %statbuf = alloca %struct.stat, align 8
  %canary = alloca i32
  store i32 1956306276, i32* %canary
  %ofname.addr = alloca i8*, align 8
  %mode = alloca i32, align 4
  %ifname.addr = alloca i8*, align 8
  %timep = alloca %struct.utimbuf, align 8
...
entry:
  ...
  %canary = alloca i32
  store i32 734780112, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1088504637, i32* %canary
  %r_off = alloca i32, align 4
  %bits = alloca i32, align 4
  %bp = alloca i8*, align 8
...
entry:
  ...
  %canary = alloca i32
  store i32 859264731, i32* %canary
...
entry:
  ...
  %bits = alloca i32, align 4
  %canary = alloca i32
  store i32 1689350894, i32* %canary
  %bp = alloca i8*, align 8
  store i64 %code, i64* %code.addr, align 8
  %0 = load i32, i32* @offset, align 4
  store i32 %0, i32* %r_off, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @prratio.9(%struct._IO_FILE* %stream, i64 %num, i64 %den) #0 {
entry:
  %stream.addr = alloca %struct._IO_FILE*, align 8
  %num.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 214908352, i32* %canary
  %den.addr = alloca i64, align 8
  %q = alloca i32, align 4
  store %struct._IO_FILE* %stream, %struct._IO_FILE** %stream.addr, align 8
  store i64 %num, i64* %num.addr, align 8
...
entry:
  ...
  %bp = alloca i8*, align 8
  %canary = alloca i32
  store i32 1825308875, i32* %canary
  %r_off = alloca i32, align 4
  store i8* getelementptr inbounds ([16 x i8], [16 x i8]* @getcode.buf, i64 0, i64 0), i8** %bp, align 8
  %0 = load i32, i32* @clear_flg, align 4
  %cmp = icmp sgt i32 %0, 0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @scott_hack.11(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent) #0 {
entry:
  %i.addr = alloca i64*, align 8
  %retval = alloca i32, align 4
  %disp.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1231790472, i32* %canary
  %hsize_reg.addr = alloca i32, align 4
  %fcode.addr = alloca i64, align 8
  %ent.addr = alloca i64*, align 8
  store i64* %i, i64** %i.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1582320193, i32* %canary
...
entry:
  ...
  %code = alloca i64, align 8
  %canary = alloca i32
  store i32 629509275, i32* %canary
...
entry:
  ...
  %q = alloca i32, align 4
  %canary = alloca i32
  store i32 1469208392, i32* %canary
  %den.addr = alloca i64, align 8
  store %struct._IO_FILE* %stream, %struct._IO_FILE** %stream.addr, align 8
  store i64 %num, i64* %num.addr, align 8
  store i64 %den, i64* %den.addr, align 8
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1066068820, i32* %canary
  %i.addr = alloca i64*, align 8
  %ent.addr = alloca i64*, align 8
  %hsize_reg.addr = alloca i32, align 4
  store i64* %i, i64** %i.addr, align 8
...
entry:
  ...
  %incode = alloca i64, align 8
  %canary = alloca i32
  store i32 355746162, i32* %canary
  %oldcode = alloca i64, align 8
  %finchar = alloca i32, align 4
  store i32 9, i32* @n_bits, align 4
  store i64 511, i64* @maxcode, align 8
...
entry:
  ...
  %ent.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 1794101875, i32* %canary
  %hsize_reg.addr = alloca i32, align 4
  %i.addr = alloca i64*, align 8
  %fcode.addr = alloca i64, align 8
  %disp.addr = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1711671551, i32* %canary
  %q = alloca i32, align 4
  %den.addr = alloca i64, align 8
  %stream.addr = alloca %struct._IO_FILE*, align 8
  %num.addr = alloca i64, align 8
...
entry:
  ...
  %r_off = alloca i32, align 4
  %canary = alloca i32
  store i32 1059304271, i32* %canary
  %bp = alloca i8*, align 8
  %retval = alloca i64, align 8
  %bits = alloca i32, align 4
  store i8* getelementptr inbounds ([16 x i8], [16 x i8]* @getcode.buf, i64 0, i64 0), i8** %bp, align 8
...
entry:
  ...
  %incode = alloca i64, align 8
  %canary = alloca i32
  store i32 1193981852, i32* %canary
  %finchar = alloca i32, align 4
  %stackp = alloca i8*, align 8
  %code = alloca i64, align 8
  store i32 9, i32* @n_bits, align 4
...
entry:
  ...
  %oldcode = alloca i64, align 8
  %canary = alloca i32
  store i32 2050395640, i32* %canary
  %incode = alloca i64, align 8
  %code = alloca i64, align 8
  %stackp = alloca i8*, align 8
  store i32 9, i32* @n_bits, align 4
...
entry:
  %canary = alloca i32
  store i32 1583561963, i32* %canary
  %i = alloca i64, align 8
  %hsize.addr = alloca i64, align 8
  %m1 = alloca i64, align 8
  %htab_p = alloca i64*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @compress.26() #0 {
entry:
  %hshift = alloca i32, align 4
  %disp = alloca i32, align 4
  %hsize_reg = alloca i64, align 8
  ...
  %ent = alloca i64, align 8
  %canary = alloca i32
  store i32 1004565652, i32* %canary
  %i = alloca i64, align 8
  %c95 = alloca i32, align 4
  store i64 0, i64* %i, align 8
  %0 = load i32, i32* @nomagic, align 4
...
entry:
  ...
  %hsize.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1375915924, i32* %canary
  %m1 = alloca i64, align 8
  store i64 %hsize, i64* %hsize.addr, align 8
  %0 = load i64, i64* %hsize.addr, align 8
  %add.ptr = getelementptr inbounds i64, i64* getelementptr inbounds ([69001 x i64], [69001 x i64]* @htab, i64 0, i64 0), i64 %0
...
entry:
  ...
  %c = alloca i32, align 4
  %canary = alloca i32
  store i32 2028411178, i32* %canary
  %hshift = alloca i32, align 4
  %fcode = alloca i64, align 8
  %hsize_reg = alloca i64, align 8
  store i64 0, i64* %i, align 8
...
entry:
  ...
  %disp = alloca i32, align 4
  %canary = alloca i32
  store i32 579693930, i32* %canary
  %fcode = alloca i64, align 8
  store i64 0, i64* %i, align 8
  %0 = load i32, i32* @nomagic, align 4
  %cmp = icmp eq i32 %0, 0
...
entry:
  %htab_p = alloca i64*, align 8
  %canary = alloca i32
  store i32 1111498554, i32* %canary
  %hsize.addr = alloca i64, align 8
  %m1 = alloca i64, align 8
  %i = alloca i64, align 8
  store i64 %hsize, i64* %hsize.addr, align 8
...
entry:
  ...
  %r_off = alloca i32, align 4
  %canary = alloca i32
  store i32 1867609860, i32* %canary
  %bp = alloca i8*, align 8
  %bits = alloca i32, align 4
  store i64 %code, i64* %code.addr, align 8
  %0 = load i32, i32* @offset, align 4
...
entry:
  ...
  %code.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 690680912, i32* %canary
  %bp = alloca i8*, align 8
  store i64 %code, i64* %code.addr, align 8
  %0 = load i32, i32* @offset, align 4
  store i32 %0, i32* %r_off, align 4
