; ModuleID = 'perf_compress.c.rand.8P2.bc'
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_copystat.9, label %ctrl0

func_copystat.9:                                  ; preds = %rand_bb
  call void @copystat.9(i8* %ifname, i8* %ofname)
  ret void

func_copystat.22:                                 ; preds = %ctrl0
  call void @copystat.22(i8* %ifname, i8* %ofname)
  ret void

func_copystat.41:                                 ; preds = %ctrl1
  call void @copystat.41(i8* %ifname, i8* %ofname)
  ret void
...
func_copystat.44:                                 ; preds = %ctrl3
  call void @copystat.44(i8* %ifname, i8* %ofname)
  ret void
...
func_copystat.52:                                 ; preds = %ctrl5
  call void @copystat.52(i8* %ifname, i8* %ofname)
  ret void

func_copystat.53:                                 ; preds = %ctrl5
  call void @copystat.53(i8* %ifname, i8* %ofname)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_copystat.22, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_copystat.41, label %ctrl2
...
ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_copystat.44, label %ctrl4
...
ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_copystat.52, label %func_copystat.53
}
...
func_compress.47:                                 ; preds = %ctrl0
  call void @compress.47()
  ret void

func_compress.57:                                 ; preds = %ctrl1
  call void @compress.57()
  ret void

func_compress.60:                                 ; preds = %ctrl2
  call void @compress.60()
  ret void

func_compress.61:                                 ; preds = %ctrl3
  call void @compress.61()
  ret void

func_compress.62:                                 ; preds = %ctrl4
  call void @compress.62()
  ret void

func_compress.63:                                 ; preds = %ctrl5
  call void @compress.63()
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_compress.47, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_compress.57, label %ctrl2
...
ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_compress.61, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_compress.62, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_compress.63, label %func_compress.64
}
...
func_cl_hash.11:                                  ; preds = %ctrl0
  call void @cl_hash.11(i64 %hsize)
  ret void

func_cl_hash.16:                                  ; preds = %ctrl1
  call void @cl_hash.16(i64 %hsize)
  ret void

func_cl_hash.38:                                  ; preds = %ctrl2
  call void @cl_hash.38(i64 %hsize)
  ret void

func_cl_hash.46:                                  ; preds = %ctrl3
  call void @cl_hash.46(i64 %hsize)
  ret void

func_cl_hash.55:                                  ; preds = %ctrl4
  call void @cl_hash.55(i64 %hsize)
  ret void

func_cl_hash.56:                                  ; preds = %ctrl5
  call void @cl_hash.56(i64 %hsize)
  ret void

func_cl_hash.59:                                  ; preds = %ctrl5
  call void @cl_hash.59(i64 %hsize)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_cl_hash.11, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_cl_hash.16, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_cl_hash.38, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_cl_hash.46, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_cl_hash.55, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_cl_hash.56, label %func_cl_hash.59
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_scott_hack.8, label %ctrl0

func_scott_hack.8:                                ; preds = %rand_bb
  %2 = call i32 @scott_hack.8(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent)
  ret i32 %2
...
func_scott_hack.19:                               ; preds = %ctrl1
  %4 = call i32 @scott_hack.19(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent)
  ret i32 %4

func_scott_hack.20:                               ; preds = %ctrl2
  %5 = call i32 @scott_hack.20(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent)
  ret i32 %5

func_scott_hack.27:                               ; preds = %ctrl3
  %6 = call i32 @scott_hack.27(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent)
  ret i32 %6

func_scott_hack.35:                               ; preds = %ctrl4
  %7 = call i32 @scott_hack.35(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent)
  ret i32 %7

func_scott_hack.36:                               ; preds = %ctrl5
  %8 = call i32 @scott_hack.36(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent)
  ret i32 %8

func_scott_hack.37:                               ; preds = %ctrl5
  %9 = call i32 @scott_hack.37(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent)
  ret i32 %9
...
ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_scott_hack.19, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_scott_hack.20, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_scott_hack.27, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_scott_hack.35, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_scott_hack.36, label %func_scott_hack.37
}
...
func_output.12:                                   ; preds = %ctrl0
  call void @output.12(i64 %code)
  ret void

func_output.21:                                   ; preds = %ctrl1
  call void @output.21(i64 %code)
  ret void

func_output.25:                                   ; preds = %ctrl2
...
func_output.49:                                   ; preds = %ctrl5
  call void @output.49(i64 %code)
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_output.12, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_output.21, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_output.25, label %ctrl3
...
ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_output.49, label %func_output.58
}
...
func_prratio.32:                                  ; preds = %ctrl2
  call void @prratio.32(%struct._IO_FILE* %stream, i64 %num, i64 %den)
  ret void
...
func_prratio.45:                                  ; preds = %ctrl4
  call void @prratio.45(%struct._IO_FILE* %stream, i64 %num, i64 %den)
  ret void

func_prratio.51:                                  ; preds = %ctrl5
  call void @prratio.51(%struct._IO_FILE* %stream, i64 %num, i64 %den)
  ret void

func_prratio.54:                                  ; preds = %ctrl5
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_prratio.28, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_prratio.32, label %ctrl3
...
ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_prratio.45, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_prratio.51, label %func_prratio.54
}
...
func_decompress.2:                                ; preds = %ctrl0
  call void @decompress.2()
  ret void

func_decompress.4:                                ; preds = %ctrl1
  call void @decompress.4()
  ret void

func_decompress.13:                               ; preds = %ctrl2
  call void @decompress.13()
  ret void

func_decompress.24:                               ; preds = %ctrl3
  call void @decompress.24()
  ret void

func_decompress.29:                               ; preds = %ctrl4
  call void @decompress.29()
  ret void

func_decompress.30:                               ; preds = %ctrl5
  call void @decompress.30()
  ret void

func_decompress.48:                               ; preds = %ctrl5
  call void @decompress.48()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_decompress.2, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_decompress.4, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_decompress.13, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_decompress.24, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_decompress.29, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_decompress.30, label %func_decompress.48
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_getcode.5, label %ctrl0

func_getcode.5:                                   ; preds = %rand_bb
  %2 = call i64 @getcode.5()
  ret i64 %2
...
func_getcode.14:                                  ; preds = %ctrl1
  %4 = call i64 @getcode.14()
  ret i64 %4

func_getcode.18:                                  ; preds = %ctrl2
  %5 = call i64 @getcode.18()
  ret i64 %5

func_getcode.23:                                  ; preds = %ctrl3
  %6 = call i64 @getcode.23()
  ret i64 %6

func_getcode.26:                                  ; preds = %ctrl4
  %7 = call i64 @getcode.26()
  ret i64 %7

func_getcode.34:                                  ; preds = %ctrl5
  %8 = call i64 @getcode.34()
  ret i64 %8

func_getcode.39:                                  ; preds = %ctrl5
  %9 = call i64 @getcode.39()
  ret i64 %9
...
ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_getcode.14, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_getcode.18, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_getcode.23, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_getcode.26, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_getcode.34, label %func_getcode.39
}
...
entry:
  ...
  %canary = alloca i32
  store i32 1201667379, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @decompress.2() #0 {
entry:
  %oldcode = alloca i64, align 8
  %canary = alloca i32
  store i32 126724718, i32* %canary
  %code = alloca i64, align 8
  %finchar = alloca i32, align 4
  %stackp = alloca i8*, align 8
  %incode = alloca i64, align 8
...
entry:
  %canary = alloca i32
  store i32 1456372421, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @decompress.4() #0 {
entry:
  %stackp = alloca i8*, align 8
  %code = alloca i64, align 8
  %canary = alloca i32
  store i32 419638381, i32* %canary
  %finchar = alloca i32, align 4
  %incode = alloca i64, align 8
  %oldcode = alloca i64, align 8
  store i32 9, i32* @n_bits, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 473442978, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 2066586186, i32* %canary
  %bits = alloca i32, align 4
  %r_off = alloca i32, align 4
...
entry:
  ...
  %bp = alloca i8*, align 8
  %canary = alloca i32
  store i32 988094172, i32* %canary
  %r_off = alloca i32, align 4
  %retval = alloca i64, align 8
  store i8* getelementptr inbounds ([16 x i8], [16 x i8]* @getcode.buf, i64 0, i64 0), i8** %bp, align 8
  %0 = load i32, i32* @clear_flg, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @scott_hack.8(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent) #0 {
entry:
  %ent.addr = alloca i64*, align 8
  %disp.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1428757654, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @copystat.9(i8* %ifname, i8* %ofname) #0 {
entry:
  %canary = alloca i32
  store i32 377617909, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1958572023, i32* %canary
...
entry:
  ...
  %hsize.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1638367663, i32* %canary
  %htab_p = alloca i64*, align 8
  %m1 = alloca i64, align 8
  store i64 %hsize, i64* %hsize.addr, align 8
  %0 = load i64, i64* %hsize.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @output.12(i64 %code) #0 {
entry:
  %r_off = alloca i32, align 4
  %code.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 2110309737, i32* %canary
  %bp = alloca i8*, align 8
  %bits = alloca i32, align 4
  store i64 %code, i64* %code.addr, align 8
  %0 = load i32, i32* @offset, align 4
...
entry:
  ...
  %code = alloca i64, align 8
  %canary = alloca i32
  store i32 2117809628, i32* %canary
  %stackp = alloca i8*, align 8
  store i32 9, i32* @n_bits, align 4
  store i64 511, i64* @maxcode, align 8
  store i64 255, i64* %code, align 8
...
entry:
  %retval = alloca i64, align 8
  %canary = alloca i32
  store i32 1869103797, i32* %canary
  %r_off = alloca i32, align 4
  %code = alloca i64, align 8
  %bp = alloca i8*, align 8
  %bits = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 994164347, i32* %canary
  %disp.addr = alloca i32, align 4
  %ent.addr = alloca i64*, align 8
  %hsize_reg.addr = alloca i32, align 4
  %retval = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @cl_hash.16(i64 %hsize) #0 {
entry:
  %m1 = alloca i64, align 8
  %i = alloca i64, align 8
  %htab_p = alloca i64*, align 8
  %canary = alloca i32
  store i32 1841032163, i32* %canary
  %hsize.addr = alloca i64, align 8
  store i64 %hsize, i64* %hsize.addr, align 8
  %0 = load i64, i64* %hsize.addr, align 8
  %add.ptr = getelementptr inbounds i64, i64* getelementptr inbounds ([69001 x i64], [69001 x i64]* @htab, i64 0, i64 0), i64 %0
...
entry:
  ...
  %bp = alloca i8*, align 8
  %canary = alloca i32
  store i32 1027782108, i32* %canary
  %code = alloca i64, align 8
  %retval = alloca i64, align 8
  store i8* getelementptr inbounds ([16 x i8], [16 x i8]* @getcode.buf, i64 0, i64 0), i8** %bp, align 8
  %0 = load i32, i32* @clear_flg, align 4
...
entry:
  %canary = alloca i32
  store i32 611285124, i32* %canary
  %retval = alloca i32, align 4
  %fcode.addr = alloca i64, align 8
  %ent.addr = alloca i64*, align 8
  %i.addr = alloca i64*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @scott_hack.20(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent) #0 {
entry:
  %fcode.addr = alloca i64, align 8
  %i.addr = alloca i64*, align 8
  %disp.addr = alloca i32, align 4
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 207801864, i32* %canary
  %ent.addr = alloca i64*, align 8
  store i64* %i, i64** %i.addr, align 8
  store i64 %fcode, i64* %fcode.addr, align 8
  store i32 %disp, i32* %disp.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @output.21(i64 %code) #0 {
entry:
  %bits = alloca i32, align 4
  %bp = alloca i8*, align 8
  %code.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 561374027, i32* %canary
  %r_off = alloca i32, align 4
  store i64 %code, i64* %code.addr, align 8
  %0 = load i32, i32* @offset, align 4
  store i32 %0, i32* %r_off, align 4
...
entry:
  %ofname.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 975925621, i32* %canary
  %mode = alloca i32, align 4
  %ifname.addr = alloca i8*, align 8
  %statbuf = alloca %struct.stat, align 8
  %timep = alloca %struct.utimbuf, align 8
...
entry:
  ...
  %code = alloca i64, align 8
  %canary = alloca i32
  store i32 1123827137, i32* %canary
  %r_off = alloca i32, align 4
  store i8* getelementptr inbounds ([16 x i8], [16 x i8]* @getcode.buf, i64 0, i64 0), i8** %bp, align 8
  %0 = load i32, i32* @clear_flg, align 4
  %cmp = icmp sgt i32 %0, 0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @decompress.24() #0 {
entry:
  %stackp = alloca i8*, align 8
  %oldcode = alloca i64, align 8
  %incode = alloca i64, align 8
  %canary = alloca i32
  store i32 1296056657, i32* %canary
  %code = alloca i64, align 8
  %finchar = alloca i32, align 4
  store i32 9, i32* @n_bits, align 4
  store i64 511, i64* @maxcode, align 8
...
entry:
  %code.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 2045577695, i32* %canary
  %bits = alloca i32, align 4
  %bp = alloca i8*, align 8
  %r_off = alloca i32, align 4
  store i64 %code, i64* %code.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @getcode.26() #0 {
entry:
  %r_off = alloca i32, align 4
  %bits = alloca i32, align 4
  %retval = alloca i64, align 8
  %bp = alloca i8*, align 8
  %canary = alloca i32
  store i32 1739108574, i32* %canary
  %code = alloca i64, align 8
  store i8* getelementptr inbounds ([16 x i8], [16 x i8]* @getcode.buf, i64 0, i64 0), i8** %bp, align 8
  %0 = load i32, i32* @clear_flg, align 4
  %cmp = icmp sgt i32 %0, 0
...
entry:
  ...
  %hsize_reg.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 168419188, i32* %canary
  %fcode.addr = alloca i64, align 8
  store i64* %i, i64** %i.addr, align 8
  store i64 %fcode, i64* %fcode.addr, align 8
  store i32 %disp, i32* %disp.addr, align 4
...
entry:
  ...
  %num.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 489701293, i32* %canary
  %q = alloca i32, align 4
  %stream.addr = alloca %struct._IO_FILE*, align 8
  store %struct._IO_FILE* %stream, %struct._IO_FILE** %stream.addr, align 8
  store i64 %num, i64* %num.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @decompress.29() #0 {
entry:
  %oldcode = alloca i64, align 8
  %incode = alloca i64, align 8
  %finchar = alloca i32, align 4
  %code = alloca i64, align 8
  %canary = alloca i32
  store i32 1178236912, i32* %canary
  %stackp = alloca i8*, align 8
  store i32 9, i32* @n_bits, align 4
  store i64 511, i64* @maxcode, align 8
  store i64 255, i64* %code, align 8
...
entry:
  %canary = alloca i32
  store i32 223804628, i32* %canary
  %stackp = alloca i8*, align 8
  %code = alloca i64, align 8
  %oldcode = alloca i64, align 8
  %finchar = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1403696047, i32* %canary
  %r_off = alloca i32, align 4
  %bp = alloca i8*, align 8
  %bits = alloca i32, align 4
  %code.addr = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @prratio.32(%struct._IO_FILE* %stream, i64 %num, i64 %den) #0 {
entry:
  %canary = alloca i32
  store i32 822214442, i32* %canary
  %q = alloca i32, align 4
  %num.addr = alloca i64, align 8
  %stream.addr = alloca %struct._IO_FILE*, align 8
  %den.addr = alloca i64, align 8
...
entry:
  %canary = alloca i32
  store i32 806100541, i32* %canary
  %bp = alloca i8*, align 8
  %r_off = alloca i32, align 4
  %code.addr = alloca i64, align 8
  %bits = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @getcode.34() #0 {
entry:
  %code = alloca i64, align 8
  %canary = alloca i32
  store i32 341362262, i32* %canary
  %r_off = alloca i32, align 4
  %bp = alloca i8*, align 8
  %bits = alloca i32, align 4
  %retval = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @scott_hack.35(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent) #0 {
entry:
  %canary = alloca i32
  store i32 213892346, i32* %canary
  %hsize_reg.addr = alloca i32, align 4
  %ent.addr = alloca i64*, align 8
  %disp.addr = alloca i32, align 4
  %i.addr = alloca i64*, align 8
...
entry:
  ...
  %i.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 1636919678, i32* %canary
  %retval = alloca i32, align 4
  %ent.addr = alloca i64*, align 8
  %disp.addr = alloca i32, align 4
  store i64* %i, i64** %i.addr, align 8
...
entry:
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 509905946, i32* %canary
  %hsize_reg.addr = alloca i32, align 4
  %disp.addr = alloca i32, align 4
  %i.addr = alloca i64*, align 8
  %fcode.addr = alloca i64, align 8
...
entry:
  ...
  %htab_p = alloca i64*, align 8
  %canary = alloca i32
  store i32 793033615, i32* %canary
  %hsize.addr = alloca i64, align 8
  %i = alloca i64, align 8
  store i64 %hsize, i64* %hsize.addr, align 8
  %0 = load i64, i64* %hsize.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @getcode.39() #0 {
entry:
  %canary = alloca i32
  store i32 522105151, i32* %canary
  %bp = alloca i8*, align 8
  %r_off = alloca i32, align 4
  %code = alloca i64, align 8
  %retval = alloca i64, align 8
...
entry:
  ...
  %canary = alloca i32
  store i32 1201563772, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @copystat.41(i8* %ifname, i8* %ofname) #0 {
entry:
  %ifname.addr = alloca i8*, align 8
  %timep = alloca %struct.utimbuf, align 8
  %canary = alloca i32
  store i32 358317913, i32* %canary
  %ofname.addr = alloca i8*, align 8
  %statbuf = alloca %struct.stat, align 8
  %mode = alloca i32, align 4
  store i8* %ifname, i8** %ifname.addr, align 8
...
entry:
  ...
  %den.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1575858683, i32* %canary
  %stream.addr = alloca %struct._IO_FILE*, align 8
  %num.addr = alloca i64, align 8
  store %struct._IO_FILE* %stream, %struct._IO_FILE** %stream.addr, align 8
  store i64 %num, i64* %num.addr, align 8
...
entry:
  ...
  %mode = alloca i32, align 4
  %canary = alloca i32
  store i32 1556593278, i32* %canary
  %ifname.addr = alloca i8*, align 8
  store i8* %ifname, i8** %ifname.addr, align 8
  store i8* %ofname, i8** %ofname.addr, align 8
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @copystat.44(i8* %ifname, i8* %ofname) #0 {
entry:
  %statbuf = alloca %struct.stat, align 8
  %ofname.addr = alloca i8*, align 8
  %ifname.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 513815614, i32* %canary
  %mode = alloca i32, align 4
  %timep = alloca %struct.utimbuf, align 8
  store i8* %ifname, i8** %ifname.addr, align 8
  store i8* %ofname, i8** %ofname.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @prratio.45(%struct._IO_FILE* %stream, i64 %num, i64 %den) #0 {
entry:
  %num.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 17465338, i32* %canary
  %q = alloca i32, align 4
  %stream.addr = alloca %struct._IO_FILE*, align 8
  %den.addr = alloca i64, align 8
  store %struct._IO_FILE* %stream, %struct._IO_FILE** %stream.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @cl_hash.46(i64 %hsize) #0 {
entry:
  %m1 = alloca i64, align 8
  %i = alloca i64, align 8
  %canary = alloca i32
  store i32 606206590, i32* %canary
  %hsize.addr = alloca i64, align 8
  %htab_p = alloca i64*, align 8
  store i64 %hsize, i64* %hsize.addr, align 8
  %0 = load i64, i64* %hsize.addr, align 8
...
entry:
  ...
  %disp = alloca i32, align 4
  %canary = alloca i32
  store i32 2102485357, i32* %canary
  %c = alloca i32, align 4
  %hshift = alloca i32, align 4
  %hsize_reg = alloca i64, align 8
  store i64 0, i64* %i, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @decompress.48() #0 {
entry:
  %code = alloca i64, align 8
  %canary = alloca i32
  store i32 1863707350, i32* %canary
  %oldcode = alloca i64, align 8
  %stackp = alloca i8*, align 8
  %finchar = alloca i32, align 4
  %incode = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @output.49(i64 %code) #0 {
entry:
  %canary = alloca i32
  store i32 48775523, i32* %canary
  %bits = alloca i32, align 4
  %r_off = alloca i32, align 4
  %bp = alloca i8*, align 8
  %code.addr = alloca i64, align 8
...
entry:
  ...
  %timep = alloca %struct.utimbuf, align 8
  %canary = alloca i32
  store i32 1911141700, i32* %canary
  %mode = alloca i32, align 4
  %statbuf = alloca %struct.stat, align 8
  store i8* %ifname, i8** %ifname.addr, align 8
  store i8* %ofname, i8** %ofname.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @prratio.51(%struct._IO_FILE* %stream, i64 %num, i64 %den) #0 {
entry:
  %q = alloca i32, align 4
  %canary = alloca i32
  store i32 992048344, i32* %canary
  %den.addr = alloca i64, align 8
  %num.addr = alloca i64, align 8
  %stream.addr = alloca %struct._IO_FILE*, align 8
  store %struct._IO_FILE* %stream, %struct._IO_FILE** %stream.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @copystat.52(i8* %ifname, i8* %ofname) #0 {
entry:
  %timep = alloca %struct.utimbuf, align 8
  %ofname.addr = alloca i8*, align 8
  %mode = alloca i32, align 4
  %ifname.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1703256826, i32* %canary
  %statbuf = alloca %struct.stat, align 8
  store i8* %ifname, i8** %ifname.addr, align 8
  store i8* %ofname, i8** %ofname.addr, align 8
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @copystat.53(i8* %ifname, i8* %ofname) #0 {
entry:
  %mode = alloca i32, align 4
  %canary = alloca i32
  store i32 1243420800, i32* %canary
  %ofname.addr = alloca i8*, align 8
  %statbuf = alloca %struct.stat, align 8
  %ifname.addr = alloca i8*, align 8
  %timep = alloca %struct.utimbuf, align 8
...
entry:
  ...
  %q = alloca i32, align 4
  %canary = alloca i32
  store i32 1982872037, i32* %canary
  %den.addr = alloca i64, align 8
  %stream.addr = alloca %struct._IO_FILE*, align 8
  store %struct._IO_FILE* %stream, %struct._IO_FILE** %stream.addr, align 8
  store i64 %num, i64* %num.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @cl_hash.55(i64 %hsize) #0 {
entry:
  %canary = alloca i32
  store i32 546676393, i32* %canary
  %htab_p = alloca i64*, align 8
  %hsize.addr = alloca i64, align 8
  %i = alloca i64, align 8
  %m1 = alloca i64, align 8
...
entry:
  %canary = alloca i32
  store i32 751870637, i32* %canary
  %i = alloca i64, align 8
  %hsize.addr = alloca i64, align 8
  %m1 = alloca i64, align 8
  %htab_p = alloca i64*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @compress.57() #0 {
entry:
  %c = alloca i32, align 4
  %fcode = alloca i64, align 8
  %ent = alloca i64, align 8
  %canary = alloca i32
  store i32 1214420780, i32* %canary
  %c95 = alloca i32, align 4
  %hshift = alloca i32, align 4
  %disp = alloca i32, align 4
  %hsize_reg = alloca i64, align 8
...
entry:
  %m1 = alloca i64, align 8
  %canary = alloca i32
  store i32 484032433, i32* %canary
  %htab_p = alloca i64*, align 8
  %i = alloca i64, align 8
  %hsize.addr = alloca i64, align 8
  store i64 %hsize, i64* %hsize.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @compress.60() #0 {
entry:
  %c95 = alloca i32, align 4
  %hshift = alloca i32, align 4
  %c = alloca i32, align 4
  %ent = alloca i64, align 8
  %canary = alloca i32
  store i32 360834841, i32* %canary
  %hsize_reg = alloca i64, align 8
  %fcode = alloca i64, align 8
  %i = alloca i64, align 8
  %disp = alloca i32, align 4
...
entry:
  ...
  %hshift = alloca i32, align 4
  %canary = alloca i32
  store i32 1677888091, i32* %canary
  %c95 = alloca i32, align 4
  %c = alloca i32, align 4
  %hsize_reg = alloca i64, align 8
  %fcode = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @compress.62() #0 {
entry:
  %i = alloca i64, align 8
  %c = alloca i32, align 4
  %hshift = alloca i32, align 4
  ...
  %hsize_reg = alloca i64, align 8
  %canary = alloca i32
  store i32 1261489927, i32* %canary
  %fcode = alloca i64, align 8
  %disp = alloca i32, align 4
  store i64 0, i64* %i, align 8
  %0 = load i32, i32* @nomagic, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @compress.63() #0 {
entry:
  %fcode = alloca i64, align 8
  %disp = alloca i32, align 4
  %c95 = alloca i32, align 4
  ...
  %c = alloca i32, align 4
  %canary = alloca i32
  store i32 1182599922, i32* %canary
  %hsize_reg = alloca i64, align 8
  %hshift = alloca i32, align 4
  %i = alloca i64, align 8
  store i64 0, i64* %i, align 8
...
entry:
  %canary = alloca i32
  store i32 1526508200, i32* %canary
  %fcode = alloca i64, align 8
  %disp = alloca i32, align 4
  %i = alloca i64, align 8
  %ent = alloca i64, align 8
