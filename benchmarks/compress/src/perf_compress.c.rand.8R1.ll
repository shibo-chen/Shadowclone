; ModuleID = 'perf_compress.c.rand.8R1.bc'
...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_copystat.13, label %ctrl0

func_copystat.13:                                 ; preds = %rand_bb
  call void @copystat.13(i8* %ifname, i8* %ofname)
  ret void

func_copystat.30:                                 ; preds = %ctrl0
  call void @copystat.30(i8* %ifname, i8* %ofname)
  ret void

func_copystat.34:                                 ; preds = %ctrl1
  call void @copystat.34(i8* %ifname, i8* %ofname)
  ret void

func_copystat.43:                                 ; preds = %ctrl2
  call void @copystat.43(i8* %ifname, i8* %ofname)
  ret void

func_copystat.49:                                 ; preds = %ctrl3
  call void @copystat.49(i8* %ifname, i8* %ofname)
  ret void

func_copystat.50:                                 ; preds = %ctrl4
  call void @copystat.50(i8* %ifname, i8* %ofname)
  ret void

func_copystat.54:                                 ; preds = %ctrl5
  call void @copystat.54(i8* %ifname, i8* %ofname)
  ret void

func_copystat.63:                                 ; preds = %ctrl5
  call void @copystat.63(i8* %ifname, i8* %ofname)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_copystat.30, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_copystat.34, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_copystat.43, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_copystat.49, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_copystat.50, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_copystat.54, label %func_copystat.63
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_compress.16, label %ctrl0

func_compress.16:                                 ; preds = %rand_bb
  call void @compress.16()
  ret void

func_compress.24:                                 ; preds = %ctrl0
  call void @compress.24()
  ret void

func_compress.27:                                 ; preds = %ctrl1
  call void @compress.27()
  ret void

func_compress.32:                                 ; preds = %ctrl2
  call void @compress.32()
  ret void

func_compress.40:                                 ; preds = %ctrl3
  call void @compress.40()
  ret void

func_compress.47:                                 ; preds = %ctrl4
  call void @compress.47()
  ret void

func_compress.51:                                 ; preds = %ctrl5
  call void @compress.51()
  ret void

func_compress.55:                                 ; preds = %ctrl5
  call void @compress.55()
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_compress.24, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_compress.27, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_compress.32, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_compress.40, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_compress.47, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_compress.51, label %func_compress.55
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_cl_hash.39, label %ctrl0

func_cl_hash.39:                                  ; preds = %rand_bb
  call void @cl_hash.39(i64 %hsize)
  ret void

func_cl_hash.42:                                  ; preds = %ctrl0
  call void @cl_hash.42(i64 %hsize)
  ret void

func_cl_hash.48:                                  ; preds = %ctrl1
  call void @cl_hash.48(i64 %hsize)
  ret void

func_cl_hash.56:                                  ; preds = %ctrl2
  call void @cl_hash.56(i64 %hsize)
  ret void

func_cl_hash.59:                                  ; preds = %ctrl3
  call void @cl_hash.59(i64 %hsize)
  ret void

func_cl_hash.60:                                  ; preds = %ctrl4
  call void @cl_hash.60(i64 %hsize)
  ret void

func_cl_hash.61:                                  ; preds = %ctrl5
  call void @cl_hash.61(i64 %hsize)
  ret void

func_cl_hash.62:                                  ; preds = %ctrl5
  call void @cl_hash.62(i64 %hsize)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_cl_hash.42, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_cl_hash.48, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_cl_hash.56, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_cl_hash.59, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_cl_hash.60, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_cl_hash.61, label %func_cl_hash.62
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_scott_hack.2, label %ctrl0

func_scott_hack.2:                                ; preds = %rand_bb
  %2 = call i32 @scott_hack.2(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent)
  ret i32 %2

func_scott_hack.12:                               ; preds = %ctrl0
  %3 = call i32 @scott_hack.12(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent)
  ret i32 %3

func_scott_hack.17:                               ; preds = %ctrl1
  %4 = call i32 @scott_hack.17(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent)
  ret i32 %4

func_scott_hack.19:                               ; preds = %ctrl2
  %5 = call i32 @scott_hack.19(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent)
  ret i32 %5

func_scott_hack.26:                               ; preds = %ctrl3
  %6 = call i32 @scott_hack.26(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent)
  ret i32 %6

func_scott_hack.36:                               ; preds = %ctrl4
  %7 = call i32 @scott_hack.36(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent)
  ret i32 %7

func_scott_hack.38:                               ; preds = %ctrl5
  %8 = call i32 @scott_hack.38(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent)
  ret i32 %8

func_scott_hack.45:                               ; preds = %ctrl5
  %9 = call i32 @scott_hack.45(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent)
  ret i32 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_scott_hack.12, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_scott_hack.17, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_scott_hack.19, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_scott_hack.26, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_scott_hack.36, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_scott_hack.38, label %func_scott_hack.45
}
...
func_output.11:                                   ; preds = %ctrl0
  call void @output.11(i64 %code)
  ret void

func_output.20:                                   ; preds = %ctrl1
  call void @output.20(i64 %code)
  ret void

func_output.22:                                   ; preds = %ctrl2
  call void @output.22(i64 %code)
  ret void

func_output.31:                                   ; preds = %ctrl3
  call void @output.31(i64 %code)
  ret void

func_output.33:                                   ; preds = %ctrl4
  call void @output.33(i64 %code)
  ret void

func_output.37:                                   ; preds = %ctrl5
  call void @output.37(i64 %code)
  ret void

func_output.44:                                   ; preds = %ctrl5
  call void @output.44(i64 %code)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_output.11, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_output.20, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_output.22, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_output.31, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_output.33, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_output.37, label %func_output.44
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_prratio.25, label %ctrl0

func_prratio.25:                                  ; preds = %rand_bb
  call void @prratio.25(%struct._IO_FILE* %stream, i64 %num, i64 %den)
  ret void

func_prratio.29:                                  ; preds = %ctrl0
  call void @prratio.29(%struct._IO_FILE* %stream, i64 %num, i64 %den)
  ret void

func_prratio.35:                                  ; preds = %ctrl1
  call void @prratio.35(%struct._IO_FILE* %stream, i64 %num, i64 %den)
  ret void

func_prratio.52:                                  ; preds = %ctrl2
  call void @prratio.52(%struct._IO_FILE* %stream, i64 %num, i64 %den)
  ret void

func_prratio.53:                                  ; preds = %ctrl3
  call void @prratio.53(%struct._IO_FILE* %stream, i64 %num, i64 %den)
  ret void

func_prratio.57:                                  ; preds = %ctrl4
  call void @prratio.57(%struct._IO_FILE* %stream, i64 %num, i64 %den)
  ret void

func_prratio.58:                                  ; preds = %ctrl5
  call void @prratio.58(%struct._IO_FILE* %stream, i64 %num, i64 %den)
  ret void

func_prratio.64:                                  ; preds = %ctrl5
  call void @prratio.64(%struct._IO_FILE* %stream, i64 %num, i64 %den)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_prratio.29, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_prratio.35, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_prratio.52, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_prratio.53, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_prratio.57, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_prratio.58, label %func_prratio.64
}
...
func_decompress.6:                                ; preds = %ctrl0
  call void @decompress.6()
  ret void

func_decompress.9:                                ; preds = %ctrl1
  call void @decompress.9()
  ret void

func_decompress.15:                               ; preds = %ctrl2
  call void @decompress.15()
  ret void

func_decompress.21:                               ; preds = %ctrl3
  call void @decompress.21()
  ret void

func_decompress.28:                               ; preds = %ctrl4
  call void @decompress.28()
  ret void

func_decompress.41:                               ; preds = %ctrl5
  call void @decompress.41()
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_decompress.6, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_decompress.9, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_decompress.15, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_decompress.21, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_decompress.28, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_decompress.41, label %func_decompress.46
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_getcode.3, label %ctrl0

func_getcode.3:                                   ; preds = %rand_bb
  %2 = call i64 @getcode.3()
  ret i64 %2

func_getcode.4:                                   ; preds = %ctrl0
  %3 = call i64 @getcode.4()
  ret i64 %3

func_getcode.5:                                   ; preds = %ctrl1
  %4 = call i64 @getcode.5()
  ret i64 %4

func_getcode.7:                                   ; preds = %ctrl2
  %5 = call i64 @getcode.7()
  ret i64 %5

func_getcode.10:                                  ; preds = %ctrl3
  %6 = call i64 @getcode.10()
  ret i64 %6

func_getcode.14:                                  ; preds = %ctrl4
  %7 = call i64 @getcode.14()
  ret i64 %7

func_getcode.18:                                  ; preds = %ctrl5
  %8 = call i64 @getcode.18()
  ret i64 %8

func_getcode.23:                                  ; preds = %ctrl5
  %9 = call i64 @getcode.23()
  ret i64 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_getcode.4, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_getcode.5, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_getcode.7, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_getcode.10, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_getcode.14, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_getcode.18, label %func_getcode.23
}
...
entry:
  ...
  %canary = alloca i32
  store i32 842046256, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @scott_hack.2(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 1452013588, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 156790215, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @getcode.4() #0 {
entry:
  %bits = alloca i32, align 4
  %retval = alloca i64, align 8
  %canary = alloca i32
  store i32 1932309653, i32* %canary
  %r_off = alloca i32, align 4
  %bp = alloca i8*, align 8
  %code = alloca i64, align 8
  store i8* getelementptr inbounds ([16 x i8], [16 x i8]* @getcode.buf, i64 0, i64 0), i8** %bp, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @getcode.5() #0 {
entry:
  %bits = alloca i32, align 4
  %bp = alloca i8*, align 8
  %canary = alloca i32
  store i32 734631936, i32* %canary
  %retval = alloca i64, align 8
  %code = alloca i64, align 8
  %r_off = alloca i32, align 4
  store i8* getelementptr inbounds ([16 x i8], [16 x i8]* @getcode.buf, i64 0, i64 0), i8** %bp, align 8
...
entry:
  %finchar = alloca i32, align 4
  %canary = alloca i32
  store i32 2132068288, i32* %canary
  %incode = alloca i64, align 8
  %oldcode = alloca i64, align 8
  %stackp = alloca i8*, align 8
  %code = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @getcode.7() #0 {
entry:
  %bits = alloca i32, align 4
  %r_off = alloca i32, align 4
  %retval = alloca i64, align 8
  %code = alloca i64, align 8
  %canary = alloca i32
  store i32 874959526, i32* %canary
  %bp = alloca i8*, align 8
  store i8* getelementptr inbounds ([16 x i8], [16 x i8]* @getcode.buf, i64 0, i64 0), i8** %bp, align 8
  %0 = load i32, i32* @clear_flg, align 4
  %cmp = icmp sgt i32 %0, 0
...
entry:
  ...
  %bp = alloca i8*, align 8
  %canary = alloca i32
  store i32 648383277, i32* %canary
  %bits = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1085933488, i32* %canary
  %code = alloca i64, align 8
  %stackp = alloca i8*, align 8
  %oldcode = alloca i64, align 8
  %incode = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @getcode.10() #0 {
entry:
  %bp = alloca i8*, align 8
  %code = alloca i64, align 8
  %canary = alloca i32
  store i32 1945694439, i32* %canary
  %r_off = alloca i32, align 4
  %retval = alloca i64, align 8
  %bits = alloca i32, align 4
  store i8* getelementptr inbounds ([16 x i8], [16 x i8]* @getcode.buf, i64 0, i64 0), i8** %bp, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @output.11(i64 %code) #0 {
entry:
  %code.addr = alloca i64, align 8
  %bits = alloca i32, align 4
  %canary = alloca i32
  store i32 259476260, i32* %canary
  %bp = alloca i8*, align 8
  %r_off = alloca i32, align 4
  store i64 %code, i64* %code.addr, align 8
  %0 = load i32, i32* @offset, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @scott_hack.12(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent) #0 {
entry:
  %canary = alloca i32
  store i32 103287614, i32* %canary
  %hsize_reg.addr = alloca i32, align 4
  %fcode.addr = alloca i64, align 8
  %retval = alloca i32, align 4
  %disp.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @copystat.13(i8* %ifname, i8* %ofname) #0 {
entry:
  %ifname.addr = alloca i8*, align 8
  %ofname.addr = alloca i8*, align 8
  %mode = alloca i32, align 4
  %canary = alloca i32
  store i32 1837350437, i32* %canary
  %statbuf = alloca %struct.stat, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @getcode.14() #0 {
entry:
  %r_off = alloca i32, align 4
  %bp = alloca i8*, align 8
  %code = alloca i64, align 8
  %canary = alloca i32
  store i32 1615552916, i32* %canary
  %bits = alloca i32, align 4
  %retval = alloca i64, align 8
  store i8* getelementptr inbounds ([16 x i8], [16 x i8]* @getcode.buf, i64 0, i64 0), i8** %bp, align 8
  %0 = load i32, i32* @clear_flg, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @decompress.15() #0 {
entry:
  %finchar = alloca i32, align 4
  %canary = alloca i32
  store i32 929392076, i32* %canary
  %code = alloca i64, align 8
  %stackp = alloca i8*, align 8
  %incode = alloca i64, align 8
  %oldcode = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @compress.16() #0 {
entry:
  ...
  %canary = alloca i32
  store i32 1258973480, i32* %canary
...
entry:
  ...
  %i.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 1181972294, i32* %canary
  %hsize_reg.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  %disp.addr = alloca i32, align 4
  store i64* %i, i64** %i.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @getcode.18() #0 {
entry:
  %canary = alloca i32
  store i32 1592733968, i32* %canary
  %r_off = alloca i32, align 4
  %retval = alloca i64, align 8
  %code = alloca i64, align 8
  %bits = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @scott_hack.19(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent) #0 {
entry:
  %disp.addr = alloca i32, align 4
  %i.addr = alloca i64*, align 8
  %ent.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 201020029, i32* %canary
  %hsize_reg.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  %fcode.addr = alloca i64, align 8
  store i64* %i, i64** %i.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @output.20(i64 %code) #0 {
entry:
  %canary = alloca i32
  store i32 2082691822, i32* %canary
  %bits = alloca i32, align 4
  %code.addr = alloca i64, align 8
  %r_off = alloca i32, align 4
  %bp = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @decompress.21() #0 {
entry:
  %canary = alloca i32
  store i32 1692902916, i32* %canary
  %code = alloca i64, align 8
  %stackp = alloca i8*, align 8
  %incode = alloca i64, align 8
  %oldcode = alloca i64, align 8
...
entry:
  %canary = alloca i32
  store i32 1668887533, i32* %canary
  %bp = alloca i8*, align 8
  %bits = alloca i32, align 4
  %code.addr = alloca i64, align 8
  %r_off = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @getcode.23() #0 {
entry:
  %code = alloca i64, align 8
  %canary = alloca i32
  store i32 1242105129, i32* %canary
  %retval = alloca i64, align 8
  %r_off = alloca i32, align 4
  %bp = alloca i8*, align 8
  %bits = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @compress.24() #0 {
entry:
  %i = alloca i64, align 8
  %hsize_reg = alloca i64, align 8
  %c = alloca i32, align 4
  ...
  %disp = alloca i32, align 4
  %canary = alloca i32
  store i32 1130313878, i32* %canary
  %hshift = alloca i32, align 4
  %ent = alloca i64, align 8
  store i64 0, i64* %i, align 8
  %0 = load i32, i32* @nomagic, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @prratio.25(%struct._IO_FILE* %stream, i64 %num, i64 %den) #0 {
entry:
  %num.addr = alloca i64, align 8
  %q = alloca i32, align 4
  %stream.addr = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 815068827, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @scott_hack.26(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent) #0 {
entry:
  %disp.addr = alloca i32, align 4
  %ent.addr = alloca i64*, align 8
  %fcode.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1070534053, i32* %canary
  %i.addr = alloca i64*, align 8
  %retval = alloca i32, align 4
  %hsize_reg.addr = alloca i32, align 4
  store i64* %i, i64** %i.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @compress.27() #0 {
entry:
  %fcode = alloca i64, align 8
  %hshift = alloca i32, align 4
  %hsize_reg = alloca i64, align 8
  %i = alloca i64, align 8
  %canary = alloca i32
  store i32 897591734, i32* %canary
  %c95 = alloca i32, align 4
  %c = alloca i32, align 4
  %ent = alloca i64, align 8
  %disp = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @decompress.28() #0 {
entry:
  %incode = alloca i64, align 8
  %oldcode = alloca i64, align 8
  %finchar = alloca i32, align 4
  %stackp = alloca i8*, align 8
  %canary = alloca i32
  store i32 2043166708, i32* %canary
  %code = alloca i64, align 8
  store i32 9, i32* @n_bits, align 4
  store i64 511, i64* @maxcode, align 8
  store i64 255, i64* %code, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @prratio.29(%struct._IO_FILE* %stream, i64 %num, i64 %den) #0 {
entry:
  %canary = alloca i32
  store i32 1041668970, i32* %canary
  %num.addr = alloca i64, align 8
  %q = alloca i32, align 4
  %den.addr = alloca i64, align 8
  %stream.addr = alloca %struct._IO_FILE*, align 8
...
entry:
  ...
  %mode = alloca i32, align 4
  %canary = alloca i32
  store i32 1097262903, i32* %canary
  %ofname.addr = alloca i8*, align 8
  %timep = alloca %struct.utimbuf, align 8
  store i8* %ifname, i8** %ifname.addr, align 8
  store i8* %ofname, i8** %ofname.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @output.31(i64 %code) #0 {
entry:
  %r_off = alloca i32, align 4
  %canary = alloca i32
  store i32 2007193149, i32* %canary
  %bits = alloca i32, align 4
  %bp = alloca i8*, align 8
  %code.addr = alloca i64, align 8
  store i64 %code, i64* %code.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @compress.32() #0 {
entry:
  %hsize_reg = alloca i64, align 8
  %hshift = alloca i32, align 4
  %c = alloca i32, align 4
  %disp = alloca i32, align 4
  %canary = alloca i32
  store i32 1158598087, i32* %canary
  %c95 = alloca i32, align 4
  %fcode = alloca i64, align 8
  %ent = alloca i64, align 8
  %i = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @output.33(i64 %code) #0 {
entry:
  %bp = alloca i8*, align 8
  %canary = alloca i32
  store i32 1401292844, i32* %canary
  %r_off = alloca i32, align 4
  %code.addr = alloca i64, align 8
  %bits = alloca i32, align 4
  store i64 %code, i64* %code.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @copystat.34(i8* %ifname, i8* %ofname) #0 {
entry:
  %statbuf = alloca %struct.stat, align 8
  %mode = alloca i32, align 4
  %ifname.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1166631100, i32* %canary
  %timep = alloca %struct.utimbuf, align 8
  %ofname.addr = alloca i8*, align 8
  store i8* %ifname, i8** %ifname.addr, align 8
  store i8* %ofname, i8** %ofname.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @prratio.35(%struct._IO_FILE* %stream, i64 %num, i64 %den) #0 {
entry:
  %stream.addr = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 1954731023, i32* %canary
  %q = alloca i32, align 4
  %num.addr = alloca i64, align 8
  %den.addr = alloca i64, align 8
  store %struct._IO_FILE* %stream, %struct._IO_FILE** %stream.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @scott_hack.36(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent) #0 {
entry:
  %canary = alloca i32
  store i32 1194294207, i32* %canary
  %i.addr = alloca i64*, align 8
  %hsize_reg.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  %ent.addr = alloca i64*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @output.37(i64 %code) #0 {
entry:
  %bits = alloca i32, align 4
  %r_off = alloca i32, align 4
  %bp = alloca i8*, align 8
  %canary = alloca i32
  store i32 621044861, i32* %canary
  %code.addr = alloca i64, align 8
  store i64 %code, i64* %code.addr, align 8
  %0 = load i32, i32* @offset, align 4
  store i32 %0, i32* %r_off, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @scott_hack.38(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent) #0 {
entry:
  %i.addr = alloca i64*, align 8
  %ent.addr = alloca i64*, align 8
  %hsize_reg.addr = alloca i32, align 4
  %disp.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1961836449, i32* %canary
  %retval = alloca i32, align 4
  %fcode.addr = alloca i64, align 8
  store i64* %i, i64** %i.addr, align 8
  store i64 %fcode, i64* %fcode.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @cl_hash.39(i64 %hsize) #0 {
entry:
  %htab_p = alloca i64*, align 8
  %m1 = alloca i64, align 8
  %canary = alloca i32
  store i32 150055789, i32* %canary
  %i = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @compress.40() #0 {
entry:
  %i = alloca i64, align 8
  %c = alloca i32, align 4
  %disp = alloca i32, align 4
  %canary = alloca i32
  store i32 1089827592, i32* %canary
  %ent = alloca i64, align 8
  %hshift = alloca i32, align 4
  %hsize_reg = alloca i64, align 8
  %fcode = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @decompress.41() #0 {
entry:
  %finchar = alloca i32, align 4
  %incode = alloca i64, align 8
  %canary = alloca i32
  store i32 1950409557, i32* %canary
  %stackp = alloca i8*, align 8
  %code = alloca i64, align 8
  %oldcode = alloca i64, align 8
  store i32 9, i32* @n_bits, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @cl_hash.42(i64 %hsize) #0 {
entry:
  %htab_p = alloca i64*, align 8
  %hsize.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 1350197358, i32* %canary
  %i = alloca i64, align 8
  %m1 = alloca i64, align 8
  store i64 %hsize, i64* %hsize.addr, align 8
  %0 = load i64, i64* %hsize.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @copystat.43(i8* %ifname, i8* %ofname) #0 {
entry:
  %mode = alloca i32, align 4
  %canary = alloca i32
  store i32 126399014, i32* %canary
  %statbuf = alloca %struct.stat, align 8
  %ofname.addr = alloca i8*, align 8
  %ifname.addr = alloca i8*, align 8
  %timep = alloca %struct.utimbuf, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @output.44(i64 %code) #0 {
entry:
  %code.addr = alloca i64, align 8
  %bits = alloca i32, align 4
  %canary = alloca i32
  store i32 432061655, i32* %canary
  %r_off = alloca i32, align 4
  %bp = alloca i8*, align 8
  store i64 %code, i64* %code.addr, align 8
  %0 = load i32, i32* @offset, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @scott_hack.45(i64* %i, i64 %fcode, i32 %disp, i32 %hsize_reg, i64* %ent) #0 {
entry:
  %retval = alloca i32, align 4
  %i.addr = alloca i64*, align 8
  %fcode.addr = alloca i64, align 8
  %ent.addr = alloca i64*, align 8
  %canary = alloca i32
  store i32 431648145, i32* %canary
  %hsize_reg.addr = alloca i32, align 4
  %disp.addr = alloca i32, align 4
  store i64* %i, i64** %i.addr, align 8
  store i64 %fcode, i64* %fcode.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1204334788, i32* %canary
  %incode = alloca i64, align 8
  %code = alloca i64, align 8
  %oldcode = alloca i64, align 8
  %stackp = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @compress.47() #0 {
entry:
  %ent = alloca i64, align 8
  %hshift = alloca i32, align 4
  %canary = alloca i32
  store i32 1014528502, i32* %canary
  %c = alloca i32, align 4
  %i = alloca i64, align 8
  %c95 = alloca i32, align 4
  %hsize_reg = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @cl_hash.48(i64 %hsize) #0 {
entry:
  %m1 = alloca i64, align 8
  %htab_p = alloca i64*, align 8
  %canary = alloca i32
  store i32 1186399932, i32* %canary
  %i = alloca i64, align 8
  %hsize.addr = alloca i64, align 8
  store i64 %hsize, i64* %hsize.addr, align 8
  %0 = load i64, i64* %hsize.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @copystat.49(i8* %ifname, i8* %ofname) #0 {
entry:
  %statbuf = alloca %struct.stat, align 8
  %canary = alloca i32
  store i32 682835762, i32* %canary
  %timep = alloca %struct.utimbuf, align 8
  %ifname.addr = alloca i8*, align 8
  %ofname.addr = alloca i8*, align 8
  %mode = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @copystat.50(i8* %ifname, i8* %ofname) #0 {
entry:
  %canary = alloca i32
  store i32 1884419542, i32* %canary
  %ofname.addr = alloca i8*, align 8
  %timep = alloca %struct.utimbuf, align 8
  %statbuf = alloca %struct.stat, align 8
  %mode = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @compress.51() #0 {
entry:
  %canary = alloca i32
  store i32 1581831135, i32* %canary
  %hshift = alloca i32, align 4
  %c = alloca i32, align 4
  %i = alloca i64, align 8
  %c95 = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @prratio.52(%struct._IO_FILE* %stream, i64 %num, i64 %den) #0 {
entry:
  %q = alloca i32, align 4
  %stream.addr = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 992101218, i32* %canary
  %den.addr = alloca i64, align 8
  %num.addr = alloca i64, align 8
  store %struct._IO_FILE* %stream, %struct._IO_FILE** %stream.addr, align 8
  store i64 %num, i64* %num.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @prratio.53(%struct._IO_FILE* %stream, i64 %num, i64 %den) #0 {
entry:
  %canary = alloca i32
  store i32 1715523102, i32* %canary
  %den.addr = alloca i64, align 8
  %q = alloca i32, align 4
  %stream.addr = alloca %struct._IO_FILE*, align 8
  %num.addr = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @copystat.54(i8* %ifname, i8* %ofname) #0 {
entry:
  %statbuf = alloca %struct.stat, align 8
  %ifname.addr = alloca i8*, align 8
  %ofname.addr = alloca i8*, align 8
  %mode = alloca i32, align 4
  %canary = alloca i32
  store i32 370679550, i32* %canary
  %timep = alloca %struct.utimbuf, align 8
  store i8* %ifname, i8** %ifname.addr, align 8
  store i8* %ofname, i8** %ofname.addr, align 8
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8
...
entry:
  ...
  %i = alloca i64, align 8
  %canary = alloca i32
  store i32 682554807, i32* %canary
  %disp = alloca i32, align 4
  store i64 0, i64* %i, align 8
  %0 = load i32, i32* @nomagic, align 4
  %cmp = icmp eq i32 %0, 0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @cl_hash.56(i64 %hsize) #0 {
entry:
  %i = alloca i64, align 8
  %canary = alloca i32
  store i32 460106845, i32* %canary
  %hsize.addr = alloca i64, align 8
  %m1 = alloca i64, align 8
  %htab_p = alloca i64*, align 8
  store i64 %hsize, i64* %hsize.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @prratio.57(%struct._IO_FILE* %stream, i64 %num, i64 %den) #0 {
entry:
  %canary = alloca i32
  store i32 361800332, i32* %canary
  %q = alloca i32, align 4
  %stream.addr = alloca %struct._IO_FILE*, align 8
  %num.addr = alloca i64, align 8
  %den.addr = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @prratio.58(%struct._IO_FILE* %stream, i64 %num, i64 %den) #0 {
entry:
  %stream.addr = alloca %struct._IO_FILE*, align 8
  %num.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 967058522, i32* %canary
  %q = alloca i32, align 4
  %den.addr = alloca i64, align 8
  store %struct._IO_FILE* %stream, %struct._IO_FILE** %stream.addr, align 8
  store i64 %num, i64* %num.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @cl_hash.59(i64 %hsize) #0 {
entry:
  %canary = alloca i32
  store i32 1267331769, i32* %canary
  %htab_p = alloca i64*, align 8
  %m1 = alloca i64, align 8
  %hsize.addr = alloca i64, align 8
  %i = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @cl_hash.60(i64 %hsize) #0 {
entry:
  %hsize.addr = alloca i64, align 8
  %i = alloca i64, align 8
  %htab_p = alloca i64*, align 8
  %canary = alloca i32
  store i32 2054669367, i32* %canary
  %m1 = alloca i64, align 8
  store i64 %hsize, i64* %hsize.addr, align 8
  %0 = load i64, i64* %hsize.addr, align 8
  %add.ptr = getelementptr inbounds i64, i64* getelementptr inbounds ([69001 x i64], [69001 x i64]* @htab, i64 0, i64 0), i64 %0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @cl_hash.61(i64 %hsize) #0 {
entry:
  %m1 = alloca i64, align 8
  %hsize.addr = alloca i64, align 8
  %canary = alloca i32
  store i32 878449527, i32* %canary
  %htab_p = alloca i64*, align 8
  %i = alloca i64, align 8
  store i64 %hsize, i64* %hsize.addr, align 8
  %0 = load i64, i64* %hsize.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @cl_hash.62(i64 %hsize) #0 {
entry:
  %canary = alloca i32
  store i32 1761110911, i32* %canary
  %m1 = alloca i64, align 8
  %i = alloca i64, align 8
  %htab_p = alloca i64*, align 8
  %hsize.addr = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @copystat.63(i8* %ifname, i8* %ofname) #0 {
entry:
  %mode = alloca i32, align 4
  %statbuf = alloca %struct.stat, align 8
  %timep = alloca %struct.utimbuf, align 8
  %canary = alloca i32
  store i32 47059950, i32* %canary
  %ofname.addr = alloca i8*, align 8
  %ifname.addr = alloca i8*, align 8
  store i8* %ifname, i8** %ifname.addr, align 8
  store i8* %ofname, i8** %ofname.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @prratio.64(%struct._IO_FILE* %stream, i64 %num, i64 %den) #0 {
entry:
  %canary = alloca i32
  store i32 1265064670, i32* %canary
  %num.addr = alloca i64, align 8
  %den.addr = alloca i64, align 8
  %q = alloca i32, align 4
  %stream.addr = alloca %struct._IO_FILE*, align 8
