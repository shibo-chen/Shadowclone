; ModuleID = 'blocksort.c.rand.4P2.bc'
...
func_BZ2_blockSort.15:                            ; preds = %ctrl0
  call void @BZ2_blockSort.15(%struct.EState* %s)
  ret void

func_BZ2_blockSort.16:                            ; preds = %ctrl1
  call void @BZ2_blockSort.16(%struct.EState* %s)
  ret void

func_BZ2_blockSort.21:                            ; preds = %ctrl1
  call void @BZ2_blockSort.21(%struct.EState* %s)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_BZ2_blockSort.15, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_BZ2_blockSort.16, label %func_BZ2_blockSort.21
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_fallbackSort.2, label %ctrl0

func_fallbackSort.2:                              ; preds = %rand_bb
  call void @fallbackSort.2(i32* %fmap, i32* %eclass, i32* %bhtab, i32 %nblock, i32 %verb)
  ret void

func_fallbackSort.4:                              ; preds = %ctrl0
  call void @fallbackSort.4(i32* %fmap, i32* %eclass, i32* %bhtab, i32 %nblock, i32 %verb)
  ret void

func_fallbackSort.26:                             ; preds = %ctrl1
  call void @fallbackSort.26(i32* %fmap, i32* %eclass, i32* %bhtab, i32 %nblock, i32 %verb)
  ret void

func_fallbackSort.30:                             ; preds = %ctrl1
  call void @fallbackSort.30(i32* %fmap, i32* %eclass, i32* %bhtab, i32 %nblock, i32 %verb)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_fallbackSort.4, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_fallbackSort.26, label %func_fallbackSort.30
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_mainSort.3, label %ctrl0

func_mainSort.3:                                  ; preds = %rand_bb
  call void @mainSort.3(i32* %ptr, i8* %block, i16* %quadrant, i32* %ftab, i32 %nblock, i32 %verb, i32* %budget)
  ret void

func_mainSort.12:                                 ; preds = %ctrl0
  call void @mainSort.12(i32* %ptr, i8* %block, i16* %quadrant, i32* %ftab, i32 %nblock, i32 %verb, i32* %budget)
  ret void
...
func_mainSort.20:                                 ; preds = %ctrl1
  call void @mainSort.20(i32* %ptr, i8* %block, i16* %quadrant, i32* %ftab, i32 %nblock, i32 %verb, i32* %budget)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_mainSort.12, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_mainSort.17, label %func_mainSort.20
}
...
func_fallbackQSort3.19:                           ; preds = %ctrl0
  call void @fallbackQSort3.19(i32* %fmap, i32* %eclass, i32 %loSt, i32 %hiSt)
  ret void

func_fallbackQSort3.31:                           ; preds = %ctrl1
  call void @fallbackQSort3.31(i32* %fmap, i32* %eclass, i32 %loSt, i32 %hiSt)
  ret void

func_fallbackQSort3.32:                           ; preds = %ctrl1
  call void @fallbackQSort3.32(i32* %fmap, i32* %eclass, i32 %loSt, i32 %hiSt)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_fallbackQSort3.19, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_fallbackQSort3.31, label %func_fallbackQSort3.32
}
...
func_fallbackSimpleSort.13:                       ; preds = %ctrl0
  call void @fallbackSimpleSort.13(i32* %fmap, i32* %eclass, i32 %lo, i32 %hi)
  ret void

func_fallbackSimpleSort.14:                       ; preds = %ctrl1
  call void @fallbackSimpleSort.14(i32* %fmap, i32* %eclass, i32 %lo, i32 %hi)
  ret void

func_fallbackSimpleSort.29:                       ; preds = %ctrl1
  call void @fallbackSimpleSort.29(i32* %fmap, i32* %eclass, i32 %lo, i32 %hi)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_fallbackSimpleSort.13, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_fallbackSimpleSort.14, label %func_fallbackSimpleSort.29
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_mainQSort3.5, label %ctrl0

func_mainQSort3.5:                                ; preds = %rand_bb
  call void @mainQSort3.5(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %loSt, i32 %hiSt, i32 %dSt, i32* %budget)
  ret void

func_mainQSort3.9:                                ; preds = %ctrl0
  call void @mainQSort3.9(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %loSt, i32 %hiSt, i32 %dSt, i32* %budget)
  ret void

func_mainQSort3.18:                               ; preds = %ctrl1
  call void @mainQSort3.18(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %loSt, i32 %hiSt, i32 %dSt, i32* %budget)
  ret void

func_mainQSort3.23:                               ; preds = %ctrl1
  call void @mainQSort3.23(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %loSt, i32 %hiSt, i32 %dSt, i32* %budget)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_mainQSort3.9, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_mainQSort3.18, label %func_mainQSort3.23
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_mainSimpleSort.8, label %ctrl0

func_mainSimpleSort.8:                            ; preds = %rand_bb
  call void @mainSimpleSort.8(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %lo, i32 %hi, i32 %d, i32* %budget)
  ret void

func_mainSimpleSort.25:                           ; preds = %ctrl0
  call void @mainSimpleSort.25(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %lo, i32 %hi, i32 %d, i32* %budget)
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_mainSimpleSort.25, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_mainSimpleSort.33, label %func_mainSimpleSort.35
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_mmed3.1, label %ctrl0

func_mmed3.1:                                     ; preds = %rand_bb
  %2 = call i8 @mmed3.1(i8 %a, i8 %b, i8 %c)
  ret i8 %2

func_mmed3.24:                                    ; preds = %ctrl0
  %3 = call i8 @mmed3.24(i8 %a, i8 %b, i8 %c)
  ret i8 %3

func_mmed3.34:                                    ; preds = %ctrl1
  %4 = call i8 @mmed3.34(i8 %a, i8 %b, i8 %c)
  ret i8 %4

func_mmed3.36:                                    ; preds = %ctrl1
  %5 = call i8 @mmed3.36(i8 %a, i8 %b, i8 %c)
  ret i8 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_mmed3.24, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_mmed3.34, label %func_mmed3.36
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_mainGtU.6, label %ctrl0

func_mainGtU.6:                                   ; preds = %rand_bb
  %2 = call i8 @mainGtU.6(i32 %i1, i32 %i2, i8* %block, i16* %quadrant, i32 %nblock, i32* %budget)
  ret i8 %2

func_mainGtU.22:                                  ; preds = %ctrl0
  %3 = call i8 @mainGtU.22(i32 %i1, i32 %i2, i8* %block, i16* %quadrant, i32 %nblock, i32* %budget)
  ret i8 %3

func_mainGtU.27:                                  ; preds = %ctrl1
  %4 = call i8 @mainGtU.27(i32 %i1, i32 %i2, i8* %block, i16* %quadrant, i32 %nblock, i32* %budget)
  ret i8 %4

func_mainGtU.28:                                  ; preds = %ctrl1
  %5 = call i8 @mainGtU.28(i32 %i1, i32 %i2, i8* %block, i16* %quadrant, i32 %nblock, i32* %budget)
  ret i8 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_mainGtU.22, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_mainGtU.27, label %func_mainGtU.28
}

; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @mmed3.1(i8 zeroext %a, i8 zeroext %b, i8 zeroext %c) #0 {
entry:
  %t = alloca i8, align 1
  %canary = alloca i32
  store i32 819682472, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @fallbackSort.2(i32* %fmap, i32* %eclass, i32* %bhtab, i32 %nblock, i32 %verb) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 541646541, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @mainSort.3(i32* %ptr, i8* %block, i16* %quadrant, i32* %ftab, i32 %nblock, i32 %verb, i32* %budget) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 579327763, i32* %canary
...
entry:
  ...
  %k = alloca i32, align 4
  %canary = alloca i32
  store i32 551529440, i32* %canary
  %i = alloca i32, align 4
  store i32* %fmap, i32** %fmap.addr, align 8
  store i32* %eclass, i32** %eclass.addr, align 8
  store i32* %bhtab, i32** %bhtab.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @mainQSort3.5(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %loSt, i32 %hiSt, i32 %dSt, i32* %budget) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 231506473, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @mainGtU.6(i32 %i1, i32 %i2, i8* %block, i16* %quadrant, i32 %nblock, i32* %budget) #0 {
entry:
  %block.addr = alloca i8*, align 8
  %quadrant.addr = alloca i16*, align 8
  ...
  %c1 = alloca i8, align 1
  %canary = alloca i32
  store i32 763933412, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1385881129, i32* %canary
  %lo = alloca i32, align 4
...
while.end192:                                     ; preds = %while.cond
  ...
  %190 = icmp eq i32 %189, 1385881129
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @mainSimpleSort.8(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %lo, i32 %hi, i32 %d, i32* %budget) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 1049811051, i32* %canary
  %ptr.addr = alloca i32*, align 8
  %block.addr = alloca i8*, align 8
  store i32* %ptr, i32** %ptr.addr, align 8
  store i8* %block, i8** %block.addr, align 8
...
for.end:                                          ; preds = %if.then94, %for.cond, %if.then
  ...
  %113 = icmp eq i32 %112, 1049811051
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @mainQSort3.9(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %loSt, i32 %hiSt, i32 %dSt, i32* %budget) #0 {
entry:
  %ptr.addr = alloca i32*, align 8
  %zztmp141 = alloca i32, align 4
  %lo = alloca i32, align 4
  ...
  %budget.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 1827827303, i32* %canary
  %loSt.addr = alloca i32, align 4
  %tz235 = alloca i32, align 4
  %sp = alloca i32, align 4
  %quadrant.addr = alloca i16*, align 8
...
while.end302:                                     ; preds = %if.then16, %while.cond
  %253 = load i32, i32* %canary
  %254 = icmp eq i32 %253, 1827827303
  br i1 %254, label %255, label %func_exit
...
entry:
  ...
  %canary = alloca i32
  store i32 964799905, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1828376738, i32* %canary
  %i = alloca i32, align 4
  %hi.addr = alloca i32, align 4
  %eclass.addr = alloca i32*, align 8
  %fmap.addr = alloca i32*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @mainSort.12(i32* %ptr, i8* %block, i16* %quadrant, i32* %ftab, i32 %nblock, i32 %verb, i32* %budget) #0 {
entry:
  %shifts = alloca i32, align 4
  %copyEnd = alloca [256 x i32], align 16
  %numQSorted = alloca i32, align 4
  ...
  %nblock.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 556289256, i32* %canary
  %verb.addr = alloca i32, align 4
  %hi = alloca i32, align 4
  %s = alloca i16, align 2
  %k = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @fallbackSimpleSort.13(i32* %fmap, i32* %eclass, i32 %lo, i32 %hi) #0 {
entry:
  %tmp = alloca i32, align 4
  %lo.addr = alloca i32, align 4
  %j = alloca i32, align 4
  ...
  %ec_tmp = alloca i32, align 4
  %canary = alloca i32
  store i32 648394455, i32* %canary
  %hi.addr = alloca i32, align 4
  %fmap.addr = alloca i32*, align 8
  store i32* %fmap, i32** %fmap.addr, align 8
  store i32* %eclass, i32** %eclass.addr, align 8
...
entry:
  ...
  %fmap.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 1144219950, i32* %canary
  %j = alloca i32, align 4
  %lo.addr = alloca i32, align 4
  store i32* %fmap, i32** %fmap.addr, align 8
  store i32* %eclass, i32** %eclass.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @BZ2_blockSort.15(%struct.EState* %s) #0 {
entry:
  %quadrant = alloca i16*, align 8
  %ptr = alloca i32*, align 8
  %budget = alloca i32, align 4
  ...
  %budgetInit = alloca i32, align 4
  %canary = alloca i32
  store i32 353577192, i32* %canary
  %block = alloca i8*, align 8
  %i = alloca i32, align 4
  %s.addr = alloca %struct.EState*, align 8
  %nblock = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @BZ2_blockSort.16(%struct.EState* %s) #0 {
entry:
  %wfact = alloca i32, align 4
  %s.addr = alloca %struct.EState*, align 8
  %quadrant = alloca i16*, align 8
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 215098502, i32* %canary
  %nblock = alloca i32, align 4
  %ftab = alloca i32*, align 8
  %ptr = alloca i32*, align 8
  %block = alloca i8*, align 8
...
entry:
  ...
  %qVal = alloca i16, align 2
  %canary = alloca i32
  store i32 1462494790, i32* %canary
  %ss = alloca i32, align 4
  %numQSorted = alloca i32, align 4
  %sb = alloca i32, align 4
  %vv = alloca i32, align 4
...
if.end514:                                        ; preds = %if.then511, %for.end508, %if.then318
  %345 = load i32, i32* %canary
  %346 = icmp eq i32 %345, 1462494790
  br i1 %346, label %347, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @mainQSort3.18(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %loSt, i32 %hiSt, i32 %dSt, i32* %budget) #0 {
entry:
  %zztmp = alloca i32, align 4
  %canary = alloca i32
  store i32 414013560, i32* %canary
  %ptr.addr = alloca i32*, align 8
  %nextHi = alloca [3 x i32], align 4
  %yyp1 = alloca i32, align 4
  %tz = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @fallbackQSort3.19(i32* %fmap, i32* %eclass, i32 %loSt, i32 %hiSt) #0 {
entry:
  %hiSt.addr = alloca i32, align 4
  %n = alloca i32, align 4
  %yyp1 = alloca i32, align 4
  ...
  %hi = alloca i32, align 4
  %canary = alloca i32
  store i32 164293326, i32* %canary
  %zztmp147 = alloca i32, align 4
  %zztmp117 = alloca i32, align 4
  %med = alloca i32, align 4
  %fmap.addr = alloca i32*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @mainSort.20(i32* %ptr, i8* %block, i16* %quadrant, i32* %ftab, i32 %nblock, i32 %verb, i32* %budget) #0 {
entry:
  %ptr.addr = alloca i32*, align 8
  %a2update = alloca i32, align 4
  %quadrant.addr = alloca i16*, align 8
  ...
  %copyEnd = alloca [256 x i32], align 16
  %canary = alloca i32
  store i32 1227366408, i32* %canary
  %bbSize = alloca i32, align 4
  %hi = alloca i32, align 4
  %h = alloca i32, align 4
  store i32* %ptr, i32** %ptr.addr, align 8
...
if.end514:                                        ; preds = %if.then511, %for.end508, %if.then318
  %345 = load i32, i32* %canary
  %346 = icmp eq i32 %345, 1227366408
  br i1 %346, label %347, label %func_exit
...
entry:
  ...
  %verb = alloca i32, align 4
  %canary = alloca i32
  store i32 1511487274, i32* %canary
  %s.addr = alloca %struct.EState*, align 8
  %ptr = alloca i32*, align 8
  %budget = alloca i32, align 4
  %wfact = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @mainGtU.22(i32 %i1, i32 %i2, i8* %block, i16* %quadrant, i32 %nblock, i32* %budget) #0 {
entry:
  %budget.addr = alloca i32*, align 8
  %s1 = alloca i16, align 2
  %i2.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @mainQSort3.23(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %loSt, i32 %hiSt, i32 %dSt, i32* %budget) #0 {
entry:
  %med = alloca i32, align 4
  %nblock.addr = alloca i32, align 4
  %block.addr = alloca i8*, align 8
  ...
  %d = alloca i32, align 4
  %canary = alloca i32
  store i32 1264012851, i32* %canary
  %nextLo = alloca [3 x i32], align 4
  %nextD = alloca [3 x i32], align 4
  %n = alloca i32, align 4
  store i32* %ptr, i32** %ptr.addr, align 8
...
while.end302:                                     ; preds = %if.then16, %while.cond
  %253 = load i32, i32* %canary
  %254 = icmp eq i32 %253, 1264012851
  br i1 %254, label %255, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @mmed3.24(i8 zeroext %a, i8 zeroext %b, i8 zeroext %c) #0 {
entry:
  %c.addr = alloca i8, align 1
  %a.addr = alloca i8, align 1
  %b.addr = alloca i8, align 1
  %canary = alloca i32
  store i32 233084347, i32* %canary
  %t = alloca i8, align 1
  store i8 %a, i8* %a.addr, align 1
  store i8 %b, i8* %b.addr, align 1
  store i8 %c, i8* %c.addr, align 1
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @mainSimpleSort.25(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %lo, i32 %hi, i32 %d, i32* %budget) #0 {
entry:
  %hi.addr = alloca i32, align 4
  %lo.addr = alloca i32, align 4
  %block.addr = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @fallbackSort.26(i32* %fmap, i32* %eclass, i32* %bhtab, i32 %nblock, i32 %verb) #0 {
entry:
  %nblock.addr = alloca i32, align 4
  %eclass.addr = alloca i32*, align 8
  %verb.addr = alloca i32, align 4
  ...
  %r = alloca i32, align 4
  %canary = alloca i32
  store i32 1946059703, i32* %canary
  %fmap.addr = alloca i32*, align 8
  %H = alloca i32, align 4
  %j = alloca i32, align 4
  %i = alloca i32, align 4
...
if.end298:                                        ; preds = %if.then297, %for.end294
  %182 = load i32, i32* %canary
  %183 = icmp eq i32 %182, 1946059703
  br i1 %183, label %184, label %func_exit
...
entry:
  ...
  %retval = alloca i8, align 1
  %canary = alloca i32
  store i32 1082631631, i32* %canary
  %budget.addr = alloca i32*, align 8
  %i1.addr = alloca i32, align 4
  %quadrant.addr = alloca i16*, align 8
  %block.addr = alloca i8*, align 8
...
return:                                           ; preds = %do.end, %if.then445, %if.then430, %if.then413, %if.then398, %if.then381, %if.then366, %if.then349, %if.then334, %if.then317, %if.then302, %if.then285, %if.then270, %if.then253, %if.then238, %if.then221, %if.then206, %if.then189, %if.then172, %if.then155, %if.then138, %if.then121, %if.then104, %if.then87, %if.then70, %if.then53, %if.then36, %if.then19, %if.then
  %333 = load i8, i8* %retval, align 1
  %334 = load i32, i32* %canary
  %335 = icmp eq i32 %334, 1082631631
  br i1 %335, label %336, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @mainGtU.28(i32 %i1, i32 %i2, i8* %block, i16* %quadrant, i32 %nblock, i32* %budget) #0 {
entry:
  %s2 = alloca i16, align 2
  %i1.addr = alloca i32, align 4
  %nblock.addr = alloca i32, align 4
  ...
  %k = alloca i32, align 4
  %canary = alloca i32
  store i32 1822007640, i32* %canary
  %c2 = alloca i8, align 1
  %retval = alloca i8, align 1
  %budget.addr = alloca i32*, align 8
  %s1 = alloca i16, align 2
...
return:                                           ; preds = %do.end, %if.then445, %if.then430, %if.then413, %if.then398, %if.then381, %if.then366, %if.then349, %if.then334, %if.then317, %if.then302, %if.then285, %if.then270, %if.then253, %if.then238, %if.then221, %if.then206, %if.then189, %if.then172, %if.then155, %if.then138, %if.then121, %if.then104, %if.then87, %if.then70, %if.then53, %if.then36, %if.then19, %if.then
  %333 = load i8, i8* %retval, align 1
  %334 = load i32, i32* %canary
  %335 = icmp eq i32 %334, 1822007640
  br i1 %335, label %336, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @fallbackSimpleSort.29(i32* %fmap, i32* %eclass, i32 %lo, i32 %hi) #0 {
entry:
  %fmap.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 1296780302, i32* %canary
  %i = alloca i32, align 4
  %eclass.addr = alloca i32*, align 8
  %lo.addr = alloca i32, align 4
  %ec_tmp = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @fallbackQSort3.31(i32* %fmap, i32* %eclass, i32 %loSt, i32 %hiSt) #0 {
entry:
  %unLo = alloca i32, align 4
  %hiSt.addr = alloca i32, align 4
  %yyn = alloca i32, align 4
  ...
  %m = alloca i32, align 4
  %canary = alloca i32
  store i32 786013276, i32* %canary
  %sp = alloca i32, align 4
  %yyp2 = alloca i32, align 4
  %hi = alloca i32, align 4
  %stackHi = alloca [100 x i32], align 16
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @fallbackQSort3.32(i32* %fmap, i32* %eclass, i32 %loSt, i32 %hiSt) #0 {
entry:
  %hi = alloca i32, align 4
  %zztmp117 = alloca i32, align 4
  %m = alloca i32, align 4
  ...
  %r3 = alloca i32, align 4
  %canary = alloca i32
  store i32 1696691546, i32* %canary
  %n = alloca i32, align 4
  %zztmp93 = alloca i32, align 4
  %unLo = alloca i32, align 4
  %zztmp147 = alloca i32, align 4
...
while.end192:                                     ; preds = %while.cond
  %189 = load i32, i32* %canary
  %190 = icmp eq i32 %189, 1696691546
  br i1 %190, label %191, label %func_exit
...
entry:
  ...
  %t = alloca i8, align 1
  %canary = alloca i32
  store i32 1330357372, i32* %canary
  %c.addr = alloca i8, align 1
  %a.addr = alloca i8, align 1
  store i8 %a, i8* %a.addr, align 1
  store i8 %b, i8* %b.addr, align 1
...
entry:
  ...
  %v = alloca i32, align 4
  %canary = alloca i32
  store i32 1933812819, i32* %canary
  %h = alloca i32, align 4
  %hi.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %block.addr = alloca i8*, align 8
...
for.end:                                          ; preds = %if.then94, %for.cond, %if.then
  %112 = load i32, i32* %canary
  %113 = icmp eq i32 %112, 1933812819
  br i1 %113, label %114, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @mmed3.36(i8 zeroext %a, i8 zeroext %b, i8 zeroext %c) #0 {
entry:
  %b.addr = alloca i8, align 1
  %canary = alloca i32
  store i32 154136064, i32* %canary
  %c.addr = alloca i8, align 1
  %a.addr = alloca i8, align 1
  %t = alloca i8, align 1
  store i8 %a, i8* %a.addr, align 1
