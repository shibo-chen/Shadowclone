...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_fopen_output_safely.21, label %ctrl0

func_fopen_output_safely.21:                      ; preds = %rand_bb
  %2 = call %struct._IO_FILE* @fopen_output_safely.21(i8* %name, i8* %mode)
...
func_fopen_output_safely.89:                      ; preds = %ctrl1
  %4 = call %struct._IO_FILE* @fopen_output_safely.89(i8* %name, i8* %mode)
...
ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_fopen_output_safely.89, label %func_fopen_output_safely.90
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_copyFileName.5, label %func_copyFileName.38

func_copyFileName.5:                              ; preds = %rand_bb
  call void @copyFileName.5(i8* %to, i8* %from)
  ret void
...
func_addFlagsFromEnvVar.68:                       ; preds = %ctrl0
  call void @addFlagsFromEnvVar.68(%struct.zzzz** %argList, i8* %varName)
  ret void

func_addFlagsFromEnvVar.86:                       ; preds = %ctrl1
  call void @addFlagsFromEnvVar.86(%struct.zzzz** %argList, i8* %varName)
  ret void

func_addFlagsFromEnvVar.88:                       ; preds = %ctrl1
  call void @addFlagsFromEnvVar.88(%struct.zzzz** %argList, i8* %varName)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_addFlagsFromEnvVar.68, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_addFlagsFromEnvVar.86, label %func_addFlagsFromEnvVar.88
}
...
func_snocString.39:                               ; preds = %ctrl0
  %3 = call %struct.zzzz* @snocString.39(%struct.zzzz* %root, i8* %name)
  ret %struct.zzzz* %3

func_snocString.61:                               ; preds = %ctrl1
  %4 = call %struct.zzzz* @snocString.61(%struct.zzzz* %root, i8* %name)
  ret %struct.zzzz* %4
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_snocString.39, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_snocString.61, label %func_snocString.95
}
...
func_compress.6:                                  ; preds = %ctrl0
  call void @compress.6(i8* %name)
  ret void

func_compress.16:                                 ; preds = %ctrl1
  call void @compress.16(i8* %name)
  ret void

func_compress.22:                                 ; preds = %ctrl1
  call void @compress.22(i8* %name)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_compress.6, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_compress.16, label %func_compress.22
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_uncompress.11, label %ctrl0

func_uncompress.11:                               ; preds = %rand_bb
  call void @uncompress.11(i8* %name)
  ret void
...
func_uncompress.19:                               ; preds = %ctrl1
  call void @uncompress.19(i8* %name)
  ret void

func_uncompress.77:                               ; preds = %ctrl1
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_uncompress.19, label %func_uncompress.77
}
...
func_testf.40:                                    ; preds = %ctrl0
  call void @testf.40(i8* %name)
  ret void

func_testf.46:                                    ; preds = %ctrl1
  call void @testf.46(i8* %name)
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_testf.40, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_testf.46, label %func_testf.49
}
...
func_cleanUpAndFail.72:                           ; preds = %ctrl0
  call void @cleanUpAndFail.72(i32 %ec)
  ret void
...
func_cleanUpAndFail.91:                           ; preds = %ctrl1
  call void @cleanUpAndFail.91(i32 %ec)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_cleanUpAndFail.72, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_cleanUpAndFail.79, label %func_cleanUpAndFail.91
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_myMalloc.7, label %func_myMalloc.9

func_myMalloc.7:                                  ; preds = %rand_bb
  %2 = call i8* @myMalloc.7(i32 %n)
  ret i8* %2

func_myMalloc.9:                                  ; preds = %rand_bb
  %3 = call i8* @myMalloc.9(i32 %n)
  ret i8* %3
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_fileExists.41, label %ctrl0

func_fileExists.41:                               ; preds = %rand_bb
  %2 = call i8 @fileExists.41(i8* %name)
  ret i8 %2

func_fileExists.73:                               ; preds = %ctrl0
  %3 = call i8 @fileExists.73(i8* %name)
  ret i8 %3

func_fileExists.76:                               ; preds = %ctrl1
  %4 = call i8 @fileExists.76(i8* %name)
  ret i8 %4

func_fileExists.80:                               ; preds = %ctrl1
  %5 = call i8 @fileExists.80(i8* %name)
  ret i8 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_fileExists.73, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_fileExists.76, label %func_fileExists.80
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_hasSuffix.56, label %ctrl0

func_hasSuffix.56:                                ; preds = %rand_bb
  %2 = call i8 @hasSuffix.56(i8* %s, i8* %suffix)
  ret i8 %2

func_hasSuffix.65:                                ; preds = %ctrl0
  %3 = call i8 @hasSuffix.65(i8* %s, i8* %suffix)
  ret i8 %3

func_hasSuffix.71:                                ; preds = %ctrl1
  %4 = call i8 @hasSuffix.71(i8* %s, i8* %suffix)
  ret i8 %4
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_hasSuffix.65, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_hasSuffix.71, label %func_hasSuffix.74
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_notAStandardFile.13, label %ctrl0

func_notAStandardFile.13:                         ; preds = %rand_bb
  %2 = call i8 @notAStandardFile.13(i8* %name)
  ret i8 %2

func_notAStandardFile.52:                         ; preds = %ctrl0
  %3 = call i8 @notAStandardFile.52(i8* %name)
  ret i8 %3

func_notAStandardFile.53:                         ; preds = %ctrl1
  %4 = call i8 @notAStandardFile.53(i8* %name)
  ret i8 %4

func_notAStandardFile.57:                         ; preds = %ctrl1
  %5 = call i8 @notAStandardFile.57(i8* %name)
  ret i8 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_notAStandardFile.52, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_notAStandardFile.53, label %func_notAStandardFile.57
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_countHardLinks.32, label %ctrl0

func_countHardLinks.32:                           ; preds = %rand_bb
  %2 = call i32 @countHardLinks.32(i8* %name)
  ret i32 %2

func_countHardLinks.59:                           ; preds = %ctrl0
  %3 = call i32 @countHardLinks.59(i8* %name)
  ret i32 %3

func_countHardLinks.70:                           ; preds = %ctrl1
  %4 = call i32 @countHardLinks.70(i8* %name)
  ret i32 %4
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_countHardLinks.59, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_countHardLinks.70, label %func_countHardLinks.84
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_saveInputFileMetaInfo.1, label %func_saveInputFileMetaInfo.27

func_saveInputFileMetaInfo.1:                     ; preds = %rand_bb
  call void @saveInputFileMetaInfo.1(i8* %srcName)
  ret void

func_saveInputFileMetaInfo.27:                    ; preds = %rand_bb
  call void @saveInputFileMetaInfo.27(i8* %srcName)
  ret void
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_pad.33, label %func_pad.42

func_pad.33:                                      ; preds = %rand_bb
  call void @pad.33(i8* %s)
  ret void

func_pad.42:                                      ; preds = %rand_bb
  call void @pad.42(i8* %s)
  ret void
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_compressStream.3, label %ctrl0

func_compressStream.3:                            ; preds = %rand_bb
  call void @compressStream.3(%struct._IO_FILE* %stream, %struct._IO_FILE* %zStream)
  ret void

func_compressStream.24:                           ; preds = %ctrl0
  call void @compressStream.24(%struct._IO_FILE* %stream, %struct._IO_FILE* %zStream)
  ret void

func_compressStream.43:                           ; preds = %ctrl1
  call void @compressStream.43(%struct._IO_FILE* %stream, %struct._IO_FILE* %zStream)
  ret void

func_compressStream.75:                           ; preds = %ctrl1
  call void @compressStream.75(%struct._IO_FILE* %stream, %struct._IO_FILE* %zStream)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_compressStream.24, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_compressStream.43, label %func_compressStream.75
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_applySavedMetaInfoToOutputFile.78, label %ctrl0

func_applySavedMetaInfoToOutputFile.78:           ; preds = %rand_bb
  call void @applySavedMetaInfoToOutputFile.78(i8* %dstName)
  ret void

func_applySavedMetaInfoToOutputFile.87:           ; preds = %ctrl0
  call void @applySavedMetaInfoToOutputFile.87(i8* %dstName)
  ret void

func_applySavedMetaInfoToOutputFile.92:           ; preds = %ctrl1
  call void @applySavedMetaInfoToOutputFile.92(i8* %dstName)
  ret void

func_applySavedMetaInfoToOutputFile.93:           ; preds = %ctrl1
  call void @applySavedMetaInfoToOutputFile.93(i8* %dstName)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_applySavedMetaInfoToOutputFile.87, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_applySavedMetaInfoToOutputFile.92, label %func_applySavedMetaInfoToOutputFile.93
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_myfeof.18, label %ctrl0

func_myfeof.18:                                   ; preds = %rand_bb
  %2 = call i8 @myfeof.18(%struct._IO_FILE* %f)
  ret i8 %2

func_myfeof.26:                                   ; preds = %ctrl0
  %3 = call i8 @myfeof.26(%struct._IO_FILE* %f)
  ret i8 %3

func_myfeof.35:                                   ; preds = %ctrl1
  %4 = call i8 @myfeof.35(%struct._IO_FILE* %f)
  ret i8 %4

func_myfeof.64:                                   ; preds = %ctrl1
  %5 = call i8 @myfeof.64(%struct._IO_FILE* %f)
  ret i8 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_myfeof.26, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_myfeof.35, label %func_myfeof.64
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_uInt64_from_UInt32s.44, label %ctrl0

func_uInt64_from_UInt32s.44:                      ; preds = %rand_bb
  call void @uInt64_from_UInt32s.44(%struct.UInt64* %n, i32 %lo32, i32 %hi32)
  ret void

func_uInt64_from_UInt32s.50:                      ; preds = %ctrl0
  call void @uInt64_from_UInt32s.50(%struct.UInt64* %n, i32 %lo32, i32 %hi32)
  ret void
...
func_uInt64_from_UInt32s.96:                      ; preds = %ctrl1
  call void @uInt64_from_UInt32s.96(%struct.UInt64* %n, i32 %lo32, i32 %hi32)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_uInt64_from_UInt32s.50, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_uInt64_from_UInt32s.85, label %func_uInt64_from_UInt32s.96
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_uInt64_to_double.14, label %ctrl0

func_uInt64_to_double.14:                         ; preds = %rand_bb
  %2 = call double @uInt64_to_double.14(%struct.UInt64* %n)
  ret double %2

func_uInt64_to_double.37:                         ; preds = %ctrl0
  %3 = call double @uInt64_to_double.37(%struct.UInt64* %n)
  ret double %3

func_uInt64_to_double.48:                         ; preds = %ctrl1
  %4 = call double @uInt64_to_double.48(%struct.UInt64* %n)
  ret double %4
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_uInt64_to_double.37, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_uInt64_to_double.48, label %func_uInt64_to_double.58
}
...
func_uInt64_toAscii.8:                            ; preds = %ctrl0
  call void @uInt64_toAscii.8(i8* %outbuf, %struct.UInt64* %n)
  ret void

func_uInt64_toAscii.82:                           ; preds = %ctrl1
  call void @uInt64_toAscii.82(i8* %outbuf, %struct.UInt64* %n)
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_uInt64_toAscii.8, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_uInt64_toAscii.82, label %func_uInt64_toAscii.94
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_uInt64_qrm10.17, label %ctrl0

func_uInt64_qrm10.17:                             ; preds = %rand_bb
  %2 = call i32 @uInt64_qrm10.17(%struct.UInt64* %n)
  ret i32 %2

func_uInt64_qrm10.20:                             ; preds = %ctrl0
  %3 = call i32 @uInt64_qrm10.20(%struct.UInt64* %n)
  ret i32 %3

func_uInt64_qrm10.28:                             ; preds = %ctrl1
  %4 = call i32 @uInt64_qrm10.28(%struct.UInt64* %n)
  ret i32 %4

func_uInt64_qrm10.30:                             ; preds = %ctrl1
  %5 = call i32 @uInt64_qrm10.30(%struct.UInt64* %n)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_uInt64_qrm10.20, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_uInt64_qrm10.28, label %func_uInt64_qrm10.30
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_uInt64_isZero.23, label %ctrl0

func_uInt64_isZero.23:                            ; preds = %rand_bb
  %2 = call i8 @uInt64_isZero.23(%struct.UInt64* %n)
  ret i8 %2

func_uInt64_isZero.31:                            ; preds = %ctrl0
  %3 = call i8 @uInt64_isZero.31(%struct.UInt64* %n)
  ret i8 %3

func_uInt64_isZero.51:                            ; preds = %ctrl1
  %4 = call i8 @uInt64_isZero.51(%struct.UInt64* %n)
  ret i8 %4

func_uInt64_isZero.62:                            ; preds = %ctrl1
  %5 = call i8 @uInt64_isZero.62(%struct.UInt64* %n)
  ret i8 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_uInt64_isZero.31, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_uInt64_isZero.51, label %func_uInt64_isZero.62
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_mapSuffix.66, label %ctrl0

func_mapSuffix.66:                                ; preds = %rand_bb
  %2 = call i8 @mapSuffix.66(i8* %name, i8* %oldSuffix, i8* %newSuffix)
  ret i8 %2

func_mapSuffix.67:                                ; preds = %ctrl0
  %3 = call i8 @mapSuffix.67(i8* %name, i8* %oldSuffix, i8* %newSuffix)
  ret i8 %3

func_mapSuffix.81:                                ; preds = %ctrl1
  %4 = call i8 @mapSuffix.81(i8* %name, i8* %oldSuffix, i8* %newSuffix)
  ret i8 %4

func_mapSuffix.83:                                ; preds = %ctrl1
  %5 = call i8 @mapSuffix.83(i8* %name, i8* %oldSuffix, i8* %newSuffix)
  ret i8 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_mapSuffix.67, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_mapSuffix.81, label %func_mapSuffix.83
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_uncompressStream.25, label %ctrl0

func_uncompressStream.25:                         ; preds = %rand_bb
  %2 = call i8 @uncompressStream.25(%struct._IO_FILE* %zStream, %struct._IO_FILE* %stream)
  ret i8 %2

func_uncompressStream.36:                         ; preds = %ctrl0
  %3 = call i8 @uncompressStream.36(%struct._IO_FILE* %zStream, %struct._IO_FILE* %stream)
  ret i8 %3

func_uncompressStream.45:                         ; preds = %ctrl1
  %4 = call i8 @uncompressStream.45(%struct._IO_FILE* %zStream, %struct._IO_FILE* %stream)
  ret i8 %4

func_uncompressStream.47:                         ; preds = %ctrl1
  %5 = call i8 @uncompressStream.47(%struct._IO_FILE* %zStream, %struct._IO_FILE* %stream)
  ret i8 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_uncompressStream.36, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_uncompressStream.45, label %func_uncompressStream.47
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_testStream.34, label %ctrl0

func_testStream.34:                               ; preds = %rand_bb
  %2 = call i8 @testStream.34(%struct._IO_FILE* %zStream)
  ret i8 %2

func_testStream.54:                               ; preds = %ctrl0
  %3 = call i8 @testStream.54(%struct._IO_FILE* %zStream)
  ret i8 %3

func_testStream.60:                               ; preds = %ctrl1
  %4 = call i8 @testStream.60(%struct._IO_FILE* %zStream)
  ret i8 %4

func_testStream.63:                               ; preds = %ctrl1
  %5 = call i8 @testStream.63(%struct._IO_FILE* %zStream)
  ret i8 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_testStream.54, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_testStream.60, label %func_testStream.63
}

; Function Attrs: noinline nounwind optnone uwtable
define internal void @saveInputFileMetaInfo.1(i8* %srcName) #0 {
entry:
  %canary = alloca i32
  store i32 1818793432, i32* %canary
  %retVal = alloca i32, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 1671127786, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @compressStream.3(%struct._IO_FILE* %stream, %struct._IO_FILE* %zStream) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 893962675, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 779672116, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @copyFileName.5(i8* %to, i8* %from) #0 {
entry:
  %from.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1853011895, i32* %canary
...
entry:
  ...
  %n = alloca i32, align 4
  %canary = alloca i32
  store i32 943116810, i32* %canary
  %retVal = alloca i32, align 4
  %name.addr = alloca i8*, align 8
  %statBuf = alloca %struct.stat, align 8
  store i8* %name, i8** %name.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 274994023, i32* %canary
  %p = alloca i8*, align 8
  %n.addr = alloca i32, align 4
  store i32 %n, i32* %n.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @uInt64_toAscii.8(i8* %outbuf, %struct.UInt64* %n) #0 {
entry:
  %outbuf.addr = alloca i8*, align 8
  %q = alloca i32, align 4
  %n.addr = alloca %struct.UInt64*, align 8
  ...
  %nBuf = alloca i32, align 4
  %canary = alloca i32
  store i32 1988802452, i32* %canary
  %buf = alloca [32 x i8], align 16
  %i = alloca i32, align 4
  store i8* %outbuf, i8** %outbuf.addr, align 8
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i8* @myMalloc.9(i32 %n) #0 {
entry:
  %n.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1003056492, i32* %canary
  %p = alloca i8*, align 8
  store i32 %n, i32* %n.addr, align 4
  %0 = load i32, i32* %n.addr, align 4
  %conv = sext i32 %0 to i64
...
entry:
  %canary = alloca i32
  store i32 808285335, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @uncompress.11(i8* %name) #0 {
entry:
  %statBuf = alloca %struct.stat, align 8
  %inStr = alloca %struct._IO_FILE*, align 8
  %retVal = alloca i32, align 4
  %canary = alloca i32
  store i32 1024569677, i32* %canary
  %outStr = alloca %struct._IO_FILE*, align 8
...
entry:
  ...
  %canary = alloca i32
  store i32 1693303693, i32* %canary
...
entry:
  %name.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 324342713, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal double @uInt64_to_double.14(%struct.UInt64* %n) #0 {
entry:
  %sum = alloca double, align 8
  %base = alloca double, align 8
  %canary = alloca i32
  store i32 229634170, i32* %canary
  %n.addr = alloca %struct.UInt64*, align 8
  %i = alloca i32, align 4
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1023779827, i32* %canary
  %retVal168 = alloca i32, align 4
  %outStr = alloca %struct._IO_FILE*, align 8
  %n = alloca i32, align 4
  %statBuf = alloca %struct.stat, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @compress.16(i8* %name) #0 {
entry:
  %canary = alloca i32
  store i32 2126613263, i32* %canary
  %retVal = alloca i32, align 4
  %name.addr = alloca i8*, align 8
  %inStr = alloca %struct._IO_FILE*, align 8
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @uInt64_qrm10.17(%struct.UInt64* %n) #0 {
entry:
  %rem = alloca i32, align 4
  %n.addr = alloca %struct.UInt64*, align 8
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1834161978, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @myfeof.18(%struct._IO_FILE* %f) #0 {
entry:
  %c = alloca i32, align 4
  %canary = alloca i32
  store i32 2055486157, i32* %canary
  %retval = alloca i8, align 1
...
entry:
  ...
  %n = alloca i32, align 4
  %canary = alloca i32
  store i32 1378766046, i32* %canary
  %outStr = alloca %struct._IO_FILE*, align 8
  %cantGuess = alloca i8, align 1
  %statBuf = alloca %struct.stat, align 8
  %name.addr = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @uInt64_qrm10.20(%struct.UInt64* %n) #0 {
entry:
  %rem = alloca i32, align 4
  %tmp = alloca i32, align 4
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1957113823, i32* %canary
  %n.addr = alloca %struct.UInt64*, align 8
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
  store i32 0, i32* %rem, align 4
  store i32 7, i32* %i, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct._IO_FILE* @fopen_output_safely.21(i8* %name, i8* %mode) #0 {
entry:
  %retval = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 1996008279, i32* %canary
  %name.addr = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @compress.22(i8* %name) #0 {
entry:
  %retVal = alloca i32, align 4
  %canary = alloca i32
  store i32 1826860867, i32* %canary
  %i = alloca i32, align 4
  %name.addr = alloca i8*, align 8
  %statBuf = alloca %struct.stat, align 8
  %n = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 657495193, i32* %canary
  %retval = alloca i8, align 1
  %n.addr = alloca %struct.UInt64*, align 8
  %i = alloca i32, align 4
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @compressStream.24(%struct._IO_FILE* %stream, %struct._IO_FILE* %zStream) #0 {
entry:
  %nbytes_in_lo32 = alloca i32, align 4
  %bzerr_dummy = alloca i32, align 4
  %nbytes_out_d = alloca double, align 8
  ...
  %nbytes_out = alloca %struct.UInt64, align 1
  %canary = alloca i32
  store i32 1058302993, i32* %canary
  %nbytes_in_hi32 = alloca i32, align 4
  %bzf = alloca i8*, align 8
  %nbytes_in_d = alloca double, align 8
  %ibuf = alloca [5000 x i8], align 16
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @uncompressStream.25(%struct._IO_FILE* %zStream, %struct._IO_FILE* %stream) #0 {
entry:
  %bzf = alloca i8*, align 8
  %bzerr_dummy = alloca i32, align 4
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1346611842, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @myfeof.26(%struct._IO_FILE* %f) #0 {
entry:
  %retval = alloca i8, align 1
  %f.addr = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 952954634, i32* %canary
  %c = alloca i32, align 4
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** %f.addr, align 8
  %call = call i32 @fgetc(%struct._IO_FILE* %0)
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @saveInputFileMetaInfo.27(i8* %srcName) #0 {
entry:
  %srcName.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 597004765, i32* %canary
  %retVal = alloca i32, align 4
  store i8* %srcName, i8** %srcName.addr, align 8
  %0 = load i8*, i8** %srcName.addr, align 8
  %call = call i32 @stat(i8* %0, %struct.stat* @fileMetaInfo) #8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @uInt64_qrm10.28(%struct.UInt64* %n) #0 {
entry:
  %canary = alloca i32
  store i32 809469077, i32* %canary
  %tmp = alloca i32, align 4
  %i = alloca i32, align 4
  %rem = alloca i32, align 4
  %n.addr = alloca %struct.UInt64*, align 8
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 919613593, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @uInt64_qrm10.30(%struct.UInt64* %n) #0 {
entry:
  %canary = alloca i32
  store i32 818985026, i32* %canary
  %i = alloca i32, align 4
  %rem = alloca i32, align 4
  %n.addr = alloca %struct.UInt64*, align 8
  %tmp = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @uInt64_isZero.31(%struct.UInt64* %n) #0 {
entry:
  %canary = alloca i32
  store i32 1395374751, i32* %canary
  %n.addr = alloca %struct.UInt64*, align 8
  %retval = alloca i8, align 1
  %i = alloca i32, align 4
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @countHardLinks.32(i8* %name) #0 {
entry:
  %name.addr = alloca i8*, align 8
  %statBuf = alloca %struct.stat, align 8
  %canary = alloca i32
  store i32 425530863, i32* %canary
  %i = alloca i32, align 4
  %retval = alloca i32, align 4
  store i8* %name, i8** %name.addr, align 8
  %0 = load i8*, i8** %name.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @pad.33(i8* %s) #0 {
entry:
  %canary = alloca i32
  store i32 297623039, i32* %canary
  %i = alloca i32, align 4
  %s.addr = alloca i8*, align 8
  store i8* %s, i8** %s.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @testStream.34(%struct._IO_FILE* %zStream) #0 {
entry:
  %nUnused = alloca i32, align 4
  %unusedTmp = alloca i8*, align 8
  %streamNo = alloca i32, align 4
  ...
  %bzf = alloca i8*, align 8
  %canary = alloca i32
  store i32 1740366797, i32* %canary
  %nread = alloca i32, align 4
  %zStream.addr = alloca %struct._IO_FILE*, align 8
  %i = alloca i32, align 4
  %unused = alloca [5000 x i8], align 16
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @myfeof.35(%struct._IO_FILE* %f) #0 {
entry:
  %canary = alloca i32
  store i32 680503971, i32* %canary
  %f.addr = alloca %struct._IO_FILE*, align 8
  %retval = alloca i8, align 1
  %c = alloca i32, align 4
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @uncompressStream.36(%struct._IO_FILE* %zStream, %struct._IO_FILE* %stream) #0 {
entry:
  %bzf = alloca i8*, align 8
  %streamNo = alloca i32, align 4
  %unused = alloca [5000 x i8], align 16
  ...
  %unusedTmpV = alloca i8*, align 8
  %canary = alloca i32
  store i32 828000742, i32* %canary
  %i = alloca i32, align 4
  %bzerr_dummy = alloca i32, align 4
  %zStream.addr = alloca %struct._IO_FILE*, align 8
  %obuf = alloca [5000 x i8], align 16
...
; Function Attrs: noinline nounwind optnone uwtable
define internal double @uInt64_to_double.37(%struct.UInt64* %n) #0 {
entry:
  %sum = alloca double, align 8
  %canary = alloca i32
  store i32 2130413249, i32* %canary
  %i = alloca i32, align 4
  %base = alloca double, align 8
  %n.addr = alloca %struct.UInt64*, align 8
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 766419121, i32* %canary
  %to.addr = alloca i8*, align 8
  %from.addr = alloca i8*, align 8
  store i8* %to, i8** %to.addr, align 8
  store i8* %from, i8** %from.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal %struct.zzzz* @snocString.39(%struct.zzzz* %root, i8* %name) #0 {
entry:
  %canary = alloca i32
  store i32 323033461, i32* %canary
  %tmp = alloca %struct.zzzz*, align 8
  %retval = alloca %struct.zzzz*, align 8
  %name.addr = alloca i8*, align 8
  %tmp6 = alloca %struct.zzzz*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @testf.40(i8* %name) #0 {
entry:
  %inStr = alloca %struct._IO_FILE*, align 8
  %name.addr = alloca i8*, align 8
  %statBuf = alloca %struct.stat, align 8
  %canary = alloca i32
  store i32 1060177960, i32* %canary
  %allOK = alloca i8, align 1
  store i8* %name, i8** %name.addr, align 8
  store i8 0, i8* @deleteOutputOnInterrupt, align 1
  %0 = load i8*, i8** %name.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @fileExists.41(i8* %name) #0 {
entry:
  %name.addr = alloca i8*, align 8
  %exists = alloca i8, align 1
  %canary = alloca i32
  store i32 1363527138, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @pad.42(i8* %s) #0 {
entry:
  %canary = alloca i32
  store i32 986291410, i32* %canary
  %s.addr = alloca i8*, align 8
  %i = alloca i32, align 4
  store i8* %s, i8** %s.addr, align 8
  %0 = load i8*, i8** %s.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @compressStream.43(%struct._IO_FILE* %stream, %struct._IO_FILE* %zStream) #0 {
entry:
  %buf_nin = alloca [32 x i8], align 16
  %bzerr_dummy = alloca i32, align 4
  %canary = alloca i32
  store i32 1981427382, i32* %canary
  %stream.addr = alloca %struct._IO_FILE*, align 8
  %nbytes_out = alloca %struct.UInt64, align 1
  %ret = alloca i32, align 4
  %nIbuf = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @uInt64_from_UInt32s.44(%struct.UInt64* %n, i32 %lo32, i32 %hi32) #0 {
entry:
  %n.addr = alloca %struct.UInt64*, align 8
  %lo32.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1483320438, i32* %canary
...
entry:
  ...
  %nUnused = alloca i32, align 4
  %canary = alloca i32
  store i32 210215943, i32* %canary
  %unused = alloca [5000 x i8], align 16
  %nread = alloca i32, align 4
  %zStream.addr = alloca %struct._IO_FILE*, align 8
  %bzerr_dummy = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @testf.46(i8* %name) #0 {
entry:
  %name.addr = alloca i8*, align 8
  %statBuf = alloca %struct.stat, align 8
  %canary = alloca i32
  store i32 434549388, i32* %canary
  %allOK = alloca i8, align 1
  %inStr = alloca %struct._IO_FILE*, align 8
  store i8* %name, i8** %name.addr, align 8
  store i8 0, i8* @deleteOutputOnInterrupt, align 1
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @uncompressStream.47(%struct._IO_FILE* %zStream, %struct._IO_FILE* %stream) #0 {
entry:
  %unusedTmpV = alloca i8*, align 8
  %stream.addr = alloca %struct._IO_FILE*, align 8
  %nread = alloca i32, align 4
  ...
  %unusedTmp = alloca i8*, align 8
  %canary = alloca i32
  store i32 1103329685, i32* %canary
  %ret = alloca i32, align 4
  %retval = alloca i8, align 1
  %obuf = alloca [5000 x i8], align 16
  %bzerr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal double @uInt64_to_double.48(%struct.UInt64* %n) #0 {
entry:
  %base = alloca double, align 8
  %sum = alloca double, align 8
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1912177004, i32* %canary
  %n.addr = alloca %struct.UInt64*, align 8
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
  store double 1.000000e+00, double* %base, align 8
  store double 0.000000e+00, double* %sum, align 8
...
entry:
  %allOK = alloca i8, align 1
  %canary = alloca i32
  store i32 753955887, i32* %canary
  %inStr = alloca %struct._IO_FILE*, align 8
  %statBuf = alloca %struct.stat, align 8
  %name.addr = alloca i8*, align 8
  store i8* %name, i8** %name.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @uInt64_from_UInt32s.50(%struct.UInt64* %n, i32 %lo32, i32 %hi32) #0 {
entry:
  %lo32.addr = alloca i32, align 4
  %hi32.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 862398673, i32* %canary
  %n.addr = alloca %struct.UInt64*, align 8
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
  store i32 %lo32, i32* %lo32.addr, align 4
  store i32 %hi32, i32* %hi32.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @uInt64_isZero.51(%struct.UInt64* %n) #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 289797731, i32* %canary
  %n.addr = alloca %struct.UInt64*, align 8
  %retval = alloca i8, align 1
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
  store i32 0, i32* %i, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @notAStandardFile.52(i8* %name) #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 8386195, i32* %canary
  %retval = alloca i8, align 1
  %name.addr = alloca i8*, align 8
  %statBuf = alloca %struct.stat, align 8
  store i8* %name, i8** %name.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @notAStandardFile.53(i8* %name) #0 {
entry:
  %statBuf = alloca %struct.stat, align 8
  %i = alloca i32, align 4
  %name.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 972983593, i32* %canary
  %retval = alloca i8, align 1
  store i8* %name, i8** %name.addr, align 8
  %0 = load i8*, i8** %name.addr, align 8
  %call = call i32 @lstat(i8* %0, %struct.stat* %statBuf) #8
...
entry:
  ...
  %unusedTmp = alloca i8*, align 8
  %canary = alloca i32
  store i32 862370386, i32* %canary
  %ret = alloca i32, align 4
  %bzerr_dummy = alloca i32, align 4
  %bzf = alloca i8*, align 8
  %nUnused = alloca i32, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 700172458, i32* %canary
  %statBuf = alloca %struct.stat, align 8
  %retVal = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @hasSuffix.56(i8* %s, i8* %suffix) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 1326551122, i32* %canary
  %s.addr = alloca i8*, align 8
  store i8* %s, i8** %s.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @notAStandardFile.57(i8* %name) #0 {
entry:
  %i = alloca i32, align 4
  %statBuf = alloca %struct.stat, align 8
  %retval = alloca i8, align 1
  %canary = alloca i32
  store i32 1451159569, i32* %canary
  %name.addr = alloca i8*, align 8
  store i8* %name, i8** %name.addr, align 8
  %0 = load i8*, i8** %name.addr, align 8
  %call = call i32 @lstat(i8* %0, %struct.stat* %statBuf) #8
...
entry:
  %canary = alloca i32
  store i32 1662837867, i32* %canary
  %sum = alloca double, align 8
  %n.addr = alloca %struct.UInt64*, align 8
  %base = alloca double, align 8
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @countHardLinks.59(i8* %name) #0 {
entry:
  %name.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1922334520, i32* %canary
  %i = alloca i32, align 4
  %statBuf = alloca %struct.stat, align 8
  %retval = alloca i32, align 4
  store i8* %name, i8** %name.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @testStream.60(%struct._IO_FILE* %zStream) #0 {
entry:
  %bzf = alloca i8*, align 8
  %retval = alloca i8, align 1
  %zStream.addr = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 135299058, i32* %canary
  %unused = alloca [5000 x i8], align 16
  %ret = alloca i32, align 4
  %bzerr = alloca i32, align 4
  %bzerr_dummy = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal %struct.zzzz* @snocString.61(%struct.zzzz* %root, i8* %name) #0 {
entry:
  %root.addr = alloca %struct.zzzz*, align 8
  %retval = alloca %struct.zzzz*, align 8
  %name.addr = alloca i8*, align 8
  %tmp6 = alloca %struct.zzzz*, align 8
  %canary = alloca i32
  store i32 777434511, i32* %canary
  %tmp = alloca %struct.zzzz*, align 8
  store %struct.zzzz* %root, %struct.zzzz** %root.addr, align 8
  store i8* %name, i8** %name.addr, align 8
  %0 = load %struct.zzzz*, %struct.zzzz** %root.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @uInt64_isZero.62(%struct.UInt64* %n) #0 {
entry:
  %canary = alloca i32
  store i32 231412526, i32* %canary
  %n.addr = alloca %struct.UInt64*, align 8
  %i = alloca i32, align 4
  %retval = alloca i8, align 1
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @testStream.63(%struct._IO_FILE* %zStream) #0 {
entry:
  %retval = alloca i8, align 1
  %streamNo = alloca i32, align 4
  %ret = alloca i32, align 4
  ...
  %nUnused = alloca i32, align 4
  %canary = alloca i32
  store i32 1378560744, i32* %canary
  %zStream.addr = alloca %struct._IO_FILE*, align 8
  %bzf = alloca i8*, align 8
  %bzerr = alloca i32, align 4
  %obuf = alloca [5000 x i8], align 16
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @myfeof.64(%struct._IO_FILE* %f) #0 {
entry:
  %f.addr = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 1267657879, i32* %canary
  %c = alloca i32, align 4
  %retval = alloca i8, align 1
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** %f.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @hasSuffix.65(i8* %s, i8* %suffix) #0 {
entry:
  %ns = alloca i32, align 4
  %suffix.addr = alloca i8*, align 8
  %nx = alloca i32, align 4
  %s.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 935300327, i32* %canary
  %retval = alloca i8, align 1
  store i8* %s, i8** %s.addr, align 8
  store i8* %suffix, i8** %suffix.addr, align 8
  %0 = load i8*, i8** %s.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @mapSuffix.66(i8* %name, i8* %oldSuffix, i8* %newSuffix) #0 {
entry:
  %oldSuffix.addr = alloca i8*, align 8
  %newSuffix.addr = alloca i8*, align 8
  %retval = alloca i8, align 1
  %canary = alloca i32
  store i32 972323773, i32* %canary
  %name.addr = alloca i8*, align 8
  store i8* %name, i8** %name.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @mapSuffix.67(i8* %name, i8* %oldSuffix, i8* %newSuffix) #0 {
entry:
  %oldSuffix.addr = alloca i8*, align 8
  %retval = alloca i8, align 1
  %canary = alloca i32
  store i32 292122975, i32* %canary
  %name.addr = alloca i8*, align 8
  %newSuffix.addr = alloca i8*, align 8
  store i8* %name, i8** %name.addr, align 8
  store i8* %oldSuffix, i8** %oldSuffix.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @addFlagsFromEnvVar.68(%struct.zzzz** %argList, i8* %varName) #0 {
entry:
  %canary = alloca i32
  store i32 1295243292, i32* %canary
  %p = alloca i8*, align 8
  %k = alloca i32, align 4
  %argList.addr = alloca %struct.zzzz**, align 8
  %i = alloca i32, align 4
...
entry:
  ...
  %retval = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 1481297782, i32* %canary
  %mode.addr = alloca i8*, align 8
  store i8* %name, i8** %name.addr, align 8
  store i8* %mode, i8** %mode.addr, align 8
  %0 = load i8*, i8** %name.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @countHardLinks.70(i8* %name) #0 {
entry:
  %name.addr = alloca i8*, align 8
  %statBuf = alloca %struct.stat, align 8
  %canary = alloca i32
  store i32 1794089095, i32* %canary
  %retval = alloca i32, align 4
  %i = alloca i32, align 4
  store i8* %name, i8** %name.addr, align 8
  %0 = load i8*, i8** %name.addr, align 8
...
entry:
  ...
  %s.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 976621431, i32* %canary
  %ns = alloca i32, align 4
  %nx = alloca i32, align 4
  %suffix.addr = alloca i8*, align 8
  store i8* %s, i8** %s.addr, align 8
...
; Function Attrs: noinline noreturn nounwind optnone uwtable
define internal void @cleanUpAndFail.72(i32 %ec) #5 {
entry:
  %canary = alloca i32
  store i32 2084757927, i32* %canary
  %ec.addr = alloca i32, align 4
  %retVal = alloca i32, align 4
  %statBuf = alloca %struct.stat, align 8
  store i32 %ec, i32* %ec.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @fileExists.73(i8* %name) #0 {
entry:
  %canary = alloca i32
  store i32 1554638091, i32* %canary
  %exists = alloca i8, align 1
  %tmp = alloca %struct._IO_FILE*, align 8
  %name.addr = alloca i8*, align 8
  store i8* %name, i8** %name.addr, align 8
...
entry:
  %nx = alloca i32, align 4
  %canary = alloca i32
  store i32 458810561, i32* %canary
  %s.addr = alloca i8*, align 8
  %retval = alloca i8, align 1
  %suffix.addr = alloca i8*, align 8
  %ns = alloca i32, align 4
...
entry:
  ...
  %nIbuf = alloca i32, align 4
  %canary = alloca i32
  store i32 1774561897, i32* %canary
  %nbytes_in_d = alloca double, align 8
  %stream.addr = alloca %struct._IO_FILE*, align 8
  %bzerr_dummy = alloca i32, align 4
  %bzerr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @fileExists.76(i8* %name) #0 {
entry:
  %name.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 987074707, i32* %canary
  %tmp = alloca %struct._IO_FILE*, align 8
  %exists = alloca i8, align 1
  store i8* %name, i8** %name.addr, align 8
  %0 = load i8*, i8** %name.addr, align 8
...
entry:
  ...
  %retVal168 = alloca i32, align 4
  %canary = alloca i32
  store i32 487537154, i32* %canary
  %i = alloca i32, align 4
  %statBuf = alloca %struct.stat, align 8
  %n = alloca i32, align 4
  store i8* %name, i8** %name.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @applySavedMetaInfoToOutputFile.78(i8* %dstName) #0 {
entry:
  %canary = alloca i32
  store i32 496905860, i32* %canary
  %retVal = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 338193521, i32* %canary
  %tmp = alloca %struct._IO_FILE*, align 8
  %exists = alloca i8, align 1
  %name.addr = alloca i8*, align 8
  store i8* %name, i8** %name.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @mapSuffix.81(i8* %name, i8* %oldSuffix, i8* %newSuffix) #0 {
entry:
  %name.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1843543778, i32* %canary
  %retval = alloca i8, align 1
  %oldSuffix.addr = alloca i8*, align 8
  %newSuffix.addr = alloca i8*, align 8
  store i8* %name, i8** %name.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @uInt64_toAscii.82(i8* %outbuf, %struct.UInt64* %n) #0 {
entry:
  %q = alloca i32, align 4
  %n_copy = alloca %struct.UInt64, align 1
  %n.addr = alloca %struct.UInt64*, align 8
  %canary = alloca i32
  store i32 564052520, i32* %canary
  %i = alloca i32, align 4
  %nBuf = alloca i32, align 4
  %buf = alloca [32 x i8], align 16
  %outbuf.addr = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @mapSuffix.83(i8* %name, i8* %oldSuffix, i8* %newSuffix) #0 {
entry:
  %oldSuffix.addr = alloca i8*, align 8
  %name.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 2027196860, i32* %canary
  %newSuffix.addr = alloca i8*, align 8
  %retval = alloca i8, align 1
  store i8* %name, i8** %name.addr, align 8
  store i8* %oldSuffix, i8** %oldSuffix.addr, align 8
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 759538136, i32* %canary
  %retval = alloca i32, align 4
  %name.addr = alloca i8*, align 8
  store i8* %name, i8** %name.addr, align 8
  %0 = load i8*, i8** %name.addr, align 8
...
entry:
  %lo32.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1593636861, i32* %canary
  %n.addr = alloca %struct.UInt64*, align 8
  %hi32.addr = alloca i32, align 4
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
  store i32 %lo32, i32* %lo32.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @addFlagsFromEnvVar.86(%struct.zzzz** %argList, i8* %varName) #0 {
entry:
  %i = alloca i32, align 4
  %p = alloca i8*, align 8
  %varName.addr = alloca i8*, align 8
  ...
  %argList.addr = alloca %struct.zzzz**, align 8
  %canary = alloca i32
  store i32 1016910697, i32* %canary
  %j = alloca i32, align 4
  store %struct.zzzz** %argList, %struct.zzzz*** %argList.addr, align 8
  store i8* %varName, i8** %varName.addr, align 8
  %0 = load i8*, i8** %varName.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @applySavedMetaInfoToOutputFile.87(i8* %dstName) #0 {
entry:
  %uTimBuf = alloca %struct.utimbuf, align 8
  %dstName.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 648071269, i32* %canary
  %retVal = alloca i32, align 4
  store i8* %dstName, i8** %dstName.addr, align 8
  %0 = load i64, i64* getelementptr inbounds (%struct.stat, %struct.stat* @fileMetaInfo, i32 0, i32 11, i32 0), align 8
  %actime = getelementptr inbounds %struct.utimbuf, %struct.utimbuf* %uTimBuf, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @addFlagsFromEnvVar.88(%struct.zzzz** %argList, i8* %varName) #0 {
entry:
  %i = alloca i32, align 4
  %envbase = alloca i8*, align 8
  %canary = alloca i32
  store i32 1665806989, i32* %canary
  %p = alloca i8*, align 8
  %k = alloca i32, align 4
  %varName.addr = alloca i8*, align 8
  %j = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct._IO_FILE* @fopen_output_safely.89(i8* %name, i8* %mode) #0 {
entry:
  %retval = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 564518496, i32* %canary
  %fp = alloca %struct._IO_FILE*, align 8
  %mode.addr = alloca i8*, align 8
  %fh = alloca i32, align 4
  %name.addr = alloca i8*, align 8
...
entry:
  ...
  %fp = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 1530596228, i32* %canary
  %retval = alloca %struct._IO_FILE*, align 8
  %fh = alloca i32, align 4
  %mode.addr = alloca i8*, align 8
  store i8* %name, i8** %name.addr, align 8
...
; Function Attrs: noinline noreturn nounwind optnone uwtable
define internal void @cleanUpAndFail.91(i32 %ec) #5 {
entry:
  %statBuf = alloca %struct.stat, align 8
  %canary = alloca i32
  store i32 1099926709, i32* %canary
  %ec.addr = alloca i32, align 4
  %retVal = alloca i32, align 4
  store i32 %ec, i32* %ec.addr, align 4
  %0 = load i32, i32* @srcMode, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @applySavedMetaInfoToOutputFile.92(i8* %dstName) #0 {
entry:
  %dstName.addr = alloca i8*, align 8
  %retVal = alloca i32, align 4
  %canary = alloca i32
  store i32 135237357, i32* %canary
  %uTimBuf = alloca %struct.utimbuf, align 8
  store i8* %dstName, i8** %dstName.addr, align 8
  %0 = load i64, i64* getelementptr inbounds (%struct.stat, %struct.stat* @fileMetaInfo, i32 0, i32 11, i32 0), align 8
  %actime = getelementptr inbounds %struct.utimbuf, %struct.utimbuf* %uTimBuf, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @applySavedMetaInfoToOutputFile.93(i8* %dstName) #0 {
entry:
  %retVal = alloca i32, align 4
  %canary = alloca i32
  store i32 1417852806, i32* %canary
  %uTimBuf = alloca %struct.utimbuf, align 8
  %dstName.addr = alloca i8*, align 8
  store i8* %dstName, i8** %dstName.addr, align 8
  %0 = load i64, i64* getelementptr inbounds (%struct.stat, %struct.stat* @fileMetaInfo, i32 0, i32 11, i32 0), align 8
...
entry:
  ...
  %nBuf = alloca i32, align 4
  %canary = alloca i32
  store i32 688303620, i32* %canary
  %outbuf.addr = alloca i8*, align 8
  %n.addr = alloca %struct.UInt64*, align 8
  %buf = alloca [32 x i8], align 16
  %q = alloca i32, align 4
...
entry:
  %retval = alloca %struct.zzzz*, align 8
  %canary = alloca i32
  store i32 2137110599, i32* %canary
  %tmp6 = alloca %struct.zzzz*, align 8
  %tmp = alloca %struct.zzzz*, align 8
  %name.addr = alloca i8*, align 8
  %root.addr = alloca %struct.zzzz*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @uInt64_from_UInt32s.96(%struct.UInt64* %n, i32 %lo32, i32 %hi32) #0 {
entry:
  %hi32.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 228207367, i32* %canary
  %n.addr = alloca %struct.UInt64*, align 8
  %lo32.addr = alloca i32, align 4
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
  store i32 %lo32, i32* %lo32.addr, align 4
