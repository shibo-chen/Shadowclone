; ModuleID = 'huffman.c.rand.4R1.bc'
...
func_BZ2_hbMakeCodeLengths.10:                    ; preds = %ctrl0
...
func_BZ2_hbMakeCodeLengths.12:                    ; preds = %ctrl1
  call void @BZ2_hbMakeCodeLengths.12(i8* %len, i32* %freq, i32 %alphaSize, i32 %maxLen)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_BZ2_hbMakeCodeLengths.10, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_BZ2_hbMakeCodeLengths.11, label %func_BZ2_hbMakeCodeLengths.12
}
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_BZ2_hbAssignCodes.7, label %func_BZ2_hbAssignCodes.8
}
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_BZ2_hbCreateDecodeTables.6, label %func_BZ2_hbCreateDecodeTables.9
}
...
entry:
  ...
  %canary = alloca i32
  store i32 163861996, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 2040281059, i32* %canary
  %i = alloca i32, align 4
...
while.end234:                                     ; preds = %if.then218
  ...
  %152 = icmp eq i32 %151, 2040281059
...
entry:
  ...
  %length.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1723803775, i32* %canary
  %limit.addr = alloca i32*, align 8
  %vec = alloca i32, align 4
  %alphaSize.addr = alloca i32, align 4
  %i = alloca i32, align 4
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 941988192, i32* %canary
  %length.addr = alloca i8*, align 8
  %minLen.addr = alloca i32, align 4
  %maxLen.addr = alloca i32, align 4
...
entry:
  %vec = alloca i32, align 4
  %canary = alloca i32
  store i32 979341676, i32* %canary
  %maxLen.addr = alloca i32, align 4
  %code.addr = alloca i32*, align 8
  %length.addr = alloca i8*, align 8
  %i = alloca i32, align 4
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 863070518, i32* %canary
  %i = alloca i32, align 4
  %pp = alloca i32, align 4
  %length.addr = alloca i8*, align 8
  %maxLen.addr = alloca i32, align 4
...
entry:
  ...
  %alphaSize.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1528647784, i32* %canary
  %code.addr = alloca i32*, align 8
  %n = alloca i32, align 4
  %vec = alloca i32, align 4
  %minLen.addr = alloca i32, align 4
...
entry:
  ...
  %n = alloca i32, align 4
  %canary = alloca i32
  store i32 1008669098, i32* %canary
  %maxLen.addr = alloca i32, align 4
  %minLen.addr = alloca i32, align 4
  store i32* %code, i32** %code.addr, align 8
  store i8* %length, i8** %length.addr, align 8
...
entry:
  ...
  %vec = alloca i32, align 4
  %canary = alloca i32
  store i32 691343154, i32* %canary
  %perm.addr = alloca i32*, align 8
  %base.addr = alloca i32*, align 8
  %limit.addr = alloca i32*, align 8
  %pp = alloca i32, align 4
...
entry:
  ...
  %nNodes = alloca i32, align 4
  %canary = alloca i32
  store i32 1563968953, i32* %canary
  %tmp171 = alloca i32, align 4
  %freq.addr = alloca i32*, align 8
  %heap = alloca [260 x i32], align 16
  %zz = alloca i32, align 4
...
while.end234:                                     ; preds = %if.then218
  %151 = load i32, i32* %canary
  %152 = icmp eq i32 %151, 1563968953
  br i1 %152, label %153, label %func_exit
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 948894205, i32* %canary
  %maxLen.addr = alloca i32, align 4
  %tmp94 = alloca i32, align 4
  %k = alloca i32, align 4
  store i8* %len, i8** %len.addr, align 8
...
entry:
  ...
  %nHeap = alloca i32, align 4
  %canary = alloca i32
  store i32 733500225, i32* %canary
  %tmp94 = alloca i32, align 4
  %len.addr = alloca i8*, align 8
  %tmp48 = alloca i32, align 4
  %maxLen.addr = alloca i32, align 4
