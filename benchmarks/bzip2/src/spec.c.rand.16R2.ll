...
func_ran.12:                                      ; preds = %ctrl1
  %4 = call double @ran.12()
  ret double %4

func_ran.13:                                      ; preds = %ctrl2
  %5 = call double @ran.13()
  ret double %5
...
ctrl1:                                            ; preds = %ctrl0
  %9 = icmp eq i32 %0, 2
  br i1 %9, label %func_ran.12, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %10 = icmp eq i32 %0, 3
  br i1 %10, label %func_ran.13, label %ctrl3
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_spec_init.10, label %ctrl0

func_spec_init.10:                                ; preds = %rand_bb
  %2 = call i32 @spec_init.10()
  ret i32 %2

func_spec_init.40:                                ; preds = %ctrl0
  %3 = call i32 @spec_init.40()
  ret i32 %3
...
func_spec_init.89:                                ; preds = %ctrl2
  %5 = call i32 @spec_init.89()
  ret i32 %5

func_spec_init.90:                                ; preds = %ctrl3
  %6 = call i32 @spec_init.90()
  ret i32 %6

func_spec_init.102:                               ; preds = %ctrl3
  %7 = call i32 @spec_init.102()
  ret i32 %7

ctrl0:                                            ; preds = %rand_bb
  %8 = icmp eq i32 %0, 1
  br i1 %8, label %func_spec_init.40, label %ctrl1
...
ctrl2:                                            ; preds = %ctrl1
  %10 = icmp eq i32 %0, 3
  br i1 %10, label %func_spec_init.89, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %11 = icmp eq i32 %0, 4
  br i1 %11, label %func_spec_init.90, label %func_spec_init.102
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_spec_random_load.17, label %ctrl0

func_spec_random_load.17:                         ; preds = %rand_bb
  %2 = call i32 @spec_random_load.17(i32 %fd)
  ret i32 %2

func_spec_random_load.22:                         ; preds = %ctrl0
  %3 = call i32 @spec_random_load.22(i32 %fd)
  ret i32 %3

func_spec_random_load.46:                         ; preds = %ctrl1
  %4 = call i32 @spec_random_load.46(i32 %fd)
  ret i32 %4

func_spec_random_load.47:                         ; preds = %ctrl2
  %5 = call i32 @spec_random_load.47(i32 %fd)
  ret i32 %5

func_spec_random_load.48:                         ; preds = %ctrl3
  %6 = call i32 @spec_random_load.48(i32 %fd)
  ret i32 %6

func_spec_random_load.52:                         ; preds = %ctrl4
  %7 = call i32 @spec_random_load.52(i32 %fd)
  ret i32 %7

func_spec_random_load.56:                         ; preds = %ctrl5
  %8 = call i32 @spec_random_load.56(i32 %fd)
  ret i32 %8

func_spec_random_load.62:                         ; preds = %ctrl6
  %9 = call i32 @spec_random_load.62(i32 %fd)
  ret i32 %9

func_spec_random_load.73:                         ; preds = %ctrl7
  %10 = call i32 @spec_random_load.73(i32 %fd)
  ret i32 %10

func_spec_random_load.77:                         ; preds = %ctrl8
  %11 = call i32 @spec_random_load.77(i32 %fd)
  ret i32 %11

func_spec_random_load.78:                         ; preds = %ctrl9
  %12 = call i32 @spec_random_load.78(i32 %fd)
  ret i32 %12

func_spec_random_load.84:                         ; preds = %ctrl10
  %13 = call i32 @spec_random_load.84(i32 %fd)
  ret i32 %13

func_spec_random_load.95:                         ; preds = %ctrl11
  %14 = call i32 @spec_random_load.95(i32 %fd)
  ret i32 %14

func_spec_random_load.96:                         ; preds = %ctrl12
  %15 = call i32 @spec_random_load.96(i32 %fd)
  ret i32 %15

func_spec_random_load.97:                         ; preds = %ctrl13
  %16 = call i32 @spec_random_load.97(i32 %fd)
  ret i32 %16

func_spec_random_load.100:                        ; preds = %ctrl13
  %17 = call i32 @spec_random_load.100(i32 %fd)
  ret i32 %17

ctrl0:                                            ; preds = %rand_bb
  %18 = icmp eq i32 %0, 1
  br i1 %18, label %func_spec_random_load.22, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %19 = icmp eq i32 %0, 2
  br i1 %19, label %func_spec_random_load.46, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %20 = icmp eq i32 %0, 3
  br i1 %20, label %func_spec_random_load.47, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %21 = icmp eq i32 %0, 4
  br i1 %21, label %func_spec_random_load.48, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %22 = icmp eq i32 %0, 5
  br i1 %22, label %func_spec_random_load.52, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %23 = icmp eq i32 %0, 6
  br i1 %23, label %func_spec_random_load.56, label %ctrl6

ctrl6:                                            ; preds = %ctrl5
  %24 = icmp eq i32 %0, 7
  br i1 %24, label %func_spec_random_load.62, label %ctrl7

ctrl7:                                            ; preds = %ctrl6
  %25 = icmp eq i32 %0, 8
  br i1 %25, label %func_spec_random_load.73, label %ctrl8

ctrl8:                                            ; preds = %ctrl7
  %26 = icmp eq i32 %0, 9
  br i1 %26, label %func_spec_random_load.77, label %ctrl9

ctrl9:                                            ; preds = %ctrl8
  %27 = icmp eq i32 %0, 10
  br i1 %27, label %func_spec_random_load.78, label %ctrl10

ctrl10:                                           ; preds = %ctrl9
  %28 = icmp eq i32 %0, 11
  br i1 %28, label %func_spec_random_load.84, label %ctrl11

ctrl11:                                           ; preds = %ctrl10
  %29 = icmp eq i32 %0, 12
  br i1 %29, label %func_spec_random_load.95, label %ctrl12

ctrl12:                                           ; preds = %ctrl11
  %30 = icmp eq i32 %0, 13
  br i1 %30, label %func_spec_random_load.96, label %ctrl13

ctrl13:                                           ; preds = %ctrl12
  %31 = icmp eq i32 %0, 14
  br i1 %31, label %func_spec_random_load.97, label %func_spec_random_load.100
}
...
func_spec_load.8:                                 ; preds = %ctrl0
  %3 = call i32 @spec_load.8(i32 %num, i8* %filename, i32 %size)
  ret i32 %3

func_spec_load.16:                                ; preds = %ctrl1
  %4 = call i32 @spec_load.16(i32 %num, i8* %filename, i32 %size)
  ret i32 %4

func_spec_load.26:                                ; preds = %ctrl2
  %5 = call i32 @spec_load.26(i32 %num, i8* %filename, i32 %size)
  ret i32 %5

func_spec_load.34:                                ; preds = %ctrl3
  %6 = call i32 @spec_load.34(i32 %num, i8* %filename, i32 %size)
  ret i32 %6

func_spec_load.37:                                ; preds = %ctrl4
  %7 = call i32 @spec_load.37(i32 %num, i8* %filename, i32 %size)
  ret i32 %7

func_spec_load.51:                                ; preds = %ctrl5
  %8 = call i32 @spec_load.51(i32 %num, i8* %filename, i32 %size)
  ret i32 %8

func_spec_load.53:                                ; preds = %ctrl6
  %9 = call i32 @spec_load.53(i32 %num, i8* %filename, i32 %size)
  ret i32 %9

func_spec_load.61:                                ; preds = %ctrl7
  %10 = call i32 @spec_load.61(i32 %num, i8* %filename, i32 %size)
  ret i32 %10

func_spec_load.69:                                ; preds = %ctrl8
  %11 = call i32 @spec_load.69(i32 %num, i8* %filename, i32 %size)
  ret i32 %11

func_spec_load.82:                                ; preds = %ctrl9
  %12 = call i32 @spec_load.82(i32 %num, i8* %filename, i32 %size)
  ret i32 %12
...
ctrl0:                                            ; preds = %rand_bb
  %18 = icmp eq i32 %0, 1
  br i1 %18, label %func_spec_load.8, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %19 = icmp eq i32 %0, 2
  br i1 %19, label %func_spec_load.16, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %20 = icmp eq i32 %0, 3
  br i1 %20, label %func_spec_load.26, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %21 = icmp eq i32 %0, 4
  br i1 %21, label %func_spec_load.34, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %22 = icmp eq i32 %0, 5
  br i1 %22, label %func_spec_load.37, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %23 = icmp eq i32 %0, 6
  br i1 %23, label %func_spec_load.51, label %ctrl6

ctrl6:                                            ; preds = %ctrl5
  %24 = icmp eq i32 %0, 7
  br i1 %24, label %func_spec_load.53, label %ctrl7

ctrl7:                                            ; preds = %ctrl6
  %25 = icmp eq i32 %0, 8
  br i1 %25, label %func_spec_load.61, label %ctrl8

ctrl8:                                            ; preds = %ctrl7
  %26 = icmp eq i32 %0, 9
  br i1 %26, label %func_spec_load.69, label %ctrl9

ctrl9:                                            ; preds = %ctrl8
  %27 = icmp eq i32 %0, 10
  br i1 %27, label %func_spec_load.82, label %ctrl10
...
func_spec_read.36:                                ; preds = %ctrl2
  %5 = call i32 @spec_read.36(i32 %fd, i8* %buf, i32 %size)
  ret i32 %5

func_spec_read.49:                                ; preds = %ctrl3
  %6 = call i32 @spec_read.49(i32 %fd, i8* %buf, i32 %size)
  ret i32 %6

func_spec_read.54:                                ; preds = %ctrl4
  %7 = call i32 @spec_read.54(i32 %fd, i8* %buf, i32 %size)
  ret i32 %7

func_spec_read.57:                                ; preds = %ctrl5
  %8 = call i32 @spec_read.57(i32 %fd, i8* %buf, i32 %size)
  ret i32 %8

func_spec_read.59:                                ; preds = %ctrl6
  %9 = call i32 @spec_read.59(i32 %fd, i8* %buf, i32 %size)
  ret i32 %9

func_spec_read.60:                                ; preds = %ctrl7
  %10 = call i32 @spec_read.60(i32 %fd, i8* %buf, i32 %size)
  ret i32 %10

func_spec_read.66:                                ; preds = %ctrl8
  %11 = call i32 @spec_read.66(i32 %fd, i8* %buf, i32 %size)
  ret i32 %11
...
func_spec_read.79:                                ; preds = %ctrl10
  %13 = call i32 @spec_read.79(i32 %fd, i8* %buf, i32 %size)
  ret i32 %13

func_spec_read.81:                                ; preds = %ctrl11
  %14 = call i32 @spec_read.81(i32 %fd, i8* %buf, i32 %size)
  ret i32 %14

func_spec_read.86:                                ; preds = %ctrl12
  %15 = call i32 @spec_read.86(i32 %fd, i8* %buf, i32 %size)
  ret i32 %15

func_spec_read.88:                                ; preds = %ctrl13
  %16 = call i32 @spec_read.88(i32 %fd, i8* %buf, i32 %size)
  ret i32 %16
...
ctrl0:                                            ; preds = %rand_bb
  %18 = icmp eq i32 %0, 1
  br i1 %18, label %func_spec_read.20, label %ctrl1
...
ctrl2:                                            ; preds = %ctrl1
  %20 = icmp eq i32 %0, 3
  br i1 %20, label %func_spec_read.36, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %21 = icmp eq i32 %0, 4
  br i1 %21, label %func_spec_read.49, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %22 = icmp eq i32 %0, 5
  br i1 %22, label %func_spec_read.54, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %23 = icmp eq i32 %0, 6
  br i1 %23, label %func_spec_read.57, label %ctrl6

ctrl6:                                            ; preds = %ctrl5
  %24 = icmp eq i32 %0, 7
  br i1 %24, label %func_spec_read.59, label %ctrl7

ctrl7:                                            ; preds = %ctrl6
  %25 = icmp eq i32 %0, 8
  br i1 %25, label %func_spec_read.60, label %ctrl8

ctrl8:                                            ; preds = %ctrl7
  %26 = icmp eq i32 %0, 9
  br i1 %26, label %func_spec_read.66, label %ctrl9
...
ctrl10:                                           ; preds = %ctrl9
  %28 = icmp eq i32 %0, 11
  br i1 %28, label %func_spec_read.79, label %ctrl11

ctrl11:                                           ; preds = %ctrl10
  %29 = icmp eq i32 %0, 12
  br i1 %29, label %func_spec_read.81, label %ctrl12

ctrl12:                                           ; preds = %ctrl11
  %30 = icmp eq i32 %0, 13
  br i1 %30, label %func_spec_read.86, label %ctrl13

ctrl13:                                           ; preds = %ctrl12
  %31 = icmp eq i32 %0, 14
  br i1 %31, label %func_spec_read.88, label %func_spec_read.103
}
...
func_spec_fread.15:                               ; preds = %ctrl0
  %3 = call i32 @spec_fread.15(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %3
...
func_spec_fread.68:                               ; preds = %ctrl2
  %5 = call i32 @spec_fread.68(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %5

func_spec_fread.71:                               ; preds = %ctrl3
  %6 = call i32 @spec_fread.71(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %6

func_spec_fread.74:                               ; preds = %ctrl4
  %7 = call i32 @spec_fread.74(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %7
...
func_spec_fread.85:                               ; preds = %ctrl7
  %10 = call i32 @spec_fread.85(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %10

func_spec_fread.87:                               ; preds = %ctrl8
  %11 = call i32 @spec_fread.87(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %11

func_spec_fread.91:                               ; preds = %ctrl9
  %12 = call i32 @spec_fread.91(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %12

func_spec_fread.92:                               ; preds = %ctrl10
  %13 = call i32 @spec_fread.92(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %13

func_spec_fread.93:                               ; preds = %ctrl11
  %14 = call i32 @spec_fread.93(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %14

func_spec_fread.99:                               ; preds = %ctrl12
  %15 = call i32 @spec_fread.99(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %15

func_spec_fread.101:                              ; preds = %ctrl13
  %16 = call i32 @spec_fread.101(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %16
...
ctrl0:                                            ; preds = %rand_bb
  %18 = icmp eq i32 %0, 1
  br i1 %18, label %func_spec_fread.15, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %19 = icmp eq i32 %0, 2
  br i1 %19, label %func_spec_fread.41, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %20 = icmp eq i32 %0, 3
  br i1 %20, label %func_spec_fread.68, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %21 = icmp eq i32 %0, 4
  br i1 %21, label %func_spec_fread.71, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %22 = icmp eq i32 %0, 5
  br i1 %22, label %func_spec_fread.74, label %ctrl5
...
ctrl7:                                            ; preds = %ctrl6
  %25 = icmp eq i32 %0, 8
  br i1 %25, label %func_spec_fread.85, label %ctrl8

ctrl8:                                            ; preds = %ctrl7
  %26 = icmp eq i32 %0, 9
  br i1 %26, label %func_spec_fread.87, label %ctrl9

ctrl9:                                            ; preds = %ctrl8
  %27 = icmp eq i32 %0, 10
  br i1 %27, label %func_spec_fread.91, label %ctrl10

ctrl10:                                           ; preds = %ctrl9
  %28 = icmp eq i32 %0, 11
  br i1 %28, label %func_spec_fread.92, label %ctrl11

ctrl11:                                           ; preds = %ctrl10
  %29 = icmp eq i32 %0, 12
  br i1 %29, label %func_spec_fread.93, label %ctrl12

ctrl12:                                           ; preds = %ctrl11
  %30 = icmp eq i32 %0, 13
  br i1 %30, label %func_spec_fread.99, label %ctrl13

ctrl13:                                           ; preds = %ctrl12
  %31 = icmp eq i32 %0, 14
  br i1 %31, label %func_spec_fread.101, label %func_spec_fread.104
}
...
func_spec_getc.27:                                ; preds = %ctrl1
  %4 = call i32 @spec_getc.27(i32 %fd)
  ret i32 %4

func_spec_getc.42:                                ; preds = %ctrl2
  %5 = call i32 @spec_getc.42(i32 %fd)
  ret i32 %5

func_spec_getc.43:                                ; preds = %ctrl3
  %6 = call i32 @spec_getc.43(i32 %fd)
  ret i32 %6

func_spec_getc.58:                                ; preds = %ctrl3
  %7 = call i32 @spec_getc.58(i32 %fd)
  ret i32 %7
...
ctrl1:                                            ; preds = %ctrl0
  %9 = icmp eq i32 %0, 2
  br i1 %9, label %func_spec_getc.27, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %10 = icmp eq i32 %0, 3
  br i1 %10, label %func_spec_getc.42, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %11 = icmp eq i32 %0, 4
  br i1 %11, label %func_spec_getc.43, label %func_spec_getc.58
}
...
func_spec_ungetc.24:                              ; preds = %ctrl0
  %3 = call i32 @spec_ungetc.24(i8 %ch, i32 %fd)
  ret i32 %3

func_spec_ungetc.28:                              ; preds = %ctrl1
  %4 = call i32 @spec_ungetc.28(i8 %ch, i32 %fd)
  ret i32 %4

func_spec_ungetc.35:                              ; preds = %ctrl2
...
func_spec_ungetc.63:                              ; preds = %ctrl3
  %7 = call i32 @spec_ungetc.63(i8 %ch, i32 %fd)
  ret i32 %7

ctrl0:                                            ; preds = %rand_bb
  %8 = icmp eq i32 %0, 1
  br i1 %8, label %func_spec_ungetc.24, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %9 = icmp eq i32 %0, 2
  br i1 %9, label %func_spec_ungetc.28, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %10 = icmp eq i32 %0, 3
  br i1 %10, label %func_spec_ungetc.35, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %11 = icmp eq i32 %0, 4
  br i1 %11, label %func_spec_ungetc.38, label %func_spec_ungetc.63
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_spec_write.18, label %ctrl0

func_spec_write.18:                               ; preds = %rand_bb
  %2 = call i32 @spec_write.18(i32 %fd, i8* %buf, i32 %size)
  ret i32 %2
...
func_spec_write.29:                               ; preds = %ctrl1
  %4 = call i32 @spec_write.29(i32 %fd, i8* %buf, i32 %size)
  ret i32 %4

func_spec_write.32:                               ; preds = %ctrl2
  %5 = call i32 @spec_write.32(i32 %fd, i8* %buf, i32 %size)
  ret i32 %5

func_spec_write.39:                               ; preds = %ctrl3
  %6 = call i32 @spec_write.39(i32 %fd, i8* %buf, i32 %size)
  ret i32 %6

func_spec_write.44:                               ; preds = %ctrl3
  %7 = call i32 @spec_write.44(i32 %fd, i8* %buf, i32 %size)
  ret i32 %7

ctrl0:                                            ; preds = %rand_bb
  %8 = icmp eq i32 %0, 1
  br i1 %8, label %func_spec_write.21, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %9 = icmp eq i32 %0, 2
  br i1 %9, label %func_spec_write.29, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %10 = icmp eq i32 %0, 3
  br i1 %10, label %func_spec_write.32, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %11 = icmp eq i32 %0, 4
  br i1 %11, label %func_spec_write.39, label %func_spec_write.44
}
...
func_spec_fwrite.25:                              ; preds = %ctrl1
  %4 = call i32 @spec_fwrite.25(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %4

func_spec_fwrite.45:                              ; preds = %ctrl2
  %5 = call i32 @spec_fwrite.45(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %5

func_spec_fwrite.50:                              ; preds = %ctrl3
  %6 = call i32 @spec_fwrite.50(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %6

func_spec_fwrite.64:                              ; preds = %ctrl4
  %7 = call i32 @spec_fwrite.64(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %7

func_spec_fwrite.65:                              ; preds = %ctrl5
  %8 = call i32 @spec_fwrite.65(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %8
...
func_spec_fwrite.70:                              ; preds = %ctrl7
  %10 = call i32 @spec_fwrite.70(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %10

func_spec_fwrite.72:                              ; preds = %ctrl8
  %11 = call i32 @spec_fwrite.72(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %11

func_spec_fwrite.83:                              ; preds = %ctrl9
  %12 = call i32 @spec_fwrite.83(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %12

func_spec_fwrite.105:                             ; preds = %ctrl10
  %13 = call i32 @spec_fwrite.105(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %13

func_spec_fwrite.106:                             ; preds = %ctrl11
  %14 = call i32 @spec_fwrite.106(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %14

func_spec_fwrite.107:                             ; preds = %ctrl12
  %15 = call i32 @spec_fwrite.107(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %15

func_spec_fwrite.108:                             ; preds = %ctrl13
  %16 = call i32 @spec_fwrite.108(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %16

func_spec_fwrite.109:                             ; preds = %ctrl13
  %17 = call i32 @spec_fwrite.109(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %17

ctrl0:                                            ; preds = %rand_bb
  %18 = icmp eq i32 %0, 1
  br i1 %18, label %func_spec_fwrite.14, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %19 = icmp eq i32 %0, 2
  br i1 %19, label %func_spec_fwrite.25, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %20 = icmp eq i32 %0, 3
  br i1 %20, label %func_spec_fwrite.45, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %21 = icmp eq i32 %0, 4
  br i1 %21, label %func_spec_fwrite.50, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %22 = icmp eq i32 %0, 5
  br i1 %22, label %func_spec_fwrite.64, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %23 = icmp eq i32 %0, 6
  br i1 %23, label %func_spec_fwrite.65, label %ctrl6
...
ctrl7:                                            ; preds = %ctrl6
  %25 = icmp eq i32 %0, 8
  br i1 %25, label %func_spec_fwrite.70, label %ctrl8

ctrl8:                                            ; preds = %ctrl7
  %26 = icmp eq i32 %0, 9
  br i1 %26, label %func_spec_fwrite.72, label %ctrl9

ctrl9:                                            ; preds = %ctrl8
  %27 = icmp eq i32 %0, 10
  br i1 %27, label %func_spec_fwrite.83, label %ctrl10

ctrl10:                                           ; preds = %ctrl9
  %28 = icmp eq i32 %0, 11
  br i1 %28, label %func_spec_fwrite.105, label %ctrl11

ctrl11:                                           ; preds = %ctrl10
  %29 = icmp eq i32 %0, 12
  br i1 %29, label %func_spec_fwrite.106, label %ctrl12

ctrl12:                                           ; preds = %ctrl11
  %30 = icmp eq i32 %0, 13
  br i1 %30, label %func_spec_fwrite.107, label %ctrl13

ctrl13:                                           ; preds = %ctrl12
  %31 = icmp eq i32 %0, 14
  br i1 %31, label %func_spec_fwrite.108, label %func_spec_fwrite.109
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_spec_putc.7, label %func_spec_putc.23

func_spec_putc.7:                                 ; preds = %rand_bb
  %2 = call i32 @spec_putc.7(i8 %ch, i32 %fd)
  ret i32 %2
...
entry:
  ...
  %canary = alloca i32
  store i32 955921753, i32* %canary
...
entry:
  ...
  %rc = alloca i32, align 4
  %canary = alloca i32
  store i32 2078900064, i32* %canary
...
entry:
  ...
  %rc = alloca i32, align 4
  %canary = alloca i32
  store i32 1279038016, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 969794034, i32* %canary
...
entry:
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 292321871, i32* %canary
  %num.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %size.addr = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
...
entry:
  ...
  %canary = alloca i32
  store i32 425595959, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_putc.7(i8 zeroext %ch, i32 %fd) #0 {
entry:
  %canary = alloca i32
  store i32 705457471, i32* %canary
  %ch.addr = alloca i8, align 1
  %fd.addr = alloca i32, align 4
  store i8 %ch, i8* %ch.addr, align 1
  store i32 %fd, i32* %fd.addr, align 4
...
entry:
  ...
  %rc = alloca i32, align 4
  %canary = alloca i32
  store i32 1293068092, i32* %canary
  %size.addr = alloca i32, align 4
  %fd = alloca i32, align 4
  %tmp = alloca i32, align 4
  %num.addr = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 2072009590, i32* %canary
  %test = alloca i64, align 8
  %hi = alloca i64, align 8
  %lo = alloca i64, align 8
  %0 = load i64, i64* @seedi, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_init.10() #0 {
entry:
  %i = alloca i32, align 4
  %limit = alloca i32, align 4
  %canary = alloca i32
  store i32 418012114, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1433375090, i32* %canary
  %rc = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local double @ran.12() #0 {
entry:
  %lo = alloca i64, align 8
  %canary = alloca i32
  store i32 549396606, i32* %canary
  %hi = alloca i64, align 8
  %test = alloca i64, align 8
  %0 = load i64, i64* @seedi, align 8
  %div = sdiv i64 %0, 127773
...
entry:
  ...
  %lo = alloca i64, align 8
  %canary = alloca i32
  store i32 1336026117, i32* %canary
  %test = alloca i64, align 8
  %0 = load i64, i64* @seedi, align 8
  %div = sdiv i64 %0, 127773
  store i64 %div, i64* %hi, align 8
...
entry:
  ...
  %buf.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 335138035, i32* %canary
  %num.addr = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
  store i32 %num, i32* %num.addr, align 4
...
entry:
  %size.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1764475081, i32* %canary
  %buf.addr = alloca i8*, align 8
  %rc = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  %retval = alloca i32, align 4
...
entry:
  ...
  %filename.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 331212719, i32* %canary
  %i = alloca i32, align 4
  %fd = alloca i32, align 4
  %rc = alloca i32, align 4
  store i32 %num, i32* %num.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 678636020, i32* %canary
  %i = alloca i32, align 4
  %fd.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_write.18(i32 %fd, i8* %buf, i32 %size) #0 {
entry:
  %canary = alloca i32
  store i32 1843283773, i32* %canary
  %buf.addr = alloca i8*, align 8
  %size.addr = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
...
entry:
  ...
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 924133754, i32* %canary
  %size.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 414283772, i32* %canary
  %rc = alloca i32, align 4
  %size.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  store i8* %buf, i8** %buf.addr, align 8
...
entry:
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1997481458, i32* %canary
  %buf.addr = alloca i8*, align 8
  %size.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  store i8* %buf, i8** %buf.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1261943500, i32* %canary
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  %random_text = alloca [32 x [131072 x i8]], align 16
...
entry:
  %canary = alloca i32
  store i32 1438428505, i32* %canary
  %fd.addr = alloca i32, align 4
  %ch.addr = alloca i8, align 1
  store i8 %ch, i8* %ch.addr, align 1
  store i32 %fd, i32* %fd.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_ungetc.24(i8 zeroext %ch, i32 %fd) #0 {
entry:
  %rc = alloca i32, align 4
  %ch.addr = alloca i8, align 1
  %canary = alloca i32
  store i32 1769985203, i32* %canary
  %fd.addr = alloca i32, align 4
  store i8 %ch, i8* %ch.addr, align 1
  store i32 %fd, i32* %fd.addr, align 4
  store i32 0, i32* %rc, align 4
...
entry:
  %canary = alloca i32
  store i32 1687288154, i32* %canary
  %buf.addr = alloca i8*, align 8
  %num.addr = alloca i32, align 4
  %size.addr = alloca i32, align 4
  %fd.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_load.26(i32 %num, i8* %filename, i32 %size) #0 {
entry:
  %num.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %size.addr = alloca i32, align 4
  ...
  %filename.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 555540181, i32* %canary
  %rc = alloca i32, align 4
  store i32 %num, i32* %num.addr, align 4
  store i8* %filename, i8** %filename.addr, align 8
  store i32 %size, i32* %size.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_getc.27(i32 %fd) #0 {
entry:
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1887709379, i32* %canary
  %rc = alloca i32, align 4
  %retval = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  store i32 0, i32* %rc, align 4
...
entry:
  %canary = alloca i32
  store i32 566784872, i32* %canary
  %ch.addr = alloca i8, align 1
  %rc = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  store i8 %ch, i8* %ch.addr, align 1
...
entry:
  %size.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 192109541, i32* %canary
  %buf.addr = alloca i8*, align 8
  %fd.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  store i8* %buf, i8** %buf.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1580959155, i32* %canary
  %fd.addr = alloca i32, align 4
  %rc = alloca i32, align 4
  %retval = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
...
entry:
  ...
  %test = alloca i64, align 8
  %canary = alloca i32
  store i32 384681069, i32* %canary
  %lo = alloca i64, align 8
  %0 = load i64, i64* @seedi, align 8
  %div = sdiv i64 %0, 127773
  store i64 %div, i64* %hi, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_write.32(i32 %fd, i8* %buf, i32 %size) #0 {
entry:
  %size.addr = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1007835812, i32* %canary
  %buf.addr = alloca i8*, align 8
  store i32 %fd, i32* %fd.addr, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 884278443, i32* %canary
  %lo = alloca i64, align 8
  %test = alloca i64, align 8
  %hi = alloca i64, align 8
  %0 = load i64, i64* @seedi, align 8
...
entry:
  %rc = alloca i32, align 4
  %canary = alloca i32
  store i32 366188202, i32* %canary
  %size.addr = alloca i32, align 4
  %tmp = alloca i32, align 4
  %i = alloca i32, align 4
  %filename.addr = alloca i8*, align 8
...
entry:
  ...
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1819939623, i32* %canary
  %rc = alloca i32, align 4
  store i8 %ch, i8* %ch.addr, align 1
  store i32 %fd, i32* %fd.addr, align 4
  store i32 0, i32* %rc, align 4
...
entry:
  ...
  %buf.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1313079197, i32* %canary
  %size.addr = alloca i32, align 4
  %rc = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_load.37(i32 %num, i8* %filename, i32 %size) #0 {
entry:
  %rc = alloca i32, align 4
  %filename.addr = alloca i8*, align 8
  %tmp = alloca i32, align 4
  ...
  %fd = alloca i32, align 4
  %canary = alloca i32
  store i32 197778463, i32* %canary
  %num.addr = alloca i32, align 4
  store i32 %num, i32* %num.addr, align 4
  store i8* %filename, i8** %filename.addr, align 8
  store i32 %size, i32* %size.addr, align 4
...
entry:
  ...
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 315767350, i32* %canary
  %ch.addr = alloca i8, align 1
  store i8 %ch, i8* %ch.addr, align 1
  store i32 %fd, i32* %fd.addr, align 4
  store i32 0, i32* %rc, align 4
...
entry:
  ...
  %size.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1774695908, i32* %canary
  %buf.addr = alloca i8*, align 8
  store i32 %fd, i32* %fd.addr, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 926859760, i32* %canary
  %limit = alloca i32, align 4
  %j = alloca i32, align 4
  %i = alloca i32, align 4
  %0 = load i32, i32* @dbglvl, align 4
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1074352738, i32* %canary
  %num.addr = alloca i32, align 4
  %size.addr = alloca i32, align 4
  %rc = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_getc.42(i32 %fd) #0 {
entry:
  %canary = alloca i32
  store i32 1000964605, i32* %canary
  %retval = alloca i32, align 4
  %rc = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 2035864855, i32* %canary
  %fd.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  %rc = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
...
entry:
  ...
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 835325130, i32* %canary
  %size.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
...
entry:
  ...
  %num.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2097273525, i32* %canary
  %fd.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 348551609, i32* %canary
  %fd.addr = alloca i32, align 4
  %j = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  %0 = load i32, i32* @dbglvl, align 4
...
entry:
  %canary = alloca i32
  store i32 296381890, i32* %canary
  %j = alloca i32, align 4
  %i = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  %random_text = alloca [32 x [131072 x i8]], align 16
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_random_load.48(i32 %fd) #0 {
entry:
  %canary = alloca i32
  store i32 1900135174, i32* %canary
  %fd.addr = alloca i32, align 4
  %random_text = alloca [32 x [131072 x i8]], align 16
  %j = alloca i32, align 4
  %i = alloca i32, align 4
...
entry:
  ...
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 447275816, i32* %canary
  %size.addr = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
  store i32 %num, i32* %num.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_load.51(i32 %num, i8* %filename, i32 %size) #0 {
entry:
  %tmp = alloca i32, align 4
  %fd = alloca i32, align 4
  %i = alloca i32, align 4
  ...
  %size.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 893202838, i32* %canary
  %filename.addr = alloca i8*, align 8
  %num.addr = alloca i32, align 4
  store i32 %num, i32* %num.addr, align 4
  store i8* %filename, i8** %filename.addr, align 8
...
entry:
  ...
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1505343363, i32* %canary
  %j = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  %0 = load i32, i32* @dbglvl, align 4
  %cmp = icmp slt i32 4, %0
...
entry:
  ...
  %tmp = alloca i32, align 4
  %canary = alloca i32
  store i32 690530104, i32* %canary
  %filename.addr = alloca i8*, align 8
  %rc = alloca i32, align 4
  %size.addr = alloca i32, align 4
  store i32 %num, i32* %num.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 281454081, i32* %canary
  %retval = alloca i32, align 4
  %size.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %rc = alloca i32, align 4
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 2106398199, i32* %canary
  %limit = alloca i32, align 4
  %0 = load i32, i32* @dbglvl, align 4
  %cmp = icmp slt i32 3, %0
  br i1 %cmp, label %if.then, label %if.end
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 781778220, i32* %canary
  %fd.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  %0 = load i32, i32* @dbglvl, align 4
  %cmp = icmp slt i32 4, %0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_read.57(i32 %fd, i8* %buf, i32 %size) #0 {
entry:
  %buf.addr = alloca i8*, align 8
  %fd.addr = alloca i32, align 4
  %rc = alloca i32, align 4
  %size.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2063651089, i32* %canary
  %retval = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 181890867, i32* %canary
  %retval = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  %rc = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1681134994, i32* %canary
  %rc = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 812316841, i32* %canary
  %buf.addr = alloca i8*, align 8
  %retval = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  %rc = alloca i32, align 4
...
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1871761671, i32* %canary
  %tmp = alloca i32, align 4
  %size.addr = alloca i32, align 4
  %filename.addr = alloca i8*, align 8
  %fd = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 292619129, i32* %canary
  %j = alloca i32, align 4
  %random_text = alloca [32 x [131072 x i8]], align 16
  %fd.addr = alloca i32, align 4
  %i = alloca i32, align 4
...
entry:
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2143800924, i32* %canary
  %ch.addr = alloca i8, align 1
  %rc = alloca i32, align 4
  store i8 %ch, i8* %ch.addr, align 1
  store i32 %fd, i32* %fd.addr, align 4
...
entry:
  ...
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1698315078, i32* %canary
  %buf.addr = alloca i8*, align 8
  %num.addr = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
...
entry:
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 605685032, i32* %canary
  %buf.addr = alloca i8*, align 8
  %size.addr = alloca i32, align 4
  %num.addr = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
...
entry:
  ...
  %buf.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 643425416, i32* %canary
  %fd.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  %size.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
...
entry:
  ...
  %rc = alloca i32, align 4
  %canary = alloca i32
  store i32 214181216, i32* %canary
  %size.addr = alloca i32, align 4
  %num.addr = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 660243566, i32* %canary
  %num.addr = alloca i32, align 4
  %filename.addr = alloca i8*, align 8
  %rc = alloca i32, align 4
  %tmp = alloca i32, align 4
...
entry:
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 143036459, i32* %canary
  %buf.addr = alloca i8*, align 8
  %num.addr = alloca i32, align 4
  %size.addr = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 326864381, i32* %canary
  %num.addr = alloca i32, align 4
  %size.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  %rc = alloca i32, align 4
...
entry:
  ...
  %num.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 929931304, i32* %canary
  %buf.addr = alloca i8*, align 8
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
  store i32 %num, i32* %num.addr, align 4
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1091156423, i32* %canary
  %fd.addr = alloca i32, align 4
  %i = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  %0 = load i32, i32* @dbglvl, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_fread.74(i8* %buf, i32 %size, i32 %num, i32 %fd) #0 {
entry:
  %rc = alloca i32, align 4
  %retval = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %num.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 443470851, i32* %canary
  %size.addr = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
...
entry:
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 2072772178, i32* %canary
  %size.addr = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %rc = alloca i32, align 4
...
entry:
  ...
  %rc = alloca i32, align 4
  %canary = alloca i32
  store i32 1136925089, i32* %canary
  %fd.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %size.addr = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_random_load.77(i32 %fd) #0 {
entry:
  %fd.addr = alloca i32, align 4
  %j = alloca i32, align 4
  %random_text = alloca [32 x [131072 x i8]], align 16
  %canary = alloca i32
  store i32 126958642, i32* %canary
  %i = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  %0 = load i32, i32* @dbglvl, align 4
  %cmp = icmp slt i32 4, %0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_random_load.78(i32 %fd) #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1843693331, i32* %canary
  %j = alloca i32, align 4
  %random_text = alloca [32 x [131072 x i8]], align 16
  %fd.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_read.79(i32 %fd, i8* %buf, i32 %size) #0 {
entry:
  %retval = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 106052435, i32* %canary
  %buf.addr = alloca i8*, align 8
  %size.addr = alloca i32, align 4
  %rc = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
...
entry:
  ...
  %buf.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1491238680, i32* %canary
  %num.addr = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
  store i32 %num, i32* %num.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 101858335, i32* %canary
  %size.addr = alloca i32, align 4
  %rc = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  %retval = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_load.82(i32 %num, i8* %filename, i32 %size) #0 {
entry:
  %fd = alloca i32, align 4
  %i = alloca i32, align 4
  %filename.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 580456316, i32* %canary
  %num.addr = alloca i32, align 4
  %tmp = alloca i32, align 4
  %size.addr = alloca i32, align 4
  %rc = alloca i32, align 4
...
entry:
  %buf.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 2045966332, i32* %canary
  %size.addr = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  %num.addr = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
...
entry:
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1655789807, i32* %canary
  %i = alloca i32, align 4
  %random_text = alloca [32 x [131072 x i8]], align 16
  %fd.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_fread.85(i8* %buf, i32 %size, i32 %num, i32 %fd) #0 {
entry:
  %size.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  ...
  %buf.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1284300384, i32* %canary
  %num.addr = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
  store i32 %num, i32* %num.addr, align 4
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 252509938, i32* %canary
  %buf.addr = alloca i8*, align 8
  store i32 %fd, i32* %fd.addr, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
...
entry:
  ...
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1415216867, i32* %canary
  %num.addr = alloca i32, align 4
  %rc = alloca i32, align 4
  %retval = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
...
entry:
  %size.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 445018791, i32* %canary
  %buf.addr = alloca i8*, align 8
  %rc = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  %retval = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_init.89() #0 {
entry:
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 374786858, i32* %canary
  %limit = alloca i32, align 4
  %i = alloca i32, align 4
  %0 = load i32, i32* @dbglvl, align 4
  %cmp = icmp slt i32 3, %0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_init.90() #0 {
entry:
  %limit = alloca i32, align 4
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1282810653, i32* %canary
  %j = alloca i32, align 4
  %0 = load i32, i32* @dbglvl, align 4
  %cmp = icmp slt i32 3, %0
  br i1 %cmp, label %if.then, label %if.end
...
entry:
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1600914085, i32* %canary
  %rc = alloca i32, align 4
  %num.addr = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
...
entry:
  ...
  %rc = alloca i32, align 4
  %canary = alloca i32
  store i32 612418547, i32* %canary
  %num.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %size.addr = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
...
entry:
  ...
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1131624713, i32* %canary
  %num.addr = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
  store i32 %num, i32* %num.addr, align 4
...
entry:
  ...
  %tmp = alloca i32, align 4
  %canary = alloca i32
  store i32 1109171868, i32* %canary
  %fd = alloca i32, align 4
  %i = alloca i32, align 4
  %filename.addr = alloca i8*, align 8
  %rc = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1669598168, i32* %canary
  %i = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  %j = alloca i32, align 4
  %random_text = alloca [32 x [131072 x i8]], align 16
...
entry:
  %canary = alloca i32
  store i32 1286205358, i32* %canary
  %random_text = alloca [32 x [131072 x i8]], align 16
  %fd.addr = alloca i32, align 4
  %j = alloca i32, align 4
  %i = alloca i32, align 4
...
entry:
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 546535073, i32* %canary
  %fd.addr = alloca i32, align 4
  %random_text = alloca [32 x [131072 x i8]], align 16
  %i = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
...
entry:
  ...
  %rc = alloca i32, align 4
  %canary = alloca i32
  store i32 1781558454, i32* %canary
  %fd = alloca i32, align 4
  %i = alloca i32, align 4
  %size.addr = alloca i32, align 4
  %filename.addr = alloca i8*, align 8
...
entry:
  %canary = alloca i32
  store i32 411460064, i32* %canary
  %fd.addr = alloca i32, align 4
  %rc = alloca i32, align 4
  %retval = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
...
entry:
  %canary = alloca i32
  store i32 932818637, i32* %canary
  %j = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %random_text = alloca [32 x [131072 x i8]], align 16
...
entry:
  ...
  %num.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 163520117, i32* %canary
  %size.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_init.102() #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 933016223, i32* %canary
  %j = alloca i32, align 4
  %limit = alloca i32, align 4
  %0 = load i32, i32* @dbglvl, align 4
  %cmp = icmp slt i32 3, %0
...
entry:
  %canary = alloca i32
  store i32 389767492, i32* %canary
  %buf.addr = alloca i8*, align 8
  %rc = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  %size.addr = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1726468264, i32* %canary
  %rc = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %retval = alloca i32, align 4
  %fd.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_fwrite.105(i8* %buf, i32 %size, i32 %num, i32 %fd) #0 {
entry:
  %num.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1209174341, i32* %canary
  %fd.addr = alloca i32, align 4
  %size.addr = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 1934084397, i32* %canary
  %size.addr = alloca i32, align 4
  %num.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %fd.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_fwrite.107(i8* %buf, i32 %size, i32 %num, i32 %fd) #0 {
entry:
  %num.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1977572712, i32* %canary
  %buf.addr = alloca i8*, align 8
  %size.addr = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_fwrite.108(i8* %buf, i32 %size, i32 %num, i32 %fd) #0 {
entry:
  %size.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %num.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 395288104, i32* %canary
  %fd.addr = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
  store i32 %num, i32* %num.addr, align 4
...
entry:
  %size.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1405901585, i32* %canary
  %buf.addr = alloca i8*, align 8
  %fd.addr = alloca i32, align 4
  %num.addr = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
...
entry:
  ...
  %tmp = alloca i32, align 4
  %canary = alloca i32
  store i32 1072679561, i32* %canary
  %num.addr = alloca i32, align 4
  %i = alloca i32, align 4
  store i32 %num, i32* %num.addr, align 4
  store i8* %filename, i8** %filename.addr, align 8
...
entry:
  ...
  %tmp = alloca i32, align 4
  %canary = alloca i32
  store i32 2023916120, i32* %canary
  %size.addr = alloca i32, align 4
  %fd = alloca i32, align 4
  %rc = alloca i32, align 4
  %i = alloca i32, align 4
...
entry:
  ...
  %size.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1595184377, i32* %canary
  %num.addr = alloca i32, align 4
  %fd = alloca i32, align 4
  store i32 %num, i32* %num.addr, align 4
  store i8* %filename, i8** %filename.addr, align 8
