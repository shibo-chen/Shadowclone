...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_ran.5, label %ctrl0

func_ran.5:                                       ; preds = %rand_bb
  %2 = call double @ran.5()
  ret double %2
...
func_ran.33:                                      ; preds = %ctrl1
  %4 = call double @ran.33()
  ret double %4

func_ran.34:                                      ; preds = %ctrl1
  %5 = call double @ran.34()
  ret double %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_ran.26, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_ran.33, label %func_ran.34
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_spec_init.6, label %ctrl0

func_spec_init.6:                                 ; preds = %rand_bb
  %2 = call i32 @spec_init.6()
  ret i32 %2

func_spec_init.9:                                 ; preds = %ctrl0
  %3 = call i32 @spec_init.9()
  ret i32 %3

func_spec_init.23:                                ; preds = %ctrl1
  %4 = call i32 @spec_init.23()
  ret i32 %4

func_spec_init.27:                                ; preds = %ctrl1
  %5 = call i32 @spec_init.27()
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_spec_init.9, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_spec_init.23, label %func_spec_init.27
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_spec_random_load.16, label %ctrl0

func_spec_random_load.16:                         ; preds = %rand_bb
  %2 = call i32 @spec_random_load.16(i32 %fd)
  ret i32 %2
...
func_spec_random_load.36:                         ; preds = %ctrl1
  %4 = call i32 @spec_random_load.36(i32 %fd)
  ret i32 %4
...
ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_spec_random_load.36, label %func_spec_random_load.38
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_spec_load.8, label %ctrl0

func_spec_load.8:                                 ; preds = %rand_bb
  %2 = call i32 @spec_load.8(i32 %num, i8* %filename, i32 %size)
  ret i32 %2

func_spec_load.19:                                ; preds = %ctrl0
  %3 = call i32 @spec_load.19(i32 %num, i8* %filename, i32 %size)
  ret i32 %3

func_spec_load.28:                                ; preds = %ctrl1
  %4 = call i32 @spec_load.28(i32 %num, i8* %filename, i32 %size)
  ret i32 %4

func_spec_load.40:                                ; preds = %ctrl1
  %5 = call i32 @spec_load.40(i32 %num, i8* %filename, i32 %size)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_spec_load.19, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_spec_load.28, label %func_spec_load.40
}
...
func_spec_read.32:                                ; preds = %ctrl1
  %5 = call i32 @spec_read.32(i32 %fd, i8* %buf, i32 %size)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_spec_read.11, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_spec_read.29, label %func_spec_read.32
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_spec_fread.12, label %ctrl0

func_spec_fread.12:                               ; preds = %rand_bb
  %2 = call i32 @spec_fread.12(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %2

func_spec_fread.20:                               ; preds = %ctrl0
  %3 = call i32 @spec_fread.20(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %3

func_spec_fread.31:                               ; preds = %ctrl1
  %4 = call i32 @spec_fread.31(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %4

func_spec_fread.37:                               ; preds = %ctrl1
  %5 = call i32 @spec_fread.37(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_spec_fread.20, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_spec_fread.31, label %func_spec_fread.37
}
...
func_spec_getc.4:                                 ; preds = %ctrl0
  %3 = call i32 @spec_getc.4(i32 %fd)
  ret i32 %3

func_spec_getc.21:                                ; preds = %ctrl1
  %4 = call i32 @spec_getc.21(i32 %fd)
  ret i32 %4

func_spec_getc.22:                                ; preds = %ctrl1
  %5 = call i32 @spec_getc.22(i32 %fd)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_spec_getc.4, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_spec_getc.21, label %func_spec_getc.22
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_spec_ungetc.35, label %ctrl0

func_spec_ungetc.35:                              ; preds = %rand_bb
  %2 = call i32 @spec_ungetc.35(i8 %ch, i32 %fd)
  ret i32 %2

func_spec_ungetc.39:                              ; preds = %ctrl0
  %3 = call i32 @spec_ungetc.39(i8 %ch, i32 %fd)
  ret i32 %3

func_spec_ungetc.41:                              ; preds = %ctrl1
  %4 = call i32 @spec_ungetc.41(i8 %ch, i32 %fd)
  ret i32 %4

func_spec_ungetc.42:                              ; preds = %ctrl1
  %5 = call i32 @spec_ungetc.42(i8 %ch, i32 %fd)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_spec_ungetc.39, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_spec_ungetc.41, label %func_spec_ungetc.42
}
...
func_spec_write.25:                               ; preds = %ctrl1
  %4 = call i32 @spec_write.25(i32 %fd, i8* %buf, i32 %size)
  ret i32 %4

func_spec_write.30:                               ; preds = %ctrl1
  %5 = call i32 @spec_write.30(i32 %fd, i8* %buf, i32 %size)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_spec_write.14, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_spec_write.25, label %func_spec_write.30
}
...
func_spec_fwrite.17:                              ; preds = %ctrl1
  %5 = call i32 @spec_fwrite.17(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_spec_fwrite.10, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_spec_fwrite.13, label %func_spec_fwrite.17
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_spec_putc.15, label %func_spec_putc.18

func_spec_putc.15:                                ; preds = %rand_bb
  %2 = call i32 @spec_putc.15(i8 %ch, i32 %fd)
  ret i32 %2
...
entry:
  ...
  %canary = alloca i32
  store i32 224411935, i32* %canary
  %fd.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
...
entry:
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2072229446, i32* %canary
  %rc = alloca i32, align 4
  %retval = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  store i32 0, i32* %rc, align 4
...
entry:
  ...
  %buf.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1946799160, i32* %canary
  %size.addr = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
...
entry:
  ...
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1501850236, i32* %canary
  %retval = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  store i32 0, i32* %rc, align 4
  %0 = load i32, i32* @dbglvl, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local double @ran.5() #0 {
entry:
  %lo = alloca i64, align 8
  %canary = alloca i32
  store i32 493113092, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1036540698, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 154311244, i32* %canary
  %size.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %fd.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
...
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 414985818, i32* %canary
  %rc = alloca i32, align 4
...
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 891335147, i32* %canary
  %j = alloca i32, align 4
  %limit = alloca i32, align 4
  %0 = load i32, i32* @dbglvl, align 4
  %cmp = icmp slt i32 3, %0
...
entry:
  ...
  %buf.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1811177568, i32* %canary
  %size.addr = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
...
entry:
  ...
  %rc = alloca i32, align 4
  %canary = alloca i32
  store i32 1748875140, i32* %canary
  %retval = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %size.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
...
entry:
  ...
  %rc = alloca i32, align 4
  %canary = alloca i32
  store i32 560756096, i32* %canary
  %fd.addr = alloca i32, align 4
  %size.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %retval = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1962284701, i32* %canary
  %size.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %num.addr = alloca i32, align 4
  %fd.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_putc.15(i8 zeroext %ch, i32 %fd) #0 {
entry:
  %ch.addr = alloca i8, align 1
  %canary = alloca i32
  store i32 618322679, i32* %canary
  %fd.addr = alloca i32, align 4
...
entry:
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1691145343, i32* %canary
  %j = alloca i32, align 4
  %i = alloca i32, align 4
...
entry:
  ...
  %num.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1804346347, i32* %canary
  %fd.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 1789614374, i32* %canary
  %fd.addr = alloca i32, align 4
  %ch.addr = alloca i8, align 1
  store i8 %ch, i8* %ch.addr, align 1
  store i32 %fd, i32* %fd.addr, align 4
...
entry:
  ...
  %tmp = alloca i32, align 4
  %canary = alloca i32
  store i32 216293604, i32* %canary
  %size.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %fd = alloca i32, align 4
  %num.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_fread.20(i8* %buf, i32 %size, i32 %num, i32 %fd) #0 {
entry:
  %size.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1350945839, i32* %canary
  %num.addr = alloca i32, align 4
  %rc = alloca i32, align 4
  %retval = alloca i32, align 4
  %fd.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_getc.21(i32 %fd) #0 {
entry:
  %canary = alloca i32
  store i32 643736745, i32* %canary
  %retval = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  %rc = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1830832976, i32* %canary
  %fd.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  store i32 0, i32* %rc, align 4
  %0 = load i32, i32* @dbglvl, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_init.23() #0 {
entry:
  %limit = alloca i32, align 4
  %canary = alloca i32
  store i32 1732387291, i32* %canary
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %0 = load i32, i32* @dbglvl, align 4
  %cmp = icmp slt i32 3, %0
...
entry:
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 965118931, i32* %canary
  %random_text = alloca [32 x [131072 x i8]], align 16
  %j = alloca i32, align 4
  %i = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_write.25(i32 %fd, i8* %buf, i32 %size) #0 {
entry:
  %canary = alloca i32
  store i32 749257984, i32* %canary
  %fd.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %size.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
...
entry:
  %test = alloca i64, align 8
  %canary = alloca i32
  store i32 2094478039, i32* %canary
  %hi = alloca i64, align 8
  %lo = alloca i64, align 8
  %0 = load i64, i64* @seedi, align 8
  %div = sdiv i64 %0, 127773
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_init.27() #0 {
entry:
  %canary = alloca i32
  store i32 2032096340, i32* %canary
  %j = alloca i32, align 4
  %i = alloca i32, align 4
  %limit = alloca i32, align 4
  %0 = load i32, i32* @dbglvl, align 4
...
entry:
  %canary = alloca i32
  store i32 1434682695, i32* %canary
  %i = alloca i32, align 4
  %size.addr = alloca i32, align 4
  %fd = alloca i32, align 4
  %rc = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_write.30(i32 %fd, i8* %buf, i32 %size) #0 {
entry:
  %buf.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1120113928, i32* %canary
  %size.addr = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  store i8* %buf, i8** %buf.addr, align 8
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1935627961, i32* %canary
  %fd.addr = alloca i32, align 4
  %rc = alloca i32, align 4
  %size.addr = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_read.32(i32 %fd, i8* %buf, i32 %size) #0 {
entry:
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1196776230, i32* %canary
  %rc = alloca i32, align 4
  %size.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
...
entry:
  %canary = alloca i32
  store i32 1564206537, i32* %canary
  %hi = alloca i64, align 8
  %test = alloca i64, align 8
  %lo = alloca i64, align 8
  %0 = load i64, i64* @seedi, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local double @ran.34() #0 {
entry:
  %lo = alloca i64, align 8
  %hi = alloca i64, align 8
  %canary = alloca i32
  store i32 123710339, i32* %canary
  %test = alloca i64, align 8
  %0 = load i64, i64* @seedi, align 8
  %div = sdiv i64 %0, 127773
  store i64 %div, i64* %hi, align 8
...
entry:
  %canary = alloca i32
  store i32 1992685016, i32* %canary
  %rc = alloca i32, align 4
  %ch.addr = alloca i8, align 1
  %fd.addr = alloca i32, align 4
  store i8 %ch, i8* %ch.addr, align 1
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_random_load.36(i32 %fd) #0 {
entry:
  %random_text = alloca [32 x [131072 x i8]], align 16
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1703223295, i32* %canary
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  %0 = load i32, i32* @dbglvl, align 4
...
entry:
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 741719665, i32* %canary
  %random_text = alloca [32 x [131072 x i8]], align 16
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_ungetc.39(i8 zeroext %ch, i32 %fd) #0 {
entry:
  %rc = alloca i32, align 4
  %canary = alloca i32
  store i32 1359098892, i32* %canary
  %fd.addr = alloca i32, align 4
  %ch.addr = alloca i8, align 1
  store i8 %ch, i8* %ch.addr, align 1
  store i32 %fd, i32* %fd.addr, align 4
...
entry:
  ...
  %num.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 284674779, i32* %canary
  %rc = alloca i32, align 4
  %size.addr = alloca i32, align 4
  store i32 %num, i32* %num.addr, align 4
  store i8* %filename, i8** %filename.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 543442606, i32* %canary
  %fd.addr = alloca i32, align 4
  %ch.addr = alloca i8, align 1
  %rc = alloca i32, align 4
  store i8 %ch, i8* %ch.addr, align 1
...
entry:
  %canary = alloca i32
  store i32 1766921262, i32* %canary
  %fd.addr = alloca i32, align 4
  %rc = alloca i32, align 4
  %ch.addr = alloca i8, align 1
  store i8 %ch, i8* %ch.addr, align 1
