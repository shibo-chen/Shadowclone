...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_fopen_output_safely.7, label %ctrl0

func_fopen_output_safely.7:                       ; preds = %rand_bb
  %2 = call %struct._IO_FILE* @fopen_output_safely.7(i8* %name, i8* %mode)
  ret %struct._IO_FILE* %2

func_fopen_output_safely.8:                       ; preds = %ctrl0
  %3 = call %struct._IO_FILE* @fopen_output_safely.8(i8* %name, i8* %mode)
  ret %struct._IO_FILE* %3

func_fopen_output_safely.11:                      ; preds = %ctrl1
  %4 = call %struct._IO_FILE* @fopen_output_safely.11(i8* %name, i8* %mode)
  ret %struct._IO_FILE* %4

func_fopen_output_safely.29:                      ; preds = %ctrl1
  %5 = call %struct._IO_FILE* @fopen_output_safely.29(i8* %name, i8* %mode)
  ret %struct._IO_FILE* %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_fopen_output_safely.8, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_fopen_output_safely.11, label %func_fopen_output_safely.29
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_copyFileName.41, label %func_copyFileName.58

func_copyFileName.41:                             ; preds = %rand_bb
  call void @copyFileName.41(i8* %to, i8* %from)
  ret void

func_copyFileName.58:                             ; preds = %rand_bb
  call void @copyFileName.58(i8* %to, i8* %from)
  ret void
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_addFlagsFromEnvVar.4, label %ctrl0

func_addFlagsFromEnvVar.4:                        ; preds = %rand_bb
  call void @addFlagsFromEnvVar.4(%struct.zzzz** %argList, i8* %varName)
  ret void

func_addFlagsFromEnvVar.10:                       ; preds = %ctrl0
  call void @addFlagsFromEnvVar.10(%struct.zzzz** %argList, i8* %varName)
  ret void

func_addFlagsFromEnvVar.25:                       ; preds = %ctrl1
  call void @addFlagsFromEnvVar.25(%struct.zzzz** %argList, i8* %varName)
  ret void

func_addFlagsFromEnvVar.47:                       ; preds = %ctrl1
  call void @addFlagsFromEnvVar.47(%struct.zzzz** %argList, i8* %varName)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_addFlagsFromEnvVar.10, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_addFlagsFromEnvVar.25, label %func_addFlagsFromEnvVar.47
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_snocString.12, label %ctrl0

func_snocString.12:                               ; preds = %rand_bb
  %2 = call %struct.zzzz* @snocString.12(%struct.zzzz* %root, i8* %name)
  ret %struct.zzzz* %2

func_snocString.19:                               ; preds = %ctrl0
  %3 = call %struct.zzzz* @snocString.19(%struct.zzzz* %root, i8* %name)
  ret %struct.zzzz* %3

func_snocString.24:                               ; preds = %ctrl1
  %4 = call %struct.zzzz* @snocString.24(%struct.zzzz* %root, i8* %name)
  ret %struct.zzzz* %4

func_snocString.60:                               ; preds = %ctrl1
  %5 = call %struct.zzzz* @snocString.60(%struct.zzzz* %root, i8* %name)
  ret %struct.zzzz* %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_snocString.19, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_snocString.24, label %func_snocString.60
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_compress.52, label %ctrl0

func_compress.52:                                 ; preds = %rand_bb
  call void @compress.52(i8* %name)
  ret void

func_compress.54:                                 ; preds = %ctrl0
  call void @compress.54(i8* %name)
  ret void

func_compress.89:                                 ; preds = %ctrl1
  call void @compress.89(i8* %name)
  ret void

func_compress.95:                                 ; preds = %ctrl1
  call void @compress.95(i8* %name)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_compress.54, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_compress.89, label %func_compress.95
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_uncompress.34, label %ctrl0

func_uncompress.34:                               ; preds = %rand_bb
  call void @uncompress.34(i8* %name)
  ret void

func_uncompress.40:                               ; preds = %ctrl0
  call void @uncompress.40(i8* %name)
  ret void

func_uncompress.61:                               ; preds = %ctrl1
  call void @uncompress.61(i8* %name)
  ret void

func_uncompress.72:                               ; preds = %ctrl1
  call void @uncompress.72(i8* %name)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_uncompress.40, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_uncompress.61, label %func_uncompress.72
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_testf.16, label %ctrl0

func_testf.16:                                    ; preds = %rand_bb
  call void @testf.16(i8* %name)
  ret void

func_testf.59:                                    ; preds = %ctrl0
  call void @testf.59(i8* %name)
  ret void

func_testf.82:                                    ; preds = %ctrl1
  call void @testf.82(i8* %name)
  ret void

func_testf.87:                                    ; preds = %ctrl1
  call void @testf.87(i8* %name)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_testf.59, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_testf.82, label %func_testf.87
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_cleanUpAndFail.22, label %ctrl0

func_cleanUpAndFail.22:                           ; preds = %rand_bb
  call void @cleanUpAndFail.22(i32 %ec)
  ret void

func_cleanUpAndFail.26:                           ; preds = %ctrl0
  call void @cleanUpAndFail.26(i32 %ec)
  ret void

func_cleanUpAndFail.73:                           ; preds = %ctrl1
  call void @cleanUpAndFail.73(i32 %ec)
  ret void

func_cleanUpAndFail.79:                           ; preds = %ctrl1
  call void @cleanUpAndFail.79(i32 %ec)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_cleanUpAndFail.26, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_cleanUpAndFail.73, label %func_cleanUpAndFail.79
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_myMalloc.20, label %func_myMalloc.28

func_myMalloc.20:                                 ; preds = %rand_bb
  %2 = call i8* @myMalloc.20(i32 %n)
  ret i8* %2

func_myMalloc.28:                                 ; preds = %rand_bb
  %3 = call i8* @myMalloc.28(i32 %n)
  ret i8* %3
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_fileExists.9, label %ctrl0

func_fileExists.9:                                ; preds = %rand_bb
  %2 = call i8 @fileExists.9(i8* %name)
  ret i8 %2
...
func_fileExists.31:                               ; preds = %ctrl1
  %4 = call i8 @fileExists.31(i8* %name)
  ret i8 %4

func_fileExists.43:                               ; preds = %ctrl1
  %5 = call i8 @fileExists.43(i8* %name)
  ret i8 %5
...
ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_fileExists.31, label %func_fileExists.43
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_hasSuffix.27, label %ctrl0

func_hasSuffix.27:                                ; preds = %rand_bb
  %2 = call i8 @hasSuffix.27(i8* %s, i8* %suffix)
  ret i8 %2

func_hasSuffix.50:                                ; preds = %ctrl0
  %3 = call i8 @hasSuffix.50(i8* %s, i8* %suffix)
  ret i8 %3

func_hasSuffix.62:                                ; preds = %ctrl1
  %4 = call i8 @hasSuffix.62(i8* %s, i8* %suffix)
  ret i8 %4

func_hasSuffix.74:                                ; preds = %ctrl1
  %5 = call i8 @hasSuffix.74(i8* %s, i8* %suffix)
  ret i8 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_hasSuffix.50, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_hasSuffix.62, label %func_hasSuffix.74
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_notAStandardFile.2, label %ctrl0

func_notAStandardFile.2:                          ; preds = %rand_bb
  %2 = call i8 @notAStandardFile.2(i8* %name)
  ret i8 %2

func_notAStandardFile.13:                         ; preds = %ctrl0
  %3 = call i8 @notAStandardFile.13(i8* %name)
  ret i8 %3

func_notAStandardFile.65:                         ; preds = %ctrl1
  %4 = call i8 @notAStandardFile.65(i8* %name)
  ret i8 %4

func_notAStandardFile.68:                         ; preds = %ctrl1
  %5 = call i8 @notAStandardFile.68(i8* %name)
  ret i8 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_notAStandardFile.13, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_notAStandardFile.65, label %func_notAStandardFile.68
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_countHardLinks.30, label %ctrl0

func_countHardLinks.30:                           ; preds = %rand_bb
  %2 = call i32 @countHardLinks.30(i8* %name)
  ret i32 %2

func_countHardLinks.44:                           ; preds = %ctrl0
  %3 = call i32 @countHardLinks.44(i8* %name)
  ret i32 %3

func_countHardLinks.45:                           ; preds = %ctrl1
  %4 = call i32 @countHardLinks.45(i8* %name)
  ret i32 %4

func_countHardLinks.66:                           ; preds = %ctrl1
  %5 = call i32 @countHardLinks.66(i8* %name)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_countHardLinks.44, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_countHardLinks.45, label %func_countHardLinks.66
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_saveInputFileMetaInfo.75, label %func_saveInputFileMetaInfo.85

func_saveInputFileMetaInfo.75:                    ; preds = %rand_bb
  call void @saveInputFileMetaInfo.75(i8* %srcName)
  ret void

func_saveInputFileMetaInfo.85:                    ; preds = %rand_bb
  call void @saveInputFileMetaInfo.85(i8* %srcName)
  ret void
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_pad.17, label %func_pad.67

func_pad.17:                                      ; preds = %rand_bb
  call void @pad.17(i8* %s)
  ret void

func_pad.67:                                      ; preds = %rand_bb
  call void @pad.67(i8* %s)
  ret void
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_compressStream.6, label %ctrl0

func_compressStream.6:                            ; preds = %rand_bb
  call void @compressStream.6(%struct._IO_FILE* %stream, %struct._IO_FILE* %zStream)
  ret void

func_compressStream.51:                           ; preds = %ctrl0
  call void @compressStream.51(%struct._IO_FILE* %stream, %struct._IO_FILE* %zStream)
  ret void

func_compressStream.92:                           ; preds = %ctrl1
  call void @compressStream.92(%struct._IO_FILE* %stream, %struct._IO_FILE* %zStream)
  ret void

func_compressStream.96:                           ; preds = %ctrl1
  call void @compressStream.96(%struct._IO_FILE* %stream, %struct._IO_FILE* %zStream)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_compressStream.51, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_compressStream.92, label %func_compressStream.96
}
...
func_applySavedMetaInfoToOutputFile.32:           ; preds = %ctrl0
  call void @applySavedMetaInfoToOutputFile.32(i8* %dstName)
  ret void

func_applySavedMetaInfoToOutputFile.48:           ; preds = %ctrl1
  call void @applySavedMetaInfoToOutputFile.48(i8* %dstName)
  ret void

func_applySavedMetaInfoToOutputFile.55:           ; preds = %ctrl1
  call void @applySavedMetaInfoToOutputFile.55(i8* %dstName)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_applySavedMetaInfoToOutputFile.32, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_applySavedMetaInfoToOutputFile.48, label %func_applySavedMetaInfoToOutputFile.55
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_myfeof.36, label %ctrl0

func_myfeof.36:                                   ; preds = %rand_bb
  %2 = call i8 @myfeof.36(%struct._IO_FILE* %f)
  ret i8 %2

func_myfeof.53:                                   ; preds = %ctrl0
  %3 = call i8 @myfeof.53(%struct._IO_FILE* %f)
  ret i8 %3

func_myfeof.56:                                   ; preds = %ctrl1
  %4 = call i8 @myfeof.56(%struct._IO_FILE* %f)
  ret i8 %4

func_myfeof.57:                                   ; preds = %ctrl1
  %5 = call i8 @myfeof.57(%struct._IO_FILE* %f)
  ret i8 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_myfeof.53, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_myfeof.56, label %func_myfeof.57
}
...
func_uInt64_from_UInt32s.14:                      ; preds = %ctrl0
  call void @uInt64_from_UInt32s.14(%struct.UInt64* %n, i32 %lo32, i32 %hi32)
  ret void

func_uInt64_from_UInt32s.70:                      ; preds = %ctrl1
  call void @uInt64_from_UInt32s.70(%struct.UInt64* %n, i32 %lo32, i32 %hi32)
  ret void

func_uInt64_from_UInt32s.76:                      ; preds = %ctrl1
  call void @uInt64_from_UInt32s.76(%struct.UInt64* %n, i32 %lo32, i32 %hi32)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_uInt64_from_UInt32s.14, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_uInt64_from_UInt32s.70, label %func_uInt64_from_UInt32s.76
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_uInt64_to_double.39, label %ctrl0

func_uInt64_to_double.39:                         ; preds = %rand_bb
  %2 = call double @uInt64_to_double.39(%struct.UInt64* %n)
  ret double %2

func_uInt64_to_double.71:                         ; preds = %ctrl0
  %3 = call double @uInt64_to_double.71(%struct.UInt64* %n)
  ret double %3

func_uInt64_to_double.78:                         ; preds = %ctrl1
  %4 = call double @uInt64_to_double.78(%struct.UInt64* %n)
  ret double %4

func_uInt64_to_double.91:                         ; preds = %ctrl1
  %5 = call double @uInt64_to_double.91(%struct.UInt64* %n)
  ret double %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_uInt64_to_double.71, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_uInt64_to_double.78, label %func_uInt64_to_double.91
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_uInt64_toAscii.18, label %ctrl0

func_uInt64_toAscii.18:                           ; preds = %rand_bb
  call void @uInt64_toAscii.18(i8* %outbuf, %struct.UInt64* %n)
  ret void

func_uInt64_toAscii.35:                           ; preds = %ctrl0
  call void @uInt64_toAscii.35(i8* %outbuf, %struct.UInt64* %n)
  ret void

func_uInt64_toAscii.42:                           ; preds = %ctrl1
  call void @uInt64_toAscii.42(i8* %outbuf, %struct.UInt64* %n)
  ret void

func_uInt64_toAscii.46:                           ; preds = %ctrl1
  call void @uInt64_toAscii.46(i8* %outbuf, %struct.UInt64* %n)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_uInt64_toAscii.35, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_uInt64_toAscii.42, label %func_uInt64_toAscii.46
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_uInt64_qrm10.64, label %ctrl0

func_uInt64_qrm10.64:                             ; preds = %rand_bb
  %2 = call i32 @uInt64_qrm10.64(%struct.UInt64* %n)
  ret i32 %2

func_uInt64_qrm10.77:                             ; preds = %ctrl0
  %3 = call i32 @uInt64_qrm10.77(%struct.UInt64* %n)
  ret i32 %3
...
func_uInt64_qrm10.84:                             ; preds = %ctrl1
  %5 = call i32 @uInt64_qrm10.84(%struct.UInt64* %n)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_uInt64_qrm10.77, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_uInt64_qrm10.81, label %func_uInt64_qrm10.84
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_uInt64_isZero.3, label %ctrl0

func_uInt64_isZero.3:                             ; preds = %rand_bb
  %2 = call i8 @uInt64_isZero.3(%struct.UInt64* %n)
  ret i8 %2

func_uInt64_isZero.23:                            ; preds = %ctrl0
  %3 = call i8 @uInt64_isZero.23(%struct.UInt64* %n)
  ret i8 %3

func_uInt64_isZero.37:                            ; preds = %ctrl1
  %4 = call i8 @uInt64_isZero.37(%struct.UInt64* %n)
  ret i8 %4

func_uInt64_isZero.38:                            ; preds = %ctrl1
  %5 = call i8 @uInt64_isZero.38(%struct.UInt64* %n)
  ret i8 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_uInt64_isZero.23, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_uInt64_isZero.37, label %func_uInt64_isZero.38
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_mapSuffix.33, label %ctrl0

func_mapSuffix.33:                                ; preds = %rand_bb
  %2 = call i8 @mapSuffix.33(i8* %name, i8* %oldSuffix, i8* %newSuffix)
  ret i8 %2

func_mapSuffix.49:                                ; preds = %ctrl0
  %3 = call i8 @mapSuffix.49(i8* %name, i8* %oldSuffix, i8* %newSuffix)
  ret i8 %3

func_mapSuffix.63:                                ; preds = %ctrl1
  %4 = call i8 @mapSuffix.63(i8* %name, i8* %oldSuffix, i8* %newSuffix)
  ret i8 %4

func_mapSuffix.69:                                ; preds = %ctrl1
  %5 = call i8 @mapSuffix.69(i8* %name, i8* %oldSuffix, i8* %newSuffix)
  ret i8 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_mapSuffix.49, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_mapSuffix.63, label %func_mapSuffix.69
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_uncompressStream.21, label %ctrl0

func_uncompressStream.21:                         ; preds = %rand_bb
  %2 = call i8 @uncompressStream.21(%struct._IO_FILE* %zStream, %struct._IO_FILE* %stream)
  ret i8 %2

func_uncompressStream.86:                         ; preds = %ctrl0
  %3 = call i8 @uncompressStream.86(%struct._IO_FILE* %zStream, %struct._IO_FILE* %stream)
  ret i8 %3

func_uncompressStream.88:                         ; preds = %ctrl1
  %4 = call i8 @uncompressStream.88(%struct._IO_FILE* %zStream, %struct._IO_FILE* %stream)
  ret i8 %4

func_uncompressStream.94:                         ; preds = %ctrl1
  %5 = call i8 @uncompressStream.94(%struct._IO_FILE* %zStream, %struct._IO_FILE* %stream)
  ret i8 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_uncompressStream.86, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_uncompressStream.88, label %func_uncompressStream.94
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_testStream.80, label %ctrl0

func_testStream.80:                               ; preds = %rand_bb
  %2 = call i8 @testStream.80(%struct._IO_FILE* %zStream)
  ret i8 %2

func_testStream.83:                               ; preds = %ctrl0
  %3 = call i8 @testStream.83(%struct._IO_FILE* %zStream)
  ret i8 %3

func_testStream.90:                               ; preds = %ctrl1
  %4 = call i8 @testStream.90(%struct._IO_FILE* %zStream)
  ret i8 %4

func_testStream.93:                               ; preds = %ctrl1
  %5 = call i8 @testStream.93(%struct._IO_FILE* %zStream)
  ret i8 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_testStream.83, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_testStream.90, label %func_testStream.93
}
...
entry:
  %canary = alloca i32
  store i32 1760499282, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @notAStandardFile.2(i8* %name) #0 {
entry:
  %i = alloca i32, align 4
  %statBuf = alloca %struct.stat, align 8
  %name.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1837128152, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @uInt64_isZero.3(%struct.UInt64* %n) #0 {
entry:
  %canary = alloca i32
  store i32 2032054380, i32* %canary
  %retval = alloca i8, align 1
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @addFlagsFromEnvVar.4(%struct.zzzz** %argList, i8* %varName) #0 {
entry:
  %j = alloca i32, align 4
  %envbase = alloca i8*, align 8
  %argList.addr = alloca %struct.zzzz**, align 8
  %canary = alloca i32
  store i32 5496357, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1743864740, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @compressStream.6(%struct._IO_FILE* %stream, %struct._IO_FILE* %zStream) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 421130575, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct._IO_FILE* @fopen_output_safely.7(i8* %name, i8* %mode) #0 {
entry:
  %canary = alloca i32
  store i32 437390356, i32* %canary
  %name.addr = alloca i8*, align 8
...
entry:
  ...
  %name.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1044138307, i32* %canary
  %fh = alloca i32, align 4
  %retval = alloca %struct._IO_FILE*, align 8
  %mode.addr = alloca i8*, align 8
  store i8* %name, i8** %name.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @fileExists.9(i8* %name) #0 {
entry:
  %tmp = alloca %struct._IO_FILE*, align 8
  %name.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1731463696, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @addFlagsFromEnvVar.10(%struct.zzzz** %argList, i8* %varName) #0 {
entry:
  %i = alloca i32, align 4
  %k = alloca i32, align 4
  %envbase = alloca i8*, align 8
  %p = alloca i8*, align 8
  %canary = alloca i32
  store i32 2129159011, i32* %canary
  %varName.addr = alloca i8*, align 8
  %j = alloca i32, align 4
  %argList.addr = alloca %struct.zzzz**, align 8
  store %struct.zzzz** %argList, %struct.zzzz*** %argList.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct._IO_FILE* @fopen_output_safely.11(i8* %name, i8* %mode) #0 {
entry:
  %canary = alloca i32
  store i32 1013772452, i32* %canary
  %name.addr = alloca i8*, align 8
  %fp = alloca %struct._IO_FILE*, align 8
  %fh = alloca i32, align 4
  %mode.addr = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal %struct.zzzz* @snocString.12(%struct.zzzz* %root, i8* %name) #0 {
entry:
  %name.addr = alloca i8*, align 8
  %tmp6 = alloca %struct.zzzz*, align 8
  %tmp = alloca %struct.zzzz*, align 8
  %canary = alloca i32
  store i32 1190317651, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @notAStandardFile.13(i8* %name) #0 {
entry:
  %statBuf = alloca %struct.stat, align 8
  %retval = alloca i8, align 1
  %canary = alloca i32
  store i32 754920566, i32* %canary
  %name.addr = alloca i8*, align 8
  %i = alloca i32, align 4
  store i8* %name, i8** %name.addr, align 8
  %0 = load i8*, i8** %name.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @uInt64_from_UInt32s.14(%struct.UInt64* %n, i32 %lo32, i32 %hi32) #0 {
entry:
  %hi32.addr = alloca i32, align 4
  %n.addr = alloca %struct.UInt64*, align 8
  %canary = alloca i32
  store i32 1870519724, i32* %canary
  %lo32.addr = alloca i32, align 4
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
  store i32 %lo32, i32* %lo32.addr, align 4
  store i32 %hi32, i32* %hi32.addr, align 4
...
entry:
  %name.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 944891218, i32* %canary
  %exists = alloca i8, align 1
  %tmp = alloca %struct._IO_FILE*, align 8
  store i8* %name, i8** %name.addr, align 8
  %0 = load i8*, i8** %name.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @testf.16(i8* %name) #0 {
entry:
  %name.addr = alloca i8*, align 8
  %statBuf = alloca %struct.stat, align 8
  %allOK = alloca i8, align 1
  %canary = alloca i32
  store i32 1086914105, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @pad.17(i8* %s) #0 {
entry:
  %canary = alloca i32
  store i32 616326187, i32* %canary
  %i = alloca i32, align 4
  %s.addr = alloca i8*, align 8
  store i8* %s, i8** %s.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @uInt64_toAscii.18(i8* %outbuf, %struct.UInt64* %n) #0 {
entry:
  %canary = alloca i32
  store i32 14396984, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal %struct.zzzz* @snocString.19(%struct.zzzz* %root, i8* %name) #0 {
entry:
  %root.addr = alloca %struct.zzzz*, align 8
  %tmp = alloca %struct.zzzz*, align 8
  %retval = alloca %struct.zzzz*, align 8
  %canary = alloca i32
  store i32 684719610, i32* %canary
  %name.addr = alloca i8*, align 8
  %tmp6 = alloca %struct.zzzz*, align 8
  store %struct.zzzz* %root, %struct.zzzz** %root.addr, align 8
  store i8* %name, i8** %name.addr, align 8
...
entry:
  %n.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1680713054, i32* %canary
  %p = alloca i8*, align 8
  store i32 %n, i32* %n.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @uncompressStream.21(%struct._IO_FILE* %zStream, %struct._IO_FILE* %stream) #0 {
entry:
  %stream.addr = alloca %struct._IO_FILE*, align 8
  ...
  %bzerr_dummy = alloca i32, align 4
  %canary = alloca i32
  store i32 2073674821, i32* %canary
...
; Function Attrs: noinline noreturn nounwind optnone uwtable
define internal void @cleanUpAndFail.22(i32 %ec) #5 {
entry:
  %canary = alloca i32
  store i32 2053325040, i32* %canary
  %retVal = alloca i32, align 4
  %statBuf = alloca %struct.stat, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @uInt64_isZero.23(%struct.UInt64* %n) #0 {
entry:
  %i = alloca i32, align 4
  %n.addr = alloca %struct.UInt64*, align 8
  %canary = alloca i32
  store i32 179325943, i32* %canary
  %retval = alloca i8, align 1
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
  store i32 0, i32* %i, align 4
  br label %for.cond
...
; Function Attrs: noinline nounwind optnone uwtable
define internal %struct.zzzz* @snocString.24(%struct.zzzz* %root, i8* %name) #0 {
entry:
  %root.addr = alloca %struct.zzzz*, align 8
  %name.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 60129218, i32* %canary
  %tmp = alloca %struct.zzzz*, align 8
  %retval = alloca %struct.zzzz*, align 8
  %tmp6 = alloca %struct.zzzz*, align 8
  store %struct.zzzz* %root, %struct.zzzz** %root.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @addFlagsFromEnvVar.25(%struct.zzzz** %argList, i8* %varName) #0 {
entry:
  %k = alloca i32, align 4
  %canary = alloca i32
  store i32 1503385464, i32* %canary
  %j = alloca i32, align 4
  %p = alloca i8*, align 8
  %argList.addr = alloca %struct.zzzz**, align 8
  %varName.addr = alloca i8*, align 8
...
; Function Attrs: noinline noreturn nounwind optnone uwtable
define internal void @cleanUpAndFail.26(i32 %ec) #5 {
entry:
  %canary = alloca i32
  store i32 486172063, i32* %canary
  %ec.addr = alloca i32, align 4
  %retVal = alloca i32, align 4
  %statBuf = alloca %struct.stat, align 8
  store i32 %ec, i32* %ec.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @hasSuffix.27(i8* %s, i8* %suffix) #0 {
entry:
  %nx = alloca i32, align 4
  %s.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1095707054, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i8* @myMalloc.28(i32 %n) #0 {
entry:
  %canary = alloca i32
  store i32 300182383, i32* %canary
  %p = alloca i8*, align 8
  %n.addr = alloca i32, align 4
  store i32 %n, i32* %n.addr, align 4
  %0 = load i32, i32* %n.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct._IO_FILE* @fopen_output_safely.29(i8* %name, i8* %mode) #0 {
entry:
  %fh = alloca i32, align 4
  %mode.addr = alloca i8*, align 8
  %name.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 487708551, i32* %canary
  %fp = alloca %struct._IO_FILE*, align 8
  %retval = alloca %struct._IO_FILE*, align 8
  store i8* %name, i8** %name.addr, align 8
  store i8* %mode, i8** %mode.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @countHardLinks.30(i8* %name) #0 {
entry:
  %name.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1680090047, i32* %canary
  %i = alloca i32, align 4
  %statBuf = alloca %struct.stat, align 8
  %retval = alloca i32, align 4
  store i8* %name, i8** %name.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @fileExists.31(i8* %name) #0 {
entry:
  %exists = alloca i8, align 1
  %canary = alloca i32
  store i32 1588532010, i32* %canary
  %tmp = alloca %struct._IO_FILE*, align 8
  %name.addr = alloca i8*, align 8
  store i8* %name, i8** %name.addr, align 8
  %0 = load i8*, i8** %name.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @applySavedMetaInfoToOutputFile.32(i8* %dstName) #0 {
entry:
  %dstName.addr = alloca i8*, align 8
  %retVal = alloca i32, align 4
  %canary = alloca i32
  store i32 1307751383, i32* %canary
  %uTimBuf = alloca %struct.utimbuf, align 8
  store i8* %dstName, i8** %dstName.addr, align 8
  %0 = load i64, i64* getelementptr inbounds (%struct.stat, %struct.stat* @fileMetaInfo, i32 0, i32 11, i32 0), align 8
  %actime = getelementptr inbounds %struct.utimbuf, %struct.utimbuf* %uTimBuf, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @mapSuffix.33(i8* %name, i8* %oldSuffix, i8* %newSuffix) #0 {
entry:
  %name.addr = alloca i8*, align 8
  %retval = alloca i8, align 1
  %canary = alloca i32
  store i32 1618737359, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @uncompress.34(i8* %name) #0 {
entry:
  %name.addr = alloca i8*, align 8
  ...
  %inStr = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 2115174209, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @uInt64_toAscii.35(i8* %outbuf, %struct.UInt64* %n) #0 {
entry:
  %canary = alloca i32
  store i32 594726496, i32* %canary
  %i = alloca i32, align 4
  %q = alloca i32, align 4
  %n.addr = alloca %struct.UInt64*, align 8
  %nBuf = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @myfeof.36(%struct._IO_FILE* %f) #0 {
entry:
  %c = alloca i32, align 4
  %canary = alloca i32
  store i32 331469682, i32* %canary
  %retval = alloca i8, align 1
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @uInt64_isZero.37(%struct.UInt64* %n) #0 {
entry:
  %canary = alloca i32
  store i32 1903656949, i32* %canary
  %n.addr = alloca %struct.UInt64*, align 8
  %retval = alloca i8, align 1
  %i = alloca i32, align 4
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @uInt64_isZero.38(%struct.UInt64* %n) #0 {
entry:
  %canary = alloca i32
  store i32 1081729828, i32* %canary
  %retval = alloca i8, align 1
  %i = alloca i32, align 4
  %n.addr = alloca %struct.UInt64*, align 8
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 632935859, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @uncompress.40(i8* %name) #0 {
entry:
  %n = alloca i32, align 4
  %inStr = alloca %struct._IO_FILE*, align 8
  %cantGuess = alloca i8, align 1
  ...
  %retVal = alloca i32, align 4
  %canary = alloca i32
  store i32 1532148348, i32* %canary
  %outStr = alloca %struct._IO_FILE*, align 8
  %magicNumberOK = alloca i8, align 1
  store i8* %name, i8** %name.addr, align 8
  store i8 0, i8* @deleteOutputOnInterrupt, align 1
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @copyFileName.41(i8* %to, i8* %from) #0 {
entry:
  %from.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 387277520, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @uInt64_toAscii.42(i8* %outbuf, %struct.UInt64* %n) #0 {
entry:
  %nBuf = alloca i32, align 4
  %i = alloca i32, align 4
  %n_copy = alloca %struct.UInt64, align 1
  ...
  %buf = alloca [32 x i8], align 16
  %canary = alloca i32
  store i32 767437323, i32* %canary
  %q = alloca i32, align 4
  store i8* %outbuf, i8** %outbuf.addr, align 8
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
  store i32 0, i32* %nBuf, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @fileExists.43(i8* %name) #0 {
entry:
  %canary = alloca i32
  store i32 511067183, i32* %canary
  %exists = alloca i8, align 1
  %name.addr = alloca i8*, align 8
  %tmp = alloca %struct._IO_FILE*, align 8
  store i8* %name, i8** %name.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @countHardLinks.44(i8* %name) #0 {
entry:
  %i = alloca i32, align 4
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 75482364, i32* %canary
  %statBuf = alloca %struct.stat, align 8
  %name.addr = alloca i8*, align 8
  store i8* %name, i8** %name.addr, align 8
  %0 = load i8*, i8** %name.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @countHardLinks.45(i8* %name) #0 {
entry:
  %canary = alloca i32
  store i32 1846172278, i32* %canary
  %statBuf = alloca %struct.stat, align 8
  %name.addr = alloca i8*, align 8
  %retval = alloca i32, align 4
  %i = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1973894306, i32* %canary
  %q = alloca i32, align 4
  %outbuf.addr = alloca i8*, align 8
  %i = alloca i32, align 4
  %n.addr = alloca %struct.UInt64*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @addFlagsFromEnvVar.47(%struct.zzzz** %argList, i8* %varName) #0 {
entry:
  %j = alloca i32, align 4
  %i = alloca i32, align 4
  %argList.addr = alloca %struct.zzzz**, align 8
  %p = alloca i8*, align 8
  %canary = alloca i32
  store i32 1164446648, i32* %canary
  %envbase = alloca i8*, align 8
  %k = alloca i32, align 4
  %varName.addr = alloca i8*, align 8
  store %struct.zzzz** %argList, %struct.zzzz*** %argList.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @applySavedMetaInfoToOutputFile.48(i8* %dstName) #0 {
entry:
  %retVal = alloca i32, align 4
  %dstName.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 142144932, i32* %canary
  %uTimBuf = alloca %struct.utimbuf, align 8
  store i8* %dstName, i8** %dstName.addr, align 8
  %0 = load i64, i64* getelementptr inbounds (%struct.stat, %struct.stat* @fileMetaInfo, i32 0, i32 11, i32 0), align 8
  %actime = getelementptr inbounds %struct.utimbuf, %struct.utimbuf* %uTimBuf, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @mapSuffix.49(i8* %name, i8* %oldSuffix, i8* %newSuffix) #0 {
entry:
  %oldSuffix.addr = alloca i8*, align 8
  %name.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 654996090, i32* %canary
  %newSuffix.addr = alloca i8*, align 8
  %retval = alloca i8, align 1
  store i8* %name, i8** %name.addr, align 8
  store i8* %oldSuffix, i8** %oldSuffix.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @hasSuffix.50(i8* %s, i8* %suffix) #0 {
entry:
  %s.addr = alloca i8*, align 8
  %retval = alloca i8, align 1
  %nx = alloca i32, align 4
  %canary = alloca i32
  store i32 469110816, i32* %canary
  %suffix.addr = alloca i8*, align 8
  %ns = alloca i32, align 4
  store i8* %s, i8** %s.addr, align 8
  store i8* %suffix, i8** %suffix.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @compressStream.51(%struct._IO_FILE* %stream, %struct._IO_FILE* %zStream) #0 {
entry:
  %bzf = alloca i8*, align 8
  %nbytes_out = alloca %struct.UInt64, align 1
  %canary = alloca i32
  store i32 604055148, i32* %canary
  %nbytes_out_lo32 = alloca i32, align 4
  %nbytes_in_lo32 = alloca i32, align 4
  %nbytes_in = alloca %struct.UInt64, align 1
  %buf_nout = alloca [32 x i8], align 16
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @compress.52(i8* %name) #0 {
entry:
  %statBuf = alloca %struct.stat, align 8
  %i = alloca i32, align 4
  %inStr = alloca %struct._IO_FILE*, align 8
  %outStr = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 491552577, i32* %canary
  %name.addr = alloca i8*, align 8
  %retVal = alloca i32, align 4
  %n = alloca i32, align 4
  store i8* %name, i8** %name.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @myfeof.53(%struct._IO_FILE* %f) #0 {
entry:
  %f.addr = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 53625937, i32* %canary
  %retval = alloca i8, align 1
  %c = alloca i32, align 4
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** %f.addr, align 8
...
entry:
  ...
  %outStr = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 394512868, i32* %canary
  %retVal = alloca i32, align 4
  store i8* %name, i8** %name.addr, align 8
  store i8 0, i8* @deleteOutputOnInterrupt, align 1
  %0 = load i8*, i8** %name.addr, align 8
...
entry:
  %uTimBuf = alloca %struct.utimbuf, align 8
  %canary = alloca i32
  store i32 783362038, i32* %canary
  %dstName.addr = alloca i8*, align 8
  %retVal = alloca i32, align 4
  store i8* %dstName, i8** %dstName.addr, align 8
  %0 = load i64, i64* getelementptr inbounds (%struct.stat, %struct.stat* @fileMetaInfo, i32 0, i32 11, i32 0), align 8
...
entry:
  %c = alloca i32, align 4
  %canary = alloca i32
  store i32 1387358481, i32* %canary
  %f.addr = alloca %struct._IO_FILE*, align 8
  %retval = alloca i8, align 1
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** %f.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @myfeof.57(%struct._IO_FILE* %f) #0 {
entry:
  %retval = alloca i8, align 1
  %c = alloca i32, align 4
  %canary = alloca i32
  store i32 1040885950, i32* %canary
  %f.addr = alloca %struct._IO_FILE*, align 8
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** %f.addr, align 8
  %call = call i32 @fgetc(%struct._IO_FILE* %0)
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @copyFileName.58(i8* %to, i8* %from) #0 {
entry:
  %canary = alloca i32
  store i32 1437413799, i32* %canary
  %to.addr = alloca i8*, align 8
  %from.addr = alloca i8*, align 8
  store i8* %to, i8** %to.addr, align 8
  store i8* %from, i8** %from.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @testf.59(i8* %name) #0 {
entry:
  %canary = alloca i32
  store i32 230894662, i32* %canary
  %allOK = alloca i8, align 1
  %statBuf = alloca %struct.stat, align 8
  %inStr = alloca %struct._IO_FILE*, align 8
  %name.addr = alloca i8*, align 8
...
entry:
  ...
  %tmp = alloca %struct.zzzz*, align 8
  %canary = alloca i32
  store i32 1337613795, i32* %canary
  %tmp6 = alloca %struct.zzzz*, align 8
  %root.addr = alloca %struct.zzzz*, align 8
  %retval = alloca %struct.zzzz*, align 8
  store %struct.zzzz* %root, %struct.zzzz** %root.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @uncompress.61(i8* %name) #0 {
entry:
  %n = alloca i32, align 4
  %retVal168 = alloca i32, align 4
  %inStr = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 671422001, i32* %canary
  %i = alloca i32, align 4
  %cantGuess = alloca i8, align 1
  %magicNumberOK = alloca i8, align 1
  %outStr = alloca %struct._IO_FILE*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @hasSuffix.62(i8* %s, i8* %suffix) #0 {
entry:
  %retval = alloca i8, align 1
  %canary = alloca i32
  store i32 84941961, i32* %canary
  %suffix.addr = alloca i8*, align 8
  %nx = alloca i32, align 4
  %s.addr = alloca i8*, align 8
  %ns = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @mapSuffix.63(i8* %name, i8* %oldSuffix, i8* %newSuffix) #0 {
entry:
  %canary = alloca i32
  store i32 40449839, i32* %canary
  %name.addr = alloca i8*, align 8
  %oldSuffix.addr = alloca i8*, align 8
  %newSuffix.addr = alloca i8*, align 8
  %retval = alloca i8, align 1
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @uInt64_qrm10.64(%struct.UInt64* %n) #0 {
entry:
  %rem = alloca i32, align 4
  %tmp = alloca i32, align 4
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1832576925, i32* %canary
  %n.addr = alloca %struct.UInt64*, align 8
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @notAStandardFile.65(i8* %name) #0 {
entry:
  %retval = alloca i8, align 1
  %name.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1285524221, i32* %canary
  %statBuf = alloca %struct.stat, align 8
  %i = alloca i32, align 4
  store i8* %name, i8** %name.addr, align 8
  %0 = load i8*, i8** %name.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @countHardLinks.66(i8* %name) #0 {
entry:
  %statBuf = alloca %struct.stat, align 8
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1545127320, i32* %canary
  %name.addr = alloca i8*, align 8
  %retval = alloca i32, align 4
  store i8* %name, i8** %name.addr, align 8
  %0 = load i8*, i8** %name.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @pad.67(i8* %s) #0 {
entry:
  %s.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 933296832, i32* %canary
  %i = alloca i32, align 4
  store i8* %s, i8** %s.addr, align 8
  %0 = load i8*, i8** %s.addr, align 8
  %call = call i64 @strlen(i8* %0) #9
...
entry:
  %statBuf = alloca %struct.stat, align 8
  %canary = alloca i32
  store i32 355489014, i32* %canary
  %i = alloca i32, align 4
  %name.addr = alloca i8*, align 8
  %retval = alloca i8, align 1
  store i8* %name, i8** %name.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 984061243, i32* %canary
  %name.addr = alloca i8*, align 8
  %oldSuffix.addr = alloca i8*, align 8
  %retval = alloca i8, align 1
  %newSuffix.addr = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @uInt64_from_UInt32s.70(%struct.UInt64* %n, i32 %lo32, i32 %hi32) #0 {
entry:
  %lo32.addr = alloca i32, align 4
  %hi32.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1761633110, i32* %canary
  %n.addr = alloca %struct.UInt64*, align 8
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
  store i32 %lo32, i32* %lo32.addr, align 4
  store i32 %hi32, i32* %hi32.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal double @uInt64_to_double.71(%struct.UInt64* %n) #0 {
entry:
  %i = alloca i32, align 4
  %n.addr = alloca %struct.UInt64*, align 8
  %canary = alloca i32
  store i32 1045004893, i32* %canary
  %sum = alloca double, align 8
  %base = alloca double, align 8
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
  store double 1.000000e+00, double* %base, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @uncompress.72(i8* %name) #0 {
entry:
  %cantGuess = alloca i8, align 1
  %canary = alloca i32
  store i32 809698273, i32* %canary
  %magicNumberOK = alloca i8, align 1
  %i = alloca i32, align 4
  %inStr = alloca %struct._IO_FILE*, align 8
  %retVal = alloca i32, align 4
...
; Function Attrs: noinline noreturn nounwind optnone uwtable
define internal void @cleanUpAndFail.73(i32 %ec) #5 {
entry:
  %retVal = alloca i32, align 4
  %ec.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 667469162, i32* %canary
  %statBuf = alloca %struct.stat, align 8
  store i32 %ec, i32* %ec.addr, align 4
  %0 = load i32, i32* @srcMode, align 4
  %cmp = icmp eq i32 %0, 3
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @hasSuffix.74(i8* %s, i8* %suffix) #0 {
entry:
  %suffix.addr = alloca i8*, align 8
  %nx = alloca i32, align 4
  %s.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1944380204, i32* %canary
  %retval = alloca i8, align 1
  %ns = alloca i32, align 4
  store i8* %s, i8** %s.addr, align 8
  store i8* %suffix, i8** %suffix.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @saveInputFileMetaInfo.75(i8* %srcName) #0 {
entry:
  %canary = alloca i32
  store i32 717800780, i32* %canary
...
entry:
  %n.addr = alloca %struct.UInt64*, align 8
  %canary = alloca i32
  store i32 1484477248, i32* %canary
  %lo32.addr = alloca i32, align 4
  %hi32.addr = alloca i32, align 4
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
  store i32 %lo32, i32* %lo32.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @uInt64_qrm10.77(%struct.UInt64* %n) #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 724548503, i32* %canary
  %n.addr = alloca %struct.UInt64*, align 8
  %rem = alloca i32, align 4
  %tmp = alloca i32, align 4
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 812526608, i32* %canary
  %sum = alloca double, align 8
  %base = alloca double, align 8
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
  store double 1.000000e+00, double* %base, align 8
...
; Function Attrs: noinline noreturn nounwind optnone uwtable
define internal void @cleanUpAndFail.79(i32 %ec) #5 {
entry:
  %statBuf = alloca %struct.stat, align 8
  %ec.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 304875957, i32* %canary
  %retVal = alloca i32, align 4
  store i32 %ec, i32* %ec.addr, align 4
  %0 = load i32, i32* @srcMode, align 4
  %cmp = icmp eq i32 %0, 3
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @testStream.80(%struct._IO_FILE* %zStream) #0 {
entry:
  %bzf = alloca i8*, align 8
  %nUnused = alloca i32, align 4
  %ret = alloca i32, align 4
  %canary = alloca i32
  store i32 1150743681, i32* %canary
  %bzerr = alloca i32, align 4
  %retval = alloca i8, align 1
  %unusedTmpV = alloca i8*, align 8
  %bzerr_dummy = alloca i32, align 4
...
entry:
  ...
  %rem = alloca i32, align 4
  %canary = alloca i32
  store i32 1688952114, i32* %canary
  %tmp = alloca i32, align 4
  %n.addr = alloca %struct.UInt64*, align 8
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
  store i32 0, i32* %rem, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @testf.82(i8* %name) #0 {
entry:
  %inStr = alloca %struct._IO_FILE*, align 8
  %allOK = alloca i8, align 1
  %canary = alloca i32
  store i32 2110904864, i32* %canary
  %name.addr = alloca i8*, align 8
  %statBuf = alloca %struct.stat, align 8
  store i8* %name, i8** %name.addr, align 8
  store i8 0, i8* @deleteOutputOnInterrupt, align 1
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @testStream.83(%struct._IO_FILE* %zStream) #0 {
entry:
  %canary = alloca i32
  store i32 631897428, i32* %canary
  %streamNo = alloca i32, align 4
  %bzf = alloca i8*, align 8
  %zStream.addr = alloca %struct._IO_FILE*, align 8
  %unusedTmpV = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @uInt64_qrm10.84(%struct.UInt64* %n) #0 {
entry:
  %rem = alloca i32, align 4
  %n.addr = alloca %struct.UInt64*, align 8
  %canary = alloca i32
  store i32 1356151167, i32* %canary
  %tmp = alloca i32, align 4
  %i = alloca i32, align 4
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
  store i32 0, i32* %rem, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @saveInputFileMetaInfo.85(i8* %srcName) #0 {
entry:
  %retVal = alloca i32, align 4
  %canary = alloca i32
  store i32 1140043820, i32* %canary
  %srcName.addr = alloca i8*, align 8
  store i8* %srcName, i8** %srcName.addr, align 8
  %0 = load i8*, i8** %srcName.addr, align 8
  %call = call i32 @stat(i8* %0, %struct.stat* @fileMetaInfo) #8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @uncompressStream.86(%struct._IO_FILE* %zStream, %struct._IO_FILE* %stream) #0 {
entry:
  %bzerr_dummy = alloca i32, align 4
  %zStream.addr = alloca %struct._IO_FILE*, align 8
  %bzerr = alloca i32, align 4
  ...
  %unused = alloca [5000 x i8], align 16
  %canary = alloca i32
  store i32 596531554, i32* %canary
  %nUnused = alloca i32, align 4
  %bzf = alloca i8*, align 8
  %unusedTmp = alloca i8*, align 8
  %ret = alloca i32, align 4
...
entry:
  ...
  %inStr = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 1923543239, i32* %canary
  %name.addr = alloca i8*, align 8
  %statBuf = alloca %struct.stat, align 8
  store i8* %name, i8** %name.addr, align 8
  store i8 0, i8* @deleteOutputOnInterrupt, align 1
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @uncompressStream.88(%struct._IO_FILE* %zStream, %struct._IO_FILE* %stream) #0 {
entry:
  %bzerr_dummy = alloca i32, align 4
  %i = alloca i32, align 4
  %streamNo = alloca i32, align 4
  ...
  %bzf = alloca i8*, align 8
  %canary = alloca i32
  store i32 1076274626, i32* %canary
  %obuf = alloca [5000 x i8], align 16
  %nread = alloca i32, align 4
  %unused = alloca [5000 x i8], align 16
  %bzerr = alloca i32, align 4
...
entry:
  ...
  %statBuf = alloca %struct.stat, align 8
  %canary = alloca i32
  store i32 2143048556, i32* %canary
  %i = alloca i32, align 4
  %inStr = alloca %struct._IO_FILE*, align 8
  %retVal = alloca i32, align 4
  store i8* %name, i8** %name.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @testStream.90(%struct._IO_FILE* %zStream) #0 {
entry:
  %bzerr = alloca i32, align 4
  %streamNo = alloca i32, align 4
  %unused = alloca [5000 x i8], align 16
  ...
  %obuf = alloca [5000 x i8], align 16
  %canary = alloca i32
  store i32 556961574, i32* %canary
  %bzf = alloca i8*, align 8
  %nread = alloca i32, align 4
  %unusedTmp = alloca i8*, align 8
  store %struct._IO_FILE* %zStream, %struct._IO_FILE** %zStream.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal double @uInt64_to_double.91(%struct.UInt64* %n) #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 326435718, i32* %canary
  %base = alloca double, align 8
  %n.addr = alloca %struct.UInt64*, align 8
  %sum = alloca double, align 8
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @compressStream.92(%struct._IO_FILE* %stream, %struct._IO_FILE* %zStream) #0 {
entry:
  %buf_nin = alloca [32 x i8], align 16
  %bzerr_dummy = alloca i32, align 4
  %nbytes_out_d = alloca double, align 8
  %canary = alloca i32
  store i32 1944854521, i32* %canary
  %zStream.addr = alloca %struct._IO_FILE*, align 8
  %stream.addr = alloca %struct._IO_FILE*, align 8
  %nbytes_in_lo32 = alloca i32, align 4
  %buf_nout = alloca [32 x i8], align 16
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @testStream.93(%struct._IO_FILE* %zStream) #0 {
entry:
  %i = alloca i32, align 4
  %unusedTmpV = alloca i8*, align 8
  %nread = alloca i32, align 4
  ...
  %retval = alloca i8, align 1
  %canary = alloca i32
  store i32 1023459986, i32* %canary
  %streamNo = alloca i32, align 4
  %ret = alloca i32, align 4
  %bzerr = alloca i32, align 4
  %bzerr_dummy = alloca i32, align 4
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 313165445, i32* %canary
  %zStream.addr = alloca %struct._IO_FILE*, align 8
  %bzerr_dummy = alloca i32, align 4
  %obuf = alloca [5000 x i8], align 16
  %nUnused = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @compress.95(i8* %name) #0 {
entry:
  %n = alloca i32, align 4
  %canary = alloca i32
  store i32 108125177, i32* %canary
  %statBuf = alloca %struct.stat, align 8
  %name.addr = alloca i8*, align 8
  %inStr = alloca %struct._IO_FILE*, align 8
  %retVal = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @compressStream.96(%struct._IO_FILE* %stream, %struct._IO_FILE* %zStream) #0 {
entry:
  %ret = alloca i32, align 4
  %nIbuf = alloca i32, align 4
  %nbytes_out_lo32 = alloca i32, align 4
  ...
  %nbytes_in_lo32 = alloca i32, align 4
  %canary = alloca i32
  store i32 666504926, i32* %canary
  %nbytes_out = alloca %struct.UInt64, align 1
  %bzerr = alloca i32, align 4
  %ibuf = alloca [5000 x i8], align 16
  %stream.addr = alloca %struct._IO_FILE*, align 8
