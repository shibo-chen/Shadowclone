; ModuleID = 'huffman.c.rand.8R2.bc'
...
func_BZ2_hbMakeCodeLengths.5:                     ; preds = %ctrl1
...
func_BZ2_hbMakeCodeLengths.18:                    ; preds = %ctrl5
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_BZ2_hbMakeCodeLengths.5, label %ctrl2
...
ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_BZ2_hbMakeCodeLengths.17, label %func_BZ2_hbMakeCodeLengths.18
}
...
func_BZ2_hbAssignCodes.10:                        ; preds = %ctrl2
...
ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_BZ2_hbAssignCodes.10, label %ctrl3
...
ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_BZ2_hbAssignCodes.14, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_BZ2_hbAssignCodes.19, label %func_BZ2_hbAssignCodes.20
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_BZ2_hbCreateDecodeTables.7, label %ctrl0

func_BZ2_hbCreateDecodeTables.7:                  ; preds = %rand_bb
...
func_BZ2_hbCreateDecodeTables.16:                 ; preds = %ctrl2
...
func_BZ2_hbCreateDecodeTables.22:                 ; preds = %ctrl4
...
ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_BZ2_hbCreateDecodeTables.16, label %ctrl3
...
ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_BZ2_hbCreateDecodeTables.22, label %ctrl5
...
entry:
  %canary = alloca i32
  store i32 311011532, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 851923693, i32* %canary
...
entry:
  ...
  %code.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 801288417, i32* %canary
  %i = alloca i32, align 4
  %n = alloca i32, align 4
  %alphaSize.addr = alloca i32, align 4
  store i32* %code, i32** %code.addr, align 8
...
entry:
  ...
  %n1 = alloca i32, align 4
  %canary = alloca i32
  store i32 1459439409, i32* %canary
  %alphaSize.addr = alloca i32, align 4
  %heap = alloca [260 x i32], align 16
  %tmp171 = alloca i32, align 4
  %tooLong = alloca i8, align 1
...
while.end234:                                     ; preds = %if.then218
  %151 = load i32, i32* %canary
  %152 = icmp eq i32 %151, 1459439409
  br i1 %152, label %153, label %func_exit
...
entry:
  ...
  %zz170 = alloca i32, align 4
  %canary = alloca i32
  store i32 1196501398, i32* %canary
  %n1 = alloca i32, align 4
  %yy93 = alloca i32, align 4
  %tmp48 = alloca i32, align 4
  %i = alloca i32, align 4
...
while.end234:                                     ; preds = %if.then218
  %151 = load i32, i32* %canary
  %152 = icmp eq i32 %151, 1196501398
  br i1 %152, label %153, label %func_exit
...
entry:
  ...
  %code.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 100142023, i32* %canary
  %maxLen.addr = alloca i32, align 4
  %minLen.addr = alloca i32, align 4
  store i32* %code, i32** %code.addr, align 8
  store i8* %length, i8** %length.addr, align 8
...
entry:
  ...
  %vec = alloca i32, align 4
  %canary = alloca i32
  store i32 383176819, i32* %canary
  %perm.addr = alloca i32*, align 8
  %limit.addr = alloca i32*, align 8
  %base.addr = alloca i32*, align 8
  %minLen.addr = alloca i32, align 4
...
entry:
  ...
  %n2 = alloca i32, align 4
  %canary = alloca i32
  store i32 1344390428, i32* %canary
  %freq.addr = alloca i32*, align 8
  %zz92 = alloca i32, align 4
  %tmp171 = alloca i32, align 4
  %nHeap = alloca i32, align 4
...
while.end234:                                     ; preds = %if.then218
  %151 = load i32, i32* %canary
  %152 = icmp eq i32 %151, 1344390428
  br i1 %152, label %153, label %func_exit
...
entry:
  ...
  %minLen.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 140329799, i32* %canary
  %vec = alloca i32, align 4
  %i = alloca i32, align 4
  %code.addr = alloca i32*, align 8
  %length.addr = alloca i8*, align 8
...
entry:
  ...
  %code.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 1806932655, i32* %canary
  %alphaSize.addr = alloca i32, align 4
  store i32* %code, i32** %code.addr, align 8
  store i8* %length, i8** %length.addr, align 8
  store i32 %minLen, i32* %minLen.addr, align 4
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 543573607, i32* %canary
  %j = alloca i32, align 4
  %maxLen.addr = alloca i32, align 4
  %minLen.addr = alloca i32, align 4
  %vec = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 574596520, i32* %canary
  %tmp48 = alloca i32, align 4
  %yy93 = alloca i32, align 4
  %freq.addr = alloca i32*, align 8
  %weight = alloca [516 x i32], align 16
...
entry:
  ...
  %n = alloca i32, align 4
  %canary = alloca i32
  store i32 985086779, i32* %canary
  %length.addr = alloca i8*, align 8
  %vec = alloca i32, align 4
  store i32* %code, i32** %code.addr, align 8
  store i8* %length, i8** %length.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 681214895, i32* %canary
  %nHeap = alloca i32, align 4
  %n1 = alloca i32, align 4
  %zz170 = alloca i32, align 4
  %i = alloca i32, align 4
...
entry:
  ...
  %minLen.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 502455377, i32* %canary
  %vec = alloca i32, align 4
  %pp = alloca i32, align 4
  %maxLen.addr = alloca i32, align 4
  store i32* %limit, i32** %limit.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 2049403354, i32* %canary
  %n2 = alloca i32, align 4
  %n1 = alloca i32, align 4
  %tmp171 = alloca i32, align 4
  %nHeap = alloca i32, align 4
...
while.end234:                                     ; preds = %if.then218
  %151 = load i32, i32* %canary
  %152 = icmp eq i32 %151, 2049403354
  br i1 %152, label %153, label %func_exit
...
entry:
  ...
  %tmp94 = alloca i32, align 4
  %canary = alloca i32
  store i32 846926000, i32* %canary
  %heap = alloca [260 x i32], align 16
  %parent = alloca [516 x i32], align 16
  %zz47 = alloca i32, align 4
  %zz = alloca i32, align 4
...
entry:
  ...
  %maxLen.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 883185560, i32* %canary
  %minLen.addr = alloca i32, align 4
  store i32* %code, i32** %code.addr, align 8
  store i8* %length, i8** %length.addr, align 8
  store i32 %minLen, i32* %minLen.addr, align 4
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1637987708, i32* %canary
  %maxLen.addr = alloca i32, align 4
  %code.addr = alloca i32*, align 8
  %minLen.addr = alloca i32, align 4
  store i32* %code, i32** %code.addr, align 8
...
entry:
  ...
  %perm.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 830298354, i32* %canary
  %vec = alloca i32, align 4
  %maxLen.addr = alloca i32, align 4
  %base.addr = alloca i32*, align 8
  %alphaSize.addr = alloca i32, align 4
...
entry:
  ...
  %alphaSize.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 734345469, i32* %canary
  %minLen.addr = alloca i32, align 4
  %limit.addr = alloca i32*, align 8
  %i = alloca i32, align 4
  %pp = alloca i32, align 4
...
entry:
  ...
  %minLen.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 987424118, i32* %canary
  %i = alloca i32, align 4
  %pp = alloca i32, align 4
  %limit.addr = alloca i32*, align 8
  %base.addr = alloca i32*, align 8
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 507916103, i32* %canary
  %vec = alloca i32, align 4
  %length.addr = alloca i8*, align 8
  %limit.addr = alloca i32*, align 8
  %pp = alloca i32, align 4
