; ModuleID = 'huffman.c.rand.8R3.bc'
...
func_BZ2_hbMakeCodeLengths.10:                    ; preds = %ctrl2
...
func_BZ2_hbMakeCodeLengths.15:                    ; preds = %ctrl5
...
ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_BZ2_hbMakeCodeLengths.10, label %ctrl3
...
ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_BZ2_hbMakeCodeLengths.15, label %func_BZ2_hbMakeCodeLengths.16
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_BZ2_hbAssignCodes.4, label %ctrl0

func_BZ2_hbAssignCodes.4:                         ; preds = %rand_bb
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_BZ2_hbAssignCodes.17, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_BZ2_hbAssignCodes.19, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_BZ2_hbAssignCodes.20, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_BZ2_hbAssignCodes.22, label %ctrl5
...
func_BZ2_hbCreateDecodeTables.6:                  ; preds = %ctrl1
...
func_BZ2_hbCreateDecodeTables.11:                 ; preds = %ctrl4
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_BZ2_hbCreateDecodeTables.6, label %ctrl2
...
ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_BZ2_hbCreateDecodeTables.11, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_BZ2_hbCreateDecodeTables.18, label %func_BZ2_hbCreateDecodeTables.21
}
...
entry:
  ...
  %canary = alloca i32
  store i32 1273371069, i32* %canary
...
while.end234:                                     ; preds = %if.then218
  ...
  %152 = icmp eq i32 %151, 1273371069
...
entry:
  %canary = alloca i32
  store i32 575178790, i32* %canary
  %j = alloca i32, align 4
...
entry:
  ...
  %tmp48 = alloca i32, align 4
  %canary = alloca i32
  store i32 2079010265, i32* %canary
  %weight = alloca [516 x i32], align 16
  %n1 = alloca i32, align 4
  %i = alloca i32, align 4
  %tmp94 = alloca i32, align 4
...
while.end234:                                     ; preds = %if.then218
  %151 = load i32, i32* %canary
  %152 = icmp eq i32 %151, 2079010265
  br i1 %152, label %153, label %func_exit
...
entry:
  ...
  %minLen.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1120791328, i32* %canary
  %alphaSize.addr = alloca i32, align 4
...
entry:
  ...
  %maxLen.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1230637237, i32* %canary
  %vec = alloca i32, align 4
  store i32* %limit, i32** %limit.addr, align 8
  store i32* %base, i32** %base.addr, align 8
  store i32* %perm, i32** %perm.addr, align 8
...
entry:
  ...
  %perm.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 155427723, i32* %canary
  %limit.addr = alloca i32*, align 8
  store i32* %limit, i32** %limit.addr, align 8
  store i32* %base, i32** %base.addr, align 8
  store i32* %perm, i32** %perm.addr, align 8
...
entry:
  ...
  %tmp171 = alloca i32, align 4
  %canary = alloca i32
  store i32 384885226, i32* %canary
  %j = alloca i32, align 4
  %parent = alloca [516 x i32], align 16
  %n1 = alloca i32, align 4
  %nHeap = alloca i32, align 4
...
entry:
  ...
  %alphaSize.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1367722261, i32* %canary
  %base.addr = alloca i32*, align 8
  %j = alloca i32, align 4
  %length.addr = alloca i8*, align 8
  %minLen.addr = alloca i32, align 4
...
entry:
  ...
  %limit.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 184638494, i32* %canary
  %alphaSize.addr = alloca i32, align 4
  %base.addr = alloca i32*, align 8
  store i32* %limit, i32** %limit.addr, align 8
  store i32* %base, i32** %base.addr, align 8
...
entry:
  ...
  %tmp94 = alloca i32, align 4
  %canary = alloca i32
  store i32 133310379, i32* %canary
  %tmp48 = alloca i32, align 4
  %zz = alloca i32, align 4
  %nNodes = alloca i32, align 4
  %yy = alloca i32, align 4
...
entry:
  ...
  %limit.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 717880352, i32* %canary
  %maxLen.addr = alloca i32, align 4
  %length.addr = alloca i8*, align 8
  %vec = alloca i32, align 4
  %perm.addr = alloca i32*, align 8
...
entry:
  ...
  %code.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 1193965680, i32* %canary
  %alphaSize.addr = alloca i32, align 4
  %vec = alloca i32, align 4
  %minLen.addr = alloca i32, align 4
  store i32* %code, i32** %code.addr, align 8
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1473329026, i32* %canary
  %len.addr = alloca i8*, align 8
  %freq.addr = alloca i32*, align 8
  %tmp48 = alloca i32, align 4
  %tooLong = alloca i8, align 1
...
while.end234:                                     ; preds = %if.then218
  %151 = load i32, i32* %canary
  %152 = icmp eq i32 %151, 1473329026
  br i1 %152, label %153, label %func_exit
...
entry:
  ...
  %zz = alloca i32, align 4
  %canary = alloca i32
  store i32 565351085, i32* %canary
  %alphaSize.addr = alloca i32, align 4
  %yy = alloca i32, align 4
  %maxLen.addr = alloca i32, align 4
  %tmp171 = alloca i32, align 4
...
entry:
  ...
  %yy93 = alloca i32, align 4
  %canary = alloca i32
  store i32 711756221, i32* %canary
  %maxLen.addr = alloca i32, align 4
  %j = alloca i32, align 4
  %tmp171 = alloca i32, align 4
  %n1 = alloca i32, align 4
...
entry:
  ...
  %alphaSize.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 245328657, i32* %canary
  %j = alloca i32, align 4
  %zz170 = alloca i32, align 4
  %nNodes = alloca i32, align 4
  %n2 = alloca i32, align 4
...
entry:
  ...
  %maxLen.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1392958867, i32* %canary
  %minLen.addr = alloca i32, align 4
  %alphaSize.addr = alloca i32, align 4
  %i = alloca i32, align 4
  store i32* %code, i32** %code.addr, align 8
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 813933004, i32* %canary
  %length.addr = alloca i8*, align 8
  store i32* %limit, i32** %limit.addr, align 8
  store i32* %base, i32** %base.addr, align 8
  store i32* %perm, i32** %perm.addr, align 8
...
entry:
  ...
  %code.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 1769780519, i32* %canary
  %maxLen.addr = alloca i32, align 4
  %alphaSize.addr = alloca i32, align 4
  %n = alloca i32, align 4
  store i32* %code, i32** %code.addr, align 8
...
entry:
  ...
  %alphaSize.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 967441901, i32* %canary
  %minLen.addr = alloca i32, align 4
  %vec = alloca i32, align 4
  %code.addr = alloca i32*, align 8
  %i = alloca i32, align 4
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 666067255, i32* %canary
  %minLen.addr = alloca i32, align 4
  %perm.addr = alloca i32*, align 8
  %vec = alloca i32, align 4
  %base.addr = alloca i32*, align 8
...
entry:
  %canary = alloca i32
  store i32 842136031, i32* %canary
  %maxLen.addr = alloca i32, align 4
  %minLen.addr = alloca i32, align 4
  %n = alloca i32, align 4
  %code.addr = alloca i32*, align 8
...
entry:
  ...
  %maxLen.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 770344727, i32* %canary
  %alphaSize.addr = alloca i32, align 4
  %length.addr = alloca i8*, align 8
  %n = alloca i32, align 4
  %minLen.addr = alloca i32, align 4
...
entry:
  ...
  %code.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 699617023, i32* %canary
  %i = alloca i32, align 4
  %length.addr = alloca i8*, align 8
  %maxLen.addr = alloca i32, align 4
  %alphaSize.addr = alloca i32, align 4
