...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_fopen_output_safely.42, label %ctrl0

func_fopen_output_safely.42:                      ; preds = %rand_bb
  %2 = call %struct._IO_FILE* @fopen_output_safely.42(i8* %name, i8* %mode)
  ret %struct._IO_FILE* %2

func_fopen_output_safely.77:                      ; preds = %ctrl0
  %3 = call %struct._IO_FILE* @fopen_output_safely.77(i8* %name, i8* %mode)
  ret %struct._IO_FILE* %3

func_fopen_output_safely.84:                      ; preds = %ctrl1
  %4 = call %struct._IO_FILE* @fopen_output_safely.84(i8* %name, i8* %mode)
  ret %struct._IO_FILE* %4

func_fopen_output_safely.90:                      ; preds = %ctrl1
  %5 = call %struct._IO_FILE* @fopen_output_safely.90(i8* %name, i8* %mode)
  ret %struct._IO_FILE* %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_fopen_output_safely.77, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_fopen_output_safely.84, label %func_fopen_output_safely.90
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_copyFileName.38, label %func_copyFileName.67

func_copyFileName.38:                             ; preds = %rand_bb
  call void @copyFileName.38(i8* %to, i8* %from)
  ret void

func_copyFileName.67:                             ; preds = %rand_bb
  call void @copyFileName.67(i8* %to, i8* %from)
  ret void
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_addFlagsFromEnvVar.37, label %ctrl0

func_addFlagsFromEnvVar.37:                       ; preds = %rand_bb
  call void @addFlagsFromEnvVar.37(%struct.zzzz** %argList, i8* %varName)
  ret void

func_addFlagsFromEnvVar.60:                       ; preds = %ctrl0
  call void @addFlagsFromEnvVar.60(%struct.zzzz** %argList, i8* %varName)
  ret void

func_addFlagsFromEnvVar.61:                       ; preds = %ctrl1
  call void @addFlagsFromEnvVar.61(%struct.zzzz** %argList, i8* %varName)
  ret void

func_addFlagsFromEnvVar.72:                       ; preds = %ctrl1
  call void @addFlagsFromEnvVar.72(%struct.zzzz** %argList, i8* %varName)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_addFlagsFromEnvVar.60, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_addFlagsFromEnvVar.61, label %func_addFlagsFromEnvVar.72
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_snocString.81, label %ctrl0

func_snocString.81:                               ; preds = %rand_bb
  %2 = call %struct.zzzz* @snocString.81(%struct.zzzz* %root, i8* %name)
  ret %struct.zzzz* %2

func_snocString.91:                               ; preds = %ctrl0
  %3 = call %struct.zzzz* @snocString.91(%struct.zzzz* %root, i8* %name)
  ret %struct.zzzz* %3

func_snocString.95:                               ; preds = %ctrl1
  %4 = call %struct.zzzz* @snocString.95(%struct.zzzz* %root, i8* %name)
  ret %struct.zzzz* %4

func_snocString.96:                               ; preds = %ctrl1
  %5 = call %struct.zzzz* @snocString.96(%struct.zzzz* %root, i8* %name)
  ret %struct.zzzz* %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_snocString.91, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_snocString.95, label %func_snocString.96
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_compress.40, label %ctrl0

func_compress.40:                                 ; preds = %rand_bb
  call void @compress.40(i8* %name)
  ret void
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_compress.74, label %func_compress.79
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_uncompress.8, label %ctrl0

func_uncompress.8:                                ; preds = %rand_bb
  call void @uncompress.8(i8* %name)
  ret void

func_uncompress.15:                               ; preds = %ctrl0
  call void @uncompress.15(i8* %name)
  ret void

func_uncompress.16:                               ; preds = %ctrl1
  call void @uncompress.16(i8* %name)
  ret void

func_uncompress.47:                               ; preds = %ctrl1
  call void @uncompress.47(i8* %name)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_uncompress.15, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_uncompress.16, label %func_uncompress.47
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_testf.4, label %ctrl0

func_testf.4:                                     ; preds = %rand_bb
  call void @testf.4(i8* %name)
  ret void

func_testf.20:                                    ; preds = %ctrl0
  call void @testf.20(i8* %name)
  ret void

func_testf.22:                                    ; preds = %ctrl1
  call void @testf.22(i8* %name)
  ret void

func_testf.41:                                    ; preds = %ctrl1
  call void @testf.41(i8* %name)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_testf.20, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_testf.22, label %func_testf.41
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_cleanUpAndFail.17, label %ctrl0

func_cleanUpAndFail.17:                           ; preds = %rand_bb
  call void @cleanUpAndFail.17(i32 %ec)
  ret void

func_cleanUpAndFail.30:                           ; preds = %ctrl0
  call void @cleanUpAndFail.30(i32 %ec)
  ret void

func_cleanUpAndFail.49:                           ; preds = %ctrl1
  call void @cleanUpAndFail.49(i32 %ec)
  ret void

func_cleanUpAndFail.55:                           ; preds = %ctrl1
  call void @cleanUpAndFail.55(i32 %ec)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_cleanUpAndFail.30, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_cleanUpAndFail.49, label %func_cleanUpAndFail.55
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_myMalloc.21, label %func_myMalloc.26

func_myMalloc.21:                                 ; preds = %rand_bb
  %2 = call i8* @myMalloc.21(i32 %n)
  ret i8* %2

func_myMalloc.26:                                 ; preds = %rand_bb
  %3 = call i8* @myMalloc.26(i32 %n)
  ret i8* %3
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_fileExists.6, label %ctrl0

func_fileExists.6:                                ; preds = %rand_bb
  %2 = call i8 @fileExists.6(i8* %name)
  ret i8 %2

func_fileExists.34:                               ; preds = %ctrl0
  %3 = call i8 @fileExists.34(i8* %name)
  ret i8 %3

func_fileExists.66:                               ; preds = %ctrl1
  %4 = call i8 @fileExists.66(i8* %name)
  ret i8 %4

func_fileExists.75:                               ; preds = %ctrl1
  %5 = call i8 @fileExists.75(i8* %name)
  ret i8 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_fileExists.34, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_fileExists.66, label %func_fileExists.75
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_hasSuffix.63, label %ctrl0

func_hasSuffix.63:                                ; preds = %rand_bb
  %2 = call i8 @hasSuffix.63(i8* %s, i8* %suffix)
  ret i8 %2

func_hasSuffix.83:                                ; preds = %ctrl0
  %3 = call i8 @hasSuffix.83(i8* %s, i8* %suffix)
  ret i8 %3

func_hasSuffix.88:                                ; preds = %ctrl1
  %4 = call i8 @hasSuffix.88(i8* %s, i8* %suffix)
  ret i8 %4

func_hasSuffix.92:                                ; preds = %ctrl1
  %5 = call i8 @hasSuffix.92(i8* %s, i8* %suffix)
  ret i8 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_hasSuffix.83, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_hasSuffix.88, label %func_hasSuffix.92
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_notAStandardFile.5, label %ctrl0

func_notAStandardFile.5:                          ; preds = %rand_bb
  %2 = call i8 @notAStandardFile.5(i8* %name)
  ret i8 %2

func_notAStandardFile.7:                          ; preds = %ctrl0
  %3 = call i8 @notAStandardFile.7(i8* %name)
  ret i8 %3

func_notAStandardFile.23:                         ; preds = %ctrl1
  %4 = call i8 @notAStandardFile.23(i8* %name)
  ret i8 %4

func_notAStandardFile.25:                         ; preds = %ctrl1
  %5 = call i8 @notAStandardFile.25(i8* %name)
  ret i8 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_notAStandardFile.7, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_notAStandardFile.23, label %func_notAStandardFile.25
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_countHardLinks.36, label %ctrl0

func_countHardLinks.36:                           ; preds = %rand_bb
  %2 = call i32 @countHardLinks.36(i8* %name)
  ret i32 %2

func_countHardLinks.87:                           ; preds = %ctrl0
  %3 = call i32 @countHardLinks.87(i8* %name)
  ret i32 %3

func_countHardLinks.89:                           ; preds = %ctrl1
  %4 = call i32 @countHardLinks.89(i8* %name)
  ret i32 %4

func_countHardLinks.93:                           ; preds = %ctrl1
  %5 = call i32 @countHardLinks.93(i8* %name)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_countHardLinks.87, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_countHardLinks.89, label %func_countHardLinks.93
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_saveInputFileMetaInfo.11, label %func_saveInputFileMetaInfo.19

func_saveInputFileMetaInfo.11:                    ; preds = %rand_bb
  call void @saveInputFileMetaInfo.11(i8* %srcName)
  ret void

func_saveInputFileMetaInfo.19:                    ; preds = %rand_bb
  call void @saveInputFileMetaInfo.19(i8* %srcName)
  ret void
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_pad.44, label %func_pad.51

func_pad.44:                                      ; preds = %rand_bb
  call void @pad.44(i8* %s)
  ret void

func_pad.51:                                      ; preds = %rand_bb
  call void @pad.51(i8* %s)
  ret void
}
...
func_compressStream.13:                           ; preds = %ctrl0
  call void @compressStream.13(%struct._IO_FILE* %stream, %struct._IO_FILE* %zStream)
  ret void

func_compressStream.14:                           ; preds = %ctrl1
  call void @compressStream.14(%struct._IO_FILE* %stream, %struct._IO_FILE* %zStream)
  ret void

func_compressStream.18:                           ; preds = %ctrl1
  call void @compressStream.18(%struct._IO_FILE* %stream, %struct._IO_FILE* %zStream)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_compressStream.13, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_compressStream.14, label %func_compressStream.18
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_applySavedMetaInfoToOutputFile.24, label %ctrl0

func_applySavedMetaInfoToOutputFile.24:           ; preds = %rand_bb
  call void @applySavedMetaInfoToOutputFile.24(i8* %dstName)
  ret void

func_applySavedMetaInfoToOutputFile.28:           ; preds = %ctrl0
  call void @applySavedMetaInfoToOutputFile.28(i8* %dstName)
  ret void

func_applySavedMetaInfoToOutputFile.53:           ; preds = %ctrl1
  call void @applySavedMetaInfoToOutputFile.53(i8* %dstName)
  ret void

func_applySavedMetaInfoToOutputFile.80:           ; preds = %ctrl1
  call void @applySavedMetaInfoToOutputFile.80(i8* %dstName)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_applySavedMetaInfoToOutputFile.28, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_applySavedMetaInfoToOutputFile.53, label %func_applySavedMetaInfoToOutputFile.80
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_myfeof.3, label %ctrl0

func_myfeof.3:                                    ; preds = %rand_bb
  %2 = call i8 @myfeof.3(%struct._IO_FILE* %f)
  ret i8 %2

func_myfeof.27:                                   ; preds = %ctrl0
  %3 = call i8 @myfeof.27(%struct._IO_FILE* %f)
  ret i8 %3

func_myfeof.33:                                   ; preds = %ctrl1
  %4 = call i8 @myfeof.33(%struct._IO_FILE* %f)
  ret i8 %4

func_myfeof.45:                                   ; preds = %ctrl1
  %5 = call i8 @myfeof.45(%struct._IO_FILE* %f)
  ret i8 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_myfeof.27, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_myfeof.33, label %func_myfeof.45
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_uInt64_from_UInt32s.29, label %ctrl0

func_uInt64_from_UInt32s.29:                      ; preds = %rand_bb
  call void @uInt64_from_UInt32s.29(%struct.UInt64* %n, i32 %lo32, i32 %hi32)
  ret void

func_uInt64_from_UInt32s.32:                      ; preds = %ctrl0
  call void @uInt64_from_UInt32s.32(%struct.UInt64* %n, i32 %lo32, i32 %hi32)
  ret void

func_uInt64_from_UInt32s.59:                      ; preds = %ctrl1
  call void @uInt64_from_UInt32s.59(%struct.UInt64* %n, i32 %lo32, i32 %hi32)
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_uInt64_from_UInt32s.32, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_uInt64_from_UInt32s.59, label %func_uInt64_from_UInt32s.85
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_uInt64_to_double.9, label %ctrl0

func_uInt64_to_double.9:                          ; preds = %rand_bb
  %2 = call double @uInt64_to_double.9(%struct.UInt64* %n)
  ret double %2

func_uInt64_to_double.10:                         ; preds = %ctrl0
  %3 = call double @uInt64_to_double.10(%struct.UInt64* %n)
  ret double %3

func_uInt64_to_double.39:                         ; preds = %ctrl1
  %4 = call double @uInt64_to_double.39(%struct.UInt64* %n)
  ret double %4

func_uInt64_to_double.58:                         ; preds = %ctrl1
  %5 = call double @uInt64_to_double.58(%struct.UInt64* %n)
  ret double %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_uInt64_to_double.10, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_uInt64_to_double.39, label %func_uInt64_to_double.58
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_uInt64_toAscii.2, label %ctrl0

func_uInt64_toAscii.2:                            ; preds = %rand_bb
  call void @uInt64_toAscii.2(i8* %outbuf, %struct.UInt64* %n)
  ret void

func_uInt64_toAscii.46:                           ; preds = %ctrl0
  call void @uInt64_toAscii.46(i8* %outbuf, %struct.UInt64* %n)
  ret void

func_uInt64_toAscii.86:                           ; preds = %ctrl1
  call void @uInt64_toAscii.86(i8* %outbuf, %struct.UInt64* %n)
  ret void

func_uInt64_toAscii.94:                           ; preds = %ctrl1
  call void @uInt64_toAscii.94(i8* %outbuf, %struct.UInt64* %n)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_uInt64_toAscii.46, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_uInt64_toAscii.86, label %func_uInt64_toAscii.94
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_uInt64_qrm10.57, label %ctrl0

func_uInt64_qrm10.57:                             ; preds = %rand_bb
  %2 = call i32 @uInt64_qrm10.57(%struct.UInt64* %n)
  ret i32 %2

func_uInt64_qrm10.70:                             ; preds = %ctrl0
  %3 = call i32 @uInt64_qrm10.70(%struct.UInt64* %n)
  ret i32 %3

func_uInt64_qrm10.73:                             ; preds = %ctrl1
  %4 = call i32 @uInt64_qrm10.73(%struct.UInt64* %n)
  ret i32 %4

func_uInt64_qrm10.76:                             ; preds = %ctrl1
  %5 = call i32 @uInt64_qrm10.76(%struct.UInt64* %n)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_uInt64_qrm10.70, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_uInt64_qrm10.73, label %func_uInt64_qrm10.76
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_uInt64_isZero.50, label %ctrl0

func_uInt64_isZero.50:                            ; preds = %rand_bb
  %2 = call i8 @uInt64_isZero.50(%struct.UInt64* %n)
  ret i8 %2

func_uInt64_isZero.64:                            ; preds = %ctrl0
  %3 = call i8 @uInt64_isZero.64(%struct.UInt64* %n)
  ret i8 %3

func_uInt64_isZero.68:                            ; preds = %ctrl1
  %4 = call i8 @uInt64_isZero.68(%struct.UInt64* %n)
  ret i8 %4
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_uInt64_isZero.64, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_uInt64_isZero.68, label %func_uInt64_isZero.78
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_mapSuffix.35, label %ctrl0

func_mapSuffix.35:                                ; preds = %rand_bb
  %2 = call i8 @mapSuffix.35(i8* %name, i8* %oldSuffix, i8* %newSuffix)
  ret i8 %2

func_mapSuffix.43:                                ; preds = %ctrl0
  %3 = call i8 @mapSuffix.43(i8* %name, i8* %oldSuffix, i8* %newSuffix)
  ret i8 %3

func_mapSuffix.69:                                ; preds = %ctrl1
  %4 = call i8 @mapSuffix.69(i8* %name, i8* %oldSuffix, i8* %newSuffix)
  ret i8 %4

func_mapSuffix.82:                                ; preds = %ctrl1
  %5 = call i8 @mapSuffix.82(i8* %name, i8* %oldSuffix, i8* %newSuffix)
  ret i8 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_mapSuffix.43, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_mapSuffix.69, label %func_mapSuffix.82
}
...
func_uncompressStream.31:                         ; preds = %ctrl0
  %3 = call i8 @uncompressStream.31(%struct._IO_FILE* %zStream, %struct._IO_FILE* %stream)
  ret i8 %3

func_uncompressStream.48:                         ; preds = %ctrl1
  %4 = call i8 @uncompressStream.48(%struct._IO_FILE* %zStream, %struct._IO_FILE* %stream)
  ret i8 %4

func_uncompressStream.52:                         ; preds = %ctrl1
  %5 = call i8 @uncompressStream.52(%struct._IO_FILE* %zStream, %struct._IO_FILE* %stream)
  ret i8 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_uncompressStream.31, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_uncompressStream.48, label %func_uncompressStream.52
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_testStream.54, label %ctrl0

func_testStream.54:                               ; preds = %rand_bb
  %2 = call i8 @testStream.54(%struct._IO_FILE* %zStream)
  ret i8 %2

func_testStream.56:                               ; preds = %ctrl0
  %3 = call i8 @testStream.56(%struct._IO_FILE* %zStream)
  ret i8 %3

func_testStream.62:                               ; preds = %ctrl1
  %4 = call i8 @testStream.62(%struct._IO_FILE* %zStream)
  ret i8 %4

func_testStream.71:                               ; preds = %ctrl1
  %5 = call i8 @testStream.71(%struct._IO_FILE* %zStream)
  ret i8 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_testStream.56, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_testStream.62, label %func_testStream.71
}
...
entry:
  ...
  %canary = alloca i32
  store i32 1493035468, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @uInt64_toAscii.2(i8* %outbuf, %struct.UInt64* %n) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 1087880884, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @myfeof.3(%struct._IO_FILE* %f) #0 {
entry:
  %canary = alloca i32
  store i32 392796708, i32* %canary
  %retval = alloca i8, align 1
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @testf.4(i8* %name) #0 {
entry:
  %inStr = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 2145555397, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @notAStandardFile.5(i8* %name) #0 {
entry:
  %statBuf = alloca %struct.stat, align 8
  %canary = alloca i32
  store i32 192278469, i32* %canary
  %name.addr = alloca i8*, align 8
  %i = alloca i32, align 4
  %retval = alloca i8, align 1
  store i8* %name, i8** %name.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @fileExists.6(i8* %name) #0 {
entry:
  %tmp = alloca %struct._IO_FILE*, align 8
  %exists = alloca i8, align 1
  %canary = alloca i32
  store i32 154838827, i32* %canary
  %name.addr = alloca i8*, align 8
  store i8* %name, i8** %name.addr, align 8
  %0 = load i8*, i8** %name.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @notAStandardFile.7(i8* %name) #0 {
entry:
  %name.addr = alloca i8*, align 8
  %i = alloca i32, align 4
  %statBuf = alloca %struct.stat, align 8
  %canary = alloca i32
  store i32 251131680, i32* %canary
  %retval = alloca i8, align 1
  store i8* %name, i8** %name.addr, align 8
  %0 = load i8*, i8** %name.addr, align 8
  %call = call i32 @lstat(i8* %0, %struct.stat* %statBuf) #8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @uncompress.8(i8* %name) #0 {
entry:
  ...
  %name.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1170795345, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal double @uInt64_to_double.9(%struct.UInt64* %n) #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 2126079318, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal double @uInt64_to_double.10(%struct.UInt64* %n) #0 {
entry:
  %i = alloca i32, align 4
  %n.addr = alloca %struct.UInt64*, align 8
  %canary = alloca i32
  store i32 311992530, i32* %canary
  %sum = alloca double, align 8
  %base = alloca double, align 8
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
  store double 1.000000e+00, double* %base, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @saveInputFileMetaInfo.11(i8* %srcName) #0 {
entry:
  %retVal = alloca i32, align 4
  %canary = alloca i32
  store i32 1580505942, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @compressStream.13(%struct._IO_FILE* %stream, %struct._IO_FILE* %zStream) #0 {
entry:
  %bzf = alloca i8*, align 8
  %nbytes_out_hi32 = alloca i32, align 4
  %bzerr = alloca i32, align 4
  ...
  %ibuf = alloca [5000 x i8], align 16
  %canary = alloca i32
  store i32 1529632018, i32* %canary
  %nIbuf = alloca i32, align 4
  %buf_nout = alloca [32 x i8], align 16
  %nbytes_out = alloca %struct.UInt64, align 1
  %zStream.addr = alloca %struct._IO_FILE*, align 8
...
entry:
  %ibuf = alloca [5000 x i8], align 16
  %canary = alloca i32
  store i32 1925705029, i32* %canary
  %nbytes_out_hi32 = alloca i32, align 4
  %nbytes_out_lo32 = alloca i32, align 4
  %bzerr = alloca i32, align 4
  %nbytes_out_d = alloca double, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @uncompress.15(i8* %name) #0 {
entry:
  %retVal = alloca i32, align 4
  %outStr = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 520412263, i32* %canary
  %statBuf = alloca %struct.stat, align 8
  %magicNumberOK = alloca i8, align 1
  %n = alloca i32, align 4
  %retVal168 = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @uncompress.16(i8* %name) #0 {
entry:
  %n = alloca i32, align 4
  %retVal168 = alloca i32, align 4
  %retVal = alloca i32, align 4
  ...
  %name.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1046014159, i32* %canary
  %outStr = alloca %struct._IO_FILE*, align 8
  %magicNumberOK = alloca i8, align 1
  %cantGuess = alloca i8, align 1
  %inStr = alloca %struct._IO_FILE*, align 8
...
; Function Attrs: noinline noreturn nounwind optnone uwtable
define internal void @cleanUpAndFail.17(i32 %ec) #5 {
entry:
  %retVal = alloca i32, align 4
  %ec.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1607293036, i32* %canary
  %statBuf = alloca %struct.stat, align 8
...
entry:
  ...
  %nbytes_in_d = alloca double, align 8
  %canary = alloca i32
  store i32 1861974527, i32* %canary
  %nbytes_out_hi32 = alloca i32, align 4
  %bzf = alloca i8*, align 8
  %stream.addr = alloca %struct._IO_FILE*, align 8
  %bzerr_dummy = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @saveInputFileMetaInfo.19(i8* %srcName) #0 {
entry:
  %canary = alloca i32
  store i32 1846207817, i32* %canary
  %srcName.addr = alloca i8*, align 8
  %retVal = alloca i32, align 4
  store i8* %srcName, i8** %srcName.addr, align 8
  %0 = load i8*, i8** %srcName.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @testf.20(i8* %name) #0 {
entry:
  %name.addr = alloca i8*, align 8
  %inStr = alloca %struct._IO_FILE*, align 8
  %statBuf = alloca %struct.stat, align 8
  %canary = alloca i32
  store i32 260980635, i32* %canary
  %allOK = alloca i8, align 1
  store i8* %name, i8** %name.addr, align 8
  store i8 0, i8* @deleteOutputOnInterrupt, align 1
  %0 = load i8*, i8** %name.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i8* @myMalloc.21(i32 %n) #0 {
entry:
  %n.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1444717545, i32* %canary
  %p = alloca i8*, align 8
  store i32 %n, i32* %n.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @testf.22(i8* %name) #0 {
entry:
  %canary = alloca i32
  store i32 239059610, i32* %canary
  %allOK = alloca i8, align 1
  %name.addr = alloca i8*, align 8
  %inStr = alloca %struct._IO_FILE*, align 8
  %statBuf = alloca %struct.stat, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @notAStandardFile.23(i8* %name) #0 {
entry:
  %retval = alloca i8, align 1
  %name.addr = alloca i8*, align 8
  %statBuf = alloca %struct.stat, align 8
  %canary = alloca i32
  store i32 196638581, i32* %canary
  %i = alloca i32, align 4
  store i8* %name, i8** %name.addr, align 8
  %0 = load i8*, i8** %name.addr, align 8
  %call = call i32 @lstat(i8* %0, %struct.stat* %statBuf) #8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @applySavedMetaInfoToOutputFile.24(i8* %dstName) #0 {
entry:
  %canary = alloca i32
  store i32 1597215642, i32* %canary
...
entry:
  ...
  %retval = alloca i8, align 1
  %canary = alloca i32
  store i32 1700626209, i32* %canary
  %statBuf = alloca %struct.stat, align 8
  store i8* %name, i8** %name.addr, align 8
  %0 = load i8*, i8** %name.addr, align 8
  %call = call i32 @lstat(i8* %0, %struct.stat* %statBuf) #8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i8* @myMalloc.26(i32 %n) #0 {
entry:
  %canary = alloca i32
  store i32 766182965, i32* %canary
  %p = alloca i8*, align 8
  %n.addr = alloca i32, align 4
  store i32 %n, i32* %n.addr, align 4
  %0 = load i32, i32* %n.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @myfeof.27(%struct._IO_FILE* %f) #0 {
entry:
  %f.addr = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 155762866, i32* %canary
  %retval = alloca i8, align 1
  %c = alloca i32, align 4
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** %f.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @applySavedMetaInfoToOutputFile.28(i8* %dstName) #0 {
entry:
  %dstName.addr = alloca i8*, align 8
  %uTimBuf = alloca %struct.utimbuf, align 8
  %canary = alloca i32
  store i32 2145933924, i32* %canary
  %retVal = alloca i32, align 4
  store i8* %dstName, i8** %dstName.addr, align 8
  %0 = load i64, i64* getelementptr inbounds (%struct.stat, %struct.stat* @fileMetaInfo, i32 0, i32 11, i32 0), align 8
  %actime = getelementptr inbounds %struct.utimbuf, %struct.utimbuf* %uTimBuf, i32 0, i32 0
...
entry:
  ...
  %canary = alloca i32
  store i32 136389483, i32* %canary
...
; Function Attrs: noinline noreturn nounwind optnone uwtable
define internal void @cleanUpAndFail.30(i32 %ec) #5 {
entry:
  %ec.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1792326467, i32* %canary
  %retVal = alloca i32, align 4
  %statBuf = alloca %struct.stat, align 8
  store i32 %ec, i32* %ec.addr, align 4
  %0 = load i32, i32* @srcMode, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @uncompressStream.31(%struct._IO_FILE* %zStream, %struct._IO_FILE* %stream) #0 {
entry:
  %unused = alloca [5000 x i8], align 16
  %nread = alloca i32, align 4
  %retval = alloca i8, align 1
  ...
  %unusedTmpV = alloca i8*, align 8
  %canary = alloca i32
  store i32 2136047976, i32* %canary
  %streamNo = alloca i32, align 4
  %stream.addr = alloca %struct._IO_FILE*, align 8
  %i = alloca i32, align 4
  %unusedTmp = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @uInt64_from_UInt32s.32(%struct.UInt64* %n, i32 %lo32, i32 %hi32) #0 {
entry:
  %n.addr = alloca %struct.UInt64*, align 8
  %lo32.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1694224120, i32* %canary
  %hi32.addr = alloca i32, align 4
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
  store i32 %lo32, i32* %lo32.addr, align 4
  store i32 %hi32, i32* %hi32.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @myfeof.33(%struct._IO_FILE* %f) #0 {
entry:
  %canary = alloca i32
  store i32 934827076, i32* %canary
  %c = alloca i32, align 4
  %f.addr = alloca %struct._IO_FILE*, align 8
  %retval = alloca i8, align 1
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @fileExists.34(i8* %name) #0 {
entry:
  %tmp = alloca %struct._IO_FILE*, align 8
  %name.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1214902470, i32* %canary
  %exists = alloca i8, align 1
  store i8* %name, i8** %name.addr, align 8
  %0 = load i8*, i8** %name.addr, align 8
  %call = call %struct._IO_FILE* @fopen(i8* %0, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.66, i64 0, i64 0))
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @mapSuffix.35(i8* %name, i8* %oldSuffix, i8* %newSuffix) #0 {
entry:
  %retval = alloca i8, align 1
  %newSuffix.addr = alloca i8*, align 8
  %name.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 764265200, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @countHardLinks.36(i8* %name) #0 {
entry:
  %canary = alloca i32
  store i32 1955070607, i32* %canary
  %name.addr = alloca i8*, align 8
  %statBuf = alloca %struct.stat, align 8
  %i = alloca i32, align 4
  %retval = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @addFlagsFromEnvVar.37(%struct.zzzz** %argList, i8* %varName) #0 {
entry:
  %i = alloca i32, align 4
  %p = alloca i8*, align 8
  %canary = alloca i32
  store i32 1077884840, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 910646794, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal double @uInt64_to_double.39(%struct.UInt64* %n) #0 {
entry:
  %base = alloca double, align 8
  %n.addr = alloca %struct.UInt64*, align 8
  %canary = alloca i32
  store i32 707709508, i32* %canary
  %sum = alloca double, align 8
  %i = alloca i32, align 4
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
  store double 1.000000e+00, double* %base, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @compress.40(i8* %name) #0 {
entry:
  %i = alloca i32, align 4
  %n = alloca i32, align 4
  %outStr = alloca %struct._IO_FILE*, align 8
  %retVal = alloca i32, align 4
  %canary = alloca i32
  store i32 2076168170, i32* %canary
  %inStr = alloca %struct._IO_FILE*, align 8
  %name.addr = alloca i8*, align 8
  %statBuf = alloca %struct.stat, align 8
  store i8* %name, i8** %name.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @testf.41(i8* %name) #0 {
entry:
  %statBuf = alloca %struct.stat, align 8
  %canary = alloca i32
  store i32 263224742, i32* %canary
  %name.addr = alloca i8*, align 8
  %inStr = alloca %struct._IO_FILE*, align 8
  %allOK = alloca i8, align 1
  store i8* %name, i8** %name.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct._IO_FILE* @fopen_output_safely.42(i8* %name, i8* %mode) #0 {
entry:
  %name.addr = alloca i8*, align 8
  ...
  %canary = alloca i32
  store i32 1106635899, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @mapSuffix.43(i8* %name, i8* %oldSuffix, i8* %newSuffix) #0 {
entry:
  %newSuffix.addr = alloca i8*, align 8
  %retval = alloca i8, align 1
  %name.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1990617583, i32* %canary
  %oldSuffix.addr = alloca i8*, align 8
  store i8* %name, i8** %name.addr, align 8
  store i8* %oldSuffix, i8** %oldSuffix.addr, align 8
  store i8* %newSuffix, i8** %newSuffix.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @pad.44(i8* %s) #0 {
entry:
  %s.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1354604797, i32* %canary
  %i = alloca i32, align 4
  store i8* %s, i8** %s.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @myfeof.45(%struct._IO_FILE* %f) #0 {
entry:
  %c = alloca i32, align 4
  %retval = alloca i8, align 1
  %canary = alloca i32
  store i32 1215631749, i32* %canary
  %f.addr = alloca %struct._IO_FILE*, align 8
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** %f.addr, align 8
  %call = call i32 @fgetc(%struct._IO_FILE* %0)
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @uInt64_toAscii.46(i8* %outbuf, %struct.UInt64* %n) #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1125857616, i32* %canary
  %q = alloca i32, align 4
  %n.addr = alloca %struct.UInt64*, align 8
  %buf = alloca [32 x i8], align 16
  %nBuf = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @uncompress.47(i8* %name) #0 {
entry:
  %n = alloca i32, align 4
  %cantGuess = alloca i8, align 1
  %name.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 600215527, i32* %canary
  %retVal168 = alloca i32, align 4
  %retVal = alloca i32, align 4
  %i = alloca i32, align 4
  %inStr = alloca %struct._IO_FILE*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @uncompressStream.48(%struct._IO_FILE* %zStream, %struct._IO_FILE* %stream) #0 {
entry:
  %bzerr = alloca i32, align 4
  %nUnused = alloca i32, align 4
  %ret = alloca i32, align 4
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 156966125, i32* %canary
  %streamNo = alloca i32, align 4
  %unusedTmp = alloca i8*, align 8
  %stream.addr = alloca %struct._IO_FILE*, align 8
  %retval = alloca i8, align 1
...
; Function Attrs: noinline noreturn nounwind optnone uwtable
define internal void @cleanUpAndFail.49(i32 %ec) #5 {
entry:
  %canary = alloca i32
  store i32 2142795501, i32* %canary
  %retVal = alloca i32, align 4
  %statBuf = alloca %struct.stat, align 8
  %ec.addr = alloca i32, align 4
  store i32 %ec, i32* %ec.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @uInt64_isZero.50(%struct.UInt64* %n) #0 {
entry:
  %canary = alloca i32
  store i32 2067579542, i32* %canary
  %i = alloca i32, align 4
  %n.addr = alloca %struct.UInt64*, align 8
  %retval = alloca i8, align 1
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @pad.51(i8* %s) #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 777480316, i32* %canary
  %s.addr = alloca i8*, align 8
  store i8* %s, i8** %s.addr, align 8
  %0 = load i8*, i8** %s.addr, align 8
  %call = call i64 @strlen(i8* %0) #9
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @uncompressStream.52(%struct._IO_FILE* %zStream, %struct._IO_FILE* %stream) #0 {
entry:
  %canary = alloca i32
  store i32 1896001914, i32* %canary
  %retval = alloca i8, align 1
  %bzerr = alloca i32, align 4
  %nread = alloca i32, align 4
  %obuf = alloca [5000 x i8], align 16
...
entry:
  %canary = alloca i32
  store i32 353869144, i32* %canary
  %uTimBuf = alloca %struct.utimbuf, align 8
  %retVal = alloca i32, align 4
  %dstName.addr = alloca i8*, align 8
  store i8* %dstName, i8** %dstName.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @testStream.54(%struct._IO_FILE* %zStream) #0 {
entry:
  %streamNo = alloca i32, align 4
  %canary = alloca i32
  store i32 614658563, i32* %canary
  %bzerr_dummy = alloca i32, align 4
  %ret = alloca i32, align 4
  %nread = alloca i32, align 4
  %zStream.addr = alloca %struct._IO_FILE*, align 8
...
entry:
  %statBuf = alloca %struct.stat, align 8
  %canary = alloca i32
  store i32 140934494, i32* %canary
  %ec.addr = alloca i32, align 4
  %retVal = alloca i32, align 4
  store i32 %ec, i32* %ec.addr, align 4
  %0 = load i32, i32* @srcMode, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @testStream.56(%struct._IO_FILE* %zStream) #0 {
entry:
  %unusedTmp = alloca i8*, align 8
  %unusedTmpV = alloca i8*, align 8
  %nUnused = alloca i32, align 4
  ...
  %zStream.addr = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 943004917, i32* %canary
  %i = alloca i32, align 4
  %retval = alloca i8, align 1
  %unused = alloca [5000 x i8], align 16
  %ret = alloca i32, align 4
...
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 596249224, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 241547103, i32* %canary
  %sum = alloca double, align 8
  %i = alloca i32, align 4
  %n.addr = alloca %struct.UInt64*, align 8
  %base = alloca double, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @uInt64_from_UInt32s.59(%struct.UInt64* %n, i32 %lo32, i32 %hi32) #0 {
entry:
  %n.addr = alloca %struct.UInt64*, align 8
  %canary = alloca i32
  store i32 1013470449, i32* %canary
  %hi32.addr = alloca i32, align 4
  %lo32.addr = alloca i32, align 4
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
  store i32 %lo32, i32* %lo32.addr, align 4
...
entry:
  ...
  %k = alloca i32, align 4
  %canary = alloca i32
  store i32 1064221259, i32* %canary
  %envbase = alloca i8*, align 8
  %i = alloca i32, align 4
  %argList.addr = alloca %struct.zzzz**, align 8
  store %struct.zzzz** %argList, %struct.zzzz*** %argList.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @addFlagsFromEnvVar.61(%struct.zzzz** %argList, i8* %varName) #0 {
entry:
  %envbase = alloca i8*, align 8
  %j = alloca i32, align 4
  %k = alloca i32, align 4
  %argList.addr = alloca %struct.zzzz**, align 8
  %canary = alloca i32
  store i32 1714531029, i32* %canary
  %varName.addr = alloca i8*, align 8
  %i = alloca i32, align 4
  %p = alloca i8*, align 8
  store %struct.zzzz** %argList, %struct.zzzz*** %argList.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @testStream.62(%struct._IO_FILE* %zStream) #0 {
entry:
  %nread = alloca i32, align 4
  %zStream.addr = alloca %struct._IO_FILE*, align 8
  %obuf = alloca [5000 x i8], align 16
  %canary = alloca i32
  store i32 468659751, i32* %canary
  %retval = alloca i8, align 1
  %unusedTmpV = alloca i8*, align 8
  %i = alloca i32, align 4
  %streamNo = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1525177942, i32* %canary
  %retval = alloca i8, align 1
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @uInt64_isZero.64(%struct.UInt64* %n) #0 {
entry:
  %retval = alloca i8, align 1
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1578696752, i32* %canary
  %n.addr = alloca %struct.UInt64*, align 8
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
  store i32 0, i32* %i, align 4
  br label %for.cond
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1066539606, i32* %canary
  %n = alloca i32, align 4
  %outStr = alloca %struct._IO_FILE*, align 8
  store i8* %name, i8** %name.addr, align 8
  store i8 0, i8* @deleteOutputOnInterrupt, align 1
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @fileExists.66(i8* %name) #0 {
entry:
  %canary = alloca i32
  store i32 1528529448, i32* %canary
  %name.addr = alloca i8*, align 8
  %exists = alloca i8, align 1
  %tmp = alloca %struct._IO_FILE*, align 8
  store i8* %name, i8** %name.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @copyFileName.67(i8* %to, i8* %from) #0 {
entry:
  %canary = alloca i32
  store i32 1002704827, i32* %canary
  %to.addr = alloca i8*, align 8
  %from.addr = alloca i8*, align 8
  store i8* %to, i8** %to.addr, align 8
  store i8* %from, i8** %from.addr, align 8
...
entry:
  ...
  %retval = alloca i8, align 1
  %canary = alloca i32
  store i32 1374877773, i32* %canary
  %i = alloca i32, align 4
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
  store i32 0, i32* %i, align 4
  br label %for.cond
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @mapSuffix.69(i8* %name, i8* %oldSuffix, i8* %newSuffix) #0 {
entry:
  %canary = alloca i32
  store i32 1247954451, i32* %canary
  %name.addr = alloca i8*, align 8
  %retval = alloca i8, align 1
  %oldSuffix.addr = alloca i8*, align 8
  %newSuffix.addr = alloca i8*, align 8
...
entry:
  ...
  %rem = alloca i32, align 4
  %canary = alloca i32
  store i32 964537412, i32* %canary
  %tmp = alloca i32, align 4
  %i = alloca i32, align 4
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
  store i32 0, i32* %rem, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @testStream.71(%struct._IO_FILE* %zStream) #0 {
entry:
  %streamNo = alloca i32, align 4
  %nUnused = alloca i32, align 4
  %i = alloca i32, align 4
  ...
  %obuf = alloca [5000 x i8], align 16
  %canary = alloca i32
  store i32 895774087, i32* %canary
  %nread = alloca i32, align 4
  %bzerr_dummy = alloca i32, align 4
  %bzerr = alloca i32, align 4
  %unused = alloca [5000 x i8], align 16
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @addFlagsFromEnvVar.72(%struct.zzzz** %argList, i8* %varName) #0 {
entry:
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 2013196717, i32* %canary
  %k = alloca i32, align 4
  %argList.addr = alloca %struct.zzzz**, align 8
  %p = alloca i8*, align 8
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @uInt64_qrm10.73(%struct.UInt64* %n) #0 {
entry:
  %i = alloca i32, align 4
  %rem = alloca i32, align 4
  %tmp = alloca i32, align 4
  %canary = alloca i32
  store i32 277334583, i32* %canary
  %n.addr = alloca %struct.UInt64*, align 8
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
  store i32 0, i32* %rem, align 4
  store i32 7, i32* %i, align 4
...
entry:
  ...
  %retVal = alloca i32, align 4
  %canary = alloca i32
  store i32 1948793457, i32* %canary
  %name.addr = alloca i8*, align 8
  %statBuf = alloca %struct.stat, align 8
  %n = alloca i32, align 4
  store i8* %name, i8** %name.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @fileExists.75(i8* %name) #0 {
entry:
  %exists = alloca i8, align 1
  %tmp = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 1682013956, i32* %canary
  %name.addr = alloca i8*, align 8
  store i8* %name, i8** %name.addr, align 8
  %0 = load i8*, i8** %name.addr, align 8
  %call = call %struct._IO_FILE* @fopen(i8* %0, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.66, i64 0, i64 0))
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @uInt64_qrm10.76(%struct.UInt64* %n) #0 {
entry:
  %n.addr = alloca %struct.UInt64*, align 8
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 452056965, i32* %canary
  %rem = alloca i32, align 4
  %tmp = alloca i32, align 4
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
  store i32 0, i32* %rem, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct._IO_FILE* @fopen_output_safely.77(i8* %name, i8* %mode) #0 {
entry:
  %fp = alloca %struct._IO_FILE*, align 8
  %retval = alloca %struct._IO_FILE*, align 8
  %mode.addr = alloca i8*, align 8
  %fh = alloca i32, align 4
  %canary = alloca i32
  store i32 587727064, i32* %canary
  %name.addr = alloca i8*, align 8
  store i8* %name, i8** %name.addr, align 8
  store i8* %mode, i8** %mode.addr, align 8
  %0 = load i8*, i8** %name.addr, align 8
...
entry:
  ...
  %retval = alloca i8, align 1
  %canary = alloca i32
  store i32 1950283253, i32* %canary
  %n.addr = alloca %struct.UInt64*, align 8
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
  store i32 0, i32* %i, align 4
  br label %for.cond
...
entry:
  %canary = alloca i32
  store i32 2055547590, i32* %canary
  %i = alloca i32, align 4
  %n = alloca i32, align 4
  %retVal = alloca i32, align 4
  %inStr = alloca %struct._IO_FILE*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @applySavedMetaInfoToOutputFile.80(i8* %dstName) #0 {
entry:
  %canary = alloca i32
  store i32 3202579, i32* %canary
  %retVal = alloca i32, align 4
  %dstName.addr = alloca i8*, align 8
  %uTimBuf = alloca %struct.utimbuf, align 8
  store i8* %dstName, i8** %dstName.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal %struct.zzzz* @snocString.81(%struct.zzzz* %root, i8* %name) #0 {
entry:
  %tmp6 = alloca %struct.zzzz*, align 8
  %retval = alloca %struct.zzzz*, align 8
  %tmp = alloca %struct.zzzz*, align 8
  %canary = alloca i32
  store i32 1966711942, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @mapSuffix.82(i8* %name, i8* %oldSuffix, i8* %newSuffix) #0 {
entry:
  %newSuffix.addr = alloca i8*, align 8
  %name.addr = alloca i8*, align 8
  %oldSuffix.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1613155070, i32* %canary
  %retval = alloca i8, align 1
  store i8* %name, i8** %name.addr, align 8
  store i8* %oldSuffix, i8** %oldSuffix.addr, align 8
  store i8* %newSuffix, i8** %newSuffix.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @hasSuffix.83(i8* %s, i8* %suffix) #0 {
entry:
  %ns = alloca i32, align 4
  %s.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1241236545, i32* %canary
  %retval = alloca i8, align 1
  %suffix.addr = alloca i8*, align 8
  %nx = alloca i32, align 4
  store i8* %s, i8** %s.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct._IO_FILE* @fopen_output_safely.84(i8* %name, i8* %mode) #0 {
entry:
  %name.addr = alloca i8*, align 8
  %mode.addr = alloca i8*, align 8
  %retval = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 314924041, i32* %canary
  %fp = alloca %struct._IO_FILE*, align 8
  %fh = alloca i32, align 4
  store i8* %name, i8** %name.addr, align 8
  store i8* %mode, i8** %mode.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 2078088830, i32* %canary
  %lo32.addr = alloca i32, align 4
  %hi32.addr = alloca i32, align 4
  %n.addr = alloca %struct.UInt64*, align 8
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @uInt64_toAscii.86(i8* %outbuf, %struct.UInt64* %n) #0 {
entry:
  %nBuf = alloca i32, align 4
  %canary = alloca i32
  store i32 1850787620, i32* %canary
  %q = alloca i32, align 4
  %n_copy = alloca %struct.UInt64, align 1
  %n.addr = alloca %struct.UInt64*, align 8
  %outbuf.addr = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @countHardLinks.87(i8* %name) #0 {
entry:
  %name.addr = alloca i8*, align 8
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 20965576, i32* %canary
  %i = alloca i32, align 4
  %statBuf = alloca %struct.stat, align 8
  store i8* %name, i8** %name.addr, align 8
  %0 = load i8*, i8** %name.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @hasSuffix.88(i8* %s, i8* %suffix) #0 {
entry:
  %suffix.addr = alloca i8*, align 8
  %ns = alloca i32, align 4
  %retval = alloca i8, align 1
  %s.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1619873481, i32* %canary
  %nx = alloca i32, align 4
  store i8* %s, i8** %s.addr, align 8
  store i8* %suffix, i8** %suffix.addr, align 8
  %0 = load i8*, i8** %s.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @countHardLinks.89(i8* %name) #0 {
entry:
  %i = alloca i32, align 4
  %statBuf = alloca %struct.stat, align 8
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 121908195, i32* %canary
  %name.addr = alloca i8*, align 8
  store i8* %name, i8** %name.addr, align 8
  %0 = load i8*, i8** %name.addr, align 8
  %call = call i32 @lstat(i8* %0, %struct.stat* %statBuf) #8
...
entry:
  ...
  %name.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1923423479, i32* %canary
  %fp = alloca %struct._IO_FILE*, align 8
  %fh = alloca i32, align 4
  %retval = alloca %struct._IO_FILE*, align 8
  store i8* %name, i8** %name.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal %struct.zzzz* @snocString.91(%struct.zzzz* %root, i8* %name) #0 {
entry:
  %canary = alloca i32
  store i32 1218251388, i32* %canary
  %root.addr = alloca %struct.zzzz*, align 8
  %retval = alloca %struct.zzzz*, align 8
  %tmp = alloca %struct.zzzz*, align 8
  %name.addr = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @hasSuffix.92(i8* %s, i8* %suffix) #0 {
entry:
  %canary = alloca i32
  store i32 1294664985, i32* %canary
  %suffix.addr = alloca i8*, align 8
  %nx = alloca i32, align 4
  %s.addr = alloca i8*, align 8
  %ns = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @countHardLinks.93(i8* %name) #0 {
entry:
  %statBuf = alloca %struct.stat, align 8
  %canary = alloca i32
  store i32 1619060002, i32* %canary
  %retval = alloca i32, align 4
  %name.addr = alloca i8*, align 8
  %i = alloca i32, align 4
  store i8* %name, i8** %name.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @uInt64_toAscii.94(i8* %outbuf, %struct.UInt64* %n) #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1999897315, i32* %canary
  %outbuf.addr = alloca i8*, align 8
  %nBuf = alloca i32, align 4
  %n_copy = alloca %struct.UInt64, align 1
  %q = alloca i32, align 4
...
entry:
  ...
  %tmp6 = alloca %struct.zzzz*, align 8
  %canary = alloca i32
  store i32 1264451179, i32* %canary
  %retval = alloca %struct.zzzz*, align 8
  %tmp = alloca %struct.zzzz*, align 8
  %name.addr = alloca i8*, align 8
  store %struct.zzzz* %root, %struct.zzzz** %root.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal %struct.zzzz* @snocString.96(%struct.zzzz* %root, i8* %name) #0 {
entry:
  %canary = alloca i32
  store i32 746235225, i32* %canary
  %retval = alloca %struct.zzzz*, align 8
  %tmp = alloca %struct.zzzz*, align 8
  %tmp6 = alloca %struct.zzzz*, align 8
  %root.addr = alloca %struct.zzzz*, align 8
