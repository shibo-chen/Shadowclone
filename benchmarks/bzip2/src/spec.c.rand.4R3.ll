...
func_ran.19:                                      ; preds = %ctrl0
  %3 = call double @ran.19()
  ret double %3

func_ran.27:                                      ; preds = %ctrl1
  %4 = call double @ran.27()
  ret double %4

func_ran.29:                                      ; preds = %ctrl1
  %5 = call double @ran.29()
  ret double %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_ran.19, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_ran.27, label %func_ran.29
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_spec_init.2, label %ctrl0

func_spec_init.2:                                 ; preds = %rand_bb
  %2 = call i32 @spec_init.2()
  ret i32 %2

func_spec_init.16:                                ; preds = %ctrl0
  %3 = call i32 @spec_init.16()
  ret i32 %3

func_spec_init.30:                                ; preds = %ctrl1
  %4 = call i32 @spec_init.30()
  ret i32 %4

func_spec_init.31:                                ; preds = %ctrl1
  %5 = call i32 @spec_init.31()
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_spec_init.16, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_spec_init.30, label %func_spec_init.31
}
...
func_spec_random_load.8:                          ; preds = %ctrl0
  %3 = call i32 @spec_random_load.8(i32 %fd)
  ret i32 %3

func_spec_random_load.25:                         ; preds = %ctrl1
  %4 = call i32 @spec_random_load.25(i32 %fd)
  ret i32 %4

func_spec_random_load.36:                         ; preds = %ctrl1
  %5 = call i32 @spec_random_load.36(i32 %fd)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_spec_random_load.8, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_spec_random_load.25, label %func_spec_random_load.36
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_spec_load.20, label %ctrl0

func_spec_load.20:                                ; preds = %rand_bb
  %2 = call i32 @spec_load.20(i32 %num, i8* %filename, i32 %size)
  ret i32 %2

func_spec_load.21:                                ; preds = %ctrl0
  %3 = call i32 @spec_load.21(i32 %num, i8* %filename, i32 %size)
  ret i32 %3

func_spec_load.33:                                ; preds = %ctrl1
  %4 = call i32 @spec_load.33(i32 %num, i8* %filename, i32 %size)
  ret i32 %4

func_spec_load.38:                                ; preds = %ctrl1
  %5 = call i32 @spec_load.38(i32 %num, i8* %filename, i32 %size)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_spec_load.21, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_spec_load.33, label %func_spec_load.38
}
...
func_spec_read.35:                                ; preds = %ctrl1
  %4 = call i32 @spec_read.35(i32 %fd, i8* %buf, i32 %size)
  ret i32 %4

func_spec_read.39:                                ; preds = %ctrl1
  %5 = call i32 @spec_read.39(i32 %fd, i8* %buf, i32 %size)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_spec_read.34, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_spec_read.35, label %func_spec_read.39
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_spec_fread.13, label %ctrl0

func_spec_fread.13:                               ; preds = %rand_bb
  %2 = call i32 @spec_fread.13(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %2

func_spec_fread.23:                               ; preds = %ctrl0
  %3 = call i32 @spec_fread.23(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %3

func_spec_fread.24:                               ; preds = %ctrl1
  %4 = call i32 @spec_fread.24(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %4

func_spec_fread.28:                               ; preds = %ctrl1
  %5 = call i32 @spec_fread.28(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_spec_fread.23, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_spec_fread.24, label %func_spec_fread.28
}
...
func_spec_getc.5:                                 ; preds = %ctrl0
  %3 = call i32 @spec_getc.5(i32 %fd)
  ret i32 %3
...
func_spec_getc.15:                                ; preds = %ctrl1
  %5 = call i32 @spec_getc.15(i32 %fd)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_spec_getc.5, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_spec_getc.9, label %func_spec_getc.15
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_spec_ungetc.22, label %ctrl0

func_spec_ungetc.22:                              ; preds = %rand_bb
  %2 = call i32 @spec_ungetc.22(i8 %ch, i32 %fd)
  ret i32 %2
...
func_spec_ungetc.32:                              ; preds = %ctrl1
  %4 = call i32 @spec_ungetc.32(i8 %ch, i32 %fd)
  ret i32 %4

func_spec_ungetc.37:                              ; preds = %ctrl1
  %5 = call i32 @spec_ungetc.37(i8 %ch, i32 %fd)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_spec_ungetc.26, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_spec_ungetc.32, label %func_spec_ungetc.37
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_spec_write.1, label %ctrl0

func_spec_write.1:                                ; preds = %rand_bb
  %2 = call i32 @spec_write.1(i32 %fd, i8* %buf, i32 %size)
  ret i32 %2
...
func_spec_write.41:                               ; preds = %ctrl1
  %4 = call i32 @spec_write.41(i32 %fd, i8* %buf, i32 %size)
  ret i32 %4

func_spec_write.42:                               ; preds = %ctrl1
  %5 = call i32 @spec_write.42(i32 %fd, i8* %buf, i32 %size)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_spec_write.12, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_spec_write.41, label %func_spec_write.42
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_spec_fwrite.4, label %ctrl0

func_spec_fwrite.4:                               ; preds = %rand_bb
  %2 = call i32 @spec_fwrite.4(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %2
...
func_spec_fwrite.17:                              ; preds = %ctrl1
  %4 = call i32 @spec_fwrite.17(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %4

func_spec_fwrite.40:                              ; preds = %ctrl1
...
ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_spec_fwrite.17, label %func_spec_fwrite.40
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_spec_putc.14, label %func_spec_putc.18

func_spec_putc.14:                                ; preds = %rand_bb
  %2 = call i32 @spec_putc.14(i8 %ch, i32 %fd)
  ret i32 %2
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_write.1(i32 %fd, i8* %buf, i32 %size) #0 {
entry:
  %canary = alloca i32
  store i32 289925808, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_init.2() #0 {
entry:
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1349340978, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 172764112, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_fwrite.4(i8* %buf, i32 %size, i32 %num, i32 %fd) #0 {
entry:
  %canary = alloca i32
  store i32 1654000174, i32* %canary
  %buf.addr = alloca i8*, align 8
  %fd.addr = alloca i32, align 4
...
entry:
  %rc = alloca i32, align 4
  %canary = alloca i32
  store i32 118052657, i32* %canary
  %fd.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  store i32 0, i32* %rc, align 4
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 593042960, i32* %canary
...
entry:
  ...
  %rc = alloca i32, align 4
  %canary = alloca i32
  store i32 1226375921, i32* %canary
  %fd.addr = alloca i32, align 4
  %size.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  store i32 %fd, i32* %fd.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_random_load.8(i32 %fd) #0 {
entry:
  %random_text = alloca [32 x [131072 x i8]], align 16
  %fd.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1168108222, i32* %canary
  %j = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  %0 = load i32, i32* @dbglvl, align 4
  %cmp = icmp slt i32 4, %0
...
entry:
  %rc = alloca i32, align 4
  %canary = alloca i32
  store i32 1422976042, i32* %canary
  %retval = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  store i32 0, i32* %rc, align 4
...
entry:
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 421772966, i32* %canary
  %size.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %num.addr = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
...
entry:
  ...
  %size.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 888804838, i32* %canary
  %fd.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
...
entry:
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1625375143, i32* %canary
  %size.addr = alloca i32, align 4
  %num.addr = alloca i32, align 4
  %rc = alloca i32, align 4
  %fd.addr = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1347316379, i32* %canary
  %fd.addr = alloca i32, align 4
...
entry:
  ...
  %rc = alloca i32, align 4
  %canary = alloca i32
  store i32 1449186945, i32* %canary
  %retval = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  store i32 0, i32* %rc, align 4
  %0 = load i32, i32* @dbglvl, align 4
...
entry:
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1017961528, i32* %canary
  %i = alloca i32, align 4
  %limit = alloca i32, align 4
  %0 = load i32, i32* @dbglvl, align 4
  %cmp = icmp slt i32 3, %0
...
entry:
  ...
  %num.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 684098384, i32* %canary
  %size.addr = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
  store i32 %num, i32* %num.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 1402526215, i32* %canary
  %ch.addr = alloca i8, align 1
  %fd.addr = alloca i32, align 4
  store i8 %ch, i8* %ch.addr, align 1
  store i32 %fd, i32* %fd.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local double @ran.19() #0 {
entry:
  %canary = alloca i32
  store i32 386326089, i32* %canary
  %hi = alloca i64, align 8
  %test = alloca i64, align 8
  %lo = alloca i64, align 8
  %0 = load i64, i64* @seedi, align 8
...
entry:
  %canary = alloca i32
  store i32 176683286, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_load.21(i32 %num, i8* %filename, i32 %size) #0 {
entry:
  %filename.addr = alloca i8*, align 8
  %tmp = alloca i32, align 4
  %num.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_ungetc.22(i8 zeroext %ch, i32 %fd) #0 {
entry:
  %canary = alloca i32
  store i32 947983851, i32* %canary
  %ch.addr = alloca i8, align 1
  %rc = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  store i8 %ch, i8* %ch.addr, align 1
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_fread.23(i8* %buf, i32 %size, i32 %num, i32 %fd) #0 {
entry:
  %size.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 276102675, i32* %canary
  %rc = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %num.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_fread.24(i8* %buf, i32 %size, i32 %num, i32 %fd) #0 {
entry:
  %size.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %num.addr = alloca i32, align 4
  ...
  %rc = alloca i32, align 4
  %canary = alloca i32
  store i32 852211655, i32* %canary
  %fd.addr = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
  store i32 %num, i32* %num.addr, align 4
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 601195747, i32* %canary
  %i = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  %0 = load i32, i32* @dbglvl, align 4
  %cmp = icmp slt i32 4, %0
...
entry:
  ...
  %lo = alloca i64, align 8
  %canary = alloca i32
  store i32 1247769952, i32* %canary
  %test = alloca i64, align 8
  %0 = load i64, i64* @seedi, align 8
  %div = sdiv i64 %0, 127773
  store i64 %div, i64* %hi, align 8
...
entry:
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1581326139, i32* %canary
  %retval = alloca i32, align 4
  %rc = alloca i32, align 4
  %num.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local double @ran.29() #0 {
entry:
  %lo = alloca i64, align 8
  %test = alloca i64, align 8
  %canary = alloca i32
  store i32 792076421, i32* %canary
  %hi = alloca i64, align 8
  %0 = load i64, i64* @seedi, align 8
  %div = sdiv i64 %0, 127773
  store i64 %div, i64* %hi, align 8
...
entry:
  %limit = alloca i32, align 4
  %canary = alloca i32
  store i32 409416207, i32* %canary
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %0 = load i32, i32* @dbglvl, align 4
  %cmp = icmp slt i32 3, %0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_init.31() #0 {
entry:
  %i = alloca i32, align 4
  %limit = alloca i32, align 4
  %canary = alloca i32
  store i32 1542497243, i32* %canary
  %j = alloca i32, align 4
  %0 = load i32, i32* @dbglvl, align 4
  %cmp = icmp slt i32 3, %0
  br i1 %cmp, label %if.then, label %if.end
...
entry:
  ...
  %ch.addr = alloca i8, align 1
  %canary = alloca i32
  store i32 778300206, i32* %canary
  %rc = alloca i32, align 4
  store i8 %ch, i8* %ch.addr, align 1
  store i32 %fd, i32* %fd.addr, align 4
  store i32 0, i32* %rc, align 4
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1073020473, i32* %canary
  %rc = alloca i32, align 4
  %fd = alloca i32, align 4
  %filename.addr = alloca i8*, align 8
  %size.addr = alloca i32, align 4
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 927051716, i32* %canary
  %buf.addr = alloca i8*, align 8
  store i32 %fd, i32* %fd.addr, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1527582719, i32* %canary
  %size.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %fd.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
...
entry:
  ...
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 510183341, i32* %canary
  %j = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  %0 = load i32, i32* @dbglvl, align 4
  %cmp = icmp slt i32 4, %0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_ungetc.37(i8 zeroext %ch, i32 %fd) #0 {
entry:
  %canary = alloca i32
  store i32 1540222609, i32* %canary
  %rc = alloca i32, align 4
  %ch.addr = alloca i8, align 1
  %fd.addr = alloca i32, align 4
  store i8 %ch, i8* %ch.addr, align 1
...
entry:
  ...
  %tmp = alloca i32, align 4
  %canary = alloca i32
  store i32 537358087, i32* %canary
  %i = alloca i32, align 4
  %num.addr = alloca i32, align 4
  %fd = alloca i32, align 4
  %size.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_read.39(i32 %fd, i8* %buf, i32 %size) #0 {
entry:
  %retval = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1233602199, i32* %canary
  %size.addr = alloca i32, align 4
  %rc = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  store i32 %fd, i32* %fd.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 1506031023, i32* %canary
  %num.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %fd.addr = alloca i32, align 4
  %size.addr = alloca i32, align 4
...
entry:
  %size.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1649991069, i32* %canary
  %fd.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  store i32 %fd, i32* %fd.addr, align 4
  store i8* %buf, i8** %buf.addr, align 8
...
entry:
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1438069522, i32* %canary
  %buf.addr = alloca i8*, align 8
  %size.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  store i8* %buf, i8** %buf.addr, align 8
