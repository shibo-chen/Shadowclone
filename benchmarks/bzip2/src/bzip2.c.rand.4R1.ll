...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_fopen_output_safely.17, label %ctrl0

func_fopen_output_safely.17:                      ; preds = %rand_bb
  %2 = call %struct._IO_FILE* @fopen_output_safely.17(i8* %name, i8* %mode)
  ret %struct._IO_FILE* %2

func_fopen_output_safely.82:                      ; preds = %ctrl0
  %3 = call %struct._IO_FILE* @fopen_output_safely.82(i8* %name, i8* %mode)
  ret %struct._IO_FILE* %3

func_fopen_output_safely.85:                      ; preds = %ctrl1
  %4 = call %struct._IO_FILE* @fopen_output_safely.85(i8* %name, i8* %mode)
  ret %struct._IO_FILE* %4

func_fopen_output_safely.88:                      ; preds = %ctrl1
  %5 = call %struct._IO_FILE* @fopen_output_safely.88(i8* %name, i8* %mode)
  ret %struct._IO_FILE* %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_fopen_output_safely.82, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_fopen_output_safely.85, label %func_fopen_output_safely.88
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_copyFileName.1, label %func_copyFileName.89

func_copyFileName.1:                              ; preds = %rand_bb
  call void @copyFileName.1(i8* %to, i8* %from)
  ret void

func_copyFileName.89:                             ; preds = %rand_bb
  call void @copyFileName.89(i8* %to, i8* %from)
  ret void
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_addFlagsFromEnvVar.18, label %ctrl0

func_addFlagsFromEnvVar.18:                       ; preds = %rand_bb
  call void @addFlagsFromEnvVar.18(%struct.zzzz** %argList, i8* %varName)
  ret void

func_addFlagsFromEnvVar.21:                       ; preds = %ctrl0
  call void @addFlagsFromEnvVar.21(%struct.zzzz** %argList, i8* %varName)
  ret void

func_addFlagsFromEnvVar.53:                       ; preds = %ctrl1
  call void @addFlagsFromEnvVar.53(%struct.zzzz** %argList, i8* %varName)
  ret void

func_addFlagsFromEnvVar.60:                       ; preds = %ctrl1
  call void @addFlagsFromEnvVar.60(%struct.zzzz** %argList, i8* %varName)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_addFlagsFromEnvVar.21, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_addFlagsFromEnvVar.53, label %func_addFlagsFromEnvVar.60
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_snocString.43, label %ctrl0

func_snocString.43:                               ; preds = %rand_bb
  %2 = call %struct.zzzz* @snocString.43(%struct.zzzz* %root, i8* %name)
  ret %struct.zzzz* %2

func_snocString.50:                               ; preds = %ctrl0
  %3 = call %struct.zzzz* @snocString.50(%struct.zzzz* %root, i8* %name)
  ret %struct.zzzz* %3

func_snocString.51:                               ; preds = %ctrl1
  %4 = call %struct.zzzz* @snocString.51(%struct.zzzz* %root, i8* %name)
  ret %struct.zzzz* %4

func_snocString.54:                               ; preds = %ctrl1
  %5 = call %struct.zzzz* @snocString.54(%struct.zzzz* %root, i8* %name)
  ret %struct.zzzz* %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_snocString.50, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_snocString.51, label %func_snocString.54
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_compress.19, label %ctrl0

func_compress.19:                                 ; preds = %rand_bb
  call void @compress.19(i8* %name)
  ret void

func_compress.77:                                 ; preds = %ctrl0
  call void @compress.77(i8* %name)
  ret void

func_compress.79:                                 ; preds = %ctrl1
  call void @compress.79(i8* %name)
  ret void

func_compress.96:                                 ; preds = %ctrl1
  call void @compress.96(i8* %name)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_compress.77, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_compress.79, label %func_compress.96
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_uncompress.30, label %ctrl0

func_uncompress.30:                               ; preds = %rand_bb
  call void @uncompress.30(i8* %name)
  ret void

func_uncompress.44:                               ; preds = %ctrl0
  call void @uncompress.44(i8* %name)
  ret void

func_uncompress.90:                               ; preds = %ctrl1
  call void @uncompress.90(i8* %name)
  ret void

func_uncompress.92:                               ; preds = %ctrl1
  call void @uncompress.92(i8* %name)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_uncompress.44, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_uncompress.90, label %func_uncompress.92
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_testf.24, label %ctrl0

func_testf.24:                                    ; preds = %rand_bb
  call void @testf.24(i8* %name)
  ret void

func_testf.45:                                    ; preds = %ctrl0
  call void @testf.45(i8* %name)
  ret void

func_testf.64:                                    ; preds = %ctrl1
  call void @testf.64(i8* %name)
  ret void

func_testf.83:                                    ; preds = %ctrl1
  call void @testf.83(i8* %name)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_testf.45, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_testf.64, label %func_testf.83
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_cleanUpAndFail.11, label %ctrl0

func_cleanUpAndFail.11:                           ; preds = %rand_bb
  call void @cleanUpAndFail.11(i32 %ec)
  ret void

func_cleanUpAndFail.13:                           ; preds = %ctrl0
  call void @cleanUpAndFail.13(i32 %ec)
  ret void

func_cleanUpAndFail.28:                           ; preds = %ctrl1
  call void @cleanUpAndFail.28(i32 %ec)
  ret void

func_cleanUpAndFail.39:                           ; preds = %ctrl1
  call void @cleanUpAndFail.39(i32 %ec)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_cleanUpAndFail.13, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_cleanUpAndFail.28, label %func_cleanUpAndFail.39
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_myMalloc.20, label %func_myMalloc.49

func_myMalloc.20:                                 ; preds = %rand_bb
  %2 = call i8* @myMalloc.20(i32 %n)
  ret i8* %2

func_myMalloc.49:                                 ; preds = %rand_bb
  %3 = call i8* @myMalloc.49(i32 %n)
  ret i8* %3
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_fileExists.27, label %ctrl0

func_fileExists.27:                               ; preds = %rand_bb
  %2 = call i8 @fileExists.27(i8* %name)
  ret i8 %2

func_fileExists.65:                               ; preds = %ctrl0
  %3 = call i8 @fileExists.65(i8* %name)
  ret i8 %3

func_fileExists.80:                               ; preds = %ctrl1
  %4 = call i8 @fileExists.80(i8* %name)
  ret i8 %4

func_fileExists.86:                               ; preds = %ctrl1
  %5 = call i8 @fileExists.86(i8* %name)
  ret i8 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_fileExists.65, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_fileExists.80, label %func_fileExists.86
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_hasSuffix.37, label %ctrl0

func_hasSuffix.37:                                ; preds = %rand_bb
  %2 = call i8 @hasSuffix.37(i8* %s, i8* %suffix)
  ret i8 %2

func_hasSuffix.38:                                ; preds = %ctrl0
  %3 = call i8 @hasSuffix.38(i8* %s, i8* %suffix)
  ret i8 %3

func_hasSuffix.59:                                ; preds = %ctrl1
  %4 = call i8 @hasSuffix.59(i8* %s, i8* %suffix)
  ret i8 %4

func_hasSuffix.71:                                ; preds = %ctrl1
  %5 = call i8 @hasSuffix.71(i8* %s, i8* %suffix)
  ret i8 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_hasSuffix.38, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_hasSuffix.59, label %func_hasSuffix.71
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_notAStandardFile.25, label %ctrl0

func_notAStandardFile.25:                         ; preds = %rand_bb
  %2 = call i8 @notAStandardFile.25(i8* %name)
  ret i8 %2

func_notAStandardFile.66:                         ; preds = %ctrl0
  %3 = call i8 @notAStandardFile.66(i8* %name)
  ret i8 %3

func_notAStandardFile.74:                         ; preds = %ctrl1
  %4 = call i8 @notAStandardFile.74(i8* %name)
  ret i8 %4

func_notAStandardFile.93:                         ; preds = %ctrl1
  %5 = call i8 @notAStandardFile.93(i8* %name)
  ret i8 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_notAStandardFile.66, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_notAStandardFile.74, label %func_notAStandardFile.93
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_countHardLinks.9, label %ctrl0

func_countHardLinks.9:                            ; preds = %rand_bb
  %2 = call i32 @countHardLinks.9(i8* %name)
  ret i32 %2

func_countHardLinks.23:                           ; preds = %ctrl0
  %3 = call i32 @countHardLinks.23(i8* %name)
  ret i32 %3

func_countHardLinks.47:                           ; preds = %ctrl1
  %4 = call i32 @countHardLinks.47(i8* %name)
  ret i32 %4

func_countHardLinks.84:                           ; preds = %ctrl1
  %5 = call i32 @countHardLinks.84(i8* %name)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_countHardLinks.23, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_countHardLinks.47, label %func_countHardLinks.84
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_saveInputFileMetaInfo.35, label %func_saveInputFileMetaInfo.72

func_saveInputFileMetaInfo.35:                    ; preds = %rand_bb
  call void @saveInputFileMetaInfo.35(i8* %srcName)
  ret void

func_saveInputFileMetaInfo.72:                    ; preds = %rand_bb
  call void @saveInputFileMetaInfo.72(i8* %srcName)
  ret void
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_pad.36, label %func_pad.41

func_pad.36:                                      ; preds = %rand_bb
  call void @pad.36(i8* %s)
  ret void

func_pad.41:                                      ; preds = %rand_bb
  call void @pad.41(i8* %s)
  ret void
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_compressStream.12, label %ctrl0

func_compressStream.12:                           ; preds = %rand_bb
  call void @compressStream.12(%struct._IO_FILE* %stream, %struct._IO_FILE* %zStream)
  ret void

func_compressStream.14:                           ; preds = %ctrl0
  call void @compressStream.14(%struct._IO_FILE* %stream, %struct._IO_FILE* %zStream)
  ret void

func_compressStream.16:                           ; preds = %ctrl1
  call void @compressStream.16(%struct._IO_FILE* %stream, %struct._IO_FILE* %zStream)
  ret void

func_compressStream.34:                           ; preds = %ctrl1
  call void @compressStream.34(%struct._IO_FILE* %stream, %struct._IO_FILE* %zStream)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_compressStream.14, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_compressStream.16, label %func_compressStream.34
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_applySavedMetaInfoToOutputFile.5, label %ctrl0

func_applySavedMetaInfoToOutputFile.5:            ; preds = %rand_bb
  call void @applySavedMetaInfoToOutputFile.5(i8* %dstName)
  ret void

func_applySavedMetaInfoToOutputFile.31:           ; preds = %ctrl0
  call void @applySavedMetaInfoToOutputFile.31(i8* %dstName)
  ret void

func_applySavedMetaInfoToOutputFile.42:           ; preds = %ctrl1
  call void @applySavedMetaInfoToOutputFile.42(i8* %dstName)
  ret void

func_applySavedMetaInfoToOutputFile.81:           ; preds = %ctrl1
  call void @applySavedMetaInfoToOutputFile.81(i8* %dstName)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_applySavedMetaInfoToOutputFile.31, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_applySavedMetaInfoToOutputFile.42, label %func_applySavedMetaInfoToOutputFile.81
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_myfeof.2, label %ctrl0

func_myfeof.2:                                    ; preds = %rand_bb
  %2 = call i8 @myfeof.2(%struct._IO_FILE* %f)
  ret i8 %2

func_myfeof.8:                                    ; preds = %ctrl0
  %3 = call i8 @myfeof.8(%struct._IO_FILE* %f)
  ret i8 %3

func_myfeof.69:                                   ; preds = %ctrl1
  %4 = call i8 @myfeof.69(%struct._IO_FILE* %f)
  ret i8 %4

func_myfeof.70:                                   ; preds = %ctrl1
  %5 = call i8 @myfeof.70(%struct._IO_FILE* %f)
  ret i8 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_myfeof.8, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_myfeof.69, label %func_myfeof.70
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_uInt64_from_UInt32s.4, label %ctrl0

func_uInt64_from_UInt32s.4:                       ; preds = %rand_bb
  call void @uInt64_from_UInt32s.4(%struct.UInt64* %n, i32 %lo32, i32 %hi32)
  ret void

func_uInt64_from_UInt32s.29:                      ; preds = %ctrl0
  call void @uInt64_from_UInt32s.29(%struct.UInt64* %n, i32 %lo32, i32 %hi32)
  ret void

func_uInt64_from_UInt32s.46:                      ; preds = %ctrl1
  call void @uInt64_from_UInt32s.46(%struct.UInt64* %n, i32 %lo32, i32 %hi32)
  ret void

func_uInt64_from_UInt32s.73:                      ; preds = %ctrl1
  call void @uInt64_from_UInt32s.73(%struct.UInt64* %n, i32 %lo32, i32 %hi32)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_uInt64_from_UInt32s.29, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_uInt64_from_UInt32s.46, label %func_uInt64_from_UInt32s.73
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_uInt64_to_double.32, label %ctrl0

func_uInt64_to_double.32:                         ; preds = %rand_bb
  %2 = call double @uInt64_to_double.32(%struct.UInt64* %n)
  ret double %2

func_uInt64_to_double.58:                         ; preds = %ctrl0
  %3 = call double @uInt64_to_double.58(%struct.UInt64* %n)
  ret double %3

func_uInt64_to_double.62:                         ; preds = %ctrl1
  %4 = call double @uInt64_to_double.62(%struct.UInt64* %n)
  ret double %4

func_uInt64_to_double.78:                         ; preds = %ctrl1
  %5 = call double @uInt64_to_double.78(%struct.UInt64* %n)
  ret double %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_uInt64_to_double.58, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_uInt64_to_double.62, label %func_uInt64_to_double.78
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_uInt64_toAscii.22, label %ctrl0

func_uInt64_toAscii.22:                           ; preds = %rand_bb
  call void @uInt64_toAscii.22(i8* %outbuf, %struct.UInt64* %n)
  ret void

func_uInt64_toAscii.52:                           ; preds = %ctrl0
  call void @uInt64_toAscii.52(i8* %outbuf, %struct.UInt64* %n)
  ret void

func_uInt64_toAscii.55:                           ; preds = %ctrl1
  call void @uInt64_toAscii.55(i8* %outbuf, %struct.UInt64* %n)
  ret void

func_uInt64_toAscii.87:                           ; preds = %ctrl1
  call void @uInt64_toAscii.87(i8* %outbuf, %struct.UInt64* %n)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_uInt64_toAscii.52, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_uInt64_toAscii.55, label %func_uInt64_toAscii.87
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_uInt64_qrm10.6, label %ctrl0

func_uInt64_qrm10.6:                              ; preds = %rand_bb
  %2 = call i32 @uInt64_qrm10.6(%struct.UInt64* %n)
  ret i32 %2

func_uInt64_qrm10.56:                             ; preds = %ctrl0
  %3 = call i32 @uInt64_qrm10.56(%struct.UInt64* %n)
  ret i32 %3

func_uInt64_qrm10.57:                             ; preds = %ctrl1
  %4 = call i32 @uInt64_qrm10.57(%struct.UInt64* %n)
  ret i32 %4

func_uInt64_qrm10.61:                             ; preds = %ctrl1
  %5 = call i32 @uInt64_qrm10.61(%struct.UInt64* %n)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_uInt64_qrm10.56, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_uInt64_qrm10.57, label %func_uInt64_qrm10.61
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_uInt64_isZero.10, label %ctrl0

func_uInt64_isZero.10:                            ; preds = %rand_bb
  %2 = call i8 @uInt64_isZero.10(%struct.UInt64* %n)
  ret i8 %2

func_uInt64_isZero.40:                            ; preds = %ctrl0
  %3 = call i8 @uInt64_isZero.40(%struct.UInt64* %n)
  ret i8 %3

func_uInt64_isZero.48:                            ; preds = %ctrl1
  %4 = call i8 @uInt64_isZero.48(%struct.UInt64* %n)
  ret i8 %4

func_uInt64_isZero.68:                            ; preds = %ctrl1
  %5 = call i8 @uInt64_isZero.68(%struct.UInt64* %n)
  ret i8 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_uInt64_isZero.40, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_uInt64_isZero.48, label %func_uInt64_isZero.68
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_mapSuffix.3, label %ctrl0

func_mapSuffix.3:                                 ; preds = %rand_bb
  %2 = call i8 @mapSuffix.3(i8* %name, i8* %oldSuffix, i8* %newSuffix)
  ret i8 %2

func_mapSuffix.7:                                 ; preds = %ctrl0
  %3 = call i8 @mapSuffix.7(i8* %name, i8* %oldSuffix, i8* %newSuffix)
  ret i8 %3

func_mapSuffix.76:                                ; preds = %ctrl1
  %4 = call i8 @mapSuffix.76(i8* %name, i8* %oldSuffix, i8* %newSuffix)
  ret i8 %4

func_mapSuffix.91:                                ; preds = %ctrl1
  %5 = call i8 @mapSuffix.91(i8* %name, i8* %oldSuffix, i8* %newSuffix)
  ret i8 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_mapSuffix.7, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_mapSuffix.76, label %func_mapSuffix.91
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_uncompressStream.33, label %ctrl0

func_uncompressStream.33:                         ; preds = %rand_bb
  %2 = call i8 @uncompressStream.33(%struct._IO_FILE* %zStream, %struct._IO_FILE* %stream)
  ret i8 %2

func_uncompressStream.63:                         ; preds = %ctrl0
  %3 = call i8 @uncompressStream.63(%struct._IO_FILE* %zStream, %struct._IO_FILE* %stream)
  ret i8 %3

func_uncompressStream.94:                         ; preds = %ctrl1
  %4 = call i8 @uncompressStream.94(%struct._IO_FILE* %zStream, %struct._IO_FILE* %stream)
  ret i8 %4

func_uncompressStream.95:                         ; preds = %ctrl1
  %5 = call i8 @uncompressStream.95(%struct._IO_FILE* %zStream, %struct._IO_FILE* %stream)
  ret i8 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_uncompressStream.63, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_uncompressStream.94, label %func_uncompressStream.95
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_testStream.15, label %ctrl0

func_testStream.15:                               ; preds = %rand_bb
  %2 = call i8 @testStream.15(%struct._IO_FILE* %zStream)
  ret i8 %2

func_testStream.26:                               ; preds = %ctrl0
  %3 = call i8 @testStream.26(%struct._IO_FILE* %zStream)
  ret i8 %3

func_testStream.67:                               ; preds = %ctrl1
  %4 = call i8 @testStream.67(%struct._IO_FILE* %zStream)
  ret i8 %4

func_testStream.75:                               ; preds = %ctrl1
  %5 = call i8 @testStream.75(%struct._IO_FILE* %zStream)
  ret i8 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_testStream.26, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_testStream.67, label %func_testStream.75
}

; Function Attrs: noinline nounwind optnone uwtable
define internal void @copyFileName.1(i8* %to, i8* %from) #0 {
entry:
  %canary = alloca i32
  store i32 515460834, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @myfeof.2(%struct._IO_FILE* %f) #0 {
entry:
  %canary = alloca i32
  store i32 1676430034, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @mapSuffix.3(i8* %name, i8* %oldSuffix, i8* %newSuffix) #0 {
entry:
  %retval = alloca i8, align 1
  %newSuffix.addr = alloca i8*, align 8
  %name.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1928843288, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @uInt64_from_UInt32s.4(%struct.UInt64* %n, i32 %lo32, i32 %hi32) #0 {
entry:
  %hi32.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 920022708, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @applySavedMetaInfoToOutputFile.5(i8* %dstName) #0 {
entry:
  %canary = alloca i32
  store i32 719671244, i32* %canary
  %retVal = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @uInt64_qrm10.6(%struct.UInt64* %n) #0 {
entry:
  %i = alloca i32, align 4
  %n.addr = alloca %struct.UInt64*, align 8
  %canary = alloca i32
  store i32 1704609356, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @mapSuffix.7(i8* %name, i8* %oldSuffix, i8* %newSuffix) #0 {
entry:
  %retval = alloca i8, align 1
  %name.addr = alloca i8*, align 8
  %newSuffix.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1035319718, i32* %canary
  %oldSuffix.addr = alloca i8*, align 8
  store i8* %name, i8** %name.addr, align 8
  store i8* %oldSuffix, i8** %oldSuffix.addr, align 8
  store i8* %newSuffix, i8** %newSuffix.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @myfeof.8(%struct._IO_FILE* %f) #0 {
entry:
  %canary = alloca i32
  store i32 354710414, i32* %canary
  %retval = alloca i8, align 1
  %c = alloca i32, align 4
  %f.addr = alloca %struct._IO_FILE*, align 8
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @countHardLinks.9(i8* %name) #0 {
entry:
  %canary = alloca i32
  store i32 409392669, i32* %canary
  %i = alloca i32, align 4
  %name.addr = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @uInt64_isZero.10(%struct.UInt64* %n) #0 {
entry:
  %i = alloca i32, align 4
  %retval = alloca i8, align 1
  %canary = alloca i32
  store i32 1470768971, i32* %canary
  %n.addr = alloca %struct.UInt64*, align 8
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
  store i32 0, i32* %i, align 4
  br label %for.cond
...
; Function Attrs: noinline noreturn nounwind optnone uwtable
define internal void @cleanUpAndFail.11(i32 %ec) #5 {
entry:
  %canary = alloca i32
  store i32 2109450109, i32* %canary
  %statBuf = alloca %struct.stat, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @compressStream.12(%struct._IO_FILE* %stream, %struct._IO_FILE* %zStream) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 924442714, i32* %canary
...
; Function Attrs: noinline noreturn nounwind optnone uwtable
define internal void @cleanUpAndFail.13(i32 %ec) #5 {
entry:
  %ec.addr = alloca i32, align 4
  %retVal = alloca i32, align 4
  %canary = alloca i32
  store i32 36614734, i32* %canary
  %statBuf = alloca %struct.stat, align 8
  store i32 %ec, i32* %ec.addr, align 4
  %0 = load i32, i32* @srcMode, align 4
  %cmp = icmp eq i32 %0, 3
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @compressStream.14(%struct._IO_FILE* %stream, %struct._IO_FILE* %zStream) #0 {
entry:
  %bzerr_dummy = alloca i32, align 4
  %nbytes_out_d = alloca double, align 8
  %ret = alloca i32, align 4
  ...
  %nbytes_in_lo32 = alloca i32, align 4
  %canary = alloca i32
  store i32 1160189208, i32* %canary
  %nbytes_out = alloca %struct.UInt64, align 1
  %bzf = alloca i8*, align 8
  %nIbuf = alloca i32, align 4
  %ibuf = alloca [5000 x i8], align 16
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @testStream.15(%struct._IO_FILE* %zStream) #0 {
entry:
  %bzerr = alloca i32, align 4
  ...
  %canary = alloca i32
  store i32 2079627258, i32* %canary
  %zStream.addr = alloca %struct._IO_FILE*, align 8
  %ret = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @compressStream.16(%struct._IO_FILE* %stream, %struct._IO_FILE* %zStream) #0 {
entry:
  %nbytes_in_d = alloca double, align 8
  %stream.addr = alloca %struct._IO_FILE*, align 8
  %bzerr = alloca i32, align 4
  ...
  %nbytes_in_lo32 = alloca i32, align 4
  %canary = alloca i32
  store i32 1027128688, i32* %canary
  %nbytes_in_hi32 = alloca i32, align 4
  %nbytes_out_d = alloca double, align 8
  store %struct._IO_FILE* %stream, %struct._IO_FILE** %stream.addr, align 8
  store %struct._IO_FILE* %zStream, %struct._IO_FILE** %zStream.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @addFlagsFromEnvVar.18(%struct.zzzz** %argList, i8* %varName) #0 {
entry:
  %p = alloca i8*, align 8
  %argList.addr = alloca %struct.zzzz**, align 8
  %envbase = alloca i8*, align 8
  %canary = alloca i32
  store i32 177993839, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @compress.19(i8* %name) #0 {
entry:
  %statBuf = alloca %struct.stat, align 8
  ...
  %name.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1690249906, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i8* @myMalloc.20(i32 %n) #0 {
entry:
  %canary = alloca i32
  store i32 104200167, i32* %canary
  %p = alloca i8*, align 8
  %n.addr = alloca i32, align 4
  store i32 %n, i32* %n.addr, align 4
...
entry:
  ...
  %envbase = alloca i8*, align 8
  %canary = alloca i32
  store i32 1073125240, i32* %canary
  %i = alloca i32, align 4
  store %struct.zzzz** %argList, %struct.zzzz*** %argList.addr, align 8
  store i8* %varName, i8** %varName.addr, align 8
  %0 = load i8*, i8** %varName.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @uInt64_toAscii.22(i8* %outbuf, %struct.UInt64* %n) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 2048262560, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @countHardLinks.23(i8* %name) #0 {
entry:
  %canary = alloca i32
  store i32 265919132, i32* %canary
  %i = alloca i32, align 4
  %name.addr = alloca i8*, align 8
  %retval = alloca i32, align 4
  %statBuf = alloca %struct.stat, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @testf.24(i8* %name) #0 {
entry:
  %canary = alloca i32
  store i32 1114175460, i32* %canary
  %name.addr = alloca i8*, align 8
  %inStr = alloca %struct._IO_FILE*, align 8
  %statBuf = alloca %struct.stat, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @notAStandardFile.25(i8* %name) #0 {
entry:
  %i = alloca i32, align 4
  %retval = alloca i8, align 1
  %name.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 713145452, i32* %canary
  %statBuf = alloca %struct.stat, align 8
  store i8* %name, i8** %name.addr, align 8
  %0 = load i8*, i8** %name.addr, align 8
  %call = call i32 @lstat(i8* %0, %struct.stat* %statBuf) #8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @testStream.26(%struct._IO_FILE* %zStream) #0 {
entry:
  %nUnused = alloca i32, align 4
  %ret = alloca i32, align 4
  %unused = alloca [5000 x i8], align 16
  ...
  %nread = alloca i32, align 4
  %canary = alloca i32
  store i32 1084644763, i32* %canary
  %streamNo = alloca i32, align 4
  %unusedTmp = alloca i8*, align 8
  %obuf = alloca [5000 x i8], align 16
  %retval = alloca i8, align 1
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @fileExists.27(i8* %name) #0 {
entry:
  %canary = alloca i32
  store i32 253267728, i32* %canary
  %name.addr = alloca i8*, align 8
...
entry:
  %canary = alloca i32
  store i32 1726713989, i32* %canary
  %ec.addr = alloca i32, align 4
  %statBuf = alloca %struct.stat, align 8
  %retVal = alloca i32, align 4
  store i32 %ec, i32* %ec.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @uInt64_from_UInt32s.29(%struct.UInt64* %n, i32 %lo32, i32 %hi32) #0 {
entry:
  %n.addr = alloca %struct.UInt64*, align 8
  %canary = alloca i32
  store i32 1559027241, i32* %canary
  %hi32.addr = alloca i32, align 4
  %lo32.addr = alloca i32, align 4
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
  store i32 %lo32, i32* %lo32.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @uncompress.30(i8* %name) #0 {
entry:
  %outStr = alloca %struct._IO_FILE*, align 8
  %statBuf = alloca %struct.stat, align 8
  %i = alloca i32, align 4
  %inStr = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 1894485241, i32* %canary
  %n = alloca i32, align 4
  %name.addr = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @applySavedMetaInfoToOutputFile.31(i8* %dstName) #0 {
entry:
  %canary = alloca i32
  store i32 1355595246, i32* %canary
  %dstName.addr = alloca i8*, align 8
  %retVal = alloca i32, align 4
  %uTimBuf = alloca %struct.utimbuf, align 8
  store i8* %dstName, i8** %dstName.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal double @uInt64_to_double.32(%struct.UInt64* %n) #0 {
entry:
  %sum = alloca double, align 8
  %base = alloca double, align 8
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1956634968, i32* %canary
  %n.addr = alloca %struct.UInt64*, align 8
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @uncompressStream.33(%struct._IO_FILE* %zStream, %struct._IO_FILE* %stream) #0 {
entry:
  %unusedTmpV = alloca i8*, align 8
  %obuf = alloca [5000 x i8], align 16
  %streamNo = alloca i32, align 4
  %unused = alloca [5000 x i8], align 16
  %canary = alloca i32
  store i32 494895274, i32* %canary
  %stream.addr = alloca %struct._IO_FILE*, align 8
  %zStream.addr = alloca %struct._IO_FILE*, align 8
  %bzf = alloca i8*, align 8
  %unusedTmp = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @compressStream.34(%struct._IO_FILE* %stream, %struct._IO_FILE* %zStream) #0 {
entry:
  %nbytes_out_hi32 = alloca i32, align 4
  %nbytes_in = alloca %struct.UInt64, align 1
  %nbytes_out = alloca %struct.UInt64, align 1
  ...
  %nIbuf = alloca i32, align 4
  %canary = alloca i32
  store i32 987759361, i32* %canary
  %bzf = alloca i8*, align 8
  %nbytes_in_d = alloca double, align 8
  %nbytes_in_hi32 = alloca i32, align 4
  %ibuf = alloca [5000 x i8], align 16
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @saveInputFileMetaInfo.35(i8* %srcName) #0 {
entry:
  %canary = alloca i32
  store i32 165543226, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @pad.36(i8* %s) #0 {
entry:
  %canary = alloca i32
  store i32 1980878429, i32* %canary
  %i = alloca i32, align 4
  %s.addr = alloca i8*, align 8
  store i8* %s, i8** %s.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @hasSuffix.37(i8* %s, i8* %suffix) #0 {
entry:
  %canary = alloca i32
  store i32 844409140, i32* %canary
  %s.addr = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @hasSuffix.38(i8* %s, i8* %suffix) #0 {
entry:
  %ns = alloca i32, align 4
  %canary = alloca i32
  store i32 1254024028, i32* %canary
  %retval = alloca i8, align 1
  %s.addr = alloca i8*, align 8
  %nx = alloca i32, align 4
  %suffix.addr = alloca i8*, align 8
...
; Function Attrs: noinline noreturn nounwind optnone uwtable
define internal void @cleanUpAndFail.39(i32 %ec) #5 {
entry:
  %canary = alloca i32
  store i32 190661611, i32* %canary
  %statBuf = alloca %struct.stat, align 8
  %retVal = alloca i32, align 4
  %ec.addr = alloca i32, align 4
  store i32 %ec, i32* %ec.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @uInt64_isZero.40(%struct.UInt64* %n) #0 {
entry:
  %retval = alloca i8, align 1
  %n.addr = alloca %struct.UInt64*, align 8
  %canary = alloca i32
  store i32 720209957, i32* %canary
  %i = alloca i32, align 4
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
  store i32 0, i32* %i, align 4
  br label %for.cond
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @pad.41(i8* %s) #0 {
entry:
  %s.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1404050571, i32* %canary
  %i = alloca i32, align 4
  store i8* %s, i8** %s.addr, align 8
  %0 = load i8*, i8** %s.addr, align 8
  %call = call i64 @strlen(i8* %0) #9
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @applySavedMetaInfoToOutputFile.42(i8* %dstName) #0 {
entry:
  %canary = alloca i32
  store i32 1917434004, i32* %canary
  %uTimBuf = alloca %struct.utimbuf, align 8
  %dstName.addr = alloca i8*, align 8
  %retVal = alloca i32, align 4
  store i8* %dstName, i8** %dstName.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal %struct.zzzz* @snocString.43(%struct.zzzz* %root, i8* %name) #0 {
entry:
  %root.addr = alloca %struct.zzzz*, align 8
  %canary = alloca i32
  store i32 1017625196, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @uncompress.44(i8* %name) #0 {
entry:
  %retVal168 = alloca i32, align 4
  %retVal = alloca i32, align 4
  %statBuf = alloca %struct.stat, align 8
  ...
  %n = alloca i32, align 4
  %canary = alloca i32
  store i32 1190231879, i32* %canary
  %magicNumberOK = alloca i8, align 1
  store i8* %name, i8** %name.addr, align 8
  store i8 0, i8* @deleteOutputOnInterrupt, align 1
  %0 = load i8*, i8** %name.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @testf.45(i8* %name) #0 {
entry:
  %statBuf = alloca %struct.stat, align 8
  %name.addr = alloca i8*, align 8
  %allOK = alloca i8, align 1
  %canary = alloca i32
  store i32 2076595901, i32* %canary
  %inStr = alloca %struct._IO_FILE*, align 8
  store i8* %name, i8** %name.addr, align 8
  store i8 0, i8* @deleteOutputOnInterrupt, align 1
  %0 = load i8*, i8** %name.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @uInt64_from_UInt32s.46(%struct.UInt64* %n, i32 %lo32, i32 %hi32) #0 {
entry:
  %canary = alloca i32
  store i32 1527824365, i32* %canary
  %lo32.addr = alloca i32, align 4
  %n.addr = alloca %struct.UInt64*, align 8
  %hi32.addr = alloca i32, align 4
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @countHardLinks.47(i8* %name) #0 {
entry:
  %canary = alloca i32
  store i32 530473254, i32* %canary
  %i = alloca i32, align 4
  %retval = alloca i32, align 4
  %statBuf = alloca %struct.stat, align 8
  %name.addr = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @uInt64_isZero.48(%struct.UInt64* %n) #0 {
entry:
  %canary = alloca i32
  store i32 1596672515, i32* %canary
  %n.addr = alloca %struct.UInt64*, align 8
  %i = alloca i32, align 4
  %retval = alloca i8, align 1
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i8* @myMalloc.49(i32 %n) #0 {
entry:
  %canary = alloca i32
  store i32 1526912968, i32* %canary
  %n.addr = alloca i32, align 4
  %p = alloca i8*, align 8
  store i32 %n, i32* %n.addr, align 4
  %0 = load i32, i32* %n.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal %struct.zzzz* @snocString.50(%struct.zzzz* %root, i8* %name) #0 {
entry:
  %tmp = alloca %struct.zzzz*, align 8
  %canary = alloca i32
  store i32 1362160473, i32* %canary
  %name.addr = alloca i8*, align 8
  %tmp6 = alloca %struct.zzzz*, align 8
  %retval = alloca %struct.zzzz*, align 8
  %root.addr = alloca %struct.zzzz*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal %struct.zzzz* @snocString.51(%struct.zzzz* %root, i8* %name) #0 {
entry:
  %tmp = alloca %struct.zzzz*, align 8
  %root.addr = alloca %struct.zzzz*, align 8
  %name.addr = alloca i8*, align 8
  %tmp6 = alloca %struct.zzzz*, align 8
  %canary = alloca i32
  store i32 1308279433, i32* %canary
  %retval = alloca %struct.zzzz*, align 8
  store %struct.zzzz* %root, %struct.zzzz** %root.addr, align 8
  store i8* %name, i8** %name.addr, align 8
  %0 = load %struct.zzzz*, %struct.zzzz** %root.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @uInt64_toAscii.52(i8* %outbuf, %struct.UInt64* %n) #0 {
entry:
  %buf = alloca [32 x i8], align 16
  %q = alloca i32, align 4
  %n.addr = alloca %struct.UInt64*, align 8
  %n_copy = alloca %struct.UInt64, align 1
  %canary = alloca i32
  store i32 1488692424, i32* %canary
  %i = alloca i32, align 4
  %outbuf.addr = alloca i8*, align 8
  %nBuf = alloca i32, align 4
  store i8* %outbuf, i8** %outbuf.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @addFlagsFromEnvVar.53(%struct.zzzz** %argList, i8* %varName) #0 {
entry:
  %varName.addr = alloca i8*, align 8
  %k = alloca i32, align 4
  %canary = alloca i32
  store i32 1637081246, i32* %canary
  %p = alloca i8*, align 8
  %j = alloca i32, align 4
  %envbase = alloca i8*, align 8
  %argList.addr = alloca %struct.zzzz**, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal %struct.zzzz* @snocString.54(%struct.zzzz* %root, i8* %name) #0 {
entry:
  %name.addr = alloca i8*, align 8
  %retval = alloca %struct.zzzz*, align 8
  %tmp = alloca %struct.zzzz*, align 8
  %canary = alloca i32
  store i32 696736739, i32* %canary
  %root.addr = alloca %struct.zzzz*, align 8
  %tmp6 = alloca %struct.zzzz*, align 8
  store %struct.zzzz* %root, %struct.zzzz** %root.addr, align 8
  store i8* %name, i8** %name.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @uInt64_toAscii.55(i8* %outbuf, %struct.UInt64* %n) #0 {
entry:
  %n.addr = alloca %struct.UInt64*, align 8
  %outbuf.addr = alloca i8*, align 8
  %q = alloca i32, align 4
  %canary = alloca i32
  store i32 326743514, i32* %canary
  %n_copy = alloca %struct.UInt64, align 1
  %nBuf = alloca i32, align 4
  %buf = alloca [32 x i8], align 16
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @uInt64_qrm10.56(%struct.UInt64* %n) #0 {
entry:
  %rem = alloca i32, align 4
  %tmp = alloca i32, align 4
  %canary = alloca i32
  store i32 153372867, i32* %canary
  %i = alloca i32, align 4
  %n.addr = alloca %struct.UInt64*, align 8
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
  store i32 0, i32* %rem, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @uInt64_qrm10.57(%struct.UInt64* %n) #0 {
entry:
  %rem = alloca i32, align 4
  %n.addr = alloca %struct.UInt64*, align 8
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1335202261, i32* %canary
  %tmp = alloca i32, align 4
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
  store i32 0, i32* %rem, align 4
  store i32 7, i32* %i, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal double @uInt64_to_double.58(%struct.UInt64* %n) #0 {
entry:
  %canary = alloca i32
  store i32 1051697596, i32* %canary
  %sum = alloca double, align 8
  %base = alloca double, align 8
  %n.addr = alloca %struct.UInt64*, align 8
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @hasSuffix.59(i8* %s, i8* %suffix) #0 {
entry:
  %s.addr = alloca i8*, align 8
  %nx = alloca i32, align 4
  %retval = alloca i8, align 1
  %suffix.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1976889883, i32* %canary
  %ns = alloca i32, align 4
  store i8* %s, i8** %s.addr, align 8
  store i8* %suffix, i8** %suffix.addr, align 8
  %0 = load i8*, i8** %s.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @addFlagsFromEnvVar.60(%struct.zzzz** %argList, i8* %varName) #0 {
entry:
  %p = alloca i8*, align 8
  %varName.addr = alloca i8*, align 8
  %argList.addr = alloca %struct.zzzz**, align 8
  ...
  %envbase = alloca i8*, align 8
  %canary = alloca i32
  store i32 1248493777, i32* %canary
  %j = alloca i32, align 4
  store %struct.zzzz** %argList, %struct.zzzz*** %argList.addr, align 8
  store i8* %varName, i8** %varName.addr, align 8
  %0 = load i8*, i8** %varName.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @uInt64_qrm10.61(%struct.UInt64* %n) #0 {
entry:
  %n.addr = alloca %struct.UInt64*, align 8
  %i = alloca i32, align 4
  %tmp = alloca i32, align 4
  %canary = alloca i32
  store i32 2115987789, i32* %canary
  %rem = alloca i32, align 4
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
  store i32 0, i32* %rem, align 4
  store i32 7, i32* %i, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal double @uInt64_to_double.62(%struct.UInt64* %n) #0 {
entry:
  %canary = alloca i32
  store i32 1268441660, i32* %canary
  %n.addr = alloca %struct.UInt64*, align 8
  %i = alloca i32, align 4
  %base = alloca double, align 8
  %sum = alloca double, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @uncompressStream.63(%struct._IO_FILE* %zStream, %struct._IO_FILE* %stream) #0 {
entry:
  %ret = alloca i32, align 4
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1229860737, i32* %canary
  %unusedTmp = alloca i8*, align 8
  %bzerr_dummy = alloca i32, align 4
  %streamNo = alloca i32, align 4
  %nUnused = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @testf.64(i8* %name) #0 {
entry:
  %allOK = alloca i8, align 1
  %canary = alloca i32
  store i32 240846778, i32* %canary
  %statBuf = alloca %struct.stat, align 8
  %name.addr = alloca i8*, align 8
  %inStr = alloca %struct._IO_FILE*, align 8
  store i8* %name, i8** %name.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @fileExists.65(i8* %name) #0 {
entry:
  %exists = alloca i8, align 1
  %canary = alloca i32
  store i32 164986335, i32* %canary
  %name.addr = alloca i8*, align 8
  %tmp = alloca %struct._IO_FILE*, align 8
  store i8* %name, i8** %name.addr, align 8
  %0 = load i8*, i8** %name.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @notAStandardFile.66(i8* %name) #0 {
entry:
  %name.addr = alloca i8*, align 8
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 195185434, i32* %canary
  %retval = alloca i8, align 1
  %statBuf = alloca %struct.stat, align 8
  store i8* %name, i8** %name.addr, align 8
  %0 = load i8*, i8** %name.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @testStream.67(%struct._IO_FILE* %zStream) #0 {
entry:
  %canary = alloca i32
  store i32 1528729392, i32* %canary
  %i = alloca i32, align 4
  %bzerr = alloca i32, align 4
  %nread = alloca i32, align 4
  %unusedTmpV = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @uInt64_isZero.68(%struct.UInt64* %n) #0 {
entry:
  %i = alloca i32, align 4
  %n.addr = alloca %struct.UInt64*, align 8
  %canary = alloca i32
  store i32 408668476, i32* %canary
  %retval = alloca i8, align 1
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
  store i32 0, i32* %i, align 4
  br label %for.cond
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @myfeof.69(%struct._IO_FILE* %f) #0 {
entry:
  %f.addr = alloca %struct._IO_FILE*, align 8
  %retval = alloca i8, align 1
  %canary = alloca i32
  store i32 2086834314, i32* %canary
  %c = alloca i32, align 4
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** %f.addr, align 8
  %call = call i32 @fgetc(%struct._IO_FILE* %0)
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @myfeof.70(%struct._IO_FILE* %f) #0 {
entry:
  %f.addr = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 2067635717, i32* %canary
  %c = alloca i32, align 4
  %retval = alloca i8, align 1
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** %f.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @hasSuffix.71(i8* %s, i8* %suffix) #0 {
entry:
  %canary = alloca i32
  store i32 1387559330, i32* %canary
  %ns = alloca i32, align 4
  %suffix.addr = alloca i8*, align 8
  %nx = alloca i32, align 4
  %retval = alloca i8, align 1
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @saveInputFileMetaInfo.72(i8* %srcName) #0 {
entry:
  %retVal = alloca i32, align 4
  %canary = alloca i32
  store i32 1998351389, i32* %canary
  %srcName.addr = alloca i8*, align 8
  store i8* %srcName, i8** %srcName.addr, align 8
  %0 = load i8*, i8** %srcName.addr, align 8
  %call = call i32 @stat(i8* %0, %struct.stat* @fileMetaInfo) #8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @uInt64_from_UInt32s.73(%struct.UInt64* %n, i32 %lo32, i32 %hi32) #0 {
entry:
  %canary = alloca i32
  store i32 931278353, i32* %canary
  %lo32.addr = alloca i32, align 4
  %hi32.addr = alloca i32, align 4
  %n.addr = alloca %struct.UInt64*, align 8
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @notAStandardFile.74(i8* %name) #0 {
entry:
  %canary = alloca i32
  store i32 1739004731, i32* %canary
  %i = alloca i32, align 4
  %name.addr = alloca i8*, align 8
  %statBuf = alloca %struct.stat, align 8
  %retval = alloca i8, align 1
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @testStream.75(%struct._IO_FILE* %zStream) #0 {
entry:
  %nread = alloca i32, align 4
  %zStream.addr = alloca %struct._IO_FILE*, align 8
  %unusedTmpV = alloca i8*, align 8
  %canary = alloca i32
  store i32 1438675156, i32* %canary
  %retval = alloca i8, align 1
  %streamNo = alloca i32, align 4
  %bzerr = alloca i32, align 4
  %bzerr_dummy = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @mapSuffix.76(i8* %name, i8* %oldSuffix, i8* %newSuffix) #0 {
entry:
  %name.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1410510848, i32* %canary
  %newSuffix.addr = alloca i8*, align 8
  %retval = alloca i8, align 1
  %oldSuffix.addr = alloca i8*, align 8
  store i8* %name, i8** %name.addr, align 8
...
entry:
  ...
  %inStr = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 1457561374, i32* %canary
  %retVal = alloca i32, align 4
  %n = alloca i32, align 4
  %i = alloca i32, align 4
  %outStr = alloca %struct._IO_FILE*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal double @uInt64_to_double.78(%struct.UInt64* %n) #0 {
entry:
  %canary = alloca i32
  store i32 1588547403, i32* %canary
  %base = alloca double, align 8
  %i = alloca i32, align 4
  %sum = alloca double, align 8
  %n.addr = alloca %struct.UInt64*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @compress.79(i8* %name) #0 {
entry:
  %outStr = alloca %struct._IO_FILE*, align 8
  %name.addr = alloca i8*, align 8
  %inStr = alloca %struct._IO_FILE*, align 8
  ...
  %statBuf = alloca %struct.stat, align 8
  %canary = alloca i32
  store i32 1227952511, i32* %canary
  %n = alloca i32, align 4
  %i = alloca i32, align 4
  store i8* %name, i8** %name.addr, align 8
  store i8 0, i8* @deleteOutputOnInterrupt, align 1
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @fileExists.80(i8* %name) #0 {
entry:
  %name.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 221711457, i32* %canary
  %tmp = alloca %struct._IO_FILE*, align 8
  %exists = alloca i8, align 1
  store i8* %name, i8** %name.addr, align 8
  %0 = load i8*, i8** %name.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @applySavedMetaInfoToOutputFile.81(i8* %dstName) #0 {
entry:
  %dstName.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1709881437, i32* %canary
  %uTimBuf = alloca %struct.utimbuf, align 8
  %retVal = alloca i32, align 4
  store i8* %dstName, i8** %dstName.addr, align 8
  %0 = load i64, i64* getelementptr inbounds (%struct.stat, %struct.stat* @fileMetaInfo, i32 0, i32 11, i32 0), align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct._IO_FILE* @fopen_output_safely.82(i8* %name, i8* %mode) #0 {
entry:
  %canary = alloca i32
  store i32 1472321058, i32* %canary
  %mode.addr = alloca i8*, align 8
  %retval = alloca %struct._IO_FILE*, align 8
  %name.addr = alloca i8*, align 8
  %fp = alloca %struct._IO_FILE*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @testf.83(i8* %name) #0 {
entry:
  %name.addr = alloca i8*, align 8
  %statBuf = alloca %struct.stat, align 8
  %canary = alloca i32
  store i32 1196543515, i32* %canary
  %allOK = alloca i8, align 1
  %inStr = alloca %struct._IO_FILE*, align 8
  store i8* %name, i8** %name.addr, align 8
  store i8 0, i8* @deleteOutputOnInterrupt, align 1
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @countHardLinks.84(i8* %name) #0 {
entry:
  %canary = alloca i32
  store i32 21596097, i32* %canary
  %statBuf = alloca %struct.stat, align 8
  %retval = alloca i32, align 4
  %i = alloca i32, align 4
  %name.addr = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct._IO_FILE* @fopen_output_safely.85(i8* %name, i8* %mode) #0 {
entry:
  %canary = alloca i32
  store i32 2058807954, i32* %canary
  %name.addr = alloca i8*, align 8
  %fh = alloca i32, align 4
  %mode.addr = alloca i8*, align 8
  %retval = alloca %struct._IO_FILE*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @fileExists.86(i8* %name) #0 {
entry:
  %tmp = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 1523040712, i32* %canary
  %exists = alloca i8, align 1
  %name.addr = alloca i8*, align 8
  store i8* %name, i8** %name.addr, align 8
  %0 = load i8*, i8** %name.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @uInt64_toAscii.87(i8* %outbuf, %struct.UInt64* %n) #0 {
entry:
  %nBuf = alloca i32, align 4
  %n.addr = alloca %struct.UInt64*, align 8
  %buf = alloca [32 x i8], align 16
  %canary = alloca i32
  store i32 1820123563, i32* %canary
  %n_copy = alloca %struct.UInt64, align 1
  %q = alloca i32, align 4
  %outbuf.addr = alloca i8*, align 8
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct._IO_FILE* @fopen_output_safely.88(i8* %name, i8* %mode) #0 {
entry:
  %name.addr = alloca i8*, align 8
  %mode.addr = alloca i8*, align 8
  %retval = alloca %struct._IO_FILE*, align 8
  %fh = alloca i32, align 4
  %canary = alloca i32
  store i32 464445425, i32* %canary
  %fp = alloca %struct._IO_FILE*, align 8
  store i8* %name, i8** %name.addr, align 8
  store i8* %mode, i8** %mode.addr, align 8
  %0 = load i8*, i8** %name.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @copyFileName.89(i8* %to, i8* %from) #0 {
entry:
  %to.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1475862064, i32* %canary
  %from.addr = alloca i8*, align 8
  store i8* %to, i8** %to.addr, align 8
  store i8* %from, i8** %from.addr, align 8
  %0 = load i8*, i8** %from.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @uncompress.90(i8* %name) #0 {
entry:
  %canary = alloca i32
  store i32 1185196696, i32* %canary
  %statBuf = alloca %struct.stat, align 8
  %retVal = alloca i32, align 4
  %retVal168 = alloca i32, align 4
  %outStr = alloca %struct._IO_FILE*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @mapSuffix.91(i8* %name, i8* %oldSuffix, i8* %newSuffix) #0 {
entry:
  %retval = alloca i8, align 1
  %oldSuffix.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 9048863, i32* %canary
  %name.addr = alloca i8*, align 8
  %newSuffix.addr = alloca i8*, align 8
  store i8* %name, i8** %name.addr, align 8
  store i8* %oldSuffix, i8** %oldSuffix.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @uncompress.92(i8* %name) #0 {
entry:
  %n = alloca i32, align 4
  %retVal168 = alloca i32, align 4
  %canary = alloca i32
  store i32 1026112961, i32* %canary
  %cantGuess = alloca i8, align 1
  %name.addr = alloca i8*, align 8
  %outStr = alloca %struct._IO_FILE*, align 8
  %magicNumberOK = alloca i8, align 1
...
entry:
  %retval = alloca i8, align 1
  %canary = alloca i32
  store i32 1315494503, i32* %canary
  %i = alloca i32, align 4
  %name.addr = alloca i8*, align 8
  %statBuf = alloca %struct.stat, align 8
  store i8* %name, i8** %name.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @uncompressStream.94(%struct._IO_FILE* %zStream, %struct._IO_FILE* %stream) #0 {
entry:
  %nread = alloca i32, align 4
  %stream.addr = alloca %struct._IO_FILE*, align 8
  %unusedTmp = alloca i8*, align 8
  %canary = alloca i32
  store i32 2001383851, i32* %canary
  %unusedTmpV = alloca i8*, align 8
  %bzerr = alloca i32, align 4
  %obuf = alloca [5000 x i8], align 16
  %retval = alloca i8, align 1
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @uncompressStream.95(%struct._IO_FILE* %zStream, %struct._IO_FILE* %stream) #0 {
entry:
  %nUnused = alloca i32, align 4
  %bzerr_dummy = alloca i32, align 4
  %bzerr = alloca i32, align 4
  ...
  %unused = alloca [5000 x i8], align 16
  %canary = alloca i32
  store i32 310618204, i32* %canary
  %stream.addr = alloca %struct._IO_FILE*, align 8
  %retval = alloca i8, align 1
  %streamNo = alloca i32, align 4
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @compress.96(i8* %name) #0 {
entry:
  %name.addr = alloca i8*, align 8
  %statBuf = alloca %struct.stat, align 8
  %outStr = alloca %struct._IO_FILE*, align 8
  ...
  %inStr = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 1770510360, i32* %canary
  %n = alloca i32, align 4
  store i8* %name, i8** %name.addr, align 8
  store i8 0, i8* @deleteOutputOnInterrupt, align 1
  %0 = load i8*, i8** %name.addr, align 8
