; ModuleID = 'huffman.c.rand.4R2.bc'
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_BZ2_hbMakeCodeLengths.6, label %func_BZ2_hbMakeCodeLengths.8
}
...
func_BZ2_hbAssignCodes.10:                        ; preds = %ctrl0
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_BZ2_hbAssignCodes.10, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_BZ2_hbAssignCodes.11, label %func_BZ2_hbAssignCodes.12
}
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_BZ2_hbCreateDecodeTables.7, label %func_BZ2_hbCreateDecodeTables.9
}
...
entry:
  ...
  %canary = alloca i32
  store i32 874788700, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1638294110, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1411681738, i32* %canary
  %i = alloca i32, align 4
  %vec = alloca i32, align 4
  %minLen.addr = alloca i32, align 4
  %maxLen.addr = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1146843617, i32* %canary
  %limit.addr = alloca i32*, align 8
  %j = alloca i32, align 4
  %i = alloca i32, align 4
  %perm.addr = alloca i32*, align 8
...
entry:
  ...
  %minLen.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 989302268, i32* %canary
  %perm.addr = alloca i32*, align 8
  %limit.addr = alloca i32*, align 8
  %i = alloca i32, align 4
  %alphaSize.addr = alloca i32, align 4
...
entry:
  ...
  %alphaSize.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2018833954, i32* %canary
  %zz = alloca i32, align 4
  %tmp171 = alloca i32, align 4
  %yy93 = alloca i32, align 4
  %zz47 = alloca i32, align 4
...
while.end234:                                     ; preds = %if.then218
  %151 = load i32, i32* %canary
  %152 = icmp eq i32 %151, 2018833954
  br i1 %152, label %153, label %func_exit
...
entry:
  ...
  %maxLen.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1396770585, i32* %canary
  %perm.addr = alloca i32*, align 8
  store i32* %limit, i32** %limit.addr, align 8
  store i32* %base, i32** %base.addr, align 8
  store i32* %perm, i32** %perm.addr, align 8
...
entry:
  ...
  %alphaSize.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1990856380, i32* %canary
  %minLen.addr = alloca i32, align 4
  %vec = alloca i32, align 4
  %maxLen.addr = alloca i32, align 4
  store i32* %code, i32** %code.addr, align 8
...
entry:
  ...
  %length.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1319967616, i32* %canary
  %minLen.addr = alloca i32, align 4
  %maxLen.addr = alloca i32, align 4
  store i32* %code, i32** %code.addr, align 8
  store i8* %length, i8** %length.addr, align 8
...
entry:
  %vec = alloca i32, align 4
  %canary = alloca i32
  store i32 910282839, i32* %canary
  %length.addr = alloca i8*, align 8
  %code.addr = alloca i32*, align 8
  %i = alloca i32, align 4
  %minLen.addr = alloca i32, align 4
