...
func_ran.33:                                      ; preds = %ctrl1
  %5 = call double @ran.33()
  ret double %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_ran.8, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_ran.18, label %func_ran.33
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_spec_init.9, label %ctrl0

func_spec_init.9:                                 ; preds = %rand_bb
  %2 = call i32 @spec_init.9()
  ret i32 %2

func_spec_init.11:                                ; preds = %ctrl0
  %3 = call i32 @spec_init.11()
  ret i32 %3

func_spec_init.17:                                ; preds = %ctrl1
  %4 = call i32 @spec_init.17()
  ret i32 %4

func_spec_init.20:                                ; preds = %ctrl1
  %5 = call i32 @spec_init.20()
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_spec_init.11, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_spec_init.17, label %func_spec_init.20
}
...
func_spec_random_load.24:                         ; preds = %ctrl0
  %3 = call i32 @spec_random_load.24(i32 %fd)
  ret i32 %3
...
func_spec_random_load.38:                         ; preds = %ctrl1
  %5 = call i32 @spec_random_load.38(i32 %fd)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_spec_random_load.24, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_spec_random_load.37, label %func_spec_random_load.38
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_spec_load.25, label %ctrl0

func_spec_load.25:                                ; preds = %rand_bb
  %2 = call i32 @spec_load.25(i32 %num, i8* %filename, i32 %size)
  ret i32 %2

func_spec_load.29:                                ; preds = %ctrl0
  %3 = call i32 @spec_load.29(i32 %num, i8* %filename, i32 %size)
  ret i32 %3

func_spec_load.32:                                ; preds = %ctrl1
  %4 = call i32 @spec_load.32(i32 %num, i8* %filename, i32 %size)
  ret i32 %4

func_spec_load.35:                                ; preds = %ctrl1
  %5 = call i32 @spec_load.35(i32 %num, i8* %filename, i32 %size)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_spec_load.29, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_spec_load.32, label %func_spec_load.35
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_spec_read.4, label %ctrl0

func_spec_read.4:                                 ; preds = %rand_bb
  %2 = call i32 @spec_read.4(i32 %fd, i8* %buf, i32 %size)
  ret i32 %2

func_spec_read.5:                                 ; preds = %ctrl0
  %3 = call i32 @spec_read.5(i32 %fd, i8* %buf, i32 %size)
  ret i32 %3

func_spec_read.6:                                 ; preds = %ctrl1
  %4 = call i32 @spec_read.6(i32 %fd, i8* %buf, i32 %size)
  ret i32 %4

func_spec_read.28:                                ; preds = %ctrl1
  %5 = call i32 @spec_read.28(i32 %fd, i8* %buf, i32 %size)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_spec_read.5, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_spec_read.6, label %func_spec_read.28
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_spec_fread.15, label %ctrl0

func_spec_fread.15:                               ; preds = %rand_bb
  %2 = call i32 @spec_fread.15(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %2

func_spec_fread.27:                               ; preds = %ctrl0
  %3 = call i32 @spec_fread.27(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %3

func_spec_fread.41:                               ; preds = %ctrl1
  %4 = call i32 @spec_fread.41(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %4

func_spec_fread.42:                               ; preds = %ctrl1
  %5 = call i32 @spec_fread.42(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_spec_fread.27, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_spec_fread.41, label %func_spec_fread.42
}
...
func_spec_getc.3:                                 ; preds = %ctrl0
  %3 = call i32 @spec_getc.3(i32 %fd)
  ret i32 %3

func_spec_getc.19:                                ; preds = %ctrl1
  %4 = call i32 @spec_getc.19(i32 %fd)
  ret i32 %4

func_spec_getc.30:                                ; preds = %ctrl1
  %5 = call i32 @spec_getc.30(i32 %fd)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_spec_getc.3, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_spec_getc.19, label %func_spec_getc.30
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_spec_ungetc.10, label %ctrl0

func_spec_ungetc.10:                              ; preds = %rand_bb
  %2 = call i32 @spec_ungetc.10(i8 %ch, i32 %fd)
  ret i32 %2

func_spec_ungetc.16:                              ; preds = %ctrl0
  %3 = call i32 @spec_ungetc.16(i8 %ch, i32 %fd)
  ret i32 %3

func_spec_ungetc.31:                              ; preds = %ctrl1
  %4 = call i32 @spec_ungetc.31(i8 %ch, i32 %fd)
  ret i32 %4

func_spec_ungetc.40:                              ; preds = %ctrl1
  %5 = call i32 @spec_ungetc.40(i8 %ch, i32 %fd)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_spec_ungetc.16, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_spec_ungetc.31, label %func_spec_ungetc.40
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_spec_write.13, label %ctrl0

func_spec_write.13:                               ; preds = %rand_bb
  %2 = call i32 @spec_write.13(i32 %fd, i8* %buf, i32 %size)
  ret i32 %2

func_spec_write.21:                               ; preds = %ctrl0
  %3 = call i32 @spec_write.21(i32 %fd, i8* %buf, i32 %size)
  ret i32 %3

func_spec_write.34:                               ; preds = %ctrl1
  %4 = call i32 @spec_write.34(i32 %fd, i8* %buf, i32 %size)
  ret i32 %4

func_spec_write.39:                               ; preds = %ctrl1
  %5 = call i32 @spec_write.39(i32 %fd, i8* %buf, i32 %size)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_spec_write.21, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_spec_write.34, label %func_spec_write.39
}
...
func_spec_fwrite.23:                              ; preds = %ctrl0
  %3 = call i32 @spec_fwrite.23(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %3
...
func_spec_fwrite.36:                              ; preds = %ctrl1
  %5 = call i32 @spec_fwrite.36(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_spec_fwrite.23, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_spec_fwrite.26, label %func_spec_fwrite.36
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_spec_putc.12, label %func_spec_putc.14

func_spec_putc.12:                                ; preds = %rand_bb
  %2 = call i32 @spec_putc.12(i8 %ch, i32 %fd)
  ret i32 %2

func_spec_putc.14:                                ; preds = %rand_bb
  %3 = call i32 @spec_putc.14(i8 %ch, i32 %fd)
  ret i32 %3
}
...
entry:
  ...
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 881524387, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 2063318099, i32* %canary
...
entry:
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1887864187, i32* %canary
  %rc = alloca i32, align 4
  %retval = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  store i32 0, i32* %rc, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_read.4(i32 %fd, i8* %buf, i32 %size) #0 {
entry:
  %rc = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1157973474, i32* %canary
  %retval = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_read.5(i32 %fd, i8* %buf, i32 %size) #0 {
entry:
  %size.addr = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  %rc = alloca i32, align 4
  %canary = alloca i32
  store i32 1865624111, i32* %canary
  %buf.addr = alloca i8*, align 8
  %retval = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  store i8* %buf, i8** %buf.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1970821931, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_init.9() #0 {
entry:
  %limit = alloca i32, align 4
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 438300450, i32* %canary
  %j = alloca i32, align 4
  %0 = load i32, i32* @dbglvl, align 4
...
entry:
  ...
  %rc = alloca i32, align 4
  %canary = alloca i32
  store i32 396731373, i32* %canary
  %fd.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_init.11() #0 {
entry:
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1575727592, i32* %canary
  %limit = alloca i32, align 4
  %i = alloca i32, align 4
  %0 = load i32, i32* @dbglvl, align 4
  %cmp = icmp slt i32 3, %0
...
entry:
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2068225509, i32* %canary
  %ch.addr = alloca i8, align 1
  store i8 %ch, i8* %ch.addr, align 1
  store i32 %fd, i32* %fd.addr, align 4
  %0 = load i32, i32* @dbglvl, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_write.13(i32 %fd, i8* %buf, i32 %size) #0 {
entry:
  %buf.addr = alloca i8*, align 8
  %size.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 39700862, i32* %canary
  %fd.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_putc.14(i8 zeroext %ch, i32 %fd) #0 {
entry:
  %ch.addr = alloca i8, align 1
  %canary = alloca i32
  store i32 1029153916, i32* %canary
  %fd.addr = alloca i32, align 4
  store i8 %ch, i8* %ch.addr, align 1
  store i32 %fd, i32* %fd.addr, align 4
  %0 = load i32, i32* @dbglvl, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_fread.15(i8* %buf, i32 %size, i32 %num, i32 %fd) #0 {
entry:
  %rc = alloca i32, align 4
  %canary = alloca i32
  store i32 1449257678, i32* %canary
  %buf.addr = alloca i8*, align 8
  %size.addr = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  %retval = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_ungetc.16(i8 zeroext %ch, i32 %fd) #0 {
entry:
  %canary = alloca i32
  store i32 2030083190, i32* %canary
  %ch.addr = alloca i8, align 1
  %fd.addr = alloca i32, align 4
  %rc = alloca i32, align 4
  store i8 %ch, i8* %ch.addr, align 1
...
entry:
  ...
  %hi = alloca i64, align 8
  %canary = alloca i32
  store i32 1444326485, i32* %canary
  %test = alloca i64, align 8
  %0 = load i64, i64* @seedi, align 8
  %div = sdiv i64 %0, 127773
  store i64 %div, i64* %hi, align 8
...
entry:
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 757067389, i32* %canary
  %retval = alloca i32, align 4
  %rc = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  store i32 0, i32* %rc, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_init.20() #0 {
entry:
  %limit = alloca i32, align 4
  %canary = alloca i32
  store i32 285499124, i32* %canary
  %j = alloca i32, align 4
  %i = alloca i32, align 4
  %0 = load i32, i32* @dbglvl, align 4
  %cmp = icmp slt i32 3, %0
...
entry:
  %canary = alloca i32
  store i32 378906768, i32* %canary
  %size.addr = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  store i32 %fd, i32* %fd.addr, align 4
...
entry:
  %size.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2051063233, i32* %canary
  %fd.addr = alloca i32, align 4
  %num.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  store i8* %buf, i8** %buf.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_fwrite.23(i8* %buf, i32 %size, i32 %num, i32 %fd) #0 {
entry:
  %canary = alloca i32
  store i32 992857728, i32* %canary
  %buf.addr = alloca i8*, align 8
  %size.addr = alloca i32, align 4
  %num.addr = alloca i32, align 4
  %fd.addr = alloca i32, align 4
...
entry:
  ...
  %random_text = alloca [32 x [131072 x i8]], align 16
  %canary = alloca i32
  store i32 1972160173, i32* %canary
  %j = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  %0 = load i32, i32* @dbglvl, align 4
  %cmp = icmp slt i32 4, %0
...
entry:
  ...
  %rc = alloca i32, align 4
  %canary = alloca i32
  store i32 1747037509, i32* %canary
...
entry:
  ...
  %buf.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1467159441, i32* %canary
  %fd.addr = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
  store i32 %num, i32* %num.addr, align 4
...
entry:
  ...
  %size.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1438773228, i32* %canary
  %retval = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %fd.addr = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
...
entry:
  ...
  %buf.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 665698882, i32* %canary
  %size.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_load.29(i32 %num, i8* %filename, i32 %size) #0 {
entry:
  %fd = alloca i32, align 4
  %canary = alloca i32
  store i32 998071865, i32* %canary
  %tmp = alloca i32, align 4
  %size.addr = alloca i32, align 4
  %num.addr = alloca i32, align 4
  %filename.addr = alloca i8*, align 8
...
entry:
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 552950912, i32* %canary
  %fd.addr = alloca i32, align 4
  %rc = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  store i32 0, i32* %rc, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_ungetc.31(i8 zeroext %ch, i32 %fd) #0 {
entry:
  %rc = alloca i32, align 4
  %canary = alloca i32
  store i32 2092974966, i32* %canary
  %fd.addr = alloca i32, align 4
  %ch.addr = alloca i8, align 1
  store i8 %ch, i8* %ch.addr, align 1
  store i32 %fd, i32* %fd.addr, align 4
...
entry:
  ...
  %size.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1255573563, i32* %canary
  %tmp = alloca i32, align 4
  %rc = alloca i32, align 4
  %num.addr = alloca i32, align 4
  %fd = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local double @ran.33() #0 {
entry:
  %canary = alloca i32
  store i32 1159221645, i32* %canary
  %lo = alloca i64, align 8
  %test = alloca i64, align 8
  %hi = alloca i64, align 8
  %0 = load i64, i64* @seedi, align 8
...
entry:
  ...
  %size.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1085975754, i32* %canary
  %buf.addr = alloca i8*, align 8
  store i32 %fd, i32* %fd.addr, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
...
entry:
  ...
  %filename.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 293387055, i32* %canary
  %fd = alloca i32, align 4
  %size.addr = alloca i32, align 4
  %i = alloca i32, align 4
  store i32 %num, i32* %num.addr, align 4
...
entry:
  ...
  %size.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1004063014, i32* %canary
  %num.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 1810260502, i32* %canary
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  %random_text = alloca [32 x [131072 x i8]], align 16
...
entry:
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1768858879, i32* %canary
  %buf.addr = alloca i8*, align 8
  %size.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  store i8* %buf, i8** %buf.addr, align 8
...
entry:
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 960452136, i32* %canary
  %rc = alloca i32, align 4
  %ch.addr = alloca i8, align 1
  store i8 %ch, i8* %ch.addr, align 1
  store i32 %fd, i32* %fd.addr, align 4
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 676664395, i32* %canary
  %buf.addr = alloca i8*, align 8
  %fd.addr = alloca i32, align 4
  %size.addr = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 621559448, i32* %canary
  %rc = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
  store i32 %num, i32* %num.addr, align 4
