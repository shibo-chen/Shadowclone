; ModuleID = 'huffman.c.rand.4P1.bc'
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_BZ2_hbMakeCodeLengths.7, label %func_BZ2_hbMakeCodeLengths.11
}
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_BZ2_hbAssignCodes.10, label %func_BZ2_hbAssignCodes.12
}
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_BZ2_hbCreateDecodeTables.8, label %func_BZ2_hbCreateDecodeTables.9
}
...
entry:
  ...
  %canary = alloca i32
  store i32 1203426710, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1158172406, i32* %canary
  %length.addr = alloca i8*, align 8
...
entry:
  ...
  %canary = alloca i32
  store i32 1340298743, i32* %canary
...
while.end234:                                     ; preds = %if.then218
  ...
  %152 = icmp eq i32 %151, 1340298743
...
entry:
  ...
  %tmp171 = alloca i32, align 4
  %canary = alloca i32
  store i32 140837266, i32* %canary
  %freq.addr = alloca i32*, align 8
  %n1 = alloca i32, align 4
  %k = alloca i32, align 4
  %i = alloca i32, align 4
...
entry:
  ...
  %code.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 180004419, i32* %canary
  %i = alloca i32, align 4
  store i32* %code, i32** %code.addr, align 8
  store i8* %length, i8** %length.addr, align 8
  store i32 %minLen, i32* %minLen.addr, align 4
...
entry:
  ...
  %alphaSize.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1999595344, i32* %canary
  %minLen.addr = alloca i32, align 4
  %perm.addr = alloca i32*, align 8
  %pp = alloca i32, align 4
  %base.addr = alloca i32*, align 8
...
entry:
  ...
  %yy = alloca i32, align 4
  %canary = alloca i32
  store i32 183981437, i32* %canary
  %heap = alloca [260 x i32], align 16
  %weight = alloca [516 x i32], align 16
  %n1 = alloca i32, align 4
  %zz92 = alloca i32, align 4
...
entry:
  ...
  %alphaSize.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1809517261, i32* %canary
  %pp = alloca i32, align 4
  %i = alloca i32, align 4
  %limit.addr = alloca i32*, align 8
  %minLen.addr = alloca i32, align 4
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1721583784, i32* %canary
  %maxLen.addr = alloca i32, align 4
  %perm.addr = alloca i32*, align 8
  %alphaSize.addr = alloca i32, align 4
  %base.addr = alloca i32*, align 8
...
entry:
  ...
  %alphaSize.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1078979693, i32* %canary
  %vec = alloca i32, align 4
  %code.addr = alloca i32*, align 8
  %n = alloca i32, align 4
  store i32* %code, i32** %code.addr, align 8
...
entry:
  ...
  %yy = alloca i32, align 4
  %canary = alloca i32
  store i32 1337859729, i32* %canary
  %n1 = alloca i32, align 4
  %tooLong = alloca i8, align 1
  %freq.addr = alloca i32*, align 8
  %zz = alloca i32, align 4
...
while.end234:                                     ; preds = %if.then218
  %151 = load i32, i32* %canary
  %152 = icmp eq i32 %151, 1337859729
  br i1 %152, label %153, label %func_exit
...
entry:
  ...
  %length.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1133999793, i32* %canary
  %vec = alloca i32, align 4
  %minLen.addr = alloca i32, align 4
  %n = alloca i32, align 4
  %alphaSize.addr = alloca i32, align 4
