; ModuleID = 'huffman.c.rand.4R3.bc'
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_BZ2_hbMakeCodeLengths.8, label %func_BZ2_hbMakeCodeLengths.12
}
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_BZ2_hbAssignCodes.9, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_BZ2_hbAssignCodes.10, label %func_BZ2_hbAssignCodes.11
}
...
func_BZ2_hbCreateDecodeTables.5:                  ; preds = %ctrl1
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_BZ2_hbCreateDecodeTables.5, label %func_BZ2_hbCreateDecodeTables.6
}
...
entry:
  ...
  %canary = alloca i32
  store i32 378837432, i32* %canary
...
entry:
  ...
  %minLen.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 710582124, i32* %canary
  %maxLen.addr = alloca i32, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 1333296838, i32* %canary
...
while.end234:                                     ; preds = %if.then218
  ...
  %152 = icmp eq i32 %151, 1333296838
...
entry:
  ...
  %vec = alloca i32, align 4
  %canary = alloca i32
  store i32 1931815247, i32* %canary
  %alphaSize.addr = alloca i32, align 4
  store i32* %limit, i32** %limit.addr, align 8
  store i32* %base, i32** %base.addr, align 8
  store i32* %perm, i32** %perm.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 885981265, i32* %canary
  %alphaSize.addr = alloca i32, align 4
  %pp = alloca i32, align 4
  %vec = alloca i32, align 4
  %maxLen.addr = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 2105905745, i32* %canary
  %length.addr = alloca i8*, align 8
  %j = alloca i32, align 4
  %minLen.addr = alloca i32, align 4
  %maxLen.addr = alloca i32, align 4
...
entry:
  ...
  %parent = alloca [516 x i32], align 16
  %canary = alloca i32
  store i32 2083190023, i32* %canary
  %k = alloca i32, align 4
  %tmp = alloca i32, align 4
  %zz = alloca i32, align 4
  %i = alloca i32, align 4
...
while.end234:                                     ; preds = %if.then218
  %151 = load i32, i32* %canary
  %152 = icmp eq i32 %151, 2083190023
  br i1 %152, label %153, label %func_exit
...
entry:
  ...
  %nNodes = alloca i32, align 4
  %canary = alloca i32
  store i32 407205745, i32* %canary
  %i = alloca i32, align 4
  %nHeap = alloca i32, align 4
  %parent = alloca [516 x i32], align 16
  %tmp48 = alloca i32, align 4
...
entry:
  %minLen.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1924214472, i32* %canary
  %maxLen.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %vec = alloca i32, align 4
  %alphaSize.addr = alloca i32, align 4
...
entry:
  ...
  %length.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1065022491, i32* %canary
  %i = alloca i32, align 4
  %code.addr = alloca i32*, align 8
  %maxLen.addr = alloca i32, align 4
  %minLen.addr = alloca i32, align 4
...
entry:
  ...
  %minLen.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 544012427, i32* %canary
  %i = alloca i32, align 4
  %length.addr = alloca i8*, align 8
  %maxLen.addr = alloca i32, align 4
  %code.addr = alloca i32*, align 8
...
entry:
  ...
  %yy93 = alloca i32, align 4
  %canary = alloca i32
  store i32 2076395487, i32* %canary
  %nHeap = alloca i32, align 4
  %yy = alloca i32, align 4
  %zz = alloca i32, align 4
  %tmp171 = alloca i32, align 4
...
while.end234:                                     ; preds = %if.then218
  %151 = load i32, i32* %canary
  %152 = icmp eq i32 %151, 2076395487
  br i1 %152, label %153, label %func_exit
