; ModuleID = 'huffman.c.rand.8R1.bc'
...
func_BZ2_hbMakeCodeLengths.13:                    ; preds = %ctrl4
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_BZ2_hbMakeCodeLengths.3, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_BZ2_hbMakeCodeLengths.4, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_BZ2_hbMakeCodeLengths.5, label %ctrl3
...
ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_BZ2_hbMakeCodeLengths.13, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_BZ2_hbMakeCodeLengths.17, label %func_BZ2_hbMakeCodeLengths.20
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_BZ2_hbAssignCodes.9, label %ctrl0

func_BZ2_hbAssignCodes.9:                         ; preds = %rand_bb
  call void @BZ2_hbAssignCodes.9(i32* %code, i8* %length, i32 %minLen, i32 %maxLen, i32 %alphaSize)
  ret void

func_BZ2_hbAssignCodes.14:                        ; preds = %ctrl0
...
func_BZ2_hbAssignCodes.19:                        ; preds = %ctrl3
  call void @BZ2_hbAssignCodes.19(i32* %code, i8* %length, i32 %minLen, i32 %maxLen, i32 %alphaSize)
  ret void
...
func_BZ2_hbAssignCodes.23:                        ; preds = %ctrl5
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_BZ2_hbAssignCodes.14, label %ctrl1
...
ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_BZ2_hbAssignCodes.19, label %ctrl4
...
ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_BZ2_hbAssignCodes.23, label %func_BZ2_hbAssignCodes.24
}
...
func_BZ2_hbCreateDecodeTables.6:                  ; preds = %ctrl0
  call void @BZ2_hbCreateDecodeTables.6(i32* %limit, i32* %base, i32* %perm, i8* %length, i32 %minLen, i32 %maxLen, i32 %alphaSize)
  ret void

func_BZ2_hbCreateDecodeTables.7:                  ; preds = %ctrl1
  call void @BZ2_hbCreateDecodeTables.7(i32* %limit, i32* %base, i32* %perm, i8* %length, i32 %minLen, i32 %maxLen, i32 %alphaSize)
  ret void

func_BZ2_hbCreateDecodeTables.8:                  ; preds = %ctrl2
  call void @BZ2_hbCreateDecodeTables.8(i32* %limit, i32* %base, i32* %perm, i8* %length, i32 %minLen, i32 %maxLen, i32 %alphaSize)
  ret void

func_BZ2_hbCreateDecodeTables.10:                 ; preds = %ctrl3
  call void @BZ2_hbCreateDecodeTables.10(i32* %limit, i32* %base, i32* %perm, i8* %length, i32 %minLen, i32 %maxLen, i32 %alphaSize)
  ret void

func_BZ2_hbCreateDecodeTables.12:                 ; preds = %ctrl4
...
func_BZ2_hbCreateDecodeTables.22:                 ; preds = %ctrl5
  call void @BZ2_hbCreateDecodeTables.22(i32* %limit, i32* %base, i32* %perm, i8* %length, i32 %minLen, i32 %maxLen, i32 %alphaSize)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_BZ2_hbCreateDecodeTables.6, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_BZ2_hbCreateDecodeTables.7, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_BZ2_hbCreateDecodeTables.8, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_BZ2_hbCreateDecodeTables.10, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_BZ2_hbCreateDecodeTables.12, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_BZ2_hbCreateDecodeTables.15, label %func_BZ2_hbCreateDecodeTables.22
}
...
entry:
  ...
  %canary = alloca i32
  store i32 423126622, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1322051673, i32* %canary
...
while.end234:                                     ; preds = %if.then218
  ...
  %152 = icmp eq i32 %151, 1322051673
...
entry:
  ...
  %n2 = alloca i32, align 4
  %canary = alloca i32
  store i32 1508429059, i32* %canary
  %maxLen.addr = alloca i32, align 4
  %tooLong = alloca i8, align 1
  %i = alloca i32, align 4
  %n1 = alloca i32, align 4
...
while.end234:                                     ; preds = %if.then218
  %151 = load i32, i32* %canary
  %152 = icmp eq i32 %151, 1508429059
  br i1 %152, label %153, label %func_exit
...
entry:
  ...
  %len.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1520419578, i32* %canary
  %yy93 = alloca i32, align 4
  %n2 = alloca i32, align 4
  store i8* %len, i8** %len.addr, align 8
  store i32* %freq, i32** %freq.addr, align 8
...
while.end234:                                     ; preds = %if.then218
  %151 = load i32, i32* %canary
  %152 = icmp eq i32 %151, 1520419578
  br i1 %152, label %153, label %func_exit
...
entry:
  %canary = alloca i32
  store i32 177562566, i32* %canary
  %zz47 = alloca i32, align 4
  %j = alloca i32, align 4
  %tmp = alloca i32, align 4
  %zz170 = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @BZ2_hbCreateDecodeTables.6(i32* %limit, i32* %base, i32* %perm, i8* %length, i32 %minLen, i32 %maxLen, i32 %alphaSize) #0 {
entry:
  %vec = alloca i32, align 4
  %alphaSize.addr = alloca i32, align 4
  %base.addr = alloca i32*, align 8
  ...
  %length.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 784371810, i32* %canary
  %minLen.addr = alloca i32, align 4
  %j = alloca i32, align 4
  store i32* %limit, i32** %limit.addr, align 8
  store i32* %base, i32** %base.addr, align 8
...
entry:
  ...
  %minLen.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 585921290, i32* %canary
  %i = alloca i32, align 4
  %base.addr = alloca i32*, align 8
  %alphaSize.addr = alloca i32, align 4
  %perm.addr = alloca i32*, align 8
...
entry:
  ...
  %pp = alloca i32, align 4
  %canary = alloca i32
  store i32 2084426185, i32* %canary
  %limit.addr = alloca i32*, align 8
  %vec = alloca i32, align 4
  %base.addr = alloca i32*, align 8
  %minLen.addr = alloca i32, align 4
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 764972121, i32* %canary
  %vec = alloca i32, align 4
  %minLen.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @BZ2_hbCreateDecodeTables.10(i32* %limit, i32* %base, i32* %perm, i8* %length, i32 %minLen, i32 %maxLen, i32 %alphaSize) #0 {
entry:
  %alphaSize.addr = alloca i32, align 4
  %base.addr = alloca i32*, align 8
  %limit.addr = alloca i32*, align 8
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 489416376, i32* %canary
  %i = alloca i32, align 4
  %minLen.addr = alloca i32, align 4
  store i32* %limit, i32** %limit.addr, align 8
  store i32* %base, i32** %base.addr, align 8
...
entry:
  ...
  %n1 = alloca i32, align 4
  %canary = alloca i32
  store i32 754970565, i32* %canary
  %tmp94 = alloca i32, align 4
  %zz47 = alloca i32, align 4
  %zz92 = alloca i32, align 4
  %j = alloca i32, align 4
...
entry:
  ...
  %vec = alloca i32, align 4
  %canary = alloca i32
  store i32 1555427510, i32* %canary
  %perm.addr = alloca i32*, align 8
  %alphaSize.addr = alloca i32, align 4
  %pp = alloca i32, align 4
  %maxLen.addr = alloca i32, align 4
...
entry:
  ...
  %zz92 = alloca i32, align 4
  %canary = alloca i32
  store i32 1140422115, i32* %canary
  %weight = alloca [516 x i32], align 16
  %tmp = alloca i32, align 4
  %k = alloca i32, align 4
  %tmp94 = alloca i32, align 4
...
while.end234:                                     ; preds = %if.then218
  %151 = load i32, i32* %canary
  %152 = icmp eq i32 %151, 1140422115
  br i1 %152, label %153, label %func_exit
...
entry:
  %canary = alloca i32
  store i32 341646699, i32* %canary
  %n = alloca i32, align 4
  %alphaSize.addr = alloca i32, align 4
  %code.addr = alloca i32*, align 8
  %vec = alloca i32, align 4
...
entry:
  ...
  %length.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 101319872, i32* %canary
  %base.addr = alloca i32*, align 8
  %alphaSize.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %minLen.addr = alloca i32, align 4
...
entry:
  ...
  %n = alloca i32, align 4
  %canary = alloca i32
  store i32 1130618842, i32* %canary
  %length.addr = alloca i8*, align 8
  %maxLen.addr = alloca i32, align 4
  %code.addr = alloca i32*, align 8
  %alphaSize.addr = alloca i32, align 4
...
entry:
  ...
  %nNodes = alloca i32, align 4
  %canary = alloca i32
  store i32 1170128432, i32* %canary
  %zz170 = alloca i32, align 4
  %j = alloca i32, align 4
  %tmp94 = alloca i32, align 4
  %parent = alloca [516 x i32], align 16
...
while.end234:                                     ; preds = %if.then218
  %151 = load i32, i32* %canary
  %152 = icmp eq i32 %151, 1170128432
  br i1 %152, label %153, label %func_exit
...
entry:
  ...
  %code.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 990136835, i32* %canary
  %alphaSize.addr = alloca i32, align 4
  %minLen.addr = alloca i32, align 4
  %maxLen.addr = alloca i32, align 4
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @BZ2_hbAssignCodes.19(i32* %code, i8* %length, i32 %minLen, i32 %maxLen, i32 %alphaSize) #0 {
entry:
  %alphaSize.addr = alloca i32, align 4
  %n = alloca i32, align 4
  %maxLen.addr = alloca i32, align 4
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1051453482, i32* %canary
  %length.addr = alloca i8*, align 8
  %code.addr = alloca i32*, align 8
  %vec = alloca i32, align 4
  store i32* %code, i32** %code.addr, align 8
...
entry:
  ...
  %nHeap = alloca i32, align 4
  %canary = alloca i32
  store i32 379969282, i32* %canary
  %n2 = alloca i32, align 4
  %tmp48 = alloca i32, align 4
  %tmp171 = alloca i32, align 4
  %freq.addr = alloca i32*, align 8
...
entry:
  ...
  %n = alloca i32, align 4
  %canary = alloca i32
  store i32 2061614315, i32* %canary
  %alphaSize.addr = alloca i32, align 4
  store i32* %code, i32** %code.addr, align 8
  store i8* %length, i8** %length.addr, align 8
  store i32 %minLen, i32* %minLen.addr, align 4
...
entry:
  ...
  %pp = alloca i32, align 4
  %canary = alloca i32
  store i32 328810278, i32* %canary
  %limit.addr = alloca i32*, align 8
  %i = alloca i32, align 4
  %maxLen.addr = alloca i32, align 4
  %vec = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 318094962, i32* %canary
  %alphaSize.addr = alloca i32, align 4
  %vec = alloca i32, align 4
  %length.addr = alloca i8*, align 8
  %maxLen.addr = alloca i32, align 4
...
entry:
  ...
  %minLen.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1756063233, i32* %canary
  %code.addr = alloca i32*, align 8
  %maxLen.addr = alloca i32, align 4
  store i32* %code, i32** %code.addr, align 8
  store i8* %length, i8** %length.addr, align 8
