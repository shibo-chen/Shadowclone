; ModuleID = 'huffman.c.rand.16R2.bc'
...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_BZ2_hbMakeCodeLengths.3, label %ctrl0

func_BZ2_hbMakeCodeLengths.3:                     ; preds = %rand_bb
  call void @BZ2_hbMakeCodeLengths.3(i8* %len, i32* %freq, i32 %alphaSize, i32 %maxLen)
  ret void

func_BZ2_hbMakeCodeLengths.5:                     ; preds = %ctrl0
  call void @BZ2_hbMakeCodeLengths.5(i8* %len, i32* %freq, i32 %alphaSize, i32 %maxLen)
  ret void

func_BZ2_hbMakeCodeLengths.6:                     ; preds = %ctrl1
  call void @BZ2_hbMakeCodeLengths.6(i8* %len, i32* %freq, i32 %alphaSize, i32 %maxLen)
  ret void

func_BZ2_hbMakeCodeLengths.8:                     ; preds = %ctrl2
  call void @BZ2_hbMakeCodeLengths.8(i8* %len, i32* %freq, i32 %alphaSize, i32 %maxLen)
  ret void

func_BZ2_hbMakeCodeLengths.9:                     ; preds = %ctrl3
  call void @BZ2_hbMakeCodeLengths.9(i8* %len, i32* %freq, i32 %alphaSize, i32 %maxLen)
  ret void

func_BZ2_hbMakeCodeLengths.10:                    ; preds = %ctrl4
  call void @BZ2_hbMakeCodeLengths.10(i8* %len, i32* %freq, i32 %alphaSize, i32 %maxLen)
  ret void

func_BZ2_hbMakeCodeLengths.12:                    ; preds = %ctrl5
  call void @BZ2_hbMakeCodeLengths.12(i8* %len, i32* %freq, i32 %alphaSize, i32 %maxLen)
  ret void

func_BZ2_hbMakeCodeLengths.13:                    ; preds = %ctrl6
  call void @BZ2_hbMakeCodeLengths.13(i8* %len, i32* %freq, i32 %alphaSize, i32 %maxLen)
  ret void

func_BZ2_hbMakeCodeLengths.17:                    ; preds = %ctrl7
  call void @BZ2_hbMakeCodeLengths.17(i8* %len, i32* %freq, i32 %alphaSize, i32 %maxLen)
  ret void

func_BZ2_hbMakeCodeLengths.18:                    ; preds = %ctrl8
  call void @BZ2_hbMakeCodeLengths.18(i8* %len, i32* %freq, i32 %alphaSize, i32 %maxLen)
  ret void

func_BZ2_hbMakeCodeLengths.27:                    ; preds = %ctrl9
  call void @BZ2_hbMakeCodeLengths.27(i8* %len, i32* %freq, i32 %alphaSize, i32 %maxLen)
  ret void

func_BZ2_hbMakeCodeLengths.28:                    ; preds = %ctrl10
  call void @BZ2_hbMakeCodeLengths.28(i8* %len, i32* %freq, i32 %alphaSize, i32 %maxLen)
  ret void

func_BZ2_hbMakeCodeLengths.29:                    ; preds = %ctrl11
  call void @BZ2_hbMakeCodeLengths.29(i8* %len, i32* %freq, i32 %alphaSize, i32 %maxLen)
  ret void

func_BZ2_hbMakeCodeLengths.31:                    ; preds = %ctrl12
  call void @BZ2_hbMakeCodeLengths.31(i8* %len, i32* %freq, i32 %alphaSize, i32 %maxLen)
  ret void

func_BZ2_hbMakeCodeLengths.34:                    ; preds = %ctrl13
  call void @BZ2_hbMakeCodeLengths.34(i8* %len, i32* %freq, i32 %alphaSize, i32 %maxLen)
  ret void

func_BZ2_hbMakeCodeLengths.36:                    ; preds = %ctrl13
  call void @BZ2_hbMakeCodeLengths.36(i8* %len, i32* %freq, i32 %alphaSize, i32 %maxLen)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_BZ2_hbMakeCodeLengths.5, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_BZ2_hbMakeCodeLengths.6, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_BZ2_hbMakeCodeLengths.8, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_BZ2_hbMakeCodeLengths.9, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_BZ2_hbMakeCodeLengths.10, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_BZ2_hbMakeCodeLengths.12, label %ctrl6

ctrl6:                                            ; preds = %ctrl5
  %8 = icmp eq i32 %0, 7
  br i1 %8, label %func_BZ2_hbMakeCodeLengths.13, label %ctrl7

ctrl7:                                            ; preds = %ctrl6
  %9 = icmp eq i32 %0, 8
  br i1 %9, label %func_BZ2_hbMakeCodeLengths.17, label %ctrl8

ctrl8:                                            ; preds = %ctrl7
  %10 = icmp eq i32 %0, 9
  br i1 %10, label %func_BZ2_hbMakeCodeLengths.18, label %ctrl9

ctrl9:                                            ; preds = %ctrl8
  %11 = icmp eq i32 %0, 10
  br i1 %11, label %func_BZ2_hbMakeCodeLengths.27, label %ctrl10

ctrl10:                                           ; preds = %ctrl9
  %12 = icmp eq i32 %0, 11
  br i1 %12, label %func_BZ2_hbMakeCodeLengths.28, label %ctrl11

ctrl11:                                           ; preds = %ctrl10
  %13 = icmp eq i32 %0, 12
  br i1 %13, label %func_BZ2_hbMakeCodeLengths.29, label %ctrl12

ctrl12:                                           ; preds = %ctrl11
  %14 = icmp eq i32 %0, 13
  br i1 %14, label %func_BZ2_hbMakeCodeLengths.31, label %ctrl13

ctrl13:                                           ; preds = %ctrl12
  %15 = icmp eq i32 %0, 14
  br i1 %15, label %func_BZ2_hbMakeCodeLengths.34, label %func_BZ2_hbMakeCodeLengths.36
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_BZ2_hbAssignCodes.1, label %ctrl0

func_BZ2_hbAssignCodes.1:                         ; preds = %rand_bb
  call void @BZ2_hbAssignCodes.1(i32* %code, i8* %length, i32 %minLen, i32 %maxLen, i32 %alphaSize)
  ret void

func_BZ2_hbAssignCodes.7:                         ; preds = %ctrl0
  call void @BZ2_hbAssignCodes.7(i32* %code, i8* %length, i32 %minLen, i32 %maxLen, i32 %alphaSize)
  ret void

func_BZ2_hbAssignCodes.11:                        ; preds = %ctrl1
  call void @BZ2_hbAssignCodes.11(i32* %code, i8* %length, i32 %minLen, i32 %maxLen, i32 %alphaSize)
  ret void

func_BZ2_hbAssignCodes.14:                        ; preds = %ctrl2
  call void @BZ2_hbAssignCodes.14(i32* %code, i8* %length, i32 %minLen, i32 %maxLen, i32 %alphaSize)
  ret void

func_BZ2_hbAssignCodes.15:                        ; preds = %ctrl3
  call void @BZ2_hbAssignCodes.15(i32* %code, i8* %length, i32 %minLen, i32 %maxLen, i32 %alphaSize)
  ret void

func_BZ2_hbAssignCodes.20:                        ; preds = %ctrl4
  call void @BZ2_hbAssignCodes.20(i32* %code, i8* %length, i32 %minLen, i32 %maxLen, i32 %alphaSize)
  ret void

func_BZ2_hbAssignCodes.22:                        ; preds = %ctrl5
  call void @BZ2_hbAssignCodes.22(i32* %code, i8* %length, i32 %minLen, i32 %maxLen, i32 %alphaSize)
  ret void

func_BZ2_hbAssignCodes.25:                        ; preds = %ctrl6
  call void @BZ2_hbAssignCodes.25(i32* %code, i8* %length, i32 %minLen, i32 %maxLen, i32 %alphaSize)
  ret void

func_BZ2_hbAssignCodes.26:                        ; preds = %ctrl7
  call void @BZ2_hbAssignCodes.26(i32* %code, i8* %length, i32 %minLen, i32 %maxLen, i32 %alphaSize)
  ret void

func_BZ2_hbAssignCodes.32:                        ; preds = %ctrl8
  call void @BZ2_hbAssignCodes.32(i32* %code, i8* %length, i32 %minLen, i32 %maxLen, i32 %alphaSize)
  ret void

func_BZ2_hbAssignCodes.37:                        ; preds = %ctrl9
  call void @BZ2_hbAssignCodes.37(i32* %code, i8* %length, i32 %minLen, i32 %maxLen, i32 %alphaSize)
  ret void

func_BZ2_hbAssignCodes.38:                        ; preds = %ctrl10
  call void @BZ2_hbAssignCodes.38(i32* %code, i8* %length, i32 %minLen, i32 %maxLen, i32 %alphaSize)
  ret void

func_BZ2_hbAssignCodes.41:                        ; preds = %ctrl11
  call void @BZ2_hbAssignCodes.41(i32* %code, i8* %length, i32 %minLen, i32 %maxLen, i32 %alphaSize)
  ret void

func_BZ2_hbAssignCodes.45:                        ; preds = %ctrl12
  call void @BZ2_hbAssignCodes.45(i32* %code, i8* %length, i32 %minLen, i32 %maxLen, i32 %alphaSize)
  ret void

func_BZ2_hbAssignCodes.46:                        ; preds = %ctrl13
  call void @BZ2_hbAssignCodes.46(i32* %code, i8* %length, i32 %minLen, i32 %maxLen, i32 %alphaSize)
  ret void

func_BZ2_hbAssignCodes.47:                        ; preds = %ctrl13
  call void @BZ2_hbAssignCodes.47(i32* %code, i8* %length, i32 %minLen, i32 %maxLen, i32 %alphaSize)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_BZ2_hbAssignCodes.7, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_BZ2_hbAssignCodes.11, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_BZ2_hbAssignCodes.14, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_BZ2_hbAssignCodes.15, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_BZ2_hbAssignCodes.20, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_BZ2_hbAssignCodes.22, label %ctrl6

ctrl6:                                            ; preds = %ctrl5
  %8 = icmp eq i32 %0, 7
  br i1 %8, label %func_BZ2_hbAssignCodes.25, label %ctrl7

ctrl7:                                            ; preds = %ctrl6
  %9 = icmp eq i32 %0, 8
  br i1 %9, label %func_BZ2_hbAssignCodes.26, label %ctrl8

ctrl8:                                            ; preds = %ctrl7
  %10 = icmp eq i32 %0, 9
  br i1 %10, label %func_BZ2_hbAssignCodes.32, label %ctrl9

ctrl9:                                            ; preds = %ctrl8
  %11 = icmp eq i32 %0, 10
  br i1 %11, label %func_BZ2_hbAssignCodes.37, label %ctrl10

ctrl10:                                           ; preds = %ctrl9
  %12 = icmp eq i32 %0, 11
  br i1 %12, label %func_BZ2_hbAssignCodes.38, label %ctrl11

ctrl11:                                           ; preds = %ctrl10
  %13 = icmp eq i32 %0, 12
  br i1 %13, label %func_BZ2_hbAssignCodes.41, label %ctrl12

ctrl12:                                           ; preds = %ctrl11
  %14 = icmp eq i32 %0, 13
  br i1 %14, label %func_BZ2_hbAssignCodes.45, label %ctrl13

ctrl13:                                           ; preds = %ctrl12
  %15 = icmp eq i32 %0, 14
  br i1 %15, label %func_BZ2_hbAssignCodes.46, label %func_BZ2_hbAssignCodes.47
}
...
func_BZ2_hbCreateDecodeTables.16:                 ; preds = %ctrl1
  call void @BZ2_hbCreateDecodeTables.16(i32* %limit, i32* %base, i32* %perm, i8* %length, i32 %minLen, i32 %maxLen, i32 %alphaSize)
  ret void

func_BZ2_hbCreateDecodeTables.19:                 ; preds = %ctrl2
  call void @BZ2_hbCreateDecodeTables.19(i32* %limit, i32* %base, i32* %perm, i8* %length, i32 %minLen, i32 %maxLen, i32 %alphaSize)
  ret void
...
func_BZ2_hbCreateDecodeTables.23:                 ; preds = %ctrl4
  call void @BZ2_hbCreateDecodeTables.23(i32* %limit, i32* %base, i32* %perm, i8* %length, i32 %minLen, i32 %maxLen, i32 %alphaSize)
  ret void

func_BZ2_hbCreateDecodeTables.24:                 ; preds = %ctrl5
  call void @BZ2_hbCreateDecodeTables.24(i32* %limit, i32* %base, i32* %perm, i8* %length, i32 %minLen, i32 %maxLen, i32 %alphaSize)
  ret void

func_BZ2_hbCreateDecodeTables.30:                 ; preds = %ctrl6
...
func_BZ2_hbCreateDecodeTables.42:                 ; preds = %ctrl11
  call void @BZ2_hbCreateDecodeTables.42(i32* %limit, i32* %base, i32* %perm, i8* %length, i32 %minLen, i32 %maxLen, i32 %alphaSize)
  ret void

func_BZ2_hbCreateDecodeTables.43:                 ; preds = %ctrl12
  call void @BZ2_hbCreateDecodeTables.43(i32* %limit, i32* %base, i32* %perm, i8* %length, i32 %minLen, i32 %maxLen, i32 %alphaSize)
  ret void

func_BZ2_hbCreateDecodeTables.44:                 ; preds = %ctrl13
  call void @BZ2_hbCreateDecodeTables.44(i32* %limit, i32* %base, i32* %perm, i8* %length, i32 %minLen, i32 %maxLen, i32 %alphaSize)
  ret void
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_BZ2_hbCreateDecodeTables.16, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_BZ2_hbCreateDecodeTables.19, label %ctrl3
...
ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_BZ2_hbCreateDecodeTables.23, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_BZ2_hbCreateDecodeTables.24, label %ctrl6

ctrl6:                                            ; preds = %ctrl5
  %8 = icmp eq i32 %0, 7
  br i1 %8, label %func_BZ2_hbCreateDecodeTables.30, label %ctrl7
...
ctrl11:                                           ; preds = %ctrl10
  %13 = icmp eq i32 %0, 12
  br i1 %13, label %func_BZ2_hbCreateDecodeTables.42, label %ctrl12

ctrl12:                                           ; preds = %ctrl11
  %14 = icmp eq i32 %0, 13
  br i1 %14, label %func_BZ2_hbCreateDecodeTables.43, label %ctrl13

ctrl13:                                           ; preds = %ctrl12
  %15 = icmp eq i32 %0, 14
  br i1 %15, label %func_BZ2_hbCreateDecodeTables.44, label %func_BZ2_hbCreateDecodeTables.48
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @BZ2_hbAssignCodes.1(i32* %code, i8* %length, i32 %minLen, i32 %maxLen, i32 %alphaSize) #0 {
entry:
  %canary = alloca i32
  store i32 1992252643, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 124339624, i32* %canary
  %vec = alloca i32, align 4
  %maxLen.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @BZ2_hbMakeCodeLengths.3(i8* %len, i32* %freq, i32 %alphaSize, i32 %maxLen) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 131188159, i32* %canary
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 686750696, i32* %canary
  %pp = alloca i32, align 4
  %minLen.addr = alloca i32, align 4
  %limit.addr = alloca i32*, align 8
  %vec = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @BZ2_hbMakeCodeLengths.5(i8* %len, i32* %freq, i32 %alphaSize, i32 %maxLen) #0 {
entry:
  %maxLen.addr = alloca i32, align 4
  %parent = alloca [516 x i32], align 16
  %nHeap = alloca i32, align 4
  ...
  %tooLong = alloca i8, align 1
  %canary = alloca i32
  store i32 397227646, i32* %canary
  %heap = alloca [260 x i32], align 16
  %zz = alloca i32, align 4
  %n2 = alloca i32, align 4
  %tmp48 = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @BZ2_hbMakeCodeLengths.6(i8* %len, i32* %freq, i32 %alphaSize, i32 %maxLen) #0 {
entry:
  %j = alloca i32, align 4
  %tmp48 = alloca i32, align 4
  %zz92 = alloca i32, align 4
  ...
  %tooLong = alloca i8, align 1
  %canary = alloca i32
  store i32 1824240576, i32* %canary
  %zz170 = alloca i32, align 4
  %n1 = alloca i32, align 4
  %nHeap = alloca i32, align 4
  %maxLen.addr = alloca i32, align 4
...
while.end234:                                     ; preds = %if.then218
  %151 = load i32, i32* %canary
  %152 = icmp eq i32 %151, 1824240576
  br i1 %152, label %153, label %func_exit
...
entry:
  ...
  %maxLen.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2094679187, i32* %canary
  %vec = alloca i32, align 4
  store i32* %code, i32** %code.addr, align 8
  store i8* %length, i8** %length.addr, align 8
  store i32 %minLen, i32* %minLen.addr, align 4
...
entry:
  ...
  %maxLen.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 950529996, i32* %canary
  %weight = alloca [516 x i32], align 16
  %zz92 = alloca i32, align 4
  %zz47 = alloca i32, align 4
  %k = alloca i32, align 4
...
entry:
  ...
  %yy93 = alloca i32, align 4
  %canary = alloca i32
  store i32 1250297637, i32* %canary
  %alphaSize.addr = alloca i32, align 4
  %maxLen.addr = alloca i32, align 4
  %nHeap = alloca i32, align 4
  store i8* %len, i8** %len.addr, align 8
...
while.end234:                                     ; preds = %if.then218
  %151 = load i32, i32* %canary
  %152 = icmp eq i32 %151, 1250297637
  br i1 %152, label %153, label %func_exit
...
entry:
  ...
  %tmp94 = alloca i32, align 4
  %canary = alloca i32
  store i32 1546764094, i32* %canary
  %n1 = alloca i32, align 4
  %heap = alloca [260 x i32], align 16
  %zz47 = alloca i32, align 4
  %weight = alloca [516 x i32], align 16
...
while.end234:                                     ; preds = %if.then218
  %151 = load i32, i32* %canary
  %152 = icmp eq i32 %151, 1546764094
  br i1 %152, label %153, label %func_exit
...
entry:
  ...
  %minLen.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1519584215, i32* %canary
  %alphaSize.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %n = alloca i32, align 4
  store i32* %code, i32** %code.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @BZ2_hbMakeCodeLengths.12(i8* %len, i32* %freq, i32 %alphaSize, i32 %maxLen) #0 {
entry:
  %nNodes = alloca i32, align 4
  %tmp48 = alloca i32, align 4
  %i = alloca i32, align 4
  ...
  %weight = alloca [516 x i32], align 16
  %canary = alloca i32
  store i32 1438201751, i32* %canary
  %tmp = alloca i32, align 4
  %nHeap = alloca i32, align 4
  %tmp171 = alloca i32, align 4
  %j = alloca i32, align 4
...
while.end234:                                     ; preds = %if.then218
  %151 = load i32, i32* %canary
  %152 = icmp eq i32 %151, 1438201751
  br i1 %152, label %153, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @BZ2_hbMakeCodeLengths.13(i8* %len, i32* %freq, i32 %alphaSize, i32 %maxLen) #0 {
entry:
  %len.addr = alloca i8*, align 8
  %heap = alloca [260 x i32], align 16
  %yy93 = alloca i32, align 4
  ...
  %tmp171 = alloca i32, align 4
  %canary = alloca i32
  store i32 1686333257, i32* %canary
  %tmp94 = alloca i32, align 4
  %nHeap = alloca i32, align 4
  %zz170 = alloca i32, align 4
  %weight = alloca [516 x i32], align 16
...
while.end234:                                     ; preds = %if.then218
  %151 = load i32, i32* %canary
  %152 = icmp eq i32 %151, 1686333257
  br i1 %152, label %153, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @BZ2_hbAssignCodes.14(i32* %code, i8* %length, i32 %minLen, i32 %maxLen, i32 %alphaSize) #0 {
entry:
  %canary = alloca i32
  store i32 1856487447, i32* %canary
  %vec = alloca i32, align 4
  %n = alloca i32, align 4
  %minLen.addr = alloca i32, align 4
  %i = alloca i32, align 4
...
entry:
  ...
  %maxLen.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1105077904, i32* %canary
  %minLen.addr = alloca i32, align 4
  %code.addr = alloca i32*, align 8
  %length.addr = alloca i8*, align 8
  store i32* %code, i32** %code.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @BZ2_hbCreateDecodeTables.16(i32* %limit, i32* %base, i32* %perm, i8* %length, i32 %minLen, i32 %maxLen, i32 %alphaSize) #0 {
entry:
  %vec = alloca i32, align 4
  %j = alloca i32, align 4
  %minLen.addr = alloca i32, align 4
  ...
  %length.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1783227497, i32* %canary
  %perm.addr = alloca i32*, align 8
  %i = alloca i32, align 4
  %base.addr = alloca i32*, align 8
  %pp = alloca i32, align 4
...
entry:
  %zz92 = alloca i32, align 4
  %canary = alloca i32
  store i32 2014265088, i32* %canary
  %zz = alloca i32, align 4
  %freq.addr = alloca i32*, align 8
  %j = alloca i32, align 4
  %heap = alloca [260 x i32], align 16
...
while.end234:                                     ; preds = %if.then218
  %151 = load i32, i32* %canary
  %152 = icmp eq i32 %151, 2014265088
  br i1 %152, label %153, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @BZ2_hbMakeCodeLengths.18(i8* %len, i32* %freq, i32 %alphaSize, i32 %maxLen) #0 {
entry:
  %n2 = alloca i32, align 4
  %zz47 = alloca i32, align 4
  %len.addr = alloca i8*, align 8
  ...
  %yy = alloca i32, align 4
  %canary = alloca i32
  store i32 1148227005, i32* %canary
  %tmp171 = alloca i32, align 4
  %nHeap = alloca i32, align 4
  %i = alloca i32, align 4
  %j = alloca i32, align 4
...
while.end234:                                     ; preds = %if.then218
  %151 = load i32, i32* %canary
  %152 = icmp eq i32 %151, 1148227005
  br i1 %152, label %153, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @BZ2_hbCreateDecodeTables.19(i32* %limit, i32* %base, i32* %perm, i8* %length, i32 %minLen, i32 %maxLen, i32 %alphaSize) #0 {
entry:
  %maxLen.addr = alloca i32, align 4
  %minLen.addr = alloca i32, align 4
  %limit.addr = alloca i32*, align 8
  ...
  %base.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 1823664769, i32* %canary
  %vec = alloca i32, align 4
  %j = alloca i32, align 4
  %i = alloca i32, align 4
  store i32* %limit, i32** %limit.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1630046147, i32* %canary
  %alphaSize.addr = alloca i32, align 4
  %maxLen.addr = alloca i32, align 4
  %length.addr = alloca i8*, align 8
  %n = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @BZ2_hbAssignCodes.22(i32* %code, i8* %length, i32 %minLen, i32 %maxLen, i32 %alphaSize) #0 {
entry:
  %i = alloca i32, align 4
  %alphaSize.addr = alloca i32, align 4
  %vec = alloca i32, align 4
...
entry:
  ...
  %limit.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 1511451950, i32* %canary
  %base.addr = alloca i32*, align 8
  %perm.addr = alloca i32*, align 8
  %minLen.addr = alloca i32, align 4
  store i32* %limit, i32** %limit.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @BZ2_hbCreateDecodeTables.24(i32* %limit, i32* %base, i32* %perm, i8* %length, i32 %minLen, i32 %maxLen, i32 %alphaSize) #0 {
entry:
  %maxLen.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 207790116, i32* %canary
  %perm.addr = alloca i32*, align 8
  %j = alloca i32, align 4
  %alphaSize.addr = alloca i32, align 4
  %vec = alloca i32, align 4
...
entry:
  ...
  %n = alloca i32, align 4
  %canary = alloca i32
  store i32 160221978, i32* %canary
  %i = alloca i32, align 4
  store i32* %code, i32** %code.addr, align 8
  store i8* %length, i8** %length.addr, align 8
  store i32 %minLen, i32* %minLen.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 1373594475, i32* %canary
  %n = alloca i32, align 4
  %i = alloca i32, align 4
  %length.addr = alloca i8*, align 8
  %alphaSize.addr = alloca i32, align 4
...
entry:
  ...
  %zz = alloca i32, align 4
  %canary = alloca i32
  store i32 742807680, i32* %canary
  %nNodes = alloca i32, align 4
  %parent = alloca [516 x i32], align 16
  %nHeap = alloca i32, align 4
  %len.addr = alloca i8*, align 8
...
entry:
  %nHeap = alloca i32, align 4
  %canary = alloca i32
  store i32 1793857334, i32* %canary
  %yy93 = alloca i32, align 4
  %len.addr = alloca i8*, align 8
  %tooLong = alloca i8, align 1
  %nNodes = alloca i32, align 4
...
while.end234:                                     ; preds = %if.then218
  %151 = load i32, i32* %canary
  %152 = icmp eq i32 %151, 1793857334
  br i1 %152, label %153, label %func_exit
...
entry:
  ...
  %alphaSize.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 207890785, i32* %canary
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %len.addr = alloca i8*, align 8
  %tmp48 = alloca i32, align 4
...
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1935177720, i32* %canary
  %limit.addr = alloca i32*, align 8
  %vec = alloca i32, align 4
  %minLen.addr = alloca i32, align 4
  %maxLen.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @BZ2_hbMakeCodeLengths.31(i8* %len, i32* %freq, i32 %alphaSize, i32 %maxLen) #0 {
entry:
  %zz = alloca i32, align 4
  %n2 = alloca i32, align 4
  %freq.addr = alloca i32*, align 8
  ...
  %len.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 504492311, i32* %canary
  %nHeap = alloca i32, align 4
  %tmp171 = alloca i32, align 4
  %nNodes = alloca i32, align 4
  %i = alloca i32, align 4
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 870347594, i32* %canary
  %maxLen.addr = alloca i32, align 4
  %code.addr = alloca i32*, align 8
  %minLen.addr = alloca i32, align 4
  store i32* %code, i32** %code.addr, align 8
...
entry:
  ...
  %length.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 774440194, i32* %canary
  %base.addr = alloca i32*, align 8
  %limit.addr = alloca i32*, align 8
  store i32* %limit, i32** %limit.addr, align 8
  store i32* %base, i32** %base.addr, align 8
...
entry:
  ...
  %n1 = alloca i32, align 4
  %canary = alloca i32
  store i32 219326737, i32* %canary
  %n2 = alloca i32, align 4
  %tooLong = alloca i8, align 1
  %nNodes = alloca i32, align 4
  %freq.addr = alloca i32*, align 8
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 131883941, i32* %canary
  %pp = alloca i32, align 4
  %alphaSize.addr = alloca i32, align 4
  %minLen.addr = alloca i32, align 4
  store i32* %limit, i32** %limit.addr, align 8
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 729309007, i32* %canary
  %zz47 = alloca i32, align 4
  %n1 = alloca i32, align 4
  %zz170 = alloca i32, align 4
  %alphaSize.addr = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1511648775, i32* %canary
  %code.addr = alloca i32*, align 8
  %alphaSize.addr = alloca i32, align 4
  %minLen.addr = alloca i32, align 4
  %vec = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @BZ2_hbAssignCodes.38(i32* %code, i8* %length, i32 %minLen, i32 %maxLen, i32 %alphaSize) #0 {
entry:
  %canary = alloca i32
  store i32 2139026472, i32* %canary
  %n = alloca i32, align 4
  %alphaSize.addr = alloca i32, align 4
  %vec = alloca i32, align 4
  %length.addr = alloca i8*, align 8
...
entry:
  %length.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 402420059, i32* %canary
  %maxLen.addr = alloca i32, align 4
  %minLen.addr = alloca i32, align 4
  %alphaSize.addr = alloca i32, align 4
  %vec = alloca i32, align 4
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 2024091498, i32* %canary
  %alphaSize.addr = alloca i32, align 4
  %length.addr = alloca i8*, align 8
  %minLen.addr = alloca i32, align 4
  store i32* %limit, i32** %limit.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @BZ2_hbAssignCodes.41(i32* %code, i8* %length, i32 %minLen, i32 %maxLen, i32 %alphaSize) #0 {
entry:
  %canary = alloca i32
  store i32 1257314336, i32* %canary
  %n = alloca i32, align 4
  %i = alloca i32, align 4
  %minLen.addr = alloca i32, align 4
  %length.addr = alloca i8*, align 8
...
entry:
  %maxLen.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1734868920, i32* %canary
  %j = alloca i32, align 4
  %alphaSize.addr = alloca i32, align 4
  %pp = alloca i32, align 4
  %vec = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 163722375, i32* %canary
  %length.addr = alloca i8*, align 8
  %vec = alloca i32, align 4
  %pp = alloca i32, align 4
  %perm.addr = alloca i32*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @BZ2_hbCreateDecodeTables.44(i32* %limit, i32* %base, i32* %perm, i8* %length, i32 %minLen, i32 %maxLen, i32 %alphaSize) #0 {
entry:
  %i = alloca i32, align 4
  %vec = alloca i32, align 4
  %pp = alloca i32, align 4
  ...
  %perm.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 1273094322, i32* %canary
  %alphaSize.addr = alloca i32, align 4
  store i32* %limit, i32** %limit.addr, align 8
  store i32* %base, i32** %base.addr, align 8
  store i32* %perm, i32** %perm.addr, align 8
...
entry:
  ...
  %minLen.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 233192045, i32* %canary
  %i = alloca i32, align 4
  %maxLen.addr = alloca i32, align 4
  %code.addr = alloca i32*, align 8
  %n = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @BZ2_hbAssignCodes.46(i32* %code, i8* %length, i32 %minLen, i32 %maxLen, i32 %alphaSize) #0 {
entry:
  %vec = alloca i32, align 4
  %canary = alloca i32
  store i32 2110293808, i32* %canary
  %maxLen.addr = alloca i32, align 4
  %alphaSize.addr = alloca i32, align 4
  %n = alloca i32, align 4
  %minLen.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @BZ2_hbAssignCodes.47(i32* %code, i8* %length, i32 %minLen, i32 %maxLen, i32 %alphaSize) #0 {
entry:
  %length.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 549371027, i32* %canary
  %alphaSize.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %code.addr = alloca i32*, align 8
  %vec = alloca i32, align 4
...
entry:
  %perm.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 796230207, i32* %canary
  %base.addr = alloca i32*, align 8
  %limit.addr = alloca i32*, align 8
  %length.addr = alloca i8*, align 8
  %vec = alloca i32, align 4
