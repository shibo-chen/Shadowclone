...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_fopen_output_safely.58, label %ctrl0

func_fopen_output_safely.58:                      ; preds = %rand_bb
  %2 = call %struct._IO_FILE* @fopen_output_safely.58(i8* %name, i8* %mode)
  ret %struct._IO_FILE* %2

func_fopen_output_safely.62:                      ; preds = %ctrl0
  %3 = call %struct._IO_FILE* @fopen_output_safely.62(i8* %name, i8* %mode)
...
func_fopen_output_safely.76:                      ; preds = %ctrl1
  %5 = call %struct._IO_FILE* @fopen_output_safely.76(i8* %name, i8* %mode)
  ret %struct._IO_FILE* %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_fopen_output_safely.62, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_fopen_output_safely.66, label %func_fopen_output_safely.76
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_copyFileName.2, label %func_copyFileName.35

func_copyFileName.2:                              ; preds = %rand_bb
  call void @copyFileName.2(i8* %to, i8* %from)
  ret void

func_copyFileName.35:                             ; preds = %rand_bb
  call void @copyFileName.35(i8* %to, i8* %from)
  ret void
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_addFlagsFromEnvVar.49, label %ctrl0

func_addFlagsFromEnvVar.49:                       ; preds = %rand_bb
  call void @addFlagsFromEnvVar.49(%struct.zzzz** %argList, i8* %varName)
  ret void

func_addFlagsFromEnvVar.80:                       ; preds = %ctrl0
  call void @addFlagsFromEnvVar.80(%struct.zzzz** %argList, i8* %varName)
  ret void

func_addFlagsFromEnvVar.84:                       ; preds = %ctrl1
  call void @addFlagsFromEnvVar.84(%struct.zzzz** %argList, i8* %varName)
  ret void

func_addFlagsFromEnvVar.91:                       ; preds = %ctrl1
  call void @addFlagsFromEnvVar.91(%struct.zzzz** %argList, i8* %varName)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_addFlagsFromEnvVar.80, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_addFlagsFromEnvVar.84, label %func_addFlagsFromEnvVar.91
}
...
func_snocString.24:                               ; preds = %ctrl0
  %3 = call %struct.zzzz* @snocString.24(%struct.zzzz* %root, i8* %name)
  ret %struct.zzzz* %3

func_snocString.29:                               ; preds = %ctrl1
  %4 = call %struct.zzzz* @snocString.29(%struct.zzzz* %root, i8* %name)
  ret %struct.zzzz* %4
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_snocString.24, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_snocString.29, label %func_snocString.54
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_compress.13, label %ctrl0

func_compress.13:                                 ; preds = %rand_bb
  call void @compress.13(i8* %name)
  ret void

func_compress.20:                                 ; preds = %ctrl0
  call void @compress.20(i8* %name)
  ret void

func_compress.27:                                 ; preds = %ctrl1
  call void @compress.27(i8* %name)
  ret void

func_compress.32:                                 ; preds = %ctrl1
  call void @compress.32(i8* %name)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_compress.20, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_compress.27, label %func_compress.32
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_uncompress.3, label %ctrl0

func_uncompress.3:                                ; preds = %rand_bb
  call void @uncompress.3(i8* %name)
  ret void

func_uncompress.12:                               ; preds = %ctrl0
  call void @uncompress.12(i8* %name)
  ret void

func_uncompress.22:                               ; preds = %ctrl1
  call void @uncompress.22(i8* %name)
  ret void

func_uncompress.70:                               ; preds = %ctrl1
  call void @uncompress.70(i8* %name)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_uncompress.12, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_uncompress.22, label %func_uncompress.70
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_testf.14, label %ctrl0

func_testf.14:                                    ; preds = %rand_bb
  call void @testf.14(i8* %name)
  ret void

func_testf.47:                                    ; preds = %ctrl0
  call void @testf.47(i8* %name)
  ret void

func_testf.57:                                    ; preds = %ctrl1
  call void @testf.57(i8* %name)
  ret void

func_testf.74:                                    ; preds = %ctrl1
  call void @testf.74(i8* %name)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_testf.47, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_testf.57, label %func_testf.74
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_cleanUpAndFail.67, label %ctrl0

func_cleanUpAndFail.67:                           ; preds = %rand_bb
  call void @cleanUpAndFail.67(i32 %ec)
  ret void
...
func_cleanUpAndFail.88:                           ; preds = %ctrl1
  call void @cleanUpAndFail.88(i32 %ec)
  ret void

func_cleanUpAndFail.89:                           ; preds = %ctrl1
  call void @cleanUpAndFail.89(i32 %ec)
  ret void
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_cleanUpAndFail.88, label %func_cleanUpAndFail.89
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_myMalloc.1, label %func_myMalloc.25

func_myMalloc.1:                                  ; preds = %rand_bb
  %2 = call i8* @myMalloc.1(i32 %n)
  ret i8* %2

func_myMalloc.25:                                 ; preds = %rand_bb
  %3 = call i8* @myMalloc.25(i32 %n)
  ret i8* %3
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_fileExists.44, label %ctrl0

func_fileExists.44:                               ; preds = %rand_bb
  %2 = call i8 @fileExists.44(i8* %name)
  ret i8 %2

func_fileExists.75:                               ; preds = %ctrl0
  %3 = call i8 @fileExists.75(i8* %name)
  ret i8 %3

func_fileExists.78:                               ; preds = %ctrl1
  %4 = call i8 @fileExists.78(i8* %name)
  ret i8 %4

func_fileExists.79:                               ; preds = %ctrl1
  %5 = call i8 @fileExists.79(i8* %name)
  ret i8 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_fileExists.75, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_fileExists.78, label %func_fileExists.79
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_hasSuffix.45, label %ctrl0

func_hasSuffix.45:                                ; preds = %rand_bb
  %2 = call i8 @hasSuffix.45(i8* %s, i8* %suffix)
  ret i8 %2

func_hasSuffix.55:                                ; preds = %ctrl0
  %3 = call i8 @hasSuffix.55(i8* %s, i8* %suffix)
  ret i8 %3

func_hasSuffix.63:                                ; preds = %ctrl1
  %4 = call i8 @hasSuffix.63(i8* %s, i8* %suffix)
  ret i8 %4

func_hasSuffix.73:                                ; preds = %ctrl1
  %5 = call i8 @hasSuffix.73(i8* %s, i8* %suffix)
  ret i8 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_hasSuffix.55, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_hasSuffix.63, label %func_hasSuffix.73
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_notAStandardFile.40, label %ctrl0

func_notAStandardFile.40:                         ; preds = %rand_bb
  %2 = call i8 @notAStandardFile.40(i8* %name)
  ret i8 %2

func_notAStandardFile.56:                         ; preds = %ctrl0
  %3 = call i8 @notAStandardFile.56(i8* %name)
  ret i8 %3

func_notAStandardFile.60:                         ; preds = %ctrl1
  %4 = call i8 @notAStandardFile.60(i8* %name)
  ret i8 %4

func_notAStandardFile.86:                         ; preds = %ctrl1
  %5 = call i8 @notAStandardFile.86(i8* %name)
  ret i8 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_notAStandardFile.56, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_notAStandardFile.60, label %func_notAStandardFile.86
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_countHardLinks.37, label %ctrl0

func_countHardLinks.37:                           ; preds = %rand_bb
  %2 = call i32 @countHardLinks.37(i8* %name)
  ret i32 %2

func_countHardLinks.68:                           ; preds = %ctrl0
  %3 = call i32 @countHardLinks.68(i8* %name)
  ret i32 %3

func_countHardLinks.95:                           ; preds = %ctrl1
  %4 = call i32 @countHardLinks.95(i8* %name)
  ret i32 %4

func_countHardLinks.96:                           ; preds = %ctrl1
  %5 = call i32 @countHardLinks.96(i8* %name)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_countHardLinks.68, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_countHardLinks.95, label %func_countHardLinks.96
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_saveInputFileMetaInfo.28, label %func_saveInputFileMetaInfo.30

func_saveInputFileMetaInfo.28:                    ; preds = %rand_bb
  call void @saveInputFileMetaInfo.28(i8* %srcName)
  ret void

func_saveInputFileMetaInfo.30:                    ; preds = %rand_bb
  call void @saveInputFileMetaInfo.30(i8* %srcName)
  ret void
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_pad.43, label %func_pad.61

func_pad.43:                                      ; preds = %rand_bb
  call void @pad.43(i8* %s)
  ret void

func_pad.61:                                      ; preds = %rand_bb
  call void @pad.61(i8* %s)
  ret void
}
...
func_compressStream.23:                           ; preds = %ctrl0
  call void @compressStream.23(%struct._IO_FILE* %stream, %struct._IO_FILE* %zStream)
  ret void

func_compressStream.52:                           ; preds = %ctrl1
  call void @compressStream.52(%struct._IO_FILE* %stream, %struct._IO_FILE* %zStream)
  ret void

func_compressStream.85:                           ; preds = %ctrl1
  call void @compressStream.85(%struct._IO_FILE* %stream, %struct._IO_FILE* %zStream)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_compressStream.23, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_compressStream.52, label %func_compressStream.85
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_applySavedMetaInfoToOutputFile.46, label %ctrl0

func_applySavedMetaInfoToOutputFile.46:           ; preds = %rand_bb
  call void @applySavedMetaInfoToOutputFile.46(i8* %dstName)
  ret void

func_applySavedMetaInfoToOutputFile.71:           ; preds = %ctrl0
  call void @applySavedMetaInfoToOutputFile.71(i8* %dstName)
  ret void
...
func_applySavedMetaInfoToOutputFile.87:           ; preds = %ctrl1
  call void @applySavedMetaInfoToOutputFile.87(i8* %dstName)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_applySavedMetaInfoToOutputFile.71, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_applySavedMetaInfoToOutputFile.81, label %func_applySavedMetaInfoToOutputFile.87
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_myfeof.19, label %ctrl0

func_myfeof.19:                                   ; preds = %rand_bb
  %2 = call i8 @myfeof.19(%struct._IO_FILE* %f)
  ret i8 %2
...
func_myfeof.92:                                   ; preds = %ctrl1
  %5 = call i8 @myfeof.92(%struct._IO_FILE* %f)
  ret i8 %5
...
ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_myfeof.69, label %func_myfeof.92
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_uInt64_from_UInt32s.8, label %ctrl0

func_uInt64_from_UInt32s.8:                       ; preds = %rand_bb
  call void @uInt64_from_UInt32s.8(%struct.UInt64* %n, i32 %lo32, i32 %hi32)
  ret void

func_uInt64_from_UInt32s.11:                      ; preds = %ctrl0
  call void @uInt64_from_UInt32s.11(%struct.UInt64* %n, i32 %lo32, i32 %hi32)
  ret void

func_uInt64_from_UInt32s.34:                      ; preds = %ctrl1
  call void @uInt64_from_UInt32s.34(%struct.UInt64* %n, i32 %lo32, i32 %hi32)
  ret void

func_uInt64_from_UInt32s.36:                      ; preds = %ctrl1
  call void @uInt64_from_UInt32s.36(%struct.UInt64* %n, i32 %lo32, i32 %hi32)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_uInt64_from_UInt32s.11, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_uInt64_from_UInt32s.34, label %func_uInt64_from_UInt32s.36
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_uInt64_to_double.17, label %ctrl0

func_uInt64_to_double.17:                         ; preds = %rand_bb
  %2 = call double @uInt64_to_double.17(%struct.UInt64* %n)
  ret double %2

func_uInt64_to_double.33:                         ; preds = %ctrl0
  %3 = call double @uInt64_to_double.33(%struct.UInt64* %n)
  ret double %3

func_uInt64_to_double.38:                         ; preds = %ctrl1
  %4 = call double @uInt64_to_double.38(%struct.UInt64* %n)
  ret double %4

func_uInt64_to_double.41:                         ; preds = %ctrl1
  %5 = call double @uInt64_to_double.41(%struct.UInt64* %n)
  ret double %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_uInt64_to_double.33, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_uInt64_to_double.38, label %func_uInt64_to_double.41
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_uInt64_toAscii.4, label %ctrl0

func_uInt64_toAscii.4:                            ; preds = %rand_bb
  call void @uInt64_toAscii.4(i8* %outbuf, %struct.UInt64* %n)
  ret void

func_uInt64_toAscii.7:                            ; preds = %ctrl0
  call void @uInt64_toAscii.7(i8* %outbuf, %struct.UInt64* %n)
  ret void

func_uInt64_toAscii.77:                           ; preds = %ctrl1
  call void @uInt64_toAscii.77(i8* %outbuf, %struct.UInt64* %n)
  ret void

func_uInt64_toAscii.83:                           ; preds = %ctrl1
  call void @uInt64_toAscii.83(i8* %outbuf, %struct.UInt64* %n)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_uInt64_toAscii.7, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_uInt64_toAscii.77, label %func_uInt64_toAscii.83
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_uInt64_qrm10.16, label %ctrl0

func_uInt64_qrm10.16:                             ; preds = %rand_bb
  %2 = call i32 @uInt64_qrm10.16(%struct.UInt64* %n)
  ret i32 %2

func_uInt64_qrm10.31:                             ; preds = %ctrl0
  %3 = call i32 @uInt64_qrm10.31(%struct.UInt64* %n)
  ret i32 %3

func_uInt64_qrm10.93:                             ; preds = %ctrl1
  %4 = call i32 @uInt64_qrm10.93(%struct.UInt64* %n)
  ret i32 %4
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_uInt64_qrm10.31, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_uInt64_qrm10.93, label %func_uInt64_qrm10.94
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_uInt64_isZero.26, label %ctrl0

func_uInt64_isZero.26:                            ; preds = %rand_bb
  %2 = call i8 @uInt64_isZero.26(%struct.UInt64* %n)
  ret i8 %2

func_uInt64_isZero.39:                            ; preds = %ctrl0
  %3 = call i8 @uInt64_isZero.39(%struct.UInt64* %n)
  ret i8 %3
...
func_uInt64_isZero.50:                            ; preds = %ctrl1
  %5 = call i8 @uInt64_isZero.50(%struct.UInt64* %n)
  ret i8 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_uInt64_isZero.39, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_uInt64_isZero.48, label %func_uInt64_isZero.50
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_mapSuffix.5, label %ctrl0

func_mapSuffix.5:                                 ; preds = %rand_bb
  %2 = call i8 @mapSuffix.5(i8* %name, i8* %oldSuffix, i8* %newSuffix)
  ret i8 %2

func_mapSuffix.6:                                 ; preds = %ctrl0
  %3 = call i8 @mapSuffix.6(i8* %name, i8* %oldSuffix, i8* %newSuffix)
  ret i8 %3

func_mapSuffix.10:                                ; preds = %ctrl1
  %4 = call i8 @mapSuffix.10(i8* %name, i8* %oldSuffix, i8* %newSuffix)
  ret i8 %4

func_mapSuffix.15:                                ; preds = %ctrl1
  %5 = call i8 @mapSuffix.15(i8* %name, i8* %oldSuffix, i8* %newSuffix)
  ret i8 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_mapSuffix.6, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_mapSuffix.10, label %func_mapSuffix.15
}
...
func_uncompressStream.42:                         ; preds = %ctrl0
  %3 = call i8 @uncompressStream.42(%struct._IO_FILE* %zStream, %struct._IO_FILE* %stream)
  ret i8 %3

func_uncompressStream.64:                         ; preds = %ctrl1
  %4 = call i8 @uncompressStream.64(%struct._IO_FILE* %zStream, %struct._IO_FILE* %stream)
  ret i8 %4

func_uncompressStream.65:                         ; preds = %ctrl1
  %5 = call i8 @uncompressStream.65(%struct._IO_FILE* %zStream, %struct._IO_FILE* %stream)
  ret i8 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_uncompressStream.42, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_uncompressStream.64, label %func_uncompressStream.65
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_testStream.51, label %ctrl0

func_testStream.51:                               ; preds = %rand_bb
  %2 = call i8 @testStream.51(%struct._IO_FILE* %zStream)
  ret i8 %2

func_testStream.59:                               ; preds = %ctrl0
  %3 = call i8 @testStream.59(%struct._IO_FILE* %zStream)
  ret i8 %3

func_testStream.82:                               ; preds = %ctrl1
  %4 = call i8 @testStream.82(%struct._IO_FILE* %zStream)
  ret i8 %4

func_testStream.90:                               ; preds = %ctrl1
  %5 = call i8 @testStream.90(%struct._IO_FILE* %zStream)
  ret i8 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_testStream.59, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_testStream.82, label %func_testStream.90
}

; Function Attrs: noinline nounwind optnone uwtable
define internal i8* @myMalloc.1(i32 %n) #0 {
entry:
  %canary = alloca i32
  store i32 1535700412, i32* %canary
  %n.addr = alloca i32, align 4
  %p = alloca i8*, align 8
  store i32 %n, i32* %n.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 1746581797, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @uncompress.3(i8* %name) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 262665625, i32* %canary
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @uInt64_toAscii.4(i8* %outbuf, %struct.UInt64* %n) #0 {
entry:
  %i = alloca i32, align 4
  %q = alloca i32, align 4
  %outbuf.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1149040040, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @mapSuffix.5(i8* %name, i8* %oldSuffix, i8* %newSuffix) #0 {
entry:
  %retval = alloca i8, align 1
  %canary = alloca i32
  store i32 1063210682, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @mapSuffix.6(i8* %name, i8* %oldSuffix, i8* %newSuffix) #0 {
entry:
  %canary = alloca i32
  store i32 666524962, i32* %canary
  %oldSuffix.addr = alloca i8*, align 8
  %name.addr = alloca i8*, align 8
  %newSuffix.addr = alloca i8*, align 8
  %retval = alloca i8, align 1
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @uInt64_toAscii.7(i8* %outbuf, %struct.UInt64* %n) #0 {
entry:
  %n.addr = alloca %struct.UInt64*, align 8
  %n_copy = alloca %struct.UInt64, align 1
  %canary = alloca i32
  store i32 918085933, i32* %canary
  %buf = alloca [32 x i8], align 16
  %outbuf.addr = alloca i8*, align 8
  %i = alloca i32, align 4
  %nBuf = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @uInt64_from_UInt32s.8(%struct.UInt64* %n, i32 %lo32, i32 %hi32) #0 {
entry:
  %canary = alloca i32
  store i32 565358231, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1970400114, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @mapSuffix.10(i8* %name, i8* %oldSuffix, i8* %newSuffix) #0 {
entry:
  %name.addr = alloca i8*, align 8
  %retval = alloca i8, align 1
  %canary = alloca i32
  store i32 1940131774, i32* %canary
  %oldSuffix.addr = alloca i8*, align 8
  %newSuffix.addr = alloca i8*, align 8
  store i8* %name, i8** %name.addr, align 8
  store i8* %oldSuffix, i8** %oldSuffix.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @uInt64_from_UInt32s.11(%struct.UInt64* %n, i32 %lo32, i32 %hi32) #0 {
entry:
  %n.addr = alloca %struct.UInt64*, align 8
  %canary = alloca i32
  store i32 1586378186, i32* %canary
  %lo32.addr = alloca i32, align 4
  %hi32.addr = alloca i32, align 4
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
  store i32 %lo32, i32* %lo32.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @uncompress.12(i8* %name) #0 {
entry:
  %magicNumberOK = alloca i8, align 1
  %cantGuess = alloca i8, align 1
  %retVal = alloca i32, align 4
  ...
  %n = alloca i32, align 4
  %canary = alloca i32
  store i32 862008844, i32* %canary
  %statBuf = alloca %struct.stat, align 8
  %inStr = alloca %struct._IO_FILE*, align 8
  %retVal168 = alloca i32, align 4
  %outStr = alloca %struct._IO_FILE*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @compress.13(i8* %name) #0 {
entry:
  %i = alloca i32, align 4
  %name.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 537657864, i32* %canary
  %statBuf = alloca %struct.stat, align 8
  %retVal = alloca i32, align 4
  %inStr = alloca %struct._IO_FILE*, align 8
  %outStr = alloca %struct._IO_FILE*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @testf.14(i8* %name) #0 {
entry:
  %inStr = alloca %struct._IO_FILE*, align 8
  %allOK = alloca i8, align 1
  %canary = alloca i32
  store i32 2083142433, i32* %canary
  %name.addr = alloca i8*, align 8
  %statBuf = alloca %struct.stat, align 8
  store i8* %name, i8** %name.addr, align 8
  store i8 0, i8* @deleteOutputOnInterrupt, align 1
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @mapSuffix.15(i8* %name, i8* %oldSuffix, i8* %newSuffix) #0 {
entry:
  %canary = alloca i32
  store i32 1367120093, i32* %canary
  %retval = alloca i8, align 1
  %oldSuffix.addr = alloca i8*, align 8
  %name.addr = alloca i8*, align 8
  %newSuffix.addr = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @uInt64_qrm10.16(%struct.UInt64* %n) #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1431951648, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal double @uInt64_to_double.17(%struct.UInt64* %n) #0 {
entry:
  %base = alloca double, align 8
  %i = alloca i32, align 4
  %n.addr = alloca %struct.UInt64*, align 8
  %canary = alloca i32
  store i32 811542299, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1782346951, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @myfeof.19(%struct._IO_FILE* %f) #0 {
entry:
  %c = alloca i32, align 4
  %f.addr = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 1199329179, i32* %canary
  %retval = alloca i8, align 1
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @compress.20(i8* %name) #0 {
entry:
  %inStr = alloca %struct._IO_FILE*, align 8
  %i = alloca i32, align 4
  %retVal = alloca i32, align 4
  ...
  %statBuf = alloca %struct.stat, align 8
  %canary = alloca i32
  store i32 527873363, i32* %canary
  %outStr = alloca %struct._IO_FILE*, align 8
  %n = alloca i32, align 4
  store i8* %name, i8** %name.addr, align 8
  store i8 0, i8* @deleteOutputOnInterrupt, align 1
...
entry:
  ...
  %bzerr_dummy = alloca i32, align 4
  %canary = alloca i32
  store i32 787102038, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @uncompress.22(i8* %name) #0 {
entry:
  %magicNumberOK = alloca i8, align 1
  %canary = alloca i32
  store i32 1966857711, i32* %canary
  %inStr = alloca %struct._IO_FILE*, align 8
  %outStr = alloca %struct._IO_FILE*, align 8
  %cantGuess = alloca i8, align 1
  %retVal = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @compressStream.23(%struct._IO_FILE* %stream, %struct._IO_FILE* %zStream) #0 {
entry:
  %ibuf = alloca [5000 x i8], align 16
  %nbytes_in_d = alloca double, align 8
  %nbytes_out = alloca %struct.UInt64, align 1
  ...
  %nbytes_in_hi32 = alloca i32, align 4
  %canary = alloca i32
  store i32 1279305510, i32* %canary
  %stream.addr = alloca %struct._IO_FILE*, align 8
  %nbytes_out_d = alloca double, align 8
  %nIbuf = alloca i32, align 4
  %bzf = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i8* @myMalloc.25(i32 %n) #0 {
entry:
  %canary = alloca i32
  store i32 121288639, i32* %canary
  %p = alloca i8*, align 8
  %n.addr = alloca i32, align 4
  store i32 %n, i32* %n.addr, align 4
  %0 = load i32, i32* %n.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @uInt64_isZero.26(%struct.UInt64* %n) #0 {
entry:
  %canary = alloca i32
  store i32 1120792191, i32* %canary
  %i = alloca i32, align 4
  %retval = alloca i8, align 1
  %n.addr = alloca %struct.UInt64*, align 8
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @compress.27(i8* %name) #0 {
entry:
  %canary = alloca i32
  store i32 206280726, i32* %canary
  %statBuf = alloca %struct.stat, align 8
  %name.addr = alloca i8*, align 8
  %i = alloca i32, align 4
  %inStr = alloca %struct._IO_FILE*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @saveInputFileMetaInfo.28(i8* %srcName) #0 {
entry:
  %canary = alloca i32
  store i32 203464012, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal %struct.zzzz* @snocString.29(%struct.zzzz* %root, i8* %name) #0 {
entry:
  %tmp6 = alloca %struct.zzzz*, align 8
  %canary = alloca i32
  store i32 150011933, i32* %canary
  %retval = alloca %struct.zzzz*, align 8
  %name.addr = alloca i8*, align 8
  %tmp = alloca %struct.zzzz*, align 8
  %root.addr = alloca %struct.zzzz*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @saveInputFileMetaInfo.30(i8* %srcName) #0 {
entry:
  %retVal = alloca i32, align 4
  %canary = alloca i32
  store i32 1344215504, i32* %canary
  %srcName.addr = alloca i8*, align 8
  store i8* %srcName, i8** %srcName.addr, align 8
  %0 = load i8*, i8** %srcName.addr, align 8
  %call = call i32 @stat(i8* %0, %struct.stat* @fileMetaInfo) #8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @uInt64_qrm10.31(%struct.UInt64* %n) #0 {
entry:
  %n.addr = alloca %struct.UInt64*, align 8
  %tmp = alloca i32, align 4
  %canary = alloca i32
  store i32 471424699, i32* %canary
  %rem = alloca i32, align 4
  %i = alloca i32, align 4
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
  store i32 0, i32* %rem, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @compress.32(i8* %name) #0 {
entry:
  %name.addr = alloca i8*, align 8
  %retVal = alloca i32, align 4
  %statBuf = alloca %struct.stat, align 8
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1606731937, i32* %canary
  %inStr = alloca %struct._IO_FILE*, align 8
  %outStr = alloca %struct._IO_FILE*, align 8
  store i8* %name, i8** %name.addr, align 8
  store i8 0, i8* @deleteOutputOnInterrupt, align 1
...
; Function Attrs: noinline nounwind optnone uwtable
define internal double @uInt64_to_double.33(%struct.UInt64* %n) #0 {
entry:
  %n.addr = alloca %struct.UInt64*, align 8
  %canary = alloca i32
  store i32 1451888366, i32* %canary
  %i = alloca i32, align 4
  %sum = alloca double, align 8
  %base = alloca double, align 8
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
...
entry:
  ...
  %hi32.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 457356108, i32* %canary
  %lo32.addr = alloca i32, align 4
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
  store i32 %lo32, i32* %lo32.addr, align 4
  store i32 %hi32, i32* %hi32.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @copyFileName.35(i8* %to, i8* %from) #0 {
entry:
  %to.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1303947772, i32* %canary
  %from.addr = alloca i8*, align 8
  store i8* %to, i8** %to.addr, align 8
  store i8* %from, i8** %from.addr, align 8
  %0 = load i8*, i8** %from.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @uInt64_from_UInt32s.36(%struct.UInt64* %n, i32 %lo32, i32 %hi32) #0 {
entry:
  %canary = alloca i32
  store i32 684464344, i32* %canary
  %lo32.addr = alloca i32, align 4
  %hi32.addr = alloca i32, align 4
  %n.addr = alloca %struct.UInt64*, align 8
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
...
entry:
  ...
  %name.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 175443215, i32* %canary
  %retval = alloca i32, align 4
  store i8* %name, i8** %name.addr, align 8
  %0 = load i8*, i8** %name.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal double @uInt64_to_double.38(%struct.UInt64* %n) #0 {
entry:
  %base = alloca double, align 8
  %i = alloca i32, align 4
  %sum = alloca double, align 8
  %canary = alloca i32
  store i32 765626021, i32* %canary
  %n.addr = alloca %struct.UInt64*, align 8
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
  store double 1.000000e+00, double* %base, align 8
  store double 0.000000e+00, double* %sum, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @uInt64_isZero.39(%struct.UInt64* %n) #0 {
entry:
  %n.addr = alloca %struct.UInt64*, align 8
  %canary = alloca i32
  store i32 1101241977, i32* %canary
  %retval = alloca i8, align 1
  %i = alloca i32, align 4
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
  store i32 0, i32* %i, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @notAStandardFile.40(i8* %name) #0 {
entry:
  %name.addr = alloca i8*, align 8
  %retval = alloca i8, align 1
  %canary = alloca i32
  store i32 273812490, i32* %canary
  %statBuf = alloca %struct.stat, align 8
  %i = alloca i32, align 4
  store i8* %name, i8** %name.addr, align 8
  %0 = load i8*, i8** %name.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal double @uInt64_to_double.41(%struct.UInt64* %n) #0 {
entry:
  %i = alloca i32, align 4
  %n.addr = alloca %struct.UInt64*, align 8
  %canary = alloca i32
  store i32 85397388, i32* %canary
  %base = alloca double, align 8
  %sum = alloca double, align 8
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
  store double 1.000000e+00, double* %base, align 8
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1628252615, i32* %canary
  %zStream.addr = alloca %struct._IO_FILE*, align 8
  %bzerr_dummy = alloca i32, align 4
  %retval = alloca i8, align 1
  %unused = alloca [5000 x i8], align 16
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @pad.43(i8* %s) #0 {
entry:
  %s.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 2011684877, i32* %canary
  %i = alloca i32, align 4
  store i8* %s, i8** %s.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @fileExists.44(i8* %name) #0 {
entry:
  %exists = alloca i8, align 1
  %canary = alloca i32
  store i32 1636028840, i32* %canary
  %name.addr = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @hasSuffix.45(i8* %s, i8* %suffix) #0 {
entry:
  %canary = alloca i32
  store i32 370282056, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @applySavedMetaInfoToOutputFile.46(i8* %dstName) #0 {
entry:
  %retVal = alloca i32, align 4
  %dstName.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1178545479, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @testf.47(i8* %name) #0 {
entry:
  %inStr = alloca %struct._IO_FILE*, align 8
  %name.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1000314272, i32* %canary
  %allOK = alloca i8, align 1
  %statBuf = alloca %struct.stat, align 8
  store i8* %name, i8** %name.addr, align 8
  store i8 0, i8* @deleteOutputOnInterrupt, align 1
...
entry:
  %n.addr = alloca %struct.UInt64*, align 8
  %canary = alloca i32
  store i32 1455453829, i32* %canary
  %i = alloca i32, align 4
  %retval = alloca i8, align 1
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
  store i32 0, i32* %i, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @addFlagsFromEnvVar.49(%struct.zzzz** %argList, i8* %varName) #0 {
entry:
  %p = alloca i8*, align 8
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 887047724, i32* %canary
...
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1162312633, i32* %canary
  %n.addr = alloca %struct.UInt64*, align 8
  %retval = alloca i8, align 1
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
  store i32 0, i32* %i, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @testStream.51(%struct._IO_FILE* %zStream) #0 {
entry:
  %ret = alloca i32, align 4
  %bzerr_dummy = alloca i32, align 4
  %bzerr = alloca i32, align 4
  ...
  %unused = alloca [5000 x i8], align 16
  %canary = alloca i32
  store i32 1699926373, i32* %canary
  %obuf = alloca [5000 x i8], align 16
  %streamNo = alloca i32, align 4
  %i = alloca i32, align 4
  store %struct._IO_FILE* %zStream, %struct._IO_FILE** %zStream.addr, align 8
...
entry:
  %retval = alloca i8, align 1
  %canary = alloca i32
  store i32 844726188, i32* %canary
  %f.addr = alloca %struct._IO_FILE*, align 8
  %c = alloca i32, align 4
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** %f.addr, align 8
...
entry:
  ...
  %root.addr = alloca %struct.zzzz*, align 8
  %canary = alloca i32
  store i32 1018156388, i32* %canary
  %name.addr = alloca i8*, align 8
  %tmp = alloca %struct.zzzz*, align 8
  store %struct.zzzz* %root, %struct.zzzz** %root.addr, align 8
  store i8* %name, i8** %name.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @hasSuffix.55(i8* %s, i8* %suffix) #0 {
entry:
  %canary = alloca i32
  store i32 1263474458, i32* %canary
  %nx = alloca i32, align 4
  %ns = alloca i32, align 4
  %suffix.addr = alloca i8*, align 8
  %s.addr = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @notAStandardFile.56(i8* %name) #0 {
entry:
  %statBuf = alloca %struct.stat, align 8
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 429975125, i32* %canary
  %name.addr = alloca i8*, align 8
  %retval = alloca i8, align 1
  store i8* %name, i8** %name.addr, align 8
  %0 = load i8*, i8** %name.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @testf.57(i8* %name) #0 {
entry:
  %canary = alloca i32
  store i32 676700110, i32* %canary
  %statBuf = alloca %struct.stat, align 8
  %inStr = alloca %struct._IO_FILE*, align 8
  %name.addr = alloca i8*, align 8
  %allOK = alloca i8, align 1
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct._IO_FILE* @fopen_output_safely.58(i8* %name, i8* %mode) #0 {
entry:
  %fp = alloca %struct._IO_FILE*, align 8
  %fh = alloca i32, align 4
  %retval = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 1129274360, i32* %canary
  %name.addr = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @testStream.59(%struct._IO_FILE* %zStream) #0 {
entry:
  %canary = alloca i32
  store i32 1480900116, i32* %canary
  %bzf = alloca i8*, align 8
  %i = alloca i32, align 4
  %ret = alloca i32, align 4
  %bzerr_dummy = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @notAStandardFile.60(i8* %name) #0 {
entry:
  %canary = alloca i32
  store i32 488868130, i32* %canary
  %name.addr = alloca i8*, align 8
  %statBuf = alloca %struct.stat, align 8
  %i = alloca i32, align 4
  %retval = alloca i8, align 1
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @pad.61(i8* %s) #0 {
entry:
  %canary = alloca i32
  store i32 679604900, i32* %canary
  %i = alloca i32, align 4
  %s.addr = alloca i8*, align 8
  store i8* %s, i8** %s.addr, align 8
  %0 = load i8*, i8** %s.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct._IO_FILE* @fopen_output_safely.62(i8* %name, i8* %mode) #0 {
entry:
  %mode.addr = alloca i8*, align 8
  %fp = alloca %struct._IO_FILE*, align 8
  %fh = alloca i32, align 4
  %name.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 504567943, i32* %canary
  %retval = alloca %struct._IO_FILE*, align 8
  store i8* %name, i8** %name.addr, align 8
  store i8* %mode, i8** %mode.addr, align 8
  %0 = load i8*, i8** %name.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @uncompressStream.64(%struct._IO_FILE* %zStream, %struct._IO_FILE* %stream) #0 {
entry:
  %stream.addr = alloca %struct._IO_FILE*, align 8
  %unusedTmp = alloca i8*, align 8
  %unusedTmpV = alloca i8*, align 8
  %unused = alloca [5000 x i8], align 16
  %canary = alloca i32
  store i32 374305357, i32* %canary
  %obuf = alloca [5000 x i8], align 16
  %bzerr = alloca i32, align 4
  %bzf = alloca i8*, align 8
  %zStream.addr = alloca %struct._IO_FILE*, align 8
...
entry:
  ...
  %bzerr_dummy = alloca i32, align 4
  %canary = alloca i32
  store i32 421702611, i32* %canary
  %nread = alloca i32, align 4
  %unusedTmpV = alloca i8*, align 8
  %unused = alloca [5000 x i8], align 16
  %ret = alloca i32, align 4
...
entry:
  ...
  %name.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1727205319, i32* %canary
  %mode.addr = alloca i8*, align 8
  %fp = alloca %struct._IO_FILE*, align 8
  store i8* %name, i8** %name.addr, align 8
  store i8* %mode, i8** %mode.addr, align 8
...
; Function Attrs: noinline noreturn nounwind optnone uwtable
define internal void @cleanUpAndFail.67(i32 %ec) #5 {
entry:
  %retVal = alloca i32, align 4
  %ec.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 189604924, i32* %canary
  %statBuf = alloca %struct.stat, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @countHardLinks.68(i8* %name) #0 {
entry:
  %statBuf = alloca %struct.stat, align 8
  %canary = alloca i32
  store i32 584533070, i32* %canary
  %i = alloca i32, align 4
  %retval = alloca i32, align 4
  %name.addr = alloca i8*, align 8
  store i8* %name, i8** %name.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1147967216, i32* %canary
  %f.addr = alloca %struct._IO_FILE*, align 8
  %retval = alloca i8, align 1
  %c = alloca i32, align 4
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @uncompress.70(i8* %name) #0 {
entry:
  %name.addr = alloca i8*, align 8
  %retVal168 = alloca i32, align 4
  %n = alloca i32, align 4
  ...
  %outStr = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 1764793794, i32* %canary
  %magicNumberOK = alloca i8, align 1
  %i = alloca i32, align 4
  %cantGuess = alloca i8, align 1
  %inStr = alloca %struct._IO_FILE*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @applySavedMetaInfoToOutputFile.71(i8* %dstName) #0 {
entry:
  %canary = alloca i32
  store i32 1581800909, i32* %canary
  %uTimBuf = alloca %struct.utimbuf, align 8
  %dstName.addr = alloca i8*, align 8
  %retVal = alloca i32, align 4
  store i8* %dstName, i8** %dstName.addr, align 8
...
entry:
  %ec.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 229327248, i32* %canary
  %statBuf = alloca %struct.stat, align 8
  %retVal = alloca i32, align 4
  store i32 %ec, i32* %ec.addr, align 4
  %0 = load i32, i32* @srcMode, align 4
...
entry:
  %nx = alloca i32, align 4
  %canary = alloca i32
  store i32 1378998150, i32* %canary
  %s.addr = alloca i8*, align 8
  %retval = alloca i8, align 1
  %suffix.addr = alloca i8*, align 8
  %ns = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @testf.74(i8* %name) #0 {
entry:
  %allOK = alloca i8, align 1
  %canary = alloca i32
  store i32 1668842781, i32* %canary
  %inStr = alloca %struct._IO_FILE*, align 8
  %name.addr = alloca i8*, align 8
  %statBuf = alloca %struct.stat, align 8
  store i8* %name, i8** %name.addr, align 8
...
entry:
  %tmp = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 2139562911, i32* %canary
  %exists = alloca i8, align 1
  %name.addr = alloca i8*, align 8
  store i8* %name, i8** %name.addr, align 8
  %0 = load i8*, i8** %name.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct._IO_FILE* @fopen_output_safely.76(i8* %name, i8* %mode) #0 {
entry:
  %fh = alloca i32, align 4
  %retval = alloca %struct._IO_FILE*, align 8
  %name.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1011618297, i32* %canary
  %mode.addr = alloca i8*, align 8
  %fp = alloca %struct._IO_FILE*, align 8
  store i8* %name, i8** %name.addr, align 8
  store i8* %mode, i8** %mode.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @uInt64_toAscii.77(i8* %outbuf, %struct.UInt64* %n) #0 {
entry:
  %i = alloca i32, align 4
  %q = alloca i32, align 4
  %n_copy = alloca %struct.UInt64, align 1
  ...
  %nBuf = alloca i32, align 4
  %canary = alloca i32
  store i32 1462700452, i32* %canary
  %outbuf.addr = alloca i8*, align 8
  store i8* %outbuf, i8** %outbuf.addr, align 8
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
  store i32 0, i32* %nBuf, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @fileExists.78(i8* %name) #0 {
entry:
  %name.addr = alloca i8*, align 8
  %tmp = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 471121065, i32* %canary
  %exists = alloca i8, align 1
  store i8* %name, i8** %name.addr, align 8
  %0 = load i8*, i8** %name.addr, align 8
  %call = call %struct._IO_FILE* @fopen(i8* %0, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.66, i64 0, i64 0))
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @fileExists.79(i8* %name) #0 {
entry:
  %tmp = alloca %struct._IO_FILE*, align 8
  %name.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 244693150, i32* %canary
  %exists = alloca i8, align 1
  store i8* %name, i8** %name.addr, align 8
  %0 = load i8*, i8** %name.addr, align 8
  %call = call %struct._IO_FILE* @fopen(i8* %0, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.66, i64 0, i64 0))
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @addFlagsFromEnvVar.80(%struct.zzzz** %argList, i8* %varName) #0 {
entry:
  %p = alloca i8*, align 8
  %argList.addr = alloca %struct.zzzz**, align 8
  %varName.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1075804725, i32* %canary
  %k = alloca i32, align 4
  %j = alloca i32, align 4
  %envbase = alloca i8*, align 8
  %i = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 395025508, i32* %canary
  %retVal = alloca i32, align 4
  %uTimBuf = alloca %struct.utimbuf, align 8
  %dstName.addr = alloca i8*, align 8
  store i8* %dstName, i8** %dstName.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @testStream.82(%struct._IO_FILE* %zStream) #0 {
entry:
  %i = alloca i32, align 4
  %bzerr = alloca i32, align 4
  %streamNo = alloca i32, align 4
  %canary = alloca i32
  store i32 1805884368, i32* %canary
  %unused = alloca [5000 x i8], align 16
  %nread = alloca i32, align 4
  %bzerr_dummy = alloca i32, align 4
  %bzf = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @uInt64_toAscii.83(i8* %outbuf, %struct.UInt64* %n) #0 {
entry:
  %q = alloca i32, align 4
  %n.addr = alloca %struct.UInt64*, align 8
  %n_copy = alloca %struct.UInt64, align 1
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 901353399, i32* %canary
  %nBuf = alloca i32, align 4
  %outbuf.addr = alloca i8*, align 8
  store i8* %outbuf, i8** %outbuf.addr, align 8
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @addFlagsFromEnvVar.84(%struct.zzzz** %argList, i8* %varName) #0 {
entry:
  %p = alloca i8*, align 8
  %canary = alloca i32
  store i32 1742914633, i32* %canary
  %envbase = alloca i8*, align 8
  %argList.addr = alloca %struct.zzzz**, align 8
  %varName.addr = alloca i8*, align 8
  %k = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @compressStream.85(%struct._IO_FILE* %stream, %struct._IO_FILE* %zStream) #0 {
entry:
  %ret = alloca i32, align 4
  %nbytes_in_d = alloca double, align 8
  %nbytes_in_lo32 = alloca i32, align 4
  %canary = alloca i32
  store i32 1814082696, i32* %canary
  %buf_nout = alloca [32 x i8], align 16
  %nbytes_out_d = alloca double, align 8
  %nbytes_out_lo32 = alloca i32, align 4
  %nbytes_in_hi32 = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @notAStandardFile.86(i8* %name) #0 {
entry:
  %statBuf = alloca %struct.stat, align 8
  %canary = alloca i32
  store i32 1280744736, i32* %canary
  %retval = alloca i8, align 1
  %name.addr = alloca i8*, align 8
  %i = alloca i32, align 4
  store i8* %name, i8** %name.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 2115816708, i32* %canary
  %dstName.addr = alloca i8*, align 8
  %retVal = alloca i32, align 4
  %uTimBuf = alloca %struct.utimbuf, align 8
  store i8* %dstName, i8** %dstName.addr, align 8
...
; Function Attrs: noinline noreturn nounwind optnone uwtable
define internal void @cleanUpAndFail.88(i32 %ec) #5 {
entry:
  %statBuf = alloca %struct.stat, align 8
  %canary = alloca i32
  store i32 1149466527, i32* %canary
  %retVal = alloca i32, align 4
  %ec.addr = alloca i32, align 4
  store i32 %ec, i32* %ec.addr, align 4
  %0 = load i32, i32* @srcMode, align 4
...
; Function Attrs: noinline noreturn nounwind optnone uwtable
define internal void @cleanUpAndFail.89(i32 %ec) #5 {
entry:
  %ec.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 872005897, i32* %canary
  %retVal = alloca i32, align 4
  %statBuf = alloca %struct.stat, align 8
  store i32 %ec, i32* %ec.addr, align 4
  %0 = load i32, i32* @srcMode, align 4
...
entry:
  ...
  %bzerr_dummy = alloca i32, align 4
  %canary = alloca i32
  store i32 1013754904, i32* %canary
  %retval = alloca i8, align 1
  %unused = alloca [5000 x i8], align 16
  %bzerr = alloca i32, align 4
  %zStream.addr = alloca %struct._IO_FILE*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @addFlagsFromEnvVar.91(%struct.zzzz** %argList, i8* %varName) #0 {
entry:
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1701886164, i32* %canary
  %varName.addr = alloca i8*, align 8
  %k = alloca i32, align 4
  %envbase = alloca i8*, align 8
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @myfeof.92(%struct._IO_FILE* %f) #0 {
entry:
  %f.addr = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 1009776867, i32* %canary
  %c = alloca i32, align 4
  %retval = alloca i8, align 1
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** %f.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @uInt64_qrm10.93(%struct.UInt64* %n) #0 {
entry:
  %n.addr = alloca %struct.UInt64*, align 8
  %canary = alloca i32
  store i32 267815219, i32* %canary
  %i = alloca i32, align 4
  %rem = alloca i32, align 4
  %tmp = alloca i32, align 4
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
...
entry:
  ...
  %tmp = alloca i32, align 4
  %canary = alloca i32
  store i32 1988012636, i32* %canary
  %n.addr = alloca %struct.UInt64*, align 8
  %rem = alloca i32, align 4
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
  store i32 0, i32* %rem, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @countHardLinks.95(i8* %name) #0 {
entry:
  %i = alloca i32, align 4
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1994538441, i32* %canary
  %statBuf = alloca %struct.stat, align 8
  %name.addr = alloca i8*, align 8
  store i8* %name, i8** %name.addr, align 8
  %0 = load i8*, i8** %name.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 645158475, i32* %canary
  %i = alloca i32, align 4
  %retval = alloca i32, align 4
  %name.addr = alloca i8*, align 8
  %statBuf = alloca %struct.stat, align 8
