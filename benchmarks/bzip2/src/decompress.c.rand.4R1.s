...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$757776942, -20(%rbp)   # imm = 0x2D2AC22E
	movq	%rdi, -16(%rbp)
	movq	-16(%rbp), %rax
	movl	$0, 3192(%rax)
	movl	$0, -4(%rbp)
...
.LBB2_5:                                # %for.inc
	...
	jmp	.LBB2_1
.LBB2_6:                                # %for.end
	cmpl	$757776942, -20(%rbp)   # imm = 0x2D2AC22E
	jne	.LBB2_8
.LBB2_7:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1601162858, -20(%rbp)  # imm = 0x5F6FCE6A
	movq	%rdi, -16(%rbp)
	movq	-16(%rbp), %rax
	movl	$0, 3192(%rax)
	movl	$0, -4(%rbp)
...
.LBB3_5:                                # %for.inc
	...
	jmp	.LBB3_1
.LBB3_6:                                # %for.end
	cmpl	$1601162858, -20(%rbp)  # imm = 0x5F6FCE6A
	jne	.LBB3_8
.LBB3_7:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_offset %rbx, -24
	movl	$1704299359, -216(%rbp) # imm = 0x65958B5F
	movq	%rdi, -16(%rbp)
	movq	-16(%rbp), %rax
	movq	(%rax), %rax
	movq	%rax, -192(%rbp)
...
.LBB4_673:                              # %save_state_and_return
	...
	movq	%rax, 64136(%rcx)
	movl	-28(%rbp), %ebx
	cmpl	$1704299359, -216(%rbp) # imm = 0x65958B5F
	jne	.LBB4_675
.LBB4_674:
	movl	%ebx, %eax
...
# %bb.0:                                # %entry
	...
	subq	$392, %rsp              # imm = 0x188
	.cfi_offset %rbx, -24
	movl	$1952930975, -268(%rbp) # imm = 0x74675C9F
	movq	%rdi, -16(%rbp)
	movq	-16(%rbp), %rax
	movq	(%rax), %rax
	movq	%rax, -192(%rbp)
...
.LBB5_673:                              # %save_state_and_return
	...
	movq	%rax, 64136(%rcx)
	movl	-28(%rbp), %ebx
	cmpl	$1952930975, -268(%rbp) # imm = 0x74675C9F
	jne	.LBB5_675
.LBB5_674:
	movl	%ebx, %eax
	addq	$392, %rsp              # imm = 0x188
...
# %bb.0:                                # %entry
	...
	subq	$392, %rsp              # imm = 0x188
	.cfi_offset %rbx, -24
	movl	$398813998, -308(%rbp)  # imm = 0x17C56B2E
	movq	%rdi, -16(%rbp)
	movq	-16(%rbp), %rax
	movq	(%rax), %rax
	movq	%rax, -192(%rbp)
...
.LBB6_673:                              # %save_state_and_return
	...
	movq	%rax, 64136(%rcx)
	movl	-28(%rbp), %ebx
	cmpl	$398813998, -308(%rbp)  # imm = 0x17C56B2E
	jne	.LBB6_675
.LBB6_674:
	movl	%ebx, %eax
	addq	$392, %rsp              # imm = 0x188
...
# %bb.0:                                # %entry
	...
	subq	$392, %rsp              # imm = 0x188
	.cfi_offset %rbx, -24
	movl	$488798651, -272(%rbp)  # imm = 0x1D2279BB
	movq	%rdi, -16(%rbp)
	movq	-16(%rbp), %rax
	movq	(%rax), %rax
	movq	%rax, -192(%rbp)
...
.LBB7_673:                              # %save_state_and_return
	...
	movq	%rax, 64136(%rcx)
	movl	-28(%rbp), %ebx
	cmpl	$488798651, -272(%rbp)  # imm = 0x1D2279BB
	jne	.LBB7_675
.LBB7_674:
	movl	%ebx, %eax
	addq	$392, %rsp              # imm = 0x188
