...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1898249311, -20(%rbp)  # imm = 0x7124FC5F
	movq	%rdi, -16(%rbp)
	movq	-16(%rbp), %rax
	movl	$0, 3192(%rax)
	movl	$0, -4(%rbp)
...
.LBB2_5:                                # %for.inc
	...
	jmp	.LBB2_1
.LBB2_6:                                # %for.end
	cmpl	$1898249311, -20(%rbp)  # imm = 0x7124FC5F
	jne	.LBB2_8
.LBB2_7:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_offset %rbx, -24
	movl	$1218934629, -340(%rbp) # imm = 0x48A77765
	movq	%rdi, -16(%rbp)
	movq	-16(%rbp), %rax
	movq	(%rax), %rax
	movq	%rax, -192(%rbp)
...
.LBB3_673:                              # %save_state_and_return
	...
	movq	%rax, 64136(%rcx)
	movl	-28(%rbp), %ebx
	cmpl	$1218934629, -340(%rbp) # imm = 0x48A77765
	jne	.LBB3_675
.LBB3_674:
	movl	%ebx, %eax
...
# %bb.0:                                # %entry
	...
	subq	$392, %rsp              # imm = 0x188
	.cfi_offset %rbx, -24
	movl	$225068194, -336(%rbp)  # imm = 0xD6A44A2
	movq	%rdi, -16(%rbp)
	movq	-16(%rbp), %rax
	movq	(%rax), %rax
	movq	%rax, -192(%rbp)
...
.LBB4_673:                              # %save_state_and_return
	...
	movq	%rax, 64136(%rcx)
	movl	-28(%rbp), %ebx
	cmpl	$225068194, -336(%rbp)  # imm = 0xD6A44A2
	jne	.LBB4_675
.LBB4_674:
	movl	%ebx, %eax
	addq	$392, %rsp              # imm = 0x188
...
# %bb.0:                                # %entry
	...
	subq	$392, %rsp              # imm = 0x188
	.cfi_offset %rbx, -24
	movl	$474565020, -256(%rbp)  # imm = 0x1C49499C
	movq	%rdi, -16(%rbp)
	movq	-16(%rbp), %rax
	movq	(%rax), %rax
	movq	%rax, -192(%rbp)
...
.LBB5_673:                              # %save_state_and_return
	...
	movq	%rax, 64136(%rcx)
	movl	-28(%rbp), %ebx
	cmpl	$474565020, -256(%rbp)  # imm = 0x1C49499C
	jne	.LBB5_675
.LBB5_674:
	movl	%ebx, %eax
	addq	$392, %rsp              # imm = 0x188
...
# %bb.0:                                # %entry
	...
	subq	$392, %rsp              # imm = 0x188
	.cfi_offset %rbx, -24
	movl	$1871566718, -276(%rbp) # imm = 0x6F8DD77E
	movq	%rdi, -16(%rbp)
	movq	-16(%rbp), %rax
	movq	(%rax), %rax
	movq	%rax, -192(%rbp)
...
.LBB6_673:                              # %save_state_and_return
	...
	movq	%rax, 64136(%rcx)
	movl	-28(%rbp), %ebx
	cmpl	$1871566718, -276(%rbp) # imm = 0x6F8DD77E
	jne	.LBB6_675
.LBB6_674:
	movl	%ebx, %eax
	addq	$392, %rsp              # imm = 0x188
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1228819029, -20(%rbp)  # imm = 0x493E4A55
	movq	%rdi, -16(%rbp)
	movq	-16(%rbp), %rax
	movl	$0, 3192(%rax)
	movl	$0, -4(%rbp)
...
.LBB7_5:                                # %for.inc
	...
	jmp	.LBB7_1
.LBB7_6:                                # %for.end
	cmpl	$1228819029, -20(%rbp)  # imm = 0x493E4A55
	jne	.LBB7_8
.LBB7_7:
	addq	$32, %rsp
	popq	%rbp
