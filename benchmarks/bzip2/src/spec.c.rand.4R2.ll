...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_ran.4, label %ctrl0

func_ran.4:                                       ; preds = %rand_bb
  %2 = call double @ran.4()
  ret double %2

func_ran.6:                                       ; preds = %ctrl0
  %3 = call double @ran.6()
  ret double %3

func_ran.7:                                       ; preds = %ctrl1
  %4 = call double @ran.7()
  ret double %4

func_ran.16:                                      ; preds = %ctrl1
  %5 = call double @ran.16()
  ret double %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_ran.6, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_ran.7, label %func_ran.16
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_spec_init.5, label %ctrl0

func_spec_init.5:                                 ; preds = %rand_bb
  %2 = call i32 @spec_init.5()
  ret i32 %2

func_spec_init.17:                                ; preds = %ctrl0
  %3 = call i32 @spec_init.17()
  ret i32 %3
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_spec_init.17, label %ctrl1
...
func_spec_random_load.30:                         ; preds = %ctrl1
  %4 = call i32 @spec_random_load.30(i32 %fd)
  ret i32 %4

func_spec_random_load.33:                         ; preds = %ctrl1
  %5 = call i32 @spec_random_load.33(i32 %fd)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_spec_random_load.12, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_spec_random_load.30, label %func_spec_random_load.33
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_spec_load.1, label %ctrl0

func_spec_load.1:                                 ; preds = %rand_bb
  %2 = call i32 @spec_load.1(i32 %num, i8* %filename, i32 %size)
  ret i32 %2

func_spec_load.25:                                ; preds = %ctrl0
  %3 = call i32 @spec_load.25(i32 %num, i8* %filename, i32 %size)
  ret i32 %3

func_spec_load.31:                                ; preds = %ctrl1
  %4 = call i32 @spec_load.31(i32 %num, i8* %filename, i32 %size)
  ret i32 %4
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_spec_load.25, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_spec_load.31, label %func_spec_load.35
}
...
func_spec_read.34:                                ; preds = %ctrl1
  %4 = call i32 @spec_read.34(i32 %fd, i8* %buf, i32 %size)
  ret i32 %4

func_spec_read.42:                                ; preds = %ctrl1
  %5 = call i32 @spec_read.42(i32 %fd, i8* %buf, i32 %size)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_spec_read.28, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_spec_read.34, label %func_spec_read.42
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_spec_fread.14, label %ctrl0

func_spec_fread.14:                               ; preds = %rand_bb
  %2 = call i32 @spec_fread.14(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %2
...
func_spec_fread.38:                               ; preds = %ctrl1
  %4 = call i32 @spec_fread.38(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %4

func_spec_fread.40:                               ; preds = %ctrl1
  %5 = call i32 @spec_fread.40(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_spec_fread.37, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_spec_fread.38, label %func_spec_fread.40
}
...
func_spec_getc.15:                                ; preds = %ctrl0
  %3 = call i32 @spec_getc.15(i32 %fd)
  ret i32 %3

func_spec_getc.18:                                ; preds = %ctrl1
  %4 = call i32 @spec_getc.18(i32 %fd)
  ret i32 %4
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_spec_getc.15, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_spec_getc.18, label %func_spec_getc.22
}
...
func_spec_ungetc.10:                              ; preds = %ctrl0
  %3 = call i32 @spec_ungetc.10(i8 %ch, i32 %fd)
  ret i32 %3

func_spec_ungetc.13:                              ; preds = %ctrl1
  %4 = call i32 @spec_ungetc.13(i8 %ch, i32 %fd)
  ret i32 %4

func_spec_ungetc.19:                              ; preds = %ctrl1
  %5 = call i32 @spec_ungetc.19(i8 %ch, i32 %fd)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_spec_ungetc.10, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_spec_ungetc.13, label %func_spec_ungetc.19
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_spec_write.8, label %ctrl0

func_spec_write.8:                                ; preds = %rand_bb
  %2 = call i32 @spec_write.8(i32 %fd, i8* %buf, i32 %size)
  ret i32 %2
...
func_spec_write.39:                               ; preds = %ctrl1
  %4 = call i32 @spec_write.39(i32 %fd, i8* %buf, i32 %size)
  ret i32 %4
...
ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_spec_write.39, label %func_spec_write.41
}
...
func_spec_fwrite.20:                              ; preds = %ctrl0
  %3 = call i32 @spec_fwrite.20(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %3
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_spec_fwrite.20, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_spec_fwrite.32, label %func_spec_fwrite.36
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_spec_putc.24, label %func_spec_putc.29

func_spec_putc.24:                                ; preds = %rand_bb
  %2 = call i32 @spec_putc.24(i8 %ch, i32 %fd)
  ret i32 %2

func_spec_putc.29:                                ; preds = %rand_bb
  %3 = call i32 @spec_putc.29(i8 %ch, i32 %fd)
  ret i32 %3
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_load.1(i32 %num, i8* %filename, i32 %size) #0 {
entry:
  %canary = alloca i32
  store i32 1969924978, i32* %canary
...
entry:
  ...
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 454791514, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 683868051, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_init.5() #0 {
entry:
  %limit = alloca i32, align 4
  %canary = alloca i32
  store i32 2138476074, i32* %canary
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %0 = load i32, i32* @dbglvl, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local double @ran.6() #0 {
entry:
  %hi = alloca i64, align 8
  %canary = alloca i32
  store i32 1926317963, i32* %canary
  %test = alloca i64, align 8
  %lo = alloca i64, align 8
  %0 = load i64, i64* @seedi, align 8
  %div = sdiv i64 %0, 127773
...
entry:
  ...
  %test = alloca i64, align 8
  %canary = alloca i32
  store i32 725862676, i32* %canary
  %hi = alloca i64, align 8
  %0 = load i64, i64* @seedi, align 8
  %div = sdiv i64 %0, 127773
  store i64 %div, i64* %hi, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_write.8(i32 %fd, i8* %buf, i32 %size) #0 {
entry:
  %buf.addr = alloca i8*, align 8
  %size.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 431824994, i32* %canary
  %fd.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
...
entry:
  %rc = alloca i32, align 4
  %canary = alloca i32
  store i32 735877341, i32* %canary
  %fd.addr = alloca i32, align 4
  %ch.addr = alloca i8, align 1
  store i8 %ch, i8* %ch.addr, align 1
  store i32 %fd, i32* %fd.addr, align 4
...
entry:
  %num.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1761293119, i32* %canary
  %size.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %fd.addr = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 116274172, i32* %canary
  %fd.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %random_text = alloca [32 x [131072 x i8]], align 16
...
entry:
  %canary = alloca i32
  store i32 834259148, i32* %canary
  %rc = alloca i32, align 4
  %ch.addr = alloca i8, align 1
  %fd.addr = alloca i32, align 4
  store i8 %ch, i8* %ch.addr, align 1
...
entry:
  ...
  %buf.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 179758139, i32* %canary
  %num.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1291110545, i32* %canary
  %fd.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  store i32 0, i32* %rc, align 4
  %0 = load i32, i32* @dbglvl, align 4
...
entry:
  ...
  %hi = alloca i64, align 8
  %canary = alloca i32
  store i32 1950597529, i32* %canary
  %test = alloca i64, align 8
  %0 = load i64, i64* @seedi, align 8
  %div = sdiv i64 %0, 127773
  store i64 %div, i64* %hi, align 8
...
entry:
  ...
  %rc = alloca i32, align 4
  %canary = alloca i32
  store i32 825577401, i32* %canary
  %retval = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  store i32 0, i32* %rc, align 4
  %0 = load i32, i32* @dbglvl, align 4
...
entry:
  %canary = alloca i32
  store i32 226023784, i32* %canary
  %fd.addr = alloca i32, align 4
  %ch.addr = alloca i8, align 1
  %rc = alloca i32, align 4
  store i8 %ch, i8* %ch.addr, align 1
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_fwrite.20(i8* %buf, i32 %size, i32 %num, i32 %fd) #0 {
entry:
  %buf.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1327952215, i32* %canary
  %fd.addr = alloca i32, align 4
  %num.addr = alloca i32, align 4
  %size.addr = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1922030418, i32* %canary
  %size.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %fd.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
...
entry:
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1632810734, i32* %canary
  %fd.addr = alloca i32, align 4
  %rc = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  store i32 0, i32* %rc, align 4
...
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1274008820, i32* %canary
  %limit = alloca i32, align 4
  %j = alloca i32, align 4
  %0 = load i32, i32* @dbglvl, align 4
  %cmp = icmp slt i32 3, %0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_putc.24(i8 zeroext %ch, i32 %fd) #0 {
entry:
  %canary = alloca i32
  store i32 1221978290, i32* %canary
  %ch.addr = alloca i8, align 1
  %fd.addr = alloca i32, align 4
  store i8 %ch, i8* %ch.addr, align 1
  store i32 %fd, i32* %fd.addr, align 4
...
entry:
  ...
  %tmp = alloca i32, align 4
  %canary = alloca i32
  store i32 821950380, i32* %canary
  %fd = alloca i32, align 4
  %rc = alloca i32, align 4
  %num.addr = alloca i32, align 4
  store i32 %num, i32* %num.addr, align 4
...
entry:
  ...
  %size.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1733630950, i32* %canary
  %rc = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
...
entry:
  ...
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 726785660, i32* %canary
  %rc = alloca i32, align 4
  %retval = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  store i8* %buf, i8** %buf.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_putc.29(i8 zeroext %ch, i32 %fd) #0 {
entry:
  %canary = alloca i32
  store i32 1224942047, i32* %canary
  %fd.addr = alloca i32, align 4
  %ch.addr = alloca i8, align 1
  store i8 %ch, i8* %ch.addr, align 1
  store i32 %fd, i32* %fd.addr, align 4
...
entry:
  ...
  %tmp = alloca i32, align 4
  %canary = alloca i32
  store i32 1211759328, i32* %canary
  %filename.addr = alloca i8*, align 8
  %num.addr = alloca i32, align 4
  store i32 %num, i32* %num.addr, align 4
  store i8* %filename, i8** %filename.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_random_load.33(i32 %fd) #0 {
entry:
  %canary = alloca i32
  store i32 792224125, i32* %canary
  %fd.addr = alloca i32, align 4
  %j = alloca i32, align 4
  %i = alloca i32, align 4
  %random_text = alloca [32 x [131072 x i8]], align 16
...
entry:
  ...
  %buf.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1492986601, i32* %canary
  %retval = alloca i32, align 4
  %rc = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
...
entry:
  %tmp = alloca i32, align 4
  %canary = alloca i32
  store i32 2079981810, i32* %canary
  %fd = alloca i32, align 4
  %filename.addr = alloca i8*, align 8
  %rc = alloca i32, align 4
  %num.addr = alloca i32, align 4
...
entry:
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1139841981, i32* %canary
  %size.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %num.addr = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
...
entry:
  ...
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 819566755, i32* %canary
  %retval = alloca i32, align 4
  %size.addr = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
...
entry:
  %size.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1771539717, i32* %canary
  %retval = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  %rc = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
...
entry:
  ...
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 659049630, i32* %canary
  %size.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_fread.40(i8* %buf, i32 %size, i32 %num, i32 %fd) #0 {
entry:
  %rc = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  %size.addr = alloca i32, align 4
...
entry:
  %size.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1926520143, i32* %canary
  %fd.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  store i32 %fd, i32* %fd.addr, align 4
  store i8* %buf, i8** %buf.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1870279440, i32* %canary
  %retval = alloca i32, align 4
  %size.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %rc = alloca i32, align 4
