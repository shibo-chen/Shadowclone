; ModuleID = 'blocksort.c.rand.4R1.bc'
...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_BZ2_blockSort.21, label %ctrl0

func_BZ2_blockSort.21:                            ; preds = %rand_bb
  call void @BZ2_blockSort.21(%struct.EState* %s)
  ret void

func_BZ2_blockSort.25:                            ; preds = %ctrl0
  call void @BZ2_blockSort.25(%struct.EState* %s)
  ret void

func_BZ2_blockSort.27:                            ; preds = %ctrl1
  call void @BZ2_blockSort.27(%struct.EState* %s)
  ret void

func_BZ2_blockSort.31:                            ; preds = %ctrl1
  call void @BZ2_blockSort.31(%struct.EState* %s)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_BZ2_blockSort.25, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_BZ2_blockSort.27, label %func_BZ2_blockSort.31
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_fallbackSort.1, label %ctrl0

func_fallbackSort.1:                              ; preds = %rand_bb
  call void @fallbackSort.1(i32* %fmap, i32* %eclass, i32* %bhtab, i32 %nblock, i32 %verb)
  ret void

func_fallbackSort.9:                              ; preds = %ctrl0
  call void @fallbackSort.9(i32* %fmap, i32* %eclass, i32* %bhtab, i32 %nblock, i32 %verb)
  ret void

func_fallbackSort.14:                             ; preds = %ctrl1
  call void @fallbackSort.14(i32* %fmap, i32* %eclass, i32* %bhtab, i32 %nblock, i32 %verb)
  ret void

func_fallbackSort.18:                             ; preds = %ctrl1
  call void @fallbackSort.18(i32* %fmap, i32* %eclass, i32* %bhtab, i32 %nblock, i32 %verb)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_fallbackSort.9, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_fallbackSort.14, label %func_fallbackSort.18
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_mainSort.13, label %ctrl0

func_mainSort.13:                                 ; preds = %rand_bb
  call void @mainSort.13(i32* %ptr, i8* %block, i16* %quadrant, i32* %ftab, i32 %nblock, i32 %verb, i32* %budget)
  ret void
...
func_mainSort.17:                                 ; preds = %ctrl1
  call void @mainSort.17(i32* %ptr, i8* %block, i16* %quadrant, i32* %ftab, i32 %nblock, i32 %verb, i32* %budget)
  ret void
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_mainSort.17, label %func_mainSort.29
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_fallbackQSort3.8, label %ctrl0

func_fallbackQSort3.8:                            ; preds = %rand_bb
  call void @fallbackQSort3.8(i32* %fmap, i32* %eclass, i32 %loSt, i32 %hiSt)
  ret void

func_fallbackQSort3.10:                           ; preds = %ctrl0
  call void @fallbackQSort3.10(i32* %fmap, i32* %eclass, i32 %loSt, i32 %hiSt)
  ret void

func_fallbackQSort3.35:                           ; preds = %ctrl1
  call void @fallbackQSort3.35(i32* %fmap, i32* %eclass, i32 %loSt, i32 %hiSt)
  ret void

func_fallbackQSort3.36:                           ; preds = %ctrl1
  call void @fallbackQSort3.36(i32* %fmap, i32* %eclass, i32 %loSt, i32 %hiSt)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_fallbackQSort3.10, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_fallbackQSort3.35, label %func_fallbackQSort3.36
}
...
func_fallbackSimpleSort.16:                       ; preds = %ctrl0
  call void @fallbackSimpleSort.16(i32* %fmap, i32* %eclass, i32 %lo, i32 %hi)
  ret void

func_fallbackSimpleSort.24:                       ; preds = %ctrl1
  call void @fallbackSimpleSort.24(i32* %fmap, i32* %eclass, i32 %lo, i32 %hi)
  ret void

func_fallbackSimpleSort.30:                       ; preds = %ctrl1
  call void @fallbackSimpleSort.30(i32* %fmap, i32* %eclass, i32 %lo, i32 %hi)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_fallbackSimpleSort.16, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_fallbackSimpleSort.24, label %func_fallbackSimpleSort.30
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_mainQSort3.2, label %ctrl0

func_mainQSort3.2:                                ; preds = %rand_bb
  call void @mainQSort3.2(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %loSt, i32 %hiSt, i32 %dSt, i32* %budget)
  ret void

func_mainQSort3.4:                                ; preds = %ctrl0
  call void @mainQSort3.4(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %loSt, i32 %hiSt, i32 %dSt, i32* %budget)
  ret void

func_mainQSort3.6:                                ; preds = %ctrl1
  call void @mainQSort3.6(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %loSt, i32 %hiSt, i32 %dSt, i32* %budget)
  ret void

func_mainQSort3.11:                               ; preds = %ctrl1
  call void @mainQSort3.11(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %loSt, i32 %hiSt, i32 %dSt, i32* %budget)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_mainQSort3.4, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_mainQSort3.6, label %func_mainQSort3.11
}
...
func_mainSimpleSort.12:                           ; preds = %ctrl0
  call void @mainSimpleSort.12(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %lo, i32 %hi, i32 %d, i32* %budget)
  ret void

func_mainSimpleSort.28:                           ; preds = %ctrl1
  call void @mainSimpleSort.28(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %lo, i32 %hi, i32 %d, i32* %budget)
  ret void

func_mainSimpleSort.33:                           ; preds = %ctrl1
  call void @mainSimpleSort.33(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %lo, i32 %hi, i32 %d, i32* %budget)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_mainSimpleSort.12, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_mainSimpleSort.28, label %func_mainSimpleSort.33
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_mmed3.19, label %ctrl0

func_mmed3.19:                                    ; preds = %rand_bb
  %2 = call i8 @mmed3.19(i8 %a, i8 %b, i8 %c)
  ret i8 %2

func_mmed3.20:                                    ; preds = %ctrl0
  %3 = call i8 @mmed3.20(i8 %a, i8 %b, i8 %c)
  ret i8 %3

func_mmed3.22:                                    ; preds = %ctrl1
  %4 = call i8 @mmed3.22(i8 %a, i8 %b, i8 %c)
  ret i8 %4

func_mmed3.34:                                    ; preds = %ctrl1
  %5 = call i8 @mmed3.34(i8 %a, i8 %b, i8 %c)
  ret i8 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_mmed3.20, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_mmed3.22, label %func_mmed3.34
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_mainGtU.7, label %ctrl0

func_mainGtU.7:                                   ; preds = %rand_bb
  %2 = call i8 @mainGtU.7(i32 %i1, i32 %i2, i8* %block, i16* %quadrant, i32 %nblock, i32* %budget)
  ret i8 %2
...
func_mainGtU.32:                                  ; preds = %ctrl1
  %5 = call i8 @mainGtU.32(i32 %i1, i32 %i2, i8* %block, i16* %quadrant, i32 %nblock, i32* %budget)
  ret i8 %5
...
ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_mainGtU.26, label %func_mainGtU.32
}

; Function Attrs: noinline nounwind optnone uwtable
define internal void @fallbackSort.1(i32* %fmap, i32* %eclass, i32* %bhtab, i32 %nblock, i32 %verb) #0 {
entry:
  %i = alloca i32, align 4
  %nBhtab = alloca i32, align 4
  %canary = alloca i32
  store i32 748477816, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @mainQSort3.2(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %loSt, i32 %hiSt, i32 %dSt, i32* %budget) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 1825003521, i32* %canary
...
while.end302:                                     ; preds = %if.then16, %while.cond
  ...
  %254 = icmp eq i32 %253, 1825003521
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1277650942, i32* %canary
  %h = alloca i32, align 4
...
for.end:                                          ; preds = %if.then94, %for.cond, %if.then
  ...
  %113 = icmp eq i32 %112, 1277650942
...
entry:
  ...
  %unHi = alloca i32, align 4
  %canary = alloca i32
  store i32 973803268, i32* %canary
  %nblock.addr = alloca i32, align 4
  %dSt.addr = alloca i32, align 4
  %lo = alloca i32, align 4
  %m = alloca i32, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 1925313152, i32* %canary
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @mainQSort3.6(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %loSt, i32 %hiSt, i32 %dSt, i32* %budget) #0 {
entry:
  %budget.addr = alloca i32*, align 8
  %hi = alloca i32, align 4
  %zztmp141 = alloca i32, align 4
  ...
  %stackHi = alloca [100 x i32], align 16
  %canary = alloca i32
  store i32 434063380, i32* %canary
  %yyp2165 = alloca i32, align 4
  %ltLo = alloca i32, align 4
  %stackD = alloca [100 x i32], align 16
  %tz258 = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @mainGtU.7(i32 %i1, i32 %i2, i8* %block, i16* %quadrant, i32 %nblock, i32* %budget) #0 {
entry:
  ...
  %block.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 169675995, i32* %canary
  %budget.addr = alloca i32*, align 8
...
entry:
  ...
  %m = alloca i32, align 4
  %canary = alloca i32
  store i32 201904374, i32* %canary
  %hiSt.addr = alloca i32, align 4
  %ltLo = alloca i32, align 4
...
entry:
  ...
  %r = alloca i32, align 4
  %canary = alloca i32
  store i32 276184792, i32* %canary
  %i = alloca i32, align 4
  %cc = alloca i32, align 4
  %nblock.addr = alloca i32, align 4
  %l = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @fallbackQSort3.10(i32* %fmap, i32* %eclass, i32 %loSt, i32 %hiSt) #0 {
entry:
  %zztmp117 = alloca i32, align 4
  %lo = alloca i32, align 4
  %eclass.addr = alloca i32*, align 8
  ...
  %r3 = alloca i32, align 4
  %canary = alloca i32
  store i32 1780211193, i32* %canary
  %yyp2 = alloca i32, align 4
  %yyn143 = alloca i32, align 4
  %med = alloca i32, align 4
  %yyp1139 = alloca i32, align 4
...
while.end192:                                     ; preds = %while.cond
  %189 = load i32, i32* %canary
  %190 = icmp eq i32 %189, 1780211193
  br i1 %190, label %191, label %func_exit
...
entry:
  ...
  %ltLo = alloca i32, align 4
  %canary = alloca i32
  store i32 2108995760, i32* %canary
  %stackHi = alloca [100 x i32], align 16
  %tz235 = alloca i32, align 4
  %budget.addr = alloca i32*, align 8
  %hiSt.addr = alloca i32, align 4
...
while.end302:                                     ; preds = %if.then16, %while.cond
  %253 = load i32, i32* %canary
  %254 = icmp eq i32 %253, 2108995760
  br i1 %254, label %255, label %func_exit
...
entry:
  ...
  %budget.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 1958856132, i32* %canary
  %lo.addr = alloca i32, align 4
  %j = alloca i32, align 4
  store i32* %ptr, i32** %ptr.addr, align 8
  store i8* %block, i8** %block.addr, align 8
...
for.end:                                          ; preds = %if.then94, %for.cond, %if.then
  %112 = load i32, i32* %canary
  %113 = icmp eq i32 %112, 1958856132
  br i1 %113, label %114, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @mainSort.13(i32* %ptr, i8* %block, i16* %quadrant, i32* %ftab, i32 %nblock, i32 %verb, i32* %budget) #0 {
entry:
  %quadrant.addr = alloca i16*, align 8
  %lo = alloca i32, align 4
  ...
  %c1 = alloca i8, align 1
  %canary = alloca i32
  store i32 626975544, i32* %canary
  %ptr.addr = alloca i32*, align 8
  %budget.addr = alloca i32*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @fallbackSort.14(i32* %fmap, i32* %eclass, i32* %bhtab, i32 %nblock, i32 %verb) #0 {
entry:
  %eclass.addr = alloca i32*, align 8
  %ftab = alloca [257 x i32], align 16
  %j = alloca i32, align 4
  ...
  %cc = alloca i32, align 4
  %canary = alloca i32
  store i32 340741868, i32* %canary
  %H = alloca i32, align 4
  %cc1 = alloca i32, align 4
  store i32* %fmap, i32** %fmap.addr, align 8
  store i32* %eclass, i32** %eclass.addr, align 8
...
entry:
  ...
  %vv = alloca i32, align 4
  %canary = alloca i32
  store i32 881771970, i32* %canary
  %a2update = alloca i32, align 4
  %k = alloca i32, align 4
  %ftab.addr = alloca i32*, align 8
  %ss = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @fallbackSimpleSort.16(i32* %fmap, i32* %eclass, i32 %lo, i32 %hi) #0 {
entry:
  %canary = alloca i32
  store i32 1586326757, i32* %canary
  %fmap.addr = alloca i32*, align 8
  %j = alloca i32, align 4
  %lo.addr = alloca i32, align 4
  %hi.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @mainSort.17(i32* %ptr, i8* %block, i16* %quadrant, i32* %ftab, i32 %nblock, i32 %verb, i32* %budget) #0 {
entry:
  %shifts = alloca i32, align 4
  %bbSize = alloca i32, align 4
  %j = alloca i32, align 4
  ...
  %copyStart = alloca [256 x i32], align 16
  %canary = alloca i32
  store i32 1801453234, i32* %canary
  %verb.addr = alloca i32, align 4
  %a2update = alloca i32, align 4
  store i32* %ptr, i32** %ptr.addr, align 8
  store i8* %block, i8** %block.addr, align 8
...
if.end514:                                        ; preds = %if.then511, %for.end508, %if.then318
  %345 = load i32, i32* %canary
  %346 = icmp eq i32 %345, 1801453234
  br i1 %346, label %347, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @fallbackSort.18(i32* %fmap, i32* %eclass, i32* %bhtab, i32 %nblock, i32 %verb) #0 {
entry:
  %H = alloca i32, align 4
  %eclass8 = alloca i8*, align 8
  %nNotDone = alloca i32, align 4
  ...
  %cc1 = alloca i32, align 4
  %canary = alloca i32
  store i32 930465612, i32* %canary
  %r = alloca i32, align 4
  %j = alloca i32, align 4
  %i = alloca i32, align 4
  %bhtab.addr = alloca i32*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @mmed3.19(i8 zeroext %a, i8 zeroext %b, i8 zeroext %c) #0 {
entry:
  %canary = alloca i32
  store i32 96402075, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @mmed3.20(i8 zeroext %a, i8 zeroext %b, i8 zeroext %c) #0 {
entry:
  %canary = alloca i32
  store i32 1046185535, i32* %canary
  %b.addr = alloca i8, align 1
  %t = alloca i8, align 1
  %c.addr = alloca i8, align 1
  %a.addr = alloca i8, align 1
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @BZ2_blockSort.21(%struct.EState* %s) #0 {
entry:
  %wfact = alloca i32, align 4
  %i = alloca i32, align 4
  %block = alloca i8*, align 8
  %canary = alloca i32
  store i32 1793503969, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @mmed3.22(i8 zeroext %a, i8 zeroext %b, i8 zeroext %c) #0 {
entry:
  %a.addr = alloca i8, align 1
  %canary = alloca i32
  store i32 90297642, i32* %canary
  %c.addr = alloca i8, align 1
  %b.addr = alloca i8, align 1
  %t = alloca i8, align 1
  store i8 %a, i8* %a.addr, align 1
...
entry:
  ...
  %i2.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1451559574, i32* %canary
  %k = alloca i32, align 4
  %c1 = alloca i8, align 1
  %c2 = alloca i8, align 1
  %quadrant.addr = alloca i16*, align 8
...
return:                                           ; preds = %do.end, %if.then445, %if.then430, %if.then413, %if.then398, %if.then381, %if.then366, %if.then349, %if.then334, %if.then317, %if.then302, %if.then285, %if.then270, %if.then253, %if.then238, %if.then221, %if.then206, %if.then189, %if.then172, %if.then155, %if.then138, %if.then121, %if.then104, %if.then87, %if.then70, %if.then53, %if.then36, %if.then19, %if.then
  %333 = load i8, i8* %retval, align 1
  %334 = load i32, i32* %canary
  %335 = icmp eq i32 %334, 1451559574
  br i1 %335, label %336, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @fallbackSimpleSort.24(i32* %fmap, i32* %eclass, i32 %lo, i32 %hi) #0 {
entry:
  %lo.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 87875902, i32* %canary
  %j = alloca i32, align 4
  %hi.addr = alloca i32, align 4
  %ec_tmp = alloca i32, align 4
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @BZ2_blockSort.25(%struct.EState* %s) #0 {
entry:
  %block = alloca i8*, align 8
  %ftab = alloca i32*, align 8
  %verb = alloca i32, align 4
  ...
  %nblock = alloca i32, align 4
  %canary = alloca i32
  store i32 286008984, i32* %canary
  %budget = alloca i32, align 4
  %s.addr = alloca %struct.EState*, align 8
  %quadrant = alloca i16*, align 8
  %i = alloca i32, align 4
...
entry:
  ...
  %i2.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 602105364, i32* %canary
  %block.addr = alloca i8*, align 8
  %i1.addr = alloca i32, align 4
  %budget.addr = alloca i32*, align 8
  %quadrant.addr = alloca i16*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @BZ2_blockSort.27(%struct.EState* %s) #0 {
entry:
  %block = alloca i8*, align 8
  %ftab = alloca i32*, align 8
  %budget = alloca i32, align 4
  %canary = alloca i32
  store i32 1889686815, i32* %canary
  %ptr = alloca i32*, align 8
  %wfact = alloca i32, align 4
  %s.addr = alloca %struct.EState*, align 8
  %verb = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @mainSimpleSort.28(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %lo, i32 %hi, i32 %d, i32* %budget) #0 {
entry:
  %ptr.addr = alloca i32*, align 8
  %j = alloca i32, align 4
  %lo.addr = alloca i32, align 4
  ...
  %nblock.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1727183470, i32* %canary
  %i = alloca i32, align 4
  %v = alloca i32, align 4
  %hi.addr = alloca i32, align 4
  %bigN = alloca i32, align 4
...
for.end:                                          ; preds = %if.then94, %for.cond, %if.then
  %112 = load i32, i32* %canary
  %113 = icmp eq i32 %112, 1727183470
  br i1 %113, label %114, label %func_exit
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1473440611, i32* %canary
  %lo = alloca i32, align 4
  %bbStart = alloca i32, align 4
  %copyStart = alloca [256 x i32], align 16
  %copyEnd = alloca [256 x i32], align 16
...
if.end514:                                        ; preds = %if.then511, %for.end508, %if.then318
  %345 = load i32, i32* %canary
  %346 = icmp eq i32 %345, 1473440611
  br i1 %346, label %347, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @fallbackSimpleSort.30(i32* %fmap, i32* %eclass, i32 %lo, i32 %hi) #0 {
entry:
  %fmap.addr = alloca i32*, align 8
  %lo.addr = alloca i32, align 4
  %hi.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 730105143, i32* %canary
  %tmp = alloca i32, align 4
  %i = alloca i32, align 4
  %eclass.addr = alloca i32*, align 8
  %j = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @BZ2_blockSort.31(%struct.EState* %s) #0 {
entry:
  %wfact = alloca i32, align 4
  %s.addr = alloca %struct.EState*, align 8
  %budget = alloca i32, align 4
  ...
  %nblock = alloca i32, align 4
  %canary = alloca i32
  store i32 1146650774, i32* %canary
  %ptr = alloca i32*, align 8
  store %struct.EState* %s, %struct.EState** %s.addr, align 8
  %0 = load %struct.EState*, %struct.EState** %s.addr, align 8
  %ptr1 = getelementptr inbounds %struct.EState, %struct.EState* %0, i32 0, i32 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @mainGtU.32(i32 %i1, i32 %i2, i8* %block, i16* %quadrant, i32 %nblock, i32* %budget) #0 {
entry:
  %nblock.addr = alloca i32, align 4
  %i2.addr = alloca i32, align 4
  %s2 = alloca i16, align 2
  ...
  %budget.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 1009441151, i32* %canary
  %retval = alloca i8, align 1
  %block.addr = alloca i8*, align 8
  store i32 %i1, i32* %i1.addr, align 4
  store i32 %i2, i32* %i2.addr, align 4
...
return:                                           ; preds = %do.end, %if.then445, %if.then430, %if.then413, %if.then398, %if.then381, %if.then366, %if.then349, %if.then334, %if.then317, %if.then302, %if.then285, %if.then270, %if.then253, %if.then238, %if.then221, %if.then206, %if.then189, %if.then172, %if.then155, %if.then138, %if.then121, %if.then104, %if.then87, %if.then70, %if.then53, %if.then36, %if.then19, %if.then
  %333 = load i8, i8* %retval, align 1
  %334 = load i32, i32* %canary
  %335 = icmp eq i32 %334, 1009441151
  br i1 %335, label %336, label %func_exit
...
entry:
  %v = alloca i32, align 4
  %canary = alloca i32
  store i32 541734124, i32* %canary
  %d.addr = alloca i32, align 4
  %nblock.addr = alloca i32, align 4
  %h = alloca i32, align 4
  %ptr.addr = alloca i32*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @mmed3.34(i8 zeroext %a, i8 zeroext %b, i8 zeroext %c) #0 {
entry:
  %a.addr = alloca i8, align 1
  %b.addr = alloca i8, align 1
  %c.addr = alloca i8, align 1
  %canary = alloca i32
  store i32 1042737774, i32* %canary
  %t = alloca i8, align 1
  store i8 %a, i8* %a.addr, align 1
  store i8 %b, i8* %b.addr, align 1
  store i8 %c, i8* %c.addr, align 1
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @fallbackQSort3.35(i32* %fmap, i32* %eclass, i32 %loSt, i32 %hiSt) #0 {
entry:
  %zztmp117 = alloca i32, align 4
  %med = alloca i32, align 4
  %canary = alloca i32
  store i32 2083286809, i32* %canary
  %yyp1139 = alloca i32, align 4
  %ltLo = alloca i32, align 4
  %yyp2140 = alloca i32, align 4
  %r = alloca i32, align 4
...
while.end192:                                     ; preds = %while.cond
  %189 = load i32, i32* %canary
  %190 = icmp eq i32 %189, 2083286809
  br i1 %190, label %191, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @fallbackQSort3.36(i32* %fmap, i32* %eclass, i32 %loSt, i32 %hiSt) #0 {
entry:
  %fmap.addr = alloca i32*, align 8
  %lo = alloca i32, align 4
  %stackLo = alloca [100 x i32], align 16
  ...
  %zztmp147 = alloca i32, align 4
  %canary = alloca i32
  store i32 1468028969, i32* %canary
  %stackHi = alloca [100 x i32], align 16
  %unLo = alloca i32, align 4
  %n = alloca i32, align 4
  %med = alloca i32, align 4
...
while.end192:                                     ; preds = %while.cond
  %189 = load i32, i32* %canary
  %190 = icmp eq i32 %189, 1468028969
  br i1 %190, label %191, label %func_exit
