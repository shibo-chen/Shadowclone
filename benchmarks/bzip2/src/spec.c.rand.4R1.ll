...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_ran.23, label %ctrl0

func_ran.23:                                      ; preds = %rand_bb
  %2 = call double @ran.23()
  ret double %2

func_ran.28:                                      ; preds = %ctrl0
  %3 = call double @ran.28()
  ret double %3

func_ran.32:                                      ; preds = %ctrl1
  %4 = call double @ran.32()
  ret double %4

func_ran.40:                                      ; preds = %ctrl1
  %5 = call double @ran.40()
  ret double %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_ran.28, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_ran.32, label %func_ran.40
}
...
func_spec_init.25:                                ; preds = %ctrl0
  %3 = call i32 @spec_init.25()
  ret i32 %3

func_spec_init.34:                                ; preds = %ctrl1
  %4 = call i32 @spec_init.34()
  ret i32 %4
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_spec_init.25, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_spec_init.34, label %func_spec_init.38
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_spec_random_load.7, label %ctrl0

func_spec_random_load.7:                          ; preds = %rand_bb
  %2 = call i32 @spec_random_load.7(i32 %fd)
  ret i32 %2
...
func_spec_random_load.15:                         ; preds = %ctrl1
  %4 = call i32 @spec_random_load.15(i32 %fd)
  ret i32 %4

func_spec_random_load.18:                         ; preds = %ctrl1
  %5 = call i32 @spec_random_load.18(i32 %fd)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_spec_random_load.10, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_spec_random_load.15, label %func_spec_random_load.18
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_spec_load.6, label %ctrl0

func_spec_load.6:                                 ; preds = %rand_bb
  %2 = call i32 @spec_load.6(i32 %num, i8* %filename, i32 %size)
  ret i32 %2

func_spec_load.27:                                ; preds = %ctrl0
  %3 = call i32 @spec_load.27(i32 %num, i8* %filename, i32 %size)
  ret i32 %3

func_spec_load.36:                                ; preds = %ctrl1
  %4 = call i32 @spec_load.36(i32 %num, i8* %filename, i32 %size)
  ret i32 %4

func_spec_load.41:                                ; preds = %ctrl1
  %5 = call i32 @spec_load.41(i32 %num, i8* %filename, i32 %size)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_spec_load.27, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_spec_load.36, label %func_spec_load.41
}
...
func_spec_read.37:                                ; preds = %ctrl1
  %4 = call i32 @spec_read.37(i32 %fd, i8* %buf, i32 %size)
  ret i32 %4
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_spec_read.22, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_spec_read.37, label %func_spec_read.39
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_spec_fread.2, label %ctrl0

func_spec_fread.2:                                ; preds = %rand_bb
  %2 = call i32 @spec_fread.2(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %2

func_spec_fread.4:                                ; preds = %ctrl0
  %3 = call i32 @spec_fread.4(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %3

func_spec_fread.8:                                ; preds = %ctrl1
  %4 = call i32 @spec_fread.8(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %4
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_spec_fread.4, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_spec_fread.8, label %func_spec_fread.13
}
...
func_spec_getc.24:                                ; preds = %ctrl1
  %4 = call i32 @spec_getc.24(i32 %fd)
  ret i32 %4

func_spec_getc.26:                                ; preds = %ctrl1
  %5 = call i32 @spec_getc.26(i32 %fd)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_spec_getc.17, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_spec_getc.24, label %func_spec_getc.26
}
...
func_spec_ungetc.30:                              ; preds = %ctrl0
  %3 = call i32 @spec_ungetc.30(i8 %ch, i32 %fd)
  ret i32 %3

func_spec_ungetc.33:                              ; preds = %ctrl1
  %4 = call i32 @spec_ungetc.33(i8 %ch, i32 %fd)
  ret i32 %4

func_spec_ungetc.35:                              ; preds = %ctrl1
  %5 = call i32 @spec_ungetc.35(i8 %ch, i32 %fd)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_spec_ungetc.30, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_spec_ungetc.33, label %func_spec_ungetc.35
}
...
func_spec_write.29:                               ; preds = %ctrl1
  %5 = call i32 @spec_write.29(i32 %fd, i8* %buf, i32 %size)
  ret i32 %5
...
ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_spec_write.16, label %func_spec_write.29
}
...
func_spec_fwrite.14:                              ; preds = %ctrl0
  %3 = call i32 @spec_fwrite.14(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %3

func_spec_fwrite.20:                              ; preds = %ctrl1
  %4 = call i32 @spec_fwrite.20(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %4

func_spec_fwrite.42:                              ; preds = %ctrl1
  %5 = call i32 @spec_fwrite.42(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_spec_fwrite.14, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_spec_fwrite.20, label %func_spec_fwrite.42
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_spec_putc.21, label %func_spec_putc.31

func_spec_putc.21:                                ; preds = %rand_bb
  %2 = call i32 @spec_putc.21(i8 %ch, i32 %fd)
  ret i32 %2

func_spec_putc.31:                                ; preds = %rand_bb
  %3 = call i32 @spec_putc.31(i8 %ch, i32 %fd)
  ret i32 %3
}
...
entry:
  ...
  %canary = alloca i32
  store i32 2009217782, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_fread.2(i8* %buf, i32 %size, i32 %num, i32 %fd) #0 {
entry:
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 2003173747, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1026406867, i32* %canary
  %rc = alloca i32, align 4
  %retval = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_fread.4(i8* %buf, i32 %size, i32 %num, i32 %fd) #0 {
entry:
  %size.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 583579557, i32* %canary
  %rc = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %num.addr = alloca i32, align 4
...
entry:
  ...
  %size.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2048893358, i32* %canary
  %fd.addr = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
  store i32 %num, i32* %num.addr, align 4
...
entry:
  %rc = alloca i32, align 4
  %canary = alloca i32
  store i32 2104682376, i32* %canary
  %num.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_random_load.7(i32 %fd) #0 {
entry:
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 285833776, i32* %canary
  %j = alloca i32, align 4
  %i = alloca i32, align 4
...
entry:
  ...
  %buf.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 510432683, i32* %canary
  %num.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  %rc = alloca i32, align 4
  %size.addr = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 929099921, i32* %canary
...
entry:
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1103012036, i32* %canary
  %fd.addr = alloca i32, align 4
  %random_text = alloca [32 x [131072 x i8]], align 16
  %i = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 251668973, i32* %canary
  %size.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %fd.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
...
entry:
  %size.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 286006262, i32* %canary
  %fd.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  store i32 %fd, i32* %fd.addr, align 4
  store i8* %buf, i8** %buf.addr, align 8
...
entry:
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1815251797, i32* %canary
  %rc = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %size.addr = alloca i32, align 4
  %retval = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_fwrite.14(i8* %buf, i32 %size, i32 %num, i32 %fd) #0 {
entry:
  %buf.addr = alloca i8*, align 8
  %num.addr = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1792290922, i32* %canary
  %size.addr = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
  store i32 %num, i32* %num.addr, align 4
...
entry:
  ...
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1731835381, i32* %canary
  %random_text = alloca [32 x [131072 x i8]], align 16
  store i32 %fd, i32* %fd.addr, align 4
  %0 = load i32, i32* @dbglvl, align 4
  %cmp = icmp slt i32 4, %0
...
entry:
  ...
  %buf.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1957403856, i32* %canary
  %size.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
...
entry:
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 413635763, i32* %canary
  %rc = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  store i32 0, i32* %rc, align 4
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 2002334663, i32* %canary
  %j = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  %0 = load i32, i32* @dbglvl, align 4
  %cmp = icmp slt i32 4, %0
...
entry:
  %canary = alloca i32
  store i32 2066711405, i32* %canary
  %retval = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  %size.addr = alloca i32, align 4
  %rc = alloca i32, align 4
...
entry:
  ...
  %buf.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 611155839, i32* %canary
  %size.addr = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
  store i32 %num, i32* %num.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_putc.21(i8 zeroext %ch, i32 %fd) #0 {
entry:
  %canary = alloca i32
  store i32 424862989, i32* %canary
  %fd.addr = alloca i32, align 4
  %ch.addr = alloca i8, align 1
  store i8 %ch, i8* %ch.addr, align 1
  store i32 %fd, i32* %fd.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 1353134169, i32* %canary
  %fd.addr = alloca i32, align 4
  %size.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  %rc = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 876348295, i32* %canary
...
entry:
  ...
  %rc = alloca i32, align 4
  %canary = alloca i32
  store i32 754120512, i32* %canary
  %retval = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  store i32 0, i32* %rc, align 4
  %0 = load i32, i32* @dbglvl, align 4
...
entry:
  %canary = alloca i32
  store i32 609061865, i32* %canary
  %j = alloca i32, align 4
  %i = alloca i32, align 4
  %limit = alloca i32, align 4
  %0 = load i32, i32* @dbglvl, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_getc.26(i32 %fd) #0 {
entry:
  %fd.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1138273190, i32* %canary
  %rc = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  store i32 0, i32* %rc, align 4
  %0 = load i32, i32* @dbglvl, align 4
...
entry:
  ...
  %rc = alloca i32, align 4
  %canary = alloca i32
  store i32 1117252715, i32* %canary
  %filename.addr = alloca i8*, align 8
  %tmp = alloca i32, align 4
  %fd = alloca i32, align 4
  store i32 %num, i32* %num.addr, align 4
...
entry:
  %lo = alloca i64, align 8
  %canary = alloca i32
  store i32 419436197, i32* %canary
  %test = alloca i64, align 8
  %hi = alloca i64, align 8
  %0 = load i64, i64* @seedi, align 8
  %div = sdiv i64 %0, 127773
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_write.29(i32 %fd, i8* %buf, i32 %size) #0 {
entry:
  %canary = alloca i32
  store i32 1598952841, i32* %canary
  %buf.addr = alloca i8*, align 8
  %fd.addr = alloca i32, align 4
  %size.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
...
entry:
  ...
  %rc = alloca i32, align 4
  %canary = alloca i32
  store i32 1131576196, i32* %canary
  %fd.addr = alloca i32, align 4
  store i8 %ch, i8* %ch.addr, align 1
  store i32 %fd, i32* %fd.addr, align 4
  store i32 0, i32* %rc, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_putc.31(i8 zeroext %ch, i32 %fd) #0 {
entry:
  %ch.addr = alloca i8, align 1
  %canary = alloca i32
  store i32 632687807, i32* %canary
  %fd.addr = alloca i32, align 4
  store i8 %ch, i8* %ch.addr, align 1
  store i32 %fd, i32* %fd.addr, align 4
  %0 = load i32, i32* @dbglvl, align 4
...
entry:
  %canary = alloca i32
  store i32 845048253, i32* %canary
  %hi = alloca i64, align 8
  %test = alloca i64, align 8
  %lo = alloca i64, align 8
  %0 = load i64, i64* @seedi, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_ungetc.33(i8 zeroext %ch, i32 %fd) #0 {
entry:
  %canary = alloca i32
  store i32 63945200, i32* %canary
  %rc = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  %ch.addr = alloca i8, align 1
  store i8 %ch, i8* %ch.addr, align 1
...
entry:
  %rc = alloca i32, align 4
  %canary = alloca i32
  store i32 1037929344, i32* %canary
  %ch.addr = alloca i8, align 1
  %fd.addr = alloca i32, align 4
  store i8 %ch, i8* %ch.addr, align 1
  store i32 %fd, i32* %fd.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 1822865353, i32* %canary
  %rc = alloca i32, align 4
  %i = alloca i32, align 4
  %size.addr = alloca i32, align 4
  %fd = alloca i32, align 4
...
entry:
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1142089996, i32* %canary
  %size.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %rc = alloca i32, align 4
  %retval = alloca i32, align 4
...
entry:
  ...
  %limit = alloca i32, align 4
  %canary = alloca i32
  store i32 291461200, i32* %canary
  %i = alloca i32, align 4
  %0 = load i32, i32* @dbglvl, align 4
  %cmp = icmp slt i32 3, %0
  br i1 %cmp, label %if.then, label %if.end
...
entry:
  %canary = alloca i32
  store i32 1395934682, i32* %canary
  %fd.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  %rc = alloca i32, align 4
  %size.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local double @ran.40() #0 {
entry:
  %test = alloca i64, align 8
  %lo = alloca i64, align 8
  %canary = alloca i32
  store i32 1702932484, i32* %canary
  %hi = alloca i64, align 8
  %0 = load i64, i64* @seedi, align 8
  %div = sdiv i64 %0, 127773
  store i64 %div, i64* %hi, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_load.41(i32 %num, i8* %filename, i32 %size) #0 {
entry:
  %tmp = alloca i32, align 4
  %fd = alloca i32, align 4
  %num.addr = alloca i32, align 4
  %filename.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 500584551, i32* %canary
  %rc = alloca i32, align 4
  %i = alloca i32, align 4
  %size.addr = alloca i32, align 4
  store i32 %num, i32* %num.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_fwrite.42(i8* %buf, i32 %size, i32 %num, i32 %fd) #0 {
entry:
  %buf.addr = alloca i8*, align 8
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1071234191, i32* %canary
  %num.addr = alloca i32, align 4
  %size.addr = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
