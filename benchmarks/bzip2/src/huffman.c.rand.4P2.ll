; ModuleID = 'huffman.c.rand.4P2.bc'
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_BZ2_hbMakeCodeLengths.4, label %func_BZ2_hbMakeCodeLengths.6
}
...
func_BZ2_hbAssignCodes.12:                        ; preds = %ctrl1
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_BZ2_hbAssignCodes.8, label %func_BZ2_hbAssignCodes.12
}
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_BZ2_hbCreateDecodeTables.9, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_BZ2_hbCreateDecodeTables.10, label %func_BZ2_hbCreateDecodeTables.11
}
...
entry:
  ...
  %canary = alloca i32
  store i32 1984072776, i32* %canary
...
while.end234:                                     ; preds = %if.then218
  ...
  %152 = icmp eq i32 %151, 1984072776
...
entry:
  ...
  %zz92 = alloca i32, align 4
  %canary = alloca i32
  store i32 293229888, i32* %canary
  %k = alloca i32, align 4
  %tmp171 = alloca i32, align 4
  %tmp = alloca i32, align 4
  %tmp48 = alloca i32, align 4
...
entry:
  ...
  %zz47 = alloca i32, align 4
  %canary = alloca i32
  store i32 1278960704, i32* %canary
  %tooLong = alloca i8, align 1
  %j = alloca i32, align 4
  %tmp48 = alloca i32, align 4
  %zz92 = alloca i32, align 4
...
while.end234:                                     ; preds = %if.then218
  %151 = load i32, i32* %canary
  %152 = icmp eq i32 %151, 1278960704
  br i1 %152, label %153, label %func_exit
...
entry:
  ...
  %vec = alloca i32, align 4
  %canary = alloca i32
  store i32 235776577, i32* %canary
  %code.addr = alloca i32*, align 8
  %alphaSize.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %length.addr = alloca i8*, align 8
...
entry:
  ...
  %tmp94 = alloca i32, align 4
  %canary = alloca i32
  store i32 1662405800, i32* %canary
  %tmp171 = alloca i32, align 4
  %yy93 = alloca i32, align 4
  %freq.addr = alloca i32*, align 8
  %k = alloca i32, align 4
...
while.end234:                                     ; preds = %if.then218
  %151 = load i32, i32* %canary
  %152 = icmp eq i32 %151, 1662405800
  br i1 %152, label %153, label %func_exit
...
entry:
  ...
  %maxLen.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 648878834, i32* %canary
...
entry:
  ...
  %vec = alloca i32, align 4
  %canary = alloca i32
  store i32 466443112, i32* %canary
  %n = alloca i32, align 4
  %minLen.addr = alloca i32, align 4
  %length.addr = alloca i8*, align 8
  store i32* %code, i32** %code.addr, align 8
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1220902399, i32* %canary
  %limit.addr = alloca i32*, align 8
  %base.addr = alloca i32*, align 8
  %maxLen.addr = alloca i32, align 4
  %perm.addr = alloca i32*, align 8
...
entry:
  ...
  %limit.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 335155605, i32* %canary
  %vec = alloca i32, align 4
  %maxLen.addr = alloca i32, align 4
  %alphaSize.addr = alloca i32, align 4
  %j = alloca i32, align 4
...
entry:
  ...
  %limit.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 948432438, i32* %canary
  %base.addr = alloca i32*, align 8
  %alphaSize.addr = alloca i32, align 4
  %vec = alloca i32, align 4
  %pp = alloca i32, align 4
...
entry:
  %maxLen.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1754606789, i32* %canary
  %vec = alloca i32, align 4
  %n = alloca i32, align 4
  %length.addr = alloca i8*, align 8
  %minLen.addr = alloca i32, align 4
