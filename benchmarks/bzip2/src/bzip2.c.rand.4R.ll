...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_fopen_output_safely.19, label %ctrl0

func_fopen_output_safely.19:                      ; preds = %rand_bb
  %2 = call %struct._IO_FILE* @fopen_output_safely.19(i8* %name, i8* %mode)
  ret %struct._IO_FILE* %2

func_fopen_output_safely.22:                      ; preds = %ctrl0
  %3 = call %struct._IO_FILE* @fopen_output_safely.22(i8* %name, i8* %mode)
  ret %struct._IO_FILE* %3

func_fopen_output_safely.66:                      ; preds = %ctrl1
  %4 = call %struct._IO_FILE* @fopen_output_safely.66(i8* %name, i8* %mode)
  ret %struct._IO_FILE* %4

func_fopen_output_safely.75:                      ; preds = %ctrl1
  %5 = call %struct._IO_FILE* @fopen_output_safely.75(i8* %name, i8* %mode)
  ret %struct._IO_FILE* %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_fopen_output_safely.22, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_fopen_output_safely.66, label %func_fopen_output_safely.75
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_copyFileName.82, label %func_copyFileName.84

func_copyFileName.82:                             ; preds = %rand_bb
  call void @copyFileName.82(i8* %to, i8* %from)
  ret void

func_copyFileName.84:                             ; preds = %rand_bb
  call void @copyFileName.84(i8* %to, i8* %from)
  ret void
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_addFlagsFromEnvVar.28, label %ctrl0

func_addFlagsFromEnvVar.28:                       ; preds = %rand_bb
  call void @addFlagsFromEnvVar.28(%struct.zzzz** %argList, i8* %varName)
  ret void

func_addFlagsFromEnvVar.36:                       ; preds = %ctrl0
  call void @addFlagsFromEnvVar.36(%struct.zzzz** %argList, i8* %varName)
  ret void

func_addFlagsFromEnvVar.62:                       ; preds = %ctrl1
  call void @addFlagsFromEnvVar.62(%struct.zzzz** %argList, i8* %varName)
  ret void

func_addFlagsFromEnvVar.64:                       ; preds = %ctrl1
  call void @addFlagsFromEnvVar.64(%struct.zzzz** %argList, i8* %varName)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_addFlagsFromEnvVar.36, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_addFlagsFromEnvVar.62, label %func_addFlagsFromEnvVar.64
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_snocString.15, label %ctrl0

func_snocString.15:                               ; preds = %rand_bb
  %2 = call %struct.zzzz* @snocString.15(%struct.zzzz* %root, i8* %name)
  ret %struct.zzzz* %2

func_snocString.59:                               ; preds = %ctrl0
  %3 = call %struct.zzzz* @snocString.59(%struct.zzzz* %root, i8* %name)
  ret %struct.zzzz* %3

func_snocString.63:                               ; preds = %ctrl1
  %4 = call %struct.zzzz* @snocString.63(%struct.zzzz* %root, i8* %name)
  ret %struct.zzzz* %4

func_snocString.95:                               ; preds = %ctrl1
  %5 = call %struct.zzzz* @snocString.95(%struct.zzzz* %root, i8* %name)
  ret %struct.zzzz* %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_snocString.59, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_snocString.63, label %func_snocString.95
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_compress.4, label %ctrl0

func_compress.4:                                  ; preds = %rand_bb
  call void @compress.4(i8* %name)
  ret void

func_compress.41:                                 ; preds = %ctrl0
  call void @compress.41(i8* %name)
  ret void

func_compress.46:                                 ; preds = %ctrl1
  call void @compress.46(i8* %name)
  ret void

func_compress.68:                                 ; preds = %ctrl1
  call void @compress.68(i8* %name)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_compress.41, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_compress.46, label %func_compress.68
}
...
func_uncompress.77:                               ; preds = %ctrl0
  call void @uncompress.77(i8* %name)
  ret void

func_uncompress.79:                               ; preds = %ctrl1
  call void @uncompress.79(i8* %name)
  ret void

func_uncompress.91:                               ; preds = %ctrl1
  call void @uncompress.91(i8* %name)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_uncompress.77, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_uncompress.79, label %func_uncompress.91
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_testf.18, label %ctrl0

func_testf.18:                                    ; preds = %rand_bb
  call void @testf.18(i8* %name)
  ret void

func_testf.25:                                    ; preds = %ctrl0
  call void @testf.25(i8* %name)
  ret void

func_testf.53:                                    ; preds = %ctrl1
  call void @testf.53(i8* %name)
  ret void

func_testf.54:                                    ; preds = %ctrl1
  call void @testf.54(i8* %name)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_testf.25, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_testf.53, label %func_testf.54
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_cleanUpAndFail.3, label %ctrl0

func_cleanUpAndFail.3:                            ; preds = %rand_bb
  call void @cleanUpAndFail.3(i32 %ec)
  ret void

func_cleanUpAndFail.9:                            ; preds = %ctrl0
  call void @cleanUpAndFail.9(i32 %ec)
  ret void

func_cleanUpAndFail.31:                           ; preds = %ctrl1
  call void @cleanUpAndFail.31(i32 %ec)
  ret void

func_cleanUpAndFail.58:                           ; preds = %ctrl1
  call void @cleanUpAndFail.58(i32 %ec)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_cleanUpAndFail.9, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_cleanUpAndFail.31, label %func_cleanUpAndFail.58
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_myMalloc.7, label %func_myMalloc.27

func_myMalloc.7:                                  ; preds = %rand_bb
  %2 = call i8* @myMalloc.7(i32 %n)
  ret i8* %2

func_myMalloc.27:                                 ; preds = %rand_bb
  %3 = call i8* @myMalloc.27(i32 %n)
  ret i8* %3
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_fileExists.17, label %ctrl0

func_fileExists.17:                               ; preds = %rand_bb
  %2 = call i8 @fileExists.17(i8* %name)
  ret i8 %2

func_fileExists.24:                               ; preds = %ctrl0
  %3 = call i8 @fileExists.24(i8* %name)
  ret i8 %3

func_fileExists.57:                               ; preds = %ctrl1
  %4 = call i8 @fileExists.57(i8* %name)
  ret i8 %4

func_fileExists.69:                               ; preds = %ctrl1
  %5 = call i8 @fileExists.69(i8* %name)
  ret i8 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_fileExists.24, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_fileExists.57, label %func_fileExists.69
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_hasSuffix.6, label %ctrl0

func_hasSuffix.6:                                 ; preds = %rand_bb
  %2 = call i8 @hasSuffix.6(i8* %s, i8* %suffix)
  ret i8 %2

func_hasSuffix.39:                                ; preds = %ctrl0
  %3 = call i8 @hasSuffix.39(i8* %s, i8* %suffix)
  ret i8 %3

func_hasSuffix.44:                                ; preds = %ctrl1
  %4 = call i8 @hasSuffix.44(i8* %s, i8* %suffix)
  ret i8 %4
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_hasSuffix.39, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_hasSuffix.44, label %func_hasSuffix.71
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_notAStandardFile.10, label %ctrl0

func_notAStandardFile.10:                         ; preds = %rand_bb
  %2 = call i8 @notAStandardFile.10(i8* %name)
  ret i8 %2

func_notAStandardFile.30:                         ; preds = %ctrl0
  %3 = call i8 @notAStandardFile.30(i8* %name)
  ret i8 %3

func_notAStandardFile.90:                         ; preds = %ctrl1
  %4 = call i8 @notAStandardFile.90(i8* %name)
  ret i8 %4

func_notAStandardFile.96:                         ; preds = %ctrl1
  %5 = call i8 @notAStandardFile.96(i8* %name)
  ret i8 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_notAStandardFile.30, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_notAStandardFile.90, label %func_notAStandardFile.96
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_countHardLinks.2, label %ctrl0

func_countHardLinks.2:                            ; preds = %rand_bb
  %2 = call i32 @countHardLinks.2(i8* %name)
  ret i32 %2

func_countHardLinks.74:                           ; preds = %ctrl0
  %3 = call i32 @countHardLinks.74(i8* %name)
  ret i32 %3

func_countHardLinks.81:                           ; preds = %ctrl1
  %4 = call i32 @countHardLinks.81(i8* %name)
  ret i32 %4

func_countHardLinks.86:                           ; preds = %ctrl1
  %5 = call i32 @countHardLinks.86(i8* %name)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_countHardLinks.74, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_countHardLinks.81, label %func_countHardLinks.86
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_saveInputFileMetaInfo.13, label %func_saveInputFileMetaInfo.34

func_saveInputFileMetaInfo.13:                    ; preds = %rand_bb
  call void @saveInputFileMetaInfo.13(i8* %srcName)
  ret void

func_saveInputFileMetaInfo.34:                    ; preds = %rand_bb
  call void @saveInputFileMetaInfo.34(i8* %srcName)
  ret void
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_pad.20, label %func_pad.80

func_pad.20:                                      ; preds = %rand_bb
  call void @pad.20(i8* %s)
  ret void

func_pad.80:                                      ; preds = %rand_bb
  call void @pad.80(i8* %s)
  ret void
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_compressStream.52, label %ctrl0

func_compressStream.52:                           ; preds = %rand_bb
  call void @compressStream.52(%struct._IO_FILE* %stream, %struct._IO_FILE* %zStream)
  ret void

func_compressStream.76:                           ; preds = %ctrl0
  call void @compressStream.76(%struct._IO_FILE* %stream, %struct._IO_FILE* %zStream)
  ret void

func_compressStream.93:                           ; preds = %ctrl1
  call void @compressStream.93(%struct._IO_FILE* %stream, %struct._IO_FILE* %zStream)
  ret void

func_compressStream.94:                           ; preds = %ctrl1
  call void @compressStream.94(%struct._IO_FILE* %stream, %struct._IO_FILE* %zStream)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_compressStream.76, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_compressStream.93, label %func_compressStream.94
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_applySavedMetaInfoToOutputFile.1, label %ctrl0

func_applySavedMetaInfoToOutputFile.1:            ; preds = %rand_bb
  call void @applySavedMetaInfoToOutputFile.1(i8* %dstName)
  ret void

func_applySavedMetaInfoToOutputFile.55:           ; preds = %ctrl0
  call void @applySavedMetaInfoToOutputFile.55(i8* %dstName)
  ret void

func_applySavedMetaInfoToOutputFile.56:           ; preds = %ctrl1
  call void @applySavedMetaInfoToOutputFile.56(i8* %dstName)
  ret void

func_applySavedMetaInfoToOutputFile.61:           ; preds = %ctrl1
  call void @applySavedMetaInfoToOutputFile.61(i8* %dstName)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_applySavedMetaInfoToOutputFile.55, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_applySavedMetaInfoToOutputFile.56, label %func_applySavedMetaInfoToOutputFile.61
}
...
func_myfeof.87:                                   ; preds = %ctrl0
  %3 = call i8 @myfeof.87(%struct._IO_FILE* %f)
  ret i8 %3

func_myfeof.88:                                   ; preds = %ctrl1
  %4 = call i8 @myfeof.88(%struct._IO_FILE* %f)
  ret i8 %4

func_myfeof.89:                                   ; preds = %ctrl1
  %5 = call i8 @myfeof.89(%struct._IO_FILE* %f)
  ret i8 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_myfeof.87, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_myfeof.88, label %func_myfeof.89
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_uInt64_from_UInt32s.12, label %ctrl0

func_uInt64_from_UInt32s.12:                      ; preds = %rand_bb
  call void @uInt64_from_UInt32s.12(%struct.UInt64* %n, i32 %lo32, i32 %hi32)
  ret void

func_uInt64_from_UInt32s.33:                      ; preds = %ctrl0
  call void @uInt64_from_UInt32s.33(%struct.UInt64* %n, i32 %lo32, i32 %hi32)
  ret void

func_uInt64_from_UInt32s.47:                      ; preds = %ctrl1
  call void @uInt64_from_UInt32s.47(%struct.UInt64* %n, i32 %lo32, i32 %hi32)
  ret void

func_uInt64_from_UInt32s.65:                      ; preds = %ctrl1
  call void @uInt64_from_UInt32s.65(%struct.UInt64* %n, i32 %lo32, i32 %hi32)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_uInt64_from_UInt32s.33, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_uInt64_from_UInt32s.47, label %func_uInt64_from_UInt32s.65
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_uInt64_to_double.45, label %ctrl0

func_uInt64_to_double.45:                         ; preds = %rand_bb
  %2 = call double @uInt64_to_double.45(%struct.UInt64* %n)
  ret double %2

func_uInt64_to_double.60:                         ; preds = %ctrl0
  %3 = call double @uInt64_to_double.60(%struct.UInt64* %n)
  ret double %3

func_uInt64_to_double.83:                         ; preds = %ctrl1
  %4 = call double @uInt64_to_double.83(%struct.UInt64* %n)
  ret double %4

func_uInt64_to_double.92:                         ; preds = %ctrl1
  %5 = call double @uInt64_to_double.92(%struct.UInt64* %n)
  ret double %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_uInt64_to_double.60, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_uInt64_to_double.83, label %func_uInt64_to_double.92
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_uInt64_toAscii.40, label %ctrl0

func_uInt64_toAscii.40:                           ; preds = %rand_bb
  call void @uInt64_toAscii.40(i8* %outbuf, %struct.UInt64* %n)
  ret void

func_uInt64_toAscii.49:                           ; preds = %ctrl0
  call void @uInt64_toAscii.49(i8* %outbuf, %struct.UInt64* %n)
  ret void

func_uInt64_toAscii.72:                           ; preds = %ctrl1
  call void @uInt64_toAscii.72(i8* %outbuf, %struct.UInt64* %n)
  ret void

func_uInt64_toAscii.73:                           ; preds = %ctrl1
  call void @uInt64_toAscii.73(i8* %outbuf, %struct.UInt64* %n)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_uInt64_toAscii.49, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_uInt64_toAscii.72, label %func_uInt64_toAscii.73
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_uInt64_qrm10.23, label %ctrl0

func_uInt64_qrm10.23:                             ; preds = %rand_bb
  %2 = call i32 @uInt64_qrm10.23(%struct.UInt64* %n)
  ret i32 %2

func_uInt64_qrm10.37:                             ; preds = %ctrl0
  %3 = call i32 @uInt64_qrm10.37(%struct.UInt64* %n)
  ret i32 %3

func_uInt64_qrm10.43:                             ; preds = %ctrl1
  %4 = call i32 @uInt64_qrm10.43(%struct.UInt64* %n)
  ret i32 %4

func_uInt64_qrm10.70:                             ; preds = %ctrl1
  %5 = call i32 @uInt64_qrm10.70(%struct.UInt64* %n)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_uInt64_qrm10.37, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_uInt64_qrm10.43, label %func_uInt64_qrm10.70
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_uInt64_isZero.11, label %ctrl0

func_uInt64_isZero.11:                            ; preds = %rand_bb
  %2 = call i8 @uInt64_isZero.11(%struct.UInt64* %n)
  ret i8 %2

func_uInt64_isZero.42:                            ; preds = %ctrl0
  %3 = call i8 @uInt64_isZero.42(%struct.UInt64* %n)
  ret i8 %3
...
func_uInt64_isZero.78:                            ; preds = %ctrl1
  %5 = call i8 @uInt64_isZero.78(%struct.UInt64* %n)
  ret i8 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_uInt64_isZero.42, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_uInt64_isZero.48, label %func_uInt64_isZero.78
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_mapSuffix.16, label %ctrl0

func_mapSuffix.16:                                ; preds = %rand_bb
  %2 = call i8 @mapSuffix.16(i8* %name, i8* %oldSuffix, i8* %newSuffix)
  ret i8 %2

func_mapSuffix.38:                                ; preds = %ctrl0
  %3 = call i8 @mapSuffix.38(i8* %name, i8* %oldSuffix, i8* %newSuffix)
  ret i8 %3

func_mapSuffix.50:                                ; preds = %ctrl1
  %4 = call i8 @mapSuffix.50(i8* %name, i8* %oldSuffix, i8* %newSuffix)
  ret i8 %4

func_mapSuffix.85:                                ; preds = %ctrl1
  %5 = call i8 @mapSuffix.85(i8* %name, i8* %oldSuffix, i8* %newSuffix)
  ret i8 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_mapSuffix.38, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_mapSuffix.50, label %func_mapSuffix.85
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_uncompressStream.5, label %ctrl0

func_uncompressStream.5:                          ; preds = %rand_bb
  %2 = call i8 @uncompressStream.5(%struct._IO_FILE* %zStream, %struct._IO_FILE* %stream)
  ret i8 %2

func_uncompressStream.8:                          ; preds = %ctrl0
  %3 = call i8 @uncompressStream.8(%struct._IO_FILE* %zStream, %struct._IO_FILE* %stream)
  ret i8 %3

func_uncompressStream.26:                         ; preds = %ctrl1
  %4 = call i8 @uncompressStream.26(%struct._IO_FILE* %zStream, %struct._IO_FILE* %stream)
  ret i8 %4

func_uncompressStream.51:                         ; preds = %ctrl1
  %5 = call i8 @uncompressStream.51(%struct._IO_FILE* %zStream, %struct._IO_FILE* %stream)
  ret i8 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_uncompressStream.8, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_uncompressStream.26, label %func_uncompressStream.51
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_testStream.14, label %ctrl0

func_testStream.14:                               ; preds = %rand_bb
  %2 = call i8 @testStream.14(%struct._IO_FILE* %zStream)
  ret i8 %2

func_testStream.32:                               ; preds = %ctrl0
  %3 = call i8 @testStream.32(%struct._IO_FILE* %zStream)
  ret i8 %3

func_testStream.35:                               ; preds = %ctrl1
  %4 = call i8 @testStream.35(%struct._IO_FILE* %zStream)
  ret i8 %4

func_testStream.67:                               ; preds = %ctrl1
  %5 = call i8 @testStream.67(%struct._IO_FILE* %zStream)
  ret i8 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_testStream.32, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_testStream.35, label %func_testStream.67
}

; Function Attrs: noinline nounwind optnone uwtable
define internal void @applySavedMetaInfoToOutputFile.1(i8* %dstName) #0 {
entry:
  %retVal = alloca i32, align 4
  %canary = alloca i32
  store i32 1028327203, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @countHardLinks.2(i8* %name) #0 {
entry:
  %statBuf = alloca %struct.stat, align 8
  %canary = alloca i32
  store i32 416859369, i32* %canary
  %i = alloca i32, align 4
  %name.addr = alloca i8*, align 8
  %retval = alloca i32, align 4
  store i8* %name, i8** %name.addr, align 8
...
; Function Attrs: noinline noreturn nounwind optnone uwtable
define internal void @cleanUpAndFail.3(i32 %ec) #5 {
entry:
  %statBuf = alloca %struct.stat, align 8
  %retVal = alloca i32, align 4
  %canary = alloca i32
  store i32 1174129525, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @compress.4(i8* %name) #0 {
entry:
  %canary = alloca i32
  store i32 612250087, i32* %canary
  %statBuf = alloca %struct.stat, align 8
  %name.addr = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @uncompressStream.5(%struct._IO_FILE* %zStream, %struct._IO_FILE* %stream) #0 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @hasSuffix.6(i8* %s, i8* %suffix) #0 {
entry:
  %ns = alloca i32, align 4
  %s.addr = alloca i8*, align 8
  %nx = alloca i32, align 4
  %canary = alloca i32
  store i32 1976712698, i32* %canary
  %retval = alloca i8, align 1
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i8* @myMalloc.7(i32 %n) #0 {
entry:
  %canary = alloca i32
  store i32 1483119269, i32* %canary
  %p = alloca i8*, align 8
  %n.addr = alloca i32, align 4
  store i32 %n, i32* %n.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @uncompressStream.8(%struct._IO_FILE* %zStream, %struct._IO_FILE* %stream) #0 {
entry:
  %streamNo = alloca i32, align 4
  %unused = alloca [5000 x i8], align 16
  %bzf = alloca i8*, align 8
  ...
  %unusedTmpV = alloca i8*, align 8
  %canary = alloca i32
  store i32 779470380, i32* %canary
  %zStream.addr = alloca %struct._IO_FILE*, align 8
  %stream.addr = alloca %struct._IO_FILE*, align 8
  %i = alloca i32, align 4
  %nread = alloca i32, align 4
...
; Function Attrs: noinline noreturn nounwind optnone uwtable
define internal void @cleanUpAndFail.9(i32 %ec) #5 {
entry:
  %statBuf = alloca %struct.stat, align 8
  %canary = alloca i32
  store i32 1132395297, i32* %canary
  %ec.addr = alloca i32, align 4
  %retVal = alloca i32, align 4
  store i32 %ec, i32* %ec.addr, align 4
  %0 = load i32, i32* @srcMode, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @notAStandardFile.10(i8* %name) #0 {
entry:
  %statBuf = alloca %struct.stat, align 8
  %retval = alloca i8, align 1
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1743441813, i32* %canary
  %name.addr = alloca i8*, align 8
  store i8* %name, i8** %name.addr, align 8
  %0 = load i8*, i8** %name.addr, align 8
  %call = call i32 @lstat(i8* %0, %struct.stat* %statBuf) #8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @uInt64_isZero.11(%struct.UInt64* %n) #0 {
entry:
  %i = alloca i32, align 4
  %retval = alloca i8, align 1
  %canary = alloca i32
  store i32 2119463888, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @uInt64_from_UInt32s.12(%struct.UInt64* %n, i32 %lo32, i32 %hi32) #0 {
entry:
  %canary = alloca i32
  store i32 504715375, i32* %canary
  %n.addr = alloca %struct.UInt64*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @saveInputFileMetaInfo.13(i8* %srcName) #0 {
entry:
  %canary = alloca i32
  store i32 493134713, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @testStream.14(%struct._IO_FILE* %zStream) #0 {
entry:
  %nUnused = alloca i32, align 4
  %unusedTmp = alloca i8*, align 8
  %obuf = alloca [5000 x i8], align 16
  ...
  %ret = alloca i32, align 4
  %canary = alloca i32
  store i32 174791804, i32* %canary
  %bzerr = alloca i32, align 4
  %zStream.addr = alloca %struct._IO_FILE*, align 8
  %nread = alloca i32, align 4
  %unused = alloca [5000 x i8], align 16
...
; Function Attrs: noinline nounwind optnone uwtable
define internal %struct.zzzz* @snocString.15(%struct.zzzz* %root, i8* %name) #0 {
entry:
  %name.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 2124086425, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @mapSuffix.16(i8* %name, i8* %oldSuffix, i8* %newSuffix) #0 {
entry:
  %canary = alloca i32
  store i32 662865227, i32* %canary
  %name.addr = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @fileExists.17(i8* %name) #0 {
entry:
  %tmp = alloca %struct._IO_FILE*, align 8
  %name.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 941492226, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @testf.18(i8* %name) #0 {
entry:
  %name.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1625071594, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct._IO_FILE* @fopen_output_safely.19(i8* %name, i8* %mode) #0 {
entry:
  %fh = alloca i32, align 4
  %fp = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 1751186948, i32* %canary
  %name.addr = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @pad.20(i8* %s) #0 {
entry:
  %canary = alloca i32
  store i32 1573689029, i32* %canary
  %s.addr = alloca i8*, align 8
  %i = alloca i32, align 4
  store i8* %s, i8** %s.addr, align 8
  %0 = load i8*, i8** %s.addr, align 8
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1220086038, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct._IO_FILE* @fopen_output_safely.22(i8* %name, i8* %mode) #0 {
entry:
  %fp = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 10141677, i32* %canary
  %retval = alloca %struct._IO_FILE*, align 8
  %mode.addr = alloca i8*, align 8
  %name.addr = alloca i8*, align 8
  %fh = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @uInt64_qrm10.23(%struct.UInt64* %n) #0 {
entry:
  %tmp = alloca i32, align 4
  %canary = alloca i32
  store i32 420243385, i32* %canary
  %i = alloca i32, align 4
  %n.addr = alloca %struct.UInt64*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @fileExists.24(i8* %name) #0 {
entry:
  %tmp = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 125503497, i32* %canary
  %exists = alloca i8, align 1
  %name.addr = alloca i8*, align 8
  store i8* %name, i8** %name.addr, align 8
  %0 = load i8*, i8** %name.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @testf.25(i8* %name) #0 {
entry:
  %inStr = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 572583432, i32* %canary
  %statBuf = alloca %struct.stat, align 8
  %allOK = alloca i8, align 1
  %name.addr = alloca i8*, align 8
  store i8* %name, i8** %name.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @uncompressStream.26(%struct._IO_FILE* %zStream, %struct._IO_FILE* %stream) #0 {
entry:
  %ret = alloca i32, align 4
  %retval = alloca i8, align 1
  %bzf = alloca i8*, align 8
  ...
  %nUnused = alloca i32, align 4
  %canary = alloca i32
  store i32 2093134442, i32* %canary
  %streamNo = alloca i32, align 4
  %nread = alloca i32, align 4
  %obuf = alloca [5000 x i8], align 16
  %zStream.addr = alloca %struct._IO_FILE*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i8* @myMalloc.27(i32 %n) #0 {
entry:
  %canary = alloca i32
  store i32 2117773995, i32* %canary
  %n.addr = alloca i32, align 4
  %p = alloca i8*, align 8
  store i32 %n, i32* %n.addr, align 4
  %0 = load i32, i32* %n.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @addFlagsFromEnvVar.28(%struct.zzzz** %argList, i8* %varName) #0 {
entry:
  %varName.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1984357941, i32* %canary
  %i = alloca i32, align 4
  %p = alloca i8*, align 8
...
entry:
  ...
  %canary = alloca i32
  store i32 1437451788, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @notAStandardFile.30(i8* %name) #0 {
entry:
  %retval = alloca i8, align 1
  %statBuf = alloca %struct.stat, align 8
  %canary = alloca i32
  store i32 307362002, i32* %canary
  %i = alloca i32, align 4
  %name.addr = alloca i8*, align 8
  store i8* %name, i8** %name.addr, align 8
  %0 = load i8*, i8** %name.addr, align 8
...
; Function Attrs: noinline noreturn nounwind optnone uwtable
define internal void @cleanUpAndFail.31(i32 %ec) #5 {
entry:
  %retVal = alloca i32, align 4
  %canary = alloca i32
  store i32 311278002, i32* %canary
  %ec.addr = alloca i32, align 4
  %statBuf = alloca %struct.stat, align 8
  store i32 %ec, i32* %ec.addr, align 4
  %0 = load i32, i32* @srcMode, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @testStream.32(%struct._IO_FILE* %zStream) #0 {
entry:
  %obuf = alloca [5000 x i8], align 16
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 445096928, i32* %canary
  %ret = alloca i32, align 4
  %unusedTmpV = alloca i8*, align 8
  %nUnused = alloca i32, align 4
  %bzerr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @uInt64_from_UInt32s.33(%struct.UInt64* %n, i32 %lo32, i32 %hi32) #0 {
entry:
  %lo32.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1870726246, i32* %canary
  %hi32.addr = alloca i32, align 4
  %n.addr = alloca %struct.UInt64*, align 8
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
  store i32 %lo32, i32* %lo32.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @saveInputFileMetaInfo.34(i8* %srcName) #0 {
entry:
  %retVal = alloca i32, align 4
  %canary = alloca i32
  store i32 1770910789, i32* %canary
  %srcName.addr = alloca i8*, align 8
  store i8* %srcName, i8** %srcName.addr, align 8
  %0 = load i8*, i8** %srcName.addr, align 8
  %call = call i32 @stat(i8* %0, %struct.stat* @fileMetaInfo) #8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @testStream.35(%struct._IO_FILE* %zStream) #0 {
entry:
  %unusedTmpV = alloca i8*, align 8
  %i = alloca i32, align 4
  %bzf = alloca i8*, align 8
  ...
  %retval = alloca i8, align 1
  %canary = alloca i32
  store i32 2144697805, i32* %canary
  %bzerr_dummy = alloca i32, align 4
  %nread = alloca i32, align 4
  store %struct._IO_FILE* %zStream, %struct._IO_FILE** %zStream.addr, align 8
  store i8* null, i8** %bzf, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @addFlagsFromEnvVar.36(%struct.zzzz** %argList, i8* %varName) #0 {
entry:
  %canary = alloca i32
  store i32 724338172, i32* %canary
  %k = alloca i32, align 4
  %j = alloca i32, align 4
  %envbase = alloca i8*, align 8
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @uInt64_qrm10.37(%struct.UInt64* %n) #0 {
entry:
  %rem = alloca i32, align 4
  %n.addr = alloca %struct.UInt64*, align 8
  %canary = alloca i32
  store i32 2038565772, i32* %canary
  %i = alloca i32, align 4
  %tmp = alloca i32, align 4
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
  store i32 0, i32* %rem, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @mapSuffix.38(i8* %name, i8* %oldSuffix, i8* %newSuffix) #0 {
entry:
  %retval = alloca i8, align 1
  %newSuffix.addr = alloca i8*, align 8
  %oldSuffix.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 572599201, i32* %canary
  %name.addr = alloca i8*, align 8
  store i8* %name, i8** %name.addr, align 8
  store i8* %oldSuffix, i8** %oldSuffix.addr, align 8
  store i8* %newSuffix, i8** %newSuffix.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @hasSuffix.39(i8* %s, i8* %suffix) #0 {
entry:
  %retval = alloca i8, align 1
  %canary = alloca i32
  store i32 1662073978, i32* %canary
  %s.addr = alloca i8*, align 8
  %ns = alloca i32, align 4
  %suffix.addr = alloca i8*, align 8
  %nx = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @uInt64_toAscii.40(i8* %outbuf, %struct.UInt64* %n) #0 {
entry:
  %buf = alloca [32 x i8], align 16
  %q = alloca i32, align 4
  %canary = alloca i32
  store i32 384558638, i32* %canary
  %n.addr = alloca %struct.UInt64*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @compress.41(i8* %name) #0 {
entry:
  %n = alloca i32, align 4
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 2137896405, i32* %canary
  %inStr = alloca %struct._IO_FILE*, align 8
  %name.addr = alloca i8*, align 8
  %retVal = alloca i32, align 4
  %outStr = alloca %struct._IO_FILE*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @uInt64_isZero.42(%struct.UInt64* %n) #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1061745015, i32* %canary
  %n.addr = alloca %struct.UInt64*, align 8
  %retval = alloca i8, align 1
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
  store i32 0, i32* %i, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @uInt64_qrm10.43(%struct.UInt64* %n) #0 {
entry:
  %canary = alloca i32
  store i32 1443576206, i32* %canary
  %n.addr = alloca %struct.UInt64*, align 8
  %tmp = alloca i32, align 4
  %i = alloca i32, align 4
  %rem = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @hasSuffix.44(i8* %s, i8* %suffix) #0 {
entry:
  %s.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1557315563, i32* %canary
  %suffix.addr = alloca i8*, align 8
  %ns = alloca i32, align 4
  %retval = alloca i8, align 1
  %nx = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal double @uInt64_to_double.45(%struct.UInt64* %n) #0 {
entry:
  %base = alloca double, align 8
  %i = alloca i32, align 4
  %n.addr = alloca %struct.UInt64*, align 8
  %canary = alloca i32
  store i32 1709529263, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @compress.46(i8* %name) #0 {
entry:
  %outStr = alloca %struct._IO_FILE*, align 8
  %name.addr = alloca i8*, align 8
  %i = alloca i32, align 4
  ...
  %inStr = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 308915113, i32* %canary
  %statBuf = alloca %struct.stat, align 8
  %n = alloca i32, align 4
  store i8* %name, i8** %name.addr, align 8
  store i8 0, i8* @deleteOutputOnInterrupt, align 1
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @uInt64_from_UInt32s.47(%struct.UInt64* %n, i32 %lo32, i32 %hi32) #0 {
entry:
  %n.addr = alloca %struct.UInt64*, align 8
  %lo32.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1738963626, i32* %canary
  %hi32.addr = alloca i32, align 4
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
  store i32 %lo32, i32* %lo32.addr, align 4
  store i32 %hi32, i32* %hi32.addr, align 4
...
entry:
  %retval = alloca i8, align 1
  %canary = alloca i32
  store i32 746269340, i32* %canary
  %i = alloca i32, align 4
  %n.addr = alloca %struct.UInt64*, align 8
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
  store i32 0, i32* %i, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @uInt64_toAscii.49(i8* %outbuf, %struct.UInt64* %n) #0 {
entry:
  %n_copy = alloca %struct.UInt64, align 1
  %i = alloca i32, align 4
  %nBuf = alloca i32, align 4
  ...
  %q = alloca i32, align 4
  %canary = alloca i32
  store i32 1250107716, i32* %canary
  %n.addr = alloca %struct.UInt64*, align 8
  store i8* %outbuf, i8** %outbuf.addr, align 8
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
  store i32 0, i32* %nBuf, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @mapSuffix.50(i8* %name, i8* %oldSuffix, i8* %newSuffix) #0 {
entry:
  %newSuffix.addr = alloca i8*, align 8
  %oldSuffix.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1511311687, i32* %canary
  %name.addr = alloca i8*, align 8
  %retval = alloca i8, align 1
  store i8* %name, i8** %name.addr, align 8
  store i8* %oldSuffix, i8** %oldSuffix.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @uncompressStream.51(%struct._IO_FILE* %zStream, %struct._IO_FILE* %stream) #0 {
entry:
  %nread = alloca i32, align 4
  %canary = alloca i32
  store i32 1869717506, i32* %canary
  %unusedTmp = alloca i8*, align 8
  %retval = alloca i8, align 1
  %nUnused = alloca i32, align 4
  %bzf = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @compressStream.52(%struct._IO_FILE* %stream, %struct._IO_FILE* %zStream) #0 {
entry:
  %nbytes_out_d = alloca double, align 8
  %canary = alloca i32
  store i32 903542770, i32* %canary
  %zStream.addr = alloca %struct._IO_FILE*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @testf.53(i8* %name) #0 {
entry:
  %statBuf = alloca %struct.stat, align 8
  %inStr = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 1838359901, i32* %canary
  %allOK = alloca i8, align 1
  %name.addr = alloca i8*, align 8
  store i8* %name, i8** %name.addr, align 8
  store i8 0, i8* @deleteOutputOnInterrupt, align 1
...
entry:
  ...
  %allOK = alloca i8, align 1
  %canary = alloca i32
  store i32 694864957, i32* %canary
  %statBuf = alloca %struct.stat, align 8
  store i8* %name, i8** %name.addr, align 8
  store i8 0, i8* @deleteOutputOnInterrupt, align 1
  %0 = load i8*, i8** %name.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @applySavedMetaInfoToOutputFile.55(i8* %dstName) #0 {
entry:
  %retVal = alloca i32, align 4
  %dstName.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1423086611, i32* %canary
  %uTimBuf = alloca %struct.utimbuf, align 8
  store i8* %dstName, i8** %dstName.addr, align 8
  %0 = load i64, i64* getelementptr inbounds (%struct.stat, %struct.stat* @fileMetaInfo, i32 0, i32 11, i32 0), align 8
  %actime = getelementptr inbounds %struct.utimbuf, %struct.utimbuf* %uTimBuf, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @applySavedMetaInfoToOutputFile.56(i8* %dstName) #0 {
entry:
  %dstName.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1340872540, i32* %canary
  %retVal = alloca i32, align 4
  %uTimBuf = alloca %struct.utimbuf, align 8
  store i8* %dstName, i8** %dstName.addr, align 8
  %0 = load i64, i64* getelementptr inbounds (%struct.stat, %struct.stat* @fileMetaInfo, i32 0, i32 11, i32 0), align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @fileExists.57(i8* %name) #0 {
entry:
  %exists = alloca i8, align 1
  %canary = alloca i32
  store i32 141057498, i32* %canary
  %tmp = alloca %struct._IO_FILE*, align 8
  %name.addr = alloca i8*, align 8
  store i8* %name, i8** %name.addr, align 8
  %0 = load i8*, i8** %name.addr, align 8
...
; Function Attrs: noinline noreturn nounwind optnone uwtable
define internal void @cleanUpAndFail.58(i32 %ec) #5 {
entry:
  %canary = alloca i32
  store i32 292129583, i32* %canary
  %ec.addr = alloca i32, align 4
  %statBuf = alloca %struct.stat, align 8
  %retVal = alloca i32, align 4
  store i32 %ec, i32* %ec.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal %struct.zzzz* @snocString.59(%struct.zzzz* %root, i8* %name) #0 {
entry:
  %tmp = alloca %struct.zzzz*, align 8
  %tmp6 = alloca %struct.zzzz*, align 8
  %retval = alloca %struct.zzzz*, align 8
  %name.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 582212370, i32* %canary
  %root.addr = alloca %struct.zzzz*, align 8
  store %struct.zzzz* %root, %struct.zzzz** %root.addr, align 8
  store i8* %name, i8** %name.addr, align 8
  %0 = load %struct.zzzz*, %struct.zzzz** %root.addr, align 8
...
entry:
  ...
  %base = alloca double, align 8
  %canary = alloca i32
  store i32 721610521, i32* %canary
  %sum = alloca double, align 8
  %i = alloca i32, align 4
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
  store double 1.000000e+00, double* %base, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @applySavedMetaInfoToOutputFile.61(i8* %dstName) #0 {
entry:
  %dstName.addr = alloca i8*, align 8
  %uTimBuf = alloca %struct.utimbuf, align 8
  %canary = alloca i32
  store i32 1468720813, i32* %canary
  %retVal = alloca i32, align 4
  store i8* %dstName, i8** %dstName.addr, align 8
  %0 = load i64, i64* getelementptr inbounds (%struct.stat, %struct.stat* @fileMetaInfo, i32 0, i32 11, i32 0), align 8
  %actime = getelementptr inbounds %struct.utimbuf, %struct.utimbuf* %uTimBuf, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @addFlagsFromEnvVar.62(%struct.zzzz** %argList, i8* %varName) #0 {
entry:
  %p = alloca i8*, align 8
  %envbase = alloca i8*, align 8
  %argList.addr = alloca %struct.zzzz**, align 8
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 2034076478, i32* %canary
  %i = alloca i32, align 4
  %varName.addr = alloca i8*, align 8
  %k = alloca i32, align 4
  store %struct.zzzz** %argList, %struct.zzzz*** %argList.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal %struct.zzzz* @snocString.63(%struct.zzzz* %root, i8* %name) #0 {
entry:
  %root.addr = alloca %struct.zzzz*, align 8
  %name.addr = alloca i8*, align 8
  %tmp6 = alloca %struct.zzzz*, align 8
  %retval = alloca %struct.zzzz*, align 8
  %canary = alloca i32
  store i32 1732367109, i32* %canary
  %tmp = alloca %struct.zzzz*, align 8
  store %struct.zzzz* %root, %struct.zzzz** %root.addr, align 8
  store i8* %name, i8** %name.addr, align 8
  %0 = load %struct.zzzz*, %struct.zzzz** %root.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @addFlagsFromEnvVar.64(%struct.zzzz** %argList, i8* %varName) #0 {
entry:
  %k = alloca i32, align 4
  %p = alloca i8*, align 8
  %canary = alloca i32
  store i32 326256552, i32* %canary
  %argList.addr = alloca %struct.zzzz**, align 8
  %varName.addr = alloca i8*, align 8
  %envbase = alloca i8*, align 8
  %j = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @uInt64_from_UInt32s.65(%struct.UInt64* %n, i32 %lo32, i32 %hi32) #0 {
entry:
  %hi32.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 368212618, i32* %canary
  %lo32.addr = alloca i32, align 4
  %n.addr = alloca %struct.UInt64*, align 8
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
  store i32 %lo32, i32* %lo32.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct._IO_FILE* @fopen_output_safely.66(i8* %name, i8* %mode) #0 {
entry:
  %fh = alloca i32, align 4
  %mode.addr = alloca i8*, align 8
  %retval = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 673387533, i32* %canary
  %name.addr = alloca i8*, align 8
  %fp = alloca %struct._IO_FILE*, align 8
  store i8* %name, i8** %name.addr, align 8
  store i8* %mode, i8** %mode.addr, align 8
...
entry:
  ...
  %bzerr = alloca i32, align 4
  %canary = alloca i32
  store i32 488738860, i32* %canary
  %unusedTmpV = alloca i8*, align 8
  %retval = alloca i8, align 1
  %ret = alloca i32, align 4
  %unused = alloca [5000 x i8], align 16
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @compress.68(i8* %name) #0 {
entry:
  %outStr = alloca %struct._IO_FILE*, align 8
  %n = alloca i32, align 4
  %canary = alloca i32
  store i32 1664698565, i32* %canary
  %retVal = alloca i32, align 4
  %i = alloca i32, align 4
  %name.addr = alloca i8*, align 8
  %statBuf = alloca %struct.stat, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @fileExists.69(i8* %name) #0 {
entry:
  %canary = alloca i32
  store i32 536387120, i32* %canary
  %name.addr = alloca i8*, align 8
  %exists = alloca i8, align 1
  %tmp = alloca %struct._IO_FILE*, align 8
  store i8* %name, i8** %name.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @uInt64_qrm10.70(%struct.UInt64* %n) #0 {
entry:
  %n.addr = alloca %struct.UInt64*, align 8
  %tmp = alloca i32, align 4
  %rem = alloca i32, align 4
  %canary = alloca i32
  store i32 931174016, i32* %canary
  %i = alloca i32, align 4
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
  store i32 0, i32* %rem, align 4
  store i32 7, i32* %i, align 4
...
entry:
  ...
  %nx = alloca i32, align 4
  %canary = alloca i32
  store i32 697125153, i32* %canary
  %retval = alloca i8, align 1
  store i8* %s, i8** %s.addr, align 8
  store i8* %suffix, i8** %suffix.addr, align 8
  %0 = load i8*, i8** %s.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @uInt64_toAscii.72(i8* %outbuf, %struct.UInt64* %n) #0 {
entry:
  %q = alloca i32, align 4
  %n.addr = alloca %struct.UInt64*, align 8
  %canary = alloca i32
  store i32 1175064709, i32* %canary
  %buf = alloca [32 x i8], align 16
  %n_copy = alloca %struct.UInt64, align 1
  %nBuf = alloca i32, align 4
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @uInt64_toAscii.73(i8* %outbuf, %struct.UInt64* %n) #0 {
entry:
  %q = alloca i32, align 4
  %i = alloca i32, align 4
  %n.addr = alloca %struct.UInt64*, align 8
  ...
  %n_copy = alloca %struct.UInt64, align 1
  %canary = alloca i32
  store i32 2016950916, i32* %canary
  %nBuf = alloca i32, align 4
  %outbuf.addr = alloca i8*, align 8
  store i8* %outbuf, i8** %outbuf.addr, align 8
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @countHardLinks.74(i8* %name) #0 {
entry:
  %statBuf = alloca %struct.stat, align 8
  %name.addr = alloca i8*, align 8
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 232545809, i32* %canary
  %i = alloca i32, align 4
  store i8* %name, i8** %name.addr, align 8
  %0 = load i8*, i8** %name.addr, align 8
  %call = call i32 @lstat(i8* %0, %struct.stat* %statBuf) #8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct._IO_FILE* @fopen_output_safely.75(i8* %name, i8* %mode) #0 {
entry:
  %fp = alloca %struct._IO_FILE*, align 8
  %retval = alloca %struct._IO_FILE*, align 8
  %fh = alloca i32, align 4
  %mode.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1433596891, i32* %canary
  %name.addr = alloca i8*, align 8
  store i8* %name, i8** %name.addr, align 8
  store i8* %mode, i8** %mode.addr, align 8
  %0 = load i8*, i8** %name.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @compressStream.76(%struct._IO_FILE* %stream, %struct._IO_FILE* %zStream) #0 {
entry:
  %bzerr_dummy = alloca i32, align 4
  %nbytes_out = alloca %struct.UInt64, align 1
  %buf_nin = alloca [32 x i8], align 16
  ...
  %bzf = alloca i8*, align 8
  %canary = alloca i32
  store i32 1482828805, i32* %canary
  %ibuf = alloca [5000 x i8], align 16
  %ret = alloca i32, align 4
  %bzerr = alloca i32, align 4
  %stream.addr = alloca %struct._IO_FILE*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @uncompress.77(i8* %name) #0 {
entry:
  %statBuf = alloca %struct.stat, align 8
  %name.addr = alloca i8*, align 8
  %retVal168 = alloca i32, align 4
  ...
  %outStr = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 1373056196, i32* %canary
  %retVal = alloca i32, align 4
  %n = alloca i32, align 4
  %i = alloca i32, align 4
  store i8* %name, i8** %name.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @uInt64_isZero.78(%struct.UInt64* %n) #0 {
entry:
  %canary = alloca i32
  store i32 154351727, i32* %canary
  %n.addr = alloca %struct.UInt64*, align 8
  %retval = alloca i8, align 1
  %i = alloca i32, align 4
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @uncompress.79(i8* %name) #0 {
entry:
  %inStr = alloca %struct._IO_FILE*, align 8
  %retVal168 = alloca i32, align 4
  %name.addr = alloca i8*, align 8
  %n = alloca i32, align 4
  %canary = alloca i32
  store i32 2005431107, i32* %canary
  %i = alloca i32, align 4
  %outStr = alloca %struct._IO_FILE*, align 8
  %cantGuess = alloca i8, align 1
  %statBuf = alloca %struct.stat, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @pad.80(i8* %s) #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1112745167, i32* %canary
  %s.addr = alloca i8*, align 8
  store i8* %s, i8** %s.addr, align 8
  %0 = load i8*, i8** %s.addr, align 8
  %call = call i64 @strlen(i8* %0) #9
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @countHardLinks.81(i8* %name) #0 {
entry:
  %canary = alloca i32
  store i32 212720489, i32* %canary
  %retval = alloca i32, align 4
  %statBuf = alloca %struct.stat, align 8
  %i = alloca i32, align 4
  %name.addr = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @copyFileName.82(i8* %to, i8* %from) #0 {
entry:
  %canary = alloca i32
  store i32 614784668, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal double @uInt64_to_double.83(%struct.UInt64* %n) #0 {
entry:
  %canary = alloca i32
  store i32 1651269497, i32* %canary
  %sum = alloca double, align 8
  %i = alloca i32, align 4
  %base = alloca double, align 8
  %n.addr = alloca %struct.UInt64*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @copyFileName.84(i8* %to, i8* %from) #0 {
entry:
  %to.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1775089992, i32* %canary
  %from.addr = alloca i8*, align 8
  store i8* %to, i8** %to.addr, align 8
  store i8* %from, i8** %from.addr, align 8
  %0 = load i8*, i8** %from.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @mapSuffix.85(i8* %name, i8* %oldSuffix, i8* %newSuffix) #0 {
entry:
  %canary = alloca i32
  store i32 490401984, i32* %canary
  %newSuffix.addr = alloca i8*, align 8
  %retval = alloca i8, align 1
  %name.addr = alloca i8*, align 8
  %oldSuffix.addr = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @countHardLinks.86(i8* %name) #0 {
entry:
  %name.addr = alloca i8*, align 8
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1307372237, i32* %canary
  %statBuf = alloca %struct.stat, align 8
  %retval = alloca i32, align 4
  store i8* %name, i8** %name.addr, align 8
  %0 = load i8*, i8** %name.addr, align 8
...
entry:
  %c = alloca i32, align 4
  %canary = alloca i32
  store i32 102712750, i32* %canary
  %f.addr = alloca %struct._IO_FILE*, align 8
  %retval = alloca i8, align 1
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** %f.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @myfeof.88(%struct._IO_FILE* %f) #0 {
entry:
  %f.addr = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 1604612427, i32* %canary
  %retval = alloca i8, align 1
  %c = alloca i32, align 4
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** %f.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @myfeof.89(%struct._IO_FILE* %f) #0 {
entry:
  %canary = alloca i32
  store i32 447439382, i32* %canary
  %c = alloca i32, align 4
  %retval = alloca i8, align 1
  %f.addr = alloca %struct._IO_FILE*, align 8
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @notAStandardFile.90(i8* %name) #0 {
entry:
  %retval = alloca i8, align 1
  %canary = alloca i32
  store i32 952229882, i32* %canary
  %i = alloca i32, align 4
  %name.addr = alloca i8*, align 8
  %statBuf = alloca %struct.stat, align 8
  store i8* %name, i8** %name.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @uncompress.91(i8* %name) #0 {
entry:
  %retVal = alloca i32, align 4
  %retVal168 = alloca i32, align 4
  %canary = alloca i32
  store i32 977550217, i32* %canary
  %n = alloca i32, align 4
  %name.addr = alloca i8*, align 8
  %cantGuess = alloca i8, align 1
  %inStr = alloca %struct._IO_FILE*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal double @uInt64_to_double.92(%struct.UInt64* %n) #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 412423537, i32* %canary
  %sum = alloca double, align 8
  %base = alloca double, align 8
  %n.addr = alloca %struct.UInt64*, align 8
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @compressStream.93(%struct._IO_FILE* %stream, %struct._IO_FILE* %zStream) #0 {
entry:
  %buf_nout = alloca [32 x i8], align 16
  %bzf = alloca i8*, align 8
  %bzerr = alloca i32, align 4
  ...
  %nbytes_in_d = alloca double, align 8
  %canary = alloca i32
  store i32 1465952912, i32* %canary
  %nIbuf = alloca i32, align 4
  %nbytes_in_hi32 = alloca i32, align 4
  %ibuf = alloca [5000 x i8], align 16
  %nbytes_out_lo32 = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @compressStream.94(%struct._IO_FILE* %stream, %struct._IO_FILE* %zStream) #0 {
entry:
  %zStream.addr = alloca %struct._IO_FILE*, align 8
  %nbytes_in_lo32 = alloca i32, align 4
  %buf_nout = alloca [32 x i8], align 16
  %canary = alloca i32
  store i32 13759824, i32* %canary
  %bzerr = alloca i32, align 4
  %nbytes_in_hi32 = alloca i32, align 4
  %nbytes_out_d = alloca double, align 8
  %nbytes_out = alloca %struct.UInt64, align 1
...
; Function Attrs: noinline nounwind optnone uwtable
define internal %struct.zzzz* @snocString.95(%struct.zzzz* %root, i8* %name) #0 {
entry:
  %tmp = alloca %struct.zzzz*, align 8
  %retval = alloca %struct.zzzz*, align 8
  %tmp6 = alloca %struct.zzzz*, align 8
  %root.addr = alloca %struct.zzzz*, align 8
  %canary = alloca i32
  store i32 1005628117, i32* %canary
  %name.addr = alloca i8*, align 8
  store %struct.zzzz* %root, %struct.zzzz** %root.addr, align 8
  store i8* %name, i8** %name.addr, align 8
  %0 = load %struct.zzzz*, %struct.zzzz** %root.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @notAStandardFile.96(i8* %name) #0 {
entry:
  %name.addr = alloca i8*, align 8
  %retval = alloca i8, align 1
  %canary = alloca i32
  store i32 708267299, i32* %canary
  %statBuf = alloca %struct.stat, align 8
  %i = alloca i32, align 4
  store i8* %name, i8** %name.addr, align 8
  %0 = load i8*, i8** %name.addr, align 8
