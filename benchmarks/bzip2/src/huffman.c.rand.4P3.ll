; ModuleID = 'huffman.c.rand.4P3.bc'
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_BZ2_hbMakeCodeLengths.5, label %func_BZ2_hbMakeCodeLengths.7
}
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_BZ2_hbAssignCodes.8, label %func_BZ2_hbAssignCodes.9
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_BZ2_hbCreateDecodeTables.6, label %ctrl0

func_BZ2_hbCreateDecodeTables.6:                  ; preds = %rand_bb
  call void @BZ2_hbCreateDecodeTables.6(i32* %limit, i32* %base, i32* %perm, i8* %length, i32 %minLen, i32 %maxLen, i32 %alphaSize)
  ret void

func_BZ2_hbCreateDecodeTables.10:                 ; preds = %ctrl0
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_BZ2_hbCreateDecodeTables.10, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_BZ2_hbCreateDecodeTables.11, label %func_BZ2_hbCreateDecodeTables.12
}
...
entry:
  ...
  %canary = alloca i32
  store i32 1848294975, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1115521407, i32* %canary
...
while.end234:                                     ; preds = %if.then218
  ...
  %152 = icmp eq i32 %151, 1115521407
...
entry:
  %canary = alloca i32
  store i32 1992096951, i32* %canary
  %zz = alloca i32, align 4
  %weight = alloca [516 x i32], align 16
  %zz170 = alloca i32, align 4
  %tmp48 = alloca i32, align 4
...
while.end234:                                     ; preds = %if.then218
  %151 = load i32, i32* %canary
  %152 = icmp eq i32 %151, 1992096951
  br i1 %152, label %153, label %func_exit
...
entry:
  %canary = alloca i32
  store i32 1700220273, i32* %canary
  %i = alloca i32, align 4
  %n = alloca i32, align 4
  %vec = alloca i32, align 4
  %code.addr = alloca i32*, align 8
...
entry:
  ...
  %zz = alloca i32, align 4
  %canary = alloca i32
  store i32 665980597, i32* %canary
  %zz47 = alloca i32, align 4
  %n2 = alloca i32, align 4
  %tmp94 = alloca i32, align 4
  %maxLen.addr = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 159258007, i32* %canary
...
entry:
  ...
  %zz170 = alloca i32, align 4
  %canary = alloca i32
  store i32 321687850, i32* %canary
  %alphaSize.addr = alloca i32, align 4
  store i8* %len, i8** %len.addr, align 8
  store i32* %freq, i32** %freq.addr, align 8
  store i32 %alphaSize, i32* %alphaSize.addr, align 4
...
entry:
  ...
  %code.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 323551630, i32* %canary
  %minLen.addr = alloca i32, align 4
  %maxLen.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %length.addr = alloca i8*, align 8
...
entry:
  ...
  %vec = alloca i32, align 4
  %canary = alloca i32
  store i32 996332895, i32* %canary
  %minLen.addr = alloca i32, align 4
  %alphaSize.addr = alloca i32, align 4
  %maxLen.addr = alloca i32, align 4
  %length.addr = alloca i8*, align 8
...
entry:
  ...
  %maxLen.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1949174588, i32* %canary
  %i = alloca i32, align 4
  %base.addr = alloca i32*, align 8
  %length.addr = alloca i8*, align 8
  %perm.addr = alloca i32*, align 8
...
entry:
  ...
  %pp = alloca i32, align 4
  %canary = alloca i32
  store i32 788083684, i32* %canary
  %limit.addr = alloca i32*, align 8
  %length.addr = alloca i8*, align 8
  %perm.addr = alloca i32*, align 8
  %j = alloca i32, align 4
...
entry:
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1613531783, i32* %canary
  %base.addr = alloca i32*, align 8
  %length.addr = alloca i8*, align 8
  %alphaSize.addr = alloca i32, align 4
  %i = alloca i32, align 4
