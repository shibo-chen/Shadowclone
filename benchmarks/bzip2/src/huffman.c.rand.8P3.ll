; ModuleID = 'huffman.c.rand.8P3.bc'
...
func_BZ2_hbMakeCodeLengths.10:                    ; preds = %ctrl1
  call void @BZ2_hbMakeCodeLengths.10(i8* %len, i32* %freq, i32 %alphaSize, i32 %maxLen)
  ret void

func_BZ2_hbMakeCodeLengths.14:                    ; preds = %ctrl2
  call void @BZ2_hbMakeCodeLengths.14(i8* %len, i32* %freq, i32 %alphaSize, i32 %maxLen)
  ret void

func_BZ2_hbMakeCodeLengths.15:                    ; preds = %ctrl3
  call void @BZ2_hbMakeCodeLengths.15(i8* %len, i32* %freq, i32 %alphaSize, i32 %maxLen)
  ret void
...
func_BZ2_hbMakeCodeLengths.20:                    ; preds = %ctrl5
  call void @BZ2_hbMakeCodeLengths.20(i8* %len, i32* %freq, i32 %alphaSize, i32 %maxLen)
  ret void

func_BZ2_hbMakeCodeLengths.23:                    ; preds = %ctrl5
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_BZ2_hbMakeCodeLengths.10, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_BZ2_hbMakeCodeLengths.14, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_BZ2_hbMakeCodeLengths.15, label %ctrl4
...
ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_BZ2_hbMakeCodeLengths.20, label %func_BZ2_hbMakeCodeLengths.23
}
...
func_BZ2_hbAssignCodes.24:                        ; preds = %ctrl5
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_BZ2_hbAssignCodes.7, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_BZ2_hbAssignCodes.9, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_BZ2_hbAssignCodes.11, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_BZ2_hbAssignCodes.21, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_BZ2_hbAssignCodes.22, label %func_BZ2_hbAssignCodes.24
}
...
ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_BZ2_hbCreateDecodeTables.13, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_BZ2_hbCreateDecodeTables.16, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_BZ2_hbCreateDecodeTables.17, label %func_BZ2_hbCreateDecodeTables.18
}
...
entry:
  ...
  %canary = alloca i32
  store i32 1126227102, i32* %canary
...
entry:
  ...
  %alphaSize.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 615690319, i32* %canary
  %i = alloca i32, align 4
  %maxLen.addr = alloca i32, align 4
...
entry:
  ...
  %perm.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 161542478, i32* %canary
  %minLen.addr = alloca i32, align 4
  %length.addr = alloca i8*, align 8
  %j = alloca i32, align 4
  %maxLen.addr = alloca i32, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 1851372768, i32* %canary
...
while.end234:                                     ; preds = %if.then218
  ...
  %152 = icmp eq i32 %151, 1851372768
...
entry:
  ...
  %maxLen.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1245448256, i32* %canary
  %code.addr = alloca i32*, align 8
  store i32* %code, i32** %code.addr, align 8
  store i8* %length, i8** %length.addr, align 8
  store i32 %minLen, i32* %minLen.addr, align 4
...
entry:
  ...
  %parent = alloca [516 x i32], align 16
  %canary = alloca i32
  store i32 2102123214, i32* %canary
  %nNodes = alloca i32, align 4
  %yy93 = alloca i32, align 4
  %zz92 = alloca i32, align 4
  %alphaSize.addr = alloca i32, align 4
...
while.end234:                                     ; preds = %if.then218
  %151 = load i32, i32* %canary
  %152 = icmp eq i32 %151, 2102123214
  br i1 %152, label %153, label %func_exit
...
entry:
  ...
  %minLen.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2019139165, i32* %canary
  %length.addr = alloca i8*, align 8
  %vec = alloca i32, align 4
  store i32* %code, i32** %code.addr, align 8
  store i8* %length, i8** %length.addr, align 8
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 999618132, i32* %canary
  %limit.addr = alloca i32*, align 8
  %base.addr = alloca i32*, align 8
  %pp = alloca i32, align 4
  %length.addr = alloca i8*, align 8
...
entry:
  ...
  %alphaSize.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 406033382, i32* %canary
  %maxLen.addr = alloca i32, align 4
  %code.addr = alloca i32*, align 8
  %minLen.addr = alloca i32, align 4
  %length.addr = alloca i8*, align 8
...
entry:
  ...
  %heap = alloca [260 x i32], align 16
  %canary = alloca i32
  store i32 1896424396, i32* %canary
  %zz92 = alloca i32, align 4
  %tmp94 = alloca i32, align 4
  %n2 = alloca i32, align 4
  %j = alloca i32, align 4
...
while.end234:                                     ; preds = %if.then218
  %151 = load i32, i32* %canary
  %152 = icmp eq i32 %151, 1896424396
  br i1 %152, label %153, label %func_exit
...
entry:
  ...
  %maxLen.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2035929126, i32* %canary
  %length.addr = alloca i8*, align 8
  %i = alloca i32, align 4
  %n = alloca i32, align 4
  store i32* %code, i32** %code.addr, align 8
...
entry:
  %alphaSize.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 696135736, i32* %canary
  %limit.addr = alloca i32*, align 8
  %i = alloca i32, align 4
  %perm.addr = alloca i32*, align 8
  %vec = alloca i32, align 4
...
entry:
  ...
  %maxLen.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 856996104, i32* %canary
  %minLen.addr = alloca i32, align 4
  %perm.addr = alloca i32*, align 8
  store i32* %limit, i32** %limit.addr, align 8
  store i32* %base, i32** %base.addr, align 8
...
entry:
  ...
  %zz170 = alloca i32, align 4
  %canary = alloca i32
  store i32 1636123813, i32* %canary
  %n2 = alloca i32, align 4
  %len.addr = alloca i8*, align 8
  %tooLong = alloca i8, align 1
  %zz = alloca i32, align 4
...
while.end234:                                     ; preds = %if.then218
  %151 = load i32, i32* %canary
  %152 = icmp eq i32 %151, 1636123813
  br i1 %152, label %153, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @BZ2_hbMakeCodeLengths.15(i8* %len, i32* %freq, i32 %alphaSize, i32 %maxLen) #0 {
entry:
  %n2 = alloca i32, align 4
  %tmp = alloca i32, align 4
  %j = alloca i32, align 4
  ...
  %len.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 543872492, i32* %canary
  %zz = alloca i32, align 4
  %nNodes = alloca i32, align 4
  %tmp171 = alloca i32, align 4
  %freq.addr = alloca i32*, align 8
...
entry:
  ...
  %base.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 581512882, i32* %canary
  %pp = alloca i32, align 4
  %j = alloca i32, align 4
  %maxLen.addr = alloca i32, align 4
  store i32* %limit, i32** %limit.addr, align 8
...
entry:
  ...
  %alphaSize.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2054728538, i32* %canary
  %base.addr = alloca i32*, align 8
  %maxLen.addr = alloca i32, align 4
  %pp = alloca i32, align 4
  %perm.addr = alloca i32*, align 8
...
entry:
  ...
  %limit.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 903698223, i32* %canary
  %i = alloca i32, align 4
  %minLen.addr = alloca i32, align 4
  %pp = alloca i32, align 4
  %j = alloca i32, align 4
...
entry:
  ...
  %nHeap = alloca i32, align 4
  %canary = alloca i32
  store i32 1390424648, i32* %canary
  %maxLen.addr = alloca i32, align 4
  %tooLong = alloca i8, align 1
  %nNodes = alloca i32, align 4
  %parent = alloca [516 x i32], align 16
...
while.end234:                                     ; preds = %if.then218
  %151 = load i32, i32* %canary
  %152 = icmp eq i32 %151, 1390424648
  br i1 %152, label %153, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @BZ2_hbMakeCodeLengths.20(i8* %len, i32* %freq, i32 %alphaSize, i32 %maxLen) #0 {
entry:
  %yy = alloca i32, align 4
  %alphaSize.addr = alloca i32, align 4
  %zz92 = alloca i32, align 4
  ...
  %tmp94 = alloca i32, align 4
  %canary = alloca i32
  store i32 1619985556, i32* %canary
  %tmp171 = alloca i32, align 4
  %nHeap = alloca i32, align 4
  %parent = alloca [516 x i32], align 16
  %n2 = alloca i32, align 4
...
while.end234:                                     ; preds = %if.then218
  %151 = load i32, i32* %canary
  %152 = icmp eq i32 %151, 1619985556
  br i1 %152, label %153, label %func_exit
...
entry:
  ...
  %code.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 166590036, i32* %canary
  %length.addr = alloca i8*, align 8
  %maxLen.addr = alloca i32, align 4
  store i32* %code, i32** %code.addr, align 8
  store i8* %length, i8** %length.addr, align 8
...
entry:
  ...
  %maxLen.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 913456383, i32* %canary
  %vec = alloca i32, align 4
  %n = alloca i32, align 4
  %i = alloca i32, align 4
  %code.addr = alloca i32*, align 8
...
entry:
  ...
  %zz = alloca i32, align 4
  %canary = alloca i32
  store i32 899531489, i32* %canary
  %j = alloca i32, align 4
  %zz92 = alloca i32, align 4
  %n2 = alloca i32, align 4
  %freq.addr = alloca i32*, align 8
...
entry:
  ...
  %n = alloca i32, align 4
  %canary = alloca i32
  store i32 2065978310, i32* %canary
  %alphaSize.addr = alloca i32, align 4
  %maxLen.addr = alloca i32, align 4
  %length.addr = alloca i8*, align 8
  %vec = alloca i32, align 4
