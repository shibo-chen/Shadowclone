...
func_ran.26:                                      ; preds = %ctrl0
  %3 = call double @ran.26()
  ret double %3

func_ran.51:                                      ; preds = %ctrl1
  %4 = call double @ran.51()
  ret double %4

func_ran.59:                                      ; preds = %ctrl2
  %5 = call double @ran.59()
  ret double %5

func_ran.64:                                      ; preds = %ctrl3
  %6 = call double @ran.64()
  ret double %6

func_ran.71:                                      ; preds = %ctrl3
  %7 = call double @ran.71()
  ret double %7

ctrl0:                                            ; preds = %rand_bb
  %8 = icmp eq i32 %0, 1
  br i1 %8, label %func_ran.26, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %9 = icmp eq i32 %0, 2
  br i1 %9, label %func_ran.51, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %10 = icmp eq i32 %0, 3
  br i1 %10, label %func_ran.59, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %11 = icmp eq i32 %0, 4
  br i1 %11, label %func_ran.64, label %func_ran.71
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_spec_init.14, label %ctrl0

func_spec_init.14:                                ; preds = %rand_bb
  %2 = call i32 @spec_init.14()
  ret i32 %2

func_spec_init.15:                                ; preds = %ctrl0
  %3 = call i32 @spec_init.15()
  ret i32 %3

func_spec_init.21:                                ; preds = %ctrl1
  %4 = call i32 @spec_init.21()
  ret i32 %4

func_spec_init.38:                                ; preds = %ctrl2
  %5 = call i32 @spec_init.38()
  ret i32 %5

func_spec_init.45:                                ; preds = %ctrl3
  %6 = call i32 @spec_init.45()
  ret i32 %6

func_spec_init.55:                                ; preds = %ctrl3
  %7 = call i32 @spec_init.55()
  ret i32 %7

ctrl0:                                            ; preds = %rand_bb
  %8 = icmp eq i32 %0, 1
  br i1 %8, label %func_spec_init.15, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %9 = icmp eq i32 %0, 2
  br i1 %9, label %func_spec_init.21, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %10 = icmp eq i32 %0, 3
  br i1 %10, label %func_spec_init.38, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %11 = icmp eq i32 %0, 4
  br i1 %11, label %func_spec_init.45, label %func_spec_init.55
}
...
func_spec_random_load.18:                         ; preds = %ctrl0
  %3 = call i32 @spec_random_load.18(i32 %fd)
  ret i32 %3

func_spec_random_load.24:                         ; preds = %ctrl1
  %4 = call i32 @spec_random_load.24(i32 %fd)
  ret i32 %4

func_spec_random_load.25:                         ; preds = %ctrl2
  %5 = call i32 @spec_random_load.25(i32 %fd)
  ret i32 %5
...
func_spec_random_load.37:                         ; preds = %ctrl4
  %7 = call i32 @spec_random_load.37(i32 %fd)
  ret i32 %7

func_spec_random_load.47:                         ; preds = %ctrl5
  %8 = call i32 @spec_random_load.47(i32 %fd)
  ret i32 %8

func_spec_random_load.62:                         ; preds = %ctrl5
  %9 = call i32 @spec_random_load.62(i32 %fd)
  ret i32 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_spec_random_load.18, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_spec_random_load.24, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_spec_random_load.25, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_spec_random_load.35, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_spec_random_load.37, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_spec_random_load.47, label %func_spec_random_load.62
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_spec_load.3, label %ctrl0

func_spec_load.3:                                 ; preds = %rand_bb
  %2 = call i32 @spec_load.3(i32 %num, i8* %filename, i32 %size)
  ret i32 %2
...
func_spec_load.6:                                 ; preds = %ctrl1
  %4 = call i32 @spec_load.6(i32 %num, i8* %filename, i32 %size)
  ret i32 %4

func_spec_load.19:                                ; preds = %ctrl2
  %5 = call i32 @spec_load.19(i32 %num, i8* %filename, i32 %size)
  ret i32 %5

func_spec_load.20:                                ; preds = %ctrl3
  %6 = call i32 @spec_load.20(i32 %num, i8* %filename, i32 %size)
  ret i32 %6

func_spec_load.54:                                ; preds = %ctrl4
  %7 = call i32 @spec_load.54(i32 %num, i8* %filename, i32 %size)
  ret i32 %7

func_spec_load.69:                                ; preds = %ctrl5
  %8 = call i32 @spec_load.69(i32 %num, i8* %filename, i32 %size)
  ret i32 %8

func_spec_load.70:                                ; preds = %ctrl5
  %9 = call i32 @spec_load.70(i32 %num, i8* %filename, i32 %size)
  ret i32 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_spec_load.5, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_spec_load.6, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_spec_load.19, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_spec_load.20, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_spec_load.54, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_spec_load.69, label %func_spec_load.70
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_spec_read.8, label %ctrl0

func_spec_read.8:                                 ; preds = %rand_bb
  %2 = call i32 @spec_read.8(i32 %fd, i8* %buf, i32 %size)
  ret i32 %2

func_spec_read.17:                                ; preds = %ctrl0
  %3 = call i32 @spec_read.17(i32 %fd, i8* %buf, i32 %size)
  ret i32 %3

func_spec_read.23:                                ; preds = %ctrl1
  %4 = call i32 @spec_read.23(i32 %fd, i8* %buf, i32 %size)
  ret i32 %4

func_spec_read.28:                                ; preds = %ctrl2
  %5 = call i32 @spec_read.28(i32 %fd, i8* %buf, i32 %size)
  ret i32 %5

func_spec_read.50:                                ; preds = %ctrl3
  %6 = call i32 @spec_read.50(i32 %fd, i8* %buf, i32 %size)
  ret i32 %6

func_spec_read.53:                                ; preds = %ctrl4
  %7 = call i32 @spec_read.53(i32 %fd, i8* %buf, i32 %size)
  ret i32 %7

func_spec_read.65:                                ; preds = %ctrl5
  %8 = call i32 @spec_read.65(i32 %fd, i8* %buf, i32 %size)
  ret i32 %8

func_spec_read.72:                                ; preds = %ctrl5
  %9 = call i32 @spec_read.72(i32 %fd, i8* %buf, i32 %size)
  ret i32 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_spec_read.17, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_spec_read.23, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_spec_read.28, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_spec_read.50, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_spec_read.53, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_spec_read.65, label %func_spec_read.72
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_spec_fread.9, label %ctrl0

func_spec_fread.9:                                ; preds = %rand_bb
  %2 = call i32 @spec_fread.9(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %2

func_spec_fread.12:                               ; preds = %ctrl0
  %3 = call i32 @spec_fread.12(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %3

func_spec_fread.27:                               ; preds = %ctrl1
  %4 = call i32 @spec_fread.27(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %4

func_spec_fread.29:                               ; preds = %ctrl2
  %5 = call i32 @spec_fread.29(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %5

func_spec_fread.30:                               ; preds = %ctrl3
  %6 = call i32 @spec_fread.30(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %6

func_spec_fread.31:                               ; preds = %ctrl4
  %7 = call i32 @spec_fread.31(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %7

func_spec_fread.33:                               ; preds = %ctrl5
  %8 = call i32 @spec_fread.33(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %8

func_spec_fread.57:                               ; preds = %ctrl5
  %9 = call i32 @spec_fread.57(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_spec_fread.12, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_spec_fread.27, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_spec_fread.29, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_spec_fread.30, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_spec_fread.31, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_spec_fread.33, label %func_spec_fread.57
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_spec_getc.39, label %ctrl0

func_spec_getc.39:                                ; preds = %rand_bb
  %2 = call i32 @spec_getc.39(i32 %fd)
  ret i32 %2

func_spec_getc.49:                                ; preds = %ctrl0
  %3 = call i32 @spec_getc.49(i32 %fd)
  ret i32 %3

func_spec_getc.58:                                ; preds = %ctrl1
  %4 = call i32 @spec_getc.58(i32 %fd)
  ret i32 %4

func_spec_getc.60:                                ; preds = %ctrl2
  %5 = call i32 @spec_getc.60(i32 %fd)
  ret i32 %5

func_spec_getc.61:                                ; preds = %ctrl3
  %6 = call i32 @spec_getc.61(i32 %fd)
  ret i32 %6

func_spec_getc.63:                                ; preds = %ctrl3
  %7 = call i32 @spec_getc.63(i32 %fd)
  ret i32 %7

ctrl0:                                            ; preds = %rand_bb
  %8 = icmp eq i32 %0, 1
  br i1 %8, label %func_spec_getc.49, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %9 = icmp eq i32 %0, 2
  br i1 %9, label %func_spec_getc.58, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %10 = icmp eq i32 %0, 3
  br i1 %10, label %func_spec_getc.60, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %11 = icmp eq i32 %0, 4
  br i1 %11, label %func_spec_getc.61, label %func_spec_getc.63
}
...
func_spec_ungetc.34:                              ; preds = %ctrl0
  %3 = call i32 @spec_ungetc.34(i8 %ch, i32 %fd)
  ret i32 %3

func_spec_ungetc.40:                              ; preds = %ctrl1
  %4 = call i32 @spec_ungetc.40(i8 %ch, i32 %fd)
  ret i32 %4

func_spec_ungetc.66:                              ; preds = %ctrl2
  %5 = call i32 @spec_ungetc.66(i8 %ch, i32 %fd)
  ret i32 %5

func_spec_ungetc.67:                              ; preds = %ctrl3
  %6 = call i32 @spec_ungetc.67(i8 %ch, i32 %fd)
  ret i32 %6

func_spec_ungetc.68:                              ; preds = %ctrl3
  %7 = call i32 @spec_ungetc.68(i8 %ch, i32 %fd)
  ret i32 %7

ctrl0:                                            ; preds = %rand_bb
  %8 = icmp eq i32 %0, 1
  br i1 %8, label %func_spec_ungetc.34, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %9 = icmp eq i32 %0, 2
  br i1 %9, label %func_spec_ungetc.40, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %10 = icmp eq i32 %0, 3
  br i1 %10, label %func_spec_ungetc.66, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %11 = icmp eq i32 %0, 4
  br i1 %11, label %func_spec_ungetc.67, label %func_spec_ungetc.68
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_spec_write.7, label %ctrl0

func_spec_write.7:                                ; preds = %rand_bb
  %2 = call i32 @spec_write.7(i32 %fd, i8* %buf, i32 %size)
  ret i32 %2

func_spec_write.11:                               ; preds = %ctrl0
  %3 = call i32 @spec_write.11(i32 %fd, i8* %buf, i32 %size)
  ret i32 %3

func_spec_write.42:                               ; preds = %ctrl1
  %4 = call i32 @spec_write.42(i32 %fd, i8* %buf, i32 %size)
  ret i32 %4
...
func_spec_write.44:                               ; preds = %ctrl3
  %6 = call i32 @spec_write.44(i32 %fd, i8* %buf, i32 %size)
  ret i32 %6

func_spec_write.52:                               ; preds = %ctrl3
  %7 = call i32 @spec_write.52(i32 %fd, i8* %buf, i32 %size)
  ret i32 %7

ctrl0:                                            ; preds = %rand_bb
  %8 = icmp eq i32 %0, 1
  br i1 %8, label %func_spec_write.11, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %9 = icmp eq i32 %0, 2
  br i1 %9, label %func_spec_write.42, label %ctrl2
...
ctrl3:                                            ; preds = %ctrl2
  %11 = icmp eq i32 %0, 4
  br i1 %11, label %func_spec_write.44, label %func_spec_write.52
}
...
func_spec_fwrite.22:                              ; preds = %ctrl0
  %3 = call i32 @spec_fwrite.22(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %3

func_spec_fwrite.32:                              ; preds = %ctrl1
  %4 = call i32 @spec_fwrite.32(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %4
...
func_spec_fwrite.41:                              ; preds = %ctrl3
  %6 = call i32 @spec_fwrite.41(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %6

func_spec_fwrite.46:                              ; preds = %ctrl4
  %7 = call i32 @spec_fwrite.46(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %7

func_spec_fwrite.48:                              ; preds = %ctrl5
  %8 = call i32 @spec_fwrite.48(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %8

func_spec_fwrite.56:                              ; preds = %ctrl5
  %9 = call i32 @spec_fwrite.56(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_spec_fwrite.22, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_spec_fwrite.32, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_spec_fwrite.36, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_spec_fwrite.41, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_spec_fwrite.46, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_spec_fwrite.48, label %func_spec_fwrite.56
}
...
entry:
  %canary = alloca i32
  store i32 627109745, i32* %canary
  %fd.addr = alloca i32, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 1783082998, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_load.3(i32 %num, i8* %filename, i32 %size) #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 410781228, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1490401134, i32* %canary
  %fd.addr = alloca i32, align 4
...
entry:
  ...
  %fd = alloca i32, align 4
  %canary = alloca i32
  store i32 1577279481, i32* %canary
  %i = alloca i32, align 4
  %size.addr = alloca i32, align 4
  store i32 %num, i32* %num.addr, align 4
  store i8* %filename, i8** %filename.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_load.6(i32 %num, i8* %filename, i32 %size) #0 {
entry:
  %i = alloca i32, align 4
  %size.addr = alloca i32, align 4
  %fd = alloca i32, align 4
  %canary = alloca i32
  store i32 958559674, i32* %canary
  %tmp = alloca i32, align 4
  %num.addr = alloca i32, align 4
  %rc = alloca i32, align 4
  %filename.addr = alloca i8*, align 8
...
entry:
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 797479121, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_read.8(i32 %fd, i8* %buf, i32 %size) #0 {
entry:
  %buf.addr = alloca i8*, align 8
  ...
  %size.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 617134155, i32* %canary
  %fd.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_fread.9(i8* %buf, i32 %size, i32 %num, i32 %fd) #0 {
entry:
  %num.addr = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 205258068, i32* %canary
  %retval = alloca i32, align 4
  %size.addr = alloca i32, align 4
  %rc = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
...
entry:
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 783370812, i32* %canary
  %ch.addr = alloca i8, align 1
  store i8 %ch, i8* %ch.addr, align 1
  store i32 %fd, i32* %fd.addr, align 4
  %0 = load i32, i32* @dbglvl, align 4
...
entry:
  %canary = alloca i32
  store i32 150350880, i32* %canary
  %size.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %fd.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
...
entry:
  ...
  %size.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1380738816, i32* %canary
  %num.addr = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  %rc = alloca i32, align 4
...
entry:
  ...
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1223185019, i32* %canary
  %num.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 1773693579, i32* %canary
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %0 = load i32, i32* @dbglvl, align 4
...
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 378707319, i32* %canary
  %limit = alloca i32, align 4
  %j = alloca i32, align 4
  %0 = load i32, i32* @dbglvl, align 4
  %cmp = icmp slt i32 3, %0
...
entry:
  %canary = alloca i32
  store i32 1960620985, i32* %canary
  %ch.addr = alloca i8, align 1
  %fd.addr = alloca i32, align 4
  store i8 %ch, i8* %ch.addr, align 1
  store i32 %fd, i32* %fd.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_read.17(i32 %fd, i8* %buf, i32 %size) #0 {
entry:
  %canary = alloca i32
  store i32 1523991467, i32* %canary
  %size.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %fd.addr = alloca i32, align 4
  %rc = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_random_load.18(i32 %fd) #0 {
entry:
  %i = alloca i32, align 4
  %random_text = alloca [32 x [131072 x i8]], align 16
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 348307935, i32* %canary
  %fd.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  %0 = load i32, i32* @dbglvl, align 4
  %cmp = icmp slt i32 4, %0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_load.19(i32 %num, i8* %filename, i32 %size) #0 {
entry:
  %filename.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 2042365973, i32* %canary
  %size.addr = alloca i32, align 4
  %fd = alloca i32, align 4
  %rc = alloca i32, align 4
  %i = alloca i32, align 4
...
entry:
  ...
  %filename.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1251547700, i32* %canary
  %rc = alloca i32, align 4
  %fd = alloca i32, align 4
  %num.addr = alloca i32, align 4
  %size.addr = alloca i32, align 4
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1821254160, i32* %canary
  %limit = alloca i32, align 4
  %0 = load i32, i32* @dbglvl, align 4
  %cmp = icmp slt i32 3, %0
  br i1 %cmp, label %if.then, label %if.end
...
entry:
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1026649244, i32* %canary
  %buf.addr = alloca i8*, align 8
  %num.addr = alloca i32, align 4
  %size.addr = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_read.23(i32 %fd, i8* %buf, i32 %size) #0 {
entry:
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1149393105, i32* %canary
  %size.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %fd.addr = alloca i32, align 4
  %rc = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_random_load.24(i32 %fd) #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 519914443, i32* %canary
  %random_text = alloca [32 x [131072 x i8]], align 16
  %fd.addr = alloca i32, align 4
  %j = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 1606522114, i32* %canary
  %random_text = alloca [32 x [131072 x i8]], align 16
  %fd.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %j = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local double @ran.26() #0 {
entry:
  %test = alloca i64, align 8
  %canary = alloca i32
  store i32 988277342, i32* %canary
  %hi = alloca i64, align 8
  %lo = alloca i64, align 8
  %0 = load i64, i64* @seedi, align 8
  %div = sdiv i64 %0, 127773
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_fread.27(i8* %buf, i32 %size, i32 %num, i32 %fd) #0 {
entry:
  %rc = alloca i32, align 4
  %canary = alloca i32
  store i32 1126227599, i32* %canary
  %retval = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  %num.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_read.28(i32 %fd, i8* %buf, i32 %size) #0 {
entry:
  %retval = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1547111770, i32* %canary
  %rc = alloca i32, align 4
  %size.addr = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
...
entry:
  ...
  %rc = alloca i32, align 4
  %canary = alloca i32
  store i32 127842742, i32* %canary
  %fd.addr = alloca i32, align 4
  %num.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  store i8* %buf, i8** %buf.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_fread.30(i8* %buf, i32 %size, i32 %num, i32 %fd) #0 {
entry:
  %num.addr = alloca i32, align 4
  %rc = alloca i32, align 4
  %size.addr = alloca i32, align 4
  ...
  %buf.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 431544679, i32* %canary
  %fd.addr = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
  store i32 %num, i32* %num.addr, align 4
...
entry:
  %num.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 413396766, i32* %canary
  %fd.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %size.addr = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
...
entry:
  ...
  %size.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 809140860, i32* %canary
  %buf.addr = alloca i8*, align 8
  %num.addr = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_ungetc.34(i8 zeroext %ch, i32 %fd) #0 {
entry:
  %ch.addr = alloca i8, align 1
  %canary = alloca i32
  store i32 2143090404, i32* %canary
  %fd.addr = alloca i32, align 4
  %rc = alloca i32, align 4
  store i8 %ch, i8* %ch.addr, align 1
  store i32 %fd, i32* %fd.addr, align 4
...
entry:
  %random_text = alloca [32 x [131072 x i8]], align 16
  %canary = alloca i32
  store i32 2041950187, i32* %canary
  %i = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  %j = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
...
entry:
  ...
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1190330289, i32* %canary
  %size.addr = alloca i32, align 4
  %num.addr = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
...
entry:
  ...
  %random_text = alloca [32 x [131072 x i8]], align 16
  %canary = alloca i32
  store i32 1573724930, i32* %canary
  %i = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  %0 = load i32, i32* @dbglvl, align 4
...
entry:
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1711262868, i32* %canary
  %limit = alloca i32, align 4
  %i = alloca i32, align 4
  %0 = load i32, i32* @dbglvl, align 4
  %cmp = icmp slt i32 3, %0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_getc.39(i32 %fd) #0 {
entry:
  %rc = alloca i32, align 4
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1001519984, i32* %canary
  %fd.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  store i32 0, i32* %rc, align 4
  %0 = load i32, i32* @dbglvl, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_ungetc.40(i8 zeroext %ch, i32 %fd) #0 {
entry:
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2078592939, i32* %canary
  %rc = alloca i32, align 4
  %ch.addr = alloca i8, align 1
  store i8 %ch, i8* %ch.addr, align 1
  store i32 %fd, i32* %fd.addr, align 4
...
entry:
  %num.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1159937276, i32* %canary
  %size.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %fd.addr = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_write.42(i32 %fd, i8* %buf, i32 %size) #0 {
entry:
  %canary = alloca i32
  store i32 764034826, i32* %canary
  %size.addr = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  store i32 %fd, i32* %fd.addr, align 4
...
entry:
  ...
  %size.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1550394526, i32* %canary
  %fd.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_write.44(i32 %fd, i8* %buf, i32 %size) #0 {
entry:
  %fd.addr = alloca i32, align 4
  %size.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 288047915, i32* %canary
  %buf.addr = alloca i8*, align 8
  store i32 %fd, i32* %fd.addr, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_init.45() #0 {
entry:
  %canary = alloca i32
  store i32 1867635528, i32* %canary
  %j = alloca i32, align 4
  %i = alloca i32, align 4
  %limit = alloca i32, align 4
  %0 = load i32, i32* @dbglvl, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_fwrite.46(i8* %buf, i32 %size, i32 %num, i32 %fd) #0 {
entry:
  %size.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %num.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1099825790, i32* %canary
  %fd.addr = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
  store i32 %num, i32* %num.addr, align 4
...
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 939525606, i32* %canary
  %j = alloca i32, align 4
  %random_text = alloca [32 x [131072 x i8]], align 16
  %fd.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
...
entry:
  ...
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 281453413, i32* %canary
  %size.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_getc.49(i32 %fd) #0 {
entry:
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 305326378, i32* %canary
  %fd.addr = alloca i32, align 4
  %rc = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  store i32 0, i32* %rc, align 4
...
entry:
  ...
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 824418062, i32* %canary
  %size.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  store i32 %fd, i32* %fd.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_write.52(i32 %fd, i8* %buf, i32 %size) #0 {
entry:
  %buf.addr = alloca i8*, align 8
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 889206285, i32* %canary
  %size.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
...
entry:
  %size.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1222903615, i32* %canary
  %retval = alloca i32, align 4
  %rc = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %fd.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_load.54(i32 %num, i8* %filename, i32 %size) #0 {
entry:
  %canary = alloca i32
  store i32 1127840703, i32* %canary
  %num.addr = alloca i32, align 4
  %filename.addr = alloca i8*, align 8
  %i = alloca i32, align 4
  %tmp = alloca i32, align 4
...
entry:
  %limit = alloca i32, align 4
  %canary = alloca i32
  store i32 1055816207, i32* %canary
  %j = alloca i32, align 4
  %i = alloca i32, align 4
  %0 = load i32, i32* @dbglvl, align 4
  %cmp = icmp slt i32 3, %0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_fwrite.56(i8* %buf, i32 %size, i32 %num, i32 %fd) #0 {
entry:
  %size.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 389958135, i32* %canary
  %num.addr = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  store i8* %buf, i8** %buf.addr, align 8
...
entry:
  %num.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2079423989, i32* %canary
  %rc = alloca i32, align 4
  %retval = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  %size.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_getc.58(i32 %fd) #0 {
entry:
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1207507166, i32* %canary
  %retval = alloca i32, align 4
  %rc = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  store i32 0, i32* %rc, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local double @ran.59() #0 {
entry:
  %lo = alloca i64, align 8
  %canary = alloca i32
  store i32 706234801, i32* %canary
  %hi = alloca i64, align 8
  %test = alloca i64, align 8
  %0 = load i64, i64* @seedi, align 8
  %div = sdiv i64 %0, 127773
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_getc.60(i32 %fd) #0 {
entry:
  %canary = alloca i32
  store i32 319426713, i32* %canary
  %retval = alloca i32, align 4
  %rc = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_getc.61(i32 %fd) #0 {
entry:
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 223748387, i32* %canary
  %rc = alloca i32, align 4
  %retval = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  store i32 0, i32* %rc, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_random_load.62(i32 %fd) #0 {
entry:
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 145811361, i32* %canary
  %j = alloca i32, align 4
  %random_text = alloca [32 x [131072 x i8]], align 16
  %i = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_getc.63(i32 %fd) #0 {
entry:
  %rc = alloca i32, align 4
  %canary = alloca i32
  store i32 1213583526, i32* %canary
  %fd.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  store i32 0, i32* %rc, align 4
...
entry:
  ...
  %test = alloca i64, align 8
  %canary = alloca i32
  store i32 1646408069, i32* %canary
  %hi = alloca i64, align 8
  %0 = load i64, i64* @seedi, align 8
  %div = sdiv i64 %0, 127773
  store i64 %div, i64* %hi, align 8
...
entry:
  %buf.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1703341904, i32* %canary
  %size.addr = alloca i32, align 4
  %rc = alloca i32, align 4
  %retval = alloca i32, align 4
  %fd.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_ungetc.66(i8 zeroext %ch, i32 %fd) #0 {
entry:
  %rc = alloca i32, align 4
  %canary = alloca i32
  store i32 429833368, i32* %canary
  %fd.addr = alloca i32, align 4
  %ch.addr = alloca i8, align 1
  store i8 %ch, i8* %ch.addr, align 1
  store i32 %fd, i32* %fd.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_ungetc.67(i8 zeroext %ch, i32 %fd) #0 {
entry:
  %fd.addr = alloca i32, align 4
  %ch.addr = alloca i8, align 1
  %canary = alloca i32
  store i32 740998696, i32* %canary
  %rc = alloca i32, align 4
  store i8 %ch, i8* %ch.addr, align 1
  store i32 %fd, i32* %fd.addr, align 4
  store i32 0, i32* %rc, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_ungetc.68(i8 zeroext %ch, i32 %fd) #0 {
entry:
  %ch.addr = alloca i8, align 1
  %canary = alloca i32
  store i32 177475500, i32* %canary
  %rc = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  store i8 %ch, i8* %ch.addr, align 1
  store i32 %fd, i32* %fd.addr, align 4
...
entry:
  %tmp = alloca i32, align 4
  %canary = alloca i32
  store i32 118277539, i32* %canary
  %rc = alloca i32, align 4
  %i = alloca i32, align 4
  %size.addr = alloca i32, align 4
  %num.addr = alloca i32, align 4
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1887628774, i32* %canary
  %size.addr = alloca i32, align 4
  %filename.addr = alloca i8*, align 8
  store i32 %num, i32* %num.addr, align 4
  store i8* %filename, i8** %filename.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local double @ran.71() #0 {
entry:
  %hi = alloca i64, align 8
  %lo = alloca i64, align 8
  %canary = alloca i32
  store i32 1444314102, i32* %canary
  %test = alloca i64, align 8
  %0 = load i64, i64* @seedi, align 8
  %div = sdiv i64 %0, 127773
  store i64 %div, i64* %hi, align 8
