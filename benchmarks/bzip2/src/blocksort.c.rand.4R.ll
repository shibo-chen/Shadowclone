; ModuleID = 'blocksort.c.rand.4R.bc'
...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_BZ2_blockSort.3, label %ctrl0

func_BZ2_blockSort.3:                             ; preds = %rand_bb
  call void @BZ2_blockSort.3(%struct.EState* %s)
  ret void

func_BZ2_blockSort.13:                            ; preds = %ctrl0
  call void @BZ2_blockSort.13(%struct.EState* %s)
  ret void

func_BZ2_blockSort.33:                            ; preds = %ctrl1
  call void @BZ2_blockSort.33(%struct.EState* %s)
  ret void

func_BZ2_blockSort.36:                            ; preds = %ctrl1
  call void @BZ2_blockSort.36(%struct.EState* %s)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_BZ2_blockSort.13, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_BZ2_blockSort.33, label %func_BZ2_blockSort.36
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_fallbackSort.9, label %ctrl0

func_fallbackSort.9:                              ; preds = %rand_bb
  call void @fallbackSort.9(i32* %fmap, i32* %eclass, i32* %bhtab, i32 %nblock, i32 %verb)
  ret void

func_fallbackSort.10:                             ; preds = %ctrl0
  call void @fallbackSort.10(i32* %fmap, i32* %eclass, i32* %bhtab, i32 %nblock, i32 %verb)
  ret void

func_fallbackSort.22:                             ; preds = %ctrl1
  call void @fallbackSort.22(i32* %fmap, i32* %eclass, i32* %bhtab, i32 %nblock, i32 %verb)
  ret void

func_fallbackSort.28:                             ; preds = %ctrl1
  call void @fallbackSort.28(i32* %fmap, i32* %eclass, i32* %bhtab, i32 %nblock, i32 %verb)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_fallbackSort.10, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_fallbackSort.22, label %func_fallbackSort.28
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_mainSort.8, label %ctrl0

func_mainSort.8:                                  ; preds = %rand_bb
  call void @mainSort.8(i32* %ptr, i8* %block, i16* %quadrant, i32* %ftab, i32 %nblock, i32 %verb, i32* %budget)
  ret void

func_mainSort.15:                                 ; preds = %ctrl0
  call void @mainSort.15(i32* %ptr, i8* %block, i16* %quadrant, i32* %ftab, i32 %nblock, i32 %verb, i32* %budget)
  ret void

func_mainSort.18:                                 ; preds = %ctrl1
  call void @mainSort.18(i32* %ptr, i8* %block, i16* %quadrant, i32* %ftab, i32 %nblock, i32 %verb, i32* %budget)
  ret void

func_mainSort.25:                                 ; preds = %ctrl1
  call void @mainSort.25(i32* %ptr, i8* %block, i16* %quadrant, i32* %ftab, i32 %nblock, i32 %verb, i32* %budget)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_mainSort.15, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_mainSort.18, label %func_mainSort.25
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_fallbackQSort3.6, label %ctrl0

func_fallbackQSort3.6:                            ; preds = %rand_bb
  call void @fallbackQSort3.6(i32* %fmap, i32* %eclass, i32 %loSt, i32 %hiSt)
  ret void

func_fallbackQSort3.17:                           ; preds = %ctrl0
  call void @fallbackQSort3.17(i32* %fmap, i32* %eclass, i32 %loSt, i32 %hiSt)
  ret void

func_fallbackQSort3.24:                           ; preds = %ctrl1
  call void @fallbackQSort3.24(i32* %fmap, i32* %eclass, i32 %loSt, i32 %hiSt)
  ret void

func_fallbackQSort3.34:                           ; preds = %ctrl1
  call void @fallbackQSort3.34(i32* %fmap, i32* %eclass, i32 %loSt, i32 %hiSt)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_fallbackQSort3.17, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_fallbackQSort3.24, label %func_fallbackQSort3.34
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_fallbackSimpleSort.5, label %ctrl0

func_fallbackSimpleSort.5:                        ; preds = %rand_bb
  call void @fallbackSimpleSort.5(i32* %fmap, i32* %eclass, i32 %lo, i32 %hi)
  ret void

func_fallbackSimpleSort.7:                        ; preds = %ctrl0
  call void @fallbackSimpleSort.7(i32* %fmap, i32* %eclass, i32 %lo, i32 %hi)
  ret void

func_fallbackSimpleSort.19:                       ; preds = %ctrl1
  call void @fallbackSimpleSort.19(i32* %fmap, i32* %eclass, i32 %lo, i32 %hi)
  ret void

func_fallbackSimpleSort.31:                       ; preds = %ctrl1
  call void @fallbackSimpleSort.31(i32* %fmap, i32* %eclass, i32 %lo, i32 %hi)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_fallbackSimpleSort.7, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_fallbackSimpleSort.19, label %func_fallbackSimpleSort.31
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_mainQSort3.4, label %ctrl0

func_mainQSort3.4:                                ; preds = %rand_bb
  call void @mainQSort3.4(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %loSt, i32 %hiSt, i32 %dSt, i32* %budget)
  ret void

func_mainQSort3.14:                               ; preds = %ctrl0
  call void @mainQSort3.14(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %loSt, i32 %hiSt, i32 %dSt, i32* %budget)
  ret void

func_mainQSort3.16:                               ; preds = %ctrl1
  call void @mainQSort3.16(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %loSt, i32 %hiSt, i32 %dSt, i32* %budget)
  ret void

func_mainQSort3.20:                               ; preds = %ctrl1
  call void @mainQSort3.20(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %loSt, i32 %hiSt, i32 %dSt, i32* %budget)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_mainQSort3.14, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_mainQSort3.16, label %func_mainQSort3.20
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_mainSimpleSort.2, label %ctrl0

func_mainSimpleSort.2:                            ; preds = %rand_bb
  call void @mainSimpleSort.2(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %lo, i32 %hi, i32 %d, i32* %budget)
  ret void

func_mainSimpleSort.11:                           ; preds = %ctrl0
  call void @mainSimpleSort.11(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %lo, i32 %hi, i32 %d, i32* %budget)
  ret void

func_mainSimpleSort.21:                           ; preds = %ctrl1
  call void @mainSimpleSort.21(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %lo, i32 %hi, i32 %d, i32* %budget)
  ret void

func_mainSimpleSort.27:                           ; preds = %ctrl1
  call void @mainSimpleSort.27(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %lo, i32 %hi, i32 %d, i32* %budget)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_mainSimpleSort.11, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_mainSimpleSort.21, label %func_mainSimpleSort.27
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_mmed3.29, label %ctrl0

func_mmed3.29:                                    ; preds = %rand_bb
  %2 = call i8 @mmed3.29(i8 %a, i8 %b, i8 %c)
  ret i8 %2

func_mmed3.30:                                    ; preds = %ctrl0
  %3 = call i8 @mmed3.30(i8 %a, i8 %b, i8 %c)
  ret i8 %3

func_mmed3.32:                                    ; preds = %ctrl1
  %4 = call i8 @mmed3.32(i8 %a, i8 %b, i8 %c)
  ret i8 %4

func_mmed3.35:                                    ; preds = %ctrl1
  %5 = call i8 @mmed3.35(i8 %a, i8 %b, i8 %c)
  ret i8 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_mmed3.30, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_mmed3.32, label %func_mmed3.35
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_mainGtU.1, label %ctrl0

func_mainGtU.1:                                   ; preds = %rand_bb
  %2 = call i8 @mainGtU.1(i32 %i1, i32 %i2, i8* %block, i16* %quadrant, i32 %nblock, i32* %budget)
  ret i8 %2

func_mainGtU.12:                                  ; preds = %ctrl0
  %3 = call i8 @mainGtU.12(i32 %i1, i32 %i2, i8* %block, i16* %quadrant, i32 %nblock, i32* %budget)
  ret i8 %3

func_mainGtU.23:                                  ; preds = %ctrl1
  %4 = call i8 @mainGtU.23(i32 %i1, i32 %i2, i8* %block, i16* %quadrant, i32 %nblock, i32* %budget)
  ret i8 %4

func_mainGtU.26:                                  ; preds = %ctrl1
  %5 = call i8 @mainGtU.26(i32 %i1, i32 %i2, i8* %block, i16* %quadrant, i32 %nblock, i32* %budget)
  ret i8 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_mainGtU.12, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_mainGtU.23, label %func_mainGtU.26
}

; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @mainGtU.1(i32 %i1, i32 %i2, i8* %block, i16* %quadrant, i32 %nblock, i32* %budget) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 1124706165, i32* %canary
...
return:                                           ; preds = %do.end, %if.then445, %if.then430, %if.then413, %if.then398, %if.then381, %if.then366, %if.then349, %if.then334, %if.then317, %if.then302, %if.then285, %if.then270, %if.then253, %if.then238, %if.then221, %if.then206, %if.then189, %if.then172, %if.then155, %if.then138, %if.then121, %if.then104, %if.then87, %if.then70, %if.then53, %if.then36, %if.then19, %if.then
  ...
  %334 = load i32, i32* %canary
  %335 = icmp eq i32 %334, 1124706165
  br i1 %335, label %336, label %func_exit

336:                                              ; preds = %return, %func_exit
  ret i8 %333
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @mainSimpleSort.2(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %lo, i32 %hi, i32 %d, i32* %budget) #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1636359664, i32* %canary
...
for.end:                                          ; preds = %if.then94, %for.cond, %if.then
  ...
  %113 = icmp eq i32 %112, 1636359664
  br i1 %113, label %114, label %func_exit

114:                                              ; preds = %for.end, %func_exit
  ret void
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @BZ2_blockSort.3(%struct.EState* %s) #0 {
entry:
  %s.addr = alloca %struct.EState*, align 8
  %budgetInit = alloca i32, align 4
  %canary = alloca i32
  store i32 737142976, i32* %canary
...
if.end49:                                         ; preds = %if.then48, %for.end
  ...
  %69 = icmp eq i32 %68, 737142976
  br i1 %69, label %70, label %func_exit

70:                                               ; preds = %if.end49, %func_exit
  ret void

func_exit:                                        ; preds = %if.end49
  call void @detect_breach()
  br label %70
}

; Function Attrs: noinline nounwind optnone uwtable
define internal void @mainQSort3.4(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %loSt, i32 %hiSt, i32 %dSt, i32* %budget) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 2013407167, i32* %canary
...
while.end302:                                     ; preds = %if.then16, %while.cond
  %253 = load i32, i32* %canary
  %254 = icmp eq i32 %253, 2013407167
  br i1 %254, label %255, label %func_exit

255:                                              ; preds = %while.end302, %func_exit
  ret void

func_exit:                                        ; preds = %while.end302
  call void @detect_breach()
  br label %255
}

; Function Attrs: noinline nounwind optnone uwtable
define internal void @fallbackSimpleSort.5(i32* %fmap, i32* %eclass, i32 %lo, i32 %hi) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 1278748240, i32* %canary
...
for.end58:                                        ; preds = %for.cond28, %if.then
  ...
  %63 = icmp eq i32 %62, 1278748240
  br i1 %63, label %64, label %func_exit

64:                                               ; preds = %for.end58, %func_exit
  ret void

func_exit:                                        ; preds = %for.end58
  call void @detect_breach()
  br label %64
}

; Function Attrs: noinline nounwind optnone uwtable
define internal void @fallbackQSort3.6(i32* %fmap, i32* %eclass, i32 %loSt, i32 %hiSt) #0 {
entry:
  %hiSt.addr = alloca i32, align 4
  %yyn143 = alloca i32, align 4
  %r3 = alloca i32, align 4
  %canary = alloca i32
  store i32 801190077, i32* %canary
...
while.end192:                                     ; preds = %while.cond
  %189 = load i32, i32* %canary
  %190 = icmp eq i32 %189, 801190077
  br i1 %190, label %191, label %func_exit

191:                                              ; preds = %while.end192, %func_exit
  ret void

func_exit:                                        ; preds = %while.end192
  call void @detect_breach()
  br label %191
}

; Function Attrs: noinline nounwind optnone uwtable
define internal void @fallbackSimpleSort.7(i32* %fmap, i32* %eclass, i32 %lo, i32 %hi) #0 {
entry:
  %ec_tmp = alloca i32, align 4
  %i = alloca i32, align 4
  %tmp = alloca i32, align 4
  ...
  %fmap.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 782218717, i32* %canary
  %eclass.addr = alloca i32*, align 8
  store i32* %fmap, i32** %fmap.addr, align 8
  store i32* %eclass, i32** %eclass.addr, align 8
  store i32 %lo, i32* %lo.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @mainSort.8(i32* %ptr, i8* %block, i16* %quadrant, i32* %ftab, i32 %nblock, i32 %verb, i32* %budget) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 713165985, i32* %canary
...
if.end514:                                        ; preds = %if.then511, %for.end508, %if.then318
  %345 = load i32, i32* %canary
  %346 = icmp eq i32 %345, 713165985
  br i1 %346, label %347, label %func_exit

347:                                              ; preds = %if.end514, %func_exit
  ret void

func_exit:                                        ; preds = %if.end514
  call void @detect_breach()
  br label %347
}

; Function Attrs: noinline nounwind optnone uwtable
define internal void @fallbackSort.9(i32* %fmap, i32* %eclass, i32* %bhtab, i32 %nblock, i32 %verb) #0 {
entry:
  %fmap.addr = alloca i32*, align 8
  ...
  %nblock.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1509606558, i32* %canary
  %i = alloca i32, align 4
  %r = alloca i32, align 4
...
if.end298:                                        ; preds = %if.then297, %for.end294
  %182 = load i32, i32* %canary
  %183 = icmp eq i32 %182, 1509606558
  br i1 %183, label %184, label %func_exit

184:                                              ; preds = %if.end298, %func_exit
  ret void

func_exit:                                        ; preds = %if.end298
  call void @detect_breach()
  br label %184
}

; Function Attrs: noinline nounwind optnone uwtable
define internal void @fallbackSort.10(i32* %fmap, i32* %eclass, i32* %bhtab, i32 %nblock, i32 %verb) #0 {
entry:
  %fmap.addr = alloca i32*, align 8
  %nblock.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 950491626, i32* %canary
  %r = alloca i32, align 4
  %i = alloca i32, align 4
  %l = alloca i32, align 4
  %k = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @mainSimpleSort.11(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %lo, i32 %hi, i32 %d, i32* %budget) #0 {
entry:
  %quadrant.addr = alloca i16*, align 8
  %block.addr = alloca i8*, align 8
  %bigN = alloca i32, align 4
  ...
  %ptr.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 1214771041, i32* %canary
  %nblock.addr = alloca i32, align 4
  %v = alloca i32, align 4
  %hi.addr = alloca i32, align 4
  %d.addr = alloca i32, align 4
...
for.end:                                          ; preds = %if.then94, %for.cond, %if.then
  %112 = load i32, i32* %canary
  %113 = icmp eq i32 %112, 1214771041
  br i1 %113, label %114, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @mainGtU.12(i32 %i1, i32 %i2, i8* %block, i16* %quadrant, i32 %nblock, i32* %budget) #0 {
entry:
  %budget.addr = alloca i32*, align 8
  %block.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1287215516, i32* %canary
  %c1 = alloca i8, align 1
  %retval = alloca i8, align 1
  %i2.addr = alloca i32, align 4
  %nblock.addr = alloca i32, align 4
...
return:                                           ; preds = %do.end, %if.then445, %if.then430, %if.then413, %if.then398, %if.then381, %if.then366, %if.then349, %if.then334, %if.then317, %if.then302, %if.then285, %if.then270, %if.then253, %if.then238, %if.then221, %if.then206, %if.then189, %if.then172, %if.then155, %if.then138, %if.then121, %if.then104, %if.then87, %if.then70, %if.then53, %if.then36, %if.then19, %if.then
  %333 = load i8, i8* %retval, align 1
  %334 = load i32, i32* %canary
  %335 = icmp eq i32 %334, 1287215516
  br i1 %335, label %336, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @BZ2_blockSort.13(%struct.EState* %s) #0 {
entry:
  %nblock = alloca i32, align 4
  %canary = alloca i32
  store i32 215552448, i32* %canary
  %ftab = alloca i32*, align 8
  %quadrant = alloca i16*, align 8
  %i = alloca i32, align 4
  %block = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @mainQSort3.14(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %loSt, i32 %hiSt, i32 %dSt, i32* %budget) #0 {
entry:
  %ltLo = alloca i32, align 4
  %yyp2 = alloca i32, align 4
  %d = alloca i32, align 4
  ...
  %zztmp = alloca i32, align 4
  %canary = alloca i32
  store i32 1119786128, i32* %canary
  %m = alloca i32, align 4
  %yyp2165 = alloca i32, align 4
  %hiSt.addr = alloca i32, align 4
  store i32* %ptr, i32** %ptr.addr, align 8
...
while.end302:                                     ; preds = %if.then16, %while.cond
  %253 = load i32, i32* %canary
  %254 = icmp eq i32 %253, 1119786128
  br i1 %254, label %255, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @mainSort.15(i32* %ptr, i8* %block, i16* %quadrant, i32* %ftab, i32 %nblock, i32 %verb, i32* %budget) #0 {
entry:
  %k = alloca i32, align 4
  %hi = alloca i32, align 4
  %canary = alloca i32
  store i32 1533116564, i32* %canary
  %c1 = alloca i8, align 1
  %lo = alloca i32, align 4
  %shifts = alloca i32, align 4
  %ss = alloca i32, align 4
...
if.end514:                                        ; preds = %if.then511, %for.end508, %if.then318
  %345 = load i32, i32* %canary
  %346 = icmp eq i32 %345, 1533116564
  br i1 %346, label %347, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @mainQSort3.16(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %loSt, i32 %hiSt, i32 %dSt, i32* %budget) #0 {
entry:
  %d = alloca i32, align 4
  %dSt.addr = alloca i32, align 4
  %sp = alloca i32, align 4
  ...
  %zztmp84 = alloca i32, align 4
  %canary = alloca i32
  store i32 823347152, i32* %canary
  %yyn168 = alloca i32, align 4
  %yyp1164 = alloca i32, align 4
  %yyp2 = alloca i32, align 4
  %yyp2165 = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @fallbackQSort3.17(i32* %fmap, i32* %eclass, i32 %loSt, i32 %hiSt) #0 {
entry:
  %zztmp73 = alloca i32, align 4
  %yyn143 = alloca i32, align 4
  %fmap.addr = alloca i32*, align 8
  ...
  %lo = alloca i32, align 4
  %canary = alloca i32
  store i32 1826935208, i32* %canary
  %m = alloca i32, align 4
  %yyp1139 = alloca i32, align 4
  %unHi = alloca i32, align 4
  %yyp2 = alloca i32, align 4
...
while.end192:                                     ; preds = %while.cond
  %189 = load i32, i32* %canary
  %190 = icmp eq i32 %189, 1826935208
  br i1 %190, label %191, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @mainSort.18(i32* %ptr, i8* %block, i16* %quadrant, i32* %ftab, i32 %nblock, i32 %verb, i32* %budget) #0 {
entry:
  %ptr.addr = alloca i32*, align 8
  %hi = alloca i32, align 4
  %canary = alloca i32
  store i32 588846705, i32* %canary
  %ss = alloca i32, align 4
  %h = alloca i32, align 4
  %block.addr = alloca i8*, align 8
  %qVal = alloca i16, align 2
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @fallbackSimpleSort.19(i32* %fmap, i32* %eclass, i32 %lo, i32 %hi) #0 {
entry:
  %j = alloca i32, align 4
  %tmp = alloca i32, align 4
  %canary = alloca i32
  store i32 726300738, i32* %canary
  %ec_tmp = alloca i32, align 4
  %i = alloca i32, align 4
  %eclass.addr = alloca i32*, align 8
  %hi.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @mainQSort3.20(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %loSt, i32 %hiSt, i32 %dSt, i32* %budget) #0 {
entry:
  %gtHi = alloca i32, align 4
  %tz235 = alloca i32, align 4
  %nextLo = alloca [3 x i32], align 4
  ...
  %loSt.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1806969970, i32* %canary
  %zztmp106 = alloca i32, align 4
  %yyp2165 = alloca i32, align 4
  %ltLo = alloca i32, align 4
  %stackHi = alloca [100 x i32], align 16
...
while.end302:                                     ; preds = %if.then16, %while.cond
  %253 = load i32, i32* %canary
  %254 = icmp eq i32 %253, 1806969970
  br i1 %254, label %255, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @mainSimpleSort.21(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %lo, i32 %hi, i32 %d, i32* %budget) #0 {
entry:
  %v = alloca i32, align 4
  %d.addr = alloca i32, align 4
  %ptr.addr = alloca i32*, align 8
  %hp = alloca i32, align 4
  %canary = alloca i32
  store i32 1151103161, i32* %canary
  %h = alloca i32, align 4
  %bigN = alloca i32, align 4
  %quadrant.addr = alloca i16*, align 8
  %block.addr = alloca i8*, align 8
...
for.end:                                          ; preds = %if.then94, %for.cond, %if.then
  %112 = load i32, i32* %canary
  %113 = icmp eq i32 %112, 1151103161
  br i1 %113, label %114, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @fallbackSort.22(i32* %fmap, i32* %eclass, i32* %bhtab, i32 %nblock, i32 %verb) #0 {
entry:
  %i = alloca i32, align 4
  %verb.addr = alloca i32, align 4
  %r = alloca i32, align 4
  ...
  %H = alloca i32, align 4
  %canary = alloca i32
  store i32 2024308113, i32* %canary
  %ftabCopy = alloca [256 x i32], align 16
  %nblock.addr = alloca i32, align 4
  %eclass.addr = alloca i32*, align 8
  %nNotDone = alloca i32, align 4
...
if.end298:                                        ; preds = %if.then297, %for.end294
  %182 = load i32, i32* %canary
  %183 = icmp eq i32 %182, 2024308113
  br i1 %183, label %184, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @mainGtU.23(i32 %i1, i32 %i2, i8* %block, i16* %quadrant, i32 %nblock, i32* %budget) #0 {
entry:
  %k = alloca i32, align 4
  %canary = alloca i32
  store i32 1567815403, i32* %canary
  %c1 = alloca i8, align 1
  %quadrant.addr = alloca i16*, align 8
  %c2 = alloca i8, align 1
  %i2.addr = alloca i32, align 4
...
return:                                           ; preds = %do.end, %if.then445, %if.then430, %if.then413, %if.then398, %if.then381, %if.then366, %if.then349, %if.then334, %if.then317, %if.then302, %if.then285, %if.then270, %if.then253, %if.then238, %if.then221, %if.then206, %if.then189, %if.then172, %if.then155, %if.then138, %if.then121, %if.then104, %if.then87, %if.then70, %if.then53, %if.then36, %if.then19, %if.then
  %333 = load i8, i8* %retval, align 1
  %334 = load i32, i32* %canary
  %335 = icmp eq i32 %334, 1567815403
  br i1 %335, label %336, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @fallbackQSort3.24(i32* %fmap, i32* %eclass, i32 %loSt, i32 %hiSt) #0 {
entry:
  %gtHi = alloca i32, align 4
  %yyp2 = alloca i32, align 4
  %yyp1 = alloca i32, align 4
  ...
  %n = alloca i32, align 4
  %canary = alloca i32
  store i32 969680183, i32* %canary
  %unHi = alloca i32, align 4
  %yyn143 = alloca i32, align 4
  %zztmp147 = alloca i32, align 4
  %zztmp93 = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @mainSort.25(i32* %ptr, i8* %block, i16* %quadrant, i32* %ftab, i32 %nblock, i32 %verb, i32* %budget) #0 {
entry:
  %ss = alloca i32, align 4
  %k = alloca i32, align 4
  %bbSize = alloca i32, align 4
  %block.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 352249307, i32* %canary
  %ftab.addr = alloca i32*, align 8
  %qVal = alloca i16, align 2
  %h = alloca i32, align 4
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @mainGtU.26(i32 %i1, i32 %i2, i8* %block, i16* %quadrant, i32 %nblock, i32* %budget) #0 {
entry:
  %quadrant.addr = alloca i16*, align 8
  %c1 = alloca i8, align 1
  %retval = alloca i8, align 1
  %canary = alloca i32
  store i32 1733261174, i32* %canary
  %s2 = alloca i16, align 2
  %block.addr = alloca i8*, align 8
  %c2 = alloca i8, align 1
  %i1.addr = alloca i32, align 4
...
return:                                           ; preds = %do.end, %if.then445, %if.then430, %if.then413, %if.then398, %if.then381, %if.then366, %if.then349, %if.then334, %if.then317, %if.then302, %if.then285, %if.then270, %if.then253, %if.then238, %if.then221, %if.then206, %if.then189, %if.then172, %if.then155, %if.then138, %if.then121, %if.then104, %if.then87, %if.then70, %if.then53, %if.then36, %if.then19, %if.then
  %333 = load i8, i8* %retval, align 1
  %334 = load i32, i32* %canary
  %335 = icmp eq i32 %334, 1733261174
  br i1 %335, label %336, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @mainSimpleSort.27(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %lo, i32 %hi, i32 %d, i32* %budget) #0 {
entry:
  %lo.addr = alloca i32, align 4
  %block.addr = alloca i8*, align 8
  %j = alloca i32, align 4
  ...
  %ptr.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 2055879771, i32* %canary
  %d.addr = alloca i32, align 4
  %hp = alloca i32, align 4
  %nblock.addr = alloca i32, align 4
  %quadrant.addr = alloca i16*, align 8
...
for.end:                                          ; preds = %if.then94, %for.cond, %if.then
  %112 = load i32, i32* %canary
  %113 = icmp eq i32 %112, 2055879771
  br i1 %113, label %114, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @fallbackSort.28(i32* %fmap, i32* %eclass, i32* %bhtab, i32 %nblock, i32 %verb) #0 {
entry:
  %ftab = alloca [257 x i32], align 16
  %r = alloca i32, align 4
  %eclass.addr = alloca i32*, align 8
  ...
  %cc1 = alloca i32, align 4
  %canary = alloca i32
  store i32 1483296299, i32* %canary
  %bhtab.addr = alloca i32*, align 8
  %eclass8 = alloca i8*, align 8
  %j = alloca i32, align 4
  %l = alloca i32, align 4
...
if.end298:                                        ; preds = %if.then297, %for.end294
  %182 = load i32, i32* %canary
  %183 = icmp eq i32 %182, 1483296299
  br i1 %183, label %184, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @mmed3.29(i8 zeroext %a, i8 zeroext %b, i8 zeroext %c) #0 {
entry:
  %canary = alloca i32
  store i32 1773224907, i32* %canary
...
if.end14:                                         ; preds = %if.end13, %if.end
  ...
  %13 = icmp eq i32 %12, 1773224907
  br i1 %13, label %14, label %func_exit

14:                                               ; preds = %if.end14, %func_exit
  ret i8 %11

func_exit:                                        ; preds = %if.end14
  call void @detect_breach()
  br label %14
}

; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @mmed3.30(i8 zeroext %a, i8 zeroext %b, i8 zeroext %c) #0 {
entry:
  %t = alloca i8, align 1
  %a.addr = alloca i8, align 1
  %c.addr = alloca i8, align 1
  %canary = alloca i32
  store i32 1097593241, i32* %canary
  %b.addr = alloca i8, align 1
  store i8 %a, i8* %a.addr, align 1
  store i8 %b, i8* %b.addr, align 1
  store i8 %c, i8* %c.addr, align 1
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @fallbackSimpleSort.31(i32* %fmap, i32* %eclass, i32 %lo, i32 %hi) #0 {
entry:
  %ec_tmp = alloca i32, align 4
  %i = alloca i32, align 4
  %fmap.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 122629636, i32* %canary
  %eclass.addr = alloca i32*, align 8
  %hi.addr = alloca i32, align 4
  %tmp = alloca i32, align 4
  %j = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @mmed3.32(i8 zeroext %a, i8 zeroext %b, i8 zeroext %c) #0 {
entry:
  %c.addr = alloca i8, align 1
  %a.addr = alloca i8, align 1
  %canary = alloca i32
  store i32 1976131376, i32* %canary
  %b.addr = alloca i8, align 1
  %t = alloca i8, align 1
  store i8 %a, i8* %a.addr, align 1
  store i8 %b, i8* %b.addr, align 1
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @BZ2_blockSort.33(%struct.EState* %s) #0 {
entry:
  %verb = alloca i32, align 4
  %block = alloca i8*, align 8
  %canary = alloca i32
  store i32 675466285, i32* %canary
  %ptr = alloca i32*, align 8
  %budget = alloca i32, align 4
  %nblock = alloca i32, align 4
  %quadrant = alloca i16*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @fallbackQSort3.34(i32* %fmap, i32* %eclass, i32 %loSt, i32 %hiSt) #0 {
entry:
  %m = alloca i32, align 4
  %fmap.addr = alloca i32*, align 8
  %med = alloca i32, align 4
  ...
  %zztmp147 = alloca i32, align 4
  %canary = alloca i32
  store i32 513836956, i32* %canary
  %zztmp93 = alloca i32, align 4
  %unHi = alloca i32, align 4
  %zztmp = alloca i32, align 4
  store i32* %fmap, i32** %fmap.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @mmed3.35(i8 zeroext %a, i8 zeroext %b, i8 zeroext %c) #0 {
entry:
  %canary = alloca i32
  store i32 1410322206, i32* %canary
  %b.addr = alloca i8, align 1
  %t = alloca i8, align 1
  %c.addr = alloca i8, align 1
  %a.addr = alloca i8, align 1
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @BZ2_blockSort.36(%struct.EState* %s) #0 {
entry:
  %s.addr = alloca %struct.EState*, align 8
  %wfact = alloca i32, align 4
  %ftab = alloca i32*, align 8
  ...
  %budget = alloca i32, align 4
  %canary = alloca i32
  store i32 1004064038, i32* %canary
  %quadrant = alloca i16*, align 8
  %ptr = alloca i32*, align 8
  %i = alloca i32, align 4
  %verb = alloca i32, align 4
