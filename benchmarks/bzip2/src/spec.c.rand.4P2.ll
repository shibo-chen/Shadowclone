...
func_ran.15:                                      ; preds = %ctrl1
  %4 = call double @ran.15()
  ret double %4

func_ran.18:                                      ; preds = %ctrl1
  %5 = call double @ran.18()
  ret double %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_ran.13, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_ran.15, label %func_ran.18
}
...
func_spec_init.32:                                ; preds = %ctrl1
  %4 = call i32 @spec_init.32()
  ret i32 %4
...
ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_spec_init.32, label %func_spec_init.34
}
...
func_spec_random_load.37:                         ; preds = %ctrl1
  %5 = call i32 @spec_random_load.37(i32 %fd)
  ret i32 %5
...
ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_spec_random_load.31, label %func_spec_random_load.37
}
...
func_spec_load.27:                                ; preds = %ctrl1
  %4 = call i32 @spec_load.27(i32 %num, i8* %filename, i32 %size)
  ret i32 %4

func_spec_load.33:                                ; preds = %ctrl1
  %5 = call i32 @spec_load.33(i32 %num, i8* %filename, i32 %size)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_spec_load.5, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_spec_load.27, label %func_spec_load.33
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_spec_read.17, label %ctrl0

func_spec_read.17:                                ; preds = %rand_bb
  %2 = call i32 @spec_read.17(i32 %fd, i8* %buf, i32 %size)
  ret i32 %2
...
func_spec_read.38:                                ; preds = %ctrl1
  %4 = call i32 @spec_read.38(i32 %fd, i8* %buf, i32 %size)
  ret i32 %4
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_spec_read.20, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_spec_read.38, label %func_spec_read.39
}
...
func_spec_fread.14:                               ; preds = %ctrl0
  %3 = call i32 @spec_fread.14(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %3
...
func_spec_fread.22:                               ; preds = %ctrl1
  %5 = call i32 @spec_fread.22(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_spec_fread.14, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_spec_fread.19, label %func_spec_fread.22
}
...
func_spec_getc.21:                                ; preds = %ctrl0
  %3 = call i32 @spec_getc.21(i32 %fd)
  ret i32 %3

func_spec_getc.28:                                ; preds = %ctrl1
  %4 = call i32 @spec_getc.28(i32 %fd)
  ret i32 %4
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_spec_getc.21, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_spec_getc.28, label %func_spec_getc.30
}
...
func_spec_ungetc.23:                              ; preds = %ctrl1
  %4 = call i32 @spec_ungetc.23(i8 %ch, i32 %fd)
  ret i32 %4

func_spec_ungetc.26:                              ; preds = %ctrl1
  %5 = call i32 @spec_ungetc.26(i8 %ch, i32 %fd)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_spec_ungetc.12, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_spec_ungetc.23, label %func_spec_ungetc.26
}
...
func_spec_write.10:                               ; preds = %ctrl0
  %3 = call i32 @spec_write.10(i32 %fd, i8* %buf, i32 %size)
  ret i32 %3
...
func_spec_write.24:                               ; preds = %ctrl1
  %5 = call i32 @spec_write.24(i32 %fd, i8* %buf, i32 %size)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_spec_write.10, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_spec_write.16, label %func_spec_write.24
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_spec_fwrite.36, label %ctrl0

func_spec_fwrite.36:                              ; preds = %rand_bb
  %2 = call i32 @spec_fwrite.36(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %2

func_spec_fwrite.40:                              ; preds = %ctrl0
  %3 = call i32 @spec_fwrite.40(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %3

func_spec_fwrite.41:                              ; preds = %ctrl1
  %4 = call i32 @spec_fwrite.41(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %4
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_spec_fwrite.40, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_spec_fwrite.41, label %func_spec_fwrite.42
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_spec_putc.29, label %func_spec_putc.35

func_spec_putc.29:                                ; preds = %rand_bb
  %2 = call i32 @spec_putc.29(i8 %ch, i32 %fd)
  ret i32 %2

func_spec_putc.35:                                ; preds = %rand_bb
  %3 = call i32 @spec_putc.35(i8 %ch, i32 %fd)
  ret i32 %3
}
...
entry:
  %canary = alloca i32
  store i32 431569987, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1541690627, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1712526930, i32* %canary
  %num.addr = alloca i32, align 4
  %rc = alloca i32, align 4
  %size.addr = alloca i32, align 4
  %i = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1906025600, i32* %canary
  %rc = alloca i32, align 4
  %fd = alloca i32, align 4
  %tmp = alloca i32, align 4
  %i = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 756348714, i32* %canary
  %j = alloca i32, align 4
  %i = alloca i32, align 4
  %fd.addr = alloca i32, align 4
...
entry:
  ...
  %buf.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 397936523, i32* %canary
  %size.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
...
entry:
  ...
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 189285113, i32* %canary
  %random_text = alloca [32 x [131072 x i8]], align 16
  %j = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  %0 = load i32, i32* @dbglvl, align 4
...
entry:
  %rc = alloca i32, align 4
  %canary = alloca i32
  store i32 1123200173, i32* %canary
  %fd.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  store i32 0, i32* %rc, align 4
...
entry:
  ...
  %size.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 724949930, i32* %canary
  %buf.addr = alloca i8*, align 8
  store i32 %fd, i32* %fd.addr, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 1610599789, i32* %canary
...
entry:
  %canary = alloca i32
  store i32 1376130377, i32* %canary
  %ch.addr = alloca i8, align 1
  %fd.addr = alloca i32, align 4
  %rc = alloca i32, align 4
  store i8 %ch, i8* %ch.addr, align 1
...
entry:
  %test = alloca i64, align 8
  %canary = alloca i32
  store i32 251026120, i32* %canary
  %lo = alloca i64, align 8
  %hi = alloca i64, align 8
  %0 = load i64, i64* @seedi, align 8
  %div = sdiv i64 %0, 127773
...
entry:
  ...
  %size.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 729099270, i32* %canary
  %num.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  %rc = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
...
entry:
  %lo = alloca i64, align 8
  %canary = alloca i32
  store i32 833379277, i32* %canary
  %test = alloca i64, align 8
  %hi = alloca i64, align 8
  %0 = load i64, i64* @seedi, align 8
  %div = sdiv i64 %0, 127773
...
entry:
  ...
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1251405038, i32* %canary
  %buf.addr = alloca i8*, align 8
  store i32 %fd, i32* %fd.addr, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
...
entry:
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 446703061, i32* %canary
  %size.addr = alloca i32, align 4
  %rc = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %fd.addr = alloca i32, align 4
...
entry:
  ...
  %rc = alloca i32, align 4
  %canary = alloca i32
  store i32 249985838, i32* %canary
  %retval = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
...
entry:
  ...
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1724589865, i32* %canary
  %retval = alloca i32, align 4
  %size.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  store i8* %buf, i8** %buf.addr, align 8
...
entry:
  ...
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 925168254, i32* %canary
  %rc = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  store i32 0, i32* %rc, align 4
  %0 = load i32, i32* @dbglvl, align 4
...
entry:
  %num.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1053466076, i32* %canary
  %fd.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  %rc = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
...
entry:
  %canary = alloca i32
  store i32 1128664624, i32* %canary
  %buf.addr = alloca i8*, align 8
  %fd.addr = alloca i32, align 4
  %size.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
...
entry:
  %limit = alloca i32, align 4
  %canary = alloca i32
  store i32 1203513863, i32* %canary
  %j = alloca i32, align 4
  %i = alloca i32, align 4
  %0 = load i32, i32* @dbglvl, align 4
  %cmp = icmp slt i32 3, %0
...
entry:
  ...
  %ch.addr = alloca i8, align 1
  %canary = alloca i32
  store i32 291683282, i32* %canary
  %fd.addr = alloca i32, align 4
  store i8 %ch, i8* %ch.addr, align 1
  store i32 %fd, i32* %fd.addr, align 4
  store i32 0, i32* %rc, align 4
...
entry:
  ...
  %size.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1946353398, i32* %canary
  %filename.addr = alloca i8*, align 8
  %i = alloca i32, align 4
  %fd = alloca i32, align 4
  %num.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_getc.28(i32 %fd) #0 {
entry:
  %canary = alloca i32
  store i32 1540383882, i32* %canary
  %fd.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  %rc = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
...
entry:
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2033029215, i32* %canary
  %ch.addr = alloca i8, align 1
  store i8 %ch, i8* %ch.addr, align 1
  store i32 %fd, i32* %fd.addr, align 4
  %0 = load i32, i32* @dbglvl, align 4
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1227285646, i32* %canary
  %fd.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  store i32 0, i32* %rc, align 4
  %0 = load i32, i32* @dbglvl, align 4
...
entry:
  %canary = alloca i32
  store i32 115652821, i32* %canary
  %i = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  %j = alloca i32, align 4
  %random_text = alloca [32 x [131072 x i8]], align 16
...
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 323733296, i32* %canary
  %j = alloca i32, align 4
  %limit = alloca i32, align 4
  %0 = load i32, i32* @dbglvl, align 4
  %cmp = icmp slt i32 3, %0
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 778752344, i32* %canary
  %num.addr = alloca i32, align 4
  %rc = alloca i32, align 4
  store i32 %num, i32* %num.addr, align 4
  store i8* %filename, i8** %filename.addr, align 8
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 473985453, i32* %canary
  %limit = alloca i32, align 4
  %0 = load i32, i32* @dbglvl, align 4
  %cmp = icmp slt i32 3, %0
  br i1 %cmp, label %if.then, label %if.end
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_putc.35(i8 zeroext %ch, i32 %fd) #0 {
entry:
  %ch.addr = alloca i8, align 1
  %canary = alloca i32
  store i32 1948772484, i32* %canary
  %fd.addr = alloca i32, align 4
  store i8 %ch, i8* %ch.addr, align 1
  store i32 %fd, i32* %fd.addr, align 4
  %0 = load i32, i32* @dbglvl, align 4
...
entry:
  ...
  %buf.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1434527357, i32* %canary
  %fd.addr = alloca i32, align 4
  %num.addr = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
...
entry:
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1207196713, i32* %canary
  %fd.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %random_text = alloca [32 x [131072 x i8]], align 16
  store i32 %fd, i32* %fd.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_read.38(i32 %fd, i8* %buf, i32 %size) #0 {
entry:
  %buf.addr = alloca i8*, align 8
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1485254993, i32* %canary
  %size.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  %rc = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
...
entry:
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1377286912, i32* %canary
  %buf.addr = alloca i8*, align 8
  %rc = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  %size.addr = alloca i32, align 4
...
entry:
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 301122158, i32* %canary
  %size.addr = alloca i32, align 4
  %num.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  store i8* %buf, i8** %buf.addr, align 8
...
entry:
  ...
  %buf.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 2105041956, i32* %canary
  %size.addr = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
...
entry:
  ...
  %num.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1917395334, i32* %canary
  %size.addr = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
  store i32 %num, i32* %num.addr, align 4
