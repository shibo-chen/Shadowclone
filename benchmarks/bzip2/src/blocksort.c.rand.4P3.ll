; ModuleID = 'blocksort.c.rand.4P3.bc'
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_BZ2_blockSort.10, label %ctrl0

func_BZ2_blockSort.10:                            ; preds = %rand_bb
  call void @BZ2_blockSort.10(%struct.EState* %s)
  ret void
...
func_BZ2_blockSort.17:                            ; preds = %ctrl1
  call void @BZ2_blockSort.17(%struct.EState* %s)
  ret void

func_BZ2_blockSort.22:                            ; preds = %ctrl1
  call void @BZ2_blockSort.22(%struct.EState* %s)
  ret void
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_BZ2_blockSort.17, label %func_BZ2_blockSort.22
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_fallbackSort.16, label %ctrl0

func_fallbackSort.16:                             ; preds = %rand_bb
  call void @fallbackSort.16(i32* %fmap, i32* %eclass, i32* %bhtab, i32 %nblock, i32 %verb)
  ret void

func_fallbackSort.20:                             ; preds = %ctrl0
  call void @fallbackSort.20(i32* %fmap, i32* %eclass, i32* %bhtab, i32 %nblock, i32 %verb)
  ret void

func_fallbackSort.27:                             ; preds = %ctrl1
  call void @fallbackSort.27(i32* %fmap, i32* %eclass, i32* %bhtab, i32 %nblock, i32 %verb)
  ret void

func_fallbackSort.32:                             ; preds = %ctrl1
  call void @fallbackSort.32(i32* %fmap, i32* %eclass, i32* %bhtab, i32 %nblock, i32 %verb)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_fallbackSort.20, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_fallbackSort.27, label %func_fallbackSort.32
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_mainSort.28, label %ctrl0

func_mainSort.28:                                 ; preds = %rand_bb
  call void @mainSort.28(i32* %ptr, i8* %block, i16* %quadrant, i32* %ftab, i32 %nblock, i32 %verb, i32* %budget)
  ret void

func_mainSort.29:                                 ; preds = %ctrl0
  call void @mainSort.29(i32* %ptr, i8* %block, i16* %quadrant, i32* %ftab, i32 %nblock, i32 %verb, i32* %budget)
  ret void

func_mainSort.33:                                 ; preds = %ctrl1
  call void @mainSort.33(i32* %ptr, i8* %block, i16* %quadrant, i32* %ftab, i32 %nblock, i32 %verb, i32* %budget)
  ret void

func_mainSort.36:                                 ; preds = %ctrl1
  call void @mainSort.36(i32* %ptr, i8* %block, i16* %quadrant, i32* %ftab, i32 %nblock, i32 %verb, i32* %budget)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_mainSort.29, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_mainSort.33, label %func_mainSort.36
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_fallbackQSort3.1, label %ctrl0

func_fallbackQSort3.1:                            ; preds = %rand_bb
  call void @fallbackQSort3.1(i32* %fmap, i32* %eclass, i32 %loSt, i32 %hiSt)
  ret void

func_fallbackQSort3.2:                            ; preds = %ctrl0
  call void @fallbackQSort3.2(i32* %fmap, i32* %eclass, i32 %loSt, i32 %hiSt)
  ret void

func_fallbackQSort3.4:                            ; preds = %ctrl1
  call void @fallbackQSort3.4(i32* %fmap, i32* %eclass, i32 %loSt, i32 %hiSt)
  ret void

func_fallbackQSort3.6:                            ; preds = %ctrl1
  call void @fallbackQSort3.6(i32* %fmap, i32* %eclass, i32 %loSt, i32 %hiSt)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_fallbackQSort3.2, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_fallbackQSort3.4, label %func_fallbackQSort3.6
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_fallbackSimpleSort.14, label %ctrl0

func_fallbackSimpleSort.14:                       ; preds = %rand_bb
  call void @fallbackSimpleSort.14(i32* %fmap, i32* %eclass, i32 %lo, i32 %hi)
  ret void

func_fallbackSimpleSort.19:                       ; preds = %ctrl0
  call void @fallbackSimpleSort.19(i32* %fmap, i32* %eclass, i32 %lo, i32 %hi)
  ret void

func_fallbackSimpleSort.34:                       ; preds = %ctrl1
  call void @fallbackSimpleSort.34(i32* %fmap, i32* %eclass, i32 %lo, i32 %hi)
  ret void

func_fallbackSimpleSort.35:                       ; preds = %ctrl1
  call void @fallbackSimpleSort.35(i32* %fmap, i32* %eclass, i32 %lo, i32 %hi)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_fallbackSimpleSort.19, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_fallbackSimpleSort.34, label %func_fallbackSimpleSort.35
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_mainQSort3.11, label %ctrl0

func_mainQSort3.11:                               ; preds = %rand_bb
  call void @mainQSort3.11(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %loSt, i32 %hiSt, i32 %dSt, i32* %budget)
  ret void

func_mainQSort3.24:                               ; preds = %ctrl0
  call void @mainQSort3.24(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %loSt, i32 %hiSt, i32 %dSt, i32* %budget)
  ret void

func_mainQSort3.30:                               ; preds = %ctrl1
  call void @mainQSort3.30(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %loSt, i32 %hiSt, i32 %dSt, i32* %budget)
  ret void

func_mainQSort3.31:                               ; preds = %ctrl1
  call void @mainQSort3.31(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %loSt, i32 %hiSt, i32 %dSt, i32* %budget)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_mainQSort3.24, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_mainQSort3.30, label %func_mainQSort3.31
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_mainSimpleSort.3, label %ctrl0

func_mainSimpleSort.3:                            ; preds = %rand_bb
  call void @mainSimpleSort.3(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %lo, i32 %hi, i32 %d, i32* %budget)
  ret void

func_mainSimpleSort.7:                            ; preds = %ctrl0
  call void @mainSimpleSort.7(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %lo, i32 %hi, i32 %d, i32* %budget)
  ret void

func_mainSimpleSort.12:                           ; preds = %ctrl1
  call void @mainSimpleSort.12(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %lo, i32 %hi, i32 %d, i32* %budget)
  ret void

func_mainSimpleSort.15:                           ; preds = %ctrl1
  call void @mainSimpleSort.15(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %lo, i32 %hi, i32 %d, i32* %budget)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_mainSimpleSort.7, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_mainSimpleSort.12, label %func_mainSimpleSort.15
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_mmed3.5, label %ctrl0

func_mmed3.5:                                     ; preds = %rand_bb
  %2 = call i8 @mmed3.5(i8 %a, i8 %b, i8 %c)
  ret i8 %2

func_mmed3.8:                                     ; preds = %ctrl0
  %3 = call i8 @mmed3.8(i8 %a, i8 %b, i8 %c)
  ret i8 %3

func_mmed3.9:                                     ; preds = %ctrl1
  %4 = call i8 @mmed3.9(i8 %a, i8 %b, i8 %c)
  ret i8 %4

func_mmed3.23:                                    ; preds = %ctrl1
  %5 = call i8 @mmed3.23(i8 %a, i8 %b, i8 %c)
  ret i8 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_mmed3.8, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_mmed3.9, label %func_mmed3.23
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_mainGtU.18, label %ctrl0

func_mainGtU.18:                                  ; preds = %rand_bb
  %2 = call i8 @mainGtU.18(i32 %i1, i32 %i2, i8* %block, i16* %quadrant, i32 %nblock, i32* %budget)
  ret i8 %2

func_mainGtU.21:                                  ; preds = %ctrl0
  %3 = call i8 @mainGtU.21(i32 %i1, i32 %i2, i8* %block, i16* %quadrant, i32 %nblock, i32* %budget)
  ret i8 %3

func_mainGtU.25:                                  ; preds = %ctrl1
  %4 = call i8 @mainGtU.25(i32 %i1, i32 %i2, i8* %block, i16* %quadrant, i32 %nblock, i32* %budget)
  ret i8 %4
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_mainGtU.21, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_mainGtU.25, label %func_mainGtU.26
}

; Function Attrs: noinline nounwind optnone uwtable
define internal void @fallbackQSort3.1(i32* %fmap, i32* %eclass, i32 %loSt, i32 %hiSt) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 428475416, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @fallbackQSort3.2(i32* %fmap, i32* %eclass, i32 %loSt, i32 %hiSt) #0 {
entry:
  %r = alloca i32, align 4
  %gtHi = alloca i32, align 4
  %zztmp = alloca i32, align 4
  ...
  %eclass.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 1815619831, i32* %canary
  %stackLo = alloca [100 x i32], align 16
  %zztmp73 = alloca i32, align 4
  %yyp1 = alloca i32, align 4
  %yyp2140 = alloca i32, align 4
...
while.end192:                                     ; preds = %while.cond
  %189 = load i32, i32* %canary
  %190 = icmp eq i32 %189, 1815619831
  br i1 %190, label %191, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @mainSimpleSort.3(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %lo, i32 %hi, i32 %d, i32* %budget) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 1374381501, i32* %canary
...
for.end:                                          ; preds = %if.then94, %for.cond, %if.then
  ...
  %113 = icmp eq i32 %112, 1374381501
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @fallbackQSort3.4(i32* %fmap, i32* %eclass, i32 %loSt, i32 %hiSt) #0 {
entry:
  %stackLo = alloca [100 x i32], align 16
  %zztmp93 = alloca i32, align 4
  %zztmp117 = alloca i32, align 4
  ...
  %lo = alloca i32, align 4
  %canary = alloca i32
  store i32 2058250056, i32* %canary
  %r = alloca i32, align 4
  %stackHi = alloca [100 x i32], align 16
  %unHi = alloca i32, align 4
  store i32* %fmap, i32** %fmap.addr, align 8
...
while.end192:                                     ; preds = %while.cond
  %189 = load i32, i32* %canary
  %190 = icmp eq i32 %189, 2058250056
  br i1 %190, label %191, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @mmed3.5(i8 zeroext %a, i8 zeroext %b, i8 zeroext %c) #0 {
entry:
  %a.addr = alloca i8, align 1
  %canary = alloca i32
  store i32 853617564, i32* %canary
...
entry:
  ...
  %unLo = alloca i32, align 4
  %canary = alloca i32
  store i32 1712224541, i32* %canary
  %med = alloca i32, align 4
  %zztmp = alloca i32, align 4
  %yyp2140 = alloca i32, align 4
  %fmap.addr = alloca i32*, align 8
...
while.end192:                                     ; preds = %while.cond
  %189 = load i32, i32* %canary
  %190 = icmp eq i32 %189, 1712224541
  br i1 %190, label %191, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @mainSimpleSort.7(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %lo, i32 %hi, i32 %d, i32* %budget) #0 {
entry:
  %lo.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %nblock.addr = alloca i32, align 4
  %hp = alloca i32, align 4
  %canary = alloca i32
  store i32 199870921, i32* %canary
  %hi.addr = alloca i32, align 4
  %ptr.addr = alloca i32*, align 8
  %j = alloca i32, align 4
  %budget.addr = alloca i32*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @mmed3.8(i8 zeroext %a, i8 zeroext %b, i8 zeroext %c) #0 {
entry:
  %canary = alloca i32
  store i32 1164942990, i32* %canary
  %b.addr = alloca i8, align 1
  %t = alloca i8, align 1
  %c.addr = alloca i8, align 1
  %a.addr = alloca i8, align 1
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @mmed3.9(i8 zeroext %a, i8 zeroext %b, i8 zeroext %c) #0 {
entry:
  %canary = alloca i32
  store i32 1025803546, i32* %canary
  %c.addr = alloca i8, align 1
  %t = alloca i8, align 1
  %b.addr = alloca i8, align 1
  %a.addr = alloca i8, align 1
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @BZ2_blockSort.10(%struct.EState* %s) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 1087222747, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @mainQSort3.11(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %loSt, i32 %hiSt, i32 %dSt, i32* %budget) #0 {
entry:
  ...
  %zztmp = alloca i32, align 4
  %canary = alloca i32
  store i32 1687693081, i32* %canary
...
while.end302:                                     ; preds = %if.then16, %while.cond
  ...
  %254 = icmp eq i32 %253, 1687693081
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @mainSimpleSort.12(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %lo, i32 %hi, i32 %d, i32* %budget) #0 {
entry:
  %bigN = alloca i32, align 4
  %j = alloca i32, align 4
  %budget.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 1986974012, i32* %canary
  %nblock.addr = alloca i32, align 4
  %d.addr = alloca i32, align 4
  %lo.addr = alloca i32, align 4
  %hp = alloca i32, align 4
...
for.end:                                          ; preds = %if.then94, %for.cond, %if.then
  %112 = load i32, i32* %canary
  %113 = icmp eq i32 %112, 1986974012
  br i1 %113, label %114, label %func_exit
...
entry:
  ...
  %budgetInit = alloca i32, align 4
  %canary = alloca i32
  store i32 1135961895, i32* %canary
  %ftab = alloca i32*, align 8
  %nblock = alloca i32, align 4
  %verb = alloca i32, align 4
  %quadrant = alloca i16*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @fallbackSimpleSort.14(i32* %fmap, i32* %eclass, i32 %lo, i32 %hi) #0 {
entry:
  %eclass.addr = alloca i32*, align 8
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 320802872, i32* %canary
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @mainSimpleSort.15(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %lo, i32 %hi, i32 %d, i32* %budget) #0 {
entry:
  %block.addr = alloca i8*, align 8
  %i = alloca i32, align 4
  %v = alloca i32, align 4
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1107173804, i32* %canary
  %bigN = alloca i32, align 4
  %budget.addr = alloca i32*, align 8
  %h = alloca i32, align 4
  store i32* %ptr, i32** %ptr.addr, align 8
...
for.end:                                          ; preds = %if.then94, %for.cond, %if.then
  %112 = load i32, i32* %canary
  %113 = icmp eq i32 %112, 1107173804
  br i1 %113, label %114, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @fallbackSort.16(i32* %fmap, i32* %eclass, i32* %bhtab, i32 %nblock, i32 %verb) #0 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @BZ2_blockSort.17(%struct.EState* %s) #0 {
entry:
  %quadrant = alloca i16*, align 8
  %s.addr = alloca %struct.EState*, align 8
  %wfact = alloca i32, align 4
  ...
  %budgetInit = alloca i32, align 4
  %canary = alloca i32
  store i32 775698314, i32* %canary
  %nblock = alloca i32, align 4
  store %struct.EState* %s, %struct.EState** %s.addr, align 8
  %0 = load %struct.EState*, %struct.EState** %s.addr, align 8
  %ptr1 = getelementptr inbounds %struct.EState, %struct.EState* %0, i32 0, i32 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @mainGtU.18(i32 %i1, i32 %i2, i8* %block, i16* %quadrant, i32 %nblock, i32* %budget) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 191467933, i32* %canary
  %k = alloca i32, align 4
  %nblock.addr = alloca i32, align 4
  %budget.addr = alloca i32*, align 8
...
entry:
  ...
  %ec_tmp = alloca i32, align 4
  %canary = alloca i32
  store i32 1984202026, i32* %canary
  %hi.addr = alloca i32, align 4
  %fmap.addr = alloca i32*, align 8
  store i32* %fmap, i32** %fmap.addr, align 8
  store i32* %eclass, i32** %eclass.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @fallbackSort.20(i32* %fmap, i32* %eclass, i32* %bhtab, i32 %nblock, i32 %verb) #0 {
entry:
  %nBhtab = alloca i32, align 4
  %i = alloca i32, align 4
  %nblock.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @mainGtU.21(i32 %i1, i32 %i2, i8* %block, i16* %quadrant, i32 %nblock, i32* %budget) #0 {
entry:
  %block.addr = alloca i8*, align 8
  %quadrant.addr = alloca i16*, align 8
  %i1.addr = alloca i32, align 4
  ...
  %s2 = alloca i16, align 2
  %canary = alloca i32
  store i32 1919582918, i32* %canary
  %budget.addr = alloca i32*, align 8
  %c2 = alloca i8, align 1
  %k = alloca i32, align 4
  %retval = alloca i8, align 1
...
return:                                           ; preds = %do.end, %if.then445, %if.then430, %if.then413, %if.then398, %if.then381, %if.then366, %if.then349, %if.then334, %if.then317, %if.then302, %if.then285, %if.then270, %if.then253, %if.then238, %if.then221, %if.then206, %if.then189, %if.then172, %if.then155, %if.then138, %if.then121, %if.then104, %if.then87, %if.then70, %if.then53, %if.then36, %if.then19, %if.then
  %333 = load i8, i8* %retval, align 1
  %334 = load i32, i32* %canary
  %335 = icmp eq i32 %334, 1919582918
  br i1 %335, label %336, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @BZ2_blockSort.22(%struct.EState* %s) #0 {
entry:
  %quadrant = alloca i16*, align 8
  %budget = alloca i32, align 4
  %i = alloca i32, align 4
  ...
  %ftab = alloca i32*, align 8
  %canary = alloca i32
  store i32 1460854406, i32* %canary
  %budgetInit = alloca i32, align 4
  %s.addr = alloca %struct.EState*, align 8
  %nblock = alloca i32, align 4
  store %struct.EState* %s, %struct.EState** %s.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @mmed3.23(i8 zeroext %a, i8 zeroext %b, i8 zeroext %c) #0 {
entry:
  %canary = alloca i32
  store i32 1915946697, i32* %canary
  %t = alloca i8, align 1
  %b.addr = alloca i8, align 1
  %c.addr = alloca i8, align 1
  %a.addr = alloca i8, align 1
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @mainQSort3.24(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %loSt, i32 %hiSt, i32 %dSt, i32* %budget) #0 {
entry:
  %zztmp = alloca i32, align 4
  %ptr.addr = alloca i32*, align 8
  %hiSt.addr = alloca i32, align 4
  ...
  %yyp1 = alloca i32, align 4
  %canary = alloca i32
  store i32 1802675957, i32* %canary
  %block.addr = alloca i8*, align 8
  %nextD = alloca [3 x i32], align 4
  %stackLo = alloca [100 x i32], align 16
  %loSt.addr = alloca i32, align 4
...
while.end302:                                     ; preds = %if.then16, %while.cond
  %253 = load i32, i32* %canary
  %254 = icmp eq i32 %253, 1802675957
  br i1 %254, label %255, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @mainGtU.25(i32 %i1, i32 %i2, i8* %block, i16* %quadrant, i32 %nblock, i32* %budget) #0 {
entry:
  %i2.addr = alloca i32, align 4
  %quadrant.addr = alloca i16*, align 8
  %k = alloca i32, align 4
  %nblock.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1147142325, i32* %canary
  %retval = alloca i8, align 1
  %c1 = alloca i8, align 1
  %block.addr = alloca i8*, align 8
  %s2 = alloca i16, align 2
...
return:                                           ; preds = %do.end, %if.then445, %if.then430, %if.then413, %if.then398, %if.then381, %if.then366, %if.then349, %if.then334, %if.then317, %if.then302, %if.then285, %if.then270, %if.then253, %if.then238, %if.then221, %if.then206, %if.then189, %if.then172, %if.then155, %if.then138, %if.then121, %if.then104, %if.then87, %if.then70, %if.then53, %if.then36, %if.then19, %if.then
  %333 = load i8, i8* %retval, align 1
  %334 = load i32, i32* %canary
  %335 = icmp eq i32 %334, 1147142325
  br i1 %335, label %336, label %func_exit
...
entry:
  ...
  %budget.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 333878480, i32* %canary
  %i1.addr = alloca i32, align 4
  store i32 %i1, i32* %i1.addr, align 4
  store i32 %i2, i32* %i2.addr, align 4
  store i8* %block, i8** %block.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @fallbackSort.27(i32* %fmap, i32* %eclass, i32* %bhtab, i32 %nblock, i32 %verb) #0 {
entry:
  %k = alloca i32, align 4
  %verb.addr = alloca i32, align 4
  %bhtab.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 1859147045, i32* %canary
  %nBhtab = alloca i32, align 4
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %ftab = alloca [257 x i32], align 16
...
if.end298:                                        ; preds = %if.then297, %for.end294
  %182 = load i32, i32* %canary
  %183 = icmp eq i32 %182, 1859147045
  br i1 %183, label %184, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @mainSort.28(i32* %ptr, i8* %block, i16* %quadrant, i32* %ftab, i32 %nblock, i32 %verb, i32* %budget) #0 {
entry:
  ...
  %ptr.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 1567409156, i32* %canary
  %nblock.addr = alloca i32, align 4
...
if.end514:                                        ; preds = %if.then511, %for.end508, %if.then318
  ...
  %346 = icmp eq i32 %345, 1567409156
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @mainSort.29(i32* %ptr, i8* %block, i16* %quadrant, i32* %ftab, i32 %nblock, i32 %verb, i32* %budget) #0 {
entry:
  %quadrant.addr = alloca i16*, align 8
  %bigDone = alloca [256 x i8], align 16
  %numQSorted = alloca i32, align 4
  %canary = alloca i32
  store i32 150325035, i32* %canary
  %qVal = alloca i16, align 2
  %hi = alloca i32, align 4
  %runningOrder = alloca [256 x i32], align 16
  %ss = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @mainQSort3.30(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %loSt, i32 %hiSt, i32 %dSt, i32* %budget) #0 {
entry:
  %quadrant.addr = alloca i16*, align 8
  %sp = alloca i32, align 4
  %tz258 = alloca i32, align 4
  ...
  %yyp1 = alloca i32, align 4
  %canary = alloca i32
  store i32 1500367970, i32* %canary
  %stackLo = alloca [100 x i32], align 16
  %hi = alloca i32, align 4
  %unHi = alloca i32, align 4
  %m = alloca i32, align 4
...
while.end302:                                     ; preds = %if.then16, %while.cond
  %253 = load i32, i32* %canary
  %254 = icmp eq i32 %253, 1500367970
  br i1 %254, label %255, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @mainQSort3.31(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %loSt, i32 %hiSt, i32 %dSt, i32* %budget) #0 {
entry:
  %stackLo = alloca [100 x i32], align 16
  %loSt.addr = alloca i32, align 4
  %n = alloca i32, align 4
  ...
  %nextHi = alloca [3 x i32], align 4
  %canary = alloca i32
  store i32 2063866430, i32* %canary
  %zztmp173 = alloca i32, align 4
  %med = alloca i32, align 4
  %hi = alloca i32, align 4
  %budget.addr = alloca i32*, align 8
...
while.end302:                                     ; preds = %if.then16, %while.cond
  %253 = load i32, i32* %canary
  %254 = icmp eq i32 %253, 2063866430
  br i1 %254, label %255, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @fallbackSort.32(i32* %fmap, i32* %eclass, i32* %bhtab, i32 %nblock, i32 %verb) #0 {
entry:
  %nblock.addr = alloca i32, align 4
  %k = alloca i32, align 4
  %eclass8 = alloca i8*, align 8
  %ftab = alloca [257 x i32], align 16
  %canary = alloca i32
  store i32 684535179, i32* %canary
  %nNotDone = alloca i32, align 4
  %verb.addr = alloca i32, align 4
  %eclass.addr = alloca i32*, align 8
  %l = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @mainSort.33(i32* %ptr, i8* %block, i16* %quadrant, i32* %ftab, i32 %nblock, i32 %verb, i32* %budget) #0 {
entry:
  %copyStart = alloca [256 x i32], align 16
  %ss = alloca i32, align 4
  %budget.addr = alloca i32*, align 8
  ...
  %vv = alloca i32, align 4
  %canary = alloca i32
  store i32 348928793, i32* %canary
  %ftab.addr = alloca i32*, align 8
  %j = alloca i32, align 4
  %k = alloca i32, align 4
  %ptr.addr = alloca i32*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @fallbackSimpleSort.34(i32* %fmap, i32* %eclass, i32 %lo, i32 %hi) #0 {
entry:
  %hi.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1591123530, i32* %canary
  %ec_tmp = alloca i32, align 4
  %fmap.addr = alloca i32*, align 8
  %tmp = alloca i32, align 4
  %j = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @fallbackSimpleSort.35(i32* %fmap, i32* %eclass, i32 %lo, i32 %hi) #0 {
entry:
  %fmap.addr = alloca i32*, align 8
  %eclass.addr = alloca i32*, align 8
  %lo.addr = alloca i32, align 4
  %tmp = alloca i32, align 4
  %canary = alloca i32
  store i32 1713229290, i32* %canary
  %j = alloca i32, align 4
  %hi.addr = alloca i32, align 4
  %ec_tmp = alloca i32, align 4
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @mainSort.36(i32* %ptr, i8* %block, i16* %quadrant, i32* %ftab, i32 %nblock, i32 %verb, i32* %budget) #0 {
entry:
  %a2update = alloca i32, align 4
  %copyStart = alloca [256 x i32], align 16
  %ftab.addr = alloca i32*, align 8
  ...
  %copyEnd = alloca [256 x i32], align 16
  %canary = alloca i32
  store i32 258664516, i32* %canary
  %ptr.addr = alloca i32*, align 8
  %ss = alloca i32, align 4
  %numQSorted = alloca i32, align 4
  %sb = alloca i32, align 4
