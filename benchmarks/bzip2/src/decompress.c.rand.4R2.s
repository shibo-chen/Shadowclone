...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1251202764, -20(%rbp)  # imm = 0x4A93D6CC
	movq	%rdi, -16(%rbp)
	movq	-16(%rbp), %rax
	movl	$0, 3192(%rax)
	movl	$0, -4(%rbp)
...
.LBB2_5:                                # %for.inc
	...
	jmp	.LBB2_1
.LBB2_6:                                # %for.end
	cmpl	$1251202764, -20(%rbp)  # imm = 0x4A93D6CC
	jne	.LBB2_8
.LBB2_7:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_offset %rbx, -24
	movl	$736552080, -244(%rbp)  # imm = 0x2BE6E490
	movq	%rdi, -16(%rbp)
	movq	-16(%rbp), %rax
	movq	(%rax), %rax
	movq	%rax, -192(%rbp)
...
.LBB3_673:                              # %save_state_and_return
	...
	movq	%rax, 64136(%rcx)
	movl	-28(%rbp), %ebx
	cmpl	$736552080, -244(%rbp)  # imm = 0x2BE6E490
	jne	.LBB3_675
.LBB3_674:
	movl	%ebx, %eax
...
# %bb.0:                                # %entry
	...
	subq	$392, %rsp              # imm = 0x188
	.cfi_offset %rbx, -24
	movl	$56000864, -256(%rbp)   # imm = 0x3568160
	movq	%rdi, -16(%rbp)
	movq	-16(%rbp), %rax
	movq	(%rax), %rax
	movq	%rax, -192(%rbp)
...
.LBB4_673:                              # %save_state_and_return
	...
	movq	%rax, 64136(%rcx)
	movl	-28(%rbp), %ebx
	cmpl	$56000864, -256(%rbp)   # imm = 0x3568160
	jne	.LBB4_675
.LBB4_674:
	movl	%ebx, %eax
	addq	$392, %rsp              # imm = 0x188
...
.LJTI4_0:
	...
	.quad	.LBB4_662
                                        # -- End function
	.text
	.p2align	4, 0x90         # -- Begin function makeMaps_d.4
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1634609559, -20(%rbp)  # imm = 0x616E2997
	movq	%rdi, -16(%rbp)
	movq	-16(%rbp), %rax
	movl	$0, 3192(%rax)
	movl	$0, -4(%rbp)
...
.LBB5_5:                                # %for.inc
	...
	jmp	.LBB5_1
.LBB5_6:                                # %for.end
	cmpl	$1634609559, -20(%rbp)  # imm = 0x616E2997
	jne	.LBB5_8
.LBB5_7:
	addq	$32, %rsp
	popq	%rbp
...
.LBB5_8:                                # %func_exit
	...
	jmp	.LBB5_7
.Lfunc_end5:
	.size	makeMaps_d.4, .Lfunc_end5-makeMaps_d.4
	.cfi_endproc
                                        # -- End function
...
# %bb.0:                                # %entry
	...
	subq	$392, %rsp              # imm = 0x188
	.cfi_offset %rbx, -24
	movl	$84232412, -356(%rbp)   # imm = 0x50548DC
	movq	%rdi, -16(%rbp)
	movq	-16(%rbp), %rax
	movq	(%rax), %rax
	movq	%rax, -192(%rbp)
...
.LBB6_673:                              # %save_state_and_return
	...
	movq	%rax, 64136(%rcx)
	movl	-28(%rbp), %ebx
	cmpl	$84232412, -356(%rbp)   # imm = 0x50548DC
	jne	.LBB6_675
.LBB6_674:
	movl	%ebx, %eax
	addq	$392, %rsp              # imm = 0x188
...
# %bb.0:                                # %entry
	...
	subq	$392, %rsp              # imm = 0x188
	.cfi_offset %rbx, -24
	movl	$229398979, -348(%rbp)  # imm = 0xDAC59C3
	movq	%rdi, -16(%rbp)
	movq	-16(%rbp), %rax
	movq	(%rax), %rax
	movq	%rax, -192(%rbp)
...
.LBB7_673:                              # %save_state_and_return
	...
	movq	%rax, 64136(%rcx)
	movl	-28(%rbp), %ebx
	cmpl	$229398979, -348(%rbp)  # imm = 0xDAC59C3
	jne	.LBB7_675
.LBB7_674:
	movl	%ebx, %eax
	addq	$392, %rsp              # imm = 0x188
