; ModuleID = 'blocksort.c.rand.4R2.bc'
...
func_BZ2_blockSort.4:                             ; preds = %ctrl0
  call void @BZ2_blockSort.4(%struct.EState* %s)
  ret void
...
func_BZ2_blockSort.23:                            ; preds = %ctrl1
  call void @BZ2_blockSort.23(%struct.EState* %s)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_BZ2_blockSort.4, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_BZ2_blockSort.17, label %func_BZ2_blockSort.23
}
...
func_fallbackSort.6:                              ; preds = %ctrl0
  call void @fallbackSort.6(i32* %fmap, i32* %eclass, i32* %bhtab, i32 %nblock, i32 %verb)
  ret void

func_fallbackSort.16:                             ; preds = %ctrl1
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_fallbackSort.6, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_fallbackSort.16, label %func_fallbackSort.27
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_mainSort.15, label %ctrl0

func_mainSort.15:                                 ; preds = %rand_bb
  call void @mainSort.15(i32* %ptr, i8* %block, i16* %quadrant, i32* %ftab, i32 %nblock, i32 %verb, i32* %budget)
  ret void

func_mainSort.22:                                 ; preds = %ctrl0
  call void @mainSort.22(i32* %ptr, i8* %block, i16* %quadrant, i32* %ftab, i32 %nblock, i32 %verb, i32* %budget)
  ret void

func_mainSort.28:                                 ; preds = %ctrl1
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_mainSort.22, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_mainSort.28, label %func_mainSort.32
}
...
func_fallbackQSort3.12:                           ; preds = %ctrl0
  call void @fallbackQSort3.12(i32* %fmap, i32* %eclass, i32 %loSt, i32 %hiSt)
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_fallbackQSort3.12, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_fallbackQSort3.25, label %func_fallbackQSort3.31
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_fallbackSimpleSort.13, label %ctrl0

func_fallbackSimpleSort.13:                       ; preds = %rand_bb
  call void @fallbackSimpleSort.13(i32* %fmap, i32* %eclass, i32 %lo, i32 %hi)
  ret void

func_fallbackSimpleSort.24:                       ; preds = %ctrl0
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_fallbackSimpleSort.24, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_fallbackSimpleSort.30, label %func_fallbackSimpleSort.34
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_mainQSort3.29, label %ctrl0

func_mainQSort3.29:                               ; preds = %rand_bb
  call void @mainQSort3.29(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %loSt, i32 %hiSt, i32 %dSt, i32* %budget)
  ret void

func_mainQSort3.33:                               ; preds = %ctrl0
  call void @mainQSort3.33(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %loSt, i32 %hiSt, i32 %dSt, i32* %budget)
  ret void

func_mainQSort3.35:                               ; preds = %ctrl1
  call void @mainQSort3.35(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %loSt, i32 %hiSt, i32 %dSt, i32* %budget)
  ret void

func_mainQSort3.36:                               ; preds = %ctrl1
  call void @mainQSort3.36(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %loSt, i32 %hiSt, i32 %dSt, i32* %budget)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_mainQSort3.33, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_mainQSort3.35, label %func_mainQSort3.36
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_mainSimpleSort.9, label %ctrl0

func_mainSimpleSort.9:                            ; preds = %rand_bb
  call void @mainSimpleSort.9(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %lo, i32 %hi, i32 %d, i32* %budget)
  ret void
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_mainSimpleSort.19, label %func_mainSimpleSort.21
}
...
func_mmed3.5:                                     ; preds = %ctrl0
  %3 = call i8 @mmed3.5(i8 %a, i8 %b, i8 %c)
  ret i8 %3

func_mmed3.7:                                     ; preds = %ctrl1
  %4 = call i8 @mmed3.7(i8 %a, i8 %b, i8 %c)
  ret i8 %4

func_mmed3.10:                                    ; preds = %ctrl1
  %5 = call i8 @mmed3.10(i8 %a, i8 %b, i8 %c)
  ret i8 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_mmed3.5, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_mmed3.7, label %func_mmed3.10
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_mainGtU.14, label %ctrl0

func_mainGtU.14:                                  ; preds = %rand_bb
  %2 = call i8 @mainGtU.14(i32 %i1, i32 %i2, i8* %block, i16* %quadrant, i32 %nblock, i32* %budget)
  ret i8 %2

func_mainGtU.18:                                  ; preds = %ctrl0
  %3 = call i8 @mainGtU.18(i32 %i1, i32 %i2, i8* %block, i16* %quadrant, i32 %nblock, i32* %budget)
  ret i8 %3

func_mainGtU.20:                                  ; preds = %ctrl1
  %4 = call i8 @mainGtU.20(i32 %i1, i32 %i2, i8* %block, i16* %quadrant, i32 %nblock, i32* %budget)
  ret i8 %4
...
ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_mainGtU.18, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_mainGtU.20, label %func_mainGtU.26
}
...
entry:
  ...
  %canary = alloca i32
  store i32 840271442, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 674949943, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 1101855286, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @BZ2_blockSort.4(%struct.EState* %s) #0 {
entry:
  %wfact = alloca i32, align 4
  %s.addr = alloca %struct.EState*, align 8
  %ftab = alloca i32*, align 8
  %canary = alloca i32
  store i32 698227612, i32* %canary
  %i = alloca i32, align 4
  %verb = alloca i32, align 4
  %quadrant = alloca i16*, align 8
  %block = alloca i8*, align 8
...
entry:
  %c.addr = alloca i8, align 1
  %canary = alloca i32
  store i32 400476065, i32* %canary
  %a.addr = alloca i8, align 1
  %t = alloca i8, align 1
  %b.addr = alloca i8, align 1
  store i8 %a, i8* %a.addr, align 1
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @fallbackSort.6(i32* %fmap, i32* %eclass, i32* %bhtab, i32 %nblock, i32 %verb) #0 {
entry:
  %cc1 = alloca i32, align 4
  %nBhtab = alloca i32, align 4
  %verb.addr = alloca i32, align 4
  ...
  %nblock.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1055798602, i32* %canary
  %j = alloca i32, align 4
  %k = alloca i32, align 4
  %ftab = alloca [257 x i32], align 16
  %l = alloca i32, align 4
...
if.end298:                                        ; preds = %if.then297, %for.end294
  %182 = load i32, i32* %canary
  %183 = icmp eq i32 %182, 1055798602
  br i1 %183, label %184, label %func_exit
...
entry:
  %t = alloca i8, align 1
  %canary = alloca i32
  store i32 257259649, i32* %canary
  %b.addr = alloca i8, align 1
  %c.addr = alloca i8, align 1
  %a.addr = alloca i8, align 1
  store i8 %a, i8* %a.addr, align 1
...
entry:
  ...
  %canary = alloca i32
  store i32 573768153, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @mainSimpleSort.9(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %lo, i32 %hi, i32 %d, i32* %budget) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 1476773833, i32* %canary
...
for.end:                                          ; preds = %if.then94, %for.cond, %if.then
  ...
  %113 = icmp eq i32 %112, 1476773833
...
entry:
  ...
  %d.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 874850076, i32* %canary
  %i = alloca i32, align 4
  %nblock.addr = alloca i32, align 4
  %quadrant.addr = alloca i16*, align 8
  store i32* %ptr, i32** %ptr.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @fallbackQSort3.12(i32* %fmap, i32* %eclass, i32 %loSt, i32 %hiSt) #0 {
entry:
  %zztmp93 = alloca i32, align 4
  %yyn143 = alloca i32, align 4
  %r3 = alloca i32, align 4
  ...
  %loSt.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1987358546, i32* %canary
  %lo = alloca i32, align 4
  %hi = alloca i32, align 4
  %r = alloca i32, align 4
  %n = alloca i32, align 4
...
while.end192:                                     ; preds = %while.cond
  %189 = load i32, i32* %canary
  %190 = icmp eq i32 %189, 1987358546
  br i1 %190, label %191, label %func_exit
...
entry:
  ...
  %hi.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 759942448, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @mainGtU.14(i32 %i1, i32 %i2, i8* %block, i16* %quadrant, i32 %nblock, i32* %budget) #0 {
entry:
  %canary = alloca i32
  store i32 1838738971, i32* %canary
  %quadrant.addr = alloca i16*, align 8
...
return:                                           ; preds = %do.end, %if.then445, %if.then430, %if.then413, %if.then398, %if.then381, %if.then366, %if.then349, %if.then334, %if.then317, %if.then302, %if.then285, %if.then270, %if.then253, %if.then238, %if.then221, %if.then206, %if.then189, %if.then172, %if.then155, %if.then138, %if.then121, %if.then104, %if.then87, %if.then70, %if.then53, %if.then36, %if.then19, %if.then
  ...
  %335 = icmp eq i32 %334, 1838738971
...
entry:
  %verb.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 304060479, i32* %canary
  %quadrant.addr = alloca i16*, align 8
...
entry:
  ...
  %r = alloca i32, align 4
  %canary = alloca i32
  store i32 348750876, i32* %canary
  %ftabCopy = alloca [256 x i32], align 16
  %l = alloca i32, align 4
  %verb.addr = alloca i32, align 4
  %j = alloca i32, align 4
...
entry:
  ...
  %wfact = alloca i32, align 4
  %canary = alloca i32
  store i32 1488977231, i32* %canary
  %i = alloca i32, align 4
  %ptr = alloca i32*, align 8
  %quadrant = alloca i16*, align 8
  %verb = alloca i32, align 4
...
entry:
  ...
  %block.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 643357668, i32* %canary
  %nblock.addr = alloca i32, align 4
  %k = alloca i32, align 4
  %budget.addr = alloca i32*, align 8
  %i1.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @mainGtU.20(i32 %i1, i32 %i2, i8* %block, i16* %quadrant, i32 %nblock, i32* %budget) #0 {
entry:
  %budget.addr = alloca i32*, align 8
  %s2 = alloca i16, align 2
  %i1.addr = alloca i32, align 4
  ...
  %c2 = alloca i8, align 1
  %canary = alloca i32
  store i32 121402996, i32* %canary
  %k = alloca i32, align 4
  %c1 = alloca i8, align 1
  %block.addr = alloca i8*, align 8
  %i2.addr = alloca i32, align 4
...
entry:
  ...
  %block.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1684707940, i32* %canary
  %i = alloca i32, align 4
  %hi.addr = alloca i32, align 4
  %nblock.addr = alloca i32, align 4
  %quadrant.addr = alloca i16*, align 8
...
for.end:                                          ; preds = %if.then94, %for.cond, %if.then
  %112 = load i32, i32* %canary
  %113 = icmp eq i32 %112, 1684707940
  br i1 %113, label %114, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @mainSort.22(i32* %ptr, i8* %block, i16* %quadrant, i32* %ftab, i32 %nblock, i32 %verb, i32* %budget) #0 {
entry:
  %bbSize = alloca i32, align 4
  %h = alloca i32, align 4
  %copyStart = alloca [256 x i32], align 16
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @BZ2_blockSort.23(%struct.EState* %s) #0 {
entry:
  %ftab = alloca i32*, align 8
  %nblock = alloca i32, align 4
  %canary = alloca i32
  store i32 572697810, i32* %canary
  %wfact = alloca i32, align 4
  %quadrant = alloca i16*, align 8
  %s.addr = alloca %struct.EState*, align 8
  %block = alloca i8*, align 8
...
entry:
  ...
  %tmp = alloca i32, align 4
  %canary = alloca i32
  store i32 338243040, i32* %canary
  %ec_tmp = alloca i32, align 4
  store i32* %fmap, i32** %fmap.addr, align 8
  store i32* %eclass, i32** %eclass.addr, align 8
  store i32 %lo, i32* %lo.addr, align 4
...
entry:
  ...
  %ltLo = alloca i32, align 4
  %canary = alloca i32
  store i32 717095747, i32* %canary
  %m = alloca i32, align 4
  %yyp2 = alloca i32, align 4
  %zztmp93 = alloca i32, align 4
  %yyp1139 = alloca i32, align 4
...
entry:
  ...
  %i1.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 756763574, i32* %canary
  %i2.addr = alloca i32, align 4
  %c2 = alloca i8, align 1
  %s2 = alloca i16, align 2
  %budget.addr = alloca i32*, align 8
...
entry:
  ...
  %fmap.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 625903832, i32* %canary
  %nBhtab = alloca i32, align 4
  %nNotDone = alloca i32, align 4
  %bhtab.addr = alloca i32*, align 8
  %ftabCopy = alloca [256 x i32], align 16
...
entry:
  ...
  %lo = alloca i32, align 4
  %canary = alloca i32
  store i32 597087519, i32* %canary
  %bbSize = alloca i32, align 4
  %ftab.addr = alloca i32*, align 8
  %i = alloca i32, align 4
  %hi = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @mainQSort3.29(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %loSt, i32 %hiSt, i32 %dSt, i32* %budget) #0 {
entry:
  %med = alloca i32, align 4
  %ptr.addr = alloca i32*, align 8
  ...
  %canary = alloca i32
  store i32 890089250, i32* %canary
  %unHi = alloca i32, align 4
  %yyn = alloca i32, align 4
  %zztmp = alloca i32, align 4
  %hiSt.addr = alloca i32, align 4
...
entry:
  ...
  %fmap.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 1936259072, i32* %canary
  %eclass.addr = alloca i32*, align 8
  %ec_tmp = alloca i32, align 4
  %i = alloca i32, align 4
  %hi.addr = alloca i32, align 4
...
entry:
  ...
  %lo = alloca i32, align 4
  %canary = alloca i32
  store i32 1511639122, i32* %canary
  %nblock.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %h = alloca i32, align 4
  %bbStart = alloca i32, align 4
...
if.end514:                                        ; preds = %if.then511, %for.end508, %if.then318
  %345 = load i32, i32* %canary
  %346 = icmp eq i32 %345, 1511639122
  br i1 %346, label %347, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @mainQSort3.33(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %loSt, i32 %hiSt, i32 %dSt, i32* %budget) #0 {
entry:
  %loSt.addr = alloca i32, align 4
  %zztmp = alloca i32, align 4
  %nblock.addr = alloca i32, align 4
  ...
  %zztmp141 = alloca i32, align 4
  %canary = alloca i32
  store i32 1064299993, i32* %canary
  %tz = alloca i32, align 4
  %sp = alloca i32, align 4
  %d = alloca i32, align 4
  %stackHi = alloca [100 x i32], align 16
...
while.end302:                                     ; preds = %if.then16, %while.cond
  %253 = load i32, i32* %canary
  %254 = icmp eq i32 %253, 1064299993
  br i1 %254, label %255, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @mainQSort3.35(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %loSt, i32 %hiSt, i32 %dSt, i32* %budget) #0 {
entry:
  %loSt.addr = alloca i32, align 4
  %unLo = alloca i32, align 4
  %d = alloca i32, align 4
  ...
  %lo = alloca i32, align 4
  %canary = alloca i32
  store i32 994395122, i32* %canary
  %gtHi = alloca i32, align 4
  %yyn = alloca i32, align 4
  %zztmp84 = alloca i32, align 4
  %sp = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @mainQSort3.36(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %loSt, i32 %hiSt, i32 %dSt, i32* %budget) #0 {
entry:
  %ptr.addr = alloca i32*, align 8
  %yyn = alloca i32, align 4
  %nextD = alloca [3 x i32], align 4
  ...
  %zztmp106 = alloca i32, align 4
  %canary = alloca i32
  store i32 568656053, i32* %canary
  %block.addr = alloca i8*, align 8
  %tz235 = alloca i32, align 4
  %yyp1164 = alloca i32, align 4
  %hiSt.addr = alloca i32, align 4
