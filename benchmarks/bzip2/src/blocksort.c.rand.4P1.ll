; ModuleID = 'blocksort.c.rand.4P1.bc'
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_BZ2_blockSort.2, label %ctrl0

func_BZ2_blockSort.2:                             ; preds = %rand_bb
  call void @BZ2_blockSort.2(%struct.EState* %s)
  ret void

func_BZ2_blockSort.5:                             ; preds = %ctrl0
  call void @BZ2_blockSort.5(%struct.EState* %s)
  ret void

func_BZ2_blockSort.8:                             ; preds = %ctrl1
  call void @BZ2_blockSort.8(%struct.EState* %s)
  ret void

func_BZ2_blockSort.12:                            ; preds = %ctrl1
  call void @BZ2_blockSort.12(%struct.EState* %s)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_BZ2_blockSort.5, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_BZ2_blockSort.8, label %func_BZ2_blockSort.12
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_fallbackSort.4, label %ctrl0

func_fallbackSort.4:                              ; preds = %rand_bb
  call void @fallbackSort.4(i32* %fmap, i32* %eclass, i32* %bhtab, i32 %nblock, i32 %verb)
  ret void

func_fallbackSort.13:                             ; preds = %ctrl0
  call void @fallbackSort.13(i32* %fmap, i32* %eclass, i32* %bhtab, i32 %nblock, i32 %verb)
  ret void
...
func_fallbackSort.31:                             ; preds = %ctrl1
  call void @fallbackSort.31(i32* %fmap, i32* %eclass, i32* %bhtab, i32 %nblock, i32 %verb)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_fallbackSort.13, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_fallbackSort.22, label %func_fallbackSort.31
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_mainSort.6, label %ctrl0

func_mainSort.6:                                  ; preds = %rand_bb
  call void @mainSort.6(i32* %ptr, i8* %block, i16* %quadrant, i32* %ftab, i32 %nblock, i32 %verb, i32* %budget)
  ret void
...
func_mainSort.27:                                 ; preds = %ctrl1
  call void @mainSort.27(i32* %ptr, i8* %block, i16* %quadrant, i32* %ftab, i32 %nblock, i32 %verb, i32* %budget)
  ret void

func_mainSort.29:                                 ; preds = %ctrl1
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_mainSort.27, label %func_mainSort.29
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_fallbackQSort3.7, label %ctrl0

func_fallbackQSort3.7:                            ; preds = %rand_bb
  call void @fallbackQSort3.7(i32* %fmap, i32* %eclass, i32 %loSt, i32 %hiSt)
  ret void

func_fallbackQSort3.9:                            ; preds = %ctrl0
  call void @fallbackQSort3.9(i32* %fmap, i32* %eclass, i32 %loSt, i32 %hiSt)
  ret void

func_fallbackQSort3.11:                           ; preds = %ctrl1
  call void @fallbackQSort3.11(i32* %fmap, i32* %eclass, i32 %loSt, i32 %hiSt)
  ret void

func_fallbackQSort3.25:                           ; preds = %ctrl1
  call void @fallbackQSort3.25(i32* %fmap, i32* %eclass, i32 %loSt, i32 %hiSt)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_fallbackQSort3.9, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_fallbackQSort3.11, label %func_fallbackQSort3.25
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_fallbackSimpleSort.1, label %ctrl0

func_fallbackSimpleSort.1:                        ; preds = %rand_bb
  call void @fallbackSimpleSort.1(i32* %fmap, i32* %eclass, i32 %lo, i32 %hi)
  ret void

func_fallbackSimpleSort.26:                       ; preds = %ctrl0
  call void @fallbackSimpleSort.26(i32* %fmap, i32* %eclass, i32 %lo, i32 %hi)
  ret void

func_fallbackSimpleSort.28:                       ; preds = %ctrl1
  call void @fallbackSimpleSort.28(i32* %fmap, i32* %eclass, i32 %lo, i32 %hi)
  ret void

func_fallbackSimpleSort.32:                       ; preds = %ctrl1
  call void @fallbackSimpleSort.32(i32* %fmap, i32* %eclass, i32 %lo, i32 %hi)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_fallbackSimpleSort.26, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_fallbackSimpleSort.28, label %func_fallbackSimpleSort.32
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_mainQSort3.14, label %ctrl0

func_mainQSort3.14:                               ; preds = %rand_bb
  call void @mainQSort3.14(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %loSt, i32 %hiSt, i32 %dSt, i32* %budget)
  ret void

func_mainQSort3.17:                               ; preds = %ctrl0
  call void @mainQSort3.17(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %loSt, i32 %hiSt, i32 %dSt, i32* %budget)
  ret void

func_mainQSort3.19:                               ; preds = %ctrl1
  call void @mainQSort3.19(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %loSt, i32 %hiSt, i32 %dSt, i32* %budget)
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_mainQSort3.17, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_mainQSort3.19, label %func_mainQSort3.20
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_mainSimpleSort.21, label %ctrl0

func_mainSimpleSort.21:                           ; preds = %rand_bb
  call void @mainSimpleSort.21(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %lo, i32 %hi, i32 %d, i32* %budget)
  ret void

func_mainSimpleSort.33:                           ; preds = %ctrl0
  call void @mainSimpleSort.33(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %lo, i32 %hi, i32 %d, i32* %budget)
  ret void

func_mainSimpleSort.34:                           ; preds = %ctrl1
  call void @mainSimpleSort.34(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %lo, i32 %hi, i32 %d, i32* %budget)
  ret void

func_mainSimpleSort.35:                           ; preds = %ctrl1
  call void @mainSimpleSort.35(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %lo, i32 %hi, i32 %d, i32* %budget)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_mainSimpleSort.33, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_mainSimpleSort.34, label %func_mainSimpleSort.35
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_mmed3.3, label %ctrl0

func_mmed3.3:                                     ; preds = %rand_bb
  %2 = call i8 @mmed3.3(i8 %a, i8 %b, i8 %c)
  ret i8 %2

func_mmed3.10:                                    ; preds = %ctrl0
  %3 = call i8 @mmed3.10(i8 %a, i8 %b, i8 %c)
  ret i8 %3

func_mmed3.16:                                    ; preds = %ctrl1
  %4 = call i8 @mmed3.16(i8 %a, i8 %b, i8 %c)
  ret i8 %4

func_mmed3.30:                                    ; preds = %ctrl1
  %5 = call i8 @mmed3.30(i8 %a, i8 %b, i8 %c)
  ret i8 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_mmed3.10, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_mmed3.16, label %func_mmed3.30
}
...
func_mainGtU.23:                                  ; preds = %ctrl0
  %3 = call i8 @mainGtU.23(i32 %i1, i32 %i2, i8* %block, i16* %quadrant, i32 %nblock, i32* %budget)
  ret i8 %3

func_mainGtU.24:                                  ; preds = %ctrl1
  %4 = call i8 @mainGtU.24(i32 %i1, i32 %i2, i8* %block, i16* %quadrant, i32 %nblock, i32* %budget)
  ret i8 %4

func_mainGtU.36:                                  ; preds = %ctrl1
  %5 = call i8 @mainGtU.36(i32 %i1, i32 %i2, i8* %block, i16* %quadrant, i32 %nblock, i32* %budget)
  ret i8 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_mainGtU.23, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_mainGtU.24, label %func_mainGtU.36
}

; Function Attrs: noinline nounwind optnone uwtable
define internal void @fallbackSimpleSort.1(i32* %fmap, i32* %eclass, i32 %lo, i32 %hi) #0 {
entry:
  %eclass.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 928734325, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @BZ2_blockSort.2(%struct.EState* %s) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 1367041720, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @mmed3.3(i8 zeroext %a, i8 zeroext %b, i8 zeroext %c) #0 {
entry:
  %b.addr = alloca i8, align 1
  %c.addr = alloca i8, align 1
  %a.addr = alloca i8, align 1
  %canary = alloca i32
  store i32 1140052065, i32* %canary
  %t = alloca i8, align 1
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @fallbackSort.4(i32* %fmap, i32* %eclass, i32* %bhtab, i32 %nblock, i32 %verb) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 639429589, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @BZ2_blockSort.5(%struct.EState* %s) #0 {
entry:
  %wfact = alloca i32, align 4
  %block = alloca i8*, align 8
  %ftab = alloca i32*, align 8
  %canary = alloca i32
  store i32 764717244, i32* %canary
  %i = alloca i32, align 4
  %s.addr = alloca %struct.EState*, align 8
  %ptr = alloca i32*, align 8
  %verb = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @mainSort.6(i32* %ptr, i8* %block, i16* %quadrant, i32* %ftab, i32 %nblock, i32 %verb, i32* %budget) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 2073433044, i32* %canary
  %j = alloca i32, align 4
...
if.end514:                                        ; preds = %if.then511, %for.end508, %if.then318
  ...
  %346 = icmp eq i32 %345, 2073433044
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @fallbackQSort3.7(i32* %fmap, i32* %eclass, i32 %loSt, i32 %hiSt) #0 {
entry:
  ...
  %hi = alloca i32, align 4
  %canary = alloca i32
  store i32 1563519312, i32* %canary
...
while.end192:                                     ; preds = %while.cond
  ...
  %190 = icmp eq i32 %189, 1563519312
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @BZ2_blockSort.8(%struct.EState* %s) #0 {
entry:
  %budgetInit = alloca i32, align 4
  %quadrant = alloca i16*, align 8
  %block = alloca i8*, align 8
  ...
  %nblock = alloca i32, align 4
  %canary = alloca i32
  store i32 136627511, i32* %canary
  %verb = alloca i32, align 4
  %ptr = alloca i32*, align 8
  %s.addr = alloca %struct.EState*, align 8
  store %struct.EState* %s, %struct.EState** %s.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @fallbackQSort3.9(i32* %fmap, i32* %eclass, i32 %loSt, i32 %hiSt) #0 {
entry:
  %n = alloca i32, align 4
  %unHi = alloca i32, align 4
  %zztmp117 = alloca i32, align 4
  ...
  %hi = alloca i32, align 4
  %canary = alloca i32
  store i32 1501674157, i32* %canary
  %zztmp = alloca i32, align 4
  %fmap.addr = alloca i32*, align 8
  %r = alloca i32, align 4
  %loSt.addr = alloca i32, align 4
...
while.end192:                                     ; preds = %while.cond
  %189 = load i32, i32* %canary
  %190 = icmp eq i32 %189, 1501674157
  br i1 %190, label %191, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @mmed3.10(i8 zeroext %a, i8 zeroext %b, i8 zeroext %c) #0 {
entry:
  %t = alloca i8, align 1
  %b.addr = alloca i8, align 1
  %a.addr = alloca i8, align 1
  %canary = alloca i32
  store i32 1298586886, i32* %canary
  %c.addr = alloca i8, align 1
  store i8 %a, i8* %a.addr, align 1
  store i8 %b, i8* %b.addr, align 1
  store i8 %c, i8* %c.addr, align 1
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @fallbackQSort3.11(i32* %fmap, i32* %eclass, i32 %loSt, i32 %hiSt) #0 {
entry:
  %m = alloca i32, align 4
  %r = alloca i32, align 4
  %yyn = alloca i32, align 4
  ...
  %yyp2 = alloca i32, align 4
  %canary = alloca i32
  store i32 1340530107, i32* %canary
  %yyp2140 = alloca i32, align 4
  %unHi = alloca i32, align 4
  %unLo = alloca i32, align 4
  %ltLo = alloca i32, align 4
...
while.end192:                                     ; preds = %while.cond
  %189 = load i32, i32* %canary
  %190 = icmp eq i32 %189, 1340530107
  br i1 %190, label %191, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @BZ2_blockSort.12(%struct.EState* %s) #0 {
entry:
  %quadrant = alloca i16*, align 8
  %canary = alloca i32
  store i32 953437113, i32* %canary
  %i = alloca i32, align 4
  %ptr = alloca i32*, align 8
  %verb = alloca i32, align 4
  %s.addr = alloca %struct.EState*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @fallbackSort.13(i32* %fmap, i32* %eclass, i32* %bhtab, i32 %nblock, i32 %verb) #0 {
entry:
  %canary = alloca i32
  store i32 719910699, i32* %canary
  %fmap.addr = alloca i32*, align 8
  %cc = alloca i32, align 4
  %cc1 = alloca i32, align 4
  %nBhtab = alloca i32, align 4
...
entry:
  ...
  %hi = alloca i32, align 4
  %canary = alloca i32
  store i32 924338513, i32* %canary
...
entry:
  ...
  %numQSorted = alloca i32, align 4
  %canary = alloca i32
  store i32 1856109271, i32* %canary
  %copyStart = alloca [256 x i32], align 16
  %ftab.addr = alloca i32*, align 8
  %bbSize = alloca i32, align 4
  %vv = alloca i32, align 4
...
if.end514:                                        ; preds = %if.then511, %for.end508, %if.then318
  %345 = load i32, i32* %canary
  %346 = icmp eq i32 %345, 1856109271
  br i1 %346, label %347, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @mmed3.16(i8 zeroext %a, i8 zeroext %b, i8 zeroext %c) #0 {
entry:
  %canary = alloca i32
  store i32 415509637, i32* %canary
  %c.addr = alloca i8, align 1
  %t = alloca i8, align 1
  %b.addr = alloca i8, align 1
  %a.addr = alloca i8, align 1
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @mainQSort3.17(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %loSt, i32 %hiSt, i32 %dSt, i32* %budget) #0 {
entry:
  %lo = alloca i32, align 4
  %n = alloca i32, align 4
  %nblock.addr = alloca i32, align 4
  ...
  %stackD = alloca [100 x i32], align 16
  %canary = alloca i32
  store i32 972898159, i32* %canary
  %yyp2 = alloca i32, align 4
  %tz235 = alloca i32, align 4
  %unHi = alloca i32, align 4
  %block.addr = alloca i8*, align 8
...
entry:
  ...
  %canary = alloca i32
  store i32 378423870, i32* %canary
  %quadrant.addr = alloca i16*, align 8
  %c1 = alloca i8, align 1
  %budget.addr = alloca i32*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @mainQSort3.19(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %loSt, i32 %hiSt, i32 %dSt, i32* %budget) #0 {
entry:
  %zztmp106 = alloca i32, align 4
  %yyp2 = alloca i32, align 4
  %zztmp84 = alloca i32, align 4
  ...
  %ptr.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 1672113010, i32* %canary
  %d = alloca i32, align 4
  %nblock.addr = alloca i32, align 4
  %n = alloca i32, align 4
  %gtHi = alloca i32, align 4
...
while.end302:                                     ; preds = %if.then16, %while.cond
  %253 = load i32, i32* %canary
  %254 = icmp eq i32 %253, 1672113010
  br i1 %254, label %255, label %func_exit
...
entry:
  ...
  %tz235 = alloca i32, align 4
  %canary = alloca i32
  store i32 1404937326, i32* %canary
  %zztmp = alloca i32, align 4
  %d = alloca i32, align 4
  %stackHi = alloca [100 x i32], align 16
  %stackLo = alloca [100 x i32], align 16
...
while.end302:                                     ; preds = %if.then16, %while.cond
  %253 = load i32, i32* %canary
  %254 = icmp eq i32 %253, 1404937326
  br i1 %254, label %255, label %func_exit
...
entry:
  ...
  %block.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 255736438, i32* %canary
  %lo.addr = alloca i32, align 4
  %quadrant.addr = alloca i16*, align 8
...
entry:
  %canary = alloca i32
  store i32 426562984, i32* %canary
  %eclass.addr = alloca i32*, align 8
  %nBhtab = alloca i32, align 4
  %H = alloca i32, align 4
  %cc1 = alloca i32, align 4
...
entry:
  ...
  %s2 = alloca i16, align 2
  %canary = alloca i32
  store i32 335673217, i32* %canary
  %c1 = alloca i8, align 1
  %block.addr = alloca i8*, align 8
  %retval = alloca i8, align 1
  %nblock.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @mainGtU.24(i32 %i1, i32 %i2, i8* %block, i16* %quadrant, i32 %nblock, i32* %budget) #0 {
entry:
  %i1.addr = alloca i32, align 4
  %s1 = alloca i16, align 2
  %quadrant.addr = alloca i16*, align 8
  ...
  %i2.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1667346319, i32* %canary
  %budget.addr = alloca i32*, align 8
  %block.addr = alloca i8*, align 8
  %retval = alloca i8, align 1
  store i32 %i1, i32* %i1.addr, align 4
...
return:                                           ; preds = %do.end, %if.then445, %if.then430, %if.then413, %if.then398, %if.then381, %if.then366, %if.then349, %if.then334, %if.then317, %if.then302, %if.then285, %if.then270, %if.then253, %if.then238, %if.then221, %if.then206, %if.then189, %if.then172, %if.then155, %if.then138, %if.then121, %if.then104, %if.then87, %if.then70, %if.then53, %if.then36, %if.then19, %if.then
  %333 = load i8, i8* %retval, align 1
  %334 = load i32, i32* %canary
  %335 = icmp eq i32 %334, 1667346319
  br i1 %335, label %336, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @fallbackQSort3.25(i32* %fmap, i32* %eclass, i32 %loSt, i32 %hiSt) #0 {
entry:
  %r3 = alloca i32, align 4
  %unLo = alloca i32, align 4
  %yyp1139 = alloca i32, align 4
  ...
  %yyn143 = alloca i32, align 4
  %canary = alloca i32
  store i32 1820365929, i32* %canary
  %r = alloca i32, align 4
  %zztmp73 = alloca i32, align 4
  %n = alloca i32, align 4
  %zztmp = alloca i32, align 4
...
while.end192:                                     ; preds = %while.cond
  %189 = load i32, i32* %canary
  %190 = icmp eq i32 %189, 1820365929
  br i1 %190, label %191, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @fallbackSimpleSort.26(i32* %fmap, i32* %eclass, i32 %lo, i32 %hi) #0 {
entry:
  %fmap.addr = alloca i32*, align 8
  %j = alloca i32, align 4
  %eclass.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 852078350, i32* %canary
  %lo.addr = alloca i32, align 4
  %hi.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %tmp = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @mainSort.27(i32* %ptr, i8* %block, i16* %quadrant, i32* %ftab, i32 %nblock, i32 %verb, i32* %budget) #0 {
entry:
  %bigDone = alloca [256 x i8], align 16
  %runningOrder = alloca [256 x i32], align 16
  %sb = alloca i32, align 4
  ...
  %ptr.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 1356033491, i32* %canary
  %ss = alloca i32, align 4
  %shifts = alloca i32, align 4
  %copyStart = alloca [256 x i32], align 16
  %numQSorted = alloca i32, align 4
...
if.end514:                                        ; preds = %if.then511, %for.end508, %if.then318
  %345 = load i32, i32* %canary
  %346 = icmp eq i32 %345, 1356033491
  br i1 %346, label %347, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @fallbackSimpleSort.28(i32* %fmap, i32* %eclass, i32 %lo, i32 %hi) #0 {
entry:
  %tmp = alloca i32, align 4
  %j = alloca i32, align 4
  %ec_tmp = alloca i32, align 4
  %canary = alloca i32
  store i32 240315654, i32* %canary
  %hi.addr = alloca i32, align 4
  %fmap.addr = alloca i32*, align 8
  %eclass.addr = alloca i32*, align 8
  %lo.addr = alloca i32, align 4
...
entry:
  ...
  %vv = alloca i32, align 4
  %canary = alloca i32
  store i32 925071797, i32* %canary
  %ftab.addr = alloca i32*, align 8
  %i = alloca i32, align 4
  %bigDone = alloca [256 x i8], align 16
  %shifts = alloca i32, align 4
...
entry:
  ...
  %t = alloca i8, align 1
  %canary = alloca i32
  store i32 1178134123, i32* %canary
  %a.addr = alloca i8, align 1
  %c.addr = alloca i8, align 1
  store i8 %a, i8* %a.addr, align 1
  store i8 %b, i8* %b.addr, align 1
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @fallbackSort.31(i32* %fmap, i32* %eclass, i32* %bhtab, i32 %nblock, i32 %verb) #0 {
entry:
  %eclass.addr = alloca i32*, align 8
  %cc1 = alloca i32, align 4
  %verb.addr = alloca i32, align 4
  ...
  %k = alloca i32, align 4
  %canary = alloca i32
  store i32 1454021850, i32* %canary
  %bhtab.addr = alloca i32*, align 8
  %fmap.addr = alloca i32*, align 8
  %j = alloca i32, align 4
  %nblock.addr = alloca i32, align 4
...
if.end298:                                        ; preds = %if.then297, %for.end294
  %182 = load i32, i32* %canary
  %183 = icmp eq i32 %182, 1454021850
  br i1 %183, label %184, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @fallbackSimpleSort.32(i32* %fmap, i32* %eclass, i32 %lo, i32 %hi) #0 {
entry:
  %lo.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1851577081, i32* %canary
  %tmp = alloca i32, align 4
  %hi.addr = alloca i32, align 4
  %eclass.addr = alloca i32*, align 8
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @mainSimpleSort.33(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %lo, i32 %hi, i32 %d, i32* %budget) #0 {
entry:
  %block.addr = alloca i8*, align 8
  %nblock.addr = alloca i32, align 4
  %budget.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 1813668030, i32* %canary
  %hi.addr = alloca i32, align 4
  %j = alloca i32, align 4
  %h = alloca i32, align 4
  %i = alloca i32, align 4
...
for.end:                                          ; preds = %if.then94, %for.cond, %if.then
  %112 = load i32, i32* %canary
  %113 = icmp eq i32 %112, 1813668030
  br i1 %113, label %114, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @mainSimpleSort.34(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %lo, i32 %hi, i32 %d, i32* %budget) #0 {
entry:
  %hi.addr = alloca i32, align 4
  %quadrant.addr = alloca i16*, align 8
  %v = alloca i32, align 4
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1218140126, i32* %canary
  %bigN = alloca i32, align 4
  %block.addr = alloca i8*, align 8
  %h = alloca i32, align 4
  %ptr.addr = alloca i32*, align 8
...
for.end:                                          ; preds = %if.then94, %for.cond, %if.then
  %112 = load i32, i32* %canary
  %113 = icmp eq i32 %112, 1218140126
  br i1 %113, label %114, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @mainSimpleSort.35(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %lo, i32 %hi, i32 %d, i32* %budget) #0 {
entry:
  %j = alloca i32, align 4
  %bigN = alloca i32, align 4
  %hi.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 431824158, i32* %canary
  %block.addr = alloca i8*, align 8
  %v = alloca i32, align 4
  %quadrant.addr = alloca i16*, align 8
  %h = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @mainGtU.36(i32 %i1, i32 %i2, i8* %block, i16* %quadrant, i32 %nblock, i32* %budget) #0 {
entry:
  %s2 = alloca i16, align 2
  %retval = alloca i8, align 1
  %budget.addr = alloca i32*, align 8
  ...
  %quadrant.addr = alloca i16*, align 8
  %canary = alloca i32
  store i32 1989526879, i32* %canary
  %nblock.addr = alloca i32, align 4
  %k = alloca i32, align 4
  store i32 %i1, i32* %i1.addr, align 4
  store i32 %i2, i32* %i2.addr, align 4
...
return:                                           ; preds = %do.end, %if.then445, %if.then430, %if.then413, %if.then398, %if.then381, %if.then366, %if.then349, %if.then334, %if.then317, %if.then302, %if.then285, %if.then270, %if.then253, %if.then238, %if.then221, %if.then206, %if.then189, %if.then172, %if.then155, %if.then138, %if.then121, %if.then104, %if.then87, %if.then70, %if.then53, %if.then36, %if.then19, %if.then
  %333 = load i8, i8* %retval, align 1
  %334 = load i32, i32* %canary
  %335 = icmp eq i32 %334, 1989526879
  br i1 %335, label %336, label %func_exit
