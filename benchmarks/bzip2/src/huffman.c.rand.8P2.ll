; ModuleID = 'huffman.c.rand.8P2.bc'
...
func_BZ2_hbMakeCodeLengths.13:                    ; preds = %ctrl3
  call void @BZ2_hbMakeCodeLengths.13(i8* %len, i32* %freq, i32 %alphaSize, i32 %maxLen)
  ret void

func_BZ2_hbMakeCodeLengths.15:                    ; preds = %ctrl4
...
func_BZ2_hbMakeCodeLengths.22:                    ; preds = %ctrl5
...
ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_BZ2_hbMakeCodeLengths.13, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_BZ2_hbMakeCodeLengths.15, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_BZ2_hbMakeCodeLengths.16, label %func_BZ2_hbMakeCodeLengths.22
}
...
func_BZ2_hbAssignCodes.8:                         ; preds = %ctrl1
...
func_BZ2_hbAssignCodes.17:                        ; preds = %ctrl4
  call void @BZ2_hbAssignCodes.17(i32* %code, i8* %length, i32 %minLen, i32 %maxLen, i32 %alphaSize)
  ret void
...
func_BZ2_hbAssignCodes.21:                        ; preds = %ctrl5
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_BZ2_hbAssignCodes.8, label %ctrl2
...
ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_BZ2_hbAssignCodes.17, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_BZ2_hbAssignCodes.20, label %func_BZ2_hbAssignCodes.21
}
...
ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_BZ2_hbCreateDecodeTables.18, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_BZ2_hbCreateDecodeTables.19, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_BZ2_hbCreateDecodeTables.23, label %func_BZ2_hbCreateDecodeTables.24
}
...
entry:
  %canary = alloca i32
  store i32 1418675923, i32* %canary
...
entry:
  %alphaSize.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1311788705, i32* %canary
  %minLen.addr = alloca i32, align 4
  %length.addr = alloca i8*, align 8
...
entry:
  ...
  %canary = alloca i32
  store i32 1113643187, i32* %canary
...
while.end234:                                     ; preds = %if.then218
  ...
  %152 = icmp eq i32 %151, 1113643187
...
entry:
  ...
  %weight = alloca [516 x i32], align 16
  %canary = alloca i32
  store i32 215291992, i32* %canary
  %heap = alloca [260 x i32], align 16
  %zz = alloca i32, align 4
  %alphaSize.addr = alloca i32, align 4
  %nHeap = alloca i32, align 4
...
entry:
  ...
  %code.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 1634924346, i32* %canary
  %minLen.addr = alloca i32, align 4
  %length.addr = alloca i8*, align 8
  store i32* %code, i32** %code.addr, align 8
  store i8* %length, i8** %length.addr, align 8
...
entry:
  ...
  %vec = alloca i32, align 4
  %canary = alloca i32
  store i32 1914867087, i32* %canary
  %minLen.addr = alloca i32, align 4
  %base.addr = alloca i32*, align 8
  %alphaSize.addr = alloca i32, align 4
  %limit.addr = alloca i32*, align 8
...
entry:
  %canary = alloca i32
  store i32 897962933, i32* %canary
  %pp = alloca i32, align 4
  %length.addr = alloca i8*, align 8
  %alphaSize.addr = alloca i32, align 4
  %perm.addr = alloca i32*, align 8
...
entry:
  ...
  %code.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 1631173438, i32* %canary
  %minLen.addr = alloca i32, align 4
  store i32* %code, i32** %code.addr, align 8
  store i8* %length, i8** %length.addr, align 8
  store i32 %minLen, i32* %minLen.addr, align 4
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 759328135, i32* %canary
  %maxLen.addr = alloca i32, align 4
  %length.addr = alloca i8*, align 8
  %minLen.addr = alloca i32, align 4
  %alphaSize.addr = alloca i32, align 4
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1446448123, i32* %canary
  %zz170 = alloca i32, align 4
  %n2 = alloca i32, align 4
  %zz92 = alloca i32, align 4
  %tmp171 = alloca i32, align 4
...
while.end234:                                     ; preds = %if.then218
  %151 = load i32, i32* %canary
  %152 = icmp eq i32 %151, 1446448123
  br i1 %152, label %153, label %func_exit
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 2092254851, i32* %canary
  %n = alloca i32, align 4
  %alphaSize.addr = alloca i32, align 4
  store i32* %code, i32** %code.addr, align 8
  store i8* %length, i8** %length.addr, align 8
...
entry:
  ...
  %zz = alloca i32, align 4
  %canary = alloca i32
  store i32 1083057756, i32* %canary
  %j = alloca i32, align 4
  %tmp = alloca i32, align 4
  %tmp171 = alloca i32, align 4
  %alphaSize.addr = alloca i32, align 4
...
while.end234:                                     ; preds = %if.then218
  %151 = load i32, i32* %canary
  %152 = icmp eq i32 %151, 1083057756
  br i1 %152, label %153, label %func_exit
...
entry:
  ...
  %tmp171 = alloca i32, align 4
  %canary = alloca i32
  store i32 547453698, i32* %canary
  %weight = alloca [516 x i32], align 16
  %heap = alloca [260 x i32], align 16
  %nHeap = alloca i32, align 4
  store i8* %len, i8** %len.addr, align 8
...
entry:
  ...
  %zz170 = alloca i32, align 4
  %canary = alloca i32
  store i32 1032711803, i32* %canary
  %tmp94 = alloca i32, align 4
  %tooLong = alloca i8, align 1
  %weight = alloca [516 x i32], align 16
  %heap = alloca [260 x i32], align 16
...
while.end234:                                     ; preds = %if.then218
  %151 = load i32, i32* %canary
  %152 = icmp eq i32 %151, 1032711803
  br i1 %152, label %153, label %func_exit
...
entry:
  ...
  %tooLong = alloca i8, align 1
  %canary = alloca i32
  store i32 1770684498, i32* %canary
  %weight = alloca [516 x i32], align 16
  %tmp48 = alloca i32, align 4
  %parent = alloca [516 x i32], align 16
  %tmp94 = alloca i32, align 4
...
while.end234:                                     ; preds = %if.then218
  %151 = load i32, i32* %canary
  %152 = icmp eq i32 %151, 1770684498
  br i1 %152, label %153, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @BZ2_hbAssignCodes.17(i32* %code, i8* %length, i32 %minLen, i32 %maxLen, i32 %alphaSize) #0 {
entry:
  %i = alloca i32, align 4
  %minLen.addr = alloca i32, align 4
  %vec = alloca i32, align 4
  ...
  %alphaSize.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 464666456, i32* %canary
  %code.addr = alloca i32*, align 8
  store i32* %code, i32** %code.addr, align 8
  store i8* %length, i8** %length.addr, align 8
  store i32 %minLen, i32* %minLen.addr, align 4
...
entry:
  %minLen.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1937791138, i32* %canary
  %i = alloca i32, align 4
  %alphaSize.addr = alloca i32, align 4
  %vec = alloca i32, align 4
  %limit.addr = alloca i32*, align 8
...
entry:
  ...
  %perm.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 1148421342, i32* %canary
  %limit.addr = alloca i32*, align 8
  %length.addr = alloca i8*, align 8
  %minLen.addr = alloca i32, align 4
  %j = alloca i32, align 4
...
entry:
  ...
  %code.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 2114051058, i32* %canary
  %maxLen.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %n = alloca i32, align 4
  store i32* %code, i32** %code.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 321594871, i32* %canary
  %length.addr = alloca i8*, align 8
  %code.addr = alloca i32*, align 8
  %i = alloca i32, align 4
  %minLen.addr = alloca i32, align 4
...
entry:
  ...
  %maxLen.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1727950520, i32* %canary
  %tooLong = alloca i8, align 1
  %k = alloca i32, align 4
  %tmp48 = alloca i32, align 4
  %zz47 = alloca i32, align 4
...
while.end234:                                     ; preds = %if.then218
  %151 = load i32, i32* %canary
  %152 = icmp eq i32 %151, 1727950520
  br i1 %152, label %153, label %func_exit
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1635139976, i32* %canary
  %pp = alloca i32, align 4
  %minLen.addr = alloca i32, align 4
  %perm.addr = alloca i32*, align 8
  %alphaSize.addr = alloca i32, align 4
