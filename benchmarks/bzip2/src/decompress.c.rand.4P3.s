...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1654199208, -20(%rbp)  # imm = 0x629913A8
	movq	%rdi, -16(%rbp)
	movq	-16(%rbp), %rax
	movl	$0, 3192(%rax)
	movl	$0, -4(%rbp)
...
.LBB2_5:                                # %for.inc
	...
	jmp	.LBB2_1
.LBB2_6:                                # %for.end
	cmpl	$1654199208, -20(%rbp)  # imm = 0x629913A8
	jne	.LBB2_8
.LBB2_7:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$32, %rsp
	movl	$1742450481, -20(%rbp)  # imm = 0x67DBAF31
	movq	%rdi, -16(%rbp)
	movq	-16(%rbp), %rax
	movl	$0, 3192(%rax)
	movl	$0, -4(%rbp)
...
.LBB3_5:                                # %for.inc
	...
	jmp	.LBB3_1
.LBB3_6:                                # %for.end
	cmpl	$1742450481, -20(%rbp)  # imm = 0x67DBAF31
	jne	.LBB3_8
.LBB3_7:
	addq	$32, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_offset %rbx, -24
	movl	$1796145167, -264(%rbp) # imm = 0x6B0F000F
	movq	%rdi, -16(%rbp)
	movq	-16(%rbp), %rax
	movq	(%rax), %rax
	movq	%rax, -192(%rbp)
...
.LBB4_673:                              # %save_state_and_return
	...
	movq	%rax, 64136(%rcx)
	movl	-28(%rbp), %ebx
	cmpl	$1796145167, -264(%rbp) # imm = 0x6B0F000F
	jne	.LBB4_675
.LBB4_674:
	movl	%ebx, %eax
...
# %bb.0:                                # %entry
	...
	subq	$392, %rsp              # imm = 0x188
	.cfi_offset %rbx, -24
	movl	$1910836298, -220(%rbp) # imm = 0x71E50C4A
	movq	%rdi, -16(%rbp)
	movq	-16(%rbp), %rax
	movq	(%rax), %rax
	movq	%rax, -192(%rbp)
...
.LBB5_673:                              # %save_state_and_return
	...
	movq	%rax, 64136(%rcx)
	movl	-28(%rbp), %ebx
	cmpl	$1910836298, -220(%rbp) # imm = 0x71E50C4A
	jne	.LBB5_675
.LBB5_674:
	movl	%ebx, %eax
	addq	$392, %rsp              # imm = 0x188
...
# %bb.0:                                # %entry
	...
	subq	$392, %rsp              # imm = 0x188
	.cfi_offset %rbx, -24
	movl	$69818016, -316(%rbp)   # imm = 0x42956A0
	movq	%rdi, -16(%rbp)
	movq	-16(%rbp), %rax
	movq	(%rax), %rax
	movq	%rax, -192(%rbp)
...
.LBB6_673:                              # %save_state_and_return
	...
	movq	%rax, 64136(%rcx)
	movl	-28(%rbp), %ebx
	cmpl	$69818016, -316(%rbp)   # imm = 0x42956A0
	jne	.LBB6_675
.LBB6_674:
	movl	%ebx, %eax
	addq	$392, %rsp              # imm = 0x188
...
# %bb.0:                                # %entry
	...
	subq	$392, %rsp              # imm = 0x188
	.cfi_offset %rbx, -24
	movl	$768970991, -328(%rbp)  # imm = 0x2DD590EF
	movq	%rdi, -16(%rbp)
	movq	-16(%rbp), %rax
	movq	(%rax), %rax
	movq	%rax, -192(%rbp)
...
.LBB7_673:                              # %save_state_and_return
	...
	movq	%rax, 64136(%rcx)
	movl	-28(%rbp), %ebx
	cmpl	$768970991, -328(%rbp)  # imm = 0x2DD590EF
	jne	.LBB7_675
.LBB7_674:
	movl	%ebx, %eax
	addq	$392, %rsp              # imm = 0x188
