...
rand_bb:
  ...
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_ran.3, label %ctrl0

func_ran.3:                                       ; preds = %rand_bb
  %2 = call double @ran.3()
  ret double %2

func_ran.9:                                       ; preds = %ctrl0
  %3 = call double @ran.9()
  ret double %3

func_ran.18:                                      ; preds = %ctrl1
  %4 = call double @ran.18()
  ret double %4
...
func_ran.38:                                      ; preds = %ctrl3
  %6 = call double @ran.38()
  ret double %6
...
ctrl0:                                            ; preds = %rand_bb
  %8 = icmp eq i32 %0, 1
  br i1 %8, label %func_ran.9, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %9 = icmp eq i32 %0, 2
  br i1 %9, label %func_ran.18, label %ctrl2
...
ctrl3:                                            ; preds = %ctrl2
  %11 = icmp eq i32 %0, 4
  br i1 %11, label %func_ran.38, label %func_ran.44
}
...
func_spec_init.24:                                ; preds = %ctrl0
  %3 = call i32 @spec_init.24()
  ret i32 %3

func_spec_init.25:                                ; preds = %ctrl1
  %4 = call i32 @spec_init.25()
  ret i32 %4

func_spec_init.42:                                ; preds = %ctrl2
  %5 = call i32 @spec_init.42()
  ret i32 %5

func_spec_init.49:                                ; preds = %ctrl3
  %6 = call i32 @spec_init.49()
  ret i32 %6
...
ctrl0:                                            ; preds = %rand_bb
  %8 = icmp eq i32 %0, 1
  br i1 %8, label %func_spec_init.24, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %9 = icmp eq i32 %0, 2
  br i1 %9, label %func_spec_init.25, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %10 = icmp eq i32 %0, 3
  br i1 %10, label %func_spec_init.42, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %11 = icmp eq i32 %0, 4
  br i1 %11, label %func_spec_init.49, label %func_spec_init.51
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_spec_random_load.11, label %ctrl0

func_spec_random_load.11:                         ; preds = %rand_bb
  %2 = call i32 @spec_random_load.11(i32 %fd)
  ret i32 %2
...
func_spec_random_load.37:                         ; preds = %ctrl1
  %4 = call i32 @spec_random_load.37(i32 %fd)
  ret i32 %4

func_spec_random_load.56:                         ; preds = %ctrl2
  %5 = call i32 @spec_random_load.56(i32 %fd)
  ret i32 %5

func_spec_random_load.58:                         ; preds = %ctrl3
  %6 = call i32 @spec_random_load.58(i32 %fd)
  ret i32 %6

func_spec_random_load.59:                         ; preds = %ctrl4
  %7 = call i32 @spec_random_load.59(i32 %fd)
  ret i32 %7

func_spec_random_load.61:                         ; preds = %ctrl5
  %8 = call i32 @spec_random_load.61(i32 %fd)
  ret i32 %8

func_spec_random_load.64:                         ; preds = %ctrl5
  %9 = call i32 @spec_random_load.64(i32 %fd)
  ret i32 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_spec_random_load.21, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_spec_random_load.37, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_spec_random_load.56, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_spec_random_load.58, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_spec_random_load.59, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_spec_random_load.61, label %func_spec_random_load.64
}
...
func_spec_load.17:                                ; preds = %ctrl0
  %3 = call i32 @spec_load.17(i32 %num, i8* %filename, i32 %size)
  ret i32 %3

func_spec_load.48:                                ; preds = %ctrl1
  %4 = call i32 @spec_load.48(i32 %num, i8* %filename, i32 %size)
  ret i32 %4

func_spec_load.54:                                ; preds = %ctrl2
  %5 = call i32 @spec_load.54(i32 %num, i8* %filename, i32 %size)
  ret i32 %5

func_spec_load.55:                                ; preds = %ctrl3
  %6 = call i32 @spec_load.55(i32 %num, i8* %filename, i32 %size)
  ret i32 %6

func_spec_load.65:                                ; preds = %ctrl4
  %7 = call i32 @spec_load.65(i32 %num, i8* %filename, i32 %size)
  ret i32 %7

func_spec_load.71:                                ; preds = %ctrl5
  %8 = call i32 @spec_load.71(i32 %num, i8* %filename, i32 %size)
  ret i32 %8
...
ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_spec_load.17, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_spec_load.48, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_spec_load.54, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_spec_load.55, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_spec_load.65, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_spec_load.71, label %func_spec_load.72
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_spec_read.26, label %ctrl0

func_spec_read.26:                                ; preds = %rand_bb
  %2 = call i32 @spec_read.26(i32 %fd, i8* %buf, i32 %size)
  ret i32 %2

func_spec_read.34:                                ; preds = %ctrl0
  %3 = call i32 @spec_read.34(i32 %fd, i8* %buf, i32 %size)
  ret i32 %3

func_spec_read.46:                                ; preds = %ctrl1
  %4 = call i32 @spec_read.46(i32 %fd, i8* %buf, i32 %size)
  ret i32 %4

func_spec_read.50:                                ; preds = %ctrl2
  %5 = call i32 @spec_read.50(i32 %fd, i8* %buf, i32 %size)
  ret i32 %5

func_spec_read.66:                                ; preds = %ctrl3
  %6 = call i32 @spec_read.66(i32 %fd, i8* %buf, i32 %size)
  ret i32 %6

func_spec_read.67:                                ; preds = %ctrl4
  %7 = call i32 @spec_read.67(i32 %fd, i8* %buf, i32 %size)
  ret i32 %7

func_spec_read.68:                                ; preds = %ctrl5
  %8 = call i32 @spec_read.68(i32 %fd, i8* %buf, i32 %size)
  ret i32 %8

func_spec_read.69:                                ; preds = %ctrl5
  %9 = call i32 @spec_read.69(i32 %fd, i8* %buf, i32 %size)
  ret i32 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_spec_read.34, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_spec_read.46, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_spec_read.50, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_spec_read.66, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_spec_read.67, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_spec_read.68, label %func_spec_read.69
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_spec_fread.6, label %ctrl0

func_spec_fread.6:                                ; preds = %rand_bb
  %2 = call i32 @spec_fread.6(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %2

func_spec_fread.7:                                ; preds = %ctrl0
  %3 = call i32 @spec_fread.7(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %3
...
func_spec_fread.14:                               ; preds = %ctrl3
  %6 = call i32 @spec_fread.14(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %6

func_spec_fread.19:                               ; preds = %ctrl4
  %7 = call i32 @spec_fread.19(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %7

func_spec_fread.22:                               ; preds = %ctrl5
  %8 = call i32 @spec_fread.22(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %8

func_spec_fread.31:                               ; preds = %ctrl5
  %9 = call i32 @spec_fread.31(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_spec_fread.7, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_spec_fread.12, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_spec_fread.13, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_spec_fread.14, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_spec_fread.19, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_spec_fread.22, label %func_spec_fread.31
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_spec_getc.20, label %ctrl0

func_spec_getc.20:                                ; preds = %rand_bb
  %2 = call i32 @spec_getc.20(i32 %fd)
  ret i32 %2

func_spec_getc.30:                                ; preds = %ctrl0
  %3 = call i32 @spec_getc.30(i32 %fd)
  ret i32 %3

func_spec_getc.35:                                ; preds = %ctrl1
  %4 = call i32 @spec_getc.35(i32 %fd)
  ret i32 %4

func_spec_getc.36:                                ; preds = %ctrl2
  %5 = call i32 @spec_getc.36(i32 %fd)
  ret i32 %5

func_spec_getc.47:                                ; preds = %ctrl3
  %6 = call i32 @spec_getc.47(i32 %fd)
  ret i32 %6

func_spec_getc.62:                                ; preds = %ctrl3
  %7 = call i32 @spec_getc.62(i32 %fd)
  ret i32 %7

ctrl0:                                            ; preds = %rand_bb
  %8 = icmp eq i32 %0, 1
  br i1 %8, label %func_spec_getc.30, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %9 = icmp eq i32 %0, 2
  br i1 %9, label %func_spec_getc.35, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %10 = icmp eq i32 %0, 3
  br i1 %10, label %func_spec_getc.36, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %11 = icmp eq i32 %0, 4
  br i1 %11, label %func_spec_getc.47, label %func_spec_getc.62
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_spec_ungetc.29, label %ctrl0

func_spec_ungetc.29:                              ; preds = %rand_bb
  %2 = call i32 @spec_ungetc.29(i8 %ch, i32 %fd)
  ret i32 %2

func_spec_ungetc.32:                              ; preds = %ctrl0
  %3 = call i32 @spec_ungetc.32(i8 %ch, i32 %fd)
  ret i32 %3

func_spec_ungetc.57:                              ; preds = %ctrl1
  %4 = call i32 @spec_ungetc.57(i8 %ch, i32 %fd)
  ret i32 %4
...
func_spec_ungetc.63:                              ; preds = %ctrl3
  %6 = call i32 @spec_ungetc.63(i8 %ch, i32 %fd)
  ret i32 %6

func_spec_ungetc.70:                              ; preds = %ctrl3
  %7 = call i32 @spec_ungetc.70(i8 %ch, i32 %fd)
  ret i32 %7

ctrl0:                                            ; preds = %rand_bb
  %8 = icmp eq i32 %0, 1
  br i1 %8, label %func_spec_ungetc.32, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %9 = icmp eq i32 %0, 2
  br i1 %9, label %func_spec_ungetc.57, label %ctrl2
...
ctrl3:                                            ; preds = %ctrl2
  %11 = icmp eq i32 %0, 4
  br i1 %11, label %func_spec_ungetc.63, label %func_spec_ungetc.70
}
...
func_spec_write.15:                               ; preds = %ctrl0
  %3 = call i32 @spec_write.15(i32 %fd, i8* %buf, i32 %size)
  ret i32 %3

func_spec_write.27:                               ; preds = %ctrl1
  %4 = call i32 @spec_write.27(i32 %fd, i8* %buf, i32 %size)
  ret i32 %4

func_spec_write.33:                               ; preds = %ctrl2
  %5 = call i32 @spec_write.33(i32 %fd, i8* %buf, i32 %size)
  ret i32 %5

func_spec_write.40:                               ; preds = %ctrl3
  %6 = call i32 @spec_write.40(i32 %fd, i8* %buf, i32 %size)
  ret i32 %6

func_spec_write.41:                               ; preds = %ctrl3
  %7 = call i32 @spec_write.41(i32 %fd, i8* %buf, i32 %size)
  ret i32 %7

ctrl0:                                            ; preds = %rand_bb
  %8 = icmp eq i32 %0, 1
  br i1 %8, label %func_spec_write.15, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %9 = icmp eq i32 %0, 2
  br i1 %9, label %func_spec_write.27, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %10 = icmp eq i32 %0, 3
  br i1 %10, label %func_spec_write.33, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %11 = icmp eq i32 %0, 4
  br i1 %11, label %func_spec_write.40, label %func_spec_write.41
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_spec_fwrite.8, label %ctrl0

func_spec_fwrite.8:                               ; preds = %rand_bb
  %2 = call i32 @spec_fwrite.8(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %2

func_spec_fwrite.10:                              ; preds = %ctrl0
  %3 = call i32 @spec_fwrite.10(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %3

func_spec_fwrite.28:                              ; preds = %ctrl1
  %4 = call i32 @spec_fwrite.28(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %4

func_spec_fwrite.39:                              ; preds = %ctrl2
  %5 = call i32 @spec_fwrite.39(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %5

func_spec_fwrite.43:                              ; preds = %ctrl3
  %6 = call i32 @spec_fwrite.43(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %6

func_spec_fwrite.45:                              ; preds = %ctrl4
  %7 = call i32 @spec_fwrite.45(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %7

func_spec_fwrite.52:                              ; preds = %ctrl5
  %8 = call i32 @spec_fwrite.52(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %8

func_spec_fwrite.53:                              ; preds = %ctrl5
  %9 = call i32 @spec_fwrite.53(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_spec_fwrite.10, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_spec_fwrite.28, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_spec_fwrite.39, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_spec_fwrite.43, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_spec_fwrite.45, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_spec_fwrite.52, label %func_spec_fwrite.53
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_spec_putc.1, label %func_spec_putc.16

func_spec_putc.1:                                 ; preds = %rand_bb
  %2 = call i32 @spec_putc.1(i8 %ch, i32 %fd)
  ret i32 %2
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_putc.1(i8 zeroext %ch, i32 %fd) #0 {
entry:
  %ch.addr = alloca i8, align 1
  %canary = alloca i32
  store i32 1695471197, i32* %canary
  %fd.addr = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1117165791, i32* %canary
  %fd.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local double @ran.3() #0 {
entry:
  %test = alloca i64, align 8
  %hi = alloca i64, align 8
  %canary = alloca i32
  store i32 78377695, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 125722862, i32* %canary
...
entry:
  ...
  %canary = alloca i32
  store i32 428991415, i32* %canary
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_fread.6(i8* %buf, i32 %size, i32 %num, i32 %fd) #0 {
entry:
  %buf.addr = alloca i8*, align 8
  %rc = alloca i32, align 4
  %size.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1421706043, i32* %canary
  %fd.addr = alloca i32, align 4
  %num.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_fread.7(i8* %buf, i32 %size, i32 %num, i32 %fd) #0 {
entry:
  %size.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %fd.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 290595209, i32* %canary
  %num.addr = alloca i32, align 4
  %rc = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_fwrite.8(i8* %buf, i32 %size, i32 %num, i32 %fd) #0 {
entry:
  %num.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %size.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 132215100, i32* %canary
  %fd.addr = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
  store i32 %num, i32* %num.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local double @ran.9() #0 {
entry:
  %hi = alloca i64, align 8
  %canary = alloca i32
  store i32 874221885, i32* %canary
  %lo = alloca i64, align 8
  %test = alloca i64, align 8
  %0 = load i64, i64* @seedi, align 8
  %div = sdiv i64 %0, 127773
...
entry:
  ...
  %buf.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1846097198, i32* %canary
  %fd.addr = alloca i32, align 4
  %num.addr = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_random_load.11(i32 %fd) #0 {
entry:
  %fd.addr = alloca i32, align 4
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1709248382, i32* %canary
  %i = alloca i32, align 4
...
entry:
  ...
  %rc = alloca i32, align 4
  %canary = alloca i32
  store i32 625604199, i32* %canary
  %fd.addr = alloca i32, align 4
  %num.addr = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
...
entry:
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1734434219, i32* %canary
  %fd.addr = alloca i32, align 4
  %size.addr = alloca i32, align 4
  %num.addr = alloca i32, align 4
  %rc = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_fread.14(i8* %buf, i32 %size, i32 %num, i32 %fd) #0 {
entry:
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1426108695, i32* %canary
  %rc = alloca i32, align 4
  %num.addr = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_write.15(i32 %fd, i8* %buf, i32 %size) #0 {
entry:
  %size.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1070599035, i32* %canary
  %buf.addr = alloca i8*, align 8
  %fd.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  store i8* %buf, i8** %buf.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 980627572, i32* %canary
  %fd.addr = alloca i32, align 4
  %ch.addr = alloca i8, align 1
  store i8 %ch, i8* %ch.addr, align 1
  store i32 %fd, i32* %fd.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_load.17(i32 %num, i8* %filename, i32 %size) #0 {
entry:
  %canary = alloca i32
  store i32 1915852940, i32* %canary
  %num.addr = alloca i32, align 4
  %rc = alloca i32, align 4
  %tmp = alloca i32, align 4
  %fd = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 214604995, i32* %canary
  %test = alloca i64, align 8
  %lo = alloca i64, align 8
  %hi = alloca i64, align 8
  %0 = load i64, i64* @seedi, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_fread.19(i8* %buf, i32 %size, i32 %num, i32 %fd) #0 {
entry:
  %size.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 15588052, i32* %canary
  %buf.addr = alloca i8*, align 8
  %num.addr = alloca i32, align 4
  %rc = alloca i32, align 4
  %fd.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_getc.20(i32 %fd) #0 {
entry:
  %canary = alloca i32
  store i32 1871046128, i32* %canary
  %rc = alloca i32, align 4
  %retval = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
...
entry:
  %random_text = alloca [32 x [131072 x i8]], align 16
  %canary = alloca i32
  store i32 2045726846, i32* %canary
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_fread.22(i8* %buf, i32 %size, i32 %num, i32 %fd) #0 {
entry:
  %num.addr = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 612218514, i32* %canary
  %buf.addr = alloca i8*, align 8
  %rc = alloca i32, align 4
  %size.addr = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
...
entry:
  %lo = alloca i64, align 8
  %canary = alloca i32
  store i32 2127397529, i32* %canary
  %test = alloca i64, align 8
  %hi = alloca i64, align 8
  %0 = load i64, i64* @seedi, align 8
  %div = sdiv i64 %0, 127773
...
entry:
  %canary = alloca i32
  store i32 1885968107, i32* %canary
  %limit = alloca i32, align 4
  %j = alloca i32, align 4
  %i = alloca i32, align 4
  %0 = load i32, i32* @dbglvl, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_init.25() #0 {
entry:
  %canary = alloca i32
  store i32 1822168407, i32* %canary
  %j = alloca i32, align 4
  %limit = alloca i32, align 4
  %i = alloca i32, align 4
  %0 = load i32, i32* @dbglvl, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_read.26(i32 %fd, i8* %buf, i32 %size) #0 {
entry:
  %retval = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 2074584591, i32* %canary
  %rc = alloca i32, align 4
  %size.addr = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_write.27(i32 %fd, i8* %buf, i32 %size) #0 {
entry:
  %buf.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 2050652478, i32* %canary
  %size.addr = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  store i8* %buf, i8** %buf.addr, align 8
...
entry:
  %size.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1351030787, i32* %canary
  %num.addr = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  store i8* %buf, i8** %buf.addr, align 8
...
entry:
  ...
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1900301968, i32* %canary
  %ch.addr = alloca i8, align 1
  store i8 %ch, i8* %ch.addr, align 1
  store i32 %fd, i32* %fd.addr, align 4
  store i32 0, i32* %rc, align 4
...
entry:
  %canary = alloca i32
  store i32 989312169, i32* %canary
  %fd.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  %rc = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
...
entry:
  ...
  %size.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 796560383, i32* %canary
  %retval = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 481171737, i32* %canary
  %rc = alloca i32, align 4
  %ch.addr = alloca i8, align 1
  %fd.addr = alloca i32, align 4
  store i8 %ch, i8* %ch.addr, align 1
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_write.33(i32 %fd, i8* %buf, i32 %size) #0 {
entry:
  %buf.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 847488321, i32* %canary
  %fd.addr = alloca i32, align 4
  %size.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  store i8* %buf, i8** %buf.addr, align 8
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1973944360, i32* %canary
  %fd.addr = alloca i32, align 4
  %size.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  store i8* %buf, i8** %buf.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_getc.35(i32 %fd) #0 {
entry:
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1512761830, i32* %canary
  %fd.addr = alloca i32, align 4
  %rc = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  store i32 0, i32* %rc, align 4
...
entry:
  %canary = alloca i32
  store i32 1964572665, i32* %canary
  %rc = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
...
entry:
  %random_text = alloca [32 x [131072 x i8]], align 16
  %canary = alloca i32
  store i32 568417847, i32* %canary
  %i = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  %j = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local double @ran.38() #0 {
entry:
  %lo = alloca i64, align 8
  %hi = alloca i64, align 8
  %canary = alloca i32
  store i32 1473594573, i32* %canary
  %test = alloca i64, align 8
  %0 = load i64, i64* @seedi, align 8
  %div = sdiv i64 %0, 127773
  store i64 %div, i64* %hi, align 8
...
entry:
  ...
  %size.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1622325116, i32* %canary
  %buf.addr = alloca i8*, align 8
  %num.addr = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
...
entry:
  ...
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 459051979, i32* %canary
  %buf.addr = alloca i8*, align 8
  store i32 %fd, i32* %fd.addr, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
...
entry:
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 926397040, i32* %canary
  %size.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  store i32 %fd, i32* %fd.addr, align 4
  store i8* %buf, i8** %buf.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 2083391395, i32* %canary
  %i = alloca i32, align 4
  %limit = alloca i32, align 4
  %j = alloca i32, align 4
  %0 = load i32, i32* @dbglvl, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_fwrite.43(i8* %buf, i32 %size, i32 %num, i32 %fd) #0 {
entry:
  %fd.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %size.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2046933454, i32* %canary
  %num.addr = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
  store i32 %num, i32* %num.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 357553009, i32* %canary
  %hi = alloca i64, align 8
  %test = alloca i64, align 8
  %lo = alloca i64, align 8
  %0 = load i64, i64* @seedi, align 8
...
entry:
  ...
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 486645005, i32* %canary
  %num.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
...
entry:
  ...
  %buf.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 492450127, i32* %canary
  %size.addr = alloca i32, align 4
  %rc = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  store i8* %buf, i8** %buf.addr, align 8
...
entry:
  ...
  %rc = alloca i32, align 4
  %canary = alloca i32
  store i32 1153709367, i32* %canary
  %retval = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  store i32 0, i32* %rc, align 4
  %0 = load i32, i32* @dbglvl, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_load.48(i32 %num, i8* %filename, i32 %size) #0 {
entry:
  %rc = alloca i32, align 4
  %i = alloca i32, align 4
  %tmp = alloca i32, align 4
  %fd = alloca i32, align 4
  %canary = alloca i32
  store i32 1737744814, i32* %canary
  %num.addr = alloca i32, align 4
  %size.addr = alloca i32, align 4
  %filename.addr = alloca i8*, align 8
  store i32 %num, i32* %num.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_init.49() #0 {
entry:
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 987590806, i32* %canary
  %i = alloca i32, align 4
  %limit = alloca i32, align 4
  %0 = load i32, i32* @dbglvl, align 4
  %cmp = icmp slt i32 3, %0
...
entry:
  ...
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1295956731, i32* %canary
  %size.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  store i32 %fd, i32* %fd.addr, align 4
  store i8* %buf, i8** %buf.addr, align 8
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 165151620, i32* %canary
  %j = alloca i32, align 4
  %0 = load i32, i32* @dbglvl, align 4
  %cmp = icmp slt i32 3, %0
  br i1 %cmp, label %if.then, label %if.end
...
entry:
  ...
  %buf.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 670767004, i32* %canary
  %num.addr = alloca i32, align 4
  %size.addr = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
...
entry:
  ...
  %num.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 351494821, i32* %canary
  %buf.addr = alloca i8*, align 8
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
  store i32 %num, i32* %num.addr, align 4
...
entry:
  ...
  %num.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1880110204, i32* %canary
  %fd = alloca i32, align 4
  %i = alloca i32, align 4
  %tmp = alloca i32, align 4
  store i32 %num, i32* %num.addr, align 4
...
entry:
  ...
  %num.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1412002688, i32* %canary
  %size.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %filename.addr = alloca i8*, align 8
  %tmp = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_random_load.56(i32 %fd) #0 {
entry:
  %j = alloca i32, align 4
  %random_text = alloca [32 x [131072 x i8]], align 16
  %canary = alloca i32
  store i32 2031923332, i32* %canary
  %fd.addr = alloca i32, align 4
  %i = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  %0 = load i32, i32* @dbglvl, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_ungetc.57(i8 zeroext %ch, i32 %fd) #0 {
entry:
  %canary = alloca i32
  store i32 718277402, i32* %canary
  %fd.addr = alloca i32, align 4
  %rc = alloca i32, align 4
  %ch.addr = alloca i8, align 1
  store i8 %ch, i8* %ch.addr, align 1
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_random_load.58(i32 %fd) #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1653416493, i32* %canary
  %fd.addr = alloca i32, align 4
  %j = alloca i32, align 4
  %random_text = alloca [32 x [131072 x i8]], align 16
  store i32 %fd, i32* %fd.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_random_load.59(i32 %fd) #0 {
entry:
  %canary = alloca i32
  store i32 64127215, i32* %canary
  %random_text = alloca [32 x [131072 x i8]], align 16
  %fd.addr = alloca i32, align 4
  %j = alloca i32, align 4
  %i = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 1394400008, i32* %canary
  %fd.addr = alloca i32, align 4
  %ch.addr = alloca i8, align 1
  %rc = alloca i32, align 4
  store i8 %ch, i8* %ch.addr, align 1
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_random_load.61(i32 %fd) #0 {
entry:
  %random_text = alloca [32 x [131072 x i8]], align 16
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 445404602, i32* %canary
  %i = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  %0 = load i32, i32* @dbglvl, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_getc.62(i32 %fd) #0 {
entry:
  %canary = alloca i32
  store i32 726332711, i32* %canary
  %retval = alloca i32, align 4
  %rc = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_ungetc.63(i8 zeroext %ch, i32 %fd) #0 {
entry:
  %ch.addr = alloca i8, align 1
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 169506346, i32* %canary
  %rc = alloca i32, align 4
  store i8 %ch, i8* %ch.addr, align 1
  store i32 %fd, i32* %fd.addr, align 4
  store i32 0, i32* %rc, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_random_load.64(i32 %fd) #0 {
entry:
  %fd.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1806528132, i32* %canary
  %j = alloca i32, align 4
  %random_text = alloca [32 x [131072 x i8]], align 16
  store i32 %fd, i32* %fd.addr, align 4
  %0 = load i32, i32* @dbglvl, align 4
...
entry:
  %num.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 171353228, i32* %canary
  %size.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %filename.addr = alloca i8*, align 8
  %tmp = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 783039205, i32* %canary
  %retval = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %fd.addr = alloca i32, align 4
  %size.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_read.67(i32 %fd, i8* %buf, i32 %size) #0 {
entry:
  %retval = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %size.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 94918052, i32* %canary
  %fd.addr = alloca i32, align 4
  %rc = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  store i8* %buf, i8** %buf.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_read.68(i32 %fd, i8* %buf, i32 %size) #0 {
entry:
  %canary = alloca i32
  store i32 587467565, i32* %canary
  %size.addr = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
...
entry:
  ...
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 279232022, i32* %canary
  %retval = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 817319792, i32* %canary
  %ch.addr = alloca i8, align 1
  %rc = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  store i8 %ch, i8* %ch.addr, align 1
...
entry:
  %canary = alloca i32
  store i32 1345658818, i32* %canary
  %fd = alloca i32, align 4
  %size.addr = alloca i32, align 4
  %num.addr = alloca i32, align 4
  %rc = alloca i32, align 4
...
entry:
  ...
  %num.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 271908103, i32* %canary
  %size.addr = alloca i32, align 4
  %rc = alloca i32, align 4
  %fd = alloca i32, align 4
  %tmp = alloca i32, align 4
