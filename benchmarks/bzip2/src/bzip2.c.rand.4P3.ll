...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_fopen_output_safely.44, label %ctrl0

func_fopen_output_safely.44:                      ; preds = %rand_bb
  %2 = call %struct._IO_FILE* @fopen_output_safely.44(i8* %name, i8* %mode)
  ret %struct._IO_FILE* %2

func_fopen_output_safely.69:                      ; preds = %ctrl0
  %3 = call %struct._IO_FILE* @fopen_output_safely.69(i8* %name, i8* %mode)
  ret %struct._IO_FILE* %3

func_fopen_output_safely.81:                      ; preds = %ctrl1
  %4 = call %struct._IO_FILE* @fopen_output_safely.81(i8* %name, i8* %mode)
  ret %struct._IO_FILE* %4

func_fopen_output_safely.86:                      ; preds = %ctrl1
  %5 = call %struct._IO_FILE* @fopen_output_safely.86(i8* %name, i8* %mode)
  ret %struct._IO_FILE* %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_fopen_output_safely.69, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_fopen_output_safely.81, label %func_fopen_output_safely.86
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_copyFileName.31, label %func_copyFileName.38

func_copyFileName.31:                             ; preds = %rand_bb
  call void @copyFileName.31(i8* %to, i8* %from)
  ret void

func_copyFileName.38:                             ; preds = %rand_bb
  call void @copyFileName.38(i8* %to, i8* %from)
  ret void
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_addFlagsFromEnvVar.13, label %ctrl0

func_addFlagsFromEnvVar.13:                       ; preds = %rand_bb
  call void @addFlagsFromEnvVar.13(%struct.zzzz** %argList, i8* %varName)
  ret void

func_addFlagsFromEnvVar.19:                       ; preds = %ctrl0
  call void @addFlagsFromEnvVar.19(%struct.zzzz** %argList, i8* %varName)
  ret void

func_addFlagsFromEnvVar.20:                       ; preds = %ctrl1
  call void @addFlagsFromEnvVar.20(%struct.zzzz** %argList, i8* %varName)
  ret void

func_addFlagsFromEnvVar.28:                       ; preds = %ctrl1
  call void @addFlagsFromEnvVar.28(%struct.zzzz** %argList, i8* %varName)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_addFlagsFromEnvVar.19, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_addFlagsFromEnvVar.20, label %func_addFlagsFromEnvVar.28
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_snocString.14, label %ctrl0

func_snocString.14:                               ; preds = %rand_bb
  %2 = call %struct.zzzz* @snocString.14(%struct.zzzz* %root, i8* %name)
  ret %struct.zzzz* %2

func_snocString.60:                               ; preds = %ctrl0
  %3 = call %struct.zzzz* @snocString.60(%struct.zzzz* %root, i8* %name)
  ret %struct.zzzz* %3

func_snocString.64:                               ; preds = %ctrl1
  %4 = call %struct.zzzz* @snocString.64(%struct.zzzz* %root, i8* %name)
  ret %struct.zzzz* %4

func_snocString.67:                               ; preds = %ctrl1
  %5 = call %struct.zzzz* @snocString.67(%struct.zzzz* %root, i8* %name)
  ret %struct.zzzz* %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_snocString.60, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_snocString.64, label %func_snocString.67
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_compress.18, label %ctrl0

func_compress.18:                                 ; preds = %rand_bb
  call void @compress.18(i8* %name)
  ret void

func_compress.65:                                 ; preds = %ctrl0
  call void @compress.65(i8* %name)
  ret void

func_compress.74:                                 ; preds = %ctrl1
  call void @compress.74(i8* %name)
  ret void

func_compress.93:                                 ; preds = %ctrl1
  call void @compress.93(i8* %name)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_compress.65, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_compress.74, label %func_compress.93
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_uncompress.23, label %ctrl0

func_uncompress.23:                               ; preds = %rand_bb
  call void @uncompress.23(i8* %name)
  ret void

func_uncompress.78:                               ; preds = %ctrl0
  call void @uncompress.78(i8* %name)
  ret void

func_uncompress.84:                               ; preds = %ctrl1
  call void @uncompress.84(i8* %name)
  ret void
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_uncompress.78, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_uncompress.84, label %func_uncompress.92
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_testf.10, label %ctrl0

func_testf.10:                                    ; preds = %rand_bb
  call void @testf.10(i8* %name)
  ret void

func_testf.17:                                    ; preds = %ctrl0
  call void @testf.17(i8* %name)
  ret void

func_testf.52:                                    ; preds = %ctrl1
  call void @testf.52(i8* %name)
  ret void

func_testf.62:                                    ; preds = %ctrl1
  call void @testf.62(i8* %name)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_testf.17, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_testf.52, label %func_testf.62
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_cleanUpAndFail.55, label %ctrl0

func_cleanUpAndFail.55:                           ; preds = %rand_bb
  call void @cleanUpAndFail.55(i32 %ec)
  ret void

func_cleanUpAndFail.68:                           ; preds = %ctrl0
  call void @cleanUpAndFail.68(i32 %ec)
  ret void
...
func_cleanUpAndFail.82:                           ; preds = %ctrl1
  call void @cleanUpAndFail.82(i32 %ec)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_cleanUpAndFail.68, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_cleanUpAndFail.77, label %func_cleanUpAndFail.82
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_myMalloc.47, label %func_myMalloc.53

func_myMalloc.47:                                 ; preds = %rand_bb
  %2 = call i8* @myMalloc.47(i32 %n)
  ret i8* %2

func_myMalloc.53:                                 ; preds = %rand_bb
  %3 = call i8* @myMalloc.53(i32 %n)
  ret i8* %3
}
...
func_fileExists.15:                               ; preds = %ctrl0
  %3 = call i8 @fileExists.15(i8* %name)
  ret i8 %3

func_fileExists.45:                               ; preds = %ctrl1
  %4 = call i8 @fileExists.45(i8* %name)
  ret i8 %4

func_fileExists.59:                               ; preds = %ctrl1
  %5 = call i8 @fileExists.59(i8* %name)
  ret i8 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_fileExists.15, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_fileExists.45, label %func_fileExists.59
}
...
func_hasSuffix.49:                                ; preds = %ctrl1
  %4 = call i8 @hasSuffix.49(i8* %s, i8* %suffix)
  ret i8 %4

func_hasSuffix.63:                                ; preds = %ctrl1
  %5 = call i8 @hasSuffix.63(i8* %s, i8* %suffix)
  ret i8 %5
...
ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_hasSuffix.49, label %func_hasSuffix.63
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_notAStandardFile.71, label %ctrl0

func_notAStandardFile.71:                         ; preds = %rand_bb
  %2 = call i8 @notAStandardFile.71(i8* %name)
  ret i8 %2

func_notAStandardFile.75:                         ; preds = %ctrl0
  %3 = call i8 @notAStandardFile.75(i8* %name)
  ret i8 %3

func_notAStandardFile.87:                         ; preds = %ctrl1
  %4 = call i8 @notAStandardFile.87(i8* %name)
  ret i8 %4

func_notAStandardFile.89:                         ; preds = %ctrl1
  %5 = call i8 @notAStandardFile.89(i8* %name)
  ret i8 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_notAStandardFile.75, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_notAStandardFile.87, label %func_notAStandardFile.89
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_countHardLinks.8, label %ctrl0

func_countHardLinks.8:                            ; preds = %rand_bb
  %2 = call i32 @countHardLinks.8(i8* %name)
  ret i32 %2

func_countHardLinks.21:                           ; preds = %ctrl0
  %3 = call i32 @countHardLinks.21(i8* %name)
  ret i32 %3

func_countHardLinks.25:                           ; preds = %ctrl1
  %4 = call i32 @countHardLinks.25(i8* %name)
  ret i32 %4

func_countHardLinks.56:                           ; preds = %ctrl1
  %5 = call i32 @countHardLinks.56(i8* %name)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_countHardLinks.21, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_countHardLinks.25, label %func_countHardLinks.56
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_saveInputFileMetaInfo.9, label %func_saveInputFileMetaInfo.35

func_saveInputFileMetaInfo.9:                     ; preds = %rand_bb
  call void @saveInputFileMetaInfo.9(i8* %srcName)
  ret void
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_pad.5, label %func_pad.12

func_pad.5:                                       ; preds = %rand_bb
  call void @pad.5(i8* %s)
  ret void
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_compressStream.7, label %ctrl0

func_compressStream.7:                            ; preds = %rand_bb
  call void @compressStream.7(%struct._IO_FILE* %stream, %struct._IO_FILE* %zStream)
  ret void

func_compressStream.30:                           ; preds = %ctrl0
  call void @compressStream.30(%struct._IO_FILE* %stream, %struct._IO_FILE* %zStream)
  ret void

func_compressStream.48:                           ; preds = %ctrl1
  call void @compressStream.48(%struct._IO_FILE* %stream, %struct._IO_FILE* %zStream)
  ret void

func_compressStream.54:                           ; preds = %ctrl1
  call void @compressStream.54(%struct._IO_FILE* %stream, %struct._IO_FILE* %zStream)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_compressStream.30, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_compressStream.48, label %func_compressStream.54
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_applySavedMetaInfoToOutputFile.51, label %ctrl0

func_applySavedMetaInfoToOutputFile.51:           ; preds = %rand_bb
  call void @applySavedMetaInfoToOutputFile.51(i8* %dstName)
  ret void

func_applySavedMetaInfoToOutputFile.66:           ; preds = %ctrl0
  call void @applySavedMetaInfoToOutputFile.66(i8* %dstName)
  ret void

func_applySavedMetaInfoToOutputFile.91:           ; preds = %ctrl1
  call void @applySavedMetaInfoToOutputFile.91(i8* %dstName)
  ret void

func_applySavedMetaInfoToOutputFile.95:           ; preds = %ctrl1
  call void @applySavedMetaInfoToOutputFile.95(i8* %dstName)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_applySavedMetaInfoToOutputFile.66, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_applySavedMetaInfoToOutputFile.91, label %func_applySavedMetaInfoToOutputFile.95
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_myfeof.40, label %ctrl0

func_myfeof.40:                                   ; preds = %rand_bb
  %2 = call i8 @myfeof.40(%struct._IO_FILE* %f)
  ret i8 %2

func_myfeof.73:                                   ; preds = %ctrl0
  %3 = call i8 @myfeof.73(%struct._IO_FILE* %f)
  ret i8 %3

func_myfeof.85:                                   ; preds = %ctrl1
  %4 = call i8 @myfeof.85(%struct._IO_FILE* %f)
  ret i8 %4

func_myfeof.96:                                   ; preds = %ctrl1
  %5 = call i8 @myfeof.96(%struct._IO_FILE* %f)
  ret i8 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_myfeof.73, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_myfeof.85, label %func_myfeof.96
}
...
func_uInt64_from_UInt32s.26:                      ; preds = %ctrl0
  call void @uInt64_from_UInt32s.26(%struct.UInt64* %n, i32 %lo32, i32 %hi32)
  ret void

func_uInt64_from_UInt32s.80:                      ; preds = %ctrl1
  call void @uInt64_from_UInt32s.80(%struct.UInt64* %n, i32 %lo32, i32 %hi32)
  ret void

func_uInt64_from_UInt32s.83:                      ; preds = %ctrl1
  call void @uInt64_from_UInt32s.83(%struct.UInt64* %n, i32 %lo32, i32 %hi32)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_uInt64_from_UInt32s.26, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_uInt64_from_UInt32s.80, label %func_uInt64_from_UInt32s.83
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_uInt64_to_double.11, label %ctrl0

func_uInt64_to_double.11:                         ; preds = %rand_bb
  %2 = call double @uInt64_to_double.11(%struct.UInt64* %n)
  ret double %2

func_uInt64_to_double.34:                         ; preds = %ctrl0
  %3 = call double @uInt64_to_double.34(%struct.UInt64* %n)
  ret double %3

func_uInt64_to_double.46:                         ; preds = %ctrl1
  %4 = call double @uInt64_to_double.46(%struct.UInt64* %n)
  ret double %4

func_uInt64_to_double.61:                         ; preds = %ctrl1
  %5 = call double @uInt64_to_double.61(%struct.UInt64* %n)
  ret double %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_uInt64_to_double.34, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_uInt64_to_double.46, label %func_uInt64_to_double.61
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_uInt64_toAscii.50, label %ctrl0

func_uInt64_toAscii.50:                           ; preds = %rand_bb
  call void @uInt64_toAscii.50(i8* %outbuf, %struct.UInt64* %n)
  ret void

func_uInt64_toAscii.76:                           ; preds = %ctrl0
  call void @uInt64_toAscii.76(i8* %outbuf, %struct.UInt64* %n)
  ret void

func_uInt64_toAscii.79:                           ; preds = %ctrl1
  call void @uInt64_toAscii.79(i8* %outbuf, %struct.UInt64* %n)
  ret void

func_uInt64_toAscii.88:                           ; preds = %ctrl1
  call void @uInt64_toAscii.88(i8* %outbuf, %struct.UInt64* %n)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_uInt64_toAscii.76, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_uInt64_toAscii.79, label %func_uInt64_toAscii.88
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_uInt64_qrm10.41, label %ctrl0

func_uInt64_qrm10.41:                             ; preds = %rand_bb
  %2 = call i32 @uInt64_qrm10.41(%struct.UInt64* %n)
  ret i32 %2

func_uInt64_qrm10.43:                             ; preds = %ctrl0
  %3 = call i32 @uInt64_qrm10.43(%struct.UInt64* %n)
  ret i32 %3

func_uInt64_qrm10.90:                             ; preds = %ctrl1
  %4 = call i32 @uInt64_qrm10.90(%struct.UInt64* %n)
  ret i32 %4

func_uInt64_qrm10.94:                             ; preds = %ctrl1
  %5 = call i32 @uInt64_qrm10.94(%struct.UInt64* %n)
  ret i32 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_uInt64_qrm10.43, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_uInt64_qrm10.90, label %func_uInt64_qrm10.94
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_uInt64_isZero.6, label %ctrl0

func_uInt64_isZero.6:                             ; preds = %rand_bb
  %2 = call i8 @uInt64_isZero.6(%struct.UInt64* %n)
  ret i8 %2

func_uInt64_isZero.57:                            ; preds = %ctrl0
  %3 = call i8 @uInt64_isZero.57(%struct.UInt64* %n)
  ret i8 %3

func_uInt64_isZero.58:                            ; preds = %ctrl1
  %4 = call i8 @uInt64_isZero.58(%struct.UInt64* %n)
  ret i8 %4

func_uInt64_isZero.72:                            ; preds = %ctrl1
  %5 = call i8 @uInt64_isZero.72(%struct.UInt64* %n)
  ret i8 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_uInt64_isZero.57, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_uInt64_isZero.58, label %func_uInt64_isZero.72
}
...
func_mapSuffix.22:                                ; preds = %ctrl0
  %3 = call i8 @mapSuffix.22(i8* %name, i8* %oldSuffix, i8* %newSuffix)
  ret i8 %3

func_mapSuffix.24:                                ; preds = %ctrl1
  %4 = call i8 @mapSuffix.24(i8* %name, i8* %oldSuffix, i8* %newSuffix)
  ret i8 %4

func_mapSuffix.36:                                ; preds = %ctrl1
  %5 = call i8 @mapSuffix.36(i8* %name, i8* %oldSuffix, i8* %newSuffix)
  ret i8 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_mapSuffix.22, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_mapSuffix.24, label %func_mapSuffix.36
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_uncompressStream.1, label %ctrl0

func_uncompressStream.1:                          ; preds = %rand_bb
  %2 = call i8 @uncompressStream.1(%struct._IO_FILE* %zStream, %struct._IO_FILE* %stream)
  ret i8 %2

func_uncompressStream.29:                         ; preds = %ctrl0
  %3 = call i8 @uncompressStream.29(%struct._IO_FILE* %zStream, %struct._IO_FILE* %stream)
  ret i8 %3

func_uncompressStream.33:                         ; preds = %ctrl1
  %4 = call i8 @uncompressStream.33(%struct._IO_FILE* %zStream, %struct._IO_FILE* %stream)
  ret i8 %4

func_uncompressStream.42:                         ; preds = %ctrl1
  %5 = call i8 @uncompressStream.42(%struct._IO_FILE* %zStream, %struct._IO_FILE* %stream)
  ret i8 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_uncompressStream.29, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_uncompressStream.33, label %func_uncompressStream.42
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_testStream.2, label %ctrl0

func_testStream.2:                                ; preds = %rand_bb
  %2 = call i8 @testStream.2(%struct._IO_FILE* %zStream)
  ret i8 %2

func_testStream.27:                               ; preds = %ctrl0
  %3 = call i8 @testStream.27(%struct._IO_FILE* %zStream)
  ret i8 %3

func_testStream.32:                               ; preds = %ctrl1
  %4 = call i8 @testStream.32(%struct._IO_FILE* %zStream)
  ret i8 %4

func_testStream.70:                               ; preds = %ctrl1
  %5 = call i8 @testStream.70(%struct._IO_FILE* %zStream)
  ret i8 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_testStream.27, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_testStream.32, label %func_testStream.70
}

; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @uncompressStream.1(%struct._IO_FILE* %zStream, %struct._IO_FILE* %stream) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 226922235, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @testStream.2(%struct._IO_FILE* %zStream) #0 {
entry:
  %bzf = alloca i8*, align 8
  %nUnused = alloca i32, align 4
  %retval = alloca i8, align 1
  ...
  %bzerr_dummy = alloca i32, align 4
  %canary = alloca i32
  store i32 985806476, i32* %canary
  %obuf = alloca [5000 x i8], align 16
  %unusedTmpV = alloca i8*, align 8
  %unused = alloca [5000 x i8], align 16
  %streamNo = alloca i32, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 439799836, i32* %canary
  %name.addr = alloca i8*, align 8
...
entry:
  %canary = alloca i32
  store i32 458680759, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @pad.5(i8* %s) #0 {
entry:
  %canary = alloca i32
  store i32 1010152523, i32* %canary
  %s.addr = alloca i8*, align 8
  %i = alloca i32, align 4
  store i8* %s, i8** %s.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @uInt64_isZero.6(%struct.UInt64* %n) #0 {
entry:
  %n.addr = alloca %struct.UInt64*, align 8
  %canary = alloca i32
  store i32 675832153, i32* %canary
  %i = alloca i32, align 4
  %retval = alloca i8, align 1
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
  store i32 0, i32* %i, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @compressStream.7(%struct._IO_FILE* %stream, %struct._IO_FILE* %zStream) #0 {
entry:
  %bzf = alloca i8*, align 8
  ...
  %canary = alloca i32
  store i32 631671793, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @countHardLinks.8(i8* %name) #0 {
entry:
  %canary = alloca i32
  store i32 1878293585, i32* %canary
  %i = alloca i32, align 4
  %retval = alloca i32, align 4
  %name.addr = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @saveInputFileMetaInfo.9(i8* %srcName) #0 {
entry:
  %canary = alloca i32
  store i32 1716520877, i32* %canary
  %retVal = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @testf.10(i8* %name) #0 {
entry:
  %statBuf = alloca %struct.stat, align 8
  %canary = alloca i32
  store i32 1280604276, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal double @uInt64_to_double.11(%struct.UInt64* %n) #0 {
entry:
  %base = alloca double, align 8
  %sum = alloca double, align 8
  %canary = alloca i32
  store i32 123611166, i32* %canary
  %n.addr = alloca %struct.UInt64*, align 8
  %i = alloca i32, align 4
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
...
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1559133202, i32* %canary
  %s.addr = alloca i8*, align 8
  store i8* %s, i8** %s.addr, align 8
  %0 = load i8*, i8** %s.addr, align 8
  %call = call i64 @strlen(i8* %0) #9
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @addFlagsFromEnvVar.13(%struct.zzzz** %argList, i8* %varName) #0 {
entry:
  %canary = alloca i32
  store i32 541843734, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal %struct.zzzz* @snocString.14(%struct.zzzz* %root, i8* %name) #0 {
entry:
  %retval = alloca %struct.zzzz*, align 8
  %root.addr = alloca %struct.zzzz*, align 8
  %canary = alloca i32
  store i32 1639671252, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @fileExists.15(i8* %name) #0 {
entry:
  %canary = alloca i32
  store i32 1233935916, i32* %canary
  %exists = alloca i8, align 1
  %name.addr = alloca i8*, align 8
  %tmp = alloca %struct._IO_FILE*, align 8
  store i8* %name, i8** %name.addr, align 8
...
entry:
  ...
  %name.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1452385159, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @testf.17(i8* %name) #0 {
entry:
  %statBuf = alloca %struct.stat, align 8
  %allOK = alloca i8, align 1
  %inStr = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 1199253709, i32* %canary
  %name.addr = alloca i8*, align 8
  store i8* %name, i8** %name.addr, align 8
  store i8 0, i8* @deleteOutputOnInterrupt, align 1
  %0 = load i8*, i8** %name.addr, align 8
...
entry:
  ...
  %statBuf = alloca %struct.stat, align 8
  %canary = alloca i32
  store i32 803935039, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @addFlagsFromEnvVar.19(%struct.zzzz** %argList, i8* %varName) #0 {
entry:
  %canary = alloca i32
  store i32 1785691593, i32* %canary
  %j = alloca i32, align 4
  %k = alloca i32, align 4
  %argList.addr = alloca %struct.zzzz**, align 8
  %varName.addr = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @addFlagsFromEnvVar.20(%struct.zzzz** %argList, i8* %varName) #0 {
entry:
  %j = alloca i32, align 4
  %varName.addr = alloca i8*, align 8
  %argList.addr = alloca %struct.zzzz**, align 8
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1579596887, i32* %canary
  %k = alloca i32, align 4
  %envbase = alloca i8*, align 8
  store %struct.zzzz** %argList, %struct.zzzz*** %argList.addr, align 8
  store i8* %varName, i8** %varName.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @countHardLinks.21(i8* %name) #0 {
entry:
  %canary = alloca i32
  store i32 329400284, i32* %canary
  %statBuf = alloca %struct.stat, align 8
  %name.addr = alloca i8*, align 8
  %i = alloca i32, align 4
  %retval = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @mapSuffix.22(i8* %name, i8* %oldSuffix, i8* %newSuffix) #0 {
entry:
  %name.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1243794193, i32* %canary
  %oldSuffix.addr = alloca i8*, align 8
  %newSuffix.addr = alloca i8*, align 8
  %retval = alloca i8, align 1
  store i8* %name, i8** %name.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @uncompress.23(i8* %name) #0 {
entry:
  %n = alloca i32, align 4
  ...
  %canary = alloca i32
  store i32 778623116, i32* %canary
  %retVal = alloca i32, align 4
  store i8* %name, i8** %name.addr, align 8
  store i8 0, i8* @deleteOutputOnInterrupt, align 1
  %0 = load i8*, i8** %name.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @mapSuffix.24(i8* %name, i8* %oldSuffix, i8* %newSuffix) #0 {
entry:
  %canary = alloca i32
  store i32 321611075, i32* %canary
  %retval = alloca i8, align 1
  %oldSuffix.addr = alloca i8*, align 8
  %name.addr = alloca i8*, align 8
  %newSuffix.addr = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @countHardLinks.25(i8* %name) #0 {
entry:
  %statBuf = alloca %struct.stat, align 8
  %i = alloca i32, align 4
  %name.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 315099353, i32* %canary
  %retval = alloca i32, align 4
  store i8* %name, i8** %name.addr, align 8
  %0 = load i8*, i8** %name.addr, align 8
  %call = call i32 @lstat(i8* %0, %struct.stat* %statBuf) #8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @uInt64_from_UInt32s.26(%struct.UInt64* %n, i32 %lo32, i32 %hi32) #0 {
entry:
  %n.addr = alloca %struct.UInt64*, align 8
  %hi32.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1798267856, i32* %canary
  %lo32.addr = alloca i32, align 4
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
  store i32 %lo32, i32* %lo32.addr, align 4
  store i32 %hi32, i32* %hi32.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @testStream.27(%struct._IO_FILE* %zStream) #0 {
entry:
  %unused = alloca [5000 x i8], align 16
  %bzf = alloca i8*, align 8
  %zStream.addr = alloca %struct._IO_FILE*, align 8
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 557884421, i32* %canary
  %ret = alloca i32, align 4
  %nread = alloca i32, align 4
  %retval = alloca i8, align 1
  %streamNo = alloca i32, align 4
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 2139636425, i32* %canary
  %j = alloca i32, align 4
  %p = alloca i8*, align 8
  %envbase = alloca i8*, align 8
  store %struct.zzzz** %argList, %struct.zzzz*** %argList.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @uncompressStream.29(%struct._IO_FILE* %zStream, %struct._IO_FILE* %stream) #0 {
entry:
  %unusedTmpV = alloca i8*, align 8
  %unused = alloca [5000 x i8], align 16
  %stream.addr = alloca %struct._IO_FILE*, align 8
  ...
  %retval = alloca i8, align 1
  %canary = alloca i32
  store i32 1195538879, i32* %canary
  %zStream.addr = alloca %struct._IO_FILE*, align 8
  %bzf = alloca i8*, align 8
  %streamNo = alloca i32, align 4
  %nread = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @compressStream.30(%struct._IO_FILE* %stream, %struct._IO_FILE* %zStream) #0 {
entry:
  %ret = alloca i32, align 4
  %bzerr_dummy = alloca i32, align 4
  %nbytes_in = alloca %struct.UInt64, align 1
  ...
  %buf_nin = alloca [32 x i8], align 16
  %canary = alloca i32
  store i32 2109033016, i32* %canary
  %nbytes_in_hi32 = alloca i32, align 4
  store %struct._IO_FILE* %stream, %struct._IO_FILE** %stream.addr, align 8
  store %struct._IO_FILE* %zStream, %struct._IO_FILE** %zStream.addr, align 8
  store i8* null, i8** %bzf, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @copyFileName.31(i8* %to, i8* %from) #0 {
entry:
  %from.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 530230924, i32* %canary
...
entry:
  ...
  %retval = alloca i8, align 1
  %canary = alloca i32
  store i32 1035743974, i32* %canary
  %zStream.addr = alloca %struct._IO_FILE*, align 8
  %bzerr = alloca i32, align 4
  %obuf = alloca [5000 x i8], align 16
  %unusedTmp = alloca i8*, align 8
...
entry:
  ...
  %unusedTmpV = alloca i8*, align 8
  %canary = alloca i32
  store i32 1023796695, i32* %canary
  %stream.addr = alloca %struct._IO_FILE*, align 8
  %zStream.addr = alloca %struct._IO_FILE*, align 8
  %bzerr_dummy = alloca i32, align 4
  %streamNo = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal double @uInt64_to_double.34(%struct.UInt64* %n) #0 {
entry:
  %base = alloca double, align 8
  %canary = alloca i32
  store i32 446974271, i32* %canary
  %i = alloca i32, align 4
  %n.addr = alloca %struct.UInt64*, align 8
  %sum = alloca double, align 8
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
...
entry:
  %srcName.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 2032729146, i32* %canary
  %retVal = alloca i32, align 4
  store i8* %srcName, i8** %srcName.addr, align 8
  %0 = load i8*, i8** %srcName.addr, align 8
  %call = call i32 @stat(i8* %0, %struct.stat* @fileMetaInfo) #8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @mapSuffix.36(i8* %name, i8* %oldSuffix, i8* %newSuffix) #0 {
entry:
  %oldSuffix.addr = alloca i8*, align 8
  %retval = alloca i8, align 1
  %newSuffix.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1322237489, i32* %canary
  %name.addr = alloca i8*, align 8
  store i8* %name, i8** %name.addr, align 8
  store i8* %oldSuffix, i8** %oldSuffix.addr, align 8
  store i8* %newSuffix, i8** %newSuffix.addr, align 8
...
entry:
  ...
  %canary = alloca i32
  store i32 1960028290, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @copyFileName.38(i8* %to, i8* %from) #0 {
entry:
  %canary = alloca i32
  store i32 583961633, i32* %canary
  %to.addr = alloca i8*, align 8
  %from.addr = alloca i8*, align 8
  store i8* %to, i8** %to.addr, align 8
  store i8* %from, i8** %from.addr, align 8
...
entry:
  ...
  %s.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 246050410, i32* %canary
  %retval = alloca i8, align 1
  store i8* %s, i8** %s.addr, align 8
  store i8* %suffix, i8** %suffix.addr, align 8
  %0 = load i8*, i8** %s.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @myfeof.40(%struct._IO_FILE* %f) #0 {
entry:
  %f.addr = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 118005428, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @uInt64_qrm10.41(%struct.UInt64* %n) #0 {
entry:
  %i = alloca i32, align 4
  %tmp = alloca i32, align 4
  %n.addr = alloca %struct.UInt64*, align 8
  %canary = alloca i32
  store i32 1433877364, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @uncompressStream.42(%struct._IO_FILE* %zStream, %struct._IO_FILE* %stream) #0 {
entry:
  %bzf = alloca i8*, align 8
  %ret = alloca i32, align 4
  %zStream.addr = alloca %struct._IO_FILE*, align 8
  ...
  %unusedTmp = alloca i8*, align 8
  %canary = alloca i32
  store i32 1060643958, i32* %canary
  %streamNo = alloca i32, align 4
  %nread = alloca i32, align 4
  store %struct._IO_FILE* %zStream, %struct._IO_FILE** %zStream.addr, align 8
  store %struct._IO_FILE* %stream, %struct._IO_FILE** %stream.addr, align 8
...
entry:
  %rem = alloca i32, align 4
  %canary = alloca i32
  store i32 1019280051, i32* %canary
  %tmp = alloca i32, align 4
  %i = alloca i32, align 4
  %n.addr = alloca %struct.UInt64*, align 8
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct._IO_FILE* @fopen_output_safely.44(i8* %name, i8* %mode) #0 {
entry:
  %fh = alloca i32, align 4
  %canary = alloca i32
  store i32 1130494765, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @fileExists.45(i8* %name) #0 {
entry:
  %name.addr = alloca i8*, align 8
  %tmp = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 329118686, i32* %canary
  %exists = alloca i8, align 1
  store i8* %name, i8** %name.addr, align 8
  %0 = load i8*, i8** %name.addr, align 8
  %call = call %struct._IO_FILE* @fopen(i8* %0, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.66, i64 0, i64 0))
...
; Function Attrs: noinline nounwind optnone uwtable
define internal double @uInt64_to_double.46(%struct.UInt64* %n) #0 {
entry:
  %n.addr = alloca %struct.UInt64*, align 8
  %sum = alloca double, align 8
  %canary = alloca i32
  store i32 50952669, i32* %canary
  %i = alloca i32, align 4
  %base = alloca double, align 8
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
  store double 1.000000e+00, double* %base, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i8* @myMalloc.47(i32 %n) #0 {
entry:
  %canary = alloca i32
  store i32 1405039965, i32* %canary
  %p = alloca i8*, align 8
  %n.addr = alloca i32, align 4
  store i32 %n, i32* %n.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @compressStream.48(%struct._IO_FILE* %stream, %struct._IO_FILE* %zStream) #0 {
entry:
  %bzf = alloca i8*, align 8
  %nbytes_in_lo32 = alloca i32, align 4
  %nIbuf = alloca i32, align 4
  %canary = alloca i32
  store i32 665099831, i32* %canary
  %nbytes_out = alloca %struct.UInt64, align 1
  %bzerr_dummy = alloca i32, align 4
  %zStream.addr = alloca %struct._IO_FILE*, align 8
  %buf_nin = alloca [32 x i8], align 16
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @hasSuffix.49(i8* %s, i8* %suffix) #0 {
entry:
  %s.addr = alloca i8*, align 8
  %suffix.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 237978913, i32* %canary
  %ns = alloca i32, align 4
  %retval = alloca i8, align 1
  %nx = alloca i32, align 4
  store i8* %s, i8** %s.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @uInt64_toAscii.50(i8* %outbuf, %struct.UInt64* %n) #0 {
entry:
  %outbuf.addr = alloca i8*, align 8
  %n_copy = alloca %struct.UInt64, align 1
  %buf = alloca [32 x i8], align 16
  %canary = alloca i32
  store i32 1810402208, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @applySavedMetaInfoToOutputFile.51(i8* %dstName) #0 {
entry:
  %canary = alloca i32
  store i32 1981708457, i32* %canary
  %retVal = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @testf.52(i8* %name) #0 {
entry:
  %inStr = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 220897716, i32* %canary
  %statBuf = alloca %struct.stat, align 8
  %name.addr = alloca i8*, align 8
  %allOK = alloca i8, align 1
  store i8* %name, i8** %name.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i8* @myMalloc.53(i32 %n) #0 {
entry:
  %canary = alloca i32
  store i32 1214372864, i32* %canary
  %n.addr = alloca i32, align 4
  %p = alloca i8*, align 8
  store i32 %n, i32* %n.addr, align 4
  %0 = load i32, i32* %n.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @compressStream.54(%struct._IO_FILE* %stream, %struct._IO_FILE* %zStream) #0 {
entry:
  %ibuf = alloca [5000 x i8], align 16
  %canary = alloca i32
  store i32 671049375, i32* %canary
  %buf_nout = alloca [32 x i8], align 16
  %nbytes_in_hi32 = alloca i32, align 4
  %bzf = alloca i8*, align 8
  %bzerr = alloca i32, align 4
...
entry:
  ...
  %statBuf = alloca %struct.stat, align 8
  %canary = alloca i32
  store i32 1550339851, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @countHardLinks.56(i8* %name) #0 {
entry:
  %statBuf = alloca %struct.stat, align 8
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1316443622, i32* %canary
  %i = alloca i32, align 4
  %name.addr = alloca i8*, align 8
  store i8* %name, i8** %name.addr, align 8
  %0 = load i8*, i8** %name.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @uInt64_isZero.57(%struct.UInt64* %n) #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1031425535, i32* %canary
  %retval = alloca i8, align 1
  %n.addr = alloca %struct.UInt64*, align 8
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
  store i32 0, i32* %i, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @uInt64_isZero.58(%struct.UInt64* %n) #0 {
entry:
  %canary = alloca i32
  store i32 1962615239, i32* %canary
  %retval = alloca i8, align 1
  %i = alloca i32, align 4
  %n.addr = alloca %struct.UInt64*, align 8
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @fileExists.59(i8* %name) #0 {
entry:
  %tmp = alloca %struct._IO_FILE*, align 8
  %exists = alloca i8, align 1
  %canary = alloca i32
  store i32 265354132, i32* %canary
  %name.addr = alloca i8*, align 8
  store i8* %name, i8** %name.addr, align 8
  %0 = load i8*, i8** %name.addr, align 8
  %call = call %struct._IO_FILE* @fopen(i8* %0, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.66, i64 0, i64 0))
...
; Function Attrs: noinline nounwind optnone uwtable
define internal %struct.zzzz* @snocString.60(%struct.zzzz* %root, i8* %name) #0 {
entry:
  %name.addr = alloca i8*, align 8
  %tmp6 = alloca %struct.zzzz*, align 8
  %canary = alloca i32
  store i32 1582616706, i32* %canary
  %retval = alloca %struct.zzzz*, align 8
  %root.addr = alloca %struct.zzzz*, align 8
  %tmp = alloca %struct.zzzz*, align 8
  store %struct.zzzz* %root, %struct.zzzz** %root.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal double @uInt64_to_double.61(%struct.UInt64* %n) #0 {
entry:
  %canary = alloca i32
  store i32 1047014206, i32* %canary
  %sum = alloca double, align 8
  %base = alloca double, align 8
  %i = alloca i32, align 4
  %n.addr = alloca %struct.UInt64*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @testf.62(i8* %name) #0 {
entry:
  %canary = alloca i32
  store i32 849625825, i32* %canary
  %inStr = alloca %struct._IO_FILE*, align 8
  %allOK = alloca i8, align 1
  %name.addr = alloca i8*, align 8
  %statBuf = alloca %struct.stat, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @hasSuffix.63(i8* %s, i8* %suffix) #0 {
entry:
  %canary = alloca i32
  store i32 1909169163, i32* %canary
  %s.addr = alloca i8*, align 8
  %ns = alloca i32, align 4
  %suffix.addr = alloca i8*, align 8
  %nx = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal %struct.zzzz* @snocString.64(%struct.zzzz* %root, i8* %name) #0 {
entry:
  %root.addr = alloca %struct.zzzz*, align 8
  %canary = alloca i32
  store i32 689795227, i32* %canary
  %tmp6 = alloca %struct.zzzz*, align 8
  %name.addr = alloca i8*, align 8
  %retval = alloca %struct.zzzz*, align 8
  %tmp = alloca %struct.zzzz*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @compress.65(i8* %name) #0 {
entry:
  %i = alloca i32, align 4
  %outStr = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 1752585489, i32* %canary
  %n = alloca i32, align 4
  %inStr = alloca %struct._IO_FILE*, align 8
  %name.addr = alloca i8*, align 8
  %statBuf = alloca %struct.stat, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @applySavedMetaInfoToOutputFile.66(i8* %dstName) #0 {
entry:
  %uTimBuf = alloca %struct.utimbuf, align 8
  %canary = alloca i32
  store i32 2063948603, i32* %canary
  %dstName.addr = alloca i8*, align 8
  %retVal = alloca i32, align 4
  store i8* %dstName, i8** %dstName.addr, align 8
  %0 = load i64, i64* getelementptr inbounds (%struct.stat, %struct.stat* @fileMetaInfo, i32 0, i32 11, i32 0), align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal %struct.zzzz* @snocString.67(%struct.zzzz* %root, i8* %name) #0 {
entry:
  %tmp = alloca %struct.zzzz*, align 8
  %canary = alloca i32
  store i32 361918693, i32* %canary
  %root.addr = alloca %struct.zzzz*, align 8
  %name.addr = alloca i8*, align 8
  %retval = alloca %struct.zzzz*, align 8
  %tmp6 = alloca %struct.zzzz*, align 8
...
; Function Attrs: noinline noreturn nounwind optnone uwtable
define internal void @cleanUpAndFail.68(i32 %ec) #5 {
entry:
  %canary = alloca i32
  store i32 2083904220, i32* %canary
  %statBuf = alloca %struct.stat, align 8
  %retVal = alloca i32, align 4
  %ec.addr = alloca i32, align 4
  store i32 %ec, i32* %ec.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct._IO_FILE* @fopen_output_safely.69(i8* %name, i8* %mode) #0 {
entry:
  %fh = alloca i32, align 4
  %fp = alloca %struct._IO_FILE*, align 8
  %name.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1378937539, i32* %canary
  %retval = alloca %struct._IO_FILE*, align 8
  %mode.addr = alloca i8*, align 8
  store i8* %name, i8** %name.addr, align 8
  store i8* %mode, i8** %mode.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @testStream.70(%struct._IO_FILE* %zStream) #0 {
entry:
  %bzerr = alloca i32, align 4
  %nread = alloca i32, align 4
  %obuf = alloca [5000 x i8], align 16
  ...
  %unusedTmp = alloca i8*, align 8
  %canary = alloca i32
  store i32 918997331, i32* %canary
  %retval = alloca i8, align 1
  %streamNo = alloca i32, align 4
  store %struct._IO_FILE* %zStream, %struct._IO_FILE** %zStream.addr, align 8
  store i8* null, i8** %bzf, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @notAStandardFile.71(i8* %name) #0 {
entry:
  %canary = alloca i32
  store i32 1425908029, i32* %canary
  %i = alloca i32, align 4
  %name.addr = alloca i8*, align 8
  %retval = alloca i8, align 1
  %statBuf = alloca %struct.stat, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @uInt64_isZero.72(%struct.UInt64* %n) #0 {
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 94052417, i32* %canary
  %n.addr = alloca %struct.UInt64*, align 8
  %retval = alloca i8, align 1
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
  store i32 0, i32* %i, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @myfeof.73(%struct._IO_FILE* %f) #0 {
entry:
  %retval = alloca i8, align 1
  %f.addr = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 1760149120, i32* %canary
  %c = alloca i32, align 4
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** %f.addr, align 8
  %call = call i32 @fgetc(%struct._IO_FILE* %0)
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @compress.74(i8* %name) #0 {
entry:
  %retVal = alloca i32, align 4
  %statBuf = alloca %struct.stat, align 8
  %canary = alloca i32
  store i32 167117088, i32* %canary
  %n = alloca i32, align 4
  %i = alloca i32, align 4
  %name.addr = alloca i8*, align 8
  %inStr = alloca %struct._IO_FILE*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @notAStandardFile.75(i8* %name) #0 {
entry:
  %retval = alloca i8, align 1
  %canary = alloca i32
  store i32 701407362, i32* %canary
  %i = alloca i32, align 4
  %statBuf = alloca %struct.stat, align 8
  %name.addr = alloca i8*, align 8
  store i8* %name, i8** %name.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @uInt64_toAscii.76(i8* %outbuf, %struct.UInt64* %n) #0 {
entry:
  %canary = alloca i32
  store i32 1476303002, i32* %canary
  %n_copy = alloca %struct.UInt64, align 1
  %buf = alloca [32 x i8], align 16
  %i = alloca i32, align 4
  %nBuf = alloca i32, align 4
...
entry:
  ...
  %retVal = alloca i32, align 4
  %canary = alloca i32
  store i32 1438822015, i32* %canary
  %statBuf = alloca %struct.stat, align 8
  store i32 %ec, i32* %ec.addr, align 4
  %0 = load i32, i32* @srcMode, align 4
  %cmp = icmp eq i32 %0, 3
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @uncompress.78(i8* %name) #0 {
entry:
  %retVal = alloca i32, align 4
  %n = alloca i32, align 4
  %i = alloca i32, align 4
  ...
  %statBuf = alloca %struct.stat, align 8
  %canary = alloca i32
  store i32 1097258866, i32* %canary
  %retVal168 = alloca i32, align 4
  %cantGuess = alloca i8, align 1
  %magicNumberOK = alloca i8, align 1
  store i8* %name, i8** %name.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @uInt64_toAscii.79(i8* %outbuf, %struct.UInt64* %n) #0 {
entry:
  %buf = alloca [32 x i8], align 16
  %n.addr = alloca %struct.UInt64*, align 8
  %i = alloca i32, align 4
  %q = alloca i32, align 4
  %canary = alloca i32
  store i32 1830308149, i32* %canary
  %n_copy = alloca %struct.UInt64, align 1
  %outbuf.addr = alloca i8*, align 8
  %nBuf = alloca i32, align 4
  store i8* %outbuf, i8** %outbuf.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @uInt64_from_UInt32s.80(%struct.UInt64* %n, i32 %lo32, i32 %hi32) #0 {
entry:
  %lo32.addr = alloca i32, align 4
  %hi32.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 260546283, i32* %canary
  %n.addr = alloca %struct.UInt64*, align 8
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
  store i32 %lo32, i32* %lo32.addr, align 4
  store i32 %hi32, i32* %hi32.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct._IO_FILE* @fopen_output_safely.81(i8* %name, i8* %mode) #0 {
entry:
  %fh = alloca i32, align 4
  %name.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1026862696, i32* %canary
  %retval = alloca %struct._IO_FILE*, align 8
  %fp = alloca %struct._IO_FILE*, align 8
  %mode.addr = alloca i8*, align 8
  store i8* %name, i8** %name.addr, align 8
...
; Function Attrs: noinline noreturn nounwind optnone uwtable
define internal void @cleanUpAndFail.82(i32 %ec) #5 {
entry:
  %statBuf = alloca %struct.stat, align 8
  %ec.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1523120153, i32* %canary
  %retVal = alloca i32, align 4
  store i32 %ec, i32* %ec.addr, align 4
  %0 = load i32, i32* @srcMode, align 4
  %cmp = icmp eq i32 %0, 3
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @uInt64_from_UInt32s.83(%struct.UInt64* %n, i32 %lo32, i32 %hi32) #0 {
entry:
  %n.addr = alloca %struct.UInt64*, align 8
  %canary = alloca i32
  store i32 836831492, i32* %canary
  %lo32.addr = alloca i32, align 4
  %hi32.addr = alloca i32, align 4
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
  store i32 %lo32, i32* %lo32.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @uncompress.84(i8* %name) #0 {
entry:
  %canary = alloca i32
  store i32 354571462, i32* %canary
  %n = alloca i32, align 4
  %i = alloca i32, align 4
  %name.addr = alloca i8*, align 8
  %outStr = alloca %struct._IO_FILE*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @myfeof.85(%struct._IO_FILE* %f) #0 {
entry:
  %f.addr = alloca %struct._IO_FILE*, align 8
  %canary = alloca i32
  store i32 468315081, i32* %canary
  %retval = alloca i8, align 1
  %c = alloca i32, align 4
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** %f.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct._IO_FILE* @fopen_output_safely.86(i8* %name, i8* %mode) #0 {
entry:
  %name.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 822533034, i32* %canary
  %fh = alloca i32, align 4
  %retval = alloca %struct._IO_FILE*, align 8
  %fp = alloca %struct._IO_FILE*, align 8
  %mode.addr = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @notAStandardFile.87(i8* %name) #0 {
entry:
  %retval = alloca i8, align 1
  %name.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 660213649, i32* %canary
  %statBuf = alloca %struct.stat, align 8
  %i = alloca i32, align 4
  store i8* %name, i8** %name.addr, align 8
  %0 = load i8*, i8** %name.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @uInt64_toAscii.88(i8* %outbuf, %struct.UInt64* %n) #0 {
entry:
  %i = alloca i32, align 4
  %buf = alloca [32 x i8], align 16
  %nBuf = alloca i32, align 4
  ...
  %q = alloca i32, align 4
  %canary = alloca i32
  store i32 296914973, i32* %canary
  %n_copy = alloca %struct.UInt64, align 1
  store i8* %outbuf, i8** %outbuf.addr, align 8
  store %struct.UInt64* %n, %struct.UInt64** %n.addr, align 8
  store i32 0, i32* %nBuf, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @notAStandardFile.89(i8* %name) #0 {
entry:
  %statBuf = alloca %struct.stat, align 8
  %canary = alloca i32
  store i32 881363837, i32* %canary
  %i = alloca i32, align 4
  %name.addr = alloca i8*, align 8
  %retval = alloca i8, align 1
  store i8* %name, i8** %name.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @uInt64_qrm10.90(%struct.UInt64* %n) #0 {
entry:
  %canary = alloca i32
  store i32 179038528, i32* %canary
  %n.addr = alloca %struct.UInt64*, align 8
  %rem = alloca i32, align 4
  %tmp = alloca i32, align 4
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @applySavedMetaInfoToOutputFile.91(i8* %dstName) #0 {
entry:
  %dstName.addr = alloca i8*, align 8
  %uTimBuf = alloca %struct.utimbuf, align 8
  %canary = alloca i32
  store i32 859827198, i32* %canary
  %retVal = alloca i32, align 4
  store i8* %dstName, i8** %dstName.addr, align 8
  %0 = load i64, i64* getelementptr inbounds (%struct.stat, %struct.stat* @fileMetaInfo, i32 0, i32 11, i32 0), align 8
  %actime = getelementptr inbounds %struct.utimbuf, %struct.utimbuf* %uTimBuf, i32 0, i32 0
...
entry:
  %name.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1932890951, i32* %canary
  %retVal = alloca i32, align 4
  %magicNumberOK = alloca i8, align 1
  %cantGuess = alloca i8, align 1
  %n = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @compress.93(i8* %name) #0 {
entry:
  %outStr = alloca %struct._IO_FILE*, align 8
  %n = alloca i32, align 4
  %canary = alloca i32
  store i32 1006798252, i32* %canary
  %name.addr = alloca i8*, align 8
  %statBuf = alloca %struct.stat, align 8
  %inStr = alloca %struct._IO_FILE*, align 8
  %i = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @uInt64_qrm10.94(%struct.UInt64* %n) #0 {
entry:
  %canary = alloca i32
  store i32 626262600, i32* %canary
  %rem = alloca i32, align 4
  %n.addr = alloca %struct.UInt64*, align 8
  %i = alloca i32, align 4
  %tmp = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @applySavedMetaInfoToOutputFile.95(i8* %dstName) #0 {
entry:
  %dstName.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1461663359, i32* %canary
  %retVal = alloca i32, align 4
  %uTimBuf = alloca %struct.utimbuf, align 8
  store i8* %dstName, i8** %dstName.addr, align 8
  %0 = load i64, i64* getelementptr inbounds (%struct.stat, %struct.stat* @fileMetaInfo, i32 0, i32 11, i32 0), align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @myfeof.96(%struct._IO_FILE* %f) #0 {
entry:
  %canary = alloca i32
  store i32 44771786, i32* %canary
  %retval = alloca i8, align 1
  %c = alloca i32, align 4
  %f.addr = alloca %struct._IO_FILE*, align 8
  store %struct._IO_FILE* %f, %struct._IO_FILE** %f.addr, align 8
