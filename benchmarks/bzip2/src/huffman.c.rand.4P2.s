...
.LBB0_3:                                # %func_BZ2_hbMakeCodeLengths.4
	...
	.cfi_def_cfa %rsp, 8
	retq
.LBB0_4:                                # %func_BZ2_hbMakeCodeLengths.6
	.cfi_def_cfa %rbp, 16
	movq	%rbx, %rdi
	movq	%r12, %rsi
	movl	%r15d, %edx
...
# %bb.1:                                # %func_BZ2_hbCreateDecodeTables.7
	...
	.cfi_def_cfa %rsp, 8
	retq
.LBB2_2:                                # %func_BZ2_hbCreateDecodeTables.9
	.cfi_def_cfa %rbp, 16
	movq	%r15, %rdi
	movq	%r14, %rsi
	movq	%rbx, %rdx
	...
	.cfi_def_cfa %rsp, 8
	retq
.LBB2_3:                                # %func_BZ2_hbCreateDecodeTables.10
	.cfi_def_cfa %rbp, 16
	movl	%eax, (%rsp)
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$48, %rsp
	movl	$98261704, -24(%rbp)    # imm = 0x5DB5AC8
	movq	%rdi, -48(%rbp)
	movq	%rsi, -40(%rbp)
	movl	%edx, -16(%rbp)
	movl	%ecx, -20(%rbp)
...
# %bb.9:                                # %for.inc9
	...
	jmp	.LBB3_1
.LBB3_10:                               # %for.end11
	cmpl	$98261704, -24(%rbp)    # imm = 0x5DB5AC8
	jne	.LBB3_12
.LBB3_11:
	addq	$48, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	movl	$1984072776, -80(%rbp)  # imm = 0x76428C48
	movq	%rdi, -104(%rbp)
	movq	%rsi, -96(%rbp)
	movl	%edx, -48(%rbp)
	movl	%ecx, -84(%rbp)
...
.LBB4_62:                               # %while.end234
	cmpl	$1984072776, -80(%rbp)  # imm = 0x76428C48
	jne	.LBB4_64
.LBB4_63:
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$5280, %rsp             # imm = 0x14A0
	movl	$293229888, -80(%rbp)   # imm = 0x117A5540
	movq	%rdi, -104(%rbp)
	movq	%rsi, -96(%rbp)
	movl	%edx, -44(%rbp)
	movl	%ecx, -84(%rbp)
...
.LBB5_62:                               # %while.end234
	cmpl	$293229888, -80(%rbp)   # imm = 0x117A5540
	jne	.LBB5_64
.LBB5_63:
	addq	$5280, %rsp             # imm = 0x14A0
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$5280, %rsp             # imm = 0x14A0
	movl	$1278960704, -84(%rbp)  # imm = 0x4C3B6440
	movq	%rdi, -104(%rbp)
	movq	%rsi, -96(%rbp)
	movl	%edx, -48(%rbp)
	movl	%ecx, -80(%rbp)
...
.LBB6_62:                               # %while.end234
	cmpl	$1278960704, -84(%rbp)  # imm = 0x4C3B6440
	jne	.LBB6_64
.LBB6_63:
	addq	$5280, %rsp             # imm = 0x14A0
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$48, %rsp
	movl	$235776577, -24(%rbp)   # imm = 0xE0DAA41
	movq	%rdi, -48(%rbp)
	movq	%rsi, -40(%rbp)
	movl	%edx, -16(%rbp)
	movl	%ecx, -28(%rbp)
...
# %bb.9:                                # %for.inc9
	...
	jmp	.LBB7_1
.LBB7_10:                               # %for.end11
	cmpl	$235776577, -24(%rbp)   # imm = 0xE0DAA41
	jne	.LBB7_12
.LBB7_11:
	addq	$48, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$5280, %rsp             # imm = 0x14A0
	movl	$1662405800, -80(%rbp)  # imm = 0x63164CA8
	movq	%rdi, -104(%rbp)
	movq	%rsi, -96(%rbp)
	movl	%edx, -40(%rbp)
	movl	%ecx, -84(%rbp)
...
.LBB8_62:                               # %while.end234
	cmpl	$1662405800, -80(%rbp)  # imm = 0x63164CA8
	jne	.LBB8_64
.LBB8_63:
	addq	$5280, %rsp             # imm = 0x14A0
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	subq	$80, %rsp
	movl	16(%rbp), %eax
	movl	$648878834, -52(%rbp)   # imm = 0x26AD1AF2
	movq	%rdi, -48(%rbp)
	movq	%rsi, -24(%rbp)
	movq	%rdx, -72(%rbp)
	movq	%rcx, -64(%rbp)
...
# %bb.33:                               # %for.inc87
	...
	jmp	.LBB9_31
.LBB9_34:                               # %for.end89
	cmpl	$648878834, -52(%rbp)   # imm = 0x26AD1AF2
	jne	.LBB9_36
.LBB9_35:
	addq	$80, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$48, %rsp
	movl	$466443112, -20(%rbp)   # imm = 0x1BCD5B68
	movq	%rdi, -48(%rbp)
	movq	%rsi, -40(%rbp)
	movl	%edx, -16(%rbp)
	movl	%ecx, -28(%rbp)
...
# %bb.9:                                # %for.inc9
	...
	jmp	.LBB10_1
.LBB10_10:                              # %for.end11
	cmpl	$466443112, -20(%rbp)   # imm = 0x1BCD5B68
	jne	.LBB10_12
.LBB10_11:
	addq	$48, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	subq	$80, %rsp
	movl	16(%rbp), %eax
	movl	$1220902399, -52(%rbp)  # imm = 0x48C57DFF
	movq	%rdi, -48(%rbp)
	movq	%rsi, -24(%rbp)
	movq	%rdx, -72(%rbp)
	movq	%rcx, -64(%rbp)
...
# %bb.33:                               # %for.inc87
	...
	jmp	.LBB11_31
.LBB11_34:                              # %for.end89
	cmpl	$1220902399, -52(%rbp)  # imm = 0x48C57DFF
	jne	.LBB11_36
.LBB11_35:
	addq	$80, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	subq	$80, %rsp
	movl	16(%rbp), %eax
	movl	$335155605, -52(%rbp)   # imm = 0x13FA1195
	movq	%rdi, -48(%rbp)
	movq	%rsi, -24(%rbp)
	movq	%rdx, -72(%rbp)
	movq	%rcx, -64(%rbp)
...
# %bb.33:                               # %for.inc87
	...
	jmp	.LBB12_31
.LBB12_34:                              # %for.end89
	cmpl	$335155605, -52(%rbp)   # imm = 0x13FA1195
	jne	.LBB12_36
.LBB12_35:
	addq	$80, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	subq	$80, %rsp
	movl	16(%rbp), %eax
	movl	$948432438, -52(%rbp)   # imm = 0x3887EE36
	movq	%rdi, -48(%rbp)
	movq	%rsi, -24(%rbp)
	movq	%rdx, -72(%rbp)
	movq	%rcx, -64(%rbp)
...
# %bb.33:                               # %for.inc87
	...
	jmp	.LBB13_31
.LBB13_34:                              # %for.end89
	cmpl	$948432438, -52(%rbp)   # imm = 0x3887EE36
	jne	.LBB13_36
.LBB13_35:
	addq	$80, %rsp
	popq	%rbp
...
# %bb.0:                                # %entry
	...
	.cfi_def_cfa_register %rbp
	subq	$48, %rsp
	movl	$1754606789, -24(%rbp)  # imm = 0x68952CC5
	movq	%rdi, -40(%rbp)
	movq	%rsi, -48(%rbp)
	movl	%edx, -20(%rbp)
	movl	%ecx, -28(%rbp)
...
# %bb.9:                                # %for.inc9
	...
	jmp	.LBB14_1
.LBB14_10:                              # %for.end11
	cmpl	$1754606789, -24(%rbp)  # imm = 0x68952CC5
	jne	.LBB14_12
.LBB14_11:
	addq	$48, %rsp
	popq	%rbp
