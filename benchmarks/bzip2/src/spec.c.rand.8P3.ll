...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_ran.15, label %ctrl0

func_ran.15:                                      ; preds = %rand_bb
  %2 = call double @ran.15()
  ret double %2

func_ran.43:                                      ; preds = %ctrl0
  %3 = call double @ran.43()
  ret double %3

func_ran.52:                                      ; preds = %ctrl1
  %4 = call double @ran.52()
  ret double %4

func_ran.62:                                      ; preds = %ctrl2
  %5 = call double @ran.62()
  ret double %5

func_ran.71:                                      ; preds = %ctrl3
  %6 = call double @ran.71()
  ret double %6

func_ran.72:                                      ; preds = %ctrl3
  %7 = call double @ran.72()
  ret double %7

ctrl0:                                            ; preds = %rand_bb
  %8 = icmp eq i32 %0, 1
  br i1 %8, label %func_ran.43, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %9 = icmp eq i32 %0, 2
  br i1 %9, label %func_ran.52, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %10 = icmp eq i32 %0, 3
  br i1 %10, label %func_ran.62, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %11 = icmp eq i32 %0, 4
  br i1 %11, label %func_ran.71, label %func_ran.72
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_spec_init.8, label %ctrl0

func_spec_init.8:                                 ; preds = %rand_bb
  %2 = call i32 @spec_init.8()
  ret i32 %2
...
func_spec_init.26:                                ; preds = %ctrl1
  %4 = call i32 @spec_init.26()
  ret i32 %4

func_spec_init.34:                                ; preds = %ctrl2
  %5 = call i32 @spec_init.34()
  ret i32 %5

func_spec_init.36:                                ; preds = %ctrl3
  %6 = call i32 @spec_init.36()
  ret i32 %6

func_spec_init.48:                                ; preds = %ctrl3
  %7 = call i32 @spec_init.48()
  ret i32 %7
...
ctrl1:                                            ; preds = %ctrl0
  %9 = icmp eq i32 %0, 2
  br i1 %9, label %func_spec_init.26, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %10 = icmp eq i32 %0, 3
  br i1 %10, label %func_spec_init.34, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %11 = icmp eq i32 %0, 4
  br i1 %11, label %func_spec_init.36, label %func_spec_init.48
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_spec_random_load.27, label %ctrl0

func_spec_random_load.27:                         ; preds = %rand_bb
  %2 = call i32 @spec_random_load.27(i32 %fd)
  ret i32 %2

func_spec_random_load.32:                         ; preds = %ctrl0
  %3 = call i32 @spec_random_load.32(i32 %fd)
  ret i32 %3
...
func_spec_random_load.44:                         ; preds = %ctrl2
  %5 = call i32 @spec_random_load.44(i32 %fd)
  ret i32 %5

func_spec_random_load.46:                         ; preds = %ctrl3
  %6 = call i32 @spec_random_load.46(i32 %fd)
  ret i32 %6
...
func_spec_random_load.70:                         ; preds = %ctrl5
  %9 = call i32 @spec_random_load.70(i32 %fd)
  ret i32 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_spec_random_load.32, label %ctrl1
...
ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_spec_random_load.44, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_spec_random_load.46, label %ctrl4
...
ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_spec_random_load.61, label %func_spec_random_load.70
}
...
func_spec_load.16:                                ; preds = %ctrl0
  %3 = call i32 @spec_load.16(i32 %num, i8* %filename, i32 %size)
  ret i32 %3

func_spec_load.42:                                ; preds = %ctrl1
  %4 = call i32 @spec_load.42(i32 %num, i8* %filename, i32 %size)
  ret i32 %4

func_spec_load.47:                                ; preds = %ctrl2
  %5 = call i32 @spec_load.47(i32 %num, i8* %filename, i32 %size)
  ret i32 %5

func_spec_load.53:                                ; preds = %ctrl3
  %6 = call i32 @spec_load.53(i32 %num, i8* %filename, i32 %size)
  ret i32 %6
...
func_spec_load.56:                                ; preds = %ctrl5
  %8 = call i32 @spec_load.56(i32 %num, i8* %filename, i32 %size)
  ret i32 %8

func_spec_load.60:                                ; preds = %ctrl5
  %9 = call i32 @spec_load.60(i32 %num, i8* %filename, i32 %size)
  ret i32 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_spec_load.16, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_spec_load.42, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_spec_load.47, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_spec_load.53, label %ctrl4
...
ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_spec_load.56, label %func_spec_load.60
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_spec_read.20, label %ctrl0

func_spec_read.20:                                ; preds = %rand_bb
  %2 = call i32 @spec_read.20(i32 %fd, i8* %buf, i32 %size)
  ret i32 %2

func_spec_read.28:                                ; preds = %ctrl0
  %3 = call i32 @spec_read.28(i32 %fd, i8* %buf, i32 %size)
  ret i32 %3
...
func_spec_read.40:                                ; preds = %ctrl3
  %6 = call i32 @spec_read.40(i32 %fd, i8* %buf, i32 %size)
  ret i32 %6

func_spec_read.64:                                ; preds = %ctrl4
  %7 = call i32 @spec_read.64(i32 %fd, i8* %buf, i32 %size)
  ret i32 %7

func_spec_read.66:                                ; preds = %ctrl5
  %8 = call i32 @spec_read.66(i32 %fd, i8* %buf, i32 %size)
  ret i32 %8
...
ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_spec_read.28, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_spec_read.29, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_spec_read.33, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_spec_read.40, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_spec_read.64, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_spec_read.66, label %func_spec_read.69
}
...
func_spec_fread.19:                               ; preds = %ctrl1
  %4 = call i32 @spec_fread.19(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %4

func_spec_fread.39:                               ; preds = %ctrl2
  %5 = call i32 @spec_fread.39(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %5
...
func_spec_fread.63:                               ; preds = %ctrl4
  %7 = call i32 @spec_fread.63(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %7

func_spec_fread.65:                               ; preds = %ctrl5
  %8 = call i32 @spec_fread.65(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %8

func_spec_fread.68:                               ; preds = %ctrl5
  %9 = call i32 @spec_fread.68(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %9

ctrl0:                                            ; preds = %rand_bb
  %10 = icmp eq i32 %0, 1
  br i1 %10, label %func_spec_fread.13, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_spec_fread.19, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_spec_fread.39, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_spec_fread.41, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_spec_fread.63, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_spec_fread.65, label %func_spec_fread.68
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_spec_getc.12, label %ctrl0

func_spec_getc.12:                                ; preds = %rand_bb
  %2 = call i32 @spec_getc.12(i32 %fd)
  ret i32 %2

func_spec_getc.17:                                ; preds = %ctrl0
  %3 = call i32 @spec_getc.17(i32 %fd)
  ret i32 %3

func_spec_getc.22:                                ; preds = %ctrl1
  %4 = call i32 @spec_getc.22(i32 %fd)
  ret i32 %4

func_spec_getc.23:                                ; preds = %ctrl2
  %5 = call i32 @spec_getc.23(i32 %fd)
  ret i32 %5

func_spec_getc.45:                                ; preds = %ctrl3
  %6 = call i32 @spec_getc.45(i32 %fd)
  ret i32 %6
...
ctrl0:                                            ; preds = %rand_bb
  %8 = icmp eq i32 %0, 1
  br i1 %8, label %func_spec_getc.17, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %9 = icmp eq i32 %0, 2
  br i1 %9, label %func_spec_getc.22, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %10 = icmp eq i32 %0, 3
  br i1 %10, label %func_spec_getc.23, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %11 = icmp eq i32 %0, 4
  br i1 %11, label %func_spec_getc.45, label %func_spec_getc.57
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_spec_ungetc.2, label %ctrl0

func_spec_ungetc.2:                               ; preds = %rand_bb
  %2 = call i32 @spec_ungetc.2(i8 %ch, i32 %fd)
  ret i32 %2

func_spec_ungetc.4:                               ; preds = %ctrl0
  %3 = call i32 @spec_ungetc.4(i8 %ch, i32 %fd)
  ret i32 %3
...
func_spec_ungetc.30:                              ; preds = %ctrl2
  %5 = call i32 @spec_ungetc.30(i8 %ch, i32 %fd)
  ret i32 %5
...
func_spec_ungetc.49:                              ; preds = %ctrl3
  %7 = call i32 @spec_ungetc.49(i8 %ch, i32 %fd)
  ret i32 %7

ctrl0:                                            ; preds = %rand_bb
  %8 = icmp eq i32 %0, 1
  br i1 %8, label %func_spec_ungetc.4, label %ctrl1
...
ctrl2:                                            ; preds = %ctrl1
  %10 = icmp eq i32 %0, 3
  br i1 %10, label %func_spec_ungetc.30, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %11 = icmp eq i32 %0, 4
  br i1 %11, label %func_spec_ungetc.38, label %func_spec_ungetc.49
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_spec_write.3, label %ctrl0

func_spec_write.3:                                ; preds = %rand_bb
  %2 = call i32 @spec_write.3(i32 %fd, i8* %buf, i32 %size)
  ret i32 %2
...
func_spec_write.7:                                ; preds = %ctrl1
  %4 = call i32 @spec_write.7(i32 %fd, i8* %buf, i32 %size)
  ret i32 %4

func_spec_write.10:                               ; preds = %ctrl2
  %5 = call i32 @spec_write.10(i32 %fd, i8* %buf, i32 %size)
  ret i32 %5

func_spec_write.24:                               ; preds = %ctrl3
  %6 = call i32 @spec_write.24(i32 %fd, i8* %buf, i32 %size)
  ret i32 %6

func_spec_write.35:                               ; preds = %ctrl3
  %7 = call i32 @spec_write.35(i32 %fd, i8* %buf, i32 %size)
  ret i32 %7
...
ctrl1:                                            ; preds = %ctrl0
  %9 = icmp eq i32 %0, 2
  br i1 %9, label %func_spec_write.7, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %10 = icmp eq i32 %0, 3
  br i1 %10, label %func_spec_write.10, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %11 = icmp eq i32 %0, 4
  br i1 %11, label %func_spec_write.24, label %func_spec_write.35
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_spec_fwrite.11, label %ctrl0

func_spec_fwrite.11:                              ; preds = %rand_bb
  %2 = call i32 @spec_fwrite.11(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %2
...
func_spec_fwrite.31:                              ; preds = %ctrl1
  %4 = call i32 @spec_fwrite.31(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %4

func_spec_fwrite.50:                              ; preds = %ctrl2
  %5 = call i32 @spec_fwrite.50(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %5

func_spec_fwrite.51:                              ; preds = %ctrl3
  %6 = call i32 @spec_fwrite.51(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %6

func_spec_fwrite.55:                              ; preds = %ctrl4
  %7 = call i32 @spec_fwrite.55(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %7

func_spec_fwrite.58:                              ; preds = %ctrl5
  %8 = call i32 @spec_fwrite.58(i8* %buf, i32 %size, i32 %num, i32 %fd)
  ret i32 %8

func_spec_fwrite.67:                              ; preds = %ctrl5
...
ctrl1:                                            ; preds = %ctrl0
  %11 = icmp eq i32 %0, 2
  br i1 %11, label %func_spec_fwrite.31, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %12 = icmp eq i32 %0, 3
  br i1 %12, label %func_spec_fwrite.50, label %ctrl3

ctrl3:                                            ; preds = %ctrl2
  %13 = icmp eq i32 %0, 4
  br i1 %13, label %func_spec_fwrite.51, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %14 = icmp eq i32 %0, 5
  br i1 %14, label %func_spec_fwrite.55, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %15 = icmp eq i32 %0, 6
  br i1 %15, label %func_spec_fwrite.58, label %func_spec_fwrite.67
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_spec_putc.1, label %func_spec_putc.18

func_spec_putc.1:                                 ; preds = %rand_bb
  %2 = call i32 @spec_putc.1(i8 %ch, i32 %fd)
  ret i32 %2

func_spec_putc.18:                                ; preds = %rand_bb
  %3 = call i32 @spec_putc.18(i8 %ch, i32 %fd)
  ret i32 %3
}
...
entry:
  %canary = alloca i32
  store i32 279537255, i32* %canary
...
entry:
  ...
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1790674905, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_write.3(i32 %fd, i8* %buf, i32 %size) #0 {
entry:
  %canary = alloca i32
  store i32 1645197652, i32* %canary
...
entry:
  %rc = alloca i32, align 4
  %canary = alloca i32
  store i32 125841948, i32* %canary
  %fd.addr = alloca i32, align 4
  %ch.addr = alloca i8, align 1
  store i8 %ch, i8* %ch.addr, align 1
  store i32 %fd, i32* %fd.addr, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 268412881, i32* %canary
  %fd.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %size.addr = alloca i32, align 4
  %rc = alloca i32, align 4
...
entry:
  %buf.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1164502937, i32* %canary
  %fd.addr = alloca i32, align 4
  %size.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  store i8* %buf, i8** %buf.addr, align 8
...
entry:
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1663036516, i32* %canary
  %size.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  store i32 %fd, i32* %fd.addr, align 4
  store i8* %buf, i8** %buf.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_init.8() #0 {
entry:
  %j = alloca i32, align 4
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1449208454, i32* %canary
...
entry:
  ...
  %size.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 650378386, i32* %canary
  %rc = alloca i32, align 4
  store i32 %num, i32* %num.addr, align 4
...
entry:
  ...
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1177991371, i32* %canary
  %buf.addr = alloca i8*, align 8
  store i32 %fd, i32* %fd.addr, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_fwrite.11(i8* %buf, i32 %size, i32 %num, i32 %fd) #0 {
entry:
  %size.addr = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2034197244, i32* %canary
  %buf.addr = alloca i8*, align 8
  %num.addr = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_getc.12(i32 %fd) #0 {
entry:
  %canary = alloca i32
  store i32 53668663, i32* %canary
  %fd.addr = alloca i32, align 4
  %rc = alloca i32, align 4
  %retval = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
...
entry:
  ...
  %size.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 682132696, i32* %canary
  %buf.addr = alloca i8*, align 8
  %num.addr = alloca i32, align 4
  %rc = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
...
entry:
  %ch.addr = alloca i8, align 1
  %canary = alloca i32
  store i32 810596429, i32* %canary
  %rc = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  store i8 %ch, i8* %ch.addr, align 1
  store i32 %fd, i32* %fd.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local double @ran.15() #0 {
entry:
  %hi = alloca i64, align 8
  %canary = alloca i32
  store i32 409833758, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_load.16(i32 %num, i8* %filename, i32 %size) #0 {
entry:
  %i = alloca i32, align 4
  %size.addr = alloca i32, align 4
  %num.addr = alloca i32, align 4
  ...
  %filename.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1653519836, i32* %canary
  %fd = alloca i32, align 4
  %rc = alloca i32, align 4
  store i32 %num, i32* %num.addr, align 4
  store i8* %filename, i8** %filename.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1372140328, i32* %canary
  %fd.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  %rc = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_putc.18(i8 zeroext %ch, i32 %fd) #0 {
entry:
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 520694054, i32* %canary
  %ch.addr = alloca i8, align 1
  store i8 %ch, i8* %ch.addr, align 1
  store i32 %fd, i32* %fd.addr, align 4
  %0 = load i32, i32* @dbglvl, align 4
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1814027638, i32* %canary
  %rc = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
  store i32 %num, i32* %num.addr, align 4
...
entry:
  ...
  %rc = alloca i32, align 4
  %canary = alloca i32
  store i32 1426214720, i32* %canary
  %buf.addr = alloca i8*, align 8
  %retval = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 1734881205, i32* %canary
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %limit = alloca i32, align 4
  %0 = load i32, i32* @dbglvl, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_getc.22(i32 %fd) #0 {
entry:
  %canary = alloca i32
  store i32 435208825, i32* %canary
  %retval = alloca i32, align 4
  %rc = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
...
entry:
  %rc = alloca i32, align 4
  %canary = alloca i32
  store i32 1111799419, i32* %canary
  %retval = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  store i32 0, i32* %rc, align 4
...
entry:
  %buf.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 575183905, i32* %canary
  %size.addr = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  store i8* %buf, i8** %buf.addr, align 8
...
entry:
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 624193644, i32* %canary
  %num.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %size.addr = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_init.26() #0 {
entry:
  %canary = alloca i32
  store i32 4278517, i32* %canary
  %limit = alloca i32, align 4
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %0 = load i32, i32* @dbglvl, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_random_load.27(i32 %fd) #0 {
entry:
  %j = alloca i32, align 4
  %i = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2068590772, i32* %canary
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 2031723128, i32* %canary
  %rc = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  %size.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
...
entry:
  ...
  %buf.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1013999755, i32* %canary
  %fd.addr = alloca i32, align 4
  %size.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  store i8* %buf, i8** %buf.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1560195403, i32* %canary
  %rc = alloca i32, align 4
  %ch.addr = alloca i8, align 1
  %fd.addr = alloca i32, align 4
  store i8 %ch, i8* %ch.addr, align 1
...
entry:
  ...
  %num.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1992134513, i32* %canary
  %buf.addr = alloca i8*, align 8
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
  store i32 %num, i32* %num.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_random_load.32(i32 %fd) #0 {
entry:
  %fd.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1180602034, i32* %canary
  %random_text = alloca [32 x [131072 x i8]], align 16
  %j = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  %0 = load i32, i32* @dbglvl, align 4
...
entry:
  ...
  %size.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2114607847, i32* %canary
  %rc = alloca i32, align 4
  %retval = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  store i8* %buf, i8** %buf.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 398549526, i32* %canary
  %j = alloca i32, align 4
  %limit = alloca i32, align 4
  %i = alloca i32, align 4
  %0 = load i32, i32* @dbglvl, align 4
...
entry:
  ...
  %buf.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1783962007, i32* %canary
  %size.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_init.36() #0 {
entry:
  %canary = alloca i32
  store i32 1607096490, i32* %canary
  %limit = alloca i32, align 4
  %j = alloca i32, align 4
  %i = alloca i32, align 4
  %0 = load i32, i32* @dbglvl, align 4
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1143210686, i32* %canary
  %fd.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  %0 = load i32, i32* @dbglvl, align 4
  %cmp = icmp slt i32 4, %0
...
entry:
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1028176523, i32* %canary
  %rc = alloca i32, align 4
  %ch.addr = alloca i8, align 1
  store i8 %ch, i8* %ch.addr, align 1
  store i32 %fd, i32* %fd.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_fread.39(i8* %buf, i32 %size, i32 %num, i32 %fd) #0 {
entry:
  %size.addr = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  ...
  %rc = alloca i32, align 4
  %canary = alloca i32
  store i32 763456031, i32* %canary
  %buf.addr = alloca i8*, align 8
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
  store i32 %num, i32* %num.addr, align 4
...
entry:
  ...
  %retval = alloca i32, align 4
  %canary = alloca i32
  store i32 1870521906, i32* %canary
  %buf.addr = alloca i8*, align 8
  %rc = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
...
entry:
  ...
  %fd.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1314068969, i32* %canary
  %rc = alloca i32, align 4
  %size.addr = alloca i32, align 4
  %num.addr = alloca i32, align 4
  %retval = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_load.42(i32 %num, i8* %filename, i32 %size) #0 {
entry:
  %canary = alloca i32
  store i32 1840166527, i32* %canary
  %fd = alloca i32, align 4
  %filename.addr = alloca i8*, align 8
  %tmp = alloca i32, align 4
  %num.addr = alloca i32, align 4
...
entry:
  ...
  %test = alloca i64, align 8
  %canary = alloca i32
  store i32 1492901831, i32* %canary
  %hi = alloca i64, align 8
  %0 = load i64, i64* @seedi, align 8
  %div = sdiv i64 %0, 127773
  store i64 %div, i64* %hi, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_random_load.44(i32 %fd) #0 {
entry:
  %j = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1820132414, i32* %canary
  %random_text = alloca [32 x [131072 x i8]], align 16
  store i32 %fd, i32* %fd.addr, align 4
  %0 = load i32, i32* @dbglvl, align 4
  %cmp = icmp slt i32 4, %0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_getc.45(i32 %fd) #0 {
entry:
  %canary = alloca i32
  store i32 304510228, i32* %canary
  %rc = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1832247237, i32* %canary
  %i = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  %0 = load i32, i32* @dbglvl, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_load.47(i32 %num, i8* %filename, i32 %size) #0 {
entry:
  %tmp = alloca i32, align 4
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 653309546, i32* %canary
  %filename.addr = alloca i8*, align 8
  %size.addr = alloca i32, align 4
  %fd = alloca i32, align 4
  %rc = alloca i32, align 4
...
entry:
  ...
  %limit = alloca i32, align 4
  %canary = alloca i32
  store i32 136239519, i32* %canary
  %j = alloca i32, align 4
  %0 = load i32, i32* @dbglvl, align 4
  %cmp = icmp slt i32 3, %0
  br i1 %cmp, label %if.then, label %if.end
...
entry:
  ...
  %ch.addr = alloca i8, align 1
  %canary = alloca i32
  store i32 1265504562, i32* %canary
  %rc = alloca i32, align 4
  store i8 %ch, i8* %ch.addr, align 1
  store i32 %fd, i32* %fd.addr, align 4
  store i32 0, i32* %rc, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_fwrite.50(i8* %buf, i32 %size, i32 %num, i32 %fd) #0 {
entry:
  %canary = alloca i32
  store i32 115601398, i32* %canary
  %buf.addr = alloca i8*, align 8
  %num.addr = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  %size.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_fwrite.51(i8* %buf, i32 %size, i32 %num, i32 %fd) #0 {
entry:
  %size.addr = alloca i32, align 4
  %num.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1748522112, i32* %canary
  %fd.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
...
entry:
  %test = alloca i64, align 8
  %canary = alloca i32
  store i32 942907178, i32* %canary
  %lo = alloca i64, align 8
  %hi = alloca i64, align 8
  %0 = load i64, i64* @seedi, align 8
  %div = sdiv i64 %0, 127773
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_load.53(i32 %num, i8* %filename, i32 %size) #0 {
entry:
  %canary = alloca i32
  store i32 1175663036, i32* %canary
  %fd = alloca i32, align 4
  %size.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %num.addr = alloca i32, align 4
...
entry:
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 2121172914, i32* %canary
  %rc = alloca i32, align 4
  %filename.addr = alloca i8*, align 8
  %num.addr = alloca i32, align 4
  %size.addr = alloca i32, align 4
...
entry:
  %num.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 568327709, i32* %canary
  %fd.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %size.addr = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 503343174, i32* %canary
  %rc = alloca i32, align 4
  store i32 %num, i32* %num.addr, align 4
  store i8* %filename, i8** %filename.addr, align 8
  store i32 %size, i32* %size.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 1246605147, i32* %canary
  %retval = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  %rc = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_fwrite.58(i8* %buf, i32 %size, i32 %num, i32 %fd) #0 {
entry:
  %fd.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 549974531, i32* %canary
  %num.addr = alloca i32, align 4
  %size.addr = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
...
entry:
  %canary = alloca i32
  store i32 182223923, i32* %canary
  %j = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  %random_text = alloca [32 x [131072 x i8]], align 16
  %i = alloca i32, align 4
...
entry:
  ...
  %filename.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 698907866, i32* %canary
  %rc = alloca i32, align 4
  %size.addr = alloca i32, align 4
  %tmp = alloca i32, align 4
  store i32 %num, i32* %num.addr, align 4
...
entry:
  ...
  %random_text = alloca [32 x [131072 x i8]], align 16
  %canary = alloca i32
  store i32 1830398691, i32* %canary
  %j = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  %0 = load i32, i32* @dbglvl, align 4
  %cmp = icmp slt i32 4, %0
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local double @ran.62() #0 {
entry:
  %lo = alloca i64, align 8
  %canary = alloca i32
  store i32 191934754, i32* %canary
  %hi = alloca i64, align 8
  %test = alloca i64, align 8
  %0 = load i64, i64* @seedi, align 8
  %div = sdiv i64 %0, 127773
...
entry:
  %canary = alloca i32
  store i32 562282351, i32* %canary
  %fd.addr = alloca i32, align 4
  %retval = alloca i32, align 4
  %size.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
...
entry:
  %num.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1583525701, i32* %canary
  %retval = alloca i32, align 4
  %rc = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  %buf.addr = alloca i8*, align 8
...
entry:
  ...
  %size.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1096842948, i32* %canary
  %rc = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
...
entry:
  ...
  %size.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1421746514, i32* %canary
  %buf.addr = alloca i8*, align 8
  %num.addr = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
...
entry:
  ...
  %num.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1465277423, i32* %canary
  %rc = alloca i32, align 4
  %size.addr = alloca i32, align 4
  store i8* %buf, i8** %buf.addr, align 8
  store i32 %size, i32* %size.addr, align 4
...
entry:
  ...
  %size.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1027306520, i32* %canary
  %rc = alloca i32, align 4
  %retval = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  store i32 %fd, i32* %fd.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @spec_random_load.70(i32 %fd) #0 {
entry:
  %canary = alloca i32
  store i32 630474124, i32* %canary
  %random_text = alloca [32 x [131072 x i8]], align 16
  %j = alloca i32, align 4
  %fd.addr = alloca i32, align 4
  %i = alloca i32, align 4
...
entry:
  %test = alloca i64, align 8
  %canary = alloca i32
  store i32 1246802743, i32* %canary
  %hi = alloca i64, align 8
  %lo = alloca i64, align 8
  %0 = load i64, i64* @seedi, align 8
  %div = sdiv i64 %0, 127773
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local double @ran.72() #0 {
entry:
  %hi = alloca i64, align 8
  %canary = alloca i32
  store i32 991471065, i32* %canary
  %lo = alloca i64, align 8
  %test = alloca i64, align 8
  %0 = load i64, i64* @seedi, align 8
  %div = sdiv i64 %0, 127773
