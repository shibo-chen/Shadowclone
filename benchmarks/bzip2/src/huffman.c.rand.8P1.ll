; ModuleID = 'huffman.c.rand.8P1.bc'
...
func_BZ2_hbMakeCodeLengths.19:                    ; preds = %ctrl5
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_BZ2_hbMakeCodeLengths.2, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_BZ2_hbMakeCodeLengths.3, label %ctrl2

ctrl2:                                            ; preds = %ctrl1
  %4 = icmp eq i32 %0, 3
  br i1 %4, label %func_BZ2_hbMakeCodeLengths.7, label %ctrl3
...
ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_BZ2_hbMakeCodeLengths.19, label %func_BZ2_hbMakeCodeLengths.23
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_BZ2_hbAssignCodes.5, label %ctrl0

func_BZ2_hbAssignCodes.5:                         ; preds = %rand_bb
  call void @BZ2_hbAssignCodes.5(i32* %code, i8* %length, i32 %minLen, i32 %maxLen, i32 %alphaSize)
  ret void

func_BZ2_hbAssignCodes.6:                         ; preds = %ctrl0
...
func_BZ2_hbAssignCodes.18:                        ; preds = %ctrl4
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_BZ2_hbAssignCodes.6, label %ctrl1
...
ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_BZ2_hbAssignCodes.18, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_BZ2_hbAssignCodes.20, label %func_BZ2_hbAssignCodes.24
}
...
rand_bb:
  %0 = call i32 @get_rand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_BZ2_hbCreateDecodeTables.4, label %ctrl0

func_BZ2_hbCreateDecodeTables.4:                  ; preds = %rand_bb
  call void @BZ2_hbCreateDecodeTables.4(i32* %limit, i32* %base, i32* %perm, i8* %length, i32 %minLen, i32 %maxLen, i32 %alphaSize)
  ret void

func_BZ2_hbCreateDecodeTables.11:                 ; preds = %ctrl0
...
ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_BZ2_hbCreateDecodeTables.11, label %ctrl1
...
ctrl3:                                            ; preds = %ctrl2
  %5 = icmp eq i32 %0, 4
  br i1 %5, label %func_BZ2_hbCreateDecodeTables.16, label %ctrl4

ctrl4:                                            ; preds = %ctrl3
  %6 = icmp eq i32 %0, 5
  br i1 %6, label %func_BZ2_hbCreateDecodeTables.17, label %ctrl5

ctrl5:                                            ; preds = %ctrl4
  %7 = icmp eq i32 %0, 6
  br i1 %7, label %func_BZ2_hbCreateDecodeTables.21, label %func_BZ2_hbCreateDecodeTables.22
}
...
entry:
  ...
  %tmp48 = alloca i32, align 4
  %canary = alloca i32
  store i32 796311747, i32* %canary
  %i = alloca i32, align 4
  %zz170 = alloca i32, align 4
  %yy93 = alloca i32, align 4
  %len.addr = alloca i8*, align 8
...
entry:
  ...
  %k = alloca i32, align 4
  %canary = alloca i32
  store i32 1123481270, i32* %canary
  %nNodes = alloca i32, align 4
  %yy = alloca i32, align 4
  %zz = alloca i32, align 4
  %len.addr = alloca i8*, align 8
...
while.end234:                                     ; preds = %if.then218
  %151 = load i32, i32* %canary
  %152 = icmp eq i32 %151, 1123481270
  br i1 %152, label %153, label %func_exit
...
entry:
  ...
  %canary = alloca i32
  store i32 1982834793, i32* %canary
  %i = alloca i32, align 4
...
entry:
  ...
  %minLen.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 2000142932, i32* %canary
  %vec = alloca i32, align 4
  %i = alloca i32, align 4
  %maxLen.addr = alloca i32, align 4
...
entry:
  %alphaSize.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1032521296, i32* %canary
  %minLen.addr = alloca i32, align 4
  %length.addr = alloca i8*, align 8
  %vec = alloca i32, align 4
  %maxLen.addr = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 181494012, i32* %canary
  %zz = alloca i32, align 4
  %i = alloca i32, align 4
  %tmp94 = alloca i32, align 4
  %zz92 = alloca i32, align 4
...
entry:
  ...
  %vec = alloca i32, align 4
  %canary = alloca i32
  store i32 1014338670, i32* %canary
  %code.addr = alloca i32*, align 8
  store i32* %code, i32** %code.addr, align 8
  store i8* %length, i8** %length.addr, align 8
  store i32 %minLen, i32* %minLen.addr, align 4
...
entry:
  ...
  %alphaSize.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 848283379, i32* %canary
  %vec = alloca i32, align 4
  %i = alloca i32, align 4
  %maxLen.addr = alloca i32, align 4
  %code.addr = alloca i32*, align 8
...
entry:
  ...
  %n1 = alloca i32, align 4
  %canary = alloca i32
  store i32 2060954498, i32* %canary
  %zz = alloca i32, align 4
  %heap = alloca [260 x i32], align 16
  %yy = alloca i32, align 4
  %yy93 = alloca i32, align 4
...
while.end234:                                     ; preds = %if.then218
  %151 = load i32, i32* %canary
  %152 = icmp eq i32 %151, 2060954498
  br i1 %152, label %153, label %func_exit
...
entry:
  ...
  %minLen.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 968739825, i32* %canary
  %limit.addr = alloca i32*, align 8
  %j = alloca i32, align 4
  %alphaSize.addr = alloca i32, align 4
  %length.addr = alloca i8*, align 8
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 909652210, i32* %canary
  %perm.addr = alloca i32*, align 8
  %maxLen.addr = alloca i32, align 4
  %limit.addr = alloca i32*, align 8
  %pp = alloca i32, align 4
...
entry:
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 569626663, i32* %canary
  %zz47 = alloca i32, align 4
  %parent = alloca [516 x i32], align 16
  %maxLen.addr = alloca i32, align 4
  %len.addr = alloca i8*, align 8
...
entry:
  %alphaSize.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1379704063, i32* %canary
  %length.addr = alloca i8*, align 8
  %minLen.addr = alloca i32, align 4
  %perm.addr = alloca i32*, align 8
  %i = alloca i32, align 4
...
entry:
  %maxLen.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1296169654, i32* %canary
  %length.addr = alloca i8*, align 8
  %i = alloca i32, align 4
  %vec = alloca i32, align 4
  %alphaSize.addr = alloca i32, align 4
...
entry:
  %canary = alloca i32
  store i32 857000421, i32* %canary
  %base.addr = alloca i32*, align 8
  %limit.addr = alloca i32*, align 8
  %perm.addr = alloca i32*, align 8
  %vec = alloca i32, align 4
...
entry:
  ...
  %minLen.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 325700714, i32* %canary
  %base.addr = alloca i32*, align 8
  %perm.addr = alloca i32*, align 8
  store i32* %limit, i32** %limit.addr, align 8
  store i32* %base, i32** %base.addr, align 8
...
entry:
  %canary = alloca i32
  store i32 1589682999, i32* %canary
  %n = alloca i32, align 4
  %maxLen.addr = alloca i32, align 4
  %alphaSize.addr = alloca i32, align 4
  %minLen.addr = alloca i32, align 4
...
entry:
  ...
  %len.addr = alloca i8*, align 8
  %canary = alloca i32
  store i32 1894517807, i32* %canary
  %tmp171 = alloca i32, align 4
  %yy93 = alloca i32, align 4
  store i8* %len, i8** %len.addr, align 8
  store i32* %freq, i32** %freq.addr, align 8
...
while.end234:                                     ; preds = %if.then218
  %151 = load i32, i32* %canary
  %152 = icmp eq i32 %151, 1894517807
  br i1 %152, label %153, label %func_exit
...
entry:
  ...
  %minLen.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 788484924, i32* %canary
  %maxLen.addr = alloca i32, align 4
  %length.addr = alloca i8*, align 8
  store i32* %code, i32** %code.addr, align 8
  store i8* %length, i8** %length.addr, align 8
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1896583321, i32* %canary
  %perm.addr = alloca i32*, align 8
  %pp = alloca i32, align 4
  %alphaSize.addr = alloca i32, align 4
  %base.addr = alloca i32*, align 8
...
entry:
  %canary = alloca i32
  store i32 799521224, i32* %canary
  %limit.addr = alloca i32*, align 8
  %j = alloca i32, align 4
  %base.addr = alloca i32*, align 8
  %i = alloca i32, align 4
...
entry:
  ...
  %nHeap = alloca i32, align 4
  %canary = alloca i32
  store i32 1807565509, i32* %canary
  %tmp94 = alloca i32, align 4
  %parent = alloca [516 x i32], align 16
  %n1 = alloca i32, align 4
  %j = alloca i32, align 4
...
while.end234:                                     ; preds = %if.then218
  %151 = load i32, i32* %canary
  %152 = icmp eq i32 %151, 1807565509
  br i1 %152, label %153, label %func_exit
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 866617160, i32* %canary
  %maxLen.addr = alloca i32, align 4
  %minLen.addr = alloca i32, align 4
  %alphaSize.addr = alloca i32, align 4
  %n = alloca i32, align 4
