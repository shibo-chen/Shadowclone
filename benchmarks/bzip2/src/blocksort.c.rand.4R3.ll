; ModuleID = 'blocksort.c.rand.4R3.bc'
...
func_BZ2_blockSort.28:                            ; preds = %ctrl1
  call void @BZ2_blockSort.28(%struct.EState* %s)
  ret void

func_BZ2_blockSort.34:                            ; preds = %ctrl1
  call void @BZ2_blockSort.34(%struct.EState* %s)
  ret void
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_BZ2_blockSort.28, label %func_BZ2_blockSort.34
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_fallbackSort.29, label %ctrl0

func_fallbackSort.29:                             ; preds = %rand_bb
  call void @fallbackSort.29(i32* %fmap, i32* %eclass, i32* %bhtab, i32 %nblock, i32 %verb)
  ret void

func_fallbackSort.30:                             ; preds = %ctrl0
  call void @fallbackSort.30(i32* %fmap, i32* %eclass, i32* %bhtab, i32 %nblock, i32 %verb)
  ret void
...
func_fallbackSort.33:                             ; preds = %ctrl1
  call void @fallbackSort.33(i32* %fmap, i32* %eclass, i32* %bhtab, i32 %nblock, i32 %verb)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_fallbackSort.30, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_fallbackSort.31, label %func_fallbackSort.33
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_mainSort.4, label %ctrl0

func_mainSort.4:                                  ; preds = %rand_bb
  call void @mainSort.4(i32* %ptr, i8* %block, i16* %quadrant, i32* %ftab, i32 %nblock, i32 %verb, i32* %budget)
  ret void

func_mainSort.21:                                 ; preds = %ctrl0
  call void @mainSort.21(i32* %ptr, i8* %block, i16* %quadrant, i32* %ftab, i32 %nblock, i32 %verb, i32* %budget)
  ret void

func_mainSort.23:                                 ; preds = %ctrl1
  call void @mainSort.23(i32* %ptr, i8* %block, i16* %quadrant, i32* %ftab, i32 %nblock, i32 %verb, i32* %budget)
  ret void

func_mainSort.32:                                 ; preds = %ctrl1
  call void @mainSort.32(i32* %ptr, i8* %block, i16* %quadrant, i32* %ftab, i32 %nblock, i32 %verb, i32* %budget)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_mainSort.21, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_mainSort.23, label %func_mainSort.32
}
...
func_fallbackQSort3.8:                            ; preds = %ctrl0
  call void @fallbackQSort3.8(i32* %fmap, i32* %eclass, i32 %loSt, i32 %hiSt)
  ret void

func_fallbackQSort3.16:                           ; preds = %ctrl1
  call void @fallbackQSort3.16(i32* %fmap, i32* %eclass, i32 %loSt, i32 %hiSt)
  ret void

func_fallbackQSort3.18:                           ; preds = %ctrl1
  call void @fallbackQSort3.18(i32* %fmap, i32* %eclass, i32 %loSt, i32 %hiSt)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_fallbackQSort3.8, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_fallbackQSort3.16, label %func_fallbackQSort3.18
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_fallbackSimpleSort.11, label %ctrl0

func_fallbackSimpleSort.11:                       ; preds = %rand_bb
  call void @fallbackSimpleSort.11(i32* %fmap, i32* %eclass, i32 %lo, i32 %hi)
  ret void

func_fallbackSimpleSort.14:                       ; preds = %ctrl0
...
func_fallbackSimpleSort.36:                       ; preds = %ctrl1
  call void @fallbackSimpleSort.36(i32* %fmap, i32* %eclass, i32 %lo, i32 %hi)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_fallbackSimpleSort.14, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_fallbackSimpleSort.35, label %func_fallbackSimpleSort.36
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_mainQSort3.12, label %ctrl0

func_mainQSort3.12:                               ; preds = %rand_bb
  call void @mainQSort3.12(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %loSt, i32 %hiSt, i32 %dSt, i32* %budget)
  ret void
...
func_mainQSort3.22:                               ; preds = %ctrl1
  call void @mainQSort3.22(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %loSt, i32 %hiSt, i32 %dSt, i32* %budget)
  ret void
...
ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_mainQSort3.20, label %func_mainQSort3.22
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_mainSimpleSort.1, label %ctrl0

func_mainSimpleSort.1:                            ; preds = %rand_bb
  call void @mainSimpleSort.1(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %lo, i32 %hi, i32 %d, i32* %budget)
  ret void

func_mainSimpleSort.2:                            ; preds = %ctrl0
  call void @mainSimpleSort.2(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %lo, i32 %hi, i32 %d, i32* %budget)
  ret void

func_mainSimpleSort.19:                           ; preds = %ctrl1
  call void @mainSimpleSort.19(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %lo, i32 %hi, i32 %d, i32* %budget)
  ret void

func_mainSimpleSort.24:                           ; preds = %ctrl1
  call void @mainSimpleSort.24(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %lo, i32 %hi, i32 %d, i32* %budget)
  ret void

ctrl0:                                            ; preds = %rand_bb
  %2 = icmp eq i32 %0, 1
  br i1 %2, label %func_mainSimpleSort.2, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %3 = icmp eq i32 %0, 2
  br i1 %3, label %func_mainSimpleSort.19, label %func_mainSimpleSort.24
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_mmed3.7, label %ctrl0

func_mmed3.7:                                     ; preds = %rand_bb
  %2 = call i8 @mmed3.7(i8 %a, i8 %b, i8 %c)
  ret i8 %2
...
func_mmed3.13:                                    ; preds = %ctrl1
  %4 = call i8 @mmed3.13(i8 %a, i8 %b, i8 %c)
  ret i8 %4

func_mmed3.15:                                    ; preds = %ctrl1
  %5 = call i8 @mmed3.15(i8 %a, i8 %b, i8 %c)
  ret i8 %5
...
ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_mmed3.13, label %func_mmed3.15
}
...
rand_bb:
  %0 = call i32 @get_urand()
  %1 = icmp eq i32 %0, 0
  br i1 %1, label %func_mainGtU.9, label %ctrl0

func_mainGtU.9:                                   ; preds = %rand_bb
  %2 = call i8 @mainGtU.9(i32 %i1, i32 %i2, i8* %block, i16* %quadrant, i32 %nblock, i32* %budget)
  ret i8 %2

func_mainGtU.25:                                  ; preds = %ctrl0
  %3 = call i8 @mainGtU.25(i32 %i1, i32 %i2, i8* %block, i16* %quadrant, i32 %nblock, i32* %budget)
  ret i8 %3

func_mainGtU.26:                                  ; preds = %ctrl1
  %4 = call i8 @mainGtU.26(i32 %i1, i32 %i2, i8* %block, i16* %quadrant, i32 %nblock, i32* %budget)
  ret i8 %4

func_mainGtU.27:                                  ; preds = %ctrl1
  %5 = call i8 @mainGtU.27(i32 %i1, i32 %i2, i8* %block, i16* %quadrant, i32 %nblock, i32* %budget)
  ret i8 %5

ctrl0:                                            ; preds = %rand_bb
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %func_mainGtU.25, label %ctrl1

ctrl1:                                            ; preds = %ctrl0
  %7 = icmp eq i32 %0, 2
  br i1 %7, label %func_mainGtU.26, label %func_mainGtU.27
}

; Function Attrs: noinline nounwind optnone uwtable
define internal void @mainSimpleSort.1(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %lo, i32 %hi, i32 %d, i32* %budget) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 907375504, i32* %canary
...
entry:
  ...
  %hp = alloca i32, align 4
  %canary = alloca i32
  store i32 1183237661, i32* %canary
  %hi.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %block.addr = alloca i8*, align 8
  %quadrant.addr = alloca i16*, align 8
...
for.end:                                          ; preds = %if.then94, %for.cond, %if.then
  %112 = load i32, i32* %canary
  %113 = icmp eq i32 %112, 1183237661
  br i1 %113, label %114, label %func_exit
...
entry:
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 860649343, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @mainSort.4(i32* %ptr, i8* %block, i16* %quadrant, i32* %ftab, i32 %nblock, i32 %verb, i32* %budget) #0 {
entry:
  ...
  %canary = alloca i32
  store i32 1069229382, i32* %canary
  %ptr.addr = alloca i32*, align 8
  store i32* %ptr, i32** %ptr.addr, align 8
  store i8* %block, i8** %block.addr, align 8
  store i16* %quadrant, i16** %quadrant.addr, align 8
...
if.end514:                                        ; preds = %if.then511, %for.end508, %if.then318
  ...
  %346 = icmp eq i32 %345, 1069229382
...
entry:
  ...
  %ftab = alloca i32*, align 8
  %canary = alloca i32
  store i32 785284754, i32* %canary
  %ptr = alloca i32*, align 8
  %quadrant = alloca i16*, align 8
  %verb = alloca i32, align 4
  %budgetInit = alloca i32, align 4
...
entry:
  ...
  %canary = alloca i32
  store i32 890421408, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @mmed3.7(i8 zeroext %a, i8 zeroext %b, i8 zeroext %c) #0 {
entry:
  %a.addr = alloca i8, align 1
  %b.addr = alloca i8, align 1
  %canary = alloca i32
  store i32 1752223743, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @fallbackQSort3.8(i32* %fmap, i32* %eclass, i32 %loSt, i32 %hiSt) #0 {
entry:
  %eclass.addr = alloca i32*, align 8
  %lo = alloca i32, align 4
  %canary = alloca i32
  store i32 479854786, i32* %canary
  %zztmp93 = alloca i32, align 4
  %yyp1139 = alloca i32, align 4
  %hi = alloca i32, align 4
  %ltLo = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @mainGtU.9(i32 %i1, i32 %i2, i8* %block, i16* %quadrant, i32 %nblock, i32* %budget) #0 {
entry:
  %canary = alloca i32
  store i32 1933763554, i32* %canary
...
return:                                           ; preds = %do.end, %if.then445, %if.then430, %if.then413, %if.then398, %if.then381, %if.then366, %if.then349, %if.then334, %if.then317, %if.then302, %if.then285, %if.then270, %if.then253, %if.then238, %if.then221, %if.then206, %if.then189, %if.then172, %if.then155, %if.then138, %if.then121, %if.then104, %if.then87, %if.then70, %if.then53, %if.then36, %if.then19, %if.then
  ...
  %335 = icmp eq i32 %334, 1933763554
...
entry:
  %a.addr = alloca i8, align 1
  %canary = alloca i32
  store i32 1332018725, i32* %canary
  %b.addr = alloca i8, align 1
  %t = alloca i8, align 1
  %c.addr = alloca i8, align 1
  store i8 %a, i8* %a.addr, align 1
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @fallbackSimpleSort.11(i32* %fmap, i32* %eclass, i32 %lo, i32 %hi) #0 {
entry:
  ...
  %fmap.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 1769071324, i32* %canary
  %i = alloca i32, align 4
  store i32* %fmap, i32** %fmap.addr, align 8
  store i32* %eclass, i32** %eclass.addr, align 8
  store i32 %lo, i32* %lo.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @mainQSort3.12(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %loSt, i32 %hiSt, i32 %dSt, i32* %budget) #0 {
entry:
  %ptr.addr = alloca i32*, align 8
  %zztmp = alloca i32, align 4
  %ltLo = alloca i32, align 4
  ...
  %canary = alloca i32
  store i32 2122468074, i32* %canary
  %nblock.addr = alloca i32, align 4
...
while.end302:                                     ; preds = %if.then16, %while.cond
  ...
  %254 = icmp eq i32 %253, 2122468074
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @mmed3.13(i8 zeroext %a, i8 zeroext %b, i8 zeroext %c) #0 {
entry:
  %canary = alloca i32
  store i32 145209788, i32* %canary
  %b.addr = alloca i8, align 1
  %a.addr = alloca i8, align 1
  %t = alloca i8, align 1
  %c.addr = alloca i8, align 1
...
entry:
  %canary = alloca i32
  store i32 127388649, i32* %canary
  %fmap.addr = alloca i32*, align 8
  %i = alloca i32, align 4
  %lo.addr = alloca i32, align 4
  %eclass.addr = alloca i32*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @mmed3.15(i8 zeroext %a, i8 zeroext %b, i8 zeroext %c) #0 {
entry:
  %t = alloca i8, align 1
  %a.addr = alloca i8, align 1
  %b.addr = alloca i8, align 1
  %canary = alloca i32
  store i32 318340680, i32* %canary
  %c.addr = alloca i8, align 1
  store i8 %a, i8* %a.addr, align 1
  store i8 %b, i8* %b.addr, align 1
  store i8 %c, i8* %c.addr, align 1
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @fallbackQSort3.16(i32* %fmap, i32* %eclass, i32 %loSt, i32 %hiSt) #0 {
entry:
  %zztmp93 = alloca i32, align 4
  %yyp1 = alloca i32, align 4
  %unHi = alloca i32, align 4
  ...
  %ltLo = alloca i32, align 4
  %canary = alloca i32
  store i32 1506002104, i32* %canary
  %yyp2 = alloca i32, align 4
  %gtHi = alloca i32, align 4
  %fmap.addr = alloca i32*, align 8
  %stackHi = alloca [100 x i32], align 16
...
while.end192:                                     ; preds = %while.cond
  %189 = load i32, i32* %canary
  %190 = icmp eq i32 %189, 1506002104
  br i1 %190, label %191, label %func_exit
...
entry:
  ...
  %yyp2165 = alloca i32, align 4
  %canary = alloca i32
  store i32 155119764, i32* %canary
  %hiSt.addr = alloca i32, align 4
  %m = alloca i32, align 4
  %nblock.addr = alloca i32, align 4
  %yyp2 = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @fallbackQSort3.18(i32* %fmap, i32* %eclass, i32 %loSt, i32 %hiSt) #0 {
entry:
  %yyn143 = alloca i32, align 4
  %zztmp93 = alloca i32, align 4
  %unHi = alloca i32, align 4
  ...
  %loSt.addr = alloca i32, align 4
  %canary = alloca i32
  store i32 1303565028, i32* %canary
  %yyp2 = alloca i32, align 4
  %n = alloca i32, align 4
  %eclass.addr = alloca i32*, align 8
  %stackLo = alloca [100 x i32], align 16
...
while.end192:                                     ; preds = %while.cond
  %189 = load i32, i32* %canary
  %190 = icmp eq i32 %189, 1303565028
  br i1 %190, label %191, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @mainSimpleSort.19(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %lo, i32 %hi, i32 %d, i32* %budget) #0 {
entry:
  %canary = alloca i32
  store i32 88249931, i32* %canary
  %budget.addr = alloca i32*, align 8
  %quadrant.addr = alloca i16*, align 8
  %hp = alloca i32, align 4
  %hi.addr = alloca i32, align 4
...
entry:
  ...
  %yyp2 = alloca i32, align 4
  %canary = alloca i32
  store i32 1264375478, i32* %canary
  %yyn = alloca i32, align 4
  %sp = alloca i32, align 4
  %tz258 = alloca i32, align 4
  %block.addr = alloca i8*, align 8
...
while.end302:                                     ; preds = %if.then16, %while.cond
  %253 = load i32, i32* %canary
  %254 = icmp eq i32 %253, 1264375478
  br i1 %254, label %255, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @mainSort.21(i32* %ptr, i8* %block, i16* %quadrant, i32* %ftab, i32 %nblock, i32 %verb, i32* %budget) #0 {
entry:
  %h = alloca i32, align 4
  %qVal = alloca i16, align 2
  %s = alloca i16, align 2
  ...
  %ss = alloca i32, align 4
  %canary = alloca i32
  store i32 1159678183, i32* %canary
  %quadrant.addr = alloca i16*, align 8
  %k = alloca i32, align 4
  %shifts = alloca i32, align 4
  %copyEnd = alloca [256 x i32], align 16
...
if.end514:                                        ; preds = %if.then511, %for.end508, %if.then318
  %345 = load i32, i32* %canary
  %346 = icmp eq i32 %345, 1159678183
  br i1 %346, label %347, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @mainQSort3.22(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %loSt, i32 %hiSt, i32 %dSt, i32* %budget) #0 {
entry:
  %quadrant.addr = alloca i16*, align 8
  %n = alloca i32, align 4
  %zztmp173 = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @mainSort.23(i32* %ptr, i8* %block, i16* %quadrant, i32* %ftab, i32 %nblock, i32 %verb, i32* %budget) #0 {
entry:
  %sb = alloca i32, align 4
  %block.addr = alloca i8*, align 8
  %copyEnd = alloca [256 x i32], align 16
  ...
  %qVal = alloca i16, align 2
  %canary = alloca i32
  store i32 2095783003, i32* %canary
  %shifts = alloca i32, align 4
  %hi = alloca i32, align 4
  %k = alloca i32, align 4
  %i = alloca i32, align 4
...
if.end514:                                        ; preds = %if.then511, %for.end508, %if.then318
  %345 = load i32, i32* %canary
  %346 = icmp eq i32 %345, 2095783003
  br i1 %346, label %347, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @mainSimpleSort.24(i32* %ptr, i8* %block, i16* %quadrant, i32 %nblock, i32 %lo, i32 %hi, i32 %d, i32* %budget) #0 {
entry:
  %h = alloca i32, align 4
  %block.addr = alloca i8*, align 8
  %lo.addr = alloca i32, align 4
  ...
  %ptr.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 1811725545, i32* %canary
  %bigN = alloca i32, align 4
  %d.addr = alloca i32, align 4
  %j = alloca i32, align 4
  %hi.addr = alloca i32, align 4
...
for.end:                                          ; preds = %if.then94, %for.cond, %if.then
  %112 = load i32, i32* %canary
  %113 = icmp eq i32 %112, 1811725545
  br i1 %113, label %114, label %func_exit
...
entry:
  ...
  %quadrant.addr = alloca i16*, align 8
  %canary = alloca i32
  store i32 1711021577, i32* %canary
  %nblock.addr = alloca i32, align 4
  %i2.addr = alloca i32, align 4
  %c1 = alloca i8, align 1
  %k = alloca i32, align 4
...
return:                                           ; preds = %do.end, %if.then445, %if.then430, %if.then413, %if.then398, %if.then381, %if.then366, %if.then349, %if.then334, %if.then317, %if.then302, %if.then285, %if.then270, %if.then253, %if.then238, %if.then221, %if.then206, %if.then189, %if.then172, %if.then155, %if.then138, %if.then121, %if.then104, %if.then87, %if.then70, %if.then53, %if.then36, %if.then19, %if.then
  %333 = load i8, i8* %retval, align 1
  %334 = load i32, i32* %canary
  %335 = icmp eq i32 %334, 1711021577
  br i1 %335, label %336, label %func_exit
...
entry:
  %canary = alloca i32
  store i32 491963496, i32* %canary
  %nblock.addr = alloca i32, align 4
  %quadrant.addr = alloca i16*, align 8
  %i1.addr = alloca i32, align 4
  %c2 = alloca i8, align 1
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i8 @mainGtU.27(i32 %i1, i32 %i2, i8* %block, i16* %quadrant, i32 %nblock, i32* %budget) #0 {
entry:
  %retval = alloca i8, align 1
  %nblock.addr = alloca i32, align 4
  %i2.addr = alloca i32, align 4
  ...
  %budget.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 586219806, i32* %canary
  %block.addr = alloca i8*, align 8
  %quadrant.addr = alloca i16*, align 8
  store i32 %i1, i32* %i1.addr, align 4
  store i32 %i2, i32* %i2.addr, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @BZ2_blockSort.28(%struct.EState* %s) #0 {
entry:
  %canary = alloca i32
  store i32 1583742564, i32* %canary
  %i = alloca i32, align 4
  %wfact = alloca i32, align 4
  %budgetInit = alloca i32, align 4
  %quadrant = alloca i16*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @fallbackSort.29(i32* %fmap, i32* %eclass, i32* %bhtab, i32 %nblock, i32 %verb) #0 {
entry:
  %j = alloca i32, align 4
  %r = alloca i32, align 4
  ...
  %fmap.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 355000334, i32* %canary
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @fallbackSort.30(i32* %fmap, i32* %eclass, i32* %bhtab, i32 %nblock, i32 %verb) #0 {
entry:
  %r = alloca i32, align 4
  %nNotDone = alloca i32, align 4
  %i = alloca i32, align 4
  ...
  %H = alloca i32, align 4
  %canary = alloca i32
  store i32 1825700320, i32* %canary
  %k = alloca i32, align 4
  %l = alloca i32, align 4
  %ftabCopy = alloca [256 x i32], align 16
  %fmap.addr = alloca i32*, align 8
...
if.end298:                                        ; preds = %if.then297, %for.end294
  %182 = load i32, i32* %canary
  %183 = icmp eq i32 %182, 1825700320
  br i1 %183, label %184, label %func_exit
...
entry:
  ...
  %r = alloca i32, align 4
  %canary = alloca i32
  store i32 559072993, i32* %canary
  %ftab = alloca [257 x i32], align 16
  %j = alloca i32, align 4
  %verb.addr = alloca i32, align 4
  %l = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @mainSort.32(i32* %ptr, i8* %block, i16* %quadrant, i32* %ftab, i32 %nblock, i32 %verb, i32* %budget) #0 {
entry:
  %shifts = alloca i32, align 4
  %sb = alloca i32, align 4
  %copyStart = alloca [256 x i32], align 16
  ...
  %j = alloca i32, align 4
  %canary = alloca i32
  store i32 1951268762, i32* %canary
  %quadrant.addr = alloca i16*, align 8
  %copyEnd = alloca [256 x i32], align 16
  %vv = alloca i32, align 4
  %verb.addr = alloca i32, align 4
...
if.end514:                                        ; preds = %if.then511, %for.end508, %if.then318
  %345 = load i32, i32* %canary
  %346 = icmp eq i32 %345, 1951268762
  br i1 %346, label %347, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @fallbackSort.33(i32* %fmap, i32* %eclass, i32* %bhtab, i32 %nblock, i32 %verb) #0 {
entry:
  %H = alloca i32, align 4
  %ftabCopy = alloca [256 x i32], align 16
  %nNotDone = alloca i32, align 4
  ...
  %k = alloca i32, align 4
  %canary = alloca i32
  store i32 1610423680, i32* %canary
  %eclass8 = alloca i8*, align 8
  store i32* %fmap, i32** %fmap.addr, align 8
  store i32* %eclass, i32** %eclass.addr, align 8
  store i32* %bhtab, i32** %bhtab.addr, align 8
...
if.end298:                                        ; preds = %if.then297, %for.end294
  %182 = load i32, i32* %canary
  %183 = icmp eq i32 %182, 1610423680
  br i1 %183, label %184, label %func_exit
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @BZ2_blockSort.34(%struct.EState* %s) #0 {
entry:
  %wfact = alloca i32, align 4
  %ftab = alloca i32*, align 8
  %s.addr = alloca %struct.EState*, align 8
  ...
  %i = alloca i32, align 4
  %canary = alloca i32
  store i32 1418692413, i32* %canary
  %budget = alloca i32, align 4
  %budgetInit = alloca i32, align 4
  %nblock = alloca i32, align 4
  %quadrant = alloca i16*, align 8
...
entry:
  ...
  %fmap.addr = alloca i32*, align 8
  %canary = alloca i32
  store i32 1238238993, i32* %canary
  %hi.addr = alloca i32, align 4
  %ec_tmp = alloca i32, align 4
  %lo.addr = alloca i32, align 4
  %j = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @fallbackSimpleSort.36(i32* %fmap, i32* %eclass, i32 %lo, i32 %hi) #0 {
entry:
  %ec_tmp = alloca i32, align 4
  %canary = alloca i32
  store i32 480542932, i32* %canary
  %tmp = alloca i32, align 4
  %lo.addr = alloca i32, align 4
  %i = alloca i32, align 4
  %eclass.addr = alloca i32*, align 8
